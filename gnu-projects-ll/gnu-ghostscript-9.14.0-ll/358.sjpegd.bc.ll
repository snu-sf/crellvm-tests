...
define i32 @gs_jpeg_create_decompress(%struct.stream_DCT_state_s* %st) #0 {
entry:
...
do.body:                                          ; preds = %if.end
  ...
  %decompress = bitcast %union._jd* %data3 to %struct.jpeg_decompress_data_s**
  %7 = load %struct.jpeg_decompress_data_s*, %struct.jpeg_decompress_data_s** %decompress, align 8, !tbaa !1
  %Picky = getelementptr inbounds %struct.jpeg_decompress_data_s, %struct.jpeg_decompress_data_s* %7, i32 0, i32 6
  ...
  %decompress5 = bitcast %union._jd* %data4 to %struct.jpeg_decompress_data_s**
  %9 = load %struct.jpeg_decompress_data_s*, %struct.jpeg_decompress_data_s** %decompress5, align 8, !tbaa !1
  %Relax = getelementptr inbounds %struct.jpeg_decompress_data_s, %struct.jpeg_decompress_data_s* %9, i32 0, i32 7
  ...
  %decompress7 = bitcast %union._jd* %data6 to %struct.jpeg_decompress_data_s**
  %11 = load %struct.jpeg_decompress_data_s*, %struct.jpeg_decompress_data_s** %decompress7, align 8, !tbaa !1
  %dummy = getelementptr inbounds %struct.jpeg_decompress_data_s, %struct.jpeg_decompress_data_s* %11, i32 0, i32 5
...
do.end:                                           ; preds = %do.body
  ...
  %decompress9 = bitcast %union._jd* %data8 to %struct.jpeg_decompress_data_s**
  %13 = load %struct.jpeg_decompress_data_s*, %struct.jpeg_decompress_data_s** %decompress9, align 8, !tbaa !1
  %dinfo = getelementptr inbounds %struct.jpeg_decompress_data_s, %struct.jpeg_decompress_data_s* %13, i32 0, i32 8
  call void @jpeg_CreateDecompress(%struct.jpeg_decompress_struct* %dinfo, i32 90, i64 880) #3
...
; Function Attrs: nounwind uwtable
define i32 @gs_jpeg_read_header(%struct.stream_DCT_state_s* %st, i32 %require_image) #0 {
entry:
  %retval = alloca i32, align 4
  %st.addr = alloca %struct.stream_DCT_state_s*, align 8
  %require_image.addr = alloca i32, align 4
  store %struct.stream_DCT_state_s* %st, %struct.stream_DCT_state_s** %st.addr, align 8, !tbaa !1
  store i32 %require_image, i32* %require_image.addr, align 4, !tbaa !18
  %0 = load %struct.stream_DCT_state_s*, %struct.stream_DCT_state_s** %st.addr, align 8, !tbaa !1
...
if.end:                                           ; preds = %entry
  ...
  %decompress = bitcast %union._jd* %data3 to %struct.jpeg_decompress_data_s**
  %6 = load %struct.jpeg_decompress_data_s*, %struct.jpeg_decompress_data_s** %decompress, align 8, !tbaa !1
  %dinfo = getelementptr inbounds %struct.jpeg_decompress_data_s, %struct.jpeg_decompress_data_s* %6, i32 0, i32 8
  %7 = load i32, i32* %require_image.addr, align 4, !tbaa !18
  %call4 = call i32 @jpeg_read_header(%struct.jpeg_decompress_struct* %dinfo, i32 %7) #3
...
; Function Attrs: nounwind uwtable
define i32 @gs_jpeg_start_decompress(%struct.stream_DCT_state_s* %st) #0 {
entry:
  %retval = alloca i32, align 4
  %st.addr = alloca %struct.stream_DCT_state_s*, align 8
  store %struct.stream_DCT_state_s* %st, %struct.stream_DCT_state_s** %st.addr, align 8, !tbaa !1
...
if.end:                                           ; preds = %entry
  ...
  %6 = load %struct.jpeg_decompress_data_s*, %struct.jpeg_decompress_data_s** %decompress, align 8, !tbaa !1
  %dinfo = getelementptr inbounds %struct.jpeg_decompress_data_s, %struct.jpeg_decompress_data_s* %6, i32 0, i32 8
  %call4 = call i32 @jpeg_start_decompress(%struct.jpeg_decompress_struct* %dinfo) #3
  store i32 %call4, i32* %retval
  br label %return
...
; Function Attrs: nounwind uwtable
define i32 @gs_jpeg_read_scanlines(%struct.stream_DCT_state_s* %st, i8** %scanlines, i32 %max_lines) #0 {
entry:
  %retval = alloca i32, align 4
  %st.addr = alloca %struct.stream_DCT_state_s*, align 8
...
if.end:                                           ; preds = %entry
  ...
  %8 = load i32, i32* %max_lines.addr, align 4, !tbaa !19
  %call4 = call i32 @jpeg_read_scanlines(%struct.jpeg_decompress_struct* %dinfo, i8** %7, i32 %8) #3
  store i32 %call4, i32* %retval
  br label %return
...
; Function Attrs: nounwind uwtable
define i32 @gs_jpeg_finish_decompress(%struct.stream_DCT_state_s* %st) #0 {
entry:
  %retval = alloca i32, align 4
  %st.addr = alloca %struct.stream_DCT_state_s*, align 8
  store %struct.stream_DCT_state_s* %st, %struct.stream_DCT_state_s** %st.addr, align 8, !tbaa !1
...
if.end:                                           ; preds = %entry
  ...
  %6 = load %struct.jpeg_decompress_data_s*, %struct.jpeg_decompress_data_s** %decompress, align 8, !tbaa !1
  %dinfo = getelementptr inbounds %struct.jpeg_decompress_data_s, %struct.jpeg_decompress_data_s* %6, i32 0, i32 8
  %call4 = call i32 @jpeg_finish_decompress(%struct.jpeg_decompress_struct* %dinfo) #3
  store i32 %call4, i32* %retval
  br label %return
...
!4 = !{!"Simple C/C++ TBAA"}
!5 = !{!6, !8, i64 456}
!6 = !{!"jpeg_decompress_data_s", !7, i64 0, !9, i64 56, !11, i64 224, !2, i64 432, !2, i64 440, !2, i64 448, !8, i64 456, !8, i64 460, !12, i64 464, !15, i64 1344, !10, i64 1400, !8, i64 1408, !8, i64 1412, !2, i64 1416, !8, i64 1424}
...
!10 = !{!"long", !3, i64 0}
!11 = !{!"", !3, i64 0}
!12 = !{!"jpeg_decompress_struct", !2, i64 0, !2, i64 8, !2, i64 16, !2, i64 24, !3, i64 32, !8, i64 36, !2, i64 40, !8, i64 48, !8, i64 52, !8, i64 56, !3, i64 60, !3, i64 64, !8, i64 68, !8, i64 72, !13, i64 80, !3, i64 88, !3, i64 92, !3, i64 96, !3, i64 100, !3, i64 104, !3, i64 108, !3, i64 112, !3, i64 116, !8, i64 120, !3, i64 124, !3, i64 128, !3, i64 132, !8, i64 136, !8, i64 140, !8, i64 144, !8, i64 148, !8, i64 152, !8, i64 156, !2, i64 160, !8, i64 168, !8, i64 172, !8, i64 176, !8, i64 180, !8, i64 184, !2, i64 192, !3, i64 200, !3, i64 232, !3, i64 264, !8, i64 296, !2, i64 304, !3, i64 312, !3, i64 316, !3, i64 320, !3, i64 324, !3, i64 340, !3, i64 356, !8, i64 372, !3, i64 376, !3, i64 380, !3, i64 381, !3, i64 382, !14, i64 384, !14, i64 386, !3, i64 388, !3, i64 392, !3, i64 396, !3, i64 400, !2, i64 408, !8, i64 416, !8, i64 420, !8, i64 424, !8, i64 428, !8, i64 432, !2, i64 440, !8, i64 448, !3, i64 456, !8, i64 488, !8, i64 492, !8, i64 496, !3, i64 500, !8, i64 756, !8, i64 760, !8, i64 764, !8, i64 768, !8, i64 772, !2, i64 776, !8, i64 784, !8, i64 788, !2, i64 792, !2, i64 800, !2, i64 808, !2, i64 816, !2, i64 824, !2, i64 832, !2, i64 840, !2, i64 848, !2, i64 856, !2, i64 864, !2, i64 872}
!13 = !{!"double", !3, i64 0}
!14 = !{!"short", !3, i64 0}
!15 = !{!"jpeg_source_mgr", !2, i64 0, !10, i64 8, !2, i64 16, !2, i64 24, !2, i64 32, !2, i64 40, !2, i64 48}
!16 = !{!6, !8, i64 460}
!17 = !{!6, !2, i64 448}
!18 = !{!3, !3, i64 0}
!19 = !{!8, !8, i64 0}
