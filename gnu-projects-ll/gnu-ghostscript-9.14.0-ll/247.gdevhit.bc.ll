...
define internal i32 @hit_fill_rectangle(%struct.gx_device_s* %dev, i32 %x, i32 %y, i32 %w, i32 %h, i64 %color) #1 {
entry:
...
land.lhs.true:                                    ; preds = %entry
  %1 = load i32, i32* %h.addr, align 4, !tbaa !5
...
declare %struct.gx_device_s* @gx_default_get_page_device(%struct.gx_device_s*) #0
...
declare i32 @gx_default_strip_copy_rop(%struct.gx_device_s*, i8*, i32, i32, i64, i64*, %struct.gx_strip_bitmap_s*, i64*, i32, i32, i32, i32, i32, i32, i32) #0

declare void @gx_get_largest_clipping_box(%struct.gx_device_s*, %struct.gs_fixed_rect_s*) #0
