...
define internal i32 @r4081_print_page(%struct.gx_device_printer_s* %pdev, %struct._IO_FILE* %prn_stream) #1 {
entry:
  ...
  %7 = load i32, i32* %width, align 4, !tbaa !7
  %add = add nsw i32 %7, 7
  %and = and i32 %add, -8
  store i32 %and, i32* %out_size, align 4, !tbaa !5
  ...
  %10 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory, align 8, !tbaa !23
  %non_gc_memory = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %10, i32 0, i32 3
  %11 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory, align 8, !tbaa !24
  %procs = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %11, i32 0, i32 1
  %alloc_byte_array = getelementptr inbounds %struct.gs_memory_procs_s, %struct.gs_memory_procs_s* %procs, i32 0, i32 10
  %12 = load i8* (%struct.gs_memory_s*, i32, i32, i8*)*, i8* (%struct.gs_memory_s*, i32, i32, i8*)** %alloc_byte_array, align 8, !tbaa !27
  ...
  %14 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory1, align 8, !tbaa !23
  %non_gc_memory2 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %14, i32 0, i32 3
  %15 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory2, align 8, !tbaa !24
  %16 = load i32, i32* %out_size, align 4, !tbaa !5
  %call3 = call i8* %12(%struct.gs_memory_s* %15, i32 %16, i32 1, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i32 0, i32 0)) #4
  store i8* %call3, i8** %out, align 8, !tbaa !1
  %17 = bitcast i32* %lnum to i8*
  call void @llvm.lifetime.start(i64 4, i8* %17) #2
  store i32 0, i32* %lnum, align 4, !tbaa !5
  %18 = bitcast i32* %last to i8*
  ...
  %20 = load i32, i32* %height, align 4, !tbaa !28
  store i32 %20, i32* %last, align 4, !tbaa !5
...
if.then.4:                                        ; preds = %if.then
  ...
  %memory5 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %23, i32 0, i32 3
  %24 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory5, align 8, !tbaa !23
  %non_gc_memory6 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %24, i32 0, i32 3
  %25 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory6, align 8, !tbaa !24
  ...
  %26 = load void (%struct.gs_memory_s*, i8*, i8*)*, void (%struct.gs_memory_s*, i8*, i8*)** %free_object, align 8, !tbaa !29
  %27 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory8 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %27, i32 0, i32 3
  %28 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory8, align 8, !tbaa !23
  %non_gc_memory9 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %28, i32 0, i32 3
  %29 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory9, align 8, !tbaa !24
  %30 = load i8*, i8** %out, align 8, !tbaa !1
  call void %26(%struct.gs_memory_s* %29, i8* %30, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i32 0, i32 0)) #4
  br label %if.end
...
while.cond:                                       ; preds = %if.end.19, %if.end.10
  %31 = load i32, i32* %lnum, align 4, !tbaa !5
  %32 = load i32, i32* %last, align 4, !tbaa !5
...
while.body:                                       ; preds = %while.cond
  ...
  %36 = load i32, i32* %line_size, align 4, !tbaa !5
  %call12 = call i32 @gdev_prn_copy_scan_lines(%struct.gx_device_printer_s* %33, i32 %34, i8* %35, i32 %36) #4
  %37 = load i8*, i8** %out, align 8, !tbaa !1
  %arrayidx = getelementptr inbounds i8, i8* %37, i64 0
  %38 = load i8, i8* %arrayidx, align 1, !tbaa !30
...
lor.lhs.false:                                    ; preds = %while.body
  ...
  %41 = load i32, i32* %line_size, align 4, !tbaa !5
  %sub = sub nsw i32 %41, 1
  %conv15 = sext i32 %sub to i64
  %call16 = call i32 @memcmp(i8* %39, i8* %add.ptr, i64 %conv15) #5
...
while.cond.20:                                    ; preds = %if.end.37, %while.end
  %43 = load i32, i32* %last, align 4, !tbaa !5
  %44 = load i32, i32* %lnum, align 4, !tbaa !5
  %cmp21 = icmp sgt i32 %43, %44
  br i1 %cmp21, label %while.body.23, label %while.end.38

while.body.23:                                    ; preds = %while.cond.20
  %45 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %46 = load i32, i32* %last, align 4, !tbaa !5
  %sub24 = sub nsw i32 %46, 1
  %47 = load i8*, i8** %out, align 8, !tbaa !1
  %48 = load i32, i32* %line_size, align 4, !tbaa !5
  %call25 = call i32 @gdev_prn_copy_scan_lines(%struct.gx_device_printer_s* %45, i32 %sub24, i8* %47, i32 %48) #4
  %49 = load i8*, i8** %out, align 8, !tbaa !1
  %arrayidx26 = getelementptr inbounds i8, i8* %49, i64 0
  %50 = load i8, i8* %arrayidx26, align 1, !tbaa !30
  %conv27 = zext i8 %50 to i32
  %cmp28 = icmp ne i32 %conv27, 0
  br i1 %cmp28, label %if.then.36, label %lor.lhs.false.30

lor.lhs.false.30:                                 ; preds = %while.body.23
  %51 = load i8*, i8** %out, align 8, !tbaa !1
  %52 = load i8*, i8** %out, align 8, !tbaa !1
  %add.ptr31 = getelementptr inbounds i8, i8* %52, i64 1
  %53 = load i32, i32* %line_size, align 4, !tbaa !5
  %sub32 = sub nsw i32 %53, 1
  %conv33 = sext i32 %sub32 to i64
  %call34 = call i32 @memcmp(i8* %51, i8* %add.ptr31, i64 %conv33) #5
  %tobool35 = icmp ne i32 %call34, 0
  br i1 %tobool35, label %if.then.36, label %if.end.37

if.then.36:                                       ; preds = %lor.lhs.false.30, %while.body.23
  br label %while.end.38

if.end.37:                                        ; preds = %lor.lhs.false.30
  %54 = load i32, i32* %last, align 4, !tbaa !5
  %dec = add nsw i32 %54, -1
  store i32 %dec, i32* %last, align 4, !tbaa !5
  br label %while.cond.20

while.end.38:                                     ; preds = %if.then.36, %while.cond.20
  %55 = load %struct._IO_FILE*, %struct._IO_FILE** %prn_stream.addr, align 8, !tbaa !1
  %56 = load i32, i32* %out_size, align 4, !tbaa !5
  %57 = load i32, i32* %last, align 4, !tbaa !5
  %58 = load i32, i32* %lnum, align 4, !tbaa !5
  %sub39 = sub nsw i32 %57, %58
  %59 = load i32, i32* %lnum, align 4, !tbaa !5
  %add40 = add nsw i32 %59, 1
  %mul = mul nsw i32 %add40, 720
  %div = sdiv i32 %mul, 300
  %call41 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %55, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.3, i32 0, i32 0), i32 %56, i32 %sub39, i32 %div) #4
  br label %while.cond.42

while.cond.42:                                    ; preds = %while.body.45, %while.end.38
  %60 = load i32, i32* %lnum, align 4, !tbaa !5
  %61 = load i32, i32* %last, align 4, !tbaa !5
  %cmp43 = icmp slt i32 %60, %61
  br i1 %cmp43, label %while.body.45, label %while.end.50
...
while.body.45:                                    ; preds = %while.cond.42
  ...
  %65 = load i32, i32* %line_size, align 4, !tbaa !5
  %call46 = call i32 @gdev_prn_copy_scan_lines(%struct.gx_device_printer_s* %62, i32 %63, i8* %64, i32 %65) #4
  %66 = load i8*, i8** %out, align 8, !tbaa !1
  %67 = load i32, i32* %line_size, align 4, !tbaa !5
  %conv47 = sext i32 %67 to i64
  %68 = load %struct._IO_FILE*, %struct._IO_FILE** %prn_stream.addr, align 8, !tbaa !1
  %call48 = call i64 @fwrite(i8* %66, i64 1, i64 %conv47, %struct._IO_FILE* %68) #4
  %69 = load i32, i32* %lnum, align 4, !tbaa !5
  %inc49 = add nsw i32 %69, 1
  store i32 %inc49, i32* %lnum, align 4, !tbaa !5
  br label %while.cond.42

while.end.50:                                     ; preds = %while.cond.42
  %70 = load %struct._IO_FILE*, %struct._IO_FILE** %prn_stream.addr, align 8, !tbaa !1
  %call51 = call i32 @fputs(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), %struct._IO_FILE* %70) #4
  %71 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory52 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %71, i32 0, i32 3
  %72 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory52, align 8, !tbaa !23
  %non_gc_memory53 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %72, i32 0, i32 3
  %73 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory53, align 8, !tbaa !24
  ...
  %74 = load void (%struct.gs_memory_s*, i8*, i8*)*, void (%struct.gs_memory_s*, i8*, i8*)** %free_object55, align 8, !tbaa !29
  ...
  %76 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory56, align 8, !tbaa !23
  %non_gc_memory57 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %76, i32 0, i32 3
  %77 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory57, align 8, !tbaa !24
  %78 = load i8*, i8** %out, align 8, !tbaa !1
  call void %74(%struct.gs_memory_s* %77, i8* %78, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.2, i32 0, i32 0)) #4
  store i32 0, i32* %retval
  store i32 1, i32* %cleanup.dest.slot
  br label %cleanup

cleanup:                                          ; preds = %while.end.50, %if.end
  %79 = bitcast i32* %last to i8*
  call void @llvm.lifetime.end(i64 4, i8* %79) #2
  %80 = bitcast i32* %lnum to i8*
  call void @llvm.lifetime.end(i64 4, i8* %80) #2
  %81 = bitcast i8** %out to i8*
  call void @llvm.lifetime.end(i64 8, i8* %81) #2
  %82 = bitcast i32* %out_size to i8*
  call void @llvm.lifetime.end(i64 4, i8* %82) #2
  %83 = bitcast i32* %line_size to i8*
