...
@.str = private unnamed_addr constant [18 x i8] c"0.popdevicefilter\00", align 1
@zdfilter_op_defs = constant [2 x %struct.op_def] [%struct.op_def { i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str, i32 0, i32 0), i32 (%struct.gs_context_state_s*)* @zpopdevicefilter }, %struct.op_def zeroinitializer], align 16

; Function Attrs: nounwind uwtable
define internal i32 @zpopdevicefilter(%struct.gs_context_state_s* %i_ctx_p) #0 {
entry:
  ...
  %2 = load %struct.gs_ref_memory_s*, %struct.gs_ref_memory_s** %current, align 8, !tbaa !5
  ...
  %4 = load %struct.gs_memory_s* (%struct.gs_memory_s*)*, %struct.gs_memory_s* (%struct.gs_memory_s*)** %stable, align 8, !tbaa !19
  ...
  %6 = load %struct.gs_ref_memory_s*, %struct.gs_ref_memory_s** %current2, align 8, !tbaa !5
  %7 = bitcast %struct.gs_ref_memory_s* %6 to %struct.gs_memory_s*
  %call = call %struct.gs_memory_s* %4(%struct.gs_memory_s* %7) #3
  ...
  %call3 = call i32 @gs_pop_device_filter(%struct.gs_memory_s* %8, %struct.gs_state_s* %10) #3
...
declare i32 @gs_pop_device_filter(%struct.gs_memory_s*, %struct.gs_state_s*) #2
