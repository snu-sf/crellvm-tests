...
define internal i32 @sunhmono_print_page(%struct.gx_device_printer_s* %pdev, %struct._IO_FILE* %prn_stream) #1 {
entry:
  %pdev.addr = alloca %struct.gx_device_printer_s*, align 8
  %prn_stream.addr = alloca %struct._IO_FILE*, align 8
  %gsLineBytes = alloca i32, align 4
  %rasLineBytes = alloca i32, align 4
  %lineCnt = alloca i32, align 4
  %lineStorage = alloca i8*, align 8
  %data = alloca i8*, align 8
  %ras = alloca %struct.sun_rasterfile_s, align 4
  %code = alloca i32, align 4
  store %struct.gx_device_printer_s* %pdev, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  store %struct._IO_FILE* %prn_stream, %struct._IO_FILE** %prn_stream.addr, align 8, !tbaa !1
  %0 = bitcast i32* %gsLineBytes to i8*
  ...
  store i32 %call, i32* %gsLineBytes, align 4, !tbaa !5
  %5 = bitcast i32* %rasLineBytes to i8*
  call void @llvm.lifetime.start(i64 4, i8* %5) #2
  %6 = load i32, i32* %gsLineBytes, align 4, !tbaa !5
  %add = add nsw i32 %6, 1
  %and = and i32 %add, -2
  store i32 %and, i32* %rasLineBytes, align 4, !tbaa !5
  %7 = bitcast i32* %lineCnt to i8*
  call void @llvm.lifetime.start(i64 4, i8* %7) #2
  %8 = bitcast i8** %lineStorage to i8*
  call void @llvm.lifetime.start(i64 8, i8* %8) #2
  %9 = bitcast i8** %data to i8*
  call void @llvm.lifetime.start(i64 8, i8* %9) #2
  %10 = bitcast %struct.sun_rasterfile_s* %ras to i8*
  ...
  %13 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory, align 8, !tbaa !7
  %non_gc_memory = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %13, i32 0, i32 3
  %14 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory, align 8, !tbaa !23
  %procs = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %14, i32 0, i32 1
  %alloc_byte_array = getelementptr inbounds %struct.gs_memory_procs_s, %struct.gs_memory_procs_s* %procs, i32 0, i32 10
  %15 = load i8* (%struct.gs_memory_s*, i32, i32, i8*)*, i8* (%struct.gs_memory_s*, i32, i32, i8*)** %alloc_byte_array, align 8, !tbaa !26
  ...
  %17 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory1, align 8, !tbaa !7
  %non_gc_memory2 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %17, i32 0, i32 3
  %18 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory2, align 8, !tbaa !23
  %19 = load i32, i32* %gsLineBytes, align 4, !tbaa !5
  %call3 = call i8* %15(%struct.gs_memory_s* %18, i32 %19, i32 1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.2, i32 0, i32 0)) #3
  store i8* %call3, i8** %lineStorage, align 8, !tbaa !1
  %20 = load i8*, i8** %lineStorage, align 8, !tbaa !1
...
if.end:                                           ; preds = %entry
  %ras_magic = getelementptr inbounds %struct.sun_rasterfile_s, %struct.sun_rasterfile_s* %ras, i32 0, i32 0
  store i32 1504078485, i32* %ras_magic, align 4, !tbaa !27
  %21 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %width = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %21, i32 0, i32 13
  %22 = load i32, i32* %width, align 4, !tbaa !29
  %ras_width = getelementptr inbounds %struct.sun_rasterfile_s, %struct.sun_rasterfile_s* %ras, i32 0, i32 1
  store i32 %22, i32* %ras_width, align 4, !tbaa !30
  %23 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %height = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %23, i32 0, i32 14
  %24 = load i32, i32* %height, align 4, !tbaa !31
  %ras_height = getelementptr inbounds %struct.sun_rasterfile_s, %struct.sun_rasterfile_s* %ras, i32 0, i32 2
  store i32 %24, i32* %ras_height, align 4, !tbaa !32
  %ras_depth = getelementptr inbounds %struct.sun_rasterfile_s, %struct.sun_rasterfile_s* %ras, i32 0, i32 3
  store i32 1, i32* %ras_depth, align 4, !tbaa !33
  %25 = load i32, i32* %rasLineBytes, align 4, !tbaa !5
  %26 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %height4 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %26, i32 0, i32 14
  %27 = load i32, i32* %height4, align 4, !tbaa !31
  %mul = mul nsw i32 %25, %27
  %ras_length = getelementptr inbounds %struct.sun_rasterfile_s, %struct.sun_rasterfile_s* %ras, i32 0, i32 4
  store i32 %mul, i32* %ras_length, align 4, !tbaa !34
  %ras_type = getelementptr inbounds %struct.sun_rasterfile_s, %struct.sun_rasterfile_s* %ras, i32 0, i32 5
  store i32 1, i32* %ras_type, align 4, !tbaa !35
  %ras_maptype = getelementptr inbounds %struct.sun_rasterfile_s, %struct.sun_rasterfile_s* %ras, i32 0, i32 6
  store i32 0, i32* %ras_maptype, align 4, !tbaa !36
  %ras_maplength = getelementptr inbounds %struct.sun_rasterfile_s, %struct.sun_rasterfile_s* %ras, i32 0, i32 7
  store i32 0, i32* %ras_maplength, align 4, !tbaa !37
  %28 = bitcast %struct.sun_rasterfile_s* %ras to i8*
  %29 = load %struct._IO_FILE*, %struct._IO_FILE** %prn_stream.addr, align 8, !tbaa !1
  %call5 = call i64 @fwrite(i8* %28, i64 1, i64 32, %struct._IO_FILE* %29) #3
  store i32 0, i32* %lineCnt, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.end
  %30 = load i32, i32* %lineCnt, align 4, !tbaa !5
  %31 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %height6 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %31, i32 0, i32 14
  %32 = load i32, i32* %height6, align 4, !tbaa !31
  %cmp7 = icmp slt i32 %30, %32
  br i1 %cmp7, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %33 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %34 = load i32, i32* %lineCnt, align 4, !tbaa !5
  %35 = load i8*, i8** %lineStorage, align 8, !tbaa !1
  %call8 = call i32 @gdev_prn_get_bits(%struct.gx_device_printer_s* %33, i32 %34, i8* %35, i8** %data) #3
  %36 = load i8*, i8** %data, align 8, !tbaa !1
  %37 = load i32, i32* %gsLineBytes, align 4, !tbaa !5
  %conv = sext i32 %37 to i64
  %38 = load %struct._IO_FILE*, %struct._IO_FILE** %prn_stream.addr, align 8, !tbaa !1
  %call9 = call i64 @fwrite(i8* %36, i64 1, i64 %conv, %struct._IO_FILE* %38) #3
  %39 = load i32, i32* %gsLineBytes, align 4, !tbaa !5
  %rem = srem i32 %39, 2
...
if.then.10:                                       ; preds = %for.body
  ...
  %call11 = call i32 @fputc(i32 0, %struct._IO_FILE* %40) #3
  br label %if.end.12
...
for.inc:                                          ; preds = %if.end.12
  %41 = load i32, i32* %lineCnt, align 4, !tbaa !5
  %inc = add nsw i32 %41, 1
  store i32 %inc, i32* %lineCnt, align 4, !tbaa !5
  br label %for.cond

for.end:                                          ; preds = %for.cond
  %42 = load %struct._IO_FILE*, %struct._IO_FILE** %prn_stream.addr, align 8, !tbaa !1
  %call13 = call i64 @fwrite(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), i64 1, i64 3, %struct._IO_FILE* %42) #3
  br label %out

out:                                              ; preds = %for.end, %if.then
  %43 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory14 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %43, i32 0, i32 3
  %44 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory14, align 8, !tbaa !7
  %non_gc_memory15 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %44, i32 0, i32 3
  %45 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory15, align 8, !tbaa !23
  %procs16 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %45, i32 0, i32 1
  %free_object = getelementptr inbounds %struct.gs_memory_procs_s, %struct.gs_memory_procs_s* %procs16, i32 0, i32 2
  %46 = load void (%struct.gs_memory_s*, i8*, i8*)*, void (%struct.gs_memory_s*, i8*, i8*)** %free_object, align 8, !tbaa !38
  %47 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory17 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %47, i32 0, i32 3
  %48 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory17, align 8, !tbaa !7
  %non_gc_memory18 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %48, i32 0, i32 3
  %49 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory18, align 8, !tbaa !23
  %50 = load i8*, i8** %lineStorage, align 8, !tbaa !1
  call void %46(%struct.gs_memory_s* %49, i8* %50, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.2, i32 0, i32 0)) #3
  %51 = load i32, i32* %code, align 4, !tbaa !5
  %52 = bitcast i32* %code to i8*
  call void @llvm.lifetime.end(i64 4, i8* %52) #2
  %53 = bitcast %struct.sun_rasterfile_s* %ras to i8*
  call void @llvm.lifetime.end(i64 32, i8* %53) #2
  %54 = bitcast i8** %data to i8*
  call void @llvm.lifetime.end(i64 8, i8* %54) #2
  %55 = bitcast i8** %lineStorage to i8*
  call void @llvm.lifetime.end(i64 8, i8* %55) #2
  %56 = bitcast i32* %lineCnt to i8*
  call void @llvm.lifetime.end(i64 4, i8* %56) #2
  %57 = bitcast i32* %rasLineBytes to i8*
  call void @llvm.lifetime.end(i64 4, i8* %57) #2
  %58 = bitcast i32* %gsLineBytes to i8*
...
!26 = !{!24, !2, i64 88}
!27 = !{!28, !6, i64 0}
!28 = !{!"sun_rasterfile_s", !6, i64 0, !6, i64 4, !6, i64 8, !6, i64 12, !6, i64 16, !6, i64 20, !6, i64 24, !6, i64 28}
!29 = !{!8, !6, i64 832}
!30 = !{!28, !6, i64 4}
!31 = !{!8, !6, i64 836}
!32 = !{!28, !6, i64 8}
