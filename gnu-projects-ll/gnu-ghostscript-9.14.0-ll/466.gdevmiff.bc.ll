...
define internal i32 @miff24_print_page(%struct.gx_device_printer_s* %pdev, %struct._IO_FILE* %file) #1 {
entry:
  ...
  %call = call i32 @gx_device_raster(%struct.gx_device_s* %2, i32 1) #3
  ...
  %6 = load i8* (%struct.gs_memory_s*, i32, i8*)*, i8* (%struct.gs_memory_s*, i32, i8*)** %alloc_bytes, align 8, !tbaa !23
  ...
  %8 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory1, align 8, !tbaa !7
  %9 = load i32, i32* %raster, align 4, !tbaa !5
  %call2 = call i8* %6(%struct.gs_memory_s* %8, i32 %9, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i32 0, i32 0)) #3
  store i8* %call2, i8** %line, align 8, !tbaa !1
  %10 = bitcast i32* %y to i8*
  call void @llvm.lifetime.start(i64 4, i8* %10) #2
  %11 = bitcast i32* %code to i8*
  call void @llvm.lifetime.start(i64 4, i8* %11) #2
  store i32 0, i32* %code, align 4, !tbaa !5
  %12 = load i8*, i8** %line, align 8, !tbaa !1
...
if.end:                                           ; preds = %entry
  ...
  %call3 = call i32 @fputs(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.3, i32 0, i32 0), %struct._IO_FILE* %13) #3
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** %file.addr, align 8, !tbaa !1
  %call4 = call i32 @fputs(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i32 0, i32 0), %struct._IO_FILE* %14) #3
  ...
  %width = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %16, i32 0, i32 13
  %17 = load i32, i32* %width, align 4, !tbaa !26
  %call5 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %15, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i32 0, i32 0), i32 %17) #3
  %18 = load %struct._IO_FILE*, %struct._IO_FILE** %file.addr, align 8, !tbaa !1
  %call6 = call i32 @fputs(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.6, i32 0, i32 0), %struct._IO_FILE* %18) #3
  %19 = load %struct._IO_FILE*, %struct._IO_FILE** %file.addr, align 8, !tbaa !1
  %20 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %height = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %20, i32 0, i32 14
  %21 = load i32, i32* %height, align 4, !tbaa !27
  %call7 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %19, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i32 0, i32 0), i32 %21) #3
  %22 = load %struct._IO_FILE*, %struct._IO_FILE** %file.addr, align 8, !tbaa !1
  %call8 = call i32 @fputs(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i32 0, i32 0), %struct._IO_FILE* %22) #3
...
for.cond:                                         ; preds = %for.inc, %if.end
  ...
  %height9 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %24, i32 0, i32 14
  %25 = load i32, i32* %height9, align 4, !tbaa !27
  %cmp10 = icmp slt i32 %23, %25
  br i1 %cmp10, label %for.body, label %for.end

for.body:                                         ; preds = %for.cond
  %26 = bitcast i8** %row to i8*
  ...
  %30 = load i8*, i8** %line, align 8, !tbaa !1
  %call11 = call i32 @gdev_prn_get_bits(%struct.gx_device_printer_s* %28, i32 %29, i8* %30, i8** %row) #3
...
if.end.14:                                        ; preds = %for.body
  ...
  %width15 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %33, i32 0, i32 13
  %34 = load i32, i32* %width15, align 4, !tbaa !26
...
while.cond:                                       ; preds = %while.end, %if.end.14
  %35 = load i8*, i8** %row, align 8, !tbaa !1
  %36 = load i8*, i8** %end, align 8, !tbaa !1
  %cmp16 = icmp ult i8* %35, %36
  br i1 %cmp16, label %while.body, label %while.end.52
...
while.cond.17:                                    ; preds = %while.body.39, %while.body
  %38 = load i32, i32* %count, align 4, !tbaa !5
  %cmp18 = icmp slt i32 %38, 255
  br i1 %cmp18, label %land.lhs.true, label %land.end

land.lhs.true:                                    ; preds = %while.cond.17
  %39 = load i8*, i8** %row, align 8, !tbaa !1
  %40 = load i8*, i8** %end, align 8, !tbaa !1
  %add.ptr19 = getelementptr inbounds i8, i8* %40, i64 -3
  %cmp20 = icmp ult i8* %39, %add.ptr19
...
land.lhs.true.21:                                 ; preds = %land.lhs.true
  ...
  %43 = load i8*, i8** %row, align 8, !tbaa !1
  %arrayidx22 = getelementptr inbounds i8, i8* %43, i64 3
  %44 = load i8, i8* %arrayidx22, align 1, !tbaa !28
...
land.lhs.true.26:                                 ; preds = %land.lhs.true.21
  ...
  %46 = load i8, i8* %arrayidx27, align 1, !tbaa !28
  %conv28 = zext i8 %46 to i32
  %47 = load i8*, i8** %row, align 8, !tbaa !1
  %arrayidx29 = getelementptr inbounds i8, i8* %47, i64 4
  %48 = load i8, i8* %arrayidx29, align 1, !tbaa !28
...
land.rhs:                                         ; preds = %land.lhs.true.26
  %49 = load i8*, i8** %row, align 8, !tbaa !1
  %arrayidx33 = getelementptr inbounds i8, i8* %49, i64 2
  %50 = load i8, i8* %arrayidx33, align 1, !tbaa !28
  %conv34 = zext i8 %50 to i32
  %51 = load i8*, i8** %row, align 8, !tbaa !1
  %arrayidx35 = getelementptr inbounds i8, i8* %51, i64 5
  %52 = load i8, i8* %arrayidx35, align 1, !tbaa !28
  %conv36 = zext i8 %52 to i32
  %cmp37 = icmp eq i32 %conv34, %conv36
  br label %land.end

land.end:                                         ; preds = %land.rhs, %land.lhs.true.26, %land.lhs.true.21, %land.lhs.true, %while.cond.17
  %53 = phi i1 [ false, %land.lhs.true.26 ], [ false, %land.lhs.true.21 ], [ false, %land.lhs.true ], [ false, %while.cond.17 ], [ %cmp37, %land.rhs ]
  br i1 %53, label %while.body.39, label %while.end

while.body.39:                                    ; preds = %land.end
  %54 = load i32, i32* %count, align 4, !tbaa !5
  %inc = add nsw i32 %54, 1
  store i32 %inc, i32* %count, align 4, !tbaa !5
  %55 = load i8*, i8** %row, align 8, !tbaa !1
  %add.ptr40 = getelementptr inbounds i8, i8* %55, i64 3
  store i8* %add.ptr40, i8** %row, align 8, !tbaa !1
  br label %while.cond.17

while.end:                                        ; preds = %land.end
  %56 = load i8*, i8** %row, align 8, !tbaa !1
  %arrayidx41 = getelementptr inbounds i8, i8* %56, i64 0
  %57 = load i8, i8* %arrayidx41, align 1, !tbaa !28
  %conv42 = zext i8 %57 to i32
  %58 = load %struct._IO_FILE*, %struct._IO_FILE** %file.addr, align 8, !tbaa !1
  %call43 = call i32 @_IO_putc(i32 %conv42, %struct._IO_FILE* %58) #3
  %59 = load i8*, i8** %row, align 8, !tbaa !1
  %arrayidx44 = getelementptr inbounds i8, i8* %59, i64 1
  %60 = load i8, i8* %arrayidx44, align 1, !tbaa !28
  %conv45 = zext i8 %60 to i32
  %61 = load %struct._IO_FILE*, %struct._IO_FILE** %file.addr, align 8, !tbaa !1
  %call46 = call i32 @_IO_putc(i32 %conv45, %struct._IO_FILE* %61) #3
  %62 = load i8*, i8** %row, align 8, !tbaa !1
  %arrayidx47 = getelementptr inbounds i8, i8* %62, i64 2
  %63 = load i8, i8* %arrayidx47, align 1, !tbaa !28
  %conv48 = zext i8 %63 to i32
  %64 = load %struct._IO_FILE*, %struct._IO_FILE** %file.addr, align 8, !tbaa !1
  %call49 = call i32 @_IO_putc(i32 %conv48, %struct._IO_FILE* %64) #3
  %65 = load i32, i32* %count, align 4, !tbaa !5
  %66 = load %struct._IO_FILE*, %struct._IO_FILE** %file.addr, align 8, !tbaa !1
  %call50 = call i32 @_IO_putc(i32 %65, %struct._IO_FILE* %66) #3
  %67 = load i8*, i8** %row, align 8, !tbaa !1
  %add.ptr51 = getelementptr inbounds i8, i8* %67, i64 3
  store i8* %add.ptr51, i8** %row, align 8, !tbaa !1
...
cleanup:                                          ; preds = %while.end.52, %if.then.13
  %69 = bitcast i8** %end to i8*
  call void @llvm.lifetime.end(i64 8, i8* %69) #2
  %70 = bitcast i8** %row to i8*
...
for.end:                                          ; preds = %cleanup, %for.cond
  ...
  %memory55 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %72, i32 0, i32 3
  %73 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory55, align 8, !tbaa !7
  %procs56 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %73, i32 0, i32 1
  %free_object = getelementptr inbounds %struct.gs_memory_procs_s, %struct.gs_memory_procs_s* %procs56, i32 0, i32 2
  %74 = load void (%struct.gs_memory_s*, i8*, i8*)*, void (%struct.gs_memory_s*, i8*, i8*)** %free_object, align 8, !tbaa !29
  %75 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory57 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %75, i32 0, i32 3
  %76 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory57, align 8, !tbaa !7
  %77 = load i8*, i8** %line, align 8, !tbaa !1
  call void %74(%struct.gs_memory_s* %76, i8* %77, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.2, i32 0, i32 0)) #3
  %78 = load i32, i32* %code, align 4, !tbaa !5
  store i32 %78, i32* %retval
  store i32 1, i32* %cleanup.dest.slot
  br label %cleanup.58

cleanup.58:                                       ; preds = %for.end, %if.then
