; ModuleID = './app/tools/gimppaintbrushtool.bc'
...
@gimp_paintbrush_tool_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [19 x i8] c"GimpPaintbrushTool\00", align 1
@.str.1 = private unnamed_addr constant [21 x i8] c"gimp-paintbrush-tool\00", align 1
@.str.2 = private unnamed_addr constant [11 x i8] c"Paintbrush\00", align 1
@.str.3 = private unnamed_addr constant [52 x i8] c"Paintbrush Tool: Paint smooth strokes using a brush\00", align 1
@.str.4 = private unnamed_addr constant [12 x i8] c"_Paintbrush\00", align 1
@.str.5 = private unnamed_addr constant [2 x i8] c"P\00", align 1
@.str.6 = private unnamed_addr constant [21 x i8] c"gimp-tool-paintbrush\00", align 1
@gimp_paintbrush_tool_parent_class = internal global i8* null, align 8
@GimpPaintbrushTool_private_offset = internal global i32 0, align 4

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_paintbrush_tool_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_paintbrush_tool_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_paintbrush_tool_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 304, void (i8*, i8*)* bitcast (void (i8*)* @gimp_paintbrush_tool_class_intern_init to void (i8*, i8*)*), i32 360, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpPaintbrushTool*)* @gimp_paintbrush_tool_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_paintbrush_tool_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_paintbrush_tool_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_paintbrush_tool_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_paintbrush_tool_parent_class, align 8
  %1 = load i32, i32* @GimpPaintbrushTool_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpPaintbrushTool_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpPaintbrushToolClass*
  call void @gimp_paintbrush_tool_class_init(%struct._GimpPaintbrushToolClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_paintbrush_tool_init(%struct._GimpPaintbrushTool* %paintbrush) #3 {
entry:
  %paintbrush.addr = alloca %struct._GimpPaintbrushTool*, align 8
  %tool = alloca %struct._GimpTool*, align 8
  store %struct._GimpPaintbrushTool* %paintbrush, %struct._GimpPaintbrushTool** %paintbrush.addr, align 8
  %0 = load %struct._GimpPaintbrushTool*, %struct._GimpPaintbrushTool** %paintbrush.addr, align 8
  %1 = bitcast %struct._GimpPaintbrushTool* %0 to %struct._GTypeInstance*
  ...
  call void @gimp_tool_control_set_tool_cursor(%struct._GimpToolControl* %4, i32 25)
  %5 = load %struct._GimpPaintbrushTool*, %struct._GimpPaintbrushTool** %paintbrush.addr, align 8
  %6 = bitcast %struct._GimpPaintbrushTool* %5 to %struct._GTypeInstance*
  ...
  %7 = bitcast %struct._GTypeInstance* %call3 to %struct._GimpPaintTool*
  call void @gimp_paint_tool_enable_color_picker(%struct._GimpPaintTool* %7, i32 1)
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @gimp_paintbrush_tool_register(void (i64, i64, %struct._GtkWidget* (%struct._GimpToolOptions*)*, i32, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*)* %callback, i8* %data) #3 {
entry:
  ...
  %call = call i64 @gimp_paintbrush_tool_get_type() #5
  %call1 = call i64 @gimp_paint_options_get_type() #5
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.2, i32 0, i32 0)) #6
  %call3 = call i8* @gettext(i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.3, i32 0, i32 0)) #6
  %1 = load i8*, i8** %data.addr, align 8
  call void %0(i64 %call, i64 %call1, %struct._GtkWidget* (%struct._GimpToolOptions*)* @gimp_paint_options_gui, i32 28608, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i32 0, i32 0), i8* %call2, i8* %call3, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), i8* %1)
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_paintbrush_tool_class_init(%struct._GimpPaintbrushToolClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpPaintbrushToolClass*, align 8
  store %struct._GimpPaintbrushToolClass* %klass, %struct._GimpPaintbrushToolClass** %klass.addr, align 8
  ret void
}
