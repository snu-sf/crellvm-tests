; ModuleID = './app/paint/gimpsourceoptions.bc'
...
@gimp_source_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [18 x i8] c"GimpSourceOptions\00", align 1
@gimp_source_options_parent_class = internal global i8* null, align 8
@GimpSourceOptions_private_offset = internal global i32 0, align 4
@.str.1 = private unnamed_addr constant [11 x i8] c"align-mode\00", align 1
...
@.str.4 = private unnamed_addr constant [20 x i8] c"gimpsourceoptions.c\00", align 1
...
define i64 @gimp_source_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_source_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_source_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_source_options_class_intern_init to void (i8*, i8*)*), i32 488, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpSourceOptions*)* @gimp_source_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_source_options_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_source_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_source_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_source_options_parent_class, align 8
  %1 = load i32, i32* @GimpSourceOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpSourceOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpSourceOptionsClass*
  call void @gimp_source_options_class_init(%struct._GimpSourceOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_source_options_init(%struct._GimpSourceOptions* %options) #3 {
entry:
  %options.addr = alloca %struct._GimpSourceOptions*, align 8
  store %struct._GimpSourceOptions* %options, %struct._GimpSourceOptions** %options.addr, align 8
  %0 = load %struct._GimpSourceOptions*, %struct._GimpSourceOptions** %options.addr, align 8
  %use_source = getelementptr inbounds %struct._GimpSourceOptions, %struct._GimpSourceOptions* %0, i32 0, i32 3
  store i32 1, i32* %use_source, align 4
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_source_options_class_init(%struct._GimpSourceOptionsClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpSourceOptionsClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  store %struct._GimpSourceOptionsClass* %klass, %struct._GimpSourceOptionsClass** %klass.addr, align 8
  %0 = load %struct._GimpSourceOptionsClass*, %struct._GimpSourceOptionsClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpSourceOptionsClass* %0 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_source_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %4 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %4, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_source_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %5 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call1 = call i64 @gimp_source_align_mode_get_type() #5
  ...
  %call3 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i32 0, i32 0), i8* null, i8* null, i32 0, i32 487)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_source_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  ...
  %call = call i64 @gimp_source_options_get_type() #5
...
sw.bb:                                            ; preds = %entry
  ...
  %align_mode = getelementptr inbounds %struct._GimpSourceOptions, %struct._GimpSourceOptions* %5, i32 0, i32 1
  store i32 %call2, i32* %align_mode, align 4
  br label %sw.epilog

sw.bb.3:                                          ; preds = %entry
  %6 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call4 = call i32 @g_value_get_boolean(%struct._GValue* %6)
  %7 = load %struct._GimpSourceOptions*, %struct._GimpSourceOptions** %options, align 8
  %sample_merged = getelementptr inbounds %struct._GimpSourceOptions, %struct._GimpSourceOptions* %7, i32 0, i32 2
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.4, i32 0, i32 0), i32 93, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.5, i32 0, i32 0), i32 %11, i8* %13, i8* %call5, i8* %call8)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_source_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpSourceOptions*, %struct._GimpSourceOptions** %options, align 8
  %align_mode = getelementptr inbounds %struct._GimpSourceOptions, %struct._GimpSourceOptions* %5, i32 0, i32 1
  %6 = load i32, i32* %align_mode, align 4
  call void @g_value_set_enum(%struct._GValue* %4, i32 %6)
  br label %sw.epilog

sw.bb.2:                                          ; preds = %entry
  %7 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %8 = load %struct._GimpSourceOptions*, %struct._GimpSourceOptions** %options, align 8
  %sample_merged = getelementptr inbounds %struct._GimpSourceOptions, %struct._GimpSourceOptions* %8, i32 0, i32 2
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.4, i32 0, i32 0), i32 115, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.5, i32 0, i32 0), i32 %13, i8* %15, i8* %call3, i8* %call6)
  br label %do.end
...
; Function Attrs: nounwind readnone
declare i64 @gimp_source_align_mode_get_type() #2
