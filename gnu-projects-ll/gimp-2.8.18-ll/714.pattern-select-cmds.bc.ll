; ModuleID = './app/pdb/pattern-select-cmds.bc'
...
@.str.1 = private unnamed_addr constant [36 x i8] c"Invokes the Gimp pattern selection.\00", align 1
@.str.2 = private unnamed_addr constant [51 x i8] c"This procedure opens the pattern selection dialog.\00", align 1
...
@.str.5 = private unnamed_addr constant [17 x i8] c"pattern-callback\00", align 1
@.str.6 = private unnamed_addr constant [17 x i8] c"pattern callback\00", align 1
@.str.7 = private unnamed_addr constant [61 x i8] c"The callback PDB proc to call when pattern selection is made\00", align 1
...
@.str.10 = private unnamed_addr constant [38 x i8] c"Title of the pattern selection dialog\00", align 1
@.str.11 = private unnamed_addr constant [16 x i8] c"initial-pattern\00", align 1
@.str.12 = private unnamed_addr constant [16 x i8] c"initial pattern\00", align 1
@.str.13 = private unnamed_addr constant [53 x i8] c"The name of the pattern to set as the first selected\00", align 1
@.str.14 = private unnamed_addr constant [26 x i8] c"gimp-patterns-close-popup\00", align 1
@.str.15 = private unnamed_addr constant [36 x i8] c"Close the pattern selection dialog.\00", align 1
@.str.16 = private unnamed_addr constant [58 x i8] c"This procedure closes an opened pattern selection dialog.\00", align 1
@.str.17 = private unnamed_addr constant [52 x i8] c"The name of the callback registered for this pop-up\00", align 1
@.str.18 = private unnamed_addr constant [24 x i8] c"gimp-patterns-set-popup\00", align 1
@.str.19 = private unnamed_addr constant [56 x i8] c"Sets the current pattern in a pattern selection dialog.\00", align 1
@.str.20 = private unnamed_addr constant [13 x i8] c"pattern-name\00", align 1
@.str.21 = private unnamed_addr constant [13 x i8] c"pattern name\00", align 1
@.str.22 = private unnamed_addr constant [43 x i8] c"The name of the pattern to set as selected\00", align 1

; Function Attrs: nounwind uwtable
define void @register_pattern_select_procs(%struct._GimpPDB* %pdb) #0 {
entry:
  ...
  %call = call %struct._GimpProcedure* @gimp_procedure_new(%struct._GValueArray* (%struct._GimpProcedure*, %struct._Gimp*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GValueArray*, %struct._GError**)* @patterns_popup_invoker)
  ...
  %call3 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.7, i32 0, i32 0), i32 0, i32 0, i32 1, i8* null, i32 227)
  ...
  %call4 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.10, i32 0, i32 0), i32 0, i32 0, i32 0, i8* null, i32 227)
  ...
  %call5 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.11, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.12, i32 0, i32 0), i8* getelementptr inbounds ([53 x i8], [53 x i8]* @.str.13, i32 0, i32 0), i32 0, i32 1, i32 0, i8* null, i32 227)
  ...
  %call6 = call %struct._GimpProcedure* @gimp_procedure_new(%struct._GValueArray* (%struct._GimpProcedure*, %struct._Gimp*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GValueArray*, %struct._GError**)* @patterns_close_popup_invoker)
  ...
  call void @gimp_object_set_static_name(%struct._GimpObject* %13, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.14, i32 0, i32 0))
  %14 = load %struct._GimpProcedure*, %struct._GimpProcedure** %procedure, align 8
  call void @gimp_procedure_set_static_strings(%struct._GimpProcedure* %14, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.14, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.15, i32 0, i32 0), i8* getelementptr inbounds ([58 x i8], [58 x i8]* @.str.16, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i8* null)
  %15 = load %struct._GimpProcedure*, %struct._GimpProcedure** %procedure, align 8
  %call9 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.17, i32 0, i32 0), i32 0, i32 0, i32 1, i8* null, i32 227)
  ...
  %call10 = call %struct._GimpProcedure* @gimp_procedure_new(%struct._GValueArray* (%struct._GimpProcedure*, %struct._Gimp*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GValueArray*, %struct._GError**)* @patterns_set_popup_invoker)
  ...
  call void @gimp_procedure_set_static_strings(%struct._GimpProcedure* %23, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.18, i32 0, i32 0), i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.19, i32 0, i32 0), i8* getelementptr inbounds ([56 x i8], [56 x i8]* @.str.19, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i8* null)
  %24 = load %struct._GimpProcedure*, %struct._GimpProcedure** %procedure, align 8
  %call13 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.17, i32 0, i32 0), i32 0, i32 0, i32 1, i8* null, i32 227)
  ...
  %call14 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.20, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.21, i32 0, i32 0), i8* getelementptr inbounds ([43 x i8], [43 x i8]* @.str.22, i32 0, i32 0), i32 0, i32 0, i32 0, i8* null, i32 227)
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @patterns_popup_invoker(%struct._GimpProcedure* %procedure, %struct._Gimp* %gimp, %struct._GimpContext* %context, %struct._GimpProgress* %progress, %struct._GValueArray* %args, %struct._GError** %error) #0 {
entry:
  ...
  %initial_pattern = alloca i8*, align 8
  ...
  store i8* %call6, i8** %initial_pattern, align 8
...
lor.lhs.false:                                    ; preds = %if.then
  ...
  %11 = load i8*, i8** %pattern_callback, align 8
...
lor.lhs.false.10:                                 ; preds = %lor.lhs.false
  ...
  %19 = load i8*, i8** %initial_pattern, align 8
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @patterns_close_popup_invoker(%struct._GimpProcedure* %procedure, %struct._Gimp* %gimp, %struct._GimpContext* %context, %struct._GimpProgress* %progress, %struct._GValueArray* %args, %struct._GError** %error) #0 {
entry:
  %procedure.addr = alloca %struct._GimpProcedure*, align 8
  %gimp.addr = alloca %struct._Gimp*, align 8
  %context.addr = alloca %struct._GimpContext*, align 8
...
lor.lhs.false:                                    ; preds = %if.then
  ...
  %7 = load i8*, i8** %pattern_callback, align 8
...
lor.lhs.false.4:                                  ; preds = %lor.lhs.false
  ...
  %9 = load %struct._Gimp*, %struct._Gimp** %gimp.addr, align 8
  %pattern_factory = getelementptr inbounds %struct._Gimp, %struct._Gimp* %9, i32 0, i32 39
  %10 = load %struct._GimpDataFactory*, %struct._GimpDataFactory** %pattern_factory, align 8
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @patterns_set_popup_invoker(%struct._GimpProcedure* %procedure, %struct._Gimp* %gimp, %struct._GimpContext* %context, %struct._GimpProgress* %progress, %struct._GValueArray* %args, %struct._GError** %error) #0 {
entry:
  %procedure.addr = alloca %struct._GimpProcedure*, align 8
  %gimp.addr = alloca %struct._Gimp*, align 8
  %context.addr = alloca %struct._GimpContext*, align 8
  ...
  %success = alloca i32, align 4
  %pattern_callback = alloca i8*, align 8
  %pattern_name = alloca i8*, align 8
  store %struct._GimpProcedure* %procedure, %struct._GimpProcedure** %procedure.addr, align 8
  store %struct._Gimp* %gimp, %struct._Gimp** %gimp.addr, align 8
  store %struct._GimpContext* %context, %struct._GimpContext** %context.addr, align 8
  store %struct._GimpProgress* %progress, %struct._GimpProgress** %progress.addr, align 8
  ...
  %arrayidx2 = getelementptr inbounds %struct._GValue, %struct._GValue* %3, i64 1
  %call3 = call i8* @g_value_get_string(%struct._GValue* %arrayidx2)
  store i8* %call3, i8** %pattern_name, align 8
...
lor.lhs.false:                                    ; preds = %if.then
  ...
  %9 = load i8*, i8** %pattern_callback, align 8
...
lor.lhs.false.7:                                  ; preds = %lor.lhs.false
  ...
  %14 = load i8*, i8** %pattern_name, align 8
