; ModuleID = './app/paint/gimppenciloptions.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpPencilOptionsClass = type { %struct._GimpPaintOptionsClass }
...
%struct._GimpPencilOptions = type { %struct._GimpPaintOptions }
...
@gimp_pencil_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [18 x i8] c"GimpPencilOptions\00", align 1
@gimp_pencil_options_parent_class = internal global i8* null, align 8
@GimpPencilOptions_private_offset = internal global i32 0, align 4
...
@.str.3 = private unnamed_addr constant [20 x i8] c"gimppenciloptions.c\00", align 1
...
define i64 @gimp_pencil_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_pencil_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_pencil_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_pencil_options_class_intern_init to void (i8*, i8*)*), i32 472, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpPencilOptions*)* @gimp_pencil_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_pencil_options_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_pencil_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_pencil_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_pencil_options_parent_class, align 8
  %1 = load i32, i32* @GimpPencilOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpPencilOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpPencilOptionsClass*
  call void @gimp_pencil_options_class_init(%struct._GimpPencilOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_pencil_options_init(%struct._GimpPencilOptions* %options) #3 {
entry:
  %options.addr = alloca %struct._GimpPencilOptions*, align 8
  store %struct._GimpPencilOptions* %options, %struct._GimpPencilOptions** %options.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_pencil_options_class_init(%struct._GimpPencilOptionsClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpPencilOptionsClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  store %struct._GimpPencilOptionsClass* %klass, %struct._GimpPencilOptionsClass** %klass.addr, align 8
  %0 = load %struct._GimpPencilOptionsClass*, %struct._GimpPencilOptionsClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpPencilOptionsClass* %0 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_pencil_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %4 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %4, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_pencil_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %5 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call1 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i8* null, i8* null, i32 1, i32 487)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_pencil_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
...
sw.bb:                                            ; preds = %entry
  ...
  %hard = getelementptr inbounds %struct._GimpPaintOptions, %struct._GimpPaintOptions* %5, i32 0, i32 7
  store i32 %call2, i32* %hard, align 4
  br label %sw.epilog
...
; Function Attrs: nounwind uwtable
define internal void @gimp_pencil_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
