; ModuleID = './app/widgets/gimpgradientselect.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpGradientSelectClass = type { %struct._GimpPdbDialogClass }
...
%struct._GimpGradientSelect = type { %struct._GimpPdbDialog, i32 }
...
@gimp_gradient_select_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [19 x i8] c"GimpGradientSelect\00", align 1
@gimp_gradient_select_parent_class = internal global i8* null, align 8
@GimpGradientSelect_private_offset = internal global i32 0, align 4
@.str.1 = private unnamed_addr constant [12 x i8] c"sample-size\00", align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"<Gradients>\00", align 1
@.str.3 = private unnamed_addr constant [17 x i8] c"/gradients-popup\00", align 1
@.str.4 = private unnamed_addr constant [10 x i8] c"gradients\00", align 1
@.str.5 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.6 = private unnamed_addr constant [21 x i8] c"gimpgradientselect.c\00", align 1
@.str.7 = private unnamed_addr constant [9 x i8] c"property\00", align 1
@.str.8 = private unnamed_addr constant [13 x i8] c"Gimp-Widgets\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_gradient_select_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_gradient_select_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_gradient_select_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  %call5 = call i64 @gimp_pdb_dialog_get_type() #5
  %call6 = call i8* @g_intern_static_string(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0))
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 1000, void (i8*, i8*)* bitcast (void (i8*)* @gimp_gradient_select_class_intern_init to void (i8*, i8*)*), i32 344, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpGradientSelect*)* @gimp_gradient_select_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_gradient_select_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_gradient_select_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_gradient_select_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_gradient_select_parent_class, align 8
  %1 = load i32, i32* @GimpGradientSelect_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpGradientSelect_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpGradientSelectClass*
  call void @gimp_gradient_select_class_init(%struct._GimpGradientSelectClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_gradient_select_init(%struct._GimpGradientSelect* %select) #3 {
entry:
  %select.addr = alloca %struct._GimpGradientSelect*, align 8
  store %struct._GimpGradientSelect* %select, %struct._GimpGradientSelect** %select.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_gradient_select_class_init(%struct._GimpGradientSelectClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpGradientSelectClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  %pdb_class = alloca %struct._GimpPdbDialogClass*, align 8
  store %struct._GimpGradientSelectClass* %klass, %struct._GimpGradientSelectClass** %klass.addr, align 8
  %0 = load %struct._GimpGradientSelectClass*, %struct._GimpGradientSelectClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpGradientSelectClass* %0 to %struct._GTypeClass*
  %call = call %struct._GTypeClass* @g_type_check_class_cast(%struct._GTypeClass* %1, i64 80)
  %2 = bitcast %struct._GTypeClass* %call to %struct._GObjectClass*
  store %struct._GObjectClass* %2, %struct._GObjectClass** %object_class, align 8
  %3 = load %struct._GimpGradientSelectClass*, %struct._GimpGradientSelectClass** %klass.addr, align 8
  %4 = bitcast %struct._GimpGradientSelectClass* %3 to %struct._GTypeClass*
  %call1 = call i64 @gimp_pdb_dialog_get_type() #5
  ...
  store void (%struct._GObject*)* @gimp_gradient_select_constructed, void (%struct._GObject*)** %constructed, align 8
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %set_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %7, i32 0, i32 3
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_gradient_select_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  ...
  store %struct._GValueArray* (%struct._GimpPdbDialog*, %struct._GimpObject*, i32, %struct._GError**)* @gimp_gradient_select_run_callback, %struct._GValueArray* (%struct._GimpPdbDialog*, %struct._GimpObject*, i32, %struct._GError**)** %run_callback, align 8
  %9 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call %struct._GParamSpec* @g_param_spec_int(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0), i8* null, i8* null, i32 0, i32 10000, i32 84, i32 234)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_gradient_select_constructed(%struct._GObject* %object) #3 {
entry:
  ...
  %call = call i64 @gimp_pdb_dialog_get_type() #5
  ...
  %3 = load i8*, i8** @gimp_gradient_select_parent_class, align 8
...
if.then:                                          ; preds = %entry
  %7 = load i8*, i8** @gimp_gradient_select_parent_class, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %gradient_factory = getelementptr inbounds %struct._Gimp, %struct._Gimp* %14, i32 0, i32 40
  %15 = load %struct._GimpDataFactory*, %struct._GimpDataFactory** %gradient_factory, align 8
  ...
  %call6 = call %struct._GtkWidget* @gimp_data_factory_view_new(i32 0, %struct._GimpDataFactory* %15, %struct._GimpContext* %17, i32 32, i32 1, %struct._GimpMenuFactory* %19, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.4, i32 0, i32 0))
  ...
  %call8 = call i64 @gimp_container_editor_get_type() #5
  ...
  %call11 = call i64 @gimp_container_box_get_type() #5
...
; Function Attrs: nounwind uwtable
define internal void @gimp_gradient_select_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
  %pspec.addr = alloca %struct._GParamSpec*, align 8
  %select = alloca %struct._GimpGradientSelect*, align 8
  ...
  %0 = load %struct._GObject*, %struct._GObject** %object.addr, align 8
  %1 = bitcast %struct._GObject* %0 to %struct._GTypeInstance*
  %call = call i64 @gimp_gradient_select_get_type() #5
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpGradientSelect*
  store %struct._GimpGradientSelect* %2, %struct._GimpGradientSelect** %select, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpGradientSelect*, %struct._GimpGradientSelect** %select, align 8
  %sample_size = getelementptr inbounds %struct._GimpGradientSelect, %struct._GimpGradientSelect* %5, i32 0, i32 1
  store i32 %call2, i32* %sample_size, align 4
  br label %sw.epilog
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), i32 132, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i32 0, i32 0), i32 %9, i8* %11, i8* %call3, i8* %call6)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @gimp_gradient_select_run_callback(%struct._GimpPdbDialog* %dialog, %struct._GimpObject* %object, i32 %closing, %struct._GError** %error) #3 {
entry:
  ...
  %3 = load %struct._GimpPdbDialog*, %struct._GimpPdbDialog** %dialog.addr, align 8
  %4 = bitcast %struct._GimpPdbDialog* %3 to %struct._GTypeInstance*
  %call2 = call i64 @gimp_gradient_select_get_type() #5
  %call3 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %4, i64 %call2)
  %5 = bitcast %struct._GTypeInstance* %call3 to %struct._GimpGradientSelect*
  %sample_size = getelementptr inbounds %struct._GimpGradientSelect, %struct._GimpGradientSelect* %5, i32 0, i32 1
  %6 = load i32, i32* %sample_size, align 4
  ...
  store double* %9, double** %values, align 8
  %10 = load double*, double** %values, align 8
  store double* %10, double** %pv, align 8
  br label %while.cond
...
while.body:                                       ; preds = %while.cond
  ...
  %caller_context = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %13, i32 0, i32 2
  %14 = load %struct._GimpContext*, %struct._GimpContext** %caller_context, align 8
  %15 = load %struct._GimpGradientSegment*, %struct._GimpGradientSegment** %seg, align 8
  %16 = load double, double* %pos, align 8
  %call6 = call %struct._GimpGradientSegment* @gimp_gradient_get_color_at(%struct._GimpGradient* %12, %struct._GimpContext* %14, %struct._GimpGradientSegment* %15, double %16, i32 0, %struct._GimpRGB* %color)
  store %struct._GimpGradientSegment* %call6, %struct._GimpGradientSegment** %seg, align 8
  %r = getelementptr inbounds %struct._GimpRGB, %struct._GimpRGB* %color, i32 0, i32 0
  %17 = load double, double* %r, align 8
  %18 = load double*, double** %pv, align 8
  ...
  %20 = load double*, double** %pv, align 8
  %incdec.ptr7 = getelementptr inbounds double, double* %20, i32 1
  store double* %incdec.ptr7, double** %pv, align 8
  store double %19, double* %20, align 8
  %b = getelementptr inbounds %struct._GimpRGB, %struct._GimpRGB* %color, i32 0, i32 2
  %21 = load double, double* %b, align 8
  %22 = load double*, double** %pv, align 8
  %incdec.ptr8 = getelementptr inbounds double, double* %22, i32 1
  store double* %incdec.ptr8, double** %pv, align 8
  store double %21, double* %22, align 8
  %a = getelementptr inbounds %struct._GimpRGB, %struct._GimpRGB* %color, i32 0, i32 3
  %23 = load double, double* %a, align 8
  %24 = load double*, double** %pv, align 8
  %incdec.ptr9 = getelementptr inbounds double, double* %24, i32 1
  store double* %incdec.ptr9, double** %pv, align 8
  store double %23, double* %24, align 8
  %25 = load double, double* %delta, align 8
  %26 = load double, double* %pos, align 8
  %add = fadd double %26, %25
  store double %add, double* %pos, align 8
  br label %while.cond

while.end:                                        ; preds = %while.cond
  %27 = load double*, double** %values, align 8
  %28 = bitcast double* %27 to i8*
  %29 = load %struct._GimpPdbDialog*, %struct._GimpPdbDialog** %dialog.addr, align 8
  %30 = bitcast %struct._GimpPdbDialog* %29 to %struct._GTypeInstance*
  %call10 = call i64 @gimp_gradient_select_get_type() #5
  %call11 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %30, i64 %call10)
  %31 = bitcast %struct._GTypeInstance* %call11 to %struct._GimpGradientSelect*
  %sample_size12 = getelementptr inbounds %struct._GimpGradientSelect, %struct._GimpGradientSelect* %31, i32 0, i32 1
  %32 = load i32, i32* %sample_size12, align 4
  %mul13 = mul nsw i32 %32, 4
  %conv14 = sext i32 %mul13 to i64
  %mul15 = mul i64 %conv14, 8
  %call16 = call %struct._GimpArray* @gimp_array_new(i8* %28, i64 %mul15, i32 1)
  store %struct._GimpArray* %call16, %struct._GimpArray** %array, align 8
  %33 = load %struct._GimpArray*, %struct._GimpArray** %array, align 8
  %static_data = getelementptr inbounds %struct._GimpArray, %struct._GimpArray* %33, i32 0, i32 2
  store i32 0, i32* %static_data, align 4
  %34 = load %struct._GimpPdbDialog*, %struct._GimpPdbDialog** %dialog.addr, align 8
  %pdb = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %34, i32 0, i32 1
  %35 = load %struct._GimpPDB*, %struct._GimpPDB** %pdb, align 8
  %36 = load %struct._GimpPdbDialog*, %struct._GimpPdbDialog** %dialog.addr, align 8
  %caller_context17 = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %36, i32 0, i32 2
  %37 = load %struct._GimpContext*, %struct._GimpContext** %caller_context17, align 8
  %38 = load %struct._GError**, %struct._GError*** %error.addr, align 8
  %39 = load %struct._GimpPdbDialog*, %struct._GimpPdbDialog** %dialog.addr, align 8
  %callback_name = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %39, i32 0, i32 6
  %40 = load i8*, i8** %callback_name, align 8
  %41 = load %struct._GimpObject*, %struct._GimpObject** %object.addr, align 8
  %42 = bitcast %struct._GimpObject* %41 to i8*
  %call18 = call i8* @gimp_object_get_name(i8* %42)
  %call19 = call i64 @gimp_int32_get_type() #5
  %43 = load %struct._GimpArray*, %struct._GimpArray** %array, align 8
  %length = getelementptr inbounds %struct._GimpArray, %struct._GimpArray* %43, i32 0, i32 1
  %44 = load i64, i64* %length, align 8
  %div20 = udiv i64 %44, 8
  %call21 = call i64 @gimp_float_array_get_type() #5
  %45 = load %struct._GimpArray*, %struct._GimpArray** %array, align 8
  %call22 = call i64 @gimp_int32_get_type() #5
  %46 = load i32, i32* %closing.addr, align 4
  %call23 = call %struct._GValueArray* (%struct._GimpPDB*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GError**, i8*, ...) @gimp_pdb_execute_procedure_by_name(%struct._GimpPDB* %35, %struct._GimpContext* %37, %struct._GimpProgress* null, %struct._GError** %38, i8* %40, i64 64, i8* %call18, i64 %call19, i64 %div20, i64 %call21, %struct._GimpArray* %45, i64 %call22, i32 %46, i64 4)
  store %struct._GValueArray* %call23, %struct._GValueArray** %return_vals, align 8
  %47 = load %struct._GimpArray*, %struct._GimpArray** %array, align 8
  call void @gimp_array_free(%struct._GimpArray* %47)
...
; Function Attrs: nounwind readnone
declare i64 @gimp_float_array_get_type() #2
