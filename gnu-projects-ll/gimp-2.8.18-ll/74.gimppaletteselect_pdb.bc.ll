; ModuleID = './libgimp/gimppaletteselect_pdb.bc'
...
@.str.1 = private unnamed_addr constant [26 x i8] c"gimp-palettes-close-popup\00", align 1
@.str.2 = private unnamed_addr constant [24 x i8] c"gimp-palettes-set-popup\00", align 1

; Function Attrs: nounwind uwtable
define i32 @gimp_palettes_popup(i8* %palette_callback, i8* %popup_title, i8* %initial_palette) #0 {
entry:
  %palette_callback.addr = alloca i8*, align 8
  %popup_title.addr = alloca i8*, align 8
  %initial_palette.addr = alloca i8*, align 8
  ...
  store i8* %initial_palette, i8** %initial_palette.addr, align 8
  store i32 1, i32* %success, align 4
  %0 = load i8*, i8** %palette_callback.addr, align 8
  %1 = load i8*, i8** %popup_title.addr, align 8
  %2 = load i8*, i8** %initial_palette.addr, align 8
...
; Function Attrs: nounwind uwtable
define i32 @gimp_palettes_close_popup(i8* %palette_callback) #0 {
entry:
  %palette_callback.addr = alloca i8*, align 8
  %return_vals = alloca %struct._GimpParam*, align 8
  %nreturn_vals = alloca i32, align 4
...
; Function Attrs: nounwind uwtable
define i32 @gimp_palettes_set_popup(i8* %palette_callback, i8* %palette_name) #0 {
entry:
  %palette_callback.addr = alloca i8*, align 8
