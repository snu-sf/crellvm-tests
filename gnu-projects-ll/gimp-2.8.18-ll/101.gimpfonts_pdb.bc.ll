; ModuleID = './libgimp/gimpfonts_pdb.bc'
...
@.str.1 = private unnamed_addr constant [20 x i8] c"gimp-fonts-get-list\00", align 1

; Function Attrs: nounwind uwtable
define i32 @gimp_fonts_refresh() #0 {
entry:
  %return_vals = alloca %struct._GimpParam*, align 8
  %nreturn_vals = alloca i32, align 4
  %success = alloca i32, align 4
  store i32 1, i32* %success, align 4
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str, i32 0, i32 0), i32* %nreturn_vals, i32 22)
...
; Function Attrs: nounwind uwtable
define i8** @gimp_fonts_get_list(i8* %filter, i32* %num_fonts) #0 {
entry:
  %filter.addr = alloca i8*, align 8
  %num_fonts.addr = alloca i32*, align 8
  %return_vals = alloca %struct._GimpParam*, align 8
  %nreturn_vals = alloca i32, align 4
  %font_list = alloca i8**, align 8
  %i = alloca i32, align 4
  store i8* %filter, i8** %filter.addr, align 8
  store i32* %num_fonts, i32** %num_fonts.addr, align 8
  store i8** null, i8*** %font_list, align 8
  %0 = load i8*, i8** %filter.addr, align 8
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
  %1 = load i32*, i32** %num_fonts.addr, align 8
...
if.then:                                          ; preds = %entry
  ...
  %6 = load i32*, i32** %num_fonts.addr, align 8
  store i32 %5, i32* %6, align 4
  %7 = load i32*, i32** %num_fonts.addr, align 8
  %8 = load i32, i32* %7, align 4
  %conv = sext i32 %8 to i64
  %call3 = call noalias i8* @g_malloc_n(i64 %conv, i64 8)
  %9 = bitcast i8* %call3 to i8**
  store i8** %9, i8*** %font_list, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond

for.cond:                                         ; preds = %for.inc, %if.then
  %10 = load i32, i32* %i, align 4
  %11 = load i32*, i32** %num_fonts.addr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %18 = load i8**, i8*** %font_list, align 8
...
if.end:                                           ; preds = %for.end, %entry
  ...
  %22 = load i8**, i8*** %font_list, align 8
  ret i8** %22
}
