; ModuleID = './plug-ins/imagemap/imap_cmd_select.bc'
...
%struct.SelectCommand_t = type { %struct.Command_t, %struct.Object_t* }

@.str = private unnamed_addr constant [7 x i8] c"Select\00", align 1
@select_command_class = internal global %struct.CommandClass_t { void (%struct.Command_t*)* @select_command_destruct, i32 (%struct.Command_t*)* @select_command_execute, void (%struct.Command_t*)* @select_command_undo, void (%struct.Command_t*)* null }, align 8

; Function Attrs: nounwind uwtable
define %struct.Command_t* @select_command_new(%struct.Object_t* %obj) #0 {
entry:
  %obj.addr = alloca %struct.Object_t*, align 8
  %command = alloca %struct.SelectCommand_t*, align 8
  store %struct.Object_t* %obj, %struct.Object_t** %obj.addr, align 8
  %call = call noalias i8* @g_malloc_n(i64 1, i64 40)
  %0 = bitcast i8* %call to %struct.SelectCommand_t*
  store %struct.SelectCommand_t* %0, %struct.SelectCommand_t** %command, align 8
  %1 = load %struct.Object_t*, %struct.Object_t** %obj.addr, align 8
  %call1 = call %struct.Object_t* @object_ref(%struct.Object_t* %1)
  %2 = load %struct.SelectCommand_t*, %struct.SelectCommand_t** %command, align 8
  %obj2 = getelementptr inbounds %struct.SelectCommand_t, %struct.SelectCommand_t* %2, i32 0, i32 1
  store %struct.Object_t* %call1, %struct.Object_t** %obj2, align 8
  %3 = load %struct.SelectCommand_t*, %struct.SelectCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.SelectCommand_t, %struct.SelectCommand_t* %3, i32 0, i32 0
  %call3 = call i8* @gettext(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0)) #3
  %call4 = call %struct.Command_t* @command_init(%struct.Command_t* %parent, i8* %call3, %struct.CommandClass_t* @select_command_class)
...
; Function Attrs: nounwind uwtable
define internal void @select_command_destruct(%struct.Command_t* %parent) #0 {
entry:
  ...
  %1 = bitcast %struct.Command_t* %0 to %struct.SelectCommand_t*
  store %struct.SelectCommand_t* %1, %struct.SelectCommand_t** %command, align 8
  %2 = load %struct.SelectCommand_t*, %struct.SelectCommand_t** %command, align 8
  %obj = getelementptr inbounds %struct.SelectCommand_t, %struct.SelectCommand_t* %2, i32 0, i32 1
...
; Function Attrs: nounwind uwtable
define internal i32 @select_command_execute(%struct.Command_t* %parent) #0 {
entry:
  %parent.addr = alloca %struct.Command_t*, align 8
  %command = alloca %struct.SelectCommand_t*, align 8
  store %struct.Command_t* %parent, %struct.Command_t** %parent.addr, align 8
...
; Function Attrs: nounwind uwtable
define internal void @select_command_undo(%struct.Command_t* %parent) #0 {
entry:
  %parent.addr = alloca %struct.Command_t*, align 8
  %command = alloca %struct.SelectCommand_t*, align 8
  store %struct.Command_t* %parent, %struct.Command_t** %parent.addr, align 8
