; ModuleID = './app/tools/gimppenciltool.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpPencilToolClass = type { %struct._GimpPaintbrushToolClass }
...
%struct._GimpPencilTool = type { %struct._GimpPaintbrushTool }
...
@gimp_pencil_tool_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [15 x i8] c"GimpPencilTool\00", align 1
@.str.1 = private unnamed_addr constant [17 x i8] c"gimp-pencil-tool\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"Pencil\00", align 1
@.str.3 = private unnamed_addr constant [46 x i8] c"Pencil Tool: Hard edge painting using a brush\00", align 1
@.str.4 = private unnamed_addr constant [8 x i8] c"Pe_ncil\00", align 1
@.str.5 = private unnamed_addr constant [2 x i8] c"N\00", align 1
@.str.6 = private unnamed_addr constant [17 x i8] c"gimp-tool-pencil\00", align 1
@gimp_pencil_tool_parent_class = internal global i8* null, align 8
@GimpPencilTool_private_offset = internal global i32 0, align 4

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_pencil_tool_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_pencil_tool_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_pencil_tool_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 304, void (i8*, i8*)* bitcast (void (i8*)* @gimp_pencil_tool_class_intern_init to void (i8*, i8*)*), i32 360, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpPencilTool*)* @gimp_pencil_tool_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_pencil_tool_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_pencil_tool_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_pencil_tool_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_pencil_tool_parent_class, align 8
  %1 = load i32, i32* @GimpPencilTool_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpPencilTool_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpPencilToolClass*
  call void @gimp_pencil_tool_class_init(%struct._GimpPencilToolClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_pencil_tool_init(%struct._GimpPencilTool* %pencil) #3 {
entry:
  %pencil.addr = alloca %struct._GimpPencilTool*, align 8
  %tool = alloca %struct._GimpTool*, align 8
  store %struct._GimpPencilTool* %pencil, %struct._GimpPencilTool** %pencil.addr, align 8
  %0 = load %struct._GimpPencilTool*, %struct._GimpPencilTool** %pencil.addr, align 8
  %1 = bitcast %struct._GimpPencilTool* %0 to %struct._GTypeInstance*
  ...
  call void @gimp_tool_control_set_tool_cursor(%struct._GimpToolControl* %4, i32 24)
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @gimp_pencil_tool_register(void (i64, i64, %struct._GtkWidget* (%struct._GimpToolOptions*)*, i32, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*)* %callback, i8* %data) #3 {
entry:
  ...
  %call = call i64 @gimp_pencil_tool_get_type() #5
...
; Function Attrs: nounwind uwtable
define internal void @gimp_pencil_tool_class_init(%struct._GimpPencilToolClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpPencilToolClass*, align 8
  store %struct._GimpPencilToolClass* %klass, %struct._GimpPencilToolClass** %klass.addr, align 8
  ret void
}
