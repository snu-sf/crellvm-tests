; ModuleID = './libgimp/gimphelp_pdb.bc'
...
define i32 @gimp_help(i8* %help_domain, i8* %help_id) #0 {
entry:
  ...
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 4, i8* %1, i32 22)
