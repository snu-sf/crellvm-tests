; ModuleID = './app/widgets/gimppaletteselect.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpPaletteSelectClass = type { %struct._GimpPdbDialogClass }
...
%struct._GimpPaletteSelect = type { %struct._GimpPdbDialog }
...
@gimp_palette_select_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [18 x i8] c"GimpPaletteSelect\00", align 1
@gimp_palette_select_parent_class = internal global i8* null, align 8
@GimpPaletteSelect_private_offset = internal global i32 0, align 4
@.str.1 = private unnamed_addr constant [11 x i8] c"<Palettes>\00", align 1
@.str.2 = private unnamed_addr constant [16 x i8] c"/palettes-popup\00", align 1
@.str.3 = private unnamed_addr constant [9 x i8] c"palettes\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_palette_select_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_palette_select_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_palette_select_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 1000, void (i8*, i8*)* bitcast (void (i8*)* @gimp_palette_select_class_intern_init to void (i8*, i8*)*), i32 336, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpPaletteSelect*)* @gimp_palette_select_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_palette_select_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_palette_select_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_palette_select_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_palette_select_parent_class, align 8
  %1 = load i32, i32* @GimpPaletteSelect_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpPaletteSelect_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpPaletteSelectClass*
  call void @gimp_palette_select_class_init(%struct._GimpPaletteSelectClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_palette_select_init(%struct._GimpPaletteSelect* %dialog) #3 {
entry:
  %dialog.addr = alloca %struct._GimpPaletteSelect*, align 8
  store %struct._GimpPaletteSelect* %dialog, %struct._GimpPaletteSelect** %dialog.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_palette_select_class_init(%struct._GimpPaletteSelectClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpPaletteSelectClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  %pdb_class = alloca %struct._GimpPdbDialogClass*, align 8
  store %struct._GimpPaletteSelectClass* %klass, %struct._GimpPaletteSelectClass** %klass.addr, align 8
  %0 = load %struct._GimpPaletteSelectClass*, %struct._GimpPaletteSelectClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpPaletteSelectClass* %0 to %struct._GTypeClass*
  %call = call %struct._GTypeClass* @g_type_check_class_cast(%struct._GTypeClass* %1, i64 80)
  %2 = bitcast %struct._GTypeClass* %call to %struct._GObjectClass*
  store %struct._GObjectClass* %2, %struct._GObjectClass** %object_class, align 8
  %3 = load %struct._GimpPaletteSelectClass*, %struct._GimpPaletteSelectClass** %klass.addr, align 8
  %4 = bitcast %struct._GimpPaletteSelectClass* %3 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*)* @gimp_palette_select_constructed, void (%struct._GObject*)** %constructed, align 8
  ...
  store %struct._GValueArray* (%struct._GimpPdbDialog*, %struct._GimpObject*, i32, %struct._GError**)* @gimp_palette_select_run_callback, %struct._GValueArray* (%struct._GimpPdbDialog*, %struct._GimpObject*, i32, %struct._GError**)** %run_callback, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_palette_select_constructed(%struct._GObject* %object) #3 {
entry:
  ...
  %3 = load i8*, i8** @gimp_palette_select_parent_class, align 8
...
if.then:                                          ; preds = %entry
  %7 = load i8*, i8** @gimp_palette_select_parent_class, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %palette_factory = getelementptr inbounds %struct._Gimp, %struct._Gimp* %14, i32 0, i32 41
  %15 = load %struct._GimpDataFactory*, %struct._GimpDataFactory** %palette_factory, align 8
  ...
  %call6 = call %struct._GtkWidget* @gimp_data_factory_view_new(i32 0, %struct._GimpDataFactory* %15, %struct._GimpContext* %17, i32 32, i32 1, %struct._GimpMenuFactory* %19, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0))
  ...
  call void @gimp_container_box_set_size_request(%struct._GimpContainerBox* %27, i32 170, i32 272)
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @gimp_palette_select_run_callback(%struct._GimpPdbDialog* %dialog, %struct._GimpObject* %object, i32 %closing, %struct._GError** %error) #3 {
entry:
  ...
  %pdb = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %3, i32 0, i32 1
  %4 = load %struct._GimpPDB*, %struct._GimpPDB** %pdb, align 8
  %5 = load %struct._GimpPdbDialog*, %struct._GimpPdbDialog** %dialog.addr, align 8
  %caller_context = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %5, i32 0, i32 2
  %6 = load %struct._GimpContext*, %struct._GimpContext** %caller_context, align 8
  ...
  %callback_name = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %8, i32 0, i32 6
  %9 = load i8*, i8** %callback_name, align 8
  %10 = load %struct._GimpObject*, %struct._GimpObject** %object.addr, align 8
  %11 = bitcast %struct._GimpObject* %10 to i8*
  %call2 = call i8* @gimp_object_get_name(i8* %11)
  %call3 = call i64 @gimp_int32_get_type() #4
  %12 = load %struct._GimpPalette*, %struct._GimpPalette** %palette, align 8
  %call4 = call i32 @gimp_palette_get_n_colors(%struct._GimpPalette* %12)
  %call5 = call i64 @gimp_int32_get_type() #4
  %13 = load i32, i32* %closing.addr, align 4
  %call6 = call %struct._GValueArray* (%struct._GimpPDB*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GError**, i8*, ...) @gimp_pdb_execute_procedure_by_name(%struct._GimpPDB* %4, %struct._GimpContext* %6, %struct._GimpProgress* null, %struct._GError** %7, i8* %9, i64 64, i8* %call2, i64 %call3, i32 %call4, i64 %call5, i32 %13, i64 4)
