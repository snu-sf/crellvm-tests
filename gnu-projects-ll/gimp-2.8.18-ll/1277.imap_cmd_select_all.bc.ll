; ModuleID = './plug-ins/imagemap/imap_cmd_select_all.bc'
...
%struct.SelectAllCommand_t = type { %struct.Command_t, %struct.ObjectList_t* }
...
@select_all_command_class = internal global %struct.CommandClass_t { void (%struct.Command_t*)* null, i32 (%struct.Command_t*)* @select_all_command_execute, void (%struct.Command_t*)* null, void (%struct.Command_t*)* null }, align 8

; Function Attrs: nounwind uwtable
define %struct.Command_t* @select_all_command_new(%struct.ObjectList_t* %list) #0 {
entry:
  %list.addr = alloca %struct.ObjectList_t*, align 8
  %command = alloca %struct.SelectAllCommand_t*, align 8
  store %struct.ObjectList_t* %list, %struct.ObjectList_t** %list.addr, align 8
  %call = call noalias i8* @g_malloc_n(i64 1, i64 40)
  %0 = bitcast i8* %call to %struct.SelectAllCommand_t*
  store %struct.SelectAllCommand_t* %0, %struct.SelectAllCommand_t** %command, align 8
  %1 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list.addr, align 8
  %2 = load %struct.SelectAllCommand_t*, %struct.SelectAllCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.SelectAllCommand_t, %struct.SelectAllCommand_t* %2, i32 0, i32 1
  store %struct.ObjectList_t* %1, %struct.ObjectList_t** %list1, align 8
  %3 = load %struct.SelectAllCommand_t*, %struct.SelectAllCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.SelectAllCommand_t, %struct.SelectAllCommand_t* %3, i32 0, i32 0
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0)) #3
  %call3 = call %struct.Command_t* @command_init(%struct.Command_t* %parent, i8* %call2, %struct.CommandClass_t* @select_all_command_class)
...
; Function Attrs: nounwind uwtable
define internal i32 @select_all_command_execute(%struct.Command_t* %parent) #0 {
entry:
  ...
  %1 = bitcast %struct.Command_t* %0 to %struct.SelectAllCommand_t*
  store %struct.SelectAllCommand_t* %1, %struct.SelectAllCommand_t** %command, align 8
  %2 = load %struct.SelectAllCommand_t*, %struct.SelectAllCommand_t** %command, align 8
  %list = getelementptr inbounds %struct.SelectAllCommand_t, %struct.SelectAllCommand_t* %2, i32 0, i32 1
  %3 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list, align 8
  %4 = load %struct.SelectAllCommand_t*, %struct.SelectAllCommand_t** %command, align 8
  %5 = bitcast %struct.SelectAllCommand_t* %4 to i8*
  ...
  %6 = load %struct.SelectAllCommand_t*, %struct.SelectAllCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.SelectAllCommand_t, %struct.SelectAllCommand_t* %6, i32 0, i32 1
  %7 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list1, align 8
  %call2 = call i32 @object_list_select_all(%struct.ObjectList_t* %7)
  %tobool = icmp ne i32 %call2, 0
  %cond = select i1 %tobool, i32 0, i32 1
  store i32 %cond, i32* %rvalue, align 4
  %8 = load %struct.SelectAllCommand_t*, %struct.SelectAllCommand_t** %command, align 8
  %list3 = getelementptr inbounds %struct.SelectAllCommand_t, %struct.SelectAllCommand_t* %8, i32 0, i32 1
  %9 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list3, align 8
  %10 = load i8*, i8** %id, align 8
  call void @object_list_remove_select_cb(%struct.ObjectList_t* %9, i8* %10)
  %11 = load i32, i32* %rvalue, align 4
  ret i32 %11
}
...
entry:
  ...
  %1 = bitcast i8* %0 to %struct.SelectAllCommand_t*
  store %struct.SelectAllCommand_t* %1, %struct.SelectAllCommand_t** %command, align 8
  %2 = load %struct.SelectAllCommand_t*, %struct.SelectAllCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.SelectAllCommand_t, %struct.SelectAllCommand_t* %2, i32 0, i32 0
...
declare i32 @object_list_select_all(%struct.ObjectList_t*) #1
