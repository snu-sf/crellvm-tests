; ModuleID = './app/core/gimpitemundo.bc'
...
@gimp_item_undo_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [13 x i8] c"GimpItemUndo\00", align 1
@gimp_item_undo_parent_class = internal global i8* null, align 8
@GimpItemUndo_private_offset = internal global i32 0, align 4
@.str.1 = private unnamed_addr constant [5 x i8] c"item\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c"Gimp-Core\00", align 1
@.str.3 = private unnamed_addr constant [15 x i8] c"gimpitemundo.c\00", align 1
@__func__.gimp_item_undo_constructed = private unnamed_addr constant [27 x i8] c"gimp_item_undo_constructed\00", align 1
@.str.4 = private unnamed_addr constant [31 x i8] c"GIMP_IS_ITEM (item_undo->item)\00", align 1
...
define i64 @gimp_item_undo_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_item_undo_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_item_undo_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 296, void (i8*, i8*)* bitcast (void (i8*)* @gimp_item_undo_class_intern_init to void (i8*, i8*)*), i32 80, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpItemUndo*)* @gimp_item_undo_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_item_undo_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_item_undo_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_item_undo_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_item_undo_parent_class, align 8
  %1 = load i32, i32* @GimpItemUndo_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpItemUndo_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpItemUndoClass*
  call void @gimp_item_undo_class_init(%struct._GimpItemUndoClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_item_undo_init(%struct._GimpItemUndo* %undo) #3 {
entry:
  %undo.addr = alloca %struct._GimpItemUndo*, align 8
  store %struct._GimpItemUndo* %undo, %struct._GimpItemUndo** %undo.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_item_undo_class_init(%struct._GimpItemUndoClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpItemUndoClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  %undo_class = alloca %struct._GimpUndoClass*, align 8
  store %struct._GimpItemUndoClass* %klass, %struct._GimpItemUndoClass** %klass.addr, align 8
  %0 = load %struct._GimpItemUndoClass*, %struct._GimpItemUndoClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpItemUndoClass* %0 to %struct._GTypeClass*
  %call = call %struct._GTypeClass* @g_type_check_class_cast(%struct._GTypeClass* %1, i64 80)
  %2 = bitcast %struct._GTypeClass* %call to %struct._GObjectClass*
  store %struct._GObjectClass* %2, %struct._GObjectClass** %object_class, align 8
  %3 = load %struct._GimpItemUndoClass*, %struct._GimpItemUndoClass** %klass.addr, align 8
  %4 = bitcast %struct._GimpItemUndoClass* %3 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*)* @gimp_item_undo_constructed, void (%struct._GObject*)** %constructed, align 8
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %set_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %7, i32 0, i32 3
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_item_undo_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %8 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %8, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_item_undo_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %9 = load %struct._GimpUndoClass*, %struct._GimpUndoClass** %undo_class, align 8
  %free = getelementptr inbounds %struct._GimpUndoClass, %struct._GimpUndoClass* %9, i32 0, i32 2
  store void (%struct._GimpUndo*, i32)* @gimp_item_undo_free, void (%struct._GimpUndo*, i32)** %free, align 8
  %10 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call i64 @gimp_item_get_type() #7
  %call4 = call %struct._GParamSpec* @g_param_spec_object(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i8* null, i8* null, i64 %call3, i32 235)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_item_undo_constructed(%struct._GObject* %object) #3 {
entry:
  ...
  %3 = load i8*, i8** @gimp_item_undo_parent_class, align 8
...
if.then:                                          ; preds = %entry
  %7 = load i8*, i8** @gimp_item_undo_parent_class, align 8
...
do.body:                                          ; preds = %if.end
  %12 = load %struct._GimpItemUndo*, %struct._GimpItemUndo** %item_undo, align 8
...
; Function Attrs: nounwind uwtable
define internal void @gimp_item_undo_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = bitcast i8* %call2 to %struct._GimpItem*
  %6 = load %struct._GimpItemUndo*, %struct._GimpItemUndo** %item_undo, align 8
  %item = getelementptr inbounds %struct._GimpItemUndo, %struct._GimpItemUndo* %6, i32 0, i32 1
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0), i32 105, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0), i32 %10, i8* %12, i8* %call3, i8* %call6)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_item_undo_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0), i32 125, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0), i32 %11, i8* %13, i8* %call2, i8* %call5)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_item_undo_free(%struct._GimpUndo* %undo, i32 %undo_mode) #3 {
entry:
...
if.then:                                          ; preds = %entry
  %5 = load %struct._GimpItemUndo*, %struct._GimpItemUndo** %item_undo, align 8
  %item2 = getelementptr inbounds %struct._GimpItemUndo, %struct._GimpItemUndo* %5, i32 0, i32 1
  %6 = load %struct._GimpItem*, %struct._GimpItem** %item2, align 8
  %7 = bitcast %struct._GimpItem* %6 to i8*
  call void @g_object_unref(i8* %7)
  %8 = load %struct._GimpItemUndo*, %struct._GimpItemUndo** %item_undo, align 8
  %item3 = getelementptr inbounds %struct._GimpItemUndo, %struct._GimpItemUndo* %8, i32 0, i32 1
  store %struct._GimpItem* null, %struct._GimpItem** %item3, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %9 = load i8*, i8** @gimp_item_undo_parent_class, align 8
