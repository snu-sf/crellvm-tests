; ModuleID = './app/pdb/dynamics-cmds.bc'
...
@.str.1 = private unnamed_addr constant [63 x i8] c"Refresh current paint dynamics. This function always succeeds.\00", align 1
@.str.2 = private unnamed_addr constant [140 x i8] c"This procedure retrieves all paint dynamics currently in the user's paint dynamics path and updates the paint dynamics dialogs accordingly.\00", align 1
...
@.str.5 = private unnamed_addr constant [5 x i8] c"2011\00", align 1
@.str.6 = private unnamed_addr constant [23 x i8] c"gimp-dynamics-get-list\00", align 1
@.str.7 = private unnamed_addr constant [44 x i8] c"Retrieve the list of loaded paint dynamics.\00", align 1
@.str.8 = private unnamed_addr constant [82 x i8] c"This procedure returns a list of the paint dynamics that are currently available.\00", align 1
...
@.str.11 = private unnamed_addr constant [13 x i8] c"num-dynamics\00", align 1
@.str.12 = private unnamed_addr constant [13 x i8] c"num dynamics\00", align 1
@.str.13 = private unnamed_addr constant [39 x i8] c"The number of available paint dynamics\00", align 1
@.str.14 = private unnamed_addr constant [14 x i8] c"dynamics-list\00", align 1
@.str.15 = private unnamed_addr constant [14 x i8] c"dynamics list\00", align 1
@.str.16 = private unnamed_addr constant [33 x i8] c"The list of paint dynamics names\00", align 1

; Function Attrs: nounwind uwtable
define void @register_dynamics_procs(%struct._GimpPDB* %pdb) #0 {
entry:
  ...
  %call = call %struct._GimpProcedure* @gimp_procedure_new(%struct._GValueArray* (%struct._GimpProcedure*, %struct._Gimp*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GValueArray*, %struct._GError**)* @dynamics_refresh_invoker)
  ...
  %call3 = call %struct._GimpProcedure* @gimp_procedure_new(%struct._GValueArray* (%struct._GimpProcedure*, %struct._Gimp*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GValueArray*, %struct._GError**)* @dynamics_get_list_invoker)
  ...
  %call7 = call %struct._GParamSpec* @gimp_param_spec_int32(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.11, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.12, i32 0, i32 0), i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.13, i32 0, i32 0), i32 0, i32 2147483647, i32 0, i32 227)
  ...
  %call8 = call %struct._GParamSpec* @gimp_param_spec_string_array(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.14, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.15, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.16, i32 0, i32 0), i32 227)
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @dynamics_refresh_invoker(%struct._GimpProcedure* %procedure, %struct._Gimp* %gimp, %struct._GimpContext* %context, %struct._GimpProgress* %progress, %struct._GValueArray* %args, %struct._GError** %error) #0 {
entry:
  ...
  %dynamics_factory = getelementptr inbounds %struct._Gimp, %struct._Gimp* %0, i32 0, i32 38
  %1 = load %struct._GimpDataFactory*, %struct._GimpDataFactory** %dynamics_factory, align 8
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @dynamics_get_list_invoker(%struct._GimpProcedure* %procedure, %struct._Gimp* %gimp, %struct._GimpContext* %context, %struct._GimpProgress* %progress, %struct._GValueArray* %args, %struct._GError** %error) #0 {
entry:
  %procedure.addr = alloca %struct._GimpProcedure*, align 8
  %gimp.addr = alloca %struct._Gimp*, align 8
  %context.addr = alloca %struct._GimpContext*, align 8
  ...
  %num_dynamics = alloca i32, align 4
  ...
  store i32 0, i32* %num_dynamics, align 4
...
if.then:                                          ; preds = %entry
  ...
  %dynamics_factory = getelementptr inbounds %struct._Gimp, %struct._Gimp* %3, i32 0, i32 38
  %4 = load %struct._GimpDataFactory*, %struct._GimpDataFactory** %dynamics_factory, align 8
  %call1 = call %struct._GimpContainer* @gimp_data_factory_get_container(%struct._GimpDataFactory* %4)
  %5 = load i8*, i8** %filter, align 8
  %call2 = call i8** @gimp_container_get_filtered_name_array(%struct._GimpContainer* %call1, i8* %5, i32* %num_dynamics)
  store i8** %call2, i8*** %dynamics_list, align 8
  br label %if.end
...
if.then.6:                                        ; preds = %cond.end
  ...
  %14 = load i32, i32* %num_dynamics, align 4
  ...
  %17 = load i8**, i8*** %dynamics_list, align 8
  %18 = load i32, i32* %num_dynamics, align 4
