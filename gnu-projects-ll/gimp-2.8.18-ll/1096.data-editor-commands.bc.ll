; ModuleID = './app/actions/data-editor-commands.bc'
...
define void @data_editor_edit_active_cmd_callback(%struct._GtkAction* %action, i8* %data) #0 {
entry:
  ...
  store i32 %call4, i32* %edit_active, align 4
  %6 = load %struct._GimpDataEditor*, %struct._GimpDataEditor** %editor, align 8
  %7 = load i32, i32* %edit_active, align 4
  call void @gimp_data_editor_set_edit_active(%struct._GimpDataEditor* %6, i32 %7)
  ret void
}
...
declare void @gimp_data_editor_set_edit_active(%struct._GimpDataEditor*, i32) #1
