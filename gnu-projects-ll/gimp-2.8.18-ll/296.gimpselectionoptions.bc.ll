; ModuleID = './app/tools/gimpselectionoptions.bc'
...
@gimp_selection_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [21 x i8] c"GimpSelectionOptions\00", align 1
...
@.str.3 = private unnamed_addr constant [15 x i8] c"gimp-selection\00", align 1
@.str.4 = private unnamed_addr constant [14 x i8] c"%s  <b>%s</b>\00", align 1
@.str.5 = private unnamed_addr constant [10 x i8] c"antialias\00", align 1
@.str.6 = private unnamed_addr constant [13 x i8] c"Antialiasing\00", align 1
@.str.7 = private unnamed_addr constant [15 x i8] c"feather-radius\00", align 1
@.str.8 = private unnamed_addr constant [7 x i8] c"Radius\00", align 1
@.str.9 = private unnamed_addr constant [8 x i8] c"feather\00", align 1
@.str.10 = private unnamed_addr constant [14 x i8] c"Feather edges\00", align 1
@gimp_selection_options_parent_class = internal global i8* null, align 8
@GimpSelectionOptions_private_offset = internal global i32 0, align 4
@.str.11 = private unnamed_addr constant [13 x i8] c"Smooth edges\00", align 1
@.str.12 = private unnamed_addr constant [37 x i8] c"Enable feathering of selection edges\00", align 1
@.str.13 = private unnamed_addr constant [21 x i8] c"Radius of feathering\00", align 1
@.str.14 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.15 = private unnamed_addr constant [23 x i8] c"gimpselectionoptions.c\00", align 1
@.str.16 = private unnamed_addr constant [9 x i8] c"property\00", align 1
@.str.17 = private unnamed_addr constant [11 x i8] c"Gimp-Tools\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_selection_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_selection_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_selection_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_selection_options_class_intern_init to void (i8*, i8*)*), i32 384, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpSelectionOptions*)* @gimp_selection_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_selection_options_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_selection_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_selection_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_selection_options_parent_class, align 8
  %1 = load i32, i32* @GimpSelectionOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpSelectionOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpToolOptionsClass*
  call void @gimp_selection_options_class_init(%struct._GimpToolOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_selection_options_init(%struct._GimpSelectionOptions* %options) #3 {
entry:
  %options.addr = alloca %struct._GimpSelectionOptions*, align 8
  store %struct._GimpSelectionOptions* %options, %struct._GimpSelectionOptions** %options.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_selection_options_gui(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  ...
  %button17 = alloca %struct._GtkWidget*, align 8
  %modifier = alloca i8*, align 8
  ...
  %call1 = call i64 @gimp_selection_options_get_type() #6
  %call2 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %4, i64 %call1)
  %5 = bitcast %struct._GTypeInstance* %call2 to %struct._GimpSelectionOptions*
  store %struct._GimpSelectionOptions* %5, %struct._GimpSelectionOptions** %options, align 8
  ...
  store %struct._GtkWidget* %call4, %struct._GtkWidget** %hbox, align 8
  ...
  %call7 = call i8* @gettext(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0)) #5
  ...
  %call11 = call %struct._GtkWidget* @gimp_prop_enum_stock_box_new(%struct._GObject* %17, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0), i32 0, i32 0)
  store %struct._GtkWidget* %call11, %struct._GtkWidget** %box, align 8
  ...
  %20 = bitcast %struct._GTypeInstance* %call13 to %struct._GtkBox*
  ...
  %22 = load %struct._GtkWidget*, %struct._GtkWidget** %box, align 8
  call void @gtk_widget_show(%struct._GtkWidget* %22)
  %23 = load %struct._GtkWidget*, %struct._GtkWidget** %box, align 8
  ...
  %call16 = call %struct._GList* @gtk_container_get_children(%struct._GtkContainer* %25)
  store %struct._GList* %call16, %struct._GList** %children, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %30 = bitcast i8* %29 to %struct._GtkWidget*
  store %struct._GtkWidget* %30, %struct._GtkWidget** %button17, align 8
  %31 = load i32, i32* %i, align 4
  %call18 = call i8* @gimp_selection_options_get_modifiers(i32 %31)
  store i8* %call18, i8** %modifier, align 8
  %32 = load i8*, i8** %modifier, align 8
...
if.end:                                           ; preds = %for.body
  %33 = load %struct._GtkWidget*, %struct._GtkWidget** %button17, align 8
  %call20 = call i8* @gtk_widget_get_tooltip_text(%struct._GtkWidget* %33)
...
if.then.22:                                       ; preds = %if.end
  ...
  %36 = load i8*, i8** %modifier, align 8
  %call23 = call noalias i8* (i8*, ...) @g_strdup_printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4, i32 0, i32 0), i8* %35, i8* %36)
  store i8* %call23, i8** %tip, align 8
  %37 = load %struct._GtkWidget*, %struct._GtkWidget** %button17, align 8
  %38 = load i8*, i8** %tip, align 8
  call void @gimp_help_set_help_data_with_markup(%struct._GtkWidget* %37, i8* %38, i8* null)
  %39 = load i8*, i8** %tip, align 8
  call void @g_free(i8* %39)
  %40 = load i8*, i8** %tooltip, align 8
  call void @g_free(i8* %40)
  br label %if.end.24

if.else:                                          ; preds = %if.end
  %41 = load %struct._GtkWidget*, %struct._GtkWidget** %button17, align 8
  %42 = load i8*, i8** %modifier, align 8
  call void @gimp_help_set_help_data(%struct._GtkWidget* %41, i8* %42, i8* null)
  br label %if.end.24

if.end.24:                                        ; preds = %if.else, %if.then.22
  br label %for.inc

for.inc:                                          ; preds = %if.end.24, %if.then
...
for.end:                                          ; preds = %for.cond
  ...
  %48 = bitcast %struct._GTypeInstance* %call26 to %struct._GtkBox*
  %49 = load %struct._GList*, %struct._GList** %children, align 8
  %next27 = getelementptr inbounds %struct._GList, %struct._GList* %49, i32 0, i32 1
  %50 = load %struct._GList*, %struct._GList** %next27, align 8
  %next28 = getelementptr inbounds %struct._GList, %struct._GList* %50, i32 0, i32 1
  %51 = load %struct._GList*, %struct._GList** %next28, align 8
  %data29 = getelementptr inbounds %struct._GList, %struct._GList* %51, i32 0, i32 0
  %52 = load i8*, i8** %data29, align 8
  %53 = bitcast i8* %52 to %struct._GTypeInstance*
  %call30 = call i64 @gtk_widget_get_type() #6
  %call31 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %53, i64 %call30)
  %54 = bitcast %struct._GTypeInstance* %call31 to %struct._GtkWidget*
  call void @gtk_box_reorder_child(%struct._GtkBox* %48, %struct._GtkWidget* %54, i32 0)
  %55 = load %struct._GList*, %struct._GList** %children, align 8
  call void @g_list_free(%struct._GList* %55)
  %56 = load %struct._GObject*, %struct._GObject** %config, align 8
  %call32 = call i8* @gettext(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.6, i32 0, i32 0)) #5
  %call33 = call %struct._GtkWidget* @gimp_prop_check_button_new(%struct._GObject* %56, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0), i8* %call32)
  ...
  %63 = load %struct._GimpSelectionOptions*, %struct._GimpSelectionOptions** %options, align 8
  %antialias_toggle = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %63, i32 0, i32 5
  store %struct._GtkWidget* %62, %struct._GtkWidget** %antialias_toggle, align 8
  %64 = load %struct._GObject*, %struct._GObject** %config, align 8
  %call36 = call i8* @gettext(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.8, i32 0, i32 0)) #5
  %call37 = call %struct._GtkWidget* @gimp_prop_spin_scale_new(%struct._GObject* %64, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.7, i32 0, i32 0), i8* %call36, double 1.000000e+00, double 1.000000e+01, i32 1)
  store %struct._GtkWidget* %call37, %struct._GtkWidget** %scale, align 8
  %65 = load %struct._GObject*, %struct._GObject** %config, align 8
  %call38 = call i8* @gettext(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.10, i32 0, i32 0)) #5
  %66 = load %struct._GtkWidget*, %struct._GtkWidget** %scale, align 8
  %call39 = call %struct._GtkWidget* @gimp_prop_expanding_frame_new(%struct._GObject* %65, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i32 0, i32 0), i8* %call38, %struct._GtkWidget* %66, %struct._GtkWidget** null)
...
; Function Attrs: nounwind uwtable
define internal i8* @gimp_selection_options_get_modifiers(i32 %operation) #3 {
entry:
...
sw.bb:                                            ; preds = %entry
  ...
  store i32 %1, i32* %modifiers, align 4
  br label %sw.epilog

sw.bb.2:                                          ; preds = %entry
  %2 = load i32, i32* %modify_mask, align 4
  store i32 %2, i32* %modifiers, align 4
  br label %sw.epilog
...
sw.bb.4:                                          ; preds = %entry
  %3 = load i32, i32* %extend_mask, align 4
  %4 = load i32, i32* %modify_mask, align 4
  %or = or i32 %3, %4
  store i32 %or, i32* %modifiers, align 4
  br label %sw.epilog

sw.epilog:                                        ; preds = %entry, %sw.bb.4, %sw.bb.3, %sw.bb.2, %sw.bb
  %5 = load i32, i32* %modifiers, align 4
  %call5 = call i8* @gimp_get_mod_string(i32 %5)
  ret i8* %call5
}

declare i8* @gtk_widget_get_tooltip_text(%struct._GtkWidget*) #1
...
; Function Attrs: nounwind uwtable
define internal void @gimp_selection_options_class_init(%struct._GimpToolOptionsClass* %klass) #3 {
entry:
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_selection_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %4 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %4, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_selection_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %5 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call1 = call i64 @gimp_channel_ops_get_type() #6
  %call2 = call %struct._GParamSpec* @g_param_spec_enum(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i32 0, i32 0), i8* null, i8* null, i64 %call1, i32 2, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %5, i32 1, %struct._GParamSpec* %call2)
  %6 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.11, i32 0, i32 0), i32 1, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %6, i32 2, %struct._GParamSpec* %call3)
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call4 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.9, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.12, i32 0, i32 0), i32 0, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %7, i32 3, %struct._GParamSpec* %call4)
  %8 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call5 = call %struct._GParamSpec* @g_param_spec_double(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.7, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.13, i32 0, i32 0), double 0.000000e+00, double 1.000000e+02, double 1.000000e+01, i32 487)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_selection_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  ...
  %call = call i64 @gimp_selection_options_get_type() #6
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpSelectionOptions*
  store %struct._GimpSelectionOptions* %2, %struct._GimpSelectionOptions** %options, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpSelectionOptions*, %struct._GimpSelectionOptions** %options, align 8
  %operation = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %5, i32 0, i32 1
  store i32 %call2, i32* %operation, align 4
  br label %sw.epilog

sw.bb.3:                                          ; preds = %entry
  %6 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call4 = call i32 @g_value_get_boolean(%struct._GValue* %6)
  %7 = load %struct._GimpSelectionOptions*, %struct._GimpSelectionOptions** %options, align 8
  %antialias = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %7, i32 0, i32 2
  store i32 %call4, i32* %antialias, align 4
  br label %sw.epilog

sw.bb.5:                                          ; preds = %entry
  %8 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call6 = call i32 @g_value_get_boolean(%struct._GValue* %8)
  %9 = load %struct._GimpSelectionOptions*, %struct._GimpSelectionOptions** %options, align 8
  %feather = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %9, i32 0, i32 3
  store i32 %call6, i32* %feather, align 4
  br label %sw.epilog

sw.bb.7:                                          ; preds = %entry
  %10 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call8 = call double @g_value_get_double(%struct._GValue* %10)
  %11 = load %struct._GimpSelectionOptions*, %struct._GimpSelectionOptions** %options, align 8
  %feather_radius = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %11, i32 0, i32 4
  store double %call8, double* %feather_radius, align 8
  br label %sw.epilog
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.14, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.15, i32 0, i32 0), i32 127, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.16, i32 0, i32 0), i32 %15, i8* %17, i8* %call9, i8* %call12)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_selection_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpSelectionOptions*, %struct._GimpSelectionOptions** %options, align 8
  %operation = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %5, i32 0, i32 1
  %6 = load i32, i32* %operation, align 4
  call void @g_value_set_enum(%struct._GValue* %4, i32 %6)
  br label %sw.epilog

sw.bb.2:                                          ; preds = %entry
  %7 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %8 = load %struct._GimpSelectionOptions*, %struct._GimpSelectionOptions** %options, align 8
  %antialias = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %8, i32 0, i32 2
  %9 = load i32, i32* %antialias, align 4
...
sw.bb.3:                                          ; preds = %entry
  %10 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %11 = load %struct._GimpSelectionOptions*, %struct._GimpSelectionOptions** %options, align 8
  %feather = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %11, i32 0, i32 3
  %12 = load i32, i32* %feather, align 4
...
sw.bb.4:                                          ; preds = %entry
  ...
  %feather_radius = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %14, i32 0, i32 4
  %15 = load double, double* %feather_radius, align 8
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.14, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.15, i32 0, i32 0), i32 159, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.16, i32 0, i32 0), i32 %19, i8* %21, i8* %call5, i8* %call8)
  br label %do.end
...
entry:
  ...
  call void @g_logv(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.17, i32 0, i32 0), i32 16, i8* %0, %struct.__va_list_tag* %arraydecay2)
