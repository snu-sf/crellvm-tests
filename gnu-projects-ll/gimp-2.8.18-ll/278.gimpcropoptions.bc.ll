; ModuleID = './app/tools/gimpcropoptions.bc'
...
@gimp_crop_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [16 x i8] c"GimpCropOptions\00", align 1
@gimp_crop_options_get_type.g_implement_interface_info = internal constant %struct._GInterfaceInfo { void (i8*, i8*)* bitcast (void (%struct._GimpRectangleOptionsInterface*)* @gimp_crop_options_rectangle_options_iface_init to void (i8*, i8*)*), void (i8*, i8*)* null, i8* null }, align 8
@.str.1 = private unnamed_addr constant [11 x i8] c"layer-only\00", align 1
@.str.2 = private unnamed_addr constant [19 x i8] c"Current layer only\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"allow-growing\00", align 1
@.str.4 = private unnamed_addr constant [14 x i8] c"Allow growing\00", align 1
@gimp_crop_options_parent_class = internal global i8* null, align 8
@GimpCropOptions_private_offset = internal global i32 0, align 4
@.str.5 = private unnamed_addr constant [10 x i8] c"highlight\00", align 1
@.str.6 = private unnamed_addr constant [33 x i8] c"Dim everything outside selection\00", align 1
@.str.7 = private unnamed_addr constant [35 x i8] c"Crop only currently selected layer\00", align 1
@.str.8 = private unnamed_addr constant [71 x i8] c"Allow resizing canvas by dragging cropping frame beyond image boundary\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_crop_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_crop_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_crop_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_crop_options_class_intern_init to void (i8*, i8*)*), i32 360, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpCropOptions*)* @gimp_crop_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  %call8 = call i64 @gimp_rectangle_options_interface_get_type() #5
  call void @g_type_add_interface_static(i64 %5, i64 %call8, %struct._GInterfaceInfo* @gimp_crop_options_get_type.g_implement_interface_info)
  %6 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_crop_options_get_type.g_define_type_id__volatile to i8*), i64 %6)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %7 = load volatile i64, i64* @gimp_crop_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %7
}
...
define internal void @gimp_crop_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_crop_options_parent_class, align 8
  %1 = load i32, i32* @GimpCropOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpCropOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpToolOptionsClass*
  call void @gimp_crop_options_class_init(%struct._GimpToolOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_crop_options_init(%struct._GimpCropOptions* %options) #3 {
entry:
...
; Function Attrs: nounwind uwtable
define internal void @gimp_crop_options_rectangle_options_iface_init(%struct._GimpRectangleOptionsInterface* %iface) #3 {
entry:
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_crop_options_gui(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  ...
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0)) #6
  %call3 = call %struct._GtkWidget* @gimp_prop_check_button_new(%struct._GObject* %4, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i8* %call2)
  ...
  %call6 = call i8* @gettext(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4, i32 0, i32 0)) #6
  ...
  %call10 = call %struct._GtkWidget* @gimp_rectangle_options_gui(%struct._GimpToolOptions* %16)
  store %struct._GtkWidget* %call10, %struct._GtkWidget** %vbox_rectangle, align 8
  ...
  %19 = bitcast %struct._GTypeInstance* %call12 to %struct._GtkBox*
  %20 = load %struct._GtkWidget*, %struct._GtkWidget** %vbox_rectangle, align 8
  call void @gtk_box_pack_start(%struct._GtkBox* %19, %struct._GtkWidget* %20, i32 0, i32 0, i32 0)
  %21 = load %struct._GtkWidget*, %struct._GtkWidget** %vbox_rectangle, align 8
...
; Function Attrs: nounwind uwtable
define internal void @gimp_crop_options_class_init(%struct._GimpToolOptionsClass* %klass) #3 {
entry:
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_crop_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %4 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %4, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_crop_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %5 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call1 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.6, i32 0, i32 0), i32 1, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %5, i32 3, %struct._GParamSpec* %call1)
  %6 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call2 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.7, i32 0, i32 0), i32 0, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %6, i32 28, %struct._GParamSpec* %call2)
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([71 x i8], [71 x i8]* @.str.8, i32 0, i32 0), i32 0, i32 487)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_crop_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  ...
  %call = call i64 @gimp_crop_options_get_type() #5
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpCropOptions*
  store %struct._GimpCropOptions* %2, %struct._GimpCropOptions** %options, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpCropOptions*, %struct._GimpCropOptions** %options, align 8
  %layer_only = getelementptr inbounds %struct._GimpCropOptions, %struct._GimpCropOptions* %5, i32 0, i32 1
  store i32 %call2, i32* %layer_only, align 4
  br label %sw.epilog

sw.bb.3:                                          ; preds = %entry
  %6 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call4 = call i32 @g_value_get_boolean(%struct._GValue* %6)
  %7 = load %struct._GimpCropOptions*, %struct._GimpCropOptions** %options, align 8
  %allow_growing = getelementptr inbounds %struct._GimpCropOptions, %struct._GimpCropOptions* %7, i32 0, i32 2
  store i32 %call4, i32* %allow_growing, align 4
  br label %sw.epilog
...
; Function Attrs: nounwind uwtable
define internal void @gimp_crop_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpCropOptions*, %struct._GimpCropOptions** %options, align 8
  %layer_only = getelementptr inbounds %struct._GimpCropOptions, %struct._GimpCropOptions* %5, i32 0, i32 1
  %6 = load i32, i32* %layer_only, align 4
  call void @g_value_set_boolean(%struct._GValue* %4, i32 %6)
  br label %sw.epilog

sw.bb.2:                                          ; preds = %entry
  %7 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %8 = load %struct._GimpCropOptions*, %struct._GimpCropOptions** %options, align 8
  %allow_growing = getelementptr inbounds %struct._GimpCropOptions, %struct._GimpCropOptions* %8, i32 0, i32 2
  %9 = load i32, i32* %allow_growing, align 4
