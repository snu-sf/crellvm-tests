; ModuleID = './app/widgets/gimptoolpresetfactoryview.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpToolPresetFactoryViewClass = type { %struct._GimpDataFactoryViewClass }
...
%struct._GimpToolPresetFactoryView = type { %struct._GimpDataFactoryView }
...
@gimp_tool_preset_factory_view_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [26 x i8] c"GimpToolPresetFactoryView\00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"Gimp-Widgets\00", align 1
@__func__.gimp_tool_preset_factory_view_new = private unnamed_addr constant [34 x i8] c"gimp_tool_preset_factory_view_new\00", align 1
...
@.str.14 = private unnamed_addr constant [14 x i8] c"<ToolPresets>\00", align 1
@.str.15 = private unnamed_addr constant [8 x i8] c"ui-path\00", align 1
@.str.16 = private unnamed_addr constant [20 x i8] c"/tool-presets-popup\00", align 1
@.str.17 = private unnamed_addr constant [13 x i8] c"action-group\00", align 1
@.str.18 = private unnamed_addr constant [13 x i8] c"tool-presets\00", align 1
@gimp_tool_preset_factory_view_parent_class = internal global i8* null, align 8
@GimpToolPresetFactoryView_private_offset = internal global i32 0, align 4

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_tool_preset_factory_view_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_tool_preset_factory_view_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_tool_preset_factory_view_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 848, void (i8*, i8*)* bitcast (void (i8*)* @gimp_tool_preset_factory_view_class_intern_init to void (i8*, i8*)*), i32 152, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpToolPresetFactoryView*)* @gimp_tool_preset_factory_view_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_tool_preset_factory_view_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_tool_preset_factory_view_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_tool_preset_factory_view_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_tool_preset_factory_view_parent_class, align 8
  %1 = load i32, i32* @GimpToolPresetFactoryView_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpToolPresetFactoryView_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpToolPresetFactoryViewClass*
  call void @gimp_tool_preset_factory_view_class_init(%struct._GimpToolPresetFactoryViewClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_tool_preset_factory_view_init(%struct._GimpToolPresetFactoryView* %view) #3 {
entry:
  %view.addr = alloca %struct._GimpToolPresetFactoryView*, align 8
  store %struct._GimpToolPresetFactoryView* %view, %struct._GimpToolPresetFactoryView** %view.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_tool_preset_factory_view_new(i32 %view_type, %struct._GimpDataFactory* %factory, %struct._GimpContext* %context, i32 %view_size, i32 %view_border_width, %struct._GimpMenuFactory* %menu_factory) #3 {
entry:
  ...
  %factory_view = alloca %struct._GimpToolPresetFactoryView*, align 8
...
if.else.9:                                        ; preds = %if.end.6
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__func__.gimp_tool_preset_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0))
...
if.else.36:                                       ; preds = %if.end.32
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__func__.gimp_tool_preset_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.44:                                       ; preds = %land.lhs.true.41, %do.body.39
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__func__.gimp_tool_preset_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.4, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.52:                                       ; preds = %land.lhs.true.49, %do.body.47
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__func__.gimp_tool_preset_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str.5, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.81:                                       ; preds = %if.end.77
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @__func__.gimp_tool_preset_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.6, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
do.end.83:                                        ; preds = %if.end.82
  %call84 = call i64 @gimp_tool_preset_factory_view_get_type() #5
  ...
  %50 = bitcast i8* %call85 to %struct._GimpToolPresetFactoryView*
  store %struct._GimpToolPresetFactoryView* %50, %struct._GimpToolPresetFactoryView** %factory_view, align 8
  %51 = load %struct._GimpToolPresetFactoryView*, %struct._GimpToolPresetFactoryView** %factory_view, align 8
  %52 = bitcast %struct._GimpToolPresetFactoryView* %51 to %struct._GTypeInstance*
  %call86 = call i64 @gimp_data_factory_view_get_type() #5
  %call87 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %52, i64 %call86)
  %53 = bitcast %struct._GTypeInstance* %call87 to %struct._GimpDataFactoryView*
  %call88 = call %struct._GtkWidget* @gimp_data_factory_view_get_duplicate_button(%struct._GimpDataFactoryView* %53)
  call void @gtk_widget_hide(%struct._GtkWidget* %call88)
  %54 = load %struct._GimpToolPresetFactoryView*, %struct._GimpToolPresetFactoryView** %factory_view, align 8
  %55 = bitcast %struct._GimpToolPresetFactoryView* %54 to %struct._GTypeInstance*
  %call89 = call i64 @gtk_widget_get_type() #5
  %call90 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %55, i64 %call89)
  %56 = bitcast %struct._GTypeInstance* %call90 to %struct._GtkWidget*
  store %struct._GtkWidget* %56, %struct._GtkWidget** %retval
  br label %return

return:                                           ; preds = %do.end.83, %if.else.81, %if.else.52, %if.else.44, %if.else.36, %if.else.9
  %57 = load %struct._GtkWidget*, %struct._GtkWidget** %retval
  ret %struct._GtkWidget* %57
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_tool_preset_factory_view_class_init(%struct._GimpToolPresetFactoryViewClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpToolPresetFactoryViewClass*, align 8
  store %struct._GimpToolPresetFactoryViewClass* %klass, %struct._GimpToolPresetFactoryViewClass** %klass.addr, align 8
  ret void
}
