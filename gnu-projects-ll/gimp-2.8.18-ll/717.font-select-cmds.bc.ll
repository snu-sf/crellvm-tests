; ModuleID = './app/pdb/font-select-cmds.bc'
...
@.str = private unnamed_addr constant [17 x i8] c"gimp-fonts-popup\00", align 1
@.str.1 = private unnamed_addr constant [33 x i8] c"Invokes the Gimp font selection.\00", align 1
@.str.2 = private unnamed_addr constant [48 x i8] c"This procedure opens the font selection dialog.\00", align 1
...
@.str.6 = private unnamed_addr constant [14 x i8] c"font-callback\00", align 1
@.str.7 = private unnamed_addr constant [14 x i8] c"font callback\00", align 1
@.str.8 = private unnamed_addr constant [58 x i8] c"The callback PDB proc to call when font selection is made\00", align 1
...
@.str.11 = private unnamed_addr constant [35 x i8] c"Title of the font selection dialog\00", align 1
@.str.12 = private unnamed_addr constant [13 x i8] c"initial-font\00", align 1
@.str.13 = private unnamed_addr constant [13 x i8] c"initial font\00", align 1
@.str.14 = private unnamed_addr constant [50 x i8] c"The name of the font to set as the first selected\00", align 1
@.str.15 = private unnamed_addr constant [23 x i8] c"gimp-fonts-close-popup\00", align 1
@.str.16 = private unnamed_addr constant [33 x i8] c"Close the font selection dialog.\00", align 1
@.str.17 = private unnamed_addr constant [55 x i8] c"This procedure closes an opened font selection dialog.\00", align 1
@.str.18 = private unnamed_addr constant [52 x i8] c"The name of the callback registered for this pop-up\00", align 1
@.str.19 = private unnamed_addr constant [21 x i8] c"gimp-fonts-set-popup\00", align 1
@.str.20 = private unnamed_addr constant [50 x i8] c"Sets the current font in a font selection dialog.\00", align 1
@.str.21 = private unnamed_addr constant [10 x i8] c"font-name\00", align 1
@.str.22 = private unnamed_addr constant [10 x i8] c"font name\00", align 1
@.str.23 = private unnamed_addr constant [40 x i8] c"The name of the font to set as selected\00", align 1

; Function Attrs: nounwind uwtable
define void @register_font_select_procs(%struct._GimpPDB* %pdb) #0 {
entry:
  ...
  %call = call %struct._GimpProcedure* @gimp_procedure_new(%struct._GValueArray* (%struct._GimpProcedure*, %struct._Gimp*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GValueArray*, %struct._GError**)* @fonts_popup_invoker)
  ...
  %call3 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([58 x i8], [58 x i8]* @.str.8, i32 0, i32 0), i32 0, i32 0, i32 1, i8* null, i32 227)
  ...
  %call4 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.9, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.11, i32 0, i32 0), i32 0, i32 0, i32 0, i8* null, i32 227)
  ...
  %call5 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.12, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.13, i32 0, i32 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.14, i32 0, i32 0), i32 0, i32 1, i32 0, i8* null, i32 227)
  ...
  %call6 = call %struct._GimpProcedure* @gimp_procedure_new(%struct._GValueArray* (%struct._GimpProcedure*, %struct._Gimp*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GValueArray*, %struct._GError**)* @fonts_close_popup_invoker)
  ...
  call void @gimp_object_set_static_name(%struct._GimpObject* %13, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.15, i32 0, i32 0))
  %14 = load %struct._GimpProcedure*, %struct._GimpProcedure** %procedure, align 8
  call void @gimp_procedure_set_static_strings(%struct._GimpProcedure* %14, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.15, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.16, i32 0, i32 0), i8* getelementptr inbounds ([55 x i8], [55 x i8]* @.str.17, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0), i8* null)
  %15 = load %struct._GimpProcedure*, %struct._GimpProcedure** %procedure, align 8
  %call9 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.18, i32 0, i32 0), i32 0, i32 0, i32 1, i8* null, i32 227)
  ...
  %call10 = call %struct._GimpProcedure* @gimp_procedure_new(%struct._GValueArray* (%struct._GimpProcedure*, %struct._Gimp*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GValueArray*, %struct._GError**)* @fonts_set_popup_invoker)
  ...
  call void @gimp_object_set_static_name(%struct._GimpObject* %22, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.19, i32 0, i32 0))
  %23 = load %struct._GimpProcedure*, %struct._GimpProcedure** %procedure, align 8
  call void @gimp_procedure_set_static_strings(%struct._GimpProcedure* %23, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.19, i32 0, i32 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.20, i32 0, i32 0), i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.20, i32 0, i32 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.5, i32 0, i32 0), i8* null)
  %24 = load %struct._GimpProcedure*, %struct._GimpProcedure** %procedure, align 8
  %call13 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.18, i32 0, i32 0), i32 0, i32 0, i32 1, i8* null, i32 227)
  ...
  %call14 = call %struct._GParamSpec* @gimp_param_spec_string(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.21, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.22, i32 0, i32 0), i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.23, i32 0, i32 0), i32 0, i32 0, i32 0, i8* null, i32 227)
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @fonts_popup_invoker(%struct._GimpProcedure* %procedure, %struct._Gimp* %gimp, %struct._GimpContext* %context, %struct._GimpProgress* %progress, %struct._GValueArray* %args, %struct._GError** %error) #0 {
entry:
  ...
  %initial_font = alloca i8*, align 8
  ...
  store i8* %call6, i8** %initial_font, align 8
...
if.then:                                          ; preds = %entry
  ...
  br i1 %tobool7, label %if.then.13, label %lor.lhs.false
...
lor.lhs.false:                                    ; preds = %if.then
  ...
  %11 = load i8*, i8** %font_callback, align 8
...
lor.lhs.false.10:                                 ; preds = %lor.lhs.false
  ...
  %19 = load i8*, i8** %initial_font, align 8
  %call11 = call i32 (%struct._Gimp*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GimpContainer*, i8*, i8*, i8*, ...) @gimp_pdb_dialog_new(%struct._Gimp* %12, %struct._GimpContext* %13, %struct._GimpProgress* %14, %struct._GimpContainer* %16, i8* %17, i8* %18, i8* %19, i8* null)
  %tobool12 = icmp ne i32 %call11, 0
  br i1 %tobool12, label %if.end, label %if.then.13

if.then.13:                                       ; preds = %lor.lhs.false.10, %lor.lhs.false, %if.then
  store i32 0, i32* %success, align 4
  br label %if.end

if.end:                                           ; preds = %if.then.13, %lor.lhs.false.10
  br label %if.end.14
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @fonts_close_popup_invoker(%struct._GimpProcedure* %procedure, %struct._Gimp* %gimp, %struct._GimpContext* %context, %struct._GimpProgress* %progress, %struct._GValueArray* %args, %struct._GError** %error) #0 {
entry:
  %procedure.addr = alloca %struct._GimpProcedure*, align 8
  %gimp.addr = alloca %struct._Gimp*, align 8
  %context.addr = alloca %struct._GimpContext*, align 8
...
lor.lhs.false:                                    ; preds = %if.then
  ...
  %7 = load i8*, i8** %font_callback, align 8
...
lor.lhs.false.4:                                  ; preds = %lor.lhs.false
  ...
  %9 = load %struct._Gimp*, %struct._Gimp** %gimp.addr, align 8
  %fonts = getelementptr inbounds %struct._Gimp, %struct._Gimp* %9, i32 0, i32 36
  %10 = load %struct._GimpContainer*, %struct._GimpContainer** %fonts, align 8
  %11 = load i8*, i8** %font_callback, align 8
  %call5 = call i32 @gimp_pdb_dialog_close(%struct._Gimp* %8, %struct._GimpContainer* %10, i8* %11)
...
if.end:                                           ; preds = %if.then.7, %lor.lhs.false.4
  br label %if.end.8
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @fonts_set_popup_invoker(%struct._GimpProcedure* %procedure, %struct._Gimp* %gimp, %struct._GimpContext* %context, %struct._GimpProgress* %progress, %struct._GValueArray* %args, %struct._GError** %error) #0 {
entry:
  %procedure.addr = alloca %struct._GimpProcedure*, align 8
  %gimp.addr = alloca %struct._Gimp*, align 8
  %context.addr = alloca %struct._GimpContext*, align 8
  ...
  %arrayidx2 = getelementptr inbounds %struct._GValue, %struct._GValue* %3, i64 1
  %call3 = call i8* @g_value_get_string(%struct._GValue* %arrayidx2)
  store i8* %call3, i8** %font_name, align 8
...
lor.lhs.false:                                    ; preds = %if.then
  ...
  %9 = load i8*, i8** %font_callback, align 8
...
lor.lhs.false.7:                                  ; preds = %lor.lhs.false
  ...
  %fonts = getelementptr inbounds %struct._Gimp, %struct._Gimp* %11, i32 0, i32 36
  %12 = load %struct._GimpContainer*, %struct._GimpContainer** %fonts, align 8
  %13 = load i8*, i8** %font_callback, align 8
  %14 = load i8*, i8** %font_name, align 8
  %call8 = call i32 (%struct._Gimp*, %struct._GimpContainer*, i8*, i8*, ...) @gimp_pdb_dialog_set(%struct._Gimp* %10, %struct._GimpContainer* %12, i8* %13, i8* %14, i8* null)
  %tobool9 = icmp ne i32 %call8, 0
  br i1 %tobool9, label %if.end, label %if.then.10

if.then.10:                                       ; preds = %lor.lhs.false.7, %lor.lhs.false, %if.then
  store i32 0, i32* %success, align 4
  br label %if.end
