; ModuleID = './app/actions/tool-preset-editor-actions.bc'
...
@.str = private unnamed_addr constant [26 x i8] c"tool-preset-editor-action\00", align 1
@tool_preset_editor_actions = internal constant [1 x %struct._GimpActionEntry] [%struct._GimpActionEntry { i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.4, i32 0, i32 0), i8* null, i8* null, void ()* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.5, i32 0, i32 0) }], align 16
@tool_preset_editor_toggle_actions = internal constant [1 x %struct._GimpToggleActionEntry] [%struct._GimpToggleActionEntry { i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i32 0, i32 0), i8* null, i8* null, void ()* bitcast (void (%struct._GtkAction*, i8*)* @data_editor_edit_active_cmd_callback to void ()*), i32 0, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.8, i32 0, i32 0) }], align 16
@.str.1 = private unnamed_addr constant [31 x i8] c"tool-preset-editor-edit-active\00", align 1
@.str.2 = private unnamed_addr constant [25 x i8] c"tool-preset-editor-popup\00", align 1
@.str.3 = private unnamed_addr constant [17 x i8] c"gimp-tool-preset\00", align 1
@.str.4 = private unnamed_addr constant [24 x i8] c"Tool Preset Editor Menu\00", align 1
...
@.str.7 = private unnamed_addr constant [24 x i8] c"Edit Active Tool Preset\00", align 1
@.str.8 = private unnamed_addr constant [30 x i8] c"gimp-brush-editor-edit-active\00", align 1

; Function Attrs: nounwind uwtable
define void @tool_preset_editor_actions_setup(%struct._GimpActionGroup* %group) #0 {
entry:
  ...
  call void @gimp_action_group_add_actions(%struct._GimpActionGroup* %0, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0), %struct._GimpActionEntry* getelementptr inbounds ([1 x %struct._GimpActionEntry], [1 x %struct._GimpActionEntry]* @tool_preset_editor_actions, i32 0, i32 0), i32 1)
  %1 = load %struct._GimpActionGroup*, %struct._GimpActionGroup** %group.addr, align 8
  call void @gimp_action_group_add_toggle_actions(%struct._GimpActionGroup* %1, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str, i32 0, i32 0), %struct._GimpToggleActionEntry* getelementptr inbounds ([1 x %struct._GimpToggleActionEntry], [1 x %struct._GimpToggleActionEntry]* @tool_preset_editor_toggle_actions, i32 0, i32 0), i32 1)
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @tool_preset_editor_actions_update(%struct._GimpActionGroup* %group, i8* %user_data) #0 {
entry:
  %group.addr = alloca %struct._GimpActionGroup*, align 8
  ...
  %call2 = call i32 @gimp_data_editor_get_edit_active(%struct._GimpDataEditor* %3)
  store i32 %call2, i32* %edit_active, align 4
  %4 = load %struct._GimpActionGroup*, %struct._GimpActionGroup** %group.addr, align 8
  %5 = load i32, i32* %edit_active, align 4
  %cmp = icmp ne i32 %5, 0
  %conv = zext i1 %cmp to i32
  call void @gimp_action_group_set_action_active(%struct._GimpActionGroup* %4, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1, i32 0, i32 0), i32 %conv)
  ret void
}
