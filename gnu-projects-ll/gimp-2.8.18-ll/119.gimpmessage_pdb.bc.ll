; ModuleID = './libgimp/gimpmessage_pdb.bc'
...
@.str.1 = private unnamed_addr constant [25 x i8] c"gimp-message-get-handler\00", align 1
@.str.2 = private unnamed_addr constant [25 x i8] c"gimp-message-set-handler\00", align 1

; Function Attrs: nounwind uwtable
define i32 @gimp_message(i8* %message) #0 {
entry:
  ...
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 22)
...
; Function Attrs: nounwind uwtable
define i32 @gimp_message_get_handler() #0 {
entry:
  %return_vals = alloca %struct._GimpParam*, align 8
  %nreturn_vals = alloca i32, align 4
  %handler = alloca i32, align 4
  store i32 0, i32* %handler, align 4
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.1, i32 0, i32 0), i32* %nreturn_vals, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
...
; Function Attrs: nounwind uwtable
define i32 @gimp_message_set_handler(i32 %handler) #0 {
entry:
  ...
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.2, i32 0, i32 0), i32* %nreturn_vals, i32 0, i32 %0, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
  %1 = load %struct._GimpParam*, %struct._GimpParam** %return_vals, align 8
  %arrayidx = getelementptr inbounds %struct._GimpParam, %struct._GimpParam* %1, i64 0
  %data = getelementptr inbounds %struct._GimpParam, %struct._GimpParam* %arrayidx, i32 0, i32 1
