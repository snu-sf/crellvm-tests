; ModuleID = './app/paint/gimpdodgeburnoptions.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpDodgeBurnOptionsClass = type { %struct._GimpPaintOptionsClass }
...
@gimp_dodge_burn_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [21 x i8] c"GimpDodgeBurnOptions\00", align 1
@gimp_dodge_burn_options_parent_class = internal global i8* null, align 8
@GimpDodgeBurnOptions_private_offset = internal global i32 0, align 4
@.str.1 = private unnamed_addr constant [5 x i8] c"type\00", align 1
@.str.2 = private unnamed_addr constant [5 x i8] c"mode\00", align 1
@.str.3 = private unnamed_addr constant [9 x i8] c"exposure\00", align 1
@.str.4 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.5 = private unnamed_addr constant [23 x i8] c"gimpdodgeburnoptions.c\00", align 1
@.str.6 = private unnamed_addr constant [9 x i8] c"property\00", align 1
@.str.7 = private unnamed_addr constant [11 x i8] c"Gimp-Paint\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_dodge_burn_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_dodge_burn_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_dodge_burn_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_dodge_burn_options_class_intern_init to void (i8*, i8*)*), i32 488, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpDodgeBurnOptions*)* @gimp_dodge_burn_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_dodge_burn_options_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_dodge_burn_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_dodge_burn_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_dodge_burn_options_parent_class, align 8
  %1 = load i32, i32* @GimpDodgeBurnOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpDodgeBurnOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpDodgeBurnOptionsClass*
  call void @gimp_dodge_burn_options_class_init(%struct._GimpDodgeBurnOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_dodge_burn_options_init(%struct._GimpDodgeBurnOptions* %options) #3 {
entry:
  %options.addr = alloca %struct._GimpDodgeBurnOptions*, align 8
  store %struct._GimpDodgeBurnOptions* %options, %struct._GimpDodgeBurnOptions** %options.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_dodge_burn_options_class_init(%struct._GimpDodgeBurnOptionsClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpDodgeBurnOptionsClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  store %struct._GimpDodgeBurnOptionsClass* %klass, %struct._GimpDodgeBurnOptionsClass** %klass.addr, align 8
  %0 = load %struct._GimpDodgeBurnOptionsClass*, %struct._GimpDodgeBurnOptionsClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpDodgeBurnOptionsClass* %0 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_dodge_burn_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %4 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %4, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_dodge_burn_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %5 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call1 = call i64 @gimp_dodge_burn_type_get_type() #5
  %call2 = call %struct._GParamSpec* @g_param_spec_enum(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i8* null, i8* null, i64 %call1, i32 0, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %5, i32 1, %struct._GParamSpec* %call2)
  %6 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call i64 @gimp_transfer_mode_get_type() #5
  %call4 = call %struct._GParamSpec* @g_param_spec_enum(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), i8* null, i8* null, i64 %call3, i32 1, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %6, i32 2, %struct._GParamSpec* %call4)
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call5 = call %struct._GParamSpec* @g_param_spec_double(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.3, i32 0, i32 0), i8* null, i8* null, double 0.000000e+00, double 1.000000e+02, double 5.000000e+01, i32 487)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_dodge_burn_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  ...
  %call = call i64 @gimp_dodge_burn_options_get_type() #5
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpDodgeBurnOptions*
  store %struct._GimpDodgeBurnOptions* %2, %struct._GimpDodgeBurnOptions** %options, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpDodgeBurnOptions*, %struct._GimpDodgeBurnOptions** %options, align 8
  %type = getelementptr inbounds %struct._GimpDodgeBurnOptions, %struct._GimpDodgeBurnOptions* %5, i32 0, i32 1
...
sw.bb.3:                                          ; preds = %entry
  ...
  %mode = getelementptr inbounds %struct._GimpDodgeBurnOptions, %struct._GimpDodgeBurnOptions* %7, i32 0, i32 2
...
sw.bb.5:                                          ; preds = %entry
  ...
  store double %call6, double* %exposure, align 8
  br label %sw.epilog
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5, i32 0, i32 0), i32 106, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0), i32 %13, i8* %15, i8* %call7, i8* %call10)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_dodge_burn_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb.2:                                          ; preds = %entry
  ...
  %8 = load %struct._GimpDodgeBurnOptions*, %struct._GimpDodgeBurnOptions** %options, align 8
  %mode = getelementptr inbounds %struct._GimpDodgeBurnOptions, %struct._GimpDodgeBurnOptions* %8, i32 0, i32 2
...
sw.bb.3:                                          ; preds = %entry
  ...
  %exposure = getelementptr inbounds %struct._GimpDodgeBurnOptions, %struct._GimpDodgeBurnOptions* %11, i32 0, i32 3
  %12 = load double, double* %exposure, align 8
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5, i32 0, i32 0), i32 131, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0), i32 %16, i8* %18, i8* %call4, i8* %call7)
  br label %do.end
