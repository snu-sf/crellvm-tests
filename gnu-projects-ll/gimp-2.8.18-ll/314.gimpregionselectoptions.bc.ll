; ModuleID = './app/tools/gimpregionselectoptions.bc'
...
@gimp_region_select_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [24 x i8] c"GimpRegionSelectOptions\00", align 1
@.str.1 = private unnamed_addr constant [19 x i8] c"select-transparent\00", align 1
@.str.2 = private unnamed_addr constant [25 x i8] c"Select transparent areas\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"sample-merged\00", align 1
@.str.4 = private unnamed_addr constant [14 x i8] c"Sample merged\00", align 1
...
@.str.7 = private unnamed_addr constant [11 x i8] c"Select by:\00", align 1
@.str.8 = private unnamed_addr constant [17 x i8] c"select-criterion\00", align 1
@gimp_region_select_options_parent_class = internal global i8* null, align 8
@GimpRegionSelectOptions_private_offset = internal global i32 0, align 4
@.str.9 = private unnamed_addr constant [52 x i8] c"Allow completely transparent regions to be selected\00", align 1
@.str.10 = private unnamed_addr constant [37 x i8] c"Base selection on all visible layers\00", align 1
@.str.11 = private unnamed_addr constant [25 x i8] c"Maximum color difference\00", align 1
@.str.12 = private unnamed_addr constant [20 x i8] c"Selection criterion\00", align 1
@.str.13 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.14 = private unnamed_addr constant [26 x i8] c"gimpregionselectoptions.c\00", align 1
...
define i64 @gimp_region_select_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_region_select_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_region_select_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_region_select_options_class_intern_init to void (i8*, i8*)*), i32 408, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpRegionSelectOptions*)* @gimp_region_select_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_region_select_options_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_region_select_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_region_select_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_region_select_options_parent_class, align 8
  %1 = load i32, i32* @GimpRegionSelectOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpRegionSelectOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpToolOptionsClass*
  call void @gimp_region_select_options_class_init(%struct._GimpToolOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_region_select_options_init(%struct._GimpRegionSelectOptions* %options) #3 {
entry:
  %options.addr = alloca %struct._GimpRegionSelectOptions*, align 8
  store %struct._GimpRegionSelectOptions* %options, %struct._GimpRegionSelectOptions** %options.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_region_select_options_gui(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  ...
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.2, i32 0, i32 0)) #5
  %call3 = call %struct._GtkWidget* @gimp_prop_check_button_new(%struct._GObject* %4, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i8* %call2)
  ...
  %call6 = call i8* @gettext(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4, i32 0, i32 0)) #5
  %call7 = call %struct._GtkWidget* @gimp_prop_check_button_new(%struct._GObject* %10, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0), i8* %call6)
  ...
  %call10 = call i8* @gettext(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.6, i32 0, i32 0)) #5
  %call11 = call %struct._GtkWidget* @gimp_prop_spin_scale_new(%struct._GObject* %16, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0), i8* %call10, double 1.000000e+00, double 1.600000e+01, i32 1)
  ...
  %call14 = call %struct._GtkWidget* @gtk_box_new(i32 0, i32 2)
  ...
  %call17 = call i8* @gettext(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.7, i32 0, i32 0)) #5
  ...
  %call21 = call %struct._GtkWidget* @gimp_prop_enum_combo_box_new(%struct._GObject* %32, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i32 0, i32 0), i32 0, i32 0)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_region_select_options_class_init(%struct._GimpToolOptionsClass* %klass) #3 {
entry:
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_region_select_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %7, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_region_select_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  ...
  store void (%struct._GimpToolOptions*)* @gimp_region_select_options_reset, void (%struct._GimpToolOptions*)** %reset, align 8
  %9 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.1, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([52 x i8], [52 x i8]* @.str.9, i32 0, i32 0), i32 1, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %9, i32 1, %struct._GParamSpec* %call3)
  %10 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call4 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.10, i32 0, i32 0), i32 0, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %10, i32 2, %struct._GParamSpec* %call4)
  %11 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call5 = call %struct._GParamSpec* @g_param_spec_double(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.11, i32 0, i32 0), double 0.000000e+00, double 2.550000e+02, double 1.500000e+01, i32 487)
  ...
  %call7 = call %struct._GParamSpec* @g_param_spec_enum(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.8, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.12, i32 0, i32 0), i64 %call6, i32 0, i32 487)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_region_select_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  ...
  %call = call i64 @gimp_region_select_options_get_type() #6
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpRegionSelectOptions*
  store %struct._GimpRegionSelectOptions* %2, %struct._GimpRegionSelectOptions** %options, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %select_transparent = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %5, i32 0, i32 1
  store i32 %call2, i32* %select_transparent, align 4
  br label %sw.epilog

sw.bb.3:                                          ; preds = %entry
  %6 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call4 = call i32 @g_value_get_boolean(%struct._GValue* %6)
  %7 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %sample_merged = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %7, i32 0, i32 2
  store i32 %call4, i32* %sample_merged, align 4
  br label %sw.epilog

sw.bb.5:                                          ; preds = %entry
  %8 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call6 = call double @g_value_get_double(%struct._GValue* %8)
  %9 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %threshold = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %9, i32 0, i32 3
  store double %call6, double* %threshold, align 8
  br label %sw.epilog

sw.bb.7:                                          ; preds = %entry
  %10 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call8 = call i32 @g_value_get_enum(%struct._GValue* %10)
  %11 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %select_criterion = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %11, i32 0, i32 4
  store i32 %call8, i32* %select_criterion, align 4
  br label %sw.epilog
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.13, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.14, i32 0, i32 0), i32 139, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.15, i32 0, i32 0), i32 %15, i8* %17, i8* %call9, i8* %call12)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_region_select_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %select_transparent = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %5, i32 0, i32 1
  %6 = load i32, i32* %select_transparent, align 4
...
sw.bb.3:                                          ; preds = %entry
  %10 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %11 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %threshold = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %11, i32 0, i32 3
  %12 = load double, double* %threshold, align 8
...
sw.bb.4:                                          ; preds = %entry
  ...
  %select_criterion = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %14, i32 0, i32 4
  %15 = load i32, i32* %select_criterion, align 4
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.13, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.14, i32 0, i32 0), i32 171, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.15, i32 0, i32 0), i32 %19, i8* %21, i8* %call5, i8* %call8)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_region_select_options_reset(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  %tool_options.addr = alloca %struct._GimpToolOptions*, align 8
  ...
  %call = call %struct._GParamSpec* @g_object_class_find_property(%struct._GObjectClass* %3, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0))
...
if.end:                                           ; preds = %if.then, %entry
  %15 = load i8*, i8** @gimp_region_select_options_parent_class, align 8
...
entry:
  ...
  call void @g_logv(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.16, i32 0, i32 0), i32 16, i8* %0, %struct.__va_list_tag* %arraydecay2)
