; ModuleID = './app/tools/gimpcoloroptions.bc'
...
@gimp_color_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [17 x i8] c"GimpColorOptions\00", align 1
@.str.1 = private unnamed_addr constant [15 x i8] c"average-radius\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"Radius\00", align 1
@.str.3 = private unnamed_addr constant [15 x i8] c"sample-average\00", align 1
@.str.4 = private unnamed_addr constant [15 x i8] c"Sample average\00", align 1
@.str.5 = private unnamed_addr constant [10 x i8] c"sensitive\00", align 1
@gimp_color_options_parent_class = internal global i8* null, align 8
@GimpColorOptions_private_offset = internal global i32 0, align 4
@.str.6 = private unnamed_addr constant [14 x i8] c"sample-merged\00", align 1
@.str.7 = private unnamed_addr constant [28 x i8] c"Color Picker Average Radius\00", align 1
@.str.8 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.9 = private unnamed_addr constant [19 x i8] c"gimpcoloroptions.c\00", align 1
@.str.10 = private unnamed_addr constant [9 x i8] c"property\00", align 1
@.str.11 = private unnamed_addr constant [11 x i8] c"Gimp-Tools\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_color_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_color_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_color_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  %call5 = call i64 @gimp_image_map_options_get_type() #7
  %call6 = call i8* @g_intern_static_string(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0))
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_color_options_class_intern_init to void (i8*, i8*)*), i32 384, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpColorOptions*)* @gimp_color_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_color_options_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_color_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_color_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_color_options_parent_class, align 8
  %1 = load i32, i32* @GimpColorOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpColorOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpToolOptionsClass*
  call void @gimp_color_options_class_init(%struct._GimpToolOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_color_options_init(%struct._GimpColorOptions* %options) #3 {
entry:
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_color_options_gui(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  ...
  %call1 = call i64 @gimp_histogram_options_get_type() #7
...
if.else.5:                                        ; preds = %land.lhs.true, %if.else
  ...
  %call6 = call i32 @g_type_check_instance_is_a(%struct._GTypeInstance* %12, i64 %13) #8
...
if.then.9:                                        ; preds = %if.end.7
  ...
  %call10 = call %struct._GtkWidget* @gimp_histogram_options_gui(%struct._GimpToolOptions* %16)
  store %struct._GtkWidget* %call10, %struct._GtkWidget** %vbox, align 8
  br label %if.end.13

if.else.11:                                       ; preds = %if.end.7
  %17 = load %struct._GimpToolOptions*, %struct._GimpToolOptions** %tool_options.addr, align 8
  %call12 = call %struct._GtkWidget* @gimp_tool_options_gui(%struct._GimpToolOptions* %17)
  store %struct._GtkWidget* %call12, %struct._GtkWidget** %vbox, align 8
  br label %if.end.13

if.end.13:                                        ; preds = %if.else.11, %if.then.9
  %call14 = call %struct._GtkWidget* @gimp_frame_new(i8* null)
  ...
  %call17 = call i8* @gettext(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0)) #6
  %call18 = call %struct._GtkWidget* @gimp_prop_spin_scale_new(%struct._GObject* %23, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i8* %call17, double 1.000000e+00, double 1.000000e+01, i32 0)
  store %struct._GtkWidget* %call18, %struct._GtkWidget** %scale, align 8
  ...
  %26 = bitcast %struct._GTypeInstance* %call20 to %struct._GtkContainer*
  ...
  %29 = load %struct._GObject*, %struct._GObject** %config, align 8
  %call21 = call i8* @gettext(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.4, i32 0, i32 0)) #6
  %call22 = call %struct._GtkWidget* @gimp_prop_check_button_new(%struct._GObject* %29, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0), i8* %call21)
  ...
  %call25 = call %struct._GBinding* @g_object_bind_property(i8* %36, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0), i8* %38, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0), i32 2)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_color_options_class_init(%struct._GimpToolOptionsClass* %klass) #3 {
entry:
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_color_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %4 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %4, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_color_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %5 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call1 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i32 0, i32 0), i8* null, i8* null, i32 0, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %5, i32 1, %struct._GParamSpec* %call1)
  %6 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call2 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.3, i32 0, i32 0), i8* null, i8* null, i32 1, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %6, i32 2, %struct._GParamSpec* %call2)
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call i8* @gettext(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str.7, i32 0, i32 0)) #6
  %call4 = call %struct._GParamSpec* @g_param_spec_double(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.1, i32 0, i32 0), i8* null, i8* %call3, double 1.000000e+00, double 3.000000e+02, double 3.000000e+00, i32 487)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_color_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
  %pspec.addr = alloca %struct._GParamSpec*, align 8
  %options = alloca %struct._GimpColorOptions*, align 8
  ...
  %call = call i64 @gimp_color_options_get_type() #7
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpColorOptions*
  store %struct._GimpColorOptions* %2, %struct._GimpColorOptions** %options, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpColorOptions*, %struct._GimpColorOptions** %options, align 8
  %sample_merged = getelementptr inbounds %struct._GimpColorOptions, %struct._GimpColorOptions* %5, i32 0, i32 1
...
sw.bb.3:                                          ; preds = %entry
  ...
  %7 = load %struct._GimpColorOptions*, %struct._GimpColorOptions** %options, align 8
  %sample_average = getelementptr inbounds %struct._GimpColorOptions, %struct._GimpColorOptions* %7, i32 0, i32 2
  store i32 %call4, i32* %sample_average, align 4
  br label %sw.epilog

sw.bb.5:                                          ; preds = %entry
  %8 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call6 = call double @g_value_get_double(%struct._GValue* %8)
  %9 = load %struct._GimpColorOptions*, %struct._GimpColorOptions** %options, align 8
  %average_radius = getelementptr inbounds %struct._GimpColorOptions, %struct._GimpColorOptions* %9, i32 0, i32 3
  store double %call6, double* %average_radius, align 8
  br label %sw.epilog
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.9, i32 0, i32 0), i32 107, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.10, i32 0, i32 0), i32 %13, i8* %15, i8* %call7, i8* %call10)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_color_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb.2:                                          ; preds = %entry
  ...
  %8 = load %struct._GimpColorOptions*, %struct._GimpColorOptions** %options, align 8
  %sample_average = getelementptr inbounds %struct._GimpColorOptions, %struct._GimpColorOptions* %8, i32 0, i32 2
  %9 = load i32, i32* %sample_average, align 4
  call void @g_value_set_boolean(%struct._GValue* %7, i32 %9)
  br label %sw.epilog

sw.bb.3:                                          ; preds = %entry
  %10 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %11 = load %struct._GimpColorOptions*, %struct._GimpColorOptions** %options, align 8
  %average_radius = getelementptr inbounds %struct._GimpColorOptions, %struct._GimpColorOptions* %11, i32 0, i32 3
  %12 = load double, double* %average_radius, align 8
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.9, i32 0, i32 0), i32 132, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.10, i32 0, i32 0), i32 %16, i8* %18, i8* %call4, i8* %call7)
  br label %do.end
...
entry:
  ...
  call void @g_logv(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.11, i32 0, i32 0), i32 16, i8* %0, %struct.__va_list_tag* %arraydecay2)
