; ModuleID = './libgimp/gimpfontselect_pdb.bc'
...
@.str.1 = private unnamed_addr constant [23 x i8] c"gimp-fonts-close-popup\00", align 1
@.str.2 = private unnamed_addr constant [21 x i8] c"gimp-fonts-set-popup\00", align 1

; Function Attrs: nounwind uwtable
define i32 @gimp_fonts_popup(i8* %font_callback, i8* %popup_title, i8* %initial_font) #0 {
entry:
  %font_callback.addr = alloca i8*, align 8
  %popup_title.addr = alloca i8*, align 8
  %initial_font.addr = alloca i8*, align 8
  ...
  store i8* %initial_font, i8** %initial_font.addr, align 8
  store i32 1, i32* %success, align 4
  %0 = load i8*, i8** %font_callback.addr, align 8
  %1 = load i8*, i8** %popup_title.addr, align 8
  %2 = load i8*, i8** %initial_font.addr, align 8
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 4, i8* %1, i32 4, i8* %2, i32 22)
...
; Function Attrs: nounwind uwtable
define i32 @gimp_fonts_close_popup(i8* %font_callback) #0 {
entry:
  %font_callback.addr = alloca i8*, align 8
  %return_vals = alloca %struct._GimpParam*, align 8
  %nreturn_vals = alloca i32, align 4
...
; Function Attrs: nounwind uwtable
define i32 @gimp_fonts_set_popup(i8* %font_callback, i8* %font_name) #0 {
entry:
  %font_callback.addr = alloca i8*, align 8
  ...
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 4, i8* %1, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
