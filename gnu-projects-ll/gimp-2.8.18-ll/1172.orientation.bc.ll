; ModuleID = './plug-ins/gimpressionist/orientation.bc'
...
@orient_radio = internal global [8 x %struct._GtkWidget*] zeroinitializer, align 16
@orient_num_adjust = internal global %struct._GtkObject* null, align 8
@orient_first_adjust = internal global %struct._GtkObject* null, align 8
@orient_last_adjust = internal global %struct._GtkObject* null, align 8
@.str = private unnamed_addr constant [13 x i8] c"Or_ientation\00", align 1
@.str.1 = private unnamed_addr constant [12 x i8] c"Directions:\00", align 1
@.str.2 = private unnamed_addr constant [47 x i8] c"The number of directions (i.e. brushes) to use\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"value-changed\00", align 1
@.str.4 = private unnamed_addr constant [13 x i8] c"Start angle:\00", align 1
@.str.5 = private unnamed_addr constant [48 x i8] c"The starting angle of the first brush to create\00", align 1
@.str.6 = private unnamed_addr constant [12 x i8] c"Angle span:\00", align 1
@.str.7 = private unnamed_addr constant [44 x i8] c"The angle span of the first brush to create\00", align 1
@.str.8 = private unnamed_addr constant [13 x i8] c"Orientation:\00", align 1
@.str.9 = private unnamed_addr constant [6 x i8] c"Value\00", align 1
@.str.10 = private unnamed_addr constant [79 x i8] c"Let the value (brightness) of the region determine the direction of the stroke\00", align 1
@.str.11 = private unnamed_addr constant [7 x i8] c"Radius\00", align 1
@.str.12 = private unnamed_addr constant [81 x i8] c"The distance from the center of the image determines the direction of the stroke\00", align 1
@.str.13 = private unnamed_addr constant [7 x i8] c"Random\00", align 1
@.str.14 = private unnamed_addr constant [42 x i8] c"Selects a random direction of each stroke\00", align 1
@.str.15 = private unnamed_addr constant [7 x i8] c"Radial\00", align 1
@.str.16 = private unnamed_addr constant [72 x i8] c"Let the direction from the center determine the direction of the stroke\00", align 1
...
@.str.20 = private unnamed_addr constant [61 x i8] c"The hue of the region determines the direction of the stroke\00", align 1
@.str.21 = private unnamed_addr constant [9 x i8] c"Adaptive\00", align 1
@.str.22 = private unnamed_addr constant [70 x i8] c"The direction that matches the original image the closest is selected\00", align 1
@.str.23 = private unnamed_addr constant [7 x i8] c"Manual\00", align 1
@.str.24 = private unnamed_addr constant [40 x i8] c"Manually specify the stroke orientation\00", align 1
...
@.str.27 = private unnamed_addr constant [36 x i8] c"Opens up the Orientation Map Editor\00", align 1

; Function Attrs: nounwind uwtable
define i32 @orientation_type_input(i32 %in) #0 {
entry:
...
; Function Attrs: nounwind uwtable
define void @orientation_restore() #0 {
entry:
  %0 = load i32, i32* getelementptr inbounds (%struct.gimpressionist_vals_t, %struct.gimpressionist_vals_t* @pcvals, i32 0, i32 3), align 4
  %idxprom = sext i32 %0 to i64
  %arrayidx = getelementptr inbounds [8 x %struct._GtkWidget*], [8 x %struct._GtkWidget*]* @orient_radio, i32 0, i64 %idxprom
  ...
  %4 = load %struct._GtkObject*, %struct._GtkObject** @orient_num_adjust, align 8
  ...
  %7 = load i32, i32* getelementptr inbounds (%struct.gimpressionist_vals_t, %struct.gimpressionist_vals_t* @pcvals, i32 0, i32 0), align 4
  %conv = sitofp i32 %7 to double
  call void @gtk_adjustment_set_value(%struct._GtkAdjustment* %6, double %conv)
  %8 = load %struct._GtkObject*, %struct._GtkObject** @orient_first_adjust, align 8
  ...
  %11 = load double, double* getelementptr inbounds (%struct.gimpressionist_vals_t, %struct.gimpressionist_vals_t* @pcvals, i32 0, i32 1), align 8
  call void @gtk_adjustment_set_value(%struct._GtkAdjustment* %10, double %11)
  %12 = load %struct._GtkObject*, %struct._GtkObject** @orient_last_adjust, align 8
  %13 = bitcast %struct._GtkObject* %12 to %struct._GTypeInstance*
  %call6 = call i64 @gtk_adjustment_get_type() #4
  %call7 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %13, i64 %call6)
  %14 = bitcast %struct._GTypeInstance* %call7 to %struct._GtkAdjustment*
  %15 = load double, double* getelementptr inbounds (%struct.gimpressionist_vals_t, %struct.gimpressionist_vals_t* @pcvals, i32 0, i32 2), align 8
...
; Function Attrs: nounwind uwtable
define void @create_orientationpage(%struct._GtkNotebook* %notebook) #0 {
entry:
  ...
  %call14 = call i8* @gettext(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.1, i32 0, i32 0)) #5
  %18 = load i32, i32* getelementptr inbounds (%struct.gimpressionist_vals_t, %struct.gimpressionist_vals_t* @pcvals, i32 0, i32 0), align 4
  %conv = sitofp i32 %18 to double
  %call15 = call i8* @gettext(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.2, i32 0, i32 0)) #5
  ...
  store %struct._GtkObject* %call16, %struct._GtkObject** @orient_num_adjust, align 8
  %19 = load %struct._GtkObject*, %struct._GtkObject** @orient_num_adjust, align 8
  %20 = bitcast %struct._GtkObject* %19 to i8*
  %call17 = call i64 @g_signal_connect_data(i8* %20, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0), void ()* bitcast (void (%struct._GtkAdjustment*, i8*)* @gimp_int_adjustment_update to void ()*), i8* bitcast (%struct.gimpressionist_vals_t* @pcvals to i8*), void (i8*, %struct._GClosure*)* null, i32 0)
  ...
  %call20 = call i8* @gettext(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.4, i32 0, i32 0)) #5
  %24 = load double, double* getelementptr inbounds (%struct.gimpressionist_vals_t, %struct.gimpressionist_vals_t* @pcvals, i32 0, i32 1), align 8
  %call21 = call i8* @gettext(i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.5, i32 0, i32 0)) #5
  ...
  store %struct._GtkObject* %call22, %struct._GtkObject** @orient_first_adjust, align 8
  %25 = load %struct._GtkObject*, %struct._GtkObject** @orient_first_adjust, align 8
  ...
  %call26 = call i8* @gettext(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.6, i32 0, i32 0)) #5
  %30 = load double, double* getelementptr inbounds (%struct.gimpressionist_vals_t, %struct.gimpressionist_vals_t* @pcvals, i32 0, i32 2), align 8
  %call27 = call i8* @gettext(i8* getelementptr inbounds ([44 x i8], [44 x i8]* @.str.7, i32 0, i32 0)) #5
  ...
  store %struct._GtkObject* %call28, %struct._GtkObject** @orient_last_adjust, align 8
  %31 = load %struct._GtkObject*, %struct._GtkObject** @orient_last_adjust, align 8
  ...
  %call36 = call i8* @gettext(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.8, i32 0, i32 0)) #5
  ...
  %call44 = call i8* @gettext(i8* getelementptr inbounds ([79 x i8], [79 x i8]* @.str.10, i32 0, i32 0)) #5
  call void @create_orientradio_button(%struct._GtkWidget* %53, i32 0, i8* %call43, i8* %call44, %struct._GSList** %radio_group)
  ...
  %call46 = call i8* @gettext(i8* getelementptr inbounds ([81 x i8], [81 x i8]* @.str.12, i32 0, i32 0)) #5
  call void @create_orientradio_button(%struct._GtkWidget* %54, i32 1, i8* %call45, i8* %call46, %struct._GSList** %radio_group)
  ...
  %call48 = call i8* @gettext(i8* getelementptr inbounds ([42 x i8], [42 x i8]* @.str.14, i32 0, i32 0)) #5
  call void @create_orientradio_button(%struct._GtkWidget* %55, i32 2, i8* %call47, i8* %call48, %struct._GSList** %radio_group)
  ...
  %call50 = call i8* @gettext(i8* getelementptr inbounds ([72 x i8], [72 x i8]* @.str.16, i32 0, i32 0)) #5
  call void @create_orientradio_button(%struct._GtkWidget* %56, i32 3, i8* %call49, i8* %call50, %struct._GSList** %radio_group)
  ...
  call void @create_orientradio_button(%struct._GtkWidget* %62, i32 4, i8* %call54, i8* %call55, %struct._GSList** %radio_group)
  ...
  %call57 = call i8* @gettext(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.20, i32 0, i32 0)) #5
  call void @create_orientradio_button(%struct._GtkWidget* %63, i32 5, i8* %call56, i8* %call57, %struct._GSList** %radio_group)
  ...
  %call59 = call i8* @gettext(i8* getelementptr inbounds ([70 x i8], [70 x i8]* @.str.22, i32 0, i32 0)) #5
  call void @create_orientradio_button(%struct._GtkWidget* %64, i32 6, i8* %call58, i8* %call59, %struct._GSList** %radio_group)
  ...
  %call64 = call i8* @gettext(i8* getelementptr inbounds ([40 x i8], [40 x i8]* @.str.24, i32 0, i32 0)) #5
  call void @create_orientradio_button(%struct._GtkWidget* %70, i32 7, i8* %call63, i8* %call64, %struct._GSList** %radio_group)
  ...
  %call68 = call i64 @g_signal_connect_data(i8* %77, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.26, i32 0, i32 0), void ()* bitcast (void (%struct._GtkWidget*)* @create_orientmap_dialog_helper to void ()*), i8* null, void (i8*, %struct._GClosure*)* null, i32 0)
  %78 = load %struct._GtkWidget*, %struct._GtkWidget** %tmpw, align 8
  %call69 = call i8* @gettext(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.27, i32 0, i32 0)) #5
...
; Function Attrs: nounwind uwtable
define internal void @create_orientradio_button(%struct._GtkWidget* %box, i32 %orient_type, i8* %label, i8* %help_string, %struct._GSList** %radio_group) #0 {
entry:
  ...
  %call = call %struct._GtkWidget* @create_radio_button(%struct._GtkWidget* %0, i32 %1, void (%struct._GtkWidget*, i8*)* @orientation_store, i8* %2, i8* %3, %struct._GSList** %4, %struct._GtkWidget** getelementptr inbounds ([8 x %struct._GtkWidget*], [8 x %struct._GtkWidget*]* @orient_radio, i32 0, i32 0))
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @create_orientmap_dialog_helper(%struct._GtkWidget* %widget) #0 {
entry:
  %widget.addr = alloca %struct._GtkWidget*, align 8
  store %struct._GtkWidget* %widget, %struct._GtkWidget** %widget.addr, align 8
  %0 = load %struct._GtkWidget*, %struct._GtkWidget** getelementptr inbounds ([8 x %struct._GtkWidget*], [8 x %struct._GtkWidget*]* @orient_radio, i32 0, i64 7), align 8
  %1 = bitcast %struct._GtkWidget* %0 to %struct._GTypeInstance*
  %call = call i64 @gtk_toggle_button_get_type() #4
  ...
  call void @create_orientmap_dialog(%struct._GtkWidget* %3)
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @orientation_store(%struct._GtkWidget* %wg, i8* %d) #0 {
entry:
  ...
  store i32 %conv, i32* getelementptr inbounds (%struct.gimpressionist_vals_t, %struct.gimpressionist_vals_t* @pcvals, i32 0, i32 3), align 4
  ret void
}

declare void @create_orientmap_dialog(%struct._GtkWidget*) #1
