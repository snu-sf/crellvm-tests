; ModuleID = './app/widgets/gimpimageview.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpImageViewClass = type { %struct._GimpContainerEditorClass }
...
%struct._GimpImageView = type { %struct._GimpContainerEditor, %struct._GtkWidget*, %struct._GtkWidget*, %struct._GtkWidget* }
...
@gimp_image_view_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [14 x i8] c"GimpImageView\00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"Gimp-Widgets\00", align 1
@__func__.gimp_image_view_new = private unnamed_addr constant [20 x i8] c"gimp_image_view_new\00", align 1
...
@.str.14 = private unnamed_addr constant [9 x i8] c"<Images>\00", align 1
@.str.15 = private unnamed_addr constant [8 x i8] c"ui-path\00", align 1
@.str.16 = private unnamed_addr constant [14 x i8] c"/images-popup\00", align 1
@.str.17 = private unnamed_addr constant [7 x i8] c"images\00", align 1
@.str.18 = private unnamed_addr constant [19 x i8] c"images-raise-views\00", align 1
@.str.19 = private unnamed_addr constant [16 x i8] c"images-new-view\00", align 1
@.str.20 = private unnamed_addr constant [14 x i8] c"images-delete\00", align 1
@gimp_image_view_parent_class = internal global i8* null, align 8
@GimpImageView_private_offset = internal global i32 0, align 4

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_image_view_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_image_view_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_image_view_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 848, void (i8*, i8*)* bitcast (void (i8*)* @gimp_image_view_class_intern_init to void (i8*, i8*)*), i32 168, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpImageView*)* @gimp_image_view_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_image_view_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_image_view_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_image_view_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_image_view_parent_class, align 8
  %1 = load i32, i32* @GimpImageView_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpImageView_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpImageViewClass*
  call void @gimp_image_view_class_init(%struct._GimpImageViewClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_image_view_init(%struct._GimpImageView* %view) #3 {
entry:
  %view.addr = alloca %struct._GimpImageView*, align 8
  store %struct._GimpImageView* %view, %struct._GimpImageView** %view.addr, align 8
  %0 = load %struct._GimpImageView*, %struct._GimpImageView** %view.addr, align 8
  %raise_button = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %0, i32 0, i32 1
  store %struct._GtkWidget* null, %struct._GtkWidget** %raise_button, align 8
  %1 = load %struct._GimpImageView*, %struct._GimpImageView** %view.addr, align 8
  %new_button = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %1, i32 0, i32 2
  store %struct._GtkWidget* null, %struct._GtkWidget** %new_button, align 8
  %2 = load %struct._GimpImageView*, %struct._GimpImageView** %view.addr, align 8
  %delete_button = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %2, i32 0, i32 3
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_image_view_new(i32 %view_type, %struct._GimpContainer* %container, %struct._GimpContext* %context, i32 %view_size, i32 %view_border_width, %struct._GimpMenuFactory* %menu_factory) #3 {
entry:
  ...
  %image_view = alloca %struct._GimpImageView*, align 8
...
if.else.9:                                        ; preds = %if.end.6
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__func__.gimp_image_view_new, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.2, i32 0, i32 0))
...
if.else.36:                                       ; preds = %if.end.32
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__func__.gimp_image_view_new, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.44:                                       ; preds = %land.lhs.true.41, %do.body.39
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__func__.gimp_image_view_new, i32 0, i32 0), i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.4, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.52:                                       ; preds = %land.lhs.true.49, %do.body.47
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__func__.gimp_image_view_new, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str.5, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.81:                                       ; preds = %if.end.77
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__func__.gimp_image_view_new, i32 0, i32 0), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.6, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
do.end.83:                                        ; preds = %if.end.82
  %call84 = call i64 @gimp_image_view_get_type() #5
  ...
  %50 = bitcast i8* %call85 to %struct._GimpImageView*
  store %struct._GimpImageView* %50, %struct._GimpImageView** %image_view, align 8
  %51 = load %struct._GimpImageView*, %struct._GimpImageView** %image_view, align 8
  %52 = bitcast %struct._GimpImageView* %51 to %struct._GTypeInstance*
  ...
  %call90 = call %struct._GtkWidget* (%struct._GimpEditor*, i8*, i8*, ...) @gimp_editor_add_action_button(%struct._GimpEditor* %57, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.17, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.18, i32 0, i32 0), i8* null)
  %58 = load %struct._GimpImageView*, %struct._GimpImageView** %image_view, align 8
  %raise_button = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %58, i32 0, i32 1
  store %struct._GtkWidget* %call90, %struct._GtkWidget** %raise_button, align 8
  %59 = load %struct._GimpContainerEditor*, %struct._GimpContainerEditor** %editor, align 8
  %view91 = getelementptr inbounds %struct._GimpContainerEditor, %struct._GimpContainerEditor* %59, i32 0, i32 1
  %60 = load %struct._GimpContainerView*, %struct._GimpContainerView** %view91, align 8
  %61 = bitcast %struct._GimpContainerView* %60 to %struct._GTypeInstance*
  %call92 = call i64 @gimp_editor_get_type() #5
  %call93 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %61, i64 %call92)
  %62 = bitcast %struct._GTypeInstance* %call93 to %struct._GimpEditor*
  %call94 = call %struct._GtkWidget* (%struct._GimpEditor*, i8*, i8*, ...) @gimp_editor_add_action_button(%struct._GimpEditor* %62, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.17, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.19, i32 0, i32 0), i8* null)
  %63 = load %struct._GimpImageView*, %struct._GimpImageView** %image_view, align 8
  %new_button = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %63, i32 0, i32 2
  store %struct._GtkWidget* %call94, %struct._GtkWidget** %new_button, align 8
  %64 = load %struct._GimpContainerEditor*, %struct._GimpContainerEditor** %editor, align 8
  %view95 = getelementptr inbounds %struct._GimpContainerEditor, %struct._GimpContainerEditor* %64, i32 0, i32 1
  %65 = load %struct._GimpContainerView*, %struct._GimpContainerView** %view95, align 8
  %66 = bitcast %struct._GimpContainerView* %65 to %struct._GTypeInstance*
  %call96 = call i64 @gimp_editor_get_type() #5
  %call97 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %66, i64 %call96)
  %67 = bitcast %struct._GTypeInstance* %call97 to %struct._GimpEditor*
  %call98 = call %struct._GtkWidget* (%struct._GimpEditor*, i8*, i8*, ...) @gimp_editor_add_action_button(%struct._GimpEditor* %67, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.17, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.20, i32 0, i32 0), i8* null)
  %68 = load %struct._GimpImageView*, %struct._GimpImageView** %image_view, align 8
  %delete_button = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %68, i32 0, i32 3
  store %struct._GtkWidget* %call98, %struct._GtkWidget** %delete_button, align 8
  %69 = load i32, i32* %view_type.addr, align 4
  %cmp99 = icmp eq i32 %69, 0
  br i1 %cmp99, label %if.then.100, label %if.end.104

if.then.100:                                      ; preds = %do.end.83
  %70 = load %struct._GimpContainerEditor*, %struct._GimpContainerEditor** %editor, align 8
  %view102 = getelementptr inbounds %struct._GimpContainerEditor, %struct._GimpContainerEditor* %70, i32 0, i32 1
  %71 = load %struct._GimpContainerView*, %struct._GimpContainerView** %view102, align 8
  %call103 = call %struct._GtkWidget* @gimp_container_view_get_dnd_widget(%struct._GimpContainerView* %71)
  store %struct._GtkWidget* %call103, %struct._GtkWidget** %dnd_widget, align 8
  %72 = load %struct._GtkWidget*, %struct._GtkWidget** %dnd_widget, align 8
  call void @gimp_dnd_xds_source_add(%struct._GtkWidget* %72, %struct._GimpViewable* (%struct._GtkWidget*, %struct._GimpContext**, i8*)* bitcast (%struct._GimpViewable* (%struct._GtkWidget*)* @gimp_dnd_get_drag_data to %struct._GimpViewable* (%struct._GtkWidget*, %struct._GimpContext**, i8*)*), i8* null)
  br label %if.end.104

if.end.104:                                       ; preds = %if.then.100, %do.end.83
  %73 = load %struct._GimpContainerEditor*, %struct._GimpContainerEditor** %editor, align 8
  %view105 = getelementptr inbounds %struct._GimpContainerEditor, %struct._GimpContainerEditor* %73, i32 0, i32 1
  %74 = load %struct._GimpContainerView*, %struct._GimpContainerView** %view105, align 8
  %75 = load %struct._GimpImageView*, %struct._GimpImageView** %image_view, align 8
  %raise_button106 = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %75, i32 0, i32 1
  %76 = load %struct._GtkWidget*, %struct._GtkWidget** %raise_button106, align 8
  %77 = bitcast %struct._GtkWidget* %76 to %struct._GTypeInstance*
  %call107 = call i64 @gtk_button_get_type() #5
  %call108 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %77, i64 %call107)
  %78 = bitcast %struct._GTypeInstance* %call108 to %struct._GtkButton*
  %call109 = call i64 @gimp_image_get_type() #5
  call void @gimp_container_view_enable_dnd(%struct._GimpContainerView* %74, %struct._GtkButton* %78, i64 %call109)
  %79 = load %struct._GimpContainerEditor*, %struct._GimpContainerEditor** %editor, align 8
  %view110 = getelementptr inbounds %struct._GimpContainerEditor, %struct._GimpContainerEditor* %79, i32 0, i32 1
  %80 = load %struct._GimpContainerView*, %struct._GimpContainerView** %view110, align 8
  %81 = load %struct._GimpImageView*, %struct._GimpImageView** %image_view, align 8
  %new_button111 = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %81, i32 0, i32 2
  %82 = load %struct._GtkWidget*, %struct._GtkWidget** %new_button111, align 8
  %83 = bitcast %struct._GtkWidget* %82 to %struct._GTypeInstance*
  %call112 = call i64 @gtk_button_get_type() #5
  %call113 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %83, i64 %call112)
  %84 = bitcast %struct._GTypeInstance* %call113 to %struct._GtkButton*
  %call114 = call i64 @gimp_image_get_type() #5
  call void @gimp_container_view_enable_dnd(%struct._GimpContainerView* %80, %struct._GtkButton* %84, i64 %call114)
  %85 = load %struct._GimpContainerEditor*, %struct._GimpContainerEditor** %editor, align 8
  %view115 = getelementptr inbounds %struct._GimpContainerEditor, %struct._GimpContainerEditor* %85, i32 0, i32 1
  %86 = load %struct._GimpContainerView*, %struct._GimpContainerView** %view115, align 8
  %87 = load %struct._GimpImageView*, %struct._GimpImageView** %image_view, align 8
  %delete_button116 = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %87, i32 0, i32 3
  %88 = load %struct._GtkWidget*, %struct._GtkWidget** %delete_button116, align 8
  %89 = bitcast %struct._GtkWidget* %88 to %struct._GTypeInstance*
  %call117 = call i64 @gtk_button_get_type() #5
  %call118 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %89, i64 %call117)
  %90 = bitcast %struct._GTypeInstance* %call118 to %struct._GtkButton*
  %call119 = call i64 @gimp_image_get_type() #5
  call void @gimp_container_view_enable_dnd(%struct._GimpContainerView* %86, %struct._GtkButton* %90, i64 %call119)
  %91 = load %struct._GimpContainerEditor*, %struct._GimpContainerEditor** %editor, align 8
  %view120 = getelementptr inbounds %struct._GimpContainerEditor, %struct._GimpContainerEditor* %91, i32 0, i32 1
  %92 = load %struct._GimpContainerView*, %struct._GimpContainerView** %view120, align 8
  %93 = bitcast %struct._GimpContainerView* %92 to %struct._GTypeInstance*
  %call121 = call i64 @gimp_editor_get_type() #5
  %call122 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %93, i64 %call121)
  %94 = bitcast %struct._GTypeInstance* %call122 to %struct._GimpEditor*
  %call123 = call %struct._GimpUIManager* @gimp_editor_get_ui_manager(%struct._GimpEditor* %94)
  ...
  call void @gimp_ui_manager_update(%struct._GimpUIManager* %call123, i8* %96)
  %97 = load %struct._GimpImageView*, %struct._GimpImageView** %image_view, align 8
  %98 = bitcast %struct._GimpImageView* %97 to %struct._GTypeInstance*
  %call124 = call i64 @gtk_widget_get_type() #5
  %call125 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %98, i64 %call124)
  %99 = bitcast %struct._GTypeInstance* %call125 to %struct._GtkWidget*
  store %struct._GtkWidget* %99, %struct._GtkWidget** %retval
  br label %return

return:                                           ; preds = %if.end.104, %if.else.81, %if.else.52, %if.else.44, %if.else.36, %if.else.9
...
declare void @gimp_dnd_xds_source_add(%struct._GtkWidget*, %struct._GimpViewable* (%struct._GtkWidget*, %struct._GimpContext**, i8*)*, i8*) #1
...
; Function Attrs: nounwind uwtable
define internal void @gimp_image_view_class_init(%struct._GimpImageViewClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpImageViewClass*, align 8
  %editor_class = alloca %struct._GimpContainerEditorClass*, align 8
  store %struct._GimpImageViewClass* %klass, %struct._GimpImageViewClass** %klass.addr, align 8
  %0 = load %struct._GimpImageViewClass*, %struct._GimpImageViewClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpImageViewClass* %0 to %struct._GTypeClass*
  ...
  store void (%struct._GimpContainerEditor*, %struct._GimpViewable*)* @gimp_image_view_activate_item, void (%struct._GimpContainerEditor*, %struct._GimpViewable*)** %activate_item, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_image_view_activate_item(%struct._GimpContainerEditor* %editor, %struct._GimpViewable* %viewable) #3 {
entry:
  %editor.addr = alloca %struct._GimpContainerEditor*, align 8
  %viewable.addr = alloca %struct._GimpViewable*, align 8
  %view = alloca %struct._GimpImageView*, align 8
  ...
  %call = call i64 @gimp_image_view_get_type() #5
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpImageView*
  store %struct._GimpImageView* %2, %struct._GimpImageView** %view, align 8
  %3 = load i8*, i8** @gimp_image_view_parent_class, align 8
...
if.then:                                          ; preds = %entry
  %7 = load i8*, i8** @gimp_image_view_parent_class, align 8
...
if.then.14:                                       ; preds = %land.lhs.true
  %20 = load %struct._GimpImageView*, %struct._GimpImageView** %view, align 8
  %raise_button = getelementptr inbounds %struct._GimpImageView, %struct._GimpImageView* %20, i32 0, i32 1
  %21 = load %struct._GtkWidget*, %struct._GtkWidget** %raise_button, align 8
