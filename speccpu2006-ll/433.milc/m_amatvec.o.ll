...
define void @mult_adj_su3_mat_vec(%struct.su3_matrix* %a, %struct.su3_vector* %b, %struct.su3_vector* %c) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx1 = getelementptr inbounds [3 x %struct.complex], [3 x %struct.complex]* %arrayidx, i32 0, i64 %idxprom
  ...
  %arrayidx4 = getelementptr inbounds [3 x [3 x %struct.complex]], [3 x [3 x %struct.complex]]* %e3, i32 0, i64 0
  %arrayidx5 = getelementptr inbounds [3 x %struct.complex], [3 x %struct.complex]* %arrayidx4, i32 0, i64 %idxprom2
  ...
  %arrayidx17 = getelementptr inbounds [3 x [3 x %struct.complex]], [3 x [3 x %struct.complex]]* %e16, i32 0, i64 1
  %arrayidx18 = getelementptr inbounds [3 x %struct.complex], [3 x %struct.complex]* %arrayidx17, i32 0, i64 %idxprom15
  ...
  %arrayidx22 = getelementptr inbounds [3 x [3 x %struct.complex]], [3 x [3 x %struct.complex]]* %e21, i32 0, i64 1
  %arrayidx23 = getelementptr inbounds [3 x %struct.complex], [3 x %struct.complex]* %arrayidx22, i32 0, i64 %idxprom20
  ...
  %arrayidx41 = getelementptr inbounds [3 x [3 x %struct.complex]], [3 x [3 x %struct.complex]]* %e40, i32 0, i64 2
  %arrayidx42 = getelementptr inbounds [3 x %struct.complex], [3 x %struct.complex]* %arrayidx41, i32 0, i64 %idxprom39
  ...
  %arrayidx46 = getelementptr inbounds [3 x [3 x %struct.complex]], [3 x [3 x %struct.complex]]* %e45, i32 0, i64 2
  %arrayidx47 = getelementptr inbounds [3 x %struct.complex], [3 x %struct.complex]* %arrayidx46, i32 0, i64 %idxprom44
