...
for.cond.145:                                     ; preds = %for.inc.187, %if.then.144
  ...
  %height146 = getelementptr inbounds %struct.ImageParameters, %struct.ImageParameters* %92, i32 0, i32 15
...
cond.false.7:                                     ; preds = %cond.false.4
  br label %cond.end.8

cond.end.8:                                       ; preds = %cond.false.7, %cond.true.6
  %cond9 = phi i32 [ %6, %cond.true.6 ], [ 255, %cond.false.7 ]
  br label %cond.end.10

cond.end.10:                                      ; preds = %cond.end.8, %cond.true.3
  %cond11 = phi i32 [ 0, %cond.true.3 ], [ %cond9, %cond.end.8 ]
  %conv = trunc i32 %cond11 to i8
  %7 = load i32, i32* %i, align 4
  %idxprom = sext i32 %7 to i64
  %8 = load i8*, i8** getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 0), align 8
  %arrayidx = getelementptr inbounds i8, i8* %8, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  ...
  store i32 %10, i32* getelementptr inbounds (%struct.user_data_unregistered_information_struct, %struct.user_data_unregistered_information_struct* @seiUser_data_unregistered, i32 0, i32 1), align 4
  ret void
}
...
cond.end.9:                                       ; preds = %cond.false.8, %cond.true.7
  %cond10 = phi i32 [ %9, %cond.true.7 ], [ 255, %cond.false.8 ]
  br label %cond.end.11

cond.end.11:                                      ; preds = %cond.end.9, %cond.true.4
  %cond12 = phi i32 [ 0, %cond.true.4 ], [ %cond10, %cond.end.9 ]
...
for.end:                                          ; preds = %for.cond
  ...
  store i32 %13, i32* getelementptr inbounds (%struct.user_data_registered_itu_t_t35_information_struct, %struct.user_data_registered_itu_t_t35_information_struct* @seiUser_data_registered_itu_t_t35, i32 0, i32 1), align 4
  ret void
}
...
entry:
  ...
  %byte_buf = getelementptr inbounds %struct.Bitstream, %struct.Bitstream* %4, i32 0, i32 2
  store i8 0, i8* %byte_buf, align 1
  store i32 0, i32* getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 4), align 4
  store i8 0, i8* getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 0), align 1
  store i8 0, i8* getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 2), align 1
...
entry:
  ...
  %mapping = getelementptr inbounds %struct.syntaxelement, %struct.syntaxelement* %sym, i32 0, i32 8
  store void (i32, i32, i32*, i32*)* @ue_linfo, void (i32, i32, i32*, i32*)** %mapping, align 8
  %1 = load i8, i8* getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 0), align 1
  ...
  %5 = load i8, i8* getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 2), align 1
...
if.then:                                          ; preds = %entry
  ...
  %10 = load i8, i8* %byte_buf, align 1
  ...
  %12 = load i8, i8* %byte_buf10, align 1
...
if.then.17:                                       ; preds = %if.then
  ...
  %20 = load i8, i8* %byte_buf19, align 1
...
if.end:                                           ; preds = %if.then.17, %if.then
  ...
  %23 = load i8, i8* %byte_buf24, align 1
  %24 = load %struct.Bitstream*, %struct.Bitstream** %dest, align 8
  %byte_pos = getelementptr inbounds %struct.Bitstream, %struct.Bitstream* %24, i32 0, i32 0
  %25 = load i32, i32* %byte_pos, align 4
  %inc = add nsw i32 %25, 1
  store i32 %inc, i32* %byte_pos, align 4
  %idxprom = sext i32 %25 to i64
  %26 = load %struct.Bitstream*, %struct.Bitstream** %dest, align 8
  %streamBuffer = getelementptr inbounds %struct.Bitstream, %struct.Bitstream* %26, i32 0, i32 9
  %27 = load i8*, i8** %streamBuffer, align 8
...
if.end.26:                                        ; preds = %if.end, %entry
  ...
  %30 = load i32, i32* %byte_pos27, align 4
  store i32 %30, i32* getelementptr inbounds (%struct.randomaccess_information_struct, %struct.randomaccess_information_struct* @seiRandomAccess, i32 0, i32 4), align 4
  ret void
}
