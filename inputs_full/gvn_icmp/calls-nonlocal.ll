...
define i32 @test(i32 %strlen, i32 %g, i8* %P) nounwind  {
entry:
	; %tmp2 = call i32 @strlen( i8* %P ) nounwind readonly 		; <i32> [#uses=1]
	%tmp3 = icmp eq i32 %strlen, 100		; <i1> [#uses=1]
...
bb6:		; preds = %entry
	...
	%tmp11 = icmp eq i32 %strlen, 100		; <i1> [#uses=1]
...
bb16:		; preds = %bb6
	...
	%tmp21 = icmp eq i32 %strlen, 100		; <i1> [#uses=1]
