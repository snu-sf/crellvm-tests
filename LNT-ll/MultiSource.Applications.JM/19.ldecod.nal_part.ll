; ModuleID = './MultiSource.Applications.JM/19.ldecod.nal_part.bc'
...
@assignSE2partition = global [2 x [20 x i32]] [[20 x i32] zeroinitializer, [20 x i32] [i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 0, i32 1, i32 1, i32 1, i32 1, i32 0, i32 2, i32 2, i32 2, i32 2, i32 0, i32 0, i32 0, i32 0]], align 16
...
@PartitionMode = common global i32 0, align 4

; Function Attrs: nounwind uwtable
define void @free_Partition(%struct.Bitstream* %currStream) #0 {
entry:
  ...
  %streamBuffer = getelementptr inbounds %struct.Bitstream, %struct.Bitstream* %0, i32 0, i32 4
  ...
  store i32 0, i32* %bitstream_length, align 4
  %3 = load %struct.Bitstream*, %struct.Bitstream** %currStream.addr, align 8
  %frame_bitoffset = getelementptr inbounds %struct.Bitstream, %struct.Bitstream* %3, i32 0, i32 2
  store i32 0, i32* %frame_bitoffset, align 4
  %4 = load %struct.Bitstream*, %struct.Bitstream** %currStream.addr, align 8
  %ei_flag = getelementptr inbounds %struct.Bitstream, %struct.Bitstream* %4, i32 0, i32 5
  store i32 0, i32* %ei_flag, align 4
  %5 = load i8*, i8** %buf, align 8
  call void @llvm.memset.p0i8.i64(i8* %5, i8 0, i64 8000000, i32 1, i1 false)
  ret void
}
