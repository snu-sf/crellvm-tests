; ModuleID = './MultiSource.Applications.SPASS/35.hash.bc'
...
@hash_TABLE = common global [29 x %struct.LIST_HELP*] zeroinitializer, align 16
...
for.body:                                         ; preds = %for.cond
  ...
  call void @hash_PutList(i32 %1, %struct.LIST_HELP* %call)
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  %1 = load i32, i32* %i, align 4
  %call = call %struct.LIST_HELP* @hash_List(i32 %1)
...
while.end:                                        ; preds = %while.cond
  ...
  %call4 = call %struct.LIST_HELP* @hash_List(i32 %6)
  call void @list_Delete(%struct.LIST_HELP* %call4)
  %7 = load i32, i32* %i, align 4
  %call5 = call %struct.LIST_HELP* @list_Nil()
  call void @hash_PutList(i32 %7, %struct.LIST_HELP* %call5)
  br label %for.inc
...
; Function Attrs: nounwind uwtable
define void @hash_ResetWithValue(void (i8*)* %ValueDelete) #0 {
entry:
...
while.body:                                       ; preds = %while.cond
  %3 = load void (i8*)*, void (i8*)** %ValueDelete.addr, align 8
...
while.end:                                        ; preds = %while.cond
  ...
  %call6 = call %struct.LIST_HELP* @hash_List(i32 %9)
  call void @list_Delete(%struct.LIST_HELP* %call6)
  %10 = load i32, i32* %i, align 4
  %call7 = call %struct.LIST_HELP* @list_Nil()
  call void @hash_PutList(i32 %10, %struct.LIST_HELP* %call7)
  br label %for.inc
...
entry:
  ...
  %call1 = call %struct.LIST_HELP* @hash_List(i32 %call)
...
while.body:                                       ; preds = %while.cond
  ...
  %3 = bitcast i8* %call3 to %struct.LIST_HELP*
  %call4 = call i8* @list_PairFirst(%struct.LIST_HELP* %3)
  %4 = load i8*, i8** %key.addr, align 8
  %cmp = icmp eq i8* %call4, %4
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %while.body
  %5 = load %struct.LIST_HELP*, %struct.LIST_HELP** %Scan, align 8
  %call5 = call i8* @list_Car(%struct.LIST_HELP* %5)
  %6 = bitcast i8* %call5 to %struct.LIST_HELP*
  %call6 = call i8* @list_PairSecond(%struct.LIST_HELP* %6)
