; ModuleID = './SingleSource.Benchmarks.BenchmarkGame/3.n-body.bc'
...
for.body:                                         ; preds = %for.cond
  ...
  %3 = load %struct.planet*, %struct.planet** %bodies.addr, align 8
  %arrayidx = getelementptr inbounds %struct.planet, %struct.planet* %3, i64 %idxprom
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %8 = load %struct.planet*, %struct.planet** %bodies.addr, align 8
  %arrayidx5 = getelementptr inbounds %struct.planet, %struct.planet* %8, i64 %idxprom4
...
for.cond.46:                                      ; preds = %for.inc.64, %for.end.45
  ...
  br i1 %cmp47, label %for.body.48, label %for.end.66

for.body.48:                                      ; preds = %for.cond.46
  %71 = load i32, i32* %i, align 4
  %idxprom50 = sext i32 %71 to i64
  %72 = load %struct.planet*, %struct.planet** %bodies.addr, align 8
  %arrayidx51 = getelementptr inbounds %struct.planet, %struct.planet* %72, i64 %idxprom50
...
for.body.13:                                      ; preds = %for.cond.11
  ...
  %23 = load %struct.planet*, %struct.planet** %bodies.addr, align 8
  %arrayidx15 = getelementptr inbounds %struct.planet, %struct.planet* %23, i64 %idxprom14
...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load %struct.planet*, %struct.planet** %bodies.addr, align 8
  %arrayidx2 = getelementptr inbounds %struct.planet, %struct.planet* %6, i64 %idxprom1
  ...
  %10 = load %struct.planet*, %struct.planet** %bodies.addr, align 8
  %arrayidx4 = getelementptr inbounds %struct.planet, %struct.planet* %10, i64 %idxprom3
  %vy = getelementptr inbounds %struct.planet, %struct.planet* %arrayidx4, i32 0, i32 4
  %11 = load double, double* %vy, align 8
  %12 = load i32, i32* %i, align 4
  %idxprom5 = sext i32 %12 to i64
  %13 = load %struct.planet*, %struct.planet** %bodies.addr, align 8
  %arrayidx6 = getelementptr inbounds %struct.planet, %struct.planet* %13, i64 %idxprom5
  ...
  %17 = load %struct.planet*, %struct.planet** %bodies.addr, align 8
  %arrayidx11 = getelementptr inbounds %struct.planet, %struct.planet* %17, i64 %idxprom10
  %vz = getelementptr inbounds %struct.planet, %struct.planet* %arrayidx11, i32 0, i32 5
  %18 = load double, double* %vz, align 8
  %19 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %19 to i64
  %20 = load %struct.planet*, %struct.planet** %bodies.addr, align 8
  %arrayidx13 = getelementptr inbounds %struct.planet, %struct.planet* %20, i64 %idxprom12
