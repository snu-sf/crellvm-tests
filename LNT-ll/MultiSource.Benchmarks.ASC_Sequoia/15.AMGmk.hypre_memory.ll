; ModuleID = './MultiSource.Benchmarks.ASC_Sequoia/15.AMGmk.hypre_memory.bc'
...
@.str.1 = private unnamed_addr constant [98 x i8] c"/home/juneyoung.lee/undef/llvm-test-suite/MultiSource/Benchmarks/ASC_Sequoia/AMGmk/hypre_memory.c\00", align 1
...
entry:
  ...
  call void @hypre_error_handler(i8* getelementptr inbounds ([98 x i8], [98 x i8]* @.str.1, i32 0, i32 0), i32 78, i32 2)
  ret i32 0
}
...
if.else:                                          ; preds = %entry
  ...
  store i8* %call2, i8** %ptr.addr, align 8
  br label %if.end
...
if.then.7:                                        ; preds = %land.lhs.true
  ...
  %call8 = call i32 @hypre_OutOfMemory(i32 %6)
  br label %if.end.9
