; ModuleID = './MultiSource.Benchmarks.mediabench/82.gsm.toast.rpe.bc'
...
for.body:                                         ; preds = %for.cond
  ...
  %add7 = add nsw i32 %8, 3
  %idxprom8 = sext i32 %add7 to i64
  %9 = load i16*, i16** %e.addr, align 8
  %arrayidx9 = getelementptr inbounds i16, i16* %9, i64 %idxprom8
  ...
  %add19 = add nsw i32 %14, 5
  %idxprom20 = sext i32 %add19 to i64
  %15 = load i16*, i16** %e.addr, align 8
  %arrayidx21 = getelementptr inbounds i16, i16* %15, i64 %idxprom20
  ...
  %add25 = add nsw i32 %17, 6
  %idxprom26 = sext i32 %add25 to i64
  %18 = load i16*, i16** %e.addr, align 8
  %arrayidx27 = getelementptr inbounds i16, i16* %18, i64 %idxprom26
  %19 = load i16, i16* %arrayidx27, align 2
  %conv28 = sext i16 %19 to i64
  %mul29 = mul nsw i64 %conv28, 5741
  %add30 = add nsw i64 %add24, %mul29
  %20 = load i32, i32* %k, align 4
  %add31 = add nsw i32 %20, 7
  %idxprom32 = sext i32 %add31 to i64
  %21 = load i16*, i16** %e.addr, align 8
  %arrayidx33 = getelementptr inbounds i16, i16* %21, i64 %idxprom32
  ...
  %add37 = add nsw i32 %23, 9
  %idxprom38 = sext i32 %add37 to i64
  %24 = load i16*, i16** %e.addr, align 8
  %arrayidx39 = getelementptr inbounds i16, i16* %24, i64 %idxprom38
  %25 = load i16, i16* %arrayidx39, align 2
  ...
  %arrayidx45 = getelementptr inbounds i16, i16* %27, i64 %idxprom44
  %28 = load i16, i16* %arrayidx45, align 2
  ...
  %30 = load i64, i64* %L_result, align 8
  %shr = ashr i64 %30, 13
  store i64 %shr, i64* %L_result, align 8
  %31 = load i64, i64* %L_result, align 8
  %cmp50 = icmp slt i64 %31, -32768
...
cond.end:                                         ; preds = %cond.false.55, %cond.true.54
  %cond = phi i64 [ 32767, %cond.true.54 ], [ %33, %cond.false.55 ]
  br label %cond.end.56
...
cond.end.56:                                      ; preds = %cond.end, %cond.true
  ...
  %arrayidx60 = getelementptr inbounds i16, i16* %35, i64 %idxprom59
