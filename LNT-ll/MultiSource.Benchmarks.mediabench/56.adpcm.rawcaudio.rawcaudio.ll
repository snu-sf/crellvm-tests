; ModuleID = './MultiSource.Benchmarks.mediabench/56.adpcm.rawcaudio.rawcaudio.bc'
...
while.body:                                       ; preds = %entry, %if.end.5
  %call = call i64 @read(i32 0, i8* bitcast ([1000 x i16]* @sbuf to i8*), i64 2000)
...
if.end.5:                                         ; preds = %if.end
  ...
  %call8 = call i64 @write(i32 1, i8* getelementptr inbounds ([500 x i8], [500 x i8]* @abuf, i32 0, i32 0), i64 %conv7)
  br label %while.body
