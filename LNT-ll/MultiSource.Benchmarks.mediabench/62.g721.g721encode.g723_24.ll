; ModuleID = './MultiSource.Benchmarks.mediabench/62.g721.g721encode.g723_24.bc'
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  call void (i32, i32, i32, i32, i32, i32, i32, %struct.g72x_state*, ...) bitcast (void (...)* @update to void (i32, i32, i32, i32, i32, i32, i32, %struct.g72x_state*, ...)*)(i32 3, i32 %conv45, i32 %conv48, i32 %conv51, i32 %conv52, i32 %conv53, i32 %conv54, %struct.g72x_state* %34)
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  call void (i32, i32, i32, i32, i32, i32, i32, %struct.g72x_state*, ...) bitcast (void (...)* @update to void (i32, i32, i32, i32, i32, i32, i32, %struct.g72x_state*, ...)*)(i32 3, i32 %conv31, i32 %conv34, i32 %conv37, i32 %conv38, i32 %conv39, i32 %conv40, %struct.g72x_state* %27)
...
sw.bb:                                            ; preds = %cond.end
  ...
  %call44 = call i32 (i32, i32, i32, i32, i32, i16*, ...) bitcast (i32 (...)* @tandem_adjust_alaw to i32 (i32, i32, i32, i32, i32, i16*, ...)*)(i32 %conv41, i32 %conv42, i32 %conv43, i32 %32, i32 4, i16* getelementptr inbounds ([3 x i16], [3 x i16]* @qtab_723_24, i32 0, i32 0))
...
sw.bb.45:                                         ; preds = %cond.end
  ...
  %call49 = call i32 (i32, i32, i32, i32, i32, i16*, ...) bitcast (i32 (...)* @tandem_adjust_ulaw to i32 (i32, i32, i32, i32, i32, i16*, ...)*)(i32 %conv46, i32 %conv47, i32 %conv48, i32 %36, i32 4, i16* getelementptr inbounds ([3 x i16], [3 x i16]* @qtab_723_24, i32 0, i32 0))
