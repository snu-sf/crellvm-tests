; ModuleID = './MultiSource.Benchmarks.MiBench/202.telecomm-gsm.gsm_print.bc'
...
define i32 @gsm_print(%struct._IO_FILE* %f, %struct.gsm_state* %s, i8* %c) #0 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %223 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %arrayidx561 = getelementptr inbounds [8 x i16], [8 x i16]* %LARc, i32 0, i64 0
  %224 = load i16, i16* %arrayidx561, align 2
  %conv562 = sext i16 %224 to i32
  %arrayidx563 = getelementptr inbounds [8 x i16], [8 x i16]* %LARc, i32 0, i64 1
  %225 = load i16, i16* %arrayidx563, align 2
  %conv564 = sext i16 %225 to i32
  %arrayidx565 = getelementptr inbounds [8 x i16], [8 x i16]* %LARc, i32 0, i64 2
  %226 = load i16, i16* %arrayidx565, align 2
  %conv566 = sext i16 %226 to i32
  %arrayidx567 = getelementptr inbounds [8 x i16], [8 x i16]* %LARc, i32 0, i64 3
  %227 = load i16, i16* %arrayidx567, align 2
  %conv568 = sext i16 %227 to i32
  %arrayidx569 = getelementptr inbounds [8 x i16], [8 x i16]* %LARc, i32 0, i64 4
  %228 = load i16, i16* %arrayidx569, align 2
  %conv570 = sext i16 %228 to i32
  %arrayidx571 = getelementptr inbounds [8 x i16], [8 x i16]* %LARc, i32 0, i64 5
  %229 = load i16, i16* %arrayidx571, align 2
  %conv572 = sext i16 %229 to i32
  %arrayidx573 = getelementptr inbounds [8 x i16], [8 x i16]* %LARc, i32 0, i64 6
  %230 = load i16, i16* %arrayidx573, align 2
  %conv574 = sext i16 %230 to i32
  %arrayidx575 = getelementptr inbounds [8 x i16], [8 x i16]* %LARc, i32 0, i64 7
  %231 = load i16, i16* %arrayidx575, align 2
  %conv576 = sext i16 %231 to i32
  %call = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %223, i8* getelementptr inbounds ([62 x i8], [62 x i8]* @.str, i32 0, i32 0), i32 %conv562, i32 %conv564, i32 %conv566, i32 %conv568, i32 %conv570, i32 %conv572, i32 %conv574, i32 %conv576)
  %232 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %arrayidx577 = getelementptr inbounds [4 x i16], [4 x i16]* %Nc, i32 0, i64 0
  %233 = load i16, i16* %arrayidx577, align 2
  %conv578 = sext i16 %233 to i32
  %arrayidx579 = getelementptr inbounds [4 x i16], [4 x i16]* %bc, i32 0, i64 0
  %234 = load i16, i16* %arrayidx579, align 2
  %conv580 = sext i16 %234 to i32
  %arrayidx581 = getelementptr inbounds [4 x i16], [4 x i16]* %Mc, i32 0, i64 0
  %235 = load i16, i16* %arrayidx581, align 2
  %conv582 = sext i16 %235 to i32
  %arrayidx583 = getelementptr inbounds [4 x i16], [4 x i16]* %xmaxc, i32 0, i64 0
  %236 = load i16, i16* %arrayidx583, align 2
  %conv584 = sext i16 %236 to i32
  %call585 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %232, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.1, i32 0, i32 0), i32 %conv578, i32 %conv580, i32 %conv582, i32 %conv584)
  %237 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %arrayidx586 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 0
  %238 = load i16, i16* %arrayidx586, align 2
  %conv587 = sext i16 %238 to i32
  %arrayidx588 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 1
  %239 = load i16, i16* %arrayidx588, align 2
  %conv589 = sext i16 %239 to i32
  %arrayidx590 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 2
  %240 = load i16, i16* %arrayidx590, align 2
  %conv591 = sext i16 %240 to i32
  %arrayidx592 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 3
  %241 = load i16, i16* %arrayidx592, align 2
  %conv593 = sext i16 %241 to i32
  %arrayidx594 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 4
  %242 = load i16, i16* %arrayidx594, align 2
  %conv595 = sext i16 %242 to i32
  %arrayidx596 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 5
  %243 = load i16, i16* %arrayidx596, align 2
  %conv597 = sext i16 %243 to i32
  %arrayidx598 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 6
  %244 = load i16, i16* %arrayidx598, align 2
  %conv599 = sext i16 %244 to i32
  %arrayidx600 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 7
  %245 = load i16, i16* %arrayidx600, align 2
  %conv601 = sext i16 %245 to i32
  %arrayidx602 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 8
  %246 = load i16, i16* %arrayidx602, align 2
  %conv603 = sext i16 %246 to i32
  %arrayidx604 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 9
  %247 = load i16, i16* %arrayidx604, align 2
  %conv605 = sext i16 %247 to i32
  %arrayidx606 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 10
  %248 = load i16, i16* %arrayidx606, align 2
  %conv607 = sext i16 %248 to i32
  %arrayidx608 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 11
  %249 = load i16, i16* %arrayidx608, align 2
  %conv609 = sext i16 %249 to i32
  %arrayidx610 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 12
  %250 = load i16, i16* %arrayidx610, align 2
  %conv611 = sext i16 %250 to i32
  %call612 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %237, i8* getelementptr inbounds ([67 x i8], [67 x i8]* @.str.2, i32 0, i32 0), i32 %conv587, i32 %conv589, i32 %conv591, i32 %conv593, i32 %conv595, i32 %conv597, i32 %conv599, i32 %conv601, i32 %conv603, i32 %conv605, i32 %conv607, i32 %conv609, i32 %conv611)
  %251 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %arrayidx613 = getelementptr inbounds [4 x i16], [4 x i16]* %Nc, i32 0, i64 1
  %252 = load i16, i16* %arrayidx613, align 2
  %conv614 = sext i16 %252 to i32
  %arrayidx615 = getelementptr inbounds [4 x i16], [4 x i16]* %bc, i32 0, i64 1
  %253 = load i16, i16* %arrayidx615, align 2
  %conv616 = sext i16 %253 to i32
  %arrayidx617 = getelementptr inbounds [4 x i16], [4 x i16]* %Mc, i32 0, i64 1
  %254 = load i16, i16* %arrayidx617, align 2
  %conv618 = sext i16 %254 to i32
  %arrayidx619 = getelementptr inbounds [4 x i16], [4 x i16]* %xmaxc, i32 0, i64 1
  %255 = load i16, i16* %arrayidx619, align 2
  %conv620 = sext i16 %255 to i32
  %call621 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %251, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.3, i32 0, i32 0), i32 %conv614, i32 %conv616, i32 %conv618, i32 %conv620)
  %256 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %arrayidx622 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 13
  %257 = load i16, i16* %arrayidx622, align 2
  %conv623 = sext i16 %257 to i32
  %arrayidx624 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 14
  %258 = load i16, i16* %arrayidx624, align 2
  %conv625 = sext i16 %258 to i32
  %arrayidx626 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 15
  %259 = load i16, i16* %arrayidx626, align 2
  %conv627 = sext i16 %259 to i32
  %arrayidx628 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 16
  %260 = load i16, i16* %arrayidx628, align 2
  %conv629 = sext i16 %260 to i32
  %arrayidx630 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 17
  %261 = load i16, i16* %arrayidx630, align 2
  %conv631 = sext i16 %261 to i32
  %arrayidx632 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 18
  %262 = load i16, i16* %arrayidx632, align 2
  %conv633 = sext i16 %262 to i32
  %arrayidx634 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 19
  %263 = load i16, i16* %arrayidx634, align 2
  %conv635 = sext i16 %263 to i32
  %arrayidx636 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 20
  %264 = load i16, i16* %arrayidx636, align 2
  %conv637 = sext i16 %264 to i32
  %arrayidx638 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 21
  %265 = load i16, i16* %arrayidx638, align 2
  %conv639 = sext i16 %265 to i32
  %arrayidx640 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 22
  %266 = load i16, i16* %arrayidx640, align 2
  %conv641 = sext i16 %266 to i32
  %arrayidx642 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 23
  %267 = load i16, i16* %arrayidx642, align 2
  %conv643 = sext i16 %267 to i32
  %arrayidx644 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 24
  %268 = load i16, i16* %arrayidx644, align 2
  %conv645 = sext i16 %268 to i32
  %arrayidx646 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 25
  %269 = load i16, i16* %arrayidx646, align 2
  %conv647 = sext i16 %269 to i32
  %call648 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %256, i8* getelementptr inbounds ([67 x i8], [67 x i8]* @.str.2, i32 0, i32 0), i32 %conv623, i32 %conv625, i32 %conv627, i32 %conv629, i32 %conv631, i32 %conv633, i32 %conv635, i32 %conv637, i32 %conv639, i32 %conv641, i32 %conv643, i32 %conv645, i32 %conv647)
  %270 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %arrayidx649 = getelementptr inbounds [4 x i16], [4 x i16]* %Nc, i32 0, i64 2
  %271 = load i16, i16* %arrayidx649, align 2
  %conv650 = sext i16 %271 to i32
  %arrayidx651 = getelementptr inbounds [4 x i16], [4 x i16]* %bc, i32 0, i64 2
  %272 = load i16, i16* %arrayidx651, align 2
  %conv652 = sext i16 %272 to i32
  %arrayidx653 = getelementptr inbounds [4 x i16], [4 x i16]* %Mc, i32 0, i64 2
  %273 = load i16, i16* %arrayidx653, align 2
  %conv654 = sext i16 %273 to i32
  %arrayidx655 = getelementptr inbounds [4 x i16], [4 x i16]* %xmaxc, i32 0, i64 2
  %274 = load i16, i16* %arrayidx655, align 2
  %conv656 = sext i16 %274 to i32
  %call657 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %270, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.4, i32 0, i32 0), i32 %conv650, i32 %conv652, i32 %conv654, i32 %conv656)
  %275 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %arrayidx658 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 26
  %276 = load i16, i16* %arrayidx658, align 2
  %conv659 = sext i16 %276 to i32
  %arrayidx660 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 27
  %277 = load i16, i16* %arrayidx660, align 2
  %conv661 = sext i16 %277 to i32
  %arrayidx662 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 28
  %278 = load i16, i16* %arrayidx662, align 2
  %conv663 = sext i16 %278 to i32
  %arrayidx664 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 29
  %279 = load i16, i16* %arrayidx664, align 2
  %conv665 = sext i16 %279 to i32
  %arrayidx666 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 30
  %280 = load i16, i16* %arrayidx666, align 2
  %conv667 = sext i16 %280 to i32
  %arrayidx668 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 31
  %281 = load i16, i16* %arrayidx668, align 2
  %conv669 = sext i16 %281 to i32
  %arrayidx670 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 32
  %282 = load i16, i16* %arrayidx670, align 2
  %conv671 = sext i16 %282 to i32
  %arrayidx672 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 33
  %283 = load i16, i16* %arrayidx672, align 2
  %conv673 = sext i16 %283 to i32
  %arrayidx674 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 34
  %284 = load i16, i16* %arrayidx674, align 2
  %conv675 = sext i16 %284 to i32
  %arrayidx676 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 35
  %285 = load i16, i16* %arrayidx676, align 2
  %conv677 = sext i16 %285 to i32
  %arrayidx678 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 36
  %286 = load i16, i16* %arrayidx678, align 2
  %conv679 = sext i16 %286 to i32
  %arrayidx680 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 37
  %287 = load i16, i16* %arrayidx680, align 2
  %conv681 = sext i16 %287 to i32
  %arrayidx682 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 38
  %288 = load i16, i16* %arrayidx682, align 2
  %conv683 = sext i16 %288 to i32
  %call684 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %275, i8* getelementptr inbounds ([67 x i8], [67 x i8]* @.str.2, i32 0, i32 0), i32 %conv659, i32 %conv661, i32 %conv663, i32 %conv665, i32 %conv667, i32 %conv669, i32 %conv671, i32 %conv673, i32 %conv675, i32 %conv677, i32 %conv679, i32 %conv681, i32 %conv683)
  %289 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %arrayidx685 = getelementptr inbounds [4 x i16], [4 x i16]* %Nc, i32 0, i64 3
  %290 = load i16, i16* %arrayidx685, align 2
  %conv686 = sext i16 %290 to i32
  %arrayidx687 = getelementptr inbounds [4 x i16], [4 x i16]* %bc, i32 0, i64 3
  %291 = load i16, i16* %arrayidx687, align 2
  %conv688 = sext i16 %291 to i32
  %arrayidx689 = getelementptr inbounds [4 x i16], [4 x i16]* %Mc, i32 0, i64 3
  %292 = load i16, i16* %arrayidx689, align 2
  %conv690 = sext i16 %292 to i32
  %arrayidx691 = getelementptr inbounds [4 x i16], [4 x i16]* %xmaxc, i32 0, i64 3
  %293 = load i16, i16* %arrayidx691, align 2
  %conv692 = sext i16 %293 to i32
  %call693 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %289, i8* getelementptr inbounds ([45 x i8], [45 x i8]* @.str.5, i32 0, i32 0), i32 %conv686, i32 %conv688, i32 %conv690, i32 %conv692)
  %294 = load %struct._IO_FILE*, %struct._IO_FILE** %f.addr, align 8
  %arrayidx694 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 39
  %295 = load i16, i16* %arrayidx694, align 2
  %conv695 = sext i16 %295 to i32
  %arrayidx696 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 40
  %296 = load i16, i16* %arrayidx696, align 2
  %conv697 = sext i16 %296 to i32
  %arrayidx698 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 41
  %297 = load i16, i16* %arrayidx698, align 2
  %conv699 = sext i16 %297 to i32
  %arrayidx700 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 42
  %298 = load i16, i16* %arrayidx700, align 2
  %conv701 = sext i16 %298 to i32
  %arrayidx702 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 43
  %299 = load i16, i16* %arrayidx702, align 2
  %conv703 = sext i16 %299 to i32
  %arrayidx704 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 44
  %300 = load i16, i16* %arrayidx704, align 2
  %conv705 = sext i16 %300 to i32
  %arrayidx706 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 45
  %301 = load i16, i16* %arrayidx706, align 2
  %conv707 = sext i16 %301 to i32
  %arrayidx708 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 46
  %302 = load i16, i16* %arrayidx708, align 2
  %conv709 = sext i16 %302 to i32
  %arrayidx710 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 47
  %303 = load i16, i16* %arrayidx710, align 2
  %conv711 = sext i16 %303 to i32
  %arrayidx712 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 48
  %304 = load i16, i16* %arrayidx712, align 2
  %conv713 = sext i16 %304 to i32
  %arrayidx714 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 49
  %305 = load i16, i16* %arrayidx714, align 2
  %conv715 = sext i16 %305 to i32
  %arrayidx716 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 50
  %306 = load i16, i16* %arrayidx716, align 2
  %conv717 = sext i16 %306 to i32
  %arrayidx718 = getelementptr inbounds [52 x i16], [52 x i16]* %xmc, i32 0, i64 51
  %307 = load i16, i16* %arrayidx718, align 2
  %conv719 = sext i16 %307 to i32
  %call720 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %294, i8* getelementptr inbounds ([67 x i8], [67 x i8]* @.str.2, i32 0, i32 0), i32 %conv695, i32 %conv697, i32 %conv699, i32 %conv701, i32 %conv703, i32 %conv705, i32 %conv707, i32 %conv709, i32 %conv711, i32 %conv713, i32 %conv715, i32 %conv717, i32 %conv719)
