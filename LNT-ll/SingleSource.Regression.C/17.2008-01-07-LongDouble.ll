; ModuleID = './SingleSource.Regression.C/17.2008-01-07-LongDouble.bc'
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), x86_fp80 %0, x86_fp80 %1)
  ret i32 0
}
