; ModuleID = './SingleSource.Benchmarks.Polybench/12.linear-algebra.kernels.symm.symm.bc'
...
entry:
  ...
  %5 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  ...
  %arraydecay3 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %6, i32 0, i32 0
  ...
  call void @init_array(i32 %3, i32 %4, double* %alpha, double* %beta, [1024 x double]* %arraydecay, [1024 x double]* %arraydecay3, [1024 x double]* %arraydecay4)
  ...
  %arraydecay5 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %12, i32 0, i32 0
  %13 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  %arraydecay6 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %13, i32 0, i32 0
  ...
  call void @kernel_symm(i32 %8, i32 %9, double %10, double %11, [1024 x double]* %arraydecay5, [1024 x double]* %arraydecay6, [1024 x double]* %arraydecay7)
  %15 = load i32, i32* %ni, align 4
  %16 = load i32, i32* %nj, align 4
  %17 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %arraydecay8 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %17, i32 0, i32 0
  call void @print_array(i32 %15, i32 %16, [1024 x double]* %arraydecay8)
  %18 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  ...
  %21 = bitcast [1024 x [1024 x double]]* %20 to i8*
  call void @free(i8* %21) #5
  %22 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B, align 8
  %23 = bitcast [1024 x [1024 x double]]* %22 to i8*
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %11 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  ...
  %14 = load i32, i32* %ni.addr, align 4
  ...
  %17 = load [1024 x double]*, [1024 x double]** %B.addr, align 8
  %arrayidx15 = getelementptr inbounds [1024 x double], [1024 x double]* %17, i64 %idxprom14
...
for.body.27:                                      ; preds = %for.cond.24
  ...
  %arrayidx35 = getelementptr inbounds [1024 x double], [1024 x double]* %29, i64 %idxprom34
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %arrayidx11 = getelementptr inbounds [1024 x double], [1024 x double]* %13, i64 %idxprom10
  ...
  %17 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  %arrayidx16 = getelementptr inbounds [1024 x double], [1024 x double]* %17, i64 %idxprom15
  %arrayidx17 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx16, i32 0, i64 %idxprom14
  ...
  %arrayidx20 = getelementptr inbounds [1024 x double], [1024 x double]* %21, i64 %idxprom19
  ...
  %25 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  %arrayidx24 = getelementptr inbounds [1024 x double], [1024 x double]* %25, i64 %idxprom23
  %arrayidx25 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx24, i32 0, i64 %idxprom22
...
for.end:                                          ; preds = %for.cond.4
  ...
  %32 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  %arrayidx30 = getelementptr inbounds [1024 x double], [1024 x double]* %32, i64 %idxprom29
  %arrayidx31 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx30, i32 0, i64 %idxprom28
  ...
  %37 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  %arrayidx35 = getelementptr inbounds [1024 x double], [1024 x double]* %37, i64 %idxprom34
  %arrayidx36 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx35, i32 0, i64 %idxprom33
  ...
  %arrayidx40 = getelementptr inbounds [1024 x double], [1024 x double]* %41, i64 %idxprom39
  %arrayidx41 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx40, i32 0, i64 %idxprom38
  ...
  %47 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  %arrayidx48 = getelementptr inbounds [1024 x double], [1024 x double]* %47, i64 %idxprom47
  %arrayidx49 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx48, i32 0, i64 %idxprom46
