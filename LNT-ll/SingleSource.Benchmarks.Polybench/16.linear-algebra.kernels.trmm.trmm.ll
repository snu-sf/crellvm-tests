; ModuleID = './SingleSource.Benchmarks.Polybench/16.linear-algebra.kernels.trmm.trmm.bc'
...
entry:
  ...
  store [1024 x [1024 x double]]* %1, [1024 x [1024 x double]]** %B, align 8
  %2 = load i32, i32* %ni, align 4
  %3 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  %arraydecay = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %3, i32 0, i32 0
  %4 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B, align 8
  %arraydecay2 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %4, i32 0, i32 0
  call void @init_array(i32 %2, double* %alpha, [1024 x double]* %arraydecay, [1024 x double]* %arraydecay2)
  ...
  call void @kernel_trmm(i32 %5, double %6, [1024 x double]* %arraydecay3, [1024 x double]* %arraydecay4)
  %9 = load i32, i32* %ni, align 4
  %10 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B, align 8
  %arraydecay5 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %10, i32 0, i32 0
  call void @print_array(i32 %9, [1024 x double]* %arraydecay5)
  %11 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  %12 = bitcast [1024 x [1024 x double]]* %11 to i8*
  call void @free(i8* %12) #5
  %13 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B, align 8
  %14 = bitcast [1024 x [1024 x double]]* %13 to i8*
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds [1024 x double], [1024 x double]* %10, i64 %idxprom6
...
for.body.6:                                       ; preds = %for.cond.3
  ...
  %9 = load [1024 x double]*, [1024 x double]** %B.addr, align 8
