; ModuleID = './SingleSource.Benchmarks.Polybench/13.linear-algebra.kernels.syr2k.syr2k.bc'
...
entry:
  ...
  call void @kernel_syr2k(i32 %8, i32 %9, double %10, double %11, [1024 x double]* %arraydecay5, [1024 x double]* %arraydecay6, [1024 x double]* %arraydecay7)
  %15 = load i32, i32* %ni, align 4
  %16 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %arraydecay8 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %16, i32 0, i32 0
  call void @print_array(i32 %15, [1024 x double]* %arraydecay8)
  %17 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %18 = bitcast [1024 x [1024 x double]]* %17 to i8*
  call void @free(i8* %18) #5
  %19 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  %20 = bitcast [1024 x [1024 x double]]* %19 to i8*
  call void @free(i8* %20) #5
  %21 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %B, align 8
  %22 = bitcast [1024 x [1024 x double]]* %21 to i8*
...
for.cond.20:                                      ; preds = %for.inc.40, %for.end.19
  ...
  %21 = load i32, i32* %ni.addr, align 4
...
for.body.27:                                      ; preds = %for.cond.24
  ...
  %29 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds [1024 x double], [1024 x double]* %7, i64 %idxprom4
...
for.cond.15:                                      ; preds = %for.inc.47, %for.body.14
...
for.body.17:                                      ; preds = %for.cond.15
  ...
  %20 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
  ...
  %24 = load [1024 x double]*, [1024 x double]** %B.addr, align 8
  ...
  %mul27 = fmul double %mul22, %25
  %26 = load i32, i32* %j, align 4
  %idxprom28 = sext i32 %26 to i64
  %27 = load i32, i32* %i, align 4
  %idxprom29 = sext i32 %27 to i64
  %28 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  %arrayidx30 = getelementptr inbounds [1024 x double], [1024 x double]* %28, i64 %idxprom29
  ...
  %33 = load [1024 x double]*, [1024 x double]** %B.addr, align 8
  %arrayidx34 = getelementptr inbounds [1024 x double], [1024 x double]* %33, i64 %idxprom33
  ...
  %mul41 = fmul double %mul36, %38
  %39 = load i32, i32* %j, align 4
  %idxprom42 = sext i32 %39 to i64
  %40 = load i32, i32* %i, align 4
  %idxprom43 = sext i32 %40 to i64
  %41 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
  %arrayidx44 = getelementptr inbounds [1024 x double], [1024 x double]* %41, i64 %idxprom43
  %arrayidx45 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx44, i32 0, i64 %idxprom42
  %42 = load double, double* %arrayidx45, align 8
  %add46 = fadd double %42, %mul41
  store double %add46, double* %arrayidx45, align 8
  br label %for.inc.47

for.inc.47:                                       ; preds = %for.body.17
