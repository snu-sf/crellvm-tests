; ModuleID = './SingleSource.Benchmarks.Polybench/27.stencils.jacobi-1d-imper.jacobi-1d-imper.bc'
...
entry:
  ...
  store [10000 x double]* %1, [10000 x double]** %B, align 8
  %2 = load i32, i32* %n, align 4
  %3 = load [10000 x double]*, [10000 x double]** %A, align 8
  %arraydecay = getelementptr inbounds [10000 x double], [10000 x double]* %3, i32 0, i32 0
  %4 = load [10000 x double]*, [10000 x double]** %B, align 8
  %arraydecay2 = getelementptr inbounds [10000 x double], [10000 x double]* %4, i32 0, i32 0
  call void @init_array(i32 %2, double* %arraydecay, double* %arraydecay2)
  %5 = load i32, i32* %tsteps, align 4
  %6 = load i32, i32* %n, align 4
  %7 = load [10000 x double]*, [10000 x double]** %A, align 8
  %arraydecay3 = getelementptr inbounds [10000 x double], [10000 x double]* %7, i32 0, i32 0
  %8 = load [10000 x double]*, [10000 x double]** %B, align 8
  %arraydecay4 = getelementptr inbounds [10000 x double], [10000 x double]* %8, i32 0, i32 0
  call void @kernel_jacobi_1d_imper(i32 %5, i32 %6, double* %arraydecay3, double* %arraydecay4)
  %9 = load i32, i32* %n, align 4
  %10 = load [10000 x double]*, [10000 x double]** %A, align 8
  %arraydecay5 = getelementptr inbounds [10000 x double], [10000 x double]* %10, i32 0, i32 0
  call void @print_array(i32 %9, double* %arraydecay5)
  %11 = load [10000 x double]*, [10000 x double]** %A, align 8
  %12 = bitcast [10000 x double]* %11 to i8*
  call void @free(i8* %12) #5
  %13 = load [10000 x double]*, [10000 x double]** %B, align 8
  %14 = bitcast [10000 x double]* %13 to i8*
