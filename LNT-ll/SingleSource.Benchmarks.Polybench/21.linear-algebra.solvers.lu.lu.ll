; ModuleID = './SingleSource.Benchmarks.Polybench/21.linear-algebra.solvers.lu.lu.bc'
...
entry:
  ...
  %2 = load [128 x [128 x double]]*, [128 x [128 x double]]** %A, align 8
  %arraydecay = getelementptr inbounds [128 x [128 x double]], [128 x [128 x double]]* %2, i32 0, i32 0
  call void @init_array(i32 %1, [128 x double]* %arraydecay)
  %3 = load i32, i32* %n, align 4
  %4 = load [128 x [128 x double]]*, [128 x [128 x double]]** %A, align 8
  %arraydecay1 = getelementptr inbounds [128 x [128 x double]], [128 x [128 x double]]* %4, i32 0, i32 0
  call void @kernel_lu(i32 %3, [128 x double]* %arraydecay1)
  %5 = load i32, i32* %n, align 4
  %6 = load [128 x [128 x double]]*, [128 x [128 x double]]** %A, align 8
  %arraydecay2 = getelementptr inbounds [128 x [128 x double]], [128 x [128 x double]]* %6, i32 0, i32 0
  call void @print_array(i32 %5, [128 x double]* %arraydecay2)
  %7 = load [128 x [128 x double]]*, [128 x [128 x double]]** %A, align 8
  %8 = bitcast [128 x [128 x double]]* %7 to i8*
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds [128 x double], [128 x double]* %9, i64 %idxprom7
  %arrayidx8 = getelementptr inbounds [128 x double], [128 x double]* %arrayidx, i32 0, i64 %idxprom
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds [128 x double], [128 x double]* %7, i64 %idxprom4
  %arrayidx5 = getelementptr inbounds [128 x double], [128 x double]* %arrayidx, i32 0, i64 %idxprom
  %8 = load double, double* %arrayidx5, align 8
  %9 = load i32, i32* %k, align 4
  %idxprom6 = sext i32 %9 to i64
  %10 = load i32, i32* %k, align 4
  %idxprom7 = sext i32 %10 to i64
  %11 = load [128 x double]*, [128 x double]** %A.addr, align 8
  %arrayidx8 = getelementptr inbounds [128 x double], [128 x double]* %11, i64 %idxprom7
  %arrayidx9 = getelementptr inbounds [128 x double], [128 x double]* %arrayidx8, i32 0, i64 %idxprom6
  ...
  %15 = load [128 x double]*, [128 x double]** %A.addr, align 8
  %arrayidx12 = getelementptr inbounds [128 x double], [128 x double]* %15, i64 %idxprom11
  %arrayidx13 = getelementptr inbounds [128 x double], [128 x double]* %arrayidx12, i32 0, i64 %idxprom10
...
for.cond.19:                                      ; preds = %for.inc.39, %for.body.17
...
for.body.21:                                      ; preds = %for.cond.19
  ...
  %25 = load [128 x double]*, [128 x double]** %A.addr, align 8
  %arrayidx24 = getelementptr inbounds [128 x double], [128 x double]* %25, i64 %idxprom23
  ...
  %29 = load [128 x double]*, [128 x double]** %A.addr, align 8
  %arrayidx28 = getelementptr inbounds [128 x double], [128 x double]* %29, i64 %idxprom27
  ...
  %33 = load [128 x double]*, [128 x double]** %A.addr, align 8
  %arrayidx32 = getelementptr inbounds [128 x double], [128 x double]* %33, i64 %idxprom31
  %arrayidx33 = getelementptr inbounds [128 x double], [128 x double]* %arrayidx32, i32 0, i64 %idxprom30
  ...
  %37 = load [128 x double]*, [128 x double]** %A.addr, align 8
  %arrayidx37 = getelementptr inbounds [128 x double], [128 x double]* %37, i64 %idxprom36
  %arrayidx38 = getelementptr inbounds [128 x double], [128 x double]* %arrayidx37, i32 0, i64 %idxprom35
...
for.body.6:                                       ; preds = %for.cond.3
  ...
  %9 = load [128 x double]*, [128 x double]** %A.addr, align 8
  %arrayidx9 = getelementptr inbounds [128 x double], [128 x double]* %9, i64 %idxprom8
  %arrayidx10 = getelementptr inbounds [128 x double], [128 x double]* %arrayidx9, i32 0, i64 %idxprom7
