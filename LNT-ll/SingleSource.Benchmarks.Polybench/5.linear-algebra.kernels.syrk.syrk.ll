; ModuleID = './SingleSource.Benchmarks.Polybench/5.linear-algebra.kernels.syrk.syrk.bc'
...
entry:
  ...
  %3 = load i32, i32* %nj, align 4
  %4 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  ...
  %arraydecay2 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %5, i32 0, i32 0
  call void @init_array(i32 %2, i32 %3, double* %alpha, double* %beta, [1024 x double]* %arraydecay, [1024 x double]* %arraydecay2)
  %6 = load i32, i32* %ni, align 4
  %7 = load i32, i32* %nj, align 4
  %8 = load double, double* %alpha, align 8
  %9 = load double, double* %beta, align 8
  %10 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %arraydecay3 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %10, i32 0, i32 0
  %11 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %A, align 8
  %arraydecay4 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %11, i32 0, i32 0
  call void @kernel_syrk(i32 %6, i32 %7, double %8, double %9, [1024 x double]* %arraydecay3, [1024 x double]* %arraydecay4)
  %12 = load i32, i32* %ni, align 4
  %13 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %C, align 8
  %arraydecay5 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %13, i32 0, i32 0
  call void @print_array(i32 %12, [1024 x double]* %arraydecay5)
...
for.body.18:                                      ; preds = %for.cond.15
  ...
  %23 = load [1024 x double]*, [1024 x double]** %C.addr, align 8
...
for.cond.9:                                       ; preds = %for.inc.38, %for.end.8
  ...
  br i1 %cmp10, label %for.body.11, label %for.end.40
...
for.body.17:                                      ; preds = %for.cond.15
  ...
  %24 = load [1024 x double]*, [1024 x double]** %A.addr, align 8
