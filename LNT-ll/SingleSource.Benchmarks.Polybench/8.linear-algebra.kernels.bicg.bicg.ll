; ModuleID = './SingleSource.Benchmarks.Polybench/8.linear-algebra.kernels.bicg.bicg.bc'
...
entry:
  ...
  %8 = load [4000 x double]*, [4000 x double]** %r, align 8
  %arraydecay5 = getelementptr inbounds [4000 x double], [4000 x double]* %8, i32 0, i32 0
  %9 = load [4000 x double]*, [4000 x double]** %p, align 8
  %arraydecay6 = getelementptr inbounds [4000 x double], [4000 x double]* %9, i32 0, i32 0
  ...
  %arraydecay7 = getelementptr inbounds [4000 x [4000 x double]], [4000 x [4000 x double]]* %12, i32 0, i32 0
  %13 = load [4000 x double]*, [4000 x double]** %s, align 8
  %arraydecay8 = getelementptr inbounds [4000 x double], [4000 x double]* %13, i32 0, i32 0
  %14 = load [4000 x double]*, [4000 x double]** %q, align 8
  %arraydecay9 = getelementptr inbounds [4000 x double], [4000 x double]* %14, i32 0, i32 0
  %15 = load [4000 x double]*, [4000 x double]** %p, align 8
  %arraydecay10 = getelementptr inbounds [4000 x double], [4000 x double]* %15, i32 0, i32 0
  %16 = load [4000 x double]*, [4000 x double]** %r, align 8
  ...
  %19 = load [4000 x double]*, [4000 x double]** %s, align 8
  %arraydecay12 = getelementptr inbounds [4000 x double], [4000 x double]* %19, i32 0, i32 0
  %20 = load [4000 x double]*, [4000 x double]** %q, align 8
  %arraydecay13 = getelementptr inbounds [4000 x double], [4000 x double]* %20, i32 0, i32 0
  call void @print_array(i32 %17, i32 %18, double* %arraydecay12, double* %arraydecay13)
  ...
  %23 = load [4000 x double]*, [4000 x double]** %s, align 8
  %24 = bitcast [4000 x double]* %23 to i8*
  call void @free(i8* %24) #5
  %25 = load [4000 x double]*, [4000 x double]** %q, align 8
  %26 = bitcast [4000 x double]* %25 to i8*
  call void @free(i8* %26) #5
  %27 = load [4000 x double]*, [4000 x double]** %p, align 8
...
for.cond.1:                                       ; preds = %for.inc.24, %for.end
  ...
  br i1 %cmp2, label %for.body.4, label %for.end.26
...
for.body.12:                                      ; preds = %for.cond.9
  ...
  %arrayidx19 = getelementptr inbounds [4000 x double], [4000 x double]* %18, i64 %idxprom18
  %arrayidx20 = getelementptr inbounds [4000 x double], [4000 x double]* %arrayidx19, i32 0, i64 %idxprom17
  store double %div, double* %arrayidx20, align 8
  br label %for.inc.21

for.inc.21:                                       ; preds = %for.body.12
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %8 = load double*, double** %q.addr, align 8
...
for.body.8:                                       ; preds = %for.cond.6
  ...
  %arrayidx15 = getelementptr inbounds [4000 x double], [4000 x double]* %19, i64 %idxprom14
  %arrayidx16 = getelementptr inbounds [4000 x double], [4000 x double]* %arrayidx15, i32 0, i64 %idxprom13
  ...
  %arrayidx23 = getelementptr inbounds [4000 x double], [4000 x double]* %28, i64 %idxprom22
  %arrayidx24 = getelementptr inbounds [4000 x double], [4000 x double]* %arrayidx23, i32 0, i64 %idxprom21
  %29 = load double, double* %arrayidx24, align 8
  %30 = load i32, i32* %j, align 4
  %idxprom25 = sext i32 %30 to i64
  %31 = load double*, double** %p.addr, align 8
  %arrayidx26 = getelementptr inbounds double, double* %31, i64 %idxprom25
  ...
  %34 = load double*, double** %q.addr, align 8
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %mul1 = mul nsw i32 %5, 16
  %idxprom = sext i32 %mul1 to i64
  %6 = load i8*, i8** %printmat, align 8
