; ModuleID = './SingleSource.Benchmarks.Polybench/7.linear-algebra.kernels.trisolv.trisolv.bc'
...
entry:
  ...
  store [4000 x double]* %2, [4000 x double]** %c, align 8
  %3 = load i32, i32* %n, align 4
  %4 = load [4000 x [4000 x double]]*, [4000 x [4000 x double]]** %A, align 8
  %arraydecay = getelementptr inbounds [4000 x [4000 x double]], [4000 x [4000 x double]]* %4, i32 0, i32 0
  %5 = load [4000 x double]*, [4000 x double]** %x, align 8
  %arraydecay3 = getelementptr inbounds [4000 x double], [4000 x double]* %5, i32 0, i32 0
  %6 = load [4000 x double]*, [4000 x double]** %c, align 8
  %arraydecay4 = getelementptr inbounds [4000 x double], [4000 x double]* %6, i32 0, i32 0
  call void @init_array(i32 %3, [4000 x double]* %arraydecay, double* %arraydecay3, double* %arraydecay4)
  %7 = load i32, i32* %n, align 4
  %8 = load [4000 x [4000 x double]]*, [4000 x [4000 x double]]** %A, align 8
  %arraydecay5 = getelementptr inbounds [4000 x [4000 x double]], [4000 x [4000 x double]]* %8, i32 0, i32 0
  %9 = load [4000 x double]*, [4000 x double]** %x, align 8
  %arraydecay6 = getelementptr inbounds [4000 x double], [4000 x double]* %9, i32 0, i32 0
  %10 = load [4000 x double]*, [4000 x double]** %c, align 8
  ...
  %arraydecay8 = getelementptr inbounds [4000 x double], [4000 x double]* %12, i32 0, i32 0
  call void @print_array(i32 %11, double* %arraydecay8)
  %13 = load [4000 x [4000 x double]]*, [4000 x [4000 x double]]** %A, align 8
  %14 = bitcast [4000 x [4000 x double]]* %13 to i8*
  ...
  %17 = load [4000 x double]*, [4000 x double]** %c, align 8
...
for.body.8:                                       ; preds = %for.cond.5
  ...
  %arrayidx17 = getelementptr inbounds [4000 x double], [4000 x double]* %17, i64 %idxprom16
  %arrayidx18 = getelementptr inbounds [4000 x double], [4000 x double]* %arrayidx17, i32 0, i64 %idxprom15
...
for.end:                                          ; preds = %for.cond.3
  ...
  %arrayidx21 = getelementptr inbounds [4000 x double], [4000 x double]* %27, i64 %idxprom20
