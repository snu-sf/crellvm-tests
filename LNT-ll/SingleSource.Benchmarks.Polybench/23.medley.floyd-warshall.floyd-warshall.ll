; ModuleID = './SingleSource.Benchmarks.Polybench/23.medley.floyd-warshall.floyd-warshall.bc'
...
entry:
  ...
  store [1024 x [1024 x double]]* %0, [1024 x [1024 x double]]** %path, align 8
  %1 = load i32, i32* %n, align 4
  %2 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path, align 8
  %arraydecay = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %2, i32 0, i32 0
  call void @init_array(i32 %1, [1024 x double]* %arraydecay)
  %3 = load i32, i32* %n, align 4
  %4 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path, align 8
  %arraydecay1 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %4, i32 0, i32 0
  call void @kernel_floyd_warshall(i32 %3, [1024 x double]* %arraydecay1)
  %5 = load i32, i32* %n, align 4
  %6 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path, align 8
  %arraydecay2 = getelementptr inbounds [1024 x [1024 x double]], [1024 x [1024 x double]]* %6, i32 0, i32 0
  call void @print_array(i32 %5, [1024 x double]* %arraydecay2)
  %7 = load [1024 x [1024 x double]]*, [1024 x [1024 x double]]** %path, align 8
  %8 = bitcast [1024 x [1024 x double]]* %7 to i8*
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %9 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %8 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  ...
  %12 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  ...
  %16 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  ...
  %add = fadd double %13, %17
  %cmp17 = fcmp olt double %9, %add
...
cond.true:                                        ; preds = %for.body.6
  ...
  %20 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
...
cond.false:                                       ; preds = %for.body.6
  ...
  %24 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  %arrayidx24 = getelementptr inbounds [1024 x double], [1024 x double]* %24, i64 %idxprom23
  ...
  %28 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  %arrayidx28 = getelementptr inbounds [1024 x double], [1024 x double]* %28, i64 %idxprom27
  %arrayidx29 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx28, i32 0, i64 %idxprom26
  %29 = load double, double* %arrayidx29, align 8
  %add30 = fadd double %25, %29
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi double [ %21, %cond.true ], [ %add30, %cond.false ]
  %30 = load i32, i32* %j, align 4
  %idxprom31 = sext i32 %30 to i64
  %31 = load i32, i32* %i, align 4
  %idxprom32 = sext i32 %31 to i64
  %32 = load [1024 x double]*, [1024 x double]** %path.addr, align 8
  %arrayidx33 = getelementptr inbounds [1024 x double], [1024 x double]* %32, i64 %idxprom32
  %arrayidx34 = getelementptr inbounds [1024 x double], [1024 x double]* %arrayidx33, i32 0, i64 %idxprom31
  store double %cond, double* %arrayidx34, align 8
  br label %for.inc
