; ModuleID = './SingleSource.Benchmarks.Polybench/3.linear-algebra.kernels.atax.atax.bc'
...
entry:
  ...
  %15 = load [4000 x double]*, [4000 x double]** %y, align 8
  %arraydecay9 = getelementptr inbounds [4000 x double], [4000 x double]* %15, i32 0, i32 0
  ...
  %20 = load [4000 x double]*, [4000 x double]** %y, align 8
  %21 = bitcast [4000 x double]* %20 to i8*
  call void @free(i8* %21) #5
  %22 = load [4000 x double]*, [4000 x double]** %tmp, align 8
...
for.cond.5:                                       ; preds = %for.inc.17, %for.body.4
...
for.body.8:                                       ; preds = %for.cond.5
  ...
  %arrayidx15 = getelementptr inbounds [4000 x double], [4000 x double]* %15, i64 %idxprom14
...
for.body.10:                                      ; preds = %for.cond.8
  ...
  %arrayidx15 = getelementptr inbounds [4000 x double], [4000 x double]* %16, i64 %idxprom14
  %arrayidx16 = getelementptr inbounds [4000 x double], [4000 x double]* %arrayidx15, i32 0, i64 %idxprom13
  ...
  %22 = load double*, double** %tmp.addr, align 8
...
for.body.26:                                      ; preds = %for.cond.24
  ...
  %arrayidx28 = getelementptr inbounds double, double* %27, i64 %idxprom27
  %28 = load double, double* %arrayidx28, align 8
  %29 = load i32, i32* %j, align 4
  %idxprom29 = sext i32 %29 to i64
  %30 = load i32, i32* %i, align 4
  %idxprom30 = sext i32 %30 to i64
  %31 = load [4000 x double]*, [4000 x double]** %A.addr, align 8
  %arrayidx31 = getelementptr inbounds [4000 x double], [4000 x double]* %31, i64 %idxprom30
  ...
  %arrayidx34 = getelementptr inbounds double, double* %34, i64 %idxprom33
