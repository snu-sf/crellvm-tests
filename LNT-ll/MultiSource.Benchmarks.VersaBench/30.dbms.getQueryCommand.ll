; ModuleID = './MultiSource.Benchmarks.VersaBench/30.dbms.getQueryCommand.bc'
...
define i64 @getQueryCommand(%struct._IO_FILE* %file, %struct.IndexKey* %searchKey, %struct.DataAttribute** %searchNonKey) #0 {
entry:
