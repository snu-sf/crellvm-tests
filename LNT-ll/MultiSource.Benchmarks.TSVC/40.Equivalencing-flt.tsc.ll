; ModuleID = './MultiSource.Benchmarks.TSVC/40.Equivalencing-flt.tsc.bc'
...
entry:
  ...
  %i = alloca i32, align 4
  %i15 = alloca i32, align 4
  %0 = load float*, float** @xx, align 8
  %call = call i32 @set1d(float* %0, float 1.000000e+00, i32 1)
...
for.body:                                         ; preds = %for.cond
  %3 = load float*, float** @xx, align 8
  store float* %3, float** @yy, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond.2
...
for.end:                                          ; preds = %for.cond.2
  ...
  %call10 = call i32 @dummy(float* %14, float* %15, float* %16, float* %17, float* %18, [256 x float]* %19, [256 x float]* %20, [256 x float]* %21, float 1.000000e+00)
  br label %for.inc.11
...
for.body.19:                                      ; preds = %for.cond.16
  ...
  %29 = load float*, float** @xx, align 8
  %arrayidx21 = getelementptr inbounds float, float* %29, i64 %idxprom20
  %30 = load float, float* %arrayidx21, align 4
  %31 = load float, float* @temp, align 4
  %add22 = fadd float %31, %30
  store float %add22, float* @temp, align 4
  br label %for.inc.23
...
entry:
  ...
  %call1 = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.101, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  %1 = load float*, float** @b, align 16
  %arrayidx = getelementptr inbounds float, float* %1, i64 16000
  store float* %arrayidx, float** @xx, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
entry:
  ...
  %i = alloca i32, align 4
  %i15 = alloca i32, align 4
  store float* getelementptr inbounds ([65536 x float], [65536 x float]* @array, i32 0, i64 4), float** @xx, align 8
  %0 = load float*, float** @xx, align 8
  %call = call i32 @set1d(float* %0, float 0.000000e+00, i32 1)
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %add = add nsw i32 %4, 8
  %idxprom = sext i32 %add to i64
  %arrayidx = getelementptr inbounds [65536 x float], [65536 x float]* @array, i32 0, i64 %idxprom
  ...
  %10 = load float*, float** @xx, align 8
...
for.body.19:                                      ; preds = %for.cond.16
  ...
  %27 = load float*, float** @xx, align 8
...
entry:
  ...
  %add.ptr = getelementptr inbounds float, float* getelementptr inbounds ([65536 x float], [65536 x float]* @array, i32 0, i32 0), i64 %idx.ext
  store float* %add.ptr, float** @xx, align 8
  %1 = load float*, float** @xx, align 8
  %call = call i32 @set1d(float* %1, float 1.000000e+00, i32 1)
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %arrayidx9 = getelementptr inbounds [65536 x float], [65536 x float]* @array, i32 0, i64 %idxprom8
  store float %add, float* %arrayidx9, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.2
  ...
  %call10 = call i32 @dummy(float* %13, float* %14, float* %15, float* %16, float* %17, [256 x float]* %18, [256 x float]* %19, [256 x float]* %20, float 1.000000e+00)
  br label %for.inc.11
...
for.body.19:                                      ; preds = %for.cond.16
  ...
  %arrayidx21 = getelementptr inbounds [65536 x float], [65536 x float]* @array, i32 0, i64 %idxprom20
  %28 = load float, float* %arrayidx21, align 4
  %29 = load float, float* @temp, align 4
  %add22 = fadd float %29, %28
  store float %add22, float* @temp, align 4
...
entry:
  ...
  store float* %add.ptr, float** @xx, align 8
  %1 = load float*, float** @xx, align 8
  %call = call i32 @set1d(float* %1, float 0.000000e+00, i32 1)
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %idxprom8 = sext i32 %add7 to i64
  %11 = load float*, float** @xx, align 8
