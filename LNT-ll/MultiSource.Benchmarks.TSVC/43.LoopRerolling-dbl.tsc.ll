; ModuleID = './MultiSource.Benchmarks.TSVC/43.LoopRerolling-dbl.tsc.bc'
...
entry:
  ...
  store i64 0, i64* %start_t, align 8
  %0 = load double*, double** @c, align 32
  %arrayidx = getelementptr inbounds double, double* %0, i64 0
  %1 = load double, double* %arrayidx, align 8
  store double %1, double* %alpha, align 8
...
for.end:                                          ; preds = %for.cond.1
  %41 = load double*, double** @a, align 32
  %42 = load double*, double** @b, align 32
  %43 = load double*, double** @c, align 32
  %44 = load double*, double** @d, align 32
  %45 = load double*, double** @e, align 32
  %46 = load [256 x double]*, [256 x double]** @aa, align 32
  %47 = load [256 x double]*, [256 x double]** @bb, align 32
  %48 = load [256 x double]*, [256 x double]** @cc, align 32
  %call41 = call i32 @dummy(double* %41, double* %42, double* %43, double* %44, double* %45, [256 x double]* %46, [256 x double]* %47, [256 x double]* %48, double 0.000000e+00)
  br label %for.inc.42
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  store double* %incdec.ptr, double** %A, align 8
  %12 = load double*, double** %B, align 8
  %incdec.ptr4 = getelementptr inbounds double, double* %12, i32 1
  store double* %incdec.ptr4, double** %B, align 8
  %13 = load double*, double** %C, align 8
  %incdec.ptr5 = getelementptr inbounds double, double* %13, i32 1
  store double* %incdec.ptr5, double** %C, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call6 = call i32 @dummy(double* %15, double* %16, double* %17, double* %18, double* %19, [256 x double]* %20, [256 x double]* %21, [256 x double]* %22, double 0.000000e+00)
  br label %for.inc.7
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load double, double* %dot, align 8
  %4 = load i32, i32* %i, align 4
  %idxprom = sext i32 %4 to i64
  ...
  %mul6 = fmul double %6, %9
  %add = fadd double %3, %mul6
  %10 = load i32, i32* %i, align 4
  ...
  %mul21 = fmul double %18, %21
  %add22 = fadd double %add14, %mul21
  ...
  %arrayidx36 = getelementptr inbounds double, double* %32, i64 %idxprom35
  %33 = load double, double* %arrayidx36, align 8
  %mul37 = fmul double %30, %33
  %add38 = fadd double %add30, %mul37
  store double %add38, double* %dot, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %36 = load double*, double** @b, align 32
  %37 = load double*, double** @c, align 32
  %38 = load double*, double** @d, align 32
  %39 = load double*, double** @e, align 32
  %40 = load [256 x double]*, [256 x double]** @aa, align 32
  %41 = load [256 x double]*, [256 x double]** @bb, align 32
  %42 = load [256 x double]*, [256 x double]** @cc, align 32
  %43 = load double, double* %dot, align 8
  %call40 = call i32 @dummy(double* %35, double* %36, double* %37, double* %38, double* %39, [256 x double]* %40, [256 x double]* %41, [256 x double]* %42, double %43)
  br label %for.inc.41
...
for.end.42:                                       ; preds = %for.cond
  ...
  %49 = load double, double* %dot, align 8
  store double %49, double* @temp, align 8
  call void @check(i32 -1)
  ret i32 0
}
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %mul44 = fmul double %41, %46
  %47 = load i32, i32* %i, align 4
  %add45 = add nsw i32 %47, 4
  %idxprom46 = sext i32 %add45 to i64
  %48 = load double*, double** @a, align 32
  %arrayidx47 = getelementptr inbounds double, double* %48, i64 %idxprom46
  %49 = load double, double* %arrayidx47, align 8
  %add48 = fadd double %49, %mul44
...
for.end:                                          ; preds = %for.cond.1
  %51 = load double*, double** @a, align 32
  %52 = load double*, double** @b, align 32
  %53 = load double*, double** @c, align 32
  %54 = load double*, double** @d, align 32
  %55 = load double*, double** @e, align 32
  %56 = load [256 x double]*, [256 x double]** @aa, align 32
  %57 = load [256 x double]*, [256 x double]** @bb, align 32
  %58 = load [256 x double]*, [256 x double]** @cc, align 32
  %call50 = call i32 @dummy(double* %51, double* %52, double* %53, double* %54, double* %55, [256 x double]* %56, [256 x double]* %57, [256 x double]* %58, double 0.000000e+00)
  br label %for.inc.51
