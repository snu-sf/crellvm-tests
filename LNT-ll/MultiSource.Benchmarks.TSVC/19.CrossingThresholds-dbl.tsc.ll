; ModuleID = './MultiSource.Benchmarks.TSVC/19.CrossingThresholds-dbl.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S281\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [15 x i8] c"S1281\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [14 x i8] c"S291\09 %.2f \09\09\00", align 1
@.str.140 = private unnamed_addr constant [14 x i8] c"S292\09 %.2f \09\09\00", align 1
@.str.141 = private unnamed_addr constant [14 x i8] c"S293\09 %.2f \09\09\00", align 1
@.str.142 = private unnamed_addr constant [15 x i8] c"S2101\09 %.2f \09\09\00", align 1
@.str.143 = private unnamed_addr constant [15 x i8] c"S2102\09 %.2f \09\09\00", align 1
@.str.144 = private unnamed_addr constant [15 x i8] c"S2111\09 %.2f \09\09\00", align 1
...
@.str.146 = private unnamed_addr constant [31 x i8] c"Running each loop %d times...\0A\00", align 1
@.str.147 = private unnamed_addr constant [30 x i8] c"Loop \09 Time(Sec) \09 Checksum \0A\00", align 1
@x = common global [32000 x double] zeroinitializer, align 32
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.65, i32 0, i32 0))
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %sub9 = fsub double %12, 1.000000e+00
  %13 = load i32, i32* %i, align 4
  %idxprom10 = sext i32 %13 to i64
  %14 = load double*, double** @a, align 32
  %arrayidx11 = getelementptr inbounds double, double* %14, i64 %idxprom10
  store double %sub9, double* %arrayidx11, align 8
...
for.end.17:                                       ; preds = %for.cond
  ...
  store i64 %sub18, i64* %clock_dif, align 8
  ...
  %call19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %31)
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call19 = call i32 @dummy(double* %25, double* %26, double* %27, double* %28, double* %29, [256 x double]* %30, [256 x double]* %31, [256 x double]* %32, double 0.000000e+00)
  br label %for.inc.20
...
for.end.22:                                       ; preds = %for.cond
  ...
  %call24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.138, i32 0, i32 0), double %37)
  call void @check(i32 12)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.66, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  store i32 31999, i32* %im1, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond.1
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds double, double* %4, i64 %idxprom
  %5 = load double, double* %arrayidx, align 8
  %6 = load i32, i32* %im1, align 4
  %idxprom4 = sext i32 %6 to i64
  %7 = load double*, double** @b, align 32
  %arrayidx5 = getelementptr inbounds double, double* %7, i64 %idxprom4
  %8 = load double, double* %arrayidx5, align 8
  %add = fadd double %5, %8
  %mul6 = fmul double %add, 5.000000e-01
  %9 = load i32, i32* %i, align 4
  %idxprom7 = sext i32 %9 to i64
  %10 = load double*, double** @a, align 32
  %arrayidx8 = getelementptr inbounds double, double* %10, i64 %idxprom7
...
for.end.12:                                       ; preds = %for.cond
  ...
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i32 0, i32 0), double %25)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.67, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  store i32 31999, i32* %im1, align 4
  store i32 31998, i32* %im2, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond.1
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %add8 = fadd double %add, %11
  %mul = fmul double %add8, 3.330000e-01
  %12 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %12 to i64
  %13 = load double*, double** @a, align 32
  %arrayidx10 = getelementptr inbounds double, double* %13, i64 %idxprom9
  store double %mul, double* %arrayidx10, align 8
  %14 = load i32, i32* %im1, align 4
  store i32 %14, i32* %im2, align 4
  %15 = load i32, i32* %i, align 4
  store i32 %15, i32* %im1, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call11 = call i32 @dummy(double* %17, double* %18, double* %19, double* %20, double* %21, [256 x double]* %22, [256 x double]* %23, [256 x double]* %24, double 0.000000e+00)
  br label %for.inc.12
...
for.end.14:                                       ; preds = %for.cond
  ...
  %call15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %29)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.68, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call5 = call i32 @dummy(double* %8, double* %9, double* %10, double* %11, double* %12, [256 x double]* %13, [256 x double]* %14, [256 x double]* %15, double 0.000000e+00)
  br label %for.inc.6
...
for.end.8:                                        ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %17 = load i64, i64* %end_t, align 8
  %18 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %17, %18
  store i64 %sub, i64* %clock_dif, align 8
  %19 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %19 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %20 = load double, double* %clock_dif_sec, align 8
  %call9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.141, i32 0, i32 0), double %20)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.69, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %5 = load [256 x double]*, [256 x double]** @bb, align 32
  %arrayidx = getelementptr inbounds [256 x double], [256 x double]* %5, i64 %idxprom4
  ...
  %arrayidx8 = getelementptr inbounds [256 x double], [256 x double]* %9, i64 %idxprom7
  %arrayidx9 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx8, i32 0, i64 %idxprom6
  %10 = load double, double* %arrayidx9, align 8
  %mul10 = fmul double %6, %10
  %11 = load i32, i32* %i, align 4
  %idxprom11 = sext i32 %11 to i64
  %12 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %12 to i64
  %13 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx13 = getelementptr inbounds [256 x double], [256 x double]* %13, i64 %idxprom12
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call15 = call i32 @dummy(double* %16, double* %17, double* %18, double* %19, double* %20, [256 x double]* %21, [256 x double]* %22, [256 x double]* %23, double 0.000000e+00)
  br label %for.inc.16
...
for.end.18:                                       ; preds = %for.cond
  ...
  %call19 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.142, i32 0, i32 0), double %28)
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.70, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.4
  ...
  store double 1.000000e+00, double* %arrayidx12, align 8
  br label %for.inc.13
...
for.end.15:                                       ; preds = %for.cond.1
  ...
  %call16 = call i32 @dummy(double* %12, double* %13, double* %14, double* %15, double* %16, [256 x double]* %17, [256 x double]* %18, [256 x double]* %19, double 0.000000e+00)
  br label %for.inc.17

for.inc.17:                                       ; preds = %for.end.15
...
for.end.19:                                       ; preds = %for.cond
  ...
  %div20 = fdiv double %conv, 1.000000e+06
  store double %div20, double* %clock_dif_sec, align 8
  %24 = load double, double* %clock_dif_sec, align 8
  %call21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.143, i32 0, i32 0), double %24)
  call void @check(i32 11)
  ret i32 0
}
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.71, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %arrayidx13 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx12, i32 0, i64 %idxprom9
...
for.end.24:                                       ; preds = %for.cond
  ...
  %29 = load double, double* %clock_dif_sec, align 8
  %call27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.144, i32 0, i32 0), double %29)
  store double 0.000000e+00, double* @temp, align 8
  store i32 0, i32* %i28, align 4
  br label %for.cond.29

for.cond.29:                                      ; preds = %for.inc.46, %for.end.24
  %30 = load i32, i32* %i28, align 4
  %cmp30 = icmp slt i32 %30, 256
...
for.cond.34:                                      ; preds = %for.inc.43, %for.body.32
  %31 = load i32, i32* %j33, align 4
  %cmp35 = icmp slt i32 %31, 256
  br i1 %cmp35, label %for.body.37, label %for.end.45

for.body.37:                                      ; preds = %for.cond.34
  %32 = load i32, i32* %j33, align 4
  ...
  %arrayidx40 = getelementptr inbounds [256 x double], [256 x double]* %34, i64 %idxprom39
  %arrayidx41 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx40, i32 0, i64 %idxprom38
  %35 = load double, double* %arrayidx41, align 8
  %36 = load double, double* @temp, align 8
  %add42 = fadd double %36, %35
  store double %add42, double* @temp, align 8
  br label %for.inc.43

for.inc.43:                                       ; preds = %for.body.37
  %37 = load i32, i32* %j33, align 4
  %inc44 = add nsw i32 %37, 1
  store i32 %inc44, i32* %j33, align 4
  br label %for.cond.34
...
for.end.48:                                       ; preds = %for.cond.29
  ...
  %cmp49 = fcmp oeq double %39, 0.000000e+00
  br i1 %cmp49, label %if.then, label %if.end

if.then:                                          ; preds = %for.end.48
  store double 3.000000e+00, double* @temp, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %for.end.48
  call void @check(i32 -1)
  ret i32 0
}
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.145, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.146, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.147, i32 0, i32 0))
  %call9 = call i32 @s281()
  %call10 = call i32 @s1281()
  %call11 = call i32 @s291()
  %call12 = call i32 @s292()
  %call13 = call i32 @s293()
  %call14 = call i32 @s2101()
  %call15 = call i32 @s2102()
  %call16 = call i32 @s2111()
  ret i32 0
}
