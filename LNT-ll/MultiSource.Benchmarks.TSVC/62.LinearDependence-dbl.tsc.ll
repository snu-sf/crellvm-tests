; ModuleID = './MultiSource.Benchmarks.TSVC/62.LinearDependence-dbl.tsc.bc'
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %arrayidx = getelementptr inbounds [32000 x double], [32000 x double]* @Y, i32 0, i64 %idxprom
  %4 = load double, double* %arrayidx, align 8
  %add = fadd double %4, 1.000000e+00
  %5 = load i32, i32* %i, align 4
  %idxprom4 = sext i32 %5 to i64
  %arrayidx5 = getelementptr inbounds [32000 x double], [32000 x double]* @X, i32 0, i64 %idxprom4
...
for.end:                                          ; preds = %for.cond.1
  %7 = load [256 x double]*, [256 x double]** @aa, align 32
  %8 = load [256 x double]*, [256 x double]** @bb, align 32
  %9 = load [256 x double]*, [256 x double]** @cc, align 32
  %call6 = call i32 @dummy(double* getelementptr inbounds ([32000 x double], [32000 x double]* @X, i32 0, i32 0), double* getelementptr inbounds ([32000 x double], [32000 x double]* @Y, i32 0, i32 0), double* getelementptr inbounds ([32000 x double], [32000 x double]* @Z, i32 0, i32 0), double* getelementptr inbounds ([32000 x double], [32000 x double]* @U, i32 0, i32 0), double* getelementptr inbounds ([32000 x double], [32000 x double]* @V, i32 0, i32 0), [256 x double]* %7, [256 x double]* %8, [256 x double]* %9, double 0.000000e+00)
  br label %for.inc.7
...
for.end:                                          ; preds = %for.cond.1
  ...
  %13 = load double*, double** @b, align 32
  %14 = load double*, double** @c, align 32
  %15 = load double*, double** @d, align 32
  %16 = load double*, double** @e, align 32
  %17 = load [256 x double]*, [256 x double]** @aa, align 32
  %18 = load [256 x double]*, [256 x double]** @bb, align 32
  %19 = load [256 x double]*, [256 x double]** @cc, align 32
  %call9 = call i32 @dummy(double* %12, double* %13, double* %14, double* %15, double* %16, [256 x double]* %17, [256 x double]* %18, [256 x double]* %19, double 0.000000e+00)
  br label %for.inc.10
...
for.end:                                          ; preds = %for.cond.1
  %36 = load double*, double** @a, align 32
  %37 = load double*, double** @b, align 32
  %38 = load double*, double** @c, align 32
  %39 = load double*, double** @d, align 32
  %40 = load double*, double** @e, align 32
  %41 = load [256 x double]*, [256 x double]** @aa, align 32
  %42 = load [256 x double]*, [256 x double]** @bb, align 32
  %43 = load [256 x double]*, [256 x double]** @cc, align 32
  %call33 = call i32 @dummy(double* %36, double* %37, double* %38, double* %39, double* %40, [256 x double]* %41, [256 x double]* %42, [256 x double]* %43, double 0.000000e+00)
  br label %for.inc.34
...
for.end:                                          ; preds = %for.cond.1
  %9 = load double*, double** @a, align 32
  %10 = load double*, double** @b, align 32
  %11 = load double*, double** @c, align 32
  %12 = load double*, double** @d, align 32
  %13 = load double*, double** @e, align 32
  %14 = load [256 x double]*, [256 x double]** @aa, align 32
  %15 = load [256 x double]*, [256 x double]** @bb, align 32
  %16 = load [256 x double]*, [256 x double]** @cc, align 32
  %call6 = call i32 @dummy(double* %9, double* %10, double* %11, double* %12, double* %13, [256 x double]* %14, [256 x double]* %15, [256 x double]* %16, double 0.000000e+00)
  br label %for.inc.7
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call7 = call i32 @dummy(double* %11, double* %12, double* %13, double* %14, double* %15, [256 x double]* %16, [256 x double]* %17, [256 x double]* %18, double 0.000000e+00)
  br label %for.inc.8
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load double*, double** @a, align 32
  %arrayidx = getelementptr inbounds double, double* %3, i64 16000
  %4 = load double, double* %arrayidx, align 8
  %5 = load i32, i32* %i, align 4
  %idxprom = sext i32 %5 to i64
  %6 = load double*, double** @b, align 32
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %7 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx = getelementptr inbounds [256 x double], [256 x double]* %7, i64 %idxprom7
  ...
  %arrayidx11 = getelementptr inbounds [256 x double], [256 x double]* %11, i64 %idxprom10
  ...
  %add = fadd double %8, %12
  %13 = load i32, i32* %j, align 4
  %idxprom13 = sext i32 %13 to i64
  %14 = load i32, i32* %i, align 4
  %idxprom14 = sext i32 %14 to i64
  %15 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx15 = getelementptr inbounds [256 x double], [256 x double]* %15, i64 %idxprom14
...
for.end.19:                                       ; preds = %for.cond.1
  ...
  %call20 = call i32 @dummy(double* %18, double* %19, double* %20, double* %21, double* %22, [256 x double]* %23, [256 x double]* %24, [256 x double]* %25, double 0.000000e+00)
  br label %for.inc.21
...
for.end.16:                                       ; preds = %for.cond.1
  ...
  %call17 = call i32 @dummy(double* %17, double* %18, double* %19, double* %20, double* %21, [256 x double]* %22, [256 x double]* %23, [256 x double]* %24, double 0.000000e+00)
  br label %for.inc.18
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %10 = load [256 x double]*, [256 x double]** @cc, align 32
  %arrayidx11 = getelementptr inbounds [256 x double], [256 x double]* %10, i64 %idxprom10
  %arrayidx12 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx11, i32 0, i64 %idxprom9
  %11 = load double, double* %arrayidx12, align 8
  %mul13 = fmul double %7, %11
  %12 = load i32, i32* %j, align 4
  %idxprom14 = sext i32 %12 to i64
  %13 = load i32, i32* %i, align 4
  %idxprom15 = sext i32 %13 to i64
  %14 = load [256 x double]*, [256 x double]** @bb, align 32
  %arrayidx16 = getelementptr inbounds [256 x double], [256 x double]* %14, i64 %idxprom15
  %arrayidx17 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx16, i32 0, i64 %idxprom14
...
for.end.24:                                       ; preds = %for.cond.1
  ...
  %call25 = call i32 @dummy(double* %21, double* %22, double* %23, double* %24, double* %25, [256 x double]* %26, [256 x double]* %27, [256 x double]* %28, double 0.000000e+00)
  br label %for.inc.26
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  store double %mul25, double* %arrayidx28, align 8
  %27 = load i32, i32* %i, align 4
  ...
  %arrayidx44 = getelementptr inbounds double, double* %39, i64 %idxprom43
  %40 = load double, double* %arrayidx44, align 8
  %mul45 = fmul double %37, %40
  ...
  store double %mul45, double* %arrayidx48, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  %44 = load double*, double** @a, align 32
  %45 = load double*, double** @b, align 32
  %46 = load double*, double** @c, align 32
  %47 = load double*, double** @d, align 32
  %48 = load double*, double** @e, align 32
  %49 = load [256 x double]*, [256 x double]** @aa, align 32
  %50 = load [256 x double]*, [256 x double]** @bb, align 32
  %51 = load [256 x double]*, [256 x double]** @cc, align 32
  %call50 = call i32 @dummy(double* %44, double* %45, double* %46, double* %47, double* %48, [256 x double]* %49, [256 x double]* %50, [256 x double]* %51, double 0.000000e+00)
  br label %for.inc.51
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %6 = load i32, i32* %j, align 4
  %idxprom7 = sext i32 %6 to i64
  %7 = load [256 x double]*, [256 x double]** @bb, align 32
  %arrayidx = getelementptr inbounds [256 x double], [256 x double]* %7, i64 %idxprom7
  %arrayidx8 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx, i32 0, i64 %idxprom
  %8 = load double, double* %arrayidx8, align 8
  %9 = load i32, i32* %i, align 4
...
for.end.18:                                       ; preds = %for.cond.1
  ...
  %24 = load [256 x double]*, [256 x double]** @bb, align 32
  %25 = load [256 x double]*, [256 x double]** @cc, align 32
  %call19 = call i32 @dummy(double* %18, double* %19, double* %20, double* %21, double* %22, [256 x double]* %23, [256 x double]* %24, [256 x double]* %25, double 0.000000e+00)
  br label %for.inc.20
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %6 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx = getelementptr inbounds [256 x double], [256 x double]* %6, i64 %idxprom8
  %arrayidx9 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx, i32 0, i64 %idxprom
  ...
  %arrayidx12 = getelementptr inbounds [256 x double], [256 x double]* %10, i64 %idxprom11
  %arrayidx13 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx12, i32 0, i64 %idxprom10
  %11 = load double, double* %arrayidx13, align 8
  %add = fadd double %7, %11
  %12 = load i32, i32* %j, align 4
  %idxprom14 = sext i32 %12 to i64
  %13 = load i32, i32* %i, align 4
  %idxprom15 = sext i32 %13 to i64
...
for.end.20:                                       ; preds = %for.cond.1
  ...
  %23 = load [256 x double]*, [256 x double]** @bb, align 32
  %24 = load [256 x double]*, [256 x double]** @cc, align 32
  %call21 = call i32 @dummy(double* %17, double* %18, double* %19, double* %20, double* %21, [256 x double]* %22, [256 x double]* %23, [256 x double]* %24, double 0.000000e+00)
  br label %for.inc.22
...
for.end.19:                                       ; preds = %for.cond.1
  ...
  %23 = load [256 x double]*, [256 x double]** @bb, align 32
  %24 = load [256 x double]*, [256 x double]** @cc, align 32
  %call20 = call i32 @dummy(double* %17, double* %18, double* %19, double* %20, double* %21, [256 x double]* %22, [256 x double]* %23, [256 x double]* %24, double 0.000000e+00)
  br label %for.inc.21
...
entry:
  ...
  %call = call i32 @posix_memalign(i8** bitcast (double** @xx to i8**), i64 32, i64 256000) #5
...
entry:
  ...
  %call = call i32 @posix_memalign(i8** %0, i64 32, i64 256000) #5
