; ModuleID = './MultiSource.Benchmarks.TSVC/28.LinearDependence-flt.tsc.bc'
...
@.str.153 = private unnamed_addr constant [30 x i8] c"Loop \09 Time(Sec) \09 Checksum \0A\00", align 1
@x = common global [32000 x float] zeroinitializer, align 16
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i32 0, i32 0))
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %arrayidx = getelementptr inbounds [32000 x float], [32000 x float]* @Y, i32 0, i64 %idxprom
  %4 = load float, float* %arrayidx, align 4
  %add = fadd float %4, 1.000000e+00
  %5 = load i32, i32* %i, align 4
  %idxprom4 = sext i32 %5 to i64
  %arrayidx5 = getelementptr inbounds [32000 x float], [32000 x float]* @X, i32 0, i64 %idxprom4
...
for.end:                                          ; preds = %for.cond.1
  %7 = load [256 x float]*, [256 x float]** @aa, align 16
  %8 = load [256 x float]*, [256 x float]** @bb, align 16
  %9 = load [256 x float]*, [256 x float]** @cc, align 16
  %call6 = call i32 @dummy(float* getelementptr inbounds ([32000 x float], [32000 x float]* @X, i32 0, i32 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @Y, i32 0, i32 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @Z, i32 0, i32 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @U, i32 0, i32 0), float* getelementptr inbounds ([32000 x float], [32000 x float]* @V, i32 0, i32 0), [256 x float]* %7, [256 x float]* %8, [256 x float]* %9, float 0.000000e+00)
  br label %for.inc.7
...
for.end.9:                                        ; preds = %for.cond
  ...
  %11 = load i64, i64* %end_t, align 8
  %12 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %11, %12
  store i64 %sub, i64* %clock_dif, align 8
  %13 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %13 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %14 = load double, double* %clock_dif_sec, align 8
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %14)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.2, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %13 = load float*, float** @b, align 16
  %14 = load float*, float** @c, align 16
  %15 = load float*, float** @d, align 16
  %16 = load float*, float** @e, align 16
  %17 = load [256 x float]*, [256 x float]** @aa, align 16
  %18 = load [256 x float]*, [256 x float]** @bb, align 16
  %19 = load [256 x float]*, [256 x float]** @cc, align 16
  %call9 = call i32 @dummy(float* %12, float* %13, float* %14, float* %15, float* %16, [256 x float]* %17, [256 x float]* %18, [256 x float]* %19, float 0.000000e+00)
  br label %for.inc.10
...
for.end.11:                                       ; preds = %for.cond
  ...
  store i64 %sub12, i64* %clock_dif, align 8
  %23 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %23 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %24 = load double, double* %clock_dif_sec, align 8
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i32 0, i32 0), double %24)
  call void @check(i32 1)
  ret i32 0
}
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %add = fadd float %mul6, %mul11
  %15 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %15 to i64
  %16 = load float*, float** @c, align 16
  ...
  %add29 = fadd float %add23, %mul28
  %33 = load i32, i32* %i, align 4
  %mul30 = mul nsw i32 2, %33
  %idxprom31 = sext i32 %mul30 to i64
  %34 = load float*, float** @a, align 16
  %arrayidx32 = getelementptr inbounds float, float* %34, i64 %idxprom31
...
for.end:                                          ; preds = %for.cond.1
  %36 = load float*, float** @a, align 16
  %37 = load float*, float** @b, align 16
  %38 = load float*, float** @c, align 16
  %39 = load float*, float** @d, align 16
  %40 = load float*, float** @e, align 16
  %41 = load [256 x float]*, [256 x float]** @aa, align 16
  %42 = load [256 x float]*, [256 x float]** @bb, align 16
  %43 = load [256 x float]*, [256 x float]** @cc, align 16
  %call33 = call i32 @dummy(float* %36, float* %37, float* %38, float* %39, float* %40, [256 x float]* %41, [256 x float]* %42, [256 x float]* %43, float 0.000000e+00)
  br label %for.inc.34

for.inc.34:                                       ; preds = %for.end
  %44 = load i32, i32* %nl, align 4
...
for.end.36:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %45 = load i64, i64* %end_t, align 8
  %46 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %45, %46
  store i64 %sub, i64* %clock_dif, align 8
  %47 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %47 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %48 = load double, double* %clock_dif_sec, align 8
  %call37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.139, i32 0, i32 0), double %48)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.3, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.11:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %24 = load double, double* %clock_dif_sec, align 8
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %24)
  call void @check(i32 1)
  ret i32 0
}
...
for.end:                                          ; preds = %for.cond.1
  %9 = load float*, float** @a, align 16
  %10 = load float*, float** @b, align 16
  %11 = load float*, float** @c, align 16
  %12 = load float*, float** @d, align 16
  %13 = load float*, float** @e, align 16
  %14 = load [256 x float]*, [256 x float]** @aa, align 16
  %15 = load [256 x float]*, [256 x float]** @bb, align 16
  %16 = load [256 x float]*, [256 x float]** @cc, align 16
  %call6 = call i32 @dummy(float* %9, float* %10, float* %11, float* %12, float* %13, [256 x float]* %14, [256 x float]* %15, [256 x float]* %16, float 0.000000e+00)
  br label %for.inc.7
...
for.end.8:                                        ; preds = %for.cond
  ...
  %call9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.141, i32 0, i32 0), double %21)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load float*, float** @a, align 16
  %arrayidx = getelementptr inbounds float, float* %3, i64 0
  %4 = load float, float* %arrayidx, align 4
  %5 = load i32, i32* %i, align 4
  %idxprom = sext i32 %5 to i64
  %6 = load float*, float** @b, align 16
  %arrayidx4 = getelementptr inbounds float, float* %6, i64 %idxprom
...
for.end:                                          ; preds = %for.cond.1
  ...
  %12 = load float*, float** @b, align 16
  %13 = load float*, float** @c, align 16
  %14 = load float*, float** @d, align 16
  %15 = load float*, float** @e, align 16
  %16 = load [256 x float]*, [256 x float]** @aa, align 16
  %17 = load [256 x float]*, [256 x float]** @bb, align 16
  %18 = load [256 x float]*, [256 x float]** @cc, align 16
  %call7 = call i32 @dummy(float* %11, float* %12, float* %13, float* %14, float* %15, [256 x float]* %16, [256 x float]* %17, [256 x float]* %18, float 0.000000e+00)
  br label %for.inc.8
...
for.end.10:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %20 = load i64, i64* %end_t, align 8
  %21 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %20, %21
  store i64 %sub, i64* %clock_dif, align 8
  %22 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %22 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %23 = load double, double* %clock_dif_sec, align 8
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.142, i32 0, i32 0), double %23)
  call void @check(i32 1)
  ret i32 0
}
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load float*, float** @a, align 16
  %arrayidx = getelementptr inbounds float, float* %3, i64 16000
  %4 = load float, float* %arrayidx, align 4
  %5 = load i32, i32* %i, align 4
  %idxprom = sext i32 %5 to i64
  %6 = load float*, float** @b, align 16
...
for.end.10:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %23 = load double, double* %clock_dif_sec, align 8
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.143, i32 0, i32 0), double %23)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.5, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %7 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx = getelementptr inbounds [256 x float], [256 x float]* %7, i64 %idxprom7
  %arrayidx8 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx, i32 0, i64 %idxprom
  ...
  %11 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx11 = getelementptr inbounds [256 x float], [256 x float]* %11, i64 %idxprom10
  ...
  %15 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx15 = getelementptr inbounds [256 x float], [256 x float]* %15, i64 %idxprom14
...
for.end.19:                                       ; preds = %for.cond.1
  ...
  %22 = load float*, float** @e, align 16
  %23 = load [256 x float]*, [256 x float]** @aa, align 16
  %24 = load [256 x float]*, [256 x float]** @bb, align 16
  %25 = load [256 x float]*, [256 x float]** @cc, align 16
  %call20 = call i32 @dummy(float* %18, float* %19, float* %20, float* %21, float* %22, [256 x float]* %23, [256 x float]* %24, [256 x float]* %25, float 0.000000e+00)
  br label %for.inc.21
...
for.end.23:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %27 = load i64, i64* %end_t, align 8
  %28 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %27, %28
  store i64 %sub, i64* %clock_dif, align 8
  %29 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %29 to double
  %div24 = fdiv double %conv, 1.000000e+06
  store double %div24, double* %clock_dif_sec, align 8
  %30 = load double, double* %clock_dif_sec, align 8
  %call25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.144, i32 0, i32 0), double %30)
...
entry:
  ...
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.6, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.16:                                       ; preds = %for.cond.1
  ...
  %call17 = call i32 @dummy(float* %17, float* %18, float* %19, float* %20, float* %21, [256 x float]* %22, [256 x float]* %23, [256 x float]* %24, float 0.000000e+00)
  br label %for.inc.18

for.inc.18:                                       ; preds = %for.end.16
  %25 = load i32, i32* %nl, align 4
  %inc19 = add nsw i32 %25, 1
  store i32 %inc19, i32* %nl, align 4
  br label %for.cond
...
for.end.20:                                       ; preds = %for.cond
  ...
  %sub21 = sub nsw i64 %26, %27
  store i64 %sub21, i64* %clock_dif, align 8
  %28 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %28 to double
  %div22 = fdiv double %conv, 1.000000e+06
  store double %div22, double* %clock_dif_sec, align 8
  %29 = load double, double* %clock_dif_sec, align 8
  %call23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.145, i32 0, i32 0), double %29)
  call void @check(i32 1)
  ret i32 0
}
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %10 = load [256 x float]*, [256 x float]** @cc, align 16
  %arrayidx11 = getelementptr inbounds [256 x float], [256 x float]* %10, i64 %idxprom10
  %arrayidx12 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx11, i32 0, i64 %idxprom9
  %11 = load float, float* %arrayidx12, align 4
  %mul13 = fmul float %7, %11
  %12 = load i32, i32* %j, align 4
  %idxprom14 = sext i32 %12 to i64
  %13 = load i32, i32* %i, align 4
  %idxprom15 = sext i32 %13 to i64
  %14 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx16 = getelementptr inbounds [256 x float], [256 x float]* %14, i64 %idxprom15
  %arrayidx17 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx16, i32 0, i64 %idxprom14
  %15 = load float, float* %arrayidx17, align 4
  %add = fadd float %mul13, %15
  %16 = load i32, i32* %j, align 4
...
for.end.24:                                       ; preds = %for.cond.1
  ...
  %23 = load float*, float** @c, align 16
  %24 = load float*, float** @d, align 16
  %25 = load float*, float** @e, align 16
  %26 = load [256 x float]*, [256 x float]** @aa, align 16
  %27 = load [256 x float]*, [256 x float]** @bb, align 16
  %28 = load [256 x float]*, [256 x float]** @cc, align 16
  %call25 = call i32 @dummy(float* %21, float* %22, float* %23, float* %24, float* %25, [256 x float]* %26, [256 x float]* %27, [256 x float]* %28, float 0.000000e+00)
  br label %for.inc.26

for.inc.26:                                       ; preds = %for.end.24
  %29 = load i32, i32* %nl, align 4
  %inc27 = add nsw i32 %29, 1
  store i32 %inc27, i32* %nl, align 4
  br label %for.cond
...
for.end.28:                                       ; preds = %for.cond
  ...
  store double %div29, double* %clock_dif_sec, align 8
  %33 = load double, double* %clock_dif_sec, align 8
  %call30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.146, i32 0, i32 0), double %33)
  call void @check(i32 11)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.7, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  store float %mul15, float* %arrayidx18, align 4
  %19 = load i32, i32* %i, align 4
  %add19 = add nsw i32 %19, 3
  %idxprom20 = sext i32 %add19 to i64
  %20 = load float*, float** @a, align 16
  %arrayidx21 = getelementptr inbounds float, float* %20, i64 %idxprom20
  %21 = load float, float* %arrayidx21, align 4
  %22 = load i32, i32* %i, align 4
  %add22 = add nsw i32 %22, 2
  %idxprom23 = sext i32 %add22 to i64
  %23 = load float*, float** @a, align 16
  %arrayidx24 = getelementptr inbounds float, float* %23, i64 %idxprom23
  %24 = load float, float* %arrayidx24, align 4
  %mul25 = fmul float %21, %24
  ...
  store float %mul25, float* %arrayidx28, align 4
  %27 = load i32, i32* %i, align 4
  %add29 = add nsw i32 %27, 4
  %idxprom30 = sext i32 %add29 to i64
  %28 = load float*, float** @a, align 16
  %arrayidx31 = getelementptr inbounds float, float* %28, i64 %idxprom30
  %29 = load float, float* %arrayidx31, align 4
  %30 = load i32, i32* %i, align 4
  %add32 = add nsw i32 %30, 3
  %idxprom33 = sext i32 %add32 to i64
  %31 = load float*, float** @a, align 16
  %arrayidx34 = getelementptr inbounds float, float* %31, i64 %idxprom33
  %32 = load float, float* %arrayidx34, align 4
  %mul35 = fmul float %29, %32
  %33 = load i32, i32* %i, align 4
  %add36 = add nsw i32 %33, 3
  %idxprom37 = sext i32 %add36 to i64
  %34 = load float*, float** @a, align 16
  %arrayidx38 = getelementptr inbounds float, float* %34, i64 %idxprom37
  store float %mul35, float* %arrayidx38, align 4
  %35 = load i32, i32* %i, align 4
  %add39 = add nsw i32 %35, 5
  %idxprom40 = sext i32 %add39 to i64
  %36 = load float*, float** @a, align 16
  %arrayidx41 = getelementptr inbounds float, float* %36, i64 %idxprom40
  %37 = load float, float* %arrayidx41, align 4
  %38 = load i32, i32* %i, align 4
  %add42 = add nsw i32 %38, 4
  %idxprom43 = sext i32 %add42 to i64
  %39 = load float*, float** @a, align 16
  %arrayidx44 = getelementptr inbounds float, float* %39, i64 %idxprom43
  %40 = load float, float* %arrayidx44, align 4
  %mul45 = fmul float %37, %40
  %41 = load i32, i32* %i, align 4
  %add46 = add nsw i32 %41, 4
  %idxprom47 = sext i32 %add46 to i64
  %42 = load float*, float** @a, align 16
  %arrayidx48 = getelementptr inbounds float, float* %42, i64 %idxprom47
  store float %mul45, float* %arrayidx48, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body.3
  %43 = load i32, i32* %i, align 4
  %add49 = add nsw i32 %43, 5
  store i32 %add49, i32* %i, align 4
  br label %for.cond.1

for.end:                                          ; preds = %for.cond.1
  %44 = load float*, float** @a, align 16
  %45 = load float*, float** @b, align 16
  %46 = load float*, float** @c, align 16
  %47 = load float*, float** @d, align 16
  %48 = load float*, float** @e, align 16
  %49 = load [256 x float]*, [256 x float]** @aa, align 16
  %50 = load [256 x float]*, [256 x float]** @bb, align 16
  %51 = load [256 x float]*, [256 x float]** @cc, align 16
  %call50 = call i32 @dummy(float* %44, float* %45, float* %46, float* %47, float* %48, [256 x float]* %49, [256 x float]* %50, [256 x float]* %51, float 0.000000e+00)
  br label %for.inc.51
...
for.end.52:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %53 = load i64, i64* %end_t, align 8
  %54 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %53, %54
  store i64 %sub, i64* %clock_dif, align 8
  %55 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %55 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %56 = load double, double* %clock_dif_sec, align 8
  %call53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.147, i32 0, i32 0), double %56)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.8, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %6 = load i32, i32* %j, align 4
  %idxprom7 = sext i32 %6 to i64
  %7 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx = getelementptr inbounds [256 x float], [256 x float]* %7, i64 %idxprom7
  %arrayidx8 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx, i32 0, i64 %idxprom
  %8 = load float, float* %arrayidx8, align 4
  %9 = load i32, i32* %i, align 4
...
for.end.18:                                       ; preds = %for.cond.1
  ...
  %24 = load [256 x float]*, [256 x float]** @bb, align 16
  %25 = load [256 x float]*, [256 x float]** @cc, align 16
  %call19 = call i32 @dummy(float* %18, float* %19, float* %20, float* %21, float* %22, [256 x float]* %23, [256 x float]* %24, [256 x float]* %25, float 0.000000e+00)
  br label %for.inc.20
...
for.end.22:                                       ; preds = %for.cond
  ...
  store i64 %sub23, i64* %clock_dif, align 8
  %29 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %29 to double
  %div24 = fdiv double %conv, 1.000000e+06
  store double %div24, double* %clock_dif_sec, align 8
  %30 = load double, double* %clock_dif_sec, align 8
  %call25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.148, i32 0, i32 0), double %30)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.9, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %6 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx = getelementptr inbounds [256 x float], [256 x float]* %6, i64 %idxprom8
  %arrayidx9 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx, i32 0, i64 %idxprom
  ...
  %arrayidx12 = getelementptr inbounds [256 x float], [256 x float]* %10, i64 %idxprom11
...
for.end.20:                                       ; preds = %for.cond.1
  ...
  %23 = load [256 x float]*, [256 x float]** @bb, align 16
  %24 = load [256 x float]*, [256 x float]** @cc, align 16
  %call21 = call i32 @dummy(float* %17, float* %18, float* %19, float* %20, float* %21, [256 x float]* %22, [256 x float]* %23, [256 x float]* %24, float 0.000000e+00)
  br label %for.inc.22
...
for.end.24:                                       ; preds = %for.cond
  ...
  store i64 %sub25, i64* %clock_dif, align 8
  %28 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %28 to double
  %div26 = fdiv double %conv, 1.000000e+06
  store double %div26, double* %clock_dif_sec, align 8
  %29 = load double, double* %clock_dif_sec, align 8
  %call27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.149, i32 0, i32 0), double %29)
  call void @check(i32 11)
  ret i32 0
}
...
for.end.19:                                       ; preds = %for.cond.1
  ...
  %23 = load [256 x float]*, [256 x float]** @bb, align 16
  %24 = load [256 x float]*, [256 x float]** @cc, align 16
  %call20 = call i32 @dummy(float* %17, float* %18, float* %19, float* %20, float* %21, [256 x float]* %22, [256 x float]* %23, [256 x float]* %24, float 0.000000e+00)
  br label %for.inc.21
...
for.end.23:                                       ; preds = %for.cond
  ...
  %26 = load i64, i64* %end_t, align 8
  %27 = load i64, i64* %start_t, align 8
  %sub24 = sub nsw i64 %26, %27
  store i64 %sub24, i64* %clock_dif, align 8
  %28 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %28 to double
  %div25 = fdiv double %conv, 1.000000e+06
  store double %div25, double* %clock_dif_sec, align 8
  %29 = load double, double* %clock_dif_sec, align 8
  %call26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.150, i32 0, i32 0), double %29)
  call void @check(i32 11)
  ret i32 0
}
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.151, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.152, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.153, i32 0, i32 0))
  %call9 = call i32 @s000()
