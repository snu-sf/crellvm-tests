; ModuleID = './MultiSource.Benchmarks.TSVC/34.Recurrences-flt.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S321\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [14 x i8] c"S322\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [14 x i8] c"S323\09 %.2f \09\09\00", align 1
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.85, i32 0, i32 0))
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.86, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call17 = call i32 @dummy(float* %21, float* %22, float* %23, float* %24, float* %25, [256 x float]* %26, [256 x float]* %27, [256 x float]* %28, float 0.000000e+00)
  br label %for.inc.18
...
for.end.20:                                       ; preds = %for.cond
  ...
  %call23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i32 0, i32 0), double %33)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.87, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call20 = call i32 @dummy(float* %26, float* %27, float* %28, float* %29, float* %30, [256 x float]* %31, [256 x float]* %32, [256 x float]* %33, float 0.000000e+00)
  br label %for.inc.21
...
for.end.23:                                       ; preds = %for.cond
  ...
  %call26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i32 0, i32 0), double %38)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call9 = call i32 @s321()
  %call10 = call i32 @s322()
  %call11 = call i32 @s323()
  ret i32 0
}
