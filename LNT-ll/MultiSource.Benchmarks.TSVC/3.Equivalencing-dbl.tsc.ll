; ModuleID = './MultiSource.Benchmarks.TSVC/3.Equivalencing-dbl.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S421\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [15 x i8] c"S1421\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [14 x i8] c"S422\09 %.2f \09\09\00", align 1
@.str.140 = private unnamed_addr constant [14 x i8] c"S423\09 %.2f \09\09\00", align 1
@.str.141 = private unnamed_addr constant [14 x i8] c"S424\09 %.2f \09\09\00", align 1
@.str.142 = private unnamed_addr constant [2 x i8] c"\0A\00", align 1
@indx = common global [32000 x i32] zeroinitializer, align 32
@.str.143 = private unnamed_addr constant [31 x i8] c"Running each loop %d times...\0A\00", align 1
@.str.144 = private unnamed_addr constant [30 x i8] c"Loop \09 Time(Sec) \09 Checksum \0A\00", align 1
@x = common global [32000 x double] zeroinitializer, align 32
...
entry:
  ...
  %0 = load double*, double** @xx, align 8
  %call = call i32 @set1d(double* %0, double 1.000000e+00, i32 1)
  %call1 = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.101, i32 0, i32 0))
...
for.body:                                         ; preds = %for.cond
  ...
  store double* %3, double** @yy, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond.2

for.cond.2:                                       ; preds = %for.inc, %for.body
  %4 = load i32, i32* %i, align 4
  %cmp3 = icmp slt i32 %4, 31999
  br i1 %cmp3, label %for.body.4, label %for.end
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %6 = load double*, double** @yy, align 8
...
for.end:                                          ; preds = %for.cond.2
  ...
  %call10 = call i32 @dummy(double* %14, double* %15, double* %16, double* %17, double* %18, [256 x double]* %19, [256 x double]* %20, [256 x double]* %21, double 1.000000e+00)
  br label %for.inc.11
...
for.end.13:                                       ; preds = %for.cond
  ...
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %26)
...
for.body.19:                                      ; preds = %for.cond.16
  ...
  %add22 = fadd double %31, %30
  store double %add22, double* @temp, align 8
  br label %for.inc.23
...
entry:
  ...
  %call1 = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.101, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  %1 = load double*, double** @b, align 32
  %arrayidx = getelementptr inbounds double, double* %1, i64 16000
  store double* %arrayidx, double** @xx, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.cond.2:                                       ; preds = %for.inc, %for.body
  %4 = load i32, i32* %i, align 4
  %cmp3 = icmp slt i32 %4, 16000
  br i1 %cmp3, label %for.body.4, label %for.end

for.body.4:                                       ; preds = %for.cond.2
  %5 = load i32, i32* %i, align 4
  %idxprom = sext i32 %5 to i64
  %6 = load double*, double** @xx, align 8
...
for.end.13:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %26 = load double, double* %clock_dif_sec, align 8
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.138, i32 0, i32 0), double %26)
  store double 0.000000e+00, double* @temp, align 8
  store i32 0, i32* %i15, align 4
  br label %for.cond.16
...
entry:
  ...
  %i = alloca i32, align 4
  %i15 = alloca i32, align 4
  store double* getelementptr inbounds ([65536 x double], [65536 x double]* @array, i32 0, i64 4), double** @xx, align 8
  %0 = load double*, double** @xx, align 8
  %call = call i32 @set1d(double* %0, double 0.000000e+00, i32 1)
  %call1 = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.102, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %add = add nsw i32 %4, 8
  %idxprom = sext i32 %add to i64
  %arrayidx = getelementptr inbounds [65536 x double], [65536 x double]* @array, i32 0, i64 %idxprom
  ...
  %add7 = fadd double %5, %8
  %9 = load i32, i32* %i, align 4
  %idxprom8 = sext i32 %9 to i64
  %10 = load double*, double** @xx, align 8
...
for.end.13:                                       ; preds = %for.cond
  ...
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i32 0, i32 0), double %24)
  store double 0.000000e+00, double* @temp, align 8
  store i32 0, i32* %i15, align 4
  br label %for.cond.16
...
for.cond.16:                                      ; preds = %for.inc.23, %for.end.13
  ...
  %cmp17 = icmp slt i32 %25, 32000
  br i1 %cmp17, label %for.body.19, label %for.end.25

for.body.19:                                      ; preds = %for.cond.16
  %26 = load i32, i32* %i15, align 4
  %idxprom20 = sext i32 %26 to i64
  %27 = load double*, double** @xx, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %i15 = alloca i32, align 4
  store i32 64, i32* %vl, align 4
  %0 = load i32, i32* %vl, align 4
  %idx.ext = sext i32 %0 to i64
  %add.ptr = getelementptr inbounds double, double* getelementptr inbounds ([65536 x double], [65536 x double]* @array, i32 0, i32 0), i64 %idx.ext
  store double* %add.ptr, double** @xx, align 8
  %1 = load double*, double** @xx, align 8
  %call = call i32 @set1d(double* %1, double 1.000000e+00, i32 1)
  %call1 = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.103, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %arrayidx9 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i32 0, i64 %idxprom8
  store double %add, double* %arrayidx9, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.2
  ...
  %call10 = call i32 @dummy(double* %13, double* %14, double* %15, double* %16, double* %17, [256 x double]* %18, [256 x double]* %19, [256 x double]* %20, double 1.000000e+00)
  br label %for.inc.11
...
for.end.13:                                       ; preds = %for.cond
  ...
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %25)
  store double 0.000000e+00, double* @temp, align 8
  store i32 0, i32* %i15, align 4
  br label %for.cond.16
...
for.cond.16:                                      ; preds = %for.inc.23, %for.end.13
  %26 = load i32, i32* %i15, align 4
  %cmp17 = icmp slt i32 %26, 32000
  br i1 %cmp17, label %for.body.19, label %for.end.25

for.body.19:                                      ; preds = %for.cond.16
  %27 = load i32, i32* %i15, align 4
  %idxprom20 = sext i32 %27 to i64
  %arrayidx21 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i32 0, i64 %idxprom20
  %28 = load double, double* %arrayidx21, align 8
  %29 = load double, double* @temp, align 8
  %add22 = fadd double %29, %28
  store double %add22, double* @temp, align 8
...
entry:
  ...
  %i = alloca i32, align 4
  %i15 = alloca i32, align 4
  store i32 63, i32* %vl, align 4
  %0 = load i32, i32* %vl, align 4
  %idx.ext = sext i32 %0 to i64
  %add.ptr = getelementptr inbounds double, double* getelementptr inbounds ([65536 x double], [65536 x double]* @array, i32 0, i32 0), i64 %idx.ext
  store double* %add.ptr, double** @xx, align 8
  %1 = load double*, double** @xx, align 8
  %call = call i32 @set1d(double* %1, double 0.000000e+00, i32 1)
  %call1 = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.104, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.13:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %25 = load double, double* %clock_dif_sec, align 8
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.141, i32 0, i32 0), double %25)
  store double 0.000000e+00, double* @temp, align 8
  store i32 0, i32* %i15, align 4
  br label %for.cond.16
...
for.body.19:                                      ; preds = %for.cond.16
  %27 = load i32, i32* %i15, align 4
  %idxprom20 = sext i32 %27 to i64
  %28 = load double*, double** @xx, align 8
  %arrayidx21 = getelementptr inbounds double, double* %28, i64 %idxprom20
  %29 = load double, double* %arrayidx21, align 8
  %30 = load double, double* @temp, align 8
  %add22 = fadd double %30, %29
  store double %add22, double* @temp, align 8
  br label %for.inc.23

for.inc.23:                                       ; preds = %for.body.19
  %31 = load i32, i32* %i15, align 4
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.142, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.143, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.144, i32 0, i32 0))
  %call9 = call i32 @s421()
  %call10 = call i32 @s1421()
  %call11 = call i32 @s422()
  %call12 = call i32 @s423()
  %call13 = call i32 @s424()
  ret i32 0
}
