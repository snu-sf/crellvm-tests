; ModuleID = './MultiSource.Benchmarks.TSVC/70.InductionVariable-dbl.tsc.bc'
...
for.end:                                          ; preds = %for.cond.1
  ...
  %20 = load [256 x double]*, [256 x double]** @bb, align 32
  %21 = load [256 x double]*, [256 x double]** @cc, align 32
  %call9 = call i32 @dummy(double* %14, double* %15, double* %16, double* %17, double* %18, [256 x double]* %19, [256 x double]* %20, [256 x double]* %21, double 0.000000e+00)
  br label %for.inc.10
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %11 = load double*, double** @e, align 32
  ...
  %cmp12 = fcmp ogt double %17, 0.000000e+00
...
for.end:                                          ; preds = %for.cond.1
  ...
  %32 = load double*, double** @b, align 32
  %33 = load double*, double** @c, align 32
  %34 = load double*, double** @d, align 32
  %35 = load double*, double** @e, align 32
  %36 = load [256 x double]*, [256 x double]** @aa, align 32
  %37 = load [256 x double]*, [256 x double]** @bb, align 32
  %38 = load [256 x double]*, [256 x double]** @cc, align 32
  %call25 = call i32 @dummy(double* %31, double* %32, double* %33, double* %34, double* %35, [256 x double]* %36, [256 x double]* %37, [256 x double]* %38, double 0.000000e+00)
  br label %for.inc.26
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %mul17 = fmul double %12, %16
  %add = fadd double %8, %mul17
  %17 = load i32, i32* %k, align 4
  %idxprom18 = sext i32 %17 to i64
  %arrayidx19 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i32 0, i64 %idxprom18
...
for.end.23:                                       ; preds = %for.cond.1
  ...
  %call24 = call i32 @dummy(double* %20, double* %21, double* %22, double* %23, double* %24, [256 x double]* %25, [256 x double]* %26, [256 x double]* %27, double 0.000000e+00)
  br label %for.inc.25
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %6 = load [256 x double]*, [256 x double]** @bb, align 32
  ...
  %arrayidx11 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i32 0, i64 %idxprom10
  ...
  %arrayidx14 = getelementptr inbounds [256 x double], [256 x double]* %12, i64 %idxprom13
  ...
  %mul16 = fmul double %9, %13
  %add = fadd double %7, %mul16
  %14 = load i32, i32* %i, align 4
  %idxprom17 = sext i32 %14 to i64
  %15 = load i32, i32* %j, align 4
  %idxprom18 = sext i32 %15 to i64
  %16 = load [256 x double]*, [256 x double]** @bb, align 32
  %arrayidx19 = getelementptr inbounds [256 x double], [256 x double]* %16, i64 %idxprom18
...
for.end.25:                                       ; preds = %for.cond.1
  ...
  %call26 = call i32 @dummy(double* %21, double* %22, double* %23, double* %24, double* %25, [256 x double]* %26, [256 x double]* %27, [256 x double]* %28, double 0.000000e+00)
  br label %for.inc.27
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call16 = call i32 @dummy(double* %22, double* %23, double* %24, double* %25, double* %26, [256 x double]* %27, [256 x double]* %28, [256 x double]* %29, double 1.000000e+00)
  br label %for.inc.17
