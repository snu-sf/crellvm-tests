; ModuleID = './MultiSource.Benchmarks.TSVC/21.ControlLoops-dbl.tsc.bc'
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call8 = call i32 @dummy(double* %11, double* %12, double* %13, double* %14, double* %15, [256 x double]* %16, [256 x double]* %17, [256 x double]* %18, double 0.000000e+00)
  br label %for.inc.9
...
for.end:                                          ; preds = %for.cond.1
  %10 = load double*, double** @a, align 32
  %11 = load double*, double** @b, align 32
  %12 = load double*, double** @c, align 32
  %13 = load double*, double** @d, align 32
  %14 = load double*, double** @e, align 32
  %15 = load [256 x double]*, [256 x double]** @aa, align 32
  %16 = load [256 x double]*, [256 x double]** @bb, align 32
  %17 = load [256 x double]*, [256 x double]** @cc, align 32
  %call6 = call i32 @dummy(double* %10, double* %11, double* %12, double* %13, double* %14, [256 x double]* %15, [256 x double]* %16, [256 x double]* %17, double 0.000000e+00)
  br label %for.inc.7
...
for.end:                                          ; preds = %for.cond.1
  ...
  %16 = load [256 x double]*, [256 x double]** @bb, align 32
  %17 = load [256 x double]*, [256 x double]** @cc, align 32
  %call7 = call i32 @dummy(double* %10, double* %11, double* %12, double* %13, double* %14, [256 x double]* %15, [256 x double]* %16, [256 x double]* %17, double 0.000000e+00)
  br label %for.inc.8
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call9 = call i32 @dummy(double* %13, double* %14, double* %15, double* %16, double* %17, [256 x double]* %18, [256 x double]* %19, [256 x double]* %20, double 0.000000e+00)
  br label %for.inc.10
...
for.end:                                          ; preds = %for.cond.1
  ...
  %17 = load [256 x double]*, [256 x double]** @bb, align 32
  %18 = load [256 x double]*, [256 x double]** @cc, align 32
  %call6 = call i32 @dummy(double* %11, double* %12, double* %13, double* %14, double* %15, [256 x double]* %16, [256 x double]* %17, [256 x double]* %18, double 0.000000e+00)
  br label %for.inc.7
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call12 = call i32 @dummy(double* %15, double* %16, double* %17, double* %18, double* %19, [256 x double]* %20, [256 x double]* %21, [256 x double]* %22, double 0.000000e+00)
  br label %for.inc.13
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx5 = getelementptr inbounds double, double* %7, i64 %idxprom4
  %8 = load double, double* %arrayidx5, align 8
  store double %8, double* %b1, align 8
  %9 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %9 to i64
  %10 = load double*, double** @c, align 32
  %arrayidx7 = getelementptr inbounds double, double* %10, i64 %idxprom6
  %11 = load double, double* %arrayidx7, align 8
  store double %11, double* %c1, align 8
  %12 = load i32, i32* %i, align 4
  %idxprom8 = sext i32 %12 to i64
  %13 = load double*, double** @d, align 32
  %arrayidx9 = getelementptr inbounds double, double* %13, i64 %idxprom8
  %14 = load double, double* %arrayidx9, align 8
  store double %14, double* %d1, align 8
  %15 = load i32, i32* %i, align 4
  %idxprom10 = sext i32 %15 to i64
  %16 = load double*, double** @e, align 32
  %arrayidx11 = getelementptr inbounds double, double* %16, i64 %idxprom10
  %17 = load double, double* %arrayidx11, align 8
  store double %17, double* %e1, align 8
  %18 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %18 to i64
  %19 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx13 = getelementptr inbounds [256 x double], [256 x double]* %19, i64 0
  %arrayidx14 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx13, i32 0, i64 %idxprom12
  %20 = load double, double* %arrayidx14, align 8
  store double %20, double* %f1, align 8
  %21 = load double, double* %a1, align 8
  %22 = load double, double* %b1, align 8
  %mul = fmul double %21, %22
  %23 = load double, double* %c1, align 8
  %mul15 = fmul double %mul, %23
  %24 = load double, double* %a1, align 8
  %25 = load double, double* %b1, align 8
  %mul16 = fmul double %24, %25
  %26 = load double, double* %d1, align 8
  %mul17 = fmul double %mul16, %26
  %add = fadd double %mul15, %mul17
  %27 = load double, double* %a1, align 8
  %28 = load double, double* %b1, align 8
  %mul18 = fmul double %27, %28
  %29 = load double, double* %e1, align 8
  %mul19 = fmul double %mul18, %29
  %add20 = fadd double %add, %mul19
  %30 = load double, double* %a1, align 8
  %31 = load double, double* %b1, align 8
  %mul21 = fmul double %30, %31
  %32 = load double, double* %f1, align 8
  %mul22 = fmul double %mul21, %32
  %add23 = fadd double %add20, %mul22
  %33 = load double, double* %a1, align 8
  %34 = load double, double* %c1, align 8
  %mul24 = fmul double %33, %34
  %35 = load double, double* %d1, align 8
  %mul25 = fmul double %mul24, %35
  %add26 = fadd double %add23, %mul25
  %36 = load double, double* %a1, align 8
  %37 = load double, double* %c1, align 8
  %mul27 = fmul double %36, %37
  %38 = load double, double* %e1, align 8
  %mul28 = fmul double %mul27, %38
  %add29 = fadd double %add26, %mul28
  %39 = load double, double* %a1, align 8
  %40 = load double, double* %c1, align 8
  %mul30 = fmul double %39, %40
  %41 = load double, double* %f1, align 8
  %mul31 = fmul double %mul30, %41
  %add32 = fadd double %add29, %mul31
  %42 = load double, double* %a1, align 8
  %43 = load double, double* %d1, align 8
  %mul33 = fmul double %42, %43
  %44 = load double, double* %e1, align 8
  %mul34 = fmul double %mul33, %44
  %add35 = fadd double %add32, %mul34
  %45 = load double, double* %a1, align 8
  %46 = load double, double* %d1, align 8
  %mul36 = fmul double %45, %46
  %47 = load double, double* %f1, align 8
  %mul37 = fmul double %mul36, %47
  %add38 = fadd double %add35, %mul37
  %48 = load double, double* %a1, align 8
  %49 = load double, double* %e1, align 8
  %mul39 = fmul double %48, %49
  %50 = load double, double* %f1, align 8
  %mul40 = fmul double %mul39, %50
  %add41 = fadd double %add38, %mul40
  store double %add41, double* %a1, align 8
  %51 = load double, double* %b1, align 8
  %52 = load double, double* %c1, align 8
  %mul42 = fmul double %51, %52
  %53 = load double, double* %d1, align 8
  %mul43 = fmul double %mul42, %53
  %54 = load double, double* %b1, align 8
  %55 = load double, double* %c1, align 8
  %mul44 = fmul double %54, %55
  %56 = load double, double* %e1, align 8
  %mul45 = fmul double %mul44, %56
  %add46 = fadd double %mul43, %mul45
  %57 = load double, double* %b1, align 8
  %58 = load double, double* %c1, align 8
  %mul47 = fmul double %57, %58
  %59 = load double, double* %f1, align 8
  %mul48 = fmul double %mul47, %59
  %add49 = fadd double %add46, %mul48
  %60 = load double, double* %b1, align 8
  %61 = load double, double* %d1, align 8
  %mul50 = fmul double %60, %61
  %62 = load double, double* %e1, align 8
  %mul51 = fmul double %mul50, %62
  %add52 = fadd double %add49, %mul51
  %63 = load double, double* %b1, align 8
  %64 = load double, double* %d1, align 8
  %mul53 = fmul double %63, %64
  %65 = load double, double* %f1, align 8
  %mul54 = fmul double %mul53, %65
  %add55 = fadd double %add52, %mul54
  %66 = load double, double* %b1, align 8
  %67 = load double, double* %e1, align 8
  %mul56 = fmul double %66, %67
  %68 = load double, double* %f1, align 8
  %mul57 = fmul double %mul56, %68
  %add58 = fadd double %add55, %mul57
  store double %add58, double* %b1, align 8
  %69 = load double, double* %c1, align 8
  %70 = load double, double* %d1, align 8
  %mul59 = fmul double %69, %70
  %71 = load double, double* %e1, align 8
  %mul60 = fmul double %mul59, %71
  %72 = load double, double* %c1, align 8
  %73 = load double, double* %d1, align 8
  %mul61 = fmul double %72, %73
  %74 = load double, double* %f1, align 8
  %mul62 = fmul double %mul61, %74
  %add63 = fadd double %mul60, %mul62
  %75 = load double, double* %c1, align 8
  %76 = load double, double* %e1, align 8
  %mul64 = fmul double %75, %76
  %77 = load double, double* %f1, align 8
  %mul65 = fmul double %mul64, %77
  %add66 = fadd double %add63, %mul65
  store double %add66, double* %c1, align 8
  %78 = load double, double* %d1, align 8
  %79 = load double, double* %e1, align 8
  %mul67 = fmul double %78, %79
  %80 = load double, double* %f1, align 8
  %mul68 = fmul double %mul67, %80
  store double %mul68, double* %d1, align 8
  %81 = load double, double* %a1, align 8
  %82 = load double, double* %b1, align 8
  %mul69 = fmul double %81, %82
  %83 = load double, double* %c1, align 8
  %mul70 = fmul double %mul69, %83
  %84 = load double, double* %d1, align 8
  %mul71 = fmul double %mul70, %84
  %85 = load i32, i32* %i, align 4
  %idxprom72 = sext i32 %85 to i64
  %arrayidx73 = getelementptr inbounds [32000 x double], [32000 x double]* @x, i32 0, i64 %idxprom72
...
for.end:                                          ; preds = %for.cond.1
  %87 = load double*, double** @a, align 32
  %88 = load double*, double** @b, align 32
  %89 = load double*, double** @c, align 32
  %90 = load double*, double** @d, align 32
  %91 = load double*, double** @e, align 32
  %92 = load [256 x double]*, [256 x double]** @aa, align 32
  %93 = load [256 x double]*, [256 x double]** @bb, align 32
  %94 = load [256 x double]*, [256 x double]** @cc, align 32
  %call74 = call i32 @dummy(double* %87, double* %88, double* %89, double* %90, double* %91, [256 x double]* %92, [256 x double]* %93, [256 x double]* %94, double 0.000000e+00)
  br label %for.inc.75
...
for.body.83:                                      ; preds = %for.cond.80
  ...
  %arrayidx85 = getelementptr inbounds [32000 x double], [32000 x double]* @x, i32 0, i64 %idxprom84
  %102 = load double, double* %arrayidx85, align 8
  %103 = load double, double* @temp, align 8
  %add86 = fadd double %103, %102
  store double %add86, double* @temp, align 8
  br label %for.inc.87
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call16 = call i32 @vpvts(double %11)
