; ModuleID = './MultiSource.Benchmarks.TSVC/46.NodeSplitting-flt.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S241\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [14 x i8] c"S242\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [14 x i8] c"S243\09 %.2f \09\09\00", align 1
@.str.140 = private unnamed_addr constant [14 x i8] c"S244\09 %.2f \09\09\00", align 1
@.str.141 = private unnamed_addr constant [15 x i8] c"S1244\09 %.2f \09\09\00", align 1
@.str.142 = private unnamed_addr constant [15 x i8] c"S2244\09 %.2f \09\09\00", align 1
...
@.str.144 = private unnamed_addr constant [31 x i8] c"Running each loop %d times...\0A\00", align 1
@.str.145 = private unnamed_addr constant [30 x i8] c"Loop \09 Time(Sec) \09 Checksum \0A\00", align 1
@x = common global [32000 x float] zeroinitializer, align 16
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.40, i32 0, i32 0))
...
for.end.25:                                       ; preds = %for.cond
  ...
  %call26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %38)
...
; Function Attrs: nounwind uwtable
define i32 @s242(float %s1, float %s2) #0 {
entry:
  %s1.addr = alloca float, align 4
  %s2.addr = alloca float, align 4
  %start_t = alloca i64, align 8
  %end_t = alloca i64, align 8
  %clock_dif = alloca i64, align 8
  %clock_dif_sec = alloca double, align 8
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  store float %s1, float* %s1.addr, align 4
  store float %s2, float* %s2.addr, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.41, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds float, float* %4, i64 %idxprom
  %5 = load float, float* %arrayidx, align 4
  %6 = load float, float* %s1.addr, align 4
  %add = fadd float %5, %6
  %7 = load float, float* %s2.addr, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call16 = call i32 @dummy(float* %20, float* %21, float* %22, float* %23, float* %24, [256 x float]* %25, [256 x float]* %26, [256 x float]* %27, float 0.000000e+00)
  br label %for.inc.17
...
for.end.19:                                       ; preds = %for.cond
  ...
  %div21 = fdiv double %conv, 1.000000e+06
  store double %div21, double* %clock_dif_sec, align 8
  %32 = load double, double* %clock_dif_sec, align 8
  %call22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i32 0, i32 0), double %32)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.42, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx13 = getelementptr inbounds float, float* %18, i64 %idxprom12
  ...
  %mul16 = fmul float %19, %22
  %add17 = fadd float %16, %mul16
  %23 = load i32, i32* %i, align 4
  ...
  %add28 = fadd float %27, %mul27
  %34 = load i32, i32* %i, align 4
  %idxprom29 = sext i32 %34 to i64
  %35 = load float*, float** @a, align 16
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call31 = call i32 @dummy(float* %37, float* %38, float* %39, float* %40, float* %41, [256 x float]* %42, [256 x float]* %43, [256 x float]* %44, float 0.000000e+00)
  br label %for.inc.32
...
for.end.34:                                       ; preds = %for.cond
  ...
  %call35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i32 0, i32 0), double %49)
  call void @check(i32 12)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.43, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call29 = call i32 @dummy(float* %34, float* %35, float* %36, float* %37, float* %38, [256 x float]* %39, [256 x float]* %40, [256 x float]* %41, float 0.000000e+00)
  br label %for.inc.30
...
for.end.32:                                       ; preds = %for.cond
  ...
  %call33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %46)
  call void @check(i32 12)
  ret i32 0
}
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %add24 = fadd float %25, %28
  %29 = load i32, i32* %i, align 4
  %idxprom25 = sext i32 %29 to i64
  %30 = load float*, float** @d, align 16
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call27 = call i32 @dummy(float* %32, float* %33, float* %34, float* %35, float* %36, [256 x float]* %37, [256 x float]* %38, [256 x float]* %39, float 0.000000e+00)
  br label %for.inc.28
...
for.end.30:                                       ; preds = %for.cond
  ...
  %call31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.141, i32 0, i32 0), double %44)
  call void @check(i32 12)
  ret i32 0
}
...
for.end.19:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %32 = load double, double* %clock_dif_sec, align 8
  %call20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.142, i32 0, i32 0), double %32)
  call void @check(i32 12)
  ret i32 0
}
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.143, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.144, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.145, i32 0, i32 0))
  %call9 = call i32 @s241()
  %9 = load float, float* %s1, align 4
  %10 = load float, float* %s2, align 4
  %call10 = call i32 @s242(float %9, float %10)
  %call11 = call i32 @s243()
  %call12 = call i32 @s244()
  %call13 = call i32 @s1244()
  %call14 = call i32 @s2244()
  ret i32 0
}
