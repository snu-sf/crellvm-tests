; ModuleID = './MultiSource.Benchmarks.TSVC/52.ControlFlow-dbl.tsc.bc'
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %4 = load double*, double** @b, align 32
  %arrayidx = getelementptr inbounds double, double* %4, i64 %idxprom
...
L20:                                              ; preds = %if.then
  ...
  %mul19 = fmul double %22, %25
  %add20 = fadd double %19, %mul19
  %26 = load i32, i32* %i, align 4
  %add21 = add nsw i32 %26, 1
  %idxprom22 = sext i32 %add21 to i64
  %27 = load double*, double** @c, align 32
...
for.end:                                          ; preds = %for.cond.1
  %29 = load double*, double** @a, align 32
  %30 = load double*, double** @b, align 32
  %31 = load double*, double** @c, align 32
  %32 = load double*, double** @d, align 32
  %33 = load double*, double** @e, align 32
  %34 = load [256 x double]*, [256 x double]** @aa, align 32
  %35 = load [256 x double]*, [256 x double]** @bb, align 32
  %36 = load [256 x double]*, [256 x double]** @cc, align 32
  %call24 = call i32 @dummy(double* %29, double* %30, double* %31, double* %32, double* %33, [256 x double]* %34, [256 x double]* %35, [256 x double]* %36, double 0.000000e+00)
  br label %for.inc.25
...
L20:                                              ; preds = %if.then
  ...
  %27 = load double*, double** @b, align 32
  %arrayidx22 = getelementptr inbounds double, double* %27, i64 %idxprom21
...
for.end:                                          ; preds = %for.cond.1
  ...
  %35 = load [256 x double]*, [256 x double]** @bb, align 32
  %36 = load [256 x double]*, [256 x double]** @cc, align 32
  %call23 = call i32 @dummy(double* %29, double* %30, double* %31, double* %32, double* %33, [256 x double]* %34, [256 x double]* %35, [256 x double]* %36, double 0.000000e+00)
  br label %for.inc.24
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %12 = load double*, double** @c, align 32
...
if.end:                                           ; preds = %for.end, %for.body
  ...
  %call12 = call i32 @dummy(double* %17, double* %18, double* %19, double* %20, double* %21, [256 x double]* %22, [256 x double]* %23, [256 x double]* %24, double 0.000000e+00)
  br label %for.inc.13
...
for.end:                                          ; preds = %for.cond.1
  %16 = load double*, double** @a, align 32
  %17 = load double*, double** @b, align 32
  %18 = load double*, double** @c, align 32
  %19 = load double*, double** @d, align 32
  %20 = load double*, double** @e, align 32
  %21 = load [256 x double]*, [256 x double]** @aa, align 32
  %22 = load [256 x double]*, [256 x double]** @bb, align 32
  %23 = load [256 x double]*, [256 x double]** @cc, align 32
  %call12 = call i32 @dummy(double* %16, double* %17, double* %18, double* %19, double* %20, [256 x double]* %21, [256 x double]* %22, [256 x double]* %23, double 0.000000e+00)
  br label %for.inc.13
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %4 = load double*, double** @e, align 32
  %arrayidx = getelementptr inbounds double, double* %4, i64 %idxprom
  %5 = load double, double* %arrayidx, align 8
  %6 = load double, double* %t.addr, align 8
  %cmp4 = fcmp oge double %5, %6
  br i1 %cmp4, label %if.then, label %if.end

if.then:                                          ; preds = %for.body.3
  %7 = load i32, i32* %i, align 4
  %idxprom5 = sext i32 %7 to i64
  %8 = load double*, double** @c, align 32
  %arrayidx6 = getelementptr inbounds double, double* %8, i64 %idxprom5
  ...
  %17 = load double*, double** @c, align 32
...
for.end:                                          ; preds = %for.cond.1
  %26 = load double*, double** @a, align 32
  %27 = load double*, double** @b, align 32
  %28 = load double*, double** @c, align 32
  %29 = load double*, double** @d, align 32
  %30 = load double*, double** @e, align 32
  %31 = load [256 x double]*, [256 x double]** @aa, align 32
  %32 = load [256 x double]*, [256 x double]** @bb, align 32
  %33 = load [256 x double]*, [256 x double]** @cc, align 32
  %call19 = call i32 @dummy(double* %26, double* %27, double* %28, double* %29, double* %30, [256 x double]* %31, [256 x double]* %32, [256 x double]* %33, double 0.000000e+00)
  br label %for.inc.20
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %4 = load double*, double** @d, align 32
  %arrayidx = getelementptr inbounds double, double* %4, i64 %idxprom
  %5 = load double, double* %arrayidx, align 8
  %6 = load i32, i32* %i, align 4
  %idxprom4 = sext i32 %6 to i64
  %7 = load double*, double** @e, align 32
...
for.end:                                          ; preds = %for.cond.1
  %34 = load double*, double** @a, align 32
  %35 = load double*, double** @b, align 32
  %36 = load double*, double** @c, align 32
  %37 = load double*, double** @d, align 32
  %38 = load double*, double** @e, align 32
  %39 = load [256 x double]*, [256 x double]** @aa, align 32
  %40 = load [256 x double]*, [256 x double]** @bb, align 32
  %41 = load [256 x double]*, [256 x double]** @cc, align 32
  %call27 = call i32 @dummy(double* %34, double* %35, double* %36, double* %37, double* %38, [256 x double]* %39, [256 x double]* %40, [256 x double]* %41, double 0.000000e+00)
  br label %for.inc.28
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %cmp12 = fcmp ogt double %16, 0.000000e+00
...
if.else:                                          ; preds = %for.body.3
  ...
  %26 = load double*, double** @d, align 32
  %arrayidx21 = getelementptr inbounds double, double* %26, i64 %idxprom20
  %27 = load double, double* %arrayidx21, align 8
  %28 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %28 to i64
  %29 = load double*, double** @e, align 32
  %arrayidx23 = getelementptr inbounds double, double* %29, i64 %idxprom22
  %30 = load double, double* %arrayidx23, align 8
  %mul24 = fmul double %27, %30
  %31 = load i32, i32* %i, align 4
  %idxprom25 = sext i32 %31 to i64
  %32 = load double*, double** @a, align 32
  %arrayidx26 = getelementptr inbounds double, double* %32, i64 %idxprom25
  store double %mul24, double* %arrayidx26, align 8
  br label %if.end
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %4 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx = getelementptr inbounds [256 x double], [256 x double]* %4, i64 0
  %arrayidx4 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx, i32 0, i64 %idxprom
  %5 = load double, double* %arrayidx4, align 8
  %cmp5 = fcmp ogt double %5, 0.000000e+00
...
for.body.8:                                       ; preds = %for.cond.6
  ...
  %9 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx11 = getelementptr inbounds [256 x double], [256 x double]* %9, i64 %idxprom10
  %arrayidx12 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx11, i32 0, i64 %idxprom9
  %10 = load double, double* %arrayidx12, align 8
  %11 = load i32, i32* %i, align 4
  %idxprom13 = sext i32 %11 to i64
  %12 = load i32, i32* %j, align 4
  %idxprom14 = sext i32 %12 to i64
  %13 = load [256 x double]*, [256 x double]** @bb, align 32
  %arrayidx15 = getelementptr inbounds [256 x double], [256 x double]* %13, i64 %idxprom14
  %arrayidx16 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx15, i32 0, i64 %idxprom13
  %14 = load double, double* %arrayidx16, align 8
  %15 = load i32, i32* %i, align 4
  %idxprom17 = sext i32 %15 to i64
  %16 = load i32, i32* %j, align 4
  %idxprom18 = sext i32 %16 to i64
  %17 = load [256 x double]*, [256 x double]** @cc, align 32
  %arrayidx19 = getelementptr inbounds [256 x double], [256 x double]* %17, i64 %idxprom18
  %arrayidx20 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx19, i32 0, i64 %idxprom17
  %18 = load double, double* %arrayidx20, align 8
  %mul21 = fmul double %14, %18
  %add = fadd double %10, %mul21
  %19 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %19 to i64
  %20 = load i32, i32* %j, align 4
  %idxprom23 = sext i32 %20 to i64
  %21 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx24 = getelementptr inbounds [256 x double], [256 x double]* %21, i64 %idxprom23
  %arrayidx25 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx24, i32 0, i64 %idxprom22
...
for.end.28:                                       ; preds = %for.cond.1
  %24 = load double*, double** @a, align 32
  %25 = load double*, double** @b, align 32
  %26 = load double*, double** @c, align 32
  %27 = load double*, double** @d, align 32
  %28 = load double*, double** @e, align 32
  %29 = load [256 x double]*, [256 x double]** @aa, align 32
  %30 = load [256 x double]*, [256 x double]** @bb, align 32
  %31 = load [256 x double]*, [256 x double]** @cc, align 32
  %call29 = call i32 @dummy(double* %24, double* %25, double* %26, double* %27, double* %28, [256 x double]* %29, [256 x double]* %30, [256 x double]* %31, double 0.000000e+00)
  br label %for.inc.30
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %6 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx = getelementptr inbounds [256 x double], [256 x double]* %6, i64 %idxprom7
  %arrayidx8 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx, i32 0, i64 %idxprom
  %7 = load double, double* %arrayidx8, align 8
  %8 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %8 to i64
  %9 = load i32, i32* %j, align 4
  %idxprom10 = sext i32 %9 to i64
  %10 = load [256 x double]*, [256 x double]** @bb, align 32
  %arrayidx11 = getelementptr inbounds [256 x double], [256 x double]* %10, i64 %idxprom10
  %arrayidx12 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx11, i32 0, i64 %idxprom9
  ...
  %14 = load [256 x double]*, [256 x double]** @cc, align 32
  %arrayidx15 = getelementptr inbounds [256 x double], [256 x double]* %14, i64 %idxprom14
  %arrayidx16 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx15, i32 0, i64 %idxprom13
  %15 = load double, double* %arrayidx16, align 8
  %mul17 = fmul double %11, %15
  %add = fadd double %7, %mul17
  %16 = load i32, i32* %i, align 4
  %idxprom18 = sext i32 %16 to i64
  %17 = load i32, i32* %j, align 4
  %idxprom19 = sext i32 %17 to i64
  %18 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx20 = getelementptr inbounds [256 x double], [256 x double]* %18, i64 %idxprom19
  %arrayidx21 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx20, i32 0, i64 %idxprom18
...
for.end:                                          ; preds = %for.cond.4
  ...
  %mul28 = fmul double %25, %28
  %add29 = fadd double %22, %mul28
...
for.end.34:                                       ; preds = %for.cond.1
  %32 = load double*, double** @a, align 32
  %33 = load double*, double** @b, align 32
  %34 = load double*, double** @c, align 32
  %35 = load double*, double** @d, align 32
  %36 = load double*, double** @e, align 32
  %37 = load [256 x double]*, [256 x double]** @aa, align 32
  %38 = load [256 x double]*, [256 x double]** @bb, align 32
  %39 = load [256 x double]*, [256 x double]** @cc, align 32
  %call35 = call i32 @dummy(double* %32, double* %33, double* %34, double* %35, double* %36, [256 x double]* %37, [256 x double]* %38, [256 x double]* %39, double 0.000000e+00)
  br label %for.inc.36
...
if.then:                                          ; preds = %for.body.3
  ...
  %8 = load i32, i32* %i, align 4
  %idxprom5 = sext i32 %8 to i64
  %9 = load double*, double** @c, align 32
  %arrayidx6 = getelementptr inbounds double, double* %9, i64 %idxprom5
  %10 = load double, double* %arrayidx6, align 8
  %mul7 = fmul double %7, %10
  %11 = load i32, i32* %i, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %30 = load [256 x double]*, [256 x double]** @bb, align 32
  %31 = load [256 x double]*, [256 x double]** @cc, align 32
  %call19 = call i32 @dummy(double* %24, double* %25, double* %26, double* %27, double* %28, [256 x double]* %29, [256 x double]* %30, [256 x double]* %31, double 0.000000e+00)
  br label %for.inc.20
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds double, double* %4, i64 %idxprom
  %5 = load double, double* %arrayidx, align 8
  %cmp4 = fcmp oge double %5, 0.000000e+00
  br i1 %cmp4, label %if.then, label %if.end
...
if.end:                                           ; preds = %for.body.3
  ...
  %arrayidx6 = getelementptr inbounds double, double* %7, i64 %idxprom5
  %8 = load double, double* %arrayidx6, align 8
  %cmp7 = fcmp oge double %8, 0.000000e+00
...
if.end.9:                                         ; preds = %if.end
  ...
  %13 = load double*, double** @d, align 32
...
L30:                                              ; preds = %if.end.9, %if.then.8
  ...
  %22 = load double*, double** @d, align 32
  ...
  %28 = load double*, double** @b, align 32
  %arrayidx26 = getelementptr inbounds double, double* %28, i64 %idxprom25
  store double %add23, double* %arrayidx26, align 8
  br label %L20
...
for.end:                                          ; preds = %for.cond.1
  %30 = load double*, double** @a, align 32
  %31 = load double*, double** @b, align 32
  %32 = load double*, double** @c, align 32
  %33 = load double*, double** @d, align 32
  %34 = load double*, double** @e, align 32
  %35 = load [256 x double]*, [256 x double]** @aa, align 32
  %36 = load [256 x double]*, [256 x double]** @bb, align 32
  %37 = load [256 x double]*, [256 x double]** @cc, align 32
  %call27 = call i32 @dummy(double* %30, double* %31, double* %32, double* %33, double* %34, [256 x double]* %35, [256 x double]* %36, [256 x double]* %37, double 0.000000e+00)
  br label %for.inc.28
...
if.end:                                           ; preds = %for.body.3
  ...
  %15 = load i32, i32* %i, align 4
  %idxprom11 = sext i32 %15 to i64
  %16 = load double*, double** @b, align 32
  %arrayidx12 = getelementptr inbounds double, double* %16, i64 %idxprom11
  store double %add, double* %arrayidx12, align 8
  br label %L30
...
L20:                                              ; preds = %if.then
  ...
  %arrayidx14 = getelementptr inbounds double, double* %18, i64 %idxprom13
  %19 = load double, double* %arrayidx14, align 8
  %sub15 = fsub double -0.000000e+00, %19
  %20 = load i32, i32* %i, align 4
  %idxprom16 = sext i32 %20 to i64
  %21 = load double*, double** @d, align 32
  %arrayidx17 = getelementptr inbounds double, double* %21, i64 %idxprom16
  ...
  %mul20 = fmul double %22, %25
  %add21 = fadd double %sub15, %mul20
  %26 = load i32, i32* %i, align 4
...
L30:                                              ; preds = %L20, %if.end
  ...
  %33 = load double, double* %arrayidx27, align 8
  ...
  %add31 = fadd double %30, %mul30
  %37 = load i32, i32* %i, align 4
  %idxprom32 = sext i32 %37 to i64
  %38 = load double*, double** @a, align 32
...
for.end:                                          ; preds = %for.cond.1
  %40 = load double*, double** @a, align 32
  %41 = load double*, double** @b, align 32
  %42 = load double*, double** @c, align 32
  %43 = load double*, double** @d, align 32
  %44 = load double*, double** @e, align 32
  %45 = load [256 x double]*, [256 x double]** @aa, align 32
  %46 = load [256 x double]*, [256 x double]** @bb, align 32
  %47 = load [256 x double]*, [256 x double]** @cc, align 32
  %call34 = call i32 @dummy(double* %40, double* %41, double* %42, double* %43, double* %44, [256 x double]* %45, [256 x double]* %46, [256 x double]* %47, double 0.000000e+00)
  br label %for.inc.35
...
if.end.19:                                        ; preds = %if.end
  ...
  %26 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %26 to i64
  %27 = load double*, double** @e, align 32
  %arrayidx23 = getelementptr inbounds double, double* %27, i64 %idxprom22
  %28 = load double, double* %arrayidx23, align 8
  %mul24 = fmul double %25, %28
  %29 = load i32, i32* %i, align 4
  %idxprom25 = sext i32 %29 to i64
...
L20:                                              ; preds = %if.then
  ...
  %39 = load double*, double** @e, align 32
...
L30:                                              ; preds = %L20, %if.end.19, %if.then.18
  ...
  %44 = load double*, double** @b, align 32
  ...
  %47 = load double*, double** @c, align 32
  ...
  %50 = load double*, double** @d, align 32
  %arrayidx44 = getelementptr inbounds double, double* %50, i64 %idxprom43
  %51 = load double, double* %arrayidx44, align 8
  %mul45 = fmul double %48, %51
  %add46 = fadd double %45, %mul45
  %52 = load i32, i32* %i, align 4
  %idxprom47 = sext i32 %52 to i64
  %53 = load double*, double** @a, align 32
  %arrayidx48 = getelementptr inbounds double, double* %53, i64 %idxprom47
...
for.end:                                          ; preds = %for.cond.1
  %55 = load double*, double** @a, align 32
  %56 = load double*, double** @b, align 32
  %57 = load double*, double** @c, align 32
  %58 = load double*, double** @d, align 32
  %59 = load double*, double** @e, align 32
  %60 = load [256 x double]*, [256 x double]** @aa, align 32
  %61 = load [256 x double]*, [256 x double]** @bb, align 32
  %62 = load [256 x double]*, [256 x double]** @cc, align 32
  %call49 = call i32 @dummy(double* %55, double* %56, double* %57, double* %58, double* %59, [256 x double]* %60, [256 x double]* %61, [256 x double]* %62, double 0.000000e+00)
  br label %for.inc.50
...
if.then.10:                                       ; preds = %if.then
  ...
  %16 = load double*, double** @e, align 32
  %arrayidx14 = getelementptr inbounds double, double* %16, i64 %idxprom13
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call18 = call i32 @dummy(double* %22, double* %23, double* %24, double* %25, double* %26, [256 x double]* %27, [256 x double]* %28, [256 x double]* %29, double 0.000000e+00)
  br label %for.inc.19
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx5 = getelementptr inbounds double, double* %7, i64 %idxprom4
  %8 = load double, double* %arrayidx5, align 8
  %cmp6 = fcmp ogt double %5, %8
  br i1 %cmp6, label %if.then, label %if.else

if.then:                                          ; preds = %for.body.3
  %9 = load i32, i32* %i, align 4
  %idxprom7 = sext i32 %9 to i64
  %10 = load double*, double** @b, align 32
  %arrayidx8 = getelementptr inbounds double, double* %10, i64 %idxprom7
  %11 = load double, double* %arrayidx8, align 8
  %12 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %12 to i64
...
if.else:                                          ; preds = %for.body.3
  ...
  %31 = load double*, double** @e, align 32
  ...
  %mul27 = fmul double %32, %35
  %add28 = fadd double %29, %mul27
  %36 = load i32, i32* %i, align 4
  %idxprom29 = sext i32 %36 to i64
  %37 = load double*, double** @b, align 32
  %arrayidx30 = getelementptr inbounds double, double* %37, i64 %idxprom29
  store double %add28, double* %arrayidx30, align 8
  %38 = load double, double* %x.addr, align 8
  %cmp31 = fcmp ogt double %38, 0.000000e+00
...
if.else.43:                                       ; preds = %if.else
  ...
  %51 = load double*, double** @e, align 32
  ...
  %54 = load double*, double** @e, align 32
  %arrayidx47 = getelementptr inbounds double, double* %54, i64 %idxprom46
  %55 = load double, double* %arrayidx47, align 8
  %mul48 = fmul double %52, %55
  %56 = load i32, i32* %i, align 4
  %idxprom49 = sext i32 %56 to i64
  %57 = load double*, double** @c, align 32
  %arrayidx50 = getelementptr inbounds double, double* %57, i64 %idxprom49
  %58 = load double, double* %arrayidx50, align 8
  %add51 = fadd double %58, %mul48
...
for.end:                                          ; preds = %for.cond.1
  %60 = load double*, double** @a, align 32
  %61 = load double*, double** @b, align 32
  %62 = load double*, double** @c, align 32
  %63 = load double*, double** @d, align 32
  %64 = load double*, double** @e, align 32
  %65 = load [256 x double]*, [256 x double]** @aa, align 32
  %66 = load [256 x double]*, [256 x double]** @bb, align 32
  %67 = load [256 x double]*, [256 x double]** @cc, align 32
  %call53 = call i32 @dummy(double* %60, double* %61, double* %62, double* %63, double* %64, [256 x double]* %65, [256 x double]* %66, [256 x double]* %67, double 0.000000e+00)
  br label %for.inc.54
...
for.end:                                          ; preds = %for.cond.1
  %19 = load double*, double** @a, align 32
  %20 = load double*, double** @b, align 32
  %21 = load double*, double** @c, align 32
  %22 = load double*, double** @d, align 32
  %23 = load double*, double** @e, align 32
  %24 = load [256 x double]*, [256 x double]** @aa, align 32
  %25 = load [256 x double]*, [256 x double]** @bb, align 32
  %26 = load [256 x double]*, [256 x double]** @cc, align 32
  %call14 = call i32 @dummy(double* %19, double* %20, double* %21, double* %22, double* %23, [256 x double]* %24, [256 x double]* %25, [256 x double]* %26, double 0.000000e+00)
  br label %for.inc.15
...
if.else:                                          ; preds = %for.body.3
  ...
  %arrayidx12 = getelementptr inbounds double, double* %16, i64 %idxprom11
  %17 = load double, double* %arrayidx12, align 8
  %cmp13 = fcmp oeq double %17, 0.000000e+00
...
if.then.14:                                       ; preds = %if.else
  ...
  %23 = load double, double* %arrayidx18, align 8
  %mul19 = fmul double %20, %23
  %24 = load i32, i32* %i, align 4
  %idxprom20 = sext i32 %24 to i64
  %25 = load double*, double** @a, align 32
  %arrayidx21 = getelementptr inbounds double, double* %25, i64 %idxprom20
  %26 = load double, double* %arrayidx21, align 8
  %add22 = fadd double %26, %mul19
...
for.end:                                          ; preds = %for.cond.1
  %37 = load double*, double** @a, align 32
  %38 = load double*, double** @b, align 32
  %39 = load double*, double** @c, align 32
  %40 = load double*, double** @d, align 32
  %41 = load double*, double** @e, align 32
  %42 = load [256 x double]*, [256 x double]** @aa, align 32
  %43 = load [256 x double]*, [256 x double]** @bb, align 32
  %44 = load [256 x double]*, [256 x double]** @cc, align 32
  %call33 = call i32 @dummy(double* %37, double* %38, double* %39, double* %40, double* %41, [256 x double]* %42, [256 x double]* %43, [256 x double]* %44, double 0.000000e+00)
  br label %for.inc.34
...
for.end:                                          ; preds = %for.cond.1
  %42 = load double*, double** @a, align 32
  %43 = load double*, double** @b, align 32
  %44 = load double*, double** @c, align 32
  %45 = load double*, double** @d, align 32
  %46 = load double*, double** @e, align 32
  %47 = load [256 x double]*, [256 x double]** @aa, align 32
  %48 = load [256 x double]*, [256 x double]** @bb, align 32
  %49 = load [256 x double]*, [256 x double]** @cc, align 32
  %call37 = call i32 @dummy(double* %42, double* %43, double* %44, double* %45, double* %46, [256 x double]* %47, [256 x double]* %48, [256 x double]* %49, double 0.000000e+00)
  br label %for.inc.38
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds double, double* %4, i64 %idxprom
  %5 = load double, double* %arrayidx, align 8
  %cmp4 = fcmp ole double %5, 0.000000e+00
  br i1 %cmp4, label %if.then, label %if.else
...
L30:                                              ; preds = %if.else
  ...
  %mul16 = fmul double %17, %20
  %21 = load i32, i32* %i, align 4
  %idxprom17 = sext i32 %21 to i64
  %22 = load double*, double** @a, align 32
  %arrayidx18 = getelementptr inbounds double, double* %22, i64 %idxprom17
  %23 = load double, double* %arrayidx18, align 8
  %add19 = fadd double %23, %mul16
...
for.end:                                          ; preds = %for.cond.1
  %25 = load double*, double** @a, align 32
  %26 = load double*, double** @b, align 32
  %27 = load double*, double** @c, align 32
  %28 = load double*, double** @d, align 32
  %29 = load double*, double** @e, align 32
  %30 = load [256 x double]*, [256 x double]** @aa, align 32
  %31 = load [256 x double]*, [256 x double]** @bb, align 32
  %32 = load [256 x double]*, [256 x double]** @cc, align 32
  %call20 = call i32 @dummy(double* %25, double* %26, double* %27, double* %28, double* %29, [256 x double]* %30, [256 x double]* %31, [256 x double]* %32, double 0.000000e+00)
  br label %for.inc.21
...
for.end:                                          ; preds = %for.cond.1
  ...
  %22 = load [256 x double]*, [256 x double]** @bb, align 32
  %23 = load [256 x double]*, [256 x double]** @cc, align 32
  %call11 = call i32 @dummy(double* %16, double* %17, double* %18, double* %19, double* %20, [256 x double]* %21, [256 x double]* %22, [256 x double]* %23, double 0.000000e+00)
  br label %for.inc.12
...
for.end:                                          ; preds = %if.then, %for.cond.1
  ...
  %25 = load [256 x double]*, [256 x double]** @bb, align 32
  %26 = load [256 x double]*, [256 x double]** @cc, align 32
  %call13 = call i32 @dummy(double* %19, double* %20, double* %21, double* %22, double* %23, [256 x double]* %24, [256 x double]* %25, [256 x double]* %26, double 0.000000e+00)
  br label %for.inc.14
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call13 = call i32 @s272(double %10)
  ...
  %call23 = call i32 @s2710(double %11)
