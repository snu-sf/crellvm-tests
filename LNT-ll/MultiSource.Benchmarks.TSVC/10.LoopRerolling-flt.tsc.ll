; ModuleID = './MultiSource.Benchmarks.TSVC/10.LoopRerolling-flt.tsc.bc'
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.93, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  %0 = load float*, float** @c, align 16
...
for.body.3:                                       ; preds = %for.cond.1
  %5 = load float, float* %alpha, align 4
  %6 = load i32, i32* %i, align 4
  ...
  %add23 = fadd float %25, %mul19
  store float %add23, float* %arrayidx22, align 4
  %26 = load float, float* %alpha, align 4
  %27 = load i32, i32* %i, align 4
  %add24 = add nsw i32 %27, 3
  ...
  %add31 = fadd float %32, %mul27
  store float %add31, float* %arrayidx30, align 4
  %33 = load float, float* %alpha, align 4
  %34 = load i32, i32* %i, align 4
  %add32 = add nsw i32 %34, 4
  ...
  %mul35 = fmul float %33, %36
  %37 = load i32, i32* %i, align 4
  %add36 = add nsw i32 %37, 4
  %idxprom37 = sext i32 %add36 to i64
  %38 = load float*, float** @a, align 16
  %arrayidx38 = getelementptr inbounds float, float* %38, i64 %idxprom37
  %39 = load float, float* %arrayidx38, align 4
  %add39 = fadd float %39, %mul35
  store float %add39, float* %arrayidx38, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body.3
  %40 = load i32, i32* %i, align 4
  %add40 = add nsw i32 %40, 5
  store i32 %add40, i32* %i, align 4
  br label %for.cond.1

for.end:                                          ; preds = %for.cond.1
  %41 = load float*, float** @a, align 16
  %42 = load float*, float** @b, align 16
  %43 = load float*, float** @c, align 16
  %44 = load float*, float** @d, align 16
  %45 = load float*, float** @e, align 16
  %46 = load [256 x float]*, [256 x float]** @aa, align 16
  %47 = load [256 x float]*, [256 x float]** @bb, align 16
  %48 = load [256 x float]*, [256 x float]** @cc, align 16
  %call41 = call i32 @dummy(float* %41, float* %42, float* %43, float* %44, float* %45, [256 x float]* %46, [256 x float]* %47, [256 x float]* %48, float 0.000000e+00)
  br label %for.inc.42
...
for.end.43:                                       ; preds = %for.cond
  ...
  %50 = load i64, i64* %end_t, align 8
  %51 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %50, %51
  store i64 %sub, i64* %clock_dif, align 8
  %52 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %52 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %53 = load double, double* %clock_dif_sec, align 8
  %call44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %53)
...
for.body:                                         ; preds = %for.cond
  ...
  store float* %4, float** %C, align 8
  store i32 0, i32* %i, align 4
  br label %for.cond.1

for.cond.1:                                       ; preds = %for.inc, %for.body
  %5 = load i32, i32* %i, align 4
  %cmp2 = icmp slt i32 %5, 32000
  br i1 %cmp2, label %for.body.3, label %for.end

for.body.3:                                       ; preds = %for.cond.1
  %6 = load float*, float** %B, align 8
  %7 = load float, float* %6, align 4
  %8 = load float*, float** %C, align 8
  %9 = load float, float* %8, align 4
  %add = fadd float %7, %9
  %10 = load float*, float** %A, align 8
  store float %add, float* %10, align 4
  %11 = load float*, float** %A, align 8
  %incdec.ptr = getelementptr inbounds float, float* %11, i32 1
  store float* %incdec.ptr, float** %A, align 8
  %12 = load float*, float** %B, align 8
  %incdec.ptr4 = getelementptr inbounds float, float* %12, i32 1
  store float* %incdec.ptr4, float** %B, align 8
  %13 = load float*, float** %C, align 8
  %incdec.ptr5 = getelementptr inbounds float, float* %13, i32 1
  store float* %incdec.ptr5, float** %C, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call6 = call i32 @dummy(float* %15, float* %16, float* %17, float* %18, float* %19, [256 x float]* %20, [256 x float]* %21, [256 x float]* %22, float 0.000000e+00)
  br label %for.inc.7
...
for.end.9:                                        ; preds = %for.cond
  ...
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.138, i32 0, i32 0), double %27)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  store i64 0, i64* %start_t, align 8
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.94, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %mul21 = fmul float %18, %21
  %add22 = fadd float %add14, %mul21
  %22 = load i32, i32* %i, align 4
  %add23 = add nsw i32 %22, 3
  %idxprom24 = sext i32 %add23 to i64
  %23 = load float*, float** @a, align 16
  %arrayidx25 = getelementptr inbounds float, float* %23, i64 %idxprom24
  ...
  %add30 = fadd float %add22, %mul29
  %28 = load i32, i32* %i, align 4
  %add31 = add nsw i32 %28, 4
  ...
  %mul37 = fmul float %30, %33
  %add38 = fadd float %add30, %mul37
  store float %add38, float* %dot, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body.3
  %34 = load i32, i32* %i, align 4
  %add39 = add nsw i32 %34, 5
  store i32 %add39, i32* %i, align 4
  br label %for.cond.1

for.end:                                          ; preds = %for.cond.1
  %35 = load float*, float** @a, align 16
  %36 = load float*, float** @b, align 16
  %37 = load float*, float** @c, align 16
  %38 = load float*, float** @d, align 16
  %39 = load float*, float** @e, align 16
  %40 = load [256 x float]*, [256 x float]** @aa, align 16
  %41 = load [256 x float]*, [256 x float]** @bb, align 16
  %42 = load [256 x float]*, [256 x float]** @cc, align 16
  %43 = load float, float* %dot, align 4
  %call40 = call i32 @dummy(float* %35, float* %36, float* %37, float* %38, float* %39, [256 x float]* %40, [256 x float]* %41, [256 x float]* %42, float %43)
  br label %for.inc.41
...
for.end.42:                                       ; preds = %for.cond
  ...
  %call43 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i32 0, i32 0), double %48)
  %49 = load float, float* %dot, align 4
  store float %49, float* @temp, align 4
  call void @check(i32 -1)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s353(i32* noalias %ip) #0 {
entry:
  ...
  store i64 0, i64* %start_t, align 8
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.95, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  %0 = load float*, float** @c, align 16
  %arrayidx = getelementptr inbounds float, float* %0, i64 0
  %1 = load float, float* %arrayidx, align 4
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %14 = load float, float* %alpha, align 4
  ...
  %add18 = fadd float %22, %mul14
  store float %add18, float* %arrayidx17, align 4
  %23 = load float, float* %alpha, align 4
  ...
  %arrayidx43 = getelementptr inbounds float, float* %45, i64 %idxprom42
  %46 = load float, float* %arrayidx43, align 4
  %mul44 = fmul float %41, %46
  %47 = load i32, i32* %i, align 4
  %add45 = add nsw i32 %47, 4
  %idxprom46 = sext i32 %add45 to i64
  %48 = load float*, float** @a, align 16
  %arrayidx47 = getelementptr inbounds float, float* %48, i64 %idxprom46
  %49 = load float, float* %arrayidx47, align 4
  %add48 = fadd float %49, %mul44
  store float %add48, float* %arrayidx47, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body.3
  %50 = load i32, i32* %i, align 4
  %add49 = add nsw i32 %50, 5
  store i32 %add49, i32* %i, align 4
  br label %for.cond.1

for.end:                                          ; preds = %for.cond.1
  %51 = load float*, float** @a, align 16
  %52 = load float*, float** @b, align 16
  %53 = load float*, float** @c, align 16
  %54 = load float*, float** @d, align 16
  %55 = load float*, float** @e, align 16
  %56 = load [256 x float]*, [256 x float]** @aa, align 16
  %57 = load [256 x float]*, [256 x float]** @bb, align 16
  %58 = load [256 x float]*, [256 x float]** @cc, align 16
  %call50 = call i32 @dummy(float* %51, float* %52, float* %53, float* %54, float* %55, [256 x float]* %56, [256 x float]* %57, [256 x float]* %58, float 0.000000e+00)
  br label %for.inc.51

for.inc.51:                                       ; preds = %for.end
  %59 = load i32, i32* %nl, align 4
...
for.end.52:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %60 = load i64, i64* %end_t, align 8
  %61 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %60, %61
  store i64 %sub, i64* %clock_dif, align 8
  %62 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %62 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %63 = load double, double* %clock_dif_sec, align 8
  %call53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %63)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.141, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.142, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.143, i32 0, i32 0))
  %call9 = call i32 @s351()
  %call10 = call i32 @s1351()
  %call11 = call i32 @s352()
  %9 = load i32*, i32** %ip, align 8
  %call12 = call i32 @s353(i32* %9)
  ret i32 0
}
