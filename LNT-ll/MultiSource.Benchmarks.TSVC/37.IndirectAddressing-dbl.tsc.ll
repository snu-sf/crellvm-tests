; ModuleID = './MultiSource.Benchmarks.TSVC/37.IndirectAddressing-dbl.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S491\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [15 x i8] c"S4112\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [15 x i8] c"S4113\09 %.2f \09\09\00", align 1
@.str.140 = private unnamed_addr constant [15 x i8] c"S4114\09 %.2f \09\09\00", align 1
@.str.141 = private unnamed_addr constant [15 x i8] c"S4115\09 %.2f \09\09\00", align 1
@.str.142 = private unnamed_addr constant [15 x i8] c"S4116\09 %.2f \09\09\00", align 1
@.str.143 = private unnamed_addr constant [15 x i8] c"S4117\09 %.2f \09\09\00", align 1
...
@.str.145 = private unnamed_addr constant [31 x i8] c"Running each loop %d times...\0A\00", align 1
@.str.146 = private unnamed_addr constant [30 x i8] c"Loop \09 Time(Sec) \09 Checksum \0A\00", align 1
@x = common global [32000 x double] zeroinitializer, align 32
...
; Function Attrs: nounwind uwtable
define i32 @s491(i32* noalias %ip) #0 {
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.116, i32 0, i32 0))
...
; Function Attrs: nounwind uwtable
define i32 @s4112(i32* noalias %ip, double %s) #0 {
entry:
  %ip.addr = alloca i32*, align 8
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.117, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call8 = call i32 @dummy(double* %13, double* %14, double* %15, double* %16, double* %17, [256 x double]* %18, [256 x double]* %19, [256 x double]* %20, double 0.000000e+00)
  br label %for.inc.9
...
for.end.11:                                       ; preds = %for.cond
  ...
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.138, i32 0, i32 0), double %25)
  call void @check(i32 1)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s4113(i32* noalias %ip) #0 {
entry:
  %ip.addr = alloca i32*, align 8
  %start_t = alloca i64, align 8
  %end_t = alloca i64, align 8
  ...
  %i = alloca i32, align 4
  store i32* %ip, i32** %ip.addr, align 8
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.118, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.15:                                       ; preds = %for.cond
  ...
  %call16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.139, i32 0, i32 0), double %28)
  call void @check(i32 1)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s4114(i32* %ip, i32 %n1) #0 {
entry:
  %ip.addr = alloca i32*, align 8
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.119, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  %4 = load i32, i32* %i, align 4
  %idxprom = sext i32 %4 to i64
  %5 = load i32*, i32** %ip.addr, align 8
  ...
  %sub6 = sub nsw i32 32000, %10
  %add = add nsw i32 %sub6, 1
  %sub7 = sub nsw i32 %add, 2
...
for.end.19:                                       ; preds = %for.cond
  ...
  %call21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.140, i32 0, i32 0), double %32)
  call void @check(i32 1)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s4115(i32* noalias %ip) #0 {
entry:
  %ip.addr = alloca i32*, align 8
  %start_t = alloca i64, align 8
  %end_t = alloca i64, align 8
  ...
  %i = alloca i32, align 4
  store i32* %ip, i32** %ip.addr, align 8
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.120, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.11:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %25 = load double, double* %clock_dif_sec, align 8
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.141, i32 0, i32 0), double %25)
  %26 = load double, double* %sum, align 8
  store double %26, double* @temp, align 8
  call void @check(i32 -1)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s4116(i32* noalias %ip, i32 %j, i32 %inc) #0 {
entry:
  %ip.addr = alloca i32*, align 8
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.121, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %12 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx8 = getelementptr inbounds [256 x double], [256 x double]* %12, i64 %idxprom7
  ...
  %mul10 = fmul double %7, %13
  %14 = load double, double* %sum, align 8
  %add11 = fadd double %14, %mul10
...
for.end:                                          ; preds = %for.cond.1
  ...
  %22 = load [256 x double]*, [256 x double]** @bb, align 32
  %23 = load [256 x double]*, [256 x double]** @cc, align 32
  %call13 = call i32 @dummy(double* %16, double* %17, double* %18, double* %19, double* %20, [256 x double]* %21, [256 x double]* %22, [256 x double]* %23, double 0.000000e+00)
  br label %for.inc.14
...
for.end.16:                                       ; preds = %for.cond
  ...
  store i64 %sub17, i64* %clock_dif, align 8
  %27 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %27 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %28 = load double, double* %clock_dif_sec, align 8
  %call18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.142, i32 0, i32 0), double %28)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.122, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.13:                                       ; preds = %for.cond
  ...
  %call15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.143, i32 0, i32 0), double %27)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.144, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.145, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.146, i32 0, i32 0))
  %9 = load i32*, i32** %ip, align 8
  %call9 = call i32 @s491(i32* %9)
  %10 = load i32*, i32** %ip, align 8
  %11 = load double, double* %s1, align 8
  %call10 = call i32 @s4112(i32* %10, double %11)
  %12 = load i32*, i32** %ip, align 8
  %call11 = call i32 @s4113(i32* %12)
  %13 = load i32*, i32** %ip, align 8
  %14 = load i32, i32* %n1, align 4
  %call12 = call i32 @s4114(i32* %13, i32 %14)
  %15 = load i32*, i32** %ip, align 8
  %call13 = call i32 @s4115(i32* %15)
  %16 = load i32*, i32** %ip, align 8
  %17 = load i32, i32* %n1, align 4
  %call14 = call i32 @s4116(i32* %16, i32 128, i32 %17)
  %call15 = call i32 @s4117()
  ret i32 0
}
