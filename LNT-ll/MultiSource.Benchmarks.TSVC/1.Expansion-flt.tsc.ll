; ModuleID = './MultiSource.Benchmarks.TSVC/1.Expansion-flt.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S251\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [15 x i8] c"S1251\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [15 x i8] c"S2251\09 %.2f \09\09\00", align 1
@.str.140 = private unnamed_addr constant [15 x i8] c"S3251\09 %.2f \09\09\00", align 1
@.str.141 = private unnamed_addr constant [14 x i8] c"S252\09 %.2f \09\09\00", align 1
@.str.142 = private unnamed_addr constant [14 x i8] c"S253\09 %.2f \09\09\00", align 1
@.str.143 = private unnamed_addr constant [14 x i8] c"S254\09 %.2f \09\09\00", align 1
@.str.144 = private unnamed_addr constant [14 x i8] c"S255\09 %.2f \09\09\00", align 1
@.str.145 = private unnamed_addr constant [14 x i8] c"S256\09 %.2f \09\09\00", align 1
@.str.146 = private unnamed_addr constant [14 x i8] c"S257\09 %.2f \09\09\00", align 1
@.str.147 = private unnamed_addr constant [14 x i8] c"S258\09 %.2f \09\09\00", align 1
@.str.148 = private unnamed_addr constant [14 x i8] c"S261\09 %.2f \09\09\00", align 1
...
@.str.150 = private unnamed_addr constant [31 x i8] c"Running each loop %d times...\0A\00", align 1
@.str.151 = private unnamed_addr constant [30 x i8] c"Loop \09 Time(Sec) \09 Checksum \0A\00", align 1
@x = common global [32000 x float] zeroinitializer, align 16
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.44, i32 0, i32 0))
...
for.end.15:                                       ; preds = %for.cond
  ...
  %call16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %29)
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call18 = call i32 @dummy(float* %24, float* %25, float* %26, float* %27, float* %28, [256 x float]* %29, [256 x float]* %30, [256 x float]* %31, float 0.000000e+00)
  br label %for.inc.19
...
for.end.21:                                       ; preds = %for.cond
  ...
  %call22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.138, i32 0, i32 0), double %36)
  call void @check(i32 1)
  ret i32 0
}
...
for.end:                                          ; preds = %for.cond.1
  ...
  %30 = load [256 x float]*, [256 x float]** @bb, align 16
  %31 = load [256 x float]*, [256 x float]** @cc, align 16
  %call17 = call i32 @dummy(float* %24, float* %25, float* %26, float* %27, float* %28, [256 x float]* %29, [256 x float]* %30, [256 x float]* %31, float 0.000000e+00)
  br label %for.inc.18
...
for.end.20:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %36 = load double, double* %clock_dif_sec, align 8
  %call21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.139, i32 0, i32 0), double %36)
  call void @check(i32 1)
  ret i32 0
}
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  store float %mul, float* %arrayidx14, align 4
  ...
  %24 = load float, float* %arrayidx18, align 4
  %mul19 = fmul float %21, %24
  %25 = load i32, i32* %i, align 4
  %idxprom20 = sext i32 %25 to i64
  %26 = load float*, float** @d, align 16
  %arrayidx21 = getelementptr inbounds float, float* %26, i64 %idxprom20
  store float %mul19, float* %arrayidx21, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %31 = load float*, float** @d, align 16
  %32 = load float*, float** @e, align 16
  %33 = load [256 x float]*, [256 x float]** @aa, align 16
  %34 = load [256 x float]*, [256 x float]** @bb, align 16
  %35 = load [256 x float]*, [256 x float]** @cc, align 16
  %call22 = call i32 @dummy(float* %28, float* %29, float* %30, float* %31, float* %32, [256 x float]* %33, [256 x float]* %34, [256 x float]* %35, float 0.000000e+00)
  br label %for.inc.23

for.inc.23:                                       ; preds = %for.end
  %36 = load i32, i32* %nl, align 4
...
for.end.25:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %37 = load i64, i64* %end_t, align 8
  %38 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %37, %38
  store i64 %sub, i64* %clock_dif, align 8
  %39 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %39 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %40 = load double, double* %clock_dif_sec, align 8
  %call26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.140, i32 0, i32 0), double %40)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.45, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %19 = load float*, float** @e, align 16
  %20 = load [256 x float]*, [256 x float]** @aa, align 16
  %21 = load [256 x float]*, [256 x float]** @bb, align 16
  %22 = load [256 x float]*, [256 x float]** @cc, align 16
  %call8 = call i32 @dummy(float* %15, float* %16, float* %17, float* %18, float* %19, [256 x float]* %20, [256 x float]* %21, [256 x float]* %22, float 0.000000e+00)
  br label %for.inc.9
...
for.end.11:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %24 = load i64, i64* %end_t, align 8
  %25 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %24, %25
  store i64 %sub, i64* %clock_dif, align 8
  %26 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %26 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %27 = load double, double* %clock_dif_sec, align 8
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.141, i32 0, i32 0), double %27)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.46, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
if.then:                                          ; preds = %for.body.3
  ...
  store float %22, float* %arrayidx16, align 4
  br label %if.end
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call17 = call i32 @dummy(float* %26, float* %27, float* %28, float* %29, float* %30, [256 x float]* %31, [256 x float]* %32, [256 x float]* %33, float 0.000000e+00)
  br label %for.inc.18
...
for.end.20:                                       ; preds = %for.cond
  ...
  %call22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.142, i32 0, i32 0), double %38)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.47, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %2 = load float*, float** @b, align 16
  %arrayidx = getelementptr inbounds float, float* %2, i64 31999
  %3 = load float, float* %arrayidx, align 4
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %add = fadd float %7, %8
  %mul5 = fmul float %add, 5.000000e-01
  %9 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %9 to i64
  %10 = load float*, float** @a, align 16
  %arrayidx7 = getelementptr inbounds float, float* %10, i64 %idxprom6
  store float %mul5, float* %arrayidx7, align 4
  %11 = load i32, i32* %i, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %21 = load [256 x float]*, [256 x float]** @bb, align 16
  %22 = load [256 x float]*, [256 x float]** @cc, align 16
  %call10 = call i32 @dummy(float* %15, float* %16, float* %17, float* %18, float* %19, [256 x float]* %20, [256 x float]* %21, [256 x float]* %22, float 0.000000e+00)
  br label %for.inc.11
...
for.end.13:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %27 = load double, double* %clock_dif_sec, align 8
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.143, i32 0, i32 0), double %27)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.48, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  ...
  store float %3, float* %x, align 4
  %4 = load float*, float** @b, align 16
  %arrayidx1 = getelementptr inbounds float, float* %4, i64 31998
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %arrayidx5 = getelementptr inbounds float, float* %8, i64 %idxprom
  %9 = load float, float* %arrayidx5, align 4
  %10 = load float, float* %x, align 4
  %add = fadd float %9, %10
  %11 = load float, float* %y, align 4
  %add6 = fadd float %add, %11
...
for.end:                                          ; preds = %for.cond.2
  ...
  %call11 = call i32 @dummy(float* %19, float* %20, float* %21, float* %22, float* %23, [256 x float]* %24, [256 x float]* %25, [256 x float]* %26, float 0.000000e+00)
  br label %for.inc.12
...
for.end.14:                                       ; preds = %for.cond
  ...
  %call15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.144, i32 0, i32 0), double %31)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.49, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %5 = load float*, float** @a, align 16
  %arrayidx = getelementptr inbounds float, float* %5, i64 %idxprom
  %6 = load float, float* %arrayidx, align 4
  %sub7 = fsub float 1.000000e+00, %6
  %7 = load i32, i32* %j, align 4
  %idxprom8 = sext i32 %7 to i64
  %8 = load float*, float** @a, align 16
  %arrayidx9 = getelementptr inbounds float, float* %8, i64 %idxprom8
  store float %sub7, float* %arrayidx9, align 4
  ...
  %arrayidx14 = getelementptr inbounds [256 x float], [256 x float]* %14, i64 %idxprom13
  %arrayidx15 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx14, i32 0, i64 %idxprom12
  %15 = load float, float* %arrayidx15, align 4
  %16 = load i32, i32* %j, align 4
  %idxprom16 = sext i32 %16 to i64
  %17 = load float*, float** @d, align 16
  %arrayidx17 = getelementptr inbounds float, float* %17, i64 %idxprom16
  %18 = load float, float* %arrayidx17, align 4
  %mul18 = fmul float %15, %18
  %add = fadd float %11, %mul18
  %19 = load i32, i32* %i, align 4
  %idxprom19 = sext i32 %19 to i64
  %20 = load i32, i32* %j, align 4
  %idxprom20 = sext i32 %20 to i64
  %21 = load [256 x float]*, [256 x float]** @cc, align 16
  %arrayidx21 = getelementptr inbounds [256 x float], [256 x float]* %21, i64 %idxprom20
  %arrayidx22 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx21, i32 0, i64 %idxprom19
...
for.end.25:                                       ; preds = %for.cond.1
  ...
  %30 = load [256 x float]*, [256 x float]** @bb, align 16
  %31 = load [256 x float]*, [256 x float]** @cc, align 16
  %call26 = call i32 @dummy(float* %24, float* %25, float* %26, float* %27, float* %28, [256 x float]* %29, [256 x float]* %30, [256 x float]* %31, float 0.000000e+00)
  br label %for.inc.27

for.inc.27:                                       ; preds = %for.end.25
  %32 = load i32, i32* %nl, align 4
  %inc28 = add nsw i32 %32, 1
  store i32 %inc28, i32* %nl, align 4
  br label %for.cond
...
for.end.29:                                       ; preds = %for.cond
  ...
  %33 = load i64, i64* %end_t, align 8
  %34 = load i64, i64* %start_t, align 8
  %sub30 = sub nsw i64 %33, %34
  store i64 %sub30, i64* %clock_dif, align 8
  %35 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %35 to double
  %div31 = fdiv double %conv, 1.000000e+06
  store double %div31, double* %clock_dif_sec, align 8
  %36 = load double, double* %clock_dif_sec, align 8
  %call32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.145, i32 0, i32 0), double %36)
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.50, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %arrayidx18 = getelementptr inbounds [256 x float], [256 x float]* %18, i64 %idxprom17
  %arrayidx19 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx18, i32 0, i64 %idxprom16
  %19 = load float, float* %arrayidx19, align 4
  %add = fadd float %15, %19
  %20 = load i32, i32* %i, align 4
  %idxprom20 = sext i32 %20 to i64
  %21 = load i32, i32* %j, align 4
  %idxprom21 = sext i32 %21 to i64
  %22 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx22 = getelementptr inbounds [256 x float], [256 x float]* %22, i64 %idxprom21
  %arrayidx23 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx22, i32 0, i64 %idxprom20
...
for.end.26:                                       ; preds = %for.cond.1
  ...
  %call27 = call i32 @dummy(float* %25, float* %26, float* %27, float* %28, float* %29, [256 x float]* %30, [256 x float]* %31, [256 x float]* %32, float 0.000000e+00)
  br label %for.inc.28

for.inc.28:                                       ; preds = %for.end.26
...
for.end.30:                                       ; preds = %for.cond
  ...
  %sub31 = sub nsw i64 %34, %35
  store i64 %sub31, i64* %clock_dif, align 8
  %36 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %36 to double
  %div32 = fdiv double %conv, 1.000000e+06
  store double %div32, double* %clock_dif_sec, align 8
  %37 = load double, double* %clock_dif_sec, align 8
  %call33 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.146, i32 0, i32 0), double %37)
  call void @check(i32 111)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.51, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %for.body.3
  ...
  %add17 = fadd float %21, 1.000000e+00
  %22 = load i32, i32* %i, align 4
  %idxprom18 = sext i32 %22 to i64
  %23 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx19 = getelementptr inbounds [256 x float], [256 x float]* %23, i64 0
  %arrayidx20 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx19, i32 0, i64 %idxprom18
  %24 = load float, float* %arrayidx20, align 4
  %mul21 = fmul float %add17, %24
  %25 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %25 to i64
  %26 = load float*, float** @e, align 16
  %arrayidx23 = getelementptr inbounds float, float* %26, i64 %idxprom22
...
for.end:                                          ; preds = %for.cond.1
  ...
  %34 = load [256 x float]*, [256 x float]** @bb, align 16
  %35 = load [256 x float]*, [256 x float]** @cc, align 16
  %call24 = call i32 @dummy(float* %28, float* %29, float* %30, float* %31, float* %32, [256 x float]* %33, [256 x float]* %34, [256 x float]* %35, float 0.000000e+00)
  br label %for.inc.25
...
for.end.27:                                       ; preds = %for.cond
  ...
  store i64 %sub, i64* %clock_dif, align 8
  %39 = load i64, i64* %clock_dif, align 8
  %conv28 = sitofp i64 %39 to double
  %div29 = fdiv double %conv28, 1.000000e+06
  store double %div29, double* %clock_dif_sec, align 8
  %40 = load double, double* %clock_dif_sec, align 8
  %call30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.147, i32 0, i32 0), double %40)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.52, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %31 = load [256 x float]*, [256 x float]** @bb, align 16
  %32 = load [256 x float]*, [256 x float]** @cc, align 16
  %call17 = call i32 @dummy(float* %25, float* %26, float* %27, float* %28, float* %29, [256 x float]* %30, [256 x float]* %31, [256 x float]* %32, float 0.000000e+00)
  br label %for.inc.18
...
for.end.20:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %37 = load double, double* %clock_dif_sec, align 8
  %call22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.148, i32 0, i32 0), double %37)
  call void @check(i32 25)
  ret i32 0
}
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.149, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.150, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.151, i32 0, i32 0))
  %call9 = call i32 @s251()
  %call10 = call i32 @s1251()
  %call11 = call i32 @s2251()
  %call12 = call i32 @s3251()
  %call13 = call i32 @s252()
  %call14 = call i32 @s253()
  %call15 = call i32 @s254()
  %call16 = call i32 @s255()
  %call17 = call i32 @s256()
  %call18 = call i32 @s257()
  %call19 = call i32 @s258()
  %call20 = call i32 @s261()
  ret i32 0
}
