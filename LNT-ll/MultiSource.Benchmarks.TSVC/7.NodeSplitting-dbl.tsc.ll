; ModuleID = './MultiSource.Benchmarks.TSVC/7.NodeSplitting-dbl.tsc.bc'
...
; Function Attrs: nounwind uwtable
define i32 @s242(double %s1, double %s2) #0 {
entry:
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds double, double* %4, i64 %idxprom
  %5 = load double, double* %arrayidx, align 8
  %6 = load double, double* %s1.addr, align 8
  %add = fadd double %5, %6
  %7 = load double, double* %s2.addr, align 8
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call16 = call i32 @dummy(double* %20, double* %21, double* %22, double* %23, double* %24, [256 x double]* %25, [256 x double]* %26, [256 x double]* %27, double 0.000000e+00)
  br label %for.inc.17
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call31 = call i32 @dummy(double* %37, double* %38, double* %39, double* %40, double* %41, [256 x double]* %42, [256 x double]* %43, [256 x double]* %44, double 0.000000e+00)
  br label %for.inc.32
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call29 = call i32 @dummy(double* %34, double* %35, double* %36, double* %37, double* %38, [256 x double]* %39, [256 x double]* %40, [256 x double]* %41, double 0.000000e+00)
  br label %for.inc.30
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %add24 = fadd double %25, %28
  %29 = load i32, i32* %i, align 4
  %idxprom25 = sext i32 %29 to i64
  %30 = load double*, double** @d, align 32
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call27 = call i32 @dummy(double* %32, double* %33, double* %34, double* %35, double* %36, [256 x double]* %37, [256 x double]* %38, [256 x double]* %39, double 0.000000e+00)
  br label %for.inc.28
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call10 = call i32 @s242(double %9, double %10)
