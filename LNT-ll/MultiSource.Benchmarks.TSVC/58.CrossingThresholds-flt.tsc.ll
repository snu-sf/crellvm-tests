; ModuleID = './MultiSource.Benchmarks.TSVC/58.CrossingThresholds-flt.tsc.bc'
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %sub9 = fsub float %12, 1.000000e+00
  %13 = load i32, i32* %i, align 4
  %idxprom10 = sext i32 %13 to i64
  %14 = load float*, float** @a, align 16
  %arrayidx11 = getelementptr inbounds float, float* %14, i64 %idxprom10
  store float %sub9, float* %arrayidx11, align 4
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %sub = fsub float %18, 1.000000e+00
  ...
  store float %21, float* %arrayidx18, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call19 = call i32 @dummy(float* %25, float* %26, float* %27, float* %28, float* %29, [256 x float]* %30, [256 x float]* %31, [256 x float]* %32, float 0.000000e+00)
  br label %for.inc.20
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %8 = load float, float* %arrayidx5, align 4
  %add = fadd float %5, %8
  %mul6 = fmul float %add, 5.000000e-01
  %9 = load i32, i32* %i, align 4
  %idxprom7 = sext i32 %9 to i64
  %10 = load float*, float** @a, align 16
  %arrayidx8 = getelementptr inbounds float, float* %10, i64 %idxprom7
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %mul = fmul float %add8, 0x3FD54FDF40000000
  %12 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %12 to i64
  %13 = load float*, float** @a, align 16
  %arrayidx10 = getelementptr inbounds float, float* %13, i64 %idxprom9
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call11 = call i32 @dummy(float* %17, float* %18, float* %19, float* %20, float* %21, [256 x float]* %22, [256 x float]* %23, [256 x float]* %24, float 0.000000e+00)
  br label %for.inc.12
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call5 = call i32 @dummy(float* %8, float* %9, float* %10, float* %11, float* %12, [256 x float]* %13, [256 x float]* %14, [256 x float]* %15, float 0.000000e+00)
  br label %for.inc.6
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %5 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx = getelementptr inbounds [256 x float], [256 x float]* %5, i64 %idxprom4
  ...
  %arrayidx8 = getelementptr inbounds [256 x float], [256 x float]* %9, i64 %idxprom7
  %arrayidx9 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx8, i32 0, i64 %idxprom6
  %10 = load float, float* %arrayidx9, align 4
  %mul10 = fmul float %6, %10
  %11 = load i32, i32* %i, align 4
  %idxprom11 = sext i32 %11 to i64
  %12 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %12 to i64
  %13 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx13 = getelementptr inbounds [256 x float], [256 x float]* %13, i64 %idxprom12
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call15 = call i32 @dummy(float* %16, float* %17, float* %18, float* %19, float* %20, [256 x float]* %21, [256 x float]* %22, [256 x float]* %23, float 0.000000e+00)
  br label %for.inc.16
...
for.end:                                          ; preds = %for.cond.4
  ...
  %10 = load [256 x float]*, [256 x float]** @aa, align 16
...
for.end.15:                                       ; preds = %for.cond.1
  ...
  %call16 = call i32 @dummy(float* %12, float* %13, float* %14, float* %15, float* %16, [256 x float]* %17, [256 x float]* %18, [256 x float]* %19, float 0.000000e+00)
  br label %for.inc.17
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %arrayidx13 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx12, i32 0, i64 %idxprom9
...
for.body.37:                                      ; preds = %for.cond.34
  ...
  %arrayidx40 = getelementptr inbounds [256 x float], [256 x float]* %34, i64 %idxprom39
  %arrayidx41 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx40, i32 0, i64 %idxprom38
  %35 = load float, float* %arrayidx41, align 4
  %36 = load float, float* @temp, align 4
  %add42 = fadd float %36, %35
  store float %add42, float* @temp, align 4
  br label %for.inc.43
...
for.end.48:                                       ; preds = %for.cond.29
  ...
  %cmp49 = fcmp oeq float %39, 0.000000e+00
