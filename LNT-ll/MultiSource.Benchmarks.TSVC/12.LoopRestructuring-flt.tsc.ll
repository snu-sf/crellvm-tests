; ModuleID = './MultiSource.Benchmarks.TSVC/12.LoopRestructuring-flt.tsc.bc'
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.33, i32 0, i32 0))
...
for.end.21:                                       ; preds = %for.cond
  ...
  store i64 %sub22, i64* %clock_dif, align 8
  %35 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %35 to double
  %div23 = fdiv double %conv, 1.000000e+06
  store double %div23, double* %clock_dif_sec, align 8
  %36 = load double, double* %clock_dif_sec, align 8
  %call24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %36)
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call8 = call i32 @dummy(float* %12, float* %13, float* %14, float* %15, float* %16, [256 x float]* %17, [256 x float]* %18, [256 x float]* %19, float 0.000000e+00)
  br label %for.inc.9
...
for.end.11:                                       ; preds = %for.cond
  ...
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.138, i32 0, i32 0), double %24)
  call void @check(i32 12)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.34, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call24 = call i32 @dummy(float* %30, float* %31, float* %32, float* %33, float* %34, [256 x float]* %35, [256 x float]* %36, [256 x float]* %37, float 0.000000e+00)
  br label %for.inc.25
...
for.end.27:                                       ; preds = %for.cond
  ...
  %sub28 = sub nsw i64 %39, %40
  store i64 %sub28, i64* %clock_dif, align 8
  ...
  %call30 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i32 0, i32 0), double %42)
  call void @check(i32 12)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.35, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.23:                                       ; preds = %for.cond
  ...
  %call26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %29)
...
entry:
  ...
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.36, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %mul14 = fmul float %8, %12
  %13 = load i32, i32* %i, align 4
  %idxprom15 = sext i32 %13 to i64
  %14 = load i32, i32* %j, align 4
  %idxprom16 = sext i32 %14 to i64
  %15 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx17 = getelementptr inbounds [256 x float], [256 x float]* %15, i64 %idxprom16
  %arrayidx18 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx17, i32 0, i64 %idxprom15
  %16 = load float, float* %arrayidx18, align 4
  %add = fadd float %mul14, %16
  %17 = load i32, i32* %i, align 4
  %idxprom19 = sext i32 %17 to i64
  %18 = load i32, i32* %j, align 4
  %idxprom20 = sext i32 %18 to i64
  %19 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx21 = getelementptr inbounds [256 x float], [256 x float]* %19, i64 %idxprom20
...
for.end.25:                                       ; preds = %for.cond.1
  ...
  %call26 = call i32 @dummy(float* %22, float* %23, float* %24, float* %25, float* %26, [256 x float]* %27, [256 x float]* %28, [256 x float]* %29, float 1.000000e+00)
  br label %for.inc.27
...
for.end.29:                                       ; preds = %for.cond
  ...
  %call32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.141, i32 0, i32 0), double %34)
  call void @check(i32 11)
  ret i32 0
}
...
for.end.19:                                       ; preds = %for.cond.1
  ...
  %call20 = call i32 @dummy(float* %18, float* %19, float* %20, float* %21, float* %22, [256 x float]* %23, [256 x float]* %24, [256 x float]* %25, float 1.000000e+00)
  br label %for.inc.21
...
for.end.23:                                       ; preds = %for.cond
  ...
  %call25 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.142, i32 0, i32 0), double %30)
  call void @check(i32 11)
  ret i32 0
}
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.37, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.cond.18:                                      ; preds = %for.inc.35, %for.end
  %16 = load i32, i32* %j17, align 4
  %cmp19 = icmp slt i32 %16, 256
...
for.body.20:                                      ; preds = %for.cond.18
  ...
  %arrayidx24 = getelementptr inbounds [256 x float], [256 x float]* %19, i64 %idxprom23
  ...
  %22 = load i32, i32* %j17, align 4
  %idxprom27 = sext i32 %22 to i64
  %23 = load [256 x float]*, [256 x float]** @cc, align 16
  %arrayidx28 = getelementptr inbounds [256 x float], [256 x float]* %23, i64 %idxprom27
  %arrayidx29 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx28, i32 0, i64 %idxprom26
  %24 = load float, float* %arrayidx29, align 4
  %add30 = fadd float %20, %24
  %25 = load i32, i32* %i, align 4
  %idxprom31 = sext i32 %25 to i64
  %26 = load i32, i32* %j17, align 4
  %idxprom32 = sext i32 %26 to i64
  %27 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx33 = getelementptr inbounds [256 x float], [256 x float]* %27, i64 %idxprom32
  %arrayidx34 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx33, i32 0, i64 %idxprom31
  store float %add30, float* %arrayidx34, align 4
  br label %for.inc.35

for.inc.35:                                       ; preds = %for.body.20
  %28 = load i32, i32* %j17, align 4
  %inc36 = add nsw i32 %28, 1
  store i32 %inc36, i32* %j17, align 4
  br label %for.cond.18
...
for.end.40:                                       ; preds = %for.cond.1
  ...
  %36 = load [256 x float]*, [256 x float]** @bb, align 16
  %37 = load [256 x float]*, [256 x float]** @cc, align 16
  %call41 = call i32 @dummy(float* %30, float* %31, float* %32, float* %33, float* %34, [256 x float]* %35, [256 x float]* %36, [256 x float]* %37, float 0.000000e+00)
  br label %for.inc.42

for.inc.42:                                       ; preds = %for.end.40
  %38 = load i32, i32* %nl, align 4
  %inc43 = add nsw i32 %38, 1
  store i32 %inc43, i32* %nl, align 4
  br label %for.cond
...
for.end.44:                                       ; preds = %for.cond
  ...
  %39 = load i64, i64* %end_t, align 8
  %40 = load i64, i64* %start_t, align 8
  %sub45 = sub nsw i64 %39, %40
  store i64 %sub45, i64* %clock_dif, align 8
  %41 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %41 to double
  %div46 = fdiv double %conv, 1.000000e+06
  store double %div46, double* %clock_dif_sec, align 8
  %42 = load double, double* %clock_dif_sec, align 8
  %call47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.143, i32 0, i32 0), double %42)
...
for.body.20:                                      ; preds = %for.cond.18
  ...
  %19 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx24 = getelementptr inbounds [256 x float], [256 x float]* %19, i64 %idxprom23
  %arrayidx25 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx24, i32 0, i64 %idxprom21
  %20 = load float, float* %arrayidx25, align 4
...
for.end.44:                                       ; preds = %for.cond
  ...
  store double %div46, double* %clock_dif_sec, align 8
  %42 = load double, double* %clock_dif_sec, align 8
  %call47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.144, i32 0, i32 0), double %42)
  call void @check(i32 1122)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.39, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.11:                                      ; preds = %for.cond.9
  ...
  %15 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx14 = getelementptr inbounds [256 x float], [256 x float]* %15, i64 %idxprom13
  ...
  %19 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx18 = getelementptr inbounds [256 x float], [256 x float]* %19, i64 %idxprom17
  ...
  %mul22 = fmul float %20, %23
  %add23 = fadd float %16, %mul22
  %24 = load i32, i32* %i, align 4
  %idxprom24 = sext i32 %24 to i64
  %25 = load i32, i32* %j, align 4
  %idxprom25 = sext i32 %25 to i64
  %26 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx26 = getelementptr inbounds [256 x float], [256 x float]* %26, i64 %idxprom25
  %arrayidx27 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx26, i32 0, i64 %idxprom24
  store float %add23, float* %arrayidx27, align 4
  br label %for.inc
...
for.end.30:                                       ; preds = %for.cond.1
  ...
  %36 = load [256 x float]*, [256 x float]** @cc, align 16
  %call31 = call i32 @dummy(float* %29, float* %30, float* %31, float* %32, float* %33, [256 x float]* %34, [256 x float]* %35, [256 x float]* %36, float 0.000000e+00)
  br label %for.inc.32

for.inc.32:                                       ; preds = %for.end.30
  %37 = load i32, i32* %nl, align 4
  %inc33 = add nsw i32 %37, 1
  store i32 %inc33, i32* %nl, align 4
  br label %for.cond
...
for.end.34:                                       ; preds = %for.cond
  ...
  %sub35 = sub nsw i64 %38, %39
  store i64 %sub35, i64* %clock_dif, align 8
  %40 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %40 to double
  %div36 = fdiv double %conv, 1.000000e+06
  store double %div36, double* %clock_dif_sec, align 8
  %41 = load double, double* %clock_dif_sec, align 8
  %call37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.145, i32 0, i32 0), double %41)
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.146, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.147, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.148, i32 0, i32 0))
  %call9 = call i32 @s221()
  %call10 = call i32 @s1221()
  %call11 = call i32 @s222()
  %call12 = call i32 @s231()
  %call13 = call i32 @s232()
  %call14 = call i32 @s1232()
  %call15 = call i32 @s233()
  %call16 = call i32 @s2233()
  %call17 = call i32 @s235()
  ret i32 0
}
