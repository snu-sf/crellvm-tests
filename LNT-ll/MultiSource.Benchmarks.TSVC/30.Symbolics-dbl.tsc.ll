; ModuleID = './MultiSource.Benchmarks.TSVC/30.Symbolics-dbl.tsc.bc'
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call7 = call i32 @dummy(double* %12, double* %13, double* %14, double* %15, double* %16, [256 x double]* %17, [256 x double]* %18, [256 x double]* %19, double 0.000000e+00)
  br label %for.inc.8
...
for.end:                                          ; preds = %for.cond.1
  ...
  %20 = load [256 x double]*, [256 x double]** @bb, align 32
  %21 = load [256 x double]*, [256 x double]** @cc, align 32
  %call10 = call i32 @dummy(double* %14, double* %15, double* %16, double* %17, double* %18, [256 x double]* %19, [256 x double]* %20, [256 x double]* %21, double 0.000000e+00)
  br label %for.inc.11
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %add13 = fadd double %15, %mul10
  store double %add13, double* %arrayidx12, align 8
  br label %for.inc
...
for.end.16:                                       ; preds = %for.cond.1
  ...
  %call17 = call i32 @dummy(double* %18, double* %19, double* %20, double* %21, double* %22, [256 x double]* %23, [256 x double]* %24, [256 x double]* %25, double 0.000000e+00)
  br label %for.inc.18
