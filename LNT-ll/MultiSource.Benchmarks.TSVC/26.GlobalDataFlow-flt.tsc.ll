; ModuleID = './MultiSource.Benchmarks.TSVC/26.GlobalDataFlow-flt.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S131\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [14 x i8] c"S132\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [14 x i8] c"S141\09 %.2f \09\09\00", align 1
@.str.140 = private unnamed_addr constant [14 x i8] c"S151\09 %.2f \09\09\00", align 1
@.str.141 = private unnamed_addr constant [14 x i8] c"S152\09 %.2f \09\09\00", align 1
@.str.142 = private unnamed_addr constant [14 x i8] c"S431\09 %.2f \09\09\00", align 1
@.str.143 = private unnamed_addr constant [14 x i8] c"S451\09 %.2f \09\09\00", align 1
@.str.144 = private unnamed_addr constant [14 x i8] c"S452\09 %.2f \09\09\00", align 1
@x = common global [32000 x float] zeroinitializer, align 16
@.str.145 = private unnamed_addr constant [14 x i8] c"S471\09 %.2f \09\09\00", align 1
@.str.146 = private unnamed_addr constant [15 x i8] c"S4121\09 %.2f \09\09\00", align 1
...
@.str.148 = private unnamed_addr constant [31 x i8] c"Running each loop %d times...\0A\00", align 1
@.str.149 = private unnamed_addr constant [30 x i8] c"Loop \09 Time(Sec) \09 Checksum \0A\00", align 1
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.18, i32 0, i32 0))
...
for.end.12:                                       ; preds = %for.cond
  ...
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %25)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.19, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
...
for.cond:                                         ; preds = %for.inc.16, %entry
  ...
  %3 = load i32, i32* @ntimes, align 4
  %mul = mul nsw i32 400, %3
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds [256 x float], [256 x float]* %7, i64 %idxprom4
  %arrayidx5 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx, i32 0, i64 %idxprom
  ...
  %add10 = fadd float %8, %mul9
  %14 = load i32, i32* %i, align 4
  %idxprom11 = sext i32 %14 to i64
  %15 = load i32, i32* %j, align 4
  %idxprom12 = sext i32 %15 to i64
  %16 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx13 = getelementptr inbounds [256 x float], [256 x float]* %16, i64 %idxprom12
  %arrayidx14 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx13, i32 0, i64 %idxprom11
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call15 = call i32 @dummy(float* %18, float* %19, float* %20, float* %21, float* %22, [256 x float]* %23, [256 x float]* %24, [256 x float]* %25, float 0.000000e+00)
  br label %for.inc.16

for.inc.16:                                       ; preds = %for.end
  %26 = load i32, i32* %nl, align 4
  %inc17 = add nsw i32 %26, 1
  store i32 %inc17, i32* %nl, align 4
  br label %for.cond
...
for.end.18:                                       ; preds = %for.cond
  ...
  %sub19 = sub nsw i64 %27, %28
  store i64 %sub19, i64* %clock_dif, align 8
  %29 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %29 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %30 = load double, double* %clock_dif_sec, align 8
  %call20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i32 0, i32 0), double %30)
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.20, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %mul5 = mul nsw i32 %add, %sub
  %div6 = sdiv i32 %mul5, 2
  %5 = load i32, i32* %i, align 4
  %add7 = add nsw i32 %5, 1
  %add8 = add nsw i32 %div6, %add7
...
for.body.12:                                      ; preds = %for.cond.10
  ...
  %arrayidx = getelementptr inbounds [256 x float], [256 x float]* %10, i64 %idxprom13
  %arrayidx14 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx, i32 0, i64 %idxprom
  %11 = load float, float* %arrayidx14, align 4
  %12 = load i32, i32* %k, align 4
  %idxprom15 = sext i32 %12 to i64
  %arrayidx16 = getelementptr inbounds [65536 x float], [65536 x float]* @array, i32 0, i64 %idxprom15
  %13 = load float, float* %arrayidx16, align 4
  %add17 = fadd float %13, %11
  store float %add17, float* %arrayidx16, align 4
  %14 = load i32, i32* %j, align 4
  %add18 = add nsw i32 %14, 1
  %15 = load i32, i32* %k, align 4
  %add19 = add nsw i32 %15, %add18
  store i32 %add19, i32* %k, align 4
  br label %for.inc
...
for.end.22:                                       ; preds = %for.cond.1
  ...
  %24 = load [256 x float]*, [256 x float]** @bb, align 16
  %25 = load [256 x float]*, [256 x float]** @cc, align 16
  %call23 = call i32 @dummy(float* %18, float* %19, float* %20, float* %21, float* %22, [256 x float]* %23, [256 x float]* %24, [256 x float]* %25, float 0.000000e+00)
  br label %for.inc.24
...
for.end.26:                                       ; preds = %for.cond
  ...
  %27 = load i64, i64* %end_t, align 8
  %28 = load i64, i64* %start_t, align 8
  %sub27 = sub nsw i64 %27, %28
  store i64 %sub27, i64* %clock_dif, align 8
  %29 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %29 to double
  %div28 = fdiv double %conv, 1.000000e+06
  store double %div28, double* %clock_dif_sec, align 8
  %30 = load double, double* %clock_dif_sec, align 8
  %call29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i32 0, i32 0), double %30)
  call void @check(i32 0)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s151s(float* %a, float* %b, i32 %m) #0 {
entry:
...
entry:
  ...
  %clock_dif_sec = alloca double, align 8
  %nl = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.21, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body:                                         ; preds = %for.cond
  %2 = load float*, float** @a, align 16
  %3 = load float*, float** @b, align 16
  %call1 = call i32 @s151s(float* %2, float* %3, i32 1)
  %4 = load float*, float** @a, align 16
  %5 = load float*, float** @b, align 16
  %6 = load float*, float** @c, align 16
  %7 = load float*, float** @d, align 16
  %8 = load float*, float** @e, align 16
  %9 = load [256 x float]*, [256 x float]** @aa, align 16
  %10 = load [256 x float]*, [256 x float]** @bb, align 16
  %11 = load [256 x float]*, [256 x float]** @cc, align 16
  %call2 = call i32 @dummy(float* %4, float* %5, float* %6, float* %7, float* %8, [256 x float]* %9, [256 x float]* %10, [256 x float]* %11, float 0.000000e+00)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %13 = load i64, i64* %end_t, align 8
  %14 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %13, %14
  store i64 %sub, i64* %clock_dif, align 8
  %15 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %15 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %16 = load double, double* %clock_dif_sec, align 8
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %16)
  call void @check(i32 1)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s152s(float* %a, float* %b, float* %c, i32 %i) #0 {
entry:
  %a.addr = alloca float*, align 8
  %b.addr = alloca float*, align 8
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.22, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %14 = load i32, i32* %i, align 4
  %call8 = call i32 @s152s(float* %11, float* %12, float* %13, i32 %14)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call9 = call i32 @dummy(float* %16, float* %17, float* %18, float* %19, float* %20, [256 x float]* %21, [256 x float]* %22, [256 x float]* %23, float 0.000000e+00)
  br label %for.inc.10
...
for.end.12:                                       ; preds = %for.cond
  ...
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.141, i32 0, i32 0), double %28)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.105, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.13:                                       ; preds = %for.cond
  ...
  %sub14 = sub nsw i64 %24, %25
  store i64 %sub14, i64* %clock_dif, align 8
  %26 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %26 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %27 = load double, double* %clock_dif_sec, align 8
  %call15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.142, i32 0, i32 0), double %27)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.110, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds float, float* %4, i64 %idxprom
  %5 = load float, float* %arrayidx, align 4
  %call4 = call float @sinf(float %5) #6
  %6 = load i32, i32* %i, align 4
  ...
  %call7 = call float @cosf(float %8) #6
  %add = fadd float %call4, %call7
  %9 = load i32, i32* %i, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call10 = call i32 @dummy(float* %12, float* %13, float* %14, float* %15, float* %16, [256 x float]* %17, [256 x float]* %18, [256 x float]* %19, float 0.000000e+00)
  br label %for.inc.11
...
for.end.13:                                       ; preds = %for.cond
  ...
  %div14 = fdiv double %conv, 1.000000e+06
  store double %div14, double* %clock_dif_sec, align 8
  %24 = load double, double* %clock_dif_sec, align 8
  %call15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.143, i32 0, i32 0), double %24)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.111, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %add = add nsw i32 %9, 1
  %conv = sitofp i32 %add to float
  %mul6 = fmul float %8, %conv
  %add7 = fadd float %5, %mul6
  %10 = load i32, i32* %i, align 4
...
for.end.13:                                       ; preds = %for.cond
  ...
  store i64 %sub, i64* %clock_dif, align 8
  %24 = load i64, i64* %clock_dif, align 8
  %conv14 = sitofp i64 %24 to double
  %div = fdiv double %conv14, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %25 = load double, double* %clock_dif_sec, align 8
  %call15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.144, i32 0, i32 0), double %25)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  store i32 32000, i32* %m, align 4
  %call = call i32 @set1d(float* getelementptr inbounds ([32000 x float], [32000 x float]* @x, i32 0, i32 0), float 0.000000e+00, i32 1)
  %call1 = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.113, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %arrayidx10 = getelementptr inbounds [32000 x float], [32000 x float]* @x, i32 0, i64 %idxprom9
  store float %add, float* %arrayidx10, align 4
  %call11 = call i32 @s471s()
  %14 = load i32, i32* %i, align 4
  ...
  %mul18 = fmul float %19, %22
  %add19 = fadd float %16, %mul18
...
for.end:                                          ; preds = %for.cond.2
  ...
  %call22 = call i32 @dummy(float* %26, float* %27, float* %28, float* %29, float* %30, [256 x float]* %31, [256 x float]* %32, [256 x float]* %33, float 0.000000e+00)
  br label %for.inc.23
...
for.end.25:                                       ; preds = %for.cond
  ...
  %call27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.145, i32 0, i32 0), double %38)
  store float 0.000000e+00, float* @temp, align 4
  store i32 0, i32* %i28, align 4
  br label %for.cond.29

for.cond.29:                                      ; preds = %for.inc.36, %for.end.25
  %39 = load i32, i32* %i28, align 4
  %cmp30 = icmp slt i32 %39, 32000
...
for.body.32:                                      ; preds = %for.cond.29
  ...
  %arrayidx34 = getelementptr inbounds [32000 x float], [32000 x float]* @x, i32 0, i64 %idxprom33
  %41 = load float, float* %arrayidx34, align 4
  %42 = load float, float* @temp, align 4
  %add35 = fadd float %42, %41
  store float %add35, float* @temp, align 4
  br label %for.inc.36
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.123, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.12:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %25 = load double, double* %clock_dif_sec, align 8
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.146, i32 0, i32 0), double %25)
  call void @check(i32 1)
  ret i32 0
}

; Function Attrs: inlinehint nounwind uwtable
define internal float @f(float %a, float %b) #4 {
entry:
...
entry:
  ...
  %call = call i32 @posix_memalign(i8** bitcast (float** @xx to i8**), i64 16, i64 128000) #6
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.147, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %call = call i32 @posix_memalign(i8** %0, i64 16, i64 128000) #6
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.148, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.149, i32 0, i32 0))
  %call9 = call i32 @s131()
  %call10 = call i32 @s132()
  %call11 = call i32 @s141()
  %call12 = call i32 @s151()
  %call13 = call i32 @s152()
  %call14 = call i32 @s431()
  %call15 = call i32 @s451()
  %call16 = call i32 @s452()
  %call17 = call i32 @s471()
  %call18 = call i32 @s4121()
  ret i32 0
}
