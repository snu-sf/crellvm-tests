; ModuleID = './MultiSource.Benchmarks.TSVC/55.ControlLoops-flt.tsc.bc'
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.124, i32 0, i32 0))
...
for.end.9:                                        ; preds = %for.cond
  ...
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.137, i32 0, i32 0), double %21)
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.125, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call8 = call i32 @dummy(float* %11, float* %12, float* %13, float* %14, float* %15, [256 x float]* %16, [256 x float]* %17, [256 x float]* %18, float 0.000000e+00)
  br label %for.inc.9
...
for.end.11:                                       ; preds = %for.cond
  ...
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.138, i32 0, i32 0), double %23)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  store i32* %ip, i32** %ip.addr, align 8
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.126, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.11:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %23 = load double, double* %clock_dif_sec, align 8
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.139, i32 0, i32 0), double %23)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.127, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.inc.10:                                       ; preds = %for.end
  ...
  store i32 %inc11, i32* %nl, align 4
  br label %for.cond
...
for.end.12:                                       ; preds = %for.cond
  ...
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.140, i32 0, i32 0), double %24)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.128, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  %10 = load float*, float** @a, align 16
  %11 = load float*, float** @b, align 16
  %12 = load float*, float** @c, align 16
  %13 = load float*, float** @d, align 16
  %14 = load float*, float** @e, align 16
  %15 = load [256 x float]*, [256 x float]** @aa, align 16
  %16 = load [256 x float]*, [256 x float]** @bb, align 16
  %17 = load [256 x float]*, [256 x float]** @cc, align 16
  %call6 = call i32 @dummy(float* %10, float* %11, float* %12, float* %13, float* %14, [256 x float]* %15, [256 x float]* %16, [256 x float]* %17, float 0.000000e+00)
  br label %for.inc.7
...
for.end.9:                                        ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %19 = load i64, i64* %end_t, align 8
  %20 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %19, %20
  store i64 %sub, i64* %clock_dif, align 8
  %21 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %21 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %22 = load double, double* %clock_dif_sec, align 8
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.141, i32 0, i32 0), double %22)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.129, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %16 = load [256 x float]*, [256 x float]** @bb, align 16
  %17 = load [256 x float]*, [256 x float]** @cc, align 16
  %call7 = call i32 @dummy(float* %10, float* %11, float* %12, float* %13, float* %14, [256 x float]* %15, [256 x float]* %16, [256 x float]* %17, float 0.000000e+00)
  br label %for.inc.8
...
for.end.10:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %22 = load double, double* %clock_dif_sec, align 8
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.142, i32 0, i32 0), double %22)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.130, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call9 = call i32 @dummy(float* %13, float* %14, float* %15, float* %16, float* %17, [256 x float]* %18, [256 x float]* %19, [256 x float]* %20, float 0.000000e+00)
  br label %for.inc.10
...
for.end.12:                                       ; preds = %for.cond
  ...
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.143, i32 0, i32 0), double %25)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.131, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %17 = load [256 x float]*, [256 x float]** @bb, align 16
  %18 = load [256 x float]*, [256 x float]** @cc, align 16
  %call6 = call i32 @dummy(float* %11, float* %12, float* %13, float* %14, float* %15, [256 x float]* %16, [256 x float]* %17, [256 x float]* %18, float 0.000000e+00)
  br label %for.inc.7
...
for.end.9:                                        ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %23 = load double, double* %clock_dif_sec, align 8
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.144, i32 0, i32 0), double %23)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.132, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.12:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %25 = load double, double* %clock_dif_sec, align 8
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.145, i32 0, i32 0), double %25)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.133, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call12 = call i32 @dummy(float* %15, float* %16, float* %17, float* %18, float* %19, [256 x float]* %20, [256 x float]* %21, [256 x float]* %22, float 0.000000e+00)
  br label %for.inc.13
...
for.end.15:                                       ; preds = %for.cond
  ...
  %call16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.146, i32 0, i32 0), double %27)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.134, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %12 = load float*, float** @e, align 16
  %13 = load [256 x float]*, [256 x float]** @aa, align 16
  %14 = load [256 x float]*, [256 x float]** @bb, align 16
  %15 = load [256 x float]*, [256 x float]** @cc, align 16
  %16 = load float, float* %sum, align 4
  %call4 = call i32 @dummy(float* %8, float* %9, float* %10, float* %11, float* %12, [256 x float]* %13, [256 x float]* %14, [256 x float]* %15, float %16)
  br label %for.inc.5
...
for.end.7:                                        ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %21 = load double, double* %clock_dif_sec, align 8
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.147, i32 0, i32 0), double %21)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.135, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %8 = load float, float* %arrayidx5, align 4
  %mul6 = fmul float %5, %8
  %9 = load float, float* %dot, align 4
  %add = fadd float %9, %mul6
...
for.end:                                          ; preds = %for.cond.1
  ...
  %17 = load [256 x float]*, [256 x float]** @bb, align 16
  %18 = load [256 x float]*, [256 x float]** @cc, align 16
  %19 = load float, float* %dot, align 4
  %call7 = call i32 @dummy(float* %11, float* %12, float* %13, float* %14, float* %15, [256 x float]* %16, [256 x float]* %17, [256 x float]* %18, float %19)
  br label %for.inc.8
...
for.end.10:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %24 = load double, double* %clock_dif_sec, align 8
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.148, i32 0, i32 0), double %24)
  %25 = load float, float* %dot, align 4
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.136, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx5 = getelementptr inbounds float, float* %7, i64 %idxprom4
  %8 = load float, float* %arrayidx5, align 4
  store float %8, float* %b1, align 4
  %9 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %9 to i64
  %10 = load float*, float** @c, align 16
  %arrayidx7 = getelementptr inbounds float, float* %10, i64 %idxprom6
  %11 = load float, float* %arrayidx7, align 4
  store float %11, float* %c1, align 4
  %12 = load i32, i32* %i, align 4
  %idxprom8 = sext i32 %12 to i64
  %13 = load float*, float** @d, align 16
  %arrayidx9 = getelementptr inbounds float, float* %13, i64 %idxprom8
  %14 = load float, float* %arrayidx9, align 4
  store float %14, float* %d1, align 4
  %15 = load i32, i32* %i, align 4
  %idxprom10 = sext i32 %15 to i64
  %16 = load float*, float** @e, align 16
  %arrayidx11 = getelementptr inbounds float, float* %16, i64 %idxprom10
  %17 = load float, float* %arrayidx11, align 4
  store float %17, float* %e1, align 4
  %18 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %18 to i64
  %19 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx13 = getelementptr inbounds [256 x float], [256 x float]* %19, i64 0
  %arrayidx14 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx13, i32 0, i64 %idxprom12
  %20 = load float, float* %arrayidx14, align 4
  store float %20, float* %f1, align 4
  %21 = load float, float* %a1, align 4
  %22 = load float, float* %b1, align 4
  %mul = fmul float %21, %22
  %23 = load float, float* %c1, align 4
  %mul15 = fmul float %mul, %23
  %24 = load float, float* %a1, align 4
  %25 = load float, float* %b1, align 4
  %mul16 = fmul float %24, %25
  %26 = load float, float* %d1, align 4
  %mul17 = fmul float %mul16, %26
  %add = fadd float %mul15, %mul17
  %27 = load float, float* %a1, align 4
  %28 = load float, float* %b1, align 4
  %mul18 = fmul float %27, %28
  %29 = load float, float* %e1, align 4
  %mul19 = fmul float %mul18, %29
  %add20 = fadd float %add, %mul19
  %30 = load float, float* %a1, align 4
  %31 = load float, float* %b1, align 4
  %mul21 = fmul float %30, %31
  %32 = load float, float* %f1, align 4
  %mul22 = fmul float %mul21, %32
  %add23 = fadd float %add20, %mul22
  %33 = load float, float* %a1, align 4
  %34 = load float, float* %c1, align 4
  %mul24 = fmul float %33, %34
  %35 = load float, float* %d1, align 4
  %mul25 = fmul float %mul24, %35
  %add26 = fadd float %add23, %mul25
  %36 = load float, float* %a1, align 4
  %37 = load float, float* %c1, align 4
  %mul27 = fmul float %36, %37
  %38 = load float, float* %e1, align 4
  %mul28 = fmul float %mul27, %38
  %add29 = fadd float %add26, %mul28
  %39 = load float, float* %a1, align 4
  %40 = load float, float* %c1, align 4
  %mul30 = fmul float %39, %40
  %41 = load float, float* %f1, align 4
  %mul31 = fmul float %mul30, %41
  %add32 = fadd float %add29, %mul31
  %42 = load float, float* %a1, align 4
  %43 = load float, float* %d1, align 4
  %mul33 = fmul float %42, %43
  %44 = load float, float* %e1, align 4
  %mul34 = fmul float %mul33, %44
  %add35 = fadd float %add32, %mul34
  %45 = load float, float* %a1, align 4
  %46 = load float, float* %d1, align 4
  %mul36 = fmul float %45, %46
  %47 = load float, float* %f1, align 4
  %mul37 = fmul float %mul36, %47
  %add38 = fadd float %add35, %mul37
  %48 = load float, float* %a1, align 4
  %49 = load float, float* %e1, align 4
  %mul39 = fmul float %48, %49
  %50 = load float, float* %f1, align 4
  %mul40 = fmul float %mul39, %50
  %add41 = fadd float %add38, %mul40
  store float %add41, float* %a1, align 4
  %51 = load float, float* %b1, align 4
  %52 = load float, float* %c1, align 4
  %mul42 = fmul float %51, %52
  %53 = load float, float* %d1, align 4
  %mul43 = fmul float %mul42, %53
  %54 = load float, float* %b1, align 4
  %55 = load float, float* %c1, align 4
  %mul44 = fmul float %54, %55
  %56 = load float, float* %e1, align 4
  %mul45 = fmul float %mul44, %56
  %add46 = fadd float %mul43, %mul45
  %57 = load float, float* %b1, align 4
  %58 = load float, float* %c1, align 4
  %mul47 = fmul float %57, %58
  %59 = load float, float* %f1, align 4
  %mul48 = fmul float %mul47, %59
  %add49 = fadd float %add46, %mul48
  %60 = load float, float* %b1, align 4
  %61 = load float, float* %d1, align 4
  %mul50 = fmul float %60, %61
  %62 = load float, float* %e1, align 4
  %mul51 = fmul float %mul50, %62
  %add52 = fadd float %add49, %mul51
  %63 = load float, float* %b1, align 4
  %64 = load float, float* %d1, align 4
  %mul53 = fmul float %63, %64
  %65 = load float, float* %f1, align 4
  %mul54 = fmul float %mul53, %65
  %add55 = fadd float %add52, %mul54
  %66 = load float, float* %b1, align 4
  %67 = load float, float* %e1, align 4
  %mul56 = fmul float %66, %67
  %68 = load float, float* %f1, align 4
  %mul57 = fmul float %mul56, %68
  %add58 = fadd float %add55, %mul57
  store float %add58, float* %b1, align 4
  %69 = load float, float* %c1, align 4
  %70 = load float, float* %d1, align 4
  %mul59 = fmul float %69, %70
  %71 = load float, float* %e1, align 4
  %mul60 = fmul float %mul59, %71
  %72 = load float, float* %c1, align 4
  %73 = load float, float* %d1, align 4
  %mul61 = fmul float %72, %73
  %74 = load float, float* %f1, align 4
  %mul62 = fmul float %mul61, %74
  %add63 = fadd float %mul60, %mul62
  %75 = load float, float* %c1, align 4
  %76 = load float, float* %e1, align 4
  %mul64 = fmul float %75, %76
  %77 = load float, float* %f1, align 4
  %mul65 = fmul float %mul64, %77
  %add66 = fadd float %add63, %mul65
  store float %add66, float* %c1, align 4
  %78 = load float, float* %d1, align 4
  %79 = load float, float* %e1, align 4
  %mul67 = fmul float %78, %79
  %80 = load float, float* %f1, align 4
  %mul68 = fmul float %mul67, %80
  store float %mul68, float* %d1, align 4
  %81 = load float, float* %a1, align 4
  %82 = load float, float* %b1, align 4
  %mul69 = fmul float %81, %82
  %83 = load float, float* %c1, align 4
  %mul70 = fmul float %mul69, %83
  %84 = load float, float* %d1, align 4
  %mul71 = fmul float %mul70, %84
  %85 = load i32, i32* %i, align 4
  %idxprom72 = sext i32 %85 to i64
  %arrayidx73 = getelementptr inbounds [32000 x float], [32000 x float]* @x, i32 0, i64 %idxprom72
...
for.end:                                          ; preds = %for.cond.1
  %87 = load float*, float** @a, align 16
  %88 = load float*, float** @b, align 16
  %89 = load float*, float** @c, align 16
  %90 = load float*, float** @d, align 16
  %91 = load float*, float** @e, align 16
  %92 = load [256 x float]*, [256 x float]** @aa, align 16
  %93 = load [256 x float]*, [256 x float]** @bb, align 16
  %94 = load [256 x float]*, [256 x float]** @cc, align 16
  %call74 = call i32 @dummy(float* %87, float* %88, float* %89, float* %90, float* %91, [256 x float]* %92, [256 x float]* %93, [256 x float]* %94, float 0.000000e+00)
  br label %for.inc.75

for.inc.75:                                       ; preds = %for.end
  %95 = load i32, i32* %nl, align 4
  %inc76 = add nsw i32 %95, 1
  store i32 %inc76, i32* %nl, align 4
  br label %for.cond

for.end.77:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %96 = load i64, i64* %end_t, align 8
  %97 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %96, %97
  store i64 %sub, i64* %clock_dif, align 8
  %98 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %98 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %99 = load double, double* %clock_dif_sec, align 8
  %call78 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.149, i32 0, i32 0), double %99)
  store float 0.000000e+00, float* @temp, align 4
  store i32 0, i32* %i79, align 4
  br label %for.cond.80

for.cond.80:                                      ; preds = %for.inc.87, %for.end.77
  %100 = load i32, i32* %i79, align 4
  %cmp81 = icmp slt i32 %100, 32000
  br i1 %cmp81, label %for.body.83, label %for.end.89

for.body.83:                                      ; preds = %for.cond.80
  %101 = load i32, i32* %i79, align 4
  %idxprom84 = sext i32 %101 to i64
  %arrayidx85 = getelementptr inbounds [32000 x float], [32000 x float]* @x, i32 0, i64 %idxprom84
  %102 = load float, float* %arrayidx85, align 4
  %103 = load float, float* @temp, align 4
  %add86 = fadd float %103, %102
  store float %add86, float* @temp, align 4
  br label %for.inc.87

for.inc.87:                                       ; preds = %for.body.83
  %104 = load i32, i32* %i79, align 4
  %inc88 = add nsw i32 %104, 1
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.150, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.151, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.152, i32 0, i32 0))
  %call9 = call i32 @va()
  %9 = load i32*, i32** %ip, align 8
  %call10 = call i32 @vag(i32* %9)
  %10 = load i32*, i32** %ip, align 8
  %call11 = call i32 @vas(i32* %10)
  %call12 = call i32 @vif()
  %call13 = call i32 @vpv()
  %call14 = call i32 @vtv()
  %call15 = call i32 @vpvtv()
  %11 = load float, float* %s1, align 4
  %call16 = call i32 @vpvts(float %11)
  %call17 = call i32 @vpvpv()
  %call18 = call i32 @vtvtv()
  %call19 = call i32 @vsumr()
  %call20 = call i32 @vdotr()
  %call21 = call i32 @vbor()
  ret i32 0
}
