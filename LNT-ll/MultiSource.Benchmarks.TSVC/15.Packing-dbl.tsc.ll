; ModuleID = './MultiSource.Benchmarks.TSVC/15.Packing-dbl.tsc.bc'
...
if.then:                                          ; preds = %for.body.3
  ...
  store double %9, double* %arrayidx8, align 8
  br label %if.end
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %cmp9 = fcmp ogt double %7, 0.000000e+00
...
if.then:                                          ; preds = %for.body.6
  ...
  %arrayidx15 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i32 0, i64 %idxprom14
...
for.end.19:                                       ; preds = %for.cond.1
  ...
  %call20 = call i32 @dummy(double* %16, double* %17, double* %18, double* %19, double* %20, [256 x double]* %21, [256 x double]* %22, [256 x double]* %23, double 0.000000e+00)
  br label %for.inc.21
