; ModuleID = './MultiSource.Benchmarks.TSVC/36.InductionVariable-flt.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S121\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [14 x i8] c"S122\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [14 x i8] c"S123\09 %.2f \09\09\00", align 1
@.str.140 = private unnamed_addr constant [14 x i8] c"S124\09 %.2f \09\09\00", align 1
@.str.141 = private unnamed_addr constant [14 x i8] c"S125\09 %.2f \09\09\00", align 1
@.str.142 = private unnamed_addr constant [14 x i8] c"S126\09 %.2f \09\09\00", align 1
@.str.143 = private unnamed_addr constant [14 x i8] c"S127\09 %.2f \09\09\00", align 1
@.str.144 = private unnamed_addr constant [14 x i8] c"S128\09 %.2f \09\09\00", align 1
@.str.145 = private unnamed_addr constant [14 x i8] c"S453\09 %.2f \09\09\00", align 1
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.10, i32 0, i32 0))
...
; Function Attrs: nounwind uwtable
define i32 @s122(i32 %n1, i32 %n3) #0 {
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.11, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %add7 = fadd float %11, %8
  store float %add7, float* %arrayidx6, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body.3
  %12 = load i32, i32* %n3.addr, align 4
  %13 = load i32, i32* %i, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %20 = load [256 x float]*, [256 x float]** @bb, align 16
  %21 = load [256 x float]*, [256 x float]** @cc, align 16
  %call9 = call i32 @dummy(float* %14, float* %15, float* %16, float* %17, float* %18, [256 x float]* %19, [256 x float]* %20, [256 x float]* %21, float 0.000000e+00)
  br label %for.inc.10
...
for.end.11:                                       ; preds = %for.cond
  ...
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i32 0, i32 0), double %26)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.12, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %11 = load float*, float** @e, align 16
  ...
  %cmp12 = fcmp ogt float %17, 0.000000e+00
...
if.then:                                          ; preds = %for.body.3
  ...
  %21 = load float, float* %arrayidx15, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %32 = load float*, float** @b, align 16
  %33 = load float*, float** @c, align 16
  %34 = load float*, float** @d, align 16
  %35 = load float*, float** @e, align 16
  %36 = load [256 x float]*, [256 x float]** @aa, align 16
  %37 = load [256 x float]*, [256 x float]** @bb, align 16
  %38 = load [256 x float]*, [256 x float]** @cc, align 16
  %call25 = call i32 @dummy(float* %31, float* %32, float* %33, float* %34, float* %35, [256 x float]* %36, [256 x float]* %37, [256 x float]* %38, float 0.000000e+00)
  br label %for.inc.26

for.inc.26:                                       ; preds = %for.end
  %39 = load i32, i32* %nl, align 4
...
for.end.28:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %40 = load i64, i64* %end_t, align 8
  %41 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %40, %41
  store i64 %sub, i64* %clock_dif, align 8
  %42 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %42 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %43 = load double, double* %clock_dif_sec, align 8
  %call29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i32 0, i32 0), double %43)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.13, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.28:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %43 = load double, double* %clock_dif_sec, align 8
  %call29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %43)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.14, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %mul17 = fmul float %12, %16
  %add = fadd float %8, %mul17
  %17 = load i32, i32* %k, align 4
  %idxprom18 = sext i32 %17 to i64
  %arrayidx19 = getelementptr inbounds [65536 x float], [65536 x float]* @array, i32 0, i64 %idxprom18
...
for.end.23:                                       ; preds = %for.cond.1
  ...
  %22 = load float*, float** @c, align 16
  %23 = load float*, float** @d, align 16
  %24 = load float*, float** @e, align 16
  %25 = load [256 x float]*, [256 x float]** @aa, align 16
  %26 = load [256 x float]*, [256 x float]** @bb, align 16
  %27 = load [256 x float]*, [256 x float]** @cc, align 16
  %call24 = call i32 @dummy(float* %20, float* %21, float* %22, float* %23, float* %24, [256 x float]* %25, [256 x float]* %26, [256 x float]* %27, float 0.000000e+00)
  br label %for.inc.25
...
for.end.27:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %29 = load i64, i64* %end_t, align 8
  %30 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %29, %30
  store i64 %sub, i64* %clock_dif, align 8
  %31 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %31 to double
  %div28 = fdiv double %conv, 1.000000e+06
  store double %div28, double* %clock_dif_sec, align 8
  %32 = load double, double* %clock_dif_sec, align 8
  %call29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.141, i32 0, i32 0), double %32)
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.15, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %arrayidx11 = getelementptr inbounds [65536 x float], [65536 x float]* @array, i32 0, i64 %idxprom10
  %9 = load float, float* %arrayidx11, align 4
  %10 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %10 to i64
  %11 = load i32, i32* %j, align 4
  %idxprom13 = sext i32 %11 to i64
  %12 = load [256 x float]*, [256 x float]** @cc, align 16
  %arrayidx14 = getelementptr inbounds [256 x float], [256 x float]* %12, i64 %idxprom13
  ...
  %mul16 = fmul float %9, %13
  %add = fadd float %7, %mul16
  %14 = load i32, i32* %i, align 4
  %idxprom17 = sext i32 %14 to i64
  %15 = load i32, i32* %j, align 4
  %idxprom18 = sext i32 %15 to i64
  %16 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx19 = getelementptr inbounds [256 x float], [256 x float]* %16, i64 %idxprom18
...
for.end.25:                                       ; preds = %for.cond.1
  ...
  %call26 = call i32 @dummy(float* %21, float* %22, float* %23, float* %24, float* %25, [256 x float]* %26, [256 x float]* %27, [256 x float]* %28, float 0.000000e+00)
  br label %for.inc.27
...
for.end.29:                                       ; preds = %for.cond
  ...
  %call32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.142, i32 0, i32 0), double %33)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.16, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx7 = getelementptr inbounds float, float* %11, i64 %idxprom6
  %12 = load float, float* %arrayidx7, align 4
  %mul8 = fmul float %9, %12
  %add = fadd float %6, %mul8
  %13 = load i32, i32* %j, align 4
  %idxprom9 = sext i32 %13 to i64
  %14 = load float*, float** @a, align 16
  %arrayidx10 = getelementptr inbounds float, float* %14, i64 %idxprom9
  ...
  %arrayidx17 = getelementptr inbounds float, float* %23, i64 %idxprom16
  %24 = load float, float* %arrayidx17, align 4
  %mul18 = fmul float %21, %24
  %add19 = fadd float %18, %mul18
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call23 = call i32 @dummy(float* %28, float* %29, float* %30, float* %31, float* %32, [256 x float]* %33, [256 x float]* %34, [256 x float]* %35, float 0.000000e+00)
  br label %for.inc.24
...
for.end.26:                                       ; preds = %for.cond
  ...
  %call27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.143, i32 0, i32 0), double %40)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.17, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call16 = call i32 @dummy(float* %22, float* %23, float* %24, float* %25, float* %26, [256 x float]* %27, [256 x float]* %28, [256 x float]* %29, float 1.000000e+00)
  br label %for.inc.17

for.inc.17:                                       ; preds = %for.end
  %30 = load i32, i32* %nl, align 4
  %inc18 = add nsw i32 %30, 1
  store i32 %inc18, i32* %nl, align 4
  br label %for.cond
...
for.end.19:                                       ; preds = %for.cond
  ...
  %sub20 = sub nsw i64 %31, %32
  store i64 %sub20, i64* %clock_dif, align 8
  %33 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %33 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %34 = load double, double* %clock_dif_sec, align 8
  %call21 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.144, i32 0, i32 0), double %34)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.112, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.10:                                       ; preds = %for.cond
  ...
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.145, i32 0, i32 0), double %23)
  call void @check(i32 1)
  ret i32 0
}
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call10 = call i32 @s122(i32 %9, i32 %10)
  %call11 = call i32 @s123()
  %call12 = call i32 @s124()
  %call13 = call i32 @s125()
  %call14 = call i32 @s126()
  %call15 = call i32 @s127()
  %call16 = call i32 @s128()
  %call17 = call i32 @s453()
  ret i32 0
}
