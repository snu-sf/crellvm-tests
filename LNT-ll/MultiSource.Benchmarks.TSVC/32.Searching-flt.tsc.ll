; ModuleID = './MultiSource.Benchmarks.TSVC/32.Searching-flt.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S331\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [14 x i8] c"S332\09 %.2f \09\09\00", align 1
...
@.str.140 = private unnamed_addr constant [31 x i8] c"Running each loop %d times...\0A\00", align 1
@.str.141 = private unnamed_addr constant [30 x i8] c"Loop \09 Time(Sec) \09 Checksum \0A\00", align 1
@x = common global [32000 x float] zeroinitializer, align 16
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.88, i32 0, i32 0))
...
for.end:                                          ; preds = %for.cond.1
  ...
  store float %conv, float* %chksum, align 4
  ...
  %17 = load float, float* %chksum, align 4
  %call5 = call i32 @dummy(float* %9, float* %10, float* %11, float* %12, float* %13, [256 x float]* %14, [256 x float]* %15, [256 x float]* %16, float %17)
  br label %for.inc.6
...
for.end.8:                                        ; preds = %for.cond
  ...
  %call10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %22)
  %23 = load i32, i32* %j, align 4
  %add = add nsw i32 %23, 1
  %conv11 = sitofp i32 %add to float
...
; Function Attrs: nounwind uwtable
define i32 @max(i32 %a1, i32 %b1) #0 {
entry:
  ...
  %0 = load i32, i32* %b1.addr, align 4
  %1 = load i32, i32* %a1.addr, align 4
  %cmp = icmp sgt i32 %0, %1
  br i1 %cmp, label %if.then, label %if.else

if.then:                                          ; preds = %entry
  %2 = load i32, i32* %b1.addr, align 4
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.89, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
if.then:                                          ; preds = %for.body.3
  ...
  store float %10, float* %value, align 4
  br label %L20
...
L20:                                              ; preds = %for.end, %if.then
  %12 = load float, float* %value, align 4
  ...
  %22 = load float, float* %chksum, align 4
  %call7 = call i32 @dummy(float* %14, float* %15, float* %16, float* %17, float* %18, [256 x float]* %19, [256 x float]* %20, [256 x float]* %21, float %22)
  br label %for.inc.8
...
for.end.10:                                       ; preds = %for.cond
  ...
  %conv11 = sitofp i64 %26 to double
  %div = fdiv double %conv11, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %27 = load double, double* %clock_dif_sec, align 8
  %call12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i32 0, i32 0), double %27)
  %28 = load float, float* %value, align 4
  store float %28, float* @temp, align 4
  call void @check(i32 -1)
  ret i32 0
}
...
entry:
  ...
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.139, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.140, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.141, i32 0, i32 0))
  %call9 = call i32 @s331()
  %9 = load float, float* %s1, align 4
  %call10 = call i32 @s332(float %9)
  ret i32 0
}
