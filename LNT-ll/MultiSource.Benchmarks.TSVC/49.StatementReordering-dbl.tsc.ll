; ModuleID = './MultiSource.Benchmarks.TSVC/49.StatementReordering-dbl.tsc.bc'
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %mul17 = fmul double %19, %22
  %sub18 = fsub double %16, %mul17
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call21 = call i32 @dummy(double* %26, double* %27, double* %28, double* %29, double* %30, [256 x double]* %31, [256 x double]* %32, [256 x double]* %33, double 0.000000e+00)
  br label %for.inc.22
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call15 = call i32 @dummy(double* %20, double* %21, double* %22, double* %23, double* %24, [256 x double]* %25, [256 x double]* %26, [256 x double]* %27, double 0.000000e+00)
  br label %for.inc.16
