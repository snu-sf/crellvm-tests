; ModuleID = './MultiSource.Benchmarks.TSVC/68.Recurrences-dbl.tsc.bc'
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call17 = call i32 @dummy(double* %21, double* %22, double* %23, double* %24, double* %25, [256 x double]* %26, [256 x double]* %27, [256 x double]* %28, double 0.000000e+00)
  br label %for.inc.18
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call20 = call i32 @dummy(double* %26, double* %27, double* %28, double* %29, double* %30, [256 x double]* %31, [256 x double]* %32, [256 x double]* %33, double 0.000000e+00)
  br label %for.inc.21
