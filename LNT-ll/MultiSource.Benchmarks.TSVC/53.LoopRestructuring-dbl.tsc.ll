; ModuleID = './MultiSource.Benchmarks.TSVC/53.LoopRestructuring-dbl.tsc.bc'
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call8 = call i32 @dummy(double* %12, double* %13, double* %14, double* %15, double* %16, [256 x double]* %17, [256 x double]* %18, [256 x double]* %19, double 0.000000e+00)
  br label %for.inc.9
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call24 = call i32 @dummy(double* %30, double* %31, double* %32, double* %33, double* %34, [256 x double]* %35, [256 x double]* %36, [256 x double]* %37, double 0.000000e+00)
  br label %for.inc.25
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %11 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx12 = getelementptr inbounds [256 x double], [256 x double]* %11, i64 %idxprom11
  ...
  %mul14 = fmul double %8, %12
  %13 = load i32, i32* %i, align 4
  %idxprom15 = sext i32 %13 to i64
  %14 = load i32, i32* %j, align 4
  %idxprom16 = sext i32 %14 to i64
  %15 = load [256 x double]*, [256 x double]** @bb, align 32
  %arrayidx17 = getelementptr inbounds [256 x double], [256 x double]* %15, i64 %idxprom16
  %arrayidx18 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx17, i32 0, i64 %idxprom15
  ...
  %arrayidx21 = getelementptr inbounds [256 x double], [256 x double]* %19, i64 %idxprom20
...
for.end.25:                                       ; preds = %for.cond.1
  ...
  %call26 = call i32 @dummy(double* %22, double* %23, double* %24, double* %25, double* %26, [256 x double]* %27, [256 x double]* %28, [256 x double]* %29, double 1.000000e+00)
  br label %for.inc.27
...
for.end.19:                                       ; preds = %for.cond.1
  ...
  %call20 = call i32 @dummy(double* %18, double* %19, double* %20, double* %21, double* %22, [256 x double]* %23, [256 x double]* %24, [256 x double]* %25, double 1.000000e+00)
  br label %for.inc.21
...
for.body.20:                                      ; preds = %for.cond.18
  ...
  %arrayidx24 = getelementptr inbounds [256 x double], [256 x double]* %19, i64 %idxprom23
  ...
  %arrayidx28 = getelementptr inbounds [256 x double], [256 x double]* %23, i64 %idxprom27
  %arrayidx29 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx28, i32 0, i64 %idxprom26
  %24 = load double, double* %arrayidx29, align 8
  %add30 = fadd double %20, %24
  ...
  %arrayidx33 = getelementptr inbounds [256 x double], [256 x double]* %27, i64 %idxprom32
  %arrayidx34 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx33, i32 0, i64 %idxprom31
...
for.end.40:                                       ; preds = %for.cond.1
  ...
  %36 = load [256 x double]*, [256 x double]** @bb, align 32
  %37 = load [256 x double]*, [256 x double]** @cc, align 32
  %call41 = call i32 @dummy(double* %30, double* %31, double* %32, double* %33, double* %34, [256 x double]* %35, [256 x double]* %36, [256 x double]* %37, double 0.000000e+00)
  br label %for.inc.42
...
for.body.20:                                      ; preds = %for.cond.18
  ...
  %19 = load [256 x double]*, [256 x double]** @bb, align 32
  %arrayidx24 = getelementptr inbounds [256 x double], [256 x double]* %19, i64 %idxprom23
  %arrayidx25 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx24, i32 0, i64 %idxprom21
  %20 = load double, double* %arrayidx25, align 8
...
for.body.11:                                      ; preds = %for.cond.9
  ...
  %15 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx14 = getelementptr inbounds [256 x double], [256 x double]* %15, i64 %idxprom13
  ...
  %19 = load [256 x double]*, [256 x double]** @bb, align 32
  %arrayidx18 = getelementptr inbounds [256 x double], [256 x double]* %19, i64 %idxprom17
  ...
  %mul22 = fmul double %20, %23
  %add23 = fadd double %16, %mul22
  %24 = load i32, i32* %i, align 4
  %idxprom24 = sext i32 %24 to i64
  %25 = load i32, i32* %j, align 4
  %idxprom25 = sext i32 %25 to i64
  %26 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx26 = getelementptr inbounds [256 x double], [256 x double]* %26, i64 %idxprom25
  %arrayidx27 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx26, i32 0, i64 %idxprom24
...
for.end.30:                                       ; preds = %for.cond.1
  ...
  %36 = load [256 x double]*, [256 x double]** @cc, align 32
  %call31 = call i32 @dummy(double* %29, double* %30, double* %31, double* %32, double* %33, [256 x double]* %34, [256 x double]* %35, [256 x double]* %36, double 0.000000e+00)
  br label %for.inc.32
