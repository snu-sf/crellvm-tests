; ModuleID = './MultiSource.Benchmarks.TSVC/66.Symbolics-flt.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S171\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [14 x i8] c"S172\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [14 x i8] c"S173\09 %.2f \09\09\00", align 1
@.str.140 = private unnamed_addr constant [14 x i8] c"S174\09 %.2f \09\09\00", align 1
@.str.141 = private unnamed_addr constant [14 x i8] c"S175\09 %.2f \09\09\00", align 1
@.str.142 = private unnamed_addr constant [14 x i8] c"S176\09 %.2f \09\09\00", align 1
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.25, i32 0, i32 0))
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %6 = load i32, i32* %i, align 4
  %7 = load i32, i32* %inc.addr, align 4
  %mul = mul nsw i32 %6, %7
...
for.end.10:                                       ; preds = %for.cond
  ...
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %23)
...
; Function Attrs: nounwind uwtable
define i32 @s172(i32 %n1, i32 %n3) #0 {
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.26, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call7 = call i32 @dummy(float* %12, float* %13, float* %14, float* %15, float* %16, [256 x float]* %17, [256 x float]* %18, [256 x float]* %19, float 0.000000e+00)
  br label %for.inc.8
...
for.end.9:                                        ; preds = %for.cond
  ...
  %sub10 = sub nsw i64 %21, %22
  store i64 %sub10, i64* %clock_dif, align 8
  %23 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %23 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %24 = load double, double* %clock_dif_sec, align 8
  %call11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i32 0, i32 0), double %24)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.27, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 16000, i32* %k, align 4
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.28, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.12:                                       ; preds = %for.cond
  ...
  %call13 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %26)
  call void @check(i32 1)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s175(i32 %inc) #0 {
entry:
  %inc.addr = alloca i32, align 4
  %start_t = alloca i64, align 8
  %end_t = alloca i64, align 8
  ...
  %i = alloca i32, align 4
  store i32 %inc, i32* %inc.addr, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.29, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.inc:                                          ; preds = %for.body.3
  %12 = load i32, i32* %inc.addr, align 4
  %13 = load i32, i32* %i, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %20 = load [256 x float]*, [256 x float]** @bb, align 16
  %21 = load [256 x float]*, [256 x float]** @cc, align 16
  %call10 = call i32 @dummy(float* %14, float* %15, float* %16, float* %17, float* %18, [256 x float]* %19, [256 x float]* %20, [256 x float]* %21, float 0.000000e+00)
  br label %for.inc.11
...
for.end.13:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %26 = load double, double* %clock_dif_sec, align 8
  %call14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.141, i32 0, i32 0), double %26)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %j = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.30, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 16000, i32* %m, align 4
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.16:                                       ; preds = %for.cond.1
  ...
  %call17 = call i32 @dummy(float* %18, float* %19, float* %20, float* %21, float* %22, [256 x float]* %23, [256 x float]* %24, [256 x float]* %25, float 0.000000e+00)
  br label %for.inc.18
...
for.end.20:                                       ; preds = %for.cond
  ...
  %call23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.142, i32 0, i32 0), double %30)
  call void @check(i32 1)
  ret i32 0
}
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call9 = call i32 @s171(i32 %9)
  %10 = load i32, i32* %n1, align 4
  %11 = load i32, i32* %n3, align 4
  %call10 = call i32 @s172(i32 %10, i32 %11)
  %call11 = call i32 @s173()
  %call12 = call i32 @s174(i32 16000)
  %12 = load i32, i32* %n1, align 4
  %call13 = call i32 @s175(i32 %12)
  %call14 = call i32 @s176()
  ret i32 0
}
