; ModuleID = './MultiSource.Benchmarks.TSVC/60.GlobalDataFlow-dbl.tsc.bc'
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds [256 x double], [256 x double]* %7, i64 %idxprom4
  %arrayidx5 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx, i32 0, i64 %idxprom
  ...
  %mul9 = fmul double %11, %13
  %add10 = fadd double %8, %mul9
  %14 = load i32, i32* %i, align 4
  %idxprom11 = sext i32 %14 to i64
  %15 = load i32, i32* %j, align 4
  %idxprom12 = sext i32 %15 to i64
  %16 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx13 = getelementptr inbounds [256 x double], [256 x double]* %16, i64 %idxprom12
  %arrayidx14 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx13, i32 0, i64 %idxprom11
  store double %add10, double* %arrayidx14, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call15 = call i32 @dummy(double* %18, double* %19, double* %20, double* %21, double* %22, [256 x double]* %23, [256 x double]* %24, [256 x double]* %25, double 0.000000e+00)
  br label %for.inc.16
...
for.body.12:                                      ; preds = %for.cond.10
  ...
  %arrayidx = getelementptr inbounds [256 x double], [256 x double]* %10, i64 %idxprom13
  %arrayidx14 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx, i32 0, i64 %idxprom
  %11 = load double, double* %arrayidx14, align 8
  %12 = load i32, i32* %k, align 4
  %idxprom15 = sext i32 %12 to i64
  %arrayidx16 = getelementptr inbounds [65536 x double], [65536 x double]* @array, i32 0, i64 %idxprom15
  %13 = load double, double* %arrayidx16, align 8
  %add17 = fadd double %13, %11
...
for.end.22:                                       ; preds = %for.cond.1
  ...
  %24 = load [256 x double]*, [256 x double]** @bb, align 32
  %25 = load [256 x double]*, [256 x double]** @cc, align 32
  %call23 = call i32 @dummy(double* %18, double* %19, double* %20, double* %21, double* %22, [256 x double]* %23, [256 x double]* %24, [256 x double]* %25, double 0.000000e+00)
  br label %for.inc.24
...
; Function Attrs: nounwind uwtable
define i32 @s151s(double* %a, double* %b, i32 %m) #0 {
entry:
...
for.body:                                         ; preds = %for.cond
  %2 = load double*, double** @a, align 32
  %3 = load double*, double** @b, align 32
  %call1 = call i32 @s151s(double* %2, double* %3, i32 1)
  %4 = load double*, double** @a, align 32
  %5 = load double*, double** @b, align 32
  %6 = load double*, double** @c, align 32
  %7 = load double*, double** @d, align 32
  %8 = load double*, double** @e, align 32
  %9 = load [256 x double]*, [256 x double]** @aa, align 32
  %10 = load [256 x double]*, [256 x double]** @bb, align 32
  %11 = load [256 x double]*, [256 x double]** @cc, align 32
  %call2 = call i32 @dummy(double* %4, double* %5, double* %6, double* %7, double* %8, [256 x double]* %9, [256 x double]* %10, [256 x double]* %11, double 0.000000e+00)
  br label %for.inc
...
; Function Attrs: nounwind uwtable
define i32 @s152s(double* %a, double* %b, double* %c, i32 %i) #0 {
entry:
  %a.addr = alloca double*, align 8
  %b.addr = alloca double*, align 8
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %10 = load double*, double** @b, align 32
  %arrayidx7 = getelementptr inbounds double, double* %10, i64 %idxprom6
  store double %mul, double* %arrayidx7, align 8
  %11 = load double*, double** @a, align 32
  %12 = load double*, double** @b, align 32
  %13 = load double*, double** @c, align 32
  %14 = load i32, i32* %i, align 4
  %call8 = call i32 @s152s(double* %11, double* %12, double* %13, i32 %14)
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call9 = call i32 @dummy(double* %16, double* %17, double* %18, double* %19, double* %20, [256 x double]* %21, [256 x double]* %22, [256 x double]* %23, double 0.000000e+00)
  br label %for.inc.10
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds double, double* %4, i64 %idxprom
  %5 = load double, double* %arrayidx, align 8
  %call4 = call double @sin(double %5) #6
  %6 = load i32, i32* %i, align 4
  ...
  %call7 = call double @cos(double %8) #6
  %add = fadd double %call4, %call7
  %9 = load i32, i32* %i, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call10 = call i32 @dummy(double* %12, double* %13, double* %14, double* %15, double* %16, [256 x double]* %17, [256 x double]* %18, [256 x double]* %19, double 0.000000e+00)
  br label %for.inc.11
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %add = add nsw i32 %9, 1
  %conv = sitofp i32 %add to double
  %mul6 = fmul double %8, %conv
  %add7 = fadd double %5, %mul6
  %10 = load i32, i32* %i, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %19 = load [256 x double]*, [256 x double]** @bb, align 32
  %20 = load [256 x double]*, [256 x double]** @cc, align 32
  %call10 = call i32 @dummy(double* %13, double* %14, double* %15, double* %16, double* %17, [256 x double]* %18, [256 x double]* %19, [256 x double]* %20, double 0.000000e+00)
  br label %for.inc.11
...
entry:
  ...
  %call = call i32 @set1d(double* getelementptr inbounds ([32000 x double], [32000 x double]* @x, i32 0, i32 0), double 0.000000e+00, i32 1)
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %arrayidx10 = getelementptr inbounds [32000 x double], [32000 x double]* @x, i32 0, i64 %idxprom9
  ...
  %mul18 = fmul double %19, %22
  %add19 = fadd double %16, %mul18
...
for.end:                                          ; preds = %for.cond.2
  ...
  %call22 = call i32 @dummy(double* %26, double* %27, double* %28, double* %29, double* %30, [256 x double]* %31, [256 x double]* %32, [256 x double]* %33, double 0.000000e+00)
  br label %for.inc.23
...
for.body.32:                                      ; preds = %for.cond.29
  ...
  %arrayidx34 = getelementptr inbounds [32000 x double], [32000 x double]* @x, i32 0, i64 %idxprom33
  %41 = load double, double* %arrayidx34, align 8
  %42 = load double, double* @temp, align 8
  %add35 = fadd double %42, %41
  store double %add35, double* @temp, align 8
  br label %for.inc.36
...
; Function Attrs: inlinehint nounwind uwtable
define internal double @f(double %a, double %b) #4 {
entry:
  %a.addr = alloca double, align 8
  %b.addr = alloca double, align 8
  store double %a, double* %a.addr, align 8
...
entry:
  ...
  %call = call i32 @posix_memalign(i8** bitcast (double** @xx to i8**), i64 32, i64 256000) #6
...
entry:
  ...
  %call = call i32 @posix_memalign(i8** %0, i64 32, i64 256000) #6
