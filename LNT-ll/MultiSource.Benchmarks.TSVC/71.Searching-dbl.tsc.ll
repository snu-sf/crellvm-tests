; ModuleID = './MultiSource.Benchmarks.TSVC/71.Searching-dbl.tsc.bc'
...
for.end:                                          ; preds = %for.cond.1
  ...
  store double %conv, double* %chksum, align 8
  ...
  %17 = load double, double* %chksum, align 8
  %call5 = call i32 @dummy(double* %9, double* %10, double* %11, double* %12, double* %13, [256 x double]* %14, [256 x double]* %15, [256 x double]* %16, double %17)
  br label %for.inc.6
...
for.end.8:                                        ; preds = %for.cond
  ...
  store double %conv11, double* @temp, align 8
...
L20:                                              ; preds = %for.end, %if.then
  %12 = load double, double* %value, align 8
  ...
  %22 = load double, double* %chksum, align 8
  %call7 = call i32 @dummy(double* %14, double* %15, double* %16, double* %17, double* %18, [256 x double]* %19, [256 x double]* %20, [256 x double]* %21, double %22)
  br label %for.inc.8
...
for.end.10:                                       ; preds = %for.cond
  ...
  store double %28, double* @temp, align 8
  call void @check(i32 -1)
  ret i32 0
}
