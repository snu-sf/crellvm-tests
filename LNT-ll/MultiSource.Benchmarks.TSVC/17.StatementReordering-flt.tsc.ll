; ModuleID = './MultiSource.Benchmarks.TSVC/17.StatementReordering-flt.tsc.bc'
...
@.str.137 = private unnamed_addr constant [14 x i8] c"S211\09 %.2f \09\09\00", align 1
@.str.138 = private unnamed_addr constant [14 x i8] c"S212\09 %.2f \09\09\00", align 1
@.str.139 = private unnamed_addr constant [15 x i8] c"S1213\09 %.2f \09\09\00", align 1
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.31, i32 0, i32 0))
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %mul17 = fmul float %19, %22
  %sub18 = fsub float %16, %mul17
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call21 = call i32 @dummy(float* %26, float* %27, float* %28, float* %29, float* %30, [256 x float]* %31, [256 x float]* %32, [256 x float]* %33, float 0.000000e+00)
  br label %for.inc.22
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.32, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end.17:                                       ; preds = %for.cond
  ...
  %call18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.138, i32 0, i32 0), double %31)
  call void @check(i32 12)
  ret i32 0
}
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call15 = call i32 @dummy(float* %20, float* %21, float* %22, float* %23, float* %24, [256 x float]* %25, [256 x float]* %26, [256 x float]* %27, float 0.000000e+00)
  br label %for.inc.16
...
for.end.18:                                       ; preds = %for.cond
  ...
  %call20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.139, i32 0, i32 0), double %32)
  call void @check(i32 12)
  ret i32 0
}
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call9 = call i32 @s211()
  %call10 = call i32 @s212()
  %call11 = call i32 @s1213()
  ret i32 0
}
