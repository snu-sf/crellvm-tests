; ModuleID = './MultiSource.Benchmarks.TSVC/42.Expansion-dbl.tsc.bc'
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  store double %mul9, double* %arrayidx11, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call18 = call i32 @dummy(double* %24, double* %25, double* %26, double* %27, double* %28, [256 x double]* %29, [256 x double]* %30, [256 x double]* %31, double 0.000000e+00)
  br label %for.inc.19
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %4 = load i32, i32* %i, align 4
  %idxprom = sext i32 %4 to i64
  %5 = load double*, double** @e, align 32
...
for.end:                                          ; preds = %for.cond.1
  ...
  %30 = load [256 x double]*, [256 x double]** @bb, align 32
  %31 = load [256 x double]*, [256 x double]** @cc, align 32
  %call17 = call i32 @dummy(double* %24, double* %25, double* %26, double* %27, double* %28, [256 x double]* %29, [256 x double]* %30, [256 x double]* %31, double 0.000000e+00)
  br label %for.inc.18
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call22 = call i32 @dummy(double* %28, double* %29, double* %30, double* %31, double* %32, [256 x double]* %33, [256 x double]* %34, [256 x double]* %35, double 0.000000e+00)
  br label %for.inc.23
...
for.end:                                          ; preds = %for.cond.1
  ...
  %19 = load double*, double** @e, align 32
  %20 = load [256 x double]*, [256 x double]** @aa, align 32
  %21 = load [256 x double]*, [256 x double]** @bb, align 32
  %22 = load [256 x double]*, [256 x double]** @cc, align 32
  %call8 = call i32 @dummy(double* %15, double* %16, double* %17, double* %18, double* %19, [256 x double]* %20, [256 x double]* %21, [256 x double]* %22, double 0.000000e+00)
  br label %for.inc.9
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call17 = call i32 @dummy(double* %26, double* %27, double* %28, double* %29, double* %30, [256 x double]* %31, [256 x double]* %32, [256 x double]* %33, double 0.000000e+00)
  br label %for.inc.18
...
for.body:                                         ; preds = %for.cond
  %2 = load double*, double** @b, align 32
  %arrayidx = getelementptr inbounds double, double* %2, i64 31999
  %3 = load double, double* %arrayidx, align 8
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %add = fadd double %7, %8
  %mul5 = fmul double %add, 5.000000e-01
  %9 = load i32, i32* %i, align 4
  %idxprom6 = sext i32 %9 to i64
  %10 = load double*, double** @a, align 32
  %arrayidx7 = getelementptr inbounds double, double* %10, i64 %idxprom6
...
for.end:                                          ; preds = %for.cond.1
  ...
  %21 = load [256 x double]*, [256 x double]** @bb, align 32
  %22 = load [256 x double]*, [256 x double]** @cc, align 32
  %call10 = call i32 @dummy(double* %15, double* %16, double* %17, double* %18, double* %19, [256 x double]* %20, [256 x double]* %21, [256 x double]* %22, double 0.000000e+00)
  br label %for.inc.11
...
for.body:                                         ; preds = %for.cond
  ...
  store double %3, double* %x, align 8
  %4 = load double*, double** @b, align 32
  %arrayidx1 = getelementptr inbounds double, double* %4, i64 31998
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %8 = load double*, double** @b, align 32
  ...
  %add6 = fadd double %add, %11
  %mul = fmul double %add6, 3.330000e-01
  %12 = load i32, i32* %i, align 4
...
for.end:                                          ; preds = %for.cond.2
  ...
  %call11 = call i32 @dummy(double* %19, double* %20, double* %21, double* %22, double* %23, [256 x double]* %24, [256 x double]* %25, [256 x double]* %26, double 0.000000e+00)
  br label %for.inc.12
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  store double %sub7, double* %arrayidx9, align 8
  ...
  %arrayidx14 = getelementptr inbounds [256 x double], [256 x double]* %14, i64 %idxprom13
  ...
  %17 = load double*, double** @d, align 32
  %arrayidx17 = getelementptr inbounds double, double* %17, i64 %idxprom16
  %18 = load double, double* %arrayidx17, align 8
  %mul18 = fmul double %15, %18
  %add = fadd double %11, %mul18
  %19 = load i32, i32* %i, align 4
  %idxprom19 = sext i32 %19 to i64
  %20 = load i32, i32* %j, align 4
  %idxprom20 = sext i32 %20 to i64
  %21 = load [256 x double]*, [256 x double]** @cc, align 32
  %arrayidx21 = getelementptr inbounds [256 x double], [256 x double]* %21, i64 %idxprom20
  %arrayidx22 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx21, i32 0, i64 %idxprom19
...
for.end.25:                                       ; preds = %for.cond.1
  ...
  %30 = load [256 x double]*, [256 x double]** @bb, align 32
  %31 = load [256 x double]*, [256 x double]** @cc, align 32
  %call26 = call i32 @dummy(double* %24, double* %25, double* %26, double* %27, double* %28, [256 x double]* %29, [256 x double]* %30, [256 x double]* %31, double 0.000000e+00)
  br label %for.inc.27
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %arrayidx18 = getelementptr inbounds [256 x double], [256 x double]* %18, i64 %idxprom17
  %arrayidx19 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx18, i32 0, i64 %idxprom16
  %19 = load double, double* %arrayidx19, align 8
  %add = fadd double %15, %19
  %20 = load i32, i32* %i, align 4
  %idxprom20 = sext i32 %20 to i64
  %21 = load i32, i32* %j, align 4
  %idxprom21 = sext i32 %21 to i64
  %22 = load [256 x double]*, [256 x double]** @aa, align 32
  %arrayidx22 = getelementptr inbounds [256 x double], [256 x double]* %22, i64 %idxprom21
  %arrayidx23 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx22, i32 0, i64 %idxprom20
...
for.end.26:                                       ; preds = %for.cond.1
  ...
  %call27 = call i32 @dummy(double* %25, double* %26, double* %27, double* %28, double* %29, [256 x double]* %30, [256 x double]* %31, [256 x double]* %32, double 0.000000e+00)
  br label %for.inc.28
...
if.end:                                           ; preds = %if.then, %for.body.3
  ...
  %arrayidx18 = getelementptr inbounds [256 x double], [256 x double]* %23, i64 0
  %arrayidx19 = getelementptr inbounds [256 x double], [256 x double]* %arrayidx18, i32 0, i64 %idxprom17
  %24 = load double, double* %arrayidx19, align 8
  %mul20 = fmul double %add16, %24
  %25 = load i32, i32* %i, align 4
  %idxprom21 = sext i32 %25 to i64
  %26 = load double*, double** @e, align 32
...
for.end:                                          ; preds = %for.cond.1
  ...
  %34 = load [256 x double]*, [256 x double]** @bb, align 32
  %35 = load [256 x double]*, [256 x double]** @cc, align 32
  %call23 = call i32 @dummy(double* %28, double* %29, double* %30, double* %31, double* %32, [256 x double]* %33, [256 x double]* %34, [256 x double]* %35, double 0.000000e+00)
  br label %for.inc.24
...
for.end.26:                                       ; preds = %for.cond
  ...
  %39 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %39 to double
  %div27 = fdiv double %conv, 1.000000e+06
  store double %div27, double* %clock_dif_sec, align 8
  %40 = load double, double* %clock_dif_sec, align 8
  %call28 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.147, i32 0, i32 0), double %40)
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  store double %21, double* %arrayidx16, align 8
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %31 = load [256 x double]*, [256 x double]** @bb, align 32
  %32 = load [256 x double]*, [256 x double]** @cc, align 32
  %call17 = call i32 @dummy(double* %25, double* %26, double* %27, double* %28, double* %29, [256 x double]* %30, [256 x double]* %31, [256 x double]* %32, double 0.000000e+00)
  br label %for.inc.18
