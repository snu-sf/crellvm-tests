; ModuleID = './MultiSource.Benchmarks.TSVC/24.Reductions-flt.tsc.bc'
...
for.body:                                         ; preds = %for.cond
  store float 0.000000e+00, float* %sum, align 4
  %2 = load float*, float** @a, align 16
  %call1 = call float @test(float* %2)
  %3 = load float, float* %sum, align 4
  %add = fadd float %3, %call1
  store float %add, float* %sum, align 4
  %4 = load float*, float** @a, align 16
  %arrayidx = getelementptr inbounds float, float* %4, i64 4
  %call2 = call float @test(float* %arrayidx)
  %5 = load float, float* %sum, align 4
  %add3 = fadd float %5, %call2
  store float %add3, float* %sum, align 4
  %6 = load float*, float** @a, align 16
  %arrayidx4 = getelementptr inbounds float, float* %6, i64 8
  %call5 = call float @test(float* %arrayidx4)
  %7 = load float, float* %sum, align 4
  %add6 = fadd float %7, %call5
  store float %add6, float* %sum, align 4
  %8 = load float*, float** @a, align 16
  %arrayidx7 = getelementptr inbounds float, float* %8, i64 12
  %call8 = call float @test(float* %arrayidx7)
  %9 = load float, float* %sum, align 4
  %add9 = fadd float %9, %call8
  store float %add9, float* %sum, align 4
  %10 = load float*, float** @a, align 16
  %arrayidx10 = getelementptr inbounds float, float* %10, i64 16
  %call11 = call float @test(float* %arrayidx10)
  %11 = load float, float* %sum, align 4
  %add12 = fadd float %11, %call11
  store float %add12, float* %sum, align 4
  %12 = load float*, float** @a, align 16
  %arrayidx13 = getelementptr inbounds float, float* %12, i64 20
  %call14 = call float @test(float* %arrayidx13)
  %13 = load float, float* %sum, align 4
  %add15 = fadd float %13, %call14
  store float %add15, float* %sum, align 4
  %14 = load float*, float** @a, align 16
  %arrayidx16 = getelementptr inbounds float, float* %14, i64 24
  %call17 = call float @test(float* %arrayidx16)
  %15 = load float, float* %sum, align 4
  %add18 = fadd float %15, %call17
  store float %add18, float* %sum, align 4
  %16 = load float*, float** @a, align 16
  %arrayidx19 = getelementptr inbounds float, float* %16, i64 28
  %call20 = call float @test(float* %arrayidx19)
  %17 = load float, float* %sum, align 4
  %add21 = fadd float %17, %call20
  store float %add21, float* %sum, align 4
  ...
  %call22 = call i32 @dummy(float* %18, float* %19, float* %20, float* %21, float* %22, [256 x float]* %23, [256 x float]* %24, [256 x float]* %25, float %26)
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  store float 1.000000e+00, float* %prod, align 4
  store i32 0, i32* %i, align 4
  br label %for.cond.1
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds float, float* %4, i64 %idxprom
  %5 = load float, float* %arrayidx, align 4
  %6 = load float, float* %prod, align 4
  %mul4 = fmul float %6, %5
  store float %mul4, float* %prod, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %14 = load [256 x float]*, [256 x float]** @bb, align 16
  %15 = load [256 x float]*, [256 x float]** @cc, align 16
  %16 = load float, float* %prod, align 4
  %call5 = call i32 @dummy(float* %8, float* %9, float* %10, float* %11, float* %12, [256 x float]* %13, [256 x float]* %14, [256 x float]* %15, float %16)
  br label %for.inc.6
...
for.end.8:                                        ; preds = %for.cond
  ...
  %22 = load float, float* %prod, align 4
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call8 = call i32 @dummy(float* %13, float* %14, float* %15, float* %16, float* %17, [256 x float]* %18, [256 x float]* %19, [256 x float]* %20, float %21)
  br label %for.inc.9
...
for.end.11:                                       ; preds = %for.cond
  ...
  store float %27, float* @temp, align 4
  call void @check(i32 -1)
  ret i32 0
}
...
for.end.19:                                       ; preds = %for.cond.7
  ...
  %conv20 = sitofp i32 %20 to float
  %add = fadd float %19, %conv20
  store float %add, float* %chksum, align 4
  ...
  %29 = load float, float* %chksum, align 4
  %call21 = call i32 @dummy(float* %21, float* %22, float* %23, float* %24, float* %25, [256 x float]* %26, [256 x float]* %27, [256 x float]* %28, float %29)
  br label %for.inc.22
...
for.end.24:                                       ; preds = %for.cond.1
  ...
  %conv27 = sitofp i32 %35 to float
  %36 = load float, float* %x, align 4
  %add28 = fadd float %conv27, %36
  %add29 = fadd float %add28, 1.000000e+00
  store float %add29, float* @temp, align 4
  call void @check(i32 -1)
  ret i32 0
}
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %mul4 = fmul float %3, 0x3FEFAE1480000000
  store float %mul4, float* %q, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call5 = call i32 @dummy(float* %5, float* %6, float* %7, float* %8, float* %9, [256 x float]* %10, [256 x float]* %11, [256 x float]* %12, float %13)
  br label %for.inc.6
...
for.end.8:                                        ; preds = %for.cond
  ...
  store float %19, float* @temp, align 4
  call void @check(i32 -1)
  ret i32 0
}
...
for.body:                                         ; preds = %for.cond
  ...
  %conv2 = sitofp i32 %call1 to float
  store float %conv2, float* %max, align 4
...
for.body.6:                                       ; preds = %for.cond.3
  ...
  %8 = load float*, float** @a, align 16
  %arrayidx7 = getelementptr inbounds float, float* %8, i64 %idxprom
  ...
  %cmp11 = fcmp ole float %conv10, %10
...
if.end:                                           ; preds = %for.body.6
  ...
  %conv15 = fptosi float %14 to i32
  %call16 = call i32 @abs(i32 %conv15) #6
  %conv17 = sitofp i32 %call16 to float
  store float %conv17, float* %max, align 4
  br label %L5
...
for.end:                                          ; preds = %for.cond.3
  ...
  %add21 = fadd float %18, %conv20
  store float %add21, float* %chksum, align 4
  ...
  %28 = load float, float* %chksum, align 4
  %call22 = call i32 @dummy(float* %20, float* %21, float* %22, float* %23, float* %24, [256 x float]* %25, [256 x float]* %26, [256 x float]* %27, float %28)
  br label %for.inc.23
...
for.end.25:                                       ; preds = %for.cond
  ...
  %34 = load float, float* %max, align 4
  %35 = load i32, i32* %index, align 4
  %conv29 = sitofp i32 %35 to float
  %add30 = fadd float %34, %conv29
  %add31 = fadd float %add30, 1.000000e+00
  store float %add31, float* @temp, align 4
  call void @check(i32 -1)
  ret i32 0
}
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call21 = call i32 @dummy(float* %28, float* %29, float* %30, float* %31, float* %32, [256 x float]* %33, [256 x float]* %34, [256 x float]* %35, float %36)
  br label %for.inc.22
...
for.end.24:                                       ; preds = %for.cond
  ...
  store float %42, float* @temp, align 4
  call void @check(i32 -1)
  ret i32 0
}
...
for.body:                                         ; preds = %for.cond
  %2 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx = getelementptr inbounds [256 x float], [256 x float]* %2, i64 0
  %arrayidx1 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx, i32 0, i64 0
  %3 = load float, float* %arrayidx1, align 4
  store float %3, float* %max, align 4
...
for.body.7:                                       ; preds = %for.cond.5
  ...
  %8 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx9 = getelementptr inbounds [256 x float], [256 x float]* %8, i64 %idxprom8
  %arrayidx10 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx9, i32 0, i64 %idxprom
...
if.then:                                          ; preds = %for.body.7
  ...
  %idxprom13 = sext i32 %12 to i64
  %13 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx14 = getelementptr inbounds [256 x float], [256 x float]* %13, i64 %idxprom13
...
for.end.18:                                       ; preds = %for.cond.2
  ...
  %conv19 = sitofp i32 %21 to float
  %add20 = fadd float %add, %conv19
  store float %add20, float* %chksum, align 4
  ...
  %30 = load float, float* %chksum, align 4
  %call21 = call i32 @dummy(float* %22, float* %23, float* %24, float* %25, float* %26, [256 x float]* %27, [256 x float]* %28, [256 x float]* %29, float %30)
  br label %for.inc.22
...
for.end.24:                                       ; preds = %for.cond
  ...
  %36 = load float, float* %max, align 4
  %37 = load i32, i32* %xindex, align 4
  %conv28 = sitofp i32 %37 to float
  %add29 = fadd float %36, %conv28
  %add30 = fadd float %add29, 1.000000e+00
  %38 = load i32, i32* %yindex, align 4
  %conv31 = sitofp i32 %38 to float
  %add32 = fadd float %add30, %conv31
  %add33 = fadd float %add32, 1.000000e+00
  store float %add33, float* @temp, align 4
  call void @check(i32 -1)
  ret i32 0
}
...
for.end.18:                                       ; preds = %for.cond.2
  ...
  %27 = load [256 x float]*, [256 x float]** @cc, align 16
  %28 = load float, float* %chksum, align 4
  %call21 = call i32 @dummy(float* %20, float* %21, float* %22, float* %23, float* %24, [256 x float]* %25, [256 x float]* %26, [256 x float]* %27, float %28)
  br label %for.inc.22
...
for.end.24:                                       ; preds = %for.cond
  ...
  %conv28 = sitofp i32 %35 to float
  %add29 = fadd float %34, %conv28
  %add30 = fadd float %add29, 1.000000e+00
  %36 = load i32, i32* %yindex, align 4
  %conv31 = sitofp i32 %36 to float
  %add32 = fadd float %add30, %conv31
  %add33 = fadd float %add32, 1.000000e+00
  store float %add33, float* @temp, align 4
  call void @check(i32 -1)
...
for.end:                                          ; preds = %for.cond.1
  ...
  %18 = load [256 x float]*, [256 x float]** @cc, align 16
  %19 = load float, float* %sum, align 4
  %call6 = call i32 @dummy(float* %11, float* %12, float* %13, float* %14, float* %15, [256 x float]* %16, [256 x float]* %17, [256 x float]* %18, float %19)
  br label %for.inc.7
...
for.body.6:                                       ; preds = %for.cond.3
  ...
  %idxprom = sext i32 %5 to i64
  %6 = load float*, float** @a, align 16
  %arrayidx7 = getelementptr inbounds float, float* %6, i64 %idxprom
  %7 = load float, float* %arrayidx7, align 4
  %conv8 = fptosi float %7 to i32
  %call9 = call i32 @abs(i32 %conv8) #6
  %conv10 = sitofp i32 %call9 to float
  %8 = load float, float* %max, align 4
  %cmp11 = fcmp ogt float %conv10, %8
  br i1 %cmp11, label %if.then, label %if.end
...
if.then:                                          ; preds = %for.body.6
  ...
  %10 = load float*, float** @a, align 16
  %arrayidx14 = getelementptr inbounds float, float* %10, i64 %idxprom13
  %11 = load float, float* %arrayidx14, align 4
  %conv15 = fptosi float %11 to i32
  %call16 = call i32 @abs(i32 %conv15) #6
  %conv17 = sitofp i32 %call16 to float
  store float %conv17, float* %max, align 4
  br label %if.end
...
for.end:                                          ; preds = %for.cond.3
  ...
  %19 = load [256 x float]*, [256 x float]** @bb, align 16
  %20 = load [256 x float]*, [256 x float]** @cc, align 16
  %21 = load float, float* %max, align 4
  %call18 = call i32 @dummy(float* %13, float* %14, float* %15, float* %16, float* %17, [256 x float]* %18, [256 x float]* %19, [256 x float]* %20, float %21)
  br label %for.inc.19
