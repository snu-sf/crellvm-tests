; ModuleID = './MultiSource.Benchmarks.TSVC/13.ControlFlow-flt.tsc.bc'
...
entry:
  ...
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.23, i32 0, i32 0))
...
if.end:                                           ; preds = %for.body.3
  ...
  %7 = load float*, float** @c, align 16
  %arrayidx6 = getelementptr inbounds float, float* %7, i64 %idxprom5
  %8 = load float, float* %arrayidx6, align 4
  %9 = load i32, i32* %i, align 4
  %idxprom7 = sext i32 %9 to i64
  %10 = load float*, float** @d, align 16
  %arrayidx8 = getelementptr inbounds float, float* %10, i64 %idxprom7
  %11 = load float, float* %arrayidx8, align 4
  %12 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %12 to i64
  %13 = load float*, float** @e, align 16
...
for.end:                                          ; preds = %for.cond.1
  %29 = load float*, float** @a, align 16
  %30 = load float*, float** @b, align 16
  %31 = load float*, float** @c, align 16
  %32 = load float*, float** @d, align 16
  %33 = load float*, float** @e, align 16
  %34 = load [256 x float]*, [256 x float]** @aa, align 16
  %35 = load [256 x float]*, [256 x float]** @bb, align 16
  %36 = load [256 x float]*, [256 x float]** @cc, align 16
  %call24 = call i32 @dummy(float* %29, float* %30, float* %31, float* %32, float* %33, [256 x float]* %34, [256 x float]* %35, [256 x float]* %36, float 0.000000e+00)
  br label %for.inc.25

for.inc.25:                                       ; preds = %for.end
  %37 = load i32, i32* %nl, align 4
  %inc26 = add nsw i32 %37, 1
  store i32 %inc26, i32* %nl, align 4
  br label %for.cond
...
for.end.27:                                       ; preds = %for.cond
  ...
  %div28 = fdiv double %conv, 1.000000e+06
  store double %div28, double* %clock_dif_sec, align 8
  %41 = load double, double* %clock_dif_sec, align 8
  %call29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.137, i32 0, i32 0), double %41)
...
L20:                                              ; preds = %if.then
  ...
  %27 = load float*, float** @b, align 16
  %arrayidx22 = getelementptr inbounds float, float* %27, i64 %idxprom21
...
for.end:                                          ; preds = %for.cond.1
  ...
  %35 = load [256 x float]*, [256 x float]** @bb, align 16
  %36 = load [256 x float]*, [256 x float]** @cc, align 16
  %call23 = call i32 @dummy(float* %29, float* %30, float* %31, float* %32, float* %33, [256 x float]* %34, [256 x float]* %35, [256 x float]* %36, float 0.000000e+00)
  br label %for.inc.24

for.inc.24:                                       ; preds = %for.end
  %37 = load i32, i32* %nl, align 4
  %inc25 = add nsw i32 %37, 1
  store i32 %inc25, i32* %nl, align 4
  br label %for.cond
...
for.end.26:                                       ; preds = %for.cond
  ...
  %41 = load double, double* %clock_dif_sec, align 8
  %call27 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.138, i32 0, i32 0), double %41)
  call void @check(i32 13)
  ret i32 0
}
...
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.24, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
if.end:                                           ; preds = %for.end, %for.body
  ...
  %call12 = call i32 @dummy(float* %17, float* %18, float* %19, float* %20, float* %21, [256 x float]* %22, [256 x float]* %23, [256 x float]* %24, float 0.000000e+00)
  br label %for.inc.13

for.inc.13:                                       ; preds = %if.end
  %25 = load i32, i32* %nl, align 4
  %inc14 = add nsw i32 %25, 1
  store i32 %inc14, i32* %nl, align 4
  br label %for.cond

for.end.15:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %26 = load i64, i64* %end_t, align 8
  %27 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %26, %27
  store i64 %sub, i64* %clock_dif, align 8
  %28 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %28 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %29 = load double, double* %clock_dif_sec, align 8
  %call16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.139, i32 0, i32 0), double %29)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.53, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %call12 = call i32 @dummy(float* %16, float* %17, float* %18, float* %19, float* %20, [256 x float]* %21, [256 x float]* %22, [256 x float]* %23, float 0.000000e+00)
  br label %for.inc.13
...
for.end.15:                                       ; preds = %for.cond
  ...
  %call16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.140, i32 0, i32 0), double %28)
  call void @check(i32 1)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s272(float %t) #0 {
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.54, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %4 = load float*, float** @e, align 16
  %arrayidx = getelementptr inbounds float, float* %4, i64 %idxprom
  %5 = load float, float* %arrayidx, align 4
  %6 = load float, float* %t.addr, align 4
  %cmp4 = fcmp oge float %5, %6
  br i1 %cmp4, label %if.then, label %if.end

if.then:                                          ; preds = %for.body.3
  %7 = load i32, i32* %i, align 4
  %idxprom5 = sext i32 %7 to i64
  %8 = load float*, float** @c, align 16
  %arrayidx6 = getelementptr inbounds float, float* %8, i64 %idxprom5
  %9 = load float, float* %arrayidx6, align 4
  %10 = load i32, i32* %i, align 4
  %idxprom7 = sext i32 %10 to i64
  %11 = load float*, float** @d, align 16
  ...
  %17 = load float*, float** @c, align 16
...
for.end:                                          ; preds = %for.cond.1
  %26 = load float*, float** @a, align 16
  %27 = load float*, float** @b, align 16
  %28 = load float*, float** @c, align 16
  %29 = load float*, float** @d, align 16
  %30 = load float*, float** @e, align 16
  %31 = load [256 x float]*, [256 x float]** @aa, align 16
  %32 = load [256 x float]*, [256 x float]** @bb, align 16
  %33 = load [256 x float]*, [256 x float]** @cc, align 16
  %call19 = call i32 @dummy(float* %26, float* %27, float* %28, float* %29, float* %30, [256 x float]* %31, [256 x float]* %32, [256 x float]* %33, float 0.000000e+00)
  br label %for.inc.20

for.inc.20:                                       ; preds = %for.end
  %34 = load i32, i32* %nl, align 4
  %inc21 = add nsw i32 %34, 1
  store i32 %inc21, i32* %nl, align 4
  br label %for.cond

for.end.22:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %35 = load i64, i64* %end_t, align 8
  %36 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %35, %36
  store i64 %sub, i64* %clock_dif, align 8
  %37 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %37 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %38 = load double, double* %clock_dif_sec, align 8
  %call23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.141, i32 0, i32 0), double %38)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.55, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %cmp10 = fcmp olt float %14, 0.000000e+00
...
if.then:                                          ; preds = %for.body.3
  ...
  %19 = load float*, float** @e, align 16
...
for.end:                                          ; preds = %for.cond.1
  %34 = load float*, float** @a, align 16
  %35 = load float*, float** @b, align 16
  %36 = load float*, float** @c, align 16
  %37 = load float*, float** @d, align 16
  %38 = load float*, float** @e, align 16
  %39 = load [256 x float]*, [256 x float]** @aa, align 16
  %40 = load [256 x float]*, [256 x float]** @bb, align 16
  %41 = load [256 x float]*, [256 x float]** @cc, align 16
  %call27 = call i32 @dummy(float* %34, float* %35, float* %36, float* %37, float* %38, [256 x float]* %39, [256 x float]* %40, [256 x float]* %41, float 0.000000e+00)
  br label %for.inc.28

for.inc.28:                                       ; preds = %for.end
  %42 = load i32, i32* %nl, align 4
  %inc29 = add nsw i32 %42, 1
  store i32 %inc29, i32* %nl, align 4
  br label %for.cond

for.end.30:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %43 = load i64, i64* %end_t, align 8
  %44 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %43, %44
  store i64 %sub, i64* %clock_dif, align 8
  %45 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %45 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %46 = load double, double* %clock_dif_sec, align 8
  %call31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.142, i32 0, i32 0), double %46)
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.56, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %cmp12 = fcmp ogt float %16, 0.000000e+00
...
if.then:                                          ; preds = %for.body.3
  ...
  %20 = load i32, i32* %i, align 4
  %idxprom15 = sext i32 %20 to i64
  %21 = load float*, float** @b, align 16
  %arrayidx16 = getelementptr inbounds float, float* %21, i64 %idxprom15
  %22 = load float, float* %arrayidx16, align 4
  %add17 = fadd float %19, %22
  %23 = load i32, i32* %i, align 4
  %idxprom18 = sext i32 %23 to i64
  %24 = load float*, float** @b, align 16
...
if.else:                                          ; preds = %for.body.3
  ...
  %26 = load float*, float** @d, align 16
  %arrayidx21 = getelementptr inbounds float, float* %26, i64 %idxprom20
  %27 = load float, float* %arrayidx21, align 4
  %28 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %28 to i64
  %29 = load float*, float** @e, align 16
  %arrayidx23 = getelementptr inbounds float, float* %29, i64 %idxprom22
  %30 = load float, float* %arrayidx23, align 4
  %mul24 = fmul float %27, %30
  %31 = load i32, i32* %i, align 4
  %idxprom25 = sext i32 %31 to i64
  %32 = load float*, float** @a, align 16
...
for.end.30:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %46 = load double, double* %clock_dif_sec, align 8
  %call31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.143, i32 0, i32 0), double %46)
  call void @check(i32 12)
  ret i32 0
}
...
entry:
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.57, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %4 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx = getelementptr inbounds [256 x float], [256 x float]* %4, i64 0
  %arrayidx4 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx, i32 0, i64 %idxprom
...
for.body.8:                                       ; preds = %for.cond.6
  ...
  %9 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx11 = getelementptr inbounds [256 x float], [256 x float]* %9, i64 %idxprom10
  %arrayidx12 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx11, i32 0, i64 %idxprom9
  %10 = load float, float* %arrayidx12, align 4
  %11 = load i32, i32* %i, align 4
  %idxprom13 = sext i32 %11 to i64
  %12 = load i32, i32* %j, align 4
  %idxprom14 = sext i32 %12 to i64
  %13 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx15 = getelementptr inbounds [256 x float], [256 x float]* %13, i64 %idxprom14
  %arrayidx16 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx15, i32 0, i64 %idxprom13
  %14 = load float, float* %arrayidx16, align 4
  %15 = load i32, i32* %i, align 4
  %idxprom17 = sext i32 %15 to i64
  %16 = load i32, i32* %j, align 4
  %idxprom18 = sext i32 %16 to i64
  %17 = load [256 x float]*, [256 x float]** @cc, align 16
  %arrayidx19 = getelementptr inbounds [256 x float], [256 x float]* %17, i64 %idxprom18
  %arrayidx20 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx19, i32 0, i64 %idxprom17
  %18 = load float, float* %arrayidx20, align 4
  %mul21 = fmul float %14, %18
  %add = fadd float %10, %mul21
  %19 = load i32, i32* %i, align 4
  %idxprom22 = sext i32 %19 to i64
  %20 = load i32, i32* %j, align 4
  %idxprom23 = sext i32 %20 to i64
  %21 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx24 = getelementptr inbounds [256 x float], [256 x float]* %21, i64 %idxprom23
  %arrayidx25 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx24, i32 0, i64 %idxprom22
...
for.end.28:                                       ; preds = %for.cond.1
  %24 = load float*, float** @a, align 16
  %25 = load float*, float** @b, align 16
  %26 = load float*, float** @c, align 16
  %27 = load float*, float** @d, align 16
  %28 = load float*, float** @e, align 16
  %29 = load [256 x float]*, [256 x float]** @aa, align 16
  %30 = load [256 x float]*, [256 x float]** @bb, align 16
  %31 = load [256 x float]*, [256 x float]** @cc, align 16
  %call29 = call i32 @dummy(float* %24, float* %25, float* %26, float* %27, float* %28, [256 x float]* %29, [256 x float]* %30, [256 x float]* %31, float 0.000000e+00)
  br label %for.inc.30

for.inc.30:                                       ; preds = %for.end.28
  %32 = load i32, i32* %nl, align 4
  %inc31 = add nsw i32 %32, 1
  store i32 %inc31, i32* %nl, align 4
  br label %for.cond

for.end.32:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %33 = load i64, i64* %end_t, align 8
  %34 = load i64, i64* %start_t, align 8
  %sub33 = sub nsw i64 %33, %34
  store i64 %sub33, i64* %clock_dif, align 8
  %35 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %35 to double
  %div34 = fdiv double %conv, 1.000000e+06
  store double %div34, double* %clock_dif_sec, align 8
  %36 = load double, double* %clock_dif_sec, align 8
  %call35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.144, i32 0, i32 0), double %36)
...
for.body.6:                                       ; preds = %for.cond.4
  ...
  %idxprom7 = sext i32 %5 to i64
  %6 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx = getelementptr inbounds [256 x float], [256 x float]* %6, i64 %idxprom7
  %arrayidx8 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx, i32 0, i64 %idxprom
  ...
  %10 = load [256 x float]*, [256 x float]** @bb, align 16
  %arrayidx11 = getelementptr inbounds [256 x float], [256 x float]* %10, i64 %idxprom10
  %arrayidx12 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx11, i32 0, i64 %idxprom9
  ...
  %14 = load [256 x float]*, [256 x float]** @cc, align 16
  %arrayidx15 = getelementptr inbounds [256 x float], [256 x float]* %14, i64 %idxprom14
  %arrayidx16 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx15, i32 0, i64 %idxprom13
  %15 = load float, float* %arrayidx16, align 4
  %mul17 = fmul float %11, %15
  %add = fadd float %7, %mul17
  %16 = load i32, i32* %i, align 4
  %idxprom18 = sext i32 %16 to i64
  %17 = load i32, i32* %j, align 4
  %idxprom19 = sext i32 %17 to i64
  %18 = load [256 x float]*, [256 x float]** @aa, align 16
  %arrayidx20 = getelementptr inbounds [256 x float], [256 x float]* %18, i64 %idxprom19
  %arrayidx21 = getelementptr inbounds [256 x float], [256 x float]* %arrayidx20, i32 0, i64 %idxprom18
...
for.end:                                          ; preds = %for.cond.4
  ...
  %24 = load float*, float** @c, align 16
  ...
  %27 = load float*, float** @d, align 16
  %arrayidx27 = getelementptr inbounds float, float* %27, i64 %idxprom26
  %28 = load float, float* %arrayidx27, align 4
  %mul28 = fmul float %25, %28
  %add29 = fadd float %22, %mul28
...
for.end.34:                                       ; preds = %for.cond.1
  %32 = load float*, float** @a, align 16
  %33 = load float*, float** @b, align 16
  %34 = load float*, float** @c, align 16
  %35 = load float*, float** @d, align 16
  %36 = load float*, float** @e, align 16
  %37 = load [256 x float]*, [256 x float]** @aa, align 16
  %38 = load [256 x float]*, [256 x float]** @bb, align 16
  %39 = load [256 x float]*, [256 x float]** @cc, align 16
  %call35 = call i32 @dummy(float* %32, float* %33, float* %34, float* %35, float* %36, [256 x float]* %37, [256 x float]* %38, [256 x float]* %39, float 0.000000e+00)
  br label %for.inc.36

for.inc.36:                                       ; preds = %for.end.34
  %40 = load i32, i32* %nl, align 4
  %inc37 = add nsw i32 %40, 1
  store i32 %inc37, i32* %nl, align 4
  br label %for.cond

for.end.38:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %41 = load i64, i64* %end_t, align 8
  %42 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %41, %42
  store i64 %sub, i64* %clock_dif, align 8
  %43 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %43 to double
  %div39 = fdiv double %conv, 1.000000e+06
  store double %div39, double* %clock_dif_sec, align 8
  %44 = load double, double* %clock_dif_sec, align 8
  %call40 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.145, i32 0, i32 0), double %44)
  call void @check(i32 11)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.58, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 16000, i32* %mid, align 4
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
if.then:                                          ; preds = %for.body.3
  ...
  %8 = load i32, i32* %i, align 4
  %idxprom5 = sext i32 %8 to i64
  %9 = load float*, float** @c, align 16
  %arrayidx6 = getelementptr inbounds float, float* %9, i64 %idxprom5
  %10 = load float, float* %arrayidx6, align 4
  %mul7 = fmul float %7, %10
  %11 = load i32, i32* %i, align 4
  %idxprom8 = sext i32 %11 to i64
  %12 = load float*, float** @a, align 16
  %arrayidx9 = getelementptr inbounds float, float* %12, i64 %idxprom8
  %13 = load float, float* %arrayidx9, align 4
  %add10 = fadd float %13, %mul7
...
if.else:                                          ; preds = %for.body.3
  ...
  %15 = load float*, float** @b, align 16
  %arrayidx12 = getelementptr inbounds float, float* %15, i64 %idxprom11
  %16 = load float, float* %arrayidx12, align 4
  %17 = load i32, i32* %i, align 4
  %idxprom13 = sext i32 %17 to i64
  %18 = load float*, float** @d, align 16
  %arrayidx14 = getelementptr inbounds float, float* %18, i64 %idxprom13
  %19 = load float, float* %arrayidx14, align 4
  %mul15 = fmul float %16, %19
  %20 = load i32, i32* %i, align 4
  %idxprom16 = sext i32 %20 to i64
  %21 = load float*, float** @a, align 16
  %arrayidx17 = getelementptr inbounds float, float* %21, i64 %idxprom16
  %22 = load float, float* %arrayidx17, align 4
  %add18 = fadd float %22, %mul15
  store float %add18, float* %arrayidx17, align 4
  br label %if.end
...
for.end:                                          ; preds = %for.cond.1
  ...
  %30 = load [256 x float]*, [256 x float]** @bb, align 16
  %31 = load [256 x float]*, [256 x float]** @cc, align 16
  %call19 = call i32 @dummy(float* %24, float* %25, float* %26, float* %27, float* %28, [256 x float]* %29, [256 x float]* %30, [256 x float]* %31, float 0.000000e+00)
  br label %for.inc.20
...
for.end.22:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %36 = load double, double* %clock_dif_sec, align 8
  %call23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.146, i32 0, i32 0), double %36)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.59, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds float, float* %4, i64 %idxprom
  %5 = load float, float* %arrayidx, align 4
  %cmp4 = fcmp oge float %5, 0.000000e+00
  br i1 %cmp4, label %if.then, label %if.end
...
if.end:                                           ; preds = %for.body.3
  ...
  %arrayidx6 = getelementptr inbounds float, float* %7, i64 %idxprom5
  %8 = load float, float* %arrayidx6, align 4
  %cmp7 = fcmp oge float %8, 0.000000e+00
...
if.end.9:                                         ; preds = %if.end
  ...
  %13 = load float*, float** @d, align 16
...
for.end:                                          ; preds = %for.cond.1
  %30 = load float*, float** @a, align 16
  %31 = load float*, float** @b, align 16
  %32 = load float*, float** @c, align 16
  %33 = load float*, float** @d, align 16
  %34 = load float*, float** @e, align 16
  %35 = load [256 x float]*, [256 x float]** @aa, align 16
  %36 = load [256 x float]*, [256 x float]** @bb, align 16
  %37 = load [256 x float]*, [256 x float]** @cc, align 16
  %call27 = call i32 @dummy(float* %30, float* %31, float* %32, float* %33, float* %34, [256 x float]* %35, [256 x float]* %36, [256 x float]* %37, float 0.000000e+00)
  br label %for.inc.28
...
for.end.30:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %39 = load i64, i64* %end_t, align 8
  %40 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %39, %40
  store i64 %sub, i64* %clock_dif, align 8
  %41 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %41 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %42 = load double, double* %clock_dif_sec, align 8
  %call31 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.147, i32 0, i32 0), double %42)
  call void @check(i32 12)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.60, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
if.end:                                           ; preds = %for.body.3
  ...
  %15 = load i32, i32* %i, align 4
  %idxprom11 = sext i32 %15 to i64
  %16 = load float*, float** @b, align 16
  %arrayidx12 = getelementptr inbounds float, float* %16, i64 %idxprom11
  store float %add, float* %arrayidx12, align 4
  br label %L30
...
L30:                                              ; preds = %L20, %if.end
  ...
  %29 = load float*, float** @b, align 16
  %arrayidx25 = getelementptr inbounds float, float* %29, i64 %idxprom24
  %30 = load float, float* %arrayidx25, align 4
  %31 = load i32, i32* %i, align 4
  %idxprom26 = sext i32 %31 to i64
  %32 = load float*, float** @c, align 16
  %arrayidx27 = getelementptr inbounds float, float* %32, i64 %idxprom26
  ...
  %add31 = fadd float %30, %mul30
  %37 = load i32, i32* %i, align 4
  %idxprom32 = sext i32 %37 to i64
  %38 = load float*, float** @a, align 16
...
for.end:                                          ; preds = %for.cond.1
  %40 = load float*, float** @a, align 16
  %41 = load float*, float** @b, align 16
  %42 = load float*, float** @c, align 16
  %43 = load float*, float** @d, align 16
  %44 = load float*, float** @e, align 16
  %45 = load [256 x float]*, [256 x float]** @aa, align 16
  %46 = load [256 x float]*, [256 x float]** @bb, align 16
  %47 = load [256 x float]*, [256 x float]** @cc, align 16
  %call34 = call i32 @dummy(float* %40, float* %41, float* %42, float* %43, float* %44, [256 x float]* %45, [256 x float]* %46, [256 x float]* %47, float 0.000000e+00)
  br label %for.inc.35

for.inc.35:                                       ; preds = %for.end
  %48 = load i32, i32* %nl, align 4
  %inc36 = add nsw i32 %48, 1
  store i32 %inc36, i32* %nl, align 4
  br label %for.cond

for.end.37:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %49 = load i64, i64* %end_t, align 8
  %50 = load i64, i64* %start_t, align 8
  %sub38 = sub nsw i64 %49, %50
  store i64 %sub38, i64* %clock_dif, align 8
  %51 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %51 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %52 = load double, double* %clock_dif_sec, align 8
  %call39 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.148, i32 0, i32 0), double %52)
  call void @check(i32 123)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.61, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
L20:                                              ; preds = %if.then
  ...
  %39 = load float*, float** @e, align 16
...
L30:                                              ; preds = %L20, %if.end.19, %if.then.18
  ...
  %44 = load float*, float** @b, align 16
  %arrayidx40 = getelementptr inbounds float, float* %44, i64 %idxprom39
  %45 = load float, float* %arrayidx40, align 4
  %46 = load i32, i32* %i, align 4
  %idxprom41 = sext i32 %46 to i64
  %47 = load float*, float** @c, align 16
  %arrayidx42 = getelementptr inbounds float, float* %47, i64 %idxprom41
  %48 = load float, float* %arrayidx42, align 4
  %49 = load i32, i32* %i, align 4
  %idxprom43 = sext i32 %49 to i64
  %50 = load float*, float** @d, align 16
  %arrayidx44 = getelementptr inbounds float, float* %50, i64 %idxprom43
  %51 = load float, float* %arrayidx44, align 4
  %mul45 = fmul float %48, %51
  %add46 = fadd float %45, %mul45
  %52 = load i32, i32* %i, align 4
  %idxprom47 = sext i32 %52 to i64
  %53 = load float*, float** @a, align 16
  %arrayidx48 = getelementptr inbounds float, float* %53, i64 %idxprom47
  store float %add46, float* %arrayidx48, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond.1
  %55 = load float*, float** @a, align 16
  %56 = load float*, float** @b, align 16
  %57 = load float*, float** @c, align 16
  %58 = load float*, float** @d, align 16
  %59 = load float*, float** @e, align 16
  %60 = load [256 x float]*, [256 x float]** @aa, align 16
  %61 = load [256 x float]*, [256 x float]** @bb, align 16
  %62 = load [256 x float]*, [256 x float]** @cc, align 16
  %call49 = call i32 @dummy(float* %55, float* %56, float* %57, float* %58, float* %59, [256 x float]* %60, [256 x float]* %61, [256 x float]* %62, float 0.000000e+00)
  br label %for.inc.50

for.inc.50:                                       ; preds = %for.end
  %63 = load i32, i32* %nl, align 4
  %inc51 = add nsw i32 %63, 1
  store i32 %inc51, i32* %nl, align 4
  br label %for.cond

for.end.52:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %64 = load i64, i64* %end_t, align 8
  %65 = load i64, i64* %start_t, align 8
  %sub53 = sub nsw i64 %64, %65
  store i64 %sub53, i64* %clock_dif, align 8
  %66 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %66 to double
  %div54 = fdiv double %conv, 1.000000e+06
  store double %div54, double* %clock_dif_sec, align 8
  %67 = load double, double* %clock_dif_sec, align 8
  %call55 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.149, i32 0, i32 0), double %67)
  call void @check(i32 123)
  ret i32 0
}
...
if.then.10:                                       ; preds = %if.then
  ...
  %16 = load float*, float** @e, align 16
...
for.end:                                          ; preds = %for.cond.1
  %22 = load float*, float** @a, align 16
  %23 = load float*, float** @b, align 16
  %24 = load float*, float** @c, align 16
  %25 = load float*, float** @d, align 16
  %26 = load float*, float** @e, align 16
  %27 = load [256 x float]*, [256 x float]** @aa, align 16
  %28 = load [256 x float]*, [256 x float]** @bb, align 16
  %29 = load [256 x float]*, [256 x float]** @cc, align 16
  %call18 = call i32 @dummy(float* %22, float* %23, float* %24, float* %25, float* %26, [256 x float]* %27, [256 x float]* %28, [256 x float]* %29, float 0.000000e+00)
  br label %for.inc.19
...
for.end.21:                                       ; preds = %for.cond
  ...
  %call22 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.150, i32 0, i32 0), double %34)
  call void @check(i32 123)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @s2710(float %x) #0 {
entry:
  ...
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.62, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx5 = getelementptr inbounds float, float* %7, i64 %idxprom4
  %8 = load float, float* %arrayidx5, align 4
  %cmp6 = fcmp ogt float %5, %8
  br i1 %cmp6, label %if.then, label %if.else

if.then:                                          ; preds = %for.body.3
  %9 = load i32, i32* %i, align 4
  %idxprom7 = sext i32 %9 to i64
  %10 = load float*, float** @b, align 16
  %arrayidx8 = getelementptr inbounds float, float* %10, i64 %idxprom7
  %11 = load float, float* %arrayidx8, align 4
  %12 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %12 to i64
...
if.else:                                          ; preds = %for.body.3
  %27 = load i32, i32* %i, align 4
  %idxprom21 = sext i32 %27 to i64
  %28 = load float*, float** @a, align 16
  %arrayidx22 = getelementptr inbounds float, float* %28, i64 %idxprom21
  %29 = load float, float* %arrayidx22, align 4
  %30 = load i32, i32* %i, align 4
  %idxprom23 = sext i32 %30 to i64
  %31 = load float*, float** @e, align 16
  ...
  %34 = load float*, float** @e, align 16
  %arrayidx26 = getelementptr inbounds float, float* %34, i64 %idxprom25
  %35 = load float, float* %arrayidx26, align 4
  %mul27 = fmul float %32, %35
  %add28 = fadd float %29, %mul27
  %36 = load i32, i32* %i, align 4
  %idxprom29 = sext i32 %36 to i64
  %37 = load float*, float** @b, align 16
  ...
  %cmp31 = fcmp ogt float %38, 0.000000e+00
  br i1 %cmp31, label %if.then.32, label %if.else.43

if.then.32:                                       ; preds = %if.else
  %39 = load i32, i32* %i, align 4
  %idxprom33 = sext i32 %39 to i64
  %40 = load float*, float** @a, align 16
  %arrayidx34 = getelementptr inbounds float, float* %40, i64 %idxprom33
  %41 = load float, float* %arrayidx34, align 4
  %42 = load i32, i32* %i, align 4
  %idxprom35 = sext i32 %42 to i64
  %43 = load float*, float** @d, align 16
  %arrayidx36 = getelementptr inbounds float, float* %43, i64 %idxprom35
  %44 = load float, float* %arrayidx36, align 4
  %45 = load i32, i32* %i, align 4
  %idxprom37 = sext i32 %45 to i64
  %46 = load float*, float** @d, align 16
  %arrayidx38 = getelementptr inbounds float, float* %46, i64 %idxprom37
  %47 = load float, float* %arrayidx38, align 4
  %mul39 = fmul float %44, %47
  %add40 = fadd float %41, %mul39
  %48 = load i32, i32* %i, align 4
  %idxprom41 = sext i32 %48 to i64
  %49 = load float*, float** @c, align 16
...
if.else.43:                                       ; preds = %if.else
  ...
  %51 = load float*, float** @e, align 16
  %arrayidx45 = getelementptr inbounds float, float* %51, i64 %idxprom44
  %52 = load float, float* %arrayidx45, align 4
  %53 = load i32, i32* %i, align 4
  %idxprom46 = sext i32 %53 to i64
  %54 = load float*, float** @e, align 16
  %arrayidx47 = getelementptr inbounds float, float* %54, i64 %idxprom46
  %55 = load float, float* %arrayidx47, align 4
  %mul48 = fmul float %52, %55
  %56 = load i32, i32* %i, align 4
  %idxprom49 = sext i32 %56 to i64
  %57 = load float*, float** @c, align 16
  %arrayidx50 = getelementptr inbounds float, float* %57, i64 %idxprom49
  %58 = load float, float* %arrayidx50, align 4
  %add51 = fadd float %58, %mul48
...
for.end:                                          ; preds = %for.cond.1
  %60 = load float*, float** @a, align 16
  %61 = load float*, float** @b, align 16
  %62 = load float*, float** @c, align 16
  %63 = load float*, float** @d, align 16
  %64 = load float*, float** @e, align 16
  %65 = load [256 x float]*, [256 x float]** @aa, align 16
  %66 = load [256 x float]*, [256 x float]** @bb, align 16
  %67 = load [256 x float]*, [256 x float]** @cc, align 16
  %call53 = call i32 @dummy(float* %60, float* %61, float* %62, float* %63, float* %64, [256 x float]* %65, [256 x float]* %66, [256 x float]* %67, float 0.000000e+00)
  br label %for.inc.54

for.inc.54:                                       ; preds = %for.end
  %68 = load i32, i32* %nl, align 4
  %inc55 = add nsw i32 %68, 1
  store i32 %inc55, i32* %nl, align 4
  br label %for.cond

for.end.56:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %69 = load i64, i64* %end_t, align 8
  %70 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %69, %70
  store i64 %sub, i64* %clock_dif, align 8
  %71 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %71 to double
  %div57 = fdiv double %conv, 1.000000e+06
  store double %div57, double* %clock_dif_sec, align 8
  %72 = load double, double* %clock_dif_sec, align 8
  %call58 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.151, i32 0, i32 0), double %72)
  call void @check(i32 123)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.63, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds float, float* %4, i64 %idxprom
  %5 = load float, float* %arrayidx, align 4
  %cmp4 = fcmp une float %5, 0.000000e+00
  br i1 %cmp4, label %if.then, label %if.end
...
for.end.15:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %28 = load double, double* %clock_dif_sec, align 8
  %call16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.152, i32 0, i32 0), double %28)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.64, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
if.then:                                          ; preds = %for.body.3
  ...
  %12 = load i32, i32* %i, align 4
  %idxprom9 = sext i32 %12 to i64
  %13 = load float*, float** @c, align 16
  %arrayidx10 = getelementptr inbounds float, float* %13, i64 %idxprom9
  %14 = load float, float* %arrayidx10, align 4
  %mul11 = fmul float %11, %14
  %15 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %15 to i64
  %16 = load float*, float** @a, align 16
  %arrayidx13 = getelementptr inbounds float, float* %16, i64 %idxprom12
  %17 = load float, float* %arrayidx13, align 4
  %add = fadd float %17, %mul11
...
for.end:                                          ; preds = %for.cond.1
  %19 = load float*, float** @a, align 16
  %20 = load float*, float** @b, align 16
  %21 = load float*, float** @c, align 16
  %22 = load float*, float** @d, align 16
  %23 = load float*, float** @e, align 16
  %24 = load [256 x float]*, [256 x float]** @aa, align 16
  %25 = load [256 x float]*, [256 x float]** @bb, align 16
  %26 = load [256 x float]*, [256 x float]** @cc, align 16
  %call14 = call i32 @dummy(float* %19, float* %20, float* %21, float* %22, float* %23, [256 x float]* %24, [256 x float]* %25, [256 x float]* %26, float 0.000000e+00)
  br label %for.inc.15

for.inc.15:                                       ; preds = %for.end
  %27 = load i32, i32* %nl, align 4
  %inc16 = add nsw i32 %27, 1
  store i32 %inc16, i32* %nl, align 4
  br label %for.cond
...
for.end.17:                                       ; preds = %for.cond
  ...
  %call18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.153, i32 0, i32 0), double %31)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.107, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
if.then.14:                                       ; preds = %if.else
  %18 = load i32, i32* %i, align 4
  %idxprom15 = sext i32 %18 to i64
  %19 = load float*, float** @b, align 16
  %arrayidx16 = getelementptr inbounds float, float* %19, i64 %idxprom15
  %20 = load float, float* %arrayidx16, align 4
  %21 = load i32, i32* %i, align 4
  ...
  %mul19 = fmul float %20, %23
  %24 = load i32, i32* %i, align 4
  %idxprom20 = sext i32 %24 to i64
  %25 = load float*, float** @a, align 16
  %arrayidx21 = getelementptr inbounds float, float* %25, i64 %idxprom20
  %26 = load float, float* %arrayidx21, align 4
  %add22 = fadd float %26, %mul19
...
if.else.23:                                       ; preds = %if.else
  ...
  %34 = load float*, float** @a, align 16
  %arrayidx30 = getelementptr inbounds float, float* %34, i64 %idxprom29
  %35 = load float, float* %arrayidx30, align 4
  %add31 = fadd float %35, %mul28
...
for.end:                                          ; preds = %for.cond.1
  %37 = load float*, float** @a, align 16
  %38 = load float*, float** @b, align 16
  %39 = load float*, float** @c, align 16
  %40 = load float*, float** @d, align 16
  %41 = load float*, float** @e, align 16
  %42 = load [256 x float]*, [256 x float]** @aa, align 16
  %43 = load [256 x float]*, [256 x float]** @bb, align 16
  %44 = load [256 x float]*, [256 x float]** @cc, align 16
  %call33 = call i32 @dummy(float* %37, float* %38, float* %39, float* %40, float* %41, [256 x float]* %42, [256 x float]* %43, [256 x float]* %44, float 0.000000e+00)
  br label %for.inc.34

for.inc.34:                                       ; preds = %for.end
  %45 = load i32, i32* %nl, align 4
  %inc35 = add nsw i32 %45, 1
  store i32 %inc35, i32* %nl, align 4
  br label %for.cond

for.end.36:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %46 = load i64, i64* %end_t, align 8
  %47 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %46, %47
  store i64 %sub, i64* %clock_dif, align 8
  %48 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %48 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %49 = load double, double* %clock_dif_sec, align 8
  %call37 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.154, i32 0, i32 0), double %49)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.108, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  %3 = load i32, i32* %i, align 4
  %idxprom = sext i32 %3 to i64
  %arrayidx = getelementptr inbounds [32000 x i32], [32000 x i32]* @indx, i32 0, i64 %idxprom
...
L20:                                              ; preds = %sw.bb.4
  ...
  %mul17 = fmul float %16, %19
  %20 = load i32, i32* %i, align 4
  %idxprom18 = sext i32 %20 to i64
  %21 = load float*, float** @a, align 16
  %arrayidx19 = getelementptr inbounds float, float* %21, i64 %idxprom18
  %22 = load float, float* %arrayidx19, align 4
  %add20 = fadd float %22, %mul17
  store float %add20, float* %arrayidx19, align 4
  br label %L50
...
L40:                                              ; preds = %sw.bb.6
  ...
  %39 = load float*, float** @a, align 16
  %arrayidx35 = getelementptr inbounds float, float* %39, i64 %idxprom34
  %40 = load float, float* %arrayidx35, align 4
  %add36 = fadd float %40, %mul33
  store float %add36, float* %arrayidx35, align 4
  br label %L50
...
for.end:                                          ; preds = %for.cond.1
  %42 = load float*, float** @a, align 16
  %43 = load float*, float** @b, align 16
  %44 = load float*, float** @c, align 16
  %45 = load float*, float** @d, align 16
  %46 = load float*, float** @e, align 16
  %47 = load [256 x float]*, [256 x float]** @aa, align 16
  %48 = load [256 x float]*, [256 x float]** @bb, align 16
  %49 = load [256 x float]*, [256 x float]** @cc, align 16
  %call37 = call i32 @dummy(float* %42, float* %43, float* %44, float* %45, float* %46, [256 x float]* %47, [256 x float]* %48, [256 x float]* %49, float 0.000000e+00)
  br label %for.inc.38

for.inc.38:                                       ; preds = %for.end
  %50 = load i32, i32* %nl, align 4
  %inc39 = add nsw i32 %50, 1
  store i32 %inc39, i32* %nl, align 4
  br label %for.cond

for.end.40:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %51 = load i64, i64* %end_t, align 8
  %52 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %51, %52
  store i64 %sub, i64* %clock_dif, align 8
  %53 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %53 to double
  %div41 = fdiv double %conv, 1.000000e+06
  store double %div41, double* %clock_dif_sec, align 8
  %54 = load double, double* %clock_dif_sec, align 8
  %call42 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.155, i32 0, i32 0), double %54)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.109, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds float, float* %4, i64 %idxprom
  %5 = load float, float* %arrayidx, align 4
  %cmp4 = fcmp ole float %5, 0.000000e+00
  br i1 %cmp4, label %if.then, label %if.else
...
L30:                                              ; preds = %if.else
  ...
  %mul16 = fmul float %17, %20
  %21 = load i32, i32* %i, align 4
  %idxprom17 = sext i32 %21 to i64
  %22 = load float*, float** @a, align 16
  %arrayidx18 = getelementptr inbounds float, float* %22, i64 %idxprom17
  %23 = load float, float* %arrayidx18, align 4
  %add19 = fadd float %23, %mul16
...
for.end:                                          ; preds = %for.cond.1
  %25 = load float*, float** @a, align 16
  %26 = load float*, float** @b, align 16
  %27 = load float*, float** @c, align 16
  %28 = load float*, float** @d, align 16
  %29 = load float*, float** @e, align 16
  %30 = load [256 x float]*, [256 x float]** @aa, align 16
  %31 = load [256 x float]*, [256 x float]** @bb, align 16
  %32 = load [256 x float]*, [256 x float]** @cc, align 16
  %call20 = call i32 @dummy(float* %25, float* %26, float* %27, float* %28, float* %29, [256 x float]* %30, [256 x float]* %31, [256 x float]* %32, float 0.000000e+00)
  br label %for.inc.21
...
for.end.23:                                       ; preds = %for.cond
  store i64 0, i64* %end_t, align 8
  %34 = load i64, i64* %end_t, align 8
  %35 = load i64, i64* %start_t, align 8
  %sub = sub nsw i64 %34, %35
  store i64 %sub, i64* %clock_dif, align 8
  %36 = load i64, i64* %clock_dif, align 8
  %conv = sitofp i64 %36 to double
  %div = fdiv double %conv, 1.000000e+06
  store double %div, double* %clock_dif_sec, align 8
  %37 = load double, double* %clock_dif_sec, align 8
  %call24 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.156, i32 0, i32 0), double %37)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.114, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %for.cond.1
  ...
  %22 = load [256 x float]*, [256 x float]** @bb, align 16
  %23 = load [256 x float]*, [256 x float]** @cc, align 16
  %call11 = call i32 @dummy(float* %16, float* %17, float* %18, float* %19, float* %20, [256 x float]* %21, [256 x float]* %22, [256 x float]* %23, float 0.000000e+00)
  br label %for.inc.12

for.inc.12:                                       ; preds = %for.end
  %24 = load i32, i32* %nl, align 4
  %inc13 = add nsw i32 %24, 1
  store i32 %inc13, i32* %nl, align 4
  br label %for.cond
...
for.end.14:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %28 = load double, double* %clock_dif_sec, align 8
  %call15 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.157, i32 0, i32 0), double %28)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %nl = alloca i32, align 4
  %i = alloca i32, align 4
  %call = call i32 @init(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.115, i32 0, i32 0))
  store i64 0, i64* %start_t, align 8
  store i32 0, i32* %nl, align 4
  br label %for.cond
...
for.end:                                          ; preds = %if.then, %for.cond.1
  ...
  %25 = load [256 x float]*, [256 x float]** @bb, align 16
  %26 = load [256 x float]*, [256 x float]** @cc, align 16
  %call13 = call i32 @dummy(float* %19, float* %20, float* %21, float* %22, float* %23, [256 x float]* %24, [256 x float]* %25, [256 x float]* %26, float 0.000000e+00)
  br label %for.inc.14

for.inc.14:                                       ; preds = %for.end
  %27 = load i32, i32* %nl, align 4
  %inc15 = add nsw i32 %27, 1
  store i32 %inc15, i32* %nl, align 4
  br label %for.cond
...
for.end.16:                                       ; preds = %for.cond
  ...
  store double %div, double* %clock_dif_sec, align 8
  %31 = load double, double* %clock_dif_sec, align 8
  %call17 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.158, i32 0, i32 0), double %31)
  call void @check(i32 1)
  ret i32 0
}
...
entry:
  ...
  %call = call i32 @posix_memalign(i8** bitcast (float** @xx to i8**), i64 16, i64 128000) #7
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.159, i32 0, i32 0))
  store i32 0, i32* %i, align 4
  br label %for.cond
...
entry:
  ...
  %call = call i32 @posix_memalign(i8** %0, i64 16, i64 128000) #7
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.160, i32 0, i32 0), i32 %4)
...
if.end.7:                                         ; preds = %if.then.4, %if.end
  ...
  %call8 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.161, i32 0, i32 0))
  %call9 = call i32 @s161()
  %call10 = call i32 @s1161()
  %9 = load i32, i32* %n1, align 4
  %call11 = call i32 @s162(i32 %9)
  %call12 = call i32 @s271()
  %10 = load float, float* %s1, align 4
  %call13 = call i32 @s272(float %10)
  %call14 = call i32 @s273()
  %call15 = call i32 @s274()
  %call16 = call i32 @s275()
  %call17 = call i32 @s2275()
  %call18 = call i32 @s276()
  %call19 = call i32 @s277()
  %call20 = call i32 @s278()
  %call21 = call i32 @s279()
  %call22 = call i32 @s1279()
  %11 = load float, float* %s1, align 4
  %call23 = call i32 @s2710(float %11)
  %call24 = call i32 @s2711()
  %call25 = call i32 @s2712()
  %call26 = call i32 @s441()
  %call27 = call i32 @s442()
  %call28 = call i32 @s443()
  %call29 = call i32 @s481()
  %call30 = call i32 @s482()
  ret i32 0
}
