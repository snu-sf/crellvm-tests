; ModuleID = './MultiSource.Benchmarks.MallocBench/62.gs.gdevs.bc'
...
@gx_device_list = global [1 x %struct.gx_device_s*] zeroinitializer, align 8

; Function Attrs: nounwind uwtable
define void @gdevs_dummy() #0 {
entry:
  ret void
}
