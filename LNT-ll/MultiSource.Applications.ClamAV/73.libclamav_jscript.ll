; ModuleID = './MultiSource.Applications.ClamAV/73.libclamav_jscript.bc'
...
define i32 @cli_scanjs(i8* %dir, i32 %desc) #0 {
entry:
  %dir.addr = alloca i8*, align 8
  %desc.addr = alloca i32, align 4
  store i8* %dir, i8** %dir.addr, align 8
  store i32 %desc, i32* %desc.addr, align 4
  call void (i8*, ...) @cli_warnmsg(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str, i32 0, i32 0))
  ret i32 -124
}
