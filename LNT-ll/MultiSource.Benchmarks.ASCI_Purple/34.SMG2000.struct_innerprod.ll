; ModuleID = './MultiSource.Benchmarks.ASCI_Purple/34.SMG2000.struct_innerprod.bc'
...
@final_innerprod_result = common global double 0.000000e+00, align 8

; Function Attrs: nounwind uwtable
define double @hypre_StructInnerProd(%struct.hypre_StructVector_struct* %x, %struct.hypre_StructVector_struct* %y) #0 {
entry:
  ...
  store double 0.000000e+00, double* %process_result, align 8
...
for.cond:                                         ; preds = %for.inc.337, %entry
  ...
  br i1 %cmp, label %for.body, label %for.end.339
...
for.body.307:                                     ; preds = %for.cond.305
  ...
  %223 = load double, double* %arrayidx311, align 8
  %mul312 = fmul double %220, %223
  %224 = load double, double* %local_result, align 8
  %add313 = fadd double %224, %mul312
  store double %add313, double* %local_result, align 8
  %225 = load i32, i32* %hypre__sx1, align 4
  %226 = load i32, i32* %xi, align 4
  %add314 = add nsw i32 %226, %225
  store i32 %add314, i32* %xi, align 4
  %227 = load i32, i32* %hypre__sx2, align 4
  %228 = load i32, i32* %yi, align 4
  %add315 = add nsw i32 %228, %227
  store i32 %add315, i32* %yi, align 4
  br label %for.inc

for.inc:                                          ; preds = %for.body.307
  %229 = load i32, i32* %loopi, align 4
...
for.end:                                          ; preds = %for.cond.305
  ...
  %231 = load i32, i32* %hypre__nx, align 4
  %232 = load i32, i32* %hypre__sx1, align 4
  %mul316 = mul nsw i32 %231, %232
  %sub317 = sub nsw i32 %230, %mul316
  %233 = load i32, i32* %xi, align 4
  %add318 = add nsw i32 %233, %sub317
  store i32 %add318, i32* %xi, align 4
  %234 = load i32, i32* %hypre__sy2, align 4
  %235 = load i32, i32* %hypre__nx, align 4
  %236 = load i32, i32* %hypre__sx2, align 4
  %mul319 = mul nsw i32 %235, %236
  %sub320 = sub nsw i32 %234, %mul319
  %237 = load i32, i32* %yi, align 4
  %add321 = add nsw i32 %237, %sub320
  store i32 %add321, i32* %yi, align 4
  br label %for.inc.322

for.inc.322:                                      ; preds = %for.end
  %238 = load i32, i32* %loopj, align 4
  %inc323 = add nsw i32 %238, 1
  store i32 %inc323, i32* %loopj, align 4
  br label %for.cond.302

for.end.324:                                      ; preds = %for.cond.302
  %239 = load i32, i32* %hypre__sz1, align 4
  %240 = load i32, i32* %hypre__ny, align 4
  %241 = load i32, i32* %hypre__sy1, align 4
  %mul325 = mul nsw i32 %240, %241
  %sub326 = sub nsw i32 %239, %mul325
  %242 = load i32, i32* %xi, align 4
  %add327 = add nsw i32 %242, %sub326
  store i32 %add327, i32* %xi, align 4
  %243 = load i32, i32* %hypre__sz2, align 4
  %244 = load i32, i32* %hypre__ny, align 4
  %245 = load i32, i32* %hypre__sy2, align 4
  %mul328 = mul nsw i32 %244, %245
  %sub329 = sub nsw i32 %243, %mul328
  %246 = load i32, i32* %yi, align 4
  %add330 = add nsw i32 %246, %sub329
  store i32 %add330, i32* %yi, align 4
  br label %for.inc.331

for.inc.331:                                      ; preds = %for.end.324
  %247 = load i32, i32* %loopk, align 4
  %inc332 = add nsw i32 %247, 1
  store i32 %inc332, i32* %loopk, align 4
  br label %for.cond.299

for.end.333:                                      ; preds = %for.cond.299
  br label %for.inc.334

for.inc.334:                                      ; preds = %for.end.333
  %248 = load i32, i32* %hypre__block, align 4
  %inc335 = add nsw i32 %248, 1
  store i32 %inc335, i32* %hypre__block, align 4
  br label %for.cond.241

for.end.336:                                      ; preds = %for.cond.241
  br label %for.inc.337

for.inc.337:                                      ; preds = %for.end.336
  %249 = load i32, i32* %i, align 4
  %inc338 = add nsw i32 %249, 1
  store i32 %inc338, i32* %i, align 4
  br label %for.cond

for.end.339:                                      ; preds = %for.cond
  %250 = load double, double* %local_result, align 8
  store double %250, double* %process_result, align 8
  %251 = bitcast double* %process_result to i8*
  %252 = load %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %x.addr, align 8
  %comm = getelementptr inbounds %struct.hypre_StructVector_struct, %struct.hypre_StructVector_struct* %252, i32 0, i32 0
  %253 = load i32, i32* %comm, align 4
  %call340 = call i32 @hypre_MPI_Allreduce(i8* %251, i8* bitcast (double* @final_innerprod_result to i8*), i32 1, i32 0, i32 0, i32 %253)
  %254 = load %struct.hypre_StructVector_struct*, %struct.hypre_StructVector_struct** %x.addr, align 8
  %global_size = getelementptr inbounds %struct.hypre_StructVector_struct, %struct.hypre_StructVector_struct* %254, i32 0, i32 8
  %255 = load i32, i32* %global_size, align 4
  %mul341 = mul nsw i32 2, %255
  %call342 = call i32 @hypre_IncFLOPCount(i32 %mul341)
  %256 = load double, double* @final_innerprod_result, align 8
  ret double %256
}
