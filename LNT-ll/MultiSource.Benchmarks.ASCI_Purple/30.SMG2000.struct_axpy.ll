; ModuleID = './MultiSource.Benchmarks.ASCI_Purple/30.SMG2000.struct_axpy.bc'
...
define i32 @hypre_StructAxpy(double %alpha, %struct.hypre_StructVector_struct* %x, %struct.hypre_StructVector_struct* %y) #0 {
entry:
...
for.body.307:                                     ; preds = %for.cond.305
  %218 = load double, double* %alpha.addr, align 8
  %219 = load i32, i32* %xi, align 4
  %idxprom308 = sext i32 %219 to i64
  %220 = load double*, double** %xp, align 8
  %arrayidx309 = getelementptr inbounds double, double* %220, i64 %idxprom308
  %221 = load double, double* %arrayidx309, align 8
  %mul310 = fmul double %218, %221
  %222 = load i32, i32* %yi, align 4
  %idxprom311 = sext i32 %222 to i64
  %223 = load double*, double** %yp, align 8
  %arrayidx312 = getelementptr inbounds double, double* %223, i64 %idxprom311
  %224 = load double, double* %arrayidx312, align 8
  %add313 = fadd double %224, %mul310
