; ModuleID = './SingleSource.Benchmarks.Misc/14.flops-6.bc'
...
entry:
  ...
  %3 = load double, double* @four, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %mul33 = fmul double %26, %add32
  %add34 = fadd double %25, %mul33
...
for.end:                                          ; preds = %for.cond
  ...
  %42 = load double, double* @four, align 8
  ...
  %mul62 = fmul double %72, %73
  store double %mul62, double* @sa, align 8
