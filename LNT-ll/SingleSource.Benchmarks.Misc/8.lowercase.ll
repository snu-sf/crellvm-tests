; ModuleID = './SingleSource.Benchmarks.Misc/8.lowercase.bc'
...
for.cond.7:                                       ; preds = %for.inc.11, %for.end
  ...
  br i1 %cmp8, label %for.body.9, label %for.end.12
...
for.body:                                         ; preds = %for.cond
  ...
  %9 = load i16*, i16** %output.addr, align 8
  %arrayidx3 = getelementptr inbounds i16, i16* %9, i64 %8
...
define internal zeroext i16 @toASCIILower(i16 zeroext %c) #3 {
entry:
