; ModuleID = './SingleSource.Benchmarks.Misc/3.perlin.bc'
...
entry:
  ...
  %arrayidx = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom
  ...
  %arrayidx16 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom15
  ...
  %arrayidx20 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom19
  ...
  %arrayidx24 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom23
  ...
  %arrayidx27 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom26
  ...
  %arrayidx31 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom30
  ...
  %arrayidx34 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom33
  ...
  %arrayidx37 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom36
  ...
  %arrayidx42 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom41
  ...
  %arrayidx46 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom45
  ...
  %arrayidx54 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom53
  ...
  %arrayidx59 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom58
  ...
  %arrayidx66 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom65
  ...
  %arrayidx72 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom71
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds [256 x i32], [256 x i32]* @permutation, i32 0, i64 %idxprom
  %2 = load i32, i32* %arrayidx, align 4
  %3 = load i32, i32* %i, align 4
  %idxprom1 = sext i32 %3 to i64
  %arrayidx2 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom1
  store i32 %2, i32* %arrayidx2, align 4
  %4 = load i32, i32* %i, align 4
  %add = add nsw i32 256, %4
  %idxprom3 = sext i32 %add to i64
  %arrayidx4 = getelementptr inbounds [512 x i32], [512 x i32]* @p, i32 0, i64 %idxprom3
...
cond.false.3:                                     ; preds = %cond.end
  ...
  br i1 %cmp4, label %cond.true.6, label %lor.lhs.false
...
cond.end.8:                                       ; preds = %cond.false.7, %cond.true.6
  %cond9 = phi double [ %8, %cond.true.6 ], [ %9, %cond.false.7 ]
  br label %cond.end.10

cond.end.10:                                      ; preds = %cond.end.8, %cond.true.2
  %cond11 = phi double [ %5, %cond.true.2 ], [ %cond9, %cond.end.8 ]
...
cond.end.16:                                      ; preds = %cond.false.15, %cond.true.14
  %cond17 = phi double [ %11, %cond.true.14 ], [ %sub, %cond.false.15 ]
...
cond.end.23:                                      ; preds = %cond.false.21, %cond.true.20
  %cond24 = phi double [ %14, %cond.true.20 ], [ %sub22, %cond.false.21 ]
