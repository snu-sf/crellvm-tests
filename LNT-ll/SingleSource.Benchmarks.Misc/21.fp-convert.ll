; ModuleID = './SingleSource.Benchmarks.Misc/21.fp-convert.bc'
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx1 = getelementptr inbounds float, float* %6, i64 %5
...
for.body.4:                                       ; preds = %for.cond.2
  ...
  %arrayidx9 = getelementptr inbounds [2048 x float], [2048 x float]* %y, i32 0, i64 %idxprom8
