; ModuleID = './SingleSource.Benchmarks.Misc/11.dt.bc'
...
entry:
  ...
  %call = call i32 @posix_memalign(i8** %0, i64 16, i64 16384) #4
  %1 = bitcast double** %dvec2 to i8**
  %call1 = call i32 @posix_memalign(i8** %1, i64 16, i64 16384) #4
...
for.body:                                         ; preds = %for.cond
  ...
  %call4 = call float @cosf(float %conv) #4
  %conv5 = fpext float %call4 to double
  %mul = fmul double 0x3FF000001AD7F29B, %conv5
  %4 = load i64, i64* %i, align 8
  %5 = load double*, double** %dvec1, align 8
  %arrayidx = getelementptr inbounds double, double* %5, i64 %4
  store double %mul, double* %arrayidx, align 8
  %6 = load i64, i64* %i, align 8
  %conv6 = sitofp i64 %6 to float
  %call7 = call float @sinf(float %conv6) #4
  %conv8 = fpext float %call7 to double
  %mul9 = fmul double 1.000000e-10, %conv8
  %add = fadd double 1.000000e+00, %mul9
  %7 = load i64, i64* %i, align 8
  %8 = load double*, double** %dvec2, align 8
  %arrayidx10 = getelementptr inbounds double, double* %8, i64 %7
...
define internal void @double_array_divs_variable(double* noalias %dvec1, double* noalias %dvec2) #3 {
entry:
...
for.body.3:                                       ; preds = %for.cond.1
  %2 = load i64, i64* %i, align 8
  %3 = load double*, double** %dvec2.addr, align 8
  %arrayidx = getelementptr inbounds double, double* %3, i64 %2
  %4 = load double, double* %arrayidx, align 8
  %5 = load i64, i64* %i, align 8
  %6 = load double*, double** %dvec1.addr, align 8
  %arrayidx4 = getelementptr inbounds double, double* %6, i64 %5
