; ModuleID = './SingleSource.Benchmarks.Misc/17.richards_benchmark.bc'
...
entry:
  ...
  %arrayidx = getelementptr inbounds [11 x %struct.task*], [11 x %struct.task*]* @tasktab, i32 0, i64 %idxprom
  ...
  store i32 %11, i32* %t_state, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %idxprom = sext i32 %2 to i64
  %3 = load %struct.packet*, %struct.packet** %p, align 8
  %p_a2 = getelementptr inbounds %struct.packet, %struct.packet* %3, i32 0, i32 4
  %arrayidx = getelementptr inbounds [4 x i8], [4 x i8]* %p_a2, i32 0, i64 %idxprom
...
while.body:                                       ; preds = %while.cond
  ...
  %2 = load i32, i32* %t_state, align 4
...
sw.bb:                                            ; preds = %while.body
  ...
  store i32 %cond, i32* %t_state4, align 4
  br label %sw.bb.5
...
entry:
  ...
  %1 = load i32, i32* %t_state, align 4
  %or = or i32 %1, 2
  store i32 %or, i32* %t_state, align 4
...
if.then.3:                                        ; preds = %if.end
  %8 = load %struct.task*, %struct.task** %t, align 8
  store %struct.task* %8, %struct.task** %retval
  br label %return

if.end.4:                                         ; preds = %if.end
  %9 = load %struct.task*, %struct.task** @tcb, align 8
  store %struct.task* %9, %struct.task** %retval
  br label %return

return:                                           ; preds = %if.end.4, %if.then.3, %if.then
  %10 = load %struct.task*, %struct.task** %retval
  ret %struct.task* %10
}
...
if.then:                                          ; preds = %entry
  ...
  store %struct.task* %3, %struct.task** %retval
  br label %return
...
if.end:                                           ; preds = %entry
  ...
  store i32 %conv, i32* %p_id1, align 4
  %8 = load %struct.task*, %struct.task** %t, align 8
...
if.then.4:                                        ; preds = %if.end
  ...
  %12 = load %struct.task*, %struct.task** %t, align 8
  %t_state = getelementptr inbounds %struct.task, %struct.task* %12, i32 0, i32 4
  %13 = load i32, i32* %t_state, align 4
  %or = or i32 %13, 1
  store i32 %or, i32* %t_state, align 4
  %14 = load %struct.task*, %struct.task** %t, align 8
...
if.then.9:                                        ; preds = %if.then.4
  %18 = load %struct.task*, %struct.task** %t, align 8
  store %struct.task* %18, %struct.task** %retval
  br label %return
...
if.end.12:                                        ; preds = %if.else, %if.end.10
  ...
  store %struct.task* %22, %struct.task** %retval
  br label %return

return:                                           ; preds = %if.end.12, %if.then.9, %if.then
  %23 = load %struct.task*, %struct.task** %retval
  ret %struct.task* %23
}
...
if.then:                                          ; preds = %entry
  ...
  store %struct.task* %call, %struct.task** %retval
  br label %return
...
if.then.2:                                        ; preds = %if.end
  ...
  store %struct.task* %call4, %struct.task** %retval
  br label %return
...
if.else:                                          ; preds = %if.end
  ...
  store %struct.task* %call7, %struct.task** %retval
  br label %return

return:                                           ; preds = %if.else, %if.then.2, %if.then
  %5 = load %struct.task*, %struct.task** %retval
  ret %struct.task* %5
}
...
if.else:                                          ; preds = %entry
  ...
  store i32 %conv, i32* %p_id, align 4
...
if.end:                                           ; preds = %if.then.5, %for.body
  ...
  %arrayidx = getelementptr inbounds [28 x i8], [28 x i8]* @alphabet, i32 0, i64 %8
  %9 = load i8, i8* %arrayidx, align 1
  %10 = load i32, i32* %i, align 4
  %idxprom = sext i32 %10 to i64
  %11 = load %struct.packet*, %struct.packet** %pkt.addr, align 8
  %p_a2 = getelementptr inbounds %struct.packet, %struct.packet* %11, i32 0, i32 4
  %arrayidx6 = getelementptr inbounds [4 x i8], [4 x i8]* %p_a2, i32 0, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  ...
  store %struct.task* %call8, %struct.task** %retval
  br label %return

return:                                           ; preds = %for.end, %if.then
  %14 = load %struct.task*, %struct.task** %retval
  ret %struct.task* %14
}
...
if.then.8:                                        ; preds = %if.end.6
  ...
  %24 = load %struct.packet*, %struct.packet** %workpkt, align 8
  %p_a2 = getelementptr inbounds %struct.packet, %struct.packet* %24, i32 0, i32 4
  %arrayidx = getelementptr inbounds [4 x i8], [4 x i8]* %p_a2, i32 0, i64 %idxprom
  ...
  store i32 %conv, i32* %p_a110, align 4
...
if.end.14:                                        ; preds = %if.end.13, %if.end
  ...
  store %struct.task* %call15, %struct.task** %retval
  br label %return

return:                                           ; preds = %if.end.14, %if.then.8, %if.then.5
  %30 = load %struct.task*, %struct.task** %retval
  ret %struct.task* %30
}
...
if.end:                                           ; preds = %if.then
  ...
  store %struct.task* %call3, %struct.task** %retval
  br label %return
