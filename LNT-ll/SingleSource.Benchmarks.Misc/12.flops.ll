; ModuleID = './SingleSource.Benchmarks.Misc/12.flops.bc'
...
entry:
  ...
  store double %div, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
...
for.end:                                          ; preds = %for.cond
  ...
  %29 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
...
while.end:                                        ; preds = %if.then, %while.cond
  ...
  store double %32, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %call28 = call i32 @dtime(double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i32 0))
  store i64 1, i64* %i, align 8
  br label %for.cond.29

for.cond.29:                                      ; preds = %for.inc.34, %while.end
...
for.end.36:                                       ; preds = %for.cond.29
  ...
  %36 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %37 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
...
if.then.41:                                       ; preds = %for.end.36
  store double 0.000000e+00, double* @nulltime, align 8
  br label %if.end.42

if.end.42:                                        ; preds = %if.then.41, %for.end.36
  %39 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %40 = load double, double* @sa, align 8
  %mul43 = fmul double %39, %40
  %41 = load double, double* @nulltime, align 8
  %sub44 = fsub double %mul43, %41
  store double %sub44, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 2), align 8
  ...
  %50 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 2), align 8
  %div51 = fdiv double %50, 1.400000e+01
  store double %div51, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 3), align 8
  ...
  %63 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 3), align 8
  %div64 = fdiv double %62, %63
  store double %div64, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 4), align 8
  %64 = load double, double* @sc, align 8
  %mul65 = fmul double %64, 1.000000e-30
  %65 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 2), align 8
  %mul66 = fmul double %65, 1.000000e-30
  %66 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 4), align 8
...
for.cond.72:                                      ; preds = %for.inc.78, %if.end.42
...
for.end.80:                                       ; preds = %for.cond.72
  ...
  %76 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %77 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
  %mul82 = fmul double %76, %77
  store double %mul82, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 5), align 8
  %78 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 5), align 8
  %cmp83 = fcmp olt double %78, 0.000000e+00
  br i1 %cmp83, label %if.then.85, label %if.end.86

if.then.85:                                       ; preds = %for.end.80
  store double 0.000000e+00, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 5), align 8
  br label %if.end.86

if.end.86:                                        ; preds = %if.then.85, %for.end.80
...
for.cond.89:                                      ; preds = %for.inc.102, %if.end.86
  %81 = load i64, i64* %i, align 8
  %82 = load i64, i64* %m, align 8
  %cmp90 = icmp sle i64 %81, %82
  br i1 %cmp90, label %for.body.92, label %for.end.104
...
for.end.104:                                      ; preds = %for.cond.89
  ...
  %98 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %99 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
  %mul106 = fmul double %98, %99
  store double %mul106, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 6), align 8
  %100 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 6), align 8
  %101 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 5), align 8
  %sub107 = fsub double %100, %101
  %div108 = fdiv double %sub107, 7.000000e+00
  store double %div108, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 7), align 8
  ...
  %119 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 7), align 8
  %div121 = fdiv double %118, %119
  store double %div121, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 8), align 8
  %120 = load double, double* @pierr, align 8
  %mul122 = fmul double %120, 1.000000e-30
  %121 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 6), align 8
  %122 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 5), align 8
  %sub123 = fsub double %121, %122
  %mul124 = fmul double %sub123, 1.000000e-30
  %123 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 8), align 8
...
for.cond.131:                                     ; preds = %for.inc.153, %for.end.104
...
for.inc.153:                                      ; preds = %for.body.135
  %150 = load i64, i64* %i, align 8
  %inc154 = add nsw i64 %150, 1
  store i64 %inc154, i64* %i, align 8
  br label %for.cond.131

for.end.155:                                      ; preds = %for.cond.131
  %call156 = call i32 @dtime(double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i32 0))
  %151 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %152 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
  %mul157 = fmul double %151, %152
  %153 = load double, double* @nulltime, align 8
  %sub158 = fsub double %mul157, %153
  store double %sub158, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 9), align 8
  ...
  %172 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 9), align 8
  %div174 = fdiv double %172, 1.700000e+01
  store double %div174, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 10), align 8
  ...
  %181 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 10), align 8
  %div180 = fdiv double %180, %181
  store double %div180, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 11), align 8
  %182 = load double, double* @sc, align 8
  %mul181 = fmul double %182, 1.000000e-30
  %183 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 9), align 8
  %mul182 = fmul double %183, 1.000000e-30
  %184 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 11), align 8
...
for.cond.191:                                     ; preds = %for.inc.212, %for.end.155
...
for.end.214:                                      ; preds = %for.cond.191
  %call215 = call i32 @dtime(double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i32 0))
  %211 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %212 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
  %mul216 = fmul double %211, %212
  %213 = load double, double* @nulltime, align 8
  %sub217 = fsub double %mul216, %213
  store double %sub217, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 12), align 8
  ...
  %231 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 12), align 8
  %div232 = fdiv double %231, 1.500000e+01
  store double %div232, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 13), align 8
  ...
  %259 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 13), align 8
  %div254 = fdiv double %258, %259
  store double %div254, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 14), align 8
  %260 = load double, double* @sc, align 8
  %mul255 = fmul double %260, 1.000000e-30
  %261 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 12), align 8
  %mul256 = fmul double %261, 1.000000e-30
  %262 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 14), align 8
...
for.inc.298:                                      ; preds = %for.body.267
  %301 = load i64, i64* %i, align 8
  %inc299 = add nsw i64 %301, 1
  store i64 %inc299, i64* %i, align 8
  br label %for.cond.263

for.end.300:                                      ; preds = %for.cond.263
  %call301 = call i32 @dtime(double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i32 0))
  %302 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %303 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
  %mul302 = fmul double %302, %303
  %304 = load double, double* @nulltime, align 8
  %sub303 = fsub double %mul302, %304
  store double %sub303, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 15), align 8
  ...
  %338 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 15), align 8
  %div332 = fdiv double %338, 2.900000e+01
  store double %div332, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 16), align 8
  ...
  %347 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 16), align 8
  %div338 = fdiv double %346, %347
  store double %div338, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 17), align 8
  %348 = load double, double* @sc, align 8
  %mul339 = fmul double %348, 1.000000e-30
  %349 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 15), align 8
  %mul340 = fmul double %349, 1.000000e-30
  %350 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 17), align 8
...
for.inc.382:                                      ; preds = %for.body.351
  %389 = load i64, i64* %i, align 8
  %inc383 = add nsw i64 %389, 1
  store i64 %inc383, i64* %i, align 8
  br label %for.cond.347

for.end.384:                                      ; preds = %for.cond.347
  %call385 = call i32 @dtime(double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i32 0))
  %390 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %391 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
  %mul386 = fmul double %390, %391
  %392 = load double, double* @nulltime, align 8
  %sub387 = fsub double %mul386, %392
  store double %sub387, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 18), align 8
  ...
  %426 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 18), align 8
  %div416 = fdiv double %426, 2.900000e+01
  store double %div416, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 19), align 8
  ...
  %435 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 19), align 8
  %div422 = fdiv double %434, %435
  store double %div422, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 20), align 8
  %436 = load double, double* @sc, align 8
  %mul423 = fmul double %436, 1.000000e-30
  %437 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 18), align 8
  %mul424 = fmul double %437, 1.000000e-30
  %438 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 20), align 8
...
for.inc.448:                                      ; preds = %for.body.434
  %459 = load i64, i64* %i, align 8
  %inc449 = add nsw i64 %459, 1
  store i64 %inc449, i64* %i, align 8
  br label %for.cond.430

for.end.450:                                      ; preds = %for.cond.430
  %call451 = call i32 @dtime(double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i32 0))
  %460 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %461 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
  %mul452 = fmul double %460, %461
  %462 = load double, double* @nulltime, align 8
  %sub453 = fsub double %mul452, %462
  store double %sub453, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 21), align 8
  %463 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 21), align 8
  %div454 = fdiv double %463, 1.200000e+01
  store double %div454, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 22), align 8
  ...
  %487 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 22), align 8
  %div477 = fdiv double %486, %487
  store double %div477, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 23), align 8
  %488 = load double, double* @sc, align 8
  %mul478 = fmul double %488, 1.000000e-30
  %489 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 21), align 8
  %mul479 = fmul double %489, 1.000000e-30
  %490 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 23), align 8
...
for.cond.486:                                     ; preds = %for.inc.522, %for.end.450
  %494 = load i64, i64* %i, align 8
  %495 = load i64, i64* %m, align 8
  %sub487 = sub nsw i64 %495, 1
  %cmp488 = icmp sle i64 %494, %sub487
  br i1 %cmp488, label %for.body.490, label %for.end.524

for.body.490:                                     ; preds = %for.cond.486
...
for.inc.522:                                      ; preds = %for.body.490
  %530 = load i64, i64* %i, align 8
  %inc523 = add nsw i64 %530, 1
  store i64 %inc523, i64* %i, align 8
  br label %for.cond.486

for.end.524:                                      ; preds = %for.cond.486
  %call525 = call i32 @dtime(double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i32 0))
  %531 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 1), align 8
  %532 = load double, double* getelementptr inbounds ([3 x double], [3 x double]* @TimeArray, i32 0, i64 1), align 8
  %mul526 = fmul double %531, %532
  %533 = load double, double* @nulltime, align 8
  %sub527 = fsub double %mul526, %533
  store double %sub527, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 24), align 8
  ...
  %568 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 24), align 8
  %div557 = fdiv double %568, 3.000000e+01
  store double %div557, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 25), align 8
  ...
  %577 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 25), align 8
  %div563 = fdiv double %576, %577
  store double %div563, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 26), align 8
  %578 = load double, double* @sc, align 8
  %mul564 = fmul double %578, 1.000000e-30
  %579 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 24), align 8
  %mul565 = fmul double %579, 1.000000e-30
  %580 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 26), align 8
  ...
  %582 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 6), align 8
  %583 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 5), align 8
  %sub568 = fsub double %582, %583
  %mul569 = fmul double %581, %sub568
  %584 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 9), align 8
  %add570 = fadd double %mul569, %584
  %div571 = fdiv double %add570, 5.200000e+01
  store double %div571, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 27), align 8
  %585 = load double, double* @one, align 8
  %586 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 27), align 8
  %div572 = fdiv double %585, %586
  store double %div572, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 28), align 8
  %587 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 2), align 8
  %588 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 9), align 8
  %add573 = fadd double %587, %588
  %589 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 12), align 8
  %add574 = fadd double %add573, %589
  %590 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 15), align 8
  %add575 = fadd double %add574, %590
  %591 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 18), align 8
  %add576 = fadd double %add575, %591
  store double %add576, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 29), align 8
  %592 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 29), align 8
  %593 = load double, double* @four, align 8
  %594 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 21), align 8
  %mul577 = fmul double %593, %594
  %add578 = fadd double %592, %mul577
  %div579 = fdiv double %add578, 1.520000e+02
  store double %div579, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 29), align 8
  %595 = load double, double* @one, align 8
  %596 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 29), align 8
  %div580 = fdiv double %595, %596
  store double %div580, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 30), align 8
  %597 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 2), align 8
  %598 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 9), align 8
  %add581 = fadd double %597, %598
  %599 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 12), align 8
  %add582 = fadd double %add581, %599
  %600 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 15), align 8
  %add583 = fadd double %add582, %600
  %601 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 18), align 8
  %add584 = fadd double %add583, %601
  store double %add584, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 31), align 8
  %602 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 31), align 8
  %603 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 21), align 8
  %add585 = fadd double %602, %603
  %604 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 24), align 8
  %add586 = fadd double %add585, %604
  %div587 = fdiv double %add586, 1.460000e+02
  store double %div587, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 31), align 8
  %605 = load double, double* @one, align 8
  %606 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 31), align 8
  %div588 = fdiv double %605, %606
  store double %div588, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 32), align 8
  %607 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 9), align 8
  %608 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 12), align 8
  %add589 = fadd double %607, %608
  %609 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 18), align 8
  %add590 = fadd double %add589, %609
  %610 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 24), align 8
  %add591 = fadd double %add590, %610
  %div592 = fdiv double %add591, 9.100000e+01
  store double %div592, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 33), align 8
  %611 = load double, double* @one, align 8
  %612 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 33), align 8
  %div593 = fdiv double %611, %612
  store double %div593, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 34), align 8
  ...
  %615 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 28), align 8
  ...
  %616 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 30), align 8
  ...
  %617 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 32), align 8
  ...
  %618 = load double, double* getelementptr inbounds ([36 x double], [36 x double]* @T, i32 0, i64 34), align 8
