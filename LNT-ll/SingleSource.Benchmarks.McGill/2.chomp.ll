; ModuleID = './SingleSource.Benchmarks.McGill/2.chomp.bc'
...
while.body:                                       ; preds = %while.cond
  ...
  %3 = load i32*, i32** %data1.addr, align 8
  %arrayidx = getelementptr inbounds i32, i32* %3, i64 %idxprom
  %4 = load i32, i32* %arrayidx, align 4
  %5 = load i32, i32* %counter, align 4
  %idxprom1 = sext i32 %5 to i64
  %6 = load i32*, i32** %data2.addr, align 8
...
if.then:                                          ; preds = %while.body
  ...
  %9 = load i32*, i32** %data2.addr, align 8
  %arrayidx4 = getelementptr inbounds i32, i32* %9, i64 %idxprom3
  %10 = load i32, i32* %arrayidx4, align 4
  %11 = load i32, i32* %counter, align 4
  %idxprom5 = sext i32 %11 to i64
  %12 = load i32*, i32** %data1.addr, align 8
...
if.end:                                           ; preds = %if.then.15, %if.then
  ...
  br i1 %tobool17, label %if.end.25, label %land.lhs.true
...
while.body:                                       ; preds = %while.cond
  ...
  br i1 %tobool4, label %if.then, label %if.end.20
...
while.cond:                                       ; preds = %while.body, %entry
  %1 = load i32*, i32** %col.addr, align 8
  %2 = load i32, i32* %1, align 4
  %idxprom = sext i32 %2 to i64
  %3 = load i32*, i32** %data1.addr, align 8
  %arrayidx = getelementptr inbounds i32, i32* %3, i64 %idxprom
  %4 = load i32, i32* %arrayidx, align 4
  %5 = load i32*, i32** %col.addr, align 8
  %6 = load i32, i32* %5, align 4
  %idxprom1 = sext i32 %6 to i64
  %7 = load i32*, i32** %data2.addr, align 8
...
while.end:                                        ; preds = %while.cond
  ...
  %13 = load i32*, i32** %data1.addr, align 8
