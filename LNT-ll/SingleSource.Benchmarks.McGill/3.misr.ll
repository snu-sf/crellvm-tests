; ModuleID = './SingleSource.Benchmarks.McGill/3.misr.bc'
...
if.then:                                          ; preds = %entry
  ...
  %call = call i8* @strcpy(i8* %arraydecay, i8* %2) #4
  br label %if.end
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [100 x i8], [100 x i8]* %structure, i32 0, i64 %idxprom
...
for.end:                                          ; preds = %for.cond
  %arrayidx3 = getelementptr inbounds [100 x i8], [100 x i8]* %structure, i32 0, i64 0
  store i8 49, i8* %arrayidx3, align 1
  %7 = load i32, i32* @reg_len, align 4
  %idxprom4 = sext i32 %7 to i64
  %arrayidx5 = getelementptr inbounds [100 x i8], [100 x i8]* %structure, i32 0, i64 %idxprom4
...
if.then.7:                                        ; preds = %if.end
  ...
  %arrayidx9 = getelementptr inbounds [3 x i16], [3 x i16]* %seed, i32 0, i64 0
  %call10 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %10, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i16* %arrayidx9) #4
  br label %if.end.13

if.else.11:                                       ; preds = %if.end
  %arrayidx12 = getelementptr inbounds [3 x i16], [3 x i16]* %seed, i32 0, i64 0
...
if.then.15:                                       ; preds = %if.end.13
  ...
  %arrayidx17 = getelementptr inbounds [3 x i16], [3 x i16]* %seed, i32 0, i64 1
  %call18 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %13, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i16* %arrayidx17) #4
  br label %if.end.21

if.else.19:                                       ; preds = %if.end.13
  %arrayidx20 = getelementptr inbounds [3 x i16], [3 x i16]* %seed, i32 0, i64 1
...
if.then.23:                                       ; preds = %if.end.21
  ...
  %arrayidx25 = getelementptr inbounds [3 x i16], [3 x i16]* %seed, i32 0, i64 2
  %call26 = call i32 (i8*, i8*, ...) @__isoc99_sscanf(i8* %16, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str, i32 0, i32 0), i16* %arrayidx25) #4
  br label %if.end.29

if.else.27:                                       ; preds = %if.end.21
  %arrayidx28 = getelementptr inbounds [3 x i16], [3 x i16]* %seed, i32 0, i64 2
...
if.end.45:                                        ; preds = %if.end.38
  ...
  %call47 = call i16* @seed48(i16* %arraydecay46) #4
...
if.end.73:                                        ; preds = %for.end.72, %for.end.59
  ...
  %arrayidx76 = getelementptr inbounds [3 x i16], [3 x i16]* %seed, i32 0, i64 0
  %38 = load i16, i16* %arrayidx76, align 2
  %conv77 = zext i16 %38 to i32
  %arrayidx78 = getelementptr inbounds [3 x i16], [3 x i16]* %seed, i32 0, i64 1
  %39 = load i16, i16* %arrayidx78, align 2
  %conv79 = zext i16 %39 to i32
  %arrayidx80 = getelementptr inbounds [3 x i16], [3 x i16]* %seed, i32 0, i64 2
...
for.body:                                         ; preds = %for.cond
  ...
  store i32 1, i32* %f_free, align 4
...
for.body.8:                                       ; preds = %for.cond.6
  ...
  %mul = mul nsw i32 %8, 31
  %9 = load i32, i32* %j, align 4
  %add = add nsw i32 %mul, %9
  %idxprom = sext i32 %add to i64
  %10 = load i8*, i8** %structure.addr, align 8
...
if.then:                                          ; preds = %for.body.8
  ...
  %13 = load i32, i32* %f_free, align 4
...
if.end:                                           ; preds = %if.then, %for.body.8
  ...
  %20 = load i32, i32* %f_free13, align 4
  ...
  store i32 %conv16, i32* %f_free17, align 4
  %call18 = call i64 @lrand48() #4
...
for.body.41:                                      ; preds = %for.cond.38
  %38 = load i32, i32* %quot, align 4
  %mul42 = mul nsw i32 %38, 31
  %39 = load i32, i32* %j, align 4
  %add43 = add nsw i32 %mul42, %39
  %idxprom44 = sext i32 %add43 to i64
  %40 = load i8*, i8** %structure.addr, align 8
...
if.then.49:                                       ; preds = %for.body.41
  ...
  %43 = load i32, i32* %f_free50, align 4
...
if.end.54:                                        ; preds = %if.then.49, %for.body.41
  ...
  %50 = load i32, i32* %f_free56, align 4
  ...
  store i32 %conv60, i32* %f_free61, align 4
  %call62 = call i64 @lrand48() #4
...
for.end.82:                                       ; preds = %for.cond.38
  %call83 = call i64 @lrand48() #4
  store i64 %call83, i64* %randv, align 8
  %65 = load i32, i32* @reg_len, align 4
  %sub84 = sub nsw i32 %65, 1
  %idxprom85 = sext i32 %sub84 to i64
  %66 = load i8*, i8** %structure.addr, align 8
  %arrayidx86 = getelementptr inbounds i8, i8* %66, i64 %idxprom85
...
if.then.90:                                       ; preds = %for.end.82
  ...
  %69 = load i32, i32* %f_free91, align 4
...
if.end.95:                                        ; preds = %if.then.90, %for.end.82
  ...
  store i32 %conv99, i32* %f_free100, align 4
  %call101 = call i64 @lrand48() #4
...
for.body.121:                                     ; preds = %for.cond.118
  ...
  %88 = load i32, i32* %f_free122, align 4
