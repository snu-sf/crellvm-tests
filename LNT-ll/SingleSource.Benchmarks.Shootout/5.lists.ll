; ModuleID = './SingleSource.Benchmarks.Shootout/5.lists.bc'
...
if.then:                                          ; preds = %entry
  store %struct.DLL* null, %struct.DLL** %retval
  br label %return
...
if.end:                                           ; preds = %entry
  ...
  store %struct.DLL* %11, %struct.DLL** %retval
  br label %return

return:                                           ; preds = %if.end, %if.then
  %12 = load %struct.DLL*, %struct.DLL** %retval
  ret %struct.DLL* %12
}
...
for.body:                                         ; preds = %for.cond
  ...
  %13 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx = getelementptr inbounds %struct.DLL, %struct.DLL* %13, i64 %idxprom
  %14 = load i32, i32* %i, align 4
  %idxprom8 = sext i32 %14 to i64
  %15 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx9 = getelementptr inbounds %struct.DLL, %struct.DLL* %15, i64 %idxprom8
  ...
  %17 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx12 = getelementptr inbounds %struct.DLL, %struct.DLL* %17, i64 %idxprom11
  %18 = load i32, i32* %j, align 4
  %idxprom13 = sext i32 %18 to i64
  %19 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx14 = getelementptr inbounds %struct.DLL, %struct.DLL* %19, i64 %idxprom13
  ...
  %arrayidx16 = getelementptr inbounds %struct.DLL, %struct.DLL* %22, i64 %idxprom15
...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx29 = getelementptr inbounds %struct.DLL, %struct.DLL* %32, i64 %idxprom28
  %33 = load i32, i32* %size, align 4
  %idxprom30 = sext i32 %33 to i64
  %34 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx31 = getelementptr inbounds %struct.DLL, %struct.DLL* %34, i64 %idxprom30
  ...
  %37 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx34 = getelementptr inbounds %struct.DLL, %struct.DLL* %37, i64 %idxprom33
  %val35 = getelementptr inbounds %struct.DLL, %struct.DLL* %arrayidx34, i32 0, i32 0
  store i32 %35, i32* %val35, align 4
  ...
  store i32 %38, i32* %val37, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %7 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx = getelementptr inbounds %struct.DLL, %struct.DLL* %7, i64 %idxprom
  %8 = load i32, i32* %i, align 4
  %idxprom3 = sext i32 %8 to i64
  %9 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx4 = getelementptr inbounds %struct.DLL, %struct.DLL* %9, i64 %idxprom3
  %next = getelementptr inbounds %struct.DLL, %struct.DLL* %arrayidx4, i32 0, i32 1
  store %struct.DLL* %arrayidx, %struct.DLL** %next, align 8
  %10 = load i32, i32* %i, align 4
  %idxprom5 = sext i32 %10 to i64
  %11 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx6 = getelementptr inbounds %struct.DLL, %struct.DLL* %11, i64 %idxprom5
  %12 = load i32, i32* %j, align 4
  %idxprom7 = sext i32 %12 to i64
  %13 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx8 = getelementptr inbounds %struct.DLL, %struct.DLL* %13, i64 %idxprom7
  ...
  %17 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx10 = getelementptr inbounds %struct.DLL, %struct.DLL* %17, i64 %idxprom9
  %val11 = getelementptr inbounds %struct.DLL, %struct.DLL* %arrayidx10, i32 0, i32 0
  store i32 %15, i32* %val11, align 4
  br label %for.inc
...
for.end:                                          ; preds = %for.cond
  ...
  %23 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx15 = getelementptr inbounds %struct.DLL, %struct.DLL* %23, i64 %idxprom14
  ...
  %27 = load %struct.DLL*, %struct.DLL** %l, align 8
  %arrayidx20 = getelementptr inbounds %struct.DLL, %struct.DLL* %27, i64 %idxprom19
...
while.cond.13:                                    ; preds = %while.body.17, %if.end.12
  ...
  br i1 %lnot16, label %while.body.17, label %while.end.19
...
if.end.24:                                        ; preds = %while.end.19
  ...
  br i1 %cmp, label %if.then.26, label %if.end.30
