; ModuleID = './SingleSource.Benchmarks.Shootout/1.hash.bc'
...
while.cond:                                       ; preds = %while.body, %entry
  ...
  %arrayidx = getelementptr inbounds [28 x i64], [28 x i64]* @ht_prime_list, i32 0, i64 %idxprom
...
while.end:                                        ; preds = %while.cond
  ...
  %arrayidx3 = getelementptr inbounds [28 x i64], [28 x i64]* @ht_prime_list, i32 0, i64 %idxprom2
  ...
  store i32 %conv4, i32* %size5, align 4
  ...
  store i32 0, i32* %iter_index, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %4 = load %struct.ht_ht*, %struct.ht_ht** %ht.addr, align 8
  %tbl = getelementptr inbounds %struct.ht_ht, %struct.ht_ht* %4, i32 0, i32 1
  %5 = load %struct.ht_node**, %struct.ht_node*** %tbl, align 8
  %arrayidx = getelementptr inbounds %struct.ht_node*, %struct.ht_node** %5, i64 %idxprom
...
entry:
  ...
  %2 = load i32, i32* %hash_code, align 4
...
if.then:                                          ; preds = %while.body
  ...
  store %struct.ht_node* %10, %struct.ht_node** %retval
  br label %return
...
while.end:                                        ; preds = %while.cond
  ...
  %inc = add nsw i32 %15, 1
  store i32 %inc, i32* %items, align 4
...
if.then.4:                                        ; preds = %while.end
  ...
  store %struct.ht_node* %call5, %struct.ht_node** %retval
  br label %return

if.else:                                          ; preds = %while.end
  %19 = load i8*, i8** %key.addr, align 8
  %call7 = call %struct.ht_node* @ht_node_create(i8* %19)
  %20 = load i32, i32* %hash_code, align 4
  %idxprom8 = sext i32 %20 to i64
  %21 = load %struct.ht_ht*, %struct.ht_ht** %ht.addr, align 8
  %tbl9 = getelementptr inbounds %struct.ht_ht, %struct.ht_ht* %21, i32 0, i32 1
  %22 = load %struct.ht_node**, %struct.ht_node*** %tbl9, align 8
  %arrayidx10 = getelementptr inbounds %struct.ht_node*, %struct.ht_node** %22, i64 %idxprom8
  store %struct.ht_node* %call7, %struct.ht_node** %arrayidx10, align 8
  store %struct.ht_node* %call7, %struct.ht_node** %retval
  br label %return

return:                                           ; preds = %if.else, %if.then.4, %if.then
  %23 = load %struct.ht_node*, %struct.ht_node** %retval
...
while.end:                                        ; preds = %while.cond
  store %struct.ht_node* null, %struct.ht_node** %retval
  br label %return

return:                                           ; preds = %while.end, %if.then
  %13 = load %struct.ht_node*, %struct.ht_node** %retval
