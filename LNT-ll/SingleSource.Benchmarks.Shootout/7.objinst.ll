; ModuleID = './SingleSource.Benchmarks.Shootout/7.objinst.bc'
...
entry:
  ...
  store i8 %conv, i8* %state1, align 1
...
entry:
  ...
  %3 = load i32, i32* %count_max, align 4
...
if.then:                                          ; preds = %entry
  ...
  store i8 %conv, i8* %state2, align 1
