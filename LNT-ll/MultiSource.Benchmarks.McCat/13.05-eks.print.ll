; ModuleID = './MultiSource.Benchmarks.McCat/13.05-eks.print.bc'
...
for.body:                                         ; preds = %for.cond
  ...
  call void @printVector(double* %3)
  br label %for.inc
...
for.body:                                         ; preds = %for.cond
  ...
  %arrayidx = getelementptr inbounds double, double* %2, i64 %idxprom
  %3 = load double, double* %arrayidx, align 8
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), double %3)
  br label %for.inc
