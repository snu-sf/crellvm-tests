; ModuleID = './SingleSource.Benchmarks.CoyoteBench/3.almabench.bc'
...
entry:
  ...
  %arrayidx2 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @a, i32 0, i64 %idxprom
  %arrayidx3 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx2, i32 0, i64 0
  %5 = load double, double* %arrayidx3, align 8
  %6 = load i32, i32* %np.addr, align 4
  %idxprom4 = sext i32 %6 to i64
  %arrayidx5 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @a, i32 0, i64 %idxprom4
  ...
  %arrayidx8 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @a, i32 0, i64 %idxprom7
  ...
  %arrayidx14 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @dlm, i32 0, i64 %idxprom13
  ...
  %arrayidx18 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @dlm, i32 0, i64 %idxprom17
  ...
  %arrayidx21 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @dlm, i32 0, i64 %idxprom20
  ...
  %arrayidx29 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @e, i32 0, i64 %idxprom28
  ...
  %arrayidx32 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @e, i32 0, i64 %idxprom31
  %arrayidx33 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx32, i32 0, i64 1
  %23 = load double, double* %arrayidx33, align 8
  %24 = load i32, i32* %np.addr, align 4
  %idxprom34 = sext i32 %24 to i64
  %arrayidx35 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @e, i32 0, i64 %idxprom34
  ...
  %arrayidx42 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @pi, i32 0, i64 %idxprom41
  ...
  %arrayidx46 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @pi, i32 0, i64 %idxprom45
  %arrayidx47 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx46, i32 0, i64 1
  %31 = load double, double* %arrayidx47, align 8
  %32 = load i32, i32* %np.addr, align 4
  %idxprom48 = sext i32 %32 to i64
  %arrayidx49 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @pi, i32 0, i64 %idxprom48
  ...
  %arrayidx57 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @dinc, i32 0, i64 %idxprom56
  ...
  %arrayidx61 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @dinc, i32 0, i64 %idxprom60
  ...
  %arrayidx64 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @dinc, i32 0, i64 %idxprom63
  %arrayidx65 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx64, i32 0, i64 2
  ...
  %arrayidx72 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @omega, i32 0, i64 %idxprom71
  ...
  %arrayidx76 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @omega, i32 0, i64 %idxprom75
  ...
  %arrayidx79 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* @omega, i32 0, i64 %idxprom78
...
for.body:                                         ; preds = %for.cond
  ...
  %55 = load i32, i32* %np.addr, align 4
  %idxprom89 = sext i32 %55 to i64
  %arrayidx90 = getelementptr inbounds [8 x [9 x double]], [8 x [9 x double]]* @kp, i32 0, i64 %idxprom89
  %arrayidx91 = getelementptr inbounds [9 x double], [9 x double]* %arrayidx90, i32 0, i64 %idxprom88
  ...
  %59 = load i32, i32* %np.addr, align 4
  %idxprom94 = sext i32 %59 to i64
  %arrayidx95 = getelementptr inbounds [8 x [10 x double]], [8 x [10 x double]]* @kq, i32 0, i64 %idxprom94
  %arrayidx96 = getelementptr inbounds [10 x double], [10 x double]* %arrayidx95, i32 0, i64 %idxprom93
  ...
  %64 = load i32, i32* %np.addr, align 4
  %idxprom99 = sext i32 %64 to i64
  %arrayidx100 = getelementptr inbounds [8 x [9 x double]], [8 x [9 x double]]* @ca, i32 0, i64 %idxprom99
  %arrayidx101 = getelementptr inbounds [9 x double], [9 x double]* %arrayidx100, i32 0, i64 %idxprom98
  ...
  %68 = load i32, i32* %np.addr, align 4
  %idxprom105 = sext i32 %68 to i64
  %arrayidx106 = getelementptr inbounds [8 x [9 x double]], [8 x [9 x double]]* @sa, i32 0, i64 %idxprom105
  %arrayidx107 = getelementptr inbounds [9 x double], [9 x double]* %arrayidx106, i32 0, i64 %idxprom104
  ...
  %arrayidx115 = getelementptr inbounds [8 x [10 x double]], [8 x [10 x double]]* @cl, i32 0, i64 %idxprom114
  %arrayidx116 = getelementptr inbounds [10 x double], [10 x double]* %arrayidx115, i32 0, i64 %idxprom113
  ...
  %77 = load i32, i32* %np.addr, align 4
  %idxprom120 = sext i32 %77 to i64
  %arrayidx121 = getelementptr inbounds [8 x [10 x double]], [8 x [10 x double]]* @sl, i32 0, i64 %idxprom120
  %arrayidx122 = getelementptr inbounds [10 x double], [10 x double]* %arrayidx121, i32 0, i64 %idxprom119
...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx129 = getelementptr inbounds [8 x [9 x double]], [8 x [9 x double]]* @kp, i32 0, i64 %idxprom128
  %arrayidx130 = getelementptr inbounds [9 x double], [9 x double]* %arrayidx129, i32 0, i64 8
  ...
  %arrayidx133 = getelementptr inbounds [8 x [9 x double]], [8 x [9 x double]]* @ca, i32 0, i64 %idxprom132
  %arrayidx134 = getelementptr inbounds [9 x double], [9 x double]* %arrayidx133, i32 0, i64 8
  ...
  %arrayidx138 = getelementptr inbounds [8 x [9 x double]], [8 x [9 x double]]* @sa, i32 0, i64 %idxprom137
  %arrayidx139 = getelementptr inbounds [9 x double], [9 x double]* %arrayidx138, i32 0, i64 8
...
for.cond.146:                                     ; preds = %for.inc.170, %for.end
  ...
  br i1 %cmp147, label %for.body.148, label %for.end.172

for.body.148:                                     ; preds = %for.cond.146
  %93 = load i32, i32* %k, align 4
  %idxprom149 = sext i32 %93 to i64
  %94 = load i32, i32* %np.addr, align 4
  %idxprom150 = sext i32 %94 to i64
  %arrayidx151 = getelementptr inbounds [8 x [10 x double]], [8 x [10 x double]]* @kq, i32 0, i64 %idxprom150
  %arrayidx152 = getelementptr inbounds [10 x double], [10 x double]* %arrayidx151, i32 0, i64 %idxprom149
  ...
  %100 = load i32, i32* %np.addr, align 4
  %idxprom155 = sext i32 %100 to i64
  %arrayidx156 = getelementptr inbounds [8 x [10 x double]], [8 x [10 x double]]* @cl, i32 0, i64 %idxprom155
  %arrayidx157 = getelementptr inbounds [10 x double], [10 x double]* %arrayidx156, i32 0, i64 %idxprom154
  ...
  %104 = load i32, i32* %np.addr, align 4
  %idxprom161 = sext i32 %104 to i64
  %arrayidx162 = getelementptr inbounds [8 x [10 x double]], [8 x [10 x double]]* @sl, i32 0, i64 %idxprom161
  %arrayidx163 = getelementptr inbounds [10 x double], [10 x double]* %arrayidx162, i32 0, i64 %idxprom160
...
while.end:                                        ; preds = %if.then
  ...
  %arrayidx206 = getelementptr inbounds [8 x double], [8 x double]* @amas, i32 0, i64 %idxprom205
  ...
  %arrayidx253 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx252, i32 0, i64 0
  ...
  %arrayidx258 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx257, i32 0, i64 1
  ...
  %arrayidx263 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx262, i32 0, i64 2
  ...
  %arrayidx285 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx284, i32 0, i64 0
  ...
  %arrayidx290 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx289, i32 0, i64 1
  ...
  %arrayidx295 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx294, i32 0, i64 2
...
entry:
  ...
  %arrayidx19 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx18, i32 0, i64 0
...
for.cond.4:                                       ; preds = %for.inc.26, %if.end.3
  ...
  br i1 %cmp5, label %for.body.6, label %for.end.28

for.body.6:                                       ; preds = %for.cond.4
  %arrayidx7 = getelementptr inbounds [2 x double], [2 x double]* %jd, i32 0, i64 0
  store double 2.451545e+06, double* %arrayidx7, align 8
  %arrayidx8 = getelementptr inbounds [2 x double], [2 x double]* %jd, i32 0, i64 1
...
for.body.11:                                      ; preds = %for.cond.9
  %arrayidx12 = getelementptr inbounds [2 x double], [2 x double]* %jd, i32 0, i64 0
...
for.body.15:                                      ; preds = %for.cond.13
  ...
  %arrayidx18 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* %position, i32 0, i64 %idxprom
...
for.cond.29:                                      ; preds = %for.inc.42, %for.end.28
  ...
  br i1 %cmp30, label %for.body.31, label %for.end.44

for.body.31:                                      ; preds = %for.cond.29
  %16 = load i32, i32* %p, align 4
  %idxprom32 = sext i32 %16 to i64
  %arrayidx33 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* %position, i32 0, i64 %idxprom32
  ...
  %arrayidx36 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* %position, i32 0, i64 %idxprom35
  ...
  %arrayidx39 = getelementptr inbounds [8 x [3 x double]], [8 x [3 x double]]* %position, i32 0, i64 %idxprom38
  %arrayidx40 = getelementptr inbounds [3 x double], [3 x double]* %arrayidx39, i32 0, i64 2
