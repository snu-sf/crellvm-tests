; ModuleID = './SingleSource.Benchmarks.Dhrystone/1.fldry.bc'
...
for.end:                                          ; preds = %for.cond
  ...
  store double 1.000000e+01, double* getelementptr inbounds ([51 x [51 x double]], [51 x [51 x double]]* @Array2Glob, i32 0, i64 8, i64 7), align 8
...
entry:
  ...
  %8 = load double*, double** %Array1Par.addr, align 8
  ...
  %10 = load double, double* %IntLoc, align 8
  %conv8 = fptosi double %10 to i32
  %add9 = add nsw i32 %conv8, 30
  %idxprom10 = sext i32 %add9 to i64
  %11 = load double*, double** %Array1Par.addr, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %16 = load double, double* %IntIndex, align 8
  %conv14 = fptosi double %16 to i32
  %idxprom15 = sext i32 %conv14 to i64
  %17 = load double, double* %IntLoc, align 8
  %conv16 = fptosi double %17 to i32
  %idxprom17 = sext i32 %conv16 to i64
  %18 = load [51 x double]*, [51 x double]** %Array2Par.addr, align 8
  %arrayidx18 = getelementptr inbounds [51 x double], [51 x double]* %18, i64 %idxprom17
  %arrayidx19 = getelementptr inbounds [51 x double], [51 x double]* %arrayidx18, i32 0, i64 %idxprom15
...
for.end:                                          ; preds = %for.cond
  %20 = load double, double* %IntLoc, align 8
  %conv20 = fptosi double %20 to i32
  %sub = sub nsw i32 %conv20, 1
  %idxprom21 = sext i32 %sub to i64
  %21 = load double, double* %IntLoc, align 8
  %conv22 = fptosi double %21 to i32
  %idxprom23 = sext i32 %conv22 to i64
  %22 = load [51 x double]*, [51 x double]** %Array2Par.addr, align 8
  %arrayidx24 = getelementptr inbounds [51 x double], [51 x double]* %22, i64 %idxprom23
  %arrayidx25 = getelementptr inbounds [51 x double], [51 x double]* %arrayidx24, i32 0, i64 %idxprom21
  %23 = load double, double* %arrayidx25, align 8
  %inc26 = fadd double %23, 1.000000e+00
  store double %inc26, double* %arrayidx25, align 8
  %24 = load double, double* %IntLoc, align 8
  %conv27 = fptosi double %24 to i32
  %idxprom28 = sext i32 %conv27 to i64
  %25 = load double*, double** %Array1Par.addr, align 8
  %arrayidx29 = getelementptr inbounds double, double* %25, i64 %idxprom28
  %26 = load double, double* %arrayidx29, align 8
  %27 = load double, double* %IntLoc, align 8
  %conv30 = fptosi double %27 to i32
  %idxprom31 = sext i32 %conv30 to i64
  %28 = load double, double* %IntLoc, align 8
  %conv32 = fptosi double %28 to i32
  %add33 = add nsw i32 %conv32, 20
  %idxprom34 = sext i32 %add33 to i64
  %29 = load [51 x double]*, [51 x double]** %Array2Par.addr, align 8
  %arrayidx35 = getelementptr inbounds [51 x double], [51 x double]* %29, i64 %idxprom34
  %arrayidx36 = getelementptr inbounds [51 x double], [51 x double]* %arrayidx35, i32 0, i64 %idxprom31
...
while.body:                                       ; preds = %while.cond
  %1 = load double, double* %IntLoc, align 8
  %conv = fptosi double %1 to i32
  %idxprom = sext i32 %conv to i64
  %2 = load i8*, i8** %StrParI1.addr, align 8
  ...
  %5 = load i8*, i8** %StrParI2.addr, align 8
