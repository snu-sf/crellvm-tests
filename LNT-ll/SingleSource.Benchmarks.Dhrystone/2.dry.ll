; ModuleID = './SingleSource.Benchmarks.Dhrystone/2.dry.bc'
...
for.end:                                          ; preds = %for.cond
  ...
  store i32 10, i32* getelementptr inbounds ([51 x [51 x i32]], [51 x [51 x i32]]* @Array2Glob, i32 0, i64 8, i64 7), align 4
...
entry:
  ...
  %2 = load i32, i32* %IntComp1, align 4
  ...
  store i32 %2, i32* %IntComp2, align 4
...
for.body:                                         ; preds = %for.cond
  ...
  %16 = load i32, i32* %IntIndex, align 4
  %idxprom10 = sext i32 %16 to i64
  %17 = load i32, i32* %IntLoc, align 4
  %idxprom11 = sext i32 %17 to i64
  %18 = load [51 x i32]*, [51 x i32]** %Array2Par.addr, align 8
  %arrayidx12 = getelementptr inbounds [51 x i32], [51 x i32]* %18, i64 %idxprom11
  %arrayidx13 = getelementptr inbounds [51 x i32], [51 x i32]* %arrayidx12, i32 0, i64 %idxprom10
...
for.end:                                          ; preds = %for.cond
  %20 = load i32, i32* %IntLoc, align 4
  %sub = sub nsw i32 %20, 1
  %idxprom14 = sext i32 %sub to i64
  %21 = load i32, i32* %IntLoc, align 4
  %idxprom15 = sext i32 %21 to i64
  %22 = load [51 x i32]*, [51 x i32]** %Array2Par.addr, align 8
  %arrayidx16 = getelementptr inbounds [51 x i32], [51 x i32]* %22, i64 %idxprom15
  %arrayidx17 = getelementptr inbounds [51 x i32], [51 x i32]* %arrayidx16, i32 0, i64 %idxprom14
  %23 = load i32, i32* %arrayidx17, align 4
  %inc18 = add nsw i32 %23, 1
  store i32 %inc18, i32* %arrayidx17, align 4
  %24 = load i32, i32* %IntLoc, align 4
  %idxprom19 = sext i32 %24 to i64
  %25 = load i32*, i32** %Array1Par.addr, align 8
  %arrayidx20 = getelementptr inbounds i32, i32* %25, i64 %idxprom19
  %26 = load i32, i32* %arrayidx20, align 4
  %27 = load i32, i32* %IntLoc, align 4
  %idxprom21 = sext i32 %27 to i64
  %28 = load i32, i32* %IntLoc, align 4
  %add22 = add nsw i32 %28, 20
  %idxprom23 = sext i32 %add22 to i64
  %29 = load [51 x i32]*, [51 x i32]** %Array2Par.addr, align 8
  %arrayidx24 = getelementptr inbounds [51 x i32], [51 x i32]* %29, i64 %idxprom23
  %arrayidx25 = getelementptr inbounds [51 x i32], [51 x i32]* %arrayidx24, i32 0, i64 %idxprom21
