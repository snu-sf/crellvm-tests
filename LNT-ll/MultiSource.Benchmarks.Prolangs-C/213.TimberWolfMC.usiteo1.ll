; ModuleID = './MultiSource.Benchmarks.Prolangs-C/213.TimberWolfMC.usiteo1.bc'
...
define i32 @usiteo1(i32 %a, i32 %xb, i32 %yb, i32 %newaor) #0 {
entry:
  ...
  %anewtileptr = alloca %struct.tilebox*, align 8
  ...
  store %struct.tilebox* %9, %struct.tilebox** %anewtileptr, align 8
  %10 = load %struct.tilebox*, %struct.tilebox** %anewtileptr, align 8
  %termptr = getelementptr inbounds %struct.tilebox, %struct.tilebox* %10, i32 0, i32 17
  %11 = load %struct.termbox*, %struct.termbox** %termptr, align 8
  store %struct.termbox* %11, %struct.termbox** %anewtermptr, align 8
  %12 = load i32, i32* @penalty, align 4
  store i32 %12, i32* %newpenalty, align 4
  %13 = load i32 (...)*, i32 (...)** @overlap, align 8
  %14 = load i32, i32* %a.addr, align 4
  %15 = load i32, i32* %axcenter, align 4
  %16 = load i32, i32* %aycenter, align 4
  %17 = load %struct.cellbox*, %struct.cellbox** %acellptr, align 8
  %orient = getelementptr inbounds %struct.cellbox, %struct.cellbox* %17, i32 0, i32 5
  %18 = load i32, i32* %orient, align 4
  %callee.knr.cast = bitcast i32 (...)* %13 to i32 (i32, i32, i32, i32, i32, i32, i32, ...)*
  %call = call i32 (i32, i32, i32, i32, i32, i32, i32, ...) %callee.knr.cast(i32 %14, i32 %15, i32 %16, i32 %18, i32 0, i32 1, i32 0)
  %19 = load i32, i32* %newpenalty, align 4
  %sub = sub nsw i32 %19, %call
  store i32 %sub, i32* %newpenalty, align 4
  %20 = load i32, i32* @binY, align 4
  %idxprom3 = sext i32 %20 to i64
  %21 = load i32, i32* @binX, align 4
  %idxprom4 = sext i32 %21 to i64
  %22 = load i32***, i32**** @blockarray, align 8
  %arrayidx5 = getelementptr inbounds i32**, i32*** %22, i64 %idxprom4
  %23 = load i32**, i32*** %arrayidx5, align 8
  %arrayidx6 = getelementptr inbounds i32*, i32** %23, i64 %idxprom3
  %24 = load i32*, i32** %arrayidx6, align 8
  store i32* %24, i32** @occa1ptr, align 8
  %25 = load i32 (...)*, i32 (...)** @overlap, align 8
  %26 = load i32, i32* %a.addr, align 4
  %27 = load i32, i32* %xb.addr, align 4
  %28 = load i32, i32* %yb.addr, align 4
  %29 = load i32, i32* %newaor.addr, align 4
  %callee.knr.cast7 = bitcast i32 (...)* %25 to i32 (i32, i32, i32, i32, i32, i32, i32, ...)*
  %call8 = call i32 (i32, i32, i32, i32, i32, i32, i32, ...) %callee.knr.cast7(i32 %26, i32 %27, i32 %28, i32 %29, i32 0, i32 1, i32 0)
  %30 = load i32, i32* %newpenalty, align 4
  %add = add nsw i32 %30, %call8
  store i32 %add, i32* %newpenalty, align 4
  %31 = load i32, i32* @binY, align 4
  %idxprom9 = sext i32 %31 to i64
  %32 = load i32, i32* @binX, align 4
  %idxprom10 = sext i32 %32 to i64
  %33 = load i32***, i32**** @blockarray, align 8
  %arrayidx11 = getelementptr inbounds i32**, i32*** %33, i64 %idxprom10
  %34 = load i32**, i32*** %arrayidx11, align 8
  %arrayidx12 = getelementptr inbounds i32*, i32** %34, i64 %idxprom9
  %35 = load i32*, i32** %arrayidx12, align 8
  store i32* %35, i32** @occa2ptr, align 8
  %36 = load %struct.termbox*, %struct.termbox** %anewtermptr, align 8
  %37 = load i32, i32* %xb.addr, align 4
  %38 = load i32, i32* %yb.addr, align 4
  call void @ufixpin(%struct.termbox* %36, i32 0, i32 %37, i32 %38)
  %39 = load %struct.cellbox*, %struct.cellbox** %acellptr, align 8
  %40 = load i32, i32* %xb.addr, align 4
  %41 = load i32, i32* %yb.addr, align 4
  %42 = load i32, i32* %newaor.addr, align 4
  call void @usoftpin(%struct.cellbox* %39, i32 0, i32 %40, i32 %41, i32 %42)
  %43 = load i32, i32* @funccost, align 4
  store i32 %43, i32* %cost, align 4
  %44 = load %struct.termbox*, %struct.termbox** %anewtermptr, align 8
  %call13 = call i32 @ufixnet(%struct.termbox* %44)
  %45 = load i32, i32* %cost, align 4
  %add14 = add nsw i32 %45, %call13
  store i32 %add14, i32* %cost, align 4
  %46 = load %struct.cellbox*, %struct.cellbox** %acellptr, align 8
  %call15 = call i32 @usoftnet(%struct.cellbox* %46)
  %47 = load i32, i32* %cost, align 4
  %add16 = add nsw i32 %47, %call15
  store i32 %add16, i32* %cost, align 4
  %48 = load i32, i32* %cost, align 4
  %49 = load i32, i32* %newpenalty, align 4
  %add17 = add nsw i32 %48, %49
...
lor.lhs.false:                                    ; preds = %entry
  %52 = load i32, i32* @funccost, align 4
  %53 = load i32, i32* @penalty, align 4
  %add19 = add nsw i32 %52, %53
  %54 = load i32, i32* %cost, align 4
  %sub20 = sub nsw i32 %add19, %54
  %55 = load i32, i32* %newpenalty, align 4
  %sub21 = sub nsw i32 %sub20, %55
  %conv = sitofp i32 %sub21 to double
  %56 = load double, double* @T, align 8
  %div = fdiv double %conv, %56
  %call22 = call double @exp(double %div) #3
  %57 = load i32, i32* @randVar, align 4
  %mul = mul nsw i32 %57, 1103515245
...
if.then:                                          ; preds = %lor.lhs.false, %entry
  %58 = load %struct.termbox*, %struct.termbox** %anewtermptr, align 8
  call void @ufixpin(%struct.termbox* %58, i32 1, i32 0, i32 0)
  %59 = load %struct.cellbox*, %struct.cellbox** %acellptr, align 8
  call void @usoftpin(%struct.cellbox* %59, i32 1, i32 0, i32 0, i32 0)
  %60 = load i32*, i32** @occa1ptr, align 8
  %61 = load i32*, i32** @occa2ptr, align 8
  %cmp28 = icmp ne i32* %60, %61
...
for.cond:                                         ; preds = %for.inc, %if.then.30
  ...
  %63 = load i32*, i32** @occa1ptr, align 8
  %arrayidx32 = getelementptr inbounds i32, i32* %63, i64 %idxprom31
  %64 = load i32, i32* %arrayidx32, align 4
  %65 = load i32, i32* %a.addr, align 4
  %cmp33 = icmp ne i32 %64, %65
...
for.end:                                          ; preds = %for.cond
  %67 = load i32*, i32** @occa1ptr, align 8
  %arrayidx35 = getelementptr inbounds i32, i32* %67, i64 0
  ...
  %arrayidx37 = getelementptr inbounds i32, i32* %69, i64 %idxprom36
  ...
  %74 = load i32*, i32** @occa2ptr, align 8
  %arrayidx40 = getelementptr inbounds i32, i32* %74, i64 0
  ...
  %76 = load i32*, i32** @occa2ptr, align 8
  %arrayidx43 = getelementptr inbounds i32, i32* %76, i64 %idxprom42
...
if.end:                                           ; preds = %for.end, %if.then
  ...
  %xcenter44 = getelementptr inbounds %struct.cellbox, %struct.cellbox* %78, i32 0, i32 2
  store i32 %77, i32* %xcenter44, align 4
  %79 = load i32, i32* %yb.addr, align 4
  %80 = load %struct.cellbox*, %struct.cellbox** %acellptr, align 8
  %ycenter45 = getelementptr inbounds %struct.cellbox, %struct.cellbox* %80, i32 0, i32 3
  store i32 %79, i32* %ycenter45, align 4
  %81 = load i32, i32* %newaor.addr, align 4
  %82 = load %struct.cellbox*, %struct.cellbox** %acellptr, align 8
  %orient46 = getelementptr inbounds %struct.cellbox, %struct.cellbox* %82, i32 0, i32 5
  store i32 %81, i32* %orient46, align 4
  %83 = load i32, i32* %cost, align 4
  store i32 %83, i32* @funccost, align 4
  %84 = load i32, i32* %newpenalty, align 4
  store i32 %84, i32* @penalty, align 4
