; ModuleID = './MultiSource.Benchmarks.Prolangs-C/43.gnugo.countlib.bc'
...
define void @countlib(i32 %m, i32 %n, i32 %color) #0 {
entry:
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds [19 x [19 x i8]], [19 x [19 x i8]]* @ml, i32 0, i64 %idxprom4
...
for.end.8:                                        ; preds = %for.cond
  ...
  call void @count(i32 %6, i32 %7, i32 %8)
  ret void
}

declare void @count(i32, i32, i32) #1
