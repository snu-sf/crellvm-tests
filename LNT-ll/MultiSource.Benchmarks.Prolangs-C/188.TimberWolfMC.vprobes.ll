; ModuleID = './MultiSource.Benchmarks.Prolangs-C/188.TimberWolfMC.vprobes.bc'
...
@.str = private unnamed_addr constant [12 x i8] c"vprobe:%d  \00", align 1
...
@.str.2 = private unnamed_addr constant [46 x i8] c"vprobe:%d  start:%d  end:%d  loc:%d  UorR:%d\0A\00", align 1

; Function Attrs: nounwind uwtable
define void @vprobes() #0 {
entry:
  %ritePtr = alloca %struct.dlink1*, align 8
  %left1ptr = alloca %struct.dlink1*, align 8
  %left2ptr = alloca %struct.dlink1*, align 8
  ...
  %redge = alloca i32, align 4
  %dx1 = alloca i32, align 4
  %dx2 = alloca i32, align 4
  %ledge = alloca i32, align 4
  %edge = alloca i32, align 4
  %check = alloca i32, align 4
  %l1x2 = alloca i32, align 4
  %l1x1 = alloca i32, align 4
  %l1y = alloca i32, align 4
  %l2x2 = alloca i32, align 4
  %l2x1 = alloca i32, align 4
  %l2y = alloca i32, align 4
  %0 = load %struct.dlink1*, %struct.dlink1** @hFixedList, align 8
  store %struct.dlink1* %0, %struct.dlink1** %ritePtr, align 8
  br label %for.cond

for.cond:                                         ; preds = %for.inc.515, %entry
  %1 = load %struct.dlink1*, %struct.dlink1** %ritePtr, align 8
  %cmp = icmp ne %struct.dlink1* %1, null
  br i1 %cmp, label %for.body, label %for.end.517

for.body:                                         ; preds = %for.cond
  %2 = load %struct.dlink1*, %struct.dlink1** %ritePtr, align 8
  %edge1 = getelementptr inbounds %struct.dlink1, %struct.dlink1* %2, i32 0, i32 0
  %3 = load i32, i32* %edge1, align 4
  store i32 %3, i32* %redge, align 4
  %4 = load i32, i32* %redge, align 4
...
if.end:                                           ; preds = %for.body
  ...
  store i32 %9, i32* %ry, align 4
  %10 = load i32, i32* %redge, align 4
  ...
  store i32 %12, i32* %rx1, align 4
  %13 = load i32, i32* %redge, align 4
  ...
  store i32 %15, i32* %rx2, align 4
  %16 = load i32, i32* %redge, align 4
...
if.then.15:                                       ; preds = %if.end
  %21 = load %struct.tnode*, %struct.tnode** @Hroot, align 8
  %22 = load i32, i32* %ry, align 4
  %call = call i32 @tprop(%struct.tnode* %21, i32 %22)
  %idxprom16 = sext i32 %call to i64
  %23 = load %struct.dlink1**, %struct.dlink1*** @Hptrs, align 8
...
if.end.27:                                        ; preds = %for.body.20
  ...
  store i32 %33, i32* %l1y, align 4
  %34 = load i32, i32* %ledge, align 4
  ...
  store i32 %36, i32* %l1x1, align 4
  %37 = load i32, i32* %ledge, align 4
  ...
  store i32 %39, i32* %l1x2, align 4
  %40 = load i32, i32* %l1x2, align 4
  %41 = load i32, i32* %rx1, align 4
  %cmp37 = icmp sle i32 %40, %41
  br i1 %cmp37, label %if.then.39, label %lor.lhs.false

lor.lhs.false:                                    ; preds = %if.end.27
  %42 = load i32, i32* %l1x1, align 4
  %43 = load i32, i32* %rx1, align 4
...
if.else:                                          ; preds = %if.end
  store %struct.dlink1* null, %struct.dlink1** %left1ptr, align 8
  br label %if.end.41

if.end.41:                                        ; preds = %if.else, %for.end
  %46 = load i32, i32* %redge, align 4
...
if.end.61:                                        ; preds = %for.body.54
  ...
  store i32 %63, i32* %l2y, align 4
  %64 = load i32, i32* %ledge, align 4
  ...
  store i32 %66, i32* %l2x1, align 4
  %67 = load i32, i32* %ledge, align 4
  ...
  store i32 %69, i32* %l2x2, align 4
  %70 = load i32, i32* %l2x2, align 4
  %71 = load i32, i32* %rx2, align 4
  %cmp71 = icmp slt i32 %70, %71
  br i1 %cmp71, label %if.then.74, label %lor.lhs.false.72

lor.lhs.false.72:                                 ; preds = %if.end.61
  %72 = load i32, i32* %l2x1, align 4
  %73 = load i32, i32* %rx2, align 4
...
for.inc.76:                                       ; preds = %if.then.74, %if.then.60
  %74 = load %struct.dlink1*, %struct.dlink1** %left2ptr, align 8
  ...
  store %struct.dlink1* %75, %struct.dlink1** %left2ptr, align 8
  br label %for.cond.52
...
if.else.79:                                       ; preds = %if.end.41
  store %struct.dlink1* null, %struct.dlink1** %left2ptr, align 8
  br label %if.end.80

if.end.80:                                        ; preds = %if.else.79, %for.end.78
  %76 = load %struct.dlink1*, %struct.dlink1** %left1ptr, align 8
  %cmp81 = icmp ne %struct.dlink1* %76, null
  br i1 %cmp81, label %land.lhs.true, label %if.end.183

land.lhs.true:                                    ; preds = %if.end.80
  %77 = load %struct.dlink1*, %struct.dlink1** %left1ptr, align 8
  %78 = load %struct.dlink1*, %struct.dlink1** %left2ptr, align 8
...
if.then.83:                                       ; preds = %land.lhs.true
  ...
  %79 = load %struct.tnode*, %struct.tnode** @Hroot, align 8
  %80 = load i32, i32* %ry, align 4
  %call84 = call i32 @tprop(%struct.tnode* %79, i32 %80)
  %idxprom85 = sext i32 %call84 to i64
  %81 = load %struct.dlink1**, %struct.dlink1*** @Hptrs, align 8
...
if.then.120:                                      ; preds = %for.end.119
  ...
  %118 = load i32, i32* %l2y, align 4
  %119 = load i32, i32* %ry, align 4
  ...
  %138 = load i32, i32* %ry, align 4
  %139 = load i32, i32* %l2y, align 4
  %140 = load i32, i32* %rx1, align 4
  ...
  %153 = load i32, i32* %l2y, align 4
  %154 = load i32, i32* %ry, align 4
  ...
  %173 = load i32, i32* %ry, align 4
  %174 = load i32, i32* %l2y, align 4
  %175 = load i32, i32* %rx2, align 4
...
if.else.181:                                      ; preds = %for.end.119
  %176 = load %struct.dlink1*, %struct.dlink1** %ritePtr, align 8
  call void @doubleDown(%struct.dlink1* %176)
  br label %if.end.182
...
if.end.183:                                       ; preds = %land.lhs.true, %if.end.80
  %177 = load %struct.dlink1*, %struct.dlink1** %left1ptr, align 8
...
land.lhs.true.185:                                ; preds = %if.end.183
  %178 = load %struct.dlink1*, %struct.dlink1** %left1ptr, align 8
...
if.then.194:                                      ; preds = %land.lhs.true.185
  %184 = load %struct.tnode*, %struct.tnode** @Hroot, align 8
  %185 = load i32, i32* %l1y, align 4
  %call195 = call i32 @tprop(%struct.tnode* %184, i32 %185)
  %idxprom196 = sext i32 %call195 to i64
  %186 = load %struct.dlink1**, %struct.dlink1*** @Hptrs, align 8
...
if.then.213:                                      ; preds = %for.end.211
  %199 = load %struct.dlink1*, %struct.dlink1** @hFixedEnd, align 8
...
if.end.225:                                       ; preds = %for.body.218
  ...
  store i32 %213, i32* %dx2, align 4
  %214 = load i32, i32* %dx2, align 4
  %215 = load i32, i32* %l1x2, align 4
  %cmp232 = icmp slt i32 %214, %215
  br i1 %cmp232, label %if.then.235, label %lor.lhs.false.233

lor.lhs.false.233:                                ; preds = %if.end.225
  %216 = load i32, i32* %dx1, align 4
  %217 = load i32, i32* %l1x2, align 4
  %cmp234 = icmp sge i32 %216, %217
...
for.end.239:                                      ; preds = %if.end.236, %for.cond.216
  %220 = load %struct.dlink1*, %struct.dlink1** %ritePtr, align 8
...
if.then.241:                                      ; preds = %for.end.239
  store i32 1, i32* %check, align 4
  %222 = load %struct.tnode*, %struct.tnode** @Hroot, align 8
  %223 = load i32, i32* %ry, align 4
  %call242 = call i32 @tprop(%struct.tnode* %222, i32 %223)
  %idxprom243 = sext i32 %call242 to i64
  %224 = load %struct.dlink1**, %struct.dlink1*** @Hptrs, align 8
...
if.then.279:                                      ; preds = %for.end.277
  ...
  %261 = load i32, i32* %l1y, align 4
  %262 = load i32, i32* %ry, align 4
  ...
  %281 = load i32, i32* %ry, align 4
  %282 = load i32, i32* %l1y, align 4
  %283 = load i32, i32* %rx1, align 4
  ...
  %296 = load i32, i32* %l1y, align 4
  %297 = load i32, i32* %ry, align 4
  ...
  %316 = load i32, i32* %ry, align 4
  %317 = load i32, i32* %l1y, align 4
  %318 = load i32, i32* %l1x2, align 4
...
if.end.348:                                       ; preds = %if.end.347, %land.lhs.true.185, %if.end.183
  %319 = load %struct.dlink1*, %struct.dlink1** %left2ptr, align 8
...
land.lhs.true.350:                                ; preds = %if.end.348
  %320 = load %struct.dlink1*, %struct.dlink1** %left2ptr, align 8
...
if.then.359:                                      ; preds = %land.lhs.true.350
  %326 = load %struct.tnode*, %struct.tnode** @Hroot, align 8
  %327 = load i32, i32* %l2y, align 4
  %call360 = call i32 @tprop(%struct.tnode* %326, i32 %327)
  %idxprom361 = sext i32 %call360 to i64
  %328 = load %struct.dlink1**, %struct.dlink1*** @Hptrs, align 8
...
if.then.378:                                      ; preds = %for.end.376
  %341 = load %struct.dlink1*, %struct.dlink1** @hFixedEnd, align 8
...
if.end.391:                                       ; preds = %for.body.384
  ...
  store i32 %355, i32* %dx2, align 4
  %356 = load i32, i32* %dx2, align 4
  %357 = load i32, i32* %l2x1, align 4
  %cmp398 = icmp sle i32 %356, %357
  br i1 %cmp398, label %if.then.401, label %lor.lhs.false.399

lor.lhs.false.399:                                ; preds = %if.end.391
  %358 = load i32, i32* %dx1, align 4
  %359 = load i32, i32* %l2x1, align 4
  %cmp400 = icmp sgt i32 %358, %359
...
for.end.405:                                      ; preds = %if.end.402, %for.cond.382
  %362 = load %struct.dlink1*, %struct.dlink1** %ritePtr, align 8
...
if.then.407:                                      ; preds = %for.end.405
  store i32 1, i32* %check, align 4
  %364 = load %struct.tnode*, %struct.tnode** @Hroot, align 8
  %365 = load i32, i32* %ry, align 4
  %call408 = call i32 @tprop(%struct.tnode* %364, i32 %365)
  %idxprom409 = sext i32 %call408 to i64
  %366 = load %struct.dlink1**, %struct.dlink1*** @Hptrs, align 8
...
if.then.445:                                      ; preds = %for.end.443
  ...
  %403 = load i32, i32* %l2y, align 4
  %404 = load i32, i32* %ry, align 4
  ...
  %423 = load i32, i32* %ry, align 4
  %424 = load i32, i32* %l2y, align 4
  %425 = load i32, i32* %l2x1, align 4
  ...
  %458 = load i32, i32* %ry, align 4
  %459 = load i32, i32* %l2y, align 4
  %460 = load i32, i32* %rx2, align 4
...
if.end.514:                                       ; preds = %if.end.513, %land.lhs.true.350, %if.end.348
  %461 = load %struct.dlink1*, %struct.dlink1** %ritePtr, align 8
  call void @doubleDown(%struct.dlink1* %461)
  br label %for.inc.515

for.inc.515:                                      ; preds = %if.end.514, %if.end.182, %if.then
  %462 = load %struct.dlink1*, %struct.dlink1** %ritePtr, align 8
  ...
  store %struct.dlink1* %463, %struct.dlink1** %ritePtr, align 8
  br label %for.cond
...
; Function Attrs: nounwind uwtable
define void @doubleDown(%struct.dlink1* %rptr) #0 {
entry:
  %rptr.addr = alloca %struct.dlink1*, align 8
  %ry = alloca i32, align 4
  %rx1 = alloca i32, align 4
  %rx2 = alloca i32, align 4
  ...
  %checkPtr = alloca %struct.dlink1*, align 8
  %ptr = alloca %struct.dlink1*, align 8
  store %struct.dlink1* %rptr, %struct.dlink1** %rptr.addr, align 8
  %0 = load %struct.dlink1*, %struct.dlink1** %rptr.addr, align 8
  ...
  %4 = load %struct.dlink1*, %struct.dlink1** %rptr.addr, align 8
  ...
  store i32 %7, i32* %rx2, align 4
  %8 = load %struct.dlink1*, %struct.dlink1** %rptr.addr, align 8
  ...
  store i32 %11, i32* %rx1, align 4
  %12 = load %struct.tnode*, %struct.tnode** @Hroot, align 8
  %13 = load i32, i32* %ry, align 4
  %call = call i32 @tprop(%struct.tnode* %12, i32 %13)
  %idxprom8 = sext i32 %call to i64
  %14 = load %struct.dlink1**, %struct.dlink1*** @Hptrs, align 8
...
if.end:                                           ; preds = %for.body
  ...
  store i32 %30, i32* %lx2, align 4
  %31 = load i32, i32* %lx2, align 4
  %32 = load i32, i32* %rx2, align 4
  %cmp23 = icmp slt i32 %31, %32
  br i1 %cmp23, label %land.lhs.true, label %if.then.25

land.lhs.true:                                    ; preds = %if.end
  %33 = load i32, i32* %lx1, align 4
  %34 = load i32, i32* %rx1, align 4
...
if.then.40:                                       ; preds = %land.lhs.true.33
  store i32 1, i32* %check, align 4
  %45 = load %struct.tnode*, %struct.tnode** @Hroot, align 8
  %46 = load i32, i32* %ry, align 4
  %call41 = call i32 @tprop(%struct.tnode* %45, i32 %46)
  %idxprom42 = sext i32 %call41 to i64
  %47 = load %struct.dlink1**, %struct.dlink1*** @Hptrs, align 8
...
for.body.46:                                      ; preds = %for.cond.44
  ...
  %51 = load %struct.dlink1*, %struct.dlink1** %rptr.addr, align 8
...
if.then.77:                                       ; preds = %if.end.76
  ...
  %86 = load i32, i32* %ly, align 4
  %87 = load i32, i32* %ry, align 4
  ...
  %120 = load i32, i32* %ly, align 4
  %121 = load i32, i32* %ry, align 4
  ...
  %134 = load i32, i32* %lx2, align 4
  %135 = load i32, i32* @numProbes, align 4
  %136 = load i32, i32* @edgeCount, align 4
  %add134 = add nsw i32 %135, %136
  call void @tinsert(%struct.tnode** @vEdgeRoot, i32 %134, i32 %add134)
  %137 = load %struct._IO_FILE*, %struct._IO_FILE** @fpdebug, align 8
  %138 = load i32, i32* @numProbes, align 4
  %139 = load i32, i32* %ry, align 4
  %140 = load i32, i32* %ly, align 4
  %141 = load i32, i32* %lx2, align 4
