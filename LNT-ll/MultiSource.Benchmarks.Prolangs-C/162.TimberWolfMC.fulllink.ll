; ModuleID = './MultiSource.Benchmarks.Prolangs-C/162.TimberWolfMC.fulllink.bc'
...
entry:
  ...
  store %struct.dlink1* %0, %struct.dlink1** @Hlist, align 8
  %1 = load i32, i32* @edgeCount, align 4
  %2 = load %struct.dlink1*, %struct.dlink1** @Hlist, align 8
  ...
  %8 = load %struct.dlink1*, %struct.dlink1** @Hlist, align 8
  %9 = load %struct.dlink1*, %struct.dlink1** @Hlist, align 8
  ...
  %20 = load %struct.dlink1*, %struct.dlink1** @Vlist, align 8
  ...
  %21 = load %struct.dlink1*, %struct.dlink1** @Vlist, align 8
  ...
  %22 = load %struct.dlink1*, %struct.dlink1** @Vlist, align 8
  ...
  %24 = load %struct.dlink1*, %struct.dlink1** @Vlist, align 8
  %25 = load %struct.dlink1*, %struct.dlink1** @Vlist, align 8
  ...
  %28 = load %struct.dlink1*, %struct.dlink1** @Vlist, align 8
  ...
  store %struct.dlink1* %31, %struct.dlink1** @Vend, align 8
  %32 = load %struct.dlink1*, %struct.dlink1** @Hlist, align 8
  store %struct.dlink1* %32, %struct.dlink1** %pptr, align 8
  %33 = load %struct.dlink1*, %struct.dlink1** @Hlist, align 8
...
for.cond:                                         ; preds = %if.end, %entry
  call void @tpop(%struct.tnode** @hEdgeRoot, %struct.tnode** %junkptr, i32* %location, i32* %index)
...
for.end:                                          ; preds = %if.then
  %48 = load %struct.dlink1*, %struct.dlink1** @Vlist, align 8
  store %struct.dlink1* %48, %struct.dlink1** %pptr, align 8
  %49 = load %struct.dlink1*, %struct.dlink1** @Vlist, align 8
...
for.cond.31:                                      ; preds = %if.end.34, %for.end
  call void @tpop(%struct.tnode** @vEdgeRoot, %struct.tnode** %junkptr, i32* %location, i32* %index)
...
; Function Attrs: nounwind uwtable
define void @makeVertDownTree() #0 {
entry:
  ...
  %0 = bitcast i8* %call to %struct.dlink1**
  store %struct.dlink1** %0, %struct.dlink1*** @VDptrs, align 8
  store i32 0, i32* %count, align 4
  store i32 -1000000, i32* %last, align 4
  %1 = load %struct.dlink1*, %struct.dlink1** @Vlist, align 8
...
if.end:                                           ; preds = %for.body
  ...
  %arrayidx4 = getelementptr inbounds %struct.edgebox, %struct.edgebox* %9, i64 %idxprom3
...
if.then.6:                                        ; preds = %if.end
  ...
  %arrayidx8 = getelementptr inbounds %struct.edgebox, %struct.edgebox* %13, i64 %idxprom7
  %loc9 = getelementptr inbounds %struct.edgebox, %struct.edgebox* %arrayidx8, i32 0, i32 3
  %14 = load i32, i32* %loc9, align 4
...
if.then.11:                                       ; preds = %if.then.6
  %16 = load %struct.dlink1**, %struct.dlink1*** @VDptrs, align 8
  %17 = bitcast %struct.dlink1** %16 to i8*
  %18 = load i32, i32* %count, align 4
  %add = add nsw i32 %18, 100
  %conv = sext i32 %add to i64
  %mul = mul i64 %conv, 8
  %call12 = call i8* @realloc(i8* %17, i64 %mul) #3
  %19 = bitcast i8* %call12 to %struct.dlink1**
  store %struct.dlink1** %19, %struct.dlink1*** @VDptrs, align 8
  br label %if.end.13

if.end.13:                                        ; preds = %if.then.11, %if.then.6
  %20 = load %struct.dlink1*, %struct.dlink1** %vptr, align 8
  %21 = load i32, i32* %count, align 4
  %idxprom14 = sext i32 %21 to i64
  %22 = load %struct.dlink1**, %struct.dlink1*** @VDptrs, align 8
  %arrayidx15 = getelementptr inbounds %struct.dlink1*, %struct.dlink1** %22, i64 %idxprom14
  store %struct.dlink1* %20, %struct.dlink1** %arrayidx15, align 8
  %23 = load i32, i32* %last, align 4
  %24 = load i32, i32* %count, align 4
  call void @tinsert(%struct.tnode** @VDroot, i32 %23, i32 %24)
  br label %if.end.16
...
for.inc:                                          ; preds = %if.end.16, %if.then
  %25 = load %struct.dlink1*, %struct.dlink1** %vptr, align 8
  %next = getelementptr inbounds %struct.dlink1, %struct.dlink1* %25, i32 0, i32 2
  %26 = load %struct.dlink1*, %struct.dlink1** %next, align 8
  store %struct.dlink1* %26, %struct.dlink1** %vptr, align 8
  br label %for.cond
...
; Function Attrs: nounwind uwtable
define void @makeHoriRiteTree() #0 {
entry:
  ...
  %call = call noalias i8* @malloc(i64 800) #3
  %0 = bitcast i8* %call to %struct.dlink1**
  store %struct.dlink1** %0, %struct.dlink1*** @HRptrs, align 8
  store i32 0, i32* %count, align 4
  store i32 -1000000, i32* %last, align 4
...
if.then.11:                                       ; preds = %if.then.6
  %16 = load %struct.dlink1**, %struct.dlink1*** @HRptrs, align 8
  %17 = bitcast %struct.dlink1** %16 to i8*
  %18 = load i32, i32* %count, align 4
  %add = add nsw i32 %18, 100
  %conv = sext i32 %add to i64
  ...
  %call12 = call i8* @realloc(i8* %17, i64 %mul) #3
  %19 = bitcast i8* %call12 to %struct.dlink1**
  store %struct.dlink1** %19, %struct.dlink1*** @HRptrs, align 8
  br label %if.end.13

if.end.13:                                        ; preds = %if.then.11, %if.then.6
  %20 = load %struct.dlink1*, %struct.dlink1** %hptr, align 8
  %21 = load i32, i32* %count, align 4
  %idxprom14 = sext i32 %21 to i64
  %22 = load %struct.dlink1**, %struct.dlink1*** @HRptrs, align 8
  %arrayidx15 = getelementptr inbounds %struct.dlink1*, %struct.dlink1** %22, i64 %idxprom14
  store %struct.dlink1* %20, %struct.dlink1** %arrayidx15, align 8
  %23 = load i32, i32* %last, align 4
  %24 = load i32, i32* %count, align 4
  call void @tinsert(%struct.tnode** @HRroot, i32 %23, i32 %24)
  br label %if.end.16
...
for.inc:                                          ; preds = %if.end.16, %if.then
  %25 = load %struct.dlink1*, %struct.dlink1** %hptr, align 8
  %next = getelementptr inbounds %struct.dlink1, %struct.dlink1* %25, i32 0, i32 2
  %26 = load %struct.dlink1*, %struct.dlink1** %next, align 8
  store %struct.dlink1* %26, %struct.dlink1** %hptr, align 8
  br label %for.cond
