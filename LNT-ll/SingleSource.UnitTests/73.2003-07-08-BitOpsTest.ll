; ModuleID = './SingleSource.UnitTests/73.2003-07-08-BitOpsTest.bc'
...
entry:
  ...
  %20 = load i32, i32* %bxor, align 4
  %21 = load i32, i32* %bor, align 4
  %22 = load i32, i32* %band, align 4
  %23 = load i32, i32* %bandnot, align 4
  %24 = load i32, i32* %bornot, align 4
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), i32 %20, i32 %21, i32 %22, i32 %23, i32 %24)
  ret void
}
