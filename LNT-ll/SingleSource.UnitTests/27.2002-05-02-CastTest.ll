; ModuleID = './SingleSource.UnitTests/27.2002-05-02-CastTest.bc'
...
cond.end.7:                                       ; preds = %cond.false.6, %cond.true.3
  ...
  %18 = load i16, i16* %s1, align 2
  %conv23 = sext i16 %18 to i32
  store i32 %conv23, i32* %uis4, align 4
  %19 = load i8, i8* %ubc0, align 1
  %conv24 = zext i8 %19 to i32
  %20 = load i8, i8* %ubc0, align 1
  %conv25 = zext i8 %20 to i32
  %call26 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i32 0, i32 0), i32 %conv24, i32 %conv25)
  %21 = load i8, i8* %ubs0, align 1
  %conv27 = zext i8 %21 to i32
  %22 = load i8, i8* %ubs0, align 1
  %conv28 = zext i8 %22 to i32
  %call29 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i32 0, i32 0), i32 %conv27, i32 %conv28)
  %23 = load i8, i8* %ubs1, align 1
  %conv30 = zext i8 %23 to i32
  %24 = load i8, i8* %ubs1, align 1
  %conv31 = zext i8 %24 to i32
  %call32 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.2, i32 0, i32 0), i32 %conv30, i32 %conv31)
  %25 = load i8, i8* %bs0, align 1
  %conv33 = sext i8 %25 to i32
  %26 = load i8, i8* %bs0, align 1
  %conv34 = sext i8 %26 to i32
  %call35 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.3, i32 0, i32 0), i32 %conv33, i32 %conv34)
  %27 = load i8, i8* %bs1, align 1
  %conv36 = sext i8 %27 to i32
  %28 = load i8, i8* %bs1, align 1
  %conv37 = sext i8 %28 to i32
  %call38 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.4, i32 0, i32 0), i32 %conv36, i32 %conv37)
  %29 = load i8, i8* %c1, align 1
  %conv39 = sext i8 %29 to i32
  %30 = load i8, i8* %c1, align 1
  %conv40 = sext i8 %30 to i32
  %call41 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.5, i32 0, i32 0), i32 %conv39, i32 %conv40)
  %31 = load i16, i16* %s1, align 2
  %conv42 = sext i16 %31 to i32
  %32 = load i16, i16* %s1, align 2
  %conv43 = sext i16 %32 to i32
  %call44 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.6, i32 0, i32 0), i32 %conv42, i32 %conv43)
  %33 = load i8, i8* %uc2, align 1
  %conv45 = zext i8 %33 to i32
  %34 = load i8, i8* %uc2, align 1
  %conv46 = zext i8 %34 to i32
  %call47 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i32 0, i32 0), i32 %conv45, i32 %conv46)
  %35 = load i16, i16* %us2, align 2
  %conv48 = zext i16 %35 to i32
  %36 = load i16, i16* %us2, align 2
  %conv49 = zext i16 %36 to i32
  %call50 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.8, i32 0, i32 0), i32 %conv48, i32 %conv49)
  %37 = load i32, i32* %ic3, align 4
  %38 = load i32, i32* %ic3, align 4
  %call51 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.9, i32 0, i32 0), i32 %37, i32 %38)
  %39 = load i32, i32* %is3, align 4
  %40 = load i32, i32* %is3, align 4
  %call52 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.10, i32 0, i32 0), i32 %39, i32 %40)
  %41 = load i32, i32* %is4, align 4
  %42 = load i32, i32* %is4, align 4
  %call53 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.11, i32 0, i32 0), i32 %41, i32 %42)
  %43 = load i32, i32* %is5, align 4
  %44 = load i32, i32* %is5, align 4
  %call54 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.12, i32 0, i32 0), i32 %43, i32 %44)
  %45 = load i32, i32* %uic4, align 4
  %46 = load i32, i32* %uic4, align 4
  %call55 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.13, i32 0, i32 0), i32 %45, i32 %46)
  %47 = load i32, i32* %uis4, align 4
  %48 = load i32, i32* %uis4, align 4
  %call56 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.14, i32 0, i32 0), i32 %47, i32 %48)
  ret i32 0
}
