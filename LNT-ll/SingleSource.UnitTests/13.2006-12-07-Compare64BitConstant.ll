; ModuleID = './SingleSource.UnitTests/13.2006-12-07-Compare64BitConstant.bc'
...
if.else:                                          ; preds = %entry
  %call1 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.1, i32 0, i32 0))
  br label %if.end
