; ModuleID = './SingleSource.UnitTests/2.2007-04-10-BitfieldTest.bc'
...
entry:
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0), i32 %bf.cast)
  ret i32 0
}
