; ModuleID = './SingleSource.UnitTests/37.2002-08-19-CodegenBug.bc'
...
entry:
  ...
  store i8* %call, i8** %validate_array, align 8
  %0 = load i8*, i8** %validate_array, align 8
...
if.end:                                           ; preds = %entry
  %call2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.1, i32 0, i32 0))
  ret i32 0
}
