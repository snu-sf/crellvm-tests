; ModuleID = './SingleSource.UnitTests/46.2008-07-13-InlineSetjmp.bc'
...
entry:
  ...
  %call = call i32 @_setjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* @g, i32 0, i32 0)) #4
...
entry:
  %retval = alloca i32, align 4
  call void @longjmp(%struct.__jmp_buf_tag* getelementptr inbounds ([1 x %struct.__jmp_buf_tag], [1 x %struct.__jmp_buf_tag]* @g, i32 0, i32 0), i32 1) #5
  unreachable
