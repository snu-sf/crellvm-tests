; ModuleID = './SingleSource.UnitTests/63.2002-05-02-CastTest3.bc'
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i32 %conv1)
  %4 = load i16, i16* %us2, align 2
  %conv2 = zext i16 %4 to i32
  %call3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.1, i32 0, i32 0), i32 %conv2)
  ret i32 0
}
