; ModuleID = './SingleSource.UnitTests/21.2007-03-02-VaCopy.bc'
...
vaarg.in_reg:                                     ; preds = %entry
  %2 = getelementptr inbounds %struct.__va_list_tag, %struct.__va_list_tag* %arraydecay4, i32 0, i32 3
...
vaarg.end:                                        ; preds = %vaarg.in_mem, %vaarg.in_reg
  ...
  %call = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* %8)
  ret void
}
