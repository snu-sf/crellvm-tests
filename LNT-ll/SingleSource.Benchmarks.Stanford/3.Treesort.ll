; ModuleID = './SingleSource.Benchmarks.Stanford/3.Treesort.bc'
...
land.end.21:                                      ; preds = %land.rhs.19, %if.else.15
  %21 = phi i1 [ false, %if.else.15 ], [ %tobool20, %land.rhs.19 ]
...
entry:
  ...
  store %struct.node* null, %struct.node** %right, align 8
  %3 = load i32, i32* getelementptr inbounds ([5001 x i32], [5001 x i32]* @sortlist, i32 0, i64 1), align 4
...
for.end:                                          ; preds = %for.cond
  ...
  %arrayidx2 = getelementptr inbounds [5001 x i32], [5001 x i32]* @sortlist, i32 0, i64 %idxprom1
