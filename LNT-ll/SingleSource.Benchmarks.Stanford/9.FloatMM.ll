; ModuleID = './SingleSource.Benchmarks.Stanford/9.FloatMM.bc'
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %6 = load [41 x float]*, [41 x float]** %m.addr, align 8
  %arrayidx = getelementptr inbounds [41 x float], [41 x float]* %6, i64 %idxprom6
  %arrayidx7 = getelementptr inbounds [41 x float], [41 x float]* %arrayidx, i32 0, i64 %idxprom
...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load [41 x float]*, [41 x float]** %a.addr, align 8
  %arrayidx = getelementptr inbounds [41 x float], [41 x float]* %6, i64 %idxprom1
  %arrayidx2 = getelementptr inbounds [41 x float], [41 x float]* %arrayidx, i32 0, i64 %idxprom
  %7 = load float, float* %arrayidx2, align 4
  %8 = load i32, i32* %column.addr, align 4
  %idxprom3 = sext i32 %8 to i64
  %9 = load i32, i32* %i, align 4
  %idxprom4 = sext i32 %9 to i64
  %10 = load [41 x float]*, [41 x float]** %b.addr, align 8
  %arrayidx5 = getelementptr inbounds [41 x float], [41 x float]* %10, i64 %idxprom4
  %arrayidx6 = getelementptr inbounds [41 x float], [41 x float]* %arrayidx5, i32 0, i64 %idxprom3
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds [41 x [41 x float]], [41 x [41 x float]]* @rmr, i32 0, i64 %idxprom4
  %arrayidx5 = getelementptr inbounds [41 x float], [41 x float]* %arrayidx, i32 0, i64 %idxprom
  %4 = load i32, i32* %i, align 4
...
if.then:                                          ; preds = %for.end.8
  ...
  %arrayidx13 = getelementptr inbounds [41 x [41 x float]], [41 x [41 x float]]* @rmr, i32 0, i64 %idxprom12
  %arrayidx14 = getelementptr inbounds [41 x float], [41 x float]* %arrayidx13, i32 0, i64 %idxprom10
