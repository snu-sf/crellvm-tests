; ModuleID = './SingleSource.Benchmarks.Stanford/11.Towers.bc'
...
entry:
  ...
  %arrayidx = getelementptr inbounds [4 x i32], [4 x i32]* @stack, i32 0, i64 %idxprom
...
if.then:                                          ; preds = %entry
  ...
  %arrayidx = getelementptr inbounds [19 x %struct.element], [19 x %struct.element]* @cellspace, i32 0, i64 %idxprom
...
if.then:                                          ; preds = %entry
  ...
  %arrayidx2 = getelementptr inbounds [4 x i32], [4 x i32]* @stack, i32 0, i64 %idxprom1
  %3 = load i32, i32* %arrayidx2, align 4
  %idxprom3 = sext i32 %3 to i64
  %arrayidx4 = getelementptr inbounds [19 x %struct.element], [19 x %struct.element]* @cellspace, i32 0, i64 %idxprom3
  %discsize = getelementptr inbounds %struct.element, %struct.element* %arrayidx4, i32 0, i32 0
  %4 = load i32, i32* %discsize, align 4
...
if.end.7:                                         ; preds = %if.end, %entry
  ...
  br i1 %tobool, label %if.end.18, label %if.then.8
...
if.then.8:                                        ; preds = %if.end.7
  ...
  %arrayidx10 = getelementptr inbounds [4 x i32], [4 x i32]* @stack, i32 0, i64 %idxprom9
  %8 = load i32, i32* %arrayidx10, align 4
  %9 = load i32, i32* %localel, align 4
  %idxprom11 = sext i32 %9 to i64
  %arrayidx12 = getelementptr inbounds [19 x %struct.element], [19 x %struct.element]* @cellspace, i32 0, i64 %idxprom11
  ...
  %arrayidx14 = getelementptr inbounds [4 x i32], [4 x i32]* @stack, i32 0, i64 %idxprom13
  store i32 %10, i32* %arrayidx14, align 4
  %12 = load i32, i32* %i.addr, align 4
  %13 = load i32, i32* %localel, align 4
  %idxprom15 = sext i32 %13 to i64
  %arrayidx16 = getelementptr inbounds [19 x %struct.element], [19 x %struct.element]* @cellspace, i32 0, i64 %idxprom15
  %discsize17 = getelementptr inbounds %struct.element, %struct.element* %arrayidx16, i32 0, i32 0
  store i32 %12, i32* %discsize17, align 4
  br label %if.end.18
...
if.then:                                          ; preds = %entry
  ...
  %arrayidx6 = getelementptr inbounds [4 x i32], [4 x i32]* @stack, i32 0, i64 %idxprom5
  %6 = load i32, i32* %arrayidx6, align 4
  %idxprom7 = sext i32 %6 to i64
  %arrayidx8 = getelementptr inbounds [19 x %struct.element], [19 x %struct.element]* @cellspace, i32 0, i64 %idxprom7
  ...
  %arrayidx15 = getelementptr inbounds [4 x i32], [4 x i32]* @stack, i32 0, i64 %idxprom14
  ...
  %arrayidx17 = getelementptr inbounds [4 x i32], [4 x i32]* @stack, i32 0, i64 %idxprom16
