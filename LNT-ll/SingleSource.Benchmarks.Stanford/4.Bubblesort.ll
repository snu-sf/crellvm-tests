; ModuleID = './SingleSource.Benchmarks.Stanford/4.Bubblesort.bc'
...
while.body.3:                                     ; preds = %while.cond.1
  ...
  %arrayidx5 = getelementptr inbounds [5001 x i32], [5001 x i32]* @sortlist, i32 0, i64 %idxprom4
...
if.then:                                          ; preds = %while.body.3
  ...
  %arrayidx11 = getelementptr inbounds [5001 x i32], [5001 x i32]* @sortlist, i32 0, i64 %idxprom10
  %10 = load i32, i32* %arrayidx11, align 4
  %11 = load i32, i32* %i, align 4
  %idxprom12 = sext i32 %11 to i64
  %arrayidx13 = getelementptr inbounds [5001 x i32], [5001 x i32]* @sortlist, i32 0, i64 %idxprom12
  store i32 %10, i32* %arrayidx13, align 4
  %12 = load i32, i32* %j, align 4
  %13 = load i32, i32* %i, align 4
  %add14 = add nsw i32 %13, 1
  %idxprom15 = sext i32 %add14 to i64
  %arrayidx16 = getelementptr inbounds [5001 x i32], [5001 x i32]* @sortlist, i32 0, i64 %idxprom15
...
while.end.18:                                     ; preds = %while.cond
  %16 = load i32, i32* getelementptr inbounds ([5001 x i32], [5001 x i32]* @sortlist, i32 0, i64 1), align 4
...
lor.lhs.false:                                    ; preds = %while.end.18
  %18 = load i32, i32* getelementptr inbounds ([5001 x i32], [5001 x i32]* @sortlist, i32 0, i64 500), align 4
...
if.end.22:                                        ; preds = %if.then.21, %lor.lhs.false
  ...
  %arrayidx25 = getelementptr inbounds [5001 x i32], [5001 x i32]* @sortlist, i32 0, i64 %idxprom24
