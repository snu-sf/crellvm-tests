; ModuleID = './SingleSource.Benchmarks.Stanford/10.RealMM.bc'
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %6 = load [41 x double]*, [41 x double]** %m.addr, align 8
  %arrayidx = getelementptr inbounds [41 x double], [41 x double]* %6, i64 %idxprom6
  %arrayidx7 = getelementptr inbounds [41 x double], [41 x double]* %arrayidx, i32 0, i64 %idxprom
...
for.body:                                         ; preds = %for.cond
  ...
  %6 = load [41 x double]*, [41 x double]** %a.addr, align 8
  %arrayidx = getelementptr inbounds [41 x double], [41 x double]* %6, i64 %idxprom1
  %arrayidx2 = getelementptr inbounds [41 x double], [41 x double]* %arrayidx, i32 0, i64 %idxprom
  %7 = load double, double* %arrayidx2, align 8
  %8 = load i32, i32* %column.addr, align 4
  %idxprom3 = sext i32 %8 to i64
  %9 = load i32, i32* %i, align 4
  %idxprom4 = sext i32 %9 to i64
  %10 = load [41 x double]*, [41 x double]** %b.addr, align 8
  %arrayidx5 = getelementptr inbounds [41 x double], [41 x double]* %10, i64 %idxprom4
  %arrayidx6 = getelementptr inbounds [41 x double], [41 x double]* %arrayidx5, i32 0, i64 %idxprom3
...
for.body.3:                                       ; preds = %for.cond.1
  ...
  %arrayidx = getelementptr inbounds [41 x [41 x double]], [41 x [41 x double]]* @rmr, i32 0, i64 %idxprom4
  %arrayidx5 = getelementptr inbounds [41 x double], [41 x double]* %arrayidx, i32 0, i64 %idxprom
  %4 = load i32, i32* %i, align 4
...
for.end.8:                                        ; preds = %for.cond
  ...
  %arrayidx12 = getelementptr inbounds [41 x [41 x double]], [41 x [41 x double]]* @rmr, i32 0, i64 %idxprom11
  %arrayidx13 = getelementptr inbounds [41 x double], [41 x double]* %arrayidx12, i32 0, i64 %idxprom9
