...
{
  do { if (file_job->delegation_tmpname) free (file_job->delegation_tmpname); } while (0);
  do { if (file_job->stdin_tmpname) free (file_job->stdin_tmpname); } while (0);
  free (file_job);
}
...
file_job_self_print (fjob_t *file, FILE *stream)
{
  ...
  fprintf (stream,
    ...
    ((((void const *) file->delegation_tmpname) == ((void*)0)) ? (const char *) "" : (const char *) (file->delegation_tmpname)),
    ((((void const *) file->stdin_tmpname) == ((void*)0)) ? (const char *) "" : (const char *) (file->stdin_tmpname)),
    file->is_toc);
}
