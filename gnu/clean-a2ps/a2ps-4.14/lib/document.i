        ...
        const char *after)
{
  ...
  do { const char * _tmp_ = (const char *) (authors); cp = ((char *) __builtin_alloca (sizeof (char) * (strlen (_tmp_) + 1))); strcpy (cp, _tmp_); } while (0);
  cp = strtok (cp, ",");
  ...
  while (cp)
    {
      ...
      *(email - 1) = '\0';
      if (!(strcmp ((author), ("Akim Demaille")) == 0))
 {
   if (first)
     {
       fputs (before, stream);
     ...
     const char *format, FILE * stream)
{
  ...
  cp = xvstrrpl ((const char *) documentation, "url(", "<a href=\"", ")url(", "\">", ")url", "</a>", "emph(", "<emph>", ")emph", "</emph>'", "samp(", "`<code>", ")samp", "</code>'", "code(", "<code>", ")code", "</code>", "@example", "<pre>", "@end example", "</pre>", "@itemize", "<ul>", "@end itemize", "</ul>", "@item\n", "<li>", "@@", "@", ((void*)0));
  fprintf (stream, format, cp);
  free (cp);
}
        ...
        const char *format, FILE * stream)
{
  ...
  cp = xvstrrpl ((const char *) documentation, "emph(", "@emph{", ")emph", "}", "samp(", "@samp{", ")samp", "}", "code(", "@code{", ")code", "}", "url(", "@href{", ")url(", ",", ")url", "}", "@itemize", "@itemize @minus", ((void*)0));
  fprintf (stream, format, cp);
  free (cp);
}
