...
file_align_argmatch (const char * option, const char * arg)
{
  ...
  (((sizeof (((file_align_args))) / sizeof (*((file_align_args)))) == (sizeof (((file_align_types))) / sizeof (*((file_align_types)))) + 1) ? (void) (0) : __assert_fail ("(sizeof (((file_align_args))) / sizeof (*((file_align_args)))) == (sizeof (((file_align_types))) / sizeof (*((file_align_types)))) + 1", "filalign.c", 64, __PRETTY_FUNCTION__));

  i = argcasematch ((arg), (file_align_args), (const char *) (file_align_types), sizeof (*(file_align_types)));
  if (i >= 0)
