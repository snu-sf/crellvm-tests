...
typedef void (* pair_ht_map_fn_t) (int i, const char * key, const char * value, void const * arg);



typedef int (* pair_ht_select_fn_t) (const char * key, const char * value);
...
void pair_add (struct pair_htable * table, const char * key, const char * value);
...
char * pair_get (struct pair_htable * table, const char * key);


void pair_table_list_short (struct pair_htable * table, FILE * stream);

void pair_table_list_long (struct pair_htable * table, FILE * stream);

void pair_table_self_print (struct pair_htable * table, FILE * stream);





void pair_table_map (struct pair_htable * table, pair_ht_map_fn_t map_fn, pair_ht_select_fn_t select_fn, void const * arg);
...
int pair_table_load (struct pair_htable * table, const char * file);
# 42 "metaseq.c" 2
# 1 "./prange.h" 1
# 35 "./prange.h"
struct job;
...
void a2ps_page_range_set_string (struct a2ps_job * job, const char * string);


void report_pages_to_print (struct a2ps_job * job, FILE * stream);


int print_page (struct a2ps_job * job, int page_num);


void page_range_to_buffer (struct page_range * page_range, unsigned char * buf, int offset);
     ...
     const unsigned char * str)
{
 ...
 if (str[i] == '-') {
   i++;
   justification = -1;
   if (!(1 && ((*__ctype_b_loc ())[(int) (((int) (int) str[i]))] & (unsigned short int) _ISdigit)))
     padding = str[i++];
 }
 if (str[i] == '+') {
   i++;
 ...
 while ((1 && ((*__ctype_b_loc ())[(int) (((int) (int) str[i]))] & (unsigned short int) _ISdigit)))
...
# 248 "metaseq.c"
 case '\\':
   switch (str[i]) {
   case 'f':
     do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('\f'); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('\f'); (void) 0; }); } while (0);
     break;

   case 'n':
     do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('\n'); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('\n'); (void) 0; }); } while (0);
     break;

   default:
     do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (str [i]); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (str [i]); (void) 0; }); } while (0);
     break;
   }
   break;
# 275 "metaseq.c"
 case '%':
   ...
   switch (str[i]) {
   case '%':
     do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('%'); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('%'); (void) 0; }); } while (0);
     break;

   case '#':
     do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (3); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (3); (void) 0; }); } while (0);
     break;

   case 'a':
     sprintf ((char *) buf2,
       gettext ("Printed by %s"),
       macro_meta_sequence_get (job, "user.name"));
     do { size_t len = (strlen((const char *)(buf2))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf2)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;

   case 'A':
     cp = macro_meta_sequence_get (job, "user.name");
     cp2 = macro_meta_sequence_get (job, "user.host");
     if (cp2)
       sprintf ((char *) buf3,
         gettext ("Printed by %s from %s"), cp, cp2);
     else
       sprintf ((char *) buf3, gettext ("Printed by %s"), cp);
     do { size_t len = (strlen((const char *)(buf3))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf3)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
   ...
   case 'c':
     ...
     if (!cp)
       ...
       gettext ("cannot get current working directory"));
     cp2 = ((unsigned char *) strrchr((char *)(cp), (int)('/')));
     if (cp2)
       cp2++;
     else
       cp2 = cp;
     do { size_t len = (strlen((const char *)(cp2))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (cp2)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     do { if (cp) free (cp); } while (0);
     break;
   case 'C':
     sprintf ((char *)buf, "%d:%02d:%02d", job->run_tm.tm_hour,
       job->run_tm.tm_min, job->run_tm.tm_sec);
     do { size_t len = (strlen((const char *)(buf))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
   ...
   case 'd':
     ...
     if (!cp)
       error (1, (*__errno_location ()),
       gettext ("cannot get current working directory"));
     do { size_t len = (strlen((const char *)(cp))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (cp)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     do { if (cp) free (cp); } while (0);
     break;
  ...
  for (j = 0, i += 2;
    ...
    buf2[j] = str[i];
  if (str[i] != '}')
    error (1, 0, gettext ("%s: too long argument for %s escape"),
    context_name, "%D{}");
  ...
  sprintf ((char *)buf, "%02d-%02d-%02d",
   ...
   case 'm':
     cp = macro_meta_sequence_get (job, "user.host");
     cp2 = ((unsigned char *) __builtin_alloca (sizeof (unsigned char) * (strlen (cp) + 1)));
     strcpy (cp2, cp);
     cp = ((unsigned char *) strchr((char *)(cp2), (int)('.')));
     if (cp)
       *cp = '\0';
     do { size_t len = (strlen((const char *)(cp2))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (cp2)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
   ...
   case 'M':
     do { size_t len = (strlen((const char *)(macro_meta_sequence_get (job, "user.host")))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (macro_meta_sequence_get (job, "user.host"))), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;

   case 'n':
     do { size_t len = (strlen((const char *)(macro_meta_sequence_get (job, "user.login")))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (macro_meta_sequence_get (job, "user.login"))), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;

   case 'N':
     do { size_t len = (strlen((const char *)(macro_meta_sequence_get (job, "user.name")))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (macro_meta_sequence_get (job, "user.name"))), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
   ...
   case 'p':
     ...
     case '#':
       do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (1); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (1); (void) 0; }); } while (0);
       break;

     default:
       error (1, 0, gettext ("%s: unknown `%s' escape `%c' (%d)"),
   ...
   case 'q':
     sprintf ((char *)buf, gettext ("Page %d"), job->pages);
     do { size_t len = (strlen((const char *)(buf))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;

   case 'Q':
     sprintf ((char *)buf, gettext ("Page %d/%c"),
       job->pages, 1);
     do { size_t len = (strlen((const char *)(buf))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
   ...
   case 's':
     ...
     case '#':
       do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (2); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (2); (void) 0; }); } while (0);
       break;
   ...
   case 'V':
     sprintf ((char *) buf, "%s %s", "a2ps", "4.14");
     do { size_t len = (strlen((const char *)(buf))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
...
# 509 "metaseq.c"
 case '$':
   ...
   i++)
     ...
     if (str[i] == '\0')
       error (1, 0, gettext ("%s: missing `%c' for %s%c escape"),
       context_name, ')', "$(", ')');
     if (str[i] != ')')
       error (1, 0, gettext ("%s: too long argument for %s escape"),
       context_name, "$()");
  ...
  break;
     ...
     cp = (unsigned char *) getenv ((char *)buf);
     if ((((const char *) (cp2) == ((void*)0)) || (*(cp2) == '\0')))
       {
  ...
  switch (*cp2) {
  case '-':
    if (!(((const char *) (cp) == ((void*)0)) || (*(cp) == '\0')))
      do { size_t len = (strlen((const char *)(cp))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (cp)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
    else
      do { size_t len = (strlen((const char *)(cp2 + 1))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (cp2 + 1)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
    break;
  ...
  default:
    error (1, 0,
    gettext ("%s: invalid separator `%s%c' for `%s' escape"),
    context_name, ":", *cp2, "${}");
  }
       }
     break;
   ...
   case '[':
     if (!(1 && ((*__ctype_b_loc ())[(int) (((int) (int) str[i]))] & (unsigned short int) _ISdigit)))
       error (1, 0, gettext ("%s: invalid argument for %s%c escape"),
       context_name, "$[", ']');
     {
       size_t value = 0;
       while ((1 && ((*__ctype_b_loc ())[(int) (((int) (int) str[i]))] & (unsigned short int) _ISdigit)))
  ...
  error (1, 0, gettext ("%s: invalid argument for %s%c escape"),
       ...
       if (value < job->argc)
  do { size_t len = (strlen((const char *)(job->argv [value]))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (job->argv [value])), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     }
     break;
   ...
   case 'd':
     cp = ((unsigned char *) strrchr((char *)(file->name), (int)('/')));
     if (cp) {
       (strncpy((char *)(buf), (const char *)(file->name), (cp - file->name)));
       buf [cp - file->name] = '\0';
       do { size_t len = (strlen((const char *)(buf))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     } else {
       do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('.'); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('.'); (void) 0; }); } while (0);
  ...
  sprintf ((char *)buf, "%02d-%02d-%02d",
   ...
   case 'E':
     strftime ((char *) buf, sizeof (buf),
        ...
        (gettext ("%A %B %d, %Y")), &(file->mod_tm));
     do { size_t len = (strlen((const char *)(buf))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;

   case 'f':
     do { size_t len = (strlen((const char *)(file->name))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (file->name)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
   ...
   case 'l':
     ...
     case '#':
       if (file != ((struct file_job *) (job->jobs->content[job->jobs->len - 1]))) {

  sprintf ((char *)buf, "%d", file->lines);
  do { size_t len = (strlen((const char *)(buf))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
       } else {

  do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (6); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (6); (void) 0; }); } while (0);
       }
       break;
   ...
   case 'N':
     ...
     cp2 = ((unsigned char *) strrchr((char *)(cp), (int)('.')));
     if (cp2) {
       (strncpy((char *)(buf), (const char *)(cp), (cp2 - cp)));
       buf [cp2 - cp] = '\0';
       do { size_t len = (strlen((const char *)(buf))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     } else
       do { size_t len = (strlen((const char *)(cp))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (cp)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
  ...
  do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (7); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (7); (void) 0; }); } while (0);
       }
       break;
  ...
  do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (4); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (4); (void) 0; }); } while (0);
       }
       break;
   ...
   case 'q':
     sprintf ((char *)buf, gettext ("Page %d"), file->pages);
     do { size_t len = (strlen((const char *)(buf))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (buf)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
   ...
   case 'Q':
     if (file != ((struct file_job *) (job->jobs->content[job->jobs->len - 1])))
       ...
       sprintf ((char *) buf, gettext ("Page %d/%d"),
  ...
  do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (8); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (8); (void) 0; }); } while (0);
       }
       break;
  ...
  do { int a; if (width && justification < 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (5); (void) 0; }); for (a = 0; a < (int) width - 1; a++) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); if (!width || justification > 0) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (5); (void) 0; }); } while (0);
       }
       break;
   ...
   case 't':
     ...
     case '1':
       i++;
       do { size_t len = (strlen((const char *)(job->tag1))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (job->tag1)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
       break;

     case '2':
       i++;
       do { size_t len = (strlen((const char *)(job->tag2))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (job->tag2)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
       break;

     case '3':
       i++;
       do { size_t len = (strlen((const char *)(job->tag3))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (job->tag3)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
       break;

     case '4':
       i++;
       do { size_t len = (strlen((const char *)(job->tag4))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (job->tag4)), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
       break;
 ...
 case '#':
  ...
  default:
   ...
   case '.':
     ...
     do { size_t len = (strlen((const char *)("ps"))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) ("ps")), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
   ...
   case '?':
     {
       ...
       cond = str[++i];
       sep = str[++i];
       next = ((unsigned char *) xstrdup((const char *)(str + ++i)));

       do { if_true = next ; next = ((unsigned char *) strchr((char *)(next), (int)(sep))); if (!next) error (1, 0, gettext ("%s: missing `%c' for %s%c escape"), context_name, sep, "#?", cond); *next++ = '\0'; } while (0);
       do { if_false = next ; next = ((unsigned char *) strchr((char *)(next), (int)(sep))); if (!next) error (1, 0, gettext ("%s: missing `%c' for %s%c escape"), context_name, sep, "#?", cond); *next++ = '\0'; } while (0);
       i += next - if_true - 1;

       switch (cond) {
       case '1':
  test = !(((const char *) (job->tag1) == ((void*)0)) || (*(job->tag1) == '\0'));
  break;
       case '2':
  test = !(((const char *) (job->tag2) == ((void*)0)) || (*(job->tag2) == '\0'));
  break;
       case '3':
  test = !(((const char *) (job->tag3) == ((void*)0)) || (*(job->tag3) == '\0'));
  break;
       case '4':
  test = !(((const char *) (job->tag4) == ((void*)0)) || (*(job->tag4) == '\0'));
  break;
...
# 1111 "metaseq.c"
   ...
   case '!':
     {
       ...
       do { in = next ; next = ((unsigned char *) strchr((char *)(next), (int)(sep))); if (!next) error (1, 0, gettext ("%s: missing `%c' for %s%c escape"), context_name, sep, "#!", category); *next++ = '\0'; } while (0);
       do { between = next ; next = ((unsigned char *) strchr((char *)(next), (int)(sep))); if (!next) error (1, 0, gettext ("%s: missing `%c' for %s%c escape"), context_name, sep, "#!", category); *next++ = '\0'; } while (0);
       i += next - in - 1;
  ...
  {
    size_t fnum, fmax;
    fmax = (((width > 0) && (justification > 0) && (width < job->argc)) ? width : ((width > 0) && (justification < 0) && (width <= job->argc) ? (job->argc - width) : job->argc));
    for (fnum = 0 ; fnum < fmax ; fnum++) {
      do { size_t len = (strlen((const char *)(job->argv [fnum]))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (job->argv [fnum])), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
      if (fnum < fmax - 1)
        grow_user_string_obstack (user_string_stack,
      job,
      ((struct file_job *) job->jobs->content [fnum]),
  ...
  {
    size_t fnum, fmax;
    fmax = (((width > 0) && (justification > 0) && (width < job->jobs->len)) ? width : ((width > 0) && (justification < 0) && (width <= job->jobs->len) ? (job->jobs->len - width) : job->jobs->len));
    for (fnum = 0 ; fnum < fmax ; fnum++) {
      grow_user_string_obstack (user_string_stack,
           job,
           ((struct file_job *) job->jobs->content [fnum]),
...

  {
    ...
    for (fnum = 0 ; fnum < fmax ; fnum++) {
      grow_user_string_obstack (user_string_stack,
           job,
           ((struct file_job *) ordered->content [fnum]),
           context_name, in);
      if (fnum < fmax - 1)
        grow_user_string_obstack (user_string_stack,
      job,
...

  {
    ...
    while (fnum < selected->len) {
      if (((struct file_job *) selected->content [fnum])->last_sheet < job->sheets)
        da_remove_at (selected, fnum, ((void*)0));
      else
        fnum++;
    }

    fmax = (((width > 0) && (justification > 0) && (width < selected->len)) ? width : ((width > 0) && (justification < 0) && (width <= selected->len) ? (selected->len - width) : selected->len));
    for (fnum = 0 ; fnum < fmax ; fnum++) {
      grow_user_string_obstack (user_string_stack,
           job,
           ((struct file_job *) selected->content [fnum]),
           context_name, in);
      if (fnum < fmax - 1)
        grow_user_string_obstack (user_string_stack,
      job,
  ...
  error (1, 0, gettext ("%s: unknown `%s' escape `%c' (%d)"),
       ...
       do { (job->tmp_filenames [k]) = (job->tmp_filenames [k]) ? (job->tmp_filenames [k]) : tempnam (((void*)0), "a2_"); } while (0);
       do { size_t len = (strlen((const char *)(job->tmp_filenames [k]))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (job->tmp_filenames [k])), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     }
     break;
   ...
   case 'o':
     do { size_t len = (strlen((const char *)(a2ps_printers_flag_output_name_get (job->printers)))); size_t nspace; nspace = (len > width) ? 0 : (width - len); if (width && justification > 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); __extension__ ({ struct obstack *__o = (user_string_stack); int __len = (len); if (__o->next_free + __len > __o->chunk_limit) _obstack_newchunk (__o, __len); memcpy ((__o->next_free), ((char *) (a2ps_printers_flag_output_name_get (job->printers))), (__len)); __o->next_free += __len; (void) 0; }); if (width && justification < 0) for (; nspace; nspace--) __extension__ ({ struct obstack *__o = (user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = (padding); (void) 0; }); } while (0);
     break;
  ...
  (user_string_stack, job, file,
   (const unsigned char *) gettext ("output command"),
      ...
      const unsigned char * str)
{
  ...
  if (first_time)
    {
      first_time = 0;
      _obstack_begin ((&user_string_stack), 0, 0, (void *(*) (long)) xmalloc, (void (*) (void *)) free);
    }

  if (!str)
    return ((void*)0);

  do { if ((((1 << 10)) & msg_verbosity)) fprintf (stderr, "Expanding of %s user string (`%s')\n", context_name, str); } while (0);
  ...
  __extension__ ({ struct obstack *__o = (&user_string_stack); if (__o->next_free + 1 > __o->chunk_limit) _obstack_newchunk (__o, 1); *(__o->next_free)++ = ('\0'); (void) 0; });
  res = (unsigned char *) __extension__ ({ struct obstack *__o1 = (&user_string_stack); void *value; value = (void *) __o1->object_base; if (__o1->next_free == value) __o1->maybe_empty_object = 1; __o1->next_free = (((((__o1->next_free) - (char *) 0)+__o1->alignment_mask) & ~ (__o1->alignment_mask)) + (char *) 0); if (__o1->next_free - (char *)__o1->chunk > __o1->chunk_limit - (char *)__o1->chunk) __o1->next_free = __o1->chunk_limit; __o1->object_base = __o1->next_free; value; });
  __extension__ ({ struct obstack *__o = (&user_string_stack); void *__obj = (res); if (__obj > (void *)__o->chunk && __obj < (void *)__o->chunk_limit) __o->next_free = __o->object_base = __obj; else (obstack_free) (__o, __obj); });

  do { if ((((1 << 10)) & msg_verbosity)) fprintf (stderr, "Expansion of %s (`%s') is `%s'\n", context_name, str, res); } while (0);
