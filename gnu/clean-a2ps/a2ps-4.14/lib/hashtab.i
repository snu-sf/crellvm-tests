    ...
    hash_func_t hash_1, hash_func_t hash_2, hash_cmp_func_t hash_cmp)
{
  ...
  if (ht->ht_size > (128 * 1024))
    ht->ht_size /= 2;
  ht->ht_vec = (void**) ((struct token * *) xcalloc (sizeof (struct token *), (ht->ht_size)));
  ht->ht_capacity = ht->ht_size * 15 / 16;
  ht->ht_fill = 0;
  ht->ht_collisions = 0;
  ht->ht_lookups = 0;
  ht->ht_rehashes = 0;
...
hash_insert_at (struct hash_table_s* ht, void *item, void const *slot)
{
  ...
  if (((old_item) == 0 || (void *) (old_item) == hash_deleted_item))
    {
      ht->ht_fill++;
      old_item = item;
    }
    ...
    hash_select_func_t select_fn, qsort_cmp_t compare)
{
 ...
 && (*select_fn) (*slot))
  ...
  if (vector_0_malloced)
    vector_0 = ((void * *) xrealloc ((void *) (vector_0), sizeof (void *) * (fill + 1)));
      ...
      void const * arg, qsort_cmp_t compare)
{
  ...
  vector_0 = hash_dump (ht, ((void*)0), compare);
