...
static char time_string[((((sizeof (uintmax_t) * 8 - (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (uintmax_t)) 0 < (__typeof__ (uintmax_t)) -1))) + sizeof "."
...
get_time (void)
{
  ...
  if (watch_not_started)
    exit (1);
  sprintf (time_string, "%""l" "u"".%0*d", s, LOG10_TIMESPEC_RESOLUTION, ns);
  return time_string;
}
