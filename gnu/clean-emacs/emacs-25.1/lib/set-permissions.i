...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "set-permissions.c" 2
# 20 "set-permissions.c"
# 1 "../src/config.h" 1
# 1916 "../src/config.h"
# 1 "../src/conf_post.h" 1
# 35 "../src/conf_post.h"
...
void free_permission_context (struct permission_context *)
  ...
  ;
# 25 "set-permissions.c" 2
# 759 "set-permissions.c"
int
...
# 775 "set-permissions.c"
int
set_permissions (struct permission_context *ctx, const char *name, int desc)
{
  _Bool acls_set __attribute__ ((__unused__)) = 0;
  _Bool early_chmod;
  _Bool must_chmod = 0;
  int ret = 0;
# 801 "set-permissions.c"
  early_chmod = 1;
...
# 833 "set-permissions.c"
  if (must_chmod && ! early_chmod)
    {
      int saved_errno = ret ? (*__errno_location ()) : 0;
