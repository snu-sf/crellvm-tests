...
ftypelet (mode_t bits)
{
  ...
  if (((((bits)) & 0170000) == (0100000)))
    return '-';
  if (((((bits)) & 0170000) == (0040000)))
    return 'd';


  if (((((bits)) & 0170000) == (0060000)))
    return 'b';
  if (((((bits)) & 0170000) == (0020000)))
    return 'c';
  if (((((bits)) & 0170000) == (0120000)))
    return 'l';
  if (((((bits)) & 0170000) == (0010000)))
    return 'p';


  if (((((bits)) & 0170000) == (0140000)))
    return 's';
...
strmode (mode_t mode, char *str)
{
  ...
  str[6] = (mode & 02000
            ? (mode & (0100 >> 3) ? 's' : 'S')
            : (mode & (0100 >> 3) ? 'x' : '-'));
  str[7] = mode & ((0400 >> 3) >> 3) ? 'r' : '-';
  str[8] = mode & ((0200 >> 3) >> 3) ? 'w' : '-';
  str[9] = (mode & 01000
            ? (mode & ((0100 >> 3) >> 3) ? 't' : 'T')
            : (mode & ((0100 >> 3) >> 3) ? 'x' : '-'));
  str[10] = ' ';
...
filemodestring (struct stat const *statp, char *str)
{
  ...
  if (((statp)->st_mode - (statp)->st_mode))
    ...
    str[0] = 'M';
  else if (((statp)->st_mode - (statp)->st_mode))
    str[0] = 'Q';
  else if (((statp)->st_mode - (statp)->st_mode))
    str[0] = 'S';
  else if (0)
