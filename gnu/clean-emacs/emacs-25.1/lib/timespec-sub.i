...
timespec_sub (struct timespec a, struct timespec b)
{
  ...
  if (! (((((0 * (0 * (bs) + (rs)) - (1)) < 0) ? - (~ (0 * (0 * (bs) + (rs)) + (0)) == -1) - ((((0 * (0 * (bs) + (rs)) + (1)) << (sizeof ((0 * (bs) + (rs)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (bs) + (rs)) + (0)))) < 0 ? ((bs) < 0 ? ((((0 * (0 * (bs) + (rs)) - (1)) < 0) ? ((((0 * (0 * (bs) + (rs)) + (1)) << (sizeof ((0 * (bs) + (rs)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (bs) + (rs)) - (1)))) + (bs) < (rs) : (rs) < ((((0 * (0 * (bs) + (rs)) - (1)) < 0) ? - (~ (0 * (0 * (bs) + (rs)) + (0)) == -1) - ((((0 * (0 * (bs) + (rs)) + (1)) << (sizeof ((0 * (bs) + (rs)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (bs) + (rs)) + (0)))) + (bs)) : (rs) < 0 ? 1 : (bs) < 0 ? (rs) - (bs) <= (rs) : (rs) < (bs)) && tmin <= rs - bs && rs - bs <= tmax)
    rs -= bs;
  else
    {
      if (rs < 0)
