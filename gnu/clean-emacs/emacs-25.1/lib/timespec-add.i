...
timespec_add (struct timespec a, struct timespec b)
{
  ...
  int rns = ns;
  time_t tmin = ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) 0 : ((time_t) ~ (time_t) 0 < (time_t) -1) ? ~ (time_t) 0 : ~ ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) -1 : ((((time_t) 1 << (sizeof (time_t) * 8 - 2)) - 1) * 2 + 1)))));
  time_t tmax = ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) -1 : ((((time_t) 1 << (sizeof (time_t) * 8 - 2)) - 1) * 2 + 1)));
  ...
  if (! (((((0 * (0 * (bs) + (rs)) - (1)) < 0) ? - (~ (0 * (0 * (bs) + (rs)) + (0)) == -1) - ((((0 * (0 * (bs) + (rs)) + (1)) << (sizeof ((0 * (bs) + (rs)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (bs) + (rs)) + (0)))) < 0 ? ((bs) < 0 ? (rs) < ((((0 * (0 * (bs) + (rs)) - (1)) < 0) ? - (~ (0 * (0 * (bs) + (rs)) + (0)) == -1) - ((((0 * (0 * (bs) + (rs)) + (1)) << (sizeof ((0 * (bs) + (rs)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (bs) + (rs)) + (0)))) - (bs) : ((((0 * (0 * (bs) + (rs)) - (1)) < 0) ? ((((0 * (0 * (bs) + (rs)) + (1)) << (sizeof ((0 * (bs) + (rs)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (bs) + (rs)) - (1)))) - (bs) < (rs)) : (rs) < 0 ? (bs) <= (rs) + (bs) : (bs) < 0 ? (rs) <= (rs) + (bs) : (rs) + (bs) < (bs)) && tmin <= rs + bs && rs + bs <= tmax)
    rs += bs;
  else
    {
      if (rs < 0)
