# 1 "count-trailing-zeros.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "count-trailing-zeros.c" 2
# 1 "../src/config.h" 1
# 1916 "../src/config.h"
# 1 "../src/conf_post.h" 1
# 35 "../src/conf_post.h"
...
# 1917 "../src/config.h" 2
# 2 "count-trailing-zeros.c" 2

# 1 "./count-trailing-zeros.h" 1
# 22 "./count-trailing-zeros.h"
...
# 23 "./count-trailing-zeros.h" 2
# 1 "./stdlib.h" 1
# 21 "./stdlib.h" 3
# 24 "./count-trailing-zeros.h" 2
# 81 "./count-trailing-zeros.h"
extern inline int
...
{
  return x ? __builtin_ctzll (x) : 8 * sizeof x;;

}
# 4 "count-trailing-zeros.c" 2
