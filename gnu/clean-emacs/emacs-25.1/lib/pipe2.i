  ...
  if (flags & 04000)
    {
      ...
      if ((fcntl_flags = rpl_fcntl (fd[1], 3, 0)) < 0
          || rpl_fcntl (fd[1], 4, fcntl_flags | 04000) == -1
          || (fcntl_flags = rpl_fcntl (fd[0], 3, 0)) < 0
          || rpl_fcntl (fd[0], 4, fcntl_flags | 04000) == -1)
        goto fail;
    }
  ...
  if (flags & 02000000)
    {
      ...
      if ((fcntl_flags = rpl_fcntl (fd[1], 1, 0)) < 0
          || rpl_fcntl (fd[1], 2, fcntl_flags | 1) == -1
          || (fcntl_flags = rpl_fcntl (fd[0], 1, 0)) < 0
          || rpl_fcntl (fd[0], 2, fcntl_flags | 1) == -1)
        goto fail;
    }
# 151 "pipe2.c"
  return 0;
