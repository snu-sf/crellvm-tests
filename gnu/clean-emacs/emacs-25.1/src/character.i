...
char_resolve_modifier_mask (EMACS_INT c)
{
  ...
  if (! (((sizeof (((c & ~CHAR_MODIFIER_MASK)) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof (((c & ~CHAR_MODIFIER_MASK)) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? (((c & ~CHAR_MODIFIER_MASK)) + (unsigned) 0) < ((0x80) + (unsigned) 0) : (((c & ~CHAR_MODIFIER_MASK)) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)))
    return c;
...
char_string (unsigned int c, unsigned char *p)
{
  ...
  if (c <= 0xFFFF)
    {
      bytes = ((((sizeof ((c) + 0)) > (sizeof ((0x7F) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x7F) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0x7F) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0x7F) + (uintmax_t) 0)) ? ((p)[0] = (c), 1) : (((sizeof ((c) + 0)) > (sizeof ((0x7FF) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x7FF) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0x7FF) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0x7FF) + (uintmax_t) 0)) ? ((p)[0] = (0xC0 | ((c) >> 6)), (p)[1] = (0x80 | ((c) & 0x3F)), 2) : (((sizeof ((c) + 0)) > (sizeof ((0xFFFF) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0xFFFF) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0xFFFF) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0xFFFF) + (uintmax_t) 0)) ? ((p)[0] = (0xE0 | ((c) >> 12)), (p)[1] = (0x80 | (((c) >> 6) & 0x3F)), (p)[2] = (0x80 | ((c) & 0x3F)), 3) : ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (c) <= sizeof (unsigned)) ? 1 : -1; })) ? (char_string (c, p)) : (char_string (c, p))));
    }
  else if (c <= 0x1FFFFF)
    {
      p[0] = (0xF0 | (c >> 18));
  ...
  else if (c <= 0x3FFFFF)
    {
      ...
      bytes = ((p)[0] = (0xC0 | (((c) >> 6) & 0x01)), (p)[1] = (0x80 | ((c) & 0x3F)), 2);
    }
  else
  ...
  if (CHAR_TABLE_P (table))
    {
      ...
      if ((NATNUMP (ch) && ((ch) >> INTTYPEBITS) <= 0x3FFFFF))
 c = ((ch) >> INTTYPEBITS);
    }
  else
    {
      for (; (((enum Lisp_Type) ((table) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); table = (((void) (0 && ((((enum Lisp_Type) ((table) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((table) - (Lisp_Cons))))->u.cdr)
 c = translate_char ((((void) (0 && ((((enum Lisp_Type) ((table) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((table) - (Lisp_Cons))))->car, c);
    }
  return c;
}

static struct Lisp_Subr _Alignas (8) Scharacterp = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fcharacterp }, 1, 2, "characterp", 0, 0}; Lisp_Object Fcharacterp
...
{
  return ((NATNUMP (object) && ((object) >> INTTYPEBITS) <= 0x3FFFFF) ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0));
}

static struct Lisp_Subr _Alignas (8) Smax_char = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fmax_char }, 0, 0, "max-char", 0, 0}; Lisp_Object Fmax_char


  (void)
{
  return ((EMACS_INT) (((EMACS_UINT) (0x3FFFFF) << INTTYPEBITS) + Lisp_Int0));
}

static struct Lisp_Subr _Alignas (8) Sunibyte_char_to_multibyte = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Funibyte_char_to_multibyte }, 1, 1, "unibyte-char-to-multibyte", 0, 0}; Lisp_Object Funibyte_char_to_multibyte
...
static struct Lisp_Subr _Alignas (8) Smultibyte_char_to_unibyte = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fmultibyte_char_to_unibyte }, 1, 1, "multibyte-char-to-unibyte", 0, 0}; Lisp_Object Fmultibyte_char_to_unibyte
  ...
  (Lisp_Object ch)
{
  ...
  if (cm < 256)
    ...
    {
      int cu = ((((sizeof ((cm) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((cm) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((cm) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((cm) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? cm : (((cm) > 0x3FFF7F) ? (cm) - 0x3FFF00 : -1));
      return ((EMACS_INT) (((EMACS_UINT) (cu) << INTTYPEBITS) + Lisp_Int0));
    }
}
...
{
  ptrdiff_t width = ((((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (c < 0x20 ? (c == '\t' ? sanitize_tab_width (((((current_buffer)-> tab_width_)) >> INTTYPEBITS)) : (c == '\n' ? 0 : (((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2))) : (c < 0x7f ? 1 : ((((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2)))) : sanitize_char_width (((CHAR_TABLE_REF (globals.f_Vchar_width_table, c)) >> INTTYPEBITS)));

  if (dp)
    {
      Lisp_Object disp = ((((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? ((((dp)->ascii) == (builtin_lisp_symbol (0))) ? (dp)->defalt : (SUB_CHAR_TABLE_P ((dp)->ascii) ? XSUB_CHAR_TABLE ((dp)->ascii)->contents[c] : (dp)->ascii)) : disp_char_vector ((dp), (c))), ch;
      int i;
 ...
 for (i = 0, width = 0; i < ASIZE (disp); i++)
   {
     ...
     if ((NATNUMP (ch) && ((ch) >> INTTYPEBITS) <= 0x3FFFFF))
       {
  int w = ((((sizeof ((((ch) >> INTTYPEBITS)) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((((ch) >> INTTYPEBITS)) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((((ch) >> INTTYPEBITS)) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((((ch) >> INTTYPEBITS)) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (((ch) >> INTTYPEBITS) < 0x20 ? (((ch) >> INTTYPEBITS) == '\t' ? sanitize_tab_width (((((current_buffer)-> tab_width_)) >> INTTYPEBITS)) : (((ch) >> INTTYPEBITS) == '\n' ? 0 : (((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2))) : (((ch) >> INTTYPEBITS) < 0x7f ? 1 : ((((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2)))) : sanitize_char_width (((CHAR_TABLE_REF (globals.f_Vchar_width_table, ((ch) >> INTTYPEBITS))) >> INTTYPEBITS)));
  if ((sizeof *(&width) == sizeof (signed char) ? (sizeof ((width) + (w)) < sizeof (signed char) ? (((((((0 * (0 * ((signed char) (w)) + ((signed char) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (w)) + ((signed char) (width))) + (0)) == -1) - ((((0 * (0 * ((signed char) (w)) + ((signed char) (width))) + (1)) << (sizeof ((0 * ((signed char) (w)) + ((signed char) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (w)) + ((signed char) (width))) + (0)))) < 0 ? (((signed char) (w)) < 0 ? ((signed char) (width)) < ((((0 * (0 * ((signed char) (w)) + ((signed char) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (w)) + ((signed char) (width))) + (0)) == -1) - ((((0 * (0 * ((signed char) (w)) + ((signed char) (width))) + (1)) << (sizeof ((0 * ((signed char) (w)) + ((signed char) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (w)) + ((signed char) (width))) + (0)))) - ((signed char) (w)) : ((((0 * (0 * ((signed char) (w)) + ((signed char) (width))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (w)) + ((signed char) (width))) + (1)) << (sizeof ((0 * ((signed char) (w)) + ((signed char) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (w)) + ((signed char) (width))) - (1)))) - ((signed char) (w)) < ((signed char) (width))) : ((signed char) (width)) < 0 ? ((signed char) (w)) <= ((signed char) (width)) + ((signed char) (w)) : ((signed char) (w)) < 0 ? ((signed char) (width)) <= ((signed char) (width)) + ((signed char) (w)) : ((signed char) (width)) + ((signed char) (w)) < ((signed char) (w))) || (((0 * (((signed char) (width)) + ((signed char) (w))) - (1)) < 0) && (((signed char) (width)) + ((signed char) (w))) < ((-127 -1))) || (127) < (((signed char) (width)) + ((signed char) (w)))) ? (*(&width) = (((unsigned char) ((signed char) (width)) + (unsigned char) ((signed char) (w))) <= (127) ? (signed char) ((unsigned char) ((signed char) (width)) + (unsigned char) ((signed char) (w))) : ((signed char) (((unsigned char) ((signed char) (width)) + (unsigned char) ((signed char) (w))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&width) = (((unsigned char) ((signed char) (width)) + (unsigned char) ((signed char) (w))) <= (127) ? (signed char) ((unsigned char) ((signed char) (width)) + (unsigned char) ((signed char) (w))) : ((signed char) (((unsigned char) ((signed char) (width)) + (unsigned char) ((signed char) (w))) - ((-127 -1))) + ((-127 -1)))), 0)) : (((((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) < 0 ? ((w) < 0 ? (width) < ((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) - (w) : ((((0 * (0 * (w) + (width)) - (1)) < 0) ? ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) - (1)))) - (w) < (width)) : (width) < 0 ? (w) <= (width) + (w) : (w) < 0 ? (width) <= (width) + (w) : (width) + (w) < (w)) || (((0 * ((width) + (w)) - (1)) < 0) && ((width) + (w)) < ((-127 -1))) || (127) < ((width) + (w))) ? (*(&width) = (((unsigned char) (width) + (unsigned char) (w)) <= (127) ? (signed char) ((unsigned char) (width) + (unsigned char) (w)) : ((signed char) (((unsigned char) (width) + (unsigned char) (w)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&width) = (((unsigned char) (width) + (unsigned char) (w)) <= (127) ? (signed char) ((unsigned char) (width) + (unsigned char) (w)) : ((signed char) (((unsigned char) (width) + (unsigned char) (w)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&width) == sizeof (short int) ? (sizeof ((width) + (w)) < sizeof (short int) ? (((((((0 * (0 * ((short int) (w)) + ((short int) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (w)) + ((short int) (width))) + (0)) == -1) - ((((0 * (0 * ((short int) (w)) + ((short int) (width))) + (1)) << (sizeof ((0 * ((short int) (w)) + ((short int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (w)) + ((short int) (width))) + (0)))) < 0 ? (((short int) (w)) < 0 ? ((short int) (width)) < ((((0 * (0 * ((short int) (w)) + ((short int) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (w)) + ((short int) (width))) + (0)) == -1) - ((((0 * (0 * ((short int) (w)) + ((short int) (width))) + (1)) << (sizeof ((0 * ((short int) (w)) + ((short int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (w)) + ((short int) (width))) + (0)))) - ((short int) (w)) : ((((0 * (0 * ((short int) (w)) + ((short int) (width))) - (1)) < 0) ? ((((0 * (0 * ((short int) (w)) + ((short int) (width))) + (1)) << (sizeof ((0 * ((short int) (w)) + ((short int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (w)) + ((short int) (width))) - (1)))) - ((short int) (w)) < ((short int) (width))) : ((short int) (width)) < 0 ? ((short int) (w)) <= ((short int) (width)) + ((short int) (w)) : ((short int) (w)) < 0 ? ((short int) (width)) <= ((short int) (width)) + ((short int) (w)) : ((short int) (width)) + ((short int) (w)) < ((short int) (w))) || (((0 * (((short int) (width)) + ((short int) (w))) - (1)) < 0) && (((short int) (width)) + ((short int) (w))) < ((-32767 -1))) || (32767) < (((short int) (width)) + ((short int) (w)))) ? (*(&width) = (((unsigned short int) ((short int) (width)) + (unsigned short int) ((short int) (w))) <= (32767) ? (short int) ((unsigned short int) ((short int) (width)) + (unsigned short int) ((short int) (w))) : ((short int) (((unsigned short int) ((short int) (width)) + (unsigned short int) ((short int) (w))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&width) = (((unsigned short int) ((short int) (width)) + (unsigned short int) ((short int) (w))) <= (32767) ? (short int) ((unsigned short int) ((short int) (width)) + (unsigned short int) ((short int) (w))) : ((short int) (((unsigned short int) ((short int) (width)) + (unsigned short int) ((short int) (w))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : (((((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) < 0 ? ((w) < 0 ? (width) < ((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) - (w) : ((((0 * (0 * (w) + (width)) - (1)) < 0) ? ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) - (1)))) - (w) < (width)) : (width) < 0 ? (w) <= (width) + (w) : (w) < 0 ? (width) <= (width) + (w) : (width) + (w) < (w)) || (((0 * ((width) + (w)) - (1)) < 0) && ((width) + (w)) < ((-32767 -1))) || (32767) < ((width) + (w))) ? (*(&width) = (((unsigned short int) (width) + (unsigned short int) (w)) <= (32767) ? (short int) ((unsigned short int) (width) + (unsigned short int) (w)) : ((short int) (((unsigned short int) (width) + (unsigned short int) (w)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&width) = (((unsigned short int) (width) + (unsigned short int) (w)) <= (32767) ? (short int) ((unsigned short int) (width) + (unsigned short int) (w)) : ((short int) (((unsigned short int) (width) + (unsigned short int) (w)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&width) == sizeof (int) ? (sizeof ((width) + (w)) < sizeof (int) ? (((((((0 * (0 * ((int) (w)) + ((int) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (w)) + ((int) (width))) + (0)) == -1) - ((((0 * (0 * ((int) (w)) + ((int) (width))) + (1)) << (sizeof ((0 * ((int) (w)) + ((int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (w)) + ((int) (width))) + (0)))) < 0 ? (((int) (w)) < 0 ? ((int) (width)) < ((((0 * (0 * ((int) (w)) + ((int) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (w)) + ((int) (width))) + (0)) == -1) - ((((0 * (0 * ((int) (w)) + ((int) (width))) + (1)) << (sizeof ((0 * ((int) (w)) + ((int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (w)) + ((int) (width))) + (0)))) - ((int) (w)) : ((((0 * (0 * ((int) (w)) + ((int) (width))) - (1)) < 0) ? ((((0 * (0 * ((int) (w)) + ((int) (width))) + (1)) << (sizeof ((0 * ((int) (w)) + ((int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (w)) + ((int) (width))) - (1)))) - ((int) (w)) < ((int) (width))) : ((int) (width)) < 0 ? ((int) (w)) <= ((int) (width)) + ((int) (w)) : ((int) (w)) < 0 ? ((int) (width)) <= ((int) (width)) + ((int) (w)) : ((int) (width)) + ((int) (w)) < ((int) (w))) || (((0 * (((int) (width)) + ((int) (w))) - (1)) < 0) && (((int) (width)) + ((int) (w))) < ((-2147483647 -1))) || (2147483647) < (((int) (width)) + ((int) (w)))) ? (*(&width) = (((unsigned int) ((int) (width)) + (unsigned int) ((int) (w))) <= (2147483647) ? (int) ((unsigned int) ((int) (width)) + (unsigned int) ((int) (w))) : ((int) (((unsigned int) ((int) (width)) + (unsigned int) ((int) (w))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&width) = (((unsigned int) ((int) (width)) + (unsigned int) ((int) (w))) <= (2147483647) ? (int) ((unsigned int) ((int) (width)) + (unsigned int) ((int) (w))) : ((int) (((unsigned int) ((int) (width)) + (unsigned int) ((int) (w))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0)) : (((((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) < 0 ? ((w) < 0 ? (width) < ((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) - (w) : ((((0 * (0 * (w) + (width)) - (1)) < 0) ? ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) - (1)))) - (w) < (width)) : (width) < 0 ? (w) <= (width) + (w) : (w) < 0 ? (width) <= (width) + (w) : (width) + (w) < (w)) || (((0 * ((width) + (w)) - (1)) < 0) && ((width) + (w)) < ((-2147483647 -1))) || (2147483647) < ((width) + (w))) ? (*(&width) = (((unsigned int) (width) + (unsigned int) (w)) <= (2147483647) ? (int) ((unsigned int) (width) + (unsigned int) (w)) : ((int) (((unsigned int) (width) + (unsigned int) (w)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&width) = (((unsigned int) (width) + (unsigned int) (w)) <= (2147483647) ? (int) ((unsigned int) (width) + (unsigned int) (w)) : ((int) (((unsigned int) (width) + (unsigned int) (w)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0))) : (sizeof *(&width) == sizeof (long int) ? (sizeof ((width) + (w)) < sizeof (long int) ? (((((((0 * (0 * ((long int) (w)) + ((long int) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (w)) + ((long int) (width))) + (0)) == -1) - ((((0 * (0 * ((long int) (w)) + ((long int) (width))) + (1)) << (sizeof ((0 * ((long int) (w)) + ((long int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (w)) + ((long int) (width))) + (0)))) < 0 ? (((long int) (w)) < 0 ? ((long int) (width)) < ((((0 * (0 * ((long int) (w)) + ((long int) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (w)) + ((long int) (width))) + (0)) == -1) - ((((0 * (0 * ((long int) (w)) + ((long int) (width))) + (1)) << (sizeof ((0 * ((long int) (w)) + ((long int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (w)) + ((long int) (width))) + (0)))) - ((long int) (w)) : ((((0 * (0 * ((long int) (w)) + ((long int) (width))) - (1)) < 0) ? ((((0 * (0 * ((long int) (w)) + ((long int) (width))) + (1)) << (sizeof ((0 * ((long int) (w)) + ((long int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (w)) + ((long int) (width))) - (1)))) - ((long int) (w)) < ((long int) (width))) : ((long int) (width)) < 0 ? ((long int) (w)) <= ((long int) (width)) + ((long int) (w)) : ((long int) (w)) < 0 ? ((long int) (width)) <= ((long int) (width)) + ((long int) (w)) : ((long int) (width)) + ((long int) (w)) < ((long int) (w))) || (((0 * (((long int) (width)) + ((long int) (w))) - (1)) < 0) && (((long int) (width)) + ((long int) (w))) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < (((long int) (width)) + ((long int) (w)))) ? (*(&width) = (((unsigned long int) ((long int) (width)) + (unsigned long int) ((long int) (w))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (width)) + (unsigned long int) ((long int) (w))) : ((long int) (((unsigned long int) ((long int) (width)) + (unsigned long int) ((long int) (w))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&width) = (((unsigned long int) ((long int) (width)) + (unsigned long int) ((long int) (w))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (width)) + (unsigned long int) ((long int) (w))) : ((long int) (((unsigned long int) ((long int) (width)) + (unsigned long int) ((long int) (w))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0)) : (((((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) < 0 ? ((w) < 0 ? (width) < ((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) - (w) : ((((0 * (0 * (w) + (width)) - (1)) < 0) ? ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) - (1)))) - (w) < (width)) : (width) < 0 ? (w) <= (width) + (w) : (w) < 0 ? (width) <= (width) + (w) : (width) + (w) < (w)) || (((0 * ((width) + (w)) - (1)) < 0) && ((width) + (w)) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < ((width) + (w))) ? (*(&width) = (((unsigned long int) (width) + (unsigned long int) (w)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (width) + (unsigned long int) (w)) : ((long int) (((unsigned long int) (width) + (unsigned long int) (w)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&width) = (((unsigned long int) (width) + (unsigned long int) (w)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (width) + (unsigned long int) (w)) : ((long int) (((unsigned long int) (width) + (unsigned long int) (w)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0))) : (sizeof ((width) + (w)) < sizeof (long long int) ? (((((((0 * (0 * ((long long int) (w)) + ((long long int) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (w)) + ((long long int) (width))) + (0)) == -1) - ((((0 * (0 * ((long long int) (w)) + ((long long int) (width))) + (1)) << (sizeof ((0 * ((long long int) (w)) + ((long long int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (w)) + ((long long int) (width))) + (0)))) < 0 ? (((long long int) (w)) < 0 ? ((long long int) (width)) < ((((0 * (0 * ((long long int) (w)) + ((long long int) (width))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (w)) + ((long long int) (width))) + (0)) == -1) - ((((0 * (0 * ((long long int) (w)) + ((long long int) (width))) + (1)) << (sizeof ((0 * ((long long int) (w)) + ((long long int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (w)) + ((long long int) (width))) + (0)))) - ((long long int) (w)) : ((((0 * (0 * ((long long int) (w)) + ((long long int) (width))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (w)) + ((long long int) (width))) + (1)) << (sizeof ((0 * ((long long int) (w)) + ((long long int) (width))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (w)) + ((long long int) (width))) - (1)))) - ((long long int) (w)) < ((long long int) (width))) : ((long long int) (width)) < 0 ? ((long long int) (w)) <= ((long long int) (width)) + ((long long int) (w)) : ((long long int) (w)) < 0 ? ((long long int) (width)) <= ((long long int) (width)) + ((long long int) (w)) : ((long long int) (width)) + ((long long int) (w)) < ((long long int) (w))) || (((0 * (((long long int) (width)) + ((long long int) (w))) - (1)) < 0) && (((long long int) (width)) + ((long long int) (w))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (width)) + ((long long int) (w)))) ? (*(&width) = (((unsigned long long int) ((long long int) (width)) + (unsigned long long int) ((long long int) (w))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (width)) + (unsigned long long int) ((long long int) (w))) : ((long long int) (((unsigned long long int) ((long long int) (width)) + (unsigned long long int) ((long long int) (w))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&width) = (((unsigned long long int) ((long long int) (width)) + (unsigned long long int) ((long long int) (w))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (width)) + (unsigned long long int) ((long long int) (w))) : ((long long int) (((unsigned long long int) ((long long int) (width)) + (unsigned long long int) ((long long int) (w))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : (((((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) < 0 ? ((w) < 0 ? (width) < ((((0 * (0 * (w) + (width)) - (1)) < 0) ? - (~ (0 * (0 * (w) + (width)) + (0)) == -1) - ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) + (0)))) - (w) : ((((0 * (0 * (w) + (width)) - (1)) < 0) ? ((((0 * (0 * (w) + (width)) + (1)) << (sizeof ((0 * (w) + (width)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (w) + (width)) - (1)))) - (w) < (width)) : (width) < 0 ? (w) <= (width) + (w) : (w) < 0 ? (width) <= (width) + (w) : (width) + (w) < (w)) || (((0 * ((width) + (w)) - (1)) < 0) && ((width) + (w)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((width) + (w))) ? (*(&width) = (((unsigned long long int) (width) + (unsigned long long int) (w)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (width) + (unsigned long long int) (w)) : ((long long int) (((unsigned long long int) (width) + (unsigned long long int) (w)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&width) = (((unsigned long long int) (width) + (unsigned long long int) (w)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (width) + (unsigned long long int) (w)) : ((long long int) (((unsigned long long int) (width) + (unsigned long long int) (w)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0))))))
    string_overflow ();
       }
   }
    }
...
static struct Lisp_Subr _Alignas (8) Schar_width = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fchar_width }, 1, 1, "char-width", 0, 0}; Lisp_Object Fchar_width
  ...
  (Lisp_Object ch)
{
  ...
  return ((EMACS_INT) (((EMACS_UINT) (width) << INTTYPEBITS) + Lisp_Int0));
}
# 327 "character.c"
ptrdiff_t
  ...
  ptrdiff_t *nchars, ptrdiff_t *nbytes)
{
  ...
  while (i_byte < len)
    {
      int bytes;
      int c = (!((str + i_byte)[0] & 0x80) ? ((bytes) = 1, (str + i_byte)[0]) : ! ((str + i_byte)[0] & 0x20) ? ((bytes) = 2, (((((str + i_byte)[0] & 0x1F) << 6) | ((str + i_byte)[1] & 0x3F)) + (((unsigned char) (str + i_byte)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((str + i_byte)[0] & 0x10) ? ((bytes) = 3, ((((str + i_byte)[0] & 0x0F) << 12) | (((str + i_byte)[1] & 0x3F) << 6) | ((str + i_byte)[2] & 0x3F))) : string_char ((str + i_byte), ((void*)0), &bytes));
      ...
      if (0 < precision && precision - width < thiswidth)
 {
   ...
   *nbytes = i_byte;
   return width;
      ...
      if ((sizeof *(&width) == sizeof (signed char) ? (sizeof ((thiswidth) + (width)) < sizeof (signed char) ? (((((((0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) + (1)) << (sizeof ((0 * ((signed char) (width)) + ((signed char) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) + (0)))) < 0 ? (((signed char) (width)) < 0 ? ((signed char) (thiswidth)) < ((((0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) + (1)) << (sizeof ((0 * ((signed char) (width)) + ((signed char) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) + (0)))) - ((signed char) (width)) : ((((0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) + (1)) << (sizeof ((0 * ((signed char) (width)) + ((signed char) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (width)) + ((signed char) (thiswidth))) - (1)))) - ((signed char) (width)) < ((signed char) (thiswidth))) : ((signed char) (thiswidth)) < 0 ? ((signed char) (width)) <= ((signed char) (thiswidth)) + ((signed char) (width)) : ((signed char) (width)) < 0 ? ((signed char) (thiswidth)) <= ((signed char) (thiswidth)) + ((signed char) (width)) : ((signed char) (thiswidth)) + ((signed char) (width)) < ((signed char) (width))) || (((0 * (((signed char) (thiswidth)) + ((signed char) (width))) - (1)) < 0) && (((signed char) (thiswidth)) + ((signed char) (width))) < ((-127 -1))) || (127) < (((signed char) (thiswidth)) + ((signed char) (width)))) ? (*(&width) = (((unsigned char) ((signed char) (thiswidth)) + (unsigned char) ((signed char) (width))) <= (127) ? (signed char) ((unsigned char) ((signed char) (thiswidth)) + (unsigned char) ((signed char) (width))) : ((signed char) (((unsigned char) ((signed char) (thiswidth)) + (unsigned char) ((signed char) (width))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&width) = (((unsigned char) ((signed char) (thiswidth)) + (unsigned char) ((signed char) (width))) <= (127) ? (signed char) ((unsigned char) ((signed char) (thiswidth)) + (unsigned char) ((signed char) (width))) : ((signed char) (((unsigned char) ((signed char) (thiswidth)) + (unsigned char) ((signed char) (width))) - ((-127 -1))) + ((-127 -1)))), 0)) : (((((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) < 0 ? ((width) < 0 ? (thiswidth) < ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) - (width) : ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) - (1)))) - (width) < (thiswidth)) : (thiswidth) < 0 ? (width) <= (thiswidth) + (width) : (width) < 0 ? (thiswidth) <= (thiswidth) + (width) : (thiswidth) + (width) < (width)) || (((0 * ((thiswidth) + (width)) - (1)) < 0) && ((thiswidth) + (width)) < ((-127 -1))) || (127) < ((thiswidth) + (width))) ? (*(&width) = (((unsigned char) (thiswidth) + (unsigned char) (width)) <= (127) ? (signed char) ((unsigned char) (thiswidth) + (unsigned char) (width)) : ((signed char) (((unsigned char) (thiswidth) + (unsigned char) (width)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&width) = (((unsigned char) (thiswidth) + (unsigned char) (width)) <= (127) ? (signed char) ((unsigned char) (thiswidth) + (unsigned char) (width)) : ((signed char) (((unsigned char) (thiswidth) + (unsigned char) (width)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&width) == sizeof (short int) ? (sizeof ((thiswidth) + (width)) < sizeof (short int) ? (((((((0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) + (1)) << (sizeof ((0 * ((short int) (width)) + ((short int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) + (0)))) < 0 ? (((short int) (width)) < 0 ? ((short int) (thiswidth)) < ((((0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) + (1)) << (sizeof ((0 * ((short int) (width)) + ((short int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) + (0)))) - ((short int) (width)) : ((((0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) - (1)) < 0) ? ((((0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) + (1)) << (sizeof ((0 * ((short int) (width)) + ((short int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (width)) + ((short int) (thiswidth))) - (1)))) - ((short int) (width)) < ((short int) (thiswidth))) : ((short int) (thiswidth)) < 0 ? ((short int) (width)) <= ((short int) (thiswidth)) + ((short int) (width)) : ((short int) (width)) < 0 ? ((short int) (thiswidth)) <= ((short int) (thiswidth)) + ((short int) (width)) : ((short int) (thiswidth)) + ((short int) (width)) < ((short int) (width))) || (((0 * (((short int) (thiswidth)) + ((short int) (width))) - (1)) < 0) && (((short int) (thiswidth)) + ((short int) (width))) < ((-32767 -1))) || (32767) < (((short int) (thiswidth)) + ((short int) (width)))) ? (*(&width) = (((unsigned short int) ((short int) (thiswidth)) + (unsigned short int) ((short int) (width))) <= (32767) ? (short int) ((unsigned short int) ((short int) (thiswidth)) + (unsigned short int) ((short int) (width))) : ((short int) (((unsigned short int) ((short int) (thiswidth)) + (unsigned short int) ((short int) (width))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&width) = (((unsigned short int) ((short int) (thiswidth)) + (unsigned short int) ((short int) (width))) <= (32767) ? (short int) ((unsigned short int) ((short int) (thiswidth)) + (unsigned short int) ((short int) (width))) : ((short int) (((unsigned short int) ((short int) (thiswidth)) + (unsigned short int) ((short int) (width))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : (((((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) < 0 ? ((width) < 0 ? (thiswidth) < ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) - (width) : ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) - (1)))) - (width) < (thiswidth)) : (thiswidth) < 0 ? (width) <= (thiswidth) + (width) : (width) < 0 ? (thiswidth) <= (thiswidth) + (width) : (thiswidth) + (width) < (width)) || (((0 * ((thiswidth) + (width)) - (1)) < 0) && ((thiswidth) + (width)) < ((-32767 -1))) || (32767) < ((thiswidth) + (width))) ? (*(&width) = (((unsigned short int) (thiswidth) + (unsigned short int) (width)) <= (32767) ? (short int) ((unsigned short int) (thiswidth) + (unsigned short int) (width)) : ((short int) (((unsigned short int) (thiswidth) + (unsigned short int) (width)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&width) = (((unsigned short int) (thiswidth) + (unsigned short int) (width)) <= (32767) ? (short int) ((unsigned short int) (thiswidth) + (unsigned short int) (width)) : ((short int) (((unsigned short int) (thiswidth) + (unsigned short int) (width)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&width) == sizeof (int) ? (sizeof ((thiswidth) + (width)) < sizeof (int) ? (((((((0 * (0 * ((int) (width)) + ((int) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (width)) + ((int) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((int) (width)) + ((int) (thiswidth))) + (1)) << (sizeof ((0 * ((int) (width)) + ((int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (width)) + ((int) (thiswidth))) + (0)))) < 0 ? (((int) (width)) < 0 ? ((int) (thiswidth)) < ((((0 * (0 * ((int) (width)) + ((int) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (width)) + ((int) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((int) (width)) + ((int) (thiswidth))) + (1)) << (sizeof ((0 * ((int) (width)) + ((int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (width)) + ((int) (thiswidth))) + (0)))) - ((int) (width)) : ((((0 * (0 * ((int) (width)) + ((int) (thiswidth))) - (1)) < 0) ? ((((0 * (0 * ((int) (width)) + ((int) (thiswidth))) + (1)) << (sizeof ((0 * ((int) (width)) + ((int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (width)) + ((int) (thiswidth))) - (1)))) - ((int) (width)) < ((int) (thiswidth))) : ((int) (thiswidth)) < 0 ? ((int) (width)) <= ((int) (thiswidth)) + ((int) (width)) : ((int) (width)) < 0 ? ((int) (thiswidth)) <= ((int) (thiswidth)) + ((int) (width)) : ((int) (thiswidth)) + ((int) (width)) < ((int) (width))) || (((0 * (((int) (thiswidth)) + ((int) (width))) - (1)) < 0) && (((int) (thiswidth)) + ((int) (width))) < ((-2147483647 -1))) || (2147483647) < (((int) (thiswidth)) + ((int) (width)))) ? (*(&width) = (((unsigned int) ((int) (thiswidth)) + (unsigned int) ((int) (width))) <= (2147483647) ? (int) ((unsigned int) ((int) (thiswidth)) + (unsigned int) ((int) (width))) : ((int) (((unsigned int) ((int) (thiswidth)) + (unsigned int) ((int) (width))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&width) = (((unsigned int) ((int) (thiswidth)) + (unsigned int) ((int) (width))) <= (2147483647) ? (int) ((unsigned int) ((int) (thiswidth)) + (unsigned int) ((int) (width))) : ((int) (((unsigned int) ((int) (thiswidth)) + (unsigned int) ((int) (width))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0)) : (((((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) < 0 ? ((width) < 0 ? (thiswidth) < ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) - (width) : ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) - (1)))) - (width) < (thiswidth)) : (thiswidth) < 0 ? (width) <= (thiswidth) + (width) : (width) < 0 ? (thiswidth) <= (thiswidth) + (width) : (thiswidth) + (width) < (width)) || (((0 * ((thiswidth) + (width)) - (1)) < 0) && ((thiswidth) + (width)) < ((-2147483647 -1))) || (2147483647) < ((thiswidth) + (width))) ? (*(&width) = (((unsigned int) (thiswidth) + (unsigned int) (width)) <= (2147483647) ? (int) ((unsigned int) (thiswidth) + (unsigned int) (width)) : ((int) (((unsigned int) (thiswidth) + (unsigned int) (width)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&width) = (((unsigned int) (thiswidth) + (unsigned int) (width)) <= (2147483647) ? (int) ((unsigned int) (thiswidth) + (unsigned int) (width)) : ((int) (((unsigned int) (thiswidth) + (unsigned int) (width)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0))) : (sizeof *(&width) == sizeof (long int) ? (sizeof ((thiswidth) + (width)) < sizeof (long int) ? (((((((0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) + (1)) << (sizeof ((0 * ((long int) (width)) + ((long int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) + (0)))) < 0 ? (((long int) (width)) < 0 ? ((long int) (thiswidth)) < ((((0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) + (1)) << (sizeof ((0 * ((long int) (width)) + ((long int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) + (0)))) - ((long int) (width)) : ((((0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) - (1)) < 0) ? ((((0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) + (1)) << (sizeof ((0 * ((long int) (width)) + ((long int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (width)) + ((long int) (thiswidth))) - (1)))) - ((long int) (width)) < ((long int) (thiswidth))) : ((long int) (thiswidth)) < 0 ? ((long int) (width)) <= ((long int) (thiswidth)) + ((long int) (width)) : ((long int) (width)) < 0 ? ((long int) (thiswidth)) <= ((long int) (thiswidth)) + ((long int) (width)) : ((long int) (thiswidth)) + ((long int) (width)) < ((long int) (width))) || (((0 * (((long int) (thiswidth)) + ((long int) (width))) - (1)) < 0) && (((long int) (thiswidth)) + ((long int) (width))) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < (((long int) (thiswidth)) + ((long int) (width)))) ? (*(&width) = (((unsigned long int) ((long int) (thiswidth)) + (unsigned long int) ((long int) (width))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (thiswidth)) + (unsigned long int) ((long int) (width))) : ((long int) (((unsigned long int) ((long int) (thiswidth)) + (unsigned long int) ((long int) (width))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&width) = (((unsigned long int) ((long int) (thiswidth)) + (unsigned long int) ((long int) (width))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (thiswidth)) + (unsigned long int) ((long int) (width))) : ((long int) (((unsigned long int) ((long int) (thiswidth)) + (unsigned long int) ((long int) (width))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0)) : (((((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) < 0 ? ((width) < 0 ? (thiswidth) < ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) - (width) : ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) - (1)))) - (width) < (thiswidth)) : (thiswidth) < 0 ? (width) <= (thiswidth) + (width) : (width) < 0 ? (thiswidth) <= (thiswidth) + (width) : (thiswidth) + (width) < (width)) || (((0 * ((thiswidth) + (width)) - (1)) < 0) && ((thiswidth) + (width)) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < ((thiswidth) + (width))) ? (*(&width) = (((unsigned long int) (thiswidth) + (unsigned long int) (width)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (thiswidth) + (unsigned long int) (width)) : ((long int) (((unsigned long int) (thiswidth) + (unsigned long int) (width)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&width) = (((unsigned long int) (thiswidth) + (unsigned long int) (width)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (thiswidth) + (unsigned long int) (width)) : ((long int) (((unsigned long int) (thiswidth) + (unsigned long int) (width)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0))) : (sizeof ((thiswidth) + (width)) < sizeof (long long int) ? (((((((0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) + (1)) << (sizeof ((0 * ((long long int) (width)) + ((long long int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) + (0)))) < 0 ? (((long long int) (width)) < 0 ? ((long long int) (thiswidth)) < ((((0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) + (0)) == -1) - ((((0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) + (1)) << (sizeof ((0 * ((long long int) (width)) + ((long long int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) + (0)))) - ((long long int) (width)) : ((((0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) + (1)) << (sizeof ((0 * ((long long int) (width)) + ((long long int) (thiswidth))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (width)) + ((long long int) (thiswidth))) - (1)))) - ((long long int) (width)) < ((long long int) (thiswidth))) : ((long long int) (thiswidth)) < 0 ? ((long long int) (width)) <= ((long long int) (thiswidth)) + ((long long int) (width)) : ((long long int) (width)) < 0 ? ((long long int) (thiswidth)) <= ((long long int) (thiswidth)) + ((long long int) (width)) : ((long long int) (thiswidth)) + ((long long int) (width)) < ((long long int) (width))) || (((0 * (((long long int) (thiswidth)) + ((long long int) (width))) - (1)) < 0) && (((long long int) (thiswidth)) + ((long long int) (width))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (thiswidth)) + ((long long int) (width)))) ? (*(&width) = (((unsigned long long int) ((long long int) (thiswidth)) + (unsigned long long int) ((long long int) (width))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (thiswidth)) + (unsigned long long int) ((long long int) (width))) : ((long long int) (((unsigned long long int) ((long long int) (thiswidth)) + (unsigned long long int) ((long long int) (width))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&width) = (((unsigned long long int) ((long long int) (thiswidth)) + (unsigned long long int) ((long long int) (width))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (thiswidth)) + (unsigned long long int) ((long long int) (width))) : ((long long int) (((unsigned long long int) ((long long int) (thiswidth)) + (unsigned long long int) ((long long int) (width))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : (((((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) < 0 ? ((width) < 0 ? (thiswidth) < ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? - (~ (0 * (0 * (width) + (thiswidth)) + (0)) == -1) - ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) + (0)))) - (width) : ((((0 * (0 * (width) + (thiswidth)) - (1)) < 0) ? ((((0 * (0 * (width) + (thiswidth)) + (1)) << (sizeof ((0 * (width) + (thiswidth)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (width) + (thiswidth)) - (1)))) - (width) < (thiswidth)) : (thiswidth) < 0 ? (width) <= (thiswidth) + (width) : (width) < 0 ? (thiswidth) <= (thiswidth) + (width) : (thiswidth) + (width) < (width)) || (((0 * ((thiswidth) + (width)) - (1)) < 0) && ((thiswidth) + (width)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((thiswidth) + (width))) ? (*(&width) = (((unsigned long long int) (thiswidth) + (unsigned long long int) (width)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (thiswidth) + (unsigned long long int) (width)) : ((long long int) (((unsigned long long int) (thiswidth) + (unsigned long long int) (width)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&width) = (((unsigned long long int) (thiswidth) + (unsigned long long int) (width)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (thiswidth) + (unsigned long long int) (width)) : ((long long int) (((unsigned long long int) (thiswidth) + (unsigned long long int) (width)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0))))))
 string_overflow ();
      i++;
      i_byte += bytes;
  }
...
{
  return c_string_width ((const unsigned char *) str, len, -1, ((void*)0), ((void*)0));
}
# 379 "character.c"
ptrdiff_t
     ...
     ptrdiff_t *nchars, ptrdiff_t *nbytes)
{
  ...
  _Bool multibyte = len < SBYTES (string);
      ...
      else
 {
   ...
   if (multibyte)
     {
       int cbytes;
       c = (!((str + i_byte)[0] & 0x80) ? ((cbytes) = 1, (str + i_byte)[0]) : ! ((str + i_byte)[0] & 0x20) ? ((cbytes) = 2, (((((str + i_byte)[0] & 0x1F) << 6) | ((str + i_byte)[1] & 0x3F)) + (((unsigned char) (str + i_byte)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((str + i_byte)[0] & 0x10) ? ((cbytes) = 3, ((((str + i_byte)[0] & 0x0F) << 12) | (((str + i_byte)[1] & 0x3F) << 6) | ((str + i_byte)[2] & 0x3F))) : string_char ((str + i_byte), ((void*)0), &cbytes));
       bytes = cbytes;
     }
   else
...
static struct Lisp_Subr _Alignas (8) Sstring_width = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fstring_width }, 1, 1, "string-width", 0, 0}; Lisp_Object Fstring_width
  ...
  (Lisp_Object str)
{
  ...
  CHECK_STRING (str);
  ((val) = make_natnum (lisp_string_width (str, -1, ((void*)0), ((void*)0))));
  return val;
}
...
multibyte_chars_in_text (const unsigned char *ptr, ptrdiff_t nbytes)
{
  ...
  while (ptr < endp)
    {
      int len = (ptr >= endp ? 0 : !((ptr)[0] & 0x80) ? 1 : ((ptr + 1 >= endp) || (((ptr)[1] & 0xC0) != 0x80)) ? 0 : ((ptr)[0] & 0xE0) == 0xC0 ? 2 : ((ptr + 2 >= endp) || (((ptr)[2] & 0xC0) != 0x80)) ? 0 : ((ptr)[0] & 0xF0) == 0xE0 ? 3 : ((ptr + 3 >= endp) || (((ptr)[3] & 0xC0) != 0x80)) ? 0 : ((ptr)[0] & 0xF8) == 0xF0 ? 4 : ((ptr + 4 >= endp) || (((ptr)[4] & 0xC0) != 0x80)) ? 0 : (ptr)[0] == 0xF8 && ((ptr)[1] & 0xF0) == 0x80 ? 5 : 0);
   ...
   ptrdiff_t *nchars, ptrdiff_t *nbytes)
{
  ...
  if (len >= 5)
    {
      const unsigned char *adjusted_endp = endp - 5;
      while (str < adjusted_endp)
 {
   if (! ((*str) == 0xC0 || (*str) == 0xC1)
       && (n = (!((str)[0] & 0x80) ? 1 : ((str)[1] & 0xC0) != 0x80 ? 0 : ((str)[0] & 0xE0) == 0xC0 ? 2 : ((str)[2] & 0xC0) != 0x80 ? 0 : ((str)[0] & 0xF0) == 0xE0 ? 3 : ((str)[3] & 0xC0) != 0x80 ? 0 : ((str)[0] & 0xF8) == 0xF0 ? 4 : ((str)[4] & 0xC0) != 0x80 ? 0 : (str)[0] == 0xF8 && ((str)[1] & 0xF0) == 0x80 ? 5 : 0)) > 0)
     str += n, bytes += n;
   else
     str++, bytes += 2;
   chars++;
  ...
  while (str < endp)
    {
      if (! ((*str) == 0xC0 || (*str) == 0xC1)
   && (n = (str >= endp ? 0 : !((str)[0] & 0x80) ? 1 : ((str + 1 >= endp) || (((str)[1] & 0xC0) != 0x80)) ? 0 : ((str)[0] & 0xE0) == 0xC0 ? 2 : ((str + 2 >= endp) || (((str)[2] & 0xC0) != 0x80)) ? 0 : ((str)[0] & 0xF0) == 0xE0 ? 3 : ((str + 3 >= endp) || (((str)[3] & 0xC0) != 0x80)) ? 0 : ((str)[0] & 0xF8) == 0xF0 ? 4 : ((str + 4 >= endp) || (((str)[4] & 0xC0) != 0x80)) ? 0 : (str)[0] == 0xF8 && ((str)[1] & 0xF0) == 0x80 ? 5 : 0)) > 0)
 str += n, bytes += n;
      else
 str++, bytes += 2;
      chars++;
    ...
    ptrdiff_t *nchars)
{
  ...
  if (nbytes >= 5)
    {
      unsigned char *adjusted_endp = endp - 5;
      while (p < adjusted_endp
      && ! ((*p) == 0xC0 || (*p) == 0xC1)
      && (n = (!((p)[0] & 0x80) ? 1 : ((p)[1] & 0xC0) != 0x80 ? 0 : ((p)[0] & 0xE0) == 0xC0 ? 2 : ((p)[2] & 0xC0) != 0x80 ? 0 : ((p)[0] & 0xF0) == 0xE0 ? 3 : ((p)[3] & 0xC0) != 0x80 ? 0 : ((p)[0] & 0xF8) == 0xF0 ? 4 : ((p)[4] & 0xC0) != 0x80 ? 0 : (p)[0] == 0xF8 && ((p)[1] & 0xF0) == 0x80 ? 5 : 0)) > 0)
 p += n, chars++;
    }
  while (p < endp
  && ! ((*p) == 0xC0 || (*p) == 0xC1)
  && (n = (p >= endp ? 0 : !((p)[0] & 0x80) ? 1 : ((p + 1 >= endp) || (((p)[1] & 0xC0) != 0x80)) ? 0 : ((p)[0] & 0xE0) == 0xC0 ? 2 : ((p + 2 >= endp) || (((p)[2] & 0xC0) != 0x80)) ? 0 : ((p)[0] & 0xF0) == 0xE0 ? 3 : ((p + 3 >= endp) || (((p)[3] & 0xC0) != 0x80)) ? 0 : ((p)[0] & 0xF8) == 0xF0 ? 4 : ((p + 4 >= endp) || (((p)[4] & 0xC0) != 0x80)) ? 0 : (p)[0] == 0xF8 && ((p)[1] & 0xF0) == 0x80 ? 5 : 0)) > 0)
    p += n, chars++;
  if (nchars)
    *nchars = chars;
  if (p == endp)
  ...
  *to++ = *p++;
   ...
   else
     {
       int c = *p++;
       c = ((c) + 0x3FFF00);
       to += ((((sizeof ((c) + 0)) > (sizeof ((0x7F) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x7F) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0x7F) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0x7F) + (uintmax_t) 0)) ? ((to)[0] = (c), 1) : (((sizeof ((c) + 0)) > (sizeof ((0x7FF) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x7FF) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0x7FF) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0x7FF) + (uintmax_t) 0)) ? ((to)[0] = (0xC0 | ((c) >> 6)), (to)[1] = (0x80 | ((c) & 0x3F)), 2) : (((sizeof ((c) + 0)) > (sizeof ((0xFFFF) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0xFFFF) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0xFFFF) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0xFFFF) + (uintmax_t) 0)) ? ((to)[0] = (0xE0 | ((c) >> 12)), (to)[1] = (0x80 | (((c) >> 6) & 0x3F)), (to)[2] = (0x80 | ((c) & 0x3F)), 3) : ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (c) <= sizeof (unsigned)) ? 1 : -1; })) ? (char_string (c, to)) : (char_string (c, to))));
     }
 }
      chars++;
    }
...
count_size_as_multibyte (const unsigned char *str, ptrdiff_t len)
{
  ...
  for (bytes = 0; str < endp; str++)
    {
      int n = *str < 0x80 ? 1 : 2;
      if ((sizeof *(&bytes) == sizeof (signed char) ? (sizeof ((bytes) + (n)) < sizeof (signed char) ? (((((((0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) + (0)) == -1) - ((((0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) + (1)) << (sizeof ((0 * ((signed char) (n)) + ((signed char) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) + (0)))) < 0 ? (((signed char) (n)) < 0 ? ((signed char) (bytes)) < ((((0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) + (0)) == -1) - ((((0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) + (1)) << (sizeof ((0 * ((signed char) (n)) + ((signed char) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) + (0)))) - ((signed char) (n)) : ((((0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) + (1)) << (sizeof ((0 * ((signed char) (n)) + ((signed char) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (n)) + ((signed char) (bytes))) - (1)))) - ((signed char) (n)) < ((signed char) (bytes))) : ((signed char) (bytes)) < 0 ? ((signed char) (n)) <= ((signed char) (bytes)) + ((signed char) (n)) : ((signed char) (n)) < 0 ? ((signed char) (bytes)) <= ((signed char) (bytes)) + ((signed char) (n)) : ((signed char) (bytes)) + ((signed char) (n)) < ((signed char) (n))) || (((0 * (((signed char) (bytes)) + ((signed char) (n))) - (1)) < 0) && (((signed char) (bytes)) + ((signed char) (n))) < ((-127 -1))) || (127) < (((signed char) (bytes)) + ((signed char) (n)))) ? (*(&bytes) = (((unsigned char) ((signed char) (bytes)) + (unsigned char) ((signed char) (n))) <= (127) ? (signed char) ((unsigned char) ((signed char) (bytes)) + (unsigned char) ((signed char) (n))) : ((signed char) (((unsigned char) ((signed char) (bytes)) + (unsigned char) ((signed char) (n))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&bytes) = (((unsigned char) ((signed char) (bytes)) + (unsigned char) ((signed char) (n))) <= (127) ? (signed char) ((unsigned char) ((signed char) (bytes)) + (unsigned char) ((signed char) (n))) : ((signed char) (((unsigned char) ((signed char) (bytes)) + (unsigned char) ((signed char) (n))) - ((-127 -1))) + ((-127 -1)))), 0)) : (((((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) < 0 ? ((n) < 0 ? (bytes) < ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) - (n) : ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) - (1)))) - (n) < (bytes)) : (bytes) < 0 ? (n) <= (bytes) + (n) : (n) < 0 ? (bytes) <= (bytes) + (n) : (bytes) + (n) < (n)) || (((0 * ((bytes) + (n)) - (1)) < 0) && ((bytes) + (n)) < ((-127 -1))) || (127) < ((bytes) + (n))) ? (*(&bytes) = (((unsigned char) (bytes) + (unsigned char) (n)) <= (127) ? (signed char) ((unsigned char) (bytes) + (unsigned char) (n)) : ((signed char) (((unsigned char) (bytes) + (unsigned char) (n)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&bytes) = (((unsigned char) (bytes) + (unsigned char) (n)) <= (127) ? (signed char) ((unsigned char) (bytes) + (unsigned char) (n)) : ((signed char) (((unsigned char) (bytes) + (unsigned char) (n)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&bytes) == sizeof (short int) ? (sizeof ((bytes) + (n)) < sizeof (short int) ? (((((((0 * (0 * ((short int) (n)) + ((short int) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (n)) + ((short int) (bytes))) + (0)) == -1) - ((((0 * (0 * ((short int) (n)) + ((short int) (bytes))) + (1)) << (sizeof ((0 * ((short int) (n)) + ((short int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (n)) + ((short int) (bytes))) + (0)))) < 0 ? (((short int) (n)) < 0 ? ((short int) (bytes)) < ((((0 * (0 * ((short int) (n)) + ((short int) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (n)) + ((short int) (bytes))) + (0)) == -1) - ((((0 * (0 * ((short int) (n)) + ((short int) (bytes))) + (1)) << (sizeof ((0 * ((short int) (n)) + ((short int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (n)) + ((short int) (bytes))) + (0)))) - ((short int) (n)) : ((((0 * (0 * ((short int) (n)) + ((short int) (bytes))) - (1)) < 0) ? ((((0 * (0 * ((short int) (n)) + ((short int) (bytes))) + (1)) << (sizeof ((0 * ((short int) (n)) + ((short int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (n)) + ((short int) (bytes))) - (1)))) - ((short int) (n)) < ((short int) (bytes))) : ((short int) (bytes)) < 0 ? ((short int) (n)) <= ((short int) (bytes)) + ((short int) (n)) : ((short int) (n)) < 0 ? ((short int) (bytes)) <= ((short int) (bytes)) + ((short int) (n)) : ((short int) (bytes)) + ((short int) (n)) < ((short int) (n))) || (((0 * (((short int) (bytes)) + ((short int) (n))) - (1)) < 0) && (((short int) (bytes)) + ((short int) (n))) < ((-32767 -1))) || (32767) < (((short int) (bytes)) + ((short int) (n)))) ? (*(&bytes) = (((unsigned short int) ((short int) (bytes)) + (unsigned short int) ((short int) (n))) <= (32767) ? (short int) ((unsigned short int) ((short int) (bytes)) + (unsigned short int) ((short int) (n))) : ((short int) (((unsigned short int) ((short int) (bytes)) + (unsigned short int) ((short int) (n))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&bytes) = (((unsigned short int) ((short int) (bytes)) + (unsigned short int) ((short int) (n))) <= (32767) ? (short int) ((unsigned short int) ((short int) (bytes)) + (unsigned short int) ((short int) (n))) : ((short int) (((unsigned short int) ((short int) (bytes)) + (unsigned short int) ((short int) (n))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : (((((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) < 0 ? ((n) < 0 ? (bytes) < ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) - (n) : ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) - (1)))) - (n) < (bytes)) : (bytes) < 0 ? (n) <= (bytes) + (n) : (n) < 0 ? (bytes) <= (bytes) + (n) : (bytes) + (n) < (n)) || (((0 * ((bytes) + (n)) - (1)) < 0) && ((bytes) + (n)) < ((-32767 -1))) || (32767) < ((bytes) + (n))) ? (*(&bytes) = (((unsigned short int) (bytes) + (unsigned short int) (n)) <= (32767) ? (short int) ((unsigned short int) (bytes) + (unsigned short int) (n)) : ((short int) (((unsigned short int) (bytes) + (unsigned short int) (n)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&bytes) = (((unsigned short int) (bytes) + (unsigned short int) (n)) <= (32767) ? (short int) ((unsigned short int) (bytes) + (unsigned short int) (n)) : ((short int) (((unsigned short int) (bytes) + (unsigned short int) (n)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&bytes) == sizeof (int) ? (sizeof ((bytes) + (n)) < sizeof (int) ? (((((((0 * (0 * ((int) (n)) + ((int) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (n)) + ((int) (bytes))) + (0)) == -1) - ((((0 * (0 * ((int) (n)) + ((int) (bytes))) + (1)) << (sizeof ((0 * ((int) (n)) + ((int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (n)) + ((int) (bytes))) + (0)))) < 0 ? (((int) (n)) < 0 ? ((int) (bytes)) < ((((0 * (0 * ((int) (n)) + ((int) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (n)) + ((int) (bytes))) + (0)) == -1) - ((((0 * (0 * ((int) (n)) + ((int) (bytes))) + (1)) << (sizeof ((0 * ((int) (n)) + ((int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (n)) + ((int) (bytes))) + (0)))) - ((int) (n)) : ((((0 * (0 * ((int) (n)) + ((int) (bytes))) - (1)) < 0) ? ((((0 * (0 * ((int) (n)) + ((int) (bytes))) + (1)) << (sizeof ((0 * ((int) (n)) + ((int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (n)) + ((int) (bytes))) - (1)))) - ((int) (n)) < ((int) (bytes))) : ((int) (bytes)) < 0 ? ((int) (n)) <= ((int) (bytes)) + ((int) (n)) : ((int) (n)) < 0 ? ((int) (bytes)) <= ((int) (bytes)) + ((int) (n)) : ((int) (bytes)) + ((int) (n)) < ((int) (n))) || (((0 * (((int) (bytes)) + ((int) (n))) - (1)) < 0) && (((int) (bytes)) + ((int) (n))) < ((-2147483647 -1))) || (2147483647) < (((int) (bytes)) + ((int) (n)))) ? (*(&bytes) = (((unsigned int) ((int) (bytes)) + (unsigned int) ((int) (n))) <= (2147483647) ? (int) ((unsigned int) ((int) (bytes)) + (unsigned int) ((int) (n))) : ((int) (((unsigned int) ((int) (bytes)) + (unsigned int) ((int) (n))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&bytes) = (((unsigned int) ((int) (bytes)) + (unsigned int) ((int) (n))) <= (2147483647) ? (int) ((unsigned int) ((int) (bytes)) + (unsigned int) ((int) (n))) : ((int) (((unsigned int) ((int) (bytes)) + (unsigned int) ((int) (n))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0)) : (((((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) < 0 ? ((n) < 0 ? (bytes) < ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) - (n) : ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) - (1)))) - (n) < (bytes)) : (bytes) < 0 ? (n) <= (bytes) + (n) : (n) < 0 ? (bytes) <= (bytes) + (n) : (bytes) + (n) < (n)) || (((0 * ((bytes) + (n)) - (1)) < 0) && ((bytes) + (n)) < ((-2147483647 -1))) || (2147483647) < ((bytes) + (n))) ? (*(&bytes) = (((unsigned int) (bytes) + (unsigned int) (n)) <= (2147483647) ? (int) ((unsigned int) (bytes) + (unsigned int) (n)) : ((int) (((unsigned int) (bytes) + (unsigned int) (n)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&bytes) = (((unsigned int) (bytes) + (unsigned int) (n)) <= (2147483647) ? (int) ((unsigned int) (bytes) + (unsigned int) (n)) : ((int) (((unsigned int) (bytes) + (unsigned int) (n)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0))) : (sizeof *(&bytes) == sizeof (long int) ? (sizeof ((bytes) + (n)) < sizeof (long int) ? (((((((0 * (0 * ((long int) (n)) + ((long int) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (n)) + ((long int) (bytes))) + (0)) == -1) - ((((0 * (0 * ((long int) (n)) + ((long int) (bytes))) + (1)) << (sizeof ((0 * ((long int) (n)) + ((long int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (n)) + ((long int) (bytes))) + (0)))) < 0 ? (((long int) (n)) < 0 ? ((long int) (bytes)) < ((((0 * (0 * ((long int) (n)) + ((long int) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (n)) + ((long int) (bytes))) + (0)) == -1) - ((((0 * (0 * ((long int) (n)) + ((long int) (bytes))) + (1)) << (sizeof ((0 * ((long int) (n)) + ((long int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (n)) + ((long int) (bytes))) + (0)))) - ((long int) (n)) : ((((0 * (0 * ((long int) (n)) + ((long int) (bytes))) - (1)) < 0) ? ((((0 * (0 * ((long int) (n)) + ((long int) (bytes))) + (1)) << (sizeof ((0 * ((long int) (n)) + ((long int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (n)) + ((long int) (bytes))) - (1)))) - ((long int) (n)) < ((long int) (bytes))) : ((long int) (bytes)) < 0 ? ((long int) (n)) <= ((long int) (bytes)) + ((long int) (n)) : ((long int) (n)) < 0 ? ((long int) (bytes)) <= ((long int) (bytes)) + ((long int) (n)) : ((long int) (bytes)) + ((long int) (n)) < ((long int) (n))) || (((0 * (((long int) (bytes)) + ((long int) (n))) - (1)) < 0) && (((long int) (bytes)) + ((long int) (n))) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < (((long int) (bytes)) + ((long int) (n)))) ? (*(&bytes) = (((unsigned long int) ((long int) (bytes)) + (unsigned long int) ((long int) (n))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (bytes)) + (unsigned long int) ((long int) (n))) : ((long int) (((unsigned long int) ((long int) (bytes)) + (unsigned long int) ((long int) (n))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&bytes) = (((unsigned long int) ((long int) (bytes)) + (unsigned long int) ((long int) (n))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (bytes)) + (unsigned long int) ((long int) (n))) : ((long int) (((unsigned long int) ((long int) (bytes)) + (unsigned long int) ((long int) (n))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0)) : (((((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) < 0 ? ((n) < 0 ? (bytes) < ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) - (n) : ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) - (1)))) - (n) < (bytes)) : (bytes) < 0 ? (n) <= (bytes) + (n) : (n) < 0 ? (bytes) <= (bytes) + (n) : (bytes) + (n) < (n)) || (((0 * ((bytes) + (n)) - (1)) < 0) && ((bytes) + (n)) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < ((bytes) + (n))) ? (*(&bytes) = (((unsigned long int) (bytes) + (unsigned long int) (n)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (bytes) + (unsigned long int) (n)) : ((long int) (((unsigned long int) (bytes) + (unsigned long int) (n)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&bytes) = (((unsigned long int) (bytes) + (unsigned long int) (n)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (bytes) + (unsigned long int) (n)) : ((long int) (((unsigned long int) (bytes) + (unsigned long int) (n)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0))) : (sizeof ((bytes) + (n)) < sizeof (long long int) ? (((((((0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) + (0)) == -1) - ((((0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) + (1)) << (sizeof ((0 * ((long long int) (n)) + ((long long int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) + (0)))) < 0 ? (((long long int) (n)) < 0 ? ((long long int) (bytes)) < ((((0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) + (0)) == -1) - ((((0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) + (1)) << (sizeof ((0 * ((long long int) (n)) + ((long long int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) + (0)))) - ((long long int) (n)) : ((((0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) + (1)) << (sizeof ((0 * ((long long int) (n)) + ((long long int) (bytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (n)) + ((long long int) (bytes))) - (1)))) - ((long long int) (n)) < ((long long int) (bytes))) : ((long long int) (bytes)) < 0 ? ((long long int) (n)) <= ((long long int) (bytes)) + ((long long int) (n)) : ((long long int) (n)) < 0 ? ((long long int) (bytes)) <= ((long long int) (bytes)) + ((long long int) (n)) : ((long long int) (bytes)) + ((long long int) (n)) < ((long long int) (n))) || (((0 * (((long long int) (bytes)) + ((long long int) (n))) - (1)) < 0) && (((long long int) (bytes)) + ((long long int) (n))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (bytes)) + ((long long int) (n)))) ? (*(&bytes) = (((unsigned long long int) ((long long int) (bytes)) + (unsigned long long int) ((long long int) (n))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (bytes)) + (unsigned long long int) ((long long int) (n))) : ((long long int) (((unsigned long long int) ((long long int) (bytes)) + (unsigned long long int) ((long long int) (n))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&bytes) = (((unsigned long long int) ((long long int) (bytes)) + (unsigned long long int) ((long long int) (n))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (bytes)) + (unsigned long long int) ((long long int) (n))) : ((long long int) (((unsigned long long int) ((long long int) (bytes)) + (unsigned long long int) ((long long int) (n))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : (((((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) < 0 ? ((n) < 0 ? (bytes) < ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? - (~ (0 * (0 * (n) + (bytes)) + (0)) == -1) - ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) + (0)))) - (n) : ((((0 * (0 * (n) + (bytes)) - (1)) < 0) ? ((((0 * (0 * (n) + (bytes)) + (1)) << (sizeof ((0 * (n) + (bytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (n) + (bytes)) - (1)))) - (n) < (bytes)) : (bytes) < 0 ? (n) <= (bytes) + (n) : (n) < 0 ? (bytes) <= (bytes) + (n) : (bytes) + (n) < (n)) || (((0 * ((bytes) + (n)) - (1)) < 0) && ((bytes) + (n)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((bytes) + (n))) ? (*(&bytes) = (((unsigned long long int) (bytes) + (unsigned long long int) (n)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (bytes) + (unsigned long long int) (n)) : ((long long int) (((unsigned long long int) (bytes) + (unsigned long long int) (n)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&bytes) = (((unsigned long long int) (bytes) + (unsigned long long int) (n)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (bytes) + (unsigned long long int) (n)) : ((long long int) (((unsigned long long int) (bytes) + (unsigned long long int) (n)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0))))))
        string_overflow ();
    }
  return bytes;
}
...
str_as_unibyte (unsigned char *str, ptrdiff_t bytes)
{
  ...
  while (p < endp)
    {
      c = *p;
      len = (!((c) & 0x80) ? 1 : !((c) & 0x20) ? 2 : !((c) & 0x10) ? 3 : !((c) & 0x08) ? 4 : 5);
      if (((c) == 0xC0 || (c) == 0xC1))
 break;
      p += len;
    }
 ...
 {
   c = (!((p)[0] & 0x80) ? *(p)++ : ! ((p)[0] & 0x20) ? ((p) += 2, ((((p)[-2] & 0x1F) << 6) | ((p)[-1] & 0x3F) | ((unsigned char) ((p)[-2]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((p)[0] & 0x10) ? ((p) += 3, ((((p)[-3] & 0x0F) << 12) | (((p)[-2] & 0x3F) << 6) | ((p)[-1] & 0x3F))) : string_char ((p), &(p), ((void*)0)));
   *to++ = (((c) > 0x3FFF7F) ? (c) - 0x3FFF00 : (c & 0xFF));
 }
      else
 {
   while (len--) *to++ = *p++;
...
str_to_unibyte (const unsigned char *src, unsigned char *dst, ptrdiff_t chars)
{
  ...
  for (i = 0; i < chars; i++)
    {
      int c = (!((src)[0] & 0x80) ? *(src)++ : ! ((src)[0] & 0x20) ? ((src) += 2, ((((src)[-2] & 0x1F) << 6) | ((src)[-1] & 0x3F) | ((unsigned char) ((src)[-2]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((src)[0] & 0x10) ? ((src) += 3, ((((src)[-3] & 0x0F) << 12) | (((src)[-2] & 0x3F) << 6) | ((src)[-1] & 0x3F))) : string_char ((src), &(src), ((void*)0)));
...
{
  _Bool multibyte = STRING_MULTIBYTE (string);
...
string_escape_byte8 (Lisp_Object string)
{
  ...
  if ((sizeof *(&thrice_byte8_count) == sizeof (signed char) ? (sizeof ((byte8_count) * (3)) < sizeof (signed char) ? ((((((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (1)) << (sizeof ((0 * ((signed char) (3)) + ((signed char) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (0)))) == 0 && ((((signed char) (byte8_count)) < 0 && 0 < ((signed char) (3))) || (((signed char) (3)) < 0 && 0 < ((signed char) (byte8_count))))) || (((signed char) (3)) < 0 ? (((signed char) (byte8_count)) < 0 ? ((signed char) (byte8_count)) < ((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (1)) << (sizeof ((0 * ((signed char) (3)) + ((signed char) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) - (1)))) / ((signed char) (3)) : ((signed char) (3)) == -1 ? 0 : ((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (1)) << (sizeof ((0 * ((signed char) (3)) + ((signed char) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (0)))) / ((signed char) (3)) < ((signed char) (byte8_count))) : ((signed char) (3)) == 0 ? 0 : (((signed char) (byte8_count)) < 0 ? ((signed char) (byte8_count)) < ((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (1)) << (sizeof ((0 * ((signed char) (3)) + ((signed char) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (0)))) / ((signed char) (3)) : ((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) + (1)) << (sizeof ((0 * ((signed char) (3)) + ((signed char) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (3)) + ((signed char) (byte8_count))) - (1)))) / ((signed char) (3)) < ((signed char) (byte8_count))))) || (((0 * (((signed char) (byte8_count)) * ((signed char) (3))) - (1)) < 0) && (((signed char) (byte8_count)) * ((signed char) (3))) < ((-127 -1))) || (127) < (((signed char) (byte8_count)) * ((signed char) (3)))) ? (*(&thrice_byte8_count) = (((unsigned char) ((signed char) (byte8_count)) * (unsigned char) ((signed char) (3))) <= (127) ? (signed char) ((unsigned char) ((signed char) (byte8_count)) * (unsigned char) ((signed char) (3))) : ((signed char) (((unsigned char) ((signed char) (byte8_count)) * (unsigned char) ((signed char) (3))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&thrice_byte8_count) = (((unsigned char) ((signed char) (byte8_count)) * (unsigned char) ((signed char) (3))) <= (127) ? (signed char) ((unsigned char) ((signed char) (byte8_count)) * (unsigned char) ((signed char) (3))) : ((signed char) (((unsigned char) ((signed char) (byte8_count)) * (unsigned char) ((signed char) (3))) - ((-127 -1))) + ((-127 -1)))), 0)) : ((((((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) == 0 && (((byte8_count) < 0 && 0 < (3)) || ((3) < 0 && 0 < (byte8_count)))) || ((3) < 0 ? ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) : (3) == -1 ? 0 : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) < (byte8_count)) : (3) == 0 ? 0 : ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) < (byte8_count)))) || (((0 * ((byte8_count) * (3)) - (1)) < 0) && ((byte8_count) * (3)) < ((-127 -1))) || (127) < ((byte8_count) * (3))) ? (*(&thrice_byte8_count) = (((unsigned char) (byte8_count) * (unsigned char) (3)) <= (127) ? (signed char) ((unsigned char) (byte8_count) * (unsigned char) (3)) : ((signed char) (((unsigned char) (byte8_count) * (unsigned char) (3)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&thrice_byte8_count) = (((unsigned char) (byte8_count) * (unsigned char) (3)) <= (127) ? (signed char) ((unsigned char) (byte8_count) * (unsigned char) (3)) : ((signed char) (((unsigned char) (byte8_count) * (unsigned char) (3)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&thrice_byte8_count) == sizeof (short int) ? (sizeof ((byte8_count) * (3)) < sizeof (short int) ? ((((((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (1)) << (sizeof ((0 * ((short int) (3)) + ((short int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (0)))) == 0 && ((((short int) (byte8_count)) < 0 && 0 < ((short int) (3))) || (((short int) (3)) < 0 && 0 < ((short int) (byte8_count))))) || (((short int) (3)) < 0 ? (((short int) (byte8_count)) < 0 ? ((short int) (byte8_count)) < ((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (1)) << (sizeof ((0 * ((short int) (3)) + ((short int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) - (1)))) / ((short int) (3)) : ((short int) (3)) == -1 ? 0 : ((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (1)) << (sizeof ((0 * ((short int) (3)) + ((short int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (0)))) / ((short int) (3)) < ((short int) (byte8_count))) : ((short int) (3)) == 0 ? 0 : (((short int) (byte8_count)) < 0 ? ((short int) (byte8_count)) < ((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (1)) << (sizeof ((0 * ((short int) (3)) + ((short int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (0)))) / ((short int) (3)) : ((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) + (1)) << (sizeof ((0 * ((short int) (3)) + ((short int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (3)) + ((short int) (byte8_count))) - (1)))) / ((short int) (3)) < ((short int) (byte8_count))))) || (((0 * (((short int) (byte8_count)) * ((short int) (3))) - (1)) < 0) && (((short int) (byte8_count)) * ((short int) (3))) < ((-32767 -1))) || (32767) < (((short int) (byte8_count)) * ((short int) (3)))) ? (*(&thrice_byte8_count) = (((unsigned short int) ((short int) (byte8_count)) * (unsigned short int) ((short int) (3))) <= (32767) ? (short int) ((unsigned short int) ((short int) (byte8_count)) * (unsigned short int) ((short int) (3))) : ((short int) (((unsigned short int) ((short int) (byte8_count)) * (unsigned short int) ((short int) (3))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&thrice_byte8_count) = (((unsigned short int) ((short int) (byte8_count)) * (unsigned short int) ((short int) (3))) <= (32767) ? (short int) ((unsigned short int) ((short int) (byte8_count)) * (unsigned short int) ((short int) (3))) : ((short int) (((unsigned short int) ((short int) (byte8_count)) * (unsigned short int) ((short int) (3))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : ((((((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) == 0 && (((byte8_count) < 0 && 0 < (3)) || ((3) < 0 && 0 < (byte8_count)))) || ((3) < 0 ? ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) : (3) == -1 ? 0 : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) < (byte8_count)) : (3) == 0 ? 0 : ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) < (byte8_count)))) || (((0 * ((byte8_count) * (3)) - (1)) < 0) && ((byte8_count) * (3)) < ((-32767 -1))) || (32767) < ((byte8_count) * (3))) ? (*(&thrice_byte8_count) = (((unsigned short int) (byte8_count) * (unsigned short int) (3)) <= (32767) ? (short int) ((unsigned short int) (byte8_count) * (unsigned short int) (3)) : ((short int) (((unsigned short int) (byte8_count) * (unsigned short int) (3)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&thrice_byte8_count) = (((unsigned short int) (byte8_count) * (unsigned short int) (3)) <= (32767) ? (short int) ((unsigned short int) (byte8_count) * (unsigned short int) (3)) : ((short int) (((unsigned short int) (byte8_count) * (unsigned short int) (3)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&thrice_byte8_count) == sizeof (int) ? (sizeof ((byte8_count) * (3)) < sizeof (int) ? ((((((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (1)) << (sizeof ((0 * ((int) (3)) + ((int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (0)))) == 0 && ((((int) (byte8_count)) < 0 && 0 < ((int) (3))) || (((int) (3)) < 0 && 0 < ((int) (byte8_count))))) || (((int) (3)) < 0 ? (((int) (byte8_count)) < 0 ? ((int) (byte8_count)) < ((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (1)) << (sizeof ((0 * ((int) (3)) + ((int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (3)) + ((int) (byte8_count))) - (1)))) / ((int) (3)) : ((int) (3)) == -1 ? 0 : ((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (1)) << (sizeof ((0 * ((int) (3)) + ((int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (0)))) / ((int) (3)) < ((int) (byte8_count))) : ((int) (3)) == 0 ? 0 : (((int) (byte8_count)) < 0 ? ((int) (byte8_count)) < ((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (1)) << (sizeof ((0 * ((int) (3)) + ((int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (0)))) / ((int) (3)) : ((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((int) (3)) + ((int) (byte8_count))) + (1)) << (sizeof ((0 * ((int) (3)) + ((int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (3)) + ((int) (byte8_count))) - (1)))) / ((int) (3)) < ((int) (byte8_count))))) || (((0 * (((int) (byte8_count)) * ((int) (3))) - (1)) < 0) && (((int) (byte8_count)) * ((int) (3))) < ((-2147483647 -1))) || (2147483647) < (((int) (byte8_count)) * ((int) (3)))) ? (*(&thrice_byte8_count) = (((unsigned int) ((int) (byte8_count)) * (unsigned int) ((int) (3))) <= (2147483647) ? (int) ((unsigned int) ((int) (byte8_count)) * (unsigned int) ((int) (3))) : ((int) (((unsigned int) ((int) (byte8_count)) * (unsigned int) ((int) (3))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&thrice_byte8_count) = (((unsigned int) ((int) (byte8_count)) * (unsigned int) ((int) (3))) <= (2147483647) ? (int) ((unsigned int) ((int) (byte8_count)) * (unsigned int) ((int) (3))) : ((int) (((unsigned int) ((int) (byte8_count)) * (unsigned int) ((int) (3))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0)) : ((((((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) == 0 && (((byte8_count) < 0 && 0 < (3)) || ((3) < 0 && 0 < (byte8_count)))) || ((3) < 0 ? ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) : (3) == -1 ? 0 : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) < (byte8_count)) : (3) == 0 ? 0 : ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) < (byte8_count)))) || (((0 * ((byte8_count) * (3)) - (1)) < 0) && ((byte8_count) * (3)) < ((-2147483647 -1))) || (2147483647) < ((byte8_count) * (3))) ? (*(&thrice_byte8_count) = (((unsigned int) (byte8_count) * (unsigned int) (3)) <= (2147483647) ? (int) ((unsigned int) (byte8_count) * (unsigned int) (3)) : ((int) (((unsigned int) (byte8_count) * (unsigned int) (3)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&thrice_byte8_count) = (((unsigned int) (byte8_count) * (unsigned int) (3)) <= (2147483647) ? (int) ((unsigned int) (byte8_count) * (unsigned int) (3)) : ((int) (((unsigned int) (byte8_count) * (unsigned int) (3)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0))) : (sizeof *(&thrice_byte8_count) == sizeof (long int) ? (sizeof ((byte8_count) * (3)) < sizeof (long int) ? ((((((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long int) (3)) + ((long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (0)))) == 0 && ((((long int) (byte8_count)) < 0 && 0 < ((long int) (3))) || (((long int) (3)) < 0 && 0 < ((long int) (byte8_count))))) || (((long int) (3)) < 0 ? (((long int) (byte8_count)) < 0 ? ((long int) (byte8_count)) < ((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long int) (3)) + ((long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) - (1)))) / ((long int) (3)) : ((long int) (3)) == -1 ? 0 : ((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long int) (3)) + ((long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (0)))) / ((long int) (3)) < ((long int) (byte8_count))) : ((long int) (3)) == 0 ? 0 : (((long int) (byte8_count)) < 0 ? ((long int) (byte8_count)) < ((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long int) (3)) + ((long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (0)))) / ((long int) (3)) : ((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long int) (3)) + ((long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (3)) + ((long int) (byte8_count))) - (1)))) / ((long int) (3)) < ((long int) (byte8_count))))) || (((0 * (((long int) (byte8_count)) * ((long int) (3))) - (1)) < 0) && (((long int) (byte8_count)) * ((long int) (3))) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < (((long int) (byte8_count)) * ((long int) (3)))) ? (*(&thrice_byte8_count) = (((unsigned long int) ((long int) (byte8_count)) * (unsigned long int) ((long int) (3))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (byte8_count)) * (unsigned long int) ((long int) (3))) : ((long int) (((unsigned long int) ((long int) (byte8_count)) * (unsigned long int) ((long int) (3))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&thrice_byte8_count) = (((unsigned long int) ((long int) (byte8_count)) * (unsigned long int) ((long int) (3))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (byte8_count)) * (unsigned long int) ((long int) (3))) : ((long int) (((unsigned long int) ((long int) (byte8_count)) * (unsigned long int) ((long int) (3))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0)) : ((((((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) == 0 && (((byte8_count) < 0 && 0 < (3)) || ((3) < 0 && 0 < (byte8_count)))) || ((3) < 0 ? ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) : (3) == -1 ? 0 : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) < (byte8_count)) : (3) == 0 ? 0 : ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) < (byte8_count)))) || (((0 * ((byte8_count) * (3)) - (1)) < 0) && ((byte8_count) * (3)) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < ((byte8_count) * (3))) ? (*(&thrice_byte8_count) = (((unsigned long int) (byte8_count) * (unsigned long int) (3)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (byte8_count) * (unsigned long int) (3)) : ((long int) (((unsigned long int) (byte8_count) * (unsigned long int) (3)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&thrice_byte8_count) = (((unsigned long int) (byte8_count) * (unsigned long int) (3)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (byte8_count) * (unsigned long int) (3)) : ((long int) (((unsigned long int) (byte8_count) * (unsigned long int) (3)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0))) : (sizeof ((byte8_count) * (3)) < sizeof (long long int) ? ((((((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long long int) (3)) + ((long long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (0)))) == 0 && ((((long long int) (byte8_count)) < 0 && 0 < ((long long int) (3))) || (((long long int) (3)) < 0 && 0 < ((long long int) (byte8_count))))) || (((long long int) (3)) < 0 ? (((long long int) (byte8_count)) < 0 ? ((long long int) (byte8_count)) < ((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long long int) (3)) + ((long long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) - (1)))) / ((long long int) (3)) : ((long long int) (3)) == -1 ? 0 : ((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long long int) (3)) + ((long long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (0)))) / ((long long int) (3)) < ((long long int) (byte8_count))) : ((long long int) (3)) == 0 ? 0 : (((long long int) (byte8_count)) < 0 ? ((long long int) (byte8_count)) < ((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long long int) (3)) + ((long long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (0)))) / ((long long int) (3)) : ((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) + (1)) << (sizeof ((0 * ((long long int) (3)) + ((long long int) (byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (3)) + ((long long int) (byte8_count))) - (1)))) / ((long long int) (3)) < ((long long int) (byte8_count))))) || (((0 * (((long long int) (byte8_count)) * ((long long int) (3))) - (1)) < 0) && (((long long int) (byte8_count)) * ((long long int) (3))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (byte8_count)) * ((long long int) (3)))) ? (*(&thrice_byte8_count) = (((unsigned long long int) ((long long int) (byte8_count)) * (unsigned long long int) ((long long int) (3))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (byte8_count)) * (unsigned long long int) ((long long int) (3))) : ((long long int) (((unsigned long long int) ((long long int) (byte8_count)) * (unsigned long long int) ((long long int) (3))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&thrice_byte8_count) = (((unsigned long long int) ((long long int) (byte8_count)) * (unsigned long long int) ((long long int) (3))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (byte8_count)) * (unsigned long long int) ((long long int) (3))) : ((long long int) (((unsigned long long int) ((long long int) (byte8_count)) * (unsigned long long int) ((long long int) (3))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : ((((((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) == 0 && (((byte8_count) < 0 && 0 < (3)) || ((3) < 0 && 0 < (byte8_count)))) || ((3) < 0 ? ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) : (3) == -1 ? 0 : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) < (byte8_count)) : (3) == 0 ? 0 : ((byte8_count) < 0 ? (byte8_count) < ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (3) + (byte8_count)) + (0)) == -1) - ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) + (0)))) / (3) : ((((0 * (0 * (3) + (byte8_count)) - (1)) < 0) ? ((((0 * (0 * (3) + (byte8_count)) + (1)) << (sizeof ((0 * (3) + (byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (3) + (byte8_count)) - (1)))) / (3) < (byte8_count)))) || (((0 * ((byte8_count) * (3)) - (1)) < 0) && ((byte8_count) * (3)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((byte8_count) * (3))) ? (*(&thrice_byte8_count) = (((unsigned long long int) (byte8_count) * (unsigned long long int) (3)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (byte8_count) * (unsigned long long int) (3)) : ((long long int) (((unsigned long long int) (byte8_count) * (unsigned long long int) (3)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&thrice_byte8_count) = (((unsigned long long int) (byte8_count) * (unsigned long long int) (3)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (byte8_count) * (unsigned long long int) (3)) : ((long long int) (((unsigned long long int) (byte8_count) * (unsigned long long int) (3)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0))))))
    string_overflow ();

  if (multibyte)
    {

      if ((sizeof *(&uninit_nchars) == sizeof (signed char) ? (sizeof ((nchars) + (thrice_byte8_count)) < sizeof (signed char) ? (((((((0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + (0)) == -1) - ((((0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + (1)) << (sizeof ((0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + (0)))) < 0 ? (((signed char) (thrice_byte8_count)) < 0 ? ((signed char) (nchars)) < ((((0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + (0)) == -1) - ((((0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + (1)) << (sizeof ((0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + (0)))) - ((signed char) (thrice_byte8_count)) : ((((0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + (1)) << (sizeof ((0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (thrice_byte8_count)) + ((signed char) (nchars))) - (1)))) - ((signed char) (thrice_byte8_count)) < ((signed char) (nchars))) : ((signed char) (nchars)) < 0 ? ((signed char) (thrice_byte8_count)) <= ((signed char) (nchars)) + ((signed char) (thrice_byte8_count)) : ((signed char) (thrice_byte8_count)) < 0 ? ((signed char) (nchars)) <= ((signed char) (nchars)) + ((signed char) (thrice_byte8_count)) : ((signed char) (nchars)) + ((signed char) (thrice_byte8_count)) < ((signed char) (thrice_byte8_count))) || (((0 * (((signed char) (nchars)) + ((signed char) (thrice_byte8_count))) - (1)) < 0) && (((signed char) (nchars)) + ((signed char) (thrice_byte8_count))) < ((-127 -1))) || (127) < (((signed char) (nchars)) + ((signed char) (thrice_byte8_count)))) ? (*(&uninit_nchars) = (((unsigned char) ((signed char) (nchars)) + (unsigned char) ((signed char) (thrice_byte8_count))) <= (127) ? (signed char) ((unsigned char) ((signed char) (nchars)) + (unsigned char) ((signed char) (thrice_byte8_count))) : ((signed char) (((unsigned char) ((signed char) (nchars)) + (unsigned char) ((signed char) (thrice_byte8_count))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&uninit_nchars) = (((unsigned char) ((signed char) (nchars)) + (unsigned char) ((signed char) (thrice_byte8_count))) <= (127) ? (signed char) ((unsigned char) ((signed char) (nchars)) + (unsigned char) ((signed char) (thrice_byte8_count))) : ((signed char) (((unsigned char) ((signed char) (nchars)) + (unsigned char) ((signed char) (thrice_byte8_count))) - ((-127 -1))) + ((-127 -1)))), 0)) : (((((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) < 0 ? ((thrice_byte8_count) < 0 ? (nchars) < ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) - (thrice_byte8_count) : ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) - (1)))) - (thrice_byte8_count) < (nchars)) : (nchars) < 0 ? (thrice_byte8_count) <= (nchars) + (thrice_byte8_count) : (thrice_byte8_count) < 0 ? (nchars) <= (nchars) + (thrice_byte8_count) : (nchars) + (thrice_byte8_count) < (thrice_byte8_count)) || (((0 * ((nchars) + (thrice_byte8_count)) - (1)) < 0) && ((nchars) + (thrice_byte8_count)) < ((-127 -1))) || (127) < ((nchars) + (thrice_byte8_count))) ? (*(&uninit_nchars) = (((unsigned char) (nchars) + (unsigned char) (thrice_byte8_count)) <= (127) ? (signed char) ((unsigned char) (nchars) + (unsigned char) (thrice_byte8_count)) : ((signed char) (((unsigned char) (nchars) + (unsigned char) (thrice_byte8_count)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&uninit_nchars) = (((unsigned char) (nchars) + (unsigned char) (thrice_byte8_count)) <= (127) ? (signed char) ((unsigned char) (nchars) + (unsigned char) (thrice_byte8_count)) : ((signed char) (((unsigned char) (nchars) + (unsigned char) (thrice_byte8_count)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&uninit_nchars) == sizeof (short int) ? (sizeof ((nchars) + (thrice_byte8_count)) < sizeof (short int) ? (((((((0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + (0)) == -1) - ((((0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + (1)) << (sizeof ((0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + (0)))) < 0 ? (((short int) (thrice_byte8_count)) < 0 ? ((short int) (nchars)) < ((((0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + (0)) == -1) - ((((0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + (1)) << (sizeof ((0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + (0)))) - ((short int) (thrice_byte8_count)) : ((((0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) - (1)) < 0) ? ((((0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + (1)) << (sizeof ((0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (thrice_byte8_count)) + ((short int) (nchars))) - (1)))) - ((short int) (thrice_byte8_count)) < ((short int) (nchars))) : ((short int) (nchars)) < 0 ? ((short int) (thrice_byte8_count)) <= ((short int) (nchars)) + ((short int) (thrice_byte8_count)) : ((short int) (thrice_byte8_count)) < 0 ? ((short int) (nchars)) <= ((short int) (nchars)) + ((short int) (thrice_byte8_count)) : ((short int) (nchars)) + ((short int) (thrice_byte8_count)) < ((short int) (thrice_byte8_count))) || (((0 * (((short int) (nchars)) + ((short int) (thrice_byte8_count))) - (1)) < 0) && (((short int) (nchars)) + ((short int) (thrice_byte8_count))) < ((-32767 -1))) || (32767) < (((short int) (nchars)) + ((short int) (thrice_byte8_count)))) ? (*(&uninit_nchars) = (((unsigned short int) ((short int) (nchars)) + (unsigned short int) ((short int) (thrice_byte8_count))) <= (32767) ? (short int) ((unsigned short int) ((short int) (nchars)) + (unsigned short int) ((short int) (thrice_byte8_count))) : ((short int) (((unsigned short int) ((short int) (nchars)) + (unsigned short int) ((short int) (thrice_byte8_count))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&uninit_nchars) = (((unsigned short int) ((short int) (nchars)) + (unsigned short int) ((short int) (thrice_byte8_count))) <= (32767) ? (short int) ((unsigned short int) ((short int) (nchars)) + (unsigned short int) ((short int) (thrice_byte8_count))) : ((short int) (((unsigned short int) ((short int) (nchars)) + (unsigned short int) ((short int) (thrice_byte8_count))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : (((((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) < 0 ? ((thrice_byte8_count) < 0 ? (nchars) < ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) - (thrice_byte8_count) : ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) - (1)))) - (thrice_byte8_count) < (nchars)) : (nchars) < 0 ? (thrice_byte8_count) <= (nchars) + (thrice_byte8_count) : (thrice_byte8_count) < 0 ? (nchars) <= (nchars) + (thrice_byte8_count) : (nchars) + (thrice_byte8_count) < (thrice_byte8_count)) || (((0 * ((nchars) + (thrice_byte8_count)) - (1)) < 0) && ((nchars) + (thrice_byte8_count)) < ((-32767 -1))) || (32767) < ((nchars) + (thrice_byte8_count))) ? (*(&uninit_nchars) = (((unsigned short int) (nchars) + (unsigned short int) (thrice_byte8_count)) <= (32767) ? (short int) ((unsigned short int) (nchars) + (unsigned short int) (thrice_byte8_count)) : ((short int) (((unsigned short int) (nchars) + (unsigned short int) (thrice_byte8_count)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&uninit_nchars) = (((unsigned short int) (nchars) + (unsigned short int) (thrice_byte8_count)) <= (32767) ? (short int) ((unsigned short int) (nchars) + (unsigned short int) (thrice_byte8_count)) : ((short int) (((unsigned short int) (nchars) + (unsigned short int) (thrice_byte8_count)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&uninit_nchars) == sizeof (int) ? (sizeof ((nchars) + (thrice_byte8_count)) < sizeof (int) ? (((((((0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + (0)) == -1) - ((((0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + (1)) << (sizeof ((0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + (0)))) < 0 ? (((int) (thrice_byte8_count)) < 0 ? ((int) (nchars)) < ((((0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + (0)) == -1) - ((((0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + (1)) << (sizeof ((0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + (0)))) - ((int) (thrice_byte8_count)) : ((((0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) - (1)) < 0) ? ((((0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + (1)) << (sizeof ((0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (thrice_byte8_count)) + ((int) (nchars))) - (1)))) - ((int) (thrice_byte8_count)) < ((int) (nchars))) : ((int) (nchars)) < 0 ? ((int) (thrice_byte8_count)) <= ((int) (nchars)) + ((int) (thrice_byte8_count)) : ((int) (thrice_byte8_count)) < 0 ? ((int) (nchars)) <= ((int) (nchars)) + ((int) (thrice_byte8_count)) : ((int) (nchars)) + ((int) (thrice_byte8_count)) < ((int) (thrice_byte8_count))) || (((0 * (((int) (nchars)) + ((int) (thrice_byte8_count))) - (1)) < 0) && (((int) (nchars)) + ((int) (thrice_byte8_count))) < ((-2147483647 -1))) || (2147483647) < (((int) (nchars)) + ((int) (thrice_byte8_count)))) ? (*(&uninit_nchars) = (((unsigned int) ((int) (nchars)) + (unsigned int) ((int) (thrice_byte8_count))) <= (2147483647) ? (int) ((unsigned int) ((int) (nchars)) + (unsigned int) ((int) (thrice_byte8_count))) : ((int) (((unsigned int) ((int) (nchars)) + (unsigned int) ((int) (thrice_byte8_count))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&uninit_nchars) = (((unsigned int) ((int) (nchars)) + (unsigned int) ((int) (thrice_byte8_count))) <= (2147483647) ? (int) ((unsigned int) ((int) (nchars)) + (unsigned int) ((int) (thrice_byte8_count))) : ((int) (((unsigned int) ((int) (nchars)) + (unsigned int) ((int) (thrice_byte8_count))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0)) : (((((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) < 0 ? ((thrice_byte8_count) < 0 ? (nchars) < ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) - (thrice_byte8_count) : ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) - (1)))) - (thrice_byte8_count) < (nchars)) : (nchars) < 0 ? (thrice_byte8_count) <= (nchars) + (thrice_byte8_count) : (thrice_byte8_count) < 0 ? (nchars) <= (nchars) + (thrice_byte8_count) : (nchars) + (thrice_byte8_count) < (thrice_byte8_count)) || (((0 * ((nchars) + (thrice_byte8_count)) - (1)) < 0) && ((nchars) + (thrice_byte8_count)) < ((-2147483647 -1))) || (2147483647) < ((nchars) + (thrice_byte8_count))) ? (*(&uninit_nchars) = (((unsigned int) (nchars) + (unsigned int) (thrice_byte8_count)) <= (2147483647) ? (int) ((unsigned int) (nchars) + (unsigned int) (thrice_byte8_count)) : ((int) (((unsigned int) (nchars) + (unsigned int) (thrice_byte8_count)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&uninit_nchars) = (((unsigned int) (nchars) + (unsigned int) (thrice_byte8_count)) <= (2147483647) ? (int) ((unsigned int) (nchars) + (unsigned int) (thrice_byte8_count)) : ((int) (((unsigned int) (nchars) + (unsigned int) (thrice_byte8_count)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0))) : (sizeof *(&uninit_nchars) == sizeof (long int) ? (sizeof ((nchars) + (thrice_byte8_count)) < sizeof (long int) ? (((((((0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + (0)) == -1) - ((((0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + (1)) << (sizeof ((0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + (0)))) < 0 ? (((long int) (thrice_byte8_count)) < 0 ? ((long int) (nchars)) < ((((0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + (0)) == -1) - ((((0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + (1)) << (sizeof ((0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + (0)))) - ((long int) (thrice_byte8_count)) : ((((0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) - (1)) < 0) ? ((((0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + (1)) << (sizeof ((0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (thrice_byte8_count)) + ((long int) (nchars))) - (1)))) - ((long int) (thrice_byte8_count)) < ((long int) (nchars))) : ((long int) (nchars)) < 0 ? ((long int) (thrice_byte8_count)) <= ((long int) (nchars)) + ((long int) (thrice_byte8_count)) : ((long int) (thrice_byte8_count)) < 0 ? ((long int) (nchars)) <= ((long int) (nchars)) + ((long int) (thrice_byte8_count)) : ((long int) (nchars)) + ((long int) (thrice_byte8_count)) < ((long int) (thrice_byte8_count))) || (((0 * (((long int) (nchars)) + ((long int) (thrice_byte8_count))) - (1)) < 0) && (((long int) (nchars)) + ((long int) (thrice_byte8_count))) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < (((long int) (nchars)) + ((long int) (thrice_byte8_count)))) ? (*(&uninit_nchars) = (((unsigned long int) ((long int) (nchars)) + (unsigned long int) ((long int) (thrice_byte8_count))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (nchars)) + (unsigned long int) ((long int) (thrice_byte8_count))) : ((long int) (((unsigned long int) ((long int) (nchars)) + (unsigned long int) ((long int) (thrice_byte8_count))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&uninit_nchars) = (((unsigned long int) ((long int) (nchars)) + (unsigned long int) ((long int) (thrice_byte8_count))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (nchars)) + (unsigned long int) ((long int) (thrice_byte8_count))) : ((long int) (((unsigned long int) ((long int) (nchars)) + (unsigned long int) ((long int) (thrice_byte8_count))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0)) : (((((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) < 0 ? ((thrice_byte8_count) < 0 ? (nchars) < ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) - (thrice_byte8_count) : ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) - (1)))) - (thrice_byte8_count) < (nchars)) : (nchars) < 0 ? (thrice_byte8_count) <= (nchars) + (thrice_byte8_count) : (thrice_byte8_count) < 0 ? (nchars) <= (nchars) + (thrice_byte8_count) : (nchars) + (thrice_byte8_count) < (thrice_byte8_count)) || (((0 * ((nchars) + (thrice_byte8_count)) - (1)) < 0) && ((nchars) + (thrice_byte8_count)) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < ((nchars) + (thrice_byte8_count))) ? (*(&uninit_nchars) = (((unsigned long int) (nchars) + (unsigned long int) (thrice_byte8_count)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (nchars) + (unsigned long int) (thrice_byte8_count)) : ((long int) (((unsigned long int) (nchars) + (unsigned long int) (thrice_byte8_count)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&uninit_nchars) = (((unsigned long int) (nchars) + (unsigned long int) (thrice_byte8_count)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (nchars) + (unsigned long int) (thrice_byte8_count)) : ((long int) (((unsigned long int) (nchars) + (unsigned long int) (thrice_byte8_count)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0))) : (sizeof ((nchars) + (thrice_byte8_count)) < sizeof (long long int) ? (((((((0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + (0)) == -1) - ((((0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + (1)) << (sizeof ((0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + (0)))) < 0 ? (((long long int) (thrice_byte8_count)) < 0 ? ((long long int) (nchars)) < ((((0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + (0)) == -1) - ((((0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + (1)) << (sizeof ((0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + (0)))) - ((long long int) (thrice_byte8_count)) : ((((0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + (1)) << (sizeof ((0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (thrice_byte8_count)) + ((long long int) (nchars))) - (1)))) - ((long long int) (thrice_byte8_count)) < ((long long int) (nchars))) : ((long long int) (nchars)) < 0 ? ((long long int) (thrice_byte8_count)) <= ((long long int) (nchars)) + ((long long int) (thrice_byte8_count)) : ((long long int) (thrice_byte8_count)) < 0 ? ((long long int) (nchars)) <= ((long long int) (nchars)) + ((long long int) (thrice_byte8_count)) : ((long long int) (nchars)) + ((long long int) (thrice_byte8_count)) < ((long long int) (thrice_byte8_count))) || (((0 * (((long long int) (nchars)) + ((long long int) (thrice_byte8_count))) - (1)) < 0) && (((long long int) (nchars)) + ((long long int) (thrice_byte8_count))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (nchars)) + ((long long int) (thrice_byte8_count)))) ? (*(&uninit_nchars) = (((unsigned long long int) ((long long int) (nchars)) + (unsigned long long int) ((long long int) (thrice_byte8_count))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (nchars)) + (unsigned long long int) ((long long int) (thrice_byte8_count))) : ((long long int) (((unsigned long long int) ((long long int) (nchars)) + (unsigned long long int) ((long long int) (thrice_byte8_count))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&uninit_nchars) = (((unsigned long long int) ((long long int) (nchars)) + (unsigned long long int) ((long long int) (thrice_byte8_count))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (nchars)) + (unsigned long long int) ((long long int) (thrice_byte8_count))) : ((long long int) (((unsigned long long int) ((long long int) (nchars)) + (unsigned long long int) ((long long int) (thrice_byte8_count))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : (((((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) < 0 ? ((thrice_byte8_count) < 0 ? (nchars) < ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? - (~ (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)) == -1) - ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) + (0)))) - (thrice_byte8_count) : ((((0 * (0 * (thrice_byte8_count) + (nchars)) - (1)) < 0) ? ((((0 * (0 * (thrice_byte8_count) + (nchars)) + (1)) << (sizeof ((0 * (thrice_byte8_count) + (nchars)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (thrice_byte8_count) + (nchars)) - (1)))) - (thrice_byte8_count) < (nchars)) : (nchars) < 0 ? (thrice_byte8_count) <= (nchars) + (thrice_byte8_count) : (thrice_byte8_count) < 0 ? (nchars) <= (nchars) + (thrice_byte8_count) : (nchars) + (thrice_byte8_count) < (thrice_byte8_count)) || (((0 * ((nchars) + (thrice_byte8_count)) - (1)) < 0) && ((nchars) + (thrice_byte8_count)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((nchars) + (thrice_byte8_count))) ? (*(&uninit_nchars) = (((unsigned long long int) (nchars) + (unsigned long long int) (thrice_byte8_count)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (nchars) + (unsigned long long int) (thrice_byte8_count)) : ((long long int) (((unsigned long long int) (nchars) + (unsigned long long int) (thrice_byte8_count)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&uninit_nchars) = (((unsigned long long int) (nchars) + (unsigned long long int) (thrice_byte8_count)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (nchars) + (unsigned long long int) (thrice_byte8_count)) : ((long long int) (((unsigned long long int) (nchars) + (unsigned long long int) (thrice_byte8_count)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)))))
   || (sizeof *(&uninit_nbytes) == sizeof (signed char) ? (sizeof ((nbytes) + (2 * byte8_count)) < sizeof (signed char) ? (((((((0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + (1)) << (sizeof ((0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + (0)))) < 0 ? (((signed char) (2 * byte8_count)) < 0 ? ((signed char) (nbytes)) < ((((0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + (1)) << (sizeof ((0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + (0)))) - ((signed char) (2 * byte8_count)) : ((((0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + (1)) << (sizeof ((0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (2 * byte8_count)) + ((signed char) (nbytes))) - (1)))) - ((signed char) (2 * byte8_count)) < ((signed char) (nbytes))) : ((signed char) (nbytes)) < 0 ? ((signed char) (2 * byte8_count)) <= ((signed char) (nbytes)) + ((signed char) (2 * byte8_count)) : ((signed char) (2 * byte8_count)) < 0 ? ((signed char) (nbytes)) <= ((signed char) (nbytes)) + ((signed char) (2 * byte8_count)) : ((signed char) (nbytes)) + ((signed char) (2 * byte8_count)) < ((signed char) (2 * byte8_count))) || (((0 * (((signed char) (nbytes)) + ((signed char) (2 * byte8_count))) - (1)) < 0) && (((signed char) (nbytes)) + ((signed char) (2 * byte8_count))) < ((-127 -1))) || (127) < (((signed char) (nbytes)) + ((signed char) (2 * byte8_count)))) ? (*(&uninit_nbytes) = (((unsigned char) ((signed char) (nbytes)) + (unsigned char) ((signed char) (2 * byte8_count))) <= (127) ? (signed char) ((unsigned char) ((signed char) (nbytes)) + (unsigned char) ((signed char) (2 * byte8_count))) : ((signed char) (((unsigned char) ((signed char) (nbytes)) + (unsigned char) ((signed char) (2 * byte8_count))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned char) ((signed char) (nbytes)) + (unsigned char) ((signed char) (2 * byte8_count))) <= (127) ? (signed char) ((unsigned char) ((signed char) (nbytes)) + (unsigned char) ((signed char) (2 * byte8_count))) : ((signed char) (((unsigned char) ((signed char) (nbytes)) + (unsigned char) ((signed char) (2 * byte8_count))) - ((-127 -1))) + ((-127 -1)))), 0)) : (((((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) < 0 ? ((2 * byte8_count) < 0 ? (nbytes) < ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) - (2 * byte8_count) : ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) - (1)))) - (2 * byte8_count) < (nbytes)) : (nbytes) < 0 ? (2 * byte8_count) <= (nbytes) + (2 * byte8_count) : (2 * byte8_count) < 0 ? (nbytes) <= (nbytes) + (2 * byte8_count) : (nbytes) + (2 * byte8_count) < (2 * byte8_count)) || (((0 * ((nbytes) + (2 * byte8_count)) - (1)) < 0) && ((nbytes) + (2 * byte8_count)) < ((-127 -1))) || (127) < ((nbytes) + (2 * byte8_count))) ? (*(&uninit_nbytes) = (((unsigned char) (nbytes) + (unsigned char) (2 * byte8_count)) <= (127) ? (signed char) ((unsigned char) (nbytes) + (unsigned char) (2 * byte8_count)) : ((signed char) (((unsigned char) (nbytes) + (unsigned char) (2 * byte8_count)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned char) (nbytes) + (unsigned char) (2 * byte8_count)) <= (127) ? (signed char) ((unsigned char) (nbytes) + (unsigned char) (2 * byte8_count)) : ((signed char) (((unsigned char) (nbytes) + (unsigned char) (2 * byte8_count)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&uninit_nbytes) == sizeof (short int) ? (sizeof ((nbytes) + (2 * byte8_count)) < sizeof (short int) ? (((((((0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + (1)) << (sizeof ((0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + (0)))) < 0 ? (((short int) (2 * byte8_count)) < 0 ? ((short int) (nbytes)) < ((((0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + (1)) << (sizeof ((0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + (0)))) - ((short int) (2 * byte8_count)) : ((((0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) - (1)) < 0) ? ((((0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + (1)) << (sizeof ((0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (2 * byte8_count)) + ((short int) (nbytes))) - (1)))) - ((short int) (2 * byte8_count)) < ((short int) (nbytes))) : ((short int) (nbytes)) < 0 ? ((short int) (2 * byte8_count)) <= ((short int) (nbytes)) + ((short int) (2 * byte8_count)) : ((short int) (2 * byte8_count)) < 0 ? ((short int) (nbytes)) <= ((short int) (nbytes)) + ((short int) (2 * byte8_count)) : ((short int) (nbytes)) + ((short int) (2 * byte8_count)) < ((short int) (2 * byte8_count))) || (((0 * (((short int) (nbytes)) + ((short int) (2 * byte8_count))) - (1)) < 0) && (((short int) (nbytes)) + ((short int) (2 * byte8_count))) < ((-32767 -1))) || (32767) < (((short int) (nbytes)) + ((short int) (2 * byte8_count)))) ? (*(&uninit_nbytes) = (((unsigned short int) ((short int) (nbytes)) + (unsigned short int) ((short int) (2 * byte8_count))) <= (32767) ? (short int) ((unsigned short int) ((short int) (nbytes)) + (unsigned short int) ((short int) (2 * byte8_count))) : ((short int) (((unsigned short int) ((short int) (nbytes)) + (unsigned short int) ((short int) (2 * byte8_count))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned short int) ((short int) (nbytes)) + (unsigned short int) ((short int) (2 * byte8_count))) <= (32767) ? (short int) ((unsigned short int) ((short int) (nbytes)) + (unsigned short int) ((short int) (2 * byte8_count))) : ((short int) (((unsigned short int) ((short int) (nbytes)) + (unsigned short int) ((short int) (2 * byte8_count))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : (((((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) < 0 ? ((2 * byte8_count) < 0 ? (nbytes) < ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) - (2 * byte8_count) : ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) - (1)))) - (2 * byte8_count) < (nbytes)) : (nbytes) < 0 ? (2 * byte8_count) <= (nbytes) + (2 * byte8_count) : (2 * byte8_count) < 0 ? (nbytes) <= (nbytes) + (2 * byte8_count) : (nbytes) + (2 * byte8_count) < (2 * byte8_count)) || (((0 * ((nbytes) + (2 * byte8_count)) - (1)) < 0) && ((nbytes) + (2 * byte8_count)) < ((-32767 -1))) || (32767) < ((nbytes) + (2 * byte8_count))) ? (*(&uninit_nbytes) = (((unsigned short int) (nbytes) + (unsigned short int) (2 * byte8_count)) <= (32767) ? (short int) ((unsigned short int) (nbytes) + (unsigned short int) (2 * byte8_count)) : ((short int) (((unsigned short int) (nbytes) + (unsigned short int) (2 * byte8_count)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned short int) (nbytes) + (unsigned short int) (2 * byte8_count)) <= (32767) ? (short int) ((unsigned short int) (nbytes) + (unsigned short int) (2 * byte8_count)) : ((short int) (((unsigned short int) (nbytes) + (unsigned short int) (2 * byte8_count)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&uninit_nbytes) == sizeof (int) ? (sizeof ((nbytes) + (2 * byte8_count)) < sizeof (int) ? (((((((0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + (1)) << (sizeof ((0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + (0)))) < 0 ? (((int) (2 * byte8_count)) < 0 ? ((int) (nbytes)) < ((((0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + (1)) << (sizeof ((0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + (0)))) - ((int) (2 * byte8_count)) : ((((0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) - (1)) < 0) ? ((((0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + (1)) << (sizeof ((0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (2 * byte8_count)) + ((int) (nbytes))) - (1)))) - ((int) (2 * byte8_count)) < ((int) (nbytes))) : ((int) (nbytes)) < 0 ? ((int) (2 * byte8_count)) <= ((int) (nbytes)) + ((int) (2 * byte8_count)) : ((int) (2 * byte8_count)) < 0 ? ((int) (nbytes)) <= ((int) (nbytes)) + ((int) (2 * byte8_count)) : ((int) (nbytes)) + ((int) (2 * byte8_count)) < ((int) (2 * byte8_count))) || (((0 * (((int) (nbytes)) + ((int) (2 * byte8_count))) - (1)) < 0) && (((int) (nbytes)) + ((int) (2 * byte8_count))) < ((-2147483647 -1))) || (2147483647) < (((int) (nbytes)) + ((int) (2 * byte8_count)))) ? (*(&uninit_nbytes) = (((unsigned int) ((int) (nbytes)) + (unsigned int) ((int) (2 * byte8_count))) <= (2147483647) ? (int) ((unsigned int) ((int) (nbytes)) + (unsigned int) ((int) (2 * byte8_count))) : ((int) (((unsigned int) ((int) (nbytes)) + (unsigned int) ((int) (2 * byte8_count))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned int) ((int) (nbytes)) + (unsigned int) ((int) (2 * byte8_count))) <= (2147483647) ? (int) ((unsigned int) ((int) (nbytes)) + (unsigned int) ((int) (2 * byte8_count))) : ((int) (((unsigned int) ((int) (nbytes)) + (unsigned int) ((int) (2 * byte8_count))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0)) : (((((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) < 0 ? ((2 * byte8_count) < 0 ? (nbytes) < ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) - (2 * byte8_count) : ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) - (1)))) - (2 * byte8_count) < (nbytes)) : (nbytes) < 0 ? (2 * byte8_count) <= (nbytes) + (2 * byte8_count) : (2 * byte8_count) < 0 ? (nbytes) <= (nbytes) + (2 * byte8_count) : (nbytes) + (2 * byte8_count) < (2 * byte8_count)) || (((0 * ((nbytes) + (2 * byte8_count)) - (1)) < 0) && ((nbytes) + (2 * byte8_count)) < ((-2147483647 -1))) || (2147483647) < ((nbytes) + (2 * byte8_count))) ? (*(&uninit_nbytes) = (((unsigned int) (nbytes) + (unsigned int) (2 * byte8_count)) <= (2147483647) ? (int) ((unsigned int) (nbytes) + (unsigned int) (2 * byte8_count)) : ((int) (((unsigned int) (nbytes) + (unsigned int) (2 * byte8_count)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned int) (nbytes) + (unsigned int) (2 * byte8_count)) <= (2147483647) ? (int) ((unsigned int) (nbytes) + (unsigned int) (2 * byte8_count)) : ((int) (((unsigned int) (nbytes) + (unsigned int) (2 * byte8_count)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0))) : (sizeof *(&uninit_nbytes) == sizeof (long int) ? (sizeof ((nbytes) + (2 * byte8_count)) < sizeof (long int) ? (((((((0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + (1)) << (sizeof ((0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + (0)))) < 0 ? (((long int) (2 * byte8_count)) < 0 ? ((long int) (nbytes)) < ((((0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + (1)) << (sizeof ((0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + (0)))) - ((long int) (2 * byte8_count)) : ((((0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) - (1)) < 0) ? ((((0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + (1)) << (sizeof ((0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (2 * byte8_count)) + ((long int) (nbytes))) - (1)))) - ((long int) (2 * byte8_count)) < ((long int) (nbytes))) : ((long int) (nbytes)) < 0 ? ((long int) (2 * byte8_count)) <= ((long int) (nbytes)) + ((long int) (2 * byte8_count)) : ((long int) (2 * byte8_count)) < 0 ? ((long int) (nbytes)) <= ((long int) (nbytes)) + ((long int) (2 * byte8_count)) : ((long int) (nbytes)) + ((long int) (2 * byte8_count)) < ((long int) (2 * byte8_count))) || (((0 * (((long int) (nbytes)) + ((long int) (2 * byte8_count))) - (1)) < 0) && (((long int) (nbytes)) + ((long int) (2 * byte8_count))) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < (((long int) (nbytes)) + ((long int) (2 * byte8_count)))) ? (*(&uninit_nbytes) = (((unsigned long int) ((long int) (nbytes)) + (unsigned long int) ((long int) (2 * byte8_count))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (nbytes)) + (unsigned long int) ((long int) (2 * byte8_count))) : ((long int) (((unsigned long int) ((long int) (nbytes)) + (unsigned long int) ((long int) (2 * byte8_count))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&uninit_nbytes) = (((unsigned long int) ((long int) (nbytes)) + (unsigned long int) ((long int) (2 * byte8_count))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (nbytes)) + (unsigned long int) ((long int) (2 * byte8_count))) : ((long int) (((unsigned long int) ((long int) (nbytes)) + (unsigned long int) ((long int) (2 * byte8_count))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0)) : (((((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) < 0 ? ((2 * byte8_count) < 0 ? (nbytes) < ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) - (2 * byte8_count) : ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) - (1)))) - (2 * byte8_count) < (nbytes)) : (nbytes) < 0 ? (2 * byte8_count) <= (nbytes) + (2 * byte8_count) : (2 * byte8_count) < 0 ? (nbytes) <= (nbytes) + (2 * byte8_count) : (nbytes) + (2 * byte8_count) < (2 * byte8_count)) || (((0 * ((nbytes) + (2 * byte8_count)) - (1)) < 0) && ((nbytes) + (2 * byte8_count)) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < ((nbytes) + (2 * byte8_count))) ? (*(&uninit_nbytes) = (((unsigned long int) (nbytes) + (unsigned long int) (2 * byte8_count)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (nbytes) + (unsigned long int) (2 * byte8_count)) : ((long int) (((unsigned long int) (nbytes) + (unsigned long int) (2 * byte8_count)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&uninit_nbytes) = (((unsigned long int) (nbytes) + (unsigned long int) (2 * byte8_count)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (nbytes) + (unsigned long int) (2 * byte8_count)) : ((long int) (((unsigned long int) (nbytes) + (unsigned long int) (2 * byte8_count)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0))) : (sizeof ((nbytes) + (2 * byte8_count)) < sizeof (long long int) ? (((((((0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + (1)) << (sizeof ((0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + (0)))) < 0 ? (((long long int) (2 * byte8_count)) < 0 ? ((long long int) (nbytes)) < ((((0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + (0)) == -1) - ((((0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + (1)) << (sizeof ((0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + (0)))) - ((long long int) (2 * byte8_count)) : ((((0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + (1)) << (sizeof ((0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (2 * byte8_count)) + ((long long int) (nbytes))) - (1)))) - ((long long int) (2 * byte8_count)) < ((long long int) (nbytes))) : ((long long int) (nbytes)) < 0 ? ((long long int) (2 * byte8_count)) <= ((long long int) (nbytes)) + ((long long int) (2 * byte8_count)) : ((long long int) (2 * byte8_count)) < 0 ? ((long long int) (nbytes)) <= ((long long int) (nbytes)) + ((long long int) (2 * byte8_count)) : ((long long int) (nbytes)) + ((long long int) (2 * byte8_count)) < ((long long int) (2 * byte8_count))) || (((0 * (((long long int) (nbytes)) + ((long long int) (2 * byte8_count))) - (1)) < 0) && (((long long int) (nbytes)) + ((long long int) (2 * byte8_count))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (nbytes)) + ((long long int) (2 * byte8_count)))) ? (*(&uninit_nbytes) = (((unsigned long long int) ((long long int) (nbytes)) + (unsigned long long int) ((long long int) (2 * byte8_count))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (nbytes)) + (unsigned long long int) ((long long int) (2 * byte8_count))) : ((long long int) (((unsigned long long int) ((long long int) (nbytes)) + (unsigned long long int) ((long long int) (2 * byte8_count))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&uninit_nbytes) = (((unsigned long long int) ((long long int) (nbytes)) + (unsigned long long int) ((long long int) (2 * byte8_count))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (nbytes)) + (unsigned long long int) ((long long int) (2 * byte8_count))) : ((long long int) (((unsigned long long int) ((long long int) (nbytes)) + (unsigned long long int) ((long long int) (2 * byte8_count))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : (((((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) < 0 ? ((2 * byte8_count) < 0 ? (nbytes) < ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? - (~ (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)) == -1) - ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) + (0)))) - (2 * byte8_count) : ((((0 * (0 * (2 * byte8_count) + (nbytes)) - (1)) < 0) ? ((((0 * (0 * (2 * byte8_count) + (nbytes)) + (1)) << (sizeof ((0 * (2 * byte8_count) + (nbytes)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (2 * byte8_count) + (nbytes)) - (1)))) - (2 * byte8_count) < (nbytes)) : (nbytes) < 0 ? (2 * byte8_count) <= (nbytes) + (2 * byte8_count) : (2 * byte8_count) < 0 ? (nbytes) <= (nbytes) + (2 * byte8_count) : (nbytes) + (2 * byte8_count) < (2 * byte8_count)) || (((0 * ((nbytes) + (2 * byte8_count)) - (1)) < 0) && ((nbytes) + (2 * byte8_count)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((nbytes) + (2 * byte8_count))) ? (*(&uninit_nbytes) = (((unsigned long long int) (nbytes) + (unsigned long long int) (2 * byte8_count)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (nbytes) + (unsigned long long int) (2 * byte8_count)) : ((long long int) (((unsigned long long int) (nbytes) + (unsigned long long int) (2 * byte8_count)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&uninit_nbytes) = (((unsigned long long int) (nbytes) + (unsigned long long int) (2 * byte8_count)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (nbytes) + (unsigned long long int) (2 * byte8_count)) : ((long long int) (((unsigned long long int) (nbytes) + (unsigned long long int) (2 * byte8_count)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0))))))
 string_overflow ();
  ...
  else
    {
      ...
      if ((sizeof *(&uninit_nbytes) == sizeof (signed char) ? (sizeof ((thrice_byte8_count) + (nbytes)) < sizeof (signed char) ? (((((((0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + (0)))) < 0 ? (((signed char) (nbytes)) < 0 ? ((signed char) (thrice_byte8_count)) < ((((0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + (0)))) - ((signed char) (nbytes)) : ((((0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (nbytes)) + ((signed char) (thrice_byte8_count))) - (1)))) - ((signed char) (nbytes)) < ((signed char) (thrice_byte8_count))) : ((signed char) (thrice_byte8_count)) < 0 ? ((signed char) (nbytes)) <= ((signed char) (thrice_byte8_count)) + ((signed char) (nbytes)) : ((signed char) (nbytes)) < 0 ? ((signed char) (thrice_byte8_count)) <= ((signed char) (thrice_byte8_count)) + ((signed char) (nbytes)) : ((signed char) (thrice_byte8_count)) + ((signed char) (nbytes)) < ((signed char) (nbytes))) || (((0 * (((signed char) (thrice_byte8_count)) + ((signed char) (nbytes))) - (1)) < 0) && (((signed char) (thrice_byte8_count)) + ((signed char) (nbytes))) < ((-127 -1))) || (127) < (((signed char) (thrice_byte8_count)) + ((signed char) (nbytes)))) ? (*(&uninit_nbytes) = (((unsigned char) ((signed char) (thrice_byte8_count)) + (unsigned char) ((signed char) (nbytes))) <= (127) ? (signed char) ((unsigned char) ((signed char) (thrice_byte8_count)) + (unsigned char) ((signed char) (nbytes))) : ((signed char) (((unsigned char) ((signed char) (thrice_byte8_count)) + (unsigned char) ((signed char) (nbytes))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned char) ((signed char) (thrice_byte8_count)) + (unsigned char) ((signed char) (nbytes))) <= (127) ? (signed char) ((unsigned char) ((signed char) (thrice_byte8_count)) + (unsigned char) ((signed char) (nbytes))) : ((signed char) (((unsigned char) ((signed char) (thrice_byte8_count)) + (unsigned char) ((signed char) (nbytes))) - ((-127 -1))) + ((-127 -1)))), 0)) : (((((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) < 0 ? ((nbytes) < 0 ? (thrice_byte8_count) < ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) - (nbytes) : ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)))) - (nbytes) < (thrice_byte8_count)) : (thrice_byte8_count) < 0 ? (nbytes) <= (thrice_byte8_count) + (nbytes) : (nbytes) < 0 ? (thrice_byte8_count) <= (thrice_byte8_count) + (nbytes) : (thrice_byte8_count) + (nbytes) < (nbytes)) || (((0 * ((thrice_byte8_count) + (nbytes)) - (1)) < 0) && ((thrice_byte8_count) + (nbytes)) < ((-127 -1))) || (127) < ((thrice_byte8_count) + (nbytes))) ? (*(&uninit_nbytes) = (((unsigned char) (thrice_byte8_count) + (unsigned char) (nbytes)) <= (127) ? (signed char) ((unsigned char) (thrice_byte8_count) + (unsigned char) (nbytes)) : ((signed char) (((unsigned char) (thrice_byte8_count) + (unsigned char) (nbytes)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned char) (thrice_byte8_count) + (unsigned char) (nbytes)) <= (127) ? (signed char) ((unsigned char) (thrice_byte8_count) + (unsigned char) (nbytes)) : ((signed char) (((unsigned char) (thrice_byte8_count) + (unsigned char) (nbytes)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&uninit_nbytes) == sizeof (short int) ? (sizeof ((thrice_byte8_count) + (nbytes)) < sizeof (short int) ? (((((((0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + (0)))) < 0 ? (((short int) (nbytes)) < 0 ? ((short int) (thrice_byte8_count)) < ((((0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + (0)))) - ((short int) (nbytes)) : ((((0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (nbytes)) + ((short int) (thrice_byte8_count))) - (1)))) - ((short int) (nbytes)) < ((short int) (thrice_byte8_count))) : ((short int) (thrice_byte8_count)) < 0 ? ((short int) (nbytes)) <= ((short int) (thrice_byte8_count)) + ((short int) (nbytes)) : ((short int) (nbytes)) < 0 ? ((short int) (thrice_byte8_count)) <= ((short int) (thrice_byte8_count)) + ((short int) (nbytes)) : ((short int) (thrice_byte8_count)) + ((short int) (nbytes)) < ((short int) (nbytes))) || (((0 * (((short int) (thrice_byte8_count)) + ((short int) (nbytes))) - (1)) < 0) && (((short int) (thrice_byte8_count)) + ((short int) (nbytes))) < ((-32767 -1))) || (32767) < (((short int) (thrice_byte8_count)) + ((short int) (nbytes)))) ? (*(&uninit_nbytes) = (((unsigned short int) ((short int) (thrice_byte8_count)) + (unsigned short int) ((short int) (nbytes))) <= (32767) ? (short int) ((unsigned short int) ((short int) (thrice_byte8_count)) + (unsigned short int) ((short int) (nbytes))) : ((short int) (((unsigned short int) ((short int) (thrice_byte8_count)) + (unsigned short int) ((short int) (nbytes))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned short int) ((short int) (thrice_byte8_count)) + (unsigned short int) ((short int) (nbytes))) <= (32767) ? (short int) ((unsigned short int) ((short int) (thrice_byte8_count)) + (unsigned short int) ((short int) (nbytes))) : ((short int) (((unsigned short int) ((short int) (thrice_byte8_count)) + (unsigned short int) ((short int) (nbytes))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : (((((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) < 0 ? ((nbytes) < 0 ? (thrice_byte8_count) < ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) - (nbytes) : ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)))) - (nbytes) < (thrice_byte8_count)) : (thrice_byte8_count) < 0 ? (nbytes) <= (thrice_byte8_count) + (nbytes) : (nbytes) < 0 ? (thrice_byte8_count) <= (thrice_byte8_count) + (nbytes) : (thrice_byte8_count) + (nbytes) < (nbytes)) || (((0 * ((thrice_byte8_count) + (nbytes)) - (1)) < 0) && ((thrice_byte8_count) + (nbytes)) < ((-32767 -1))) || (32767) < ((thrice_byte8_count) + (nbytes))) ? (*(&uninit_nbytes) = (((unsigned short int) (thrice_byte8_count) + (unsigned short int) (nbytes)) <= (32767) ? (short int) ((unsigned short int) (thrice_byte8_count) + (unsigned short int) (nbytes)) : ((short int) (((unsigned short int) (thrice_byte8_count) + (unsigned short int) (nbytes)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned short int) (thrice_byte8_count) + (unsigned short int) (nbytes)) <= (32767) ? (short int) ((unsigned short int) (thrice_byte8_count) + (unsigned short int) (nbytes)) : ((short int) (((unsigned short int) (thrice_byte8_count) + (unsigned short int) (nbytes)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&uninit_nbytes) == sizeof (int) ? (sizeof ((thrice_byte8_count) + (nbytes)) < sizeof (int) ? (((((((0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + (0)))) < 0 ? (((int) (nbytes)) < 0 ? ((int) (thrice_byte8_count)) < ((((0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + (0)))) - ((int) (nbytes)) : ((((0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (nbytes)) + ((int) (thrice_byte8_count))) - (1)))) - ((int) (nbytes)) < ((int) (thrice_byte8_count))) : ((int) (thrice_byte8_count)) < 0 ? ((int) (nbytes)) <= ((int) (thrice_byte8_count)) + ((int) (nbytes)) : ((int) (nbytes)) < 0 ? ((int) (thrice_byte8_count)) <= ((int) (thrice_byte8_count)) + ((int) (nbytes)) : ((int) (thrice_byte8_count)) + ((int) (nbytes)) < ((int) (nbytes))) || (((0 * (((int) (thrice_byte8_count)) + ((int) (nbytes))) - (1)) < 0) && (((int) (thrice_byte8_count)) + ((int) (nbytes))) < ((-2147483647 -1))) || (2147483647) < (((int) (thrice_byte8_count)) + ((int) (nbytes)))) ? (*(&uninit_nbytes) = (((unsigned int) ((int) (thrice_byte8_count)) + (unsigned int) ((int) (nbytes))) <= (2147483647) ? (int) ((unsigned int) ((int) (thrice_byte8_count)) + (unsigned int) ((int) (nbytes))) : ((int) (((unsigned int) ((int) (thrice_byte8_count)) + (unsigned int) ((int) (nbytes))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned int) ((int) (thrice_byte8_count)) + (unsigned int) ((int) (nbytes))) <= (2147483647) ? (int) ((unsigned int) ((int) (thrice_byte8_count)) + (unsigned int) ((int) (nbytes))) : ((int) (((unsigned int) ((int) (thrice_byte8_count)) + (unsigned int) ((int) (nbytes))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0)) : (((((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) < 0 ? ((nbytes) < 0 ? (thrice_byte8_count) < ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) - (nbytes) : ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)))) - (nbytes) < (thrice_byte8_count)) : (thrice_byte8_count) < 0 ? (nbytes) <= (thrice_byte8_count) + (nbytes) : (nbytes) < 0 ? (thrice_byte8_count) <= (thrice_byte8_count) + (nbytes) : (thrice_byte8_count) + (nbytes) < (nbytes)) || (((0 * ((thrice_byte8_count) + (nbytes)) - (1)) < 0) && ((thrice_byte8_count) + (nbytes)) < ((-2147483647 -1))) || (2147483647) < ((thrice_byte8_count) + (nbytes))) ? (*(&uninit_nbytes) = (((unsigned int) (thrice_byte8_count) + (unsigned int) (nbytes)) <= (2147483647) ? (int) ((unsigned int) (thrice_byte8_count) + (unsigned int) (nbytes)) : ((int) (((unsigned int) (thrice_byte8_count) + (unsigned int) (nbytes)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&uninit_nbytes) = (((unsigned int) (thrice_byte8_count) + (unsigned int) (nbytes)) <= (2147483647) ? (int) ((unsigned int) (thrice_byte8_count) + (unsigned int) (nbytes)) : ((int) (((unsigned int) (thrice_byte8_count) + (unsigned int) (nbytes)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0))) : (sizeof *(&uninit_nbytes) == sizeof (long int) ? (sizeof ((thrice_byte8_count) + (nbytes)) < sizeof (long int) ? (((((((0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + (0)))) < 0 ? (((long int) (nbytes)) < 0 ? ((long int) (thrice_byte8_count)) < ((((0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + (0)))) - ((long int) (nbytes)) : ((((0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (nbytes)) + ((long int) (thrice_byte8_count))) - (1)))) - ((long int) (nbytes)) < ((long int) (thrice_byte8_count))) : ((long int) (thrice_byte8_count)) < 0 ? ((long int) (nbytes)) <= ((long int) (thrice_byte8_count)) + ((long int) (nbytes)) : ((long int) (nbytes)) < 0 ? ((long int) (thrice_byte8_count)) <= ((long int) (thrice_byte8_count)) + ((long int) (nbytes)) : ((long int) (thrice_byte8_count)) + ((long int) (nbytes)) < ((long int) (nbytes))) || (((0 * (((long int) (thrice_byte8_count)) + ((long int) (nbytes))) - (1)) < 0) && (((long int) (thrice_byte8_count)) + ((long int) (nbytes))) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < (((long int) (thrice_byte8_count)) + ((long int) (nbytes)))) ? (*(&uninit_nbytes) = (((unsigned long int) ((long int) (thrice_byte8_count)) + (unsigned long int) ((long int) (nbytes))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (thrice_byte8_count)) + (unsigned long int) ((long int) (nbytes))) : ((long int) (((unsigned long int) ((long int) (thrice_byte8_count)) + (unsigned long int) ((long int) (nbytes))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&uninit_nbytes) = (((unsigned long int) ((long int) (thrice_byte8_count)) + (unsigned long int) ((long int) (nbytes))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (thrice_byte8_count)) + (unsigned long int) ((long int) (nbytes))) : ((long int) (((unsigned long int) ((long int) (thrice_byte8_count)) + (unsigned long int) ((long int) (nbytes))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0)) : (((((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) < 0 ? ((nbytes) < 0 ? (thrice_byte8_count) < ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) - (nbytes) : ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)))) - (nbytes) < (thrice_byte8_count)) : (thrice_byte8_count) < 0 ? (nbytes) <= (thrice_byte8_count) + (nbytes) : (nbytes) < 0 ? (thrice_byte8_count) <= (thrice_byte8_count) + (nbytes) : (thrice_byte8_count) + (nbytes) < (nbytes)) || (((0 * ((thrice_byte8_count) + (nbytes)) - (1)) < 0) && ((thrice_byte8_count) + (nbytes)) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < ((thrice_byte8_count) + (nbytes))) ? (*(&uninit_nbytes) = (((unsigned long int) (thrice_byte8_count) + (unsigned long int) (nbytes)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (thrice_byte8_count) + (unsigned long int) (nbytes)) : ((long int) (((unsigned long int) (thrice_byte8_count) + (unsigned long int) (nbytes)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&uninit_nbytes) = (((unsigned long int) (thrice_byte8_count) + (unsigned long int) (nbytes)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (thrice_byte8_count) + (unsigned long int) (nbytes)) : ((long int) (((unsigned long int) (thrice_byte8_count) + (unsigned long int) (nbytes)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0))) : (sizeof ((thrice_byte8_count) + (nbytes)) < sizeof (long long int) ? (((((((0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + (0)))) < 0 ? (((long long int) (nbytes)) < 0 ? ((long long int) (thrice_byte8_count)) < ((((0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + (0)) == -1) - ((((0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + (0)))) - ((long long int) (nbytes)) : ((((0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + (1)) << (sizeof ((0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (nbytes)) + ((long long int) (thrice_byte8_count))) - (1)))) - ((long long int) (nbytes)) < ((long long int) (thrice_byte8_count))) : ((long long int) (thrice_byte8_count)) < 0 ? ((long long int) (nbytes)) <= ((long long int) (thrice_byte8_count)) + ((long long int) (nbytes)) : ((long long int) (nbytes)) < 0 ? ((long long int) (thrice_byte8_count)) <= ((long long int) (thrice_byte8_count)) + ((long long int) (nbytes)) : ((long long int) (thrice_byte8_count)) + ((long long int) (nbytes)) < ((long long int) (nbytes))) || (((0 * (((long long int) (thrice_byte8_count)) + ((long long int) (nbytes))) - (1)) < 0) && (((long long int) (thrice_byte8_count)) + ((long long int) (nbytes))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (thrice_byte8_count)) + ((long long int) (nbytes)))) ? (*(&uninit_nbytes) = (((unsigned long long int) ((long long int) (thrice_byte8_count)) + (unsigned long long int) ((long long int) (nbytes))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (thrice_byte8_count)) + (unsigned long long int) ((long long int) (nbytes))) : ((long long int) (((unsigned long long int) ((long long int) (thrice_byte8_count)) + (unsigned long long int) ((long long int) (nbytes))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&uninit_nbytes) = (((unsigned long long int) ((long long int) (thrice_byte8_count)) + (unsigned long long int) ((long long int) (nbytes))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (thrice_byte8_count)) + (unsigned long long int) ((long long int) (nbytes))) : ((long long int) (((unsigned long long int) ((long long int) (thrice_byte8_count)) + (unsigned long long int) ((long long int) (nbytes))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : (((((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) < 0 ? ((nbytes) < 0 ? (thrice_byte8_count) < ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? - (~ (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)) == -1) - ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) + (0)))) - (nbytes) : ((((0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)) < 0) ? ((((0 * (0 * (nbytes) + (thrice_byte8_count)) + (1)) << (sizeof ((0 * (nbytes) + (thrice_byte8_count)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (nbytes) + (thrice_byte8_count)) - (1)))) - (nbytes) < (thrice_byte8_count)) : (thrice_byte8_count) < 0 ? (nbytes) <= (thrice_byte8_count) + (nbytes) : (nbytes) < 0 ? (thrice_byte8_count) <= (thrice_byte8_count) + (nbytes) : (thrice_byte8_count) + (nbytes) < (nbytes)) || (((0 * ((thrice_byte8_count) + (nbytes)) - (1)) < 0) && ((thrice_byte8_count) + (nbytes)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((thrice_byte8_count) + (nbytes))) ? (*(&uninit_nbytes) = (((unsigned long long int) (thrice_byte8_count) + (unsigned long long int) (nbytes)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (thrice_byte8_count) + (unsigned long long int) (nbytes)) : ((long long int) (((unsigned long long int) (thrice_byte8_count) + (unsigned long long int) (nbytes)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&uninit_nbytes) = (((unsigned long long int) (thrice_byte8_count) + (unsigned long long int) (nbytes)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (thrice_byte8_count) + (unsigned long long int) (nbytes)) : ((long long int) (((unsigned long long int) (thrice_byte8_count) + (unsigned long long int) (nbytes)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0))))))
 string_overflow ();
 ...
 if (((c) == 0xC0 || (c) == 0xC1))
   {
     c = (!((src)[0] & 0x80) ? *(src)++ : ! ((src)[0] & 0x20) ? ((src) += 2, ((((src)[-2] & 0x1F) << 6) | ((src)[-1] & 0x3F) | ((unsigned char) ((src)[-2]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((src)[0] & 0x10) ? ((src) += 3, ((((src)[-3] & 0x0F) << 12) | (((src)[-2] & 0x3F) << 6) | ((src)[-1] & 0x3F))) : string_char ((src), &(src), ((void*)0)));
     c = (((c) > 0x3FFF7F) ? (c) - 0x3FFF00 : (c & 0xFF));
...
static struct Lisp_Subr _Alignas (8) Sstring = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .aMANY = Fstring }, 0, MANY, "string", 0, 0}; Lisp_Object Fstring
  ...
  (ptrdiff_t n, Lisp_Object *args)
{
  ...
  do { if ((n) <= sa_avail / sizeof *(buf) / (5)) (buf) = (sa_avail -= (sizeof *(buf) * (5) * (n)), __builtin_alloca (sizeof *(buf) * (5) * (n))); else { (buf) = xnmalloc (n, sizeof *(buf) * (5)); sa_must_free = 1; record_unwind_protect_ptr (xfree, buf); } } while (0);
  p = buf;

  for (i = 0; i < n; i++)
    {
      (((NATNUMP (args[i]) && ((args[i]) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), args[i]));
      c = ((args[i]) >> INTTYPEBITS);
      p += ((((sizeof ((c) + 0)) > (sizeof ((0x7F) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x7F) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0x7F) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0x7F) + (uintmax_t) 0)) ? ((p)[0] = (c), 1) : (((sizeof ((c) + 0)) > (sizeof ((0x7FF) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x7FF) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0x7FF) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0x7FF) + (uintmax_t) 0)) ? ((p)[0] = (0xC0 | ((c) >> 6)), (p)[1] = (0x80 | ((c) & 0x3F)), 2) : (((sizeof ((c) + 0)) > (sizeof ((0xFFFF) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0xFFFF) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0xFFFF) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0xFFFF) + (uintmax_t) 0)) ? ((p)[0] = (0xE0 | ((c) >> 12)), (p)[1] = (0x80 | (((c) >> 6) & 0x3F)), (p)[2] = (0x80 | ((c) & 0x3F)), 3) : ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (c) <= sizeof (unsigned)) ? 1 : -1; })) ? (char_string (c, p)) : (char_string (c, p))));
    }
...
static struct Lisp_Subr _Alignas (8) Sunibyte_string = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .aMANY = Funibyte_string }, 0, MANY, "unibyte-string", 0, 0}; Lisp_Object Funibyte_string
  ...
  (ptrdiff_t n, Lisp_Object *args)
{
  ...
  Lisp_Object str;
  ptrdiff_t sa_avail = MAX_ALLOCA; ptrdiff_t sa_count = SPECPDL_INDEX (); _Bool sa_must_free = 0;
  unsigned char *buf = ((n) <= sa_avail ? (sa_avail -= (n), __builtin_alloca (n)) : (sa_must_free = 1, record_xmalloc (n)));
  unsigned char *p = buf;

  for (i = 0; i < n; i++)
    {
      do { ((((((enum Lisp_Type) ((args[i]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), args[i])); if (! ((0) <= ((args[i]) >> INTTYPEBITS) && ((args[i]) >> INTTYPEBITS) <= (255))) args_out_of_range_3 (args[i], ((EMACS_INT) (((EMACS_UINT) ((0) < 0 && (0) < (-1 - (9223372036854775807L >> INTTYPEBITS)) ? (-1 - (9223372036854775807L >> INTTYPEBITS)) : (0)) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (((255) < ((9223372036854775807L >> INTTYPEBITS)) ? (255) : ((9223372036854775807L >> INTTYPEBITS)))) << INTTYPEBITS) + Lisp_Int0))); } while (0);
      *p++ = ((args[i]) >> INTTYPEBITS);
    }
...
static struct Lisp_Subr _Alignas (8) Schar_resolve_modifiers = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fchar_resolve_modifiers }, 1, 1, "char-resolve-modifiers", 0, 0}; Lisp_Object Fchar_resolve_modifiers
  ...
  (Lisp_Object character)
{
  ...
  ((((((enum Lisp_Type) ((character) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), character));
  c = ((character) >> INTTYPEBITS);
  return ((EMACS_INT) (((EMACS_UINT) (char_resolve_modifier_mask (c)) << INTTYPEBITS) + Lisp_Int0));
}

static struct Lisp_Subr _Alignas (8) Sget_byte = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fget_byte }, 0, 2, "get-byte", 0, 0}; Lisp_Object Fget_byte
# 914 "character.c"
  (Lisp_Object position, Lisp_Object string)
{
 ...
 {
   p = ((((current_buffer->pt_byte) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (current_buffer->pt_byte) + (current_buffer->text->beg) - ((1))));
 }
      else
 {
   ...
   if (((position) >> INTTYPEBITS) < (current_buffer->begv) || ((position) >> INTTYPEBITS) >= (current_buffer->zv))
     args_out_of_range_3 (position, ((EMACS_INT) (((EMACS_UINT) ((current_buffer->begv)) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) ((current_buffer->zv)) << INTTYPEBITS) + Lisp_Int0)));
   pos = ((position) >> INTTYPEBITS);
   p = (((pos) >= (current_buffer->text->gpt) ? (current_buffer->text->gap_size) : 0) + buf_charpos_to_bytepos (current_buffer, pos) + (current_buffer->text->beg) - ((1)));
 }
      if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))))
 return ((EMACS_INT) (((EMACS_UINT) (*p) << INTTYPEBITS) + Lisp_Int0));
    }
  else
    {
      CHECK_STRING (string);
      ...
      else
 {
   ...
   if (((position) >> INTTYPEBITS) >= SCHARS (string))
 ...
 return ((EMACS_INT) (((EMACS_UINT) (*p) << INTTYPEBITS) + Lisp_Int0));
  ...
  c = (!((p)[0] & 0x80) ? (p)[0] : ! ((p)[0] & 0x20) ? (((((p)[0] & 0x1F) << 6) | ((p)[1] & 0x3F)) + (((unsigned char) (p)[0]) < 0xC2 ? 0x3FFF80 : 0)) : ! ((p)[0] & 0x10) ? ((((p)[0] & 0x0F) << 12) | (((p)[1] & 0x3F) << 6) | ((p)[2] & 0x3F)) : string_char ((p), ((void*)0), ((void*)0)));
  if (((c) > 0x3FFF7F))
    c = (((c) > 0x3FFF7F) ? (c) - 0x3FFF00 : (c & 0xFF));
  else if (! (((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)))
...
alphabeticp (int c)
{
  Lisp_Object category = CHAR_TABLE_REF (globals.f_Vunicode_category_table, c);
  if (! ((((enum Lisp_Type) ((category) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    return 0;
  EMACS_INT gen_cat = ((category) >> INTTYPEBITS);
...
graphicp (int c)
{
  ...
  return (!(gen_cat == UNICODE_CATEGORY_Zs
     || gen_cat == UNICODE_CATEGORY_Zl
     || gen_cat == UNICODE_CATEGORY_Zp
     || gen_cat == UNICODE_CATEGORY_Cc
     || gen_cat == UNICODE_CATEGORY_Cs
     || gen_cat == UNICODE_CATEGORY_Cn));
}
...
printablep (int c)
{
  ...
  return (!(gen_cat == UNICODE_CATEGORY_Cc
     || gen_cat == UNICODE_CATEGORY_Cs
     || gen_cat == UNICODE_CATEGORY_Cn));
}
...
syms_of_character (void)
{
  ...
  Vchar_unify_table = builtin_lisp_symbol (0);
  ...
  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "translation-table-vector", &globals.f_Vtranslation_table_vector); } while (0);




  globals.f_Vtranslation_table_vector = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (16) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0));

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "auto-fill-chars", &globals.f_Vauto_fill_chars); } while (0);



  globals.f_Vauto_fill_chars = Fmake_char_table (builtin_lisp_symbol (186), builtin_lisp_symbol (0));
  CHAR_TABLE_SET (globals.f_Vauto_fill_chars, ' ', builtin_lisp_symbol (901));
  CHAR_TABLE_SET (globals.f_Vauto_fill_chars, '\n', builtin_lisp_symbol (901));

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "char-width-table", &globals.f_Vchar_width_table); } while (0);


  globals.f_Vchar_width_table = Fmake_char_table (builtin_lisp_symbol (0), ((EMACS_INT) (((EMACS_UINT) (1) << INTTYPEBITS) + Lisp_Int0)));
  char_table_set_range (globals.f_Vchar_width_table, 0x80, 0x9F, ((EMACS_INT) (((EMACS_UINT) (4) << INTTYPEBITS) + Lisp_Int0)));
  char_table_set_range (globals.f_Vchar_width_table, 0x3FFF7F + 1, 0x3FFFFF,
   ((EMACS_INT) (((EMACS_UINT) (4) << INTTYPEBITS) + Lisp_Int0)));

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "printable-chars", &globals.f_Vprintable_chars); } while (0);

  globals.f_Vprintable_chars = Fmake_char_table (builtin_lisp_symbol (0), builtin_lisp_symbol (0));
  Fset_char_table_range (globals.f_Vprintable_chars,
    Fcons (((EMACS_INT) (((EMACS_UINT) (32) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (126) << INTTYPEBITS) + Lisp_Int0))), builtin_lisp_symbol (901));
  Fset_char_table_range (globals.f_Vprintable_chars,
    Fcons (((EMACS_INT) (((EMACS_UINT) (160) << INTTYPEBITS) + Lisp_Int0)),
    ((EMACS_INT) (((EMACS_UINT) (0x3FFF7F) << INTTYPEBITS) + Lisp_Int0))), builtin_lisp_symbol (901));

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "char-script-table", &globals.f_Vchar_script_table); } while (0);



                                                  ;
  Fput (builtin_lisp_symbol (256), builtin_lisp_symbol (258), ((EMACS_INT) (((EMACS_UINT) (1) << INTTYPEBITS) + Lisp_Int0)));
  globals.f_Vchar_script_table = Fmake_char_table (builtin_lisp_symbol (256), builtin_lisp_symbol (0));

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "script-representative-chars", &globals.f_Vscript_representative_chars); } while (0);
  ...
  globals.f_Vscript_representative_chars = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "unicode-category-table", &globals.f_Vunicode_category_table); } while (0);
  ...
  globals.f_Vunicode_category_table = builtin_lisp_symbol (0);
}
