...
hash_get_category_set (Lisp_Object table, Lisp_Object category_set)
{
  ...
  if (((XCHAR_TABLE (table)->extras[1]) == (builtin_lisp_symbol (0))))
    set_char_table_extras
      (table, 1,
       make_hash_table (hashtest_equal, ((EMACS_INT) (((EMACS_UINT) (DEFAULT_HASH_SIZE) << INTTYPEBITS) + Lisp_Int0)),
  ...
  if (i >= 0)
    return HASH_KEY (h, i);
  hash_put (h, category_set, builtin_lisp_symbol (0), hash);
  return category_set;
}
...
static void
set_category_set (Lisp_Object category_set, EMACS_INT category, _Bool val)
{
  bool_vector_set (category_set, category, val);
}

static struct Lisp_Subr _Alignas (8) Smake_category_set = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fmake_category_set }, 1, 1, "make-category-set", 0, 0}; Lisp_Object Fmake_category_set
  ...
  (Lisp_Object categories)
{
  ...
  val = (Fmake_bool_vector (((EMACS_INT) (((EMACS_UINT) (128) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0)));
  ...
  while (--len >= 0)
    {
      ...
      Lisp_Object category = ((EMACS_INT) (((EMACS_UINT) (cat) << INTTYPEBITS) + Lisp_Int0));

      ((RANGED_INTEGERP (0x20, category, 0x7E)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (244), category));
...
static struct Lisp_Subr _Alignas (8) Sdefine_category = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fdefine_category }, 2, 3, "define-category", 0, 0}; Lisp_Object Fdefine_category
  ...
  (Lisp_Object category, Lisp_Object docstring, Lisp_Object table)
{
  ...
  if (!((AREF (Fchar_table_extra_slot (table, ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0))), ((((category) >> INTTYPEBITS)) - ' '))) == (builtin_lisp_symbol (0))))
    error ("Category `%c' is already defined", (int) ((category) >> INTTYPEBITS));
  if (!((globals.f_Vpurify_flag) == (builtin_lisp_symbol (0))))
    docstring = Fpurecopy (docstring);
  ASET (Fchar_table_extra_slot (table, ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0))), ((((category) >> INTTYPEBITS)) - ' '), docstring);

  return builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Scategory_docstring = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fcategory_docstring }, 1, 2, "category-docstring", 0, 0}; Lisp_Object Fcategory_docstring
  ...
  (Lisp_Object category, Lisp_Object table)
{
  ...
  return AREF (Fchar_table_extra_slot (table, ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0))), ((((category) >> INTTYPEBITS)) - ' '));
}

static struct Lisp_Subr _Alignas (8) Sget_unused_category = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fget_unused_category }, 0, 1, "get-unused-category", 0, 0}; Lisp_Object Fget_unused_category
  ...
  (Lisp_Object table)
{
  ...
  for (i = ' '; i <= '~'; i++)
    if (((AREF (Fchar_table_extra_slot (table, ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0))), ((i) - ' '))) == (builtin_lisp_symbol (0))))
...
static struct Lisp_Subr _Alignas (8) Scategory_table_p = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fcategory_table_p }, 1, 1, "category-table-p", 0, 0}; Lisp_Object Fcategory_table_p

  (Lisp_Object arg)
{
  if (CHAR_TABLE_P (arg)
      && ((XCHAR_TABLE (arg)->purpose) == (builtin_lisp_symbol (242))))
...
check_category_table (Lisp_Object table)
{
  if (((table) == (builtin_lisp_symbol (0))))
    return ((current_buffer)-> category_table_);
  ((!((Fcategory_table_p (table)) == (builtin_lisp_symbol (0)))) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (243), table));
  return table;
}

static struct Lisp_Subr _Alignas (8) Scategory_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fcategory_table }, 0, 0, "category-table", 0, 0}; Lisp_Object Fcategory_table
...
static struct Lisp_Subr _Alignas (8) Sstandard_category_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fstandard_category_table }, 0, 0, "standard-category-table", 0, 0}; Lisp_Object Fstandard_category_table



  (void)
{
  return ((&buffer_defaults)-> category_table_);
}
...
copy_category_entry (Lisp_Object table, Lisp_Object c, Lisp_Object val)
{
  ...
  if ((((enum Lisp_Type) ((c) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    char_table_set_range (table, (((((void) (0 && ((((enum Lisp_Type) ((c) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((c) - (Lisp_Cons))))->car) >> INTTYPEBITS), (((((void) (0 && ((((enum Lisp_Type) ((c) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((c) - (Lisp_Cons))))->u.cdr) >> INTTYPEBITS), val);
  else
    char_table_set (table, ((c) >> INTTYPEBITS), val);
}
...
copy_category_table (Lisp_Object table)
{
  ...
  if (! ((XCHAR_TABLE (table)->defalt) == (builtin_lisp_symbol (0))))
    set_char_table_defalt (table,
      Fcopy_sequence (XCHAR_TABLE (table)->defalt));
  set_char_table_extras
    (table, 0, Fcopy_sequence (XCHAR_TABLE (table)->extras[0]));
  map_char_table (copy_category_entry, builtin_lisp_symbol (0), table, table);

  return table;
}

static struct Lisp_Subr _Alignas (8) Scopy_category_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fcopy_category_table }, 0, 1, "copy-category-table", 0, 0}; Lisp_Object Fcopy_category_table
  ...
  (Lisp_Object table)
{
  if (!((table) == (builtin_lisp_symbol (0))))
    ...
    table = ((&buffer_defaults)-> category_table_);

  return copy_category_table (table);
}

static struct Lisp_Subr _Alignas (8) Smake_category_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fmake_category_table }, 0, 0, "make-category-table", 0, 0}; Lisp_Object Fmake_category_table
  ...
  (void)
{
  ...
  val = Fmake_char_table (builtin_lisp_symbol (242), builtin_lisp_symbol (0));
  set_char_table_defalt (val, (Fmake_bool_vector (((EMACS_INT) (((EMACS_UINT) (128) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0))));
  for (i = 0; i < (1 << CHARTAB_SIZE_BITS_0); i++)
    set_char_table_contents (val, i, (Fmake_bool_vector (((EMACS_INT) (((EMACS_UINT) (128) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0))));
  Fset_char_table_extra_slot (val, ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)),
         Fmake_vector (((EMACS_INT) (((EMACS_UINT) (95) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0)));
  return val;
}

static struct Lisp_Subr _Alignas (8) Sset_category_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fset_category_table }, 1, 1, "set-category-table", 0, 0}; Lisp_Object Fset_category_table
  ...
  (Lisp_Object table)
{
  ...
  idx = ((*(Lisp_Object *)((__builtin_offsetof(struct buffer, category_table_)) + (char *) &buffer_local_flags)) >> INTTYPEBITS);
...
{
  return CHAR_TABLE_REF (((current_buffer)-> category_table_), c);
}

static struct Lisp_Subr _Alignas (8) Schar_category_set = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fchar_category_set }, 1, 1, "char-category-set", 0, 0}; Lisp_Object Fchar_category_set


  (Lisp_Object ch)
{
  (((NATNUMP (ch) && ((ch) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), ch));
  return char_category_set (((ch) >> INTTYPEBITS));
}

static struct Lisp_Subr _Alignas (8) Scategory_set_mnemonics = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fcategory_set_mnemonics }, 1, 1, "category-set-mnemonics", 0, 0}; Lisp_Object Fcategory_set_mnemonics
  ...
  (Lisp_Object category_set)
{
  ...
  (((BOOL_VECTOR_P (category_set) && bool_vector_size (category_set) == 128)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (245), category_set));
...
static struct Lisp_Subr _Alignas (8) Smodify_category_entry = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fmodify_category_entry }, 2, 4, "modify-category-entry", 0, 0}; Lisp_Object Fmodify_category_entry
# 343 "category.c"
  (Lisp_Object character, Lisp_Object category, Lisp_Object table, Lisp_Object reset)
{
  ...
  if (((((enum Lisp_Type) ((character) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    {
      (((NATNUMP (character) && ((character) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), character));
      start = end = ((character) >> INTTYPEBITS);
    }
  else
    {
      CHECK_CONS (character);
      do { Lisp_Object tmp = (((void) (0 && ((((enum Lisp_Type) ((character) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((character) - (Lisp_Cons))))->car; (((NATNUMP (tmp) && ((tmp) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), tmp)); } while (0);
      do { Lisp_Object tmp = (((void) (0 && ((((enum Lisp_Type) ((character) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((character) - (Lisp_Cons))))->u.cdr; (((NATNUMP (tmp) && ((tmp) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), tmp)); } while (0);
      start = (((((void) (0 && ((((enum Lisp_Type) ((character) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((character) - (Lisp_Cons))))->car) >> INTTYPEBITS);
      end = (((((void) (0 && ((((enum Lisp_Type) ((character) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((character) - (Lisp_Cons))))->u.cdr) >> INTTYPEBITS);
    }
  ...
  if (((AREF (Fchar_table_extra_slot (table, ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0))), ((((category) >> INTTYPEBITS)) - ' '))) == (builtin_lisp_symbol (0))))
    error ("Undefined category: %c", (int) ((category) >> INTTYPEBITS));

  set_value = ((reset) == (builtin_lisp_symbol (0)));

  while (start <= end)
    {
      from = start, to = end;
      category_set = char_table_ref_and_range (table, start, &from, &to);
      if (CATEGORY_MEMBER (((category) >> INTTYPEBITS), category_set) != ((reset) == (builtin_lisp_symbol (0))))
 {
   category_set = Fcopy_sequence (category_set);
   set_category_set (category_set, ((category) >> INTTYPEBITS), set_value);
...
word_boundary_p (int c1, int c2)
{
  ...
  Lisp_Object tail;
  _Bool default_result;

  if (((CHAR_TABLE_REF (globals.f_Vchar_script_table, c1)) == (CHAR_TABLE_REF (globals.f_Vchar_script_table, c2))))

    {
      tail = globals.f_Vword_separating_categories;
      default_result = 0;
    }
  else
    {
      tail = globals.f_Vword_combining_categories;
      default_result = 1;
    }

  category_set1 = char_category_set (c1);
  if (((category_set1) == (builtin_lisp_symbol (0))))
    return default_result;
  category_set2 = char_category_set (c2);
  if (((category_set2) == (builtin_lisp_symbol (0))))
    return default_result;
  ...
  for (; (((enum Lisp_Type) ((tail) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); tail = (((void) (0 && ((((enum Lisp_Type) ((tail) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail) - (Lisp_Cons))))->u.cdr)
    {
      Lisp_Object elt = (((void) (0 && ((((enum Lisp_Type) ((tail) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail) - (Lisp_Cons))))->car;

      if ((((enum Lisp_Type) ((elt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)
   && ((((((void) (0 && ((((enum Lisp_Type) ((elt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((elt) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (0)))
       || (RANGED_INTEGERP (0x20, (((void) (0 && ((((enum Lisp_Type) ((elt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((elt) - (Lisp_Cons))))->car, 0x7E)
    && CATEGORY_MEMBER ((((((void) (0 && ((((enum Lisp_Type) ((elt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((elt) - (Lisp_Cons))))->car) >> INTTYPEBITS), category_set1)
    && ! CATEGORY_MEMBER ((((((void) (0 && ((((enum Lisp_Type) ((elt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((elt) - (Lisp_Cons))))->car) >> INTTYPEBITS), category_set2)))
   && ((((((void) (0 && ((((enum Lisp_Type) ((elt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((elt) - (Lisp_Cons))))->u.cdr) == (builtin_lisp_symbol (0)))
       || (RANGED_INTEGERP (0x20, (((void) (0 && ((((enum Lisp_Type) ((elt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((elt) - (Lisp_Cons))))->u.cdr, 0x7E)
    && ! CATEGORY_MEMBER ((((((void) (0 && ((((enum Lisp_Type) ((elt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((elt) - (Lisp_Cons))))->u.cdr) >> INTTYPEBITS), category_set1)
    && CATEGORY_MEMBER ((((((void) (0 && ((((enum Lisp_Type) ((elt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((elt) - (Lisp_Cons))))->u.cdr) >> INTTYPEBITS), category_set2))))
 return !default_result;
    }
  return default_result;
}
...
init_category_once (void)
{
                                            ...
                                            ;
  Fput (builtin_lisp_symbol (242), builtin_lisp_symbol (258), ((EMACS_INT) (((EMACS_UINT) (2) << INTTYPEBITS) + Lisp_Int0)));

  ((&buffer_defaults)-> category_table_) = Fmake_char_table (builtin_lisp_symbol (242), builtin_lisp_symbol (0));

  set_char_table_defalt (((&buffer_defaults)-> category_table_), (Fmake_bool_vector (((EMACS_INT) (((EMACS_UINT) (128) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0))));
  Fset_char_table_extra_slot (((&buffer_defaults)-> category_table_), ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)),
         Fmake_vector (((EMACS_INT) (((EMACS_UINT) (95) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0)));
}
...
syms_of_category (void)
{
  ...
  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "word-combining-categories", &globals.f_Vword_combining_categories); } while (0);
# 496 "category.c"
  globals.f_Vword_combining_categories = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "word-separating-categories", &globals.f_Vword_separating_categories); } while (0);



  globals.f_Vword_separating_categories = builtin_lisp_symbol (0);
