...
static Lisp_Object being_printed[200];
...
_Bool print_output_debug_flag = 1;
# 191 "print.c"
static void
...
printchar_to_stream (unsigned int ch, FILE *stream)
{
  Lisp_Object dv ;
  ptrdiff_t i = 0, n = 1;
  Lisp_Object coding_system = globals.f_Vlocale_coding_system;
  _Bool encode_p = 0;
  ...
  if ((((sizeof ((ch) + 0)) > (sizeof ((0x3FFFFF) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0x3FFFFF) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) <= ((0x3FFFFF) + (unsigned) 0) : ((ch) + (uintmax_t) 0) <= ((0x3FFFFF) + (uintmax_t) 0)) && (CHAR_TABLE_P (globals.f_Vstandard_display_table) && ((XCHAR_TABLE (globals.f_Vstandard_display_table)->purpose) == (builtin_lisp_symbol (346))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (globals.f_Vstandard_display_table)) == 6))
    {
      dv = ((((sizeof ((ch) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((ch) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? ((((XCHAR_TABLE (globals.f_Vstandard_display_table))->ascii) == (builtin_lisp_symbol (0))) ? (XCHAR_TABLE (globals.f_Vstandard_display_table))->defalt : (SUB_CHAR_TABLE_P ((XCHAR_TABLE (globals.f_Vstandard_display_table))->ascii) ? XSUB_CHAR_TABLE ((XCHAR_TABLE (globals.f_Vstandard_display_table))->ascii)->contents[ch] : (XCHAR_TABLE (globals.f_Vstandard_display_table))->ascii)) : disp_char_vector ((XCHAR_TABLE (globals.f_Vstandard_display_table)), (ch)));
      if (VECTORP (dv))
 {
   n = ASIZE (dv);
   goto next_char;
 ...
 {
   unsigned char mbstr[5];
   int len = ((((sizeof ((ch) + 0)) > (sizeof ((0x7F) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0x7F) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) <= ((0x7F) + (unsigned) 0) : ((ch) + (uintmax_t) 0) <= ((0x7F) + (uintmax_t) 0)) ? ((mbstr)[0] = (ch), 1) : (((sizeof ((ch) + 0)) > (sizeof ((0x7FF) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0x7FF) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) <= ((0x7FF) + (unsigned) 0) : ((ch) + (uintmax_t) 0) <= ((0x7FF) + (uintmax_t) 0)) ? ((mbstr)[0] = (0xC0 | ((ch) >> 6)), (mbstr)[1] = (0x80 | ((ch) & 0x3F)), 2) : (((sizeof ((ch) + 0)) > (sizeof ((0xFFFF) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0xFFFF) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) <= ((0xFFFF) + (unsigned) 0) : ((ch) + (uintmax_t) 0) <= ((0xFFFF) + (uintmax_t) 0)) ? ((mbstr)[0] = (0xE0 | ((ch) >> 12)), (mbstr)[1] = (0x80 | (((ch) >> 6) & 0x3F)), (mbstr)[2] = (0x80 | ((ch) & 0x3F)), 3) : ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (ch) <= sizeof (unsigned)) ? 1 : -1; })) ? (char_string (ch, mbstr)) : (char_string (ch, mbstr))));
   ...
   fwrite (SSDATA (encoded_ch), 1, SBYTES (encoded_ch), stream);
    ...
    next_char:
      for (; i < n; i++)
 if ((NATNUMP (AREF (dv, i)) && ((AREF (dv, i)) >> INTTYPEBITS) <= 0x3FFFFF))
   break;
      if (! (i < n))
 break;
      ch = ((AREF (dv, i)) >> INTTYPEBITS);
    }
}
...
{
  if (!((fun) == (builtin_lisp_symbol (0))) && !((fun) == (builtin_lisp_symbol (901))))
    call1 (fun, ((EMACS_INT) (((EMACS_UINT) (ch) << INTTYPEBITS) + Lisp_Int0)));
  else
    {
      unsigned char str[5];
      int len = ((((sizeof ((ch) + 0)) > (sizeof ((0x7F) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0x7F) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) <= ((0x7F) + (unsigned) 0) : ((ch) + (uintmax_t) 0) <= ((0x7F) + (uintmax_t) 0)) ? ((str)[0] = (ch), 1) : (((sizeof ((ch) + 0)) > (sizeof ((0x7FF) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0x7FF) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) <= ((0x7FF) + (unsigned) 0) : ((ch) + (uintmax_t) 0) <= ((0x7FF) + (uintmax_t) 0)) ? ((str)[0] = (0xC0 | ((ch) >> 6)), (str)[1] = (0x80 | ((ch) & 0x3F)), 2) : (((sizeof ((ch) + 0)) > (sizeof ((0xFFFF) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0xFFFF) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) <= ((0xFFFF) + (unsigned) 0) : ((ch) + (uintmax_t) 0) <= ((0xFFFF) + (uintmax_t) 0)) ? ((str)[0] = (0xE0 | ((ch) >> 12)), (str)[1] = (0x80 | (((ch) >> 6) & 0x3F)), (str)[2] = (0x80 | ((ch) & 0x3F)), 3) : ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (ch) <= sizeof (unsigned)) ? 1 : -1; })) ? (char_string (ch, str)) : (char_string (ch, str))));
      ...
      else if (noninteractive)
 {
   ...
   if ((CHAR_TABLE_P (globals.f_Vstandard_display_table) && ((XCHAR_TABLE (globals.f_Vstandard_display_table)->purpose) == (builtin_lisp_symbol (346))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (globals.f_Vstandard_display_table)) == 6))
...
{
  if (((printcharfun) == (builtin_lisp_symbol (0))))
    {
 ...
 print_buffer = xpalloc (print_buffer, &print_buffer_size, incr, -1, 1);
  ...
  else if (noninteractive && ((printcharfun) == (builtin_lisp_symbol (901))))
    {
      if ((CHAR_TABLE_P (globals.f_Vstandard_display_table) && ((XCHAR_TABLE (globals.f_Vstandard_display_table)->purpose) == (builtin_lisp_symbol (346))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (globals.f_Vstandard_display_table)) == 6))
 {
   int len;
   for (ptrdiff_t i = 0; i < size_byte; i += len)
     {
       int ch = (!(((const unsigned char *) ptr + i)[0] & 0x80) ? ((len) = 1, ((const unsigned char *) ptr + i)[0]) : ! (((const unsigned char *) ptr + i)[0] & 0x20) ? ((len) = 2, ((((((const unsigned char *) ptr + i)[0] & 0x1F) << 6) | (((const unsigned char *) ptr + i)[1] & 0x3F)) + (((unsigned char) ((const unsigned char *) ptr + i)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! (((const unsigned char *) ptr + i)[0] & 0x10) ? ((len) = 3, (((((const unsigned char *) ptr + i)[0] & 0x0F) << 12) | ((((const unsigned char *) ptr + i)[1] & 0x3F) << 6) | (((const unsigned char *) ptr + i)[2] & 0x3F))) : string_char (((const unsigned char *) ptr + i), ((void*)0), &len));
 ...
 fwrite (ptr, 1, size_byte, stdout);
  ...
  else if (((printcharfun) == (builtin_lisp_symbol (901))))
    {
...
{
  if (((printcharfun) == (builtin_lisp_symbol (901))) || ((printcharfun) == (builtin_lisp_symbol (0))))
    {
      ptrdiff_t chars;

      if (globals.f_print_escape_nonascii)
 string = string_escape_byte8 (string);

      if (STRING_MULTIBYTE (string))
 chars = SCHARS (string);
      else if (! globals.f_print_escape_nonascii
        && (((printcharfun) == (builtin_lisp_symbol (901)))
     ? ! ((((&buffer_defaults)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))
     : ! ((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))))
 {
 ...
 chars = SBYTES (string);
      ...
      if (((printcharfun) == (builtin_lisp_symbol (901))))
 {
   ...
   char *buffer = ((nbytes) <= sa_avail ? (sa_avail -= (nbytes), __builtin_alloca (nbytes)) : (sa_must_free = 1, record_xmalloc (nbytes)));
 ...
 for (i = 0; i < size_byte; )
   {
     ...
     int len;
     int ch = (!((SDATA (string) + i)[0] & 0x80) ? ((len) = 1, (SDATA (string) + i)[0]) : ! ((SDATA (string) + i)[0] & 0x20) ? ((len) = 2, (((((SDATA (string) + i)[0] & 0x1F) << 6) | ((SDATA (string) + i)[1] & 0x3F)) + (((unsigned char) (SDATA (string) + i)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((SDATA (string) + i)[0] & 0x10) ? ((len) = 3, ((((SDATA (string) + i)[0] & 0x0F) << 12) | (((SDATA (string) + i)[1] & 0x3F) << 6) | ((SDATA (string) + i)[2] & 0x3F))) : string_char ((SDATA (string) + i), ((void*)0), &len));
     printchar (ch, printcharfun);
     i += len;
   }
    }
...
static struct Lisp_Subr _Alignas (8) Swrite_char = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fwrite_char }, 1, 2, "write-char", 0, 0}; Lisp_Object Fwrite_char


  (Lisp_Object character, Lisp_Object printcharfun)
{
  if (((printcharfun) == (builtin_lisp_symbol (0))))
    printcharfun = globals.f_Vstandard_output;
  ...
  struct buffer *old = current_buffer; ptrdiff_t old_point = -1, start_point = -1; ptrdiff_t old_point_byte = -1, start_point_byte = -1; ptrdiff_t specpdl_count = SPECPDL_INDEX (); _Bool free_print_buffer = 0; _Bool multibyte = !((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))); Lisp_Object original = printcharfun; if (((printcharfun) == (builtin_lisp_symbol (0)))) printcharfun = builtin_lisp_symbol (901); if (BUFFERP (printcharfun)) { if (XBUFFER (printcharfun) != current_buffer) Fset_buffer (printcharfun); printcharfun = builtin_lisp_symbol (0); } if (((((enum Lisp_Type) ((printcharfun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE (printcharfun) == Lisp_Misc_Marker)) { ptrdiff_t marker_pos; if (! XMARKER (printcharfun)->buffer) error ("Marker does not point anywhere"); if (XMARKER (printcharfun)->buffer != current_buffer) set_buffer_internal (XMARKER (printcharfun)->buffer); marker_pos = marker_position (printcharfun); if (marker_pos < (current_buffer->begv) || marker_pos > (current_buffer->zv)) signal_error ("Marker is outside the accessible " "part of the buffer", printcharfun); old_point = (current_buffer->pt + 0); old_point_byte = (current_buffer->pt_byte + 0); (set_point_both (marker_pos, marker_byte_position (printcharfun))); start_point = (current_buffer->pt + 0); start_point_byte = (current_buffer->pt_byte + 0); printcharfun = builtin_lisp_symbol (0); } if (((printcharfun) == (builtin_lisp_symbol (0)))) { Lisp_Object string; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) && ! globals.f_print_escape_multibyte) specbind (builtin_lisp_symbol (770), builtin_lisp_symbol (901)); if (! ((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) && ! globals.f_print_escape_nonascii) specbind (builtin_lisp_symbol (772), builtin_lisp_symbol (901)); if (print_buffer != 0) { string = make_string_from_bytes (print_buffer, print_buffer_pos, print_buffer_pos_byte); record_unwind_protect (print_unwind, string); } else { int new_size = 1000; print_buffer = xmalloc (new_size); print_buffer_size = new_size; free_print_buffer = 1; } print_buffer_pos = 0; print_buffer_pos_byte = 0; } if (((printcharfun) == (builtin_lisp_symbol (901))) && ! noninteractive) setup_echo_area_for_printing (multibyte);;
  printchar (((character) >> INTTYPEBITS), printcharfun);
  if (((printcharfun) == (builtin_lisp_symbol (0)))) { if (print_buffer_pos != print_buffer_pos_byte && ((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) { ptrdiff_t sa_avail = MAX_ALLOCA; ptrdiff_t sa_count = SPECPDL_INDEX (); _Bool sa_must_free = 0; unsigned char *temp = ((print_buffer_pos + 1) <= sa_avail ? (sa_avail -= (print_buffer_pos + 1), __builtin_alloca (print_buffer_pos + 1)) : (sa_must_free = 1, record_xmalloc (print_buffer_pos + 1))); copy_text ((unsigned char *) print_buffer, temp, print_buffer_pos_byte, 1, 0); insert_1_both ((char *) temp, print_buffer_pos, print_buffer_pos, 0, 1, 0); do { if (sa_must_free) { sa_must_free = 0; unbind_to (sa_count, builtin_lisp_symbol (0)); } } while (0); } else insert_1_both (print_buffer, print_buffer_pos, print_buffer_pos_byte, 0, 1, 0); signal_after_change ((current_buffer->pt + 0) - print_buffer_pos, 0, print_buffer_pos); } if (free_print_buffer) { xfree (print_buffer); print_buffer = 0; } unbind_to (specpdl_count, builtin_lisp_symbol (0)); if (((((enum Lisp_Type) ((original) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE (original) == Lisp_Misc_Marker)) set_marker_both (original, builtin_lisp_symbol (0), (current_buffer->pt + 0), (current_buffer->pt_byte + 0)); if (old_point >= 0) (set_point_both (old_point + (old_point >= start_point ? (current_buffer->pt + 0) - start_point : 0), old_point_byte + (old_point_byte >= start_point_byte ? (current_buffer->pt_byte + 0) - start_point_byte : 0))); set_buffer_internal (old);;
  return character;
}
...
{
  write_string_1 (data, globals.f_Vstandard_output);
}
...
temp_output_buffer_setup (const char *bufname)
{
  ...
  bset_directory (current_buffer, ((old)-> directory_));
  bset_read_only (current_buffer, builtin_lisp_symbol (0));
  bset_filename (current_buffer, builtin_lisp_symbol (0));
  bset_undo_list (current_buffer, builtin_lisp_symbol (901));
  ((void) (0 && (current_buffer->overlays_before == ((void*)0))));
  ((void) (0 && (current_buffer->overlays_after == ((void*)0))));
  bset_enable_multibyte_characters
    (current_buffer, ((&buffer_defaults)-> enable_multibyte_characters_));
  specbind (builtin_lisp_symbol (547), builtin_lisp_symbol (901));
  ...
  run_hook (builtin_lisp_symbol (904));

  unbind_to (count, builtin_lisp_symbol (0));

  specbind (builtin_lisp_symbol (871), buf);
}

static void print (Lisp_Object, Lisp_Object, _Bool);
static void print_preprocess (Lisp_Object);
static void print_preprocess_string (INTERVAL, Lisp_Object);
static void print_object (Lisp_Object, Lisp_Object, _Bool);

static struct Lisp_Subr _Alignas (8) Sterpri = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fterpri }, 0, 2, "terpri", 0, 0}; Lisp_Object Fterpri
  ...
  (Lisp_Object printcharfun, Lisp_Object ensure)
{
  ...
  if (((ensure) == (builtin_lisp_symbol (0))))
    val = builtin_lisp_symbol (901);

  else if (FUNCTIONP (printcharfun))
    signal_error ("Unsupported function argument", printcharfun);
  else if (noninteractive && !((printcharfun) == (builtin_lisp_symbol (0))))
    val = printchar_stdout_last == 10 ? builtin_lisp_symbol (0) : builtin_lisp_symbol (901);
  else
    val = ((Fbolp ()) == (builtin_lisp_symbol (0))) ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0);
...
static struct Lisp_Subr _Alignas (8) Sprin1 = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fprin1 }, 1, 2, "prin1", 0, 0}; Lisp_Object Fprin1
# 629 "print.c"
...
static struct Lisp_Subr _Alignas (8) Sprin1_to_string = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fprin1_to_string }, 1, 2, "prin1-to-string", 0, 0}; Lisp_Object Fprin1_to_string
# 653 "print.c"
  (Lisp_Object object, Lisp_Object noescape)
{
  ...
  Lisp_Object save_deactivate_mark = globals.f_Vdeactivate_mark;
  _Bool prev_abort_on_gc = abort_on_gc;
  abort_on_gc = 1;

  Lisp_Object printcharfun = Vprin1_to_string_buffer;
  struct buffer *old = current_buffer; ptrdiff_t old_point = -1, start_point = -1; ptrdiff_t old_point_byte = -1, start_point_byte = -1; ptrdiff_t specpdl_count = SPECPDL_INDEX (); _Bool free_print_buffer = 0; _Bool multibyte = !((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))); Lisp_Object original = printcharfun; if (((printcharfun) == (builtin_lisp_symbol (0)))) printcharfun = builtin_lisp_symbol (901); if (BUFFERP (printcharfun)) { if (XBUFFER (printcharfun) != current_buffer) Fset_buffer (printcharfun); printcharfun = builtin_lisp_symbol (0); } if (((((enum Lisp_Type) ((printcharfun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE (printcharfun) == Lisp_Misc_Marker)) { ptrdiff_t marker_pos; if (! XMARKER (printcharfun)->buffer) error ("Marker does not point anywhere"); if (XMARKER (printcharfun)->buffer != current_buffer) set_buffer_internal (XMARKER (printcharfun)->buffer); marker_pos = marker_position (printcharfun); if (marker_pos < (current_buffer->begv) || marker_pos > (current_buffer->zv)) signal_error ("Marker is outside the accessible " "part of the buffer", printcharfun); old_point = (current_buffer->pt + 0); old_point_byte = (current_buffer->pt_byte + 0); (set_point_both (marker_pos, marker_byte_position (printcharfun))); start_point = (current_buffer->pt + 0); start_point_byte = (current_buffer->pt_byte + 0); printcharfun = builtin_lisp_symbol (0); } if (((printcharfun) == (builtin_lisp_symbol (0)))) { Lisp_Object string; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) && ! globals.f_print_escape_multibyte) specbind (builtin_lisp_symbol (770), builtin_lisp_symbol (901)); if (! ((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) && ! globals.f_print_escape_nonascii) specbind (builtin_lisp_symbol (772), builtin_lisp_symbol (901)); if (print_buffer != 0) { string = make_string_from_bytes (print_buffer, print_buffer_pos, print_buffer_pos_byte); record_unwind_protect (print_unwind, string); } else { int new_size = 1000; print_buffer = xmalloc (new_size); print_buffer_size = new_size; free_print_buffer = 1; } print_buffer_pos = 0; print_buffer_pos_byte = 0; } if (((printcharfun) == (builtin_lisp_symbol (901))) && ! noninteractive) setup_echo_area_for_printing (multibyte);;
  print (object, printcharfun, ((noescape) == (builtin_lisp_symbol (0))));
  ...
  if (SBYTES (object) == SCHARS (object))
    do { if (XSTRING (object)->size == 0) (object) = empty_unibyte_string; else XSTRING (object)->size_byte = -1; } while (0);
  ...
  globals.f_Vdeactivate_mark = save_deactivate_mark;

  abort_on_gc = prev_abort_on_gc;
  return unbind_to (count, object);
}

static struct Lisp_Subr _Alignas (8) Sprinc = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fprinc }, 1, 2, "princ", 0, 0}; Lisp_Object Fprinc
# 712 "print.c"
  (Lisp_Object object, Lisp_Object printcharfun)
{
  if (((printcharfun) == (builtin_lisp_symbol (0))))
...
static struct Lisp_Subr _Alignas (8) Sprint = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fprint }, 1, 2, "print", 0, 0}; Lisp_Object Fprint
# 745 "print.c"
  (Lisp_Object object, Lisp_Object printcharfun)
{
  if (((printcharfun) == (builtin_lisp_symbol (0))))
...
static struct Lisp_Subr _Alignas (8) Sexternal_debugging_output = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fexternal_debugging_output }, 1, 1, "external-debugging-output", 0, 0}; Lisp_Object Fexternal_debugging_output
...
{
  ((((((enum Lisp_Type) ((character) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), character));
  printchar_to_stream (((character) >> INTTYPEBITS), stderr);
  return character;
}
...
extern void debug_output_compilation_hack (_Bool) ;
void
debug_output_compilation_hack (_Bool x)
{
  print_output_debug_flag = x;
}
# 785 "print.c"
static FILE *initial_stderr_stream = ((void*)0);

static struct Lisp_Subr _Alignas (8) Sredirect_debugging_output = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fredirect_debugging_output }, 1, 2, "redirect-debugging-output", "FDebug output file: \nP", 0}; Lisp_Object Fredirect_debugging_output
...
{
  if (initial_stderr_stream != ((void*)0))
    {
      block_input ();
      fclose (stderr);
      unblock_input ();
  ...
  initial_stderr_stream = ((void*)0);

  if (STRINGP (file))
    {
      file = Fexpand_file_name (file, builtin_lisp_symbol (0));
      initial_stderr_stream = stderr;
      stderr = emacs_fopen (SSDATA (file), ((append) == (builtin_lisp_symbol (0))) ? "w" : "a");
      if (stderr == ((void*)0))
 {
   stderr = initial_stderr_stream;
   initial_stderr_stream = ((void*)0);
...
{
  Fprin1 (arg, builtin_lisp_symbol (394));
  fprintf (stderr, "\r\n");
}

void safe_debug_print (Lisp_Object) ;
void
safe_debug_print (Lisp_Object arg)
{
  ...
  if (valid > 0)
    ...
    {
      EMACS_UINT n = (arg);
      fprintf (stderr, "#<%s_LISP_OBJECT 0x%08""l""x>\r\n",
        !valid ? "INVALID" : "SOME",
        n);
    }
}
...
static struct Lisp_Subr _Alignas (8) Serror_message_string = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Ferror_message_string }, 1, 1, "error-message-string", 0, 0}; Lisp_Object Ferror_message_string
  ...
  (Lisp_Object obj)
{
  ...
  if ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (372)))
      && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)
      && STRINGP ((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car)
      && (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) == (builtin_lisp_symbol (0))))
    return (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car;

  print_error_message (obj, Vprin1_to_string_buffer, 0, builtin_lisp_symbol (0));
       ...
       Lisp_Object caller)
{
  ...
  if (!((caller) == (builtin_lisp_symbol (0))) && (((enum Lisp_Type) ((caller) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
    {
      Lisp_Object cname = SYMBOL_NAME (caller);
      ptrdiff_t cnamelen = SBYTES (cname);
      ptrdiff_t sa_avail = MAX_ALLOCA; ptrdiff_t sa_count = SPECPDL_INDEX (); _Bool sa_must_free = 0;
      char *name = ((cnamelen) <= sa_avail ? (sa_avail -= (cnamelen), __builtin_alloca (cnamelen)) : (sa_must_free = 1, record_xmalloc (cnamelen)));
  ...
  if (((errname) == (builtin_lisp_symbol (372))))
    {
      data = Fcdr (data);
      if (!(((enum Lisp_Type) ((data) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 data = builtin_lisp_symbol (0);
      errmsg = Fcar (data);
      file_error = builtin_lisp_symbol (0);
    }
  else
    {
      Lisp_Object error_conditions = Fget (errname, builtin_lisp_symbol (373));
      errmsg = Fget (errname, builtin_lisp_symbol (374));
      file_error = Fmemq (builtin_lisp_symbol (411), error_conditions);
    }
  ...
  if (!((file_error) == (builtin_lisp_symbol (0))) && (((enum Lisp_Type) ((tail) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    errmsg = (((void) (0 && ((((enum Lisp_Type) ((tail) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail) - (Lisp_Cons))))->car, tail = (((void) (0 && ((((enum Lisp_Type) ((tail) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail) - (Lisp_Cons))))->u.cdr;

  {
    ...
    for (; (((enum Lisp_Type) ((tail) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); tail = (((void) (0 && ((((enum Lisp_Type) ((tail) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail) - (Lisp_Cons))))->u.cdr, sep = ", ")
      {
 Lisp_Object obj;

 if (sep)
   write_string_1 (sep, stream);
 obj = (((void) (0 && ((((enum Lisp_Type) ((tail) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail) - (Lisp_Cons))))->car;
 if (!((file_error) == (builtin_lisp_symbol (0)))
     || ((errname) == (builtin_lisp_symbol (367))) || ((errname) == (builtin_lisp_symbol (981))))
   Fprinc (obj, stream);
 else
   Fprin1 (obj, stream);
      }
...
float_to_string (char *buf, double data)
{
 ...
 if (u_data.c[i] & u_minus_zero.c[i])
  ...
  if (((globals.f_Vfloat_output_format) == (builtin_lisp_symbol (0)))
      || !STRINGP (globals.f_Vfloat_output_format))
  lose:
    {


      len = dtoastr (buf, 350 - 2, 0, 0, data);
  ...
  else
    {
      ...
      cp = SSDATA (globals.f_Vfloat_output_format);
 ...
 goto lose;
      ...
      len = sprintf (buf, SSDATA (globals.f_Vfloat_output_format), data);
    }
...
static void
print (Lisp_Object obj, Lisp_Object printcharfun, _Bool escapeflag)
{
  ...
  if (((globals.f_Vprint_continuous_numbering) == (builtin_lisp_symbol (0)))
      || ((globals.f_Vprint_number_table) == (builtin_lisp_symbol (0))))
    {
  ...
  if (!((globals.f_Vprint_gensym) == (builtin_lisp_symbol (0))) || !((globals.f_Vprint_circle) == (builtin_lisp_symbol (0))))
    {
      ...
      if (HASH_TABLE_P (globals.f_Vprint_number_table))
 {

   struct Lisp_Hash_Table *h = XHASH_TABLE (globals.f_Vprint_number_table);
   ptrdiff_t i;

   for (i = 0; i < HASH_TABLE_SIZE (h); ++i)
     if (!((HASH_HASH (h, i)) == (builtin_lisp_symbol (0)))
  && ((HASH_VALUE (h, i)) == (builtin_lisp_symbol (901))))
       Fremhash (HASH_KEY (h, i), globals.f_Vprint_number_table);
 }
    }
...
print_preprocess (Lisp_Object obj)
{
  ...
  if (((globals.f_Vprint_circle) == (builtin_lisp_symbol (0))))
    {
 ...
 loop:
  if ((STRINGP (obj) || (((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) || ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Vectorlike) && (VECTORP (obj) || COMPILEDP (obj) || CHAR_TABLE_P (obj) || SUB_CHAR_TABLE_P (obj) || HASH_TABLE_P (obj) || FONTP (obj))) || (! ((globals.f_Vprint_gensym) == (builtin_lisp_symbol (0))) && (((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol) && !SYMBOL_INTERNED_P (obj))))
    {
      if (!HASH_TABLE_P (globals.f_Vprint_number_table))
 globals.f_Vprint_number_table = (Fmake_hash_table) ((sizeof (((Lisp_Object []) {builtin_lisp_symbol (129), builtin_lisp_symbol (369)})) / sizeof (((Lisp_Object []) {builtin_lisp_symbol (129), builtin_lisp_symbol (369)}))[0]), ((Lisp_Object []) {builtin_lisp_symbol (129), builtin_lisp_symbol (369)}));



      if (! ((globals.f_Vprint_circle) == (builtin_lisp_symbol (0))) || (((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
 {
   Lisp_Object num = Fgethash (obj, globals.f_Vprint_number_table, builtin_lisp_symbol (0));
   if (!((num) == (builtin_lisp_symbol (0)))



       || (!((globals.f_Vprint_continuous_numbering) == (builtin_lisp_symbol (0)))
    && (((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol)
    && !SYMBOL_INTERNED_P (obj)))
     {
       if (!((((enum Lisp_Type) ((num) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
  {
    print_number_index++;

    Fputhash (obj, ((EMACS_INT) (((EMACS_UINT) (- print_number_index) << INTTYPEBITS) + Lisp_Int0)),
     ...
     Fputhash (obj, builtin_lisp_symbol (901), globals.f_Vprint_number_table);
 }
 ...
 case Lisp_String:
   ...
   traverse_intervals_noorder (string_intervals (obj),
          print_preprocess_string, builtin_lisp_symbol (0));
   break;

 case Lisp_Cons:


   if (loop_count && ((obj) == (halftail)))
     break;
   print_preprocess ((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car);
   obj = (((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr;
   loop_count++;
   if (!(loop_count & 1))
...
print_check_string_charset_prop (INTERVAL interval, Lisp_Object string)
{
  ...
  if (((interval->plist) == (builtin_lisp_symbol (0)))
      || (print_check_string_result == (1
     | 2)))
    return;
  for (val = interval->plist; (((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ! (((((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (261)));
       val = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr);
  if (! (((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      print_check_string_result |= 1;
      return;
    }
  if (! (print_check_string_result & 1))
    {
      if (! ((val) == (interval->plist))
   || (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 print_check_string_result |= 1;
    }
  if (((globals.f_Vprint_charset_text_property) == (builtin_lisp_symbol (0)))
      || ! (print_check_string_result & 2))
    {
      int i, c;
      ...
      charset = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car;
      for (i = 0; i < ((interval) == ((void*)0) ? 0 : ((((interval)) == ((void*)0) ? 0 : ((interval))->total_length) - (((interval)->right) == ((void*)0) ? 0 : ((interval)->right)->total_length) - (((interval)->left) == ((void*)0) ? 0 : ((interval)->left)->total_length))); i++)
 {
   do { charpos++; if (STRING_MULTIBYTE (string)) { unsigned char *chp = &SDATA (string)[bytepos]; int chlen; c = (!((chp)[0] & 0x80) ? ((chlen) = 1, (chp)[0]) : ! ((chp)[0] & 0x20) ? ((chlen) = 2, (((((chp)[0] & 0x1F) << 6) | ((chp)[1] & 0x3F)) + (((unsigned char) (chp)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((chp)[0] & 0x10) ? ((chlen) = 3, ((((chp)[0] & 0x0F) << 12) | (((chp)[1] & 0x3F) << 6) | ((chp)[2] & 0x3F))) : string_char ((chp), ((void*)0), &chlen)); bytepos += chlen; } else { c = SREF (string, bytepos); bytepos++; } } while (0);
   if (! (((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0))
       && ! (((AREF (((HASH_VALUE (XHASH_TABLE (Vcharset_hash_table), (((c) < 0x80 ? (charset_table + (charset_ascii)) : char_charset ((c), builtin_lisp_symbol (0), ((void*)0))))->hash_index))), charset_name))) == (charset)))
     {
       print_check_string_result |= 2;
       break;
     }
...
print_prune_string_charset (Lisp_Object string)
{
  ...
  if (! (print_check_string_result & 2))
    {
      string = Fcopy_sequence (string);
      if (print_check_string_result & 1)
 {
   if (((print_prune_charset_plist) == (builtin_lisp_symbol (0))))
     print_prune_charset_plist = list1 (builtin_lisp_symbol (261));
   Fremove_text_properties (((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)),
       ((EMACS_INT) (((EMACS_UINT) (SCHARS (string)) << INTTYPEBITS) + Lisp_Int0)),
       print_prune_charset_plist, string);
 }
      else
 Fset_text_properties (((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (SCHARS (string)) << INTTYPEBITS) + Lisp_Int0)),
         builtin_lisp_symbol (0), string);
    }
  return string;
}

static void
print_object (Lisp_Object obj, Lisp_Object printcharfun, _Bool escapeflag)
{
  char buf[((sizeof "from..to..in " + 2 * ((((sizeof (EMACS_INT) * 8 - (! ((__typeof__ (EMACS_INT)) 0 < (__typeof__ (EMACS_INT)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (EMACS_INT)) 0 < (__typeof__ (EMACS_INT)) -1)))) > (((sizeof " . #" + ((((sizeof (printmax_t) * 8 - (! ((__typeof__ (printmax_t)) 0 < (__typeof__ (printmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (printmax_t)) 0 < (__typeof__ (printmax_t)) -1)))) > (40) ? (sizeof " . #" + ((((sizeof (printmax_t) * 8 - (! ((__typeof__ (printmax_t)) 0 < (__typeof__ (printmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (printmax_t)) 0 < (__typeof__ (printmax_t)) -1)))) : (40))) ? (sizeof "from..to..in " + 2 * ((((sizeof (EMACS_INT) * 8 - (! ((__typeof__ (EMACS_INT)) 0 < (__typeof__ (EMACS_INT)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (EMACS_INT)) 0 < (__typeof__ (EMACS_INT)) -1)))) : (((sizeof " . #" + ((((sizeof (printmax_t) * 8 - (! ((__typeof__ (printmax_t)) 0 < (__typeof__ (printmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (printmax_t)) 0 < (__typeof__ (printmax_t)) -1)))) > (40) ? (sizeof " . #" + ((((sizeof (printmax_t) * 8 - (! ((__typeof__ (printmax_t)) 0 < (__typeof__ (printmax_t)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (printmax_t)) 0 < (__typeof__ (printmax_t)) -1)))) : (40))))];
 ...
 if (((obj) == (being_printed[i])))
  ...
  else if ((STRINGP (obj) || (((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) || ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Vectorlike) && (VECTORP (obj) || COMPILEDP (obj) || CHAR_TABLE_P (obj) || SUB_CHAR_TABLE_P (obj) || HASH_TABLE_P (obj) || FONTP (obj))) || (! ((globals.f_Vprint_gensym) == (builtin_lisp_symbol (0))) && (((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol) && !SYMBOL_INTERNED_P (obj))))
    {

      Lisp_Object num = Fgethash (obj, globals.f_Vprint_number_table, builtin_lisp_symbol (0));
      if (((((enum Lisp_Type) ((num) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
 {
   EMACS_INT n = ((num) >> INTTYPEBITS);
   if (n < 0)
     {

       int len = sprintf (buf, "#%""l""d=", -n);
       strout (buf, len, len, printcharfun);

       Fputhash (obj, ((EMACS_INT) (((EMACS_UINT) (- n) << INTTYPEBITS) + Lisp_Int0)), globals.f_Vprint_number_table);
     }
   else
     {
  ...
  switch (((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))))
    ...
    case Lisp_Int0: case Lisp_Int1:
      {
 int len = sprintf (buf, "%""l""d", ((obj) >> INTTYPEBITS));
 strout (buf, len, len, printcharfun);
      }
      break;
      ...
      else
 {
   ...
   _Bool need_nonhex = 0;
   _Bool multibyte = STRING_MULTIBYTE (obj);

   if (! ((globals.f_Vprint_charset_text_property) == (builtin_lisp_symbol (901))))
   ...
   for (i = 0, i_byte = 0; i_byte < size_byte;)
     {
       ...
       do { i++; if (STRING_MULTIBYTE (obj)) { unsigned char *chp = &SDATA (obj)[i_byte]; int chlen; c = (!((chp)[0] & 0x80) ? ((chlen) = 1, (chp)[0]) : ! ((chp)[0] & 0x20) ? ((chlen) = 2, (((((chp)[0] & 0x1F) << 6) | ((chp)[1] & 0x3F)) + (((unsigned char) (chp)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((chp)[0] & 0x10) ? ((chlen) = 3, ((((chp)[0] & 0x0F) << 12) | (((chp)[1] & 0x3F) << 6) | ((chp)[2] & 0x3F))) : string_char ((chp), ((void*)0), &chlen)); i_byte += chlen; } else { c = SREF (obj, i_byte); i_byte++; } } while (0);

       do { if (!((globals.f_Vquit_flag) == (builtin_lisp_symbol (0))) && ((globals.f_Vinhibit_quit) == (builtin_lisp_symbol (0)))) process_quit_flag (); else if (pending_signals) process_pending_signals (); } while (0);

       if (multibyte
    ? (((c) > 0x3FFF7F) && (c = (((c) > 0x3FFF7F) ? (c) - 0x3FFF00 : (c & 0xFF)), 1))
    : ((((sizeof ((c) + 0)) > (sizeof ((0x100) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x100) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x100) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x100) + (uintmax_t) 0)) && ! (((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0))
       && globals.f_print_escape_nonascii))
  {
    ...
    need_nonhex = 0;
         ...
         && ! (((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) && globals.f_print_escape_multibyte)
  {

    char outbuf[sizeof "\\x" + ((((sizeof (c) * 8 - (! ((__typeof__ (c)) 0 < (__typeof__ (c)) -1))) * 146 + 484) / 485) + (! ((__typeof__ (c)) 0 < (__typeof__ (c)) -1)))];
       ...
       else
  {
    ...
    if (c == '\n' && globals.f_print_escape_newlines
        ? (c = 'n', 1)
        : c == '\f' && globals.f_print_escape_newlines
        ? (c = 'f', 1)
        : c == '\"' || c == '\\')
      printchar ('\\', printcharfun);
 ...
 if (! ((globals.f_Vprint_gensym) == (builtin_lisp_symbol (0))) && !SYMBOL_INTERNED_P (obj))
   print_c_string ("#:", printcharfun);
 else if (size_byte == 0)
   {
     print_c_string ("##", printcharfun);
 ...
 for (i = 0, i_byte = 0; i_byte < size_byte;)
   {
     ...
     do { i++; if (STRING_MULTIBYTE (name)) { unsigned char *chp = &SDATA (name)[i_byte]; int chlen; c = (!((chp)[0] & 0x80) ? ((chlen) = 1, (chp)[0]) : ! ((chp)[0] & 0x20) ? ((chlen) = 2, (((((chp)[0] & 0x1F) << 6) | ((chp)[1] & 0x3F)) + (((unsigned char) (chp)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((chp)[0] & 0x10) ? ((chlen) = 3, ((((chp)[0] & 0x0F) << 12) | (((chp)[1] & 0x3F) << 6) | ((chp)[2] & 0x3F))) : string_char ((chp), ((void*)0), &chlen)); i_byte += chlen; } else { c = SREF (name, i_byte); i_byte++; } } while (0);
     do { if (!((globals.f_Vquit_flag) == (builtin_lisp_symbol (0))) && ((globals.f_Vinhibit_quit) == (builtin_lisp_symbol (0)))) process_quit_flag (); else if (pending_signals) process_pending_signals (); } while (0);
  ...
  if (c == '\"' || c == '\\' || c == '\''
    ...
    case Lisp_Cons:
      ...
      if (((((enum Lisp_Type) ((globals.f_Vprint_level) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
   && print_depth > ((globals.f_Vprint_level) >> INTTYPEBITS))
 print_c_string ("...", printcharfun);
      else if (globals.f_print_quoted && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) == (builtin_lisp_symbol (0)))
        && (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (783))))
 {
   printchar ('\'', printcharfun);
   print_object ((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car, printcharfun, escapeflag);
 }
      else if (globals.f_print_quoted && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) == (builtin_lisp_symbol (0)))
        && (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (476))))
 {
   print_c_string ("#'", printcharfun);
   print_object ((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car, printcharfun, escapeflag);
 }
      else if (globals.f_print_quoted && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) == (builtin_lisp_symbol (0)))
        && (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (195))))
 {
   printchar ('`', printcharfun);
   ...
   new_backquote_output--;
        ...
        && new_backquote_output
        && ((((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (282)))
     || (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (283)))
     || (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (284)))))
 {
   print_object ((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car, printcharfun, 0);
   new_backquote_output--;
   print_object ((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car, printcharfun, escapeflag);
   new_backquote_output++;
 }
      else
 {
   ...
   printmax_t print_length = (NATNUMP (globals.f_Vprint_length)
         ? ((globals.f_Vprint_length) >> INTTYPEBITS)
         : ((printmax_t) (! (! ((printmax_t) 0 < (printmax_t) -1)) ? (printmax_t) -1 : ((((printmax_t) 1 << (sizeof (printmax_t) * 8 - 2)) - 1) * 2 + 1))));

   printmax_t i = 0;
   while ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
     {
       ...
       if (print_length <= i)
  {
    ...
    goto end_of_list;
       ...
       i++;
       print_object ((((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((obj) - (Lisp_Cons))))->car, printcharfun, escapeflag);
      ...
      else if (BOOL_VECTOR_P (obj))
 {
   ...
   int len = sprintf (buf, "#&%""l""d\"", size);
   strout (buf, len, len, printcharfun);




   if (NATNUMP (globals.f_Vprint_length)
       && ((globals.f_Vprint_length) >> INTTYPEBITS) < size_in_chars)
     size_in_chars = ((globals.f_Vprint_length) >> INTTYPEBITS);
   ...
   for (i = 0; i < size_in_chars; i++)
     {
       ...
       if (c == '\n' && globals.f_print_escape_newlines)
  print_c_string ("\\n", printcharfun);
       else if (c == '\f' && globals.f_print_escape_newlines)
      ...
      else if (SUBRP (obj))
 {
   ...
   printchar ('>', printcharfun);
      ...
      else if (PSEUDOVECTORP (obj, PVEC_XWIDGET) || PSEUDOVECTORP (obj, PVEC_XWIDGET_VIEW))
 {
      ...
      else if (HASH_TABLE_P (obj))
 {
   ...
   int len;
# 1794 "print.c"
   len = sprintf (buf, "#s(hash-table size %""l""d", ASIZE (h->next));
   strout (buf, len, len, printcharfun);

   if (!((h->test.name) == (builtin_lisp_symbol (0))))
     {
   ...
   if (NATNUMP (globals.f_Vprint_length)
       && ((globals.f_Vprint_length) >> INTTYPEBITS) < size)
     size = ((globals.f_Vprint_length) >> INTTYPEBITS);
 ...
 {
   if (!(!((((XBUFFER (obj))-> name_)) == (builtin_lisp_symbol (0)))))
     print_c_string ("#<killed buffer>", printcharfun);
   else if (escapeflag)
     {
       print_c_string ("#<buffer ", printcharfun);
       print_string (((XBUFFER (obj))-> name_), printcharfun);
       printchar ('>', printcharfun);
     }
   else
     print_string (((XBUFFER (obj))-> name_), printcharfun);
 ...
 {
   int len;
   void *ptr = (((void) (0 && (FRAMEP (obj)))), (struct frame *) ((void *) (intptr_t) ((obj) - (Lisp_Vectorlike))));
   Lisp_Object frame_name = (((void) (0 && (FRAMEP (obj)))), (struct frame *) ((void *) (intptr_t) ((obj) - (Lisp_Vectorlike))))->name;

   print_c_string (((((((void) (0 && (FRAMEP (obj)))), (struct frame *) ((void *) (intptr_t) ((obj) - (Lisp_Vectorlike)))))->terminal != 0)
      ? "#<frame "
      : "#<dead frame "),
     printcharfun);
   if (!STRINGP (frame_name))
     {
       ...
       if ((((enum Lisp_Type) ((frame_name) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
 ...
 case Lisp_Misc_Marker:
   ...
   if (! XMARKER (obj)->buffer)
     ...
     {
       int len = sprintf (buf, "at %""l""d in ", marker_position (obj));
       strout (buf, len, len, printcharfun);
       print_string (((XMARKER (obj)->buffer)-> name_), printcharfun);
     }
   printchar ('>', printcharfun);
   break;
 ...
 case Lisp_Misc_Overlay:
   ...
   if (! XMARKER (XOVERLAY (obj)->start)->buffer)
     print_c_string ("in no buffer", printcharfun);
   else
     {
       int len = sprintf (buf, "from %""l""d to %""l""d in ",
     marker_position (XOVERLAY (obj)->start),
     marker_position (XOVERLAY (obj)->end));
       strout (buf, len, len, printcharfun);
       print_string (((XMARKER (XOVERLAY (obj)->start)->buffer)-> name_),
       printcharfun);
     }
   printchar ('>', printcharfun);
          break;
# 2022 "print.c"
        case Lisp_Misc_Finalizer:
          ...
          if (((XFINALIZER (obj)->function) == (builtin_lisp_symbol (0))))
 ...
 case Lisp_Misc_Save_Value:
  ...
  int limit = ((amount) < (8) ? (amount) : (8));
  Lisp_Object *area = v->data[0].pointer;

  i = sprintf (buf, "with %""l""d objects", amount);
  strout (buf, i, i, printcharfun);
 ...
 if ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc))
   len = sprintf (buf, "(MISC 0x%04x)", (unsigned) XMISCTYPE (obj));
 else if ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Vectorlike))
   len = sprintf (buf, "(PVEC 0x%08zx)", (size_t) ASIZE (obj));
 else
   len = sprintf (buf, "(0x%02x)", (unsigned) ((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))));
 strout (buf, len, len, printcharfun);
...
print_interval (INTERVAL interval, Lisp_Object printcharfun)
{
  if (((interval->plist) == (builtin_lisp_symbol (0))))
    return;
  printchar (' ', printcharfun);
  print_object (((EMACS_INT) (((EMACS_UINT) (interval->position) << INTTYPEBITS) + Lisp_Int0)), printcharfun, 1);
  printchar (' ', printcharfun);
  print_object (((EMACS_INT) (((EMACS_UINT) (interval->position + ((interval) == ((void*)0) ? 0 : ((((interval)) == ((void*)0) ? 0 : ((interval))->total_length) - (((interval)->right) == ((void*)0) ? 0 : ((interval)->right)->total_length) - (((interval)->left) == ((void*)0) ? 0 : ((interval)->left)->total_length)))) << INTTYPEBITS) + Lisp_Int0)),
  printcharfun, 1);
  printchar (' ', printcharfun);
...
syms_of_print (void)
{
  ...
  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "standard-output", &globals.f_Vstandard_output); } while (0);





  globals.f_Vstandard_output = builtin_lisp_symbol (901);
                                              ;

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "float-output-format", &globals.f_Vfloat_output_format); } while (0);
# 2208 "print.c"
  globals.f_Vfloat_output_format = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "print-length", &globals.f_Vprint_length); } while (0);


  globals.f_Vprint_length = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "print-level", &globals.f_Vprint_level); } while (0);


  globals.f_Vprint_level = builtin_lisp_symbol (0);

  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "print-escape-newlines", &globals.f_print_escape_newlines); } while (0);


  globals.f_print_escape_newlines = 0;

  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "print-escape-nonascii", &globals.f_print_escape_nonascii); } while (0);





  globals.f_print_escape_nonascii = 0;

  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "print-escape-multibyte", &globals.f_print_escape_multibyte); } while (0);



  globals.f_print_escape_multibyte = 0;

  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "print-quoted", &globals.f_print_quoted); } while (0);


  globals.f_print_quoted = 0;

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "print-gensym", &globals.f_Vprint_gensym); } while (0);
  ...
  globals.f_Vprint_gensym = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "print-circle", &globals.f_Vprint_circle); } while (0);
# 2263 "print.c"
  globals.f_Vprint_circle = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "print-continuous-numbering", &globals.f_Vprint_continuous_numbering); } while (0);
  ...
  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "print-number-table", &globals.f_Vprint_number_table); } while (0);
# 2283 "print.c"
  globals.f_Vprint_number_table = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "print-charset-text-property", &globals.f_Vprint_charset_text_property); } while (0);
# 2296 "print.c"
  globals.f_Vprint_charset_text_property = builtin_lisp_symbol (324);
  ...
  print_prune_charset_plist = builtin_lisp_symbol (0);
