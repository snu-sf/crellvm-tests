...
{
  int c, c1;
  _Bool inword = flag == CASE_DOWN;


  if (((XCHAR_TABLE (((current_buffer)-> downcase_table_))->extras[1]) == (builtin_lisp_symbol (0))))
    Fset_case_table (((current_buffer)-> downcase_table_));

  if (((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    {
      int flagbits = (CHAR_ALT | CHAR_SUPER | CHAR_HYPER
        | CHAR_SHIFT | CHAR_CTL | CHAR_META);
      int flags = ((obj) >> INTTYPEBITS) & flagbits;
      ...
      if ((((sizeof ((((obj) >> INTTYPEBITS)) + 0)) > (sizeof ((flagbits) + 0)) ? (sizeof ((((obj) >> INTTYPEBITS)) + 0)) : (sizeof ((flagbits) + 0))) <= sizeof (unsigned) ? ((((obj) >> INTTYPEBITS)) + (unsigned) 0) > ((flagbits) + (unsigned) 0) : ((((obj) >> INTTYPEBITS)) + (uintmax_t) 0) > ((flagbits) + (uintmax_t) 0)))
 return obj;

      c1 = ((obj) >> INTTYPEBITS) & ~flagbits;
 ...
 (((void) (0 && ((c1) >= 0 && (c1) < 256))), (c1) = ((((sizeof ((c1) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c1) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c1) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c1) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (c1) : ((c1) + 0x3FFF00)));
      c = downcase (c1);
      if (inword)
 ((obj) = make_natnum (c | flags));
      else if (c == (((obj) >> INTTYPEBITS) & ~flagbits))
 {
   if (! inword)
     c = upcase1 (c1);
   if (! multibyte)
     do { if (! (((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0))) c = (((c) > 0x3FFF7F) ? (c) - 0x3FFF00 : (c & 0xFF)); } while (0);
   ((obj) = make_natnum (c | flags));
 }
      return obj;
    }
  ...
  if (!STRINGP (obj))
    wrong_type_argument (builtin_lisp_symbol (255), obj);
      ...
      for (i = 0; i < size; i++)
 {
  ...
  SSET (obj, i, c);
  ...
  else
    {
      ...
      ptrdiff_t o_size;
      if ((sizeof *(&o_size) == sizeof (signed char) ? (sizeof ((size) * (5)) < sizeof (signed char) ? ((((((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (0)) == -1) - ((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (1)) << (sizeof ((0 * ((signed char) (5)) + ((signed char) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (0)))) == 0 && ((((signed char) (size)) < 0 && 0 < ((signed char) (5))) || (((signed char) (5)) < 0 && 0 < ((signed char) (size))))) || (((signed char) (5)) < 0 ? (((signed char) (size)) < 0 ? ((signed char) (size)) < ((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (1)) << (sizeof ((0 * ((signed char) (5)) + ((signed char) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (5)) + ((signed char) (size))) - (1)))) / ((signed char) (5)) : ((signed char) (5)) == -1 ? 0 : ((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (0)) == -1) - ((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (1)) << (sizeof ((0 * ((signed char) (5)) + ((signed char) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (0)))) / ((signed char) (5)) < ((signed char) (size))) : ((signed char) (5)) == 0 ? 0 : (((signed char) (size)) < 0 ? ((signed char) (size)) < ((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (0)) == -1) - ((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (1)) << (sizeof ((0 * ((signed char) (5)) + ((signed char) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (0)))) / ((signed char) (5)) : ((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (5)) + ((signed char) (size))) + (1)) << (sizeof ((0 * ((signed char) (5)) + ((signed char) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (5)) + ((signed char) (size))) - (1)))) / ((signed char) (5)) < ((signed char) (size))))) || (((0 * (((signed char) (size)) * ((signed char) (5))) - (1)) < 0) && (((signed char) (size)) * ((signed char) (5))) < ((-127 -1))) || (127) < (((signed char) (size)) * ((signed char) (5)))) ? (*(&o_size) = (((unsigned char) ((signed char) (size)) * (unsigned char) ((signed char) (5))) <= (127) ? (signed char) ((unsigned char) ((signed char) (size)) * (unsigned char) ((signed char) (5))) : ((signed char) (((unsigned char) ((signed char) (size)) * (unsigned char) ((signed char) (5))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&o_size) = (((unsigned char) ((signed char) (size)) * (unsigned char) ((signed char) (5))) <= (127) ? (signed char) ((unsigned char) ((signed char) (size)) * (unsigned char) ((signed char) (5))) : ((signed char) (((unsigned char) ((signed char) (size)) * (unsigned char) ((signed char) (5))) - ((-127 -1))) + ((-127 -1)))), 0)) : ((((((((0 * (0 * (5) + (size)) - (1)) < 0) ? - (~ (0 * (0 * (5) + (size)) + (0)) == -1) - ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) + (0)))) == 0 && (((size) < 0 && 0 < (5)) || ((5) < 0 && 0 < (size)))) || ((5) < 0 ? ((size) < 0 ? (size) < ((((0 * (0 * (5) + (size)) - (1)) < 0) ? ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) - (1)))) / (5) : (5) == -1 ? 0 : ((((0 * (0 * (5) + (size)) - (1)) < 0) ? - (~ (0 * (0 * (5) + (size)) + (0)) == -1) - ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) + (0)))) / (5) < (size)) : (5) == 0 ? 0 : ((size) < 0 ? (size) < ((((0 * (0 * (5) + (size)) - (1)) < 0) ? - (~ (0 * (0 * (5) + (size)) + (0)) == -1) - ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) + (0)))) / (5) : ((((0 * (0 * (5) + (size)) - (1)) < 0) ? ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) - (1)))) / (5) < (size)))) || (((0 * ((size) * (5)) - (1)) < 0) && ((size) * (5)) < ((-127 -1))) || (127) < ((size) * (5))) ? (*(&o_size) = (((unsigned char) (size) * (unsigned char) (5)) <= (127) ? (signed char) ((unsigned char) (size) * (unsigned char) (5)) : ((signed char) (((unsigned char) (size) * (unsigned char) (5)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&o_size) = (((unsigned char) (size) * (unsigned char) (5)) <= (127) ? (signed char) ((unsigned char) (size) * (unsigned char) (5)) : ((signed char) (((unsigned char) (size) * (unsigned char) (5)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&o_size) == sizeof (short int) ? (sizeof ((size) * (5)) < sizeof (short int) ? ((((((((0 * (0 * ((short int) (5)) + ((short int) (size))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (5)) + ((short int) (size))) + (0)) == -1) - ((((0 * (0 * ((short int) (5)) + ((short int) (size))) + (1)) << (sizeof ((0 * ((short int) (5)) + ((short int) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (5)) + ((short int) (size))) + (0)))) == 0 && ((((short int) (size)) < 0 && 0 < ((short int) (5))) || (((short int) (5)) < 0 && 0 < ((short int) (size))))) || (((short int) (5)) < 0 ? (((short int) (size)) < 0 ? ((short int) (size)) < ((((0 * (0 * ((short int) (5)) + ((short int) (size))) - (1)) < 0) ? ((((0 * (0 * ((short int) (5)) + ((short int) (size))) + (1)) << (sizeof ((0 * ((short int) (5)) + ((short int) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (5)) + ((short int) (size))) - (1)))) / ((short int) (5)) : ((short int) (5)) == -1 ? 0 : ((((0 * (0 * ((short int) (5)) + ((short int) (size))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (5)) + ((short int) (size))) + (0)) == -1) - ((((0 * (0 * ((short int) (5)) + ((short int) (size))) + (1)) << (sizeof ((0 * ((short int) (5)) + ((short int) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (5)) + ((short int) (size))) + (0)))) / ((short int) (5)) < ((short int) (size))) : ((short int) (5)) == 0 ? 0 : (((short int) (size)) < 0 ? ((short int) (size)) < ((((0 * (0 * ((short int) (5)) + ((short int) (size))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (5)) + ((short int) (size))) + (0)) == -1) - ((((0 * (0 * ((short int) (5)) + ((short int) (size))) + (1)) << (sizeof ((0 * ((short int) (5)) + ((short int) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (5)) + ((short int) (size))) + (0)))) / ((short int) (5)) : ((((0 * (0 * ((short int) (5)) + ((short int) (size))) - (1)) < 0) ? ((((0 * (0 * ((short int) (5)) + ((short int) (size))) + (1)) << (sizeof ((0 * ((short int) (5)) + ((short int) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (5)) + ((short int) (size))) - (1)))) / ((short int) (5)) < ((short int) (size))))) || (((0 * (((short int) (size)) * ((short int) (5))) - (1)) < 0) && (((short int) (size)) * ((short int) (5))) < ((-32767 -1))) || (32767) < (((short int) (size)) * ((short int) (5)))) ? (*(&o_size) = (((unsigned short int) ((short int) (size)) * (unsigned short int) ((short int) (5))) <= (32767) ? (short int) ((unsigned short int) ((short int) (size)) * (unsigned short int) ((short int) (5))) : ((short int) (((unsigned short int) ((short int) (size)) * (unsigned short int) ((short int) (5))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&o_size) = (((unsigned short int) ((short int) (size)) * (unsigned short int) ((short int) (5))) <= (32767) ? (short int) ((unsigned short int) ((short int) (size)) * (unsigned short int) ((short int) (5))) : ((short int) (((unsigned short int) ((short int) (size)) * (unsigned short int) ((short int) (5))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : ((((((((0 * (0 * (5) + (size)) - (1)) < 0) ? - (~ (0 * (0 * (5) + (size)) + (0)) == -1) - ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) + (0)))) == 0 && (((size) < 0 && 0 < (5)) || ((5) < 0 && 0 < (size)))) || ((5) < 0 ? ((size) < 0 ? (size) < ((((0 * (0 * (5) + (size)) - (1)) < 0) ? ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) - (1)))) / (5) : (5) == -1 ? 0 : ((((0 * (0 * (5) + (size)) - (1)) < 0) ? - (~ (0 * (0 * (5) + (size)) + (0)) == -1) - ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) + (0)))) / (5) < (size)) : (5) == 0 ? 0 : ((size) < 0 ? (size) < ((((0 * (0 * (5) + (size)) - (1)) < 0) ? - (~ (0 * (0 * (5) + (size)) + (0)) == -1) - ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) + (0)))) / (5) : ((((0 * (0 * (5) + (size)) - (1)) < 0) ? ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) - (1)))) / (5) < (size)))) || (((0 * ((size) * (5)) - (1)) < 0) && ((size) * (5)) < ((-32767 -1))) || (32767) < ((size) * (5))) ? (*(&o_size) = (((unsigned short int) (size) * (unsigned short int) (5)) <= (32767) ? (short int) ((unsigned short int) (size) * (unsigned short int) (5)) : ((short int) (((unsigned short int) (size) * (unsigned short int) (5)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&o_size) = (((unsigned short int) (size) * (unsigned short int) (5)) <= (32767) ? (short int) ((unsigned short int) (size) * (unsigned short int) (5)) : ((short int) (((unsigned short int) (size) * (unsigned short int) (5)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&o_size) == sizeof (int) ? (sizeof ((size) * (5)) < sizeof (int) ? ((((((((0 * (0 * ((int) (5)) + ((int) (size))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (5)) + ((int) (size))) + (0)) == -1) - ((((0 * (0 * ((int) (5)) + ((int) (size))) + (1)) << (sizeof ((0 * ((int) (5)) + ((int) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (5)) + ((int) (size))) + (0)))) == 0 && ((((int) (size)) < 0 && 0 < ((int) (5))) || (((int) (5)) < 0 && 0 < ((int) (size))))) || (((int) (5)) < 0 ? (((int) (size)) < 0 ? ((int) (size)) < ((((0 * (0 * ((int) (5)) + ((int) (size))) - (1)) < 0) ? ((((0 * (0 * ((int) (5)) + ((int) (size))) + (1)) << (sizeof ((0 * ((int) (5)) + ((int) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (5)) + ((int) (size))) - (1)))) / ((int) (5)) : ((int) (5)) == -1 ? 0 : ((((0 * (0 * ((int) (5)) + ((int) (size))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (5)) + ((int) (size))) + (0)) == -1) - ((((0 * (0 * ((int) (5)) + ((int) (size))) + (1)) << (sizeof ((0 * ((int) (5)) + ((int) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (5)) + ((int) (size))) + (0)))) / ((int) (5)) < ((int) (size))) : ((int) (5)) == 0 ? 0 : (((int) (size)) < 0 ? ((int) (size)) < ((((0 * (0 * ((int) (5)) + ((int) (size))) - (1)) < 0) ? - (~ (0 * (0 * ((int)
((((0 * (0 * ((long long int) (5)) + ((long long int) (size))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (5)) + ((long long int) (size))) + (1)) << (sizeof ((0 * ((long long int) (5)) + ((long long int) (size))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (5)) + ((long long int) (size))) - (1)))) / ((long long int) (5)) < ((long long int) (size))))) || (((0 * (((long long int) (size)) * ((long long int) (5))) - (1)) < 0) && (((long long int) (size)) * ((long long int) (5))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (size)) * ((long long int) (5)))) ? (*(&o_size) = (((unsigned long long int) ((long long int) (size)) * (unsigned long long int) ((long long int) (5))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (size)) * (unsigned long long int) ((long long int) (5))) : ((long long int) (((unsigned long long int) ((long long int) (size)) * (unsigned long long int) ((long long int) (5))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&o_size) = (((unsigned long long int) ((long long int) (size)) * (unsigned long long int) ((long long int) (5))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (size)) * (unsigned long long int) ((long long int) (5))) : ((long long int) (((unsigned long long int) ((long long int) (size)) * (unsigned long long int) ((long long int) (5))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : ((((((((0 * (0 * (5) + (size)) - (1)) < 0) ? - (~ (0 * (0 * (5) + (size)) + (0)) == -1) - ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) + (0)))) == 0 && (((size) < 0 && 0 < (5)) || ((5) < 0 && 0 < (size)))) || ((5) < 0 ? ((size) < 0 ? (size) < ((((0 * (0 * (5) + (size)) - (1)) < 0) ? ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) - (1)))) / (5) : (5) == -1 ? 0 : ((((0 * (0 * (5) + (size)) - (1)) < 0) ? - (~ (0 * (0 * (5) + (size)) + (0)) == -1) - ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) + (0)))) / (5) < (size)) : (5) == 0 ? 0 : ((size) < 0 ? (size) < ((((0 * (0 * (5) + (size)) - (1)) < 0) ? - (~ (0 * (0 * (5) + (size)) + (0)) == -1) - ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) + (0)))) / (5) : ((((0 * (0 * (5) + (size)) - (1)) < 0) ? ((((0 * (0 * (5) + (size)) + (1)) << (sizeof ((0 * (5) + (size)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (5) + (size)) - (1)))) / (5) < (size)))) || (((0 * ((size) * (5)) - (1)) < 0) && ((size) * (5)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((size) * (5))) ? (*(&o_size) = (((unsigned long long int) (size) * (unsigned long long int) (5)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (size) * (unsigned long long int) (5)) : ((long long int) (((unsigned long long int) (size) * (unsigned long long int) (5)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&o_size) = (((unsigned long long int) (size) * (unsigned long long int) (5)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (size) * (unsigned long long int) (5)) : ((long long int) (((unsigned long long int) (size) * (unsigned long long int) (5)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0))))))
 o_size = (9223372036854775807L);
      unsigned char *dst = ((o_size) <= sa_avail ? (sa_avail -= (o_size), __builtin_alloca (o_size)) : (sa_must_free = 1, record_xmalloc (o_size)));
      unsigned char *o = dst;
      ...
      for (i = i_byte = 0; i < size; i++, i_byte += len)
 {
   if (o_size - 5 < o - dst)
     string_overflow ();
   c = (!((SDATA (obj) + i_byte)[0] & 0x80) ? ((len) = 1, (SDATA (obj) + i_byte)[0]) : ! ((SDATA (obj) + i_byte)[0] & 0x20) ? ((len) = 2, (((((SDATA (obj) + i_byte)[0] & 0x1F) << 6) | ((SDATA (obj) + i_byte)[1] & 0x3F)) + (((unsigned char) (SDATA (obj) + i_byte)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((SDATA (obj) + i_byte)[0] & 0x10) ? ((len) = 3, ((((SDATA (obj) + i_byte)[0] & 0x0F) << 12) | (((SDATA (obj) + i_byte)[1] & 0x3F) << 6) | ((SDATA (obj) + i_byte)[2] & 0x3F))) : string_char ((SDATA (obj) + i_byte), ((void*)0), &len));
   if (inword && flag != CASE_CAPITALIZE_UP)
     c = downcase (c);
   else if (!uppercasep (c)
     && (!inword || flag != CASE_CAPITALIZE_UP))
   ...
   if ((int) flag >= (int) CASE_CAPITALIZE)
     inword = (SYNTAX (c) == Sword);
   o += ((((sizeof ((c) + 0)) > (sizeof ((0x7F) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x7F) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0x7F) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0x7F) + (uintmax_t) 0)) ? ((o)[0] = (c), 1) : (((sizeof ((c) + 0)) > (sizeof ((0x7FF) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x7FF) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0x7FF) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0x7FF) + (uintmax_t) 0)) ? ((o)[0] = (0xC0 | ((c) >> 6)), (o)[1] = (0x80 | ((c) & 0x3F)), 2) : (((sizeof ((c) + 0)) > (sizeof ((0xFFFF) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0xFFFF) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) <= ((0xFFFF) + (unsigned) 0) : ((c) + (uintmax_t) 0) <= ((0xFFFF) + (uintmax_t) 0)) ? ((o)[0] = (0xE0 | ((c) >> 12)), (o)[1] = (0x80 | (((c) >> 6) & 0x3F)), (o)[2] = (0x80 | ((c) & 0x3F)), 3) : ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (c) <= sizeof (unsigned)) ? 1 : -1; })) ? (char_string (c, o)) : (char_string (c, o))));
 }
      ((void) (0 && (o - dst <= o_size)));
...
static struct Lisp_Subr _Alignas (8) Supcase = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fupcase }, 1, 1, "upcase", 0, 0}; Lisp_Object Fupcase
...
static struct Lisp_Subr _Alignas (8) Sdowncase = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fdowncase }, 1, 1, "downcase", 0, 0}; Lisp_Object Fdowncase
...
static struct Lisp_Subr _Alignas (8) Scapitalize = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fcapitalize }, 1, 1, "capitalize", 0, 0}; Lisp_Object Fcapitalize
...
static struct Lisp_Subr _Alignas (8) Supcase_initials = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fupcase_initials }, 1, 1, "upcase-initials", 0, 0}; Lisp_Object Fupcase_initials
...
casify_region (enum case_action flag, Lisp_Object b, Lisp_Object e)
{
      ...
      if (multibyte)
 {
   ...
   len = ( (c) <= 0x7F ? 1 : (c) <= 0x7FF ? 2 : (c) <= 0xFFFF ? 3 : (c) <= 0x1FFFFF ? 4 : (c) <= 0x3FFF7F ? 5 : 2);
 }
      else
 {
   c = *(((((start_byte)) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((start_byte)) + (current_buffer->text->beg) - ((1))));
   (((void) (0 && ((c) >= 0 && (c) < 256))), (c) = ((((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (c) : ((c) + 0x3FFF00)));
   len = 1;
 }
      c2 = c;
      ...
      if (c != c2)
 {
   ...
   if (! multibyte)
     {
       do { if (! (((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0))) c = (((c) > 0x3FFF7F) ? (c) - 0x3FFF00 : (c & 0xFF)); } while (0);
       *(((((start_byte)) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((start_byte)) + (current_buffer->text->beg) - ((1)))) = c;
     }
   else if ((((sizeof ((c2) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c2) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c2) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c2) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) && (((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)))
     *(((((start_byte)) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((start_byte)) + (current_buffer->text->beg) - ((1)))) = c;
   else
     {
       int tolen = ( (c) <= 0x7F ? 1 : (c) <= 0x7FF ? 2 : (c) <= 0xFFFF ? 3 : (c) <= 0x1FFFFF ? 4 : (c) <= 0x3FFF7F ? 5 : 2);
       int j;
       unsigned char str[5];
       ...
       if (len == tolen)
  {
    ...
    for (j = 0; j < len; ++j)
      *(((((start_byte + j)) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((start_byte + j)) + (current_buffer->text->beg) - ((1)))) = str[j];
  }
       else
  {
  ...
  if ((current_buffer->pt + 0) != opoint)
    (temp_set_point_both (current_buffer, (opoint), (opoint_byte)));

  if (first >= 0)
    {
      signal_after_change (first, last + 1 - first, last + 1 - first);
      update_compositions (first, last + 1, ((1 | 2) | 4));
    }
}

static struct Lisp_Subr _Alignas (8) Supcase_region = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fupcase_region }, 2, 2, "upcase-region", "r", 0}; Lisp_Object Fupcase_region
...
static struct Lisp_Subr _Alignas (8) Sdowncase_region = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fdowncase_region }, 2, 3, "downcase-region", "(list (region-beginning) (region-end) (region-noncontiguous-p))", 0}; Lisp_Object Fdowncase_region
...
{
  Lisp_Object bounds = builtin_lisp_symbol (0);

  if (!((region_noncontiguous_p) == (builtin_lisp_symbol (0))))
    {
      bounds = call1 (Fsymbol_value (intern ("region-extract-function")),
        intern ("bounds"));

      while ((((enum Lisp_Type) ((bounds) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 {
   casify_region (CASE_DOWN, (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((bounds) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bounds) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((bounds) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bounds) - (Lisp_Cons))))->car) - (Lisp_Cons))))->car, (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((bounds) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bounds) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((bounds) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bounds) - (Lisp_Cons))))->car) - (Lisp_Cons))))->u.cdr);
   bounds = (((void) (0 && ((((enum Lisp_Type) ((bounds) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bounds) - (Lisp_Cons))))->u.cdr;
 }
    }
  else
...
static struct Lisp_Subr _Alignas (8) Scapitalize_region = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fcapitalize_region }, 2, 2, "capitalize-region", "r", 0}; Lisp_Object Fcapitalize_region
...
static struct Lisp_Subr _Alignas (8) Supcase_initials_region = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fupcase_initials_region }, 2, 2, "upcase-initials-region", "r", 0}; Lisp_Object Fupcase_initials_region
...
operate_on_word (Lisp_Object arg, ptrdiff_t *newpoint)
{
  ...
  iarg = ((arg) >> INTTYPEBITS);
  farend = scan_words ((current_buffer->pt + 0), iarg);
  if (!farend)
    farend = iarg > 0 ? (current_buffer->zv) : (current_buffer->begv);

  *newpoint = (current_buffer->pt + 0) > farend ? (current_buffer->pt + 0) : farend;
  ((val) = make_natnum (farend));

  return val;
}

static struct Lisp_Subr _Alignas (8) Supcase_word = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fupcase_word }, 1, 1, "upcase-word", "p", 0}; Lisp_Object Fupcase_word
  ...
  (Lisp_Object arg)
{
  Lisp_Object beg, end;
  ptrdiff_t newpoint;
  ((beg) = make_natnum ((current_buffer->pt + 0)));
...
static struct Lisp_Subr _Alignas (8) Sdowncase_word = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fdowncase_word }, 1, 1, "downcase-word", "p", 0}; Lisp_Object Fdowncase_word
...
static struct Lisp_Subr _Alignas (8) Scapitalize_word = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fcapitalize_word }, 1, 1, "capitalize-word", "p", 0}; Lisp_Object Fcapitalize_word
# 428 "casefiddle.c"
  (Lisp_Object arg)
{
  Lisp_Object beg, end;
...
{
  initial_define_key (control_x_map, (('U')&037), "upcase-region");
  Fput (intern ("upcase-region"), builtin_lisp_symbol (343), builtin_lisp_symbol (901));
  initial_define_key (control_x_map, (('L')&037), "downcase-region");
  Fput (intern ("downcase-region"), builtin_lisp_symbol (343), builtin_lisp_symbol (901));
