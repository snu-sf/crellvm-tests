...
{
  (((((enum Lisp_Type) ((x) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (434), x));
}
...
extract_float (Lisp_Object num)
{
  ...
  if ((((enum Lisp_Type) ((num) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float))
    return XFLOAT_DATA (num);
  return (double) ((num) >> INTTYPEBITS);
}



static struct Lisp_Subr _Alignas (8) Sacos = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Facos }, 1, 1, "acos", 0, 0}; Lisp_Object Facos
...
static struct Lisp_Subr _Alignas (8) Sasin = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fasin }, 1, 1, "asin", 0, 0}; Lisp_Object Fasin
...
static struct Lisp_Subr _Alignas (8) Satan = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fatan }, 1, 2, "atan", 0, 0}; Lisp_Object Fatan
...
static struct Lisp_Subr _Alignas (8) Scos = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fcos }, 1, 1, "cos", 0, 0}; Lisp_Object Fcos
...
static struct Lisp_Subr _Alignas (8) Ssin = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fsin }, 1, 1, "sin", 0, 0}; Lisp_Object Fsin
...
static struct Lisp_Subr _Alignas (8) Stan = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Ftan }, 1, 1, "tan", 0, 0}; Lisp_Object Ftan
...
static struct Lisp_Subr _Alignas (8) Sisnan = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fisnan }, 1, 1, "isnan", 0, 0}; Lisp_Object Fisnan

  (Lisp_Object x)
{
  CHECK_FLOAT (x);
  return ((XFLOAT_DATA (x)) != (XFLOAT_DATA (x))) ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0);
}


static struct Lisp_Subr _Alignas (8) Scopysign = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fcopysign }, 2, 2, "copysign", 0, 0}; Lisp_Object Fcopysign
...
static struct Lisp_Subr _Alignas (8) Sfrexp = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Ffrexp }, 1, 1, "frexp", 0, 0}; Lisp_Object Ffrexp
# 179 "floatfns.c"
  (Lisp_Object x)
{
  ...
  return Fcons (make_float (sgnfcand), ((EMACS_INT) (((EMACS_UINT) (exponent) << INTTYPEBITS) + Lisp_Int0)));
}

static struct Lisp_Subr _Alignas (8) Sldexp = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fldexp }, 2, 2, "ldexp", 0, 0}; Lisp_Object Fldexp


  (Lisp_Object sgnfcand, Lisp_Object exponent)
{
  ((((((enum Lisp_Type) ((exponent) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), exponent));
  int e = (((((-2147483647 -1)) > (((exponent) >> INTTYPEBITS)) ? ((-2147483647 -1)) : (((exponent) >> INTTYPEBITS)))) < (2147483647) ? ((((-2147483647 -1)) > (((exponent) >> INTTYPEBITS)) ? ((-2147483647 -1)) : (((exponent) >> INTTYPEBITS)))) : (2147483647));
  return make_float (ldexp (XFLOATINT (sgnfcand), e));
}

static struct Lisp_Subr _Alignas (8) Sexp = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fexp }, 1, 1, "exp", 0, 0}; Lisp_Object Fexp
...
static struct Lisp_Subr _Alignas (8) Sexpt = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fexpt }, 2, 2, "expt", 0, 0}; Lisp_Object Fexpt
  ...
  (Lisp_Object arg1, Lisp_Object arg2)
{
  ...
  if (((((enum Lisp_Type) ((arg1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
      && ((((enum Lisp_Type) ((arg2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
      && ((arg2) >> INTTYPEBITS) >= 0)
    {
      EMACS_INT y;
      EMACS_UINT acc, x;
      ...
      while ((y >>= 1) != 0)
 {
   ...
   if (y & 1)
     acc *= x;
      ...
      ((val) = ((EMACS_INT) (((EMACS_UINT) (acc) << INTTYPEBITS) + Lisp_Int0)));
      return val;
    }
  f1 = (((enum Lisp_Type) ((arg1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float) ? XFLOAT_DATA (arg1) : ((arg1) >> INTTYPEBITS);
  f2 = (((enum Lisp_Type) ((arg2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float) ? XFLOAT_DATA (arg2) : ((arg2) >> INTTYPEBITS);
  f3 = pow (f1, f2);
  return make_float (f3);
}

static struct Lisp_Subr _Alignas (8) Slog = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Flog }, 1, 2, "log", 0, 0}; Lisp_Object Flog
...
static struct Lisp_Subr _Alignas (8) Ssqrt = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fsqrt }, 1, 1, "sqrt", 0, 0}; Lisp_Object Fsqrt
...
static struct Lisp_Subr _Alignas (8) Sabs = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fabs }, 1, 1, "abs", 0, 0}; Lisp_Object Fabs

  (register Lisp_Object arg)
{
  CHECK_NUMBER_OR_FLOAT (arg);

  if ((((enum Lisp_Type) ((arg) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float))
    arg = make_float (fabs (XFLOAT_DATA (arg)));
  else if (((arg) >> INTTYPEBITS) < 0)
    ((arg) = ((EMACS_INT) (((EMACS_UINT) (- ((arg) >> INTTYPEBITS)) << INTTYPEBITS) + Lisp_Int0)));

  return arg;
}

static struct Lisp_Subr _Alignas (8) Sfloat = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Ffloat }, 1, 1, "float", 0, 0}; Lisp_Object Ffloat

  (register Lisp_Object arg)
{
  CHECK_NUMBER_OR_FLOAT (arg);

  if (((((enum Lisp_Type) ((arg) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    return make_float ((double) ((arg) >> INTTYPEBITS));
  else
    return arg;
}

static struct Lisp_Subr _Alignas (8) Slogb = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Flogb }, 1, 1, "logb", 0, 0}; Lisp_Object Flogb
  ...
  (Lisp_Object arg)
{
  ...
  if (f == 0.0)
    value = (-1 - (9223372036854775807L >> INTTYPEBITS));
  else if (((f) - (f) == 0))
    {
      int ivalue;
      frexp (f, &ivalue);
    ...
    value = (9223372036854775807L >> INTTYPEBITS);

  ((val) = ((EMACS_INT) (((EMACS_UINT) (value) << INTTYPEBITS) + Lisp_Int0)));
  return val;
}
   ...
   const char *name)
{
  ...
  if (! ((divisor) == (builtin_lisp_symbol (0))))
    {
      EMACS_INT i1, i2;

      CHECK_NUMBER_OR_FLOAT (divisor);

      if ((((enum Lisp_Type) ((arg) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float) || (((enum Lisp_Type) ((divisor) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float))
 {
   double f1, f2;

   f1 = (((enum Lisp_Type) ((arg) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float) ? XFLOAT_DATA (arg) : ((arg) >> INTTYPEBITS);
   f2 = ((((enum Lisp_Type) ((divisor) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float) ? XFLOAT_DATA (divisor) : ((divisor) >> INTTYPEBITS));
   if (! IEEE_FLOATING_POINT && f2 == 0)
     xsignal0 (builtin_lisp_symbol (178));

   f1 = (*double_round) (f1 / f2);
   if ((! ((0 <= (f1) || (-1 - (9223372036854775807L >> INTTYPEBITS)) <= (f1)) && (f1) <= (9223372036854775807L >> INTTYPEBITS))))
     xsignal3 (builtin_lisp_symbol (786), build_string (name), arg, divisor);
   arg = ((EMACS_INT) (((EMACS_UINT) (f1) << INTTYPEBITS) + Lisp_Int0));
   return arg;
 }

      i1 = ((arg) >> INTTYPEBITS);
      i2 = ((divisor) >> INTTYPEBITS);

      if (i2 == 0)
 xsignal0 (builtin_lisp_symbol (178));

      ((arg) = ((EMACS_INT) (((EMACS_UINT) ((*int_round2) (i1, i2)) << INTTYPEBITS) + Lisp_Int0)));
      return arg;
    }
  ...
  if ((((enum Lisp_Type) ((arg) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float))
    {
      ...
      if ((! ((0 <= (d) || (-1 - (9223372036854775807L >> INTTYPEBITS)) <= (d)) && (d) <= (9223372036854775807L >> INTTYPEBITS))))
 xsignal2 (builtin_lisp_symbol (786), build_string (name), arg);
      arg = ((EMACS_INT) (((EMACS_UINT) (d) << INTTYPEBITS) + Lisp_Int0));
    }
...
static struct Lisp_Subr _Alignas (8) Sceiling = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fceiling }, 1, 2, "ceiling", 0, 0}; Lisp_Object Fceiling
...
static struct Lisp_Subr _Alignas (8) Sfloor = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Ffloor }, 1, 2, "floor", 0, 0}; Lisp_Object Ffloor
...
static struct Lisp_Subr _Alignas (8) Sround = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fround }, 1, 2, "round", 0, 0}; Lisp_Object Fround
...
static struct Lisp_Subr _Alignas (8) Struncate = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Ftruncate }, 1, 2, "truncate", 0, 0}; Lisp_Object Ftruncate
...
fmod_float (Lisp_Object x, Lisp_Object y)
{
  ...
  f1 = (((enum Lisp_Type) ((x) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float) ? XFLOAT_DATA (x) : ((x) >> INTTYPEBITS);
  f2 = (((enum Lisp_Type) ((y) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float) ? XFLOAT_DATA (y) : ((y) >> INTTYPEBITS);
...
static struct Lisp_Subr _Alignas (8) Sfceiling = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Ffceiling }, 1, 1, "fceiling", 0, 0}; Lisp_Object Ffceiling
...
static struct Lisp_Subr _Alignas (8) Sffloor = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fffloor }, 1, 1, "ffloor", 0, 0}; Lisp_Object Fffloor
...
static struct Lisp_Subr _Alignas (8) Sfround = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Ffround }, 1, 1, "fround", 0, 0}; Lisp_Object Ffround
...
static struct Lisp_Subr _Alignas (8) Sftruncate = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fftruncate }, 1, 1, "ftruncate", 0, 0}; Lisp_Object Fftruncate
