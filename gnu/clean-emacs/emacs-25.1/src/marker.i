...
{
  ((((((enum Lisp_Type) ((x) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE (x) == Lisp_Misc_Marker)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (646), x));
}
...
buf_charpos_to_bytepos (struct buffer *b, ptrdiff_t charpos)
{
  ...
  ((void) (0 && (((1)) <= charpos && charpos <= ((b)->text->z))));

  best_above = ((b)->text->z);
  best_above_byte = ((b)->text->z_byte);
  ...
  best_below_byte = ((1));
# 168 "marker.c"
  { ptrdiff_t this_charpos = ((b == current_buffer ? (current_buffer->pt + 0) : ((((b)-> pt_marker_)) == (builtin_lisp_symbol (0))) ? b->pt : marker_position (((b)-> pt_marker_)))); _Bool changed = 0; if (this_charpos == charpos) { ptrdiff_t value = ((b == current_buffer ? (current_buffer->pt_byte + 0) : ((((b)-> pt_marker_)) == (builtin_lisp_symbol (0))) ? b->pt_byte : marker_byte_position (((b)-> pt_marker_)))); do { } while (0); return value; } else if (this_charpos > charpos) { if (this_charpos < best_above) { best_above = this_charpos; best_above_byte = ((b == current_buffer ? (current_buffer->pt_byte + 0) : ((((b)-> pt_marker_)) == (builtin_lisp_symbol (0))) ? b->pt_byte : marker_byte_position (((b)-> pt_marker_)))); changed = 1; } } else if (this_charpos > best_below) { best_below = this_charpos; best_below_byte = ((b == current_buffer ? (current_buffer->pt_byte + 0) : ((((b)-> pt_marker_)) == (builtin_lisp_symbol (0))) ? b->pt_byte : marker_byte_position (((b)-> pt_marker_)))); changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below_byte + (charpos - best_below); do { } while (0); return value; } } };
  { ptrdiff_t this_charpos = (((b)->text->gpt)); _Bool changed = 0; if (this_charpos == charpos) { ptrdiff_t value = (((b)->text->gpt_byte)); do { } while (0); return value; } else if (this_charpos > charpos) { if (this_charpos < best_above) { best_above = this_charpos; best_above_byte = (((b)->text->gpt_byte)); changed = 1; } } else if (this_charpos > best_below) { best_below = this_charpos; best_below_byte = (((b)->text->gpt_byte)); changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below_byte + (charpos - best_below); do { } while (0); return value; } } };
  { ptrdiff_t this_charpos = ((b == current_buffer ? (current_buffer->begv) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv : marker_position (((b)-> begv_marker_)))); _Bool changed = 0; if (this_charpos == charpos) { ptrdiff_t value = ((b == current_buffer ? (current_buffer->begv_byte) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv_byte : marker_byte_position (((b)-> begv_marker_)))); do { } while (0); return value; } else if (this_charpos > charpos) { if (this_charpos < best_above) { best_above = this_charpos; best_above_byte = ((b == current_buffer ? (current_buffer->begv_byte) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv_byte : marker_byte_position (((b)-> begv_marker_)))); changed = 1; } } else if (this_charpos > best_below) { best_below = this_charpos; best_below_byte = ((b == current_buffer ? (current_buffer->begv_byte) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv_byte : marker_byte_position (((b)-> begv_marker_)))); changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below_byte + (charpos - best_below); do { } while (0); return value; } } };
  { ptrdiff_t this_charpos = ((b == current_buffer ? (current_buffer->zv) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv : marker_position (((b)-> zv_marker_)))); _Bool changed = 0; if (this_charpos == charpos) { ptrdiff_t value = ((b == current_buffer ? (current_buffer->zv_byte) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv_byte : marker_byte_position (((b)-> zv_marker_)))); do { } while (0); return value; } else if (this_charpos > charpos) { if (this_charpos < best_above) { best_above = this_charpos; best_above_byte = ((b == current_buffer ? (current_buffer->zv_byte) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv_byte : marker_byte_position (((b)-> zv_marker_)))); changed = 1; } } else if (this_charpos > best_below) { best_below = this_charpos; best_below_byte = ((b == current_buffer ? (current_buffer->zv_byte) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv_byte : marker_byte_position (((b)-> zv_marker_)))); changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below_byte + (charpos - best_below); do { } while (0); return value; } } };

  if (b == cached_buffer && ((b)->text->modiff) == cached_modiff)
    { ptrdiff_t this_charpos = (cached_charpos); _Bool changed = 0; if (this_charpos == charpos) { ptrdiff_t value = (cached_bytepos); do { } while (0); return value; } else if (this_charpos > charpos) { if (this_charpos < best_above) { best_above = this_charpos; best_above_byte = (cached_bytepos); changed = 1; } } else if (this_charpos > best_below) { best_below = this_charpos; best_below_byte = (cached_bytepos); changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below_byte + (charpos - best_below); do { } while (0); return value; } } };

  for (tail = ((b)->text->markers); tail; tail = tail->next)
    {
      { ptrdiff_t this_charpos = (tail->charpos); _Bool changed = 0; if (this_charpos == charpos) { ptrdiff_t value = (tail->bytepos); do { } while (0); return value; } else if (this_charpos > charpos) { if (this_charpos < best_above) { best_above = this_charpos; best_above_byte = (tail->bytepos); changed = 1; } } else if (this_charpos > best_below) { best_below = this_charpos; best_below_byte = (tail->bytepos); changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below_byte + (charpos - best_below); do { } while (0); return value; } } };
 ...
 break;
  ...
  if (charpos - best_below < best_above - charpos)
    {
      _Bool record = charpos - best_below > 5000;

      while (best_below != charpos)
 {
   best_below++;
   do { unsigned char *chp = ((b)->text->beg + (best_below_byte) - ((1)) + ((best_below_byte) >= (b)->text->gpt_byte ? (b)->text->gap_size : 0)); best_below_byte += (!((*chp) & 0x80) ? 1 : !((*chp) & 0x20) ? 2 : !((*chp) & 0x10) ? 3 : !((*chp) & 0x08) ? 4 : 5); } while (0);
 }
 ...
 build_marker (b, best_below, best_below_byte);
    ...
    {
      _Bool record = best_above - charpos > 5000;

      while (best_above != charpos)
 {
   best_above--;
   do { unsigned char *chp; best_above_byte--; if (best_above_byte < ((b)->text->gpt_byte)) chp = ((b)->text->beg) + best_above_byte - ((1)); else chp = ((b)->text->beg) + ((b)->text->gap_size) + best_above_byte - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; best_above_byte--; } } while (0);
 }
...
buf_bytepos_to_charpos (struct buffer *b, ptrdiff_t bytepos)
{
  ...
  ((void) (0 && ((((1))) <= bytepos && bytepos <= ((b)->text->z_byte))));
  ...
  { ptrdiff_t this_bytepos = ((b == current_buffer ? (current_buffer->pt_byte + 0) : ((((b)-> pt_marker_)) == (builtin_lisp_symbol (0))) ? b->pt_byte : marker_byte_position (((b)-> pt_marker_)))); int changed = 0; if (this_bytepos == bytepos) { ptrdiff_t value = ((b == current_buffer ? (current_buffer->pt + 0) : ((((b)-> pt_marker_)) == (builtin_lisp_symbol (0))) ? b->pt : marker_position (((b)-> pt_marker_)))); do { } while (0); return value; } else if (this_bytepos > bytepos) { if (this_bytepos < best_above_byte) { best_above = ((b == current_buffer ? (current_buffer->pt + 0) : ((((b)-> pt_marker_)) == (builtin_lisp_symbol (0))) ? b->pt : marker_position (((b)-> pt_marker_)))); best_above_byte = this_bytepos; changed = 1; } } else if (this_bytepos > best_below_byte) { best_below = ((b == current_buffer ? (current_buffer->pt + 0) : ((((b)-> pt_marker_)) == (builtin_lisp_symbol (0))) ? b->pt : marker_position (((b)-> pt_marker_)))); best_below_byte = this_bytepos; changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below + (bytepos - best_below_byte); do { } while (0); return value; } } };
  { ptrdiff_t this_bytepos = (((b)->text->gpt_byte)); int changed = 0; if (this_bytepos == bytepos) { ptrdiff_t value = (((b)->text->gpt)); do { } while (0); return value; } else if (this_bytepos > bytepos) { if (this_bytepos < best_above_byte) { best_above = (((b)->text->gpt)); best_above_byte = this_bytepos; changed = 1; } } else if (this_bytepos > best_below_byte) { best_below = (((b)->text->gpt)); best_below_byte = this_bytepos; changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below + (bytepos - best_below_byte); do { } while (0); return value; } } };
  { ptrdiff_t this_bytepos = ((b == current_buffer ? (current_buffer->begv_byte) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv_byte : marker_byte_position (((b)-> begv_marker_)))); int changed = 0; if (this_bytepos == bytepos) { ptrdiff_t value = ((b == current_buffer ? (current_buffer->begv) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv : marker_position (((b)-> begv_marker_)))); do { } while (0); return value; } else if (this_bytepos > bytepos) { if (this_bytepos < best_above_byte) { best_above = ((b == current_buffer ? (current_buffer->begv) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv : marker_position (((b)-> begv_marker_)))); best_above_byte = this_bytepos; changed = 1; } } else if (this_bytepos > best_below_byte) { best_below = ((b == current_buffer ? (current_buffer->begv) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv : marker_position (((b)-> begv_marker_)))); best_below_byte = this_bytepos; changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below + (bytepos - best_below_byte); do { } while (0); return value; } } };
  { ptrdiff_t this_bytepos = ((b == current_buffer ? (current_buffer->zv_byte) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv_byte : marker_byte_position (((b)-> zv_marker_)))); int changed = 0; if (this_bytepos == bytepos) { ptrdiff_t value = ((b == current_buffer ? (current_buffer->zv) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv : marker_position (((b)-> zv_marker_)))); do { } while (0); return value; } else if (this_bytepos > bytepos) { if (this_bytepos < best_above_byte) { best_above = ((b == current_buffer ? (current_buffer->zv) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv : marker_position (((b)-> zv_marker_)))); best_above_byte = this_bytepos; changed = 1; } } else if (this_bytepos > best_below_byte) { best_below = ((b == current_buffer ? (current_buffer->zv) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv : marker_position (((b)-> zv_marker_)))); best_below_byte = this_bytepos; changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below + (bytepos - best_below_byte); do { } while (0); return value; } } };

  if (b == cached_buffer && ((b)->text->modiff) == cached_modiff)
    { ptrdiff_t this_bytepos = (cached_bytepos); int changed = 0; if (this_bytepos == bytepos) { ptrdiff_t value = (cached_charpos); do { } while (0); return value; } else if (this_bytepos > bytepos) { if (this_bytepos < best_above_byte) { best_above = (cached_charpos); best_above_byte = this_bytepos; changed = 1; } } else if (this_bytepos > best_below_byte) { best_below = (cached_charpos); best_below_byte = this_bytepos; changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below + (bytepos - best_below_byte); do { } while (0); return value; } } };

  for (tail = ((b)->text->markers); tail; tail = tail->next)
    {
      { ptrdiff_t this_bytepos = (tail->bytepos); int changed = 0; if (this_bytepos == bytepos) { ptrdiff_t value = (tail->charpos); do { } while (0); return value; } else if (this_bytepos > bytepos) { if (this_bytepos < best_above_byte) { best_above = (tail->charpos); best_above_byte = this_bytepos; changed = 1; } } else if (this_bytepos > best_below_byte) { best_below = (tail->charpos); best_below_byte = this_bytepos; changed = 1; } if (changed) { if (best_above - best_below == best_above_byte - best_below_byte) { ptrdiff_t value = best_below + (bytepos - best_below_byte); do { } while (0); return value; } } };
 ...
 break;
  ...
  if (bytepos - best_below_byte < best_above_byte - bytepos)
    {
      _Bool record = bytepos - best_below_byte > 5000;
 ...
 build_marker (b, best_below, best_below_byte);
    ...
    {
      _Bool record = best_above_byte - bytepos > 5000;
...
static struct Lisp_Subr _Alignas (8) Smarker_buffer = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fmarker_buffer }, 1, 1, "marker-buffer", 0, 0}; Lisp_Object Fmarker_buffer
  ...
  (register Lisp_Object marker)
{
  ...
  if (XMARKER (marker)->buffer)
    {
      ((((buf) = make_lisp_ptr (XMARKER (marker)->buffer, Lisp_Vectorlike)), ((void) (0 && (((((struct vectorlike_header *) ((void *) (intptr_t) ((buf) - (Lisp_Vectorlike)))) ->size) & (((9223372036854775807L) - (9223372036854775807L) / 2) | PVEC_TYPE_MASK)) == (((9223372036854775807L) - (9223372036854775807L) / 2) | (PVEC_BUFFER << PSEUDOVECTOR_AREA_BITS)))))));




      ((void) (0 && ((!((((XBUFFER (buf))-> name_)) == (builtin_lisp_symbol (0)))))));
      return buf;
    }
  return builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Smarker_position = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fmarker_position }, 1, 1, "marker-position", 0, 0}; Lisp_Object Fmarker_position

  (Lisp_Object marker)
{
  CHECK_MARKER (marker);
  if (XMARKER (marker)->buffer)
    return ((EMACS_INT) (((EMACS_UINT) (XMARKER (marker)->charpos) << INTTYPEBITS) + Lisp_Int0));
...
live_buffer (Lisp_Object buffer)
{
  ...
  return (!((((b)-> name_)) == (builtin_lisp_symbol (0)))) ? b : ((void*)0);
}
...
set_marker_internal (Lisp_Object marker, Lisp_Object position,
       Lisp_Object buffer, _Bool restricted)
{
  ...
  if (((position) == (builtin_lisp_symbol (0)))
      || (((((enum Lisp_Type) ((position) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE (position) == Lisp_Misc_Marker) && !XMARKER (position)->buffer)
      || !b)
    unchain_marker (m);



  else if (((((enum Lisp_Type) ((position) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE (position) == Lisp_Misc_Marker) && b == XMARKER (position)->buffer
    && b == m->buffer)
    {
  ...
  else
    {
      ...
      if (((((enum Lisp_Type) ((position) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
 charpos = ((position) >> INTTYPEBITS), bytepos = -1;
      else if (((((enum Lisp_Type) ((position) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE (position) == Lisp_Misc_Marker))
 {
 ...
 (restricted ? (b == current_buffer ? (current_buffer->begv) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv : marker_position (((b)-> begv_marker_))) : ((1)), charpos,
  restricted ? (b == current_buffer ? (current_buffer->zv) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv : marker_position (((b)-> zv_marker_))) : ((b)->text->z));
      if (bytepos == -1)
 bytepos = buf_charpos_to_bytepos (b, charpos);
      else
 bytepos = clip_to_bounds
   (restricted ? (b == current_buffer ? (current_buffer->begv_byte) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv_byte : marker_byte_position (((b)-> begv_marker_))) : (((1))),
    bytepos, restricted ? (b == current_buffer ? (current_buffer->zv_byte) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv_byte : marker_byte_position (((b)-> zv_marker_))) : ((b)->text->z_byte));
...
static struct Lisp_Subr _Alignas (8) Sset_marker = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fset_marker }, 2, 3, "set-marker", 0, 0}; Lisp_Object Fset_marker
  ...
  if (b)
    {
      attach_marker
 (m, b,
  clip_to_bounds ((b == current_buffer ? (current_buffer->begv) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv : marker_position (((b)-> begv_marker_))), charpos, (b == current_buffer ? (current_buffer->zv) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv : marker_position (((b)-> zv_marker_)))),
  clip_to_bounds ((b == current_buffer ? (current_buffer->begv_byte) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv_byte : marker_byte_position (((b)-> begv_marker_))), bytepos, (b == current_buffer ? (current_buffer->zv_byte) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv_byte : marker_byte_position (((b)-> zv_marker_)))));
    }
  else
    unchain_marker (m);
  return marker;
  ...
  if (b)
    {
      ...
      ((void) (0 && ((!((((b)-> name_)) == (builtin_lisp_symbol (0)))))));

      marker->buffer = ((void*)0);
      prev = &((b)->text->markers);

      for (tail = ((b)->text->markers); tail; prev = &tail->next, tail = *prev)
 if (marker == tail)
   {
     if (*prev == ((b)->text->markers))
       {
...
marker_position (Lisp_Object marker)
{
  ...
  ((void) (0 && (((1)) <= m->charpos && m->charpos <= ((buf)->text->z))));
...
marker_byte_position (Lisp_Object marker)
{
  ...
  ((void) (0 && ((((1))) <= m->bytepos && m->bytepos <= ((buf)->text->z_byte))));

  return m->bytepos;
}

static struct Lisp_Subr _Alignas (8) Scopy_marker = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fcopy_marker }, 0, 2, "copy-marker", 0, 0}; Lisp_Object Fcopy_marker
  ...
  (register Lisp_Object marker, Lisp_Object type)
{
  ...
  ((((((enum Lisp_Type) ((marker) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) || ((((enum Lisp_Type) ((marker) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE (marker) == Lisp_Misc_Marker)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (558), marker));

  new = Fmake_marker ();
  Fset_marker (new, marker,
        (((((enum Lisp_Type) ((marker) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE (marker) == Lisp_Misc_Marker) ? Fmarker_buffer (marker) : builtin_lisp_symbol (0)));
  XMARKER (new)->insertion_type = !((type) == (builtin_lisp_symbol (0)));
  return new;
}

static struct Lisp_Subr _Alignas (8) Smarker_insertion_type = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fmarker_insertion_type }, 1, 1, "marker-insertion-type", 0, 0}; Lisp_Object Fmarker_insertion_type
...
{
  CHECK_MARKER (marker);
  return XMARKER (marker)->insertion_type ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Sset_marker_insertion_type = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fset_marker_insertion_type }, 2, 2, "set-marker-insertion-type", 0, 0}; Lisp_Object Fset_marker_insertion_type
  ...
  (Lisp_Object marker, Lisp_Object type)
{
  ...
  XMARKER (marker)->insertion_type = ! ((type) == (builtin_lisp_symbol (0)));
  return type;
}

static struct Lisp_Subr _Alignas (8) Sbuffer_has_markers_at = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fbuffer_has_markers_at }, 1, 1, "buffer-has-markers-at", 0, 0}; Lisp_Object Fbuffer_has_markers_at
  ...
  (Lisp_Object position)
{
  ...
  charpos = clip_to_bounds ((1), ((position) >> INTTYPEBITS), (current_buffer->text->z));
