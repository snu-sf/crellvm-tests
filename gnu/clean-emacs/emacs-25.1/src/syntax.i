...
{
  return SYNTAX_FLAGS_COMEND_FIRST (syntax_property_with_flags (c, 1));
}
...
struct lisp_parse_state
  {
    ...
    ptrdiff_t location;
    ptrdiff_t location_byte;
    ptrdiff_t comstr_start;
...
static Lisp_Object skip_chars (_Bool, Lisp_Object, Lisp_Object, _Bool);
static Lisp_Object skip_syntaxes (_Bool, Lisp_Object, Lisp_Object);
static Lisp_Object scan_lists (EMACS_INT, EMACS_INT, EMACS_INT, _Bool);
static void scan_sexps_forward (struct lisp_parse_state *,
                                ptrdiff_t, ptrdiff_t, ptrdiff_t, EMACS_INT,
                                _Bool, Lisp_Object, int);
static _Bool in_classes (int, Lisp_Object);
...
{
  return SYNTAX_FLAGS_PREFIX (syntax_property_with_flags (c, 1));
}

struct gl_state_s gl_state;

enum { INTERVALS_AT_ONCE = 10 };
...
SYNTAX_MATCH (int c)
{
  Lisp_Object ent = syntax_property_entry (c, 1);
  return (((enum Lisp_Type) ((ent) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? (((void) (0 && ((((enum Lisp_Type) ((ent) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((ent) - (Lisp_Cons))))->u.cdr : builtin_lisp_symbol (0);
}
# 238 "syntax.c"
static void
SETUP_SYNTAX_TABLE (ptrdiff_t from, ptrdiff_t count)
{
  ...
  gl_state.b_property = (current_buffer->begv);
  gl_state.e_property = (current_buffer->zv) + 1;
  gl_state.object = builtin_lisp_symbol (0);
  gl_state.offset = 0;
  if (globals.f_parse_sexp_lookup_properties)
    {
      if (count > 0)
 update_syntax_table_forward (from, 1, builtin_lisp_symbol (0));
      else if (from > (current_buffer->begv))
 {
   update_syntax_table (from - 1, count, 1, builtin_lisp_symbol (0));
  ...
  if (BUFFERP (gl_state.object))
    {
      ...
      gl_state.e_property = (buf == current_buffer ? (current_buffer->zv) : ((((buf)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? buf->zv : marker_position (((buf)-> zv_marker_))) - (buf == current_buffer ? (current_buffer->begv) : ((((buf)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? buf->begv : marker_position (((buf)-> begv_marker_))) + 1;
      gl_state.offset = (buf == current_buffer ? (current_buffer->begv) : ((((buf)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? buf->begv : marker_position (((buf)-> begv_marker_))) - 1;
    }
  else if (((gl_state.object) == (builtin_lisp_symbol (0))))
    {
      gl_state.b_property = 1;
      gl_state.e_property = (current_buffer->zv) - (current_buffer->begv) + 1;
      gl_state.offset = (current_buffer->begv) - 1;
    }
  else if (((gl_state.object) == (builtin_lisp_symbol (901))))
    {
      gl_state.b_property = 0;
      gl_state.e_property = (9223372036854775807L);
      gl_state.offset = 0;
    }
  else
    {
...
# 315 "syntax.c"
void
update_syntax_table (ptrdiff_t charpos, EMACS_INT count, _Bool init,
       Lisp_Object object)
{
  ...
  if (init)
    {
      gl_state.old_prop = builtin_lisp_symbol (0);
 ...
 return;
      ...
      while (!((i)->up_obj || (i)->up.interval == 0))
 {
   if ((! ((i)->up_obj || (i)->up.interval == 0) && (((void) (0 && ((i) != 0 && ! (i)->up_obj))), (i)->up.interval)->right == (i)))
     (((void) (0 && ((i) != 0 && ! (i)->up_obj))), (i)->up.interval)->position = i->position
       - ((i)->left ? (i)->left->total_length : 0) + ((i) == ((void*)0) ? 0 : (i)->total_length)
       - (((((void) (0 && ((i) != 0 && ! (i)->up_obj))), (i)->up.interval)) == ((void*)0) ? 0 : ((((void) (0 && ((i) != 0 && ! (i)->up_obj))), (i)->up.interval))->total_length)
       + (((((void) (0 && ((i) != 0 && ! (i)->up_obj))), (i)->up.interval))->left ? ((((void) (0 && ((i) != 0 && ! (i)->up_obj))), (i)->up.interval))->left->total_length : 0);
   else
     (((void) (0 && ((i) != 0 && ! (i)->up_obj))), (i)->up.interval)->position = i->position - ((i)->left ? (i)->left->total_length : 0)
       + ((i) == ((void*)0) ? 0 : (i)->total_length);
   i = (((void) (0 && ((i) != 0 && ! (i)->up_obj))), (i)->up.interval);
 }
      i = gl_state.forward_i;
      gl_state.b_property = i->position - gl_state.offset;
      gl_state.e_property = ((i)->position + (((i)) == ((void*)0) ? 0 : (((((i))) == ((void*)0) ? 0 : (((i)))->total_length) - ((((i))->right) == ((void*)0) ? 0 : (((i))->right)->total_length) - ((((i))->left) == ((void*)0) ? 0 : (((i))->left)->total_length)))) - gl_state.offset;
      goto update;
    }
 ...
 error ("Error in syntax_table logic for intervals <-");
      ...
      if (((i)->position + (((i)) == ((void*)0) ? 0 : (((((i))) == ((void*)0) ? 0 : (((i)))->total_length) - ((((i))->right) == ((void*)0) ? 0 : (((i))->right)->total_length) - ((((i))->left) == ((void*)0) ? 0 : (((i))->left)->total_length)))) != gl_state.b_property)
 {
   invalidate = 0;
  ...
  else if (charpos >= ((i)->position + (((i)) == ((void*)0) ? 0 : (((((i))) == ((void*)0) ? 0 : (((i)))->total_length) - ((((i))->right) == ((void*)0) ? 0 : (((i))->right)->total_length) - ((((i))->left) == ((void*)0) ? 0 : (((i))->left)->total_length)))))
    {
      if (count < 0)
 error ("Error in syntax_table logic for intervals ->");
      ...
      if (i->position != gl_state.e_property)
 {
  ...
  update:
  tmp_table = textget (i->plist, builtin_lisp_symbol (899));

  if (invalidate)
    invalidate = !((tmp_table) == (gl_state.old_prop));
      ...
      else
 {
  ...
  if (!((tmp_table) == (gl_state.old_prop)))
    {
      gl_state.current_syntax_table = tmp_table;
      gl_state.old_prop = tmp_table;
      if (((Fsyntax_table_p (tmp_table)) == (builtin_lisp_symbol (901))))
 {
   gl_state.use_global = 0;
 }
      else if ((((enum Lisp_Type) ((tmp_table) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 {
      ...
      else
 {
  ...
  while (i)
    {
      if (cnt && !((tmp_table) == (textget (i->plist, builtin_lisp_symbol (899)))))
 {
   if (count > 0)
     {
     ...
     {
       gl_state.b_property
  = i->position + ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))) - gl_state.offset;
       gl_state.backward_i = i;
     }
   return;
 }
...
{
  EMACS_INT zv = (current_buffer->zv);
  if (globals.f_syntax_propertize__done <= charpos
      && globals.f_syntax_propertize__done < zv)
    {
      EMACS_INT modiffs = (current_buffer->text->chars_modiff);
      safe_call1 (builtin_lisp_symbol (562),
    ((EMACS_INT) (((EMACS_UINT) (((zv) < (1 + charpos) ? (zv) : (1 + charpos))) << INTTYPEBITS) + Lisp_Int0)));
      if (modiffs != (current_buffer->text->chars_modiff))
 ...
 error ("parse-sexp-propertize-function did not move"
  ...
  else if (gl_state.e_property > globals.f_syntax_propertize__done)
    {
      gl_state.e_property = globals.f_syntax_propertize__done;
      gl_state.e_property_truncated = 1;
    }
    ...
    && gl_state.e_property < globals.f_syntax_propertize__done)
    {
      ...
      gl_state.e_property_truncated = 0;
      update_syntax_table_forward (charpos, 0, builtin_lisp_symbol (0));
    }
}

void
update_syntax_table_forward (ptrdiff_t charpos, _Bool init,
        Lisp_Object object)
{
  if (gl_state.e_property_truncated)
    {
      ((void) (0 && (((object) == (builtin_lisp_symbol (0))))));
      ((void) (0 && (charpos >= gl_state.e_property)));
      parse_sexp_propertize (charpos);
    }
  else
    {
      update_syntax_table (charpos, 1, init, object);
      if (((object) == (builtin_lisp_symbol (0))) && gl_state.e_property > globals.f_syntax_propertize__done)
 parse_sexp_propertize (charpos);
    }
}
...
char_quoted (ptrdiff_t charpos, ptrdiff_t bytepos)
{
  ...
  ptrdiff_t beg = (current_buffer->begv);
  _Bool quoted = 0;
  ...
  while (charpos > beg)
    {
      int c;
      do { (charpos)--; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (bytepos)--; else do { unsigned char *chp; (bytepos)--; if ((bytepos) < (current_buffer->text->gpt_byte)) chp = (current_buffer->text->beg) + (bytepos) - ((1)); else chp = (current_buffer->text->beg) + (current_buffer->text->gap_size) + (bytepos) - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; (bytepos)--; } } while (0); } while (0);

      UPDATE_SYNTAX_TABLE_BACKWARD (charpos);
      c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((bytepos)) : ((((sizeof ((*((((((bytepos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((bytepos))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((bytepos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((bytepos))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((bytepos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((bytepos))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((bytepos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((bytepos))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((bytepos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((bytepos))) + (current_buffer->text->beg) - ((1))))) : ((*((((((bytepos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((bytepos))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
      code = syntax_property (c, 1);
...
dec_bytepos (ptrdiff_t bytepos)
{
  ...
  do { unsigned char *chp; bytepos--; if (bytepos < (current_buffer->text->gpt_byte)) chp = (current_buffer->text->beg) + bytepos - ((1)); else chp = (current_buffer->text->beg) + (current_buffer->text->gap_size) + bytepos - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; bytepos--; } } while (0);
  return bytepos;
}
# 584 "syntax.c"
static ptrdiff_t
...
{
  ptrdiff_t opoint = (current_buffer->pt + 0), opoint_byte = (current_buffer->pt_byte + 0);
  ...
  if (current_buffer == find_start_buffer
      ...
      && (current_buffer->begv) == find_start_begv
      && (current_buffer->text->modiff) == find_start_modiff)
    return find_start_value;

  if (!globals.f_open_paren_in_column_0_is_defun_start)
    {
      find_start_value = (current_buffer->begv);
      find_start_value_byte = (current_buffer->begv_byte);
      goto found;
    }


  scan_newline (pos, pos_byte, (current_buffer->begv), (current_buffer->begv_byte), -1, 1);




  SETUP_BUFFER_SYNTAX_TABLE ();
  while ((current_buffer->pt + 0) > (current_buffer->begv))
    {
      int c;



      c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR (((current_buffer->pt_byte + 0))) : ((((sizeof ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) : ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
      if (syntax_property (c, 1) == Sopen)
 {
   SETUP_SYNTAX_TABLE ((current_buffer->pt + 0) + 1, -1);
   c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR (((current_buffer->pt_byte + 0))) : ((((sizeof ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) : ((*(((((((current_buffer->pt_byte + 0)))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((((current_buffer->pt_byte + 0)))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
   if (syntax_property (c, 1) == Sopen)
     break;
   ...
   SETUP_BUFFER_SYNTAX_TABLE ();
      ...
      scan_newline ((current_buffer->pt + 0), (current_buffer->pt_byte + 0), (current_buffer->begv), (current_buffer->begv_byte), -2, 1);
    }


  find_start_value = (current_buffer->pt + 0);
  find_start_value_byte = (current_buffer->pt_byte + 0);
  (temp_set_point_both (current_buffer, (opoint), (opoint_byte)));

 found:
  find_start_buffer = current_buffer;
  find_start_modiff = (current_buffer->text->modiff);
  find_start_begv = (current_buffer->begv);
  find_start_pos = pos;
...
prev_char_comend_first (ptrdiff_t pos, ptrdiff_t pos_byte)
{
  ...
  do { (pos)--; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (pos_byte)--; else do { unsigned char *chp; (pos_byte)--; if ((pos_byte) < (current_buffer->text->gpt_byte)) chp = (current_buffer->text->beg) + (pos_byte) - ((1)); else chp = (current_buffer->text->beg) + (current_buffer->text->gap_size) + (pos_byte) - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; (pos_byte)--; } } while (0); } while (0);
  UPDATE_SYNTAX_TABLE_BACKWARD (pos);
  c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((pos_byte)) : *((((((pos_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((pos_byte))) + (current_buffer->text->beg) - ((1)))));
...
back_comment (ptrdiff_t from, ptrdiff_t from_byte, ptrdiff_t stop,
       _Bool comnested, int comstyle, ptrdiff_t *charpos_ptr,
       ptrdiff_t *bytepos_ptr)
{
# 690 "syntax.c"
  int string_style = -1;
  _Bool string_lossage = 0;





  _Bool comment_lossage = 0;
  ...
  while (from != stop)
    {
      ptrdiff_t temp_byte;
      int prev_syntax;
      _Bool com2start, com2end, comstart;


      do { (from)--; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (from_byte)--; else do { unsigned char *chp; (from_byte)--; if ((from_byte) < (current_buffer->text->gpt_byte)) chp = (current_buffer->text->beg) + (from_byte) - ((1)); else chp = (current_buffer->text->beg) + (current_buffer->text->gap_size) + (from_byte) - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; (from_byte)--; } } while (0); } while (0);
      UPDATE_SYNTAX_TABLE_BACKWARD (from);

      prev_syntax = syntax;
      c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
      syntax = syntax_property_with_flags (c, 1);
      code = syntax_property (c, 1);
...
# 755 "syntax.c"
      if (from > stop && (com2end || comstart))
 {
   ...
   do { (next)--; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (next_byte)--; else do { unsigned char *chp; (next_byte)--; if ((next_byte) < (current_buffer->text->gpt_byte)) chp = (current_buffer->text->beg) + (next_byte) - ((1)); else chp = (current_buffer->text->beg) + (current_buffer->text->gap_size) + (next_byte) - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; (next_byte)--; } } while (0); } while (0);
   UPDATE_SYNTAX_TABLE_BACKWARD (next);
   next_c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((next_byte)) : ((((sizeof ((*((((((next_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((next_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((next_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((next_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((next_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((next_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((next_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((next_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((next_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((next_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((next_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((next_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
   next_syntax = syntax_property_with_flags (next_c, 1);
 ...
 continue;
      ...
      if ((globals.f_Vcomment_end_can_be_escaped || code != Sendcomment)
 ...
 case Sopen:
   ...
   if (globals.f_open_paren_in_column_0_is_defun_start
    ...
    || (temp_byte = dec_bytepos (from_byte),
        (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((temp_byte)) : *((((((temp_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_byte))) + (current_buffer->text->beg) - ((1))))) == '\n')))
     {
       defun_start = from;
      ...
      if (defun_start == 0)
 {
   ...
   adjusted = (defun_start > (current_buffer->begv));
 }
      do
 {
   scan_sexps_forward (&state,
         defun_start, defun_start_byte,
         comment_end, ((EMACS_INT) (! (! ((EMACS_INT) 0 < (EMACS_INT) -1)) ? (EMACS_INT) 0 : ((EMACS_INT) ~ (EMACS_INT) 0 < (EMACS_INT) -1) ? ~ (EMACS_INT) 0 : ~ ((EMACS_INT) (! (! ((EMACS_INT) 0 < (EMACS_INT) -1)) ? (EMACS_INT) -1 : ((((EMACS_INT) 1 << (sizeof (EMACS_INT) * 8 - 2)) - 1) * 2 + 1))))),
         0, builtin_lisp_symbol (0), 0);
   defun_start = comment_end;
   if (!adjusted)
     {
       adjusted = 1;
       find_start_value
  = (((enum Lisp_Type) ((state.levelstarts) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? (((((void) (0 && ((((enum Lisp_Type) ((state.levelstarts) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((state.levelstarts) - (Lisp_Cons))))->car) >> INTTYPEBITS)
  : state.thislevelstart >= 0 ? state.thislevelstart
  : find_start_value;
       find_start_value_byte = (buf_charpos_to_bytepos (current_buffer, find_start_value));
     }
...

  {
    ...
    defun_start_byte = (buf_charpos_to_bytepos (current_buffer, defun_start));
  }
     }
...
static struct Lisp_Subr _Alignas (8) Ssyntax_table_p = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fsyntax_table_p }, 1, 1, "syntax-table-p", 0, 0}; Lisp_Object Fsyntax_table_p


  (Lisp_Object object)
{
  if (CHAR_TABLE_P (object)
      && ((XCHAR_TABLE (object)->purpose) == (builtin_lisp_symbol (899))))
...
{
  ((CHAR_TABLE_P (obj) && ((XCHAR_TABLE (obj)->purpose) == (builtin_lisp_symbol (899)))) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (900), obj));

}

static struct Lisp_Subr _Alignas (8) Ssyntax_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fsyntax_table }, 0, 0, "syntax-table", 0, 0}; Lisp_Object Fsyntax_table


  (void)
{
  return ((current_buffer)-> syntax_table_);
}

static struct Lisp_Subr _Alignas (8) Sstandard_syntax_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fstandard_syntax_table }, 0, 0, "standard-syntax-table", 0, 0}; Lisp_Object Fstandard_syntax_table



  (void)
{
  return ((&buffer_defaults)-> syntax_table_);
}

static struct Lisp_Subr _Alignas (8) Scopy_syntax_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fcopy_syntax_table }, 0, 1, "copy-syntax-table", 0, 0}; Lisp_Object Fcopy_syntax_table
  ...
  (Lisp_Object table)
{
  ...
  if (!((table) == (builtin_lisp_symbol (0))))
    ...
    table = ((&buffer_defaults)-> syntax_table_);

  copy = Fcopy_sequence (table);



  set_char_table_defalt (copy, builtin_lisp_symbol (0));




  if (((XCHAR_TABLE (copy)->parent) == (builtin_lisp_symbol (0))))
    Fset_char_table_parent (copy, ((&buffer_defaults)-> syntax_table_));
  return copy;
}

static struct Lisp_Subr _Alignas (8) Sset_syntax_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fset_syntax_table }, 1, 1, "set-syntax-table", 0, 0}; Lisp_Object Fset_syntax_table
  ...
  (Lisp_Object table)
{
  ...
  idx = ((*(Lisp_Object *)((__builtin_offsetof(struct buffer, syntax_table_)) + (char *) &buffer_local_flags)) >> INTTYPEBITS);
  do { if ((idx) < 0 || (idx) >= last_per_buffer_idx) emacs_abort (); (current_buffer)->local_flags[idx] = (1); } while (0);
  return table;
}
...
unsigned char const syntax_spec_code[0400] =
  { 0377, 0377, 0377, 0377, 0377, 0377, 0377, 0377,
    ...
    Sinherit, 0377, 0377, 0377, 0377, 0377, 0377, 0377,
    0377, 0377, 0377, 0377, 0377, 0377, 0377, 0377,
...
static struct Lisp_Subr _Alignas (8) Schar_syntax = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fchar_syntax }, 1, 1, "char-syntax", 0, 0}; Lisp_Object Fchar_syntax
  ...
  (Lisp_Object character)
{
  ...
  char_int = ((character) >> INTTYPEBITS);
  SETUP_BUFFER_SYNTAX_TABLE ();
  return ((EMACS_INT) (((EMACS_UINT) (syntax_code_spec[syntax_property (char_int, 1)]) << INTTYPEBITS) + Lisp_Int0));
}

static struct Lisp_Subr _Alignas (8) Smatching_paren = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fmatching_paren }, 1, 1, "matching-paren", 0, 0}; Lisp_Object Fmatching_paren
  ...
  (Lisp_Object character)
{
  ...
  char_int = ((character) >> INTTYPEBITS);
  SETUP_BUFFER_SYNTAX_TABLE ();
  code = syntax_property (char_int, 1);
  if (code == Sopen || code == Sclose)
    return SYNTAX_MATCH (char_int);
  return builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Sstring_to_syntax = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fstring_to_syntax }, 1, 1, "string-to-syntax", 0, 0}; Lisp_Object Fstring_to_syntax
  ...
  (Lisp_Object string)
{
  ...
  if (*p)
    {
      int len;
      int character = (!((p)[0] & 0x80) ? ((len) = 1, (p)[0]) : ! ((p)[0] & 0x20) ? ((len) = 2, (((((p)[0] & 0x1F) << 6) | ((p)[1] & 0x3F)) + (((unsigned char) (p)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((p)[0] & 0x10) ? ((len) = 3, ((((p)[0] & 0x0F) << 12) | (((p)[1] & 0x3F) << 6) | ((p)[2] & 0x3F))) : string_char ((p), ((void*)0), &len));
      ((match) = ((EMACS_INT) (((EMACS_UINT) (character) << INTTYPEBITS) + Lisp_Int0)));
      if (((match) >> INTTYPEBITS) == ' ')
 match = builtin_lisp_symbol (0);
      p += len;
    }
  else
    match = builtin_lisp_symbol (0);
 ...
 break;
  ...
  if (val < ASIZE (Vsyntax_code_object) && ((match) == (builtin_lisp_symbol (0))))
    return AREF (Vsyntax_code_object, val);
  else

    return Fcons (((EMACS_INT) (((EMACS_UINT) (val) << INTTYPEBITS) + Lisp_Int0)), match);
}



static struct Lisp_Subr _Alignas (8) Smodify_syntax_entry = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fmodify_syntax_entry }, 2, 3, "modify-syntax-entry", "cSet syntax for character: \nsSet syntax for %s to: ", 0}; Lisp_Object Fmodify_syntax_entry
# 1222 "syntax.c"
  (Lisp_Object c, Lisp_Object newentry, Lisp_Object syntax_table)
{
  if ((((enum Lisp_Type) ((c) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      do { Lisp_Object tmp = (((void) (0 && ((((enum Lisp_Type) ((c) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((c) - (Lisp_Cons))))->car; (((NATNUMP (tmp) && ((tmp) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), tmp)); } while (0);
      do { Lisp_Object tmp = (((void) (0 && ((((enum Lisp_Type) ((c) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((c) - (Lisp_Cons))))->u.cdr; (((NATNUMP (tmp) && ((tmp) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), tmp)); } while (0);
    }
  else
    (((NATNUMP (c) && ((c) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), c));

  if (((syntax_table) == (builtin_lisp_symbol (0))))
    syntax_table = ((current_buffer)-> syntax_table_);
  else
  ...
  if ((((enum Lisp_Type) ((c) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    ...
    SET_RAW_SYNTAX_ENTRY (syntax_table, ((c) >> INTTYPEBITS), newentry);
...
static struct Lisp_Subr _Alignas (8) Sinternal_describe_syntax_value = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Finternal_describe_syntax_value }, 1, 1, "internal-describe-syntax-value", 0, 0}; Lisp_Object Finternal_describe_syntax_value


  (Lisp_Object syntax)
{
  int code, syntax_code;
  _Bool start1, start2, end1, end2, prefix, comstyleb, comstylec, comnested;
  char str[2];
  Lisp_Object first, match_lisp, value = syntax;

  if (((value) == (builtin_lisp_symbol (0))))
    {
  ...
  if (!(((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      insert_string ("invalid");
      return syntax;
    }

  first = (((void) (0 && ((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((value) - (Lisp_Cons))))->car;
  match_lisp = (((void) (0 && ((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((value) - (Lisp_Cons))))->u.cdr;

  if (!((((enum Lisp_Type) ((first) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) || !(((match_lisp) == (builtin_lisp_symbol (0))) || (NATNUMP (match_lisp) && ((match_lisp) >> INTTYPEBITS) <= 0x3FFFFF)))
    {
      insert_string ("invalid");
      return syntax;
    }

  syntax_code = ((first) >> INTTYPEBITS) & 2147483647;
  ...
  if (((match_lisp) == (builtin_lisp_symbol (0))))
    insert (" ", 1);
  else
    insert_char (((match_lisp) >> INTTYPEBITS));
  ...
  if (prefix)
    {
      Lisp_Object prefixdoc = (USE_STACK_STRING ? (make_lisp_ptr ((&(union Aligned_String) {{strlen (",\n\t  is a prefix character for `backward-prefix-chars'"), -1, 0, (unsigned char *) (",\n\t  is a prefix character for `backward-prefix-chars'")}}.s), Lisp_String)) : build_string ((",\n\t  is a prefix character for `backward-prefix-chars'")));
...
{
  register ptrdiff_t beg = (current_buffer->begv);
  register ptrdiff_t end = (current_buffer->zv);
  register ptrdiff_t from_byte = (buf_charpos_to_bytepos (current_buffer, from));
      ...
      while (1)
 {
   ...
   ch0 = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
   code = syntax_property (ch0, 1);
   do { (from)++; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (from_byte)++; else do { unsigned char *chp = ((((from_byte)) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((from_byte)) + (current_buffer->text->beg) - ((1))); (from_byte) += (!((*chp) & 0x80) ? 1 : !((*chp) & 0x20) ? 2 : !((*chp) & 0x10) ? 3 : !((*chp) & 0x08) ? 4 : 5); } while (0); } while (0);
   if (globals.f_words_include_escapes
   ...
   if (code == Sword)
     break;
      ...
      func = CHAR_TABLE_REF (globals.f_Vfind_word_boundary_function_table, ch0);
      if (! ((Ffboundp (func)) == (builtin_lisp_symbol (0))))
 {
   pos = call2 (func, ((EMACS_INT) (((EMACS_UINT) (from - 1) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (end) << INTTYPEBITS) + Lisp_Int0)));
   if (((((enum Lisp_Type) ((pos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && from < ((pos) >> INTTYPEBITS) && ((pos) >> INTTYPEBITS) <= (current_buffer->zv))
     {
       from = ((pos) >> INTTYPEBITS);
       from_byte = (buf_charpos_to_bytepos (current_buffer, from));
     }
 }
      else
   ...
   while (1)
     {
       if (from == end) break;
       UPDATE_SYNTAX_TABLE_FORWARD (from);
       ch1 = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
       code = syntax_property (ch1, 1);
       if ((code != Sword
      ...
      while (1)
 {
   ...
   if (code == Sword)
     break;
      ...
      func = CHAR_TABLE_REF (globals.f_Vfind_word_boundary_function_table, ch1);
      if (! ((Ffboundp (func)) == (builtin_lisp_symbol (0))))
  {
   pos = call2 (func, ((EMACS_INT) (((EMACS_UINT) (from) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (beg) << INTTYPEBITS) + Lisp_Int0)));
   if (((((enum Lisp_Type) ((pos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && (current_buffer->begv) <= ((pos) >> INTTYPEBITS) && ((pos) >> INTTYPEBITS) < from)
     {
       from = ((pos) >> INTTYPEBITS);
       from_byte = (buf_charpos_to_bytepos (current_buffer, from));
     }
...
static struct Lisp_Subr _Alignas (8) Sforward_word = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fforward_word }, 0, 1, "forward-word", "^p", 0}; Lisp_Object Fforward_word
# 1548 "syntax.c"
  (Lisp_Object arg)
{
  Lisp_Object tmp;
  ...
  if (((arg) == (builtin_lisp_symbol (0))))
    ((arg) = make_natnum (1));
  else
    ((((((enum Lisp_Type) ((arg) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), arg));

  val = orig_val = scan_words ((current_buffer->pt + 0), ((arg) >> INTTYPEBITS));
  if (! orig_val)
    val = ((arg) >> INTTYPEBITS) > 0 ? (current_buffer->zv) : (current_buffer->begv);


  tmp = Fconstrain_to_field (((EMACS_INT) (((EMACS_UINT) (val) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) ((current_buffer->pt + 0)) << INTTYPEBITS) + Lisp_Int0)),
        builtin_lisp_symbol (0), builtin_lisp_symbol (0), builtin_lisp_symbol (0));
  val = ((tmp) >> INTTYPEBITS);

  (set_point (val));
  return val == orig_val ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Sskip_chars_forward = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fskip_chars_forward }, 1, 2, "skip-chars-forward", 0, 0}; Lisp_Object Fskip_chars_forward
# 1581 "syntax.c"
...
static struct Lisp_Subr _Alignas (8) Sskip_chars_backward = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fskip_chars_backward }, 1, 2, "skip-chars-backward", 0, 0}; Lisp_Object Fskip_chars_backward
...
static struct Lisp_Subr _Alignas (8) Sskip_syntax_forward = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fskip_syntax_forward }, 1, 2, "skip-syntax-forward", 0, 0}; Lisp_Object Fskip_syntax_forward
...
static struct Lisp_Subr _Alignas (8) Sskip_syntax_backward = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fskip_syntax_backward }, 1, 2, "skip-syntax-backward", 0, 0}; Lisp_Object Fskip_syntax_backward
...
static Lisp_Object
skip_chars (_Bool forwardp, Lisp_Object string, Lisp_Object lim,
     _Bool handle_iso_classes)
{
  int c;
  char fastmap[0400];
  ...
  CHECK_STRING (string);
  iso_classes = builtin_lisp_symbol (0);

  if (((lim) == (builtin_lisp_symbol (0))))
    ((lim) = ((EMACS_INT) (((EMACS_UINT) (forwardp ? (current_buffer->zv) : (current_buffer->begv)) << INTTYPEBITS) + Lisp_Int0)));
  else
    do { if (((((enum Lisp_Type) (((lim)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE ((lim)) == Lisp_Misc_Marker)) ((lim) = make_natnum (marker_position (lim))); else ((((((enum Lisp_Type) ((lim) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (558), lim)); } while (0);


  if (((lim) >> INTTYPEBITS) > (current_buffer->zv))
    ((lim) = make_natnum ((current_buffer->zv)));
  if (((lim) >> INTTYPEBITS) < (current_buffer->begv))
    ((lim) = make_natnum ((current_buffer->begv)));

  multibyte = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))
        && (((lim) >> INTTYPEBITS) - (current_buffer->pt + 0) != (buf_charpos_to_bytepos (current_buffer, ((lim) >> INTTYPEBITS))) - (current_buffer->pt_byte + 0)));
      ...
      while (i_byte < size_byte)
 {
   ...
   if (handle_iso_classes && c == '['
       ...
       && str[i_byte] == ':')
     {
       ...
       unsigned char class_name[9 + 1];
       re_wctype_t cc;

       if (class_limit - class_beg > 9)
  class_limit = class_beg + 9;
  ...
  error ("Invalid ISO C character class");
       ...
       iso_classes = Fcons (((EMACS_INT) (((EMACS_UINT) (cc) << INTTYPEBITS) + Lisp_Int0)), iso_classes);
 ...
 not_a_class_name:
       ...
       if (c <= c2)
  {
    ...
    while (c < lim2)
      fastmap[c++] = 1;
    if (! (((sizeof ((c2) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c2) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c2) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c2) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)))
      ...
      if (multibyte && string_has_eight_bit)
 {
   ...
   do { if ((128) <= sa_avail / sizeof *(char_ranges) / (2)) (char_ranges) = (sa_avail -= (sizeof *(char_ranges) * (2) * (128)), __builtin_alloca (sizeof *(char_ranges) * (2) * (128))); else { (char_ranges) = xnmalloc (128, sizeof *(char_ranges) * (2)); sa_must_free = 1; record_unwind_protect_ptr (xfree, char_ranges); } } while (0);
   i = 0;
   ...
   while ((p1 = memchr (himap + i, 1, 0200 - i)))
     {
       ...
       c = ((i + 0200) + 0x3FFF00);
       i += strlen (p1);
       c2 = ((i + 0200 - 1) + 0x3FFF00);

       char_ranges[n_char_ranges++] = c;
       char_ranges[n_char_ranges++] = c2;
       leading_code = ((c) <= 0x7F ? c : (c) <= 0x7FF ? (0xC0 | ((c) >> 6)) : (c) <= 0xFFFF ? (0xE0 | ((c) >> 12)) : (c) <= 0x1FFFFF ? (0xF0 | ((c) >> 18)) : (c) <= 0x3FFF7F ? 0xF8 : (0xC0 | (((c) >> 6) & 0x01)));
       memset (fastmap + leading_code, 1,
        ((c2) <= 0x7F ? c2 : (c2) <= 0x7FF ? (0xC0 | ((c2) >> 6)) : (c2) <= 0xFFFF ? (0xE0 | ((c2) >> 12)) : (c2) <= 0x1FFFFF ? (0xF0 | ((c2) >> 18)) : (c2) <= 0x3FFF7F ? 0xF8 : (0xC0 | (((c2) >> 6) & 0x01))) - leading_code + 1);
     }
 }
    }
  else
    {
      do { if ((SCHARS (string)) <= sa_avail / sizeof *(char_ranges) / (2)) (char_ranges) = (sa_avail -= (sizeof *(char_ranges) * (2) * (SCHARS (string))), __builtin_alloca (sizeof *(char_ranges) * (2) * (SCHARS (string)))); else { (char_ranges) = xnmalloc (SCHARS (string), sizeof *(char_ranges) * (2)); sa_must_free = 1; record_unwind_protect_ptr (xfree, char_ranges); } } while (0);

      while (i_byte < size_byte)
 {
   int leading_code = str[i_byte];
   c = (!((str + i_byte)[0] & 0x80) ? ((len) = 1, (str + i_byte)[0]) : ! ((str + i_byte)[0] & 0x20) ? ((len) = 2, (((((str + i_byte)[0] & 0x1F) << 6) | ((str + i_byte)[1] & 0x3F)) + (((unsigned char) (str + i_byte)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((str + i_byte)[0] & 0x10) ? ((len) = 3, ((((str + i_byte)[0] & 0x0F) << 12) | (((str + i_byte)[1] & 0x3F) << 6) | ((str + i_byte)[2] & 0x3F))) : string_char ((str + i_byte), ((void*)0), &len));
   i_byte += len;

   if (handle_iso_classes && c == '['
       && i_byte < size_byte
       && (!((str + i_byte)[0] & 0x80) ? (str + i_byte)[0] : ! ((str + i_byte)[0] & 0x20) ? (((((str + i_byte)[0] & 0x1F) << 6) | ((str + i_byte)[1] & 0x3F)) + (((unsigned char) (str + i_byte)[0]) < 0xC2 ? 0x3FFF80 : 0)) : ! ((str + i_byte)[0] & 0x10) ? ((((str + i_byte)[0] & 0x0F) << 12) | (((str + i_byte)[1] & 0x3F) << 6) | ((str + i_byte)[2] & 0x3F)) : string_char ((str + i_byte), ((void*)0), ((void*)0))) == ':')
     {
       const unsigned char *class_beg = str + i_byte + 1;
       const unsigned char *class_end = class_beg;
       const unsigned char *class_limit = str + size_byte - 2;
  ...
  break;
   ...
   if (i_byte + 1 < size_byte
       && str[i_byte] == '-')
     {
       ...
       c2 = (!((str + i_byte)[0] & 0x80) ? ((len) = 1, (str + i_byte)[0]) : ! ((str + i_byte)[0] & 0x20) ? ((len) = 2, (((((str + i_byte)[0] & 0x1F) << 6) | ((str + i_byte)[1] & 0x3F)) + (((unsigned char) (str + i_byte)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((str + i_byte)[0] & 0x10) ? ((len) = 3, ((((str + i_byte)[0] & 0x0F) << 12) | (((str + i_byte)[1] & 0x3F) << 6) | ((str + i_byte)[2] & 0x3F))) : string_char ((str + i_byte), ((void*)0), &len));
       i_byte += len;
   ...
   for (i = 0; i < n_char_ranges; i += 2)
     {
       ...
       for (; c1 < lim2; c1++)
  {
    int b = ((((sizeof ((c1) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c1) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c1) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c1) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? c1 : (((c1) > 0x3FFF7F) ? (c1) - 0x3FFF00 : -1));
    if (b >= 0)
      fastmap[b] = 1;
  }
     }
      ...
      else
 {
  ...
  {
    ptrdiff_t start_point = (current_buffer->pt + 0);
    ptrdiff_t pos = (current_buffer->pt + 0);
    ptrdiff_t pos_byte = (current_buffer->pt_byte + 0);
    unsigned char *p = ((((current_buffer->pt_byte) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (current_buffer->pt_byte) + (current_buffer->text->beg) - ((1)))), *endp, *stop;

    if (forwardp)
      {
 endp = (((lim) >> INTTYPEBITS) == (current_buffer->text->gpt)) ? (current_buffer->text->beg + current_buffer->text->gpt_byte - ((1))) : (((((lim) >> INTTYPEBITS)) >= (current_buffer->text->gpt) ? (current_buffer->text->gap_size) : 0) + buf_charpos_to_bytepos (current_buffer, ((lim) >> INTTYPEBITS)) + (current_buffer->text->beg) - ((1)));
 stop = (pos < (current_buffer->text->gpt) && (current_buffer->text->gpt) < ((lim) >> INTTYPEBITS)) ? (current_buffer->text->beg + current_buffer->text->gpt_byte - ((1))) : endp;
      }
    else
      {
 endp = (((((lim) >> INTTYPEBITS)) >= (current_buffer->text->gpt) ? (current_buffer->text->gap_size) : 0) + buf_charpos_to_bytepos (current_buffer, ((lim) >> INTTYPEBITS)) + (current_buffer->text->beg) - ((1)));
 stop = (pos >= (current_buffer->text->gpt) && (current_buffer->text->gpt) > ((lim) >> INTTYPEBITS)) ? (current_buffer->text->beg + current_buffer->text->gpt_byte + current_buffer->text->gap_size - ((1))) : endp;
      }
 ...
 if (multibyte)
       ...
       if (p >= stop)
  {
    ...
    stop = endp;
       ...
       c = (!((p)[0] & 0x80) ? ((nbytes) = 1, (p)[0]) : ! ((p)[0] & 0x20) ? ((nbytes) = 2, (((((p)[0] & 0x1F) << 6) | ((p)[1] & 0x3F)) + (((unsigned char) (p)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((p)[0] & 0x10) ? ((nbytes) = 3, ((((p)[0] & 0x0F) << 12) | (((p)[1] & 0x3F) << 6) | ((p)[2] & 0x3F))) : string_char ((p), ((void*)0), &nbytes));
       if (! ((iso_classes) == (builtin_lisp_symbol (0))) && in_classes (c, iso_classes))
  {
    if (negate)
      break;
    else
...
# 2001 "syntax.c"
       ...
       if (p >= stop)
  {
    ...
    stop = endp;
       ...
       if (!((iso_classes) == (builtin_lisp_symbol (0))) && in_classes (*p, iso_classes))
  {
    if (negate)
      break;
    else
 ...
 if (multibyte)
       ...
       if (p <= stop)
  {
    if (p <= endp)
      break;
    p = (current_buffer->text->beg + current_buffer->text->gpt_byte - ((1)));
    stop = endp;
  }
       prev_p = p;
       while (--p >= stop && ! (((*p) & 0xC0) != 0x80));
       ...
       if (p <= stop)
  {
    ...
    stop = endp;
       ...
       if (! ((iso_classes) == (builtin_lisp_symbol (0))) && in_classes (p[-1], iso_classes))
  {
    if (negate)
      break;
    else
  ...
  break;
    ...
    return ((EMACS_INT) (((EMACS_UINT) ((current_buffer->pt + 0) - start_point) << INTTYPEBITS) + Lisp_Int0));
  }
}


static Lisp_Object
skip_syntaxes (_Bool forwardp, Lisp_Object string, Lisp_Object lim)
{
  int c;
  ...
  if (forwardp ? ((current_buffer->pt + 0) >= ((lim) >> INTTYPEBITS)) : ((current_buffer->pt + 0) <= ((lim) >> INTTYPEBITS)))
 ...
 while (1)
  ...
  if (multibyte)
    ...
    c = *p, nbytes = 1;
  if (! fastmap[syntax_property (c, 1)])
    goto done;
  p += nbytes, pos++, pos_byte += nbytes;
       }
     while (!globals.f_parse_sexp_lookup_properties
 ...
 if (multibyte)
  ...
  UPDATE_SYNTAX_TABLE_BACKWARD (pos - 1);
  if (! fastmap[syntax_property (p[-1], 1)])
    break;
  p--, pos--, pos_byte--;
       }
   }
...
in_classes (int c, Lisp_Object iso_classes)
{
  ...
  while ((((enum Lisp_Type) ((iso_classes) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      Lisp_Object elt;
      elt = (((void) (0 && ((((enum Lisp_Type) ((iso_classes) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((iso_classes) - (Lisp_Cons))))->car;
      iso_classes = (((void) (0 && ((((enum Lisp_Type) ((iso_classes) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((iso_classes) - (Lisp_Cons))))->u.cdr;

      if (re_iswctype (c, ((elt) >> INTTYPEBITS)))
 fits_class = 1;
    }
       ...
       EMACS_INT *incomment_ptr)
{
   ...
   *bytepos_ptr = from_byte;
   ...
   && (SYNTAX_FLAGS_COMMENT_NESTED (syntax) ?
       (nesting > 0 && --nesting == 0) : nesting < 0)
          && !(globals.f_Vcomment_end_can_be_escaped && char_quoted (from, from_byte)))
 ...
 nesting++;
   ...
   && (c1 = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00))),
       other_syntax = syntax_property_with_flags (c1, 1),
...
static struct Lisp_Subr _Alignas (8) Sforward_comment = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fforward_comment }, 1, 1, "forward-comment", 0, 0}; Lisp_Object Fforward_comment
  ...
  (Lisp_Object count)
{
  ...
  count1 = ((count) >> INTTYPEBITS);
  stop = count1 > 0 ? (current_buffer->zv) : (current_buffer->begv);

  immediate_quit = 1;
  do { if (!((globals.f_Vquit_flag) == (builtin_lisp_symbol (0))) && ((globals.f_Vinhibit_quit) == (builtin_lisp_symbol (0)))) process_quit_flag (); else if (pending_signals) process_pending_signals (); } while (0);

  from = (current_buffer->pt + 0);
  from_byte = (current_buffer->pt_byte + 0);
  ...
  while (count1 > 0)
    {
      do
 {
   _Bool comstart_first;
   int syntax, other_syntax;

   if (from == stop)
     {
       (set_point_both (from, from_byte));
       immediate_quit = 0;
       return builtin_lisp_symbol (0);
     }
   c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
      ...
      while (1)
 {
   ...
   if (from <= stop)
     {
       (set_point_both ((current_buffer->begv), (current_buffer->begv_byte)));
       immediate_quit = 0;
       return builtin_lisp_symbol (0);
     }
       ...
       while (1)
  {
    ...
    UPDATE_SYNTAX_TABLE_BACKWARD (from);
    c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
    if (syntax_property (c, 1) == Scomment_fence
        && !char_quoted (from, from_byte))
      {
        fence_found = 1;
        break;
...
syntax_multibyte (int c, _Bool multibyte_symbol_p)
{
  return (((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) || !multibyte_symbol_p ? syntax_property (c, 1) : Ssymbol;
}

static Lisp_Object
scan_lists (EMACS_INT from, EMACS_INT count, EMACS_INT depth, _Bool sexpflag)
{
  Lisp_Object val;
  ptrdiff_t stop = count > 0 ? (current_buffer->zv) : (current_buffer->begv);
  int c, c1;
  int stringterm;
  _Bool quoted;
  _Bool mathexit = 0;
  enum syntaxcode code;
  EMACS_INT min_depth = depth;
  int comstyle = 0;
  _Bool comnested = 0;
  ptrdiff_t temp_pos;
  ...
  EMACS_INT dummy;
  _Bool multibyte_symbol_p = sexpflag && globals.f_multibyte_syntax_as_symbol;

  if (depth > 0) min_depth = 0;

  if (from > (current_buffer->zv)) from = (current_buffer->zv);
  if (from < (current_buffer->begv)) from = (current_buffer->begv);
      ...
      while (from < stop)
 {
   ...
   if (from < stop && comstart_first
       && (c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00))),
    other_syntax = syntax_property_with_flags (c, 1),
    SYNTAX_FLAGS_COMSTART_SECOND (other_syntax))
       ...
       while (from < stop)
  {
   ...
   goto lose;
    ...
    do { (from)++; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (from_byte)++; else do { unsigned char *chp = ((((from_byte)) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((from_byte)) + (current_buffer->text->beg) - ((1))); (from_byte) += (!((*chp) & 0x80) ? 1 : !((*chp) & 0x20) ? 2 : !((*chp) & 0x10) ? 3 : !((*chp) & 0x08) ? 4 : 5); } while (0); } while (0);
     ...
     case Scomment:
       if (!globals.f_parse_sexp_ignore_comments) break;
       UPDATE_SYNTAX_TABLE_FORWARD (from);
       ...
       if (!found)
  {
    ...
    goto lose;
     ...
     case Smath:
       if (!sexpflag)
  break;
       if (from != stop && c == (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00))))
  {
    do { (from)++; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (from_byte)++; else do { unsigned char *chp = ((((from_byte)) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((from_byte)) + (current_buffer->text->beg) - ((1))); (from_byte) += (!((*chp) & 0x80) ? 1 : !((*chp) & 0x20) ? 2 : !((*chp) & 0x10) ? 3 : !((*chp) & 0x08) ? 4 : 5); } while (0); } while (0);
  }
       if (mathexit)
  {
    ...
    goto close1;
     ...
     close1:
       if (!--depth) goto done;
       if (depth < min_depth)
  xsignal3 (builtin_lisp_symbol (828),
     build_string ("Containing expression ends prematurely"),
     ((EMACS_INT) (((EMACS_UINT) (last_good) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (from) << INTTYPEBITS) + Lisp_Int0)));
       break;

     case Sstring:
     case Sstring_fence:
       temp_pos = dec_bytepos (from_byte);
       stringterm = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((temp_pos)) : ((((sizeof ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) : ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
       while (1)
  {
      ...
      while (from > stop)
 {
   ...
   if (from > stop && SYNTAX_FLAGS_COMEND_SECOND (syntax)
       ...
       && globals.f_parse_sexp_ignore_comments)
     {
       ...
       UPDATE_SYNTAX_TABLE_BACKWARD (from);
       code = Sendcomment;
       c2 = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
       other_syntax = syntax_property_with_flags (c2, 1);
       comstyle = SYNTAX_FLAGS_COMMENT_STYLE (other_syntax, syntax);
       comnested |= SYNTAX_FLAGS_COMMENT_NESTED (other_syntax);
     }
       ...
       while (from > stop)
  {
    temp_pos = from_byte;
    if (! ((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))))
      do { unsigned char *chp; temp_pos--; if (temp_pos < (current_buffer->text->gpt_byte)) chp = (current_buffer->text->beg) + temp_pos - ((1)); else chp = (current_buffer->text->beg) + (current_buffer->text->gap_size) + temp_pos - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; temp_pos--; } } while (0);
    else
      temp_pos--;
    UPDATE_SYNTAX_TABLE_BACKWARD (from - 1);
    c1 = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((temp_pos)) : ((((sizeof ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) : ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
       ...
       if (from > (current_buffer->begv))
  {
    temp_pos = dec_bytepos (from_byte);
    UPDATE_SYNTAX_TABLE_BACKWARD (from - 1);
    if (from != stop && c == (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((temp_pos)) : ((((sizeof ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) : ((*((((((temp_pos))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((temp_pos))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00))))
      do { (from)--; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (from_byte)--; else do { unsigned char *chp; (from_byte)--; if ((from_byte) < (current_buffer->text->gpt_byte)) chp = (current_buffer->text->beg) + (from_byte) - ((1)); else chp = (current_buffer->text->beg) + (current_buffer->text->gap_size) + (from_byte) - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; (from_byte)--; } } while (0); } while (0);
  }
       if (mathexit)
  {
  ...
  xsignal3 (builtin_lisp_symbol (828),
     ...
     case Sendcomment:
       if (!globals.f_parse_sexp_ignore_comments)
  break;
       found = back_comment (from, from_byte, stop, comnested, comstyle,
        &out_charpos, &out_bytepos);
       ...
       while (1)
  {
   ...
   break;
     ...
     case Sstring:
       stringterm = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
       while (1)
  {
    if (from == stop)
      goto lose;
...
static struct Lisp_Subr _Alignas (8) Sscan_lists = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fscan_lists }, 3, 3, "scan-lists", 0, 0}; Lisp_Object Fscan_lists
# 3040 "syntax.c"
  (Lisp_Object from, Lisp_Object count, Lisp_Object depth)
{
  ((((((enum Lisp_Type) ((from) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), from));
  ((((((enum Lisp_Type) ((count) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), count));
  ((((((enum Lisp_Type) ((depth) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), depth));

  return scan_lists (((from) >> INTTYPEBITS), ((count) >> INTTYPEBITS), ((depth) >> INTTYPEBITS), 0);
}

static struct Lisp_Subr _Alignas (8) Sscan_sexps = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fscan_sexps }, 2, 2, "scan-sexps", 0, 0}; Lisp_Object Fscan_sexps
# 3060 "syntax.c"
  (Lisp_Object from, Lisp_Object count)
{
  ...
  return scan_lists (((from) >> INTTYPEBITS), ((count) >> INTTYPEBITS), 0, 1);
}

static struct Lisp_Subr _Alignas (8) Sbackward_prefix_chars = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fbackward_prefix_chars }, 0, 0, "backward-prefix-chars", 0, 0}; Lisp_Object Fbackward_prefix_chars
  ...
  (void)
{
  ...
  && ((c = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((pos_byte)) : ((((sizeof ((*((((((pos_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((pos_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((pos_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((pos_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((pos_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((pos_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((pos_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((pos_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((pos_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((pos_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((pos_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((pos_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00))), syntax_property (c, 1) == Squote)
...
scan_sexps_forward (struct lisp_parse_state *stateptr,
      ...
      EMACS_INT targetdepth, _Bool stopbefore,
      Lisp_Object oldstate, int commentstop)
{
  ...
  EMACS_INT mindepth;
  _Bool start_quoted = 0;
  Lisp_Object tem;
  ptrdiff_t prev_from;
  ptrdiff_t prev_from_byte;
  int prev_from_syntax;
  _Bool boundary_stop = commentstop == -1;
  _Bool nofence;
  _Bool found;
  ptrdiff_t out_bytepos, out_charpos;
  int temp;
  ...
  if (from != (current_buffer->begv))
    do { (prev_from)--; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (prev_from_byte)--; else do { unsigned char *chp; (prev_from_byte)--; if ((prev_from_byte) < (current_buffer->text->gpt_byte)) chp = (current_buffer->text->beg) + (prev_from_byte) - ((1)); else chp = (current_buffer->text->beg) + (current_buffer->text->gap_size) + (prev_from_byte) - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; (prev_from_byte)--; } } while (0); } while (0);
# 3164 "syntax.c"
  immediate_quit = 1;
  do { if (!((globals.f_Vquit_flag) == (builtin_lisp_symbol (0))) && ((globals.f_Vinhibit_quit) == (builtin_lisp_symbol (0)))) process_quit_flag (); else if (pending_signals) process_pending_signals (); } while (0);

  if (((oldstate) == (builtin_lisp_symbol (0))))
    {
      depth = 0;
      state.instring = -1;
      state.incomment = 0;
 ...
 depth = 0;
      ...
      state.instring = (!((tem) == (builtin_lisp_symbol (0)))
   ? ((NATNUMP (tem) && ((tem) >> INTTYPEBITS) <= 0x3FFFFF) ? ((tem) >> INTTYPEBITS) : ST_STRING_STYLE)
   : -1);

      oldstate = Fcdr (oldstate);
      tem = Fcar (oldstate);
      state.incomment = (!((tem) == (builtin_lisp_symbol (0)))
    ? (((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) ? ((tem) >> INTTYPEBITS) : -1)
    : 0);

      oldstate = Fcdr (oldstate);
      tem = Fcar (oldstate);
      start_quoted = !((tem) == (builtin_lisp_symbol (0)));
      ...
      oldstate = Fcdr (oldstate);
      tem = Fcar (oldstate);
      state.comstyle = (((tem) == (builtin_lisp_symbol (0)))
   ? 0
   : (RANGED_INTEGERP (0, tem, ST_COMMENT_STYLE)
      ...
      tem = Fcar (oldstate);
      state.comstr_start =
 RANGED_INTEGERP ((-9223372036854775807L-1), tem, (9223372036854775807L)) ? ((tem) >> INTTYPEBITS) : -1;
      oldstate = Fcdr (oldstate);
      tem = Fcar (oldstate);
      while (!((tem) == (builtin_lisp_symbol (0))))
 {
   Lisp_Object temhd = Fcar (tem);
   if (RANGED_INTEGERP ((-9223372036854775807L-1), temhd, (9223372036854775807L)))
     curlevel->last = ((temhd) >> INTTYPEBITS);
  ...
  temp = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((prev_from_byte)) : *((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1)))));
  prev_from_syntax = syntax_property_with_flags (temp, 1);
  UPDATE_SYNTAX_TABLE_FORWARD (from);
 ...
 goto startquotedinstring;
  ...
  while (from < end)
    {
      int syntax;
      do { prev_from = from; prev_from_byte = from_byte; temp = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((prev_from_byte)) : ((((sizeof ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00))); prev_from_syntax = syntax_property_with_flags (temp, 1); do { (from)++; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (from_byte)++; else do { unsigned char *chp = ((((from_byte)) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((from_byte)) + (current_buffer->text->beg) - ((1))); (from_byte) += (!((*chp) & 0x80) ? 1 : !((*chp) & 0x20) ? 2 : !((*chp) & 0x10) ? 3 : !((*chp) & 0x08) ? 4 : 5); } while (0); } while (0); if (from < end) UPDATE_SYNTAX_TABLE_FORWARD (from); } while (0);
      code = prev_from_syntax & 0xff;

      if (from < end
   && SYNTAX_FLAGS_COMSTART_FIRST (prev_from_syntax)
   && (c1 = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : *((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))),
       syntax = syntax_property_with_flags (c1, 1),
       SYNTAX_FLAGS_COMSTART_SECOND (syntax)))
 ...
 symstarted:
   while (from < end)
     {
       int symchar = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((from_byte)) : ((((sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00)));
       switch (syntax_property (symchar, 1))
  {
  case Scharquote:
  case Sescape:
    do { prev_from = from; prev_from_byte = from_byte; temp = (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((prev_from_byte)) : ((((sizeof ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00))); prev_from_syntax = syntax_property_with_flags (temp, 1); do { (from)++; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (from_byte)++; else do { unsigned char *chp = ((((from_byte)) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + ((from_byte)) + (current_buffer->text->beg) - ((1))); (from_byte) += (!((*chp) & 0x80) ? 1 : !((*chp) & 0x20) ? 2 : !((*chp) & 0x10) ? 3 : !((*chp) & 0x08) ? 4 : 5); } while (0); } while (0); if (from < end) UPDATE_SYNTAX_TABLE_FORWARD (from); } while (0);
 ...
 startincomment:
   ...
   found = forw_comment (from, from_byte, end,
    ...
    (from == (current_buffer->begv) || from < state.comstr_start + 3)
    ? 0 : prev_from_syntax,
 ...
 case Sstring_fence:
   ...
   state.instring = (code == Sstring
       ? ((!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0))) ? FETCH_MULTIBYTE_CHAR ((prev_from_byte)) : ((((sizeof ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) : ((*((((((prev_from_byte))) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (((prev_from_byte))) + (current_buffer->text->beg) - ((1))))) + 0x3FFF00))))
       : ST_STRING_STYLE);
   if (boundary_stop) goto done;
 startinstring:
   {
 ...
 endquoted:
  ...
  state.levelstarts = builtin_lisp_symbol (0);
  while (curlevel > levelstart)
    state.levelstarts = Fcons (((EMACS_INT) (((EMACS_UINT) ((--curlevel)->last) << INTTYPEBITS) + Lisp_Int0)),
          state.levelstarts);
  immediate_quit = 0;
...
static struct Lisp_Subr _Alignas (8) Sparse_partial_sexp = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a6 = Fparse_partial_sexp }, 2, 6, "parse-partial-sexp", 0, 0}; Lisp_Object Fparse_partial_sexp
# 3505 "syntax.c"
   ...
   Lisp_Object stopbefore, Lisp_Object oldstate, Lisp_Object commentstop)
{
  ...
  if (!((targetdepth) == (builtin_lisp_symbol (0))))
    {
      ((((((enum Lisp_Type) ((targetdepth) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), targetdepth));
      target = ((targetdepth) >> INTTYPEBITS);
    }
  else
    target = ((EMACS_INT) (! (! ((EMACS_INT) 0 < (EMACS_INT) -1)) ? (EMACS_INT) 0 : ((EMACS_INT) ~ (EMACS_INT) 0 < (EMACS_INT) -1) ? ~ (EMACS_INT) 0 : ~ ((EMACS_INT) (! (! ((EMACS_INT) 0 < (EMACS_INT) -1)) ? (EMACS_INT) -1 : ((((EMACS_INT) 1 << (sizeof (EMACS_INT) * 8 - 2)) - 1) * 2 + 1)))));

  validate_region (&from, &to);
  scan_sexps_forward (&state, ((from) >> INTTYPEBITS), (buf_charpos_to_bytepos (current_buffer, ((from) >> INTTYPEBITS))),
        ((to) >> INTTYPEBITS),
        target, !((stopbefore) == (builtin_lisp_symbol (0))), oldstate,
        (((commentstop) == (builtin_lisp_symbol (0)))
         ? 0 : (((commentstop) == (builtin_lisp_symbol (899))) ? -1 : 1)));

  (set_point_both (state.location, state.location_byte));

  return Fcons (((EMACS_INT) (((EMACS_UINT) (state.depth) << INTTYPEBITS) + Lisp_Int0)),
    Fcons (state.prevlevelstart < 0
    ? builtin_lisp_symbol (0) : ((EMACS_INT) (((EMACS_UINT) (state.prevlevelstart) << INTTYPEBITS) + Lisp_Int0)),
      Fcons (state.thislevelstart < 0
      ? builtin_lisp_symbol (0) : ((EMACS_INT) (((EMACS_UINT) (state.thislevelstart) << INTTYPEBITS) + Lisp_Int0)),
        Fcons (state.instring >= 0
        ? (state.instring == ST_STRING_STYLE
    ? builtin_lisp_symbol (901) : ((EMACS_INT) (((EMACS_UINT) (state.instring) << INTTYPEBITS) + Lisp_Int0))) : builtin_lisp_symbol (0),
   Fcons (state.incomment < 0 ? builtin_lisp_symbol (901) :
   (state.incomment == 0 ? builtin_lisp_symbol (0) :
    ((EMACS_INT) (((EMACS_UINT) (state.incomment) << INTTYPEBITS) + Lisp_Int0))),
     Fcons (state.quoted ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0),
       Fcons (((EMACS_INT) (((EMACS_UINT) (state.mindepth) << INTTYPEBITS) + Lisp_Int0)),
         Fcons ((state.comstyle
          ? (state.comstyle == ST_COMMENT_STYLE
      ? builtin_lisp_symbol (899)
      : ((EMACS_INT) (((EMACS_UINT) (state.comstyle) << INTTYPEBITS) + Lisp_Int0)))
          : builtin_lisp_symbol (0)),
         Fcons (((state.incomment
           || (state.instring >= 0))
          ? ((EMACS_INT) (((EMACS_UINT) (state.comstr_start) << INTTYPEBITS) + Lisp_Int0))
          : builtin_lisp_symbol (0)),
         Fcons (state.levelstarts, builtin_lisp_symbol (0)))))))))));
}
...
init_syntax_once (void)
{
  ...
  for (i = 0; i < Smax; i++)
    ASET (Vsyntax_code_object, i, Fcons (((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0)));



  Fput (builtin_lisp_symbol (899), builtin_lisp_symbol (258), ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)));

  temp = AREF (Vsyntax_code_object, Swhitespace);

  ((&buffer_defaults)-> syntax_table_) = Fmake_char_table (builtin_lisp_symbol (899), temp);


  temp = AREF (Vsyntax_code_object, Spunct);
  for (i = 0; i <= ' ' - 1; i++)
    SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), i, temp);
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), 0177, temp);


  temp = AREF (Vsyntax_code_object, Swhitespace);
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), ' ', temp);
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), '\t', temp);
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), '\n', temp);
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), 015, temp);
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), 014, temp);
  ...
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), '(',
   Fcons (((EMACS_INT) (((EMACS_UINT) (Sopen) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (')') << INTTYPEBITS) + Lisp_Int0))));
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), ')',
   Fcons (((EMACS_INT) (((EMACS_UINT) (Sclose) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) ('(') << INTTYPEBITS) + Lisp_Int0))));
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), '[',
   Fcons (((EMACS_INT) (((EMACS_UINT) (Sopen) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (']') << INTTYPEBITS) + Lisp_Int0))));
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), ']',
   Fcons (((EMACS_INT) (((EMACS_UINT) (Sclose) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) ('[') << INTTYPEBITS) + Lisp_Int0))));
  ...
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), '}',
   Fcons (((EMACS_INT) (((EMACS_UINT) (Sclose) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) ('{') << INTTYPEBITS) + Lisp_Int0))));
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), '"',
   Fcons (((EMACS_INT) (((EMACS_UINT) (Sstring) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0)));
  SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), '\\',
   Fcons (((EMACS_INT) (((EMACS_UINT) (Sescape) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0)));

  temp = AREF (Vsyntax_code_object, Ssymbol);
  for (i = 0; i < 10; i++)
    {
      c = "_-+*/&|<>="[i];
      SET_RAW_SYNTAX_ENTRY (((&buffer_defaults)-> syntax_table_), c, temp);
    }
  ...
  temp = AREF (Vsyntax_code_object, Sword);
  char_table_set_range (((&buffer_defaults)-> syntax_table_), 0x80, 0x3FFFFF, temp);
}
...
syms_of_syntax (void)
{
  ...
  staticpro (&re_match_object);
                                    ...
                                    ;
  Fput (builtin_lisp_symbol (828), builtin_lisp_symbol (373),
 listn (CONSTYPE_PURE, 2, builtin_lisp_symbol (828), builtin_lisp_symbol (372)));
  Fput (builtin_lisp_symbol (828), builtin_lisp_symbol (374),
 build_pure_c_string ("Scan error"));

  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "parse-sexp-ignore-comments", &globals.f_parse_sexp_ignore_comments); } while (0);


  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "parse-sexp-lookup-properties", &globals.f_parse_sexp_lookup_properties); } while (0);





  do { static struct Lisp_Intfwd i_fwd; defvar_int (&i_fwd, "syntax-propertize--done", &globals.f_syntax_propertize__done); } while (0);

  globals.f_syntax_propertize__done = -1;
                                                                      ;
  Fmake_variable_buffer_local (intern ("syntax-propertize--done"));

  globals.f_words_include_escapes = 0;
  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "words-include-escapes", &globals.f_words_include_escapes); } while (0);


  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "multibyte-syntax-as-symbol", &globals.f_multibyte_syntax_as_symbol); } while (0);

  globals.f_multibyte_syntax_as_symbol = 0;

  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "open-paren-in-column-0-is-defun-start", &globals.f_open_paren_in_column_0_is_defun_start); } while (0);


  globals.f_open_paren_in_column_0_is_defun_start = 1;


  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "find-word-boundary-function-table", &globals.f_Vfind_word_boundary_function_table); } while (0);
# 3702 "syntax.c"
  globals.f_Vfind_word_boundary_function_table = Fmake_char_table (builtin_lisp_symbol (0), builtin_lisp_symbol (0));

  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "comment-end-can-be-escaped", &globals.f_Vcomment_end_can_be_escaped); } while (0);

  globals.f_Vcomment_end_can_be_escaped = 0;
                                                                    ;
  Fmake_variable_buffer_local (builtin_lisp_symbol (287));
