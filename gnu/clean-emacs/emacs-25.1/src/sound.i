...
# 1 "/usr/include/sys/soundcard.h" 1 3 4
# 1 "/usr/include/linux/soundcard.h" 1 3 4
# 149 "/usr/include/linux/soundcard.h" 3 4
...
# 186 "/usr/include/linux/soundcard.h" 3 4
# 1 "/usr/include/linux/patchkey.h" 1 3 4
# 187 "/usr/include/linux/soundcard.h" 2 3 4
# 209 "/usr/include/linux/soundcard.h" 3 4
struct patch_info {
  unsigned short key;
  ...
  unsigned int mode;
# 242 "/usr/include/linux/soundcard.h" 3 4
  int len;
  int loop_start, loop_end;
# 261 "/usr/include/linux/soundcard.h" 3 4
...
# 465 "/usr/include/linux/soundcard.h" 3 4
...
struct synth_info {
  ...
  int synth_subtype;
# 493 "/usr/include/linux/soundcard.h" 3 4
  int perc_mode;
  int nr_voices;
  int nr_drums;
  int instr_bank_size;
...
# 568 "/usr/include/linux/soundcard.h" 3 4
...
# 602 "/usr/include/linux/soundcard.h" 3 4
...
# 693 "/usr/include/linux/soundcard.h" 3 4
...
# 902 "/usr/include/linux/soundcard.h" 3 4
...
# 925 "/usr/include/linux/soundcard.h" 3 4
typedef unsigned char mixer_record[128];
# 953 "/usr/include/linux/soundcard.h" 3 4
typedef struct mixer_vol_table {
  int num;
  char name[32];
  int levels[32];
} mixer_vol_table;
# 1054 "/usr/include/linux/soundcard.h" 3 4
void seqbuf_dump(void);
# 2 "/usr/include/sys/soundcard.h" 2 3 4
# 69 "sound.c" 2
# 103 "sound.c"
enum sound_attr
{
...
static _Bool wav_init (struct sound *);
static void wav_play (struct sound *, struct sound_device *);
static _Bool au_init (struct sound *);
...
sound_perror (const char *msg)
{
...

  {
    ...
    sigaddset (&unblocked, 29);
    pthread_sigmask (1, &unblocked, 0);
  }
...
parse_sound (Lisp_Object sound, Lisp_Object *attrs)
{
  ...
  if (!(((enum Lisp_Type) ((sound) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) || !(((((void) (0 && ((((enum Lisp_Type) ((sound) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((sound) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (866))))
    return 0;

  sound = (((void) (0 && ((((enum Lisp_Type) ((sound) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((sound) - (Lisp_Cons))))->u.cdr;
  attrs[SOUND_FILE] = Fplist_get (sound, builtin_lisp_symbol (41));
  attrs[SOUND_DATA] = Fplist_get (sound, builtin_lisp_symbol (29));
  attrs[SOUND_DEVICE] = Fplist_get (sound, builtin_lisp_symbol (32));
  attrs[SOUND_VOLUME] = Fplist_get (sound, builtin_lisp_symbol (136));
  ...
  if (!STRINGP (attrs[SOUND_FILE])
    ...
    return 0;
# 384 "sound.c"
  if (!((attrs[SOUND_VOLUME]) == (builtin_lisp_symbol (0))))
    {
      if (((((enum Lisp_Type) ((attrs[SOUND_VOLUME]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
 {
   if (((attrs[SOUND_VOLUME]) >> INTTYPEBITS) < 0
       || ((attrs[SOUND_VOLUME]) >> INTTYPEBITS) > 100)
     return 0;
 }
      else if ((((enum Lisp_Type) ((attrs[SOUND_VOLUME]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float))
 {
 ...
 return 0;
  ...
  if (!((attrs[SOUND_DEVICE]) == (builtin_lisp_symbol (0)))
...
be2hl (u_int32_t value)
{
  ...
  value = (__extension__ ({ register unsigned int __v, __x = (value); if (__builtin_constant_p (__x)) __v = ((((__x) & 0xff000000) >> 24) | (((__x) & 0x00ff0000) >> 8) | (((__x) & 0x0000ff00) << 8) | (((__x) & 0x000000ff) << 24)); else __asm__ ("bswap %0" : "=r" (__v) : "0" (__x)); __v; }));
...
wav_play (struct sound *s, struct sound_device *sd)
{
  ...
  if (STRINGP (s->data))
  ...
  else
    {
      ...
      char *buffer = ((blksize) <= sa_avail ? (sa_avail -= (blksize), __builtin_alloca (blksize)) : (sa_must_free = 1, record_xmalloc (blksize)));
      lseek (s->fd, sizeof *header, 0);
      while (data_left > 0
...
au_play (struct sound *s, struct sound_device *sd)
{
  ...
  if (STRINGP (s->data))
  ...
  else
    {
      ...
      lseek (s->fd, header->data_offset, 0);
...
vox_open (struct sound_device *sd)
{
  ...
  char const *file = string_default (sd->file, "/dev/dsp");
  sd->fd = emacs_open (file, 01, 0);
  if (sd->fd < 0)
    sound_perror (file);
}
...
vox_configure (struct sound_device *sd)
{
  ...
  sigemptyset (&blocked);
  sigaddset (&blocked, 29);
  pthread_sigmask (0, &blocked, &oldset);


  val = sd->format;
  if (ioctl (sd->fd, (((2U|1U) << (((0 +8)+8)+14)) | ((('P')) << (0 +8)) | (((5)) << 0) | ((((sizeof(int)))) << ((0 +8)+8))), &sd->format) < 0
      || val != sd->format)
    sound_perror ("Could not set sound format");

  val = sd->channels != 1;
  if (ioctl (sd->fd, (((2U|1U) << (((0 +8)+8)+14)) | ((('P')) << (0 +8)) | (((3)) << 0) | ((((sizeof(int)))) << ((0 +8)+8))), &val) < 0
      || val != (sd->channels != 1))
  ...
  if (sd->sample_rate > 0)
    {
      val = sd->sample_rate;
      if (ioctl (sd->fd, (((2U|1U) << (((0 +8)+8)+14)) | ((('P')) << (0 +8)) | (((2)) << 0) | ((((sizeof(int)))) << ((0 +8)+8))), &sd->sample_rate) < 0)
  ...
  if (sd->volume > 0)
    {
      ...
      ioctl (sd->fd, (((2U|1U) << (((0 +8)+8)+14)) | ((('M')) << (0 +8)) | (((4)) << 0) | ((((sizeof(int)))) << ((0 +8)+8))), &volume);
    }

  turn_on_atimers (1);

  pthread_sigmask (2, &oldset, 0);
  ...
  if (sd->fd >= 0)
    {
      ...
      ioctl (sd->fd, (((0U) << (((0 +8)+8)+14)) | ((('P')) << (0 +8)) | (((1)) << 0) | ((0) << ((0 +8)+8))), ((void*)0));
  ...
  if (s->type == RIFF)
    {
      ...
      if (h->precision == 8)
 sd->format = 0x00000008;
      else if (h->precision == 16)
 sd->format = 0x00000010;
      else
...
# 1345 "sound.c"
static struct Lisp_Subr _Alignas (8) Splay_sound_internal = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fplay_sound_internal }, 1, 1, "play-sound-internal", 0, 0}; Lisp_Object Fplay_sound_internal
  ...
  (Lisp_Object sound)
{
  ...
  Lisp_Object file = builtin_lisp_symbol (0);
  ...
  char headerbuf[((sizeof (struct wav_header)) > (sizeof (struct au_header)) ? (sizeof (struct wav_header)) : (sizeof (struct au_header)))];
  current_sound->header = headerbuf;

  if (STRINGP (attrs[SOUND_FILE]))
    {

      current_sound->fd = openp (list1 (globals.f_Vdata_directory),
     attrs[SOUND_FILE], builtin_lisp_symbol (0), &file, builtin_lisp_symbol (0), 0);
      if (current_sound->fd < 0)
 ...
 = emacs_read (current_sound->fd, current_sound->header,
        ((sizeof (struct wav_header)) > (sizeof (struct au_header)) ? (sizeof (struct wav_header)) : (sizeof (struct au_header))));
 ...
 sound_perror ("Invalid sound file header");
  ...
  else
    {
      ...
      current_sound->header_size = ((((sizeof (struct wav_header)) > (sizeof (struct au_header)) ? (sizeof (struct wav_header)) : (sizeof (struct au_header)))) < (SBYTES (current_sound->data)) ? (((sizeof (struct wav_header)) > (sizeof (struct au_header)) ? (sizeof (struct wav_header)) : (sizeof (struct au_header)))) : (SBYTES (current_sound->data)));
  ...
  if (((((enum Lisp_Type) ((attrs[SOUND_VOLUME]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    current_sound_device->volume = ((attrs[SOUND_VOLUME]) >> INTTYPEBITS);
  else if ((((enum Lisp_Type) ((attrs[SOUND_VOLUME]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Float))
    current_sound_device->volume = XFLOAT_DATA (attrs[SOUND_VOLUME]) * 100;

  (Frun_hook_with_args) ((sizeof (((Lisp_Object []) {builtin_lisp_symbol (751), sound})) / sizeof (((Lisp_Object []) {builtin_lisp_symbol (751), sound}))[0]), ((Lisp_Object []) {builtin_lisp_symbol (751), sound}));
