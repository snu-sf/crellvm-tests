...
int
read_bytecode_char (_Bool unreadflag)
{
  if (unreadflag)
    {
...
# 81 "doc.c"
Lisp_Object
get_doc_string (Lisp_Object filepos, _Bool unibyte, _Bool definition)
{
  ...
  if (((((enum Lisp_Type) ((filepos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    {
      file = globals.f_Vdoc_file_name;
      pos = filepos;
    }
  else if ((((enum Lisp_Type) ((filepos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      file = (((void) (0 && ((((enum Lisp_Type) ((filepos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((filepos) - (Lisp_Cons))))->car;
      pos = (((void) (0 && ((((enum Lisp_Type) ((filepos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((filepos) - (Lisp_Cons))))->u.cdr;
    }
  else
    return builtin_lisp_symbol (0);

  position = ((((pos) >> INTTYPEBITS)) < 0 ? -(((pos) >> INTTYPEBITS)) : (((pos) >> INTTYPEBITS)));

  if (!STRINGP (globals.f_Vdoc_directory))
    return builtin_lisp_symbol (0);
  ...
  file = encode_file_name (file);
  Lisp_Object docdir
    = ((tem) == (builtin_lisp_symbol (0))) ? encode_file_name (globals.f_Vdoc_directory) : empty_unibyte_string;
  ptrdiff_t docdir_sizemax = SBYTES (docdir) + 1;

  docdir_sizemax = ((docdir_sizemax) > (sizeof sibling_etc) ? (docdir_sizemax) : (sizeof sibling_etc));

  name = ((docdir_sizemax + SBYTES (file)) <= sa_avail ? (sa_avail -= (docdir_sizemax + SBYTES (file)), __builtin_alloca (docdir_sizemax + SBYTES (file))) : (sa_must_free = 1, record_xmalloc (docdir_sizemax + SBYTES (file))));
  lispstpcpy (lispstpcpy (name, docdir), file);

  fd = emacs_open (name, 00, 0);
  if (fd < 0)
    {
      ...
      if (fd < 0)
 {
   ...
   Lisp_Object cannot_open = (USE_STACK_STRING ? (make_lisp_ptr ((&(union Aligned_String) {{strlen ("Cannot open doc string file \""), -1, 0, (unsigned char *) ("Cannot open doc string file \"")}}.s), Lisp_String)) : build_string (("Cannot open doc string file \"")));
   Lisp_Object quote_nl = (USE_STACK_STRING ? (make_lisp_ptr ((&(union Aligned_String) {{strlen ("\"\n"), -1, 0, (unsigned char *) ("\"\n")}}.s), Lisp_String)) : build_string (("\"\n")));
  ...
  offset = ((position) < (((1024) > (position % (8 * 1024)) ? (1024) : (position % (8 * 1024)))) ? (position) : (((1024) > (position % (8 * 1024)) ? (1024) : (position % (8 * 1024)))));
  if (((off_t) (! (! ((off_t) 0 < (off_t) -1)) ? (off_t) -1 : ((((off_t) 1 << (sizeof (off_t) * 8 - 2)) - 1) * 2 + 1))) < position
      || lseek (fd, position - offset, 0) < 0)
    error ("Position %""l""d out of range in doc string file \"%s\"",
    position, name);
      ...
      if (p1)
 {
  ...
  if ((((enum Lisp_Type) ((filepos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      int test = 1;
      ...
      if (*from == 1)
 {
   ...
   if (c == 1)
     ...
     *to++ = 037;
     ...
     {
       unsigned char uc = c;
       error ("Invalid data in documentation file -- %c followed by code %03o",
  ...
  if (definition)
    {
      ...
      return Fread (builtin_lisp_symbol (598));
    }
...
{
  if (((file) == (builtin_lisp_symbol (0))))
    Fsnarf_documentation (globals.f_Vdoc_file_name);
  else
    Fload (file, builtin_lisp_symbol (901), builtin_lisp_symbol (901), builtin_lisp_symbol (901), builtin_lisp_symbol (0));

  return 1;
}

static struct Lisp_Subr _Alignas (8) Sdocumentation = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fdocumentation }, 1, 2, "documentation", 0, 0}; Lisp_Object Fdocumentation
  ...
  (Lisp_Object function, Lisp_Object raw)
{
 ...
 documentation:
  ...
  doc = builtin_lisp_symbol (0);

  if ((((enum Lisp_Type) ((function) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
    {
      Lisp_Object tem = Fget (function, builtin_lisp_symbol (477));
      if (!((tem) == (builtin_lisp_symbol (0))))
 return Fdocumentation_property (function, builtin_lisp_symbol (477),
     raw);
    }

  fun = Findirect_function (function, builtin_lisp_symbol (0));
  if ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((((void) (0 && ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((fun) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (636))))
    fun = (((void) (0 && ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((fun) - (Lisp_Cons))))->u.cdr;
  if (SUBRP (fun))
    {
      if (XSUBR (fun)->doc == 0)
 return builtin_lisp_symbol (0);
 ...
 doc = ((EMACS_INT) (((EMACS_UINT) ((intptr_t) XSUBR (fun)->doc) << INTTYPEBITS) + Lisp_Int0));
    }
      ...
      else
 {
   ...
   if (STRINGP (tem))
     doc = tem;
   else if (NATNUMP (tem) || (((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
     doc = tem;
   else
     return builtin_lisp_symbol (0);
 }
  ...
  else if ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      funcar = (((void) (0 && ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((fun) - (Lisp_Cons))))->car;
      if (!(((enum Lisp_Type) ((funcar) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
 xsignal1 (builtin_lisp_symbol (570), fun);
      else if (((funcar) == (builtin_lisp_symbol (589))))
 return build_string ("Prefix command (definition is a keymap associating keystrokes with commands).");
      else if (((funcar) == (builtin_lisp_symbol (598)))
        || (((funcar) == (builtin_lisp_symbol (271))) && (fun = (((void) (0 && ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((fun) - (Lisp_Cons))))->u.cdr, 1))
        || ((funcar) == (builtin_lisp_symbol (191))))
 {
   ...
   else if ((NATNUMP (tem) || ((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tem) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)))
     && !(((((void) (0 && ((((enum Lisp_Type) ((tem1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tem1) - (Lisp_Cons))))->u.cdr) == (builtin_lisp_symbol (0))))
     doc = tem;
   else
     return builtin_lisp_symbol (0);
 }
 ...
 goto oops;
  ...
  if (((doc) == (((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)))))
    doc = builtin_lisp_symbol (0);
  if (((((enum Lisp_Type) ((doc) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) || (((enum Lisp_Type) ((doc) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      Lisp_Object tem;
      tem = get_doc_string (doc, 0, 0);
      if (((tem) == (builtin_lisp_symbol (0))) && try_reload)
 {
 ...
 doc = tem;
  ...
  if (((raw) == (builtin_lisp_symbol (0))))
    doc = Fsubstitute_command_keys (doc);
  return doc;
}

static struct Lisp_Subr _Alignas (8) Sdocumentation_property = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fdocumentation_property }, 2, 3, "documentation-property", 0, 0}; Lisp_Object Fdocumentation_property
# 439 "doc.c"
  (Lisp_Object symbol, Lisp_Object prop, Lisp_Object raw)
{
 ...
 documentation_property:
  ...
  if (((tem) == (((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)))))
    tem = builtin_lisp_symbol (0);
  if (((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) || ((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tem) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)))
    {
      Lisp_Object doc = tem;
      ...
      if (((tem) == (builtin_lisp_symbol (0))) && try_reload)
 {
   ...
   if (try_reload)
    ...
    tem = Feval (tem, builtin_lisp_symbol (0));

  if (((raw) == (builtin_lisp_symbol (0))) && STRINGP (tem))
...
store_function_docstring (Lisp_Object obj, ptrdiff_t offset)
{
  ...
  Lisp_Object fun = (((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol) ? (((void) (0 && ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol)))), (struct Lisp_Symbol *) ((intptr_t) (obj) - Lisp_Symbol + (char *) lispsym))->function : obj;
  ...
  if (SUBRP (fun))
  ...
  else if ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      ...
      tem = (((void) (0 && ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((fun) - (Lisp_Cons))))->car;
      if (((tem) == (builtin_lisp_symbol (598))) || ((tem) == (builtin_lisp_symbol (191)))
   || (((tem) == (builtin_lisp_symbol (271))) && (fun = (((void) (0 && ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((fun) - (Lisp_Cons))))->u.cdr, 1)))
 {
   tem = Fcdr (Fcdr (fun));
   if ((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tem) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
     ...
     XSETCAR (tem, ((EMACS_INT) (((EMACS_UINT) (offset) << INTTYPEBITS) + Lisp_Int0)));
 }
      else if (((tem) == (builtin_lisp_symbol (636))))
 store_function_docstring ((((void) (0 && ((((enum Lisp_Type) ((fun) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((fun) - (Lisp_Cons))))->u.cdr, offset);
    }
  ...
  else if (COMPILEDP (fun))
    {
      ...
      if ((ASIZE (fun) & PSEUDOVECTOR_SIZE_MASK) > COMPILED_DOC_STRING)
 ASET (fun, COMPILED_DOC_STRING, ((EMACS_INT) (((EMACS_UINT) (offset) << INTTYPEBITS) + Lisp_Int0)));
      else
 {
   Lisp_Object format = (USE_STACK_STRING ? (make_lisp_ptr ((&(union Aligned_String) {{strlen ("No docstring slot for %s"), -1, 0, (unsigned char *) ("No docstring slot for %s")}}.s), Lisp_String)) : build_string (("No docstring slot for %s")));
   (Fmessage) ((sizeof (((Lisp_Object []) {format, ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol) ? SYMBOL_NAME (obj) : build_string ("<anonymous>"))})) / sizeof (((Lisp_Object []) {format, ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol) ? SYMBOL_NAME (obj) : build_string ("<anonymous>"))}))[0]), ((Lisp_Object []) {format, ((((enum Lisp_Type) ((obj) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol) ? SYMBOL_NAME (obj) : build_string ("<anonymous>"))}));
...
static struct Lisp_Subr _Alignas (8) Ssnarf_documentation = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fsnarf_documentation }, 1, 1, "Snarf-documentation", 0, 0}; Lisp_Object Fsnarf_documentation
# 538 "doc.c"
  (Lisp_Object filename)
{
  ...
  if (((delayed_init) == (builtin_lisp_symbol (957)))) delayed_init = builtin_lisp_symbol (0);

  CHECK_STRING (filename);

  if

    (!((globals.f_Vpurify_flag) == (builtin_lisp_symbol (0))))
    ...
    {
      CHECK_STRING (globals.f_Vdoc_directory);
      dirname = SSDATA (globals.f_Vdoc_directory);
      dirlen = SBYTES (globals.f_Vdoc_directory);
    }

  count = SPECPDL_INDEX ();
  ptrdiff_t sa_avail = MAX_ALLOCA; ptrdiff_t sa_count = SPECPDL_INDEX (); _Bool sa_must_free = 0;
  name = ((dirlen + SBYTES (filename) + 1) <= sa_avail ? (sa_avail -= (dirlen + SBYTES (filename) + 1), __builtin_alloca (dirlen + SBYTES (filename) + 1)) : (sa_must_free = 1, record_xmalloc (dirlen + SBYTES (filename) + 1)));
  lispstpcpy (stpcpy (name, dirname), filename);


  if (((globals.f_Vbuild_files) == (builtin_lisp_symbol (0))))
    {
...
# 587 "doc.c" 2
      ...
      int i = (sizeof (buildobj) / sizeof (buildobj)[0]);
      while (0 <= --i)
 globals.f_Vbuild_files = Fcons (build_string (buildobj[i]), globals.f_Vbuild_files);
      globals.f_Vbuild_files = Fpurecopy (globals.f_Vbuild_files);
    }
  ...
  record_unwind_protect_int (close_file_unwind, fd);
  globals.f_Vdoc_file_name = filename;
  filled = 0;
  pos = 0;
  while (1)
    {
      ...
      if (p)
 {
          ...
          if (p[1] == 'S')
            {
              ...
              if (end - p > 4 && end[-2] == '.'
                  && (end[-1] == 'o' || end[-1] == 'c'))
                {
                  ...
                  char *fromfile = ((len + 1) <= sa_avail ? (sa_avail -= (len + 1), __builtin_alloca (len + 1)) : (sa_must_free = 1, record_xmalloc (len + 1)));
                  memcpy (fromfile, &p[2], len);
                  fromfile[len] = 0;
                  if (fromfile[len-1] == 'c')
                    fromfile[len-1] = 'o';

                  skip_file = ((Fmember (build_string (fromfile), globals.f_Vbuild_files)) == (builtin_lisp_symbol (0)));

                }
            }

   sym = oblookup (globals.f_Vobarray, p + 2,
   ...
   if (! skip_file && (((enum Lisp_Type) ((sym) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
     {
       ...
       if (p[1] == 'V')
  {
                  ...
                  if (!((Fboundp (sym)) == (builtin_lisp_symbol (0)))
                      || !((Fmemq (sym, delayed_init)) == (builtin_lisp_symbol (0))))
                    Fput (sym, builtin_lisp_symbol (992),
                          ((EMACS_INT) (((EMACS_UINT) ((pos + end + 1 - buf) * (end[1] == '*' ? -1 : 1)) << INTTYPEBITS) + Lisp_Int0)));
                ...
                {
                  if (!((Ffboundp (sym)) == (builtin_lisp_symbol (0))))
  ...
  error ("DOC file invalid at position %""l""d", pos);
     }
 }
      pos += end - buf;
      filled -= end - buf;
...
{
  if (!globals.f_text_quoting_flag)
    return 1;
  if (! (CHAR_TABLE_P (globals.f_Vstandard_display_table) && ((XCHAR_TABLE (globals.f_Vstandard_display_table)->purpose) == (builtin_lisp_symbol (346))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (globals.f_Vstandard_display_table)) == 6))
    return 0;
  Lisp_Object dv = ((((sizeof ((LEFT_SINGLE_QUOTATION_MARK) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((LEFT_SINGLE_QUOTATION_MARK) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((LEFT_SINGLE_QUOTATION_MARK) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((LEFT_SINGLE_QUOTATION_MARK) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? ((((XCHAR_TABLE (globals.f_Vstandard_display_table))->ascii) == (builtin_lisp_symbol (0))) ? (XCHAR_TABLE (globals.f_Vstandard_display_table))->defalt : (SUB_CHAR_TABLE_P ((XCHAR_TABLE (globals.f_Vstandard_display_table))->ascii) ? XSUB_CHAR_TABLE ((XCHAR_TABLE (globals.f_Vstandard_display_table))->ascii)->contents[LEFT_SINGLE_QUOTATION_MARK] : (XCHAR_TABLE (globals.f_Vstandard_display_table))->ascii)) : disp_char_vector ((XCHAR_TABLE (globals.f_Vstandard_display_table)), (LEFT_SINGLE_QUOTATION_MARK)));

  return (VECTORP (dv) && ASIZE (dv) == 1
   && ((AREF (dv, 0)) == (((EMACS_INT) (((EMACS_UINT) ('`') << INTTYPEBITS) + Lisp_Int0)))));
}
...
{
  if (((globals.f_Vtext_quoting_style) == (builtin_lisp_symbol (0)))
      ? default_to_grave_quoting_style ()
      : ((globals.f_Vtext_quoting_style) == (builtin_lisp_symbol (500))))
    return GRAVE_QUOTING_STYLE;
  else if (((globals.f_Vtext_quoting_style) == (builtin_lisp_symbol (881))))
    return STRAIGHT_QUOTING_STYLE;
  else
    return CURVE_QUOTING_STYLE;
}

static struct Lisp_Subr _Alignas (8) Ssubstitute_command_keys = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fsubstitute_command_keys }, 1, 1, "substitute-command-keys", 0, 0}; Lisp_Object Fsubstitute_command_keys
# 739 "doc.c"
  (Lisp_Object string)
{
  char *buf;
  _Bool changed = 0;
  _Bool nonquotes_changed = 0;
  unsigned char *strp;
  char *bufp;
  ptrdiff_t idx;
  ptrdiff_t bsize;
  ...
  CHECK_STRING (string);
  tem = builtin_lisp_symbol (0);
  keymap = builtin_lisp_symbol (0);
  name = builtin_lisp_symbol (0);
  ...
  keymap = globals.f_Voverriding_local_map;

  bsize = SBYTES (string);


  enum { EXTRA_ROOM = 20 };
  if (bsize <= ((ptrdiff_t) (((9223372036854775807L >> INTTYPEBITS)) < ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1) ? ((9223372036854775807L >> INTTYPEBITS)) : ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1))) - EXTRA_ROOM)
    bsize += EXTRA_ROOM;
      ...
      if (strp[0] == '\\' && strp[1] == '=')
 {
   ...
   changed = nonquotes_changed = 1;
   strp += 2;
   if (multibyte)
     {
       int len;

       (!((strp)[0] & 0x80) ? ((len) = 1, (strp)[0]) : ! ((strp)[0] & 0x20) ? ((len) = 2, (((((strp)[0] & 0x1F) << 6) | ((strp)[1] & 0x3F)) + (((unsigned char) (strp)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((strp)[0] & 0x10) ? ((len) = 3, ((((strp)[0] & 0x0F) << 12) | (((strp)[1] & 0x3F) << 6) | ((strp)[2] & 0x3F))) : string_char ((strp), ((void*)0), &len));
       if (len == 1)
  *bufp = *strp;
       else
      ...
      else if (strp[0] == '\\' && strp[1] == '[')
 {
   ...
   name = Fintern (make_string ((char *) start, length_byte), builtin_lisp_symbol (0));

 do_remap:
   tem = Fwhere_is_internal (name, keymap, builtin_lisp_symbol (901), builtin_lisp_symbol (0), builtin_lisp_symbol (0));

   if (VECTORP (tem) && ASIZE (tem) > 1
       && ((AREF (tem, 0)) == (builtin_lisp_symbol (805))) && (((enum Lisp_Type) ((AREF (tem, 1)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol)
       && follow_remap)
     {
       name = AREF (tem, 1);
       follow_remap = 0;
   ...
   if (((tem) == (builtin_lisp_symbol (0))))
     {
       ...
       if (((ptrdiff_t) (((9223372036854775807L >> INTTYPEBITS)) < ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1) ? ((9223372036854775807L >> INTTYPEBITS)) : ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1))) - 4 < bsize)
  string_overflow ();
  ...
  length = length_byte;
     ...
     {
       tem = Fkey_description (tem, builtin_lisp_symbol (0));
       goto subst_string;
     }
 }
      ...
      else if (strp[0] == '\\' && (strp[1] == '{' || strp[1] == '<'))
 {
   ...
   Lisp_Object active_maps = Fcurrent_active_maps (builtin_lisp_symbol (0), builtin_lisp_symbol (0));
   ...
   if (((tem) == (builtin_lisp_symbol (0))))
     {
       ...
       Lisp_Object msg_prefix = (USE_STACK_STRING ? (make_lisp_ptr ((&(union Aligned_String) {{strlen ("\nUses keymap `"), -1, 0, (unsigned char *) ("\nUses keymap `")}}.s), Lisp_String)) : build_string (("\nUses keymap `")));
       insert1 (Fsubstitute_command_keys (msg_prefix));
       insert_from_string (name, 0, 0,
      SCHARS (name),
      SBYTES (name), 1);
       Lisp_Object msg_suffix = (USE_STACK_STRING ? (make_lisp_ptr ((&(union Aligned_String) {{strlen ("', which is not currently defined.\n"), -1, 0, (unsigned char *) ("', which is not currently defined.\n")}}.s), Lisp_String)) : build_string (("', which is not currently defined.\n")));
       insert1 (Fsubstitute_command_keys (msg_suffix));
       if (start[-1] == '<') keymap = builtin_lisp_symbol (0);
     }
   else if (start[-1] == '<')
     keymap = tem;
   else
     ...
     builtin_lisp_symbol (0), 0, 1, 0, 0, 1);
     }
   tem = Fbuffer_string ();
   Ferase_buffer ();
 ...
 subst_quote:
   ...
   {
     ptrdiff_t offset = bufp - buf;
     if (((ptrdiff_t) (((9223372036854775807L >> INTTYPEBITS)) < ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1) ? ((9223372036854775807L >> INTTYPEBITS)) : ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1))) - length_byte < bsize)
       string_overflow ();
 ...
 {
   start = (unsigned char const *) (strp[0] == '`' ? "\xE2\x80\x98" : "\xE2\x80\x99");
   length_byte = sizeof "\xE2\x80\x98" - 1;
   if (multibyte || pure_ascii)
     length = 1;
   else
     length = length_byte;
 ...
 *bufp++ = *strp++, nchars++;
 ...
 {
   int len;
   int ch = (!((strp)[0] & 0x80) ? ((len) = 1, (strp)[0]) : ! ((strp)[0] & 0x20) ? ((len) = 2, (((((strp)[0] & 0x1F) << 6) | ((strp)[1] & 0x3F)) + (((unsigned char) (strp)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((strp)[0] & 0x10) ? ((len) = 3, ((((strp)[0] & 0x0F) << 12) | (((strp)[1] & 0x3F) << 6) | ((strp)[2] & 0x3F))) : string_char ((strp), ((void*)0), &len));
...
syms_of_doc (void)
{
  ...
  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "internal-doc-file-name", &globals.f_Vdoc_file_name); } while (0);

  globals.f_Vdoc_file_name = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "build-files", &globals.f_Vbuild_files); } while (0);

  globals.f_Vbuild_files = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "text-quoting-style", &globals.f_Vtext_quoting_style); } while (0);
  ...
  globals.f_Vtext_quoting_style = builtin_lisp_symbol (0);

  do { static struct Lisp_Boolfwd b_fwd; defvar_bool (&b_fwd, "internal--text-quoting-flag", &globals.f_text_quoting_flag); } while (0);
