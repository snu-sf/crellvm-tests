...
{
  { ((void*)0), 0, 0, 0, 0, 0 },
  { question_mark_bits, (sizeof (question_mark_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { exclamation_mark_bits, (sizeof (exclamation_mark_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { left_arrow_bits, (sizeof (left_arrow_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { right_arrow_bits, (sizeof (right_arrow_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { up_arrow_bits, (sizeof (up_arrow_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_TOP, 0 },
  { down_arrow_bits, (sizeof (down_arrow_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_BOTTOM, 0 },
  { left_curly_arrow_bits, (sizeof (left_curly_arrow_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { right_curly_arrow_bits, (sizeof (right_curly_arrow_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { left_triangle_bits, (sizeof (left_triangle_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { right_triangle_bits, (sizeof (right_triangle_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { top_left_angle_bits, (sizeof (top_left_angle_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_TOP, 0 },
  { top_right_angle_bits, (sizeof (top_right_angle_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_TOP, 0 },
  { bottom_left_angle_bits, (sizeof (bottom_left_angle_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_BOTTOM, 0 },
  { bottom_right_angle_bits, (sizeof (bottom_right_angle_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_BOTTOM, 0 },
  { left_bracket_bits, (sizeof (left_bracket_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { right_bracket_bits, (sizeof (right_bracket_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { filled_rectangle_bits, (sizeof (filled_rectangle_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { hollow_rectangle_bits, (sizeof (hollow_rectangle_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { filled_square_bits, (sizeof (filled_square_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { hollow_square_bits, (sizeof (hollow_square_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { vertical_bar_bits, (sizeof (vertical_bar_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_CENTER, 0 },
  { horizontal_bar_bits, (sizeof (horizontal_bar_bits)/(sizeof (unsigned short))), 8, 0, ALIGN_BITMAP_BOTTOM, 0 },
  { empty_line_bits, (sizeof (empty_line_bits)/(sizeof (unsigned short))), 8, 3, ALIGN_BITMAP_TOP, 0 },
};
...
int max_used_fringe_bitmap = (sizeof (standard_bitmaps) / sizeof (standard_bitmaps)[0]);
...
lookup_fringe_bitmap (Lisp_Object bitmap)
{
  ...
  bitmap = Fget (bitmap, builtin_lisp_symbol (467));
  if (!((((enum Lisp_Type) ((bitmap) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    return 0;

  bn = ((bitmap) >> INTTYPEBITS);
  if (bn > 0
      && bn < max_used_fringe_bitmap
      && (bn < (sizeof (standard_bitmaps) / sizeof (standard_bitmaps)[0])
   || fringe_bitmaps[bn] != ((void*)0)))
    return bn;
...
get_fringe_bitmap_name (int bn)
{
  ...
  bitmaps = globals.f_Vfringe_bitmaps;
  num = ((EMACS_INT) (((EMACS_UINT) (bn) << INTTYPEBITS) + Lisp_Int0));

  while ((((enum Lisp_Type) ((bitmaps) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      Lisp_Object bitmap = (((void) (0 && ((((enum Lisp_Type) ((bitmaps) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bitmaps) - (Lisp_Cons))))->car;
      if (((num) == (Fget (bitmap, builtin_lisp_symbol (467)))))
 return bitmap;
      bitmaps = (((void) (0 && ((((enum Lisp_Type) ((bitmaps) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bitmaps) - (Lisp_Cons))))->u.cdr;
    }
...
get_fringe_bitmap_data (int bn)
{
  ...
  if (fb == ((void*)0))
    fb = &standard_bitmaps[bn < (sizeof (standard_bitmaps) / sizeof (standard_bitmaps)[0])
      ? bn : 1];
...
{
  struct frame *f = (((void) (0 && (FRAMEP (((w)->frame))))), (struct frame *) ((void *) (intptr_t) ((((w)->frame)) - (Lisp_Vectorlike))));
  struct draw_fringe_bitmap_params p;
  struct fringe_bitmap *fb;
  int period;
  ...
  if (face_id == DEFAULT_FACE_ID)
    {
      ...
      face_id = ((face) == (builtin_lisp_symbol (0))) ? lookup_named_face (f, builtin_lisp_symbol (467), 0)
 ...
 face_id = FRINGE_FACE_ID;
  ...
  p.y = ((row->y) + (((0 || 0) ? 0 : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->internal_border_width)) + (w)->pixel_top)) + offset;
  ...
  p.face = ((((sizeof ((face_id) + 0)) > (sizeof (((f)->face_cache->used) + 0)) ? (sizeof ((face_id) + 0)) : (sizeof (((f)->face_cache->used) + 0))) <= sizeof (unsigned) ? ((face_id) + (unsigned) 0) < (((f)->face_cache->used) + (unsigned) 0) : ((face_id) + (uintmax_t) 0) < (((f)->face_cache->used) + (uintmax_t) 0)) ? (f)->face_cache->faces_by_id[face_id] : ((void*)0));
  ...
  p.bx = -1;
  header_line_height = ((BUFFERP ((w)->contents) ? (!((w)->mini) && !(w)->pseudo_window_p && ((((void) (0 && (FRAMEP (((w)->frame))))), (struct frame *) ((void *) (intptr_t) ((((w)->frame)) - (Lisp_Vectorlike)))))->wants_modeline && !((((XBUFFER ((w)->contents))-> header_line_format_)) == (builtin_lisp_symbol (0))) && ((w)->pixel_height > ((BUFFERP ((w)->contents) ? (!((w)->mini) && !(w)->pseudo_window_p && ((((void) (0 && (FRAMEP (((w)->frame))))), (struct frame *) ((void *) (intptr_t) ((((w)->frame)) - (Lisp_Vectorlike)))))->wants_modeline && !((((XBUFFER ((w)->contents))-> mode_line_format_)) == (builtin_lisp_symbol (0))) && (w)->pixel_height > (((((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike))))))->line_height))) : 0) ? (2 * (((((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike))))))->line_height))) : (((((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike))))))->line_height))))) : 0) ? (w->header_line_height >= 0 ? w->header_line_height : (w->header_line_height = (((w->current_matrix) && (w->current_matrix)->rows ? (w->current_matrix)->rows->height : 0) ? ((w->current_matrix) && (w->current_matrix)->rows ? (w->current_matrix)->rows->height : 0) : estimate_mode_line_height ((((void) (0 && (FRAMEP (w->frame)))), (struct frame *) ((void *) (intptr_t) ((w->frame) - (Lisp_Vectorlike)))), HEADER_LINE_FACE_ID)))) : 0);
  p.by = ((((header_line_height) > (row->y) ? (header_line_height) : (row->y))) + (((0 || 0) ? 0 : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->internal_border_width)) + (w)->pixel_top));
  p.ny = row->visible_height;
  if (left_p)
    {
      int wd = (w->left_fringe_width >= 0 ? w->left_fringe_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->left_fringe_width));
      int x = window_box_left (w, (((w)->fringes_outside_margins)
       ? LEFT_MARGIN_AREA
       : TEXT_AREA));
      if (p.wd > wd)
 p.wd = wd;
      ...
      if (p.wd < wd || p.y > p.by || p.y + p.h < p.by + p.ny)
 {
   ...
   wd -= ((!((w)->pixel_left == 0)
    ...
    && !((f)->right_divider_width)
    && !(((((w)->pseudo_window_p) ? vertical_scroll_bar_none : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (901))) ? ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->vertical_scroll_bar_type) : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (607))) ? vertical_scroll_bar_left : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (811))) ? vertical_scroll_bar_right : vertical_scroll_bar_none) == vertical_scroll_bar_left) || ((((w)->pseudo_window_p) ? vertical_scroll_bar_none : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (901))) ? ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->vertical_scroll_bar_type) : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (607))) ? vertical_scroll_bar_left : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (811))) ? vertical_scroll_bar_right : vertical_scroll_bar_none) == vertical_scroll_bar_right))
   ...
   p.nx = wd;
    ...
    (((w)->fringes_outside_margins)
     ? RIGHT_MARGIN_AREA
     : TEXT_AREA));
      int wd = (w->right_fringe_width >= 0 ? w->right_fringe_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->right_fringe_width));
      if (p.wd > wd)
 p.wd = wd;
      p.x = x + (wd - p.wd) / 2;
      ...
      if (p.wd < wd || p.y > p.by || p.y + p.h < p.by + p.ny)
 {
  ...
  if (p.x >= (((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->internal_border_width) + ((w)->pixel_left + (((((w)->pseudo_window_p) ? vertical_scroll_bar_none : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (901))) ? ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->vertical_scroll_bar_type) : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (607))) ? vertical_scroll_bar_left : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (811))) ? vertical_scroll_bar_right : vertical_scroll_bar_none) == vertical_scroll_bar_left) ? (w->scroll_bar_width >= 0 ? w->scroll_bar_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->config_scroll_bar_width)) : 0)))
      && (p.x + p.wd) <= (((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->internal_border_width) + ((w)->pixel_left + (((((w)->pseudo_window_p) ? vertical_scroll_bar_none : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (901))) ? ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->vertical_scroll_bar_type) : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (607))) ? vertical_scroll_bar_left : ((w->vertical_scroll_bar_type) == (builtin_lisp_symbol (811))) ? vertical_scroll_bar_right : vertical_scroll_bar_none) == vertical_scroll_bar_left) ? (w->scroll_bar_width >= 0 ? w->scroll_bar_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->config_scroll_bar_width)) : 0))) + (w)->pixel_width)
    ((f)->terminal->rif)->draw_fringe_bitmap (w, row, &p);
}

static int
get_logical_cursor_bitmap (struct window *w, Lisp_Object cursor)
{
  Lisp_Object cmap, bm = builtin_lisp_symbol (0);

  if ((cmap = ((XBUFFER (w->contents))-> fringe_cursor_alist_)), !((cmap) == (builtin_lisp_symbol (0))))
    {
      bm = Fassq (cursor, cmap);
      if ((((enum Lisp_Type) ((bm) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 {
   if ((bm = (((void) (0 && ((((enum Lisp_Type) ((bm) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bm) - (Lisp_Cons))))->u.cdr), ((bm) == (builtin_lisp_symbol (0))))
     return 0;
   return lookup_fringe_bitmap (bm);
 }
    }
  if (((cmap) == (((&buffer_defaults)-> fringe_cursor_alist_))))
    return 0;
  bm = Fassq (cursor, ((&buffer_defaults)-> fringe_cursor_alist_));
  if (!(((enum Lisp_Type) ((bm) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) || ((bm = (((void) (0 && ((((enum Lisp_Type) ((bm) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bm) - (Lisp_Cons))))->u.cdr), ((bm) == (builtin_lisp_symbol (0)))))
    return 0;
  return lookup_fringe_bitmap (bm);
}
...
{
  Lisp_Object cmap, bm1 = builtin_lisp_symbol (0), bm2 = builtin_lisp_symbol (0), bm;
  EMACS_INT ln1 = 0, ln2 = 0;
  int ix1 = right_p;
  int ix2 = ix1 + (partial_p ? 2 : 0);
# 737 "fringe.c"
  if ((cmap = ((XBUFFER (w->contents))-> fringe_indicator_alist_)), !((cmap) == (builtin_lisp_symbol (0))))
    {
      bm1 = Fassq (bitmap, cmap);
      if ((((enum Lisp_Type) ((bm1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 {
   if ((bm1 = (((void) (0 && ((((enum Lisp_Type) ((bm1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bm1) - (Lisp_Cons))))->u.cdr), ((bm1) == (builtin_lisp_symbol (0))))
     return 0;
   if ((((enum Lisp_Type) ((bm1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
     {
       ln1 = ((Flength (bm1)) >> INTTYPEBITS);
       if (partial_p)
  {
    if (ln1 > ix2)
      {
        bm = Fnth (((EMACS_INT) (((EMACS_UINT) (ix2) << INTTYPEBITS) + Lisp_Int0)), bm1);
        if (!((bm) == (builtin_lisp_symbol (901))))
   goto found;
      }
  }
       else
  {
    if (ln1 > ix1)
      {
        bm = Fnth (((EMACS_INT) (((EMACS_UINT) (ix1) << INTTYPEBITS) + Lisp_Int0)), bm1);
        if (!((bm) == (builtin_lisp_symbol (901))))
   goto found;
      }
  }
     }
   else if ((bm = bm1, !((bm) == (builtin_lisp_symbol (901)))))
     goto found;
 }
    }

  if (!((cmap) == (((&buffer_defaults)-> fringe_indicator_alist_)))
      && !((((&buffer_defaults)-> fringe_indicator_alist_)) == (builtin_lisp_symbol (0))))
    {
      bm2 = Fassq (bitmap, ((&buffer_defaults)-> fringe_indicator_alist_));
      if ((((enum Lisp_Type) ((bm2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 {
   if ((bm2 = (((void) (0 && ((((enum Lisp_Type) ((bm2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((bm2) - (Lisp_Cons))))->u.cdr), !((bm2) == (builtin_lisp_symbol (0))))
     {
       if ((((enum Lisp_Type) ((bm2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
  {
    ln2 = ((Flength (bm2)) >> INTTYPEBITS);
    if (partial_p)
      {
        if (ln2 > ix2)
   {
     bm = Fnth (((EMACS_INT) (((EMACS_UINT) (ix2) << INTTYPEBITS) + Lisp_Int0)), bm2);
     if (!((bm) == (builtin_lisp_symbol (901))))
       goto found;
   }
      }
 ...
 goto found;
  ...
  if (ln2 > ix1)
    {
      bm = Fnth (((EMACS_INT) (((EMACS_UINT) (ix1) << INTTYPEBITS) + Lisp_Int0)), bm2);
      if (!((bm) == (builtin_lisp_symbol (901))))
 goto found;
      return 0;
    }
  else if ((bm = bm2, ((bm) == (builtin_lisp_symbol (0)))))
    return 0;
...
draw_fringe_bitmap (struct window *w, struct glyph_row *row, int left_p)
{
  ...
  if (left_p == row->reversed_p && row->cursor_in_fringe_p)
    {
      Lisp_Object cursor = builtin_lisp_symbol (0);

      switch (w->phys_cursor_type)
 {
 case HOLLOW_BOX_CURSOR:
   if (row->visible_height >= (sizeof (hollow_rectangle_bits)/(sizeof (unsigned short))))
     cursor = builtin_lisp_symbol (521);
   else
     cursor = builtin_lisp_symbol (522);
   break;
 case FILLED_BOX_CURSOR:
   cursor = builtin_lisp_symbol (218);
   break;
 case BAR_CURSOR:
   cursor = builtin_lisp_symbol (196);
   break;
 case HBAR_CURSOR:
   cursor = builtin_lisp_symbol (512);
   break;
 case NO_CURSOR:
 default:
   ...
   break;
      ...
      if (!((cursor) == (builtin_lisp_symbol (0))))
 {
   int bm = get_logical_cursor_bitmap (w, cursor);
   if (bm != 0)
     {
       draw_fringe_bitmap_1 (w, row, left_p, 2, bm);
       overlay = ((cursor) == (builtin_lisp_symbol (218))) ? 3 : 1;
     }
 }
    }

  draw_fringe_bitmap_1 (w, row, left_p, overlay, 0);

  if (left_p && row->overlay_arrow_bitmap != 0)
...
draw_row_fringe_bitmaps (struct window *w, struct glyph_row *row)
{
  ...
  if ((w->left_fringe_width >= 0 ? w->left_fringe_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->left_fringe_width)) != 0)
    draw_fringe_bitmap (w, row, 1);

  if ((w->right_fringe_width >= 0 ? w->right_fringe_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->right_fringe_width)) != 0)
    draw_fringe_bitmap (w, row, 0);
}
# 900 "fringe.c"
_Bool
draw_window_fringes (struct window *w, _Bool no_fringe_p)
{
  struct glyph_row *row;
  ...
  if (no_fringe_p
      && ((w->left_fringe_width >= 0 ? w->left_fringe_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->left_fringe_width)) == 0
   || (w->right_fringe_width >= 0 ? w->right_fringe_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->right_fringe_width)) == 0))
    updated_p = 1;
...
_Bool
update_window_fringes (struct window *w, _Bool keep_current_p)
{
  ...
  int y;
  _Bool redraw_p = 0;
  Lisp_Object boundary_top = builtin_lisp_symbol (0), boundary_bot = builtin_lisp_symbol (0);
  Lisp_Object arrow_top = builtin_lisp_symbol (0), arrow_bot = builtin_lisp_symbol (0);
  Lisp_Object empty_pos;
  Lisp_Object ind = builtin_lisp_symbol (0);

  int bitmap_cache[(8*4)];
  ...
  if (!((w)->mini)
      && (ind = ((XBUFFER (w->contents))-> indicate_buffer_boundaries_), !((ind) == (builtin_lisp_symbol (0)))))
    {
      if (((ind) == (builtin_lisp_symbol (607))) || ((ind) == (builtin_lisp_symbol (811))))
 boundary_top = boundary_bot = arrow_top = arrow_bot = ind;
      else if ((((enum Lisp_Type) ((ind) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((ind) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((ind) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 {
   Lisp_Object pos;
   if (pos = Fassq (builtin_lisp_symbol (901), ind), !((pos) == (builtin_lisp_symbol (0))))
     boundary_top = boundary_bot = arrow_top = arrow_bot = (((void) (0 && ((((enum Lisp_Type) ((pos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((pos) - (Lisp_Cons))))->u.cdr;
   if (pos = Fassq (builtin_lisp_symbol (928), ind), !((pos) == (builtin_lisp_symbol (0))))
     boundary_top = (((void) (0 && ((((enum Lisp_Type) ((pos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((pos) - (Lisp_Cons))))->u.cdr;
   if (pos = Fassq (builtin_lisp_symbol (213), ind), !((pos) == (builtin_lisp_symbol (0))))
     boundary_bot = (((void) (0 && ((((enum Lisp_Type) ((pos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((pos) - (Lisp_Cons))))->u.cdr;
   if (pos = Fassq (builtin_lisp_symbol (977), ind), !((pos) == (builtin_lisp_symbol (0))))
     arrow_top = (((void) (0 && ((((enum Lisp_Type) ((pos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((pos) - (Lisp_Cons))))->u.cdr;
   if (pos = Fassq (builtin_lisp_symbol (352), ind), !((pos) == (builtin_lisp_symbol (0))))
     arrow_bot = (((void) (0 && ((((enum Lisp_Type) ((pos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((pos) - (Lisp_Cons))))->u.cdr;
 }
      else

 boundary_top = boundary_bot = builtin_lisp_symbol (607);
    }

  top_ind_rn = bot_ind_rn = -1;
  if (!((ind) == (builtin_lisp_symbol (0))))
    {
    ...
    y += row->height, ++rn)
 {
  ...
  {
    if (((row)->minpos.charpos) <= (XBUFFER (w->contents) == current_buffer ? (current_buffer->begv) : ((((XBUFFER (w->contents))-> begv_marker_)) == (builtin_lisp_symbol (0))) ? XBUFFER (w->contents)->begv : marker_position (((XBUFFER (w->contents))-> begv_marker_)))
        && !((((row))->height != ((row))->visible_height) && (((row))->y < ((BUFFERP ((((w)))->contents) ? (!((((w)))->mini) && !(((w)))->pseudo_window_p && ((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike)))))->wants_modeline && !((((XBUFFER ((((w)))->contents))-> header_line_format_)) == (builtin_lisp_symbol (0))) && ((((w)))->pixel_height > ((BUFFERP ((((w)))->contents) ? (!((((w)))->mini) && !(((w)))->pseudo_window_p && ((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike)))))->wants_modeline && !((((XBUFFER ((((w)))->contents))-> mode_line_format_)) == (builtin_lisp_symbol (0))) && (((w)))->pixel_height > (((((((void) (0 && (FRAMEP (((((((w)))))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((((w)))))->frame)) - (Lisp_Vectorlike))))))->line_height))) : 0) ? (2 * (((((((void) (0 && (FRAMEP (((((((w)))))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((((w)))))->frame)) - (Lisp_Vectorlike))))))->line_height))) : (((((((void) (0 && (FRAMEP (((((((w)))))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((((w)))))->frame)) - (Lisp_Vectorlike))))))->line_height))))) : 0) ? (((w))->header_line_height >= 0 ? ((w))->header_line_height : (((w))->header_line_height = (((((w))->current_matrix) && (((w))->current_matrix)->rows ? (((w))->current_matrix)->rows->height : 0) ? ((((w))->current_matrix) && (((w))->current_matrix)->rows ? (((w))->current_matrix)->rows->height : 0) : estimate_mode_line_height ((((void) (0 && (FRAMEP (((w))->frame)))), (struct frame *) ((void *) (intptr_t) ((((w))->frame) - (Lisp_Vectorlike)))), HEADER_LINE_FACE_ID)))) : 0))))
      row->indicate_bob_p = !((boundary_top) == (builtin_lisp_symbol (0)));
    else
      row->indicate_top_line_p = !((arrow_top) == (builtin_lisp_symbol (0)));
    top_ind_rn = rn;
  }

       if (bot_ind_rn < 0)
  {
    if (((row)->maxpos.charpos) >= (XBUFFER (w->contents) == current_buffer ? (current_buffer->zv) : ((((XBUFFER (w->contents))-> zv_marker_)) == (builtin_lisp_symbol (0))) ? XBUFFER (w->contents)->zv : marker_position (((XBUFFER (w->contents))-> zv_marker_)))
        && !((((row))->height != ((row))->visible_height) && ((((row))->y + ((row))->height - ((row))->extra_line_spacing) > ((((w)))->pixel_height - ((((((((w)))->pixel_top + (((w)))->pixel_height) == (((XWINDOW (((((void) (0 && (FRAMEP ((((((w))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((w))))->frame)) - (Lisp_Vectorlike)))))->root_window))->pixel_top + (XWINDOW (((((void) (0 && (FRAMEP ((((((w))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((w))))->frame)) - (Lisp_Vectorlike)))))->root_window))->pixel_height))) && (((XWINDOW (((((void) (0 && (FRAMEP ((((((w))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((w))))->frame)) - (Lisp_Vectorlike)))))->root_window))->next) == (builtin_lisp_symbol (0)))) || (((((w)))->prev) == (((((void) (0 && (FRAMEP ((((((w))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((w))))->frame)) - (Lisp_Vectorlike)))))->root_window)) || (((w)))->pseudo_window_p) ? 0 : ((((((void) (0 && (FRAMEP ((((((w))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((w))))->frame)) - (Lisp_Vectorlike))))))->bottom_divider_width)) - (((((((w)))->pseudo_window_p) || (((((w)))->mini) && (((((w))->prev) == (((((void) (0 && (FRAMEP ((((((w))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((w))))->frame)) - (Lisp_Vectorlike)))))->root_window))))) ? 0 : ((((w))->horizontal_scroll_bar_type) == (builtin_lisp_symbol (901))) ? ((((((void) (0 && (FRAMEP ((((((w))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((w))))->frame)) - (Lisp_Vectorlike))))))->horizontal_scroll_bars) : ((((w))->horizontal_scroll_bar_type) == (builtin_lisp_symbol (213))) ? 1 : 0) ? (((w))->scroll_bar_height >= 0 ? ((w))->scroll_bar_height : ((((((void) (0 && (FRAMEP ((((((w))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((w))))->frame)) - (Lisp_Vectorlike))))))->config_scroll_bar_height)) : 0) - ((BUFFERP (((((w))))->contents) ? (!(((((w))))->mini) && !((((w))))->pseudo_window_p && ((((void) (0 && (FRAMEP ((((((w))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((w))))->frame)) - (Lisp_Vectorlike)))))->wants_modeline && !((((XBUFFER (((((w))))->contents))-> mode_line_format_)) == (builtin_lisp_symbol (0))) && ((((w))))->pixel_height > (((((((void) (0 && (FRAMEP ((((((((w))))))->frame))))), (struct frame *) ((void *) (intptr_t) (((((((((w))))))->frame)) - (Lisp_Vectorlike))))))->line_height))) : 0) ? (((w))->mode_line_height >= 0 ? ((w))->mode_line_height : (((w))->mode_line_height = (((((w))->current_matrix) && (((w))->current_matrix)->rows ? ((((w))->current_matrix)->rows + (((w))->current_matrix)->nrows - 1)->height : 0) ? ((((w))->current_matrix) && (((w))->current_matrix)->rows ? ((((w))->current_matrix)->rows + (((w))->current_matrix)->nrows - 1)->height : 0) : estimate_mode_line_height ((((void) (0 && (FRAMEP (((w))->frame)))), (struct frame *) ((void *) (intptr_t) ((((w))->frame) - (Lisp_Vectorlike)))), (((!globals.f_mode_line_in_non_selected_windows || ((((w)))) == XWINDOW (selected_window) || (minibuf_level > 0 && !((minibuf_selected_window) == (builtin_lisp_symbol (0))) && (XWINDOW (selected_window)) == XWINDOW (minibuf_window) && ((((w)))) == XWINDOW (minibuf_selected_window))) ? MODE_LINE_FACE_ID : MODE_LINE_INACTIVE_FACE_ID)))))) : 0)))))
      row->indicate_eob_p = !((boundary_bot) == (builtin_lisp_symbol (0))), bot_ind_rn = rn;
    else if (y + row->height >= yb)
      row->indicate_bottom_line_p = !((arrow_bot) == (builtin_lisp_symbol (0))), bot_ind_rn = rn;
  }
     }
 }
    }

  empty_pos = ((XBUFFER (w->contents))-> indicate_empty_lines_);
  if (!((empty_pos) == (builtin_lisp_symbol (0))) && !((empty_pos) == (builtin_lisp_symbol (811))))
    empty_pos = (w->left_fringe_width >= 0 ? w->left_fringe_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->left_fringe_width)) == 0 ? builtin_lisp_symbol (811) : builtin_lisp_symbol (607);
...
# 1048 "fringe.c"
 ...
 {
   if (((boundary_top) == (builtin_lisp_symbol (607))))
     bn = ((row->indicate_eob_p && ((boundary_bot) == (builtin_lisp_symbol (607))))
    ? (bitmap_cache[1*4+row->ends_at_zv_p] >= 0 ? bitmap_cache[1*4+row->ends_at_zv_p] : (bitmap_cache[1*4+row->ends_at_zv_p] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (929), 0, row->ends_at_zv_p)))
    : (bitmap_cache[2*4+0] >= 0 ? bitmap_cache[2*4+0] : (bitmap_cache[2*4+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (928), 0, 0))));
   else
     bn = ((row->indicate_eob_p && ((boundary_bot) == (builtin_lisp_symbol (811))))
    ? (bitmap_cache[1*4+2+row->ends_at_zv_p] >= 0 ? bitmap_cache[1*4+2+row->ends_at_zv_p] : (bitmap_cache[1*4+2+row->ends_at_zv_p] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (929), 1, row->ends_at_zv_p)))
    : (bitmap_cache[2*4+2+0] >= 0 ? bitmap_cache[2*4+2+0] : (bitmap_cache[2*4+2+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (928), 1, 0))));
 }
      else if (row->indicate_top_line_p)
 {
   if (((arrow_top) == (builtin_lisp_symbol (607))))
     bn = (bitmap_cache[6*4+0] >= 0 ? bitmap_cache[6*4+0] : (bitmap_cache[6*4+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (977), 0, 0)));
   else
     bn = (bitmap_cache[6*4+2+0] >= 0 ? bitmap_cache[6*4+2+0] : (bitmap_cache[6*4+2+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (977), 1, 0)));
 }
 ...
 {
   if (((boundary_bot) == (builtin_lisp_symbol (607))))
     bn = (bitmap_cache[3*4+row->ends_at_zv_p] >= 0 ? bitmap_cache[3*4+row->ends_at_zv_p] : (bitmap_cache[3*4+row->ends_at_zv_p] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (213), 0, row->ends_at_zv_p)));
   else
     bn = (bitmap_cache[3*4+2+row->ends_at_zv_p] >= 0 ? bitmap_cache[3*4+2+row->ends_at_zv_p] : (bitmap_cache[3*4+2+row->ends_at_zv_p] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (213), 1, row->ends_at_zv_p)));
 }
      else if (row->indicate_bottom_line_p)
 {
   if (((arrow_bot) == (builtin_lisp_symbol (607))))
     bn = (bitmap_cache[7*4+0] >= 0 ? bitmap_cache[7*4+0] : (bitmap_cache[7*4+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (352), 0, 0)));
   else
     bn = (bitmap_cache[7*4+2+0] >= 0 ? bitmap_cache[7*4+2+0] : (bitmap_cache[7*4+2+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (352), 1, 0)));
 }
   ...
   if (fb->align == ALIGN_BITMAP_BOTTOM && fb->period == 0)
     {
       ...
       if (bot_ind_min_y < ((BUFFERP ((w)->contents) ? (!((w)->mini) && !(w)->pseudo_window_p && ((((void) (0 && (FRAMEP (((w)->frame))))), (struct frame *) ((void *) (intptr_t) ((((w)->frame)) - (Lisp_Vectorlike)))))->wants_modeline && !((((XBUFFER ((w)->contents))-> header_line_format_)) == (builtin_lisp_symbol (0))) && ((w)->pixel_height > ((BUFFERP ((w)->contents) ? (!((w)->mini) && !(w)->pseudo_window_p && ((((void) (0 && (FRAMEP (((w)->frame))))), (struct frame *) ((void *) (intptr_t) ((((w)->frame)) - (Lisp_Vectorlike)))))->wants_modeline && !((((XBUFFER ((w)->contents))-> mode_line_format_)) == (builtin_lisp_symbol (0))) && (w)->pixel_height > (((((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike))))))->line_height))) : 0) ? (2 * (((((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike))))))->line_height))) : (((((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike))))))->line_height))))) : 0) ? (w->header_line_height >= 0 ? w->header_line_height : (w->header_line_height = (((w->current_matrix) && (w->current_matrix)->rows ? (w->current_matrix)->rows->height : 0) ? ((w->current_matrix) && (w->current_matrix)->rows ? (w->current_matrix)->rows->height : 0) : estimate_mode_line_height ((((void) (0 && (FRAMEP (w->frame)))), (struct frame *) ((void *) (intptr_t) ((w->frame) - (Lisp_Vectorlike)))), HEADER_LINE_FACE_ID)))) : 0))
  bot_ind_min_y = ((BUFFERP ((w)->contents) ? (!((w)->mini) && !(w)->pseudo_window_p && ((((void) (0 && (FRAMEP (((w)->frame))))), (struct frame *) ((void *) (intptr_t) ((((w)->frame)) - (Lisp_Vectorlike)))))->wants_modeline && !((((XBUFFER ((w)->contents))-> header_line_format_)) == (builtin_lisp_symbol (0))) && ((w)->pixel_height > ((BUFFERP ((w)->contents) ? (!((w)->mini) && !(w)->pseudo_window_p && ((((void) (0 && (FRAMEP (((w)->frame))))), (struct frame *) ((void *) (intptr_t) ((((w)->frame)) - (Lisp_Vectorlike)))))->wants_modeline && !((((XBUFFER ((w)->contents))-> mode_line_format_)) == (builtin_lisp_symbol (0))) && (w)->pixel_height > (((((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike))))))->line_height))) : 0) ? (2 * (((((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike))))))->line_height))) : (((((((void) (0 && (FRAMEP (((((w)))->frame))))), (struct frame *) ((void *) (intptr_t) ((((((w)))->frame)) - (Lisp_Vectorlike))))))->line_height))))) : 0) ? (w->header_line_height >= 0 ? w->header_line_height : (w->header_line_height = (((w->current_matrix) && (w->current_matrix)->rows ? (w->current_matrix)->rows->height : 0) ? ((w->current_matrix) && (w->current_matrix)->rows ? (w->current_matrix)->rows->height : 0) : estimate_mode_line_height ((((void) (0 && (FRAMEP (w->frame)))), (struct frame *) ((void *) (intptr_t) ((w->frame) - (Lisp_Vectorlike)))), HEADER_LINE_FACE_ID)))) : 0);
 ...
 row = cur;
      ...
      if ((w->left_fringe_width >= 0 ? w->left_fringe_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->left_fringe_width)) == 0)
 left = 0;
      else if (row->left_user_fringe_bitmap != 0)
 {
 ...
 left = (bitmap_cache[0*4+0] >= 0 ? bitmap_cache[0*4+0] : (bitmap_cache[0*4+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (936), 0, 0)));
      else if (row->indicate_bob_p && ((boundary_top) == (builtin_lisp_symbol (607))))
 {
   left = ((row->indicate_eob_p && ((boundary_bot) == (builtin_lisp_symbol (607))))
    ? (bitmap_cache[1*4+top_row_ends_at_zv_p] >= 0 ? bitmap_cache[1*4+top_row_ends_at_zv_p] : (bitmap_cache[1*4+top_row_ends_at_zv_p] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (929), 0, top_row_ends_at_zv_p)))
    : (bitmap_cache[2*4+0] >= 0 ? bitmap_cache[2*4+0] : (bitmap_cache[2*4+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (928), 0, 0))));
   if (top_ind_min_y >= 0)
     left_offset = top_ind_min_y - row->y;
 }
      else if (row->indicate_eob_p && ((boundary_bot) == (builtin_lisp_symbol (607))))
 {
   left = (bitmap_cache[3*4+bot_row_ends_at_zv_p] >= 0 ? bitmap_cache[3*4+bot_row_ends_at_zv_p] : (bitmap_cache[3*4+bot_row_ends_at_zv_p] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (213), 0, bot_row_ends_at_zv_p)));
   if (bot_ind_max_y >= 0)
     left_offset = bot_ind_max_y - (row->y + row->visible_height);
 }
      else if ((!row->reversed_p && ((row)->continuation_lines_width > 0))
        || (row->reversed_p && row->continued_p))
 left = (bitmap_cache[4*4+0] >= 0 ? bitmap_cache[4*4+0] : (bitmap_cache[4*4+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (297), 0, 0)));
      else if (row->indicate_empty_line_p && ((empty_pos) == (builtin_lisp_symbol (607))))
 left = (bitmap_cache[5*4+0] >= 0 ? bitmap_cache[5*4+0] : (bitmap_cache[5*4+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (364), 0, 0)));
      else if (row->indicate_top_line_p && ((arrow_top) == (builtin_lisp_symbol (607))))
 {
   left = (bitmap_cache[6*4+0] >= 0 ? bitmap_cache[6*4+0] : (bitmap_cache[6*4+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (977), 0, 0)));
   if (top_ind_min_y >= 0)
     left_offset = top_ind_min_y - row->y;
 }
      else if (row->indicate_bottom_line_p && ((arrow_bot) == (builtin_lisp_symbol (607))))
 {
   left = (bitmap_cache[7*4+0] >= 0 ? bitmap_cache[7*4+0] : (bitmap_cache[7*4+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (352), 0, 0)));
   if (bot_ind_max_y >= 0)
     left_offset = bot_ind_max_y - (row->y + row->visible_height);
 }
      else
 left = 0;
      ...
      if ((w->right_fringe_width >= 0 ? w->right_fringe_width : ((((((void) (0 && (FRAMEP ((((w))->frame))))), (struct frame *) ((void *) (intptr_t) (((((w))->frame)) - (Lisp_Vectorlike))))))->right_fringe_width)) == 0)
 right = 0;
      else if (row->right_user_fringe_bitmap != 0)
 {
 ...
 right = (bitmap_cache[0*4+2+0] >= 0 ? bitmap_cache[0*4+2+0] : (bitmap_cache[0*4+2+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (936), 1, 0)));
      else if (row->indicate_bob_p && ((boundary_top) == (builtin_lisp_symbol (811))))
 {
   right = ((row->indicate_eob_p && ((boundary_bot) == (builtin_lisp_symbol (811))))
     ? (bitmap_cache[1*4+2+top_row_ends_at_zv_p] >= 0 ? bitmap_cache[1*4+2+top_row_ends_at_zv_p] : (bitmap_cache[1*4+2+top_row_ends_at_zv_p] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (929), 1, top_row_ends_at_zv_p)))
     : (bitmap_cache[2*4+2+0] >= 0 ? bitmap_cache[2*4+2+0] : (bitmap_cache[2*4+2+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (928), 1, 0))));
   if (top_ind_min_y >= 0)
     right_offset = top_ind_min_y - row->y;
 }
      else if (row->indicate_eob_p && ((boundary_bot) == (builtin_lisp_symbol (811))))
 {
   right = (bitmap_cache[3*4+2+bot_row_ends_at_zv_p] >= 0 ? bitmap_cache[3*4+2+bot_row_ends_at_zv_p] : (bitmap_cache[3*4+2+bot_row_ends_at_zv_p] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (213), 1, bot_row_ends_at_zv_p)));
   if (bot_ind_max_y >= 0)
     right_offset = bot_ind_max_y - (row->y + row->visible_height);
 }
      else if ((!row->reversed_p && row->continued_p)
        || (row->reversed_p && ((row)->continuation_lines_width > 0)))
 right = (bitmap_cache[4*4+2+0] >= 0 ? bitmap_cache[4*4+2+0] : (bitmap_cache[4*4+2+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (297), 1, 0)));
      else if (row->indicate_top_line_p && ((arrow_top) == (builtin_lisp_symbol (811))))
 {
   right = (bitmap_cache[6*4+2+0] >= 0 ? bitmap_cache[6*4+2+0] : (bitmap_cache[6*4+2+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (977), 1, 0)));
   if (top_ind_min_y >= 0)
     right_offset = top_ind_min_y - row->y;
 }
      else if (row->indicate_bottom_line_p && ((arrow_bot) == (builtin_lisp_symbol (811))))
 {
   right = (bitmap_cache[7*4+2+0] >= 0 ? bitmap_cache[7*4+2+0] : (bitmap_cache[7*4+2+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (352), 1, 0)));
   if (bot_ind_max_y >= 0)
     right_offset = bot_ind_max_y - (row->y + row->visible_height);
 }
      else if (row->indicate_empty_line_p && ((empty_pos) == (builtin_lisp_symbol (811))))
 right = (bitmap_cache[5*4+2+0] >= 0 ? bitmap_cache[5*4+2+0] : (bitmap_cache[5*4+2+0] = get_logical_fringe_bitmap (w, builtin_lisp_symbol (364), 1, 0)));
      else
 right = 0;
 ...
 row->overlay_arrow_bitmap = get_logical_fringe_bitmap (w, builtin_lisp_symbol (730), 0, 0);
...
destroy_fringe_bitmap (int n)
{
  ...
  fringe_faces[n] = builtin_lisp_symbol (0);

  fbp = &fringe_bitmaps[n];
  if (*fbp && (*fbp)->dynamic)
    {

      struct redisplay_interface *rif = ((((FRAMEP (selected_frame) && (((((void) (0 && (FRAMEP (selected_frame)))), (struct frame *) ((void *) (intptr_t) ((selected_frame) - (Lisp_Vectorlike)))))->terminal != 0)) ? (((void) (0 && (FRAMEP (selected_frame)))), (struct frame *) ((void *) (intptr_t) ((selected_frame) - (Lisp_Vectorlike)))) : (emacs_abort (), (struct frame *) 0)))->terminal->rif);
 ...
 rif->destroy_fringe_bitmap (n);
  ...
  while (max_used_fringe_bitmap > (sizeof (standard_bitmaps) / sizeof (standard_bitmaps)[0])
  && fringe_bitmaps[max_used_fringe_bitmap - 1] == ((void*)0))
    max_used_fringe_bitmap--;
}


static struct Lisp_Subr _Alignas (8) Sdestroy_fringe_bitmap = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fdestroy_fringe_bitmap }, 1, 1, "destroy-fringe-bitmap", 0, 0}; Lisp_Object Fdestroy_fringe_bitmap
  ...
  (Lisp_Object bitmap)
{
  ...
  (((((enum Lisp_Type) ((bitmap) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (897), bitmap));
  ...
  if (n >= (sizeof (standard_bitmaps) / sizeof (standard_bitmaps)[0]))
    {
      globals.f_Vfringe_bitmaps = Fdelq (bitmap, globals.f_Vfringe_bitmaps);

      Fput (bitmap, builtin_lisp_symbol (467), builtin_lisp_symbol (0));
    }
...
static struct Lisp_Subr _Alignas (8) Sdefine_fringe_bitmap = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a5 = Fdefine_fringe_bitmap }, 2, 5, "define-fringe-bitmap", 0, 0}; Lisp_Object Fdefine_fringe_bitmap
# 1485 "fringe.c"
  (Lisp_Object bitmap, Lisp_Object bits, Lisp_Object height, Lisp_Object width, Lisp_Object align)
{
  ...
  if (((height) == (builtin_lisp_symbol (0))))
    fb.height = h;
  else
    {
      ((((((enum Lisp_Type) ((height) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), height));
      fb.height = ((0) > (((((height) >> INTTYPEBITS)) < (255) ? (((height) >> INTTYPEBITS)) : (255))) ? (0) : (((((height) >> INTTYPEBITS)) < (255) ? (((height) >> INTTYPEBITS)) : (255))));
      if (fb.height > h)
 {
   fill1 = (fb.height - h) / 2;
  ...
  if (((width) == (builtin_lisp_symbol (0))))
  ...
  else
    {
      ...
      fb.width = ((0) > (((((width) >> INTTYPEBITS)) < (255) ? (((width) >> INTTYPEBITS)) : (255))) ? (0) : (((((width) >> INTTYPEBITS)) < (255) ? (((width) >> INTTYPEBITS)) : (255))));
    }

  fb.period = 0;
  fb.align = ALIGN_BITMAP_CENTER;

  if ((((enum Lisp_Type) ((align) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      Lisp_Object period = (((void) (0 && ((((enum Lisp_Type) ((align) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((align) - (Lisp_Cons))))->u.cdr;
      if ((((enum Lisp_Type) ((period) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 {
   period = (((void) (0 && ((((enum Lisp_Type) ((period) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((period) - (Lisp_Cons))))->car;
   if (!((period) == (builtin_lisp_symbol (0))))
     {
       fb.period = fb.height;
       fb.height = 255;
     }
 }
      align = (((void) (0 && ((((enum Lisp_Type) ((align) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((align) - (Lisp_Cons))))->car;
    }
  if (((align) == (builtin_lisp_symbol (928))))
    fb.align = ALIGN_BITMAP_TOP;
  else if (((align) == (builtin_lisp_symbol (213))))
    fb.align = ALIGN_BITMAP_BOTTOM;
  else if (!((align) == (builtin_lisp_symbol (0))) && !((align) == (builtin_lisp_symbol (251))))
 ...
 {
   for (n = (sizeof (standard_bitmaps) / sizeof (standard_bitmaps)[0]);
        n < max_fringe_bitmaps;
        n++)
     if (fringe_bitmaps[n] == ((void*)0))
       break;
  ...
  {
    fringe_bitmaps[i] = ((void*)0);
    fringe_faces[i] = builtin_lisp_symbol (0);
  }
      ...
      globals.f_Vfringe_bitmaps = Fcons (bitmap, globals.f_Vfringe_bitmaps);
      Fput (bitmap, builtin_lisp_symbol (467), ((EMACS_INT) (((EMACS_UINT) (n) << INTTYPEBITS) + Lisp_Int0)));
    }

  fb.dynamic = 1;

  xfb = xmalloc (sizeof fb + fb.height * (sizeof (unsigned short)));
 ...
 {
   Lisp_Object elt = Faref (bits, ((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0)));
   b[j++] = NUMBERP (elt) ? ((elt) >> INTTYPEBITS) : 0;
 }
...
static struct Lisp_Subr _Alignas (8) Sset_fringe_bitmap_face = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fset_fringe_bitmap_face }, 1, 2, "set-fringe-bitmap-face", 0, 0}; Lisp_Object Fset_fringe_bitmap_face
  ...
  (Lisp_Object bitmap, Lisp_Object face)
{
  ...
  if (!((face) == (builtin_lisp_symbol (0))))
    {
      struct frame *f = ((FRAMEP (selected_frame) && (((((void) (0 && (FRAMEP (selected_frame)))), (struct frame *) ((void *) (intptr_t) ((selected_frame) - (Lisp_Vectorlike)))))->terminal != 0)) ? (((void) (0 && (FRAMEP (selected_frame)))), (struct frame *) ((void *) (intptr_t) ((selected_frame) - (Lisp_Vectorlike)))) : (emacs_abort (), (struct frame *) 0));

      if (((((sizeof ((FRINGE_FACE_ID) + 0)) > (sizeof (((f)->face_cache->used) + 0)) ? (sizeof ((FRINGE_FACE_ID) + 0)) : (sizeof (((f)->face_cache->used) + 0))) <= sizeof (unsigned) ? ((FRINGE_FACE_ID) + (unsigned) 0) < (((f)->face_cache->used) + (unsigned) 0) : ((FRINGE_FACE_ID) + (uintmax_t) 0) < (((f)->face_cache->used) + (uintmax_t) 0)) ? (f)->face_cache->faces_by_id[FRINGE_FACE_ID] : ((void*)0))
...
static struct Lisp_Subr _Alignas (8) Sfringe_bitmaps_at_pos = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Ffringe_bitmaps_at_pos }, 0, 2, "fringe-bitmaps-at-pos", 0, 0}; Lisp_Object Ffringe_bitmaps_at_pos
# 1648 "fringe.c"
  ...
  if (!((pos) == (builtin_lisp_symbol (0))))
    {
      ...
      if (! ((current_buffer->begv) <= ((pos) >> INTTYPEBITS) && ((pos) >> INTTYPEBITS) <= (current_buffer->zv)))
 args_out_of_range (window, pos);
      textpos = ((pos) >> INTTYPEBITS);
    }
  else if (w == XWINDOW (selected_window))
    textpos = (current_buffer->pt + 0);
  else
    textpos = marker_position (w->pointm);

  row = ((w->current_matrix)->rows->mode_line_p ? (w->current_matrix)->rows + 1 : (w->current_matrix)->rows);
  row = row_containing_pos (w, textpos, row, ((void*)0), 0);
  if (row)
    return list3 (get_fringe_bitmap_name (row->left_fringe_bitmap),
    get_fringe_bitmap_name (row->right_fringe_bitmap),
    (row->overlay_arrow_bitmap == 0 ? builtin_lisp_symbol (0)
     : row->overlay_arrow_bitmap < 0 ? builtin_lisp_symbol (901)
...
syms_of_fringe (void)
{
  ...
  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "overflow-newline-into-fringe", &globals.f_Voverflow_newline_into_fringe); } while (0);
  ...
  globals.f_Voverflow_newline_into_fringe = builtin_lisp_symbol (901);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "fringe-bitmaps", &globals.f_Vfringe_bitmaps); } while (0);

  globals.f_Vfringe_bitmaps = builtin_lisp_symbol (0);
}
...
mark_fringe_data (void)
{
  ...
  for (i = 0; i < max_fringe_bitmaps; i++)
    if (!((fringe_faces[i]) == (builtin_lisp_symbol (0))))
...
init_fringe_once (void)
{
  ...
  for (bt = 0 + 1; bt < (sizeof (standard_bitmaps) / sizeof (standard_bitmaps)[0]); bt++)
...
init_fringe (void)
{
  max_fringe_bitmaps = (sizeof (standard_bitmaps) / sizeof (standard_bitmaps)[0]) + 20;

  fringe_bitmaps = xzalloc (max_fringe_bitmaps * sizeof *fringe_bitmaps);

  extern int (*_gl_verify_function5 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (NIL_IS_ZERO) ? 1 : -1; }))];
