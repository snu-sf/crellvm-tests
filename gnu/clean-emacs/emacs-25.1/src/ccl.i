...
static tr_stack mapping_stack[30];
...
ccl_driver (struct ccl_program *ccl, int *source, int *destination, int src_size, int dst_size, Lisp_Object charset_list)
{
      ...
      if (!((globals.f_Vquit_flag) == (builtin_lisp_symbol (0))) && ((globals.f_Vinhibit_quit) == (builtin_lisp_symbol (0))))
 {
   ...
   break;
      ...
      this_ic = ic;
      do { EMACS_INT prog_word = (((ccl_prog)[ic++]) >> INTTYPEBITS); if (! ((((-1 - ((1 << (28 - 1)) - 1))) <= (prog_word)) & ((prog_word) <= (((1 << (28 - 1)) - 1))))) do { ccl->status = 3; goto ccl_error_handler; } while (0); (code) = prog_word; } while (0);
      field1 = code >> 8;
      field2 = (code & 0xFF) >> 5;
 ...
 case 0x02:
   reg[field2] = ((ccl_prog[ic++]) >> INTTYPEBITS);
   break;
 ...
 case 0x03:
   ...
   j = field1 >> 3;
   if (0 <= i && i < j)
     reg[field2] = ((ccl_prog[ic + i]) >> INTTYPEBITS);
   ic += j;
   break;
 ...
 case 0x06:
   i = reg[field2];
   do { if (! dst) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (dst < dst_end) *dst++ = (i); else do { ic--; ccl->status = 2; goto ccl_finish; } while (0); } while (0);
   ic += field1;
   break;
 ...
 case 0x07:
   ...
   do { if (! dst) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (dst < dst_end) *dst++ = (i); else do { ic--; ccl->status = 2; goto ccl_finish; } while (0); } while (0);
   ic++;
   do { if (! src) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (src < src_end) reg[field2] = *src++; else if (ccl->last_block) { reg[field2] = -1; ic = ccl->eof_ic; goto ccl_repeat; } else do { ic--; ccl->status = 1; goto ccl_finish; } while (0); } while (0);
   ic += field1 - 1;
   break;

 case 0x08:
   i = ((ccl_prog[ic]) >> INTTYPEBITS);
   do { if (! dst) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (dst < dst_end) *dst++ = (i); else do { ic--; ccl->status = 2; goto ccl_finish; } while (0); } while (0);
   ic += field1;
   break;
 ...
 case 0x0A:
   j = ((ccl_prog[ic++]) >> INTTYPEBITS);
   do { int ccli; if (!dst) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (dst + j <= dst_end) { if (((ccl_prog[ic]) >> INTTYPEBITS) & 0x1000000) for (ccli = 0; ccli < j; ccli++) *dst++ = ((ccl_prog[ic + ccli]) >> INTTYPEBITS) & 0xFFFFFF; else for (ccli = 0; ccli < j; ccli++) *dst++ = ((((ccl_prog[ic + (ccli / 3)]) >> INTTYPEBITS)) >> ((2 - (ccli % 3)) * 8)) & 0xFF; } else do { ic--; ccl->status = 2; goto ccl_finish; } while (0); } while (0);
   ic += field1 - 1;
   break;
 ...
 case 0x0D:
 {
   int ioff = 0 <= reg[field2] && reg[field2] < field1 ? reg[field2] : field1;
   int incr = ((ccl_prog[ic + ioff]) >> INTTYPEBITS);
   ic += incr;
 }
   break;
 ...
 case 0x13:
   {
     ...
     if (field2)
       prog_id = ((ccl_prog[ic++]) >> INTTYPEBITS);
     else
       prog_id = field1;
  ...
  do { ccl->status = 3; goto ccl_error_handler; } while (0);
       }
     ...
     ic = 2;
     eof_ic = ((ccl_prog[1]) >> INTTYPEBITS);
   }
   break;

 case 0x14:
   if (!field2)
     do { if (! dst) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (dst < dst_end) *dst++ = (field1); else do { ic--; ccl->status = 2; goto ccl_finish; } while (0); } while (0);
   else
     {
       do { int ccli; if (!dst) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (dst + field1 <= dst_end) { if (((ccl_prog[ic]) >> INTTYPEBITS) & 0x1000000) for (ccli = 0; ccli < field1; ccli++) *dst++ = ((ccl_prog[ic + ccli]) >> INTTYPEBITS) & 0xFFFFFF; else for (ccli = 0; ccli < field1; ccli++) *dst++ = ((((ccl_prog[ic + (ccli / 3)]) >> INTTYPEBITS)) >> ((2 - (ccli % 3)) * 8)) & 0xFF; } else do { ic--; ccl->status = 2; goto ccl_finish; } while (0); } while (0);
       ic += (field1 + 2) / 3;
     }
   break;
 ...
 case 0x15:
   ...
   if (0 <= i && i < field1)
     {
       j = ((ccl_prog[ic + i]) >> INTTYPEBITS);
       do { if (! dst) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (dst < dst_end) *dst++ = (j); else do { ic--; ccl->status = 2; goto ccl_finish; } while (0); } while (0);
     }
   ic += field1;
   break;
 ...
 case 0x16:
  ...
  ic = eof_ic;
   ...
   ic--;
   do { ccl->status = 0; goto ccl_finish; } while (0);
 ...
 ccl_expr_self:
   switch (op)
     {
     case 0x00: reg[field2] += i; break;
     case 0x01: reg[field2] -= i; break;
     case 0x02: reg[field2] *= i; break;
     case 0x03: reg[field2] /= i; break;
     case 0x04: reg[field2] %= i; break;
     case 0x05: reg[field2] &= i; break;
     case 0x06: reg[field2] |= i; break;
     case 0x07: reg[field2] ^= i; break;
     case 0x08: reg[field2] <<= i; break;
     case 0x09: reg[field2] >>= i; break;
     case 0x0A: reg[field2] <<= 8; reg[field2] |= i; break;
     case 0x0B: reg[7] = reg[field2] & 0xFF; reg[field2] >>= 8; break;
     case 0x0C: reg[7] = reg[field2] % i; reg[field2] /= i; break;
     case 0x10: reg[field2] = reg[field2] < i; break;
     case 0x11: reg[field2] = reg[field2] > i; break;
     case 0x12: reg[field2] = reg[field2] == i; break;
     case 0x13: reg[field2] = reg[field2] <= i; break;
     case 0x14: reg[field2] = reg[field2] >= i; break;
     case 0x15: reg[field2] = reg[field2] != i; break;
     default: do { ccl->status = 3; goto ccl_error_handler; } while (0);
     }
   break;
 ...
 case 0x1B:
   i = reg[field2];
   jump_address = ic + field1;
   op = ((ccl_prog[ic++]) >> INTTYPEBITS);
   j = ((ccl_prog[ic++]) >> INTTYPEBITS);
   field2 = 7;
   goto ccl_set_expr;
 ...
 case 0x1C:
   ...
   jump_address = ic + field1;
   op = ((ccl_prog[ic++]) >> INTTYPEBITS);
   do { EMACS_INT prog_word = (((ccl_prog)[ic++]) >> INTTYPEBITS); if (! (((0) <= (prog_word)) & ((prog_word) <= (7)))) do { ccl->status = 3; goto ccl_error_handler; } while (0); (j) = prog_word; } while (0);
   j = reg[j];
   field2 = 7;
 ...
 ccl_set_expr:
   switch (op)
     {
     case 0x00: reg[field2] = i + j; break;
     case 0x01: reg[field2] = i - j; break;
     case 0x02: reg[field2] = i * j; break;
     case 0x03: reg[field2] = i / j; break;
     case 0x04: reg[field2] = i % j; break;
     case 0x05: reg[field2] = i & j; break;
     case 0x06: reg[field2] = i | j; break;
     case 0x07: reg[field2] = i ^ j; break;
     case 0x08: reg[field2] = i << j; break;
     case 0x09: reg[field2] = i >> j; break;
     case 0x0A: reg[field2] = (i << 8) | j; break;
     case 0x0B: reg[field2] = i >> 8; reg[7] = i & 0xFF; break;
     case 0x0C: reg[field2] = i / j; reg[7] = i % j; break;
     case 0x10: reg[field2] = i < j; break;
     case 0x11: reg[field2] = i > j; break;
     case 0x12: reg[field2] = i == j; break;
     case 0x13: reg[field2] = i <= j; break;
     case 0x14: reg[field2] = i >= j; break;
     case 0x15: reg[field2] = i != j; break;
     case 0x16:
       {
  i = (i << 8) | j;
  do { int s1, s2, j1, j2; s1 = (i) >> 8, s2 = (i) & 0xFF; if (s2 >= 0x9F) (j1 = s1 * 2 - (s1 >= 0xE0 ? 0x160 : 0xE0), j2 = s2 - 0x7E); else (j1 = s1 * 2 - ((s1 >= 0xE0) ? 0x161 : 0xE1), j2 = s2 - ((s2 >= 0x7F) ? 0x20 : 0x1F)); (i) = (j1 << 8) | j2; } while (0);
  reg[field2] = i >> 8;
  reg[7] = i & 0xFF;
  break;
       }
     case 0x17:
       {
  i = (i << 8) | j;
  do { int s1, s2, j1, j2; j1 = (i) >> 8, j2 = (i) & 0xFF; if (j1 & 1) (s1 = j1 / 2 + ((j1 < 0x5F) ? 0x71 : 0xB1), s2 = j2 + ((j2 >= 0x60) ? 0x20 : 0x1F)); else (s1 = j1 / 2 + ((j1 < 0x5F) ? 0x70 : 0xB0), s2 = j2 + 0x7E); (i) = (s1 << 8) | s2; } while (0);
  reg[field2] = i >> 8;
  reg[7] = i & 0xFF;
  break;
       }
 ...
 case 0x1F:
   switch ((field1 >> 6))
     ...
     case 0x00:
       if (!src)
  do { ccl->status = 3; goto ccl_error_handler; } while (0);
       do { if (! src) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (src < src_end) i = *src++; else if (ccl->last_block) { i = -1; ic = ccl->eof_ic; goto ccl_repeat; } else do { ic--; ccl->status = 1; goto ccl_finish; } while (0); } while (0);
       do { unsigned ncode; charset = char_charset ((i), (charset_list), &ncode); if (! charset && ! ((charset_list) == (builtin_lisp_symbol (0)))) charset = char_charset ((i), builtin_lisp_symbol (0), &ncode); if (charset) { (reg[(field1 & 7)]) = ((charset)->id); (reg[field2]) = ncode; } } while (0);
       break;

     case 0x01:
       if (! dst)
  do { ccl->status = 3; goto ccl_error_handler; } while (0);
       i = ((reg[(field1 & 7)]) == 0 ? (reg[field2]) : (charset = (charset_table + ((reg[(field1 & 7)]))), (((((sizeof (((reg[field2])) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof (((reg[field2])) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? (((reg[field2])) + (unsigned) 0) < ((0x80) + (unsigned) 0) : (((reg[field2])) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) && (charset)->ascii_compatible_p) ? ((reg[field2])) : (((reg[field2])) < (charset)->min_code || ((reg[field2])) > (charset)->max_code) ? -1 : (charset)->unified_p ? decode_char ((charset), ((reg[field2]))) : (charset)->method == CHARSET_METHOD_OFFSET ? ((charset)->code_linear_p ? (int) (((reg[field2])) - (charset)->min_code) + (charset)->code_offset : decode_char ((charset), ((reg[field2])))) : (charset)->method == CHARSET_METHOD_MAP ? (((charset)->code_linear_p && VECTORP ((AREF (((HASH_VALUE (XHASH_TABLE (Vcharset_hash_table), (charset)->hash_index))), charset_decoder)))) ? ((AREF ((AREF (((HASH_VALUE (XHASH_TABLE (Vcharset_hash_table), (charset)->hash_index))), charset_decoder)), ((reg[field2])) - (charset)->min_code)) >> INTTYPEBITS) : decode_char ((charset), ((reg[field2])))) : decode_char ((charset), ((reg[field2]))))));
       do { if (! dst) do { ccl->status = 3; goto ccl_error_handler; } while (0); else if (dst < dst_end) *dst++ = (i); else do { ic--; ccl->status = 2; goto ccl_finish; } while (0); } while (0);
       break;

     case 0x02:
       i = ((reg[(field1 & 7)]) == 0 ? (reg[field2]) : (charset = (charset_table + ((reg[(field1 & 7)]))), (((((sizeof (((reg[field2])) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof (((reg[field2])) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? (((reg[field2])) + (unsigned) 0) < ((0x80) + (unsigned) 0) : (((reg[field2])) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) && (charset)->ascii_compatible_p) ? ((reg[field2])) : (((reg[field2])) < (charset)->min_code || ((reg[field2])) > (charset)->max_code) ? -1 : (charset)->unified_p ? decode_char ((charset), ((reg[field2]))) : (charset)->method == CHARSET_METHOD_OFFSET ? ((charset)->code_linear_p ? (int) (((reg[field2])) - (charset)->min_code) + (charset)->code_offset : decode_char ((charset), ((reg[field2])))) : (charset)->method == CHARSET_METHOD_MAP ? (((charset)->code_linear_p && VECTORP ((AREF (((HASH_VALUE (XHASH_TABLE (Vcharset_hash_table), (charset)->hash_index))), charset_decoder)))) ? ((AREF ((AREF (((HASH_VALUE (XHASH_TABLE (Vcharset_hash_table), (charset)->hash_index))), charset_decoder)), ((reg[field2])) - (charset)->min_code)) >> INTTYPEBITS) : decode_char ((charset), ((reg[field2])))) : decode_char ((charset), ((reg[field2]))))));
       op = translate_char (((((void) (0 && ((((enum Lisp_Type) ((XVECTOR (globals.f_Vtranslation_table_vector)->contents[(reg[((field1 >> 3) & 7)])]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((XVECTOR (globals.f_Vtranslation_table_vector)->contents[(reg[((field1 >> 3) & 7)])]) - (Lisp_Cons))))->u.cdr), i);
       do { unsigned ncode; charset = char_charset ((op), (charset_list), &ncode); if (! charset && ! ((charset_list) == (builtin_lisp_symbol (0)))) charset = char_charset ((op), builtin_lisp_symbol (0), &ncode); if (charset) { (reg[(field1 & 7)]) = ((charset)->id); (reg[field2]) = ncode; } } while (0);
       break;

     case 0x03:
       {
  ptrdiff_t eop;
  do { EMACS_INT prog_word = (((ccl_prog)[ic++]) >> INTTYPEBITS); if (! (((0) <= (prog_word)) & ((prog_word) <= ((VECTORP (globals.f_Vtranslation_table_vector) ? ASIZE (globals.f_Vtranslation_table_vector) : -1))))) do { ccl->status = 3; goto ccl_error_handler; } while (0); (eop) = prog_word; } while (0);



  i = ((reg[(field1 & 7)]) == 0 ? (reg[field2]) : (charset = (charset_table + ((reg[(field1 & 7)]))), (((((sizeof (((reg[field2])) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof (((reg[field2])) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? (((reg[field2])) + (unsigned) 0) < ((0x80) + (unsigned) 0) : (((reg[field2])) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) && (charset)->ascii_compatible_p) ? ((reg[field2])) : (((reg[field2])) < (charset)->min_code || ((reg[field2])) > (charset)->max_code) ? -1 : (charset)->unified_p ? decode_char ((charset), ((reg[field2]))) : (charset)->method == CHARSET_METHOD_OFFSET ? ((charset)->code_linear_p ? (int) (((reg[field2])) - (charset)->min_code) + (charset)->code_offset : decode_char ((charset), ((reg[field2])))) : (charset)->method == CHARSET_METHOD_MAP ? (((charset)->code_linear_p && VECTORP ((AREF (((HASH_VALUE (XHASH_TABLE (Vcharset_hash_table), (charset)->hash_index))), charset_decoder)))) ? ((AREF ((AREF (((HASH_VALUE (XHASH_TABLE (Vcharset_hash_table), (charset)->hash_index))), charset_decoder)), ((reg[field2])) - (charset)->min_code)) >> INTTYPEBITS) : decode_char ((charset), ((reg[field2])))) : decode_char ((charset), ((reg[field2]))))));
  op = translate_char (((((void) (0 && ((((enum Lisp_Type) ((XVECTOR (globals.f_Vtranslation_table_vector)->contents[(eop)]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((XVECTOR (globals.f_Vtranslation_table_vector)->contents[(eop)]) - (Lisp_Cons))))->u.cdr), i);
  do { unsigned ncode; charset = char_charset ((op), (charset_list), &ncode); if (! charset && ! ((charset_list) == (builtin_lisp_symbol (0)))) charset = char_charset ((op), builtin_lisp_symbol (0), &ncode); if (charset) { (reg[(field1 & 7)]) = ((charset)->id); (reg[field2]) = ncode; } } while (0);
       }
       break;
  ...
  do { EMACS_INT prog_word = (((ccl_prog)[ic++]) >> INTTYPEBITS); if (! (((0) <= (prog_word)) & ((prog_word) <= ((VECTORP (globals.f_Vtranslation_hash_table_vector) ? ASIZE (globals.f_Vtranslation_hash_table_vector) : -1))))) do { ccl->status = 3; goto ccl_error_handler; } while (0); (eop) = prog_word; } while (0);



  h = (XHASH_TABLE ((((void) (0 && ((((enum Lisp_Type) ((AREF (globals.f_Vtranslation_hash_table_vector, (eop))) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((AREF (globals.f_Vtranslation_hash_table_vector, (eop))) - (Lisp_Cons))))->u.cdr));

  eop = hash_lookup (h, ((EMACS_INT) (((EMACS_UINT) (reg[(field1 & 7)]) << INTTYPEBITS) + Lisp_Int0)), ((void*)0));
  if (eop >= 0)
    {
      Lisp_Object opl;
      opl = HASH_VALUE (h, eop);
      if (! (((((-2147483647 -1)) <= (eop)) & ((eop) <= (2147483647))) && (NATNUMP (opl) && ((opl) >> INTTYPEBITS) <= 0x3FFFFF)))
        do { ccl->status = 3; goto ccl_error_handler; } while (0);
      reg[(field1 & 7)] = charset_unicode;
      reg[field2] = eop;
      reg[7] = 1;
    }
  else
  ...
  eop = hash_lookup (h, ((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0)), ((void*)0));
  if (eop >= 0)
    {
      Lisp_Object opl;
      opl = HASH_VALUE (h, eop);
      if (! (((((enum Lisp_Type) ((opl) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && ((((-2147483647 -1)) <= (((opl) >> INTTYPEBITS))) & ((((opl) >> INTTYPEBITS)) <= (2147483647)))))
        do { ccl->status = 3; goto ccl_error_handler; } while (0);
      reg[(field1 & 7)] = ((opl) >> INTTYPEBITS);
      reg[7] = 1;
    }
  else
    reg[7] = 0;
  ...
  for (;i < j;i++)
    {
      if (!VECTORP (globals.f_Vcode_conversion_map_vector)) continue;
      size = ASIZE (globals.f_Vcode_conversion_map_vector);
      point = ((ccl_prog[ic++]) >> INTTYPEBITS);
      if (! (0 <= point && point < size)) continue;
      map = AREF (globals.f_Vcode_conversion_map_vector, point);


      if (!(((enum Lisp_Type) ((map) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)) continue;
      map = (((void) (0 && ((((enum Lisp_Type) ((map) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((map) - (Lisp_Cons))))->u.cdr;
      ...
      if (((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
        {
   point = ((content) >> INTTYPEBITS);
   if (!(point <= op && op - point + 1 < size)) continue;
   content = AREF (map, op - point + 1);
        }
      else if (((content) == (builtin_lisp_symbol (901))))
        {
   if (size != 4) continue;
   if (((((enum Lisp_Type) ((AREF (map, 2)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
       && ((AREF (map, 2)) >> INTTYPEBITS) <= op
       && ((((enum Lisp_Type) ((AREF (map, 3)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
       && op < ((AREF (map, 3)) >> INTTYPEBITS))
     content = AREF (map, 1);
   else
     continue;
        }
      ...
      if (((content) == (builtin_lisp_symbol (0))))
        continue;
      else if (((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && ((((-2147483647 -1)) <= (((content) >> INTTYPEBITS))) & ((((content) >> INTTYPEBITS)) <= (2147483647))))
        {
   reg[(field1 & 7)] = i;
   reg[field2] = ((content) >> INTTYPEBITS);
   break;
        }
      else if (((content) == (builtin_lisp_symbol (901))) || ((content) == (builtin_lisp_symbol (598))))
        {
   reg[(field1 & 7)] = i;
   break;
        }
      else if ((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
        {
   attrib = (((void) (0 && ((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((content) - (Lisp_Cons))))->car;
   value = (((void) (0 && ((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((content) - (Lisp_Cons))))->u.cdr;
   if (! (((((enum Lisp_Type) ((attrib) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && ((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
          && ((((-2147483647 -1)) <= (((value) >> INTTYPEBITS))) & ((((value) >> INTTYPEBITS)) <= (2147483647)))))
     continue;
   reg[(field1 & 7)] = i;
   reg[field2] = ((value) >> INTTYPEBITS);
   break;
        }
      else if ((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
        do { struct ccl_program called_ccl; if (stack_idx >= 256 || ! setup_ccl_program (&called_ccl, (content))) { if (stack_idx > 0) { ccl_prog = ccl_prog_stack_struct[0].ccl_prog; ic = ccl_prog_stack_struct[0].ic; eof_ic = ccl_prog_stack_struct[0].eof_ic; } do { ccl->status = 3; goto ccl_error_handler; } while (0); } ccl_prog_stack_struct[stack_idx].ccl_prog = ccl_prog; ccl_prog_stack_struct[stack_idx].ic = (fin_ic); ccl_prog_stack_struct[stack_idx].eof_ic = eof_ic; stack_idx++; ccl_prog = called_ccl.prog; ic = 2; eof_ic = ((ccl_prog[1]) >> INTTYPEBITS); goto ccl_repeat; } while (0);
      else
        do { ccl->status = 3; goto ccl_error_handler; } while (0);
    }
  if (i == j)
  ...
  map_set_rest_length = ((ccl_prog[ic++]) >> INTTYPEBITS);

  fin_ic = ic + map_set_rest_length;
  op = reg[field2];

  if ((map_set_rest_length > reg[(field1 & 7)]) && (reg[(field1 & 7)] >= 0))
    {
      ic += reg[(field1 & 7)];
      i = reg[(field1 & 7)];
  ...
  if (mapping_stack_pointer <= (mapping_stack + 1))
    {
      ...
      mapping_stack_pointer = mapping_stack;
      do { mapping_stack_pointer->rest_length = (0); mapping_stack_pointer->orig_val = (op); mapping_stack_pointer++; } while (0);
      reg[(field1 & 7)] = -1;
    }
  else
    {
      ...
      do { mapping_stack_pointer--; (map_set_rest_length) = mapping_stack_pointer->rest_length; (orig_op) = mapping_stack_pointer->orig_val; } while (0);
      do { mapping_stack_pointer--; (map_set_rest_length) = mapping_stack_pointer->rest_length; (reg[field2]) = mapping_stack_pointer->orig_val; } while (0);
      switch (op)
        {
        case -1:
  ...
  if (!VECTORP (globals.f_Vcode_conversion_map_vector))
    do { ccl->status = 3; goto ccl_error_handler; } while (0);
  map_vector_size = ASIZE (globals.f_Vcode_conversion_map_vector);
  ...
  do {
        ...
        if (point < 0)
   {
     ...
     if (mapping_stack_pointer
         >= &mapping_stack[30])
       do { ccl->status = 3; goto ccl_error_handler; } while (0);
     do { mapping_stack_pointer->rest_length = (map_set_rest_length - point); mapping_stack_pointer->orig_val = (reg[field2]); mapping_stack_pointer++; } while (0);
   ...
   continue;
        ...
        reg[(field1 & 7)] = i;
        if (((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && ((((-2147483647 -1)) <= (((content) >> INTTYPEBITS))) & ((((content) >> INTTYPEBITS)) <= (2147483647))))
   {
     op = ((content) >> INTTYPEBITS);
        ...
        else if (((content) == (builtin_lisp_symbol (901))))
   {
     op = reg[field2];
        ...
        else if (((content) == (builtin_lisp_symbol (598))))
   {
     i += map_set_rest_length;
     ic += map_set_rest_length;
     break;
        ...
        else if ((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
   {
     if (mapping_stack_pointer
         >= &mapping_stack[30])
       do { ccl->status = 3; goto ccl_error_handler; } while (0);
     do { mapping_stack_pointer->rest_length = (map_set_rest_length); mapping_stack_pointer->orig_val = (reg[field2]); mapping_stack_pointer++; } while (0);
     do { mapping_stack_pointer->rest_length = (map_set_rest_length); mapping_stack_pointer->orig_val = (op); mapping_stack_pointer++; } while (0);
     stack_idx_of_map_multiple = stack_idx + 1;
     do { struct ccl_program called_ccl; if (stack_idx >= 256 || ! setup_ccl_program (&called_ccl, (content))) { if (stack_idx > 0) { ccl_prog = ccl_prog_stack_struct[0].ccl_prog; ic = ccl_prog_stack_struct[0].ic; eof_ic = ccl_prog_stack_struct[0].eof_ic; } do { ccl->status = 3; goto ccl_error_handler; } while (0); } ccl_prog_stack_struct[stack_idx].ccl_prog = ccl_prog; ccl_prog_stack_struct[stack_idx].ic = (current_ic); ccl_prog_stack_struct[stack_idx].eof_ic = eof_ic; stack_idx++; ccl_prog = called_ccl.prog; ic = 2; eof_ic = ((ccl_prog[1]) >> INTTYPEBITS); goto ccl_repeat; } while (0);
   }
        else
   do { ccl->status = 3; goto ccl_error_handler; } while (0);
      }
  ...
  op = reg[field2];
  if (! (VECTORP (globals.f_Vcode_conversion_map_vector)
         && j < ASIZE (globals.f_Vcode_conversion_map_vector)))
    {
      reg[(field1 & 7)] = -1;
      break;
    }
  map = AREF (globals.f_Vcode_conversion_map_vector, j);
  if (!(((enum Lisp_Type) ((map) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      reg[(field1 & 7)] = -1;
      break;
    }
  ...
  if (! (VECTORP (map)
         && 0 < ASIZE (map)
         && ((((enum Lisp_Type) ((AREF (map, 0)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
         && ((AREF (map, 0)) >> INTTYPEBITS) <= op
         && op - ((AREF (map, 0)) >> INTTYPEBITS) + 1 < ASIZE (map)))
    {
      reg[(field1 & 7)] = -1;
      break;
    }
  point = op - ((AREF (map, 0)) >> INTTYPEBITS) + 1;
  reg[(field1 & 7)] = 0;
  content = AREF (map, point);
  if (((content) == (builtin_lisp_symbol (0))))
    reg[(field1 & 7)] = -1;
  else if ((((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && ((! ((int) 0 < (int) -1)) ? ((int) (! (! ((int) 0 < (int) -1)) ? (int) 0 : ((int) ~ (int) 0 < (int) -1) ? ~ (int) 0 : ~ ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1))))) <= ((content) >> INTTYPEBITS) : 0 <= ((content) >> INTTYPEBITS)) && ((content) >> INTTYPEBITS) <= ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1)))))
    reg[field2] = ((content) >> INTTYPEBITS);
  else if (((content) == (builtin_lisp_symbol (901))));
  else if ((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      attrib = (((void) (0 && ((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((content) - (Lisp_Cons))))->car;
      value = (((void) (0 && ((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((content) - (Lisp_Cons))))->u.cdr;
      if (!((((enum Lisp_Type) ((attrib) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
   || !(((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && ((! ((int) 0 < (int) -1)) ? ((int) (! (! ((int) 0 < (int) -1)) ? (int) 0 : ((int) ~ (int) 0 < (int) -1) ? ~ (int) 0 : ~ ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1))))) <= ((value) >> INTTYPEBITS) : 0 <= ((value) >> INTTYPEBITS)) && ((value) >> INTTYPEBITS) <= ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1)))))
        continue;
      reg[field2] = ((value) >> INTTYPEBITS);
      break;
    }
  else if ((((enum Lisp_Type) ((content) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
    do { struct ccl_program called_ccl; if (stack_idx >= 256 || ! setup_ccl_program (&called_ccl, (content))) { if (stack_idx > 0) { ccl_prog = ccl_prog_stack_struct[0].ccl_prog; ic = ccl_prog_stack_struct[0].ic; eof_ic = ccl_prog_stack_struct[0].eof_ic; } do { ccl->status = 3; goto ccl_error_handler; } while (0); } ccl_prog_stack_struct[stack_idx].ccl_prog = ccl_prog; ccl_prog_stack_struct[stack_idx].ic = (ic); ccl_prog_stack_struct[stack_idx].eof_ic = eof_ic; stack_idx++; ccl_prog = called_ccl.prog; ic = 2; eof_ic = ((ccl_prog[1]) >> INTTYPEBITS); goto ccl_repeat; } while (0);
  else
    reg[(field1 & 7)] = -1;
       }
       break;
...
resolve_symbol_ccl_program (Lisp_Object ccl)
{
  ...
  if (! (2 < ASIZE (ccl) && ASIZE (ccl) <= 2147483647))
  ...
  for (i = 0; i < veclen; i++)
    {
      ...
      if ((((((enum Lisp_Type) ((contents) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && ((! ((int) 0 < (int) -1)) ? ((int) (! (! ((int) 0 < (int) -1)) ? (int) 0 : ((int) ~ (int) 0 < (int) -1) ? ~ (int) 0 : ~ ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1))))) <= ((contents) >> INTTYPEBITS) : 0 <= ((contents) >> INTTYPEBITS)) && ((contents) >> INTTYPEBITS) <= ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1)))))
 continue;
      else if ((((enum Lisp_Type) ((contents) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)
        && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((contents) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((contents) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol)
        && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((contents) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((contents) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
 {



   val = Fget ((((void) (0 && ((((enum Lisp_Type) ((contents) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((contents) - (Lisp_Cons))))->car, (((void) (0 && ((((enum Lisp_Type) ((contents) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((contents) - (Lisp_Cons))))->u.cdr);
   if (RANGED_INTEGERP (0, val, 2147483647))
     ASET (result, i, val);
   else
     unresolved = 1;
   continue;
 }
      else if ((((enum Lisp_Type) ((contents) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
 {



   val = Fget (contents, builtin_lisp_symbol (935));
   if (RANGED_INTEGERP (0, val, 2147483647))
     ASET (result, i, val);
   else
     {
       val = Fget (contents, builtin_lisp_symbol (275));
       if (RANGED_INTEGERP (0, val, 2147483647))
  ASET (result, i, val);
       else
  {
    val = Fget (contents, builtin_lisp_symbol (247));
    if (RANGED_INTEGERP (0, val, 2147483647))
      ASET (result, i, val);
    else
      unresolved = 1;
  ...
  if (! (0 <= ((AREF (result, 0)) >> INTTYPEBITS)
  && (((0) <= (((AREF (result, 1)) >> INTTYPEBITS))) & ((((AREF (result, 1)) >> INTTYPEBITS)) <= (ASIZE (ccl))))))

    return builtin_lisp_symbol (0);

  return (unresolved ? builtin_lisp_symbol (901) : result);
}
  ...
  if (VECTORP (ccl_prog))
    {
      ...
      *idx = -1;
      return (VECTORP (val) ? val : builtin_lisp_symbol (0));
    }
  if (!(((enum Lisp_Type) ((ccl_prog) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
    return builtin_lisp_symbol (0);

  val = Fget (ccl_prog, builtin_lisp_symbol (247));
  if (! NATNUMP (val)
      || ((val) >> INTTYPEBITS) >= ASIZE (Vccl_program_table))
    return builtin_lisp_symbol (0);
  slot = AREF (Vccl_program_table, ((val) >> INTTYPEBITS));
  if (! VECTORP (slot)
      || ASIZE (slot) != 4
      || ! VECTORP (AREF (slot, 1)))
    return builtin_lisp_symbol (0);
  *idx = ((val) >> INTTYPEBITS);
  if (((AREF (slot, 2)) == (builtin_lisp_symbol (0))))
    {
      val = resolve_symbol_ccl_program (AREF (slot, 1));
      if (! VECTORP (val))
 return builtin_lisp_symbol (0);
      ASET (slot, 1, val);
      ASET (slot, 2, builtin_lisp_symbol (901));
    }
  return AREF (slot, 1);
}
...
setup_ccl_program (struct ccl_program *ccl, Lisp_Object ccl_prog)
{
  ...
  if (! ((ccl_prog) == (builtin_lisp_symbol (0))))
    {
 ...
 return 0;
      ...
      ccl->eof_ic = ((vp->contents[1]) >> INTTYPEBITS);
      ccl->buf_magnification = ((vp->contents[0]) >> INTTYPEBITS);
      if (ccl->idx >= 0)
 {
   Lisp_Object slot;

   slot = AREF (Vccl_program_table, ccl->idx);
   ASET (slot, 3, builtin_lisp_symbol (0));
 }
    }
  ccl->ic = 2;
  for (i = 0; i < 8; i++)
...
static struct Lisp_Subr _Alignas (8) Sccl_program_p = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fccl_program_p }, 1, 1, "ccl-program-p", 0, 0}; Lisp_Object Fccl_program_p
  ...
  if (VECTORP (object))
    {
      ...
      return (VECTORP (val) ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0));
    }
  if (!(((enum Lisp_Type) ((object) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol))
    return builtin_lisp_symbol (0);

  val = Fget (object, builtin_lisp_symbol (247));
  return ((! NATNUMP (val)
    || ((val) >> INTTYPEBITS) >= ASIZE (Vccl_program_table))
   ? builtin_lisp_symbol (0) : builtin_lisp_symbol (901));
}

static struct Lisp_Subr _Alignas (8) Sccl_execute = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fccl_execute }, 2, 2, "ccl-execute", 0, 0}; Lisp_Object Fccl_execute
# 1981 "ccl.c"
  (Lisp_Object ccl_prog, Lisp_Object reg)
{
  ...
  for (i = 0; i < 8; i++)
    ccl.reg[i] = ((((((enum Lisp_Type) ((AREF (reg, i)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && ((! ((int) 0 < (int) -1)) ? ((int) (! (! ((int) 0 < (int) -1)) ? (int) 0 : ((int) ~ (int) 0 < (int) -1) ? ~ (int) 0 : ~ ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1))))) <= ((AREF (reg, i)) >> INTTYPEBITS) : 0 <= ((AREF (reg, i)) >> INTTYPEBITS)) && ((AREF (reg, i)) >> INTTYPEBITS) <= ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1))))
    ? ((AREF (reg, i)) >> INTTYPEBITS)
    : 0);

  ccl_driver (&ccl, ((void*)0), ((void*)0), 0, 0, builtin_lisp_symbol (0));
  ...
  for (i = 0; i < 8; i++)
    ASET (reg, i, ((EMACS_INT) (((EMACS_UINT) (ccl.reg[i]) << INTTYPEBITS) + Lisp_Int0)));
  return builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Sccl_execute_on_string = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a5 = Fccl_execute_on_string }, 3, 5, "ccl-execute-on-string", 0, 0}; Lisp_Object Fccl_execute_on_string
# 2035 "ccl.c"
  (Lisp_Object ccl_prog, Lisp_Object status, Lisp_Object str, Lisp_Object contin, Lisp_Object unibyte_p)
{
  ...
  int source[1024], destination[1024];
  ...
  for (i = 0; i < 8; i++)
    {
      if (((AREF (status, i)) == (builtin_lisp_symbol (0))))
 ASET (status, i, ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)));
      if ((((((enum Lisp_Type) ((AREF (status, i)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && ((! ((int) 0 < (int) -1)) ? ((int) (! (! ((int) 0 < (int) -1)) ? (int) 0 : ((int) ~ (int) 0 < (int) -1) ? ~ (int) 0 : ~ ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1))))) <= ((AREF (status, i)) >> INTTYPEBITS) : 0 <= ((AREF (status, i)) >> INTTYPEBITS)) && ((AREF (status, i)) >> INTTYPEBITS) <= ((int) (! (! ((int) 0 < (int) -1)) ? (int) -1 : ((((int) 1 << (sizeof (int) * 8 - 2)) - 1) * 2 + 1)))))
 ccl.reg[i] = ((AREF (status, i)) >> INTTYPEBITS);
    }
  if (((((enum Lisp_Type) ((AREF (status, i)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    {
      i = ((AREF (status, 8)) >> INTTYPEBITS);
 ...
 ccl.ic = i;
  ...
  if ((sizeof *(&outbufsize) == sizeof (signed char) ? (sizeof ((buf_magnification) * (outbufsize)) < sizeof (signed char) ? ((((((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (1)) << (sizeof ((0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (0)))) == 0 && ((((signed char) (buf_magnification)) < 0 && 0 < ((signed char) (outbufsize))) || (((signed char) (outbufsize)) < 0 && 0 < ((signed char) (buf_magnification))))) || (((signed char) (outbufsize)) < 0 ? (((signed char) (buf_magnification)) < 0 ? ((signed char) (buf_magnification)) < ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (1)) << (sizeof ((0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) - (1)))) / ((signed char) (outbufsize)) : ((signed char) (outbufsize)) == -1 ? 0 : ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (1)) << (sizeof ((0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (0)))) / ((signed char) (outbufsize)) < ((signed char) (buf_magnification))) : ((signed char) (outbufsize)) == 0 ? 0 : (((signed char) (buf_magnification)) < 0 ? ((signed char) (buf_magnification)) < ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (1)) << (sizeof ((0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (0)))) / ((signed char) (outbufsize)) : ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + (1)) << (sizeof ((0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (buf_magnification))) - (1)))) / ((signed char) (outbufsize)) < ((signed char) (buf_magnification))))) || (((0 * (((signed char) (buf_magnification)) * ((signed char) (outbufsize))) - (1)) < 0) && (((signed char) (buf_magnification)) * ((signed char) (outbufsize))) < ((-127 -1))) || (127) < (((signed char) (buf_magnification)) * ((signed char) (outbufsize)))) ? (*(&outbufsize) = (((unsigned char) ((signed char) (buf_magnification)) * (unsigned char) ((signed char) (outbufsize))) <= (127) ? (signed char) ((unsigned char) ((signed char) (buf_magnification)) * (unsigned char) ((signed char) (outbufsize))) : ((signed char) (((unsigned char) ((signed char) (buf_magnification)) * (unsigned char) ((signed char) (outbufsize))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&outbufsize) = (((unsigned char) ((signed char) (buf_magnification)) * (unsigned char) ((signed char) (outbufsize))) <= (127) ? (signed char) ((unsigned char) ((signed char) (buf_magnification)) * (unsigned char) ((signed char) (outbufsize))) : ((signed char) (((unsigned char) ((signed char) (buf_magnification)) * (unsigned char) ((signed char) (outbufsize))) - ((-127 -1))) + ((-127 -1)))), 0)) : ((((((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) == 0 && (((buf_magnification) < 0 && 0 < (outbufsize)) || ((outbufsize) < 0 && 0 < (buf_magnification)))) || ((outbufsize) < 0 ? ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) : (outbufsize) == -1 ? 0 : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) < (buf_magnification)) : (outbufsize) == 0 ? 0 : ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) < (buf_magnification)))) || (((0 * ((buf_magnification) * (outbufsize)) - (1)) < 0) && ((buf_magnification) * (outbufsize)) < ((-127 -1))) || (127) < ((buf_magnification) * (outbufsize))) ? (*(&outbufsize) = (((unsigned char) (buf_magnification) * (unsigned char) (outbufsize)) <= (127) ? (signed char) ((unsigned char) (buf_magnification) * (unsigned char) (outbufsize)) : ((signed char) (((unsigned char) (buf_magnification) * (unsigned char) (outbufsize)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&outbufsize) = (((unsigned char) (buf_magnification) * (unsigned char) (outbufsize)) <= (127) ? (signed char) ((unsigned char) (buf_magnification) * (unsigned char) (outbufsize)) : ((signed char) (((unsigned char) (buf_magnification) * (unsigned char) (outbufsize)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&outbufsize) == sizeof (short int) ? (sizeof ((buf_magnification) * (outbufsize)) < sizeof (short int) ? ((((((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (1)) << (sizeof ((0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (0)))) == 0 && ((((short int) (buf_magnification)) < 0 && 0 < ((short int) (outbufsize))) || (((short int) (outbufsize)) < 0 && 0 < ((short int) (buf_magnification))))) || (((short int) (outbufsize)) < 0 ? (((short int) (buf_magnification)) < 0 ? ((short int) (buf_magnification)) < ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (1)) << (sizeof ((0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) - (1)))) / ((short int) (outbufsize)) : ((short int) (outbufsize)) == -1 ? 0 : ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (1)) << (sizeof ((0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (0)))) / ((short int) (outbufsize)) < ((short int) (buf_magnification))) : ((short int) (outbufsize)) == 0 ? 0 : (((short int) (buf_magnification)) < 0 ? ((short int) (buf_magnification)) < ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (1)) << (sizeof ((0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (0)))) / ((short int) (outbufsize)) : ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + (1)) << (sizeof ((0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (outbufsize)) + ((short int) (buf_magnification))) - (1)))) / ((short int) (outbufsize)) < ((short int) (buf_magnification))))) || (((0 * (((short int) (buf_magnification)) * ((short int) (outbufsize))) - (1)) < 0) && (((short int) (buf_magnification)) * ((short int) (outbufsize))) < ((-32767 -1))) || (32767) < (((short int) (buf_magnification)) * ((short int) (outbufsize)))) ? (*(&outbufsize) = (((unsigned short int) ((short int) (buf_magnification)) * (unsigned short int) ((short int) (outbufsize))) <= (32767) ? (short int) ((unsigned short int) ((short int) (buf_magnification)) * (unsigned short int) ((short int) (outbufsize))) : ((short int) (((unsigned short int) ((short int) (buf_magnification)) * (unsigned short int) ((short int) (outbufsize))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&outbufsize) = (((unsigned short int) ((short int) (buf_magnification)) * (unsigned short int) ((short int) (outbufsize))) <= (32767) ? (short int) ((unsigned short int) ((short int) (buf_magnification)) * (unsigned short int) ((short int) (outbufsize))) : ((short int) (((unsigned short int) ((short int) (buf_magnification)) * (unsigned short int) ((short int) (outbufsize))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : ((((((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) == 0 && (((buf_magnification) < 0 && 0 < (outbufsize)) || ((outbufsize) < 0 && 0 < (buf_magnification)))) || ((outbufsize) < 0 ? ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) : (outbufsize) == -1 ? 0 : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) < (buf_magnification)) : (outbufsize) == 0 ? 0 : ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) < (buf_magnification)))) || (((0 * ((buf_magnification) * (outbufsize)) - (1)) < 0) && ((buf_magnification) * (outbufsize)) < ((-32767 -1))) || (32767) < ((buf_magnification) * (outbufsize))) ? (*(&outbufsize) = (((unsigned short int) (buf_magnification) * (unsigned short int) (outbufsize)) <= (32767) ? (short int) ((unsigned short int) (buf_magnification) * (unsigned short int) (outbufsize)) : ((short int) (((unsigned short int) (buf_magnification) * (unsigned short int) (outbufsize)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&outbufsize) = (((unsigned short int) (buf_magnification) * (unsigned short int) (outbufsize)) <= (32767) ? (short int) ((unsigned short int) (buf_magnification) * (unsigned short int) (outbufsize)) : ((short int) (((unsigned short int) (buf_magnification) * (unsigned short int) (outbufsize)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&outbufsize) == sizeof (int) ? (sizeof ((buf_magnification) * (outbufsize)) < sizeof (int) ? ((((((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (1)) << (sizeof ((0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (0)))) == 0 && ((((int) (buf_magnification)) < 0 && 0 < ((int) (outbufsize))) || (((int) (outbufsize)) < 0 && 0 < ((int) (buf_magnification))))) || (((int) (outbufsize)) < 0 ? (((int) (buf_magnification)) < 0 ? ((int) (buf_magnification)) < ((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (1)) << (sizeof ((0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) - (1)))) / ((int) (outbufsize)) : ((int) (outbufsize)) == -1 ? 0 : ((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (1)) << (sizeof ((0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (0)))) / ((int) (outbufsize)) < ((int) (buf_magnification))) : ((int) (outbufsize)) == 0 ? 0 : (((int) (buf_magnification)) < 0 ? ((int) (buf_magnification)) < ((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (1)) << (sizeof ((0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (0)))) / ((int) (outbufsize)) : ((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + (1)) << (sizeof ((0 * ((int) (outbufsize)) + ((int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (outbufsize)) + ((int) (buf_magnification))) - (1)))) / ((int) (outbufsize)) < ((int) (buf_magnification))))) || (((0 * (((int) (buf_magnification)) * ((int) (outbufsize))) - (1)) < 0) && (((int) (buf_magnification)) * ((int) (outbufsize))) < ((-2147483647 -1))) || (2147483647) < (((int) (buf_magnification)) * ((int) (outbufsize)))) ? (*(&outbufsize) = (((unsigned int) ((int) (buf_magnification)) * (unsigned int) ((int) (outbufsize))) <= (2147483647) ? (int) ((unsigned int) ((int) (buf_magnification)) * (unsigned int) ((int) (outbufsize))) : ((int) (((unsigned int) ((int) (buf_magnification)) * (unsigned int) ((int) (outbufsize))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&outbufsize) = (((unsigned int) ((int) (buf_magnification)) * (unsigned int) ((int) (outbufsize))) <= (2147483647) ? (int) ((unsigned int) ((int) (buf_magnification)) * (unsigned int) ((int) (outbufsize))) : ((int) (((unsigned int) ((int) (buf_magnification)) * (unsigned int) ((int) (outbufsize))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0)) : ((((((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) == 0 && (((buf_magnification) < 0 && 0 < (outbufsize)) || ((outbufsize) < 0 && 0 < (buf_magnification)))) || ((outbufsize) < 0 ? ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) : (outbufsize) == -1 ? 0 : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) < (buf_magnification)) : (outbufsize) == 0 ? 0 : ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) < (buf_magnification)))) || (((0 * ((buf_magnification) * (outbufsize)) - (1)) < 0) && ((buf_magnification) * (outbufsize)) < ((-2147483647 -1))) || (2147483647) < ((buf_magnification) * (outbufsize))) ? (*(&outbufsize) = (((unsigned int) (buf_magnification) * (unsigned int) (outbufsize)) <= (2147483647) ? (int) ((unsigned int) (buf_magnification) * (unsigned int) (outbufsize)) : ((int) (((unsigned int) (buf_magnification) * (unsigned int) (outbufsize)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&outbufsize) = (((unsigned int) (buf_magnification) * (unsigned int) (outbufsize)) <= (2147483647) ? (int) ((unsigned int) (buf_magnification) * (unsigned int) (outbufsize)) : ((int) (((unsigned int) (buf_magnification) * (unsigned int) (outbufsize)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0))) : (sizeof *(&outbufsize) == sizeof (long int) ? (sizeof ((buf_magnification) * (outbufsize)) < sizeof (long int) ? ((((((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (0)))) == 0 && ((((long int) (buf_magnification)) < 0 && 0 < ((long int) (outbufsize))) || (((long int) (outbufsize)) < 0 && 0 < ((long int) (buf_magnification))))) || (((long int) (outbufsize)) < 0 ? (((long int) (buf_magnification)) < 0 ? ((long int) (buf_magnification)) < ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) - (1)))) / ((long int) (outbufsize)) : ((long int) (outbufsize)) == -1 ? 0 : ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (0)))) / ((long int) (outbufsize)) < ((long int) (buf_magnification))) : ((long int) (outbufsize)) == 0 ? 0 : (((long int) (buf_magnification)) < 0 ? ((long int) (buf_magnification)) < ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (0)))) / ((long int) (outbufsize)) : ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (outbufsize)) + ((long int) (buf_magnification))) - (1)))) / ((long int) (outbufsize)) < ((long int) (buf_magnification))))) || (((0 * (((long int) (buf_magnification)) * ((long int) (outbufsize))) - (1)) < 0) && (((long int) (buf_magnification)) * ((long int) (outbufsize))) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < (((long int) (buf_magnification)) * ((long int) (outbufsize)))) ? (*(&outbufsize) = (((unsigned long int) ((long int) (buf_magnification)) * (unsigned long int) ((long int) (outbufsize))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (buf_magnification)) * (unsigned long int) ((long int) (outbufsize))) : ((long int) (((unsigned long int) ((long int) (buf_magnification)) * (unsigned long int) ((long int) (outbufsize))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&outbufsize) = (((unsigned long int) ((long int) (buf_magnification)) * (unsigned long int) ((long int) (outbufsize))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (buf_magnification)) * (unsigned long int) ((long int) (outbufsize))) : ((long int) (((unsigned long int) ((long int) (buf_magnification)) * (unsigned long int) ((long int) (outbufsize))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0)) : ((((((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) == 0 && (((buf_magnification) < 0 && 0 < (outbufsize)) || ((outbufsize) < 0 && 0 < (buf_magnification)))) || ((outbufsize) < 0 ? ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) : (outbufsize) == -1 ? 0 : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) < (buf_magnification)) : (outbufsize) == 0 ? 0 : ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) < (buf_magnification)))) || (((0 * ((buf_magnification) * (outbufsize)) - (1)) < 0) && ((buf_magnification) * (outbufsize)) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < ((buf_magnification) * (outbufsize))) ? (*(&outbufsize) = (((unsigned long int) (buf_magnification) * (unsigned long int) (outbufsize)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (buf_magnification) * (unsigned long int) (outbufsize)) : ((long int) (((unsigned long int) (buf_magnification) * (unsigned long int) (outbufsize)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&outbufsize) = (((unsigned long int) (buf_magnification) * (unsigned long int) (outbufsize)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (buf_magnification) * (unsigned long int) (outbufsize)) : ((long int) (((unsigned long int) (buf_magnification) * (unsigned long int) (outbufsize)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0))) : (sizeof ((buf_magnification) * (outbufsize)) < sizeof (long long int) ? ((((((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (0)))) == 0 && ((((long long int) (buf_magnification)) < 0 && 0 < ((long long int) (outbufsize))) || (((long long int) (outbufsize)) < 0 && 0 < ((long long int) (buf_magnification))))) || (((long long int) (outbufsize)) < 0 ? (((long long int) (buf_magnification)) < 0 ? ((long long int) (buf_magnification)) < ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) - (1)))) / ((long long int) (outbufsize)) : ((long long int) (outbufsize)) == -1 ? 0 : ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (0)))) / ((long long int) (outbufsize)) < ((long long int) (buf_magnification))) : ((long long int) (outbufsize)) == 0 ? 0 : (((long long int) (buf_magnification)) < 0 ? ((long long int) (buf_magnification)) < ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (0)) == -1) - ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (0)))) / ((long long int) (outbufsize)) : ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + (1)) << (sizeof ((0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (buf_magnification))) - (1)))) / ((long long int) (outbufsize)) < ((long long int) (buf_magnification))))) || (((0 * (((long long int) (buf_magnification)) * ((long long int) (outbufsize))) - (1)) < 0) && (((long long int) (buf_magnification)) * ((long long int) (outbufsize))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (buf_magnification)) * ((long long int) (outbufsize)))) ? (*(&outbufsize) = (((unsigned long long int) ((long long int) (buf_magnification)) * (unsigned long long int) ((long long int) (outbufsize))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (buf_magnification)) * (unsigned long long int) ((long long int) (outbufsize))) : ((long long int) (((unsigned long long int) ((long long int) (buf_magnification)) * (unsigned long long int) ((long long int) (outbufsize))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&outbufsize) = (((unsigned long long int) ((long long int) (buf_magnification)) * (unsigned long long int) ((long long int) (outbufsize))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (buf_magnification)) * (unsigned long long int) ((long long int) (outbufsize))) : ((long long int) (((unsigned long long int) ((long long int) (buf_magnification)) * (unsigned long long int) ((long long int) (outbufsize))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : ((((((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) == 0 && (((buf_magnification) < 0 && 0 < (outbufsize)) || ((outbufsize) < 0 && 0 < (buf_magnification)))) || ((outbufsize) < 0 ? ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) : (outbufsize) == -1 ? 0 : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) < (buf_magnification)) : (outbufsize) == 0 ? 0 : ((buf_magnification) < 0 ? (buf_magnification) < ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (buf_magnification)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) + (0)))) / (outbufsize) : ((((0 * (0 * (outbufsize) + (buf_magnification)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (buf_magnification)) + (1)) << (sizeof ((0 * (outbufsize) + (buf_magnification)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (buf_magnification)) - (1)))) / (outbufsize) < (buf_magnification)))) || (((0 * ((buf_magnification) * (outbufsize)) - (1)) < 0) && ((buf_magnification) * (outbufsize)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((buf_magnification) * (outbufsize))) ? (*(&outbufsize) = (((unsigned long long int) (buf_magnification) * (unsigned long long int) (outbufsize)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (buf_magnification) * (unsigned long long int) (outbufsize)) : ((long long int) (((unsigned long long int) (buf_magnification) * (unsigned long long int) (outbufsize)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&outbufsize) = (((unsigned long long int) (buf_magnification) * (unsigned long long int) (outbufsize)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (buf_magnification) * (unsigned long long int) (outbufsize)) : ((long long int) (((unsigned long long int) (buf_magnification) * (unsigned long long int) (outbufsize)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)))))
      || (sizeof *(&outbufsize) == sizeof (signed char) ? (sizeof ((256) + (outbufsize)) < sizeof (signed char) ? (((((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) + (0)) == -1) - ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) + (1)) << (sizeof ((0 * ((signed char) (outbufsize)) + ((signed char) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) + (0)))) < 0 ? (((signed char) (outbufsize)) < 0 ? ((signed char) (256)) < ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) + (0)) == -1) - ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) + (1)) << (sizeof ((0 * ((signed char) (outbufsize)) + ((signed char) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) + (0)))) - ((signed char) (outbufsize)) : ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) - (1)) < 0) ? ((((0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) + (1)) << (sizeof ((0 * ((signed char) (outbufsize)) + ((signed char) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((signed char) (outbufsize)) + ((signed char) (256))) - (1)))) - ((signed char) (outbufsize)) < ((signed char) (256))) : ((signed char) (256)) < 0 ? ((signed char) (outbufsize)) <= ((signed char) (256)) + ((signed char) (outbufsize)) : ((signed char) (outbufsize)) < 0 ? ((signed char) (256)) <= ((signed char) (256)) + ((signed char) (outbufsize)) : ((signed char) (256)) + ((signed char) (outbufsize)) < ((signed char) (outbufsize))) || (((0 * (((signed char) (256)) + ((signed char) (outbufsize))) - (1)) < 0) && (((signed char) (256)) + ((signed char) (outbufsize))) < ((-127 -1))) || (127) < (((signed char) (256)) + ((signed char) (outbufsize)))) ? (*(&outbufsize) = (((unsigned char) ((signed char) (256)) + (unsigned char) ((signed char) (outbufsize))) <= (127) ? (signed char) ((unsigned char) ((signed char) (256)) + (unsigned char) ((signed char) (outbufsize))) : ((signed char) (((unsigned char) ((signed char) (256)) + (unsigned char) ((signed char) (outbufsize))) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&outbufsize) = (((unsigned char) ((signed char) (256)) + (unsigned char) ((signed char) (outbufsize))) <= (127) ? (signed char) ((unsigned char) ((signed char) (256)) + (unsigned char) ((signed char) (outbufsize))) : ((signed char) (((unsigned char) ((signed char) (256)) + (unsigned char) ((signed char) (outbufsize))) - ((-127 -1))) + ((-127 -1)))), 0)) : (((((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) < 0 ? ((outbufsize) < 0 ? (256) < ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) - (outbufsize) : ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) - (1)))) - (outbufsize) < (256)) : (256) < 0 ? (outbufsize) <= (256) + (outbufsize) : (outbufsize) < 0 ? (256) <= (256) + (outbufsize) : (256) + (outbufsize) < (outbufsize)) || (((0 * ((256) + (outbufsize)) - (1)) < 0) && ((256) + (outbufsize)) < ((-127 -1))) || (127) < ((256) + (outbufsize))) ? (*(&outbufsize) = (((unsigned char) (256) + (unsigned char) (outbufsize)) <= (127) ? (signed char) ((unsigned char) (256) + (unsigned char) (outbufsize)) : ((signed char) (((unsigned char) (256) + (unsigned char) (outbufsize)) - ((-127 -1))) + ((-127 -1)))), 1) : (*(&outbufsize) = (((unsigned char) (256) + (unsigned char) (outbufsize)) <= (127) ? (signed char) ((unsigned char) (256) + (unsigned char) (outbufsize)) : ((signed char) (((unsigned char) (256) + (unsigned char) (outbufsize)) - ((-127 -1))) + ((-127 -1)))), 0))) : sizeof *(&outbufsize) == sizeof (short int) ? (sizeof ((256) + (outbufsize)) < sizeof (short int) ? (((((((0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) + (0)) == -1) - ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) + (1)) << (sizeof ((0 * ((short int) (outbufsize)) + ((short int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) + (0)))) < 0 ? (((short int) (outbufsize)) < 0 ? ((short int) (256)) < ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) + (0)) == -1) - ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) + (1)) << (sizeof ((0 * ((short int) (outbufsize)) + ((short int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) + (0)))) - ((short int) (outbufsize)) : ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) - (1)) < 0) ? ((((0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) + (1)) << (sizeof ((0 * ((short int) (outbufsize)) + ((short int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((short int) (outbufsize)) + ((short int) (256))) - (1)))) - ((short int) (outbufsize)) < ((short int) (256))) : ((short int) (256)) < 0 ? ((short int) (outbufsize)) <= ((short int) (256)) + ((short int) (outbufsize)) : ((short int) (outbufsize)) < 0 ? ((short int) (256)) <= ((short int) (256)) + ((short int) (outbufsize)) : ((short int) (256)) + ((short int) (outbufsize)) < ((short int) (outbufsize))) || (((0 * (((short int) (256)) + ((short int) (outbufsize))) - (1)) < 0) && (((short int) (256)) + ((short int) (outbufsize))) < ((-32767 -1))) || (32767) < (((short int) (256)) + ((short int) (outbufsize)))) ? (*(&outbufsize) = (((unsigned short int) ((short int) (256)) + (unsigned short int) ((short int) (outbufsize))) <= (32767) ? (short int) ((unsigned short int) ((short int) (256)) + (unsigned short int) ((short int) (outbufsize))) : ((short int) (((unsigned short int) ((short int) (256)) + (unsigned short int) ((short int) (outbufsize))) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&outbufsize) = (((unsigned short int) ((short int) (256)) + (unsigned short int) ((short int) (outbufsize))) <= (32767) ? (short int) ((unsigned short int) ((short int) (256)) + (unsigned short int) ((short int) (outbufsize))) : ((short int) (((unsigned short int) ((short int) (256)) + (unsigned short int) ((short int) (outbufsize))) - ((-32767 -1))) + ((-32767 -1)))), 0)) : (((((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) < 0 ? ((outbufsize) < 0 ? (256) < ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) - (outbufsize) : ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) - (1)))) - (outbufsize) < (256)) : (256) < 0 ? (outbufsize) <= (256) + (outbufsize) : (outbufsize) < 0 ? (256) <= (256) + (outbufsize) : (256) + (outbufsize) < (outbufsize)) || (((0 * ((256) + (outbufsize)) - (1)) < 0) && ((256) + (outbufsize)) < ((-32767 -1))) || (32767) < ((256) + (outbufsize))) ? (*(&outbufsize) = (((unsigned short int) (256) + (unsigned short int) (outbufsize)) <= (32767) ? (short int) ((unsigned short int) (256) + (unsigned short int) (outbufsize)) : ((short int) (((unsigned short int) (256) + (unsigned short int) (outbufsize)) - ((-32767 -1))) + ((-32767 -1)))), 1) : (*(&outbufsize) = (((unsigned short int) (256) + (unsigned short int) (outbufsize)) <= (32767) ? (short int) ((unsigned short int) (256) + (unsigned short int) (outbufsize)) : ((short int) (((unsigned short int) (256) + (unsigned short int) (outbufsize)) - ((-32767 -1))) + ((-32767 -1)))), 0))) : sizeof *(&outbufsize) == sizeof (int) ? (sizeof ((256) + (outbufsize)) < sizeof (int) ? (((((((0 * (0 * ((int) (outbufsize)) + ((int) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (outbufsize)) + ((int) (256))) + (0)) == -1) - ((((0 * (0 * ((int) (outbufsize)) + ((int) (256))) + (1)) << (sizeof ((0 * ((int) (outbufsize)) + ((int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (outbufsize)) + ((int) (256))) + (0)))) < 0 ? (((int) (outbufsize)) < 0 ? ((int) (256)) < ((((0 * (0 * ((int) (outbufsize)) + ((int) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((int) (outbufsize)) + ((int) (256))) + (0)) == -1) - ((((0 * (0 * ((int) (outbufsize)) + ((int) (256))) + (1)) << (sizeof ((0 * ((int) (outbufsize)) + ((int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (outbufsize)) + ((int) (256))) + (0)))) - ((int) (outbufsize)) : ((((0 * (0 * ((int) (outbufsize)) + ((int) (256))) - (1)) < 0) ? ((((0 * (0 * ((int) (outbufsize)) + ((int) (256))) + (1)) << (sizeof ((0 * ((int) (outbufsize)) + ((int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((int) (outbufsize)) + ((int) (256))) - (1)))) - ((int) (outbufsize)) < ((int) (256))) : ((int) (256)) < 0 ? ((int) (outbufsize)) <= ((int) (256)) + ((int) (outbufsize)) : ((int) (outbufsize)) < 0 ? ((int) (256)) <= ((int) (256)) + ((int) (outbufsize)) : ((int) (256)) + ((int) (outbufsize)) < ((int) (outbufsize))) || (((0 * (((int) (256)) + ((int) (outbufsize))) - (1)) < 0) && (((int) (256)) + ((int) (outbufsize))) < ((-2147483647 -1))) || (2147483647) < (((int) (256)) + ((int) (outbufsize)))) ? (*(&outbufsize) = (((unsigned int) ((int) (256)) + (unsigned int) ((int) (outbufsize))) <= (2147483647) ? (int) ((unsigned int) ((int) (256)) + (unsigned int) ((int) (outbufsize))) : ((int) (((unsigned int) ((int) (256)) + (unsigned int) ((int) (outbufsize))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&outbufsize) = (((unsigned int) ((int) (256)) + (unsigned int) ((int) (outbufsize))) <= (2147483647) ? (int) ((unsigned int) ((int) (256)) + (unsigned int) ((int) (outbufsize))) : ((int) (((unsigned int) ((int) (256)) + (unsigned int) ((int) (outbufsize))) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0)) : (((((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) < 0 ? ((outbufsize) < 0 ? (256) < ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) - (outbufsize) : ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) - (1)))) - (outbufsize) < (256)) : (256) < 0 ? (outbufsize) <= (256) + (outbufsize) : (outbufsize) < 0 ? (256) <= (256) + (outbufsize) : (256) + (outbufsize) < (outbufsize)) || (((0 * ((256) + (outbufsize)) - (1)) < 0) && ((256) + (outbufsize)) < ((-2147483647 -1))) || (2147483647) < ((256) + (outbufsize))) ? (*(&outbufsize) = (((unsigned int) (256) + (unsigned int) (outbufsize)) <= (2147483647) ? (int) ((unsigned int) (256) + (unsigned int) (outbufsize)) : ((int) (((unsigned int) (256) + (unsigned int) (outbufsize)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 1) : (*(&outbufsize) = (((unsigned int) (256) + (unsigned int) (outbufsize)) <= (2147483647) ? (int) ((unsigned int) (256) + (unsigned int) (outbufsize)) : ((int) (((unsigned int) (256) + (unsigned int) (outbufsize)) - ((-2147483647 -1))) + ((-2147483647 -1)))), 0))) : (sizeof *(&outbufsize) == sizeof (long int) ? (sizeof ((256) + (outbufsize)) < sizeof (long int) ? (((((((0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) + (0)) == -1) - ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) + (1)) << (sizeof ((0 * ((long int) (outbufsize)) + ((long int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) + (0)))) < 0 ? (((long int) (outbufsize)) < 0 ? ((long int) (256)) < ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) + (0)) == -1) - ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) + (1)) << (sizeof ((0 * ((long int) (outbufsize)) + ((long int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) + (0)))) - ((long int) (outbufsize)) : ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) - (1)) < 0) ? ((((0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) + (1)) << (sizeof ((0 * ((long int) (outbufsize)) + ((long int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long int) (outbufsize)) + ((long int) (256))) - (1)))) - ((long int) (outbufsize)) < ((long int) (256))) : ((long int) (256)) < 0 ? ((long int) (outbufsize)) <= ((long int) (256)) + ((long int) (outbufsize)) : ((long int) (outbufsize)) < 0 ? ((long int) (256)) <= ((long int) (256)) + ((long int) (outbufsize)) : ((long int) (256)) + ((long int) (outbufsize)) < ((long int) (outbufsize))) || (((0 * (((long int) (256)) + ((long int) (outbufsize))) - (1)) < 0) && (((long int) (256)) + ((long int) (outbufsize))) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < (((long int) (256)) + ((long int) (outbufsize)))) ? (*(&outbufsize) = (((unsigned long int) ((long int) (256)) + (unsigned long int) ((long int) (outbufsize))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (256)) + (unsigned long int) ((long int) (outbufsize))) : ((long int) (((unsigned long int) ((long int) (256)) + (unsigned long int) ((long int) (outbufsize))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&outbufsize) = (((unsigned long int) ((long int) (256)) + (unsigned long int) ((long int) (outbufsize))) <= (9223372036854775807L) ? (long int) ((unsigned long int) ((long int) (256)) + (unsigned long int) ((long int) (outbufsize))) : ((long int) (((unsigned long int) ((long int) (256)) + (unsigned long int) ((long int) (outbufsize))) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0)) : (((((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) < 0 ? ((outbufsize) < 0 ? (256) < ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) - (outbufsize) : ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) - (1)))) - (outbufsize) < (256)) : (256) < 0 ? (outbufsize) <= (256) + (outbufsize) : (outbufsize) < 0 ? (256) <= (256) + (outbufsize) : (256) + (outbufsize) < (outbufsize)) || (((0 * ((256) + (outbufsize)) - (1)) < 0) && ((256) + (outbufsize)) < ((-9223372036854775807L -1L))) || (9223372036854775807L) < ((256) + (outbufsize))) ? (*(&outbufsize) = (((unsigned long int) (256) + (unsigned long int) (outbufsize)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (256) + (unsigned long int) (outbufsize)) : ((long int) (((unsigned long int) (256) + (unsigned long int) (outbufsize)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 1) : (*(&outbufsize) = (((unsigned long int) (256) + (unsigned long int) (outbufsize)) <= (9223372036854775807L) ? (long int) ((unsigned long int) (256) + (unsigned long int) (outbufsize)) : ((long int) (((unsigned long int) (256) + (unsigned long int) (outbufsize)) - ((-9223372036854775807L -1L))) + ((-9223372036854775807L -1L)))), 0))) : (sizeof ((256) + (outbufsize)) < sizeof (long long int) ? (((((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) + (0)) == -1) - ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) + (1)) << (sizeof ((0 * ((long long int) (outbufsize)) + ((long long int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) + (0)))) < 0 ? (((long long int) (outbufsize)) < 0 ? ((long long int) (256)) < ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) - (1)) < 0) ? - (~ (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) + (0)) == -1) - ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) + (1)) << (sizeof ((0 * ((long long int) (outbufsize)) + ((long long int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) + (0)))) - ((long long int) (outbufsize)) : ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) - (1)) < 0) ? ((((0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) + (1)) << (sizeof ((0 * ((long long int) (outbufsize)) + ((long long int) (256))) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * ((long long int) (outbufsize)) + ((long long int) (256))) - (1)))) - ((long long int) (outbufsize)) < ((long long int) (256))) : ((long long int) (256)) < 0 ? ((long long int) (outbufsize)) <= ((long long int) (256)) + ((long long int) (outbufsize)) : ((long long int) (outbufsize)) < 0 ? ((long long int) (256)) <= ((long long int) (256)) + ((long long int) (outbufsize)) : ((long long int) (256)) + ((long long int) (outbufsize)) < ((long long int) (outbufsize))) || (((0 * (((long long int) (256)) + ((long long int) (outbufsize))) - (1)) < 0) && (((long long int) (256)) + ((long long int) (outbufsize))) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < (((long long int) (256)) + ((long long int) (outbufsize)))) ? (*(&outbufsize) = (((unsigned long long int) ((long long int) (256)) + (unsigned long long int) ((long long int) (outbufsize))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (256)) + (unsigned long long int) ((long long int) (outbufsize))) : ((long long int) (((unsigned long long int) ((long long int) (256)) + (unsigned long long int) ((long long int) (outbufsize))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&outbufsize) = (((unsigned long long int) ((long long int) (256)) + (unsigned long long int) ((long long int) (outbufsize))) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) ((long long int) (256)) + (unsigned long long int) ((long long int) (outbufsize))) : ((long long int) (((unsigned long long int) ((long long int) (256)) + (unsigned long long int) ((long long int) (outbufsize))) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0)) : (((((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) < 0 ? ((outbufsize) < 0 ? (256) < ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? - (~ (0 * (0 * (outbufsize) + (256)) + (0)) == -1) - ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) + (0)))) - (outbufsize) : ((((0 * (0 * (outbufsize) + (256)) - (1)) < 0) ? ((((0 * (0 * (outbufsize) + (256)) + (1)) << (sizeof ((0 * (outbufsize) + (256)) + 0) * 8 - 2)) - 1) * 2 + 1) : (0 * (0 * (outbufsize) + (256)) - (1)))) - (outbufsize) < (256)) : (256) < 0 ? (outbufsize) <= (256) + (outbufsize) : (outbufsize) < 0 ? (256) <= (256) + (outbufsize) : (256) + (outbufsize) < (outbufsize)) || (((0 * ((256) + (outbufsize)) - (1)) < 0) && ((256) + (outbufsize)) < ((-9223372036854775807LL -1LL))) || (9223372036854775807LL) < ((256) + (outbufsize))) ? (*(&outbufsize) = (((unsigned long long int) (256) + (unsigned long long int) (outbufsize)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (256) + (unsigned long long int) (outbufsize)) : ((long long int) (((unsigned long long int) (256) + (unsigned long long int) (outbufsize)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 1) : (*(&outbufsize) = (((unsigned long long int) (256) + (unsigned long long int) (outbufsize)) <= (9223372036854775807LL) ? (long long int) ((unsigned long long int) (256) + (unsigned long long int) (outbufsize)) : ((long long int) (((unsigned long long int) (256) + (unsigned long long int) (outbufsize)) - ((-9223372036854775807LL -1LL))) + ((-9223372036854775807LL -1LL)))), 0))))))
 ...
 while (j < 1024 && p < endp)
   source[j++] = (!((p)[0] & 0x80) ? *(p)++ : ! ((p)[0] & 0x20) ? ((p) += 2, ((((p)[-2] & 0x1F) << 6) | ((p)[-1] & 0x3F) | ((unsigned char) ((p)[-2]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((p)[0] & 0x10) ? ((p) += 3, ((((p)[-3] & 0x0F) << 12) | (((p)[-2] & 0x3F) << 6) | ((p)[-1] & 0x3F))) : string_char ((p), &(p), ((void*)0)));
      consumed_chars += j;
      consumed_bytes = p - SDATA (str);

      if (consumed_bytes == str_bytes)
 ccl.last_block = ((contin) == (builtin_lisp_symbol (0)));
      src = source;
      src_size = j;
      while (1)
 {
   int max_expansion = ((unibyte_p) == (builtin_lisp_symbol (0))) ? 5 : 1;
   ptrdiff_t offset, shortfall;
   ccl_driver (&ccl, src, destination, src_size, 1024,
   ...
   if (((unibyte_p) == (builtin_lisp_symbol (0))))
     {
       for (j = 0; j < ccl.produced; j++)
  do { if ((destination[j]) <= 0x7F) *(outp)++ = (destination[j]); else if ((destination[j]) <= 0x7FF) *(outp)++ = (0xC0 | ((destination[j]) >> 6)), *(outp)++ = (0x80 | ((destination[j]) & 0x3F)); else if ((destination[j]) <= 0xFFFF) *(outp)++ = (0xE0 | ((destination[j]) >> 12)), *(outp)++ = (0x80 | (((destination[j]) >> 6) & 0x3F)), *(outp)++ = (0x80 | ((destination[j]) & 0x3F)); else { extern int (*_gl_verify_function5 (void)) [(!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (destination[j]) <= sizeof (unsigned)) ? 1 : -1; }))]; (outp) += char_string (destination[j], outp); } } while (0);
     }
   else
     {
       for (j = 0; j < ccl.produced; j++)
 ...
 break;
  ...
  for (i = 0; i < 8; i++)
    ASET (status, i, ((EMACS_INT) (((EMACS_UINT) (ccl.reg[i]) << INTTYPEBITS) + Lisp_Int0)));
  ASET (status, 8, ((EMACS_INT) (((EMACS_UINT) (ccl.ic) << INTTYPEBITS) + Lisp_Int0)));

  val = make_specified_string ((const char *) outbuf, produced_chars,
          outp - outbuf, ((unibyte_p) == (builtin_lisp_symbol (0))));
  xfree (outbuf);

  return val;
}

static struct Lisp_Subr _Alignas (8) Sregister_ccl_program = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fregister_ccl_program }, 2, 2, "register-ccl-program", 0, 0}; Lisp_Object Fregister_ccl_program
     ...
     (Lisp_Object name, Lisp_Object ccl_prog)
{
  ...
  resolved = builtin_lisp_symbol (0);
  if (!((ccl_prog) == (builtin_lisp_symbol (0))))
    {
      CHECK_VECTOR (ccl_prog);
      resolved = resolve_symbol_ccl_program (ccl_prog);
      if (((resolved) == (builtin_lisp_symbol (0))))
 error ("Error in CCL program");
      if (VECTORP (resolved))
 {
   ccl_prog = resolved;
   resolved = builtin_lisp_symbol (901);
 }
      else
 resolved = builtin_lisp_symbol (0);
    }
      ...
      if (((name) == (AREF (slot, 0))))
 {
   ...
   ASET (slot, 3, builtin_lisp_symbol (901));
   return ((EMACS_INT) (((EMACS_UINT) (idx) << INTTYPEBITS) + Lisp_Int0));
 }
    }
...

  {
    ...
    ASET (elt, 1, ccl_prog);
    ASET (elt, 2, resolved);
    ASET (elt, 3, builtin_lisp_symbol (901));
    ASET (Vccl_program_table, idx, elt);
  }

  Fput (name, builtin_lisp_symbol (247), ((EMACS_INT) (((EMACS_UINT) (idx) << INTTYPEBITS) + Lisp_Int0)));
  return ((EMACS_INT) (((EMACS_UINT) (idx) << INTTYPEBITS) + Lisp_Int0));
}
# 2228 "ccl.c"
static struct Lisp_Subr _Alignas (8) Sregister_code_conversion_map = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fregister_code_conversion_map }, 2, 2, "register-code-conversion-map", 0, 0}; Lisp_Object Fregister_code_conversion_map
  ...
  (Lisp_Object symbol, Lisp_Object map)
{
  ...
  len = ASIZE (globals.f_Vcode_conversion_map_vector);

  for (i = 0; i < len; i++)
    {
      Lisp_Object slot = AREF (globals.f_Vcode_conversion_map_vector, i);

      if (!(((enum Lisp_Type) ((slot) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 break;

      if (((symbol) == ((((void) (0 && ((((enum Lisp_Type) ((slot) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((slot) - (Lisp_Cons))))->car)))
 {
   idx = ((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0));
   XSETCDR (slot, map);
   Fput (symbol, builtin_lisp_symbol (274), map);
   Fput (symbol, builtin_lisp_symbol (275), idx);
   return idx;
 }
    }

  if (i == len)
    globals.f_Vcode_conversion_map_vector = larger_vector (globals.f_Vcode_conversion_map_vector,
       1, -1);

  idx = ((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0));
  Fput (symbol, builtin_lisp_symbol (274), map);
  Fput (symbol, builtin_lisp_symbol (275), idx);
  ASET (globals.f_Vcode_conversion_map_vector, i, Fcons (symbol, map));
  return idx;
}
...
syms_of_ccl (void)
{
  ...
  Vccl_program_table = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (32) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0));
  ...
  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "code-conversion-map-vector", &globals.f_Vcode_conversion_map_vector); } while (0);

  globals.f_Vcode_conversion_map_vector = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (16) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0));

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "font-ccl-encoder-alist", &globals.f_Vfont_ccl_encoder_alist); } while (0);
# 2308 "ccl.c"
  globals.f_Vfont_ccl_encoder_alist = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "translation-hash-table-vector", &globals.f_Vtranslation_hash_table_vector); } while (0);




    globals.f_Vtranslation_hash_table_vector = builtin_lisp_symbol (0);
