...
static _Bool bidi_initialized = 0;
...
bidi_get_type (int ch, bidi_dir_t override)
{
  ...
  default_type = (bidi_type_t) ((CHAR_TABLE_REF (bidi_type_table, ch)) >> INTTYPEBITS);
...
{
  ((void) (0 && (UNKNOWN_BT <= type && type <= NEUTRAL_ON)));
}
  ...
  if (((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    {
      ...
      ((void) (0 && ((((sizeof ((((val) >> INTTYPEBITS)) + 0)) > (sizeof ((0x3FFFFF) + 0)) ? (sizeof ((((val) >> INTTYPEBITS)) + 0)) : (sizeof ((0x3FFFFF) + 0))) <= sizeof (unsigned) ? ((((val) >> INTTYPEBITS)) + (unsigned) 0) <= ((0x3FFFFF) + (unsigned) 0) : ((((val) >> INTTYPEBITS)) + (uintmax_t) 0) <= ((0x3FFFFF) + (uintmax_t) 0)))));
...
bidi_paired_bracket_type (int c)
{
  ...
  return (bidi_bracket_type_t) ((CHAR_TABLE_REF (bidi_brackets_table, c)) >> INTTYPEBITS);
}
...
bidi_push_embedding_level (struct bidi_it *bidi_it,
      int level, bidi_dir_t override, _Bool isolate_status)
{
  struct bidi_stack *st;
  int prev_level = bidi_it->level_stack[bidi_it->stack_idx].level;

  bidi_it->stack_idx++;
  ((void) (0 && (bidi_it->stack_idx < 125 +2+1)));
...
bidi_pop_embedding_level (struct bidi_it *bidi_it)
{
  ...
  if (bidi_it->stack_idx > 0)
    {
      _Bool isolate_status = ((bidi_it)->level_stack[bidi_it->stack_idx].flags & 1);
...
bidi_remember_char (struct bidi_saved_info *saved_info,
      struct bidi_it *bidi_it, _Bool from_type)
{
...
bidi_copy_it (struct bidi_it *to, struct bidi_it *from)
{
  ...
  memcpy (to, from,
   (__builtin_offsetof(struct bidi_it, level_stack) + sizeof from->level_stack[0]
    + from->stack_idx * sizeof from->level_stack[0]));
}
# 571 "bidi.c"
static ptrdiff_t bidi_cache_max_elts = 50000;
static struct bidi_it *bidi_cache;
static ptrdiff_t bidi_cache_size = 0;
enum { elsz = sizeof (struct bidi_it) };
static ptrdiff_t bidi_cache_idx;
static ptrdiff_t bidi_cache_last_idx;
static ptrdiff_t bidi_cache_start = 0;





static ptrdiff_t bidi_cache_start_stack[5];
...
{
  if (bidi_cache_size > 200)
    {
      bidi_cache = xrealloc (bidi_cache, 200 * elsz);
      bidi_cache_size = 200;
    }
  bidi_cache_reset ();
  bidi_cache_max_elts = 50000;
}
...
# 717 "bidi.c"
static ptrdiff_t
bidi_cache_find_level_change (int level, int dir, _Bool before)
{
  if (bidi_cache_idx)
    {
...
bidi_cache_ensure_space (ptrdiff_t idx)
{
  ...
  if (idx >= bidi_cache_size)
    {
      ptrdiff_t chunk_size = 200;

      if (bidi_cache_size > bidi_cache_max_elts - chunk_size)
 chunk_size = bidi_cache_max_elts - bidi_cache_size;

      if (((idx + 1) > (bidi_cache_size + chunk_size) ? (idx + 1) : (bidi_cache_size + chunk_size)) <= bidi_cache_max_elts)

 {


   ptrdiff_t string_or_buffer_bound
     = (((ptrdiff_t) (((9223372036854775807L >> INTTYPEBITS) - 1) < ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L)))) ? ((9223372036854775807L >> INTTYPEBITS) - 1) : ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L)))))) > (((ptrdiff_t) (((9223372036854775807L >> INTTYPEBITS)) < ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1) ? ((9223372036854775807L >> INTTYPEBITS)) : ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1)))) ? ((ptrdiff_t) (((9223372036854775807L >> INTTYPEBITS) - 1) < ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L)))) ? ((9223372036854775807L >> INTTYPEBITS) - 1) : ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L)))))) : (((ptrdiff_t) (((9223372036854775807L >> INTTYPEBITS)) < ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1) ? ((9223372036854775807L >> INTTYPEBITS)) : ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1)))));


   ptrdiff_t c_bound
     = ((((9223372036854775807L)) < ((18446744073709551615UL)) ? ((9223372036854775807L)) : ((18446744073709551615UL))) - bidi_shelve_header_size) / elsz;
   ptrdiff_t max_elts = bidi_cache_max_elts;

   max_elts = ((max_elts) < (((string_or_buffer_bound) < (c_bound) ? (string_or_buffer_bound) : (c_bound))) ? (max_elts) : (((string_or_buffer_bound) < (c_bound) ? (string_or_buffer_bound) : (c_bound))));



   bidi_cache = xpalloc (bidi_cache, &bidi_cache_size,
    ((chunk_size) > (idx - bidi_cache_size + 1) ? (chunk_size) : (idx - bidi_cache_size + 1)),
    max_elts, elsz);
   ((void) (0 && (bidi_cache_size > idx)));
 }
    }
}

static int
bidi_cache_iterator_state (struct bidi_it *bidi_it, _Bool resolved,
      _Bool update_only)
{
  ptrdiff_t idx;
...
static bidi_type_t
bidi_cache_find (ptrdiff_t charpos, _Bool resolved_only, struct bidi_it *bidi_it)
{
...
void
bidi_unshelve_cache (void *databuf, _Bool just_free)
{
...
bidi_initialize (void)
{
  ...
  if (((bidi_type_table) == (builtin_lisp_symbol (0))))
    emacs_abort ();
  staticpro (&bidi_type_table);

  bidi_mirror_table = uniprop_table (intern ("mirroring"));
  if (((bidi_mirror_table) == (builtin_lisp_symbol (0))))
    emacs_abort ();
  staticpro (&bidi_mirror_table);

  bidi_brackets_table = uniprop_table (intern ("bracket-type"));
  if (((bidi_brackets_table) == (builtin_lisp_symbol (0))))
    emacs_abort ();
  staticpro (&bidi_brackets_table);

                                              ;
  paragraph_start_re = Fsymbol_value (builtin_lisp_symbol (741));
  if (!STRINGP (paragraph_start_re))
    paragraph_start_re = build_string ("\f\\|[ \t]*$");
  staticpro (&paragraph_start_re);
                                                    ;
  paragraph_separate_re = Fsymbol_value (builtin_lisp_symbol (740));
...
void
bidi_init_it (ptrdiff_t charpos, ptrdiff_t bytepos, _Bool frame_window_p,
       struct bidi_it *bidi_it)
{
  if (! bidi_initialized)
    bidi_initialize ();
...
bidi_count_bytes (const unsigned char *s, ptrdiff_t beg,
    ptrdiff_t begbyte, ptrdiff_t end, _Bool unibyte)
{
  ptrdiff_t pos = beg;
...
static int
bidi_char_at_pos (ptrdiff_t bytepos, const unsigned char *s, _Bool unibyte)
{
  if (s)
    {
      s += bytepos;
 ...
 return *s;
    ...
    s = (((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1)));
  return (!((s)[0] & 0x80) ? (s)[0] : ! ((s)[0] & 0x20) ? (((((s)[0] & 0x1F) << 6) | ((s)[1] & 0x3F)) + (((unsigned char) (s)[0]) < 0xC2 ? 0x3FFF80 : 0)) : ! ((s)[0] & 0x10) ? ((((s)[0] & 0x0F) << 12) | (((s)[1] & 0x3F) << 6) | ((s)[2] & 0x3F)) : string_char ((s), ((void*)0), ((void*)0)));
}
# 1269 "bidi.c"
static int
bidi_fetch_char (ptrdiff_t charpos, ptrdiff_t bytepos, ptrdiff_t *disp_pos,
   ...
   struct window *w,
   _Bool frame_window_p, ptrdiff_t *ch_len, ptrdiff_t *nchars)
{
  int ch;
  ptrdiff_t endpos
    = (string->s || STRINGP (string->lstring)) ? string->schars : (current_buffer->zv);
  struct text_pos pos;
  int len;
 ...
 *ch_len = (buf_charpos_to_bytepos (current_buffer, disp_end_pos)) - bytepos;
    }
  else
    {
    normal_char:
      if (string->s)
 {
   ...
   if (!string->unibyte)
     {
       ch = (!((string->s + bytepos)[0] & 0x80) ? ((len) = 1, (string->s + bytepos)[0]) : ! ((string->s + bytepos)[0] & 0x20) ? ((len) = 2, (((((string->s + bytepos)[0] & 0x1F) << 6) | ((string->s + bytepos)[1] & 0x3F)) + (((unsigned char) (string->s + bytepos)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((string->s + bytepos)[0] & 0x10) ? ((len) = 3, ((((string->s + bytepos)[0] & 0x0F) << 12) | (((string->s + bytepos)[1] & 0x3F) << 6) | ((string->s + bytepos)[2] & 0x3F))) : string_char ((string->s + bytepos), ((void*)0), &len));
       *ch_len = len;
     }
   else
     {
       ch = ((((sizeof ((string->s[bytepos]) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((string->s[bytepos]) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((string->s[bytepos]) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((string->s[bytepos]) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (string->s[bytepos]) : ((string->s[bytepos]) + 0x3FFF00));
       *ch_len = 1;
     }
 }
      else if (STRINGP (string->lstring))
 {
   if (!string->unibyte)
     {
       ch = (!((SDATA (string->lstring) + bytepos)[0] & 0x80) ? ((len) = 1, (SDATA (string->lstring) + bytepos)[0]) : ! ((SDATA (string->lstring) + bytepos)[0] & 0x20) ? ((len) = 2, (((((SDATA (string->lstring) + bytepos)[0] & 0x1F) << 6) | ((SDATA (string->lstring) + bytepos)[1] & 0x3F)) + (((unsigned char) (SDATA (string->lstring) + bytepos)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((SDATA (string->lstring) + bytepos)[0] & 0x10) ? ((len) = 3, ((((SDATA (string->lstring) + bytepos)[0] & 0x0F) << 12) | (((SDATA (string->lstring) + bytepos)[1] & 0x3F) << 6) | ((SDATA (string->lstring) + bytepos)[2] & 0x3F))) : string_char ((SDATA (string->lstring) + bytepos), ((void*)0), &len));

       *ch_len = len;
     }
   else
     {
       ch = ((((sizeof ((SREF (string->lstring, bytepos)) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((SREF (string->lstring, bytepos)) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((SREF (string->lstring, bytepos)) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((SREF (string->lstring, bytepos)) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (SREF (string->lstring, bytepos)) : ((SREF (string->lstring, bytepos)) + 0x3FFF00));
       *ch_len = 1;
     }
 }
      else
 {
   ch = (!(((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[0] & 0x80) ? ((len) = 1, ((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[0]) : ! (((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[0] & 0x20) ? ((len) = 2, ((((((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[0] & 0x1F) << 6) | (((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[1] & 0x3F)) + (((unsigned char) ((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! (((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[0] & 0x10) ? ((len) = 3, (((((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[0] & 0x0F) << 12) | ((((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[1] & 0x3F) << 6) | (((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))))[2] & 0x3F))) : string_char (((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1)))), ((void*)0), &len));
   *ch_len = len;
 }
      *nchars = 1;
    }
  ...
  if (charpos + *nchars <= endpos && charpos + *nchars > *disp_pos
      && *disp_prop)
    {
      ((pos).charpos = (charpos + *nchars), (pos).bytepos = bytepos + *ch_len);
      *disp_pos = compute_display_string_pos (&pos, string, w, frame_window_p,
           disp_prop);
    }
...
bidi_fetch_char_skip_isolates (ptrdiff_t charpos, ptrdiff_t bytepos,
          ...
          struct bidi_string_data *string,
          struct window *w, _Bool frame_window_p,
...
bidi_at_paragraph_end (ptrdiff_t charpos, ptrdiff_t bytepos)
{
  ...
  val = fast_looking_at (sep_re, charpos, bytepos, (current_buffer->zv), (current_buffer->zv_byte), builtin_lisp_symbol (0));
  if (val < 0)
    {
      if (fast_looking_at (start_re, charpos, bytepos, (current_buffer->zv), (current_buffer->zv_byte), builtin_lisp_symbol (0)) >= 0)
 val = -1;
      else
 val = -2;
    }
...
bidi_find_paragraph_start (ptrdiff_t pos, ptrdiff_t pos_byte)
{
  ...
  ptrdiff_t limit = (current_buffer->zv), limit_byte = (current_buffer->zv_byte);
  ...
  while (pos_byte > (current_buffer->begv_byte)
  && n++ < 7500
  && fast_looking_at (re, pos, pos_byte, limit, limit_byte, builtin_lisp_symbol (0)) < 0)
    {
 ...
 {
   pos = next, pos_byte = (buf_charpos_to_bytepos (current_buffer, pos));
   break;
 }
      else
 pos = find_newline_no_quit (pos, pos_byte, -1, &pos_byte);
  ...
  if (n >= 7500)
    pos = (current_buffer->begv), pos_byte = (current_buffer->begv_byte);
  if (bpc)
    know_region_cache (cache_buffer, bpc, pos, oldpos);


  pos_byte = clip_to_bounds ((current_buffer->begv_byte), pos_byte, (current_buffer->zv_byte));
  return pos_byte;
}
# 1583 "bidi.c"
static bidi_type_t
find_first_strong_char (ptrdiff_t pos, ptrdiff_t bytepos, ptrdiff_t end,
   ...
   _Bool string_p, _Bool frame_window_p,
   ptrdiff_t *ch_len, ptrdiff_t *nchars, _Bool stop_at_pdi)
{
  ptrdiff_t pos1;
  bidi_type_t type;
  int ch;
...
# 1657 "bidi.c"
void
bidi_paragraph_init (bidi_dir_t dir, struct bidi_it *bidi_it, _Bool no_default_p)
{
  ptrdiff_t bytepos = bidi_it->bytepos;
  _Bool string_p = bidi_it->string.s || STRINGP (bidi_it->string.lstring);
  ptrdiff_t pstartbyte;



  ptrdiff_t begbyte = string_p ? 0 : (current_buffer->begv_byte);
  ptrdiff_t end = string_p ? bidi_it->string.schars : (current_buffer->zv);
 ...
 bytepos = pstartbyte;
 if (!string_p)
   pos = (buf_bytepos_to_charpos (current_buffer, bytepos));
 ...
 if (!string_p
     && no_default_p && bidi_it->paragraph_dir == NEUTRAL_DIR)
   {
     ...
     if (pstartbyte == (current_buffer->begv_byte))
       bidi_it->paragraph_dir = L2R;
     else
       {
  ptrdiff_t prevpbyte = pstartbyte;
  ptrdiff_t p = (buf_bytepos_to_charpos (current_buffer, pstartbyte)), pbyte = pstartbyte;


  while (pbyte > (current_buffer->begv_byte) && prevpbyte >= pstartbyte)
    {



      do { (p)--; if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) (pbyte)--; else do { unsigned char *chp; (pbyte)--; if ((pbyte) < (current_buffer->text->gpt_byte)) chp = (current_buffer->text->beg) + (pbyte) - ((1)); else chp = (current_buffer->text->beg) + (current_buffer->text->gap_size) + (pbyte) - ((1)); while (!(((*chp) & 0xC0) != 0x80)) { chp--; (pbyte)--; } } while (0); } while (0);
...
bidi_explicit_dir_char (int ch)
{
  ...
  ch_type = (bidi_type_t) ((CHAR_TABLE_REF (bidi_type_table, ch)) >> INTTYPEBITS);
...
bidi_resolve_explicit (struct bidi_it *bidi_it)
{
  ...
  int new_level;
  bidi_dir_t override;
  _Bool isolate_status;
  _Bool string_p = bidi_it->string.s || STRINGP (bidi_it->string.lstring);
  ptrdiff_t ch_len, nchars, disp_pos, end;
  int disp_prop;
  ptrdiff_t eob
    = ((bidi_it->string.s || STRINGP (bidi_it->string.lstring))
       ? bidi_it->string.schars : (current_buffer->zv));


  if (bidi_it->type_after_wn != WEAK_BN
 ...
 bidi_it->bracket_pairing_pos = -1;
  ...
  if (bidi_it->bytepos < (string_p ? 0 : (current_buffer->begv_byte))
      || bidi_it->first_elt)
    {
      bidi_it->first_elt = 0;
      if (string_p)
 {
   ...
   ((void) (0 && (bidi_it->bytepos == bidi_count_bytes (p, 0, 0, bidi_it->charpos, bidi_it->string.unibyte))));


 }
      else
 {
   if (bidi_it->charpos < (current_buffer->begv))
     {
       bidi_it->charpos = (current_buffer->begv);
       bidi_it->bytepos = (current_buffer->begv_byte);
     }
   ((void) (0 && (bidi_it->bytepos == (buf_charpos_to_bytepos (current_buffer, bidi_it->charpos)))));
 }
 ...
 {
   ((void) (0 && (bidi_it->prev.charpos == bidi_it->charpos - 1)));
   prev_type = bidi_it->prev.orig_type;
 }
    }

  else if (bidi_it->charpos < (string_p ? bidi_it->string.schars : (current_buffer->zv)))
    {
 ...
 emacs_abort ();
  ...
  isolate_status = ((bidi_it)->level_stack[bidi_it->stack_idx].flags & 1);
  override = (((bidi_it)->level_stack[bidi_it->stack_idx].flags >> 1) & 3);
  new_level = current_level;

  if (bidi_it->charpos >= (string_p ? bidi_it->string.schars : (current_buffer->zv)))
    {
      curchar = (-1);
      bidi_it->ch_len = 1;
      bidi_it->nchars = 1;
      bidi_it->disp_pos = (string_p ? bidi_it->string.schars : (current_buffer->zv));
      bidi_it->disp_prop = 0;
    }
  else
    {
   ...
   && bidi_it->invalid_isolates == 0)
 {
   ...
   if (bidi_it->type_after_wn == RLE)
     ...
     override = R2L;
   bidi_push_embedding_level (bidi_it, new_level, override, 0);
   bidi_it->resolved_level = new_level;
 }
      else
 {
      ...
      else
 {
   if (bidi_it->invalid_isolates == 0)
     bidi_it->invalid_levels++;
      ...
      break;
    case FSI:
      end = string_p ? bidi_it->string.schars : (current_buffer->zv);
 ...
 {
   bidi_it->invalid_levels = 0;
   while (!((bidi_it)->level_stack[bidi_it->stack_idx].flags & 1))
     bidi_pop_embedding_level (bidi_it);
   ((void) (0 && (bidi_it->stack_idx > 0)));
   new_level = bidi_pop_embedding_level (bidi_it);
   bidi_it->isolate_level--;
 }
      bidi_it->resolved_level = new_level;
      ...
      {
 bidi_dir_t stack_override = (((bidi_it)->level_stack[bidi_it->stack_idx].flags >> 1) & 3);
 if (stack_override == L2R)
  ...
  ((void) (0 && (bidi_it->resolved_level >= 0)));
...
bidi_resolve_weak (struct bidi_it *bidi_it)
{
  ...
  ((void) (0 && (!(type == UNKNOWN_BT || type == LRE || type == LRO || type == RLE || type == RLO || type == PDF))));
...
# 2222 "bidi.c"
       ...
       if (bidi_isolate_fmt_char (bidi_it->prev.type))
  {
    ...
    ((void) (0 && (bidi_it->invalid_isolates > 0)));
    type = NEUTRAL_ON;
  }
       else
  {
         ...
         || bidi_it->prev.type == WEAK_AN)))
 {
  ...
  type = WEAK_EN;
      ...
      else if (type == WEAK_ET
        || type == WEAK_BN)
 {
   if (bidi_it->prev.type == WEAK_EN)
     type = WEAK_EN;
   else if (bidi_it->next_en_pos > bidi_it->charpos
     && bidi_it->next_en_type != WEAK_BN)
     {
       if (bidi_it->next_en_type == WEAK_EN)
  type = WEAK_EN;
     }
...
# 2339 "bidi.c"
  ...
  if (type == WEAK_ES || type == WEAK_ET || type == WEAK_CS
      || (type == WEAK_BN
   && (bidi_it->prev.type == WEAK_CS
...
bidi_find_bracket_pairs (struct bidi_it *bidi_it)
{
  ...
  if (btype == BIDI_BRACKET_OPEN)
    {
      bpa_stack_entry bpa_stack[((int)((MAX_ALLOCA / sizeof (bpa_stack_entry)) > (1) ? (MAX_ALLOCA / sizeof (bpa_stack_entry)) : (1)))];
      int bpa_sp = -1;
      struct bidi_it saved_it;
      ...
      _Bool l2r_seen = 0, r2l_seen = 0;
      ptrdiff_t pairing_pos;
      int idx_at_entry = bidi_cache_idx;

      ((void) (0 && (((int)((MAX_ALLOCA / sizeof (bpa_stack_entry)) > (1) ? (MAX_ALLOCA / sizeof (bpa_stack_entry)) : (1))) >= 100)));
      bidi_copy_it (&saved_it, bidi_it);
      ...
      while (1)
 {
   ...
   if (btype == BIDI_BRACKET_OPEN)
     do { int ch; if (bpa_sp < ((int)((MAX_ALLOCA / sizeof (bpa_stack_entry)) > (1) ? (MAX_ALLOCA / sizeof (bpa_stack_entry)) : (1))) - 1) { bpa_sp++; ch = ( (((sizeof ((bidi_it->ch) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((bidi_it->ch) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((bidi_it->ch) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((bidi_it->ch) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? bidi_it->ch : (bidi_it->ch) == LEFT_POINTING_ANGLE_BRACKET ? LEFT_ANGLE_BRACKET : (bidi_it->ch) == RIGHT_POINTING_ANGLE_BRACKET ? RIGHT_ANGLE_BRACKET : bidi_it->ch ); bpa_stack[bpa_sp].close_bracket_char = bidi_mirror_char (ch); bpa_stack[bpa_sp].open_bracket_idx = bidi_cache_last_idx; bpa_stack[bpa_sp].flags = 0; ; } } while (0);
   else if (btype == BIDI_BRACKET_CLOSE)
     {
       int sp = bpa_sp;
       int curchar = ( (((sizeof ((bidi_it->ch) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((bidi_it->ch) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((bidi_it->ch) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((bidi_it->ch) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? bidi_it->ch : (bidi_it->ch) == LEFT_POINTING_ANGLE_BRACKET ? LEFT_ANGLE_BRACKET : (bidi_it->ch) == RIGHT_POINTING_ANGLE_BRACKET ? RIGHT_ANGLE_BRACKET : bidi_it->ch );
       ...
       if (sp >= 0)
  {
    ...
    if (bpa_stack[sp].flags & 1)
      tem_it.bracket_enclosed_type = embedding_type;
    else if (bpa_stack[sp].flags & 2)
      tem_it.bracket_enclosed_type
       ...
       if (flag)
  {
   ...
   if (bidi_it->level_stack[new_sidx].level > current_level
       && (((bidi_it)->level_stack[new_sidx].flags & 1)
    || (new_sidx > old_sidx + 1
        && ((bidi_it)->level_stack[new_sidx - 1].flags & 1))))
     {
...
bidi_resolve_brackets (struct bidi_it *bidi_it)
{
      ...
      if (type == NEUTRAL_ON)
 {
  ...
  type = bidi_it->bracket_enclosed_type;
    ...
    {
      ((void) (0 && (bidi_it->resolved_level == -1)));
   ...
   && ((bidi_it)->level_stack[bidi_it->stack_idx].flags & 1))
 {
  ...
  if (resolve_bracket)
    {
      ...
      ((void) (0 && (bidi_it->prev_for_neutral.type != UNKNOWN_BT)));
      ((void) (0 && (bidi_it->bracket_pairing_pos > bidi_it->charpos)));
      if (bidi_it->bracket_enclosed_type == embedding_type)
 type = embedding_type;
      else
 {
  ...
  : embedding_type;
     ...
     case STRONG_L:
       type =
  (bidi_it->bracket_enclosed_type == STRONG_L)
  ? STRONG_L
  : embedding_type;
       break;
     default:
      ...
      ((void) (0 && (type == STRONG_L || type == STRONG_R || type == NEUTRAL_ON)));
...
bidi_resolve_neutral (struct bidi_it *bidi_it)
{
  ...
  ((void) (0 && (type == STRONG_R || type == STRONG_L || type == WEAK_BN || type == WEAK_EN || type == WEAK_AN || type == NEUTRAL_B || type == NEUTRAL_S || type == NEUTRAL_WS || type == NEUTRAL_ON || type == LRI || type == RLI || type == PDI)));
# 2970 "bidi.c"
  current_level = bidi_it->level_stack[bidi_it->stack_idx].level;
  ((void) (0 && (current_level >= 0)));
...
# 3004 "bidi.c"
        ...
        && ((((sizeof ((bidi_it->ch) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((bidi_it->ch) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((bidi_it->ch) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((bidi_it->ch) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0))
     || (type != WEAK_BN
         && !bidi_explicit_dir_char (bidi_it->ch)
...
# 3036 "bidi.c"
   ...
   _Bool adjacent_to_neutrals = is_neutral;
...
bidi_level_of_next_char (struct bidi_it *bidi_it)
{
      ...
      if (type != UNKNOWN_BT)
 {
  ...
  ((void) (0 && ((type == STRONG_R || type == STRONG_L || type == WEAK_BN || type == WEAK_EN || type == WEAK_AN))));
  ...
  if ((bidi_it->orig_type == NEUTRAL_WS
      ...
      && level != bidi_it->level_stack[0].level)
    {
      ...
      bidi_type_t chtype;
      _Bool fwp = bidi_it->frame_window_p;
 ...
 chtype = bidi_get_type (ch, NEUTRAL_DIR);
  ...
  if (bidi_it->orig_type == NEUTRAL_B
...
# 3330 "bidi.c"
static void
bidi_find_other_level_edge (struct bidi_it *bidi_it, int level, _Bool end_flag)
{
 ...
 if (!bidi_cache_iterator_state (bidi_it, 1, 0))
   {
     ...
     ((void) (0 && (new_level == bidi_it->level_stack[0].level)));
...
bidi_move_to_visually_next (struct bidi_it *bidi_it)
{
      ...
      if (bidi_it->first_elt)
 {
  ...
  if (new_level != old_level)
    {
      _Bool ascending = new_level > old_level;
...
# 3455 "bidi.c"
      ...
      while (next_level != expected_next_level)
 {
   ...
   ((void) (0 && (incr > 0 ? next_level > expected_next_level : next_level < expected_next_level)));
...
# 3487 "bidi.c"
 ...
 bidi_it->separator_limit = bidi_it->string.schars;
      else if (bidi_it->bytepos < (current_buffer->zv_byte))
 {
   ptrdiff_t sep_len
 ...
 bidi_cache_iterator_state (bidi_it, 1, 0);
  ...
  ((void) (0 && (bidi_it->resolved_level >= 0 && bidi_it->resolved_level <= 125 + 2)));
...
{
  ptrdiff_t found_pos = (current_buffer->zv);
 ...
 found_pos = bidi_it->charpos;
    } while (found_pos == (current_buffer->zv)
      && bidi_it->charpos < (current_buffer->zv)
      && bidi_it->ch != (-1)
      && bidi_it->ch != '\n');
...
void bidi_dump_cached_states (void) ;
void
bidi_dump_cached_states (void)
{
  ...
  fprintf (stderr, "Total of  %""l""d state%s in cache:\n",
  ...
  fputs ("pos ", stderr);
  for (i = 0; i < bidi_cache_idx; i++)
    fprintf (stderr, "%*""l""d", ndigits, bidi_cache[i].charpos);
  fputs ("\n", stderr);
}
