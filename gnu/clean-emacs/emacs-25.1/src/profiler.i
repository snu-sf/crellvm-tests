...
{
  return ((a + b) < ((9223372036854775807L >> INTTYPEBITS)) ? (a + b) : ((9223372036854775807L >> INTTYPEBITS)));
}
...
make_log (EMACS_INT heap_size, EMACS_INT max_stack_depth)
{
  ...
  Lisp_Object log = make_hash_table (hashtest_profiler,
         ((EMACS_INT) (((EMACS_UINT) (heap_size) << INTTYPEBITS) + Lisp_Int0)),
  ...
  while (i > 0)
    set_hash_key_slot (h, --i,
         Fmake_vector (((EMACS_INT) (((EMACS_UINT) (max_stack_depth) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0)));
  return log;
}
# 79 "profiler.c"
         ...
         ptrdiff_t start, ptrdiff_t size)
{
  ((void) (0 && (size > 0)));
  if (size < 2)
    return ((HASH_VALUE (log, start)) >> INTTYPEBITS);
  if (size < 3)


    return ((((HASH_VALUE (log, start)) >> INTTYPEBITS)
      + ((HASH_VALUE (log, start + 1)) >> INTTYPEBITS))
     / 2);
  else
    {
...
static void evict_lower_half (log_t *log)
{
  ...
  for (i = 0; i < size; i++)
    ...
    if (((HASH_VALUE (log, i)) >> INTTYPEBITS) <= median)
      {
 Lisp_Object key = HASH_KEY (log, i);
 {
   Lisp_Object tmp;
   ((((tmp) = make_lisp_ptr (log, Lisp_Vectorlike)), ((void) (0 && (((((struct vectorlike_header *) ((void *) (intptr_t) ((tmp) - (Lisp_Vectorlike)))) ->size) & (((9223372036854775807L) - (9223372036854775807L) / 2) | PVEC_TYPE_MASK)) == (((9223372036854775807L) - (9223372036854775807L) / 2) | (PVEC_HASH_TABLE << PSEUDOVECTOR_AREA_BITS)))))));
   Fremhash (key, tmp);
 }
 ((void) (0 && (((log->next_free) == (((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0)))))));

 ((void) (0 && (VECTORP (key))));
 for (ptrdiff_t j = 0; j < ASIZE (key); j++)
   ASET (key, j, builtin_lisp_symbol (0));
...
record_backtrace (log_t *log, EMACS_INT count)
{
  ...
  if (!((((enum Lisp_Type) ((log->next_free) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))


    evict_lower_half (log);
  index = ((log->next_free) >> INTTYPEBITS);
...

  {
    ...
    if (j >= 0)
      {
 EMACS_INT old_val = ((HASH_VALUE (log, j)) >> INTTYPEBITS);
 EMACS_INT new_val = saturated_add (old_val, count);
 set_hash_value_slot (log, j, ((EMACS_INT) (((EMACS_UINT) (new_val) << INTTYPEBITS) + Lisp_Int0)));
      }
    else
      {

 ((void) (0 && (!((log->next_free) == (builtin_lisp_symbol (0))))));
 ptrdiff_t j = hash_put (log, backtrace, ((EMACS_INT) (((EMACS_UINT) (count) << INTTYPEBITS) + Lisp_Int0)), hash);
...
static _Bool profiler_timer_ok;
...
{
  if (((backtrace_top_function ()) == (builtin_lisp_symbol (192))))
...
setup_cpu_timer (Lisp_Object sampling_interval)
{
  ...
  if (! RANGED_INTEGERP (1, sampling_interval,
    (((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) -1 : ((((time_t) 1 << (sizeof (time_t) * 8 - 2)) - 1) * 2 + 1))) < 9223372036854775807L / billion
     ? ((EMACS_INT) ((time_t) (! (! ((time_t) 0 < (time_t) -1)) ? (time_t) -1 : ((((time_t) 1 << (sizeof (time_t) * 8 - 2)) - 1) * 2 + 1))) * billion
        + (billion - 1))
     : 9223372036854775807L)))
    return -1;

  current_sampling_interval = ((sampling_interval) >> INTTYPEBITS);
  interval = make_timespec (current_sampling_interval / billion,
       current_sampling_interval % billion);
  emacs_sigaction_init (&action, deliver_profiler_signal);
  sigaction (27, &action, 0);
 ...
 0
      ...
      sigev.sigev_signo = 27;
      sigev.sigev_notify = SIGEV_SIGNAL;

      for (i = 0; i < (sizeof (system_clock) / sizeof (system_clock)[0]); i++)
...
static struct Lisp_Subr _Alignas (8) Sprofiler_cpu_start = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fprofiler_cpu_start }, 1, 1, "profiler-cpu-start", 0, 0}; Lisp_Object Fprofiler_cpu_start
  ...
  (Lisp_Object sampling_interval)
{
  ...
  if (((cpu_log) == (builtin_lisp_symbol (0))))
    {
      cpu_gc_count = 0;
      cpu_log = make_log (globals.f_profiler_log_size,
     globals.f_profiler_max_stack_depth);
    }
...
static struct Lisp_Subr _Alignas (8) Sprofiler_cpu_stop = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fprofiler_cpu_stop }, 0, 0, "profiler-cpu-stop", 0, 0}; Lisp_Object Fprofiler_cpu_stop
  ...
  (void)
{
 ...
 setitimer (ITIMER_PROF, &disable, 0);
  ...
  signal (27, ((__sighandler_t) 1));
  profiler_cpu_running = NOT_RUNNING;
  return builtin_lisp_symbol (901);
}

static struct Lisp_Subr _Alignas (8) Sprofiler_cpu_running_p = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fprofiler_cpu_running_p }, 0, 0, "profiler-cpu-running-p", 0, 0}; Lisp_Object Fprofiler_cpu_running_p



  (void)
{
  return profiler_cpu_running ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Sprofiler_cpu_log = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fprofiler_cpu_log }, 0, 0, "profiler-cpu-log", 0, 0}; Lisp_Object Fprofiler_cpu_log
  ...
  (void)
{
  ...
  cpu_log = (profiler_cpu_running
      ? make_log (globals.f_profiler_log_size, globals.f_profiler_max_stack_depth)
      : builtin_lisp_symbol (0));
  Fputhash (Fmake_vector (((EMACS_INT) (((EMACS_UINT) (1) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (192)),
     ((EMACS_INT) (((EMACS_UINT) (cpu_gc_count) << INTTYPEBITS) + Lisp_Int0)),
     result);
  cpu_gc_count = 0;
  return result;
}
...
_Bool profiler_memory_running;

static Lisp_Object memory_log;

static struct Lisp_Subr _Alignas (8) Sprofiler_memory_start = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fprofiler_memory_start }, 0, 0, "profiler-memory-start", 0, 0}; Lisp_Object Fprofiler_memory_start
  ...
  (void)
{
  ...
  if (((memory_log) == (builtin_lisp_symbol (0))))
    memory_log = make_log (globals.f_profiler_log_size,
      globals.f_profiler_max_stack_depth);
...
static struct Lisp_Subr _Alignas (8) Sprofiler_memory_stop = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fprofiler_memory_stop }, 0, 0, "profiler-memory-stop", 0, 0}; Lisp_Object Fprofiler_memory_stop
...
static struct Lisp_Subr _Alignas (8) Sprofiler_memory_running_p = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fprofiler_memory_running_p }, 0, 0, "profiler-memory-running-p", 0, 0}; Lisp_Object Fprofiler_memory_running_p



  (void)
{
  return profiler_memory_running ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Sprofiler_memory_log = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fprofiler_memory_log }, 0, 0, "profiler-memory-log", 0, 0}; Lisp_Object Fprofiler_memory_log
...
{
  ((void) (0 && (HASH_TABLE_P (memory_log))));
  record_backtrace (XHASH_TABLE (memory_log), ((size) < ((9223372036854775807L >> INTTYPEBITS)) ? (size) : ((9223372036854775807L >> INTTYPEBITS))));
}

static struct Lisp_Subr _Alignas (8) Sfunction_equal = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Ffunction_equal }, 2, 2, "function-equal", 0, 0}; Lisp_Object Ffunction_equal
     ...
     (Lisp_Object f1, Lisp_Object f2)
{
  ...
  if (((f1) == (f2)))
    ...
    res = ((AREF (f1, COMPILED_BYTECODE)) == (AREF (f2, COMPILED_BYTECODE)));
  else if ((((enum Lisp_Type) ((f1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((enum Lisp_Type) ((f2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((f1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f1) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((f2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f2) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)
    && ((builtin_lisp_symbol (271)) == ((((void) (0 && ((((enum Lisp_Type) ((f1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f1) - (Lisp_Cons))))->car))
    && ((builtin_lisp_symbol (271)) == ((((void) (0 && ((((enum Lisp_Type) ((f2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f2) - (Lisp_Cons))))->car)))
    res = (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((f1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f1) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((f1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f1) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) == ((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((f2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f2) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((f2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f2) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr));
  else
    res = 0;
  return res ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0);
}
  ...
  Lisp_Object bt1, Lisp_Object bt2)
{
 ...
 return 0;
      for (i = 0; i < l; i++)
 if (((Ffunction_equal (AREF (bt1, i), AREF (bt2, i))) == (builtin_lisp_symbol (0))))
   return 0;
      return 1;
    }
  else
      ...
      for (i = 0; i < l; i++)
 {
   ...
   EMACS_UINT hash1
     = (COMPILEDP (f) ? XUINT (AREF (f, COMPILED_BYTECODE))
        : ((((enum Lisp_Type) ((f) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((f) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ((builtin_lisp_symbol (271)) == ((((void) (0 && ((((enum Lisp_Type) ((f) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f) - (Lisp_Cons))))->car)))
        ? XUINT ((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((f) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((f) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((f) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) : XUINT (f));
...
{
  do { static struct Lisp_Intfwd i_fwd; defvar_int (&i_fwd, "profiler-max-stack-depth", &globals.f_profiler_max_stack_depth); } while (0);

  globals.f_profiler_max_stack_depth = 16;
  do { static struct Lisp_Intfwd i_fwd; defvar_int (&i_fwd, "profiler-log-size", &globals.f_profiler_log_size); } while (0);



  globals.f_profiler_log_size = 10000;

                                                                ;

  hashtest_profiler.name = builtin_lisp_symbol (776);
  hashtest_profiler.user_hash_function = builtin_lisp_symbol (0);
  hashtest_profiler.user_cmp_function = builtin_lisp_symbol (0);
  ...
  profiler_memory_running = 0;
  memory_log = builtin_lisp_symbol (0);
