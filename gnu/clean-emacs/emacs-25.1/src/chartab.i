...
{
  ((CHAR_TABLE_P (x)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (259), x));
}
...
static struct Lisp_Subr _Alignas (8) Smake_char_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fmake_char_table }, 1, 2, "make-char-table", 0, 0}; Lisp_Object Fmake_char_table
  ...
  (register Lisp_Object purpose, Lisp_Object init)
{
  ...
  (((((enum Lisp_Type) ((purpose) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Symbol)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (897), purpose));
  n = Fget (purpose, builtin_lisp_symbol (258));
  if (((n) == (builtin_lisp_symbol (0))))
  ...
  else
    {
      CHECK_NATNUM (n);
      if (((n) >> INTTYPEBITS) > 10)
 args_out_of_range (n, builtin_lisp_symbol (0));
      n_extras = ((n) >> INTTYPEBITS);
    }

  size = CHAR_TABLE_STANDARD_SLOTS + n_extras;
  vector = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (size) << INTTYPEBITS) + Lisp_Int0)), init);
  ((XVECTOR (vector))->header.size |= ((9223372036854775807L) - (9223372036854775807L) / 2) | ((PVEC_CHAR_TABLE) << PSEUDOVECTOR_AREA_BITS));
  set_char_table_parent (vector, builtin_lisp_symbol (0));
  set_char_table_purpose (vector, purpose);
  ((((vector) = make_lisp_ptr (XCHAR_TABLE (vector), Lisp_Vectorlike)), ((void) (0 && (((((struct vectorlike_header *) ((void *) (intptr_t) ((vector) - (Lisp_Vectorlike)))) ->size) & (((9223372036854775807L) - (9223372036854775807L) / 2) | PVEC_TYPE_MASK)) == (((9223372036854775807L) - (9223372036854775807L) / 2) | (PVEC_CHAR_TABLE << PSEUDOVECTOR_AREA_BITS)))))));
  return vector;
}
...
char_table_ascii (Lisp_Object table)
{
  ...
  if ((((XCHAR_TABLE (table)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (table)) == 5) && (STRINGP (val) && SCHARS (val) > 0 && ((SREF (val, 0) == 1 || (SREF (val, 0) == 2)))))
...
copy_sub_char_table (Lisp_Object table)
{
  ...
  Lisp_Object copy = make_sub_char_table (depth, min_char, builtin_lisp_symbol (0));
  int i;
...
copy_char_table (Lisp_Object table)
{
  ...
  copy = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (size) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0));
  ((XVECTOR (copy))->header.size |= ((9223372036854775807L) - (9223372036854775807L) / 2) | ((PVEC_CHAR_TABLE) << PSEUDOVECTOR_AREA_BITS));
 ...
 : XCHAR_TABLE (table)->contents[i]));
  ...
  ((((copy) = make_lisp_ptr (XCHAR_TABLE (copy), Lisp_Vectorlike)), ((void) (0 && (((((struct vectorlike_header *) ((void *) (intptr_t) ((copy) - (Lisp_Vectorlike)))) ->size) & (((9223372036854775807L) - (9223372036854775807L) / 2) | PVEC_TYPE_MASK)) == (((9223372036854775807L) - (9223372036854775807L) / 2) | (PVEC_CHAR_TABLE << PSEUDOVECTOR_AREA_BITS)))))));
  return copy;
}

static Lisp_Object
sub_char_table_ref (Lisp_Object table, int c, _Bool is_uniprop)
{
  struct Lisp_Sub_Char_Table *tbl = XSUB_CHAR_TABLE (table);
  Lisp_Object val;
  int idx = (((c) - (tbl->min_char)) >> chartab_bits[(tbl->depth)]);

  val = tbl->contents[idx];
  if (is_uniprop && (STRINGP (val) && SCHARS (val) > 0 && ((SREF (val, 0) == 1 || (SREF (val, 0) == 2)))))
...
char_table_ref (Lisp_Object table, int c)
{
 ...
 val = XSUB_CHAR_TABLE (val)->contents[c];
    ...
    {
      val = tbl->contents[(((c) - (0)) >> chartab_bits[(0)])];
      if (SUB_CHAR_TABLE_P (val))
 val = sub_char_table_ref (val, c, (((XCHAR_TABLE (table)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (table)) == 5));
    }
  if (((val) == (builtin_lisp_symbol (0))))
    {
      val = tbl->defalt;
      if (((val) == (builtin_lisp_symbol (0))) && CHAR_TABLE_P (tbl->parent))
...
sub_char_table_ref_and_range (Lisp_Object table, int c, int *from, int *to,
         Lisp_Object defalt, _Bool is_uniprop)
{
  struct Lisp_Sub_Char_Table *tbl = XSUB_CHAR_TABLE (table);
  int depth = tbl->depth, min_char = tbl->min_char;
  int chartab_idx = (((c) - (min_char)) >> chartab_bits[(depth)]), idx;
  Lisp_Object val;
  ...
  else if (((val) == (builtin_lisp_symbol (0))))
    val = defalt;
  ...
  while (idx > 0 && *from < min_char + idx * chartab_chars[depth])
    {
      ...
      if (is_uniprop && (STRINGP (this_val) && SCHARS (this_val) > 0 && ((SREF (this_val, 0) == 1 || (SREF (this_val, 0) == 2)))))
 this_val = uniprop_table_uncompress (table, idx);
      if (SUB_CHAR_TABLE_P (this_val))
 this_val = sub_char_table_ref_and_range (this_val, c, from, to, defalt,
       is_uniprop);
      else if (((this_val) == (builtin_lisp_symbol (0))))
 this_val = defalt;
...
{
  struct Lisp_Char_Table *tbl = XCHAR_TABLE (table);
  int chartab_idx = (((c) - (0)) >> chartab_bits[(0)]), idx;
  Lisp_Object val;
  _Bool is_uniprop = (((XCHAR_TABLE (table)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (table)) == 5);
...
static void
sub_char_table_set (Lisp_Object table, int c, Lisp_Object val, _Bool is_uniprop)
{
  struct Lisp_Sub_Char_Table *tbl = XSUB_CHAR_TABLE (table);
  int depth = tbl->depth, min_char = tbl->min_char;
  int i = (((c) - (min_char)) >> chartab_bits[(depth)]);
  Lisp_Object sub;
  ...
  if (depth == 3)
  ...
  else
    {
      ...
      if (! SUB_CHAR_TABLE_P (sub))
 {
   if (is_uniprop && (STRINGP (sub) && SCHARS (sub) > 0 && ((SREF (sub, 0) == 1 || (SREF (sub, 0) == 2)))))
...
char_table_set (Lisp_Object table, int c, Lisp_Object val)
{
      ...
      if (! SUB_CHAR_TABLE_P (sub))
 {
   ...
   set_char_table_contents (table, i, sub);
      ...
      sub_char_table_set (sub, c, val, (((XCHAR_TABLE (table)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (table)) == 5));
      if ((((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)))
     ...
     _Bool is_uniprop)
{
  ...
  if (from < min_char)
    from = min_char;
  i = (((from) - (min_char)) >> chartab_bits[(depth)]);
...
char_table_set_range (Lisp_Object table, int from, int to, Lisp_Object val)
{
  ...
  if (from == to)
    ...
    {
      _Bool is_uniprop = (((XCHAR_TABLE (table)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (table)) == 5);
      int lim = (((to) - (0)) >> chartab_bits[(0)]);
      int i, c;

      for (i = (((from) - (0)) >> chartab_bits[(0)]), c = 0; i <= lim;
    i++, c += chartab_chars[0])
 {
   if (c > to)
     break;
       ...
       if (! SUB_CHAR_TABLE_P (sub))
  {
    ...
    set_char_table_contents (table, i, sub);
      ...
      if ((((sizeof ((from) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((from) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((from) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((from) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)))
 set_char_table_ascii (table, char_table_ascii (table));
    }
}


static struct Lisp_Subr _Alignas (8) Schar_table_subtype = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fchar_table_subtype }, 1, 1, "char-table-subtype", 0, 0}; Lisp_Object Fchar_table_subtype
...
static struct Lisp_Subr _Alignas (8) Schar_table_parent = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fchar_table_parent }, 1, 1, "char-table-parent", 0, 0}; Lisp_Object Fchar_table_parent
...
static struct Lisp_Subr _Alignas (8) Sset_char_table_parent = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fset_char_table_parent }, 2, 2, "set-char-table-parent", 0, 0}; Lisp_Object Fset_char_table_parent
  ...
  if (!((parent) == (builtin_lisp_symbol (0))))
    {
      ...
      for (temp = parent; !((temp) == (builtin_lisp_symbol (0))); temp = XCHAR_TABLE (temp)->parent)
 if (((temp) == (char_table)))
...
static struct Lisp_Subr _Alignas (8) Schar_table_extra_slot = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fchar_table_extra_slot }, 2, 2, "char-table-extra-slot", 0, 0}; Lisp_Object Fchar_table_extra_slot
  ...
  (Lisp_Object char_table, Lisp_Object n)
{
  ...
  if (((n) >> INTTYPEBITS) < 0
      || ((n) >> INTTYPEBITS) >= CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (char_table)))
    args_out_of_range (char_table, n);

  return XCHAR_TABLE (char_table)->extras[((n) >> INTTYPEBITS)];
}

static struct Lisp_Subr _Alignas (8) Sset_char_table_extra_slot = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fset_char_table_extra_slot }, 3, 3, "set-char-table-extra-slot", 0, 0}; Lisp_Object Fset_char_table_extra_slot
  ...
  (Lisp_Object char_table, Lisp_Object n, Lisp_Object value)
{
  ...
  set_char_table_extras (char_table, ((n) >> INTTYPEBITS), value);
  return value;
}

static struct Lisp_Subr _Alignas (8) Schar_table_range = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fchar_table_range }, 2, 2, "char-table-range", 0, 0}; Lisp_Object Fchar_table_range
  ...
  (Lisp_Object char_table, Lisp_Object range)
{
  ...
  if (((range) == (builtin_lisp_symbol (0))))
    val = XCHAR_TABLE (char_table)->defalt;
  else if ((NATNUMP (range) && ((range) >> INTTYPEBITS) <= 0x3FFFFF))
    val = CHAR_TABLE_REF (char_table, ((range) >> INTTYPEBITS));
  else if ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      int from, to;

      do { Lisp_Object tmp = (((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->car; (((NATNUMP (tmp) && ((tmp) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), tmp)); } while (0);
      do { Lisp_Object tmp = (((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->u.cdr; (((NATNUMP (tmp) && ((tmp) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), tmp)); } while (0);
      from = (((((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->car) >> INTTYPEBITS);
      to = (((((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->u.cdr) >> INTTYPEBITS);
...
static struct Lisp_Subr _Alignas (8) Sset_char_table_range = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fset_char_table_range }, 3, 3, "set-char-table-range", 0, 0}; Lisp_Object Fset_char_table_range
...
{
  CHECK_CHAR_TABLE (char_table);
  if (((range) == (builtin_lisp_symbol (901))))
    {
      int i;
 ...
 set_char_table_contents (char_table, i, value);
  ...
  else if (((range) == (builtin_lisp_symbol (0))))
    set_char_table_defalt (char_table, value);
  else if ((NATNUMP (range) && ((range) >> INTTYPEBITS) <= 0x3FFFFF))
    char_table_set (char_table, ((range) >> INTTYPEBITS), value);
  else if ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      do { Lisp_Object tmp = (((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->car; (((NATNUMP (tmp) && ((tmp) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), tmp)); } while (0);
      do { Lisp_Object tmp = (((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->u.cdr; (((NATNUMP (tmp) && ((tmp) >> INTTYPEBITS) <= 0x3FFFFF)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (260), tmp)); } while (0);
      char_table_set_range (char_table,
       (((((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->car) >> INTTYPEBITS), (((((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->u.cdr) >> INTTYPEBITS), value);
    }
  else
...
optimize_sub_char_table (Lisp_Object table, Lisp_Object test)
{
      ...
      if (SUB_CHAR_TABLE_P (this))
 {
   ...
   set_sub_char_table_contents (table, i, this);
      ...
      if (optimizable
   && (((test) == (builtin_lisp_symbol (0))) ? ((Fequal (this, elt)) == (builtin_lisp_symbol (0)))
       : ((test) == (builtin_lisp_symbol (369))) ? !((this) == (elt))
       : ((call2 (test, this, elt)) == (builtin_lisp_symbol (0)))))
 optimizable = 0;
    }
...
static struct Lisp_Subr _Alignas (8) Soptimize_char_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Foptimize_char_table }, 1, 2, "optimize-char-table", 0, 0}; Lisp_Object Foptimize_char_table
      ...
      Lisp_Object range, Lisp_Object top)
{
  ...
  int chars_in_block;
  int from = (((((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->car) >> INTTYPEBITS), to = (((((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->u.cdr) >> INTTYPEBITS);
  int i, c;
  _Bool is_uniprop = (((XCHAR_TABLE (top)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (top)) == 5);
  uniprop_decoder_t decoder = ((((XCHAR_TABLE (top)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (top)) == 5) ? uniprop_get_decoder (top) : ((void*)0));
  ...
  for (c = min_char + chars_in_block * i; c <= max_char;
       i++, c += chars_in_block)
    {
     ...
     : XCHAR_TABLE (table)->contents[i]);
      ...
      if (is_uniprop && (STRINGP (this) && SCHARS (this) > 0 && ((SREF (this, 0) == 1 || (SREF (this, 0) == 2)))))
 this = uniprop_table_uncompress (table, i);
      if (SUB_CHAR_TABLE_P (this))
 {
   if (to >= nextc)
     XSETCDR (range, ((EMACS_INT) (((EMACS_UINT) (nextc - 1) << INTTYPEBITS) + Lisp_Int0)));
   val = map_sub_char_table (c_function, function, this, arg,
        val, range, top);
 }
      else
 {
   if (((this) == (builtin_lisp_symbol (0))))
     this = XCHAR_TABLE (top)->defalt;
   if (!((val) == (this)))
     {
       _Bool different_value = 1;

       if (((val) == (builtin_lisp_symbol (0))))
  {
    if (! ((XCHAR_TABLE (top)->parent) == (builtin_lisp_symbol (0))))
      {
        ...
        set_char_table_parent (parent, builtin_lisp_symbol (0));
   ...
   different_value = 0;
       ...
       if (! ((val) == (builtin_lisp_symbol (0))) && different_value)
  {
    XSETCDR (range, ((EMACS_INT) (((EMACS_UINT) (c - 1) << INTTYPEBITS) + Lisp_Int0)));
    if ((((((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->car) == ((((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->u.cdr)))
      {
        if (c_function)
   (*c_function) (arg, (((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->car, val);
        else
   {
     if (decoder)
       val = decoder (top, val);
     call2 (function, (((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->car, val);
   }
      }
    else
      {
        ...
        else
   {
     ...
     call2 (function, range, val);
      ...
      XSETCDR (range, ((EMACS_INT) (((EMACS_UINT) (to) << INTTYPEBITS) + Lisp_Int0)));
    }
  return val;
}
  ...
  Lisp_Object function, Lisp_Object table, Lisp_Object arg)
{
  ...
  uniprop_decoder_t decoder = ((((XCHAR_TABLE (table)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (table)) == 5) ? uniprop_get_decoder (table) : ((void*)0));

  range = Fcons (((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (0x3FFFFF) << INTTYPEBITS) + Lisp_Int0)));
  ...
  while (((val) == (builtin_lisp_symbol (0))) && ! ((XCHAR_TABLE (table)->parent) == (builtin_lisp_symbol (0))))
    {
      Lisp_Object temp;
      int from = (((((void) (0 && ((((enum Lisp_Type) ((range) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((range) - (Lisp_Cons))))->car) >> INTTYPEBITS);
...
static struct Lisp_Subr _Alignas (8) Smap_char_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fmap_char_table }, 2, 2, "map-char-table", 0, 0}; Lisp_Object Fmap_char_table
  ...
  (Lisp_Object function, Lisp_Object char_table)
{
  ...
  map_char_table (((void*)0), function, char_table, char_table);
  return builtin_lisp_symbol (0);
}
       ...
       unsigned from, unsigned to)
{
  ...
  range = Fcons (builtin_lisp_symbol (0), builtin_lisp_symbol (0));
...
uniprop_table_uncompress (Lisp_Object table, int idx)
{
  ...
  Lisp_Object sub = make_sub_char_table (3, min_char, builtin_lisp_symbol (0));
  ...
  if (*p == 1)
    {
      ...
      p++;
      idx = (!((p)[0] & 0x80) ? *(p)++ : ! ((p)[0] & 0x20) ? ((p) += 2, ((((p)[-2] & 0x1F) << 6) | ((p)[-1] & 0x3F) | ((unsigned char) ((p)[-2]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((p)[0] & 0x10) ? ((p) += 3, ((((p)[-3] & 0x0F) << 12) | (((p)[-2] & 0x3F) << 6) | ((p)[-1] & 0x3F))) : string_char ((p), &(p), ((void*)0)));
      while (p < pend && idx < chartab_chars[2])
 {
   int v = (!((p)[0] & 0x80) ? *(p)++ : ! ((p)[0] & 0x20) ? ((p) += 2, ((((p)[-2] & 0x1F) << 6) | ((p)[-1] & 0x3F) | ((unsigned char) ((p)[-2]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((p)[0] & 0x10) ? ((p) += 3, ((((p)[-3] & 0x0F) << 12) | (((p)[-2] & 0x3F) << 6) | ((p)[-1] & 0x3F))) : string_char ((p), &(p), ((void*)0)));
   set_sub_char_table_contents
     (sub, idx++, v > 0 ? ((EMACS_INT) (((EMACS_UINT) (v) << INTTYPEBITS) + Lisp_Int0)) : builtin_lisp_symbol (0));
 }
    }
  else if (*p == 2)
    {
      ...
      for (idx = 0; p < pend; )
 {
   ...
   if (p < pend)
     {
       count = (!((p)[0] & 0x80) ? ((len) = 1, (p)[0]) : ! ((p)[0] & 0x20) ? ((len) = 2, (((((p)[0] & 0x1F) << 6) | ((p)[1] & 0x3F)) + (((unsigned char) (p)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((p)[0] & 0x10) ? ((len) = 3, ((((p)[0] & 0x0F) << 12) | (((p)[1] & 0x3F) << 6) | ((p)[2] & 0x3F))) : string_char ((p), ((void*)0), &len));
       if (count < 128)
  count = 1;
       else
  {
   ...
   while (count-- > 0)
     set_sub_char_table_contents (sub, idx++, ((EMACS_INT) (((EMACS_UINT) (v) << INTTYPEBITS) + Lisp_Int0)));
 }
    }
# 1164 "chartab.c"
  return sub;
  ...
  if (VECTORP (XCHAR_TABLE (table)->extras[4]))
    {
      ...
      if (((value) >> INTTYPEBITS) >= 0 && ((value) >> INTTYPEBITS) < ASIZE (valvec))
 value = AREF (valvec, ((value) >> INTTYPEBITS));
    }
  return value;
}
...
static const int uniprop_decoder_count = (sizeof (uniprop_decoder) / sizeof (uniprop_decoder)[0]);
...
uniprop_get_decoder (Lisp_Object table)
{
  ...
  if (! ((((enum Lisp_Type) ((XCHAR_TABLE (table)->extras[1]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    return ((void*)0);
  i = ((XCHAR_TABLE (table)->extras[1]) >> INTTYPEBITS);
...
{
  if (! ((value) == (builtin_lisp_symbol (0))) && ! (NATNUMP (value) && ((value) >> INTTYPEBITS) <= 0x3FFFFF))
    wrong_type_argument (builtin_lisp_symbol (559), value);
  return value;
}
...
uniprop_encode_value_run_length (Lisp_Object table, Lisp_Object value)
{
  ...
  return ((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0));
}
...
uniprop_encode_value_numeric (Lisp_Object table, Lisp_Object value)
{
  ...
  ((((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), value));
  for (i = 0; i < size; i++)
    if (((value) == (value_table[i])))
      break;
  value = ((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0));
  if (i == size)
    set_char_table_extras (table, 4,
      (Fvconcat) ((sizeof (((Lisp_Object []) {XCHAR_TABLE (table)->extras[4], Fmake_vector (((EMACS_INT) (((EMACS_UINT) (1) << INTTYPEBITS) + Lisp_Int0)), value)})) / sizeof (((Lisp_Object []) {XCHAR_TABLE (table)->extras[4], Fmake_vector (((EMACS_INT) (((EMACS_UINT) (1) << INTTYPEBITS) + Lisp_Int0)), value)}))[0]), ((Lisp_Object []) {XCHAR_TABLE (table)->extras[4], Fmake_vector (((EMACS_INT) (((EMACS_UINT) (1) << INTTYPEBITS) + Lisp_Int0)), value)})));
...
static const int uniprop_encoder_count = (sizeof (uniprop_encoder) / sizeof (uniprop_encoder)[0]);
...
uniprop_get_encoder (Lisp_Object table)
{
  ...
  if (! ((((enum Lisp_Type) ((XCHAR_TABLE (table)->extras[2]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    return ((void*)0);
  i = ((XCHAR_TABLE (table)->extras[2]) >> INTTYPEBITS);
...
uniprop_table (Lisp_Object prop)
{
  ...
  val = Fassq (prop, globals.f_Vchar_code_property_alist);
  if (! (((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    return builtin_lisp_symbol (0);
  table = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr;
  if (STRINGP (table))
    {
      Lisp_Object intl = (USE_STACK_STRING ? (make_lisp_ptr ((&(union Aligned_String) {{strlen ("international/"), -1, 0, (unsigned char *) ("international/")}}.s), Lisp_String)) : build_string (("international/")));
      result = Fload (concat2 (intl, table), builtin_lisp_symbol (901), builtin_lisp_symbol (901), builtin_lisp_symbol (901), builtin_lisp_symbol (901));
      if (((result) == (builtin_lisp_symbol (0))))
 return builtin_lisp_symbol (0);
      table = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr;
    }
  if (! CHAR_TABLE_P (table)
      || ! (((XCHAR_TABLE (table)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (table)) == 5))
    return builtin_lisp_symbol (0);
  ...
  if (((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
      ? (((val) >> INTTYPEBITS) < 0 || ((val) >> INTTYPEBITS) >= uniprop_decoder_count)
...
static struct Lisp_Subr _Alignas (8) Sunicode_property_table_internal = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Funicode_property_table_internal }, 1, 1, "unicode-property-table-internal", 0, 0}; Lisp_Object Funicode_property_table_internal
  ...
  (Lisp_Object prop)
{
  ...
  if (CHAR_TABLE_P (table))
    return table;
  return Fcdr (Fassq (prop, globals.f_Vchar_code_property_alist));
}

static struct Lisp_Subr _Alignas (8) Sget_unicode_property_internal = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fget_unicode_property_internal }, 2, 2, "get-unicode-property-internal", 0, 0}; Lisp_Object Fget_unicode_property_internal
  ...
  (Lisp_Object char_table, Lisp_Object ch)
{
  ...
  if (! (((XCHAR_TABLE (char_table)->purpose) == (builtin_lisp_symbol (254))) && CHAR_TABLE_EXTRA_SLOTS (XCHAR_TABLE (char_table)) == 5))
    error ("Invalid Unicode property table");
  val = CHAR_TABLE_REF (char_table, ((ch) >> INTTYPEBITS));
  decoder = uniprop_get_decoder (char_table);
  return (decoder ? decoder (char_table, val) : val);
}

static struct Lisp_Subr _Alignas (8) Sput_unicode_property_internal = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fput_unicode_property_internal }, 3, 3, "put-unicode-property-internal", 0, 0}; Lisp_Object Fput_unicode_property_internal
  ...
  (Lisp_Object char_table, Lisp_Object ch, Lisp_Object value)
{
  ...
  CHAR_TABLE_SET (char_table, ((ch) >> INTTYPEBITS), value);
  return builtin_lisp_symbol (0);
}
...
# 1392 "chartab.c"
  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "char-code-property-alist", &globals.f_Vchar_code_property_alist); } while (0);


  globals.f_Vchar_code_property_alist = builtin_lisp_symbol (0);
}
