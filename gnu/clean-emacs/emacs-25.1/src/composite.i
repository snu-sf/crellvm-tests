      ...
      Lisp_Object prop, Lisp_Object string)
{
  ...
  enum {
    GLYPH_LEN_MAX = (((2147483647 - 1) / 2) < ((((9223372036854775807L)) < ((18446744073709551615UL)) ? ((9223372036854775807L)) : ((18446744073709551615UL))) / 5) ? ((2147483647 - 1) / 2) : ((((9223372036854775807L)) < ((18446744073709551615UL)) ? ((9223372036854775807L)) : ((18446744073709551615UL))) / 5))
  ...
  if (nchars == 0 || !(((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    goto invalid_composition;

  id = (((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->car;
  if (((((enum Lisp_Type) ((id) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    {

      if (((id) >> INTTYPEBITS) < 0 || ((id) >> INTTYPEBITS) >= n_compositions)
 goto invalid_composition;
      return ((id) >> INTTYPEBITS);
    }



  if (!(((enum Lisp_Type) ((id) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    goto invalid_composition;
  length = (((void) (0 && ((((enum Lisp_Type) ((id) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((id) - (Lisp_Cons))))->car;
  if (!((((enum Lisp_Type) ((length) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) || ((length) >> INTTYPEBITS) != nchars)
    goto invalid_composition;

  components = (((void) (0 && ((((enum Lisp_Type) ((id) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((id) - (Lisp_Cons))))->u.cdr;





  if (((((enum Lisp_Type) ((components) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
    key = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (1) << INTTYPEBITS) + Lisp_Int0)), components);
  else if (STRINGP (components) || (((enum Lisp_Type) ((components) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    key = Fvconcat (1, &components);
  else if (VECTORP (components))
    key = components;
  else if (((components) == (builtin_lisp_symbol (0))))
    {
      key = make_uninit_vector (nchars);
      if (STRINGP (string))
 for (i = 0; i < nchars; i++)
   {
     do { charpos++; if (STRING_MULTIBYTE (string)) { unsigned char *chp = &SDATA (string)[bytepos]; int chlen; ch = (!((chp)[0] & 0x80) ? ((chlen) = 1, (chp)[0]) : ! ((chp)[0] & 0x20) ? ((chlen) = 2, (((((chp)[0] & 0x1F) << 6) | ((chp)[1] & 0x3F)) + (((unsigned char) (chp)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((chp)[0] & 0x10) ? ((chlen) = 3, ((((chp)[0] & 0x0F) << 12) | (((chp)[1] & 0x3F) << 6) | ((chp)[2] & 0x3F))) : string_char ((chp), ((void*)0), &chlen)); bytepos += chlen; } else { ch = SREF (string, bytepos); bytepos++; } } while (0);
     ASET (key, i, ((EMACS_INT) (((EMACS_UINT) (ch) << INTTYPEBITS) + Lisp_Int0)));
   }
      else
 for (i = 0; i < nchars; i++)
   {
     do { charpos++; if (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) { unsigned char *chp = (((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))); int chlen; ch = (!((chp)[0] & 0x80) ? ((chlen) = 1, (chp)[0]) : ! ((chp)[0] & 0x20) ? ((chlen) = 2, (((((chp)[0] & 0x1F) << 6) | ((chp)[1] & 0x3F)) + (((unsigned char) (chp)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((chp)[0] & 0x10) ? ((chlen) = 3, ((((chp)[0] & 0x0F) << 12) | (((chp)[1] & 0x3F) << 6) | ((chp)[2] & 0x3F))) : string_char ((chp), ((void*)0), &chlen)); bytepos += chlen; } else { ch = *((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1)))); bytepos++; } } while (0);
     ASET (key, i, ((EMACS_INT) (((EMACS_UINT) (ch) << INTTYPEBITS) + Lisp_Int0)));
   }
    }
  else
  ...
  if (hash_index >= 0)
    {
      ...
      XSETCAR (prop, id);
      XSETCDR (prop, Fcons (((EMACS_INT) (((EMACS_UINT) (nchars) << INTTYPEBITS) + Lisp_Int0)), Fcons (key, (((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr)));
      return ((id) >> INTTYPEBITS);
    }
 ...
 if (! VECTORP (AREF (key, i)))
  ...
  else if (VECTORP (components) || (((enum Lisp_Type) ((components) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      ptrdiff_t len = ASIZE (key);
 ...
 goto invalid_composition;
      ...
      for (i = 0; i < len; i++)
 {
   if (!((((enum Lisp_Type) ((key_contents[i]) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
     goto invalid_composition;
 }
    }
  ...
  method = (((components) == (builtin_lisp_symbol (0)))
     ? COMPOSITION_RELATIVE
     : ((((((enum Lisp_Type) ((components) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) || STRINGP (components))
        ? COMPOSITION_WITH_ALTCHARS
        : COMPOSITION_WITH_RULE_ALTCHARS));
 ...
 {
   int this_width;
   ch = ((key_contents[i]) >> INTTYPEBITS);


   this_width = (ch == '\t' ? 1 : ((((sizeof ((ch) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((ch) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (ch < 0x20 ? (ch == '\t' ? sanitize_tab_width (((((current_buffer)-> tab_width_)) >> INTTYPEBITS)) : (ch == '\n' ? 0 : (((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2))) : (ch < 0x7f ? 1 : ((((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2)))) : sanitize_char_width (((CHAR_TABLE_REF (globals.f_Vchar_width_table, ch)) >> INTTYPEBITS))));
   if (cmp->width < this_width)
  ...
  else
    {
      ...
      ch = ((key_contents[0]) >> INTTYPEBITS);
      rightmost = ch != '\t' ? ((((sizeof ((ch) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((ch) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (ch < 0x20 ? (ch == '\t' ? sanitize_tab_width (((((current_buffer)-> tab_width_)) >> INTTYPEBITS)) : (ch == '\n' ? 0 : (((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2))) : (ch < 0x7f ? 1 : ((((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2)))) : sanitize_char_width (((CHAR_TABLE_REF (globals.f_Vchar_width_table, ch)) >> INTTYPEBITS))) : 1;
      ...
      for (i = 1; i < glyph_len; i += 2)
 {
   ...
   rule = ((key_contents[i]) >> INTTYPEBITS);
   ch = ((key_contents[i + 1]) >> INTTYPEBITS);
   this_width = ch != '\t' ? ((((sizeof ((ch) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((ch) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((ch) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((ch) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (ch < 0x20 ? (ch == '\t' ? sanitize_tab_width (((((current_buffer)-> tab_width_)) >> INTTYPEBITS)) : (ch == '\n' ? 0 : (((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2))) : (ch < 0x7f ? 1 : ((((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2)))) : sanitize_char_width (((CHAR_TABLE_REF (globals.f_Vchar_width_table, ch)) >> INTTYPEBITS))) : 1;
# 375 "composite.c"
   do { rule &= 0xFF; gref = (rule) / 12; if (gref > 12) gref = 11; nref = (rule) % 12; } while (0);
   this_left = (leftmost
    ...
    Lisp_Object *prop, Lisp_Object object)
{
  ...
  if (get_property_and_range (pos, builtin_lisp_symbol (290), prop, start, end, object))
    return 1;
  ...
  if (limit > pos)
    {
      val = Fnext_single_property_change (((EMACS_INT) (((EMACS_UINT) (pos) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (290),
       object, ((EMACS_INT) (((EMACS_UINT) (limit) << INTTYPEBITS) + Lisp_Int0)));
      pos = ((val) >> INTTYPEBITS);
      if (pos == limit)
 return 0;
    }
    ...
    {
      if (get_property_and_range (pos - 1, builtin_lisp_symbol (290), prop, start, end,
      object))
 return 1;
      val = Fprevious_single_property_change (((EMACS_INT) (((EMACS_UINT) (pos) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (290),
           object, ((EMACS_INT) (((EMACS_UINT) (limit) << INTTYPEBITS) + Lisp_Int0)));
      pos = ((val) >> INTTYPEBITS);
      if (pos == limit)
 return 0;
  ...
  get_property_and_range (pos, builtin_lisp_symbol (290), prop, start, end, object);
  return 1;
}
...
run_composition_function (ptrdiff_t from, ptrdiff_t to, Lisp_Object prop)
{
  ...
  func = (composition_registered_p (prop) ? (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr : (((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? (((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr : builtin_lisp_symbol (0));


  if (from > (current_buffer->begv)
      && find_composition (from - 1, -1, &start, &end, &prop, builtin_lisp_symbol (0))
      && !composition_valid_p (start, end, prop))
    from = start;
  if (to < (current_buffer->zv)
      && find_composition (to, -1, &start, &end, &prop, builtin_lisp_symbol (0))
      && !composition_valid_p (start, end, prop))
    to = end;
  if (!((Ffboundp (func)) == (builtin_lisp_symbol (0))))
    call2 (func, ((EMACS_INT) (((EMACS_UINT) (from) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (to) << INTTYPEBITS) + Lisp_Int0)));
}
# 491 "composite.c"
void
update_compositions (ptrdiff_t from, ptrdiff_t to, int check_mask)
{
  ...
  if (! ((current_buffer->begv) <= from && from <= to && to <= (current_buffer->zv)))
    return;
   ...
   && composition_valid_p (start, end, prop))
 {
   ...
   if (end > to)
     max_pos = end;
   if (from < end)
     Fput_text_property (((EMACS_INT) (((EMACS_UINT) (from) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (end) << INTTYPEBITS) + Lisp_Int0)),
    builtin_lisp_symbol (290),
    Fcons ((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->car, (((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr), builtin_lisp_symbol (0));
   run_composition_function (start, end, prop);
   from = end;
 }
      else if (from < (current_buffer->zv)
        && find_composition (from, -1, &start, &from, &prop, builtin_lisp_symbol (0))
  ...
  if (check_mask & 4)
    {
      ...
      while (from < to - 1
      && find_composition (from, to, &start, &from, &prop, builtin_lisp_symbol (0))
      && composition_valid_p (start, from, prop)
      && from < to - 1)
 run_composition_function (start, from, prop);
    }
  ...
  if (check_mask & 2)
    {
      if (from < to
   && find_composition (to - 1, -1, &start, &end, &prop, builtin_lisp_symbol (0))
   && composition_valid_p (start, end, prop))
 {
   ...
   if (to < end)
     {
       Fput_text_property (((EMACS_INT) (((EMACS_UINT) (start) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (to) << INTTYPEBITS) + Lisp_Int0)),
      builtin_lisp_symbol (290),
      Fcons ((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->car, (((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr), builtin_lisp_symbol (0));
       max_pos = end;
     }
  ...
  if (min_pos < max_pos)
    {
      ...
      Fremove_list_of_text_properties (((EMACS_INT) (((EMACS_UINT) (min_pos) << INTTYPEBITS) + Lisp_Int0)),
           ((EMACS_INT) (((EMACS_UINT) (max_pos) << INTTYPEBITS) + Lisp_Int0)),
           list1 (builtin_lisp_symbol (185)), builtin_lisp_symbol (0));
...
make_composition_value_copy (Lisp_Object list)
{
  ...
  for (; (((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); list = (((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->u.cdr)
    {
      plist = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car;
      while ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && (((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 {
   if ((((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->car) == (builtin_lisp_symbol (290)))
       && (val = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car, (((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))
     XSETCAR ((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->u.cdr, Fcons ((((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->car, (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr));
   plist = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr;
 }
    }
}
# 622 "composite.c"
       ...
       Lisp_Object modification_func, Lisp_Object string)
{
  ...
  prop = Fcons (Fcons (((EMACS_INT) (((EMACS_UINT) (end - start) << INTTYPEBITS) + Lisp_Int0)), components),
  modification_func);
  Fput_text_property (((EMACS_INT) (((EMACS_UINT) (start) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (end) << INTTYPEBITS) + Lisp_Int0)),
         builtin_lisp_symbol (290), prop, string);
}
...
gstring_lookup_cache (Lisp_Object header)
{
  ...
  ptrdiff_t i = hash_lookup (h, header, ((void*)0));

  return (i >= 0 ? HASH_VALUE (h, i) : builtin_lisp_symbol (0));
}
...
composition_gstring_put_cache (Lisp_Object gstring, ptrdiff_t len)
{
  ...
  if (len < 0)
    {
      ptrdiff_t j, glyph_len = (ASIZE ((gstring)) - 2);
      for (j = 0; j < glyph_len; j++)
 if (((AREF ((gstring), (j) + 2)) == (builtin_lisp_symbol (0))))
   break;
      len = j;
    }

  copy = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (len + 2) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0));
  ASET (copy, 0, Fcopy_sequence (header));
  for (i = 0; i < len; i++)
    ASET ((copy), (i) + 2, (Fcopy_sequence (AREF ((gstring), (i) + 2))));
  i = hash_put (h, AREF (copy, 0), copy, hash);
  ASET (copy, 1, ((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0)));
  return copy;
}
...
composition_gstring_p (Lisp_Object gstring)
{
  ...
  if (! VECTORP (header) || ASIZE (header) < 2)
    return 0;
  if (! ((AREF (AREF (gstring, 0), 0)) == (builtin_lisp_symbol (0)))
      && (! FONT_OBJECT_P (AREF (AREF (gstring, 0), 0))
   && ! (hash_lookup (XHASH_TABLE (Vcoding_system_hash_table), AREF (AREF (gstring, 0), 0), ((void*)0)) >= 0 || (! ((AREF (AREF (gstring, 0), 0)) == (builtin_lisp_symbol (0))) && ! ((Fcoding_system_p (AREF (AREF (gstring, 0), 0))) == (builtin_lisp_symbol (0)))))))
    return 0;
  for (i = 1; i < ASIZE (AREF (gstring, 0)); i++)
    if (! NATNUMP (AREF (AREF (gstring, 0), i)))
      return 0;
  if (! ((AREF (gstring, 1)) == (builtin_lisp_symbol (0))) && ! NATNUMP (AREF (gstring, 1)))
    return 0;
  for (i = 0; i < (ASIZE ((gstring)) - 2); i++)
    {
      Lisp_Object glyph = AREF ((gstring), (i) + 2);
      if (((glyph) == (builtin_lisp_symbol (0))))
 break;
      ...
      struct font_metrics *metrics)
{
  ...
  if (metrics)
    {
      Lisp_Object font_object = AREF (AREF (gstring, 0), 0);
  ...
  for (glyph = lgstring_glyph_addr (gstring, from); from < to; from++, glyph++)
    {
      ...
      if (((AREF ((*glyph), LGLYPH_IX_ADJUSTMENT)) == (builtin_lisp_symbol (0))))
 width += ((AREF ((*glyph), LGLYPH_IX_WIDTH)) >> INTTYPEBITS);
      else
 width += (VECTORP (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT)) ? ((AREF (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT), 2)) >> INTTYPEBITS) : 0);
      if (metrics)
 {
   x = metrics->width + ((AREF ((*glyph), LGLYPH_IX_LBEARING)) >> INTTYPEBITS) + (VECTORP (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT)) ? ((AREF (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT), 0)) >> INTTYPEBITS) : 0);
   if (metrics->lbearing > x)
     metrics->lbearing = x;
   x = metrics->width + ((AREF ((*glyph), LGLYPH_IX_RBEARING)) >> INTTYPEBITS) + (VECTORP (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT)) ? ((AREF (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT), 0)) >> INTTYPEBITS) : 0);
   if (metrics->rbearing < x)
     metrics->rbearing = x;
   metrics->width = width;
   x = ((AREF ((*glyph), LGLYPH_IX_ASCENT)) >> INTTYPEBITS) - (VECTORP (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT)) ? ((AREF (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT), 1)) >> INTTYPEBITS) : 0);
   if (metrics->ascent < x)
     metrics->ascent = x;
   x = ((AREF ((*glyph), LGLYPH_IX_DESCENT)) >> INTTYPEBITS) + (VECTORP (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT)) ? ((AREF (AREF ((*glyph), LGLYPH_IX_ADJUSTMENT), 1)) >> INTTYPEBITS) : 0);
       ...
       ptrdiff_t to, Lisp_Object font_object, Lisp_Object string)
{
 ...
 args_out_of_range (header, ((EMACS_INT) (((EMACS_UINT) (len + 1) << INTTYPEBITS) + Lisp_Int0)));
    }
  else
    {
      if (len <= 8)
 ...
 do { unsigned char *chp = (((from_byte) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (from_byte) + (current_buffer->text->beg) - ((1))); int chlen; c = (!((chp)[0] & 0x80) ? ((chlen) = 1, (chp)[0]) : ! ((chp)[0] & 0x20) ? ((chlen) = 2, (((((chp)[0] & 0x1F) << 6) | ((chp)[1] & 0x3F)) + (((unsigned char) (chp)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((chp)[0] & 0x10) ? ((chlen) = 3, ((((chp)[0] & 0x0F) << 12) | (((chp)[1] & 0x3F) << 6) | ((chp)[2] & 0x3F))) : string_char ((chp), ((void*)0), &chlen)); from_byte += chlen; from++; } while (0);
      else
 do { unsigned char *fetch_ptr = &SDATA (string)[from_byte]; int fetch_len; c = (!((fetch_ptr)[0] & 0x80) ? ((fetch_len) = 1, (fetch_ptr)[0]) : ! ((fetch_ptr)[0] & 0x20) ? ((fetch_len) = 2, (((((fetch_ptr)[0] & 0x1F) << 6) | ((fetch_ptr)[1] & 0x3F)) + (((unsigned char) (fetch_ptr)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((fetch_ptr)[0] & 0x10) ? ((fetch_len) = 3, ((((fetch_ptr)[0] & 0x0F) << 12) | (((fetch_ptr)[1] & 0x3F) << 6) | ((fetch_ptr)[2] & 0x3F))) : string_char ((fetch_ptr), ((void*)0), &fetch_len)); from_byte += fetch_len; from++; } while (0);
      ASET (header, i + 1, ((EMACS_INT) (((EMACS_UINT) (c) << INTTYPEBITS) + Lisp_Int0)));
    }
  return header;
}
...
fill_gstring_body (Lisp_Object gstring)
{
  ...
  ptrdiff_t len = (ASIZE (AREF (gstring, 0)) - 1);
  ptrdiff_t i;

  for (i = 0; i < len; i++)
    {
      Lisp_Object g = AREF ((gstring), (i) + 2);
      int c = ((AREF (header, i + 1)) >> INTTYPEBITS);

      if (((g) == (builtin_lisp_symbol (0))))
 {
   g = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (LGLYPH_SIZE) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0));
   ASET ((gstring), (i) + 2, (g));
 }
      ASET ((g), LGLYPH_IX_FROM, ((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0)));
      ASET ((g), LGLYPH_IX_TO, ((EMACS_INT) (((EMACS_UINT) (i) << INTTYPEBITS) + Lisp_Int0)));
      ASET ((g), LGLYPH_IX_CHAR, ((EMACS_INT) (((EMACS_UINT) (c) << INTTYPEBITS) + Lisp_Int0)));
      if (FONT_OBJECT_P (font_object))
 {
 ...
 {
   int width = ((CHAR_TABLE_REF (globals.f_Vchar_width_table, c)) >> INTTYPEBITS);

   ASET (g, LGLYPH_IX_CODE, c == 0xFFFFFFFF ? builtin_lisp_symbol (0) : (! (! ((0 <= (c) || (-1 - (9223372036854775807L >> INTTYPEBITS)) <= (c)) && (c) <= (9223372036854775807L >> INTTYPEBITS))) ? ((EMACS_INT) (((EMACS_UINT) (c) << INTTYPEBITS) + Lisp_Int0)) : ((0 * (c) - (1)) < 0) ? intbig_to_lisp (c) : uintbig_to_lisp (c)));
   ASET ((g), LGLYPH_IX_LBEARING, ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)));
   ASET ((g), LGLYPH_IX_RBEARING, ((EMACS_INT) (((EMACS_UINT) (width) << INTTYPEBITS) + Lisp_Int0)));
   ASET ((g), LGLYPH_IX_WIDTH, ((EMACS_INT) (((EMACS_UINT) (width) << INTTYPEBITS) + Lisp_Int0)));
   ASET ((g), LGLYPH_IX_ASCENT, ((EMACS_INT) (((EMACS_UINT) (1) << INTTYPEBITS) + Lisp_Int0)));
   ASET ((g), LGLYPH_IX_DESCENT, ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0)));
 }
      ASET ((g), LGLYPH_IX_ADJUSTMENT, (builtin_lisp_symbol (0)));
    }
  if (i < (ASIZE ((gstring)) - 2))
    ASET ((gstring), (i) + 2, (builtin_lisp_symbol (0)));
}
# 864 "composite.c"
static Lisp_Object
...
{
  ptrdiff_t count = SPECPDL_INDEX ();
  struct frame *f = (((void) (0 && (FRAMEP (win->frame)))), (struct frame *) ((void *) (intptr_t) ((win->frame) - (Lisp_Vectorlike))));
  Lisp_Object pos = ((EMACS_INT) (((EMACS_UINT) (charpos) << INTTYPEBITS) + Lisp_Int0));
  ptrdiff_t to;
  ptrdiff_t pt = (current_buffer->pt + 0), pt_byte = (current_buffer->pt_byte + 0);
  Lisp_Object re, font_object, lgstring;
  ptrdiff_t len;

  record_unwind_save_match_data ();
  re = AREF (rule, 0);
  if (((re) == (builtin_lisp_symbol (0))))
    len = 1;
  else if (! STRINGP (re))
    ...
    {
      if (((string) == (builtin_lisp_symbol (0))))
 len = (buf_bytepos_to_charpos (current_buffer, bytepos + len)) - charpos;
      else
 ...
 return unbind_to (count, builtin_lisp_symbol (0));
  ...
  lgstring = Fcomposition_get_gstring (pos, ((EMACS_INT) (((EMACS_UINT) (to) << INTTYPEBITS) + Lisp_Int0)), font_object,
           string);
  if (((AREF (lgstring, 1)) == (builtin_lisp_symbol (0))))
    {

      if (((string) == (builtin_lisp_symbol (0))))
 record_unwind_protect (restore_point_unwind,
          build_marker (current_buffer, pt, pt_byte));
      lgstring = safe_call (6, globals.f_Vauto_composition_function, AREF (rule, 2),
       pos, ((EMACS_INT) (((EMACS_UINT) (to) << INTTYPEBITS) + Lisp_Int0)), font_object, string);
    }
...
char_composable_p (int c)
{
  ...
  return (c > ' '
   && (c == ZERO_WIDTH_NON_JOINER || c == ZERO_WIDTH_JOINER
       || (val = CHAR_TABLE_REF (globals.f_Vunicode_category_table, c),
    (((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0) && (((val) >> INTTYPEBITS) <= UNICODE_CATEGORY_So)))));
}
# 947 "composite.c"
void
composition_compute_stop_pos (struct composition_it *cmp_it, ptrdiff_t charpos, ptrdiff_t bytepos, ptrdiff_t endpos, Lisp_Object string)
{
      ...
      if (endpos < 0)
 {
   ...
   endpos = ((string) == (builtin_lisp_symbol (0))) ? (current_buffer->begv) - 1 : -1;
  ...
  if (((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))
      || ((globals.f_Vauto_composition_mode) == (builtin_lisp_symbol (0))))
    return;
  if (bytepos < 0)
    {
      if (((string) == (builtin_lisp_symbol (0))))
      ...
      while (charpos < endpos)
 {
   if (STRINGP (string))
     ...
     do { charpos++; if (!((((current_buffer)-> enable_multibyte_characters_)) == (builtin_lisp_symbol (0)))) { unsigned char *chp = (((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))); int chlen; c = (!((chp)[0] & 0x80) ? ((chlen) = 1, (chp)[0]) : ! ((chp)[0] & 0x20) ? ((chlen) = 2, (((((chp)[0] & 0x1F) << 6) | ((chp)[1] & 0x3F)) + (((unsigned char) (chp)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((chp)[0] & 0x10) ? ((chlen) = 3, ((((chp)[0] & 0x0F) << 12) | (((chp)[1] & 0x3F) << 6) | ((chp)[2] & 0x3F))) : string_char ((chp), ((void*)0), &chlen)); bytepos += chlen; } else { c = *((((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1)))); bytepos++; } } while (0);
   if (c == '\n')
     {
       cmp_it->ch = -2;
       break;
     }
   val = CHAR_TABLE_REF (globals.f_Vcomposition_function_table, c);
   if (! ((val) == (builtin_lisp_symbol (0))))
     {
       for (int ridx = 0; (((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); val = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr, ridx++)
  {
    Lisp_Object elt = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->car;
    if (VECTORP (elt) && ASIZE (elt) == 3
        && NATNUMP (AREF (elt, 1))
        && charpos - 1 - ((AREF (elt, 1)) >> INTTYPEBITS) >= start)
      {
        cmp_it->rule_idx = ridx;
        cmp_it->lookback = ((AREF (elt, 1)) >> INTTYPEBITS);
   ...
   && !(STRINGP (string) && endpos == SCHARS (string)))
 {
   ...
   if (charpos < start)
  ...
  else if (charpos > endpos)
    {
      ...
      if (((string) == (builtin_lisp_symbol (0))))
 p = (((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1)));
      else
 p = SDATA (string) + bytepos;
      c = (!((p)[0] & 0x80) ? ((len) = 1, (p)[0]) : ! ((p)[0] & 0x20) ? ((len) = 2, (((((p)[0] & 0x1F) << 6) | ((p)[1] & 0x3F)) + (((unsigned char) (p)[0]) < 0xC2 ? 0x3FFF80 : 0))) : ! ((p)[0] & 0x10) ? ((len) = 3, ((((p)[0] & 0x0F) << 12) | (((p)[1] & 0x3F) << 6) | ((p)[2] & 0x3F))) : string_char ((p), ((void*)0), &len));
      limit = bytepos + len;
   ...
   if (! ((val) == (builtin_lisp_symbol (0))))
     {
       ...
       for (ridx = 0; (((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); val = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr, ridx++)
  {
    ...
    if (VECTORP (elt) && ASIZE (elt) == 3
        && NATNUMP (AREF (elt, 1))
        && charpos - ((AREF (elt, 1)) >> INTTYPEBITS) > endpos)
      {
        ptrdiff_t back = ((AREF (elt, 1)) >> INTTYPEBITS);
        ptrdiff_t cpos = charpos - back, bpos;

        if (back == 0)
   bpos = bytepos;
        else
   bpos = (((string) == (builtin_lisp_symbol (0))) ? (buf_charpos_to_bytepos (current_buffer, cpos))
     ...
     if (blen > 1)
       {
         bpos += blen;
         if (((string) == (builtin_lisp_symbol (0))))
    cpos = (buf_bytepos_to_charpos (current_buffer, bpos)) - 1;
         else
         ...
         struct face *face, Lisp_Object string)
{
 ...
 return 0;
  ...
  if (endpos < 0)
    endpos = ((string) == (builtin_lisp_symbol (0))) ? (current_buffer->begv) : 0;
 ...
 goto no_composition;
    ...
    {
      Lisp_Object lgstring = builtin_lisp_symbol (0);
      Lisp_Object val, elt;
      ptrdiff_t i;

      val = CHAR_TABLE_REF (globals.f_Vcomposition_function_table, cmp_it->ch);
      for (i = 0; i < cmp_it->rule_idx; i++, val = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr);
      if (charpos < endpos)
 {
   for (; (((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); val = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr)
     {
       elt = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->car;
       if (! VECTORP (elt) || ASIZE (elt) != 3
    || ! ((((enum Lisp_Type) ((AREF (elt, 1)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0))
  continue;
       if (((AREF (elt, 1)) >> INTTYPEBITS) != cmp_it->lookback)
  goto no_composition;
       lgstring = autocmp_chars (elt, charpos, bytepos, endpos,
     w, face, string);
       if (composition_gstring_p (lgstring))
  break;
       lgstring = builtin_lisp_symbol (0);
      ...
      else
 {
  ...
  bpos = (buf_charpos_to_bytepos (current_buffer, cpos));
     }
   lgstring = autocmp_chars (elt, cpos, bpos, charpos + 1, w, face,
        string);
   if (! composition_gstring_p (lgstring)
       || cpos + (ASIZE (AREF (lgstring, 0)) - 1) - 1 != charpos)


     goto no_composition;
 }
      if (((lgstring) == (builtin_lisp_symbol (0))))
 goto no_composition;
      if (((AREF (lgstring, 1)) == (builtin_lisp_symbol (0))))
 lgstring = composition_gstring_put_cache (lgstring, -1);
      cmp_it->id = ((AREF (lgstring, 1)) >> INTTYPEBITS);
      for (i = 0; i < (ASIZE ((lgstring)) - 2); i++)
 if (((AREF ((lgstring), (i) + 2)) == (builtin_lisp_symbol (0))))
   break;
      cmp_it->nglyphs = i;
      cmp_it->from = 0;
      cmp_it->to = i;
  ...
  if (charpos < endpos)
    {
      charpos++;
      if (((string) == (builtin_lisp_symbol (0))))
 do { unsigned char *chp = (((bytepos) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (bytepos) + (current_buffer->text->beg) - ((1))); bytepos += (!((*chp) & 0x80) ? 1 : !((*chp) & 0x20) ? 2 : !((*chp) & 0x10) ? 3 : !((*chp) & 0x08) ? 4 : 5); } while (0);
      else
 bytepos += (!((*(SDATA (string) + bytepos)) & 0x80) ? 1 : !((*(SDATA (string) + bytepos)) & 0x20) ? 2 : !((*(SDATA (string) + bytepos)) & 0x10) ? 3 : !((*(SDATA (string) + bytepos)) & 0x08) ? 4 : 5);
    }
  else
    {
      charpos--;
...
composition_update_it (struct composition_it *cmp_it, ptrdiff_t charpos, ptrdiff_t bytepos, Lisp_Object string)
{
      ...
      else
 {
   for (i = 0; i < cmp->glyph_len; i++)
     ...
     if ((c = ((XVECTOR (XVECTOR (XHASH_TABLE (composition_hash_table) ->key_and_value) ->contents[cmp->hash_index * 2]) ->contents[cmp->method == COMPOSITION_WITH_RULE_ALTCHARS ? (i) * 2 : (i)]) >> INTTYPEBITS)) != '\t')
       break;
   if (c == '\t')
     c = ' ';
 }
 ...
 cmp_it->nbytes = (buf_charpos_to_bytepos (current_buffer, charpos)) - bytepos;
    }
  else
    {
      ...
      if (cmp_it->nglyphs == 0)
 {
   cmp_it->nchars = (ASIZE (AREF (gstring, 0)) - 1);
   cmp_it->width = 0;
   ...
   return -1;
      ...
      if (! cmp_it->reversed_p)
 {
   glyph = AREF ((gstring), (cmp_it->from) + 2);
   from = ((AREF ((glyph), LGLYPH_IX_FROM)) >> INTTYPEBITS);
   for (cmp_it->to = cmp_it->from + 1; cmp_it->to < cmp_it->nglyphs;
        cmp_it->to++)
     {
       glyph = AREF ((gstring), (cmp_it->to) + 2);
       if (((AREF ((glyph), LGLYPH_IX_FROM)) >> INTTYPEBITS) != from)
  break;
     }
   cmp_it->charpos = charpos;
 }
 ...
 {
   glyph = AREF ((gstring), (cmp_it->to - 1) + 2);
   from = ((AREF ((glyph), LGLYPH_IX_FROM)) >> INTTYPEBITS);
   cmp_it->charpos = charpos - (((AREF ((glyph), LGLYPH_IX_TO)) >> INTTYPEBITS) - from);
   for (cmp_it->from = cmp_it->to - 1; cmp_it->from > 0;
        cmp_it->from--)
     {
       glyph = AREF ((gstring), (cmp_it->from - 1) + 2);
       if (((AREF ((glyph), LGLYPH_IX_FROM)) >> INTTYPEBITS) != from)
  break;
     }
 }
      glyph = AREF ((gstring), (cmp_it->from) + 2);
      cmp_it->nchars = ((AREF ((glyph), LGLYPH_IX_TO)) >> INTTYPEBITS) + 1 - from;
      cmp_it->nbytes = 0;
      cmp_it->width = 0;
      for (i = cmp_it->nchars - 1; i >= 0; i--)
 {
   c = ((AREF (AREF (gstring, 0), (from + i) + 1)) >> INTTYPEBITS);
   cmp_it->nbytes += ( (c) <= 0x7F ? 1 : (c) <= 0x7FF ? 2 : (c) <= 0xFFFF ? 3 : (c) <= 0x1FFFFF ? 4 : (c) <= 0x3FFF7F ? 5 : 2);
   cmp_it->width += ((((sizeof ((c) + 0)) > (sizeof ((0x80) + 0)) ? (sizeof ((c) + 0)) : (sizeof ((0x80) + 0))) <= sizeof (unsigned) ? ((c) + (unsigned) 0) < ((0x80) + (unsigned) 0) : ((c) + (uintmax_t) 0) < ((0x80) + (uintmax_t) 0)) ? (c < 0x20 ? (c == '\t' ? sanitize_tab_width (((((current_buffer)-> tab_width_)) >> INTTYPEBITS)) : (c == '\n' ? 0 : (((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2))) : (c < 0x7f ? 1 : ((((((current_buffer)-> ctl_arrow_)) == (builtin_lisp_symbol (0))) ? 4 : 2)))) : sanitize_char_width (((CHAR_TABLE_REF (globals.f_Vchar_width_table, c)) >> INTTYPEBITS)));
 }
    }
  return c;
}
       ...
       Lisp_Object *gstring, Lisp_Object string)
{
  ...
  Lisp_Object window;
  struct window *w;
  _Bool need_adjustment = 0;

  window = Fget_buffer_window (Fcurrent_buffer (), builtin_lisp_symbol (0));
  if (((window) == (builtin_lisp_symbol (0))))
    return 0;
  w = XWINDOW (window);
  ...
  if (((string) == (builtin_lisp_symbol (0))))
    {
      head = (current_buffer->begv), tail = (current_buffer->zv), stop = (current_buffer->text->gpt);
      cur.pos_byte = (buf_charpos_to_bytepos (current_buffer, cur.pos));
      cur.p = (((cur.pos_byte) >= (current_buffer->text->gpt_byte) ? (current_buffer->text->gap_size) : 0) + (cur.pos_byte) + (current_buffer->text->beg) - ((1)));
    }
  else
    {
  ...
  if (limit < 0)
    ...
    limit = pos;
  if (limit <= pos)
    fore_check_limit = ((tail) < (pos + 1 + 3) ? (tail) : (pos + 1 + 3));
  else
    fore_check_limit = ((tail) < (limit + 3) ? (tail) : (limit + 3));
# 1504 "composite.c"
  while (1)
    {
      c = (!((cur.p)[0] & 0x80) ? (cur.p)[0] : ! ((cur.p)[0] & 0x20) ? (((((cur.p)[0] & 0x1F) << 6) | ((cur.p)[1] & 0x3F)) + (((unsigned char) (cur.p)[0]) < 0xC2 ? 0x3FFF80 : 0)) : ! ((cur.p)[0] & 0x10) ? ((((cur.p)[0] & 0x0F) << 12) | (((cur.p)[1] & 0x3F) << 6) | ((cur.p)[2] & 0x3F)) : string_char ((cur.p), ((void*)0), ((void*)0)));
      if (! char_composable_p (c))
 {
  ...
  if (cur.pos <= limit)
    return 0;
  do { if ((cur).pos == (stop)) (cur).p = (current_buffer->text->beg + current_buffer->text->gpt_byte - ((1))); do { (cur).pos_byte--; (cur).p--; } while (! (((*((cur).p)) & 0xC0) != 0x80)); (cur).pos--; } while (0);
  c = (!((cur.p)[0] & 0x80) ? (cur.p)[0] : ! ((cur.p)[0] & 0x20) ? (((((cur.p)[0] & 0x1F) << 6) | ((cur.p)[1] & 0x3F)) + (((unsigned char) (cur.p)[0]) < 0xC2 ? 0x3FFF80 : 0)) : ! ((cur.p)[0] & 0x10) ? ((((cur.p)[0] & 0x0F) << 12) | (((cur.p)[1] & 0x3F) << 6) | ((cur.p)[2] & 0x3F)) : string_char ((cur.p), ((void*)0), ((void*)0)));
       } while (! char_composable_p (c));
      ...
      while (cur.pos < fore_check_limit)
 {
   ...
   c = (!((cur.p)[0] & 0x80) ? (cur.p)[0] : ! ((cur.p)[0] & 0x20) ? (((((cur.p)[0] & 0x1F) << 6) | ((cur.p)[1] & 0x3F)) + (((unsigned char) (cur.p)[0]) < 0xC2 ? 0x3FFF80 : 0)) : ! ((cur.p)[0] & 0x10) ? ((((cur.p)[0] & 0x0F) << 12) | (((cur.p)[1] & 0x3F) << 6) | ((cur.p)[2] & 0x3F)) : string_char ((cur.p), ((void*)0), ((void*)0)));
   for (val = CHAR_TABLE_REF (globals.f_Vcomposition_function_table, c);
        (((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); val = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->u.cdr)
     {
       Lisp_Object elt = (((void) (0 && ((((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((val) - (Lisp_Cons))))->car;

       if (VECTORP (elt) && ASIZE (elt) == 3 && NATNUMP (AREF (elt, 1)))
  {
    EMACS_INT check_pos = cur.pos - ((AREF (elt, 1)) >> INTTYPEBITS);
    ...
    for (check = cur; check_pos < check.pos; )
      do { if ((check).pos == (stop)) (check).p = (current_buffer->text->beg + current_buffer->text->gpt_byte - ((1))); do { (check).pos_byte--; (check).p--; } while (! (((*((check).p)) & 0xC0) != 0x80)); (check).pos--; } while (0);
    *gstring = autocmp_chars (elt, check.pos, check.pos_byte,
         tail, w, ((void*)0), string);
    need_adjustment = 1;
    if (((*gstring) == (builtin_lisp_symbol (0))))
      {
   ...
   cur.p = SDATA (string) + cur.pos_byte;
    ...
    else
      {
        ...
        *start = check.pos;
        *end = check.pos + (ASIZE (AREF (*gstring, 0)) - 1);
        if (pos < limit
     ? pos < *end
     : *start <= pos && pos < *end)
   ...
   if (! (((enum Lisp_Type) ((val) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
     ...
     do { (cur).pos++; if ((cur).pos == (stop)) { (cur).p = (current_buffer->text->beg + current_buffer->text->gpt_byte + current_buffer->text->gap_size - ((1))); (cur).pos_byte = (current_buffer->text->gpt_byte); } else { (cur).pos_byte += (!((*((cur).p)) & 0x80) ? 1 : !((*((cur).p)) & 0x20) ? 2 : !((*((cur).p)) & 0x10) ? 3 : !((*((cur).p)) & 0x08) ? 4 : 5); (cur).p += (!((*((cur).p)) & 0x80) ? 1 : !((*((cur).p)) & 0x20) ? 2 : !((*((cur).p)) & 0x10) ? 3 : !((*((cur).p)) & 0x08) ? 4 : 5); } } while (0);
 }
...
composition_adjust_point (ptrdiff_t last_pt, ptrdiff_t new_pt)
{
  ...
  if (new_pt == (current_buffer->begv) || new_pt == (current_buffer->zv))
    return new_pt;


  if (get_property_and_range (new_pt, builtin_lisp_symbol (290), &val, &beg, &end, builtin_lisp_symbol (0))
 ...
 return (new_pt < last_pt ? beg : end);
  ...
  if (! find_automatic_composition (new_pt, (ptrdiff_t) -1, &beg, &end, &val,
      ...
      || beg == new_pt)
    return new_pt;
  for (i = 0; i < (ASIZE ((val)) - 2); i++)
    {
      Lisp_Object glyph = AREF ((val), (i) + 2);

      if (((glyph) == (builtin_lisp_symbol (0))))
 break;
      if (beg + ((AREF ((glyph), LGLYPH_IX_FROM)) >> INTTYPEBITS) == new_pt)
 return new_pt;
      if (beg + ((AREF ((glyph), LGLYPH_IX_TO)) >> INTTYPEBITS) >= new_pt)
 return (new_pt < last_pt
  ? beg + ((AREF ((glyph), LGLYPH_IX_FROM)) >> INTTYPEBITS)
  : beg + ((AREF ((glyph), LGLYPH_IX_TO)) >> INTTYPEBITS) + 1);
    }
  return new_pt;
}

static struct Lisp_Subr _Alignas (8) Scomposition_get_gstring = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fcomposition_get_gstring }, 4, 4, "composition-get-gstring", 0, 0}; Lisp_Object Fcomposition_get_gstring
# 1712 "composite.c"
  (Lisp_Object from, Lisp_Object to, Lisp_Object font_object, Lisp_Object string)
{
  ...
  if (! FONT_OBJECT_P (font_object))
    {
      ...
      coding = ((((terminal)->terminal_coding)->common_flags
   & 0x0800)
  ? ((terminal)->terminal_coding) : &safe_terminal_coding);
      font_object = (HASH_KEY (XHASH_TABLE (Vcoding_system_hash_table), coding->id));
    }
 ...
 error ("Attempt to shape unibyte text");
      ...
      frompos = ((from) >> INTTYPEBITS);
      topos = ((to) >> INTTYPEBITS);
      frombyte = (buf_charpos_to_bytepos (current_buffer, frompos));
    }
  else
    {
      CHECK_STRING (string);
 ...
 error ("Attempt to shape unibyte text");
  ...
  header = fill_gstring_header (builtin_lisp_symbol (0), frompos, frombyte,
    topos, font_object, string);
  gstring = gstring_lookup_cache (header);
  if (! ((gstring) == (builtin_lisp_symbol (0))))
    return gstring;

  if ((ASIZE ((gstring_work)) - 2) < topos - frompos)
    gstring_work = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (topos - frompos + 2) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0));
  ASET (gstring_work, 0, header);
  ASET (gstring_work, 1, builtin_lisp_symbol (0));
...
static struct Lisp_Subr _Alignas (8) Scompose_region_internal = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fcompose_region_internal }, 2, 4, "compose-region-internal", 0, 0}; Lisp_Object Fcompose_region_internal
  ...
  (Lisp_Object start, Lisp_Object end, Lisp_Object components, Lisp_Object modification_func)
{
  ...
  if (!((components) == (builtin_lisp_symbol (0)))
      && !((((enum Lisp_Type) ((components) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
      && !(((enum Lisp_Type) ((components) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)
      && !STRINGP (components))
    CHECK_VECTOR (components);

  compose_text (((start) >> INTTYPEBITS), ((end) >> INTTYPEBITS), components, modification_func, builtin_lisp_symbol (0));
  return builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Scompose_string_internal = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a5 = Fcompose_string_internal }, 3, 5, "compose-string-internal", 0, 0}; Lisp_Object Fcompose_string_internal
...
static struct Lisp_Subr _Alignas (8) Sfind_composition_internal = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Ffind_composition_internal }, 4, 4, "find-composition-internal", 0, 0}; Lisp_Object Ffind_composition_internal
  ...
  (Lisp_Object pos, Lisp_Object limit, Lisp_Object string, Lisp_Object detail_p)
{
  ...
  if (!((limit) == (builtin_lisp_symbol (0))))
    {
      ...
      to = ((((limit) >> INTTYPEBITS)) < ((current_buffer->zv)) ? (((limit) >> INTTYPEBITS)) : ((current_buffer->zv)));
    }
  else
    to = -1;
  ...
  if (!((string) == (builtin_lisp_symbol (0))))
    {
      CHECK_STRING (string);
      if (((pos) >> INTTYPEBITS) < 0 || ((pos) >> INTTYPEBITS) > SCHARS (string))
 ...
 args_out_of_range (Fcurrent_buffer (), pos);
  ...
  if (!find_composition (from, to, &start, &end, &prop, string))
   ...
   && find_automatic_composition (from, to, &start, &end, &gstring,
      string))
 return list3 (((EMACS_INT) (((EMACS_UINT) (start) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (end) << INTTYPEBITS) + Lisp_Int0)), gstring);
      return builtin_lisp_symbol (0);
    }
  if ((end <= ((pos) >> INTTYPEBITS) || start > ((pos) >> INTTYPEBITS)))
    {
      ptrdiff_t s, e;

      if (find_automatic_composition (from, to, &s, &e, &gstring, string)
   && (e <= ((pos) >> INTTYPEBITS) ? e > end : s < start))
 return list3 (((EMACS_INT) (((EMACS_UINT) (s) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (e) << INTTYPEBITS) + Lisp_Int0)), gstring);
    }
  if (!composition_valid_p (start, end, prop))
    return list3 (((EMACS_INT) (((EMACS_UINT) (start) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (end) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0));
  if (((detail_p) == (builtin_lisp_symbol (0))))
    return list3 (((EMACS_INT) (((EMACS_UINT) (start) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (end) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (901));

  if (composition_registered_p (prop))
    id = (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->car) >> INTTYPEBITS);
  else
    {
      ptrdiff_t start_byte = (((string) == (builtin_lisp_symbol (0)))
         ? (buf_charpos_to_bytepos (current_buffer, start))
  ...
  if (id >= 0)
    {
      ...
      components = Fcopy_sequence ((composition_registered_p (prop) ? (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car : (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->car) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->car) - (Lisp_Cons))))->u.cdr));
      relative_p = (method == COMPOSITION_WITH_RULE_ALTCHARS
      ? builtin_lisp_symbol (0) : builtin_lisp_symbol (901));
      mod_func = (composition_registered_p (prop) ? (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr : (((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? (((void) (0 && ((((enum Lisp_Type) ((prop) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((prop) - (Lisp_Cons))))->u.cdr : builtin_lisp_symbol (0));
      tail = list4 (components, relative_p, mod_func, ((EMACS_INT) (((EMACS_UINT) (width) << INTTYPEBITS) + Lisp_Int0)));
    }
  else
    tail = builtin_lisp_symbol (0);

  return Fcons (((EMACS_INT) (((EMACS_UINT) (start) << INTTYPEBITS) + Lisp_Int0)), Fcons (((EMACS_INT) (((EMACS_UINT) (end) << INTTYPEBITS) + Lisp_Int0)), tail));
}
...
syms_of_composite (void)
{
  ...
  Lisp_Object args[] = {builtin_lisp_symbol (129), builtin_lisp_symbol (371), builtin_lisp_symbol (118), ((EMACS_INT) (((EMACS_UINT) (311) << INTTYPEBITS) + Lisp_Int0))};
  composition_hash_table = (Fmake_hash_table) ((sizeof (args) / sizeof (args)[0]), args);
  staticpro (&composition_hash_table);


  gstring_hash_table = (Fmake_hash_table) ((sizeof (args) / sizeof (args)[0]), args);
  staticpro (&gstring_hash_table);

  staticpro (&gstring_work_headers);
  gstring_work_headers = make_uninit_vector (8);
  for (i = 0; i < 8; i++)
    ASET (gstring_work_headers, i, Fmake_vector (((EMACS_INT) (((EMACS_UINT) (i + 2) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0)));
  staticpro (&gstring_work);
  gstring_work = Fmake_vector (((EMACS_INT) (((EMACS_UINT) (10) << INTTYPEBITS) + Lisp_Int0)), builtin_lisp_symbol (0));


  globals.f_Vtext_property_default_nonsticky
    = Fcons (Fcons (builtin_lisp_symbol (290), builtin_lisp_symbol (901)), globals.f_Vtext_property_default_nonsticky);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "compose-chars-after-function", &globals.f_Vcompose_chars_after_function); } while (0);
# 1931 "composite.c"
  globals.f_Vcompose_chars_after_function = intern_c_string ("compose-chars-after");

                                          ;

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "auto-composition-mode", &globals.f_Vauto_composition_mode); } while (0);


  globals.f_Vauto_composition_mode = builtin_lisp_symbol (901);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "auto-composition-function", &globals.f_Vauto_composition_function); } while (0);
# 1951 "composite.c"
  globals.f_Vauto_composition_function = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "composition-function-table", &globals.f_Vcomposition_function_table); } while (0);
# 1984 "composite.c"
  globals.f_Vcomposition_function_table = Fmake_char_table (builtin_lisp_symbol (0), builtin_lisp_symbol (0));
