 ...
 const char *format_end, va_list ap)
{
  ...
  fmtcpy = (format_end - format < sizeof (fixed_buffer) - 1
     ? fixed_buffer
     : ((format_end - format + 1) <= sa_avail ? (sa_avail -= (format_end - format + 1), __builtin_alloca (format_end - format + 1)) : (sa_must_free = 1, record_xmalloc (format_end - format + 1))));
      ...
      if (fmtchar == '%')
 {
   ...
   int maxmlen = ((((1) > (pDlen) ? (1) : (pDlen))) > (((pIlen) > (pMlen) ? (pIlen) : (pMlen))) ? (((1) > (pDlen) ? (1) : (pDlen))) : (((pIlen) > (pMlen) ? (pIlen) : (pMlen))));
   int mlen;
    ...
    && '0' <= fmt[1] && fmt[1] <= '9')
      {
        ...
        if (n >= ((2147483647) < ((((9223372036854775807L)) < ((18446744073709551615UL)) ? ((9223372036854775807L)) : ((18446744073709551615UL)))) ? (2147483647) : ((((9223372036854775807L)) < ((18446744073709551615UL)) ? ((9223372036854775807L)) : ((18446744073709551615UL))))) / 10)
  ...
  length_modifier = long_modifier;
       if (mlen == pDlen && memcmp (fmt, "l", pDlen) == 0)
  length_modifier = pD_modifier;
       if (mlen == pIlen && memcmp (fmt, "l", pIlen) == 0)
  length_modifier = pI_modifier;
       if (mlen == pMlen && memcmp (fmt, "l" "d", pMlen) == 0)
   ...
   *string = 0;
   ...
   if (size_bound > (((9223372036854775807L)) < ((18446744073709551615UL)) ? ((9223372036854775807L)) : ((18446744073709551615UL))) - 308 - 50)
     error ("Format width or precision too large");
   size_bound += 308 + 50;
  ...
  signed_pD_modifier:
    {
      ptrdiff_t v = __builtin_va_arg(ap, ptrdiff_t);
      tem = sprintf (sprintf_buffer, fmtcpy, v);
    }
    break;
  case pI_modifier:
    {
      EMACS_INT v = __builtin_va_arg(ap, EMACS_INT);
      tem = sprintf (sprintf_buffer, fmtcpy, v);
    }
    break;
  case pM_modifier:
    {
      intmax_t v = __builtin_va_arg(ap, intmax_t);
      tem = sprintf (sprintf_buffer, fmtcpy, v);
    }
    break;
  }
  ...
  case pI_modifier:
    {
      EMACS_UINT v = __builtin_va_arg(ap, EMACS_UINT);
      tem = sprintf (sprintf_buffer, fmtcpy, v);
    }
    break;
  case pM_modifier:
    {
      uintmax_t v = __builtin_va_arg(ap, uintmax_t);
      tem = sprintf (sprintf_buffer, fmtcpy, v);
    }
    break;
  }
  ...
  minlen = atoi (&fmtcpy[1]);
       ...
       tem = strlen (string);
       if (((ptrdiff_t) (((9223372036854775807L >> INTTYPEBITS)) < ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1) ? ((9223372036854775807L >> INTTYPEBITS)) : ((((18446744073709551615UL)) < ((9223372036854775807L)) ? ((18446744073709551615UL)) : ((9223372036854775807L))) - 1))) < tem)
       ...
       if (tem > bufsize)
  {
    ...
    do
      {
        tem--;
        if ((((string[tem]) & 0xC0) != 0x80))
   {
     if ((!((string[tem]) & 0x80) ? 1 : !((string[tem]) & 0x20) ? 2 : !((string[tem]) & 0x10) ? 3 : !((string[tem]) & 0x08) ? 4 : 5) <= bufsize - tem)
       tem = bufsize;
     break;
   }
      }
       ...
       if (minlen < 0)
  {
    ...
    minlen = 0;
     ...
     case 'c':
       {
  int chr = __builtin_va_arg(ap, int);
  tem = ((((sizeof ((chr) + 0)) > (sizeof ((0x7F) + 0)) ? (sizeof ((chr) + 0)) : (sizeof ((0x7F) + 0))) <= sizeof (unsigned) ? ((chr) + (unsigned) 0) <= ((0x7F) + (unsigned) 0) : ((chr) + (uintmax_t) 0) <= ((0x7F) + (uintmax_t) 0)) ? (((unsigned char *) charbuf)[0] = (chr), 1) : (((sizeof ((chr) + 0)) > (sizeof ((0x7FF) + 0)) ? (sizeof ((chr) + 0)) : (sizeof ((0x7FF) + 0))) <= sizeof (unsigned) ? ((chr) + (unsigned) 0) <= ((0x7FF) + (unsigned) 0) : ((chr) + (uintmax_t) 0) <= ((0x7FF) + (uintmax_t) 0)) ? (((unsigned char *) charbuf)[0] = (0xC0 | ((chr) >> 6)), ((unsigned char *) charbuf)[1] = (0x80 | ((chr) & 0x3F)), 2) : (((sizeof ((chr) + 0)) > (sizeof ((0xFFFF) + 0)) ? (sizeof ((chr) + 0)) : (sizeof ((0xFFFF) + 0))) <= sizeof (unsigned) ? ((chr) + (unsigned) 0) <= ((0xFFFF) + (unsigned) 0) : ((chr) + (uintmax_t) 0) <= ((0xFFFF) + (uintmax_t) 0)) ? (((unsigned char *) charbuf)[0] = (0xE0 | ((chr) >> 12)), ((unsigned char *) charbuf)[1] = (0x80 | (((chr) >> 6) & 0x3F)), ((unsigned char *) charbuf)[2] = (0x80 | ((chr) & 0x3F)), 3) : ((!!sizeof (struct { unsigned int _gl_verify_error_if_negative: (sizeof (chr) <= sizeof (unsigned)) ? 1 : -1; })) ? (char_string (chr, (unsigned char *) charbuf)) : (char_string (chr, (unsigned char *) charbuf))));
  string = charbuf;
  string[tem] = 0;
  width = strwidth (string, tem);
  if (fmtcpy[1] != 'c')
 ...
 src = "\xE2\x80\x98", srclen = sizeof "\xE2\x80\x98" - 1;
      else if (quoting_style == CURVE_QUOTING_STYLE && fmtchar == '\'')
 src = "\xE2\x80\x99", srclen = sizeof "\xE2\x80\x99" - 1;
      else if (quoting_style == STRAIGHT_QUOTING_STYLE && fmtchar == '`')
 src = "'", srclen = 1;
      else
 {
   while (fmt < format_end && !(((*fmt) & 0xC0) != 0x80))
     fmt++;
...
esprintf (char *buf, char const *format, ...)
{
  ...
  nbytes = doprnt (buf, ((ptrdiff_t) (! (! ((ptrdiff_t) 0 < (ptrdiff_t) -1)) ? (ptrdiff_t) -1 : ((((ptrdiff_t) 1 << (sizeof (ptrdiff_t) * 8 - 2)) - 1) * 2 + 1))), format, 0, ap);
  __builtin_va_end(ap);
  return nbytes;
}
# 527 "doprnt.c"
    ...
    char const *format, va_list ap)
{
      ...
      if (*buf != nonheapbuf)
 {
   ...
   *buf = ((void*)0);
      ...
      *buf = xpalloc (((void*)0), bufsize, 1, bufsize_max, 1);
    }
}
