...
static struct Lisp_Subr _Alignas (8) Scase_table_p = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fcase_table_p }, 1, 1, "case-table-p", 0, 0}; Lisp_Object Fcase_table_p
  ...
  (Lisp_Object object)
{
  ...
  if (! ((XCHAR_TABLE (object)->purpose) == (builtin_lisp_symbol (239))))
    return builtin_lisp_symbol (0);
  ...
  return ((((up) == (builtin_lisp_symbol (0))) || CHAR_TABLE_P (up))
   && ((((canon) == (builtin_lisp_symbol (0))) && ((eqv) == (builtin_lisp_symbol (0))))
        || (CHAR_TABLE_P (canon)
    && (((eqv) == (builtin_lisp_symbol (0))) || CHAR_TABLE_P (eqv))))
...
{
  ((!((Fcase_table_p (obj)) == (builtin_lisp_symbol (0)))) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (240), obj));
  return (obj);
}

static struct Lisp_Subr _Alignas (8) Scurrent_case_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fcurrent_case_table }, 0, 0, "current-case-table", 0, 0}; Lisp_Object Fcurrent_case_table

  (void)
{
  return ((current_buffer)-> downcase_table_);
}

static struct Lisp_Subr _Alignas (8) Sstandard_case_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a0 = Fstandard_case_table }, 0, 0, "standard-case-table", 0, 0}; Lisp_Object Fstandard_case_table
...
static Lisp_Object set_case_table (Lisp_Object, _Bool);

static struct Lisp_Subr _Alignas (8) Sset_case_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fset_case_table }, 1, 1, "set-case-table", 0, 0}; Lisp_Object Fset_case_table
# 99 "casetab.c"
  (Lisp_Object table)
{
...
static struct Lisp_Subr _Alignas (8) Sset_standard_case_table = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a1 = Fset_standard_case_table }, 1, 1, "set-standard-case-table", 0, 0}; Lisp_Object Fset_standard_case_table
...
static Lisp_Object
set_case_table (Lisp_Object table, _Bool standard)
{
  Lisp_Object up, canon, eqv;
  ...
  if (((up) == (builtin_lisp_symbol (0))))
    {
      up = Fmake_char_table (builtin_lisp_symbol (239), builtin_lisp_symbol (0));
      map_char_table (set_identity, builtin_lisp_symbol (0), table, up);
      map_char_table (shuffle, builtin_lisp_symbol (0), table, up);
      set_char_table_extras (table, 0, up);
    }

  if (((canon) == (builtin_lisp_symbol (0))))
    {
      canon = Fmake_char_table (builtin_lisp_symbol (239), builtin_lisp_symbol (0));
      set_char_table_extras (table, 1, canon);
      map_char_table (set_canon, builtin_lisp_symbol (0), table, table);
    }

  if (((eqv) == (builtin_lisp_symbol (0))))
    {
      eqv = Fmake_char_table (builtin_lisp_symbol (239), builtin_lisp_symbol (0));
      map_char_table (set_identity, builtin_lisp_symbol (0), canon, eqv);
      map_char_table (shuffle, builtin_lisp_symbol (0), canon, eqv);
...
set_identity (Lisp_Object table, Lisp_Object c, Lisp_Object elt)
{
 ...
 {
   from = (((((void) (0 && ((((enum Lisp_Type) ((c) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((c) - (Lisp_Cons))))->car) >> INTTYPEBITS);
   to = (((((void) (0 && ((((enum Lisp_Type) ((c) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((c) - (Lisp_Cons))))->u.cdr) >> INTTYPEBITS);
 }
      else
 from = to = ((c) >> INTTYPEBITS);

      to++;
      for (; from < to; from++)
 CHAR_TABLE_SET (table, from, ((EMACS_INT) (((EMACS_UINT) (from) << INTTYPEBITS) + Lisp_Int0)));
    }
}
...
shuffle (Lisp_Object table, Lisp_Object c, Lisp_Object elt)
{
      ...
      for (; from < to; from++)
 {
   ...
   Faset (table, elt, ((EMACS_INT) (((EMACS_UINT) (from) << INTTYPEBITS) + Lisp_Int0)));
   Faset (table, ((EMACS_INT) (((EMACS_UINT) (from) << INTTYPEBITS) + Lisp_Int0)), tem);
 }
    }
}
...
init_casetab_once (void)
{
  ...
  Lisp_Object down, up, eqv;
                                    ...
                                    ;
  Fput (builtin_lisp_symbol (239), builtin_lisp_symbol (258), ((EMACS_INT) (((EMACS_UINT) (3) << INTTYPEBITS) + Lisp_Int0)));

  down = Fmake_char_table (builtin_lisp_symbol (239), builtin_lisp_symbol (0));
  Vascii_downcase_table = down;
  set_char_table_purpose (down, builtin_lisp_symbol (239));

  for (i = 0; i < 128; i++)
    {
      int c = (i >= 'A' && i <= 'Z') ? i + ('a' - 'A') : i;
      CHAR_TABLE_SET (down, i, ((EMACS_INT) (((EMACS_UINT) (c) << INTTYPEBITS) + Lisp_Int0)));
    }
  ...
  for (i = 0; i < 128; i++)
    {
      int c = (i >= 'a' && i <= 'z') ? i + ('A' - 'a') : i;
      CHAR_TABLE_SET (up, i, ((EMACS_INT) (((EMACS_UINT) (c) << INTTYPEBITS) + Lisp_Int0)));
    }
   ...
   for (i = 0; i < 128; i++)
     {
      int c = ((i >= 'A' && i <= 'Z') ? i + ('a' - 'A')
        : ((i >= 'a' && i <= 'z') ? i + ('A' - 'a')
    : i));
      CHAR_TABLE_SET (eqv, i, ((EMACS_INT) (((EMACS_UINT) (c) << INTTYPEBITS) + Lisp_Int0)));
    }
