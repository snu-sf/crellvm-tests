...
{
  if (STRINGP (propval))
    xsignal1 (builtin_lisp_symbol (913), propval);

  xsignal0 (builtin_lisp_symbol (913));
}
...
{
  ptrdiff_t b = ((start) >> INTTYPEBITS), e = ((end) >> INTTYPEBITS);
  struct buffer *buf = XBUFFER (buffer), *old = current_buffer;

  set_buffer_internal (buf);

  prepare_to_modify_buffer_1 (b, e, ((void*)0));

  do { if (((buf)->text->unchanged_modified) == ((buf)->text->modiff) && (((buf)->text->overlay_unchanged_modified) == ((buf)->text->overlay_modiff))) { ((buf)->text->beg_unchanged) = (b - 1) - ((1)); ((buf)->text->end_unchanged) = ((buf)->text->z) - (e); } else { if (((buf)->text->z) - (e) < ((buf)->text->end_unchanged)) ((buf)->text->end_unchanged) = ((buf)->text->z) - (e); if ((b - 1) - ((1)) < ((buf)->text->beg_unchanged)) ((buf)->text->beg_unchanged) = (b - 1) - ((1)); } } while (0);
...
{
  ((STRINGP (x) || BUFFERP (x)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (225), x));
}
# 130 "textprop.c"
enum { soft = 0, hard = 1 };
...
validate_interval_range (Lisp_Object object, Lisp_Object *begin,
    Lisp_Object *end, _Bool force)
{
  INTERVAL i;
  ptrdiff_t searchpos;

  CHECK_STRING_OR_BUFFER (object);
  do { if (((((enum Lisp_Type) (((*begin)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE ((*begin)) == Lisp_Misc_Marker)) ((*begin) = make_natnum (marker_position (*begin))); else ((((((enum Lisp_Type) ((*begin) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (558), *begin)); } while (0);
  ...
  if (((*begin) >> INTTYPEBITS) > ((*end) >> INTTYPEBITS))
    {
      Lisp_Object n;
      n = *begin;
      *begin = *end;
  ...
  if (BUFFERP (object))
    {
      ...
      if (!((b == current_buffer ? (current_buffer->begv) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv : marker_position (((b)-> begv_marker_))) <= ((*begin) >> INTTYPEBITS) && ((*begin) >> INTTYPEBITS) <= ((*end) >> INTTYPEBITS)
     && ((*end) >> INTTYPEBITS) <= (b == current_buffer ? (current_buffer->zv) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv : marker_position (((b)-> zv_marker_)))))
 args_out_of_range (*begin, *end);
      i = buffer_intervals (b);


      if ((b == current_buffer ? (current_buffer->begv) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv : marker_position (((b)-> begv_marker_))) == (b == current_buffer ? (current_buffer->zv) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv : marker_position (((b)-> zv_marker_))))
 return ((void*)0);

      searchpos = ((*begin) >> INTTYPEBITS);
    }
  else
    {
      ptrdiff_t len = SCHARS (object);

      if (! (0 <= ((*begin) >> INTTYPEBITS) && ((*begin) >> INTTYPEBITS) <= ((*end) >> INTTYPEBITS)
      && ((*end) >> INTTYPEBITS) <= len))
 args_out_of_range (*begin, *end);
      ((*begin) = make_natnum (((*begin) >> INTTYPEBITS)));
      if (begin != end)
 ((*end) = make_natnum (((*end) >> INTTYPEBITS)));
...
validate_plist (Lisp_Object list)
{
      ...
      do
 {
  ...
  return list2 (list, builtin_lisp_symbol (0));
}
...
interval_has_all_properties (Lisp_Object plist, INTERVAL i)
{
  ...
  for (tail1 = plist; (((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); tail1 = Fcdr ((((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->u.cdr))
    {
      Lisp_Object sym1 = (((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->car;
      _Bool found = 0;


      for (tail2 = i->plist; (((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); tail2 = Fcdr ((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->u.cdr))
 if (((sym1) == ((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->car)))
   {


     if (! ((Fcar ((((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->u.cdr)) == (Fcar ((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->u.cdr))))
       return 0;
...
interval_has_some_properties (Lisp_Object plist, INTERVAL i)
{
  ...
  for (tail1 = plist; (((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); tail1 = Fcdr ((((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->u.cdr))
    {
      sym = (((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->car;


      for (tail2 = i->plist; (((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); tail2 = Fcdr ((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->u.cdr))
 if (((sym) == ((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->car)))
   return 1;
    }
...
interval_has_some_properties_list (Lisp_Object list, INTERVAL i)
{
  ...
  for (tail1 = list; (((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); tail1 = (((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->u.cdr)
    {
      sym = (((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->car;


      for (tail2 = i->plist; (((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); tail2 = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr)
 if (((sym) == ((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->car)))
   return 1;
    }
...
property_value (Lisp_Object plist, Lisp_Object prop)
{
  ...
  while (((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ((value)=(((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->u.cdr, (((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))))
    if ((((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->car) == (prop)))
      return (((void) (0 && ((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((value) - (Lisp_Cons))))->car;
    else
      plist = (((void) (0 && ((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((value) - (Lisp_Cons))))->u.cdr;

  return builtin_lisp_symbol (957);
}
...
set_properties (Lisp_Object properties, INTERVAL interval, Lisp_Object object)
{
  ...
  if (BUFFERP (object))
    ...
    ((((enum Lisp_Type) ((sym) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ((value)=(((void) (0 && ((((enum Lisp_Type) ((sym) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((sym) - (Lisp_Cons))))->u.cdr, (((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)));
    sym = (((void) (0 && ((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((value) - (Lisp_Cons))))->u.cdr)
 if (! ((property_value (properties, (((void) (0 && ((((enum Lisp_Type) ((sym) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((sym) - (Lisp_Cons))))->car)) == ((((void) (0 && ((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((value) - (Lisp_Cons))))->car)))

   {
     record_property_change (interval->position, ((interval) == ((void*)0) ? 0 : ((((interval)) == ((void*)0) ? 0 : ((interval))->total_length) - (((interval)->right) == ((void*)0) ? 0 : ((interval)->right)->total_length) - (((interval)->left) == ((void*)0) ? 0 : ((interval)->left)->total_length))),
        (((void) (0 && ((((enum Lisp_Type) ((sym) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((sym) - (Lisp_Cons))))->car, (((void) (0 && ((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((value) - (Lisp_Cons))))->car,
        object);
   }
    ...
    ((((enum Lisp_Type) ((sym) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ((value)=(((void) (0 && ((((enum Lisp_Type) ((sym) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((sym) - (Lisp_Cons))))->u.cdr, (((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)));
    sym = (((void) (0 && ((((enum Lisp_Type) ((value) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((value) - (Lisp_Cons))))->u.cdr)
 if (((property_value (interval->plist, (((void) (0 && ((((enum Lisp_Type) ((sym) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((sym) - (Lisp_Cons))))->car)) == (builtin_lisp_symbol (957))))
   {
     record_property_change (interval->position, ((interval) == ((void*)0) ? 0 : ((((interval)) == ((void*)0) ? 0 : ((interval))->total_length) - (((interval)->right) == ((void*)0) ? 0 : ((interval)->right)->total_length) - (((interval)->left) == ((void*)0) ? 0 : ((interval)->left)->total_length))),
        (((void) (0 && ((((enum Lisp_Type) ((sym) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((sym) - (Lisp_Cons))))->car, builtin_lisp_symbol (0),
        object);
   }
    }
  ...
  enum property_set_type set_type)
{
  ...
  tail1 = plist;
  sym1 = builtin_lisp_symbol (0);
  val1 = builtin_lisp_symbol (0);


  for (tail1 = plist; (((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); tail1 = Fcdr ((((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->u.cdr))
    {
      _Bool found = 0;
      sym1 = (((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->car;
      val1 = Fcar ((((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->u.cdr);
 ...
 if (((sym1) == ((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->car)))
   {
     ...
     this_cdr = (((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->u.cdr;

     found = 1;



     if (((val1) == (Fcar (this_cdr))))
       break;


     if (BUFFERP (object))
       {
  record_property_change (i->position, ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))),
     ...
     if (set_type == TEXT_PROPERTY_REPLACE)
       ...
       if ((((enum Lisp_Type) ((Fcar (this_cdr)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) &&

    (! ((sym1) == (builtin_lisp_symbol (397))) ||
     ((Fkeywordp (Fcar (Fcar (this_cdr)))) == (builtin_lisp_symbol (0)))))
      ...
      if (! found)
 {
   ...
   if (BUFFERP (object))
     {
       record_property_change (i->position, ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))),
          sym1, builtin_lisp_symbol (0), object);
     }
...
remove_properties (Lisp_Object plist, Lisp_Object list, INTERVAL i, Lisp_Object object)
{
  ...
  _Bool use_plist = ! ((plist) == (builtin_lisp_symbol (0)));
  Lisp_Object tail1 = use_plist ? plist : list;

  Lisp_Object current_plist = i->plist;


  while ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
    {
      Lisp_Object sym = (((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->car;


      while ((((enum Lisp_Type) ((current_plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ((sym) == ((((void) (0 && ((((enum Lisp_Type) ((current_plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((current_plist) - (Lisp_Cons))))->car)))
 {
   if (BUFFERP (object))
     record_property_change (i->position, ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))),
        sym, (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((current_plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((current_plist) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((current_plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((current_plist) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car,
        object);

   current_plist = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((current_plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((current_plist) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((current_plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((current_plist) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr;
   changed = 1;
 }


      Lisp_Object tail2 = current_plist;
      while (! ((tail2) == (builtin_lisp_symbol (0))))
 {
   Lisp_Object this = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr;
   if ((((enum Lisp_Type) ((this) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && ((sym) == ((((void) (0 && ((((enum Lisp_Type) ((this) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((this) - (Lisp_Cons))))->car)))
     {
       if (BUFFERP (object))
  record_property_change (i->position, ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))),
     sym, (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((this) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((this) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((this) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((this) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car, object);

       Fsetcdr ((((void) (0 && ((((enum Lisp_Type) ((tail2) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail2) - (Lisp_Cons))))->u.cdr, (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((this) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((this) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((this) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((this) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr);
       changed = 1;
     }
   tail2 = this;
 }
      ...
      tail1 = (((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->u.cdr;
      if (use_plist && (((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 tail1 = (((void) (0 && ((((enum Lisp_Type) ((tail1) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((tail1) - (Lisp_Cons))))->u.cdr;
    }
...
interval_of (ptrdiff_t position, Lisp_Object object)
{
  ...
  else if (((object) == (builtin_lisp_symbol (901))))
    return ((void*)0);
  ...
  if (BUFFERP (object))
    {
      ...
      beg = (b == current_buffer ? (current_buffer->begv) : ((((b)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? b->begv : marker_position (((b)-> begv_marker_)));
      end = (b == current_buffer ? (current_buffer->zv) : ((((b)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? b->zv : marker_position (((b)-> zv_marker_)));
      i = buffer_intervals (b);
    }
  else
    {
  ...
  if (!(beg <= position && position <= end))
    args_out_of_range (((EMACS_INT) (((EMACS_UINT) (position) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (position) << INTTYPEBITS) + Lisp_Int0)));
  if (beg == end || !i)
    return ((void*)0);
...
static struct Lisp_Subr _Alignas (8) Stext_properties_at = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Ftext_properties_at }, 1, 2, "text-properties-at", 0, 0}; Lisp_Object Ftext_properties_at
  ...
  (Lisp_Object position, Lisp_Object object)
{
  ...
  if (((position) >> INTTYPEBITS) == ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))) + i->position)
    return builtin_lisp_symbol (0);

  return i->plist;
}

static struct Lisp_Subr _Alignas (8) Sget_text_property = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fget_text_property }, 2, 3, "get-text-property", 0, 0}; Lisp_Object Fget_text_property
...
get_char_property_and_overlay (Lisp_Object position, register Lisp_Object prop, Lisp_Object object, Lisp_Object *overlay)
{
  ...
  if (WINDOWP (object))
    {
      (((WINDOWP (object) && BUFFERP (XWINDOW (object)->contents))) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (1027), object));
      w = XWINDOW (object);
      object = w->contents;
    }
  if (BUFFERP (object))
    {
      ...
      if (((position) >> INTTYPEBITS) < (XBUFFER (object) == current_buffer ? (current_buffer->begv) : ((((XBUFFER (object))-> begv_marker_)) == (builtin_lisp_symbol (0))) ? XBUFFER (object)->begv : marker_position (((XBUFFER (object))-> begv_marker_)))
   || ((position) >> INTTYPEBITS) > (XBUFFER (object) == current_buffer ? (current_buffer->zv) : ((((XBUFFER (object))-> zv_marker_)) == (builtin_lisp_symbol (0))) ? XBUFFER (object)->zv : marker_position (((XBUFFER (object))-> zv_marker_))))
 xsignal1 (builtin_lisp_symbol (177), position);

      set_buffer_temp (XBUFFER (object));

      ptrdiff_t sa_avail = MAX_ALLOCA; ptrdiff_t sa_count = SPECPDL_INDEX (); _Bool sa_must_free = 0;
      do { ptrdiff_t maxlen = 40; do { if ((maxlen) <= sa_avail / sizeof *(overlay_vec) / (1)) (overlay_vec) = (sa_avail -= (sizeof *(overlay_vec) * (1) * (maxlen)), __builtin_alloca (sizeof *(overlay_vec) * (1) * (maxlen))); else { (overlay_vec) = xnmalloc (maxlen, sizeof *(overlay_vec) * (1)); sa_must_free = 1; record_unwind_protect_ptr (xfree, overlay_vec); } } while (0); (noverlays) = overlays_at (((position) >> INTTYPEBITS), 0, &(overlay_vec), &maxlen, ((void*)0), ((void*)0), 0); if ((noverlays) > maxlen) { maxlen = noverlays; do { if ((maxlen) <= sa_avail / sizeof *(overlay_vec) / (1)) (overlay_vec) = (sa_avail -= (sizeof *(overlay_vec) * (1) * (maxlen)), __builtin_alloca (sizeof *(overlay_vec) * (1) * (maxlen))); else { (overlay_vec) = xnmalloc (maxlen, sizeof *(overlay_vec) * (1)); sa_must_free = 1; record_unwind_protect_ptr (xfree, overlay_vec); } } while (0); (noverlays) = overlays_at (((position) >> INTTYPEBITS), 0, &(overlay_vec), &maxlen, ((void*)0), ((void*)0), 0); } } while (0);
...
static struct Lisp_Subr _Alignas (8) Sget_char_property = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fget_char_property }, 2, 3, "get-char-property", 0, 0}; Lisp_Object Fget_char_property
# 670 "textprop.c"
  (Lisp_Object position, Lisp_Object prop, Lisp_Object object)
{
...
static struct Lisp_Subr _Alignas (8) Sget_char_property_and_overlay = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fget_char_property_and_overlay }, 2, 3, "get-char-property-and-overlay", 0, 0}; Lisp_Object Fget_char_property_and_overlay
# 689 "textprop.c"
  (Lisp_Object position, Lisp_Object prop, Lisp_Object object)
{
  Lisp_Object overlay;
...
static struct Lisp_Subr _Alignas (8) Snext_char_property_change = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fnext_char_property_change }, 1, 2, "next-char-property-change", 0, 0}; Lisp_Object Fnext_char_property_change
# 710 "textprop.c"
  (Lisp_Object position, Lisp_Object limit)
{
  ...
  if (! ((limit) == (builtin_lisp_symbol (0))))
    {
      do { if (((((enum Lisp_Type) (((limit)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE ((limit)) == Lisp_Misc_Marker)) ((limit) = make_natnum (marker_position (limit))); else ((((((enum Lisp_Type) ((limit) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (558), limit)); } while (0);
      if (((limit) >> INTTYPEBITS) < ((temp) >> INTTYPEBITS))
 temp = limit;
    }
  return Fnext_property_change (position, builtin_lisp_symbol (0), temp);
}

static struct Lisp_Subr _Alignas (8) Sprevious_char_property_change = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a2 = Fprevious_char_property_change }, 1, 2, "previous-char-property-change", 0, 0}; Lisp_Object Fprevious_char_property_change
# 736 "textprop.c"
  (Lisp_Object position, Lisp_Object limit)
{
  Lisp_Object temp;
 ...
 temp = limit;
  ...
  return Fprevious_property_change (position, builtin_lisp_symbol (0), temp);
}


static struct Lisp_Subr _Alignas (8) Snext_single_char_property_change = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fnext_single_char_property_change }, 2, 4, "next-single-char-property-change", 0, 0}; Lisp_Object Fnext_single_char_property_change
# 769 "textprop.c"
  (Lisp_Object position, Lisp_Object prop, Lisp_Object object, Lisp_Object limit)
{
 ...
 {
   if (((limit) == (builtin_lisp_symbol (0))))
     position = ((EMACS_INT) (((EMACS_UINT) (SCHARS (object)) << INTTYPEBITS) + Lisp_Int0));
   else
     {
       ((((((enum Lisp_Type) ((limit) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), limit));
       position = limit;
     }
 }
    }
      ...
      if (BUFFERP (object) && current_buffer != XBUFFER (object))
 {
   ...
   Fset_buffer (object);
      ...
      if (((limit) == (builtin_lisp_symbol (0))))
 ((limit) = make_natnum ((current_buffer->zv)));
      else
 do { if (((((enum Lisp_Type) (((limit)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE ((limit)) == Lisp_Misc_Marker)) ((limit) = make_natnum (marker_position (limit))); else ((((((enum Lisp_Type) ((limit) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (558), limit)); } while (0);

      if (((position) >> INTTYPEBITS) >= ((limit) >> INTTYPEBITS))
 {
   position = limit;
   if (((position) >> INTTYPEBITS) > (current_buffer->zv))
     ((position) = make_natnum ((current_buffer->zv)));
 }
      else
 while (1)
   {
...
static struct Lisp_Subr _Alignas (8) Sprevious_single_char_property_change = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fprevious_single_char_property_change }, 2, 4, "previous-single-char-property-change", 0, 0}; Lisp_Object Fprevious_single_char_property_change
# 854 "textprop.c"
  (Lisp_Object position, Lisp_Object prop, Lisp_Object object, Lisp_Object limit)
{
  if (STRINGP (object))
 ...
 {
   if (((limit) == (builtin_lisp_symbol (0))))
     position = ((EMACS_INT) (((EMACS_UINT) (0) << INTTYPEBITS) + Lisp_Int0));
   else
     {
       ((((((enum Lisp_Type) ((limit) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (559), limit));
       position = limit;
      ...
      if (BUFFERP (object) && current_buffer != XBUFFER (object))
 {
   ...
   Fset_buffer (object);
      ...
      if (((limit) == (builtin_lisp_symbol (0))))
 ((limit) = make_natnum ((current_buffer->begv)));
      else
 do { if (((((enum Lisp_Type) (((limit)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE ((limit)) == Lisp_Misc_Marker)) ((limit) = make_natnum (marker_position (limit))); else ((((((enum Lisp_Type) ((limit) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (558), limit)); } while (0);
 ...
 {
   position = limit;
   if (((position) >> INTTYPEBITS) < (current_buffer->begv))
     ((position) = make_natnum ((current_buffer->begv)));
 }
      else
 {
   Lisp_Object initial_value
     = Fget_char_property (((EMACS_INT) (((EMACS_UINT) (((position) >> INTTYPEBITS) - 1) << INTTYPEBITS) + Lisp_Int0)),
      prop, object);
...
static struct Lisp_Subr _Alignas (8) Snext_property_change = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fnext_property_change }, 1, 3, "next-property-change", 0, 0}; Lisp_Object Fnext_property_change
# 943 "textprop.c"
  (Lisp_Object position, Lisp_Object object, Lisp_Object limit)
{
  ...
  if (!((limit) == (builtin_lisp_symbol (0))) && !((limit) == (builtin_lisp_symbol (901))))
    do { if (((((enum Lisp_Type) (((limit)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE ((limit)) == Lisp_Misc_Marker)) ((limit) = make_natnum (marker_position (limit))); else ((((((enum Lisp_Type) ((limit) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (558), limit)); } while (0);
 ...
 next = next_interval (i);
      ...
      if (!next)
 ((position) = make_natnum ((STRINGP (object) ? SCHARS (object) : (XBUFFER (object) == current_buffer ? (current_buffer->zv) : ((((XBUFFER (object))-> zv_marker_)) == (builtin_lisp_symbol (0))) ? XBUFFER (object)->zv : marker_position (((XBUFFER (object))-> zv_marker_))))));


      else
 ((position) = make_natnum (next->position));
      return position;
    }
  ...
  && (((limit) == (builtin_lisp_symbol (0))) || next->position < ((limit) >> INTTYPEBITS)))
    next = next_interval (next);

  if (!next
      || (next->position
   >= (((((enum Lisp_Type) ((limit) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
       ? ((limit) >> INTTYPEBITS)
       : (STRINGP (object)
   ? SCHARS (object)
   : (XBUFFER (object) == current_buffer ? (current_buffer->zv) : ((((XBUFFER (object))-> zv_marker_)) == (builtin_lisp_symbol (0))) ? XBUFFER (object)->zv : marker_position (((XBUFFER (object))-> zv_marker_)))))))
    return limit;
  else
    return ((EMACS_INT) (((EMACS_UINT) (next->position) << INTTYPEBITS) + Lisp_Int0));
}

static struct Lisp_Subr _Alignas (8) Snext_single_property_change = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fnext_single_property_change }, 2, 4, "next-single-property-change", 0, 0}; Lisp_Object Fnext_single_property_change
# 1009 "textprop.c"
  (Lisp_Object position, Lisp_Object prop, Lisp_Object object, Lisp_Object limit)
{
  register INTERVAL i, next;
  ...
  next = next_interval (i);
  while (next
  && ((here_val) == (textget (next->plist, prop)))
  && (((limit) == (builtin_lisp_symbol (0))) || next->position < ((limit) >> INTTYPEBITS)))
    next = next_interval (next);
...
static struct Lisp_Subr _Alignas (8) Sprevious_property_change = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a3 = Fprevious_property_change }, 1, 3, "previous-property-change", 0, 0}; Lisp_Object Fprevious_property_change
# 1057 "textprop.c"
  (Lisp_Object position, Lisp_Object object, Lisp_Object limit)
{
  ...
  if (i->position == ((position) >> INTTYPEBITS))
    i = previous_interval (i);

  previous = previous_interval (i);
  while (previous && intervals_equal (previous, i)
  && (((limit) == (builtin_lisp_symbol (0)))
      || (previous->position + ((previous) == ((void*)0) ? 0 : ((((previous)) == ((void*)0) ? 0 : ((previous))->total_length) - (((previous)->right) == ((void*)0) ? 0 : ((previous)->right)->total_length) - (((previous)->left) == ((void*)0) ? 0 : ((previous)->left)->total_length))) > ((limit) >> INTTYPEBITS))))
    previous = previous_interval (previous);

  if (!previous
      || (previous->position + ((previous) == ((void*)0) ? 0 : ((((previous)) == ((void*)0) ? 0 : ((previous))->total_length) - (((previous)->right) == ((void*)0) ? 0 : ((previous)->right)->total_length) - (((previous)->left) == ((void*)0) ? 0 : ((previous)->left)->total_length)))
   <= (((((enum Lisp_Type) ((limit) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)
       ? ((limit) >> INTTYPEBITS)
       : (STRINGP (object) ? 0 : (XBUFFER (object) == current_buffer ? (current_buffer->begv) : ((((XBUFFER (object))-> begv_marker_)) == (builtin_lisp_symbol (0))) ? XBUFFER (object)->begv : marker_position (((XBUFFER (object))-> begv_marker_)))))))
    return limit;
  else
    return ((EMACS_INT) (((EMACS_UINT) (previous->position + ((previous) == ((void*)0) ? 0 : ((((previous)) == ((void*)0) ? 0 : ((previous))->total_length) - (((previous)->right) == ((void*)0) ? 0 : ((previous)->right)->total_length) - (((previous)->left) == ((void*)0) ? 0 : ((previous)->left)->total_length)))) << INTTYPEBITS) + Lisp_Int0));
}

static struct Lisp_Subr _Alignas (8) Sprevious_single_property_change = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fprevious_single_property_change }, 2, 4, "previous-single-property-change", 0, 0}; Lisp_Object Fprevious_single_property_change
# 1106 "textprop.c"
  (Lisp_Object position, Lisp_Object prop, Lisp_Object object, Lisp_Object limit)
{
  register INTERVAL i, previous;
  ...
  if (i && i->position == ((position) >> INTTYPEBITS))
    i = previous_interval (i);
  ...
  previous = previous_interval (i);
  while (previous
  && ((here_val) == (textget (previous->plist, prop)))
  && (((limit) == (builtin_lisp_symbol (0)))
      || (previous->position + ((previous) == ((void*)0) ? 0 : ((((previous)) == ((void*)0) ? 0 : ((previous))->total_length) - (((previous)->right) == ((void*)0) ? 0 : ((previous)->right)->total_length) - (((previous)->left) == ((void*)0) ? 0 : ((previous)->left)->total_length))) > ((limit) >> INTTYPEBITS))))
    previous = previous_interval (previous);
...
add_text_properties_1 (Lisp_Object start, Lisp_Object end,
  ...
  if (((properties) == (builtin_lisp_symbol (0))))
    return builtin_lisp_symbol (0);
 ...
 retry:
  ...
  s = ((start) >> INTTYPEBITS);
  len = ((end) >> INTTYPEBITS) - s;


  if (interval_has_all_properties (properties, i))
    {
      ptrdiff_t got = ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))) - (s - i->position);
      ...
      do
 {
   ...
   len -= got;
   i = next_interval (i);
   got = ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length)));
 }
  ...
  if (BUFFERP (object) && first_time)
    {
      ptrdiff_t prev_total_length = ((i) == ((void*)0) ? 0 : (i)->total_length);
      ...
      if (((i) == ((void*)0) ? 0 : (i)->total_length) != prev_total_length
   || i->position != prev_pos)
 {
   first_time = 0;
   goto retry;
  ...
  for (;;)
    {
      ...
      if (((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))) >= len)
 {
   if (interval_has_all_properties (properties, i))
     {
       if (BUFFERP (object))
  signal_after_change (((start) >> INTTYPEBITS), ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS),
         ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS));
  ...
  signal_after_change (((start) >> INTTYPEBITS), ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS),
   ...
   return builtin_lisp_symbol (901);
      ...
      len -= ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length)));
...
static struct Lisp_Subr _Alignas (8) Sadd_text_properties = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fadd_text_properties }, 3, 4, "add-text-properties", 0, 0}; Lisp_Object Fadd_text_properties
# 1268 "textprop.c"
...
static struct Lisp_Subr _Alignas (8) Sput_text_property = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a5 = Fput_text_property }, 4, 5, "put-text-property", 0, 0}; Lisp_Object Fput_text_property
...
{
  Lisp_Object properties = (USE_STACK_CONS ? make_lisp_ptr (&(union Aligned_Cons) { { property, { make_lisp_ptr (&(union Aligned_Cons) { { value, { builtin_lisp_symbol (0) } } }.s, Lisp_Cons) } } }.s, Lisp_Cons) : list2 (property, value));
  Fadd_text_properties (start, end, properties, object);
  return builtin_lisp_symbol (0);
}

static struct Lisp_Subr _Alignas (8) Sset_text_properties = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fset_text_properties }, 3, 4, "set-text-properties", 0, 0}; Lisp_Object Fset_text_properties
# 1302 "textprop.c"
  (Lisp_Object start, Lisp_Object end, Lisp_Object properties, Lisp_Object object)
{
  return set_text_properties (start, end, properties, object, builtin_lisp_symbol (901));
}


static struct Lisp_Subr _Alignas (8) Sadd_face_text_property = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a5 = Fadd_face_text_property }, 3, 5, "add-face-text-property", 0, 0}; Lisp_Object Fadd_face_text_property
# 1327 "textprop.c"
  (Lisp_Object start, Lisp_Object end, Lisp_Object face,
   Lisp_Object append, Lisp_Object object)
{
  Lisp_Object properties = (USE_STACK_CONS ? make_lisp_ptr (&(union Aligned_Cons) { { builtin_lisp_symbol (397), { make_lisp_ptr (&(union Aligned_Cons) { { face, { builtin_lisp_symbol (0) } } }.s, Lisp_Cons) } } }.s, Lisp_Cons) : list2 (builtin_lisp_symbol (397), face));
       ...
       Lisp_Object object, Lisp_Object coherent_change_p)
{
  ...
  if (((properties) == (builtin_lisp_symbol (0))) && STRINGP (object)
      && ((start) >> INTTYPEBITS) == 0
      && ((end) >> INTTYPEBITS) == SCHARS (object))
    {
      if (!string_intervals (object))
 return builtin_lisp_symbol (0);

      set_string_intervals (object, ((void*)0));
      return builtin_lisp_symbol (901);
    }
 ...
 return builtin_lisp_symbol (0);
  ...
  if (BUFFERP (object) && !((coherent_change_p) == (builtin_lisp_symbol (0))))
    modify_text_properties (object, start, end);
...
{
  register INTERVAL prev_changed = ((void*)0);
  ...
  else if (((end) >> INTTYPEBITS) < ((start) >> INTTYPEBITS))
    {
      s = ((end) >> INTTYPEBITS);
      len = ((start) >> INTTYPEBITS) - s;
    }
  else
    return;
...
static struct Lisp_Subr _Alignas (8) Sremove_text_properties = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fremove_text_properties }, 3, 4, "remove-text-properties", 0, 0}; Lisp_Object Fremove_text_properties
# 1503 "textprop.c"
  (Lisp_Object start, Lisp_Object end, Lisp_Object properties, Lisp_Object object)
{
  INTERVAL i, unchanged;
      ...
      if (((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))) >= len)
 {
  ...
  signal_after_change (((start) >> INTTYPEBITS), ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS),
   ...
   if (((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))) == len)
     {
       remove_properties (properties, builtin_lisp_symbol (0), i, object);
       if (BUFFERP (object))
  signal_after_change (((start) >> INTTYPEBITS), ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS),
         ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS));
       return builtin_lisp_symbol (901);
   ...
   return builtin_lisp_symbol (901);
      ...
      len -= ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length)));
      modified |= remove_properties (properties, builtin_lisp_symbol (0), i, object);
      i = next_interval (i);
    }
}

static struct Lisp_Subr _Alignas (8) Sremove_list_of_text_properties = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a4 = Fremove_list_of_text_properties }, 3, 4, "remove-list-of-text-properties", 0, 0}; Lisp_Object Fremove_list_of_text_properties
  ...
  (Lisp_Object start, Lisp_Object end, Lisp_Object list_of_properties, Lisp_Object object)
{
      ...
      if (((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))) >= len)
 {
  ...
  {
    if (BUFFERP (object))
      signal_after_change (((start) >> INTTYPEBITS),
      ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS),
      ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS));
    return builtin_lisp_symbol (901);
  }
  ...
  return builtin_lisp_symbol (0);
   ...
   else if (((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))) == len)
     {
       if (!modified && BUFFERP (object))
  modify_text_properties (object, start, end);
       remove_properties (builtin_lisp_symbol (0), properties, i, object);
       if (BUFFERP (object))
  signal_after_change (((start) >> INTTYPEBITS), ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS),
         ((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS));
       return builtin_lisp_symbol (901);
...
static struct Lisp_Subr _Alignas (8) Stext_property_any = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a5 = Ftext_property_any }, 4, 5, "text-property-any", 0, 0}; Lisp_Object Ftext_property_any
  ...
  (Lisp_Object start, Lisp_Object end, Lisp_Object property, Lisp_Object value, Lisp_Object object)
{
  ...
  i = validate_interval_range (object, &start, &end, soft);
  if (!i)
    return (!((value) == (builtin_lisp_symbol (0))) || ((start) == (end)) ? builtin_lisp_symbol (0) : start);
  e = ((end) >> INTTYPEBITS);
  ...
  while (i)
    {
      if (i->position >= e)
 break;
      if (((textget (i->plist, property)) == (value)))
 {
   pos = i->position;
   if (pos < ((start) >> INTTYPEBITS))
     pos = ((start) >> INTTYPEBITS);
   return ((EMACS_INT) (((EMACS_UINT) (pos) << INTTYPEBITS) + Lisp_Int0));
 }
      i = next_interval (i);
    }
  return builtin_lisp_symbol (0);
...
static struct Lisp_Subr _Alignas (8) Stext_property_not_all = { { PVEC_SUBR << PSEUDOVECTOR_AREA_BITS }, { .a5 = Ftext_property_not_all }, 4, 5, "text-property-not-all", 0, 0}; Lisp_Object Ftext_property_not_all
  ...
  (Lisp_Object start, Lisp_Object end, Lisp_Object property, Lisp_Object value, Lisp_Object object)
{
      ...
      if (! ((textget (i->plist, property)) == (value)))
 {
   if (i->position > s)
     s = i->position;
   return ((EMACS_INT) (((EMACS_UINT) (s) << INTTYPEBITS) + Lisp_Int0));
 }
      i = next_interval (i);
    }
  return builtin_lisp_symbol (0);
...
{
  _Bool ignore_previous_character;
  Lisp_Object prev_pos = ((EMACS_INT) (((EMACS_UINT) (((pos) >> INTTYPEBITS) - 1) << INTTYPEBITS) + Lisp_Int0));
  Lisp_Object front_sticky;
  _Bool is_rear_sticky = 1, is_front_sticky = 0;
  Lisp_Object defalt = Fassq (prop, globals.f_Vtext_property_default_nonsticky);
  ...
  ignore_previous_character = ((pos) >> INTTYPEBITS) <= (XBUFFER (buffer) == current_buffer ? (current_buffer->begv) : ((((XBUFFER (buffer))-> begv_marker_)) == (builtin_lisp_symbol (0))) ? XBUFFER (buffer)->begv : marker_position (((XBUFFER (buffer))-> begv_marker_)));

  if (ignore_previous_character || ((((enum Lisp_Type) ((defalt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) && !(((((void) (0 && ((((enum Lisp_Type) ((defalt) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((defalt) - (Lisp_Cons))))->u.cdr) == (builtin_lisp_symbol (0)))))
    is_rear_sticky = 0;
  else
    {
      Lisp_Object rear_non_sticky
 = Fget_text_property (prev_pos, builtin_lisp_symbol (794), buffer);

      if (!(((((enum Lisp_Type) ((rear_non_sticky) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? Fmemq (prop, rear_non_sticky) : rear_non_sticky) == (builtin_lisp_symbol (0))))
 ...
 is_rear_sticky = 0;
  ...
  front_sticky = Fget_text_property (pos, builtin_lisp_symbol (468), buffer);

  if (((front_sticky) == (builtin_lisp_symbol (901)))
      || ((((enum Lisp_Type) ((front_sticky) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)
   && !((Fmemq (prop, front_sticky)) == (builtin_lisp_symbol (0)))))
  ...
  if (ignore_previous_character
      || ((Fget_text_property (prev_pos, prop, buffer)) == (builtin_lisp_symbol (0))))
    return 1;
  else
    return -1;
}
        ...
        Lisp_Object pos, Lisp_Object dest, Lisp_Object prop)
{
  ...
  do { if (((((enum Lisp_Type) (((pos)) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Misc) && XMISCTYPE ((pos)) == Lisp_Misc_Marker)) ((pos) = make_natnum (marker_position (pos))); else ((((((enum Lisp_Type) ((pos) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) & (Lisp_Int0 | ~Lisp_Int1)) == Lisp_Int0)) ? (void) 0 : (void) wrong_type_argument (builtin_lisp_symbol (558), pos)); } while (0);
  {
    ...
    e = ((pos) >> INTTYPEBITS) + (((end) >> INTTYPEBITS) - ((start) >> INTTYPEBITS));
    if ((9223372036854775807L >> INTTYPEBITS) < e)
      args_out_of_range (pos, end);
    dest_start = pos;
    ((dest_end) = make_natnum (e));
  ...
  stuff = builtin_lisp_symbol (0);

  while (s < e)
    {
      e2 = i->position + ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length)));
      if (e2 > e)
 e2 = e;
      len = e2 - s;
 ...
 while (! ((plist) == (builtin_lisp_symbol (0))))
   {
     if (((Fcar (plist)) == (prop)))
       {
  ...
  break;
     ...
     plist = Fcdr (Fcdr (plist));
      ...
      if (! ((plist) == (builtin_lisp_symbol (0))))


 stuff = Fcons (list3 (((EMACS_INT) (((EMACS_UINT) (p) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (p + len) << INTTYPEBITS) + Lisp_Int0)), plist),
         stuff);
 ...
 break;
  ...
  while (! ((stuff) == (builtin_lisp_symbol (0))))
    {
      res = Fcar (stuff);
      res = Fadd_text_properties (Fcar (res), Fcar (Fcdr (res)),
      Fcar (Fcdr (Fcdr (res))), dest);
      if (! ((res) == (builtin_lisp_symbol (0))))
 modified = 1;
      stuff = Fcdr (stuff);
    }

  return modified ? builtin_lisp_symbol (901) : builtin_lisp_symbol (0);
}
# 1967 "textprop.c"
Lisp_Object
text_property_list (Lisp_Object object, Lisp_Object start, Lisp_Object end, Lisp_Object prop)
{
  ...
  if (i)
    {
      ptrdiff_t s = ((start) >> INTTYPEBITS);
      ptrdiff_t e = ((end) >> INTTYPEBITS);
      ...
      while (s < e)
 {
   ...
   interval_end = i->position + ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length)));
   if (interval_end > e)
     interval_end = e;
   len = interval_end - s;
   ...
   if (!((prop) == (builtin_lisp_symbol (0))))
     for (; (((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); plist = Fcdr ((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->u.cdr))
       if ((((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->car) == (prop)))
  {
    plist = list2 (prop, Fcar ((((void) (0 && ((((enum Lisp_Type) ((plist) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((plist) - (Lisp_Cons))))->u.cdr));
    break;
  }

   if (!((plist) == (builtin_lisp_symbol (0))))
     result = Fcons (list3 (((EMACS_INT) (((EMACS_UINT) (s) << INTTYPEBITS) + Lisp_Int0)), ((EMACS_INT) (((EMACS_UINT) (s + len) << INTTYPEBITS) + Lisp_Int0)),
       plist),
       result);
...
{
  for (; (((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); list = (((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->u.cdr)
    {
      Lisp_Object item, start, end, plist;

      item = (((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car;
      start = ((EMACS_INT) (((EMACS_UINT) ((((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->car) >> INTTYPEBITS) + ((delta) >> INTTYPEBITS)) << INTTYPEBITS) + Lisp_Int0));
      end = ((EMACS_INT) (((EMACS_UINT) ((((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car) >> INTTYPEBITS) + ((delta) >> INTTYPEBITS)) << INTTYPEBITS) + Lisp_Int0));
      plist = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car;
...
{
  Lisp_Object prev = builtin_lisp_symbol (0), head = list;
  ptrdiff_t max = ((new_end) >> INTTYPEBITS);

  for (; (((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons); prev = list, list = (((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->u.cdr)
    {
      Lisp_Object item, beg, end;

      item = (((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->car;
      beg = (((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->car;
      end = (((void) (0 && ((((enum Lisp_Type) (((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->u.cdr) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) (((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->u.cdr) - (Lisp_Cons))))->car;

      if (((beg) >> INTTYPEBITS) >= max)
 {


   if (((head) == (list)))
     head = (((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->u.cdr;
   else
     XSETCDR (prev, (((void) (0 && ((((enum Lisp_Type) ((list) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((list) - (Lisp_Cons))))->u.cdr);
 }
      else if (((end) >> INTTYPEBITS) > max)

 XSETCAR ((((void) (0 && ((((enum Lisp_Type) ((item) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons)))), (struct Lisp_Cons *) ((void *) (intptr_t) ((item) - (Lisp_Cons))))->u.cdr, new_end);
    }
         ...
         ptrdiff_t start, ptrdiff_t end)
{
  ...
  hooks = builtin_lisp_symbol (0);
  prev_mod_hooks = builtin_lisp_symbol (0);
  mod_hooks = builtin_lisp_symbol (0);

  interval_insert_behind_hooks = builtin_lisp_symbol (0);
  interval_insert_in_front_hooks = builtin_lisp_symbol (0);
  ...
  if (start == end)
    {
      ...
      if (start == (buf == current_buffer ? (current_buffer->begv) : ((((buf)-> begv_marker_)) == (builtin_lisp_symbol (0))) ? buf->begv : marker_position (((buf)-> begv_marker_))))
 prev = 0;
      else if (i->position == start)
 prev = previous_interval (i);
      else if (i->position < start)
 prev = i;
      if (start == (buf == current_buffer ? (current_buffer->zv) : ((((buf)-> zv_marker_)) == (builtin_lisp_symbol (0))) ? buf->zv : marker_position (((buf)-> zv_marker_))))
 i = 0;



      if (((globals.f_Vinhibit_read_only) == (builtin_lisp_symbol (0))) || (((enum Lisp_Type) ((globals.f_Vinhibit_read_only) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons))
 {
   ...
   if (i != prev)
     {
       if (i)
  {
    after = textget (i->plist, builtin_lisp_symbol (792));




    if (! ((after) == (builtin_lisp_symbol (0)))
        && ((Fmemq (after, globals.f_Vinhibit_read_only)) == (builtin_lisp_symbol (0))))
      {
        Lisp_Object tem;

        tem = textget (i->plist, builtin_lisp_symbol (468));
        if (((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? ! ((Fmemq (builtin_lisp_symbol (792), tem)) == (builtin_lisp_symbol (0))) : ! ((tem) == (builtin_lisp_symbol (0))))
     || (((Fplist_get (i->plist, builtin_lisp_symbol (792))) == (builtin_lisp_symbol (0)))
         && ((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? ! ((Fmemq (builtin_lisp_symbol (241), tem)) == (builtin_lisp_symbol (0))) : ! ((tem) == (builtin_lisp_symbol (0))))))
   text_read_only (after);
       ...
       if (prev)
  {
    before = textget (prev->plist, builtin_lisp_symbol (792));




    if (! ((before) == (builtin_lisp_symbol (0)))
        && ((Fmemq (before, globals.f_Vinhibit_read_only)) == (builtin_lisp_symbol (0))))
      {
        Lisp_Object tem;

        tem = textget (prev->plist, builtin_lisp_symbol (794));
        if (! ((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? ! ((Fmemq (builtin_lisp_symbol (792), tem)) == (builtin_lisp_symbol (0))) : ! ((tem) == (builtin_lisp_symbol (0))))
     && (! ((Fplist_get (prev->plist,builtin_lisp_symbol (792))) == (builtin_lisp_symbol (0)))
         || ! ((((enum Lisp_Type) ((tem) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? ! ((Fmemq (builtin_lisp_symbol (241), tem)) == (builtin_lisp_symbol (0))) : ! ((tem) == (builtin_lisp_symbol (0))))))
   text_read_only (before);
   ...
   else if (i)
     {
       ...
       if (! ((after) == (builtin_lisp_symbol (0))) && ((Fmemq (after, globals.f_Vinhibit_read_only)) == (builtin_lisp_symbol (0))))
  {
    Lisp_Object tem;
 ...
 interval_insert_behind_hooks
   = textget (prev->plist, builtin_lisp_symbol (552));
      if (i)
 interval_insert_in_front_hooks
   = textget (i->plist, builtin_lisp_symbol (554));
    }
  else
    {
      ...
      do
 {
   if (! (i && (((textget ((i)->plist, builtin_lisp_symbol (792))) == (builtin_lisp_symbol (0))) || !((textget ((i)->plist, builtin_lisp_symbol (547))) == (builtin_lisp_symbol (0))) || (((((enum Lisp_Type) ((globals.f_Vinhibit_read_only) & ~(((9223372036854775807L >> (3 - 1)) / 2 < (9223372036854775807L)) ? - (1 << 3) : (9223372036854775807L >> (3 - 1))))) == Lisp_Cons) ? !((Fmemq (textget ((i)->plist, builtin_lisp_symbol (792)), globals.f_Vinhibit_read_only)) == (builtin_lisp_symbol (0))) : !((globals.f_Vinhibit_read_only) == (builtin_lisp_symbol (0))))))))
     text_read_only (textget (i->plist, builtin_lisp_symbol (792)));

   if (!globals.f_inhibit_modification_hooks)
     {
       mod_hooks = textget (i->plist, builtin_lisp_symbol (676));
       if (! ((mod_hooks) == (builtin_lisp_symbol (0))) && ! ((mod_hooks) == (prev_mod_hooks)))
  {
   ...
   if (i->position + ((i) == ((void*)0) ? 0 : ((((i)) == ((void*)0) ? 0 : ((i))->total_length) - (((i)->right) == ((void*)0) ? 0 : ((i)->right)->total_length) - (((i)->left) == ((void*)0) ? 0 : ((i)->left)->total_length))) < end
       && (!((((current_buffer)-> read_only_)) == (builtin_lisp_symbol (0)))
      ...
      if (!globals.f_inhibit_modification_hooks)
 {
   ...
   while (! ((hooks) == (builtin_lisp_symbol (0))))
     {
       call_mod_hooks (Fcar (hooks), ((EMACS_INT) (((EMACS_UINT) (start) << INTTYPEBITS) + Lisp_Int0)),
         ((EMACS_INT) (((EMACS_UINT) (end) << INTTYPEBITS) + Lisp_Int0)));
       hooks = Fcdr (hooks);
     }
 }
    }
...
{
  if (! ((interval_insert_behind_hooks) == (builtin_lisp_symbol (0))))
    call_mod_hooks (interval_insert_behind_hooks, start, end);
  if (! ((interval_insert_in_front_hooks) == (builtin_lisp_symbol (0)))
      && ! ((interval_insert_in_front_hooks) == (interval_insert_behind_hooks)))
...
{
  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "default-text-properties", &globals.f_Vdefault_text_properties); } while (0);



  globals.f_Vdefault_text_properties = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "char-property-alias-alist", &globals.f_Vchar_property_alias_alist); } while (0);
  ...
  globals.f_Vchar_property_alias_alist = builtin_lisp_symbol (0);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "inhibit-point-motion-hooks", &globals.f_Vinhibit_point_motion_hooks); } while (0);
# 2319 "textprop.c"
  globals.f_Vinhibit_point_motion_hooks = builtin_lisp_symbol (901);

  do { static struct Lisp_Objfwd o_fwd; defvar_lisp (&o_fwd, "text-property-default-nonsticky", &globals.f_Vtext_property_default_nonsticky); } while (0);
# 2332 "textprop.c"
  globals.f_Vtext_property_default_nonsticky
    = list2 (Fcons (builtin_lisp_symbol (899), builtin_lisp_symbol (901)), Fcons (builtin_lisp_symbol (344), builtin_lisp_symbol (901)));
