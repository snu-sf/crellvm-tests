...
define i32 @process_non_source_image(%struct.gs_context_state_s* %i_ctx_p, %struct.gs_image_common_s* %pic, i8* %cname) #0 {
entry:
  ...
  %4 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs, align 8, !tbaa !5
  %call = call i32 @gs_image_begin_typed(%struct.gs_image_common_s* %2, %struct.gs_state_s* %4, i32 0, %struct.gx_image_enum_common_s** %pie) #3
  store i32 %call, i32* %code, align 4, !tbaa !19
  %5 = load i32, i32* %code, align 4, !tbaa !19
  %6 = bitcast i32* %code to i8*
  call void @llvm.lifetime.end(i64 4, i8* %6) #1
  %7 = bitcast %struct.gx_image_enum_common_s** %pie to i8*
