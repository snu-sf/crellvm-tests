...
define i32 @gs_setrasterop(%struct.gs_state_s* %pgs, i32 %rop) #0 {
entry:
  ...
  %1 = load i32, i32* %in_cachedevice, align 4, !tbaa !6
...
if.end:                                           ; preds = %entry
  %2 = load i32, i32* %rop.addr, align 4, !tbaa !5
  %and = and i32 %2, 255
  %3 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %log_op = getelementptr inbounds %struct.gs_state_s, %struct.gs_state_s* %3, i32 0, i32 10
  %4 = load i32, i32* %log_op, align 4, !tbaa !24
  %and1 = and i32 %4, -256
  %or = or i32 %and, %and1
  %5 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %log_op2 = getelementptr inbounds %struct.gs_state_s, %struct.gs_state_s* %5, i32 0, i32 10
  store i32 %or, i32* %log_op2, align 4, !tbaa !24
...
; Function Attrs: nounwind uwtable
define i32 @gs_currentrasterop(%struct.gs_state_s* %pgs) #0 {
entry:
  %pgs.addr = alloca %struct.gs_state_s*, align 8
  store %struct.gs_state_s* %pgs, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %0 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %log_op = getelementptr inbounds %struct.gs_state_s, %struct.gs_state_s* %0, i32 0, i32 10
  %1 = load i32, i32* %log_op, align 4, !tbaa !24
  %and = and i32 %1, 255
  ret i32 %and
}

; Function Attrs: nounwind uwtable
define i32 @gs_setsourcetransparent(%struct.gs_state_s* %pgs, i32 %transparent) #0 {
entry:
  %retval = alloca i32, align 4
  %pgs.addr = alloca %struct.gs_state_s*, align 8
  %transparent.addr = alloca i32, align 4
  store %struct.gs_state_s* %pgs, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  store i32 %transparent, i32* %transparent.addr, align 4, !tbaa !25
  %0 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %in_cachedevice = getelementptr inbounds %struct.gs_state_s, %struct.gs_state_s* %0, i32 0, i32 74
  %1 = load i32, i32* %in_cachedevice, align 4, !tbaa !6
  %tobool = icmp ne i32 %1, 0
...
if.end:                                           ; preds = %entry
  %2 = load i32, i32* %transparent.addr, align 4, !tbaa !25
...
cond.false:                                       ; preds = %if.end
  %5 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %log_op2 = getelementptr inbounds %struct.gs_state_s, %struct.gs_state_s* %5, i32 0, i32 10
  %6 = load i32, i32* %log_op2, align 4, !tbaa !24
  %and = and i32 %6, -257
  br label %cond.end
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %log_op3 = getelementptr inbounds %struct.gs_state_s, %struct.gs_state_s* %7, i32 0, i32 10
  store i32 %cond, i32* %log_op3, align 4, !tbaa !24
  store i32 0, i32* %retval
  br label %return
...
; Function Attrs: nounwind uwtable
define i32 @gs_currentsourcetransparent(%struct.gs_state_s* %pgs) #0 {
entry:
  %pgs.addr = alloca %struct.gs_state_s*, align 8
  store %struct.gs_state_s* %pgs, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %0 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
...
; Function Attrs: nounwind uwtable
define i32 @gs_settexturetransparent(%struct.gs_state_s* %pgs, i32 %transparent) #0 {
entry:
  %retval = alloca i32, align 4
  %pgs.addr = alloca %struct.gs_state_s*, align 8
  %transparent.addr = alloca i32, align 4
...
; Function Attrs: nounwind uwtable
define i32 @gs_currenttexturetransparent(%struct.gs_state_s* %pgs) #0 {
entry:
  %pgs.addr = alloca %struct.gs_state_s*, align 8
  store %struct.gs_state_s* %pgs, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %0 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
...
; Function Attrs: nounwind uwtable
define i32 @gs_set_logical_op(%struct.gs_state_s* %pgs, i32 %lop) #0 {
entry:
  %pgs.addr = alloca %struct.gs_state_s*, align 8
  %lop.addr = alloca i32, align 4
  store %struct.gs_state_s* %pgs, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  store i32 %lop, i32* %lop.addr, align 4, !tbaa !25
  %0 = load i32, i32* %lop.addr, align 4, !tbaa !25
  %1 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %log_op = getelementptr inbounds %struct.gs_state_s, %struct.gs_state_s* %1, i32 0, i32 10
  store i32 %0, i32* %log_op, align 4, !tbaa !24
  ret i32 0
}

; Function Attrs: nounwind uwtable
define i32 @gs_current_logical_op(%struct.gs_state_s* %pgs) #0 {
entry:
  %pgs.addr = alloca %struct.gs_state_s*, align 8
  store %struct.gs_state_s* %pgs, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %0 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
