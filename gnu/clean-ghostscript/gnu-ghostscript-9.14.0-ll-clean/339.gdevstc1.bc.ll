...
define i32 @stc_gsmono(%struct.stcolor_device_s* %sdev, i32 %npixel, i8* %in, i8* %buf, i8* %out) #0 {
entry:
  ...
  %0 = load i32, i32* %npixel.addr, align 4, !tbaa !5
...
if.then.2:                                        ; preds = %if.then
  ...
  %call = call i8* @memcpy(i8* %2, i8* %3, i64 %conv) #3
  br label %if.end
...
if.else:                                          ; preds = %if.then
  ...
  %call4 = call i8* @memset(i8* %5, i32 0, i64 %conv3) #3
  br label %if.end
...
if.else.5:                                        ; preds = %entry
  ...
  %9 = load %struct.stc_dither_s*, %struct.stc_dither_s** %dither, align 8, !tbaa !7
  %bufadd = getelementptr inbounds %struct.stc_dither_s, %struct.stc_dither_s* %9, i32 0, i32 3
  %10 = load i32, i32* %bufadd, align 4, !tbaa !26
  %11 = load i32, i32* %npixel.addr, align 4, !tbaa !5
  %sub = sub nsw i32 0, %11
  %12 = load %struct.stcolor_device_s*, %struct.stcolor_device_s** %sdev.addr, align 8, !tbaa !1
  %stc6 = getelementptr inbounds %struct.stcolor_device_s, %struct.stcolor_device_s* %12, i32 0, i32 68
  %dither7 = getelementptr inbounds %struct.stc_s, %struct.stc_s* %stc6, i32 0, i32 2
  %13 = load %struct.stc_dither_s*, %struct.stc_dither_s** %dither7, align 8, !tbaa !7
  %flags = getelementptr inbounds %struct.stc_dither_s, %struct.stc_dither_s* %13, i32 0, i32 2
  %14 = load i32, i32* %flags, align 4, !tbaa !28
  %div = udiv i32 %14, 256
  %mul = mul i32 %sub, %div
  %15 = load %struct.stcolor_device_s*, %struct.stcolor_device_s** %sdev.addr, align 8, !tbaa !1
  %color_info = getelementptr inbounds %struct.stcolor_device_s, %struct.stcolor_device_s* %15, i32 0, i32 11
  %num_components = getelementptr inbounds %struct.gx_device_color_info_s, %struct.gx_device_color_info_s* %color_info, i32 0, i32 1
  %16 = load i32, i32* %num_components, align 4, !tbaa !29
  %mul8 = mul i32 %mul, %16
  %add = add i32 %10, %mul8
  store i32 %add, i32* %buf_size, align 4, !tbaa !5
  %17 = load i32, i32* %buf_size, align 4, !tbaa !5
  %cmp9 = icmp sgt i32 %17, 0
  br i1 %cmp9, label %if.then.11, label %if.end.16

if.then.11:                                       ; preds = %if.else.5
  %18 = load i8*, i8** %buf.addr, align 8, !tbaa !1
  %19 = load i32, i32* %buf_size, align 4, !tbaa !5
  %20 = load %struct.stcolor_device_s*, %struct.stcolor_device_s** %sdev.addr, align 8, !tbaa !1
  %stc12 = getelementptr inbounds %struct.stcolor_device_s, %struct.stcolor_device_s* %20, i32 0, i32 68
  %alg_item = getelementptr inbounds %struct.stc_s, %struct.stc_s* %stc12, i32 0, i32 19
  %21 = load i32, i32* %alg_item, align 4, !tbaa !30
  %mul13 = mul nsw i32 %19, %21
  %conv14 = sext i32 %mul13 to i64
  %call15 = call i8* @memset(i8* %18, i32 0, i64 %conv14) #3
  br label %if.end.16

if.end.16:                                        ; preds = %if.then.11, %if.else.5
  %22 = load %struct.stcolor_device_s*, %struct.stcolor_device_s** %sdev.addr, align 8, !tbaa !1
  %color_info17 = getelementptr inbounds %struct.stcolor_device_s, %struct.stcolor_device_s* %22, i32 0, i32 11
  ...
  %23 = load i32, i32* %num_components18, align 4, !tbaa !29
...
if.end.22:                                        ; preds = %if.end.16
  ...
  %stc23 = getelementptr inbounds %struct.stcolor_device_s, %struct.stcolor_device_s* %24, i32 0, i32 68
  %dither24 = getelementptr inbounds %struct.stc_s, %struct.stc_s* %stc23, i32 0, i32 2
  %25 = load %struct.stc_dither_s*, %struct.stc_dither_s** %dither24, align 8, !tbaa !7
  %flags25 = getelementptr inbounds %struct.stc_dither_s, %struct.stc_dither_s* %25, i32 0, i32 2
  %26 = load i32, i32* %flags25, align 4, !tbaa !28
  %and = and i32 %26, 24
  %cmp26 = icmp ne i32 %and, 8
...
if.end.29:                                        ; preds = %if.end.22
  ...
  %stc30 = getelementptr inbounds %struct.stcolor_device_s, %struct.stcolor_device_s* %27, i32 0, i32 68
  %dither31 = getelementptr inbounds %struct.stc_s, %struct.stc_s* %stc30, i32 0, i32 2
  %28 = load %struct.stc_dither_s*, %struct.stc_dither_s** %dither31, align 8, !tbaa !7
  %flags32 = getelementptr inbounds %struct.stc_dither_s, %struct.stc_dither_s* %28, i32 0, i32 2
  %29 = load i32, i32* %flags32, align 4, !tbaa !28
  %and33 = and i32 %29, 64
...
cleanup:                                          ; preds = %if.end.37, %if.then.36, %if.then.28, %if.then.21
  %30 = bitcast i32* %buf_size to i8*
...
!23 = !{!"stc_s", !10, i64 0, !6, i64 8, !2, i64 16, !2, i64 24, !3, i64 32, !3, i64 64, !3, i64 80, !3, i64 112, !3, i64 144, !3, i64 160, !3, i64 192, !3, i64 204, !24, i64 216, !25, i64 232, !25, i64 248, !6, i64 264, !6, i64 268, !6, i64 272, !6, i64 276, !6, i64 280, !6, i64 284, !6, i64 288, !6, i64 292, !6, i64 296, !6, i64 300, !6, i64 304, !6, i64 308, !6, i64 312, !6, i64 316, !6, i64 320, !6, i64 324, !6, i64 328, !6, i64 332, !6, i64 336, !2, i64 344, !2, i64 352, !2, i64 360, !3, i64 368, !6, i64 400}
!24 = !{!"gs_param_string_array_s", !2, i64 0, !6, i64 8, !6, i64 12}
!25 = !{!"gs_param_string_s", !2, i64 0, !6, i64 8, !6, i64 12}
!26 = !{!27, !6, i64 20}
!27 = !{!"stc_dither_s", !2, i64 0, !2, i64 8, !6, i64 16, !6, i64 20, !3, i64 24}
!28 = !{!27, !6, i64 16}
!29 = !{!8, !6, i64 100}
!30 = !{!8, !6, i64 18752}
