...
define internal i32 @cif_print_page(%struct.gx_device_printer_s* %pdev, %struct._IO_FILE* %prn_stream) #1 {
entry:
  ...
  %10 = load i8* (%struct.gs_memory_s*, i32, i32, i8*)*, i8* (%struct.gs_memory_s*, i32, i32, i8*)** %alloc_byte_array, align 8, !tbaa !26
  %11 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory1 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %11, i32 0, i32 3
  %12 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory1, align 8, !tbaa !7
  ...
  %14 = load i32, i32* %line_size, align 4, !tbaa !5
  %call3 = call i8* %10(%struct.gs_memory_s* %13, i32 %14, i32 1, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0)) #5
  store i8* %call3, i8** %in, align 8, !tbaa !1
  %15 = bitcast i8** %s to i8*
  call void @llvm.lifetime.start(i64 8, i8* %15) #2
  %16 = bitcast i32* %scanline to i8*
  call void @llvm.lifetime.start(i64 4, i8* %16) #2
  %17 = bitcast i32* %scanbyte to i8*
  call void @llvm.lifetime.start(i64 4, i8* %17) #2
  %18 = bitcast i32* %length to i8*
  call void @llvm.lifetime.start(i64 4, i8* %18) #2
  %19 = bitcast i32* %start to i8*
  call void @llvm.lifetime.start(i64 4, i8* %19) #2
  %20 = load i8*, i8** %in, align 8, !tbaa !1
...
if.end:                                           ; preds = %entry
  ...
  %fname = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %21, i32 0, i32 45
  %arraydecay = getelementptr inbounds [4096 x i8], [4096 x i8]* %fname, i32 0, i32 0
  %call4 = call i8* @strchr(i8* %arraydecay, i32 46) #6
  store i8* %call4, i8** %s, align 8, !tbaa !1
...
if.then.6:                                        ; preds = %if.end
  ...
  %fname7 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %22, i32 0, i32 45
  %arraydecay8 = getelementptr inbounds [4096 x i8], [4096 x i8]* %fname7, i32 0, i32 0
...
if.else:                                          ; preds = %if.end
  ...
  %fname10 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %24, i32 0, i32 45
  %arraydecay11 = getelementptr inbounds [4096 x i8], [4096 x i8]* %fname10, i32 0, i32 0
  ...
  store i32 %conv12, i32* %length, align 4, !tbaa !5
  br label %if.end.13

if.end.13:                                        ; preds = %if.else, %if.then.6
  %25 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory14 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %25, i32 0, i32 3
  %26 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory14, align 8, !tbaa !7
  %non_gc_memory15 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %26, i32 0, i32 3
  %27 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory15, align 8, !tbaa !23
  ...
  %28 = load i8* (%struct.gs_memory_s*, i32, i32, i8*)*, i8* (%struct.gs_memory_s*, i32, i32, i8*)** %alloc_byte_array17, align 8, !tbaa !26
  ...
  %30 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory18, align 8, !tbaa !7
  %non_gc_memory19 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %30, i32 0, i32 3
  %31 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory19, align 8, !tbaa !23
  %32 = load i32, i32* %length, align 4, !tbaa !5
  %call20 = call i8* %28(%struct.gs_memory_s* %31, i32 %32, i32 1, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3, i32 0, i32 0)) #5
  store i8* %call20, i8** %s, align 8, !tbaa !1
  %33 = load i8*, i8** %s, align 8, !tbaa !1
  %34 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %fname21 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %34, i32 0, i32 45
  %arraydecay22 = getelementptr inbounds [4096 x i8], [4096 x i8]* %fname21, i32 0, i32 0
  %35 = load i32, i32* %length, align 4, !tbaa !5
  %conv23 = sext i32 %35 to i64
  %call24 = call i8* @strncpy(i8* %33, i8* %arraydecay22, i64 %conv23) #6
  ...
  store i8 0, i8* %add.ptr, align 1, !tbaa !27
  %38 = load %struct._IO_FILE*, %struct._IO_FILE** %prn_stream.addr, align 8, !tbaa !1
  %39 = load i8*, i8** %s, align 8, !tbaa !1
  %call25 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %38, i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.4, i32 0, i32 0), i8* %39) #5
  %40 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory26 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %40, i32 0, i32 3
  %41 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory26, align 8, !tbaa !7
  %non_gc_memory27 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %41, i32 0, i32 3
  %42 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory27, align 8, !tbaa !23
  %procs28 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %42, i32 0, i32 1
  %free_object = getelementptr inbounds %struct.gs_memory_procs_s, %struct.gs_memory_procs_s* %procs28, i32 0, i32 2
  %43 = load void (%struct.gs_memory_s*, i8*, i8*)*, void (%struct.gs_memory_s*, i8*, i8*)** %free_object, align 8, !tbaa !28
  %44 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory29 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %44, i32 0, i32 3
  %45 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory29, align 8, !tbaa !7
  %non_gc_memory30 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %45, i32 0, i32 3
  %46 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory30, align 8, !tbaa !23
  %47 = load i8*, i8** %s, align 8, !tbaa !1
  call void %43(%struct.gs_memory_s* %46, i8* %47, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3, i32 0, i32 0)) #5
  store i32 0, i32* %lnum, align 4, !tbaa !5
  br label %for.cond

for.cond:                                         ; preds = %for.inc.68, %if.end.13
  ...
  %50 = load i32, i32* %height, align 4, !tbaa !29
  %cmp31 = icmp slt i32 %48, %50
  br i1 %cmp31, label %for.body, label %for.end.70
...
for.body:                                         ; preds = %for.cond
  ...
  %53 = load i8*, i8** %in, align 8, !tbaa !1
  %54 = load i32, i32* %line_size, align 4, !tbaa !5
  %call33 = call i32 @gdev_prn_copy_scan_lines(%struct.gx_device_printer_s* %51, i32 %52, i8* %53, i32 %54) #5
  store i32 0, i32* %length, align 4, !tbaa !5
  store i32 0, i32* %scanline, align 4, !tbaa !5
  br label %for.cond.34

for.cond.34:                                      ; preds = %for.inc.65, %for.body
  %55 = load i32, i32* %scanline, align 4, !tbaa !5
  %56 = load i32, i32* %line_size, align 4, !tbaa !5
  %cmp35 = icmp slt i32 %55, %56
  br i1 %cmp35, label %for.body.37, label %for.end.67

for.body.37:                                      ; preds = %for.cond.34
  store i32 7, i32* %scanbyte, align 4, !tbaa !5
  br label %for.cond.38

for.cond.38:                                      ; preds = %for.inc, %for.body.37
  %57 = load i32, i32* %scanbyte, align 4, !tbaa !5
  %cmp39 = icmp sge i32 %57, 0
  br i1 %cmp39, label %for.body.41, label %for.end

for.body.41:                                      ; preds = %for.cond.38
  %58 = load i32, i32* %scanline, align 4, !tbaa !5
  %idxprom = sext i32 %58 to i64
  %59 = load i8*, i8** %in, align 8, !tbaa !1
  %arrayidx = getelementptr inbounds i8, i8* %59, i64 %idxprom
  %60 = load i8, i8* %arrayidx, align 1, !tbaa !27
  %conv42 = zext i8 %60 to i32
  %61 = load i32, i32* %scanbyte, align 4, !tbaa !5
  %shr = ashr i32 %conv42, %61
  %and = and i32 %shr, 1
  %cmp43 = icmp ne i32 %and, 0
  br i1 %cmp43, label %if.then.45, label %if.else.51

if.then.45:                                       ; preds = %for.body.41
  %62 = load i32, i32* %length, align 4, !tbaa !5
  %cmp46 = icmp eq i32 %62, 0
  br i1 %cmp46, label %if.then.48, label %if.end.50

if.then.48:                                       ; preds = %if.then.45
  %63 = load i32, i32* %scanline, align 4, !tbaa !5
  %mul = mul nsw i32 %63, 8
  %64 = load i32, i32* %scanbyte, align 4, !tbaa !5
  %sub = sub nsw i32 7, %64
  %add49 = add nsw i32 %mul, %sub
  store i32 %add49, i32* %start, align 4, !tbaa !5
  br label %if.end.50

if.end.50:                                        ; preds = %if.then.48, %if.then.45
  %65 = load i32, i32* %length, align 4, !tbaa !5
  %inc = add nsw i32 %65, 1
  store i32 %inc, i32* %length, align 4, !tbaa !5
  br label %if.end.64

if.else.51:                                       ; preds = %for.body.41
  %66 = load i32, i32* %length, align 4, !tbaa !5
...
if.then.54:                                       ; preds = %if.else.51
  ...
  %68 = load i32, i32* %length, align 4, !tbaa !5
  %mul55 = mul nsw i32 %68, 4
  %69 = load i32, i32* %start, align 4, !tbaa !5
  %mul56 = mul nsw i32 %69, 4
  %70 = load i32, i32* %length, align 4, !tbaa !5
  %mul57 = mul nsw i32 %70, 2
  %add58 = add nsw i32 %mul56, %mul57
  %71 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %height59 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %71, i32 0, i32 14
  %72 = load i32, i32* %height59, align 4, !tbaa !29
  %73 = load i32, i32* %lnum, align 4, !tbaa !5
  %sub60 = sub nsw i32 %72, %73
  %mul61 = mul nsw i32 %sub60, 4
  %call62 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %67, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i32 0, i32 0), i32 %mul55, i32 %add58, i32 %mul61) #5
  br label %if.end.63

if.end.63:                                        ; preds = %if.then.54, %if.else.51
  store i32 0, i32* %length, align 4, !tbaa !5
  br label %if.end.64
...
for.inc:                                          ; preds = %if.end.64
  %74 = load i32, i32* %scanbyte, align 4, !tbaa !5
  %dec = add nsw i32 %74, -1
  store i32 %dec, i32* %scanbyte, align 4, !tbaa !5
  br label %for.cond.38
...
for.inc.65:                                       ; preds = %for.end
  %75 = load i32, i32* %scanline, align 4, !tbaa !5
  %inc66 = add nsw i32 %75, 1
  store i32 %inc66, i32* %scanline, align 4, !tbaa !5
  br label %for.cond.34

for.end.67:                                       ; preds = %for.cond.34
  br label %for.inc.68

for.inc.68:                                       ; preds = %for.end.67
  %76 = load i32, i32* %lnum, align 4, !tbaa !5
  %inc69 = add nsw i32 %76, 1
  store i32 %inc69, i32* %lnum, align 4, !tbaa !5
  br label %for.cond

for.end.70:                                       ; preds = %for.cond
  %77 = load %struct._IO_FILE*, %struct._IO_FILE** %prn_stream.addr, align 8, !tbaa !1
  %call71 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %77, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.6, i32 0, i32 0)) #5
  %78 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory72 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %78, i32 0, i32 3
  %79 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory72, align 8, !tbaa !7
  %non_gc_memory73 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %79, i32 0, i32 3
  %80 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory73, align 8, !tbaa !23
  %procs74 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %80, i32 0, i32 1
  %free_object75 = getelementptr inbounds %struct.gs_memory_procs_s, %struct.gs_memory_procs_s* %procs74, i32 0, i32 2
  %81 = load void (%struct.gs_memory_s*, i8*, i8*)*, void (%struct.gs_memory_s*, i8*, i8*)** %free_object75, align 8, !tbaa !28
  %82 = load %struct.gx_device_printer_s*, %struct.gx_device_printer_s** %pdev.addr, align 8, !tbaa !1
  %memory76 = getelementptr inbounds %struct.gx_device_printer_s, %struct.gx_device_printer_s* %82, i32 0, i32 3
  %83 = load %struct.gs_memory_s*, %struct.gs_memory_s** %memory76, align 8, !tbaa !7
  %non_gc_memory77 = getelementptr inbounds %struct.gs_memory_s, %struct.gs_memory_s* %83, i32 0, i32 3
  %84 = load %struct.gs_memory_s*, %struct.gs_memory_s** %non_gc_memory77, align 8, !tbaa !23
  %85 = load i8*, i8** %in, align 8, !tbaa !1
  call void %81(%struct.gs_memory_s* %84, i8* %85, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.2, i32 0, i32 0)) #5
  store i32 0, i32* %retval
  store i32 1, i32* %cleanup.dest.slot
  br label %cleanup

cleanup:                                          ; preds = %for.end.70, %if.then
  %86 = bitcast i32* %start to i8*
  call void @llvm.lifetime.end(i64 4, i8* %86) #2
  %87 = bitcast i32* %length to i8*
  call void @llvm.lifetime.end(i64 4, i8* %87) #2
  %88 = bitcast i32* %scanbyte to i8*
  call void @llvm.lifetime.end(i64 4, i8* %88) #2
  %89 = bitcast i32* %scanline to i8*
  call void @llvm.lifetime.end(i64 4, i8* %89) #2
  %90 = bitcast i8** %s to i8*
  call void @llvm.lifetime.end(i64 8, i8* %90) #2
  %91 = bitcast i8** %in to i8*
  call void @llvm.lifetime.end(i64 8, i8* %91) #2
  %92 = bitcast i32* %lnum to i8*
  call void @llvm.lifetime.end(i64 4, i8* %92) #2
  %93 = bitcast i32* %line_size to i8*
