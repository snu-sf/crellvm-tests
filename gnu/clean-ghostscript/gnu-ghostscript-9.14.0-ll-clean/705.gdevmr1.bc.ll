...
define i32 @mem_mono_strip_copy_rop(%struct.gx_device_s* %dev, i8* %sdata, i32 %sourcex, i32 %sraster, i64 %id, i64* %scolors, %struct.gx_strip_bitmap_s* %textures, i64* %tcolors, i32 %x, i32 %y, i32 %width, i32 %height, i32 %phase_x, i32 %phase_y, i32 %lop) #0 {
entry:
  ...
  %call = call i32 @gs_transparent_rop(i32 %4) #3
  store i32 %call, i32* %rop, align 4, !tbaa !9
...
if.then:                                          ; preds = %entry
  %8 = bitcast [3 x i16]* %cv to i8*
  call void @llvm.lifetime.start(i64 6, i8* %8) #1
  %arrayidx = getelementptr inbounds [3 x i16], [3 x i16]* %cv, i32 0, i64 2
  store i16 0, i16* %arrayidx, align 2, !tbaa !31
  %arrayidx1 = getelementptr inbounds [3 x i16], [3 x i16]* %cv, i32 0, i64 1
  store i16 0, i16* %arrayidx1, align 2, !tbaa !31
  %arrayidx2 = getelementptr inbounds [3 x i16], [3 x i16]* %cv, i32 0, i64 0
  store i16 0, i16* %arrayidx2, align 2, !tbaa !31
  ...
  %11 = load i64 (%struct.gx_device_s*, i16*)*, i64 (%struct.gx_device_s*, i16*)** %encode_color, align 8, !tbaa !32
  ...
  %call3 = call i64 %11(%struct.gx_device_s* %12, i16* %arraydecay) #3
  %cmp4 = icmp ne i64 %call3, 0
  %conv = zext i1 %cmp4 to i32
  call void @gdev_mem_mono_set_inverted(%struct.gx_device_memory_s* %9, i32 %conv) #3
  %13 = bitcast [3 x i16]* %cv to i8*
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %palette5 = getelementptr inbounds %struct.gx_device_memory_s, %struct.gx_device_memory_s* %14, i32 0, i32 53
  %data6 = getelementptr inbounds %struct.gs_const_string_s, %struct.gs_const_string_s* %palette5, i32 0, i32 0
  %15 = load i8*, i8** %data6, align 8, !tbaa !10
  %arrayidx7 = getelementptr inbounds i8, i8* %15, i64 0
  %16 = load i8, i8* %arrayidx7, align 1, !tbaa !9
  %conv8 = zext i8 %16 to i32
  %cmp9 = icmp ne i32 %conv8, 0
  %conv10 = zext i1 %cmp9 to i32
  store i32 %conv10, i32* %invert, align 4, !tbaa !5
  %17 = load i32, i32* %invert, align 4, !tbaa !5
  %tobool = icmp ne i32 %17, 0
  br i1 %tobool, label %if.then.11, label %if.end.14

if.then.11:                                       ; preds = %if.end
  %18 = load i32, i32* %rop, align 4, !tbaa !9
  %idxprom = zext i32 %18 to i64
  %arrayidx12 = getelementptr inbounds [256 x i8], [256 x i8]* @byte_reverse_bits, i32 0, i64 %idxprom
  %19 = load i8, i8* %arrayidx12, align 1, !tbaa !9
  %conv13 = zext i8 %19 to i32
  %xor = xor i32 %conv13, 255
  store i32 %xor, i32* %rop, align 4, !tbaa !9
  br label %if.end.14

if.end.14:                                        ; preds = %if.then.11, %if.end
  %20 = load %struct.gx_device_s*, %struct.gx_device_s** %dev.addr, align 8, !tbaa !1
  %21 = load i8*, i8** %sdata.addr, align 8, !tbaa !1
  %22 = load i32, i32* %sourcex.addr, align 4, !tbaa !5
  %23 = load i32, i32* %sraster.addr, align 4, !tbaa !5
  %24 = load i64, i64* %id.addr, align 8, !tbaa !7
  %25 = load i64*, i64** %scolors.addr, align 8, !tbaa !1
  %26 = load %struct.gx_strip_bitmap_s*, %struct.gx_strip_bitmap_s** %textures.addr, align 8, !tbaa !1
  ...
  %32 = load i32, i32* %phase_x.addr, align 4, !tbaa !5
  %33 = load i32, i32* %phase_y.addr, align 4, !tbaa !5
  %34 = load i32, i32* %rop, align 4, !tbaa !9
  %call15 = call i32 @mem_mono_strip_copy_rop_dev(%struct.gx_device_s* %20, i8* %21, i32 %22, i32 %23, i64 %24, i64* %25, %struct.gx_strip_bitmap_s* %26, i64* %27, i32 %28, i32 %29, i32 %30, i32 %31, i32 %32, i32 %33, i32 %34) #3
  %35 = bitcast i32* %invert to i8*
  call void @llvm.lifetime.end(i64 4, i8* %35) #1
  %36 = bitcast i32* %rop to i8*
...
declare i32 @gs_transparent_rop(i32) #2
...
declare i32 @mem_mono_strip_copy_rop_dev(%struct.gx_device_s*, i8*, i32, i32, i64, i64*, %struct.gx_strip_bitmap_s*, i64*, i32, i32, i32, i32, i32, i32, i32) #2
...
!31 = !{!14, !14, i64 0}
!32 = !{!33, !2, i64 1552}
!33 = !{!"gx_device_s", !6, i64 0, !2, i64 8, !2, i64 16, !2, i64 24, !2, i64 32, !6, i64 40, !2, i64 48, !12, i64 56, !6, i64 80, !6, i64 84, !6, i64 88, !13, i64 96, !16, i64 816, !6, i64 832, !6, i64 836, !6, i64 840, !6, i64 844, !6, i64 848, !6, i64 852, !3, i64 856, !3, i64 864, !6, i64 880, !3, i64 884, !3, i64 892, !3, i64 900, !3, i64 908, !8, i64 928, !8, i64 936, !6, i64 944, !6, i64 948, !6, i64 952, !6, i64 956, !6, i64 960, !8, i64 968, !8, i64 976, !17, i64 984, !6, i64 1052, !6, i64 1056, !18, i64 1064, !2, i64 1104, !3, i64 1112, !20, i64 1120, !21, i64 1144}
