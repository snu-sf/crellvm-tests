...
define i32 @gs_setalpha(%struct.gs_state_s* %pgs, double %alpha) #0 {
entry:
  %pgs.addr = alloca %struct.gs_state_s*, align 8
  %alpha.addr = alloca double, align 8
  store %struct.gs_state_s* %pgs, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  store double %alpha, double* %alpha.addr, align 8, !tbaa !5
  %0 = load double, double* %alpha.addr, align 8, !tbaa !5
...
cond.false:                                       ; preds = %entry
  %1 = load double, double* %alpha.addr, align 8, !tbaa !5
...
cond.false.3:                                     ; preds = %cond.false
  %2 = load double, double* %alpha.addr, align 8, !tbaa !5
  %mul = fmul double %2, 6.553500e+04
  br label %cond.end

cond.end:                                         ; preds = %cond.false.3, %cond.true.2
  %cond = phi double [ 6.553500e+04, %cond.true.2 ], [ %mul, %cond.false.3 ]
  br label %cond.end.4

cond.end.4:                                       ; preds = %cond.end, %cond.true
  %cond5 = phi double [ 0.000000e+00, %cond.true ], [ %cond, %cond.end ]
  %conv = fptoui double %cond5 to i16
  %3 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %alpha6 = getelementptr inbounds %struct.gs_state_s, %struct.gs_state_s* %3, i32 0, i32 11
  store i16 %conv, i16* %alpha6, align 2, !tbaa !7
  ...
  %5 = load %struct.gx_device_color_s*, %struct.gx_device_color_s** %dev_color, align 8, !tbaa !24
  %type = getelementptr inbounds %struct.gx_device_color_s, %struct.gx_device_color_s* %5, i32 0, i32 0
  store %struct.gx_device_color_type_s* @gx_dc_type_data_none, %struct.gx_device_color_type_s** %type, align 8, !tbaa !26
  ret i32 0
}

; Function Attrs: nounwind uwtable
define float @gs_currentalpha(%struct.gs_state_s* %pgs) #0 {
entry:
  %pgs.addr = alloca %struct.gs_state_s*, align 8
  store %struct.gs_state_s* %pgs, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %0 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs.addr, align 8, !tbaa !1
  %alpha = getelementptr inbounds %struct.gs_state_s, %struct.gs_state_s* %0, i32 0, i32 11
  %1 = load i16, i16* %alpha, align 2, !tbaa !7
...
!24 = !{!25, !2, i64 16}
!25 = !{!"", !2, i64 0, !2, i64 8, !2, i64 16}
!26 = !{!27, !2, i64 0}
!27 = !{!"gx_device_color_s", !2, i64 0, !3, i64 8, !28, i64 352, !9, i64 360, !29, i64 368, !31, i64 632}
!28 = !{!"gs_int_point_s", !9, i64 0, !9, i64 4}
!29 = !{!"gs_client_color_s", !2, i64 0, !30, i64 8}
!30 = !{!"gs_paint_color_s", !3, i64 0}
!31 = !{!"_mask", !32, i64 0, !19, i64 8, !2, i64 16}
!32 = !{!"mp_", !9, i64 0, !9, i64 4}
