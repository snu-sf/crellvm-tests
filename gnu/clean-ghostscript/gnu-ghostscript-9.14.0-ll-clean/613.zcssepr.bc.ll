...
@.str.1 = private unnamed_addr constant [18 x i8] c"0currentoverprint\00", align 1
@.str.2 = private unnamed_addr constant [23 x i8] c"0.currentoverprintmode\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"1setoverprint\00", align 1
@.str.4 = private unnamed_addr constant [19 x i8] c"1.setoverprintmode\00", align 1
@zcssepr_l2_op_defs = constant [6 x %struct.op_def] [%struct.op_def { i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i32 (%struct.gs_context_state_s*)* null }, %struct.op_def { i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.1, i32 0, i32 0), i32 (%struct.gs_context_state_s*)* @zcurrentoverprint }, %struct.op_def { i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.2, i32 0, i32 0), i32 (%struct.gs_context_state_s*)* @zcurrentoverprintmode }, %struct.op_def { i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0), i32 (%struct.gs_context_state_s*)* @zsetoverprint }, %struct.op_def { i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.4, i32 0, i32 0), i32 (%struct.gs_context_state_s*)* @zsetoverprintmode }, %struct.op_def zeroinitializer], align 16

; Function Attrs: nounwind uwtable
define internal i32 @zcurrentoverprint(%struct.gs_context_state_s* %i_ctx_p) #0 {
entry:
...
do.end:                                           ; preds = %do.cond
  ...
  %call = call i32 @gs_currentoverprint(%struct.gs_state_s* %10) #3
  ...
  store i16 %conv, i16* %boolval, align 2, !tbaa !22
  ...
  store i16 256, i16* %type_attrs, align 2, !tbaa !23
...
; Function Attrs: nounwind uwtable
define internal i32 @zcurrentoverprintmode(%struct.gs_context_state_s* %i_ctx_p) #0 {
entry:
  %retval = alloca i32, align 4
  %i_ctx_p.addr = alloca %struct.gs_context_state_s*, align 8
  %op = alloca %struct.ref_s*, align 8
...
do.end:                                           ; preds = %do.cond
  ...
  %pgs = getelementptr inbounds %struct.gs_context_state_s, %struct.gs_context_state_s* %9, i32 0, i32 0
  %10 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs, align 8, !tbaa !21
  %call = call i32 @gs_currentoverprintmode(%struct.gs_state_s* %10) #3
...
; Function Attrs: nounwind uwtable
define internal i32 @zsetoverprint(%struct.gs_context_state_s* %i_ctx_p) #0 {
entry:
  %retval = alloca i32, align 4
  %i_ctx_p.addr = alloca %struct.gs_context_state_s*, align 8
  %op = alloca %struct.ref_s*, align 8
...
if.end:                                           ; preds = %entry
  ...
  %boolval = bitcast %union.v* %value to i16*
  %10 = load i16, i16* %boolval, align 2, !tbaa !22
  %conv2 = zext i16 %10 to i32
  call void @gs_setoverprint(%struct.gs_state_s* %8, i32 %conv2) #3
...
; Function Attrs: nounwind uwtable
define internal i32 @zsetoverprintmode(%struct.gs_context_state_s* %i_ctx_p) #0 {
entry:
  %retval = alloca i32, align 4
  %i_ctx_p.addr = alloca %struct.gs_context_state_s*, align 8
  %op = alloca %struct.ref_s*, align 8
...
lor.lhs.false:                                    ; preds = %entry
  ...
  %pgs = getelementptr inbounds %struct.gs_context_state_s, %struct.gs_context_state_s* %7, i32 0, i32 0
  %8 = load %struct.gs_state_s*, %struct.gs_state_s** %pgs, align 8, !tbaa !21
  %9 = load i32, i32* %param, align 4, !tbaa !26
  %call1 = call i32 @gs_setoverprintmode(%struct.gs_state_s* %8, i32 %9) #3
...
declare i32 @gs_currentoverprint(%struct.gs_state_s*) #2

; Function Attrs: nounwind
declare void @llvm.lifetime.end(i64, i8* nocapture) #1

declare i32 @gs_currentoverprintmode(%struct.gs_state_s*) #2

declare i32 @check_type_failed(%struct.ref_s*) #2

declare void @gs_setoverprint(%struct.gs_state_s*, i32) #2

declare i32 @int_param(%struct.ref_s*, i32, i32*) #2

declare i32 @gs_setoverprintmode(%struct.gs_state_s*, i32) #2
