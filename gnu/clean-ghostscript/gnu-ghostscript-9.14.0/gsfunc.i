...
static const gc_ptr_element_t function_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_function_t *)0)->params.Domain - (char *)((gs_function_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_function_t *)0)->params.Range - (char *)((gs_function_t *)0) )) } }; static const gc_struct_data_t function_reloc_ptrs = { (sizeof(function_enum_ptrs) / sizeof((function_enum_ptrs)[0])), 0, 0, function_enum_ptrs }; const gs_memory_struct_type_t st_function = { sizeof(gs_function_t), "gs_function_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &function_reloc_ptrs };
static gs_ptr_type_t function_ptr_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { switch ( index ) { default: return 0; case 0: return (pep->ptr = (const void *)(*(gs_function_t * const *)vptr), (&ptr_struct_procs)); } } static void function_ptr_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { ; (*(gs_function_t * *)vptr = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(*(gs_function_t * *)vptr), gcst))); } static const gs_memory_struct_type_t st_function_ptr = { sizeof(gs_function_t *), "gs_function_t *", 0, 0, function_ptr_enum_ptrs, function_ptr_reloc_ptrs, 0, 0 };

static gs_ptr_type_t function_ptr_element_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { uint count = size / (uint)sizeof(gs_function_t *); if ( count == 0 ) return 0; return (*(st_function_ptr).enum_ptrs)(mem, (const char *)vptr + (index % count) * sizeof(gs_function_t *), sizeof(gs_function_t *), index / count, pep, &(st_function_ptr), gcst); } static void function_ptr_element_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { { uint count = size / (uint)sizeof(gs_function_t *); for ( ; count; count--, vptr = (char *)vptr + sizeof(gs_function_t *) ) (*(st_function_ptr).reloc_ptrs)(vptr, sizeof(gs_function_t *), &(st_function_ptr), gcst); } } static const gs_memory_struct_type_t st_function_ptr_element = { sizeof(gs_function_t *), "gs_function_t *[]", 0, 0, function_ptr_element_enum_ptrs, function_ptr_element_reloc_ptrs, 0, 0 };
                     ...
                     gs_memory_t *mem)
{
    ...
    if (count == 0)
        return ((-15));
    ptr = (gs_function_t * *)(*(mem)->procs.alloc_struct_array)(mem, count, &st_function_ptr_element, "Functions");
...
fn_common_free(gs_function_t * pfn, bool free_params, gs_memory_t * mem)
{
    ...
    ((mem)->procs.free_object(mem, pfn, "fn_common_free"));
}
...
{
    if (pvalues) {
        void *values = (*(mem)->procs.alloc_byte_array)(mem, count, size, "fn_copy_values");
               ...
               const gs_range_t *pranges, gs_memory_t *mem)
{
    if (pvalues == 0)
        *ppvalues = 0;
        ...
        float *out = (float *)
            (*(mem)->procs.alloc_byte_array)(mem, 2 * npairs, sizeof(*pvalues), "fn_scale_pairs");
...
fn_common_serialize(const gs_function_t * pfn, stream *s)
{
    ...
    if (code < 0)
        return code;
    if (p->Range == ((void*)0) && p->n * 2 > (((int)(sizeof(dummy))) / ((int)(sizeof((dummy)[0])))))
        return ((-28));
    return sputs(s, (const byte *)(p->Range != ((void*)0) ? &p->Range[0] : dummy),
