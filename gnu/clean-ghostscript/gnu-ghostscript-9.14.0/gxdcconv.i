...
# 24 "./base/gxdcconv.c" 2
# 1 "./base/gxlum.h" 1
# 25 "./base/gxdcconv.c" 2
# 1 "./base/gxistate.h" 1
# 29 "./base/gxistate.h"
# 1 "./base/gxline.h" 1
# 22 "./base/gxline.h"
                  ...
                  frac cmyk[4], gs_memory_t *mem)
{
    ...
    frac bg =
        (pis == ((void*)0) ? k : pis->black_generation == ((void*)0) ? ((frac)0) :
         (pis->black_generation->proc == gs_identity_transfer ? k : gx_color_frac_map(k, &pis->black_generation->values[0])));
    signed_frac ucr =
        (pis == ((void*)0) ? k : pis->undercolor_removal == ((void*)0) ? ((frac)0) :
         (pis->undercolor_removal->proc == gs_identity_transfer ? k : gx_color_frac_map(k, &pis->undercolor_removal->values[0])));
    ...
    if (ucr == ((frac)0x7ff8))
        ...
        if (!gs_currentcpsimode(mem)) {
            ...
            signed_frac not_ucr = (ucr < 0 ? ((frac)0x7ff8) + ucr : ((frac)0x7ff8));

            cmyk[0] = (c < ucr ? ((frac)0) : c > not_ucr ? ((frac)0x7ff8) : c - ucr);
            cmyk[1] = (m < ucr ? ((frac)0) : m > not_ucr ? ((frac)0x7ff8) : m - ucr);
            cmyk[2] = (y < ucr ? ((frac)0) : y > not_ucr ? ((frac)0x7ff8) : y - ucr);
        } else {
            ...
            cmyk[0] =
                (((v) < 0.0) ? ((frac)0) : v >= (float)((frac)0x7ff8) ? ((frac)0x7ff8) : (frac) v);
...
color_cmyk_to_gray(frac c, frac m, frac y, frac k, const gs_imager_state * pis)
{
    ...
    return (not_gray > ((frac)0x7ff8) - k ?
            ((frac)0) : ((frac)0x7ff8) - (not_gray + k));
}
    ...
    switch (k) {
        ...
        default:
            if (!gs_currentcpsimode(mem)) {
                ...
                frac not_k = ((frac)0x7ff8) - k;

                rgb[0] = (c > not_k ? ((frac)0) : not_k - c);
                rgb[1] = (m > not_k ? ((frac)0) : not_k - m);
                rgb[2] = (y > not_k ? ((frac)0) : not_k - y);
            } else {
