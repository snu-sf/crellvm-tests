...
compute_ldx(trap_line *tl, fixed ys)
{
    ...
    if ( df < ((~(-1 << ((1 << 2) * 8 - 1))) / (1L << 8)) ) {
         if ( df == 0 )
             tl->ldi = ((fixed)(di)<<8), tl->ldf = 0, tl->xf = -h;
         else {
             tl->ldi = ((fixed)(di)<<8) + ((fixed)(df)<<8) / h;
             tl->ldf = ((fixed)(df)<<8) % h;
             tl->xf =
                 (ys < (1L << 8) ? ys * df % h : fixed_mult_rem(ys, df, h)) - h;
         }
    }
    else {
        tl->ldi = ((fixed)(di)<<8) + fixed_mult_quo((1L << 8), df, h);
        tl->ldf = fixed_mult_rem((1L << 8), df, h);
                ...
                const trap_line *l, fixed ybot, int num_components)
{
    ...
    if (e->c1 == ((void*)0) || e->c0 == ((void*)0))
        g->den = 0;
    else {
        bool ends_from_fa = (e1->c1 == ((void*)0) || e1->c0 == ((void*)0));
...
step_gradient(trap_gradient *g, int num_components)
{
    ...
    if (g->den == 0)
        return;
    for (i = 0; i < num_components; i++) {
        int64_t fc = g->f[i] + (int64_t)g->num[i] * (1L << 8);
        int32_t fc32;
...
check_gradient_overflow(const gs_linear_color_edge *le, const gs_linear_color_edge *re,
                int num_components)
{
    if (le->c1 == ((void*)0) || re->c1 == ((void*)0)) {

        return ((bool)0);
    } else {
# 242 "./base/gdevddrw.c"
        int32_t xl = (((le->start.x) < (le->end.x)) ? (le->start.x) : (le->end.x));
        int32_t xr = (((re->start.x) < (re->end.x)) ? (re->start.x) : (re->end.x));

        return ((xr) >> 1) - ((xl) >> 1) >= 0x3FFFFFFE;
    }
}
             ...
             const trap_line *l, const trap_line *r, int il, int ir, int num_components)
{
    ...
    int32_t xl = l->x - (l->xf == -l->h ? 1 : 0) - ((1L << 8) >> 1);
    int32_t xr = r->x - (r->xf == -r->h ? 1 : 0) - ((1L << 8) >> 1);

    int32_t x0 = ((fixed)(il)<<8) + ((1L << 8) >> 1);
    int32_t x1 = ((fixed)(ir)<<8) - ((1L << 8) >> 1);
    int i;
# 272 "./base/gdevddrw.c"
    xg->den = ((int)((x1 - x0) >> (8)));
    if (xg->den <= 0) {
...
# 1 "./base/gxdtfill.h" 1
# 132 "./base/gxdtfill.h"
static int gx_fill_trapezoid_as_fd (gx_device * dev, const gs_fixed_edge * left,
    const gs_fixed_edge * right, fixed ybot, fixed ytop, int flags,
    const gx_device_color * pdevc, gs_logical_operation_t fa)
{
    const fixed ymin = (((ybot)+(((1<<8)>>1) - 1L))&(-1L<<8)) + ((1L << 8) >> 1);
    const fixed ymax = (((ytop)+(((1<<8)>>1) - 1L))&(-1L<<8));

    if (ymin >= ymax)
        return 0;
    {
        int iy = ((int)((ymin) >> (8)));
        const int iy1 = ((int)((ymax) >> (8)));
        trap_line l, r;
...
# 173 "./base/gxdtfill.h"
        ...
        ry = iy;
# 260 "./base/gxdtfill.h"
        if (((l.x)&(-1L<<8)) == (((x1l)+(((1<<8)>>1) - 1L))&(-1L<<8))) {

            l.di = 0, l.df = 0;
            fxl = 0;
        } else {
            compute_dx(&l, dxl, ysl);
            fxl = (ysl < (1L << 8) && l.df < ((~(-1 << ((1 << 2) * 8 - 1))) / (1L << 8)) ? ysl * l.df / l.h : fixed_mult_quo(ysl, l.df, l.h));
            l.x += fxl;
        }
        if (((r.x)&(-1L<<8)) == (((x1r)+(((1<<8)>>1) - 1L))&(-1L<<8))) {
                ...
                if (l.di == 0 && l.df == 0) {
                    ...
                    do { } while (0);
                    do { } while (0);;
                    code = (1 ? (1 ? (*fill_rect)(dev, ry, rxl, iy1 - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy1 - ry, cindex)) : (1 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy1 - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy1 - ry, dev, fa, ((void*)0))));
                    goto xit;
                }
            ...
            if (ysr == ysl && r.h == l.h)
                ...
                r.x += (ysr < (1L << 8) && r.df < ((~(-1 << ((1 << 2) * 8 - 1))) / (1L << 8)) ? ysr * r.df / r.h : fixed_mult_quo(ysr, r.df, r.h));
        } else {
            compute_dx(&r, dxr, ysr);
            r.x += (ysr < (1L << 8) && r.df < ((~(-1 << ((1 << 2) * 8 - 1))) / (1L << 8)) ? ysr * r.df / r.h : fixed_mult_quo(ysr, r.df, r.h));
        }
        ...
        r.x += 1L;
# 341 "./base/gxdtfill.h"
        rxl = ((int)((!((l.x)&((1<<8)-1)) && l.xf == -l.h ? l.x - (1L << 8) : l.x) >> (8)));
        rxr = ((int)((!((r.x)&((1<<8)-1)) && r.xf == -r.h ? r.x - (1L << 8) : r.x) >> (8)));
        do { } while (0);
        while (0 ? 1 : ++iy != iy1) {
# 362 "./base/gxdtfill.h"
                register int ixl, ixr;

                l.x += l.ldi; if ( (l.xf += l.ldf) >= 0 ) l.xf -= l.h, l.x++; ixl = ((int)((!((l.x)&((1<<8)-1)) && l.xf == -l.h ? l.x - (1L << 8) : l.x) >> (8)));
                r.x += r.ldi; if ( (r.xf += r.ldf) >= 0 ) r.xf -= r.h, r.x++; ixr = ((int)((!((r.x)&((1<<8)-1)) && r.xf == -r.h ? r.x - (1L << 8) : r.x) >> (8)));
                do { } while (0);
                if (ixl != rxl || ixr != rxr) {
                    do { } while (0);
                    do { } while (0);
                    do { } while (0);;
                    code = (1 ? (1 ? (*fill_rect)(dev, ry, rxl, iy - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry, cindex)) : (1 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry, dev, fa, ((void*)0))));
                    if (code < 0)
                        goto xit;
...
# 334 "./base/gdevddrw.c" 2
# 343 "./base/gdevddrw.c"
# 1 "./base/gxdtfill.h" 1
# 132 "./base/gxdtfill.h"
static int gx_fill_trapezoid_as_nd (gx_device * dev, const gs_fixed_edge * left,
    const gs_fixed_edge * right, fixed ybot, fixed ytop, int flags,
    const gx_device_color * pdevc, gs_logical_operation_t fa)
{
    const fixed ymin = (((ybot)+(((1<<8)>>1) - 1L))&(-1L<<8)) + ((1L << 8) >> 1);
...
# 260 "./base/gxdtfill.h"
        ...
        if (((r.x)&(-1L<<8)) == (((x1r)+(((1<<8)>>1) - 1L))&(-1L<<8))) {
                ...
                if (l.di == 0 && l.df == 0) {
                    ...
                    do { } while (0);
                    do { } while (0);;
                    code = (0 ? (1 ? (*fill_rect)(dev, ry, rxl, iy1 - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy1 - ry, cindex)) : (1 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy1 - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy1 - ry, dev, fa, ((void*)0))));
                    goto xit;
                }
...
# 362 "./base/gxdtfill.h"
                ...
                if (ixl != rxl || ixr != rxr) {
                    ...
                    do { } while (0);
                    do { } while (0);;
                    code = (0 ? (1 ? (*fill_rect)(dev, ry, rxl, iy - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry, cindex)) : (1 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry, dev, fa, ((void*)0))));
                    if (code < 0)
                        goto xit;
                    rxl = ixl, rxr = ixr, ry = iy;
                }
...
# 344 "./base/gdevddrw.c" 2
# 353 "./base/gdevddrw.c"
# 1 "./base/gxdtfill.h" 1
# 132 "./base/gxdtfill.h"
static int gx_fill_trapezoid_ns_fd (gx_device * dev, const gs_fixed_edge * left,
    const gs_fixed_edge * right, fixed ybot, fixed ytop, int flags,
    const gx_device_color * pdevc, gs_logical_operation_t fa)
{
    const fixed ymin = (((ybot)+(((1<<8)>>1) - 1L))&(-1L<<8)) + ((1L << 8) >> 1);
...
# 260 "./base/gxdtfill.h"
        ...
        if (((r.x)&(-1L<<8)) == (((x1r)+(((1<<8)>>1) - 1L))&(-1L<<8))) {
                ...
                if (l.di == 0 && l.df == 0) {
                    ...
                    do { } while (0);
                    do { } while (0);;
                    code = (1 ? (0 ? (*fill_rect)(dev, ry, rxl, iy1 - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy1 - ry, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy1 - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy1 - ry, dev, fa, ((void*)0))));
                    goto xit;
                }
...
# 362 "./base/gxdtfill.h"
                ...
                if (ixl != rxl || ixr != rxr) {
                    ...
                    do { } while (0);
                    do { } while (0);;
                    code = (1 ? (0 ? (*fill_rect)(dev, ry, rxl, iy - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry, dev, fa, ((void*)0))));
                    if (code < 0)
                        goto xit;
                    rxl = ixl, rxr = ixr, ry = iy;
                }
...
# 354 "./base/gdevddrw.c" 2
# 363 "./base/gdevddrw.c"
# 1 "./base/gxdtfill.h" 1
# 132 "./base/gxdtfill.h"
static int gx_fill_trapezoid_ns_nd (gx_device * dev, const gs_fixed_edge * left,
    const gs_fixed_edge * right, fixed ybot, fixed ytop, int flags,
    const gx_device_color * pdevc, gs_logical_operation_t fa)
{
    const fixed ymin = (((ybot)+(((1<<8)>>1) - 1L))&(-1L<<8)) + ((1L << 8) >> 1);
...
# 260 "./base/gxdtfill.h"
        ...
        if (((r.x)&(-1L<<8)) == (((x1r)+(((1<<8)>>1) - 1L))&(-1L<<8))) {
                ...
                if (l.di == 0 && l.df == 0) {
                    ...
                    do { } while (0);
                    do { } while (0);;
                    code = (0 ? (0 ? (*fill_rect)(dev, ry, rxl, iy1 - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy1 - ry, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy1 - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy1 - ry, dev, fa, ((void*)0))));
                    goto xit;
                }
...
# 362 "./base/gxdtfill.h"
                ...
                if (ixl != rxl || ixr != rxr) {
                    ...
                    do { } while (0);
                    do { } while (0);;
                    code = (0 ? (0 ? (*fill_rect)(dev, ry, rxl, iy - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry, dev, fa, ((void*)0))));
                    if (code < 0)
                        goto xit;
                    rxl = ixl, rxr = ixr, ry = iy;
                }
    ...
    const gx_device_color * pdevc, gs_logical_operation_t fa)
{
        ...
        return 0;
    {
        ...
        int code;
            ...
            int peak_y0 = ybot + ((1L << 8) >> 1);
            int peak_y1 = ytop - ((1L << 8) >> 1);
# 173 "./base/gxdtfill.h"
            gx_color_index cindex = pdevc->colors.pure;
            int (*fill_rect)(gx_device *dev, int x, int y, int width, int height, gx_color_index color) =
                ((dev)->procs.fill_rectangle);
...
# 260 "./base/gxdtfill.h"
        ...
        if (((r.x)&(-1L<<8)) == (((x1r)+(((1<<8)>>1) - 1L))&(-1L<<8))) {
                ...
                if (l.di == 0 && l.df == 0) {
                    rxl = ((int)((l.x) >> (8)));
                    rxr = ((int)((r.x) >> (8)));
                    if (rxl == rxr) if ((!peak0 || iy >= peak_y0) && (!peak1 || iy <= peak_y1)) { fixed x = ((fixed)(rxl)<<8) + ((1L << 8) >> 1); if (x - l.x < r.x - x) ++rxr; else --rxl; };
                    do { } while (0);;
                    code = (1 ? (0 ? (*fill_rect)(dev, ry, rxl, iy1 - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy1 - ry, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy1 - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy1 - ry, dev, fa, ((void*)0))));
                    goto xit;
                }
...
# 362 "./base/gxdtfill.h"
                ...
                l.x += l.ldi; if ( (l.xf += l.ldf) >= 0 ) l.xf -= l.h, l.x++; ixl = ((int)((!((l.x)&((1<<8)-1)) && l.xf == -l.h ? l.x - (1L << 8) : l.x) >> (8)));
                r.x += r.ldi; if ( (r.xf += r.ldf) >= 0 ) r.xf -= r.h, r.x++; ixr = ((int)((!((r.x)&((1<<8)-1)) && r.xf == -r.h ? r.x - (1L << 8) : r.x) >> (8)));
                if (ixl == ixr) if ((!peak0 || iy >= peak_y0) && (!peak1 || iy <= peak_y1)) { fixed x = ((fixed)(ixl)<<8) + ((1L << 8) >> 1); if (x - l.x < r.x - x) ++ixr; else --ixl; };
                if (ixl != rxl || ixr != rxr) {
                    if (rxr < ixl) { if (iy - ry > 1) { do { } while (0);; code = (1 ? (0 ? (*fill_rect)(dev, ry, rxl, iy - ry - 1, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry - 1, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry - 1, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry - 1, dev, fa, ((void*)0)))); if (code < 0) goto xit; ry = iy - 1; } rxr = ixl = (ixl + ixl) / 2; };
                    if (ixr < rxl) { if (iy - ry > 1) { do { } while (0);; code = (1 ? (0 ? (*fill_rect)(dev, ry, rxl, iy - ry - 1, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry - 1, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry - 1, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry - 1, dev, fa, ((void*)0)))); if (code < 0) goto xit; ry = iy - 1; } ixr = rxl = (rxl + rxl) / 2; };
                    do { } while (0);;
                    code = (1 ? (0 ? (*fill_rect)(dev, ry, rxl, iy - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry, dev, fa, ((void*)0))));
                    if (code < 0)
                        goto xit;
...
# 362 "./base/gxdtfill.h"
                ...
                if (ixl == ixr) if ((!peak0 || iy >= peak_y0) && (!peak1 || iy <= peak_y1)) { fixed x = ((fixed)(ixl)<<8) + ((1L << 8) >> 1); if (x - l.x < r.x - x) ++ixr; else --ixl; };
                if (ixl != rxl || ixr != rxr) {
                    if (rxr < ixl) { if (iy - ry > 1) { do { } while (0);; code = (0 ? (0 ? (*fill_rect)(dev, ry, rxl, iy - ry - 1, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry - 1, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry - 1, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry - 1, dev, fa, ((void*)0)))); if (code < 0) goto xit; ry = iy - 1; } rxr = ixl = (ixl + ixl) / 2; };
                    if (ixr < rxl) { if (iy - ry > 1) { do { } while (0);; code = (0 ? (0 ? (*fill_rect)(dev, ry, rxl, iy - ry - 1, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry - 1, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry - 1, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry - 1, dev, fa, ((void*)0)))); if (code < 0) goto xit; ry = iy - 1; } ixr = rxl = (rxl + rxl) / 2; };
                    do { } while (0);;
                    code = (0 ? (0 ? (*fill_rect)(dev, ry, rxl, iy - ry, rxr - rxl, cindex) : (*fill_rect)(dev, rxl, ry, rxr - rxl, iy - ry, cindex)) : (0 ? (*(pdevc)->type->fill_rectangle)(pdevc, ry, rxl, iy - ry, rxr - rxl, dev, fa, ((void*)0)) : (*(pdevc)->type->fill_rectangle)(pdevc, rxl, ry, rxr - rxl, iy - ry, dev, fa, ((void*)0))));
                    if (code < 0)
                        goto xit;
...
# 384 "./base/gdevddrw.c" 2
# 401 "./base/gdevddrw.c"
# 1 "./base/gxdtfill.h" 1
# 132 "./base/gxdtfill.h"
static int gx_fill_trapezoid_ns_lc (gx_device * dev, const gs_linear_color_edge * left,
    const gs_linear_color_edge * right, fixed ybot, fixed ytop, int flags,
    const gx_device_color * pdevc, const gs_fill_attributes * fa)
{
    const fixed ymin = (((ybot)+(((1<<8)>>1) - 1L))&(-1L<<8)) + ((1L << 8) >> 1);
    const fixed ymax = (((ytop)+(((1<<8)>>1) - 1L))&(-1L<<8));
...
# 341 "./base/gxdtfill.h"
        ...
        while (1 ? 1 : ++iy != iy1) {
                ...
                if (rxl != rxr) {
                    ...
                    code = (!(rxr - rxl) ? 0 : ((dev)->procs.fill_linear_color_scanline)(dev, fa, rxl, iy, rxr - rxl, xg.c, xg.f, xg.num, xg.den));
                    if (code < 0)
                        goto xit;
                }
                if (++iy == iy1)
                    break;
                l.x += l.ldi; if ( (l.xf += l.ldf) >= 0 ) l.xf -= l.h, l.x++; rxl = ((int)((!((l.x)&((1<<8)-1)) && l.xf == -l.h ? l.x - (1L << 8) : l.x) >> (8)));
                r.x += r.ldi; if ( (r.xf += r.ldf) >= 0 ) r.xf -= r.h, r.x++; rxr = ((int)((!((r.x)&((1<<8)-1)) && r.xf == -r.h ? r.x - (1L << 8) : r.x) >> (8)));
...
# 402 "./base/gdevddrw.c" 2
# 411 "./base/gdevddrw.c"
# 1 "./base/gxdtfill.h" 1
# 132 "./base/gxdtfill.h"
static int gx_fill_trapezoid_as_lc (gx_device * dev, const gs_linear_color_edge * left,
    const gs_linear_color_edge * right, fixed ybot, fixed ytop, int flags,
    const gx_device_color * pdevc, const gs_fill_attributes * fa)
{
    const fixed ymin = (((ybot)+(((1<<8)>>1) - 1L))&(-1L<<8)) + ((1L << 8) >> 1);
...
gx_default_fill_trapezoid(gx_device * dev, const gs_fixed_edge * left,
    ...
    const gx_device_color * pdevc, gs_logical_operation_t lop)
{
    bool fill_direct = (((pdevc)->type == (&gx_dc_type_data_pure)) && (((lop) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc)));
...
{
    fixed y02 = (((le->start.y) > (re->start.y)) ? (le->start.y) : (re->start.y)), ymin = (((y02) > (fa->clip->p.y)) ? (y02) : (fa->clip->p.y));
    fixed y13 = (((le->end.y) < (re->end.y)) ? (le->end.y) : (re->end.y)), ymax = (((y13) < (fa->clip->q.y)) ? (y13) : (fa->clip->q.y));
    int code;

    code = (fa->swap_axes ? gx_fill_trapezoid_as_lc : gx_fill_trapezoid_ns_lc)(dev,
            le, re, ymin, ymax, 0, ((void*)0), fa);
    if (code < 0)
        return code;
    return !code;
}
                  ...
                  const gx_device_color * pdevc, gs_logical_operation_t lop)
{
    ...
    if (( ((ax) | (by)) == 0 || ((bx) | (ay)) == 0 )) {
        ...
        return (*(pdevc)->type->fill_rectangle)(pdevc, r.p.x, r.p.y, r.q.x - r.p.x, r.q.y - r.p.y, dev, lop, ((void*)0));
...
# 635 "./base/gdevddrw.c"
    ...
    fill_trapezoid = ((dev)->procs.fill_trapezoid);
    qy = py + ay + by;
    ...
    if (ay < by) {
        if (!((((py)+(((1<<8)>>1) - 1L))&(-1L<<8)) == (((left.end.y)+(((1<<8)>>1) - 1L))&(-1L<<8)))) {
        ...
        ym = right.end.y;
        if (!((((left.start.y)+(((1<<8)>>1) - 1L))&(-1L<<8)) == (((ym)+(((1<<8)>>1) - 1L))&(-1L<<8)))) {
        ...
        if (!((((py)+(((1<<8)>>1) - 1L))&(-1L<<8)) == (((right.end.y)+(((1<<8)>>1) - 1L))&(-1L<<8)))) {
        ...
        right.end.x = qx, right.end.y = qy;
        ym = left.end.y;
        if (!((((right.start.y)+(((1<<8)>>1) - 1L))&(-1L<<8)) == (((ym)+(((1<<8)>>1) - 1L))&(-1L<<8)))) {
    ...
    if (!((((ym)+(((1<<8)>>1) - 1L))&(-1L<<8)) == (((qy)+(((1<<8)>>1) - 1L))&(-1L<<8))))
                          ...
                          fixed adjustx, fixed adjusty)
{
    ...
    do { } while (0);
# 794 "./base/gdevddrw.c"
    epsilon = ((adjustx | adjusty) == 0 ? 1L : 0);

    {
        ...
        if ((w < 0 ? -w : w) <= (h < 0 ? -h : h)) {
            ...
            if (h < 0)
                (tf = fx0, fx0 = fx1, fx1 = tf), (tf = fy0, fy0 = fy1, fy1 = tf),
                    h = -h;
# 819 "./base/gdevddrw.c"
            if (w == 0 && adjusty) {
                int deltay;
                deltay = ((fixed)(((int)((fy1) >> (8))))<<8) + ((1L << 8) >> 1) -fy1;

                if ((deltay > 0) && (deltay <= ((1L << 8) >> 1)))
                {
                    int c = (*(pdevc)->type->fill_rectangle)(pdevc, ((int)((fx1) >> (8))), ((int)((fy1) >> (8))), 1, 1, dev, lop, ((void*)0));


                    if (c < 0) return c;
                }
                deltay = ((fixed)(((int)((fy0) >> (8))))<<8) + ((1L << 8) >> 1) -fy0;

                if ((deltay < 0) && (deltay >= -((1L << 8) >> 1)))
                {
                    int c = (*(pdevc)->type->fill_rectangle)(pdevc, ((int)((fx0) >> (8))), ((int)((fy0) >> (8))), 1, 1, dev, lop, ((void*)0));
                ...
                int deltax, deltay;
                deltay = ((fixed)(((int)((fy1) >> (8))))<<8) + ((1L << 8) >> 1) -fy1;
                deltax = ((fixed)(((int)((fx1) >> (8))))<<8) + ((1L << 8) >> 1) -fx1;

                if (deltax < 0) deltax=-deltax;
                if ((deltay > 0) && (deltay <= ((1L << 8) >> 1)) &&
                    (deltay+deltax <= ((1L << 8) >> 1)))
                {
                    int c = (*(pdevc)->type->fill_rectangle)(pdevc, ((int)((fx1) >> (8))), ((int)((fy1) >> (8))), 1, 1, dev, lop, ((void*)0));
                ...
                deltay = ((fixed)(((int)((fy0) >> (8))))<<8) + ((1L << 8) >> 1) -fy0;
                deltax = ((fixed)(((int)((fx0) >> (8))))<<8) + ((1L << 8) >> 1) -fx0;
            ...
            ix = ((int)((fx0-epsilon) >> (8)));
            itox = ((int)((fx1-epsilon) >> (8)));
            if (itox == ix) {


                iy = ((int)((fy0+((1L << 8) >> 1)-1L) >> (8)));
                itoy = ((int)((fy1+((1L << 8) >> 1)-1L) >> (8)));
                itoy = itoy - iy;
                if (itoy <= 0) {
                ...
                return (*(pdevc)->type->fill_rectangle)(pdevc, ix, iy, 1, itoy, dev, lop, ((void*)0));

            }
            left.start.x = fx0 - ((1L << 8) >> 1) + 1L - epsilon;
            right.start.x = left.start.x + (1L << 8);
            left.end.x = fx1 - ((1L << 8) >> 1) + 1L - epsilon;
            right.end.x = left.end.x + (1L << 8);
            ...
            iy = ((int)((fy0 - epsilon) >> (8)));
            itoy = ((int)((fy1 - epsilon) >> (8)));
            if (itoy == iy) {


                ix = ((int)((fx0+((1L << 8) >> 1)-1L) >> (8)));
                itox = ((int)((fx1+((1L << 8) >> 1)-1L) >> (8)));
                itox = itox - ix;
                if (itox <= 0) {
                ...
                return (*(pdevc)->type->fill_rectangle)(pdevc, ix, iy, itox, 1, dev, lop, ((void*)0));

            }
            left.start.x = fy0 - ((1L << 8) >> 1) + 1L - epsilon;
            right.start.x = left.start.x + (1L << 8);
            left.end.x = fy1 - ((1L << 8) >> 1) + 1L - epsilon;
            right.end.x = left.end.x + (1L << 8);
            left.start.y = right.start.y = fx0;
            left.end.y = right.end.y = fx1;
            swap_axes = ((bool)1);
        }
        return (*((dev)->procs.fill_trapezoid)) (dev, &left, &right,
...
static gs_ptr_type_t image_enum_common_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void image_enum_common_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_gx_image_enum_common = { sizeof(gx_image_enum_common_t), "gx_image_enum_common_t", 0, 0, image_enum_common_enum_ptrs, image_enum_common_reloc_ptrs, 0, 0 };

static
gs_ptr_type_t image_enum_common_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gx_image_enum_common_t *eptr = vptr; switch ( index ) { default:
    return 0;
case 0: return (pep->ptr = (const void *)(gx_device_enum_ptr(eptr->dev)), (&ptr_struct_procs));
} }

static void image_enum_common_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gx_image_enum_common_t *eptr = vptr;
{
                       ...
                       gs_memory_t * memory, gx_image_enum_common_t ** pinfo)
{
    ...
    int (*save_begin_image)(gx_device *dev, const gs_imager_state *pis, const gs_image_t *pim, gs_image_format_t format, const gs_int_rect *prect, const gx_drawing_color *pdcolor, const gx_clip_path *pcpath, gs_memory_t *memory, gx_image_enum_common_t **pinfo) = ((dev)->procs.begin_image);
    gs_image_t image;
    const gs_image_t *ptim;
    int code;


    ((dev)->procs.set_graphics_type_tag)(dev, GS_IMAGE_TAG);

    ((dev)->procs.begin_image = (gx_no_begin_image));
    ...
    code = (*((dev)->procs.begin_typed_image))
        (dev, pis, ((void*)0), (const gs_image_common_t *)ptim, prect, pdcolor,
         pcpath, memory, pinfo);
    ((dev)->procs.begin_image = (save_begin_image));
    return code;
}
                      ...
                      gs_memory_t * memory, gx_image_enum_common_t ** pinfo)
{
    ...
    if (pic->type->begin_typed_image == gx_begin_image1) {
        ...
        if (pmat == 0 ||
            (pis != 0 && !gs_matrix_compare(pmat, &(*(const gs_matrix *)&(pis)->ctm)))
            ) {
            int code = (*((dev)->procs.begin_image))
...
gx_default_fillpage(gx_device *dev, gs_imager_state * pis, gx_device_color *pdevc)
{
    ...
    if (hl_color_available) {
        ...
        rect.p.x = rect.p.y = 0;
        rect.q.x = ((fixed)(dev->width)<<8);
        rect.q.y = ((fixed)(dev->height)<<8);
        code = ((dev)->procs.fill_rectangle_hl_color)(dev,
                &rect, (const gs_imager_state *)pis, pdevc, ((void*)0));
    }
    if (!hl_color_available || code == (-15))
        code = (*(pdevc)->type->fill_rectangle)(pdevc, 0, 0, dev->width, dev->height, dev, (rop3_default | (((bool)0) ? 0x100 : 0) | (((bool)0) ? 0x200 : 0)), ((void*)0));
    return code;
}
