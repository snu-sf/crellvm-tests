...
{
# 380 "./base/gsmatrix.c"
    { double min01, max01, min23, max23; if ( pts[0].x < pts[1].x ) min01 = pts[0].x, max01 = pts[1].x; else min01 = pts[1].x, max01 = pts[0].x; if ( pts[2].x < pts[3].x ) min23 = pts[2].x, max23 = pts[3].x; else min23 = pts[3].x, max23 = pts[2].x; pbox->p.x = (((min01) < (min23)) ? (min01) : (min23)); pbox->q.x = (((max01) > (max23)) ? (max01) : (max23)); };
...
gs_matrix_fixed_from_matrix(gs_matrix_fixed *pfmat, const gs_matrix *pmat)
{
    *(gs_matrix *)pfmat = *pmat;
    if (((pmat->tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (pmat->tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((pmat->ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (pmat->ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)))) {
        pfmat->tx = ((pfmat->tx_fixed = ((fixed)((pmat->tx)*(float)(1<<8))))*(1.0/(1<<8)));
        pfmat->ty = ((pfmat->ty_fixed = ((fixed)((pmat->ty)*(float)(1<<8))))*(1.0/(1<<8)));
        pfmat->txy_fixed_valid = ((bool)1);
    } else {
        pfmat->txy_fixed_valid = ((bool)0);
    }
    return 0;
}
                         ...
                         double x, double y, gs_fixed_point * ppt)
{
    ...
    if (!pmat->txy_fixed_valid) {
        ...
        if (!(((fpt.x) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (fpt.x) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((fpt.y) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (fpt.y) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)))))
            return ((-13));
        ppt->x = ((fixed)((fpt.x)*(float)(1<<8)));
        ppt->y = ((fixed)((fpt.y)*(float)(1<<8)));
        return 0;
    }
    if (!((pmat->xy) == 0.0)) {
        if ((code = (xtemp = (y) * (pmat->yx), (((xtemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (xtemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0 ||
            (code = (ytemp = (x) * (pmat->xy), (((ytemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (ytemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0
            )
            return code;
        px = ((fixed)((xtemp)*(float)(1<<8)));
        py = ((fixed)((ytemp)*(float)(1<<8)));
        if (!((pmat->xx) == 0.0)) {
            if ((code = (xtemp = (x) * (pmat->xx), (((xtemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (xtemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0)
                return code;
            t = ((fixed)((xtemp)*(float)(1<<8)));
            if ((code = ((((px) ^ (t)) >= 0) && ((((px)+(t)) ^ (px)) < 0) ? (((px)=(((px)<0) ? (-1 << ((1 << 2) * 8 - 1)) : (~(-1 << ((1 << 2) * 8 - 1))))), (-13)) : (((px) = ((px)+(t))), 0))) < 0)
                return code;
        }
        if (!((pmat->yy) == 0.0)) {
            if ((code = (ytemp = (y) * (pmat->yy), (((ytemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (ytemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0)
                return code;
            t = ((fixed)((ytemp)*(float)(1<<8)));
            if ((code = ((((py) ^ (t)) >= 0) && ((((py)+(t)) ^ (py)) < 0) ? (((py)=(((py)<0) ? (-1 << ((1 << 2) * 8 - 1)) : (~(-1 << ((1 << 2) * 8 - 1))))), (-13)) : (((py) = ((py)+(t))), 0))) < 0)
                return code;
        }
    } else {
        if ((code = (xtemp = (x) * (pmat->xx), (((xtemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (xtemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0 ||
            (code = (ytemp = (y) * (pmat->yy), (((ytemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (ytemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0
            )
            return code;
        px = ((fixed)((xtemp)*(float)(1<<8)));
        py = ((fixed)((ytemp)*(float)(1<<8)));
        if (!((pmat->yx) == 0.0)) {
            if ((code = (ytemp = (y) * (pmat->yx), (((ytemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (ytemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0)
                return code;
            t = ((fixed)((ytemp)*(float)(1<<8)));
            if ((code = ((((px) ^ (t)) >= 0) && ((((px)+(t)) ^ (px)) < 0) ? (((px)=(((px)<0) ? (-1 << ((1 << 2) * 8 - 1)) : (~(-1 << ((1 << 2) * 8 - 1))))), (-13)) : (((px) = ((px)+(t))), 0))) < 0)
                return code;
    ...
    if (((code = ((((px) ^ (pmat->tx_fixed)) >= 0) && ((((px)+(pmat->tx_fixed)) ^ (px)) < 0) ? (((ppt->x)=(((px)<0) ? (-1 << ((1 << 2) * 8 - 1)) : (~(-1 << ((1 << 2) * 8 - 1))))), (-13)) : (((ppt->x) = ((px)+(pmat->tx_fixed))), 0))) < 0) ||
        ((code = ((((py) ^ (pmat->ty_fixed)) >= 0) && ((((py)+(pmat->ty_fixed)) ^ (py)) < 0) ? (((ppt->y)=(((py)<0) ? (-1 << ((1 << 2) * 8 - 1)) : (~(-1 << ((1 << 2) * 8 - 1))))), (-13)) : (((ppt->y) = ((py)+(pmat->ty_fixed))), 0))) < 0) )
        return code;
    return 0;
}
                         ...
                         double x, double y, gs_fixed_point * ppt)
{
    ...
    if (!(((fpt.x) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (fpt.x) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((fpt.y) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (fpt.y) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)))))
        return ((-13));
    ppt->x = ((fixed)floor((fpt.x)*(float)(1<<8) + 0.5));
    ppt->y = ((fixed)floor((fpt.y)*(float)(1<<8) + 0.5));
    return 0;
}
                            ...
                            double dx, double dy, gs_fixed_point * ppt)
{
    ...
    if ((code = (xtemp = (dx) * (pmat->xx), (((xtemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (xtemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0 ||
        (code = (ytemp = (dy) * (pmat->yy), (((ytemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (ytemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0
        )
        return code;
    px = ((fixed)((xtemp)*(float)(1<<8)));
    py = ((fixed)((ytemp)*(float)(1<<8)));
    if (!((pmat->yx) == 0.0)) {
        if ((code = (ytemp = (dy) * (pmat->yx), (((ytemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (ytemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0)
            return code;
        t = ((fixed)((ytemp)*(float)(1<<8)));
        if ((code = ((((px) ^ (t)) >= 0) && ((((px)+(t)) ^ (px)) < 0) ? (((px)=(((px)<0) ? (-1 << ((1 << 2) * 8 - 1)) : (~(-1 << ((1 << 2) * 8 - 1))))), (-13)) : (((px) = ((px)+(t))), 0))) < 0)
            return code;
    ...
    if (!((pmat->xy) == 0.0)) {
        if ((code = (xtemp = (dx) * (pmat->xy), (((xtemp) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (xtemp) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? 0 : ((-13))))) < 0)
            return code;
        t = ((fixed)((xtemp)*(float)(1<<8)));
        if ((code = ((((py) ^ (t)) >= 0) && ((((py)+(t)) ^ (py)) < 0) ? (((py)=(((py)<0) ? (-1 << ((1 << 2) * 8 - 1)) : (~(-1 << ((1 << 2) * 8 - 1))))), (-13)) : (((py) = ((py)+(t))), 0))) < 0)
            return code;
...
{
    int b = ((int)((s)->cursor.r.limit - (s)->cursor.r.ptr > 1 ? (++((s)->cursor.r.ptr), (int)*(s)->cursor.r.ptr) : spgetcc(s, ((bool)1))));
    float coeff[6];
    int i;
    int status;
    uint nread;
