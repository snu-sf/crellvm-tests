...
# 51 "./base/gxpath.c"
static const gc_ptr_element_t path_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gx_path *)0)->segments - (char *)((gx_path *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_path *)0)->box_last - (char *)((gx_path *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_path *)0)->last_charpath_segment - (char *)((gx_path *)0) )) } }; static const gc_struct_data_t path_reloc_ptrs = { (sizeof(path_enum_ptrs) / sizeof((path_enum_ptrs)[0])), 0, 0, path_enum_ptrs }; const gs_memory_struct_type_t st_path = { sizeof(gx_path), "path", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &path_reloc_ptrs };
static const gc_ptr_element_t path_segments_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gx_path_segments *)0)->contents.subpath_first - (char *)((gx_path_segments *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_path_segments *)0)->contents.subpath_current - (char *)((gx_path_segments *)0) )) } }; static const gc_struct_data_t path_segments_reloc_ptrs = { (sizeof(path_segments_enum_ptrs) / sizeof((path_segments_enum_ptrs)[0])), 0, 0, path_segments_enum_ptrs }; static const gs_memory_struct_type_t st_path_segments = { sizeof(gx_path_segments), "path segments", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &path_segments_reloc_ptrs };
static const gc_ptr_element_t segment_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((struct segment_s *)0)->prev - (char *)((struct segment_s *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((struct segment_s *)0)->next - (char *)((struct segment_s *)0) )) } }; static const gc_struct_data_t segment_reloc_ptrs = { (sizeof(segment_enum_ptrs) / sizeof((segment_enum_ptrs)[0])), 0, 0, segment_enum_ptrs }; static const gs_memory_struct_type_t st_segment = { sizeof(struct segment_s), "segment", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &segment_reloc_ptrs };
static const gc_struct_data_t line_reloc_ptrs = { 0, 0, &st_segment, 0 }; static const gs_memory_struct_type_t st_line = { sizeof(line_segment), "line", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &line_reloc_ptrs };
static const gc_struct_data_t dash_reloc_ptrs = { 0, 0, &st_segment, 0 }; static const gs_memory_struct_type_t st_dash = { sizeof(dash_segment), "dash", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &dash_reloc_ptrs };
static const gc_ptr_element_t close_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((line_close_segment *)0)->sub - (char *)((line_close_segment *)0) )) } }; static const gc_struct_data_t close_reloc_ptrs = { (sizeof(close_enum_ptrs) / sizeof((close_enum_ptrs)[0])), 0, &st_segment, close_enum_ptrs }; static const gs_memory_struct_type_t st_line_close = { sizeof(line_close_segment), "close", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &close_reloc_ptrs };
static const gs_memory_struct_type_t st_curve = { sizeof(curve_segment), "curve", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &segment_reloc_ptrs };
static const gc_ptr_element_t subpath_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((subpath *)0)->last - (char *)((subpath *)0) )) } }; static const gc_struct_data_t subpath_reloc_ptrs = { (sizeof(subpath_enum_ptrs) / sizeof((subpath_enum_ptrs)[0])), 0, &st_segment, subpath_enum_ptrs }; static const gs_memory_struct_type_t st_subpath = { sizeof(subpath), "subpath", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &subpath_reloc_ptrs };



static void rc_free_path_segments(gs_memory_t *, void *, client_name_t);
static void rc_free_path_segments_local(gs_memory_t *, void *, client_name_t);
...
{
    ppath->box_last = 0;
    ppath->segments->contents.subpath_first = ppath->segments->contents.subpath_current = 0;
    ...
    ppath->bbox.p.x = (~(-1 << ((1 << 2) * 8 - 1)));
    ppath->bbox.p.y = (~(-1 << ((1 << 2) * 8 - 1)));
    ppath->bbox.q.x = (-1 << ((1 << 2) * 8 - 1));
    ppath->bbox.q.y = (-1 << ((1 << 2) * 8 - 1));
}
                    ...
                    client_name_t cname)
{
    ...
    do { if ( ((*ppsegs) = (gx_path_segments *)(*(mem)->procs.alloc_struct)(mem, &st_path_segments, cname)) == 0 ) { return ((-25)); } else { do { (*ppsegs)->rc.ref_count = 1; (*ppsegs)->rc.memory = mem; (*ppsegs)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0);
                              ...
                              gs_memory_t * mem, client_name_t cname)
{
    if (shared) {
        if (shared->segments == &shared->local_segments) {
            (eprintf_program_ident(gs_program_name(), gs_revision_number()), lprintf_file_and_line("./base/gxpath.c", 142), errprintf_nomem("Attempt to share (local) segments of path 0x%lx!\n", (ulong) shared));

            return ((-100));
        }
        *ppath = *shared;
        do { if (ppath->segments) do { (ppath->segments)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    } else {
                     ...
                     client_name_t cname)
{
    ...
    if (shared) {
        if (shared->segments == &shared->local_segments) {
            (eprintf_program_ident(gs_program_name(), gs_revision_number()), lprintf_file_and_line("./base/gxpath.c", 177), errprintf_nomem("Attempt to share (local) segments of path 0x%lx!\n", (ulong) shared));

            ((mem)->procs.free_object(mem, ppath, cname));
            return 0;
        }
        *ppath = *shared;
        do { if (ppath->segments) do { (ppath->segments)->rc.ref_count++; do { } while (0); } while (0); } while (0);
                          ...
                          gs_memory_t * mem)
{
    if (shared) {
        if (shared->segments == &shared->local_segments) {
            (eprintf_program_ident(gs_program_name(), gs_revision_number()), lprintf_file_and_line("./base/gxpath.c", 208), errprintf_nomem("Attempt to share (local) segments of path 0x%lx!\n", (ulong) shared));
        ...
        *ppath = *shared;
        ...
        do { (&ppath->local_segments)->rc.ref_count = 1; (&ppath->local_segments)->rc.memory = mem; (&ppath->local_segments)->rc.free = rc_free_path_segments_local; do { } while (0); } while (0);
...
gx_path_unshare(gx_path * ppath)
{
    ...
    if (((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1))
...
{
    do { if (ppath->segments) { do { do { } while (0); (ppath->segments)->rc.ref_count += (-1); } while (0); if (!(ppath->segments)->rc.ref_count) { do { do { } while (0); (ppath->segments)->rc.free((ppath->segments)->rc.memory, (void *)(ppath->segments), cname); } while (0); (ppath->segments) = 0; } else do { } while (0); } } while (0);

    ppath->box_last = 0;
    ppath->segments = 0;
    if (ppath->allocation == path_allocated_on_heap)
        ((ppath->memory)->procs.free_object(ppath->memory, ppath, cname));
}
# 284 "./base/gxpath.c"
int
gx_path_assign_preserve(gx_path * ppto, gx_path * ppfrom)
{
    ...
    if (fromsegs == &ppfrom->local_segments) {
        ...
        if (tosegs == &ppto->local_segments || ((ppto)->segments != 0 && (ppto)->segments->rc.ref_count > 1)) {
            ...
            if (code < 0)
                return code;
            do { if (ppto->segments) { do { do { } while (0); (ppto->segments)->rc.ref_count += (-1); } while (0); if (!(ppto->segments)->rc.ref_count) { do { do { } while (0); (ppto->segments)->rc.free((ppto->segments)->rc.memory, (void *)(ppto->segments), "gx_path_assign"); } while (0); (ppto->segments) = 0; } else do { } while (0); } } while (0);
        } else {
        ...
        do { if (tosegs) do { (tosegs)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    } else {

        do { if (fromsegs) do { (fromsegs)->rc.ref_count++; do { } while (0); } while (0); } while (0);
        do { if (tosegs) { do { do { } while (0); (tosegs)->rc.ref_count += (-1); } while (0); if (!(tosegs)->rc.ref_count) { do { do { } while (0); (tosegs)->rc.free((tosegs)->rc.memory, (void *)(tosegs), "gx_path_assign"); } while (0); (tosegs) = 0; } else do { } while (0); } } while (0);
    }
    *ppto = *ppfrom;
    ppto->memory = mem;
...
gx_path_assign_free(gx_path * ppto, gx_path * ppfrom)
{
    ...
    if (ppto->segments == &ppto->local_segments &&
        ...
        !((ppto)->segments != 0 && (ppto)->segments->rc.ref_count > 1)
        ) {
        ...
        rc_free_path_segments_local((&ppto->local_segments)->rc.memory, (&ppto->local_segments),
                                    "gx_path_assign_free");


        *ppto = *ppfrom;
        do { if ((&ppfrom->local_segments)) do { ((&ppfrom->local_segments))->rc.ref_count++; do { } while (0); } while (0); } while (0);
        ppto->segments = (&ppto->local_segments);
        ppto->memory = mem;
        ppto->allocation = allocation;
                            ...
                            client_name_t cname)
{
    ...
    while (pseg) {
        ...
        do { } while (0);
        ((mem)->procs.free_object(mem, pseg, cname));
        pseg = prev;
    }
}
static void
rc_free_path_segments(gs_memory_t * mem, void *vpsegs, client_name_t cname)
{
    ...
    ((mem)->procs.free_object(mem, vpsegs, cname));
}
# 438 "./base/gxpath.c"
int
gx_path_new(gx_path * ppath)
{
    ...
    if (((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1)) {
        ...
        if (code < 0)
            return code;
        do { if (psegs) { do { do { } while (0); (psegs)->rc.ref_count += (-1); } while (0); if (!(psegs)->rc.ref_count) { do { do { } while (0); (psegs)->rc.free((psegs)->rc.memory, (void *)(psegs), "gx_path_new"); } while (0); (psegs) = 0; } else do { } while (0); } } while (0);
    } else {
...
gx_path_new_subpath(gx_path * ppath)
{
    ...
    do { if ( ((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1) ) { int code_; if( (code_ = path_alloc_copy(ppath)) < 0 ) return code_; } } while (0); psub = ppath->segments->contents.subpath_current; if( !(spp = (subpath *)(*(((ppath->memory)->procs.stable(ppath->memory)))->procs.alloc_struct)(((ppath->memory)->procs.stable(ppath->memory)), &st_subpath, "gx_path_new_subpath")) ) return ((-25)); spp->type = s_start, spp->notes = sn_none, spp->next = 0;
    ...
    if (!psub) {
        ppath->segments->contents.subpath_first = spp;
        spp->prev = 0;
    } else {
    ...
    ppath->segments->contents.subpath_current = spp;
    ppath->subpath_count++;
    do { } while (0);
    return 0;
}
...
{
    if (ppath->bbox_set)
        if ( (x < ppath->bbox.p.x || x > ppath->bbox.q.x || y < ppath->bbox.p.y || y > ppath->bbox.q.y) ) return ((-15));
    ppath->position.x = x;
    ppath->position.y = y;
...
gx_path_add_relative_point(gx_path * ppath, fixed dx, fixed dy)
{
...

    {
        ...
        if (((nx ^ dx) < 0 && (ppath->position.x ^ dx) >= 0) ||
            ...
            return ((-13));
        if (ppath->bbox_set)
            if ( (nx < ppath->bbox.p.x || nx > ppath->bbox.q.x || ny < ppath->bbox.p.y || ny > ppath->bbox.q.y) ) return ((-15));
        ppath->position.x = nx;
        ppath->position.y = ny;
    }
    ((ppath)->state_flags = (ppath)->start_flags = psf_last_moveto);
...
gz_path_add_line_notes(gx_path * ppath, fixed x, fixed y, segment_notes notes)
{
    ...
    if (ppath->bbox_set)
        if ( (x < ppath->bbox.p.x || x > ppath->bbox.q.x || y < ppath->bbox.p.y || y > ppath->bbox.q.y) ) return ((-15));
    do { if ( !(((ppath)->state_flags & psf_is_drawing) != 0) ) { int code_; if ( !(((ppath)->state_flags & psf_position_valid) != 0) ) return ((-14)); code_ = gx_path_new_subpath(ppath); if ( code_ < 0 ) return code_; } } while (0);
    do { if ( ((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1) ) { int code_; if( (code_ = path_alloc_copy(ppath)) < 0 ) return code_; } } while (0); psub = ppath->segments->contents.subpath_current; if( !(lp = (line_segment *)(*(((ppath->memory)->procs.stable(ppath->memory)))->procs.alloc_struct)(((ppath->memory)->procs.stable(ppath->memory)), &st_line, "gx_path_add_line")) ) return ((-25)); lp->type = s_line, lp->notes = notes, lp->next = 0;

    { segment *prev = psub->last; prev->next = (segment *)lp; lp->prev = prev; psub->last = (segment *)lp; };
...
gz_path_add_gap_notes(gx_path * ppath, fixed x, fixed y, segment_notes notes)
{
    ...
    if (ppath->bbox_set)
        if ( (x < ppath->bbox.p.x || x > ppath->bbox.q.x || y < ppath->bbox.p.y || y > ppath->bbox.q.y) ) return ((-15));
    do { if ( !(((ppath)->state_flags & psf_is_drawing) != 0) ) { int code_; if ( !(((ppath)->state_flags & psf_position_valid) != 0) ) return ((-14)); code_ = gx_path_new_subpath(ppath); if ( code_ < 0 ) return code_; } } while (0);
    do { if ( ((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1) ) { int code_; if( (code_ = path_alloc_copy(ppath)) < 0 ) return code_; } } while (0); psub = ppath->segments->contents.subpath_current; if( !(lp = (line_segment *)(*(((ppath->memory)->procs.stable(ppath->memory)))->procs.alloc_struct)(((ppath->memory)->procs.stable(ppath->memory)), &st_line, "gx_path_add_gap")) ) return ((-25)); lp->type = s_gap, lp->notes = notes, lp->next = 0;
                        ...
                        segment_notes notes)
{
    ...
    if (count <= 0)
        return 0;
    do { if ( ((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1) ) { int code_; if( (code_ = path_alloc_copy(ppath)) < 0 ) return code_; } } while (0);
    do { if ( !(((ppath)->state_flags & psf_is_drawing) != 0) ) { int code_; if ( !(((ppath)->state_flags & psf_position_valid) != 0) ) return ((-14)); code_ = gx_path_new_subpath(ppath); if ( code_ < 0 ) return code_; } } while (0);
    psub = ppath->segments->contents.subpath_current;
    prev = psub->last;
    ...
    for (i = 0; i < count; i++) {
        ...
        if (!(next = (line_segment *)(*(((ppath->memory)->procs.stable(ppath->memory)))->procs.alloc_struct)(((ppath->memory)->procs.stable(ppath->memory)), &st_line, "gx_path_add_lines"))
...
gx_path_add_dash_notes(gx_path * ppath, fixed x, fixed y, fixed dx, fixed dy, segment_notes notes)
{
    ...
    if (ppath->bbox_set)
        if ( (x < ppath->bbox.p.x || x > ppath->bbox.q.x || y < ppath->bbox.p.y || y > ppath->bbox.q.y) ) return ((-15));
    do { if ( !(((ppath)->state_flags & psf_is_drawing) != 0) ) { int code_; if ( !(((ppath)->state_flags & psf_position_valid) != 0) ) return ((-14)); code_ = gx_path_new_subpath(ppath); if ( code_ < 0 ) return code_; } } while (0);
    do { if ( ((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1) ) { int code_; if( (code_ = path_alloc_copy(ppath)) < 0 ) return code_; } } while (0); psub = ppath->segments->contents.subpath_current; if( !(lp = (dash_segment *)(*(((ppath->memory)->procs.stable(ppath->memory)))->procs.alloc_struct)(((ppath->memory)->procs.stable(ppath->memory)), &st_dash, "gx_dash_add_dash")) ) return ((-25)); lp->type = s_dash, lp->notes = notes, lp->next = 0;
...
gx_path_add_rectangle(gx_path * ppath, fixed x0, fixed y0, fixed x1, fixed y1)
{
    ...
    if ((code = gx_path_add_point(ppath, x0, y0)) < 0 ||
        (code = gx_path_add_lines_notes(ppath, pts, 3, sn_none)) < 0 ||
        (code = gx_path_close_subpath_notes(ppath, sn_none)) < 0
        )
        return code;
    return 0;
}
                        ...
                        segment_notes notes)
{
    ...
    if (ppath->bbox_set) {
        if ( (x1 < ppath->bbox.p.x || x1 > ppath->bbox.q.x || y1 < ppath->bbox.p.y || y1 > ppath->bbox.q.y) ) return ((-15));
        if ( (x2 < ppath->bbox.p.x || x2 > ppath->bbox.q.x || y2 < ppath->bbox.p.y || y2 > ppath->bbox.q.y) ) return ((-15));
        if ( (x3 < ppath->bbox.p.x || x3 > ppath->bbox.q.x || y3 < ppath->bbox.p.y || y3 > ppath->bbox.q.y) ) return ((-15));
    }
    do { if ( !(((ppath)->state_flags & psf_is_drawing) != 0) ) { int code_; if ( !(((ppath)->state_flags & psf_position_valid) != 0) ) return ((-14)); code_ = gx_path_new_subpath(ppath); if ( code_ < 0 ) return code_; } } while (0);
    do { if ( ((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1) ) { int code_; if( (code_ = path_alloc_copy(ppath)) < 0 ) return code_; } } while (0); psub = ppath->segments->contents.subpath_current; if( !(lp = (curve_segment *)(*(((ppath->memory)->procs.stable(ppath->memory)))->procs.alloc_struct)(((ppath->memory)->procs.stable(ppath->memory)), &st_curve, "gx_path_add_curve")) ) return ((-25)); lp->type = s_curve, lp->notes = notes, lp->next = 0;
...
{
    do { if ( ((ppfrom)->segments != 0 && (ppfrom)->segments->rc.ref_count > 1) ) { int code_; if( (code_ = path_alloc_copy(ppfrom)) < 0 ) return code_; } } while (0);
    do { if ( ((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1) ) { int code_; if( (code_ = path_alloc_copy(ppath)) < 0 ) return code_; } } while (0);
    if (ppfrom->segments->contents.subpath_first) {
        if (ppath->segments->contents.subpath_first) {
            subpath *psub = ppath->segments->contents.subpath_current;
            segment *pseg = psub->last;
            subpath *pfsub = ppfrom->segments->contents.subpath_first;

            pseg->next = (segment *) pfsub;
            pfsub->prev = pseg;
        } else
            ppath->segments->contents.subpath_first = ppfrom->segments->contents.subpath_first;
        ppath->segments->contents.subpath_current = ppfrom->segments->contents.subpath_current;
                      ...
                      gs_char_path_mode mode)
{
    ...
    switch (mode) {
        ...
        case cpm_false_charboxpath:
            ...
            if (code >= 0)
                code = gx_path_add_line_notes(to_path, bbox.q.x, bbox.q.y, sn_none);
            break;
    }
    if (code < 0)
        return code;
...
gz_path_close_subpath_notes(gx_path * ppath, segment_notes notes)
{
    ...
    do { if ( ((ppath)->segments != 0 && (ppath)->segments->rc.ref_count > 1) ) { int code_; if( (code_ = path_alloc_copy(ppath)) < 0 ) return code_; } } while (0); psub = ppath->segments->contents.subpath_current; if( !(lp = (line_close_segment *)(*(((ppath->memory)->procs.stable(ppath->memory)))->procs.alloc_struct)(((ppath->memory)->procs.stable(ppath->memory)), &st_line_close, "gx_path_close_subpath")) ) return ((-25)); lp->type = s_line_close, lp->notes = notes, lp->next = 0;
...
{
  return (((ppath)->state_flags & psf_is_drawing) != 0);
}
...
path_alloc_copy(gx_path * ppath)
{
    ...
    (void)gx_path_init_local_shared(&path_new, ((void*)0), ppath->memory);
    code = gx_path_copy_reducing(ppath, &path_new, (~(-1 << ((1 << 2) * 8 - 1))), ((void*)0), pco_none);
    if (code < 0) {
