...
zbuildfont32(i_ctx_t *i_ctx_p)
{
    ...
    code = build_proc_name_refs(((gs_memory_t *)((i_ctx_p->memory).current)), &build, ((void*)0), "%Type32BuildGlyph");
    if (code < 0)
        return code;
...
zgetshowoperator(i_ctx_t *i_ctx_p)
{
    ...
    if (osenum == ((void*)0))
        ...
        *(void **)&proc = osenum->enum_client_data;
        ((op)->value.opproc = (proc), ((op)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((op)->tas.rsize = (0)));
    }
    return 0;
}
