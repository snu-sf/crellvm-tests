...
# 25 "./base/gxclfile.c" 2
# 35 "./base/gxclfile.c"
static int
clist_fopen(char fname[4096], const char *fmode,
            ...
            bool ok_to_compress)
{
    ...
    if (*pcf == ((void*)0)) {
        (emprintf_program_ident(mem, gs_program_name(), gs_revision_number()), errprintf(mem, "Could not open the scratch file %s.\n", fname));
        return ((-9));
    }
    return 0;
}
...
int gs_gxclfile_init(gs_memory_t *);
int
