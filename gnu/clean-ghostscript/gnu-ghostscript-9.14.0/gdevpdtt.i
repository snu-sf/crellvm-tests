# 1 "./devices/vector/gdevpdtt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpdtt.c" 2
# 18 "./devices/vector/gdevpdtt.c"
# 1 "./base/math_.h" 1
# 23 "./base/math_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 19 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/string_.h" 1
# 32 "./base/string_.h"
...
# 33 "./base/string_.h" 2
# 20 "./devices/vector/gdevpdtt.c" 2
# 1 "/usr/include/stdlib.h" 1 3 4
# 32 "/usr/include/stdlib.h" 3 4
# 1 "/home/juneyoung.lee/llvm-prototypes/llvm-install-3.7.0/bin/../lib/clang/3.7.0/include/stddef.h" 1 3 4
...
# 21 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
...
# 22 "./devices/vector/gdevpdtt.c" 2
...
# 24 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gscedata.h" 1
# 37 "./base/gscedata.h"
...
# 25 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gsmatrix.h" 1
# 31 "./base/gsmatrix.h"
struct gs_matrix_s {
...
# 26 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gzstate.h" 1
# 22 "./base/gzstate.h"
# 1 "./base/gscpm.h" 1
# 22 "./base/gscpm.h"
...
# 27 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gxfcache.h" 1
# 24 "./base/gxfcache.h"
# 1 "./base/gsuid.h" 1
# 26 "./base/gsuid.h"
...
# 28 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gxfont.h" 1
# 24 "./base/gxfont.h"
# 1 "./base/gsfont.h" 1
# 44 "./base/gsfont.h"
...
# 29 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gxfont0.h" 1
# 25 "./base/gxfont0.h"
typedef enum {
    fmap_8_8 = 2,
...
# 30 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gxfcid.h" 1
# 22 "./base/gxfcid.h"
# 1 "./base/gxcid.h" 1
# 27 "./base/gxcid.h"
...
# 31 "./devices/vector/gdevpdtt.c" 2
...
# 32 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gxfcmap.h" 1
# 24 "./base/gxfcmap.h"
# 1 "./base/gsfcmap.h" 1
# 35 "./base/gsfcmap.h"
...
# 33 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gxpath.h" 1
# 25 "./base/gxpath.h"
# 1 "./base/gspenum.h" 1
# 30 "./base/gspenum.h"
...
# 34 "./devices/vector/gdevpdtt.c" 2
# 1 "./base/gxchar.h" 1
# 23 "./base/gxchar.h"
# 1 "./base/gschar.h" 1
# 39 "./base/gschar.h"
...
# 35 "./devices/vector/gdevpdtt.c" 2
...
# 37 "./devices/vector/gdevpdtt.c" 2
...
# 38 "./devices/vector/gdevpdtt.c" 2
...
# 39 "./devices/vector/gdevpdtt.c" 2
...
# 40 "./devices/vector/gdevpdtt.c" 2
...
# 41 "./devices/vector/gdevpdtt.c" 2
# 1 "./devices/vector/gdevpdtf.h" 1
# 108 "./devices/vector/gdevpdtf.h"
...
# 42 "./devices/vector/gdevpdtt.c" 2
# 1 "./devices/vector/gdevpdts.h" 1
# 41 "./devices/vector/gdevpdts.h"
...
# 43 "./devices/vector/gdevpdtt.c" 2
# 1 "./devices/vector/gdevpdtt.h" 1
# 97 "./devices/vector/gdevpdtt.h"
...
int process_composite_text(gs_text_enum_t *pte, void *vbuf, uint bsize);
int process_cmap_text(gs_text_enum_t *pte, void *vbuf, uint bsize);
int process_cid_text(gs_text_enum_t *pte, void *vbuf, uint bsize);



int process_plain_text(gs_text_enum_t *pte, void *vbuf, uint bsize);
...
# 44 "./devices/vector/gdevpdtt.c" 2
...
# 45 "./devices/vector/gdevpdtt.c" 2
...
# 47 "./devices/vector/gdevpdtt.c" 2




extern const gs_memory_struct_type_t st_gs_text_enum; static const gc_ptr_element_t pdf_text_enum_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((pdf_text_enum_t *)0)->pte_default - (char *)((pdf_text_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((pdf_text_enum_t *)0)->cgp - (char *)((pdf_text_enum_t *)0) )) } }; static const gc_struct_data_t pdf_text_enum_reloc_ptrs = { (sizeof(pdf_text_enum_enum_ptrs) / sizeof((pdf_text_enum_enum_ptrs)[0])), 0, &st_gs_text_enum, pdf_text_enum_enum_ptrs }; static const gs_memory_struct_type_t st_pdf_text_enum = { sizeof(pdf_text_enum_t), "pdf_text_enum_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &pdf_text_enum_reloc_ptrs };





static gs_glyph standard_glyph_code_for_notdef = ((gs_glyph)0x7fffffff);
...
pdf_text_resync(gs_text_enum_t *pte, const gs_text_enum_t *pfrom)
{
    ...
    if ((pte->text.operation ^ pfrom->text.operation) & ~(0x00001 | 0x00002 | 0x00004 | 0x00008 | (0x00010 | 0x00020)))
        return ((-15));
    ...
    pte->text = pfrom->text;
    gs_text_enum_copy_dynamic(pte, pfrom, ((bool)0));
    return 0;
}
static bool
                   ...
                   gs_text_cache_control_t control)
{
    ...
    case TEXT_SET_CACHE_DEVICE:
        ...
        if (pdev->PS_accumulator){
            gs_matrix_scale(&(*(const gs_matrix *)&(pte->pis)->ctm), .01, .01, &m);
...
# 133 "./devices/vector/gdevpdtt.c"
    ...
    if ((penum->current_font->FontType == ft_user_defined ||
        ...
        penum->current_font->FontType == ft_GL2_531) &&
            penum->outer_CID == ((gs_glyph)0x7fffffff) &&
            !(pgste->text.operation & 0x00800)) {
        int code;
        gs_glyph glyph;

        glyph = penum->returned.current_glyph;
        if ((glyph != ((gs_glyph)0x7fffffff) && penum->output_char_code != ((gs_char)~0L)) || !pdev->PS_accumulator) {
            ...
            if ((*(pgste->memory)->procs.object_type)(pgste->memory, pgste) != &st_gs_show_enum) {
            ...
            for (i = 0; i < narg; i += 2) {
                ...
                gs_point_transform(pw[i], pw[i + 1], &(*(const gs_matrix *)&(penum_s->pgs)->ctm), &p);
                pw1[i] = p.x;
                pw1[i + 1] = p.y;
            }
            if (control != TEXT_SET_CHAR_WIDTH) {
                clip_box.p.x = ((fixed)((pw1[2])*(float)(1<<8)));
                clip_box.p.y = ((fixed)((pw1[3])*(float)(1<<8)));
                clip_box.q.x = ((fixed)((pw1[4])*(float)(1<<8)));
                clip_box.q.y = ((fixed)((pw1[5])*(float)(1<<8)));
            } else {
# 205 "./devices/vector/gdevpdtt.c"
                clip_box.p.x = clip_box.p.y = (-1 << ((1 << 2) * 8 - 1)) / 2;
                clip_box.q.x = clip_box.q.y = (~(-1 << ((1 << 2) * 8 - 1))) / 2;
            }
            code = gx_clip_to_rectangle(penum_s->pgs, &clip_box);
            if (code < 0)
                return code;
# 220 "./devices/vector/gdevpdtt.c"
            if (pdev->PS_accumulator)
                gs_matrix_scale(&(*(const gs_matrix *)&(penum_s->pgs)->ctm), .01, .01, &m);
            else
                m = (*(const gs_matrix *)&(penum_s->pgs)->ctm);
            for (i = 0; i < narg; i += 2) {
                gs_point p;
            ...
            if (!pdev->PS_accumulator)
                code = pdf_set_charproc_attrs(pdev, pte->current_font,
                        pw1, narg, control, penum->returned.current_char, ((bool)0));
            else
                code = pdf_set_charproc_attrs(pdev, pte->current_font,
                        pw1, narg, control, penum->output_char_code, ((bool)1));
            if (code < 0)
                return code;
...
# 269 "./devices/vector/gdevpdtt.c"
            gs_matrix_scale(&(*(const gs_matrix *)&(penum->pis)->ctm), .01, .01, (gs_matrix *)&(*(const gs_matrix *)&(penum->pis)->ctm));
            ...
            penum->charproc_accum = ((bool)0);
            pdev->accumulating_charproc = ((bool)0);
        }
    }
    if (pdev->PS_accumulator && penum->pte_default) {
        if (penum->pte_default->text.operation & 0x00800 )
...
{
    if (penum->cgp) {
        ((penum->memory)->procs.free_object(penum->memory, penum->cgp, "pdf_text_release"));
        penum->cgp = 0;
    }
}


static int pdf_text_process(gs_text_enum_t *pte);
        ...
        if (!pdev->ForOPDFRead) {
            if (pis->text_rendering_mode != 3 && pis->text_rendering_mode != 7) {
                if (font->PaintType == 2) {
                    ...
                    code = ((((pgs)->color[0].dev_color))->type != (&gx_dc_type_data_none)) ? 0 : gx_remap_color(pgs);;
                    if (code != 0)
                        return code;
                    ...
                    if (pis->text_rendering_mode == 1 || pis->text_rendering_mode == 2 ||
                        ...
                        if (!pdev->remap_fill_color) {
                            if (pdev->remap_stroke_color) {
                                pdev->remap_stroke_color = ((bool)0);
                            } else {
                                gs_swapcolors_quick(pgs);
                                code = ((((pgs)->color[0].dev_color))->type != (&gx_dc_type_data_none)) ? 0 : gx_remap_color(pgs);;
                                if (code == (-103))
                                    pdev->remap_stroke_color = ((bool)1);
                                if (code != 0)
                                    return code;
                            }
                        } else
                            pdev->remap_fill_color = ((bool)0);
                        gs_swapcolors_quick(pgs);
                        code = ((((pgs)->color[0].dev_color))->type != (&gx_dc_type_data_none)) ? 0 : gx_remap_color(pgs);;
                        if (code == (-103))
                            pdev->remap_fill_color = ((bool)1);
                        if (code != 0)
                            return code;
                    }
                }
...
pdf_prepare_text_drawing(gx_device_pdf *const pdev, gs_text_enum_t *pte)
{
    ...
    bool new_clip = ((bool)0);
    int code;
    gs_font *font = pte->current_font;

    if (!(text->operation & 0x00200) || pis->text_rendering_mode == 3) {
                    ...
                    gs_memory_t * mem, gs_text_enum_t ** ppte)
{
...

    {
        ...
        gs_matrix_multiply(&font->FontMatrix, &(*(const gs_matrix *)&(pis)->ctm), &tmat);
    ...
    if ((text->operation & (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000)) && !path0->segments->contents.subpath_first) {
        if (pdf_compare_text_state_for_charpath(pdev->text->text_state, pdev, pis, font, text))
            pdev->last_charpath_op = text->operation & (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000);
    }
    ...
    if(font->FontType == ft_composite && ((gs_font_type0 *)font)->data.FMapType != fmap_CMap) {
        ...
        do { if ( ((penum) = (pdf_text_enum_t *)(*(mem)->procs.alloc_struct)(mem, &st_pdf_text_enum, "gdev_pdf_text_begin")) == 0 ) { return ((-25)); } else { do { (penum)->rc.ref_count = 1; (penum)->rc.memory = mem; (penum)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0);

        penum->rc.free = rc_free_text_enum;
        penum->pte_default = 0;
        penum->charproc_accum = ((bool)0);
        pdev->accumulating_charproc = ((bool)0);
        penum->cdevproc_callout = ((bool)0);
        penum->returned.total_width.x = penum->returned.total_width.y = 0;
        penum->cgp = ((void*)0);
        penum->output_char_code = ((gs_char)~0L);
        code = gs_text_enum_init((gs_text_enum_t *)penum, &pdf_text_procs,
                             dev, pis, text, font, path, pdcolor, pcpath, mem);
        if (code < 0) {
            ((mem)->procs.free_object(mem, penum, "gdev_pdf_text_begin"));
            return code;
        }
        do {
    ...
    if (!user_defined || !(text->operation & (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000))) {
        if (user_defined &&
            (text->operation & 0x00200) && (text->operation & 0x20000)
            ...
            if (code < 0)
                return code;
        } else if ((!(text->operation & 0x00400) && pis->text_rendering_mode != 3)
                    || path == 0 || !(((path)->state_flags & psf_position_valid) != 0)
                    || pdev->type3charpath)
            return gx_default_text_begin(dev, pis, text, font, path, pdcolor,
                                         pcpath, mem, ppte);
        else if (text->operation & (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000))
            return gx_default_text_begin(dev, pis, text, font, path, pdcolor,
                                         pcpath, mem, ppte);
    }
    ...
    if (pdev->font3 != 0) {
# 645 "./devices/vector/gdevpdtt.c"
        penum->device_disabled_grid_fitting = ((bool)1);
    }
...
static const gc_ptr_element_t pdf_font_cache_elem_enum[] = { { GC_ELT_OBJ, ((int) ( (char *)&((pdf_font_cache_elem_t *)0)->next - (char *)((pdf_font_cache_elem_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((pdf_font_cache_elem_t *)0)->pdfont - (char *)((pdf_font_cache_elem_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((pdf_font_cache_elem_t *)0)->glyph_usage - (char *)((pdf_font_cache_elem_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((pdf_font_cache_elem_t *)0)->real_widths - (char *)((pdf_font_cache_elem_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((pdf_font_cache_elem_t *)0)->pdev - (char *)((pdf_font_cache_elem_t *)0) )) } }; static const gc_struct_data_t pdf_font_cache_elem_reloc = { (sizeof(pdf_font_cache_elem_enum) / sizeof((pdf_font_cache_elem_enum)[0])), 0, 0, pdf_font_cache_elem_enum }; static const gs_memory_struct_type_t st_pdf_font_cache_elem = { sizeof(pdf_font_cache_elem_t), "pdf_font_cache_elem_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &pdf_font_cache_elem_reloc };
...
pdf_remove_font_cache_elem(pdf_font_cache_elem_t *e0)
{
    ...
    for (; *e != 0; e = &(*e)->next)
        if (*e == e0) {
            *e = e0->next;
            ((pdev->v_memory)->procs.free_object(pdev->v_memory, e0->glyph_usage, "pdf_remove_font_cache_elem"));

            ((pdev->v_memory)->procs.free_object(pdev->v_memory, e0->real_widths, "pdf_remove_font_cache_elem"));
# 701 "./devices/vector/gdevpdtt.c"
            e0->next = 0;
            e0->glyph_usage = 0;
            e0->real_widths = 0;
            e0->pdev = 0;
            ((pdev->v_memory)->procs.free_object(pdev->v_memory, e0, "pdf_remove_font_cache_elem"));
                             ...
                             gs_font *font)
{
    ...
    len = (num_chars + 7) / 8;
    e->glyph_usage = (*(pdev->v_memory)->procs.alloc_bytes)(pdev->v_memory, len, "alloc_font_cache_elem_arrays");


    e->real_widths = (num_widths > 0 ? (double *)(*(pdev->v_memory)->procs.alloc_bytes)(pdev->v_memory, num_widths * sizeof(*e->real_widths) * ((font->FontType == ft_user_defined || font->FontType == ft_GL2_stick_user_defined || font->FontType == ft_PCL_user_defined || font->FontType == ft_MicroType || font->FontType == ft_GL2_531) ? 2 : 1), "alloc_font_cache_elem_arrays") : ((void*)0));
    ...
    if (e->glyph_usage == ((void*)0) || (num_widths !=0 && e->real_widths == ((void*)0))) {
        ((pdev->v_memory)->procs.free_object(pdev->v_memory, e->glyph_usage, "pdf_attach_font_resource"));

        ((pdev->v_memory)->procs.free_object(pdev->v_memory, e->real_widths, "alloc_font_cache_elem_arrays"));
                            ...
                            double **real_widths, int *num_chars, int *num_widths)
{
    ...
    if (e != ((void*)0) && (((*e)->glyph_usage == ((void*)0) && glyph_usage !=((void*)0)) ||
                      ((*e)->real_widths == ((void*)0) && real_widths !=((void*)0)))) {
        int code = alloc_font_cache_elem_arrays(pdev, *e, font);

        if (code < 0)
            return code;
    }
    *pdfont = (e == ((void*)0) ? ((void*)0) : (*e)->pdfont);
    if (glyph_usage != ((void*)0))
        *glyph_usage = (e == ((void*)0) ? ((void*)0) : (*e)->glyph_usage);
    if (real_widths != ((void*)0))
        *real_widths = (e == ((void*)0) ? ((void*)0) : (*e)->real_widths);
    if (num_chars != ((void*)0))
        *num_chars = (e == ((void*)0) ? 0 : (*e)->num_chars);
    if (num_widths != ((void*)0))
        *num_widths = (e == ((void*)0) ? 0 : (*e)->num_widths);
    return 0;
}
                         ...
                         pdf_font_resource_t *pdfont)
{
    ...
    if (pe != ((void*)0)) {
        ...
        e = (pdf_font_cache_elem_t *)(pdf_font_cache_elem_t *)(*(pdev->v_memory)->procs.alloc_struct)(pdev->v_memory, &st_pdf_font_cache_elem, "pdf_attach_font_resource");
        ...
        e->num_chars = 0;
        e->glyph_usage = ((void*)0);
        e->real_widths = ((void*)0);
        e->pdev = pdev;
            ...
            if (font->FontType == ft_user_defined ||
                ...
                *pmat = base_font->orig_FontMatrix;
                ...
                if (base_font->FontMatrix.xx == 1.0/2048 &&
                    ...
                    ((base_font->FontMatrix.yy) < 0 ? -(base_font->FontMatrix.yy) : (base_font->FontMatrix.yy)) == 1.0/2048
                    )
                    *pmat = base_font->FontMatrix;
                else
...
glyph_orig_matrix(const gs_font *font, gs_glyph cid, gs_matrix *pmat)
{
    ...
    if (code >= 0) {
        if (font->FontType == ft_CID_encrypted) {
            ...
            if (cid < ((gs_glyph)0x80000000L))
                cid = ((gs_glyph)0x80000000L);
            code = ((gs_font_cid0 *)font)->cidata.glyph_data((gs_font_base *)font,
                                cid, ((void*)0), &fidx);
            if (code < 0) {
                code = ((gs_font_cid0 *)font)->cidata.glyph_data((gs_font_base *)font,
                                (gs_glyph)((gs_glyph)0x80000000L), ((void*)0), &fidx);
            }
            if (code >= 0) {
            ...
            const pdf_char_glyph_pair_t *pairs, int num_chars)
{
    ...
    for (i = 0; i < num_chars; ++i) {
        ...
        if (pairs[i].glyph == pet->glyph)
            continue;
        if (pet->glyph != ((gs_glyph)0x7fffffff))
            return ((bool)0);
    }
    return ((bool)1);
}
                           ...
                           gs_font *font, const pdf_char_glyph_pair_t *pairs, int num_chars)
{
    ...
    case ft_composite:
        {
# 1062 "./devices/vector/gdevpdtt.c"
    ...
    case ft_GL2_stick_user_defined:
    case ft_GL2_531:
        if (pdfont->u.simple.Encoding == ((void*)0))
            return ((bool)0);
    ...
    case ft_CID_TrueType:
        {
            gs_font *font1 = (gs_font *)pdf_font_resource_font(pdfont, ((bool)0));
    ...
    for (i = 0; i < 16; i++) {
        for (pres = pchain[i]; pres != 0; pres = pres->next) {
            ...
            if (pdfont->FontType == ft_composite) {
                ...
                cfont = pdf_font_resource_font(pdfont->u.type0.DescendantFont, ((bool)0));
                if (font0->data.CMap->WMode != pdfont->u.type0.WMode)
                    continue;
            } else
                cfont = pdf_font_resource_font(pdfont, ((bool)0));
            ...
            code = gs_copied_can_copy_glyphs((const gs_font *)cfont, ofont,
                            ...
                            sizeof(pdf_char_glyph_pair_t), ((bool)1));
            if (code == (-28))
                return code;
            if(code > 0) {
                *ppdfont = pdfont;
                            ...
                            pdf_char_glyph_pairs_t *cgp)
{
    ...
    code = pdf_attached_font_resource(pdev, subfont, ppdsubf, ((void*)0), ((void*)0), ((void*)0), ((void*)0));
    if (code < 0)
        return code;
    if (*ppdsubf != ((void*)0)) {
        const gs_font_base *cfont = pdf_font_resource_font(*ppdsubf, ((bool)0));
    ...
    code = pdf_find_font_resource(pdev, subfont,
                                  resourceCIDFont, ppdsubf, cgp, ((bool)1));
    if (code < 0)
        return code;
    if (*ppdsubf == ((void*)0)) {
                       ...
                       pdf_font_resource_t **ppdfont)
{
    ...
    cached = (*(pdev->v_memory)->procs.alloc_bytes)(pdev->v_memory, 256/8, "pdf_make_font3_resource");
    if (cached == ((void*)0))
        return ((-25));
    code = font_resource_encoded_alloc(pdev, &pdfont, bfont->id,
                    ft_user_defined, pdf_write_contents_bitmap);
    if (code < 0) {
        ((pdev->v_memory)->procs.free_object(pdev->v_memory, cached, "pdf_make_font3_resource"));
        return code;
    }
    memset(cached, 0, 256 / 8);
    pdfont->mark_glyph = font->dir->ccache.mark_glyph;
    pdfont->u.simple.s.type3.bitmap_font = ((bool)0);
    pdfont->u.simple.BaseEncoding = pdf_refine_encoding_index(pdev,
                        bfont->nearest_encoding_index, ((bool)1));
    pdfont->u.simple.s.type3.char_procs = ((void*)0);
    ...
    if (pdfont->u.simple.s.type3.Resources == ((void*)0))
        return ((-25));
    ...
    if (pdfont->u.simple.s.type3.FontMatrix.xx != 0.0 ||
        ...
        while (((pdfont->u.simple.s.type3.FontMatrix.xx) < 0 ? -(pdfont->u.simple.s.type3.FontMatrix.xx) : (pdfont->u.simple.s.type3.FontMatrix.xx)) < 0.001 &&
               ((pdfont->u.simple.s.type3.FontMatrix.xy) < 0 ? -(pdfont->u.simple.s.type3.FontMatrix.xy) : (pdfont->u.simple.s.type3.FontMatrix.xy)) < 0.001 &&
               ((pdfont->u.simple.s.type3.FontMatrix.yx) < 0 ? -(pdfont->u.simple.s.type3.FontMatrix.yx) : (pdfont->u.simple.s.type3.FontMatrix.yx)) < 0.001 &&
               ((pdfont->u.simple.s.type3.FontMatrix.yy) < 0 ? -(pdfont->u.simple.s.type3.FontMatrix.yy) : (pdfont->u.simple.s.type3.FontMatrix.yy)) < 0.001) {
                       ...
                       pdf_char_glyph_pairs_t *cgp)
{
    ...
    if (embed == FONT_EMBED_STANDARD) {
        ...
        if (psf->pdfont == ((void*)0) ||
                !pdf_is_compatible_encoding(pdev, psf->pdfont, font,
                        cgp->s, cgp->num_all_chars)) {
            code = pdf_font_std_alloc(pdev, ppdfont, (psf->pdfont == ((void*)0)), base_font->id,
            ...
            (*ppdfont)->u.simple.BaseEncoding = pdf_refine_encoding_index(pdev,
                ((const gs_font_base *)base_font)->nearest_encoding_index, ((bool)1));
            code = 1;
        } else
            *ppdfont = psf->pdfont;
        return code;
            ...
            for (i = 0; i <= 0xff; ++i) {
                ...
                if (glyph == ((gs_glyph)0x7fffffff) ||
                    (glyph >= (((gs_glyph)0x80000000L) | (((gs_glyph)0x80000000L) >> 1)) &&
                     glyph <= (((gs_glyph)0x80000000L) | (((gs_glyph)0x80000000L) >> 1)) + 0xff)
                    )
                    continue;
...
# 1510 "./devices/vector/gdevpdtt.c"
        BaseEncoding = pdf_refine_encoding_index(pdev,
            ((const gs_font_base *)base_font)->nearest_encoding_index, ((bool)0));
    }
    ...
    if (font_is_simple) {
        ...
        *glyph = font->procs.encode_char(font, *char_code, GLYPH_SPACE_NAME);
        ...
        if (*glyph < ((gs_glyph)0x80000000L))
            return 3;
        *cid = *glyph - ((gs_glyph)0x80000000L);
    }
    return 0;
}
                                ...
                                int *last_reserved_char)
{
    ...
    if (pdfont->u.simple.preferred_encoding_index != -1) {
        ...
        if (standard_glyph_code_for_notdef == ((gs_glyph)0x7fffffff))
        ...
        for (ch = *last_reserved_char + 1; ch < 256; ch++) {
            ...
            if (pet->glyph == ((gs_glyph)0x7fffffff) && enc[ch] == standard_glyph_code_for_notdef) {
...
{
    const int go = (pstr != ((void*)0) ? pstr->size : penum->text.size);
    const int struct_size = sizeof(pdf_char_glyph_pairs_t) +
                            sizeof(pdf_char_glyph_pair_t) * (2 * go - 1);
    pdf_char_glyph_pairs_t *cgp = (pdf_char_glyph_pairs_t *)(*(penum->memory)->procs.alloc_bytes)(penum->memory, struct_size, "pdf_alloc_text_glyphs_table");
                ...
                byte *glyph_usage, int char_cache_size)
{
    ...
    if (pstr != ((void*)0)) {
        ...
        if ( scan.text.operation & 0x00004 )
            scan.text.operation = ((scan.text.operation & ~0x00004) | 0x00001);
    }
    for (;;) {
                ...
                int *ps_encoding_index)
{
    ...
    code = pdf_attached_font_resource(pdev, font, &pdfont, ((void*)0), ((void*)0), ((void*)0), ((void*)0));
    if (code < 0)
        return code;
...
do_unknown:
    if (unknown) {
        ...
        for (i = 0; i < pstr->size; i++) {
            ...
            store_glyphs(cgp, ((void*)0), 0, gdata[i], gdata[i], gdata[i]);
        }
        code = pdf_find_font_resource(pdev, font, resourceFont, &pdfont, cgp, ((bool)0));
        if (code < 0)
            return code;
        if (code) {
    ...
    for (j = 0, ei = start_ei; gs_c_known_encodings[j]; j++, ei++) {
        ...
        for (i = 0; i < pstr->size; i++) {
            ...
            store_glyphs(cgp, ((void*)0), 0, ch, ch, gdata[i]);
        }
...
{
    int code;
    pdf_font_resource_t *pdfont_not_allowed = ((void*)0);

    if (*ppdfont != 0) {
        gs_font_base *cfont = pdf_font_resource_font(*ppdfont, ((bool)0));
    ...
    if (*ppdfont == 0) {
        ...
        while ((below = base_font->base) != base_font &&
               base_font->procs.same_font(base_font, below, 1))
            base_font = below;
        if (base_font != font)
            same_encoding = ((base_font->procs.same_font(base_font, font,
                              4) & 4) != 0);

        code = pdf_attached_font_resource(pdev, base_font, ppdfont, ((void*)0), ((void*)0), ((void*)0), ((void*)0));
        if (code < 0)
            return code;
        if (base_font != font) {
        ...
        if(*ppdfont != ((void*)0) && !pdf_is_compatible_encoding(pdev, *ppdfont,
                                    base_font, cgp->s, cgp->num_all_chars))
                *ppdfont = ((void*)0);
        if (*ppdfont == ((void*)0) || *ppdfont == pdfont_not_allowed) {
            pdf_resource_type_t type =
                (pdf_is_CID_font(base_font) ? resourceCIDFont
                                            : resourceFont);
            *ppdfont = ((void*)0);
            code = pdf_find_font_resource(pdev, base_font, type, ppdfont, cgp, ((bool)1));
            if (code < 0)
                return code;
            if (*ppdfont == ((void*)0)) {
            ...
            byte *glyph_usage, int char_cache_size)
{
    ...
    if (pstr != ((void*)0)) {
        ...
        if ( scan.text.operation & 0x00004 )
            scan.text.operation =
                ((scan.text.operation & ~0x00004) | 0x00001);
    }
    for (;;) {
...
# 2187 "./devices/vector/gdevpdtt.c"
        if (pdsubf->u.cidfont.parent == ((void*)0) ||
                pdf_find_type0_font_resource(pdev, pdsubf, CMapName, font_index, pdfont) <= 0) {
            int code = pdf_font_type0_alloc(pdev, pdfont, 0L, pdsubf, CMapName);
...
pdf_find_glyph(pdf_font_resource_t *pdfont, gs_glyph glyph)
{
    if (pdfont->FontType != ft_user_defined &&
        ...
        for (i = pdfont->u.simple.FirstChar; i <= pdfont->u.simple.LastChar; i++, pet++) {
            if (pet->glyph == glyph)
                return (gs_char)i;
            if (i0 == -1 && pet->glyph == ((gs_glyph)0x7fffffff))
                i0 = i;
        }
        if (i0 != -1)
            return (gs_char)i0;
...
# 2237 "./devices/vector/gdevpdtt.c"
static int
                              ...
                              gs_font *font, gx_device_pdf *pdev)
{
    ...
    {
        gs_font_base *cfont = pdf_font_resource_font(pdfont, ((bool)0));
    ...
    *tmat = (*(const gs_matrix *)&(pis)->ctm);
    ...
    size = sqrt((double)(tmat->yx)*(tmat->yx)+(double)(tmat->yy)*(tmat->yy)) / sy;
    if (size < 0.01)
        size = sqrt((double)(tmat->xx)*(tmat->xx)+(double)(tmat->xy)*(tmat->xy)) / sx;
    if (size < 0.01)
        size = 1;
                      ...
                      pdf_font_resource_t *pdfont, const gs_matrix *pfmat)
{
    ...
    if (penum->text.operation & 0x00040) {
    ...
    if (penum->text.operation & 0x00080) {
        gs_point pt;
    ...
    tmat.yx /= size;
    tmat.yy /= size;
    tmat.tx += ((cpt.x)*(1.0/(1<<8)));
    tmat.ty += ((cpt.y)*(1.0/(1<<8)));
                    ...
                    pdf_glyph_widths_t *pwidths)
{
    ...
    code = cfont->procs.font_info((gs_font *)cfont, ((void*)0),
                                  0x0800, &finfo);
    if (code < 0)
        return code;
    if (wmode) {
...
# 2531 "./devices/vector/gdevpdtt.c"
int
                 ...
                 const double cdevproc_result[10])
{
    ...
    pwidths->replaced_v = ((bool)0);
    pwidths->ignore_wmode = ((bool)0);
    if (glyph == ((gs_glyph)0x7fffffff))
        return get_missing_width(cfont, wmode, &scale_c, pwidths);
    code = cfont->procs.glyph_info((gs_font *)cfont, glyph, ((void*)0),
                                    1 |
                                    (1 << wmode) |
                                    32 |
                                    (64 << wmode),
    ...
    if ((code == (-21) || !(info.members & (1 << wmode)))) {





        if (code == (-21) && (ofont->FontType == ft_encrypted || ofont->FontType == ft_encrypted2)) {
            int index;
            ...
            for (index = 0;
                ...
                index != 0;) {
                    if (gs_font_glyph_is_notdef((gs_font_base *)ofont, notdef_glyph)) {
                        code = ofont->procs.glyph_info((gs_font *)ofont, notdef_glyph, ((void*)0),
                                            1 << wmode,
                                            &info);
    ...
    if (cdevproc_result == ((void*)0)) {
        info.members = 0;
        code = ofont->procs.glyph_info(ofont, glyph, ((void*)0),
                                            (1 << wmode) |
                                            (64 << wmode) |
    ...
    if (code == (-21) || !(info.members & (1 << wmode)))
        ...
        if ((info.members & (64 | 128)) != 0) {
            pwidths->replaced_v = ((bool)1);
            if ((info.members & 128) == 0 && wmode == 1)
                pwidths->ignore_wmode = ((bool)1);
        }
        else
            info.v.x = info.v.y = 0;
...
pdf_choose_output_char_code(gx_device_pdf *pdev, pdf_text_enum_t *penum, gs_char *pch)
{
    ...
    if (penum->text.operation & 0x00020) {
        byte buf[1];
        ...
        if (font0->data.FMapType == fmap_CMap) {
            pdf_font_resource_t *pdfont;
            int code = pdf_attached_font_resource(pdev, font, &pdfont, ((void*)0), ((void*)0), ((void*)0), ((void*)0));
...
pdf_choose_output_glyph_hame(gx_device_pdf *pdev, pdf_text_enum_t *penum, gs_const_string *gnstr, gs_glyph glyph)
{
    if (penum->orig_font->FontType == ft_composite || penum->orig_font->procs.glyph_name(penum->orig_font, glyph, gnstr) < 0) {
        ...
        gnstr->size = 5;
        p = (byte *)(*(pdev->v_memory)->procs.alloc_string)(pdev->v_memory, gnstr->size, "pdf_text_set_cache");
        if (p == ((void*)0))
            return ((-25));
                       ...
                       gs_text_enum_t **ppte)
{
    ...
    if(pte->current_font->FontType == 3 && (text1.operation & 0x00200)) {

        text1.operation &= ~0x00200;
        text1.operation |= 0x00400;
    }
                             ...
                             gs_text_enum_t *pte_default, pdf_text_enum_t *const penum)
{
    ...
    if (penum->current_font->FontType == ft_user_defined &&
        penum->outer_CID == ((gs_glyph)0x7fffffff) &&
            !(penum->pte_default->text.operation & 0x00800)) {
        ...
        if (code < 0)
            return code;
# 2816 "./devices/vector/gdevpdtt.c"
        pdev->width *= 100;
        pdev->height *= 100;
        ...
        if (code < 0)
            return code;
        code = pdf_attached_font_resource(pdev, penum->current_font, &pdfont, ((void*)0), ((void*)0), ((void*)0), ((void*)0));
        if (code < 0)
            return code;
        pdev->font3 = (pdf_resource_t *)pdfont;
        pdev->substream_Resources = pdfont->u.simple.s.type3.Resources;
        penum->charproc_accum = ((bool)1);
        pdev->accumulating_charproc = ((bool)1);
                             ...
                             bool was_PS_type3)
{
    ...
    if ((penum->current_font->FontType == ft_user_defined ||
       ...
       stell(pdev->strm) == 0)
    {
        char glyph[256], FontName[47 + 1], KeyName[256];
        int len;

        len = (((47) < (gnstr.size)) ? (47) : (gnstr.size));
        memcpy(glyph, gnstr.data, len);
        glyph[len] = 0x00;
        len = (((47) < (penum->current_font->font_name.size)) ? (47) : (penum->current_font->font_name.size));
        memcpy(FontName, penum->current_font->font_name.chars, len);
        FontName[len] = 0x00;
        len = (((47) < (penum->current_font->key_name.size)) ? (47) : (penum->current_font->key_name.size));
        memcpy(KeyName, penum->current_font->key_name.chars, len);
        KeyName[len] = 0x00;

        (emprintf_program_ident(pdev->memory, gs_program_name(), gs_revision_number()), errprintf(pdev->memory, "ERROR: Page %d used undefined glyph '%s' from type 3 font '%s', key '%s'\n", pdev->next_page, glyph, FontName, KeyName));
...
# 3000 "./devices/vector/gdevpdtt.c"
...
static int pdf_query_purge_cached_char(const gs_memory_t *mem, cached_char *cc, void *data)
{
    ...
    if (cc->code == to_purge->code && ((cc)->pair) == ((to_purge)->pair) &&
        cc->subpix_origin.x == to_purge->subpix_origin.x &&
        cc->subpix_origin.y == to_purge->subpix_origin.y &&
        cc->wmode == to_purge->wmode && ((cc)->head.depth) == ((to_purge)->head.depth)
        )
        return 1;
    return 0;
}
...
pdf_text_process(gs_text_enum_t *pte)
{
    ...
    gs_text_enum_t *pte_default;
    int (*process)(gs_text_enum_t *pte, void *vbuf, uint bsize);
    ...
    union bu_ {
        byte bytes[100];
        gs_char chars[100 / sizeof(gs_char)];
        gs_glyph glyphs[100 / sizeof(gs_glyph)];
    } buf;
    ...
    if (!penum->pte_default) {
        pdev->charproc_just_accumulated = ((bool)0);
        if (penum->cdevproc_callout) {
    ...
    if ((penum->current_font->FontType == ft_user_defined ||
        ...
        penum->current_font->FontType == ft_GL2_stick_user_defined ||
        penum->current_font->FontType == ft_GL2_531) &&
        (penum->text.operation & (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000))
        && !pdev->type3charpath) {
        pdev->type3charpath = ((bool)1);
...
# 3097 "./devices/vector/gdevpdtt.c"
    if (pte_default) {
        gs_char *cdata;
        ...
        if (penum->charproc_accum) {
            ...
            code = complete_charproc(pdev, pte, pte_default, penum, ((bool)1));
            if (code < 0)
                return code;
            if (!pdev->type3charpath)
                goto top;
        ...
        if (penum->current_font->FontType == ft_PCL_user_defined
            && operation & 0x00004 && !pdev->type3charpath &&
            cdata[pte->index] <= 255) {
# 3127 "./devices/vector/gdevpdtt.c"
            pdf_font_resource_t *pdfont;

            code = pdf_attached_font_resource(pdev, (gs_font *)penum->current_font, &pdfont, ((void*)0), ((void*)0), ((void*)0), ((void*)0));
            if (code < 0)
                return code;
        ...
        if ((penum->current_font->FontType == ft_GL2_stick_user_defined ||
            ...
            && operation & 0x00004 && !pdev->type3charpath) {
# 3165 "./devices/vector/gdevpdtt.c"
            float x0y1, x1y0;
        ...
        if (early_accumulator) {
            if (cdata[pte->index] <= 255) {
...

                {
                    ...
                    code = gx_lookup_fm_pair(pfont, &(*(const gs_matrix *)&(pte->pis)->ctm), &log2_scale, ((bool)0), &pair);
                    if (code < 0)
                        return code;
                ...
                code = complete_charproc(pdev, pte, pte_default, penum, ((bool)0));
                if (penum->current_font->FontType == ft_PCL_user_defined)
                {
# 3289 "./devices/vector/gdevpdtt.c"
                    cached_char *cc;
                    cached_fm_pair *pair;
                    gs_log2_scale_point log2_scale = {0,0};
                    gs_font *rfont = (pte->fstack.depth < 0 ? pte->current_font : pte->fstack.items[0].font);
                    ...
                    gx_device_memory *dev =
                        (gx_device_memory *)(*(mem)->procs.alloc_struct)(mem, &st_device_memory, "show_cache_setup(dev_cache)");
                    ...
                    gx_device_retain((gx_device *)dev, ((bool)1));



                    code = gx_alloc_char_bits(pte->current_font->dir, dev, ((void*)0),
                                0, 0, &log2_scale, 1, &cc);
                    if (code < 0)
                        return code;


                    code = gx_lookup_fm_pair(pte->current_font, &(*(const gs_matrix *)&(pte->pis)->ctm),
                            &log2_scale, ((bool)0), &pair);
                    if (code < 0)
                        return code;
                    ...
                    gx_device_retain((gx_device *)dev, ((bool)0));
...
# 3377 "./devices/vector/gdevpdtt.c"
        {
        ...
        gs_text_enum_copy_dynamic(pte, pte_default, ((bool)1));
        if (code)
            return code;
        gs_text_release(pte_default, "pdf_text_process");
        penum->pte_default = 0;
        if (pdev->type3charpath)
            pdev->type3charpath = ((bool)0);
        return 0;
    }
    {
    ...
    if (operation & (0x00001 | 0x00002)) {
        if (size < sizeof(gs_glyph))
            size = sizeof(gs_glyph);
    } else if (operation & 0x00004)
        size *= sizeof(gs_char);
    else if (operation & 0x00010)
        size = sizeof(gs_char);
    else if (operation & 0x00008)
        size *= sizeof(gs_glyph);
    else if (operation & 0x00020)
        size = sizeof(gs_glyph);
    else
        goto skip;
# 3479 "./devices/vector/gdevpdtt.c"
    ...
    if (size <= sizeof(buf)) {
        ...
        byte *buf = (*(pte->memory)->procs.alloc_string)(pte->memory, size, "pdf_text_process");

        if (buf == 0)
            return ((-25));
        code = process(pte, buf, size);
        (*(pte->memory)->procs.free_string)(pte->memory, buf, size, "pdf_text_process");
    }
 skip:
    if (code < 0 ||
 ...
 default_impl:
        ...
        gs_text_enum_copy_dynamic(pte_default, pte, ((bool)0));
    }

    if (penum->pte_default && !code)
        goto top;
    return code;
# 3543 "./devices/vector/gdevpdtt.c"
}
