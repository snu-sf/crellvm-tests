                      ...
                      uint count, ref *pparray)
{
    ...
    if (dict_find_string(pdict, kstr, &pvalue) > 0) {
        ...
        do { if ( !((((const byte *)&((&*pvalue)->tas.type_attrs))[1]) == (t_array)) ) return ((-20)); } while (0);
        if (((pvalue)->tas.rsize) != count)
            return ((-15));
        for (i = 0; i < count; i++) {
            ref proc;
        ...
        *pparray = *pvalue;
        ...
        ((pparray)->value.const_refs = (&empty_procs[0]), ((pparray)->tas.type_attrs = ((t_array) << 8) + ((0x20 + 0x40) | avm_foreign)), ((pparray)->tas.rsize = (count)));
                ...
                const gs_memory_t * mem)
{
    ...
    for (i = 0; i < n; ++i) {
        do { if ( !((((const byte *)&((&pta[i])->tas.type_attrs))[1]) == (t_integer)) ) return ((-20)); } while (0);
        if (pta[i].value.intval <= 1 || pta[i].value.intval > ((unsigned short)0xffff + (unsigned short)0))
            return ((-15));
    ...
    if (n == 3) {
        table =
            (gs_const_string *)(*(mem->stable_memory)->procs.alloc_struct_array)(mem->stable_memory, pclt->dims[0], &st_const_string_element, "cie_table_param");
        ...
        if ( !(((&pta[4])->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x20))) == (((t_array) << 8) + (0x20))) ) return ((!((((const byte *)&((&pta[4])->tas.type_attrs))[1]) == (t_array)) ? check_type_failed(&pta[4]) : (-7)));
        if (((pta + 4)->tas.rsize) != d0)
            return ((-15));
        table =
            (gs_const_string *)(*(mem->stable_memory)->procs.alloc_struct_array)(mem->stable_memory, ntables, &st_const_string_element, "cie_table_param");
    ...
    if (code < 0) {
        (((gs_memory_t *)mem)->procs.free_object((gs_memory_t *)mem, table, "cie_table_param"));
        return code;
    }
    pclt->table = table;
    return 0;
                   ...
                   gs_const_string * strings)
{
    ...
    if ( !(((&*ptable)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x20))) == (((t_array) << 8) + (0x20))) ) return ((!((((const byte *)&((&*ptable)->tas.type_attrs))[1]) == (t_array)) ? check_type_failed(&*ptable) : (-7)));
    if (((ptable)->tas.rsize) != count)
        return ((-15));
    rstrings = ptable->value.const_refs;
    for (i = 0; i < count; ++i) {
        const ref *const prt2 = rstrings + i;

        if ( !(((&*prt2)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x20))) == (((t_string) << 8) + (0x20))) ) return ((!((((const byte *)&((&*prt2)->tas.type_attrs))[1]) == (t_string)) ? check_type_failed(&*prt2) : (-7)));
        if (((prt2)->tas.rsize) != nbytes)
            return ((-15));
            ...
            ref_cie_procs * pcprocs, bool *has_a_procs, bool *has_lmn_procs)
{
    ...
    if (code < 0)
        return code;
    if ((code = dict_proc_param(pdref, "DecodeA", &(pcprocs->Decode.A), ((bool)1))) < 0)
        return code;
    *has_a_procs = !code;
    return 0;
}
...
# 336 "./psi/zcie.c"
    if (*has_abc_procs) {
        cieicc_prepare_caches(i_ctx_p, (&pcie->RangeABC)->ranges,
                 ...
                 ((void*)0), pcie, imem, "Decode.ABC(ICC)");
    } else {
        pcie->caches.DecodeABC.caches->floats.params.is_identity = ((bool)1);
        (pcie->caches.DecodeABC.caches)[1].floats.params.is_identity = ((bool)1);
        (pcie->caches.DecodeABC.caches)[2].floats.params.is_identity = ((bool)1);
    }
    if (*has_lmn_procs) {
        cieicc_prepare_caches(i_ctx_p, (&pcie->common.RangeLMN)->ranges,
                    ...
                    ((void*)0), pcie, imem, "Decode.LMN(ICC)");
    } else {
        pcie->common.caches.DecodeLMN->floats.params.is_identity = ((bool)1);
        (pcie->common.caches.DecodeLMN)[1].floats.params.is_identity = ((bool)1);
        (pcie->common.caches.DecodeLMN)[2].floats.params.is_identity = ((bool)1);
    }
    return 0;
}
               ...
               const ref_cie_procs * pcprocs, int edepth, int code)
{
    ...
    ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->colorspace[0].procs.cie = *pcprocs;
    ...
    *has_defg_procs = !code;
    if (*has_defg_procs) {
        cieicc_prepare_caches(i_ctx_p, (&pcie->RangeDEFG)->ranges,
         ...
         pcie->caches_defg.DecodeDEFG->floats.params.is_identity = ((bool)1);
        (pcie->caches_defg.DecodeDEFG)[1].floats.params.is_identity = ((bool)1);
        (pcie->caches_defg.DecodeDEFG)[2].floats.params.is_identity = ((bool)1);
        (pcie->caches_defg.DecodeDEFG)[3].floats.params.is_identity = ((bool)1);
    }
    return(0);
}
int
ciedefgspace(i_ctx_t *i_ctx_p, ref *CIEDict, ulong dictkey)
{
    ...
    int edepth = ref_stack_count(&((i_ctx_p->exec_stack).stack));
    gs_memory_t *mem = gs_state_memory((i_ctx_p->pgs));
    gs_color_space *pcs;
    ref_cie_procs procs;
    gs_cie_defg *pcie;
    int code = 0;
    ...
    procs = ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->colorspace[0].procs.cie;
    if (pcs == ((void*)0) ) {
    if ((code = dict_find_string(CIEDict, "Table", &ptref)) <= 0)
        return (code < 0 ? code : ((-15)));
    if ( !(((&*ptref)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x20))) == (((t_array) << 8) + (0x20))) ) return ((!((((const byte *)&((&*ptref)->tas.type_attrs))[1]) == (t_array)) ? check_type_failed(&*ptref) : (-7)));
    if (((ptref)->tas.rsize) != 5)
        return ((-15));

        code = gs_cspace_build_CIEDEFG(&pcs, ((void*)0), mem->stable_memory);
    if (code < 0)
        return code;
    ...
    pcie->Table.m = 3;
        ...
        code = cie_defg_param(i_ctx_p, ((gs_memory_t *)((i_ctx_p->memory).current)), CIEDict, pcie, &procs,
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    gs_cie_defg *pcie = ((gs_cie_defg *)((op)->value.pstruct));
    ...
    *has_def_procs = !code;
    if (*has_def_procs) {
        cieicc_prepare_caches(i_ctx_p, (&pcie->RangeDEF)->ranges,
                 ...
                 ((void*)0), pcie, imem, "Decode.DEF(ICC)");
    } else {
         pcie->caches_def.DecodeDEF->floats.params.is_identity = ((bool)1);
        (pcie->caches_def.DecodeDEF)[1].floats.params.is_identity = ((bool)1);
        (pcie->caches_def.DecodeDEF)[2].floats.params.is_identity = ((bool)1);
    }
    return(0);
}
...
ciedefspace(i_ctx_t *i_ctx_p, ref *CIEDict, ulong dictkey)
{
    ...
    if ((code = dict_find_string(CIEDict, "Table", &ptref)) <= 0)
        return (code < 0 ? code : ((-15)));
    if ( !(((&*ptref)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x20))) == (((t_array) << 8) + (0x20))) ) return ((!((((const byte *)&((&*ptref)->tas.type_attrs))[1]) == (t_array)) ? check_type_failed(&*ptref) : (-7)));
    if (((ptref)->tas.rsize) != 4)
        return ((-15));

        code = gs_cspace_build_CIEDEF(&pcs, ((void*)0), mem->stable_memory);
    if (code < 0)
        return code;
    pcie = pcs->params.def;
    pcie->Table.n = 3;
    pcie->Table.m = 3;
        ...
        code = cie_def_param(i_ctx_p, ((gs_memory_t *)((i_ctx_p->memory).current)), CIEDict, pcie, &procs,
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    gs_cie_def *pcie = ((gs_cie_def *)((op)->value.pstruct));
...
cieabcspace(i_ctx_t *i_ctx_p, ref *CIEDict, ulong dictkey)
{
    ...
    if (pcs == ((void*)0) ) {
        ...
        code = gs_cspace_build_CIEABC(&pcs, ((void*)0), mem->stable_memory);
    if (code < 0)
        return code;
    pcie = pcs->params.abc;
        code = cie_cache_push_finish(i_ctx_p, cie_abc_finish, imem, pcie);
        code = cie_abc_param(i_ctx_p, ((gs_memory_t *)((i_ctx_p->memory).current)), CIEDict, pcie, &procs,
            &has_abc_procs, &has_lmn_procs);
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    gs_cie_abc *pcie = ((gs_cie_abc *)((op)->value.pstruct));
...
cieaspace(i_ctx_t *i_ctx_p, ref *CIEdict, ulong dictkey)
{
    ...
    if (pcs == ((void*)0) ) {
        ...
        code = gs_cspace_build_CIEA(&pcs, ((void*)0), mem->stable_memory);
    if (code < 0)
        return code;
    pcie = pcs->params.a;
        code = cie_a_param(((gs_memory_t *)((i_ctx_p->memory).current)), CIEdict, pcie, &procs, &has_a_procs,
                                &has_lmn_procs);
        if (code < 0)
            return code;
        ...
        if (!has_a_procs && !has_lmn_procs) {
            pcie->common.caches.DecodeLMN->floats
                .params.is_identity = ((bool)1);
            (pcie->common.caches.DecodeLMN)[1].floats.params.is_identity = ((bool)1);
            (pcie->common.caches.DecodeLMN)[2].floats.params.is_identity = ((bool)1);
            pcie->caches.DecodeA.floats.params.is_identity = ((bool)1);
        } else {
            if (has_a_procs) {
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    gs_cie_a *pcie = ((gs_cie_a *)((op)->value.pstruct));
                  ...
                  gs_ref_memory_t * imem, client_name_t cname)
{
    ...
    pcache->params.is_identity = ((proc)->tas.rsize) == 0;
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (9) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 9); if ( es_code_ < 0 ) return es_code_; };
    ep = (((i_ctx_p->exec_stack).stack).p);
    ((ep + 9)->value.realval = (lp.A), ((ep + 9)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((ep + 8)->value.intval = (lp.N), ((ep + 8)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    ((ep + 7)->value.realval = (lp.B), ((ep + 7)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ep[6] = *proc;
    ((ep + 6)->tas.type_attrs &= ~(0x80));
    ((ep + 5)->value.opproc = (zcvx), ((ep + 5)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep + 5)->tas.rsize = (0)));
    ((ep + 4)->value.opproc = (zfor_samples), ((ep + 4)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep + 4)->tas.rsize = (0)));
    ((ep + 3)->value.opproc = (cie_cache_finish), ((ep + 3)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep + 3)->tas.rsize = (0)));
    ...
    ((ep + 2)->value.intval = ((char *)pcache - (char *)container), ((ep + 2)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    ((ep + 1)->value.pstruct = ((obj_header_t *)(container)), ((ep + 1)->tas.type_attrs = ((t_struct) << 8) + (space)) );
    return 5;
}
...
cie_cache_finish_store(i_ctx_t *i_ctx_p, bool replicate)
{
    ...
    if ( (((i_ctx_p->exec_stack).stack).p) < (((i_ctx_p->exec_stack).stack).bot) + ((2) - 1) ) { ((i_ctx_p->exec_stack).stack).requested = (2); return ((-104)); };


    pcache = (cie_cache_floats *) (((char *)(((((i_ctx_p->exec_stack).stack).p) - 1)->value.pstruct)) + (((i_ctx_p->exec_stack).stack).p)->value.intval);

    pcache->params.is_identity = ((bool)0);
    do { } while (0);

    if (replicate ||
        (code = float_params(op, (1 << 9), &pcache->values[0])) < 0
        ) {
        ...
        for (i = 0; i < (1 << 9); i++) {
            code = float_param(ref_stack_index(&((i_ctx_p->op_stack).stack),
                               (replicate ? 0 : (1 << 9) - 1 - i)),
                               &pcache->values[i]);
            if (code < 0)
                return code;
...
# 828 "./psi/zcie.c"
    ref_stack_pop(&((i_ctx_p->op_stack).stack), (replicate ? 1 : (1 << 9)));
...
{
    return cie_cache_finish_store(i_ctx_p, ((bool)0));
}
# 848 "./psi/zcie.c"
int
                      ...
                      gs_ref_memory_t * imem, void *data)
{
    ...
    (((((i_ctx_p->exec_stack).stack).p))->value.pstruct = ((obj_header_t *)(data)), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_struct) << 8) + (imemory_space(imem))) );
    return 5;
}
# 867 "./psi/zcie.c"
                  ...
                  const gs_ref_memory_t * imem, client_name_t cname)
{
    ...
    ((ep + 5)->value.opproc = (zcvx), ((ep + 5)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep + 5)->tas.rsize = (0)));
    ((ep + 4)->value.opproc = (zfor_samples), ((ep + 4)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep + 4)->tas.rsize = (0)));
    ((ep + 3)->value.opproc = (cie_create_icc), ((ep + 3)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep + 3)->tas.rsize = (0)));
    (((i_ctx_p->exec_stack).stack).p) += 9;
...
cie_create_icc(i_ctx_t *i_ctx_p)
{
    ...
    if ((code = float_params(op, (1 << 9), &pcache->values[0])) < 0) {


        uint i;

        for (i = 0; i < (1 << 9); i++) {
            code = float_param(ref_stack_index(&((i_ctx_p->op_stack).stack),(1 << 9) - 1 - i),
                               &pcache->values[i]);
            if (code < 0)
                return code;
        }
...
# 960 "./psi/zcie.c"
    ref_stack_pop(&((i_ctx_p->op_stack).stack), (1 << 9));
    (((i_ctx_p->exec_stack).stack).p) -= 2;
    return 14;
}
