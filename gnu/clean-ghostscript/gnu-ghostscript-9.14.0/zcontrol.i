...
zcond(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( !(((&*op)->tas.type_attrs) & (0x40)) ) return ((-7)); } while (0);
    if ((((op)->tas.rsize) & 1) != 0)
        return ((-15));
    if (((op)->tas.rsize) == 0)
        return zpop(i_ctx_p);
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (3) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 3); if ( es_code_ < 0 ) return es_code_; };
    (((i_ctx_p->exec_stack).stack).p) = ep += 3;
    (*(ep - 2) = *(op));
    ((ep - 1)->value.opproc = (cond_continue), ((ep - 1)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep - 1)->tas.rsize = (0)));
    array_get(((gs_memory_t *)((i_ctx_p->memory).current)), op, 0L, ep);
    do { if (((((&(i_ctx_p->exec_stack))->stack.p)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x80))) == (((t_file) << 8) + (0x80)))) ((&(i_ctx_p->exec_stack))->current_file = ((&(i_ctx_p->exec_stack))->stack.p)); } while (0);
...
cond_continue(i_ctx_t *i_ctx_p)
{
    ...
    if (op->value.boolval) {
        array_get(((gs_memory_t *)((i_ctx_p->memory).current)), ep, 1L, ep);
        do { if (((((&(i_ctx_p->exec_stack))->stack.p)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x80))) == (((t_file) << 8) + (0x80)))) ((&(i_ctx_p->exec_stack))->current_file = ((&(i_ctx_p->exec_stack))->stack.p)); } while (0);
        code = 14;
        ...
        array_get(((gs_memory_t *)((i_ctx_p->memory).current)), ep, 0L, ep + 2);
        ((ep + 1)->value.opproc = (cond_continue), ((ep + 1)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep + 1)->tas.rsize = (0)));
        (((i_ctx_p->exec_stack).stack).p) = ep + 2;
        do { if (((((&(i_ctx_p->exec_stack))->stack.p)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x80))) == (((t_file) << 8) + (0x80)))) ((&(i_ctx_p->exec_stack))->current_file = ((&(i_ctx_p->exec_stack))->stack.p)); } while (0);
        code = 5;
    } else {
        (((i_ctx_p->exec_stack).stack).p) = ep - 1;
        code = 14;
    }
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return code;
...
zexecn(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op)); if ( (ulong)(*op).value.intval > (((unsigned int)~0 + (unsigned int)0) - 1) ) return ((-15)); } while (0);
    n = (uint) op->value.intval;
    if ( op < (((i_ctx_p->op_stack).stack).bot) + ((n + 1) - 1) ) return ((-17));
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (n) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), n); if ( es_code_ < 0 ) return es_code_; };
    esp_orig = (((i_ctx_p->exec_stack).stack).p);
    for (i = 0; i < n; ++i) {
        const ref *rp = ref_stack_index(&((i_ctx_p->op_stack).stack), (long)(i + 1));


        if (((ref_type_properties[(((const byte *)&((rp)->tas.type_attrs))[1])] & (1)) != 0)) {
            if (!(((rp)->tas.type_attrs) & (0x40)) &&
                (((rp)->tas.type_attrs) & (0x80))
                ) {
                (((i_ctx_p->exec_stack).stack).p) = esp_orig;
                return ((-7));
            }
        }
        ...
        if (!(((rp)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x80))) == (((t_null) << 8) + (0x80)))) {
            ++(((i_ctx_p->exec_stack).stack).p);
            (*((((i_ctx_p->exec_stack).stack).p)) = *(rp));
        }
    }
    do { if (((((&(i_ctx_p->exec_stack))->stack.p)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x80))) == (((t_file) << 8) + (0x80)))) ((&(i_ctx_p->exec_stack))->current_file = ((&(i_ctx_p->exec_stack))->stack.p)); } while (0);
    ((((i_ctx_p->op_stack).stack).p) -= (n + 1));
    return 5;
}
...
zsuperexec(i_ctx_t *i_ctx_p)
{
    ...
    if (!(((op)->tas.type_attrs) & (0x80)))
        return 0;
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (2) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 2); if ( es_code_ < 0 ) return es_code_; };
    ep = (((i_ctx_p->exec_stack).stack).p) += 3;
    ((ep - 2)->value.opproc = (end_superexec), ((ep - 2)->tas.type_attrs = ((t_null) << 8) + (0x80)), ((ep - 2)->tas.rsize = (0)));
    ((ep - 1)->value.opproc = (end_superexec), ((ep - 1)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep - 1)->tas.rsize = (0)));
    (*(ep) = *(op));
    do { if (((((&(i_ctx_p->exec_stack))->stack.p)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x80))) == (((t_file) << 8) + (0x80)))) ((&(i_ctx_p->exec_stack))->current_file = ((&(i_ctx_p->exec_stack))->stack.p)); } while (0);
    ((((i_ctx_p->op_stack).stack).p) -= (1));
...
zrunandhide(i_ctx_t *i_ctx_p)
{
    ...
    if (!(((op - 1)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0))))
        return (check_type_failed(op));
    if (!(((op)->tas.type_attrs) & (0x80)))
        return 0;
    ...
    ep = (((i_ctx_p->exec_stack).stack).p) += 5;
    ((ep - 4)->value.opproc = (err_end_runandhide), ((ep - 4)->tas.type_attrs = ((t_null) << 8) + (0x80)), ((ep - 4)->tas.rsize = (0)));
    ((ep - 1)->value.opproc = (end_runandhide), ((ep - 1)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep - 1)->tas.rsize = (0)));
    (*(ep) = *(op));


    ((ep - 3)->value.intval = ((int)op[-1].tas.type_attrs), ((ep - 3)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    (*(ep - 2) = *(op - 1));
    ((ep - 2)->tas.type_attrs &= ~((0x10 + 0x20 +0x40)));
...
runandhide_restore_hidden(i_ctx_t *i_ctx_p, ref *obj, ref *attrs)
{
    ...
    ((op)->tas.type_attrs |= (attrs->value.intval));
    return 0;
}
...
end_runandhide(i_ctx_t *i_ctx_p)
{
    ...
    if ((code = runandhide_restore_hidden(i_ctx_p, (((i_ctx_p->exec_stack).stack).p), (((i_ctx_p->exec_stack).stack).p) - 1)) < 0)
        return code;
...
err_end_runandhide(i_ctx_t *i_ctx_p)
{
    ...
    if ((code = runandhide_restore_hidden(i_ctx_p, (((i_ctx_p->exec_stack).stack).p) + 3, (((i_ctx_p->exec_stack).stack).p) + 2)) < 0)
        return code;
    return 0;
}
...
zif(i_ctx_t *i_ctx_p)
{
    ...
    if ( !((((const byte *)&((&op[-1])->tas.type_attrs))[1]) == (t_boolean)) ) return (check_type_failed(&op[-1]));
...
zifelse(i_ctx_t *i_ctx_p)
{
    ...
    if ( !((((const byte *)&((&op[-2])->tas.type_attrs))[1]) == (t_boolean)) ) return (check_type_failed(&op[-2]));
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (1) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 1); if ( es_code_ < 0 ) return es_code_; };
    ++(((i_ctx_p->exec_stack).stack).p);
...
zfor(i_ctx_t *i_ctx_p)
{
    ...
    ep = (((i_ctx_p->exec_stack).stack).p) + 6;
    do { if ( !(((&*op)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))) ) return (check_proc_failed(&*op)); } while (0);



    if (((((const byte *)&((op - 3)->tas.type_attrs))[1]) == (t_integer)) &&
        ((((const byte *)&((op - 2)->tas.type_attrs))[1]) == (t_integer))
        ) {
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    register es_ptr ep = (((i_ctx_p->exec_stack).stack).p);
...
zfor_samples(i_ctx_t *i_ctx_p)
{
    ...
    if ( !((((const byte *)&((&op[-3])->tas.type_attrs))[1]) == (t_real)) ) return (check_type_failed(&op[-3]));
    if ( !((((const byte *)&((&op[-2])->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&op[-2]));
    if ( !((((const byte *)&((&op[-1])->tas.type_attrs))[1]) == (t_real)) ) return (check_type_failed(&op[-1]));
    do { if ( !(((&*op)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))) ) return (check_proc_failed(&*op)); } while (0);
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (8) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 8); if ( es_code_ < 0 ) return es_code_; };
    ep = (((i_ctx_p->exec_stack).stack).p) + 7;
    ((ep - 6)->value.opproc = (no_cleanup), ((ep - 6)->tas.type_attrs = ((t_null) << 8) + (0x80)), ((ep - 6)->tas.rsize = (2)));
    ((ep - 5)->value.intval = (0), ((ep - 5)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    memcpy(ep - 4, op - 3, 3 * sizeof(ref));
    (*(ep - 1) = *(op));
    ((ep)->value.opproc = (for_samples_continue), ((ep)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((ep)->tas.rsize = (0)));
    (((i_ctx_p->exec_stack).stack).p) = ep;
    ((((i_ctx_p->op_stack).stack).p) -= (4));
    return 5;
}
...
for_samples_continue(i_ctx_t *i_ctx_p)
{
    ...
    if (var > n) {
        (((i_ctx_p->exec_stack).stack).p) -= 6;
        return 14;
    }
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.realval = (((n - var) * a + var * b) / n), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
...
zrepeat(i_ctx_t *i_ctx_p)
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    do { if ( !(((&*op)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))) ) return (check_proc_failed(&*op)); } while (0);
    if ( !((((const byte *)&((&op[-1])->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&op[-1]));
    if (op[-1].value.intval < 0)
        return ((-15));
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (5) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 5); if ( es_code_ < 0 ) return es_code_; };


    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (no_cleanup), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_null) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (2))));
    *++(((i_ctx_p->exec_stack).stack).p) = op[-1];
    *++(((i_ctx_p->exec_stack).stack).p) = *op;
    (((((i_ctx_p->exec_stack).stack).p) + 1)->value.opproc = (repeat_continue), (((((i_ctx_p->exec_stack).stack).p) + 1)->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p) + 1)->tas.rsize = (0)));
    ((((i_ctx_p->op_stack).stack).p) -= (2));
...
zloop(i_ctx_t *i_ctx_p)
{
    ...
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (no_cleanup), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_null) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (2))));
    *++(((i_ctx_p->exec_stack).stack).p) = *op;
    (((((i_ctx_p->exec_stack).stack).p) + 1)->value.opproc = (loop_continue), (((((i_ctx_p->exec_stack).stack).p) + 1)->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p) + 1)->tas.rsize = (0)));
    ((((i_ctx_p->op_stack).stack).p) -= (1));
...
zexit(i_ctx_t *i_ctx_p)
{
    ...
    ref_stack_enum_begin(&rsenum, &((i_ctx_p->exec_stack).stack));
    do {
...
stopped_push(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    *op = (((i_ctx_p->exec_stack).stack).p)[-1];
    (((i_ctx_p->exec_stack).stack).p) -= 3;
    return 14;
}
...
zstopped(i_ctx_t *i_ctx_p)
{
    ...
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (5) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 5); if ( es_code_ < 0 ) return es_code_; };
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (no_cleanup), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_null) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (3))));
    ++(((i_ctx_p->exec_stack).stack).p);
    (((((i_ctx_p->exec_stack).stack).p))->value.boolval = (0), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_boolean) << 8) + (0)) );
    ++(((i_ctx_p->exec_stack).stack).p);
    (((((i_ctx_p->exec_stack).stack).p))->value.intval = (1), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_integer) << 8) + (0)) );
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (stopped_push), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (zexec), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
    return 5;
}
...
zinstopped(i_ctx_t *i_ctx_p)
{
    ...
    if (count) {
        do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
        op[-1] = *ref_stack_index(&((i_ctx_p->exec_stack).stack), count - 2);
        ((op)->value.boolval = (1), ((op)->tas.type_attrs = ((t_boolean) << 8) + (0)) );
    } else
...
zcountexecstack(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.intval = (count_exec_stack(i_ctx_p, ((bool)0))), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
static int
zcountexecstack1(i_ctx_t *i_ctx_p)
{
    ...
    if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_boolean)) ) return (check_type_failed(&*op));
    ((op)->value.intval = (count_exec_stack(i_ctx_p, op->value.boolval)), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
               ...
               op_proc_t cont)
{
    ...
    if (!(((op1)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0))))
    ...
    if (depth > size)
        return ((-15));
    do { if ( !(((&*op1)->tas.type_attrs) & (0x10)) ) return ((-7)); } while (0);
    {
        int code = ref_stack_store_check(&((i_ctx_p->exec_stack).stack), op1, size, 0);
    ...
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (1) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 1); if ( es_code_ < 0 ) return es_code_; };
    ((op1)->tas.rsize = (depth));
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (cont), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
    return 5;
}
static int
zexecstack(i_ctx_t *i_ctx_p)
{
    ...
    return push_execstack(i_ctx_p, op, ((bool)0), execstack_continue);
}
static int
...
do_execstack(i_ctx_t *i_ctx_p, bool include_marks, os_ptr op1)
{
    ...
    uint asize = ((op1)->tas.rsize);
    uint i;
    ref *rq;
# 804 "./psi/zcontrol.c"
    for (i = 0, rq = arefs + asize; rq != arefs; ++i) {
        const ref *rp = ref_stack_index(&((i_ctx_p->exec_stack).stack), (long)i);

        if ((((rp)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x80))) == (((t_null) << 8) + (0x80))) && !include_marks)
            continue;
        --rq;
        (((void)((((((rq)->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), op1, (ref_packed *)(rq), "execstack") : 0))), ((void)(((*(rq) = *(rp)), ((rq)->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
        switch ((((const byte *)&((rq)->tas.type_attrs))[1])) {
            case t_operator: {
                uint opidx = (((rq)->tas.rsize) == 0 ? op_find_index(rq) : ((rq)->tas.rsize));

                if (opidx == 0 || (((&op_defs_all[(opidx) >> 4] [(opidx) & ((1 << 4) - 1)]))->oname[1] == '%'))
                    ((rq)->tas.type_attrs &= ~(0x80));
                break;
            }
            case t_struct:
            case t_astruct: {
                const char *tname = rq->value.pstruct ?
                    ((const char *)gs_struct_type_name((*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_type)(((gs_memory_t *)((i_ctx_p->memory).current)), rq->value.pstruct)))

                    : "NULL";

                ((rq)->value.const_bytes = ((const byte *)tname), ((rq)->tas.type_attrs = ((t_string) << 8) + ((0x20 + 0x40) | avm_foreign)), ((rq)->tas.rsize = (strlen(tname))));
    ...
    ((((i_ctx_p->op_stack).stack).p) -= (op - op1));
    return 0;
}
static int
execstack_continue(i_ctx_t *i_ctx_p)
{
    ...
    return do_execstack(i_ctx_p, ((bool)0), op);
}
static int
...
zcurrentfile(i_ctx_t *i_ctx_p)
{
    ...
    if (((i_ctx_p->exec_stack).current_file) != 0) {
# 891 "./psi/zcontrol.c"
            (*(op) = *(((i_ctx_p->exec_stack).current_file)));
        ...
        (*(op) = *(fp));
        ((&(i_ctx_p->exec_stack))->current_file = (fp));
    }
...
check_for_exec(const_os_ptr op)
{
    if (!(((op)->tas.type_attrs) & (0x40)) &&
        ((ref_type_properties[(((const byte *)&((op)->tas.type_attrs))[1])] & (1)) != 0) &&
        ((((op)->tas.type_attrs) & (0x80)) || !((((const byte *)&((op)->tas.type_attrs))[1]) == (t_dictionary)))
        ) {
        return ((-7));
    }
    return 0;
...
count_exec_stack(i_ctx_t *i_ctx_p, bool include_marks)
{
    ...
    if (!include_marks) {
        ...
        for (i = count; i--;)
            if ((((ref_stack_index(&((i_ctx_p->exec_stack).stack), (long)i))->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x80))) == (((t_null) << 8) + (0x80))))
...
pop_estack(i_ctx_t *i_ctx_p, uint count)
{
    ...
    for (; idx < count; idx++) {
        ref *ep = ref_stack_index(&((i_ctx_p->exec_stack).stack), idx - popped);

        if ((((ep)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x80))) == (((t_null) << 8) + (0x80)))) {
            ref_stack_pop(&((i_ctx_p->exec_stack).stack), idx + 1 - popped);
            popped = idx + 1;
            (*((ep)->value.opproc)) (i_ctx_p);
        }
    }
    ref_stack_pop(&((i_ctx_p->exec_stack).stack), count - popped);
}
...
{
    ((op - 1)->value.opproc = (opproc), ((op - 1)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((op - 1)->tas.rsize = (0)));
    ((op)->value.intval = ((-8)), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return ((-101));
}
