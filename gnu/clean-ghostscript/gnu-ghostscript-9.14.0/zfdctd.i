...
static const gc_ptr_element_t jpeg_decompress_data_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((jpeg_decompress_data *)0)->dummy - (char *)((jpeg_decompress_data *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((jpeg_decompress_data *)0)->scanline_buffer - (char *)((jpeg_decompress_data *)0) )) } }; static const gc_struct_data_t jpeg_decompress_data_reloc_ptrs = { (sizeof(jpeg_decompress_data_enum_ptrs) / sizeof((jpeg_decompress_data_enum_ptrs)[0])), 0, 0, jpeg_decompress_data_enum_ptrs }; static const gs_memory_struct_type_t st_jpeg_decompress_data = { sizeof(jpeg_decompress_data), "JPEG decompress data", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &jpeg_decompress_data_reloc_ptrs };
...
{
    uint use_space = (((space) > (avm_global)) ? (space) : (avm_global));
    os_ptr sop = (((i_ctx_p->op_stack).stack).p) - npop;
    ...
    return (&(i_ctx_p->memory))->spaces.memories.indexed[use_space >> 2];
}
...
zDCTD(i_ctx_t *i_ctx_p)
{
    ...
    jddp = (jpeg_decompress_data *)(*(mem)->procs.alloc_struct_immovable)(mem, &st_jpeg_decompress_data, "zDCTD");
...
fail:
    ...
    ((mem)->procs.free_object(mem, jddp, "zDCTD fail"));
    return code;
}
