# 1 "./base/gscolorbuffer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./base/gscolorbuffer.c" 2
# 23 "./base/gscolorbuffer.c"
# 1 "./base/string_.h" 1
# 23 "./base/string_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 29 "./base/gscolorbuffer.c" 2
# 40 "./base/gscolorbuffer.c"
static void
rgb_to_cmyk(byte rgb[],byte cmyk[])
{
    ...
    cmyk[3] = (cmyk[0] < cmyk[1]) ?
        (((cmyk[0]) < (cmyk[2])) ? (cmyk[0]) : (cmyk[2])) : (((cmyk[1]) < (cmyk[2])) ? (cmyk[1]) : (cmyk[2]));
...
rgb_to_gray(byte rgb[], byte gray[])
{
    ...
    temp_value = temp_value * (1.0 / 255.0 );
    gray[0] = ( (0.0 < (temp_value) && (temp_value) < 1.0) ? ((unsigned char) ((temp_value) * 255.0)) : (((temp_value) <= 0.0) ? 0x00 : 0xFF) );
...
cmyk_to_rgb(byte cmyk[], byte rgb[])
{
    ...
    rgb[0] = 255 - (((cmyk[0] + cmyk[3]) < (255)) ? (cmyk[0] + cmyk[3]) : (255));
    rgb[1] = 255 - (((cmyk[1] + cmyk[3]) < (255)) ? (cmyk[1] + cmyk[3]) : (255));
    rgb[2] = 255 - (((cmyk[2] + cmyk[3]) < (255)) ? (cmyk[2] + cmyk[3]) : (255));
...

{
    ...
    void (* color_remap)(byte input[],byte output[]) = ((void*)0);
    byte input_vector[4],output_vector[4];
    int plane_offset[(8 * 8)+3],alpha_offset_in,max_num_channels;
    ...
    max_num_channels = (((input_num_color) > (output_num_color)) ? (input_num_color) : (output_num_color)) +
        num_noncolor_planes;

    for (z = 0; z < max_num_channels; z++)
       plane_offset[z] = z * plane_stride;

    if (color_remap == ((void*)0)) {
