...
{
    pgs->alpha =
        (gx_color_value) (alpha < 0 ? 0 : alpha > 1 ? ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) :
                          alpha * ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)));
...
{
    return (float)pgs->alpha / ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1));
}
