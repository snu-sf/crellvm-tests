# 1 "./devices/vector/whitelst.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/whitelst.c" 2
# 29 "./devices/vector/whitelst.c"
# 1 "./devices/vector/whitelst.h" 1
# 23 "./devices/vector/whitelst.h"
int IsInWhiteList (const char *Name, int size);
# 30 "./devices/vector/whitelst.c" 2



static const char EmbeddingWhiteList[][483] = {
"Aachen",
"Adobe Arabic",
"Adobe Caslon",
"Adobe Devanagari",
