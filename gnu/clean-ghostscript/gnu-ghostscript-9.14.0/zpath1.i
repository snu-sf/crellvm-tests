      ...
      int (*aproc)(gs_state *, double, double, double, double, double))
{
    ...
    if (code < 0)
        return code;
    code = (*aproc)((i_ctx_p->pgs), xyra[0], xyra[1], xyra[2], xyra[3], xyra[4]);
    if (code >= 0)
...
zarcto(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    ((op - 4)->value.realval = (tanxy[0]), ((op - 4)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((op - 3)->value.realval = (tanxy[1]), ((op - 3)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((op - 2)->value.realval = (tanxy[2]), ((op - 2)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((op - 1)->value.realval = (tanxy[3]), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
...
common_arct(i_ctx_t *i_ctx_p, float *tanxy)
{
    ...
    if (code < 0)
        return code;
    return gs_arcto((i_ctx_p->pgs), args[0], args[1], args[2], args[3], args[4], tanxy);
}
...
{
    return gs_dashpath((i_ctx_p->pgs));
}
...
{
    return gs_flattenpath((i_ctx_p->pgs));
}
...
{
    return gs_reversepath((i_ctx_p->pgs));
}
...
{
    return gs_strokepath((i_ctx_p->pgs));
}
...
{
    return gs_clippath((i_ctx_p->pgs));
}
...
z1pathbbox(i_ctx_t *i_ctx_p)
{
    ...
    code = gs_upathbbox((i_ctx_p->pgs), &box, op->value.boolval);
    if (code < 0)
        return code;
    ...
    ((op - 3)->value.realval = (box.p.x), ((op - 3)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((op - 2)->value.realval = (box.p.y), ((op - 2)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((op - 1)->value.realval = (box.q.x), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((op)->value.realval = (box.q.y), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zpathforall(i_ctx_t *i_ctx_p)
{
    ...
    if ((penum = gs_path_enum_alloc(((gs_memory_t *)((i_ctx_p->memory).current)), "pathforall")) == 0)
        return ((-25));
    code = gs_path_enum_copy_init(((gs_memory_t *)((i_ctx_p->memory).current)), penum, (i_ctx_p->pgs), ((bool)1));
    if (code < 0) {
        ((((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_object(((gs_memory_t *)((i_ctx_p->memory).current)), penum, "path_cleanup"));
        return code;
    }

    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (path_cleanup), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_null) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (2))));
    memcpy((((i_ctx_p->exec_stack).stack).p) + 1, op - 3, 4 * sizeof(ref));
    ...
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (path_continue), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
...
{
    gs_path_enum *penum = ((gs_path_enum *)(((((i_ctx_p->exec_stack).stack).p))->value.pstruct));
    gs_point ppts[3];
    int code;



    if ( (((i_ctx_p->op_stack).stack).top) - (((i_ctx_p->op_stack).stack).p) < (6) ) { ((i_ctx_p->op_stack).stack).requested = (6); return ((-16)); };
    ...
    switch (code) {
        ...
        default:
            return code;
        case 1:
            (((i_ctx_p->exec_stack).stack).p)[2] = (((i_ctx_p->exec_stack).stack).p)[-4];
            pf_push(i_ctx_p, ppts, 1);
            break;
        case 2:
            (((i_ctx_p->exec_stack).stack).p)[2] = (((i_ctx_p->exec_stack).stack).p)[-3];
            pf_push(i_ctx_p, ppts, 1);
            break;
        case 3:
            (((i_ctx_p->exec_stack).stack).p)[2] = (((i_ctx_p->exec_stack).stack).p)[-2];
            pf_push(i_ctx_p, ppts, 3);
            break;
        case 4:
            (((i_ctx_p->exec_stack).stack).p)[2] = (((i_ctx_p->exec_stack).stack).p)[-1];
            break;
    }
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (path_continue), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
...
pf_push(i_ctx_t *i_ctx_p, gs_point * ppts, int n)
{
    ...
    while (n--) {
        op += 2;
        ((op - 1)->value.realval = (ppts->x), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
        ((op)->value.realval = (ppts->y), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
        ppts++;
    }
...
{
    gs_path_enum *penum = ((gs_path_enum *)(((((i_ctx_p->exec_stack).stack).p) + 6)->value.pstruct));
