...
# Version of the pcl3 rules: $Revision: 1.5 $.
...
wep9_=  $(DEVOBJ)gdevwep9pin.$(OBJ)

$(DD)wep9pin.dev:  $(wep9_) $(DD)page.dev
	$(SETPDEV2) $(DD)wep9pin $(wep9_)

$(DEVOBJ)gdevwep9pin.$(OBJ): $(CONTRIBSRC)gdevwep9pin.c $(PDEVH)
	$(DEVCC) $(O_)gdevwep9pin.$(OBJ) $(C_) $(CONTRIBSRC)gdevwep9pin.c

### ----------------- WeP 24-pin Ghostscript Driver ---------------------- ###

wep_=  $(DEVOBJ)gdevwep24pin.$(OBJ)

$(DD)wep24pin.dev:  $(wep_) $(DD)page.dev
	$(SETPDEV2) $(DD)wep24pin $(wep_)

$(DEVOBJ)gdevwep24pin.$(OBJ): $(CONTRIBSRC)gdevwep24pin.c $(PDEVH)
	$(DEVCC) $(O_)gdevwep24pin.$(OBJ) $(C_) $(CONTRIBSRC)gdevwep24pin.c
