...
zcurrentsmoothness(i_ctx_t *i_ctx_p)
{
    ...
    ((op)->value.realval = (gs_currentsmoothness((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zsetsmoothness(i_ctx_t *i_ctx_p)
{
    ...
    if ((code = gs_setsmoothness((i_ctx_p->pgs), smoothness)) < 0)
        return code;
...
zshfill(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0 || (code = gs_shfill((i_ctx_p->pgs), psh)) < 0)
        return code;
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
...
zbuildshadingpattern(i_ctx_t *i_ctx_p)
{
    ...
    if ( !((((const byte *)&((&*op2)->tas.type_attrs))[1]) == (t_dictionary)) ) return (check_type_failed(&*op2));
    do { if ( !(((&*(&(&*op2)->value.pdict->values))->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
    gs_pattern2_init(&templat);
    if ((code = read_matrix(((gs_memory_t *)((i_ctx_p->memory).current)), op - 1, &mat)) < 0 ||
        (code = dict_uid_param(op2, &templat.uid, 1, ((gs_memory_t *)((i_ctx_p->memory).current)), i_ctx_p)) != 1 ||
        (code = shading_param(op, &templat.Shading)) < 0 ||
        (code = int_pattern_alloc(&pdata, op2, ((gs_memory_t *)((i_ctx_p->memory).current)))) < 0
        )
        return ((code < 0 ? code : (-15)));
    templat.client_data = pdata;
    code = gs_make_pattern(&cc_instance,
                           (const gs_pattern_template_t *)&templat,
                           &mat, (i_ctx_p->pgs), ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (code < 0) {
        ((((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_object(((gs_memory_t *)((i_ctx_p->memory).current)), pdata, "int_pattern"));
        return code;
    }
    ((op - 1)->value.pstruct = ((obj_header_t *)(cc_instance.pattern)), ((op - 1)->tas.type_attrs = ((t_struct) << 8) + (((0x20 + 0x40)) | (((&(i_ctx_p->memory)))->current_space))) );
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return code;
}
...
shading_param(const_os_ptr op, const gs_shading_t ** ppsh)
{
    ...
    if (!(((op)->tas.type_attrs & ((((1 << 6) - (2)) << 8) + (0))) == (((t_struct) << 8) + (0))) ||
        ((((op)->tas.type_attrs) & ((0x10 + 0x20 +0x40))) == (0x80 | 0x40))
        )
        return ((-20));
...
build_shading(i_ctx_t *i_ctx_p, build_shading_proc_t proc)
{
    ...
    {
        gs_color_space *pcs = gs_currentcolorspace((i_ctx_p->pgs));
        ...
        if (dict_find_string(op, "Background", &pvalue) > 0) {
            gs_client_color *pcc =
                (gs_client_color *)(*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_struct)(((gs_memory_t *)((i_ctx_p->memory).current)), &st_client_color, "build_shading");
            ...
            code = dict_floats_param(((gs_memory_t *)((i_ctx_p->memory).current)), op, "Background",
                                     gs_color_space_num_components(pcs),
                                     pcc->paint.values, ((void*)0));
            if (code < 0) {
    ...
    if (dict_find_string(op, "BBox", &pvalue) <= 0)
    ...
    else if ((code = dict_floats_param(((gs_memory_t *)((i_ctx_p->memory).current)), op, "BBox",
                                       4, box, ((void*)0))) == 4) {
        ...
        params.have_BBox = ((bool)1);
    } else {
        gs_errorinfo_put_pair_from_dict(i_ctx_p, op, "BBox");
        goto fail;
    }
    code = dict_bool_param(op, "AntiAlias", ((bool)0), &params.AntiAlias);
    if (code < 0) {
        gs_errorinfo_put_pair_from_dict(i_ctx_p, op, "AntiAlias");
        goto fail;
    }

    code = (*proc)(i_ctx_p, op, &params, &psh, ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (code < 0)
        goto fail;
    if (gx_color_space_needs_cie_caches(psh->params.ColorSpace)) {
        do { if (psh->params.cie_joint_caches) { do { do { } while (0); (psh->params.cie_joint_caches)->rc.ref_count += (-1); } while (0); if (!(psh->params.cie_joint_caches)->rc.ref_count) { do { do { } while (0); (psh->params.cie_joint_caches)->rc.free((psh->params.cie_joint_caches)->rc.memory, (void *)(psh->params.cie_joint_caches), "build_shading"); } while (0); (psh->params.cie_joint_caches) = 0; } else do { } while (0); } } while (0);
        psh->params.cie_joint_caches = gx_currentciecaches((i_ctx_p->pgs));
        do { if (psh->params.cie_joint_caches) do { (psh->params.cie_joint_caches)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    }
    ((op)->value.pstruct = ((obj_header_t *)(psh)), ((op)->tas.type_attrs = ((t_struct) << 8) + (((0) | (((&(i_ctx_p->memory)))->current_space))|((&(i_ctx_p->memory))->new_mask))) );
    return code;
fail:
    ((((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_object(((gs_memory_t *)((i_ctx_p->memory).current)), params.Background, "Background"));
                 ...
                 int num_inputs, gs_memory_t *mem, const float *shading_domain)
{
    ...
    *ppfn = 0;
    if (dict_find_string(op, "Function", &pFunction) <= 0)
        return 0;
    if ((((pFunction)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0)))) {
        uint size = ((pFunction)->tas.rsize);
        gs_function_t **Functions;
        uint i;
        gs_function_AdOt_params_t params;

        do { if ( !(((&*pFunction)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
        if (size == 0)
            return ((-15));
        ...
        for (i = 0; i < size; ++i) {
            ...
            array_get(((gs_memory_t *)((i_ctx_p->memory).current)), pFunction, (long)i, &rsubfn);
        ...
        if ((*ppfn)->params.m != num_inputs) {
            ((*ppfn)->head.procs.free(*ppfn, ((bool)1), mem));
            return ((-15));
        }
    }
    return code;
                ...
                gs_shading_t ** ppsh, gs_memory_t *mem)
{
    ...
    *(gs_shading_params_t *)&params = *pcommon;
    ...
    if (dict_find_string(op, "Matrix", &pmatrix) > 0 ) {
        code = read_matrix(((gs_memory_t *)((i_ctx_p->memory).current)), pmatrix, &params.Matrix);
        if (code < 0) {
 ...
 out:;
    if (code < 0 && params.Function)
        ((mem)->procs.free_object(mem, params.Function, "Function"));
    return code;
}
...
{
    int code = dict_floats_param(((gs_memory_t *)((i_ctx_p->memory).current)), op, "Coords",
                                 num_Coords, Coords, ((void*)0));
    ...
    *pFunction = 0;
    ...
    if (dict_find_string(op, "Extend", &pExtend) <= 0)
        Extend[0] = Extend[1] = ((bool)0);
    else {
        ref E0, E1;

        if (!(((pExtend)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0))))
            return ((-20));
        else if (((pExtend)->tas.rsize) != 2)
            return ((-15));
        else if ((array_get(((gs_memory_t *)((i_ctx_p->memory).current)), pExtend, 0L, &E0),
                  !((((const byte *)&((&E0)->tas.type_attrs))[1]) == (t_boolean))) ||
                 (array_get(((gs_memory_t *)((i_ctx_p->memory).current)), pExtend, 1L, &E1),
                  !((((const byte *)&((&E1)->tas.type_attrs))[1]) == (t_boolean)))
            )
            return ((-20));
                   ...
                   gs_memory_t *mem)
{
    ...
    *pFunction = 0;
    if (dict_find_string(op, "DataSource", &pDataSource) <= 0)
        return ((-15));
    if ((((pDataSource)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0)))) {
        uint size = ((pDataSource)->tas.rsize);

        data = (float *)(*(mem)->procs.alloc_byte_array)(mem, size, sizeof(float), "build_mesh_shading");

        if (data == 0)
            return ((-25));
        code = process_float_array(mem, pDataSource, size, data);
        if (code < 0) {
            ((mem)->procs.free_object(mem, data, "build_mesh_shading"));
            return code;
        }
        ((&params->DataSource)->type = data_source_type_floats, (&params->DataSource)->data.str.data = (byte *)data, (&params->DataSource)->data.str.size = (size) * sizeof(float), (&params->DataSource)->access = data_source_access_bytes);
    } else
        switch ((((const byte *)&((pDataSource)->tas.type_attrs))[1])) {
            case t_file: {
                stream *s;

                do { if ( !(((&*(pDataSource))->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x20))) == (((t_file) << 8) + (0x20))) ) return ((!((((const byte *)&((&*(pDataSource))->tas.type_attrs))[1]) == (t_file)) ? check_type_failed(&*(pDataSource)) : (-7))); do { s = (pDataSource)->value.pfile; if (s->read_id != ((pDataSource)->tas.rsize)) { if (s->read_id == 0 && s->write_id == ((pDataSource)->tas.rsize)) { int fcode = file_switch_to_read(pDataSource); if (fcode < 0) return(fcode); } else { s = (i_ctx_p->invalid_file_stream); } } } while (0); } while (0);
                ((&params->DataSource)->type = data_source_type_stream, (&params->DataSource)->data.strm = s, (&params->DataSource)->access = data_source_access_stream);
                break;
            }
            case t_string:
                do { if ( !(((&*pDataSource)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
                ((&params->DataSource)->type = data_source_type_string, (&params->DataSource)->data.str.data = pDataSource->value.bytes, (&params->DataSource)->data.str.size = ((pDataSource)->tas.rsize), (&params->DataSource)->access = data_source_access_string);
    ...
    code = build_shading_function(i_ctx_p, op, pFunction, 1, mem, ((void*)0));
    if (code < 0) {
        ((mem)->procs.free_object(mem, data, "build_mesh_shading"));
        return code;
    }
    if (((params->DataSource).type == data_source_type_floats)) {
        ...
        if ((code = dict_int_param(op, "BitsPerCoordinate", 1, 32, 0,
            ...
            *pDecode = (float *)
                (*(mem)->procs.alloc_byte_array)(mem, num_decode, sizeof(float), "build_mesh_shading");

            if (*pDecode == 0)
                code = ((-25));
            else {
                code = dict_floats_param(mem, op, "Decode", num_decode, *pDecode, ((void*)0));
                if (code < 0) {
                    ((mem)->procs.free_object(mem, *pDecode, "build_mesh_shading"));
                    *pDecode = 0;
                }
            }
        }
    ...
    if (code < 0) {
        if (*pFunction != 0) {
            ((*pFunction)->head.procs.free(*pFunction, ((bool)1), mem));
            *pFunction = 0;
        }
        ((mem)->procs.free_object(mem, data, "build_mesh_shading"));
    }
                ...
                gs_shading_t ** ppsh, gs_memory_t *mem)
{
    ...
    *(gs_shading_params_t *)&params = *pcommon;
    if ((code =
        ...
        ((mem)->procs.free_object(mem, params.Function, "Function"));
        ((mem)->procs.free_object(mem, params.Decode, "Decode"));
    }
    return code;
}
    ...
    *(gs_shading_params_t *)&params = *pcommon;
    if ((code =
         build_mesh_shading(i_ctx_p, op, (gs_shading_mesh_params_t *)&params,
                            &params.Decode, &params.Function, mem)) < 0 ||
        (code = check_indexed_vs_function(i_ctx_p, op, params.ColorSpace, params.Function)) < 0 ||
        (code = dict_int_param(op, "VerticesPerRow", 2, (~(-1 << ((1 << 2) * 8 - 1))), 0,
