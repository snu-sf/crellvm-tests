...
int file_close_finish(stream *);
int file_close_disable(stream *);
# 26 "./base/gximage4.c" 2


static int gx_begin_image4(gx_device *dev, const gs_imager_state *pis, const gs_matrix *pmat, const gs_image_common_t *pim, const gs_int_rect *prect, const gx_drawing_color *pdcolor, const gx_clip_path *pcpath, gs_memory_t *memory, gx_image_enum_common_t **pinfo);


extern const gs_memory_struct_type_t st_gs_pixel_image; static const gc_struct_data_t image4_reloc_ptrs = { 0, 0, &st_gs_pixel_image, 0 }; static const gs_memory_struct_type_t st_gs_image4 = { sizeof(gs_image4_t), "gs_image4_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &image4_reloc_ptrs };


static int gx_image4_sput(const gs_image_common_t *pic, stream *s, const gs_color_space **ppcs);
static int gx_image4_sget(gs_image_common_t *pic, stream *s, gs_color_space *pcs);
static void gx_image4_release(gs_image_common_t *pic, gs_memory_t *mem);
                ...
                gs_memory_t * mem, gx_image_enum_common_t ** pinfo)
{
...

    {
        ...
        int spp = (*(pim->ColorSpace)->type->num_components)(pim->ColorSpace);
        int i;
        ...
        for (i = 0; i < spp * 2; i += 2) {
            ...
            if ((c0 | c1) > max_value) {
                ((mem)->procs.free_object(mem, penum, "gx_begin_image4"));
                return ((-15));
            }
            if (c0 > c1) {
                opaque = ((bool)1);
