...
static
gs_ptr_type_t device_printer_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gx_device_printer *pdev = vptr; switch ( index ) { default:
    if (((gx_device_printer *)(pdev)->buffer_space != 0))
        return (*(st_device_clist).enum_ptrs)(mem, vptr, size, index-(0), pep, &(st_device_clist), gcst);
    else
        return (*(st_device_forward).enum_ptrs)(mem, vptr, size, index-(0), pep, &(st_device_forward), gcst);
} }
static
void device_printer_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gx_device_printer *pdev = vptr;
{
    if (((gx_device_printer *)(pdev)->buffer_space != 0))
        (*(st_device_clist).reloc_ptrs)(vptr, size, &(st_device_clist), gcst);
    else
        (*(st_device_forward).reloc_ptrs)(vptr, size, &(st_device_forward), gcst);
} }
const gs_memory_struct_type_t st_device_printer = { sizeof(gx_device_printer), "gx_device_printer", 0, 0, device_printer_enum_ptrs, device_printer_reloc_ptrs, gx_device_finalize, 0 };




const gx_device_procs prn_std_procs =
    { gdev_prn_open, ((void*)0), ((void*)0), gdev_prn_output_page, gdev_prn_close, gx_default_b_w_map_rgb_color, gx_default_b_w_map_color_rgb, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), gdev_prn_get_params, gdev_prn_put_params, ((void*)0), ((void*)0), ((void*)0), ((void*)0), gx_page_device_get_page_device, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), gx_default_b_w_map_rgb_color, gx_default_b_w_map_color_rgb, ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), ((void*)0), gdev_prn_dev_spec_op, ((void*)0), gx_default_get_profile, gx_default_set_graphics_type_tag };
...
extern int clist_open(gx_device *dev);
...
gdev_prn_open(gx_device * pdev)
{
    ...
    ppdev->file = ((void*)0);
    code = gdev_prn_allocate_memory(pdev, ((void*)0), 0, 0);
    if (code < 0)
        return code;
...
prn_finish_bg_print(gx_device_printer *ppdev)
{
    ...
    if (ppdev->bg_print.device != ((void*)0)) {
        int closecode;
        gp_semaphore_wait(&(ppdev->bg_print.sema)->native);
        ...
        teardown_device_and_mem_for_thread(ppdev->bg_print.device,
                                           ppdev->bg_print.thread_id, ((bool)1));
        ppdev->bg_print.device = ((void*)0);
    }
}
...
# 185 "./base/gdevprn.c"
    for ( space = space_params->BufferSpace; ; ) {
        base = (reallocate ?
                (byte *)((buffer_memory)->procs.resize_object(buffer_memory, *the_memory, space, "cmd list buffer")) :

                (*(buffer_memory)->procs.alloc_bytes)(buffer_memory, space, "cmd list buffer"));

        if (base != 0)
            break;
        if (bufferSpace_is_exact || (space >>= 1) < 10000)
            break;
    }
    if (base == 0)
        return ((-25));
...
open_c:
    ...
    do { (pclist_dev)->common.data = (base); (pclist_dev)->common.data_size = (space); (pclist_dev)->common.target = (pdev); (pclist_dev)->common.buf_procs = (ppdev->printer_procs.buf_procs); (pclist_dev)->common.band_params = (space_params->band); (pclist_dev)->common.do_not_open_or_close_bandfiles = (((bool)0)); (pclist_dev)->common.bandlist_memory = ((ppdev->bandlist_memory == 0 ? pdev->memory->non_gc_memory: ppdev->bandlist_memory)); (pclist_dev)->writer.free_up_bandlist_memory = (ppdev->free_up_bandlist_memory); (pclist_dev)->writer.disable_mask = (ppdev->clist_disable_mask); (pclist_dev)->writer.page_uses_transparency = (ppdev->page_uses_transparency); (pclist_dev)->writer.pinst = ((void*)0); } while (0);
# 216 "./base/gdevprn.c"
    ...
    if (code < 0) {
        ...
        if ( code == (-15) &&
            ...
            space <<= 1;
            if (reallocate) {
                base = ((buffer_memory)->procs.resize_object(buffer_memory, *the_memory, space, "cmd list buf(retry open)"));


                if (base != 0)
                    *the_memory = base;
            } else {
                ((buffer_memory)->procs.free_object(buffer_memory, base, "cmd list buf(retry open)"));

                *the_memory = base =
                    (*(buffer_memory)->procs.alloc_bytes)(buffer_memory, space, "cmd list buf(retry open)");
        ...
        if (!reallocate) {
            ((buffer_memory)->procs.free_object(buffer_memory, base, "cmd list buf"));
...
gdev_prn_tear_down(gx_device *pdev, byte **the_memory)
{
    ...
    if (((gx_device_printer *)(ppdev)->buffer_space != 0)) {

        (*gs_clist_device_procs.close_device)( (gx_device *)pcldev );
        *the_memory = ppdev->buf;
        ppdev->buf = 0;
        ppdev->buffer_space = 0;
        was_command_list = ((bool)1);




        if (!((pclist_dev)->common.ymin < 0))
            ((pcrdev->memory)->procs.free_object(pcrdev->memory, pcrdev->color_usage_array, "clist_color_usage_array"));

    } else {

        *the_memory = pmemdev->base;
        pmemdev->base = 0;
        was_command_list = ((bool)0);
    }


    if (ppdev->orig_procs.open_device != 0)
        pdev->procs = ppdev->orig_procs;
    ppdev->orig_procs.open_device = 0;
                  ...
                  int new_width, int new_height, bool reallocate)
{
    ...
    int save_width = 0x0badf00d;
    int save_height = 0x0badf00d;
    bool is_command_list = ((bool)0);
    bool save_is_command_list = ((bool)0);
    bool size_ok = 0;
    int ecode = 0;
    int pass;
    ...
    for ( pass = 1; pass <= (reallocate ? 2 : 1); ++pass ) {
        ...
        byte *base = 0;
        bool bufferSpace_is_default = ((bool)0);
        ...
        size_ok = ppdev->printer_procs.buf_procs.size_buf_device
            (&buf_space, pdev, ((void*)0), pdev->height, ((bool)0)) >= 0;
        mem_space = buf_space.bits + buf_space.line_ptrs;
        if (ppdev->page_uses_transparency) {
            pdf14_trans_buffer_size = ((3 * (((((1) > (pdev->width)) ? (1) : (pdev->width))) * 8 * (1 + 4))) >> 3);
            if (new_height < (((unsigned long)~0L + (unsigned long)0) - mem_space) / pdf14_trans_buffer_size) {
        ...
        if (!is_command_list) {
            ...
            base =
                (reallocate ?
                 (byte *)((buffer_memory)->procs.resize_object(buffer_memory, the_memory, (uint)mem_space, "printer buffer")) :

                 (*(buffer_memory)->procs.alloc_bytes)(buffer_memory, (uint)mem_space, "printer_buffer"));

            if (base == 0)
                is_command_list = ((bool)1);
            else
                the_memory = base;
        }
        if (!is_command_list && pass == 1 && 500000L != 0
            && buffer_memory == pdev->memory->non_gc_memory) {

            byte * left = (*(buffer_memory)->procs.alloc_bytes)(buffer_memory, 500000L, "printer mem left");

            if (left == 0)
                is_command_list = ((bool)1);
            else
                ((buffer_memory)->procs.free_object(buffer_memory, left, "printer mem left"));
        }
        ...
        if (is_command_list) {
            ...
            int code;
            if (!reallocate) {
                ((buffer_memory)->procs.free_object(buffer_memory, the_memory, "printer buffer(open)"));
            ...
            if ((code = gdev_create_buf_device
                 (ppdev->printer_procs.buf_procs.create_buf_device,
                  &bdev, pdev, 0, ((void*)0), ((void*)0), ((void*)0))) < 0 ||
                ...
                ((buffer_memory)->procs.free_object(buffer_memory, base, "printer buffer"));
                pdev->procs = ppdev->orig_procs;
                ppdev->orig_procs.open_device = 0;
                return (code);
            }
    ...
    if (ecode >= 0 || reallocate) {




        ((ppdev)->procs.get_initial_matrix = (ppdev->orig_procs.get_initial_matrix));
        ((ppdev)->procs.output_page = (ppdev->orig_procs.output_page));
        ((ppdev)->procs.close_device = (ppdev->orig_procs.close_device));
        ((ppdev)->procs.map_rgb_color = (ppdev->orig_procs.map_rgb_color));
        ((ppdev)->procs.map_color_rgb = (ppdev->orig_procs.map_color_rgb));
        ((ppdev)->procs.get_params = (ppdev->orig_procs.get_params));
        ((ppdev)->procs.put_params = (ppdev->orig_procs.put_params));
        ((ppdev)->procs.map_cmyk_color = (ppdev->orig_procs.map_cmyk_color));
        ((ppdev)->procs.get_xfont_procs = (ppdev->orig_procs.get_xfont_procs));
        ((ppdev)->procs.get_xfont_device = (ppdev->orig_procs.get_xfont_device));
        ((ppdev)->procs.map_rgb_alpha_color = (ppdev->orig_procs.map_rgb_alpha_color));


        ((ppdev)->procs.get_page_device = (gx_page_device_get_page_device));
        ((ppdev)->procs.get_clipping_box = (ppdev->orig_procs.get_clipping_box));
        ((ppdev)->procs.map_color_rgb_alpha = (ppdev->orig_procs.map_color_rgb_alpha));
        ((ppdev)->procs.get_hardware_params = (ppdev->orig_procs.get_hardware_params));
        ((ppdev)->procs.get_color_mapping_procs = (ppdev->orig_procs.get_color_mapping_procs));
        ((ppdev)->procs.get_color_comp_index = (ppdev->orig_procs.get_color_comp_index));
        ((ppdev)->procs.encode_color = (ppdev->orig_procs.encode_color));
        ((ppdev)->procs.decode_color = (ppdev->orig_procs.decode_color));
        ((ppdev)->procs.update_spot_equivalent_colors = (ppdev->orig_procs.update_spot_equivalent_colors));
        ((ppdev)->procs.ret_devn_params = (ppdev->orig_procs.ret_devn_params));

        if ( ((ppdev)->procs.put_image) == 0 ) ((ppdev)->procs.put_image = (ppdev->orig_procs.put_image));
...
gdev_prn_free_memory(gx_device *pdev)
{
    ...
    ((buffer_memory)->procs.free_object(buffer_memory, the_memory, "gdev_prn_free_memory"));
    return 0;
}
...
gdev_prn_get_params(gx_device * pdev, gs_param_list * plist)
{
    ...
    if (clist_io_procs_file_global == ((void*)0))
        ppdev->BLS_force_memory = ((bool)1);
    if (ppdev->BLS_force_memory) {
        bls.data = (byte *)"memory";
        bls.size = 6;
        bls.persistent = ((bool)0);
    } else {
        bls.data = (byte *)"file";
        bls.size = 4;
        bls.persistent = ((bool)0);
    ...
    switch (code = param_read_string(plist, (param_name = "BandListStorage"), &bls)) {
        case 0:
            ...
            if ((bls.size > 1) && (bls.data[0] == 'm' ||
                 (clist_io_procs_file_global != ((void*)0) && bls.data[0] == 'f')))
                break;
...
# 732 "./base/gdevprn.c"
    switch ( code = (*(plist)->procs->begin_xmit_collection)(plist, (param_name = "InputAttributes"), &mdict, (((bool)1) ? gs_param_collection_dict_int_keys : gs_param_collection_dict_any)) ) { case 0: (*(plist)->procs->end_xmit_collection)(plist, "InputAttributes", &mdict); break; default: ecode = code; (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: ; };
    switch ( code = (*(plist)->procs->begin_xmit_collection)(plist, (param_name = "OutputAttributes"), &mdict, (((bool)1) ? gs_param_collection_dict_int_keys : gs_param_collection_dict_any)) ) { case 0: (*(plist)->procs->end_xmit_collection)(plist, "OutputAttributes", &mdict); break; default: ecode = code; (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: ; };
...
gdev_prn_output_page_aux(gx_device * pdev, int num_copies, int flush, bool seekable, bool bg_print_ok)
{
    ...
    bool upgraded_copypage = ((bool)0);
    int code;

    prn_finish_bg_print(ppdev);

    if (num_copies > 0 && ppdev->saved_pages_list != ((void*)0)) {
        ...
        if ( !flush &&
            ...
            upgraded_copypage = ((bool)1);
            flush = ((bool)1);

        } else if (num_copies > 0) {
            int threads_enabled = 0;
            int print_foreground = 1;

            if (bg_print_ok && ((gx_device_printer *)(ppdev)->buffer_space != 0) &&
            ...
            while (ppdev->bg_print_requested && threads_enabled) {
                ...
                if (ppdev->bg_print.sema == ((void*)0))
                    if (((ppdev->bg_print.sema = gx_semaphore_alloc(ppdev->memory->non_gc_memory)) == ((void*)0)))
                        break;

                ndev = setup_device_and_mem_for_thread(pdev->memory->thread_safe_memory, pdev, ((bool)1), ((void*)0));
                if (ndev == ((void*)0)) {
                    break;
                }
                ...
                if ((code = crdev->page_info.io_procs->fclose(crdev->page_info.cfile, crdev->page_info.cfname, ((bool)0))) < 0 ||
                    (code = crdev->page_info.io_procs->fclose(crdev->page_info.bfile, crdev->page_info.bfname, ((bool)0))) < 0) {
                    return ((-1));
                }
                crdev->page_info.cfile = crdev->page_info.bfile = ((void*)0);
                if ((code = clist_open(pdev)) < 0)
            ...
            if (print_foreground) {
                ...
                if (ppdev->bg_print.sema != ((void*)0) && ppdev->bg_print.device != ((void*)0)) {
                ...
                outcode = (*ppdev->printer_procs.print_page_copies)(ppdev, ppdev->file,
                                                          num_copies);
                fflush(ppdev->file);
                errcode = (ferror(ppdev->file) ? ((-12)) : 0);
    ...
    pdevn_params = ((pdev)->procs.ret_devn_params)(pdev);
    if (pdevn_params != ((void*)0)) {

        free_separation_names(pdev->memory, &(pdevn_params->separations));
        pdevn_params->num_separation_order_names = 0;
    }
    endcode = (((gx_device_printer *)(ppdev)->buffer_space != 0) &&
...
{
    return(gdev_prn_output_page_aux(pdev, num_copies, flush, ((bool)0), ((bool)0)));
}

int
gdev_prn_output_page_seekable(gx_device * pdev, int num_copies, int flush)
{
    return(gdev_prn_output_page_aux(pdev, num_copies, flush, ((bool)1), ((bool)0)));
}

int
gdev_prn_bg_output_page(gx_device * pdev, int num_copies, int flush)
{
    return(gdev_prn_output_page_aux(pdev, num_copies, flush, ((bool)0), ((bool)1)));
}

int
gdev_prn_bg_output_page_seekable(gx_device * pdev, int num_copies, int flush)
{
    return(gdev_prn_output_page_aux(pdev, num_copies, flush, ((bool)1), ((bool)1)));
}
...
prn_print_page_in_background(void *data)
{
    ...
    gp_semaphore_signal(&(bg_print->sema)->native);
}
                             ...
                             const gx_device *dev)
{
    ...
    if (first_bit & 7)
        bits_fill_rectangle(data, first_bit, raster, (uint)((uint)(0) * 0x01010101),
                            -first_bit & 7, height);
}
                               ...
                               bool seekable)
{
    ...
    ppdev->file_is_new = ((bool)1);
    return 0;
}
int
gdev_prn_open_printer(gx_device *pdev, bool binary_mode)
{
    return gdev_prn_open_printer_seekable(pdev, binary_mode, ((bool)0));
}
                         ...
                         gx_color_usage_t *color_usage, int *range_start)
{
    ...
    if (crdev->color_usage_array == ((void*)0)) {
    }
    for (i = start; i < end; ++i) {
    ...
    *range_start = start * band_height;
    return (((end * band_height) < (dev->height)) ? (end * band_height) : (dev->height)) - *range_start;
}
int
                     ...
                     gx_color_usage_t *color_usage, int *range_start)
{
    ...
    if (!((gx_device_printer *)(pdev)->buffer_space != 0)) {
        *range_start = 0;
        color_usage->or = (((gx_color_usage_bits)1 << (dev)->color_info.num_components) - 1);
        return dev->height;
    }
    if (y < 0 || height < 0 || height > dev->height - y)
        return -1;
    ...
    const gx_render_plane_t *render_plane, gs_memory_t *mem, gx_color_usage_t *color_usage)
{
    ...
    if (mdproto == 0)
        return ((-15));
    if (mem) {
        mdev = (gx_device_memory *)(*(mem)->procs.alloc_struct)(mem, &st_device_memory, "create_buf_device");
    ...
    if (target == (gx_device *)mdev) {
        ...
        ((mdev)->procs = (mdproto)->procs);
        check_device_separable((gx_device *)mdev);

        if (mdev->procs.dev_spec_op == ((void*)0))
            ((mdev)->procs.dev_spec_op = (gdev_prn_dev_spec_op));
        ...
        gs_make_mem_device(mdev, mdproto, mem, (color_usage == ((void*)0) ? 1 : 0),
                           target);
    }
    ...
    if (plane_index >= 0) {
        gx_device_plane_extract *edev =
            (gx_device_plane_extract *)(*(mem)->procs.alloc_struct)(mem, &st_device_plane_extract, "create_buf_device");
    ...
    if (&bdev->color_info != &target->color_info)
                           ...
                           int height, bool not_used)
{
    ...
    space->raster = gx_device_raster((const gx_device *)(&mdev), ((bool)1));
    return 0;
}
                            ...
                            int full_height)
{
    ...
    if (ptrs == 0) {
        ...
        if (mdev->line_ptrs != ((void*)0))
            ((mdev->line_pointer_memory)->procs.free_object(mdev->line_pointer_memory, mdev->line_ptrs, "mem_close"));
        ...
        ptrs = (byte **)
            (*(mdev->memory)->procs.alloc_byte_array)(mdev->memory, (mdev->is_planar ? full_height * mdev->color_info.num_components : setup_height), sizeof(byte *), "setup_buf_device");
...
gx_default_destroy_buf_device(gx_device *bdev)
{
    ...
    if (!gs_device_is_memory(bdev)) {
        ...
        ((bdev->memory)->procs.free_object(bdev->memory, bdev, "destroy_buf_device"));
    }

    ((mdev)->procs.close_device)(mdev);
    ((mdev->memory)->procs.free_object(mdev->memory, mdev, "destroy_buf_device"));
}
