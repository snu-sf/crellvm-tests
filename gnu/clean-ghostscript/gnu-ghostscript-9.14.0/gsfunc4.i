...
static const gc_ptr_element_t function_PtCr_enum_ptrs[] = { { GC_ELT_STRING, ((int) ( (char *)&((gs_function_PtCr_t *)0)->params.ops - (char *)((gs_function_PtCr_t *)0) )) } }; static const gc_struct_data_t function_PtCr_reloc_ptrs = { (sizeof(function_PtCr_enum_ptrs) / sizeof((function_PtCr_enum_ptrs)[0])), 0, &st_function, function_PtCr_enum_ptrs }; static const gs_memory_struct_type_t st_function_PtCr = { sizeof(gs_function_PtCr_t), "gs_function_PtCr_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &function_PtCr_reloc_ptrs };
# 49 "./base/gsfunc4.c"
typedef enum {
    CVT_NONE = 0,
    CVT_BOOL,
...
# 162 "./base/gsfunc4.c"
        {{PtCr_typecheck,PtCr_typecheck,PtCr_abs_int,PtCr_abs, PtCr_typecheck,PtCr_typecheck,PtCr_abs_int,PtCr_abs, PtCr_typecheck,PtCr_typecheck,PtCr_abs_int,PtCr_abs, PtCr_typecheck,PtCr_typecheck,PtCr_abs_int,PtCr_abs}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_add_int,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_add}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_and,PtCr_and,PtCr_typecheck, PtCr_typecheck,PtCr_and,PtCr_and,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_int2_to_float,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_atan}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_bitshift,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_ceiling, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_ceiling, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_ceiling, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_ceiling}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_cos, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_cos, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_cos, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_cos}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_cvi, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_cvi, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_cvi, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_cvi}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_no_op, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_no_op, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_no_op, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_no_op}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_int2_to_float,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_div}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_int2_to_float,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_exp}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_floor, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_floor, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_floor, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_floor}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_idiv,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_ln, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_ln, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_ln, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_ln}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_log, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_log, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_log, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_log}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_mod,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_mul_int,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_mul}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_neg_int,PtCr_neg, PtCr_typecheck,PtCr_typecheck,PtCr_neg_int,PtCr_neg, PtCr_typecheck,PtCr_typecheck,PtCr_neg_int,PtCr_neg, PtCr_typecheck,PtCr_typecheck,PtCr_neg_int,PtCr_neg}},
        {{PtCr_typecheck,PtCr_not,PtCr_not,PtCr_typecheck, PtCr_typecheck,PtCr_not,PtCr_not,PtCr_typecheck, PtCr_typecheck,PtCr_not,PtCr_not,PtCr_typecheck, PtCr_typecheck,PtCr_not,PtCr_not,PtCr_typecheck}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_or,PtCr_or,PtCr_typecheck, PtCr_typecheck,PtCr_or,PtCr_or,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_round, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_round, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_round, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_round}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_sin, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_sin, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_sin, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_sin}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_sqrt, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_sqrt, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_sqrt, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_sqrt}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_sub_int,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_sub}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_truncate, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_truncate, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_truncate, PtCr_typecheck,PtCr_typecheck,PtCr_no_op,PtCr_truncate}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_xor,PtCr_xor,PtCr_typecheck, PtCr_typecheck,PtCr_xor,PtCr_xor,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck}},



        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_eq_int,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_eq_int,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_eq}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_ge_int,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_ge}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_gt_int,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_gt}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_le_int,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_le}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_lt_int,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_lt}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_ne_int,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_ne_int,PtCr_2nd_int_to_float, PtCr_typecheck,PtCr_typecheck,PtCr_int_to_float,PtCr_ne}},



        {{PtCr_typecheck,PtCr_typecheck,PtCr_copy,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_copy,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_copy,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_copy,PtCr_typecheck}},
        {{PtCr_typecheck,PtCr_dup,PtCr_dup,PtCr_dup, PtCr_typecheck,PtCr_dup,PtCr_dup,PtCr_dup, PtCr_typecheck,PtCr_dup,PtCr_dup,PtCr_dup, PtCr_typecheck,PtCr_dup,PtCr_dup,PtCr_dup}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_exch,PtCr_exch,PtCr_exch, PtCr_typecheck,PtCr_exch,PtCr_exch,PtCr_exch, PtCr_typecheck,PtCr_exch,PtCr_exch,PtCr_exch}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_index,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_index,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_index,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_index,PtCr_typecheck}},
        {{PtCr_typecheck,PtCr_pop,PtCr_pop,PtCr_pop, PtCr_typecheck,PtCr_pop,PtCr_pop,PtCr_pop, PtCr_typecheck,PtCr_pop,PtCr_pop,PtCr_pop, PtCr_typecheck,PtCr_pop,PtCr_pop,PtCr_pop}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_roll,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_typecheck,PtCr_typecheck}},



        {{PtCr_byte,PtCr_byte,PtCr_byte,PtCr_byte, PtCr_byte,PtCr_byte,PtCr_byte,PtCr_byte, PtCr_byte,PtCr_byte,PtCr_byte,PtCr_byte, PtCr_byte,PtCr_byte,PtCr_byte,PtCr_byte}},
        {{PtCr_int,PtCr_int,PtCr_int,PtCr_int, PtCr_int,PtCr_int,PtCr_int,PtCr_int, PtCr_int,PtCr_int,PtCr_int,PtCr_int, PtCr_int,PtCr_int,PtCr_int,PtCr_int}},
        {{PtCr_float,PtCr_float,PtCr_float,PtCr_float, PtCr_float,PtCr_float,PtCr_float,PtCr_float, PtCr_float,PtCr_float,PtCr_float,PtCr_float, PtCr_float,PtCr_float,PtCr_float,PtCr_float}},
        {{PtCr_true,PtCr_true,PtCr_true,PtCr_true, PtCr_true,PtCr_true,PtCr_true,PtCr_true, PtCr_true,PtCr_true,PtCr_true,PtCr_true, PtCr_true,PtCr_true,PtCr_true,PtCr_true}},
        {{PtCr_false,PtCr_false,PtCr_false,PtCr_false, PtCr_false,PtCr_false,PtCr_false,PtCr_false, PtCr_false,PtCr_false,PtCr_false,PtCr_false, PtCr_false,PtCr_false,PtCr_false,PtCr_false}},



        {{PtCr_typecheck,PtCr_if,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_if,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_if,PtCr_typecheck,PtCr_typecheck, PtCr_typecheck,PtCr_if,PtCr_typecheck,PtCr_typecheck}},
        {{PtCr_else,PtCr_else,PtCr_else,PtCr_else, PtCr_else,PtCr_else,PtCr_else,PtCr_else, PtCr_else,PtCr_else,PtCr_else,PtCr_else, PtCr_else,PtCr_else,PtCr_else,PtCr_else}},
        {{PtCr_return,PtCr_return,PtCr_return,PtCr_return, PtCr_return,PtCr_return,PtCr_return,PtCr_return, PtCr_return,PtCr_return,PtCr_return,PtCr_return, PtCr_return,PtCr_return,PtCr_return,PtCr_return}},
        {{PtCr_typecheck,PtCr_typecheck,PtCr_repeat,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_repeat,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_repeat,PtCr_typecheck, PtCr_typecheck,PtCr_typecheck,PtCr_repeat,PtCr_typecheck}},
        {{PtCr_repeat_end,PtCr_repeat_end,PtCr_repeat_end,PtCr_repeat_end, PtCr_repeat_end,PtCr_repeat_end,PtCr_repeat_end,PtCr_repeat_end, PtCr_repeat_end,PtCr_repeat_end,PtCr_repeat_end,PtCr_repeat_end, PtCr_repeat_end,PtCr_repeat_end,PtCr_repeat_end,PtCr_repeat_end}}
    };

    vstack[-1].type = CVT_NONE;
    vstack[0].type = CVT_NONE;
    ...
    sw:
        ...
        case PtCr_bitshift:
            ...
            if (vsp->value.i < -((1 << 2) * 8 - 1) || vsp->value.i > ((1 << 2) * 8 - 1))
                vsp[-1].value.i = 0;
        ...
        case PtCr_idiv:
            if (vsp->value.i == 0)
                return ((-23));
            if ((vsp[-1].value.i /= vsp->value.i) == (-1 << ((1 << 2) * 8 - 1)) &&
                vsp->value.i == -1)
                return ((-15));
            --vsp; continue;
        case PtCr_ln:
        ...
        case PtCr_mul_int: {
            ...
            if (prod < (-1 << ((1 << 2) * 8 - 1)) || prod > (~(-1 << ((1 << 2) * 8 - 1))))
        ...
        case PtCr_eq_int:
            vsp[-1].value.i = vsp[-1].value.i == vsp->value.i;
            goto rel;
        case PtCr_eq:
            vsp[-1].value.i = vsp[-1].value.f == vsp->value.f;
        rel:
            vsp[-1].type = CVT_BOOL;
            --vsp; continue;
        case PtCr_ge_int:
        ...
        case PtCr_float :
            ...
            goto push;
        case PtCr_true:
            vsp[1].value.i = ((bool)1), vsp[1].type = CVT_BOOL;
            goto push;
        case PtCr_false:
            vsp[1].value.i = ((bool)0), vsp[1].type = CVT_BOOL;
        push:
            if (vsp == &vstack[256])
                return ((-13));
            ++vsp;
        ...
        case PtCr_repeat:
            ...
            repeat_proc_size[repeat_nesting_level] = 1 + (p[0] << 8) + p[1];
            --vsp;
            p += 3 + (p[0] <<8) + p[1];
            ...
            byte *buf, const byte **ptr)
{
    const gs_function_PtCr_t *const pfn =
        (const gs_function_PtCr_t *)
          ((const char *)psrc - ((int) ( (char *)&((gs_function_PtCr_t *)0)->data_source - (char *)((gs_function_PtCr_t *)0) )));
# 682 "./base/gsfunc4.c"
    stream_SFD_state st;
    stream ds, bs;
    byte dbuf[200];
    ...
    s_init(&ds, ((void*)0));
    s_init_state((stream_state *)&st, templat, ((void*)0));
                    ...
                    const gs_range_t *pranges, gs_memory_t *mem)
{
    gs_function_PtCr_t *psfn =
        (gs_function_PtCr_t *)(*(mem)->procs.alloc_struct)(mem, &st_function_PtCr, "fn_PtCr_make_scaled");


    int n = pfn->params.n;
    uint opsize = pfn->params.ops.size + (9 + 2 * sizeof(float)) * n;
    byte *ops = (*(mem)->procs.alloc_string)(mem, opsize, "fn_PtCr_make_scaled(ops)");
    byte *p;
    int code, i;

    if (psfn == 0 || ops == 0) {
        (*(mem)->procs.free_string)(mem, ops, opsize, "fn_PtCr_make_scaled(ops)");
        ((mem)->procs.free_object(mem, psfn, "fn_PtCr_make_scaled"));
        return ((-25));
    }
    ...
    memcpy(ops, pfn->params.ops.data, pfn->params.ops.size - 1);
    ...
    *p++ = PtCr_return;
    ...
    psfn->params.ops.data =
        (*(mem)->procs.resize_string)(mem, ops, opsize, psfn->params.ops.size, "fn_PtCr_make_scaled");
    ...
    *ppfn = 0;
    ...
    }
    {
        gs_function_PtCr_t *pfn =
            (gs_function_PtCr_t *)(*(mem)->procs.alloc_struct)(mem, &st_function_PtCr, "gs_function_PtCr_init");
        ...
        ((&pfn->data_source)->type = data_source_type_string, (&pfn->data_source)->data.str.data = ((void*)0), (&pfn->data_source)->data.str.size = 0, (&pfn->data_source)->access = data_source_access_string);
