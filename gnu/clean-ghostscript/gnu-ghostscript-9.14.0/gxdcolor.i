...
static void gx_dc_no_save_dc(const gx_device_color * pdevc, gx_device_color_saved * psdc);
static const gx_device_halftone * gx_dc_no_get_dev_halftone(const gx_device_color * pdevc);
static int gx_dc_no_load(gx_device_color *pdevc, const gs_imager_state *pis, gx_device *dev, gs_color_select_t select);
static int gx_dc_no_fill_rectangle(const gx_device_color *pdevc, int x, int y, int w, int h, gx_device *dev, gs_logical_operation_t lop, const gx_rop_source_t *source);
static int gx_dc_no_fill_masked(const gx_device_color *pdevc, const byte *data, int data_x, int raster, gx_bitmap_id id, int x, int y, int w, int h, gx_device *dev, gs_logical_operation_t lop, bool invert);
static bool gx_dc_no_equal(const gx_device_color *pdevc1, const gx_device_color *pdevc2);
static int gx_dc_no_write(const gx_device_color *pdevc, const gx_device_color_saved *psdc, const gx_device * dev, int64_t offset, byte *data, uint *psize);
static int gx_dc_no_read(gx_device_color *pdevc, const gs_imager_state * pis, const gx_device_color *prior_devc, const gx_device * dev, int64_t offset, const byte *data, uint size, gs_memory_t *mem);
static int gx_dc_no_get_nonzero_comps(const gx_device_color * pdevc, const gx_device * dev, gx_color_index * pcomp_bits);
...
static int gx_dc_null_load(gx_device_color *pdevc, const gs_imager_state *pis, gx_device *dev, gs_color_select_t select);
static int gx_dc_null_fill_rectangle(const gx_device_color *pdevc, int x, int y, int w, int h, gx_device *dev, gs_logical_operation_t lop, const gx_rop_source_t *source);
static int gx_dc_null_fill_masked(const gx_device_color *pdevc, const byte *data, int data_x, int raster, gx_bitmap_id id, int x, int y, int w, int h, gx_device *dev, gs_logical_operation_t lop, bool invert);
static bool gx_dc_null_equal(const gx_device_color *pdevc1, const gx_device_color *pdevc2);
static int gx_dc_null_read(gx_device_color *pdevc, const gs_imager_state * pis, const gx_device_color *prior_devc, const gx_device * dev, int64_t offset, const byte *data, uint size, gs_memory_t *mem);
...
static void gx_dc_pure_save_dc(const gx_device_color * pdevc, gx_device_color_saved * psdc);
static int gx_dc_pure_load(gx_device_color *pdevc, const gs_imager_state *pis, gx_device *dev, gs_color_select_t select);
static int gx_dc_pure_fill_rectangle(const gx_device_color *pdevc, int x, int y, int w, int h, gx_device *dev, gs_logical_operation_t lop, const gx_rop_source_t *source);
static int gx_dc_pure_fill_masked(const gx_device_color *pdevc, const byte *data, int data_x, int raster, gx_bitmap_id id, int x, int y, int w, int h, gx_device *dev, gs_logical_operation_t lop, bool invert);
static bool gx_dc_pure_equal(const gx_device_color *pdevc1, const gx_device_color *pdevc2);
static int gx_dc_pure_write(const gx_device_color *pdevc, const gx_device_color_saved *psdc, const gx_device * dev, int64_t offset, byte *data, uint *psize);
static int gx_dc_pure_read(gx_device_color *pdevc, const gs_imager_state * pis, const gx_device_color *prior_devc, const gx_device * dev, int64_t offset, const byte *data, uint size, gs_memory_t *mem);
...
static void gx_dc_devn_save_dc(const gx_device_color * pdevc, gx_device_color_saved * psdc);
static int gx_dc_devn_load(gx_device_color *pdevc, const gs_imager_state *pis, gx_device *dev, gs_color_select_t select);
static int gx_dc_devn_fill_rectangle(const gx_device_color *pdevc, int x, int y, int w, int h, gx_device *dev, gs_logical_operation_t lop, const gx_rop_source_t *source);
static bool gx_dc_devn_equal(const gx_device_color *pdevc1, const gx_device_color *pdevc2);
static int gx_dc_devn_write(const gx_device_color *pdevc, const gx_device_color_saved *psdc, const gx_device * dev, int64_t offset, byte *data, uint *psize);
static int gx_dc_devn_read(gx_device_color *pdevc, const gs_imager_state * pis, const gx_device_color *prior_devc, const gx_device * dev, int64_t offset, const byte *data, uint size, gs_memory_t *mem);
...
{
    if (dev->cached_colors.black == ((gx_color_index)(~0))) {
        const gx_cm_color_map_procs * cm_procs = ((dev)->procs.get_color_mapping_procs)(dev);
        int i, ncomps = dev->color_info.num_components;
        frac cm_comps[(8 * 8)];
        gx_color_value cv[(8 * 8)];


        cm_procs->map_gray(dev, ((frac)0), cm_comps);

        for (i = 0; i < ncomps; i++)
            cv[i] = ((ushort)( ((cm_comps[i]) << (((1 << 1) * 8) - 15)) + ((cm_comps[i]) >> (15 * 2 - ((1 << 1) * 8) - 3)) ));

        dev->cached_colors.black = ((dev)->procs.encode_color)(dev, cv);
    }
...
{
    if (dev->cached_colors.white == ((gx_color_index)(~0))) {
        const gx_cm_color_map_procs * cm_procs = ((dev)->procs.get_color_mapping_procs)(dev);
        int i, ncomps = dev->color_info.num_components;
        frac cm_comps[(8 * 8)];
        gx_color_value cv[(8 * 8)];
        ...
        cm_procs->map_gray(dev, ((frac)0x7ff8), cm_comps);

        for (i = 0; i < ncomps; i++)
            cv[i] = ((ushort)( ((cm_comps[i]) << (((1 << 1) * 8) - 15)) + ((cm_comps[i]) >> (15 * 2 - ((1 << 1) * 8) - 3)) ));

        dev->cached_colors.white = ((dev)->procs.encode_color)(dev, cv);
    }
...
{
    dev->cached_colors.black = dev->cached_colors.white = ((gx_color_index)(~0));
}


static const gx_rop_source_t gx_rop_no_source_0 = {((void*)0), 0, 0, 0L, {0, 0}, 0, ((bool)1)};
static const gx_rop_source_t gx_rop_no_source_1 = {((void*)0), 0, 0, 0L, {1, 1}, 0, ((bool)1)};
void
...
top:
    ...
    else if (black == ((gx_color_index)(~0))) {
        ((void)(gx_device_black(dev)));
        goto top;
    } else {
        *pno_source = gx_rop_no_source_0;
        ((pno_source)->scolors[0] = (pno_source)->scolors[1] = (black));
        *psource = pno_source;
    }
}
                        ...
                        const gx_rop_source_t *source)
{
    ...
    if (w <= 0 || h <= 0)
        return 0;
    if ((( ((((lop) << 4) ^ (lop)) & 0xf0) != 0 ) || ((lop) & 0x200)))
        return ((-100));
    ((&filler)->colors.pure = (0), (&filler)->type = (&gx_dc_type_data_pure)); (&filler)->ccolor_valid = ((bool)0);
                          ...
                          const gx_rop_source_t * source)
{
    ...
    rect.p.x = ((fixed)(x)<<8);
    rect.p.y = ((fixed)(y)<<8);
    rect.q.x = ((fixed)(w + x)<<8);
    rect.q.y = ((fixed)(h + y)<<8);
    return (*((dev)->procs.fill_rectangle_hl_color)) (dev, &rect, ((void*)0), pdevc, ((void*)0));
}
                   ...
                   gx_device * dev, gs_logical_operation_t lop, bool invert)
{
    ...
    for (iy = 0; iy < h; ++iy, row += raster) {
        ...
        while (left) {
            ...
            code = (*(pdevc)->type->fill_rectangle)(pdevc, x + w - l0, y + iy, l0 - left, 1, dev, lop, ((void*)0));
...
gx_dc_devn_equal(const gx_device_color * pdevc1, const gx_device_color * pdevc2)
{
    ...
    if (pdevc1->type == (&gx_dc_type_data_devn) && pdevc2->type == (&gx_dc_type_data_devn)) {
        for (k = 0; k < (8 * 8); k++) {
...
gx_dc_pure_fill_rectangle(const gx_device_color * pdevc, int x, int y,
                  int w, int h, gx_device * dev, gs_logical_operation_t lop,
                          const gx_rop_source_t * source)
{
    if (source == ((void*)0) && (((lop) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc)))
        return (*((dev)->procs.fill_rectangle)) (dev, x, y, w, h,
                                                 pdevc->colors.pure);
    {
        ...
        if (source->planar_height == 0)
            return (*((dev)->procs.strip_copy_rop))
                (dev, source->sdata, source->sourcex, source->sraster,
                 source->id, (source->use_scolors ? source->scolors : ((void*)0)),
                 ((void*)0) , colors, x, y, w, h, 0, 0, lop);
        else
            return (*((dev)->procs.strip_copy_rop2))
                (dev, source->sdata, source->sourcex, source->sraster,
                 source->id, (source->use_scolors ? source->scolors : ((void*)0)),
                 ((void*)0) , colors, x, y, w, h, 0, 0, lop, source->planar_height);
    }
}
...
gx_dc_pure_fill_masked(const gx_device_color * pdevc, const byte * data,
        int data_x, int raster, gx_bitmap_id id, int x, int y, int w, int h,
                   gx_device * dev, gs_logical_operation_t lop, bool invert)
{
    if ((((lop) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc))) {
        gx_color_index color0, color1;

        if (invert)
            color0 = pdevc->colors.pure, color1 = ((gx_color_index)(~0));
        else
            color1 = pdevc->colors.pure, color0 = ((gx_color_index)(~0));
        return (*((dev)->procs.copy_mono))
            (dev, data, data_x, raster, id, x, y, w, h, color0, color1);
    } {
        gx_color_index scolors[2];
        gx_color_index tcolors[2];

        if ( lop != (rop3_default | (((bool)0) ? 0x100 : 0) | (((bool)0) ? 0x200 : 0)) ) {
        ...
        return (*((dev)->procs.strip_copy_rop))
            (dev, data, data_x, raster, id, scolors,
             ((void*)0), tcolors, x, y, w, h, 0, 0,
             (invert ? ( (((lop) & 0xcc) >> 2) | (((lop) & (rop3_1 - 0xcc)) << 2) | ((lop) & ~rop3_1) ) : lop) | (0xcc | 0x100));
    }
}
...
{
    return pdevc2->type == pdevc1->type &&
        ((pdevc1)->colors.pure) == ((pdevc2)->colors.pure);
}
# 883 "./base/gxdcolor.c"
static int
gx_dc_pure_write(
...
{
    int code;
    gx_color_value cvals[(8 * 8)];

    code = ((dev)->procs.decode_color)( (gx_device *)dev,
                                         pdevc->colors.pure,
                                         cvals );
    if (code >= 0) {
        int i, ncomps = dev->color_info.num_components;
...
gx_complete_halftone(gx_device_color *pdevc, int num_comps, gx_device_halftone *pdht)
{
    ...
    pdevc->colors.colored.alpha = ((unsigned short)0xffff + (unsigned short)0);
