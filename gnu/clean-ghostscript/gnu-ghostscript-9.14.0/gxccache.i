                      ...
                      gs_fixed_point *subpix_origin)
{
    ...
    while ((cc = dir->ccache.table[chi & dir->ccache.table_mask]) != 0) {
        if (cc->code == glyph && ((cc)->pair) == pair &&
            ...
            cc->wmode == wmode && ((cc)->head.depth) == depth
            ) {
            do { } while (0);
...
gx_image_cached_char(register gs_show_enum * penum, register cached_char * cc)
{
    ...
    gx_device_color *pdevc = ((pgs)->color[0].dev_color);
    int x, y, w, h, depth;
    int code;
    gs_fixed_point pt;
  ...
  top:code = ( !pgs->current_point_valid ? ((-14)) : ((&pt)->x = ((fixed)floor((pgs->current_point.x)*(float)(1<<8) + 0.5)), (&pt)->y = ((fixed)floor((pgs->current_point.y)*(float)(1<<8) + 0.5)), 0) );
    if (code < 0)
        return code;
    ...
    x = ((int)(((pt.x)+((1<<8)>>1)) >> (8))) + penum->ftx;
    pt.y -= cc->offset.y + cc->subpix_origin.y;
    y = ((int)(((pt.y)+((1<<8)>>1)) >> (8))) + penum->fty;
    w = cc->width;
    h = cc->height;
# 222 "./base/gxccache.c"
    ...
    if (xg != ((gx_xglyph)~0L) && (xf = ((cc)->pair)->xfont) != 0) {
        int cx = x + ((int)((cc->offset.x) >> (8)));
        int cy = y + ((int)((cc->offset.y) >> (8)));
        ...
        if ((((((pgs)->color[0].dev_color))->type == (&gx_dc_type_data_pure)) && ((((pgs)->log_op) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc)))) {
        ...
        if (!((cc)->id != 0L)) {
            ...
            if (code != 0)
                return (1);
            gx_add_char_bits(((cc)->pair)->font->dir,
                             cc, &scale_log2_1);
    ...
    bits = ((byte *)(cc) + ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) ));




    depth = (((cc)->head.depth) == 3 ? 2 : ((cc)->head.depth));
    if ((((orig_dev)->procs.fill_mask) != gx_default_fill_mask ||
        !(((pgs->log_op) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc)))) {
        ...
        if (code >= 0) {
            code = gx_image_fill_masked
                (orig_dev, bits, 0, ((cc)->raster), cc->id,
                 x, y, w, h, pdevc, depth, pgs->log_op, pcpath);
            if (code >= 0)
                goto done;
        }
    } else if ((((((pgs)->color[0].dev_color))->type == (&gx_dc_type_data_pure)) && ((((pgs)->log_op) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc)))) {
        gx_color_index color = pdevc->colors.pure;

        if (depth > 1) {
            code = (*((imaging_dev)->procs.copy_alpha))
                (imaging_dev, bits, 0, ((cc)->raster), cc->id,
                 x, y, w, h, color, depth);
            if (code >= 0)
                return (0);
        ...
        code = (*((imaging_dev)->procs.copy_mono))
            (imaging_dev, bits, 0, ((uint)((((w) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3)), 0L,
             x, y, w, h, ((gx_color_index)(~0)), color);
        goto done;
    }
    if (depth > 1) {
        ...
        gs_image_t image;
        int iy;
        uint used, raster = (bits == ((byte *)(cc) + ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) ? ((cc)->raster)
                             : ((uint)((((cc->width) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3)) );
        int code1;

        if (pie == 0) {
            if (bits != ((byte *)(cc) + ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )))
                ((mem)->procs.free_object(mem, bits, "compress_alpha_bits"));
  ...
  done:if (bits != ((byte *)(cc) + ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )))
        ((penum->memory->non_gc_memory)->procs.free_object(penum->memory->non_gc_memory, bits, "compress_alpha_bits"));
    if (code > 0)
        code = 0;
    return (code);
}
...
{
    const byte *data = ((const byte *)(cc) + ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) ));
    uint width = cc->width;
    ...
    int depth = (((cc)->head.depth) == 3 ? 2 : ((cc)->head.depth));
    uint sraster = ((cc)->raster);
    uint sskip = sraster - ((width * depth + 7) >> 3);
    uint draster = ((uint)((((width) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3));
