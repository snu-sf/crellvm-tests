# 1 "./jbig2dec/jbig2_arith_int.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./jbig2dec/jbig2_arith_int.c" 2
# 26 "./jbig2dec/jbig2_arith_int.c"
...
# 27 "./jbig2dec/jbig2_arith_int.c" 2
...
# 29 "./jbig2dec/jbig2_arith_int.c" 2
...
# 30 "./jbig2dec/jbig2_arith_int.c" 2
...
# 32 "./jbig2dec/jbig2_arith_int.c" 2
...
# 33 "./jbig2dec/jbig2_arith_int.c" 2
...
# 34 "./jbig2dec/jbig2_arith_int.c" 2
...
# 35 "./jbig2dec/jbig2_arith_int.c" 2
...
jbig2_arith_int_ctx_new(Jbig2Ctx *ctx)
{
  Jbig2ArithIntCtx *result = ((Jbig2ArithIntCtx *)jbig2_alloc(ctx->allocator, 1, sizeof(Jbig2ArithIntCtx)));
