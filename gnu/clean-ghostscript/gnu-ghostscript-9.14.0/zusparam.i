...
zcheckpassword(i_ctx_t *i_ctx_p)
{
    ...
    int result = 0;
    int code = names_ref(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, (const byte *)"Password", 8, &params[0], 0);
    password pass;

    if (code < 0)
        return code;
    params[1] = *op;
    array_param_list_read(&list, params, 2, ((void*)0), ((bool)0), ((i_ctx_p->memory).current));
    if (dict_read_password(&pass, (&(i_ctx_p->dict_stack).system_dict), "StartJobPassword") >= 0 &&
        param_check_password(plist, &pass) == 0
        )
        result = 1;
    if (dict_read_password(&pass, (&(i_ctx_p->dict_stack).system_dict), "SystemParamsPassword") >= 0 &&
        param_check_password(plist, &pass) == 0
        )
        result = 2;
    (((&list)->memory)->procs.free_object((&list)->memory, (&list)->results, "iparam_list_release"));
...
{
    return gs_currentcachesize((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir));
}
static int
set_MaxFontCache(i_ctx_t *i_ctx_p, long val)
{
    return gs_setcachesize((i_ctx_p->pgs), (gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir),
                           (uint)(val < 0 ? 0 : val > ((unsigned int)~0 + (unsigned int)0) ? ((unsigned int)~0 + (unsigned int)0) :
                                   val));
}
static long
current_CurFontCache(i_ctx_t *i_ctx_p)
{
    ...
    gs_cachestatus((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), cstat);
    return cstat[0];
}
static long
current_MaxGlobalVM(i_ctx_t *i_ctx_p)
{
    ...
    gs_memory_gc_status(((i_ctx_p->memory).spaces.memories.named.global), &stat);
    return stat.max_vm;
}
static int
set_MaxGlobalVM(i_ctx_t *i_ctx_p, long val)
{
    ...
    gs_memory_set_gc_status(((i_ctx_p->memory).spaces.memories.named.global), &stat);
    return 0;
}
static long
...
current_PageCount(i_ctx_t *i_ctx_p)
{
    ...
    if ((*((dev)->procs.get_page_device))(dev) != 0)
        if (dev->ShowpageCount > i_ctx_p->nv_page_count)
         i_ctx_p->nv_page_count = dev->ShowpageCount;
    return 1000 + i_ctx_p->nv_page_count;
}

static const long_param_def_t system_long_params[] =
{
    {"BuildTime", (-1L << ((1 << 3) * 8 - 1)), (~(-1L << ((1 << 3) * 8 - 1))), current_BuildTime, ((void*)0)},
{"MaxFontCache", 0, ((unsigned int)~0 + (unsigned int)0), current_MaxFontCache, set_MaxFontCache},
    {"CurFontCache", 0, ((unsigned int)~0 + (unsigned int)0), current_CurFontCache, ((void*)0)},
    {"Revision", (-1L << ((1 << 3) * 8 - 1)), (~(-1L << ((1 << 3) * 8 - 1))), current_Revision, ((void*)0)},
    {"PageCount", (-1L << ((1 << 3) * 8 - 1)), (~(-1L << ((1 << 3) * 8 - 1))), current_PageCount, ((void*)0)},


    {"MaxGlobalVM", 0, (~(-1L << ((1 << 3) * 8 - 1))), current_MaxGlobalVM, set_MaxGlobalVM}
};
...
{
    {"ByteOrder", current_ByteOrder, ((void*)0)}
};
...
{
    {"RealFormat", current_RealFormat, ((void*)0)},
};


static const param_set system_param_set =
{
    system_long_params, (sizeof(system_long_params) / sizeof((system_long_params)[0])),
    system_bool_params, (sizeof(system_bool_params) / sizeof((system_bool_params)[0])),
    system_string_params, (sizeof(system_string_params) / sizeof((system_string_params)[0]))
};
...
zsetsystemparams(i_ctx_t *i_ctx_p)
{
    ...
    code = dict_param_list_read(&list, op, ((void*)0), ((bool)0), ((i_ctx_p->memory).current));
    if (code < 0)
        return code;
    code = dict_read_password(&pass, (&(i_ctx_p->dict_stack).system_dict), "SystemParamsPassword");
    if (code < 0)
        return code;
    ...
    switch (code) {
        ...
        case 1:
            break;
        case 0:
            code = dict_write_password(&pass, (&(i_ctx_p->dict_stack).system_dict),
                                       "StartJobPassword",
...
{
    return gs_currentcacheupper((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir));
}
static int
set_MaxFontItem(i_ctx_t *i_ctx_p, long val)
{
    return gs_setcacheupper((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), val);
}
static long
current_MinFontCompress(i_ctx_t *i_ctx_p)
{
    return gs_currentcachelower((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir));
}
static int
set_MinFontCompress(i_ctx_t *i_ctx_p, long val)
{
    return gs_setcachelower((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), val);
}
static long
current_MaxOpStack(i_ctx_t *i_ctx_p)
{
    return (uint)((&((i_ctx_p->op_stack).stack))->max_stack.value.intval);
}
static int
set_MaxOpStack(i_ctx_t *i_ctx_p, long val)
{
    return ref_stack_set_max_count(&((i_ctx_p->op_stack).stack), val);
}
static long
current_MaxDictStack(i_ctx_t *i_ctx_p)
{
    return (uint)((&((i_ctx_p->dict_stack).stack))->max_stack.value.intval);
}
static int
set_MaxDictStack(i_ctx_t *i_ctx_p, long val)
{
    return ref_stack_set_max_count(&((i_ctx_p->dict_stack).stack), val);
}
static long
current_MaxExecStack(i_ctx_t *i_ctx_p)
{
    return (uint)((&((i_ctx_p->exec_stack).stack))->max_stack.value.intval);
}
static int
set_MaxExecStack(i_ctx_t *i_ctx_p, long val)
{
    return ref_stack_set_max_count(&((i_ctx_p->exec_stack).stack), val);
}
static long
current_MaxLocalVM(i_ctx_t *i_ctx_p)
{
    ...
    gs_memory_gc_status(((i_ctx_p->memory).spaces.memories.named.local), &stat);
    return stat.max_vm;
}
static int
set_MaxLocalVM(i_ctx_t *i_ctx_p, long val)
{
    ...
    gs_memory_gc_status(((i_ctx_p->memory).spaces.memories.named.local), &stat);
    stat.max_vm = (((val) > (0)) ? (val) : (0));
    gs_memory_set_gc_status(((i_ctx_p->memory).spaces.memories.named.local), &stat);
    return 0;
}
static long
current_VMReclaim(i_ctx_t *i_ctx_p)
{
    ...
    gs_memory_gc_status(((i_ctx_p->memory).spaces.memories.named.global), &gstat);
    gs_memory_gc_status(((i_ctx_p->memory).spaces.memories.named.local), &lstat);
...
{
    return gs_currentminscreenlevels(((gs_memory_t *)((i_ctx_p->memory).current)));
}
static int
set_MinScreenLevels(i_ctx_t *i_ctx_p, long val)
{
    gs_setminscreenlevels(((gs_memory_t *)((i_ctx_p->memory).current)), (uint) val);
    return 0;
}
static long
current_AlignToPixels(i_ctx_t *i_ctx_p)
{
    return gs_currentaligntopixels((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir));
}
static int
set_AlignToPixels(i_ctx_t *i_ctx_p, long val)
{
    gs_setaligntopixels((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), (uint)val);
    return 0;
}
static long
current_GridFitTT(i_ctx_t *i_ctx_p)
{
    return gs_currentgridfittt((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir));
}
static int
set_GridFitTT(i_ctx_t *i_ctx_p, long val)
{
    gs_setgridfittt((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), (uint)val);
    return 0;
}
...
{
    return gs_currentaccuratescreens(((gs_memory_t *)((i_ctx_p->memory).current)));
}
static int
set_AccurateScreens(i_ctx_t *i_ctx_p, bool val)
{
    gs_setaccuratescreens(((gs_memory_t *)((i_ctx_p->memory).current)), val);
    return 0;
}
...
{
    const gs_imager_state * pis = (gs_imager_state *) (i_ctx_p->pgs);
...
{
    user_long_params, (sizeof(user_long_params) / sizeof((user_long_params)[0])),
    user_bool_params, (sizeof(user_bool_params) / sizeof((user_bool_params)[0])),
    user_string_params, (sizeof(user_string_params) / sizeof((user_string_params)[0]))
};
...
set_user_params(i_ctx_t *i_ctx_p, const ref *paramdict)
{
    ...
    if ( !((((const byte *)&((&*paramdict)->tas.type_attrs))[1]) == (t_dictionary)) ) return (check_type_failed(&*paramdict));
    code = dict_param_list_read(&list, paramdict, ((void*)0), ((bool)0), ((i_ctx_p->memory).current));
    if (code < 0)
        return code;
    ...
    return
        (psref == 0 ||
         !bytes_compare((const byte *)pname, strlen(pname),
                        psref->value.const_bytes, ((psref)->tas.rsize)));
}
static int
                   ...
                   const ref * psref )
{
    ...
    stack_param_list_write(&list, &((i_ctx_p->op_stack).stack), ((void*)0), ((i_ctx_p->memory).current));
    for (i = 0; i < pset->long_count; i++) {
...
{
    return current_param_list(i_ctx_p, pset, ((void*)0));
}
...
currentparam1(i_ctx_t *i_ctx_p, const param_set * pset)
{
    ...
    names_string_ref(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, (const ref *)op, &sref);
    code = current_param_list(i_ctx_p, pset, &sref);
    if (code < 0)
        return code;
    if ((((i_ctx_p->op_stack).stack).p) == op)
        return ((-21));
