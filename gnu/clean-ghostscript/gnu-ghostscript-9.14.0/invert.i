# 1 "./openjpeg/libopenjpeg/invert.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/invert.c" 2
# 27 "./openjpeg/libopenjpeg/invert.c"
...
# 28 "./openjpeg/libopenjpeg/invert.c" 2
...
static void opj_lupInvert ( OPJ_FLOAT32 * pSrcMatrix,
                            ...
                            OPJ_FLOAT32 * p_swap_area);
# 65 "./openjpeg/libopenjpeg/invert.c"
OPJ_BOOL opj_matrix_inversion_f(OPJ_FLOAT32 * pSrcMatrix,
                                OPJ_FLOAT32 * pDestMatrix,
                                OPJ_UINT32 nb_compo)
{
 ...
 l_data = (OPJ_BYTE *) ((size_t)(l_total_size) >= (size_t)-0x100 ? ((void*)0) : malloc(l_total_size));
 if (l_data == 0) {
  return 0;
 }
                   ...
                   OPJ_UINT32 nb_compo,OPJ_FLOAT32 * p_intermediate_data)
{
 ...
 lDestPtr = pResult + nb_compo;
    ...
    ((nb_compo != 0) ? (void) (0) : __assert_fail ("nb_compo != 0", "./openjpeg/libopenjpeg/invert.c", 247, __PRETTY_FUNCTION__));
