# 1 "./openjpeg/libopenjpeg/function_list.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/function_list.c" 2
# 27 "./openjpeg/libopenjpeg/function_list.c"
...
# 28 "./openjpeg/libopenjpeg/function_list.c" 2
...
opj_procedure_list_t * opj_procedure_list_create()
{
        ...
        opj_procedure_list_t * l_validation = (opj_procedure_list_t *) ((size_t)(sizeof(opj_procedure_list_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_procedure_list_t)));
        if (! l_validation)
        {
                return 00;
        }
        ...
        l_validation->m_nb_max_procedures = 10;
        l_validation->m_procedures = (opj_procedure*)((size_t)(10 * sizeof(opj_procedure)) >= (size_t)-0x100 ? ((void*)0) : malloc(10 * sizeof(opj_procedure)));
        ...
        memset(l_validation->m_procedures,0,10 * sizeof(opj_procedure));
        return l_validation;
}
...
OPJ_BOOL opj_procedure_list_add_procedure (opj_procedure_list_t * p_validation_list, opj_procedure p_procedure)
{
        if (p_validation_list->m_nb_max_procedures == p_validation_list->m_nb_procedures)
        {
                ...
                p_validation_list->m_nb_max_procedures += 10;
                new_procedures = (opj_procedure*)((size_t)(p_validation_list->m_nb_max_procedures * sizeof(opj_procedure)) >= (size_t)-0x100 ? ((void*)0) : realloc(p_validation_list->m_procedures, p_validation_list->m_nb_max_procedures * sizeof(opj_procedure)));
