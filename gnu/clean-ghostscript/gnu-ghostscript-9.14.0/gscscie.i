...
static const gc_ptr_element_t cie_common_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_cie_common *)0)->client_data - (char *)((gs_cie_common *)0) )) } }; static const gc_struct_data_t cie_common_reloc_ptrs = { (sizeof(cie_common_enum_ptrs) / sizeof((cie_common_enum_ptrs)[0])), 0, 0, cie_common_enum_ptrs }; const gs_memory_struct_type_t st_cie_common = { sizeof(gs_cie_common), "gs_cie_common", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cie_common_reloc_ptrs };
const gs_memory_struct_type_t st_cie_common_elements_t = { sizeof(gs_cie_common_elements_t), "gs_cie_common_elements_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cie_common_reloc_ptrs };
static const gs_memory_struct_type_t st_cie_a = { sizeof(gs_cie_a), "gs_cie_a", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cie_common_reloc_ptrs };
static const gs_memory_struct_type_t st_cie_abc = { sizeof(gs_cie_abc), "gs_cie_abc", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cie_common_reloc_ptrs };
static const gc_ptr_element_t cie_def_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_cie_def *)0)->Table.table - (char *)((gs_cie_def *)0) )) } }; static const gc_struct_data_t cie_def_reloc_ptrs = { (sizeof(cie_def_enum_ptrs) / sizeof((cie_def_enum_ptrs)[0])), 0, &st_cie_abc, cie_def_enum_ptrs }; static const gs_memory_struct_type_t st_cie_def = { sizeof(gs_cie_def), "gs_cie_def", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cie_def_reloc_ptrs };
static const gc_ptr_element_t cie_defg_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_cie_defg *)0)->Table.table - (char *)((gs_cie_defg *)0) )) } }; static const gc_struct_data_t cie_defg_reloc_ptrs = { (sizeof(cie_defg_enum_ptrs) / sizeof((cie_defg_enum_ptrs)[0])), 0, &st_cie_abc, cie_defg_enum_ptrs }; static const gs_memory_struct_type_t st_cie_defg = { sizeof(gs_cie_defg), "gs_cie_defg", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cie_defg_reloc_ptrs };




static const gc_ptr_element_t cs_CIEDEFG_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_space *)0)->params.defg - (char *)((gs_color_space *)0) )) } }; static const gc_struct_data_t cs_CIEDEFG_reloc_ptrs = { (sizeof(cs_CIEDEFG_enum_ptrs) / sizeof((cs_CIEDEFG_enum_ptrs)[0])), 0, 0, cs_CIEDEFG_enum_ptrs }; static const gs_memory_struct_type_t st_color_space_CIEDEFG = { sizeof(gs_color_space), "gs_color_space(CIEDEFG)", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cs_CIEDEFG_reloc_ptrs };


static void gx_final_CIEDEFG(const gs_color_space *);
static int gx_serialize_CIEDEFG(const gs_color_space *, stream *);
const gs_color_space_type gs_color_space_type_CIEDEFG = {
    gs_color_space_index_CIEDEFG, ((bool)1), ((bool)1),
    &st_color_space_CIEDEFG, gx_num_components_4,
    gx_init_CIE, gx_restrict_CIEDEFG,
    gx_concrete_space_CIE,
    gx_concretize_CIEDEFG, ((void*)0),
    gx_remap_CIEDEFG,
    gx_install_CIE,
...
static const gc_ptr_element_t cs_CIEDEF_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_space *)0)->params.def - (char *)((gs_color_space *)0) )) } }; static const gc_struct_data_t cs_CIEDEF_reloc_ptrs = { (sizeof(cs_CIEDEF_enum_ptrs) / sizeof((cs_CIEDEF_enum_ptrs)[0])), 0, 0, cs_CIEDEF_enum_ptrs }; static const gs_memory_struct_type_t st_color_space_CIEDEF = { sizeof(gs_color_space), "gs_color_space(CIEDEF)", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cs_CIEDEF_reloc_ptrs };


static void gx_final_CIEDEF(const gs_color_space *);
static int gx_serialize_CIEDEF(const gs_color_space *, stream *);
const gs_color_space_type gs_color_space_type_CIEDEF = {
    gs_color_space_index_CIEDEF, ((bool)1), ((bool)1),
    &st_color_space_CIEDEF, gx_num_components_3,
    gx_init_CIE, gx_restrict_CIEDEF,
    gx_concrete_space_CIE,
    gx_concretize_CIEDEF, ((void*)0),
    gx_remap_CIEDEF,
    gx_install_CIE,
    gx_spot_colors_set_overprint,
...
static const gc_ptr_element_t cs_CIEABC_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_space *)0)->params.abc - (char *)((gs_color_space *)0) )) } }; static const gc_struct_data_t cs_CIEABC_reloc_ptrs = { (sizeof(cs_CIEABC_enum_ptrs) / sizeof((cs_CIEABC_enum_ptrs)[0])), 0, 0, cs_CIEABC_enum_ptrs }; static const gs_memory_struct_type_t st_color_space_CIEABC = { sizeof(gs_color_space), "gs_color_space(CIEABC)", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cs_CIEABC_reloc_ptrs };


static void gx_final_CIEABC(const gs_color_space *);
static int gx_serialize_CIEABC(const gs_color_space *, stream *);
const gs_color_space_type gs_color_space_type_CIEABC = {
    gs_color_space_index_CIEABC, ((bool)1), ((bool)1),
    &st_color_space_CIEABC, gx_num_components_3,
    gx_init_CIE, gx_restrict_CIEABC,
    gx_concrete_space_CIE,
    gx_concretize_CIEABC, ((void*)0),
...
static const gc_ptr_element_t cs_CIEA_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_space *)0)->params.a - (char *)((gs_color_space *)0) )) } }; static const gc_struct_data_t cs_CIEA_reloc_ptrs = { (sizeof(cs_CIEA_enum_ptrs) / sizeof((cs_CIEA_enum_ptrs)[0])), 0, 0, cs_CIEA_enum_ptrs }; static const gs_memory_struct_type_t st_color_space_CIEA = { sizeof(gs_color_space), "gs_color_space(CIEA)", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cs_CIEA_reloc_ptrs };


static void gx_final_CIEA(const gs_color_space *);
static int gx_serialize_CIEA(const gs_color_space *, stream *);
const gs_color_space_type gs_color_space_type_CIEA = {
    gs_color_space_index_CIEA, ((bool)1), ((bool)1),
    &st_color_space_CIEA, gx_num_components_1,
    gx_init_CIE, gx_restrict_CIEA,
    gx_concrete_space_CIE,
    gx_concretize_CIEA, ((void*)0),
    gx_remap_CIEA,
    gx_install_CIE,
    gx_spot_colors_set_overprint,
...
gx_final_CIEDEFG(const gs_color_space * pcs)
{
    ...
    if (pcs->icc_equivalent != ((void*)0)) {
        do { if (pcs_noconst->icc_equivalent) { do { do { } while (0); (pcs_noconst->icc_equivalent)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->icc_equivalent)->rc.ref_count) { do { do { } while (0); (pcs_noconst->icc_equivalent)->rc.free((pcs_noconst->icc_equivalent)->rc.memory, (void *)(pcs_noconst->icc_equivalent), "gx_final_CIEDEFG"); } while (0); (pcs_noconst->icc_equivalent) = 0; } else do { } while (0); } } while (0);
    }
    if (pcs->cmm_icc_profile_data != ((void*)0)) {
        do { if (pcs_noconst->cmm_icc_profile_data) { do { do { } while (0); (pcs_noconst->cmm_icc_profile_data)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->cmm_icc_profile_data)->rc.ref_count) { do { do { } while (0); (pcs_noconst->cmm_icc_profile_data)->rc.free((pcs_noconst->cmm_icc_profile_data)->rc.memory, (void *)(pcs_noconst->cmm_icc_profile_data), "gx_final_CIEDEFG"); } while (0); (pcs_noconst->cmm_icc_profile_data) = 0; } else do { } while (0); } } while (0);
    }
    do { if (pcs_noconst->params.defg) { do { do { } while (0); (pcs_noconst->params.defg)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->params.defg)->rc.ref_count) { do { do { } while (0); (pcs_noconst->params.defg)->rc.free((pcs_noconst->params.defg)->rc.memory, (void *)(pcs_noconst->params.defg), "gx_final_CIEDEFG"); } while (0); (pcs_noconst->params.defg) = 0; } else do { } while (0); } } while (0);
}
...
gx_final_CIEDEF(const gs_color_space * pcs)
{
    ...
    if (pcs->icc_equivalent != ((void*)0)) {
        do { if (pcs_noconst->icc_equivalent) { do { do { } while (0); (pcs_noconst->icc_equivalent)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->icc_equivalent)->rc.ref_count) { do { do { } while (0); (pcs_noconst->icc_equivalent)->rc.free((pcs_noconst->icc_equivalent)->rc.memory, (void *)(pcs_noconst->icc_equivalent), "gx_final_CIEDEF"); } while (0); (pcs_noconst->icc_equivalent) = 0; } else do { } while (0); } } while (0);
    }
    if (pcs->cmm_icc_profile_data != ((void*)0)) {
        do { if (pcs_noconst->cmm_icc_profile_data) { do { do { } while (0); (pcs_noconst->cmm_icc_profile_data)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->cmm_icc_profile_data)->rc.ref_count) { do { do { } while (0); (pcs_noconst->cmm_icc_profile_data)->rc.free((pcs_noconst->cmm_icc_profile_data)->rc.memory, (void *)(pcs_noconst->cmm_icc_profile_data), "gx_final_CIEDEF"); } while (0); (pcs_noconst->cmm_icc_profile_data) = 0; } else do { } while (0); } } while (0);
    }
    do { if (pcs_noconst->params.def) { do { do { } while (0); (pcs_noconst->params.def)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->params.def)->rc.ref_count) { do { do { } while (0); (pcs_noconst->params.def)->rc.free((pcs_noconst->params.def)->rc.memory, (void *)(pcs_noconst->params.def), "gx_final_CIEDEF"); } while (0); (pcs_noconst->params.def) = 0; } else do { } while (0); } } while (0);
}
...
gx_final_CIEABC(const gs_color_space * pcs)
{
    ...
    if (pcs->icc_equivalent != ((void*)0)) {
        do { if (pcs_noconst->icc_equivalent) { do { do { } while (0); (pcs_noconst->icc_equivalent)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->icc_equivalent)->rc.ref_count) { do { do { } while (0); (pcs_noconst->icc_equivalent)->rc.free((pcs_noconst->icc_equivalent)->rc.memory, (void *)(pcs_noconst->icc_equivalent), "gx_final_CIEABC"); } while (0); (pcs_noconst->icc_equivalent) = 0; } else do { } while (0); } } while (0);
    }
    if (pcs->cmm_icc_profile_data != ((void*)0)) {
        do { if (pcs_noconst->cmm_icc_profile_data) { do { do { } while (0); (pcs_noconst->cmm_icc_profile_data)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->cmm_icc_profile_data)->rc.ref_count) { do { do { } while (0); (pcs_noconst->cmm_icc_profile_data)->rc.free((pcs_noconst->cmm_icc_profile_data)->rc.memory, (void *)(pcs_noconst->cmm_icc_profile_data), "gx_final_CIEABC"); } while (0); (pcs_noconst->cmm_icc_profile_data) = 0; } else do { } while (0); } } while (0);
    }
    do { if (pcs_noconst->params.abc) { do { do { } while (0); (pcs_noconst->params.abc)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->params.abc)->rc.ref_count) { do { do { } while (0); (pcs_noconst->params.abc)->rc.free((pcs_noconst->params.abc)->rc.memory, (void *)(pcs_noconst->params.abc), "gx_final_CIEABC"); } while (0); (pcs_noconst->params.abc) = 0; } else do { } while (0); } } while (0);
}
...
gx_final_CIEA(const gs_color_space * pcs)
{
    ...
    if (pcs->icc_equivalent != ((void*)0)) {
        do { if (pcs_noconst->icc_equivalent) { do { do { } while (0); (pcs_noconst->icc_equivalent)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->icc_equivalent)->rc.ref_count) { do { do { } while (0); (pcs_noconst->icc_equivalent)->rc.free((pcs_noconst->icc_equivalent)->rc.memory, (void *)(pcs_noconst->icc_equivalent), "gx_final_CIEA"); } while (0); (pcs_noconst->icc_equivalent) = 0; } else do { } while (0); } } while (0);
    }
    if (pcs->cmm_icc_profile_data != ((void*)0)) {
        do { if (pcs_noconst->cmm_icc_profile_data) { do { do { } while (0); (pcs_noconst->cmm_icc_profile_data)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->cmm_icc_profile_data)->rc.ref_count) { do { do { } while (0); (pcs_noconst->cmm_icc_profile_data)->rc.free((pcs_noconst->cmm_icc_profile_data)->rc.memory, (void *)(pcs_noconst->cmm_icc_profile_data), "gx_final_CIEA"); } while (0); (pcs_noconst->cmm_icc_profile_data) = 0; } else do { } while (0); } } while (0);
    }
    do { if (pcs_noconst->params.a) { do { do { } while (0); (pcs_noconst->params.a)->rc.ref_count += (-1); } while (0); if (!(pcs_noconst->params.a)->rc.ref_count) { do { do { } while (0); (pcs_noconst->params.a)->rc.free((pcs_noconst->params.a)->rc.memory, (void *)(pcs_noconst->params.a), "gx_adjust_cspace_CIEA"); } while (0); (pcs_noconst->params.a) = 0; } else do { } while (0); } } while (0);
}
# 219 "./base/gscscie.c"
void
...
set_ctbl_defaults(gx_color_lookup_table * plktblp, int num_comps)
{
    ...
    plktblp->n = num_comps;
    plktblp->m = 3;
    for (i = 0; i < (sizeof(plktblp->dims) / sizeof((plktblp->dims)[0])); i++)
        plktblp->dims[i] = 0;
    plktblp->table = 0;
}
                ...
                gs_memory_type_ptr_t stype, gs_memory_t * pmem)
{
    ...
    if (pcspace == ((void*)0))
        return ((void*)0);
    do { if ( ((pdata) = (gs_cie_common_elements_t *)(*(pmem)->procs.alloc_struct)(pmem, stype, "gx_build_cie_space(data)")) == 0 ) { { ((pmem)->procs.free_object(pmem, pcspace, "gx_build_cie_space")); return 0; }; } else { do { (pdata)->rc.ref_count = 1; (pdata)->rc.memory = pmem; (pdata)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0);
...
{
    const uint cache_size = (((int)(sizeof(c->values))) / ((int)(sizeof((c->values)[0]))));
    uint n;
    int code;
