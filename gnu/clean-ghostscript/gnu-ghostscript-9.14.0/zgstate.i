...
static const gs_memory_struct_type_t st_int_gstate = { sizeof(int_gstate), "int_gstate", 0, ref_struct_clear_marks, ref_struct_enum_ptrs, ref_struct_reloc_ptrs, 0, 0 };
static const gs_memory_struct_type_t st_int_remap_color_info = { sizeof(int_remap_color_info_t), "int_remap_color_info_t", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };
...
zset_real(i_ctx_t *i_ctx_p, int (*set_proc)(gs_state *, double))
{
    ...
    code = set_proc((i_ctx_p->pgs), param);
    if (!code)
...
zset_bool(i_ctx_t *i_ctx_p, void (*set_proc)(gs_state *, bool))
{
    ...
    set_proc((i_ctx_p->pgs), op->value.boolval);
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
...
zcurrent_bool(i_ctx_t *i_ctx_p, bool (*current_proc)(const gs_state *))
{
    ...
    ((op)->value.boolval = (current_proc((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_boolean) << 8) + (0)) );
    return 0;
}
...
zset_uint(i_ctx_t *i_ctx_p, void (*set_proc)(gs_state *, uint))
{
    ...
    set_proc((i_ctx_p->pgs), op->value.intval);
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
...
zcurrent_uint(i_ctx_t *i_ctx_p, uint (*current_proc)(const gs_state *))
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.intval = (current_proc((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
...
int_gstate_alloc(const gs_dual_memory_t * dmem)
{
    ...
    iigs = (int_gstate *)(*((gs_memory_t *)lmem)->procs.alloc_struct)((gs_memory_t *)lmem, &st_int_gstate, "int_gstate_alloc(int_gstate)");

    if (iigs == ((void*)0))
        return ((void*)0);
    { register ref *rp_ = (ref *)(iigs); register int i = sizeof(int_gstate) / sizeof(ref); do { (((rp_)->tas.type_attrs = ((t_null) << 8) + (0)) ); ++rp_; } while ( --i ); };
    ((&iigs->dash_pattern_array)->value.refs = ((ref *)((void*)0)), ((&iigs->dash_pattern_array)->tas.type_attrs = ((t_array) << 8) + ((0x10 + 0x20 +0x40))), ((&iigs->dash_pattern_array)->tas.rsize = (0)));
    gs_alloc_ref_array(lmem, &proc0, (0x20 + 0x40) + 0x80, 2,
                       "int_gstate_alloc(proc0)");
    ((proc0.value.refs)->value.opproc = (zpop), ((proc0.value.refs)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((proc0.value.refs)->tas.rsize = (0)));
    ((proc0.value.refs + 1)->value.realval = (0.0), ((proc0.value.refs + 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
    iigs->black_generation = proc0;
    iigs->undercolor_removal = proc0;
    ((&iigs->use_cie_color)->value.boolval = (0), ((&iigs->use_cie_color)->tas.type_attrs = ((t_boolean) << 8) + (0)) );





    prci = (int_remap_color_info_t *)(*((gs_memory_t *)gmem)->procs.alloc_struct)((gs_memory_t *)gmem, &st_int_remap_color_info, "int_gstate_alloc(remap color info)");


    if (prci == ((void*)0))
        return ((void*)0);
    ((&iigs->remap_color_info)->value.pstruct = ((obj_header_t *)(prci)), ((&iigs->remap_color_info)->tas.type_attrs = ((t_struct) << 8) + (imemory_space(gmem))) );
    (((&(iigs)->pagedevice)->tas.type_attrs = ((t_null) << 8) + (0)) );
    gs_state_set_client(pgs, iigs, &istate_procs, ((bool)1));

    gs_setlimitclamp(pgs, ((bool)1));
...
{
    return gs_grestore((i_ctx_p->pgs));
}
...
{
    return gs_grestoreall((i_ctx_p->pgs));
}
...
zinitgraphics(i_ctx_t *i_ctx_p)
{
     ...
     ((&((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->dash_pattern_array)->value.refs = ((ref *)((void*)0)), ((&((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->dash_pattern_array)->tas.type_attrs = ((t_array) << 8) + ((0x10 + 0x20 +0x40))), ((&((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->dash_pattern_array)->tas.rsize = (0)));
     return gs_initgraphics((i_ctx_p->pgs));
}
...
zsetlinewidth(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return (check_type_failed(op));
    code = gs_setlinewidth((i_ctx_p->pgs), fabs(width));
    if (code >= 0)
        ((((i_ctx_p->op_stack).stack).p) -= (1));
    return code;
}
...
zcurrentlinewidth(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.realval = (gs_currentlinewidth((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zsetlinecap(i_ctx_t *i_ctx_p)
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    int param;
    int code = int_param(op, (~(-1 << ((1 << 2) * 8 - 1))), &param);

    if (code < 0 || (code = gs_setlinecap((i_ctx_p->pgs), (gs_line_cap) param)) < 0)
        return code;
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
...
zcurrentlinecap(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.intval = ((int)gs_currentlinecap((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
...
zsetlinejoin(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0 || (code = gs_setlinejoin((i_ctx_p->pgs), (gs_line_join) param)) < 0)
        return code;
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
...
zcurrentlinejoin(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.intval = ((int)gs_currentlinejoin((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
...
zcurrentmiterlimit(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.realval = (gs_currentmiterlimit((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zsetdash(i_ctx_t *i_ctx_p)
{
    ...
    n = ((op1)->tas.rsize);
    pattern =
        (float *)(*(mem)->procs.alloc_byte_array)(mem, n, sizeof(float), "setdash");
    ...
    if (code >= 0)
        code = gs_setdash((i_ctx_p->pgs), pattern, n, offset);
    ((mem)->procs.free_object(mem, pattern, "setdash"));
    if (code < 0)
        return code;
    (*(&((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->dash_pattern_array) = *(op1));
...
zcurrentdash(i_ctx_t *i_ctx_p)
{
    ...
    (*(op - 1) = *(&((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->dash_pattern_array));
    ((op)->value.realval = (gs_currentdash_offset((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zcurrentflat(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.realval = (gs_currentflat((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zsetcurvejoin(i_ctx_t *i_ctx_p)
{
    ...
    if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op));
    if (op->value.intval < -1 || op->value.intval > (~(-1 << ((1 << 2) * 8 - 1))))
        return ((-15));
    code = gs_setcurvejoin((i_ctx_p->pgs), (int)op->value.intval);
    if (code < 0)
        return code;
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
...
zcurrentcurvejoin(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.intval = (gs_currentcurvejoin((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
...
zsetfilladjust2(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    code = gs_setfilladjust((i_ctx_p->pgs), adjust[0], adjust[1]);
    if (code < 0)
        return code;
    ((((i_ctx_p->op_stack).stack).p) -= (2));
    return 0;
...
zcurrentfilladjust2(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (2)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (2); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    gs_currentfilladjust((i_ctx_p->pgs), &adjust);
    ((op - 1)->value.realval = (adjust.x), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((op)->value.realval = (adjust.y), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zsetdotlength(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_boolean)) ) return (check_type_failed(&*op));
    code = gs_setdotlength((i_ctx_p->pgs), length, op->value.boolval);
    if (code < 0)
        return code;
    ((((i_ctx_p->op_stack).stack).p) -= (2));
    return 0;
...
zcurrentdotlength(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (2)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (2); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op - 1)->value.realval = (gs_currentdotlength((i_ctx_p->pgs))), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((op)->value.boolval = (gs_currentdotlength_absolute((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_boolean) << 8) + (0)) );
    return 0;
}
...
{
    return gs_setdotorientation((i_ctx_p->pgs));
}
...
{
    return gs_dotorientation((i_ctx_p->pgs));
}
...
{
    return (int_gstate *)(*(mem)->procs.alloc_struct)(mem, &st_int_gstate, "int_gsave");
}
...
{
    ((mem)->procs.free_object(mem, old, "int_grestore"));
}
