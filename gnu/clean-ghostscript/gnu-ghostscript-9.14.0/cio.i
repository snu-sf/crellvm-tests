# 1 "./openjpeg/libopenjpeg/cio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/cio.c" 2
# 34 "./openjpeg/libopenjpeg/cio.c"
...
# 35 "./openjpeg/libopenjpeg/cio.c" 2
...
void opj_write_bytes_BE (OPJ_BYTE * p_buffer, OPJ_UINT32 p_value, OPJ_UINT32 p_nb_bytes)
{
 ...
 ((p_nb_bytes > 0 && p_nb_bytes <= sizeof(OPJ_UINT32)) ? (void) (0) : __assert_fail ("p_nb_bytes > 0 && p_nb_bytes <= sizeof(OPJ_UINT32)", "./openjpeg/libopenjpeg/cio.c", 45, __PRETTY_FUNCTION__));
...
void opj_write_bytes_LE (OPJ_BYTE * p_buffer, OPJ_UINT32 p_value, OPJ_UINT32 p_nb_bytes)
{
 ...
 ((p_nb_bytes > 0 && p_nb_bytes <= sizeof(OPJ_UINT32)) ? (void) (0) : __assert_fail ("p_nb_bytes > 0 && p_nb_bytes <= sizeof(OPJ_UINT32)", "./openjpeg/libopenjpeg/cio.c", 55, __PRETTY_FUNCTION__));
...
void opj_read_bytes_BE(const OPJ_BYTE * p_buffer, OPJ_UINT32 * p_value, OPJ_UINT32 p_nb_bytes)
{
 ...
 ((p_nb_bytes > 0 && p_nb_bytes <= sizeof(OPJ_UINT32)) ? (void) (0) : __assert_fail ("p_nb_bytes > 0 && p_nb_bytes <= sizeof(OPJ_UINT32)", "./openjpeg/libopenjpeg/cio.c", 66, __PRETTY_FUNCTION__));
...
void opj_read_bytes_LE(const OPJ_BYTE * p_buffer, OPJ_UINT32 * p_value, OPJ_UINT32 p_nb_bytes)
{
 ...
 ((p_nb_bytes > 0 && p_nb_bytes <= sizeof(OPJ_UINT32)) ? (void) (0) : __assert_fail ("p_nb_bytes > 0 && p_nb_bytes <= sizeof(OPJ_UINT32)", "./openjpeg/libopenjpeg/cio.c", 77, __PRETTY_FUNCTION__));
...
opj_stream_t* opj_stream_create(OPJ_SIZE_T p_buffer_size,OPJ_BOOL l_is_input)
{
 ...
 l_stream = (opj_stream_private_t*) ((size_t)(sizeof(opj_stream_private_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_stream_private_t)));
 if (! l_stream) {
  return 00;
 }
 ...
 l_stream->m_stored_data = (OPJ_BYTE *) ((size_t)(p_buffer_size) >= (size_t)-0x100 ? ((void*)0) : malloc(p_buffer_size));
...
{
 return opj_stream_create(0x100000,l_is_input);
}
...
OPJ_OFF_T opj_stream_read_skip (opj_stream_private_t * p_stream, OPJ_OFF_T p_size, opj_event_mgr_t * p_event_mgr)
{
 ...
 ((p_size >= 0) ? (void) (0) : __assert_fail ("p_size >= 0", "./openjpeg/libopenjpeg/cio.c", 461, __PRETTY_FUNCTION__));
...
OPJ_OFF_T opj_stream_get_number_byte_left (const opj_stream_private_t * p_stream)
{
  ((p_stream->m_byte_offset >= 0) ? (void) (0) : __assert_fail ("p_stream->m_byte_offset >= 0", "./openjpeg/libopenjpeg/cio.c", 558, __PRETTY_FUNCTION__));
  ((p_stream->m_user_data_length >= (OPJ_UINT64)p_stream->m_byte_offset) ? (void) (0) : __assert_fail ("p_stream->m_user_data_length >= (OPJ_UINT64)p_stream->m_byte_offset", "./openjpeg/libopenjpeg/cio.c", 559, __PRETTY_FUNCTION__));
...
{
 ((p_size >= 0) ? (void) (0) : __assert_fail ("p_size >= 0", "./openjpeg/libopenjpeg/cio.c", 567, __PRETTY_FUNCTION__));
...
OPJ_BOOL opj_stream_seek (opj_stream_private_t * p_stream, OPJ_OFF_T p_size, struct opj_event_mgr * p_event_mgr)
{
 ((p_size >= 0) ? (void) (0) : __assert_fail ("p_size >= 0", "./openjpeg/libopenjpeg/cio.c", 614, __PRETTY_FUNCTION__));
