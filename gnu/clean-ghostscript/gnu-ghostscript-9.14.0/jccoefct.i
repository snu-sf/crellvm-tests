 ...
 for (yindex = 0; yindex < compptr->MCU_height; yindex++) {
   if (coef->iMCU_row_num < last_iMCU_row ||
     ...
     if (blockcnt < compptr->MCU_width) {
       ...
       memset((void *)((void *) coef->MCU_buffer[blkn + blockcnt]), 0, (size_t)((compptr->MCU_width - blockcnt) * ((size_t) sizeof(JBLOCK))));
  ...
  coef->MCU_buffer[blkn+bi][0][0] = coef->MCU_buffer[blkn+bi-1][0][0];
     ...
     memset((void *)((void *) coef->MCU_buffer[blkn]), 0, (size_t)(compptr->MCU_width * ((size_t) sizeof(JBLOCK))));
