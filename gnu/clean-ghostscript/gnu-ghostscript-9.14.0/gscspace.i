...
# 36 "./base/gscspace.c" 2

static int gx_install_DeviceGray(gs_color_space *, gs_state *);
static int gx_install_DeviceRGB(gs_color_space *, gs_state *);
static int gx_install_DeviceCMYK(gs_color_space *, gs_state *);
...
static const gs_color_space_type gs_color_space_type_DeviceGray = {
    gs_color_space_index_DeviceGray, ((bool)1), ((bool)1),
    ...
    ((void*)0), gx_no_adjust_color_count,
...
static const gs_color_space_type gs_color_space_type_DeviceRGB = {
    gs_color_space_index_DeviceRGB, ((bool)1), ((bool)1),
...
static int gx_set_overprint_DeviceCMYK(const gs_color_space *, gs_state *);

static const gs_color_space_type gs_color_space_type_DeviceCMYK = {
    gs_color_space_index_DeviceCMYK, ((bool)1), ((bool)1),
...
static void gs_cspace_final(const gs_memory_t *cmem, void *ptr); static gs_ptr_type_t color_space_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void color_space_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_color_space = { sizeof(gs_color_space), "gs_color_space", 0, 0, color_space_enum_ptrs, color_space_reloc_ptrs, gs_cspace_final, 0 };
const gs_memory_struct_type_t st_base_color_space = { sizeof(gs_color_space), "gs_base_color_space", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };
                   ...
                   const gs_color_space_type *pcstype)
{
    ...
    do { if ( ((pcs) = (gs_color_space *)(*(mem)->procs.alloc_struct)(mem, &st_color_space, "gs_cspace_alloc_with_id")) == 0 ) { return ((void*)0); } else { do { (pcs)->rc.ref_count = 1; (pcs)->rc.memory = mem; (pcs)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0);
    ...
    pcs->pclient_color_space_data = ((void*)0);
    pcs->cmm_icc_profile_data = ((void*)0);
...
{
    return gs_cspace_alloc_with_id(mem, 1,
...
{
    return gs_cspace_alloc_with_id(mem, 3,
                                   &gs_color_space_type_DeviceRGB);
}
gs_color_space *
gs_cspace_new_DeviceCMYK(gs_memory_t *mem)
{
    return gs_cspace_alloc_with_id(mem, 4,
...
gs_cspace_new_ICC(gs_memory_t *pmem, gs_state * pgs, int components)
{
    ...
    switch (components) {
        case -1:
            if (icc_manage->smask_profiles == ((void*)0)) {
        ...
        default: do { if (pcspace) { do { do { } while (0); (pcspace)->rc.ref_count += (-1); } while (0); if (!(pcspace)->rc.ref_count) { do { do { } while (0); (pcspace)->rc.free((pcspace)->rc.memory, (void *)(pcspace), "gs_cspace_new_ICC"); } while (0); (pcspace) = 0; } else do { } while (0); } } while (0); return ((void*)0);
    }
    do { if (pcspace->cmm_icc_profile_data) do { (pcspace->cmm_icc_profile_data)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    return pcspace;
}
...
{
    return (*(pcs)->type->num_components)(pcs);
}
...
gx_install_DeviceGray(gs_color_space * pcs, gs_state * pgs)
{
    ...
    do { if (pgs->icc_manager->default_gray) do { (pgs->icc_manager->default_gray)->rc.ref_count++; do { } while (0); } while (0); } while (0);
...
void rc_increment_cs(gs_color_space *pcs)
{
    do { if (pcs) do { (pcs)->rc.ref_count++; do { } while (0); } while (0); } while (0);
}

void rc_decrement_cs(gs_color_space *pcs, const char *cname) {

    if (pcs) {
        do { if (pcs) { do { do { } while (0); (pcs)->rc.ref_count += (-1); } while (0); if (!(pcs)->rc.ref_count) { do { do { } while (0); (pcs)->rc.free((pcs)->rc.memory, (void *)(pcs), cname); } while (0); (pcs) = 0; } else do { } while (0); } } while (0);
    }
}
...
{
    if (pcs) {
        do { if (pcs) { do { do { } while (0); (pcs)->rc.ref_count += (-1); } while (0); if (!(pcs)->rc.ref_count) { do { do { } while (0); (pcs)->rc.free((pcs)->rc.memory, (void *)(pcs), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0);
    }
}
...
void cs_adjust_counts_icc(gs_state *pgs, int delta)
{
    ...
    if (pcs) {
        (*((pgs)->color[0].color_space)->type->adjust_color_count) (((pgs)->color[0].ccolor), ((pgs)->color[0].color_space), delta); do { if (((pgs)->color[0].color_space)) { do { do { } while (0); (((pgs)->color[0].color_space))->rc.ref_count += (delta); } while (0); if (!(((pgs)->color[0].color_space))->rc.ref_count) { do { do { } while (0); (((pgs)->color[0].color_space))->rc.free((((pgs)->color[0].color_space))->rc.memory, (void *)(((pgs)->color[0].color_space)), "cs_adjust_counts"); } while (0); do { } while (0); } else do { } while (0); } } while (0);
    }
}
...
gx_spot_colors_set_overprint(const gs_color_space * pcs, gs_state * pgs)
{
    ...
    if ((params.retain_any_comps = pis->overprint))
        params.retain_spot_comps = ((bool)1);
...
check_cmyk_color_model_comps(gx_device * dev)
{
    ...
    void (*map_cmyk) (gx_device * dev, frac c, frac m, frac y, frac k, frac * out);
    frac frac_14 = ((frac)0x7ff8) / 4;
    frac out[(8 * 8)];
    gx_color_index process_comps;


    if ( ncomps < 4 ||
         (cyan_c = ((dev)->procs.get_color_comp_index)(
                       dev,
                       "Cyan",
                       sizeof("Cyan") - 1,
                       0 )) < 0 ||
         cyan_c == (8 * 8) ||
         (magenta_c = ((dev)->procs.get_color_comp_index)(
                          dev,
                          "Magenta",
                          sizeof("Magenta") - 1,
                          0 )) < 0 ||
         magenta_c == (8 * 8) ||
         (yellow_c = ((dev)->procs.get_color_comp_index)(
                        dev,
                        "Yellow",
                        sizeof("Yellow") - 1,
                        0 )) < 0 ||
         yellow_c == (8 * 8) ||
         (black_c = ((dev)->procs.get_color_comp_index)(
                        dev,
                        "Black",
                        sizeof("Black") - 1,
                        0 )) < 0 ||
    ...
    if ( (pprocs = ((dev)->procs.get_color_mapping_procs)(dev)) == 0 ||
         (map_cmyk = pprocs->map_cmyk) == 0 )
        return 0;

    map_cmyk(dev, frac_14, ((frac)0), ((frac)0), ((frac)0), out);
    if (!check_single_comp(cyan_c, frac_14, ncomps, out))
        return 0;
    map_cmyk(dev, ((frac)0), frac_14, ((frac)0), ((frac)0), out);
    if (!check_single_comp(magenta_c, frac_14, ncomps, out))
        return 0;
    map_cmyk(dev, ((frac)0), ((frac)0), frac_14, ((frac)0), out);
    if (!check_single_comp(yellow_c, frac_14, ncomps, out))
        return ((bool)0);
    map_cmyk(dev, ((frac)0), ((frac)0), ((frac)0), frac_14, out);
...
check_rgb_color_model_comps(gx_device * dev)
{
    ...
    if ( ncomps < 3 ||
         (red_c = ((dev)->procs.get_color_comp_index)(
                       dev,
                       "Red",
                       sizeof("Red") - 1,
                       0 )) < 0 ||
         red_c == (8 * 8) ||
         (green_c = ((dev)->procs.get_color_comp_index)(
                          dev,
                          "Green",
                          sizeof("Green") - 1,
                          0 )) < 0 ||
         green_c == (8 * 8) ||
         (blue_c = ((dev)->procs.get_color_comp_index)(
                        dev,
                        "Blue",
                        sizeof("Blue") - 1,
                        0 )) < 0 ||
    ...
    map_rgb(dev, ((void*)0), frac_14, ((frac)0), ((frac)0), out);
    if (!check_single_comp(red_c, frac_14, ncomps, out))
        return 0;
    map_rgb(dev, ((void*)0), ((frac)0), frac_14, ((frac)0), out);
    if (!check_single_comp(green_c, frac_14, ncomps, out))
        return 0;
    map_rgb(dev, ((void*)0), ((frac)0), ((frac)0), frac_14, out);
...
int gx_set_overprint_cmyk(const gs_color_space * pcs, gs_state * pgs)
{
    ...
    if (pcs->cmm_icc_profile_data != ((void*)0) && output_profile != ((void*)0)) {
    ...
    pdc = ((pgs)->color[0].dev_color);
    if (((pdc)->type != (&gx_dc_type_data_none)) && profile_ok) {
        gx_color_index nz_comps, one, temp;
        int code;
        int num_colorant[4], k;
        bool colorant_ok;

        int (*procp)(const gx_device_color * pdevc, const gx_device * dev, gx_color_index * pcomp_bits);
        ...
        if (pdc->ccolor_valid) {
            ...
            num_colorant[0] = (((dev)->procs.get_color_comp_index)) (dev, "Cyan", strlen("Cyan"), 0);

            num_colorant[1] = (((dev)->procs.get_color_comp_index)) (dev, "Magenta", strlen("Magenta"), 0);

            num_colorant[2] = (((dev)->procs.get_color_comp_index)) (dev, "Yellow", strlen("Yellow"), 0);

            num_colorant[3] = (((dev)->procs.get_color_comp_index)) (dev, "Black", strlen("Black"), 0);
    ...
    params.retain_any_comps = ((bool)1);
...
int gx_set_overprint_rgb(const gs_color_space * pcs, gs_state * pgs)
{
    ...
    params.k_value = 0;
    params.blendspot = ((bool)0);
    if (((pdc)->type != (&gx_dc_type_data_none))) {
        gx_color_index nz_comps, one, temp;
        int code;
        ...
        if (pdc->ccolor_valid) {
            ...
            num_colorant[0] = (((dev)->procs.get_color_comp_index)) (dev, "Red", strlen("Red"), 0);

            num_colorant[1] = (((dev)->procs.get_color_comp_index)) (dev, "Green", strlen("Green"), 0);

            num_colorant[2] = (((dev)->procs.get_color_comp_index)) (dev, "Blue", strlen("Blue"), 0);
        ...
        double t, int n, float smoothness)
{
    ...
    if (c0->type == &gx_dc_type_data_pure) {
        ...
        for (i = 0; i < n; i++) {
            ...
            float max_diff = (((1) > (max_color * smoothness)) ? (1) : (max_color * smoothness));
            int b0 = (pure0 >> shift) & mask, b1 = (pure1 >> shift) & mask;
            int b = (pure >> shift) & mask;
            double bb = b0 * t + b1 * (1 - t);

            if (((b - bb) < 0 ? -(b - bb) : (b - bb)) > max_diff)
                return ((bool)0);
        }
        return ((bool)1);
    } else {
...
static
gs_ptr_type_t color_space_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst)
{
    const gs_color_space *pcs = vptr;

    if (index == 0)
        return (pep->ptr = (const void *)(pcs->base_space), (&ptr_struct_procs));
    if (index == 1)
        return (pep->ptr = (const void *)(pcs->pclient_color_space_data), (&ptr_struct_procs));
    if (index == 2)
        return (pep->ptr = (const void *)(pcs->icc_equivalent), (&ptr_struct_procs));
    return (*(*pcs->type->stype).enum_ptrs)(mem, vptr, size, index - 3, pep, &(*pcs->type->stype), gcst);

}
static
void color_space_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_color_space *pcs = vptr;
{
    (pcs->base_space = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pcs->base_space), gcst)));
    (pcs->pclient_color_space_data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pcs->pclient_color_space_data), gcst)));
    (pcs->icc_equivalent = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pcs->icc_equivalent), gcst)));
    (*(*pcs->type->stype).reloc_ptrs)(vptr, size, &(*pcs->type->stype), gcst);
}
}
