# 1 "./openjpeg/libopenjpeg/phix_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/phix_manager.c" 2
# 36 "./openjpeg/libopenjpeg/phix_manager.c"
...
# 37 "./openjpeg/libopenjpeg/phix_manager.c" 2
# 51 "./openjpeg/libopenjpeg/phix_manager.c"
int opj_write_phix( int coff, opj_codestream_info_t cstr_info, OPJ_BOOL EPHused, int j2klen, opj_stream_private_t *cio,
              opj_event_mgr_t * p_manager )
{
  ...
  box = (opj_jp2_box_t *)((size_t)(cstr_info.numcomps) != 0 && (size_t)(cstr_info.numcomps) >= (size_t)-0x100 / (size_t)(sizeof(opj_jp2_box_t)) ? ((void*)0) : calloc(cstr_info.numcomps, sizeof(opj_jp2_box_t)));
  ...
  for( i=0;i<2;i++){
    ...
    opj_write_bytes_LE(l_data_header,0x70686978,4);
...
int opj_write_phixfaix( int coff, int compno, opj_codestream_info_t cstr_info, OPJ_BOOL EPHused, int j2klen, opj_stream_private_t *cio,
              opj_event_mgr_t * p_manager )
{
  int tileno, version, i, nmax, size_of_coding;
  ...
  lenp = opj_stream_tell(cio);
  opj_stream_skip(cio, 4, p_manager);
  opj_write_bytes_LE(l_data_header,0x66616978,4);
  opj_stream_write_data(cio,l_data_header,4,p_manager);
  opj_write_bytes_LE(l_data_header,version,1);
  ...
  opj_write_bytes_LE(l_data_header,nmax,size_of_coding);
  opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
  opj_write_bytes_LE(l_data_header,cstr_info.tw*cstr_info.th,size_of_coding);
  opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
 ...
 for( layno=0; layno<numOflayers; layno++){
   ...
   default:
    ...
    opj_write_bytes_LE(l_data_header,(OPJ_UINT32)(packet.start_pos-coff),size_of_coding);
    opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
    opj_write_bytes_LE(l_data_header,(OPJ_UINT32)(packet.end_ph_pos-packet.start_pos+1),size_of_coding);
    opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
   ...
   num_packet++;
    ...
    while( num_packet < nmax){
      opj_write_bytes_LE(l_data_header,0,size_of_coding);
      opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
      opj_write_bytes_LE(l_data_header,0,size_of_coding);
      opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
      num_packet++;
