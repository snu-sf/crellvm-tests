...
static gs_ptr_type_t gs_glyph_cache_elem_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void gs_glyph_cache_elem_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static const gs_memory_struct_type_t st_glyph_cache_elem = { sizeof(gs_glyph_cache_elem), "gs_glyph_cache_elem", 0, 0, gs_glyph_cache_elem_enum_ptrs, gs_glyph_cache_elem_reloc_ptrs, 0, 0 };


static
gs_ptr_type_t gs_glyph_cache_elem_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_glyph_cache_elem *e = vptr; switch ( index ) { default:
{
    index --;
    if (index < 2)
        return (*(st_glyph_data).enum_ptrs)(mem, &e->gd, sizeof(e->gd), index, pep, &(st_glyph_data), gcst);
    return 0;
}
case 0: return (pep->ptr = (const void *)(((const gs_glyph_cache_elem *)vptr)->next), (&ptr_struct_procs));
} }
static void gs_glyph_cache_elem_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_glyph_cache_elem *e = vptr;
{
    (((gs_glyph_cache_elem *)vptr)->next = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_glyph_cache_elem *)vptr)->next), gcst)));
    (*(st_glyph_data).reloc_ptrs)(&e->gd, sizeof(e->gd), &(st_glyph_data), gcst);
} }
...
static const gc_ptr_element_t gs_glyph_cache_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_glyph_cache *)0)->list - (char *)((gs_glyph_cache *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_glyph_cache *)0)->memory - (char *)((gs_glyph_cache *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_glyph_cache *)0)->pfont - (char *)((gs_glyph_cache *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_glyph_cache *)0)->s - (char *)((gs_glyph_cache *)0) )) } }; static const gc_struct_data_t gs_glyph_cache_reloc_ptrs = { (sizeof(gs_glyph_cache_enum_ptrs) / sizeof((gs_glyph_cache_enum_ptrs)[0])), 0, 0, gs_glyph_cache_enum_ptrs }; static const gs_memory_struct_type_t st_glyph_cache = { sizeof(gs_glyph_cache), "gs_glyph_cache", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &gs_glyph_cache_reloc_ptrs };


int gs_glpyh_cache__release(void *proc_data, void *event_data);
                        ...
                        get_glyph_data_from_file read_data)
{
    ...
    gs_glyph_cache *gdcache = (gs_glyph_cache *)(gs_glyph_cache *)(*(mem)->procs.alloc_struct)(mem, &st_glyph_cache, "gs_glyph_cache");
...
gs_glyph_cache__release(void *data, void *event)
{
    ...
    while (e != ((void*)0)) {
        ...
        ((self->memory)->procs.free_object(self->memory, e, "gs_glyph_cache_elem__release"));
        e = next_e;
    }
    self->list = ((void*)0);
    gs_font_notify_unregister((gs_font *)pfont, gs_glyph_cache__release, (void *)self);
    ((self->memory)->procs.free_object(self->memory, self, "gs_glyph_cache__release"));
    return 0;
}
...
{
    gs_glyph_cache_elem **e = &self->list, **p_unlocked = ((void*)0);
    int count = 0;
...
{ gs_glyph_cache *gdcache = pfont->data.gdcache;
    ...
    gs_glyph_cache_elem *e = ((void*)0);

    if (pe == ((void*)0) || (*pe)->glyph_index != glyph_index) {
        int code;

        if (pe != ((void*)0) && gdcache->total_size > 32767 &&
                          (*pe)->lock_count <= 0) {
            ...
            e = (gs_glyph_cache_elem *)(gs_glyph_cache_elem *)(*(gdcache->memory)->procs.alloc_struct)(gdcache->memory, &st_glyph_cache_elem, "gs_glyph_cache_elem");
