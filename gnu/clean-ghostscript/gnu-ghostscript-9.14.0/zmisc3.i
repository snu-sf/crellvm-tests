...
{
    return gs_clipsave((i_ctx_p->pgs));
}
...
{
    return gs_cliprestore((i_ctx_p->pgs));
}
# 49 "./psi/zmisc3.c"
...
zeqproc(i_ctx_t *i_ctx_p)
{
    ...
    ((&stack[0].proc1)->value.refs = (op - 1), ((&stack[0].proc1)->tas.type_attrs = ((t_array) << 8) + (0)), ((&stack[0].proc1)->tas.rsize = (1)));
    ((&stack[0].proc2)->value.refs = (op), ((&stack[0].proc2)->tas.type_attrs = ((t_array) << 8) + (0)), ((&stack[0].proc2)->tas.rsize = (1)));
    for (;;) {
        long i;

        if (((&top->proc1)->tas.rsize) == 0) {

            if (top == stack) {

                ((op - 1)->value.boolval = (1), ((op - 1)->tas.type_attrs = ((t_boolean) << 8) + (0)) );
        ...
        i = ((&top->proc1)->tas.rsize) - 1;
        array_get(((gs_memory_t *)((i_ctx_p->memory).current)), &top->proc1, i, &top[1].proc1);
        array_get(((gs_memory_t *)((i_ctx_p->memory).current)), &top->proc2, i, &top[1].proc2);
        ((&top->proc1)->tas.rsize -= (1));
        ++top;
# 92 "./psi/zmisc3.c"
        if (obj_eq(((gs_memory_t *)((i_ctx_p->memory).current)), &top->proc1, &top->proc2)) {

            if ((((const byte *)&((&top->proc1)->tas.type_attrs))[1]) != (((const byte *)&((&top->proc2)->tas.type_attrs))[1]) &&
                ((((const byte *)&((&top->proc1)->tas.type_attrs))[1]) == t_name ||
                 (((const byte *)&((&top->proc2)->tas.type_attrs))[1]) == t_name)
                )
                break;
            --top;
            continue;
        }
        if ((((&top->proc1)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0))) && (((&top->proc2)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0))) &&
            ((&top->proc1)->tas.rsize) == ((&top->proc2)->tas.rsize) &&
            top < stack + (12 - 1)
            ) {
