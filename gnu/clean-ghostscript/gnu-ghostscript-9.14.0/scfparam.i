...
# 26 "./base/scfparam.c" 2


static const gs_param_item_t s_CF_param_items[] =
{

    { "Uncompressed", gs_param_type_bool, ((int) ( (char *)&((stream_CF_state *)0)->Uncompressed - (char *)((stream_CF_state *)0) )) },
    { "K", gs_param_type_int, ((int) ( (char *)&((stream_CF_state *)0)->K - (char *)((stream_CF_state *)0) )) },
    { "EndOfLine", gs_param_type_bool, ((int) ( (char *)&((stream_CF_state *)0)->EndOfLine - (char *)((stream_CF_state *)0) )) },
    { "EncodedByteAlign", gs_param_type_bool, ((int) ( (char *)&((stream_CF_state *)0)->EncodedByteAlign - (char *)((stream_CF_state *)0) )) },
    { "Columns", gs_param_type_int, ((int) ( (char *)&((stream_CF_state *)0)->Columns - (char *)((stream_CF_state *)0) )) },
    { "Rows", gs_param_type_int, ((int) ( (char *)&((stream_CF_state *)0)->Rows - (char *)((stream_CF_state *)0) )) },
    { "EndOfBlock", gs_param_type_bool, ((int) ( (char *)&((stream_CF_state *)0)->EndOfBlock - (char *)((stream_CF_state *)0) )) },
    { "BlackIs1", gs_param_type_bool, ((int) ( (char *)&((stream_CF_state *)0)->BlackIs1 - (char *)((stream_CF_state *)0) )) },
    { "DamagedRowsBeforeError", gs_param_type_int, ((int) ( (char *)&((stream_CF_state *)0)->DamagedRowsBeforeError - (char *)((stream_CF_state *)0) )) },
    { "FirstBitLowOrder", gs_param_type_bool, ((int) ( (char *)&((stream_CF_state *)0)->FirstBitLowOrder - (char *)((stream_CF_state *)0) )) },
    { "DecodedByteAlign", gs_param_type_int, ((int) ( (char *)&((stream_CF_state *)0)->DecodedByteAlign - (char *)((stream_CF_state *)0) )) },
...
int s_CF_get_params(gs_param_list *plist, const stream_CF_state *ss, bool all);
int
s_CF_get_params(gs_param_list * plist, const stream_CF_state * ss, bool all)
{
    ...
    if (all)
        ...
        ((&cfs_defaults)->Uncompressed = ((bool)0), (&cfs_defaults)->K = 0, (&cfs_defaults)->EndOfLine = ((bool)0), (&cfs_defaults)->EncodedByteAlign = ((bool)0), (&cfs_defaults)->Columns = 1728, (&cfs_defaults)->Rows = 0, (&cfs_defaults)->EndOfBlock = ((bool)1), (&cfs_defaults)->BlackIs1 = ((bool)0), (&cfs_defaults)->DamagedRowsBeforeError = 0, (&cfs_defaults)->FirstBitLowOrder = ((bool)0), (&cfs_defaults)->DecodedByteAlign = 1, (&cfs_defaults)->lbuf = 0, (&cfs_defaults)->lprev = 0, (&cfs_defaults)->error_string[0] = 0);
...
int s_CF_put_params(gs_param_list *plist, stream_CF_state *ss);
int
s_CF_put_params(gs_param_list * plist, stream_CF_state * ss)
{
    ...
    if (code >= 0 &&
        (state.K < -1000000 || state.K > 1000000 ||
         state.Columns < 0 || state.Columns > (2560 * 32000 * 2 / 3) ||
         state.Rows < 0 || state.Rows > 1000000 ||
         state.DamagedRowsBeforeError < 0 ||
         state.DamagedRowsBeforeError > 1000000 ||
