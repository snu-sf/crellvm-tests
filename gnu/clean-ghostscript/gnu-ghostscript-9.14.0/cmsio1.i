# 1 "./lcms2/src/cmsio1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmsio1.c" 2
# 27 "./lcms2/src/cmsio1.c"
...
# 28 "./lcms2/src/cmsio1.c" 2




static const cmsTagSignature Device2PCS16[] = {cmsSigAToB0Tag,
                                                  cmsSigAToB1Tag,
                                                  cmsSigAToB2Tag,
                                                  cmsSigAToB1Tag };

static const cmsTagSignature Device2PCSFloat[] = {cmsSigDToB0Tag,
                                                  cmsSigDToB1Tag,
                                                  cmsSigDToB2Tag,
                                                  cmsSigDToB3Tag };

static const cmsTagSignature PCS2Device16[] = {cmsSigBToA0Tag,
                                                  cmsSigBToA1Tag,
                                                  cmsSigBToA2Tag,
                                                  cmsSigBToA1Tag };

static const cmsTagSignature PCS2DeviceFloat[] = {cmsSigBToD0Tag,
                                                  cmsSigBToD1Tag,
                                                  cmsSigBToD2Tag,
                                                  cmsSigBToD3Tag };
...
static const cmsFloat64Number GrayInputMatrix[] = { ((1.0/(1.0 + 32767.0/32768.0))*0.9642), ((1.0/(1.0 + 32767.0/32768.0))*1.0), ((1.0/(1.0 + 32767.0/32768.0))*0.8249) };
static const cmsFloat64Number OneToThreeInputMatrix[] = { 1, 1, 1 };
static const cmsFloat64Number PickYMatrix[] = { 0, (((1.0 + 32767.0/32768.0))*1.0), 0 };
...
cmsBool _cmsReadMediaWhitePoint(cmsCIEXYZ* Dest, cmsHPROFILE hProfile)
{
    ...
    (((Dest != ((void*)0))) ? (void) (0) : __assert_fail ("(Dest != ((void*)0))", "./lcms2/src/cmsio1.c", 68, __PRETTY_FUNCTION__));
...
cmsBool _cmsReadCHAD(cmsMAT3* Dest, cmsHPROFILE hProfile)
{
    ...
    (((Dest != ((void*)0))) ? (void) (0) : __assert_fail ("(Dest != ((void*)0))", "./lcms2/src/cmsio1.c", 98, __PRETTY_FUNCTION__));
    ...
    if (cmsGetEncodedICCversion(hProfile) < 0x4000000) {
        ...
        if (cmsGetDeviceClass(hProfile) == cmsSigDisplayClass) {
            ...
            return _cmsAdaptationMatrix(Dest, ((void*)0), White, cmsD50_XYZ());
        }
    }
...
cmsBool ReadICCMatrixRGB2XYZ(cmsMAT3* r, cmsHPROFILE hProfile)
{
    ...
    (((r != ((void*)0))) ? (void) (0) : __assert_fail ("(r != ((void*)0))", "./lcms2/src/cmsio1.c", 137, __PRETTY_FUNCTION__));
...
cmsPipeline* BuildGrayInputMatrixPipeline(cmsHPROFILE hProfile)
{
    ...
    if (cmsGetPCS(hProfile) == cmsSigLabData) {
        ...
        if (!cmsPipelineInsertStage(Lut, cmsAT_END, cmsStageAllocMatrix(ContextID, 3, 1, OneToThreeInputMatrix, ((void*)0))) ||
        ...
        if (!cmsPipelineInsertStage(Lut, cmsAT_END, cmsStageAllocToneCurves(ContextID, 1, &GrayTRC)) ||
            !cmsPipelineInsertStage(Lut, cmsAT_END, cmsStageAllocMatrix(ContextID, 3, 1, GrayInputMatrix, ((void*)0))))
            goto Error;
    }
...
cmsPipeline* BuildRGBInputMatrixShaper(cmsHPROFILE hProfile)
{
    ...
    if (!ReadICCMatrixRGB2XYZ(&Mat, hProfile)) return ((void*)0);
    ...
    for (i=0; i < 3; i++)
        for (j=0; j < 3; j++)
            Mat.v[i].n[j] *= (1.0/(1.0 + 32767.0/32768.0));
    ...
    if (Lut != ((void*)0)) {
        ...
        if (!cmsPipelineInsertStage(Lut, cmsAT_END, cmsStageAllocToneCurves(ContextID, 3, Shapes)) ||
            !cmsPipelineInsertStage(Lut, cmsAT_END, cmsStageAllocMatrix(ContextID, 3, 3, (cmsFloat64Number*) &Mat, ((void*)0))))
            goto Error;
...
cmsPipeline* _cmsReadInputLUT(cmsHPROFILE hProfile, int Intent)
{
    ...
    if (cmsGetDeviceClass(hProfile) == cmsSigNamedColorClass) {
        ...
        if (!cmsPipelineInsertStage(Lut, cmsAT_BEGIN, _cmsStageAllocNamedColor(nc, 1)) ||
...
cmsPipeline* BuildGrayOutputPipeline(cmsHPROFILE hProfile)
{
    ...
    if (RevGrayTRC == ((void*)0)) return ((void*)0);
    ...
    if (cmsGetPCS(hProfile) == cmsSigLabData) {
        ...
        if (!cmsPipelineInsertStage(Lut, cmsAT_END, cmsStageAllocMatrix(ContextID, 1, 3, PickLstarMatrix, ((void*)0))))
            goto Error;
    }
    else {
        if (!cmsPipelineInsertStage(Lut, cmsAT_END, cmsStageAllocMatrix(ContextID, 1, 3, PickYMatrix, ((void*)0))))
            goto Error;
    }
...
cmsPipeline* BuildRGBOutputMatrixShaper(cmsHPROFILE hProfile)
{
    ...
    for (i=0; i < 3; i++)
        for (j=0; j < 3; j++)
            Inv.v[i].n[j] *= ((1.0 + 32767.0/32768.0));
    ...
    if (Lut != ((void*)0)) {
        ...
        if (!cmsPipelineInsertStage(Lut, cmsAT_END, cmsStageAllocMatrix(ContextID, 3, 3, (cmsFloat64Number*) &Inv, ((void*)0))) ||
...
cmsPipeline* _cmsReadDevicelinkLUT(cmsHPROFILE hProfile, int Intent)
{
    ...
    if (cmsGetDeviceClass(hProfile) == cmsSigNamedColorClass) {
        ...
        if (!cmsPipelineInsertStage(Lut, cmsAT_BEGIN, _cmsStageAllocNamedColor(nc, 0)))
            goto Error;
...
Error:
    ...
    if (!cmsIsTag(hProfile, tag16)) {
        ...
        tag16 = Device2PCS16[0];
        if (!cmsIsTag(hProfile, tag16)) return ((void*)0);
    }
...
cmsBool cmsIsCLUT(cmsHPROFILE hProfile, cmsUInt32Number Intent, cmsUInt32Number UsedDirection)
{
    ...
    switch (UsedDirection) {
       ...
       case 0: TagTable = Device2PCS16; break;
       case 1:TagTable = PCS2Device16; break;


       case 2:
           return cmsIsIntentSupported(hProfile, Intent, 0) &&
                  cmsIsIntentSupported(hProfile, 1, 1);

       default:
           cmsSignalError(cmsGetProfileContextID(hProfile), 2, "Unexpected direction (%d)", UsedDirection);
           return 0;
    }
                                        ...
                                        cmsUInt32Number Intent, cmsUInt32Number UsedDirection)
{
    ...
    if (cmsIsCLUT(hProfile, Intent, UsedDirection)) return 1;
...
cmsSEQ* _cmsReadProfileSequence(cmsHPROFILE hProfile)
{
    ...
    if (ProfileSeq == ((void*)0) && ProfileId == ((void*)0)) return ((void*)0);

    if (ProfileSeq == ((void*)0)) return cmsDupProfileSequenceDescription(ProfileId);
    if (ProfileId == ((void*)0)) return cmsDupProfileSequenceDescription(ProfileSeq);
...
cmsBool _cmsWriteProfileSequence(cmsHPROFILE hProfile, const cmsSEQ* seq)
{
    if (!cmsWriteTag(hProfile, cmsSigProfileSequenceDescTag, seq)) return 0;

    if (cmsGetProfileVersion(hProfile) >= 4.0) {

            if (!cmsWriteTag(hProfile, cmsSigProfileSequenceIdTag, seq)) return 0;
    }
