# 1 "./openjpeg/libopenjpeg/image.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/image.c" 2
# 27 "./openjpeg/libopenjpeg/image.c"
...
# 28 "./openjpeg/libopenjpeg/image.c" 2

opj_image_t* opj_image_create0(void) {
 opj_image_t *image = (opj_image_t*)((size_t)(1) != 0 && (size_t)(1) >= (size_t)-0x100 / (size_t)(sizeof(opj_image_t)) ? ((void*)0) : calloc(1, sizeof(opj_image_t)));
 return image;
}
...
opj_image_t* opj_image_create(OPJ_UINT32 numcmpts, opj_image_cmptparm_t *cmptparms, OPJ_COLOR_SPACE clrspc) {
 ...
 image = (opj_image_t*) ((size_t)(1) != 0 && (size_t)(1) >= (size_t)-0x100 / (size_t)(sizeof(opj_image_t)) ? ((void*)0) : calloc(1, sizeof(opj_image_t)));
 if(image) {
  image->color_space = clrspc;
  image->numcomps = numcmpts;

  image->comps = (opj_image_comp_t*)((size_t)(image->numcomps * sizeof(opj_image_comp_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(image->numcomps * sizeof(opj_image_comp_t)));
  if(!image->comps) {
  ...
  for(compno = 0; compno < numcmpts; compno++) {
   ...
   comp->data = (OPJ_INT32*) ((size_t)(comp->w * comp->h) != 0 && (size_t)(comp->w * comp->h) >= (size_t)-0x100 / (size_t)(sizeof(OPJ_INT32)) ? ((void*)0) : calloc(comp->w * comp->h, sizeof(OPJ_INT32)));
   if(!comp->data) {
    fprintf(stderr,"Unable to allocate memory for image.\n");
    opj_image_destroy(image);
    return ((void*)0);
...
# 139 "./openjpeg/libopenjpeg/image.c"
void opj_copy_image_header(const opj_image_t* p_image_src, opj_image_t* p_image_dest)
{
 OPJ_UINT32 compno;


 ((p_image_src != 00) ? (void) (0) : __assert_fail ("p_image_src != 00", "./openjpeg/libopenjpeg/image.c", 144, __PRETTY_FUNCTION__));
 ((p_image_dest != 00) ? (void) (0) : __assert_fail ("p_image_dest != 00", "./openjpeg/libopenjpeg/image.c", 145, __PRETTY_FUNCTION__));
 ...
 p_image_dest->comps = (opj_image_comp_t*) ((size_t)(p_image_dest->numcomps * sizeof(opj_image_comp_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(p_image_dest->numcomps * sizeof(opj_image_comp_t)));
 if (!p_image_dest->comps){
  p_image_dest->comps = ((void*)0);
 ...
 if (p_image_dest->icc_profile_len) {
  p_image_dest->icc_profile_buf = (OPJ_BYTE*)((size_t)(p_image_dest->icc_profile_len) >= (size_t)-0x100 ? ((void*)0) : malloc(p_image_dest->icc_profile_len));
...
opj_image_t* opj_image_tile_create(OPJ_UINT32 numcmpts, opj_image_cmptparm_t *cmptparms, OPJ_COLOR_SPACE clrspc) {
 ...
 image = (opj_image_t*) ((size_t)(sizeof(opj_image_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_image_t)));
 if (image)
 {
