...
int file_close_finish(stream *);
int file_close_disable(stream *);
# 29 "./base/gscpixel.c" 2


static void gx_restrict_DevicePixel(gs_client_color *, const gs_color_space *);
static int gx_remap_concrete_DevicePixel(const frac *, const gs_color_space * pcs, gx_device_color *, const gs_imager_state *, gx_device *, gs_color_select_t);
static int gx_concretize_DevicePixel(const gs_client_color *, const gs_color_space *, frac *, const gs_imager_state *, gx_device *);
static int gx_set_overprint_DevicePixel(const gs_color_space *, gs_state *);
static int gx_serialize_DevicePixel(const gs_color_space *, stream *);
static const gs_color_space_type gs_color_space_type_DevicePixel = {
    gs_color_space_index_DevicePixel, ((bool)1), ((bool)0),
...
gx_restrict_DevicePixel(gs_client_color * pcc, const gs_color_space * pcs)
{
    ...
    pcc->paint.values[0] = (pixel < 0 ? 0 : (((pixel) < (max_value)) ? (pixel) : (max_value)));
}
...
{
    ((pdc)->colors.pure = (pconc[0] & ((1 << dev->color_info.depth) - 1)), (pdc)->type = (&gx_dc_type_data_pure));
    return 0;
}
