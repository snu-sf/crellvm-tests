...
static const gc_ptr_element_t fm_pair_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((cached_fm_pair *)0)->font - (char *)((cached_fm_pair *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((cached_fm_pair *)0)->UID.xvalues - (char *)((cached_fm_pair *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((cached_fm_pair *)0)->xfont - (char *)((cached_fm_pair *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((cached_fm_pair *)0)->ttf - (char *)((cached_fm_pair *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((cached_fm_pair *)0)->ttr - (char *)((cached_fm_pair *)0) )) } }; static const gc_struct_data_t fm_pair_reloc_ptrs = { (sizeof(fm_pair_enum_ptrs) / sizeof((fm_pair_enum_ptrs)[0])), 0, 0, fm_pair_enum_ptrs }; static const gs_memory_struct_type_t st_cached_fm_pair = { sizeof(cached_fm_pair), "cached_fm_pair", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &fm_pair_reloc_ptrs };
static gs_ptr_type_t fm_pair_element_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { uint count = size / (uint)sizeof(cached_fm_pair); if ( count == 0 ) return 0; return (*(st_cached_fm_pair).enum_ptrs)(mem, (const char *)vptr + (index % count) * sizeof(cached_fm_pair), sizeof(cached_fm_pair), index / count, pep, &(st_cached_fm_pair), gcst); } static void fm_pair_element_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { { uint count = size / (uint)sizeof(cached_fm_pair); for ( ; count; count--, vptr = (char *)vptr + sizeof(cached_fm_pair) ) (*(st_cached_fm_pair).reloc_ptrs)(vptr, sizeof(cached_fm_pair), &(st_cached_fm_pair), gcst); } } static const gs_memory_struct_type_t st_cached_fm_pair_element = { sizeof(cached_fm_pair), "cached_fm_pair[]", 0, 0, fm_pair_element_enum_ptrs, fm_pair_element_reloc_ptrs, 0, 0 };

static gs_ptr_type_t cc_ptr_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void cc_ptr_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static const gs_memory_struct_type_t st_cached_char_ptr = { sizeof(cached_char *), "cached_char *", 0, 0, cc_ptr_enum_ptrs, cc_ptr_reloc_ptrs, 0, 0 };
static gs_ptr_type_t cc_ptr_element_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { uint count = size / (uint)sizeof(cached_char *); if ( count == 0 ) return 0; return (*(st_cached_char_ptr).enum_ptrs)(mem, (const char *)vptr + (index % count) * sizeof(cached_char *), sizeof(cached_char *), index / count, pep, &(st_cached_char_ptr), gcst); } static void cc_ptr_element_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { { uint count = size / (uint)sizeof(cached_char *); for ( ; count; count--, vptr = (char *)vptr + sizeof(cached_char *) ) (*(st_cached_char_ptr).reloc_ptrs)(vptr, sizeof(cached_char *), &(st_cached_char_ptr), gcst); } } static const gs_memory_struct_type_t st_cached_char_ptr_element = { sizeof(cached_char *), "cached_char *[]", 0, 0, cc_ptr_element_enum_ptrs, cc_ptr_element_reloc_ptrs, 0, 0 };




static const gs_memory_struct_type_t st_font_cache_bytes = { sizeof(byte), "font cache bytes", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };



static
gs_ptr_type_t cc_ptr_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { switch ( index ) { default: return 0;

} }
static void cc_ptr_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) {
{
}
}
            ...
            gs_font_dir * pdir, uint bmax, uint mmax, uint cmax, uint upper)
{
    ...
    chsize = (((chsize) > (( (( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) & ((( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) - 1) ? ((bmax) + ((( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) - 1)) / (( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) * (( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) : ((bmax) + ((( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) - 1)) & -(( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) ) / ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) ) + 1)) ? (chsize) : (( (( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) & ((( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) - 1) ? ((bmax) + ((( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) - 1)) / (( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) * (( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) : ((bmax) + ((( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) - 1)) & -(( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) )) ) / ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) ) + 1));


    while (chsize & (chsize + 1))
        chsize |= chsize >> 1;
    chsize++;
    mdata = (cached_fm_pair *)(*(struct_mem)->procs.alloc_struct_array)(struct_mem, mmax, &st_cached_fm_pair_element, "font_dir_alloc(mdata)");


    chars = (cached_char * *)(*(struct_mem)->procs.alloc_struct_array)(struct_mem, chsize, &st_cached_char_ptr_element, "font_dir_alloc(chars)");


    if (mdata == 0 || chars == 0) {
        ((struct_mem)->procs.free_object(struct_mem, chars, "font_dir_alloc(chars)"));
        ((struct_mem)->procs.free_object(struct_mem, mdata, "font_dir_alloc(mdata)"));
        return ((-25));
    }
...
gx_char_cache_init(register gs_font_dir * dir)
{
    ...
    ((dir->ccache.bits_memory)->procs.alloc_bytes_immovable(dir->ccache.bits_memory, sizeof(char_cache_chunk), "initial_chunk"));
    ...
    for (i = 0, pair = dir->fmcache.mdata;
        ...
        pair->index = i;
        (((pair)->font = 0, ((&(pair)->UID)->id = (~(-1L << ((1 << 3) * 8 - 1))), (&(pair)->UID)->xvalues = 0)), (pair)->xfont_tried = ((bool)0), (pair)->xfont = 0);
        pair->ttf = 0;
        pair->ttr = 0;
    }
    return 0;
...
# 313 "./base/gxccman.c"
        ...
        pair = dir->fmcache.mdata + pair->prev;
    ...
    if (code < 0) {
        ((&pair->UID)->id = (~(-1L << ((1 << 3) * 8 - 1))), (&pair->UID)->xvalues = 0);
        return code;
    }
...
gs_purge_fm_pair(gs_font_dir * dir, cached_fm_pair * pair, int xfont_only)
{
    ...
    if (!xfont_only) {
...

        {
            ...
            ((dir->memory->stable_memory)->procs.free_object(dir->memory->stable_memory, pair->UID.xvalues, "gs_purge_fm_pair"));
            pair->UID.xvalues = 0;
        }
        ((pair)->font = 0, ((&(pair)->UID)->id = (~(-1L << ((1 << 3) * 8 - 1))), (&(pair)->UID)->xvalues = 0));
        code = fm_pair_remove_from_list(dir, pair, &dir->fmcache.used);
        if (code < 0)
            return code;
                   ...
                   const gs_log2_scale_point * pscale, int depth, cached_char **pcc)
{
    ...
    float HWResolution0 = 72, HWResolution1 = 72;
    int code;
    ...
    *pcc = 0;
    ...
    iraster = ((uint)((((nwidth_bits) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3));
    ...
    if (dev2 == 0) {
        ...
        do { if (target) { do { do { } while (0); (target)->rc.ref_count += (-1); } while (0); if (!(target)->rc.ref_count) { do { do { } while (0); (target)->rc.free((target)->rc.memory, (void *)(target), "gx_alloc_char_bits"); } while (0); do { } while (0); } else do { } while (0); } } while (0);
        pdev->rc = rc;
        pdev->retained = retained;
        pdev->width = iwidth;
        pdev->height = iheight;
        pdev->raster = gx_device_raster((gx_device *)pdev, 1);
        gdev_mem_data_size(pdev, (pdev)->width, (pdev)->height, &isize);
        ...
        gs_make_mem_abuf_device(dev, dev->memory, (gx_device *) dev2,
                                pscale, depth, 0, ((bool)0));
        dev->rc = rc;
        dev->width = iwidth;
        dev->height = 2 << log2_yscale;
        gdev_mem_data_size(dev, (dev)->width, (dev)->height, &isize);
        gdev_mem_data_size(dev2, (dev2)->width, (dev2)->height, &isize2);
        isize += isize2;
        dev->HWResolution[0] = HWResolution0 * (1 >> log2_xscale);
        dev->HWResolution[1] = HWResolution1 * (1 >> log2_yscale);
    }
    icdsize = isize + ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) );
    ...
    *pcc = cc;
    ...
    if (dev2) {
        ...
        byte *bits = ((byte *)(cc) + ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) ));
        ulong bsize;

        gdev_mem_data_size(dev2, (dev2)->width, (dev2)->height, &bsize);
        memset(bits, 0, bsize);
        dev2->base = bits;
        (*((dev2)->procs.open_device)) ((gx_device *) dev2);
        dev->base = bits + bsize;
        (*((dev)->procs.open_device)) ((gx_device *) dev);
    } else if (dev)
...
gx_open_cache_device(gx_device_memory * dev, cached_char * cc)
{
    ...
    gdev_mem_data_size(dev, (dev)->width, (dev)->height, &bsize);
...
# 747 "./base/gxccman.c"
        ...
        nraster = ((uint)((((nwidth_bits) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3));
    ...
    cc->offset.x -= ((fixed)(bbox.p.x)<<8);
    cc->offset.y -= ((fixed)(bbox.p.y)<<8);
    ...
    ((cc)->raster = (nraster));
    {
        uint diff = ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (cc->head.size - ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) ) - nraster * cc->height) - (cc->head.size - ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) ) - nraster * cc->height) % ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (cc->head.size - ( ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) & (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1) ? (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) / ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) * ((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) : (((int)sizeof(cached_char)) + (((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) - 1)) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) ) - nraster * cc->height) & -((((((1 << 3)) > ((((8) > (8)) ? (8) : (8)))) ? ((1 << 3)) : ((((8) > (8)) ? (8) : (8)))))) );
...
gs_purge_font_from_char_caches_forced(gs_font * font, bool force)
{
    ...
    font->is_cached = ((bool)0);
    do { } while (0);

    for (; count--; pair++) {
        if (pair->font == font) {
            if (!force && ((&pair->UID)->id != (~(-1L << ((1 << 3) * 8 - 1))))) {
...
{
# 879 "./base/gxccman.c"
    return gs_purge_font_from_char_caches_forced(font, ((bool)0));
}
...
gs_purge_font_from_char_caches_completely(gs_font * font)
{
    ...
    return gs_purge_font_from_char_caches_forced(font, ((bool)1));
}
    ...
    if (cc == 0) {
        if (dir->ccache.bspace < dir->ccache.bmax) {
            ...
            cck = (char_cache_chunk *)
                ((mem)->procs.alloc_bytes_immovable(mem, sizeof(*cck), "char cache chunk"));

            if (cck == 0)
                return 0;
            cdata =
                (byte *)(*(mem)->procs.alloc_struct_array_immovable)(mem, cksize, &st_font_cache_bytes, "char cache chunk(data)");


            if (cdata == 0) {
                ((mem)->procs.free_object(mem, cck, "char cache chunk"));
                return 0;
            }
