...
static gs_ptr_type_t show_enum_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void show_enum_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_gs_show_enum = { sizeof(gs_show_enum), "gs_show_enum", 0, 0, show_enum_enum_ptrs, show_enum_reloc_ptrs, 0, 0 };
extern const gs_memory_struct_type_t st_gs_text_enum;
extern const gs_memory_struct_type_t st_gs_state;
static
gs_ptr_type_t show_enum_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { switch ( index ) { default:
     return (*(st_gs_text_enum).enum_ptrs)(mem, vptr, size, index - 5, pep, &(st_gs_text_enum), gcst);
case 0: return (pep->ptr = (const void *)(((const gs_show_enum *)vptr)->pgs), (&ptr_struct_procs));
case 1: return (pep->ptr = (const void *)(((const gs_show_enum *)vptr)->show_gstate), (&ptr_struct_procs));
case 2: return (pep->ptr = (const void *)(((const gs_show_enum *)vptr)->dev_cache), (&ptr_struct_procs)); case (2)+1: return (pep->ptr = (const void *)(((const gs_show_enum *)vptr)->dev_cache2), (&ptr_struct_procs)); case (2)+2: return (pep->ptr = (const void *)(((const gs_show_enum *)vptr)->dev_null), (&ptr_struct_procs));
} }
static void show_enum_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_show_enum *eptr = vptr;
{
    (*(st_gs_text_enum).reloc_ptrs)(vptr, size, &(st_gs_text_enum), gcst);
    (eptr->pgs = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(eptr->pgs), gcst)));
    (eptr->show_gstate = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(eptr->show_gstate), gcst)));
    (((gs_show_enum *)vptr)->dev_cache = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_show_enum *)vptr)->dev_cache), gcst))); (((gs_show_enum *)vptr)->dev_cache2 = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_show_enum *)vptr)->dev_cache2), gcst))); (((gs_show_enum *)vptr)->dev_null = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_show_enum *)vptr)->dev_null), gcst)));
}
}
...
gs_show_enum_alloc(gs_memory_t * mem, gs_state * pgs, client_name_t cname)
{
    ...
    do { if ( ((penum) = (gs_show_enum *)(*(mem)->procs.alloc_struct)(mem, &st_gs_show_enum, cname)) == 0 ) { return 0; } else { do { (penum)->rc.ref_count = 1; (penum)->rc.memory = mem; (penum)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0);

    penum->rc.free = rc_free_text_enum;
    penum->auto_release = ((bool)1);
...
static int gx_show_text_resync(gs_text_enum_t *pte, const gs_text_enum_t *pfrom);
static int gx_show_text_process(gs_text_enum_t *pte);
static bool gx_show_text_is_width_only(const gs_text_enum_t *pte);
static int gx_show_text_current_width(const gs_text_enum_t *pte, gs_point *pwidth);
static int gx_show_text_set_cache(gs_text_enum_t *pte, const double *values, gs_text_cache_control_t control);
static int gx_show_text_retry(gs_text_enum_t *pte);
static void gx_show_text_release(gs_text_enum_t *pte, client_name_t cname);
                      ...
                      gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    bool propagate_charpath = (operation & 0x00400) != 0;
    int code;
    ...
    if ((*(mem)->procs.object_type)(mem, pis) != &st_gs_state)
        return ((-100));
    ...
    if (code < 0) {
        ((mem)->procs.free_object(mem, penum, "gx_default_text_begin"));
        return code;
    }
    penum->auto_release = ((bool)0);
    penum->level = pgs->level;
    if (operation & (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000))
        penum->charpath_flag =
            (operation & 0x01000 ? cpm_false_charpath :
             operation & 0x02000 ? cpm_true_charpath :
             operation & 0x04000 ? cpm_false_charboxpath :
             operation & 0x08000 ? cpm_true_charboxpath :
             operation & 0x00800 ? cpm_charwidth :
             cpm_show );
    else
        penum->charpath_flag =
    ...
    penum->show_gstate =
        (propagate_charpath && (pgs->in_charpath != 0) ?
         pgs->show_gstate : pgs);
    if((operation &
         (0x00200 | 0x20000 | 0x40000)) ==
         (0x00200 | 0x20000)) {

        gx_device_null *dev_null =
            (gx_device_null *)(*(mem)->procs.alloc_struct)(mem, &st_device_null, "stringwidth(dev_null)");
...
{
    int (*next_proc)(gs_text_enum_t *pte, gs_char *pchar, gs_glyph *pglyph) = pgs->font->procs.next_char_glyph;
    ...
    if (next_proc == gs_default_next_char_glyph)
        ...
        code = gs_text_enum_init(&tenum, &default_text_procs,
                             ((void*)0), ((void*)0), text, pgs->root_font,
                             ((void*)0), ((void*)0), ((void*)0), mem);
        if (code < 0)
            return code;
...
gx_hld_stringwidth_begin(gs_imager_state * pis, gx_path **path)
{
    ...
    if ((*(pis->memory)->procs.object_type)(pis->memory, pis) != &st_gs_state)
        return ((-28));
    code = gs_gsave(pgs);
    if (code < 0)
        return code;
...
gx_default_text_restore_state(gs_text_enum_t *pte)
{
    ...
    if ((((pte)->text.operation & (0x00200)) != 0))
        return 0;
                          ...
                          gs_text_cache_control_t control)
{
    ...
    case TEXT_SET_CACHE_DEVICE: {
        ...
        if (code < 0)
            return code;
        if ((((penum)->text.operation & (0x00200 | 0x10000)) == (0x00200 | 0x10000)))
            return code;
...
set_char_width(gs_show_enum *penum, gs_state *pgs, double wx, double wy)
{
    ...
    if (code < 0 && penum->cc == 0) {
        ...
        code = gs_distance_transform(wx, wy, &(*(const gs_matrix *)&(pgs)->ctm), &penum->wxy_float);
        penum->wxy.x = penum->wxy.y = 0;
        penum->use_wxy_float = ((bool)1);
    } else {
        penum->use_wxy_float = ((bool)0);
    ...
    if ((((penum)->text.operation & (0x00200 | 0x10000)) == (0x00200 | 0x10000)))
        gs_nulldevice(pgs);
    return !!(((penum)->text.operation & (0x00200)) != 0);
}
                    ...
                    gs_fixed_point *subpix_origin, gs_log2_scale_point *log2_scale)
{
    ...
    *alpha_bits = (*((dev)->procs.get_alpha_bits)) (dev, go_text);
    if (in_setcachedevice) {

    } else {
        code = ( !pgs->current_point_valid ? ((-14)) : ((&penum->origin)->x = ((fixed)floor((pgs->current_point.x)*(float)(1<<8) + 0.5)), (&penum->origin)->y = ((fixed)floor((pgs->current_point.y)*(float)(1<<8) + 0.5)), 0) );
        if (code < 0) {

            if (!(((penum)->text.operation & (0x00200)) != 0))
                return code;
    ...
    *depth = (log2_scale->x + log2_scale->y == 0 ?
        1 : (((log2_scale->x + log2_scale->y) < (*alpha_bits)) ? (log2_scale->x + log2_scale->y) : (*alpha_bits)));
    if (gs_currentaligntopixels(penum->current_font->dir) == 0) {
        int scx = -1L << (8 - log2_scale->x);
        int rdx = 1L << (8 - 1 - log2_scale->x);
        ...
        subpix_origin->x = ((penum->origin.x + rdx) & scx) & ((1L << 8) - 1);
    } else
                 ...
                 double urx, double ury)
{
    ...
    if (penum->can_cache <= 0 || !pgs->char_tm_valid) {
        ...
        static const fixed max_cdim[3] =
        {
            ...
            ((1L << 8) << ((1 << 1) * 8 - 0)) - ((1L << 8) >> 0) * 3, ((1L << 8) << ((1 << 1) * 8 - 1)) - ((1L << 8) >> 1) * 3, ((1L << 8) << ((1 << 1) * 8 - 2)) - ((1L << 8) >> 2) * 3
            ...
            return 0;
        {
            ...
            if ( (cll.x) > (cur.x) ) ctemp = cll.x, cll.x = cur.x, cur.x = ctemp;
            if ( (cll.y) > (cur.y) ) ctemp = cll.y, cll.y = cur.y, cur.y = ctemp;
            if ( (clr.x) > (cul.x) ) ctemp = clr.x, clr.x = cul.x, cul.x = ctemp;
            if ( (clr.y) > (cul.y) ) ctemp = clr.y, clr.y = cul.y, cul.y = ctemp;
        ...
        code = compute_glyph_raster_params(penum, ((bool)1), &alpha_bits, &depth,
...
# 586 "./base/gxchar.c"
        ...
        if (cdim.x > max_cdim[log2_scale.x] ||
            ...
            return 0;
        iwidth = ((ushort) ((int)((cdim.x) >> (8))) + 3) << log2_scale.x;
        iheight = ((ushort) ((int)((cdim.y) >> (8))) + 3) << log2_scale.y;
        do { } while (0);
        ...
        code = gx_alloc_char_bits(dir, penum->dev_cache,
                                (iwidth > ((uint)80000) / iheight &&
                                 log2_scale.x + log2_scale.y > alpha_bits ?
                                 penum->dev_cache2 : ((void*)0)),
        ...
        if (cc == 0) {
            ...
            clip_box.p.x = penum->origin.x - (((-cll.x)+((1<<8)-1))&(-1L<<8));
            clip_box.p.y = penum->origin.y - (((-cll.y)+((1<<8)-1))&(-1L<<8));
            clip_box.q.x = clip_box.p.x + ((fixed)(iwidth)<<8);
            clip_box.q.y = clip_box.p.y + ((fixed)(iheight)<<8);
            (void)gx_path_init_local_shared(&box_path, ((void*)0), pgs->memory);
            code = gx_path_add_rectangle(&box_path, clip_box.p.x, clip_box.p.y,
                                                    clip_box.q.x, clip_box.q.y);
            if (code < 0)
                return code;
            code = gx_cpath_clip(pgs, pgs->clip_path, &box_path, (-1));
        ...
        cc->offset.x = (((-cll.x)+((1<<8)-1))&(-1L<<8)) + (1L << 8);
        cc->offset.y = (((-cll.y)+((1<<8)-1))&(-1L<<8)) + (1L << 8);
        do { } while (0);
        ...
        if (penum->pair != 0)
            ((cc)->pair_index = ((cc)->pair = (penum->pair))->index);
        else
            cc->pair = 0;
        ...
        clip_box.q.x = ((fixed)(iwidth)<<8);
        clip_box.q.y = ((fixed)(iheight)<<8);
...
{
    penum->encode_char =
        ((((penum)->text.operation & (0x00008 | 0x00020)) != 0) ?
         gs_no_encode_char :
    ...
    switch (penum->width_status) {
        ...
        case sws_cache:
            ...
            { cached_fm_pair *pair;
                ...
                code = gx_lookup_fm_pair(pgs->font, &*(gs_matrix *)&(pgs)->char_tm,
            ...
            if (!!(((penum)->text.operation & (0x00200 | 0x00800)) != 0) ||
        ...
        case sws_cache_width_only:
            ...
            if (code < 0)
                return code;
            code = (*(((pgs)->color[0].dev_color))->type->load)(((pgs)->color[0].dev_color), (const gs_imager_state *)(pgs), (pgs)->device, gs_color_select_texture);
            if (code < 0)
                return code;
...
show_fast_move(gs_state * pgs, gs_fixed_point * pwxy)
{
    return gs_moveto_aux((gs_imager_state *)pgs, pgs->path,
                              pgs->current_point.x + ((pwxy->x)*(1.0/(1<<8))),
                              pgs->current_point.y + ((pwxy->y)*(1.0/(1<<8))));
}
...
int gx_current_char(const gs_text_enum_t * pte)
{
    ...
    gs_char chr = ((penum)->returned.current_char) & 0xff;
    ...
    if (fdepth > 0) {
        ...
        case fmap_9_7:
            ...
            break;
        case fmap_CMap:
            chr = ((penum)->returned.current_char);
            if (!penum->cmap_code)
                break;
...
show_move(gs_show_enum * penum)
{
    ...
    if ((((penum)->text.operation & (0x00100)) != 0)) {
        gs_point dpt;
        ...
        if ((((penum)->text.operation & (0x00080)) != 0)
        ...
        if ((((penum)->text.operation & (0x00040)) != 0)) {
...

    {
        ...
        if (penum->use_wxy_float)
            code = gs_moveto_aux((gs_imager_state *)pgs, pgs->path,
                    pgs->current_point.x + penum->wxy_float.x + ((penum->wxy.x)*(1.0/(1<<8))),
                    pgs->current_point.y + penum->wxy_float.y + ((penum->wxy.y)*(1.0/(1<<8))));
        else
    ...
    if ((((penum)->text.operation & (0x10000)) != 0) && penum->index < penum->text.size) {
        penum->continue_proc = continue_kshow;
        return 2;
    }
    return 0;
...
show_proceed(gs_show_enum * penum)
{
    ...
    if (penum->charpath_flag == cpm_show && !(((penum)->text.operation & (0x00200 | 0x00800)) != 0)) {
        code = (*(((pgs)->color[0].dev_color))->type->load)(((pgs)->color[0].dev_color), (const gs_imager_state *)(pgs), (pgs)->device, gs_color_select_texture);
        if (code < 0)
            return code;
    }
  more:
    ...
    if (penum->can_cache >= 0) {
        ...
        for (;;) {
            start = penum->index;
            switch ((code = (++(penum->xy_index), next_char_glyph((gs_text_enum_t *)penum, &chr, &glyph)))
                ...
                case 0:
                    ...
                    penum->is_pure_color = (((((penum->pgs)->color[0].dev_color))->type == (&gx_dc_type_data_pure)) && ((((penum->pgs)->log_op) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc)));
...

                    {
                        ...
                        code = compute_glyph_raster_params(penum, ((bool)0),
                                    &alpha_bits, &depth, &subpix_origin, &log2_scale);
                        if (code < 0)
                            return code;
                        if (pair == 0) {
                            code = gx_lookup_fm_pair(pfont, &*(gs_matrix *)&(pgs)->char_tm, &log2_scale,
                    ...
                    if (penum->charpath_flag == cpm_charwidth) {
                        ...
                        if (code < 0)
                            return code;
                        llx = (((pt.x - cc->offset.x)+((1<<8)>>1))&(-1L<<8)) +
                            ((fixed)(penum->ftx)<<8);
                        lly = (((pt.y - cc->offset.y)+((1<<8)>>1))&(-1L<<8)) +
                            ((fixed)(penum->fty)<<8);
                        urx = llx + ((fixed)(cc->width)<<8),
                            ury = lly + ((fixed)(cc->height)<<8);
                        (void)gx_path_init_local_shared(&box_path, ((void*)0), pgs->memory);
                        code =
                    ...
                    penum->use_wxy_float = ((bool)0);
                    penum->wxy_float.x = penum->wxy_float.y = 0;
                    if ((((penum)->text.operation & (0x00100 | 0x00040 | 0x00080 | 0x10000)) != 0)) {
        ...
        switch ((code = (++(penum->xy_index), next_char_glyph((gs_text_enum_t *)penum, &chr, &glyph)))
            ...
            case 0:
                { int alpha_bits, depth;
                    ...
                    code = compute_glyph_raster_params(penum, ((bool)0), &alpha_bits, &depth, &subpix_origin, &log2_scale);
                    if (code < 0)
                        return code;
                    if (pair == 0) {
                        code = gx_lookup_fm_pair(pfont, &*(gs_matrix *)&(pgs)->char_tm, &log2_scale,
...
# 1179 "./base/gxchar.c"
    ...
    pgs->stroke_adjust = ((bool)0);
    {
        ...
        if ((code = ( !pgs->current_point_valid ? ((-14)) : ((&cpt)->x = ((fixed)floor((pgs->current_point.x)*(float)(1<<8) + 0.5)), (&cpt)->y = ((fixed)floor((pgs->current_point.y)*(float)(1<<8) + 0.5)), 0) )) < 0) {
        ...
        if (pgs->ctm.txy_fixed_valid && pgs->char_tm.txy_fixed_valid) {
            ...
            gs_settocharmatrix(pgs);
            fpx = ((cpt.x)*(1.0/(1<<8))) + (pgs->ctm.tx - tx);
            fpy = ((cpt.y)*(1.0/(1<<8))) + (pgs->ctm.ty - ty);

            if (!(((fpx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (fpx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((fpy) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (fpy) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))))) {
                (code = (-13));
                goto rret;
            }
            cpt.x = ((fixed)((fpx)*(float)(1<<8)));
            cpt.y = ((fixed)((fpy)*(float)(1<<8)));
        }
        gs_newpath(pgs);
...
show_finish(gs_show_enum * penum)
{
    ...
    if ((penum->text.operation & 0x01000) ||
        (penum->text.operation & 0x02000)) {
        if (pgs->path->segments->contents.subpath_current)
            pgs->path->last_charpath_segment = pgs->path->segments->contents.subpath_current->last;
    }
...
gx_show_text_release(gs_text_enum_t *pte, client_name_t cname)
{
    ...
    penum->cc = 0;
    if (penum->dev_cache2) {
        gx_device_retain((gx_device *)penum->dev_cache2, ((bool)0));
        penum->dev_cache2 = 0;
    }
    if (penum->dev_cache) {
        gx_device_retain((gx_device *)penum->dev_cache, ((bool)0));
        penum->dev_cache = 0;
    }
    if (penum->dev_null) {
        gx_device_retain((gx_device *)penum->dev_null, ((bool)0));
        penum->dev_null = 0;
    }
...
gx_show_text_is_width_only(const gs_text_enum_t *pte)
{
    ...
    return ((!!(((penum)->text.operation & (0x00200 | 0x00800)) != 0) || penum->cc != 0) &&
...
show_state_setup(gs_show_enum * penum)
{
    ...
    if (penum->fstack.depth <= 0) {
        ...
        if (pfont->FontType == ft_CID_encrypted) {
            ...
            int code = ((gs_font_cid0 *)pfont)->cidata.glyph_data((gs_font_base *)pfont,
                                penum->text.data.d_glyph, ((void*)0), &fidx);
            if (code < 0) {
               code = ((gs_font_cid0 *)pfont)->cidata.glyph_data((gs_font_base *)pfont,
                            (gs_glyph)(((gs_glyph)0x80000000L) + 0), ((void*)0), &fidx);
               if (code < 0)
                   return ((-10));
            }
    ...
    if (penum->can_cache >= 0 &&
        ...
        penum->ibox.p.x = ((int)((cbox.p.x) >> (8)));
        penum->ibox.p.y = ((int)((cbox.p.y) >> (8)));
        penum->ibox.q.x = ((int)(((cbox.q.x)+((1<<8)-1)) >> (8)));
        penum->ibox.q.y = ((int)(((cbox.q.y)+((1<<8)-1)) >> (8)));
        gx_cpath_outer_box(pcpath, &cbox);
        penum->obox.p.x = ((int)((cbox.p.x) >> (8)));
        penum->obox.p.y = ((int)((cbox.p.y) >> (8)));
        penum->obox.q.x = ((int)(((cbox.q.x)+((1<<8)-1)) >> (8)));
        penum->obox.q.y = ((int)(((cbox.q.y)+((1<<8)-1)) >> (8)));
        if (pgs->ctm.txy_fixed_valid && pgs->char_tm.txy_fixed_valid) {
            penum->ftx = (int)((long)((pgs->char_tm.tx_fixed - pgs->ctm.tx_fixed) >> (8)));

            penum->fty = (int)((long)((pgs->char_tm.ty_fixed - pgs->ctm.ty_fixed) >> (8)));
            ...
            if (!(((fdx) >= -2.0 * (1L << ((((1 << 2) * 8 - 1)) - 2)) && (fdx) < 2.0 * (1L << ((((1 << 2) * 8 - 1)) - 2))) &&
                  ((fdy) >= -2.0 * (1L << ((((1 << 2) * 8 - 1)) - 2)) && (fdy) < 2.0 * (1L << ((((1 << 2) * 8 - 1)) - 2))))
                )
                return ((-13));
...
show_set_scale(const gs_show_enum * penum, gs_log2_scale_point *log2_scale)
{
    ...
    if ((penum->charpath_flag == cpm_show ||
        ...
        !(((penum)->text.operation & (0x00200 | 0x00800)) != 0)
        ...
        if (code >= 0) {
            int sx =
            (((extent.x) < 0 ? -(extent.x) : (extent.x)) < ((fixed)(60)<<8) ? 2 :
             ((extent.x) < 0 ? -(extent.x) : (extent.x)) < ((fixed)(200)<<8) ? 1 :
             0);
            int sy =
            (((extent.y) < 0 ? -(extent.y) : (extent.y)) < ((fixed)(60)<<8) ? 2 :
             ((extent.y) < 0 ? -(extent.y) : (extent.y)) < ((fixed)(200)<<8) ? 1 :
             0);
...
show_cache_setup(gs_show_enum * penum)
{
    ...
    gx_device_memory *dev2 =
        (gx_device_memory *)(*(mem)->procs.alloc_struct)(mem, &st_device_memory, "show_cache_setup(dev_cache2)");
    ...
    penum->dev_cache = dev;
    gs_make_mem_mono_device(dev2, mem, ((pgs)->device));
    ...
    gx_device_retain((gx_device *)dev2, ((bool)1));
    return 0;
}
...
show_origin_setup(gs_state * pgs, fixed cpt_x, fixed cpt_y, gs_show_enum * penum)
{
    if (penum->charpath_flag == cpm_show) {
        ...
        if (gs_currentaligntopixels(penum->current_font->dir) == 0) {
            int scx = -1L << (8 - penum->log2_scale.x);
            int scy = -1L << (8 - penum->log2_scale.y);
            int rdx = 1L << (8 - 1 - penum->log2_scale.x);
            int rdy = 1L << (8 - 1 - penum->log2_scale.y);

            cpt_x = (cpt_x + rdx) & scx;
            cpt_y = (cpt_y + rdy) & scy;
        } else {
            cpt_x = (((cpt_x)+((1<<8)>>1))&(-1L<<8));
            cpt_y = (((cpt_y)+((1<<8)>>1))&(-1L<<8));
        }
    }
