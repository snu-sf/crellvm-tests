...
const byte enc_num_bytes[] = {
    4, 4, 2, 4, 0, 0, 0, 0, 4, 4, 2, 4, 0, 0, 0, 0, sizeof(ref)
};
        ...
        case t_string:
            {
                ...
                if (((op)->tas.rsize) < 4 || bp[0] != 149)
                    return ((-20));
                format = bp[1];
                if (!(((format) & 127) <= 49) ||
                    sdecodeshort(bp + 2, format) !=
                    (((op)->tas.rsize) - 4) / (enc_num_bytes[(format) >> 4])
                    )
                    return ((-15));
            }
            break;
...
{
    return (format == 256 ? ((op)->tas.rsize) :
            (((op)->tas.rsize) - 4) / (enc_num_bytes[(format) >> 4]));
}
...
static const double binary_scale[32] = {
    ...
    1.0, (0.5 / (1L << (1 -1))), (0.5 / (1L << (2 -1))), (0.5 / (1L << (3 -1))),
    (0.5 / (1L << (4 -1))), (0.5 / (1L << (5 -1))), (0.5 / (1L << (6 -1))), (0.5 / (1L << (7 -1))),
    (0.5 / (1L << (8 -1))), (0.5 / (1L << (9 -1))), (0.5 / (1L << (10 -1))), (0.5 / (1L << (11 -1))),
    (0.5 / (1L << (12 -1))), (0.5 / (1L << (13 -1))), (0.5 / (1L << (14 -1))), (0.5 / (1L << (15 -1))),
    (0.5 / (1L << (16 -1))), (0.5 / (1L << (17 -1))), (0.5 / (1L << (18 -1))), (0.5 / (1L << (19 -1))),
    (0.5 / (1L << (20 -1))), (0.5 / (1L << (21 -1))), (0.5 / (1L << (22 -1))), (0.5 / (1L << (23 -1))),
    (0.5 / (1L << (24 -1))), (0.5 / (1L << (25 -1))), (0.5 / (1L << (26 -1))), (0.5 / (1L << (27 -1))),
    (0.5 / (1L << (28 -1))), (0.5 / (1L << (29 -1))), (0.5 / (1L << (30 -1))), (0.5 / (1L << (31 -1)))
