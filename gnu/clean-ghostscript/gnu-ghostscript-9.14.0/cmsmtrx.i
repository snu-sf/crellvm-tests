# 1 "./lcms2/src/cmsmtrx.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmsmtrx.c" 2
# 27 "./lcms2/src/cmsmtrx.c"
...
void _cmsVEC3cross(cmsVEC3* r, const cmsVEC3* u, const cmsVEC3* v)
{
    r ->n[0] = u->n[1] * v->n[2] - v->n[1] * u->n[2];
    r ->n[1] = u->n[2] * v->n[0] - v->n[2] * u->n[0];
    r ->n[2] = u->n[0] * v->n[1] - v->n[0] * u->n[1];
}
...
cmsFloat64Number _cmsVEC3distance(const cmsVEC3* a, const cmsVEC3* b)
{
    cmsFloat64Number d1 = a ->n[0] - b ->n[0];
    cmsFloat64Number d2 = a ->n[1] - b ->n[1];
    cmsFloat64Number d3 = a ->n[2] - b ->n[2];
...
cmsBool _cmsMAT3isIdentity(const cmsMAT3* a)
{
    ...
    for (i=0; i < 3; i++)
        for (j=0; j < 3; j++)
            if (!CloseEnough(a ->v[i].n[j], Identity.v[i].n[j])) return 0;
...
void _cmsMAT3per(cmsMAT3* r, const cmsMAT3* a, const cmsMAT3* b)
{
    ...
    _cmsVEC3init(&r-> v[0], a->v[0].n[0]*b->v[0].n[0] + a->v[0].n[1]*b->v[1].n[0] + a->v[0].n[2]*b->v[2].n[0], a->v[0].n[0]*b->v[0].n[1] + a->v[0].n[1]*b->v[1].n[1] + a->v[0].n[2]*b->v[2].n[1], a->v[0].n[0]*b->v[0].n[2] + a->v[0].n[1]*b->v[1].n[2] + a->v[0].n[2]*b->v[2].n[2]);
    _cmsVEC3init(&r-> v[1], a->v[1].n[0]*b->v[0].n[0] + a->v[1].n[1]*b->v[1].n[0] + a->v[1].n[2]*b->v[2].n[0], a->v[1].n[0]*b->v[0].n[1] + a->v[1].n[1]*b->v[1].n[1] + a->v[1].n[2]*b->v[2].n[1], a->v[1].n[0]*b->v[0].n[2] + a->v[1].n[1]*b->v[1].n[2] + a->v[1].n[2]*b->v[2].n[2]);
    _cmsVEC3init(&r-> v[2], a->v[2].n[0]*b->v[0].n[0] + a->v[2].n[1]*b->v[1].n[0] + a->v[2].n[2]*b->v[2].n[0], a->v[2].n[0]*b->v[0].n[1] + a->v[2].n[1]*b->v[1].n[1] + a->v[2].n[2]*b->v[2].n[1], a->v[2].n[0]*b->v[0].n[2] + a->v[2].n[1]*b->v[1].n[2] + a->v[2].n[2]*b->v[2].n[2]);
...
cmsBool _cmsMAT3solve(cmsVEC3* x, cmsMAT3* a, cmsVEC3* b)
{
    ...
    if (!_cmsMAT3inverse(&m, &a_1)) return 0;
...
void _cmsMAT3eval(cmsVEC3* r, const cmsMAT3* a, const cmsVEC3* v)
{
    r->n[0] = a->v[0].n[0]*v->n[0] + a->v[0].n[1]*v->n[1] + a->v[0].n[2]*v->n[2];
    r->n[1] = a->v[1].n[0]*v->n[0] + a->v[1].n[1]*v->n[1] + a->v[1].n[2]*v->n[2];
    r->n[2] = a->v[2].n[0]*v->n[0] + a->v[2].n[1]*v->n[1] + a->v[2].n[2]*v->n[2];
}
