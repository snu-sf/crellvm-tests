# 1 "./jbig2dec/jbig2_metadata.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./jbig2dec/jbig2_metadata.c" 2
# 24 "./jbig2dec/jbig2_metadata.c"
...
# 25 "./jbig2dec/jbig2_metadata.c" 2
...
# 27 "./jbig2dec/jbig2_metadata.c" 2
...
# 28 "./jbig2dec/jbig2_metadata.c" 2
...
# 30 "./jbig2dec/jbig2_metadata.c" 2
...
# 31 "./jbig2dec/jbig2_metadata.c" 2
# 1 "./jbig2dec/jbig2_metadata.h" 1
# 28 "./jbig2dec/jbig2_metadata.h"
typedef enum {
...
int jbig2_comment_unicode(Jbig2Ctx *ctx, Jbig2Segment *segment,
                               const uint8_t *segment_data);
# 32 "./jbig2dec/jbig2_metadata.c" 2


Jbig2Metadata *jbig2_metadata_new(Jbig2Ctx *ctx, Jbig2Encoding encoding)
{
    Jbig2Metadata *md = ((Jbig2Metadata *)jbig2_alloc(ctx->allocator, 1, sizeof(Jbig2Metadata)));

    if (md != ((void*)0)) {
        md->encoding = encoding;
        md->entries = 0;
        md->max_entries = 4;
        md->keys = ((char* *)jbig2_alloc(ctx->allocator, md->max_entries, sizeof(char*)));
        md->values = ((char* *)jbig2_alloc(ctx->allocator, md->max_entries, sizeof(char*)));
        if (md->keys == ((void*)0) || md->values == ((void*)0)) {
...
{
    char *s = ((char *)jbig2_alloc(ctx->allocator, len, sizeof(char)));
    if (s == ((void*)0)) {
        jbig2_error(ctx, JBIG2_SEVERITY_FATAL, -1,
                        ...
                        const char *value, const int value_length)
{
    ...
    if (md->entries == md->max_entries) {
        md->max_entries <<= 1;
        keys = ((char* *)jbig2_realloc(ctx->allocator, (md->keys), md->max_entries, sizeof(char*)));
        values = ((char* *)jbig2_realloc(ctx->allocator, (md->values), md->max_entries, sizeof(char*)));
