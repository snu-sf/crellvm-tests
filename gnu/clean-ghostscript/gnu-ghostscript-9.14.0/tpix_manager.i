# 1 "./openjpeg/libopenjpeg/tpix_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/tpix_manager.c" 2
# 36 "./openjpeg/libopenjpeg/tpix_manager.c"
...
# 37 "./openjpeg/libopenjpeg/tpix_manager.c" 2
# 46 "./openjpeg/libopenjpeg/tpix_manager.c"
int get_num_max_tile_parts( opj_codestream_info_t cstr_info);
# 60 "./openjpeg/libopenjpeg/tpix_manager.c"
                    ...
                    opj_event_mgr_t * p_manager )
{
  ...
  opj_write_bytes_LE(l_data_header,0x74706978,4);
                        ...
                        opj_event_mgr_t * p_manager )
{
  ...
  opj_write_bytes_LE(l_data_header,num_max_tile_parts,size_of_coding);
  ...
  for (i = 0; i < cstr_info.tw*cstr_info.th; i++)
    ...
    for (j = 0; j < cstr_info.tile[i].num_tps; j++)
      ...
      opj_write_bytes_LE(l_data_header,tp.tp_start_pos-coff,size_of_coding);
      opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
      opj_write_bytes_LE(l_data_header,tp.tp_end_pos-tp.tp_start_pos+1,size_of_coding);
      opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
      ...
      if (version & 0x02)
        ...
        opj_write_bytes_LE(l_data_header,Aux,4);
        opj_stream_write_data(cio,l_data_header,4,p_manager);
    ...
    while (j < num_max_tile_parts)
      ...
      if (version & 0x02)
      opj_write_bytes_LE(l_data_header,0,4);
      opj_stream_write_data(cio,l_data_header,4,p_manager);
      j++;
      }
    }
...
int get_num_max_tile_parts( opj_codestream_info_t cstr_info)
{
  ...
  for( i=0; i<cstr_info.tw*cstr_info.th; i++)
    num_max_tp = ((cstr_info.tile[i].num_tps)>(num_max_tp)?(cstr_info.tile[i].num_tps):(num_max_tp));
