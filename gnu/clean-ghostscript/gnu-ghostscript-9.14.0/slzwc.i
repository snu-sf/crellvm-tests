...
static const gc_ptr_element_t lzwd_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((stream_LZW_state *)0)->table.decode - (char *)((stream_LZW_state *)0) )) } }; static const gc_struct_data_t lzwd_reloc_ptrs = { (sizeof(lzwd_enum_ptrs) / sizeof((lzwd_enum_ptrs)[0])), 0, 0, lzwd_enum_ptrs }; const gs_memory_struct_type_t st_LZW_state = { sizeof(stream_LZW_state), "LZWDecode state", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &lzwd_reloc_ptrs };
...
s_LZW_set_defaults(stream_state * st)
{
    ...
    ((ss)->InitialCodeLength = 8, (ss)->FirstBitLowOrder = ((bool)0), (ss)->BlockData = ((bool)0), (ss)->EarlyChange = 1, (ss)->table.decode = 0);
}
...
s_LZW_release(stream_state * st)
{
    ...
    ((st->memory)->procs.free_object(st->memory, ss->table.decode, "LZW(close)"));
}
