# 1 "./devices/vector/gdevpdtf.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpdtf.c" 2
# 18 "./devices/vector/gdevpdtf.c"
# 1 "./base/memory_.h" 1
# 23 "./base/memory_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 55 "./base/memory_.h" 2
# 19 "./devices/vector/gdevpdtf.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
...
# 20 "./devices/vector/gdevpdtf.c" 2
...
# 22 "./devices/vector/gdevpdtf.c" 2
# 1 "./base/gxfcache.h" 1
# 23 "./base/gxfcache.h"
# 1 "./base/gsccode.h" 1
# 27 "./base/gsccode.h"
...
# 23 "./devices/vector/gdevpdtf.c" 2
# 1 "./base/gxfcid.h" 1
# 22 "./base/gxfcid.h"
# 1 "./base/gxcid.h" 1
# 27 "./base/gxcid.h"
...
# 24 "./devices/vector/gdevpdtf.c" 2
# 1 "./base/gxfcmap.h" 1
# 24 "./base/gxfcmap.h"
# 1 "./base/gsfcmap.h" 1
# 27 "./base/gsfcmap.h"
...
# 25 "./devices/vector/gdevpdtf.c" 2
...
# 26 "./devices/vector/gdevpdtf.c" 2
...
# 28 "./devices/vector/gdevpdtf.c" 2
...
int psf_convert_type1_to_type2(stream *s, const gs_glyph_data_t *pgd,
                               gs_font_type1 *pfont);
# 29 "./devices/vector/gdevpdtf.c" 2
...
# 30 "./devices/vector/gdevpdtf.c" 2
# 1 "./devices/vector/gdevpdtb.h" 1
# 22 "./devices/vector/gdevpdtb.h"
...
# 23 "./devices/vector/gdevpdtb.h" 2
# 64 "./devices/vector/gdevpdtb.h"
...
# 31 "./devices/vector/gdevpdtf.c" 2
...
# 32 "./devices/vector/gdevpdtf.c" 2
# 1 "./devices/vector/gdevpdtf.h" 1
# 93 "./devices/vector/gdevpdtf.h"
...
# 33 "./devices/vector/gdevpdtf.c" 2
# 1 "./devices/vector/gdevpdtw.h" 1
# 34 "./devices/vector/gdevpdtw.h"
int
...
# 34 "./devices/vector/gdevpdtf.c" 2
...
# 35 "./devices/vector/gdevpdtf.c" 2
# 1 "./devices/vector/whitelst.h" 1
# 23 "./devices/vector/whitelst.h"
int IsInWhiteList (const char *Name, int size);
# 36 "./devices/vector/gdevpdtf.c" 2


static gs_ptr_type_t pdf_font_resource_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void pdf_font_resource_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_pdf_font_resource = { sizeof(pdf_font_resource_t), "pdf_font_resource_t", 0, 0, pdf_font_resource_enum_ptrs, pdf_font_resource_reloc_ptrs, 0, 0 };
static const gc_ptr_element_t pdf_encoding1_enum_ptrs[] = { { GC_ELT_CONST_STRING, ((int) ( (char *)&((pdf_encoding_element_t *)0)->str - (char *)((pdf_encoding_element_t *)0) )) } }; static const gc_struct_data_t pdf_encoding1_reloc_ptrs = { (sizeof(pdf_encoding1_enum_ptrs) / sizeof((pdf_encoding1_enum_ptrs)[0])), 0, 0, pdf_encoding1_enum_ptrs }; static const gs_memory_struct_type_t st_pdf_encoding1 = { sizeof(pdf_encoding_element_t), "pdf_encoding_element_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &pdf_encoding1_reloc_ptrs };
static gs_ptr_type_t pdf_encoding_elt_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { uint count = size / (uint)sizeof(pdf_encoding_element_t); if ( count == 0 ) return 0; return (*(st_pdf_encoding1).enum_ptrs)(mem, (const char *)vptr + (index % count) * sizeof(pdf_encoding_element_t), sizeof(pdf_encoding_element_t), index / count, pep, &(st_pdf_encoding1), gcst); } static void pdf_encoding_elt_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { { uint count = size / (uint)sizeof(pdf_encoding_element_t); for ( ; count; count--, vptr = (char *)vptr + sizeof(pdf_encoding_element_t) ) (*(st_pdf_encoding1).reloc_ptrs)(vptr, sizeof(pdf_encoding_element_t), &(st_pdf_encoding1), gcst); } } static const gs_memory_struct_type_t st_pdf_encoding_element = { sizeof(pdf_encoding_element_t), "pdf_encoding_element_t[]", 0, 0, pdf_encoding_elt_enum_ptrs, pdf_encoding_elt_reloc_ptrs, 0, 0 };
static const gc_ptr_element_t pdf_std_font_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((pdf_standard_font_t *)0)->pdfont - (char *)((pdf_standard_font_t *)0) )) } }; static const gc_struct_data_t pdf_std_font_reloc_ptrs = { (sizeof(pdf_std_font_enum_ptrs) / sizeof((pdf_std_font_enum_ptrs)[0])), 0, 0, pdf_std_font_enum_ptrs }; static const gs_memory_struct_type_t st_pdf_standard_font = { sizeof(pdf_standard_font_t), "pdf_standard_font_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &pdf_std_font_reloc_ptrs };
static gs_ptr_type_t pdf_std_font_elt_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { uint count = size / (uint)sizeof(pdf_standard_font_t); if ( count == 0 ) return 0; return (*(st_pdf_standard_font).enum_ptrs)(mem, (const char *)vptr + (index % count) * sizeof(pdf_standard_font_t), sizeof(pdf_standard_font_t), index / count, pep, &(st_pdf_standard_font), gcst); } static void pdf_std_font_elt_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { { uint count = size / (uint)sizeof(pdf_standard_font_t); for ( ; count; count--, vptr = (char *)vptr + sizeof(pdf_standard_font_t) ) (*(st_pdf_standard_font).reloc_ptrs)(vptr, sizeof(pdf_standard_font_t), &(st_pdf_standard_font), gcst); } } static const gs_memory_struct_type_t st_pdf_standard_font_element = { sizeof(pdf_standard_font_t), "pdf_standard_font_t[]", 0, 0, pdf_std_font_elt_enum_ptrs, pdf_std_font_elt_reloc_ptrs, 0, 0 };
static const gc_ptr_element_t pdf_outline_fonts_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((pdf_outline_fonts_t *)0)->standard_fonts - (char *)((pdf_outline_fonts_t *)0) )) } }; static const gc_struct_data_t pdf_outline_fonts_reloc_ptrs = { (sizeof(pdf_outline_fonts_enum_ptrs) / sizeof((pdf_outline_fonts_enum_ptrs)[0])), 0, 0, pdf_outline_fonts_enum_ptrs }; static const gs_memory_struct_type_t st_pdf_outline_fonts = { sizeof(pdf_outline_fonts_t), "pdf_outline_fonts_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &pdf_outline_fonts_reloc_ptrs };

static
gs_ptr_type_t pdf_font_resource_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const pdf_font_resource_t *pdfont = vptr; switch ( index ) { default:
return (*(st_pdf_resource).enum_ptrs)(mem, vptr, size, index-(12), pep, &(st_pdf_resource), gcst);
case 0: return (pep->ptr = (&pdfont->BaseFont)->data, pep->size = (&pdfont->BaseFont)->size, (&ptr_string_procs));
case 1: return (pep->ptr = (const void *)(pdfont->FontDescriptor), (&ptr_struct_procs));
case 2: return (pep->ptr = (const void *)(pdfont->base_font), (&ptr_struct_procs));
case 3: return (pep->ptr = (const void *)(pdfont->Widths), (&ptr_struct_procs));
case 4: return (pep->ptr = (const void *)(pdfont->used), (&ptr_struct_procs));
case 5: return (pep->ptr = (const void *)(pdfont->res_ToUnicode), (&ptr_struct_procs));
case 6: return (pep->ptr = (const void *)(pdfont->cmap_ToUnicode), (&ptr_struct_procs));
case 7: switch (pdfont->FontType) {
 case ft_composite:
     return (pep->ptr = (const void *)(pdfont->u.type0.DescendantFont), (&ptr_struct_procs));
 case ft_CID_encrypted:
 case ft_CID_TrueType:
     return (pep->ptr = (const void *)(pdfont->u.cidfont.Widths2), (&ptr_struct_procs));
 default:
     pdf_mark_glyph_names(pdfont, mem);
     return (pep->ptr = (const void *)(pdfont->u.simple.Encoding), (&ptr_struct_procs));
}
case 8: switch (pdfont->FontType) {
 case ft_composite:
     return (pdfont->u.type0.cmap_is_standard ? (pep->ptr = (const void *)(0), (&ptr_struct_procs)) :
             (pep->ptr = (&pdfont->u.type0.CMapName)->data, pep->size = (&pdfont->u.type0.CMapName)->size, (&ptr_const_string_procs)));
 case ft_encrypted:
 case ft_encrypted2:
 case ft_TrueType:
 ...
 case ft_GL2_531:
     return (pep->ptr = (const void *)(pdfont->u.simple.v), (&ptr_struct_procs));
 case ft_CID_encrypted:
 case ft_CID_TrueType:
     return (pep->ptr = (const void *)(pdfont->u.cidfont.v), (&ptr_struct_procs));
 default:
...
case 9: switch (pdfont->FontType) {
 ...
 case ft_user_defined:
 case ft_GL2_531:
     return (pep->ptr = (const void *)(pdfont->u.simple.s.type3.char_procs), (&ptr_struct_procs));
 case ft_CID_encrypted:
 case ft_CID_TrueType:
     return (pep->ptr = (const void *)(pdfont->u.cidfont.CIDToGIDMap), (&ptr_struct_procs));
 default:
     return (pep->ptr = (const void *)(0), (&ptr_struct_procs));
}
case 10: switch (pdfont->FontType) {
 ...
 case ft_user_defined:
 case ft_GL2_531:
     return (pep->ptr = (const void *)(pdfont->u.simple.s.type3.cached), (&ptr_struct_procs));
 case ft_CID_encrypted:
 case ft_CID_TrueType:
     return (pep->ptr = (const void *)(pdfont->u.cidfont.parent), (&ptr_struct_procs));
 default:
     return (pep->ptr = (const void *)(0), (&ptr_struct_procs));
}
case 11: switch (pdfont->FontType) {
 ...
 case ft_user_defined:
 case ft_GL2_531:
     return (pep->ptr = (const void *)(pdfont->u.simple.s.type3.Resources), (&ptr_struct_procs));
 case ft_CID_encrypted:
 case ft_CID_TrueType:
     return (pep->ptr = (const void *)(pdfont->u.cidfont.used2), (&ptr_struct_procs));
 default:
     return (pep->ptr = (const void *)(0), (&ptr_struct_procs));
}
} }
static
void pdf_font_resource_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { pdf_font_resource_t *pdfont = vptr;
{
    (*(st_pdf_resource).reloc_ptrs)(vptr, size, &(st_pdf_resource), gcst);
    (((*(const gc_procs_common_t **)(gcst))->reloc_string)(&(pdfont->BaseFont), gcst));
    (pdfont->FontDescriptor = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->FontDescriptor), gcst)));
    (pdfont->base_font = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->base_font), gcst)));
    (pdfont->Widths = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->Widths), gcst)));
    (pdfont->used = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->used), gcst)));
    (pdfont->res_ToUnicode = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->res_ToUnicode), gcst)));
    (pdfont->cmap_ToUnicode = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->cmap_ToUnicode), gcst)));
    switch (pdfont->FontType) {
    case ft_composite:
        if (!pdfont->u.type0.cmap_is_standard)
            (((*(const gc_procs_common_t **)(gcst))->reloc_const_string)(&(pdfont->u.type0.CMapName), gcst));
        (pdfont->u.type0.DescendantFont = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.type0.DescendantFont), gcst)));
        break;
    case ft_PCL_user_defined:
    case ft_MicroType:
    case ft_GL2_stick_user_defined:
    case ft_user_defined:
    case ft_GL2_531:
        (pdfont->u.simple.Encoding = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.simple.Encoding), gcst)));
        (pdfont->u.simple.v = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.simple.v), gcst)));
        (pdfont->u.simple.s.type3.char_procs = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.simple.s.type3.char_procs), gcst)));
        (pdfont->u.simple.s.type3.cached = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.simple.s.type3.cached), gcst)));
        (pdfont->u.simple.s.type3.Resources = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.simple.s.type3.Resources), gcst)));
        break;
    case ft_CID_encrypted:
    case ft_CID_TrueType:
        (pdfont->u.cidfont.Widths2 = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.cidfont.Widths2), gcst)));
        (pdfont->u.cidfont.v = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.cidfont.v), gcst)));
        (pdfont->u.cidfont.CIDToGIDMap = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.cidfont.CIDToGIDMap), gcst)));
        (pdfont->u.cidfont.parent = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.cidfont.parent), gcst)));
        (pdfont->u.cidfont.used2 = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.cidfont.used2), gcst)));
        break;
    default:
        (pdfont->u.simple.Encoding = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.simple.Encoding), gcst)));
        (pdfont->u.simple.v = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pdfont->u.simple.v), gcst)));
...
{
    bool has_uid = (((&bfont->UID)->id & ~0xffffff) == 0) && bfont->UID.id != 0;
    ...
    for (i = 0; i < 14; ++psf, ++i) {
        ...
        if (!psf->pdfont)
            continue;
        cfont = pdf_font_resource_font(psf->pdfont, ((bool)0));
        if (has_uid) {
    ...
    for (; orig; orig = orig->next) {
        ...
        if ((((&obfont->UID)->id & ~0xffffff) == 0)) {
            ...
            if (i >= 0 && pdf_standard_fonts(pdev)[i].pdfont == 0) {
                pdf_font_resource_t *pdfont;
                int code = pdf_font_std_alloc(pdev, &pdfont, ((bool)1), orig->id, obfont,
                                              i);
...
pdf_outline_fonts_alloc(gs_memory_t *mem)
{
    pdf_outline_fonts_t *pofs =
        (pdf_outline_fonts_t *)(*(mem)->procs.alloc_struct)(mem, &st_pdf_outline_fonts, "pdf_outline_fonts_alloc(outline_fonts)");

    pdf_standard_font_t *ppsf =
        (pdf_standard_font_t *)(*(mem)->procs.alloc_struct_array)(mem, 14, &st_pdf_standard_font_element, "pdf_outline_fonts_alloc(standard_fonts)");
...
{
    void *q = (*(mem)->procs.alloc_byte_array)(mem, new_size, elem_size, "pdf_resize_array");

    if (q == ((void*)0))
        return ((-25));
    memset((char *)q + elem_size * old_size, 0, elem_size * (new_size - old_size));
    memcpy(q, *p, elem_size * old_size);
    ((mem)->procs.free_object(mem, *p, "pdf_resize_array"));
    *p = q;
    return 0;
}
                    ...
                    pdf_font_write_contents_proc_t write_contents)
{
    ...
    if (chars_count != 0) {
        ...
        if (!is_CID_font) {
            widths = (void *)(*(mem)->procs.alloc_byte_array)(mem, chars_count, sizeof(*widths), "font_resource_alloc(Widths)");

        } else {

        }
        used = (*(mem)->procs.alloc_bytes)(mem, size, "font_resource_alloc(used)");
    ...
    pfres->res_ToUnicode = ((void*)0);
    pfres->cmap_ToUnicode = ((void*)0);
    pfres->mark_glyph = 0;
    pfres->mark_glyph_data = 0;
    *ppfres = pfres;
    return 0;
 fail:
    ((mem)->procs.free_object(mem, used, "font_resource_alloc(used)"));
    ((mem)->procs.free_object(mem, widths, "font_resource_alloc(Widths)"));
    return code;
}
...
int font_resource_free(gx_device_pdf *pdev, pdf_font_resource_t *pdfont)
{
        if(pdfont->BaseFont.size
           && (pdfont->base_font == ((void*)0) || !pdfont->base_font->is_standard)) {

            (*(pdev->v_memory)->procs.free_string)(pdev->v_memory, pdfont->BaseFont.data, pdfont->BaseFont.size, "Free BaseFont string");
            pdfont->BaseFont.data = (byte *)0L;
            pdfont->BaseFont.size = 0;
        }
        if(pdfont->Widths) {
            ((pdev->v_memory)->procs.free_object(pdev->v_memory, pdfont->Widths, "Free Widths array"));
            pdfont->Widths = 0;
        }
        if(pdfont->used) {
            ((pdev->v_memory)->procs.free_object(pdev->v_memory, pdfont->used, "Free used array"));
            pdfont->used = 0;
        }
        ...
        if(pdfont->cmap_ToUnicode) {
            gs_cmap_ToUnicode_free(pdev->v_memory, pdfont->cmap_ToUnicode);
        ...
        switch(pdfont->FontType) {
            ...
            case ft_GL2_531:
                if(pdfont->u.simple.Encoding) {
                    ((pdev->v_memory)->procs.free_object(pdev->v_memory, pdfont->u.simple.Encoding, "Free simple Encoding"));
                    pdfont->u.simple.Encoding = 0;
                }
                if(pdfont->u.simple.v) {
                    ((pdev->v_memory)->procs.free_object(pdev->v_memory, pdfont->u.simple.v, "Free simple v"));
                    pdfont->u.simple.v = 0;
                }
            ...
            case ft_CID_TrueType:
                if(pdfont->u.cidfont.used2) {
                    ((pdev->v_memory)->procs.free_object(pdev->v_memory, pdfont->u.cidfont.used2, "Free CIDFont used2"));
                    pdfont->u.cidfont.used2 = 0;
                }
                if(pdfont->u.cidfont.CIDToGIDMap) {
                    ((pdev->v_memory)->procs.free_object(pdev->v_memory, pdfont->u.cidfont.CIDToGIDMap, "Free CIDToGID map"));
        ...
        if (pdfont->object) {
            ((pdev->v_memory)->procs.free_object(pdev->v_memory, pdfont->object, "Free font resource object"));
            pdfont->object = 0;
        }

        if(pdfont->FontDescriptor)
            pdfont->FontDescriptor = ((void*)0);
    return 0;
}
...
{
    pdf_encoding_element_t *Encoding =
        (pdf_encoding_element_t *)(*(pdev->v_memory)->procs.alloc_struct_array)(pdev->v_memory, 256, &st_pdf_encoding_element, "font_resource_encoded_alloc");


    gs_point *v = (gs_point *)(*(pdev->v_memory)->procs.alloc_byte_array)(pdev->v_memory, 256, sizeof(gs_point), "pdf_font_simple_alloc");

    pdf_font_resource_t *pdfont;
    int code, i;

    if (v == 0 || Encoding == 0) {
        ((pdev->v_memory)->procs.free_object(pdev->v_memory, Encoding, "font_resource_encoded_alloc"));

        ((pdev->v_memory)->procs.free_object(pdev->v_memory, v, "font_resource_encoded_alloc"));
    ...
    for (i = 0; i < 256; ++i)
        Encoding[i].glyph = ((gs_glyph)0x7fffffff);
...
pdf_resize_resource_arrays(gx_device_pdf *pdev, pdf_font_resource_t *pfres, int chars_count)
{
    ...
    if (pfres->FontType == ft_CID_TrueType) {
        if (pfres->u.cidfont.CIDToGIDMap != ((void*)0)) {
    ...
    if (pfres->FontType == ft_CID_encrypted || pfres->FontType == ft_CID_TrueType) {
        if (pfres->u.cidfont.used2 != ((void*)0)) {
...
has_extension_glyphs(gs_font *pfont)
{
    ...
    psf_enumerate_list_begin(&genum, (gs_font *)pfont, ((void*)0), 0, GLYPH_SPACE_NAME);
    for (glyph = ((gs_glyph)0x7fffffff); (psf_enumerate_glyphs_next(&genum, &glyph)) != 1; ) {
                      ...
                      pdf_char_glyph_pair_t *pairs, int num_glyphs)
{
    ...
    bool embed_as_standard_called = ((bool)0);
    bool do_embed_as_standard = ((bool)0);
    int code;
    gs_font_info_t info;
...
# 777 "./devices/vector/gdevpdtf.c"
            char name[47 + 1];
            int len;

            len = (((47) < (font->font_name.size)) ? (47) : (font->font_name.size));
            memcpy(name, font->font_name.chars, len);
            name[len] = 0;
            (emprintf_program_ident(pdev->v_memory, gs_program_name(), gs_revision_number()), errprintf(pdev->v_memory, "\nWarning: %s cannot be embedded because of licensing restrictions\n", name));
    ...
    if (pdev->CompatibilityLevel < 1.3) {
        if (index >= 0 &&
            (embed_as_standard_called = ((bool)1),
...
pdf_compute_BaseFont(gx_device_pdf *pdev, pdf_font_resource_t *pdfont, bool finish)
{
    ...
    size = fname.size;
    data = (*(pdev->v_memory)->procs.alloc_string)(pdev->v_memory, size, "pdf_compute_BaseFont");
    ...
    case ft_CID_TrueType: {
        ...
        for (i = j = 0; i < size; ++i)
            if (data[i] != ' ')
                data[j++] = data[i];
        data = (*(pdev->v_memory)->procs.resize_string)(pdev->v_memory, data, i, j, "pdf_compute_BaseFont");
    ...
    if (pdfont->BaseFont.size)
        (*(pdev->v_memory)->procs.free_string)(pdev->v_memory, pdfont->BaseFont.data, pdfont->BaseFont.size, "Replacing BaseFont string");
    pdfont->BaseFont.data = fname.data = data;
    pdfont->BaseFont.size = fname.size = size;

    if (finish && pdfont->FontDescriptor != ((void*)0) &&
        ...
        ((&pdf_font_resource_font(pdfont, ((bool)0))->UID)->id = (~(-1L << ((1 << 3) * 8 - 1))), (&pdf_font_resource_font(pdfont, ((bool)0))->UID)->xvalues = 0);
    }
                     ...
                     const gs_const_string *CMapName)
{
    ...
    if (code >= 0) {
        ...
        code = pdf_compute_BaseFont(pdev, *ppfres, ((bool)0));
    }
    return code;
}
...
pdf_font_type3_alloc(gx_device_pdf *pdev, pdf_font_resource_t **ppfres,
                     pdf_font_write_contents_proc_t write_contents)
{
    return font_resource_simple_alloc(pdev, ppfres, 0L, ft_user_defined,
                                      256, write_contents);
}
                   ...
                   bool is_original, gs_id rid, gs_font_base *pfont, int index)
{
    ...
    if (code < 0 ||
        (code = pdf_base_font_alloc(pdev, &pdfont->base_font, pfont, orig_matrix, ((bool)1))) < 0
        )
        return code;
                      ...
                      gs_id rid, pdf_font_descriptor_t *pfd)
{
    ...
    set_is_MM_instance(pdfont, pdf_font_descriptor_font(pfd, ((bool)0)));
    *ppfres = pdfont;
    return pdf_compute_BaseFont(pdev, pdfont, ((bool)0));
}
                       ...
                       gs_id rid, pdf_font_descriptor_t *pfd)
{
    ...
    gs_font_base *font = pdf_font_descriptor_font(pfd, ((bool)0));
    int chars_count;
    int code;
    pdf_font_write_contents_proc_t write_contents;
    ...
    case ft_CID_TrueType:
        ...
        map = (void *)(*(pdev->v_memory)->procs.alloc_byte_array)(pdev->v_memory, chars_count, sizeof(*map), "CIDToGIDMap");
    ...
    pdfont->u.cidfont.Widths2 = ((void*)0);
    pdfont->u.cidfont.v = ((void*)0);
    pdfont->u.cidfont.parent = ((void*)0);


    pdfont->u.cidfont.used2 = (*(pdev->v_memory)->procs.alloc_bytes)(pdev->v_memory, (chars_count + 7) / 8, "pdf_font_cidfont_alloc");

    if (pdfont->u.cidfont.used2 == ((void*)0))
        return ((-25));
                                 ...
                                 int wmode, double **w, double **w0, double **v)
{
    ...
    *w0 = (wmode ? pdfont->Widths : ((void*)0));
    *v = (wmode ? pdfont->u.cidfont.v : ((void*)0));
    *w = (wmode ? pdfont->u.cidfont.Widths2 : pdfont->Widths);
    if (*w == ((void*)0)) {
        ww = (double *)(*(mem)->procs.alloc_byte_array)(mem, chars_count, sizeof(*ww), "pdf_obtain_cidfont_widths_arrays");

        if (wmode) {
            vv = (double *)(*(mem)->procs.alloc_byte_array)(mem, chars_count, sizeof(*vv) * 2, "pdf_obtain_cidfont_widths_arrays");

            if (pdfont->Widths == 0) {
                ww0 = (double *)(*(mem)->procs.alloc_byte_array)(mem, chars_count, sizeof(*ww0), "pdf_obtain_cidfont_widths_arrays");
        ...
        if (ww == 0 || (wmode && vv == 0) || (wmode && ww0 == 0)) {
            ((mem)->procs.free_object(mem, ww, "pdf_obtain_cidfont_widths_arrays"));
            ((mem)->procs.free_object(mem, vv, "pdf_obtain_cidfont_widths_arrays"));
            ((mem)->procs.free_object(mem, ww0, "pdf_obtain_cidfont_widths_arrays"));
            return ((-25));
        }
        if (wmode)
    ...
    if (pdev->PDFA == 0)
        ...
        if (pdfont->FontType != ft_TrueType)
                ...
                return 0;
            {
                ...
                pdf_reserve_object_id(pdev, (pdf_resource_t *)pdfont, 0L);
