...
dctd_fill_input_buffer(j_decompress_ptr dinfo)
{
    ...
    (jpeg_decompress_data *) ((char *)dinfo -
                              ((int) ( (char *)&((jpeg_decompress_data *)0)->dinfo - (char *)((jpeg_decompress_data *)0) )));
...
s_DCTD_init(stream_state * st)
{
    ...
    ss->data.decompress->input_eod = ((bool)0);
    ss->data.decompress->faked_eoi = ((bool)0);
    ss->phase = 0;
    return 0;
}
        ...
        case 2:
            ...
            if (ss->scan_line_size > (uint) jddp->templat.min_out_size) {
                ...
                jddp->scanline_buffer =
                    ((((jddp->memory)->procs.stable(jddp->memory)))->procs.alloc_bytes_immovable(((jddp->memory)->procs.stable(jddp->memory)), ss->scan_line_size, "s_DCTD_process(scanline_buffer)"));
...
{&st_DCT_state, s_DCTD_init, s_DCTD_process, 2000, 4000, ((void*)0),
 s_DCTD_set_defaults
};
