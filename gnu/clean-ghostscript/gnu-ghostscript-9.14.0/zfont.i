...
{
    return (glyph >= gs_c_min_std_encoding_glyph || glyph == ((gs_glyph)0x7fffffff) ? ((bool)0) :
            names_mark_index(mem->gs_lib_ctx->gs_name_table, (uint) glyph));
}
...
{
    ref v;
    int code = names_ref(mem->gs_lib_ctx->gs_name_table, gstr->data, gstr->size, &v, 0);

    if (code < 0)
        return code;
    *pglyph = (gs_glyph)names_index(mem->gs_lib_ctx->gs_name_table, &v);
    return 0;
}
...
{
    (gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir) = gs_font_dir_alloc2(((gs_memory_t *)((i_ctx_p->memory).current))->stable_memory, ((gs_memory_t *)((i_ctx_p->memory).current))->non_gc_memory);
    if ((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir) == ((void*)0))
        return (-25);
    (gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir)->ccache.mark_glyph = zfont_mark_glyph_name;
    (gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir)->global_glyph_code = zfont_global_glyph_code;
    return gs_register_struct_root(((gs_memory_t *)((i_ctx_p->memory).current)), ((void*)0), (void **)&(gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir),
                                   "ifont_dir");
}
...
zmakefont(i_ctx_t *i_ctx_p)
{
    ...
    if ((code = read_matrix(((gs_memory_t *)((i_ctx_p->memory).current)), op, &mat)) < 0)
        return code;
    return make_font(i_ctx_p, &mat);
}
...
zsetfont(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0 || (code = gs_setfont((i_ctx_p->pgs), pfont)) < 0)
        return code;
...
zcurrentfont(i_ctx_t *i_ctx_p)
{
    ...
    *op = *(&((font_data *)((gs_currentfont((i_ctx_p->pgs)))->client_data))->dict);
    return 0;
}
...
zcachestatus(i_ctx_t *i_ctx_p)
{
    ...
    gs_cachestatus((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), status);
    do { if ( (op += (7)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (7); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
...
zsetcachelimit(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op)); if ( (ulong)(*op).value.intval > (((unsigned int)~0 + (unsigned int)0)) ) return ((-15)); } while (0);
    gs_setcacheupper((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir),(uint) op->value.intval);
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
...
zsetcacheparams(i_ctx_t *i_ctx_p)
{
    ...
    for (i = 0; i < 3 && !((((const byte *)&((opp)->tas.type_attrs))[1]) == (t_mark)); i++, opp--) {
        do { if ( !((((const byte *)&((&*opp)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*opp)); if ( (ulong)(*opp).value.intval > (((unsigned int)~0 + (unsigned int)0)) ) return ((-15)); } while (0);
        params[i] = opp->value.intval;
    }
    switch (i) {
        case 3:
            if ((code = gs_setcachesize((i_ctx_p->pgs), (gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), params[2])) < 0)
                return code;
        case 2:
            if ((code = gs_setcachelower((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), params[1])) < 0)
                return code;
        case 1:
            if ((code = gs_setcacheupper((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), params[0])) < 0)
                return code;
        case 0:;
    }
...
zcurrentcacheparams(i_ctx_t *i_ctx_p)
{
    ...
    params[0] = gs_currentcachesize((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir));
    params[1] = gs_currentcachelower((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir));
    params[2] = gs_currentcacheupper((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir));
    ...
    (((op - 3)->tas.type_attrs = ((t_mark) << 8) + (0)) );
...
font_param(const ref * pfdict, gs_font ** ppfont)
{
    ...
    if ( !((((const byte *)&((&*pfdict)->tas.type_attrs))[1]) == (t_dictionary)) ) return (check_type_failed(&*pfdict));
    if (dict_find_string(pfdict, "FID", &pid) <= 0 ||
        !((((const byte *)&((pid)->tas.type_attrs))[1]) == (t_fontID))
        )
        return ((-10));
    pfont = ((gs_font *)((pid)->value.pstruct));
    if (pfont == 0)
        return ((-10));
        ...
        gs_ref_memory_t *imem)
{
    ...
    ((&fid)->value.pstruct = ((void *)pfont), ((&fid)->tas.type_attrs = ((t_fontID) << 8) + ((0x20 + 0x40) | imemory_space(imem) | imemory_new_mask(imem))) );


    return (i_ctx_p ? dict_put_string(fp, "FID", &fid, &(i_ctx_p->dict_stack)) :
            dict_put_string(fp, "FID", &fid, ((void*)0)));
}
...
make_font(i_ctx_t *i_ctx_p, const gs_matrix * pmat)
{
        ...
        return code;
    {
        ...
        ialloc_set_space((&(i_ctx_p->memory)), (avm_space)(((fp)->tas.type_attrs) & (((1 << 2) - 1) << 2)));
        if (dict_find_string(fp, "Encoding", &pencoding) > 0 &&
            !(((pencoding)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0)))
            )
            code = ((-10));
        else {
            ...
            olddict = *(&((font_data *)((oldfont)->client_data))->dict);
            *(&((font_data *)((oldfont)->client_data))->dict) = *fp;
            code = gs_makefont((gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir), oldfont, pmat, &newfont);
            *(&((font_data *)((oldfont)->client_data))->dict) = olddict;
        }
    ...
    if (pencoding != 0 &&
        !obj_eq(((gs_memory_t *)((i_ctx_p->memory).current)), pencoding, &((font_data *)((newfont)->client_data))->Encoding)
        ) {
        if (newfont->FontType == ft_composite)
            return ((-15));

        (*(&((font_data *)((newfont)->client_data))->Encoding) = *(pencoding));
                   ...
                   const gs_matrix * pmat, gs_font ** ppfont)
{
    ...
    ref *fp = (&((font_data *)((oldfont)->client_data))->dict);
    font_data *pdata;
    ...
    if (dlen < mlen)
        dlen = mlen;
    if ((pdata = (font_data *)(*(mem)->procs.alloc_struct)(mem, &st_font_data, "make_font(font_data)")) == 0
    ...
    if ((code = dict_alloc(imem, dlen, &newdict)) < 0 ||
        (code = dict_copy_entries(fp, &newdict, ((bool)0), ((void*)0))) < 0 ||
        (code = gs_alloc_ref_array(imem, &newmat, (0x10 + 0x20 +0x40), 12,
                                   "make_font(matrices)")) < 0
        )
        return code;
    refset_null_new(newmat.value.refs, 12, imemory_new_mask(imem));
    (*(&scalemat) = *(&newmat));
    ((&scalemat)->tas.rsize = (6));
...
# 404 "./psi/zfont.c"
    {
        ...
        if (!(dict_find_string(fp, "ScaleMatrix", &ppsm) > 0 &&
            ...
            scale = *pmat;
        write_matrix_in(&scalemat, &scale, ((void*)0), imem);
    }
    ((&scalemat)->tas.type_attrs &= ~(0x10));
    ((&newmat)->tas.rsize = (6));
    write_matrix_in(&newmat, &newfont->FontMatrix, ((void*)0), imem);
    ((&newmat)->tas.type_attrs &= ~(0x10));
    if ((code = dict_put_string(&newdict, "FontMatrix", &newmat, ((void*)0))) < 0 ||
        (code = dict_put_string(&newdict, "OrigFont", (&((font_data *)((oldfont->base)->client_data))->dict), ((void*)0))) < 0 ||
        (code = dict_put_string(&newdict, "ScaleMatrix", &scalemat, ((void*)0))) < 0 ||
        (code = add_FID(((void*)0), &newdict, newfont, imem)) < 0
        )
        return code;
    newfont->client_data = pdata;
    *pdata = *((font_data *)((oldfont)->client_data));
    pdata->dict = newdict;
    (((&(&newdict)->value.pdict->values))->tas.type_attrs &= ~(0x10));
    return 0;
}
...
make_uint_array(register os_ptr op, const uint * intp, int count)
{
    ...
    for (i = 0; i < count; i++, op++, intp++)
        ((op)->value.intval = (*intp), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
}
...
top:
...

    {
        ...
        for (pair = pdir->fmcache.mdata, n = pdir->fmcache.mmax;
            ...
            if (!((pair)->font == 0 && !((&(pair)->UID)->id != (~(-1L << ((1 << 3) * 8 - 1)))))) {
# 525 "./psi/zfont.c"
                if (pair->font != 0 &&
                    alloc_is_since_save((char *)pair->font, save)
                    ) {
                    if (!((&pair->UID)->id != (~(-1L << ((1 << 3) * 8 - 1)))))
...
zfont_info_has(const ref *pfidict, const char *key, gs_const_string *pmember)
{
    ...
    if (dict_find_string(pfidict, key, &pvalue) > 0 &&
        ((((const byte *)&((pvalue)->tas.type_attrs))[1]) == (t_string))
        ) {
        pmember->data = pvalue->value.const_bytes;
        pmember->size = ((pvalue)->tas.rsize);
        return ((bool)1);
    }
    return ((bool)0);
}
           ...
           gs_font_info_t *info)
{
    ...
    if (code < 0)
        return code;
    pfdict = &((font_data *)((font)->client_data))->dict;
...
static
void unicode_decoder_clear_marks(const gs_memory_t *cmem, void *vptr, uint size, const gs_memory_struct_type_t *pstype)
{ gs_unicode_decoder *const pptr = vptr;

    ((&pptr->data)->tas.type_attrs &= ~(1));
}
static
gs_ptr_type_t unicode_decoder_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_unicode_decoder *pptr = vptr; switch ( index ) { default: return 0;
case 0:
return (pep->ptr = (const void *)(&pptr->data), (&ptr_ref_procs));
} }
static void unicode_decoder_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_unicode_decoder *pptr = vptr;;
(*((*(const gc_procs_with_refs_t **)(gcst))->reloc_refs))((ref_packed *)(&(pptr->data)), (ref_packed *)(&(pptr->data) + 1), gcst);
((&pptr->data)->tas.type_attrs &= ~(1));
}

static const gs_memory_struct_type_t st_unicode_decoder = { sizeof(gs_unicode_decoder), "unicode_decoder", 0, unicode_decoder_clear_marks, unicode_decoder_enum_ptrs, unicode_decoder_reloc_ptrs, 0, 0 };
...
zfont_get_to_unicode_map(gs_font_dir *dir)
{
    ...
    return (pud == ((void*)0) ? ((void*)0) : &pud->data);
}

static int
setup_unicode_decoder(i_ctx_t *i_ctx_p, ref *Decoding)
{
    gs_unicode_decoder *pud = (gs_unicode_decoder *)(*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_struct)(((gs_memory_t *)((i_ctx_p->memory).current)), &st_unicode_decoder, "setup_unicode_decoder");

    if (pud == ((void*)0))
        return ((-25));
    ((void)(((*(&pud->data) = *(Decoding)), ((&pud->data)->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask))));
    (gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)))->font_dir)->glyph_to_unicode_table = pud;
    return 0;
}
