...
zsqrt(i_ctx_t *i_ctx_p)
{
    ...
    if (num < 0.0)
        return ((-15));
    ((op)->value.realval = (sqrt(num)), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zarccos(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    result = acos(num) * (180.0 / 3.14159265358979323846);
    ((op)->value.realval = (result), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zarcsin(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    result = asin(num) * (180.0 / 3.14159265358979323846);
    ((op)->value.realval = (result), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zatan(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    ((op - 1)->value.realval = (result), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
...
zcos(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    ((op)->value.realval = (gs_cos_degrees(angle)), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zsin(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    ((op)->value.realval = (gs_sin_degrees(angle)), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zln(i_ctx_t *i_ctx_p)
{
    ...
    if (num <= 0.0)
        return ((-15));
    ((op)->value.realval = (log(num)), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zlog(i_ctx_t *i_ctx_p)
{
    ...
    if (num <= 0.0)
        return ((-15));
    ((op)->value.realval = (log10(num)), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    return 0;
}
...
zrand(i_ctx_t *i_ctx_p)
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
# 212 "./psi/zmath.c"
    (i_ctx_p->rand_state) = 16807 * ((i_ctx_p->rand_state) % 127773) - 2836 * ((i_ctx_p->rand_state) / 127773);

    if ((i_ctx_p->rand_state) <= 0)
        (i_ctx_p->rand_state) += 0x7fffffff;
    ...
    ((op)->value.intval = ((i_ctx_p->rand_state)), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
