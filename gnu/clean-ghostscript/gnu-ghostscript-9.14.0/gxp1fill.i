               ...
               gx_device * dev, bool set_mask_phase)
{
    ...
    if ((ptfs->cdev = (gx_device_tile_clip *)(gx_device_tile_clip *)(*(dev->memory)->procs.alloc_struct)(dev->memory, &st_device_mask_clip, "tile_fill_init(cdev)")) == ((void*)0)) {



        return ((-25));
    }
    ptfs->cdev->finalize = ((void*)0);
    ...
    if (set_mask_phase && m_tile->is_simple) {
        px = imod(-(int)(((int)(m_tile->step_matrix.tx - ptfs->phase.x + 0.5)) - (((m_tile->step_matrix.tx - ptfs->phase.x + 0.5)<0) && ((m_tile->step_matrix.tx - ptfs->phase.x + 0.5) != (float)(int)(m_tile->step_matrix.tx - ptfs->phase.x + 0.5)))),
                  m_tile->tmask.rep_width);
        py = imod(-(int)(((int)(m_tile->step_matrix.ty - ptfs->phase.y + 0.5)) - (((m_tile->step_matrix.ty - ptfs->phase.y + 0.5)<0) && ((m_tile->step_matrix.ty - ptfs->phase.y + 0.5) != (float)(int)(m_tile->step_matrix.ty - ptfs->phase.y + 0.5)))),
                                ...
                                int x, int y, int w, int h))
{
    ...
    step_matrix.ty -= ptfs->phase.y;
    {
        ...
        do { } while (0);
# 190 "./base/gxp1fill.c"
        u0 = ibbox.p.x - (((ptile->bbox.p.x) > (0)) ? (ptile->bbox.p.x) : (0)) - 0.000001;
        v0 = ibbox.p.y - (((ptile->bbox.p.y) > (0)) ? (ptile->bbox.p.y) : (0)) - 0.000001;
        u1 = ibbox.q.x - (((ptile->bbox.q.x) < (0)) ? (ptile->bbox.q.x) : (0)) + 0.000001;
        v1 = ibbox.q.y - (((ptile->bbox.q.y) < (0)) ? (ptile->bbox.q.y) : (0)) + 0.000001;
        if (!ptile->is_simple)
            u0 -= bbw, v0 -= bbh, u1 += bbw, v1 += bbh;
        i0 = (int)(((int)(u0)) - (((u0)<0) && ((u0) != (float)(int)(u0))));
        j0 = (int)(((int)(v0)) - (((v0)<0) && ((v0) != (float)(int)(v0))));
        i1 = (int)ceil(u1);
        j1 = (int)ceil(v1);
    }
    do { } while (0);
    for (i = i0; i < i1; i++)
        for (j = j0; j < j1; j++) {
            int x = (int)(((int)(step_matrix.xx * i + step_matrix.yx * j + step_matrix.tx)) - (((step_matrix.xx * i + step_matrix.yx * j + step_matrix.tx)<0) && ((step_matrix.xx * i + step_matrix.yx * j + step_matrix.tx) != (float)(int)(step_matrix.xx * i + step_matrix.yx * j + step_matrix.tx))));

            int y = (int)(((int)(step_matrix.xy * i + step_matrix.yy * j + step_matrix.ty)) - (((step_matrix.xy * i + step_matrix.yy * j + step_matrix.ty)<0) && ((step_matrix.xy * i + step_matrix.yy * j + step_matrix.ty) != (float)(int)(step_matrix.xy * i + step_matrix.yy * j + step_matrix.ty))));
                  ...
                  int x, int y, int w, int h)
{
    ...
    if (source == ((void*)0) && (((lop) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc)) && dev->procs.copy_planes != ((void*)0) &&
        ptfs->num_planes > 0) {
            code = (*((ptfs->pcdev)->procs.copy_planes))
                    (ptfs->pcdev, data + bits->raster * yoff, xoff,
                     bits->raster,
                     (full_transfer ? bits->id : 0L),
                     x, y, w, h, ptile->tbits.rep_height);
    } else if (source == ((void*)0) && (((lop) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc))) {
            code = (*((ptfs->pcdev)->procs.copy_color))
                    (ptfs->pcdev, data + bits->raster * yoff, xoff,
                     bits->raster,
                     (full_transfer ? bits->id : 0L),
                     x, y, w, h);
        ...
        source_id = (full_transfer ? source->id : 0L);
        data_tile.data = (byte *) data;
        ...
        if (source->planar_height == 0) {
            code = (*((ptfs->pcdev)->procs.strip_copy_rop))
                           (ptfs->pcdev,
            ...
            code = (*((ptfs->pcdev)->procs.strip_copy_rop2))
                           (ptfs->pcdev,
                            source->sdata + (y - ptfs->y0) * source->sraster,
                            source->sourcex + (x - ptfs->x0),
                            source->sraster, source_id,
                  ...
                  int x, int y, int w, int h)
{
    ...
    crdev->page_info.io_procs->rewind(crdev->page_info.bfile, ((bool)0), ((void*)0));
    crdev->page_info.io_procs->rewind(crdev->page_info.cfile, ((bool)0), ((void*)0));

    if (crdev->icc_table == ((void*)0))
        code = clist_read_icctable(crdev);

    if ( crdev->icc_cache_cl == ((void*)0) )
                             ...
                             const gx_rop_source_t * source)
{
    ...
    if (ptile == 0)
        return 0;
    if (rop_source == ((void*)0))
        gx_set_rop_no_source(&(rop_source), &(no_source), dev);
    bits = &ptile->tbits;

    code = tile_fill_init(&state, pdevc, dev, ((bool)0));
    if (code < 0)
        return code;
    if (ptile->is_simple && ptile->cdev == ((void*)0)) {
        int px =
            imod(-(int)(((int)(ptile->step_matrix.tx - state.phase.x + 0.5)) - (((ptile->step_matrix.tx - state.phase.x + 0.5)<0) && ((ptile->step_matrix.tx - state.phase.x + 0.5) != (float)(int)(ptile->step_matrix.tx - state.phase.x + 0.5)))),
                 bits->rep_width);
        int py =
            imod(-(int)(((int)(ptile->step_matrix.ty - state.phase.y + 0.5)) - (((ptile->step_matrix.ty - state.phase.y + 0.5)<0) && ((ptile->step_matrix.ty - state.phase.y + 0.5) != (float)(int)(ptile->step_matrix.ty - state.phase.y + 0.5)))),
                 bits->rep_height);

        if ((state.cdev != ((void*)0)))
            tile_clip_set_phase(state.cdev, px, py);
        if (source == ((void*)0) && (((lop) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc)))
            code = (*((state.pcdev)->procs.strip_tile_rectangle))
                (state.pcdev, bits, x, y, w, h,
                 ((gx_color_index)(~0)), ((gx_color_index)(~0)), px, py);
        else if (rop_source->planar_height == 0)
            code = (*((state.pcdev)->procs.strip_copy_rop))
                        (state.pcdev,
                         rop_source->sdata, rop_source->sourcex,
                         rop_source->sraster, rop_source->id,
                         (rop_source->use_scolors ? rop_source->scolors : ((void*)0)),
                         bits, ((void*)0), x, y, w, h, px, py, lop);
        else
            code = (*((state.pcdev)->procs.strip_copy_rop2))
                        (state.pcdev,
                         rop_source->sdata, rop_source->sourcex,
                         rop_source->sraster, rop_source->id,
                         (rop_source->use_scolors ? rop_source->scolors : ((void*)0)),
...
tile_masked_fill(const tile_fill_state_t * ptfs,
                 int x, int y, int w, int h)
{
    if (ptfs->source == ((void*)0))
        return (*ptfs->fill_rectangle)
            (ptfs->pdevc, x, y, w, h, ptfs->pcdev, ptfs->lop, ((void*)0));
    else {
        const gx_rop_source_t *source = ptfs->source;
                            ...
                            const gx_rop_source_t * source)
{
    ...
    code = tile_fill_init(&state, pdevc, dev, ((bool)1));
    if (code < 0)
        return code;
...
# 753 "./base/gxp1fill.c"
    left_rem_end = (((dx+w) < (tile_width)) ? (dx+w) : (tile_width));
    left_width = left_rem_end - dx;
    left_copy_start = (((dx) > (ptile->ttrans->rect.p.x)) ? (dx) : (ptile->ttrans->rect.p.x));
    left_copy_rem_end = (((dx+w) < (ptile->ttrans->rect.q.x)) ? (dx+w) : (ptile->ttrans->rect.q.x));
    ...
    num_full_tiles = (int)(((int)((float) (w - left_width)/ (float) tile_width)) - ((((float) (w - left_width)/ (float) tile_width)<0) && (((float) (w - left_width)/ (float) tile_width) != (float)(int)((float) (w - left_width)/ (float) tile_width))));
                      ...
                      gx_pattern_trans_t *fill_trans_buffer)
{
    ...
    int tile_width = ptile->ttrans->width;
    int tile_height = ptile->ttrans->height;
    int num_chan = ptile->ttrans->n_chan;
                           ...
                           const gx_device_color * pdevc)
{
    ...
    do { do { if ( (xmin | ymin) < 0 ) { if ( xmin < 0 ) w += xmin, xmin = 0; if ( ymin < 0 ) h += ymin, ymin = 0; } } while (0); do { if ( w > (dev)->width - xmin ) w = (dev)->width - xmin; } while (0); do { if ( h > (dev)->height - ymin ) h = (dev)->height - ymin; } while (0); } while (0);
    if (w < 0 || h < 0)
        return 0;
    xmax = w + xmin;
    ymax = h + ymin;
    ...
    if (ptile->is_simple && ptile->cdev == ((void*)0)) {
        ...
        int px =
            imod(-(int)(((int)(ptile->step_matrix.tx - phase.x + 0.5)) - (((ptile->step_matrix.tx - phase.x + 0.5)<0) && ((ptile->step_matrix.tx - phase.x + 0.5) != (float)(int)(ptile->step_matrix.tx - phase.x + 0.5)))),
                  ptile->ttrans->width);
        int py =
            imod(-(int)(((int)(ptile->step_matrix.ty - phase.y + 0.5)) - (((ptile->step_matrix.ty - phase.y + 0.5)<0) && ((ptile->step_matrix.ty - phase.y + 0.5) != (float)(int)(ptile->step_matrix.ty - phase.y + 0.5)))),
                 ptile->ttrans->height);
        ...
        if (ptile->cdev == ((void*)0)) {
            ...
            code = tile_fill_init(&state_clist_trans, pdevc, dev, ((bool)0));
            ...
            if (code >= 0 && (state_clist_trans.cdev != ((void*)0))) {
                tile_clip_free((gx_device_tile_clip *)state_clist_trans.cdev);
                state_clist_trans.cdev = ((void*)0);
            }
