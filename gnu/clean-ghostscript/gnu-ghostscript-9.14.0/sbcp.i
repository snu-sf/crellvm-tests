                ...
                stream_cursor_write * pw, bool last, const byte * escaped)
{
    ...
    const byte *end = p + (((rcount) < (wcount)) ? (rcount) : (wcount));
...
{&st_stream_state, ((void*)0), s_BCPE_process, 1, 2
};
const stream_template s_TBCPE_template =
{&st_stream_state, ((void*)0), s_TBCPE_process, 1, 2
};



static const gs_memory_struct_type_t st_BCPD_state = { sizeof(stream_BCPD_state), "(T)BCPDecode state", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };
