...
# 24 "./base/sarc4.c" 2
# 35 "./base/sarc4.c"
static const gs_memory_struct_type_t st_arcfour_state = { sizeof(stream_arcfour_state), "Arcfour filter state", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };
...
const stream_template s_arcfour_template = {
    &st_arcfour_state, ((void*)0), s_arcfour_process, 1, 1
};
