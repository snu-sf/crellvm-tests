...
static const gs_memory_struct_type_t st_names_array_ref = { sizeof(names_array_ref_t), "names_array_ref_t", 0, ref_struct_clear_marks, ref_struct_enum_ptrs, ref_struct_reloc_ptrs, 0, 0 };
...
{
    ref *pnames = (ref *)
        (names_array_ref_t *)(*(((mem)->procs.stable(mem)))->procs.alloc_struct)(((mem)->procs.stable(mem)), &st_names_array_ref, cname);


    if (pnames == 0)
        return ((-25));
    ((pnames)->value.refs = ((ref *)((void*)0)), ((pnames)->tas.type_attrs = ((t_array) << 8) + ((0x20 + 0x40))), ((pnames)->tas.rsize = (0)));
    *ppnames = pnames;
    return 0;
}
...
zbseq_init(i_ctx_t *i_ctx_p)
{
    ...
    ref *psystem_names = 0;
    int code = create_names_array(&psystem_names, ((gs_memory_t *)((i_ctx_p->memory).spaces.memories.named.global)),
                                  "zbseq_init(system_names)");

    if (code < 0)
        return code;
    ((i_ctx_p->memory).spaces.memories.named.global->names_array) = psystem_names;
    return 0;
}
...
zinstallsystemnames(i_ctx_t *i_ctx_p)
{
    ...
    if ((avm_space)(((op)->tas.type_attrs) & (((1 << 2) - 1) << 2)) != avm_global || imemory_save_level(((i_ctx_p->memory).spaces.memories.named.global)) != 0)
        return ((-7));
    if ( !(((&*op)->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x20))) == (((t_shortarray) << 8) + (0x20))) ) return ((!((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_shortarray)) ? check_type_failed(&*op) : (-7)));
    (((void)((((((((i_ctx_p->memory).spaces.memories.named.global->names_array))->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), ((void*)0), (ref_packed *)(((i_ctx_p->memory).spaces.memories.named.global->names_array)), ".installsystemnames") : 0))), ((void)(((*(((i_ctx_p->memory).spaces.memories.named.global->names_array)) = *(op)), ((((i_ctx_p->memory).spaces.memories.named.global->names_array))->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
...
zcurrentobjectformat(i_ctx_t *i_ctx_p)
{
    ...
    *op = (i_ctx_p->binary_object_format);
    return 0;
}
...
zsetobjectformat(i_ctx_t *i_ctx_p)
{
    ...
    (((void)((((((&(i_ctx_p->binary_object_format))->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), &cont, (ref_packed *)(&(i_ctx_p->binary_object_format)), "setobjectformat") : 0))), ((void)(((*(&(i_ctx_p->binary_object_format)) = *(op)), ((&(i_ctx_p->binary_object_format))->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
# 119 "./psi/zbseq.c"
