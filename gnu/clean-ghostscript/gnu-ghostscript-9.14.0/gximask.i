                           ...
                           gs_memory_t *mem, gx_device **cdev)
{
    if (gx_dc_is_pattern2_color(pdevc) || gx_dc_is_pattern1_color_clist_based(pdevc)) {
        if (!((dev)->procs.dev_spec_op)(dev, gxdso_pattern_can_accum, ((void*)0), 0L)) {
            extern const gs_memory_struct_type_t st_device_cpath_accum;
            gx_device_cpath_accum *pcdev = (gx_device_cpath_accum *)(*(mem)->procs.alloc_struct)(mem, &st_device_cpath_accum, "gx_image_fill_masked_start");
            ...
            pcdev->rc.memory = mem;
            pcdev->width = dev->width;
            pcdev->height = dev->height;
            gx_device_retain((gx_device *)pcdev, ((bool)1));
...
gx_image_fill_masked_end(gx_device *dev, gx_device *tdev, const gx_device_color *pdevc)
{
    ...
    (void)gx_cpath_init_local_shared(&cpath, ((void*)0), pcdev->memory);
    ...
    if (code >= 0 && pcdev->bbox.p.x < pcdev->bbox.q.x) {
        code1 = (*(pdevc)->type->fill_rectangle)(pdevc, pcdev->bbox.p.x, pcdev->bbox.p.y, pcdev->bbox.q.x - pcdev->bbox.p.x, pcdev->bbox.q.y - pcdev->bbox.p.y, (gx_device *)&cdev, (rop3_default | (((bool)0) ? 0x100 : 0) | (((bool)0) ? 0x200 : 0)), 0);
    ...
    gx_device_retain((gx_device *)pcdev, ((bool)0));
    ...
    gs_logical_operation_t lop, const gx_clip_path *pcpath)
{
    ...
    if (code >= 0)
        code = (*((cdev)->procs.fill_mask))(cdev, data, data_x, raster, id,
