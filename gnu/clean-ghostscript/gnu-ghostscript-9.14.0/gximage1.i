...
# 55 "./base/memory_.h" 2
# 24 "./base/gximage1.c" 2


static const gc_struct_data_t image1_reloc_ptrs = { 0, 0, &st_gs_pixel_image, 0 }; const gs_memory_struct_type_t st_gs_image1 = { sizeof(gs_image1_t), "gs_image1_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &image1_reloc_ptrs };
...
static int gx_image1_sput(const gs_image_common_t *pic, stream *s, const gs_color_space **ppcs);
static int gx_image1_sget(gs_image_common_t *pic, stream *s, gs_color_space *pcs);
static void gx_image1_release(gs_image_common_t *pic, gs_memory_t *mem);
...
static int gx_image1_mask_sput(const gs_image_common_t *pic, stream *s, const gs_color_space **ppcs);
static int gx_image1_mask_sget(gs_image_common_t *pic, stream *s, gs_color_space *pcs);
                       ...
                       bool adjust)
{
    ...
    pim->ImageMask = (color_space == ((void*)0));
    pim->adjust = adjust;
...
{
    gs_image_t_init_adjust(pim, ((void*)0), ((bool)1));
    if (write_1s)
                ...
                gs_memory_t * mem, gx_image_enum_common_t ** pinfo)
{
    ...
    penum->use_mask_color = ((bool)0);
    penum->image_parent_type = pim->image_parent_type;
    penum->masked = pim->ImageMask;
    penum->adjust =
        (pim->ImageMask && pim->adjust ? ((fixed)((0.25)*(float)(1<<8))) : 0L);
                    ...
                    const gs_color_space **ignore_ppcs)
{
    ...
    uint control =
        (gx_image_matrix_is_default((const gs_data_image_t *)pim) ? 0 :
         0x01) |
        (pim->Decode[0] != 0 ? 0x02 : 0) |
        (pim->Interpolate ? 0x04 : 0) |
        (pim->adjust ? 0x08 : 0) |
        (pim->Alpha << 4) |
        ((pim->BitsPerComponent - 1) << 6);
                    ...
                    gs_color_space *ignore_pcs)
{
    ...
    if ((code = sget_variable_uint(s, &control)) < 0)
        return code;
    gs_image_t_init_mask_adjust(pim, (control & 0x02) != 0, ((bool)1));
    ...
    pim->Interpolate = (control & 0x04) != 0;
    pim->adjust = (control & 0x08) != 0;
    pim->Alpha = (control >> 4) & 0x3;
    pim->BitsPerComponent = ((control >> 6) & 0xf) + 1;
    return 0;
}
...
# 233 "./base/gximage1.c"
    memset(penum, 0, (*(mem)->procs.object_size)(mem, penum));
    ((mem)->procs.free_object(mem, penum, "gx_image_free_enum"));
    *ppenum = ((void*)0);
}
