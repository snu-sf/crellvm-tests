                       ...
                       int phase_x, int phase_y, gs_logical_operation_t lop)
{
    ...
    gx_color_index const_source = ((gx_color_index)(~0));
    gx_color_index const_texture = ((gx_color_index)(~0));
    ...
    gx_color_index strans =
        (lop & 0x100 ? all_ones : ((gx_color_index)(~0)));
    gx_color_index ttrans =
        (lop & 0x200 ? all_ones : ((gx_color_index)(~0)));
# 85 "./base/gdevmr8n.c"
    if (!( ((((rop) << 2) ^ (rop)) & 0xcc) != 0 ))
        const_source = 0;
    ...
    if (bpp == 1 &&
        (( (dev)->color_info.num_components > 1 || (dev)->color_info.gray_index == 0xff ) ||
...
df: return mem_default_strip_copy_rop(dev,
    ...
    if (const_source == ((gx_color_index)(~0))) {
    ...
    drow = base + x * bpp;
# 627 "./base/gdevmr8n.c"
    if (const_texture != ((gx_color_index)(~0))) {
            ...
            for (; line_count-- > 0; drow += draster) {
                ...
                if (bpp == 1)
                    ...
                    for (; left > 0; ++dptr, --left) {
                        ...
                        if ( ((byte)const_source) == strans || ((byte)const_texture) == ttrans ) continue; *dptr = (*rop_proc_table[rop])(*dptr, (byte)const_source, (byte)const_texture);
                    }
                else
                    ...
                    for (; left > 0; dptr += 3, --left) {
                        ...
                        if ( (const_source) == strans || (const_texture) == ttrans ) continue; { gx_color_index d_pixel = (((gx_color_index)(dptr)[0] << 16) | ((gx_color_index)(dptr)[1] << 8) | (dptr)[2]); d_pixel = (*rop_proc_table[rop])(d_pixel, const_source, const_texture); (dptr)[0] = (byte)((d_pixel) >> 16), (dptr)[1] = (byte)((uint)(d_pixel) >> 8), (dptr)[2] = (byte)(d_pixel); };
                    }
            }
        } else {
                ...
                if (scolors) {
                    ...
                    if (bpp == 1)
                        ...
                        for (; left > 0; ++dptr, ++sx, --left) {
                            ...
                            if ( (s_pixel) == strans || ((byte)const_texture) == ttrans ) continue; *dptr = (*rop_proc_table[rop])(*dptr, s_pixel, (byte)const_texture);
                        }
                    else
                        ...
                        for (; left > 0; dptr += 3, ++sx, --left) {
                            ...
                            if ( (s_pixel) == strans || (const_texture) == ttrans ) continue; { gx_color_index d_pixel = (((gx_color_index)(dptr)[0] << 16) | ((gx_color_index)(dptr)[1] << 8) | (dptr)[2]); d_pixel = (*rop_proc_table[rop])(d_pixel, s_pixel, const_texture); (dptr)[0] = (byte)((d_pixel) >> 16), (dptr)[1] = (byte)((uint)(d_pixel) >> 8), (dptr)[2] = (byte)(d_pixel); };
                        }
                } else if (bpp == 1) {
    ...
    } else if (const_source != ((gx_color_index)(~0))) {
                ...
                if (tcolors) {
                    ...
                    if (bpp == 1)
                        ...
                        for (; left > 0; ++dptr, ++tx, --left) {
                            ...
                            if ( ((byte)const_source) == strans || (t_pixel) == ttrans ) continue; *dptr = (*rop_proc_table[rop])(*dptr, (byte)const_source, t_pixel);
                        }
                    else
                        ...
                        for (; left > 0; dptr += 3, ++tx, --left) {
                            ...
                            if ( (const_source) == strans || (t_pixel) == ttrans ) continue; { gx_color_index d_pixel = (((gx_color_index)(dptr)[0] << 16) | ((gx_color_index)(dptr)[1] << 8) | (dptr)[2]); d_pixel = (*rop_proc_table[rop])(d_pixel, const_source, t_pixel); (dptr)[0] = (byte)((d_pixel) >> 16), (dptr)[1] = (byte)((uint)(d_pixel) >> 8), (dptr)[2] = (byte)(d_pixel); };
                        }
                } else if (bpp == 1) {
...
# 795 "./base/gdevmr8n.c"
                if (bpp == 1) {
                    ...
                    for (; left > 0; ++dptr, ++sptr, ++tptr, ++sx, ++tx, --left) {
                        byte s_pixel =
                            (scolors ? (((srow)[(sx) >> 3] & (0x80 >> ((sx) & 7))) ? (byte)scolors[1] : (byte)scolors[0]) : *sptr);
                        byte t_pixel =
                            (tcolors ? (((tptr)[(tx) >> 3] & (0x80 >> ((tx) & 7))) ? (byte)tcolors[1] : (byte)tcolors[0]) : *tptr);

                        do { } while (0);

                        if ( (s_pixel) == strans || (t_pixel) == ttrans ) continue; *dptr = (*rop_proc_table[rop])(*dptr, s_pixel, t_pixel);
                    }
                } else {
                    ...
                    for (; left > 0; dptr += 3, sptr += 3, tptr += 3, ++sx, ++tx, --left) {
                        bits32 s_pixel =
                            (scolors ? (((srow)[(sx) >> 3] & (0x80 >> ((sx) & 7))) ? scolors[1] : scolors[0]) :
                             (((gx_color_index)(sptr)[0] << 16) | ((gx_color_index)(sptr)[1] << 8) | (sptr)[2]));
                        bits32 t_pixel =
                            (tcolors ? (((tptr)[(tx) >> 3] & (0x80 >> ((tx) & 7))) ? tcolors[1] : tcolors[0]) :
                             (((gx_color_index)(tptr)[0] << 16) | ((gx_color_index)(tptr)[1] << 8) | (tptr)[2]));

                        do { } while (0);

                        if ( (s_pixel) == strans || (t_pixel) == ttrans ) continue; { gx_color_index d_pixel = (((gx_color_index)(dptr)[0] << 16) | ((gx_color_index)(dptr)[1] << 8) | (dptr)[2]); d_pixel = (*rop_proc_table[rop])(d_pixel, s_pixel, t_pixel); (dptr)[0] = (byte)((d_pixel) >> 16), (dptr)[1] = (byte)((uint)(d_pixel) >> 8), (dptr)[2] = (byte)(d_pixel); };
                    }
                }
            }
        }
