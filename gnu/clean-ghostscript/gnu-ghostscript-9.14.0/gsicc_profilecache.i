# 1 "./base/gsicc_profilecache.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./base/gsicc_profilecache.c" 2
# 20 "./base/gsicc_profilecache.c"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
# 1 "./base/stdpre.h" 1
# 253 "./base/stdpre.h"
...
# 21 "./base/gsicc_profilecache.c" 2
...
# 23 "./base/gsicc_profilecache.c" 2
# 1 "./base/gsmemory.h" 1
# 43 "./base/gsmemory.h"
# 1 "./base/gslibctx.h" 1
# 21 "./base/gslibctx.h"
...
# 24 "./base/gsicc_profilecache.c" 2
# 1 "./base/gsstruct.h" 1
# 23 "./base/gsstruct.h"
# 1 "./base/gsstype.h" 1
# 23 "./base/gsstype.h"
...
# 25 "./base/gsicc_profilecache.c" 2
# 1 "./base/scommon.h" 1
# 25 "./base/scommon.h"
# 1 "./base/stdint_.h" 1
# 43 "./base/stdint_.h"
...
# 26 "./base/gsicc_profilecache.c" 2
# 1 "./base/gx.h" 1
# 23 "./base/gx.h"
# 1 "./base/gserrors.h" 1
# 50 "./base/gserrors.h"
...
# 27 "./base/gsicc_profilecache.c" 2
# 1 "./base/gzstate.h" 1
# 22 "./base/gzstate.h"
# 1 "./base/gscpm.h" 1
# 22 "./base/gscpm.h"
...
# 28 "./base/gsicc_profilecache.c" 2
...
# 30 "./base/gsicc_profilecache.c" 2
...
static const gc_ptr_element_t profile_entry_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gsicc_profile_entry_t *)0)->color_space - (char *)((gsicc_profile_entry_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gsicc_profile_entry_t *)0)->next - (char *)((gsicc_profile_entry_t *)0) )) } }; static const gc_struct_data_t profile_entry_reloc_ptrs = { (sizeof(profile_entry_enum_ptrs) / sizeof((profile_entry_enum_ptrs)[0])), 0, 0, profile_entry_enum_ptrs }; static const gs_memory_struct_type_t st_profile_entry = { sizeof(gsicc_profile_entry_t), "gsicc_profile_entry", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &profile_entry_reloc_ptrs };


static const gc_ptr_element_t profile_list_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gsicc_profile_cache_t *)0)->head - (char *)((gsicc_profile_cache_t *)0) )) } }; static const gc_struct_data_t profile_list_reloc_ptrs = { (sizeof(profile_list_enum_ptrs) / sizeof((profile_list_enum_ptrs)[0])), 0, 0, profile_list_enum_ptrs }; static const gs_memory_struct_type_t st_profile_cache = { sizeof(gsicc_profile_cache_t), "gsicc_profile_cache", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &profile_list_reloc_ptrs };
...
gsicc_profilecache_new(gs_memory_t *memory)
{
    ...
    result = (gsicc_profile_cache_t *)(*(memory->stable_memory)->procs.alloc_struct)(memory->stable_memory, &st_profile_cache, "gsicc_profilecache_new");

    if ( result == ((void*)0) )
        return(((void*)0));
    do { (result)->rc.ref_count = 1; (result)->rc.memory = memory->stable_memory; (result)->rc.free = rc_gsicc_profile_cache_free; do { } while (0); } while (0);
    result->head = ((void*)0);
...
rc_gsicc_profile_cache_free(gs_memory_t * mem, void *ptr_in, client_name_t cname)
{
    ...
    while (curr != ((void*)0) ){
        next = curr->next;
        do { if (curr->color_space) { do { do { } while (0); (curr->color_space)->rc.ref_count += (-1); } while (0); if (!(curr->color_space)->rc.ref_count) { do { do { } while (0); (curr->color_space)->rc.free((curr->color_space)->rc.memory, (void *)(curr->color_space), "rc_gsicc_profile_cache_free"); } while (0); (curr->color_space) = 0; } else do { } while (0); } } while (0);
        ((mem->stable_memory)->procs.free_object(mem->stable_memory, curr, "rc_gsicc_profile_cache_free"));
    ...
    ((mem->stable_memory)->procs.free_object(mem->stable_memory, profile_cache, "rc_gsicc_profile_cache_free"));
...
gsicc_add_cs(gs_state * pgs, gs_color_space * colorspace, ulong dictkey)
{
    ...
    result = (gsicc_profile_entry_t *)(*(memory->stable_memory)->procs.alloc_struct)(memory->stable_memory, &st_profile_entry, "gsicc_add_cs");

    if (result == ((void*)0))
        return;


    if (profile_cache->num_entries >= 50) {
        gsicc_remove_cs_entry(profile_cache);
    }


    result->next = profile_cache->head;
    profile_cache->head = result;
    result->color_space = colorspace;
    do { if (colorspace) do { (colorspace)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    result->key = dictkey;
    profile_cache->num_entries++;
}
...
{
    gsicc_profile_cache_t *profile_cache = pgs->icc_profile_cache;
    gsicc_profile_entry_t *prev = ((void*)0), *curr = profile_cache->head;
...
gsicc_remove_cs_entry(gsicc_profile_cache_t *profile_cache)
{
    ...
    do { if (curr->color_space) { do { do { } while (0); (curr->color_space)->rc.ref_count += (-1); } while (0); if (!(curr->color_space)->rc.ref_count) { do { do { } while (0); (curr->color_space)->rc.free((curr->color_space)->rc.memory, (void *)(curr->color_space), "gsicc_remove_cs_entry"); } while (0); (curr->color_space) = 0; } else do { } while (0); } } while (0);
    ((memory->stable_memory)->procs.free_object(memory->stable_memory, curr, "gsicc_remove_cs_entry"));
}
