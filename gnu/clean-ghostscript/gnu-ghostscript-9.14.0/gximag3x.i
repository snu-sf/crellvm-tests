...
# 32 "./base/gximag3x.c" 2

extern const gs_memory_struct_type_t st_color_space;


static int gx_begin_image3x(gx_device *dev, const gs_imager_state *pis, const gs_matrix *pmat, const gs_image_common_t *pim, const gs_int_rect *prect, const gx_drawing_color *pdcolor, const gx_clip_path *pcpath, gs_memory_t *memory, gx_image_enum_common_t **pinfo);
static int gx_image3x_plane_data(gx_image_enum_common_t *info, const gx_image_plane_t *planes, int height, int *rows_used);
static int gx_image3x_end_image(gx_image_enum_common_t *info, bool draw_last);
static int gx_image3x_flush(gx_image_enum_common_t *info);
static bool gx_image3x_planes_wanted(const gx_image_enum_common_t *info, byte *wanted);


static const gc_struct_data_t image3x_reloc_ptrs = { 0, 0, &st_gs_pixel_image, 0 }; static const gs_memory_struct_type_t st_gs_image3x = { sizeof(gs_image3x_t), "gs_image3x_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &image3x_reloc_ptrs };
...
typedef struct gx_image3x_enum_s {
    ...
    image3x_channel_state_t mask[2], pixel;
} gx_image3x_enum_t;

extern const gs_memory_struct_type_t st_gx_image_enum_common;
static const gc_ptr_element_t image3x_enum_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3x_enum_t *)0)->pcdev - (char *)((gx_image3x_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3x_enum_t *)0)->mask[0].info - (char *)((gx_image3x_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3x_enum_t *)0)->mask[0].mdev - (char *)((gx_image3x_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3x_enum_t *)0)->mask[0].data - (char *)((gx_image3x_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3x_enum_t *)0)->mask[1].info - (char *)((gx_image3x_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3x_enum_t *)0)->mask[1].mdev - (char *)((gx_image3x_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3x_enum_t *)0)->mask[1].data - (char *)((gx_image3x_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3x_enum_t *)0)->pixel.info - (char *)((gx_image3x_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3x_enum_t *)0)->pixel.data - (char *)((gx_image3x_enum_t *)0) )) } }; static const gc_struct_data_t image3x_enum_reloc_ptrs = { (sizeof(image3x_enum_enum_ptrs) / sizeof((image3x_enum_enum_ptrs)[0])), 0, &st_gx_image_enum_common, image3x_enum_enum_ptrs }; static const gs_memory_struct_type_t st_image3x_enum = { sizeof(gx_image3x_enum_t), "gx_image3x_enum_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &image3x_enum_reloc_ptrs };
# 114 "./base/gximag3x.c"
                        ...
                        gx_image_enum_common_t **pinfo)
{
    ...
    if (pim->Height <= 0)
        return ((-15));
    penum = (gx_image3x_enum_t *)(*(mem)->procs.alloc_struct)(mem, &st_image3x_enum, "gx_begin_image3x");
    ...
    if (penum->mask[0].data || penum->mask[1].data) {
        ...
        penum->pixel.data =
            (*(mem)->procs.alloc_bytes)(mem, (penum->pixel.width * pim->BitsPerComponent * penum->num_components + 7) >> 3, "gx_begin_image3x(pixel.data)");
    ...
    for (i = 0; i < 2; ++i) {
        ...
        if (code < 0)
            goto out1;
        code = ((dev)->procs.get_profile)(dev, &mdev->icc_struct);
        if (code < 0)
            goto out1;
        do { if (mdev->icc_struct) do { (mdev->icc_struct)->rc.ref_count++; do { } while (0); } while (0); } while (0);
        penum->mask[i].mdev = mdev;
        gs_image_t_init_adjust(&mask[i].image, pmcs, ((bool)1));
        mask[i].image.ColorSpace = pmcs;
        mask[i].image.adjust = ((bool)0);
        ...
        }
        {
            ...
            m_mat.ty -= origin[i].y;
# 274 "./base/gximag3x.c"
            code = ((*((mdev)->procs.begin_typed_image)) (mdev, pis, &m_mat, (const gs_image_common_t *)&mask[i].image, &mask[i].rect, ((void*)0), ((void*)0), mem, &penum->mask[i].info));
    ...
    gs_image_t_init_adjust(&pixel.image, pim->ColorSpace, ((bool)1));
    {
    ...
    if (midev[0])
        gx_device_retain(midev[0], ((bool)1));
    if (midev[1])
        gx_device_retain(midev[1], ((bool)1));
    gx_device_retain(pcdev, ((bool)1));
    *pinfo = (gx_image_enum_common_t *) penum;
    return 0;
  out3:
    if (penum->mask[1].info)
        gx_image_end(penum->mask[1].info, ((bool)0));
    if (penum->mask[0].info)
        gx_image_end(penum->mask[0].info, ((bool)0));
  out2:
    if (penum->mask[1].mdev) {
        gs_closedevice(penum->mask[1].mdev);
        ((mem)->procs.free_object(mem, penum->mask[1].mdev, "gx_begin_image3x(mask[1].mdev)"));

    }
    if (penum->mask[0].mdev) {
        gs_closedevice(penum->mask[0].mdev);
        ((mem)->procs.free_object(mem, penum->mask[0].mdev, "gx_begin_image3x(mask[0].mdev)"));

    }
  out1:
    ((mem)->procs.free_object(mem, penum->mask[0].data, "gx_begin_image3x(mask[0].data)"));
    ((mem)->procs.free_object(mem, penum->mask[1].data, "gx_begin_image3x(mask[1].data)"));
    ((mem)->procs.free_object(mem, penum->pixel.data, "gx_begin_image3x(pixel.data)"));
  out0:
    ((mem)->procs.free_object(mem, penum, "gx_begin_image3x"));
    return code;
}
static bool
                   ...
                   image3x_channel_state_t *pmcs, gs_memory_t *mem)
{
    ...
    if (pmcs->InterleaveType == interleave_chunky) {
        ...
        pmcs->data =
            (*(mem)->procs.alloc_bytes)(mem, (pmcs->width * pimm->MaskDict.BitsPerComponent + 7) >> 3, "gx_begin_image3x(mask data)");
...
static int make_midx_default(gx_device **pmidev, gx_device *dev, int width, int height, int depth, gs_memory_t *mem);
static int
                 ...
                 int depth, gs_memory_t *mem)
{
    ...
    if (width != 0)
        if (height > ((unsigned long)~0L + (unsigned long)0)/width)
            return ((-25));
    if (mdproto == 0)
        return ((-15));
    midev = (gx_device_memory *)(*(mem)->procs.alloc_struct)(mem, &st_device_memory, "make_mid_default");

    if (midev == 0)
        return ((-25));
    gs_make_mem_device(midev, mdproto, mem, 0, ((void*)0));
    midev->bitmap_memory = mem;
    midev->width = width;
    midev->height = height;
    check_device_separable((gx_device *)midev);
    gx_device_fill_in_procs((gx_device *)midev);
    code = ((midev)->procs.open_device)((gx_device *)midev);
    if (code < 0) {
        ((mem)->procs.free_object(mem, midev, "make_midx_default"));
        return code;
    }
    midev->is_open = ((bool)1);
    ((midev)->procs.fill_rectangle)
        ((gx_device *)midev, 0, 0, width, height, (gx_color_index)0);
    *pmidev = (gx_device *)midev;
    return 0;
}
static int make_mcdex_default( gx_device *dev, const gs_imager_state *pis, const gs_matrix *pmat, const gs_image_common_t *pic, const gs_int_rect *prect, const gx_drawing_color *pdcolor, const gx_clip_path *pcpath, gs_memory_t *mem, gx_image_enum_common_t **pinfo, gx_device **pmcdev, gx_device *midev[2], gx_image_enum_common_t *pminfo[2], const gs_int_point origin[2], const gs_image3x_t *pim);
static int
...
# 548 "./base/gximag3x.c"
    ...
    code = ((dev)->procs.get_profile)(dev, &icc_struct);
    if (code < 0) {
        return(code);
    }

    bbdev = (gx_device_bbox *)(*(mem)->procs.alloc_struct_immovable)(mem, &st_device_bbox, "make_mcdex_default");
    ...
    do { if (bbdev->icc_struct) do { (bbdev->icc_struct)->rc.ref_count++; do { } while (0); } while (0); } while (0);

    gx_device_bbox_fwd_open_close(bbdev, ((bool)0));
    code = ((bbdev)->procs.begin_typed_image)
        ((gx_device *)bbdev, pis, pmat, pic, prect, pdcolor, pcpath, mem,
         pinfo);
    if (code < 0) {
        ((mem)->procs.free_object(mem, bbdev, "make_mcdex_default"));
        return code;
    }
                     ...
                     int *rows_used)
{
    ...
    for (i = 0; i < 2; ++i) {
        ...
        if (!penum->mask[i].depth)
            continue;
        h1 = (((h1) < (((mh > penum->mask[i].y) ? (mh - penum->mask[i].y) : mh))) ? (h1) : (((mh > penum->mask[i].y) ? (mh - penum->mask[i].y) : mh)));
        if (penum->mask[i].InterleaveType == interleave_chunky)
            ++num_chunky;
    }
    h = (((height) < (h1)) ? (height) : (h1));
    ...
    *rows_used = 0;
    ...
    if (num_chunky) {
        ...
        const byte *sptr = (planes[0].data + (bit_x >> 3)); int sbit = (bit_x & 7);

        byte *pptr = (penum->pixel.data); int pbit = (0); byte pbbyte = ((pbit) ? (byte)(*(pptr) & (0xff00 >> (pbit))) : 0);

        byte *dptr[2]; int dbit[2]; byte dbbyte[2];
        ...
        for (i = 0; i < 2; ++i)
            if (penum->mask[i].data) {
                ...
                dbit[i] = (0);
                dbbyte[i] = ((0) ? (byte)(*(dptr[i]) & (0xff00 >> (0))) : 0);
            } else
                depth[i] = 0;
        ...
        for (x = 0; x < width; ++x) {
            ...
            for (i = 0; i < 2; ++i)
                if (depth[i]) {
                    do { switch ( (bpc) >> 2 ) { case 0: value = (*(sptr) >> (8 - (sbit) - (bpc))) & ((bpc) | 1); break; case 1: value = (*(sptr) >> (4 - (sbit))) & 0xf; break; case 2: value = *(sptr); break; case 3: value = ((sbit) ? ((*(sptr) & 0xf) << 8) | (sptr)[1] : (*(sptr) << 4) | ((sptr)[1] >> 4)); break; default: return ((-15)); } } while (0); do { sbit += (bpc); sptr += sbit >> 3; sbit &= 7; } while (0);
                    do { switch ( (depth[i]) >> 2 ) { case 0: if ( (dbit[i] += (depth[i])) == 8 ) *(dptr[i])++ = dbbyte[i] | (byte)(value), dbbyte[i] = 0, dbit[i] = 0; else dbbyte[i] |= (byte)((value) << (8 - dbit[i])); break; case 1: if ( dbit[i] ^= 4 ) dbbyte[i] = (byte)((value) << 4); else *(dptr[i])++ = dbbyte[i] | ((byte)(value)); break; case 3: if ( dbit[i] ^= 4 ) *(dptr[i])++ = (byte)((value) >> 4), dbbyte[i] = (byte)((value) << 4); else *(dptr[i]) = dbbyte[i] | (byte)((value) >> 8), (dptr[i])[1] = (byte)(value), dptr[i] += 2; break; case 2: *(dptr[i])++ = (byte)(value); break; default: return ((-15)); } } while (0);

                }
            for (i = 0; i < num_components; ++i) {
                do { switch ( (bpc) >> 2 ) { case 0: value = (*(sptr) >> (8 - (sbit) - (bpc))) & ((bpc) | 1); break; case 1: value = (*(sptr) >> (4 - (sbit))) & 0xf; break; case 2: value = *(sptr); break; case 3: value = ((sbit) ? ((*(sptr) & 0xf) << 8) | (sptr)[1] : (*(sptr) << 4) | ((sptr)[1] >> 4)); break; default: return ((-15)); } } while (0); do { sbit += (bpc); sptr += sbit >> 3; sbit &= 7; } while (0);
                do { switch ( (bpc) >> 2 ) { case 0: if ( (pbit += (bpc)) == 8 ) *(pptr)++ = pbbyte | (byte)(value), pbbyte = 0, pbit = 0; else pbbyte |= (byte)((value) << (8 - pbit)); break; case 1: if ( pbit ^= 4 ) pbbyte = (byte)((value) << 4); else *(pptr)++ = pbbyte | ((byte)(value)); break; case 3: if ( pbit ^= 4 ) *(pptr)++ = (byte)((value) >> 4), pbbyte = (byte)((value) << 4); else *(pptr) = pbbyte | (byte)((value) >> 8), (pptr)[1] = (byte)(value), pptr += 2; break; case 2: *(pptr)++ = (byte)(value); break; default: return ((-15)); } } while (0);
            }
        }
        for (i = 0; i < 2; ++i)
            if (penum->mask[i].data)
                if ( (dbit[i]) != 0 ) *(dptr[i]) = dbbyte[i] | (*(dptr[i]) & (0xff >> (dbit[i])));;
        if ( (pbit) != 0 ) *(pptr) = pbbyte | (*(pptr) & (0xff >> (pbit)));;
        }
...
gx_image3x_end_image(gx_image_enum_common_t * info, bool draw_last)
{
    ...
    do { if (pcdev->icc_struct) { do { do { } while (0); (pcdev->icc_struct)->rc.ref_count += (-1); } while (0); if (!(pcdev->icc_struct)->rc.ref_count) { do { do { } while (0); (pcdev->icc_struct)->rc.free((pcdev->icc_struct)->rc.memory, (void *)(pcdev->icc_struct), "gx_image3x_end_image(pcdev->icc_struct)"); } while (0); (pcdev->icc_struct) = 0; } else do { } while (0); } } while (0);
    pcdev->icc_struct = ((void*)0);
    ...
    ((mem)->procs.free_object(mem, penum->mask[0].data, "gx_image3x_end_image(mask[0].data)"));

    ((mem)->procs.free_object(mem, penum->mask[1].data, "gx_image3x_end_image(mask[1].data)"));

    ((mem)->procs.free_object(mem, penum->pixel.data, "gx_image3x_end_image(pixel.data)"));

    ((mem)->procs.free_object(mem, pcdev, "gx_image3x_end_image(pcdev)"));
    ((mem)->procs.free_object(mem, mdev0, "gx_image3x_end_image(mask[0].mdev)"));
    ((mem)->procs.free_object(mem, mdev1, "gx_image3x_end_image(mask[1].mdev)"));
