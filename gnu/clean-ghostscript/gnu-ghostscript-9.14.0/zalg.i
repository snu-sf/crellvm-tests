...
zsort(i_ctx_t *i_ctx_p)
{
    ...
    if ((((const byte *)&((&op[-1])->tas.type_attrs))[1]) == t_mixedarray || (((const byte *)&((&op[-1])->tas.type_attrs))[1]) == t_shortarray)
        return ((-7));
    if ( !(((&op[-1])->tas.type_attrs & ((((1 << 6) - (1)) << 8) + (0x10))) == (((t_array) << 8) + (0x10))) ) return ((!((((const byte *)&((&op[-1])->tas.type_attrs))[1]) == (t_array)) ? check_type_failed(&op[-1]) : (-7)));

    if (!(((&op[0])->tas.type_attrs) & (0x80)))
        return (check_type_failed(&op[0]));
    switch (((&op[0])->tas.type_attrs >= (t_next_index << 8) ? t_operator : (((const byte *)&((&op[0])->tas.type_attrs))[1]))) {
        case t_array:
        case t_mixedarray:
        case t_shortarray:
        case t_string:
            if (!(((&op[0])->tas.type_attrs) & (0x40)))
                return ((-7));
            break;
        case t_name:
        case t_operator:
    ...
    if (N <= 1) {
        ...
        if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (11) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 11); if ( es_code_ < 0 ) return es_code_; };
        (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (zsort_cleanup), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_null) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
        ((&(((i_ctx_p->exec_stack).stack).p)[1])->value.intval = (N / 2 + 1), ((&(((i_ctx_p->exec_stack).stack).p)[1])->tas.type_attrs = ((t_integer) << 8) + (0)) );
        ((&(((i_ctx_p->exec_stack).stack).p)[2])->value.intval = (N), ((&(((i_ctx_p->exec_stack).stack).p)[2])->tas.type_attrs = ((t_integer) << 8) + (0)) );
        ((&(((i_ctx_p->exec_stack).stack).p)[3])->value.intval = (0), ((&(((i_ctx_p->exec_stack).stack).p)[3])->tas.type_attrs = ((t_integer) << 8) + (0)) );
        ((&(((i_ctx_p->exec_stack).stack).p)[4])->value.intval = (0), ((&(((i_ctx_p->exec_stack).stack).p)[4])->tas.type_attrs = ((t_integer) << 8) + (0)) );
        (((&(((i_ctx_p->exec_stack).stack).p)[5])->tas.type_attrs = ((t_null) << 8) + (0)) );
        ((&(((i_ctx_p->exec_stack).stack).p)[6])->value.intval = (2), ((&(((i_ctx_p->exec_stack).stack).p)[6])->tas.type_attrs = ((t_integer) << 8) + (0)) );
        (*(&(((i_ctx_p->exec_stack).stack).p)[7]) = *(&op[0]));
        (*(&(((i_ctx_p->exec_stack).stack).p)[8]) = *(&op[-1]));
        (((i_ctx_p->exec_stack).stack).p) += 8;
        ((&(((i_ctx_p->exec_stack).stack).p)[1])->value.opproc = (zsort_continue), ((&(((i_ctx_p->exec_stack).stack).p)[1])->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((&(((i_ctx_p->exec_stack).stack).p)[1])->tas.rsize = (0)));
        (((&op[0])->tas.type_attrs = ((t_null) << 8) + (0)) );
...
zsort_continue(i_ctx_t *i_ctx_p)
{
    ...
    ref *Rn;
# 124 "./psi/zalg.c"
    status = (((i_ctx_p->exec_stack).stack).p) - 8;
    Rn = (status[8]).value.refs - 1;
    switch ((status[6].value.intval)) {
        case 2:
H2: if ((status[1].value.intval) > 1) {
                (status[1].value.intval)--;
                (*(&(status[5])) = *(&Rn[(status[1].value.intval)]));
            } else {
                (*(&(status[5])) = *(&Rn[(status[2].value.intval)]));
                (((void)((((((&Rn[(status[2].value.intval)])->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), &(status[8]), (ref_packed *)(&Rn[(status[2].value.intval)]), ".sort(H2-a)") : 0))), ((void)(((*(&Rn[(status[2].value.intval)]) = *(&Rn[1])), ((&Rn[(status[2].value.intval)])->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
                (status[2].value.intval)--;
                if ((status[2].value.intval) <= 1) {
                    (((void)((((((&Rn[1])->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), &(status[8]), (ref_packed *)(&Rn[1]), ".sort(H2-b)") : 0))), ((void)(((*(&Rn[1]) = *(&(status[5]))), ((&Rn[1])->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
                    (((i_ctx_p->exec_stack).stack).p) -= 9;
                    ((((i_ctx_p->op_stack).stack).p) -= (1));
                    return 14;
                }
            }
            (status[4].value.intval) = (status[1].value.intval);
H4: (status[3].value.intval) = (status[4].value.intval);
            (status[4].value.intval) <<= 1;
            if ((status[4].value.intval) >= (status[2].value.intval))
                if ((status[4].value.intval) == (status[2].value.intval))
                    goto H6;
                else
                    goto H8;
            else {
          (status[6].value.intval) = 5;
                ...
                (*(&op[-1]) = *(&Rn[(status[4].value.intval)]));
                (*(&op[0]) = *(&Rn[(status[4].value.intval) + 1]));
                break;
            }
        case 5:
            if (!((((const byte *)&((&op[0])->tas.type_attrs))[1]) == (t_boolean)))
                return ((-20));
            if (op[0].value.boolval)
                (status[4].value.intval)++;
H6: (status[6].value.intval) = 6;
            do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
            (*(&op[-1]) = *(&(status[5])));
            (*(&op[0]) = *(&Rn[(status[4].value.intval)]));
            break;
        case 6:
            if (!((((const byte *)&((&op[0])->tas.type_attrs))[1]) == (t_boolean)))
                return ((-20));
            if (op[0].value.boolval) {
            (((void)((((((&Rn[(status[3].value.intval)])->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), &(status[8]), (ref_packed *)(&Rn[(status[3].value.intval)]), ".sort(H7)") : 0))), ((void)(((*(&Rn[(status[3].value.intval)]) = *(&Rn[(status[4].value.intval)])), ((&Rn[(status[3].value.intval)])->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
                goto H4;
            } else {
H8: (((void)((((((&Rn[(status[3].value.intval)])->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), &(status[8]), (ref_packed *)(&Rn[(status[3].value.intval)]), ".sort(H8)") : 0))), ((void)(((*(&Rn[(status[3].value.intval)]) = *(&(status[5]))), ((&Rn[(status[3].value.intval)])->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
                goto H2;
            }
        default:
            ((((i_ctx_p->op_stack).stack).p) -= (1));
    ...
    (*((((i_ctx_p->exec_stack).stack).p)) = *(&(status[7])));
    return 5;
