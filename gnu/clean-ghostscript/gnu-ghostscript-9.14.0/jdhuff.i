...
typedef struct {
  ...
  d_derived_tbl * dc_cur_tbls[64];
  d_derived_tbl * ac_cur_tbls[64];
    ...
    d_derived_tbl * htbl, int min_bits)
{
  ...
  code = (((int) (get_buffer >> (bits_left -= (l)))) & bmask[l]);
  ...
  while (code > htbl->maxcode[l]) {
    ...
    code |= (((int) (get_buffer >> (bits_left -= (1)))) & bmask[1]);
    l++;
  }
...
decode_mcu_DC_first (j_decompress_ptr cinfo, JBLOCKROW *MCU_data)
{
 ...
 return FALSE;
  ...
  if (! entropy->insufficient_data) {
    ...
    for (blkn = 0; blkn < cinfo->blocks_in_MCU; blkn++) {
      ...
      { register int nb, look; if (bits_left < 8) { if (! jpeg_fill_bit_buffer(&br_state,get_buffer,bits_left, 0)) {return FALSE;} get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; if (bits_left < 8) { nb = 1; goto label1; } } look = (((int) (get_buffer >> (bits_left - (8)))) & bmask[8]); if ((nb = tbl->look_nbits[look]) != 0) { (bits_left -= (nb)); s = tbl->look_sym[look]; } else { nb = 8 +1; label1: if ((s=jpeg_huff_decode(&br_state,get_buffer,bits_left,tbl,nb)) < 0) { return FALSE; } get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; } };
      if (s) {
 ...
 r = (((int) (get_buffer >> (bits_left -= (s)))) & bmask[s]);
 s = ((r) <= bmask[(s) - 1] ? (r) - bmask[s] : (r));
      }
...
decode_mcu_AC_first (j_decompress_ptr cinfo, JBLOCKROW *MCU_data)
{
 ...
 { register int nb, look; if (bits_left < 8) { if (! jpeg_fill_bit_buffer(&br_state,get_buffer,bits_left, 0)) {return FALSE;} get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; if (bits_left < 8) { nb = 1; goto label2; } } look = (((int) (get_buffer >> (bits_left - (8)))) & bmask[8]); if ((nb = tbl->look_nbits[look]) != 0) { (bits_left -= (nb)); s = tbl->look_sym[look]; } else { nb = 8 +1; label2: if ((s=jpeg_huff_decode(&br_state,get_buffer,bits_left,tbl,nb)) < 0) { return FALSE; } get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; } };
 r = s >> 4;
 s &= 15;
 if (s) {
   k += r;
   ...
   if (r != 15) {
     if (r) {
       EOBRUN = 1 << r;
       { if (bits_left < (r)) { if (! jpeg_fill_bit_buffer(&(br_state),get_buffer,bits_left,r)) { return FALSE; } get_buffer = (br_state).get_buffer; bits_left = (br_state).bits_left; } };
       r = (((int) (get_buffer >> (bits_left -= (r)))) & bmask[r]);
       EOBRUN += r;
       EOBRUN--;
     }
     break;
...
decode_mcu_DC_refine (j_decompress_ptr cinfo, JBLOCKROW *MCU_data)
{
 ...
 return FALSE;
  ...
  for (blkn = 0; blkn < cinfo->blocks_in_MCU; blkn++) {
    ...
    { if (bits_left < (1)) { if (! jpeg_fill_bit_buffer(&(br_state),get_buffer,bits_left,1)) { return FALSE; } get_buffer = (br_state).get_buffer; bits_left = (br_state).bits_left; } };
    if ((((int) (get_buffer >> (bits_left -= (1)))) & bmask[1]))
...
decode_mcu_AC_refine (j_decompress_ptr cinfo, JBLOCKROW *MCU_data)
{
 ...
 return FALSE;
  ...
  if (! entropy->insufficient_data) {
    ...
    if (EOBRUN == 0) {
      do {
 { register int nb, look; if (bits_left < 8) { if (! jpeg_fill_bit_buffer(&br_state,get_buffer,bits_left, 0)) {goto undoit;} get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; if (bits_left < 8) { nb = 1; goto label3; } } look = (((int) (get_buffer >> (bits_left - (8)))) & bmask[8]); if ((nb = tbl->look_nbits[look]) != 0) { (bits_left -= (nb)); s = tbl->look_sym[look]; } else { nb = 8 +1; label3: if ((s=jpeg_huff_decode(&br_state,get_buffer,bits_left,tbl,nb)) < 0) { goto undoit; } get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; } };
 r = s >> 4;
 s &= 15;
 if (s) {
   if (s != 1)
...
decode_mcu_sub (j_decompress_ptr cinfo, JBLOCKROW *MCU_data)
{
 ...
 return FALSE;
  ...
  if (! entropy->insufficient_data) {
    ...
    for (blkn = 0; blkn < cinfo->blocks_in_MCU; blkn++) {
      ...
      { register int nb, look; if (bits_left < 8) { if (! jpeg_fill_bit_buffer(&br_state,get_buffer,bits_left, 0)) {return FALSE;} get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; if (bits_left < 8) { nb = 1; goto label1; } } look = (((int) (get_buffer >> (bits_left - (8)))) & bmask[8]); if ((nb = htbl->look_nbits[look]) != 0) { (bits_left -= (nb)); s = htbl->look_sym[look]; } else { nb = 8 +1; label1: if ((s=jpeg_huff_decode(&br_state,get_buffer,bits_left,htbl,nb)) < 0) { return FALSE; } get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; } };
 ...
 for (; k < coef_limit; k++) {
   { register int nb, look; if (bits_left < 8) { if (! jpeg_fill_bit_buffer(&br_state,get_buffer,bits_left, 0)) {return FALSE;} get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; if (bits_left < 8) { nb = 1; goto label2; } } look = (((int) (get_buffer >> (bits_left - (8)))) & bmask[8]); if ((nb = htbl->look_nbits[look]) != 0) { (bits_left -= (nb)); s = htbl->look_sym[look]; } else { nb = 8 +1; label2: if ((s=jpeg_huff_decode(&br_state,get_buffer,bits_left,htbl,nb)) < 0) { return FALSE; } get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; } };
 ...
 if (s) {
   ...
   (bits_left -= (s));
      ...
      for (; k <= Se; k++) {
 { register int nb, look; if (bits_left < 8) { if (! jpeg_fill_bit_buffer(&br_state,get_buffer,bits_left, 0)) {return FALSE;} get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; if (bits_left < 8) { nb = 1; goto label3; } } look = (((int) (get_buffer >> (bits_left - (8)))) & bmask[8]); if ((nb = htbl->look_nbits[look]) != 0) { (bits_left -= (nb)); s = htbl->look_sym[look]; } else { nb = 8 +1; label3: if ((s=jpeg_huff_decode(&br_state,get_buffer,bits_left,htbl,nb)) < 0) { return FALSE; } get_buffer = br_state.get_buffer; bits_left = br_state.bits_left; } };
