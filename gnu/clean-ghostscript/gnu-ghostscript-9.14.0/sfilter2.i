...
# 24 "./base/sfilter2.c" 2
# 1 "./base/scanchar.h" 1
# 38 "./base/scanchar.h"
extern const byte scan_char_array[4 + 256];
# 25 "./base/sfilter2.c" 2



static const gs_memory_struct_type_t st_A85E_state = { sizeof(stream_A85E_state), "ASCII85Encode state", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };
...
s_A85E_init(stream_state * st)
{
    ...
    return ((ss)->count = 0, (ss)->last_char = '\n', 0);
}
...
static const gs_memory_struct_type_t st_BT_state = { sizeof(stream_BT_state), "ByteTranslateEncode/Decode state", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };
...
const stream_template s_BTE_template = {
    &st_BT_state, ((void*)0), s_BT_process, 1, 1
};
