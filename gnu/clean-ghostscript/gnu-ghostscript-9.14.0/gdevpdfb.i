# 1 "./devices/vector/gdevpdfb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpdfb.c" 2
# 18 "./devices/vector/gdevpdfb.c"
# 1 "./base/string_.h" 1
# 23 "./base/string_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 33 "./base/string_.h" 2
# 19 "./devices/vector/gdevpdfb.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
...
# 20 "./devices/vector/gdevpdfb.c" 2
...
# 22 "./devices/vector/gdevpdfb.c" 2
...
# 23 "./devices/vector/gdevpdfb.c" 2
...
# 24 "./devices/vector/gdevpdfb.c" 2
...
extern int gx_dc_read_color( gx_color_index * pcolor,
                                  ...
                                  const byte * pdata,
                                  int size );
# 26 "./devices/vector/gdevpdfb.c" 2
# 1 "./base/gxpcolor.h" 1
# 23 "./base/gxpcolor.h"
# 1 "./base/gspcolor.h" 1
# 51 "./base/gspcolor.h"
...
# 27 "./devices/vector/gdevpdfb.c" 2
...
# 29 "./devices/vector/gdevpdfb.c" 2
...
# 30 "./devices/vector/gdevpdfb.c" 2
...
# 31 "./devices/vector/gdevpdfb.c" 2
# 1 "./base/gsptype1.h" 1
# 38 "./base/gsptype1.h"
...
# 32 "./devices/vector/gdevpdfb.c" 2
                   ...
                   int for_pattern)
{
    ...
    gs_image_t_init_mask_adjust(pim, ((bool)1), ((bool)1));
    ...
    if ((code = pdf_begin_write_image(pdev, piw, id, w, h, ((void*)0), in_line)) < 0 ||
              ...
              gx_color_index one, const gx_clip_path *pcpath)
{
    ...
    byte palette[sizeof(gx_color_index_data) * 2];
    gs_image_t image;
    ...
    if (zero == ((gx_color_index)(~0))) {
        ...
        if (id != 0L && sourcex == 0 && show_enum) {
            ...
            if (pres == 0) {
                ...
                if (code < 0)
                    return code;
                y_offset = -y_offset;
                width = psdf_round(pdev->char_width.x, 100, 10);
                ...
                code = pdf_begin_write_image(pdev, &writer, 0L, w, h, ((void*)0), ((bool)1));
                if (code < 0)
                    return code;
        ...
        gs_image_t_init_adjust(&image, pcs, ((bool)1));
        ...
        pcs->params.indexed.use_proc = ((bool)0);
        gs_image_t_init_adjust(&image, pcs, ((bool)1));
    ...
    pdf_make_bitmap_image(&image, x, y, w, h);
    {
        ...
        pdf_image_writer_init(&writer);
        code = pdf_begin_write_image(pdev, &writer, 0L, w, h, ((void*)0), in_line);
        if (code < 0)
            return code;
    }
  wr:
    if (image.ImageMask)
        ...
        code = pdf_color_space_named(pdev, &cs_value, ((void*)0), pcs,
                               &writer.pin->color_spaces, in_line, ((void*)0), 0, ((bool)0));
        if (code < 0)
            return code;
        pcsvalue = &cs_value;
    }
# 297 "./devices/vector/gdevpdfb.c"
    if (pres) {
        if (!pdev->NoT3CCITT) {
            ...
            image.Decode[1] = d0;
            psdf_CFE_binary(&writer.binary[0], image.Width, image.Height, ((bool)1));
            invert ^= 0xff;
        }
    } else {
        ...
        psdf_setup_image_filters((gx_device_psdf *) pdev, &writer.binary[0],
                                 (gs_pixel_image_t *)&image, ((void*)0), ((void*)0), ((bool)1), in_line);
    }
                    ...
                    int for_pattern)
{
    ...
    if (!base)
        return 1;
    gs_image_t_init_adjust(pim, pcs, ((bool)1));
    pdf_make_bitmap_image(pim, x, y, w, h);
    ...
    if ((code = pdf_begin_write_image(pdev, piw, id, w, h, ((void*)0), in_line)) < 0 ||
        (code = pdf_color_space_named(pdev, &cs_value, ((void*)0), pcs,
                                &piw->pin->color_spaces, in_line, ((void*)0), 0, ((bool)0))) < 0 ||
        (for_pattern < 2 || nbytes < 512000 ?
            (code = psdf_setup_lossless_filters((gx_device_psdf *) pdev,
                        &piw->binary[0], (gs_pixel_image_t *)pim, ((bool)0))) :
            (code = psdf_setup_image_filters((gx_device_psdf *) pdev,
                        &piw->binary[0], (gs_pixel_image_t *)pim, ((void*)0), ((void*)0), ((bool)0), ((bool)0)))
        ) < 0 ||
        (code = pdf_begin_image_data(pdev, piw, (const gs_pixel_image_t *)pim,
                                     &cs_value, 0)) < 0
        )
                   ...
                   gs_logical_operation_t lop, const gx_clip_path * pcpath)
{
    ...
    if (width <= 0 || height <= 0)
        return 0;
    if (depth > 1 || (!((pdcolor)->type == (&gx_dc_type_data_pure)) != 0 && !(gx_dc_is_pattern1_color(pdcolor))))
        return gx_default_fill_mask(dev, data, data_x, raster, id,
                                    x, y, width, height, pdcolor, depth, lop,
                                    pcpath);
    return pdf_copy_mono(pdev, data, data_x, raster, id, x, y, width, height,
                         ((gx_color_index)(~0)), ((pdcolor)->colors.pure),
                         pcpath);
}
                              ...
                              int px, int py)
{
    ...
    if (tiles->id == 0L || tiles->shift != 0 ||
        (w < tw && h < th) ||
        color0 != ((gx_color_index)(~0))
        )
        goto use_default;
