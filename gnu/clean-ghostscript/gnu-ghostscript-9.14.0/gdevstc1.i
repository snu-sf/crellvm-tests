# 1 "./devices/gdevstc1.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/gdevstc1.c" 2
# 37 "./devices/gdevstc1.c"
...
# 59 "./devices/gdevstc1.c"
   if(npixel > 0) {
     ...
     int buf_size;
# 99 "./devices/gdevstc1.c"
     buf_size =
           sdev->stc.dither->bufadd
             + (-npixel)
               * (sdev->stc.dither->flags/256)
     ...
     if((sdev->stc.dither->flags & 24) != 8) return -2;




      if((sdev->stc.dither->flags & 64) != 0) return -3;
