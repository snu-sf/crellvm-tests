# 1 "./openjpeg/libopenjpeg/mct.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/mct.c" 2
# 35 "./openjpeg/libopenjpeg/mct.c"
...
# 36 "./openjpeg/libopenjpeg/mct.c" 2
...
# 39 "./openjpeg/libopenjpeg/mct.c" 2
...
void opj_mct_encode(
  OPJ_INT32* __restrict__ c0,
  OPJ_INT32* __restrict__ c1,
  OPJ_INT32* __restrict__ c2,
  OPJ_UINT32 n)
{
 OPJ_UINT32 i;
 for(i = 0; i < n; ++i) {
...
void opj_mct_decode_real(
  OPJ_FLOAT32* __restrict__ c0,
  OPJ_FLOAT32* __restrict__ c1,
  OPJ_FLOAT32* __restrict__ c2,
  OPJ_UINT32 n)
{
 OPJ_UINT32 i;
        ...
        OPJ_UINT32 isSigned)
{
 ...
 lCurrentData = (OPJ_INT32 *) ((size_t)((pNbComp + lNbMatCoeff) * sizeof(OPJ_INT32)) >= (size_t)-0x100 ? ((void*)0) : malloc((pNbComp + lNbMatCoeff) * sizeof(OPJ_INT32)));
 if (! lCurrentData) {
  return 0;
 }
        ...
        OPJ_UINT32 isSigned)
{
 ...
 lCurrentData = (OPJ_FLOAT32 *) ((size_t)(2 * pNbComp * sizeof(OPJ_FLOAT32)) >= (size_t)-0x100 ? ((void*)0) : malloc(2 * pNbComp * sizeof(OPJ_FLOAT32)));
 if (! lCurrentData) {
  return 0;
 }
