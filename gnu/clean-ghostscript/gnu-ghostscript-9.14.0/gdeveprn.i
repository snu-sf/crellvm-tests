# 1 "./contrib/pcl3/eprn/gdeveprn.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./contrib/pcl3/eprn/gdeveprn.c" 2
# 38 "./contrib/pcl3/eprn/gdeveprn.c"
static const char
  cm_id[] = "@(#)$Id: gdeveprn.c,v 1.25 2001/04/30 05:15:51 Martin Rel $";
# 61 "./contrib/pcl3/eprn/gdeveprn.c"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
# 1 "./base/stdpre.h" 1
# 253 "./base/stdpre.h"
...
# 62 "./contrib/pcl3/eprn/gdeveprn.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 65 "./contrib/pcl3/eprn/gdeveprn.c" 2
...
# 66 "./contrib/pcl3/eprn/gdeveprn.c" 2
...
# 67 "./contrib/pcl3/eprn/gdeveprn.c" 2
...
# 69 "./contrib/pcl3/eprn/gdeveprn.c" 2
# 80 "./contrib/pcl3/eprn/gdeveprn.c"
# 1 "./psi/iref.h" 1
# 22 "./psi/iref.h"
# 1 "./base/stdint_.h" 1
# 43 "./base/stdint_.h"
...
# 81 "./contrib/pcl3/eprn/gdeveprn.c" 2
# 1 "./base/gsmemraw.h" 1
# 82 "./contrib/pcl3/eprn/gdeveprn.c" 2
# 1 "./base/gsmemory.h" 1
# 42 "./base/gsmemory.h"
# 1 "./base/gstypes.h" 1
# 28 "./base/gstypes.h"
...
# 83 "./contrib/pcl3/eprn/gdeveprn.c" 2
...
# 85 "./contrib/pcl3/eprn/gdeveprn.c" 2
# 1 "./psi/icstate.h" 1
# 22 "./psi/icstate.h"
# 1 "./psi/imemory.h" 1
# 22 "./psi/imemory.h"
...
# 98 "/usr/include/bits/stat.h" 3 4
    __time_t st_atime;
...
# 156 "/usr/include/bits/stat.h" 3 4
    __time_t st_atime;
    __syscall_ulong_t st_atimensec;
    __time_t st_mtime;
    __syscall_ulong_t st_mtimensec;
...
extern int chmod (const char *__file, __mode_t __mode)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1)));
# 298 "/usr/include/sys/stat.h" 3 4
...
# 502 "/usr/include/sys/stat.h" 3 4
extern __inline __attribute__ ((__gnu_inline__)) int
...
# 86 "./contrib/pcl3/eprn/gdeveprn.c" 2
...
# 88 "./contrib/pcl3/eprn/gdeveprn.c" 2
...
# 90 "./contrib/pcl3/eprn/gdeveprn.c" 2
# 1 "./psi/imain.h" 1
# 23 "./psi/imain.h"
# 1 "./base/gsexit.h" 1
# 26 "./base/gsexit.h"
...
# 91 "./contrib/pcl3/eprn/gdeveprn.c" 2
# 1 "./base/gscoord.h" 1
# 24 "./base/gscoord.h"
...
# 92 "./contrib/pcl3/eprn/gdeveprn.c" 2
...
# 1 "./base/gsio.h" 1
# 28 "./base/gxstdio.h" 2
# 99 "./contrib/pcl3/eprn/gdeveprn.c" 2



# 1 "./contrib/pcl3/eprn/pagecount.h" 1
# 22 "./contrib/pcl3/eprn/pagecount.h"
#pragma ident "@(#)$Id: pagecount.h,v 1.3 2000/11/19 07:05:17 Martin Rel $"
# 34 "./contrib/pcl3/eprn/pagecount.h"
...
# 103 "./contrib/pcl3/eprn/gdeveprn.c" 2
...
# 105 "./contrib/pcl3/eprn/gdeveprn.c" 2
# 123 "./contrib/pcl3/eprn/gdeveprn.c"
void eprn_get_initial_matrix(gx_device *device, gs_matrix *mptr)
{
  ...
  if (dev->eprn.code == ms_none) {
    ...
    if (eprn_set_page_layout(dev) != 0)
      (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("  Processing can't be stopped at this point although this error " "occurred.\n"));
...
# 166 "./contrib/pcl3/eprn/gdeveprn.c"
  if (dev->eprn.soft_tumble && dev->ShowpageCount % 2 != 0) quarters += 2;


  for (j = 0; j < 2; j++) pixels_per_bp[j] = dev->HWResolution[j]/72.0;
  ...
  switch (quarters % 4) {
  case 0:
# 214 "./contrib/pcl3/eprn/gdeveprn.c"
    gx_default_get_initial_matrix(device, mptr);
# 225 "./contrib/pcl3/eprn/gdeveprn.c"
    break;
  case 1:
...
# 280 "./contrib/pcl3/eprn/gdeveprn.c"
  {
...
# 311 "./contrib/pcl3/eprn/gdeveprn.c"
static void print_flags(ms_MediaCode flags, const ms_Flag *user_flags)
{

  if (user_flags != ((void*)0)) {
    while (user_flags->code != ms_none) {
      if (user_flags->code & flags) {
        (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s", user_flags->name));
  ...
  if (flags & 0x0400U) (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("Small"));
  if (flags & 0x0800U ) (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("Big"));
  if (flags & 0x2000U) (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("Extra"));
  flags &= ~(0x0400U | 0x0800U | 0x2000U);


  if (flags & ~0x4000U)
    (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("0x%04X", (unsigned int)(flags & ~0x4000U)));


  if (flags & 0x4000U) (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("." "Transverse"));

  return;
}
# 355 "./contrib/pcl3/eprn/gdeveprn.c"
static void eprn_flag_mismatch(const struct s_eprn_Device *eprn,
  bool no_match)
{
  if (eprn->fmr != ((void*)0)) (*eprn->fmr)(eprn, no_match);
  else {
    const char *epref = eprn->CUPS_messages? "ERROR: ": "";

    (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s" "? eprn: " "The %s does not support ", epref, eprn->cap->name));

    if (eprn->desired_flags == 0) (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("an empty set of media flags"));
    else {
      (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("the \""));
      print_flags(eprn->desired_flags, eprn->flag_desc);
      (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("\" flag(s)"));
    }
    (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("\n%s  (ignoring presence or absence of \"", epref));
    {
      ms_MediaCode optional = 0x4000U;
      if (eprn->optional_flags != ((void*)0)) {
        const ms_MediaCode *of = eprn->optional_flags;
        while (*of != ms_none) optional |= *of++;
      }
      print_flags(optional, eprn->flag_desc);
    }
    (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("\") for "));
    ...
    (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem(" page size.\n"));
  }

  return;
}
# 396 "./contrib/pcl3/eprn/gdeveprn.c"
  ...
  const ms_MediaCode *optional, ms_MediaCode old_code, ms_MediaCode new_code)
{
  ...
  old_code = ((old_code) & 0xFF00U);
  new_code = ((new_code) & 0xFF00U);
  ...
  if (old_diff == 0) return ((bool)0);
  if (new_diff == 0) return ((bool)1);


  old_diff = old_diff & ~0x4000U;
  new_diff = new_diff & ~0x4000U;
  if (old_diff == 0) return ((bool)0);
  if (new_diff == 0) return ((bool)1);
  ...
  if (optional != ((void*)0)) {
    ...
    while (*opt != ms_none) {
      ...
      if (old_diff == 0) {
        if (new_diff != 0) return ((bool)0);


        {
          ms_MediaCode diff = ((old_code ^ new_code) & 0xFF00U);
          while (optional < opt && (diff & *opt) == 0) opt--;
          if ((diff & *opt) == 0) {
            if ((diff & 0x4000U) == 0) return ((bool)0);

            return (new_code & 0x4000U) ==
              (desired & 0x4000U);
          }
...
# 461 "./contrib/pcl3/eprn/gdeveprn.c"
static bool flag_match(ms_MediaCode desired,
  const ms_MediaCode *optional, ms_MediaCode code)
{
  code = (((code) & 0xFF00U) ^ desired) & ~0x4000U;
  if (code == 0) return ((bool)1);

  if (optional == ((void*)0)) return ((bool)0);
...
# 496 "./contrib/pcl3/eprn/gdeveprn.c"
...
# 533 "./contrib/pcl3/eprn/gdeveprn.c"
  if (w > h) {
    float temp;
    temp = w; w = h; h = temp;
  ...
  if (eprn->media_overrides == ((void*)0)) pd = eprn->cap->sizes;
  ...
  if (eprn->cap->custom != ((void*)0)) {
    ...
    if (best_cmatch != ((void*)0) && eprn->media_overrides != ((void*)0)) {
      for (pd = eprn->media_overrides; pd->code != ms_none; pd++) {
        if (((ms_Size)((pd->code) & ~0xFF00U)) == ms_CustomPageSize) {
          if (best_cdmatch == ((void*)0) ||
  ...
  if (best_dmatch == ((void*)0)) {
    ...
    if (best_cmatch == ((void*)0)) {
      ...
      (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s" "? eprn: " "This document requests a page size of %.0f x %.0f bp.\n", epref, dev->MediaSize[0], dev->MediaSize[1]));


      if (eprn->cap->custom == ((void*)0)) {

        if (eprn->media_overrides != ((void*)0))
          (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s  The media configuration file does not contain an entry for " " this size.\n", epref));


        else
          (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s  This size is not supported by the %s.\n", epref, eprn->cap->name));

      }
      else
        (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s  This size is not supported as a discrete size and it exceeds " "the\n" "%s  custom page size limits for the %s.\n", epref, epref, eprn->cap->name));
    ...
    if (eprn->media_overrides != ((void*)0) && best_cdmatch == ((void*)0)) {
      (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s" "? eprn: " "This document requests a page size of %.0f x %.0f bp\n" "%s  but there is no entry for this size in the " "media configuration file\n" "%s  %s.\n", epref, dev->MediaSize[0], dev->MediaSize[1], epref, epref, eprn->media_file));
...

  {
    ...
    if (best_cmatch != ((void*)0) &&
        (eprn->media_overrides == ((void*)0) || best_cdmatch != ((void*)0)))
      custom_code = (eprn->media_overrides == ((void*)0)?
...
# 714 "./contrib/pcl3/eprn/gdeveprn.c"
  if (fabs(w - h) > 1 &&
    ...
    if (reallocate) {
      ...
      if (rc < 0) {
        (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s" "? eprn: " "Failure of gdev_prn_open(), code is %d.\n", epref, rc));
...
# 794 "./contrib/pcl3/eprn/gdeveprn.c"
  if (eprn->keep_margins) {
    ...
    if (quarters != 0) {
      ...
      for (j = 0; j < 4; j++) margins[j] /= 72.0;

      gx_device_set_margins((gx_device *)dev, margins, ((bool)0));
...
# 844 "./contrib/pcl3/eprn/gdeveprn.c"
void eprn_init_device(eprn_Device *dev, const eprn_PrinterDescription *desc)
{
  ...
  ((desc != ((void*)0)) ? (void) (0) : __assert_fail ("desc != ((void*)0)", "./contrib/pcl3/eprn/gdeveprn.c", 852, __PRETTY_FUNCTION__));
  eprn->cap = desc;
  eprn_set_media_data(dev, ((void*)0), 0);
  ...
  eprn->right_shift = 0;
  eprn->down_shift = 0;
  eprn->keep_margins = ((bool)0);
  eprn->soft_tumble = ((bool)0);
  ...
  if (eprn->pagecount_file != ((void*)0)) {
    ((dev->memory->non_gc_memory->non_gc_memory)->procs.free_object(dev->memory->non_gc_memory->non_gc_memory, eprn->pagecount_file, "eprn_init_device"));
...
# 928 "./contrib/pcl3/eprn/gdeveprn.c"
int eprn_open_device(gx_device *device)
{
  ...
  if (eprn_check_colour_info(eprn->cap->colour_info, &eprn->colour_model,
    ...
    (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s" "? eprn: " "The requested combination of colour model (", epref));

    str.size = 0;
    if (eprn_get_string(eprn->colour_model, eprn_colour_model_list, &str) != 0)
      ((0) ? (void) (0) : __assert_fail ("0", "./contrib/pcl3/eprn/gdeveprn.c", 952, __PRETTY_FUNCTION__));
    errwrite(device->memory, (const char *)str.data, str.size * sizeof(str.data[0]));
    (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("),\n" "%s  resolution (%gx%g ppi) and intensity levels (%d, %d) is\n" "%s  not supported by the %s.\n", epref, device->HWResolution[0], device->HWResolution[1], eprn->black_levels, eprn->non_black_levels, epref, eprn->cap->name));
  ...
  if (device->color_info.num_components == 4) {
    ...
    ((device)->procs.map_rgb_color = (((void*)0)));

    if (eprn->intensity_rendering == eprn_IR_FloydSteinberg)
      ((device)->procs.map_cmyk_color = (&eprn_map_cmyk_color_max));
    else if (device->color_info.max_gray > 1 || device->color_info.max_color > 1)
      ((device)->procs.map_cmyk_color = (&eprn_map_cmyk_color_flex));
    else
      ((device)->procs.map_cmyk_color = (&eprn_map_cmyk_color));

    if (eprn->intensity_rendering == eprn_IR_FloydSteinberg)
      ((device)->procs.map_rgb_color = (&eprn_map_rgb_color_for_CMY_or_K_max));
    else if (device->color_info.max_gray > 1 || device->color_info.max_color > 1)
      ((device)->procs.map_rgb_color = (&eprn_map_rgb_color_for_CMY_or_K_flex));
    else
      ((device)->procs.map_rgb_color = (&eprn_map_rgb_color_for_CMY_or_K));

  }
  else {
    ((device)->procs.map_cmyk_color = (((void*)0)));

    if (eprn->colour_model == eprn_DeviceRGB) {
      if (eprn->intensity_rendering == eprn_IR_FloydSteinberg)
        ((device)->procs.map_rgb_color = (&eprn_map_rgb_color_for_RGB_max));
      else if (device->color_info.max_color > 1)
        ((device)->procs.map_rgb_color = (&eprn_map_rgb_color_for_RGB_flex));
      else
        ((device)->procs.map_rgb_color = (&eprn_map_rgb_color_for_RGB));
    } else {
      if (eprn->intensity_rendering == eprn_IR_FloydSteinberg)
        ((device)->procs.map_rgb_color = (&eprn_map_rgb_color_for_CMY_or_K_max));
      else if (device->color_info.max_gray > 1 || device->color_info.max_color > 1)
  ...
  if (eprn->pagecount_file != ((void*)0)) {
    ...
    if (pcf_getcount(eprn->pagecount_file, &count) == 0)
      ...
      (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("  No further attempts will be made to access the page count file.\n"));

      ((device->memory->non_gc_memory->non_gc_memory)->procs.free_object(device->memory->non_gc_memory->non_gc_memory, eprn->pagecount_file, "eprn_open_device"));
  ...
  if (eprn->scan_line.str != ((void*)0))
    ((device->memory->non_gc_memory->non_gc_memory)->procs.free_object(device->memory->non_gc_memory->non_gc_memory, eprn->scan_line.str, "eprn_open_device"));

  if (eprn->next_scan_line.str != ((void*)0)) {
    ((device->memory->non_gc_memory->non_gc_memory)->procs.free_object(device->memory->non_gc_memory->non_gc_memory, eprn->next_scan_line.str, "eprn_open_device"));

    eprn->next_scan_line.str = ((void*)0);
  }


  eprn->octets_per_line = gx_device_raster((gx_device *)((gx_device_printer *)device), 0);
  eprn->scan_line.str = (eprn_Octet *) (void *)(*(device->memory->non_gc_memory->non_gc_memory)->procs.alloc_byte_array)(device->memory->non_gc_memory->non_gc_memory, eprn->octets_per_line, sizeof(eprn_Octet), "eprn_open_device");

  if (eprn->intensity_rendering == eprn_IR_FloydSteinberg) {
    eprn->next_scan_line.str = (eprn_Octet *) (void *)(*(device->memory->non_gc_memory->non_gc_memory)->procs.alloc_byte_array)(device->memory->non_gc_memory->non_gc_memory, eprn->octets_per_line, sizeof(eprn_Octet), "eprn_open_device");

    if (eprn->next_scan_line.str == ((void*)0) && eprn->scan_line.str != ((void*)0)) {
      ((device->memory->non_gc_memory->non_gc_memory)->procs.free_object(device->memory->non_gc_memory->non_gc_memory, eprn->scan_line.str, "eprn_open_device"));

      eprn->scan_line.str = ((void*)0);
    }
  }
  if (eprn->scan_line.str == ((void*)0)) {
    (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("%s" "? eprn: " "Memory allocation failure from gs_malloc() in eprn_open_device().\n", epref));
...
int eprn_close_device(gx_device *device)
{
  ...
  if (eprn->scan_line.str != ((void*)0)) {
    ((device->memory->non_gc_memory->non_gc_memory)->procs.free_object(device->memory->non_gc_memory->non_gc_memory, eprn->scan_line.str, "eprn_close_device"));

    eprn->scan_line.str = ((void*)0);
  }
  if (eprn->next_scan_line.str != ((void*)0)) {
    ((device->memory->non_gc_memory->non_gc_memory)->procs.free_object(device->memory->non_gc_memory->non_gc_memory, eprn->next_scan_line.str, "eprn_close_device"));
...
# 1110 "./contrib/pcl3/eprn/gdeveprn.c"
static void eprn_forget_defaultmatrix(gs_memory_t *memory)
{
  ...
  gs_setdefaultmatrix(get_minst_from_memory(memory)->i_ctx_p->pgs, ((void*)0));


  return;
}
# 1131 "./contrib/pcl3/eprn/gdeveprn.c"
int eprn_output_page(gx_device *dev, int num_copies, int flush)
{
  ...
  if (rc == 0 && eprn->CUPS_accounting)
    (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("PAGE: %ld %d\n", dev->ShowpageCount, num_copies));





  if (rc == 0 && eprn->pagecount_file != ((void*)0)) {
    ((num_copies > 0) ? (void) (0) : __assert_fail ("num_copies > 0", "./contrib/pcl3/eprn/gdeveprn.c", 1166, __PRETTY_FUNCTION__));
    if (pcf_inccount(eprn->pagecount_file, num_copies) != 0) {

      (eprintf_program_ident(gs_program_name(), gs_revision_number()), errprintf_nomem("  No further attempts will be made to access the page count file.\n"));

      ((dev->memory->non_gc_memory->non_gc_memory)->procs.free_object(dev->memory->non_gc_memory->non_gc_memory, eprn->pagecount_file, "eprn_output_page"));
