# 1 "./lcms2/src/cmssamp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmssamp.c" 2
# 27 "./lcms2/src/cmssamp.c"
...
# 28 "./lcms2/src/cmssamp.c" 2
# 40 "./lcms2/src/cmssamp.c"
static
cmsHTRANSFORM CreateRoundtripXForm(cmsHPROFILE hProfile, cmsUInt32Number nIntent)
{
    cmsContext ContextID = cmsGetProfileContextID(hProfile);
    cmsHPROFILE hLab = cmsCreateLab4ProfileTHR(ContextID, ((void*)0));
    cmsHTRANSFORM xform;
    ...
    Intents[0] = 1; Intents[1] = nIntent; Intents[2] = 1; Intents[3] = 1;

    xform = cmsCreateExtendedTransform(ContextID, 4, hProfiles, BPC, Intents,
        States, ((void*)0), 0, (((1) << 22)|((10) << 16)|((3) << 3)|(0)), (((1) << 22)|((10) << 16)|((3) << 3)|(0)), 0x0040|0x0100);
                                    ...
                                    cmsUInt32Number dwFlags)
{
    ...
    if (!cmsIsIntentSupported(hInput, Intent, 0)) {
    ...
    dwFormat = cmsFormatterForColorspaceOfProfile(hInput, 2, 0);
    ...
    if (nChannels != (((dwFormat)>>3)&15)) {
       BlackPoint -> X = BlackPoint ->Y = BlackPoint -> Z = 0.0;
       return 0;
    }


    hLab = cmsCreateLab2ProfileTHR(ContextID, ((void*)0));
    if (hLab == ((void*)0)) {
       BlackPoint -> X = BlackPoint ->Y = BlackPoint -> Z = 0.0;
       return 0;
    }
    ...
    xform = cmsCreateTransformTHR(ContextID, hInput, dwFormat,
                                hLab, (((1) << 22)|((10) << 16)|((3) << 3)|(0)), Intent, 0x0100|0x0040);
    cmsCloseProfile(hLab);
    ...
    cmsLab2XYZ(((void*)0), &BlackXYZ, &Lab);
...
cmsBool BlackPointUsingPerceptualBlack(cmsCIEXYZ* BlackPoint, cmsHPROFILE hProfile)
{
    ...
    if (!cmsIsIntentSupported(hProfile, 0, 0)) {

        BlackPoint -> X = BlackPoint ->Y = BlackPoint -> Z = 0.0;
        return 1;
    }

    hRoundTrip = CreateRoundtripXForm(hProfile, 0);
    ...
    cmsLab2XYZ(((void*)0), &BlackXYZ, &LabOut);
    ...
    if ((cmsGetEncodedICCversion(hProfile) >= 0x4000000) &&
        (Intent == 0 || Intent == 2)) {
            ...
            if (cmsIsMatrixShaper(hProfile))
                return BlackPointAsDarkerColorant(hProfile, 1, BlackPoint, 0);


            BlackPoint -> X = 0.00336;
            BlackPoint -> Y = 0.0034731;
            BlackPoint -> Z = 0.00287;

            return 1;
    }
# 267 "./lcms2/src/cmssamp.c"
    if (Intent == 1 &&
...
cmsFloat64Number RootOfLeastSquaresFitQuadraticCurve(int n, cmsFloat64Number x[], cmsFloat64Number y[])
{
    ...
    if (fabs(a) < 1.0E-10) {
        ...
        return (((0) < ((((50) > (-c/b)) ? (50) : (-c/b)))) ? (0) : ((((50) > (-c/b)) ? (50) : (-c/b))));
    }
    else {
         ...
         if (d <= 0) {
             ...
             return (((0) > ((((50) < (rt)) ? (50) : (rt)))) ? (0) : ((((50) < (rt)) ? (50) : (rt))));
         }
   }

}
# 368 "./lcms2/src/cmssamp.c"
cmsBool cmsDetectDestinationBlackPoint(cmsCIEXYZ* BlackPoint, cmsHPROFILE hProfile, cmsUInt32Number Intent, cmsUInt32Number dwFlags)
{
    cmsColorSpaceSignature ColorSpace;
    cmsHTRANSFORM hRoundTrip = ((void*)0);
    cmsCIELab InitialLab, destLab, Lab;
    cmsFloat64Number inRamp[256], outRamp[256];
    cmsFloat64Number MinL, MaxL;
    cmsBool NearlyStraightMidrange = 1;
    ...
    if (!cmsIsCLUT(hProfile, Intent, 1 ) ||
    ...
    if (Intent == 1) {
        ...
        cmsXYZ2Lab(((void*)0), &InitialLab, &IniXYZ);
    ...
    for (l=0; l < 256; l++) {
        ...
        Lab.a = (((50) < ((((-50) > (InitialLab.a)) ? (-50) : (InitialLab.a)))) ? (50) : ((((-50) > (InitialLab.a)) ? (-50) : (InitialLab.a))));
        Lab.b = (((50) < ((((-50) > (InitialLab.b)) ? (-50) : (InitialLab.b)))) ? (50) : ((((-50) > (InitialLab.b)) ? (-50) : (InitialLab.b))));
    ...
    for (l = 254; l > 0; --l) {
        outRamp[l] = (((outRamp[l]) < (outRamp[l+1])) ? (outRamp[l]) : (outRamp[l+1]));
    }
    ...
    if (Intent == 1) {
        ...
        if (NearlyStraightMidrange) {
            ...
            cmsLab2XYZ(((void*)0), BlackPoint, &InitialLab);
            cmsDeleteTransform(hRoundTrip);
            return 1;
        }
    }
    ...
    cmsLab2XYZ(((void*)0), BlackPoint, &Lab);
