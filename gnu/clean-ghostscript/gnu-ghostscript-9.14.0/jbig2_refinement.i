# 1 "./jbig2dec/jbig2_refinement.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./jbig2dec/jbig2_refinement.c" 2
# 28 "./jbig2dec/jbig2_refinement.c"
...
# 29 "./jbig2dec/jbig2_refinement.c" 2
...
# 31 "./jbig2dec/jbig2_refinement.c" 2
...
# 32 "./jbig2dec/jbig2_refinement.c" 2
...
# 34 "./jbig2dec/jbig2_refinement.c" 2
...
# 36 "./jbig2dec/jbig2_refinement.c" 2
...
# 37 "./jbig2dec/jbig2_refinement.c" 2
...
# 38 "./jbig2dec/jbig2_refinement.c" 2
...
jbig2_decode_refinement_region(Jbig2Ctx *ctx,
                            ...
                            Jbig2Image *image,
                            Jbig2ArithCx *GB_stats);
# 39 "./jbig2dec/jbig2_refinement.c" 2
...
# 40 "./jbig2dec/jbig2_refinement.c" 2
...
# 106 "./jbig2dec/jbig2_refinement.c"
  return 0;
}
...
# 159 "./jbig2dec/jbig2_refinement.c"
  return 0;
}
...
# 373 "./jbig2dec/jbig2_refinement.c"
int
jbig2_decode_refinement_region(Jbig2Ctx *ctx,
       Jbig2Segment *segment,
       const Jbig2RefinementRegionParams *params,
