...
static void gs_font_dir_finalize(const gs_memory_t *cmem, void *ptr); static gs_ptr_type_t font_dir_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void font_dir_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static const gs_memory_struct_type_t st_font_dir = { sizeof(gs_font_dir), "gs_font_dir", 0, 0, font_dir_enum_ptrs, font_dir_reloc_ptrs, gs_font_dir_finalize, 0 };
static gs_ptr_type_t font_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst);
static void font_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst);

static const gc_ptr_element_t gs_font_info_ptrs[] = { { GC_ELT_CONST_STRING, ((int) ( (char *)&((gs_font_info_t *)0)->Copyright - (char *)((gs_font_info_t *)0) )) }, { GC_ELT_CONST_STRING, ((int) ( (char *)&((gs_font_info_t *)0)->Notice - (char *)((gs_font_info_t *)0) )) }, { GC_ELT_CONST_STRING, ((int) ( (char *)&((gs_font_info_t *)0)->FamilyName - (char *)((gs_font_info_t *)0) )) }, { GC_ELT_CONST_STRING, ((int) ( (char *)&((gs_font_info_t *)0)->FullName - (char *)((gs_font_info_t *)0) )) } }; static const gc_struct_data_t gs_font_info_data = { (sizeof(gs_font_info_ptrs) / sizeof((gs_font_info_ptrs)[0])), 0, 0, gs_font_info_ptrs }; const gs_memory_struct_type_t st_gs_font_info = { sizeof(gs_font_info_t), "gs_font_info_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &gs_font_info_data };
const gs_memory_struct_type_t st_gs_font = { sizeof(gs_font), "gs_font", 0, 0, font_enum_ptrs, font_reloc_ptrs, gs_font_finalize, 0 };
static const gc_ptr_element_t font_base_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_font_base *)0)->UID.xvalues - (char *)((gs_font_base *)0) )) } }; static const gc_struct_data_t font_base_reloc_ptrs = { (sizeof(font_base_enum_ptrs) / sizeof((font_base_enum_ptrs)[0])), 0, &st_gs_font, font_base_enum_ptrs }; const gs_memory_struct_type_t st_gs_font_base = { sizeof(gs_font_base), "gs_font_base", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, gs_font_finalize, &font_base_reloc_ptrs };
static gs_ptr_type_t font_ptr_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { switch ( index ) { default: return 0; case 0: return (pep->ptr = (const void *)(*(gs_font * const *)vptr), (&ptr_struct_procs)); } } static void font_ptr_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { ; (*(gs_font * *)vptr = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(*(gs_font * *)vptr), gcst))); } static const gs_memory_struct_type_t st_gs_font_ptr = { sizeof(gs_font *), "gs_font *", 0, 0, font_ptr_enum_ptrs, font_ptr_reloc_ptrs, 0, 0 };
static gs_ptr_type_t font_ptr_element_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { uint count = size / (uint)sizeof(gs_font *); if ( count == 0 ) return 0; return (*(st_gs_font_ptr).enum_ptrs)(mem, (const char *)vptr + (index % count) * sizeof(gs_font *), sizeof(gs_font *), index / count, pep, &(st_gs_font_ptr), gcst); } static void font_ptr_element_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { { uint count = size / (uint)sizeof(gs_font *); for ( ; count; count--, vptr = (char *)vptr + sizeof(gs_font *) ) (*(st_gs_font_ptr).reloc_ptrs)(vptr, sizeof(gs_font *), &(st_gs_font_ptr), gcst); } } const gs_memory_struct_type_t st_gs_font_ptr_element = { sizeof(gs_font *), "gs_font *[]", 0, 0, font_ptr_element_enum_ptrs, font_ptr_element_reloc_ptrs, 0, 0 };
# 90 "./base/gsfont.c"
static
gs_ptr_type_t font_dir_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_font_dir *dir = vptr; switch ( index ) { default:
{
    ...
    for (; offset <= tmask; ++offset) {
        ...
        if (cc != 0 && !--count) {
            ...
            return (pep->ptr = (const void *)(((cc)->pair) - cc->pair_index), (&ptr_struct_procs));
        }
    }
}
return 0;

case 0: return (pep->ptr = (const void *)(((const gs_font_dir *)vptr)->scaled_fonts), (&ptr_struct_procs)); case 1: return (pep->ptr = (const void *)(((const gs_font_dir *)vptr)->fmcache.mdata), (&ptr_struct_procs)); case 2: return (pep->ptr = (const void *)(((const gs_font_dir *)vptr)->ccache.table), (&ptr_struct_procs)); case 3: return (pep->ptr = (const void *)(((const gs_font_dir *)vptr)->ccache.mark_glyph_data), (&ptr_struct_procs)); case 4: return (pep->ptr = (const void *)(((const gs_font_dir *)vptr)->glyph_to_unicode_table), (&ptr_struct_procs)); case 5: return (pep->ptr = (const void *)(((const gs_font_dir *)vptr)->tti), (&ptr_struct_procs)); case 6: return (pep->ptr = (const void *)(((const gs_font_dir *)vptr)->ttm), (&ptr_struct_procs)); case 7: return (pep->ptr = (const void *)(((const gs_font_dir *)vptr)->san), (&ptr_struct_procs));

} }
static void font_dir_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_font_dir *dir = vptr;;
...

{
    ...
    for (chi = dir->ccache.table_mask; chi >= 0; --chi) {
        ...
        if (cc != 0)
            ((cc)->pair = ((cached_fm_pair *) (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((cc)->pair) - cc->pair_index), gcst)) + cc->pair_index));
...
(((gs_font_dir *)vptr)->orig_fonts = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_dir *)vptr)->orig_fonts), gcst)));

(((gs_font_dir *)vptr)->scaled_fonts = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_dir *)vptr)->scaled_fonts), gcst))); (((gs_font_dir *)vptr)->fmcache.mdata = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_dir *)vptr)->fmcache.mdata), gcst))); (((gs_font_dir *)vptr)->ccache.table = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_dir *)vptr)->ccache.table), gcst))); (((gs_font_dir *)vptr)->ccache.mark_glyph_data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_dir *)vptr)->ccache.mark_glyph_data), gcst))); (((gs_font_dir *)vptr)->glyph_to_unicode_table = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_dir *)vptr)->glyph_to_unicode_table), gcst))); (((gs_font_dir *)vptr)->tti = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_dir *)vptr)->tti), gcst))); (((gs_font_dir *)vptr)->ttm = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_dir *)vptr)->ttm), gcst))); (((gs_font_dir *)vptr)->san = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_dir *)vptr)->san), gcst)));
...
gs_font_finalize(const gs_memory_t *cmem, void *vptr)
{
    ...
    gs_notify_all(&pfont->notify_list, ((void*)0));
...
static
gs_ptr_type_t font_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_font *pfont = vptr; switch ( index ) { default: return (*(st_gs_notify_list).enum_ptrs)(mem, &pfont->notify_list, sizeof(gs_notify_list_t), index - 5, pep, &(st_gs_notify_list), gcst);


case 0: return (pep->ptr = (const void *)((pfont->base == pfont ? 0 : pfont->next)), (&ptr_struct_procs));
case 1: return (pep->ptr = (const void *)((pfont->base == pfont ? 0 : pfont->prev)), (&ptr_struct_procs));
case 2: return (pep->ptr = (const void *)(((const gs_font *)vptr)->dir), (&ptr_struct_procs)); case (2)+1: return (pep->ptr = (const void *)(((const gs_font *)vptr)->base), (&ptr_struct_procs)); case (2)+2: return (pep->ptr = (const void *)(((const gs_font *)vptr)->client_data), (&ptr_struct_procs));
} }
static void font_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_font *pfont = vptr;;
(*(st_gs_notify_list).reloc_ptrs)(&pfont->notify_list, sizeof(gs_notify_list_t), &(st_gs_notify_list), gcst);


(((gs_font *)vptr)->next = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font *)vptr)->next), gcst)));
(((gs_font *)vptr)->prev = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font *)vptr)->prev), gcst)));
(((gs_font *)vptr)->dir = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font *)vptr)->dir), gcst))); (((gs_font *)vptr)->base = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font *)vptr)->base), gcst))); (((gs_font *)vptr)->client_data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font *)vptr)->client_data), gcst)));
}
...
{
    gs_font_dir *pdir =
        (gs_font_dir *)(*(struct_mem)->procs.alloc_struct)(struct_mem, &st_font_dir, "font_dir_alloc(dir)");
    ...
    if (code < 0) {
        ((struct_mem)->procs.free_object(struct_mem, pdir, "font_dir_alloc(dir)"));
        return 0;
    }
    pdir->orig_fonts = 0;
    pdir->scaled_fonts = 0;
    pdir->ssize = 0;
    pdir->smax = smax;
    pdir->align_to_pixels = ((bool)0);
    pdir->glyph_to_unicode_table = ((void*)0);
    pdir->grid_fit_tt = 1;
    pdir->memory = struct_mem;
    pdir->tti = 0;
    pdir->ttm = 0;
    pdir->san = 0;
    pdir->global_glyph_code = ((void*)0);
    pdir->text_enum_id = 0;
    pdir->hash = 42;
    return pdir;
}
...
gs_font_dir_finalize(const gs_memory_t *cmem, void *vptr)
{
    ...
    if (pdir == cmem->gs_lib_ctx->font_dir) {
        cmem->gs_lib_ctx->font_dir = ((void*)0);
    }
}
...
gs_font_alloc(gs_memory_t *mem, gs_memory_type_ptr_t pstype,
              ...
              client_name_t cname)
{
    gs_font *pfont = (gs_font *)(*(mem)->procs.alloc_struct)(mem, pstype, cname);
                   ...
                   client_name_t cname)
{
    ...
    ((&pfont->UID)->id = (~(-1L << ((1 << 3) * 8 - 1))), (&pfont->UID)->xvalues = 0);
...
{
# 371 "./base/gsfont.c"
    gs_notify_init(&font->notify_list, ((font->memory)->procs.stable(font->memory)));
}
                       ...
                       int (*similar)(const gs_font *, const gs_font *))
{
    ...
    for (; pfont1 != ((void*)0); pfont1 = pfont1->next) {
...
# 496 "./base/gsfont.c"
    if (pfont->FontType != ft_composite) {
        ...
        can_cache = ((bool)0);
    pf_out = (gs_font *)(*(mem)->procs.alloc_struct)(mem, (*(mem)->procs.object_type)(mem, pfont), "gs_makefont");

    if (!pf_out)
        return ((-25));
    memcpy(pf_out, pfont, (*(mem)->procs.object_size)(mem, pfont));
...
gs_setcachesize(gs_state * pgs, gs_font_dir * pdir, uint size)
{
...

    {
        ...
        for (pfont = pdir->scaled_fonts; pfont != 0; pfont = pfont->next) {
            ...
            if (code != 0)
                gs_throw_imp(__func__, "./base/gsfont.c", 662, 1, (code), "%s", gs_errstr((code)));
    ...
    ((stable_mem)->procs.free_object(stable_mem, pdir->fmcache.mdata, "gs_setcachesize(mdata)"));
    ((stable_mem)->procs.free_object(stable_mem, pdir->ccache.table, "gs_setcachesize(table)"));
...
{
    pdir->ccache.lower = ((int)size < 0) ? 0 : size;
    return 0;
}
int
gs_setcacheupper(gs_font_dir * pdir, uint size)
{
    pdir->ccache.upper = ((int)size < 0) ? 0 : size;
    return 0;
}
int
...
gs_purge_font(gs_font * pfont)
{
    ...
    if (prev != 0)
        ...
        (eprintf_program_ident(gs_program_name(), gs_revision_number()), lprintf_file_and_line("./base/gsfont.c", 750), errprintf_nomem("purged font 0x%lx not found\n", (ulong) pfont));
    }
...
gs_find_font_by_id(gs_font_dir *pdir, gs_id id, gs_matrix *FontMatrix)
 {
    ...
    for(; pfont != ((void*)0); pfont = pfont->next)
        if(pfont->id == id &&
                     ...
                     gs_font_info_t *info)
{
    ...
    if (members & 0x0004) {
        ...
        info->Flags_returned |= 0x0004;
    }
    if ((members & 0x0020) &&
        (info->Flags_requested & (1<<0))
        ) {



        gs_glyph notdef = ((gs_glyph)0x7fffffff);
        gs_glyph glyph;
        int fixed_width = 0;
        int index;
        int code = 0;
        int ecode = 0;
        bool has_glyphs = ((bool)0);
        ...
        for (index = 0;
            ...
            if (notdef == ((gs_glyph)0x7fffffff) && gs_font_glyph_is_notdef(bfont, glyph)) {
                notdef = glyph;
                info->MissingWidth = (int)glyph_info.width[wmode].x;
                info->members |= 0x0800;
            }
            if (glyph_info.width[wmode].y != 0)
                fixed_width = (-1 << ((1 << 2) * 8 - 1));
        ...
        if (fixed_width > 0) {
            info->Flags |= (1<<0);
            info->members |= 0x0002 | 0x0400 |
                0x0800;
            info->AvgWidth = info->MaxWidth = info->MissingWidth = fixed_width;
        }
        info->Flags_returned |= (1<<0);
    } else if (members & 0x0800) {
        gs_glyph glyph;
        int index;
...
gs_font_glyph_is_notdef(gs_font_base *bfont, gs_glyph glyph)
{
    ...
    if (glyph >= ((gs_glyph)0x80000000L))
        return (glyph == ((gs_glyph)0x80000000L));
                      ...
                      int members, gs_glyph_info_t *info)
{
    ...
    code = gx_path_add_point(&path, 0L, 0L);
    if (code < 0)
        goto out;
    ...
    if (members & (1 | 2)) {
        ...
        if (members & wmask) {
            ...
            if (code < 0)
                goto out;
            info->width[wmode].x = ((pt.x)*(1.0/(1<<8)));
            info->width[wmode].y = ((pt.y)*(1.0/(1<<8)));
            returned |= wmask;
        }
    }
    if (members & 4) {
        ...
        if (code < 0)
            goto out;
        info->bbox.p.x = ((bbox.p.x)*(1.0/(1<<8)));
        info->bbox.p.y = ((bbox.p.y)*(1.0/(1<<8)));
        info->bbox.q.x = ((bbox.q.x)*(1.0/(1<<8)));
        info->bbox.q.y = ((bbox.q.y)*(1.0/(1<<8)));
        returned |= 4;
    }
    if (members & (1 << wmode) && charstrings_font) {
        if (pmat == 0) {
    ...
    if (members & (64 << wmode) && charstrings_font) {
        if (pmat == 0) {
            info->v.x = sbw[0];
            info->v.y = sbw[1];
        } else {
