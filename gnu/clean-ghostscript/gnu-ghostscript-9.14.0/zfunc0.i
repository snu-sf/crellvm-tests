...
int gs_build_function_0(i_ctx_t *i_ctx_p, const ref *op, const gs_function_params_t *params, int depth, gs_function_t **ppfn, gs_memory_t *mem);
                    ...
                    int depth, gs_function_t ** ppfn, gs_memory_t *mem)
{
    ...
    *(gs_function_params_t *) & params = *mnDR;
    ...
    params.pole = ((void*)0);
    params.Size = params.array_step = params.stream_step = ((void*)0);
    if ((code = dict_find_string(op, "DataSource", &pDataSource)) <= 0)
        return (code < 0 ? code : ((-15)));
    switch ((((const byte *)&((pDataSource)->tas.type_attrs))[1])) {
        case t_string:
            ((&params.DataSource)->type = data_source_type_string, (&params.DataSource)->data.str.data = pDataSource->value.const_bytes, (&params.DataSource)->data.str.size = ((pDataSource)->tas.rsize), (&params.DataSource)->access = data_source_access_string);
        ...
        case t_file: {
            ...
            do { s = (pDataSource)->value.pfile; if (s->read_id != ((pDataSource)->tas.rsize)) { if (s->read_id == 0 && s->write_id == ((pDataSource)->tas.rsize)) { int fcode = file_switch_to_read(pDataSource); if (fcode < 0) return (fcode); } else { return ((-9)); } } } while (0);
    ...
    if ((code = dict_int_param(op, "Order", 1, 3, 1, &params.Order)) < 0 ||
        ...
        ((code = fn_build_float_array(op, "Encode", ((bool)0), ((bool)1), &params.Encode, mem)) != 2 * params.m && (code != 0 || params.Encode != 0)) ||
        ((code = fn_build_float_array(op, "Decode", ((bool)0), ((bool)1), &params.Decode, mem)) != 2 * params.n && (code != 0 || params.Decode != 0))
        ) {
        goto fail;
    } {
        int *ptr = (int *)
