...
gs_setcmykcolor(gs_state * pgs, double c, double m, double y, double k)
{
    ...
    if ((code = gs_setcolorspace(pgs, pcs)) >= 0) {
       gs_client_color *pcc = ((pgs)->color[0].ccolor);

        (*((pgs)->color[0].color_space)->type->adjust_color_count) (((pgs)->color[0].ccolor), ((pgs)->color[0].color_space), -1);
        pcc->paint.values[0] = (c < 0.0 ? 0.0 : c > 1.0 ? 1.0 : c);
        pcc->paint.values[1] = (m < 0.0 ? 0.0 : m > 1.0 ? 1.0 : m);
        pcc->paint.values[2] = (y < 0.0 ? 0.0 : y > 1.0 ? 1.0 : y);
        pcc->paint.values[3] = (k < 0.0 ? 0.0 : k > 1.0 ? 1.0 : k);
        pcc->pattern = 0;
...
{
    return gs_setblackgeneration_remap(pgs, proc, ((bool)1));
}
int
gs_setblackgeneration_remap(gs_state * pgs, gs_mapping_proc proc, bool remap)
{
    do { if ( (pgs->black_generation) == 0 || (pgs->black_generation)->rc.ref_count > 1 || (pgs->black_generation)->rc.memory != (pgs->memory) ) { gx_transfer_map *new; do { if ( ((new) = (gx_transfer_map *)(*(pgs->memory)->procs.alloc_struct)(pgs->memory, &st_transfer_map, "gs_setblackgeneration")) == 0 ) { return ((-25)); } else { do { (new)->rc.ref_count = 1; (new)->rc.memory = pgs->memory; (new)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0); if ( pgs->black_generation ) do { do { } while (0); (pgs->black_generation)->rc.ref_count += (-1); } while (0); (pgs->black_generation) = new; } } while (0);
...
{
    return gs_setundercolorremoval_remap(pgs, proc, ((bool)1));
}
int
gs_setundercolorremoval_remap(gs_state * pgs, gs_mapping_proc proc, bool remap)
{
    do { if ( (pgs->undercolor_removal) == 0 || (pgs->undercolor_removal)->rc.ref_count > 1 || (pgs->undercolor_removal)->rc.memory != (pgs->memory) ) { gx_transfer_map *new; do { if ( ((new) = (gx_transfer_map *)(*(pgs->memory)->procs.alloc_struct)(pgs->memory, &st_transfer_map, "gs_setundercolorremoval")) == 0 ) { return ((-25)); } else { do { (new)->rc.ref_count = 1; (new)->rc.memory = pgs->memory; (new)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0); if ( pgs->undercolor_removal ) do { do { } while (0); (pgs->undercolor_removal)->rc.ref_count += (-1); } while (0); (pgs->undercolor_removal) = new; } } while (0);
                          ...
                          gs_mapping_proc gray_proc, bool remap)
{
    ...
    old = *ptran;
    do { if ( (ptran->gray) == 0 || (ptran->gray)->rc.ref_count > 1 || (ptran->gray)->rc.memory != (pgs->memory) ) { gx_transfer_map *new; do { if ( ((new) = (gx_transfer_map *)(*(pgs->memory)->procs.alloc_struct)(pgs->memory, &st_transfer_map, "gs_setcolortransfer")) == 0 ) { goto fgray; } else { do { (new)->rc.ref_count = 1; (new)->rc.memory = pgs->memory; (new)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0); if ( ptran->gray ) do { do { } while (0); (ptran->gray)->rc.ref_count += (-1); } while (0); (ptran->gray) = new; } } while (0);

    do { if ( (ptran->red) == 0 || (ptran->red)->rc.ref_count > 1 || (ptran->red)->rc.memory != (pgs->memory) ) { gx_transfer_map *new; do { if ( ((new) = (gx_transfer_map *)(*(pgs->memory)->procs.alloc_struct)(pgs->memory, &st_transfer_map, "gs_setcolortransfer")) == 0 ) { goto fred; } else { do { (new)->rc.ref_count = 1; (new)->rc.memory = pgs->memory; (new)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0); if ( ptran->red ) do { do { } while (0); (ptran->red)->rc.ref_count += (-1); } while (0); (ptran->red) = new; } } while (0);

    do { if ( (ptran->green) == 0 || (ptran->green)->rc.ref_count > 1 || (ptran->green)->rc.memory != (pgs->memory) ) { gx_transfer_map *new; do { if ( ((new) = (gx_transfer_map *)(*(pgs->memory)->procs.alloc_struct)(pgs->memory, &st_transfer_map, "gs_setcolortransfer")) == 0 ) { goto fgreen; } else { do { (new)->rc.ref_count = 1; (new)->rc.memory = pgs->memory; (new)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0); if ( ptran->green ) do { do { } while (0); (ptran->green)->rc.ref_count += (-1); } while (0); (ptran->green) = new; } } while (0);

    do { if ( (ptran->blue) == 0 || (ptran->blue)->rc.ref_count > 1 || (ptran->blue)->rc.memory != (pgs->memory) ) { gx_transfer_map *new; do { if ( ((new) = (gx_transfer_map *)(*(pgs->memory)->procs.alloc_struct)(pgs->memory, &st_transfer_map, "gs_setcolortransfer")) == 0 ) { goto fblue; } else { do { (new)->rc.ref_count = 1; (new)->rc.memory = pgs->memory; (new)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0); if ( ptran->blue ) do { do { } while (0); (ptran->blue)->rc.ref_count += (-1); } while (0); (ptran->blue) = new; } } while (0);
    ...
    return 0;
  fblue:
    do { if ((ptran->green) != (old.green)) { do { if (old.green) do { (old.green)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (ptran->green) { do { do { } while (0); (ptran->green)->rc.ref_count += (-1); } while (0); if (!(ptran->green)->rc.ref_count) { do { do { } while (0); (ptran->green)->rc.free((ptran->green)->rc.memory, (void *)(ptran->green), "setcolortransfer"); } while (0); do { } while (0); } else do { } while (0); } } while (0); (ptran->green) = (old.green); } } while (0);
  fgreen:
    do { if ((ptran->red) != (old.red)) { do { if (old.red) do { (old.red)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (ptran->red) { do { do { } while (0); (ptran->red)->rc.ref_count += (-1); } while (0); if (!(ptran->red)->rc.ref_count) { do { do { } while (0); (ptran->red)->rc.free((ptran->red)->rc.memory, (void *)(ptran->red), "setcolortransfer"); } while (0); do { } while (0); } else do { } while (0); } } while (0); (ptran->red) = (old.red); } } while (0);
  fred:
    do { if ((ptran->gray) != (old.gray)) { do { if (old.gray) do { (old.gray)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (ptran->gray) { do { do { } while (0); (ptran->gray)->rc.ref_count += (-1); } while (0); if (!(ptran->gray)->rc.ref_count) { do { do { } while (0); (ptran->gray)->rc.free((ptran->gray)->rc.memory, (void *)(ptran->gray), "setcolortransfer"); } while (0); do { } while (0); } else do { } while (0); } } while (0); (ptran->gray) = (old.gray); } } while (0);
  fgray:
    return ((-25));
}
int
