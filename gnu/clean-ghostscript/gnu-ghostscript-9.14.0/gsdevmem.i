                    ...
                    bool word_oriented, bool page_device, gs_memory_t * mem)
{
    ...
    if (bits_per_pixel <= 8) {
        ...
        for (i = 0, p = colors, q = palette;
            ...
            switch ( q[0] ) { case 0xff: mask <<= 4; case 0: break; default: mask = 0; };
            switch ( q[1] ) { case 0xff: mask <<= 2; case 0: break; default: mask = 0; };
            switch ( q[2] ) { case 0xff: mask <<= 1; case 0: break; default: mask = 0; };
...
# 149 "./base/gsdevmem.c"
    ...
    if (bits_per_pixel == 1) {
        ...
        byte *dev_palette = (*(mem)->procs.alloc_string)(mem, pcount, "gs_makeimagedevice(palette)");
    ...
    new_dev->retained = ((bool)1);
    do { (new_dev)->rc.ref_count = 1; (new_dev)->rc.memory = new_dev->memory; (new_dev)->rc.free = rc_free_struct_only; do { } while (0); } while (0);
                    ...
                    bool word_oriented, bool page_device, gs_memory_t * mem)
{
    ...
    (gx_device_memory *)(*(mem)->procs.alloc_struct)(mem, &st_device_memory, "gs_makeimagedevice(device)");
