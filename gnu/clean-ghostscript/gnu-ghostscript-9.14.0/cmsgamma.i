# 1 "./lcms2/src/cmsgamma.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmsgamma.c" 2
# 26 "./lcms2/src/cmsgamma.c"
...
# 27 "./lcms2/src/cmsgamma.c" 2
# 45 "./lcms2/src/cmsgamma.c"
typedef struct _cmsParametricCurvesCollection_st {

    int nFunctions;
    int FunctionTypes[20];
    int ParameterCount[20];
    cmsParametricCurveEvaluator Evaluator;

    struct _cmsParametricCurvesCollection_st* Next;
                                               ...
                                               const struct _cmsContext_struct* src)
{
   ...
   _cmsCurvesPluginChunkType* head = (_cmsCurvesPluginChunkType*) src->chunks[CurvesPlugin];
    ...
    (((head != ((void*)0))) ? (void) (0) : __assert_fail ("(head != ((void*)0))", "./lcms2/src/cmsgamma.c", 78, __PRETTY_FUNCTION__));
...
void _cmsAllocCurvesPluginChunk(struct _cmsContext_struct* ctx,
                                const struct _cmsContext_struct* src)
{
    (((ctx != ((void*)0))) ? (void) (0) : __assert_fail ("(ctx != ((void*)0))", "./lcms2/src/cmsgamma.c", 108, __PRETTY_FUNCTION__));
...
_cmsCurvesPluginChunkType _cmsCurvesPluginChunk = { ((void*)0) };
                                      ...
                                      const cmsUInt16Number* Values)
{
    ...
    if (nEntries > 65530 || nEntries < 0) {
        cmsSignalError(ContextID, 2, "Couldn't create tone curve of more than 65530 entries");
        return ((void*)0);
    }

    if (nEntries <= 0 && nSegments <= 0) {
        cmsSignalError(ContextID, 2, "Couldn't create tone curve with zero segments and no table");
        return ((void*)0);
    }
    ...
    if (nEntries <= 0) {
       ...
       if (p ->Table16 == ((void*)0)) goto Error;
    }

    p -> nEntries = nEntries;


    if (Values != ((void*)0) && (nEntries > 0)) {
    ...
    if (Segments != ((void*)0) && (nSegments > 0)) {

        _cmsParametricCurvesCollection *c;

        p ->SegInterp = (cmsInterpParams**) _cmsCalloc(ContextID, nSegments, sizeof(cmsInterpParams*));
        if (p ->SegInterp == ((void*)0)) goto Error;

        for (i=0; i< nSegments; i++) {


            if (Segments[i].Type == 0)
                p ->SegInterp[i] = _cmsComputeInterpParams(ContextID, Segments[i].nGridPoints, 1, 1, ((void*)0), 0x0001);

            memmove(&p ->Segments[i], &Segments[i], sizeof(cmsCurveSegment));

            if (Segments[i].Type == 0 && Segments[i].SampledPoints != ((void*)0))
                ...
                p ->Segments[i].SampledPoints = ((void*)0);


            c = GetParametricCurveByType(ContextID, Segments[i].Type, ((void*)0));
            if (c != ((void*)0))
                    p ->Evals[i] = c ->Evaluator;
        }
    }

    p ->InterpParams = _cmsComputeInterpParams(ContextID, p ->nEntries, 1, 1, p->Table16, 0x0000);
    if (p->InterpParams != ((void*)0))
        return p;
...
cmsUInt32Number cmsGetToneCurveEstimatedTableEntries(const cmsToneCurve* t)
{
    (((t != ((void*)0))) ? (void) (0) : __assert_fail ("(t != ((void*)0))", "./lcms2/src/cmsgamma.c", 606, __PRETTY_FUNCTION__));
    return t ->nEntries;
}

const cmsUInt16Number* cmsGetToneCurveEstimatedTable(const cmsToneCurve* t)
{
    (((t != ((void*)0))) ? (void) (0) : __assert_fail ("(t != ((void*)0))", "./lcms2/src/cmsgamma.c", 612, __PRETTY_FUNCTION__));
    return t ->Table16;
}
...
cmsToneCurve* cmsBuildTabulatedToneCurve16(cmsContext ContextID, cmsInt32Number nEntries, const cmsUInt16Number Values[])
{
    return AllocateToneCurveStruct(ContextID, nEntries, 0, ((void*)0), Values);
}
                                                   ...
                                                   cmsInt32Number nSegments, const cmsCurveSegment Segments[])
{
    ...
    (((Segments != ((void*)0))) ? (void) (0) : __assert_fail ("(Segments != ((void*)0))", "./lcms2/src/cmsgamma.c", 641, __PRETTY_FUNCTION__));
    ...
    g = AllocateToneCurveStruct(ContextID, nGridPoints, nSegments, Segments, ((void*)0));
...
cmsToneCurve* cmsBuildParametricToneCurve(cmsContext ContextID, cmsInt32Number Type, const cmsFloat64Number Params[])
{
    ...
    (((Params != ((void*)0))) ? (void) (0) : __assert_fail ("(Params != ((void*)0))", "./lcms2/src/cmsgamma.c", 719, __PRETTY_FUNCTION__));

    if (c == ((void*)0)) {
        cmsSignalError(ContextID, 8, "Invalid parametric curve type %d", Type);
        return ((void*)0);
    }
...
void cmsFreeToneCurveTriple(cmsToneCurve* Curve[3])
{
    ...
    (((Curve != ((void*)0))) ? (void) (0) : __assert_fail ("(Curve != ((void*)0))", "./lcms2/src/cmsgamma.c", 789, __PRETTY_FUNCTION__));

    if (Curve[0] != ((void*)0)) cmsFreeToneCurve(Curve[0]);
    if (Curve[1] != ((void*)0)) cmsFreeToneCurve(Curve[1]);
    if (Curve[2] != ((void*)0)) cmsFreeToneCurve(Curve[2]);

    Curve[0] = Curve[1] = Curve[2] = ((void*)0);
}



cmsToneCurve* cmsDupToneCurve(const cmsToneCurve* In)
{
...
{
    cmsToneCurve* out = ((void*)0);
    cmsToneCurve* Yreversed = ((void*)0);
    cmsFloat32Number t, x;
    cmsFloat32Number* Res = ((void*)0);
    cmsUInt32Number i;


    (((X != ((void*)0))) ? (void) (0) : __assert_fail ("(X != ((void*)0))", "./lcms2/src/cmsgamma.c", 823, __PRETTY_FUNCTION__));
    (((Y != ((void*)0))) ? (void) (0) : __assert_fail ("(Y != ((void*)0))", "./lcms2/src/cmsgamma.c", 824, __PRETTY_FUNCTION__));

    Yreversed = cmsReverseToneCurveEx(nResultingPoints, Y);
    if (Yreversed == ((void*)0)) goto Error;

    Res = (cmsFloat32Number*) _cmsCalloc(ContextID, nResultingPoints, sizeof(cmsFloat32Number));
    if (Res == ((void*)0)) goto Error;
...
Error:
    ...
    if (Res != ((void*)0)) _cmsFree(ContextID, Res);
    if (Yreversed != ((void*)0)) cmsFreeToneCurve(Yreversed);
...
cmsToneCurve* cmsReverseToneCurveEx(cmsInt32Number nResultSamples, const cmsToneCurve* InCurve)
{
    cmsToneCurve *out;
    ...
    (((InCurve != ((void*)0))) ? (void) (0) : __assert_fail ("(InCurve != ((void*)0))", "./lcms2/src/cmsgamma.c", 909, __PRETTY_FUNCTION__));



    if (InCurve ->nSegments == 1 && InCurve ->Segments[0].Type > 0 &&

        GetParametricCurveByType(InCurve ->InterpParams->ContextID, InCurve ->Segments[0].Type, ((void*)0)) != ((void*)0)) {
    ...
    out = cmsBuildTabulatedToneCurve16(InCurve ->InterpParams->ContextID, nResultSamples, ((void*)0));
    if (out == ((void*)0))
        return ((void*)0);
...
cmsToneCurve* cmsReverseToneCurve(const cmsToneCurve* InGamma)
{
    (((InGamma != ((void*)0))) ? (void) (0) : __assert_fail ("(InGamma != ((void*)0))", "./lcms2/src/cmsgamma.c", 971, __PRETTY_FUNCTION__));

    return cmsReverseToneCurveEx(4096, InGamma);
}
# 985 "./lcms2/src/cmsgamma.c"
static
cmsBool smooth2(cmsContext ContextID, cmsFloat32Number w[], cmsFloat32Number y[], cmsFloat32Number z[], cmsFloat32Number lambda, int m)
{
    ...
    c = (cmsFloat32Number*) _cmsCalloc(ContextID, 4097, sizeof(cmsFloat32Number));
    d = (cmsFloat32Number*) _cmsCalloc(ContextID, 4097, sizeof(cmsFloat32Number));
    e = (cmsFloat32Number*) _cmsCalloc(ContextID, 4097, sizeof(cmsFloat32Number));
    ...
    if (c != ((void*)0)) _cmsFree(ContextID, c);
    if (d != ((void*)0)) _cmsFree(ContextID, d);
    if (e != ((void*)0)) _cmsFree(ContextID, e);
...
cmsBool cmsSmoothToneCurve(cmsToneCurve* Tab, cmsFloat64Number lambda)
{
    cmsFloat32Number w[4097], y[4097], z[4097];
    int i, nItems, Zeros, Poles;

    if (Tab == ((void*)0)) return 0;

    if (cmsIsToneCurveLinear(Tab)) return 1;

    nItems = Tab -> nEntries;

    if (nItems >= 4097) {
        cmsSignalError(Tab ->InterpParams->ContextID, 2, "cmsSmoothToneCurve: too many points.");
        return 0;
    }
    ...
    if (!smooth2(Tab ->InterpParams->ContextID, w, y, z, (cmsFloat32Number) lambda, nItems)) return 0;
    ...
    for (i=nItems; i > 1; --i) {
        ...
        if (z[i] >= 65535.) Poles++;
        if (z[i] < z[i-1]) {
            cmsSignalError(Tab ->InterpParams->ContextID, 2, "cmsSmoothToneCurve: Non-Monotonic.");
            return 0;
        }
    }

    if (Zeros > (nItems / 3)) {
        cmsSignalError(Tab ->InterpParams->ContextID, 2, "cmsSmoothToneCurve: Degenerated, mostly zeros.");
        return 0;
    }
    if (Poles > (nItems / 3)) {
        cmsSignalError(Tab ->InterpParams->ContextID, 2, "cmsSmoothToneCurve: Degenerated, mostly poles.");
        return 0;
    }
...
cmsBool cmsIsToneCurveLinear(const cmsToneCurve* Curve)
{
    ...
    (((Curve != ((void*)0))) ? (void) (0) : __assert_fail ("(Curve != ((void*)0))", "./lcms2/src/cmsgamma.c", 1109, __PRETTY_FUNCTION__));
...
cmsBool cmsIsToneCurveMonotonic(const cmsToneCurve* t)
{
    ...
    (((t != ((void*)0))) ? (void) (0) : __assert_fail ("(t != ((void*)0))", "./lcms2/src/cmsgamma.c", 1128, __PRETTY_FUNCTION__));
...
cmsBool cmsIsToneCurveDescending(const cmsToneCurve* t)
{
    (((t != ((void*)0))) ? (void) (0) : __assert_fail ("(t != ((void*)0))", "./lcms2/src/cmsgamma.c", 1170, __PRETTY_FUNCTION__));
...
cmsBool cmsIsToneCurveMultisegment(const cmsToneCurve* t)
{
    (((t != ((void*)0))) ? (void) (0) : __assert_fail ("(t != ((void*)0))", "./lcms2/src/cmsgamma.c", 1179, __PRETTY_FUNCTION__));
...
cmsInt32Number cmsGetToneCurveParametricType(const cmsToneCurve* t)
{
    (((t != ((void*)0))) ? (void) (0) : __assert_fail ("(t != ((void*)0))", "./lcms2/src/cmsgamma.c", 1186, __PRETTY_FUNCTION__));
...
cmsFloat32Number cmsEvalToneCurveFloat(const cmsToneCurve* Curve, cmsFloat32Number v)
{
    (((Curve != ((void*)0))) ? (void) (0) : __assert_fail ("(Curve != ((void*)0))", "./lcms2/src/cmsgamma.c", 1195, __PRETTY_FUNCTION__));
...
cmsUInt16Number cmsEvalToneCurve16(const cmsToneCurve* Curve, cmsUInt16Number v)
{
    ...
    (((Curve != ((void*)0))) ? (void) (0) : __assert_fail ("(Curve != ((void*)0))", "./lcms2/src/cmsgamma.c", 1216, __PRETTY_FUNCTION__));

    Curve ->InterpParams ->Interpolation.Lerp16(&v, &out, Curve ->InterpParams);
    return out;
}
# 1240 "./lcms2/src/cmsgamma.c"
cmsFloat64Number cmsEstimateGamma(const cmsToneCurve* t, cmsFloat64Number Precision)
{
    ...
    (((t != ((void*)0))) ? (void) (0) : __assert_fail ("(t != ((void*)0))", "./lcms2/src/cmsgamma.c", 1246, __PRETTY_FUNCTION__));
