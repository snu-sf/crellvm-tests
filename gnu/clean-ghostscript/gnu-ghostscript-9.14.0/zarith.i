...
{
    register os_ptr op = (((i_ctx_p->op_stack).stack).p);
    ...
    case t_real:
        ...
        case t_real:
            ...
            break;
        case t_integer:
            ((op - 1)->value.realval = ((double)op[-1].value.intval + op->value.realval), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
        }
        break;
    case t_integer:
        switch ((((const byte *)&((op - 1)->tas.type_attrs))[1])) {
        ...
        case t_real:
            ...
            break;
        case t_integer: {
            if (sizeof(ps_int) != 4 && gs_currentcpsimode(((gs_memory_t *)((i_ctx_p->memory).current)))) {
                ...
                if (((int1 += int2) ^ int2) < 0 &&
                    ...
                    ((op - 1)->value.realval = ((double)(int1 - int2) + int2), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                }
                else {
                ...
                if (((op[-1].value.intval += int2) ^ int2) < 0 &&
                    ...
                    ((op - 1)->value.realval = ((double)(op[-1].value.intval - int2) + int2), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                }
            }
        }
        }
        ...
        case t_real:
            ...
            switch ((((const byte *)&((op1)->tas.type_attrs))[1])) {
                ...
                case t_real:
                    ...
                    break;
                case t_integer:
                    ((op1)->value.realval = ((double)op1->value.intval / op->value.realval), ((op1)->tas.type_attrs = ((t_real) << 8) + (0)) );
            }
            break;
        case t_integer:
            ...
            switch ((((const byte *)&((op1)->tas.type_attrs))[1])) {
                ...
                case t_real:
                    ...
                    break;
                case t_integer:
                    ((op1)->value.realval = ((double)op1->value.intval / (double)op->value.intval), ((op1)->tas.type_attrs = ((t_real) << 8) + (0)) );
            }
    }
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
    ...
    case t_integer:
        ...
        case t_integer: {
            if (sizeof(ps_int) != 4 && gs_currentcpsimode(((gs_memory_t *)((i_ctx_p->memory).current)))) {
                ...
                if (ab > (double)(~(-1 << ((1 << 2) * 8 - 1))))
                    ((op - 1)->value.realval = (ab), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                else if (ab < (double)(-1 << ((1 << 2) * 8 - 1)))
                    ((op - 1)->value.realval = (ab), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                else
                ...
                double ab = (double)op[-1].value.intval * op->value.intval;
                if (ab > (double)(~(-((int64_t)1) << (sizeof(int64_t) * 8 - 1))))
                    ((op - 1)->value.realval = (ab), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                else if (ab < (double)(-((int64_t)1) << (sizeof(int64_t) * 8 - 1)))
                    ((op - 1)->value.realval = (ab), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                else
                    op[-1].value.intval = (ps_int)ab;
            }
        ...
        case t_integer: {
            if (sizeof(ps_int) != 4 && gs_currentcpsimode(((gs_memory_t *)((i_ctx_p->memory).current)))) {
                ...
                if ((int1 ^ (int3 = int1 - int2)) < 0 &&
                    ...
                    ((op - 1)->value.realval = ((float)int1 - op->value.intval), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                }
                else {
...
zidiv(i_ctx_t *i_ctx_p)
{
    ...
    if (sizeof(ps_int) && gs_currentcpsimode(((gs_memory_t *)((i_ctx_p->memory).current)))) {
        int tmpval;
        if ((op->value.intval == 0) || (op[-1].value.intval == (ps_int)(-1 << ((1 << 2) * 8 - 1)) && op->value.intval == -1)) {
        ...
        if ((op->value.intval == 0) || (op[-1].value.intval == (-((int64_t)1) << (sizeof(int64_t) * 8 - 1)) && op->value.intval == -1)) {
...
zneg(i_ctx_t *i_ctx_p)
{
    ...
    switch ((((const byte *)&((op)->tas.type_attrs))[1])) {
        ...
        case t_real:
            ...
            break;
        case t_integer:
            if (sizeof(ps_int) != 32 && gs_currentcpsimode(((gs_memory_t *)((i_ctx_p->memory).current)))) {
                if (((unsigned int)op->value.intval) == (-1 << ((1 << 2) * 8 - 1)))
                    ((op)->value.realval = (-(float)(ps_uint32)(-1 << ((1 << 2) * 8 - 1))), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
                else
                    op->value.intval = -op->value.intval;
            }
            else {
                if (op->value.intval == (-((int64_t)1) << (sizeof(int64_t) * 8 - 1)))
                    ((op)->value.realval = (-(float)(-((int64_t)1) << (sizeof(int64_t) * 8 - 1))), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
                else
                    op->value.intval = -op->value.intval;
            }
    }
