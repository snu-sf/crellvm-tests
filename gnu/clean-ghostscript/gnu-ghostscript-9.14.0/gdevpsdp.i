# 1 "./devices/vector/gdevpsdp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpsdp.c" 2
# 18 "./devices/vector/gdevpsdp.c"
# 1 "./base/string_.h" 1
# 23 "./base/string_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 33 "./base/string_.h" 2
# 19 "./devices/vector/gdevpsdp.c" 2
# 1 "./obj/jpeglib_.h" 1
# 25 "./obj/jpeglib_.h"
# 1 "./obj/jconfig.h" 1
# 507 "./obj/jconfig.h"
...
# 20 "./devices/vector/gdevpsdp.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
...
# 21 "./devices/vector/gdevpsdp.c" 2
...
# 23 "./devices/vector/gdevpsdp.c" 2
# 1 "./base/gxdevice.h" 1
# 23 "./base/gxdevice.h"
# 1 "./base/gxdevcli.h" 1
# 23 "./base/gxdevcli.h"
...
# 24 "./devices/vector/gdevpsdp.c" 2
# 1 "./base/gsparamx.h" 1
# 23 "./base/gsparamx.h"
...
# 25 "./devices/vector/gdevpsdp.c" 2
...
# 26 "./devices/vector/gdevpsdp.c" 2
...
# 29 "./devices/vector/gdevpsdp.c" 2
# 1 "./base/slzwx.h" 1
# 23 "./base/slzwx.h"
...
# 30 "./devices/vector/gdevpsdp.c" 2
# 1 "./base/srlx.h" 1
# 29 "./base/srlx.h"
...
# 31 "./devices/vector/gdevpsdp.c" 2
# 1 "./base/szlibx.h" 1
# 23 "./base/szlibx.h"
...
# 32 "./devices/vector/gdevpsdp.c" 2
# 41 "./devices/vector/gdevpsdp.c"
static gs_ptr_type_t param_string_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void param_string_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static const gs_memory_struct_type_t st_gs_param_string = { sizeof(gs_param_string), "gs_param_string", 0, 0, param_string_enum_ptrs, param_string_reloc_ptrs, 0, 0 };

static
gs_ptr_type_t param_string_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_param_string *pstr = vptr; switch ( index ) { default: return 0;
case 0: return (pep->ptr = (pstr)->data, pep->size = (pstr)->size, (&ptr_const_string_procs));
} }
static
void param_string_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_param_string *pstr = vptr;
{
    gs_const_string str;

    str.data = pstr->data, str.size = pstr->size;
    (((*(const gc_procs_common_t **)(gcst))->reloc_const_string)(&(str), gcst));
    pstr->data = str.data;
}
}
static gs_ptr_type_t param_string_elt_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { uint count = size / (uint)sizeof(gs_param_string); if ( count == 0 ) return 0; return (*(st_gs_param_string).enum_ptrs)(mem, (const char *)vptr + (index % count) * sizeof(gs_param_string), sizeof(gs_param_string), index / count, pep, &(st_gs_param_string), gcst); } static void param_string_elt_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { { uint count = size / (uint)sizeof(gs_param_string); for ( ; count; count--, vptr = (char *)vptr + sizeof(gs_param_string) ) (*(st_gs_param_string).reloc_ptrs)(vptr, sizeof(gs_param_string), &(st_gs_param_string), gcst); } } static const gs_memory_struct_type_t st_param_string_element = { sizeof(gs_param_string), "gs_param_string[]", 0, 0, param_string_elt_enum_ptrs, param_string_elt_reloc_ptrs, 0, 0 };
# 90 "./devices/vector/gdevpsdp.c"
...
typedef struct psdf_image_param_names_s {
    ...
    const char *Filter;
    const char *AutoFilterStrategy;
    gs_param_item_t items[9];



} psdf_image_param_names_t;
# 144 "./devices/vector/gdevpsdp.c"
static const psdf_image_param_names_t Color_names = {
    "ColorACSImageDict", "ColorImageDict", "ColorImageDownsampleType", 1.5, Poly_filters, "ColorImageFilter", 0, { { "AutoFilterColorImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilter - (char *)((psdf_image_params *)0) )) }, { "AntiAliasColorImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AntiAlias - (char *)((psdf_image_params *)0) )) }, { "ColorImageDepth", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Depth - (char *)((psdf_image_params *)0) )) }, { "DownsampleColorImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Downsample - (char *)((psdf_image_params *)0) )) }, { "ColorImageDownsampleThreshold", gs_param_type_float, ((int) ( (char *)&((psdf_image_params *)0)->DownsampleThreshold - (char *)((psdf_image_params *)0) )) }, { "EncodeColorImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Encode - (char *)((psdf_image_params *)0) )) }, { "ColorImageResolution", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Resolution - (char *)((psdf_image_params *)0) )) }, { 0, gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilterStrategy - (char *)((psdf_image_params *)0) )) }, { 0 } }
...
static const psdf_image_param_names_t Gray_names = {
    "GrayACSImageDict", "GrayImageDict", "GrayImageDownsampleType", 2.0, Poly_filters, "GrayImageFilter", 0, { { "AutoFilterGrayImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilter - (char *)((psdf_image_params *)0) )) }, { "AntiAliasGrayImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AntiAlias - (char *)((psdf_image_params *)0) )) }, { "GrayImageDepth", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Depth - (char *)((psdf_image_params *)0) )) }, { "DownsampleGrayImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Downsample - (char *)((psdf_image_params *)0) )) }, { "GrayImageDownsampleThreshold", gs_param_type_float, ((int) ( (char *)&((psdf_image_params *)0)->DownsampleThreshold - (char *)((psdf_image_params *)0) )) }, { "EncodeGrayImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Encode - (char *)((psdf_image_params *)0) )) }, { "GrayImageResolution", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Resolution - (char *)((psdf_image_params *)0) )) }, { 0, gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilterStrategy - (char *)((psdf_image_params *)0) )) }, { 0 } }
...
static const psdf_image_param_names_t Mono_names = {
    0, "MonoImageDict", "MonoImageDownsampleType", 2.0, Mono_filters, "MonoImageFilter", 0, { { 0, gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilter - (char *)((psdf_image_params *)0) )) }, { "AntiAliasMonoImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AntiAlias - (char *)((psdf_image_params *)0) )) }, { "MonoImageDepth", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Depth - (char *)((psdf_image_params *)0) )) }, { "DownsampleMonoImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Downsample - (char *)((psdf_image_params *)0) )) }, { "MonoImageDownsampleThreshold", gs_param_type_float, ((int) ( (char *)&((psdf_image_params *)0)->DownsampleThreshold - (char *)((psdf_image_params *)0) )) }, { "EncodeMonoImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Encode - (char *)((psdf_image_params *)0) )) }, { "MonoImageResolution", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Resolution - (char *)((psdf_image_params *)0) )) }, { 0, gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilterStrategy - (char *)((psdf_image_params *)0) )) }, { 0 } }
...
static const psdf_image_param_names_t Color_names15 = {
    "ColorACSImageDict", "ColorImageDict", "ColorImageDownsampleType", 1.5, Poly_filters, "ColorImageFilter", "ColorAutoFilterStrategy", { { "AutoFilterColorImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilter - (char *)((psdf_image_params *)0) )) }, { "AntiAliasColorImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AntiAlias - (char *)((psdf_image_params *)0) )) }, { "ColorImageDepth", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Depth - (char *)((psdf_image_params *)0) )) }, { "DownsampleColorImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Downsample - (char *)((psdf_image_params *)0) )) }, { "ColorImageDownsampleThreshold", gs_param_type_float, ((int) ( (char *)&((psdf_image_params *)0)->DownsampleThreshold - (char *)((psdf_image_params *)0) )) }, { "EncodeColorImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Encode - (char *)((psdf_image_params *)0) )) }, { "ColorImageResolution", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Resolution - (char *)((psdf_image_params *)0) )) }, { "ColorAutoFilterStrategy", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilterStrategy - (char *)((psdf_image_params *)0) )) }, { 0 } }
...
static const psdf_image_param_names_t Gray_names15 = {
    "GrayACSImageDict", "GrayImageDict", "GrayImageDownsampleType", 2.0, Poly_filters, "GrayImageFilter", "GrayAutoFilterStrategy", { { "AutoFilterGrayImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilter - (char *)((psdf_image_params *)0) )) }, { "AntiAliasGrayImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->AntiAlias - (char *)((psdf_image_params *)0) )) }, { "GrayImageDepth", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Depth - (char *)((psdf_image_params *)0) )) }, { "DownsampleGrayImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Downsample - (char *)((psdf_image_params *)0) )) }, { "GrayImageDownsampleThreshold", gs_param_type_float, ((int) ( (char *)&((psdf_image_params *)0)->DownsampleThreshold - (char *)((psdf_image_params *)0) )) }, { "EncodeGrayImages", gs_param_type_bool, ((int) ( (char *)&((psdf_image_params *)0)->Encode - (char *)((psdf_image_params *)0) )) }, { "GrayImageResolution", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->Resolution - (char *)((psdf_image_params *)0) )) }, { "GrayAutoFilterStrategy", gs_param_type_int, ((int) ( (char *)&((psdf_image_params *)0)->AutoFilterStrategy - (char *)((psdf_image_params *)0) )) }, { 0 } }
...
static const char *const ColorConversionStrategy_names[] = {
    "LeaveColorUnchanged", "UseDeviceDependentColor", "UseDeviceIndependentColor", "UseDeviceIndependentColorForImages", "sRGB", "CMYK", "Gray", "RGB", "ByObjectType", 0
};
...
static const gs_param_item_t psdf_param_items[] = {
    ...
    { "ASCII85EncodePages", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->ASCII85EncodePages - (char *)((psdf_distiller_params *)0) )) },


    { "CompressPages", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->CompressPages - (char *)((psdf_distiller_params *)0) )) },

    { "DetectBlends", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->DetectBlends - (char *)((psdf_distiller_params *)0) )) },
    { "DoThumbnails", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->DoThumbnails - (char *)((psdf_distiller_params *)0) )) },
    { "ImageMemory", gs_param_type_long, ((int) ( (char *)&((psdf_distiller_params *)0)->ImageMemory - (char *)((psdf_distiller_params *)0) )) },

    { "LZWEncodePages", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->LZWEncodePages - (char *)((psdf_distiller_params *)0) )) },
    { "OPM", gs_param_type_int, ((int) ( (char *)&((psdf_distiller_params *)0)->OPM - (char *)((psdf_distiller_params *)0) )) },
    { "PreserveHalftoneInfo", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->PreserveHalftoneInfo - (char *)((psdf_distiller_params *)0) )) },
    { "PreserveOPIComments", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->PreserveOPIComments - (char *)((psdf_distiller_params *)0) )) },
    { "PreserveOverprintSettings", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->PreserveOverprintSettings - (char *)((psdf_distiller_params *)0) )) },


    { "UseFlateCompression", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->UseFlateCompression - (char *)((psdf_distiller_params *)0) )) },



    { "ConvertCMYKImagesToRGB", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->ConvertCMYKImagesToRGB - (char *)((psdf_distiller_params *)0) )) },
    { "ConvertImagesToIndexed", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->ConvertImagesToIndexed - (char *)((psdf_distiller_params *)0) )) },




    { "EmbedAllFonts", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->EmbedAllFonts - (char *)((psdf_distiller_params *)0) )) },
    { "MaxSubsetPct", gs_param_type_int, ((int) ( (char *)&((psdf_distiller_params *)0)->MaxSubsetPct - (char *)((psdf_distiller_params *)0) )) },
    { "SubsetFonts", gs_param_type_bool, ((int) ( (char *)&((psdf_distiller_params *)0)->SubsetFonts - (char *)((psdf_distiller_params *)0) )) },
...
psdf_write_name(gs_param_list *plist, const char *key, const char *str)
{
    ...
    ((pstr).data = (const byte *)(str), (pstr).size = strlen((const char *)(pstr).data), (pstr).persistent = ((bool)1));
                          ...
                          gs_c_param_list *plvalue)
{
    ...
    if (pname == 0)
        return 0;
    dict.size = 12;
    if ((code = (*(plist)->procs->begin_xmit_collection)(plist, pname, &dict, (((bool)0) ? gs_param_collection_dict_int_keys : gs_param_collection_dict_any))) < 0)
        return code;
    if (plvalue != 0) {
        gs_c_param_list_read(plvalue);
        code = param_list_copy(dict.list, (gs_param_list *)plvalue);
    }
    (*(plist)->procs->end_xmit_collection)(plist, pname, &dict);
    return code;
}
          ...
          const psdf_image_param_names_t * pnames, psdf_image_params * params)
{
    ...
    code = gs_param_write_items(plist, params, ((void*)0), items);
    if (code < 0)
        return code;
...
gdev_psdf_get_params(gx_device * dev, gs_param_list * plist)
{
    ...
    code = gs_param_write_items(plist, &pdev->params, ((void*)0), psdf_param_items);
    if (code < 0)
        return code;
...
extern int s_CF_put_params(gs_param_list *plist, stream_CF_state *ss);
extern int s_DCTE_put_params(gs_param_list *plist, stream_DCT_state *ss);
typedef int (*ss_put_params_t)(gs_param_list *plist, stream_state *ss);
                       ...
                       gs_const_string *pstr, gs_memory_t *mem, int ecode)
{
    ...
    case 0: {
        uint size = ps.size;
        byte *data = (*(mem)->procs.alloc_string)(mem, size, "psdf_read_string_param");
...
{
    return psdf_DCT_filter(plist, st, 8 , 8 , 3 ,
                           ((void*)0));
}
                       ...
                       gs_param_string_array * psa)
{
    ...
    switch (code = param_read_name_array(plist, pname, psa)) {
        default:
            (*(plist)->procs->signal_error)(plist, pname, code);
        case 0:
        case 1:
            break;
    }
          ...
          gs_memory_t *mem)
{
    ...
    for (i = 0; i < psa->size; ++i) {
        ...
        if (j == count) {
            ...
            byte *data = (*(mem)->procs.alloc_string)(mem, size, "add_embed");
                     ...
                     gs_memory_t *mem)
{
    ...
    rdata = (gs_param_string *)(*(mem)->procs.alloc_struct_array)(mem, psa->size + asa->size, &st_param_string_element, "psdf_put_embed_param(update)");
    ...
    rsa.data = rdata;
    rsa.size = psa->size;
    rsa.persistent = ((bool)0);
    code = add_embed(&rsa, asa, mem);
    if (code < 0) {
        ((mem)->procs.free_object(mem, rdata, "psdf_put_embed_param(update)"));
        return code;
    }
                     ...
                     gs_memory_t *mem, int ecode)
{
    ...
    if (psa->data)
        psa->data = ((mem)->procs.resize_object(mem, (gs_param_string *)psa->data, psa->size, "psdf_put_embed_param(resize)"));
                          ...
                          ss_put_params_t put_params, gs_memory_t * mem)
{
    ...
    mem = ((mem)->procs.stable(mem));
    switch (code = (*(plist)->procs->begin_xmit_collection)(plist, pname, &dict, (((bool)0) ? gs_param_collection_dict_int_keys : gs_param_collection_dict_any))) {
        default:
            (*(plist)->procs->signal_error)(plist, pname, code);
            return code;
        case 1:
        ...
        case 0: {
            ...
            if (templat->release)
                templat->release(ss);
            ((mem)->procs.free_object(mem, ss, pname));
            if (code < 0) {
                (*(plist)->procs->signal_error)(plist, pname, code);
            } else {
                ...
                if (code < 0) {
                    ...
                    ((mem)->procs.free_object(mem, plvalue, pname));
                    plvalue = *pplvalue;
                }
            }
        }
