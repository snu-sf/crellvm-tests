...
zcopy(i_ctx_t *i_ctx_p)
{
    ...
    int type = (((const byte *)&((op)->tas.type_attrs))[1]);
...
zcopy_integer(i_ctx_t *i_ctx_p)
{
    ...
    if ((uint) op->value.intval > (uint)(op - (((i_ctx_p->op_stack).stack).bot))) {

        if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op));
        if (op->value.intval >= (int)ref_stack_count(&((i_ctx_p->op_stack).stack)))
            return ((-17));
        if (op->value.intval < 0)
            return ((-15));
        do { if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op)); if ( (ulong)(*op).value.intval >= (ref_stack_count(&((i_ctx_p->op_stack).stack))) ) return ((-15)); } while (0);
        count = op->value.intval;
    } else if (op1 + (count = op->value.intval) <= (((i_ctx_p->op_stack).stack).top)) {

        memcpy((char *)op, (char *)(op - count), count * sizeof(ref));
        do { if ( (op += (count - 1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (count - 1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
        return 0;
    }

    code = ref_stack_push(&((i_ctx_p->op_stack).stack), count - 1);
    if (code < 0)
        return code;
    for (i = 0; i < count; i++)
        *ref_stack_index(&((i_ctx_p->op_stack).stack), i) =
            *ref_stack_index(&((i_ctx_p->op_stack).stack), i + count);
    return 0;
}
...
zlength(i_ctx_t *i_ctx_p)
{
    ...
    switch ((((const byte *)&((op)->tas.type_attrs))[1])) {
        ...
        case t_mixedarray:
        case t_shortarray:
            do { if ( !(((&*op)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            ((op)->value.intval = (((op)->tas.rsize)), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
            return 0;
        case t_dictionary:
            do { if ( !(((&*(&(&*op)->value.pdict->values))->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            ((op)->value.intval = (dict_length(op)), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
            return 0;
        case t_name: {
            ref str;

            names_string_ref(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, op, &str);
            ((op)->value.intval = (((&str)->tas.rsize)), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
            return 0;
        }
        case t_astruct:
            if ((*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_type)(((gs_memory_t *)((i_ctx_p->memory).current)), op->value.pstruct) != &st_bytes)
                return ((-20));
            do { if ( !(((&*op)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            ((op)->value.intval = ((*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_size)(((gs_memory_t *)((i_ctx_p->memory).current)), op->value.pstruct)), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
            return 0;
        default:
            return (check_type_failed(op));
    }
...
zget(i_ctx_t *i_ctx_p)
{
    ...
    switch ((((const byte *)&((op1)->tas.type_attrs))[1])) {
        case t_dictionary:
            do { if ( !(((&*(&(&*op1)->value.pdict->values))->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            if (dict_find(op1, op, &pvalue) <= 0)
                return ((-21));
            op[-1] = *pvalue;
            break;
        case t_string:
            do { if ( !(((&*op1)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            do { if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op)); if ( (ulong)(*op).value.intval >= (((op1)->tas.rsize)) ) return ((-15)); } while (0);
            ((op1)->value.intval = (op1->value.bytes[(uint) op->value.intval]), ((op1)->tas.type_attrs = ((t_integer) << 8) + (0)) );
            break;
        case t_array:
        case t_mixedarray:
        case t_shortarray:
            if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op));
            do { if ( !(((&*op1)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            code = array_get(((gs_memory_t *)((i_ctx_p->memory).current)), op1, op->value.intval, op1);
            if (code < 0)
                return code;
            break;
        case t__invalid:
...
zput(i_ctx_t *i_ctx_p)
{
    ...
    switch ((((const byte *)&((op2)->tas.type_attrs))[1])) {
        case t_dictionary:
            if (i_ctx_p->in_superexec == 0)
                do { if ( !(((&*(&(&*op2)->value.pdict->values))->tas.type_attrs) & (0x10)) ) return ((-7)); } while (0);
            {
                int code = dict_put(op2, op1, op, &(i_ctx_p->dict_stack));
            ...
            break;
        case t_array:
            do { if ( !(((&*op2)->tas.type_attrs) & (0x10)) ) return ((-7)); } while (0);
            do { if ( !((((const byte *)&((&*op1)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op1)); if ( (ulong)(*op1).value.intval >= (((op2)->tas.rsize)) ) return ((-15)); } while (0);
            if ( (avm_space)(((op)->tas.type_attrs) & (((1 << 2) - 1) << 2)) > ((avm_space)(((op2)->tas.type_attrs) & (((1 << 2) - 1) << 2))) ) return ((-7));
            {
                ref *eltp = op2->value.refs + (uint) op1->value.intval;

                (((void)((((((eltp)->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), op2, (ref_packed *)(eltp), "put") : 0))), ((void)(((*(eltp) = *(op)), ((eltp)->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
            }
            break;
        case t_mixedarray:
        case t_shortarray:
        ...
        case t_string:
            ...
            ssize = ((op2)->tas.rsize);
str: do { if ( !(((&*op2)->tas.type_attrs) & (0x10)) ) return ((-7)); } while (0);
            do { if ( !((((const byte *)&((&*op1)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op1)); if ( (ulong)(*op1).value.intval >= (ssize) ) return ((-15)); } while (0);
            do { if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op)); if ( (ulong)(*op).value.intval > (0xff) ) return ((-15)); } while (0);
            sdata[(uint)op1->value.intval] = (byte)op->value.intval;
            break;
        case t_astruct:
            if ((*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_type)(((gs_memory_t *)((i_ctx_p->memory).current)), op2->value.pstruct) != &st_bytes)
                return ((-20));
            sdata = ((byte *)((op2)->value.pstruct));
            ssize = (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_size)(((gs_memory_t *)((i_ctx_p->memory).current)), op2->value.pstruct);
            goto str;
        default:
            return (check_type_failed(op2));
    }
...
zforceput(i_ctx_t *i_ctx_p)
{
    ...
    case t_array:
        do { if ( !((((const byte *)&((&*op1)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op1)); if ( (ulong)(*op1).value.intval >= (((op2)->tas.rsize)) ) return ((-15)); } while (0);
        if ((avm_space)(((op2)->tas.type_attrs) & (((1 << 2) - 1) << 2)) > (avm_space)(((op)->tas.type_attrs) & (((1 << 2) - 1) << 2))) {
            if (imemory_save_level(((i_ctx_p->memory).current)))
                return ((-7));
        }
        {
            ref *eltp = op2->value.refs + (uint) op1->value.intval;
        ...
        break;
    case t_dictionary:
        if (op2->value.pdict == (&(i_ctx_p->dict_stack).system_dict)->value.pdict ||
            !imemory_save_level(((i_ctx_p->memory).current))
            ) {
            uint space = (avm_space)(((op2)->tas.type_attrs) & (((1 << 2) - 1) << 2));

            ((op2)->tas.type_attrs = ((op2)->tas.type_attrs & ~((((1 << 2) - 1) << 2))) | ((uint)avm_local));
            code = dict_put(op2, op1, op, &(i_ctx_p->dict_stack));
            ((op2)->tas.type_attrs = ((op2)->tas.type_attrs & ~((((1 << 2) - 1) << 2))) | ((uint)space));
        } else
            code = dict_put(op2, op1, op, &(i_ctx_p->dict_stack));
        if (code < 0)
            return code;
...
zgetinterval(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( !(((&*op2)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
    do { if ( !((((const byte *)&((&*op1)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op1)); if ( (ulong)(*op1).value.intval > (((op2)->tas.rsize)) ) return ((-15)); } while (0);
    index = op1->value.intval;
    do { if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*op)); if ( (ulong)(*op).value.intval > (((op2)->tas.rsize) - index) ) return ((-15)); } while (0);
    count = op->value.intval;
    switch ((((const byte *)&((op2)->tas.type_attrs))[1])) {
        case t_array:
        ...
        case t_mixedarray: {
            ...
            for (; index--;)
                packed = ((*(const ref_packed *)(packed) >= ((ref_packed)(2) << 13)) ? packed + 1 : packed + (sizeof(ref) / sizeof(ref_packed)));
...
zputinterval(i_ctx_t *i_ctx_p)
{
    ...
    switch ((((const byte *)&((opto)->tas.type_attrs))[1])) {
        default:
            return ((-20));
        case t__invalid:
            if ((((const byte *)&((op)->tas.type_attrs))[1]) != t_array && (((const byte *)&((op)->tas.type_attrs))[1]) != t_string && (((const byte *)&((op)->tas.type_attrs))[1]) != t__invalid)
                return ((-20));
            else
                return ((-17));
        case t_mixedarray:
        ...
        case t_array:
        case t_string:
            do { if ( !(((&*opto)->tas.type_attrs) & (0x10)) ) return ((-7)); } while (0);
            do { if ( !((((const byte *)&((&*opindex)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*opindex)); if ( (ulong)(*opindex).value.intval > (((opto)->tas.rsize)) ) return ((-15)); } while (0);
        ...
        case t_astruct: {
            ...
            do { if ( !(((&*opto)->tas.type_attrs) & (0x10)) ) return ((-7)); } while (0);
            if ((*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_type)(((gs_memory_t *)((i_ctx_p->memory).current)), opto->value.pstruct) != &st_bytes)
                return ((-20));
            dsize = (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_size)(((gs_memory_t *)((i_ctx_p->memory).current)), opto->value.pstruct);
            do { if ( !((((const byte *)&((&*opindex)->tas.type_attrs))[1]) == (t_integer)) ) return (check_type_failed(&*opindex)); if ( (ulong)(*opindex).value.intval > (dsize) ) return ((-15)); } while (0);
            ...
            if (ssize > dsize - index)
                return ((-15));
            memcpy(((byte *)((opto)->value.pstruct)) + index, op->value.const_bytes, ssize);
            code = 0;
            break;
        }
    }
...
zforall(i_ctx_t *i_ctx_p)
{
    ...
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (6) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 6); if ( es_code_ < 0 ) return es_code_; };
    ...
    switch ((((const byte *)&((obj)->tas.type_attrs))[1])) {
        default:
            return (check_type_failed(obj));
        case t_array:
            do { if ( !(((&*obj)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            ((cproc)->value.opproc = (array_continue), ((cproc)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((cproc)->tas.rsize = (0)));
            break;
        case t_dictionary:
            do { if ( !(((&*(&(&*obj)->value.pdict->values))->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            ((cproc)->value.intval = (dict_first(obj)), ((cproc)->tas.type_attrs = ((t_integer) << 8) + (0)) );
            ++cproc;
            ((cproc)->value.opproc = (dict_continue), ((cproc)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((cproc)->tas.rsize = (0)));
            break;
        case t_string:
            do { if ( !(((&*obj)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            ((cproc)->value.opproc = (string_continue), ((cproc)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((cproc)->tas.rsize = (0)));
            break;
        case t_mixedarray:
        case t_shortarray:
            do { if ( !(((&*obj)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
            ((cproc)->value.opproc = (packedarray_continue), ((cproc)->tas.type_attrs = ((t_operator) << 8) + (0x80)), ((cproc)->tas.rsize = (0)));
            break;
    }
# 450 "./psi/zgeneric.c"
    ((ep + 1)->value.opproc = (forall_cleanup), ((ep + 1)->tas.type_attrs = ((t_null) << 8) + (0x80)), ((ep + 1)->tas.rsize = (2)));
    ep[2] = *obj;
    ep[3] = *op;
    (((i_ctx_p->exec_stack).stack).p) = cproc - 1;
    ((((i_ctx_p->op_stack).stack).p) -= (2));
    return (*((cproc)->value.opproc))(i_ctx_p);
}
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    es_ptr obj = (((i_ctx_p->exec_stack).stack).p) - 1;
    ...
    if (((obj)->tas.rsize)) {
        ...
        *(((i_ctx_p->exec_stack).stack).p) = obj[1];
        return 5;
    } else {
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    es_ptr obj = (((i_ctx_p->exec_stack).stack).p) - 2;
    int index = (((i_ctx_p->exec_stack).stack).p)->value.intval;
    ...
    if ((index = dict_next(obj, index, op - 1)) >= 0) {
        (((i_ctx_p->exec_stack).stack).p)->value.intval = index;
        (((i_ctx_p->exec_stack).stack).p) += 2;
        *(((i_ctx_p->exec_stack).stack).p) = obj[1];
        return 5;
    } else {
...
string_continue(i_ctx_t *i_ctx_p)
{
    ...
    if (((obj)->tas.rsize)) {
        ((obj)->tas.rsize -= (1));
        do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
        ((op)->value.intval = (*obj->value.bytes), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
        obj->value.bytes++;
        (((i_ctx_p->exec_stack).stack).p) += 2;
        *(((i_ctx_p->exec_stack).stack).p) = obj[1];
        return 5;
...
packedarray_continue(i_ctx_t *i_ctx_p)
{
    ...
    if (((obj)->tas.rsize)) {
        ...
        ((obj)->tas.rsize -= (1));
        do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
        packed_get(((gs_memory_t *)((i_ctx_p->memory).current)), packed, op);
        obj->value.packed = ((*(const ref_packed *)(packed) >= ((ref_packed)(2) << 13)) ? packed + 1 : packed + (sizeof(ref) / sizeof(ref_packed)));
        (((i_ctx_p->exec_stack).stack).p) += 2;
        *(((i_ctx_p->exec_stack).stack).p) = obj[1];
        return 5;
    } else {
...
# 573 "./psi/zgeneric.c"
static int
copy_interval(i_ctx_t *i_ctx_p , os_ptr prto,
              uint index, os_ptr prfrom, client_name_t cname)
{
    int fromtype = (((const byte *)&((prfrom)->tas.type_attrs))[1]);
    uint fromsize = ((prfrom)->tas.rsize);

    if (!(fromtype == (((const byte *)&((prto)->tas.type_attrs))[1]) ||
          ((fromtype == t_shortarray || fromtype == t_mixedarray) &&
           (((const byte *)&((prto)->tas.type_attrs))[1]) == t_array))
        )
        return (check_type_failed(prfrom));
    do { if ( !(((&*prfrom)->tas.type_attrs) & (0x20)) ) return ((-7)); } while (0);
    do { if ( !(((&*prto)->tas.type_attrs) & (0x10)) ) return ((-7)); } while (0);
    if (fromsize > ((prto)->tas.rsize) - index)
        return ((-15));
    switch (fromtype) {
        case t_array:
            {
        ...
        case t_shortarray:
            {
                ...
                for (i = 0; i < fromsize; i++, pdest++) {
                    packed_get(((gs_memory_t *)((i_ctx_p->memory).current)), packed, &elt);
                    (((void)((((((pdest)->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), prto, (ref_packed *)(pdest), cname) : 0))), ((void)(((*(pdest) = *(&elt)), ((pdest)->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
                    packed = ((*(const ref_packed *)(packed) >= ((ref_packed)(2) << 13)) ? packed + 1 : packed + (sizeof(ref) / sizeof(ref_packed)));
                }
            }
            break;
