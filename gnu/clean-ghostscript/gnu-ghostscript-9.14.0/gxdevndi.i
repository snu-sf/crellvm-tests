...
# 21 "./base/gxdevndi.c" 2
# 1 "./base/gxlum.h" 1
# 22 "./base/gxdevndi.c" 2
...
int gs_cname_to_colorant_number(gs_state * pgs, byte * pname, uint name_size,
                                 int halftonetype);
# 25 "./base/gxdevndi.c" 2
# 45 "./base/gxdevndi.c"
static const gx_color_value q0[] = {
    0
};
static const gx_color_value q1[] = {
    0, (gx_color_value)(((1) * (0xffffL * 2) + 1) / (1 * 2))
};
static const gx_color_value q2[] = {
    0, (gx_color_value)(((1) * (0xffffL * 2) + 2) / (2 * 2)), (gx_color_value)(((2) * (0xffffL * 2) + 2) / (2 * 2))
};
static const gx_color_value q3[] = {
    0, (gx_color_value)(((1) * (0xffffL * 2) + 3) / (3 * 2)), (gx_color_value)(((2) * (0xffffL * 2) + 3) / (3 * 2)), (gx_color_value)(((3) * (0xffffL * 2) + 3) / (3 * 2))
};
static const gx_color_value q4[] = {
    0, (gx_color_value)(((1) * (0xffffL * 2) + 4) / (4 * 2)), (gx_color_value)(((2) * (0xffffL * 2) + 4) / (4 * 2)), (gx_color_value)(((3) * (0xffffL * 2) + 4) / (4 * 2)),
    (gx_color_value)(((4) * (0xffffL * 2) + 4) / (4 * 2))
};
static const gx_color_value q5[] = {
    0, (gx_color_value)(((1) * (0xffffL * 2) + 5) / (5 * 2)), (gx_color_value)(((2) * (0xffffL * 2) + 5) / (5 * 2)), (gx_color_value)(((3) * (0xffffL * 2) + 5) / (5 * 2)),
    (gx_color_value)(((4) * (0xffffL * 2) + 5) / (5 * 2)), (gx_color_value)(((5) * (0xffffL * 2) + 5) / (5 * 2))
};
static const gx_color_value q6[] = {
    0, (gx_color_value)(((1) * (0xffffL * 2) + 6) / (6 * 2)), (gx_color_value)(((2) * (0xffffL * 2) + 6) / (6 * 2)), (gx_color_value)(((3) * (0xffffL * 2) + 6) / (6 * 2)),
    (gx_color_value)(((4) * (0xffffL * 2) + 6) / (6 * 2)), (gx_color_value)(((5) * (0xffffL * 2) + 6) / (6 * 2)), (gx_color_value)(((6) * (0xffffL * 2) + 6) / (6 * 2))
};
static const gx_color_value q7[] = {
    0, (gx_color_value)(((1) * (0xffffL * 2) + 7) / (7 * 2)), (gx_color_value)(((2) * (0xffffL * 2) + 7) / (7 * 2)), (gx_color_value)(((3) * (0xffffL * 2) + 7) / (7 * 2)),
    (gx_color_value)(((4) * (0xffffL * 2) + 7) / (7 * 2)), (gx_color_value)(((5) * (0xffffL * 2) + 7) / (7 * 2)), (gx_color_value)(((6) * (0xffffL * 2) + 7) / (7 * 2)), (gx_color_value)(((7) * (0xffffL * 2) + 7) / (7 * 2))
};
        ...
        gx_device_halftone * pdht, const gs_int_point * ht_phase)
{
    ...
    for (i = 0; i < num_colors; i++) {
        ...
        long shade = pcolor[i] * nshades / (((long)((frac)0x7ff8)) + 1);
...
# 134 "./base/gxdevndi.c"
    if (!dither_check) {
        for (i = 0; i < num_colors; i++)
            vcolor[i] = ((max_value[i]) <= 7 ? fc_color_quo[max_value[i]][int_color[i]] : (gx_color_value)(((int_color[i]) * (0xffffL * 2) + max_value[i]) / (max_value[i] * 2)));
        ((pdevc)->colors.pure = (((dev)->procs.encode_color)(dev, vcolor)), (pdevc)->type = gx_dc_type_pure);
        return 0;
    }
    ...
    for (i = 0; i < num_colors; i++)
        ((pdevc)->colors.colored.c_base[i] = (int_color[i]), (pdevc)->colors.colored.c_level[i] = (l_color[i]));
...
gx_devn_reduce_colored_halftone(gx_device_color *pdevc, gx_device *dev)
{
    ...
    for (i = 0; i < num_colors; i++) {
        ...
        v[i] = ((max_value[i]) <= 7 ? fc_color_quo[max_value[i]][b[i]] : (gx_color_value)(((b[i]) * (0xffffL * 2) + max_value[i]) / (max_value[i] * 2)));
    }
    c0 = ((dev)->procs.encode_color)(dev, v);
    ...
    if (planes == 0) {
        ...
        ((pdevc)->colors.pure = (c0), (pdevc)->type = gx_dc_type_pure);
        return 0;
    } else {
...
# 204 "./base/gxdevndi.c"
        ...
        bi = b[i] + 1;
        v[i] = ((max_value[i]) <= 7 ? fc_color_quo[max_value[i]][bi] : (gx_color_value)(((bi) * (0xffffL * 2) + max_value[i]) / (max_value[i] * 2)));
        level = pdevc->colors.colored.c_level[i];
        c1 = ((dev)->procs.encode_color)(dev, v);
        if (invert) {
            level = pdht->components[i].corder.num_levels - level;
            ((pdevc)->colors.binary.b_ht = (pdht), (pdevc)->colors.binary.b_index = (i), (pdevc)->colors.binary.color[0] = (c1), (pdevc)->colors.binary.color[1] = (c0), (pdevc)->colors.binary.b_level = (level), (pdevc)->type = gx_dc_type_ht_binary);
        } else
            ((pdevc)->colors.binary.b_ht = (pdht), (pdevc)->colors.binary.b_index = (i), (pdevc)->colors.binary.color[0] = (c0), (pdevc)->colors.binary.color[1] = (c1), (pdevc)->colors.binary.b_level = (level), (pdevc)->type = gx_dc_type_ht_binary);
