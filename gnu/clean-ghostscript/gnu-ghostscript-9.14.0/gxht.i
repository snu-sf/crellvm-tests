...
static gs_ptr_type_t dc_ht_binary_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void dc_ht_binary_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_dc_ht_binary = { sizeof(gx_device_color), "dc_ht_binary", 0, 0, dc_ht_binary_enum_ptrs, dc_ht_binary_reloc_ptrs, 0, 0 };

static void gx_dc_ht_binary_save_dc(const gx_device_color * pdevc, gx_device_color_saved * psdc);
static const gx_device_halftone * gx_dc_ht_binary_get_dev_halftone(const gx_device_color * pdevc);
...
static int gx_dc_ht_binary_fill_masked(const gx_device_color *pdevc, const byte *data, int data_x, int raster, gx_bitmap_id id, int x, int y, int w, int h, gx_device *dev, gs_logical_operation_t lop, bool invert);
static bool gx_dc_ht_binary_equal(const gx_device_color *pdevc1, const gx_device_color *pdevc2);
static int gx_dc_ht_binary_write(const gx_device_color *pdevc, const gx_device_color_saved *psdc, const gx_device * dev, int64_t offset, byte *data, uint *psize);
static int gx_dc_ht_binary_read(gx_device_color *pdevc, const gs_imager_state * pis, const gx_device_color *prior_devc, const gx_device * dev, int64_t offset, const byte *data, uint size, gs_memory_t *mem);
...
static
gs_ptr_type_t dc_ht_binary_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gx_device_color *cptr = vptr; switch ( index ) { default: return 0;
case 0: return (pep->ptr = (const void *)(((const gx_device_color *)vptr)->colors.binary.b_ht), (&ptr_struct_procs));
case 1:
{
    gx_ht_tile *tile = cptr->colors.binary.b_tile;

    return (pep->ptr = (const void *)(tile ? tile - tile->index : 0), (&ptr_struct_procs));
}
} }
static void dc_ht_binary_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gx_device_color *cptr = vptr;
{
    gx_ht_tile *tile = cptr->colors.binary.b_tile;
    uint index = tile ? tile->index : 0;

    (((gx_device_color *)vptr)->colors.binary.b_ht = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gx_device_color *)vptr)->colors.binary.b_ht), gcst)));
    (((gx_device_color *)vptr)->colors.binary.b_tile = (void *)(((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gx_device_color *)vptr)->colors.binary.b_tile - (index)), gcst)), ((gx_device_color *)vptr)->colors.binary.b_tile += (index));
}
}



static gs_ptr_type_t ht_tiles_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void ht_tiles_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static const gs_memory_struct_type_t st_ht_tiles = { sizeof(gx_ht_tile), "ht tiles", 0, 0, ht_tiles_enum_ptrs, ht_tiles_reloc_ptrs, 0, 0 };
static
gs_ptr_type_t ht_tiles_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst)
{
    return 0;
}

static void ht_tiles_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) {
{
    ...
    if (bits == 0)
        return;
    (bits = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(bits), gcst)));
...
static const gc_ptr_element_t ht_cache_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gx_ht_cache *)0)->bits - (char *)((gx_ht_cache *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_ht_cache *)0)->ht_tiles - (char *)((gx_ht_cache *)0) )) } }; static const gc_struct_data_t ht_cache_reloc_ptrs = { (sizeof(ht_cache_enum_ptrs) / sizeof((ht_cache_enum_ptrs)[0])), ((int) ( (char *)&((gx_ht_cache *)0)->order - (char *)((gx_ht_cache *)0) )), &st_ht_order, ht_cache_enum_ptrs }; static const gs_memory_struct_type_t st_ht_cache = { sizeof(gx_ht_cache), "ht cache", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &ht_cache_reloc_ptrs };
...
{
    gx_ht_cache *pcache =
    (gx_ht_cache *)(*(mem)->procs.alloc_struct)(mem, &st_ht_cache, "alloc_ht_cache(struct)");

    byte *tbits =
        (*(mem)->procs.alloc_bytes)(mem, max_bits_size, "alloc_ht_cache(bits)");
    gx_ht_tile *ht_tiles =
        (gx_ht_tile *)(*(mem)->procs.alloc_struct_array)(mem, max_tiles, &st_ht_tiles, "alloc_ht_cache(ht_tiles)");
    ...
    ((pcache)->order.levels = 0, (pcache)->order.bit_data = 0, (pcache)->ht_tiles[0].tiles.data = 0);
    return pcache;
}
...
# 238 "./base/gxht.c"
    pdevc->colors.binary.b_tile = ((void*)0);
    return 0;
}
                               ...
                               const gx_rop_source_t * source)
{
    ...
    if (source == ((void*)0) && (((lop) & (0x200 | (rop3_1 - 0xcc))) == (0xf0 & ~0xcc)))
        return (*((dev)->procs.strip_tile_rectangle)) (dev,
    ...
    if (pdevc->colors.binary.color[0] == ((gx_color_index)(~0)))
        lop = (((lop) & ~(rop3_1 - 0xf0)) | (rop3_D & ~0xf0));
    if (pdevc->colors.binary.color[1] == ((gx_color_index)(~0)))
        lop = (((lop) & ~0xf0) | (rop3_D & 0xf0));
    if (source == ((void*)0))
                      ...
                      const gx_device_color * pdevc2)
{
    return pdevc2->type == pdevc1->type &&
        ...
        ((pdevc1)->colors.binary.color[0]) == ((pdevc2)->colors.binary.color[0]) &&
        ((pdevc1)->colors.binary.color[1]) == ((pdevc2)->colors.binary.color[1]) &&
    ...
    uint * psize )
{
    ...
    if ( psdc == 0 ||
        ...
        req_size += ( (uint)(pdevc->colors.binary.b_level) < (1U << 7) ? 1 : (uint)(pdevc->colors.binary.b_level) < (1U << (2 * 7)) ? 2 : enc_u_size_uint(pdevc->colors.binary.b_level) );
    }
    ...
    *pdata++ = (byte)flag_bits;
    ...
    if ((flag_bits & dc_ht_binary_has_level) != 0)
        do { if ((uint)(pdevc->colors.binary.b_level) < (1U << 7)) *(pdata)++ = (byte)(pdevc->colors.binary.b_level); else if ((uint)(pdevc->colors.binary.b_level) < (1U << (2 * 7))) { *(pdata)++ = (1U << 7) | ((pdevc->colors.binary.b_level) & ((1U << 7) - 1)); *(pdata)++ = (pdevc->colors.binary.b_level) >> 7; } else (pdata) = enc_u_put_uint((pdevc->colors.binary.b_level), (pdata)); } while (0);
    ...
    gs_memory_t * mem )
{
    ...
    if (prior_devc != 0 && prior_devc->type == (&gx_dc_type_data_ht_binary))
        devc = *prior_devc;
    else
        memset(&devc, 0, sizeof(devc));
    devc.type = (&gx_dc_type_data_ht_binary);
    ...
    if ((flag_bits & dc_ht_binary_has_level) != 0) {
        ...
        if (size < 1)
            return ((-15));
        do { if (((devc.colors.binary.b_level) = *(pdata)) >= (1U << 7)) { uint tmp_w; (pdata) = enc_u_get_uint(&tmp_w, (pdata)); (devc.colors.binary.b_level) = tmp_w; } else ++(pdata); } while (0);
...
{
    int code;
    gx_color_value cvals_0[(8 * 8)],
                            cvals_1[(8 * 8)];

    if ( (code = ((dev)->procs.decode_color)( (gx_device *)dev,
...
gx_ht_init_cache(const gs_memory_t *mem, gx_ht_cache * pcache, const gx_ht_order * porder)
{
    ...
    int width_unit =
    (width <= (sizeof(ht_mask_t) * 8) / 2 ? (sizeof(ht_mask_t) * 8) / width * width :
     width);
...
# 697 "./base/gxht.c"
        ...
        raster = ((uint)((((width_unit) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3));
