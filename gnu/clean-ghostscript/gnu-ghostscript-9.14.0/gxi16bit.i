...
# 23 "./base/gxi16bit.c" 2
# 1 "./base/gxfrac.h" 1
# 27 "./base/gxfrac.h"
typedef short frac;
typedef short signed_frac;
# 24 "./base/gxi16bit.c" 2
# 1 "./base/gxarith.h" 1
# 27 "./base/gxarith.h"
                 ...
                 int ignore_num_components_per_plane)
{
    ...
    while (left >= 2) {
        ...
        *bufp = (frac)((((frac)0x7ff8) * (sample + 1)) >> 16);
                 ...
                 int ignore_num_components_per_plane)
{
    ...
    while (left >= 2) {
        ...
        *bufp = (unsigned short)(sample);
        bufp = ( unsigned short *)((byte *)(bufp) + (spread));
        psrc += 2;
        left -= 2;
    }
    *pdata_x = 0;
