...
# 20 "./base/gxctable.c" 2
# 1 "./base/gxfrac.h" 1
# 27 "./base/gxfrac.h"
typedef short frac;
typedef short signed_frac;
# 21 "./base/gxctable.c" 2
# 1 "./base/gxctable.h" 1
# 39 "./base/gxctable.h"
                             ...
                             const gx_color_lookup_table * pclt, frac * pv)
{
    ...
    if (pclt->n > 3) {
        table += ((int)(((pi[0])+((1<<8)>>1)) >> (8))) * pdim[1];
        ++pi, ++pdim;
    } {
        int ic = ((int)(((pi[2])+((1<<8)>>1)) >> (8)));
        int ib = ((int)(((pi[1])+((1<<8)>>1)) >> (8)));
        int ia = ((int)(((pi[0])+((1<<8)>>1)) >> (8)));
                  ...
                  frac * pv, fixed factor)
{
    ...
    if (pclt->n > 3) {
        ...
        interpolate_accum(pi + 1, &clt3, pv, (1L << 8));
        if (ix == pdim[0] - 1)
            return;
        clt3.table += pdim[1];
        ...
        for (j = 0; j < m; ++j, ++pa0, ++pa1) {
            ...
            frac v00 = v000 +
                (frac) (((long)fc * (v001 - v000)) >> (8));

            frac v01 = v010 +
                (frac) (((long)fc * (v011 - v010)) >> (8));

            frac v10 = v100 +
                (frac) (((long)fc * (v101 - v100)) >> (8));

            frac v11 = v110 +
                (frac) (((long)fc * (v111 - v110)) >> (8));


            frac v0 = v00 +
                (frac) (((long)fb * (v01 - v00)) >> (8));

            frac v1 = v10 +
                (frac) (((long)fb * (v11 - v10)) >> (8));


            rv = v0 +
                (frac) (((long)fa * (v1 - v0)) >> (8));

            if (factor == (1L << 8))
                pv[j] = rv;
            else
                pv[j] += (frac) (((long)factor * (rv - pv[j])) >> (8));
...
gx_color_interpolate_linear(const fixed * pi,
                            const gx_color_lookup_table * pclt, frac * pv)
{
    interpolate_accum(pi, pclt, pv, (1L << 8));
}
