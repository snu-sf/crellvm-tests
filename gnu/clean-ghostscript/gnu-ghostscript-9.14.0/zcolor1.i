...
zcurrentblackgeneration(i_ctx_t *i_ctx_p)
{
    ...
    *op = ((int_gstate *)(((i_ctx_p->pgs))->client_data))->black_generation;
    return 0;
}
...
zcurrentcolortransfer(i_ctx_t *i_ctx_p)
{
    ...
    op[-3] = ((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.red;
    op[-2] = ((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.green;
    op[-1] = ((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.blue;
...
zcurrentundercolorremoval(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    *op = ((int_gstate *)(((i_ctx_p->pgs))->client_data))->undercolor_removal;
    return 0;
}
...
zsetblackgeneration(i_ctx_t *i_ctx_p)
{
    ...
    code = gs_setblackgeneration_remap((i_ctx_p->pgs), gs_mapped_transfer, ((bool)0));
    if (code < 0)
        return code;
    ((int_gstate *)(((i_ctx_p->pgs))->client_data))->black_generation = *op;
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (zcolor_remap_color), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
    return zcolor_remap_one(i_ctx_p, &((int_gstate *)(((i_ctx_p->pgs))->client_data))->black_generation,
                            (i_ctx_p->pgs)->black_generation, (i_ctx_p->pgs),
...
zsetcolortransfer(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( !(((&op[-3])->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))) ) return (check_proc_failed(&op[-3])); } while (0);
    do { if ( !(((&op[-2])->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))) ) return (check_proc_failed(&op[-2])); } while (0);
    do { if ( !(((&op[-1])->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))) ) return (check_proc_failed(&op[-1])); } while (0);
    do { if ( !(((&*op)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))) ) return (check_proc_failed(&*op)); } while (0);
    if ( (((i_ctx_p->op_stack).stack).top) - (((i_ctx_p->op_stack).stack).p) < (zcolor_remap_one_ostack * 4 - 4) ) { ((i_ctx_p->op_stack).stack).requested = (zcolor_remap_one_ostack * 4 - 4); return ((-16)); };
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (1 + zcolor_remap_one_estack * 4) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 1 + zcolor_remap_one_estack * 4); if ( es_code_ < 0 ) return es_code_; };
    ((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.red = op[-3];
    ((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.green = op[-2];
    ((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.blue = op[-1];
    ((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.gray = *op;
    if ((code = gs_setcolortransfer_remap((i_ctx_p->pgs),
    ...
    if ((code = zcolor_remap_one(i_ctx_p,
                                 ...
                                 (i_ctx_p->pgs)->set_transfer.red, (i_ctx_p->pgs),
                                 zcolor_remap_one_finish)) < 0 ||
        (code = zcolor_remap_one(i_ctx_p,
                                 &((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.green,
                                 (i_ctx_p->pgs)->set_transfer.green, (i_ctx_p->pgs),
                                 zcolor_remap_one_finish)) < 0 ||
        (code = zcolor_remap_one(i_ctx_p,
                                 &((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.blue,
                                 (i_ctx_p->pgs)->set_transfer.blue, (i_ctx_p->pgs),
                                 zcolor_remap_one_finish)) < 0 ||
        (code = zcolor_remap_one(i_ctx_p, &((int_gstate *)(((i_ctx_p->pgs))->client_data))->transfer_procs.gray,
                                 (i_ctx_p->pgs)->set_transfer.gray, (i_ctx_p->pgs),
                                 zcolor_remap_one_finish)) < 0
        )
        return code;
    return 5;
...
zsetundercolorremoval(i_ctx_t *i_ctx_p)
{
    ...
    if ( (((i_ctx_p->op_stack).stack).top) - (((i_ctx_p->op_stack).stack).p) < (zcolor_remap_one_ostack - 1) ) { ((i_ctx_p->op_stack).stack).requested = (zcolor_remap_one_ostack - 1); return ((-16)); };
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (1 + zcolor_remap_one_estack) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 1 + zcolor_remap_one_estack); if ( es_code_ < 0 ) return es_code_; };
    code = gs_setundercolorremoval_remap((i_ctx_p->pgs), gs_mapped_transfer, ((bool)0));
    if (code < 0)
        return code;
    ((int_gstate *)(((i_ctx_p->pgs))->client_data))->undercolor_removal = *op;
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (zcolor_remap_color), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
    return zcolor_remap_one(i_ctx_p, &((int_gstate *)(((i_ctx_p->pgs))->client_data))->undercolor_removal,
                            (i_ctx_p->pgs)->undercolor_removal, (i_ctx_p->pgs),
