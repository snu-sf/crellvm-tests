# 1 "./openjpeg/libopenjpeg/bio.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/bio.c" 2
# 32 "./openjpeg/libopenjpeg/bio.c"
...
# 33 "./openjpeg/libopenjpeg/bio.c" 2
# 45 "./openjpeg/libopenjpeg/bio.c"
...
opj_bio_t* opj_bio_create(void) {
 opj_bio_t *bio = (opj_bio_t*)((size_t)(sizeof(opj_bio_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_bio_t)));
 return bio;
}
