# 1 "./devices/gdevstc4.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/gdevstc4.c" 2
# 32 "./devices/gdevstc4.c"
   ...
   if(npixel > 0) {
                    ...
                    *p = *cp++;
                    ...
                    if (j != 0)
                    {
                        ...
                        *b += e - (l = (j>>2) - *fb);
                        ...
                        {
                            l += *bb;
                            if (l > 127) l = 127; if (l < -128) l = -128; if (l < 0) l += 256;
                            *q = l;
                        }
                    }
                    else
    ...
    escp2c_conv_stc(in, out, fullcolor_line_size);
      ...
      if(( sd->stc.dither == ((void*)0)) ||
         ((sd->stc.dither->flags & 24) != 8)) return -2;




      if((sd->stc.dither->flags/256) < 1) return -3;
