...
# 22 "./base/gsnotify.c" 2


static const gc_ptr_element_t notify_registration_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_notify_registration_t *)0)->proc_data - (char *)((gs_notify_registration_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_notify_registration_t *)0)->next - (char *)((gs_notify_registration_t *)0) )) } }; static const gc_struct_data_t notify_registration_reloc_ptrs = { (sizeof(notify_registration_enum_ptrs) / sizeof((notify_registration_enum_ptrs)[0])), 0, 0, notify_registration_enum_ptrs }; static const gs_memory_struct_type_t st_gs_notify_registration = { sizeof(gs_notify_registration_t), "gs_notify_registration_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &notify_registration_reloc_ptrs };
static const gc_ptr_element_t notify_list_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_notify_list_t *)0)->first - (char *)((gs_notify_list_t *)0) )) } }; static const gc_struct_data_t notify_list_reloc_ptrs = { (sizeof(notify_list_enum_ptrs) / sizeof((notify_list_enum_ptrs)[0])), 0, 0, notify_list_enum_ptrs }; const gs_memory_struct_type_t st_gs_notify_list = { sizeof(gs_notify_list_t), "gs_notify_list_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &notify_list_reloc_ptrs };
                   ...
                   void *proc_data)
{
    gs_notify_registration_t *nreg =
        (gs_notify_registration_t *)(*(nlist->memory)->procs.alloc_struct)(nlist->memory, &st_gs_notify_registration, "gs_notify_register");
    ...
    while ((cur = *prev) != 0)
        if (cur->proc == proc &&
            ...
            *prev = cur->next;
            ...
            ((nlist->memory)->procs.free_object(nlist->memory, cur, "gs_notify_unregister"));
            found = 1;
        } else
            prev = &cur->next;
    return found;
...
gs_notify_release(gs_notify_list_t *nlist)
{
    ...
    while (nlist->first) {
        ...
        ((mem)->procs.free_object(mem, nlist->first, "gs_notify_release"));
        nlist->first = next;
    }
}
