...
gc_locate(const void *ptr, gc_state_t * gcst)
{
    ...
    if ((((&gcst->loc)->cp != 0 && ((((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbase)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->cend))) && !(((&gcst->loc)->cp)->inner_count != 0 && (((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbot)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->ctop)))))) || chunk_locate_ptr(ptr, &gcst->loc)))
        return gcst->loc.cp;
    mem = gcst->loc.memory;
    ...
    if ((other = (const gs_ref_memory_t *)mem->stable_memory) != mem ||
        (other = gcst->spaces.memories.indexed[mem->space >> 2]) != mem
        ) {
    ...
    if (gcst->spaces.memories.named.local != gcst->spaces.memories.named.global) {
        gcst->loc.memory = other =
            (mem->space == avm_local ? gcst->spaces.memories.named.global : gcst->spaces.memories.named.local);
        gcst->loc.cp = 0;
        if ((((&gcst->loc)->cp != 0 && ((((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbase)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->cend))) && !(((&gcst->loc)->cp)->inner_count != 0 && (((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbot)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->ctop)))))) || chunk_locate_ptr(ptr, &gcst->loc)))
            return gcst->loc.cp;
    ...
    if (mem != gcst->spaces.memories.named.system) {
        gcst->loc.memory = gcst->spaces.memories.named.system;
        gcst->loc.cp = 0;
        if ((((&gcst->loc)->cp != 0 && ((((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbase)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->cend))) && !(((&gcst->loc)->cp)->inner_count != 0 && (((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbot)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->ctop)))))) || chunk_locate_ptr(ptr, &gcst->loc)))
            return gcst->loc.cp;
    }
    ...
    switch (mem->space) {
    default:
        other = gcst->spaces.memories.named.global;
        if (other->stable_memory != (const gs_memory_t *)other) {
            gcst->loc.memory = (gs_ref_memory_t *)other->stable_memory;
            gcst->loc.cp = 0;
            if ((((&gcst->loc)->cp != 0 && ((((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbase)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->cend))) && !(((&gcst->loc)->cp)->inner_count != 0 && (((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbot)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->ctop)))))) || chunk_locate_ptr(ptr, &gcst->loc)))
        ...
        break;
    case avm_global:
        gcst->loc.memory = gcst->spaces.memories.named.global;
        break;
    case avm_local:
        gcst->loc.memory = gcst->spaces.memories.named.local;
        break;
    }
    for (;;) {
        if (gcst->loc.memory != mem) {
            gcst->loc.cp = 0;
            if ((((&gcst->loc)->cp != 0 && ((((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbase)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->cend))) && !(((&gcst->loc)->cp)->inner_count != 0 && (((ptr_ord_t)((const byte *)(ptr)) >= (ptr_ord_t)(((&gcst->loc)->cp)->cbot)) && ((ptr_ord_t)((const byte *)(ptr)) < (ptr_ord_t)(((&gcst->loc)->cp)->ctop)))))) || chunk_locate_ptr(ptr, &gcst->loc)))
                return gcst->loc.cp;
        }
