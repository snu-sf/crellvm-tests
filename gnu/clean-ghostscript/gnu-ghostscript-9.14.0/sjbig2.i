...
# 27 "./base/sjbig2.c" 2
# 39 "./base/sjbig2.c"
static const gc_ptr_element_t jbig2decode_state_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((stream_jbig2decode_state *)0)->global_struct - (char *)((stream_jbig2decode_state *)0) )) } }; static const gc_struct_data_t jbig2decode_state_reloc_ptrs = { (sizeof(jbig2decode_state_enum_ptrs) / sizeof((jbig2decode_state_enum_ptrs)[0])), 0, 0, jbig2decode_state_enum_ptrs }; static const gs_memory_struct_type_t st_jbig2decode_state = { sizeof(stream_jbig2decode_state), "jbig2decode filter state", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &jbig2decode_state_reloc_ptrs };
               ...
               int32_t seg_idx)
{
    ...
    switch (severity) {
        ...
        case JBIG2_SEVERITY_FATAL:
            ...
            code = (-12);
            if (state != ((void*)0)) state->error = code;
            break;;
    ...
    if (state)
    {
        if (severity == JBIG2_SEVERITY_FATAL) {
            (dmprintf_file_and_line(state->memory,"./base/sjbig2.c", 73), errprintf(state->memory,"jbig2dec %s %s %s\n", type, msg, segment));
        } else {
            do { } while (0);
        }
    }
    else
    {
        ...
        if (severity == JBIG2_SEVERITY_FATAL) {
            (dprintf_file_and_line("./base/sjbig2.c", 85), errprintf_nomem("jbig2dec %s %s %s\n", type, msg, segment));
        } else {
            do { } while (0);
        }
    }
...
s_jbig2decode_make_global_data(byte *data, uint length, void **result)
{
    ...
    ctx = jbig2_ctx_new(((void*)0), JBIG2_OPTIONS_EMBEDDED, ((void*)0),
                            s_jbig2decode_error, ((void*)0));
...
s_jbig2decode_init(stream_state * ss)
{
    ...
    state->decode_ctx = jbig2_ctx_new(((void*)0), JBIG2_OPTIONS_EMBEDDED,
                  ...
                  stream_cursor_write * pw, bool last)
{
    ...
    if (out_size > 0) {
        ...
        if (image != ((void*)0)) {
            ...
            long usable = (((image_size - state->offset) < (out_size)) ? (image_size - state->offset) : (out_size));
...
s_jbig2decode_set_defaults(stream_state *ss)
{
    ...
    state->global_struct = ((void*)0);
    state->global_ctx = ((void*)0);
    state->decode_ctx = ((void*)0);
    state->image = ((void*)0);
    state->offset = 0;
    state->error = 0;
}
