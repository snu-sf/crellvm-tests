...
# 34 "./psi/zfunc4.c" 2
# 49 "./psi/zfunc4.c"
int zabs(i_ctx_t *); int zand(i_ctx_t *); int zatan(i_ctx_t *); int zbitshift(i_ctx_t *);
int zceiling(i_ctx_t *); int zcos(i_ctx_t *); int zcvi(i_ctx_t *); int zcvr(i_ctx_t *);
int zdiv(i_ctx_t *); int zexp(i_ctx_t *); int zfloor(i_ctx_t *); int zidiv(i_ctx_t *);
int zln(i_ctx_t *); int zlog(i_ctx_t *); int zmod(i_ctx_t *); int zmul(i_ctx_t *);
int zneg(i_ctx_t *); int znot(i_ctx_t *); int zor(i_ctx_t *); int zround(i_ctx_t *);
int zsin(i_ctx_t *); int zsqrt(i_ctx_t *); int ztruncate(i_ctx_t *); int zxor(i_ctx_t *);
int zeq(i_ctx_t *); int zge(i_ctx_t *); int zgt(i_ctx_t *); int zle(i_ctx_t *); int zlt(i_ctx_t *); int zne(i_ctx_t *);
int z2copy(i_ctx_t *);
...
{
    if (!(((pref)->tas.type_attrs) & (0x80)))
        return ((bool)0);
    if (((pref)->tas.type_attrs >= (t_next_index << 8) ? t_operator : (((const byte *)&((pref)->tas.type_attrs))[1])) == t_operator) {
        return pref->value.opproc == proc;
    } else if (((pref)->tas.type_attrs >= (t_next_index << 8) ? t_operator : (((const byte *)&((pref)->tas.type_attrs))[1])) == t_name) {
        ref * val;
        if (dict_find((&(i_ctx_p->dict_stack).system_dict), pref, &val) <= 0)
            return ((bool)0);
        if (((val)->tas.type_attrs >= (t_next_index << 8) ? t_operator : (((const byte *)&((val)->tas.type_attrs))[1])) != t_operator)
            return ((bool)0);
        if (!(((val)->tas.type_attrs) & (0x80)))
            return ((bool)0);
...
# 235 "./psi/zfunc4.c"
        ...
        p = ops;
        sz = *psize;
        if(array_get(((gs_memory_t *)((i_ctx_p->memory).current)), pref, 0, &r_tp) < 0)
            goto idiom_failed;
        if (array_get(((gs_memory_t *)((i_ctx_p->memory).current)), pref, 1, &r_cttf) < 0)
            goto idiom_failed;
        if (((((const byte *)&((&r_tp)->tas.type_attrs))[1]) == (t_name)) && ((((const byte *)&((&r_cttf)->tas.type_attrs))[1]) == (t_name))) {
            if ((code = names_enter_string(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, "tint_params", &n_tp)) < 0)
                return code;
            if (r_tp.value.pname == n_tp.value.pname) {
                if ((code = names_enter_string(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, "CorelTintTransformFunction", &n_cttf)) < 0)
                    return code;
                if (r_cttf.value.pname == n_cttf.value.pname) {
                    v_tp = dstack_find_name_by_index(&(i_ctx_p->dict_stack), names_index(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, &n_tp));
                    v_cttf = dstack_find_name_by_index(&(i_ctx_p->dict_stack), names_index(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, &n_cttf));
                    if (v_tp && v_cttf && (((v_tp)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0))) && (((v_cttf)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0)))) {
                        uint n_elem = ((v_tp)->tas.rsize);

                        if ((n_elem & 3) == 0 && ((v_cttf)->tas.rsize) == 31) {
                            ...
                            for (i = 0; i < 4; i ++) {
                                ...
                                for (j = 0; j < n_col; j++) {
                                    if (array_get(((gs_memory_t *)((i_ctx_p->memory).current)), v_tp, j*4 + i, &v) < 0)
                                        goto idiom_failed;
                                    if ((((const byte *)&((&v)->tas.type_attrs))[1]) == t_integer)
                                        fv = (float)v.value.intval;
                                    else if ((((const byte *)&((&v)->tas.type_attrs))[1]) == t_real)
                                        fv = v.value.realval;
                                    else
                                        goto idiom_failed;
  ...
  idiom_failed:;
    for (i = 0; i < size; ++i) {
        byte no_ops[1 + (((sizeof(int)) > (sizeof(float))) ? (sizeof(int)) : (sizeof(float)))];
        ref elt, elt2, elt3;
        ref * delp;

        p = (ops ? ops + *psize : no_ops);
        array_get(((gs_memory_t *)((i_ctx_p->memory).current)), pref, i, &elt);
        switch (((&elt)->tas.type_attrs >= (t_next_index << 8) ? t_operator : (((const byte *)&((&elt)->tas.type_attrs))[1]))) {
        case t_integer:
        ...
        case t_boolean:
            *p = (elt.value.boolval ? PtCr_true : PtCr_false);
            ...
            break;
        case t_name:
            if (!(((&elt)->tas.type_attrs) & (0x80)))
                return ((-15));
            names_string_ref(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, &elt, &elt);
            if (!bytes_compare(elt.value.bytes, ((&elt)->tas.rsize),
                               (const byte *)"true", 4)) {
                *p = PtCr_true;
                ++*psize;
                break;
            ...
            if (dict_find((&(i_ctx_p->dict_stack).system_dict), &elt, &delp) <= 0)
                return ((-21));
            if (((delp)->tas.type_attrs >= (t_next_index << 8) ? t_operator : (((const byte *)&((delp)->tas.type_attrs))[1])) != t_operator)
                return ((-20));
            if (!(((delp)->tas.type_attrs) & (0x80)))
                return ((-15));
            elt = *delp;
        ...
        default: {
            if (!(((&elt)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))))
                return ((-20));
            if (depth == 10)
                return ((-13));
            if ((code = array_get(((gs_memory_t *)((i_ctx_p->memory).current)), pref, ++i, &elt2)) < 0)
                return code;
            *psize += 3;
            ...
            if (resolves_to_oper(i_ctx_p, &elt2, zrepeat)) {
                ...
                code = gs_get_device_or_hw_params(i_ctx_p->pgs->device, (gs_param_list *)&list, ((bool)0));
                if (code < 0)
                    return code;
            ...
            } else if (!(((&elt2)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))))
                return ((-15));
            else if ((code = array_get(((gs_memory_t *)((i_ctx_p->memory).current)), pref, ++i, &elt3)) < 0)
                return code;
...
int gs_build_function_4(i_ctx_t *i_ctx_p, const ref *op, const gs_function_params_t *params, int depth, gs_function_t **ppfn, gs_memory_t *mem);
                    ...
                    int depth, gs_function_t ** ppfn, gs_memory_t *mem)
{
    ...
    *(gs_function_params_t *)&params = *mnDR;
    ...
    if (!(((proc)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80)))) {
        code = ((-20));
        goto fail;
    }
    size = 0;
    code = check_psc_function(i_ctx_p, proc, 0, ((void*)0), &size);
    if (code < 0)
        goto fail;
    ops = (*(mem)->procs.alloc_string)(mem, size + 1, "gs_build_function_4(ops)");
    if (ops == 0) {
        code = ((-25));
        goto fail;
    }
    size = 0;
    check_psc_function(i_ctx_p, proc, 0, ops, &size);
...
int make_type4_function(i_ctx_t * i_ctx_p, ref *arr, ref *pproc, gs_function_t **func)
{
    ...
    if (code < 0)
        return code;
    ptr = (float *)(*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_byte_array)(((gs_memory_t *)((i_ctx_p->memory).current)), num_components * 2, sizeof(float), "make_type4_function(Domain)");
    if (!ptr)
        return (-25);
    code = space->domain(i_ctx_p, arr, ptr);
    if (code < 0) {
        gs_free_const_object(((gs_memory_t *)((i_ctx_p->memory).current)), ptr, "make_type4_function(Domain)");
        return code;
    }
    params.Domain = ptr;
    ...
    ptr = (float *)(*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_byte_array)(((gs_memory_t *)((i_ctx_p->memory).current)), num_components * 2, sizeof(float), "make_type4_function(Range)");
    if (!ptr) {
        gs_free_const_object(((gs_memory_t *)((i_ctx_p->memory).current)), params.Domain, "make_type4_function(Domain)");
        return (-25);
    }
    ...
    if (code < 0) {
        gs_free_const_object(((gs_memory_t *)((i_ctx_p->memory).current)), ptr, "make_type4_function(Domain)");
        gs_free_const_object(((gs_memory_t *)((i_ctx_p->memory).current)), params.Domain, "make_type4_function(Range)");
        return code;
    }
    params.Range = ptr;
    ...
    params.ops.size = 0;
    size = 0;
    code = check_psc_function(i_ctx_p, (const ref *)pproc, 0, ((void*)0), &size);
    if (code < 0) {
        gs_function_PtCr_free_params(&params, ((gs_memory_t *)((i_ctx_p->memory).current)));
        return code;
    }
    ops = (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_string)(((gs_memory_t *)((i_ctx_p->memory).current)), size + 1, "make_type4_function(ops)");
    size = 0;
    check_psc_function(i_ctx_p, (const ref *)pproc, 0, ops, &size);
    ops[size] = PtCr_return;
    params.ops.data = ops;
    params.ops.size = size + 1;
    code = gs_function_PtCr_init(func, &params, ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (code < 0)
        gs_function_PtCr_free_params(&params, ((gs_memory_t *)((i_ctx_p->memory).current)));
