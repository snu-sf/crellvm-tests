...
static const gc_ptr_element_t gs_color_index_cache_elem_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_index_cache_t *)0)->direct_space - (char *)((gs_color_index_cache_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_index_cache_t *)0)->memory - (char *)((gs_color_index_cache_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_index_cache_t *)0)->buf - (char *)((gs_color_index_cache_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_index_cache_t *)0)->paint_values - (char *)((gs_color_index_cache_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_index_cache_t *)0)->frac_values - (char *)((gs_color_index_cache_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_color_index_cache_t *)0)->trans_dev - (char *)((gs_color_index_cache_t *)0) )) } }; static const gc_struct_data_t gs_color_index_cache_reloc_ptrs = { (sizeof(gs_color_index_cache_elem_ptrs) / sizeof((gs_color_index_cache_elem_ptrs)[0])), 0, 0, gs_color_index_cache_elem_ptrs }; static const gs_memory_struct_type_t st_color_index_cache = { sizeof(gs_color_index_cache_t), "gs_color_index_cache_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &gs_color_index_cache_reloc_ptrs };
...
{
    int client_num_components = (*(direct_space)->type->num_components)(direct_space);
    int device_num_components = trans_dev->color_info.num_components;
    gs_color_index_cache_elem_t *buf = ( gs_color_index_cache_elem_t *)(*(memory)->procs.alloc_byte_array)(memory, 256, sizeof(gs_color_index_cache_elem_t), "gs_color_index_cache_create");

    float *paint_values = (float *)(*(memory)->procs.alloc_byte_array)(memory, 256 * client_num_components, sizeof(float), "gs_color_index_cache_create");

    frac31 *frac_values = (need_frac ? (frac31 *)(*(memory)->procs.alloc_byte_array)(memory, 256 * device_num_components, sizeof(frac31), "gs_color_index_cache_create") : ((void*)0));

    gs_color_index_cache_t *pcic = (gs_color_index_cache_t *)(*(memory)->procs.alloc_struct)(memory, &st_color_index_cache, "gs_color_index_cache_create");

    if (buf == ((void*)0) || paint_values == ((void*)0) || (need_frac && frac_values == ((void*)0)) || pcic == ((void*)0)) {
        ((memory)->procs.free_object(memory, buf, "gs_color_index_cache_create"));
        ((memory)->procs.free_object(memory, paint_values, "gs_color_index_cache_create"));
        ((memory)->procs.free_object(memory, frac_values, "gs_color_index_cache_create"));
        ((memory)->procs.free_object(memory, pcic, "gs_color_index_cache_create"));
        return ((void*)0);
    }
    memset(pcic, 0, sizeof(*pcic));
    memset(buf, 0, 256 * sizeof(gs_color_index_cache_elem_t));
...
{
    ((pcic->memory)->procs.free_object(pcic->memory, pcic->buf, "gs_color_index_cache_create"));
    ((pcic->memory)->procs.free_object(pcic->memory, pcic->paint_values, "gs_color_index_cache_create"));
    ((pcic->memory)->procs.free_object(pcic->memory, pcic->frac_values, "gs_color_index_cache_create"));
    pcic->buf = ((void*)0);
    pcic->paint_values = ((void*)0);
    pcic->frac_values = ((void*)0);
    ((pcic->memory)->procs.free_object(pcic->memory, pcic, "gs_color_index_cache_create"));
}
                           ...
                           const float *paint_values, uint *pi)
{
    ...
    if (self->used < 256) {
        ...
        i = self->recent_touch;
        self->recent_touch = self->buf[i].touch_prev;
...
compute_frac_values(gs_color_index_cache_t *self, uint i)
{
    ...
    if (self->buf[i].color_type == &gx_dc_type_data_pure) {
        ...
        self->buf[i].frac_values_done = ((bool)1);
    } else {

        for (j = 0; j < device_num_components; j++) {
            self->frac_values[i * device_num_components + j] =
                ((frac)( ((self->buf[i].color.devn[j]) >> (((1 << 1) * 8) - 15)) - ((self->buf[i].color.devn[j]) >> (((1 << 1) * 8) - 3)) ));
        }
        self->buf[i].frac_values_done = ((bool)1);
    }
}
                      ...
                      gx_device_color *pdevc, frac31 *frac_values)
{
    ...
    if (get_color_index_cache_elem(self, paint_values, &i)) {
        if (pdevc != ((void*)0)) {
            ...
            pdevc->ccolor_valid = ((bool)1);
        }
        if (frac_values != ((void*)0) && !self->buf[i].frac_values_done)
        ...
        if (frac_values != ((void*)0))
            ...
            self->buf[i].frac_values_done = ((bool)0);
    }
    if (frac_values != ((void*)0))
