# 1 "./lcms2/src/cmsvirt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmsvirt.c" 2
# 27 "./lcms2/src/cmsvirt.c"
...
cmsBool SetSeqDescTag(cmsHPROFILE hProfile, const char* Model)
{
    ...
    cmsMLUsetASCII( Seq->seq[0].Manufacturer, "\0\0", "\0\0", "Little CMS");
    cmsMLUsetASCII( Seq->seq[0].Model, "\0\0", "\0\0", Model);
                                          ...
                                          cmsToneCurve* const TransferFunction[3])
{
    ...
    cmsSetHeaderRenderingIntent(hICC, 0);
# 141 "./lcms2/src/cmsvirt.c"
    ...
    if (WhitePoint) {
        ...
        _cmsAdaptationMatrix(&CHAD, ((void*)0), &WhitePointXYZ, cmsD50_XYZ());
...
cmsHPROFILE cmsCreateRGBProfile(const cmsCIExyY* WhitePoint,
                                          ...
                                          cmsToneCurve* const TransferFunction[3])
{
    return cmsCreateRGBProfileTHR(((void*)0), WhitePoint, Primaries, TransferFunction);
}
...
cmsHPROFILE cmsCreateGrayProfile(const cmsCIExyY* WhitePoint,
                                                    const cmsToneCurve* TransferFunction)
{
    return cmsCreateGrayProfileTHR(((void*)0), WhitePoint, TransferFunction);
}
...
cmsHPROFILE cmsCreateLinearizationDeviceLink(cmsColorSpaceSignature ColorSpace,
                                                                 cmsToneCurve* const TransferFunctions[])
{
    return cmsCreateLinearizationDeviceLinkTHR(((void*)0), ColorSpace, TransferFunctions);
}
# 363 "./lcms2/src/cmsvirt.c"
static
int InkLimitingSampler(register const cmsUInt16Number In[], register cmsUInt16Number Out[], register void* Cargo)
{
    ...
    Out[0] = _cmsQuickSaturateWord(In[0] * Ratio);
    Out[1] = _cmsQuickSaturateWord(In[1] * Ratio);
    Out[2] = _cmsQuickSaturateWord(In[2] * Ratio);
                                                     ...
                                                     cmsFloat64Number Limit)
{
    ...
    if (ColorSpace != cmsSigCmykData) {
        cmsSignalError(ContextID, 9, "InkLimiting: Only CMYK currently supported");
        return ((void*)0);
    }

    if (Limit < 0.0 || Limit > 400) {

        cmsSignalError(ContextID, 2, "InkLimiting: Limit should be between 0..400");
        if (Limit < 0) Limit = 0;
    ...
    CLUT = cmsStageAllocCLut16bit(ContextID, 17, nChannels, nChannels, ((void*)0));
...
cmsHPROFILE cmsCreateInkLimitingDeviceLink(cmsColorSpaceSignature ColorSpace, cmsFloat64Number Limit)
{
    return cmsCreateInkLimitingDeviceLinkTHR(((void*)0), ColorSpace, Limit);
}
...
cmsHPROFILE cmsCreateLab2ProfileTHR(cmsContext ContextID, const cmsCIExyY* WhitePoint)
{
    ...
    hProfile = cmsCreateRGBProfileTHR(ContextID, WhitePoint == ((void*)0) ? cmsD50_xyY() : WhitePoint, ((void*)0), ((void*)0));
    ...
    if (!SetTextTags(hProfile, L"Lab identity built-in")) return ((void*)0);
...
cmsHPROFILE cmsCreateLab2Profile(const cmsCIExyY* WhitePoint)
{
    return cmsCreateLab2ProfileTHR(((void*)0), WhitePoint);
}
...
cmsHPROFILE cmsCreateLab4Profile(const cmsCIExyY* WhitePoint)
{
    return cmsCreateLab4ProfileTHR(((void*)0), WhitePoint);
}
...
cmsHPROFILE cmsCreateXYZProfileTHR(cmsContext ContextID)
{
    ...
    hProfile = cmsCreateRGBProfileTHR(ContextID, cmsD50_xyY(), ((void*)0), ((void*)0));
    if (hProfile == ((void*)0)) return ((void*)0);
...
cmsHPROFILE cmsCreateXYZProfile(void)
{
    return cmsCreateXYZProfileTHR(((void*)0));
}
# 628 "./lcms2/src/cmsvirt.c"
static
...
cmsHPROFILE cmsCreate_sRGBProfile(void)
{
    return cmsCreate_sRGBProfileTHR(((void*)0));
}
    ...
    int TempDest)
{
    ...
    for (i=0; i < 8; i++) Dimensions[i] = nLUTPoints;
    CLUT = cmsStageAllocCLut16bitGranular(ContextID, Dimensions, 3, 3, ((void*)0));
    ...
    if (!SetTextTags(hICC, L"BCHS built-in")) return ((void*)0);
...
Error:
    ...
    return ((void*)0);
       ...
       cmsHPROFILE cmsCreateBCHSWabstractProfile(int nLUTPoints,
                                                             ...
                                                             int TempDest)
{
    return cmsCreateBCHSWabstractProfileTHR(((void*)0), nLUTPoints, Bright, Contrast, Hue, Saturation, TempSrc, TempDest);
}
...
cmsHPROFILE cmsCreateNULLProfile(void)
{
    return cmsCreateNULLProfileTHR(((void*)0));
}
...
cmsHPROFILE CreateNamedColorDevicelink(cmsHTRANSFORM xform)
{
    ...
    cmsHPROFILE hICC = ((void*)0);
    int i, nColors;
    cmsNAMEDCOLORLIST *nc2 = ((void*)0), *Original = ((void*)0);


    hICC = cmsCreateProfilePlaceholder(v->ContextID);
    if (hICC == ((void*)0)) return ((void*)0);
    ...
    if (Original == ((void*)0)) goto Error;

    nColors = cmsNamedColorCount(Original);
    nc2 = cmsDupNamedColorList(Original);
    if (nc2 == ((void*)0)) goto Error;


    nc2 ->ColorantCount = cmsPipelineOutputChannels(v ->Lut);


    cmsChangeBuffersFormat(xform, (((1) << 3)|(2)),
        ((0) << 22) | ((_cmsLCMScolorSpace(v ->ExitColorSpace)) << 16)
        | (2) | ((cmsChannelsOf(v ->ExitColorSpace)) << 3));
...
Error:
    if (hICC != ((void*)0)) cmsCloseProfile(hICC);
    return ((void*)0);
}
...
typedef struct {
    cmsBool IsV4;
    cmsTagSignature RequiredTag;
    cmsTagTypeSignature LutType;
    int nTypes;
    cmsStageSignature MpeTypes[5];

} cmsAllowedLUT;

static const cmsAllowedLUT AllowedLUTTypes[] = {

    { 0, 0, cmsSigLut16Type, 4, { cmsSigMatrixElemType, cmsSigCurveSetElemType, cmsSigCLutElemType, cmsSigCurveSetElemType}},
    { 0, 0, cmsSigLut16Type, 3, { cmsSigCurveSetElemType, cmsSigCLutElemType, cmsSigCurveSetElemType}},
    { 0, 0, cmsSigLut16Type, 2, { cmsSigCurveSetElemType, cmsSigCLutElemType}},
    { 1 , 0, cmsSigLutAtoBType, 1, { cmsSigCurveSetElemType }},
    { 1 , cmsSigAToB0Tag, cmsSigLutAtoBType, 3, { cmsSigCurveSetElemType, cmsSigMatrixElemType, cmsSigCurveSetElemType } },
    { 1 , cmsSigAToB0Tag, cmsSigLutAtoBType, 3, { cmsSigCurveSetElemType, cmsSigCLutElemType, cmsSigCurveSetElemType } },
    { 1 , cmsSigAToB0Tag, cmsSigLutAtoBType, 5, { cmsSigCurveSetElemType, cmsSigCLutElemType, cmsSigCurveSetElemType, cmsSigMatrixElemType, cmsSigCurveSetElemType }},
    { 1 , cmsSigBToA0Tag, cmsSigLutBtoAType, 1, { cmsSigCurveSetElemType }},
    { 1 , cmsSigBToA0Tag, cmsSigLutBtoAType, 3, { cmsSigCurveSetElemType, cmsSigMatrixElemType, cmsSigCurveSetElemType }},
    { 1 , cmsSigBToA0Tag, cmsSigLutBtoAType, 3, { cmsSigCurveSetElemType, cmsSigCLutElemType, cmsSigCurveSetElemType }},
    { 1 , cmsSigBToA0Tag, cmsSigLutBtoAType, 5, { cmsSigCurveSetElemType, cmsSigMatrixElemType, cmsSigCurveSetElemType, cmsSigCLutElemType, cmsSigCurveSetElemType }}
};
...
cmsBool CheckOne(const cmsAllowedLUT* Tab, const cmsPipeline* Lut)
{
    ...
    for (n=0, mpe = Lut ->Elements; mpe != ((void*)0); mpe = mpe ->Next, n++) {
        ...
        if (n > Tab ->nTypes) return 0;
        if (cmsStageType(mpe) != Tab ->MpeTypes[n]) return 0;
    }
...
const cmsAllowedLUT* FindCombination(const cmsPipeline* Lut, cmsBool IsV4, cmsTagSignature DestinationTag)
{
    ...
    for (n=0; n < (sizeof(AllowedLUTTypes)/sizeof(cmsAllowedLUT)); n++) {
...
cmsHPROFILE cmsTransform2DeviceLink(cmsHTRANSFORM hTransform, cmsFloat64Number Version, cmsUInt32Number dwFlags)
{
    ...
    (((hTransform != ((void*)0))) ? (void) (0) : __assert_fail ("(hTransform != ((void*)0))", "./lcms2/src/cmsvirt.c", 1058, __PRETTY_FUNCTION__));
    ...
    FrmIn = ((ColorSpaceBitsIn) << 16) | ((ChansIn) << 3)|(2);
    FrmOut = ((ColorSpaceBitsOut) << 16) | ((ChansOut) << 3)|(2);
    ...
    if (xform -> InputColorant != ((void*)0)) {
           if (!cmsWriteTag(hProfile, cmsSigColorantTableTag, xform->InputColorant)) goto Error;
    }

    if (xform -> OutputColorant != ((void*)0)) {
           if (!cmsWriteTag(hProfile, cmsSigColorantTableOutTag, xform->OutputColorant)) goto Error;
    }

    if ((deviceClass == cmsSigLinkClass) && (xform ->Sequence != ((void*)0))) {
...
Error:
    if (LUT != ((void*)0)) cmsPipelineFree(LUT);
    cmsCloseProfile(hProfile);
    return ((void*)0);
}
