...
static const gc_ptr_element_t shading_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_shading_t *)0)->params.ColorSpace - (char *)((gs_shading_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_shading_t *)0)->params.cie_joint_caches - (char *)((gs_shading_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_shading_t *)0)->params.Background - (char *)((gs_shading_t *)0) )) } }; static const gc_struct_data_t shading_reloc_ptrs = { (sizeof(shading_enum_ptrs) / sizeof((shading_enum_ptrs)[0])), 0, 0, shading_enum_ptrs }; static const gs_memory_struct_type_t st_shading = { sizeof(gs_shading_t), "gs_shading_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &shading_reloc_ptrs };
static gs_ptr_type_t shading_mesh_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void shading_mesh_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static const gs_memory_struct_type_t st_shading_mesh = { sizeof(gs_shading_mesh_t), "gs_shading_mesh_t", 0, 0, shading_mesh_enum_ptrs, shading_mesh_reloc_ptrs, 0, 0 };

static
gs_ptr_type_t shading_mesh_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_shading_mesh_t *psm = vptr; switch ( index ) { default:
{
    index -= 2;
    if (index < 1)
        return (*(st_data_source).enum_ptrs)(mem, &psm->params.DataSource, sizeof(psm->params.DataSource), index, pep, &(st_data_source), gcst);

    return (*(st_shading).enum_ptrs)(mem, vptr, size, index-(1), pep, &(st_shading), gcst);
}
case 0: return (pep->ptr = (const void *)(((const gs_shading_mesh_t *)vptr)->params.Function), (&ptr_struct_procs)); case (0)+1: return (pep->ptr = (const void *)(((const gs_shading_mesh_t *)vptr)->params.Decode), (&ptr_struct_procs));
} }

static
void shading_mesh_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_shading_mesh_t *psm = vptr;
{
    (*(st_shading).reloc_ptrs)(vptr, size, &(st_shading), gcst);
    (*(st_data_source).reloc_ptrs)(&psm->params.DataSource, sizeof(psm->params.DataSource), &(st_data_source), gcst);

    (((gs_shading_mesh_t *)vptr)->params.Function = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_shading_mesh_t *)vptr)->params.Function), gcst))); (((gs_shading_mesh_t *)vptr)->params.Decode = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_shading_mesh_t *)vptr)->params.Decode), gcst)));
}
}
...
{
    if (((*pds).type == data_source_type_floats))
        return 2;
    switch (bpf) {
...
shading_params_init(gs_shading_params_t *params)
{
    ...
    params->Background = 0;
    params->have_BBox = ((bool)0);
    params->AntiAlias = ((bool)0);
}
...
{
    shading_params_init((gs_shading_params_t *)params);
    ((&params->DataSource)->type = data_source_type_floats, (&params->DataSource)->data.str.data = (byte *)((void*)0), (&params->DataSource)->data.str.size = (0) * sizeof(float), (&params->DataSource)->access = data_source_access_bytes);
...
# 173 "./base/gsshade.c"
static const gc_ptr_element_t shading_Fb_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_shading_Fb_t *)0)->params.Function - (char *)((gs_shading_Fb_t *)0) )) } }; static const gc_struct_data_t shading_Fb_reloc_ptrs = { (sizeof(shading_Fb_enum_ptrs) / sizeof((shading_Fb_enum_ptrs)[0])), 0, &st_shading, shading_Fb_enum_ptrs }; static const gs_memory_struct_type_t st_shading_Fb = { sizeof(gs_shading_Fb_t), "gs_shading_Fb_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &shading_Fb_reloc_ptrs };
                   ...
                   const gs_shading_Fb_params_t * params, gs_memory_t * mem)
{
    ...
    if (code < 0 ||
        ...
        return code;
    do { psh = (void *)(*(mem)->procs.alloc_struct)(mem, &st_shading_Fb, "gs_shading_Fb_init"); if ( psh == 0 ) return ((-25)); psh->head.type = shading_type_Function_based; psh->head.procs = shading_Fb_procs; psh->params = *params; *ppsh = (gs_shading_t *)psh; } while (0);
...
static const gc_ptr_element_t shading_A_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_shading_A_t *)0)->params.Function - (char *)((gs_shading_A_t *)0) )) } }; static const gc_struct_data_t shading_A_reloc_ptrs = { (sizeof(shading_A_enum_ptrs) / sizeof((shading_A_enum_ptrs)[0])), 0, &st_shading, shading_A_enum_ptrs }; static const gs_memory_struct_type_t st_shading_A = { sizeof(gs_shading_A_t), "gs_shading_A_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &shading_A_reloc_ptrs };
...
gs_shading_A_params_init(gs_shading_A_params_t * params)
{
    ...
    params->Domain[1] = 1;
    params->Function = 0;
    params->Extend[0] = params->Extend[1] = ((bool)0);
}
                  ...
                  const gs_shading_A_params_t * params, gs_memory_t * mem)
{
    ...
    if (code < 0)
        return code;
    do { psh = (void *)(*(mem)->procs.alloc_struct)(mem, &st_shading_A, "gs_shading_A_init"); if ( psh == 0 ) return ((-25)); psh->head.type = shading_type_Axial; psh->head.procs = shading_A_procs; psh->params = *params; *ppsh = (gs_shading_t *)psh; } while (0);
...
static const gc_ptr_element_t shading_R_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_shading_R_t *)0)->params.Function - (char *)((gs_shading_R_t *)0) )) } }; static const gc_struct_data_t shading_R_reloc_ptrs = { (sizeof(shading_R_enum_ptrs) / sizeof((shading_R_enum_ptrs)[0])), 0, &st_shading, shading_R_enum_ptrs }; static const gs_memory_struct_type_t st_shading_R = { sizeof(gs_shading_R_t), "gs_shading_R_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &shading_R_reloc_ptrs };
                  ...
                  const gs_shading_R_params_t * params, gs_memory_t * mem)
{
    ...
    if ((params->Domain != 0 && params->Domain[0] == params->Domain[1]) ||
        ...
        return ((-15));
    do { psh = (void *)(*(mem)->procs.alloc_struct)(mem, &st_shading_R, "gs_shading_R_init"); if ( psh == 0 ) return ((-25)); psh->head.type = shading_type_Radial; psh->head.procs = shading_R_procs; psh->params = *params; *ppsh = (gs_shading_t *)psh; } while (0);
...
static const gs_memory_struct_type_t st_shading_FfGt = { sizeof(gs_shading_FfGt_t), "gs_shading_FfGt_t", 0, 0, shading_mesh_enum_ptrs, shading_mesh_reloc_ptrs, 0, 0 };
                     ...
                     gs_memory_t * mem)
{
    ...
    if (bpf < 0)
        return bpf;
    do { psh = (void *)(*(mem)->procs.alloc_struct)(mem, &st_shading_FfGt, "gs_shading_FfGt_init"); if ( psh == 0 ) return ((-25)); psh->head.type = shading_type_Free_form_Gouraud_triangle; psh->head.procs = shading_FfGt_procs; psh->params = *params; *ppsh = (gs_shading_t *)psh; } while (0);
...
static const gs_memory_struct_type_t st_shading_LfGt = { sizeof(gs_shading_LfGt_t), "gs_shading_LfGt_t", 0, 0, shading_mesh_enum_ptrs, shading_mesh_reloc_ptrs, 0, 0 };
                 ...
                 const gs_shading_LfGt_params_t * params, gs_memory_t * mem)
{
    ...
    if (params->VerticesPerRow < 2)
        return ((-15));
    do { psh = (void *)(*(mem)->procs.alloc_struct)(mem, &st_shading_LfGt, "gs_shading_LfGt_init"); if ( psh == 0 ) return ((-25)); psh->head.type = shading_type_Lattice_form_Gouraud_triangle; psh->head.procs = shading_LfGt_procs; psh->params = *params; *ppsh = (gs_shading_t *)psh; } while (0);
...
static const gs_memory_struct_type_t st_shading_Cp = { sizeof(gs_shading_Cp_t), "gs_shading_Cp_t", 0, 0, shading_mesh_enum_ptrs, shading_mesh_reloc_ptrs, 0, 0 };
                   ...
                   const gs_shading_Cp_params_t * params, gs_memory_t * mem)
{
    ...
    if (bpf < 0)
        return bpf;
    do { psh = (void *)(*(mem)->procs.alloc_struct)(mem, &st_shading_Cp, "gs_shading_Cp_init"); if ( psh == 0 ) return ((-25)); psh->head.type = shading_type_Coons_patch; psh->head.procs = shading_Cp_procs; psh->params = *params; *ppsh = (gs_shading_t *)psh; } while (0);
...
static const gs_memory_struct_type_t st_shading_Tpp = { sizeof(gs_shading_Tpp_t), "gs_shading_Tpp_t", 0, 0, shading_mesh_enum_ptrs, shading_mesh_reloc_ptrs, 0, 0 };
                  ...
                  const gs_shading_Tpp_params_t * params, gs_memory_t * mem)
{
    ...
    if (bpf < 0)
        return bpf;
    do { psh = (void *)(*(mem)->procs.alloc_struct)(mem, &st_shading_Tpp, "gs_shading_Tpp_init"); if ( psh == 0 ) return ((-25)); psh->head.type = shading_type_Tensor_product_patch; psh->head.procs = shading_Tpp_procs; psh->params = *params; *ppsh = (gs_shading_t *)psh; } while (0);
                     ...
                     gs_imager_state *pis, bool fill_background)
{
    ...
    ((dev)->procs.get_clipping_box)(dev, &path_box);
    if (prect)
        do { if ((*prect).p.x > (path_box).p.x) (path_box).p.x = (*prect).p.x; if ((*prect).q.x < (path_box).q.x) (path_box).q.x = (*prect).q.x; if ((*prect).p.y > (path_box).p.y) (path_box).p.y = (*prect).p.y; if ((*prect).q.y < (path_box).q.y) (path_box).q.y = (*prect).q.y; } while (0);
    ...
    if (code >= 0) {
        path_rect.p.x = ((path_box.p.x)*(1.0/(1<<8)));
        path_rect.p.y = ((path_box.p.y)*(1.0/(1<<8)));
        path_rect.q.x = ((path_box.q.x)*(1.0/(1<<8)));
        path_rect.q.y = ((path_box.q.y)*(1.0/(1<<8)));
        gs_bbox_transform_inverse(&path_rect, (const gs_matrix *)pmat, &rect);
        code = ((psh)->head.procs.fill_rectangle(psh, &rect, &path_box, dev, pis));
    }
    return code;
}
