...
{
    return ((((rp)->tas.type_attrs) & (0x80)) &&
            (((rp)->tas.type_attrs >= (t_next_index << 8) ? t_operator : (((const byte *)&((rp)->tas.type_attrs))[1])) == t_operator || (((const byte *)&((rp)->tas.type_attrs))[1]) == t_oparray));
}
static int
...
# 80 "./psi/zmisc.c"
    while (depth) {
        while (((bsp)->tas.rsize)) {
            ...
            ((bsp)->tas.rsize -= (1));
            if ((*(const ref_packed *)(tpp) >= ((ref_packed)(2) << 13))) {

                ushort elt = *tpp;

                if ((*(&elt) >= ((ref_packed)(7) << 13))) {
                    ref nref;
                    ref *pvalue;

                    names_index_ref(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, (*(&elt) & ((1 << 12) - 1)), &nref);

                    if ((pvalue = dstack_find_name_by_index(&(i_ctx_p->dict_stack), names_index(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, &nref))) != 0 &&
                        r_is_ex_oper(pvalue)
                        ) {
                        if ( (avm_space)(((pvalue)->tas.type_attrs) & (((1 << 2) - 1) << 2)) > ((avm_space)(((bsp)->tas.type_attrs) & (((1 << 2) - 1) << 2))) ) return ((-7));




                        alloc_save_change((&(i_ctx_p->memory)), bsp, (ref_packed *)(tpp), "bind");
                        *tpp = ((ref_packed)(pt_executable_operator) << 13) +
                            (((pvalue)->tas.rsize) == 0 ? op_find_index(pvalue) : ((pvalue)->tas.rsize));
                    }
                }
                ...
                switch ((((const byte *)&((tp)->tas.type_attrs))[1])) {
                    case t_name:
                        if ((((tp)->tas.type_attrs) & (0x80))) {
                            ref *pvalue;

                            if ((pvalue = dstack_find_name_by_index(&(i_ctx_p->dict_stack), names_index(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, tp))) != 0 &&
                                r_is_ex_oper(pvalue)
                                ) {
                                if ( (avm_space)(((pvalue)->tas.type_attrs) & (((1 << 2) - 1) << 2)) > ((avm_space)(((bsp)->tas.type_attrs) & (((1 << 2) - 1) << 2))) ) return ((-7));
                                (((void)((((((tp)->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), bsp, (ref_packed *)(tp), "bind") : 0))), ((void)(((*(tp) = *(pvalue)), ((tp)->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
                            }
                        }
                        break;
                    case t_array:
                        if (!(((tp)->tas.type_attrs) & (0x10)))
                            break;
                    case t_mixedarray:
                    case t_shortarray:
                        if ((((tp)->tas.type_attrs) & (0x80))) {

                            ((tp)->tas.type_attrs &= ~(0x10));
                            if (bsp >= (((i_ctx_p->op_stack).stack).top)) {

                                ref temp;
                                int code;

                                temp = *tp;
                                (((i_ctx_p->op_stack).stack).p) = bsp;
                                code = ref_stack_push(&((i_ctx_p->op_stack).stack), 1);
                                if (code < 0) {
                                    ref_stack_pop(&((i_ctx_p->op_stack).stack), depth);
                                    return (code);
                                }
                                bsp = (((i_ctx_p->op_stack).stack).p);
                                *bsp = temp;
                            } else
                                *++bsp = *tp;
                            depth++;
        ...
        bsp--;
        depth--;
        if (bsp < (((i_ctx_p->op_stack).stack).bot)) {
            (((i_ctx_p->op_stack).stack).p) = bsp;
...
zserialnumber(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.intval = (gp_serialnumber()), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
...
zrealtime(i_ctx_t *i_ctx_p)
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    long secs_ns[2];
    gs_lib_ctx_t *libctx = gs_lib_ctx_get_interp_instance(((gs_memory_t *)((i_ctx_p->memory).current)));

    gp_get_realtime(secs_ns);
    secs_ns[1] -= libctx->real_time_0[1];
    secs_ns[0] -= libctx->real_time_0[0];
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.intval = (secs_ns[0] * 1000 + secs_ns[1] / 1000000), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
...
zgetenv(i_ctx_t *i_ctx_p)
{
    ...
    str = ref_to_string(op, ((gs_memory_t *)((i_ctx_p->memory).current)), "getenv key");
    if (str == 0)
        return ((-25));
    if (gp_getenv(str, (char *)0, &len) > 0) {
        (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_string)(((gs_memory_t *)((i_ctx_p->memory).current)), (byte *) str, ((op)->tas.rsize) + 1, "getenv key");
        ((op)->value.boolval = (0), ((op)->tas.type_attrs = ((t_boolean) << 8) + (0)) );
        return 0;
    }
    value = (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_string)(((gs_memory_t *)((i_ctx_p->memory).current)), len, "getenv value");
    if (value == 0) {
        (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_string)(((gs_memory_t *)((i_ctx_p->memory).current)), (byte *) str, ((op)->tas.rsize) + 1, "getenv key");
        return ((-25));
    }
    ((void)(gp_getenv(str, (char *)value, &len)));
    (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_string)(((gs_memory_t *)((i_ctx_p->memory).current)), (byte *) str, ((op)->tas.rsize) + 1, "getenv key");

    value = (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.resize_string)(((gs_memory_t *)((i_ctx_p->memory).current)), value, len, len - 1, "getenv value");

    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op - 1)->value.bytes = (value), ((op - 1)->tas.type_attrs = ((t_string) << 8) + ((0x10 + 0x20 +0x40) | (((&(i_ctx_p->memory)))->current_space))), ((op - 1)->tas.rsize = (len - 1)));
...
zdefaultpapersize(i_ctx_t *i_ctx_p)
{
    ...
    value = (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_string)(((gs_memory_t *)((i_ctx_p->memory).current)), len, "defaultpapersize value");
    if (value == 0) {
        return ((-25));
    }
    ((void)(gp_defaultpapersize((char *)value, &len)));

    value = (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.resize_string)(((gs_memory_t *)((i_ctx_p->memory).current)), value, len, len - 1, "defaultpapersize value");
...
zmakeoperator(i_ctx_t *i_ctx_p)
{
    ...
    if ( !((((const byte *)&((&op[-1])->tas.type_attrs))[1]) == (t_name)) ) return (check_type_failed(&op[-1]));
    do { if ( !(((&*op)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))) ) return (check_proc_failed(&*op)); } while (0);
    switch ((avm_space)(((op)->tas.type_attrs) & (((1 << 2) - 1) << 2))) {
        case avm_global:
...
# 304 "./psi/zmisc.c"
    while (count > 0 && ((((const byte *)&((&tab[count - 1])->tas.type_attrs))[1]) == (t_null)))
        --count;
    if (count == ((&opt->table)->tas.rsize))
        return ((-13));
    (((void)((((((&tab[count])->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), &opt->table, (ref_packed *)(&tab[count]), "makeoperator") : 0))), ((void)(((*(&tab[count]) = *(op)), ((&tab[count])->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask)))));
    opt->nx_table[count] = names_index(((gs_memory_t *)((i_ctx_p->memory).current))->gs_lib_ctx->gs_name_table, op - 1);
    op_index_ref(((gs_memory_t *)((i_ctx_p->memory).current)), opt->base_index + count, op - 1);
    opt->count = count + 1;
...
zoserrno(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.intval = ((*__errno_location ())), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
...
zsetoserrno(i_ctx_t *i_ctx_p)
{
    ...
    (*__errno_location ()) = op->value.intval;
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
...
zoserrorstring(i_ctx_t *i_ctx_p)
{
    ...
    code = string_to_ref(str, op, ((i_ctx_p->memory).current), ".oserrorstring");
    if (code < 0)
        return code;

    while ((len = ((op)->tas.rsize)) != 0 &&
...
zsetCPSImode(i_ctx_t *i_ctx_p)
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_boolean)) ) return (check_type_failed(&*op));
    gs_setcpsimode(((gs_memory_t *)((i_ctx_p->memory).current)), op->value.boolval);
    if (op->value.boolval) {
        i_ctx_p->scanner_options |= 128;
    }
    else {
        i_ctx_p->scanner_options &= ~(int)128;
    }
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
...
zgetCPSImode(i_ctx_t *i_ctx_p)
{
    ...
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op)->value.boolval = (gs_currentcpsimode(((gs_memory_t *)((i_ctx_p->memory).current)))), ((op)->tas.type_attrs = ((t_boolean) << 8) + (0)) );
    return 0;
}
# 506 "./psi/zmisc.c"
