# 1 "./devices/vector/gdevpdfj.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpdfj.c" 2
# 18 "./devices/vector/gdevpdfj.c"
# 1 "./base/memory_.h" 1
# 23 "./base/memory_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 55 "./base/memory_.h" 2
# 19 "./devices/vector/gdevpdfj.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
...
# 20 "./devices/vector/gdevpdfj.c" 2
...
# 22 "./devices/vector/gdevpdfj.c" 2
...
# 23 "./devices/vector/gdevpdfj.c" 2
...
# 24 "./devices/vector/gdevpdfj.c" 2
...
# 26 "./devices/vector/gdevpdfj.c" 2
# 1 "./devices/vector/gdevpsds.h" 1
# 28 "./devices/vector/gdevpsds.h"
...
# 27 "./devices/vector/gdevpdfj.c" 2
# 1 "./base/spngpx.h" 1
# 33 "./base/spngpx.h"
...
# 28 "./devices/vector/gdevpdfj.c" 2
# 1 "/usr/include/stdlib.h" 1 3 4
# 32 "/usr/include/stdlib.h" 3 4
# 1 "/home/juneyoung.lee/llvm-prototypes/llvm-install-3.7.0/bin/../lib/clang/3.7.0/include/stddef.h" 1 3 4
...
# 29 "./devices/vector/gdevpdfj.c" 2





static gs_ptr_type_t pdf_image_writer_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void pdf_image_writer_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_pdf_image_writer = { sizeof(pdf_image_writer), "pdf_image_writer", 0, 0, pdf_image_writer_enum_ptrs, pdf_image_writer_reloc_ptrs, 0, 0 };
static gs_ptr_type_t pdf_image_writer_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const pdf_image_writer *piw = vptr; switch ( index ) { default:
     index -= 4;
     if (index < 3 * piw->alt_writer_count) {
         gs_ptr_type_t ret =
             (*(st_psdf_binary_writer).enum_ptrs)(mem, &piw->binary[index / 3], sizeof(psdf_binary_writer), index % 3, pep, &(st_psdf_binary_writer), gcst);
    ...
    return 0;
case 0: return (pep->ptr = (const void *)(piw->pres), (&ptr_struct_procs));
case 1: return (pep->ptr = (const void *)(piw->data), (&ptr_struct_procs));
case 2: return (pep->ptr = (const void *)(piw->named), (&ptr_struct_procs));
case 3: return (pep->ptr = (const void *)(piw->pres_mask), (&ptr_struct_procs));
} }
static void pdf_image_writer_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { pdf_image_writer *piw = vptr;
{
    int i;

    for (i = 0; i < piw->alt_writer_count; ++i)
        (*(st_psdf_binary_writer).reloc_ptrs)(&piw->binary[i], sizeof(psdf_binary_writer), &(st_psdf_binary_writer), gcst);

    (piw->pres = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(piw->pres), gcst)));
    (piw->data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(piw->data), gcst)));
    (piw->named = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(piw->named), gcst)));
    (piw->pres_mask = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(piw->pres_mask), gcst)));
}
}
...
const pdf_image_names_t pdf_image_names_full = {
    ...
    "/BitsPerComponent", "/ColorSpace", "/Decode", "/Height", "/ImageMask", "/Interpolate", "/Width"
};
                           ...
                           const cos_value_t *pcsvalue)
{
    ...
    if (pcs) {
        do { if ((code = (cos_dict_put_c_key(pcd, pin->ColorSpace, pcsvalue))) < 0) return code; } while (0);
        ...
        num_components = 1;
    do { if ((code = (cos_dict_put_c_key_int(pcd, pin->Width, pim->Width))) < 0) return code; } while (0);
    do { if ((code = (cos_dict_put_c_key_int(pcd, pin->Height, pim->Height))) < 0) return code; } while (0);
    do { if ((code = (cos_dict_put_c_key_int(pcd, pin->BitsPerComponent, pim->BitsPerComponent))) < 0) return code; } while (0);

    {
        ...
        if (i < num_components * 2) {
            ...
            if (pcs == ((void*)0)) {
                ...
                for (i = 0; i < num_components * 2; ++i)
                    do { if ((code = (cos_array_add_real(pca, (((pim->Decode[i]) < (1)) ? (pim->Decode[i]) : (1))))) < 0) return code; } while (0);
            } else {
                for (i = 0; i < num_components * 2; ++i)
                    do { if ((code = (cos_array_add_real(pca, pim->Decode[i]))) < 0) return code; } while (0);
            }
            do { if ((code = (cos_dict_put_c_key_object(pcd, pin->Decode, ((cos_object_t *)&((pca)->cos_procs))))) < 0) return code; } while (0);

        }
    }
    if (pim->Interpolate) {
        if (pdev->PDFA != 0)
            (emprintf_program_ident(pdev->memory, gs_program_name(), gs_revision_number()), errprintf(pdev->memory, "PDFA doesn't allow images with Interpolate true.\n"));

        else
            do { if ((code = (cos_dict_put_c_strings(pcd, pin->Interpolate, "true"))) < 0) return code; } while (0);
    }
    return 0;
}
int
                     ...
                     const cos_value_t *pcsvalue)
{
    ...
    case 1: {
        ...
        if (pim->ImageMask) {
            do { if ((code = (cos_dict_put_c_strings(pcd, pin->ImageMask, "true"))) < 0) return code; } while (0);
...
# 174 "./devices/vector/gdevpdfj.c"
    ...
    case 4: {
        ...
        for (i = 0; i < num_components; ++i) {
            ...
            do { if ((code = (cos_array_add_int(pca, lo))) < 0) return code; } while (0);
            do { if ((code = (cos_array_add_int(pca, hi))) < 0) return code; } while (0);
        }
        do { if ((code = (cos_dict_put_c_key_object(pcd, "/Mask", ((cos_object_t *)&((pca)->cos_procs))))) < 0) return code; } while (0);
    }
        break;
    default:
        return ((-15));
                      ...
                      bool in_line)
{
    ...
    if (in_line) {
        ...
        *(mask ? &piw->pres_mask : &piw->pres) = pres;
        ...
        do { if ((code = (cos_dict_put_c_strings(cos_stream_dict(pcos), "/Subtype", "/Image"))) < 0) return code; } while (0);
    ...
    piw->binary[alt_stream_index].target = ((void*)0);
    pdev->strm = save_strm;
    return code;
}
                     ...
                     int alt_writer_index)
{
    ...
    if (code < 0) {
        if (!piw->pres)
            cos_free(((cos_object_t *)&((piw->data)->cos_procs)), "pdf_begin_image_data");
        piw->data = 0;
    }
    return code;
}
            ...
            for (; lines_left; lines_left--)
                for (i = 0; i < piw->alt_writer_count; i++) {
                    for (l = bytes_per_line; l > 0; l -= lb)
                        if ((sputs(piw->binary[i].strm, buf, (((l) < (lb)) ? (l) : (lb)),
                                            &ignore)) < 0)
                            return ((-12));
                }
        }
...
pdf_end_image_binary(gx_device_pdf *pdev, pdf_image_writer *piw, int data_h)
{
    ...
    if (piw->alt_writer_count > 2)
        code = pdf_choose_compression(piw, ((bool)1));
    else
    ...
    if (data_h != piw->height) {
        ...
        if (!value || value->contents.chars.size > 255)
            return((-15));
        __builtin_strncpy ((char *)&data, (const char *)value->contents.chars.data, value->contents.chars.size);
...
pdf_end_write_image(gx_device_pdf * pdev, pdf_image_writer * piw)
{
    ...
    if (pres) {
        ...
        if (named) {
            if (pdev->ForOPDFRead) {
                code = cos_dict_put_c_key_bool(named, "/.Global", ((bool)1));
                if (code < 0)
                    return code;
            }
            ...
            *(cos_object_t *)named = *pco;
            pres->object = ((cos_object_t *)&((named)->cos_procs));
        } else if (!pres->named) {
            if (pdev->DetectDuplicateImages) {
                pdf_x_object_t *pxo = (pdf_x_object_t *)piw->pres;
                int height = pxo->height, width = pxo->width;

                code = pdf_substitute_resource(pdev, &piw->pres, resourceXObject, ((void*)0), ((bool)0));
                if (code < 0)
                    return code;
                ...
                pdf_reserve_object_id(pdev, piw->pres, 0L);
            }
        ...
        pprints1(s, "\nEI%s\n", piw->end_string);
        cos_free(((cos_object_t *)&((piw->data)->cos_procs)), "pdf_end_write_image");
        return 1;
    }
}
    ...
    for (yi = 0; yi < h; ++yi) {
        ...
        if (sbit == 0) {
            ...
            for (i = 0; i < nbytes; ++data, ++i)
                (!((s)->cursor.w.ptr >= (s)->cursor.w.limit) ? (++((s)->cursor.w.ptr), *(s)->cursor.w.ptr=((byte)(*data ^ invert)), 0) : spputc((s),((byte)(*data ^ invert))));
        } else {
            int wleft = w;
            int rbit = 8 - sbit;

            for (; wleft + sbit > 8; ++data, wleft -= 8)
                (!((s)->cursor.w.ptr >= (s)->cursor.w.limit) ? (++((s)->cursor.w.ptr), *(s)->cursor.w.ptr=((byte)(((*data << sbit) + (data[1] >> rbit)) ^ invert)), 0) : spputc((s),((byte)(((*data << sbit) + (data[1] >> rbit)) ^ invert))));
            if (wleft > 0)
                (!((s)->cursor.w.ptr >= (s)->cursor.w.limit) ? (++((s)->cursor.w.ptr), *(s)->cursor.w.ptr=((byte)(((*data << sbit) ^ invert) & (byte) (0xff00 >> wleft))), 0) : spputc((s),((byte)(((*data << sbit) ^ invert) & (byte) (0xff00 >> wleft)))));
...
static __inline__ bool much_bigger__DL(long l1, long l2)
{
...
pdf_choose_compression_cos(pdf_image_writer *piw, cos_stream_t *s[2], bool force)
{
    ...
    piw->binary[1].strm = piw->binary[2].strm = 0;
