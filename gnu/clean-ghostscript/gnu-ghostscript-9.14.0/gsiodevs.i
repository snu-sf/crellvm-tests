...
stdio_close_file(stream *s)
{
    ...
    s->file = 0;
    ((mem)->procs.free_object(mem, s->cbuf, "stdio_close_file(buffer)"));
    return 0;
}
static int
           ...
           void (*srw_file)(stream *, FILE *, byte *, uint))
{
    ...
    if (!((access)[0] == (rw) && (access)[1] == 0))
        return ((-9));
    s = s_alloc(mem, "stdio_open(stream)");
    buf = (*(mem)->procs.alloc_bytes)(mem, 128, "stdio_open(buffer)");
    if (s == 0 || buf == 0) {
        ((mem)->procs.free_object(mem, buf, "stdio_open(buffer)"));
        ((mem)->procs.free_object(mem, s, "stdio_open(stream)"));
        return ((-25));
    }
    srw_file(s, file, buf, 128);
...
const gx_io_device gs_iodev_stdin = { "%stdin%", iodev_dtype_stdio, { iodev_no_init, stdin_open, iodev_no_open_file, iodev_no_fopen, iodev_no_fclose, iodev_no_delete_file, iodev_no_rename_file, iodev_no_file_status, iodev_no_enumerate_files, ((void*)0), ((void*)0), iodev_no_get_params, iodev_no_put_params }};
...
const gx_io_device gs_iodev_stdout = { "%stdout%", iodev_dtype_stdio, { iodev_no_init, stdout_open, iodev_no_open_file, iodev_no_fopen, iodev_no_fclose, iodev_no_delete_file, iodev_no_rename_file, iodev_no_file_status, iodev_no_enumerate_files, ((void*)0), ((void*)0), iodev_no_get_params, iodev_no_put_params }};
...
const gx_io_device gs_iodev_stderr = { "%stderr%", iodev_dtype_stdio, { iodev_no_init, stderr_open, iodev_no_open_file, iodev_no_fopen, iodev_no_fclose, iodev_no_delete_file, iodev_no_rename_file, iodev_no_file_status, iodev_no_enumerate_files, ((void*)0), ((void*)0), iodev_no_get_params, iodev_no_put_params }};
