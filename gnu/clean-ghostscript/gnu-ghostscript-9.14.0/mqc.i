# 1 "./openjpeg/libopenjpeg/mqc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/mqc.c" 2
# 33 "./openjpeg/libopenjpeg/mqc.c"
...
# 34 "./openjpeg/libopenjpeg/mqc.c" 2
# 46 "./openjpeg/libopenjpeg/mqc.c"
...
static __inline__ OPJ_INT32 opj_mqc_mpsexchange(opj_mqc_t *const mqc);





static __inline__ OPJ_INT32 opj_mqc_lpsexchange(opj_mqc_t *const mqc);
...
static __inline__ void opj_mqc_renormd(opj_mqc_t *const mqc);
...
# 310 "./openjpeg/libopenjpeg/mqc.c"
...
opj_mqc_t* opj_mqc_create(void) {
 opj_mqc_t *mqc = (opj_mqc_t*)((size_t)(sizeof(opj_mqc_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_mqc_t)));
...
# 563 "./openjpeg/libopenjpeg/mqc.c"
 opj_mqc_bytein(mqc);
 mqc->c <<= 7;
 mqc->ct -= 7;
 mqc->a = 0x8000;
