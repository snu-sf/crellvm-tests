# 1 "./openjpeg/libopenjpeg/dwt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/dwt.c" 2
# 35 "./openjpeg/libopenjpeg/dwt.c"
...
# 36 "./openjpeg/libopenjpeg/dwt.c" 2
...
# 39 "./openjpeg/libopenjpeg/dwt.c" 2
# 49 "./openjpeg/libopenjpeg/dwt.c"
...
static OPJ_UINT32 opj_dwt_max_resolution(opj_tcd_resolution_t* __restrict__ r, OPJ_UINT32 i);




static void opj_v4dwt_decode(opj_v4dwt_t* __restrict__ dwt);

static void opj_v4dwt_interleave_h(opj_v4dwt_t* __restrict__ w, OPJ_FLOAT32* __restrict__ a, OPJ_INT32 x, OPJ_INT32 size);

static void opj_v4dwt_interleave_v(opj_v4dwt_t* __restrict__ v , OPJ_FLOAT32* __restrict__ a , OPJ_INT32 x, OPJ_INT32 nb_elts_read);
...
# 164 "./openjpeg/libopenjpeg/dwt.c"
...
# 190 "./openjpeg/libopenjpeg/dwt.c"
...
void opj_dwt_encode_1(OPJ_INT32 *a, OPJ_INT32 dn, OPJ_INT32 sn, OPJ_INT32 cas) {
 ...
 if (!cas) {
  if ((dn > 0) || (sn > 1)) {
   for (i = 0; i < dn; i++) a[(1+(i)*2)] -= (((i)<0?a[(0)*2]:((i)>=sn?a[(sn-1)*2]:a[(i)*2])) + ((i + 1)<0?a[(0)*2]:((i + 1)>=sn?a[(sn-1)*2]:a[(i + 1)*2]))) >> 1;
   for (i = 0; i < sn; i++) a[(i)*2] += (((i - 1)<0?a[(1+(0)*2)]:((i - 1)>=dn?a[(1+(dn-1)*2)]:a[(1+(i - 1)*2)])) + ((i)<0?a[(1+(0)*2)]:((i)>=dn?a[(1+(dn-1)*2)]:a[(1+(i)*2)])) + 2) >> 2;
  }
 } else {
  if (!sn && dn == 1)
   a[(0)*2] *= 2;
  else {
   for (i = 0; i < dn; i++) a[(i)*2] -= (((i)<0?a[(1+(0)*2)]:((i)>=sn?a[(1+(sn-1)*2)]:a[(1+(i)*2)])) + ((i - 1)<0?a[(1+(0)*2)]:((i - 1)>=sn?a[(1+(sn-1)*2)]:a[(1+(i - 1)*2)]))) >> 1;
   for (i = 0; i < sn; i++) a[(1+(i)*2)] += (((i)<0?a[(0)*2]:((i)>=dn?a[(dn-1)*2]:a[(i)*2])) + ((i + 1)<0?a[(0)*2]:((i + 1)>=dn?a[(dn-1)*2]:a[(i + 1)*2])) + 2) >> 2;
  }
 }
}
...
void opj_dwt_encode_1_real(OPJ_INT32 *a, OPJ_INT32 dn, OPJ_INT32 sn, OPJ_INT32 cas) {
 ...
 if (!cas) {
  if ((dn > 0) || (sn > 1)) {
   for (i = 0; i < dn; i++)
    a[(1+(i)*2)] -= opj_int_fix_mul(((i)<0?a[(0)*2]:((i)>=sn?a[(sn-1)*2]:a[(i)*2])) + ((i + 1)<0?a[(0)*2]:((i + 1)>=sn?a[(sn-1)*2]:a[(i + 1)*2])), 12993);
   for (i = 0; i < sn; i++)
    a[(i)*2] -= opj_int_fix_mul(((i - 1)<0?a[(1+(0)*2)]:((i - 1)>=dn?a[(1+(dn-1)*2)]:a[(1+(i - 1)*2)])) + ((i)<0?a[(1+(0)*2)]:((i)>=dn?a[(1+(dn-1)*2)]:a[(1+(i)*2)])), 434);
   for (i = 0; i < dn; i++)
    a[(1+(i)*2)] += opj_int_fix_mul(((i)<0?a[(0)*2]:((i)>=sn?a[(sn-1)*2]:a[(i)*2])) + ((i + 1)<0?a[(0)*2]:((i + 1)>=sn?a[(sn-1)*2]:a[(i + 1)*2])), 7233);
   for (i = 0; i < sn; i++)
    a[(i)*2] += opj_int_fix_mul(((i - 1)<0?a[(1+(0)*2)]:((i - 1)>=dn?a[(1+(dn-1)*2)]:a[(1+(i - 1)*2)])) + ((i)<0?a[(1+(0)*2)]:((i)>=dn?a[(1+(dn-1)*2)]:a[(1+(i)*2)])), 3633);
   for (i = 0; i < dn; i++)
  ...
  if ((sn > 0) || (dn > 1)) {
   for (i = 0; i < dn; i++)
    a[(i)*2] -= opj_int_fix_mul(((i)<0?a[(1+(0)*2)]:((i)>=sn?a[(1+(sn-1)*2)]:a[(1+(i)*2)])) + ((i - 1)<0?a[(1+(0)*2)]:((i - 1)>=sn?a[(1+(sn-1)*2)]:a[(1+(i - 1)*2)])), 12993);
   for (i = 0; i < sn; i++)
    a[(1+(i)*2)] -= opj_int_fix_mul(((i)<0?a[(0)*2]:((i)>=dn?a[(dn-1)*2]:a[(i)*2])) + ((i + 1)<0?a[(0)*2]:((i + 1)>=dn?a[(dn-1)*2]:a[(i + 1)*2])), 434);
   for (i = 0; i < dn; i++)
    a[(i)*2] += opj_int_fix_mul(((i)<0?a[(1+(0)*2)]:((i)>=sn?a[(1+(sn-1)*2)]:a[(1+(i)*2)])) + ((i - 1)<0?a[(1+(0)*2)]:((i - 1)>=sn?a[(1+(sn-1)*2)]:a[(1+(i - 1)*2)])), 7233);
   for (i = 0; i < sn; i++)
    a[(1+(i)*2)] += opj_int_fix_mul(((i)<0?a[(0)*2]:((i)>=dn?a[(dn-1)*2]:a[(i)*2])) + ((i + 1)<0?a[(0)*2]:((i + 1)>=dn?a[(dn-1)*2]:a[(i + 1)*2])), 3633);
   for (i = 0; i < dn; i++)
...
# 382 "./openjpeg/libopenjpeg/dwt.c"
__inline__ OPJ_BOOL opj_dwt_encode_procedure(opj_tcd_tilecomp_t * tilec,void (*p_function)(OPJ_INT32 *, OPJ_INT32,OPJ_INT32,OPJ_INT32) )
{
 OPJ_INT32 i, j, k;
 OPJ_INT32 *a = 00;
 OPJ_INT32 *aj = 00;
 ...
 bj = (OPJ_INT32*)((size_t)(l_data_size) >= (size_t)-0x100 ? ((void*)0) : malloc(l_data_size));
 if (! bj) {
  return 0;
 }
 i = l;
...
OPJ_UINT32 opj_dwt_max_resolution(opj_tcd_resolution_t* __restrict__ r, OPJ_UINT32 i) {
 OPJ_UINT32 mr = 0;
 OPJ_UINT32 w;
 while( --i ) {
  ++r;
...
OPJ_BOOL opj_dwt_decode_tile(opj_tcd_tilecomp_t* tilec, OPJ_UINT32 numres, DWT1DFN dwt_1D) {
 ...
 OPJ_UINT32 rw = tr->x1 - tr->x0;
 OPJ_UINT32 rh = tr->y1 - tr->y0;

 OPJ_UINT32 w = tilec->x1 - tilec->x0;

 h.mem = (OPJ_INT32*)
 malloc(opj_dwt_max_resolution(tr, numres) * sizeof(OPJ_INT32));
 if (! h.mem){
  return 0;
 }
 ...
 while( --numres) {
  OPJ_INT32 * __restrict__ tiledp = tilec->data;
  OPJ_UINT32 j;
...
void opj_v4dwt_interleave_h(opj_v4dwt_t* __restrict__ w, OPJ_FLOAT32* __restrict__ a, OPJ_INT32 x, OPJ_INT32 size){
 OPJ_FLOAT32* __restrict__ bi = (OPJ_FLOAT32*) (w->wavelet + w->cas);
...
void opj_v4dwt_interleave_v(opj_v4dwt_t* __restrict__ v , OPJ_FLOAT32* __restrict__ a , OPJ_INT32 x, OPJ_INT32 nb_elts_read){
 opj_v4_t* __restrict__ bi = v->wavelet + v->cas;
 OPJ_INT32 i;
...
void opj_v4dwt_decode_step1_sse(opj_v4_t* w, OPJ_INT32 count, const __m128 c){
 __m128* __restrict__ vw = (__m128*) w;
 OPJ_INT32 i;
...
void opj_v4dwt_decode_step2_sse(opj_v4_t* l, opj_v4_t* w, OPJ_INT32 k, OPJ_INT32 m, __m128 c){
 __m128* __restrict__ vl = (__m128*) l;
 __m128* __restrict__ vw = (__m128*) w;
 OPJ_INT32 i;
...
# 792 "./openjpeg/libopenjpeg/dwt.c"
void opj_v4dwt_decode(opj_v4dwt_t* __restrict__ dwt)
{
 OPJ_INT32 a, b;
 if(dwt->cas == 0) {
...
# 823 "./openjpeg/libopenjpeg/dwt.c"
}
...
OPJ_BOOL opj_dwt_decode_real(opj_tcd_tilecomp_t* __restrict__ tilec, OPJ_UINT32 numres)
{
 ...
 OPJ_UINT32 rw = res->x1 - res->x0;
 OPJ_UINT32 rh = res->y1 - res->y0;

 OPJ_UINT32 w = tilec->x1 - tilec->x0;

 h.wavelet = (opj_v4_t*) malloc((opj_dwt_max_resolution(res, numres)+5) * sizeof(opj_v4_t));
 v.wavelet = h.wavelet;

 while( --numres) {
  OPJ_FLOAT32 * __restrict__ aj = (OPJ_FLOAT32*) tilec->data;
