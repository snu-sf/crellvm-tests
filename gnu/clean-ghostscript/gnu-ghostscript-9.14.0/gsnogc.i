...
extern void gs_nogc_reclaim(vm_spaces *pspaces, bool global);
# 22 "./base/gsnogc.c" 2
# 1 "./base/gsstruct.h" 1
# 23 "./base/gsstruct.h"
# 1 "./base/gsstype.h" 1
...
{
    return (*(mem)->procs.alloc_bytes)(mem, nbytes, cname);
}
...
{
    ((mem)->procs.free_object(mem, str, cname));
}
...
{
    return ((mem)->procs.resize_object(mem, data, new_num, cname));
}
# 60 "./base/gsnogc.c"
...
gs_nogc_reclaim(vm_spaces * pspaces, bool global)
{
    ...
    for (space = 0; space < (sizeof(pspaces->memories.indexed) / sizeof((pspaces->memories.indexed)[0])); ++space) {
        ...
        if (mem->stable_memory != (gs_memory_t *)mem &&
            ...
            (((gs_memory_t *)mem->stable_memory)->procs.consolidate_free((gs_memory_t *)mem->stable_memory));
        }
    }
}
