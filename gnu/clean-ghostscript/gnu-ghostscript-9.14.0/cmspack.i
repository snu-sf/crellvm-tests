# 1 "./lcms2/src/cmspack.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmspack.c" 2
# 27 "./lcms2/src/cmspack.c"
...
# 28 "./lcms2/src/cmspack.c" 2
# 45 "./lcms2/src/cmspack.c"
static inline cmsUInt16Number FomLabV2ToLabV4(cmsUInt16Number x)
{
    int a = (x << 8 | x) >> 8;
...
static inline cmsUInt16Number FomLabV4ToLabV2(cmsUInt16Number x)
{
...
cmsUInt8Number* UnrollChunkyBytes(register _cmsTRANSFORM* info,
                                  ...
                                  register cmsUInt32Number Stride)
{
    int nChan = (((info -> InputFormat)>>3)&15);
    int DoSwap = (((info ->InputFormat)>>10)&1);
    int Reverse = (((info ->InputFormat)>>13)&1);
    int SwapFirst = (((info -> InputFormat)>>14)&1);
    int Extra = (((info -> InputFormat)>>7)&7);
    ...
    for (i=0; i < nChan; i++) {
        ...
        v = (cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum));
        v = Reverse ? ((cmsUInt16Number)(0xffff-(v))) : v;
        wIn[index] = v;
        accum++;
    }
                                  ...
                                  register cmsUInt32Number Stride)
{
    ...
    if (DoSwap ^ SwapFirst) {
        accum += (((info -> InputFormat)>>7)&7) * Stride;
    }

    for (i=0; i < nChan; i++) {

        int index = DoSwap ? (nChan - i - 1) : i;
        cmsUInt16Number v = (cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum));

        wIn[index] = Reverse ? ((cmsUInt16Number)(0xffff-(v))) : v;
        accum += Stride;
    }
...
cmsUInt8Number* Unroll4Bytes(register _cmsTRANSFORM* info,
                             ...
                             register cmsUInt32Number Stride)
{
    wIn[0] = (cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum)); accum++;
    wIn[1] = (cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum)); accum++;
    wIn[2] = (cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum)); accum++;
    wIn[3] = (cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum)); accum++;
...
cmsUInt8Number* Unroll4BytesReverse(register _cmsTRANSFORM* info,
                                    ...
                                    register cmsUInt32Number Stride)
{
    wIn[0] = (cmsUInt16Number) ((((cmsUInt16Number) (((cmsUInt8Number) (0xff-(*accum))))) << 8)|(((cmsUInt8Number) (0xff-(*accum))))); accum++;
    wIn[1] = (cmsUInt16Number) ((((cmsUInt16Number) (((cmsUInt8Number) (0xff-(*accum))))) << 8)|(((cmsUInt8Number) (0xff-(*accum))))); accum++;
    wIn[2] = (cmsUInt16Number) ((((cmsUInt16Number) (((cmsUInt8Number) (0xff-(*accum))))) << 8)|(((cmsUInt8Number) (0xff-(*accum))))); accum++;
    wIn[3] = (cmsUInt16Number) ((((cmsUInt16Number) (((cmsUInt8Number) (0xff-(*accum))))) << 8)|(((cmsUInt8Number) (0xff-(*accum))))); accum++;
...
cmsUInt8Number* UnrollLabV2_8(register _cmsTRANSFORM* info,
                              ...
                              register cmsUInt32Number Stride)
{
    wIn[0] = FomLabV2ToLabV4((cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum))); accum++;
    wIn[1] = FomLabV2ToLabV4((cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum))); accum++;
    wIn[2] = FomLabV2ToLabV4((cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum))); accum++;
...
cmsUInt8Number* Unroll1Byte(register _cmsTRANSFORM* info,
                            ...
                            register cmsUInt32Number Stride)
{
    wIn[0] = wIn[1] = wIn[2] = (cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum)); accum++;
...
cmsUInt8Number* Unroll1ByteReversed(register _cmsTRANSFORM* info,
                                    ...
                                    register cmsUInt32Number Stride)
{
    wIn[0] = wIn[1] = wIn[2] = ((cmsUInt16Number)(0xffff-((cmsUInt16Number) ((((cmsUInt16Number) (*accum)) << 8)|(*accum))))); accum++;
...
{
    int nChan = (((info -> InputFormat)>>3)&15);
    int SwapEndian = (((info -> InputFormat)>>11)&1);
    int DoSwap = (((info ->InputFormat)>>10)&1);
    int Reverse = (((info ->InputFormat)>>13)&1);
    int SwapFirst = (((info -> InputFormat)>>14)&1);
    int Extra = (((info -> InputFormat)>>7)&7);
    ...
    for (i=0; i < nChan; i++) {
        ...
        if (SwapEndian)
            v = (cmsUInt16Number) ((cmsUInt16Number) ((v)<<8)|((v)>>8));
                                  ...
                                  register cmsUInt32Number Stride)
{
    ...
    if (DoSwap) {
        accum += (((info -> InputFormat)>>7)&7) * Stride * sizeof(cmsUInt16Number);
    }
...
cmsUInt8Number* Unroll4WordsReverse(register _cmsTRANSFORM* info,
                                    ...
                                    register cmsUInt32Number Stride)
{
    wIn[0] = ((cmsUInt16Number)(0xffff-(*(cmsUInt16Number*) accum))); accum+= 2;
    wIn[1] = ((cmsUInt16Number)(0xffff-(*(cmsUInt16Number*) accum))); accum+= 2;
    wIn[2] = ((cmsUInt16Number)(0xffff-(*(cmsUInt16Number*) accum))); accum+= 2;
    wIn[3] = ((cmsUInt16Number)(0xffff-(*(cmsUInt16Number*) accum))); accum+= 2;
...
cmsUInt8Number* Unroll1WordReversed(register _cmsTRANSFORM* info,
                                    ...
                                    register cmsUInt32Number Stride)
{
    wIn[0] = wIn[1] = wIn[2] = ((cmsUInt16Number)(0xffff-(*(cmsUInt16Number*) accum))); accum+= 2;
                                    ...
                                    register cmsUInt32Number Stride)
{
    if ((((info -> InputFormat)>>12)&1)) {
        ...
        accum += sizeof(cmsCIELab) + (((info ->InputFormat)>>7)&7) * sizeof(cmsFloat64Number);
        return accum;
    }
}
                                    ...
                                    register cmsUInt32Number Stride)
{
    ...
    if ((((info -> InputFormat)>>12)&1)) {
        ...
        cmsFloat2LabEncoded(wIn, &Lab);
        accum += (3 + (((info ->InputFormat)>>7)&7)) * sizeof(cmsFloat32Number);
        return accum;
    }
}
                                    ...
                                    register cmsUInt32Number Stride)
{
    if ((((info -> InputFormat)>>12)&1)) {
        ...
        accum += sizeof(cmsCIEXYZ) + (((info ->InputFormat)>>7)&7) * sizeof(cmsFloat64Number);
                                   ...
                                   register cmsUInt32Number Stride)
{
    if ((((info -> InputFormat)>>12)&1)) {
        ...
        accum += 3 * sizeof(cmsFloat32Number) + (((info ->InputFormat)>>7)&7) * sizeof(cmsFloat32Number);
...
static inline cmsBool IsInkSpace(cmsUInt32Number Type)
{
    switch ((((Type)>>16)&31)) {
                                ...
                                register cmsUInt32Number Stride)
{
    ...
    int Extra = (((info -> InputFormat)>>7)&7);
    int ExtraFirst = DoSwap ^ SwapFirst;
    int Planar = (((info -> InputFormat)>>12)&1);
    cmsFloat64Number v;
    cmsUInt16Number vi;
    int i, start = 0;
                                       ...
                                       cmsUInt32Number Stride)
{
    ...
    if ((((info -> InputFormat)>>12)&1)) {
        ...
        accum += sizeof(cmsFloat64Number)*(3 + (((info ->InputFormat)>>7)&7));
        return accum;
    }
}
                                      ...
                                      cmsUInt32Number Stride)
{
    ...
    if ((((info -> InputFormat)>>12)&1)) {
        ...
        accum += sizeof(cmsFloat32Number)*(3 + (((info ->InputFormat)>>7)&7));
        return accum;
    }
}
                                       ...
                                       cmsUInt32Number Stride)
{
    ...
    if ((((info -> InputFormat)>>12)&1)) {
        ...
        wIn[0] = (cmsFloat32Number) (Pt[0] / (1.0 + 32767.0/32768.0));
        wIn[1] = (cmsFloat32Number) (Pt[Stride] / (1.0 + 32767.0/32768.0));
        wIn[2] = (cmsFloat32Number) (Pt[Stride*2] / (1.0 + 32767.0/32768.0));
        ...
        wIn[0] = (cmsFloat32Number) (Pt[0] / (1.0 + 32767.0/32768.0));
        wIn[1] = (cmsFloat32Number) (Pt[1] / (1.0 + 32767.0/32768.0));
        wIn[2] = (cmsFloat32Number) (Pt[2] / (1.0 + 32767.0/32768.0));
...
cmsUInt8Number* PackAnyBytes(register _cmsTRANSFORM* info,
                             ...
                             register cmsUInt32Number Stride)
{
    int nChan = (((info -> OutputFormat)>>3)&15);
    int DoSwap = (((info ->OutputFormat)>>10)&1);
    int Reverse = (((info ->OutputFormat)>>13)&1);
    int Extra = (((info -> OutputFormat)>>7)&7);
    int SwapFirst = (((info -> OutputFormat)>>14)&1);
    int ExtraFirst = DoSwap ^ SwapFirst;
    ...
    for (i=0; i < nChan; i++) {
        ...
        v = (cmsUInt8Number) ((((wOut[index]) * 65281 + 8388608) >> 24) & 0xFF);

        if (Reverse)
            v = ((cmsUInt8Number) (0xff-(v)));
                                ...
                                register cmsUInt32Number Stride)
{
    ...
    if (DoSwap ^ SwapFirst) {
        output += (((info -> OutputFormat)>>7)&7) * Stride;
    }
    ...
    for (i=0; i < nChan; i++) {
        ...
        int index = DoSwap ? (nChan - i - 1) : i;
        cmsUInt8Number v = (cmsUInt8Number) ((((wOut[index]) * 65281 + 8388608) >> 24) & 0xFF);

        *(cmsUInt8Number*) output = (cmsUInt8Number) (Reverse ? ((cmsUInt8Number) (0xff-(v))) : v);
        output += Stride;
    }
                                ...
                                register cmsUInt32Number Stride)
{
    ...
    int DoSwap = (((info ->OutputFormat)>>10)&1);
    int Reverse= (((info ->OutputFormat)>>13)&1);
    int SwapEndian = (((info -> OutputFormat)>>11)&1);
    int i;
    cmsUInt8Number* Init = output;
    cmsUInt16Number v;

    if (DoSwap) {
        output += (((info -> OutputFormat)>>7)&7) * Stride * sizeof(cmsUInt16Number);
    }
...
cmsUInt8Number* Pack6Bytes(register _cmsTRANSFORM* info,
                           ...
                           register cmsUInt32Number Stride)
{
    *output++ = (cmsUInt8Number) ((((wOut[0]) * 65281 + 8388608) >> 24) & 0xFF);
    *output++ = (cmsUInt8Number) ((((wOut[1]) * 65281 + 8388608) >> 24) & 0xFF);
    *output++ = (cmsUInt8Number) ((((wOut[2]) * 65281 + 8388608) >> 24) & 0xFF);
    *output++ = (cmsUInt8Number) ((((wOut[3]) * 65281 + 8388608) >> 24) & 0xFF);
    *output++ = (cmsUInt8Number) ((((wOut[4]) * 65281 + 8388608) >> 24) & 0xFF);
    *output++ = (cmsUInt8Number) ((((wOut[5]) * 65281 + 8388608) >> 24) & 0xFF);
...
cmsUInt8Number* Pack4BytesReverse(register _cmsTRANSFORM* info,
                                  ...
                                  register cmsUInt32Number Stride)
{
    *output++ = ((cmsUInt8Number) (0xff-((cmsUInt8Number) ((((wOut[0]) * 65281 + 8388608) >> 24) & 0xFF))));
    *output++ = ((cmsUInt8Number) (0xff-((cmsUInt8Number) ((((wOut[1]) * 65281 + 8388608) >> 24) & 0xFF))));
    *output++ = ((cmsUInt8Number) (0xff-((cmsUInt8Number) ((((wOut[2]) * 65281 + 8388608) >> 24) & 0xFF))));
    *output++ = ((cmsUInt8Number) (0xff-((cmsUInt8Number) ((((wOut[3]) * 65281 + 8388608) >> 24) & 0xFF))));
...
cmsUInt8Number* Pack4WordsReverse(register _cmsTRANSFORM* info,
                                  ...
                                  register cmsUInt32Number Stride)
{
    *(cmsUInt16Number*) output = ((cmsUInt16Number)(0xffff-(wOut[0])));
    output+= 2;
    *(cmsUInt16Number*) output = ((cmsUInt16Number)(0xffff-(wOut[1])));
    output+= 2;
    *(cmsUInt16Number*) output = ((cmsUInt16Number)(0xffff-(wOut[2])));
    output+= 2;
    *(cmsUInt16Number*) output = ((cmsUInt16Number)(0xffff-(wOut[3])));
    output+= 2;
...
cmsUInt8Number* Pack4WordsBigEndian(register _cmsTRANSFORM* info,
                                    ...
                                    register cmsUInt32Number Stride)
{
    *(cmsUInt16Number*) output = (cmsUInt16Number) ((cmsUInt16Number) ((wOut[0])<<8)|((wOut[0])>>8));
    output+= 2;
    *(cmsUInt16Number*) output = (cmsUInt16Number) ((cmsUInt16Number) ((wOut[1])<<8)|((wOut[1])>>8));
    output+= 2;
    *(cmsUInt16Number*) output = (cmsUInt16Number) ((cmsUInt16Number) ((wOut[2])<<8)|((wOut[2])>>8));
    output+= 2;
    *(cmsUInt16Number*) output = (cmsUInt16Number) ((cmsUInt16Number) ((wOut[3])<<8)|((wOut[3])>>8));
    output+= 2;
...
cmsUInt8Number* PackLabV2_8(register _cmsTRANSFORM* info,
                            ...
                            register cmsUInt32Number Stride)
{
    *output++ = (cmsUInt8Number) ((((FomLabV4ToLabV2(wOut[0])) * 65281 + 8388608) >> 24) & 0xFF);
    *output++ = (cmsUInt8Number) ((((FomLabV4ToLabV2(wOut[1])) * 65281 + 8388608) >> 24) & 0xFF);
    *output++ = (cmsUInt8Number) ((((FomLabV4ToLabV2(wOut[2])) * 65281 + 8388608) >> 24) & 0xFF);
...
cmsUInt8Number* Pack1ByteReversed(register _cmsTRANSFORM* info,
                                  ...
                                  register cmsUInt32Number Stride)
{
    *output++ = (cmsUInt8Number) ((((((cmsUInt16Number)(0xffff-(wOut[0])))) * 65281 + 8388608) >> 24) & 0xFF);
                                    ...
                                    register cmsUInt32Number Stride)
{
    ...
    if ((((info -> OutputFormat)>>12)&1)) {
        ...
        return output + (sizeof(cmsCIELab) + (((info ->OutputFormat)>>7)&7) * sizeof(cmsFloat64Number));
    }
}
                                    ...
                                    register cmsUInt32Number Stride)
{
    ...
    if ((((info -> OutputFormat)>>12)&1)) {
       ...
       ((cmsFloat32Number*) output)[2] = (cmsFloat32Number) Lab.b;
        ...
        return output + (3 + (((info ->OutputFormat)>>7)&7)) * sizeof(cmsFloat32Number);
    }
}
                                    ...
                                    register cmsUInt32Number Stride)
{
    if ((((Info -> OutputFormat)>>12)&1)) {
        ...
        return output + (sizeof(cmsCIEXYZ) + (((Info ->OutputFormat)>>7)&7) * sizeof(cmsFloat64Number));
    }
}
                                   ...
                                   register cmsUInt32Number Stride)
{
    if ((((Info -> OutputFormat)>>12)&1)) {
        ...
        return output + (3 * sizeof(cmsFloat32Number) + (((Info ->OutputFormat)>>7)&7) * sizeof(cmsFloat32Number));
    }
}
                                ...
                                register cmsUInt32Number Stride)
{
    ...
    int Extra = (((info -> OutputFormat)>>7)&7);
    int SwapFirst = (((info -> OutputFormat)>>14)&1);
    int Planar = (((info -> OutputFormat)>>12)&1);
    int ExtraFirst = DoSwap ^ SwapFirst;
                                      ...
                                      cmsUInt32Number Stride)
{
    ...
    if ((((Info -> OutputFormat)>>12)&1)) {
        ...
        return output + (sizeof(cmsFloat32Number)*3 + (((Info ->OutputFormat)>>7)&7) * sizeof(cmsFloat32Number));
    }
                                       ...
                                       cmsUInt32Number Stride)
{
    ...
    if ((((Info -> OutputFormat)>>12)&1)) {
        ...
        return output + (sizeof(cmsFloat64Number)*3 + (((Info ->OutputFormat)>>7)&7) * sizeof(cmsFloat64Number));
    }
                                      ...
                                      cmsUInt32Number Stride)
{
    ...
    if ((((Info -> OutputFormat)>>12)&1)) {
        ...
        Out[0] = (cmsFloat32Number) (wOut[0] * (1.0 + 32767.0/32768.0));
        Out[Stride] = (cmsFloat32Number) (wOut[1] * (1.0 + 32767.0/32768.0));
        Out[Stride*2] = (cmsFloat32Number) (wOut[2] * (1.0 + 32767.0/32768.0));
        ...
        Out[0] = (cmsFloat32Number) (wOut[0] * (1.0 + 32767.0/32768.0));
        Out[1] = (cmsFloat32Number) (wOut[1] * (1.0 + 32767.0/32768.0));
        Out[2] = (cmsFloat32Number) (wOut[2] * (1.0 + 32767.0/32768.0));
                                       ...
                                       cmsUInt32Number Stride)
{
    ...
    if ((((Info -> OutputFormat)>>12)&1)) {
        ...
        Out[0] = (cmsFloat64Number) (wOut[0] * (1.0 + 32767.0/32768.0));
        Out[Stride] = (cmsFloat64Number) (wOut[1] * (1.0 + 32767.0/32768.0));
        Out[Stride*2] = (cmsFloat64Number) (wOut[2] * (1.0 + 32767.0/32768.0));
        ...
        Out[0] = (cmsFloat64Number) (wOut[0] * (1.0 + 32767.0/32768.0));
        Out[1] = (cmsFloat64Number) (wOut[1] * (1.0 + 32767.0/32768.0));
        Out[2] = (cmsFloat64Number) (wOut[2] * (1.0 + 32767.0/32768.0));

        return output + (sizeof(cmsFloat64Number)*3 + (((Info ->OutputFormat)>>7)&7) * sizeof(cmsFloat64Number));
    }

}
# 2715 "./lcms2/src/cmspack.c"
static
...
static cmsFormatters16 InputFormatters16[] = {
    ...
    { (((1) << 22)|((10) << 16)|((3) << 3)|(0)), ((1) << 12)|((7) << 7), UnrollLabDoubleTo16},
    { (((1) << 22)|((9) << 16)|((3) << 3)|(0)), ((1) << 12)|((7) << 7), UnrollXYZDoubleTo16},
    { (((1) << 22)|((10) << 16)|((3) << 3)|(4)), ((1) << 12)|((7) << 7), UnrollLabFloatTo16},
    { (((1) << 22)|((9) << 16)|((3) << 3)|(4)), ((1) << 12)|((7) << 7), UnrollXYZFloatTo16},
    { (((1) << 22)|((3) << 16)|((1) << 3)|(0)), 0, UnrollDouble1Chan},
    { ((1) << 22)|(0), ((15) << 3)|((1) << 12)|((1) << 14)|((1) << 13)|
                                             ((1) << 10)|((7) << 7)|((31) << 16), UnrollDoubleTo16},
    { ((1) << 22)|(4), ((15) << 3)|((1) << 12)|((1) << 14)|((1) << 13)|
                                             ((1) << 10)|((7) << 7)|((31) << 16), UnrollFloatTo16},

    { ((1) << 22)|(2), ((15) << 3)|((1) << 12)|((1) << 14)|((1) << 13)|
                                            ((7) << 7)|((1) << 10)|((31) << 16), UnrollHalfTo16},


    { ((1) << 3)|(1), ((31) << 16), Unroll1Byte},
    { ((1) << 3)|(1)|((1) << 7), ((31) << 16), Unroll1ByteSkip1},
    { ((1) << 3)|(1)|((2) << 7), ((31) << 16), Unroll1ByteSkip2},
    { ((1) << 3)|(1)|((1) << 13), ((31) << 16), Unroll1ByteReversed},
    { ((16) << 16)|((2) << 3)|(1), 0, Unroll2Bytes},

    { (((30) << 16)|((3) << 3)|(1)), 0, UnrollLabV2_8 },
    { (((30) << 16)|((3) << 3)|(1)|((1) << 7)|((1) << 14)), 0, UnrollALabV2_8 },
    { (((30) << 16)|((3) << 3)|(2)), 0, UnrollLabV2_16 },

    { ((3) << 3)|(1), ((31) << 16), Unroll3Bytes},
    { ((3) << 3)|(1)|((1) << 10), ((31) << 16), Unroll3BytesSwap},
    { ((3) << 3)|((1) << 7)|(1)|((1) << 10), ((31) << 16), Unroll3BytesSkip1Swap},
    { ((3) << 3)|((1) << 7)|(1)|((1) << 14), ((31) << 16), Unroll3BytesSkip1SwapFirst},

    { ((3) << 3)|((1) << 7)|(1)|((1) << 10)|((1) << 14),
                                                               ((31) << 16), Unroll3BytesSkip1SwapSwapFirst},

    { ((4) << 3)|(1), ((31) << 16), Unroll4Bytes},
    { ((4) << 3)|(1)|((1) << 13), ((31) << 16), Unroll4BytesReverse},
    { ((4) << 3)|(1)|((1) << 14), ((31) << 16), Unroll4BytesSwapFirst},
    { ((4) << 3)|(1)|((1) << 10), ((31) << 16), Unroll4BytesSwap},
    { ((4) << 3)|(1)|((1) << 10)|((1) << 14), ((31) << 16), Unroll4BytesSwapSwapFirst},

    { (1)|((1) << 12), ((1) << 13)|((1) << 14)|
                                   ((1) << 10)|((7) << 7)|((15) << 3)|((31) << 16), UnrollPlanarBytes},

    { (1), ((1) << 13)|((1) << 14)|((1) << 10)|
                                           ((7) << 7)|((15) << 3)|((31) << 16), UnrollChunkyBytes},

    { ((1) << 3)|(2), ((31) << 16), Unroll1Word},
    { ((1) << 3)|(2)|((1) << 13), ((31) << 16), Unroll1WordReversed},
    { ((1) << 3)|(2)|((3) << 7), ((31) << 16), Unroll1WordSkip3},

    { ((2) << 3)|(2), ((31) << 16), Unroll2Words},
    { ((3) << 3)|(2), ((31) << 16), Unroll3Words},
    { ((4) << 3)|(2), ((31) << 16), Unroll4Words},

    { ((3) << 3)|(2)|((1) << 10), ((31) << 16), Unroll3WordsSwap},
    { ((3) << 3)|(2)|((1) << 7)|((1) << 14), ((31) << 16), Unroll3WordsSkip1SwapFirst},
    { ((3) << 3)|(2)|((1) << 7)|((1) << 10), ((31) << 16), Unroll3WordsSkip1Swap},
    { ((4) << 3)|(2)|((1) << 13), ((31) << 16), Unroll4WordsReverse},
    { ((4) << 3)|(2)|((1) << 14), ((31) << 16), Unroll4WordsSwapFirst},
    { ((4) << 3)|(2)|((1) << 10), ((31) << 16), Unroll4WordsSwap},
    { ((4) << 3)|(2)|((1) << 10)|((1) << 14), ((31) << 16), Unroll4WordsSwapSwapFirst},


    { (2)|((1) << 12), ((1) << 13)|((1) << 10)|((1) << 11)|((7) << 7)|((15) << 3)|((31) << 16), UnrollPlanarWords},
    { (2), ((1) << 13)|((1) << 14)|((1) << 10)|((1) << 11)|((7) << 7)|((15) << 3)|((31) << 16), UnrollAnyWords},
};
...
static cmsFormattersFloat InputFormattersFloat[] = {
    ...
    { (((1) << 22)|((10) << 16)|((3) << 3)|(0)), ((1) << 12)|((7) << 7), UnrollLabDoubleToFloat},
    { (((1) << 22)|((10) << 16)|((3) << 3)|(4)), ((1) << 12)|((7) << 7), UnrollLabFloatToFloat},

    { (((1) << 22)|((9) << 16)|((3) << 3)|(0)), ((1) << 12)|((7) << 7), UnrollXYZDoubleToFloat},
    { (((1) << 22)|((9) << 16)|((3) << 3)|(4)), ((1) << 12)|((7) << 7), UnrollXYZFloatToFloat},

    { ((1) << 22)|(4), ((1) << 12)|((1) << 14)|((1) << 10)|((7) << 7)|
                                                      ((15) << 3)|((31) << 16), UnrollFloatsToFloat},

    { ((1) << 22)|(0), ((1) << 12)|((1) << 14)|((1) << 10)|((7) << 7)|
                                                        ((15) << 3)|((31) << 16), UnrollDoublesToFloat},

    { ((1) << 22)|(2), ((1) << 12)|((1) << 14)|((1) << 10)|((7) << 7)|
                                                        ((15) << 3)|((31) << 16), UnrollHalfToFloat},
...
static cmsFormatters16 OutputFormatters16[] = {
    ...
    { (((1) << 22)|((10) << 16)|((3) << 3)|(0)), ((1) << 12)|((7) << 7), PackLabDoubleFrom16},
    { (((1) << 22)|((9) << 16)|((3) << 3)|(0)), ((1) << 12)|((7) << 7), PackXYZDoubleFrom16},

    { (((1) << 22)|((10) << 16)|((3) << 3)|(4)), ((1) << 12)|((7) << 7), PackLabFloatFrom16},
    { (((1) << 22)|((9) << 16)|((3) << 3)|(4)), ((1) << 12)|((7) << 7), PackXYZFloatFrom16},

    { ((1) << 22)|(0), ((1) << 13)|((1) << 14)|((1) << 10)|
                                    ((15) << 3)|((1) << 12)|((7) << 7)|((31) << 16), PackDoubleFrom16},
    { ((1) << 22)|(4), ((1) << 13)|((1) << 14)|((1) << 10)|
                                    ((15) << 3)|((1) << 12)|((7) << 7)|((31) << 16), PackFloatFrom16},

    { ((1) << 22)|(2), ((1) << 13)|((1) << 14)|((1) << 10)|
                                    ((15) << 3)|((1) << 12)|((7) << 7)|((31) << 16), PackHalfFrom16},


    { ((1) << 3)|(1), ((31) << 16), Pack1Byte},
    { ((1) << 3)|(1)|((1) << 7), ((31) << 16), Pack1ByteSkip1},
    { ((1) << 3)|(1)|((1) << 7)|((1) << 14), ((31) << 16), Pack1ByteSkip1SwapFirst},

    { ((1) << 3)|(1)|((1) << 13), ((31) << 16), Pack1ByteReversed},

    { (((30) << 16)|((3) << 3)|(1)), 0, PackLabV2_8 },
    { (((30) << 16)|((3) << 3)|(1)|((1) << 7)|((1) << 14)), 0, PackALabV2_8 },
    { (((30) << 16)|((3) << 3)|(2)), 0, PackLabV2_16 },

    { ((3) << 3)|(1)|((1) << 21), ((31) << 16), Pack3BytesOptimized},
    { ((3) << 3)|(1)|((1) << 7)|((1) << 21), ((31) << 16), Pack3BytesAndSkip1Optimized},
    { ((3) << 3)|(1)|((1) << 7)|((1) << 14)|((1) << 21),
                                                                   ((31) << 16), Pack3BytesAndSkip1SwapFirstOptimized},
    { ((3) << 3)|(1)|((1) << 7)|((1) << 10)|((1) << 14)|((1) << 21),
                                                                   ((31) << 16), Pack3BytesAndSkip1SwapSwapFirstOptimized},
    { ((3) << 3)|(1)|((1) << 10)|((1) << 7)|((1) << 21),
                                                                   ((31) << 16), Pack3BytesAndSkip1SwapOptimized},
    { ((3) << 3)|(1)|((1) << 10)|((1) << 21), ((31) << 16), Pack3BytesSwapOptimized},



    { ((3) << 3)|(1), ((31) << 16), Pack3Bytes},
    { ((3) << 3)|(1)|((1) << 7), ((31) << 16), Pack3BytesAndSkip1},
    { ((3) << 3)|(1)|((1) << 7)|((1) << 14), ((31) << 16), Pack3BytesAndSkip1SwapFirst},
    { ((3) << 3)|(1)|((1) << 7)|((1) << 10)|((1) << 14),
                                                                   ((31) << 16), Pack3BytesAndSkip1SwapSwapFirst},
    { ((3) << 3)|(1)|((1) << 10)|((1) << 7), ((31) << 16), Pack3BytesAndSkip1Swap},
    { ((3) << 3)|(1)|((1) << 10), ((31) << 16), Pack3BytesSwap},
    { ((6) << 3)|(1), ((31) << 16), Pack6Bytes},
    { ((6) << 3)|(1)|((1) << 10), ((31) << 16), Pack6BytesSwap},
    { ((4) << 3)|(1), ((31) << 16), Pack4Bytes},
    { ((4) << 3)|(1)|((1) << 13), ((31) << 16), Pack4BytesReverse},
    { ((4) << 3)|(1)|((1) << 14), ((31) << 16), Pack4BytesSwapFirst},
    { ((4) << 3)|(1)|((1) << 10), ((31) << 16), Pack4BytesSwap},
    { ((4) << 3)|(1)|((1) << 10)|((1) << 14), ((31) << 16), Pack4BytesSwapSwapFirst},

    { (1), ((1) << 13)|((1) << 14)|((1) << 10)|((7) << 7)|((15) << 3)|((31) << 16), PackAnyBytes},
    { (1)|((1) << 12), ((1) << 13)|((1) << 14)|((1) << 10)|((7) << 7)|((15) << 3)|((31) << 16), PackPlanarBytes},

    { ((1) << 3)|(2), ((31) << 16), Pack1Word},
    { ((1) << 3)|(2)|((1) << 7), ((31) << 16), Pack1WordSkip1},
    { ((1) << 3)|(2)|((1) << 7)|((1) << 14), ((31) << 16), Pack1WordSkip1SwapFirst},
    { ((1) << 3)|(2)|((1) << 13), ((31) << 16), Pack1WordReversed},
    { ((1) << 3)|(2)|((1) << 11), ((31) << 16), Pack1WordBigEndian},
    { ((3) << 3)|(2), ((31) << 16), Pack3Words},
    { ((3) << 3)|(2)|((1) << 10), ((31) << 16), Pack3WordsSwap},
    { ((3) << 3)|(2)|((1) << 11), ((31) << 16), Pack3WordsBigEndian},
    { ((3) << 3)|(2)|((1) << 7), ((31) << 16), Pack3WordsAndSkip1},
    { ((3) << 3)|(2)|((1) << 7)|((1) << 10), ((31) << 16), Pack3WordsAndSkip1Swap},
    { ((3) << 3)|(2)|((1) << 7)|((1) << 14), ((31) << 16), Pack3WordsAndSkip1SwapFirst},

    { ((3) << 3)|(2)|((1) << 7)|((1) << 10)|((1) << 14),
                                                                   ((31) << 16), Pack3WordsAndSkip1SwapSwapFirst},

    { ((4) << 3)|(2), ((31) << 16), Pack4Words},
    { ((4) << 3)|(2)|((1) << 13), ((31) << 16), Pack4WordsReverse},
    { ((4) << 3)|(2)|((1) << 10), ((31) << 16), Pack4WordsSwap},
    { ((4) << 3)|(2)|((1) << 11), ((31) << 16), Pack4WordsBigEndian},

    { ((6) << 3)|(2), ((31) << 16), Pack6Words},
    { ((6) << 3)|(2)|((1) << 10), ((31) << 16), Pack6WordsSwap},

    { (2)|((1) << 12), ((1) << 13)|((1) << 11)|((1) << 10)|((7) << 7)|((15) << 3)|((31) << 16), PackPlanarWords},
    { (2), ((1) << 13)|((1) << 14)|((1) << 10)|((1) << 11)|((7) << 7)|((15) << 3)|((31) << 16), PackAnyWords}
...
static cmsFormattersFloat OutputFormattersFloat[] = {
    ...
    { (((1) << 22)|((10) << 16)|((3) << 3)|(4)), ((1) << 12)|((7) << 7), PackLabFloatFromFloat},
    { (((1) << 22)|((9) << 16)|((3) << 3)|(4)), ((1) << 12)|((7) << 7), PackXYZFloatFromFloat},

    { (((1) << 22)|((10) << 16)|((3) << 3)|(0)), ((1) << 12)|((7) << 7), PackLabDoubleFromFloat},
    { (((1) << 22)|((9) << 16)|((3) << 3)|(0)), ((1) << 12)|((7) << 7), PackXYZDoubleFromFloat},

    { ((1) << 22)|(4), ((1) << 12)|
                             ((1) << 13)|((1) << 14)|((1) << 10)|((7) << 7)|((15) << 3)|((31) << 16), PackFloatsFromFloat },
    { ((1) << 22)|(0), ((1) << 12)|
                             ((1) << 13)|((1) << 14)|((1) << 10)|((7) << 7)|((15) << 3)|((31) << 16), PackDoublesFromFloat },

    { ((1) << 22)|(2),
                             ((1) << 13)|((1) << 14)|((1) << 10)|((7) << 7)|((15) << 3)|((31) << 16), PackHalfFromFloat },
...
_cmsFormattersPluginChunkType _cmsFormattersPluginChunk = { ((void*)0) };
                                               ...
                                               const struct _cmsContext_struct* src)
{
   ...
   _cmsFormattersPluginChunkType* head = (_cmsFormattersPluginChunkType*) src->chunks[FormattersPlugin];
     ...
     (((head != ((void*)0))) ? (void) (0) : __assert_fail ("(head != ((void*)0))", "./lcms2/src/cmspack.c", 3240, __PRETTY_FUNCTION__));
...
void _cmsAllocFormattersPluginChunk(struct _cmsContext_struct* ctx,
                                    const struct _cmsContext_struct* src)
{
      (((ctx != ((void*)0))) ? (void) (0) : __assert_fail ("(ctx != ((void*)0))", "./lcms2/src/cmspack.c", 3270, __PRETTY_FUNCTION__));
                             ...
                             cmsUInt32Number dwFlags)
{
    ...
    for (f =ctx->FactoryList; f != ((void*)0); f = f ->Next) {

        cmsFormatter fn = f ->Factory(Type, Dir, dwFlags);
        if (fn.Fmt16 != ((void*)0)) return fn;
    }
...
cmsUInt32Number cmsFormatterForColorspaceOfProfile(cmsHPROFILE hProfile, cmsUInt32Number nBytes, cmsBool lIsFloat)
{
    ...
    return ((Float) << 22) | ((ColorSpaceBits) << 16) | (nBytes) | ((nOutputChans) << 3);
}
