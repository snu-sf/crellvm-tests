...
# 30 "./base/gximage3.c" 2


static int gx_begin_image3(gx_device *dev, const gs_imager_state *pis, const gs_matrix *pmat, const gs_image_common_t *pim, const gs_int_rect *prect, const gx_drawing_color *pdcolor, const gx_clip_path *pcpath, gs_memory_t *memory, gx_image_enum_common_t **pinfo);
static int gx_image3_plane_data(gx_image_enum_common_t *info, const gx_image_plane_t *planes, int height, int *rows_used);
static int gx_image3_end_image(gx_image_enum_common_t *info, bool draw_last);
static int gx_image3_flush(gx_image_enum_common_t *info);
static bool gx_image3_planes_wanted(const gx_image_enum_common_t *info, byte *wanted);


static const gc_struct_data_t image3_reloc_ptrs = { 0, 0, &st_gs_pixel_image, 0 }; static const gs_memory_struct_type_t st_gs_image3 = { sizeof(gs_image3_t), "gs_image3_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &image3_reloc_ptrs };
...
extern const gs_memory_struct_type_t st_gx_image_enum_common;
static const gc_ptr_element_t image3_enum_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3_enum_t *)0)->mdev - (char *)((gx_image3_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3_enum_t *)0)->pcdev - (char *)((gx_image3_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3_enum_t *)0)->pixel_info - (char *)((gx_image3_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3_enum_t *)0)->mask_info - (char *)((gx_image3_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3_enum_t *)0)->pixel_data - (char *)((gx_image3_enum_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_image3_enum_t *)0)->mask_data - (char *)((gx_image3_enum_t *)0) )) } }; static const gc_struct_data_t image3_enum_reloc_ptrs = { (sizeof(image3_enum_enum_ptrs) / sizeof((image3_enum_enum_ptrs)[0])), 0, &st_gx_image_enum_common, image3_enum_enum_ptrs }; static const gs_memory_struct_type_t st_image3_enum = { sizeof(gx_image3_enum_t), "gx_image3_enum_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &image3_enum_reloc_ptrs };




static int make_mid_default(gx_device **pmidev, gx_device *dev, int width, int height, gs_memory_t *mem);
static int
make_mid_default(gx_device **pmidev, gx_device *dev, int width, int height,
                 gs_memory_t *mem)
{
    gx_device_memory *midev =
        (gx_device_memory *)(*(mem)->procs.alloc_struct)(mem, &st_device_memory, "make_mid_default");

    int code;

    if (midev == 0)
        return ((-25));
    gs_make_mem_mono_device(midev, mem, ((void*)0));
    ...
    if (code < 0) {
        ((mem)->procs.free_object(mem, midev, "make_mid_default"));
        return code;
    }
...
static int make_mcde_default( gx_device *dev, const gs_imager_state *pis, const gs_matrix *pmat, const gs_image_common_t *pic, const gs_int_rect *prect, const gx_drawing_color *pdcolor, const gx_clip_path *pcpath, gs_memory_t *mem, gx_image_enum_common_t **pinfo, gx_device **pmcdev, gx_device *midev, gx_image_enum_common_t *pminfo, const gs_int_point *origin);
static int
                  ...
                  const gs_int_point *origin)
{
    ...
    gx_device_mask_clip *mcdev =
        (gx_device_mask_clip *)(*(mem)->procs.alloc_struct)(mem, &st_device_mask_clip, "make_mcde_default");
    ...
    if (code < 0) {
        ((mem)->procs.free_object(mem, mcdev, "make_mcde_default"));
        return code;
    }
    mcdev->tiles = bits;
    code = ((mcdev)->procs.begin_typed_image)
                        ...
                        gx_image_enum_common_t **pinfo)
{
    ...
    if (fabs(mi_pixel.tx - mi_mask.tx) >= 0.5 ||
        ...
        return ((-15));
# 287 "./base/gximage3.c"
    penum = (gx_image3_enum_t *)(*(mem)->procs.alloc_struct)(mem, &st_image3_enum, "gx_begin_image3");
    ...
    if (pim->InterleaveType == interleave_chunky) {
        ...
        penum->pixel_data =
            (*(mem)->procs.alloc_bytes)(mem, (penum->pixel_width * pim->BitsPerComponent * penum->num_components + 7) >> 3, "gx_begin_image3(pixel_data)");



        penum->mask_data =
            (*(mem)->procs.alloc_bytes)(mem, (penum->mask_width + 7) >> 3, "gx_begin_image3(mask_data)");
    ...
    if (code < 0)
        goto out1;
    penum->mdev = mdev;
    gs_image_t_init_mask_adjust(&i_mask, ((bool)0), ((bool)1));
    i_mask.adjust = ((bool)0);
    {
    ...
    }
    {
        ...
        ((&dcolor)->colors.pure = (1), (&dcolor)->type = gx_dc_type_pure); (&dcolor)->ccolor_valid = ((bool)0);
        ...
        code = ((*((mdev)->procs.begin_typed_image)) (mdev, ((void*)0), &m_mat, (const gs_image_common_t *)&i_mask, &mask_rect, &dcolor, ((void*)0), mem, &penum->mask_info));
    ...
    gs_image_t_init_adjust(&i_pixel, pim->ColorSpace, ((bool)1));
    {
    ...
    gx_device_retain(mdev, ((bool)1));
    gx_device_retain(pcdev, ((bool)1));
    *pinfo = (gx_image_enum_common_t *) penum;
    return 0;
  out3:
    gx_image_end(penum->mask_info, ((bool)0));
  out2:
    gs_closedevice(mdev);
    ((mem)->procs.free_object(mem, mdev, "gx_begin_image3(mdev)"));
  out1:
    ((mem)->procs.free_object(mem, penum->mask_data, "gx_begin_image3(mask_data)"));
    ((mem)->procs.free_object(mem, penum->pixel_data, "gx_begin_image3(pixel_data)"));
    ((mem)->procs.free_object(mem, penum, "gx_begin_image3"));
    return code;
}
static bool
                     ...
                     int *rows_used)
{
    ...
    int mask_used = 0;
    int h1 = (((pixel_height - penum->pixel_y) > (mask_height - penum->mask_y)) ? (pixel_height - penum->pixel_y) : (mask_height - penum->mask_y));
    int h = (((height) < (h1)) ? (height) : (h1));
        ...
        case interleave_chunky:
            ...
            if (h > 1) {
                ...
                *rows_used = h_orig - h;
                ...
                byte *mptr = (penum->mask_data); int mbit = (0); byte mbbyte = ((mbit) ? (byte)(*(mptr) & (0xff00 >> (mbit))) : 0);

                byte *pptr = (penum->pixel_data); int pbit = (0); byte pbbyte = ((pbit) ? (byte)(*(pptr) & (0xff00 >> (pbit))) : 0);
                ...
                for (x = 0; x < width; ++x) {
                    ...
                    do { switch ( (1) >> 2 ) { case 0: if ( (mbit += (1)) == 8 ) *(mptr)++ = mbbyte | (byte)(value != 0), mbbyte = 0, mbit = 0; else mbbyte |= (byte)((value != 0) << (8 - mbit)); break; case 1: if ( mbit ^= 4 ) mbbyte = (byte)((value != 0) << 4); else *(mptr)++ = mbbyte | ((byte)(value != 0)); break; case 3: if ( mbit ^= 4 ) *(mptr)++ = (byte)((value != 0) >> 4), mbbyte = (byte)((value != 0) << 4); else *(mptr) = mbbyte | (byte)((value != 0) >> 8), (mptr)[1] = (byte)(value != 0), mptr += 2; break; case 2: *(mptr)++ = (byte)(value != 0); break; default: return ((-15)); } } while (0);
                ...
                if ( (mbit) != 0 ) *(mptr) = mbbyte | (*(mptr) & (0xff >> (mbit)));;
...
gx_image3_end_image(gx_image_enum_common_t * info, bool draw_last)
{
    ...
    ((mem)->procs.free_object(mem, penum->mask_data, "gx_image3_end_image(mask_data)"));

    ((mem)->procs.free_object(mem, penum->pixel_data, "gx_image3_end_image(pixel_data)"));

    ((mem)->procs.free_object(mem, pcdev, "gx_image3_end_image(pcdev)"));
    ((mem)->procs.free_object(mem, mdev, "gx_image3_end_image(mdev)"));
