# 1 "./lcms2/src/cmsmd5.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmsmd5.c" 2
# 27 "./lcms2/src/cmsmd5.c"
...
# 28 "./lcms2/src/cmsmd5.c" 2
# 49 "./lcms2/src/cmsmd5.c"
typedef struct {
...
cmsBool cmsMD5computeID(cmsHPROFILE hProfile)
{
    ...
    cmsUInt8Number* Mem = ((void*)0);
    cmsHANDLE MD5 = ((void*)0);
    _cmsICCPROFILE* Icc = (_cmsICCPROFILE*) hProfile;
    _cmsICCPROFILE Keep;

    (((hProfile != ((void*)0))) ? (void) (0) : __assert_fail ("(hProfile != ((void*)0))", "./lcms2/src/cmsmd5.c", 270, __PRETTY_FUNCTION__));
    ...
    if (!cmsSaveProfileToMem(hProfile, ((void*)0), &BytesNeeded)) goto Error;


    Mem = (cmsUInt8Number*) _cmsMalloc(ContextID, BytesNeeded);
    if (Mem == ((void*)0)) goto Error;
...
Error:
    ...
    if (Mem != ((void*)0)) _cmsFree(ContextID, Mem);
    memmove(Icc, &Keep, sizeof(_cmsICCPROFILE));
    return 0;
}
