# 1 "./lcms2/src/cmserr.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmserr.c" 2
# 26 "./lcms2/src/cmserr.c"
...
int cmsstrcasecmp(const char* s1, const char* s2)
{
    ...
    while ((__extension__ ({ int __res; if (sizeof (*us1) > 1) { if (__builtin_constant_p (*us1)) { int __c = (*us1); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (*us1); } else __res = (*__ctype_toupper_loc ())[(int) (*us1)]; __res; })) == (__extension__ ({ int __res; if (sizeof (*us2++) > 1) { if (__builtin_constant_p (*us2++)) { int __c = (*us2++); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (*us2++); } else __res = (*__ctype_toupper_loc ())[(int) (*us2++)]; __res; })))
        if (*us1++ == '\0')
            return 0;

    return ((__extension__ ({ int __res; if (sizeof (*us1) > 1) { if (__builtin_constant_p (*us1)) { int __c = (*us1); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (*us1); } else __res = (*__ctype_toupper_loc ())[(int) (*us1)]; __res; })) - (__extension__ ({ int __res; if (sizeof (*--us2) > 1) { if (__builtin_constant_p (*--us2)) { int __c = (*--us2); __res = __c < -128 || __c > 255 ? __c : (*__ctype_toupper_loc ())[__c]; } else __res = toupper (*--us2); } else __res = (*__ctype_toupper_loc ())[(int) (*--us2)]; __res; })));
}
...
{
    if (size > ((cmsUInt32Number)(1024U*1024U*512U))) return ((void*)0);
...
void* _cmsCallocDefaultFn(cmsContext ContextID, cmsUInt32Number num, cmsUInt32Number size)
{
    ...
    if (num >= (2147483647 *2U +1U) / size) return ((void*)0);
    ...
    if (Total > ((cmsUInt32Number)(1024U*1024U*512U))) return ((void*)0);
...
{
    (((ctx != ((void*)0))) ? (void) (0) : __assert_fail ("(ctx != ((void*)0))", "./lcms2/src/cmserr.c", 180, __PRETTY_FUNCTION__));
...
void _cmsInstallAllocFunctions(cmsPluginMemHandler* Plugin, _cmsMemPluginChunkType* ptr)
{
    if (Plugin == ((void*)0)) {
        ...
        if (Plugin ->MallocZeroPtr != ((void*)0)) ptr ->MallocZeroPtr = Plugin -> MallocZeroPtr;
        if (Plugin ->CallocPtr != ((void*)0)) ptr ->CallocPtr = Plugin -> CallocPtr;
        if (Plugin ->DupPtr != ((void*)0)) ptr ->DupPtr = Plugin -> DupPtr;
...
cmsBool _cmsRegisterMemHandlerPlugin(cmsContext ContextID, cmsPluginBase *Data)
{
    ...
    if (Plugin -> MallocPtr == ((void*)0) ||
        ...
        Plugin -> ReallocPtr == ((void*)0)) return 0;
...
void _cmsSubAllocDestroy(_cmsSubAllocator* sub)
{
    ...
    for (chunk = sub ->h; chunk != ((void*)0); chunk = n) {

        n = chunk->next;
        if (chunk->Block != ((void*)0)) _cmsFree(sub ->ContextID, chunk->Block);
...
void* _cmsSubAllocDup(_cmsSubAllocator* s, const void *ptr, cmsUInt32Number size)
{
    ...
    if (ptr != ((void*)0) && NewPtr != ((void*)0)) {
        memcpy(NewPtr, ptr, size);
    }

    return NewPtr;
}
# 443 "./lcms2/src/cmserr.c"
...
void cmsSetLogErrorHandler(cmsLogErrorHandlerFunction Fn)
{
    cmsSetLogErrorHandlerTHR(((void*)0), Fn);
}
...
void cmsSignalError(cmsContext ContextID, cmsUInt32Number ErrorCode, const char *ErrorText, ...)
{
    ...
    __builtin_va_start(args, ErrorText);
    vsnprintf(Buffer, 1024 -1, ErrorText, args);
...
cmsBool _cmsRegisterMutexPlugin(cmsContext ContextID, cmsPluginBase* Data)
{
    ...
    if (Plugin ->CreateMutexPtr == ((void*)0) || Plugin ->DestroyMutexPtr == ((void*)0) ||
        Plugin ->LockMutexPtr == ((void*)0) || Plugin ->UnlockMutexPtr == ((void*)0)) return 0;
...
void* _cmsCreateMutex(cmsContext ContextID)
{
    ...
    if (ptr ->CreateMutexPtr == ((void*)0)) return ((void*)0);
...
cmsBool _cmsLockMutex(cmsContext ContextID, void* mtx)
{
    ...
    if (ptr ->LockMutexPtr == ((void*)0)) return 1;
