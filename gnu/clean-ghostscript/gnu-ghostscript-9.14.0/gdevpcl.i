...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/gdevpcl.c" 2
# 18 "./devices/gdevpcl.c"
# 1 "./base/gdevprn.h" 1
# 22 "./base/gdevprn.h"
# 1 "./base/memory_.h" 1
# 23 "./base/memory_.h"
...
{
    float width_inches = dev->width / dev->HWResolution[0];
    float height_inches = dev->height / dev->HWResolution[1];
    ...
    if (dev->width > dev->height) {
        ...
        width_inches = dev->height / dev->HWResolution[1];
        height_inches = dev->width / dev->HWResolution[0];
    }
# 72 "./devices/gdevpcl.c"
    new_width_difference = 7.25 - width_inches; new_height_difference = 10.5 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 1; };
    new_width_difference = 8.5 - width_inches; new_height_difference = 11.0 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 2; };
    new_width_difference = 8.5 - width_inches; new_height_difference = 14.0 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 3; };
    new_width_difference = 11.0 - width_inches; new_height_difference = 17.0 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 6; };
    new_width_difference = 5.83 - width_inches; new_height_difference = 8.27 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 25; };
    new_width_difference = 8.27 - width_inches; new_height_difference = 11.69 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 26; };
    new_width_difference = 11.69 - width_inches; new_height_difference = 16.54 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 27; };
    new_width_difference = 16.54 - width_inches; new_height_difference = 23.39 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 28; };
    new_width_difference = 23.39 - width_inches; new_height_difference = 33.11 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 29; };
    new_width_difference = 33.11 - width_inches; new_height_difference = 46.81 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 30; };
    new_width_difference = 7.16 - width_inches; new_height_difference = 10.12 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 45; };
    new_width_difference = 10.12 - width_inches; new_height_difference = 14.33 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 46; };
    new_width_difference = 3.94 - width_inches; new_height_difference = 5.83 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 71; };
    new_width_difference = 5.83 - width_inches; new_height_difference = 7.87 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 72; };
    new_width_difference = 3.87 - width_inches; new_height_difference = 7.5 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 80; };
    new_width_difference = 4.12 - width_inches; new_height_difference = 9.5 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 81; };
    new_width_difference = 4.33 - width_inches; new_height_difference = 8.66 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 90; };
    new_width_difference = 6.38 - width_inches; new_height_difference = 9.01 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 91; };
    new_width_difference = 6.93 - width_inches; new_height_difference = 9.84 - height_inches; if ((new_width_difference > -0.01) && (new_height_difference > -0.01) && ((width_difference == -1.0) || (new_width_difference < width_difference) || ((new_width_difference == width_difference) && (new_height_difference < height_difference)))) { width_difference = new_width_difference; height_difference = new_height_difference; code = 100; };
...
# 118 "./devices/gdevpcl.c"
gx_color_index
gdev_pcl_3bit_map_rgb_color(gx_device * dev, const gx_color_value cv[])
{
    gx_color_value r, g, b;
    r = cv[0]; g = cv[1]; b = cv[2];
    return (((b >> (sizeof(gx_color_value) * 8 - 1)) << 2) + ((g >> (sizeof(gx_color_value) * 8 - 1)) << 1) + (r >> (sizeof(gx_color_value) * 8 - 1))) ^ 7;
}
...
gdev_pcl_mode2compress(const word * row, const word * end_row,
                       byte * compressed)
{
    return gdev_pcl_mode2compress_padded(row, end_row, compressed, ((bool)0));
}
# 267 "./devices/gdevpcl.c"
int
gdev_pcl_mode3compress(int bytecount, const byte * current, byte * previous, byte * compressed)
{
        ...
        offset = diff - run;
        {
            ...
            while (diff < cur) {
                ...
                if ((similar = next - diff)) {
                    ...
                    if ((temp = (similar -= 2)) > 31)
                        temp = 31;
                    if (offset < 3)
                        *out++ = 0x80 | (offset << 5) | (byte) temp;
                    else {
                        *out++ = 0x80 | (3 << 5) | (byte) temp;
                        offset -= 3;
                        while (offset >= 255) {
                            *out++ = 255;
                            offset -= 255;
