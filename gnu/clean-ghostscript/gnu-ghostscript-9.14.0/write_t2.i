                   ...
                   unsigned char *a_private_dict_length_ptr)
{
    ...
    write_delta_array_entry(a_fapi_font, a_output,
                            gs_fapi_font_feature_BlueValues, ((bool)0), 6, 16);
    write_delta_array_entry(a_fapi_font, a_output,
                            gs_fapi_font_feature_OtherBlues, ((bool)0), 7, 16);
    write_delta_array_entry(a_fapi_font, a_output,
                            gs_fapi_font_feature_FamilyBlues, ((bool)0), 8, 16);
    write_delta_array_entry(a_fapi_font, a_output,
                            gs_fapi_font_feature_FamilyOtherBlues, ((bool)0), 9,
                            16);
    ...
    write_word_entry(a_fapi_font, a_output, gs_fapi_font_feature_StdVW, 1,
                     ((bool)0), 11, 16);
    write_delta_array_entry(a_fapi_font, a_output,
                            gs_fapi_font_feature_StemSnapH, ((bool)1), 12, 16);
    write_delta_array_entry(a_fapi_font, a_output,
                            gs_fapi_font_feature_StemSnapV, ((bool)1), 13, 16);
...

    {
        ...
        write_type2_float(a_output, ((t1->data.defaultWidthX)*(1.0/(1<<8))));
        WRF_wbyte(a_output, 20);
        write_type2_float(a_output, ((t1->data.nominalWidthX)*(1.0/(1<<8))));
...
{
    unsigned char *charset_offset_ptr = ((void*)0);
    unsigned char *charstrings_offset_ptr = ((void*)0);
    unsigned char *private_dict_length_ptr = ((void*)0);
    int characters = 0;
