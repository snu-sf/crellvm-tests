...
{
    int code = gs_matrix_invert(&(*(const gs_matrix *)&(pgs)->ctm), &pgs->ctm_inverse);

    do { } while (0);
    if (code < 0)
        return code;
    pgs->ctm_inverse_valid = ((bool)1);
    return 0;
}
# 98 "./base/gscoord.c"
int
gs_initmatrix(gs_state * pgs)
{
    ...
    (pgs->ctm_inverse_valid = ((bool)0), pgs->char_tm_valid = ((bool)0), ((pgs->ctm).txy_fixed_valid = (((imat.tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (imat.tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((imat.ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (imat.ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? (((pgs->ctm).tx = (imat.tx), ((((pgs->ctm).tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->ctm).tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->ctm).tx_fixed = ((fixed)(((pgs->ctm).tx)*(float)(1<<8))), 0) : ((-13)))), ((pgs->ctm).ty = (imat.ty), ((((pgs->ctm).ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->ctm).ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->ctm).ty_fixed = ((fixed)(((pgs->ctm).ty)*(float)(1<<8))), 0) : ((-13)))), ((bool)1)) : ((pgs->ctm).tx = (imat.tx), (pgs->ctm).ty = (imat.ty), ((bool)0)))));
    (*(gs_matrix *)&(pgs)->ctm = (imat));
...
{
    gs_matrix cmat;
    int code = gs_matrix_multiply(pmat, &(*(const gs_matrix *)&(pgs)->ctm), &cmat);

    if (code < 0)
        return code;
    ((pgs->char_tm).txy_fixed_valid = (((cmat.tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (cmat.tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((cmat.ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (cmat.ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? (((pgs->char_tm).tx = (cmat.tx), ((((pgs->char_tm).tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->char_tm).tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->char_tm).tx_fixed = ((fixed)(((pgs->char_tm).tx)*(float)(1<<8))), 0) : ((-13)))), ((pgs->char_tm).ty = (cmat.ty), ((((pgs->char_tm).ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->char_tm).ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->char_tm).ty_fixed = ((fixed)(((pgs->char_tm).ty)*(float)(1<<8))), 0) : ((-13)))), ((bool)1)) : ((pgs->char_tm).tx = (cmat.tx), (pgs->char_tm).ty = (cmat.ty), ((bool)0))));
    *(gs_matrix *)&(pgs)->char_tm = cmat;




    pgs->char_tm_valid = ((bool)1);
    return 0;
}
...
{
    (pgs->ctm_inverse_valid = ((bool)0), pgs->char_tm_valid = ((bool)0), ((pgs->ctm).txy_fixed_valid = (((pmat->tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (pmat->tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((pmat->ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (pmat->ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? (((pgs->ctm).tx = (pmat->tx), ((((pgs->ctm).tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->ctm).tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->ctm).tx_fixed = ((fixed)(((pgs->ctm).tx)*(float)(1<<8))), 0) : ((-13)))), ((pgs->ctm).ty = (pmat->ty), ((((pgs->ctm).ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->ctm).ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->ctm).ty_fixed = ((fixed)(((pgs->ctm).ty)*(float)(1<<8))), 0) : ((-13)))), ((bool)1)) : ((pgs->ctm).tx = (pmat->tx), (pgs->ctm).ty = (pmat->ty), ((bool)0)))));
...
{
    ((pis->ctm).txy_fixed_valid = (((pmat->tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (pmat->tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((pmat->ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (pmat->ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? (((pis->ctm).tx = (pmat->tx), ((((pis->ctm).tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pis->ctm).tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pis->ctm).tx_fixed = ((fixed)(((pis->ctm).tx)*(float)(1<<8))), 0) : ((-13)))), ((pis->ctm).ty = (pmat->ty), ((((pis->ctm).ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pis->ctm).ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pis->ctm).ty_fixed = ((fixed)(((pis->ctm).ty)*(float)(1<<8))), 0) : ((-13)))), ((bool)1)) : ((pis->ctm).tx = (pmat->tx), (pis->ctm).ty = (pmat->ty), ((bool)0))));
    (*(gs_matrix *)&(pis)->ctm = (*pmat));
...
gs_translate(gs_state * pgs, double dx, double dy)
{
    ...
    if ((code = gs_distance_transform(dx, dy, &(*(const gs_matrix *)&(pgs)->ctm), &pt)) < 0)
        return code;
    pt.x = (float)pt.x + pgs->ctm.tx;
    pt.y = (float)pt.y + pgs->ctm.ty;
    (pgs->ctm_inverse_valid = ((bool)0), pgs->char_tm_valid = ((bool)0), ((pgs->ctm).txy_fixed_valid = (((pt.x) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (pt.x) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((pt.y) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (pt.y) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? (((pgs->ctm).tx = (pt.x), ((((pgs->ctm).tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->ctm).tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->ctm).tx_fixed = ((fixed)(((pgs->ctm).tx)*(float)(1<<8))), 0) : ((-13)))), ((pgs->ctm).ty = (pt.y), ((((pgs->ctm).ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->ctm).ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->ctm).ty_fixed = ((fixed)(((pgs->ctm).ty)*(float)(1<<8))), 0) : ((-13)))), ((bool)1)) : ((pgs->ctm).tx = (pt.x), (pgs->ctm).ty = (pt.y), ((bool)0)))));
...
gs_scale(gs_state * pgs, double sx, double sy)
{
    ...
    pgs->ctm.yx *= sy;
    pgs->ctm.yy *= sy;
    pgs->ctm_inverse_valid = ((bool)0), pgs->char_tm_valid = ((bool)0);
...
{
    int code = gs_matrix_rotate(&(*(const gs_matrix *)&(pgs)->ctm), ang,
                                &(*(gs_matrix *)&(pgs)->ctm));
...
gs_concat(gs_state * pgs, const gs_matrix * pmat)
{
    ...
    if (code < 0)
        return code;
    (pgs->ctm_inverse_valid = ((bool)0), pgs->char_tm_valid = ((bool)0), ((pgs->ctm).txy_fixed_valid = (((cmat.tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (cmat.tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) && ((cmat.ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && (cmat.ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? (((pgs->ctm).tx = (cmat.tx), ((((pgs->ctm).tx) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->ctm).tx) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->ctm).tx_fixed = ((fixed)(((pgs->ctm).tx)*(float)(1<<8))), 0) : ((-13)))), ((pgs->ctm).ty = (cmat.ty), ((((pgs->ctm).ty) >= -2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2)) && ((pgs->ctm).ty) < 2.0 * (1L << (((sizeof(fixed) * 8 - 8)) - 2))) ? ((pgs->ctm).ty_fixed = ((fixed)(((pgs->ctm).ty)*(float)(1<<8))), 0) : ((-13)))), ((bool)1)) : ((pgs->ctm).tx = (cmat.tx), (pgs->ctm).ty = (cmat.ty), ((bool)0)))));
    (*(gs_matrix *)&(pgs)->ctm = (cmat));
...
{
    return gs_point_transform(x, y, &(*(const gs_matrix *)&(pgs)->ctm), pt);
}

int
gs_dtransform(gs_state * pgs, double dx, double dy, gs_point * pt)
{
    return gs_distance_transform(dx, dy, &(*(const gs_matrix *)&(pgs)->ctm), pt);
}
...
gs_itransform(gs_state * pgs, double x, double y, gs_point * pt)
{
    ...
    if (!(!((((&pgs->ctm)->xy) == 0.0 && ((&pgs->ctm)->yx) == 0.0) || (((&pgs->ctm)->xx) == 0.0 && ((&pgs->ctm)->yy) == 0.0)))) {
        return gs_point_transform_inverse(x, y, &(*(const gs_matrix *)&(pgs)->ctm), pt);
    } else {
        if ( !pgs->ctm_inverse_valid ) { int code = ctm_set_inverse(pgs); if ( code < 0 ) return code; };
...
gs_imager_idtransform(const gs_imager_state * pis, double dx, double dy,
                      gs_point * pt)
{
    return gs_distance_transform_inverse(dx, dy, &(*(const gs_matrix *)&(pis)->ctm), pt);
}
...
{
    double fpx = ((px)*(1.0/(1<<8)));
    double fdx = fpx - pgs->ctm.tx;
    double fpy = ((py)*(1.0/(1<<8)));
    double fdy = fpy - pgs->ctm.ty;
    fixed dx, dy;
    int code;

    if (pgs->ctm.txy_fixed_valid) {
        dx = ((fixed)((fdx)*(float)(1<<8)));
        dy = ((fixed)((fdy)*(float)(1<<8)));
    ...
    pgs->ctm.ty = fpy;
    pgs->ctm.ty_fixed = py;
    pgs->ctm.txy_fixed_valid = ((bool)1);
    pgs->ctm_inverse_valid = ((bool)0);
    if (pgs->char_tm_valid) {
        pgs->char_tm.tx += fdx;
        pgs->char_tm.ty += fdy;
...
# 404 "./base/gscoord.c"
    (pgs)->current_point.x = ((pgs->ctm.tx_fixed)*(1.0/(1<<8))); (pgs)->current_point.y = ((pgs->ctm.ty_fixed)*(1.0/(1<<8)));;
    pgs->current_point_valid = ((bool)1);
    return 0;
}
...
{
# 423 "./base/gscoord.c"
    if ( sx != 1 ) { pgs->ctm.xx *= sx; pgs->ctm.yx *= sx; pgs->ctm_inverse_valid = ((bool)0); if ( pgs->char_tm_valid ) { pgs->char_tm.xx *= sx; pgs->char_tm.yx *= sx; } };
    if ( sy != 1 ) { pgs->ctm.xy *= sy; pgs->ctm.yy *= sy; pgs->ctm_inverse_valid = ((bool)0); if ( pgs->char_tm_valid ) { pgs->char_tm.xy *= sy; pgs->char_tm.yy *= sy; } };
                         ...
                         int max_bits)
{
    ...
    if ( ((ctm.xx) == 0.0) ) pfc->xx = 0; else pfc->xx = (long)ldexp(ctm.xx, scale);
    if ( ((ctm.xy) == 0.0) ) pfc->xy = 0; else pfc->xy = (long)ldexp(ctm.xy, scale);
    if ( ((ctm.yx) == 0.0) ) pfc->yx = 0; else pfc->yx = (long)ldexp(ctm.yx, scale);
    if ( ((ctm.yy) == 0.0) ) pfc->yy = 0; else pfc->yy = (long)ldexp(ctm.yy, scale);
# 501 "./base/gscoord.c"
...
fixed_coeff_mult(fixed value, long coeff, const fixed_coeff *pfc, int maxb)
{
    ...
    if ((value + ((1L << 8) << (maxb - 1))) & (-(1L << 8) << maxb)) {

        return
            (coeff < 0 ?
             -fixed_mult_quo(value, -coeff, (1L << 8) << shift) :
             fixed_mult_quo(value, coeff, (1L << 8) << shift));
    } else {
        ...
        return (fixed)
            ((((int)((value) >> (8))) * coeff + ((int)((((int)(value)&((1<<8)-1)) * coeff) >> (8))) + pfc->round) >> (shift));
