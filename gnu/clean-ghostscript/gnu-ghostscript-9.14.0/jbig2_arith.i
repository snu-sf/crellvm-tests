# 1 "./jbig2dec/jbig2_arith.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./jbig2dec/jbig2_arith.c" 2
# 24 "./jbig2dec/jbig2_arith.c"
...
# 187 "./jbig2dec/jbig2_arith.c"
Jbig2ArithState *
jbig2_arith_new (Jbig2Ctx *ctx, Jbig2WordStream *ws)
{
  Jbig2ArithState *result;

  result = ((Jbig2ArithState *)jbig2_alloc(ctx->allocator, 1, sizeof(Jbig2ArithState)));
  if (result == ((void*)0))
  {
