...
hc_put_code_proc(bool reverse_bits, byte * q, uint cw)
{
    ...
    if (reverse_bits) {
        ...
        q[-3] = byte_reverse_bits[((byte)(cw >> (3 * 8)))];
        q[-2] = byte_reverse_bits[((byte)(cw >> (2 * 8)))];

        q[-1] = byte_reverse_bits[((byte)(cw >> (1 * 8)))];
        q[0] = byte_reverse_bits[((byte)(cw >> (0 * 8)))];
    } else {
...
{
    while (bits_left < ((1 << 2) * 8)) {
        byte c = (byte) (bits >> (((1 << 2) * 8) - 8));
