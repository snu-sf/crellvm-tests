# 1 "./openjpeg/libopenjpeg/raw.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/raw.c" 2
# 30 "./openjpeg/libopenjpeg/raw.c"
...
# 31 "./openjpeg/libopenjpeg/raw.c" 2
# 45 "./openjpeg/libopenjpeg/raw.c"
opj_raw_t* opj_raw_create(void) {
 opj_raw_t *raw = (opj_raw_t*)((size_t)(sizeof(opj_raw_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_raw_t)));
 return raw;
}
