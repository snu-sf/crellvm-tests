# 1 "./openjpeg/libopenjpeg/jp2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/jp2.c" 2
# 34 "./openjpeg/libopenjpeg/jp2.c"
...
static OPJ_BOOL opj_jpip_write_fidx(opj_jp2_t *jp2,
  opj_stream_private_t *cio,
  opj_event_mgr_t * p_manager );
# 218 "./openjpeg/libopenjpeg/jp2.c"
static OPJ_BOOL opj_jp2_read_jp(opj_jp2_t *jp2,
                                OPJ_BYTE * p_header_data,
                                OPJ_UINT32 p_header_size,
                                opj_event_mgr_t * p_manager);
# 232 "./openjpeg/libopenjpeg/jp2.c"
...
OPJ_BOOL opj_jp2_default_validation ( opj_jp2_t * jp2,
                                        opj_stream_private_t *cio,
                                        opj_event_mgr_t * p_manager );
# 372 "./openjpeg/libopenjpeg/jp2.c"
static const opj_jp2_header_handler_t * opj_jp2_img_find_handler (OPJ_UINT32 p_id);
# 381 "./openjpeg/libopenjpeg/jp2.c"
static const opj_jp2_header_handler_t * opj_jp2_find_handler (OPJ_UINT32 p_id );

const opj_jp2_header_handler_t jp2_header [] =
{
 {0x6a502020,opj_jp2_read_jp},
 {0x66747970,opj_jp2_read_ftyp},
 {0x6a703268,opj_jp2_read_jp2h}
};

const opj_jp2_header_handler_t jp2_img_header [] =
{
 {0x69686472,opj_jp2_read_ihdr},
 {0x636f6c72,opj_jp2_read_colr},
 {0x62706363,opj_jp2_read_bpcc},
 {0x70636c72,opj_jp2_read_pclr},
 {0x636d6170,opj_jp2_read_cmap},
 {0x63646566,opj_jp2_read_cdef}

};
# 412 "./openjpeg/libopenjpeg/jp2.c"
                              ...
                              opj_event_mgr_t * p_manager )
{
 ...
 ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 440, __PRETTY_FUNCTION__));
 ((box != 00) ? (void) (0) : __assert_fail ("box != 00", "./openjpeg/libopenjpeg/jp2.c", 441, __PRETTY_FUNCTION__));
 ((p_number_bytes_read != 00) ? (void) (0) : __assert_fail ("p_number_bytes_read != 00", "./openjpeg/libopenjpeg/jp2.c", 442, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 443, __PRETTY_FUNCTION__));
 ...
 *p_number_bytes_read = opj_stream_read_data(cio,l_data_header,8,p_manager);
 ...
 if (box->length == 1) {
  ...
  opj_read_bytes_LE(l_data_header,&l_xl_part_size, 4);
  if (l_xl_part_size != 0) {
...
# 509 "./openjpeg/libopenjpeg/jp2.c"
                            ...
                            opj_event_mgr_t * p_manager )
{
 ...
 ((p_image_header_data != 00) ? (void) (0) : __assert_fail ("p_image_header_data != 00", "./openjpeg/libopenjpeg/jp2.c", 515, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 516, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 517, __PRETTY_FUNCTION__));
 ...
 opj_read_bytes_LE(p_image_header_data,&(jp2->w),4);
 p_image_header_data += 4;
 opj_read_bytes_LE(p_image_header_data,&(jp2->numcomps),2);
 p_image_header_data += 2;


 jp2->comps = (opj_jp2_comps_t*) ((size_t)(jp2->numcomps * sizeof(opj_jp2_comps_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(jp2->numcomps * sizeof(opj_jp2_comps_t)));
 if (jp2->comps == 0) {
 ...
 opj_read_bytes_LE(p_image_header_data,&(jp2->bpc),1);
 ++ p_image_header_data;

 opj_read_bytes_LE(p_image_header_data,&(jp2->C),1);
 ++ p_image_header_data;
 ...
 opj_read_bytes_LE(p_image_header_data,&(jp2->UnkC),1);
 ++ p_image_header_data;
 opj_read_bytes_LE(p_image_header_data,&(jp2->IPR),1);
 ++ p_image_header_data;
                              ...
                              )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 565, __PRETTY_FUNCTION__));
 ((p_nb_bytes_written != 00) ? (void) (0) : __assert_fail ("p_nb_bytes_written != 00", "./openjpeg/libopenjpeg/jp2.c", 566, __PRETTY_FUNCTION__));


 l_ihdr_data = (OPJ_BYTE *) ((size_t)(22) >= (size_t)-0x100 ? ((void*)0) : malloc(22));
 if (l_ihdr_data == 00) {
  return 00;
 }
 ...
 opj_write_bytes_LE(l_current_ihdr_ptr,22,4);
 l_current_ihdr_ptr+=4;

 opj_write_bytes_LE(l_current_ihdr_ptr,0x69686472, 4);
 l_current_ihdr_ptr+=4;

 opj_write_bytes_LE(l_current_ihdr_ptr,jp2->h, 4);
 l_current_ihdr_ptr+=4;

 opj_write_bytes_LE(l_current_ihdr_ptr, jp2->w, 4);
 l_current_ihdr_ptr+=4;

 opj_write_bytes_LE(l_current_ihdr_ptr, jp2->numcomps, 2);
 l_current_ihdr_ptr+=2;

 opj_write_bytes_LE(l_current_ihdr_ptr, jp2->bpc, 1);
 ++l_current_ihdr_ptr;

 opj_write_bytes_LE(l_current_ihdr_ptr, jp2->C, 1);
 ++l_current_ihdr_ptr;

 opj_write_bytes_LE(l_current_ihdr_ptr, jp2->UnkC, 1);
 ++l_current_ihdr_ptr;

 opj_write_bytes_LE(l_current_ihdr_ptr, jp2->IPR, 1);
 ++l_current_ihdr_ptr;
                                ...
                                )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 619, __PRETTY_FUNCTION__));
 ((p_nb_bytes_written != 00) ? (void) (0) : __assert_fail ("p_nb_bytes_written != 00", "./openjpeg/libopenjpeg/jp2.c", 620, __PRETTY_FUNCTION__));

 l_bpcc_data = (OPJ_BYTE *) ((size_t)(l_bpcc_size) >= (size_t)-0x100 ? ((void*)0) : malloc(l_bpcc_size));
 if (l_bpcc_data == 00) {
  return 00;
 }
 ...
 opj_write_bytes_LE(l_current_bpcc_ptr,l_bpcc_size,4);
 l_current_bpcc_ptr += 4;

 opj_write_bytes_LE(l_current_bpcc_ptr,0x62706363,4);
 l_current_bpcc_ptr += 4;

 for (i = 0; i < jp2->numcomps; ++i) {
  opj_write_bytes_LE(l_current_bpcc_ptr, jp2->comps[i].bpcc, 1);
  ++l_current_bpcc_ptr;
 }
                            ...
                            )
{
 ...
 ((p_bpc_header_data != 00) ? (void) (0) : __assert_fail ("p_bpc_header_data != 00", "./openjpeg/libopenjpeg/jp2.c", 655, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 656, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 657, __PRETTY_FUNCTION__));
 ...
 for (i = 0; i < jp2->numcomps; ++i) {
  opj_read_bytes_LE(p_bpc_header_data,&jp2->comps[i].bpcc ,1);
  ++p_bpc_header_data;
 }
                                ...
                                )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 688, __PRETTY_FUNCTION__));
 ((p_nb_bytes_written != 00) ? (void) (0) : __assert_fail ("p_nb_bytes_written != 00", "./openjpeg/libopenjpeg/jp2.c", 689, __PRETTY_FUNCTION__));
    ((jp2->meth == 1 || jp2->meth == 2) ? (void) (0) : __assert_fail ("jp2->meth == 1 || jp2->meth == 2", "./openjpeg/libopenjpeg/jp2.c", 690, __PRETTY_FUNCTION__));
 ...
 switch (jp2->meth) {
  case 1 :
   ...
   break;
  case 2 :
            ((jp2->color.icc_profile_len) ? (void) (0) : __assert_fail ("jp2->color.icc_profile_len", "./openjpeg/libopenjpeg/jp2.c", 697, __PRETTY_FUNCTION__));
 ...
 l_colr_data = (OPJ_BYTE *) ((size_t)(l_colr_size) >= (size_t)-0x100 ? ((void*)0) : malloc(l_colr_size));
 if (l_colr_data == 00) {
  return 00;
 }
 ...
 opj_write_bytes_LE(l_current_colr_ptr,l_colr_size,4);
 l_current_colr_ptr += 4;

 opj_write_bytes_LE(l_current_colr_ptr,0x636f6c72,4);
 l_current_colr_ptr += 4;

 opj_write_bytes_LE(l_current_colr_ptr, jp2->meth,1);
 ++l_current_colr_ptr;

 opj_write_bytes_LE(l_current_colr_ptr, jp2->precedence,1);
 ++l_current_colr_ptr;

 opj_write_bytes_LE(l_current_colr_ptr, jp2->approx,1);
 ++l_current_colr_ptr;

 if (jp2->meth == 1) {
        opj_write_bytes_LE(l_current_colr_ptr, jp2->enumcs,4); }
    else {
        if (jp2->meth == 2) {
            OPJ_UINT32 i;
            for(i = 0; i < jp2->color.icc_profile_len; ++i) {
                opj_write_bytes_LE(l_current_colr_ptr, jp2->color.icc_profile_buf[i], 1);
                ++l_current_colr_ptr;
            }
        }
 }
...
void opj_jp2_free_pclr(opj_jp2_color_t *color)
{
 ...
 if(color->jp2_pclr->cmap) free(color->jp2_pclr->cmap);

    free(color->jp2_pclr); color->jp2_pclr = ((void*)0);
}
...
static OPJ_BOOL opj_jp2_check_color(opj_image_t *image, opj_jp2_color_t *color, opj_event_mgr_t *p_manager)
{
 ...
 if (color->jp2_pclr && color->jp2_pclr->cmap) {
  ...
  pcol_usage = ((size_t)(nr_channels) != 0 && (size_t)(nr_channels) >= (size_t)-0x100 / (size_t)(sizeof(OPJ_BOOL)) ? ((void*)0) : calloc(nr_channels, sizeof(OPJ_BOOL)));
  if (!pcol_usage) {
...
void opj_jp2_apply_pclr(opj_image_t *image, opj_jp2_color_t *color)
{
 ...
 new_comps = (opj_image_comp_t*)
   ((size_t)(nr_channels * sizeof(opj_image_comp_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(nr_channels * sizeof(opj_image_comp_t)));
 ...
 for(i = 0; i < nr_channels; ++i) {
  ...
  if(cmap[i].mtyp == 0){
   old_comps[cmp].data = ((void*)0); continue;
  }


  new_comps[pcol].data = (OPJ_INT32*)
    ((size_t)(old_comps[cmp].w * old_comps[cmp].h * sizeof(OPJ_INT32)) >= (size_t)-0x100 ? ((void*)0) : malloc(old_comps[cmp].w * old_comps[cmp].h * sizeof(OPJ_INT32)));
 ...
 max = image->numcomps;
 for(i = 0; i < max; ++i) {
  if(old_comps[i].data) free(old_comps[i].data);
 }
                            ...
                            )
{
 ...
 ((p_pclr_header_data != 00) ? (void) (0) : __assert_fail ("p_pclr_header_data != 00", "./openjpeg/libopenjpeg/jp2.c", 914, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 915, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 916, __PRETTY_FUNCTION__));
 ...
 entries = (OPJ_UINT32*) ((size_t)(nr_channels * nr_entries * sizeof(OPJ_UINT32)) >= (size_t)-0x100 ? ((void*)0) : malloc(nr_channels * nr_entries * sizeof(OPJ_UINT32)));
    if (!entries)
        return 0;
 channel_size = (OPJ_BYTE*) ((size_t)(nr_channels) >= (size_t)-0x100 ? ((void*)0) : malloc(nr_channels));
    if (!channel_size)
    {
        free(entries);
        return 0;
    }
 channel_sign = (OPJ_BYTE*) ((size_t)(nr_channels) >= (size_t)-0x100 ? ((void*)0) : malloc(nr_channels));
 if (!channel_sign)
 {
        free(entries);
        free(channel_size);
 ...
 jp2_pclr = (opj_jp2_pclr_t*)((size_t)(sizeof(opj_jp2_pclr_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_jp2_pclr_t)));
    if (!jp2_pclr)
    {
        free(entries);
        free(channel_size);
                            ...
                            )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1009, __PRETTY_FUNCTION__));
 ((p_cmap_header_data != 00) ? (void) (0) : __assert_fail ("p_cmap_header_data != 00", "./openjpeg/libopenjpeg/jp2.c", 1010, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1011, __PRETTY_FUNCTION__));
 ...
 cmap = (opj_jp2_cmap_comp_t*) ((size_t)(nr_channels * sizeof(opj_jp2_cmap_comp_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(nr_channels * sizeof(opj_jp2_cmap_comp_t)));
    if (!cmap)
        return 0;


 for(i = 0; i < nr_channels; ++i) {
  opj_read_bytes_LE(p_cmap_header_data, &l_value, 2);
  p_cmap_header_data +=2;
  cmap[i].cmp = (OPJ_UINT16) l_value;

  opj_read_bytes_LE(p_cmap_header_data, &l_value, 1);
  ++p_cmap_header_data;
...
void opj_jp2_apply_cdef(opj_image_t *image, opj_jp2_color_t *color)
{
 ...
 if(color->jp2_cdef->info) free(color->jp2_cdef->info);

 free(color->jp2_cdef); color->jp2_cdef = ((void*)0);
                            ...
                            )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1111, __PRETTY_FUNCTION__));
 ((p_cdef_header_data != 00) ? (void) (0) : __assert_fail ("p_cdef_header_data != 00", "./openjpeg/libopenjpeg/jp2.c", 1112, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1113, __PRETTY_FUNCTION__));
    (void)p_cdef_header_size;



 if(jp2->color.jp2_cdef) return 0;
 ...
 opj_read_bytes_LE(p_cdef_header_data,&l_value ,2);
 ...
 cdef_info = (opj_jp2_cdef_info_t*) ((size_t)(l_value * sizeof(opj_jp2_cdef_info_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(l_value * sizeof(opj_jp2_cdef_info_t)));
    if (!cdef_info)
        return 0;

 jp2->color.jp2_cdef = (opj_jp2_cdef_t*)((size_t)(sizeof(opj_jp2_cdef_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_jp2_cdef_t)));
                            ...
                            )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1177, __PRETTY_FUNCTION__));
 ((p_colr_header_data != 00) ? (void) (0) : __assert_fail ("p_colr_header_data != 00", "./openjpeg/libopenjpeg/jp2.c", 1178, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1179, __PRETTY_FUNCTION__));
 ...
 opj_read_bytes_LE(p_colr_header_data,&jp2->precedence ,1);
 ++p_colr_header_data;

 opj_read_bytes_LE(p_colr_header_data,&jp2->approx ,1);
 ++p_colr_header_data;
 ...
 if (jp2->meth == 1) {
  ...
  opj_read_bytes_LE(p_colr_header_data,&jp2->enumcs ,4);
  ...
  jp2->color.icc_profile_buf = (OPJ_BYTE*) ((size_t)(icc_len) >= (size_t)-0x100 ? ((void*)0) : malloc(icc_len));
  ...
  {
   opj_read_bytes_LE(p_colr_header_data,&l_value,1);
   ++p_colr_header_data;
   jp2->color.icc_profile_buf[it_icc_value] = (OPJ_BYTE) l_value;
 ...
 else if (jp2->meth > 2)
    {
        ...
        opj_event_msg(p_manager, 4, "COLR BOX meth value is not a regular value (%d), "
                            ...
                            )
{
 ...
 ((stream != 00) ? (void) (0) : __assert_fail ("stream != 00", "./openjpeg/libopenjpeg/jp2.c", 1322, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1323, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1324, __PRETTY_FUNCTION__));
 ...
 opj_write_bytes_LE(l_jp2h_data,l_jp2h_size,4);
       ...
       opj_event_mgr_t * p_manager )
{
 ...
 ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 1413, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1414, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1415, __PRETTY_FUNCTION__));

 l_ftyp_data = (OPJ_BYTE *) ((size_t)(l_ftyp_size) >= (size_t)-0x100 ? ((void*)0) : malloc(l_ftyp_size));
 ...
 opj_write_bytes_LE(l_current_data_ptr, l_ftyp_size,4);
 l_current_data_ptr += 4;

 opj_write_bytes_LE(l_current_data_ptr, 0x66747970,4);
 l_current_data_ptr += 4;

 opj_write_bytes_LE(l_current_data_ptr, jp2->brand,4);
 l_current_data_ptr += 4;

 opj_write_bytes_LE(l_current_data_ptr, jp2->minversion,4);
 l_current_data_ptr += 4;

 for (i = 0; i < jp2->numcl; i++) {
  opj_write_bytes_LE(l_current_data_ptr, jp2->cl[i],4);
 }
       ...
       opj_event_mgr_t * p_manager )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1463, __PRETTY_FUNCTION__));
 ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 1464, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1465, __PRETTY_FUNCTION__));
 ((opj_stream_has_seek(cio)) ? (void) (0) : __assert_fail ("opj_stream_has_seek(cio)", "./openjpeg/libopenjpeg/jp2.c", 1466, __PRETTY_FUNCTION__));

 j2k_codestream_exit = opj_stream_tell(cio);
 opj_write_bytes_LE(l_data_header,
                    (OPJ_UINT32) (j2k_codestream_exit - jp2->j2k_codestream_offset),
                    4);
 opj_write_bytes_LE(l_data_header + 4,0x6a703263,4);
          ...
          opj_event_mgr_t * p_manager )
{
 ...
 ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 1500, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1501, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1502, __PRETTY_FUNCTION__));


 opj_write_bytes_LE(l_signature_data,12,4);

 opj_write_bytes_LE(l_signature_data+4,0x6a502020,4);

 opj_write_bytes_LE(l_signature_data+8,0x0d0a870a,4);
...
void opj_jp2_setup_decoder(opj_jp2_t *jp2, opj_dparameters_t *parameters)
{
 ...
 jp2->color.jp2_has_colr = 0;
    jp2->ignore_pclr_cmap_cdef = parameters->flags & 0x0001;
}
                            ...
                            opj_event_mgr_t * p_manager)
{
 ...
 jp2->minversion = 0;
 jp2->numcl = 1;
 jp2->cl = (OPJ_UINT32*) ((size_t)(jp2->numcl * sizeof(OPJ_UINT32)) >= (size_t)-0x100 ? ((void*)0) : malloc(jp2->numcl * sizeof(OPJ_UINT32)));
    if (!jp2->cl){
        jp2->cl = ((void*)0);
                                ...
                                )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1640, __PRETTY_FUNCTION__));
 ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 1641, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1642, __PRETTY_FUNCTION__));
                                ...
                                )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1661, __PRETTY_FUNCTION__));
 ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 1662, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1663, __PRETTY_FUNCTION__));
...
void opj_jp2_setup_end_header_writing (opj_jp2_t *jp2)
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1679, __PRETTY_FUNCTION__));
...
void opj_jp2_setup_end_header_reading (opj_jp2_t *jp2)
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1699, __PRETTY_FUNCTION__));
                                        ...
                                        )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1713, __PRETTY_FUNCTION__));
 ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 1714, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1715, __PRETTY_FUNCTION__));
                                                ...
                                                )
{
 ...
 OPJ_UINT32 l_last_data_size = 1024;
 OPJ_UINT32 l_current_data_size;
 OPJ_BYTE * l_current_data = 00;


 ((stream != 00) ? (void) (0) : __assert_fail ("stream != 00", "./openjpeg/libopenjpeg/jp2.c", 1771, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1772, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1773, __PRETTY_FUNCTION__));

 l_current_data = (OPJ_BYTE*)((size_t)(l_last_data_size) >= (size_t)-0x100 ? ((void*)0) : malloc(l_last_data_size));
 ...
 while (opj_jp2_read_boxhdr(&box,&l_nb_bytes_read,stream,p_manager)) {
  ...
  if (l_current_handler != 00) {
   if (l_current_data_size > l_last_data_size) {
    OPJ_BYTE* new_current_data = (OPJ_BYTE*)((size_t)(l_current_data_size) >= (size_t)-0x100 ? ((void*)0) : realloc(l_current_data, l_current_data_size));
    if (!new_current_data) {
     free(l_current_data);
...
# 1861 "./openjpeg/libopenjpeg/jp2.c"
static OPJ_BOOL opj_jp2_exec ( opj_jp2_t * jp2,
                                opj_procedure_list_t * p_procedure_list,
                                opj_stream_private_t *stream,
                                opj_event_mgr_t * p_manager
...

{
 ...
 ((p_procedure_list != 00) ? (void) (0) : __assert_fail ("p_procedure_list != 00", "./openjpeg/libopenjpeg/jp2.c", 1873, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1874, __PRETTY_FUNCTION__));
 ((stream != 00) ? (void) (0) : __assert_fail ("stream != 00", "./openjpeg/libopenjpeg/jp2.c", 1875, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1876, __PRETTY_FUNCTION__));
                                ...
                                )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1898, __PRETTY_FUNCTION__));
 ((stream != 00) ? (void) (0) : __assert_fail ("stream != 00", "./openjpeg/libopenjpeg/jp2.c", 1899, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1900, __PRETTY_FUNCTION__));
...
# 1940 "./openjpeg/libopenjpeg/jp2.c"
static const opj_jp2_header_handler_t * opj_jp2_img_find_handler (OPJ_UINT32 p_id)
{
...
# 1963 "./openjpeg/libopenjpeg/jp2.c"
static OPJ_BOOL opj_jp2_read_jp(opj_jp2_t *jp2,
                                OPJ_BYTE * p_header_data,
                                OPJ_UINT32 p_header_size,
                                opj_event_mgr_t * p_manager
...

{
 ...
 ((p_header_data != 00) ? (void) (0) : __assert_fail ("p_header_data != 00", "./openjpeg/libopenjpeg/jp2.c", 1973, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 1974, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 1975, __PRETTY_FUNCTION__));
...
# 2010 "./openjpeg/libopenjpeg/jp2.c"
static OPJ_BOOL opj_jp2_read_ftyp( opj_jp2_t *jp2,
         OPJ_BYTE * p_header_data,
         OPJ_UINT32 p_header_size,
         opj_event_mgr_t * p_manager
                                    )
{
 ...
 ((p_header_data != 00) ? (void) (0) : __assert_fail ("p_header_data != 00", "./openjpeg/libopenjpeg/jp2.c", 2019, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2020, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 2021, __PRETTY_FUNCTION__));
 ...
 opj_read_bytes_LE(p_header_data,&jp2->minversion,4);
 p_header_data += 4;
 ...
 for (i = 0; i < jp2->numcl; ++i)
 {
  opj_read_bytes_LE(p_header_data,&jp2->cl[i],4);
  p_header_data += 4;
 }
          ...
          opj_event_mgr_t * p_manager )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2075, __PRETTY_FUNCTION__));
 ((stream != 00) ? (void) (0) : __assert_fail ("stream != 00", "./openjpeg/libopenjpeg/jp2.c", 2076, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 2077, __PRETTY_FUNCTION__));
  ...
  opj_event_mgr_t * p_manager )
{
  ...
  ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2093, __PRETTY_FUNCTION__));
  ((stream != 00) ? (void) (0) : __assert_fail ("stream != 00", "./openjpeg/libopenjpeg/jp2.c", 2094, __PRETTY_FUNCTION__));
  ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 2095, __PRETTY_FUNCTION__));
...
# 2116 "./openjpeg/libopenjpeg/jp2.c"
static OPJ_BOOL opj_jp2_read_jp2h( opj_jp2_t *jp2,
                                    OPJ_BYTE *p_header_data,
                                    OPJ_UINT32 p_header_size,
                                    opj_event_mgr_t * p_manager
                                    )
{
 ...
 ((p_header_data != 00) ? (void) (0) : __assert_fail ("p_header_data != 00", "./openjpeg/libopenjpeg/jp2.c", 2127, __PRETTY_FUNCTION__));
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2128, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 2129, __PRETTY_FUNCTION__));
                                     ...
                                     )
{
 ...
 ((p_data != 00) ? (void) (0) : __assert_fail ("p_data != 00", "./openjpeg/libopenjpeg/jp2.c", 2184, __PRETTY_FUNCTION__));
 ((box != 00) ? (void) (0) : __assert_fail ("box != 00", "./openjpeg/libopenjpeg/jp2.c", 2185, __PRETTY_FUNCTION__));
 ((p_number_bytes_read != 00) ? (void) (0) : __assert_fail ("p_number_bytes_read != 00", "./openjpeg/libopenjpeg/jp2.c", 2186, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 2187, __PRETTY_FUNCTION__));
 ...
 opj_read_bytes_LE(p_data, &l_value, 4);
 p_data += 4;
 ...
 *p_number_bytes_read = 8;
 ...
 if (box->length == 1) {
  ...
  opj_read_bytes_LE(p_data,&l_xl_part_size, 4);
  p_data += 4;
                                ...
                                )
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2248, __PRETTY_FUNCTION__));
 ((p_stream != 00) ? (void) (0) : __assert_fail ("p_stream != 00", "./openjpeg/libopenjpeg/jp2.c", 2249, __PRETTY_FUNCTION__));
 ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 2250, __PRETTY_FUNCTION__));
...
void opj_jp2_setup_encoding_validation (opj_jp2_t *jp2)
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2277, __PRETTY_FUNCTION__));
...
void opj_jp2_setup_decoding_validation (opj_jp2_t *jp2)
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2286, __PRETTY_FUNCTION__));
...
void opj_jp2_setup_header_writing (opj_jp2_t *jp2)
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2293, __PRETTY_FUNCTION__));
...
void opj_jp2_setup_header_reading (opj_jp2_t *jp2)
{
 ...
 ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2309, __PRETTY_FUNCTION__));
 ...
 if (jp2) {
  ...
  if (jp2->color.jp2_cdef) {
   if (jp2->color.jp2_cdef->info) {
    ...
    jp2->color.jp2_cdef->info = ((void*)0);
   }
...
opj_jp2_t* opj_jp2_create(OPJ_BOOL p_is_decoder)
{
 opj_jp2_t *jp2 = (opj_jp2_t*)((size_t)(sizeof(opj_jp2_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_jp2_t)));
 if (jp2) {
  ...
  jp2->color.icc_profile_buf = ((void*)0);
  jp2->color.icc_profile_len = 0;
  jp2->color.jp2_cdef = ((void*)0);
  jp2->color.jp2_pclr = ((void*)0);
  jp2->color.jp2_has_colr = 0;
...
void jp2_dump(opj_jp2_t* p_jp2, OPJ_INT32 flag, FILE* out_stream)
{
 ...
 ((p_jp2 != 00) ? (void) (0) : __assert_fail ("p_jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2544, __PRETTY_FUNCTION__));
  ...
  opj_event_mgr_t * p_manager )
{
  ...
  ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2579, __PRETTY_FUNCTION__));
  ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 2580, __PRETTY_FUNCTION__));
  ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 2581, __PRETTY_FUNCTION__));
  ((opj_stream_has_seek(cio)) ? (void) (0) : __assert_fail ("opj_stream_has_seek(cio)", "./openjpeg/libopenjpeg/jp2.c", 2582, __PRETTY_FUNCTION__));

  j2k_codestream_exit = opj_stream_tell(cio);
  opj_write_bytes_LE(l_data_header, 24, 4);
  opj_write_bytes_LE(l_data_header + 4,0x69707472,4);




  opj_write_double_LE(l_data_header + 4 + 4, 0);
  opj_write_double_LE(l_data_header + 8 + 8, 0);
  ...
  opj_event_mgr_t * p_manager )
{
  ...
  ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2621, __PRETTY_FUNCTION__));
  ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 2622, __PRETTY_FUNCTION__));
  ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 2623, __PRETTY_FUNCTION__));
  ((opj_stream_has_seek(cio)) ? (void) (0) : __assert_fail ("opj_stream_has_seek(cio)", "./openjpeg/libopenjpeg/jp2.c", 2624, __PRETTY_FUNCTION__));

  opj_write_bytes_LE(l_data_header, 24, 4);
  opj_write_bytes_LE(l_data_header + 4,0x66696478,4);
  opj_write_double_LE(l_data_header + 4 + 4, 0);
  opj_write_double_LE(l_data_header + 8 + 8, 0);
  ...
  opj_event_mgr_t * p_manager )
{
  ...
  ((jp2 != 00) ? (void) (0) : __assert_fail ("jp2 != 00", "./openjpeg/libopenjpeg/jp2.c", 2653, __PRETTY_FUNCTION__));
  ((cio != 00) ? (void) (0) : __assert_fail ("cio != 00", "./openjpeg/libopenjpeg/jp2.c", 2654, __PRETTY_FUNCTION__));
  ((p_manager != 00) ? (void) (0) : __assert_fail ("p_manager != 00", "./openjpeg/libopenjpeg/jp2.c", 2655, __PRETTY_FUNCTION__));
  ((opj_stream_has_seek(cio)) ? (void) (0) : __assert_fail ("opj_stream_has_seek(cio)", "./openjpeg/libopenjpeg/jp2.c", 2656, __PRETTY_FUNCTION__));

  j2k_codestream_exit = opj_stream_tell(cio);
  opj_write_bytes_LE(l_data_header, 24, 4);
  opj_write_bytes_LE(l_data_header + 4,0x63696478,4);
  ...
  opj_event_mgr_t * p_manager )
{
  ...
  opj_write_bytes_LE(l_data_header,0x70727879,4);
  opj_stream_write_data(cio,l_data_header,4,p_manager);

  opj_write_bytes_LE( l_data_header, offset_jp2c, 8);
  opj_stream_write_data(cio,l_data_header,8,p_manager);
  opj_write_bytes_LE( l_data_header, length_jp2c, 4);
  opj_write_bytes_LE( l_data_header+4, 0x6a703263, 4);
  opj_stream_write_data(cio,l_data_header,8,p_manager);

  opj_write_bytes_LE( l_data_header, 1, 1);
  opj_stream_write_data(cio,l_data_header,1,p_manager);

  opj_write_bytes_LE( l_data_header, offset_idx, 8);
  opj_stream_write_data(cio,l_data_header,8,p_manager);
  opj_write_bytes_LE( l_data_header, length_idx, 4);
  opj_write_bytes_LE( l_data_header+4, 0x63696478, 4);
  opj_stream_write_data(cio,l_data_header,8,p_manager);
  ...
  opj_event_mgr_t * p_manager )
{
  ...
  lenp = opj_stream_tell(cio);
  opj_stream_skip(cio, 4, p_manager);
  opj_write_bytes_LE(l_data_header,0x66696478,4);
  opj_stream_write_data(cio,l_data_header,4,p_manager);
