...
pc_4bit_map_rgb_color(gx_device * dev, const gx_color_value cv[])
{
    ...
    r = (cv[0] > (((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1))/2));
    g = (cv[1] > (((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1))/2));
    color = (cv[2] > (((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1))/2));
    color += (r << 2) + (g << 1);
    if (color > 0)
        color += 8;
    return color;
                      ...
                      gx_color_value prgb[3])
{
    ...
    prgb[0] = ((int)color & 4 ? ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) : 0);
    prgb[1] = ((int)color & 2 ? ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) : 0);
    prgb[2] = ((int)color & 1 ? ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) : 0);
    return 0;
...
pc_8bit_map_rgb_color(gx_device * dev, const gx_color_value cv[])
{
    ...
    rv = r / (((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) / 6 + 1);
    gv = g / (((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) / 6 + 1);

    return (gx_color_index)
         (rv * 6 + gv) * 6 + b / (((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) / 6 + 1);
}
int
                      ...
                      gx_color_value prgb[3])
{
    ...
    {0,
     ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) / 5,
     2 * ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) / 5,
     3 * ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) / 5,
     ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) - (((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) / 5),
    ...
    if ((uint)color >= 216) {
        ...
        prgb[0] = ramp6[(uint)color / 36];
        prgb[1] = ramp6[((uint)color / 6) % 6];
        prgb[2] = ramp6[(uint)color % 6];
    }
...
pc_write_palette(gx_device * dev, uint max_index, FILE * file)
{
    ...
    for (i = 0; i < max_index; i++) {
        ...
        for (c = 0; c < 3; c++) {
            byte b = rgb[c] >> ((sizeof(gx_color_value) * 8) - 8);
