...
zDCTE(i_ctx_t *i_ctx_p)
{
    ...
    gs_memory_t *mem = ((((gs_memory_t *)((i_ctx_p->memory).current)))->procs.stable(((gs_memory_t *)((i_ctx_p->memory).current))));
    ...
    if (((((const byte *)&((op)->tas.type_attrs))[1]) == (t_dictionary)))
        ...
        dop = 0, dspace = 0;
    if ((code = dict_param_list_read(&list, dop, ((void*)0), ((bool)0), ((i_ctx_p->memory).current))) < 0)
        goto fail;
...
fail:
    ...
    ((mem)->procs.free_object(mem, jcdp, "zDCTE fail"));
    return code;
}
# 135 "./psi/zfdcte.c"
