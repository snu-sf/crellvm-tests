...
int gs_build_function_2(i_ctx_t *i_ctx_p, const ref *op, const gs_function_params_t *params, int depth, gs_function_t **ppfn, gs_memory_t *mem);
int gs_build_function_3(i_ctx_t *i_ctx_p, const ref *op, const gs_function_params_t *params, int depth, gs_function_t **ppfn, gs_memory_t *mem);
                    ...
                    int depth, gs_function_t ** ppfn, gs_memory_t *mem)
{
    ...
    *(gs_function_params_t *)&params = *mnDR;
    ...
    if ((code = dict_float_param(op, "N", 0.0, &params.N)) != 0 ||
        (code = n0 = fn_build_float_array_forced(op, "C0", ((bool)0), &params.C0, mem)) < 0 ||
        (code = n1 = fn_build_float_array_forced(op, "C1", ((bool)0), &params.C1, mem)) < 0
        )
        goto fail;
    if (params.C0 == 0)
        n0 = 1;
    ...
    *(gs_function_params_t *) & params = *mnDR;
    ...
    params.Encode = 0;
    {
        ...
        if ((code = dict_find_string(op, "Functions", &pFunctions)) <= 0)
            return (code < 0 ? code : ((-15)));
        do { if ( !((((const byte *)&((&*pFunctions)->tas.type_attrs))[1]) == (t_array)) ) return ((-20)); } while (0);
        params.k = ((pFunctions)->tas.rsize);
    ...
    if ((code = fn_build_float_array(op, "Bounds", ((bool)1), ((bool)0), &params.Bounds, mem)) != params.k - 1)
        goto fail;
    if (gs_currentcpsimode(((gs_memory_t *)((i_ctx_p->memory).current)))) {
        ...
        ref *encode;
        float *p = (float *)(*(mem)->procs.alloc_byte_array)(mem, k2, sizeof(float), "Encode");
        ...
        if (!(((encode)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0))) == (((t_array) << 8) + (0)))) {
            code = ((-20));
            goto fail;
        }
        sz = (((k2) < (((encode)->tas.rsize))) ? (k2) : (((encode)->tas.rsize)));
        code = process_float_array(mem, encode, sz, p);
        if (code < 0)
            goto fail;
        while (sz < k2)
            p[sz++] = 0.0;
    } else if ((code = fn_build_float_array(op, "Encode", ((bool)1), ((bool)1), &params.Encode, mem)) != 2 * params.k)
        goto fail;
    if (params.Range == 0)
