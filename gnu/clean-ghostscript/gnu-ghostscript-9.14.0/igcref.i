...
static void refs_compact(const gs_memory_t *cmem, obj_header_t *pre, obj_header_t *dpre, uint size);
static const struct_shared_procs_t refs_shared_procs =
{refs_clear_reloc, refs_set_reloc, refs_compact};
static void refs_clear_marks(const gs_memory_t *cmem, void *pre, uint size, const gs_memory_struct_type_t *pstype);
static void refs_do_reloc(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst);
const gs_memory_struct_type_t st_refs =
{sizeof(ref), "refs", &refs_shared_procs, refs_clear_marks, 0, refs_do_reloc};
# 64 "./psi/igcref.c"
void ref_struct_clear_marks(const gs_memory_t *cmem, void *vptr, uint size, const gs_memory_struct_type_t *pstype)
{
    ref *pref = (ref *) vptr;
...
gs_ptr_type_t ref_struct_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst)
{
...
void ref_struct_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) {
{
...
refs_clear_reloc(obj_header_t *hdr, uint size)
{
    ...
    while (rp < end) {
        if ((*(const ref_packed *)(rp) >= ((ref_packed)(2) << 13)))
            ...
            if (!((ref_type_properties[(((const byte *)&((pref)->tas.type_attrs))[1])] & (2 | 4)) != 0)) {
                do { } while (0);
                ((pref)->tas.rsize = (0));
            }
            rp += (sizeof(ref) / sizeof(ref_packed));
...
# 227 "./psi/igcref.c"
            int i;
# 263 "./psi/igcref.c"
            switch (((*rp & (1 << 12)) + (rp[1] & (1 << 12)) + (rp[2] & (1 << 12)) + (rp[3] & (1 << 12)))) {
                case (((((8 - 1) | (4 - 1) | (8 - 1)) + 1) / 2) * (1 << 12)):
                    do { } while (0);
                ...
                case 0:
...

                    {
                        ...
                        *rp = ((ref_packed)(pt_integer) << 13) +
                            (((rel) < (((1 << 12) - 1))) ? (rel) : (((1 << 12) - 1)));
                    }
                    rp += ((((8 - 1) | (4 - 1) | (8 - 1)) + 1) / 2);
                    freed += sizeof(ref_packed) * ((((8 - 1) | (4 - 1) | (8 - 1)) + 1) / 2);
            }
        } else {
            uint rel = reloc + freed;
...
# 409 "./psi/igcref.c"
        ...
        if (((((pref)->tas.type_attrs) & (1)) || do_all) &&
            (avm_space)(((pref)->tas.type_attrs) & (((1 << 2) - 1) << 2)) >= min_trace
            ) {
            switch ((((const byte *)&((pref)->tas.type_attrs))[1])) {

                case t_file:
                    (pref->value.pfile = (((*(const gc_procs_with_refs_t **)(gcst))->reloc_struct_ptr)((const void *)(pref->value.pfile), gcst)));
                    break;
                case t_device:
                    (pref->value.pdevice = (((*(const gc_procs_with_refs_t **)(gcst))->reloc_struct_ptr)((const void *)(pref->value.pdevice), gcst)));

                    break;
                case t_fontID:
                case t_struct:
                case t_astruct:
                    (pref->value.pstruct = (((*(const gc_procs_with_refs_t **)(gcst))->reloc_struct_ptr)((const void *)(pref->value.pstruct), gcst)));

                    break;

                case t_dictionary:
                    do { } while (0);
                    pref->value.pdict = (dict *)igc_reloc_ref_ptr((ref_packed *)pref->value.pdict, gcst);
...
# 458 "./psi/igcref.c"
                            if (size < (50 * sizeof(ref)) / sizeof(ref)) {
                                do { } while (0);
                                pref->value.refs = (ref *) igc_reloc_ref_ptr( (ref_packed *) pref->value.refs, gcst);
                                ...
                                --size;
                                pref->value.refs = (ref *) igc_reloc_ref_ptr( (ref_packed *) (pref->value.refs + size), gcst) - size;
                ...
                case t_mixedarray:
                    if (((pref)->tas.rsize) != 0) {
                        do { } while (0);
                        pref->value.packed = igc_reloc_ref_ptr(pref->value.packed, gcst);
...
# 508 "./psi/igcref.c"
                            --size;
                            pref->value.packed = igc_reloc_ref_ptr(pref->value.packed + size, gcst) - size;
                ...
                case t_name:
                    {
                        void *psub = names_ref_sub_table(cmem->gs_lib_ctx->gs_name_table, pref);
                        void *rsub = (((*(const gc_procs_with_refs_t **)(gcst))->reloc_struct_ptr)((const void *)(psub), gcst));
                ...
                case t_string:
                    {
                        ...
                        (((*(const gc_procs_with_refs_t **)(gcst))->reloc_string)(&(str), gcst));
                        pref->value.bytes = str.data;
                    }
                    break;
                case t_oparray:
                    do { } while (0);
                    pref->value.const_refs = (const ref *)igc_reloc_ref_ptr((const ref_packed *)pref->value.const_refs, gcst);
...
# 580 "./psi/igcref.c"
            ...
            if (!(*rp & (1 << 12))) {
                if (*rp != ((ref_packed)(pt_integer) << 13) + ((1 << 12) - 1)) {
                    ...
                    do { } while (0);
                    rp = ((const ref_packed *) ((const char *)prp - (*rp & ((1 << 12) - 1)) + dec));
                ...
                dec += sizeof(ref_packed) * ((((8 - 1) | (4 - 1) | (8 - 1)) + 1) / 2);
                rp += ((((8 - 1) | (4 - 1) | (8 - 1)) + 1) / 2);
            } else
                rp++;
            continue;
        }
        if (!((ref_type_properties[(((const byte *)&((((const ref *)rp))->tas.type_attrs))[1])] & (2 | 4)) != 0)) {

            do { } while (0);
            rp = ((const ref_packed *) (((((const ref *)rp))->tas.rsize) == 0 ? prp : (const ref_packed *)((const char *)prp - ((((const ref *)rp))->tas.rsize) + dec)));
