...
static const gc_ptr_element_t gs_sampled_data_enum_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_sampled_data_enum *)0)->pfn - (char *)((gs_sampled_data_enum *)0) )) } }; static const gc_struct_data_t gs_sampled_data_enum_reloc_ptrs = { (sizeof(gs_sampled_data_enum_enum_ptrs) / sizeof((gs_sampled_data_enum_enum_ptrs)[0])), 0, 0, gs_sampled_data_enum_enum_ptrs }; static const gs_memory_struct_type_t st_gs_sampled_data_enum = { sizeof(gs_sampled_data_enum), "gs_sampled_data_enum", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &gs_sampled_data_enum_reloc_ptrs };
...
zbuildsampledfunction(i_ctx_t *i_ctx_p)
{
    ...
    if ( !((((const byte *)&((&*pdict)->tas.type_attrs))[1]) == (t_dictionary)) ) return (check_type_failed(&*pdict));



    if (dict_find_string(pdict, "Function", &pfunc) <= 0)
        return ((-15));
    do { if ( !(((&*pfunc)->tas.type_attrs & ((((1 << 6) - (4)) << 8) + (0x40 +0x80))) == (((t_array) << 8) + (0x40 +0x80))) ) return (check_proc_failed(&*pfunc)); } while (0);



    code = cube_build_func0(pdict, &params, ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (code < 0)
        return code;
# 125 "./psi/zfsample.c"
    code = gs_function_Sd_init(&pfn, &params, ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (code < 0)
        return code;



    return sampled_data_setup(i_ctx_p, pfn, pfunc, sampled_data_finish, ((gs_memory_t *)((i_ctx_p->memory).current)));
}
# 142 "./psi/zfsample.c"
static bool
valid_cube_size(int num_inputs, int num_outputs, int sample_size, const int Size[])
{
    ...
    for (i = 0; i < num_inputs; i++) {
        if (Size[i] <= 0 || Size[i] > 0x10000 / total_size)
            return ((bool)0);
        total_size *= Size[i];
    }
    return ((bool)1);
...
{
    return (gs_sampled_data_enum *)(*(mem)->procs.alloc_struct)(mem, &st_gs_sampled_data_enum, cname);
...
cube_ptr_from_index(gs_function_Sd_params_t * params, int indexes[])
{
    ...
    return (byte *)(params->DataSource.data.str.data) +
        sum * params->n * ((params->BitsPerSample) >> 3);
}
                                                        ...
                                                        gs_memory_t *mem)
{
    ...
    if ((code = dict_int_param(pdict, "Order", 1, 3, 1, &params->Order)) < 0 ||
        ...
        ((code = params->m =
            fn_build_float_array(pdict, "Domain", ((bool)0), ((bool)1),
                                        &params->Domain, mem)) < 0 ) ||
        ((code = params->n =
            fn_build_float_array(pdict, "Range", ((bool)0), ((bool)1),
                                        &params->Range, mem)) < 0)
        ) {
        goto fail;
    }
    ...
    {
        int *ptr = (int *)
            (*(mem)->procs.alloc_byte_array)(mem, params->m, sizeof(int), "Size");
    ...
    total_size = params->n * ((params->BitsPerSample) >> 3);
    for (i = 0; i < params->m; i++)
        total_size *= params->Size[i];



    bytes = (*(mem)->procs.alloc_byte_array)(mem, total_size, 1, "cube_build_func0(bytes)");
    if (!bytes) {
        code = ((-25));
        goto fail;
    }
    ((&params->DataSource)->type = data_source_type_bytes, (&params->DataSource)->data.str.data = (const unsigned char *)bytes, (&params->DataSource)->data.str.size = total_size, (&params->DataSource)->access = data_source_access_bytes);
        ...
        const ref * pproc, int (*finish_proc)(i_ctx_t *), gs_memory_t * mem)
{
    ...
    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (3 + 1) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 3 + 1); if ( es_code_ < 0 ) return es_code_; };
    if ( (((i_ctx_p->op_stack).stack).top) - (((i_ctx_p->op_stack).stack).p) < (params->m + 3) ) { ((i_ctx_p->op_stack).stack).requested = (params->m + 3); return ((-16)); };
    if ( (((i_ctx_p->op_stack).stack).top) - (((i_ctx_p->op_stack).stack).p) < (params->n + 3) ) { ((i_ctx_p->op_stack).stack).requested = (params->n + 3); return ((-16)); };




    penum = gs_sampled_data_enum_alloc(((gs_memory_t *)((i_ctx_p->memory).current)), "zbuildsampledfuntion(params)");
    if (penum == ((void*)0))
        return ((-25));
    ...
    penum->o_stack_depth = ref_stack_count(&((i_ctx_p->op_stack).stack));
    ...
    for (i = 0; i < 3; i++)
        (((op - i)->tas.type_attrs = ((t_null) << 8) + (0)) );



    (((i_ctx_p->exec_stack).stack).p) += 3;
    (((((i_ctx_p->exec_stack).stack).p) - 2)->value.opproc = (finish_proc), (((((i_ctx_p->exec_stack).stack).p) - 2)->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p) - 2)->tas.rsize = (0)));
    (((i_ctx_p->exec_stack).stack).p)[-1] = *pproc;
    (((((i_ctx_p->exec_stack).stack).p))->value.pstruct = ((obj_header_t *)(penum)), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_struct) << 8) + ((0) | (((&(i_ctx_p->memory)))->current_space))) );
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (sampled_data_sample), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
    return 5;
}
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    gs_sampled_data_enum *penum = ((gs_sampled_data_enum *)(((((i_ctx_p->exec_stack).stack).p))->value.pstruct));
    ref proc;
    ...
    do { if ( (op += (num_inputs)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (num_inputs); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    for (i = 0; i < num_inputs; i++) {
        double dmin = params->Domain[2 * i];
        double dmax = params->Domain[2 * i + 1];

        ((op - num_inputs + i + 1)->value.realval = ((float) ( penum->indexes[i] * (dmax - dmin)/(params->Size[i] - 1) + dmin)), ((op - num_inputs + i + 1)->tas.type_attrs = ((t_real) << 8) + (0)) );

    }

    proc = (((i_ctx_p->exec_stack).stack).p)[-1];
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (sampled_data_continue), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
...
sampled_data_continue(i_ctx_t *i_ctx_p)
{
    ...
    int bps = ((params->BitsPerSample) >> 3), stack_depth_adjust = 0;





    if (num_out + 3 + penum->o_stack_depth != ref_stack_count(&((i_ctx_p->op_stack).stack))) {
        stack_depth_adjust = ref_stack_count(&((i_ctx_p->op_stack).stack)) - penum->o_stack_depth;

        if (stack_depth_adjust < 0) {
# 502 "./psi/zfsample.c"
            do { if ( (op += (-stack_depth_adjust)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (-stack_depth_adjust); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
            ((((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_object(((gs_memory_t *)((i_ctx_p->memory).current)), penum->pfn, "sampled_data_continue(pfn)"));
            ((((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_object(((gs_memory_t *)((i_ctx_p->memory).current)), penum, "sampled_data_continue((enum)"));
            return ((-23));
        }
    }
    ...
    ((((i_ctx_p->op_stack).stack).p) -= (num_out));
    ...
    if (increment_cube_indexes(params, penum->indexes)) {
        if (stack_depth_adjust == 0)
            ...
            ((((i_ctx_p->op_stack).stack).p) -= (stack_depth_adjust - num_out));

        code = 0;
        if ((*(((((i_ctx_p->exec_stack).stack).p) - 2)->value.opproc)) != 0)
            code = (*(((((i_ctx_p->exec_stack).stack).p) - 2)->value.opproc))(i_ctx_p);

        return code;
    } else {
        if (stack_depth_adjust) {
            stack_depth_adjust -= num_out;
            do { if ( (op += (3 - stack_depth_adjust)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (3 - stack_depth_adjust); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
            for (i=0;i<3 - stack_depth_adjust;i++)
                (((op - i)->tas.type_attrs = ((t_null) << 8) + (0)) );
        }
    }
...
sampled_data_finish(i_ctx_t *i_ctx_p)
{
    ...
    gs_function_t * pfn;
    ref cref;
    int code = gs_function_Sd_init(&pfn, params, ((gs_memory_t *)((i_ctx_p->memory).current)));

    if (code < 0)
        return code;

    code = gs_alloc_ref_array(((i_ctx_p->memory).current), &cref, 0x80 | 0x40, 2, "sampled_data_finish(cref)");

    if (code < 0)
        return code;

    ((cref.value.refs)->value.pstruct = ((obj_header_t *)(pfn)), ((cref.value.refs)->tas.type_attrs = ((t_struct) << 8) + (((0x80 | 0x40) | (((&(i_ctx_p->memory)))->current_space))|((&(i_ctx_p->memory))->new_mask))) );
    ((cref.value.refs + 1)->value.opproc = (zexecfunction), ((cref.value.refs + 1)->tas.type_attrs = ((t_operator) << 8) + ((0x80)|((&(i_ctx_p->memory))->new_mask))), ((cref.value.refs + 1)->tas.rsize = (0)));
    (*(op) = *(&cref));

    (((i_ctx_p->exec_stack).stack).p) -= 3;
    ((((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_object(((gs_memory_t *)((i_ctx_p->memory).current)), penum->pfn, "sampled_data_finish(pfn)"));
    ((((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_object(((gs_memory_t *)((i_ctx_p->memory).current)), penum, "sampled_data_finish(enum)"));
    return 14;
}
...
int make_sampled_function(i_ctx_t * i_ctx_p, ref *arr, ref *pproc, gs_function_t **func)
{
    ...
    if (code < 0)
        return code;
    fptr = (float *)(*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_byte_array)(((gs_memory_t *)((i_ctx_p->memory).current)), num_components * 2, sizeof(float), "make_sampled_function(Domain)");
    if (!fptr)
        return (-25);
    code = space->domain(i_ctx_p, arr, fptr);
    if (code < 0) {
        gs_free_const_object(((gs_memory_t *)((i_ctx_p->memory).current)), fptr, "make_sampled_function(Domain)");
        return code;
    }
    params.Domain = fptr;
    ...
    if (code < 0) {
        gs_free_const_object(((gs_memory_t *)((i_ctx_p->memory).current)), params.Domain, "make_type4_function(Domain)");
        return code;
    }
    fptr = (float *)(*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_byte_array)(((gs_memory_t *)((i_ctx_p->memory).current)), num_components * 2, sizeof(float), "make_sampled_function(Range)");
    if (!fptr) {
        gs_free_const_object(((gs_memory_t *)((i_ctx_p->memory).current)), params.Domain, "make_sampled_function(Domain)");
        return (-25);
    }
    code = altspace->range(i_ctx_p, palternatespace, fptr);
    if (code < 0) {
        gs_free_const_object(((gs_memory_t *)((i_ctx_p->memory).current)), params.Domain, "make_sampled_function(Domain)");
        gs_free_const_object(((gs_memory_t *)((i_ctx_p->memory).current)), fptr, "make_sampled_function(Range)");
        return code;
    }
    params.Range = fptr;
    ...
    ptr = (int *)(*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_byte_array)(((gs_memory_t *)((i_ctx_p->memory).current)), params.m, sizeof(int), "Size");
    if (ptr == ((void*)0)) {
        code = ((-25));
        goto fail;
    }
    ...
    bytes = (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_byte_array)(((gs_memory_t *)((i_ctx_p->memory).current)), total_size, 1, "cube_build_func0(bytes)");
    if (!bytes) {
        code = ((-25));
        goto fail;
    }
...
# 694 "./psi/zfsample.c"
    ...
    return sampled_data_setup(i_ctx_p, pfn, pproc, sampled_data_finish, ((gs_memory_t *)((i_ctx_p->memory).current)));

fail:
    gs_function_Sd_free_params(&params, ((gs_memory_t *)((i_ctx_p->memory).current)));
    return (code < 0 ? code : ((-15)));
}
