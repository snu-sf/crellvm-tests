...
static gs_ptr_type_t font_type0_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst);
static void font_type0_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst);

const gs_memory_struct_type_t st_gs_font_type0 = { sizeof(gs_font_type0), "gs_font_type0", 0, 0, font_type0_enum_ptrs, font_type0_reloc_ptrs, gs_font_finalize, 0 };
static
gs_ptr_type_t font_type0_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_font_type0 *pfont = vptr; switch ( index ) { default:
return (*(st_gs_font).enum_ptrs)(mem, vptr, size, index-(3), pep, &(st_gs_font), gcst);
case 0: return (pep->ptr = (const void *)(((const gs_font_type0 *)vptr)->data.Encoding), (&ptr_struct_procs));
case 1: return (pep->ptr = (const void *)(((const gs_font_type0 *)vptr)->data.FDepVector), (&ptr_struct_procs));
case 2:
switch (pfont->data.FMapType)
{
    case fmap_SubsVector:
        return (pep->ptr = (&((const gs_font_type0 *)vptr)->data.SubsVector)->data, pep->size = (&((const gs_font_type0 *)vptr)->data.SubsVector)->size, (&ptr_const_string_procs));

    case fmap_CMap:
        return (pep->ptr = (const void *)(((const gs_font_type0 *)vptr)->data.CMap), (&ptr_struct_procs));
    default:
        return (pep->ptr = (const void *)(0), (&ptr_struct_procs));
}
} }
static void font_type0_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_font_type0 *pfont = vptr;
(*(st_gs_font).reloc_ptrs)(vptr, size, &(st_gs_font), gcst);
(((gs_font_type0 *)vptr)->data.Encoding = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_type0 *)vptr)->data.Encoding), gcst)));
(((gs_font_type0 *)vptr)->data.FDepVector = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_type0 *)vptr)->data.FDepVector), gcst)));
switch (pfont->data.FMapType)
{
    case fmap_SubsVector:
(((*(const gc_procs_common_t **)(gcst))->reloc_const_string)(&(((gs_font_type0 *)vptr)->data.SubsVector), gcst));
break;
    case fmap_CMap:
(((gs_font_type0 *)vptr)->data.CMap = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_font_type0 *)vptr)->data.CMap), gcst)));
break;
    default:
;
}
