# 1 "./lcms2/src/cmspcs.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmspcs.c" 2
# 27 "./lcms2/src/cmspcs.c"
...
# 28 "./lcms2/src/cmspcs.c" 2
# 91 "./lcms2/src/cmspcs.c"
void cmsXYZ2xyY(cmsCIExyY* Dest, const cmsCIEXYZ* Source)
{
...
{
    if (ab < (-128.0)) ab = (-128.0);
    if (ab > ((65535.0/256.0) - 128.0)) ab = ((65535.0/256.0) - 128.0);
...
void cmsLCh2Lab(cmsCIELab* Lab, const cmsCIELCh* LCh)
{
    cmsFloat64Number h = (LCh -> h * 3.14159265358979323846) / 180.0;
...
void cmsFloat2XYZEncoded(cmsUInt16Number XYZ[3], const cmsCIEXYZ* fXYZ)
{
    ...
    if (xyz.X > (1.0 + 32767.0/32768.0))
        xyz.X = (1.0 + 32767.0/32768.0);

    if (xyz.X < 0)
        xyz.X = 0;

    if (xyz.Y > (1.0 + 32767.0/32768.0))
        xyz.Y = (1.0 + 32767.0/32768.0);

    if (xyz.Y < 0)
        xyz.Y = 0;

    if (xyz.Z > (1.0 + 32767.0/32768.0))
        xyz.Z = (1.0 + 32767.0/32768.0);
...
cmsFloat64Number ComputeLBFD(const cmsCIELab* Lab)
{
  ...
  return (54.6 * (0.43429448190325182765 * (log(yt + 1.5))) - 9.6);
}
...
cmsFloat64Number cmsBFDdeltaE(const cmsCIELab* Lab1, const cmsCIELab* Lab2)
{
    ...
    t = 0.627+(0.055*cos((Aveh-254)/(180/3.14159265358979323846))-
           0.040*cos((2*Aveh-136)/(180/3.14159265358979323846))+
           0.070*cos((3*Aveh-31)/(180/3.14159265358979323846))+
           0.049*cos((4*Aveh+114)/(180/3.14159265358979323846))-
           0.015*cos((5*Aveh-103)/(180/3.14159265358979323846)));

    dh = dc*(g*t+1-g);
    rh = -0.260*cos((Aveh-308)/(180/3.14159265358979323846))-
           0.379*cos((2*Aveh-160)/(180/3.14159265358979323846))-
           0.636*cos((3*Aveh+254)/(180/3.14159265358979323846))+
           0.226*cos((4*Aveh+140)/(180/3.14159265358979323846))-
           0.194*cos((5*Aveh+280)/(180/3.14159265358979323846));
...
cmsFloat64Number cmsCMCdeltaE(const cmsCIELab* Lab1, const cmsCIELab* Lab2, cmsFloat64Number l, cmsFloat64Number c)
{
  ...
  if ((LCh1.h > 164) && (LCh1.h < 345))
      t = 0.56 + fabs(0.2 * cos(((LCh1.h + 168)/(180/3.14159265358979323846))));
  else
      t = 0.36 + fabs(0.4 * cos(((LCh1.h + 35 )/(180/3.14159265358979323846))));
...
cmsFloat64Number cmsCIE2000DeltaE(const cmsCIELab* Lab1, const cmsCIELab* Lab2,
...
cmsColorSpaceSignature _cmsICCcolorSpace(int OurNotation)
{
       ...
       case 1:
       case 3: return cmsSigGrayData;

       case 2:
       case 4: return cmsSigRgbData;

       case 5: return cmsSigCmyData;
       case 6: return cmsSigCmykData;
       case 7:return cmsSigYCbCrData;
       case 8: return cmsSigLuvData;
       case 9: return cmsSigXYZData;

       case 30:
       case 10: return cmsSigLabData;

       case 11: return cmsSigLuvKData;
       case 12: return cmsSigHsvData;
       case 13: return cmsSigHlsData;
       case 14: return cmsSigYxyData;

       case 15: return cmsSigMCH1Data;
       case 16: return cmsSigMCH2Data;
       case 17: return cmsSigMCH3Data;
       case 18: return cmsSigMCH4Data;
       case 19: return cmsSigMCH5Data;
       case 20: return cmsSigMCH6Data;
       case 21: return cmsSigMCH7Data;
       case 22: return cmsSigMCH8Data;

       case 23: return cmsSigMCH9Data;
       case 24: return cmsSigMCHAData;
       case 25: return cmsSigMCHBData;
       case 26: return cmsSigMCHCData;
       case 27: return cmsSigMCHDData;
       case 28: return cmsSigMCHEData;
       case 29: return cmsSigMCHFData;
...
int _cmsLCMScolorSpace(cmsColorSpaceSignature ProfileSpace)
{
    ...
    case cmsSigGrayData: return 3;
    case cmsSigRgbData: return 4;
    case cmsSigCmyData: return 5;
    case cmsSigCmykData: return 6;
    case cmsSigYCbCrData:return 7;
    case cmsSigLuvData: return 8;
    case cmsSigXYZData: return 9;
    case cmsSigLabData: return 10;
    case cmsSigLuvKData: return 11;
    case cmsSigHsvData: return 12;
    case cmsSigHlsData: return 13;
    case cmsSigYxyData: return 14;

    case cmsSig1colorData:
    case cmsSigMCH1Data: return 15;

    case cmsSig2colorData:
    case cmsSigMCH2Data: return 16;

    case cmsSig3colorData:
    case cmsSigMCH3Data: return 17;

    case cmsSig4colorData:
    case cmsSigMCH4Data: return 18;

    case cmsSig5colorData:
    case cmsSigMCH5Data: return 19;

    case cmsSig6colorData:
    case cmsSigMCH6Data: return 20;

    case cmsSigMCH7Data:
    case cmsSig7colorData:return 21;

    case cmsSigMCH8Data:
    case cmsSig8colorData:return 22;

    case cmsSigMCH9Data:
    case cmsSig9colorData:return 23;

    case cmsSigMCHAData:
    case cmsSig10colorData:return 24;

    case cmsSigMCHBData:
    case cmsSig11colorData:return 25;

    case cmsSigMCHCData:
    case cmsSig12colorData:return 26;

    case cmsSigMCHDData:
    case cmsSig13colorData:return 27;

    case cmsSigMCHEData:
    case cmsSig14colorData:return 28;

    case cmsSigMCHFData:
    case cmsSig15colorData:return 29;
