                     ...
                     int *rows_used)
{
    ...
    gx_device *dev;
    const int y = penum->y;
    int y_end = (((y + height) < (penum->rect.h)) ? (y + height) : (penum->rect.h));
        ...
        if (bit_planar) {
            ...
            buffer =
                (*penum->unpack)(penum->buffer, &sourcex,
                                 ...
                                 planes[0].data_x, (((penum->rect.w + (planes[0]).data_x) * penum->spp * penum->bps / num_planes + 7) >> 3),
            ...
            for (px = 1; px < num_planes; ++px) {
                (*penum->unpack)(penum->buffer + (px << penum->log2_xbytes),
                                 ...
                                 planes[px].data_x, (((penum->rect.w + (planes[px]).data_x) * penum->spp * penum->bps / num_planes + 7) >> 3),
                                 &penum->map[px], penum->spread, 1);
                offsets[px] += planes[px].raster;
            }
        }
# 138 "./base/gxidata.c"
        penum->cur.x = ((penum->dda.row.x).state).Q;
        ...
        penum->cur.y = ((penum->dda.row.y).state).Q;
                ...
                case image_portrait:
                    {
                        ...
                        if (yn <= penum->clip_outer.p.y)
                            goto mt;
                        penum->yci = ((yc) < 0 && ((yc) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)((yc) >> (8)) + 1 : ((int)((((yc)+(((1<<8)>>1) - 1L))) >> (8))));
                        penum->hci = ((yn) < 0 && ((yn) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)((yn) >> (8)) + 1 : ((int)((((yn)+(((1<<8)>>1) - 1L))) >> (8)))) - penum->yci;
                        if (penum->hci == 0)
                            goto mt;
                        do { } while (0);
                ...
                case image_landscape:
                    {
                        ...
                        if (xn <= penum->clip_outer.p.x)
                            goto mt;
                        penum->xci = ((xc) < 0 && ((xc) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)((xc) >> (8)) + 1 : ((int)((((xc)+(((1<<8)>>1) - 1L))) >> (8))));
                        penum->wci = ((xn) < 0 && ((xn) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)((xn) >> (8)) + 1 : ((int)((((xn)+(((1<<8)>>1) - 1L))) >> (8)))) - penum->xci;
                        if (penum->wci == 0)
                            goto mt;
                        do { } while (0);
        ...
        if (x_used) {
            ...
            do { uint n_ = (x_used); ((penum->dda.pixel0.x).state).Q += ((penum->dda.pixel0.x).step).dQ * (x_used); while ( n_-- ) { ((penum->dda.pixel0.x).state).R -= ((penum->dda.pixel0.x).step).dR; if ((signed int)((penum->dda.pixel0.x).state).R < 0) { ((penum->dda.pixel0.x).state).Q ++; ((penum->dda.pixel0.x).state).R += ((penum->dda.pixel0.x).step).N; } } } while (0);
            do { uint n_ = (x_used); ((penum->dda.pixel0.y).state).Q += ((penum->dda.pixel0.y).step).dQ * (x_used); while ( n_-- ) { ((penum->dda.pixel0.y).state).R -= ((penum->dda.pixel0.y).step).dR; if ((signed int)((penum->dda.pixel0.y).state).R < 0) { ((penum->dda.pixel0.y).state).Q ++; ((penum->dda.pixel0.y).state).R += ((penum->dda.pixel0.y).step).N; } } } while (0);
            penum->used.x = 0;
        }
        do { } while (0);
        ...
        if (code < 0) {
            ...
            penum->used.x += x_used;
            if (!penum->used.y) {
                do { ((penum->dda.row.x).state).R += ((penum->dda.row.x).step).dR; if (((penum->dda.row.x).state).R >= ((penum->dda.row.x).step).N) { ((penum->dda.row.x).state).Q--; ((penum->dda.row.x).state).R -= ((penum->dda.row.x).step).N; } ((penum->dda.row.x).state).Q -= ((penum->dda.row.x).step).dQ; } while (0);
                do { ((penum->dda.row.y).state).R += ((penum->dda.row.y).step).dR; if (((penum->dda.row.y).state).R >= ((penum->dda.row.y).step).N) { ((penum->dda.row.y).state).Q--; ((penum->dda.row.y).state).R -= ((penum->dda.row.y).step).N; } ((penum->dda.row.y).state).Q -= ((penum->dda.row.y).step).dQ; } while (0);
                (((penum->dda.strip.x).state).Q += (penum->prev.x - penum->cur.x));

                (((penum->dda.strip.y).state).Q += (penum->prev.y - penum->cur.y));
...
gx_image1_flush(gx_image_enum_common_t * info)
{
        ...
        case image_portrait:
            {
                ...
                penum->yci = ((int)(((yc - adjust)+((1<<8)>>1)) >> (8)));
                penum->hci = ((int)(((yc + adjust)+((1<<8)>>1)) >> (8))) - penum->yci;
            }
            break;
        case image_landscape:
            {
                ...
                penum->xci = ((int)(((xc - adjust)+((1<<8)>>1)) >> (8)));
                penum->wci = ((int)(((xc + adjust)+((1<<8)>>1)) >> (8))) - penum->xci;
            }
            break;
        case image_skewed:
            ;
    ...
    update_strip(penum);
    penum->prev = penum->cur;
    return (*penum->render)(penum, ((void*)0), 0, width_spp, 0,
...
update_strip(gx_image_enum *penum)
{
    ...
    (((penum->dda.strip.x).state).Q += (penum->cur.x - penum->prev.x));
    (((penum->dda.strip.y).state).Q += (penum->cur.y - penum->prev.y));
...
# 363 "./base/gxidata.c"
        ...
        if (direct) {
            ...
            dest[0] = (ptab->lookup8[(byte)(w0 >> 24)]); dest += spread;
            dest[1] = (ptab->lookup8[(byte)(w0 >> 16)]); dest += spread;
            dest[2] = (ptab->lookup8[(byte)(w0 >> 8)]); dest += spread;
            dest[3] = (ptab->lookup8[(byte)(w0)]); dest += spread;
            dest[4] = (ptab->lookup8[(byte)(w1 >> 24)]); dest += spread;
            dest[5] = (ptab->lookup8[(byte)(w1 >> 16)]); dest += spread;
            dest[6] = (ptab->lookup8[(byte)(w1 >> 8)]); dest += spread;
            dest[7] = (ptab->lookup8[(byte)(w1)]); dest += spread;
...
gx_image1_end_image(gx_image_enum_common_t * info, bool draw_last)
{
    ...
    if ( penum->rop_dev )
        gx_device_set_target((gx_device_forward *)penum->rop_dev, ((void*)0));
    if ( penum->clip_dev )
        gx_device_set_target((gx_device_forward *)penum->clip_dev, ((void*)0));


    ((mem)->procs.free_object(mem, penum->rop_dev, "image RasterOp"));
    ((mem)->procs.free_object(mem, penum->clip_dev, "image clipper"));

    if (scaler != 0) {
        (*scaler->templat->release) ((stream_state *) scaler);
        ((mem)->procs.free_object(mem, scaler, "image scaler state"));
    }
    if (penum->icc_link != ((void*)0)) {
        gsicc_release_link(penum->icc_link);
    }
    if (penum->color_cache != ((void*)0)) {
        ((mem)->procs.free_object(mem, penum->color_cache->device_contone, "device_contone"));

        ((mem)->procs.free_object(mem, penum->color_cache->is_transparent, "image is_transparent"));

        ((mem)->procs.free_object(mem, penum->color_cache, "image color cache"));
    }
    if (penum->thresh_buffer != ((void*)0)) {
        ((mem)->procs.free_object(mem, penum->thresh_buffer, "image thresh_buffer"));
    }
    if (penum->ht_buffer != ((void*)0)) {
        ((mem)->procs.free_object(mem, penum->ht_buffer, "image ht_buffer"));
    }
    if (penum->clues != ((void*)0)) {
        ((mem)->procs.free_object(mem, penum->clues, "image clues"));
    }
    ((mem)->procs.free_object(mem, penum->line, "image line"));
    ((mem)->procs.free_object(mem, penum->buffer, "image buffer"));
