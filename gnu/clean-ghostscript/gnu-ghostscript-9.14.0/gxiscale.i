...
# 25 "./base/gxiscale.c" 2
# 1 "./base/gxfrac.h" 1
# 27 "./base/gxfrac.h"
typedef short frac;
typedef short signed_frac;
# 26 "./base/gxiscale.c" 2
# 1 "./base/gxarith.h" 1
# 27 "./base/gxarith.h"
...
# 50 "./base/gxiscale.c" 2

static void
decode_sample_frac_to_float(gx_image_enum *penum, frac sample_value, gs_client_color *cc, int i);
# 63 "./base/gxiscale.c"
irender_proc_t gs_image_class_0_interpolate(gx_image_enum *penum);




static int image_render_interpolate(gx_image_enum *penum, const byte *buffer, int data_x, uint w, int h, gx_device *dev);
static int image_render_interpolate_icc(gx_image_enum *penum, const byte *buffer, int data_x, uint w, int h, gx_device *dev);
static int image_render_interpolate_landscape(gx_image_enum *penum, const byte *buffer, int data_x, uint w, int h, gx_device *dev);
static int image_render_interpolate_landscape_icc(gx_image_enum *penum, const byte *buffer, int data_x, uint w, int h, gx_device *dev);
...
gs_image_class_0_interpolate(gx_image_enum * penum)
{
    ...
    if ( pcs->type->index == gs_color_space_index_Indexed) {
        if ( pcs->base_space->cmm_icc_profile_data != ((void*)0)) {
            use_icc = ((bool)1);
        }
    }
    ...
    code = ((penum->dev)->procs.get_profile)(penum->dev, &dev_profile);
    if (code) {
        penum->interpolate = ((bool)0);
        return 0;
    }
...
# 156 "./base/gxiscale.c"
    ...
    if (penum->posture == image_portrait) {
        fixed dw = ((penum->dst_width) < 0 ? -(penum->dst_width) : (penum->dst_width));
        fixed dh = ((penum->dst_height) < 0 ? -(penum->dst_height) : (penum->dst_height));
        iss.WidthOut = (((fixed)((int64_t)(penum->rect.x + penum->rect.w) * dw / penum->Width)) < 0 && (((fixed)((int64_t)(penum->rect.x + penum->rect.w) * dw / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)(penum->rect.x + penum->rect.w) * dw / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)(penum->rect.x + penum->rect.w) * dw / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))))

                     - (((fixed)((int64_t)penum->rect.x * dw / penum->Width)) < 0 && (((fixed)((int64_t)penum->rect.x * dw / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)penum->rect.x * dw / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)penum->rect.x * dw / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))));

        iss.HeightOut = (((fixed)((int64_t)(penum->rect.y + penum->rect.h) * dh / penum->Height)) < 0 && (((fixed)((int64_t)(penum->rect.y + penum->rect.h) * dh / penum->Height)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)(penum->rect.y + penum->rect.h) * dh / penum->Height)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)(penum->rect.y + penum->rect.h) * dh / penum->Height))+(((1<<8)>>1) - 1L))) >> (8))))

                      - (((fixed)((int64_t)penum->rect.y * dh / penum->Height)) < 0 && (((fixed)((int64_t)penum->rect.y * dh / penum->Height)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)penum->rect.y * dh / penum->Height)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)penum->rect.y * dh / penum->Height))+(((1<<8)>>1) - 1L))) >> (8))));

        iss.EntireWidthOut = ((int)((((dw)+(((1<<8)>>1) - 1L))) >> (8)));
        iss.EntireHeightOut = ((int)((((dh)+(((1<<8)>>1) - 1L))) >> (8)));
        iss.PatchWidthOut = (((fixed)((int64_t)(penum->rrect.x + penum->rrect.w) * dw / penum->Width)) < 0 && (((fixed)((int64_t)(penum->rrect.x + penum->rrect.w) * dw / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)(penum->rrect.x + penum->rrect.w) * dw / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)(penum->rrect.x + penum->rrect.w) * dw / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))))

                          - (((fixed)((int64_t)penum->rrect.x * dw / penum->Width)) < 0 && (((fixed)((int64_t)penum->rrect.x * dw / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)penum->rrect.x * dw / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)penum->rrect.x * dw / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))));

        iss.PatchHeightOut = (((fixed)((int64_t)(penum->rrect.y + penum->rrect.h) * dh / penum->Height)) < 0 && (((fixed)((int64_t)(penum->rrect.y + penum->rrect.h) * dh / penum->Height)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)(penum->rrect.y + penum->rrect.h) * dh / penum->Height)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)(penum->rrect.y + penum->rrect.h) * dh / penum->Height))+(((1<<8)>>1) - 1L))) >> (8))))

                           - (((fixed)((int64_t)penum->rrect.y * dh / penum->Height)) < 0 && (((fixed)((int64_t)penum->rrect.y * dh / penum->Height)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)penum->rrect.y * dh / penum->Height)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)penum->rrect.y * dh / penum->Height))+(((1<<8)>>1) - 1L))) >> (8))));

        iss.LeftMarginOut = (((fixed)((int64_t)iss.LeftMarginIn * dw / penum->Width)) < 0 && (((fixed)((int64_t)iss.LeftMarginIn * dw / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)iss.LeftMarginIn * dw / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)iss.LeftMarginIn * dw / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))));

    } else {
        fixed dw = ((penum->dst_width) < 0 ? -(penum->dst_width) : (penum->dst_width));
        fixed dh = ((penum->dst_height) < 0 ? -(penum->dst_height) : (penum->dst_height));
        iss.WidthOut = (((fixed)((int64_t)(penum->rect.x + penum->rect.w) * dh / penum->Width)) < 0 && (((fixed)((int64_t)(penum->rect.x + penum->rect.w) * dh / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)(penum->rect.x + penum->rect.w) * dh / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)(penum->rect.x + penum->rect.w) * dh / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))))

                     - (((fixed)((int64_t)penum->rect.x * dh / penum->Width)) < 0 && (((fixed)((int64_t)penum->rect.x * dh / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)penum->rect.x * dh / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)penum->rect.x * dh / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))));

        iss.HeightOut = (((fixed)((int64_t)(penum->rect.y + penum->rect.h) * dw / penum->Height)) < 0 && (((fixed)((int64_t)(penum->rect.y + penum->rect.h) * dw / penum->Height)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)(penum->rect.y + penum->rect.h) * dw / penum->Height)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)(penum->rect.y + penum->rect.h) * dw / penum->Height))+(((1<<8)>>1) - 1L))) >> (8))))

                      - (((fixed)((int64_t)penum->rect.y * dw / penum->Height)) < 0 && (((fixed)((int64_t)penum->rect.y * dw / penum->Height)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)penum->rect.y * dw / penum->Height)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)penum->rect.y * dw / penum->Height))+(((1<<8)>>1) - 1L))) >> (8))));

        iss.EntireWidthOut = ((int)((((dh)+(((1<<8)>>1) - 1L))) >> (8)));
        iss.EntireHeightOut = ((int)((((dw)+(((1<<8)>>1) - 1L))) >> (8)));
        iss.PatchWidthOut = (((fixed)((int64_t)(penum->rrect.x + penum->rrect.w) * dh / penum->Width)) < 0 && (((fixed)((int64_t)(penum->rrect.x + penum->rrect.w) * dh / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)(penum->rrect.x + penum->rrect.w) * dh / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)(penum->rrect.x + penum->rrect.w) * dh / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))))

                          - (((fixed)((int64_t)penum->rrect.x * dh / penum->Width)) < 0 && (((fixed)((int64_t)penum->rrect.x * dh / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)penum->rrect.x * dh / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)penum->rrect.x * dh / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))));

        iss.PatchHeightOut = (((fixed)((int64_t)(penum->rrect.y + penum->rrect.h) * dw / penum->Height)) < 0 && (((fixed)((int64_t)(penum->rrect.y + penum->rrect.h) * dw / penum->Height)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)(penum->rrect.y + penum->rrect.h) * dw / penum->Height)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)(penum->rrect.y + penum->rrect.h) * dw / penum->Height))+(((1<<8)>>1) - 1L))) >> (8))))

                           - (((fixed)((int64_t)penum->rrect.y * dw / penum->Height)) < 0 && (((fixed)((int64_t)penum->rrect.y * dw / penum->Height)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)penum->rrect.y * dw / penum->Height)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)penum->rrect.y * dw / penum->Height))+(((1<<8)>>1) - 1L))) >> (8))));

        iss.LeftMarginOut = (((fixed)((int64_t)iss.LeftMarginIn * dh / penum->Width)) < 0 && (((fixed)((int64_t)iss.LeftMarginIn * dh / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)iss.LeftMarginIn * dh / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)iss.LeftMarginIn * dh / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))));

    }
    iss.PatchWidthOut = ((iss.PatchWidthOut) < 0 ? -(iss.PatchWidthOut) : (iss.PatchWidthOut));
    iss.PatchHeightOut = ((iss.PatchHeightOut) < 0 ? -(iss.PatchHeightOut) : (iss.PatchHeightOut));
    ...
    iss.WidthOut = ((iss.WidthOut) < 0 ? -(iss.WidthOut) : (iss.WidthOut));
    iss.HeightOut = ((iss.HeightOut) < 0 ? -(iss.HeightOut) : (iss.HeightOut));
    ...
    if (pcs->type->index == gs_color_space_index_Indexed) {
        ...
        iss.spp_decode = (*(pcs->base_space)->type->num_components)(pcs->base_space);
    } else {


        iss.spp_decode = (*(pcs)->type->num_components)(pcs);
    }
...
# 265 "./base/gxiscale.c"
        ...
        if (use_icc) {
            ...
            iss.MaxValueIn = ((frac)0x7ff8);
        }
        in_size = ( ((1 << 3)) & (((1 << 3)) - 1) ? ((iss.WidthIn * iss.spp_decode * sizeof(frac)) + (((1 << 3)) - 1)) / ((1 << 3)) * ((1 << 3)) : ((iss.WidthIn * iss.spp_decode * sizeof(frac)) + (((1 << 3)) - 1)) & -((1 << 3)) );
    ...
    pol = (*(pcs)->type->polarity)(pcs);
    if ((iss.WidthOut < iss.WidthIn) &&
        (iss.HeightOut < iss.HeightIn) &&
        (pol != GX_CINFO_POLARITY_UNKNOWN) &&
        (((penum->dev)->procs.dev_spec_op)(penum->dev, gxdso_interpolate_antidropout, ((void*)0), 0) > 0)) {
        ...
        int threshold = ((penum->dev)->procs.dev_spec_op)(penum->dev, gxdso_interpolate_threshold, ((void*)0), 0);
        if ((threshold > 0) &&
    ...
    {
        uint out_size =
            iss.WidthOut * (((iss.spp_interp * (iss.BitsPerComponentOut / 8)) > (sizeof(gx_color_index_data))) ? (iss.spp_interp * (iss.BitsPerComponentOut / 8)) : (sizeof(gx_color_index_data)));




        out_size += (1 << 3);
        line = (*(mem)->procs.alloc_bytes)(mem, in_size + out_size, "image scale src+dst line");
    ...
    if (line == 0 || pss == 0 ||
        ...
        ((mem)->procs.free_object(mem, pss, "image scale state"));
        ((mem)->procs.free_object(mem, line, "image scale src+dst line"));
    ...
    if (penum->posture == image_portrait) {
        ...
        if (penum->matrix.xx < 0)
            do { uint n_ = (penum->rect.w); ((x0).state).Q += ((x0).step).dQ * (penum->rect.w); while ( n_-- ) { ((x0).state).R -= ((x0).step).dR; if ((signed int)((x0).state).R < 0) { ((x0).state).Q ++; ((x0).state).R += ((x0).step).N; } } } while (0);
        penum->xyi.x = ((int)((((((x0).state).Q)+(((1<<8)>>1) - 1L))) >> (8))) + pss->params.LeftMarginOut;
        penum->xyi.y = penum->yi0 + (((fixed)((int64_t)penum->rect.y * penum->dst_height / penum->Height)) < 0 && (((fixed)((int64_t)penum->rect.y * penum->dst_height / penum->Height)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)penum->rect.y * penum->dst_height / penum->Height)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)penum->rect.y * penum->dst_height / penum->Height))+(((1<<8)>>1) - 1L))) >> (8))));
        ...
        if (penum->matrix.xy < 0)
            x0 += penum->rrect.w;
        penum->xyi.x = ((int)((((((penum->dda.pixel0.x).state).Q)+(((1<<8)>>1) - 1L))) >> (8)));
        penum->xyi.y = penum->yi0 + (((fixed)((int64_t)x0 * penum->dst_height / penum->Width)) < 0 && (((fixed)((int64_t)x0 * penum->dst_height / penum->Width)) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)(((fixed)((int64_t)x0 * penum->dst_height / penum->Width)) >> (8)) + 1 : ((int)(((((fixed)((int64_t)x0 * penum->dst_height / penum->Width))+(((1<<8)>>1) - 1L))) >> (8))));
    ...
    if (use_icc) {
        ...
        gsicc_rendering_param_t rendering_params;
        int k;
        int src_num_comp = (*(penum->pcs)->type->num_components)(penum->pcs);

        penum->icc_setup.need_decode = ((bool)0);

        for (k = 0; k < src_num_comp; k++) {
            if ( penum->map[k].decoding != sd_none ) {
                penum->icc_setup.need_decode = ((bool)1);
                break;
            }
        }
        ...
        if (gs_color_space_is_PSCIE(penum->pcs) && penum->pcs->icc_equivalent != ((void*)0)) {
        ...
        if (penum->icc_setup.is_lab) penum->icc_setup.need_decode = ((bool)0);
        penum->icc_setup.must_halftone = ((( (penum->dev)->color_info.num_components > 1 || (penum->dev)->color_info.gray_index == 0xff ) ? (penum->dev)->color_info.max_color : (penum->dev)->color_info.max_gray) < 31);
        penum->icc_setup.has_transfer =
            gx_has_transfer(penum->pis, num_des_comps);
        if (penum->icc_link == ((void*)0)) {
            penum->icc_link = gsicc_get_link(penum->pis, penum->dev, pcs, ((void*)0),
...
# 482 "./base/gxiscale.c"
                if (!need_decode) {
                    ...
                    if (!reversed) {
                        ...
                        stream_r->ptr = out - 1;
                        out += ( ((1 << 3)) & (((1 << 3)) - 1) ? ((pss->params.WidthIn * spp_decode) + (((1 << 3)) - 1)) / ((1 << 3)) * ((1 << 3)) : ((pss->params.WidthIn * spp_decode) + (((1 << 3)) - 1)) & -((1 << 3)) );
                    ...
                    for (i = 0; i < pss->params.WidthIn; i++, psrc += spp_decode) {
                        ...
                        for (j = 0; j < dc; ++j) {
                            switch ( penum->map[j].decoding ) { case sd_none: cc.paint.values[j] = (pdata[j]) * (1.0f / 255.0f); break; case sd_lookup: cc.paint.values[j] = penum->map[j].decode_lookup[(pdata[j]) >> 4]; break; case sd_compute: cc.paint.values[j] = penum->map[j].decode_lookup[0] + (pdata[j]) * penum->map[j].decode_factor; };
                            psrc[j] = ( (0.0 < cc.paint.values[j] && cc.paint.values[j] < 1.0) ? ((unsigned char) (cc.paint.values[j]*255.0)) : ( (cc.paint.values[j] <= 0.0) ? 0x00 : 0xFF ));
                        }
                        pdata += dpd;
                    }
                    out += ( ((1 << 3)) & (((1 << 3)) - 1) ? ((pss->params.WidthIn * spp_decode) + (((1 << 3)) - 1)) / ((1 << 3)) * ((1 << 3)) : ((pss->params.WidthIn * spp_decode) + (((1 << 3)) - 1)) & -((1 << 3)) );
                ...
                int dc = penum->spp;
                const byte *pdata = bdata;
                unsigned char *psrc = (unsigned char *) penum->line;
                int i;
                ...
                max_range = (penum->map[0].decode_factor < 0 ?
                    penum->map[0].decode_lookup[0] :
                penum->map[0].decode_lookup[0] + 255.0 * penum->map[0].decode_factor);
            ...
            if (pcs->type->index != gs_color_space_index_Indexed) {
                ...
                if (is_icc) {
                    ...
                    for (i = 0; i < pss->params.WidthIn; i++,
                        ...
                        for (j = 0; j < dc; ++j) {
                            psrc[j] = gx_unit_frac(penum->map[j].decode_lookup[0] + (((const frac *)pdata)[j]) * penum->map[j].decode_factor);
                        }
                        pdata += dpd;
# 646 "./base/gxiscale.c"
                    }
                }
                out += ( ((1 << 3)) & (((1 << 3)) - 1) ? ((pss->params.WidthIn * spp_decode * sizeof(frac)) + (((1 << 3)) - 1)) / ((1 << 3)) * ((1 << 3)) : ((pss->params.WidthIn * spp_decode * sizeof(frac)) + (((1 << 3)) - 1)) & -((1 << 3)) );
                ...
                for (i = 0; i < pss->params.WidthIn; i++, psrc += spp_decode) {
                    ...
                    decode_value = penum->map[i].decode_lookup[0] +
                         ...
                         int data_x, uint iw, int h, gx_device * dev)
{
    ...
    initial_decode(penum, buffer, data_x, h, need_decode, &stream_r, ((bool)0));
...

    {
        ...
        uint raster = ((uint)((((width * bpp) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3));
        bool device_color;
        ...
        for (;;) {
            ...
            byte *l_dptr = (out); int l_dbit = (0); byte l_dbyte = ((l_dbit) ? (byte)(*(l_dptr) & (0xff00 >> (l_dbit))) : 0); int l_xprev = (xo);
            stream_w.limit = out + width *
                (((spp_decode * sizeofPixelOut) > (sizeof(gx_color_index_data))) ? (spp_decode * sizeofPixelOut) : (sizeof(gx_color_index_data))) - 1;
...
# 779 "./base/gxiscale.c"
                    ...
                    pconcs = (*(pactual_cs)->type->concrete_space)(pactual_cs, pis);
                    if (pconcs->cmm_icc_profile_data != ((void*)0)) {
                        device_color = ((bool)0);
                    } else {
                    ...
                    if (device_color) {
                        ...
                        for (j = 0; j < num_components; ++j) {
                            ...
                            if (is_index_space || islab) {
                                cc.paint.values[j] = ((psrc[j]) / ((float)((frac)0x7ff8)));
                            } else {
                        ...
                        if (gs_color_space_is_ICC(pactual_cs) &&
                            pactual_cs->cmm_icc_profile_data != ((void*)0) &&
                    ...
                    if (code < 0)
                        return code;
                    if (((&devc)->type == (&gx_dc_type_data_pure))) {
                        ...
                        switch (spp_decode) {
                            case 1:
                                do {
                                    if (sizeof(color) > 4) do { switch ( (bpp) >> 2 ) { case 0: if ( (l_dbit += (bpp)) == 8 ) *(l_dptr)++ = l_dbyte | (byte)(color), l_dbyte = 0, l_dbit = 0; else l_dbyte |= (byte)((color) << (8 - l_dbit)); break; case 1: if ( l_dbit ^= 4 ) l_dbyte = (byte)((color) << 4); else *(l_dptr)++ = l_dbyte | ((byte)(color)); break; case 3: if ( l_dbit ^= 4 ) *(l_dptr)++ = (byte)((color) >> 4), l_dbyte = (byte)((color) << 4); else *(l_dptr) = l_dbyte | (byte)((color) >> 8), (l_dptr)[1] = (byte)(color), l_dptr += 2; break; case 16: *(l_dptr)++ = (byte)((color) >> ((56) >= 8 * sizeof((color)) ? (56) & (8 * sizeof((color)) - 1) : (56))); case 14: *(l_dptr)++ = (byte)((color) >> ((48) >= 8 * sizeof((color)) ? (48) & (8 * sizeof((color)) - 1) : (48))); case 12: *(l_dptr)++ = (byte)((color) >> ((40) >= 8 * sizeof((color)) ? (40) & (8 * sizeof((color)) - 1) : (40))); case 10: *(l_dptr)++ = (byte)((color) >> ((32) >= 8 * sizeof((color)) ? (32) & (8 * sizeof((color)) - 1) : (32))); case 8: *(l_dptr)++ = (byte)((color) >> 24); case 6: *(l_dptr)++ = (byte)((color) >> 16); case 4: *(l_dptr)++ = (byte)((color) >> 8); case 2: *(l_dptr)++ = (byte)(color); break; default: return ((-15)); } } while (0); else do { switch ( (bpp) >> 2 ) { case 0: if ( (l_dbit += (bpp)) == 8 ) *(l_dptr)++ = l_dbyte | (byte)(color), l_dbyte = 0, l_dbit = 0; else l_dbyte |= (byte)((color) << (8 - l_dbit)); break; case 1: if ( l_dbit ^= 4 ) l_dbyte = (byte)((color) << 4); else *(l_dptr)++ = l_dbyte | ((byte)(color)); break; case 3: if ( l_dbit ^= 4 ) *(l_dptr)++ = (byte)((color) >> 4), l_dbyte = (byte)((color) << 4); else *(l_dptr) = l_dbyte | (byte)((color) >> 8), (l_dptr)[1] = (byte)(color), l_dptr += 2; break; case 8: *(l_dptr)++ = (byte)((color) >> 24); case 6: *(l_dptr)++ = (byte)((color) >> 16); case 4: *(l_dptr)++ = (byte)((color) >> 8); case 2: *(l_dptr)++ = (byte)(color); break; default: return ((-15)); } } while (0);
                                    do { } while (0);
                                    x++, psrc += 1;
                        ...
                        if ( (x) > l_xprev ) { int code; if ( (l_dbit) != 0 ) *(l_dptr) = l_dbyte | (*(l_dptr) & (0xff >> (l_dbit)));; code = (*((dev)->procs.copy_color)) (dev, out, l_xprev - (xo), raster, 0L, l_xprev, ry, (x) - l_xprev, 1); if ( code < 0 ) return code; };
                        rcode = (*(&devc)->type->fill_rectangle)(&devc, x, ry, 1, 1, dev, lop, ((void*)0));

                        if (rcode < 0)
                            return rcode;
                        if ( (bpp) < 8 ) { if ( (l_dbit) != 0 ) *(l_dptr) = l_dbyte | (*(l_dptr) & (0xff >> (l_dbit)));; do { l_dbit += (bpp); l_dptr += l_dbit >> 3; l_dbit &= 7; } while (0); l_dbyte &= ~(0xff << l_dbit); } else l_dptr += ((bpp) >> 3);
                        l_xprev = x + 1;
                        x++, psrc += spp_decode;
                    }
                }
...
inactive:
            ...
            if ((status == 0 && stream_r.ptr == stream_r.limit) || status == ((int)(-1)))
                break;
        }
    }
    return (h == 0 ? 0 : 1);
                         ...
                         int data_x, uint iw, int h, gx_device * dev)
{
    ...
    if (penum->icc_link == ((void*)0)) {
        return gs_throw_imp(__func__, "./base/gxiscale.c", 913, 1, -1, "ICC Link not created during gs_image_class_0_interpolate");
    }
    ...
    initial_decode(penum, buffer, data_x, h, need_decode, &stream_r, ((bool)1));
...

    {
        ...
        if (pss->params.early_cm && !penum->icc_link->is_identity
            ...
            p_cm_buff =
                (byte *) (*(pis->memory)->procs.alloc_bytes)(pis->memory, num_bytes_decode * width_in * spp_cm, "image_render_interpolate_icc");



            gsicc_init_buffer(&input_buff_desc, spp_decode, num_bytes_decode,
                          ((bool)0), ((bool)0), ((bool)0), 0, width_in * spp_decode,
                          1, width_in);
            gsicc_init_buffer(&output_buff_desc, spp_cm, num_bytes_decode,
                          ((bool)0), ((bool)0), ((bool)0), 0, width_in * spp_cm,
                          1, width_in);
            ...
            if (!penum->icc_link->is_identity) {
                p_cm_buff = (byte *) (*(pis->memory)->procs.alloc_bytes)(pis->memory, sizeof(unsigned short) * width * spp_cm, "image_render_interpolate_icc");



                gsicc_init_buffer(&input_buff_desc, spp_decode, 2,
                              ((bool)0), ((bool)0), ((bool)0), 0, width * spp_decode,
                              1, pss->params.PatchWidthOut);
                gsicc_init_buffer(&output_buff_desc, spp_cm, 2,
                              ((bool)0), ((bool)0), ((bool)0), 0, width * spp_cm,
                              1, pss->params.PatchWidthOut);
            }
        }
        for (;;) {
            ...
            byte *l_dptr = (out); int l_dbit = (0); byte l_dbyte = ((l_dbit) ? (byte)(*(l_dptr) & (0xff00 >> (l_dbit))) : 0); int l_xprev = (xo);
            stream_w.limit = out + width *
                (((spp_interp * sizeofPixelOut) > (sizeof(gx_color_index_data))) ? (spp_interp * sizeofPixelOut) : (sizeof(gx_color_index_data))) - 1;
...
# 1054 "./base/gxiscale.c"
                    if (must_halftone || has_transfer) {
                        ...
                        color = ((dev)->procs.encode_color)(dev, p_cm_interp);

                        if (color != ((gx_color_index)(~0)))
                            ((&devc)->colors.pure = (color), (&devc)->type = (&gx_dc_type_data_pure));
                    }
                    if (((&devc)->type == (&gx_dc_type_data_pure))) {
...
inactive:
        ...
        if (p_cm_buff != ((void*)0)) {
            ((pis->memory)->procs.free_object(pis->memory, (byte *)p_cm_buff, "image_render_interpolate_icc"));
...
# 1216 "./base/gxiscale.c"
...

                    {
                        ...
                        rcode = (*(&devc)->type->fill_rectangle)(&devc, ry, x, 1, 1, dev, lop, ((void*)0));
                                       ...
                                       gx_device * dev)
{
    ...
    if (penum->icc_link == ((void*)0)) {
        return gs_throw_imp(__func__, "./base/gxiscale.c", 1316, 1, -1, "ICC Link not created during gs_image_class_0_interpolate");
    }
# 1326 "./base/gxiscale.c"
    need_decode = !((penum->device_color || penum->icc_setup.is_lab) &&
                     (penum->icc_setup.need_decode == 0) ||
                     gs_color_space_is_CIE(pcs));
    initial_decode(penum, buffer, data_x, h, need_decode, &stream_r, ((bool)1));
...
decode_sample_frac_to_float(gx_image_enum *penum, frac sample_value, gs_client_color *cc, int i)
{
    ...
    {
        case sd_none:
            cc->paint.values[i] = ((sample_value) / ((float)((frac)0x7ff8)));
            break;
        case sd_lookup:
            cc->paint.values[i] =
                   penum->map[i].decode_lookup[(((byte)((uint)((((sample_value) >> (15 - 3)) + (sample_value)) >> (15 - (8)))))) >> 4];
            break;
        case sd_compute:
            cc->paint.values[i] =
                   penum->map[i].decode_lookup[0] + ((sample_value) / ((float)((frac)0x7ff8)))*255.0 * penum->map[i].decode_factor;
    }
}
