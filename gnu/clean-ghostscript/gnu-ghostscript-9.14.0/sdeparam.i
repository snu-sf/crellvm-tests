...
static const gs_param_item_t s_DCTE_param_items[] =
{
    ...
    { "Columns", gs_param_type_int, ((int) ( (char *)&((dcte_scalars_t *)0)->Columns - (char *)((dcte_scalars_t *)0) )) },
    { "Rows", gs_param_type_int, ((int) ( (char *)&((dcte_scalars_t *)0)->Rows - (char *)((dcte_scalars_t *)0) )) },
    { "Colors", gs_param_type_int, ((int) ( (char *)&((dcte_scalars_t *)0)->Colors - (char *)((dcte_scalars_t *)0) )) },
    { "Marker", gs_param_type_string, ((int) ( (char *)&((dcte_scalars_t *)0)->Markers - (char *)((dcte_scalars_t *)0) )) },
    { "NoMarker", gs_param_type_bool, ((int) ( (char *)&((dcte_scalars_t *)0)->NoMarker - (char *)((dcte_scalars_t *)0) )) },
    { "Resync", gs_param_type_int, ((int) ( (char *)&((dcte_scalars_t *)0)->Resync - (char *)((dcte_scalars_t *)0) )) },
    { "Blend", gs_param_type_int, ((int) ( (char *)&((dcte_scalars_t *)0)->Blend - (char *)((dcte_scalars_t *)0) )) },
...
int s_DCTE_get_params(gs_param_list *plist, const stream_DCT_state *ss, bool all);
 ...
 const jpeg_compress_data * jcdp, gs_memory_t * mem, bool is_vert, bool all)
{
    ...
    if (write) {
        int *data = (int *)(*(mem)->procs.alloc_byte_array)(mem, num_colors, sizeof(int), "dcte_get_samples");
...
s_DCTE_get_params(gs_param_list * plist, const stream_DCT_state * ss, bool all)
{
    ...
    if (!all) {
        jpeg_compress_data *jcdp_default = (jpeg_compress_data *)(*(mem)->procs.alloc_struct_immovable)(mem, &st_jpeg_compress_data, "s_DCTE_get_params");
    ...
    params.Markers.persistent = ((bool)0);
    ...
    if ((code = s_DCT_get_params(plist, ss, defaults)) < 0 ||
        ...
        (code = dcte_get_samples(plist, "HSamples", params.Colors,
                                 jcdp, mem, ((bool)0), all)) < 0 ||
        (code = dcte_get_samples(plist, "VSamples", params.Colors,
                                 jcdp, mem, ((bool)1), all)) < 0 ||
    (code = s_DCT_get_quantization_tables(plist, ss, defaults, ((bool)1))) < 0 ||
        (code = s_DCT_get_huffman_tables(plist, ss, defaults, ((bool)1))) < 0
        )
        do { } while (0);

  fail:if (defaults) {
        gs_jpeg_destroy(&dcts_defaults);
        ((mem)->procs.free_object(mem, dcts_defaults.data.compress, "s_DCTE_get_params"));
...
int s_DCTE_put_params(gs_param_list *plist, stream_DCT_state *ss);
...
s_DCTE_put_params(gs_param_list * plist, stream_DCT_state * pdct)
{
    ...
    if ((code = gs_jpeg_set_defaults(pdct)) < 0)
        return code;
    if ((code = s_DCT_put_huffman_tables(plist, pdct, ((bool)1))) < 0)
        return code;
    switch ((code = s_DCT_put_quantization_tables(plist, pdct, ((bool)1)))) {
        case 0:
            break;
        default:
            return code;
        case 1:
            ...
            if (pdct->QFactor != 1.0) {
                code = gs_jpeg_set_linear_quality(pdct,
                                             (int)((((pdct->QFactor) < (100.0)) ? (pdct->QFactor) : (100.0))
                                                   * 100.0 + 0.5),
                                                  TRUE);
                if (code < 0)
                    return code;
