...
static gs_ptr_type_t text_params_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void text_params_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_gs_text_params = { sizeof(gs_text_params_t), "gs_text_params", 0, 0, text_params_enum_ptrs, text_params_reloc_ptrs, 0, 0 };
static gs_ptr_type_t text_enum_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void text_enum_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_gs_text_enum = { sizeof(gs_text_enum_t), "gs_text_enum_t", 0, 0, text_enum_enum_ptrs, text_enum_reloc_ptrs, 0, 0 };

static
gs_ptr_type_t text_params_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_text_params_t *tptr = vptr; switch ( index ) { default: return 0;
case 0:
if (tptr->operation & 0x00001) {
    return (pep->ptr = tptr->data.bytes, pep->size = tptr->size, (&ptr_const_string_procs));
}
if (tptr->operation & 0x00002)
    return (pep->ptr = (const void *)(tptr->data.bytes), (&ptr_struct_procs));
if (tptr->operation & 0x00004)
    return (pep->ptr = (const void *)(tptr->data.chars), (&ptr_struct_procs));
if (tptr->operation & 0x00008)
    return (pep->ptr = (const void *)(tptr->data.glyphs), (&ptr_struct_procs));
return (pep->ptr = (const void *)(((void*)0)), (&ptr_struct_procs));
case 1:
return (pep->ptr = (const void *)(tptr->operation & 0x00100 ? tptr->x_widths : ((void*)0)), (&ptr_struct_procs));

case 2:
return (pep->ptr = (const void *)(tptr->operation & 0x00100 ? tptr->y_widths : ((void*)0)), (&ptr_struct_procs));

} }
static void text_params_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_text_params_t *tptr = vptr;
{
    if (tptr->operation & 0x00001) {
        gs_const_string str;
    ...
    } else if (tptr->operation & 0x00002)
        (tptr->data.bytes = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(tptr->data.bytes), gcst)));
    else if (tptr->operation & 0x00004)
        (tptr->data.chars = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(tptr->data.chars), gcst)));
    else if (tptr->operation & 0x00008)
        (tptr->data.glyphs = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(tptr->data.glyphs), gcst)));
    if (tptr->operation & 0x00100) {
        (tptr->x_widths = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(tptr->x_widths), gcst)));
        (tptr->y_widths = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(tptr->y_widths), gcst)));
    }
}
}

static gs_ptr_type_t text_enum_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_text_enum_t *eptr = vptr; switch ( index ) { default:
{
    if (index == 8) {
        if (eptr->pair != 0)
            return (pep->ptr = (const void *)(eptr->pair - eptr->pair->index), (&ptr_struct_procs));
        else
            return (pep->ptr = (const void *)(0), (&ptr_struct_procs));
    }
    index -= 9;
    if (index <= eptr->fstack.depth)
        return (pep->ptr = (const void *)(eptr->fstack.items[index].font), (&ptr_struct_procs));
    index -= eptr->fstack.depth + 1;
     return (*(st_gs_text_params).enum_ptrs)(mem, &eptr->text, sizeof(eptr->text), index, pep, &(st_gs_text_params), gcst);
}
case 0: return (pep->ptr = (const void *)(gx_device_enum_ptr(eptr->dev)), (&ptr_struct_procs));
case 1: return (pep->ptr = (const void *)(gx_device_enum_ptr(eptr->imaging_dev)), (&ptr_struct_procs));
case 2: return (pep->ptr = (const void *)(((const gs_text_enum_t *)vptr)->pis), (&ptr_struct_procs)); case (2)+1: return (pep->ptr = (const void *)(((const gs_text_enum_t *)vptr)->orig_font), (&ptr_struct_procs)); case (2)+2: return (pep->ptr = (const void *)(((const gs_text_enum_t *)vptr)->path), (&ptr_struct_procs));
case 5: return (pep->ptr = (const void *)(((const gs_text_enum_t *)vptr)->pdcolor), (&ptr_struct_procs)); case (5)+1: return (pep->ptr = (const void *)(((const gs_text_enum_t *)vptr)->pcpath), (&ptr_struct_procs)); case (5)+2: return (pep->ptr = (const void *)(((const gs_text_enum_t *)vptr)->current_font), (&ptr_struct_procs));
} }

static void text_enum_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_text_enum_t *eptr = vptr;
{
    int i;

    (*(st_gs_text_params).reloc_ptrs)(&eptr->text, sizeof(eptr->text), &(st_gs_text_params), gcst);
    eptr->dev = gx_device_reloc_ptr(eptr->dev, gcst);
    eptr->imaging_dev = gx_device_reloc_ptr(eptr->imaging_dev, gcst);
    (((gs_text_enum_t *)vptr)->pis = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_text_enum_t *)vptr)->pis), gcst))); (((gs_text_enum_t *)vptr)->orig_font = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_text_enum_t *)vptr)->orig_font), gcst))); (((gs_text_enum_t *)vptr)->path = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_text_enum_t *)vptr)->path), gcst)));
    (((gs_text_enum_t *)vptr)->pdcolor = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_text_enum_t *)vptr)->pdcolor), gcst))); (((gs_text_enum_t *)vptr)->pcpath = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_text_enum_t *)vptr)->pcpath), gcst))); (((gs_text_enum_t *)vptr)->current_font = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_text_enum_t *)vptr)->current_font), gcst)));
    if (eptr->pair != ((void*)0))
        eptr->pair = (cached_fm_pair *)(((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(eptr->pair - eptr->pair->index), gcst)) +
                             eptr->pair->index;
    for (i = 0; i <= eptr->fstack.depth; i++)
        (((gs_text_enum_t *)vptr)->fstack.items[i].font = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_text_enum_t *)vptr)->fstack.items[i].font), gcst)));
}
}
...
{
    if (((!(((text)->operation) & (0x00001 | 0x00002 | 0x00004 | 0x00008 | (0x00010 | 0x00020))) || !(((text)->operation) & (0x00200 | 0x00400 | (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000))) || ( (((text)->operation) & (0x00001 | 0x00002 | 0x00004 | 0x00008 | (0x00010 | 0x00020))) & ((((text)->operation) & (0x00001 | 0x00002 | 0x00004 | 0x00008 | (0x00010 | 0x00020))) - 1) ) || ( (((text)->operation) & (0x00200 | 0x00400 | (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000))) & ((((text)->operation) & (0x00200 | 0x00400 | (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000))) - 1) ) || ((((text)->operation) & (0x00040 | 0x00080)) && (((text)->operation) & 0x00100)) ) || ( ((text)->operation & (0x00010 | 0x00020)) && ((text)->size != 1) ) ))
        return ((-15));
    {
        gx_path *tpath =
            ((text->operation & 0x00200) &&
             !(text->operation & 0x20000) ? 0 : path);
        const gx_clip_path *tcpath =
            (text->operation & 0x00400 ? pcpath : 0);





        return ((dev)->procs.text_begin)
...
gs_text_enum_init_dynamic(gs_text_enum_t *pte, gs_font *font)
{
    ...
    pte->outer_CID = ((gs_glyph)0x7fffffff);
    pte->single_byte_space = ((bool)0);
                  ...
                  gs_memory_t *mem)
{
    ...
    if (code >= 0)
        do { if (dev) do { (dev)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    return code;
}
              ...
              gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    if (text->operation & (0x00400 | (0x00800 | 0x01000 | 0x02000 | 0x04000 | 0x08000))) {
    ...
    ((pgs->device)->procs.set_graphics_type_tag)(pgs->device, GS_TEXT_TAG);
    ...
    if (code < 0)
        return code;
    pgs->device->sgr.stroke_stored = ((bool)0);
...
# 294 "./base/gstext.c"
    ...
    if (pte->pdcolor != 0) {
        int code = ((((pgs)->color[0].dev_color))->type != (&gx_dc_type_data_none)) ? 0 : gx_remap_color(pgs);;
        if (code != 0)
            return code;
    }
    return 0;
...
static __inline__ uint text_do_draw(gs_state * pgs)
{
    return (pgs->text_rendering_mode == 3 ?
        0x00200 | 0x40000 : 0x00400);
}
              ...
              gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00001 | text_do_draw(pgs) | 0x20000;
               ...
               gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00001 | 0x00040 |
        text_do_draw(pgs) | 0x20000;
    text.data.bytes = str, text.size = size;
    text.delta_all.x = ax;
    text.delta_all.y = ay;
    return gs_text_begin(pgs, &text, mem, ppte);
                   ...
                   gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00001 | 0x00080 |
        text_do_draw(pgs) | 0x20000;
    text.data.bytes = str, text.size = size;
               ...
               gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    if (pgs->ctm.xx * pgs->ctm.yy - pgs->ctm.yx * pgs->ctm.xy == 0)
        return ((-23));
    text.operation = 0x00001 | text_do_draw(pgs) | 0x10000 |
        0x20000;
    text.data.bytes = str, text.size = size;
    return gs_text_begin(pgs, &text, mem, ppte);
}
                ...
                uint widths_size, gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00001 | 0x00100 |
        text_do_draw(pgs) | 0x20000;
    text.data.bytes = str, text.size = size;
                   ...
                   gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00020 | text_do_draw(pgs) | 0x20000;
               ...
               gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00001 | 0x00200 | 0x10000;
    text.data.bytes = str, text.size = size;
    return gs_text_begin(pgs, &text, mem, ppte);
}
int
                     ...
                     gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00001 | 0x00200 | 0x20000;
    text.data.bytes = str, text.size = size;
    return gs_text_begin(pgs, &text, mem, ppte);
}
int
                  ...
                  gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00001 | 0x20000 |
        (stroke_path ? 0x02000 : 0x01000);
    text.data.bytes = str, text.size = size;
    return gs_text_begin(pgs, &text, mem, ppte);
}
int
                   ...
                   gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00020 | 0x20000 |
        (stroke_path ? 0x02000 : 0x01000);
    text.data.d_glyph = glyph;
    text.size = 1;
    result = gs_text_begin(pgs, &text, mem, ppte);
                    ...
                    gs_memory_t * mem, gs_text_enum_t ** ppte)
{
    ...
    text.operation = 0x00020 | 0x00200 | 0x20000;
    text.data.d_glyph = glyph;
    text.size = 1;
    result = gs_text_begin(pgs, &text, mem, ppte);
    if (result == 0)
...
{
    do { if (pte->dev) { do { do { } while (0); (pte->dev)->rc.ref_count += (-1); } while (0); if (!(pte->dev)->rc.ref_count) { do { do { } while (0); (pte->dev)->rc.free((pte->dev)->rc.memory, (void *)(pte->dev), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0);
    do { if (pte->imaging_dev) { do { do { } while (0); (pte->imaging_dev)->rc.ref_count += (-1); } while (0); if (!(pte->imaging_dev)->rc.ref_count) { do { do { } while (0); (pte->imaging_dev)->rc.free((pte->imaging_dev)->rc.memory, (void *)(pte->imaging_dev), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0);
}
void
...
{
    do { if (pte) { do { do { } while (0); (pte)->rc.ref_count += (-1); } while (0); if (!(pte)->rc.ref_count) { do { do { } while (0); (pte)->rc.free((pte)->rc.memory, (void *)(pte), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0);
}
...
gs_default_next_char_glyph(gs_text_enum_t *pte, gs_char *pchr, gs_glyph *pglyph)
{
    if (pte->index >= pte->text.size)
        return 2;
    if (pte->text.operation & (0x00001 | 0x00002)) {

        *pchr = pte->text.data.bytes[pte->index];
        if (pte->outer_CID != ((gs_glyph)0x7fffffff))
            *pglyph = pte->outer_CID;
        else
            *pglyph = ((gs_glyph)0x7fffffff);
    } else if (pte->text.operation & 0x00020) {

        *pchr = ((gs_char)~0L);
        *pglyph = pte->text.data.d_glyph;
    } else if (pte->text.operation & 0x00008) {
        *pchr = ((gs_char)~0L);
        *pglyph = pte->text.data.glyphs[pte->index];
    } else if (pte->text.operation & 0x00010) {
        *pchr = pte->text.data.d_char;
        *pglyph = ((gs_glyph)0x7fffffff);
    } else if (pte->text.operation & 0x00004) {
