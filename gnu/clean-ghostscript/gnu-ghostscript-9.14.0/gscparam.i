...
# 55 "./base/memory_.h" 2
# 19 "./base/gscparam.c" 2
# 1 "./base/string_.h" 1
# 20 "./base/gscparam.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
...
# 24 "./base/gscparam.c" 2


typedef union c_param_value_s {
    bool b; int i; long l; float f; gs_param_string s; gs_param_string n; gs_param_int_array ia; gs_param_float_array fa; gs_param_string_array sa; gs_param_string_array na; gs_c_param_list d;
} gs_c_param_value;



static const gc_ptr_element_t c_param_list_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_c_param_list *)0)->head - (char *)((gs_c_param_list *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_c_param_list *)0)->target - (char *)((gs_c_param_list *)0) )) } }; static const gc_struct_data_t c_param_list_reloc_ptrs = { (sizeof(c_param_list_enum_ptrs) / sizeof((c_param_list_enum_ptrs)[0])), 0, 0, c_param_list_enum_ptrs }; static const gs_memory_struct_type_t st_c_param_list = { sizeof(gs_c_param_list), "c_param_list", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &c_param_list_reloc_ptrs };


const byte gs_param_type_sizes[] = {
    0, sizeof(bool), sizeof(int), sizeof(long), sizeof(float), sizeof(gs_param_string), sizeof(gs_param_string), sizeof(gs_param_int_array), sizeof(gs_param_float_array), sizeof(gs_param_string_array), sizeof(gs_param_string_array), (sizeof(gs_c_param_list)), (sizeof(gs_c_param_list)), (sizeof(gs_c_param_list))
};


const byte gs_param_type_base_sizes[] = {
    0, sizeof(bool), sizeof(int), sizeof(long), sizeof(float), 1, 1, sizeof(int), sizeof(float), sizeof(gs_param_string), sizeof(gs_param_string), (0), (0), (0)
};
...
static gs_ptr_type_t c_param_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void c_param_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static const gs_memory_struct_type_t st_c_param = { sizeof(gs_c_param), "gs_c_param", 0, 0, c_param_enum_ptrs, c_param_reloc_ptrs, 0, 0 };

gs_ptr_type_t c_param_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_c_param *param = vptr; switch ( index ) { default: {
    index -= 3;
    switch (param->type) {
    ...
    case gs_param_type_array:
        return (*(st_c_param_list).enum_ptrs)(mem, &param->value.d, sizeof(param->value.d), index, pep, &(st_c_param_list), gcst);
...
case 0: return (pep->ptr = (const void *)(param->next), (&ptr_struct_procs));
case 1: return (pep->ptr = (const void *)(param->alternate_typed_data), (&ptr_struct_procs));
case 2:
    if (!param->key.persistent) {
        ...
        return (pep->ptr = (&key)->data, pep->size = (&key)->size, (&ptr_string_procs));
    } else
        return (pep->ptr = (const void *)(0), (&ptr_struct_procs));
} }
void c_param_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_c_param *param = vptr; {
    (param->next = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(param->next), gcst)));
    (param->alternate_typed_data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(param->alternate_typed_data), gcst)));
    if (!param->key.persistent) {
        gs_const_string key;

        key.data = param->key.data;
        key.size = param->key.size;
        (((*(const gc_procs_common_t **)(gcst))->reloc_const_string)(&(key), gcst));
    ...
    case gs_param_type_dict_int_keys:
    case gs_param_type_array:
        (*(st_c_param_list).reloc_ptrs)(&param->value.d, sizeof(param->value.d), &(st_c_param_list), gcst);
        break;
    default: {
        gs_param_typed_value value;
        ...
        value.type = param->type;
        gs_param_typed_value_reloc_ptrs(&value, sizeof(value), ((void*)0), gcst);
...
{
    return (gs_c_param_list *)(*(mem)->procs.alloc_struct)(mem, &st_c_param_list, cname);
}
...
c_param_find(const gs_c_param_list *plist, gs_param_name pkey, bool any)
{
    ...
    for (; pparam != 0; pparam = pparam->next)
        if (pparam->key.size == len && !memcmp(pparam->key.data, pkey, len))
            return (pparam->type != ((gs_param_type)-1) || any ? pparam : 0);
    return 0;
}



static int c_param_begin_write_collection(gs_param_list *, gs_param_name, gs_param_dict *, gs_param_collection_type_t);
static int c_param_end_write_collection(gs_param_list *, gs_param_name, gs_param_dict *);
static int c_param_write_typed(gs_param_list *, gs_param_name, gs_param_typed_value *);
static int c_param_request(gs_param_list *, gs_param_name);
static int c_param_requested(const gs_param_list *, gs_param_name);
...
gs_c_param_list_write(gs_c_param_list * plist, gs_memory_t * mem)
{
    ...
    plist->target = 0;
    plist->count = 0;
    plist->any_requested = ((bool)0);
    plist->persistent_keys = ((bool)1);
...
gs_c_param_list_release(gs_c_param_list * plist)
{
    ...
    while ((pparam = plist->head) != 0) {
        ...
        ((mem)->procs.free_object(mem, pparam->alternate_typed_data, "gs_c_param_list_release alternate data"));

        ((mem)->procs.free_object(mem, pparam, "gs_c_param_list_release entry"));
...
{
    gs_c_param *pparam =
        (gs_c_param *)(*(plist->memory)->procs.alloc_struct)(plist->memory, &st_c_param, "c_param_add entry");
    ...
    if (!plist->persistent_keys) {
        ...
        byte *str = (*(plist->memory)->procs.alloc_string)(plist->memory, len, "c_param_add key");

        if (str == 0) {
            ((plist->memory)->procs.free_object(plist->memory, pparam, "c_param_add entry"));
            return 0;
        }
        memcpy(str, pkey, len);
        pparam->key.data = str;
        pparam->key.persistent = ((bool)0);
        pparam->free_key = ((bool)1);
    } else {
        pparam->key.data = (const byte *)pkey;
        pparam->key.persistent = ((bool)1);
        pparam->free_key = ((bool)0);
    }
    pparam->key.size = len;
              ...
              gs_param_type type)
{
    ...
    switch (type) {
        ...
        case gs_param_type_float_array:
            if (!pparam->value.s.persistent) {
                byte *top_level_memory = ((void*)0);

                top_level_sizeof =
                    pparam->value.s.size * gs_param_type_base_sizes[type];
                if (top_level_sizeof + second_level_sizeof > 0) {
                    top_level_memory =
                        ((plist->memory)->procs.alloc_bytes_immovable(plist->memory, top_level_sizeof + second_level_sizeof, "c_param_write data"));


                    if (top_level_memory == 0) {
                        ((plist->memory)->procs.free_object(plist->memory, pparam, "c_param_write entry"));
                        return ((-25));
                    }
...
c_param_request(gs_param_list * plist, gs_param_name pkey)
{
    ...
    cplist->any_requested = ((bool)1);
    if (c_param_find(cplist, pkey, ((bool)1)))
        return 0;
    pparam = c_param_add(cplist, pkey);
    if (pparam == 0)
        return ((-25));
    pparam->type = ((gs_param_type)-1);
    cplist->head = pparam;
    return 0;
}
...
c_param_requested(const gs_param_list * plist, gs_param_name pkey)
{
    ...
    if (!cplist->any_requested)
        return (target ? (*(target)->procs->requested)(target, pkey) : -1);
    if (c_param_find(cplist, pkey, ((bool)1)) != 0)
        return 1;
    if (!target)
        return 0;
    code = (*(target)->procs->requested)(target, pkey);
    return (code < 0 ? 0 : 1);
}



static int c_param_begin_read_collection(gs_param_list *, gs_param_name, gs_param_dict *, gs_param_collection_type_t);
static int c_param_end_read_collection(gs_param_list *, gs_param_name, gs_param_dict *);
static int c_param_read_typed(gs_param_list *, gs_param_name, gs_param_typed_value *);
static int c_param_get_next_key(gs_param_list *, gs_param_enumerator_t *, gs_param_key_t *);
                   ...
                   gs_param_typed_value * pvalue)
{
    ...
    gs_c_param *pparam = c_param_find(cplist, pkey, ((bool)0));
    int code;

    if (pparam == 0)
        return (cplist->target ?
                ((pvalue)->type = ((gs_param_type)-1), param_read_requested_typed(cplist->target, pkey, pvalue)) : 1);
    ...
    code = param_coerce_typed(pvalue, req_type, ((void*)0));
    ...
    if (code == (-20) &&
        ...
        fa.persistent = ((bool)0);

        if (pparam->alternate_typed_data == 0) {
            if ((pparam->alternate_typed_data
                 = (void *)((cplist->memory)->procs.alloc_bytes_immovable(cplist->memory, fa.size * sizeof(float), "gs_c_param_read alternate float array"))) == 0)
               ...
               gs_param_dict * pvalue, gs_param_collection_type_t coll_type)
{
    ...
    if (pparam == 0)
        return
            (cplist->target ?
             (*(cplist->target)->procs->begin_xmit_collection)(cplist->target, pkey, pvalue, coll_type) :
