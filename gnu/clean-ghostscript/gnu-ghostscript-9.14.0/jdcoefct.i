...
decompress_onepass (j_decompress_ptr cinfo, JSAMPIMAGE output_buf)
{
  ...
  MCU_col_num++) {
      ...
      if (cinfo->lim_Se)
 memset((void *)((void *) coef->MCU_buffer[0]), 0, (size_t)((size_t) (cinfo->blocks_in_MCU * ((size_t) sizeof(JBLOCK)))));
 ...
 ((j_common_ptr) cinfo, 1, TRUE,
  ...
  (JDIMENSION) access_rows);
    ...
    buffer = (JBLOCKROW)
      ...
      64 * ((size_t) sizeof(JBLOCK)));
    for (i = 0; i < 64; i++) {
      coef->MCU_buffer[i] = buffer + i;
    }
    if (cinfo->lim_Se == 0)
      memset((void *)((void *) buffer), 0, (size_t)((size_t) (64 * ((size_t) sizeof(JBLOCK)))));
