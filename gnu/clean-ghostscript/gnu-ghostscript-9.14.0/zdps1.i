...
const gs_memory_struct_type_t st_igstate_obj = { sizeof(igstate_obj), "gstatetype", 0, ref_struct_clear_marks, ref_struct_enum_ptrs, ref_struct_reloc_ptrs, 0, 0 };
...
z1copy(i_ctx_t *i_ctx_p)
{
    ...
    if (code >= 0)
        return code;
    if (!((((const byte *)&((op)->tas.type_attrs))[1]) == (t_astruct)))
        return code;
...
zsetstrokeadjust(i_ctx_t *i_ctx_p)
{
    ...
    gs_setstrokeadjust((i_ctx_p->pgs), op->value.boolval);
...
zcurrentstrokeadjust(i_ctx_t *i_ctx_p)
{
    ...
    ((op)->value.boolval = (gs_currentstrokeadjust((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_boolean) << 8) + (0)) );
    return 0;
}
# 88 "./psi/zdps1.c"
static int
...
{
# 101 "./psi/zdps1.c"
    if (space != avm_local && imemory_save_level(((i_ctx_p->memory).current)) > 0)
        return ((-7));


    { register ref *rp_ = (ref *)(isp); register int i = sizeof(int_gstate) / sizeof(ref); do { if ( (avm_space)(((rp_)->tas.type_attrs) & (((1 << 2) - 1) << 2)) > (space) ) return ((-7)); ++rp_; } while ( --i ); };
...
zgstate(i_ctx_t *i_ctx_p)
{
    ...
    int code = gstate_check_space(i_ctx_p, ((int_gstate *)gs_state_client_data((i_ctx_p->pgs))), (((&(i_ctx_p->memory)))->current_space));
    igstate_obj *pigo;
    gs_state *pnew;
    int_gstate *isp;
    ...
    if (code < 0)
        return code;
    pigo = (igstate_obj *)(*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_struct)(((gs_memory_t *)((i_ctx_p->memory).current)), &st_igstate_obj, "gstate");
    if (pigo == 0)
        return ((-25));
    pnew = gs_state_copy((i_ctx_p->pgs), ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (pnew == 0) {
        ((((gs_memory_t *)((i_ctx_p->memory).current)))->procs.free_object(((gs_memory_t *)((i_ctx_p->memory).current)), pigo, "gstate"));
        return ((-25));
    }
    isp = ((int_gstate *)gs_state_client_data(pnew));
    { register ref *rp_ = (ref *)(isp); register int i = sizeof(int_gstate) / sizeof(ref); do { ((rp_)->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask); ++rp_; } while ( --i ); };
    do { if ( (op += (1)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (1); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ...
    ((op)->value.pstruct = ((obj_header_t *)(pigo)), ((op)->tas.type_attrs = ((t_astruct) << 8) + (((0x10 + 0x20 +0x40)) | (((&(i_ctx_p->memory)))->current_space))) );





    ((&pigo->gstate)->value.pstruct = ((obj_header_t *)(pnew)), ((&pigo->gstate)->tas.type_attrs = ((t_struct) << 8) + ((0) | (((&(i_ctx_p->memory)))->current_space))) );
...
zcopy_gstate(i_ctx_t *i_ctx_p)
{
    ...
    if ( !((((&*op)->tas.type_attrs & ((((1 << 6) - (2)) << 8) + (0))) == (((t_struct) << 8) + (0))) && (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_type)(((gs_memory_t *)((i_ctx_p->memory).current)), (&*op)->value.pstruct) == &st_igstate_obj) ) return (check_type_failed(&*op));
    if ( !((((&*op1)->tas.type_attrs & ((((1 << 6) - (2)) << 8) + (0))) == (((t_struct) << 8) + (0))) && (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_type)(((gs_memory_t *)((i_ctx_p->memory).current)), (&*op1)->value.pstruct) == &st_igstate_obj) ) return (check_type_failed(&*op1));
    do { if ( !(((&*op)->tas.type_attrs) & (0x10)) ) return ((-7)); } while (0);
    code = gstate_unshare(i_ctx_p);
    if (code < 0)
        return code;
    pgs = ((gs_state *)((&((igstate_obj *)((op)->value.pstruct))->gstate)->value.pstruct));
    pgs1 = ((gs_state *)((&((igstate_obj *)((op1)->value.pstruct))->gstate)->value.pstruct));
    pistate = ((int_gstate *)gs_state_client_data(pgs));
    code = gstate_check_space(i_ctx_p, ((int_gstate *)gs_state_client_data(pgs1)), (avm_space)(((op)->tas.type_attrs) & (((1 << 2) - 1) << 2)));
    if (code < 0)
        return code;

    { register ref *rp_ = (ref *)(pistate); register int i = sizeof(int_gstate) / sizeof(ref); do { ((void)((((((rp_)->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), op, (ref_packed *)(rp_), "copygstate") : 0))); ++rp_; } while ( --i ); };

    mem = gs_state_swap_memory(pgs, ((gs_memory_t *)((i_ctx_p->memory).current)));
    code = gs_copygstate(pgs, pgs1);
    gs_state_swap_memory(pgs, mem);
    if (code < 0)
        return code;
    { register ref *rp_ = (ref *)(pistate); register int i = sizeof(int_gstate) / sizeof(ref); do { ((rp_)->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask); ++rp_; } while ( --i ); };
    *op1 = *op;
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
}
...
zcurrentgstate(i_ctx_t *i_ctx_p)
{
    ...
    pgs = ((gs_state *)((&((igstate_obj *)((op)->value.pstruct))->gstate)->value.pstruct));
    pistate = ((int_gstate *)gs_state_client_data(pgs));
    code = gstate_check_space(i_ctx_p, ((int_gstate *)gs_state_client_data((i_ctx_p->pgs))), (avm_space)(((op)->tas.type_attrs) & (((1 << 2) - 1) << 2)));
    if (code < 0)
        return code;

    { register ref *rp_ = (ref *)(pistate); register int i = sizeof(int_gstate) / sizeof(ref); do { ((void)((((((rp_)->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0) ? alloc_save_change((&(i_ctx_p->memory)), op, (ref_packed *)(rp_), "currentgstate") : 0))); ++rp_; } while ( --i ); };

    mem = gs_state_swap_memory(pgs, ((gs_memory_t *)((i_ctx_p->memory).current)));
    code = gs_currentgstate(pgs, (i_ctx_p->pgs));
    gs_state_swap_memory(pgs, mem);
    if (code < 0)
        return code;
    { register ref *rp_ = (ref *)(pistate); register int i = sizeof(int_gstate) / sizeof(ref); do { ((rp_)->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask); ++rp_; } while ( --i ); };
...
zsetgstate(i_ctx_t *i_ctx_p)
{
    ...
    code = gs_setgstate((i_ctx_p->pgs), ((gs_state *)((&((igstate_obj *)((op)->value.pstruct))->gstate)->value.pstruct)));
    if (code < 0)
        return code;
    ((((i_ctx_p->op_stack).stack).p) -= (1));
    return 0;
...
zrectappend(i_ctx_t *i_ctx_p)
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    local_rects_t lr;
    int npop = rect_get(&lr, op, ((gs_memory_t *)((i_ctx_p->memory).current)));
    int code;

    if (npop < 0)
        return npop;
    code = gs_rectappend((i_ctx_p->pgs), lr.pr, lr.count);
    rect_release(&lr, ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (code < 0)
        return code;
...
zrectclip(i_ctx_t *i_ctx_p)
{
    ...
    if (npop < 0)
        return npop;
    code = gs_rectclip((i_ctx_p->pgs), lr.pr, lr.count);
    rect_release(&lr, ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (code < 0)
        return code;
    ((((i_ctx_p->op_stack).stack).p) -= (npop));
...
zrectfill(i_ctx_t *i_ctx_p)
{
    ...
    if (npop < 0)
        return npop;
    code = gs_rectfill((i_ctx_p->pgs), lr.pr, lr.count);
    rect_release(&lr, ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (code < 0)
        return code;
    ((((i_ctx_p->op_stack).stack).p) -= (npop));
...
zrectstroke(i_ctx_t *i_ctx_p)
{
    ...
    if (read_matrix(((gs_memory_t *)((i_ctx_p->memory).current)), op, &mat) >= 0) {

        npop = rect_get(&lr, op - 1, ((gs_memory_t *)((i_ctx_p->memory).current)));
        if (npop < 0)
            return npop;
        code = gs_rectstroke((i_ctx_p->pgs), lr.pr, lr.count, &mat);
        npop++;
    } else {

        npop = rect_get(&lr, op, ((gs_memory_t *)((i_ctx_p->memory).current)));
        if (npop < 0)
            return npop;
        code = gs_rectstroke((i_ctx_p->pgs), lr.pr, lr.count, (gs_matrix *) 0);
    }
    rect_release(&lr, ((gs_memory_t *)((i_ctx_p->memory).current)));
    if (code < 0)
        return code;
...
rect_get(local_rects_t * plr, os_ptr op, gs_memory_t *mem)
{
    ...
    if (count <= 5)
        ...
        pr = (gs_rect *)(*(mem)->procs.alloc_byte_array)(mem, count, sizeof(gs_rect), "rect_get");
...
{
    if (plr->pr != plr->rl)
        ((mem)->procs.free_object(mem, plr->pr, "rect_release"));
}
...
zsetbbox(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    if ((code = gs_setbbox((i_ctx_p->pgs), box[0], box[1], box[2], box[3])) < 0)
        return code;
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    ref *pgsref = &((igstate_obj *)((op)->value.pstruct))->gstate;
    gs_state *pgs = ((gs_state *)((pgsref)->value.pstruct));
    gs_state *pnew;
    int_gstate *isp;

    if (!((((pgsref)->tas.type_attrs) & ((&(i_ctx_p->memory)))->test_mask) == 0))
        return 0;
    ...
    isp = ((int_gstate *)gs_state_client_data(pnew));
    { register ref *rp_ = (ref *)(isp); register int i = sizeof(int_gstate) / sizeof(ref); do { ((rp_)->tas.type_attrs |= ((&(i_ctx_p->memory)))->new_mask); ++rp_; } while ( --i ); };
    alloc_save_change((&(i_ctx_p->memory)), op, (ref_packed *)(pgsref), "gstate_unshare");
    ((pgsref)->value.pstruct = ((obj_header_t *)(pnew)), ((pgsref)->tas.type_attrs = ((t_struct) << 8) + (((0) | (((&(i_ctx_p->memory)))->current_space))|((&(i_ctx_p->memory))->new_mask))) );
    return 0;
}
