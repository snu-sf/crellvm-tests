...
(char *target, size_t max, const char *source);
                   ...
                   int
trio_contains
(const char *string, const char *substring);
...
(const char *first, const char *second);
                   ...
                   int
trio_equal_case_max
(const char *first, size_t max, const char *second);
...
(char *target, size_t max, const char *format, const struct tm *datetime);
...
(const char *string, const char *pattern);
                   ...
                   size_t
trio_span_function
(char *target, const char *source, int (*Function) (int));
...
(const char *string, const char *substring);
                   ...
                   char *
trio_substring_max
(const char *string, size_t max, const char *substring);
...
(int source);
                   ...
                   char *
trio_tokenize
(char *string, const char *delimiters);
...
typedef struct _trio_string_t trio_string_t;
                   ...
                   int
trio_string_append
(trio_string_t *self, trio_string_t *other);
...
(trio_string_t *self, size_t max, trio_string_t *second);
...
(trio_string_t *self, size_t max, trio_string_t *other);
...
(trio_string_t *self, size_t max, const char *format, const struct tm *datetime);



                   char *
trio_string_get
(trio_string_t *self, int offset);



                   char *
trio_string_index
(trio_string_t *self, int character);
...
(trio_string_t *self);
                   ...
                   int
trio_xstring_append
(trio_string_t *self, const char *other);



                   int
trio_xstring_append_char
(trio_string_t *self, char character);



                   int
trio_xstring_append_max
(trio_string_t *self, const char *other, size_t max);
...
(trio_string_t *self, size_t max, const char *other);
...
(trio_string_t *self, const char *other);
                   ...
                   void
trio_xstring_set
(trio_string_t *self, char *buffer);
