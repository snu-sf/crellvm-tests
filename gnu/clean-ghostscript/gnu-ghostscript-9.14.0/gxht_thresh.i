# 1 "./base/gxht_thresh.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./base/gxht_thresh.c" 2
# 20 "./base/gxht_thresh.c"
# 1 "./base/memory_.h" 1
# 23 "./base/memory_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 32 "./base/gxht_thresh.c" 2
# 48 "./base/gxht_thresh.c"
                    ...
                    int data_length)
{
    ...
    if (k > ((1 << 3)*8)) {
        if (ht_landscape.index > 0) {
            local_widths[num_contone-1] -= k-((1 << 3)*8);
        } else {
            local_widths[0] -= k-((1 << 3)*8);
        }
    }
    ...
    for (k = data_length; k > 0; k--) {
        contone_ptr = &(contone_align[position]);
        curr_position = 0;
        contone_out_posit = 0;
...
gxht_thresh_image_init(gx_image_enum *penum)
{
    ...
    if (((( (penum->dev)->color_info.num_components > 1 || (penum->dev)->color_info.gray_index == 0xff ) ? (penum->dev)->color_info.max_color : (penum->dev)->color_info.max_gray) < 31)) {
        if (penum->pis != ((void*)0) && penum->pis->dev_ht != ((void*)0)) {
            for (k = 0; k < penum->pis->dev_ht->num_comp; k++) {
                ...
                code = gx_ht_construct_threshold(d_order, penum->dev,
                                                 penum->pis, k);
                if (code < 0 ) {
                    return gs_throw_imp(__func__, "./base/gxht_thresh.c", 592, 1, code, "threshold creation failed");
                }
            }
        } else {
            return -1;
...
# 617 "./base/gxht_thresh.c"
    if (penum->posture == image_landscape) {
        int col_length =
            ((int)(((((penum->x_extent.y) < 0 ? -(penum->x_extent.y) : (penum->x_extent.y)))+((1<<8)>>1)) >> (8)));
        ox = ((penum->dda.pixel0.x).state).Q;
        oy = ((penum->dda.pixel0.y).state).Q;



        temp = (col_length + ((1 << 3)*8)-1)/((1 << 3)*8);

        penum->line_size = ((uint)(((((temp * ((1 << 3)*8)) * 8) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3));

        penum->line = (*(penum->memory)->procs.alloc_bytes)(penum->memory, ((1 << 3)*8) * penum->line_size * spp_out + 16, "gxht_thresh");



        penum->thresh_buffer = (*(penum->memory)->procs.alloc_bytes)(penum->memory, penum->line_size * ((1 << 3)*8) + 16, "gxht_thresh");



        penum->ht_buffer =
                        (*(penum->memory)->procs.alloc_bytes)(penum->memory, penum->line_size * (((1 << 3)*8)>>3) * spp_out, "gxht_thresh");


        penum->ht_plane_height = penum->line_size;
        penum->ht_stride = penum->line_size;
        if (penum->line == ((void*)0) || penum->thresh_buffer == ((void*)0)
        ...
        if (penum->y_extent.x < 0) {
            ...
            penum->ht_landscape.curr_pos = ((1 << 3)*8)-1;
        ...
        if (penum->x_extent.y < 0) {
            penum->ht_landscape.flipy = ((bool)1);
            penum->ht_landscape.y_pos =
                ((((penum->dda.pixel0.y).state).Q + penum->x_extent.y) < 0 && ((((penum->dda.pixel0.y).state).Q + penum->x_extent.y) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)((((penum->dda.pixel0.y).state).Q + penum->x_extent.y) >> (8)) + 1 : ((int)((((((penum->dda.pixel0.y).state).Q + penum->x_extent.y)+(((1<<8)>>1) - 1L))) >> (8))));
        } else {
            penum->ht_landscape.flipy = ((bool)0);
            penum->ht_landscape.y_pos =
                ((((penum->dda.pixel0.y).state).Q) < 0 && ((((penum->dda.pixel0.y).state).Q) & ((1L << 8) - 1L)) == ((1L << 8) >> 1) ? (int)((((penum->dda.pixel0.y).state).Q) >> (8)) + 1 : ((int)((((((penum->dda.pixel0.y).state).Q)+(((1<<8)>>1) - 1L))) >> (8))));
        }
        memset(&(penum->ht_landscape.widths[0]), 0, sizeof(int)*((1 << 3)*8));
...
# 685 "./base/gxht_thresh.c"
        memset(&(penum->ht_landscape), 0, sizeof(ht_landscape_info_t));
        ox = ((penum->dda.pixel0.x).state).Q;
        oy = ((penum->dda.pixel0.y).state).Q;
        dev_width =
           (int) fabs((long) ((long)(((ox + penum->x_extent.x)+(((1<<8)>>1) - 1L)) >> (8))) -
                    ((long)(((ox)+(((1<<8)>>1) - 1L)) >> (8))));
        ...
        penum->ht_offset_bits = (-((int)((((ox)+(((1<<8)>>1) - 1L))) >> (8)))) & (((uint)((((1) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3)) - 1);
        if (penum->ht_offset_bits > 0) {
            penum->ht_stride = ((uint)(((((7 + (dev_width + 4)) + ((1 << 3) * 8)) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3));
        } else {
            penum->ht_stride = ((uint)(((((7 + (dev_width + 2)) + ((1 << 3) * 8)) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3));
        }



        max_height = (int) ceil(((((penum->dst_height) < 0 ? -(penum->dst_height) : (penum->dst_height)))*(1.0/(1<<8))) /
                                            (float) penum->Height);
        penum->ht_buffer =
                        (*(penum->memory)->procs.alloc_bytes)(penum->memory, penum->ht_stride * max_height * spp_out, "gxht_thresh");


        penum->ht_plane_height = penum->ht_stride * max_height;
# 726 "./base/gxht_thresh.c"
        temp = (int) ceil((float) ((dev_width + 15.0) + 15.0)/16.0);
        penum->line_size = ((uint)((((temp * 16 * 8) + ((1 << 3) * 8 - 1)) >> (3 + 3)) << 3));
        penum->line = (*(penum->memory)->procs.alloc_bytes)(penum->memory, penum->line_size * spp_out, "gxht_thresh");

        penum->thresh_buffer = (*(penum->memory)->procs.alloc_bytes)(penum->memory, penum->line_size * max_height, "gxht_thresh");
    ...
    penum->dxx = ((fixed)((penum->matrix.xx + ((1L)*(1.0/(1<<8))) / 2)*(float)(1<<8)));
    return code;
}
                       ...
                       int data_length, int num_used)
{
    ...
    if (ht_landscape->index < 0) {
        ...
        memset(&(ht_landscape->widths[0]), 0, sizeof(int)*((1 << 3)*8));
        ht_landscape->widths[((1 << 3)*8)-1] = delta;
        ht_landscape->curr_pos = ((1 << 3)*8)-2;
    ...
    switch (posture) {
        case image_portrait:
            ...
            for (j = 0; j < spp_out; j++) {
                ...
                dx = ((int)((xrun) >> (8))) % thresh_width;

                left_rem_end = (((dx + dest_width) < (thresh_width)) ? (dx + dest_width) : (thresh_width));

                left_width = left_rem_end - dx;

                num_full_tiles =
                    (int)(((int)((dest_width - left_width)/ (float) thresh_width)) - ((((dest_width - left_width)/ (float) thresh_width)<0) && (((dest_width - left_width)/ (float) thresh_width) != (float)(int)((dest_width - left_width)/ (float) thresh_width))));
...
# 933 "./base/gxht_thresh.c"
            if (offset_bits > 0) {
                int x_pos = ((int)((xrun) >> (8)));
                if (!is_planar_dev) {
                    (*((dev)->procs.copy_mono)) (dev, penum->ht_buffer, 0, dithered_stride,
                                                 0L, x_pos, y_pos,
                                                 offset_bits, vdi, dev_white,
                                                 dev_black);
                } else {
                    (*((dev)->procs.copy_planes)) (dev, penum->ht_buffer, 0, dithered_stride,
                                                 0L, x_pos, y_pos,
                                                 offset_bits, vdi, vdi);
                }
            }
            if ((dest_width - offset_bits) > 0 ) {
                ...
                int x_pos = ((int)((xrun) >> (8))) + offset_bits;

                int xoffs = offset_bits > 0 ? 16 : 0;

                if (!is_planar_dev) {
                    (*((dev)->procs.copy_mono)) (dev, penum->ht_buffer, xoffs, dithered_stride,
                                                 0L, x_pos, y_pos,
                                                 curr_width, vdi, dev_white,
                                                 dev_black);
                } else {
                    (*((dev)->procs.copy_planes)) (dev, penum->ht_buffer, xoffs, dithered_stride,
                                                 0L, x_pos, y_pos,
                                                 curr_width, vdi, vdi);
                }
            }
        ...
        case image_landscape:
            ...
            while ( (penum->ht_landscape.count >= ((1 << 3)*8) ||
                ...
                for (j = 0; j < spp_out; j++) {
                    halftone = penum->ht_buffer +
                                   j * penum->ht_plane_height * (((1 << 3)*8)>>3);
                    thresh_width = penum->pis->dev_ht->components[j].corder.width;
                    thresh_height =
                    ...
                    left_rem_end = (((dx + ((1 << 3)*8)) < (thresh_width)) ? (dx + ((1 << 3)*8)) : (thresh_width));
                    left_width = left_rem_end - dx;

                    num_full_tiles = (((1 << 3)*8) - left_width) / thresh_width;

                    right_tile_width =
                        ((1 << 3)*8) - num_full_tiles * thresh_width - left_width;
                    ...
                    if (dest_height <= 2 * thresh_height) {
                        ...
                        replicate_tile = ((bool)0);
                    } else {
                        init_tile = thresh_height;
                        replicate_tile = ((bool)1);
                    }
                    ...
                    if (replicate_tile) {
                        ...
                        num_tiles =
                            (int)(((int)((float) (dest_height - thresh_height)/ (float) thresh_height)) - ((((float) (dest_height - thresh_height)/ (float) thresh_height)<0) && (((float) (dest_height - thresh_height)/ (float) thresh_height) != (float)(int)((float) (dest_height - thresh_height)/ (float) thresh_height))));
                        tile_remainder = dest_height - (num_tiles + 1) * thresh_height;
                        for (jj = 0; jj < num_tiles; jj ++) {
                            memcpy(ptr_out, thresh_align, ((1 << 3)*8) * thresh_height);
                            ptr_out += ((1 << 3)*8) * thresh_height;
                        }

                        memcpy(ptr_out, thresh_align, ((1 << 3)*8) * tile_remainder);
                    }
                ...
                if (penum->ht_landscape.index < 0) {
                    ...
                    if (!is_planar_dev) {
                        (*((dev)->procs.copy_mono)) (dev, penum->ht_buffer, 0, ((1 << 3)*8)>>3,
                                                     0L,
                        ...
                        (*((dev)->procs.copy_planes)) (dev, penum->ht_buffer, 0, ((1 << 3)*8)>>3,
                                                     0L,
                                                     penum->ht_landscape.xstart,
                                                     penum->ht_landscape.y_pos,
                                                     width, dest_height,
            ...
            break;
        default:
            return gs_throw_imp(__func__, "./base/gxht_thresh.c", 1128, 1, -1, "Invalid orientation for thresholding");
    }
    return 0;
}
