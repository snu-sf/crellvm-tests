...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./obj/aux/gscdefs.c" 2
# 19 "./obj/aux/gscdefs.c"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
# 1 "./base/stdpre.h" 1
# 253 "./base/stdpre.h"
...
# 21 "./obj/aux/gscdefs.c" 2
# 1 "./obj/gconfigd.h" 1
# 22 "./obj/aux/gscdefs.c" 2
# 32 "./obj/aux/gscdefs.c"
const long gs_buildtime = 0;





const char *const gs_copyright = "Copyright (C) 2014 Artifex Software, Inc.  All rights reserved.";





const char *const gs_productfamily = "GNU Ghostscript";





const char *const gs_product = "GNU Ghostscript" "";
...
const long gs_revisiondate = 20140702;





const long gs_serialnumber = 42;
...
const char *const gs_dev_defaults = "x11alpha bbox";
