...
# 31 "./ijs/ijs_client.c" 2
# 1 "./ijs/ijs_client.h" 1
# 29 "./ijs/ijs_client.h"
...
ijs_invoke_server (const char *server_cmd)
{
  ...
  if (ok)
    ok = ijs_send_int (&ctx->send_chan, 35) >= 0;
  if (ok)
