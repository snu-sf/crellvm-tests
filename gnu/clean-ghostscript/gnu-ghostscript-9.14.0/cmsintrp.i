# 1 "./lcms2/src/cmsintrp.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmsintrp.c" 2
# 27 "./lcms2/src/cmsintrp.c"
...
_cmsInterpPluginChunkType _cmsInterpPluginChunk = { ((void*)0) };
...
void _cmsAllocInterpPluginChunk(struct _cmsContext_struct* ctx, const struct _cmsContext_struct* src)
{
    ...
    (((ctx != ((void*)0))) ? (void) (0) : __assert_fail ("(ctx != ((void*)0))", "./lcms2/src/cmsintrp.c", 43, __PRETTY_FUNCTION__));
    ...
    (((from != ((void*)0))) ? (void) (0) : __assert_fail ("(from != ((void*)0))", "./lcms2/src/cmsintrp.c", 54, __PRETTY_FUNCTION__));
                                           ...
                                           cmsUInt32Number dwFlags)
{
    ...
    if (!_cmsSetInterpolationRoutine(ContextID, p)) {
         cmsSignalError(ContextID, 8, "Unsupported interpolation (%d->%d channels)", InputChan, OutputChan);
...
void _cmsFreeInterpParams(cmsInterpParams* p)
{
    if (p != ((void*)0)) _cmsFree(p ->ContextID, p);
}



static inline cmsUInt16Number LinearInterp(cmsS15Fixed16Number a, cmsS15Fixed16Number l, cmsS15Fixed16Number h)
{
...

{
    ...
    for (OutChan = 0; OutChan < TotalOut; OutChan++) {
        ...
        d00 = (LutTable[(X0)+(Y0)+OutChan]);
        d01 = (LutTable[(X0)+(Y1)+OutChan]);
        d10 = (LutTable[(X1)+(Y0)+OutChan]);
        d11 = (LutTable[(X1)+(Y1)+OutChan]);

        dx0 = (cmsFloat32Number) ((d00)+(((d10)-(d00))*(fx)));
        dx1 = (cmsFloat32Number) ((d01)+(((d11)-(d01))*(fx)));

        dxy = (cmsFloat32Number) ((dx0)+(((dx1)-(dx0))*(fy)));
...

{
  ...
  register int X0, X1, Y0, Y1;
    ...
    for (OutChan = 0; OutChan < TotalOut; OutChan++) {
        ...
        dx0 = (cmsUInt16Number) (d00 + (((((d10-d00)*rx))+0x8000)>>16));
        dx1 = (cmsUInt16Number) (d01 + (((((d11-d01)*rx))+0x8000)>>16));

        dxy = (cmsUInt16Number) (dx0 + (((((dx1-dx0)*ry))+0x8000)>>16));
...

{
    ...
    for (OutChan = 0; OutChan < TotalOut; OutChan++) {
        ...
        d000 = (LutTable[(X0)+(Y0)+(Z0)+OutChan]);
        d001 = (LutTable[(X0)+(Y0)+(Z1)+OutChan]);
        d010 = (LutTable[(X0)+(Y1)+(Z0)+OutChan]);
        d011 = (LutTable[(X0)+(Y1)+(Z1)+OutChan]);

        d100 = (LutTable[(X1)+(Y0)+(Z0)+OutChan]);
        d101 = (LutTable[(X1)+(Y0)+(Z1)+OutChan]);
        d110 = (LutTable[(X1)+(Y1)+(Z0)+OutChan]);
        d111 = (LutTable[(X1)+(Y1)+(Z1)+OutChan]);


        dx00 = (cmsFloat32Number) ((d000)+(((d100)-(d000))*(fx)));
        dx01 = (cmsFloat32Number) ((d001)+(((d101)-(d001))*(fx)));
        dx10 = (cmsFloat32Number) ((d010)+(((d110)-(d010))*(fx)));
        dx11 = (cmsFloat32Number) ((d011)+(((d111)-(d011))*(fx)));

        dxy0 = (cmsFloat32Number) ((dx00)+(((dx10)-(dx00))*(fy)));
        dxy1 = (cmsFloat32Number) ((dx01)+(((dx11)-(dx01))*(fy)));

        dxyz = (cmsFloat32Number) ((dxy0)+(((dxy1)-(dxy0))*(fz)));
...

{
  ...
  register int X0, X1, Y0, Y1, Z0, Z1;
    ...
    for (OutChan = 0; OutChan < TotalOut; OutChan++) {
        ...
        dx00 = (cmsUInt16Number) (d000 + (((((d100-d000)*rx))+0x8000)>>16));
        dx01 = (cmsUInt16Number) (d001 + (((((d101-d001)*rx))+0x8000)>>16));
        dx10 = (cmsUInt16Number) (d010 + (((((d110-d010)*rx))+0x8000)>>16));
        dx11 = (cmsUInt16Number) (d011 + (((((d111-d011)*rx))+0x8000)>>16));

        dxy0 = (cmsUInt16Number) (dx00 + (((((dx10-dx00)*ry))+0x8000)>>16));
        dxy1 = (cmsUInt16Number) (dx01 + (((((dx11-dx01)*ry))+0x8000)>>16));

        dxyz = (cmsUInt16Number) (dxy0 + (((((dxy1-dxy0)*rz))+0x8000)>>16));
                     ...
                     register const cmsInterpParams* p16)
{
    ...
    cmsS15Fixed16Number c0, c1, c2, c3, Rest;
    cmsUInt32Number OutChan;
    cmsUInt16Number Tmp1[128], Tmp2[128];
                ...
                if (rz >= rx && rx >= ry) {
                    ...
                    if (ry >= rx && rx >= rz) {
                        ...
                        if (ry >= rz && rz >= rx) {
                            ...
                            Tmp1[OutChan] = (cmsUInt16Number) c0 + (((_cmsToFixedDomain(Rest))+0x8000)>>16);
    }
                ...
                if (rz >= rx && rx >= ry) {
                    ...
                    if (ry >= rx && rx >= rz) {
                        ...
                        if (ry >= rz && rz >= rx) {
                            ...
                            Tmp2[OutChan] = (cmsUInt16Number) c0 + (((_cmsToFixedDomain(Rest))+0x8000)>>16);
    }
                      ...
                      const cmsInterpParams* p)
{
       ...
       cmsUInt32Number i;
       cmsFloat32Number Tmp1[128], Tmp2[128];
       cmsInterpParams p1;
...
cmsInterpFunction DefaultInterpolatorsFactory(cmsUInt32Number nInputChannels, cmsUInt32Number nOutputChannels, cmsUInt32Number dwFlags)
{
    ...
    cmsInterpFunction Interpolation;
    cmsBool IsFloat = (dwFlags & 0x0001);
    cmsBool IsTrilinear = (dwFlags & 0x0100);

    memset(&Interpolation, 0, sizeof(Interpolation));


    if (nInputChannels >= 4 && nOutputChannels >= 128)
