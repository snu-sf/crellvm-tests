...
const gs_memory_struct_type_t st_free = { sizeof(byte), "(free)", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };


const gs_memory_struct_type_t st_bytes = { sizeof(byte), "bytes", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };


static const gc_ptr_element_t gc_root_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_gc_root_t *)0)->next - (char *)((gs_gc_root_t *)0) )) } }; static const gc_struct_data_t gc_root_reloc_ptrs = { (sizeof(gc_root_enum_ptrs) / sizeof((gc_root_enum_ptrs)[0])), 0, 0, gc_root_enum_ptrs }; const gs_memory_struct_type_t st_gc_root_t = { sizeof(gs_gc_root_t), "gs_gc_root_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &gc_root_reloc_ptrs };


static const gc_ptr_element_t const_string_elts[] = { { GC_ELT_CONST_STRING, 0 } }; static const gc_struct_data_t const_string_sdata = { (sizeof(const_string_elts) / sizeof((const_string_elts)[0])), 0, 0, const_string_elts }; static const gs_memory_struct_type_t st_const_string = { sizeof(gs_const_string), "gs_const_string", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &const_string_sdata };
static gs_ptr_type_t const_string_elt_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { uint count = size / (uint)sizeof(gs_const_string); if ( count == 0 ) return 0; return (*(st_const_string).enum_ptrs)(mem, (const char *)vptr + (index % count) * sizeof(gs_const_string), sizeof(gs_const_string), index / count, pep, &(st_const_string), gcst); } static void const_string_elt_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { { uint count = size / (uint)sizeof(gs_const_string); for ( ; count; count--, vptr = (char *)vptr + sizeof(gs_const_string) ) (*(st_const_string).reloc_ptrs)(vptr, sizeof(gs_const_string), &(st_const_string), gcst); } } const gs_memory_struct_type_t st_const_string_element = { sizeof(gs_const_string), "gs_const_string[]", 0, 0, const_string_elt_enum_ptrs, const_string_elt_reloc_ptrs, 0, 0 };


gs_ptr_type_t
enum_bytestring(enum_ptr_t *pep, const gs_bytestring *pbs)
{
    return (pbs->bytes ? (pep->ptr = (const void *)(pbs->bytes), (&ptr_struct_procs)) : (pep->ptr = (pbs)->data, pep->size = (pbs)->size, (&ptr_string_procs)));
}
gs_ptr_type_t
enum_const_bytestring(enum_ptr_t *pep, const gs_const_bytestring *pbs)
{
    return (pbs->bytes ? (pep->ptr = (const void *)(pbs->bytes), (&ptr_struct_procs)) : (pep->ptr = (pbs)->data, pep->size = (pbs)->size, (&ptr_const_string_procs)));
}
void
reloc_bytestring(gs_bytestring *pbs, gc_state_t *gcst)
{
    if (pbs->bytes) {
        ...
        pbs->bytes = bytes = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(bytes), gcst));
        pbs->data = bytes + offset;
    } else
        (((*(const gc_procs_common_t **)(gcst))->reloc_string)(&(*(gs_string *)pbs), gcst));
}
void
reloc_const_bytestring(gs_const_bytestring *pbs, gc_state_t *gcst)
{
    if (pbs->bytes) {
        ...
        (((*(const gc_procs_common_t **)(gcst))->reloc_const_string)(&(*(gs_const_string *)pbs), gcst));
}
...
gs_alloc_memset(void *ptr, int fill, ulong lsize)
{
    ...
    for (; msize; msize -= isize, p += isize) {
        isize = (((msize) < ((~(-1 << ((1 << 2) * 8 - 1))))) ? (msize) : ((~(-1 << ((1 << 2) * 8 - 1)))));
        memset(p, fill, isize);
    }
}
...
{
    if (obj == 0)
        return (void *)(*(mem)->procs.alloc_struct_array)(mem, num_elements, pstype, cname);
    ...
    return ((mem)->procs.resize_object(mem, obj, num_elements, cname));
}
...
gs_raw_alloc_struct_immovable(gs_memory_t * rmem,
                              ...
                              client_name_t cname)
{
    return ((rmem)->procs.alloc_bytes_immovable(rmem, gs_struct_type_size(pstype), cname));
}
...
gs_free_const_object(gs_memory_t * mem, const void *data, client_name_t cname)
{
    ...
    u.r = data;
    ((mem)->procs.free_object(mem, u.w, cname));
}
void
                     ...
                     client_name_t cname)
{
    ...
    u.r = data;
    (*(mem)->procs.free_string)(mem, u.w, nbytes, cname);
}
...
{
    if (pbs->bytes)
        ((mem)->procs.free_object(mem, pbs->bytes, cname));
    else
        (*(mem)->procs.free_string)(mem, pbs->data, pbs->size, cname);
}
void
...
gs_ptr_type_t gs_no_struct_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst)
{
    return 0;
...
void gs_no_struct_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) {
{
}
}
...
gs_register_struct_root(gs_memory_t *mem, gs_gc_root_t *root,
                        void **pp, client_name_t cname)
{
    return (*(mem)->procs.register_root)(mem, root, (&ptr_struct_procs), pp, cname);
}
# 282 "./base/gsmemory.c"
void
...
gs_ptr_type_t basic_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst)
{
    ...
    if (index < psd->num_ptrs) {
        ...
        const char *pptr = (const char *)vptr + ppe->offset;
# 317 "./base/gsmemory.c"
        switch ((gc_ptr_type_index_t)ppe->type) {
            case GC_ELT_OBJ:
                return (pep->ptr = (const void *)(*(const void *const *)pptr), (&ptr_struct_procs));
            case GC_ELT_STRING:
                return (pep->ptr = ((const gs_string *)pptr)->data, pep->size = ((const gs_string *)pptr)->size, (&ptr_string_procs));
            case GC_ELT_CONST_STRING:
                return (pep->ptr = ((const gs_const_string *)pptr)->data, pep->size = ((const gs_const_string *)pptr)->size, (&ptr_const_string_procs));
        }
    }
    if (!psd->super_type)
        return 0;
    return (*(*(psd->super_type)).enum_ptrs)(mem, (const void *) ((const char *)vptr + psd->super_offset), pstype->ssize, index - psd->num_ptrs, pep, &(*(psd->super_type)), gcst);
...
void basic_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) {
{
    const gc_struct_data_t *psd = pstype->proc_data;
    uint i;
    ...
    for (i = 0; i < psd->num_ptrs; ++i) {
        ...
        switch ((gc_ptr_type_index_t) ppe->type) {
            case GC_ELT_OBJ:
                (*(void **)pptr = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(*(void **)pptr), gcst)));
                break;
            case GC_ELT_STRING:
                (((*(const gc_procs_common_t **)(gcst))->reloc_string)(&(*(gs_string *)pptr), gcst));
                break;
            case GC_ELT_CONST_STRING:
                (((*(const gc_procs_common_t **)(gcst))->reloc_const_string)(&(*(gs_const_string *)pptr), gcst));
                break;
        }
    }
    if (psd->super_type)
        (*(*(psd->super_type)).reloc_ptrs)((void *)((char *)vptr + psd->super_offset), pstype->ssize, &(*(psd->super_type)), gcst);
