# 1 "./openjpeg/libopenjpeg/opj_clock.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/opj_clock.c" 2
# 30 "./openjpeg/libopenjpeg/opj_clock.c"
...
# 31 "./openjpeg/libopenjpeg/opj_clock.c" 2
...
extern int setpriority (__priority_which_t __which, id_t __who, int __prio)
     __attribute__ ((__nothrow__ ));
# 32 "./openjpeg/libopenjpeg/opj_clock.c" 2
# 1 "/usr/include/sys/times.h" 1 3 4
# 28 "/usr/include/sys/times.h" 3 4
# 1 "/usr/include/time.h" 1 3 4
...
# 33 "./openjpeg/libopenjpeg/opj_clock.c" 2
...
# 35 "./openjpeg/libopenjpeg/opj_clock.c" 2

OPJ_FLOAT64 opj_clock(void) {
# 48 "./openjpeg/libopenjpeg/opj_clock.c"
    struct rusage t;
