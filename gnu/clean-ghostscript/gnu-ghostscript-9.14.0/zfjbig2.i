...
# 39 "./jbig2dec/jbig2.h"
# 1 "./jbig2dec/memento.h" 1
# 140 "./jbig2dec/memento.h"
# 1 "/usr/include/memory.h" 1 3 4
# 141 "./jbig2dec/memento.h" 2
# 168 "./jbig2dec/memento.h"
...
{
    const stream_template *templat; gs_memory_t *memory; int (*report_error)(stream_state *, const char *); int min_left; char error_string[79 + 1];
    s_jbig2_global_data_t *global_struct;
    Jbig2GlobalCtx *global_ctx;
    Jbig2Ctx *decode_ctx;
    Jbig2Image *image;
    long offset;
...
static const gs_memory_struct_type_t st_jbig2_global_data_t = { sizeof(s_jbig2_global_data_t), "jbig2globaldata", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, jbig2_global_data_finalize, 0 };
...
# 71 "./psi/zfjbig2.c"
    ...
    return filter_read(i_ctx_p, 0, &s_jbig2decode_template,
                       (stream_state *) & state, (sop ? (avm_space)(((sop)->tas.type_attrs) & (((1 << 2) - 1) << 2)) : 0));
}
...
z_jbig2makeglobalctx(i_ctx_t * i_ctx_p)
{
        ...
        if ( !((((const byte *)&((&*op)->tas.type_attrs))[1]) == (t_astruct)) ) return (check_type_failed(&*op));
        size = (*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.object_size)(((gs_memory_t *)((i_ctx_p->memory).current)), op->value.pstruct);
        data = ((byte *)((op)->value.pstruct));

        code = s_jbig2decode_make_global_data(data, size,
                        &global);
        if (size > 0 && global == ((void*)0)) {
            (dmprintf_file_and_line(((gs_memory_t *)((i_ctx_p->memory).current)),"./psi/zfjbig2.c", 108), errprintf(((gs_memory_t *)((i_ctx_p->memory).current)),"failed to create parsed JBIG2GLOBALS object."));
            return ((-1));
        }

        st = (s_jbig2_global_data_t *)(*(((gs_memory_t *)((i_ctx_p->memory).current)))->procs.alloc_struct)(((gs_memory_t *)((i_ctx_p->memory).current)), &st_jbig2_global_data_t, "jbig2decode parsed global context");


        if (st == ((void*)0)) return ((-25));

        st->data = global;
        ((op)->value.pstruct = ((obj_header_t *)((byte*)st)), ((op)->tas.type_attrs = ((t_astruct) << 8) + ((0x20 + 0x40) | (((&(i_ctx_p->memory)))->current_space))) );
