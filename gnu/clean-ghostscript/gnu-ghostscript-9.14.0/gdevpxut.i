# 1 "./devices/gdevpxut.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/gdevpxut.c" 2
# 18 "./devices/gdevpxut.c"
# 1 "./base/math_.h" 1
# 23 "./base/math_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
px_write_file_header(stream *s, const gx_device *dev)
{
    ...
    static const byte stream_header[] = {
        pxt_attr_ubyte, (pxaUnitsPerMeasure),
        pxt_ubyte, (byte)(0), pxt_attr_ubyte, (pxaMeasure),
        pxt_ubyte, (byte)(eBackChAndErrPage), pxt_attr_ubyte, (pxaErrorReport),
        pxtBeginSession,
        pxt_ubyte, (byte)(0), pxt_attr_ubyte, (pxaSourceType),
        pxt_ubyte, (byte)(eBinaryLowByteFirst), pxt_attr_ubyte, (pxaDataOrg),
        pxtOpenDataSource
    };
    ...
    px_put_bytes(s, stream_header, sizeof(stream_header));
    return 0;
}
                      ...
                      int page, bool Duplex, bool Tumble, int media_type_set, char *media_type)
{
    ...
    static const struct {
        ...
        { eDefaultPaperSize, "defaultpaper", (float)((-1) * 1.0 / (-1)), (float)((-1) * 1.0 / -1) }, { eLetterPaper, "letter", (float)((2550) * 1.0 / (300)), (float)((3300) * 1.0 / 300) }, { eLegalPaper, "legal", (float)((2550) * 1.0 / (300)), (float)((4200) * 1.0 / 300) }, { eA4Paper, "a4", (float)((2480) * 1.0 / (300)), (float)((3507) * 1.0 / 300) }, { eExecPaper, "executive", (float)((2175) * 1.0 / (300)), (float)((3150) * 1.0 / 300) }, { eLedgerPaper, "ledger", (float)((3300) * 1.0 / (300)), (float)((5100) * 1.0 / 300) }, { eA3Paper, "a3", (float)((3507) * 1.0 / (300)), (float)((4960) * 1.0 / 300) }, { eCOM10Envelope, "com10", (float)((1237) * 1.0 / (300)), (float)((2850) * 1.0 / 300) }, { eMonarchEnvelope, "monarch", (float)((1162) * 1.0 / (300)), (float)((2250) * 1.0 / 300) }, { eC5Envelope, "c5", (float)((1913) * 1.0 / (300)), (float)((2704) * 1.0 / 300) }, { eDLEnvelope, "dl", (float)((1299) * 1.0 / (300)), (float)((2598) * 1.0 / 300) }, { eJB4Paper, "jisb4", (float)((3035) * 1.0 / (300)), (float)((4299) * 1.0 / 300) }, { eJB4Paper, "jis b4", (float)((3035) * 1.0 / (300)), (float)((4299) * 1.0 / 300) }, { eJB5Paper, "jisb5", (float)((2150) * 1.0 / (300)), (float)((3035) * 1.0 / 300) }, { eJB5Paper, "jis b5", (float)((2150) * 1.0 / (300)), (float)((3035) * 1.0 / 300) }, { eB5Envelope, "b5", (float)((2078) * 1.0 / (300)), (float)((2952) * 1.0 / 300) }, { eB5Paper, "b5paper", (float)((2150) * 1.0 / (300)), (float)((3035) * 1.0 / 300) }, { eJPostcard, "jpost", (float)((1181) * 1.0 / (300)), (float)((1748) * 1.0 / 300) }, { eJDoublePostcard, "jpostd", (float)((2362) * 1.0 / (300)), (float)((1748) * 1.0 / 300) }, { eA5Paper, "a5", (float)((1748) * 1.0 / (300)), (float)((2480) * 1.0 / 300) }, { eA6Paper, "a6", (float)((1240) * 1.0 / (300)), (float)((1748) * 1.0 / 300) }, { eJB6Paper, "jisb6", (float)((1512) * 1.0 / (300)), (float)((2150) * 1.0 / 300) }, { eJIS8K, "jis8K", (float)((3154) * 1.0 / (300)), (float)((4606) * 1.0 / 300) }, { eJIS16K, "jis16K", (float)((2303) * 1.0 / (300)), (float)((3154) * 1.0 / 300) }, { eJISExec, "jisexec", (float)((2551) * 1.0 / (300)), (float)((3898) * 1.0 / 300) }, { eB6JIS, "B6 (JIS)", (float)((1512) * 1.0 / (300)), (float)((2150) * 1.0 / 300) }, { eC6Envelope, "C6", (float)((1345) * 1.0 / (300)), (float)((1912) * 1.0 / 300) }, { e8Kai, "8Kai", (float)((3154) * 1.0 / (300)), (float)((4608) * 1.0 / 300) }, { e16Kai, "16Kai", (float)((2304) * 1.0 / (300)), (float)((3154) * 1.0 / 300) }, { e12x18, "12x18", (float)((3600) * 1.0 / (300)), (float)((5400) * 1.0 / 300) }, { e13x19_2, "13x19.2", (float)((3900) * 1.0 / (300)), (float)((5758) * 1.0 / 300) }, { e13x19, "13x19", (float)((3900) * 1.0 / (300)), (float)((5700) * 1.0 / 300) }, { e12_6x19_2, "12.6x19.2", (float)((3779) * 1.0 / (300)), (float)((5758) * 1.0 / 300) }, { e12_6x18_5, "12.6x18.5", (float)((3779) * 1.0 / (300)), (float)((5550) * 1.0 / 300) }, { e13x18, "13x18", (float)((3900) * 1.0 / (300)), (float)((5400) * 1.0 / 300) }, { eSRA3, "SRA3", (float)((3779) * 1.0 / (300)), (float)((5316) * 1.0 / 300) }, { eSRA4, "SRA4", (float)((2658) * 1.0 / (300)), (float)((3779) * 1.0 / 300) }, { e226x310, "226x310", (float)((2670) * 1.0 / (300)), (float)((3662) * 1.0 / 300) }, { e310x432, "310x432", (float)((3662) * 1.0 / (300)), (float)((5104) * 1.0 / 300) }, { eEngQuatro, "EngQuatro", (float)((2400) * 1.0 / (300)), (float)((3000) * 1.0 / 300) }, { e11x14, "11x14", (float)((3300) * 1.0 / (300)), (float)((4200) * 1.0 / 300) }, { e11x15, "11x15", (float)((3300) * 1.0 / (300)), (float)((4500) * 1.0 / 300) }, { e10x14, "10x14", (float)((3000) * 1.0 / (300)), (float)((4200) * 1.0 / 300) },
        { pxeMediaSize_next }
    };
...
px_put_a(stream * s, px_attribute_t a)
{
    ...
    (!((s)->cursor.w.ptr >= (s)->cursor.w.limit) ? (++((s)->cursor.w.ptr), *(s)->cursor.w.ptr=((byte)a), 0) : spputc((s),((byte)a)));
}
void
px_put_ac(stream *s, px_attribute_t a, px_tag_t op)
{
    px_put_a(s, a);
    (!((s)->cursor.w.ptr >= (s)->cursor.w.limit) ? (++((s)->cursor.w.ptr), *(s)->cursor.w.ptr=((byte)op), 0) : spputc((s),((byte)op)));
}
...
{
    (!((s)->cursor.w.ptr >= (s)->cursor.w.limit) ? (++((s)->cursor.w.ptr), *(s)->cursor.w.ptr=((byte) l), 0) : spputc((s),((byte) l)));
    (!((s)->cursor.w.ptr >= (s)->cursor.w.limit) ? (++((s)->cursor.w.ptr), *(s)->cursor.w.ptr=((byte) (l >> 8)), 0) : spputc((s),((byte) (l >> 8))));
    (!((s)->cursor.w.ptr >= (s)->cursor.w.limit) ? (++((s)->cursor.w.ptr), *(s)->cursor.w.ptr=((byte) (l >> 16)), 0) : spputc((s),((byte) (l >> 16))));
    (!((s)->cursor.w.ptr >= (s)->cursor.w.limit) ? (++((s)->cursor.w.ptr), *(s)->cursor.w.ptr=((byte) (l >> 24)), 0) : spputc((s),((byte) (l >> 24))));
}
# 369 "./devices/gdevpxut.c"
void
