                  ...
                  gs_memory_t * mem)
{
    ...
    for (i = count; --i >= 0;)
        if (Functions[i])
            (((gs_function_t *)Functions[i])->head.procs.free((gs_function_t *)Functions[i], ((bool)1), mem));
                   ...
                   gs_memory_t *mem)
{
    ...
    if (code < 0)
        return code;
    for (i = 0; i < count; ++i) {
        int code = ((pfns[i])->head.procs.make_scaled(pfns[i], &psfns[i], ranges, mem));
                     ...
                     const gs_range_t *pranges, gs_memory_t *mem)
{
    gs_function_ElIn_t *psfn =
        (gs_function_ElIn_t *)(*(mem)->procs.alloc_struct)(mem, &st_function_ElIn, "fn_ElIn_make_scaled");
    ...
    *ppfn = 0;
    ...
    if (params->N < 0) {
        ...
        gs_function_ElIn_t *pfn =
            (gs_function_ElIn_t *)(*(mem)->procs.alloc_struct)(mem, &st_function_ElIn, "gs_function_ElIn_init");
...
static const gc_ptr_element_t function_1ItSg_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_function_1ItSg_t *)0)->params.Functions - (char *)((gs_function_1ItSg_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_function_1ItSg_t *)0)->params.Bounds - (char *)((gs_function_1ItSg_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_function_1ItSg_t *)0)->params.Encode - (char *)((gs_function_1ItSg_t *)0) )) } }; static const gc_struct_data_t function_1ItSg_reloc_ptrs = { (sizeof(function_1ItSg_enum_ptrs) / sizeof((function_1ItSg_enum_ptrs)[0])), 0, &st_function, function_1ItSg_enum_ptrs }; static const gs_memory_struct_type_t st_function_1ItSg = { sizeof(gs_function_1ItSg_t), "gs_function_1ItSg_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &function_1ItSg_reloc_ptrs };
...
fn_1ItSg_evaluate(const gs_function_t * pfn_common, const float *in, float *out)
{
    ...
    do { } while (0);
    return ((pfn->params.Functions[i])->head.procs.evaluate)(pfn->params.Functions[i], &encoded, out);
}
                      ...
                      const float *lower, const float *upper, uint *mask)
{
    ...
    *mask = 0;
    ...
    for (i = 0; i < pfn->params.k; ++i) {
        ...
        esmall = (float)1e-6 * ((e1 - e0) < 0 ? -(e1 - e0) : (e1 - e0));
        vb0 = (((vv0) > (b0)) ? (vv0) : (b0));
        vb1 = (((vv1) < (b1)) ? (vv1) : (b1));
        if (b1 == b0)
            return 1;
        ...
        if (w0 > w1)
            return ((pfn->params.Functions[i])->head.procs.is_monotonic)(pfn->params.Functions[i], &w1, &w0, mask);

        else
            return ((pfn->params.Functions[i])->head.procs.is_monotonic)(pfn->params.Functions[i], &w0, &w1, mask);
                     ...
                     const gs_range_t *pranges, gs_memory_t *mem)
{
    gs_function_1ItSg_t *psfn =
        (gs_function_1ItSg_t *)(*(mem)->procs.alloc_struct)(mem, &st_function_1ItSg, "fn_1ItSg_make_scaled");
    ...
    if ((code = (psfn->params.Bounds == 0 || psfn->params.Encode == 0 ?
        ...
        (code = fn_scale_functions((gs_function_t ***)&psfn->params.Functions,
                                   ...
                                   pfn->params.n, pranges, ((bool)0), mem)) < 0) {
        (((gs_function_t *)psfn)->head.procs.free((gs_function_t *)psfn, ((bool)1), mem));
        return code;
    }
    *ppsfn = psfn;
...
gs_function_1ItSg_serialize(const gs_function_t * pfn, stream *s)
{
    ...
    for (k = 0; k < p->k && code >= 0; k++)
        code = ((p->Functions[k])->head.procs.serialize(p->Functions[k], s));
    if (code < 0)
        return code;
    ...
    *ppfn = 0;
    ...
    fn_check_mnDR((const gs_function_params_t *)params, 1, n);
    {
        gs_function_1ItSg_t *pfn =
            (gs_function_1ItSg_t *)(*(mem)->procs.alloc_struct)(mem, &st_function_1ItSg, "gs_function_1ItSg_init");
...
static const gc_ptr_element_t function_AdOt_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_function_AdOt_t *)0)->params.Functions - (char *)((gs_function_AdOt_t *)0) )) } }; static const gc_struct_data_t function_AdOt_reloc_ptrs = { (sizeof(function_AdOt_enum_ptrs) / sizeof((function_AdOt_enum_ptrs)[0])), 0, &st_function, function_AdOt_enum_ptrs }; static const gs_memory_struct_type_t st_function_AdOt = { sizeof(gs_function_AdOt_t), "gs_function_AdOt_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &function_AdOt_reloc_ptrs };
...
fn_AdOt_evaluate(const gs_function_t *pfn_common, const float *in0, float *out)
{
    ...
    for (i = 0; i < pfn->params.n; ++i) {
        int code =
            ((pfn->params.Functions[i])->head.procs.evaluate)(pfn->params.Functions[i], in, out + i);
                     ...
                     const float *lower, const float *upper, uint *mask)
{
    ...
    for (i = 0; i < pfn->params.n; ++i) {
        int code =
            ((pfn->params.Functions[i])->head.procs.is_monotonic)(pfn->params.Functions[i], lower, upper, mask);
                    ...
                    const gs_range_t *pranges, gs_memory_t *mem)
{
    gs_function_AdOt_t *psfn =
        (gs_function_AdOt_t *)(*(mem)->procs.alloc_struct)(mem, &st_function_AdOt, "fn_AdOt_make_scaled");
    ...
    if ((code = fn_common_scale((gs_function_t *)psfn,
        ...
        (code = fn_scale_functions((gs_function_t ***)&psfn->params.Functions,
                                   pfn->params.Functions,
                                   pfn->params.n, pranges, ((bool)1), mem)) < 0) {
        (((gs_function_t *)psfn)->head.procs.free((gs_function_t *)psfn, ((bool)1), mem));
        return code;
    }
    *ppsfn = psfn;
    ...
    *ppfn = 0;
        ...
        return ((-15));
    {
        gs_function_AdOt_t *pfn =
            (gs_function_AdOt_t *)(*(mem)->procs.alloc_struct)(mem, &st_function_AdOt, "gs_function_AdOt_init");

        float *domain = (float *)
            (*(mem)->procs.alloc_byte_array)(mem, 2 * m, sizeof(float), "gs_function_AdOt_init(Domain)");
        ...
        if (domain == 0) {
            (((gs_function_t *)pfn)->head.procs.free((gs_function_t *)pfn, ((bool)1), mem));
            return ((-25));
        }
# 737 "./base/gsfunc3.c"
        ...
        for (i = 1; i < n; ++i) {
            ...
            for (j = 0; j < 2 * m; j += 2, dom += 2) {
                domain[j] = (((domain[j]) > (dom[0])) ? (domain[j]) : (dom[0]));
                domain[j + 1] = (((domain[j + 1]) < (dom[1])) ? (domain[j + 1]) : (dom[1]));
            }
        }
        *ppfn = (gs_function_t *) pfn;
    }
