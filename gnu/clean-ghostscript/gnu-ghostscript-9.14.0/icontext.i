...
extern const gs_memory_struct_type_t st_gs_dual_memory;
extern const gs_memory_struct_type_t st_ref_stack;
extern const gs_memory_struct_type_t st_dict_stack;
extern const gs_memory_struct_type_t st_exec_stack;
extern const gs_memory_struct_type_t st_op_stack;


static
void context_state_clear_marks(const gs_memory_t *cmem, void *vptr, uint size, const gs_memory_struct_type_t *pstype)
{
    gs_context_state_t *const pcst = vptr;

    ((&pcst->stdio[0])->tas.type_attrs &= ~(1));
    ((&pcst->stdio[1])->tas.type_attrs &= ~(1));
    ((&pcst->stdio[2])->tas.type_attrs &= ~(1));
    ((&pcst->error_object)->tas.type_attrs &= ~(1));
    ((&pcst->userparams)->tas.type_attrs &= ~(1));
    ((&pcst->op_array_table_global.table)->tas.type_attrs &= ~(1));
    ((&pcst->op_array_table_local.table)->tas.type_attrs &= ~(1));
}
static
gs_ptr_type_t context_state_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_context_state_t *pcst = vptr; switch ( index ) { default: {
    index -= 10;
    if (index < 0)
        return (*(st_gs_dual_memory).enum_ptrs)(mem, &pcst->memory, sizeof(pcst->memory), index, pep, &(st_gs_dual_memory), gcst);

    index -= 0;
    if (index < 2)
        return (*(st_dict_stack).enum_ptrs)(mem, &pcst->dict_stack, sizeof(pcst->dict_stack), index, pep, &(st_dict_stack), gcst);

    index -= 2;
    if (index < 2)
        return (*(st_exec_stack).enum_ptrs)(mem, &pcst->exec_stack, sizeof(pcst->exec_stack), index, pep, &(st_exec_stack), gcst);

    index -= 2;
    return (*(st_op_stack).enum_ptrs)(mem, &pcst->op_stack, sizeof(pcst->op_stack), index, pep, &(st_op_stack), gcst);

    }
    case 0: return (pep->ptr = (const void *)(((const gs_context_state_t *)vptr)->pgs), (&ptr_struct_procs));
    case 1: return (pep->ptr = (const void *)(&pcst->stdio[0]), (&ptr_ref_procs));
    case 2: return (pep->ptr = (const void *)(&pcst->stdio[1]), (&ptr_ref_procs));
    case 3: return (pep->ptr = (const void *)(&pcst->stdio[2]), (&ptr_ref_procs));
    case 4: return (pep->ptr = (const void *)(&pcst->error_object), (&ptr_ref_procs));
    case 5: return (pep->ptr = (const void *)(&pcst->userparams), (&ptr_ref_procs));
    case 6: return (pep->ptr = (const void *)(((const gs_context_state_t *)vptr)->op_array_table_global.nx_table), (&ptr_struct_procs));
    case 7: return (pep->ptr = (const void *)(((const gs_context_state_t *)vptr)->op_array_table_local.nx_table), (&ptr_struct_procs));
    case 8: return (pep->ptr = (const void *)(&pcst->op_array_table_global.table), (&ptr_ref_procs));
    case 9: return (pep->ptr = (const void *)(&pcst->op_array_table_local.table), (&ptr_ref_procs));
} }
static void context_state_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_context_state_t *pcst = vptr;;
    (((gs_context_state_t *)vptr)->pgs = (((*(const gc_procs_with_refs_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_context_state_t *)vptr)->pgs), gcst)));
    (*(st_gs_dual_memory).reloc_ptrs)(&pcst->memory, sizeof(pcst->memory), &(st_gs_dual_memory), gcst);

    (*((*(const gc_procs_with_refs_t **)(gcst))->reloc_refs))((ref_packed *)(&(pcst->stdio[0])), (ref_packed *)(&(pcst->stdio[0]) + 1), gcst);
    (*((*(const gc_procs_with_refs_t **)(gcst))->reloc_refs))((ref_packed *)(&(pcst->stdio[1])), (ref_packed *)(&(pcst->stdio[1]) + 1), gcst);
    (*((*(const gc_procs_with_refs_t **)(gcst))->reloc_refs))((ref_packed *)(&(pcst->stdio[2])), (ref_packed *)(&(pcst->stdio[2]) + 1), gcst);
    (*((*(const gc_procs_with_refs_t **)(gcst))->reloc_refs))((ref_packed *)(&(pcst->error_object)), (ref_packed *)(&(pcst->error_object) + 1), gcst);
    ((&pcst->error_object)->tas.type_attrs &= ~(1));
    (*((*(const gc_procs_with_refs_t **)(gcst))->reloc_refs))((ref_packed *)(&(pcst->userparams)), (ref_packed *)(&(pcst->userparams) + 1), gcst);
    ((&pcst->userparams)->tas.type_attrs &= ~(1));
    (((gs_context_state_t *)vptr)->op_array_table_global.nx_table = (((*(const gc_procs_with_refs_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_context_state_t *)vptr)->op_array_table_global.nx_table), gcst)));
    (((gs_context_state_t *)vptr)->op_array_table_local.nx_table = (((*(const gc_procs_with_refs_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_context_state_t *)vptr)->op_array_table_local.nx_table), gcst)));
    (*((*(const gc_procs_with_refs_t **)(gcst))->reloc_refs))((ref_packed *)(&(pcst->op_array_table_global.table)), (ref_packed *)(&(pcst->op_array_table_global.table) + 1), gcst);
    ((&pcst->op_array_table_global.table)->tas.type_attrs &= ~(1));
    (*((*(const gc_procs_with_refs_t **)(gcst))->reloc_refs))((ref_packed *)(&(pcst->op_array_table_local.table)), (ref_packed *)(&(pcst->op_array_table_local.table) + 1), gcst);
    ((&pcst->op_array_table_local.table)->tas.type_attrs &= ~(1));
    (*(st_dict_stack).reloc_ptrs)(&pcst->dict_stack, sizeof(pcst->dict_stack), &(st_dict_stack), gcst);
    (*(st_exec_stack).reloc_ptrs)(&pcst->exec_stack, sizeof(pcst->exec_stack), &(st_exec_stack), gcst);
    (*(st_op_stack).reloc_ptrs)(&pcst->op_stack, sizeof(pcst->op_stack), &(st_op_stack), gcst);
}
const gs_memory_struct_type_t st_context_state = { sizeof(gs_context_state_t), "gs_context_state_t", 0, context_state_clear_marks, context_state_enum_ptrs, context_state_reloc_ptrs, 0, 0 };
...
context_state_alloc(gs_context_state_t ** ppcst,
                    ...
                    const gs_dual_memory_t * dmem)
{
    gs_ref_memory_t *mem = dmem->spaces.memories.named.local;
    gs_context_state_t *pcst = *ppcst;
    int code;
    int i;

    if (pcst == 0) {
        pcst = (gs_context_state_t *)(*((gs_memory_t *) mem)->procs.alloc_struct)((gs_memory_t *) mem, &st_context_state, "context_state_alloc");
    ...
    pcst->in_superexec = 0;
    pcst->plugin_list = 0;
    (((&pcst->error_object)->tas.type_attrs = ((t__invalid) << 8) + (0)) );
    {
        ...
        if (dict_find_string(system_dict, "userparams", &puserparams) >= 0)
            ...
            size = 300;
        code = dict_alloc(pcst->memory.spaces.memories.named.local, size, &pcst->userparams);
        if (code < 0)
            goto x2;

    }
    pcst->scanner_options = 0;
    pcst->LockFilePermissions = ((bool)0);
    pcst->starting_arg_file = ((bool)0);
    pcst->RenderTTNotdef = ((bool)1);
...

    {
        ...
        s = (stream*)((mem->non_gc_memory->stable_memory)->procs.alloc_bytes_immovable(mem->non_gc_memory->stable_memory, sizeof(*s), "context_state_alloc"));
    ...
    ((&pcst->stdio[0])->value.pfile = (pcst->invalid_file_stream), ((&pcst->stdio[0])->tas.type_attrs = ((t_file) << 8) + ((0x20 + 0x40) | avm_foreign)), ((&pcst->stdio[0])->tas.rsize = (1)));

    ((&pcst->stdio[1])->value.pfile = (pcst->invalid_file_stream), ((&pcst->stdio[1])->tas.type_attrs = ((t_file) << 8) + ((0x10 + 0x20 +0x40) | avm_foreign)), ((&pcst->stdio[1])->tas.rsize = (1)));

    ((&pcst->stdio[2])->value.pfile = (pcst->invalid_file_stream), ((&pcst->stdio[2])->tas.type_attrs = ((t_file) << 8) + ((0x10 + 0x20 +0x40) | avm_foreign)), ((&pcst->stdio[2])->tas.rsize = (1)));

    for (i = (sizeof(pcst->memory.spaces.memories.indexed) / sizeof((pcst->memory.spaces.memories.indexed)[0])); --i >= 0;)
        if (dmem->spaces.memories.indexed[i] != 0)
            ++(dmem->spaces.memories.indexed[i]->num_contexts);
  ...
  x0:if (*ppcst == 0)
        (((gs_memory_t *) mem)->procs.free_object((gs_memory_t *) mem, pcst, "context_state_alloc"));
    return code;
}
...
{
    gs_ref_memory_t *lmem = ((i_ctx_p->memory).spaces.memories.named.local);
    ref *system_dict = (&(i_ctx_p->dict_stack).system_dict);
    uint space = (avm_space)(((system_dict)->tas.type_attrs) & (((1 << 2) - 1) << 2));
    ...
    alloc_set_not_in_save((&(i_ctx_p->memory)));
    ((system_dict)->tas.type_attrs = ((system_dict)->tas.type_attrs & ~((((1 << 2) - 1) << 2))) | ((uint)avm_max));
...

    {
        ...
        if (dict_find_string(puserdict, "localdicts", &plocaldicts) > 0 &&
            ((((const byte *)&((plocaldicts)->tas.type_attrs))[1]) == (t_dictionary))
            ) {
            dict_copy_entries(plocaldicts, system_dict, ((bool)0), dstack);
        }
    }
    ...
    ((system_dict)->tas.type_attrs = ((system_dict)->tas.type_attrs & ~((((1 << 2) - 1) << 2))) | ((uint)space));
    if (lmem->save_level > 0)
        alloc_set_in_save((&(i_ctx_p->memory)));
...
context_state_store(gs_context_state_t * pcst)
{
...

    {
        ...
        if (dict_find_string((&(i_ctx_p->dict_stack).system_dict), "userparams", &puserparams) < 0)
            return ((-100));
...
{
    gs_ref_memory_t *mem = pcst->memory.spaces.memories.named.local;
    int freed = 0;
    int i;



    ((mem->non_gc_memory->stable_memory)->procs.free_object(mem->non_gc_memory->stable_memory, pcst->invalid_file_stream, "context_state_alloc"));
    ...
    for (i = (sizeof(pcst->memory.spaces.memories.indexed) / sizeof((pcst->memory.spaces.memories.indexed)[0])); --i >= 0;) {
        if (pcst->memory.spaces.memories.indexed[i] != 0 &&
            !--(pcst->memory.spaces.memories.indexed[i]->num_contexts)
            ) {
