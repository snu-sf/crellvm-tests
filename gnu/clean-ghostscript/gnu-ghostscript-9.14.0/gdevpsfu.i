# 1 "./devices/vector/gdevpsfu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpsfu.c" 2
# 18 "./devices/vector/gdevpsfu.c"
# 1 "./base/memory_.h" 1
# 23 "./base/memory_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 55 "./base/memory_.h" 2
# 19 "./devices/vector/gdevpsfu.c" 2
# 1 "/usr/include/stdlib.h" 1 3 4
# 32 "/usr/include/stdlib.h" 3 4
# 1 "/home/juneyoung.lee/llvm-prototypes/llvm-install-3.7.0/bin/../lib/clang/3.7.0/include/stddef.h" 1 3 4
...
# 20 "./devices/vector/gdevpsfu.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
...
# 21 "./devices/vector/gdevpsfu.c" 2
...
# 23 "./devices/vector/gdevpsfu.c" 2
# 1 "./base/gxfont.h" 1
# 23 "./base/gxfont.h"
# 1 "./base/gsccode.h" 1
# 27 "./base/gsccode.h"
...
# 24 "./devices/vector/gdevpsfu.c" 2
...
int psf_convert_type1_to_type2(stream *s, const gs_glyph_data_t *pgd,
                               gs_font_type1 *pfont);
# 25 "./devices/vector/gdevpsfu.c" 2
...
enumerate_range_next(psf_glyph_enum_t *ppge, gs_glyph *pglyph)
{
    if (ppge->index >= ppge->subset.size)
        return 1;
    *pglyph = (gs_glyph)(ppge->index++ + ((gs_glyph)0x80000000L));
    return 0;
}
void
                       ...
                       uint max_pieces, gs_font *font)
{
    ...
    for (i = 0; i < count; ++i) {
        ...
        if (count + max_pieces > max_count) {
            ...
            code = font->procs.glyph_info(font, glyphs[i], ((void*)0),
                                          8, &info);
            if (code < 0)
                continue;
                         ...
                         glyph_data_proc_t glyph_data)
{
    ...
    while ((code = psf_enumerate_glyphs_next(ppge, &glyph)) != 1) {
        ...
        code = pfont->procs.glyph_info((gs_font *)pfont, glyph, ((void*)0),
                                       members, &info);
                       ...
                       glyph_data_proc_t glyph_data)
{
    ...
    if (subset_glyphs) {
        if (subset_size > (sizeof(pglyphs->subset_data) / sizeof((pglyphs->subset_data)[0])))
            return ((-13));
...

    {
        ...
        psf_enumerate_list_begin(&genum, (gs_font *)pfont, subset_glyphs,
...

    {
        ...
        psf_enumerate_list_begin(&genum, (gs_font *)pfont, ((void*)0), 0,
                                    GLYPH_SPACE_NAME);
    ...
    if (subset_glyphs) {
        ...
        int code = psf_add_subset_pieces(subset_glyphs, &subset_size,
                                          (sizeof(pglyphs->subset_data) / sizeof((pglyphs->subset_data)[0])) - 1, 2,
                                          (gs_font *)pfont);
        uint keep_size, i;
        ...
        for (i = 0, keep_size = 0; i < subset_size; ++i) {
            ...
            if (pfont->procs.glyph_info((gs_font *)pfont, glyph, ((void*)0),
                                        8, &info) >= 0)
