# 1 "./devices/vector/gdevpdfd.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpdfd.c" 2
# 18 "./devices/vector/gdevpdfd.c"
# 1 "./base/math_.h" 1
# 23 "./base/math_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 19 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/memory_.h" 1
# 54 "./base/memory_.h"
...
# 55 "./base/memory_.h" 2
# 20 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
...
# 21 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gxdevice.h" 1
# 23 "./base/gxdevice.h"
# 1 "./base/gxdevcli.h" 1
# 23 "./base/gxdevcli.h"
...
# 22 "./devices/vector/gdevpdfd.c" 2
...
# 24 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gxpaint.h" 1
# 50 "./base/gxpaint.h"
...
int gx_stroke_path_only(gx_path * ppath, gx_path * to_path, gx_device * dev,
                        ...
                        const gx_clip_path * pcpath);
# 25 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gxcoord.h" 1
# 23 "./base/gxcoord.h"
# 1 "./base/gscoord.h" 1
# 24 "./base/gscoord.h"
...
# 26 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gxdevmem.h" 1
# 81 "./base/gxdevmem.h"
...
# 27 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gxcolor2.h" 1
# 23 "./base/gxcolor2.h"
# 1 "./base/gscolor2.h" 1
# 23 "./base/gscolor2.h"
...
# 28 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gxhldevc.h" 1
# 67 "./base/gxhldevc.h"
...
# 29 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gsstate.h" 1
# 31 "./base/gsstate.h"
...
# 30 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gxstate.h" 1
# 37 "./base/gxstate.h"
...
# 31 "./devices/vector/gdevpdfd.c" 2
...
# 33 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gsshade.h" 1
# 24 "./base/gsshade.h"
# 1 "./base/gsdsrc.h" 1
# 53 "./base/gsdsrc.h"
...
# 34 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gzpath.h" 1
# 23 "./base/gzpath.h"
# 1 "./base/gxpath.h" 1
# 25 "./base/gxpath.h"
...
# 35 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gzcpath.h" 1
# 23 "./base/gzcpath.h"
# 1 "./base/gxcpath.h" 1
# 44 "./base/gxcpath.h"
...
# 36 "./devices/vector/gdevpdfd.c" 2
...
# 37 "./devices/vector/gdevpdfd.c" 2
...
# 38 "./devices/vector/gdevpdfd.c" 2
...
# 39 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gsutil.h" 1
# 25 "./base/gsutil.h"
...
# 40 "./devices/vector/gdevpdfd.c" 2
...
# 41 "./devices/vector/gdevpdfd.c" 2
...
# 42 "./devices/vector/gdevpdfd.c" 2
# 1 "./base/gxdevsop.h" 1
# 113 "./base/gxdevsop.h"
...
# 43 "./devices/vector/gdevpdfd.c" 2
                        ...
                        gx_color_index color)
{
    ...
    code = pdf_put_clip_path(pdev, ((void*)0));
    if (code < 0)
        return code;
                 ...
                 const gx_drawing_color * pdc)
{
    ...
    bool hl_color = (*((vdev)->vec_procs->can_handle_hl_color)) (vdev, pis, pdc);
           ...
           gx_path_type_t type)
{
    ...
    fixed xmax = ((fixed)(32766)<<8), ymax = ((fixed)(32766)<<8);
...
pdf_remember_clip_path(gx_device_pdf * pdev, const gx_clip_path * pcpath)
{
    ...
    pdev->clip_path = gx_path_alloc_shared(((void*)0), pdev->v_memory, "pdf clip path");
    if (pdev->clip_path == 0)
        return ((-25));
...
pdf_must_put_clip_path(gx_device_pdf * pdev, const gx_clip_path * pcpath)
{
    if (pcpath == ((void*)0)) {
        ...
        if (pdev->clip_path_id == pcpath->id)
            return ((bool)0);
        if (gx_cpath_includes_rectangle(pcpath, 0L, 0L,
                                        ((fixed)(pdev->width)<<8),
                                        ((fixed)(pdev->height)<<8)))
            if (pdev->clip_path_id == pdev->no_clip_path_id)
                return ((bool)0);
    ...
    if (new_id != pdev->no_clip_path_id) {
        ...
        if (cpath_is_rectangle(pcpath, &rect)) {
            ...
            pprintg4(s, "%g %g %g %g re",
                ((rect.p.x)*(1.0/(1<<8))), ((rect.p.y)*(1.0/(1<<8))),
                ((rect.q.x - rect.p.x)*(1.0/(1<<8))),
                ((rect.q.y - rect.p.y)*(1.0/(1<<8))));
            pprints1(s, " %s n\n", (pcpath->rule <= 0 ? "W" : "W*"));
        } else {
            ...
            gdev_vector_dopath_init(&state, (gx_device_vector *)pdev,
                                    gx_path_type_fill, ((void*)0));
            if (pcpath->path_list == ((void*)0)) {
# 431 "./devices/vector/gdevpdfd.c"
                gs_cpath_enum cenum;
    ...
    return pdf_remember_clip_path(pdev,
            (pdev->clip_path_id == pdev->no_clip_path_id ? ((void*)0) : pcpath));
}
                  ...
                  double prescale, double *pscale)
{
    ...
    bmin = (((bbox->p.x / pdev->scale.x) < (bbox->p.y / pdev->scale.y)) ? (bbox->p.x / pdev->scale.x) : (bbox->p.y / pdev->scale.y)) * prescale;
    bmax = (((bbox->q.x / pdev->scale.x) > (bbox->q.y / pdev->scale.y)) ? (bbox->q.x / pdev->scale.x) : (bbox->q.y / pdev->scale.y)) * prescale;
    if (bmin <= ((fixed)(-16300)<<8) ||
        bmax > ((fixed)(16300)<<8)
        ) {

        *pscale = (((bmin / ((fixed)(-16300)<<8)) > (bmax / ((fixed)(16300)<<8))) ? (bmin / ((fixed)(-16300)<<8)) : (bmax / ((fixed)(16300)<<8)));
...
static const gc_ptr_element_t pdf_lcvd_t_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((pdf_lcvd_t *)0)->mask - (char *)((pdf_lcvd_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((pdf_lcvd_t *)0)->pdev - (char *)((pdf_lcvd_t *)0) )) } }; static const gc_struct_data_t pdf_lcvd_t_reloc_ptrs = { (sizeof(pdf_lcvd_t_enum_ptrs) / sizeof((pdf_lcvd_t_enum_ptrs)[0])), 0, &st_device_memory, pdf_lcvd_t_enum_ptrs }; const gs_memory_struct_type_t st_pdf_lcvd_t = { sizeof(pdf_lcvd_t), "pdf_lcvd_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &pdf_lcvd_t_reloc_ptrs };
...
lcvd_get_clipping_box_shifted_from_mdev(gx_device *dev, gs_fixed_rect *pbox)
{
    ...
    ofs = ((fixed)(cvd->mdev.mapped_x)<<8);
    pbox->p.x += ofs;
    pbox->q.x += ofs;
    ofs = ((fixed)(cvd->mdev.mapped_y)<<8);
    pbox->p.y += ofs;
    pbox->q.y += ofs;
}
static int
...
write_image(gx_device_pdf *pdev, gx_device_memory *mdev, gs_matrix *m)
{
    ...
    if (m != ((void*)0))
        pdf_put_matrix(pdev, ((void*)0), m, " cm\n");
    code = pdf_copy_color_data(pdev, mdev->base, sourcex,
                mdev->raster, 0L, 0, 0, mdev->width, mdev->height,
                &image, &writer, 2);
    if (code == 1)
        code = 0;
    else if (code == 0)
        code = pdf_do_image(pdev, writer.pres, ((void*)0), ((bool)1));
    return code;
}
static int
...
write_subimage(gx_device_pdf *pdev, gx_device_memory *mdev, int x, int y, int x1, int y1)
{
    ...
    int X = (((0) > (x - 1)) ? (0) : (x - 1));
    int Y = (((0) > (y - 1)) ? (0) : (y - 1));
    int X1 = (((mdev->width) < (x1 + 1)) ? (mdev->width) : (x1 + 1));
    int Y1 = (((mdev->height) < (y1 + 1)) ? (mdev->height) : (y1 + 1));
    int code;
    ...
    if (!writer.pres)
        return 0;
    return pdf_do_image(pdev, writer.pres, ((void*)0), ((bool)1));
}
...
write_image_with_clip(gx_device_pdf *pdev, pdf_lcvd_t *cvd)
{
    ...
    if (cvd->write_matrix)
        pdf_put_matrix(pdev, ((void*)0), &cvd->m, " cm q\n");
    for(;;) {
        int x1, y1;

        compute_subimage(cvd->mask->width, cvd->mask->height,
                         cvd->mask->raster, cvd->mask->base,
                         x, y, (((pdev->MaxClipPathSize) > (100)) ? (pdev->MaxClipPathSize) : (100)), &x1, &y1);
...
pdf_dump_converted_image(gx_device_pdf *pdev, pdf_lcvd_t *cvd)
{
    ...
    if (!cvd->path_is_empty || cvd->has_background) {
        if (!cvd->has_background)
            stream_puts(pdev->strm, "W n\n");
        code = write_image(pdev, &cvd->mdev, (cvd->write_matrix ? &cvd->m : ((void*)0)));
        cvd->path_is_empty = ((bool)1);
        ...
        if (code >= 0) {
            stream_puts(pdev->strm, "W n\n");
            code = write_image(pdev, &cvd->mdev, ((void*)0));
        }
        ...
        if (code >= 0)
            code = write_mask(pdev, cvd->mask, (cvd->write_matrix ? &cvd->m : ((void*)0)));
        cvd->mask_is_empty = ((bool)1);
    } else if (!cvd->mask_is_empty && !pdev->PatternImagemask) {
    ...
    if (code > 0)
        code = (*((&cvd->mdev)->procs.fill_rectangle))((gx_device *)&cvd->mdev,
    ...
    if (gx_path_is_null(ppath)) {
        ...
        if (!cvd->path_is_empty) {
            ...
            if (code < 0)
                return code;
            stream_puts(pdev->strm, "Q q\n");
            ((&cvd->mdev)->procs.fill_rectangle) = lcvd_fill_rectangle_shifted2;
        }
        ...
        if (!cvd->mask_is_empty) {
            ...
            if (code < 0)
                return code;
            stream_puts(pdev->strm, "Q q\n");
            ((&cvd->mdev)->procs.fill_rectangle) = lcvd_fill_rectangle_shifted;
            cvd->mask_is_empty = ((bool)1);
        }
                                 ...
                                 bool need_mask, int x, int y, int w, int h, bool write_on_close)
{
    ...
    if (cvd == ((void*)0)) {
        cvd = (pdf_lcvd_t *)(*(mem)->procs.alloc_struct)(mem, &st_pdf_lcvd_t, "pdf_setup_masked_image_converter");
        if (cvd == ((void*)0))
            return ((-25));
        *pcvd = cvd;
    }
    ...
    cvd->path_is_empty = ((bool)1);
    cvd->mask_is_empty = ((bool)1);
    cvd->mask_is_clean = ((bool)0);
    cvd->has_background = ((bool)0);
    cvd->mask = 0;
    cvd->write_matrix = ((bool)1);
    code = (*((&cvd->mdev)->procs.open_device))((gx_device *)&cvd->mdev);
    if (code < 0)
        return code;
    code = (*((&cvd->mdev)->procs.fill_rectangle))((gx_device *)&cvd->mdev,
                0, 0, cvd->mdev.width, cvd->mdev.height, (gx_color_index)0);
    if (code < 0)
        return code;
    if (need_mask) {
        mask = (gx_device_memory *)(*(mem)->procs.alloc_struct)(mem, &st_device_memory, "pdf_setup_masked_image_converter");
        if (mask == ((void*)0))
            return ((-25));
        cvd->mask = mask;
        ...
        if (code < 0)
            return code;
        if (write_on_close) {
            code = (*((mask)->procs.fill_rectangle))((gx_device *)mask,
                        0, 0, mask->width, mask->height, (gx_color_index)0);
            if (code < 0)
                return code;
        }
    }
    cvd->std_copy_color = ((&cvd->mdev)->procs.copy_color);
    cvd->std_fill_rectangle = ((&cvd->mdev)->procs.fill_rectangle);
    cvd->std_close_device = ((&cvd->mdev)->procs.close_device);
    cvd->std_get_clipping_box = ((&cvd->mdev)->procs.get_clipping_box);
    if (!write_on_close) {

        ((&cvd->mdev)->procs.fill_rectangle) = (need_mask ? lcvd_fill_rectangle_shifted2
                                                          : lcvd_fill_rectangle_shifted);
        ((&cvd->mdev)->procs.get_clipping_box) = lcvd_get_clipping_box_shifted_from_mdev;
    } else {
        ((&cvd->mdev)->procs.fill_rectangle) = lcvd_fill_rectangle_shifted;
        ((&cvd->mdev)->procs.get_clipping_box) = lcvd_get_clipping_box_shifted_from_mdev;
    }
    ((&cvd->mdev)->procs.copy_color) = lcvd_copy_color_shifted;
    ((&cvd->mdev)->procs.dev_spec_op) = lcvd_dev_spec_op;
    ((&cvd->mdev)->procs.fill_path) = lcvd_handle_fill_path_as_shading_coverage;
    cvd->m = *m;
    if (write_on_close) {
        cvd->mdev.is_open = ((bool)1);
        if (mask)
            mask->is_open = ((bool)1);
        ((&cvd->mdev)->procs.close_device) = lcvd_close_device_with_writing;
    }
    return 0;
}
...
{
    (*((&cvd->mdev)->procs.close_device))((gx_device *)&cvd->mdev);
    if (cvd->mask) {
        (*((cvd->mask)->procs.close_device))((gx_device *)cvd->mask);
        ((cvd->mask->memory)->procs.free_object(cvd->mask->memory, cvd->mask, "pdf_remove_masked_image_converter"));
    }
}
              ...
              const gx_drawing_color * pdcolor, const gx_clip_path * pcpath)
{
    gx_device_pdf *pdev = (gx_device_pdf *) dev;
    int code;
# 1083 "./devices/vector/gdevpdfd.c"
    bool have_path;
    ...
    have_path = !((ppath)->segments != 0 && (ppath)->segments->contents.subpath_first == 0);
    ...
    if (code == (-15)) {
        ...
        if (!convert_to_image) {
            ...
            gs_matrix m, save_ctm = (*(const gs_matrix *)&(pis)->ctm), ms, msi, mm;
            ...
            if (code < 0)
                return code;
            do { if ((box).p.x > (bbox).p.x) (bbox).p.x = (box).p.x; if ((box).q.x < (bbox).q.x) (bbox).q.x = (box).q.x; if ((box).p.y > (bbox).p.y) (bbox).p.y = (box).p.y; if ((box).q.y < (bbox).q.y) (bbox).q.y = (box).q.y; } while (0);
            code = gx_dc_pattern2_get_bbox(pdcolor, &bbox1);
            if (code < 0)
                return code;
            if (code)
                do { if ((bbox1).p.x > (bbox).p.x) (bbox).p.x = (bbox1).p.x; if ((bbox1).q.x < (bbox).q.x) (bbox).q.x = (bbox1).q.x; if ((bbox1).p.y > (bbox).p.y) (bbox).p.y = (bbox1).p.y; if ((bbox1).q.y < (bbox).q.y) (bbox).q.y = (bbox1).q.y; } while (0);
            if (bbox.p.x >= bbox.q.x || bbox.p.y >= bbox.q.y)
                return 0;
            sx = ((int)((bbox.p.x) >> (8)));
            sy = ((int)((bbox.p.y) >> (8)));
            gs_make_identity(&m);
            rect_size.x = ((int)((bbox.q.x + ((1L << 8) >> 1)) >> (8))) - sx;
            rect_size.y = ((int)((bbox.q.y + ((1L << 8) >> 1)) >> (8))) - sy;
            ...
            if (scale > 1) {
                ...
                gs_matrix_multiply(&(*(const gs_matrix *)&(pis)->ctm), &ms, &mm);
                gs_setmatrix((gs_state *)pis, &mm);
                gs_matrix_multiply(&(*(const gs_matrix *)&((gs_imager_state *)pgs)->ctm), &ms, &mm);
                gs_setmatrix((gs_state *)pgs, &mm);
                sx = ((int)((bbox.p.x / (int)scalex) >> (8)));
                sy = ((int)((bbox.p.y / (int)scaley) >> (8)));
                cvd.path_offset.x = sx;
                cvd.path_offset.y = sy;
            }
            code = pdf_setup_masked_image_converter(pdev, pdev->memory, &m, &pcvd, need_mask, sx, sy,
                            rect_size.x, rect_size.y, ((bool)0));
            pcvd->has_background = gx_dc_pattern2_has_background(pdcolor);
            stream_puts(pdev->strm, "q\n");
            if (code >= 0) {
                code = gdev_vector_dopath((gx_device_vector *)pdev, ppath,
                                        gx_path_type_clip, ((void*)0));
                if (code >= 0)
                    stream_puts(pdev->strm, (params->rule < 0 ? "W n\n" : "W* n\n"));
            }
            pdf_put_matrix(pdev, ((void*)0), &cvd.m, " cm q\n");
            cvd.write_matrix = ((bool)0);
            if (code >= 0)
                code = gs_shading_do_fill_rectangle(pi.templat.Shading,
                     ((void*)0), (gx_device *)&cvd.mdev, (gs_imager_state *)pgs, !pi.shfill);
            if (code >= 0)
                code = pdf_dump_converted_image(pdev, &cvd);
            stream_puts(pdev->strm, "Q Q\n");
        ...
        return code;
    {
        ...
        double scale;
        gs_matrix smat;
        gs_matrix *psmat = ((void*)0);

        if (pcpath) {
            do { if ((box).p.x > (box1).p.x) (box1).p.x = (box).p.x; if ((box).q.x < (box1).q.x) (box1).q.x = (box).q.x; if ((box).p.y > (box1).p.y) (box1).p.y = (box).p.y; if ((box).q.y < (box1).q.y) (box1).q.y = (box).q.y; } while (0);
              ...
              const gx_drawing_color * pdcolor, const gx_clip_path * pcpath)
{
    ...
    if (((ppath)->segments != 0 && (ppath)->segments->contents.subpath_first == 0))
        return 0;
    if (pdf_must_put_clip_path(pdev, pcpath))
        code = pdf_unclip(pdev);
    else if ((pdev->last_charpath_op & 0x01000) && ppath->segments->contents.subpath_current &&
        (ppath->last_charpath_segment == ppath->segments->contents.subpath_current->last) && !pdev->ForOPDFRead) {
    ...
    if (code < 0)
        return code;
# 1335 "./devices/vector/gdevpdfd.c"
...
# 1349 "./devices/vector/gdevpdfd.c"
        set_ctm = ((bool)0);
        scale = fabs(pis->ctm.xx + pis->ctm.xy + pis->ctm.yx + pis->ctm.yy)
                / sqrt(2);
    }
    if (set_ctm) {
    ...
    {
# 1377 "./devices/vector/gdevpdfd.c"
        gs_fixed_rect clip_box, stroke_bbox = bbox;
        gs_point d0, d1;
        gs_fixed_point p0, p1;
        fixed bbox_expansion_x, bbox_expansion_y;

        gs_distance_transform(pis->line_params.half_width, 0, &(*(const gs_matrix *)&(pis)->ctm), &d0);
        gs_distance_transform(0, pis->line_params.half_width, &(*(const gs_matrix *)&(pis)->ctm), &d1);
        p0.x = ((fixed)((((d0.x) < 0 ? -(d0.x) : (d0.x)))*(float)(1<<8)));
        p0.y = ((fixed)((((d0.y) < 0 ? -(d0.y) : (d0.y)))*(float)(1<<8)));
        p1.x = ((fixed)((((d1.x) < 0 ? -(d1.x) : (d1.x)))*(float)(1<<8)));
        p1.y = ((fixed)((((d1.y) < 0 ? -(d1.y) : (d1.y)))*(float)(1<<8)));
        bbox_expansion_x = (((p0.x) > (p1.x)) ? (p0.x) : (p1.x)) + (1L << 8) * 2;
        bbox_expansion_y = (((p0.y) > (p1.y)) ? (p0.y) : (p1.y)) + (1L << 8) * 2;
        ...
        do { if ((clip_box).p.x > (stroke_bbox).p.x) (stroke_bbox).p.x = (clip_box).p.x; if ((clip_box).q.x < (stroke_bbox).q.x) (stroke_bbox).q.x = (clip_box).q.x; if ((clip_box).p.y > (stroke_bbox).p.y) (stroke_bbox).p.y = (clip_box).p.y; if ((clip_box).q.y < (stroke_bbox).q.y) (stroke_bbox).q.y = (clip_box).q.y; } while (0);
    ...
    const gx_clip_path *pcpath)
{
    ...
    if (rect->p.x == rect->q.x)
        return 0;
    if (!convert_to_image) {
        code = prepare_fill_with_clip(pdev, pis, &box, ((bool)1), pdcolor, pcpath);
        if (code < 0)
            return code;
        if (code == 1)
            return 0;
        ...
        pprintg4(pdev->strm, "%g %g %g %g re f\n",
                ((box1.p.x)*(1.0/(1<<8))) / scale, ((box1.p.y)*(1.0/(1<<8))) / scale,
                ((box1.q.x - box1.p.x)*(1.0/(1<<8))) / scale, ((box1.q.y - box1.p.y)*(1.0/(1<<8))) / scale);
        if (psmat)
            stream_puts(pdev->strm, "Q\n");
        if (pdev->Eps2Write) {
            gs_rect *Box;
            ...
            if (((box1.p.x)*(1.0/(1<<8))) / (pdev->HWResolution[0] / 72.0) < Box->p.x)
                Box->p.x = ((box1.p.x)*(1.0/(1<<8))) / (pdev->HWResolution[0] / 72.0);
            if (((box1.p.y)*(1.0/(1<<8))) / (pdev->HWResolution[1] / 72.0) < Box->p.y)
                Box->p.y = ((box1.p.y)*(1.0/(1<<8))) / (pdev->HWResolution[1] / 72.0);
            if (((box1.q.x)*(1.0/(1<<8))) / (pdev->HWResolution[0] / 72.0) > Box->q.x)
                Box->q.x = ((box1.q.x)*(1.0/(1<<8))) / (pdev->HWResolution[0] / 72.0) - Box->p.x;
            if (((box1.q.y)*(1.0/(1<<8))) / (pdev->HWResolution[1] / 72.0) > Box->q.y)
                Box->q.y = ((box1.q.y)*(1.0/(1<<8))) / (pdev->HWResolution[1] / 72.0) - Box->p.y;
        }
        return 0;
    } else {
        ...
        (void)gx_path_init_local_shared(&path, ((void*)0), pis->memory);
...
gdev_pdf_fillpage(gx_device *dev, gs_imager_state * pis, gx_device_color *pdevc)
{
    ...
    if (((pdevc)->colors.pure) == pdev->white && !((pdev)->contents_id != 0) && pdev->sbstack_depth <= bottom) {
