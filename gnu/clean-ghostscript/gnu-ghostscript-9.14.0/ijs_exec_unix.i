# 1 "./ijs/ijs_exec_unix.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./ijs/ijs_exec_unix.c" 2
# 25 "./ijs/ijs_exec_unix.c"
# 1 "./ijs/unistd_.h" 1
# 41 "./ijs/unistd_.h"
