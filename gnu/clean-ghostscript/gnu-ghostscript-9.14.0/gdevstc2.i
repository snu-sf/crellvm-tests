# 1 "./devices/gdevstc2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/gdevstc2.c" 2
# 37 "./devices/gdevstc2.c"
...
# 40 "./devices/gdevstc2.c" 2
# 60 "./devices/gdevstc2.c"
static const byte grayvals[2] = { 0, 1 };

static const byte rgbvals[8] = {
   0, 4, 2, 4|2, 1, 1|4, 1|2, 1|4|2};

static const byte cmykvals[16] = {
      0, 8,4,8|4,2,2|8,2|4,1,
  1,1, 1, 1, 1, 1, 1,1};

static const byte *const pixelconversion[5] = {
   ((void*)0), grayvals, ((void*)0), rgbvals, cmykvals};
...
stc_fs(stcolor_device *sdev,int npixel,byte *bin,byte *bbuf,byte *out)
{
   ...
   if(npixel > 0) {
      ...
      if((sdev->color_info.num_components < 0) ||
         (sdev->color_info.num_components >= (sizeof(pixelconversion) / sizeof((pixelconversion)[0]))) ||
         (pixelconversion[sdev->color_info.num_components] == ((void*)0))) return -1;
      ...
      if(sdev->stc.dither->flags & (64 | 128)) return -4;
