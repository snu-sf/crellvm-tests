# 1 "./openjpeg/libopenjpeg/ppix_manager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/ppix_manager.c" 2
# 36 "./openjpeg/libopenjpeg/ppix_manager.c"
...
# 37 "./openjpeg/libopenjpeg/ppix_manager.c" 2
# 51 "./openjpeg/libopenjpeg/ppix_manager.c"
int opj_write_ppix( int coff, opj_codestream_info_t cstr_info, OPJ_BOOL EPHused, int j2klen, opj_stream_private_t *cio,
              opj_event_mgr_t * p_manager )
{
  ...
  for (i=0;i<2;i++){
    ...
    opj_write_bytes_LE(l_data_header,0x70706978,4);
              ...
              opj_event_mgr_t * p_manager )
{
 ...
 for( layno=0; layno<numOflayers; layno++){
   ...
   default:
    ...
    opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
    opj_write_bytes_LE(l_data_header,(OPJ_UINT32)(packet.end_pos-packet.start_pos+1),size_of_coding);
    opj_stream_write_data(cio,l_data_header,size_of_coding,p_manager);
