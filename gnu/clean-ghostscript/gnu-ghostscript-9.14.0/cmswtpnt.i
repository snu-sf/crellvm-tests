# 1 "./lcms2/src/cmswtpnt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmswtpnt.c" 2
# 27 "./lcms2/src/cmswtpnt.c"
...
# 28 "./lcms2/src/cmswtpnt.c" 2



const cmsCIEXYZ* cmsD50_XYZ(void)
{
    static cmsCIEXYZ D50XYZ = {0.9642, 1.0, 0.8249};
...
cmsBool cmsWhitePointFromTemp(cmsCIExyY* WhitePoint, cmsFloat64Number TempK)
{
    ...
    (((WhitePoint != ((void*)0))) ? (void) (0) : __assert_fail ("(WhitePoint != ((void*)0))", "./lcms2/src/cmswtpnt.c", 54, __PRETTY_FUNCTION__));
    ...
    if (T >= 4000. && T <= 7000.)
    {
        ...
        if (T > 7000.0 && T <= 25000.0)
        {
            ...
            cmsSignalError(0, 2, "cmsWhitePointFromTemp: invalid temp");
            return 0;
        }
...
cmsBool cmsTempFromWhitePoint(cmsFloat64Number* TempK, const cmsCIExyY* WhitePoint)
{
    ...
    (((WhitePoint != ((void*)0))) ? (void) (0) : __assert_fail ("(WhitePoint != ((void*)0))", "./lcms2/src/cmswtpnt.c", 151, __PRETTY_FUNCTION__));
    (((TempK != ((void*)0))) ? (void) (0) : __assert_fail ("(TempK != ((void*)0))", "./lcms2/src/cmswtpnt.c", 152, __PRETTY_FUNCTION__));
    ...
    for (j=0; j < sizeof(isotempdata)/sizeof(ISOTEMPERATURE); j++) {
...

{
    ...
    Tmp = *Chad;
    if (!_cmsMAT3inverse(&Tmp, &Chad_Inv)) return 0;
...
cmsBool _cmsAdaptMatrixToD50(cmsMAT3* r, const cmsCIExyY* SourceWhitePt)
{
    ...
    if (!_cmsAdaptationMatrix(&Bradford, ((void*)0), &Dn, cmsD50_XYZ())) return 0;
...
cmsBool _cmsBuildRGB2XYZtransferMatrix(cmsMAT3* r, const cmsCIExyY* WhitePt, const cmsCIExyYTRIPLE* Primrs)
{
    ...
    _cmsVEC3init(&r -> v[0], Coef.n[0]*xr, Coef.n[1]*xg, Coef.n[2]*xb);
    _cmsVEC3init(&r -> v[1], Coef.n[0]*yr, Coef.n[1]*yg, Coef.n[2]*yb);
    _cmsVEC3init(&r -> v[2], Coef.n[0]*(1.0-xr-yr), Coef.n[1]*(1.0-xg-yg), Coef.n[2]*(1.0-xb-yb));
                                       ...
                                       const cmsCIEXYZ* Value)
{
    ...
    (((Result != ((void*)0))) ? (void) (0) : __assert_fail ("(Result != ((void*)0))", "./lcms2/src/cmswtpnt.c", 334, __PRETTY_FUNCTION__));
    (((SourceWhitePt != ((void*)0))) ? (void) (0) : __assert_fail ("(SourceWhitePt != ((void*)0))", "./lcms2/src/cmswtpnt.c", 335, __PRETTY_FUNCTION__));
    (((Illuminant != ((void*)0))) ? (void) (0) : __assert_fail ("(Illuminant != ((void*)0))", "./lcms2/src/cmswtpnt.c", 336, __PRETTY_FUNCTION__));
    (((Value != ((void*)0))) ? (void) (0) : __assert_fail ("(Value != ((void*)0))", "./lcms2/src/cmswtpnt.c", 337, __PRETTY_FUNCTION__));

    if (!_cmsAdaptationMatrix(&Bradford, ((void*)0), SourceWhitePt, Illuminant)) return 0;
