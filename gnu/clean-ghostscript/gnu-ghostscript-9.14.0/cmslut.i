# 1 "./lcms2/src/cmslut.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmslut.c" 2
# 27 "./lcms2/src/cmslut.c"
...
cmsBool cmsPipelineCheckAndRetreiveStages(const cmsPipeline* Lut, cmsUInt32Number n, ...)
{
    ...
    if (cmsPipelineStageCount(Lut) != n) return 0;
    ...
    for (i=0; i < n; i++) {
        ...
        Type = (cmsStageSignature)__builtin_va_arg(args, cmsStageSignature);
        if (mpe ->Type != Type) {
    ...
    for (i=0; i < n; i++) {
        ...
        ElemPtr = __builtin_va_arg(args, void**);
        if (ElemPtr != ((void*)0))
            *ElemPtr = mpe;
                    ...
                    const cmsStage *mpe)
{
    ...
    (((mpe != ((void*)0))) ? (void) (0) : __assert_fail ("(mpe != ((void*)0))", "./lcms2/src/cmslut.c", 174, __PRETTY_FUNCTION__));

    Data = (_cmsStageToneCurvesData*) mpe ->Data;
    if (Data == ((void*)0)) return;

    if (Data ->TheCurves == ((void*)0)) return;
...
void CurveSetElemTypeFree(cmsStage* mpe)
{
    ...
    (((mpe != ((void*)0))) ? (void) (0) : __assert_fail ("(mpe != ((void*)0))", "./lcms2/src/cmslut.c", 192, __PRETTY_FUNCTION__));

    Data = (_cmsStageToneCurvesData*) mpe ->Data;
    if (Data == ((void*)0)) return;

    if (Data ->TheCurves != ((void*)0)) {
        for (i=0; i < Data ->nCurves; i++) {
            if (Data ->TheCurves[i] != ((void*)0))
...
cmsStage* cmsStageAllocToneCurves(cmsContext ContextID, cmsUInt32Number nChannels, cmsToneCurve* const Curves[])
{
    ...
    NewMPE = _cmsStageAllocPlaceholder(ContextID, cmsSigCurveSetElemType, nChannels, nChannels,
                                     EvaluateCurves, CurveSetDup, CurveSetElemTypeFree, ((void*)0) );
    if (NewMPE == ((void*)0)) return ((void*)0);
...
cmsStage* _cmsStageAllocIdentityCurves(cmsContext ContextID, int nChannels)
{
    cmsStage* mpe = cmsStageAllocToneCurves(ContextID, nChannels, ((void*)0));

    if (mpe == ((void*)0)) return ((void*)0);
    mpe ->Implements = cmsSigIdentityElemType;
    return mpe;
}
# 311 "./lcms2/src/cmslut.c"
static
...
cmsStage* cmsStageAllocMatrix(cmsContext ContextID, cmsUInt32Number Rows, cmsUInt32Number Cols,
                                     const cmsFloat64Number* Matrix, const cmsFloat64Number* Offset)
{
    ...
    if (n >= (2147483647 *2U +1U) / Cols) return ((void*)0);
    if (n >= (2147483647 *2U +1U) / Rows) return ((void*)0);
    if (n < Rows || n < Cols) return ((void*)0);

    NewMPE = _cmsStageAllocPlaceholder(ContextID, cmsSigMatrixElemType, Cols, Rows,
                                     EvaluateMatrix, MatrixElemDup, MatrixElemTypeFree, ((void*)0) );
    if (NewMPE == ((void*)0)) return ((void*)0);
...
{
    _cmsStageCLutData* Data = (_cmsStageCLutData*) mpe ->Data;
    cmsUInt16Number In16[128], Out16[128];

    (((mpe ->InputChannels <= 128)) ? (void) (0) : __assert_fail ("(mpe ->InputChannels <= 128)", "./lcms2/src/cmslut.c", 456, __PRETTY_FUNCTION__));
    (((mpe ->OutputChannels <= 128)) ? (void) (0) : __assert_fail ("(mpe ->OutputChannels <= 128)", "./lcms2/src/cmslut.c", 457, __PRETTY_FUNCTION__));
...
cmsUInt32Number CubeSize(const cmsUInt32Number Dims[], cmsUInt32Number b)
{
    ...
    (((Dims != ((void*)0))) ? (void) (0) : __assert_fail ("(Dims != ((void*)0))", "./lcms2/src/cmslut.c", 471, __PRETTY_FUNCTION__));
    ...
    for (rv = 1; b > 0; b--) {
        ...
        if (rv > (2147483647 *2U +1U) / dim) return 0;
    }
                                         ...
                                         const cmsUInt16Number* Table)
{
    ...
    (((clutPoints != ((void*)0))) ? (void) (0) : __assert_fail ("(clutPoints != ((void*)0))", "./lcms2/src/cmslut.c", 560, __PRETTY_FUNCTION__));

    if (inputChan > 8) {
        cmsSignalError(ContextID, 2, "Too many input channels (%d channels, max=%d)", inputChan, 8);
        return ((void*)0);
    }

    NewMPE = _cmsStageAllocPlaceholder(ContextID, cmsSigCLutElemType, inputChan, outputChan,
                                     EvaluateCLUTfloatIn16, CLUTElemDup, CLutElemTypeFree, ((void*)0) );
    ...
    NewElem ->Params = _cmsComputeInterpParamsEx(ContextID, clutPoints, inputChan, outputChan, NewElem ->Tab.T, 0x0000);
    if (NewElem ->Params == ((void*)0)) {
        cmsStageFree(NewMPE);
        return ((void*)0);
    }
...
cmsStage* cmsStageAllocCLutFloatGranular(cmsContext ContextID, const cmsUInt32Number clutPoints[], cmsUInt32Number inputChan, cmsUInt32Number outputChan, const cmsFloat32Number* Table)
{
    ...
    (((clutPoints != ((void*)0))) ? (void) (0) : __assert_fail ("(clutPoints != ((void*)0))", "./lcms2/src/cmslut.c", 651, __PRETTY_FUNCTION__));
    ...
    NewMPE = _cmsStageAllocPlaceholder(ContextID, cmsSigCLutElemType, inputChan, outputChan,
                                             EvaluateCLUTfloat, CLUTElemDup, CLutElemTypeFree, ((void*)0));
    if (NewMPE == ((void*)0)) return ((void*)0);
    ...
    NewElem ->Params = _cmsComputeInterpParamsEx(ContextID, clutPoints, inputChan, outputChan, NewElem ->Tab.TFloat, 0x0001);
    if (NewElem ->Params == ((void*)0)) {
        cmsStageFree(NewMPE);
        return ((void*)0);
    }
...
cmsStage* _cmsStageAllocIdentityCLut(cmsContext ContextID, int nChan)
{
    ...
    mpe = cmsStageAllocCLut16bitGranular(ContextID, Dimensions, nChan, nChan, ((void*)0));
    if (mpe == ((void*)0)) return ((void*)0);
...
cmsBool cmsStageSampleCLut16bit(cmsStage* mpe, cmsSAMPLER16 Sampler, void * Cargo, cmsUInt32Number dwFlags)
{
    ...
    cmsUInt16Number In[8 +1], Out[128];
    _cmsStageCLutData* clut;

    if (mpe == ((void*)0)) return 0;
    ...
    if (nOutputs <= 0) return 0;
    if (nInputs > 8) return 0;
    if (nOutputs >= 128) return 0;

    nTotalPoints = CubeSize(nSamples, nInputs);
    if (nTotalPoints == 0) return 0;
...
cmsBool cmsStageSampleCLutFloat(cmsStage* mpe, cmsSAMPLERFLOAT Sampler, void * Cargo, cmsUInt32Number dwFlags)
{
    ...
    int nInputs, nOutputs;
    cmsUInt32Number* nSamples;
    cmsFloat32Number In[8 +1], Out[128];
                                         ...
                                         cmsSAMPLER16 Sampler, void * Cargo)
{
    ...
    cmsUInt16Number In[16];

    if (nInputs >= 16) return 0;
...
cmsInt32Number cmsSliceSpaceFloat(cmsUInt32Number nInputs, const cmsUInt32Number clutPoints[],
                                            cmsSAMPLERFLOAT Sampler, void * Cargo)
{
    int i, t, nTotalPoints, rest;
    cmsFloat32Number In[16];
                     ...
                     const cmsStage *mpe)
{
    cmsCIELab Lab;
    cmsCIEXYZ XYZ;
    const cmsFloat64Number XYZadj = (1.0 + 32767.0/32768.0);
...
cmsStage* _cmsStageAllocLab2XYZ(cmsContext ContextID)
{
    return _cmsStageAllocPlaceholder(ContextID, cmsSigLab2XYZElemType, 3, 3, EvaluateLab2XYZ, ((void*)0), ((void*)0), ((void*)0));
}
# 978 "./lcms2/src/cmslut.c"
cmsStage* _cmsStageAllocLabV2ToV4curves(cmsContext ContextID)
{
    cmsStage* mpe;
    ...
    LabTable[0] = cmsBuildTabulatedToneCurve16(ContextID, 258, ((void*)0));
    LabTable[1] = cmsBuildTabulatedToneCurve16(ContextID, 258, ((void*)0));
    LabTable[2] = cmsBuildTabulatedToneCurve16(ContextID, 258, ((void*)0));

    for (j=0; j < 3; j++) {

        if (LabTable[j] == ((void*)0)) {
...
cmsStage* _cmsStageAllocLabV2ToV4(cmsContext ContextID)
{
    ...
    cmsStage *mpe = cmsStageAllocMatrix(ContextID, 3, 3, V2ToV4, ((void*)0));

    if (mpe == ((void*)0)) return mpe;
    mpe ->Implements = cmsSigLabV2toV4;
    return mpe;
}
...
cmsStage* _cmsStageAllocLabV4ToV2(cmsContext ContextID)
{
    static const cmsFloat64Number V4ToV2[] = { 65280.0/65535.0, 0, 0,
     ...
     cmsStage *mpe = cmsStageAllocMatrix(ContextID, 3, 3, V4ToV2, ((void*)0));
...
cmsStage* _cmsStageNormalizeFromXyzFloat(cmsContext ContextID)
{
    ...
    cmsStage *mpe = cmsStageAllocMatrix(ContextID, 3, 3, a1, ((void*)0));
...
cmsStage* _cmsStageAllocXYZ2Lab(cmsContext ContextID)
{
    return _cmsStageAllocPlaceholder(ContextID, cmsSigXYZ2LabElemType, 3, 3, EvaluateXYZ2Lab, ((void*)0), ((void*)0), ((void*)0));
...
void BlessLUT(cmsPipeline* lut)
{
    ...
    if (lut ->Elements != ((void*)0)) {
        ...
        if (First != ((void*)0))lut ->InputChannels = First ->InputChannels;
        if (Last != ((void*)0)) lut ->OutputChannels = Last ->OutputChannels;
    }
}
...
void _LUTeval16(register const cmsUInt16Number In[], register cmsUInt16Number Out[], register const void* D)
{
    ...
    cmsStage *mpe;
    cmsFloat32Number Storage[2][128];
...
cmsPipeline* cmsPipelineAlloc(cmsContext ContextID, cmsUInt32Number InputChannels, cmsUInt32Number OutputChannels)
{
       ...
       if (InputChannels >= 16 ||
           OutputChannels >= 16) return ((void*)0);
       ...
       NewLUT ->DupDataFn = ((void*)0);
       NewLUT ->FreeDataFn = ((void*)0);
       NewLUT ->Data = NewLUT;
...
cmsContext cmsGetPipelineContextID(const cmsPipeline* lut)
{
    (((lut != ((void*)0))) ? (void) (0) : __assert_fail ("(lut != ((void*)0))", "./lcms2/src/cmslut.c", 1358, __PRETTY_FUNCTION__));
    return lut ->ContextID;
}

cmsUInt32Number cmsPipelineInputChannels(const cmsPipeline* lut)
{
    (((lut != ((void*)0))) ? (void) (0) : __assert_fail ("(lut != ((void*)0))", "./lcms2/src/cmslut.c", 1364, __PRETTY_FUNCTION__));
    return lut ->InputChannels;
}

cmsUInt32Number cmsPipelineOutputChannels(const cmsPipeline* lut)
{
    (((lut != ((void*)0))) ? (void) (0) : __assert_fail ("(lut != ((void*)0))", "./lcms2/src/cmslut.c", 1370, __PRETTY_FUNCTION__));
...
void cmsPipelineEval16(const cmsUInt16Number In[], cmsUInt16Number Out[], const cmsPipeline* lut)
{
    (((lut != ((void*)0))) ? (void) (0) : __assert_fail ("(lut != ((void*)0))", "./lcms2/src/cmslut.c", 1398, __PRETTY_FUNCTION__));
...
void cmsPipelineEvalFloat(const cmsFloat32Number In[], cmsFloat32Number Out[], const cmsPipeline* lut)
{
    (((lut != ((void*)0))) ? (void) (0) : __assert_fail ("(lut != ((void*)0))", "./lcms2/src/cmslut.c", 1406, __PRETTY_FUNCTION__));
...
cmsPipeline* cmsPipelineDup(const cmsPipeline* lut)
{
    cmsPipeline* NewLUT;
    cmsStage *NewMPE, *Anterior = ((void*)0), *mpe;
    cmsBool First = 1;
...
int cmsPipelineInsertStage(cmsPipeline* lut, cmsStageLoc loc, cmsStage* mpe)
{
    cmsStage* Anterior = ((void*)0), *pt;

    if (lut == ((void*)0) || mpe == ((void*)0))
        return 0;
...
cmsBool cmsPipelineCat(cmsPipeline* l1, const cmsPipeline* l2)
{
    ...
    if (l1 ->Elements == ((void*)0) && l2 ->Elements == ((void*)0)) {
...
cmsStage* cmsPipelineGetPtrToLastStage(const cmsPipeline* lut)
{
    cmsStage *mpe, *Anterior = ((void*)0);

    for (mpe = lut ->Elements; mpe != ((void*)0); mpe = mpe ->Next)
        Anterior = mpe;
...
cmsUInt32Number cmsPipelineStageCount(const cmsPipeline* lut)
{
    ...
    for (n=0, mpe = lut ->Elements; mpe != ((void*)0); mpe = mpe ->Next)
            n++;
                                              ...
                                              const cmsPipeline* lut)
{
    ...
    if (lut ->InputChannels != 3 && lut ->InputChannels != 4) return 0;
    if (lut ->OutputChannels != 3) return 0;
    ...
    for (i = 0; i < 30; i++) {
        ...
        for (j = 0; j < 3; j++) {
            ...
            Jacobian.v[0].n[j] = ((fxd[0] - fx[0]) / 0.001f);
            Jacobian.v[1].n[j] = ((fxd[1] - fx[1]) / 0.001f);
            Jacobian.v[2].n[j] = ((fxd[2] - fx[2]) / 0.001f);
        }
