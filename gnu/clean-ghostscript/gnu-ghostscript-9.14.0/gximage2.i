...
# 32 "./base/gximage2.c" 2


static int gx_begin_image2(gx_device *dev, const gs_imager_state *pis, const gs_matrix *pmat, const gs_image_common_t *pim, const gs_int_rect *prect, const gx_drawing_color *pdcolor, const gx_clip_path *pcpath, gs_memory_t *memory, gx_image_enum_common_t **pinfo);
static int gx_image2_source_size(const gs_imager_state *pis, const gs_image_common_t *pic, gs_int_point *psize);


extern const gs_memory_struct_type_t st_gs_image_common; static const gc_ptr_element_t image2_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_image2_t *)0)->DataSource - (char *)((gs_image2_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_image2_t *)0)->UnpaintedPath - (char *)((gs_image2_t *)0) )) } }; static const gc_struct_data_t image2_reloc_ptrs = { (sizeof(image2_enum_ptrs) / sizeof((image2_enum_ptrs)[0])), 0, &st_gs_image_common, image2_enum_ptrs }; static const gs_memory_struct_type_t st_gs_image2 = { sizeof(gs_image2_t), "gs_image2_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &image2_reloc_ptrs };
                ...
                gs_memory_t * mem, gx_image_enum_common_t ** pinfo)
{
    ...
    gs_image_t_init_adjust(&idata.image, gs_currentcolorspace((const gs_state *)pis), ((bool)1));
    ...
    row_size = (((3 * idata.image.Width) > (source_size)) ? (3 * idata.image.Width) : (source_size));
    row = (*(mem)->procs.alloc_bytes)(mem, row_size, "gx_begin_image2");
    if (row == 0)
        return ((-25));
    if (pixel_copy) {
        ...
        if ( pcpath == ((void*)0) ||
             gx_cpath_includes_rectangle(pcpath,
                                     ((fixed)(idata.bbox.p.x)<<8),
                                     ((fixed)(idata.bbox.p.y)<<8),
                                     ((fixed)(idata.bbox.q.x)<<8),
                                     ((fixed)(idata.bbox.q.y)<<8)) ) {
            gs_matrix mat;
            ...
            direct_copy =
                ((((&dmat)->xy) == 0.0 && ((&dmat)->yx) == 0.0) || (((&dmat)->xx) == 0.0 && ((&dmat)->yy) == 0.0)) &&

                mat.xx == dmat.xx && mat.xy == dmat.xy && mat.yx == dmat.yx && mat.yy == dmat.yy;
...
# 203 "./base/gximage2.c"
        {
            ...
            (*((sdev)->procs.map_rgb_alpha_color))
            (sdev, (gx_color_value) 0, (gx_color_value) 0,
             (gx_color_value) 0, (gx_color_value) 0);

            has_alpha =
                trans_black != (*((sdev)->procs.map_rgb_alpha_color))
                (sdev, (gx_color_value) 0, (gx_color_value) 0,
                 (gx_color_value) 0, ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1))) &&
                trans_black != (*((sdev)->procs.map_rgb_alpha_color))
                (sdev, ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)), ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)),
                 ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)), ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)));
        }
    }
    idata.image.Alpha =
    ...
    if (!direct_copy)
        code = (*((dev)->procs.begin_typed_image))
            (dev, pis, pmat, (const gs_image_common_t *)&idata.image, ((void*)0),
    ...
    if (code >= 0) {
        ...
        for (y = 0; code >= 0 && y < idata.image.Height; ++y) {
            ...
            if (pixel_copy) {
                ...
                code = (*((sdev)->procs.get_bits_rectangle))
            ...
            if (num_unread > 0 && pim->UnpaintedPath) {
                ...
                for (i = 0; code >= 0 && i < num_unread; ++i)
                    code = gx_path_add_rectangle(pim->UnpaintedPath,
                                                 ((fixed)(unread[i].p.x)<<8),
                                                 ((fixed)(unread[i].p.y)<<8),
                                                 ((fixed)(unread[i].q.x)<<8),
                                                 ((fixed)(unread[i].q.y)<<8));
                ((dev->memory)->procs.free_object(dev->memory, unread, "UnpaintedPath unread"));
            }
        ...
        if (!direct_copy) {
            if (code >= 0)
                code = gx_image_end(info, ((bool)1));
            else
                ((void)(gx_image_end(info, ((bool)0))));
        }
    }
    ((mem)->procs.free_object(mem, row, "gx_begin_image2"));
