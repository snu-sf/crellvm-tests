...
zcurrenthalftone(i_ctx_t *i_ctx_p)
{
    ...
    gs_currenthalftone((i_ctx_p->pgs), &ht);
    switch (ht.type) {
        case ht_type_screen:
            ...
            ((op - 3)->value.realval = (ht.params.screen.frequency), ((op - 3)->tas.type_attrs = ((t_real) << 8) + (0)) );
            ((op - 2)->value.realval = (ht.params.screen.angle), ((op - 2)->tas.type_attrs = ((t_real) << 8) + (0)) );
            op[-1] = ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->screen_procs.gray;
            ((op)->value.intval = (1), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
            break;
        case ht_type_colorscreen:
            do { if ( (op += (13)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (13); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
            {
                os_ptr opc = op - 12;
                gs_screen_halftone *pht =
                    &ht.params.colorscreen.screens.colored.red;

                ((opc)->value.realval = (pht->frequency), ((opc)->tas.type_attrs = ((t_real) << 8) + (0)) );
                ((opc + 1)->value.realval = (pht->angle), ((opc + 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                opc[2] = ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->screen_procs.red;

                opc = op - 9;
                pht = &ht.params.colorscreen.screens.colored.green;
                ((opc)->value.realval = (pht->frequency), ((opc)->tas.type_attrs = ((t_real) << 8) + (0)) );
                ((opc + 1)->value.realval = (pht->angle), ((opc + 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                opc[2] = ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->screen_procs.green;

                opc = op - 6;
                pht = &ht.params.colorscreen.screens.colored.blue;
                ((opc)->value.realval = (pht->frequency), ((opc)->tas.type_attrs = ((t_real) << 8) + (0)) );
                ((opc + 1)->value.realval = (pht->angle), ((opc + 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                opc[2] = ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->screen_procs.blue;

                opc = op - 3;
                pht = &ht.params.colorscreen.screens.colored.gray;
                ((opc)->value.realval = (pht->frequency), ((opc)->tas.type_attrs = ((t_real) << 8) + (0)) );
                ((opc + 1)->value.realval = (pht->angle), ((opc + 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
                opc[2] = ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->screen_procs.gray;
            }
            ((op)->value.intval = (2), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
            break;
        default:
            ...
            op[-1] = ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->halftone;
...
zcurrentscreenlevels(i_ctx_t *i_ctx_p)
{
    ...
    ((op)->value.intval = (gs_currentscreenlevels((i_ctx_p->pgs))), ((op)->tas.type_attrs = ((t_integer) << 8) + (0)) );
    return 0;
}
# 122 "./psi/zht.c"
...
zsetscreen(i_ctx_t *i_ctx_p)
{
    ...
    gs_memory_t *mem;
    int space_index = ((int)(avm_space)(((op)->tas.type_attrs) & (((1 << 2) - 1) << 2)) >> 2);

    if (code < 0)
        return code;
    mem = (gs_memory_t *)(&(i_ctx_p->memory))->spaces.memories.indexed[space_index];




    code = gs_screen_order_init_memory(&order, (i_ctx_p->pgs), &screen,
                  ...
                  int (*finish_proc)(i_ctx_t *), int space_index)
{
    ...
    gs_memory_t * mem = (gs_memory_t *)(&(i_ctx_p->memory))->spaces.memories.indexed[space_index];
    int code;

    if ( (((i_ctx_p->exec_stack).stack).p) > (((i_ctx_p->exec_stack).stack).top) - (4 + 1) ) { int es_code_ = ref_stack_extend(&((i_ctx_p->exec_stack).stack), 4 + 1); if ( es_code_ < 0 ) return es_code_; };
    penum = gs_screen_enum_alloc(mem, "setscreen");
    if (penum == 0)
        return ((-25));
    (((((i_ctx_p->exec_stack).stack).p) + 4)->value.pstruct = ((obj_header_t *)(penum)), (((((i_ctx_p->exec_stack).stack).p) + 4)->tas.type_attrs = ((t_struct) << 8) + (space_index << 2)) );
    code = gs_screen_enum_init_memory(penum, porder, (i_ctx_p->pgs), psp, mem);
    if (code < 0) {
        screen_cleanup(i_ctx_p);
        return code;
    }

    (((((i_ctx_p->exec_stack).stack).p) + 1)->value.opproc = (screen_cleanup), (((((i_ctx_p->exec_stack).stack).p) + 1)->tas.type_attrs = ((t_null) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p) + 1)->tas.rsize = (0)));
    ...
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (screen_sample), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
...
{
    os_ptr op = (((i_ctx_p->op_stack).stack).p);
    gs_screen_enum *penum = ((gs_screen_enum *)(((((i_ctx_p->exec_stack).stack).p))->value.pstruct));
    gs_point pt;
    ...
    do { if ( (op += (2)) > (((i_ctx_p->op_stack).stack).top) ) { ((i_ctx_p->op_stack).stack).requested = (2); return ((-16)); } else (((i_ctx_p->op_stack).stack).p) = op; } while (0);
    ((op - 1)->value.realval = (pt.x), ((op - 1)->tas.type_attrs = ((t_real) << 8) + (0)) );
    ((op)->value.realval = (pt.y), ((op)->tas.type_attrs = ((t_real) << 8) + (0)) );
    proc = (((i_ctx_p->exec_stack).stack).p)[-1];
    (++(((i_ctx_p->exec_stack).stack).p), (((((i_ctx_p->exec_stack).stack).p))->value.opproc = (set_screen_continue), (((((i_ctx_p->exec_stack).stack).p))->tas.type_attrs = ((t_operator) << 8) + (0x80)), (((((i_ctx_p->exec_stack).stack).p))->tas.rsize = (0))));
...
set_screen_continue(i_ctx_t *i_ctx_p)
{
    ...
    if (code < 0)
        return code;
    code = gs_screen_next(((gs_screen_enum *)(((((i_ctx_p->exec_stack).stack).p))->value.pstruct)), value);
    if (code < 0)
        return code;
...
{
    gs_screen_install(((gs_screen_enum *)(((((i_ctx_p->exec_stack).stack).p))->value.pstruct)));
    ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->screen_procs.red = (((i_ctx_p->exec_stack).stack).p)[-1];
    ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->screen_procs.green = (((i_ctx_p->exec_stack).stack).p)[-1];
    ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->screen_procs.blue = (((i_ctx_p->exec_stack).stack).p)[-1];
    ((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->screen_procs.gray = (((i_ctx_p->exec_stack).stack).p)[-1];
    (((&((int_gstate *)gs_state_client_data((i_ctx_p->pgs)))->halftone)->tas.type_attrs = ((t_null) << 8) + (0)) );
    return 0;
}
...
{
    gs_screen_enum *penum = ((gs_screen_enum *)(((((i_ctx_p->exec_stack).stack).p) + 4)->value.pstruct));

    ((penum->halftone.rc.memory)->procs.free_object(penum->halftone.rc.memory, penum, "screen_cleanup"));
    return 0;
}
