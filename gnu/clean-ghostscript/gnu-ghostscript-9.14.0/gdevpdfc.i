# 1 "./devices/vector/gdevpdfc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpdfc.c" 2
# 18 "./devices/vector/gdevpdfc.c"
# 1 "./base/math_.h" 1
# 23 "./base/math_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 19 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/memory_.h" 1
# 54 "./base/memory_.h"
...
# 55 "./base/memory_.h" 2
# 20 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
...
# 21 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/gscspace.h" 1
# 23 "./base/gscspace.h"
# 1 "./base/gsiparam.h" 1
# 22 "./base/gsiparam.h"
...
# 22 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/gscdevn.h" 1
# 30 "./base/gscdevn.h"
int
...
# 23 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/gscie.h" 1
# 27 "./base/gscie.h"
# 1 "./base/gxctable.h" 1
# 22 "./base/gxctable.h"
...
# 24 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/gscindex.h" 1
# 48 "./base/gscindex.h"
...
int gs_cspace_indexed_lookup_frac(const gs_color_space *pcs, float index_float,
                        frac *output);
# 25 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/gscsepr.h" 1
# 43 "./base/gscsepr.h"
...
# 26 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/stream.h" 1
# 23 "./base/stream.h"
# 1 "./base/scommon.h" 1
# 25 "./base/scommon.h"
...
int file_close_finish(stream *);
int file_close_disable(stream *);
# 27 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/gsicc.h" 1
# 24 "./base/gsicc.h"
# 1 "./base/gxcspace.h" 1
# 25 "./base/gxcspace.h"
...
# 28 "./devices/vector/gdevpdfc.c" 2
...
int alloc_function_array(uint count, gs_function_t *** pFunctions,
                         gs_memory_t *mem);
# 30 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/gsfunc3.h" 1
# 23 "./base/gsfunc3.h"
# 1 "./base/gsdsrc.h" 1
# 22 "./base/gsdsrc.h"
...
void gs_function_AdOt_free_params(gs_function_AdOt_params_t * params,
                                  gs_memory_t * mem);
# 31 "./devices/vector/gdevpdfc.c" 2
# 1 "./base/gsfunc0.h" 1
# 31 "./base/gsfunc0.h"
...
void gs_function_Sd_free_params(gs_function_Sd_params_t * params,
                                gs_memory_t * mem);
# 32 "./devices/vector/gdevpdfc.c" 2
...
# 33 "./devices/vector/gdevpdfc.c" 2
...
# 34 "./devices/vector/gdevpdfc.c" 2
# 1 "./devices/vector/gdevpdfc.h" 1
# 22 "./devices/vector/gdevpdfc.h"
...
# 35 "./devices/vector/gdevpdfc.c" 2
...
# 36 "./devices/vector/gdevpdfc.c" 2
...
# 38 "./devices/vector/gdevpdfc.c" 2
...
# 40 "./devices/vector/gdevpdfc.c" 2
...
# 42 "./devices/vector/gdevpdfc.c" 2
...
# 43 "./devices/vector/gdevpdfc.c" 2
# 69 "./devices/vector/gdevpdfc.c"
static const gc_ptr_element_t pdf_color_space_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((pdf_color_space_t *)0)->ranges - (char *)((pdf_color_space_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((pdf_color_space_t *)0)->serialized - (char *)((pdf_color_space_t *)0) )) } }; static const gc_struct_data_t pdf_color_space_reloc_ptrs = { (sizeof(pdf_color_space_enum_ptrs) / sizeof((pdf_color_space_enum_ptrs)[0])), 0, &st_pdf_resource, pdf_color_space_enum_ptrs }; const gs_memory_struct_type_t st_pdf_color_space = { sizeof(pdf_color_space_t), "pdf_color_space_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &pdf_color_space_reloc_ptrs };
# 96 "./devices/vector/gdevpdfc.c"
static bool
                           ...
                           float *pexpt)
{
    ...
    if (va == 0 || (va > 0) != (k > 0))
        return ((bool)0);
    p = log(va / k) / log(((((1 << 9) / 3)) / (double)((1 << 9) - 1)));
    if (fabs(vb - k * pow(((((1 << 9) * 2 / 3)) / (double)((1 << 9) - 1)), p)) >= 0.001)
        return ((bool)0);
    *pexpt = p;
    return ((bool)1);
}
...
cie_scalar_cache_is_exponential(const gx_cie_scalar_cache * pc, float *pexpt)
{
    return cie_values_are_exponential(pc->floats.values[0],
                                      pc->floats.values[((1 << 9) / 3)],
                                      pc->floats.values[((1 << 9) * 2 / 3)],
                                      pc->floats.values[((1 << 9) - 1)],
                                      pexpt);
}
...
cie_vector_cache_is_exponential(const gx_cie_vector_cache * pc, float *pexpt)
{
    return cie_values_are_exponential(pc->vecs.values[0].u,
                                      pc->vecs.values[((1 << 9) / 3)].u,
                                      pc->vecs.values[((1 << 9) * 2 / 3)].u,
                                      pc->vecs.values[((1 << 9) - 1)].u,
                                      pexpt);
}
# 150 "./devices/vector/gdevpdfc.c"
static cie_cache_one_step_t
cie_cached_abc_is_one_step(const gs_cie_abc *pcie, const gs_matrix3 **ppmat)
{


    if ((((&(pcie->common.caches.DecodeLMN)[0])->floats.params.is_identity) && ((&(pcie->common.caches.DecodeLMN)[1])->floats.params.is_identity) && ((&(pcie->common.caches.DecodeLMN)[2])->floats.params.is_identity))) {
    ...
    if ((((&(pcie->caches.DecodeABC.caches)[0])->floats.params.is_identity) && ((&(pcie->caches.DecodeABC.caches)[1])->floats.params.is_identity) && ((&(pcie->caches.DecodeABC.caches)[2])->floats.params.is_identity))) {
        if (pcie->MatrixABC.is_identity) {
            *ppmat = &pcie->common.MatrixLMN;
            return ONE_STEP_LMN;
        }
...
cie_scalar_cache_is_lab_lmn(const gs_cie_abc *pcie, int i)
{
    ...
    return (fabs((pcie->common.caches.DecodeLMN[0].floats.values[i]) - g * (pcie->common.points.WhitePoint.u)) < 0.001 &&
            fabs((pcie->common.caches.DecodeLMN[1].floats.values[i]) - g * (pcie->common.points.WhitePoint.v)) < 0.001 &&
            fabs((pcie->common.caches.DecodeLMN[2].floats.values[i]) - g * (pcie->common.points.WhitePoint.w)) < 0.001
            );
...
cie_vector_cache_is_lab_abc(const gx_cie_vector_cache3_t *pvc, int i)
{
    ...
    return (fabs((pc3[0].vecs.values[i].u) -
                 (l + 16) / 116) < 0.001 &&
            fabs((pc3[1].vecs.values[i].u) -
                 a / 500) < 0.001 &&
            fabs((pc3[2].vecs.values[i].w) -
                 b / -200) < 0.001
            );
}
                           ...
                           const gs_vector3 *pvec)
{
    ...
    if (code < 0) {
        cos_free(((cos_object_t *)&((pca)->cos_procs)), "cos_array_from_vector3");
        return code;
    }
    return cos_dict_put_c_key_object(pcd, key, ((cos_object_t *)&((pca)->cos_procs)));
}
                     ...
                     const gs_cie_common *pciec)
{
    ...
    return cos_array_add_object(pca, ((cos_object_t *)&((pcd)->cos_procs)));
}
...
int pdf_delete_sampled_base_space_function(gx_device_pdf *pdev, gs_function_t *pfn)
{
    ...
    ((pdev->memory)->procs.free_object(pdev->memory, (void *)params->Domain, "pdf_delete_function"));
    ((pdev->memory)->procs.free_object(pdev->memory, (void *)params->Range, "pdf_delete_function"));
    (*(pdev->memory)->procs.free_string)(pdev->memory, (void *)params->DataSource.data.str.data, params->DataSource.data.str.size, "pdf_dselete_function");
    ((pdev->memory)->procs.free_object(pdev->memory, (void *)pfn, "pdf_delete_function"));
    return 0;
}
...
int pdf_delete_base_space_function(gx_device_pdf *pdev, gs_function_t *pfn)
{
    ...
    ((pdev->memory)->procs.free_object(pdev->memory, (void *)params->Domain, "pdf_delete_function"));
    ((pdev->memory)->procs.free_object(pdev->memory, (void *)params->Range, "pdf_delete_function"));
    ((pdev->memory)->procs.free_object(pdev->memory, (void *)params->C0, "pdf_delete_function"));
    ((pdev->memory)->procs.free_object(pdev->memory, (void *)params->C1, "pdf_delete_function"));
    ((pdev->memory)->procs.free_object(pdev->memory, (void *)pfn, "pdf_delete_function"));
    return 0;
}
                                        ...
                                        int nSrcComp, int nDstComp, byte *data)
{
    ...
    str.data = (*(pdev->memory)->procs.alloc_string)(pdev->memory, nDstComp * nSrcComp * 2 * sizeof(float), "pdf_DeviceN");
    ...
    ptr1 = (*(pdev->memory)->procs.alloc_byte_array)(pdev->memory, nSrcComp, sizeof(int), "pdf_make_function(Domain)");
    ...
    ptr1 = (float *)
        (*(pdev->memory)->procs.alloc_byte_array)(pdev->memory, 2 * nSrcComp, sizeof(float), "pdf_make_function(Domain)");
    if (ptr1 == 0) {
        return ((-25));
    }
    ptr2 = (float *)
        (*(pdev->memory)->procs.alloc_byte_array)(pdev->memory, 2 * nDstComp, sizeof(float), "pdf_make_function(Range)");
    if (ptr2 == 0) {
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)ptr1, "pdf_make_function(Range)"));
        return ((-25));
    }
    for (i=0;i<nSrcComp;i++) {
        ((float *)ptr1)[i*2] = 0.0f;
    ...
    params.Domain = ptr1;
    params.Range = ptr2;
    params.Encode = params.Decode = ((void*)0);
    ((&params.DataSource)->type = data_source_type_string, (&params.DataSource)->data.str = str, (&params.DataSource)->access = data_source_access_string);
                                        ...
                                        int ncomp, float *data_low, float *data_high)
{
    ...
    ptr1 = (float *)
        (*(pdev->memory)->procs.alloc_byte_array)(pdev->memory, 2, sizeof(float), "pdf_make_function(Domain)");
    if (ptr1 == 0) {
        return ((-25));
    }
    ptr2 = (float *)
        (*(pdev->memory)->procs.alloc_byte_array)(pdev->memory, 2 * ncomp, sizeof(float), "pdf_make_function(Range)");
    if (ptr2 == 0) {
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)ptr1, "pdf_make_function(Range)"));
        return ((-25));
    }
    ...
    ptr1 = (float *)(*(pdev->memory)->procs.alloc_byte_array)(pdev->memory, ncomp, sizeof(float), "pdf_make_function(C0)");
    if (ptr1 == 0) {
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)params.Domain, "pdf_make_function(C0)"));
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)params.Range, "pdf_make_function(C0)"));
        return ((-25));
    }
    ptr2 = (float *)(*(pdev->memory)->procs.alloc_byte_array)(pdev->memory, ncomp, sizeof(float), "pdf_make_function(C1)");
    if (ptr2 == 0) {
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)params.Domain, "pdf_make_function(C1)"));
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)params.Range, "pdf_make_function(C1)"));
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)ptr1, "pdf_make_function(C1)"));
        return ((-25));
    }
    ...
    if (code < 0) {
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)params.Domain, "pdf_make_function"));
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)params.Range, "pdf_make_function"));
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)params.C0, "pdf_make_function"));
        ((pdev->memory)->procs.free_object(pdev->memory, (void *)params.C1, "pdf_make_function"));
    }
    return code;
}
...
# 558 "./devices/vector/gdevpdfc.c"
        gs_function_t *new_pfn = 0;
        float in[1] = {0.0f};
        float out_low[4];
        float out_high[4];

        code = ((pfn)->head.procs.evaluate)(pfn, in, out_low);
        if (code < 0)
            return code;
        pdf_SepRGB_ConvertToCMYK((float *)&out_low, (float *)&out_low);

        in[0] = 1.0f;
        code = ((pfn)->head.procs.evaluate)(pfn, in, out_high);
        if (code < 0)
            return code;
    ...
    if ((code = cos_array_add(pca, cos_c_string_value(&v, csname))) < 0 ||
        ...
        (code = pdf_color_space_named(pdev, &v, &ranges, alt_space, pcsn, ((bool)0), ((void*)0), 0, ((bool)0))) < 0 ||
        (code = cos_array_add(pca, &v)) < 0 ||
        (code = pdf_function_scaled(pdev, pfn, ranges, &v)) < 0 ||
        (code = cos_array_add(pca, &v)) < 0 ||
        (v_attributes != ((void*)0) ? code = cos_array_add(pca, v_attributes) : 0) < 0
        )
        return code;
    return 0;
}
                        ...
                        const gs_color_space *pcs, cos_array_t *pca, cos_value_t *cos_base)
{
    ...
    table = (*(mem)->procs.alloc_string)(mem, string_size, "pdf_color_space(table)");
    palette = (*(mem)->procs.alloc_string)(mem, table_size, "pdf_color_space(palette)");
    if (table == 0 || palette == 0) {
        (*(mem)->procs.free_string)(mem, palette, table_size, "pdf_color_space(palette)");

        (*(mem)->procs.free_string)(mem, table, string_size, "pdf_color_space(table)");
    ...
    s_init(&es, mem);
    s_init_state((stream_state *)&st, &s_PSSE_template, ((void*)0));
    s_init_filter(&es, (stream_state *)&st, buf, sizeof(buf), &s);
    (!((&s)->cursor.w.ptr >= (&s)->cursor.w.limit) ? (++((&s)->cursor.w.ptr), *(&s)->cursor.w.ptr=('('), 0) : spputc((&s),('(')));
    if (pcs->params.indexed.use_proc) {
        ...
        for (j = 0; j < num_components; ++j)
            cmin.paint.values[j] = (float)(-1L << ((1 << 3) * 8 - 1)),
                cmax.paint.values[j] = (float)(~(-1L << ((1 << 3) * 8 - 1)));
    ...
    table = (*(mem)->procs.resize_string)(mem, table, string_size, string_used, "pdf_color_space(table)");
# 771 "./devices/vector/gdevpdfc.c"
    if (pdev->UseOldColor || cos_base == ((void*)0)) {
    if ((code = pdf_color_space_named(pdev, pvalue, ((void*)0), base_space,
                                &pdf_color_space_names, ((bool)0), ((void*)0), 0, ((bool)0))) < 0 ||
                ...
                bool by_name, const byte *res_name, int name_length, bool keepICC)
{
    ...
    byte *serialized = ((void*)0), serialized0[100];
...
# 920 "./devices/vector/gdevpdfc.c"
    ...
    case gs_color_space_index_ICC:
        ...
        if (pcs->cmm_icc_profile_data == ((void*)0) ||
            ...
            return pdf_color_space_named( pdev, pvalue, ppranges,
                                    pcs->base_space,
                                    pcsn, by_name, ((void*)0), 0, keepICC);
            } else {
                switch( (*(pcs)->type->num_components)(pcs) ) {
                    case 1:
                        cos_c_string_value(pvalue, pcsn->DeviceGray);
                        return 0;
                    case 3:
    ...
    if (pres == ((void*)0)) {
        ...
        if (serialized_size <= sizeof(serialized0))
            ...
            serialized = (*(pdev->v_memory)->procs.alloc_bytes)(pdev->v_memory, serialized_size, "pdf_color_space");
        ...
        if (pres != ((void*)0)) {
            if (serialized != serialized0)
                ((pdev->v_memory)->procs.free_object(pdev->v_memory, serialized, "pdf_color_space"));
            serialized = ((void*)0);
        }
    }
    if (pres) {
        ...
        if (!pcie->common.MatrixLMN.is_identity) {
            if (!pdev->UseOldColor && !pdev->ForOPDFRead) {
                ...
                code = pdf_convert_cie_space(pdev, pca, pcs, "GRAY", pciec,
                                         &pcie->RangeA, ONE_STEP_NOT, ((void*)0),
                                         &ranges);
            }
            break;
        }
        if (unitary && identityA &&
            ((&pcie->caches.DecodeA)->floats.params.is_identity) &&
            (cie_scalar_cache_is_exponential(&(pcie->common.caches.DecodeLMN)[0], &(expts).u) && cie_scalar_cache_is_exponential(&(pcie->common.caches.DecodeLMN)[1], &(expts).v) && cie_scalar_cache_is_exponential(&(pcie->common.caches.DecodeLMN)[2], &(expts).w)) &&
            expts.v == expts.u && expts.w == expts.u
            ) {
            do { } while (0);
        } else if (unitary && identityA &&
                   (((&(pcie->common.caches.DecodeLMN)[0])->floats.params.is_identity) && ((&(pcie->common.caches.DecodeLMN)[1])->floats.params.is_identity) && ((&(pcie->common.caches.DecodeLMN)[2])->floats.params.is_identity)) &&
    ...
    case gs_color_space_index_CIEABC: {
        ...
        if (unitary) {
            switch (one_step) {
            case ONE_STEP_ABC:
                if ((cie_vector_cache_is_exponential(&(pcie->caches.DecodeABC.caches)[0], &(expts).u) && cie_vector_cache_is_exponential(&(pcie->caches.DecodeABC.caches)[1], &(expts).v) && cie_vector_cache_is_exponential(&(pcie->caches.DecodeABC.caches)[2], &(expts).w)))
                    goto calrgb;
                break;
            case ONE_STEP_LMN:
                if ((cie_scalar_cache_is_exponential(&(pcie->common.caches.DecodeLMN)[0], &(expts).u) && cie_scalar_cache_is_exponential(&(pcie->common.caches.DecodeLMN)[1], &(expts).v) && cie_scalar_cache_is_exponential(&(pcie->common.caches.DecodeLMN)[2], &(expts).w)))
                    goto calrgb;
            default:
                break;
            }
        ...
        if (!pmat->is_identity) {
            ...
            if ((code = cos_array_add_vector3(pcma, &pmat->cu)) < 0 ||
                ...
                (code = cos_dict_put(pcd, (const byte *)"/Matrix", 7,
                                     cos_object_value(&v, ((cos_object_t *)&((pcma)->cos_procs))))) < 0
                )
                return code;
        }
    }
    ...
    case gs_color_space_index_Indexed:
        code = pdf_indexed_color_space(pdev, pvalue, pcs, pca, ((void*)0));
        break;
            ...
            return ((-15));
        {
            ...
            if (pcs->params.device_n.colorants != ((void*)0)) {
                ...
                for (csa = pcs->params.device_n.colorants; csa != ((void*)0); csa = csa->next) {
                    ...
                    if (code < 0)
                        return code;
                    code = pdf_color_space_named(pdev, &v_separation, ((void*)0), csa->cspace, pcsn, ((bool)0), ((void*)0), 0, keepICC);
                    if (code < 0)
                        return code;
            ...
            return ((-15));
        {
            ...
            if ((code = pcs->params.separation.get_colorname_string(
                ...
                (code = pdf_separation_color_space(pdev, pca, "/Separation", &v,
                                            pcs->base_space,
                                            pfn, &pdf_color_space_names, ((void*)0))) < 0)
                return code;
        }
        break;
...

    {
        ...
        if (res_name != ((void*)0)) {
            int l = (((name_length) < (sizeof(pres->rname) - 1)) ? (name_length) : (sizeof(pres->rname) - 1));
        ...
        if (ranges) {
            ...
            gs_range_t *copy_ranges = (gs_range_t *)
                (*(pdev->v_memory)->procs.alloc_byte_array)(pdev->v_memory, num_comp, sizeof(gs_range_t), "pdf_color_space");
...
int free_color_space(gx_device_pdf *pdev, pdf_resource_t *pres)
{
    ...
    if (ppcs->serialized)
        ((pdev->v_memory)->procs.free_object(pdev->v_memory, ppcs->serialized, "free serialized colour space"));
    if (pres->object) {
        cos_release(pres->object, "release ColorSpace object");
        ((pdev->v_memory)->procs.free_object(pdev->v_memory, pres->object, "free ColorSpace object"));
        pres->object = 0;
    }
    return 0;
}
                  ...
                  pdf_resource_t **ppres, const char *cs_name)
{
    ...
    if (!*ppres) {
        int code = pdf_begin_resource_body(pdev, resourceColorSpace, 0L,
                                           ppres);
                ...
                const gs_color_space *pcs, cos_value_t *pvalue)
{
    ...
    return pdf_color_space_named(pdev, pvalue, ((void*)0), pcs, &pdf_color_space_names, ((bool)1), ((void*)0), 0, ((bool)0));
}
