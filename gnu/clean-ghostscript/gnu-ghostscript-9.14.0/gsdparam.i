...
# 55 "./base/memory_.h" 2
# 18 "./base/gsdparam.c" 2
# 1 "./base/string_.h" 1
# 19 "./base/gsdparam.c" 2
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 44 "./base/stdio_.h"
                           ...
                           bool is_hardware)
{
    ...
    if ( ((dev)->procs.get_params) == 0 ) ((dev)->procs.get_params = (gx_default_get_params));
    if ( ((dev)->procs.get_page_device) == 0 ) ((dev)->procs.get_page_device = (gx_default_get_page_device));
    if ( ((dev)->procs.get_alpha_bits) == 0 ) ((dev)->procs.get_alpha_bits = (gx_default_get_alpha_bits));
    code = (is_hardware ?
            (*((dev)->procs.get_hardware_params)) (dev, plist) :
            (*((dev)->procs.get_params)) (dev, plist));
    if (dev != orig_dev)
...
gx_default_get_params(gx_device * dev, gs_param_list * plist)
{
    ...
    bool seprs = ((bool)0);
    gs_param_string dns, pcms, profile_array[4];
    gs_param_string proof_profile, link_profile, icc_colorants;
    gsicc_rendering_intents_t profile_intents[4];
    gsicc_blackptcomp_t blackptcomps[4];
    gsicc_blackpreserve_t blackpreserve[4];
    bool devicegraytok = ((bool)1);
    bool graydetection = ((bool)0);
    bool usefastcolor = ((bool)0);
    bool sim_overprint = ((bool)1);
    bool prebandthreshold = ((bool)1);
    int k;
    ...
    ((dns).data = (const byte *)(dev->dname), (dns).size = strlen((const char *)(dns).data), (dns).persistent = ((bool)1));
    {
        const char *cms = ((dev)->color_info.cm_name);



        if ((cms != ((void*)0)) && (*cms != '\0'))
            ((pcms).data = (const byte *)(cms), (pcms).size = strlen((const char *)(pcms).data), (pcms).persistent = ((bool)1));
        else
            pcms.data = 0;
    }

    (hwra.data = dev->HWResolution, hwra.size = 2, hwra.persistent = ((bool)0));;
    (msa.data = dev->MediaSize, msa.size = 2, msa.persistent = ((bool)0));;
    (ibba.data = dev->ImagingBBox, ibba.size = 4, ibba.persistent = ((bool)0));;
    (ma.data = dev->Margins, ma.size = 2, ma.persistent = ((bool)0));;
    (scna.data = ((void*)0), scna.size = 0, scna.persistent = ((bool)0));;


    HWSize[0] = dev->width;
    HWSize[1] = dev->height;
    (hwsa.data = HWSize, hwsa.size = 2, hwsa.persistent = ((bool)0));;
    (hwma.data = dev->HWMargins, hwma.size = 4, hwma.persistent = ((bool)0));;
    (mhwra.data = dev->MarginsHWResolution, mhwra.size = 2, mhwra.persistent = ((bool)0));;
    ...
    if (dev->procs.get_profile != ((void*)0)) {
        ...
        if (dev_profile == ((void*)0)) {
            code = gsicc_init_device_profile_struct(dev, ((void*)0), 0);
            code = ((dev)->procs.get_profile)(dev, &dev_profile);
        }
        ...
        for (k = 0; k < 4; k++) {
            if (dev_profile->device_profile[k] == ((void*)0)
                || dev_profile->device_profile[k]->name == ((void*)0)) {
                ((profile_array[k]).data = (const byte *)(null_str), (profile_array[k]).size = strlen((const char *)(profile_array[k]).data), (profile_array[k]).persistent = ((bool)1));
                profile_intents[k] = gsRINOTSPECIFIED;
                blackptcomps[k] = gsBPNOTSPECIFIED;
                blackpreserve[k] = gsBKPRESNOTSPECIFIED;
            } else {
                ((profile_array[k]).data = (const byte *)(dev_profile->device_profile[k]->name), (profile_array[k]).size = strlen((const char *)(profile_array[k]).data), (profile_array[k]).persistent = ((bool)1));
        ...
        if (dev_profile->proof_profile == ((void*)0)) {
            ((proof_profile).data = (const byte *)(null_str), (proof_profile).size = strlen((const char *)(proof_profile).data), (proof_profile).persistent = ((bool)1));
        } else {
            ((proof_profile).data = (const byte *)(dev_profile->proof_profile->name), (proof_profile).size = strlen((const char *)(proof_profile).data), (proof_profile).persistent = ((bool)1));

        }
        if (dev_profile->link_profile == ((void*)0)) {
            ((link_profile).data = (const byte *)(null_str), (link_profile).size = strlen((const char *)(link_profile).data), (link_profile).persistent = ((bool)1));
        } else {
            ((link_profile).data = (const byte *)(dev_profile->link_profile->name), (link_profile).size = strlen((const char *)(link_profile).data), (link_profile).persistent = ((bool)1));
        ...
        if (dev_profile->spotnames == ((void*)0)) {
            ((icc_colorants).data = (const byte *)(null_str), (icc_colorants).size = strlen((const char *)(icc_colorants).data), (icc_colorants).persistent = ((bool)1));
        } else {
            char *colorant_names;

            colorant_names =
                gsicc_get_dev_icccolorants(dev_profile);
            if (colorant_names != ((void*)0)) {
                ((icc_colorants).data = (const byte *)(colorant_names), (icc_colorants).size = strlen((const char *)(icc_colorants).data), (icc_colorants).persistent = ((bool)1));
            } else {
                ((icc_colorants).data = (const byte *)(null_str), (icc_colorants).size = strlen((const char *)(icc_colorants).data), (icc_colorants).persistent = ((bool)1));
            }
        }
    ...
    if (
        ...
        (code = (dev->NumCopies_set < 0 ||
                 (*((dev)->procs.get_page_device))(dev) == 0 ? 0:
                 dev->NumCopies_set ?
    ...
    if (dev->LeadingEdge & (1 << 2)) {
        int leadingedge = dev->LeadingEdge & 3;
    ...
    if ((*(plist)->procs->requested)(plist, "HWColorMap")) {
        byte palette[3 << 8];
...
param_HWColorMap(gx_device * dev, byte * palette )
{
    ...
    if (depth <= 8 && colors <= 3) {
        ...
        if ( ((dev)->procs.map_color_rgb) == 0 ) ((dev)->procs.map_color_rgb = (gx_default_w_b_map_color_rgb));
        for (i = 0; (i >> depth) == 0; i++) {
            int j;

            if ((*((dev)->procs.map_color_rgb)) (dev, i, rgb) < 0)
                return ((bool)0);
            for (j = 0; j < colors; j++)
                *p++ = ((gx_color_value)((((unsigned int)rgb[j])*0xFF01 + 0x800000)>>24));
        }
        return ((bool)1);
    }
    return ((bool)0);
...
{
    pdict->size = count;
    return (*(mlist)->procs->begin_xmit_collection)(mlist, "InputAttributes", pdict, (((bool)1) ? gs_param_collection_dict_int_keys : gs_param_collection_dict_any));
}
                       ...
                       const gdev_input_media_t * pim)
{
    ...
    mdict.size = 4;
    code = (*(pdict->list)->procs->begin_xmit_collection)(pdict->list, key, &mdict, (((bool)0) ? gs_param_collection_dict_int_keys : gs_param_collection_dict_any));
    if (code < 0)
        return code;
    ...
    if (code < 0)
        return code;
    return (*(pdict->list)->procs->end_xmit_collection)(pdict->list, key, &mdict);
}
...
{
    return (*(mlist)->procs->end_xmit_collection)(mlist, "InputAttributes", pdict);
}
...
{
    pdict->size = count;
    return (*(mlist)->procs->begin_xmit_collection)(mlist, "OutputAttributes", pdict, (((bool)1) ? gs_param_collection_dict_int_keys : gs_param_collection_dict_any));
}
...
{
    return (*(mlist)->procs->end_xmit_collection)(mlist, "OutputAttributes", pdict);
}
...
gs_putdeviceparams(gx_device * dev, gs_param_list * plist)
{
    ...
    gx_device_set_procs(dev);
    if ( ((dev)->procs.put_params) == 0 ) ((dev)->procs.put_params = (gx_default_put_params));
    if ( ((dev)->procs.get_alpha_bits) == 0 ) ((dev)->procs.get_alpha_bits = (gx_default_get_alpha_bits));
    code = (*((dev)->procs.put_params)) (dev, plist);
...
gx_default_put_icc_colorants(gs_param_string *colorants, gx_device * dev)
{
    ...
    if ( ((dev)->procs.get_profile) == 0 ) ((dev)->procs.get_profile = (gx_default_get_profile));
    tempstr = (char *) (*(dev->memory)->procs.alloc_bytes)(dev->memory, colorants->size+1, "gx_default_put_icc_colorants");

    memcpy(tempstr, colorants->data, colorants->size);

    tempstr[colorants->size] = 0;
    code = gsicc_set_device_profile_colorants(dev, tempstr);
    ((dev->memory)->procs.free_object(dev->memory, tempstr, "gx_default_put_icc_colorants"));
    return code;
}
                   ...
                   gsicc_profile_types_t index)
{
    ...
    if ( ((dev)->procs.get_profile) == 0 ) ((dev)->procs.get_profile = (gx_default_get_profile));
    if (icc_pro->size < 4096) {
        tempstr = (char *) (*(dev->memory)->procs.alloc_bytes)(dev->memory, icc_pro->size+1, "gx_default_put_icc");
        ...
        ((dev->memory)->procs.free_object(dev->memory, tempstr, "gx_default_put_icc"));
    }
    return code;
}
...
gx_default_put_params(gx_device * dev, gs_param_list * plist)
{
    ...
    bool usefastcolor = ((bool)0);
    bool sim_overprint = ((bool)1);
    bool prebandthreshold = ((bool)0);
    int profile_types[4] = {gsDEFAULTPROFILE,
                                               gsGRAPHICPROFILE,
                                               gsIMAGEPROFILE,
                                               gsTEXTPROFILE};
...
# 954 "./base/gsdparam.c"
    if (leadingedge & (1 << 3)) {
        leadingedge = (leadingedge & (1 << 2)) |
            ((leadingedge >> 4) & 3);
    }
# 978 "./base/gsdparam.c"
    do { switch (code = param_read_float_array(plist, (param_name = "HWResolution"), &(hwra))) { case 0: if ((hwra).size != 2) { ecode = ((-15)); (hwra).data = 0; } else {
        if (hwra.data[0] <= 0 || hwra.data[1] <= 0)
            ecode = ((-15));
        else
            break;
    } goto hwre; default: ecode = code;hwre: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: (hwra).data = 0; } } while (0);
    do { switch (code = param_read_int_array(plist, (param_name = "HWSize"), &(hwsa))) { case 0: if ((hwsa).size != 2) { ecode = ((-15)); (hwsa).data = 0; } else {
        ...
        else if (hwsa.data[0] > ((~(-1 << ((1 << 2) * 8 - 1))) / (1L << 8)) || hwsa.data[1] > ((~(-1 << ((1 << 2) * 8 - 1))) / (1L << 8)))
            ecode = ((-13));


        else
            break;
    } goto hwse; default: ecode = code;hwse: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: (hwsa).data = 0; } } while (0);
    {
        int t;
        ...
        if (code < 0) {
            ...
            if (t < 0 || t > 3)
                (*(plist)->procs->signal_error)(plist, "LeadingEdge", ecode = (-15));
    ...
    do { switch (code = param_read_float_array(plist, (param_name = "Margins"), &(ma))) { case 0: if ((ma).size != 2) { ecode = ((-15)); (ma).data = 0; } else {
        break;
    } goto me; default: ecode = code;me: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: (ma).data = 0; } } while (0);
    do { switch (code = param_read_float_array(plist, (param_name = ".HWMargins"), &(hwma))) { case 0: if ((hwma).size != 4) { ecode = ((-15)); (hwma).data = 0; } else {
        break;
    } goto hwme; default: ecode = code;hwme: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: (hwma).data = 0; } } while (0);

    do { switch (code = param_read_float_array(plist, (param_name = ".MarginsHWResolution"), &(mhwra))) { case 0: if ((mhwra).size != 2) { ecode = ((-15)); (mhwra).data = 0; } else {
        if (mhwra.data[0] != dev->MarginsHWResolution[0] ||
            ...
            break;
    } goto mhwre; default: ecode = code;mhwre: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: (mhwra).data = 0; } } while (0);
    ...
    if (dev->NumCopies_set >= 0 &&
        (*((dev)->procs.get_page_device))(dev) != 0
        ) {
...
nce:
    ...
    if ((code = param_read_long(plist, "MaxBitmap", &sp.MaxBitmap)) < 0)
        ecode = code;
# 1234 "./base/gsdparam.c"
    switch (code = param_read_long(plist, (param_name = "BufferSpace"), &sp.BufferSpace)) {
        case 0: if ((sp.params_are_read_only ? sp.BufferSpace != save_sp.BufferSpace : sp.BufferSpace < 10000)) ecode = (-15); else break; goto bse; default: ecode = code;bse: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: break;
    }

    switch (code = param_read_int(plist, (param_name = "BandWidth"), &sp.band.BandWidth)) {
        case 0: if ((sp.params_are_read_only ? sp.band.BandWidth != save_sp.band.BandWidth : sp.band.BandWidth < 0)) ecode = (-15); else break; goto bwe; default: ecode = code;bwe: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: break;
    }

    switch (code = param_read_int(plist, (param_name = "BandHeight"), &sp.band.BandHeight)) {
        case 0: if ((sp.params_are_read_only ? sp.band.BandHeight != save_sp.band.BandHeight : sp.band.BandHeight < 0)) ecode = (-15); else break; goto bhe; default: ecode = code;bhe: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: break;
    }

    switch (code = param_read_long(plist, (param_name = "BandBufferSpace"), &sp.band.BandBufferSpace)) {
        case 0: if ((sp.params_are_read_only ? sp.band.BandBufferSpace != save_sp.band.BandBufferSpace : sp.band.BandBufferSpace < 0)) ecode = (-15); else break; goto bbse; default: ecode = code;bbse: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: break;
    }
...
# 1275 "./base/gsdparam.c"
    { int igni; switch ( code = param_read_int(plist, (param_name = "%MediaSource"), &igni) ) { default: ecode = code; (*(plist)->procs->signal_error)(plist, param_name, ecode); case 0: case 1: break; } }
        { int igni; switch ( code = param_read_int(plist, (param_name = "%MediaDestination"), &igni) ) { default: ecode = code; (*(plist)->procs->signal_error)(plist, param_name, ecode); case 0: case 1: break; } }
        ...
        default:
            ...
            ecode = code;
          ibbe:(*(plist)->procs->signal_error)(plist, param_name, ecode);
        case 1:
            ibba.data = 0;
            break;
    }
    ...
    {
        const char * pcms = ((dev)->color_info.cm_name);

        if ((code = param_check_bytes(plist, "ProcessColorModel", (const byte *)(pcms), ((pcms != ((void*)0))) ? strlen(pcms) : 0, (pcms != ((void*)0)))) < 0)
            ecode = code;
    }
    { int igni; switch ( code = param_read_int(plist, (param_name = "MaxSeparations"), &igni) ) { default: ecode = code; (*(plist)->procs->signal_error)(plist, param_name, ecode); case 0: case 1: break; } }
    if ((code = param_check_bool(plist, "Separations", ((bool)0), ((bool)1))) < 0)
        ecode = code;
    ...
    if ((code = param_check_bytes(plist, "OutputDevice", (const byte *)(dev->dname), (((bool)1)) ? strlen(dev->dname) : 0, ((bool)1))) < 0)
        ecode = code;
    if ((code = param_check_bytes(plist, "Name", (const byte *)(dev->dname), (((bool)1)) ? strlen(dev->dname) : 0, ((bool)1))) < 0)
        ecode = code;
    if ((code = param_check_long(plist, "Colors", (long)(colors), ((bool)1))) < 0)
        ecode = code;
    if ((code = param_check_long(plist, "BitsPerPixel", (long)(depth), ((bool)1))) < 0)
        ecode = code;
    if ((code = param_check_long(plist, "GrayValues", (long)(GrayValues), ((bool)1))) < 0)
        ecode = code;


    { int igni; switch ( code = param_read_int(plist, (param_name = "PageCount"), &igni) ) { default: ecode = code; (*(plist)->procs->signal_error)(plist, param_name, ecode); case 0: case 1: break; } }

    if ((code = param_check_long(plist, "RedValues", (long)(RGBValues), ((bool)1))) < 0)
        ecode = code;
    if ((code = param_check_long(plist, "GreenValues", (long)(RGBValues), ((bool)1))) < 0)
        ecode = code;
    if ((code = param_check_long(plist, "BlueValues", (long)(RGBValues), ((bool)1))) < 0)
        ecode = code;
    if ((code = param_check_long(plist, "ColorValues", ColorValues, ((bool)1))) < 0)
        ecode = code;
    if (param_read_string(plist, "HWColorMap", &cms) != 1) {
        ...
        if (param_HWColorMap(dev, palette))
            ...
            code = param_check_bytes(plist, "HWColorMap", 0, 0, ((bool)0));
        if (code < 0)
            ecode = code;
    }
    ...
    code = (*(plist)->procs->commit)(plist);
    if (ecode < 0)
        return ecode;
    if (code < 0)
        return code;
# 1365 "./base/gsdparam.c"
    if (hwra.data != 0 &&
    ...
    dev->LeadingEdge &= 3;
    dev->LeadingEdge |= (leadingedge & (1 << 2));
    ...
    if (msa.data != 0 &&
        ...
        if (dev->is_open)
            gs_closedevice(dev);
        gx_device_set_media_size(dev, msa.data[0], msa.data[1]);
    }
    if (ma.data != 0) {
    ...
    if (ibba.data != 0) {
        ...
        dev->ImagingBBox_set = ((bool)1);
    } else if (ibbnull) {
        dev->ImagingBBox_set = ((bool)0);
    }
    dev->UseCIEColor = ucc;
        dev->color_info.anti_alias.text_bits =
                param_normalize_anti_alias_bits((((dev->color_info.max_gray) > (dev->color_info.max_color)) ? (dev->color_info.max_gray) : (dev->color_info.max_color)), tab);

        dev->color_info.anti_alias.graphics_bits =
                param_normalize_anti_alias_bits((((dev->color_info.max_gray) > (dev->color_info.max_color)) ? (dev->color_info.max_gray) : (dev->color_info.max_color)), gab);
...
{
    dev->LeadingEdge = (dev->LeadingEdge & ~(3 << 4)) |
        ((le_req << 4) & (3 << 4)) |
        (1 << 3);
}
                ...
                const float *res, gs_param_float_array * pa)
{
    ...
    do { switch (code = param_read_float_array(plist, (param_name = pname), &(*pa))) { case 0: if ((*pa).size != 2) { ecode = ((-15)); (*pa).data = 0; } else {
        ...
        else if (width_new > ((~(-1 << ((1 << 2) * 8 - 1))) / (1L << 8)) || height_new > ((~(-1 << ((1 << 2) * 8 - 1))) / (1L << 8)))
            ecode = ((-13));


        else
            break;
    } goto mse; default: ecode = code;mse: (*(plist)->procs->signal_error)(plist, param_name, ecode); case 1: (*pa).data = 0; } } while (0);
    return ecode;
}
