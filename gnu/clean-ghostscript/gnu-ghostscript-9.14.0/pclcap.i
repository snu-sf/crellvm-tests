# 1 "./contrib/pcl3/src/pclcap.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./contrib/pcl3/src/pclcap.c" 2
# 16 "./contrib/pcl3/src/pclcap.c"
static const char
  cm_id[] = "@(#)$Id: pclcap.c,v 1.17 2001/03/08 09:17:51 Martin Rel $";
# 27 "./contrib/pcl3/src/pclcap.c"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
# 1 "./base/stdpre.h" 1
# 253 "./base/stdpre.h"
...
# 28 "./contrib/pcl3/src/pclcap.c" 2
...
extern void __assert (const char *__assertion, const char *__file, int __line)
     __attribute__ ((__nothrow__ )) __attribute__ ((__noreturn__));
# 29 "./contrib/pcl3/src/pclcap.c" 2
...
# 30 "./contrib/pcl3/src/pclcap.c" 2
...
# 31 "./contrib/pcl3/src/pclcap.c" 2
...
# 23 "./contrib/pcl3/src/pclcap.h" 2
...
# 34 "./contrib/pcl3/src/pclcap.c" 2
...
# 35 "./contrib/pcl3/src/pclcap.c" 2
# 90 "./contrib/pcl3/src/pclcap.c"
static const eprn_PageDescription
  ...
  hpdj3xx_sizes[] = {
    ...
    {ms_Letter,
      75*(72.0/300), 120*(72.0/300), 75*(72.0/300), 30*(72.0/300)},
    {ms_Legal,
      75*(72.0/300), 120*(72.0/300), 75*(72.0/300), 30*(72.0/300)},
    {ms_A4,
      37*(72.0/300), 120*(72.0/300), 43*(72.0/300), 30*(72.0/300)},
    {ms_Executive,
      75*(72.0/300), 120*(72.0/300), 75*(72.0/300), 30*(72.0/300)},
    {ms_none}
  },
  hpdj400_sizes[] = {
# 118 "./contrib/pcl3/src/pclcap.c"
    {ms_Letter,
      0.25*72.0, (0.5-0.08)*72.0, 0.25*72.0, 0.08*72.0},
    {ms_Legal,
      0.25*72.0, (0.5-0.08)*72.0, 0.25*72.0, 0.08*72.0},
    {ms_A4,
      0.125*72.0, (0.5-0.08)*72.0, 3.6*(72.0/25.4), 0.08*72.0},
    {ms_Executive,
      0.25*72.0, (0.5-0.08)*72.0, 0.25*72.0, 0.08*72.0},
    {ms_JISB5,
      3.175*(72.0/25.4), (0.5-0.08)*72.0, 3.25*(72.0/25.4), 0.08*72.0},
    ...
    {ms_Env10 | 0x4000U,
      0.125*72.0, (0.5-0.08)*72.0, 0.08*72.0, 0.08*72.0},
    {ms_EnvDL | 0x4000U,
      0.125*72.0, (0.5-0.08)*72.0, 0.11*72.0, 0.08*72.0},
    {ms_none}
  },
  hpdj500_sizes[] = {
    ...
    {ms_Letter,
      0.25*72.0, 0.57*72.0, 0.25*72.0, 0.1*72.0},
    {ms_Legal,
      0.25*72.0, 0.57*72.0, 0.25*72.0, 0.1*72.0},
    {ms_A4,
      3.1*(72.0/25.4), 0.57*72.0, 3.6*(72.0/25.4), 0.1*72.0},
    {ms_Env10 | 0x4000U,
      0.75*72.0, 0.57*72.0, 0.75*72.0, 0.1*72.0},
    {ms_none}
  },
  hpdj500c_sizes[] = {
    ...
    {ms_Letter,
      0.25*72.0, 0.4*72.0, 0.25*72.0, 0.1*72.0},
    {ms_Legal,
      0.25*72.0, 0.4*72.0, 0.25*72.0, 0.1*72.0},
    {ms_A4,
      3.1*(72.0/25.4), 0.4*72.0, 3.6*(72.0/25.4), 0.1*72.0},
    {ms_Env10 | 0x4000U,



      0.75*72.0, 0.4*72.0, 0.75*72.0, 0.1*72.0},
    {ms_none}
  },
  common_sizes[] = {
    ...
    {ms_Letter,
      0.25*72.0, 0.46*72.0, 0.25*72.0, 0.04*72.0},
    {ms_Legal,
      0.25*72.0, 0.46*72.0, 0.25*72.0, 0.04*72.0},
    {ms_Executive,
      0.25*72.0, 0.46*72.0, 0.20*72.0, 0.04*72.0},
    {ms_A4,
      3.1*(72.0/25.4), 0.46*72.0, 3.6*(72.0/25.4), 0.04*72.0},


    {ms_Env10,
      0.123*72.0, 0.71*72.0, 0.125*72.0, 0.04*72.0},
    {ms_EnvDL,
      3.1*(72.0/25.4), 18.0*(72.0/25.4), 3.6*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_none}
  },
  hpdj540_sizes[] = {
    ...
    {ms_Executive,
      0.25*72.0, 0.46*72.0, 0.25*72.0, 0.04*72.0},
    {ms_Letter, 0.25*72.0, 0.46*72.0, 0.25*72.0, 0.04*72.0},
    {ms_Legal, 0.25*72.0, 0.46*72.0, 0.25*72.0, 0.04*72.0},
    {ms_A4, 3.2*(72.0/25.4), 11.7*(72.0/25.4), 3.2*(72.0/25.4), 0.04*72.0},
    {ms_A5, 3.2*(72.0/25.4), 18.0*(72.0/25.4), 3.2*(72.0/25.4), 0.04*72.0},
    {ms_JISB5, 4.2*(72.0/25.4), 11.7*(72.0/25.4), 4.2*(72.0/25.4), 0.04*72.0},
    {ms_Index4x6in,
      0.13*72.0, 0.71*72.0, 0.13*72.0, 0.04*72.0},
    {ms_Index5x8in,
      0.13*72.0, 0.71*72.0, 0.13*72.0, 0.04*72.0},
    {ms_A6 | 0x0200U,
      3.2*(72.0/25.4), 18.0*(72.0/25.4), 3.2*(72.0/25.4), 0.04*72.0},
    {ms_Env10, 0.13*72.0, 0.71*72.0, 0.13*72.0, 0.04*72.0},

    {ms_EnvDL, 0.13*72.0, 0.71*72.0, 0.13*72.0, 0.04*72.0},

    {ms_EnvC6, 0.13*72.0, 0.71*72.0, 0.13*72.0, 0.04*72.0},

    {ms_Postcard, 4.2*(72.0/25.4), 18.0*(72.0/25.4), 4.2*(72.0/25.4), 0.04*72.0},
    {ms_none}
  },
  hpdj660c_sizes[] = {
# 237 "./contrib/pcl3/src/pclcap.c"
    {ms_Letter, 0.25*72.0, 0.46*72.0, 0.25*72.0, 0.04*72.0},
    {ms_Legal, 0.25*72.0, 0.46*72.0, 0.25*72.0, 0.04*72.0},
    {ms_Executive,
      0.25*72.0, 0.46*72.0, 0.25*72.0, 0.04*72.0},
    {ms_A4, 0.13*72.0, 0.46*72.0, 0.13*72.0, 0.04*72.0},
    {ms_A5, 0.13*72.0, 0.71*72.0, 0.13*72.0, 0.04*72.0},
    {ms_JISB5, 0.17*72.0, 0.46*72.0, 0.17*72.0, 0.04*72.0},
    ...
    {ms_A6 | 0x0200U,
      0.13*72.0, 0.71*72.0, 0.13*72.0, 0.04*72.0},
    {ms_Postcard,
      0.17*72.0, 0.71*72.0, 0.17*72.0, 0.04*72.0},
    {ms_EnvUS_A2,
      0.13*72.0, 0.71*72.0, 0.13*72.0, 0.04*72.0},
...
# 285 "./contrib/pcl3/src/pclcap.c"
    ...
    {ms_EnvUS_A2,
      0.13*72.0, 0.71*72.0, 0.13*72.0, 0.04*72.0},
    {ms_Letter | 0x0800U,
      0.25*72.0, 0.0, 0.25*72.0, 0.0},
    {ms_A4 | 0x0800U,
      0.13*72.0, 0.0, 0.13*72.0, 0.0},
  ...
  hpdj850c_sizes[] = {
# 361 "./contrib/pcl3/src/pclcap.c"
    {ms_Letter, 6.4*(72.0/25.4), 11.7*(72.0/25.4), 6.4*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_Legal, 6.4*(72.0/25.4), 11.7*(72.0/25.4), 6.4*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_Executive, 6.4*(72.0/25.4), 11.7*(72.0/25.4), 6.4*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_A4, 3.4*(72.0/25.4), 11.7*(72.0/25.4), 3.4*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_A5, 3.4*(72.0/25.4), 11.7*(72.0/25.4), 3.4*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_JISB5, 3.2*(72.0/25.4), 11.7*(72.0/25.4), 3.2*(72.0/25.4), 1.0*(72.0/25.4)},
    ...
    {ms_Index4x6in, 3.2*(72.0/25.4), 11.7*(72.0/25.4), 3.2*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_Index5x8in, 3.2*(72.0/25.4), 11.7*(72.0/25.4), 3.2*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_A6 | 0x0200U, 3.2*(72.0/25.4), 11.7*(72.0/25.4), 3.2*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_Postcard, 3.2*(72.0/25.4), 11.7*(72.0/25.4), 3.2*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_Env10, 3.2*(72.0/25.4), 22.0*(72.0/25.4), 3.2*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_EnvDL, 3.2*(72.0/25.4), 22.0*(72.0/25.4), 3.2*(72.0/25.4), 1.0*(72.0/25.4)},
    {ms_EnvC6, 3.2*(72.0/25.4), 22.0*(72.0/25.4), 3.2*(72.0/25.4), 1.0*(72.0/25.4)},
  ...
  hpdj1120c_sizes[] = {
    ...
    {ms_Executive, 0.25*72.0, 0.46*72.0, 0.25*72.0,
                        0.12*72.0},
    {ms_Letter, 0.25*72.0, 0.46*72.0, 0.25*72.0,
                        0.12*72.0},
    {ms_Legal, 0.25*72.0, 0.46*72.0, 0.25*72.0,
                        0.12*72.0},
    {ms_Tabloid, 0.20*72.0, 0.46*72.0, 0.20*72.0,
                        0.12*72.0},
    {ms_Statement, 0.20*72.0, 0.46*72.0, 0.20*72.0,
                        0.12*72.0},
    {ms_HPSuperB, 0.20*72.0, 0.46*72.0, 0.20*72.0,
                        0.12*72.0},
    {ms_A6, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},
    {ms_A5, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_A4, 0.20*72.0, 0.46*72.0, 0.20*72.0,
                        0.12*72.0},

    {ms_A3, 0.20*72.0, 0.46*72.0, 0.20*72.0,
                        0.12*72.0},
    {ms_JISB5, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_JISB4, 0.20*72.0, 0.46*72.0, 0.20*72.0,
                        0.12*72.0},
    {ms_Postcard, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_A6 | 0x0200U, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_Index4x6in, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_Index5x8in, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_Env10, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_EnvDL, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_EnvC6, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_EnvUS_A2, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_EnvChou3, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_EnvChou4, 0.125*72.0, 0.46*72.0, 0.125*72.0,
                        0.12*72.0},

    {ms_EnvKaku2, 0.20*72.0, 0.46*72.0, 0.20*72.0,
                        0.12*72.0},

    {ms_Letter | 0x0800U,
      0.25*72.0, 0, 0.25*72.0, 0.04*72.0},
    {ms_A4 | 0x0800U,
      0.13*72.0, 0, 0.13*72.0, 0.04*72.0},
    {ms_none}
  };
# 476 "./contrib/pcl3/src/pclcap.c"
static const eprn_CustomPageDescription
  hpdj540_custom_sizes[] = {
# 487 "./contrib/pcl3/src/pclcap.c"
    {
      ms_CustomPageSize,
      0.13*72.0, 0.46*72.0, 0.125*72.0, 0.04*72.0,
      7.12*72.0, 8.5*72.0, 5.83*72.0, 14*72.0
    },
    {
      ms_CustomPageSize,
      0.13*72.0, 0.71*72.0, 0.125*72.0, 0.04*72.0,
      5*72.0, 7.12*72.0, 5.83*72.0, 14*72.0
    },
  ...
  hpdj_6xx_and_8xx_custom_sizes[] = {
    ...
    {
      ms_CustomPageSize,
      0.13*72.0, 0.46*72.0, 0.13*72.0, 0.04*72.0,
      5*72.0, 8.5*72.0, 148*(72.0/25.4), 14*72.0
    },
    {ms_none, 0, 0, 0, 0, 0, 0, 0, 0}
  },
  hpdj850c_custom_sizes[] = {
    {
# 519 "./contrib/pcl3/src/pclcap.c"
      ms_CustomPageSize,
      3.4*(72.0/25.4), 11.7*(72.0/25.4), 3.4*(72.0/25.4), 1.0*(72.0/25.4),
      100*(72.0/25.4), 216*(72.0/25.4), 148*(72.0/25.4), 356*(72.0/25.4)
    },
    {ms_none, 0, 0, 0, 0, 0, 0, 0, 0}
  },
  hpdj1120c_custom_sizes[] = {
    {
      ...
      ms_CustomPageSize,
      0.125*72.0, 0.46*72.0, 0.125*72.0, 0.12*72.0,
      90*(72.0/25.4), 13*72.0, 146*(72.0/25.4), 19*72.0,
    },
    {ms_none, 0, 0, 0, 0, 0, 0, 0, 0}
  },
  any_custom_sizes[] = {
...
static const eprn_ResLev
  rl_basic[] = {
    {basic_resolutions, two_levels}, {((void*)0), ((void*)0)}
  },
  rl_basic_without_100[] = {
    {basic_without_100, two_levels}, {((void*)0), ((void*)0)}
  },
  rl_hpdj6xx_black[] = {
    {basic_resolutions, two_levels}, {six_by_three, two_levels},
    {sixhundred, two_levels}, {((void*)0), ((void*)0)}
  },
  rl_hpdj6xx_colour[] = {
    {basic_resolutions, two_levels}, {six_by_three, two_levels}, {((void*)0), ((void*)0)}
  },
  rl_three[] = {
    {threehundred, two_levels}, {((void*)0), ((void*)0)}
  },
  rl_six[] = {
    {sixhundred, two_levels}, {((void*)0), ((void*)0)}
  },
  rl_hpdj85x_black[] = {
    {basic_without_100, two_levels}, {sixhundred, two_levels}, {((void*)0), ((void*)0)}
  },
  rl_three_with_levels_2_4[] = {
    {threehundred, two_to_four_levels}, {((void*)0), ((void*)0)}
  },
  rl_three_with_levels_3_4[] = {
    {threehundred, three_to_four_levels}, {((void*)0), ((void*)0)}
  },
  rl_three_with_levels_4[] = {
    {threehundred, four_levels}, {((void*)0), ((void*)0)}
  },
  rl_hpdj1120c_black[] = {
  ...
  rl_150_and_300[] = {
    {rel_150_and_300, two_levels}, {((void*)0), ((void*)0)}
  },
  rl_any_two_levels[] = {

    {((void*)0), two_levels}, {((void*)0), ((void*)0)}
  },
  rl_any[] = {
    {((void*)0), any_levels}, {((void*)0), ((void*)0)}
  };
...
static const eprn_ColourInfo
  ci_old_mono[] = {
    { eprn_DeviceGray, {rl_basic, ((void*)0)} },
    { eprn_DeviceGray, {((void*)0), ((void*)0)} }
  },
  ci_hpdj500c[] = {
    { eprn_DeviceGray, {rl_basic, ((void*)0)} },
    { eprn_DeviceCMY, {rl_basic, ((void*)0)} },
    { eprn_DeviceGray, {((void*)0), ((void*)0)} }
  },
  ci_hpdj540[] = {
    { eprn_DeviceGray, {rl_basic_without_100, ((void*)0)} },
    { eprn_DeviceCMY, {rl_basic_without_100, ((void*)0)} },
    { eprn_DeviceGray, {((void*)0), ((void*)0)} }
  },
  ci_hpdj5xx_cmyk[] = {
    ...
    { eprn_DeviceGray, {rl_basic, ((void*)0)} },
    { eprn_DeviceCMY, {rl_basic, ((void*)0)} },
    { eprn_DeviceCMY_plus_K, {rl_basic, ((void*)0)} },
    { eprn_DeviceGray, {((void*)0), ((void*)0)} }
  },
  ci_hpdj600[] = {

    { eprn_DeviceGray, {rl_hpdj6xx_black, ((void*)0)} },
    { eprn_DeviceCMY, {rl_hpdj6xx_colour, ((void*)0)} },
    { eprn_DeviceGray, {((void*)0), ((void*)0)} }
  },
  ci_hpdj6xx[] = {
    ...
    { eprn_DeviceGray, {rl_hpdj6xx_black, ((void*)0)} },
    { eprn_DeviceCMY, {rl_hpdj6xx_colour, ((void*)0)} },
    { eprn_DeviceCMYK, {rl_hpdj6xx_colour, ((void*)0)} },
    { eprn_DeviceCMYK, {rl_six, rl_three} },
    { eprn_DeviceGray, {((void*)0), ((void*)0)} }
  },
  ci_hpdj85x[] = {
    { eprn_DeviceGray, {rl_hpdj85x_black, ((void*)0)} },
    { eprn_DeviceCMY, {rl_basic_without_100, ((void*)0)} },
    { eprn_DeviceCMYK, {rl_basic_without_100, ((void*)0)} },

    { eprn_DeviceGray, {rl_three_with_levels_4, ((void*)0)} },
  ...
  ci_hpdj1120c[] = {
    ...
    { eprn_DeviceGray, {rl_hpdj1120c_black, ((void*)0)} },
    { eprn_DeviceCMYK, {rl_six, rl_three_with_levels_4} },
    { eprn_DeviceCMYK, {rl_six, rl_three} },
    { eprn_DeviceCMYK, {rl_three_with_levels_4, rl_three_with_levels_3_4} },
    { eprn_DeviceCMYK, {rl_150_and_300, ((void*)0)} },
  ...
  ci_any[] = {
    { eprn_DeviceGray, {rl_any, ((void*)0)} },
    { eprn_DeviceRGB, {rl_any_two_levels, ((void*)0)} },
    { eprn_DeviceCMY, {rl_any, ((void*)0)} },
...
const pcl_PrinterDescription pcl3_printers[] = {
  ...
  { HPDeskJet, pcl_level_3plus_DJ500,
    { "HP DeskJet", hpdj500_sizes, ((void*)0), 0.0, ci_old_mono } },
  { HPDeskJetPlus, pcl_level_3plus_DJ500,
    { "HP DeskJet Plus", hpdj500_sizes, ((void*)0), 0.0, ci_old_mono } },
  { HPDJPortable, pcl_level_3plus_S5,
    { "HP DeskJet Portable", hpdj3xx_sizes, ((void*)0), 0.0, ci_old_mono } },


  { HPDJ310, pcl_level_3plus_S5,
    { "HP DeskJet 310", hpdj3xx_sizes, ((void*)0), 50*(72.0/300), ci_hpdj500c } },



  { HPDJ320, pcl_level_3plus_S5,
    { "HP DeskJet 320", hpdj3xx_sizes, ((void*)0), 50*(72.0/300), ci_hpdj500c } },
  { HPDJ340, pcl_level_3plus_S5,
    { "HP DeskJet 340", hpdj3xx_sizes, ((void*)0), 50*(72.0/300), ci_hpdj500c } },
  { HPDJ400, pcl_level_3plus_S5,
    { "HP DeskJet 400", hpdj400_sizes, ((void*)0), 0.0, ci_hpdj500c } },

  { HPDJ500, pcl_level_3plus_DJ500,
    {"HP DeskJet 500", hpdj500_sizes, ((void*)0), 0.0, ci_old_mono } },
  { HPDJ500C, pcl_level_3plus_S5,
    { "HP DeskJet 500C", hpdj500c_sizes, ((void*)0), 0.17*72.0, ci_hpdj500c } },
  { HPDJ510, pcl_level_3plus_S5,
    { "HP DeskJet 510", common_sizes, ((void*)0), 0.0, ci_old_mono } },
  { HPDJ520, pcl_level_3plus_S5,
    { "HP DeskJet 520", common_sizes, ((void*)0), 0.0, ci_old_mono } },
  { HPDJ540, pcl_level_3plus_S68,
    { "HP DeskJet 540", hpdj540_sizes, hpdj540_custom_sizes,
      0.13*72.0, ci_hpdj540 } },
  { HPDJ550C, pcl_level_3plus_S5,
    { "HP DeskJet 550C", common_sizes, ((void*)0), 0.13*72.0, ci_hpdj5xx_cmyk }},
  { HPDJ560C, pcl_level_3plus_S5,
    { "HP DeskJet 560C", common_sizes, ((void*)0), 0.13*72.0, ci_hpdj5xx_cmyk }},
  { pcl3_generic_old, pcl_level_3plus_ERG_both,
    { "unspecified PCL-3+ printer (old)", common_sizes, ((void*)0), 0.0, ci_any } },
  { HPDJ600, pcl_level_3plus_S68,
    { "HP DeskJet 600", hpdj6xx_and_8xx_sizes, hpdj_6xx_and_8xx_custom_sizes,
      0.13*72.0, ci_hpdj600 } },
  { HPDJ660C, pcl_level_3plus_S68,
    { "HP DeskJet 660C", hpdj660c_sizes, hpdj_6xx_and_8xx_custom_sizes,
      0.13*72.0, ci_hpdj6xx } },
...
static void check(void)
{
  ...
  for (j = 0; j < (sizeof(pcl3_printers)/sizeof(pcl3_printers[0])); j++)
    ((pcl3_printers[j].id == j) ? (void) (0) : __assert_fail ("pcl3_printers[j].id == j", "./contrib/pcl3/src/pclcap.c", 803, __PRETTY_FUNCTION__));

  checked = 1;

  return;
}
# 823 "./contrib/pcl3/src/pclcap.c"
