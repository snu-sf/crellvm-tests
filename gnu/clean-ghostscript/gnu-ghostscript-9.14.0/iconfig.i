...
# 564 "./obj/gconfig.h"
"PostScript" "\000"
"PostScriptLevel1" "\000"
# 593 "./obj/gconfig.h"
"PostScriptLevel2" "\000"
# 615 "./obj/gconfig.h"
"PostScriptLevel3" "\000"
# 663 "./obj/gconfig.h"
"PDF" "\000"
# 31 "./base/gconf.h" 2
# 46 "./obj/iconfig.c" 2
...
# 1 "./obj/gconfig.h" 1
# 573 "./obj/gconfig.h"
extern int gs_build_function_4(i_ctx_t *i_ctx_p, const ref *op, const gs_function_params_t *params, int depth, gs_function_t **ppfn, gs_memory_t *mem);





extern int gs_build_function_0(i_ctx_t *i_ctx_p, const ref *op, const gs_function_params_t *params, int depth, gs_function_t **ppfn, gs_memory_t *mem);
# 605 "./obj/gconfig.h"
extern int gs_build_function_2(i_ctx_t *i_ctx_p, const ref *op, const gs_function_params_t *params, int depth, gs_function_t **ppfn, gs_memory_t *mem);
extern int gs_build_function_3(i_ctx_t *i_ctx_p, const ref *op, const gs_function_params_t *params, int depth, gs_function_t **ppfn, gs_memory_t *mem);
# 31 "./base/gconf.h" 2
# 53 "./obj/iconfig.c" 2
...
# 1 "./obj/gconfig.h" 1
# 573 "./obj/gconfig.h"
{4,gs_build_function_4},





{0,gs_build_function_0},
# 605 "./obj/gconfig.h"
{2,gs_build_function_2},
{3,gs_build_function_3},
# 31 "./base/gconf.h" 2
# 57 "./obj/iconfig.c" 2
 {0}
};
...
const uint build_function_type_table_count =
    (sizeof(build_function_type_table) / sizeof((build_function_type_table)[0])) - 1;




extern const op_def interp1_op_defs[];
extern const op_def interp2_op_defs[];

# 1 "./base/gconf.h" 1
# 30 "./base/gconf.h"
# 1 "./obj/gconfig.h" 1
# 407 "./obj/gconfig.h"
extern const op_def zbseq_l2_op_defs[];





extern const op_def zcolor1_op_defs[];
extern const op_def zht1_op_defs[];
extern const op_def zupath_l2_op_defs[];
extern const op_def zvmem2_op_defs[];
extern const op_def zdps1_l2_op_defs[];





extern const op_def ireclaim_l2_op_defs[];
extern const op_def zcharx_op_defs[];





extern const op_def zchar1_op_defs[];
extern const op_def zfont1_op_defs[];
extern const op_def zmisc1_op_defs[];





extern const op_def zusparam_op_defs[];
extern const op_def zmisc2_op_defs[];
...
extern const op_def zchar2_op_defs[];
extern const op_def zfont2_op_defs[];
extern const op_def zchar42_op_defs[];
extern const op_def zfont42_op_defs[];





extern const op_def zfrsd_op_defs[];
extern const op_def zfcid0_op_defs[];
extern const op_def zfcid1_op_defs[];
# 467 "./obj/gconfig.h"
extern const op_def zcrd_l2_op_defs[];
extern const op_def zfcmap_op_defs[];





extern const op_def zcfont_op_defs[];
extern const op_def zfont0_op_defs[];
extern const op_def zfdcte_op_defs[];
extern const op_def zfdctd_op_defs[];
extern const op_def zfdecode_op_defs[];
extern const op_def zfilter2_op_defs[];
extern const op_def ziodev2_l2_op_defs[];
...
extern const op_def zdevice2_l2_op_defs[];
extern const op_def zmedia2_l2_op_defs[];
# 498 "./obj/gconfig.h"
extern const op_def zpcolor_l2_op_defs[];
extern const op_def zarith_op_defs[];
extern const op_def zarray_op_defs[];
extern const op_def zcontrol1_op_defs[];
extern const op_def zcontrol2_op_defs[];
extern const op_def zcontrol3_op_defs[];
extern const op_def zdict1_op_defs[];
extern const op_def zdict2_op_defs[];
extern const op_def zfile_op_defs[];
extern const op_def zfile1_op_defs[];
extern const op_def zfileio1_op_defs[];
extern const op_def zfileio2_op_defs[];
extern const op_def zfilter_op_defs[];
extern const op_def zfproc_op_defs[];
extern const op_def zgeneric_op_defs[];
extern const op_def ziodev_op_defs[];
extern const op_def zmath_op_defs[];
extern const op_def zalg_op_defs[];
extern const op_def zmisc_op_defs[];
extern const op_def zpacked_op_defs[];
extern const op_def zrelbit_op_defs[];
extern const op_def zstack_op_defs[];
extern const op_def zstring_op_defs[];
extern const op_def zsysvm_op_defs[];
extern const op_def ztoken_op_defs[];
extern const op_def ztype_op_defs[];
extern const op_def zvmem_op_defs[];
extern const op_def zbfont_op_defs[];
extern const op_def zchar_a_op_defs[];
extern const op_def zchar_b_op_defs[];
extern const op_def zcolor_op_defs[];
extern const op_def zcolor_ext_op_defs[];
extern const op_def zdevice_op_defs[];
extern const op_def zfont_op_defs[];
extern const op_def zfontenum_op_defs[];
extern const op_def zgstate1_op_defs[];
extern const op_def zgstate2_op_defs[];
extern const op_def zgstate3_op_defs[];
extern const op_def zdfilter_op_defs[];
extern const op_def zht_op_defs[];
extern const op_def zimage_op_defs[];
extern const op_def zmatrix_op_defs[];
extern const op_def zmatrix2_op_defs[];
extern const op_def zpaint_op_defs[];
extern const op_def zpath_op_defs[];
extern const op_def pantone_op_defs[];
# 553 "./obj/gconfig.h"
extern const op_def zdscpars_op_defs[];
extern const op_def zfapi_op_defs[];





extern const op_def zfbcp_op_defs[];
extern const op_def zpath1_op_defs[];
...
extern const op_def zht2_l2_op_defs[];
extern const op_def zcssepr_l2_op_defs[];
extern const op_def zfsample_op_defs[];





extern const op_def zfunc_op_defs[];





extern const op_def zchar32_op_defs[];
extern const op_def zfont32_op_defs[];





extern const op_def zfimscale_op_defs[];
extern const op_def zform_op_defs[];
# 599 "./obj/gconfig.h"
extern const op_def zimage3_op_defs[];
extern const op_def zmisc3_op_defs[];
extern const op_def zcolor3_l3_op_defs[];
extern const op_def zshade_op_defs[];
# 612 "./obj/gconfig.h"
extern const op_def zfzlib_op_defs[];
# 624 "./obj/gconfig.h"
extern const op_def ztrans1_op_defs[];
extern const op_def ztrans2_op_defs[];
# 643 "./obj/gconfig.h"
extern const op_def zfmd5_op_defs[];
extern const op_def zfsha2_op_defs[];
extern const op_def zfarc4_op_defs[];
extern const op_def zfaes_op_defs[];
...
extern const op_def zicc_ll3_op_defs[];





extern const op_def zpdfops_op_defs[];
# 669 "./obj/gconfig.h"
extern const op_def zcontext1_op_defs[];
extern const op_def zcontext2_op_defs[];
extern const op_def zdps_op_defs[];





extern const op_def zdpnext_op_defs[];
# 687 "./obj/gconfig.h"
extern const op_def zfjbig2_op_defs[];
extern const op_def zfjpx_op_defs[];
# 31 "./base/gconf.h" 2
# 69 "./obj/iconfig.c" 2
...
const uint op_def_count = ((sizeof(op_defs_all) / sizeof((op_defs_all)[0])) - 1) * (1 << 4);
...
typedef int (*i_plugin_instantiation_proc)(i_plugin_client_memory *client_mem, i_plugin_instance **instance); extern const i_plugin_instantiation_proc i_plugin_table[];
