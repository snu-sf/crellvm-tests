...
static const gc_ptr_element_t clip_rect_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gx_clip_rect *)0)->next - (char *)((gx_clip_rect *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_clip_rect *)0)->prev - (char *)((gx_clip_rect *)0) )) } }; static const gc_struct_data_t clip_rect_reloc_ptrs = { (sizeof(clip_rect_enum_ptrs) / sizeof((clip_rect_enum_ptrs)[0])), 0, 0, clip_rect_enum_ptrs }; const gs_memory_struct_type_t st_clip_rect = { sizeof(gx_clip_rect), "clip_rect", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &clip_rect_reloc_ptrs };
static const gc_ptr_element_t clip_list_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gx_clip_list *)0)->head - (char *)((gx_clip_list *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_clip_list *)0)->tail - (char *)((gx_clip_list *)0) )) } }; static const gc_struct_data_t clip_list_reloc_ptrs = { (sizeof(clip_list_enum_ptrs) / sizeof((clip_list_enum_ptrs)[0])), 0, 0, clip_list_enum_ptrs }; const gs_memory_struct_type_t st_clip_list = { sizeof(gx_clip_list), "clip_list", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &clip_list_reloc_ptrs };
static gs_ptr_type_t clip_path_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void clip_path_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_clip_path = { sizeof(gx_clip_path), "clip_path", 0, 0, clip_path_enum_ptrs, clip_path_reloc_ptrs, 0, 0 };
static const gc_struct_data_t clip_rect_list_reloc_ptrs = { 0, ((int) ( (char *)&((gx_clip_rect_list *)0)->list - (char *)((gx_clip_rect_list *)0) )), &st_clip_list, 0 }; static const gs_memory_struct_type_t st_clip_rect_list = { sizeof(gx_clip_rect_list), "gx_clip_rect_list", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &clip_rect_list_reloc_ptrs };
static gs_ptr_type_t device_clip_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void device_clip_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_device_clip = { sizeof(gx_device_clip), "gx_device_clip", 0, 0, device_clip_enum_ptrs, device_clip_reloc_ptrs, gx_device_finalize, 0 };
static const gc_ptr_element_t cpath_enum_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gs_cpath_enum *)0)->visit - (char *)((gs_cpath_enum *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gs_cpath_enum *)0)->rp - (char *)((gs_cpath_enum *)0) )) } }; static const gc_struct_data_t cpath_enum_reloc_ptrs = { (sizeof(cpath_enum_enum_ptrs) / sizeof((cpath_enum_enum_ptrs)[0])), 0, &st_path_enum, cpath_enum_enum_ptrs }; static const gs_memory_struct_type_t st_cpath_enum = { sizeof(gs_cpath_enum), "gs_cpath_enum", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cpath_enum_reloc_ptrs };
static const gc_ptr_element_t cpath_path_list_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gx_cpath_path_list *)0)->next - (char *)((gx_cpath_path_list *)0) )) } }; static const gc_struct_data_t cpath_path_list_reloc_ptrs = { (sizeof(cpath_path_list_enum_ptrs) / sizeof((cpath_path_list_enum_ptrs)[0])), 0, &st_path, cpath_path_list_enum_ptrs }; static const gs_memory_struct_type_t st_cpath_path_list = { sizeof(gx_cpath_path_list), "gs_cpath_list", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &cpath_path_list_reloc_ptrs };


static
gs_ptr_type_t clip_path_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gx_clip_path *cptr = vptr; switch ( index ) { default: return (*(st_path).enum_ptrs)(mem, &cptr->path, sizeof(cptr->path), index - 2, pep, &(st_path), gcst);

case 0:
return (pep->ptr = (const void *)((cptr->rect_list == &cptr->local_list ? 0 : cptr->rect_list)), (&ptr_struct_procs));

case 1:
return (pep->ptr = (const void *)(cptr->path_list), (&ptr_struct_procs));
} }
static
void clip_path_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gx_clip_path *cptr = vptr;
{
    if (cptr->rect_list != &cptr->local_list)
        (cptr->rect_list = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(cptr->rect_list), gcst)));
    (cptr->path_list = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(cptr->path_list), gcst)));
    (*(st_path).reloc_ptrs)(&cptr->path, sizeof(gx_path), &(st_path), gcst);
}
}


static
gs_ptr_type_t device_clip_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gx_device_clip *cptr = vptr; switch ( index ) { default:
{
    if (index < 2 + 1)
        return (*(st_clip_list).enum_ptrs)(mem, &cptr->list, sizeof(gx_clip_list), index - 1, pep, &(st_clip_list), gcst);

    return (*(st_device_forward).enum_ptrs)(mem, vptr, sizeof(gx_device_forward), index - (2 + 1), pep, &(st_device_forward), gcst);


}
case 0:
return (pep->ptr = (const void *)((cptr->current == &cptr->list.single ? ((void*)0) : (void *)cptr->current)), (&ptr_struct_procs));

} }
static
void device_clip_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gx_device_clip *cptr = vptr;
{
    if (cptr->current == &cptr->list.single)
        cptr->current = &((gx_device_clip *)(((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(vptr), gcst)))->list.single;
    else
        (((gx_device_clip *)vptr)->current = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gx_device_clip *)vptr)->current), gcst)));
    (*(st_clip_list).reloc_ptrs)(&cptr->list, sizeof(gx_clip_list), &(st_clip_list), gcst);
    (*(st_device_forward).reloc_ptrs)(vptr, sizeof(gx_device_forward), &(st_device_forward), gcst);
}
}
...
static void rc_free_cpath_list(gs_memory_t *, void *, client_name_t);
static void rc_free_cpath_list_local(gs_memory_t *, void *, client_name_t);
static void rc_free_cpath_path_list(gs_memory_t *, void *, client_name_t);
...
cpath_init_rectangle(gx_clip_path * pcpath, gs_fixed_rect * pbox)
{
    ...
    pcpath->path_valid = ((bool)0);
    pcpath->path.bbox = *pbox;
    gx_cpath_set_outer_box(pcpath);
    pcpath->id = gs_next_ids(pcpath->path.memory, 1);
}
static void
...
cpath_alloc_list(gx_clip_rect_list ** prlist, gs_memory_t * mem,
                 client_name_t cname)
{
    do { if ( ((*prlist) = (gx_clip_rect_list *)(*(mem)->procs.alloc_struct)(mem, &st_clip_rect_list, cname)) == 0 ) { return ((-25)); } else { do { (*prlist)->rc.ref_count = 1; (*prlist)->rc.memory = mem; (*prlist)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0);
        ...
        const gx_clip_path * shared, gs_memory_t * mem, client_name_t cname)
{
    if (shared) {
        if (shared->path.segments == &shared->path.local_segments) {
            (eprintf_program_ident(gs_program_name(), gs_revision_number()), lprintf_file_and_line("./base/gxcpath.c", 165), errprintf_nomem("Attempt to share (local) segments of clip path 0x%lx!\n", (ulong) shared));
        ...
        *pcpath = *shared;
        ...
        do { if (pcpath->path.segments) do { (pcpath->path.segments)->rc.ref_count++; do { } while (0); } while (0); } while (0);
        do { if (pcpath->rect_list) do { (pcpath->rect_list)->rc.ref_count++; do { } while (0); } while (0); } while (0);
        do { if (pcpath->path_list) do { (pcpath->path_list)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    } else {
        int code = cpath_alloc_list(&pcpath->rect_list, mem, cname);

        if (code < 0)
            return code;
        code = gx_path_init_contained_shared(&pcpath->path, ((void*)0), mem, cname);
        if (code < 0) {
            ((mem)->procs.free_object(mem, pcpath->rect_list, cname));
            pcpath->rect_list = 0;
            return code;
        }
...
{
    gx_clip_path *pcpath =
    (gx_clip_path *)(*(mem)->procs.alloc_struct)(mem, &st_clip_path, cname);
    int code;

    if (pcpath == 0)
        return 0;
    code = gx_cpath_init_contained_shared(pcpath, shared, mem, cname);
    if (code < 0) {
        ((mem)->procs.free_object(mem, pcpath, cname));
        return 0;
    }
                                  ...
                                  bool safely_nested)
{
    if (shared) {
        if ((shared->path.segments == &shared->path.local_segments) &&
            !safely_nested) {
            (eprintf_program_ident(gs_program_name(), gs_revision_number()), lprintf_file_and_line("./base/gxcpath.c", 223), errprintf_nomem("Attempt to share (local) segments of clip path 0x%lx!\n", (ulong) shared));
        ...
        (void)gx_path_init_local_shared(&pcpath->path, ((void*)0), mem);
        do { (&pcpath->local_list)->rc.ref_count = 1; (&pcpath->local_list)->rc.memory = mem; (&pcpath->local_list)->rc.free = rc_free_cpath_list_local; do { } while (0); } while (0);
...
gx_cpath_unshare(gx_clip_path * pcpath)
{
    ...
    if (rlist->rc.ref_count > 1) {
        ...
        do { if (rlist) { do { do { } while (0); (rlist)->rc.ref_count += (-1); } while (0); if (!(rlist)->rc.ref_count) { do { do { } while (0); (rlist)->rc.free((rlist)->rc.memory, (void *)(rlist), "gx_cpath_unshare"); } while (0); (rlist) = 0; } else do { } while (0); } } while (0);
    }
    return code;
}
...
gx_cpath_free(gx_clip_path * pcpath, client_name_t cname)
{
    ...
    do { if (pcpath->rect_list) { do { do { } while (0); (pcpath->rect_list)->rc.ref_count += (-1); } while (0); if (!(pcpath->rect_list)->rc.ref_count) { do { do { } while (0); (pcpath->rect_list)->rc.free((pcpath->rect_list)->rc.memory, (void *)(pcpath->rect_list), cname); } while (0); (pcpath->rect_list) = 0; } else do { } while (0); } } while (0);
    do { if (pcpath->path_list) { do { do { } while (0); (pcpath->path_list)->rc.ref_count += (-1); } while (0); if (!(pcpath->path_list)->rc.ref_count) { do { do { } while (0); (pcpath->path_list)->rc.free((pcpath->path_list)->rc.memory, (void *)(pcpath->path_list), cname); } while (0); (pcpath->path_list) = 0; } else do { } while (0); } } while (0);
    ...
    pcpath->path_list = 0;
    {
        ...
        if (alloc == path_allocated_on_heap) {
            ...
            ((pcpath->path.memory)->procs.free_object(pcpath->path.memory, pcpath, cname));
        } else
            gx_path_free(&pcpath->path, cname);
    }
}
...
gx_cpath_assign_preserve(gx_clip_path * pcpto, gx_clip_path * pcpfrom)
{
    ...
    if (fromlist == &pcpfrom->local_list) {
        ...
        if (tolist == &pcpto->local_list || tolist->rc.ref_count > 1) {
            ...
            if (code < 0)
                return code;
            do { if (pcpto->rect_list) { do { do { } while (0); (pcpto->rect_list)->rc.ref_count += (-1); } while (0); if (!(pcpto->rect_list)->rc.ref_count) { do { do { } while (0); (pcpto->rect_list)->rc.free((pcpto->rect_list)->rc.memory, (void *)(pcpto->rect_list), "gx_cpath_assign"); } while (0); (pcpto->rect_list) = 0; } else do { } while (0); } } while (0);
        } else {
        ...
        do { if (tolist) do { (tolist)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    } else {

        do { if (fromlist) do { (fromlist)->rc.ref_count++; do { } while (0); } while (0); } while (0);
        do { if (pcpto->rect_list) { do { do { } while (0); (pcpto->rect_list)->rc.ref_count += (-1); } while (0); if (!(pcpto->rect_list)->rc.ref_count) { do { do { } while (0); (pcpto->rect_list)->rc.free((pcpto->rect_list)->rc.memory, (void *)(pcpto->rect_list), "gx_cpath_assign"); } while (0); (pcpto->rect_list) = 0; } else do { } while (0); } } while (0);
    }
    do { if (pcpfrom->path_list) do { (pcpfrom->path_list)->rc.ref_count++; do { } while (0); } while (0); } while (0);
...
rc_free_cpath_list(gs_memory_t * mem, void *vrlist, client_name_t cname)
{
    ...
    ((mem)->procs.free_object(mem, vrlist, cname));
}
...
rc_free_cpath_path_list(gs_memory_t * mem, void *vplist, client_name_t cname)
{
    ...
    do { if (plist->next) { do { do { } while (0); (plist->next)->rc.ref_count += (-1); } while (0); if (!(plist->next)->rc.ref_count) { do { do { } while (0); (plist->next)->rc.free((plist->next)->rc.memory, (void *)(plist->next), cname); } while (0); (plist->next) = 0; } else do { } while (0); } } while (0);
    gx_path_free(&plist->path, cname);
    ((plist->path.memory)->procs.free_object(plist->path.memory, plist, cname));
}
                        ...
                        gx_path *ppfrom, gx_cpath_path_list *next, gx_cpath_path_list **pnew)
{
    ...
    gx_cpath_path_list *pcplist = (gx_cpath_path_list *)(*(mem)->procs.alloc_struct)(mem, &st_cpath_path_list, cname);


    if (pcplist == 0)
        return ((-25));
    do { (pcplist)->rc.ref_count = 1; (pcplist)->rc.memory = mem; (pcplist)->rc.free = rc_free_cpath_path_list; do { } while (0); } while (0);
    if (pcpath!=((void*)0) && !pcpath->path_valid) {
        code = gx_path_init_contained_shared(&pcplist->path, ((void*)0), mem, cname);
        if (code < 0)
            return code;
        code = gx_cpath_to_path(pcpath, &pcplist->path);
    } else {
        (void)gx_path_init_local_shared(&pcplist->path, ((void*)0), mem);
...
gx_cpath_to_path(gx_clip_path * pcpath, gx_path * ppath)
{
    if (!pcpath->path_valid) {
        ...
        (void)gx_path_init_local_shared(&rpath, ((void*)0), pcpath->path.memory);
...
gx_cpath_inner_box(const gx_clip_path * pcpath, gs_fixed_rect * pbox)
{
    *pbox = pcpath->inner_box;
    return ((gx_cpath_list(pcpath))->count <= 1);
}
bool
...
{
    pcpath->outer_box.p.x = ((pcpath->path.bbox.p.x)&(-1L<<8));
    pcpath->outer_box.p.y = ((pcpath->path.bbox.p.y)&(-1L<<8));
    pcpath->outer_box.q.x = (((pcpath->path.bbox.q.x)+((1<<8)-1))&(-1L<<8));
    pcpath->outer_box.q.y = (((pcpath->path.bbox.q.y)+((1<<8)-1))&(-1L<<8));
}
...
static __inline__ gx_clip_list *
...
cpath_set_rectangle(gx_clip_path * pcpath, gs_fixed_rect * pbox)
{
    ...
    if (rlist->rc.ref_count <= 1)
        ...
        if (code < 0)
            return code;
        do { if (rlist) { do { do { } while (0); (rlist)->rc.ref_count += (-1); } while (0); if (!(rlist)->rc.ref_count) { do { do { } while (0); (rlist)->rc.free((rlist)->rc.memory, (void *)(rlist), "gx_cpath_from_rectangle"); } while (0); (rlist) = 0; } else do { } while (0); } } while (0);
...
{
    if (pcpath->path_valid) {
        return (gx_path_is_rectangular((const gx_path *)&pcpath->path, rect) != prt_none);
    }
                   ...
                   int rule, gs_imager_state *pis, const gx_fill_params * params)
{
    ...
    if (((ppath)->curve_count != 0)) {
        (void)gx_path_init_local_shared(&fpath, ((void*)0), pis->memory);
        code = gx_path_copy_reducing(ppath, &fpath, ((fixed)((((pis)->flatness))*(float)(1<<8))), ((void*)0), (pis->accurate_curves ? pco_accurate : pco_none));
    ...
    if (gx_cpath_inner_box(pcpath, &old_box) &&
        ((code = (gx_path_is_rectangular(ppath, &new_box) != prt_none)) ||
         ((ppath)->segments != 0 && (ppath)->segments->contents.subpath_first == 0))
        ) {
        int changed = 0;
        ...
        if (!code) {
            ...
            if (gx_path_current_point(ppath, &new_box.p) < 0) {
                ...
                new_box.p.x = ((fixed)((pis->ctm.tx)*(float)(1<<8)));
                new_box.p.y = ((fixed)((pis->ctm.ty)*(float)(1<<8)));
            }
            new_box.q = new_box.p;
            changed = 1;
        } else {
            {
                gs_fixed_point adjust = params != ((void*)0) ? params->adjust : pis->fill_adjust;
                fixed adjust_xl, adjust_xu, adjust_yl, adjust_yu;

                if (adjust.x == -1)
                    adjust_xl = adjust_xu = adjust_yl = adjust_yu = 0;
                else {
                    adjust_xl = (adjust.x == ((1L << 8) >> 1) ? ((1L << 8) >> 1) - 1L : adjust.x);
                    adjust_yl = (adjust.y == ((1L << 8) >> 1) ? ((1L << 8) >> 1) - 1L : adjust.y);
                    adjust_xu = adjust.x;
                    adjust_yu = adjust.y;
                }
                new_box.p.x = ((fixed)(((int)((((new_box.p.x - adjust_xl)+(((1<<8)>>1) - 1L))) >> (8))))<<8);
                new_box.p.y = ((fixed)(((int)((((new_box.p.y - adjust_yl)+(((1<<8)>>1) - 1L))) >> (8))))<<8);
                new_box.q.x = ((fixed)(((int)((((new_box.q.x + adjust_xu)+(((1<<8)>>1) - 1L))) >> (8))))<<8);
                new_box.q.y = ((fixed)(((int)((((new_box.q.y + adjust_yu)+(((1<<8)>>1) - 1L))) >> (8))))<<8);
            }
        ...
        do { if (pcpath->path_list) { do { do { } while (0); (pcpath->path_list)->rc.ref_count += (-1); } while (0); if (!(pcpath->path_list)->rc.ref_count) { do { do { } while (0); (pcpath->path_list)->rc.free((pcpath->path_list)->rc.memory, (void *)(pcpath->path_list), "gx_cpath_intersect"); } while (0); (pcpath->path_list) = 0; } else do { } while (0); } } while (0);
        pcpath->path_list = ((void*)0);
        ...
        if (!path_valid && next == ((void*)0)) {
            code = gx_cpath_path_list_new(pcpath->path.memory, pcpath, pcpath->rule,
                                            &pcpath->path, ((void*)0), &next);
            if (code < 0)
                goto ex;
        }
        code = gx_cpath_intersect_path_slow(pcpath, (params != ((void*)0) ? ppath_orig : ppath),
                            rule, pis, params);
        if (code < 0)
            goto ex;
        if (path_valid) {
            ...
            code = gx_cpath_path_list_new(pcpath->path.memory, ((void*)0), rule,
    ...
    if (!list_shared) {
        ...
        for (; pr != 0; pr = pr->next)
            if (pr != list->head && pr != list->tail) {
                ...
                if ( pr->xmin != (-1 << ((1 << 2) * 8 - 1)) && pr->xmin != (~(-1 << ((1 << 2) * 8 - 1))) ) pr->xmin = (log2_scale_x >= 0 ? pr->xmin << log2_scale_x : pr->xmin >> -log2_scale_x);
                if ( pr->xmax != (-1 << ((1 << 2) * 8 - 1)) && pr->xmax != (~(-1 << ((1 << 2) * 8 - 1))) ) pr->xmax = (log2_scale_x >= 0 ? pr->xmax << log2_scale_x : pr->xmax >> -log2_scale_x);
                if ( pr->ymin != (-1 << ((1 << 2) * 8 - 1)) && pr->ymin != (~(-1 << ((1 << 2) * 8 - 1))) ) pr->ymin = (log2_scale_y >= 0 ? pr->ymin << log2_scale_y : pr->ymin >> -log2_scale_y);
                if ( pr->ymax != (-1 << ((1 << 2) * 8 - 1)) && pr->ymax != (~(-1 << ((1 << 2) * 8 - 1))) ) pr->ymax = (log2_scale_y >= 0 ? pr->ymax << log2_scale_y : pr->ymax >> -log2_scale_y);
        ...
        if (log2_scale_x > 0) {
            ...
            list->xmin = ((list->xmin) >> (-log2_scale_x));
            list->xmax = ((list->xmax) >> (-log2_scale_x));
        }
    }
    pcpath->id = gs_next_ids(pcpath->path.memory, 1);
    return 0;
                            ...
                            register gs_fixed_rect * rp)
{
    ...
    clp->single.xmin = clp->xmin = ((int)((rp->p.x) >> (8)));
    clp->single.ymin = ((int)((rp->p.y) >> (8)));
...
gx_cpath_enum_init(gs_cpath_enum * penum, const gx_clip_path * pcpath)
{
    if ((penum->using_path = pcpath->path_valid)) {
        ...
        (void)gx_path_init_local_shared(&empty_path, ((void*)0), pcpath->path.memory);
        ...
        penum->rp = 0;
        penum->any_rectangles = ((bool)0);
        penum->state = cpe_scan;
        penum->have_line = ((bool)0);
    }
    return 0;
}
...
gx_cpath_enum_next(gs_cpath_enum * penum, gs_fixed_point pts[3])
{
    ...
    if (penum->have_line) {
        (pts[0].x = ((fixed)(penum->line_end.x)<<8), pts[0].y = ((fixed)(penum->line_end.y)<<8));
        penum->have_line = ((bool)0);
        return 2;
    } {
            ...
            case cpe_scan:
                ...
                for (; visit != 0; visit = visit->next) {
                    if (visit->to_visit & visit_left) {
                        (pts[0].x = ((fixed)(visit->xmin)<<8), pts[0].y = ((fixed)(visit->ymin)<<8));
                        first_visit = visit_left;
                        state = cpe_left;
                    } else if (visit->to_visit & visit_right) {
                        (pts[0].x = ((fixed)(visit->xmax)<<8), pts[0].y = ((fixed)(visit->ymax)<<8));
                ...
                if (!penum->any_rectangles) {
                    ...
                    (pts[0].x = ((fixed)(0L)<<8), pts[0].y = ((fixed)(0L)<<8));
                    code = 1;
                    break;
                }
              ...
              left:
                ...
                if (look == 0 || look->ymin > rp->ymax ||
                    ...
                    state =
                        (rp == visit && first_visit == visit_right ? cpe_close :
                         ((penum->line_end.x = (rp->xmax), penum->line_end.y = (rp->ymax), penum->have_line = ((bool)1)), cpe_right));
                    (pts[0].x = ((fixed)(rp->xmin)<<8), pts[0].y = ((fixed)(rp->ymax)<<8)); code = 2; break;
                }
...

                {
                    ...
                    if (prev != 0 && prev->ymax == rp->ymax &&
                        ...
                        state =
                            (rp == visit && first_visit == visit_right ? cpe_close :
                             ((penum->line_end.x = (prev->xmax), penum->line_end.y = (prev->ymax), penum->have_line = ((bool)1)), cpe_right));
                        (pts[0].x = ((fixed)(cur->xmin)<<8), pts[0].y = ((fixed)(cur->ymax)<<8)); code = 2; break;
                    }
                    rp = look;
                    if (rp == visit && first_visit == visit_left)
                        ...
                        (penum->line_end.x = (rp->xmin), penum->line_end.y = (rp->ymin), penum->have_line = ((bool)1));
                    (pts[0].x = ((fixed)(cur->xmin)<<8), pts[0].y = ((fixed)(cur->ymax)<<8)); code = 2; break;
                }
              ...
              right:
                ...
                if (look == 0 || look->ymax < rp->ymin ||
                    ...
                    state =
                        (rp == visit && first_visit == visit_left ? cpe_close :
                         ((penum->line_end.x = (rp->xmin), penum->line_end.y = (rp->ymin), penum->have_line = ((bool)1)), cpe_left));
                    (pts[0].x = ((fixed)(rp->xmax)<<8), pts[0].y = ((fixed)(rp->ymin)<<8)); code = 2; break;
                }
...

                {
                    ...
                    if (next != 0 && next->ymin == rp->ymin &&
                        ...
                        state =
                            (rp == visit && first_visit == visit_left ? cpe_close :
                             ((penum->line_end.x = (next->xmin), penum->line_end.y = (next->ymin), penum->have_line = ((bool)1)), cpe_left));
                        (pts[0].x = ((fixed)(cur->xmax)<<8), pts[0].y = ((fixed)(cur->ymin)<<8)); code = 2; break;
                    }
                    rp = look;
                    if (rp == visit && first_visit == visit_right)
                        ...
                        (penum->line_end.x = (rp->xmax), penum->line_end.y = (rp->ymax), penum->have_line = ((bool)1));
                    (pts[0].x = ((fixed)(cur->xmax)<<8), pts[0].y = ((fixed)(cur->ymin)<<8)); code = 2; break;
                }
...
gx_cpath_copy(const gx_clip_path * from, gx_clip_path * pcpath)
{
    ...
    if (pcpath->path_list)
        do { if (pcpath->path_list) { do { do { } while (0); (pcpath->path_list)->rc.ref_count += (-1); } while (0); if (!(pcpath->path_list)->rc.ref_count) { do { do { } while (0); (pcpath->path_list)->rc.free((pcpath->path_list)->rc.memory, (void *)(pcpath->path_list), "gx_cpath_copy"); } while (0); (pcpath->path_list) = 0; } else do { } while (0); } } while (0);
    pcpath->path_list = ((void*)0);
    pcpath->rule = from->rule;
    pcpath->outer_box = from->outer_box;
    pcpath->inner_box = from->inner_box;
    l->single = from->rect_list->list.single;
    for (r = from->rect_list->list.head; r != ((void*)0); r = r->next) {
        s = (gx_clip_rect *)(*(from->rect_list->rc.memory)->procs.alloc_struct)(from->rect_list->rc.memory, &st_clip_rect, "gx_cpath_copy");
        if (s == ((void*)0))
            return ((-25));
        *s = *r;
        s->next = ((void*)0);
