...
void gx_hld_saved_color_init(gx_hl_saved_color * psc)
{
    ...
    psc->color_space_id = psc->pattern_id = 0L;
    ((&temp_devc)->type = (&gx_dc_type_data_null));
...
const gs_state * gx_hld_get_gstate_ptr(const gs_imager_state * pis)
{
    ...
    if (pis == ((void*)0) || pis->is_gstate == ((bool)0))
        return ((void*)0);
                ...
                gx_hl_saved_color * psc)
{
    ...
    if (pdevc == ((void*)0)) {
        ...
        if ((pdevc->type == (&gx_dc_pattern)
           || pdevc->type == (&gx_dc_pattern2)) && pdevc->ccolor_valid)
                           ...
                           const gx_hl_saved_color * psc2)
{
    ...
    if (((&psc1->saved_dev_color)->type == (&gx_dc_type_data_pure)) || psc1->saved_dev_color.type == &gx_dc_pure_masked) {
        if (psc1->saved_dev_color.colors.pure != psc2->saved_dev_color.colors.pure) {
            return(((bool)0));
        }
    }
    else if (((&psc1->saved_dev_color)->type == (&gx_dc_type_data_ht_binary))) {
    ...
    else if (((&psc1->saved_dev_color)->type == (&gx_dc_type_data_ht_colored))) {
    ...
    else if (((&psc1->saved_dev_color)->type == (&gx_dc_type_data_devn))) {
                ...
                const gx_device_color * pdevc)
{
    ...
    if (pgs != ((void*)0) && pdevc != ((void*)0) && pdevc->ccolor_valid)
        return ((bool)1);
    return ((bool)0);
}
...
{
    if (pdevc != ((void*)0) && pdevc->ccolor_valid) {
