...
gs_jpeg_error_exit(j_common_ptr cinfo)
{
    ...
    (jpeg_stream_data *) ((char *)cinfo -
                          ((int) ( (char *)&((jpeg_compress_data *)0)->cinfo - (char *)((jpeg_compress_data *)0) )));

    longjmp((*(jmp_buf *)( ((size_t)(jcomdp->exit_jmpbuf).stuff + ((size_t)&((gsfix_jmp_buf_test*)0)->j)) & ~(size_t)(((size_t)&((gsfix_jmp_buf_test*)0)->j)-1) )), 1);
}
...
{
    if (_setjmp ((*(jmp_buf *)( ((size_t)(st->data.common->exit_jmpbuf).stuff + ((size_t)&((gsfix_jmp_buf_test*)0)->j)) & ~(size_t)(((size_t)&((gsfix_jmp_buf_test*)0)->j)-1) )))) {
...
{
    if (st->data.common && _setjmp ((*(jmp_buf *)( ((size_t)(st->data.common->exit_jmpbuf).stuff + ((size_t)&((gsfix_jmp_buf_test*)0)->j)) & ~(size_t)(((size_t)&((gsfix_jmp_buf_test*)0)->j)-1) ))))
        return (gs_jpeg_log_error(st));
    if (st->data.compress)
        jpeg_destroy((j_common_ptr) & st->data.compress->cinfo);
    return 0;
}
# 190 "./base/sjpegc.c"
static __inline__ jpeg_compress_data *
cinfo2jcd(j_common_ptr cinfo)
{

    return (jpeg_compress_data *)
      ((byte *)cinfo - ((int) ( (char *)&((jpeg_compress_data *)0)->cinfo - (char *)((jpeg_compress_data *)0) )));
}
...
jpeg_alloc(j_common_ptr cinfo, size_t size, const char *info)
{
    ...
    return((*(mem)->procs.alloc_bytes)(mem, size, info));
}
...
jpeg_free(j_common_ptr cinfo, void *data, const char *info)
{
    ...
    ((mem)->procs.free_object(mem, data, info));
}
...
void
jpeg_free_large(j_common_ptr cinfo, void * object, size_t size)
{
