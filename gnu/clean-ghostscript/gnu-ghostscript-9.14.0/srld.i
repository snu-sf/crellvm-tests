...
static const gs_memory_struct_type_t st_RLD_state = { sizeof(stream_RLD_state), "RunLengthDecode state", 0, 0, gs_no_struct_enum_ptrs, gs_no_struct_reloc_ptrs, 0, 0 };
...
s_RLD_init(stream_state * st)
{
    ...
    return ((ss)->min_left = ((ss)->EndOfData ? 1 : 0), (ss)->copy_left = 0);
}
...
const stream_template s_RLD_template = {
    &st_RLD_state, s_RLD_init, s_RLD_process, 1, 1, ((void*)0),
    s_RLD_set_defaults
};
