# 1 "./openjpeg/libopenjpeg/tgt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/tgt.c" 2
# 34 "./openjpeg/libopenjpeg/tgt.c"
...
# 35 "./openjpeg/libopenjpeg/tgt.c" 2
...
opj_tgt_tree_t *opj_tgt_create(OPJ_UINT32 numleafsh, OPJ_UINT32 numleafsv) {
        ...
        tree = (opj_tgt_tree_t *) ((size_t)(sizeof(opj_tgt_tree_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(sizeof(opj_tgt_tree_t)));
        if(!tree) {
        ...
        tree->nodes = (opj_tgt_node_t*) ((size_t)(tree->numnodes) != 0 && (size_t)(tree->numnodes) >= (size_t)-0x100 / (size_t)(sizeof(opj_tgt_node_t)) ? ((void*)0) : calloc(tree->numnodes, sizeof(opj_tgt_node_t)));
        if(!tree->nodes) {
...
# 129 "./openjpeg/libopenjpeg/tgt.c"
opj_tgt_tree_t *opj_tgt_init(opj_tgt_tree_t * p_tree,OPJ_UINT32 p_num_leafs_h, OPJ_UINT32 p_num_leafs_v)
{
        ...
        if ((p_tree->numleafsh != p_num_leafs_h) || (p_tree->numleafsv != p_num_leafs_v)) {
                ...
                if (l_node_size > p_tree->nodes_size) {
                        opj_tgt_node_t* new_nodes = (opj_tgt_node_t*) ((size_t)(l_node_size) >= (size_t)-0x100 ? ((void*)0) : realloc(p_tree->nodes, l_node_size));
                        if (! new_nodes) {
