...
gs_ptr_type_t gs_param_typed_value_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gs_param_typed_value *pvalue = vptr; switch ( index ) { default: return 0;
    case 0:
    switch (pvalue->type) {
    case gs_param_type_string:
        return (pep->ptr = (&pvalue->value.s)->data, pep->size = (&pvalue->value.s)->size, (&ptr_string_procs));
    case gs_param_type_name:
        return (pep->ptr = (&pvalue->value.n)->data, pep->size = (&pvalue->value.n)->size, (&ptr_string_procs));
    case gs_param_type_int_array:
        return (pep->ptr = (const void *)(pvalue->value.ia.data), (&ptr_struct_procs));
    case gs_param_type_float_array:
        return (pep->ptr = (const void *)(pvalue->value.fa.data), (&ptr_struct_procs));
    case gs_param_type_string_array:
        return (pep->ptr = (const void *)(pvalue->value.sa.data), (&ptr_struct_procs));
    case gs_param_type_name_array:
        return (pep->ptr = (const void *)(pvalue->value.na.data), (&ptr_struct_procs));
    default:
        return (pep->ptr = (const void *)(0), (&ptr_struct_procs));
    }
} }
void gs_param_typed_value_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gs_param_typed_value *pvalue = vptr; {
    switch (pvalue->type) {
    case gs_param_type_string:
    case gs_param_type_name: {
        gs_const_string str;

        str.data = pvalue->value.s.data;
    ...
    case gs_param_type_int_array:
        (pvalue->value.ia.data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pvalue->value.ia.data), gcst)));
        break;
    case gs_param_type_float_array:
        (pvalue->value.fa.data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pvalue->value.fa.data), gcst)));
        break;
    case gs_param_type_string_array:
        (pvalue->value.sa.data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pvalue->value.sa.data), gcst)));
        break;
    case gs_param_type_name_array:
        (pvalue->value.na.data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(pvalue->value.na.data), gcst)));
        break;
    default:
        break;
    }
...
void
gs_param_list_set_persist_keys(gs_param_list *plist, bool persistent)
{
...
static const byte xfer_item_sizes[] = {
    0, sizeof(bool), sizeof(int), sizeof(long), sizeof(float), sizeof(gs_param_string), sizeof(gs_param_string), sizeof(gs_param_int_array), sizeof(gs_param_float_array), sizeof(gs_param_string_array), sizeof(gs_param_string_array), (0), (0), (0)
};
int
...
param_coerce_typed(gs_param_typed_value * pvalue, gs_param_type req_type,
                   gs_memory_t * mem)
{
    if (req_type == ((gs_param_type)-1) || pvalue->type == req_type)
        return 0;
        ...
        case gs_param_type_int_array:
            switch (req_type) {
                case gs_param_type_float_array:{
                        ...
                        if (mem == 0)
                            break;
                        fv = (float *)(*(mem)->procs.alloc_byte_array)(mem, size, sizeof(float), "int array => float array");
                        ...
                        pvalue->value.fa.persistent = ((bool)0);
                        goto ok;
                    }
                default:
                    break;
...
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_bool; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.b; return code;
}
int
param_read_int(gs_param_list * plist, gs_param_name pkey, int *pvalue)
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_int; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.i; return code;
}
int
param_read_long(gs_param_list * plist, gs_param_name pkey, long *pvalue)
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_long; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.l; return code;
}
int
param_read_float(gs_param_list * plist, gs_param_name pkey, float *pvalue)
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_float; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.f; return code;
}
int
param_read_string(gs_param_list * plist, gs_param_name pkey,
                  gs_param_string * pvalue)
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_string; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.s; return code;
}
int
param_read_name(gs_param_list * plist, gs_param_name pkey,
                gs_param_string * pvalue)
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_string; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.n; return code;
}
int
param_read_int_array(gs_param_list * plist, gs_param_name pkey,
                     gs_param_int_array * pvalue)
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_int_array; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.ia; return code;
}
int
param_read_float_array(gs_param_list * plist, gs_param_name pkey,
                       gs_param_float_array * pvalue)
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_float_array; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.fa; return code;
}
int
param_read_string_array(gs_param_list * plist, gs_param_name pkey,
                        gs_param_string_array * pvalue)
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_string_array; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.sa; return code;
}
int
param_read_name_array(gs_param_list * plist, gs_param_name pkey,
                      gs_param_string_array * pvalue)
{
    gs_param_typed_value typed; int code; typed.type = gs_param_type_name_array; code = param_read_requested_typed(plist, pkey, &typed); if ( code == 0 ) *pvalue = typed.value.na; return code;
}
# 359 "./base/gsparam.c"
int
param_write_null(gs_param_list * plist, gs_param_name pkey)
{
    ...
    typed.type = gs_param_type_null;
    return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
param_write_bool(gs_param_list * plist, gs_param_name pkey, const bool * pvalue)
{
    gs_param_typed_value typed; typed.value.b = *pvalue; typed.type = gs_param_type_bool; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
param_write_int(gs_param_list * plist, gs_param_name pkey, const int *pvalue)
{
    gs_param_typed_value typed; typed.value.i = *pvalue; typed.type = gs_param_type_int; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
param_write_long(gs_param_list * plist, gs_param_name pkey, const long *pvalue)
{
    gs_param_typed_value typed; typed.value.l = *pvalue; typed.type = gs_param_type_long; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
param_write_float(gs_param_list * plist, gs_param_name pkey,
                  const float *pvalue)
{
    gs_param_typed_value typed; typed.value.f = *pvalue; typed.type = gs_param_type_float; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
param_write_string(gs_param_list * plist, gs_param_name pkey,
                   const gs_param_string * pvalue)
{
    gs_param_typed_value typed; typed.value.s = *pvalue; typed.type = gs_param_type_string; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
param_write_name(gs_param_list * plist, gs_param_name pkey,
                 const gs_param_string * pvalue)
{
    gs_param_typed_value typed; typed.value.n = *pvalue; typed.type = gs_param_type_name; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
param_write_int_array(gs_param_list * plist, gs_param_name pkey,
                      const gs_param_int_array * pvalue)
{
    gs_param_typed_value typed; typed.value.ia = *pvalue; typed.type = gs_param_type_int_array; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
...
{
    gs_param_typed_value typed; typed.value.fa = *pvalue; typed.type = gs_param_type_float_array; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
...
{
    gs_param_typed_value typed; typed.value.sa = *pvalue; typed.type = gs_param_type_string_array; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
int
param_write_name_array(gs_param_list * plist, gs_param_name pkey,
                       const gs_param_string_array * pvalue)
{
    gs_param_typed_value typed; typed.value.na = *pvalue; typed.type = gs_param_type_name_array; return (*(plist)->procs->xmit_typed)(plist, pkey, &typed);
}
