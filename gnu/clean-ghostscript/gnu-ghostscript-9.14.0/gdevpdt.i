# 1 "./devices/vector/gdevpdt.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpdt.c" 2
# 18 "./devices/vector/gdevpdt.c"
# 1 "./base/gx.h" 1
# 22 "./base/gx.h"
# 1 "./base/stdio_.h" 1
# 26 "./base/stdio_.h"
...
# 24 "./devices/vector/gdevpdt.c" 2


static const gc_ptr_element_t pdf_text_data_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((pdf_text_data_t *)0)->outline_fonts - (char *)((pdf_text_data_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((pdf_text_data_t *)0)->bitmap_fonts - (char *)((pdf_text_data_t *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((pdf_text_data_t *)0)->text_state - (char *)((pdf_text_data_t *)0) )) } }; static const gc_struct_data_t pdf_text_data_reloc_ptrs = { (sizeof(pdf_text_data_enum_ptrs) / sizeof((pdf_text_data_enum_ptrs)[0])), 0, 0, pdf_text_data_enum_ptrs }; static const gs_memory_struct_type_t st_pdf_text_data = { sizeof(pdf_text_data_t), "pdf_text_data_t", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &pdf_text_data_reloc_ptrs };
...
{
    pdf_text_data_t *ptd =
        (pdf_text_data_t *)(*(mem)->procs.alloc_struct)(mem, &st_pdf_text_data, "pdf_text_data_alloc");
    ...
    if (pts == 0 || pbfs == 0 || pofs == 0 || ptd == 0) {
        ((mem)->procs.free_object(mem, pts, "pdf_text_data_alloc"));
        ((mem)->procs.free_object(mem, pbfs, "pdf_text_data_alloc"));
        ((mem)->procs.free_object(mem, pofs, "pdf_text_data_alloc"));
        ((mem)->procs.free_object(mem, ptd, "pdf_text_data_alloc"));
        return 0;
    }
...
int text_data_free(gs_memory_t *mem, pdf_text_data_t *ptd)
{
    ((mem)->procs.free_object(mem, ptd->outline_fonts->standard_fonts, "Free text Outline standard fonts"));;
    ((mem)->procs.free_object(mem, ptd->outline_fonts, "Free text Outline fonts"));;
    ((mem)->procs.free_object(mem, ptd->bitmap_fonts, "Free text Bitmap fotns"));;
    ((mem)->procs.free_object(mem, ptd->text_state, "Free text state"));;
    ((mem)->procs.free_object(mem, ptd, "Free text"));
