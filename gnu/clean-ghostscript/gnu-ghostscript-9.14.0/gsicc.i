...
# 34 "./base/gsicc.c" 2
# 46 "./base/gsicc.c"
static int gx_num_components_ICC(const gs_color_space *);
static void gx_init_ICC(gs_client_color *, const gs_color_space *);
static void gx_restrict_ICC(gs_client_color *, const gs_color_space *);
static int gx_concretize_ICC(const gs_client_color *, const gs_color_space *, frac *, const gs_imager_state *, gx_device *);
static int gx_remap_ICC(const gs_client_color *, const gs_color_space *, gx_device_color *, const gs_imager_state *, gx_device *, gs_color_select_t);
static int gx_install_ICC(gs_color_space *, gs_state *);
static int gx_remap_concrete_ICC(const frac *, const gs_color_space * pcs, gx_device_color *, const gs_imager_state *, gx_device *, gs_color_select_t);
static void gx_final_ICC(const gs_color_space *);
static int gx_serialize_ICC(const gs_color_space *, stream *);
static int gx_cspace_is_linear_ICC(const gs_color_space *cs, const gs_imager_state * pis, gx_device *dev, const gs_client_color *c0, const gs_client_color *c1, const gs_client_color *c2, const gs_client_color *c3, float smoothness, gsicc_link_t *icclink);
static int gx_set_overprint_ICC(const gs_color_space *, gs_state *);
static gx_color_polarity_t gx_polarity_ICC(const gs_color_space *);
int gx_remap_ICC_imagelab(const gs_client_color *, const gs_color_space *, gx_device_color *, const gs_imager_state *, gx_device *, gs_color_select_t);
                        ...
                        float smoothness, gsicc_link_t *icclink)
{
    ...
    int ndes;
    int code;
    unsigned short src0[(64)];
    unsigned short src1[(64)];
    unsigned short src01[(64)];
    unsigned short des0[(64)];
    unsigned short des1[(64)];
    unsigned short des01[(64)];
    unsigned short interp_des;
    unsigned short max_diff = (unsigned short) (((1) > (65535 * smoothness)) ? (1) : (65535 * smoothness));
    int k;
    ...
    for (k = 0; k < ndes; k++) {
        ...
        if ((((signed int) interp_des - (signed int) des01[k]) < 0 ? -((signed int) interp_des - (signed int) des01[k]) : ((signed int) interp_des - (signed int) des01[k])) > max_diff)
            return ((bool)0);
    }
    return 1;
}
                ...
                const gs_client_color *c2, float smoothness, gsicc_link_t *icclink)
{
    ...
    unsigned short src0[(64)];
    unsigned short src1[(64)];
    unsigned short src2[(64)];
    unsigned short des0[(64)];
    unsigned short des1[(64)];
    unsigned short des2[(64)];
    unsigned short src01[(64)];
    unsigned short src12[(64)];
    unsigned short src02[(64)];
    unsigned short src012[(64)];
    unsigned short des01[(64)];
    unsigned short des12[(64)];
    unsigned short des02[(64)];
    unsigned short des012[(64)];
    int nsrc = cs->type->num_components(cs);
    int ndes, code;
    unsigned short max_diff = (unsigned short) (((1) > (65535 * smoothness)) ? (1) : (65535 * smoothness));
    ...
    for (k = 0; k < ndes; k++){
        ...
        if ((((signed int) interp_des - (signed int) des02[k]) < 0 ? -((signed int) interp_des - (signed int) des02[k]) : ((signed int) interp_des - (signed int) des02[k])) > max_diff)
            return ((bool)0);
        interp_des = (des1[k] + des2[k]) >> 1;
        if ((((signed int) interp_des - (signed int) des12[k]) < 0 ? -((signed int) interp_des - (signed int) des12[k]) : ((signed int) interp_des - (signed int) des12[k])) > max_diff)
            return ((bool)0);

        interp_des = (des0[k] + interp_des) >> 1;
        if ((((signed int) interp_des - (signed int) des012[k]) < 0 ? -((signed int) interp_des - (signed int) des012[k]) : ((signed int) interp_des - (signed int) des012[k])) > max_diff)
            return ((bool)0);
    }
    return 1;
}
                ...
                float smoothness, gsicc_link_t *icclink)
{
    ...
    if (((( (dev)->color_info.num_components > 1 || (dev)->color_info.gray_index == 0xff ) ? (dev)->color_info.max_color : (dev)->color_info.max_gray) < 31)) return 0;
    if (icclink->is_identity) return 1;
                          ...
                          gs_color_select_t select)
{
    ...
    if (dev_profile->spotnames != ((void*)0) &&
        ...
        dev_profile->spotnames->equiv_cmyk_set = ((bool)1);
    }
                ...
                gs_color_select_t select)
{
    ...
    if (dev_profile == ((void*)0))
        return gs_throw_imp(__func__, "./base/gsicc.c", 381, 0, (-100), "Attempting to do ICC remap with no profile");
    ...
    memset(psrc_cm,0,sizeof(unsigned short)*(64));
    ...
    icc_link = gsicc_get_link(pis, dev, pcs, ((void*)0), &rendering_params, pis->memory);
    if (icc_link == ((void*)0)) {
        return gs_throw_imp(__func__, "./base/gsicc.c", 407, 1, -1, "Could not create ICC link:  Check profiles");
    }
...
# 431 "./base/gsicc.c"
    ...
    for ( k = 0; k < num_des_comps; k++){
        conc[k] = ((frac)( ((psrc_temp[k]) >> (((1 << 1) * 8) - 15)) - ((psrc_temp[k]) >> (((1 << 1) * 8) - 3)) ));
    }
                ...
                gs_color_select_t select)
{
    ...
    icc_link = gsicc_get_link(pis, dev, pcs, ((void*)0), &rendering_params, pis->memory);
    if (icc_link == ((void*)0)) {
        return gs_throw_imp(__func__, "./base/gsicc.c", 488, 1, -1, "Could not create ICC link:  Check profiles");
    }
    if (icc_link->is_identity) {
        psrc_temp = &(psrc[0]);
    } else {
...
gx_concretize_ICC(
    ...
    icc_link = gsicc_get_link(pis, dev, pcs, ((void*)0), &rendering_params, pis->memory);
    if (icc_link == ((void*)0)) {
        return gs_throw_imp(__func__, "./base/gsicc.c", 551, 1, -1, "Could not create ICC link:  Check profiles");
    }
    ...
    for (k = 0; k < num_des_comps; k++){
        pconc[k] = ((frac)(((((float) psrc_temp[k])/65535.0) + 0.5 / ((float)((frac)0x7ff8))) * ((float)((frac)0x7ff8))));
    }
...
gx_serialize_ICC(const gs_color_space * pcs, stream * s)
{
    ...
    code = sputs(s, (byte *)profile__serial, ((char *)&(((cmm_profile_t *)(((void*)0)))->buffer) - (char *)(((void*)0))), &n);
    return(code);
}
...
gx_set_overprint_ICC(const gs_color_space * pcs, gs_state * pgs)
{
    ...
    cmm_dev_profile_t *dev_profile;
    int code = ((dev)->procs.get_profile)(dev, &dev_profile);
