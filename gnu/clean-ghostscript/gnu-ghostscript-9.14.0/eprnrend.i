# 1 "./contrib/pcl3/eprn/eprnrend.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./contrib/pcl3/eprn/eprnrend.c" 2
# 49 "./contrib/pcl3/eprn/eprnrend.c"
static const char
  cm_id[] = "@(#)$Id: eprnrend.c,v 1.15 2001/08/01 05:12:56 Martin Rel $";
# 61 "./contrib/pcl3/eprn/eprnrend.c"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
# 1 "./base/stdpre.h" 1
# 253 "./base/stdpre.h"
...
# 62 "./contrib/pcl3/eprn/eprnrend.c" 2
...
# 41 "./base/assert_.h" 2
# 65 "./contrib/pcl3/eprn/eprnrend.c" 2
...
# 66 "./contrib/pcl3/eprn/eprnrend.c" 2
...
# 74 "./contrib/pcl3/eprn/eprnrend.c" 2
# 121 "./contrib/pcl3/eprn/eprnrend.c"
unsigned int eprn_number_of_bitplanes(eprn_Device *dev)
{
  return dev->eprn.output_planes;
}
# 136 "./contrib/pcl3/eprn/eprnrend.c"
...
# 163 "./contrib/pcl3/eprn/eprnrend.c"
gx_color_index eprn_map_rgb_color_for_RGB(gx_device *device,
  const gx_color_value cv[])
{
  gx_color_value red = cv[0], green = cv[1], blue = cv[2];
  static const gx_color_value half = ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1))/2;
  ...
  if (red > half) value |= 2U;
  if (green > half) value |= 4U;
  if (blue > half) value |= 8U;
...
# 244 "./contrib/pcl3/eprn/eprnrend.c"
...
# 261 "./contrib/pcl3/eprn/eprnrend.c"
  step = ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1))/eprn->non_black_levels;
...
# 289 "./contrib/pcl3/eprn/eprnrend.c"
gx_color_index eprn_map_rgb_color_for_CMY_or_K_flex(gx_device *device,
  const gx_color_value cv[])
{
  gx_color_value red = cv[0], green = cv[1], blue = cv[2];
  const eprn_Device *dev = (eprn_Device *)device;
# 305 "./contrib/pcl3/eprn/eprnrend.c"
  gx_color_value tmpcv[4];
  if (dev->eprn.colour_model != eprn_DeviceCMY && red == green && green == blue) {
    tmpcv[0] = 0; tmpcv[1] = 0; tmpcv[2] = 0;
    tmpcv[3] = ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) - red;
    return eprn_map_cmyk_color_flex(device, tmpcv);

  }
  tmpcv[0] = ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) - red;
  tmpcv[1] = ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) - green;
  tmpcv[2] = ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1)) - blue;
  tmpcv[3] = 0;
  return eprn_map_cmyk_color_flex(device, tmpcv);
}
# 328 "./contrib/pcl3/eprn/eprnrend.c"
  ...
  const gx_color_value cv[])
{
  ...
  value = ((unsigned int)((red) >> 8)) << 8;
  value |= ((unsigned int)((green) >> 8)) << 16;
  value |= ((unsigned int)((blue) >> 8)) << 24;
...
# 410 "./contrib/pcl3/eprn/eprnrend.c"
  ...
  gx_color_value rgb[])
{
  ...
  if (((eprn_Device *)device)->eprn.colour_model == eprn_DeviceRGB)
    rgb[0] = rgb[1] = rgb[2] = ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1));
  else
    rgb[0] = rgb[1] = rgb[2] = 0;

  return -1;
}
# 436 "./contrib/pcl3/eprn/eprnrend.c"
gx_color_index eprn_map_cmyk_color(gx_device *device,
  const gx_color_value cv[])
{
  gx_color_value cyan = cv[0], magenta = cv[1], yellow = cv[2], black = cv[3];
  gx_color_index value = 0;
  static const gx_color_value threshold = ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1))/2;
  ...
  if (cyan > threshold) value |= 2U;
  if (magenta > threshold) value |= 4U;
  if (yellow > threshold) value |= 8U;
  if (black > threshold) value |= 1U;
...
# 470 "./contrib/pcl3/eprn/eprnrend.c"
  ...
  const gx_color_value cv[])
{
  ...
  unsigned int level;
  const eprn_Eprn *eprn = &((eprn_Device *)device)->eprn;
# 515 "./contrib/pcl3/eprn/eprnrend.c"
  ...
  if (eprn->colour_model != eprn_DeviceCMY) {
    step = ((gx_color_value)((1L << (sizeof(gx_color_value) * 8)) - 1))/eprn->black_levels;
    level = black/step;
...
# 551 "./contrib/pcl3/eprn/eprnrend.c"
  ...
  const gx_color_value cv[])
{
  ...
  value = ((unsigned int)((black) >> 8));
  value |= ((unsigned int)((cyan) >> 8)) << 8;
  value |= ((unsigned int)((magenta) >> 8)) << 16;
  value |= ((unsigned int)((yellow) >> 8)) << 24;
...
# 582 "./contrib/pcl3/eprn/eprnrend.c"
...
# 614 "./contrib/pcl3/eprn/eprnrend.c"
...
# 680 "./contrib/pcl3/eprn/eprnrend.c"
...
# 771 "./contrib/pcl3/eprn/eprnrend.c"
...
# 854 "./contrib/pcl3/eprn/eprnrend.c"
  ...
  int length, eprn_OctetString plane[])
{
  ...
  while (k < length) {
    ...
    for (l = 0; l < 4 && k < length; l++, k++) {
      eprn_Octet part;
# 889 "./contrib/pcl3/eprn/eprnrend.c"
      part = (line[k] >> 4) & 0x0F;
      octet[0] <<= 1; if (part & 1U) octet[0] |= 1; octet[1] <<= 1; if (part & 2U) octet[1] |= 1; octet[2] <<= 1; if (part & 4U) octet[2] |= 1; octet[3] <<= 1; if (part & 8U) octet[3] |= 1;
...
# 930 "./contrib/pcl3/eprn/eprnrend.c"
  ...
  int length, eprn_OctetString plane[])
{
  ...
  for (k = 0; k < length; k++) {
    ...
    *ptr[1] = (*ptr[1] << 1) | (pixel >> 1) & 0x01;
    *ptr[2] = (*ptr[2] << 1) | (pixel >> 2) & 0x01;
    *ptr[3] = (*ptr[3] << 1) | (pixel >> 3) & 0x01;
    *ptr[4] = (*ptr[4] << 1) | (pixel >> 4) & 0x01;
    *ptr[5] = (*ptr[5] << 1) | (pixel >> 5) & 0x01;
    *ptr[6] = (*ptr[6] << 1) | (pixel >> 6) & 0x01;
    *ptr[7] = (*ptr[7] << 1) | (pixel >> 7) & 0x01;
...
# 1006 "./contrib/pcl3/eprn/eprnrend.c"
...
# 1047 "./contrib/pcl3/eprn/eprnrend.c"
  return 0;
}
# 1058 "./contrib/pcl3/eprn/eprnrend.c"
int eprn_get_planes(eprn_Device *dev, eprn_OctetString bitplanes[])
{
  eprn_OctetString *line;
  int
    j,
    rc;
...
# 1111 "./contrib/pcl3/eprn/eprnrend.c"
    if (dev->eprn.colour_model == eprn_DeviceGray)
...
# 1134 "./contrib/pcl3/eprn/eprnrend.c"
          line->str[line->length - 1] |= 2U | 4U | 8U;
        }
