...
# 34 "./base/gsistate.c" 2
# 43 "./base/gsistate.c"
extern gx_color_map_procs *const cmap_procs_default;


static
gs_ptr_type_t line_params_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { const gx_line_params *plp = vptr; switch ( index ) { default: return 0;
    case 0: return (pep->ptr = (const void *)((plp->dash.pattern_size == 0 ? ((void*)0) : plp->dash.pattern)), (&ptr_struct_procs));

} }
static void line_params_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { gx_line_params *plp = vptr;
{
    if (plp->dash.pattern_size)
        (plp->dash.pattern = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(plp->dash.pattern), gcst)));
} }
static const gs_memory_struct_type_t st_line_params = { sizeof(gx_line_params), "line_params", 0, 0, line_params_enum_ptrs, line_params_reloc_ptrs, 0, 0 };
# 65 "./base/gsistate.c"
static gs_ptr_type_t imager_state_enum_ptrs(const gs_memory_t *mem, const void *ptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); static void imager_state_reloc_ptrs(void *ptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst); const gs_memory_struct_type_t st_imager_state = { sizeof(gs_imager_state), "gs_imager_state", 0, 0, imager_state_enum_ptrs, imager_state_reloc_ptrs, 0, 0 };
static
gs_ptr_type_t imager_state_enum_ptrs(const gs_memory_t *mem, const void *vptr, uint size, int index, enum_ptr_t *pep, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) { switch ( index ) { default:
    return (*(st_line_params).enum_ptrs)(mem, &((const gs_imager_state *)vptr)->line_params, sizeof(((const gs_imager_state *)vptr)->line_params), index-((1 + 14 + 5) - 1), pep, &(st_line_params), gcst);
    case 0: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->client_data), (&ptr_struct_procs));
    case 1: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->trans_device), (&ptr_struct_procs));
    case 2: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->icc_manager), (&ptr_struct_procs));
    case 3: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->icc_link_cache), (&ptr_struct_procs));
    case 4: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->icc_profile_cache), (&ptr_struct_procs));

    case 0 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->halftone), (&ptr_struct_procs)); case 1 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->dev_ht), (&ptr_struct_procs)); case 2 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->cie_render), (&ptr_struct_procs)); case 3 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->black_generation), (&ptr_struct_procs)); case 4 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->undercolor_removal), (&ptr_struct_procs)); case 5 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->set_transfer.red), (&ptr_struct_procs)); case 6 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->set_transfer.green), (&ptr_struct_procs)); case 7 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->set_transfer.blue), (&ptr_struct_procs)); case 8 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->set_transfer.gray), (&ptr_struct_procs)); case 9 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->cie_joint_caches), (&ptr_struct_procs)); case 10 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->pattern_cache), (&ptr_struct_procs)); case 11 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->devicergb_cs), (&ptr_struct_procs)); case 12 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->devicecmyk_cs), (&ptr_struct_procs)); case 13 +5: return (pep->ptr = (const void *)(((const gs_imager_state *)vptr)->cie_joint_caches_alt), (&ptr_struct_procs));

} }
static void imager_state_reloc_ptrs(void *vptr, uint size, const gs_memory_struct_type_t *pstype, gc_state_t *gcst) {
{
    (*(st_line_params).reloc_ptrs)(&((gs_imager_state *)vptr)->line_params, sizeof(((gs_imager_state *)vptr)->line_params), &(st_line_params), gcst);
    (((gs_imager_state *)vptr)->client_data = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->client_data), gcst)));
    (((gs_imager_state *)vptr)->trans_device = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->trans_device), gcst)));
    (((gs_imager_state *)vptr)->icc_manager = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->icc_manager), gcst)));
    (((gs_imager_state *)vptr)->icc_link_cache = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->icc_link_cache), gcst)));
    (((gs_imager_state *)vptr)->icc_profile_cache = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->icc_profile_cache), gcst)));

    (((gs_imager_state *)vptr)->halftone = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->halftone), gcst))); (((gs_imager_state *)vptr)->dev_ht = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->dev_ht), gcst))); (((gs_imager_state *)vptr)->cie_render = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->cie_render), gcst))); (((gs_imager_state *)vptr)->black_generation = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->black_generation), gcst))); (((gs_imager_state *)vptr)->undercolor_removal = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->undercolor_removal), gcst))); (((gs_imager_state *)vptr)->set_transfer.red = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->set_transfer.red), gcst))); (((gs_imager_state *)vptr)->set_transfer.green = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->set_transfer.green), gcst))); (((gs_imager_state *)vptr)->set_transfer.blue = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->set_transfer.blue), gcst))); (((gs_imager_state *)vptr)->set_transfer.gray = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->set_transfer.gray), gcst))); (((gs_imager_state *)vptr)->cie_joint_caches = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->cie_joint_caches), gcst))); (((gs_imager_state *)vptr)->pattern_cache = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->pattern_cache), gcst))); (((gs_imager_state *)vptr)->devicergb_cs = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->devicergb_cs), gcst))); (((gs_imager_state *)vptr)->devicecmyk_cs = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->devicecmyk_cs), gcst))); (((gs_imager_state *)vptr)->cie_joint_caches_alt = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->cie_joint_caches_alt), gcst)));

    {
        int i = (8 * 8) - 1;

        for (; i >= 0; i--)
            (((gs_imager_state *)vptr)->effective_transfer[i] = (((*(const gc_procs_common_t **)(gcst))->reloc_struct_ptr)((const void *)(((gs_imager_state *)vptr)->effective_transfer[i]), gcst)));
    }
} }
...
gs_imager_state_initialize(gs_imager_state * pis, gs_memory_t * mem)
{
    ...
    pis->dev_ht = 0;
    pis->cie_render = 0;
    pis->cie_to_xyz = ((bool)0);
    pis->black_generation = 0;
    pis->undercolor_removal = 0;

    do { if ( ((pis->set_transfer.gray) = (gx_transfer_map *)(*(mem)->procs.alloc_struct)(mem, &st_transfer_map, "gs_imager_state_init(transfer)")) == 0 ) { return ((-25)); } else { do { (pis->set_transfer.gray)->rc.ref_count = 1; (pis->set_transfer.gray)->rc.memory = mem; (pis->set_transfer.gray)->rc.free = rc_free_struct_only; do { } while (0); } while (0); } } while (0);



    pis->set_transfer.gray->proc = gs_identity_transfer;
    pis->set_transfer.gray->id = gs_next_ids(pis->memory, 1);
    pis->set_transfer.gray->values[0] = ((frac)0);
    pis->set_transfer.red =
        pis->set_transfer.green =
        pis->set_transfer.blue = ((void*)0);
    for (i = 0; i < (8 * 8); i++)
        pis->effective_transfer[i] = pis->set_transfer.gray;
    pis->cie_joint_caches = ((void*)0);
    pis->cie_joint_caches_alt = ((void*)0);
    pis->cmap_procs = cmap_procs_default;
    pis->pattern_cache = ((void*)0);
    pis->have_pattern_streams = ((bool)0);
...
gs_imager_state_copy(const gs_imager_state * pis, gs_memory_t * mem)
{
    gs_imager_state *pis_copy =
        (gs_imager_state *)(*(mem)->procs.alloc_struct)(mem, &st_imager_state, "gs_imager_state_copy");
...
{
    do { if (pis->halftone) do { (pis->halftone)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->dev_ht) do { (pis->dev_ht)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->cie_render) do { (pis->cie_render)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->black_generation) do { (pis->black_generation)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->undercolor_removal) do { (pis->undercolor_removal)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->set_transfer.gray) do { (pis->set_transfer.gray)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->set_transfer.red) do { (pis->set_transfer.red)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->set_transfer.green) do { (pis->set_transfer.green)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->set_transfer.blue) do { (pis->set_transfer.blue)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->cie_joint_caches) do { (pis->cie_joint_caches)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->cie_joint_caches_alt) do { (pis->cie_joint_caches_alt)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->devicergb_cs) do { (pis->devicergb_cs)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->devicecmyk_cs) do { (pis->devicecmyk_cs)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->icc_link_cache) do { (pis->icc_link_cache)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->icc_profile_cache) do { (pis->icc_profile_cache)->rc.ref_count++; do { } while (0); } while (0); } while (0);
    do { if (pis->icc_manager) do { (pis->icc_manager)->rc.ref_count++; do { } while (0); } while (0); } while (0);
}
...
gs_imager_state_pre_assign(gs_imager_state *pto, const gs_imager_state *pfrom)
{
    ...
    do { if ((pto->cie_joint_caches) != (pfrom->cie_joint_caches)) { do { if (pfrom->cie_joint_caches) do { (pfrom->cie_joint_caches)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->cie_joint_caches) { do { do { } while (0); (pto->cie_joint_caches)->rc.ref_count += (-1); } while (0); if (!(pto->cie_joint_caches)->rc.ref_count) { do { do { } while (0); (pto->cie_joint_caches)->rc.free((pto->cie_joint_caches)->rc.memory, (void *)(pto->cie_joint_caches), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->cie_joint_caches_alt) != (pfrom->cie_joint_caches_alt)) { do { if (pfrom->cie_joint_caches_alt) do { (pfrom->cie_joint_caches_alt)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->cie_joint_caches_alt) { do { do { } while (0); (pto->cie_joint_caches_alt)->rc.ref_count += (-1); } while (0); if (!(pto->cie_joint_caches_alt)->rc.ref_count) { do { do { } while (0); (pto->cie_joint_caches_alt)->rc.free((pto->cie_joint_caches_alt)->rc.memory, (void *)(pto->cie_joint_caches_alt), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->set_transfer.blue) != (pfrom->set_transfer.blue)) { do { if (pfrom->set_transfer.blue) do { (pfrom->set_transfer.blue)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->set_transfer.blue) { do { do { } while (0); (pto->set_transfer.blue)->rc.ref_count += (-1); } while (0); if (!(pto->set_transfer.blue)->rc.ref_count) { do { do { } while (0); (pto->set_transfer.blue)->rc.free((pto->set_transfer.blue)->rc.memory, (void *)(pto->set_transfer.blue), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->set_transfer.green) != (pfrom->set_transfer.green)) { do { if (pfrom->set_transfer.green) do { (pfrom->set_transfer.green)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->set_transfer.green) { do { do { } while (0); (pto->set_transfer.green)->rc.ref_count += (-1); } while (0); if (!(pto->set_transfer.green)->rc.ref_count) { do { do { } while (0); (pto->set_transfer.green)->rc.free((pto->set_transfer.green)->rc.memory, (void *)(pto->set_transfer.green), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->set_transfer.red) != (pfrom->set_transfer.red)) { do { if (pfrom->set_transfer.red) do { (pfrom->set_transfer.red)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->set_transfer.red) { do { do { } while (0); (pto->set_transfer.red)->rc.ref_count += (-1); } while (0); if (!(pto->set_transfer.red)->rc.ref_count) { do { do { } while (0); (pto->set_transfer.red)->rc.free((pto->set_transfer.red)->rc.memory, (void *)(pto->set_transfer.red), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->set_transfer.gray) != (pfrom->set_transfer.gray)) { do { if (pfrom->set_transfer.gray) do { (pfrom->set_transfer.gray)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->set_transfer.gray) { do { do { } while (0); (pto->set_transfer.gray)->rc.ref_count += (-1); } while (0); if (!(pto->set_transfer.gray)->rc.ref_count) { do { do { } while (0); (pto->set_transfer.gray)->rc.free((pto->set_transfer.gray)->rc.memory, (void *)(pto->set_transfer.gray), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->undercolor_removal) != (pfrom->undercolor_removal)) { do { if (pfrom->undercolor_removal) do { (pfrom->undercolor_removal)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->undercolor_removal) { do { do { } while (0); (pto->undercolor_removal)->rc.ref_count += (-1); } while (0); if (!(pto->undercolor_removal)->rc.ref_count) { do { do { } while (0); (pto->undercolor_removal)->rc.free((pto->undercolor_removal)->rc.memory, (void *)(pto->undercolor_removal), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->black_generation) != (pfrom->black_generation)) { do { if (pfrom->black_generation) do { (pfrom->black_generation)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->black_generation) { do { do { } while (0); (pto->black_generation)->rc.ref_count += (-1); } while (0); if (!(pto->black_generation)->rc.ref_count) { do { do { } while (0); (pto->black_generation)->rc.free((pto->black_generation)->rc.memory, (void *)(pto->black_generation), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->cie_render) != (pfrom->cie_render)) { do { if (pfrom->cie_render) do { (pfrom->cie_render)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->cie_render) { do { do { } while (0); (pto->cie_render)->rc.ref_count += (-1); } while (0); if (!(pto->cie_render)->rc.ref_count) { do { do { } while (0); (pto->cie_render)->rc.free((pto->cie_render)->rc.memory, (void *)(pto->cie_render), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->dev_ht) != (pfrom->dev_ht)) { do { if (pfrom->dev_ht) do { (pfrom->dev_ht)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->dev_ht) { do { do { } while (0); (pto->dev_ht)->rc.ref_count += (-1); } while (0); if (!(pto->dev_ht)->rc.ref_count) { do { do { } while (0); (pto->dev_ht)->rc.free((pto->dev_ht)->rc.memory, (void *)(pto->dev_ht), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->halftone) != (pfrom->halftone)) { do { if (pfrom->halftone) do { (pfrom->halftone)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->halftone) { do { do { } while (0); (pto->halftone)->rc.ref_count += (-1); } while (0); if (!(pto->halftone)->rc.ref_count) { do { do { } while (0); (pto->halftone)->rc.free((pto->halftone)->rc.memory, (void *)(pto->halftone), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->devicergb_cs) != (pfrom->devicergb_cs)) { do { if (pfrom->devicergb_cs) do { (pfrom->devicergb_cs)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->devicergb_cs) { do { do { } while (0); (pto->devicergb_cs)->rc.ref_count += (-1); } while (0); if (!(pto->devicergb_cs)->rc.ref_count) { do { do { } while (0); (pto->devicergb_cs)->rc.free((pto->devicergb_cs)->rc.memory, (void *)(pto->devicergb_cs), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->devicecmyk_cs) != (pfrom->devicecmyk_cs)) { do { if (pfrom->devicecmyk_cs) do { (pfrom->devicecmyk_cs)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->devicecmyk_cs) { do { do { } while (0); (pto->devicecmyk_cs)->rc.ref_count += (-1); } while (0); if (!(pto->devicecmyk_cs)->rc.ref_count) { do { do { } while (0); (pto->devicecmyk_cs)->rc.free((pto->devicecmyk_cs)->rc.memory, (void *)(pto->devicecmyk_cs), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->icc_link_cache) != (pfrom->icc_link_cache)) { do { if (pfrom->icc_link_cache) do { (pfrom->icc_link_cache)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->icc_link_cache) { do { do { } while (0); (pto->icc_link_cache)->rc.ref_count += (-1); } while (0); if (!(pto->icc_link_cache)->rc.ref_count) { do { do { } while (0); (pto->icc_link_cache)->rc.free((pto->icc_link_cache)->rc.memory, (void *)(pto->icc_link_cache), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->icc_profile_cache) != (pfrom->icc_profile_cache)) { do { if (pfrom->icc_profile_cache) do { (pfrom->icc_profile_cache)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->icc_profile_cache) { do { do { } while (0); (pto->icc_profile_cache)->rc.ref_count += (-1); } while (0); if (!(pto->icc_profile_cache)->rc.ref_count) { do { do { } while (0); (pto->icc_profile_cache)->rc.free((pto->icc_profile_cache)->rc.memory, (void *)(pto->icc_profile_cache), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
    do { if ((pto->icc_manager) != (pfrom->icc_manager)) { do { if (pfrom->icc_manager) do { (pfrom->icc_manager)->rc.ref_count++; do { } while (0); } while (0); } while (0); do { if (pto->icc_manager) { do { do { } while (0); (pto->icc_manager)->rc.ref_count += (-1); } while (0); if (!(pto->icc_manager)->rc.ref_count) { do { do { } while (0); (pto->icc_manager)->rc.free((pto->icc_manager)->rc.memory, (void *)(pto->icc_manager), cname); } while (0); do { } while (0); } else do { } while (0); } } while (0); } } while (0);
...
gs_imager_state_release(gs_imager_state * pis)
{
    ...
    do { if (pis->cie_joint_caches) { do { do { } while (0); (pis->cie_joint_caches)->rc.ref_count += (-1); } while (0); if (!(pis->cie_joint_caches)->rc.ref_count) { do { do { } while (0); (pis->cie_joint_caches)->rc.free((pis->cie_joint_caches)->rc.memory, (void *)(pis->cie_joint_caches), cname); } while (0); (pis->cie_joint_caches) = 0; } else do { } while (0); } } while (0); pis->cie_joint_caches = ((void*)0);
    do { if (pis->set_transfer.gray) { do { do { } while (0); (pis->set_transfer.gray)->rc.ref_count += (-1); } while (0); if (!(pis->set_transfer.gray)->rc.ref_count) { do { do { } while (0); (pis->set_transfer.gray)->rc.free((pis->set_transfer.gray)->rc.memory, (void *)(pis->set_transfer.gray), cname); } while (0); (pis->set_transfer.gray) = 0; } else do { } while (0); } } while (0); pis->set_transfer.gray = ((void*)0);
    do { if (pis->set_transfer.blue) { do { do { } while (0); (pis->set_transfer.blue)->rc.ref_count += (-1); } while (0); if (!(pis->set_transfer.blue)->rc.ref_count) { do { do { } while (0); (pis->set_transfer.blue)->rc.free((pis->set_transfer.blue)->rc.memory, (void *)(pis->set_transfer.blue), cname); } while (0); (pis->set_transfer.blue) = 0; } else do { } while (0); } } while (0); pis->set_transfer.blue = ((void*)0);
    do { if (pis->set_transfer.green) { do { do { } while (0); (pis->set_transfer.green)->rc.ref_count += (-1); } while (0); if (!(pis->set_transfer.green)->rc.ref_count) { do { do { } while (0); (pis->set_transfer.green)->rc.free((pis->set_transfer.green)->rc.memory, (void *)(pis->set_transfer.green), cname); } while (0); (pis->set_transfer.green) = 0; } else do { } while (0); } } while (0); pis->set_transfer.green = ((void*)0);
    do { if (pis->set_transfer.red) { do { do { } while (0); (pis->set_transfer.red)->rc.ref_count += (-1); } while (0); if (!(pis->set_transfer.red)->rc.ref_count) { do { do { } while (0); (pis->set_transfer.red)->rc.free((pis->set_transfer.red)->rc.memory, (void *)(pis->set_transfer.red), cname); } while (0); (pis->set_transfer.red) = 0; } else do { } while (0); } } while (0); pis->set_transfer.red = ((void*)0);
    do { if (pis->undercolor_removal) { do { do { } while (0); (pis->undercolor_removal)->rc.ref_count += (-1); } while (0); if (!(pis->undercolor_removal)->rc.ref_count) { do { do { } while (0); (pis->undercolor_removal)->rc.free((pis->undercolor_removal)->rc.memory, (void *)(pis->undercolor_removal), cname); } while (0); (pis->undercolor_removal) = 0; } else do { } while (0); } } while (0); pis->undercolor_removal = ((void*)0);
    do { if (pis->black_generation) { do { do { } while (0); (pis->black_generation)->rc.ref_count += (-1); } while (0); if (!(pis->black_generation)->rc.ref_count) { do { do { } while (0); (pis->black_generation)->rc.free((pis->black_generation)->rc.memory, (void *)(pis->black_generation), cname); } while (0); (pis->black_generation) = 0; } else do { } while (0); } } while (0); pis->black_generation = ((void*)0);
    do { if (pis->cie_render) { do { do { } while (0); (pis->cie_render)->rc.ref_count += (-1); } while (0); if (!(pis->cie_render)->rc.ref_count) { do { do { } while (0); (pis->cie_render)->rc.free((pis->cie_render)->rc.memory, (void *)(pis->cie_render), cname); } while (0); (pis->cie_render) = 0; } else do { } while (0); } } while (0); pis->cie_render = ((void*)0);
    ...
    do { if (pis->dev_ht) { do { do { } while (0); (pis->dev_ht)->rc.ref_count += (-1); } while (0); if (!(pis->dev_ht)->rc.ref_count) { do { do { } while (0); (pis->dev_ht)->rc.free((pis->dev_ht)->rc.memory, (void *)(pis->dev_ht), cname); } while (0); (pis->dev_ht) = 0; } else do { } while (0); } } while (0); pis->dev_ht = ((void*)0);
    do { if (pis->halftone) { do { do { } while (0); (pis->halftone)->rc.ref_count += (-1); } while (0); if (!(pis->halftone)->rc.ref_count) { do { do { } while (0); (pis->halftone)->rc.free((pis->halftone)->rc.memory, (void *)(pis->halftone), cname); } while (0); (pis->halftone) = 0; } else do { } while (0); } } while (0); pis->halftone = ((void*)0);
    do { if (pis->devicergb_cs) { do { do { } while (0); (pis->devicergb_cs)->rc.ref_count += (-1); } while (0); if (!(pis->devicergb_cs)->rc.ref_count) { do { do { } while (0); (pis->devicergb_cs)->rc.free((pis->devicergb_cs)->rc.memory, (void *)(pis->devicergb_cs), cname); } while (0); (pis->devicergb_cs) = 0; } else do { } while (0); } } while (0); pis->devicergb_cs = ((void*)0);
    do { if (pis->devicecmyk_cs) { do { do { } while (0); (pis->devicecmyk_cs)->rc.ref_count += (-1); } while (0); if (!(pis->devicecmyk_cs)->rc.ref_count) { do { do { } while (0); (pis->devicecmyk_cs)->rc.free((pis->devicecmyk_cs)->rc.memory, (void *)(pis->devicecmyk_cs), cname); } while (0); (pis->devicecmyk_cs) = 0; } else do { } while (0); } } while (0); pis->devicecmyk_cs = ((void*)0);
    do { if (pis->icc_link_cache) { do { do { } while (0); (pis->icc_link_cache)->rc.ref_count += (-1); } while (0); if (!(pis->icc_link_cache)->rc.ref_count) { do { do { } while (0); (pis->icc_link_cache)->rc.free((pis->icc_link_cache)->rc.memory, (void *)(pis->icc_link_cache), cname); } while (0); (pis->icc_link_cache) = 0; } else do { } while (0); } } while (0); pis->icc_link_cache = ((void*)0);
    do { if (pis->icc_profile_cache) { do { do { } while (0); (pis->icc_profile_cache)->rc.ref_count += (-1); } while (0); if (!(pis->icc_profile_cache)->rc.ref_count) { do { do { } while (0); (pis->icc_profile_cache)->rc.free((pis->icc_profile_cache)->rc.memory, (void *)(pis->icc_profile_cache), cname); } while (0); (pis->icc_profile_cache) = 0; } else do { } while (0); } } while (0); pis->icc_profile_cache = ((void*)0);
    do { if (pis->icc_manager) { do { do { } while (0); (pis->icc_manager)->rc.ref_count += (-1); } while (0); if (!(pis->icc_manager)->rc.ref_count) { do { do { } while (0); (pis->icc_manager)->rc.free((pis->icc_manager)->rc.memory, (void *)(pis->icc_manager), cname); } while (0); (pis->icc_manager) = 0; } else do { } while (0); } } while (0); pis->icc_manager = ((void*)0);
