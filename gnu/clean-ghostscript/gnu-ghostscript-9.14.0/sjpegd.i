...
gs_jpeg_create_decompress(stream_DCT_state * st)
{
    ...
    do { (st->data.decompress)->Picky = 0; (st->data.decompress)->Relax = 0; (st->data.decompress)->dummy = 0;} while (0);
    jpeg_CreateDecompress((&st->data.decompress->dinfo), 90, (size_t) sizeof(struct jpeg_decompress_struct));
    return 0;
}
