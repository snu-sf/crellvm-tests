# 1 "./openjpeg/libopenjpeg/pi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./openjpeg/libopenjpeg/pi.c" 2
# 33 "./openjpeg/libopenjpeg/pi.c"
...
# 34 "./openjpeg/libopenjpeg/pi.c" 2
# 46 "./openjpeg/libopenjpeg/pi.c"
                                    ...
                                    OPJ_UINT32 * p_max_res )
{
 ...
 ((p_cp != 00) ? (void) (0) : __assert_fail ("p_cp != 00", "./openjpeg/libopenjpeg/pi.c", 572, __PRETTY_FUNCTION__));
 ((p_image != 00) ? (void) (0) : __assert_fail ("p_image != 00", "./openjpeg/libopenjpeg/pi.c", 573, __PRETTY_FUNCTION__));
 ((p_tileno < p_cp->tw * p_cp->th) ? (void) (0) : __assert_fail ("p_tileno < p_cp->tw * p_cp->th", "./openjpeg/libopenjpeg/pi.c", 574, __PRETTY_FUNCTION__));
                                        ...
                                        OPJ_UINT32 ** p_resolutions )
{
 ...
 ((p_cp != 00) ? (void) (0) : __assert_fail ("p_cp != 00", "./openjpeg/libopenjpeg/pi.c", 691, __PRETTY_FUNCTION__));
 ((p_image != 00) ? (void) (0) : __assert_fail ("p_image != 00", "./openjpeg/libopenjpeg/pi.c", 692, __PRETTY_FUNCTION__));
 ((tileno < p_cp->tw * p_cp->th) ? (void) (0) : __assert_fail ("tileno < p_cp->tw * p_cp->th", "./openjpeg/libopenjpeg/pi.c", 693, __PRETTY_FUNCTION__));
                                    ...
                                    OPJ_UINT32 tileno )
{
 ...
 ((cp != 00) ? (void) (0) : __assert_fail ("cp != 00", "./openjpeg/libopenjpeg/pi.c", 799, __PRETTY_FUNCTION__));
 ((image != 00) ? (void) (0) : __assert_fail ("image != 00", "./openjpeg/libopenjpeg/pi.c", 800, __PRETTY_FUNCTION__));
 ((tileno < cp->tw * cp->th) ? (void) (0) : __assert_fail ("tileno < cp->tw * cp->th", "./openjpeg/libopenjpeg/pi.c", 801, __PRETTY_FUNCTION__));
 ...
 l_pi = (opj_pi_iterator_t*) ((size_t)((l_poc_bound)) != 0 && (size_t)((l_poc_bound)) >= (size_t)-0x100 / (size_t)(sizeof(opj_pi_iterator_t)) ? ((void*)0) : calloc((l_poc_bound), sizeof(opj_pi_iterator_t)));
 if (!l_pi) {
  return ((void*)0);
 }
 ...
 for (pino = 0; pino < l_poc_bound ; ++pino) {
  ...
  l_current_pi->comps = (opj_pi_comp_t*) ((size_t)(image->numcomps) != 0 && (size_t)(image->numcomps) >= (size_t)-0x100 / (size_t)(sizeof(opj_pi_comp_t)) ? ((void*)0) : calloc(image->numcomps, sizeof(opj_pi_comp_t)));
  ...
  for (compno = 0; compno < image->numcomps; ++compno) {
   ...
   comp->resolutions = (opj_pi_resolution_t*) ((size_t)(tccp->numresolutions * sizeof(opj_pi_resolution_t)) >= (size_t)-0x100 ? ((void*)0) : malloc(tccp->numresolutions * sizeof(opj_pi_resolution_t)));
   if (!comp->resolutions) {
    opj_pi_destroy(l_pi, l_poc_bound);
    return 00;
   }
                                            ...
                                            OPJ_UINT32 p_dy_min)
{
 ...
 ((p_cp != 00) ? (void) (0) : __assert_fail ("p_cp != 00", "./openjpeg/libopenjpeg/pi.c", 869, __PRETTY_FUNCTION__));
 ((p_tileno < p_cp->tw * p_cp->th) ? (void) (0) : __assert_fail ("p_tileno < p_cp->tw * p_cp->th", "./openjpeg/libopenjpeg/pi.c", 870, __PRETTY_FUNCTION__));
                                    ...
                                    OPJ_UINT32 p_dy_min)
{
 ...
 ((p_cp != 00) ? (void) (0) : __assert_fail ("p_cp != 00", "./openjpeg/libopenjpeg/pi.c", 945, __PRETTY_FUNCTION__));
 ((p_tileno < p_cp->tw * p_cp->th) ? (void) (0) : __assert_fail ("p_tileno < p_cp->tw * p_cp->th", "./openjpeg/libopenjpeg/pi.c", 946, __PRETTY_FUNCTION__));
                               ...
                               OPJ_UINT32 p_max_res)
{
 ...
 ((p_pi != 00) ? (void) (0) : __assert_fail ("p_pi != 00", "./openjpeg/libopenjpeg/pi.c", 995, __PRETTY_FUNCTION__));
 ((p_tcp != 00) ? (void) (0) : __assert_fail ("p_tcp != 00", "./openjpeg/libopenjpeg/pi.c", 996, __PRETTY_FUNCTION__));
                                   ...
                                   OPJ_UINT32 p_max_res)
{
 ...
 ((p_tcp != 00) ? (void) (0) : __assert_fail ("p_tcp != 00", "./openjpeg/libopenjpeg/pi.c", 1033, __PRETTY_FUNCTION__));
 ((p_pi != 00) ? (void) (0) : __assert_fail ("p_pi != 00", "./openjpeg/libopenjpeg/pi.c", 1034, __PRETTY_FUNCTION__));
          ...
          OPJ_UINT32 p_tile_no)
{
 ...
 ((p_cp != 00) ? (void) (0) : __assert_fail ("p_cp != 00", "./openjpeg/libopenjpeg/pi.c", 1176, __PRETTY_FUNCTION__));
 ((p_image != 00) ? (void) (0) : __assert_fail ("p_image != 00", "./openjpeg/libopenjpeg/pi.c", 1177, __PRETTY_FUNCTION__));
 ((p_tile_no < p_cp->tw * p_cp->th) ? (void) (0) : __assert_fail ("p_tile_no < p_cp->tw * p_cp->th", "./openjpeg/libopenjpeg/pi.c", 1178, __PRETTY_FUNCTION__));
 ...
 l_data_stride = 4 * 33;
 l_tmp_data = (OPJ_UINT32*)((size_t)(l_data_stride * p_image->numcomps * sizeof(OPJ_UINT32)) >= (size_t)-0x100 ? ((void*)0) : malloc(l_data_stride * p_image->numcomps * sizeof(OPJ_UINT32)));
 ...
 l_tmp_ptr = (OPJ_UINT32**)((size_t)(p_image->numcomps * sizeof(OPJ_UINT32 *)) >= (size_t)-0x100 ? ((void*)0) : malloc(p_image->numcomps * sizeof(OPJ_UINT32 *)));
 ...
 l_current_pi->include = (OPJ_INT16*) ((size_t)((l_tcp->numlayers +1) * l_step_l) != 0 && (size_t)((l_tcp->numlayers +1) * l_step_l) >= (size_t)-0x100 / (size_t)(sizeof(OPJ_INT16)) ? ((void*)0) : calloc((l_tcp->numlayers +1) * l_step_l, sizeof(OPJ_INT16)));
 if
                                            ...
                                            J2K_T2_MODE p_t2_mode )
{
 ...
 ((p_cp != 00) ? (void) (0) : __assert_fail ("p_cp != 00", "./openjpeg/libopenjpeg/pi.c", 1378, __PRETTY_FUNCTION__));
 ((p_image != 00) ? (void) (0) : __assert_fail ("p_image != 00", "./openjpeg/libopenjpeg/pi.c", 1379, __PRETTY_FUNCTION__));
 ((p_tile_no < p_cp->tw * p_cp->th) ? (void) (0) : __assert_fail ("p_tile_no < p_cp->tw * p_cp->th", "./openjpeg/libopenjpeg/pi.c", 1380, __PRETTY_FUNCTION__));
 ...
 l_current_pi->include = (OPJ_INT16*) ((size_t)(l_tcp->numlayers * l_step_l) != 0 && (size_t)(l_tcp->numlayers * l_step_l) >= (size_t)-0x100 / (size_t)(sizeof(OPJ_INT16)) ? ((void*)0) : calloc(l_tcp->numlayers * l_step_l, sizeof(OPJ_INT16)));
                                        ...
                                        OPJ_UINT32 p_tile_no )
{
 ...
 ((p_cp != 00) ? (void) (0) : __assert_fail ("p_cp != 00", "./openjpeg/libopenjpeg/pi.c", 1836, __PRETTY_FUNCTION__));
 ((p_image != 00) ? (void) (0) : __assert_fail ("p_image != 00", "./openjpeg/libopenjpeg/pi.c", 1837, __PRETTY_FUNCTION__));
 ((p_tile_no < p_cp->tw * p_cp->th) ? (void) (0) : __assert_fail ("p_tile_no < p_cp->tw * p_cp->th", "./openjpeg/libopenjpeg/pi.c", 1838, __PRETTY_FUNCTION__));
