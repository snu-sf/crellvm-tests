# 1 "./devices/vector/gdevpsdu.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/vector/gdevpsdu.c" 2
# 18 "./devices/vector/gdevpsdu.c"
# 1 "./base/stdio_.h" 1
# 26 "./base/stdio_.h"
# 1 "./base/std.h" 1
# 22 "./base/std.h"
...
# 83 "./base/stdio_.h" 2
# 19 "./devices/vector/gdevpsdu.c" 2
# 1 "./obj/jpeglib_.h" 1
# 25 "./obj/jpeglib_.h"
# 1 "./obj/jconfig.h" 1
# 507 "./obj/jconfig.h"
...
# 20 "./devices/vector/gdevpsdu.c" 2
# 1 "./base/memory_.h" 1
# 54 "./base/memory_.h"
...
# 55 "./base/memory_.h" 2
# 21 "./devices/vector/gdevpsdu.c" 2
# 1 "./base/gx.h" 1
# 23 "./base/gx.h"
# 1 "./base/gserrors.h" 1
# 50 "./base/gserrors.h"
...
# 22 "./devices/vector/gdevpsdu.c" 2
...
# 24 "./devices/vector/gdevpsdu.c" 2
...
# 28 "./devices/vector/gdevpsdu.c" 2
# 1 "./base/sjpeg.h" 1
# 36 "./base/sjpeg.h"
...
# 29 "./devices/vector/gdevpsdu.c" 2
# 1 "./base/spprint.h" 1
# 32 "./base/spprint.h"
...
# 30 "./devices/vector/gdevpsdu.c" 2
# 1 "./base/gsovrc.h" 1
# 220 "./base/gsovrc.h"
...
# 31 "./devices/vector/gdevpsdu.c" 2
...
# 32 "./devices/vector/gdevpsdu.c" 2


static const gc_ptr_element_t device_psdf_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((gx_device_psdf *)0)->params.ColorImage.ACSDict - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_device_psdf *)0)->params.ColorImage.Dict - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_CONST_STRING, ((int) ( (char *)&((gx_device_psdf *)0)->params.CalCMYKProfile - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_CONST_STRING, ((int) ( (char *)&((gx_device_psdf *)0)->params.CalGrayProfile - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_CONST_STRING, ((int) ( (char *)&((gx_device_psdf *)0)->params.CalRGBProfile - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_CONST_STRING, ((int) ( (char *)&((gx_device_psdf *)0)->params.sRGBProfile - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_device_psdf *)0)->params.GrayImage.ACSDict - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_device_psdf *)0)->params.GrayImage.Dict - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_device_psdf *)0)->params.MonoImage.ACSDict - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_device_psdf *)0)->params.MonoImage.Dict - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_device_psdf *)0)->params.AlwaysEmbed.data - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_device_psdf *)0)->params.NeverEmbed.data - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_CONST_STRING, ((int) ( (char *)&((gx_device_psdf *)0)->params.PSDocOptions - (char *)((gx_device_psdf *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((gx_device_psdf *)0)->params.PSPageOptions.data - (char *)((gx_device_psdf *)0) )) } }; static const gc_struct_data_t device_psdf_data = { (sizeof(device_psdf_ptrs) / sizeof((device_psdf_ptrs)[0])), 0, &st_device_vector, device_psdf_ptrs }; const gs_memory_struct_type_t st_device_psdf = { sizeof(gx_device_psdf), "gx_device_psdf", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, gx_device_finalize, &device_psdf_data };
static const gc_ptr_element_t psdf_binary_writer_enum_ptrs[] = { { GC_ELT_OBJ, ((int) ( (char *)&((psdf_binary_writer *)0)->target - (char *)((psdf_binary_writer *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((psdf_binary_writer *)0)->strm - (char *)((psdf_binary_writer *)0) )) }, { GC_ELT_OBJ, ((int) ( (char *)&((psdf_binary_writer *)0)->dev - (char *)((psdf_binary_writer *)0) )) } }; static const gc_struct_data_t psdf_binary_writer_reloc_ptrs = { (sizeof(psdf_binary_writer_enum_ptrs) / sizeof((psdf_binary_writer_enum_ptrs)[0])), 0, 0, psdf_binary_writer_enum_ptrs }; const gs_memory_struct_type_t st_psdf_binary_writer = { sizeof(psdf_binary_writer), "psdf_binary_writer", 0, 0, basic_enum_ptrs, basic_reloc_ptrs, 0, &psdf_binary_writer_reloc_ptrs };
...
psdf_setlinecap(gx_device_vector * vdev, gs_line_cap cap)
{
    switch (cap) {
        ...
        default:
            ...
            (emprintf_program_ident(vdev->memory, gs_program_name(), gs_revision_number()), errprintf(vdev->memory, "Unknown line cap enumerator %d, substituting butt\n", cap));
...
psdf_setlinejoin(gx_device_vector * vdev, gs_line_join join)
{
    switch (join) {
        ...
        default:
            ...
            (emprintf_program_ident(vdev->memory, gs_program_name(), gs_revision_number()), errprintf(vdev->memory, "Unknown line join enumerator %d, substituting miter\n", join));
...
psdf_adjust_color_index(gx_device_vector *vdev, gx_color_index color)
{
    ...
    return (color == (((gx_color_index)(~0)) ^ 1) ? ((gx_color_index)(~0)) : color);
}
               ...
               const psdf_set_color_commands_t *ppscc, bool UseOldColor)
{
    ...
    if (UseOldColor) {
        ...
        code = (((gx_device *)vdev)->procs.get_profile)((gx_device *)vdev, &dev_profile);
        if (code < 0)
            return code;
        ...
        return ((-15));
    {
        stream *s = gdev_vector_stream(vdev);
        gx_color_index color =
            psdf_adjust_color_index(vdev, ((pdc)->colors.pure));
...
psdf_begin_binary(gx_device_psdf * pdev, psdf_binary_writer * pbw)
{
    ...
    if (!pdev->binary_ok) {
        ...
        byte *buf = (*(mem)->procs.alloc_bytes)(mem, 100, "psdf_begin_binary(buf)");
        ...
        if (buf == 0 || ss == 0 || s == 0) {
            ((mem)->procs.free_object(mem, s, "psdf_begin_binary(stream)"));
            ((mem)->procs.free_object(mem, ss, "psdf_begin_binary(stream_state)"));
            ((mem)->procs.free_object(mem, buf, "psdf_begin_binary(buf)"));
            return ((-25));
        }
        ss->templat = &s_A85E_template;
        s_init_filter(s, (stream_state *)ss, buf, 100, pdev->strm);
                ...
                psdf_binary_writer *pbw )
{
        ...
        jcdp = (jpeg_compress_data *)(*(mem)->procs.alloc_struct_immovable)(mem, &st_jpeg_compress_data, "zDCTE");
        ...
        ss->icc_profile = ((void*)0);
        jcdp->templat.min_in_size =
            (((s_DCTE_template.min_in_size) > (ss->scan_line_size)) ? (s_DCTE_template.min_in_size) : (ss->scan_line_size));

        jcdp->templat.min_out_size =
            (((s_DCTE_template.min_out_size) > (ss->Markers.size)) ? (s_DCTE_template.min_out_size) : (ss->Markers.size));
        if (pbw)
    ...
    dcte_fail:
        gs_jpeg_destroy(ss);
        ((mem)->procs.free_object(mem, jcdp, "setup_image_compression"));
        ss->data.compress = ((void*)0);
    rcc_fail:
        gs_c_param_list_release(&rcc_list);
        return code;
}
...
psdf_CFE_binary(psdf_binary_writer * pbw, int w, int h, bool invert)
{
    ...
    stream_CFE_state *st =
        (stream_CFE_state *)(*(mem)->procs.alloc_struct)(mem, templat->stype, "psdf_CFE_binary");
    ...
    if (code < 0)
        ((mem)->procs.free_object(mem, st, "psdf_CFE_binary"));
    return code;
}
...
{
    if (((dev)->procs.get_alpha_bits)(dev, go_graphics) > 1)
        (emprintf_program_ident(dev->memory, gs_program_name(), gs_revision_number()), errprintf(dev->memory, "Can't set GraphicsAlphaBits > 1 with a vector device %s.\n", dev->dname));
