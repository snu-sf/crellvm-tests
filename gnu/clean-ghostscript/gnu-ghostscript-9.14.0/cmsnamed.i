# 1 "./lcms2/src/cmsnamed.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./lcms2/src/cmsnamed.c" 2
# 27 "./lcms2/src/cmsnamed.c"
...
cmsBool GrowMLUpool(cmsMLU* mlu)
{
    ...
    if (size < mlu ->PoolSize) return 0;


    NewPtr = _cmsRealloc(mlu ->ContextID, mlu ->MemPool, size);
    if (NewPtr == ((void*)0)) return 0;
...
cmsBool GrowMLUtable(cmsMLU* mlu)
{
    ...
    if (AllocatedEntries / 2 != mlu ->AllocatedEntries) return 0;
                     ...
                     cmsUInt16Number LanguageCode, cmsUInt16Number CountryCode)
{
    ...
    if (mlu ->UsedEntries >= mlu ->AllocatedEntries) {
        if (!GrowMLUtable(mlu)) return 0;
    }


    if (SearchMLUEntry(mlu, LanguageCode, CountryCode) >= 0) return 0;


    while ((mlu ->PoolSize - mlu ->PoolUsed) < size) {

            if (!GrowMLUpool(mlu)) return 0;
    }
...
cmsBool cmsMLUsetWide(cmsMLU* mlu, const char Language[3], const char Country[3], const wchar_t* WideString)
{
...
cmsMLU* cmsMLUdup(const cmsMLU* mlu)
{
    cmsMLU* NewMlu = ((void*)0);


    if (mlu == ((void*)0)) return ((void*)0);

    NewMlu = cmsMLUalloc(mlu ->ContextID, mlu ->UsedEntries);
    if (NewMlu == ((void*)0)) return ((void*)0);
    ...
    if (NewMlu ->Entries == ((void*)0) || mlu ->Entries == ((void*)0)) goto Error;
    ...
    if (mlu ->PoolUsed == 0) {
        NewMlu ->MemPool = ((void*)0);
    }
    else {

        NewMlu ->MemPool = _cmsMalloc(mlu ->ContextID, mlu ->PoolUsed);
        if (NewMlu ->MemPool == ((void*)0)) goto Error;
    }

    NewMlu ->PoolSize = mlu ->PoolUsed;

    if (NewMlu ->MemPool == ((void*)0) || mlu ->MemPool == ((void*)0)) goto Error;
...
Error:
    ...
    if (NewMlu != ((void*)0)) cmsMLUfree(NewMlu);
    return ((void*)0);
}
                              ...
                              cmsUInt16Number* UsedLanguageCode, cmsUInt16Number* UsedCountryCode)
{
    ...
    if (mlu -> AllocatedEntries <= 0) return ((void*)0);
    ...
    for (i=0; i < mlu ->UsedEntries; i++) {
        ...
        if (v -> Language == LanguageCode) {
            ...
            if (v -> Country == CountryCode) {
                ...
                if (UsedLanguageCode != ((void*)0)) *UsedLanguageCode = v ->Language;
                if (UsedCountryCode != ((void*)0)) *UsedCountryCode = v ->Country;

                if (len != ((void*)0)) *len = v ->Len;
                                       ...
                                       char* Buffer, cmsUInt32Number BufferSize)
{
    ...
    Wide = _cmsMLUgetWide(mlu, &StrLen, Lang, Cntry, ((void*)0), ((void*)0));
    if (Wide == ((void*)0)) return 0;

    ASCIIlen = StrLen / sizeof(wchar_t);


    if (Buffer == ((void*)0)) return ASCIIlen + 1;
                                      ...
                                      wchar_t* Buffer, cmsUInt32Number BufferSize)
{
    ...
    if (Buffer == ((void*)0)) return StrLen + sizeof(wchar_t);
                                              ...
                                              char ObtainedLanguage[3], char ObtainedCountry[3])
{
    ...
    Wide = _cmsMLUgetWide(mlu, ((void*)0), Lang, Cntry, &ObtLang, &ObtCode);
    if (Wide == ((void*)0)) return 0;
                                          ...
                                          char CountryCode[3])
{
    ...
    if (idx >= (cmsUInt32Number) mlu->UsedEntries) return 0;
...
cmsNAMEDCOLORLIST* cmsAllocNamedColorList(cmsContext ContextID, cmsUInt32Number n, cmsUInt32Number ColorantCount, const char* Prefix, const char* Suffix)
{
    ...
    __builtin_strncpy (v ->Prefix, Prefix, sizeof(v ->Prefix)-1);
    __builtin_strncpy (v ->Suffix, Suffix, sizeof(v ->Suffix)-1);
...
cmsBool cmsAppendNamedColor(cmsNAMEDCOLORLIST* NamedColorList,
                                       const char* Name,
                                       cmsUInt16Number PCS[3], cmsUInt16Number Colorant[16])
{
    cmsUInt32Number i;
    ...
    if (NamedColorList ->nColors + 1 > NamedColorList ->Allocated) {
        if (!GrowNamedColorList(NamedColorList)) return 0;
    }

    for (i=0; i < NamedColorList ->ColorantCount; i++)
        NamedColorList ->List[NamedColorList ->nColors].DeviceColorant[i] = Colorant == ((void*)0)? 0 : Colorant[i];

    for (i=0; i < 3; i++)
        NamedColorList ->List[NamedColorList ->nColors].PCS[i] = PCS == ((void*)0) ? 0 : PCS[i];

    if (Name != ((void*)0)) {

        __builtin_strncpy (NamedColorList ->List[NamedColorList ->nColors].Name, Name, 256 -1);
        NamedColorList ->List[NamedColorList ->nColors].Name[256 -1] = 0;
...
cmsUInt32Number cmsNamedColorCount(const cmsNAMEDCOLORLIST* NamedColorList)
{
     if (NamedColorList == ((void*)0)) return 0;
                                     ...
                                     cmsUInt16Number* Colorant)
{
    ...
    if (nColor >= cmsNamedColorCount(NamedColorList)) return 0;
...
cmsInt32Number cmsNamedColorIndex(const cmsNAMEDCOLORLIST* NamedColorList, const char* Name)
{
    int i, n;

    if (NamedColorList == ((void*)0)) return -1;
...
void EvalNamedColorPCS(const cmsFloat32Number In[], cmsFloat32Number Out[], const cmsStage *mpe)
{
    ...
    if (index >= NamedColorList-> nColors) {
        cmsSignalError(NamedColorList ->ContextID, 2, "Color %d out of range; ignored", index);
    }
    else {
...
cmsNAMEDCOLORLIST* cmsGetNamedColorList(cmsHTRANSFORM xform)
{
    ...
    if (mpe ->Type != cmsSigNamedColorElemType) return ((void*)0);
...
cmsSEQ* cmsAllocProfileSequenceDescription(cmsContext ContextID, cmsUInt32Number n)
{
    ...
    for (i=0; i < n; i++) {
        Seq -> seq[i].Manufacturer = ((void*)0);
        Seq -> seq[i].Model = ((void*)0);
        Seq -> seq[i].Description = ((void*)0);
    }
...
void cmsFreeProfileSequenceDescription(cmsSEQ* pseq)
{
    ...
    for (i=0; i < pseq ->n; i++) {
        if (pseq ->seq[i].Manufacturer != ((void*)0)) cmsMLUfree(pseq ->seq[i].Manufacturer);
        if (pseq ->seq[i].Model != ((void*)0)) cmsMLUfree(pseq ->seq[i].Model);
        if (pseq ->seq[i].Description != ((void*)0)) cmsMLUfree(pseq ->seq[i].Description);
    }

    if (pseq ->seq != ((void*)0)) _cmsFree(pseq ->ContextID, pseq ->seq);
...
void cmsDictFree(cmsHANDLE hDict)
{
    ...
    (((dict != ((void*)0))) ? (void) (0) : __assert_fail ("(dict != ((void*)0))", "./lcms2/src/cmsnamed.c", 833, __PRETTY_FUNCTION__));


    entry = dict ->head;
    while (entry != ((void*)0)) {

            if (entry ->DisplayName != ((void*)0)) cmsMLUfree(entry ->DisplayName);
            if (entry ->DisplayValue != ((void*)0)) cmsMLUfree(entry ->DisplayValue);
            if (entry ->Name != ((void*)0)) _cmsFree(dict ->ContextID, entry -> Name);
            if (entry ->Value != ((void*)0)) _cmsFree(dict ->ContextID, entry -> Value);
...
cmsBool cmsDictAddEntry(cmsHANDLE hDict, const wchar_t* Name, const wchar_t* Value, const cmsMLU *DisplayName, const cmsMLU *DisplayValue)
{
    ...
    (((dict != ((void*)0))) ? (void) (0) : __assert_fail ("(dict != ((void*)0))", "./lcms2/src/cmsnamed.c", 869, __PRETTY_FUNCTION__));
    (((Name != ((void*)0))) ? (void) (0) : __assert_fail ("(Name != ((void*)0))", "./lcms2/src/cmsnamed.c", 870, __PRETTY_FUNCTION__));
...
cmsHANDLE cmsDictDup(cmsHANDLE hDict)
{
    ...
    (((old_dict != ((void*)0))) ? (void) (0) : __assert_fail ("(old_dict != ((void*)0))", "./lcms2/src/cmsnamed.c", 894, __PRETTY_FUNCTION__));

    hNew = cmsDictAlloc(old_dict ->ContextID);
    if (hNew == ((void*)0)) return ((void*)0);
