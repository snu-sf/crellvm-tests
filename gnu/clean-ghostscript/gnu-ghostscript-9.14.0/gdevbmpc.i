# 1 "./devices/gdevbmpc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 316 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "./devices/gdevbmpc.c" 2
# 17 "./devices/gdevbmpc.c"
# 1 "./base/gdevprn.h" 1
# 22 "./base/gdevprn.h"
# 1 "./base/memory_.h" 1
# 23 "./base/memory_.h"
...
typedef uint dword;
# 43 "./devices/gdevbmpc.c"
typedef struct bmp_file_header_s {
# 55 "./devices/gdevbmpc.c"
    dword size;
    word reserved1;
    word reserved2;
    dword offBits;
                       ...
                       int raster)
{
    ...
    fputc('M', file);
    {
        ...
        fhdr.size = ((2 + sizeof(bmp_file_header)) + sizeof(bmp_info_header) + quads + bmp_raster * height);



        fhdr.reserved1 = (0);
        fhdr.reserved2 = (0);
        fhdr.offBits = ((2 + sizeof(bmp_file_header)) + sizeof(bmp_info_header) + quads);
...

    {
        ...
        ihdr.width = (pdev->width);
        ihdr.height = (height);
        ihdr.planes = (1);
        ihdr.bitCount = (depth);
        ihdr.compression = (0);
        ihdr.sizeImage = (bmp_raster * height);
        ...
        ihdr.xPelsPerMeter = ((dword)(pdev->HWResolution[0] * (100 / 2.54 ) + 0.5));

        ihdr.yPelsPerMeter = ((dword)(pdev->HWResolution[1] * (100 / 2.54 ) + 0.5));
...
write_bmp_header(gx_device_printer *pdev, FILE *file)
{
    ...
    if (depth <= 8) {
        ...
        for (i = 0; i != 1 << depth; i++) {
            ...
            q.red = ((gx_color_value)((((unsigned int)rgb[0])*0xFF01 + 0x800000)>>24));
            q.green = ((gx_color_value)((((unsigned int)rgb[1])*0xFF01 + 0x800000)>>24));
            q.blue = ((gx_color_value)((((unsigned int)rgb[2])*0xFF01 + 0x800000)>>24));
            palette[i] = q;
        }
    }
    return write_bmp_depth_header(pdev, file, depth, (const byte *)palette,
                                  gx_device_raster((gx_device *)(pdev), 0));
}
...
bmp_map_16m_rgb_color(gx_device * dev, const gx_color_value cv[])
{
    ...
    return ((gx_color_value)((((unsigned int)r)*0xFF01 + 0x800000)>>24)) +
        ((uint) ((gx_color_value)((((unsigned int)g)*0xFF01 + 0x800000)>>24)) << 8) +
        ((ulong) ((gx_color_value)((((unsigned int)b)*0xFF01 + 0x800000)>>24)) << 16);
}
...
{
    prgb[2] = (((color >> 16) << ((sizeof(gx_color_value) * 8) - 8)) + ((color >> 16) >> (16 - (sizeof(gx_color_value) * 8))));
    prgb[1] = ((((color >> 8) & 0xff) << ((sizeof(gx_color_value) * 8) - 8)) + (((color >> 8) & 0xff) >> (16 - (sizeof(gx_color_value) * 8))));
    prgb[0] = (((color & 0xff) << ((sizeof(gx_color_value) * 8) - 8)) + ((color & 0xff) >> (16 - (sizeof(gx_color_value) * 8))));
    return 0;
}
