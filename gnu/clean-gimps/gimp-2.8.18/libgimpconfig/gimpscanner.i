                       ...
                       GError **error)
{
  ...
  file = g_mapped_file_new (filename, (0), error);

  if (! file)
    {
      if (error)
        {
          (*error)->domain = (gimp_config_error_quark ());
                         ...
                         GError **error)
{
  ...
  do{ if (text != ((void*)0) || text_len == 0) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "text != NULL || text_len == 0"); return (((void*)0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "error == NULL || *error == NULL"); return (((void*)0)); }; }while (0);

  if (text_len < 0)
    text_len = strlen (text);

  scanner = gimp_scanner_new (((void*)0), ((void*)0), error);
                  ...
                  GError **error)
{
  ...
  scanner = g_scanner_new (((void*)0));

  data = ((GimpScannerData*) g_slice_alloc0 (sizeof (GimpScannerData)));
  ...
  scanner->config->cset_identifier_nth = ( "abcdefghijklmnopqrstuvwxyz" "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
                                             "0123456789" "-_" );
  scanner->config->scan_identifier_1char = (!(0));
...
gimp_scanner_destroy (GScanner *scanner)
{
  ...
  do{ if (scanner != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "scanner != NULL"); return; }; }while (0);
  ...
  g_free (data->name);
  do { if (1) g_slice_free1 (sizeof (GimpScannerData), (data)); else (void) ((GimpScannerData*) 0 == (data)); } while (0);
  ...
  if (*scanner->value.v_string)
    {
      if (! g_utf8_validate (scanner->value.v_string, -1, ((void*)0)))
        {
          g_scanner_warn (scanner, dgettext ("gimp20" "-libgimp", "invalid UTF-8 string"));
          return (0);
        }
  ...
  else
    {
      g_scanner_error
        (scanner,
         ...
         dgettext ("gimp20" "-libgimp", "expected 'yes' or 'no' for boolean token, got '%s'"),
                          ...
                          GimpRGB *dest)
{
  ...
  if (! g_scanner_scope_lookup_symbol (scanner, scope_id, "color-rgb"))
    {
      g_scanner_scope_add_symbol (scanner, scope_id,
                                  "color-rgb", ((gpointer) (glong) (COLOR_RGB)));
      g_scanner_scope_add_symbol (scanner, scope_id,
                                  "color-rgba", ((gpointer) (glong) (COLOR_RGBA)));
      g_scanner_scope_add_symbol (scanner, scope_id,
                                  "color-hsv", ((gpointer) (glong) (COLOR_HSV)));
      g_scanner_scope_add_symbol (scanner, scope_id,
                                  "color-hsva", ((gpointer) (glong) (COLOR_HSVA)));
    }
        ...
        case G_TOKEN_SYMBOL:
          {
            ...
            switch (((gint) (glong) (scanner->value.v_symbol)))
              {
              case COLOR_RGB:
                n_channels = 3;
 ...
 finish:
  ...
  if (token != G_TOKEN_NONE)
    {
      g_scanner_get_next_token (scanner);
      g_scanner_unexp_token (scanner, token, ((void*)0), ((void*)0), ((void*)0),
                      ...
                      gboolean is_error)
{
  ...
  do{ if (is_error) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "is_error"); return; }; }while (0);

  if (data->name)
    g_set_error (data->error, (gimp_config_error_quark ()), GIMP_CONFIG_ERROR_PARSE,
                 dgettext ("gimp20" "-libgimp", "Error while parsing '%s' in line %d: %s"),
