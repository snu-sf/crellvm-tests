# 1 "gimpconfigwriter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 319 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpconfigwriter.c" 2
# 22 "gimpconfigwriter.c"
# 1 "../config.h" 1
# 23 "gimpconfigwriter.c" 2
...
gboolean gimp_config_copy (GimpConfig *src,
                                                 GimpConfig *dest,
                                                 GParamFlags flags);
# 47 "gimpconfigwriter.c" 2
# 1 "./gimpconfig-error.h" 1
...
# 52 "gimpconfigwriter.c" 2
# 64 "gimpconfigwriter.c"
...
gimp_config_writer_flush (GimpConfigWriter *writer)
{
  if (write (writer->fd, writer->buffer->str, writer->buffer->len) < 0)
    g_set_error (&writer->error, (gimp_config_error_quark ()), GIMP_CONFIG_ERROR_WRITE,
                 dgettext ("gimp20" "-libgimp", "Error writing to '%s': %s"),
                 gimp_filename_to_utf8 (writer->filename), g_strerror ((*__errno_location ())));
...
gimp_config_writer_newline (GimpConfigWriter *writer)
{
  ...
  g_string_append_c_inline (writer->buffer, '\n');
...
{
  GimpConfigWriter *writer;
  gchar *tmpname = ((void*)0);
  gint fd;

  do{ if (filename != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "filename != NULL"); return (((void*)0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "error == NULL || *error == NULL"); return (((void*)0)); }; }while (0);

  if (atomic)
    {
      tmpname = g_strconcat (filename, "XXXXXX", ((void*)0));

      fd = g_mkstemp (tmpname);

      if (fd == -1)
        {
          g_set_error (error, (gimp_config_error_quark ()), GIMP_CONFIG_ERROR_WRITE,
                       dgettext ("gimp20" "-libgimp", "Could not create temporary file for '%s': %s"),
  ...
  else
    {
      ...
      if (fd == -1)
        {
          g_set_error (error, (gimp_config_error_quark ()), GIMP_CONFIG_ERROR_WRITE,
                       dgettext ("gimp20" "-libgimp", "Could not open '%s' for writing: %s"),
                       gimp_filename_to_utf8 (filename), g_strerror ((*__errno_location ())));
          return ((void*)0);
        }
    }

  writer = ((GimpConfigWriter*) g_slice_alloc0 (sizeof (GimpConfigWriter)));

  writer->fd = fd;
  writer->filename = g_strdup (filename);
  writer->tmpname = tmpname;
  writer->buffer = g_string_new (((void*)0));
...
# 188 "gimpconfigwriter.c"
GimpConfigWriter *
gimp_config_writer_new_fd (gint fd)
{
  GimpConfigWriter *writer;

  do{ if (fd > 0) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "fd > 0"); return (((void*)0)); }; }while (0);
...
# 211 "gimpconfigwriter.c"
GimpConfigWriter *
gimp_config_writer_new_string (GString *string)
{
  GimpConfigWriter *writer;

  do{ if (string != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "string != NULL"); return (((void*)0)); }; }while (0);
...
# 239 "gimpconfigwriter.c"
void
gimp_config_writer_comment_mode (GimpConfigWriter *writer,
                                 gboolean enable)
{
  do{ if (writer != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer != NULL"); return; }; }while (0);
...
# 276 "gimpconfigwriter.c"
void
gimp_config_writer_open (GimpConfigWriter *writer,
                         const gchar *name)
{
  do{ if (writer != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer != NULL"); return; }; }while (0);
  do{ if (name != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "name != NULL"); return; }; }while (0);
...
{
  do{ if (writer != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer != NULL"); return; }; }while (0);
  do{ if (len == 0 || string != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "len == 0 || string != NULL"); return; }; }while (0);
                           ...
                           ...)
{
  ...
  do{ if (writer != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer != NULL"); return; }; }while (0);
  do{ if (format != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "format != NULL"); return; }; }while (0);
...
# 396 "gimpconfigwriter.c"
void
gimp_config_writer_identifier (GimpConfigWriter *writer,
                               const gchar *identifier)
{
  do{ if (writer != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer != NULL"); return; }; }while (0);
  do{ if (identifier != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "identifier != NULL"); return; }; }while (0);
                         ...
                         const guint8 *data)
{
  ...
  do{ if (writer != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer != NULL"); return; }; }while (0);
  do{ if (length > 0) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "length > 0"); return; }; }while (0);
  do{ if (data != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "data != NULL"); return; }; }while (0);
  ...
  for (i = 0; i < length; i++)
    {
      if (((g_ascii_table[(guchar) (data[i])] & G_ASCII_ALPHA) != 0))
        g_string_append_c_inline (writer->buffer, data[i]);
      else
...
gimp_config_writer_revert (GimpConfigWriter *writer)
{
  ...
  do{ if (writer->depth > 0) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer->depth > 0"); return; }; }while (0);
  do{ if (writer->marker != -1) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer->marker != -1"); return; }; }while (0);
                           ...
                           GError **error)
{
  ...
  do{ if (writer != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer != NULL"); return ((0)); }; }while (0);
  ...
  do { if (1) g_slice_free1 (sizeof (GimpConfigWriter), (writer)); else (void) ((GimpConfigWriter*) 0 == (writer)); } while (0);
  ...
  if (writer->buffer->len == 0 && !writer->comment)
    {
      if (write (writer->fd, "\n", 1) < 0)
        ...
        (gimp_config_error_quark ()), GIMP_CONFIG_ERROR_WRITE,
                            ...
                            const gchar *comment)
{
  ...
  gimp_config_writer_comment_mode (writer, (!(0)));
  ...
  while (len > 0)
    {
      for (s = comment, i = 0, space = 0;
           *s != '\n' && (i <= 75 || space == 0) && i < len;
           s++, i++)
        {
          if (((g_ascii_table[(guchar) (*s)] & G_ASCII_SPACE) != 0))
            space = i;
        }
...
gimp_config_writer_close_file (GimpConfigWriter *writer,
                               GError **error)
{
  do{ if (writer->fd != 0) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "writer->fd != 0"); return ((0)); }; }while (0);
  ...
  if (writer->tmpname)
    {
      if (rename (writer->tmpname, writer->filename) == -1)
        {
          g_set_error (error, (gimp_config_error_quark ()), GIMP_CONFIG_ERROR_WRITE,
                       dgettext ("gimp20" "-libgimp", "Could not create '%s': %s"),
                       gimp_filename_to_utf8 (writer->filename),
                       g_strerror ((*__errno_location ())));
