...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpcolorconfig.c" 2
# 22 "gimpcolorconfig.c"
# 1 "../config.h" 1
# 23 "gimpcolorconfig.c" 2
...
# 31 "gimpcolorconfig.c" 2



# 1 "./gimpcolorconfig.h" 1
# 37 "./gimpcolorconfig.h"
...
gboolean gimp_config_copy (GimpConfig *src,
                                                 GimpConfig *dest,
                                                 GParamFlags flags);
# 36 "gimpcolorconfig.c" 2
# 1 "./gimpconfig-params.h" 1
# 37 "gimpcolorconfig.c" 2
# 1 "./gimpconfig-path.h" 1
# 41 "./gimpconfig-path.h"
...
# 40 "gimpcolorconfig.c" 2
# 77 "gimpcolorconfig.c"
enum
{
  PROP_0,
  PROP_MODE,
...
static void gimp_color_config_init (GimpColorConfig *self); static void gimp_color_config_class_init (GimpColorConfigClass *klass); static gpointer gimp_color_config_parent_class = ((void*)0); static gint GimpColorConfig_private_offset; static void gimp_color_config_class_intern_init (gpointer klass) { gimp_color_config_parent_class = g_type_class_peek_parent (klass); if (GimpColorConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpColorConfig_private_offset); gimp_color_config_class_init ((GimpColorConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_color_config_get_instance_private (GimpColorConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpColorConfig_private_offset)))); } GType gimp_color_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpColorConfig"), sizeof (GimpColorConfigClass), (GClassInitFunc) gimp_color_config_class_intern_init, sizeof (GimpColorConfig), (GInstanceInitFunc) gimp_color_config_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) ((void*)0), ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); } gimp_type_set_translation_domain (g_define_type_id, "gimp20" "-libgimp");} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_color_config_class_init (GimpColorConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_MODE, g_param_spec_enum ("mode", ((void*)0), ("Mode of operation for color management."), (gimp_color_management_mode_get_type ()), GIMP_COLOR_MANAGEMENT_DISPLAY, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_RGB_PROFILE, gimp_param_spec_config_path ("rgb-profile", ((void*)0), ("The default RGB working space color profile."), GIMP_CONFIG_PATH_FILE, ((void*)0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_CMYK_PROFILE, gimp_param_spec_config_path ("cmyk-profile", ((void*)0), ("The CMYK color profile used to convert between RGB and CMYK."), GIMP_CONFIG_PATH_FILE, ((void*)0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_DISPLAY_PROFILE, gimp_param_spec_config_path ("display-profile", ((void*)0), ("The color profile of your (primary) monitor."), GIMP_CONFIG_PATH_FILE, ((void*)0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_DISPLAY_PROFILE_FROM_GDK, g_param_spec_boolean ("display-profile-from-gdk", ((void*)0), ("When enabled, GIMP will try to use the display color profile from " "the windowing system.  The configured monitor profile is then only " "used as a fallback."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_PRINTER_PROFILE, gimp_param_spec_config_path ("printer-profile", ((void*)0), ("The color profile used for simulating a printed version (softproof)."), GIMP_CONFIG_PATH_FILE, ((void*)0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_DISPLAY_RENDERING_INTENT, g_param_spec_enum ("display-rendering-intent", ((void*)0), ("Sets how colors are mapped for your display."), (gimp_color_rendering_intent_get_type ()), GIMP_COLOR_RENDERING_INTENT_PERCEPTUAL, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));





  g_object_class_install_property (object_class, PROP_SIMULATION_RENDERING_INTENT, g_param_spec_enum ("simulation-rendering-intent", ((void*)0), ("Sets how colors are converted from RGB working space to the " "print simulation device."), (gimp_color_rendering_intent_get_type ()), GIMP_COLOR_RENDERING_INTENT_PERCEPTUAL, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));





  g_object_class_install_property (object_class, PROP_SIMULATION_GAMUT_CHECK, g_param_spec_boolean ("simulation-gamut-check", ((void*)0), ("When enabled, the print simulation will mark colors which can not be " "represented in the target color space."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_OUT_OF_GAMUT_COLOR, gimp_param_spec_rgb ("out-of-gamut-color", ((void*)0), ("The color to use for marking colors which are out of gamut."), (0), &color, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));





  g_object_class_install_property (object_class, PROP_DISPLAY_MODULE, g_param_spec_string ("display-module", ((void*)0), ((void*)0), "CdisplayLcms", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
{
  GimpColorConfig *color_config = ((((GimpColorConfig*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_color_config_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_color_config_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                                ...
                                GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpcolorconfig.c", 258, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                ...
                                GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpcolorconfig.c", 308, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
