# 1 "gimpconfig-utils.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 319 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpconfig-utils.c" 2
# 22 "gimpconfig-utils.c"
# 1 "../config.h" 1
# 23 "gimpconfig-utils.c" 2
...
gboolean gimp_config_copy (GimpConfig *src,
                                                 GimpConfig *dest,
                                                 GParamFlags flags);
# 32 "gimpconfig-utils.c" 2
# 1 "./gimpconfig-params.h" 1
# 33 "gimpconfig-utils.c" 2
...
void gimp_config_string_append_escaped (GString *string,
                                              const gchar *val);
# 34 "gimpconfig-utils.c" 2
# 45 "gimpconfig-utils.c"
static gboolean
                       ...
                       GParamFlags flags)
{
  ...
  param_specs = g_object_class_list_properties (((((GObjectClass*) (((GTypeInstance*) ((a)))->g_class)))),
                                                &n_param_specs);
  ...
  for (i = 0; i < n_param_specs; i++)
    {
      ...
      GParamSpec *b_spec = g_object_class_find_property (((((GObjectClass*) (((GTypeInstance*) ((b)))->g_class)))),
                                                         a_spec->name);
                  ...
                  GParamFlags flags)
{
  ...
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((a)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "G_IS_OBJECT (a)"); return (((void*)0)); }; }while (0);
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((b)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "G_IS_OBJECT (b)"); return (((void*)0)); }; }while (0);

  if (((((GTypeClass*) (((GTypeInstance*) (a))->g_class))->g_type)) == ((((GTypeClass*) (((GTypeInstance*) (b))->g_class))->g_type)))
                  ...
                  GParamFlags flags)
{
  ...
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((src)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "G_IS_OBJECT (src)"); return ((0)); }; }while (0);
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((dest)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "G_IS_OBJECT (dest)"); return ((0)); }; }while (0);





  if (((((GTypeClass*) (((GTypeInstance*) (src))->g_class))->g_type)) == ((((GTypeClass*) (((GTypeInstance*) (dest))->g_class))->g_type)))
...
gimp_config_reset_properties (GObject *object)
{
  ...
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((object)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "G_IS_OBJECT (object)"); return; }; }while (0);

  klass = ((((GObjectClass*) (((GTypeInstance*) ((object)))->g_class))));
  ...
  for (i = 0; i < n_property_specs; i++)
    {
      ...
      if ((prop_spec->flags & G_PARAM_WRITABLE) &&
        ...
        {
          if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((prop_spec)); GType __t = ((g_param_spec_types[19])); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
            {
                            ...
                            const gchar *property_name)
{
  ...
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((object)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "G_IS_OBJECT (object)"); return; }; }while (0);
  do{ if (property_name != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "property_name != NULL"); return; }; }while (0);
...
# 403 "gimpconfig-utils.c"
void
gimp_config_string_append_escaped (GString *string,
                                   const gchar *val)
{
  do{ if (string != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "string != NULL"); return; }; }while (0);
