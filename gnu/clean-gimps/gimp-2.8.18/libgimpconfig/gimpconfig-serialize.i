# 1 "gimpconfig-serialize.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 319 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpconfig-serialize.c" 2
# 22 "gimpconfig-serialize.c"
# 1 "../config.h" 1
# 23 "gimpconfig-serialize.c" 2
...
gboolean gimp_config_copy (GimpConfig *src,
                                                 GimpConfig *dest,
                                                 GParamFlags flags);
# 35 "gimpconfig-serialize.c" 2
# 1 "./gimpconfig-params.h" 1
# 36 "gimpconfig-serialize.c" 2
...
void gimp_config_string_append_escaped (GString *string,
                                              const gchar *val);
# 38 "gimpconfig-serialize.c" 2
# 49 "gimpconfig-serialize.c"
static gboolean gimp_config_serialize_rgb (const GValue *value,
                                            GString *str,
                                            gboolean has_alpha);
# 65 "gimpconfig-serialize.c"
gboolean
                                  ...
                                  GimpConfigWriter *writer)
{
  ...
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((config)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "G_IS_OBJECT (config)"); return ((0)); }; }while (0);
  ...
  for (i = 0; i < n_property_specs; i++)
    {
      ...
      g_object_get_property (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))), prop_spec->name, &value);
...
# 166 "gimpconfig-serialize.c"
gboolean
gimp_config_serialize_property (GimpConfig *config,
                                GParamSpec *param_spec,
                                GimpConfigWriter *writer)
{
  GimpConfigInterface *config_iface = ((void*)0);
  GimpConfigInterface *parent_iface = ((void*)0);
  GValue value = { 0, };
  gboolean success = (0);

  if (! (param_spec->flags & (1 << (0 + (8)))))
    return (0);

  if (param_spec->flags & (1 << (5 + (8))))
    return (!(0));

  g_value_init (&value, param_spec->value_type);
  g_object_get_property (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))), param_spec->name, &value);

  if (param_spec->flags & (1 << (4 + (8))) &&
  ...
  if (((g_type_fundamental (param_spec->owner_type)) == ((GType) ((20) << (2)))))
    {
      GTypeClass *owner_class = g_type_class_peek (param_spec->owner_type);

      config_iface = g_type_interface_peek (owner_class, (gimp_config_interface_get_type ()));
# 209 "gimpconfig-serialize.c"
      if (config_iface)
        {
  ...
  if (! success)
    {
      if ((((__extension__ ({ GValue *__val = (GValue*) ((&value)); GType __t = (((GType) ((20) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
        {
          GimpConfigInterface *config_iface = ((void*)0);
          ...
          if (prop_object)
            config_iface = ((((GimpConfigInterface*) g_type_interface_peek (((GTypeInstance*) ((prop_object)))->g_class, ((gimp_config_interface_get_type ()))))));
          else
            success = (!(0));
          ...
          if (config_iface)
            {
              ...
              if (! (param_spec->flags & (1 << (1 + (8)))))
                {
                  GType object_type = ((((GTypeClass*) (((GTypeInstance*) (prop_object))->g_class))->g_type));

                  gimp_config_writer_string (writer, g_type_name (object_type));
                }

              success = config_iface->serialize (prop_object, writer, ((void*)0));
      ...
      else
        {
          ...
          if ((((__extension__ ({ GValue *__val = (GValue*) ((&value)); GType __t = ((gimp_rgb_get_type ())); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
            {
            ...
            {
              success = gimp_config_serialize_value (&value, str, (!(0)));
            }
      ...
      if (! success)
        {
          ...
          if ((((__extension__ ({ GValue *__val = (GValue*) ((&value)); GType __t = (((GType) ((16) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
            {
              success = (!(0));
            }
          else
            {
              g_warning ("couldn't serialize property %s::%s of type %s",
                         g_type_name (((((GTypeClass*) (((GTypeInstance*) (config))->g_class))->g_type))),
                         param_spec->name,
                                        ...
                                        GimpConfigWriter *writer)
{
  ...
  pspec = g_object_class_find_property (((((GObjectClass*) (((GTypeInstance*) ((config)))->g_class)))),
                                        prop_name);
...
# 360 "gimpconfig-serialize.c"
gboolean
gimp_config_serialize_value (const GValue *value,
                             GString *str,
                             gboolean escaped)
{
  if ((((__extension__ ({ GValue *__val = (GValue*) ((value)); GType __t = (((GType) ((5) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
    {
      gboolean bool;
  ...
  if ((((__extension__ ({ GValue *__val = (GValue*) ((value)); GType __t = (((GType) ((12) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
    {
      GEnumClass *enum_class = g_type_class_peek ((((GValue*) (value))->g_type));
      ...
      if (enum_value && enum_value->value_nick)
      ...
      else
        {
          g_warning ("Couldn't get nick for enum_value of %s",
                     (g_type_name (((((GTypeClass*) (enum_class))->g_type)))));
          return (0);
        }
    }
  ...
  if ((((__extension__ ({ GValue *__val = (GValue*) ((value)); GType __t = (((GType) ((15) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))) || (((__extension__ ({ GValue *__val = (GValue*) ((value)); GType __t = (((GType) ((14) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
    {
      gdouble v_double;
      gchar buf[(29 + 10)];

      if ((((__extension__ ({ GValue *__val = (GValue*) ((value)); GType __t = (((GType) ((15) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
  ...
  if ((((__extension__ ({ GValue *__val = (GValue*) ((value)); GType __t = ((gimp_rgb_get_type ())); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
    {
      return gimp_config_serialize_rgb (value, str, (!(0)));
    }

  if ((((__extension__ ({ GValue *__val = (GValue*) ((value)); GType __t = ((gimp_matrix2_get_type ())); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
    {
      GimpMatrix2 *trafo;
  ...
  if ((((GValue*) (value))->g_type) == (g_value_array_get_type ()))
    {
      GValueArray *array;
  ...
  if (g_value_type_transformable ((((GValue*) (value))->g_type), ((GType) ((16) << (2)))))
    {
      GValue tmp_value = { 0, };

      g_value_init (&tmp_value, ((GType) ((16) << (2))));
  ...
  if (rgb)
    {
      ...
      g_ascii_formatd (buf[0], (29 + 10), "%f", rgb->r);
      g_ascii_formatd (buf[1], (29 + 10), "%f", rgb->g);
      g_ascii_formatd (buf[2], (29 + 10), "%f", rgb->b);

      if (has_alpha)
        {
          g_ascii_formatd (buf[3], (29 + 10), "%f", rgb->a);
