# 1 "gimpconfig-deserialize.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 319 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpconfig-deserialize.c" 2
# 22 "gimpconfig-deserialize.c"
# 1 "../config.h" 1
# 23 "gimpconfig-deserialize.c" 2
...
GTokenType gimp_config_deserialize_property (GimpConfig *config,
                                                GScanner *scanner,
                                                gint nest_level);
# 36 "gimpconfig-deserialize.c" 2
# 1 "./gimpconfig-params.h" 1
# 37 "gimpconfig-deserialize.c" 2
...
# 41 "gimpconfig-deserialize.c" 2
# 59 "gimpconfig-deserialize.c"
                           ...
                           const gchar *token_name)
{
  ...
  g_scanner_error (scanner,
                   dgettext ("gimp20" "-libgimp", "value for token %s is not a valid UTF-8 string"),
                   token_name);

  return (0);
}
# 127 "gimpconfig-deserialize.c"
gboolean
                                  ...
                                  gint nest_level)
{
  ...
  prop_spec = ((((GParamSpec*) g_type_check_instance_cast ((GTypeInstance*) ((scanner->value.v_symbol)), (((GType) ((19) << (2))))))));

  g_value_init (&value, prop_spec->value_type);

  if (((g_type_fundamental (prop_spec->owner_type)) == ((GType) ((20) << (2)))))
    {
...
# 267 "gimpconfig-deserialize.c"
  ...
  if (token == G_TOKEN_RIGHT_PAREN &&
    ...
    {
      if (! ((((__extension__ ({ GValue *__val = (GValue*) ((&value)); GType __t = (((GType) ((20) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))) &&
             (prop_spec->flags & (1 << (1 + (8))))))
        g_object_set_property (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))), prop_spec->name, &value);
    }
# 319 "gimpconfig-deserialize.c"
  g_value_unset (&value);
                                     ...
                                     GScanner *scanner)
{
  ...
  switch (value_type)
    ...
    default:
      do { g_assertion_message_expr ("LibGimpConfig", "gimpconfig-deserialize.c", 419, ((const char*) (__func__)), ((void*)0)); } while (0);
      break;
    }
  ...
  switch (value_type)
      ...
      else
        {
          g_scanner_error
            (scanner,
             ...
             dgettext ("gimp20" "-libgimp", "expected 'yes' or 'no' for boolean token %s, got '%s'"),
    ...
    default:
      do { g_assertion_message_expr ("LibGimpConfig", "gimpconfig-deserialize.c", 494, ((const char*) (__func__)), ((void*)0)); } while (0);
      break;
    }
                              ...
                              GScanner *scanner)
{
  ...
  enum_class = g_type_class_peek ((((GValue*) (value))->g_type));
  ...
  switch (g_scanner_peek_next_token (scanner))
    ...
    case G_TOKEN_IDENTIFIER:
      ...
      if (!enum_value)
        {
          g_scanner_error (scanner,
                           dgettext ("gimp20" "-libgimp", "invalid value '%s' for token %s"),
    ...
    case G_TOKEN_INT:
      ...
      if (!enum_value)
        {
          g_scanner_error (scanner,
                           dgettext ("gimp20" "-libgimp", "invalid value '%ld' for token %s"),
                                 ...
                                 GScanner *scanner)
{
  ...
  scanner->config->cset_identifier_nth = "0123456789" "gGmMkKbB";
  ...
  if (scanner->value.v_string)
    {
      ...
      if (!expand)
        {
          g_scanner_error (scanner,
                           dgettext ("gimp20" "-libgimp", "while parsing token '%s': %s"),
                                ...
                                gint nest_level)
{
      ...
      if (! (prop_spec->flags & (1 << (1 + (8)))))
        {
          ...
          prop_object = g_object_new (type, ((void*)0));
  ...
  if (! config_iface->deserialize (prop_object, scanner, nest_level + 1, ((void*)0)))
    return G_TOKEN_NONE;
                                     ...
                                     GScanner *scanner)
{
  ...
  array_spec = ((((GParamSpecValueArray*) g_type_check_instance_cast ((GTypeInstance*) ((prop_spec)), ((g_param_spec_types[18]))))));
                              ...
                              GScanner *scanner)
{
  ...
  scanner->config->cset_identifier_first = ( "abcdefghijklmnopqrstuvwxyz" "ABCDEFGHIJKLMNOPQRSTUVWXYZ" "." );
  scanner->config->cset_identifier_nth = ( "abcdefghijklmnopqrstuvwxyz" "ABCDEFGHIJKLMNOPQRSTUVWXYZ"
                                             "0123456789" "-_." );
  ...
  while (g_scanner_peek_next_token (scanner) != G_TOKEN_RIGHT_PAREN)
    {
      ...
      if (token == G_TOKEN_IDENTIFIER)
        ...
        {
          g_scanner_get_next_token (scanner);
          g_string_append_c_inline (buffer, scanner->value.v_char);
        }
      else if (token == ' ')
        {
          g_scanner_get_next_token (scanner);
          g_string_append_c_inline (buffer, token);
        }
      else
        {
          token = G_TOKEN_IDENTIFIER;
                             ...
                             GScanner *scanner)
{
  ...
  if (!g_value_type_transformable (((GType) ((16) << (2))), prop_spec->value_type))
    {
      g_warning ("%s: %s can not be transformed from a string",
                 ((const char*) (__func__)), g_type_name (prop_spec->value_type));
      return G_TOKEN_NONE;
    }
