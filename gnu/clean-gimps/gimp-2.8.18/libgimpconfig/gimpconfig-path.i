...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpconfig-path.c" 2
# 22 "gimpconfig-path.c"
# 1 "../config.h" 1
# 23 "gimpconfig-path.c" 2
...
# 35 "gimpconfig-path.c" 2
# 55 "gimpconfig-path.c"
GType
  ...
  if (! path_type)
    {
      ...
      path_type = g_type_register_static (((GType) ((16) << (2))), "GimpConfigPath",
                                          &type_info, 0);
    }

  return path_type;
}
# 78 "gimpconfig-path.c"
  ...
  if (! spec_type)
    {
      ...
      spec_type = g_type_register_static ((g_param_spec_types[14]),
                                          "GimpParamConfigPath",
                                          &type_info, 0);
    }
...
{
  class->value_type = (gimp_config_path_get_type ());
}
# 146 "gimpconfig-path.c"
GParamSpec *
                             ...
                             GParamFlags flags)
{
  ...
  pspec = g_param_spec_internal ((gimp_param_config_path_get_type ()),
                                 name, nick, blurb, flags);

  pspec->default_value = g_strdup (default_value);

  ((((GimpParamSpecConfigPath*) g_type_check_instance_cast ((GTypeInstance*) ((pspec)), ((gimp_param_config_path_get_type ()))))))->type = type;

  return ((((GParamSpec*) g_type_check_instance_cast ((GTypeInstance*) ((pspec)), (((GType) ((19) << (2))))))));
}
# 177 "gimpconfig-path.c"
GimpConfigPathType
gimp_param_spec_config_path_type (GParamSpec *pspec)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((pspec)); GType __t = ((gimp_param_config_path_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "GIMP_IS_PARAM_SPEC_CONFIG_PATH (pspec)"); return (0); }; }while (0);

  return ((((GimpParamSpecConfigPath*) g_type_check_instance_cast ((GTypeInstance*) ((pspec)), ((gimp_param_config_path_get_type ()))))))->type;
}
...
# 212 "gimpconfig-path.c"
gchar *
gimp_config_build_data_path (const gchar *name)
{
  return g_strconcat ("${gimp_dir}", "/", name,
                      ":",
                      "${gimp_data_dir}", "/", name,
                      ((void*)0));
}
# 238 "gimpconfig-path.c"
gchar *
gimp_config_build_plug_in_path (const gchar *name)
{
  return g_strconcat ("${gimp_dir}", "/", name,
                      ":",
                      "${gimp_plug_in_dir}", "/", name,
                      ((void*)0));
}
# 263 "gimpconfig-path.c"
gchar *
gimp_config_build_writable_path (const gchar *name)
{
  return g_strconcat ("${gimp_dir}", "/", name, ((void*)0));
}
# 288 "gimpconfig-path.c"
gchar *
gimp_config_path_expand (const gchar *path,
                         gboolean recode,
                         GError **error)
{
  do{ if (path != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpConfig", ((const char*) (__func__)), "path != NULL"); return (((void*)0)); }; }while (0);
  ...
  if (recode)
    {
      ...
      retval = g_filename_from_utf8 (expanded, -1, ((void*)0), ((void*)0), error);
                              ...
                              GError **error)
{
  ...
  gchar *n;
  gchar *token;
  gchar *filename = ((void*)0);
  gchar *expanded = ((void*)0);
  gchar **substs = ((void*)0);
  guint n_substs = 0;
  gint length = 0;
  gint i;
  ...
  while (*p)
    {
      ...
      else if ((token = gimp_config_path_extract_token (&p)) != ((void*)0))
        {
          ...
          if (i < n_substs)
          ...
          else
            {
              ...
              if (!s)
                s = g_getenv (token);
# 384 "gimpconfig-path.c"
            }

          if (!s)
            {
              g_set_error (error, (gimp_config_error_quark ()), GIMP_CONFIG_ERROR_PARSE,
      dgettext ("gimp20" "-libgimp", "Cannot expand ${%s}"), token);
              g_free (token);
              goto cleanup;
            }

          if (n_substs % 4 == 0)
            substs = ((gchar * *) g_realloc_n (substs, (2 * (n_substs + 4)), sizeof (gchar *)));
      ...
      else
        {
          ...
          p = (char *)((p) + g_utf8_skip[*(const guchar *)(p)]);
        }
    }
  ...
  expanded = ((gchar *) g_malloc_n ((length + 1), sizeof (gchar)));
