...
__attribute__((visibility("hidden"))) gboolean _gimp_reloc_init (GError **error);
__attribute__((visibility("hidden"))) gboolean _gimp_reloc_init_lib (GError **error);

__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_exe (const gchar *default_exe);
__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_exe_dir (const gchar *default_dir);
__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_prefix (const gchar *default_prefix);
__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_bin_dir (const gchar *default_bin_dir);
__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_data_dir (const gchar *default_data_dir);
__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_plugin_dir (const gchar *default_plugin_dir);
__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_locale_dir (const gchar *default_locale_dir);
__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_lib_dir (const gchar *default_lib_dir);
__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_libexec_dir (const gchar *default_libexec_dir);
__attribute__((visibility("hidden"))) gchar * _gimp_reloc_find_etc_dir (const gchar *default_etc_dir);
# 46 "gimpenv.c" 2
# 80 "gimpenv.c"
...
const guint gimp_major_version = (2);
const guint gimp_minor_version = (8);
const guint gimp_micro_version = (18);
# 99 "gimpenv.c"
void
gimp_env_init (gboolean plug_in)
{
  static gboolean gimp_env_initialized = (0);
  const gchar *data_home = g_get_user_data_dir ();

  if (gimp_env_initialized)
    g_error ("gimp_env_init() must only be called once!");

  gimp_env_initialized = (!(0));


  if (plug_in)
    {
      _gimp_reloc_init_lib (((void*)0));
    }
  else if (_gimp_reloc_init (((void*)0)))
    {


      const gchar *ldpath = g_getenv ("LD_LIBRARY_PATH");
      gchar *libdir = _gimp_reloc_find_lib_dir (((void*)0));

      if (ldpath && *ldpath)
        {
          gchar *tmp = g_strconcat (libdir, ":", ldpath, ((void*)0));

          g_setenv ("LD_LIBRARY_PATH", tmp, (!(0)));

          g_free (tmp);
        }
      else
        {
          g_setenv ("LD_LIBRARY_PATH", libdir, (!(0)));
        }
  ...
  if (! g_file_test (data_home, G_FILE_TEST_IS_DIR))
    {
      if (g_mkdir_with_parents (data_home, 0400 | 0200 | 0100) != 0)
        {
          g_warning ("Failed to create the data directory '%s': %s",
                     data_home, g_strerror ((*__errno_location ())));
        }
    }
}
# 178 "gimpenv.c"
...
gimp_directory (void)
{
  static gchar *gimp_dir = ((void*)0);
  static gchar *last_env_gimp_dir = ((void*)0);
  ...
  if (gimp_dir)
    {
      gboolean gimp2_directory_changed = (0);
...
# 269 "gimpenv.c"
      if (home_dir)
        {
          gimp_dir = g_build_filename (home_dir, ".gimp-2.8", ((void*)0));
        }
      else
        {
...
# 296 "gimpenv.c"
          ...
          subdir_name = g_strconcat (".gimp-2.8" ".", user_name, ((void*)0));
          gimp_dir = g_build_filename (gimp_data_directory (),
                                       subdir_name,
                                       ((void*)0));
          g_free (user_name);
...
{
  static gchar *toplevel = ((void*)0);

  if (toplevel)
    return toplevel;
# 458 "gimpenv.c"
  toplevel = _gimp_reloc_find_prefix ("/usr/local");
...
{
  static gchar *gimp_data_dir = ((void*)0);

  if (! gimp_data_dir)
    {
      gchar *tmp = _gimp_reloc_find_data_dir ("/usr/local/share/gimp/2.0");
...
{
  static gchar *gimp_locale_dir = ((void*)0);

  if (! gimp_locale_dir)
    {
      gchar *tmp = _gimp_reloc_find_locale_dir ("/usr/local/share/locale");
...
{
  static gchar *gimp_sysconf_dir = ((void*)0);

  if (! gimp_sysconf_dir)
    {
      gchar *tmp = _gimp_reloc_find_etc_dir ("/usr/local/etc/gimp/2.0");
...
{
  static gchar *gimp_plug_in_dir = ((void*)0);

  if (! gimp_plug_in_dir)
    {
      gchar *tmp = _gimp_reloc_find_plugin_dir ("/usr/local/lib/gimp/2.0");
...
{
  return g_build_filename (gimp_directory (), basename, ((void*)0));
}
# 649 "gimpenv.c"
const gchar *
gimp_gtkrc (void)
{
  static gchar *gimp_gtkrc_filename = ((void*)0);
                 ...
                 GList **check_failed)
{
  ...
  patharray = g_strsplit (path, ":", max_paths);
...
gimp_path_get_user_writable_dir (GList *path)
{
  ...
  do{ if (path != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "path != NULL"); return (((void*)0)); }; }while (0);
  ...
  for (list = path; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
      ...
      if (!err && ((((filestat.st_mode)) & 0170000) == (0040000)) &&

          ((filestat.st_mode & 0200) ||

           ((filestat.st_mode & (0200 >> 3)) &&
            (euid != filestat.st_uid)) ||

           ((filestat.st_mode & ((0200 >> 3) >> 3)) &&
            (euid != filestat.st_uid) &&
