...
_gimp_reloc_find_bin_dir (const gchar *default_bin_dir)
{
        ...
        prefix = _gimp_reloc_find_prefix (((void*)0));
        if (prefix == ((void*)0)) {

                if (default_bin_dir != ((void*)0))
                        return g_strdup (default_bin_dir);
                else
                        return ((void*)0);
        }

        dir = g_build_filename (prefix, "bin", ((void*)0));
        g_free (prefix);
        return dir;
}
# 519 "gimpreloc.c"
...
_gimp_reloc_find_plugin_dir (const gchar *default_plugin_dir)
{
        ...
        libdir = _gimp_reloc_find_lib_dir (((void*)0));
        if (libdir == ((void*)0)) {

                if (default_plugin_dir != ((void*)0))
...
_gimp_reloc_find_locale_dir (const gchar *default_locale_dir)
{
        ...
        data_dir = _gimp_reloc_find_data_dir (((void*)0));
        if (data_dir == ((void*)0)) {

                if (default_locale_dir != ((void*)0))
                        return g_strdup (default_locale_dir);
                else
                        return ((void*)0);
        }

        dir = g_build_filename (data_dir, "locale", ((void*)0));
        g_free (data_dir);
        return dir;
}
# 610 "gimpreloc.c"
...
_gimp_reloc_find_lib_dir (const gchar *default_lib_dir)
{
        ...
        if (prefix == ((void*)0)) {
                ...
                if (default_lib_dir != ((void*)0))
                        return g_strdup (default_lib_dir);
                else
                        return ((void*)0);
        }

        dir = g_build_filename (prefix, "lib", ((void*)0));
        g_free (prefix);
        return dir;
}
# 643 "gimpreloc.c"
...
_gimp_reloc_find_libexec_dir (const gchar *default_libexec_dir)
{
        ...
        if (prefix == ((void*)0)) {
                ...
                if (default_libexec_dir != ((void*)0))
                        return g_strdup (default_libexec_dir);
                else
                        return ((void*)0);
        }

        dir = g_build_filename (prefix, "libexec", ((void*)0));
        g_free (prefix);
        return dir;
}
# 677 "gimpreloc.c"
