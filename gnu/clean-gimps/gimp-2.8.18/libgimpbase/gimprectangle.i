                          ...
                          gint *dest_height)
{
  ...
  d_x = (((x1) > (x2)) ? (x1) : (x2));
  d_y = (((y1) > (y2)) ? (y1) : (y2));
  d_w = (((x1 + width1) < (x2 + width2)) ? (x1 + width1) : (x2 + width2)) - d_x;
  d_h = (((y1 + height1) < (y2 + height2)) ? (y1 + height1) : (y2 + height2)) - d_y;
