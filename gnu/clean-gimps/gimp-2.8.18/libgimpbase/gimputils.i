                   ...
                   gint max_chars)
{
  ...
  if (str)
    {
      const gchar *p;
      const gchar *newline = ((void*)0);
      gint chars = 0;
      gunichar unichar;

      for (p = str; *p; p = (char *)((p) + g_utf8_skip[*(const guchar *)(p)]))
        {
          if (++chars > max_chars)
            break;
      ...
      if (*p)
        {
          gsize len = p - str;
          gchar *trimmed = ((gchar *) g_malloc_n ((len + e_len + 2), sizeof (gchar)));
                  ...
                  ...)
{
  ...
  do{ if (str != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "str != NULL"); return (((void*)0)); }; }while (0);
  ...
  if (g_utf8_validate (str, len, &start_invalid))
    ...
    {
      utf8 = g_locale_to_utf8 (str, len, ((void*)0), ((void*)0), ((void*)0));
    }
      ...
      if (warning_format)
        {
          ...
          __builtin_va_start(warning_args, warning_format);

          g_logv ("LibGimpBase", G_LOG_LEVEL_MESSAGE,
                  warning_format, warning_args);

          __builtin_va_end(warning_args);
        }
      ...
      if (start_invalid > str)
        {
          ...
          utf8 = g_strconcat (tmp, " ", dgettext ("gimp20" "-libgimp", "(invalid UTF-8 string)"), ((void*)0));
          g_free (tmp);
        }
      else
        {
          utf8 = g_strdup (dgettext ("gimp20" "-libgimp", "(invalid UTF-8 string)"));
        }
    }
      ...
      if (*str == '_')
        {
          ...
          if (past_bracket && str[1] && *((char *)((str + 1) + g_utf8_skip[*(const guchar *)(str + 1)])) == ')')
            {
              str = (char *)((str + 1) + g_utf8_skip[*(const guchar *)(str + 1)]) + 1;
              p--;
            }
          else
            {
                    ...
                    gint value)
{
  ...
  do{ if ((((__extension__ ({ GTypeClass *__class = (GTypeClass*) ((enum_class)); GType __t = (((GType) ((12) << (2)))); gboolean __r; if (!__class) __r = (0); else if (__class->g_type == __t) __r = (!(0)); else __r = g_type_check_class_is_a (__class, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "G_IS_ENUM_CLASS (enum_class)"); return (((void*)0)); }; }while (0);

  value_desc =
    gimp_enum_get_value_descriptions ((((GTypeClass*) (enum_class))->g_type));
                     ...
                     const gchar **value_help)
{
  ...
  do{ if (((g_type_fundamental (enum_type)) == ((GType) ((12) << (2))))) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "G_TYPE_IS_ENUM (enum_type)"); return ((0)); }; }while (0);
...
gimp_enum_value_get_desc (GEnumClass *enum_class,
                          GEnumValue *enum_value)
{
  GType type = (((GTypeClass*) (enum_class))->g_type);
  GimpEnumDesc *enum_desc;
                           ...
                           guint value)
{
  ...
  do{ if ((((__extension__ ({ GTypeClass *__class = (GTypeClass*) ((flags_class)); GType __t = (((GType) ((13) << (2)))); gboolean __r; if (!__class) __r = (0); else if (__class->g_type == __t) __r = (!(0)); else __r = g_type_check_class_is_a (__class, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "G_IS_FLAGS_CLASS (flags_class)"); return (((void*)0)); }; }while (0);

  value_desc =
    gimp_flags_get_value_descriptions ((((GTypeClass*) (flags_class))->g_type));
                            ...
                            const gchar **value_help)
{
  ...
  do{ if (((g_type_fundamental (flags_type)) == ((GType) ((13) << (2))))) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "G_TYPE_IS_FLAGS (flags_type)"); return ((0)); }; }while (0);
...
gimp_flags_value_get_desc (GFlagsClass *flags_class,
                           GFlagsValue *flags_value)
{
  GType type = (((GTypeClass*) (flags_class))->g_type);
  GimpFlagsDesc *flags_desc;
