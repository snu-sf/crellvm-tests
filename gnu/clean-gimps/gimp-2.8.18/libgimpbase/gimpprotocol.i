...
__attribute__((visibility("hidden"))) gboolean _gimp_wire_read_int32 (GIOChannel *channel,
                                                   guint32 *data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_read_int16 (GIOChannel *channel,
                                                   guint16 *data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_read_int8 (GIOChannel *channel,
                                                   guint8 *data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_read_double (GIOChannel *channel,
                                                   gdouble *data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_read_string (GIOChannel *channel,
                                                   gchar **data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_read_color (GIOChannel *channel,
                                                   GimpRGB *data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_write_int32 (GIOChannel *channel,
                                                   const guint32 *data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_write_int16 (GIOChannel *channel,
                                                   const guint16 *data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_write_int8 (GIOChannel *channel,
                                                   const guint8 *data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_write_double (GIOChannel *channel,
                                                   const gdouble *data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_write_string (GIOChannel *channel,
                                                   gchar **data,
                                                   gint count,
                                                   gpointer user_data);
__attribute__((visibility("hidden"))) gboolean _gimp_wire_write_color (GIOChannel *channel,
                                                   const GimpRGB *data,
                                                   gint count,
                                                   gpointer user_data);
# 28 "gimpprotocol.c" 2
...
_gp_config_read (GIOChannel *channel,
                 ...
                 gpointer user_data)
{
  GPConfig *config = ((GPConfig*) g_slice_alloc0 (sizeof (GPConfig)));
 ...
 cleanup:
  ...
  do { if (1) g_slice_free1 (sizeof (GPConfig), (config)); else (void) ((GPConfig*) 0 == (config)); } while (0);
}
...
_gp_tile_req_read (GIOChannel *channel,
                   ...
                   gpointer user_data)
{
  GPTileReq *tile_req = ((GPTileReq*) g_slice_alloc0 (sizeof (GPTileReq)));
 ...
 cleanup:
  do { if (1) g_slice_free1 (sizeof (GPTileReq), (tile_req)); else (void) ((GPTileReq*) 0 == (tile_req)); } while (0);
  msg->data = ((void*)0);
}
...
_gp_tile_req_destroy (GimpWireMessage *msg)
{
  ...
  if (tile_req)
    do { if (1) g_slice_free1 (sizeof (GPTileReq), (msg->data)); else (void) ((GPTileReq*) 0 == (msg->data)); } while (0);
}
...
_gp_tile_data_read (GIOChannel *channel,
                    ...
                    gpointer user_data)
{
  GPTileData *tile_data = ((GPTileData*) g_slice_alloc0 (sizeof (GPTileData)));
  ...
  if (!tile_data->use_shm)
    {
      ...
      tile_data->data = ((guchar *) g_malloc_n ((length), sizeof (guchar)));
 ...
 cleanup:
  ...
  do { if (1) g_slice_free1 (sizeof (GPTileData), (tile_data)); else (void) ((GPTileData*) 0 == (tile_data)); } while (0);
  msg->data = ((void*)0);
}
...
_gp_proc_run_read (GIOChannel *channel,
                   ...
                   gpointer user_data)
{
  GPProcRun *proc_run = ((GPProcRun*) g_slice_alloc0 (sizeof (GPProcRun)));
 ...
 cleanup:
  do { if (1) g_slice_free1 (sizeof (GPProcRun), (proc_run)); else (void) ((GPProcRun*) 0 == (proc_run)); } while (0);
  msg->data = ((void*)0);
}
...
_gp_proc_return_read (GIOChannel *channel,
                      ...
                      gpointer user_data)
{
  GPProcReturn *proc_return = ((GPProcReturn*) g_slice_alloc0 (sizeof (GPProcReturn)));
 ...
 cleanup:
  do { if (1) g_slice_free1 (sizeof (GPProcReturn), (proc_return)); else (void) ((GPProcReturn*) 0 == (proc_return)); } while (0);
  msg->data = ((void*)0);
}
...
_gp_proc_install_read (GIOChannel *channel,
                       ...
                       gpointer user_data)
{
  GPProcInstall *proc_install = ((GPProcInstall*) g_slice_alloc0 (sizeof (GPProcInstall)));
  gint i;
  ...
  proc_install->params = ((GPParamDef *) g_malloc0_n ((proc_install->nparams), sizeof (GPParamDef)));
  ...
  proc_install->return_vals = ((GPParamDef *) g_malloc0_n ((proc_install->nreturn_vals), sizeof (GPParamDef)));
 ...
 cleanup:
  ...
  do { if (1) g_slice_free1 (sizeof (GPProcInstall), (proc_install)); else (void) ((GPProcInstall*) 0 == (proc_install)); } while (0);
  msg->data = ((void*)0);
}
...
_gp_proc_uninstall_read (GIOChannel *channel,
                         ...
                         gpointer user_data)
{
  GPProcUninstall *proc_uninstall = ((GPProcUninstall*) g_slice_alloc0 (sizeof (GPProcUninstall)));
 ...
 cleanup:
  do { if (1) g_slice_free1 (sizeof (GPProcUninstall), (proc_uninstall)); else (void) ((GPProcUninstall*) 0 == (proc_uninstall)); } while (0);
}
                 ...
                 gpointer user_data)
{
  ...
  *params = ((GPParam *) g_malloc0_n ((*nparams), sizeof (GPParam)));
  ...
  for (i = 0; i < *nparams; i++)
    {
      ...
      switch ((*params)[i].type)
        ...
        case GIMP_PDB_INT32ARRAY:
          (*params)[i-1].data.d_int32 = (((0) > ((*params)[i-1].data.d_int32)) ? (0) : ((*params)[i-1].data.d_int32));
          (*params)[i].data.d_int32array = ((gint32 *) g_malloc_n (((*params)[i-1].data.d_int32), sizeof (gint32)));
        ...
        case GIMP_PDB_INT16ARRAY:
          (*params)[i-1].data.d_int32 = (((0) > ((*params)[i-1].data.d_int32)) ? (0) : ((*params)[i-1].data.d_int32));
          (*params)[i].data.d_int16array = ((gint16 *) g_malloc_n (((*params)[i-1].data.d_int32), sizeof (gint16)));
        ...
        case GIMP_PDB_INT8ARRAY:
          (*params)[i-1].data.d_int32 = (((0) > ((*params)[i-1].data.d_int32)) ? (0) : ((*params)[i-1].data.d_int32));
          (*params)[i].data.d_int8array = ((guint8 *) g_malloc_n (((*params)[i-1].data.d_int32), sizeof (guint8)));
        ...
        case GIMP_PDB_FLOATARRAY:
          (*params)[i-1].data.d_int32 = (((0) > ((*params)[i-1].data.d_int32)) ? (0) : ((*params)[i-1].data.d_int32));
          (*params)[i].data.d_floatarray = ((gdouble *) g_malloc_n (((*params)[i-1].data.d_int32), sizeof (gdouble)));
        ...
        case GIMP_PDB_STRINGARRAY:
          (*params)[i-1].data.d_int32 = (((0) > ((*params)[i-1].data.d_int32)) ? (0) : ((*params)[i-1].data.d_int32));
          (*params)[i].data.d_stringarray = ((gchar * *) g_malloc0_n (((*params)[i-1].data.d_int32), sizeof (gchar *)));
 ...
 case GIMP_PDB_COLORARRAY:
   (*params)[i].data.d_colorarray = ((GimpRGB *) g_malloc_n (((*params)[i-1].data.d_int32), sizeof (GimpRGB)));
       ...
       goto cleanup;
        ...
        case GIMP_PDB_PARASITE:
          if (! _gimp_wire_read_string (channel,
                                        ...
                                        user_data))
            goto cleanup;
          if ((*params)[i].data.d_parasite.name == ((void*)0))
            {
