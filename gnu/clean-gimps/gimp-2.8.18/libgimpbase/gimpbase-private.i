# 1 "gimpbase-private.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 319 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpbase-private.c" 2
# 22 "gimpbase-private.c"
# 1 "../config.h" 1
# 23 "gimpbase-private.c" 2
...
# 31 "gimpbase-private.c" 2


GimpUnitVtable _gimp_unit_vtable = { ((void*)0), };


void
gimp_base_init (GimpUnitVtable *vtable)
{
  static gboolean gimp_base_initialized = (0);

  do{ if (vtable != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "vtable != NULL"); return; }; }while (0);
