  ...
  if (! memsize_type)
    {
      ...
      memsize_type = g_type_register_static (((GType) ((11) << (2))), "GimpMemsize",
                                             &type_info, 0);

      g_value_register_transform_func (memsize_type, ((GType) ((16) << (2))),
                                       memsize_to_string);
      g_value_register_transform_func (((GType) ((16) << (2))), memsize_type,
                                       string_to_memsize);
    }
...
gimp_memsize_serialize (guint64 memsize)
{
  if (memsize > (1 << 30) && memsize % (1 << 30) == 0)
    return g_strdup_printf ("%" "lu" "G", memsize >> 30);
  else if (memsize > (1 << 20) && memsize % (1 << 20) == 0)
    return g_strdup_printf ("%" "lu" "M", memsize >> 20);
  else if (memsize > (1 << 10) && memsize % (1 << 10) == 0)
    return g_strdup_printf ("%" "lu" "k", memsize >> 10);
  else
    return g_strdup_printf ("%" "lu", memsize);
}
# 106 "gimpmemsize.c"
gboolean
                          ...
                          guint64 *memsize)
{
  ...
  do{ if (string != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "string != NULL"); return ((0)); }; }while (0);
  do{ if (memsize != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "memsize != NULL"); return ((0)); }; }while (0);

  size = g_ascii_strtoull (string, &end, 0);

  if (size == (0xffffffffffffffffUL) && (*__errno_location ()) == 34)
    return (0);
  ...
  if (end && *end)
    {
      ...
      if (shift)
        {
          guint64 limit = (0xffffffffffffffffUL) >> shift;
  ...
  if (! spec_type)
    {
      ...
      spec_type = g_type_register_static ((g_param_spec_types[8]),
                                          "GimpParamMemsize",
                                          &type_info, 0);
    }
...
{
  class->value_type = (gimp_memsize_get_type ());
}
# 267 "gimpmemsize.c"
GParamSpec *
                         ...
                         GParamFlags flags)
{
  ...
  pspec = g_param_spec_internal ((gimp_param_memsize_get_type ()),
