...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpparasiteio.c" 2
# 27 "gimpparasiteio.c"
# 1 "../config.h" 1
# 28 "gimpparasiteio.c" 2
...
# 34 "gimpparasiteio.c" 2

# 1 "./gimpparasiteio.h" 1
# 41 "./gimpparasiteio.h"
...
gimp_pixpipe_params_init (GimpPixPipeParams *params)
{
  ...
  do{ if (params != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "params != NULL"); return; }; }while (0);
  ...
  params->free_placement_string = (0);
  for (i = 0; i < 4; i++)
    {
      params->selection[i] = "random";
      params->free_selection_string = (0);
    }
  params->rank[0] = 1;
  for (i = 1; i < 4; i++)
    params->rank[i] = 0;
                           ...
                           GimpPixPipeParams *params)
{
  ...
  do{ if (string != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "string != NULL"); return; }; }while (0);
  do{ if (params != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "params != NULL"); return; }; }while (0);
      ...
      if (strcmp (p, "ncells") == 0)
      ...
      else if (strcmp (p, "dim") == 0)
        {
          if (r)
            {
              params->dim = atoi (r + 1);
              params->dim = (((params->dim) > (4)) ? (4) : (((params->dim) < (1)) ? (1) : (params->dim)));
            }
        }
...
gimp_pixpipe_params_build (GimpPixPipeParams *params)
{
  ...
  do{ if (params != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "params != NULL"); return (((void*)0)); }; }while (0);
