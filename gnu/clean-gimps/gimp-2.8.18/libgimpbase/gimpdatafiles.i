                                ...
                                const gchar *extension)
{
  ...
  do{ if (filename != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "filename != NULL"); return ((0)); }; }while (0);
  do{ if (extension != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "extension != NULL"); return ((0)); }; }while (0);
                                 ...
                                 gpointer user_data)
{
  ...
  do{ if (path_str != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "path_str != NULL"); return; }; }while (0);
  do{ if (loader_func != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "loader_func != NULL"); return; }; }while (0);

  local_path = g_strdup (path_str);

  path = gimp_path_parse (local_path, 256, (!(0)), ((void*)0));

  for (list = path; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
      const gchar *dirname = list->data;
      GDir *dir;

      dir = g_dir_open (dirname, 0, ((void*)0));
          ...
          while ((dir_ent = g_dir_read_name (dir)))
            {
              ...
              filename = g_build_filename (dirname, dir_ent, ((void*)0));
