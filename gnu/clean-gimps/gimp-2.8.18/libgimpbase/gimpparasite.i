  ...
  if (! type)
    {
      ...
      type = g_type_register_static ((g_param_spec_types[16]),
                                     "GimpParamParasite",
                                     &type_info, 0);
    }
...
{
  class->value_type = (gimp_parasite_get_type ());
                              ...
                              GValue *value)
{
  ...
  else if (parasite->name == ((void*)0) ||
           ! g_utf8_validate (parasite->name, -1, ((void*)0)) ||
           (parasite->size == 0 && parasite->data != ((void*)0)) ||
           (parasite->size > 0 && parasite->data == ((void*)0)))
    {
      g_value_set_boxed (value, ((void*)0));
      return (!(0));
    }
                                ...
                                const GValue *value2)
{
  ...
  if (! parasite1)
    return parasite2 != ((void*)0) ? -1 : 0;
  else if (! parasite2)
    return parasite1 != ((void*)0);
  else
                          ...
                          GParamFlags flags)
{
  ...
  parasite_spec = g_param_spec_internal ((gimp_param_parasite_get_type ()),
                                         name, nick, blurb, flags);

  return ((((GParamSpec*) g_type_check_instance_cast ((GTypeInstance*) ((parasite_spec)), (((GType) ((19) << (2))))))));
}
# 211 "gimpparasite.c"
GimpParasite *
                   ...
                   gconstpointer data)
{
  ...
  parasite = ((GimpParasite*) g_slice_alloc (sizeof (GimpParasite)));
...
gimp_parasite_free (GimpParasite *parasite)
{
  ...
  do { if (1) g_slice_free1 (sizeof (GimpParasite), (parasite)); else (void) ((GimpParasite*) 0 == (parasite)); } while (0);
}
                       ...
                       const GimpParasite *b)
{
  if (a && b &&
      ...
      a->size == b->size)
    {
      if (a->data == ((void*)0) && b->data == ((void*)0))
        return (!(0));
