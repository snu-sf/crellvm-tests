...
static GHashTable *wire_ht = ((void*)0);
static GimpWireIOFunc wire_read_func = ((void*)0);
static GimpWireIOFunc wire_write_func = ((void*)0);
static GimpWireFlushFunc wire_flush_func = ((void*)0);
static gboolean wire_error_val = (0);
                    ...
                    GimpWireDestroyFunc destroy_func)
{
  ...
  if (! handler)
    handler = ((GimpWireHandler*) g_slice_alloc0 (sizeof (GimpWireHandler)));
...
gimp_wire_read (GIOChannel *channel,
                ...
                gpointer user_data)
{
  do{ if (count >= 0) { } else { g_return_if_fail_warning ("LibGimpBase", ((const char*) (__func__)), "count >= 0"); return ((0)); }; }while (0);
  ...
  if (count > 0)
    {
      ...
      while (count--)
        {
          *data = ((((((guint16) ( (guint16) ((guint16) (*data) >> 8) | (guint16) ((guint16) (*data) << 8)))))));
          data++;
        }
    }
  ...
  for (i = 0; i < count; i++)
    {
      ...
      if (tmp > 0)
        {
          data[i] = ((gchar *) g_try_malloc_n ((tmp), sizeof (gchar)));

          if (! data[i])
            {
              g_printerr ("%s: failed to allocate %u bytes\n", ((const char*) (__func__)), tmp);
              return (0);
            }
  ...
  if (count > 0)
    {
      ...
      for (i = 0; i < count; i++)
        {
          guint32 tmp = (((((guint32) ( (((guint32) (data[i]) & (guint32) 0x000000ffU) << 24) | (((guint32) (data[i]) & (guint32) 0x0000ff00U) << 8) | (((guint32) (data[i]) & (guint32) 0x00ff0000U) >> 8) | (((guint32) (data[i]) & (guint32) 0xff000000U) >> 24))))));
  ...
  if (count > 0)
    {
      ...
      for (i = 0; i < count; i++)
        {
          guint16 tmp = (((((guint16) ( (guint16) ((guint16) (data[i]) >> 8) | (guint16) ((guint16) (data[i]) << 8))))));
