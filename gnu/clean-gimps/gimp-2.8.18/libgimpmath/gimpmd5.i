                     ...
                     guchar digest[16])
{
  ...
  do{ if (buffer != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpMath", ((const char*) (__func__)), "buffer != NULL"); return; }; }while (0);
  do{ if (digest != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpMath", ((const char*) (__func__)), "digest != NULL"); return; }; }while (0);
