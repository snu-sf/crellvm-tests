...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimphelpdomain.c" 2
# 27 "gimphelpdomain.c"
# 1 "../../config.h" 1
# 28 "gimphelpdomain.c" 2
...
gboolean gimp_help_locale_parse (GimpHelpLocale *locale,
                                         ...
                                         GError **error);
# 32 "./gimphelp.h" 2
# 1 "./gimphelpprogress.h" 1
# 27 "./gimphelpprogress.h"
typedef struct
{
...
# 37 "gimphelpdomain.c" 2




# 1 "../../libgimp/stdplugins-intl.h" 1
# 28 "../../libgimp/stdplugins-intl.h"
...
# 29 "../../libgimp/stdplugins-intl.h" 2
# 42 "gimphelpdomain.c" 2
...
gimp_help_domain_new (const gchar *domain_name,
                      const gchar *domain_uri)
{
  GimpHelpDomain *domain = ((GimpHelpDomain*) g_slice_alloc0 (sizeof (GimpHelpDomain)));
...
{
  do{ if (domain != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "domain != NULL"); return; }; }while (0);
  ...
  do { if (1) g_slice_free1 (sizeof (GimpHelpDomain), (domain)); else (void) ((GimpHelpDomain*) 0 == (domain)); } while (0);
}
                                ...
                                GimpHelpProgress *progress)
{
  ...
  domain_locale_parse (domain, locale, progress, ((void*)0));
...
{
  GimpHelpLocale *locale = ((void*)0);
  const gchar *ref = ((void*)0);
  GList *list;

  do{ if (domain != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "domain != NULL"); return (((void*)0)); }; }while (0);
  do{ if (help_locales != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "help_locales != NULL"); return (((void*)0)); }; }while (0);
  do{ if (help_id != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "help_id != NULL"); return (((void*)0)); }; }while (0);
  ...
  if (ref)
  ...
  else
    {
      ...
      if (! domain_locale_parse (domain, locale, ((void*)0), &error))
        {
          switch (error->code)
            {
            case G_IO_ERROR_NOT_FOUND:
              if (domain->help_domain)
                {
                  g_message (gettext ("The help pages for '%s' are not available."),
                             domain->help_domain);
                }
              else
                {
                  g_message ("%s\n\n%s",
                             gettext ("The GIMP user manual is not available."),
                             ...
                             gettext ("Please install the additional help package " "or use the online user manual at: " "http://docs.gimp.org/"));
            ...
            case G_IO_ERROR_NOT_SUPPORTED:
              g_message ("%s\n\n%s",
                         error->message,
                         gettext ("Perhaps you are missing GIO backends and need " "to install GVFS?"));
        ...
        {
          g_message (gettext ("Help ID '%s' unknown"), help_id);
        }
                     ...
                     GError **error)
{
  ...
  do{ if (domain != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "domain != NULL"); return ((0)); }; }while (0);
  do{ if (locale != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "locale != NULL"); return ((0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "error == NULL || *error == NULL"); return ((0)); }; }while (0);
