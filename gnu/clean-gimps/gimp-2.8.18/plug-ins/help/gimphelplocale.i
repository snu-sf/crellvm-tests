...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimphelplocale.c" 2
# 27 "gimphelplocale.c"
# 1 "../../config.h" 1
# 28 "gimphelplocale.c" 2
...
# 43 "gimphelplocale.c" 2
# 1 "./gimphelpprogress-private.h" 1
# 29 "./gimphelpprogress-private.h"
void _gimp_help_progress_start (GimpHelpProgress *progress,
                                  GCancellable *cancellable,
                                  const gchar *format,
                                  ...) __attribute__((__format__ (__printf__, 3, 4))) __attribute__((visibility("hidden")));
void _gimp_help_progress_update (GimpHelpProgress *progress,
                                  gdouble percentage) __attribute__((visibility("hidden")));
void _gimp_help_progress_pulse (GimpHelpProgress *progress) __attribute__((visibility("hidden")));
void _gimp_help_progress_finish (GimpHelpProgress *progress) __attribute__((visibility("hidden")));
# 44 "gimphelplocale.c" 2
...
{
  GimpHelpLocale *locale = ((GimpHelpLocale*) g_slice_alloc0 (sizeof (GimpHelpLocale)));
...
{
  do{ if (locale != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "locale != NULL"); return; }; }while (0);
  ...
  do { if (1) g_slice_free1 (sizeof (GimpHelpLocale), (locale)); else (void) ((GimpHelpLocale*) 0 == (locale)); } while (0);
}
...
gimp_help_locale_map (GimpHelpLocale *locale,
                      const gchar *help_id)
{
  do{ if (locale != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "locale != NULL"); return (((void*)0)); }; }while (0);
                        ...
                        GError **error)
{
  ...
  GCancellable *cancellable = ((void*)0);
  LocaleParser parser = { ((void*)0), };
  goffset size = 0;
  gboolean success;
# 208 "gimphelplocale.c"
  do{ if (locale != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "locale != NULL"); return ((0)); }; }while (0);
  do{ if (uri != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "uri != NULL"); return ((0)); }; }while (0);
  ...
  if (locale->help_id_mapping)
    {
      g_hash_table_destroy (locale->help_id_mapping);
      locale->help_id_mapping = ((void*)0);
    }

  if (locale->help_missing)
    {
      g_free (locale->help_missing);
      locale->help_missing = ((void*)0);
    }
# 248 "gimphelplocale.c"
  ...
  if (progress)
    {
      ...
      _gimp_help_progress_start (progress, cancellable,
                                 gettext ("Loading index from '%s'"), name);
      ...
      if (! info)
        {
          locale_set_error (error,
                            gettext ("Could not open '%s' for reading: %s"), file);
          g_object_unref (file);
  ...
  parser.file = file;
  parser.value = g_string_new (((void*)0));
  parser.locale = locale;
  parser.help_domain = help_domain;
  parser.id_attr_name = g_strdup ("id");

  context = g_markup_parse_context_new (&markup_parser, 0, &parser, ((void*)0));

  success = locale_parser_parse (context, progress,
                                 ((((GInputStream*) g_type_check_instance_cast ((GTypeInstance*) ((stream)), ((g_input_stream_get_type ())))))), size,
                                 cancellable, error);
  ...
  g_string_free (parser.value, (!(0)));
  g_free (parser.id_attr_name);

  if (! success)
    locale_set_error (error, gettext ("Parse error in '%s':\n%s"), file);

  g_object_unref (file);

  return success;
}
# 334 "gimphelplocale.c"
static gboolean
...
{
  do { if (parser->unknown_depth > 0 && parser->state == LOCALE_IN_UNKNOWN) ; else g_assertion_message_expr (((gchar*) 0), "gimphelplocale.c", 476, ((const char*) (__func__)), "parser->unknown_depth > 0 && parser->state == LOCALE_IN_UNKNOWN"); } while (0);
...
locale_parser_parse_item (LocaleParser *parser,
                          ...
                          const gchar **values)
{
  const gchar *id = ((void*)0);
  const gchar *ref = ((void*)0);
  const gchar *title = ((void*)0);
  const gchar *sort = ((void*)0);
  const gchar *parent = ((void*)0);
                             ...
                             const gchar **values)
{
  ...
  if (ref &&
      parser->locale->help_missing == ((void*)0))
    {
