# 1 "gimphelpprogress.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimphelpprogress.c" 2
# 27 "gimphelpprogress.c"
# 1 "../../config.h" 1
# 28 "gimphelpprogress.c" 2
                        ...
                        gpointer user_data)
{
  ...
  do{ if (vtable != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "vtable != NULL"); return (((void*)0)); }; }while (0);

  progress = ((GimpHelpProgress*) g_slice_alloc0 (sizeof (GimpHelpProgress)));
...
{
  do{ if (progress != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "progress != NULL"); return; }; }while (0);

  if (progress->cancellable)
    {
      g_object_unref (progress->cancellable);
      progress->cancellable = ((void*)0);
    }

  do { if (1) g_slice_free1 (sizeof (GimpHelpProgress), (progress)); else (void) ((GimpHelpProgress*) 0 == (progress)); } while (0);
}
                           ...
                           ...)
{
  ...
  if (progress->vtable.start)
    progress->vtable.start (message, cancellable != ((void*)0), progress->user_data);

  g_free (message);
}
# 135 "gimphelpprogress.c"
void
