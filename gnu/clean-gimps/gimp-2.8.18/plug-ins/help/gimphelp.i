...
static GHashTable *domain_hash = ((void*)0);
...
gimp_help_register_domain (const gchar *domain_name,
                           const gchar *domain_uri)
{
  do{ if (domain_name != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "domain_name != NULL"); return; }; }while (0);
  do{ if (domain_uri != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "domain_uri != NULL"); return; }; }while (0);
...
{
  do{ if (domain_name) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "domain_name"); return (((void*)0)); }; }while (0);
...
gimp_help_parse_locales (const gchar *help_locales)
{
  ...
  for (list = locales; list; list = list->next)
    if (strcmp ((const gchar *) list->data, "en") == 0)
      break;
