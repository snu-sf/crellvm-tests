# 1 "gimp-help-lookup.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-help-lookup.c" 2
# 21 "gimp-help-lookup.c"
# 1 "../../config.h" 1
# 22 "gimp-help-lookup.c" 2
...
static const gchar *help_base = ((void*)0);
static gchar *help_root = ((void*)0);
static const gchar *help_locales = ((void*)0);
static const gchar **help_ids = ((void*)0);
      ...
      gchar *argv[])
{
  ...
  help_base = g_getenv ("GIMP2_HELP_URI");
  help_root = g_build_filename (gimp_data_directory (), "help", ((void*)0));

  context = g_option_context_new ("HELP-ID");
  g_option_context_add_main_entries (context, entries, ((void*)0));
  ...
  if (help_base)
    ...
    uri = g_filename_to_uri (help_root, ((void*)0), ((void*)0));

  gimp_help_register_domain ("http://www.gimp.org/help", uri);
  g_free (uri);

  uri = lookup ("http://www.gimp.org/help",
                help_locales ? help_locales : "en",
                help_ids ? help_ids[0] : "gimp-main");
...
progress_new (void)
{
  ...
  return gimp_help_progress_new (&vtable, ((void*)0));
}
