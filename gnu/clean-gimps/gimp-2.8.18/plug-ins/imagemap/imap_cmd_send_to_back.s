	.text
	.file	"imap_cmd_send_to_back.bc"
	.globl	send_to_back_command_new
	.align	16, 0x90
	.type	send_to_back_command_new,@function
send_to_back_command_new:               # @send_to_back_command_new
	.cfi_startproc
# BB#0:                                 # %entry
	pushq	%rbp
.Ltmp0:
...
.Ltmp2:
	...
	callq	gettext
	movabsq	$send_to_back_command_class, %rdx
	...
	retq
.Lfunc_end0:
	.size	send_to_back_command_new, .Lfunc_end0-send_to_back_command_new
	.cfi_endproc

	.align	16, 0x90
	.type	send_to_back_command_execute,@function
...
.Ltmp5:
	...
	movq	-16(%rbp), %rax
	movq	32(%rax), %rdi
	callq	object_list_send_to_back
	movq	-16(%rbp), %rax
	movq	32(%rax), %rdi
	movq	-24(%rbp), %rsi
	...
	retq
.Lfunc_end1:
	.size	send_to_back_command_execute, .Lfunc_end1-send_to_back_command_execute
	.cfi_endproc
...
.L.str:
	...
	.type	send_to_back_command_class,@object # @send_to_back_command_class
	.data
	.align	8
send_to_back_command_class:
	.quad	0
	.quad	send_to_back_command_execute
	.quad	0
	.quad	0
	.size	send_to_back_command_class, 32
