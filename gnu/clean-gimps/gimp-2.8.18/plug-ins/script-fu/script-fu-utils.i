...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "script-fu-utils.c" 2
# 18 "script-fu-utils.c"
# 1 "../../config.h" 1
# 19 "script-fu-utils.c" 2
...
# 23 "script-fu-utils.c" 2

# 1 "./script-fu-utils.h" 1
# 22 "./script-fu-utils.h"
gchar * script_fu_strescape (const gchar *source);
# 25 "script-fu-utils.c" 2
...
script_fu_strescape (const gchar *source)
{
  ...
  do{ if (source != ((void*)0)) { } else { g_return_if_fail_warning (((gchar*) 0), ((const char*) (__func__)), "source != NULL"); return (((void*)0)); }; }while (0);
