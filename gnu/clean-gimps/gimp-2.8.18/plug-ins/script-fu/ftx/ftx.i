...
pointer foreign_fileexists(scheme *sc, pointer args)
{
  ...
  filename = g_filename_from_utf8 (filename, -1, ((void*)0), ((void*)0), ((void*)0));
...
pointer foreign_diropenstream(scheme *sc, pointer args)
{
  ...
  dirpath = g_filename_from_utf8 (dirpath, -1, ((void*)0), ((void*)0), ((void*)0));

  dir = g_dir_open(dirpath, 0, ((void*)0));
  if (dir == ((void*)0))
    return sc->F;
...
pointer foreign_dirreadentry(scheme *sc, pointer args)
{
  ...
  entry = g_filename_to_utf8 (entry, -1, ((void*)0), ((void*)0), ((void*)0));
...
void init_ftx (scheme *sc)
{
  ...
  for (i = 0; file_type_constants[i].name != ((void*)0); ++i)
  {
      sc->vptr->scheme_define(sc, sc->global_env,
