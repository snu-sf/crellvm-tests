...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "script-fu-regex.c" 2
# 28 "script-fu-regex.c"
# 1 "../../config.h" 1
# 29 "script-fu-regex.c" 2

# 1 "./tinyscheme/scheme-private.h" 1





# 1 "./tinyscheme/scheme.h" 1
...
gboolean g_close (gint fd,
                  GError **error);
# 9 "./tinyscheme/scheme.h" 2
# 111 "./tinyscheme/scheme.h"
...
void scheme_register_foreign_func_list(scheme * sc,
                                      ...
                                      int n);
# 7 "./tinyscheme/scheme-private.h" 2
...
# 1 "./tinyscheme/opdefines.h" 1
    ...
    OP_CLOSUREP,
    OP_MACROP,
# 154 "./tinyscheme/scheme-private.h" 2
 OP_MAXDEFINED
};
# 164 "./tinyscheme/scheme-private.h"
int is_string(pointer p);
char *string_value(pointer p);
int is_number(pointer p);
num nvalue(pointer p);
...
int is_immutable(pointer p);
void setimmutable(pointer p);
# 31 "script-fu-regex.c" 2
# 1 "./script-fu-regex.h" 1
# 22 "./script-fu-regex.h"
void script_fu_regex_init (scheme *sc);
# 32 "script-fu-regex.c" 2
                  ...
                  pointer args)
{
  ...
  is_valid_utf8 = g_utf8_validate (string, -1, ((void*)0));
  ...
  regex = g_regex_new (pattern, G_REGEX_EXTENDED, 0, ((void*)0));
  if (! regex)
    return sc->F;

  if (! num)
    {
      success = g_regex_match (regex, string, 0, ((void*)0));
    }
  else
    {
      GMatchInfo *match_info;
