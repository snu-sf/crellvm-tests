...
int i;
 ...
 p2 = p->nextb[ bit_code & 0xff ];
 if ( p2 == 0 )
 {
     p2 = p->nextb[ bit_code & 0xff ] =
  ( struct g3_tree * ) calloc( 1, sizeof( struct g3_tree ));
     if ( p2 == ((void*)0) ) { perror( "malloc 3" ); exit(11); }
     p2->nr_bits = 0;
 ...
 tree_add_node( p2, g3c, bit_code >> 8, bit_length - 8 );
    }
}
...
void build_tree (struct g3_tree ** p, struct g3code * c )
{
 ...
 if ( *p == ((void*)0) ) { perror( "malloc(1)" ); exit(10); }
