...
# 1 "./gimpmoduletypes.h" 1
# 36 "./gimpmoduletypes.h"
...
static void gimp_module_db_init (GimpModuleDB *self); static void gimp_module_db_class_init (GimpModuleDBClass *klass); static gpointer gimp_module_db_parent_class = ((void*)0); static gint GimpModuleDB_private_offset; static void gimp_module_db_class_intern_init (gpointer klass) { gimp_module_db_parent_class = g_type_class_peek_parent (klass); if (GimpModuleDB_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpModuleDB_private_offset); gimp_module_db_class_init ((GimpModuleDBClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_module_db_get_instance_private (GimpModuleDB *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpModuleDB_private_offset)))); } GType gimp_module_db_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpModuleDB"), sizeof (GimpModuleDBClass), (GClassInitFunc) gimp_module_db_class_intern_init, sizeof (GimpModuleDB), (GInstanceInitFunc) gimp_module_db_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_module_db_class_init (GimpModuleDBClass *klass)
{
  ...
  db_signals[ADD] =
    g_signal_new ("add",
                  ...
                  G_SIGNAL_RUN_FIRST,
                  ((glong) __builtin_offsetof(GimpModuleDBClass, add)),
                  ((void*)0), ((void*)0),
  ...
  db_signals[REMOVE] =
    g_signal_new ("remove",
                  (((GTypeClass*) (klass))->g_type),
                  G_SIGNAL_RUN_FIRST,
                  ((glong) __builtin_offsetof(GimpModuleDBClass, remove)),
                  ((void*)0), ((void*)0),
                  g_cclosure_marshal_VOID__OBJECT,
                  ((GType) ((1) << (2))), 1,
                  (gimp_module_get_type ()));
  ...
  db_signals[MODULE_MODIFIED] =
    g_signal_new ("module-modified",
                  (((GTypeClass*) (klass))->g_type),
                  G_SIGNAL_RUN_FIRST,
                  ((glong) __builtin_offsetof(GimpModuleDBClass, module_modified)),
                  ((void*)0), ((void*)0),
                  g_cclosure_marshal_VOID__OBJECT,
                  ((GType) ((1) << (2))), 1,
                  (gimp_module_get_type ()));
...
{
  GimpModuleDB *db = ((((GimpModuleDB*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_module_db_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_module_db_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
# 161 "gimpmoduledb.c"
GimpModuleDB *
gimp_module_db_new (gboolean verbose)
{
  ...
  db = g_object_new ((gimp_module_db_get_type ()), ((void*)0));

  db->verbose = verbose ? (!(0)) : (0);
                    ...
                    const gchar *inhibit_list)
{
  ...
  start = p;
  while (start != inhibit_list && *start != ':')
    start--;
                                 ...
                                 const gchar *load_inhibit)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((db)); GType __t = ((gimp_module_db_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpModule", ((const char*) (__func__)), "GIMP_IS_MODULE_DB (db)"); return; }; }while (0);
  ...
  for (list = db->modules; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((db)); GType __t = ((gimp_module_db_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpModule", ((const char*) (__func__)), "GIMP_IS_MODULE_DB (db)"); return (((void*)0)); }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((db)); GType __t = ((gimp_module_db_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpModule", ((const char*) (__func__)), "GIMP_IS_MODULE_DB (db)"); return; }; }while (0);
  do{ if (module_path != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpModule", ((const char*) (__func__)), "module_path != NULL"); return; }; }while (0);
...
gimp_module_db_module_initialize (const GimpDatafileData *file_data,
                                  gpointer user_data)
{
  GimpModuleDB *db = ((((GimpModuleDB*) g_type_check_instance_cast ((GTypeInstance*) ((user_data)), ((gimp_module_db_get_type ()))))));
  GimpModule *module;
  gboolean load_inhibit;
  ...
  g_signal_connect_data ((module), ("modified"), (((GCallback) (gimp_module_db_module_modified))), (db), ((void*)0), (GConnectFlags) 0);
                                   ...
                                   gpointer user_data)
{
  ...
  g_signal_handlers_disconnect_matched ((module), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_module_db_module_modified), (db));
