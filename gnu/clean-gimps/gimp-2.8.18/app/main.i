         ...
         ...)
{
  ...
  g_logv ("Gimp", G_LOG_LEVEL_ERROR, format, args);
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp", G_LOG_LEVEL_MESSAGE, format, args);
  __builtin_va_end(args);
}
static void
            ...
            ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp", G_LOG_LEVEL_CRITICAL, format, args);
  __builtin_va_end(args);
}
static void
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp", G_LOG_LEVEL_WARNING, format, args);
  __builtin_va_end(args);
}
static void
        ...
        ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp", G_LOG_LEVEL_INFO, format, args);
  __builtin_va_end(args);
}
static void
         ...
         ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp", G_LOG_LEVEL_DEBUG, format, args);
  __builtin_va_end(args);
}
...
# 1 "./pdb/pdb-types.h" 1
# 22 "./pdb/pdb-types.h"
# 1 "./core/core-types.h" 1
# 22 "./core/core-types.h"
...
# 24 "./core/core-types.h" 2


# 1 "./base/base-types.h" 1
# 26 "./base/base-types.h"
# 1 "./paint-funcs/paint-funcs-types.h" 1
# 22 "./paint-funcs/paint-funcs-types.h"
# 1 "./base/base-types.h" 1
# 23 "./paint-funcs/paint-funcs-types.h" 2
# 35 "./paint-funcs/paint-funcs-types.h"
typedef enum
{
...
# 27 "./base/base-types.h" 2

# 1 "./base/base-enums.h" 1
# 39 "./base/base-enums.h"
...
# 29 "./base/base-types.h" 2

# 1 "./config/config-types.h" 1
# 25 "./config/config-types.h"
...
# 26 "./config/config-types.h" 2

# 1 "./config/config-enums.h" 1
# 24 "./config/config-enums.h"
...
# 31 "./base/base-types.h" 2
# 50 "./base/base-types.h"
...
# 27 "./core/core-types.h" 2

# 1 "./core/core-enums.h" 1
# 41 "./core/core-enums.h"
...
# 29 "./core/core-types.h" 2
# 60 "./core/core-types.h"
...
# 1 "./gegl/gimp-gegl-types.h" 1
# 23 "./gegl/gimp-gegl-types.h"
# 1 "./core/core-types.h" 1
# 24 "./gegl/gimp-gegl-types.h" 2

# 1 "./gegl/gimp-gegl-enums.h" 1
# 26 "./gegl/gimp-gegl-enums.h"
...
# 238 "./core/core-types.h" 2
# 1 "./paint/paint-types.h" 1
# 22 "./paint/paint-types.h"
# 1 "./core/core-types.h" 1
# 23 "./paint/paint-types.h" 2
# 1 "./paint/paint-enums.h" 1
# 39 "./paint/paint-enums.h"
...
# 239 "./core/core-types.h" 2
# 1 "./text/text-types.h" 1
# 24 "./text/text-types.h"
# 1 "./core/core-types.h" 1
# 25 "./text/text-types.h" 2

# 1 "./text/text-enums.h" 1
# 24 "./text/text-enums.h"
...
# 240 "./core/core-types.h" 2
# 1 "./vectors/vectors-types.h" 1
# 25 "./vectors/vectors-types.h"
# 1 "./core/core-types.h" 1
# 26 "./vectors/vectors-types.h" 2

# 1 "./vectors/vectors-enums.h" 1
# 24 "./vectors/vectors-enums.h"
typedef enum
{
  GIMP_ANCHOR_ANCHOR,
  GIMP_ANCHOR_CONTROL
...
# 241 "./core/core-types.h" 2
# 1 "./pdb/pdb-types.h" 1
# 242 "./core/core-types.h" 2
# 1 "./plug-in/plug-in-types.h" 1
# 22 "./plug-in/plug-in-types.h"
# 1 "./core/core-types.h" 1
# 23 "./plug-in/plug-in-types.h" 2

# 1 "./plug-in/plug-in-enums.h" 1
# 24 "./plug-in/plug-in-enums.h"
...
# 243 "./core/core-types.h" 2
# 23 "./pdb/pdb-types.h" 2
...
# 1 "./config/gimpconfig-dump.h" 1
# 24 "./config/gimpconfig-dump.h"
typedef enum
{
...
# 1 "./core/gimp.h" 1
# 22 "./core/gimp.h"
# 1 "./core/gimpobject.h" 1
# 30 "./core/gimpobject.h"
...
# 55 "main.c" 2
# 1 "./pdb/gimpprocedure.h" 1
# 25 "./pdb/gimpprocedure.h"
...
gint gimp_procedure_name_compare (GimpProcedure *proc1,
                                                   GimpProcedure *proc2);
# 56 "main.c" 2
# 1 "./pdb/internal-procs.h" 1
# 23 "./pdb/internal-procs.h"
...
void app_abort (gboolean no_interface,
                     const gchar *abort_message) __attribute__((__noreturn__));
void app_exit (gint status) __attribute__((__noreturn__));
...
static void gimp_show_version_and_exit (void) __attribute__((__noreturn__));
static void gimp_show_license_and_exit (void) __attribute__((__noreturn__));
...
static const gchar *system_gimprc = ((void*)0);
static const gchar *user_gimprc = ((void*)0);
static const gchar *session_name = ((void*)0);
static const gchar *batch_interpreter = ((void*)0);
static const gchar **batch_commands = ((void*)0);
static const gchar **filenames = ((void*)0);
static gboolean as_new = (0);
static gboolean no_interface = (0);
static gboolean no_data = (0);
static gboolean no_fonts = (0);
static gboolean no_splash = (0);
static gboolean be_verbose = (0);
static gboolean new_instance = (0);

static gboolean use_shm = (!(0));



static gboolean use_cpu_accel = (!(0));
static gboolean console_messages = (0);
static gboolean use_debug_handler = (0);
...
static const GOptionEntry main_entries[] =
{
  { "version", 'v', G_OPTION_FLAG_NO_ARG,
    ...
    ("Show version information and exit"), ((void*)0)
  },
  {
    "license", 0, G_OPTION_FLAG_NO_ARG,
    G_OPTION_ARG_CALLBACK, (GOptionArgFunc) gimp_show_license_and_exit,
    ("Show license information and exit"), ((void*)0)
  },
  {
    "verbose", 0, 0,
    G_OPTION_ARG_NONE, &be_verbose,
    ("Be more verbose"), ((void*)0)
  },
  {
    "new-instance", 'n', 0,
    G_OPTION_ARG_NONE, &new_instance,
    ("Start a new GIMP instance"), ((void*)0)
  },
  {
    "as-new", 'a', 0,
    G_OPTION_ARG_NONE, &as_new,
    ("Open images as new"), ((void*)0)
  },
  {
    "no-interface", 'i', 0,
    G_OPTION_ARG_NONE, &no_interface,
    ("Run without a user interface"), ((void*)0)
  },
  {
    "no-data", 'd', 0,
    G_OPTION_ARG_NONE, &no_data,
    ("Do not load brushes, gradients, patterns, ..."), ((void*)0)
  },
  {
    "no-fonts", 'f', 0,
    G_OPTION_ARG_NONE, &no_fonts,
    ("Do not load any fonts"), ((void*)0)
  },
  {
    "no-splash", 's', 0,
    G_OPTION_ARG_NONE, &no_splash,
    ("Do not show a splash screen"), ((void*)0)
  },
  {
    "no-shm", 0, G_OPTION_FLAG_REVERSE,
    G_OPTION_ARG_NONE, &use_shm,
    ("Do not use shared memory between GIMP and plugins"), ((void*)0)
  },
  {
    "no-cpu-accel", 0, G_OPTION_FLAG_REVERSE,
    G_OPTION_ARG_NONE, &use_cpu_accel,
    ("Do not use special CPU acceleration functions"), ((void*)0)
  },
  {
    "session", 0, 0,
  ...
  },
  {
    ...
    ("Output a sorted list of deprecated procedures in the PDB"), ((void*)0)
  },
  {
    "", 0, 0,
...
# 359 "main.c"
  ...
  g_set_application_name (gettext ("GNU Image Manipulation Program"));
...
# 427 "main.c"
  ...
  context = g_option_context_new (gettext ("[FILE|URI...]"));
  g_option_context_set_summary (context, gettext ("GNU Image Manipulation Program"));

  g_option_context_add_main_entries (context, main_entries, "gimp20");
  ...
  if (! g_option_context_parse_strv (context, &argv, &error))
...

    {
      if (error)
        ...
        {
          g_print ("%s\n",
                   gettext ("GIMP could not initialize the graphical user interface.\n" "Make sure a proper setup for your display environment " "exists."));
  ...
  if (no_interface || be_verbose || console_messages || batch_commands != ((void*)0))
                               ;
                            ...
                            GError **error)
{
  ...
  fatal_mask = g_log_set_always_fatal ((G_LOG_FLAG_RECURSION | G_LOG_LEVEL_ERROR));
  ...
  if (format)
    {
      ...
      gimp = g_object_new ((gimp_get_type ()), ((void*)0));
                                            ...
                                            GError **error)
{
  ...
  for (iter = deprecated_procs; iter; iter = ((iter) ? (((GList *)(iter))->next) : ((void*)0)))
    {
      GimpProcedure *procedure = ((((GimpProcedure*) g_type_check_instance_cast ((GTypeInstance*) ((iter->data)), ((gimp_procedure_get_type ()))))));
...
gimp_show_license_and_exit (void)
{
  ...
  g_print ("\n");
  g_print (gettext ("GIMP is free software: you can redistribute it and/or modify it " "under the terms of the GNU General Public License as published by " "the Free Software Foundation; either version 3 of the License, or " "(at your option) any later version." "\n\n" "GIMP is distributed in the hope that it will be useful, " "but WITHOUT ANY WARRANTY; without even the implied warranty of " "MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the " "GNU General Public License for more details." "\n\n" "You should have received a copy of the GNU General Public License " "along with GIMP. If not, see: http://www.gnu.org/licenses/"));
  g_print ("\n\n");
...
gimp_init_i18n (void)
{
  ...
  bindtextdomain ("gimp20""-libgimp", gimp_locale_directory ());

  bind_textdomain_codeset ("gimp20""-libgimp", "UTF-8");


  bindtextdomain ("gimp20", gimp_locale_directory ());

  bind_textdomain_codeset ("gimp20", "UTF-8");
