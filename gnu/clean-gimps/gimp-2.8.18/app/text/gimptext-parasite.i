# 1 "gimptext-parasite.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimptext-parasite.c" 2
# 21 "gimptext-parasite.c"
# 1 "../../config.h" 1
# 22 "gimptext-parasite.c" 2
...
void gimp_text_get_transformation (GimpText *text,
                                     GimpMatrix3 *matrix);
# 36 "gimptext-parasite.c" 2
# 1 "./gimptext-parasite.h" 1
# 25 "./gimptext-parasite.h"
const gchar * gimp_text_parasite_name (void) __attribute__((__const__));
GimpParasite * gimp_text_to_parasite (const GimpText *text);
GimpText * gimp_text_from_parasite (const GimpParasite *parasite,
                                                 GError **error);

const gchar * gimp_text_gdyntext_parasite_name (void) __attribute__((__const__));
GimpText * gimp_text_from_gdyntext_parasite (const GimpParasite *parasite);
# 37 "gimptext-parasite.c" 2
# 1 "./gimptext-xlfd.h" 1
# 27 "./gimptext-xlfd.h"
...
gimp_text_to_parasite (const GimpText *text)
{
  ...
  str = gimp_config_serialize_to_string (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((text)), ((gimp_config_interface_get_type ())))))), ((void*)0));
  do{ if (str != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "str != NULL"); return (((void*)0)); }; }while (0);
                         ...
                         GError **error)
{
  ...
  do{ if (parasite != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "parasite != NULL"); return (((void*)0)); }; }while (0);
  do{ if (strcmp (gimp_parasite_name (parasite), gimp_text_parasite_name ()) == 0) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "strcmp (gimp_parasite_name (parasite), gimp_text_parasite_name ()) == 0"); return (((void*)0)); }; }while (0);

  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "error == NULL || *error == NULL"); return (((void*)0)); }; }while (0);

  str = gimp_parasite_data (parasite);
  do{ if (str != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "str != NULL"); return (((void*)0)); }; }while (0);

  text = g_object_new ((gimp_text_get_type ()), ((void*)0));

  gimp_config_deserialize_string (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((text)), ((gimp_config_interface_get_type ())))))),
                                  str,
...
gimp_text_from_gdyntext_parasite (const GimpParasite *parasite)
{
  ...
  do{ if (parasite != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "parasite != NULL"); return (((void*)0)); }; }while (0);
  do{ if (strcmp (gimp_parasite_name (parasite), gimp_text_gdyntext_parasite_name ()) == 0) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "strcmp (gimp_parasite_name (parasite), gimp_text_gdyntext_parasite_name ()) == 0"); return (((void*)0)); }; }while (0);
  ...
  if (! g_utf8_validate (text, -1, ((void*)0)))
    {
      gchar *tmp = gimp_any_to_utf8 (text, -1, ((void*)0));

      g_free (text);
      text = tmp;
    }

  antialias = atoi (params[ANTIALIAS]) ? (!(0)) : (0);
  ...
  spacing = g_strtod (params[LINE_SPACING], ((void*)0));

  color = strtol (params[COLOR], ((void*)0), 16);
  gimp_rgba_set_uchar (&rgb, color >> 16, color >> 8, color, 255);

  retval = g_object_new ((gimp_text_get_type ()),
                         "text", text,
                         "antialias", antialias,
                         "justify", justify,
  ...
  gimp_text_set_font_from_xlfd (((((GimpText*) g_type_check_instance_cast ((GTypeInstance*) ((retval)), ((gimp_text_get_type ())))))), params[XLFD]);
