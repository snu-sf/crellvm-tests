...
GType gimp_font_list_get_type (void) __attribute__((__const__));
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((gimp)); GType __t = ((gimp_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "GIMP_IS_GIMP (gimp)"); return; }; }while (0);

  gimp->fonts = gimp_font_list_new (72.0, 72.0);
  gimp_object_set_name (((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->fonts)), ((gimp_object_get_type ())))))), "fonts");

  g_signal_connect_data ((gimp->config), ("notify::font-path"), (((GCallback) (gimp_fonts_load))), (gimp), ((void*)0), G_CONNECT_SWAPPED);
                             ...
                             GimpInitStatusFunc status_callback)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((gimp->fonts)); GType __t = ((gimp_font_list_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "GIMP_IS_FONT_LIST (gimp->fonts)"); return; }; }while (0);
  ...
  gimp_container_freeze (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->fonts)), ((gimp_container_get_type ())))))));

  gimp_container_clear (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->fonts)), ((gimp_container_get_type ())))))));
  ...
  fonts_conf = gimp_personal_rc_file ("fonts.conf");
  if (! gimp_fonts_load_fonts_conf (config, fonts_conf))
    goto cleanup;

  fonts_conf = g_build_filename (gimp_sysconf_directory (), "fonts.conf", ((void*)0));
  if (! gimp_fonts_load_fonts_conf (config, fonts_conf))
    goto cleanup;

  path = gimp_config_path_expand (gimp->config->font_path, (!(0)), ((void*)0));
  ...
  if (status_callback)
    {
      ...
      end_time = g_get_monotonic_time () + 0.1 * ((1000000L));
      while (!data.caching_complete)
        if (!g_cond_wait_until (&data.cond, &data.mutex, end_time))
          {
            status_callback (((void*)0), ((void*)0), 0.6);

            end_time += 0.1 * ((1000000L));
            continue;
          }
  ...
  gimp_font_list_restore (((((GimpFontList*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->fonts)), ((gimp_font_list_get_type ())))))));

 cleanup:
  gimp_container_thaw (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->fonts)), ((gimp_container_get_type ())))))));
...
{
  gimp_fonts_load_with_status (gimp, ((void*)0));
}
                            ...
                            gchar *fonts_conf)
{
  ...
  if (! FcConfigParseAndLoad (config, (const guchar *) fonts_conf, 0))
    {
      FcConfigDestroy (config);
      ret = (0);
    }
                            ...
                            const gchar *path_str)
{
  ...
  do{ if (config != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "config != NULL"); return; }; }while (0);
  do{ if (path_str != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "path_str != NULL"); return; }; }while (0);

  path = gimp_path_parse (path_str, 256, (!(0)), ((void*)0));
