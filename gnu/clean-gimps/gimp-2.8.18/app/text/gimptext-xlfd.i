...
launder_font_name (gchar *name)
{
  ...
  if (((g_ascii_table[(guchar) (last_char)] & G_ASCII_DIGIT) != 0) || last_char == '.')
    {
      laundered_name = g_strconcat (name, ",", ((void*)0));
      g_free (name);
