# 1 "gimptextlayout-render.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimptextlayout-render.c" 2
# 21 "gimptextlayout-render.c"
# 1 "../../config.h" 1
# 22 "gimptextlayout-render.c" 2
...
# 25 "/usr/include/pango-1.0/pango/pango-coverage.h"
...
# 26 "/usr/include/pango-1.0/pango/pango-coverage.h" 2
...
void gimp_text_layout_untransform_distance (GimpTextLayout *layout,
                                                        gdouble *x,
                                                        gdouble *y);
# 28 "gimptextlayout-render.c" 2
# 1 "./gimptextlayout-render.h" 1
# 25 "./gimptextlayout-render.h"
void gimp_text_layout_render (GimpTextLayout *layout,
                               cairo_t *cr,
                               GimpTextDirection base_dir,
                               gboolean path);
# 29 "gimptextlayout-render.c" 2
                         ...
                         gboolean path)
{
  ...
  do{ if (cr != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "cr != NULL"); return; }; }while (0);
