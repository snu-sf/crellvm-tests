...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimptextlayout.c" 2
# 21 "gimptextlayout.c"
# 1 "../../config.h" 1
# 22 "gimptextlayout.c" 2
         ...
         ...)
{
  ...
  g_logv ("Gimp-Text", G_LOG_LEVEL_ERROR, format, args);
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Text", G_LOG_LEVEL_MESSAGE, format, args);
  __builtin_va_end(args);
}
static void
            ...
            ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Text", G_LOG_LEVEL_CRITICAL, format, args);
  __builtin_va_end(args);
}
static void
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Text", G_LOG_LEVEL_WARNING, format, args);
  __builtin_va_end(args);
}
static void
        ...
        ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Text", G_LOG_LEVEL_INFO, format, args);
  __builtin_va_end(args);
}
static void
         ...
         ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Text", G_LOG_LEVEL_DEBUG, format, args);
  __builtin_va_end(args);
}
...
# 26 "gimptextlayout.c" 2
# 1 "/usr/include/pango-1.0/pango/pangocairo.h" 1
# 25 "/usr/include/pango-1.0/pango/pangocairo.h"
...
# 35 "/usr/include/pango-1.0/pango/pango-coverage.h"
...
# 97 "/usr/include/pango-1.0/pango/pango-font.h"
typedef enum {
...
# 127 "/usr/include/pango-1.0/pango/pango-font.h"
typedef enum {
...
# 152 "/usr/include/pango-1.0/pango/pango-font.h"
typedef enum {
...
# 217 "/usr/include/pango-1.0/pango/pango-font.h"
...
# 284 "/usr/include/pango-1.0/pango/pango-font.h"
...
# 341 "/usr/include/pango-1.0/pango/pango-font.h"
...
# 495 "/usr/include/pango-1.0/pango/pango-font.h"
...
# 29 "/usr/include/pango-1.0/pango/pango-item.h"
typedef struct _PangoAnalysis PangoAnalysis;
typedef struct _PangoItem PangoItem;
# 67 "/usr/include/pango-1.0/pango/pango-item.h"
...
# 36 "/usr/include/pango-1.0/pango/pango-context.h"
...
# 30 "/usr/include/pango-1.0/pango/pango-glyph.h"
...
# 12 "/usr/include/pango-1.0/pango/pango-enum-types.h"
...
# 26 "/usr/include/pango-1.0/pango/pangocairo.h" 2
...
# 27 "/usr/include/pango-1.0/pango/pangocairo.h" 2
...
# 33 "gimptextlayout.c" 2

# 1 "../../app/core/gimperror.h" 1
# 22 "../../app/core/gimperror.h"
typedef enum
{
  GIMP_FAILED,
} GimpErrorCode;
...
GQuark gimp_error_quark (void) __attribute__((__const__));
# 35 "gimptextlayout.c" 2
...
GType gimp_text_get_type (void) __attribute__((__const__));

void gimp_text_get_transformation (GimpText *text,
                                     GimpMatrix3 *matrix);
# 37 "gimptextlayout.c" 2
# 1 "./gimptextlayout.h" 1
# 30 "./gimptextlayout.h"
...
GType gimp_text_layout_get_type (void) __attribute__((__const__));
...
static void gimp_text_layout_init (GimpTextLayout *self); static void gimp_text_layout_class_init (GimpTextLayoutClass *klass); static gpointer gimp_text_layout_parent_class = ((void*)0); static gint GimpTextLayout_private_offset; static void gimp_text_layout_class_intern_init (gpointer klass) { gimp_text_layout_parent_class = g_type_class_peek_parent (klass); if (GimpTextLayout_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpTextLayout_private_offset); gimp_text_layout_class_init ((GimpTextLayoutClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_text_layout_get_instance_private (GimpTextLayout *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpTextLayout_private_offset)))); } GType gimp_text_layout_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpTextLayout"), sizeof (GimpTextLayoutClass), (GClassInitFunc) gimp_text_layout_class_intern_init, sizeof (GimpTextLayout), (GInstanceInitFunc) gimp_text_layout_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpTextLayout *layout = ((((GimpTextLayout*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_text_layout_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_text_layout_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                      ...
                      GError **error)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((text)); GType __t = ((gimp_text_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "GIMP_IS_TEXT (text)"); return (((void*)0)); }; }while (0);

  font_desc = pango_font_description_from_string (text->font);
  do{ if (font_desc != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "font_desc != NULL"); return (((void*)0)); }; }while (0);

  size = pango_units_from_double (gimp_units_to_points (text->font_size,
                                                        text->unit,
                                                        yres));

  pango_font_description_set_size (font_desc, (((1) > (size)) ? (1) : (size)));

  context = gimp_text_get_pango_context (text, xres, yres);

  layout = g_object_new ((gimp_text_layout_get_type ()), ((void*)0));
  ...
  switch (text->justify)
    ...
    case GIMP_TEXT_JUSTIFY_FILL:
      alignment = PANGO_ALIGN_LEFT;
      pango_layout_set_justify (layout->layout, (!(0)));
      break;
    }
...
gimp_text_layout_get_size (GimpTextLayout *layout,
                           ...
                           gint *height)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((layout)); GType __t = ((gimp_text_layout_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "GIMP_IS_TEXT_LAYOUT (layout)"); return ((0)); }; }while (0);
...
gimp_text_layout_get_offsets (GimpTextLayout *layout,
                              ...
                              gint *y)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((layout)); GType __t = ((gimp_text_layout_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "GIMP_IS_TEXT_LAYOUT (layout)"); return; }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((layout)); GType __t = ((gimp_text_layout_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "GIMP_IS_TEXT_LAYOUT (layout)"); return (((void*)0)); }; }while (0);
                                ...
                                cairo_matrix_t *matrix)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((layout)); GType __t = ((gimp_text_layout_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "GIMP_IS_TEXT_LAYOUT (layout)"); return; }; }while (0);
  do{ if (matrix != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "matrix != NULL"); return; }; }while (0);
                                 ...
                                 PangoRectangle *rect)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((layout)); GType __t = ((gimp_text_layout_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "GIMP_IS_TEXT_LAYOUT (layout)"); return; }; }while (0);
  do{ if (rect != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Text", ((const char*) (__func__)), "rect != NULL"); return; }; }while (0);
  ...
  rect->x = ((int) ((x) + 0.5));
  rect->y = ((int) ((y) + 0.5));
  rect->width = ((int) ((width) + 0.5));
  rect->height = ((int) ((height) + 0.5));
}
...
{
  GimpText *text = layout->text;
  gchar *open_tag = ((void*)0);
  gchar *content = ((void*)0);
  gchar *close_tag = ((void*)0);
  gchar *tagged;
  gchar *markup;
  ...
  markup = g_strconcat (open_tag, tagged, close_tag, ((void*)0));

  g_free (open_tag);
  g_free (tagged);
  g_free (close_tag);

  if (pango_parse_markup (markup, -1, 0, ((void*)0), ((void*)0), ((void*)0), error) == (0))
    {
      if (error && *error &&
          (*error)->domain == g_markup_error_quark () &&
          (*error)->code == G_MARKUP_ERROR_INVALID_CONTENT)
        {
# 574 "gimptextlayout.c"
          g_error_free (*error);
          *error = ((void*)0);
          g_set_error_literal (error, (gimp_error_quark ()), GIMP_FAILED,
                               gettext ("The new text layout cannot be generated. " "Most likely the font size is too big."));
...
# 612 "gimptextlayout.c"
  if (ink.width < 1 || ink.height < 1)
    return;

  x1 = (((ink.x) < (logical.x)) ? (ink.x) : (logical.x));
  y1 = (((ink.y) < (logical.y)) ? (ink.y) : (logical.y));
  x2 = (((ink.x + ink.width) > (logical.x + logical.width)) ? (ink.x + ink.width) : (logical.x + logical.width));
  y2 = (((ink.y + ink.height) > (logical.y + logical.height)) ? (ink.y + ink.height) : (logical.y + logical.height));
  ...
  if (pango_layout_get_width (layout->layout) > 0)
    {
      ...
      pango_layout_get_pixel_size (layout->layout, &width, ((void*)0));

      if ((base_dir == GIMP_TEXT_DIRECTION_LTR && align == PANGO_ALIGN_RIGHT) ||
          (base_dir == GIMP_TEXT_DIRECTION_RTL && align == PANGO_ALIGN_LEFT))
        {
          layout->extents.x +=
            (((int)(pango_layout_get_width (layout->layout)) + 512) >> 10) - width;
        }
      else if (align == PANGO_ALIGN_CENTER)
        {
          layout->extents.x +=
            ((((int)(pango_layout_get_width (layout->layout)) + 512) >> 10) - width) / 2;
       }
    }
                             ...
                             gdouble yres)
{
  ...
  pango_cairo_font_map_set_resolution (((((PangoCairoFontMap*) g_type_check_instance_cast ((GTypeInstance*) ((fontmap)), ((pango_cairo_font_map_get_type ())))))), yres);
