...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "file-procedure.c" 2
# 21 "file-procedure.c"
# 1 "../../config.h" 1
# 22 "file-procedure.c" 2
...
# 37 "/usr/include/glib-2.0/glib/gbacktrace.h"
extern
         ...
         ...)
{
  ...
  g_logv ("Gimp-File", G_LOG_LEVEL_ERROR, format, args);
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-File", G_LOG_LEVEL_MESSAGE, format, args);
  __builtin_va_end(args);
}
static void
            ...
            ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-File", G_LOG_LEVEL_CRITICAL, format, args);
  __builtin_va_end(args);
}
static void
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-File", G_LOG_LEVEL_WARNING, format, args);
  __builtin_va_end(args);
}
static void
        ...
        ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-File", G_LOG_LEVEL_INFO, format, args);
  __builtin_va_end(args);
}
static void
         ...
         ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-File", G_LOG_LEVEL_DEBUG, format, args);
  __builtin_va_end(args);
}
...
# 43 "file-procedure.c" 2

# 1 "../../app/plug-in/gimppluginprocedure.h" 1
# 25 "../../app/plug-in/gimppluginprocedure.h"
...
# 26 "../../app/plug-in/gimppluginprocedure.h" 2

# 1 "../../app/pdb/gimpprocedure.h" 1
# 22 "../../app/pdb/gimpprocedure.h"
...
gint gimp_procedure_name_compare (GimpProcedure *proc1,
                                                   GimpProcedure *proc2);
# 28 "../../app/plug-in/gimppluginprocedure.h" 2
# 38 "../../app/plug-in/gimppluginprocedure.h"
...
# 45 "file-procedure.c" 2

# 1 "./file-procedure.h" 1
# 24 "./file-procedure.h"
typedef enum
{
                     ...
                     GError **error)
{
  ...
  do{ if (procs != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-File", ((const char*) (__func__)), "procs != NULL"); return (((void*)0)); }; }while (0);
  do{ if (uri != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-File", ((const char*) (__func__)), "uri != NULL"); return (((void*)0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-File", ((const char*) (__func__)), "error == NULL || *error == NULL"); return (((void*)0)); }; }while (0);


  file_proc = file_proc_find_by_name (all_procs, uri, (!(0)));
  ...
  if (filename)
    {
      GimpPlugInProcedure *size_matched_proc = ((void*)0);
      FILE *ifp = ((void*)0);
      gboolean opened = (0);
      gint head_size = 0;
              ...
              if ((!opened))
                {
                  ...
                  if (ifp != ((void*)0))
                    ...
                    g_set_error_literal (error,
                                         g_file_error_quark (),
                                         g_file_error_from_errno ((*__errno_location ())),
      ...
      if (ifp)
        {
          if (ferror (ifp))
            g_set_error_literal (error, g_file_error_quark (),
                                 g_file_error_from_errno ((*__errno_location ())),
                                 g_strerror ((*__errno_location ())));
 ...
 g_set_error_literal (error, g_file_error_quark (), G_FILE_ERROR_FAILED,
        gettext ("Unknown file type"));
    }
                               ...
                               const gchar *uri)
{
  ...
  return file_proc_find_by_prefix (procs, uri, (0));
}
                                  ...
                                  const gchar *uri)
{
  ...
  return file_proc_find_by_extension (procs, uri, (0));
}
                         ...
                         FileProcedureGroup group)
{
  ...
  gboolean is_xcf_save = (0);
  gboolean is_filter = (0);
  gboolean is_uri = (0);
                          ...
                          gboolean skip_magic)
{
  ...
  for (p = procs; p; p = ((p) ? (((GSList *)(p))->next) : ((void*)0)))
    {
      ...
      for (prefixes = proc->prefixes_list;
           prefixes;
           prefixes = ((prefixes) ? (((GSList *)(prefixes))->next) : ((void*)0)))
        {
  ...
  for (p = procs; p; p = ((p) ? (((GSList *)(p))->next) : ((void*)0)))
    {
      ...
      for (extensions = proc->extensions_list;
           ext && extensions;
           extensions = ((extensions) ? (((GSList *)(extensions))->next) : ((void*)0)))
        {
          const gchar *p1 = ext;
      ...
      switch (*uin)
        {
          case '0': case '1': case '2': case '3':
            for (tmpptr = tmp; (tmpptr - tmp) <= 3;)
              {
                *(tmpptr++) = *(uin++);
                if ( (*uin == '\0') || (!((g_ascii_table[(guchar) (*uin)] & G_ASCII_DIGIT) != 0))
                    || (*uin == '8') || (*uin == '9'))
                  break;
              }
...

{
  ...
  if (num_operator_ptr && (*num_operator_ptr == '&'))
    {
      if (((g_ascii_table[(guchar) (num_operator_ptr[1])] & G_ASCII_DIGIT) != 0))
        {
          if (num_operator_ptr[1] != '0')
            sscanf (num_operator_ptr+1, "%lu", &num_operatorval);
          else if (num_operator_ptr[2] == 'x')
  ...
  if (numbytes > 0)
    {
      ...
      (*__errno_location ()) = 0;
      num_testval = strtol (value, ((void*)0), 0);
      ...
      if (numbytes == 5)
      ...
      else
        {
          ...
          if (fseek (ifp, offs, (offs >= 0) ? 0 : 2) < 0)
            return FILE_MATCH_NONE;

          for (k = 0; k < numbytes; k++)
            fileval = (fileval << 8) | (c = _IO_getc (ifp));
          ...
          for (k = 0; found && (k < numbytes); k++)
            {
              ...
              found = (c != (-1)) && (c == (gint) mem_testval[k]);
            }
        }
    }
...

{
  ...
  while (magics_list)
    {
      if ((offset = magics_list->data) == ((void*)0)) break;
      if ((magics_list = magics_list->next) == ((void*)0)) break;
      if ((type = magics_list->data) == ((void*)0)) break;
      if ((magics_list = magics_list->next) == ((void*)0)) break;
      if ((value = magics_list->data) == ((void*)0)) break;
