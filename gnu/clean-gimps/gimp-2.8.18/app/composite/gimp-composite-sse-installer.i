# 1 "gimp-composite-sse-installer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-composite-sse-installer.c" 2


# 1 "../../config.h" 1
# 4 "gimp-composite-sse-installer.c" 2
...
# 5 "gimp-composite-sse-installer.c" 2
...
# 6 "gimp-composite-sse-installer.c" 2
...
# 7 "gimp-composite-sse-installer.c" 2
...
# 8 "gimp-composite-sse-installer.c" 2
...
# 9 "gimp-composite-sse-installer.c" 2
...
# 10 "gimp-composite-sse-installer.c" 2

# 1 "./gimp-composite-sse.h" 1
...
# 12 "gimp-composite-sse-installer.c" 2
...
gimp_composite_sse_install (void)
{
  ...
  if (gimp_composite_sse_init ())
    {
      for (t = &_gimp_composite_sse[0]; t->function != ((void*)0); t++)
        {
