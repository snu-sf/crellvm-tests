# 1 "gimp-composite-sse2.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-composite-sse2.c" 2
# 21 "gimp-composite-sse2.c"
# 1 "../../config.h" 1
# 22 "gimp-composite-sse2.c" 2
  ...
  for (; n_pixels >= 4; n_pixels -= 4)
    {
      asm volatile ("  movdqu       %1,%%xmm2\n"
                    "\tmovdqu       %2,%%xmm3\n"
                    "\tmovdqu     %%""xmm2"", %%""xmm4""; " "\tpunpcklbw %%""xmm6"", %%""xmm4""\n"
                    "\tmovdqu     %%""xmm3"", %%""xmm5""; " "\tpunpcklbw %%""xmm6"", %%""xmm5""\n"
                    "\tpsubw     %%xmm5,%%xmm4\n"
                    "\tpaddw     %%xmm7,%%xmm4\n"
                    "\tmovdqu    %%xmm4,%%xmm1\n"

                    "\tmovdqu     %%""xmm2"", %%""xmm4""; " "\tpunpckhbw %%""xmm6"", %%""xmm4""\n"
                    "\tmovdqu     %%""xmm3"", %%""xmm5""; " "\tpunpckhbw %%""xmm6"", %%""xmm5""\n"
