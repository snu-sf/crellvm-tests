# 1 "gimp-composite-mmx-installer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-composite-mmx-installer.c" 2


# 1 "../../config.h" 1
# 4 "gimp-composite-mmx-installer.c" 2
...
# 5 "gimp-composite-mmx-installer.c" 2
...
# 6 "gimp-composite-mmx-installer.c" 2
...
# 7 "gimp-composite-mmx-installer.c" 2
...
# 8 "gimp-composite-mmx-installer.c" 2
...
# 9 "gimp-composite-mmx-installer.c" 2
...
# 10 "gimp-composite-mmx-installer.c" 2

# 1 "./gimp-composite-mmx.h" 1
...
# 12 "gimp-composite-mmx-installer.c" 2
...
gimp_composite_mmx_install (void)
{
  ...
  if (gimp_composite_mmx_init ())
    {
      for (t = &_gimp_composite_mmx[0]; t->function != ((void*)0); t++)
        {
