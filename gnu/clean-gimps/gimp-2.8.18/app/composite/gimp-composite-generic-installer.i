# 1 "gimp-composite-generic-installer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-composite-generic-installer.c" 2


# 1 "../../config.h" 1
# 4 "gimp-composite-generic-installer.c" 2
...
# 5 "gimp-composite-generic-installer.c" 2
...
# 6 "gimp-composite-generic-installer.c" 2
...
# 7 "gimp-composite-generic-installer.c" 2
...
# 8 "gimp-composite-generic-installer.c" 2
...
# 9 "gimp-composite-generic-installer.c" 2
...
# 11 "gimp-composite-generic-installer.c" 2
...
gimp_composite_generic_install (void)
{
  ...
  if (gimp_composite_generic_init ())
    {
      for (t = &_gimp_composite_generic[0]; t->function != ((void*)0); t++)
        {
