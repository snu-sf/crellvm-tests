# 1 "gimp-composite-mmx.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-composite-mmx.c" 2
# 28 "gimp-composite-mmx.c"
# 1 "../../config.h" 1
# 29 "gimp-composite-mmx.c" 2
...
# 36 "gimp-composite-mmx.c" 2



# 1 "./gimp-composite-x86.h" 1
# 234 "./gimp-composite-x86.h"
...
# 40 "gimp-composite-mmx.c" 2
# 60 "gimp-composite-mmx.c"
  ...
  for (; n_pixels >= 2; n_pixels -= 2)
    {
      asm volatile ("  movq       %1, %%mm2\n"
                    ...
                    "\tmovq    %%mm0, %%mm1\n"
                    "\tpandn   %%mm4, %%mm1\n"
                    "\t" "\tmovq %%" "mm2" ", %%" "mm4" ";" "psubusb %%" "mm3" ", %%" "mm4" ";" "psubb %%" "mm4" ", %%" "mm2" "\n" "\n"
                    "\tpand    %%mm0, %%mm2\n"
                    "\tpor     %%mm2, %%mm1\n"
                    "\tmovq    %%mm1, %0\n"
                    : "=m" (*d)
  ...
  for (; n_pixels >= 2; n_pixels -= 2)
    {
      asm volatile ("  movq    %1, %%mm2\n"
                    ...
                    "\t" "\tmovq %%" "mm2" ", %%" "mm5" ";" "psubusb %%" "mm3" ", %%" "mm5" ";" "psubb %%" "mm5" ", %%" "mm2" "\n" "\n"
                    "\tpand      %%mm0, %%mm2\n"
  ...
  for (; n_pixels >= 2; n_pixels -= 2)
    {
      asm volatile ("  movq       %1, %%mm2\n"
                    "\tmovq       %2, %%mm3\n"
                    "\tmovq    %%mm2, %%mm4\n"
                    "\t" "\tmovq %%" "mm3" ", %%" "mm5" ";" "psubusb %%" "mm4" ", %%" "mm5" ";" "paddb %%" "mm5" ", %%" "mm4" "\n" "\n"
                    "\tmovq    %%mm0, %%mm1\n"
                    "\tpandn   %%mm4, %%mm1\n"
                    "\t" "\tmovq %%" "mm3" ", %%" "mm4" ";" "psubusb %%" "mm2" ", %%" "mm4" ";" "psubb %%" "mm4" ", %%" "mm3" "\n" "\n"
                    "\tpand    %%mm0, %%mm3\n"
                    "\tpor     %%mm3, %%mm1\n"
                    "\tmovq    %%mm1, %0\n"
                    : "=m" (*d)
