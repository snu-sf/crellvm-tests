# 1 "gimp-composite-vis.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-composite-vis.c" 2
# 21 "gimp-composite-vis.c"
# 1 "../../config.h" 1
# 22 "gimp-composite-vis.c" 2
