# 1 "gimp-composite-sse.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-composite-sse.c" 2
# 28 "gimp-composite-sse.c"
# 1 "../../config.h" 1
# 29 "gimp-composite-sse.c" 2
