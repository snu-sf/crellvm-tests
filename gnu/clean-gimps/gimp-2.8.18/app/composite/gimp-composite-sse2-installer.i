# 1 "gimp-composite-sse2-installer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-composite-sse2-installer.c" 2


# 1 "../../config.h" 1
# 4 "gimp-composite-sse2-installer.c" 2
...
# 5 "gimp-composite-sse2-installer.c" 2
...
# 6 "gimp-composite-sse2-installer.c" 2
         ...
         ...)
{
  ...
  g_logv ("Gimp-Composite", G_LOG_LEVEL_ERROR, format, args);
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Composite", G_LOG_LEVEL_MESSAGE, format, args);
  __builtin_va_end(args);
}
static void
            ...
            ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Composite", G_LOG_LEVEL_CRITICAL, format, args);
  __builtin_va_end(args);
}
static void
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Composite", G_LOG_LEVEL_WARNING, format, args);
  __builtin_va_end(args);
}
static void
        ...
        ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Composite", G_LOG_LEVEL_INFO, format, args);
  __builtin_va_end(args);
}
static void
         ...
         ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Composite", G_LOG_LEVEL_DEBUG, format, args);
  __builtin_va_end(args);
}
...
# 7 "gimp-composite-sse2-installer.c" 2
...
# 8 "gimp-composite-sse2-installer.c" 2
...
# 9 "gimp-composite-sse2-installer.c" 2
# 1 "./gimp-composite.h" 1
# 24 "./gimp-composite.h"
typedef enum
{
  GIMP_PIXELFORMAT_V8,
...
# 10 "gimp-composite-sse2-installer.c" 2

# 1 "./gimp-composite-sse2.h" 1
...
# 12 "gimp-composite-sse2-installer.c" 2
...
gimp_composite_sse2_install (void)
{
  ...
  if (gimp_composite_sse2_init ())
    {
      for (t = &_gimp_composite_sse2[0]; t->function != ((void*)0); t++)
        {
