# 1 "gimp-composite-generic.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-composite-generic.c" 2
# 24 "gimp-composite-generic.c"
# 1 "../../config.h" 1
# 25 "gimp-composite-generic.c" 2
...
# 37 "gimp-composite-generic.c" 2
# 1 "./gimp-composite-generic.h" 1
...
# 38 "gimp-composite-generic.c" 2
# 57 "gimp-composite-generic.c"
static guchar add_lut[511];
static gint32 random_table[4096];
static guchar burn_lut[256][256];
# 74 "gimp-composite-generic.c"
void
...
gimp_composite_darken_any_any_any_generic (GimpCompositeContext * ctx)
{
  ...
  const guint alpha = (has_alpha1 || has_alpha2) ? (((bytes1) > (bytes2)) ? (bytes1) : (bytes2)) - 1 : bytes1;
  guint b;
  guchar s1, s2;
  ...
  while (length--)
    {
      ...
      if (has_alpha1 && has_alpha2)
        dest[alpha] = (((src1[alpha]) < (src2[alpha])) ? (src1[alpha]) : (src2[alpha]));
      else if (has_alpha2)
...
gimp_composite_multiply_any_any_any_generic (GimpCompositeContext * ctx)
{
  ...
  if (has_alpha1 && has_alpha2) {
    while (length--)
      {
        for (b = 0; b < alpha; b++)
          dest[b] = ((tmp) = (src1[b]) * (src2[b]) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
...
gimp_composite_screen_any_any_any_generic (GimpCompositeContext * ctx)
{
  ...
  while (length--)
    {
      for (b = 0; b < alpha; b++)
        dest[b] = 255 - ((tmp) = ((255 - src1[b])) * ((255 - src2[b])) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
  ...
  while (length--)
    {
      for (b = 0; b < alpha; b++)
        {
          dest[b] = ((tmp) = (src1[b]) * (src1[b] + ((tmpM) = (2 * src2[b]) * (255 - src1[b]) + 0x80, ((((tmpM) >> 8) + (tmpM)) >> 8))) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
        }
          ...
          if (src2[b] > 128)
            {
              ...
              dest[b] = (guchar) (((255 - (tmp >> 8)) < (255)) ? (255 - (tmp >> 8)) : (255));
            }
          else
            {
              tmp = (gint) src1[b] * ((gint) src2[b] << 1);
              dest[b] = (guchar) (((tmp >> 8) < (255)) ? (tmp >> 8) : (255));
            }
        }
      ...
      for (b = 0; b < alpha; b++)
        {
          ...
          tmpM = ((tmpM) = (src1[b]) * (src2[b]) + 0x80, ((((tmpM) >> 8) + (tmpM)) >> 8));
          tmpS = 255 - ((tmp1) = ((255 - src1[b])) * ((255 - src2[b])) + 0x80, ((((tmp1) >> 8) + (tmp1)) >> 8));
          dest[b] = ((tmp2) = ((255 - src1[b])) * (tmpM) + 0x80, ((((tmp2) >> 8) + (tmp2)) >> 8)) + ((tmp3) = (src1[b]) * (tmpS) + 0x80, ((((tmp3) >> 8) + (tmp3)) >> 8));
        }
      ...
      for (b = 0; b < alpha; b++)
        {
          ...
          dest[b] = (guchar) (((diff) > (255)) ? (255) : (((diff) < (0)) ? (0) : (diff)));
        }
      ...
      for (b = 0; b < alpha; b++)
        {
          ...
          dest[b] = (guchar) (((sum) > (255)) ? (255) : (((sum) < (0)) ? (0) : (sum)));
        }
    ...
    while (length--)
      {
        for (b = 0; b < alpha; b++)
          D[b] = add_lut[A[b] + B[b]];
        D[alpha] = (((A[alpha]) < (B[alpha])) ? (A[alpha]) : (B[alpha]));
        A += bytes1;
        B += bytes2;
        D += bytes2;
      }
...
gimp_composite_dissolve_any_any_any_generic (GimpCompositeContext * ctx)
{
  ...
  gr = g_rand_new_with_seed(random_table[y % 4096]);
  ...
  while (length--)
    {
      ...
      dest[alpha] =
        (rand_val >= combined_opacity) ? 0 : 255;
...
gimp_composite_scale_any_any_any_generic (GimpCompositeContext * ctx)
{
  ...
  while (length--)
    {
      *dest++ = (guchar) ((tmp) = (*src1) * (ctx->scale.scale) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
      src1++;
    }
}
# 1424 "gimp-composite-generic.c"
gboolean
    ...
    for (b = 0; b < 256; b++)
      {
        ...
        burn_lut[a][b] = (((tmp) > (255)) ? (255) : (((tmp) < (0)) ? (0) : (tmp)));
      }
