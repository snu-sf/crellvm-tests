                  ...
                  gint height)
{
  ...
  do{ if (width > 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "width > 0"); return (((void*)0)); }; }while (0);
  do{ if (height > 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "height > 0"); return (((void*)0)); }; }while (0);

  pyramid = ((TilePyramid*) g_slice_alloc0 (sizeof (TilePyramid)));
  ...
  switch (type)
    ...
    case GIMP_INDEXEDA_IMAGE:
      do { g_assertion_message_expr ("Gimp-Base", "tile-pyramid.c", 116, ((const char*) (__func__)), ((void*)0)); } while (0);
      break;
    }
...
tile_pyramid_destroy (TilePyramid *pyramid)
{
  ...
  do{ if (pyramid != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "pyramid != NULL"); return; }; }while (0);

  for (level = 0; level <= pyramid->top_level; level++)
    tile_manager_unref (pyramid->tiles[level]);

  do { if (1) g_slice_free1 (sizeof (TilePyramid), (pyramid)); else (void) ((TilePyramid*) 0 == (pyramid)); } while (0);
}
# 156 "tile-pyramid.c"
gint
...
tile_pyramid_get_tiles (TilePyramid *pyramid,
                        ...
                        gboolean *is_premult)
{
  do{ if (pyramid != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "pyramid != NULL"); return (((void*)0)); }; }while (0);

  level = tile_pyramid_alloc_levels (pyramid, level);

  do{ if (pyramid->tiles[level] != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "pyramid->tiles[level] != NULL"); return (((void*)0)); }; }while (0);
                              ...
                              gint height)
{
  ...
  do{ if (pyramid != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "pyramid != NULL"); return; }; }while (0);
  do{ if (x >= 0 && y >= 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "x >= 0 && y >= 0"); return; }; }while (0);
  do{ if (width >= 0 && height >= 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "width >= 0 && height >= 0"); return; }; }while (0);
  ...
  for (level = 0; level <= pyramid->top_level; level++)
    {
      ...
      tile_manager_invalidate_area (pyramid->tiles[level],
                                    x, y, (((width) > (1)) ? (width) : (1)), (((height) > (1)) ? (height) : (1)));
...
{
  do{ if (pyramid != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "pyramid != NULL"); return (0); }; }while (0);
...
tile_pyramid_get_memsize (const TilePyramid *pyramid)
{
  ...
  for (level = 0; level <= pyramid->top_level; level++)
    memsize += tile_manager_get_memsize (pyramid->tiles[level], (!(0)));
                           ...
                           gint top_level)
{
  ...
  top_level = (((top_level) < (10 - 1)) ? (top_level) : (10 - 1));
