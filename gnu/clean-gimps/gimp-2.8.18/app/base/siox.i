         ...
         ...)
{
  ...
  g_logv ("Gimp-Base", G_LOG_LEVEL_ERROR, format, args);
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Base", G_LOG_LEVEL_MESSAGE, format, args);
  __builtin_va_end(args);
}
static void
            ...
            ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Base", G_LOG_LEVEL_CRITICAL, format, args);
  __builtin_va_end(args);
}
static void
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Base", G_LOG_LEVEL_WARNING, format, args);
  __builtin_va_end(args);
}
static void
        ...
        ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Base", G_LOG_LEVEL_INFO, format, args);
  __builtin_va_end(args);
}
static void
         ...
         ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Base", G_LOG_LEVEL_DEBUG, format, args);
  __builtin_va_end(args);
}
...
{
  do { if (1) g_slice_free1 (sizeof (classresult), (entry)); else (void) ((classresult*) 0 == (entry)); } while (0);
}
          ...
          lab *pixel)
{
  ...
  switch (bpp)
      ...
      if (colormap)
        {
          ...
          cpercep_rgb_to_space (colormap[i + 0],
                                colormap[i + 1],
                                colormap[i + 2], &l, &a, &b);
        }
      else
    ...
    default:
      do{ g_log ("Gimp-Base", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "siox.c", 167, ((const char*) (__func__))); return; }while (0);
    }
          ...
          const gint dims)
{
  ...
  min = (((const gfloat *) (points + left))[curdim]);
  max = min;

  for (i = left+1; i < right; i++)
    {
      curval = (((const gfloat *) (points + i))[curdim]);
      ...
      if (pivot != max)
        {
          ...
          while ((!(0)))
            {
              while ((((const gfloat *) (points + l))[curdim]) <= pivot)
                ++l;

              while ((((const gfloat *) (points + r))[curdim]) > pivot)
                --r;
             ...
             gint height)
{
  ...
  pixel_region_init (&region, mask, x, y, width, height, (!(0)));
                ...
                gint height)
{
  ...
  for (pr = pixel_regions_register (1, &region);
       pr != ((void*)0); pr = pixel_regions_process (pr))
    {
      ...
      if (oldx == xx)
        {
          ...
          xx = ((gint) (glong) (stack->data));
          stack = g_slist_delete_link (stack, stack);

          yy = ((gint) (glong) (stack->data));
          stack = g_slist_delete_link (stack, stack);
        }
          ...
          for (col = 0; col < region.w; col++, d++)
            {
              ...
              if (val && (val != 0x7))
                {
                  struct blob *b = ((struct blob*) g_slice_alloc (sizeof (struct blob)));
  ...
  for (iter = list; iter; iter = iter->next)
    {
      ...
      do { if (1) g_slice_free1 (sizeof (struct blob), (b)); else (void) ((struct blob*) 0 == (b)); } while (0);
    }
           ...
           gint height)
{
  ...
  do{ if (pixels != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "pixels != NULL"); return (((void*)0)); }; }while (0);
  do{ if (x >= 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "x >= 0"); return (((void*)0)); }; }while (0);
  do{ if (y >= 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "y >= 0"); return (((void*)0)); }; }while (0);

  state = ((SioxState*) g_slice_alloc (sizeof (SioxState)));
                         ...
                         gpointer progress_data)
{
  ...
  do{ if (state != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "state != NULL"); return; }; }while (0);
  do{ if (mask != ((void*)0) && tile_manager_bpp (mask) == 1) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "mask != NULL && tile_manager_bpp (mask) == 1"); return; }; }while (0);
  do{ if (x1 >= 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "x1 >= 0"); return; }; }while (0);
  do{ if (x2 > x1 && x2 <= tile_manager_width (mask)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "x2 > x1 && x2 <= tile_manager_width (mask)"); return; }; }while (0);
  do{ if (y1 >= 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "y1 >= 0"); return; }; }while (0);
  do{ if (y2 > y1 && y2 <= tile_manager_height (mask)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "y2 > y1 && y2 <= tile_manager_height (mask)"); return; }; }while (0);
  do{ if (smoothness >= 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "smoothness >= 0"); return; }; }while (0);
  do{ if (progress_data == ((void*)0) || progress_callback != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "progress_data == NULL || progress_callback != NULL"); return; }; }while (0);
  ...
  do{ if (x + width <= tile_manager_width (mask)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "x + width <= tile_manager_width (mask)"); return; }; }while (0);
  do{ if (y + height <= tile_manager_height (mask)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "y + height <= tile_manager_height (mask)"); return; }; }while (0);
  ...
  if (refinement & SIOX_REFINEMENT_ADD_FOREGROUND)
    g_hash_table_foreach_remove (state->cache, siox_cache_remove_bg, ((void*)0));

  if (refinement & SIOX_REFINEMENT_ADD_BACKGROUND)
    g_hash_table_foreach_remove (state->cache, siox_cache_remove_fg, ((void*)0));
  ...
  if (refinement & (SIOX_REFINEMENT_ADD_FOREGROUND |
                    SIOX_REFINEMENT_ADD_BACKGROUND))
    {
      ...
      pixel_region_init (&mapPR, mask, x, y, width, height, (0));
      total = width * height;
      ...
      if (refinement & SIOX_REFINEMENT_ADD_FOREGROUND)
        surefg = ((lab *) g_malloc_n ((surefgcount), sizeof (lab)));

      if (refinement & SIOX_REFINEMENT_ADD_BACKGROUND)
        surebg = ((lab *) g_malloc_n ((surebgcount), sizeof (lab)));
          ...
          for (col = 0; col < srcPR.w; col++, m++, s += state->bpp)
            {
              ...
              cr = g_hash_table_lookup (state->cache, ((gpointer) (glong) (key)));
              ...
              cr = ((classresult*) g_slice_alloc0 (sizeof (classresult)));
              ...
              g_hash_table_insert (state->cache, ((gpointer) (glong) (key)), cr);
          ...
          gfloat threshold)
{
  ...
  pixel_region_init (&mapPR, mask, x - brush_radius, y - brush_radius,
                     brush_radius * 2, brush_radius * 2, (!(0)));
...
siox_done (SioxState *state)
{
  ...
  do { if (1) g_slice_free1 (sizeof (SioxState), (state)); else (void) ((SioxState*) 0 == (state)); } while (0);
