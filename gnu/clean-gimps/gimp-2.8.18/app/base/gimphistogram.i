...
# 32 "gimphistogram.c" 2
# 1 "./pixel-processor.h" 1
# 27 "./pixel-processor.h"
...
{
  GimpHistogram *histogram = ((GimpHistogram*) g_slice_alloc0 (sizeof (GimpHistogram)));
...
{
  do{ if (histogram != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "histogram != NULL"); return (((void*)0)); }; }while (0);
...
{
  do{ if (histogram != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "histogram != NULL"); return; }; }while (0);
  ...
  if (histogram->ref_count == 0)
    {
      ...
      do { if (1) g_slice_free1 (sizeof (GimpHistogram), (histogram)); else (void) ((GimpHistogram*) 0 == (histogram)); } while (0);
    }
}
# 114 "gimphistogram.c"
GimpHistogram *
gimp_histogram_duplicate (GimpHistogram *histogram)
{
  ...
  g_mutex_lock (g_static_mutex_get_mutex_impl (&histogram->mutex));
  ...
  g_mutex_unlock (g_static_mutex_get_mutex_impl (&histogram->mutex));
                            ...
                            GimpHistogramChannel channel)
{
  ...
  do{ if (histogram != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "histogram != NULL"); return (0.0); }; }while (0);
  ...
  if (channel == GIMP_HISTOGRAM_RGB)
    for (x = 0; x < 256; x++)
      {
        max = (((max) > ((histogram->values[0][(GIMP_HISTOGRAM_RED) * 256 + (x)]))) ? (max) : ((histogram->values[0][(GIMP_HISTOGRAM_RED) * 256 + (x)])));
        max = (((max) > ((histogram->values[0][(GIMP_HISTOGRAM_GREEN) * 256 + (x)]))) ? (max) : ((histogram->values[0][(GIMP_HISTOGRAM_GREEN) * 256 + (x)])));
        max = (((max) > ((histogram->values[0][(GIMP_HISTOGRAM_BLUE) * 256 + (x)]))) ? (max) : ((histogram->values[0][(GIMP_HISTOGRAM_BLUE) * 256 + (x)])));
      }
  else
    for (x = 0; x < 256; x++)
      {
        max = (((max) > ((histogram->values[0][(channel) * 256 + (x)]))) ? (max) : ((histogram->values[0][(channel) * 256 + (x)])));
      }
                          ...
                          gint bin)
{
  ...
  if (channel == GIMP_HISTOGRAM_RGB)
    {
      gdouble min = (histogram->values[0][(GIMP_HISTOGRAM_RED) * 256 + (bin)]);

      min = (((min) < ((histogram->values[0][(GIMP_HISTOGRAM_GREEN) * 256 + (bin)]))) ? (min) : ((histogram->values[0][(GIMP_HISTOGRAM_GREEN) * 256 + (bin)])));

      return (((min) < ((histogram->values[0][(GIMP_HISTOGRAM_BLUE) * 256 + (bin)]))) ? (min) : ((histogram->values[0][(GIMP_HISTOGRAM_BLUE) * 256 + (bin)])));
    }
  else
    {
      return (histogram->values[0][(channel) * 256 + (bin)]);
    }
}
...
{
  do{ if (histogram != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "histogram != NULL"); return (0); }; }while (0);
                          ...
                          gint end)
{
  ...
  start = (((start) > (255)) ? (255) : (((start) < (0)) ? (0) : (start)));
  end = (((end) > (255)) ? (255) : (((end) < (0)) ? (0) : (end)));

  for (i = start; i <= end; i++)
    count += (histogram->values[0][(channel) * 256 + (i)]);
                         ...
                         gint end)
{
  ...
  if (channel == GIMP_HISTOGRAM_RGB)
    {
      for (i = start; i <= end; i++)
        mean += (i * (histogram->values[0][(GIMP_HISTOGRAM_RED) * 256 + (i)]) +
                 i * (histogram->values[0][(GIMP_HISTOGRAM_GREEN) * 256 + (i)]) +
                 i * (histogram->values[0][(GIMP_HISTOGRAM_BLUE) * 256 + (i)]));
    }
  else
    {
      for (i = start; i <= end; i++)
        mean += i * (histogram->values[0][(channel) * 256 + (i)]);
    }
                           ...
                           gint end)
{
  ...
  do{ if (histogram != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "histogram != NULL"); return (-1); }; }while (0);
  ...
  if (channel == GIMP_HISTOGRAM_RGB)
    for (i = start; i <= end; i++)
      {
        sum += ((histogram->values[0][(GIMP_HISTOGRAM_RED) * 256 + (i)]) +
                (histogram->values[0][(GIMP_HISTOGRAM_GREEN) * 256 + (i)]) +
                (histogram->values[0][(GIMP_HISTOGRAM_BLUE) * 256 + (i)]));
    ...
    for (i = start; i <= end; i++)
      {
        sum += (histogram->values[0][(channel) * 256 + (i)]);
                              ...
                              gint end)
{
  ...
  hist = ((gdouble*) __builtin_alloca (sizeof (gdouble) * (gsize) (maxval + 1)));
  chist = ((gdouble*) __builtin_alloca (sizeof (gdouble) * (gsize) (maxval + 1)));
  cmom = ((gdouble*) __builtin_alloca (sizeof (gdouble) * (gsize) (maxval + 1)));

  if (channel == GIMP_HISTOGRAM_RGB)
    {
      for (i = start; i <= end; i++)
        hist[i - start] = ((histogram->values[0][(GIMP_HISTOGRAM_RED) * 256 + (i)]) +
                           (histogram->values[0][(GIMP_HISTOGRAM_GREEN) * 256 + (i)]) +
                           (histogram->values[0][(GIMP_HISTOGRAM_BLUE) * 256 + (i)]));
    }
  else
    {
      for (i = start; i <= end; i++)
        hist[i - start] = (histogram->values[0][(channel) * 256 + (i)]);
    }
  ...
  for (i = start; i <= end; i++)
    {
      ...
      if (channel == GIMP_HISTOGRAM_RGB)
        {
          value = ((histogram->values[0][(GIMP_HISTOGRAM_RED) * 256 + (i)]) +
                   (histogram->values[0][(GIMP_HISTOGRAM_GREEN) * 256 + (i)]) +
                   (histogram->values[0][(GIMP_HISTOGRAM_BLUE) * 256 + (i)]));
        }
      else
  ...
  if (bytes + 1 != histogram->n_channels)
    {
      ...
      histogram->values[0] = ((gdouble *) g_malloc_n ((histogram->n_channels * 256), sizeof (gdouble)));
    }
}
                                     ...
                                     PixelRegion *mask)
{
  ...
  if (! values)
    {
      histogram->values[slot] = ((gdouble *) g_malloc0_n ((histogram->n_channels * 256), sizeof (gdouble)));
      values = histogram->values[slot];
    }
              ...
              while (w--)
                {
                  ...
                  (values[(0) * 256 + (s[0])]) += weight * masked;
                  (values[(1) * 256 + (s[1])]) += masked;
              ...
              while (w--)
                {
                  ...
                  (values[(1) * 256 + (s[0])]) += masked;
                  (values[(2) * 256 + (s[1])]) += masked;
                  (values[(3) * 256 + (s[2])]) += masked;

                  max = (s[0] > s[1]) ? s[0] : s[1];

                  if (s[2] > max)
                    (values[(0) * 256 + (s[2])]) += masked;
                  else
                    (values[(0) * 256 + (max)]) += masked;
              ...
              while (w--)
                {
                  ...
                  (values[(1) * 256 + (s[0])]) += weight * masked;
                  (values[(2) * 256 + (s[1])]) += weight * masked;
                  (values[(3) * 256 + (s[2])]) += weight * masked;
                  (values[(4) * 256 + (s[3])]) += masked;

                  max = (s[0] > s[1]) ? s[0] : s[1];

                  if (s[2] > max)
                   (values[(0) * 256 + (s[2])]) += weight * masked;
                  else
                    (values[(0) * 256 + (max)]) += weight * masked;
              ...
              while (w--)
                {
                  ...
                  (values[(0) * 256 + (s[0])]) += weight;
                  (values[(1) * 256 + (s[1])]) += 1.0;
          ...
          while (h--)
            {
              ...
              while (w--)
                {
                  (values[(1) * 256 + (s[0])]) += 1.0;
                  (values[(2) * 256 + (s[1])]) += 1.0;
                  (values[(3) * 256 + (s[2])]) += 1.0;

                  max = (s[0] > s[1]) ? s[0] : s[1];

                  if (s[2] > max)
                    (values[(0) * 256 + (s[2])]) += 1.0;
                  else
                    (values[(0) * 256 + (max)]) += 1.0;
              ...
              while (w--)
                {
                  ...
                  (values[(1) * 256 + (s[0])]) += weight;
                  (values[(2) * 256 + (s[1])]) += weight;
                  (values[(3) * 256 + (s[2])]) += weight;
                  (values[(4) * 256 + (s[3])]) += 1.0;

                  max = (s[0] > s[1]) ? s[0] : s[1];

                  if (s[2] > max)
                    (values[(0) * 256 + (s[2])]) += weight;
                  else
                    (values[(0) * 256 + (max)]) += weight;
