...
{
  if (! tile->rowhint)
    tile->rowhint = g_slice_alloc0 (sizeof (TileRowHint) * 64);
}
...
# 224 "tile-rowhints.c"
    ...
    default:
      do{ g_log ("Gimp-Base", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "tile-rowhints.c", 260, ((const char*) (__func__))); return; }while (0);
      break;
    }
}
