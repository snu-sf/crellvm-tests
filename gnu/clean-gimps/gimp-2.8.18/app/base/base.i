...
static GimpBaseConfig *base_config = ((void*)0);
           ...
           gboolean use_cpu_accel)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((config)); GType __t = ((gimp_base_config_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "GIMP_IS_BASE_CONFIG (config)"); return ((0)); }; }while (0);
  do{ if (base_config == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "base_config == NULL"); return ((0)); }; }while (0);

  base_config = g_object_ref (config);

  tile_cache_init (config->tile_cache_size);
  g_signal_connect_data ((config), ("notify::tile-cache-size"), (((GCallback) (base_tile_cache_size_notify))), (((void*)0)), ((void*)0), (GConnectFlags) 0);



  if (! config->swap_path || ! *config->swap_path)
    gimp_config_reset_property (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))), "swap-path");
  ...
  if (! config->temp_path || ! *config->temp_path)
    gimp_config_reset_property (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))), "temp-path");

  temp_dir = gimp_config_path_expand (config->temp_path, (!(0)), ((void*)0));
  ...
  g_signal_connect_data ((config), ("notify::num-processors"), (((GCallback) (base_num_processors_notify))), (((void*)0)), ((void*)0), (GConnectFlags) 0);
...
base_exit (void)
{
  do{ if (base_config != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "base_config != NULL"); return; }; }while (0);
  ...
  g_signal_handlers_disconnect_matched ((base_config), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (base_tile_cache_size_notify), (((void*)0)));
...
base_toast_old_swap_files (const gchar *swap_path)
{
  ...
  dirname = gimp_config_path_expand (swap_path, (!(0)), ((void*)0));
  if (!dirname)
    return;
...
# 173 "base.c"
        ...
        if (kill (pid, 0))
          ...
          {
            gchar *filename = g_build_filename (dirname, entry, ((void*)0));
...
base_tile_cache_size_notify (GObject *config,
                             ...
                             gpointer data)
{
  tile_cache_set_size (((((GimpBaseConfig*) g_type_check_instance_cast ((GTypeInstance*) ((config)), ((gimp_base_config_get_type ()))))))->tile_cache_size);
}
...
base_num_processors_notify (GObject *config,
                            ...
                            gpointer data)
{
  pixel_processor_set_num_threads (((((GimpBaseConfig*) g_type_check_instance_cast ((GTypeInstance*) ((config)), ((gimp_base_config_get_type ()))))))->num_processors);
}
