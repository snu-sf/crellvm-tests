...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "hue-saturation.c" 2
# 18 "hue-saturation.c"
# 1 "../../config.h" 1
# 19 "hue-saturation.c" 2
...
# 27 "hue-saturation.c" 2

# 1 "./hue-saturation.h" 1
# 22 "./hue-saturation.h"
...
hue_saturation_init (HueSaturation *hs)
{
  ...
  do{ if (hs != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "hs != NULL"); return; }; }while (0);
    ...
    for (i = 0; i < 256; i++)
      {
        ...
        value = (((value) > (255)) ? (255) : (((value) < (-255)) ? (-255) : (value)));
# 92 "hue-saturation.c"
        hs->saturation_transfer[hue][i] = ((((i * (255 + value)) / 255) > (255)) ? (255) : ((((i * (255 + value)) / 255) < (0)) ? (0) : ((i * (255 + value)) / 255)));
      }
}
