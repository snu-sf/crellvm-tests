...
static gboolean transfer_initialized = (0);
...
color_balance_init (ColorBalance *cb)
{
  ...
  do{ if (cb != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "cb != NULL"); return; }; }while (0);
  ...
  for (i = 0; i < 256; i++)
    {
      ...
      gdouble low = ((((i - b) / -a + .5) > (1)) ? (1) : ((((i - b) / -a + .5) < (0)) ? (0) : ((i - b) / -a + .5))) * scale;
      gdouble mid = ((((i - b) / a + .5) > (1)) ? (1) : ((((i - b) / a + .5) < (0)) ? (0) : ((i - b) / a + .5))) *
                    ((((i + b - 255) / -a + .5) > (1)) ? (1) : ((((i + b - 255) / -a + .5) < (0)) ? (0) : ((i + b - 255) / -a + .5))) * scale;
