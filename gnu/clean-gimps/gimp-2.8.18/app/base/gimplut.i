...
gimp_lut_new (void)
{
  ...
  lut = ((GimpLut*) g_slice_alloc (sizeof (GimpLut)));
...
gimp_lut_free (GimpLut *lut)
{
  ...
  g_free (lut->luts);
  do { if (1) g_slice_free1 (sizeof (GimpLut), (lut)); else (void) ((GimpLut*) 0 == (lut)); } while (0);
}
                ...
                gint nchannels)
{
  ...
  lut->luts = ((guchar * *) g_malloc_n ((lut->nchannels), sizeof (guchar *)));

  for (i = 0; i < lut->nchannels; i++)
    {
      lut->luts[i] = ((guchar *) g_malloc_n ((256), sizeof (guchar)));
      ...
      for (v = 0; v < 256; v++)
        {
          ...
          lut->luts[i][v] = (((val) > (255)) ? (255) : (((val) < (0)) ? (0) : (val)));
        }
    }
}
                  ...
                  PixelRegion *destPR)
{
  const guchar *src;
  guchar *dest;
  guchar *lut0 = ((void*)0), *lut1 = ((void*)0), *lut2 = ((void*)0), *lut3 = ((void*)0);
