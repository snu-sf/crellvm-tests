              ...
              const guchar *color)
{
  ...
  do{ if (width > 0 && height > 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "width > 0 && height > 0"); return (((void*)0)); }; }while (0);
  do{ if (bytes > 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "bytes > 0"); return (((void*)0)); }; }while (0);

  temp = ((TempBuf*) g_slice_alloc (sizeof (TempBuf)));
  ...
  temp->data = ((guchar *) g_malloc_n ((width * height * bytes), sizeof (guchar)));
...
temp_buf_copy (TempBuf *src,
               TempBuf *dest)
{
  do{ if (src != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src != NULL"); return (((void*)0)); }; }while (0);
  do{ if (! dest || (dest->width == src->width && dest->height == src->height)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "! dest || (dest->width == src->width && dest->height == src->height)"); return (((void*)0)); }; }while (0);


  if (! dest)
    dest = temp_buf_new (src->width, src->height, src->bytes, 0, 0, ((void*)0));
  ...
  if (src->bytes != dest->bytes)
    {
      if (src->bytes == 4 && dest->bytes == 2)
        temp_buf_to_gray (src, dest);
      else if (src->bytes == 3 && dest->bytes == 1)
        temp_buf_to_gray (src, dest);
      else if (src->bytes == 2 && dest->bytes == 4)
        temp_buf_to_color (src, dest);
      else if (src->bytes == 1 && dest->bytes == 3)
        temp_buf_to_color (src, dest);
      else
                 ...
                 gint height)
{
  ...
  if (! buf)
    {
      buf = temp_buf_new (width, height, bytes, x, y, ((void*)0));
    }
  else
    {
      ...
      if (size != (buf->width * buf->height * buf->bytes))
        {
          buf->data = ((guchar *) g_realloc_n (buf->data, (size), sizeof (guchar)));
        }
                ...
                gint new_height)
{
  ...
  do{ if (src != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src != NULL"); return (((void*)0)); }; }while (0);
  do{ if (new_width > 0 && new_height > 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "new_width > 0 && new_height > 0"); return (((void*)0)); }; }while (0);
                    ...
                    gint dest_y)
{
  ...
  do{ if (src != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src != NULL"); return (dest); }; }while (0);
  do{ if (!dest || dest->bytes == src->bytes) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "!dest || dest->bytes == src->bytes"); return (dest); }; }while (0);

  do{ if (width + dest_x > 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "width + dest_x > 0"); return (dest); }; }while (0);
  do{ if (height + dest_y > 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "height + dest_y > 0"); return (dest); }; }while (0);

  do{ if (!dest || dest->width >= width + dest_x) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "!dest || dest->width >= width + dest_x"); return (dest); }; }while (0);
  do{ if (!dest || dest->height >= height + dest_y) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "!dest || dest->height >= height + dest_y"); return (dest); }; }while (0);


  x1 = (((x) > (src->width - 1)) ? (src->width - 1) : (((x) < (0)) ? (0) : (x)));
  y1 = (((y) > (src->height - 1)) ? (src->height - 1) : (((y) < (0)) ? (0) : (y)));
  x2 = (((x + width - 1) > (src->width - 1)) ? (src->width - 1) : (((x + width - 1) < (0)) ? (0) : (x + width - 1)));
  y2 = (((y + height - 1) > (src->height - 1)) ? (src->height - 1) : (((y + height - 1) < (0)) ? (0) : (y + height - 1)));
...
temp_buf_demultiply (TempBuf *buf)
{
  ...
  do{ if (buf != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "buf != NULL"); return; }; }while (0);
  ...
  switch (buf->bytes)
    ...
    default:
      do{ g_log ("Gimp-Base", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "temp-buf.c", 339, ((const char*) (__func__))); return; }while (0);
      break;
    }
}
...
temp_buf_free (TempBuf *buf)
{
  ...
  do { if (1) g_slice_free1 (sizeof (TempBuf), (buf)); else (void) ((TempBuf*) 0 == (buf)); } while (0);
}
...
temp_buf_dump (TempBuf *buf,
               const gchar *filename)
{
  gint fd = open (filename, 0100 | 01000 | 01, 0666);

  do{ if (fd != -1) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "fd != -1"); return; }; }while (0);
  do{ if (buf != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "buf != NULL"); return; }; }while (0);
  do{ if (temp_buf_get_data (buf) != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "temp_buf_get_data (buf) != NULL"); return; }; }while (0);
                   ...
                   TempBuf *dest_buf)
{
  ...
  switch (dest_buf->bytes)
    {
    case 3:
      do{ if (src_buf->bytes == 1) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_buf->bytes == 1"); return; }; }while (0);
      while (num_pixels--)
        {
          guchar tmp;
    ...
    case 4:
      do{ if (src_buf->bytes == 2) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_buf->bytes == 2"); return; }; }while (0);
      while (num_pixels--)
        {
          guchar tmp;
    ...
    default:
      do{ g_log ("Gimp-Base", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "temp-buf.c", 453, ((const char*) (__func__))); return; }while (0);
      break;
    }
}
                  ...
                  TempBuf *dest_buf)
{
  ...
  switch (dest_buf->bytes)
    {
    case 1:
      do{ if (src_buf->bytes == 3) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_buf->bytes == 3"); return; }; }while (0);
      while (num_pixels--)
        {
          gint lum = ((src[0]) * (0.2126) + (src[1]) * (0.7152) + (src[2]) * (0.0722)) + 0.5;
    ...
    case 2:
      do{ if (src_buf->bytes == 4) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_buf->bytes == 4"); return; }; }while (0);
      while (num_pixels--)
        {
          gint lum = ((src[0]) * (0.2126) + (src[1]) * (0.7152) + (src[2]) * (0.0722)) + 0.5;
    ...
    default:
      do{ g_log ("Gimp-Base", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "temp-buf.c", 499, ((const char*) (__func__))); return; }while (0);
      break;
    }
}
