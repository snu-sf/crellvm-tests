# 1 "tile-manager-preview.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "tile-manager-preview.c" 2
# 18 "tile-manager-preview.c"
# 1 "../../config.h" 1
# 19 "tile-manager-preview.c" 2
...
# 23 "tile-manager-preview.c" 2

# 1 "../../app/paint-funcs/subsample-region.h" 1
# 22 "../../app/paint-funcs/subsample-region.h"
...
void tile_manager_write_pixel_data_1 (TileManager *tm,
                                                 ...
                                                 gint y,
                                                 const guchar *buffer);
# 29 "tile-manager-preview.c" 2
# 1 "./tile-manager-preview.h" 1
# 22 "./tile-manager-preview.h"
...
tile_manager_get_preview (TileManager *tiles,
                          ...
                          gint height)
{
  do{ if (tiles != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tiles != NULL"); return (((void*)0)); }; }while (0);
                              ...
                              gint dest_height)
{
  ...
  do{ if (src_x >= 0 && src_x < tile_manager_width (tiles)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_x >= 0 && src_x < tile_manager_width (tiles)"); return (((void*)0)); }; }while (0);

  do{ if (src_y >= 0 && src_y < tile_manager_height (tiles)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_y >= 0 && src_y < tile_manager_height (tiles)"); return (((void*)0)); }; }while (0);


  do{ if (src_width > 0 && src_x + src_width <= tile_manager_width (tiles)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_width > 0 && src_x + src_width <= tile_manager_width (tiles)"); return (((void*)0)); }; }while (0);

  do{ if (src_height > 0 && src_y + src_height <= tile_manager_height (tiles)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "src_height > 0 && src_y + src_height <= tile_manager_height (tiles)"); return (((void*)0)); }; }while (0);



  do{ if (dest_width > 0 && dest_height > 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "dest_width > 0 && dest_height > 0"); return (((void*)0)); }; }while (0);
                             ...
                             gint dest_height)
{
  ...
  preview = temp_buf_new (dest_width, dest_height,
                          tile_manager_bpp (tiles), 0, 0, ((void*)0));

  pixel_region_init (&srcPR, tiles, src_x, src_y, src_width, src_height, (0));
