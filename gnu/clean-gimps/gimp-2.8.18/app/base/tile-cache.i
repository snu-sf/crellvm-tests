...
static TileList tile_list = { ((void*)0), ((void*)0) };
static guint idle_swapper = 0;
static guint idle_delay = 0;
static Tile *idle_scan_last = ((void*)0);
# 62 "tile-cache.c"
static GMutex *tile_cache_mutex = ((void*)0);
# 77 "tile-cache.c"
...
tile_cache_init (guint64 tile_cache_size)
{
  ...
  do{ if (tile_cache_mutex == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tile_cache_mutex == NULL"); return; }; }while (0);

  tile_cache_mutex = g_mutex_new ();


  tile_list.first = tile_list.last = ((void*)0);
  idle_scan_last = ((void*)0);
...
tile_cache_exit (void)
{
  ...
  if (cur_cache_size > 0)
    g_warning ("tile cache not empty (%""lu"" bytes left)",
               cur_cache_size);
...
# 209 "tile-cache.c"
 ...
 idle_scan_last=tile;
   ...
   idle_delay = 0;
          idle_swapper = g_timeout_add_full (300,
                                             1000,
                                             tile_idle_preswap,
                                             ((void*)0), ((void*)0));
        }
