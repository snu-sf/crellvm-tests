...
void tile_manager_write_pixel_data_1 (TileManager *tm,
                                                 ...
                                                 const guchar *buffer);
# 29 "tile-manager.c" 2
# 1 "./tile-manager-private.h" 1
# 22 "./tile-manager-private.h"
struct _TileManager
{
  gint ref_count;
  ...
  Tile **tiles;
  TileValidateProc validate_proc;
                  ...
                  gint bpp)
{
  ...
  do{ if (bpp > 0 && bpp <= 4) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "bpp > 0 && bpp <= 4"); return (((void*)0)); }; }while (0);
...
{
  do{ if (tm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tm != NULL"); return (((void*)0)); }; }while (0);
...
{
  do{ if (tm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tm != NULL"); return; }; }while (0);
  ...
  if (tm->ref_count < 1)
    {
      ...
      do { if (1) g_slice_free1 (sizeof (TileManager), (tm)); else (void) ((TileManager*) 0 == (tm)); } while (0);
    }
}
...
{
  do{ if (tm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tm != NULL"); return; }; }while (0);
  do{ if (tile != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tile != NULL"); return; }; }while (0);
...
tile_manager_allocate_tiles (TileManager *tm)
{
  ...
  do { if (tm->tiles == ((void*)0)) ; else g_assertion_message_expr ("Gimp-Base", "tile-manager.c", 368, ((const char*) (__func__)), "tm->tiles == NULL"); } while (0);
...
{
  do{ if (tm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tm != NULL"); return; }; }while (0);
  do{ if (srctile != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "srctile != NULL"); return; }; }while (0);
                  ...
                  Tile *srctile)
{
  ...
  do{ if (tm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tm != NULL"); return; }; }while (0);
  do{ if (srctile != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "srctile != NULL"); return; }; }while (0);
  do{ if (tile_num >= 0) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tile_num >= 0"); return; }; }while (0);
  do{ if (tile_num < tm->ntile_rows * tm->ntile_cols) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tile_num < tm->ntile_rows * tm->ntile_cols"); return; }; }while (0);

  if ((! tm->tiles))
    {
      g_warning ("%s: empty tile level - initializing", "tile-manager.c" ":" "492");
  ...
  if ((! srctile->valid))
    g_warning("%s: srctile not validated yet!  please report", "tile-manager.c" ":" "504");
  ...
  if ((tile->ewidth != srctile->ewidth || tile->eheight != srctile->eheight || tile->bpp != srctile->bpp))
...

    {
      g_warning ("%s: nonconformant map (%p -> %p)",
                 "tile-manager.c" ":" "511", srctile, tile);
    }
...
{
  do{ if (tm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tm != NULL"); return (0); }; }while (0);
                          ...
                          Tile *tile)
{
  ...
  if ((tl == ((void*)0)))
    {
      g_warning ("%s: tile not attached to manager", "tile-manager.c" ":" "631");
      return 0;
    }
                               ...
                               gint *tile_row)
{
  ...
  do{ if (tm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tm != NULL"); return; }; }while (0);
  do{ if (tile != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tile != NULL"); return; }; }while (0);
  do{ if (tile_col != ((void*)0) && tile_row != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tile_col != NULL && tile_row != NULL"); return; }; }while (0);
                                   ...
                                   gint *y)
{
  ...
  do{ if (tm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tm != NULL"); return; }; }while (0);
  do{ if (tile != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "tile != NULL"); return; }; }while (0);
  do{ if (x != ((void*)0) && y != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "x != NULL && y != NULL"); return; }; }while (0);
                            ...
                            Tile *srctile)
{
  ...
  if ((tl == ((void*)0)))
    {
      g_warning ("%s: tile not attached to manager", "tile-manager.c" ":" "694");
      return;
    }
