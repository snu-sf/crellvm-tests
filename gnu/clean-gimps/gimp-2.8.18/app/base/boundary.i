               ...
               int *num_segs)
{
  ...
  do{ if (maskPR != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "maskPR != NULL"); return (((void*)0)); }; }while (0);
  do{ if (num_segs != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "num_segs != NULL"); return (((void*)0)); }; }while (0);

  boundary = generate_boundary (maskPR, type, x1, y1, x2, y2, threshold);

  *num_segs = boundary->num_segs;

  return boundary_free (boundary, (0));
}
# 189 "boundary.c"
BoundSeg *
               ...
               gint *num_groups)
{
  ...
  do{ if ((segs == ((void*)0) && num_segs == 0) || (segs != ((void*)0) && num_segs > 0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "(segs == NULL && num_segs == 0) || (segs != NULL && num_segs > 0)"); return (((void*)0)); }; }while (0);

  do{ if (num_groups != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "num_groups != NULL"); return (((void*)0)); }; }while (0);
  ...
  *num_groups = 0;
  ...
  segs_ptrs_by_xy1 = ((const BoundSeg * *) g_malloc_n ((num_segs), sizeof (const BoundSeg *)));
  segs_ptrs_by_xy2 = ((const BoundSeg * *) g_malloc_n ((num_segs), sizeof (const BoundSeg *)));
  ...
  for (index = 0; index < num_segs; index++)
    ((BoundSeg *) segs)[index].visited = (0);

  boundary = boundary_new (((void*)0));
                   ...
                   gint *num_segs)
{
  ...
  do{ if ((sorted_segs == ((void*)0) && num_groups == 0) || (sorted_segs != ((void*)0) && num_groups > 0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "(sorted_segs == NULL && num_groups == 0) || (sorted_segs != NULL && num_groups > 0)"); return (((void*)0)); }; }while (0);

  do{ if (num_segs != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Base", ((const char*) (__func__)), "num_segs != NULL"); return (((void*)0)); }; }while (0);

  new_bounds = g_array_new ((0), (0), sizeof (BoundSeg));
      ...
      if (n_points > 0)
        {
          ...
          tmp_points = g_array_new ((0), (0), sizeof (gint));
          ...
          for (j = 0; j < tmp_points->len; j++)
            g_array_append_vals (new_bounds, &(sorted_segs[(((gint*) (void *) (tmp_points)->data) [(j)])]), 1);



          g_array_append_vals (new_bounds, &(sorted_segs[seg]), 1);

          g_array_free (tmp_points, (!(0)));
        }
  ...
  *num_segs = new_bounds->len;
  ...
  return (BoundSeg *) g_array_free (new_bounds, (0));
}
...
{
  Boundary *boundary = ((Boundary*) g_slice_alloc0 (sizeof (Boundary)));
  ...
  if (PR)
    {
      ...
      boundary->vert_segs = ((gint *) g_malloc_n ((PR->w + PR->x + 1), sizeof (gint)));
      ...
      boundary->empty_segs_n = ((gint *) g_malloc_n ((boundary->max_empty_segs), sizeof (gint)));
      boundary->empty_segs_c = ((gint *) g_malloc_n ((boundary->max_empty_segs), sizeof (gint)));
      boundary->empty_segs_l = ((gint *) g_malloc_n ((boundary->max_empty_segs), sizeof (gint)));
    }
               ...
               gboolean free_segs)
{
  ...
  do { if (1) g_slice_free1 (sizeof (Boundary), (boundary)); else (void) ((Boundary*) 0 == (boundary)); } while (0);
                  ...
                  gboolean open)
{
  if (boundary->num_segs >= boundary->max_segs)
    {
      boundary->max_segs += 2048;

      boundary->segs = ((BoundSeg *) g_realloc_n (boundary->segs, (boundary->max_segs), sizeof (BoundSeg)));
    }
  ...
  if (scanline < maskPR->y || scanline >= (maskPR->y + maskPR->h))
    {
      ...
      empty_segs[(*num_empty)++] = 2147483647;
      return;
    }
  ...
  for (empty_index = 0; empty_index < num_empty; empty_index += 2)
    {
      ...
      if (e_s <= start && e_e >= end)
        ...
        {
          process_horiz_seg (boundary,
                             (((e_s) > (start)) ? (e_s) : (start)), scanline,
                             (((e_e) < (end)) ? (e_e) : (end)), scanline, top);
        }
    }
}
              ...
              gint y)
{
  ...
  if (segptr_xy1 != ((void*)0) && segptr_xy2 != ((void*)0))
    return (((segptr_xy1) < (segptr_xy2)) ? (segptr_xy1) : (segptr_xy2));
  else if (segptr_xy1 != ((void*)0))
    return segptr_xy1;
  else if (segptr_xy2 != ((void*)0))
    return segptr_xy2;
...
{
  const BoundSeg **seg;
  const BoundSeg *found_seg = ((void*)0);
                    ...
                    GArray **ret_points)
{
  ...
  if (end_idx - start_idx < 2)
    {
      *ret_points = g_array_append_vals (*ret_points, &(start_idx), 1);
      return;
    }
      ...
      for (i = start_idx + 1; i < end_idx; i++)
        {
          ...
          gint dist = (((segs[i].x1 - segs[start_idx].x1) * (segs[i].x1 - segs[start_idx].x1)) +
                       ((segs[i].y1 - segs[start_idx].y1) * (segs[i].y1 - segs[start_idx].y1)));
