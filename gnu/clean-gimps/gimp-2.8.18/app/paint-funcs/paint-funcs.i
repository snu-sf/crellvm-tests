         ...
         ...)
{
  ...
  g_logv ("Gimp-Paint-Funcs", G_LOG_LEVEL_ERROR, format, args);
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint-Funcs", G_LOG_LEVEL_MESSAGE, format, args);
  __builtin_va_end(args);
}
static void
            ...
            ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint-Funcs", G_LOG_LEVEL_CRITICAL, format, args);
  __builtin_va_end(args);
}
static void
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint-Funcs", G_LOG_LEVEL_WARNING, format, args);
  __builtin_va_end(args);
}
static void
        ...
        ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint-Funcs", G_LOG_LEVEL_INFO, format, args);
  __builtin_va_end(args);
}
static void
         ...
         ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint-Funcs", G_LOG_LEVEL_DEBUG, format, args);
  __builtin_va_end(args);
}
...
# 1 "./paint-funcs-types.h" 1
# 22 "./paint-funcs-types.h"
...
# 1 "../../app/base/pixel-processor.h" 1
# 27 "../../app/base/pixel-processor.h"
...
void tile_manager_write_pixel_data_1 (TileManager *tm,
                                                 ...
                                                 const guchar *buffer);
# 34 "paint-funcs.c" 2
# 1 "../../app/base/tile-rowhints.h" 1
# 27 "../../app/base/tile-rowhints.h"
typedef guchar TileRowHint;
# 37 "../../app/base/tile-rowhints.h"
...
# 1 "../../app/composite/gimp-composite.h" 1
# 24 "../../app/composite/gimp-composite.h"
typedef enum
{
  GIMP_PIXELFORMAT_V8,
...
# 53 "../../app/composite/gimp-composite.h"
...
# 73 "../../app/composite/gimp-composite.h"
typedef enum
{
...
void combine_regions_replace (PixelRegion *src1,
                                           ...
                                           CombinationMode type);
# 40 "paint-funcs.c" 2
# 1 "./paint-funcs-utils.h" 1
# 41 "paint-funcs.c" 2
# 1 "./paint-funcs-generic.h" 1
# 27 "./paint-funcs-generic.h"
void
...
pattern_pixels_mask (guchar *dest,
                     ...
                     gint y)
{
  const guint alpha = (~bytes & 1) ? bytes - 1 : bytes;
  const guchar *pat;
  guint i;
      ...
      while (w--)
        {
          ...
          *dest++ = ((tmp) = (src[alpha]) * (*m) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
          m++;
          src += bytes;
        }
    }
      ...
      while (w--)
        {
          ...
          *dest++ = ((tmp) = (src[alpha]) * (255) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
          src += bytes;
        }
    }
}
              ...
              for (b = 0; b < alpha; b++)
                {
                  ...
                  dest[b] = affect[b] ? (((new_val) < (255)) ? (new_val) : (255)) : src1[b];
                }
            }
              ...
              gint scale)
{
  ...
  while (length --)
    {
      *dest++ = (guchar) ((tmp) = (*src) * (scale) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
      src++;
    }
}
      ...
      for (b = 0; b < alpha; b++)
        {
          ...
          dest[b] = (((t1) = (src[b]) * (src[alpha]) + 0x80, ((((t1) >> 8) + (t1)) >> 8)) +
                     ((t2) = (bg[b]) * ((255 - src[alpha])) + 0x80, ((((t2) >> 8) + (t2)) >> 8)));
        }
...
gray_to_rgb_pixels (const guchar *src,
                    ...
                    guint bytes)
{
  const gboolean has_alpha = (bytes == 2) ? (!(0)) : (0);
      ...
      while (length --)
        {
          ...
          *src = ((tmp) = (*src) * (*mask) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
          mask++;
          src += bytes;
        }
    }
      ...
      while (length --)
        {
          ...
          *src = ((tmp) = (*src) * (*mask) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
          mask++;
          src += bytes;
        }
    }
                                        ...
                                        guint bytes)
{
  ...
  if (opacity != 255)
    while (length --)
      {
        gint tmp;
        gint mask_val = ((tmp) = (*mask) * (opacity) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));

        *src = *src + ((tmp) = ((255 - *src)) * (mask_val) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
    ...
    while (length --)
      {
        ...
        *src = *src + ((tmp) = ((255 - *src)) * (*mask) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
        ...
        if (opacity > *src)
          {
            ...
            *src = *src + ((tmp) = ((opacity - *src)) * (mask_val) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
          }
  ...
  while (length --)
    {
      gint col_index = *src++ * 3;
      glong tmp;
      guchar new_alpha = ((tmp) = (*src) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
            ...
            while(length--)
              {
                ...
                dest[1] = src[1];
                dest[2] = src[2];
                dest[3] = ((tmp) = (opacity) * (*m) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
                src += bytes;
                dest += dest_bytes;
                m++;
              }
        ...
        while (length--)
          {
            ...
            *destp = ((tmp) = (opacity) * (*m) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
            destp += dest_bytes;
            m++;
          }
      else
      ...
      while (length--)
        {
          ...
          dest[alpha] = (affect [alpha] ?
                         ((tmp) = (opacity) * (src[alpha]) * (*m) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16)) : 0);
      ...
      while (length--)
        {
          ...
          dest[alpha] = (affect [alpha] ?
                         ((tmp) = (opacity) * (src[alpha]) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8)) : 0);
...
struct _LayerMode
{
  const guint affect_alpha : 1;

  const guint increase_opacity : 1;
  const guint decrease_opacity : 1;
};
            ...
            gint *length)
{
  ...
  const gdouble l = sqrt (-sigma2 * -5.541263545);
  ...
  curve = ((gint *) g_malloc_n ((n), sizeof (gint)));
  ...
  if (mask)
    {
      ...
      while (length --)
        {
          register gulong tmp;
          const guchar new_alpha = ((tmp) = (*m) * (opacity) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
          guint b;
  ...
  if (mask)
    {
      ...
      while (length --)
        {
          register gulong tmp;
          const guchar new_alpha = ((tmp) = (src2[alpha]) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
          guint b;
  ...
  else
    {
      while (length --)
        {
          register gulong tmp;
          const guchar new_alpha = ((tmp) = (src2[alpha]) * (opacity) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
          guint b;
      ...
      while (length --)
        {
          ...
          const guchar new_alpha = ((tmp) = (255) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
          guint b;

          for (b = 0; b < bytes - 1; b++)
            dest[b] = (new_alpha > 127) ? cmap[index + b] : src1[b];

          dest[b] = (new_alpha > 127) ? 255 : src1[b];
      ...
      while (length --)
        {
          register gulong tmp;
          const guint index = src2[0] * 3;
          const guchar new_alpha = ((tmp) = (255) * (opacity) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
          guint b;
      ...
      while (length --)
        {
          ...
          for (b = 0; b < bytes; b++)
            dest[b] = (affect[b] ?
                       (((tmp) = ((src2[b]) - (src1[b])) * (new_alpha) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8)) + (src1[b])) : src1[b]);
      ...
      while (length --)
        {
          ...
          for (b = 0; b < bytes; b++)
            dest[b] = (affect[b] ?
                       (((tmp) = ((src2[b]) - (src1[b])) * (opacity) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8)) + (src1[b])) : src1[b]);
  ...
  if (mask)
    {
      ...
      while (length --)
        {
          register glong t1;
          const guchar new_alpha = ((t1) = (src2[alpha]) * (*m) * (opacity) + 0x7F5B, ((((t1) >> 7) + (t1)) >> 16));
          guint b;

          for (b = 0; b < bytes; b++)
            dest[b] = (affect[b] ?
                       (((t1) = ((src2[b]) - (src1[b])) * (new_alpha) + 0x80, ((((t1) >> 8) + (t1)) >> 8)) + (src1[b])) : src1[b]);
      ...
      if (bytes == 3 && affect[0] && affect[1] && affect[2])
        {
          while (length --)
            {
              register glong t1;
              const guchar new_alpha = ((t1) = (src2[alpha]) * (opacity) + 0x80, ((((t1) >> 8) + (t1)) >> 8));

              dest[0] = (((t1) = ((src2[0]) - (src1[0])) * (new_alpha) + 0x80, ((((t1) >> 8) + (t1)) >> 8)) + (src1[0]));
              dest[1] = (((t1) = ((src2[1]) - (src1[1])) * (new_alpha) + 0x80, ((((t1) >> 8) + (t1)) >> 8)) + (src1[1]));
              dest[2] = (((t1) = ((src2[2]) - (src1[2])) * (new_alpha) + 0x80, ((((t1) >> 8) + (t1)) >> 8)) + (src1[2]));
          ...
          while (length --)
            {
              ...
              for (b = 0; b < bytes; b++)
                dest[b] = (affect[b] ?
                           (((t1) = ((src2[b]) - (src1[b])) * (new_alpha) + 0x80, ((((t1) >> 8) + (t1)) >> 8)) + (src1[b])) :
                           src1[b]);
      ...
      if (opacity == 255)
          ...
          while (length--)
            {
              ...
              guchar src2_alpha = *m;
              guchar new_alpha =
                src1[alpha] + ((tmp) = ((255 - src1[alpha])) * (src2_alpha) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));

              if (src2_alpha != 0 && new_alpha != 0) { b = alpha; if (src2_alpha == new_alpha){ do { b--; dest [b] = affect [b] ? src2 [b] : src1 [b];} while (b); } else { ratio = (float) src2_alpha / new_alpha; compl_ratio = 1.0 - ratio; do { b--; dest[b] = affect[b] ? (guchar) (src2[b] * ratio + src1[b] * compl_ratio + 0.0001) : src1[b]; } while (b); } };
      ...
      else
        {
          while (length--)
            {
              register gulong tmp;
              guchar src2_alpha = ((tmp) = (*m) * (opacity) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
              guchar new_alpha =
                src1[alpha] + ((tmp) = ((255 - src1[alpha])) * (src2_alpha) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
                  ...
                  while (i--)
                    {
                      ...
                      register gulong tmp;
                      guchar src2_alpha = ((tmp) = (src2[alpha]) * (*m) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
                      guchar new_alpha =
                        src1[alpha] +
                        ((tmp) = ((255 - src1[alpha])) * (src2_alpha) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
                  ...
                  while (i--)
                    {
                      ...
                      register gulong tmp;
                      guchar src2_alpha = ((tmp) = (src2[alpha]) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
      ...
      if (opacity == 255)
      ...
      else
        {
          while (length --)
            {
              register gulong tmp;
              guchar src2_alpha = ((tmp) = (src2[alpha]) * (opacity) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
              guchar new_alpha =
                src1[alpha] + ((tmp) = ((255 - src1[alpha])) * (src2_alpha) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
                                         ...
                                         const guint bytes)
{
  ...
  while (length --)
    {
      register gulong t;
      guchar channel_alpha = ((t) = (255 - *channel) * (opacity) + 0x80, ((((t) >> 8) + (t)) >> 8));

      if (channel_alpha)
        {
          register gulong s;
          const guchar new_alpha =
            src[alpha] + ((t) = ((255 - src[alpha])) * (channel_alpha) + 0x80, ((((t) >> 8) + (t)) >> 8));
          guchar compl_alpha;
          guint b;
          ...
          for (b = 0; b < alpha; b++)
            dest[b] = ((t) = (col[b]) * (channel_alpha) + 0x80, ((((t) >> 8) + (t)) >> 8)) +
              ((s) = (src[b]) * (compl_alpha) + 0x80, ((((s) >> 8) + (s)) >> 8));
                                              ...
                                              const guint bytes)
{
  ...
  while (length --)
    {
      register gulong t;
      guchar channel_alpha = ((t) = (*channel) * (opacity) + 0x80, ((((t) >> 8) + (t)) >> 8));
  ...
  while (length --)
    {
      ...
      guchar src2_alpha = ((tmp) = (src2[alpha]) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
      guchar new_alpha =
        src2_alpha + ((tmp) = ((255 - src2_alpha)) * (src1_alpha) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
      ...
      for (b = 0; b < alpha; b++)
        dest[b] = (affect[b]) ?
          (guchar) (src1[b] * ratio + src2[b] * compl_ratio + 0.0001) :
        src1[b];
  ...
  while (length --)
    {
      ...
      guchar src2_alpha = ((tmp) = (src2[alpha]) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
      guchar new_alpha =
        (src2_alpha > 127) ? 255 : 0;

      for (b = 0; b < bytes1; b++)
        dest[b] =
          (affect[b] && new_alpha == 255 && (src1_alpha > 127)) ?
          src2[b] : src1[b];
...
replace_inten_pixels (const guchar *src1,
                      ...
                      guint bytes2)
{
  const guint has_alpha1 = (~bytes1 & 1);
  const guint has_alpha2 = (~bytes2 & 1);
  ...
  while (length --)
    {
      ...
      guchar new_alpha = (((tmp) = ((src2_alpha) - (src1_alpha)) * (((tmp) = (*m) * (opacity) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8))) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8)) + (src1_alpha));
      ...
      if (new_alpha)
        {
          ...
          ratio = ((ratio)/(new_alpha) + (((ratio) % (new_alpha)) > ((new_alpha) / 2)));
          ...
          for (b = 0; b < alpha; b++)
            {
              if (! affect[b])
              ...
              else if (src2[b] > src1[b])
                {
                  ...
                  dest[b] = src1[b] + ((t)/(255) + (((t) % (255)) > ((255) / 2)));
                }
              else
                {
                        ...
                        guint bytes2)
{
  const guint has_alpha1 = (~bytes1 & 1);
  const guint has_alpha2 = (~bytes2 & 1);
  const guint bytes = (((bytes1) < (bytes2)) ? (bytes1) : (bytes2));
  const guchar *m = mask ? mask : &no_mask;
  guint b;
  gint tmp;
  ...
  while (length --)
    {
      guchar mask_alpha = ((tmp) = (*m) * (opacity) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
      ...
      while (length --)
        {
          ...
          src2_alpha = ((tmp) = (src2[alpha]) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
          dest[alpha] = src1[alpha] - ((tmp) = (src1[alpha]) * (src2_alpha) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
  ...
  while (length --)
    {
      ...
      src2_alpha = ((tmp) = (src2[alpha]) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
      dest[alpha] = (src2_alpha > 127) ? 0 : src1[alpha];
  ...
  while (length --)
    {
      ...
      src2_alpha = ((tmp) = (src2[alpha]) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
      dest[alpha] = (src2_alpha > 127) ? 255 : src1[alpha];
  ...
  while (length --)
    {
      switch (bytes)
        {
        case 2:
          src2_alpha = ((tmp) = (src2[1]) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
          ...
          gimp_rgba_get_uchar (&color, dest, ((void*)0), ((void*)0), dest + 1);
          break;

        case 4:
          src2_alpha = ((tmp) = (src2[3]) * (*m) * (opacity) + 0x7F5B, ((((tmp) >> 7) + (tmp)) >> 16));
...
extract_from_inten_pixels (guchar *src,
                           ...
                           guint dest_bytes)
{
  const gint alpha = (~src_bytes & 1) ? src_bytes - 1 : src_bytes;
  const guchar *m = mask ? mask : &no_mask;
  gint b;
  gint tmp;
  ...
  while (length --)
    {
      ...
      if ((~src_bytes & 1))
        {
          dest[alpha] = ((tmp) = (*m) * (src[alpha]) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
          if (cut)
            src[alpha] = ((tmp) = ((255 - *m)) * (src[alpha]) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8));
        }
      else
        {
          if ((~dest_bytes & 1))
          ...
          if (cut)
            for (b = 0; b < src_bytes; b++)
              src[b] = (((tmp) = ((bg[b]) - (src[b])) * (*m) + 0x80, ((((tmp) >> 8) + (tmp)) >> 8)) + (src[b]));
        }
  ...
  while (length --)
    {
      ...
      if ((~src_bytes & 1))
        {
          dest[3] = ((t) = (*m) * (src[1]) + 0x80, ((((t) >> 8) + (t)) >> 8));
          if (cut)
            src[1] = ((t) = ((255 - *m)) * (src[1]) + 0x80, ((((t) >> 8) + (t)) >> 8));
        }
      else
        {
          if ((~dest_bytes & 1))
                ...
                gint off_y)
{
  ...
  for (pr = pixel_regions_register (2, dest, mask);
    ...
    {
      guchar *d = dest->data;
      const guchar *m = mask ? mask->data : ((void*)0);
      gint y;
              ...
              for (j = y - margin; j <= y + margin; j++)
                {
                  for (i = x - margin; i <= x + margin; i++, m++)
                    {
                      gint xx = (((i) > (x2)) ? (x2) : (((i) < (x1)) ? (x1) : (i)));
                      gint yy = (((j) > (y2)) ? (y2) : (((j) < (y1)) ? (y1) : (j)));
              ...
              for (b = 0; b < bytes; b++)
                {
                  ...
                  if (total[b] < 0.0)
                    ...
                    *d++ = (total[b] > 255.0) ? 255 : (guchar) ((int) ((total[b]) + 0.5));
                }
            }
        }
      else
                      ...
                      gdouble radius_y)
{
  ...
  length = (((srcR->w) > (srcR->h)) ? (srcR->w) : (srcR->h)) * srcR->bytes;
  data = ((guchar *) g_malloc_n ((length * 2), sizeof (guchar)));
  src = data;
  dest = data + length;
  ...
  buf = ((guint *) g_malloc_n (((((width) > (height)) ? (width) : (height)) * 2), sizeof (guint)));

  if (radius_y != 0.0)
    {
      curve = make_curve (- ((radius_y) * (radius_y)) / (2 * -5.541263545), &length);

      sum = ((gint *) g_malloc_n ((2 * length + 1), sizeof (gint)));
      sum[0] = 0;
  ...
  if (radius_x != 0.0)
    {
      curve = make_curve (- ((radius_x) * (radius_x)) / (2 * -5.541263545), &length);
                   ...
                   gpointer progress_data)
{
  ...
  length = distPR->w + 1;
  memory = ((gfloat *) g_malloc_n ((length * 2), sizeof (gfloat)));
  ...
  for (i = 0; i < srcPR->h; i++)
    {
      ...
      for (j = 0; j < srcPR->w; j++)
        {
          min_prev = (((distp_cur[j-1]) < (distp_prev[j])) ? (distp_cur[j-1]) : (distp_prev[j]));
          min_left = ((((srcPR->w - j - 1)) < ((srcPR->h - i - 1))) ? ((srcPR->w - j - 1)) : ((srcPR->h - i - 1)));
          min = (gint) (((min_left) < (min_prev)) ? (min_left) : (min_prev));
          fraction = 255;
              ...
              while (y >= end)
                {
                  ...
                  boundary = (((y % 64) < (width - (x % 64) - 1)) ? (y % 64) : (width - (x % 64) - 1));

                  boundary = (((boundary) < (y - end)) ? (boundary) : (y - end)) + 1;
              ...
              if (min_left != min)
                {
                  ...
                  fraction = (((fraction) < (prev_frac)) ? (fraction) : (prev_frac));
                }
                ...
                guint16 yradius)
{
  ...
  for (i = 0; i < diameter; i++)
  {
    ...
    circ[i] = rint(yradius / (gdouble) xradius * sqrt (((xradius) * (xradius)) - ((tmp) * (tmp))));
               ...
               gint16 yradius)
{
  ...
  max = ((guchar * *) g_malloc_n ((region->w + 2 * xradius), sizeof (guchar *)));
  buf = ((guchar * *) g_malloc_n ((yradius + 1), sizeof (guchar *)));

  for (i = 0; i < yradius + 1; i++)
    buf[i] = ((guchar *) g_malloc_n ((region->w), sizeof (guchar)));

  buffer = ((guchar *) g_malloc_n (((region->w + 2 * xradius) * (yradius + 1)), sizeof (guchar)));
  ...
  out = ((guchar *) g_malloc_n ((region->w), sizeof (guchar)));

  circ = ((gint16 *) g_malloc_n ((2 * xradius + 1), sizeof (gint16)));
  ...
  for (i = 0; i < yradius && i < region->h; i++)
  ...
  for (x = 0; x < region->w; x++)
    {
      ...
      for (j = 2; j < yradius + 1; j++)
        max[x][j] = (((buf[j][x]) > (max[x][j-1])) ? (buf[j][x]) : (max[x][j-1]));
    }
  ...
  for (y = 0; y < region->h; y++)
    {
      ...
      for (x = 0; x < region->w; x++)
        {
          for (i = yradius; i > 0; i--)
            max[x][i] = ((((((max[x][i - 1]) > (buf[i - 1][x])) ? (max[x][i - 1]) : (buf[i - 1][x]))) > (buf[i][x])) ? ((((max[x][i - 1]) > (buf[i - 1][x])) ? (max[x][i - 1]) : (buf[i - 1][x]))) : (buf[i][x]));
...
# 2889 "paint-funcs.c"
  ...
  buffer = ((guchar *) g_malloc_n ((buffer_size), sizeof (guchar)));
...
smooth_region (PixelRegion *region)
{
  ...
  for (i = 0; i < 3; i++)
    buf[i] = ((guchar *) g_malloc_n ((width + 2), sizeof (guchar)));

  out = ((guchar *) g_malloc_n ((width), sizeof (guchar)));
               ...
               gboolean edge_lock)
{
  ...
  if (xradius == 1 && yradius == 1)
    {
      ...
      for (i = 0; i < 3; i++)
        source[i] = ((guchar *) g_malloc_n ((src->w), sizeof (guchar)));

      transition = ((guchar *) g_malloc_n ((src->w), sizeof (guchar)));
  ...
  max = ((gint16 *) g_malloc_n ((src->w + 2 * xradius), sizeof (gint16)));
  ...
  for (i = 0; i < 3; i++)
    buf[i] = ((guchar *) g_malloc_n ((src->w), sizeof (guchar)));

  transition = ((guchar * *) g_malloc_n ((yradius + 1), sizeof (guchar *)));

  for (i = 0; i < yradius + 1; i++)
    {
      transition[i] = ((guchar *) g_malloc_n ((src->w + 2 * xradius), sizeof (guchar)));
      memset(transition[i], 0, src->w + 2 * xradius);
      transition[i] += xradius;
    }

  out = ((guchar *) g_malloc_n ((src->w), sizeof (guchar)));

  density = ((guchar * *) g_malloc_n ((2 * xradius + 1), sizeof (guchar *)));
  density += xradius;


  for (x = 0; x < (xradius + 1); x++)
    {
      density[ x] = ((guchar *) g_malloc_n ((2 * yradius + 1), sizeof (guchar)));
      density[ x] += yradius;
      density[-x] = density[x];
    }
                    ...
                    PixelRegion *mask)
{
  ...
  buf = __builtin_alloca ((((src->w * (src->bytes + 1)) > (dest->w * dest->bytes)) ? (src->w * (src->bytes + 1)) : (dest->w * dest->bytes)));
          ...
          if (mode == GIMP_DISSOLVE_MODE)
            {
              ...
              initial_inten_a_pixels (buf, d, ((void*)0), 255, affect,
                                      src->w, src->bytes + 1);
            }
          else
            {
                    ...
                    PixelRegion *mask)
{
  ...
  buf = __builtin_alloca (((((((src1->w * src1->bytes) > (src2->w * (src2->bytes + 1))) ? (src1->w * src1->bytes) : (src2->w * (src2->bytes + 1)))) > (dest->w * dest->bytes)) ? ((((src1->w * src1->bytes) > (src2->w * (src2->bytes + 1))) ? (src1->w * src1->bytes) : (src2->w * (src2->bytes + 1)))) : (dest->w * dest->bytes)));
      ...
      for (i = 0; i < src1->bytes - 1; i++)
        {
          if (!affect[i])
            {
              st.opacity_quickskip_possible = (0);
              break;
            }
        }
    }
