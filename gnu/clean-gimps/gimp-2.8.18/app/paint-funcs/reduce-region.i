  ...
  if (level > 0)
    {
      ...
      guchar *dst = ((guchar *) g_malloc_n ((width * height * bytes), sizeof (guchar)));
          ...
          while (level)
            {
              ...
              dst = ((guchar *) g_malloc_n ((width * height * bytes), sizeof (guchar)));
                     ...
                     gint bytes)
{
  ...
  src_buf = ((guchar *) g_malloc_n ((src_width * bytes * 3), sizeof (guchar)));
  ...
  for (y = 0 ; y < srcPR->h ; y+=2)
    {
      pixel_region_get_row (srcPR, 0, (((y-1) < 0) ? -(y-1) : (y-1)), src_width, row0, 1);
               ...
               gint alpha)
{
  ...
  src_buf = ((guchar *) g_malloc_n ((rowstride * 3), sizeof (guchar)));
  ...
  for (x=0; x < width ; x+=2)
    {
      for (b = start ; b >= 0 ; b--)
        {
          sum += src0[(((x-1) < 0) ? -(x-1) : (x-1)) * bytes + b] * 12;
          sum += src0[(((x) < 0) ? -(x) : (x)) * bytes + b] * 32;
          sum += src0[(((x+1) < 0) ? -(x+1) : (x+1)) * bytes + b] * 12;

          sum += src1[(((x-1) < 0) ? -(x-1) : (x-1)) * bytes + b] * 32;
          sum += src1[(((x) < 0) ? -(x) : (x)) * bytes + b] * 86;
          sum += src1[(((x+1) < 0) ? -(x+1) : (x+1)) * bytes + b] * 32;

          sum += src2[(((x-1) < 0) ? -(x-1) : (x-1)) * bytes + b] * 12;
          sum += src2[(((x) < 0) ? -(x) : (x)) * bytes + b] * 32;
          sum += src2[(((x+1) < 0) ? -(x+1) : (x+1)) * bytes + b] * 12;
                 ...
                 gint bytes)
{
  ...
  dst = ((guchar *) g_malloc_n ((dstPR->w * dstPR->h * bytes), sizeof (guchar)));
                    ...
                    PixelRegion *srcPR)
{
  ...
  src0 = ((guchar *) g_malloc0_n ((srcPR->w * bytes), sizeof (guchar)));
  src1 = ((guchar *) g_malloc0_n ((srcPR->w * bytes), sizeof (guchar)));
  dst = ((guchar *) g_malloc0_n ((dstPR->w * bytes), sizeof (guchar)));
