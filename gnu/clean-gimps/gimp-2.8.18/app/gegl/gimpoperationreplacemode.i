# 1 "gimpoperationreplacemode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpoperationreplacemode.c" 2
# 22 "gimpoperationreplacemode.c"
# 1 "../../config.h" 1
# 23 "gimpoperationreplacemode.c" 2
...
# 25 "gimpoperationreplacemode.c" 2
...
# 27 "gimpoperationreplacemode.c" 2

# 1 "./gimpoperationreplacemode.h" 1
# 26 "./gimpoperationreplacemode.h"
...
# 27 "./gimpoperationreplacemode.h" 2
...
# 29 "gimpoperationreplacemode.c" 2
...
static void gimp_operation_replace_mode_init (GimpOperationReplaceMode *self); static void gimp_operation_replace_mode_class_init (GimpOperationReplaceModeClass *klass); static gpointer gimp_operation_replace_mode_parent_class = ((void*)0); static gint GimpOperationReplaceMode_private_offset; static void gimp_operation_replace_mode_class_intern_init (gpointer klass) { gimp_operation_replace_mode_parent_class = g_type_class_peek_parent (klass); if (GimpOperationReplaceMode_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpOperationReplaceMode_private_offset); gimp_operation_replace_mode_class_init ((GimpOperationReplaceModeClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_operation_replace_mode_get_instance_private (GimpOperationReplaceMode *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpOperationReplaceMode_private_offset)))); } GType gimp_operation_replace_mode_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_operation_point_layer_mode_get_type ()), g_intern_static_string ("GimpOperationReplaceMode"), sizeof (GimpOperationReplaceModeClass), (GClassInitFunc) gimp_operation_replace_mode_class_intern_init, sizeof (GimpOperationReplaceMode), (GInstanceInitFunc) gimp_operation_replace_mode_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
