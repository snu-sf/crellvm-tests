# 1 "gimpoperationpointlayermode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpoperationpointlayermode.c" 2
# 22 "gimpoperationpointlayermode.c"
# 1 "../../config.h" 1
# 23 "gimpoperationpointlayermode.c" 2
...
# 25 "gimpoperationpointlayermode.c" 2
...
# 29 "/usr/include/gegl-0.2/gegl-plugin.h" 2
# 1 "/usr/include/gegl-0.2/gegl.h" 1
# 23 "/usr/include/gegl-0.2/gegl.h"
...
# 30 "/usr/include/gegl-0.2/gegl-plugin.h" 2
...
# 26 "gimpoperationpointlayermode.c" 2
...
# 28 "gimpoperationpointlayermode.c" 2
...
# 30 "gimpoperationpointlayermode.c" 2

# 1 "../../app/paint-funcs/paint-funcs.h" 1
# 23 "../../app/paint-funcs/paint-funcs.h"
...
void combine_regions_replace (PixelRegion *src1,
                                           ...
                                           const gboolean *affect,
                                           CombinationMode type);
# 32 "gimpoperationpointlayermode.c" 2
...
# 34 "gimpoperationpointlayermode.c" 2
# 70 "gimpoperationpointlayermode.c"
enum
{
  PROP_0,
  PROP_BLEND_MODE
...
static void gimp_operation_point_layer_mode_init (GimpOperationPointLayerMode *self); static void gimp_operation_point_layer_mode_class_init (GimpOperationPointLayerModeClass *klass); static gpointer gimp_operation_point_layer_mode_parent_class = ((void*)0); static gint GimpOperationPointLayerMode_private_offset; static void gimp_operation_point_layer_mode_class_intern_init (gpointer klass) { gimp_operation_point_layer_mode_parent_class = g_type_class_peek_parent (klass); if (GimpOperationPointLayerMode_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpOperationPointLayerMode_private_offset); gimp_operation_point_layer_mode_class_init ((GimpOperationPointLayerModeClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_operation_point_layer_mode_get_instance_private (GimpOperationPointLayerMode *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpOperationPointLayerMode_private_offset)))); } GType gimp_operation_point_layer_mode_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gegl_operation_point_composer_get_type ()), g_intern_static_string ("GimpOperationPointLayerMode"), sizeof (GimpOperationPointLayerModeClass), (GClassInitFunc) gimp_operation_point_layer_mode_class_intern_init, sizeof (GimpOperationPointLayerMode), (GInstanceInitFunc) gimp_operation_point_layer_mode_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }



static guint32 dissolve_lut[400 * 300];
...
gimp_operation_point_layer_mode_class_init (GimpOperationPointLayerModeClass *klass)
{
  ...
  GeglOperationPointComposerClass *point_class = ((((GeglOperationPointComposerClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gegl_operation_point_composer_get_type ()))))));
  GRand *rand = g_rand_new_with_seed (737893334);
  int i;
  ...
  g_object_class_install_property (object_class, PROP_BLEND_MODE,
                                   g_param_spec_enum ("blend-mode", ((void*)0), ((void*)0),
...
gimp_operation_point_layer_mode_set_property (GObject *object,
                                              ...
                                              GParamSpec *pspec)
{
  GimpOperationPointLayerMode *self = ((((GimpOperationPointLayerMode*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_operation_point_layer_mode_get_type ()))))));
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpoperationpointlayermode.c", 157, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                              ...
                                              GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpoperationpointlayermode.c", 177, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                                     ...
                                                     gfloat *new)
{
  ...
  switch (blend_mode)
    {
    case GIMP_HUE_MODE:
      new_lchab[0] = in_lchab[0];
      new_lchab[1] = in_lchab[1];
      new_lchab[2] = lay_lchab[2];
      break;

    case GIMP_SATURATION_MODE:
      new_lchab[0] = in_lchab[0];
      new_lchab[1] = lay_lchab[1];
      new_lchab[2] = in_lchab[2];
      break;
    ...
    case GIMP_VALUE_MODE:
      new_lchab[0] = lay_lchab[0];
      new_lchab[1] = in_lchab[1];
      new_lchab[2] = in_lchab[2];
      break;

    default:
      do { g_assertion_message_expr ("Gimp-GEGL", "gimpoperationpointlayermode.c", 236, ((const char*) (__func__)), ((void*)0)); } while (0);
      break;
    }
                                                       ...
                                                       gfloat *out)
{
  ...
  if ((in[(3)]) <= 0.0)
    gimp_rgba_set (&inRGB, 0.0, 0.0, 0.0, (in[(3)]));
  else
    gimp_rgba_set (&inRGB, in[(0)] / (in[(3)]), in[(1)] / (in[(3)]), in[(2)] / (in[(3)]), (in[(3)]));

  if ((lay[(3)]) <= 0.0)
    gimp_rgba_set (&layRGB, 0.0, 0.0, 0.0, (lay[(3)]));
  else
    gimp_rgba_set (&layRGB, lay[(0)] / (lay[(3)]), lay[(1)] / (lay[(3)]), lay[(2)] / (lay[(3)]), (lay[(3)]));
...
gimp_operation_point_layer_mode_process (GeglOperation *operation,
                                         ...
                                         gint level)
{
  GimpOperationPointLayerMode *self = ((((GimpOperationPointLayerMode*) g_type_check_instance_cast ((GTypeInstance*) ((operation)), ((gimp_operation_point_layer_mode_get_type ()))))));
  ...
  while (sample--)
    {
      ...
      switch (blend_mode)
        ...
        case GIMP_ERASE_MODE:
          ...
          (out[(3)]) = (in[(3)]) - (in[(3)]) * (lay[(3)]);
          if ((in[(3)]) <= 0.0)
            for (c = 0; c < 3; c++) { (out[c]) = 0.0; }

          else
            for (c = 0; c < 3; c++) { (out[c]) = (in[(3)] ? in[c] / in[(3)] : 0.0) * (out[(3)]); };

          break;

        case GIMP_ANTI_ERASE_MODE:

          (out[(3)]) = (in[(3)]) + (1 - (in[(3)])) * (lay[(3)]);
          if ((in[(3)]) <= 0.0)
            for (c = 0; c < 3; c++) { (out[c]) = 0.0; }
        ...
        case GIMP_DISSOLVE_MODE:
          ...
          x = (roi->x + sample - (sample / roi->width) * roi->width) % 400;
          y = (roi->y + sample / roi->width) % 300;

          if ((lay[(3)]) * ((guint32) 0xffffffff) >= dissolve_lut[y * 400 + x])
            {
              (out[(3)]) = 1.0;
              for (c = 0; c < 3; c++) { (out[c]) = (lay[(3)] ? lay[c] / lay[(3)] : 0.0); };

            }
          else
            {
              (out[(3)]) = (in[(3)]);
              for (c = 0; c < 3; c++) { (out[c]) = (in[c]); };
        ...
        case GIMP_NORMAL_MODE:
          ...
          for (c = 0; c < 3; c++) { (out[c]) = (lay[c]) + (in[c]) * (1 - (lay[(3)])); };

          break;

        case GIMP_BEHIND_MODE:

          for (c = 0; c < 3; c++) { (out[c]) = (in[c]) + (lay[c]) * (1 - (in[(3)])); };

          break;

        case GIMP_MULTIPLY_MODE:

          for (c = 0; c < 3; c++) { (out[c]) = (lay[c]) * (in[c]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); };

          break;

        case GIMP_SCREEN_MODE:

          for (c = 0; c < 3; c++) { (out[c]) = (lay[c]) + (in[c]) - (lay[c]) * (in[c]); };

          break;

        case GIMP_DIFFERENCE_MODE:

          for (c = 0; c < 3; c++) { (out[c]) = (in[c]) + (lay[c]) - 2 * ((((lay[c]) * (in[(3)])) < ((in[c]) * (lay[(3)]))) ? ((lay[c]) * (in[(3)])) : ((in[c]) * (lay[(3)]))); };

          break;

        case GIMP_DARKEN_ONLY_MODE:

          for (c = 0; c < 3; c++) { (out[c]) = ((((lay[c]) * (in[(3)])) < ((in[c]) * (lay[(3)]))) ? ((lay[c]) * (in[(3)])) : ((in[c]) * (lay[(3)]))) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); };
        ...
        case GIMP_OVERLAY_MODE:
          ...
          for (c = 0; c < 3; c++) { if (2 * (in[c]) < (in[(3)])) (out[c]) = 2 * (lay[c]) * (in[c]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else (out[c]) = (lay[(3)]) * (in[(3)]) - 2 * ((in[(3)]) - (in[c])) * ((lay[(3)]) - (lay[c])) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); };
        ...
        case GIMP_DODGE_MODE:
          ...
          for (c = 0; c < 3; c++) { if ((lay[c]) * (in[(3)]) + (in[c]) * (lay[(3)]) >= (lay[(3)]) * (in[(3)])) (out[c]) = (lay[(3)]) * (in[(3)]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else (out[c]) = (in[c]) * (lay[(3)]) / (1 - (lay[(3)] ? lay[c] / lay[(3)] : 0.0)) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); };
        ...
        case GIMP_BURN_MODE:
          ...
          for (c = 0; c < 3; c++) { if ((lay[c]) * (in[(3)]) + (in[c]) * (lay[(3)]) <= (lay[(3)]) * (in[(3)])) (out[c]) = (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else (out[c]) = (lay[(3)]) * ((lay[c]) * (in[(3)]) + (in[c]) * (lay[(3)]) - (lay[(3)]) * (in[(3)])) / (lay[c]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); };
        ...
        case GIMP_HARDLIGHT_MODE:
          ...
          for (c = 0; c < 3; c++) { if (2 * (lay[c]) < (lay[(3)])) (out[c]) = 2 * (lay[c]) * (in[c]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else (out[c]) = (lay[(3)]) * (in[(3)]) - 2 * ((in[(3)]) - (in[c])) * ((lay[(3)]) - (lay[c])) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); };
        ...
        case GIMP_SOFTLIGHT_MODE:
          ...
          for (c = 0; c < 3; c++) { (out[c]) = (in[c]) * ((lay[(3)]) * (in[(3)] ? in[c] / in[(3)] : 0.0) + (2 * (lay[c]) * (1 - (in[(3)] ? in[c] / in[(3)] : 0.0)))) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); };
        ...
        case GIMP_ADDITION_MODE:
          ...
          for (c = 0; c < 3; c++) { if ((lay[c]) * (in[(3)]) + (in[c]) * (lay[(3)]) >= (lay[(3)]) * (in[(3)])) (out[c]) = (lay[(3)]) * (in[(3)]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else (out[c]) = (in[c]) + (lay[c]); };
        ...
        case GIMP_SUBTRACT_MODE:
          ...
          for (c = 0; c < 3; c++) { if ((in[c]) * (lay[(3)]) - (lay[c]) * (in[(3)]) <= 0) (out[c]) = (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else (out[c]) = (in[c]) + (lay[c]) - 2 * (lay[c]) * (in[(3)]); };
...
# 491 "gimpoperationpointlayermode.c"
          for (c = 0; c < 3; c++) { if ((in[c]) * (lay[(3)]) - (lay[c]) * (in[(3)]) + 0.5 * (lay[(3)]) * (in[(3)]) >= (lay[(3)]) * (in[(3)])) (out[c]) = (lay[(3)]) * (in[(3)]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else if ((in[c]) * (lay[(3)]) - (lay[c]) * (in[(3)]) + 0.5 * (lay[(3)]) * (in[(3)]) <= 0) (out[c]) = (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else (out[c]) = (in[c]) + (lay[c]) - 2 * (lay[c]) * (in[(3)]) + 0.5 * (in[(3)]) * (lay[(3)]); };
...
# 510 "gimpoperationpointlayermode.c"
          for (c = 0; c < 3; c++) { if ((in[c]) * (lay[(3)]) + (lay[c]) * (in[(3)]) - 0.5 * (lay[(3)]) * (in[(3)]) >= (lay[(3)]) * (in[(3)])) (out[c]) = (lay[(3)]) * (in[(3)]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else if ((in[c]) * (lay[(3)]) + (lay[c]) * (in[(3)]) - 0.5 * (lay[(3)]) * (in[(3)]) <= 0) (out[c]) = (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else (out[c]) = (in[c]) + (lay[c]) - 0.5 * (in[(3)]) * (lay[(3)]); };
        ...
        case GIMP_DIVIDE_MODE:
          ...
          for (c = 0; c < 3; c++) { if ((lay[(3)]) == 0.0 || (in[c]) / (lay[c]) > (in[(3)]) / (lay[(3)])) (out[c]) = (lay[(3)]) * (in[(3)]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); else (out[c]) = (in[c]) * (lay[(3)]) * (lay[(3)]) / (lay[c]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); };
        ...
        case GIMP_COLOR_MODE:
        case GIMP_VALUE_MODE:
# 546 "gimpoperationpointlayermode.c"
          gimp_operation_point_layer_mode_get_new_color_lchab (blend_mode,
                                                               in,
                                                               lay,
                                                               new);
          for (c = 0; c < 3; c++) { (out[c]) = (new[c]) * (lay[(3)]) * (in[(3)]) + (lay[c]) * (1 - (in[(3)])) + (in[c]) * (1 - (lay[(3)])); };
