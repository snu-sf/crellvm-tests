# 1 "gimpcolorizeconfig.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpcolorizeconfig.c" 2
# 21 "gimpcolorizeconfig.c"
# 1 "../../config.h" 1
# 22 "gimpcolorizeconfig.c" 2
...
# 28 "gimpcolorizeconfig.c" 2


# 1 "../../app/base/colorize.h" 1
# 22 "../../app/base/colorize.h"
struct _Colorize
{
  gdouble hue;
  gdouble saturation;
...
void colorize (Colorize *colorize,
                           PixelRegion *srcPR,
                           PixelRegion *destPR);
# 31 "gimpcolorizeconfig.c" 2

# 1 "./gimpcolorizeconfig.h" 1
# 25 "./gimpcolorizeconfig.h"
# 1 "../../app/core/gimpimagemapconfig.h" 1
# 25 "../../app/core/gimpimagemapconfig.h"
...
# 26 "../../app/core/gimpimagemapconfig.h" 2
# 36 "../../app/core/gimpimagemapconfig.h"
...
GType gimp_image_map_config_get_type (void) __attribute__((__const__));

gint gimp_image_map_config_compare (GimpImageMapConfig *a,
                                        GimpImageMapConfig *b);
# 26 "./gimpcolorizeconfig.h" 2
# 36 "./gimpcolorizeconfig.h"
...
GType gimp_colorize_config_get_type (void) __attribute__((__const__));


void gimp_colorize_config_to_cruft (GimpColorizeConfig *config,
                                       Colorize *cruft);
# 33 "gimpcolorizeconfig.c" 2
...
static void gimp_colorize_config_init (GimpColorizeConfig *self); static void gimp_colorize_config_class_init (GimpColorizeConfigClass *klass); static gpointer gimp_colorize_config_parent_class = ((void*)0); static gint GimpColorizeConfig_private_offset; static void gimp_colorize_config_class_intern_init (gpointer klass) { gimp_colorize_config_parent_class = g_type_class_peek_parent (klass); if (GimpColorizeConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpColorizeConfig_private_offset); gimp_colorize_config_class_init ((GimpColorizeConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_colorize_config_get_instance_private (GimpColorizeConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpColorizeConfig_private_offset)))); } GType gimp_colorize_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_image_map_config_get_type ()), g_intern_static_string ("GimpColorizeConfig"), sizeof (GimpColorizeConfigClass), (GClassInitFunc) gimp_colorize_config_class_intern_init, sizeof (GimpColorizeConfig), (GInstanceInitFunc) gimp_colorize_config_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) gimp_colorize_config_iface_init, ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_colorize_config_class_init (GimpColorizeConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_HUE, g_param_spec_double ("hue", ((void*)0), "Hue", 0.0, 1.0, 0.5, 0 | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_SATURATION, g_param_spec_double ("saturation", ((void*)0), "Saturation", 0.0, 1.0, 0.5, 0 | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_LIGHTNESS, g_param_spec_double ("lightness", ((void*)0), "Lightness", -1.0, 1.0, 0.0, 0 | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_colorize_config_get_property (GObject *object,
                                   ...
                                   GParamSpec *pspec)
{
  GimpColorizeConfig *self = ((((GimpColorizeConfig*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_colorize_config_get_type ()))))));
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpcolorizeconfig.c", 128, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                   ...
                                   GParamSpec *pspec)
{
  ...
  switch (property_id)
   ...
   default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpcolorizeconfig.c", 156, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
gimp_colorize_config_to_cruft (GimpColorizeConfig *config,
                               Colorize *cruft)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((config)); GType __t = ((gimp_colorize_config_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-GEGL", ((const char*) (__func__)), "GIMP_IS_COLORIZE_CONFIG (config)"); return; }; }while (0);
  do{ if (cruft != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-GEGL", ((const char*) (__func__)), "cruft != NULL"); return; }; }while (0);
...
gimp_colorize_config_equal (GimpConfig *a,
                            GimpConfig *b)
{
  GimpColorizeConfig *config_a = ((((GimpColorizeConfig*) g_type_check_instance_cast ((GTypeInstance*) ((a)), ((gimp_colorize_config_get_type ()))))));
  GimpColorizeConfig *config_b = ((((GimpColorizeConfig*) g_type_check_instance_cast ((GTypeInstance*) ((b)), ((gimp_colorize_config_get_type ()))))));
