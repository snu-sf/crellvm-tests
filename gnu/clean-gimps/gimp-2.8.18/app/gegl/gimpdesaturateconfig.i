# 1 "gimpdesaturateconfig.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpdesaturateconfig.c" 2
# 21 "gimpdesaturateconfig.c"
# 1 "../../config.h" 1
# 22 "gimpdesaturateconfig.c" 2
...
# 28 "gimpdesaturateconfig.c" 2

# 1 "./gimpdesaturateconfig.h" 1
# 25 "./gimpdesaturateconfig.h"
...
# 26 "./gimpdesaturateconfig.h" 2
# 36 "./gimpdesaturateconfig.h"
...
GType gimp_desaturate_config_get_type (void) __attribute__((__const__));
# 30 "gimpdesaturateconfig.c" 2
...
static void gimp_desaturate_config_init (GimpDesaturateConfig *self); static void gimp_desaturate_config_class_init (GimpDesaturateConfigClass *klass); static gpointer gimp_desaturate_config_parent_class = ((void*)0); static gint GimpDesaturateConfig_private_offset; static void gimp_desaturate_config_class_intern_init (gpointer klass) { gimp_desaturate_config_parent_class = g_type_class_peek_parent (klass); if (GimpDesaturateConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpDesaturateConfig_private_offset); gimp_desaturate_config_class_init ((GimpDesaturateConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_desaturate_config_get_instance_private (GimpDesaturateConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpDesaturateConfig_private_offset)))); } GType gimp_desaturate_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_image_map_config_get_type ()), g_intern_static_string ("GimpDesaturateConfig"), sizeof (GimpDesaturateConfigClass), (GClassInitFunc) gimp_desaturate_config_class_intern_init, sizeof (GimpDesaturateConfig), (GInstanceInitFunc) gimp_desaturate_config_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) ((void*)0), ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_desaturate_config_class_init (GimpDesaturateConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_MODE, g_param_spec_enum ("mode", ((void*)0), "Desaturate mode", (gimp_desaturate_mode_get_type ()), GIMP_DESATURATE_LIGHTNESS, 0 | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_desaturate_config_get_property (GObject *object,
                                     ...
                                     GParamSpec *pspec)
{
  GimpDesaturateConfig *self = ((((GimpDesaturateConfig*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_desaturate_config_get_type ()))))));
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpdesaturateconfig.c", 95, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                     ...
                                     GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpdesaturateconfig.c", 115, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
