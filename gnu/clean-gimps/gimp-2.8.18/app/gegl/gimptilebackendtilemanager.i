# 1 "gimptilebackendtilemanager.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimptilebackendtilemanager.c" 2
# 21 "gimptilebackendtilemanager.c"
# 1 "../../config.h" 1
# 22 "gimptilebackendtilemanager.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 24 "gimptilebackendtilemanager.c" 2
...
# 26 "gimptilebackendtilemanager.c" 2

# 1 "/usr/include/gegl-0.2/gegl-tile.h" 1
# 23 "/usr/include/gegl-0.2/gegl-tile.h"
# 1 "/usr/include/gegl-0.2/gegl-buffer-backend.h" 1
# 23 "/usr/include/gegl-0.2/gegl-buffer-backend.h"
...
# 1 "/usr/include/gegl-0.2/gegl-tile-backend.h" 1
# 22 "/usr/include/gegl-0.2/gegl-tile-backend.h"
# 1 "/usr/include/gegl-0.2/gegl-tile-source.h" 1
# 24 "/usr/include/gegl-0.2/gegl-tile-source.h"
# 1 "/usr/include/gegl-0.2/gegl-tile.h" 1
# 25 "/usr/include/gegl-0.2/gegl-tile-source.h" 2
# 41 "/usr/include/gegl-0.2/gegl-tile-source.h"
...
GType gegl_tile_source_get_type (void) __attribute__((__const__));
...
# 23 "/usr/include/gegl-0.2/gegl-tile-backend.h" 2
# 38 "/usr/include/gegl-0.2/gegl-tile-backend.h"
...
GType gegl_tile_backend_get_type (void) __attribute__((__const__));
# 39 "/usr/include/gegl-0.2/gegl-buffer-backend.h" 2

# 1 "/usr/include/gegl-0.2/gegl-tile.h" 1
# 41 "/usr/include/gegl-0.2/gegl-buffer-backend.h" 2
# 24 "/usr/include/gegl-0.2/gegl-tile.h" 2
...
# 28 "gimptilebackendtilemanager.c" 2
...
# 30 "gimptilebackendtilemanager.c" 2
...
# 32 "gimptilebackendtilemanager.c" 2
...
void tile_detach (Tile *tile,
                                  void *tm,
                                  gint tile_num);
# 34 "gimptilebackendtilemanager.c" 2
...
void tile_manager_write_pixel_data_1 (TileManager *tm,
                                                 ...
                                                 gint y,
                                                 const guchar *buffer);
# 35 "gimptilebackendtilemanager.c" 2

# 1 "./gimptilebackendtilemanager.h" 1
# 35 "./gimptilebackendtilemanager.h"
...
GType gimp_tile_backend_tile_manager_get_type (void) __attribute__((__const__));
...
GeglBuffer * gimp_tile_manager_get_gegl_buffer (TileManager *tm,
                                                      gboolean write);
# 37 "gimptilebackendtilemanager.c" 2
...
# 38 "gimptilebackendtilemanager.c" 2
...
static void gimp_tile_backend_tile_manager_init (GimpTileBackendTileManager *self); static void gimp_tile_backend_tile_manager_class_init (GimpTileBackendTileManagerClass *klass); static gpointer gimp_tile_backend_tile_manager_parent_class = ((void*)0); static gint GimpTileBackendTileManager_private_offset; static void gimp_tile_backend_tile_manager_class_intern_init (gpointer klass) { gimp_tile_backend_tile_manager_parent_class = g_type_class_peek_parent (klass); if (GimpTileBackendTileManager_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpTileBackendTileManager_private_offset); gimp_tile_backend_tile_manager_class_init ((GimpTileBackendTileManagerClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_tile_backend_tile_manager_get_instance_private (GimpTileBackendTileManager *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpTileBackendTileManager_private_offset)))); } GType gimp_tile_backend_tile_manager_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gegl_tile_backend_get_type ()), g_intern_static_string ("GimpTileBackendTileManager"), sizeof (GimpTileBackendTileManagerClass), (GClassInitFunc) gimp_tile_backend_tile_manager_class_intern_init, sizeof (GimpTileBackendTileManager), (GInstanceInitFunc) gimp_tile_backend_tile_manager_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GeglTileSource *source = ((((GeglTileSource*) g_type_check_instance_cast ((GTypeInstance*) ((backend)), ((gegl_tile_source_get_type ()))))));

  backend->priv = ((GimpTileBackendTileManagerPrivate*) g_type_instance_get_private ((GTypeInstance*) (backend), ((gimp_tile_backend_tile_manager_get_type ()))));
...
{
  GimpTileBackendTileManager *backend = ((((GimpTileBackendTileManager*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_tile_backend_tile_manager_get_type ()))))));

  if (backend->priv->tile_manager)
    {
      tile_manager_unref (backend->priv->tile_manager);
      backend->priv->tile_manager = ((void*)0);
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_tile_backend_tile_manager_parent_class)), (((GType) ((20) << (2))))))))->dispose (object);
}

static void
gimp_tile_backend_tile_manager_finalize (GObject *object)
{
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_tile_backend_tile_manager_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                                        ...
                                        gpointer data)
{
  ...
  backend_tm = ((((GimpTileBackendTileManager*) g_type_check_instance_cast ((GTypeInstance*) ((tile_store)), ((gimp_tile_backend_tile_manager_get_type ()))))));
  backend = ((((GeglTileBackend*) g_type_check_instance_cast ((GTypeInstance*) ((tile_store)), ((gegl_tile_backend_get_type ()))))));
  ...
  switch (command)
    ...
    case GEGL_TILE_GET:
      {
        ...
        gimp_tile = tile_manager_get_at (backend_tm->priv->tile_manager,
                                         x, y, (!(0)), backend_tm->priv->write);
        if (!gimp_tile)
          return ((void*)0);
        do{ if (gimp_tile != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-GEGL", ((const char*) (__func__)), "gimp_tile != NULL"); return (((void*)0)); }; }while (0);

        tile_size = gegl_tile_backend_get_tile_size (backend);
        tile_stride = 64 * tile_bpp (gimp_tile);
    ...
    default:
      do { if (command < GEGL_TILE_LAST_COMMAND && command >= 0) ; else g_assertion_message_expr ("Gimp-GEGL", "gimptilebackendtilemanager.c", 194, ((const char*) (__func__)), "command < GEGL_TILE_LAST_COMMAND && command >= 0"); } while (0);
    }
                                    ...
                                    gboolean write)
{
  ...
  ret = g_object_new ((gimp_tile_backend_tile_manager_get_type ()),
                      "tile-width", 64,
                      "tile-height", 64,
                      "format", gimp_bpp_to_babl_format (bpp, (0)),
                      ((void*)0));
  backend_tm = ((((GimpTileBackendTileManager*) g_type_check_instance_cast ((GTypeInstance*) ((ret)), ((gimp_tile_backend_tile_manager_get_type ()))))));
                                   ...
                                   gboolean write)
{
  ...
  buffer = gegl_buffer_new_for_backend (((void*)0), backend);
