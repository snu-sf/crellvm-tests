# 1 "gimpoperationdifferencemode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpoperationdifferencemode.c" 2
# 22 "gimpoperationdifferencemode.c"
# 1 "../../config.h" 1
# 23 "gimpoperationdifferencemode.c" 2
...
# 25 "gimpoperationdifferencemode.c" 2
...
# 27 "gimpoperationdifferencemode.c" 2

# 1 "./gimpoperationdifferencemode.h" 1
# 26 "./gimpoperationdifferencemode.h"
...
# 27 "./gimpoperationdifferencemode.h" 2
...
# 29 "gimpoperationdifferencemode.c" 2
...
static void gimp_operation_difference_mode_init (GimpOperationDifferenceMode *self); static void gimp_operation_difference_mode_class_init (GimpOperationDifferenceModeClass *klass); static gpointer gimp_operation_difference_mode_parent_class = ((void*)0); static gint GimpOperationDifferenceMode_private_offset; static void gimp_operation_difference_mode_class_intern_init (gpointer klass) { gimp_operation_difference_mode_parent_class = g_type_class_peek_parent (klass); if (GimpOperationDifferenceMode_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpOperationDifferenceMode_private_offset); gimp_operation_difference_mode_class_init ((GimpOperationDifferenceModeClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_operation_difference_mode_get_instance_private (GimpOperationDifferenceMode *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpOperationDifferenceMode_private_offset)))); } GType gimp_operation_difference_mode_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_operation_point_layer_mode_get_type ()), g_intern_static_string ("GimpOperationDifferenceMode"), sizeof (GimpOperationDifferenceModeClass), (GClassInitFunc) gimp_operation_difference_mode_class_intern_init, sizeof (GimpOperationDifferenceMode), (GInstanceInitFunc) gimp_operation_difference_mode_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
