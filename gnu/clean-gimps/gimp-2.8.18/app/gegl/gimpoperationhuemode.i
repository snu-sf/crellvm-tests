# 1 "gimpoperationhuemode.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpoperationhuemode.c" 2
# 22 "gimpoperationhuemode.c"
# 1 "../../config.h" 1
# 23 "gimpoperationhuemode.c" 2
...
# 27 "gimpoperationhuemode.c" 2

# 1 "./gimpoperationhuemode.h" 1
# 26 "./gimpoperationhuemode.h"
...
static void gimp_operation_hue_mode_init (GimpOperationHueMode *self); static void gimp_operation_hue_mode_class_init (GimpOperationHueModeClass *klass); static gpointer gimp_operation_hue_mode_parent_class = ((void*)0); static gint GimpOperationHueMode_private_offset; static void gimp_operation_hue_mode_class_intern_init (gpointer klass) { gimp_operation_hue_mode_parent_class = g_type_class_peek_parent (klass); if (GimpOperationHueMode_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpOperationHueMode_private_offset); gimp_operation_hue_mode_class_init ((GimpOperationHueModeClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_operation_hue_mode_get_instance_private (GimpOperationHueMode *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpOperationHueMode_private_offset)))); } GType gimp_operation_hue_mode_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_operation_point_layer_mode_get_type ()), g_intern_static_string ("GimpOperationHueMode"), sizeof (GimpOperationHueModeClass), (GClassInitFunc) gimp_operation_hue_mode_class_intern_init, sizeof (GimpOperationHueMode), (GInstanceInitFunc) gimp_operation_hue_mode_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
