# 1 "gimpoperationpointfilter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpoperationpointfilter.c" 2
# 21 "gimpoperationpointfilter.c"
# 1 "../../config.h" 1
# 22 "gimpoperationpointfilter.c" 2
...
# 24 "gimpoperationpointfilter.c" 2
...
# 26 "gimpoperationpointfilter.c" 2
...
void gimp_operation_point_filter_set_property (GObject *object,
                                                  ...
                                                  const GValue *value,
                                                  GParamSpec *pspec);
# 28 "gimpoperationpointfilter.c" 2
...
static void gimp_operation_point_filter_init (GimpOperationPointFilter *self); static void gimp_operation_point_filter_class_init (GimpOperationPointFilterClass *klass); static gpointer gimp_operation_point_filter_parent_class = ((void*)0); static gint GimpOperationPointFilter_private_offset; static void gimp_operation_point_filter_class_intern_init (gpointer klass) { gimp_operation_point_filter_parent_class = g_type_class_peek_parent (klass); if (GimpOperationPointFilter_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpOperationPointFilter_private_offset); gimp_operation_point_filter_class_init ((GimpOperationPointFilterClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_operation_point_filter_get_instance_private (GimpOperationPointFilter *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpOperationPointFilter_private_offset)))); } GType gimp_operation_point_filter_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gegl_operation_point_filter_get_type ()), g_intern_static_string ("GimpOperationPointFilter"), sizeof (GimpOperationPointFilterClass), (GClassInitFunc) gimp_operation_point_filter_class_intern_init, sizeof (GimpOperationPointFilter), (GInstanceInitFunc) gimp_operation_point_filter_init, (GTypeFlags) G_TYPE_FLAG_ABSTRACT); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpOperationPointFilter *self = ((((GimpOperationPointFilter*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_operation_point_filter_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_operation_point_filter_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                                          ...
                                          GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpoperationpointfilter.c", 85, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                          ...
                                          GParamSpec *pspec)
{
  ...
  switch (property_id)
   ...
   default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpoperationpointfilter.c", 107, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
