...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-gegl-utils.c" 2
# 21 "gimp-gegl-utils.c"
# 1 "../../config.h" 1
# 22 "gimp-gegl-utils.c" 2
...
# 30 "gimp-gegl-utils.c" 2
# 42 "gimp-gegl-utils.c"
const Babl *
gimp_bpp_to_babl_format (guint bpp,
                         gboolean linear)
{
  do{ if (bpp > 0 && bpp <= 4) { } else { g_return_if_fail_warning ("Gimp-GEGL", ((const char*) (__func__)), "bpp > 0 && bpp <= 4"); return (((void*)0)); }; }while (0);
...
gimp_buffer_to_tiles (GeglBuffer *buffer)
{
  ...
  TileManager *new_tiles = ((void*)0);
  GeglNode *source = ((void*)0);
  GeglNode *sink = ((void*)0);

  do{ if (buffer != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-GEGL", ((const char*) (__func__)), "buffer != NULL"); return (((void*)0)); }; }while (0);


  new_tiles = tile_manager_new ((gegl_buffer_get_extent(buffer)->width),
                                (gegl_buffer_get_extent(buffer)->height),
                                gimp_babl_format_to_legacy_bpp (format));
  source = gegl_node_new_child (((void*)0),
                                "operation", "gegl:buffer-source",
                                "buffer", buffer,
                                ((void*)0));
  sink = gegl_node_new_child (((void*)0),
                              "operation", "gimp:tilemanager-sink",
                              "tile-manager", new_tiles,
                              ((void*)0));
  gegl_node_link_many (source, sink, ((void*)0));
