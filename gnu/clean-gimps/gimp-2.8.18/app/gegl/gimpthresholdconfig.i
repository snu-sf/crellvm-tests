# 1 "gimpthresholdconfig.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpthresholdconfig.c" 2
# 21 "gimpthresholdconfig.c"
# 1 "../../config.h" 1
# 22 "gimpthresholdconfig.c" 2
...
# 28 "gimpthresholdconfig.c" 2


# 1 "../../app/base/threshold.h" 1
# 22 "../../app/base/threshold.h"
struct _Threshold
{
  gboolean color;
  gint low_threshold;
...
void threshold (Threshold *tr,
                    PixelRegion *srcPR,
                    PixelRegion *destPR);
# 31 "gimpthresholdconfig.c" 2

# 1 "./gimpthresholdconfig.h" 1
# 25 "./gimpthresholdconfig.h"
...
# 26 "./gimpthresholdconfig.h" 2
# 36 "./gimpthresholdconfig.h"
...
GType gimp_threshold_config_get_type (void) __attribute__((__const__));


void gimp_threshold_config_to_cruft (GimpThresholdConfig *config,
                                        Threshold *cruft,
                                        gboolean color);
# 33 "gimpthresholdconfig.c" 2
...
static void gimp_threshold_config_init (GimpThresholdConfig *self); static void gimp_threshold_config_class_init (GimpThresholdConfigClass *klass); static gpointer gimp_threshold_config_parent_class = ((void*)0); static gint GimpThresholdConfig_private_offset; static void gimp_threshold_config_class_intern_init (gpointer klass) { gimp_threshold_config_parent_class = g_type_class_peek_parent (klass); if (GimpThresholdConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpThresholdConfig_private_offset); gimp_threshold_config_class_init ((GimpThresholdConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_threshold_config_get_instance_private (GimpThresholdConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpThresholdConfig_private_offset)))); } GType gimp_threshold_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_image_map_config_get_type ()), g_intern_static_string ("GimpThresholdConfig"), sizeof (GimpThresholdConfigClass), (GClassInitFunc) gimp_threshold_config_class_intern_init, sizeof (GimpThresholdConfig), (GInstanceInitFunc) gimp_threshold_config_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) gimp_threshold_config_iface_init, ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_threshold_config_class_init (GimpThresholdConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_LOW, g_param_spec_double ("low", ((void*)0), "Low threshold", 0.0, 1.0, 0.5, 0 | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_HIGH, g_param_spec_double ("high", ((void*)0), "High threshold", 0.0, 1.0, 1.0, 0 | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_threshold_config_get_property (GObject *object,
                                    ...
                                    GParamSpec *pspec)
{
  GimpThresholdConfig *self = ((((GimpThresholdConfig*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_threshold_config_get_type ()))))));
                                    ...
                                    GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpthresholdconfig.c", 142, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
gimp_threshold_config_equal (GimpConfig *a,
                             GimpConfig *b)
{
  GimpThresholdConfig *config_a = ((((GimpThresholdConfig*) g_type_check_instance_cast ((GTypeInstance*) ((a)), ((gimp_threshold_config_get_type ()))))));
  GimpThresholdConfig *config_b = ((((GimpThresholdConfig*) g_type_check_instance_cast ((GTypeInstance*) ((b)), ((gimp_threshold_config_get_type ()))))));
...
gimp_threshold_config_to_cruft (GimpThresholdConfig *config,
                                ...
                                gboolean color)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((config)); GType __t = ((gimp_threshold_config_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-GEGL", ((const char*) (__func__)), "GIMP_IS_THRESHOLD_CONFIG (config)"); return; }; }while (0);
