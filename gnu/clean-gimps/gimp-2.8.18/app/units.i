...
# 23 "units.c" 2
# 1 "../libgimpbase/gimpbase-private.h" 1
# 26 "../libgimpbase/gimpbase-private.h"
...
static Gimp *the_unit_gimp = ((void*)0);
...
units_init (Gimp *gimp)
{
  ...
  do{ if (the_unit_gimp == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp", ((const char*) (__func__)), "the_unit_gimp == NULL"); return; }; }while (0);
