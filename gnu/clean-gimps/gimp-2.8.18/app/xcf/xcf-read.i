         ...
         ...)
{
  ...
  g_logv ("Gimp-XCF", G_LOG_LEVEL_ERROR, format, args);
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-XCF", G_LOG_LEVEL_MESSAGE, format, args);
  __builtin_va_end(args);
}
static void
            ...
            ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-XCF", G_LOG_LEVEL_CRITICAL, format, args);
  __builtin_va_end(args);
}
static void
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-XCF", G_LOG_LEVEL_WARNING, format, args);
  __builtin_va_end(args);
}
static void
        ...
        ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-XCF", G_LOG_LEVEL_INFO, format, args);
  __builtin_va_end(args);
}
static void
         ...
         ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-XCF", G_LOG_LEVEL_DEBUG, format, args);
  __builtin_va_end(args);
}
  ...
  if (count > 0)
    {
      ...
      while (count--)
        {
          *data = ((((((guint32) ( (((guint32) (*data) & (guint32) 0x000000ffU) << 24) | (((guint32) (*data) & (guint32) 0x0000ff00U) << 8) | (((guint32) (*data) & (guint32) 0x00ff0000U) >> 8) | (((guint32) (*data) & (guint32) 0xff000000U) >> 24)))))));
          data++;
        }
    }
  ...
  for (i = 0; i < count; i++)
    {
      ...
      if (tmp > (16L * 1024 * 1024))
        {
          g_warning ("Maximum string length (%ld bytes) exceeded. "
                     "Possibly corrupt XCF file.", (16L * 1024 * 1024));
          data[i] = ((void*)0);
        }
      else if (tmp > 0)
        {
          ...
          str = ((gchar *) g_malloc_n ((tmp), sizeof (gchar)));
          ...
          data[i] = gimp_any_to_utf8 (str, -1,
                                      gettext ("Invalid UTF-8 string in XCF file"));
