...
static Gimp *the_errors_gimp = ((void*)0);
static gboolean use_debug_handler = (0);
static GimpStackTraceMode stack_trace_mode = GIMP_STACK_TRACE_QUERY;
static gchar *full_prog_name = ((void*)0);




static __attribute__((__noreturn__)) void gimp_eek (const gchar *reason,
                                       const gchar *message,
...
static void gimp_error_log_func (const gchar *domain,
                                     GLogLevelFlags flags,
                                     const gchar *message,
                                     gpointer data) __attribute__((__noreturn__));
             ...
             GimpStackTraceMode _stack_trace_mode)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((gimp)); GType __t = ((gimp_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp", ((const char*) (__func__)), "GIMP_IS_GIMP (gimp)"); return; }; }while (0);
  do{ if (_full_prog_name != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp", ((const char*) (__func__)), "_full_prog_name != NULL"); return; }; }while (0);
  do{ if (full_prog_name == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp", ((const char*) (__func__)), "full_prog_name == NULL"); return; }; }while (0);
  ...
  use_debug_handler = _use_debug_handler ? (!(0)) : (0);
  stack_trace_mode = _stack_trace_mode;
  full_prog_name = g_strdup (_full_prog_name);

  for (i = 0; i < (sizeof (log_domains) / sizeof ((log_domains)[0])); i++)
    g_log_set_handler (log_domains[i],
                       G_LOG_LEVEL_MESSAGE,
                       gimp_message_log_func, gimp);

  g_log_set_handler (((void*)0),
...
errors_exit (void)
{
  the_errors_gimp = ((void*)0);
}

void
gimp_fatal_error (const gchar *message)
{
  gimp_eek ("fatal error", message, (!(0)));
}
                       ...
                       gpointer data)
{
  ...
  if (gimp)
    {
      gimp_show_message (gimp, ((void*)0), GIMP_MESSAGE_WARNING, ((void*)0), message);
    }
  else
    {
      g_printerr ("%s: %s\n\n",
