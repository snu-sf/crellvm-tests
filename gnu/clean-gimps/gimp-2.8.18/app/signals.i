...
static void gimp_sigfatal_handler (gint sig_num) __attribute__((__noreturn__));
...
{
# 51 "signals.c"
  gimp_signal_private (1, gimp_sigfatal_handler, 0);
  gimp_signal_private (2, gimp_sigfatal_handler, 0);
  gimp_signal_private (3, gimp_sigfatal_handler, 0);
  gimp_signal_private (6, gimp_sigfatal_handler, 0);
  gimp_signal_private (15, gimp_sigfatal_handler, 0);

  if (stack_trace_mode != GIMP_STACK_TRACE_NEVER)
    {

      gimp_signal_private (7, gimp_sigfatal_handler, 0);
      gimp_signal_private (11, gimp_sigfatal_handler, 0);
      gimp_signal_private (8, gimp_sigfatal_handler, 0);
    }


  gimp_signal_private (13, ((__sighandler_t) 1), 0);


  gimp_signal_private (17, ((__sighandler_t) 0), 0x10000000);
