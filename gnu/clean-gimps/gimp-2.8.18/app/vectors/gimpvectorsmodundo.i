# 1 "gimpvectorsmodundo.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpvectorsmodundo.c" 2
# 18 "gimpvectorsmodundo.c"
# 1 "../../config.h" 1
# 19 "gimpvectorsmodundo.c" 2
...
# 23 "gimpvectorsmodundo.c" 2

# 1 "./gimpvectors.h" 1
# 24 "./gimpvectors.h"
# 1 "../../app/core/gimpitem.h" 1
# 22 "../../app/core/gimpitem.h"
# 1 "../../app/core/gimpviewable.h" 1
# 25 "../../app/core/gimpviewable.h"
...
# 28 "../../app/core/gimpviewable.h" 2
# 46 "../../app/core/gimpviewable.h"
...
# 23 "../../app/core/gimpitem.h" 2
# 33 "../../app/core/gimpitem.h"
...
GType gimp_item_get_type (void) __attribute__((__const__));
...
GType gimp_vectors_get_type (void) __attribute__((__const__));
...
# 25 "gimpvectorsmodundo.c" 2
# 1 "./gimpvectorsmodundo.h" 1
# 22 "./gimpvectorsmodundo.h"
# 1 "../../app/core/gimpitemundo.h" 1
# 22 "../../app/core/gimpitemundo.h"
# 1 "../../app/core/gimpundo.h" 1
# 25 "../../app/core/gimpundo.h"
...
GType gimp_undo_get_type (void) __attribute__((__const__));
...
# 23 "../../app/core/gimpitemundo.h" 2
# 33 "../../app/core/gimpitemundo.h"
...
GType gimp_item_undo_get_type (void) __attribute__((__const__));
# 23 "./gimpvectorsmodundo.h" 2
# 33 "./gimpvectorsmodundo.h"
...
GType gimp_vectors_mod_undo_get_type (void) __attribute__((__const__));
# 26 "gimpvectorsmodundo.c" 2
...
static void gimp_vectors_mod_undo_init (GimpVectorsModUndo *self); static void gimp_vectors_mod_undo_class_init (GimpVectorsModUndoClass *klass); static gpointer gimp_vectors_mod_undo_parent_class = ((void*)0); static gint GimpVectorsModUndo_private_offset; static void gimp_vectors_mod_undo_class_intern_init (gpointer klass) { gimp_vectors_mod_undo_parent_class = g_type_class_peek_parent (klass); if (GimpVectorsModUndo_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpVectorsModUndo_private_offset); gimp_vectors_mod_undo_class_init ((GimpVectorsModUndoClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_vectors_mod_undo_get_instance_private (GimpVectorsModUndo *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpVectorsModUndo_private_offset)))); } GType gimp_vectors_mod_undo_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_item_undo_get_type ()), g_intern_static_string ("GimpVectorsModUndo"), sizeof (GimpVectorsModUndoClass), (GClassInitFunc) gimp_vectors_mod_undo_class_intern_init, sizeof (GimpVectorsModUndo), (GInstanceInitFunc) gimp_vectors_mod_undo_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_vectors_mod_undo_class_init (GimpVectorsModUndoClass *klass)
{
  ...
  GimpUndoClass *undo_class = ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gimp_undo_get_type ()))))));
...
{
  GimpVectorsModUndo *vectors_mod_undo = ((((GimpVectorsModUndo*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_vectors_mod_undo_get_type ()))))));
  GimpVectors *vectors;

  if (((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_vectors_mod_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed)
    ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_vectors_mod_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed (object);

  do { if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((((((GimpItemUndo*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_item_undo_get_type ()))))))->item)); GType __t = ((gimp_vectors_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) ; else g_assertion_message_expr ("Gimp-Vectors", "gimpvectorsmodundo.c", 74, ((const char*) (__func__)), "GIMP_IS_VECTORS (GIMP_ITEM_UNDO (object)->item)"); } while (0);

  vectors = ((((GimpVectors*) g_type_check_instance_cast ((GTypeInstance*) ((((((GimpItemUndo*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_item_undo_get_type ()))))))->item)), ((gimp_vectors_get_type ()))))));

  vectors_mod_undo->vectors =
    ((((GimpVectors*) g_type_check_instance_cast ((GTypeInstance*) ((gimp_item_duplicate (((((GimpItem*) g_type_check_instance_cast ((GTypeInstance*) ((vectors)), ((gimp_item_get_type ())))))), ((((GTypeClass*) (((GTypeInstance*) (vectors))->g_class))->g_type))))), ((gimp_vectors_get_type ()))))));
                                   ...
                                   gint64 *gui_size)
{
  ...
  memsize += gimp_object_get_memsize (((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((vectors_mod_undo->vectors)), ((gimp_object_get_type ())))))),
                                      gui_size);

  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_vectors_mod_undo_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
...
gimp_vectors_mod_undo_pop (GimpUndo *undo,
                           ...
                           GimpUndoAccumulator *accum)
{
  GimpVectorsModUndo *vectors_mod_undo = ((((GimpVectorsModUndo*) g_type_check_instance_cast ((GTypeInstance*) ((undo)), ((gimp_vectors_mod_undo_get_type ()))))));
  GimpVectors *vectors = ((((GimpVectors*) g_type_check_instance_cast ((GTypeInstance*) ((((((GimpItemUndo*) g_type_check_instance_cast ((GTypeInstance*) ((undo)), ((gimp_item_undo_get_type ()))))))->item)), ((gimp_vectors_get_type ()))))));
  GimpVectors *temp;
  gint offset_x;
  gint offset_y;

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_vectors_mod_undo_parent_class)), ((gimp_undo_get_type ()))))))->pop (undo, undo_mode, accum);
  ...
  gimp_item_get_offset (((((GimpItem*) g_type_check_instance_cast ((GTypeInstance*) ((temp)), ((gimp_item_get_type ())))))), &offset_x, &offset_y);
  gimp_item_set_offset (((((GimpItem*) g_type_check_instance_cast ((GTypeInstance*) ((vectors)), ((gimp_item_get_type ())))))), offset_x, offset_y);

  gimp_item_set_size (((((GimpItem*) g_type_check_instance_cast ((GTypeInstance*) ((vectors)), ((gimp_item_get_type ())))))),
                      gimp_item_get_width (((((GimpItem*) g_type_check_instance_cast ((GTypeInstance*) ((temp)), ((gimp_item_get_type ()))))))),
                      gimp_item_get_height (((((GimpItem*) g_type_check_instance_cast ((GTypeInstance*) ((temp)), ((gimp_item_get_type ()))))))));
  ...
  if (vectors_mod_undo->vectors)
    {
      ...
      vectors_mod_undo->vectors = ((void*)0);
    }

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_vectors_mod_undo_parent_class)), ((gimp_undo_get_type ()))))))->free (undo, undo_mode);
}
