...
gimp_anchor_new (GimpAnchorType type,
                 const GimpCoords *position)
{
  GimpAnchor *anchor = ((GimpAnchor*) g_slice_alloc0 (sizeof (GimpAnchor)));
...
{
  do{ if (anchor != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Vectors", ((const char*) (__func__)), "anchor != NULL"); return (((void*)0)); }; }while (0);

  return (1 ? (GimpAnchor*) g_slice_copy (sizeof (GimpAnchor), (anchor)) : ((void) ((GimpAnchor*) 0 == (anchor)), (GimpAnchor*) 0));
}
...
gimp_anchor_free (GimpAnchor *anchor)
{
  ...
  do { if (1) g_slice_free1 (sizeof (GimpAnchor), (anchor)); else (void) ((GimpAnchor*) 0 == (anchor)); } while (0);
}
