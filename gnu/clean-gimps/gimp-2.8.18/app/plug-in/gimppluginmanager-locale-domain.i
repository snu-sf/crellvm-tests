# 1 "gimppluginmanager-locale-domain.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppluginmanager-locale-domain.c" 2
# 20 "gimppluginmanager-locale-domain.c"
# 1 "../../config.h" 1
# 21 "gimppluginmanager-locale-domain.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 23 "gimppluginmanager-locale-domain.c" 2
...
# 25 "gimppluginmanager-locale-domain.c" 2
...
# 27 "gimppluginmanager-locale-domain.c" 2
...
# 29 "gimppluginmanager-locale-domain.c" 2
...
# 31 "gimppluginmanager-locale-domain.c" 2
# 1 "./gimppluginmanager-locale-domain.h" 1
# 24 "./gimppluginmanager-locale-domain.h"
...
gint gimp_plug_in_manager_get_locale_domains (GimpPlugInManager *manager,
                                                       ...
                                                       gchar ***locale_paths);
# 32 "gimppluginmanager-locale-domain.c" 2
  ...
  for (list = manager->locale_domains; list; list = list->next)
    {
      ...
      do { if (1) g_slice_free1 (sizeof (GimpPlugInLocaleDomain), (domain)); else (void) ((GimpPlugInLocaleDomain*) 0 == (domain)); } while (0);
    }

  g_slist_free (manager->locale_domains);
  manager->locale_domains = ((void*)0);
}
                                        ...
                                        const gchar *domain_path)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((manager)); GType __t = ((gimp_plug_in_manager_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_PLUG_IN_MANAGER (manager)"); return; }; }while (0);
  do{ if (prog_name != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "prog_name != NULL"); return; }; }while (0);
  do{ if (domain_name != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "domain_name != NULL"); return; }; }while (0);

  domain = ((GimpPlugInLocaleDomain*) g_slice_alloc (sizeof (GimpPlugInLocaleDomain)));
...
{
  GSList *list;
  GSList *unique = ((void*)0);
  gint n_domains;
  gint i;

  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((manager)); GType __t = ((gimp_plug_in_manager_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_PLUG_IN_MANAGER (manager)"); return (0); }; }while (0);
  do{ if (locale_domains != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "locale_domains != NULL"); return (0); }; }while (0);
  do{ if (locale_paths != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "locale_paths != NULL"); return (0); }; }while (0);
  ...
  *locale_domains = ((gchar * *) g_malloc0_n ((n_domains + 1), sizeof (gchar *)));
  *locale_paths = ((gchar * *) g_malloc0_n ((n_domains + 1), sizeof (gchar *)));

  (*locale_domains)[0] = g_strdup ("gimp20" "-std-plug-ins");
