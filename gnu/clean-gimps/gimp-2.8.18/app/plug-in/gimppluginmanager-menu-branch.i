# 1 "gimppluginmanager-menu-branch.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppluginmanager-menu-branch.c" 2
# 20 "gimppluginmanager-menu-branch.c"
# 1 "../../config.h" 1
# 21 "gimppluginmanager-menu-branch.c" 2
...
# 23 "gimppluginmanager-menu-branch.c" 2
...
# 25 "gimppluginmanager-menu-branch.c" 2
...
# 27 "gimppluginmanager-menu-branch.c" 2
# 1 "./gimppluginmanager-menu-branch.h" 1
# 24 "./gimppluginmanager-menu-branch.h"
  ...
  for (list = manager->menu_branches; list; list = list->next)
    {
      ...
      do { if (1) g_slice_free1 (sizeof (GimpPlugInMenuBranch), (branch)); else (void) ((GimpPlugInMenuBranch*) 0 == (branch)); } while (0);
    }

  g_slist_free (manager->menu_branches);
  manager->menu_branches = ((void*)0);
}
                                      ...
                                      const gchar *menu_label)
{
  ...
  do{ if (menu_path != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "menu_path != NULL"); return; }; }while (0);
  do{ if (menu_label != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "menu_label != NULL"); return; }; }while (0);

  branch = ((GimpPlugInMenuBranch*) g_slice_alloc (sizeof (GimpPlugInMenuBranch)));
