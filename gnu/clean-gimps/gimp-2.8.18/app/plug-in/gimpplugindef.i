...
static void gimp_plug_in_def_init (GimpPlugInDef *self); static void gimp_plug_in_def_class_init (GimpPlugInDefClass *klass); static gpointer gimp_plug_in_def_parent_class = ((void*)0); static gint GimpPlugInDef_private_offset; static void gimp_plug_in_def_class_intern_init (gpointer klass) { gimp_plug_in_def_parent_class = g_type_class_peek_parent (klass); if (GimpPlugInDef_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpPlugInDef_private_offset); gimp_plug_in_def_class_init ((GimpPlugInDefClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_plug_in_def_get_instance_private (GimpPlugInDef *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpPlugInDef_private_offset)))); } GType gimp_plug_in_def_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_object_get_type ()), g_intern_static_string ("GimpPlugInDef"), sizeof (GimpPlugInDefClass), (GClassInitFunc) gimp_plug_in_def_class_intern_init, sizeof (GimpPlugInDef), (GInstanceInitFunc) gimp_plug_in_def_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpPlugInDef *plug_in_def = ((((GimpPlugInDef*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_plug_in_def_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_plug_in_def_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                              ...
                              gint64 *gui_size)
{
  ...
  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_plug_in_def_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
...
gimp_plug_in_def_new (const gchar *prog)
{
  ...
  do{ if (prog != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "prog != NULL"); return (((void*)0)); }; }while (0);

  plug_in_def = g_object_new ((gimp_plug_in_def_get_type ()), ((void*)0));
                                ...
                                GimpPlugInProcedure *proc)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((plug_in_def)); GType __t = ((gimp_plug_in_def_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_PLUG_IN_DEF (plug_in_def)"); return; }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((proc)); GType __t = ((gimp_plug_in_procedure_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_PLUG_IN_PROCEDURE (proc)"); return; }; }while (0);
                                    ...
                                    const gchar *domain_path)
{
  ...
  for (list = plug_in_def->procedures; list; list = ((list) ? (((GSList *)(list))->next) : ((void*)0)))
    {
                                  ...
                                  gboolean needs_query)
{
  ...
  plug_in_def->needs_query = needs_query ? (!(0)) : (0);
}
                               ...
                               gboolean has_init)
{
  ...
  plug_in_def->has_init = has_init ? (!(0)) : (0);
}
