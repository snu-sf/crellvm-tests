# 1 "gimpenvirontable.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpenvirontable.c" 2
# 21 "gimpenvirontable.c"
# 1 "../../config.h" 1
# 22 "gimpenvirontable.c" 2
...
# 33 "gimpenvirontable.c" 2

# 1 "./gimpenvirontable.h" 1
# 33 "./gimpenvirontable.h"
...
GType gimp_environ_table_get_type (void) __attribute__((__const__));
...
static void gimp_environ_table_init (GimpEnvironTable *self); static void gimp_environ_table_class_init (GimpEnvironTableClass *klass); static gpointer gimp_environ_table_parent_class = ((void*)0); static gint GimpEnvironTable_private_offset; static void gimp_environ_table_class_intern_init (gpointer klass) { gimp_environ_table_parent_class = g_type_class_peek_parent (klass); if (GimpEnvironTable_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpEnvironTable_private_offset); gimp_environ_table_class_init ((GimpEnvironTableClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_environ_table_get_instance_private (GimpEnvironTable *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpEnvironTable_private_offset)))); } GType gimp_environ_table_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpEnvironTable"), sizeof (GimpEnvironTableClass), (GClassInitFunc) gimp_environ_table_class_intern_init, sizeof (GimpEnvironTable), (GInstanceInitFunc) gimp_environ_table_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  environ_table->vars = ((void*)0);
  environ_table->internal = ((void*)0);

  environ_table->envp = ((void*)0);
}

static void
gimp_environ_table_finalize (GObject *object)
{
  GimpEnvironTable *environ_table = ((((GimpEnvironTable*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_environ_table_get_type ()))))));

  gimp_environ_table_clear_all (environ_table);

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_environ_table_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}

GimpEnvironTable *
gimp_environ_table_new (void)
{
  return g_object_new ((gimp_environ_table_get_type ()), ((void*)0));
}

static guint
gimp_environ_table_str_hash (gconstpointer v)
{
# 117 "gimpenvirontable.c"
  return g_str_hash (v);
...
gimp_environ_table_load (GimpEnvironTable *environ_table,
                         const gchar *env_path)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((environ_table)); GType __t = ((gimp_environ_table_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_ENVIRON_TABLE (environ_table)"); return; }; }while (0);
                        ...
                        const gchar *separator)
{
  ...
  val = ((GimpEnvironValue*) g_slice_alloc (sizeof (GimpEnvironValue)));
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((environ_table)); GType __t = ((gimp_environ_table_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_ENVIRON_TABLE (environ_table)"); return (((void*)0)); }; }while (0);
...
gimp_environ_table_load_env_file (const GimpDatafileData *file_data,
                                  gpointer user_data)
{
  GimpEnvironTable *environ_table = ((((GimpEnvironTable*) g_type_check_instance_cast ((GTypeInstance*) ((user_data)), ((gimp_environ_table_get_type ()))))));
  FILE *env;
  gchar buffer[4096];
  gsize len;
  ...
  while (fgets (buffer, sizeof (buffer), env))
    {
      ...
      *p = '\0';
      ...
      if (name[0] == '\0')
        {
          g_message (gettext ("Empty variable name in environment file %s"),
      ...
      if (! gimp_environ_table_legal_name (name))
        {
          g_message (gettext ("Illegal variable name in environment file %s: %s"),
      ...
      if (! g_hash_table_lookup (environ_table->vars, name))
        {
          ...
          val->value = gimp_config_path_expand (value, (0), ((void*)0));
          val->separator = g_strdup (separator);
...
gimp_environ_table_legal_name (gchar *name)
{
  ...
  if (! ((g_ascii_table[(guchar) (*name)] & G_ASCII_ALPHA) != 0) && (*name != '_'))
    return (0);

  for (s = name + 1; *s; s++)
    if (! ((g_ascii_table[(guchar) (*s)] & G_ASCII_ALNUM) != 0) && (*s != '_'))
      return (0);
...
gimp_environ_table_populate (GimpEnvironTable *environ_table)
{
 ...
 g_ptr_array_add (env_array, g_strconcat (*var, "=", g_getenv (*var), ((void*)0)));
  ...
  g_ptr_array_add (env_array, ((void*)0));

  environ_table->envp = (gchar **) g_ptr_array_free (env_array, (0));
# 382 "gimpenvirontable.c"
}
  ...
  if (val->separator)
    {
      ...
      if (old)
        var = g_strconcat (name, "=", val->value, val->separator, old, ((void*)0));
    }

  if (! var)
    var = g_strconcat (name, "=", val->value, ((void*)0));
...
gimp_environ_table_free_value (GimpEnvironValue *val)
{
  ...
  do { if (1) g_slice_free1 (sizeof (GimpEnvironValue), (val)); else (void) ((GimpEnvironValue*) 0 == (val)); } while (0);
}
