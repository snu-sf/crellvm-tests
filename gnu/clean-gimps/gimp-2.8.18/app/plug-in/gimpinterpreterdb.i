# 1 "gimpinterpreterdb.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpinterpreterdb.c" 2
# 32 "gimpinterpreterdb.c"
# 1 "../../config.h" 1
# 33 "gimpinterpreterdb.c" 2
...
gboolean g_close (gint fd,
                  GError **error);
# 49 "gimpinterpreterdb.c" 2
# 58 "gimpinterpreterdb.c"
...
# 61 "gimpinterpreterdb.c" 2

# 1 "./gimpinterpreterdb.h" 1
# 33 "./gimpinterpreterdb.h"
...
GType gimp_interpreter_db_get_type (void) __attribute__((__const__));
...
static void gimp_interpreter_db_init (GimpInterpreterDB *self); static void gimp_interpreter_db_class_init (GimpInterpreterDBClass *klass); static gpointer gimp_interpreter_db_parent_class = ((void*)0); static gint GimpInterpreterDB_private_offset; static void gimp_interpreter_db_class_intern_init (gpointer klass) { gimp_interpreter_db_parent_class = g_type_class_peek_parent (klass); if (GimpInterpreterDB_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpInterpreterDB_private_offset); gimp_interpreter_db_class_init ((GimpInterpreterDBClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_interpreter_db_get_instance_private (GimpInterpreterDB *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpInterpreterDB_private_offset)))); } GType gimp_interpreter_db_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpInterpreterDB"), sizeof (GimpInterpreterDBClass), (GClassInitFunc) gimp_interpreter_db_class_intern_init, sizeof (GimpInterpreterDB), (GInstanceInitFunc) gimp_interpreter_db_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_interpreter_db_init (GimpInterpreterDB *db)
{
  ...
  db->magics = ((void*)0);
  db->magic_names = ((void*)0);

  db->extensions = ((void*)0);
  db->extension_names = ((void*)0);
}

static void
gimp_interpreter_db_finalize (GObject *object)
{
  GimpInterpreterDB *db = ((((GimpInterpreterDB*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_interpreter_db_get_type ()))))));

  gimp_interpreter_db_clear (db);

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_interpreter_db_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}

GimpInterpreterDB *
gimp_interpreter_db_new (void)
{
  return g_object_new ((gimp_interpreter_db_get_type ()), ((void*)0));
}
...
gimp_interpreter_db_load (GimpInterpreterDB *db,
                          const gchar *interp_path)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((db)); GType __t = ((gimp_interpreter_db_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_INTERPRETER_DB (db)"); return; }; }while (0);
                                      ...
                                      gpointer user_data)
{
  ...
  db = ((((GimpInterpreterDB*) g_type_check_instance_cast ((GTypeInstance*) ((user_data)), ((gimp_interpreter_db_get_type ()))))));

  interp_file = fopen (file_data->filename, "r");
  if (! interp_file)
    return;
  ...
  while (fgets (buffer, sizeof (buffer), interp_file))
    {
      ...
      if (((g_ascii_table[(guchar) (buffer[0])] & G_ASCII_ALNUM) != 0) || (buffer[0] == '/'))
        gimp_interpreter_db_add_program (db, file_data, buffer);
      else if (! ((g_ascii_table[(guchar) (buffer[0])] & G_ASCII_SPACE) != 0) && (buffer[0] != '\0'))
                                 ...
                                 gchar *buffer)
{
  ...
  *p = '\0';
  ...
  if (! g_file_test (program, G_FILE_TEST_IS_EXECUTABLE))
    {
      g_message (gettext ("Bad interpreter referenced in interpreter file %s: %s"),
...
bail:
  g_message (gettext ("Bad binary format string in interpreter file %s"),
             gimp_filename_to_utf8 (file_data->filename));
      ...
      if (c == '\\' && *s == 'x')
        {
          ...
          if (! ((g_ascii_table[(guchar) (*s++)] & G_ASCII_XDIGIT) != 0))
            return (0);
  ...
  if (! g_hash_table_lookup (db->magic_names, name))
    {
      ...
      interp_magic = ((GimpInterpreterMagic*) g_slice_alloc (sizeof (GimpInterpreterMagic)));
  ...
  while (list)
    {
      ...
      do { if (1) g_slice_free1 (sizeof (GimpInterpreterMagic), (magic)); else (void) ((GimpInterpreterMagic*) 0 == (magic)); } while (0);
                             ...
                             gchar **interp_arg)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((db)); GType __t = ((gimp_interpreter_db_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_INTERPRETER_DB (db)"); return (((void*)0)); }; }while (0);
  do{ if (program_path != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "program_path != NULL"); return (((void*)0)); }; }while (0);
  do{ if (interp_arg != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "interp_arg != NULL"); return (((void*)0)); }; }while (0);

  *interp_arg = ((void*)0);

  fd = open (program_path, 00 | 0, 0);
...
collect_extensions (const gchar *ext,
                    const gchar *program __attribute__((__unused__)),
                    GString *str)
{
  if (str->len)
