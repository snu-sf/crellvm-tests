...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpplugindebug.c" 2
# 20 "gimpplugindebug.c"
# 1 "../../config.h" 1
# 21 "gimpplugindebug.c" 2
...
# 27 "gimpplugindebug.c" 2

# 1 "./gimpplugindebug.h" 1
# 24 "./gimpplugindebug.h"
typedef enum
{
...
gimp_plug_in_debug_new (void)
{
  ...
  if (!g_shell_parse_argv (wrapper, ((void*)0), &args, &error))
    {
  ...
  debug = ((GimpPlugInDebug*) g_slice_alloc (sizeof (GimpPlugInDebug)));
  ...
  if (debug_string)
    {
      ...
      debug->flags = g_parse_debug_string (debug_string + 1,
                                           ...
                                           (sizeof (gimp_debug_wrap_keys) / sizeof ((gimp_debug_wrap_keys)[0])));
    }
  else
    {
...
{
  do{ if (debug != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "debug != NULL"); return; }; }while (0);
  ...
  do { if (1) g_slice_free1 (sizeof (GimpPlugInDebug), (debug)); else (void) ((GimpPlugInDebug*) 0 == (debug)); } while (0);
}
                         ...
                         const gchar **args)
{
  ...
  do{ if (debug != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "debug != NULL"); return (((void*)0)); }; }while (0);
  do{ if (name != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "name != NULL"); return (((void*)0)); }; }while (0);
  ...
  for (arg = debug->args; *arg != ((void*)0); arg++)
    g_ptr_array_add (argv, *arg);

  for (arg = (gchar **) args; *arg != ((void*)0); arg++)
    g_ptr_array_add (argv, *arg);

  g_ptr_array_add (argv, ((void*)0));

  return (gchar **) g_ptr_array_free (argv, (0));
}
