# 1 "gimppluginmanager-history.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppluginmanager-history.c" 2
# 20 "gimppluginmanager-history.c"
# 1 "../../config.h" 1
# 21 "gimppluginmanager-history.c" 2
...
# 23 "gimppluginmanager-history.c" 2
...
# 25 "gimppluginmanager-history.c" 2
...
# 27 "gimppluginmanager-history.c" 2

# 1 "../../app/config/gimpcoreconfig.h" 1
# 26 "../../app/config/gimpcoreconfig.h"
...
# 29 "gimppluginmanager-history.c" 2
...
# 31 "gimppluginmanager-history.c" 2
...
# 33 "gimppluginmanager-history.c" 2
# 1 "./gimppluginmanager-history.h" 1
# 24 "./gimppluginmanager-history.h"
...
# 34 "gimppluginmanager-history.c" 2
...
# 35 "gimppluginmanager-history.c" 2
...
gimp_plug_in_manager_history_size (GimpPlugInManager *manager)
{
  ...
  return (((1) > (manager->gimp->config->plug_in_history_size)) ? (1) : (manager->gimp->config->plug_in_history_size));
}
...
gimp_plug_in_manager_history_nth (GimpPlugInManager *manager,
                                      guint n)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((manager)); GType __t = ((gimp_plug_in_manager_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_PLUG_IN_MANAGER (manager)"); return (((void*)0)); }; }while (0);
                                  ...
                                  GimpPlugInProcedure *procedure)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((manager)); GType __t = ((gimp_plug_in_manager_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_PLUG_IN_MANAGER (manager)"); return; }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((procedure)); GType __t = ((gimp_plug_in_procedure_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_PLUG_IN_PROCEDURE (procedure)"); return; }; }while (0);
