...
# 1 "/usr/include/time.h" 1 3 4
# 35 "/usr/include/sys/shm.h" 2 3 4
# 50 "/usr/include/sys/shm.h" 3 4
...
gimp_plug_in_shm_new (void)
{
  ...
  GimpPlugInShm *shm = ((GimpPlugInShm*) g_slice_alloc0 (sizeof (GimpPlugInShm)));
  ...
  {
    shm->shm_ID = shmget (((__key_t) 0), (64 * 64 * 4), 01000 | 0600);

    if (shm->shm_ID != -1)
      {
        shm->shm_addr = (guchar *) shmat (shm->shm_ID, ((void*)0), 0);

        if (shm->shm_addr == (guchar *) -1)
          {
            g_printerr ("shmat() failed: %s\n" "Disabling shared memory tile transport",
                        g_strerror ((*__errno_location ())));
            shmctl (shm->shm_ID, 0, ((void*)0));
            shm->shm_ID = -1;
          }
...
# 234 "gimppluginshm.c"
  if (shm->shm_ID == -1)
    {
      do { if (1) g_slice_free1 (sizeof (GimpPlugInShm), (shm)); else (void) ((GimpPlugInShm*) 0 == (shm)); } while (0);
      shm = ((void*)0);
    }
  else
    {
      do { if (gimp_log_flags & GIMP_LOG_SHM) gimp_log (GIMP_LOG_SHM, ((const char*) (__func__)), 241, "attached shared memory segment ID = %d", shm->shm_ID); } while (0);
    }
...
{
  do{ if (shm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "shm != NULL"); return; }; }while (0);
  ...
  if (shm->shm_ID != -1)
    {
      ...
      shmdt (shm->shm_addr);
# 281 "gimppluginshm.c"
      do { if (gimp_log_flags & GIMP_LOG_SHM) gimp_log (GIMP_LOG_SHM, ((const char*) (__func__)), 281, "detached shared memory segment ID = %d", shm->shm_ID); } while (0);
    }
...
{
  do{ if (shm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "shm != NULL"); return (-1); }; }while (0);
...
{
  do{ if (shm != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "shm != NULL"); return (((void*)0)); }; }while (0);
