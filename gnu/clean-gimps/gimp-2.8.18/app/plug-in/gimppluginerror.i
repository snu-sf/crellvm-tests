...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppluginerror.c" 2
# 18 "gimppluginerror.c"
# 1 "../../config.h" 1
# 19 "gimppluginerror.c" 2
...
# 21 "gimppluginerror.c" 2

# 1 "./gimppluginerror.h" 1
# 22 "./gimppluginerror.h"
typedef enum
{
  GIMP_PLUG_IN_FAILED,
...
GQuark gimp_plug_in_error_quark (void) __attribute__((__const__));
# 23 "gimppluginerror.c" 2
# 32 "gimppluginerror.c"
GQuark
