# 1 "gimppluginmanager-data.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppluginmanager-data.c" 2
# 20 "gimppluginmanager-data.c"
# 1 "../../config.h" 1
# 21 "gimppluginmanager-data.c" 2
...
# 29 "gimppluginmanager-data.c" 2
# 1 "./gimppluginmanager-data.h" 1
# 24 "./gimppluginmanager-data.h"
  ...
  if (manager->data_list)
    {
      ...
      for (list = manager->data_list;
           ...
           list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
        {
          ...
          g_free (data->data);
          do { if (1) g_slice_free1 (sizeof (GimpPlugInData), (data)); else (void) ((GimpPlugInData*) 0 == (data)); } while (0);
        }

      g_list_free (manager->data_list);
      manager->data_list = ((void*)0);
    }
}
                               ...
                               const guint8 *data)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((manager)); GType __t = ((gimp_plug_in_manager_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_PLUG_IN_MANAGER (manager)"); return; }; }while (0);
  do{ if (identifier != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "identifier != NULL"); return; }; }while (0);
  do{ if (bytes > 0) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "bytes > 0"); return; }; }while (0);
  do{ if (data != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "data != NULL"); return; }; }while (0);

  for (list = manager->data_list; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
  ...
  if (list == ((void*)0))
    {
      plug_in_data = ((GimpPlugInData*) g_slice_alloc0 (sizeof (GimpPlugInData)));
                               ...
                               gint32 *bytes)
{
  ...
  do{ if (identifier != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "identifier != NULL"); return (((void*)0)); }; }while (0);
  do{ if (bytes != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "bytes != NULL"); return (((void*)0)); }; }while (0);
