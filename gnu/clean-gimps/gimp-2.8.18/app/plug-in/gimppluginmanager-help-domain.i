# 1 "gimppluginmanager-help-domain.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppluginmanager-help-domain.c" 2
# 20 "gimppluginmanager-help-domain.c"
# 1 "../../config.h" 1
# 21 "gimppluginmanager-help-domain.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 23 "gimppluginmanager-help-domain.c" 2
...
# 25 "gimppluginmanager-help-domain.c" 2
...
# 27 "gimppluginmanager-help-domain.c" 2
...
# 29 "gimppluginmanager-help-domain.c" 2
# 1 "./gimppluginmanager-help-domain.h" 1
# 24 "./gimppluginmanager-help-domain.h"
...
gint gimp_plug_in_manager_get_help_domains (GimpPlugInManager *manager,
                                                     gchar ***help_domains,
                                                     gchar ***help_uris);
# 30 "gimppluginmanager-help-domain.c" 2
  ...
  for (list = manager->help_domains; list; list = list->next)
    {
      ...
      do { if (1) g_slice_free1 (sizeof (GimpPlugInHelpDomain), (domain)); else (void) ((GimpPlugInHelpDomain*) 0 == (domain)); } while (0);
    }

  g_slist_free (manager->help_domains);
  manager->help_domains = ((void*)0);
}
                                      ...
                                      const gchar *domain_uri)
{
  ...
  domain = ((GimpPlugInHelpDomain*) g_slice_alloc (sizeof (GimpPlugInHelpDomain)));
                                       ...
                                       gchar ***help_uris)
{
  ...
  do{ if (help_domains != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "help_domains != NULL"); return (0); }; }while (0);
  do{ if (help_uris != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "help_uris != NULL"); return (0); }; }while (0);
  ...
  if (n_domains > 0)
    {
      ...
      *help_domains = ((gchar * *) g_malloc0_n ((n_domains + 1), sizeof (gchar *)));
      *help_uris = ((gchar * *) g_malloc0_n ((n_domains + 1), sizeof (gchar *)));
