# 1 "gimptemporaryprocedure.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimptemporaryprocedure.c" 2
# 20 "gimptemporaryprocedure.c"
# 1 "../../config.h" 1
# 21 "gimptemporaryprocedure.c" 2
...
# 29 "gimptemporaryprocedure.c" 2

# 1 "./gimppluginmanager-call.h" 1
# 30 "./gimppluginmanager-call.h"
...
GValueArray * gimp_plug_in_manager_call_run_temp (GimpPlugInManager *manager,
                                                  ...
                                                  GimpTemporaryProcedure *procedure,
                                                  GValueArray *args);
# 31 "gimptemporaryprocedure.c" 2
# 1 "./gimptemporaryprocedure.h" 1
# 24 "./gimptemporaryprocedure.h"
...
void gimp_plug_in_procedure_handle_return_values (GimpPlugInProcedure *proc,
                                                      ...
                                                      GValueArray *return_vals);
# 25 "./gimptemporaryprocedure.h" 2
# 35 "./gimptemporaryprocedure.h"
...
GType gimp_temporary_procedure_get_type (void) __attribute__((__const__));

GimpProcedure * gimp_temporary_procedure_new (GimpPlugIn *plug_in);
# 32 "gimptemporaryprocedure.c" 2
...
static void gimp_temporary_procedure_init (GimpTemporaryProcedure *self); static void gimp_temporary_procedure_class_init (GimpTemporaryProcedureClass *klass); static gpointer gimp_temporary_procedure_parent_class = ((void*)0); static gint GimpTemporaryProcedure_private_offset; static void gimp_temporary_procedure_class_intern_init (gpointer klass) { gimp_temporary_procedure_parent_class = g_type_class_peek_parent (klass); if (GimpTemporaryProcedure_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpTemporaryProcedure_private_offset); gimp_temporary_procedure_class_init ((GimpTemporaryProcedureClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_temporary_procedure_get_instance_private (GimpTemporaryProcedure *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpTemporaryProcedure_private_offset)))); } GType gimp_temporary_procedure_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_plug_in_procedure_get_type ()), g_intern_static_string ("GimpTemporaryProcedure"), sizeof (GimpTemporaryProcedureClass), (GClassInitFunc) gimp_temporary_procedure_class_intern_init, sizeof (GimpTemporaryProcedure), (GInstanceInitFunc) gimp_temporary_procedure_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_temporary_procedure_class_init (GimpTemporaryProcedureClass *klass)
{
  ...
  GimpProcedureClass *proc_class = ((((GimpProcedureClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gimp_procedure_get_type ()))))));
  GimpPlugInProcedureClass *plug_class = ((((GimpPlugInProcedureClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gimp_plug_in_procedure_get_type ()))))));
...
{
  ((((GimpProcedure*) g_type_check_instance_cast ((GTypeInstance*) ((proc)), ((gimp_procedure_get_type ()))))))->proc_type = GIMP_TEMPORARY;
}
...
gimp_temporary_procedure_finalize (GObject *object)
{
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_temporary_procedure_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                                  ...
                                  GError **error)
{
  return gimp_plug_in_manager_call_run_temp (gimp->plug_in_manager,
                                             context, progress,
                                             ((((GimpTemporaryProcedure*) g_type_check_instance_cast ((GTypeInstance*) ((procedure)), ((gimp_temporary_procedure_get_type ())))))),
                                             args);
}
...
gimp_temporary_procedure_execute_async (GimpProcedure *procedure,
                                        ...
                                        GimpObject *display)
{
  GimpTemporaryProcedure *temp_procedure = ((((GimpTemporaryProcedure*) g_type_check_instance_cast ((GTypeInstance*) ((procedure)), ((gimp_temporary_procedure_get_type ()))))));
  GValueArray *return_vals;
  ...
  if (return_vals)
    {
      GimpPlugInProcedure *proc = ((((GimpPlugInProcedure*) g_type_check_instance_cast ((GTypeInstance*) ((procedure)), ((gimp_plug_in_procedure_get_type ()))))));
...
{
  return ((((GimpTemporaryProcedure*) g_type_check_instance_cast ((GTypeInstance*) ((procedure)), ((gimp_temporary_procedure_get_type ()))))))->plug_in->prog;
}
...
gimp_temporary_procedure_new (GimpPlugIn *plug_in)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((plug_in)); GType __t = ((gimp_plug_in_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "GIMP_IS_PLUG_IN (plug_in)"); return (((void*)0)); }; }while (0);

  proc = g_object_new ((gimp_temporary_procedure_get_type ()), ((void*)0));

  proc->plug_in = plug_in;

  ((((GimpPlugInProcedure*) g_type_check_instance_cast ((GTypeInstance*) ((proc)), ((gimp_plug_in_procedure_get_type ()))))))->prog = g_strdup ("none");

  return ((((GimpProcedure*) g_type_check_instance_cast ((GTypeInstance*) ((proc)), ((gimp_procedure_get_type ()))))));
}
