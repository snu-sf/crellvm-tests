...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "plug-in-params.c" 2
# 18 "plug-in-params.c"
# 1 "../../config.h" 1
# 19 "plug-in-params.c" 2
...
# 24 "plug-in-params.c" 2
# 1 "../../libgimpbase/gimpprotocol.h" 1
# 32 "../../libgimpbase/gimpprotocol.h"
enum
{
  GP_QUIT,
  GP_CONFIG,
...
void gimp_value_take_colorarray (GValue *value,
                                                  GimpRGB *array,
                                                  gsize length);
# 30 "plug-in-params.c" 2

# 1 "../../app/pdb/gimp-pdb-compat.h" 1
# 22 "../../app/pdb/gimp-pdb-compat.h"
...
# 32 "plug-in-params.c" 2

# 1 "./plug-in-params.h" 1
# 22 "./plug-in-params.h"
                        ...
                        gboolean full_copy)
{
  ...
  do{ if ((pspecs != ((void*)0) && n_pspecs > 0) || (pspecs == ((void*)0) && n_pspecs == 0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "(pspecs != NULL && n_pspecs > 0) || (pspecs == NULL && n_pspecs == 0)"); return (((void*)0)); }; }while (0);

  do{ if ((params != ((void*)0) && n_params > 0) || (params == ((void*)0) && n_params == 0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "(params != NULL && n_params > 0) || (params == NULL && n_params == 0)"); return (((void*)0)); }; }while (0);
  ...
  for (i = 0; i < n_params; i++)
    {
          ...
          if (pspec_index < n_pspecs)
            {
              ...
              pspec_arg_type = gimp_pdb_compat_arg_type_from_gtype
                ((((((GParamSpec*) g_type_check_instance_cast ((GTypeInstance*) ((pspecs[pspec_index])), (((GType) ((19) << (2))))))))->value_type));
              ...
              if (pspec_arg_type == params[i].type)
                {
                  type = (((((GParamSpec*) g_type_check_instance_cast ((GTypeInstance*) ((pspecs[pspec_index])), (((GType) ((19) << (2))))))))->value_type);
                }
            }
        }
      ...
      switch (gimp_pdb_compat_arg_type_from_gtype (type))
        {
        case GIMP_PDB_INT32:
          if ((((__extension__ ({ GValue *__val = (GValue*) ((&value)); GType __t = (((GType) ((6) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
            g_value_set_int (&value, params[i].data.d_int32);
          else if ((((__extension__ ({ GValue *__val = (GValue*) ((&value)); GType __t = (((GType) ((7) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
            g_value_set_uint (&value, params[i].data.d_int32);
          else if ((((__extension__ ({ GValue *__val = (GValue*) ((&value)); GType __t = (((GType) ((12) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
            g_value_set_enum (&value, params[i].data.d_int32);
          else if ((((__extension__ ({ GValue *__val = (GValue*) ((&value)); GType __t = (((GType) ((5) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
            g_value_set_boolean (&value, params[i].data.d_int32 ? (!(0)) : (0));
          else
            {
              g_printerr ("%s: unhandled GIMP_PDB_INT32 type: %s\n",
                          ((const char*) (__func__)), g_type_name ((((GValue*) (&value))->g_type)));
              do{ g_log ("Gimp-Plug-In", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "plug-in-params.c", 109, ((const char*) (__func__))); return (args); }while (0);
            }
          break;
                        ...
                        gboolean full_copy)
{
  ...
  do{ if (args != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Plug-In", ((const char*) (__func__)), "args != NULL"); return (((void*)0)); }; }while (0);

  params = ((GPParam *) g_malloc0_n ((args->n_values), sizeof (GPParam)));
  ...
  for (i = 0; i < args->n_values; i++)
    {
      ...
      params[i].type =
        gimp_pdb_compat_arg_type_from_gtype ((((GValue*) (value))->g_type));
        ...
        case GIMP_PDB_INT32:
          if ((((__extension__ ({ GValue *__val = (GValue*) ((value)); GType __t = (((GType) ((6) << (2)))); gboolean __r; if (!__val) __r = (0); else if (__val->g_type == __t) __r = (!(0)); else __r = g_type_check_value_holds (__val, __t); __r; })))))
          ...
          else
            {
              g_printerr ("%s: unhandled GIMP_PDB_INT32 type: %s\n",
                          ((const char*) (__func__)), g_type_name ((((GValue*) (value))->g_type)));
              do{ g_log ("Gimp-Plug-In", G_LOG_LEVEL_CRITICAL, "file %s: line %d (%s): should not be reached", "plug-in-params.c", 295, ((const char*) (__func__))); return (params); }while (0);
            }
          break;
            ...
            if (parasite)
              {
                ...
                if (full_copy)
                  {
                    parasite->name = ((void*)0);
                    parasite->flags = 0;
                    parasite->size = 0;
                    parasite->data = ((void*)0);
              ...
              {
                params[i].data.d_parasite.name = ((void*)0);
                params[i].data.d_parasite.flags = 0;
                params[i].data.d_parasite.size = 0;
                params[i].data.d_parasite.data = ((void*)0);
              }
          }
          break;
