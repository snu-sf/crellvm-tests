# 1 "gimpplugin-context.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpplugin-context.c" 2
# 20 "gimpplugin-context.c"
# 1 "../../config.h" 1
# 21 "gimpplugin-context.c" 2
...
gimp_plug_in_context_push (GimpPlugIn *plug_in)
{
  ...
  context = gimp_pdb_context_new (plug_in->manager->gimp, parent, (0));
