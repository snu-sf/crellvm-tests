...
# 1 "./config/gimprc.h" 1
# 24 "./config/gimprc.h"
# 1 "./config/gimppluginconfig.h" 1
# 24 "./config/gimppluginconfig.h"
# 1 "./config/gimpguiconfig.h" 1
# 24 "./config/gimpguiconfig.h"
# 1 "./config/gimpdisplayconfig.h" 1
# 24 "./config/gimpdisplayconfig.h"
# 1 "./config/gimpcoreconfig.h" 1
# 26 "./config/gimpcoreconfig.h"
# 1 "./config/gimpbaseconfig.h" 1
# 34 "./config/gimpbaseconfig.h"
...
# 27 "./config/gimpcoreconfig.h" 2
# 36 "./config/gimpcoreconfig.h"
...
# 25 "./config/gimpdisplayconfig.h" 2
# 38 "./config/gimpdisplayconfig.h"
...
# 25 "./config/gimpguiconfig.h" 2
# 34 "./config/gimpguiconfig.h"
...
# 25 "./config/gimppluginconfig.h" 2
# 34 "./config/gimppluginconfig.h"
...
# 53 "app.c" 2
# 1 "./core/gimp-user-install.h" 1
# 22 "./core/gimp-user-install.h"
...
void gimp_fatal_error (const gchar *message) __attribute__((__noreturn__));
void gimp_terminate (const gchar *message) __attribute__((__noreturn__));
# 66 "app.c" 2
# 1 "./units.h" 1
# 27 "./units.h"
...
app_run (const gchar *full_prog_name,
         ...
         GimpPDBCompatMode pdb_compat_mode)
{
  GimpInitStatusFunc update_status_func = ((void*)0);
  Gimp *gimp;
  ...
  if (! swap_is_ok)
    {
      gchar *path = gimp_config_path_expand (config->swap_path, (0), ((void*)0));

      g_message (gettext ("Unable to open a test swap file.\n\n" "To avoid data loss, please check the location " "and permissions of the swap directory defined in " "your Preferences (currently \"%s\")."), path);
  ...
  gimp_rc_set_autosave (((((GimpRc*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->edit_config)), ((gimp_rc_get_type ())))))), (!(0)));

  loop = run_loop = g_main_loop_new (((void*)0), (0));

  g_signal_connect_data ((gimp), ("exit"), (((GCallback) (app_exit_after_callback))), (&run_loop), ((void*)0), G_CONNECT_AFTER);
