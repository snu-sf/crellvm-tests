...
GType gimp_ink_get_type (void) __attribute__((__const__));
# 27 "gimpinkundo.c" 2
...
GType gimp_ink_undo_get_type (void) __attribute__((__const__));
# 29 "gimpinkundo.c" 2
...
static void gimp_ink_undo_init (GimpInkUndo *self); static void gimp_ink_undo_class_init (GimpInkUndoClass *klass); static gpointer gimp_ink_undo_parent_class = ((void*)0); static gint GimpInkUndo_private_offset; static void gimp_ink_undo_class_intern_init (gpointer klass) { gimp_ink_undo_parent_class = g_type_class_peek_parent (klass); if (GimpInkUndo_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpInkUndo_private_offset); gimp_ink_undo_class_init ((GimpInkUndoClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_ink_undo_get_instance_private (GimpInkUndo *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpInkUndo_private_offset)))); } GType gimp_ink_undo_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_paint_core_undo_get_type ()), g_intern_static_string ("GimpInkUndo"), sizeof (GimpInkUndoClass), (GClassInitFunc) gimp_ink_undo_class_intern_init, sizeof (GimpInkUndo), (GInstanceInitFunc) gimp_ink_undo_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpInkUndo *ink_undo = ((((GimpInkUndo*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_ink_undo_get_type ()))))));
  GimpInk *ink;

  if (((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_ink_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed)
    ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_ink_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed (object);

  do { if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((((((GimpPaintCoreUndo*) g_type_check_instance_cast ((GTypeInstance*) ((ink_undo)), ((gimp_paint_core_undo_get_type ()))))))->paint_core)); GType __t = ((gimp_ink_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) ; else g_assertion_message_expr ("Gimp-Paint", "gimpinkundo.c", 71, ((const char*) (__func__)), "GIMP_IS_INK (GIMP_PAINT_CORE_UNDO (ink_undo)->paint_core)"); } while (0);

  ink = ((((GimpInk*) g_type_check_instance_cast ((GTypeInstance*) ((((((GimpPaintCoreUndo*) g_type_check_instance_cast ((GTypeInstance*) ((ink_undo)), ((gimp_paint_core_undo_get_type ()))))))->paint_core)), ((gimp_ink_get_type ()))))));
...
gimp_ink_undo_pop (GimpUndo *undo,
                   ...
                   GimpUndoAccumulator *accum)
{
  GimpInkUndo *ink_undo = ((((GimpInkUndo*) g_type_check_instance_cast ((GTypeInstance*) ((undo)), ((gimp_ink_undo_get_type ()))))));

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_ink_undo_parent_class)), ((gimp_undo_get_type ()))))))->pop (undo, undo_mode, accum);

  if (((((GimpPaintCoreUndo*) g_type_check_instance_cast ((GTypeInstance*) ((ink_undo)), ((gimp_paint_core_undo_get_type ()))))))->paint_core)
    {
      GimpInk *ink = ((((GimpInk*) g_type_check_instance_cast ((GTypeInstance*) ((((((GimpPaintCoreUndo*) g_type_check_instance_cast ((GTypeInstance*) ((ink_undo)), ((gimp_paint_core_undo_get_type ()))))))->paint_core)), ((gimp_ink_get_type ()))))));
      GimpBlob *tmp_blob;
  ...
  if (ink_undo->last_blob)
    {
      ...
      ink_undo->last_blob = ((void*)0);
    }

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_ink_undo_parent_class)), ((gimp_undo_get_type ()))))))->free (undo, undo_mode);
}
