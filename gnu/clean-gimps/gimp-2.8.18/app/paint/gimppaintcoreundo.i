# 1 "gimppaintcoreundo.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppaintcoreundo.c" 2
# 18 "gimppaintcoreundo.c"
# 1 "../../config.h" 1
# 19 "gimppaintcoreundo.c" 2
...
struct _GimpPaintCore
{
  ...
  gboolean use_saved_proj;

  TileManager *undo_tiles;
  TileManager *saved_proj_tiles;
  TileManager *canvas_tiles;

  TempBuf *orig_buf;
  TempBuf *orig_proj_buf;
  TempBuf *canvas_buf;
...
GType gimp_paint_core_get_type (void) __attribute__((__const__));
...
void gimp_paint_core_smooth_coords (GimpPaintCore *core,
                                                     GimpPaintOptions *paint_options,
                                                     GimpCoords *coords);
# 25 "gimppaintcoreundo.c" 2
# 1 "./gimppaintcoreundo.h" 1
# 22 "./gimppaintcoreundo.h"
# 1 "../../app/core/gimpundo.h" 1
# 22 "../../app/core/gimpundo.h"
# 1 "../../app/core/gimpviewable.h" 1
# 27 "../../app/core/gimpviewable.h"
...
# 23 "./gimppaintcoreundo.h" 2
# 33 "./gimppaintcoreundo.h"
...
GType gimp_paint_core_undo_get_type (void) __attribute__((__const__));
# 26 "gimppaintcoreundo.c" 2
...
static void gimp_paint_core_undo_init (GimpPaintCoreUndo *self); static void gimp_paint_core_undo_class_init (GimpPaintCoreUndoClass *klass); static gpointer gimp_paint_core_undo_parent_class = ((void*)0); static gint GimpPaintCoreUndo_private_offset; static void gimp_paint_core_undo_class_intern_init (gpointer klass) { gimp_paint_core_undo_parent_class = g_type_class_peek_parent (klass); if (GimpPaintCoreUndo_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpPaintCoreUndo_private_offset); gimp_paint_core_undo_class_init ((GimpPaintCoreUndoClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_paint_core_undo_get_instance_private (GimpPaintCoreUndo *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpPaintCoreUndo_private_offset)))); } GType gimp_paint_core_undo_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_undo_get_type ()), g_intern_static_string ("GimpPaintCoreUndo"), sizeof (GimpPaintCoreUndoClass), (GClassInitFunc) gimp_paint_core_undo_class_intern_init, sizeof (GimpPaintCoreUndo), (GInstanceInitFunc) gimp_paint_core_undo_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_paint_core_undo_class_init (GimpPaintCoreUndoClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_PAINT_CORE,
                                   g_param_spec_object ("paint-core", ((void*)0), ((void*)0),
...
{
  GimpPaintCoreUndo *paint_core_undo = ((((GimpPaintCoreUndo*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_paint_core_undo_get_type ()))))));

  if (((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_paint_core_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed)
    ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_paint_core_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed (object);

  do { if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((paint_core_undo->paint_core)); GType __t = ((gimp_paint_core_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) ; else g_assertion_message_expr ("Gimp-Paint", "gimppaintcoreundo.c", 90, ((const char*) (__func__)), "GIMP_IS_PAINT_CORE (paint_core_undo->paint_core)"); } while (0);

  paint_core_undo->last_coords = paint_core_undo->paint_core->start_coords;

  g_object_add_weak_pointer (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((paint_core_undo->paint_core)), (((GType) ((20) << (2)))))))),
                                   ...
                                   GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimppaintcoreundo.c", 113, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
gimp_paint_core_undo_pop (GimpUndo *undo,
                          ...
                          GimpUndoAccumulator *accum)
{
  GimpPaintCoreUndo *paint_core_undo = ((((GimpPaintCoreUndo*) g_type_check_instance_cast ((GTypeInstance*) ((undo)), ((gimp_paint_core_undo_get_type ()))))));

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_paint_core_undo_parent_class)), ((gimp_undo_get_type ()))))))->pop (undo, undo_mode, accum);
                           ...
                           GimpUndoMode undo_mode)
{
  ...
  if (paint_core_undo->paint_core)
    {
      g_object_remove_weak_pointer (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((paint_core_undo->paint_core)), (((GType) ((20) << (2)))))))),
                                    (gpointer) &paint_core_undo->paint_core);
      paint_core_undo->paint_core = ((void*)0);
    }

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_paint_core_undo_parent_class)), ((gimp_undo_get_type ()))))))->free (undo, undo_mode);
}
