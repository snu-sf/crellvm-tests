...
static void gimp_pencil_init (GimpPencil *self); static void gimp_pencil_class_init (GimpPencilClass *klass); static gpointer gimp_pencil_parent_class = ((void*)0); static gint GimpPencil_private_offset; static void gimp_pencil_class_intern_init (gpointer klass) { gimp_pencil_parent_class = g_type_class_peek_parent (klass); if (GimpPencil_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpPencil_private_offset); gimp_pencil_class_init ((GimpPencilClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_pencil_get_instance_private (GimpPencil *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpPencil_private_offset)))); } GType gimp_pencil_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_paintbrush_get_type ()), g_intern_static_string ("GimpPencil"), sizeof (GimpPencilClass), (GClassInitFunc) gimp_pencil_class_intern_init, sizeof (GimpPencil), (GInstanceInitFunc) gimp_pencil_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
