# 1 "gimppenciloptions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppenciloptions.c" 2
# 18 "gimppenciloptions.c"
# 1 "../../config.h" 1
# 19 "gimppenciloptions.c" 2
...
# 25 "gimppenciloptions.c" 2

# 1 "./gimppenciloptions.h" 1
# 22 "./gimppenciloptions.h"
...
void gimp_paint_options_copy_gradient_props (GimpPaintOptions *src,
                                                GimpPaintOptions *dest);
# 23 "./gimppenciloptions.h" 2
# 33 "./gimppenciloptions.h"
...
GType gimp_pencil_options_get_type (void) __attribute__((__const__));
# 27 "gimppenciloptions.c" 2
...
static void gimp_pencil_options_init (GimpPencilOptions *self); static void gimp_pencil_options_class_init (GimpPencilOptionsClass *klass); static gpointer gimp_pencil_options_parent_class = ((void*)0); static gint GimpPencilOptions_private_offset; static void gimp_pencil_options_class_intern_init (gpointer klass) { gimp_pencil_options_parent_class = g_type_class_peek_parent (klass); if (GimpPencilOptions_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpPencilOptions_private_offset); gimp_pencil_options_class_init ((GimpPencilOptionsClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_pencil_options_get_instance_private (GimpPencilOptions *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpPencilOptions_private_offset)))); } GType gimp_pencil_options_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_paint_options_get_type ()), g_intern_static_string ("GimpPencilOptions"), sizeof (GimpPencilOptionsClass), (GClassInitFunc) gimp_pencil_options_class_intern_init, sizeof (GimpPencilOptions), (GInstanceInitFunc) gimp_pencil_options_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_pencil_options_class_init (GimpPencilOptionsClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_HARD, g_param_spec_boolean ("hard", ((void*)0), ((void*)0), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_pencil_options_set_property (GObject *object,
                                  ...
                                  GParamSpec *pspec)
{
  GimpPaintOptions *options = ((((GimpPaintOptions*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_paint_options_get_type ()))))));
  ...
  switch (property_id)
    ...
    case PROP_HARD:
      ...
      break;
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimppenciloptions.c", 86, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                  ...
                                  GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_HARD:
      ...
      break;
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimppenciloptions.c", 105, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
