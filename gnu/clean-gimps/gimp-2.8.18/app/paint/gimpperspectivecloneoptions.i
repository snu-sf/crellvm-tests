# 1 "gimpperspectivecloneoptions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpperspectivecloneoptions.c" 2
# 18 "gimpperspectivecloneoptions.c"
# 1 "../../config.h" 1
# 19 "gimpperspectivecloneoptions.c" 2
         ...
         ...)
{
  ...
  g_logv ("Gimp-Paint", G_LOG_LEVEL_ERROR, format, args);
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint", G_LOG_LEVEL_MESSAGE, format, args);
  __builtin_va_end(args);
}
static void
            ...
            ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint", G_LOG_LEVEL_CRITICAL, format, args);
  __builtin_va_end(args);
}
static void
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint", G_LOG_LEVEL_WARNING, format, args);
  __builtin_va_end(args);
}
static void
        ...
        ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint", G_LOG_LEVEL_INFO, format, args);
  __builtin_va_end(args);
}
static void
         ...
         ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("Gimp-Paint", G_LOG_LEVEL_DEBUG, format, args);
  __builtin_va_end(args);
}
...
# 21 "gimpperspectivecloneoptions.c" 2
...
# 23 "gimpperspectivecloneoptions.c" 2
...
# 25 "gimpperspectivecloneoptions.c" 2

# 1 "./gimpperspectivecloneoptions.h" 1
# 22 "./gimpperspectivecloneoptions.h"
# 1 "./gimpcloneoptions.h" 1
# 22 "./gimpcloneoptions.h"
# 1 "./gimpsourceoptions.h" 1
# 22 "./gimpsourceoptions.h"
# 1 "./gimppaintoptions.h" 1
# 22 "./gimppaintoptions.h"
# 1 "../../app/core/gimptooloptions.h" 1
# 22 "../../app/core/gimptooloptions.h"
# 1 "../../app/core/gimpcontext.h" 1
# 25 "../../app/core/gimpcontext.h"
...
# 26 "../../app/core/gimpcontext.h" 2
# 36 "../../app/core/gimpcontext.h"
typedef struct _GimpContextClass GimpContextClass;
# 47 "../../app/core/gimpcontext.h"
struct _GimpContext
{
...
# 23 "../../app/core/gimptooloptions.h" 2
# 33 "../../app/core/gimptooloptions.h"
...
GType gimp_tool_options_get_type (void) __attribute__((__const__));
...
# 23 "./gimppaintoptions.h" 2
# 34 "./gimppaintoptions.h"
...
GType gimp_paint_options_get_type (void) __attribute__((__const__));
...
void gimp_paint_options_copy_gradient_props (GimpPaintOptions *src,
                                                GimpPaintOptions *dest);
# 23 "./gimpsourceoptions.h" 2
# 33 "./gimpsourceoptions.h"
...
GType gimp_source_options_get_type (void) __attribute__((__const__));
# 23 "./gimpcloneoptions.h" 2
# 33 "./gimpcloneoptions.h"
...
GType gimp_clone_options_get_type (void) __attribute__((__const__));
# 23 "./gimpperspectivecloneoptions.h" 2
# 33 "./gimpperspectivecloneoptions.h"
...
GType gimp_perspective_clone_options_get_type (void) __attribute__((__const__));
# 27 "gimpperspectivecloneoptions.c" 2
...
static void gimp_perspective_clone_options_init (GimpPerspectiveCloneOptions *self); static void gimp_perspective_clone_options_class_init (GimpPerspectiveCloneOptionsClass *klass); static gpointer gimp_perspective_clone_options_parent_class = ((void*)0); static gint GimpPerspectiveCloneOptions_private_offset; static void gimp_perspective_clone_options_class_intern_init (gpointer klass) { gimp_perspective_clone_options_parent_class = g_type_class_peek_parent (klass); if (GimpPerspectiveCloneOptions_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpPerspectiveCloneOptions_private_offset); gimp_perspective_clone_options_class_init ((GimpPerspectiveCloneOptionsClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_perspective_clone_options_get_instance_private (GimpPerspectiveCloneOptions *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpPerspectiveCloneOptions_private_offset)))); } GType gimp_perspective_clone_options_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_clone_options_get_type ()), g_intern_static_string ("GimpPerspectiveCloneOptions"), sizeof (GimpPerspectiveCloneOptionsClass), (GClassInitFunc) gimp_perspective_clone_options_class_intern_init, sizeof (GimpPerspectiveCloneOptions), (GInstanceInitFunc) gimp_perspective_clone_options_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_perspective_clone_options_class_init (GimpPerspectiveCloneOptionsClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_CLONE_MODE, g_param_spec_enum ("clone-mode", ((void*)0), ((void*)0), (gimp_perspective_clone_mode_get_type ()), GIMP_PERSPECTIVE_CLONE_MODE_ADJUST, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_perspective_clone_options_set_property (GObject *object,
                                             ...
                                             GParamSpec *pspec)
{
  GimpPerspectiveCloneOptions *options = ((((GimpPerspectiveCloneOptions*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_perspective_clone_options_get_type ()))))));
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpperspectivecloneoptions.c", 85, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                             ...
                                             GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpperspectivecloneoptions.c", 105, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
