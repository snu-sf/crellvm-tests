# 1 "gimpcloneoptions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpcloneoptions.c" 2
# 18 "gimpcloneoptions.c"
# 1 "../../config.h" 1
# 19 "gimpcloneoptions.c" 2
...
static void gimp_clone_options_init (GimpCloneOptions *self); static void gimp_clone_options_class_init (GimpCloneOptionsClass *klass); static gpointer gimp_clone_options_parent_class = ((void*)0); static gint GimpCloneOptions_private_offset; static void gimp_clone_options_class_intern_init (gpointer klass) { gimp_clone_options_parent_class = g_type_class_peek_parent (klass); if (GimpCloneOptions_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpCloneOptions_private_offset); gimp_clone_options_class_init ((GimpCloneOptionsClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_clone_options_get_instance_private (GimpCloneOptions *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpCloneOptions_private_offset)))); } GType gimp_clone_options_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_source_options_get_type ()), g_intern_static_string ("GimpCloneOptions"), sizeof (GimpCloneOptionsClass), (GClassInitFunc) gimp_clone_options_class_intern_init, sizeof (GimpCloneOptions), (GInstanceInitFunc) gimp_clone_options_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_clone_options_class_init (GimpCloneOptionsClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_CLONE_TYPE, g_param_spec_enum ("clone-type", ((void*)0), ((void*)0), (gimp_clone_type_get_type ()), GIMP_IMAGE_CLONE, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_clone_options_set_property (GObject *object,
                                 ...
                                 GParamSpec *pspec)
{
  GimpCloneOptions *options = ((((GimpCloneOptions*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_clone_options_get_type ()))))));
  ...
  switch (property_id)
    ...
    case PROP_CLONE_TYPE:
      ...
      break;
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpcloneoptions.c", 90, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                 ...
                                 GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_CLONE_TYPE:
      ...
      break;
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpcloneoptions.c", 109, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
gimp_clone_options_notify (GObject *object,
                           GParamSpec *pspec)
{
  if (((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_clone_options_parent_class)), (((GType) ((20) << (2))))))))->notify)
    ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_clone_options_parent_class)), (((GType) ((20) << (2))))))))->notify (object, pspec);

  if (! strcmp ("clone-type", g_param_spec_get_name (pspec)))
    ((((GimpSourceOptions*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_source_options_get_type ()))))))->use_source =
      (((((GimpCloneOptions*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_clone_options_get_type ()))))))->clone_type == GIMP_IMAGE_CLONE);
}
