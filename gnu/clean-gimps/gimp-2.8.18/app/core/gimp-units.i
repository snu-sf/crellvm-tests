...
gimp_unitrc_load (Gimp *gimp)
{
  ...
  if (! scanner && error->code == GIMP_CONFIG_ERROR_OPEN_ENOENT)
    {
      ...
      filename = g_build_filename (gimp_sysconf_directory (), "unitrc", ((void*)0));
  ...
  g_scanner_scope_add_symbol (scanner, 0,
                              "unit-info", ((gpointer) (glong) (UNIT_INFO)));
  g_scanner_scope_add_symbol (scanner, UNIT_INFO,
                              "factor", ((gpointer) (glong) (UNIT_FACTOR)));
  g_scanner_scope_add_symbol (scanner, UNIT_INFO,
                              "digits", ((gpointer) (glong) (UNIT_DIGITS)));
  g_scanner_scope_add_symbol (scanner, UNIT_INFO,
                              "symbol", ((gpointer) (glong) (UNIT_SYMBOL)));
  g_scanner_scope_add_symbol (scanner, UNIT_INFO,
                              "abbreviation", ((gpointer) (glong) (UNIT_ABBREV)));
  g_scanner_scope_add_symbol (scanner, UNIT_INFO,
                              "singular", ((gpointer) (glong) (UNIT_SINGULAR)));
  g_scanner_scope_add_symbol (scanner, UNIT_INFO,
                              "plural", ((gpointer) (glong) (UNIT_PLURAL)));
  ...
  while (g_scanner_peek_next_token (scanner) == token)
    {
      ...
      switch (token)
        ...
        case G_TOKEN_SYMBOL:
          if (scanner->value.v_symbol == ((gpointer) (glong) (UNIT_INFO)))
            {
  ...
  if (token != G_TOKEN_LEFT_PAREN)
    {
      ...
      gimp_config_file_backup_on_error (filename, "unitrc", ((void*)0));
    }
...
gimp_unitrc_save (Gimp *gimp)
{
  ...
  for (i = _gimp_unit_get_number_of_built_in_units (gimp);
       ...
       i++)
    {
      if (_gimp_unit_get_deletion_flag (gimp, i) == (0))
        {
          gchar buf[(29 + 10)];
      ...
      if (g_scanner_peek_next_token (scanner) == token)
        {
          ...
          _gimp_unit_set_deletion_flag (gimp, unit, (0));
        }
    }
