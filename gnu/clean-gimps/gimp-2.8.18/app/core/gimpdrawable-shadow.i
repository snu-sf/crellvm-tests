# 1 "gimpdrawable-shadow.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpdrawable-shadow.c" 2
# 18 "gimpdrawable-shadow.c"
# 1 "../../config.h" 1
# 19 "gimpdrawable-shadow.c" 2
...
# 28 "gimpdrawable-shadow.c" 2
# 1 "./gimpdrawable-private.h" 1
# 21 "./gimpdrawable-private.h"
struct _GimpDrawablePrivate
{
  ...
  GSList *preview_cache;
  gboolean preview_valid;
};
# 29 "gimpdrawable-shadow.c" 2
  ...
  if (drawable->private->shadow)
    {
      ...
      drawable->private->shadow = ((void*)0);
    }
}
                                  ...
                                  const gchar *undo_desc)
{
  ...
  do{ if (drawable->private->shadow != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "drawable->private->shadow != NULL"); return; }; }while (0);
  ...
  if (gimp_item_mask_intersect (((((GimpItem*) g_type_check_instance_cast ((GTypeInstance*) ((drawable)), ((gimp_item_get_type ())))))), &x, &y, &width, &height))
    {
      ...
      pixel_region_init (&shadowPR, tiles, x, y, width, height, (0));

      gimp_drawable_apply_region (drawable, &shadowPR,
                                  push_undo, undo_desc,
                                  1.0, GIMP_REPLACE_MODE,
                                  ((void*)0), ((void*)0), x, y);
