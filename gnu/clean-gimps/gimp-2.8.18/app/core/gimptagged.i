  ...
  if (! tagged_iface_type)
    {
      ...
      tagged_iface_type = g_type_register_static (((GType) ((2) << (2))),
                                                  "GimpTaggedInterface",
                                                  &tagged_iface_info,
                                                  0);
   }
  ...
  if (! initialized)
    {
      gimp_tagged_signals[TAG_ADDED] =
        g_signal_new ("tag-added",
                      ...
                      G_SIGNAL_RUN_LAST,
                      ((glong) __builtin_offsetof(GimpTaggedInterface, tag_added)),
                      ((void*)0), ((void*)0),
      ...
      gimp_tagged_signals[TAG_REMOVED] =
        g_signal_new ("tag-removed",
                      (gimp_tagged_interface_get_type ()),
                      G_SIGNAL_RUN_LAST,
                      ((glong) __builtin_offsetof(GimpTaggedInterface, tag_removed)),
                      ((void*)0), ((void*)0),
                      g_cclosure_marshal_VOID__OBJECT,
                      ((GType) ((1) << (2))), 1,
                      (gimp_tag_get_type ()));
...
gimp_tagged_add_tag (GimpTagged *tagged,
                     GimpTag *tag)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tagged)); GType __t = ((gimp_tagged_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAGGED (tagged)"); return; }; }while (0);
  ...
  if (((((GimpTaggedInterface*) g_type_interface_peek (((GTypeInstance*) ((tagged)))->g_class, ((gimp_tagged_interface_get_type ()))))))->add_tag (tagged, tag))
    {
                        ...
                        GimpTag *tag)
{
  ...
  for (tag_iter = gimp_tagged_get_tags (tagged);
       tag_iter;
       tag_iter = ((tag_iter) ? (((GList *)(tag_iter))->next) : ((void*)0)))
    {
      ...
      if (gimp_tag_equals (tag_ref, tag))
        {
          ...
          if (((((GimpTaggedInterface*) g_type_interface_peek (((GTypeInstance*) ((tagged)))->g_class, ((gimp_tagged_interface_get_type ()))))))->remove_tag (tagged, tag_ref))
            {
                      ...
                      GList *tags)
{
  ...
  for (list = old_tags; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
  ...
  for (list = tags; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
      do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((list->data)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (list->data)"); return; }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tagged)); GType __t = ((gimp_tagged_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAGGED (tagged)"); return (((void*)0)); }; }while (0);

  return ((((GimpTaggedInterface*) g_type_interface_peek (((GTypeInstance*) ((tagged)))->g_class, ((gimp_tagged_interface_get_type ()))))))->get_tags (tagged);
}
# 227 "gimptagged.c"
gchar *
gimp_tagged_get_identifier (GimpTagged *tagged)
{
  ...
  return ((((GimpTaggedInterface*) g_type_interface_peek (((GTypeInstance*) ((tagged)))->g_class, ((gimp_tagged_interface_get_type ()))))))->get_identifier (tagged);
}
# 249 "gimptagged.c"
gchar *
gimp_tagged_get_checksum (GimpTagged *tagged)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tagged)); GType __t = ((gimp_tagged_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAGGED (tagged)"); return ((0)); }; }while (0);

  return ((((GimpTaggedInterface*) g_type_interface_peek (((GTypeInstance*) ((tagged)))->g_class, ((gimp_tagged_interface_get_type ()))))))->get_checksum (tagged);
}
# 264 "gimptagged.c"
gboolean
