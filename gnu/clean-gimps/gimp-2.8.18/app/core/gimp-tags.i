...
# 1 "../../app/config/gimpxmlparser.h" 1
# 25 "../../app/config/gimpxmlparser.h"
...
gimp_tags_user_install (void)
{
  ...
  tags_locale = gettext ("tags-locale:C");
  ...
  tags_installer.buf = g_string_new (((void*)0));
  ...
  markup_parser.passthrough = ((void*)0);
  markup_parser.error = ((void*)0);
  ...
  if (! result)
    {
      g_string_free (tags_installer.buf, (!(0)));
      return (0);
    }

  g_string_append (tags_installer.buf, "\n</tags>\n");

  filename = g_build_filename (gimp_directory (), "tags.xml", ((void*)0));
