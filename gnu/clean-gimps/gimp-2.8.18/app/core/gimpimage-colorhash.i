# 1 "gimpimage-colorhash.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpimage-colorhash.c" 2
# 18 "gimpimage-colorhash.c"
# 1 "../../config.h" 1
# 19 "gimpimage-colorhash.c" 2
...
# 25 "gimpimage-colorhash.c" 2
# 1 "./gimpimage-colorhash.h" 1
# 22 "./gimpimage-colorhash.h"
...
gint gimp_image_color_hash_rgb_to_indexed (const GimpImage *image,
                                             ...
                                             gint g,
                                             gint b);
# 26 "gimpimage-colorhash.c" 2
# 1 "./gimpimage-colormap.h" 1
# 25 "./gimpimage-colormap.h"
...
static ColorHash color_hash_table[1021];
  ...
  for (i = 0; i < 1021; i++)
    {
      ...
      color_hash_table[i].image = ((void*)0);
    }
