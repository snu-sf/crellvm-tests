  ...
  if (! progress_iface_type)
    {
      ...
      progress_iface_type = g_type_register_static (((GType) ((2) << (2))),
                                                    "GimpProgressInterface",
                                                    &progress_iface_info,
                                                    0);

      g_type_interface_add_prerequisite (progress_iface_type, ((GType) ((20) << (2))));
    }
  ...
  if (! initialized)
    {
      progress_signals[CANCEL] =
        g_signal_new ("cancel",
                      (((GTypeInterface*) (progress_iface))->g_type),
                      G_SIGNAL_RUN_FIRST,
                      ((glong) __builtin_offsetof(GimpProgressInterface, cancel)),
                      ((void*)0), ((void*)0),
                     ...
                     gboolean cancelable)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((progress)); GType __t = ((gimp_progress_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_PROGRESS (progress)"); return (((void*)0)); }; }while (0);

  if (! message)
    message = gettext ("Please wait");

  progress_iface = ((((GimpProgressInterface*) g_type_interface_peek (((GTypeInstance*) ((progress)))->g_class, ((gimp_progress_interface_get_type ()))))));
...
gimp_progress_end (GimpProgress *progress)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((progress)); GType __t = ((gimp_progress_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_PROGRESS (progress)"); return; }; }while (0);
...
gimp_progress_is_active (GimpProgress *progress)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((progress)); GType __t = ((gimp_progress_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_PROGRESS (progress)"); return ((0)); }; }while (0);
                         ...
                         gdouble percentage)
{
  ...
  percentage = (((percentage) > (1.0)) ? (1.0) : (((percentage) < (0.0)) ? (0.0) : (percentage)));
                       ...
                       const gchar *message)
{
  ...
  do{ if (domain != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "domain != NULL"); return ((0)); }; }while (0);
  do{ if (message != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "message != NULL"); return ((0)); }; }while (0);
...
gimp_progress_update_and_flush (gint min,
                                ...
                                gpointer data)
{
  gimp_progress_set_value (((((GimpProgress*) g_type_check_instance_cast ((GTypeInstance*) ((data)), ((gimp_progress_interface_get_type ())))))),
                           (gdouble) (current - min) / (gdouble) (max - min));

  while (g_main_context_pending (((void*)0)))
