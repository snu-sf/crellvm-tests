# 1 "gimptaggedcontainer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimptaggedcontainer.c" 2
# 21 "gimptaggedcontainer.c"
# 1 "../../config.h" 1
# 22 "gimptaggedcontainer.c" 2
...
GType gimp_tag_get_type (void) __attribute__((__const__));
...
gboolean gimp_tagged_has_tag (GimpTagged *tagged,
                                           GimpTag *tag);
# 31 "gimptaggedcontainer.c" 2
# 1 "./gimptaggedcontainer.h" 1
# 25 "./gimptaggedcontainer.h"
# 1 "./gimpfilteredcontainer.h" 1
# 26 "./gimpfilteredcontainer.h"
# 1 "./gimplist.h" 1
# 25 "./gimplist.h"
# 1 "./gimpcontainer.h" 1
# 36 "./gimpcontainer.h"
...
GType gimp_list_get_type (void) __attribute__((__const__));
...
# 27 "./gimpfilteredcontainer.h" 2
# 37 "./gimpfilteredcontainer.h"
...
GType gimp_filtered_container_get_type (void) __attribute__((__const__));

GimpContainer * gimp_filtered_container_new (GimpContainer *src_container,
                                                  GimpObjectFilterFunc filter_func,
                                                  gpointer filter_data);
# 26 "./gimptaggedcontainer.h" 2
# 36 "./gimptaggedcontainer.h"
...
GType gimp_tagged_container_get_type (void) __attribute__((__const__));
...
static void gimp_tagged_container_init (GimpTaggedContainer *self); static void gimp_tagged_container_class_init (GimpTaggedContainerClass *klass); static gpointer gimp_tagged_container_parent_class = ((void*)0); static gint GimpTaggedContainer_private_offset; static void gimp_tagged_container_class_intern_init (gpointer klass) { gimp_tagged_container_parent_class = g_type_class_peek_parent (klass); if (GimpTaggedContainer_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpTaggedContainer_private_offset); gimp_tagged_container_class_init ((GimpTaggedContainerClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_tagged_container_get_instance_private (GimpTaggedContainer *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpTaggedContainer_private_offset)))); } GType gimp_tagged_container_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_filtered_container_get_type ()), g_intern_static_string ("GimpTaggedContainer"), sizeof (GimpTaggedContainerClass), (GClassInitFunc) gimp_tagged_container_class_intern_init, sizeof (GimpTaggedContainer), (GInstanceInitFunc) gimp_tagged_container_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GObjectClass *g_object_class = ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), (((GType) ((20) << (2))))))));
  GimpObjectClass *gimp_object_class = ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gimp_object_get_type ()))))));
  GimpContainerClass *container_class = ((((GimpContainerClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gimp_container_get_type ()))))));
  GimpFilteredContainerClass *filtered_class = ((((GimpFilteredContainerClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gimp_filtered_container_get_type ()))))));
  ...
  gimp_tagged_container_signals[TAG_COUNT_CHANGED] =
    g_signal_new ("tag-count-changed",
                  ...
                  G_SIGNAL_RUN_LAST,
                  ((glong) __builtin_offsetof(GimpTaggedContainerClass, tag_count_changed)),
                  ((void*)0), ((void*)0),
...
{
  GimpTaggedContainer *tagged_container = ((((GimpTaggedContainer*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_tagged_container_get_type ()))))));

  if (tagged_container->filter)
    {
      g_list_free_full (tagged_container->filter,
                        (GDestroyNotify) gimp_tag_or_null_unref);
      tagged_container->filter = ((void*)0);
    }

  if (tagged_container->tag_ref_counts)
    {
      g_hash_table_unref (tagged_container->tag_ref_counts);
      tagged_container->tag_ref_counts = ((void*)0);
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_tagged_container_parent_class)), (((GType) ((20) << (2))))))))->dispose (object);
}
                                   ...
                                   gint64 *gui_size)
{
  ...
  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_tagged_container_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
...
{
  GimpFilteredContainer *filtered_container = ((((GimpFilteredContainer*) g_type_check_instance_cast ((GTypeInstance*) ((container)), ((gimp_filtered_container_get_type ()))))));
  GimpTaggedContainer *tagged_container = ((((GimpTaggedContainer*) g_type_check_instance_cast ((GTypeInstance*) ((container)), ((gimp_tagged_container_get_type ()))))));
  GList *list;

  for (list = ((((GimpList*) g_type_check_instance_cast ((GTypeInstance*) ((filtered_container->src_container)), ((gimp_list_get_type ()))))))->list;
       list;
       list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
      g_signal_handlers_disconnect_matched ((list->data), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_tagged_container_tag_added), (tagged_container));


      g_signal_handlers_disconnect_matched ((list->data), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_tagged_container_tag_removed), (tagged_container));
  ...
  ((((GimpContainerClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_tagged_container_parent_class)), ((gimp_container_get_type ()))))))->clear (container);
}
...
gimp_tagged_container_src_add (GimpFilteredContainer *filtered_container,
                               GimpObject *object)
{
  GimpTaggedContainer *tagged_container = ((((GimpTaggedContainer*) g_type_check_instance_cast ((GTypeInstance*) ((filtered_container)), ((gimp_tagged_container_get_type ()))))));
  GList *list;

  for (list = gimp_tagged_get_tags (((((GimpTagged*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_tagged_interface_get_type ())))))));
       list;
       list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
  ...
  g_signal_connect_data ((object), ("tag-added"), (((GCallback) (gimp_tagged_container_tag_added))), (tagged_container), ((void*)0), (GConnectFlags) 0);


  g_signal_connect_data ((object), ("tag-removed"), (((GCallback) (gimp_tagged_container_tag_removed))), (tagged_container), ((void*)0), (GConnectFlags) 0);



  if (gimp_tagged_container_object_matches (tagged_container, object))
    {
      gimp_container_add (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_container_get_type ())))))), object);
    }
}
                                  ...
                                  GimpObject *object)
{
  ...
  g_signal_handlers_disconnect_matched ((object), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_tagged_container_tag_added), (tagged_container));


  g_signal_handlers_disconnect_matched ((object), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_tagged_container_tag_removed), (tagged_container));
  ...
  if (gimp_tagged_container_object_matches (tagged_container, object))
    {
      gimp_container_remove (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_container_get_type ())))))), object);
    }
}
...
{
  gimp_container_clear (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((filtered_container)), ((gimp_container_get_type ())))))));
}
...
gimp_tagged_container_new (GimpContainer *src_container)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((src_container)); GType __t = ((gimp_list_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_LIST (src_container)"); return (((void*)0)); }; }while (0);

  children_type = gimp_container_get_children_type (src_container);
  sort_func = ((((GimpList*) g_type_check_instance_cast ((GTypeInstance*) ((src_container)), ((gimp_list_get_type ()))))))->sort_func;

  tagged_container = g_object_new ((gimp_tagged_container_get_type ()),
                                   "sort-func", sort_func,
  ...
  return ((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_container_get_type ()))))));
}
# 295 "gimptaggedcontainer.c"
void
                                  ...
                                  GList *tags)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tagged_container)); GType __t = ((gimp_tagged_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAGGED_CONTAINER (tagged_container)"); return; }; }while (0);

  if (tags)
    {
      GList *list;

      for (list = tags; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
        do{ if (list->data == ((void*)0) || (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((list->data)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "list->data == NULL || GIMP_IS_TAG (list->data)"); return; }; }while (0);
    }

  if (! gimp_container_frozen (((((GimpFilteredContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_filtered_container_get_type ()))))))->src_container))
    {
      gimp_tagged_container_src_freeze (((((GimpFilteredContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_filtered_container_get_type ())))))));
    }


  new_filter = g_list_copy (tags);
  g_list_foreach (new_filter, (GFunc) gimp_tag_or_null_ref, ((void*)0));
  ...
  if (! gimp_container_frozen (((((GimpFilteredContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_filtered_container_get_type ()))))))->src_container))
    {
      gimp_tagged_container_src_thaw (((((GimpFilteredContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_filtered_container_get_type ())))))));
    }
}
# 340 "gimptaggedcontainer.c"
const GList *
gimp_tagged_container_get_filter (GimpTaggedContainer *tagged_container)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tagged_container)); GType __t = ((gimp_tagged_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAGGED_CONTAINER (tagged_container)"); return (((void*)0)); }; }while (0);
                                      ...
                                      GimpObject *object)
{
  ...
  for (filter_tags = tagged_container->filter;
       filter_tags;
       filter_tags = ((filter_tags) ? (((GList *)(filter_tags))->next) : ((void*)0)))
    {
      if (! filter_tags->data)
        {
      ...
      if (! gimp_tagged_has_tag (((((GimpTagged*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_tagged_interface_get_type ())))))),
                                 filter_tags->data))
        {
                                 ...
                                 GimpTaggedContainer *tagged_container)
{
  ...
  if (gimp_tagged_container_object_matches (tagged_container,
                                            ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((tagged)), ((gimp_object_get_type ()))))))) &&
      ! gimp_container_have (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_container_get_type ())))))),
                             ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((tagged)), ((gimp_object_get_type ()))))))))
    {
      gimp_container_add (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_container_get_type ())))))),
                          ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((tagged)), ((gimp_object_get_type ())))))));
    }
}
                                   ...
                                   GimpTaggedContainer *tagged_container)
{
  ...
  if (! gimp_tagged_container_object_matches (tagged_container,
      ...
      gimp_container_have (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_container_get_type ())))))),
                           ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((tagged)), ((gimp_object_get_type ()))))))))
    {
      gimp_container_remove (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((tagged_container)), ((gimp_container_get_type ())))))),
                             ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((tagged)), ((gimp_object_get_type ())))))));
    }
}
                               ...
                               GimpTag *tag)
{
  ...
  ref_count = ((gint) (glong) (g_hash_table_lookup (tagged_container->tag_ref_counts, tag)));

  ref_count++;
  g_hash_table_insert (tagged_container->tag_ref_counts,
                       tag, ((gpointer) (glong) (ref_count)));
  if (ref_count == 1)
    {
...
# 476 "gimptaggedcontainer.c"
gint
gimp_tagged_container_get_tag_count (GimpTaggedContainer *container)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_tagged_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAGGED_CONTAINER (container)"); return (0); }; }while (0);
