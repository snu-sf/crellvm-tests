# 1 "gimpdrawable-process.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpdrawable-process.c" 2
# 18 "gimpdrawable-process.c"
# 1 "../../config.h" 1
# 19 "gimpdrawable-process.c" 2
...
# 23 "gimpdrawable-process.c" 2

# 1 "../../app/base/gimplut.h" 1
# 24 "../../app/base/gimplut.h"
struct _GimpLut
{
  guchar **luts;
  gint nchannels;
};
# 37 "../../app/base/gimplut.h"
...
GType gimp_drawable_get_type (void) __attribute__((__const__));
...
# 29 "gimpdrawable-process.c" 2
# 1 "./gimpdrawable-process.h" 1
# 22 "./gimpdrawable-process.h"
...
void gimp_drawable_process_lut (GimpDrawable *drawable,
                                 ...
                                 const gchar *undo_desc,
                                 GimpLut *lut);
# 30 "gimpdrawable-process.c" 2
# 1 "./gimpdrawable-shadow.h" 1
# 24 "./gimpdrawable-shadow.h"
                       ...
                       gpointer data)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((drawable)); GType __t = ((gimp_drawable_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_DRAWABLE (drawable)"); return; }; }while (0);
  do{ if (gimp_item_is_attached (((((GimpItem*) g_type_check_instance_cast ((GTypeInstance*) ((drawable)), ((gimp_item_get_type ())))))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "gimp_item_is_attached (GIMP_ITEM (drawable))"); return; }; }while (0);
  do{ if (progress == ((void*)0) || (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((progress)); GType __t = ((gimp_progress_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "progress == NULL || GIMP_IS_PROGRESS (progress)"); return; }; }while (0);
  do{ if (undo_desc != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "undo_desc != NULL"); return; }; }while (0);

  if (gimp_item_mask_intersect (((((GimpItem*) g_type_check_instance_cast ((GTypeInstance*) ((drawable)), ((gimp_item_get_type ())))))), &x, &y, &width, &height))
    {
      ...
      gimp_drawable_merge_shadow_tiles (drawable, (!(0)), undo_desc);
