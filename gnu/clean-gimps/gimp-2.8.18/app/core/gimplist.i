...
static void gimp_list_init (GimpList *self); static void gimp_list_class_init (GimpListClass *klass); static gpointer gimp_list_parent_class = ((void*)0); static gint GimpList_private_offset; static void gimp_list_class_intern_init (gpointer klass) { gimp_list_parent_class = g_type_class_peek_parent (klass); if (GimpList_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpList_private_offset); gimp_list_class_init ((GimpListClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_list_get_instance_private (GimpList *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpList_private_offset)))); } GType gimp_list_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_container_get_type ()), g_intern_static_string ("GimpList"), sizeof (GimpListClass), (GClassInitFunc) gimp_list_class_intern_init, sizeof (GimpList), (GInstanceInitFunc) gimp_list_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_list_set_property (GObject *object,
                        ...
                        GParamSpec *pspec)
{
  GimpList *list = ((((GimpList*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_list_get_type ()))))));
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimplist.c", 158, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                        ...
                        GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimplist.c", 184, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                       ...
                       gint64 *gui_size)
{
  ...
  memsize += (gimp_container_get_n_children (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((list)), ((gimp_container_get_type ()))))))) *
              sizeof (GList));

  if (gimp_container_get_policy (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((list)), ((gimp_container_get_type ()))))))) ==
      GIMP_CONTAINER_POLICY_STRONG)
    {
      GList *glist;

      for (glist = list->list; glist; glist = ((glist) ? (((GList *)(glist))->next) : ((void*)0)))
        memsize += gimp_object_get_memsize (((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((glist->data)), ((gimp_object_get_type ())))))), gui_size);
    }

  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_list_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
               ...
               GimpObject *object)
{
  ...
  if (list->unique_names || list->sort_func)
    g_signal_connect_data ((object), ("name-changed"), (((GCallback) (gimp_list_object_renamed))), (list), ((void*)0), (GConnectFlags) 0);
  ...
  ((((GimpContainerClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_list_parent_class)), ((gimp_container_get_type ()))))))->add (container, object);
}
                  ...
                  GimpObject *object)
{
  ...
  if (list->unique_names || list->sort_func)
    g_signal_handlers_disconnect_matched ((object), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_list_object_renamed), (list));



  list->list = g_list_remove (list->list, object);

  ((((GimpContainerClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_list_parent_class)), ((gimp_container_get_type ()))))))->remove (container, object);
}
                ...
                const GimpObject *object)
{
  ...
  return g_list_find (list->list, object) ? (!(0)) : (0);
}
               ...
               gboolean unique_names)
{
  ...
  do{ if (g_type_is_a (children_type, (gimp_object_get_type ()))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "g_type_is_a (children_type, GIMP_TYPE_OBJECT)"); return (((void*)0)); }; }while (0);

  list = g_object_new ((gimp_list_get_type ()),
                       "children-type", children_type,
                       "policy", GIMP_CONTAINER_POLICY_STRONG,
                       "unique-names", unique_names ? (!(0)) : (0),
                       ((void*)0));


  gimp_object_set_static_name (((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((list)), ((gimp_object_get_type ())))))), g_type_name (children_type));

  return ((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((list)), ((gimp_container_get_type ()))))));
}
# 386 "gimplist.c"
GimpContainer *
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((list)); GType __t = ((gimp_list_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_LIST (list)"); return; }; }while (0);

  if (gimp_container_get_n_children (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((list)), ((gimp_container_get_type ()))))))) > 1)
    {
      gimp_container_freeze (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((list)), ((gimp_container_get_type ())))))));
      list->list = g_list_reverse (list->list);
      gimp_container_thaw (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((list)), ((gimp_container_get_type ())))))));
    }
}
# 434 "gimplist.c"
void
  ...
  if (sort_func != list->sort_func)
    {
      ...
      g_object_notify (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((list)), (((GType) ((20) << (2)))))))), "sort-func");
    }
}
# 458 "gimplist.c"
void
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((list)); GType __t = ((gimp_list_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_LIST (list)"); return; }; }while (0);
  do{ if (sort_func != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "sort_func != NULL"); return; }; }while (0);
                         ...
                         GimpObject *object)
{
  ...
  for (list = gimp_list->list; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
                          ...
                          GimpList *list)
{
  if (list->unique_names)
    {
      g_signal_handlers_block_matched ((object), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_list_object_renamed), (list));



      gimp_list_uniquefy_name (list, object);

      g_signal_handlers_unblock_matched ((object), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_list_object_renamed), (list));
  ...
  if (list->sort_func)
    {
      ...
      for (glist = list->list; glist; glist = ((glist) ? (((GList *)(glist))->next) : ((void*)0)))
        {
          GimpObject *object2 = ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((glist->data)), ((gimp_object_get_type ()))))));
      ...
      if (new_index != old_index)
        gimp_container_reorder (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((list)), ((gimp_container_get_type ())))))), object, new_index);
    }
}
