...
gimp_marshal_BOOLEAN__BOOLEAN (GClosure *closure,
                               GValue *return_value __attribute__((__unused__)),
                               guint n_param_values,
                               const GValue *param_values,
                               gpointer invocation_hint __attribute__((__unused__)),
                               gpointer marshal_data)
{
  ...
  do{ if (return_value != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "return_value != NULL"); return; }; }while (0);
  do{ if (n_param_values == 2) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "n_param_values == 2"); return; }; }while (0);
                                ...
                                gpointer marshal_data)
{
  ...
  do{ if (return_value != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "return_value != NULL"); return; }; }while (0);
  do{ if (n_param_values == 3) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "n_param_values == 3"); return; }; }while (0);
                                      ...
                                      gpointer marshal_data)
{
  ...
  v_return = callback (data1,
                       ...
                       (param_values + 2)->data[0].v_pointer,
                       data2);
                                             ...
                                             gpointer marshal_data)
{
  ...
  do{ if (return_value != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "return_value != NULL"); return; }; }while (0);
  do{ if (n_param_values == 4) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "n_param_values == 4"); return; }; }while (0);
  ...
  v_return = callback (data1,
                       (param_values + 1)->data[0].v_pointer,
                       (param_values + 2)->data[0].v_pointer,
                       (param_values + 3)->data[0].v_pointer,
                       data2);
                                            ...
                                            gpointer marshal_data)
{
  ...
  do{ if (n_param_values == 6) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "n_param_values == 6"); return; }; }while (0);
  ...
  callback (data1,
            (param_values + 1)->data[0].v_int,
            (param_values + 2)->data[0].v_int,
            (param_values + 3)->data[0].v_int,
            (param_values + 4)->data[0].v_int,
            (param_values + 5)->data[0].v_int,
            data2);
}
                                  ...
                                  gpointer marshal_data)
{
  ...
  callback (data1,
            (param_values + 1)->data[0].v_double,
            (param_values + 2)->data[0].v_double,
            data2);
}
                                                ...
                                                gpointer marshal_data)
{
  ...
  do{ if (n_param_values == 5) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "n_param_values == 5"); return; }; }while (0);
  ...
  callback (data1,
            (param_values + 1)->data[0].v_double,
            (param_values + 2)->data[0].v_double,
            (param_values + 3)->data[0].v_double,
            (param_values + 4)->data[0].v_double,
            data2);
}
                                        ...
                                        gpointer marshal_data)
{
  ...
  callback = (GMarshalFunc_VOID__ENUM_ENUM_BOXED_INT) (marshal_data ? marshal_data : cc->callback);
                                              ...
                                              gpointer marshal_data)
{
  ...
  callback (data1,
            (param_values + 1)->data[0].v_pointer,
            (param_values + 2)->data[0].v_int,
            (param_values + 3)->data[0].v_uint,
            (param_values + 4)->data[0].v_ulong,
            data2);
}
