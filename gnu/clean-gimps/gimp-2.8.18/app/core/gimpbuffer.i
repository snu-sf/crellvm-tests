...
void tile_manager_write_pixel_data_1 (TileManager *tm,
                                                 ...
                                                 const guchar *buffer);
# 28 "gimpbuffer.c" 2
# 1 "../../app/base/tile-manager-preview.h" 1
# 22 "../../app/base/tile-manager-preview.h"
...
GType gimp_buffer_get_type (void) __attribute__((__const__));
...
static void gimp_buffer_init (GimpBuffer *self); static void gimp_buffer_class_init (GimpBufferClass *klass); static gpointer gimp_buffer_parent_class = ((void*)0); static gint GimpBuffer_private_offset; static void gimp_buffer_class_intern_init (gpointer klass) { gimp_buffer_parent_class = g_type_class_peek_parent (klass); if (GimpBuffer_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpBuffer_private_offset); gimp_buffer_class_init ((GimpBufferClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_buffer_get_instance_private (GimpBuffer *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpBuffer_private_offset)))); } GType gimp_buffer_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_viewable_get_type ()), g_intern_static_string ("GimpBuffer"), sizeof (GimpBufferClass), (GClassInitFunc) gimp_buffer_class_intern_init, sizeof (GimpBuffer), (GInstanceInitFunc) gimp_buffer_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpBuffer *buffer = ((((GimpBuffer*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_buffer_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_buffer_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                         ...
                         gint64 *gui_size)
{
  ...
  memsize += tile_manager_get_memsize (buffer->tiles, (0));

  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_buffer_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
...
gimp_buffer_get_size (GimpViewable *viewable,
                      ...
                      gint *height)
{
  GimpBuffer *buffer = ((((GimpBuffer*) g_type_check_instance_cast ((GTypeInstance*) ((viewable)), ((gimp_buffer_get_type ()))))));
                            ...
                            gint *popup_height)
{
  ...
  buffer = ((((GimpBuffer*) g_type_check_instance_cast ((GTypeInstance*) ((viewable)), ((gimp_buffer_get_type ()))))));
                 ...
                 gboolean copy_pixels)
{
  ...
  do{ if (tiles != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "tiles != NULL"); return (((void*)0)); }; }while (0);
  do{ if (name != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "name != NULL"); return (((void*)0)); }; }while (0);

  buffer = g_object_new ((gimp_buffer_get_type ()),
                         "name", name,
                         ((void*)0));
                             ...
                             gint offset_y)
{
  ...
  pixel_region_init (&destPR, tiles, 0, 0, width, height, (!(0)));
  ...
  buffer = gimp_buffer_new (tiles, name, offset_x, offset_y, (0));
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((buffer)); GType __t = ((gimp_buffer_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_BUFFER (buffer)"); return (0); }; }while (0);
