...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpsubprogress.c" 2
# 18 "gimpsubprogress.c"
# 1 "../../config.h" 1
# 19 "gimpsubprogress.c" 2
...
# 23 "gimpsubprogress.c" 2

# 1 "../../app/core/gimpsubprogress.h" 1
# 30 "../../app/core/gimpsubprogress.h"
...
GType gimp_sub_progress_get_type (void) __attribute__((__const__));
...
static void gimp_sub_progress_init (GimpSubProgress *self); static void gimp_sub_progress_class_init (GimpSubProgressClass *klass); static gpointer gimp_sub_progress_parent_class = ((void*)0); static gint GimpSubProgress_private_offset; static void gimp_sub_progress_class_intern_init (gpointer klass) { gimp_sub_progress_parent_class = g_type_class_peek_parent (klass); if (GimpSubProgress_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpSubProgress_private_offset); gimp_sub_progress_class_init ((GimpSubProgressClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_sub_progress_get_instance_private (GimpSubProgress *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpSubProgress_private_offset)))); } GType gimp_sub_progress_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpSubProgress"), sizeof (GimpSubProgressClass), (GClassInitFunc) gimp_sub_progress_class_intern_init, sizeof (GimpSubProgress), (GInstanceInitFunc) gimp_sub_progress_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) gimp_sub_progress_iface_init, ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_progress_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpSubProgress *sub = ((((GimpSubProgress*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_sub_progress_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_sub_progress_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
...
{
  GimpSubProgress *sub = ((((GimpSubProgress*) g_type_check_instance_cast ((GTypeInstance*) ((progress)), ((gimp_sub_progress_get_type ()))))));
...
gimp_sub_progress_new (GimpProgress *progress)
{
  ...
  sub = g_object_new ((gimp_sub_progress_get_type ()), ((void*)0));

  if (progress)
    sub->progress = g_object_ref (progress);

  return ((((GimpProgress*) g_type_check_instance_cast ((GTypeInstance*) ((sub)), ((gimp_progress_interface_get_type ()))))));
}
# 228 "gimpsubprogress.c"
void
gimp_sub_progress_set_range (GimpSubProgress *progress,
                             gdouble start,
                             gdouble end)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((progress)); GType __t = ((gimp_sub_progress_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_SUB_PROGRESS (progress)"); return; }; }while (0);
  do{ if (start < end) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "start < end"); return; }; }while (0);

  progress->start = start;
  progress->end = end;
}
# 247 "gimpsubprogress.c"
void
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((progress)); GType __t = ((gimp_sub_progress_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_SUB_PROGRESS (progress)"); return; }; }while (0);
  do{ if (index < num_steps && num_steps > 0) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "index < num_steps && num_steps > 0"); return; }; }while (0);
