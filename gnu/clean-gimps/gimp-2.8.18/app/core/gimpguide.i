...
static void gimp_guide_init (GimpGuide *self); static void gimp_guide_class_init (GimpGuideClass *klass); static gpointer gimp_guide_parent_class = ((void*)0); static gint GimpGuide_private_offset; static void gimp_guide_class_intern_init (gpointer klass) { gimp_guide_parent_class = g_type_class_peek_parent (klass); if (GimpGuide_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpGuide_private_offset); gimp_guide_class_init ((GimpGuideClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_guide_get_instance_private (GimpGuide *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpGuide_private_offset)))); } GType gimp_guide_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpGuide"), sizeof (GimpGuideClass), (GClassInitFunc) gimp_guide_class_intern_init, sizeof (GimpGuide), (GInstanceInitFunc) gimp_guide_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_guide_class_init (GimpGuideClass *klass)
{
  ...
  gimp_guide_signals[REMOVED] =
    g_signal_new ("removed",
                  ...
                  G_SIGNAL_RUN_FIRST,
                  ((glong) __builtin_offsetof(GimpGuideClass, removed)),
                  ((void*)0), ((void*)0),
  ...
  g_object_class_install_property (object_class, PROP_ID,
                                   g_param_spec_uint ("id", ((void*)0), ((void*)0),
                                                      0, ((guint32) 0xffffffff), 0,
                                                      G_PARAM_CONSTRUCT_ONLY |
                                                      (G_PARAM_READWRITE | (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB))));

  g_object_class_install_property (object_class, PROP_ORIENTATION, g_param_spec_enum ("orientation", ((void*)0), ((void*)0), (gimp_orientation_type_get_type ()), GIMP_ORIENTATION_UNKNOWN, 0 | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_POSITION, g_param_spec_int ("position", ((void*)0), ((void*)0), -1, 262144, -1, 0 | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_guide_get_property (GObject *object,
                         ...
                         GParamSpec *pspec)
{
  GimpGuide *guide = ((((GimpGuide*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_guide_get_type ()))))));
  ...
  switch (property_id)
    ...
    case PROP_POSITION:
      ...
      break;
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpguide.c", 125, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
gimp_guide_new (GimpOrientationType orientation,
                guint32 guide_ID)
{
  return g_object_new ((gimp_guide_get_type ()),
                       "id", guide_ID,
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((guide)); GType __t = ((gimp_guide_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_GUIDE (guide)"); return (0); }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((guide)); GType __t = ((gimp_guide_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_GUIDE (guide)"); return (GIMP_ORIENTATION_UNKNOWN); }; }while (0);
...
gimp_guide_set_orientation (GimpGuide *guide,
                            GimpOrientationType orientation)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((guide)); GType __t = ((gimp_guide_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_GUIDE (guide)"); return; }; }while (0);

  guide->orientation = orientation;

  g_object_notify (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((guide)), (((GType) ((20) << (2)))))))), "orientation");
}

gint
gimp_guide_get_position (GimpGuide *guide)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((guide)); GType __t = ((gimp_guide_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_GUIDE (guide)"); return (-1); }; }while (0);
                         ...
                         gint position)
{
  ...
  g_object_notify (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((guide)), (((GType) ((20) << (2)))))))), "position");
}
