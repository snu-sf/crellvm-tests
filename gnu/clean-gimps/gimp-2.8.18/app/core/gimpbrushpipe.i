...
static void gimp_brush_pipe_init (GimpBrushPipe *self); static void gimp_brush_pipe_class_init (GimpBrushPipeClass *klass); static gpointer gimp_brush_pipe_parent_class = ((void*)0); static gint GimpBrushPipe_private_offset; static void gimp_brush_pipe_class_intern_init (gpointer klass) { gimp_brush_pipe_parent_class = g_type_class_peek_parent (klass); if (GimpBrushPipe_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpBrushPipe_private_offset); gimp_brush_pipe_class_init ((GimpBrushPipeClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_brush_pipe_get_instance_private (GimpBrushPipe *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpBrushPipe_private_offset)))); } GType gimp_brush_pipe_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_brush_get_type ()), g_intern_static_string ("GimpBrushPipe"), sizeof (GimpBrushPipeClass), (GClassInitFunc) gimp_brush_pipe_class_intern_init, sizeof (GimpBrushPipe), (GInstanceInitFunc) gimp_brush_pipe_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; };
...
gimp_brush_pipe_class_init (GimpBrushPipeClass *klass)
{
  ...
  GimpBrushClass *brush_class = ((((GimpBrushClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gimp_brush_get_type ()))))));
...
{
  GimpBrushPipe *pipe = ((((GimpBrushPipe*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_brush_pipe_get_type ()))))));
  ...
  ((((GimpBrush*) g_type_check_instance_cast ((GTypeInstance*) ((pipe)), ((gimp_brush_get_type ()))))))->mask = ((void*)0);
  ((((GimpBrush*) g_type_check_instance_cast ((GTypeInstance*) ((pipe)), ((gimp_brush_get_type ()))))))->pixmap = ((void*)0);

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_brush_pipe_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                             ...
                             gint64 *gui_size)
{
  ...
  memsize += pipe->dimension * (sizeof (gint) +
                                sizeof (gint) +
                                sizeof (PipeSelectModes));

  for (i = 0; i < pipe->n_brushes; i++)
    memsize += gimp_object_get_memsize (((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((pipe->brushes[i])), ((gimp_object_get_type ())))))),
                                        gui_size);

  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_brush_pipe_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
...
{
  GimpBrushPipe *pipe = ((((GimpBrushPipe*) g_type_check_instance_cast ((GTypeInstance*) ((brush)), ((gimp_brush_pipe_get_type ()))))));
  gint i;

  ((((GimpBrushClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_brush_pipe_parent_class)), ((gimp_brush_get_type ()))))))->begin_use (brush);
...
gimp_brush_pipe_end_use (GimpBrush *brush)
{
  ...
  ((((GimpBrushClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_brush_pipe_parent_class)), ((gimp_brush_get_type ()))))))->end_use (brush);
                              ...
                              const GimpCoords *current_coords)
{
  ...
  if (pipe->n_brushes == 1)
    return ((((GimpBrush*) g_type_check_instance_cast ((GTypeInstance*) ((pipe->current)), ((gimp_brush_get_type ()))))));
  ...
  for (i = 0; i < pipe->dimension; i++)
    {
      switch (pipe->select[i])
        ...
        case PIPE_SELECT_VELOCITY:
          ix = ((int) ((current_coords->velocity * pipe->rank[i]) + 0.5));
          break;
      ...
      pipe->index[i] = (((ix) > (pipe->rank[i] - 1)) ? (pipe->rank[i] - 1) : (((ix) < (0)) ? (0) : (ix)));
      brushix += pipe->stride[i] * pipe->index[i];
    }


  brushix = (((brushix) > (pipe->n_brushes - 1)) ? (pipe->n_brushes - 1) : (((brushix) < (0)) ? (0) : (brushix)));
