...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpbezierdesc.c" 2
# 21 "gimpbezierdesc.c"
# 1 "../../config.h" 1
# 22 "gimpbezierdesc.c" 2
                      ...
                      gint n_data)
{
  ...
  do{ if (n_data == 0 || data != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "n_data == 0 || data != NULL"); return (((void*)0)); }; }while (0);

  desc = ((GimpBezierDesc*) g_slice_alloc (sizeof (GimpBezierDesc)));
  ...
  for (i = 0; i < n_points; i++)
    {
      ...
      if (i == 0 ||
          ...
          prev.y != points[i].y)
        {
          ...
          g_array_append_vals (path_data, &(pd), 1);
                                      ...
                                      gint n_bound_groups)
{
  ...
  do{ if (bound_segs != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "bound_segs != NULL"); return (((void*)0)); }; }while (0);
  do{ if (n_bound_segs > 0) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "n_bound_segs > 0"); return (((void*)0)); }; }while (0);

  path_data = g_array_new ((0), (0), sizeof (cairo_path_data_t));

  points = ((GimpVector2 *) g_malloc0_n ((n_bound_segs + 4), sizeof (GimpVector2)));
  ...
  for (i = 0; i < n_bound_groups; i++)
    {
      ...
      add_polyline (path_data, points, n_points, (!(0)));
  ...
  return gimp_bezier_desc_new ((cairo_path_data_t *) g_array_free (path_data, (0)),
                               path_data_len);
}
                            ...
                            gdouble offset_y)
{
  ...
  do{ if (desc != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "desc != NULL"); return; }; }while (0);
...
{
  do{ if (desc != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "desc != NULL"); return (((void*)0)); }; }while (0);
...
gimp_bezier_desc_free (GimpBezierDesc *desc)
{
  ...
  g_free (desc->data);
  do { if (1) g_slice_free1 (sizeof (GimpBezierDesc), (desc)); else (void) ((GimpBezierDesc*) 0 == (desc)); } while (0);
}
