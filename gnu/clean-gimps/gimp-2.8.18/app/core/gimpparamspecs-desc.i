# 1 "gimpparamspecs-desc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpparamspecs-desc.c" 2
# 18 "gimpparamspecs-desc.c"
# 1 "../../config.h" 1
# 19 "gimpparamspecs-desc.c" 2
...
# 27 "gimpparamspecs-desc.c" 2

# 1 "./gimpparamspecs.h" 1
# 36 "./gimpparamspecs.h"
...
void gimp_value_take_colorarray (GValue *value,
                                                  GimpRGB *array,
                                                  gsize length);
# 29 "gimpparamspecs-desc.c" 2
# 1 "./gimpparamspecs-desc.h" 1
# 22 "./gimpparamspecs-desc.h"
gchar * gimp_param_spec_get_desc (GParamSpec *pspec);
# 30 "gimpparamspecs-desc.c" 2
...
gimp_param_spec_boolean_desc (GParamSpec *pspec)
{
  ...
  return g_strconcat (blurb, " (TRUE or FALSE)", ((void*)0));
}

static gchar *
gimp_param_spec_int32_desc (GParamSpec *pspec)
{
  GParamSpecInt *ispec = ((((GParamSpecInt*) g_type_check_instance_cast ((GTypeInstance*) ((pspec)), ((g_param_spec_types[3]))))));
  const gchar *blurb = gimp_param_spec_get_blurb (pspec);

  if (ispec->minimum == ((gint32) 0x80000000) && ispec->maximum == ((gint32) 0x7fffffff))
    return g_strdup (blurb);

  if (ispec->minimum == ((gint32) 0x80000000))
    return g_strdup_printf ("%s (%s <= %d)", blurb,
                            g_param_spec_get_name (pspec),
                            ispec->maximum);

  if (ispec->maximum == ((gint32) 0x7fffffff))
    return g_strdup_printf ("%s (%s >= %d)", blurb,
                            g_param_spec_get_name (pspec),
                            ispec->minimum);
...
{
  GParamSpecDouble *dspec = ((((GParamSpecDouble*) g_type_check_instance_cast ((GTypeInstance*) ((pspec)), ((g_param_spec_types[13]))))));
  const gchar *blurb = gimp_param_spec_get_blurb (pspec);

  if (dspec->minimum == - 1.7976931348623157e+308 && dspec->maximum == 1.7976931348623157e+308)
    return g_strdup (blurb);

  if (dspec->minimum == - 1.7976931348623157e+308)
    return g_strdup_printf ("%s (%s <= %g)", blurb,
                            g_param_spec_get_name (pspec),
                            dspec->maximum);

  if (dspec->maximum == 1.7976931348623157e+308)
    return g_strdup_printf ("%s (%s >= %g)", blurb,
                            g_param_spec_get_name (pspec),
                            dspec->minimum);
...
gimp_param_spec_enum_desc (GParamSpec *pspec)
{
  ...
  if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((pspec)); GType __t = ((gimp_param_enum_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
    excluded = ((((GimpParamSpecEnum*) g_type_check_instance_cast ((GTypeInstance*) ((pspec)), ((gimp_param_enum_get_type ()))))))->excluded_values;
  else
    excluded = ((void*)0);
  ...
  for (i = 0, n = 0, enum_value = enum_class->values;
       ...
       i++, enum_value++)
    {
      ...
      for (list = excluded; list; list = list->next)
        {
          gint value = ((gint) (glong) (list->data));
      ...
      if ((g_str_has_prefix (enum_value->value_name, "GIMP_")))
...
# 165 "gimpparamspecs-desc.c"
gchar *
gimp_param_spec_get_desc (GParamSpec *pspec)
{
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((pspec)), (((GType) ((19) << (2))))))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "G_IS_PARAM_SPEC (pspec)"); return (((void*)0)); }; }while (0);

  if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((pspec)); GType __t = ((gimp_param_unit_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
    {
    }
  else if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((pspec)); GType __t = ((gimp_param_int32_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
    {
