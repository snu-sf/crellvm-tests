...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpfilloptions.c" 2
# 21 "gimpfilloptions.c"
# 1 "../../config.h" 1
# 22 "gimpfilloptions.c" 2
...
# 31 "gimpfilloptions.c" 2
# 1 "./gimpfilloptions.h" 1
# 25 "./gimpfilloptions.h"
# 1 "./gimpcontext.h" 1
# 25 "./gimpcontext.h"
# 1 "./gimpviewable.h" 1
# 27 "./gimpviewable.h"
...
GType gimp_viewable_get_type (void) __attribute__((__const__));
...
GType gimp_context_get_type (void) __attribute__((__const__));
...
# 26 "./gimpfilloptions.h" 2
# 36 "./gimpfilloptions.h"
...
GType gimp_fill_options_get_type (void) __attribute__((__const__));
...
static void gimp_fill_options_init (GimpFillOptions *self); static void gimp_fill_options_class_init (GimpFillOptionsClass *klass); static gpointer gimp_fill_options_parent_class = ((void*)0); static gint GimpFillOptions_private_offset; static void gimp_fill_options_class_intern_init (gpointer klass) { gimp_fill_options_parent_class = g_type_class_peek_parent (klass); if (GimpFillOptions_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpFillOptions_private_offset); gimp_fill_options_class_init ((GimpFillOptionsClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_fill_options_get_instance_private (GimpFillOptions *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpFillOptions_private_offset)))); } GType gimp_fill_options_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_context_get_type ()), g_intern_static_string ("GimpFillOptions"), sizeof (GimpFillOptionsClass), (GClassInitFunc) gimp_fill_options_class_intern_init, sizeof (GimpFillOptions), (GInstanceInitFunc) gimp_fill_options_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_fill_options_class_init (GimpFillOptionsClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_STYLE, g_param_spec_enum ("style", ((void*)0), ((void*)0), (gimp_fill_style_get_type ()), GIMP_FILL_STYLE_SOLID, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));





  g_object_class_install_property (object_class, PROP_ANTIALIAS, g_param_spec_boolean ("antialias", ((void*)0), ((void*)0), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_fill_options_set_property (GObject *object,
                                ...
                                GParamSpec *pspec)
{
  GimpFillOptionsPrivate *private = ((GimpFillOptionsPrivate*) g_type_instance_get_private ((GTypeInstance*) (object), ((gimp_fill_options_get_type ()))));
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpfilloptions.c", 145, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                ...
                                GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpfilloptions.c", 175, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((options)); GType __t = ((gimp_fill_options_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_FILL_OPTIONS (options)"); return (GIMP_FILL_STYLE_SOLID); }; }while (0);

  return ((GimpFillOptionsPrivate*) g_type_instance_get_private ((GTypeInstance*) (options), ((gimp_fill_options_get_type ()))))->style;
}

gboolean
gimp_fill_options_get_antialias (GimpFillOptions *options)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((options)); GType __t = ((gimp_fill_options_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_FILL_OPTIONS (options)"); return ((0)); }; }while (0);

  return ((GimpFillOptionsPrivate*) g_type_instance_get_private ((GTypeInstance*) (options), ((gimp_fill_options_get_type ()))))->antialias;
}
