# 1 "gimptoolpreset-save.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimptoolpreset-save.c" 2
# 18 "gimptoolpreset-save.c"
# 1 "../../config.h" 1
# 19 "gimptoolpreset-save.c" 2
...
# 27 "gimptoolpreset-save.c" 2
# 1 "./gimptoolpreset-save.h" 1
# 23 "./gimptoolpreset-save.h"
gboolean gimp_tool_preset_save (GimpData *data,
                                  GError **error);
# 28 "gimptoolpreset-save.c" 2
...
gimp_tool_preset_save (GimpData *data,
                       GError **error)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((data)); GType __t = ((gimp_tool_preset_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TOOL_PRESET (data)"); return ((0)); }; }while (0);
  ...
  return gimp_config_serialize_to_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((data)), ((gimp_config_interface_get_type ())))))),
