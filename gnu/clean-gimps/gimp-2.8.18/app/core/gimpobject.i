  ...
  if (! object_type)
    {
      ...
      object_type = g_type_register_static (((GType) ((20) << (2))),
                                            "GimpObject",
                                            &object_info, 0);
    }
...
gimp_object_class_init (GimpObjectClass *klass)
{
  ...
  object_signals[DISCONNECT] =
    g_signal_new ("disconnect",
                  ...
                  G_SIGNAL_RUN_FIRST,
                  ((glong) __builtin_offsetof(GimpObjectClass, disconnect)),
                  ((void*)0), ((void*)0),
  ...
  object_signals[NAME_CHANGED] =
    g_signal_new ("name-changed",
                  (((GTypeClass*) (klass))->g_type),
                  G_SIGNAL_RUN_FIRST,
                  ((glong) __builtin_offsetof(GimpObjectClass, name_changed)),
                  ((void*)0), ((void*)0),
                  g_cclosure_marshal_VOID__VOID,
                  ((GType) ((1) << (2))), 0);
  ...
  klass->disconnect = ((void*)0);
  klass->name_changed = ((void*)0);
...
gimp_object_init (GimpObject *object,
                  GimpObjectClass *klass)
{
  object->p = ((GimpObjectPrivate*) g_type_instance_get_private ((GTypeInstance*) (object), ((gimp_object_get_type ()))));


  object->p->name = ((void*)0);
  object->p->normalized = ((void*)0);

  gimp_debug_add_instance (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), (((GType) ((20) << (2)))))))), ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), (((GType) ((20) << (2)))))))));
}

static void
gimp_object_dispose (GObject *object)
{
  GimpObject *gimp_object = ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_object_get_type ()))))));

  if (! gimp_object->p->disconnected)
    {
      g_signal_emit (object, object_signals[DISCONNECT], 0);

      gimp_object->p->disconnected = (!(0));
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((parent_class)), (((GType) ((20) << (2))))))))->dispose (object);
}

static void
gimp_object_finalize (GObject *object)
{
  gimp_object_name_free (((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_object_get_type ())))))));
                          ...
                          GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_NAME:
      ...
      break;
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpobject.c", 205, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                      ...
                      const gchar *name)
{
  ...
  object->p->static_name = (0);

  gimp_object_name_changed (object);
  g_object_notify (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), (((GType) ((20) << (2)))))))), "name");
}
# 267 "gimpobject.c"
void
...
gimp_object_get_name (gconstpointer object)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object_typed)); GType __t = ((gimp_object_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_OBJECT (object_typed)"); return (((void*)0)); }; }while (0);
...
{
  do{ if (object->p->normalized == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "object->p->normalized == NULL"); return; }; }while (0);
                         ...
                         gint64 *gui_size)
{
  ...
  do{ if (object == ((void*)0) || (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gimp_object_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "object == NULL || GIMP_IS_OBJECT (object)"); return (0); }; }while (0);
  ...
  if (gimp_debug_memsize)
    {
      ...
      static GList *aggregation_tree = ((void*)0);
      ...
      memsize = ((((GimpObjectClass*) (((GTypeInstance*) ((object)))->g_class))))->get_memsize (object,
                                                             &gui_memsize);

      indent_level--;

      for (i = 0; i < (((my_indent_level * 2) < (sizeof (indent_buf) - 1)) ? (my_indent_level * 2) : (sizeof (indent_buf) - 1)); i++)
        indent_buf[i] = ' ';
      ...
      if (indent_level == 0)
        {
          ...
          for (list = aggregation_tree; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
            {
  ...
  my_size = ((((GimpObjectClass*) (((GTypeInstance*) ((object)))->g_class))))->get_memsize (object,
                                                         &my_gui_size);
