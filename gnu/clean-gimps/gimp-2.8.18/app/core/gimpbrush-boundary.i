# 1 "gimpbrush-boundary.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpbrush-boundary.c" 2
# 18 "gimpbrush-boundary.c"
# 1 "../../config.h" 1
# 19 "gimpbrush-boundary.c" 2
...
# 24 "gimpbrush-boundary.c" 2

# 1 "../../app/base/boundary.h" 1
# 26 "../../app/base/boundary.h"
typedef enum
{
...
void gimp_brush_set_spacing (GimpBrush *brush,
                                                      gint spacing);
# 31 "gimpbrush-boundary.c" 2
# 1 "./gimpbrush-boundary.h" 1
# 22 "./gimpbrush-boundary.h"
