# 1 "gimpgradient-save.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpgradient-save.c" 2
# 18 "gimpgradient-save.c"
# 1 "../../config.h" 1
# 19 "gimpgradient-save.c" 2
...
GType gimp_gradient_get_type (void) __attribute__((__const__));
...
# 31 "gimpgradient-save.c" 2
# 1 "./gimpgradient-save.h" 1
# 23 "./gimpgradient-save.h"
...
gimp_gradient_save (GimpData *data,
                    GError **error)
{
  GimpGradient *gradient = ((((GimpGradient*) g_type_check_instance_cast ((GTypeInstance*) ((data)), ((gimp_gradient_get_type ()))))));
  GimpGradientSegment *seg;
  gint num_segments;
  FILE *file;

  file = fopen (gimp_data_get_filename (data), "wb");

  if (! file)
    {
      g_set_error (error, (gimp_data_error_quark ()), GIMP_DATA_ERROR_OPEN,
                   gettext ("Could not open '%s' for writing: %s"),
                   gimp_filename_to_utf8 (gimp_data_get_filename (data)),
                   g_strerror ((*__errno_location ())));
      return (0);
    }
# 66 "gimpgradient-save.c"
  ...
  for (seg = gradient->segments; seg; seg = seg->next)
    {
      ...
      g_ascii_formatd (buf[0], (29 + 10),
                       "%f", seg->left);
      g_ascii_formatd (buf[1], (29 + 10),
                       "%f", seg->middle);
      g_ascii_formatd (buf[2], (29 + 10),
                       "%f", seg->right);
      g_ascii_formatd (buf[3], (29 + 10),
                       "%f", seg->left_color.r);
      g_ascii_formatd (buf[4], (29 + 10),
                       "%f", seg->left_color.g);
      g_ascii_formatd (buf[5], (29 + 10),
                       "%f", seg->left_color.b);
      g_ascii_formatd (buf[6], (29 + 10),
                       "%f", seg->left_color.a);
      g_ascii_formatd (buf[7], (29 + 10),
                       "%f", seg->right_color.r);
      g_ascii_formatd (buf[8], (29 + 10),
                       "%f", seg->right_color.g);
      g_ascii_formatd (buf[9], (29 + 10),
                       "%f", seg->right_color.b);
      g_ascii_formatd (buf[10], (29 + 10),
                       "%f", seg->right_color.a);
                        ...
                        GError **error)
{
  ...
  GimpGradientSegment *seg;
  gchar buf[(29 + 10)];
  gchar color_buf[4][(29 + 10)];

  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((gradient)); GType __t = ((gimp_gradient_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_GRADIENT (gradient)"); return ((0)); }; }while (0);
  do{ if (filename != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "filename != NULL"); return ((0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "error == NULL || *error == NULL"); return ((0)); }; }while (0);
      ...
      for (seg = gradient->segments; seg; seg = seg->next)
        {
          ...
          g_ascii_formatd (buf, (29 + 10), "%f",
                           seg->left);
          g_ascii_formatd (color_buf[0], (29 + 10), "%f",
                           seg->left_color.r);
          g_ascii_formatd (color_buf[1], (29 + 10), "%f",
                           seg->left_color.g);
          g_ascii_formatd (color_buf[2], (29 + 10), "%f",
                           seg->left_color.b);
          g_ascii_formatd (color_buf[3], (29 + 10), "%f",
