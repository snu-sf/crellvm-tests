# 1 "gimppattern-load.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppattern-load.c" 2
# 18 "gimppattern-load.c"
# 1 "../../config.h" 1
# 19 "gimppattern-load.c" 2
...
gboolean g_close (gint fd,
                  GError **error);
# 35 "gimppattern-load.c" 2
# 44 "gimppattern-load.c"
...
# 51 "gimppattern-load.c" 2
# 1 "./gimppattern-header.h" 1
# 26 "./gimppattern-header.h"
                   ...
                   GError **error)
{
  ...
  if (read (fd, &header, sizeof (header)) != sizeof (header))
    {
      g_set_error (error, (gimp_data_error_quark ()), GIMP_DATA_ERROR_READ,
                   gettext ("Fatal parse error in pattern file '%s': " "File appears truncated."),
  ...
  header.header_size = ((((((guint32) ( (((guint32) (header.header_size) & (guint32) 0x000000ffU) << 24) | (((guint32) (header.header_size) & (guint32) 0x0000ff00U) << 8) | (((guint32) (header.header_size) & (guint32) 0x00ff0000U) >> 8) | (((guint32) (header.header_size) & (guint32) 0xff000000U) >> 24)))))));
  header.version = ((((((guint32) ( (((guint32) (header.version) & (guint32) 0x000000ffU) << 24) | (((guint32) (header.version) & (guint32) 0x0000ff00U) << 8) | (((guint32) (header.version) & (guint32) 0x00ff0000U) >> 8) | (((guint32) (header.version) & (guint32) 0xff000000U) >> 24)))))));
  header.width = ((((((guint32) ( (((guint32) (header.width) & (guint32) 0x000000ffU) << 24) | (((guint32) (header.width) & (guint32) 0x0000ff00U) << 8) | (((guint32) (header.width) & (guint32) 0x00ff0000U) >> 8) | (((guint32) (header.width) & (guint32) 0xff000000U) >> 24)))))));
  header.height = ((((((guint32) ( (((guint32) (header.height) & (guint32) 0x000000ffU) << 24) | (((guint32) (header.height) & (guint32) 0x0000ff00U) << 8) | (((guint32) (header.height) & (guint32) 0x00ff0000U) >> 8) | (((guint32) (header.height) & (guint32) 0xff000000U) >> 24)))))));
  header.bytes = ((((((guint32) ( (((guint32) (header.bytes) & (guint32) 0x000000ffU) << 24) | (((guint32) (header.bytes) & (guint32) 0x0000ff00U) << 8) | (((guint32) (header.bytes) & (guint32) 0x00ff0000U) >> 8) | (((guint32) (header.bytes) & (guint32) 0xff000000U) >> 24)))))));
  header.magic_number = ((((((guint32) ( (((guint32) (header.magic_number) & (guint32) 0x000000ffU) << 24) | (((guint32) (header.magic_number) & (guint32) 0x0000ff00U) << 8) | (((guint32) (header.magic_number) & (guint32) 0x00ff0000U) >> 8) | (((guint32) (header.magic_number) & (guint32) 0xff000000U) >> 24)))))));


  if (header.magic_number != (('G' << 24) + ('P' << 16) + ('A' << 8) + ('T' << 0)) || header.version != 1 ||
      header.header_size <= sizeof (header))
    {
      g_set_error (error, (gimp_data_error_quark ()), GIMP_DATA_ERROR_READ,
                   gettext ("Fatal parse error in pattern file '%s': " "Unknown pattern format version %d."),
  ...
  if (header.bytes < 1 || header.bytes > 4)
    {
      g_set_error (error, (gimp_data_error_quark ()), GIMP_DATA_ERROR_READ,
                   gettext ("Fatal parse error in pattern file '%s: " "Unsupported pattern depth %d.\n" "GIMP Patterns must be GRAY or RGB."),
  ...
  if ((bn_size = (header.header_size - sizeof (header))))
    {
      ...
      name = ((gchar *) g_malloc_n ((bn_size), sizeof (gchar)));
      ...
      utf8 = gimp_any_to_utf8 (name, -1,
                               gettext ("Invalid UTF-8 string in pattern file '%s'."),
                               gimp_filename_to_utf8 (filename));
      g_free (name);
      name = utf8;
    }
  ...
  return g_list_prepend (((void*)0), pattern);
                          ...
                          GError **error)
{
  ...
  pattern->mask = temp_buf_new (width, height, bytes, 0, 0, ((void*)0));
