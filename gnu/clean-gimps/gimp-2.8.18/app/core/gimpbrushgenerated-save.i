# 1 "gimpbrushgenerated-save.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpbrushgenerated-save.c" 2
# 20 "gimpbrushgenerated-save.c"
# 1 "../../config.h" 1
# 21 "gimpbrushgenerated-save.c" 2
...
# 23 "gimpbrushgenerated-save.c" 2
...
# 24 "gimpbrushgenerated-save.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 25 "gimpbrushgenerated-save.c" 2
...
# 28 "gimpbrushgenerated-save.c" 2
...
# 31 "gimpbrushgenerated-save.c" 2
...
gboolean g_close (gint fd,
                  GError **error);
# 32 "gimpbrushgenerated-save.c" 2
...
# 34 "gimpbrushgenerated-save.c" 2
...
# 36 "gimpbrushgenerated-save.c" 2
...
void temp_buf_dump (TempBuf *buf,
                                  const gchar *filename);
# 38 "gimpbrushgenerated-save.c" 2
...
# 40 "gimpbrushgenerated-save.c" 2
# 1 "./gimpbrushgenerated-save.h" 1
# 25 "./gimpbrushgenerated-save.h"
gboolean gimp_brush_generated_save (GimpData *data,
                                      GError **error);
# 41 "gimpbrushgenerated-save.c" 2
...
# 43 "gimpbrushgenerated-save.c" 2
...
gimp_brush_generated_save (GimpData *data,
                           GError **error)
{
  GimpBrushGenerated *brush = ((((GimpBrushGenerated*) g_type_check_instance_cast ((GTypeInstance*) ((data)), ((gimp_brush_generated_get_type ()))))));
  const gchar *name = gimp_object_get_name (data);
  FILE *file;
  gchar buf[(29 + 10)];
  gboolean have_shape = (0);

  do{ if (name != ((void*)0) && *name != '\0') { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "name != NULL && *name != '\\0'"); return ((0)); }; }while (0);
  ...
  fprintf (file, "%s\n",
           g_ascii_formatd (buf, (29 + 10), "%f",
                            gimp_brush_get_spacing (((((GimpBrush*) g_type_check_instance_cast ((GTypeInstance*) ((brush)), ((gimp_brush_get_type ())))))))));
