# 1 "gimpbrushpipe-load.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpbrushpipe-load.c" 2
# 19 "gimpbrushpipe-load.c"
# 1 "../../config.h" 1
# 20 "gimpbrushpipe-load.c" 2
...
# 44 "gimpbrushpipe-load.c" 2
# 1 "../../libgimpbase/gimpparasiteio.h" 1
# 41 "../../libgimpbase/gimpparasiteio.h"
...
gchar * gimp_pixpipe_params_build (GimpPixPipeParams *params) __attribute__((__malloc__));
# 45 "gimpbrushpipe-load.c" 2
...
void temp_buf_dump (TempBuf *buf,
                                  const gchar *filename);
# 49 "gimpbrushpipe-load.c" 2

# 1 "./gimpbrush-load.h" 1
# 28 "./gimpbrush-load.h"
...
GType gimp_brush_get_type (void) __attribute__((__const__));
...
GType gimp_brush_pipe_get_type (void) __attribute__((__const__));
# 52 "gimpbrushpipe-load.c" 2
# 1 "./gimpbrushpipe-load.h" 1
# 26 "./gimpbrushpipe-load.h"
GList * gimp_brush_pipe_load (GimpContext *context,
                              const gchar *filename,
                              GError **error);
# 53 "gimpbrushpipe-load.c" 2
                      ...
                      GError **error)
{
  ...
  do{ if (filename != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "filename != NULL"); return (((void*)0)); }; }while (0);
  do{ if (g_path_is_absolute (filename)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "g_path_is_absolute (filename)"); return (((void*)0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "error == NULL || *error == NULL"); return (((void*)0)); }; }while (0);

  fd = open (filename, 00 | 0, 0);

  if (fd == -1)
    {
      g_set_error (error, (gimp_data_error_quark ()), GIMP_DATA_ERROR_OPEN,
                   gettext ("Could not open '%s' for reading: %s"),
                   gimp_filename_to_utf8 (filename), g_strerror ((*__errno_location ())));
      return ((void*)0);
    }
  ...
  buffer = g_string_new (((void*)0));
  while (read (fd, &c, 1) == 1 && c != '\n' && buffer->len < 1024)
    g_string_append_c_inline (buffer, c);

  if (buffer->len > 0 && buffer->len < 1024)
    {
      gchar *utf8 =
        gimp_any_to_utf8 (buffer->str, buffer->len,
                          gettext ("Invalid UTF-8 string in brush file '%s'."),
                          gimp_filename_to_utf8 (filename));

      pipe = g_object_new ((gimp_brush_pipe_get_type ()),
                           "name", utf8,
  ...
  if (! pipe)
    {
      g_set_error (error, (gimp_data_error_quark ()), GIMP_DATA_ERROR_READ,
                   gettext ("Fatal parse error in brush file '%s': " "File is corrupt."),
  ...
  while (*paramstring && ((g_ascii_table[(guchar) (*paramstring)] & G_ASCII_SPACE) != 0))
    paramstring++;
  ...
  if (*paramstring)
    {
      ...
      pipe->rank = ((gint *) g_malloc0_n ((pipe->dimension), sizeof (gint)));
      pipe->select = ((PipeSelectModes *) g_malloc0_n ((pipe->dimension), sizeof (PipeSelectModes)));
      pipe->index = ((gint *) g_malloc0_n ((pipe->dimension), sizeof (gint)));
      ...
      for (i = 0; i < pipe->dimension; i++)
        {
          pipe->rank[i] = (((1) > (params.rank[i])) ? (1) : (params.rank[i]));
    ...
    {
      pipe->dimension = 1;
      pipe->rank = ((gint *) g_malloc_n ((1), sizeof (gint)));
      pipe->rank[0] = num_of_brushes;
      pipe->select = ((PipeSelectModes *) g_malloc_n ((1), sizeof (PipeSelectModes)));
      pipe->select[0] = PIPE_SELECT_INCREMENTAL;
      pipe->index = ((gint *) g_malloc_n ((1), sizeof (gint)));
      pipe->index[0] = 0;
    }
  ...
  pipe->stride = ((gint *) g_malloc0_n ((pipe->dimension), sizeof (gint)));
  for (i = 0; i < pipe->dimension; i++)
    {
      if (i == 0)
  ...
  do { if (pipe->stride[pipe->dimension-1] == 1) ; else g_assertion_message_expr ("Gimp-Core", "gimpbrushpipe-load.c", 207, ((const char*) (__func__)), "pipe->stride[pipe->dimension-1] == 1"); } while (0);

  pipe->brushes = ((GimpBrush * *) g_malloc0_n ((num_of_brushes), sizeof (GimpBrush *)));

  while (pipe->n_brushes < num_of_brushes)
    {
      GError *my_error = ((void*)0);
      ...
      if (pipe->brushes[pipe->n_brushes])
        {
          gimp_object_set_name (((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((pipe->brushes[pipe->n_brushes])), ((gimp_object_get_type ())))))),
                                ((void*)0));
        }
      else
        {
  ...
  ((((GimpBrush*) g_type_check_instance_cast ((GTypeInstance*) ((pipe)), ((gimp_brush_get_type ()))))))->spacing = pipe->current->spacing;
  ((((GimpBrush*) g_type_check_instance_cast ((GTypeInstance*) ((pipe)), ((gimp_brush_get_type ()))))))->x_axis = pipe->current->x_axis;
  ((((GimpBrush*) g_type_check_instance_cast ((GTypeInstance*) ((pipe)), ((gimp_brush_get_type ()))))))->y_axis = pipe->current->y_axis;
  ((((GimpBrush*) g_type_check_instance_cast ((GTypeInstance*) ((pipe)), ((gimp_brush_get_type ()))))))->mask = pipe->current->mask;
  ((((GimpBrush*) g_type_check_instance_cast ((GTypeInstance*) ((pipe)), ((gimp_brush_get_type ()))))))->pixmap = pipe->current->pixmap;

  return g_list_prepend (((void*)0), pipe);
}
