# 1 "gimpdocumentlist.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpdocumentlist.c" 2
# 18 "gimpdocumentlist.c"
# 1 "../../config.h" 1
# 19 "gimpdocumentlist.c" 2
...
# 29 "gimpdocumentlist.c" 2
# 1 "./gimpdocumentlist.h" 1
# 21 "./gimpdocumentlist.h"
# 1 "../../app/core/gimplist.h" 1
# 25 "../../app/core/gimplist.h"
# 1 "./gimpcontainer.h" 1
# 36 "./gimpcontainer.h"
...
void gimp_container_remove_handler (GimpContainer *container,
                                                GQuark id);
# 26 "../../app/core/gimplist.h" 2
# 36 "../../app/core/gimplist.h"
...
# 22 "./gimpdocumentlist.h" 2
# 31 "./gimpdocumentlist.h"
...
GType gimp_imagefile_get_type (void) __attribute__((__const__));
...
# 31 "gimpdocumentlist.c" 2


static void gimp_document_list_init (GimpDocumentList *self); static void gimp_document_list_class_init (GimpDocumentListClass *klass); static gpointer gimp_document_list_parent_class = ((void*)0); static gint GimpDocumentList_private_offset; static void gimp_document_list_class_intern_init (gpointer klass) { gimp_document_list_parent_class = g_type_class_peek_parent (klass); if (GimpDocumentList_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpDocumentList_private_offset); gimp_document_list_class_init ((GimpDocumentListClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_document_list_get_instance_private (GimpDocumentList *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpDocumentList_private_offset)))); } GType gimp_document_list_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_list_get_type ()), g_intern_static_string ("GimpDocumentList"), sizeof (GimpDocumentListClass), (GClassInitFunc) gimp_document_list_class_intern_init, sizeof (GimpDocumentList), (GInstanceInitFunc) gimp_document_list_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_document_list_new (Gimp *gimp)
{
  ...
  document_list = g_object_new ((gimp_document_list_get_type ()),
                                "name", "document-list",
                                "children-type", (gimp_imagefile_get_type ()),
                                "policy", GIMP_CONTAINER_POLICY_STRONG,
                                ((void*)0));

  document_list->gimp = gimp;

  return ((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((document_list)), ((gimp_container_get_type ()))))));
}
                            ...
                            const gchar *mime_type)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((document_list)); GType __t = ((gimp_document_list_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_DOCUMENT_LIST (document_list)"); return (((void*)0)); }; }while (0);
  do{ if (uri != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "uri != NULL"); return (((void*)0)); }; }while (0);

  gimp = document_list->gimp;

  container = ((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((document_list)), ((gimp_container_get_type ()))))));
  ...
  if (imagefile)
    {
      gimp_container_reorder (container, ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((imagefile)), ((gimp_object_get_type ())))))), 0);
    }
  else
    {
      imagefile = gimp_imagefile_new (gimp, uri);
      gimp_container_add (container, ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((imagefile)), ((gimp_object_get_type ())))))));
