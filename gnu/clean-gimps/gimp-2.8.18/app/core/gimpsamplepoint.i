...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpsamplepoint.c" 2
# 18 "gimpsamplepoint.c"
# 1 "../../config.h" 1
# 19 "gimpsamplepoint.c" 2
...
gimp_sample_point_new (guint32 sample_point_ID)
{
  ...
  sample_point = ((GimpSamplePoint*) g_slice_alloc0 (sizeof (GimpSamplePoint)));
...
{
  do{ if (sample_point != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "sample_point != NULL"); return (((void*)0)); }; }while (0);
...
{
  do{ if (sample_point != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "sample_point != NULL"); return; }; }while (0);

  sample_point->ref_count--;

  if (sample_point->ref_count < 1)
    do { if (1) g_slice_free1 (sizeof (GimpSamplePoint), (sample_point)); else (void) ((GimpSamplePoint*) 0 == (sample_point)); } while (0);
}
