# 1 "gimpimagemapconfig.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpimagemapconfig.c" 2
# 21 "gimpimagemapconfig.c"
# 1 "../../config.h" 1
# 22 "gimpimagemapconfig.c" 2
...
# 30 "gimpimagemapconfig.c" 2

# 1 "./gimpimagemapconfig.h" 1
# 25 "./gimpimagemapconfig.h"
# 1 "./gimpviewable.h" 1
# 25 "./gimpviewable.h"
# 1 "./gimpobject.h" 1
# 30 "./gimpobject.h"
...
# 26 "./gimpimagemapconfig.h" 2
# 36 "./gimpimagemapconfig.h"
...
static void gimp_image_map_config_init (GimpImageMapConfig *self); static void gimp_image_map_config_class_init (GimpImageMapConfigClass *klass); static gpointer gimp_image_map_config_parent_class = ((void*)0); static gint GimpImageMapConfig_private_offset; static void gimp_image_map_config_class_intern_init (gpointer klass) { gimp_image_map_config_parent_class = g_type_class_peek_parent (klass); if (GimpImageMapConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpImageMapConfig_private_offset); gimp_image_map_config_class_init ((GimpImageMapConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_image_map_config_get_instance_private (GimpImageMapConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpImageMapConfig_private_offset)))); } GType gimp_image_map_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_viewable_get_type ()), g_intern_static_string ("GimpImageMapConfig"), sizeof (GimpImageMapConfigClass), (GClassInitFunc) gimp_image_map_config_class_intern_init, sizeof (GimpImageMapConfig), (GInstanceInitFunc) gimp_image_map_config_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_image_map_config_class_init (GimpImageMapConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_TIME, g_param_spec_uint ("time", ((void*)0), "Time of settings creation", 0, (2147483647 *2U +1U), 0, 0 | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_image_map_config_get_property (GObject *object,
                                    ...
                                    GParamSpec *pspec)
{
  GimpImageMapConfig *config = ((((GimpImageMapConfig*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_image_map_config_get_type ()))))));
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpimagemapconfig.c", 91, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
      ...
      if (config->time > 0)
        {
          ...
          name = g_locale_to_utf8 (buf, -1, ((void*)0), ((void*)0), ((void*)0));
          gimp_object_set_name (((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), ((gimp_object_get_type ())))))), name);
          g_free (name);
        }
      break;

   default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpimagemapconfig.c", 127, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
