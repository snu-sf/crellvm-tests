# 1 "gimpdynamics-load.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpdynamics-load.c" 2
# 18 "gimpdynamics-load.c"
# 1 "../../config.h" 1
# 19 "gimpdynamics-load.c" 2
...
GType gimp_dynamics_get_type (void) __attribute__((__const__));
...
# 27 "gimpdynamics-load.c" 2
# 1 "./gimpdynamics-load.h" 1
# 25 "./gimpdynamics-load.h"
GList * gimp_dynamics_load (GimpContext *context,
                            const gchar *filename,
                            GError **error);
# 28 "gimpdynamics-load.c" 2
                    ...
                    GError **error)
{
  ...
  dynamics = g_object_new ((gimp_dynamics_get_type ()), ((void*)0));

  if (gimp_config_deserialize_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((dynamics)), ((gimp_config_interface_get_type ())))))),
                                    filename,
                                    ((void*)0), error))
    {
      return g_list_prepend (((void*)0), dynamics);
    }
