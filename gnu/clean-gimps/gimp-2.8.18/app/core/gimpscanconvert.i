...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpscanconvert.c" 2
# 18 "gimpscanconvert.c"
# 1 "../../config.h" 1
# 19 "gimpscanconvert.c" 2
...
void tile_manager_write_pixel_data_1 (TileManager *tm,
                                                 ...
                                                 gint y,
                                                 const guchar *buffer);
# 33 "gimpscanconvert.c" 2

# 1 "./gimpbezierdesc.h" 1
# 27 "./gimpbezierdesc.h"
...
# 35 "gimpscanconvert.c" 2
# 1 "./gimpscanconvert.h" 1
# 22 "./gimpscanconvert.h"
...
# 70 "gimpscanconvert.c"
GimpScanConvert *
gimp_scan_convert_new (void)
{
  GimpScanConvert *sc = ((GimpScanConvert*) g_slice_alloc0 (sizeof (GimpScanConvert)));

  sc->path_data = g_array_new ((0), (0), sizeof (cairo_path_data_t));
  sc->ratio_xy = 1.0;
...
{
  do{ if (sc != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "sc != NULL"); return; }; }while (0);

  if (sc->path_data)
    g_array_free (sc->path_data, (!(0)));

  if (sc->dash_info)
    g_array_free (sc->dash_info, (!(0)));

  do { if (1) g_slice_free1 (sizeof (GimpScanConvert), (sc)); else (void) ((GimpScanConvert*) 0 == (sc)); } while (0);
}
# 108 "gimpscanconvert.c"
void
                                ...
                                gboolean closed)
{
  ...
  do{ if (sc != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "sc != NULL"); return; }; }while (0);
  do{ if (points != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "points != NULL"); return; }; }while (0);
  do{ if (n_points > 0) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "n_points > 0"); return; }; }while (0);
  ...
  for (i = 0; i < n_points; i++)
    {
      ...
      if (i == 0 ||
          ...
          prev.y != points[i].y)
        {
          ...
          pd.header.length = 2;
          sc->path_data = g_array_append_vals (sc->path_data, &(pd), 1);
...
# 208 "gimpscanconvert.c"
void
gimp_scan_convert_add_bezier (GimpScanConvert *sc,
                              const GimpBezierDesc *bezier)
{
  do{ if (sc != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "sc != NULL"); return; }; }while (0);
  do{ if (bezier != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "bezier != NULL"); return; }; }while (0);

  sc->path_data = g_array_append_vals (sc->path_data,
                                       bezier->data, bezier->num_data);
}
# 242 "gimpscanconvert.c"
void
  ...
  if (dash_info && dash_info->len >= 2)
    {
      ...
      dash_offset = dash_offset * (((width) > (1.0)) ? (width) : (1.0));

      n_dashes = dash_info->len;
      dashes = ((gdouble *) g_malloc_n ((dash_info->len), sizeof (gdouble)));

      for (i = 0; i < dash_info->len ; i++)
        dashes[i] = (((width) > (1.0)) ? (width) : (1.0)) * (((gdouble*) (void *) (dash_info)->data) [(i)]);
      ...
      if (n_dashes >= 2)
        {
          sc->dash_info = g_array_sized_new ((0), (0),
                               ...
                               guchar value)
{
  ...
  do{ if (sc != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "sc != NULL"); return; }; }while (0);
  do{ if (tile_manager != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "tile_manager != NULL"); return; }; }while (0);
  ...
  pixel_region_init (&maskPR, tile_manager, x, y, width, height, (!(0)));

  do{ if (maskPR.bytes == 1) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "maskPR.bytes == 1"); return; }; }while (0);
      ...
      if (maskPR.rowstride != stride)
        {
          ...
          dest = tmp_buf = __builtin_alloca (stride * maskPR.h);
