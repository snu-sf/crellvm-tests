# 1 "gimpdynamics-save.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpdynamics-save.c" 2
# 18 "gimpdynamics-save.c"
# 1 "../../config.h" 1
# 19 "gimpdynamics-save.c" 2
...
# 27 "gimpdynamics-save.c" 2
# 1 "./gimpdynamics-save.h" 1
# 23 "./gimpdynamics-save.h"
gboolean gimp_dynamics_save (GimpData *data,
                               GError **error);
# 28 "gimpdynamics-save.c" 2
...
gimp_dynamics_save (GimpData *data,
                    GError **error)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((data)); GType __t = ((gimp_dynamics_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_DYNAMICS (data)"); return ((0)); }; }while (0);
