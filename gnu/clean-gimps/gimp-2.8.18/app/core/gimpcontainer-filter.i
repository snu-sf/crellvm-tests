# 1 "gimpcontainer-filter.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpcontainer-filter.c" 2
# 21 "gimpcontainer-filter.c"
# 1 "../../config.h" 1
# 22 "gimpcontainer-filter.c" 2
...
void gimp_container_remove_handler (GimpContainer *container,
                                                GQuark id);
# 30 "gimpcontainer-filter.c" 2
# 1 "./gimpcontainer-filter.h" 1
# 25 "./gimpcontainer-filter.h"
                       ...
                       gpointer user_data)
{
  ...
  do{ if (filter != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "filter != NULL"); return (((void*)0)); }; }while (0);

  result =
    g_object_new (((((GTypeClass*) (((GTypeInstance*) (container))->g_class))->g_type)),
  ...
  if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((result)); GType __t = ((gimp_list_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
    gimp_list_reverse (((((GimpList*) g_type_check_instance_cast ((GTypeInstance*) ((result)), ((gimp_list_get_type ())))))));
...
gimp_object_filter_by_name (const GimpObject *object,
                            const GRegex *regex)
{
  return g_regex_match (regex, gimp_object_get_name (object), 0, ((void*)0));
}
# 113 "gimpcontainer-filter.c"
GimpContainer *
                               ...
                               GError **error)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (((void*)0)); }; }while (0);
  do{ if (regexp != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "regexp != NULL"); return (((void*)0)); }; }while (0);
                                        ...
                                        gint *length)
{
  ...
  if (regexp == ((void*)0) || strlen (regexp) == 0)
