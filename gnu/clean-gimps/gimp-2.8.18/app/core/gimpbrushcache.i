...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpbrushcache.c" 2
# 21 "gimpbrushcache.c"
# 1 "../../config.h" 1
# 22 "gimpbrushcache.c" 2
...
# 26 "gimpbrushcache.c" 2

# 1 "./gimpbrushcache.h" 1
# 25 "./gimpbrushcache.h"
# 1 "./gimpobject.h" 1
# 30 "./gimpobject.h"
...
GType gimp_brush_cache_get_type (void) __attribute__((__const__));
...
static void gimp_brush_cache_init (GimpBrushCache *self); static void gimp_brush_cache_class_init (GimpBrushCacheClass *klass); static gpointer gimp_brush_cache_parent_class = ((void*)0); static gint GimpBrushCache_private_offset; static void gimp_brush_cache_class_intern_init (gpointer klass) { gimp_brush_cache_parent_class = g_type_class_peek_parent (klass); if (GimpBrushCache_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpBrushCache_private_offset); gimp_brush_cache_class_init ((GimpBrushCacheClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_brush_cache_get_instance_private (GimpBrushCache *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpBrushCache_private_offset)))); } GType gimp_brush_cache_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_object_get_type ()), g_intern_static_string ("GimpBrushCache"), sizeof (GimpBrushCacheClass), (GClassInitFunc) gimp_brush_cache_class_intern_init, sizeof (GimpBrushCache), (GInstanceInitFunc) gimp_brush_cache_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpBrushCache *cache = ((((GimpBrushCache*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_brush_cache_get_type ()))))));

  if (((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_brush_cache_parent_class)), (((GType) ((20) << (2))))))))->constructed)
    ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_brush_cache_parent_class)), (((GType) ((20) << (2))))))))->constructed (object);

  do { if (cache->data_destroy != ((void*)0)) ; else g_assertion_message_expr ("Gimp-Core", "gimpbrushcache.c", 87, ((const char*) (__func__)), "cache->data_destroy != NULL"); } while (0);
}
  ...
  if (cache->last_data)
    {
      ...
      cache->last_data = ((void*)0);
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_brush_cache_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpbrushcache.c", 119, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpbrushcache.c", 139, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                      ...
                      gchar debug_miss)
{
  ...
  do{ if (data_destroy != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "data_destroy != NULL"); return (((void*)0)); }; }while (0);

  cache = g_object_new ((gimp_brush_cache_get_type ()),
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((cache)); GType __t = ((gimp_brush_cache_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_BRUSH_CACHE (cache)"); return; }; }while (0);
...
gimp_brush_cache_get (GimpBrushCache *cache,
                      ...
                      gdouble hardness)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((cache)); GType __t = ((gimp_brush_cache_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_BRUSH_CACHE (cache)"); return (((void*)0)); }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((cache)); GType __t = ((gimp_brush_cache_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_BRUSH_CACHE (cache)"); return; }; }while (0);
  do{ if (data != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "data != NULL"); return; }; }while (0);
