...
# 23 "gimppaintinfo.c" 2

# 1 "../../app/paint/gimppaintoptions.h" 1
# 22 "../../app/paint/gimppaintoptions.h"
...
# 23 "../../app/paint/gimppaintoptions.h" 2
# 34 "../../app/paint/gimppaintoptions.h"
...
# 75 "../../app/paint/gimppaintoptions.h"
...
GType gimp_paint_info_get_type (void) __attribute__((__const__));
...
static void gimp_paint_info_init (GimpPaintInfo *self); static void gimp_paint_info_class_init (GimpPaintInfoClass *klass); static gpointer gimp_paint_info_parent_class = ((void*)0); static gint GimpPaintInfo_private_offset; static void gimp_paint_info_class_intern_init (gpointer klass) { gimp_paint_info_parent_class = g_type_class_peek_parent (klass); if (GimpPaintInfo_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpPaintInfo_private_offset); gimp_paint_info_class_init ((GimpPaintInfoClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_paint_info_get_instance_private (GimpPaintInfo *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpPaintInfo_private_offset)))); } GType gimp_paint_info_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_viewable_get_type ()), g_intern_static_string ("GimpPaintInfo"), sizeof (GimpPaintInfoClass), (GClassInitFunc) gimp_paint_info_class_intern_init, sizeof (GimpPaintInfo), (GInstanceInitFunc) gimp_paint_info_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  paint_info->gimp = ((void*)0);
  paint_info->paint_type = ((GType) ((1) << (2)));
  paint_info->blurb = ((void*)0);
  paint_info->paint_options = ((void*)0);
}

static void
gimp_paint_info_dispose (GObject *object)
{
  GimpPaintInfo *paint_info = ((((GimpPaintInfo*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_paint_info_get_type ()))))));

  if (paint_info->paint_options)
    {
      g_object_run_dispose (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((paint_info->paint_options)), (((GType) ((20) << (2)))))))));
      g_object_unref (paint_info->paint_options);
      paint_info->paint_options = ((void*)0);
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_paint_info_parent_class)), (((GType) ((20) << (2))))))))->dispose (object);
}
...
gimp_paint_info_finalize (GObject *object)
{
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_paint_info_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
...
gimp_paint_info_get_description (GimpViewable *viewable,
                                 gchar **tooltip)
{
  GimpPaintInfo *paint_info = ((((GimpPaintInfo*) g_type_check_instance_cast ((GTypeInstance*) ((viewable)), ((gimp_paint_info_get_type ()))))));
                     ...
                     const gchar *stock_id)
{
  ...
  do{ if (identifier != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "identifier != NULL"); return (((void*)0)); }; }while (0);
  do{ if (blurb != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "blurb != NULL"); return (((void*)0)); }; }while (0);
  do{ if (stock_id != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "stock_id != NULL"); return (((void*)0)); }; }while (0);

  paint_info = g_object_new ((gimp_paint_info_get_type ()),
                             "name", identifier,
                             "stock-id", stock_id,
                             ((void*)0));
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((gimp)); GType __t = ((gimp_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_GIMP (gimp)"); return; }; }while (0);
  do{ if (! paint_info || (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((paint_info)); GType __t = ((gimp_paint_info_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "! paint_info || GIMP_IS_PAINT_INFO (paint_info)"); return; }; }while (0);
