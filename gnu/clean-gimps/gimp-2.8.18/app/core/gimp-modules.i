...
# 26 "gimp-modules.c" 2
# 1 "../../libgimpmodule/gimpmodule.h" 1
# 25 "../../libgimpmodule/gimpmodule.h"
...
# 26 "../../libgimpmodule/gimpmodule.h" 2
...
# 30 "../../libgimpmodule/gimpmodule.h" 2
...
void gimp_module_db_refresh (GimpModuleDB *db,
                                                const gchar *module_path);
# 32 "../../libgimpmodule/gimpmodule.h" 2
# 69 "../../libgimpmodule/gimpmodule.h"
typedef enum
{
...
# 154 "../../libgimpmodule/gimpmodule.h"
typedef struct _GimpModuleClass GimpModuleClass;
# 172 "../../libgimpmodule/gimpmodule.h"
struct _GimpModule
{
...
# 234 "../../libgimpmodule/gimpmodule.h"
...
gimp_modules_load (Gimp *gimp)
{
  ...
  gchar *path;
  GScanner *scanner;
  gchar *module_load_inhibit = ((void*)0);
  ...
  scanner = gimp_scanner_new_file (filename, ((void*)0));
  g_free (filename);
      ...
      while (g_scanner_peek_next_token (scanner) == token)
        {
          ...
          switch (token)
            ...
            case G_TOKEN_SYMBOL:
              if (scanner->value.v_symbol == ((gpointer) (glong) (1)))
                {
  ...
  path = gimp_config_path_expand (gimp->config->module_path, (!(0)), ((void*)0));
  ...
  if (! gimp->no_interface && gimp->write_modulerc)
    {
      ...
      writer = gimp_config_writer_new_file (filename, (!(0)),
                                            "GIMP modulerc", &error);
      g_free (filename);
