...
gimp_curve_map_value (GimpCurve *curve,
                      gdouble value)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((curve)); GType __t = ((gimp_curve_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CURVE (curve)"); return (0.0); }; }while (0);
...
gimp_curve_map_pixels (GimpCurve *curve_colors,
                       ...
                       glong samples)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((curve_colors)); GType __t = ((gimp_curve_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CURVE (curve_colors)"); return; }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((curve_red)); GType __t = ((gimp_curve_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CURVE (curve_red)"); return; }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((curve_green)); GType __t = ((gimp_curve_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CURVE (curve_green)"); return; }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((curve_blue)); GType __t = ((gimp_curve_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CURVE (curve_blue)"); return; }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((curve_alpha)); GType __t = ((gimp_curve_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CURVE (curve_alpha)"); return; }; }while (0);
