...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpcurve-load.c" 2
# 18 "gimpcurve-load.c"
# 1 "../../config.h" 1
# 19 "gimpcurve-load.c" 2
...
GType gimp_curve_get_type (void) __attribute__((__const__));
...
void gimp_curve_get_uchar (GimpCurve *curve,
                                              gint n_samples,
                                              guchar *samples);
# 34 "gimpcurve-load.c" 2
# 1 "./gimpcurve-load.h" 1
# 25 "./gimpcurve-load.h"
GList * gimp_curve_load (const gchar *filename,
                         GError **error);
# 35 "gimpcurve-load.c" 2
