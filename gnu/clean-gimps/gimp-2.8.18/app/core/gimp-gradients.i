...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-gradients.c" 2
# 21 "gimp-gradients.c"
# 1 "../../config.h" 1
# 22 "gimp-gradients.c" 2
...
# 28 "gimp-gradients.c" 2
# 1 "./gimp-gradients.h" 1
# 25 "./gimp-gradients.h"
void gimp_gradients_init (Gimp *gimp);
# 29 "gimp-gradients.c" 2
# 1 "./gimpcontext.h" 1
# 25 "./gimpcontext.h"
# 1 "./gimpviewable.h" 1
# 27 "./gimpviewable.h"
...
void gimp_container_remove_handler (GimpContainer *container,
                                                GQuark id);
# 31 "gimp-gradients.c" 2
# 1 "./gimpdatafactory.h" 1
# 28 "./gimpdatafactory.h"
...
gimp_gradients_init (Gimp *gimp)
{
  ...
  gradient = gimp_gradients_add_gradient (gimp,
                                          gettext ("FG to BG (Hardedge)"),
                                          "gimp-gradient-fg-bg-rgb-hardedge");
  ...
  gradient = gimp_gradients_add_gradient (gimp,
                                          gettext ("FG to BG (HSV counter-clockwise)"),
                                          "gimp-gradient-fg-bg-hsv-ccw");
  gradient->segments->left_color_type = GIMP_GRADIENT_COLOR_FOREGROUND;
  gradient->segments->right_color_type = GIMP_GRADIENT_COLOR_BACKGROUND;
  ...
  gradient = gimp_gradients_add_gradient (gimp,
                                          gettext ("FG to BG (HSV clockwise hue)"),
                                          "gimp-gradient-fg-bg-hsv-cw");
  gradient->segments->left_color_type = GIMP_GRADIENT_COLOR_FOREGROUND;
  gradient->segments->right_color_type = GIMP_GRADIENT_COLOR_BACKGROUND;
  ...
  gradient = gimp_gradients_add_gradient (gimp,
                                          gettext ("FG to Transparent"),
                                          "gimp-gradient-fg-transparent");
  gradient->segments->left_color_type = GIMP_GRADIENT_COLOR_FOREGROUND;
                             ...
                             const gchar *id)
{
  ...
  gradient = ((((GimpGradient*) g_type_check_instance_cast ((GTypeInstance*) ((gimp_gradient_new (gimp_get_user_context (gimp), name))), ((gimp_gradient_get_type ()))))));


  gimp_data_make_internal (((((GimpData*) g_type_check_instance_cast ((GTypeInstance*) ((gradient)), ((gimp_data_get_type ())))))), id);

  gimp_container_add (gimp_data_factory_get_container (gimp->gradient_factory),
                      ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((gradient)), ((gimp_object_get_type ())))))));
  g_object_unref (gradient);

  g_object_set_data (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((gimp)), (((GType) ((20) << (2)))))))), id, gradient);
