# 1 "gimptoolpreset-load.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimptoolpreset-load.c" 2
# 18 "gimptoolpreset-load.c"
# 1 "../../config.h" 1
# 19 "gimptoolpreset-load.c" 2
...
# 28 "gimptoolpreset-load.c" 2
# 1 "./gimptoolpreset.h" 1
# 22 "./gimptoolpreset.h"
# 1 "./gimpdata.h" 1
# 29 "./gimpdata.h"
typedef enum
...
GType gimp_tool_preset_get_type (void) __attribute__((__const__));
...
# 29 "gimptoolpreset-load.c" 2
# 1 "./gimptoolpreset-load.h" 1
# 25 "./gimptoolpreset-load.h"
GList * gimp_tool_preset_load (GimpContext *context,
                               const gchar *filename,
                               GError **error);
# 30 "gimptoolpreset-load.c" 2
                       ...
                       GError **error)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((context)); GType __t = ((gimp_context_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTEXT (context)"); return (((void*)0)); }; }while (0);
  ...
  tool_preset = g_object_new ((gimp_tool_preset_get_type ()),
                              "gimp", context->gimp,
                              ((void*)0));

  if (gimp_config_deserialize_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((tool_preset)), ((gimp_config_interface_get_type ())))))),
                                    filename,
                                    ((void*)0), error))
    {
      if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tool_preset->tool_options)); GType __t = ((gimp_context_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
        {
          return g_list_prepend (((void*)0), tool_preset);
        }
      else
        {
          g_set_error (error, (gimp_config_error_quark ()), GIMP_CONFIG_ERROR_PARSE,
                       gettext ("Error while parsing '%s'"),
