# 1 "gimpimage-preview.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpimage-preview.c" 2
# 18 "gimpimage-preview.c"
# 1 "../../config.h" 1
# 19 "gimpimage-preview.c" 2
...
# 28 "gimpimage-preview.c" 2
# 1 "./gimpimage-preview.h" 1
# 26 "./gimpimage-preview.h"
...
TempBuf * gimp_image_get_new_preview (GimpViewable *viewable,
                                       ...
                                       gint width,
                                       gint height);
# 29 "gimpimage-preview.c" 2
# 1 "./gimpimage-private.h" 1
# 22 "./gimpimage-private.h"
...
struct _GimpImagePrivate
{
  ...
  GimpItemTree *layers;
  GimpItemTree *channels;
  GimpItemTree *vectors;
  GSList *layer_stack;
  ...
  gint group_count;
  GimpUndoType pushing_undo_group;
...
void gimp_image_take_mask (GimpImage *image,
                             GimpChannel *mask);
# 30 "gimpimage-preview.c" 2
# 1 "./gimpprojection.h" 1
# 25 "./gimpprojection.h"
...
GType gimp_projection_get_type (void) __attribute__((__const__));
