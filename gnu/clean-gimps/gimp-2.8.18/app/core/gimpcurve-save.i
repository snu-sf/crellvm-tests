...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpcurve-save.c" 2
# 18 "gimpcurve-save.c"
# 1 "../../config.h" 1
# 19 "gimpcurve-save.c" 2
...
void gimp_curve_get_uchar (GimpCurve *curve,
                                              gint n_samples,
                                              guchar *samples);
# 30 "gimpcurve-save.c" 2
# 1 "./gimpcurve-save.h" 1
# 23 "./gimpcurve-save.h"
gboolean gimp_curve_save (GimpData *data,
                            GError **error);
# 31 "gimpcurve-save.c" 2
                 ...
                 GError **error)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((data)); GType __t = ((gimp_curve_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CURVE (data)"); return ((0)); }; }while (0);
