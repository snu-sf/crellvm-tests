...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-templates.c" 2
# 18 "gimp-templates.c"
# 1 "../../config.h" 1
# 19 "gimp-templates.c" 2
...
GType gimp_template_get_type (void) __attribute__((__const__));
...
gimp_templates_load (Gimp *gimp)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((gimp->templates)); GType __t = ((gimp_list_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_LIST (gimp->templates)"); return; }; }while (0);
  ...
  if (! gimp_config_deserialize_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->templates)), ((gimp_config_interface_get_type ())))))),
                                      filename, ((void*)0), &error))
    {
      if (error->code == GIMP_CONFIG_ERROR_OPEN_ENOENT)
        {
          ...
          if (! gimp_config_deserialize_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->templates)), ((gimp_config_interface_get_type ())))))),
                                              filename, ((void*)0), &error))
            {
              gimp_message_literal (gimp, ((void*)0), GIMP_MESSAGE_ERROR,
        error->message);
            }
        }
      else
        {
          gimp_message_literal (gimp, ((void*)0), GIMP_MESSAGE_ERROR, error->message);
        }

      g_clear_error (&error);
    }

  gimp_list_reverse (((((GimpList*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->templates)), ((gimp_list_get_type ())))))));
...
gimp_templates_save (Gimp *gimp)
{
  ...
  if (! gimp_config_serialize_to_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((gimp->templates)), ((gimp_config_interface_get_type ())))))),
                                       filename,
                                       header, footer, ((void*)0),
                                       &error))
    {
      gimp_message_literal (gimp, ((void*)0), GIMP_MESSAGE_ERROR, error->message);
      g_error_free (error);
...
gimp_templates_migrate_get_child_by_name (const GimpContainer *container,
                                          const gchar *name)
{
  GimpList *list = ((((GimpList*) g_type_check_instance_cast ((GTypeInstance*) ((container)), ((gimp_list_get_type ()))))));
  GimpObject *retval = ((void*)0);
  GList *glist;

  for (glist = list->list; glist; glist = ((glist) ? (((GList *)(glist))->next) : ((void*)0)))
    {
...
# 168 "gimp-templates.c"
void
gimp_templates_migrate (const gchar *olddir)
{
  GimpContainer *templates = gimp_list_new ((gimp_template_get_type ()), (!(0)));
  gchar *filename = gimp_personal_rc_file ("templaterc");

  if (gimp_config_deserialize_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((templates)), ((gimp_config_interface_get_type ())))))), filename,
                                    ((void*)0), ((void*)0)))
    {
      ...
      if (olddir && (strstr (olddir, "2.0") || strstr (olddir, "2.2")))
        {
          ...
          GimpContainerClass *class = ((((GimpContainerClass*) (((GTypeInstance*) ((templates)))->g_class))));
          gpointer func = class->get_child_by_name;

          class->get_child_by_name = gimp_templates_migrate_get_child_by_name;

          gimp_config_deserialize_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((templates)), ((gimp_config_interface_get_type ())))))),
                                        tmp, ((void*)0), ((void*)0));
      ...
      gimp_list_reverse (((((GimpList*) g_type_check_instance_cast ((GTypeInstance*) ((templates)), ((gimp_list_get_type ())))))));

      gimp_config_serialize_to_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((templates)), ((gimp_config_interface_get_type ())))))), filename,
