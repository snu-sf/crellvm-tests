...
# 25 "gimpguideundo.c" 2
# 1 "./gimpimage-guides.h" 1
# 24 "./gimpimage-guides.h"
...
GType gimp_guide_get_type (void) __attribute__((__const__));
...
GType gimp_guide_undo_get_type (void) __attribute__((__const__));
# 28 "gimpguideundo.c" 2
...
static void gimp_guide_undo_init (GimpGuideUndo *self); static void gimp_guide_undo_class_init (GimpGuideUndoClass *klass); static gpointer gimp_guide_undo_parent_class = ((void*)0); static gint GimpGuideUndo_private_offset; static void gimp_guide_undo_class_intern_init (gpointer klass) { gimp_guide_undo_parent_class = g_type_class_peek_parent (klass); if (GimpGuideUndo_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpGuideUndo_private_offset); gimp_guide_undo_class_init ((GimpGuideUndoClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_guide_undo_get_instance_private (GimpGuideUndo *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpGuideUndo_private_offset)))); } GType gimp_guide_undo_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_undo_get_type ()), g_intern_static_string ("GimpGuideUndo"), sizeof (GimpGuideUndoClass), (GClassInitFunc) gimp_guide_undo_class_intern_init, sizeof (GimpGuideUndo), (GInstanceInitFunc) gimp_guide_undo_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_guide_undo_class_init (GimpGuideUndoClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_GUIDE,
                                   g_param_spec_object ("guide", ((void*)0), ((void*)0),
                                                        (gimp_guide_get_type ()),
...
{
  GimpGuideUndo *guide_undo = ((((GimpGuideUndo*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_guide_undo_get_type ()))))));

  if (((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_guide_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed)
    ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_guide_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed (object);

  do { if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((guide_undo->guide)); GType __t = ((gimp_guide_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) ; else g_assertion_message_expr ("Gimp-Core", "gimpguideundo.c", 92, ((const char*) (__func__)), "GIMP_IS_GUIDE (guide_undo->guide)"); } while (0);
                              ...
                              GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpguideundo.c", 113, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
gimp_guide_undo_pop (GimpUndo *undo,
                     ...
                     GimpUndoAccumulator *accum)
{
  GimpGuideUndo *guide_undo = ((((GimpGuideUndo*) g_type_check_instance_cast ((GTypeInstance*) ((undo)), ((gimp_guide_undo_get_type ()))))));
  GimpOrientationType orientation;
  gint position;
  gboolean moved = (0);

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_guide_undo_parent_class)), ((gimp_undo_get_type ()))))))->pop (undo, undo_mode, accum);
  ...
  if (position == -1)
    ...
    {
      gimp_image_remove_guide (undo->image, guide_undo->guide, (0));
    }
  else
    {
  ...
  if (guide_undo->guide)
    {
      ...
      guide_undo->guide = ((void*)0);
    }

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_guide_undo_parent_class)), ((gimp_undo_get_type ()))))))->free (undo, undo_mode);
}
