...
GType gimp_image_get_type (void) __attribute__((__const__));
...
GType gimp_undo_stack_get_type (void) __attribute__((__const__));
...
static void gimp_undo_stack_init (GimpUndoStack *self); static void gimp_undo_stack_class_init (GimpUndoStackClass *klass); static gpointer gimp_undo_stack_parent_class = ((void*)0); static gint GimpUndoStack_private_offset; static void gimp_undo_stack_class_intern_init (gpointer klass) { gimp_undo_stack_parent_class = g_type_class_peek_parent (klass); if (GimpUndoStack_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpUndoStack_private_offset); gimp_undo_stack_class_init ((GimpUndoStackClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_undo_stack_get_instance_private (GimpUndoStack *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpUndoStack_private_offset)))); } GType gimp_undo_stack_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_undo_get_type ()), g_intern_static_string ("GimpUndoStack"), sizeof (GimpUndoStackClass), (GClassInitFunc) gimp_undo_stack_class_intern_init, sizeof (GimpUndoStack), (GInstanceInitFunc) gimp_undo_stack_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  stack->undos = gimp_list_new ((gimp_undo_get_type ()), (0));
}

static void
gimp_undo_stack_finalize (GObject *object)
{
  GimpUndoStack *stack = ((((GimpUndoStack*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_undo_stack_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_undo_stack_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                             ...
                             gint64 *gui_size)
{
  ...
  memsize += gimp_object_get_memsize (((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((stack->undos)), ((gimp_object_get_type ())))))), gui_size);

  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_undo_stack_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
...
gimp_undo_stack_pop (GimpUndo *undo,
                     ...
                     GimpUndoAccumulator *accum)
{
  GimpUndoStack *stack = ((((GimpUndoStack*) g_type_check_instance_cast ((GTypeInstance*) ((undo)), ((gimp_undo_stack_get_type ()))))));
  GList *list;

  for (list = ((((GimpList*) g_type_check_instance_cast ((GTypeInstance*) ((stack->undos)), ((gimp_list_get_type ()))))))->list;
       list;
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((image)); GType __t = ((gimp_image_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_IMAGE (image)"); return (((void*)0)); }; }while (0);

  return g_object_new ((gimp_undo_stack_get_type ()),
                       "image", image,
                       ((void*)0));
}
...
gimp_undo_stack_push_undo (GimpUndoStack *stack,
                           GimpUndo *undo)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((stack)); GType __t = ((gimp_undo_stack_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_UNDO_STACK (stack)"); return; }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((undo)); GType __t = ((gimp_undo_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_UNDO (undo)"); return; }; }while (0);

  gimp_container_add (stack->undos, ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((undo)), ((gimp_object_get_type ())))))));
}
                          ...
                          GimpUndoAccumulator *accum)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((stack)); GType __t = ((gimp_undo_stack_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_UNDO_STACK (stack)"); return (((void*)0)); }; }while (0);
  do{ if (accum != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "accum != NULL"); return (((void*)0)); }; }while (0);

  undo = ((((GimpUndo*) g_type_check_instance_cast ((GTypeInstance*) ((gimp_container_get_first_child (stack->undos))), ((gimp_undo_get_type ()))))));

  if (undo)
    {
      gimp_container_remove (stack->undos, ((((GimpObject*) g_type_check_instance_cast ((GTypeInstance*) ((undo)), ((gimp_object_get_type ())))))));
                             ...
                             GimpUndoMode undo_mode)
{
  ...
  undo = ((((GimpUndo*) g_type_check_instance_cast ((GTypeInstance*) ((gimp_container_get_last_child (stack->undos))), ((gimp_undo_get_type ()))))));
...
gimp_undo_stack_peek (GimpUndoStack *stack)
{
  ...
  return ((((GimpUndo*) g_type_check_instance_cast ((GTypeInstance*) ((gimp_container_get_first_child (stack->undos))), ((gimp_undo_get_type ()))))));
}

gint
gimp_undo_stack_get_depth (GimpUndoStack *stack)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((stack)); GType __t = ((gimp_undo_stack_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_UNDO_STACK (stack)"); return (0); }; }while (0);
