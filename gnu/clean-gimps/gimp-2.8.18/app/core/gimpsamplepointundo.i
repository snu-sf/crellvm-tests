# 1 "gimpsamplepointundo.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpsamplepointundo.c" 2
# 18 "gimpsamplepointundo.c"
# 1 "../../config.h" 1
# 19 "gimpsamplepointundo.c" 2
...
# 25 "gimpsamplepointundo.c" 2
# 1 "./gimpimage-sample-points.h" 1
# 24 "./gimpimage-sample-points.h"
...
GimpSamplePoint * gimp_image_find_sample_point (GimpImage *image,
                                                      ...
                                                      gdouble epsilon_x,
                                                      gdouble epsilon_y);
# 26 "gimpsamplepointundo.c" 2
# 1 "./gimpsamplepoint.h" 1
# 25 "./gimpsamplepoint.h"
...
GType gimp_sample_point_get_type (void) __attribute__((__const__));
...
# 27 "gimpsamplepointundo.c" 2
# 1 "./gimpsamplepointundo.h" 1
# 22 "./gimpsamplepointundo.h"
# 1 "./gimpundo.h" 1
# 25 "./gimpundo.h"
...
# 23 "./gimpsamplepointundo.h" 2
# 33 "./gimpsamplepointundo.h"
...
GType gimp_sample_point_undo_get_type (void) __attribute__((__const__));
# 28 "gimpsamplepointundo.c" 2
...
static void gimp_sample_point_undo_init (GimpSamplePointUndo *self); static void gimp_sample_point_undo_class_init (GimpSamplePointUndoClass *klass); static gpointer gimp_sample_point_undo_parent_class = ((void*)0); static gint GimpSamplePointUndo_private_offset; static void gimp_sample_point_undo_class_intern_init (gpointer klass) { gimp_sample_point_undo_parent_class = g_type_class_peek_parent (klass); if (GimpSamplePointUndo_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpSamplePointUndo_private_offset); gimp_sample_point_undo_class_init ((GimpSamplePointUndoClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_sample_point_undo_get_instance_private (GimpSamplePointUndo *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpSamplePointUndo_private_offset)))); } GType gimp_sample_point_undo_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_undo_get_type ()), g_intern_static_string ("GimpSamplePointUndo"), sizeof (GimpSamplePointUndoClass), (GClassInitFunc) gimp_sample_point_undo_class_intern_init, sizeof (GimpSamplePointUndo), (GInstanceInitFunc) gimp_sample_point_undo_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_sample_point_undo_class_init (GimpSamplePointUndoClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_SAMPLE_POINT,
                                   g_param_spec_boxed ("sample-point", ((void*)0), ((void*)0),
...
{
  GimpSamplePointUndo *sample_point_undo = ((((GimpSamplePointUndo*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_sample_point_undo_get_type ()))))));

  if (((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_sample_point_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed)
    ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_sample_point_undo_parent_class)), (((GType) ((20) << (2))))))))->constructed (object);

  do { if (sample_point_undo->sample_point != ((void*)0)) ; else g_assertion_message_expr ("Gimp-Core", "gimpsamplepointundo.c", 92, ((const char*) (__func__)), "sample_point_undo->sample_point != NULL"); } while (0);
                                     ...
                                     GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpsamplepointundo.c", 113, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
gimp_sample_point_undo_pop (GimpUndo *undo,
                            ...
                            GimpUndoAccumulator *accum)
{
  GimpSamplePointUndo *sample_point_undo = ((((GimpSamplePointUndo*) g_type_check_instance_cast ((GTypeInstance*) ((undo)), ((gimp_sample_point_undo_get_type ()))))));
  gint x;
  gint y;

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_sample_point_undo_parent_class)), ((gimp_undo_get_type ()))))))->pop (undo, undo_mode, accum);
  ...
  if (x == -1)
  ...
  else if (sample_point_undo->x == -1)
    {
      gimp_image_remove_sample_point (undo->image,
                                      sample_point_undo->sample_point, (0));
    }
  else
    {
  ...
  if (sample_point_undo->sample_point)
    {
      ...
      sample_point_undo->sample_point = ((void*)0);
    }

  ((((GimpUndoClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_sample_point_undo_parent_class)), ((gimp_undo_get_type ()))))))->free (undo, undo_mode);
}
