...
GType gimp_id_table_get_type (void) __attribute__((__const__));
...
static void gimp_id_table_init (GimpIdTable *self); static void gimp_id_table_class_init (GimpIdTableClass *klass); static gpointer gimp_id_table_parent_class = ((void*)0); static gint GimpIdTable_private_offset; static void gimp_id_table_class_intern_init (gpointer klass) { gimp_id_table_parent_class = g_type_class_peek_parent (klass); if (GimpIdTable_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpIdTable_private_offset); gimp_id_table_class_init ((GimpIdTableClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_id_table_get_instance_private (GimpIdTable *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpIdTable_private_offset)))); } GType gimp_id_table_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_object_get_type ()), g_intern_static_string ("GimpIdTable"), sizeof (GimpIdTableClass), (GClassInitFunc) gimp_id_table_class_intern_init, sizeof (GimpIdTable), (GInstanceInitFunc) gimp_id_table_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_id_table_class_init (GimpIdTableClass *klass)
{
  ...
  GimpIdTableClass *gimp_id_table_class = ((((GimpIdTableClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gimp_id_table_get_type ()))))));
...
{
  id_table->priv = ((GimpIdTablePriv*) g_type_instance_get_private ((GTypeInstance*) (id_table), ((gimp_id_table_get_type ()))));



  id_table->priv->id_table = g_hash_table_new (g_direct_hash, ((void*)0));
  id_table->priv->next_id = 1;
}

static void
gimp_id_table_finalize (GObject *object)
{
  GimpIdTable *id_table = ((((GimpIdTable*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_id_table_get_type ()))))));

  if (id_table->priv->id_table)
    {
      g_hash_table_unref (id_table->priv->id_table);
      id_table->priv->id_table = ((void*)0);
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_id_table_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                           ...
                           gint64 *gui_size)
{
  ...
  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_id_table_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
...
{
  return g_object_new ((gimp_id_table_get_type ()), ((void*)0));
}
# 126 "gimpidtable.c"
gint
gimp_id_table_insert (GimpIdTable *id_table, gpointer data)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((id_table)); GType __t = ((gimp_id_table_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_ID_TABLE (id_table)"); return (0); }; }while (0);
  ...
  do
    {
      ...
      if (id_table->priv->next_id == 2147483647)
        id_table->priv->next_id = 1;
      ...
      if (start_id == id_table->priv->next_id)
        {
          ...
          g_error ("%s: out of ids!", ((const char*) (__func__)));
          break;
        }
    }
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((id_table)); GType __t = ((gimp_id_table_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_ID_TABLE (id_table)"); return (0); }; }while (0);
  do{ if (id > 0) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "id > 0"); return (0); }; }while (0);

  if (gimp_id_table_lookup (id_table, id))
    return -1;

  g_hash_table_insert (id_table->priv->id_table, ((gpointer) (glong) (id)), data);
...
gimp_id_table_replace (GimpIdTable *id_table, gint id, gpointer data)
{
  ...
  g_hash_table_replace (id_table->priv->id_table, ((gpointer) (glong) (id)), data);
}
# 209 "gimpidtable.c"
gpointer
gimp_id_table_lookup (GimpIdTable *id_table, gint id)
{
  ...
  return g_hash_table_lookup (id_table->priv->id_table, ((gpointer) (glong) (id)));
}
# 228 "gimpidtable.c"
gboolean
gimp_id_table_remove (GimpIdTable *id_table, gint id)
{
  ...
  do{ if (id_table != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "id_table != NULL"); return ((0)); }; }while (0);

  return g_hash_table_remove (id_table->priv->id_table, ((gpointer) (glong) (id)));
}
