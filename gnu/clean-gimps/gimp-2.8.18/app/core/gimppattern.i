...
# 1 "../../app/base/temp-buf.h" 1
# 22 "../../app/base/temp-buf.h"
struct _TempBuf
{
  gint bytes;
  gint width;
...
TempBuf * temp_buf_scale (TempBuf *buf,
                                  gint width,
                                  gint height) __attribute__((warn_unused_result));
...
GType gimp_data_get_type (void) __attribute__((__const__));
...
GQuark gimp_data_error_quark (void) __attribute__((__const__));
# 23 "./gimppattern.h" 2
# 33 "./gimppattern.h"
...
GType gimp_pattern_get_type (void) __attribute__((__const__));
...
# 31 "gimppattern.c" 2
# 1 "./gimppattern-load.h" 1
# 25 "./gimppattern-load.h"
...
GType gimp_tagged_interface_get_type (void) __attribute__((__const__));
...
static void gimp_pattern_init (GimpPattern *self); static void gimp_pattern_class_init (GimpPatternClass *klass); static gpointer gimp_pattern_parent_class = ((void*)0); static gint GimpPattern_private_offset; static void gimp_pattern_class_intern_init (gpointer klass) { gimp_pattern_parent_class = g_type_class_peek_parent (klass); if (GimpPattern_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpPattern_private_offset); gimp_pattern_class_init ((GimpPatternClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_pattern_get_instance_private (GimpPattern *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpPattern_private_offset)))); } GType gimp_pattern_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_data_get_type ()), g_intern_static_string ("GimpPattern"), sizeof (GimpPatternClass), (GClassInitFunc) gimp_pattern_class_intern_init, sizeof (GimpPattern), (GInstanceInitFunc) gimp_pattern_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) gimp_pattern_tagged_iface_init, ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_tagged_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_pattern_class_init (GimpPatternClass *klass)
{
  ...
  GimpDataClass *data_class = ((((GimpDataClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), ((gimp_data_get_type ()))))));
...
{
  GimpPattern *pattern = ((((GimpPattern*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_pattern_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_pattern_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                          ...
                          gint64 *gui_size)
{
  ...
  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_pattern_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
...
gimp_pattern_get_size (GimpViewable *viewable,
                       ...
                       gint *height)
{
  GimpPattern *pattern = ((((GimpPattern*) g_type_check_instance_cast ((GTypeInstance*) ((viewable)), ((gimp_pattern_get_type ()))))));
                              ...
                              gint height)
{
  ...
  copy_width = (((width) < (pattern->mask->width)) ? (width) : (pattern->mask->width));
  copy_height = (((height) < (pattern->mask->height)) ? (height) : (pattern->mask->height));
...
{
  GimpPattern *pattern = g_object_new ((gimp_pattern_get_type ()), ((void*)0));

  pattern->mask = temp_buf_copy (((((GimpPattern*) g_type_check_instance_cast ((GTypeInstance*) ((data)), ((gimp_pattern_get_type ()))))))->mask, ((void*)0));

  return ((((GimpData*) g_type_check_instance_cast ((GTypeInstance*) ((pattern)), ((gimp_data_get_type ()))))));
}

static gchar *
gimp_pattern_get_checksum (GimpTagged *tagged)
{
  GimpPattern *pattern = ((((GimpPattern*) g_type_check_instance_cast ((GTypeInstance*) ((tagged)), ((gimp_pattern_get_type ()))))));
  gchar *checksum_string = ((void*)0);
                  ...
                  const gchar *name)
{
  ...
  do{ if (name != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "name != NULL"); return (((void*)0)); }; }while (0);
  do{ if (name[0] != '\n') { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "name[0] != '\\n'"); return (((void*)0)); }; }while (0);

  pattern = g_object_new ((gimp_pattern_get_type ()),
                          "name", name,
                          ((void*)0));

  pattern->mask = temp_buf_new (32, 32, 3, 0, 0, ((void*)0));
...
{
  static GimpData *standard_pattern = ((void*)0);
  ...
  if (! standard_pattern)
    {
      ...
      g_object_add_weak_pointer (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((standard_pattern)), (((GType) ((20) << (2)))))))),
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((pattern)); GType __t = ((gimp_pattern_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_PATTERN (pattern)"); return (((void*)0)); }; }while (0);
