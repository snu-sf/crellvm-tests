...
GType gimp_grid_get_type (void) __attribute__((__const__));
...
const gchar * gimp_grid_parasite_name (void) __attribute__((__const__));
...
static void gimp_grid_init (GimpGrid *self); static void gimp_grid_class_init (GimpGridClass *klass); static gpointer gimp_grid_parent_class = ((void*)0); static gint GimpGrid_private_offset; static void gimp_grid_class_intern_init (gpointer klass) { gimp_grid_parent_class = g_type_class_peek_parent (klass); if (GimpGrid_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpGrid_private_offset); gimp_grid_class_init ((GimpGridClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_grid_get_instance_private (GimpGrid *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpGrid_private_offset)))); } GType gimp_grid_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_object_get_type ()), g_intern_static_string ("GimpGrid"), sizeof (GimpGridClass), (GClassInitFunc) gimp_grid_class_intern_init, sizeof (GimpGrid), (GInstanceInitFunc) gimp_grid_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) ((void*)0), ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_grid_class_init (GimpGridClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_STYLE, g_param_spec_enum ("style", ((void*)0), ("Line style used for the grid."), (gimp_grid_style_get_type ()), GIMP_GRID_SOLID, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));





  g_object_class_install_property (object_class, PROP_FGCOLOR, gimp_param_spec_rgb ("fgcolor", ((void*)0), ("The foreground color of the grid."), (!(0)), &black, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_BGCOLOR, gimp_param_spec_rgb ("bgcolor", ((void*)0), ("The background color of the grid; " "only used in double dashed line style."), (!(0)), &white, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));





  g_object_class_install_property (object_class, PROP_XSPACING, g_param_spec_double ("xspacing", ((void*)0), ("Horizontal spacing of grid lines."), 1.0, 262144, 10.0, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_YSPACING, g_param_spec_double ("yspacing", ((void*)0), ("Vertical spacing of grid lines."), 1.0, 262144, 10.0, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_SPACING_UNIT, gimp_param_spec_unit ("spacing-unit", ((void*)0), ((void*)0), (0), (0), GIMP_UNIT_INCH, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_XOFFSET, g_param_spec_double ("xoffset", ((void*)0), ("Horizontal offset of the first grid " "line; this may be a negative number."), - 262144, 262144, 0.0, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  g_object_class_install_property (object_class, PROP_YOFFSET, g_param_spec_double ("yoffset", ((void*)0), ("Vertical offset of the first grid " "line; this may be a negative number."), - 262144, 262144, 0.0, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  g_object_class_install_property (object_class, PROP_OFFSET_UNIT, gimp_param_spec_unit ("offset-unit", ((void*)0), ((void*)0), (0), (0), GIMP_UNIT_INCH, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_grid_get_property (GObject *object,
                        ...
                        GParamSpec *pspec)
{
  GimpGrid *grid = ((((GimpGrid*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_grid_get_type ()))))));
  ...
  switch (property_id)
    ...
    case PROP_OFFSET_UNIT:
      ...
      break;
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpgrid.c", 177, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                        ...
                        GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_OFFSET_UNIT:
      ...
      break;
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpgrid.c", 223, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
gimp_grid_get_spacing (GimpGrid *grid,
                       ...
                       gdouble *yspacing)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((grid)); GType __t = ((gimp_grid_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_GRID (grid)"); return; }; }while (0);
...
gimp_grid_to_parasite (const GimpGrid *grid)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((grid)); GType __t = ((gimp_grid_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_GRID (grid)"); return (((void*)0)); }; }while (0);

  str = gimp_config_serialize_to_string (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((grid)), ((gimp_config_interface_get_type ())))))), ((void*)0));
  do{ if (str != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "str != NULL"); return (((void*)0)); }; }while (0);
...
gimp_grid_from_parasite (const GimpParasite *parasite)
{
  ...
  do{ if (parasite != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "parasite != NULL"); return (((void*)0)); }; }while (0);
  do{ if (strcmp (gimp_parasite_name (parasite), gimp_grid_parasite_name ()) == 0) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "strcmp (gimp_parasite_name (parasite), gimp_grid_parasite_name ()) == 0"); return (((void*)0)); }; }while (0);


  str = gimp_parasite_data (parasite);
  do{ if (str != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "str != NULL"); return (((void*)0)); }; }while (0);

  grid = g_object_new ((gimp_grid_get_type ()), ((void*)0));

  if (! gimp_config_deserialize_string (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((grid)), ((gimp_config_interface_get_type ())))))),
                                        str,
