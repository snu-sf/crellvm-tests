...
static void gimp_tag_init (GimpTag *self); static void gimp_tag_class_init (GimpTagClass *klass); static gpointer gimp_tag_parent_class = ((void*)0); static gint GimpTag_private_offset; static void gimp_tag_class_intern_init (gpointer klass) { gimp_tag_parent_class = g_type_class_peek_parent (klass); if (GimpTag_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpTag_private_offset); gimp_tag_class_init ((GimpTagClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_tag_get_instance_private (GimpTag *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpTag_private_offset)))); } GType gimp_tag_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpTag"), sizeof (GimpTagClass), (GClassInitFunc) gimp_tag_class_intern_init, sizeof (GimpTag), (GInstanceInitFunc) gimp_tag_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_tag_new (const char *tag_string)
{
  ...
  do{ if (tag_string != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "tag_string != NULL"); return (((void*)0)); }; }while (0);

  tag_name = gimp_tag_string_make_valid (tag_string);
  if (! tag_name)
    return ((void*)0);

  tag = g_object_new ((gimp_tag_get_type ()), ((void*)0));
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tag)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (tag)"); return ((0)); }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tag)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (tag)"); return; }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tag)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (tag)"); return (((void*)0)); }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tag)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (tag)"); return (-1); }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tag)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (tag)"); return ((0)); }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((other)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (other)"); return ((0)); }; }while (0);
...
gimp_tag_compare_func (const void *p1,
                       const void *p2)
{
  GimpTag *t1 = ((((GimpTag*) g_type_check_instance_cast ((GTypeInstance*) ((p1)), ((gimp_tag_get_type ()))))));
  GimpTag *t2 = ((((GimpTag*) g_type_check_instance_cast ((GTypeInstance*) ((p2)), ((gimp_tag_get_type ()))))));
                              ...
                              const gchar *tag_string)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tag)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (tag)"); return (0); }; }while (0);
  do{ if (tag_string != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "tag_string != NULL"); return (0); }; }while (0);
                     ...
                     const gchar *prefix_string)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tag)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (tag)"); return ((0)); }; }while (0);
  do{ if (prefix_string != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "prefix_string != NULL"); return ((0)); }; }while (0);
...
gimp_tag_string_make_valid (const gchar *tag_string)
{
  ...
  do{ if (tag_string) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "tag_string"); return (((void*)0)); }; }while (0);

  tag = g_utf8_normalize (tag_string, -1, G_NORMALIZE_ALL);
  if (! tag)
    return ((void*)0);

  tag = g_strchomp (g_strchug (tag));
  if (! *tag)
    {
      g_free (tag);
      return ((void*)0);
  ...
  buffer = g_string_new ("");
  tag_cursor = tag;
  if (g_str_has_prefix (tag_cursor, "gimp:"))
    {
      tag_cursor += strlen ("gimp:");
    }
  do
    {
      c = g_utf8_get_char (tag_cursor);
      tag_cursor = (char *)((tag_cursor) + g_utf8_skip[*(const guchar *)(tag_cursor)]);
...
gimp_tag_or_null_ref (GimpTag *tag_or_null)
{
  if (tag_or_null)
    {
      do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((tag_or_null)); GType __t = ((gimp_tag_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TAG (tag_or_null)"); return; }; }while (0);
