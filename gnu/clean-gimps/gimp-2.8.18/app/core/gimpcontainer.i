...
GType gimp_container_get_type (void) __attribute__((__const__));
...
static void gimp_container_init (GimpContainer *self); static void gimp_container_class_init (GimpContainerClass *klass); static gpointer gimp_container_parent_class = ((void*)0); static gint GimpContainer_private_offset; static void gimp_container_class_intern_init (gpointer klass) { gimp_container_parent_class = g_type_class_peek_parent (klass); if (GimpContainer_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpContainer_private_offset); gimp_container_class_init ((GimpContainerClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_container_get_instance_private (GimpContainer *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpContainer_private_offset)))); } GType gimp_container_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_object_get_type ()), g_intern_static_string ("GimpContainer"), sizeof (GimpContainerClass), (GClassInitFunc) gimp_container_class_intern_init, sizeof (GimpContainer), (GInstanceInitFunc) gimp_container_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) gimp_container_config_iface_init, ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_container_class_init (GimpContainerClass *klass)
{
  ...
  container_signals[ADD] =
    g_signal_new ("add",
                  ...
                  G_SIGNAL_RUN_FIRST,
                  ((glong) __builtin_offsetof(GimpContainerClass, add)),
                  ((void*)0), ((void*)0),
  ...
  container_signals[REMOVE] =
    g_signal_new ("remove",
                  (((GTypeClass*) (klass))->g_type),
                  G_SIGNAL_RUN_FIRST,
                  ((glong) __builtin_offsetof(GimpContainerClass, remove)),
                  ((void*)0), ((void*)0),
                  g_cclosure_marshal_VOID__OBJECT,
                  ((GType) ((1) << (2))), 1,
                  (gimp_object_get_type ()));
  ...
  container_signals[REORDER] =
    g_signal_new ("reorder",
                  (((GTypeClass*) (klass))->g_type),
                  G_SIGNAL_RUN_FIRST,
                  ((glong) __builtin_offsetof(GimpContainerClass, reorder)),
                  ((void*)0), ((void*)0),
  ...
  container_signals[FREEZE] =
    g_signal_new ("freeze",
                  (((GTypeClass*) (klass))->g_type),
                  G_SIGNAL_RUN_LAST,
                  ((glong) __builtin_offsetof(GimpContainerClass, freeze)),
                  ((void*)0), ((void*)0),
  ...
  container_signals[THAW] =
    g_signal_new ("thaw",
                  (((GTypeClass*) (klass))->g_type),
                  G_SIGNAL_RUN_LAST,
                  ((glong) __builtin_offsetof(GimpContainerClass, thaw)),
                  ((void*)0), ((void*)0),
                  g_cclosure_marshal_VOID__VOID,
                  ((GType) ((1) << (2))), 0);
  ...
  klass->reorder = ((void*)0);
  klass->freeze = ((void*)0);
  klass->thaw = ((void*)0);

  klass->clear = ((void*)0);
  klass->have = ((void*)0);
  klass->foreach = ((void*)0);
  klass->get_child_by_name = ((void*)0);
  klass->get_child_by_index = ((void*)0);
  klass->get_child_index = ((void*)0);
...
{
  container->priv = ((GimpContainerPriv*) g_type_instance_get_private ((GTypeInstance*) (container), ((gimp_container_get_type ()))));


  container->priv->handlers = ((void*)0);
  container->priv->freeze_count = 0;

  container->priv->children_type = ((GType) ((1) << (2)));
...
{
  GimpContainer *container = ((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_container_get_type ()))))));
  ...
  if (container->priv->children_type != ((GType) ((1) << (2))))
    {
      g_type_class_unref (g_type_class_peek (container->priv->children_type));
      container->priv->children_type = ((GType) ((1) << (2)));
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_container_parent_class)), (((GType) ((20) << (2))))))))->dispose (object);
}
                             ...
                             GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_POLICY:
      ...
      break;
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpcontainer.c", 278, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                            ...
                            gint64 *gui_size)
{
  ...
  for (list = container->priv->handlers; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
  ...
  return memsize + ((((GimpObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_container_parent_class)), ((gimp_object_get_type ()))))))->get_memsize (object,
                                                                  gui_size);
}
                                  ...
                                  SerializeData *serialize_data)
{
  ...
  config_iface = ((((GimpConfigInterface*) g_type_interface_peek (((GTypeInstance*) ((object)))->g_class, ((gimp_config_interface_get_type ()))))));

  if (! config_iface)
    serialize_data->success = (0);

  if (! serialize_data->success)
    return;

  gimp_config_writer_open (serialize_data->writer,
                           g_type_name (((((GTypeClass*) (((GTypeInstance*) (object))->g_class))->g_type))));
  ...
  serialize_data->success = config_iface->serialize (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_config_interface_get_type ())))))),
...
gimp_container_serialize (GimpConfig *config,
                          ...
                          gpointer data)
{
  GimpContainer *container = ((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((config)), ((gimp_container_get_type ()))))));
  SerializeData serialize_data;
        ...
        case G_TOKEN_IDENTIFIER:
          {
            ...
            if (! g_type_is_a (type, (gimp_config_interface_get_type ())))
              {
                g_scanner_error (scanner,
            ...
            if (! child)
              {
                if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((data)); GType __t = ((gimp_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
                  child = g_object_new (type, "gimp", data, ((void*)0));
                else
                  child = g_object_new (type, ((void*)0));
            ...
            if (! ((((GimpConfigInterface*) g_type_interface_peek (((GTypeInstance*) ((child)))->g_class, ((gimp_config_interface_get_type ()))))))->deserialize (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((child)), ((gimp_config_interface_get_type ())))))),
                                                                  scanner,
                                                                  nest_level + 1,
                                                                  ((void*)0)))
              {
...
gimp_container_disconnect_callback (GimpObject *object,
                                    gpointer data)
{
  GimpContainer *container = ((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((data)), ((gimp_container_get_type ()))))));
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (((GType) ((1) << (2)))); }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (0); }; }while (0);
                    ...
                    GimpObject *object)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return ((0)); }; }while (0);
  do{ if (object != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "object != NULL"); return ((0)); }; }while (0);
  do{ if (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) (object); GType __t = (container->priv->children_type); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "G_TYPE_CHECK_INSTANCE_TYPE (object, container->priv->children_type)"); return ((0)); }; }while (0);
  ...
  if (gimp_container_have (container, object))
    {
      g_warning ("%s: container %p already contains object %p",
                 ((const char*) (__func__)), container, object);
      return (0);
    }
  ...
  for (list = container->priv->handlers; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
      ...
      handler_id = g_signal_connect_data ((object), (handler->signame), (handler->callback), (handler->callback_data), ((void*)0), (GConnectFlags) 0);




      g_object_set_qdata (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), (((GType) ((20) << (2)))))))), handler->quark,
                          ((gpointer) (gulong) (handler_id)));
    }
  ...
  switch (container->priv->policy)
    ...
    case GIMP_CONTAINER_POLICY_WEAK:
      g_signal_connect_data ((object), ("disconnect"), (((GCallback) (gimp_container_disconnect_callback))), (container), ((void*)0), (GConnectFlags) 0);
                       ...
                       GimpObject *object)
{
  ...
  for (list = container->priv->handlers; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
      ...
      handler_id = ((guint) (gulong) (g_object_get_qdata (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), (((GType) ((20) << (2)))))))), handler->quark)));
      ...
      if (handler_id)
        {
          ...
          g_object_set_qdata (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((object)), (((GType) ((20) << (2)))))))), handler->quark, ((void*)0));
        }
    }
  ...
  switch (container->priv->policy)
    ...
    case GIMP_CONTAINER_POLICY_WEAK:
      g_signal_handlers_disconnect_matched ((object), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_container_disconnect_callback), (container));
                       ...
                       gint index)
{
  ...
  do{ if (index >= -1 && index <= container->priv->n_children) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "index >= -1 && index <= container->priv->n_children"); return ((0)); }; }while (0);
                        ...
                        gint new_index)
{
  ...
  do{ if (new_index >= -1 && new_index < container->priv->n_children) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "new_index >= -1 && new_index < container->priv->n_children"); return ((0)); }; }while (0);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return; }; }while (0);
...
gimp_container_frozen (GimpContainer *container)
{
  ...
  return (container->priv->freeze_count > 0) ? (!(0)) : (0);
}
  ...
  if (container->priv->n_children > 0)
    {
      ...
      ((((GimpContainerClass*) (((GTypeInstance*) ((container)))->g_class))))->clear (container);
                     ...
                     GimpObject *object)
{
  ...
  return ((((GimpContainerClass*) (((GTypeInstance*) ((container)))->g_class))))->have (container, object);
}
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return; }; }while (0);
  do{ if (func != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "func != NULL"); return; }; }while (0);

  if (container->priv->n_children > 0)
    ((((GimpContainerClass*) (((GTypeInstance*) ((container)))->g_class))))->foreach (container, func, user_data);
}
...
gimp_container_get_child_by_name (const GimpContainer *container,
                                  const gchar *name)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (((void*)0)); }; }while (0);

  if (!name)
    return ((void*)0);

  return ((((GimpContainerClass*) (((GTypeInstance*) ((container)))->g_class))))->get_child_by_name (container,
                                                                  name);
}
                                   ...
                                   gint index)
{
  ...
  return ((((GimpContainerClass*) (((GTypeInstance*) ((container)))->g_class))))->get_child_by_index (container,
                                                                   index);
}
# 844 "gimpcontainer.c"
GimpObject *
...
gimp_container_get_child_index (const GimpContainer *container,
                                const GimpObject *object)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (-1); }; }while (0);
  do{ if (object != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "object != NULL"); return (-1); }; }while (0);
  do{ if (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) (object); GType __t = (container->priv->children_type); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "G_TYPE_CHECK_INSTANCE_TYPE (object, container->priv->children_type)"); return (-1); }; }while (0);



  return ((((GimpContainerClass*) (((GTypeInstance*) ((container)))->g_class))))->get_child_index (container,
                                                                object);
}
                                ...
                                const GimpObject *object)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (((void*)0)); }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((object)); GType __t = ((gimp_object_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_OBJECT (object)"); return (((void*)0)); }; }while (0);
                               ...
                               gint *length)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (((void*)0)); }; }while (0);
  do{ if (length != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "length != NULL"); return (((void*)0)); }; }while (0);

  *length = gimp_container_get_n_children (container);
  if (*length == 0)
    return ((void*)0);

  names = iter = ((gchar * *) g_malloc_n ((*length), sizeof (gchar *)));
                            ...
                            gpointer callback_data)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return (0); }; }while (0);
  do{ if (signame != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "signame != NULL"); return (0); }; }while (0);
  do{ if (callback != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "callback != NULL"); return (0); }; }while (0);

  if (! g_str_has_prefix (signame, "notify::"))
    do{ if (g_signal_lookup (signame, container->priv->children_type)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "g_signal_lookup (signame, container->priv->children_type)"); return (0); }; }while (0);


  handler = ((GimpContainerHandler*) g_slice_alloc0 (sizeof (GimpContainerHandler)));
                               ...
                               GQuark id)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_CONTAINER (container)"); return; }; }while (0);
  do{ if (id != 0) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "id != 0"); return; }; }while (0);
  ...
  do { if (1) g_slice_free1 (sizeof (GimpContainerHandler), (handler)); else (void) ((GimpContainerHandler*) 0 == (handler)); } while (0);
}
