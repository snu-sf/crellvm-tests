# 1 "gimpfilteredcontainer.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpfilteredcontainer.c" 2
# 22 "gimpfilteredcontainer.c"
# 1 "../../config.h" 1
# 23 "gimpfilteredcontainer.c" 2
...
static void gimp_filtered_container_init (GimpFilteredContainer *self); static void gimp_filtered_container_class_init (GimpFilteredContainerClass *klass); static gpointer gimp_filtered_container_parent_class = ((void*)0); static gint GimpFilteredContainer_private_offset; static void gimp_filtered_container_class_intern_init (gpointer klass) { gimp_filtered_container_parent_class = g_type_class_peek_parent (klass); if (GimpFilteredContainer_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpFilteredContainer_private_offset); gimp_filtered_container_class_init ((GimpFilteredContainerClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_filtered_container_get_instance_private (GimpFilteredContainer *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpFilteredContainer_private_offset)))); } GType gimp_filtered_container_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_list_get_type ()), g_intern_static_string ("GimpFilteredContainer"), sizeof (GimpFilteredContainerClass), (GClassInitFunc) gimp_filtered_container_class_intern_init, sizeof (GimpFilteredContainer), (GInstanceInitFunc) gimp_filtered_container_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpFilteredContainer *filtered_container = ((((GimpFilteredContainer*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_filtered_container_get_type ()))))));

  if (((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_filtered_container_parent_class)), (((GType) ((20) << (2))))))))->constructed)
    ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_filtered_container_parent_class)), (((GType) ((20) << (2))))))))->constructed (object);

  do { if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((filtered_container->src_container)); GType __t = ((gimp_container_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) ; else g_assertion_message_expr ("Gimp-Core", "gimpfilteredcontainer.c", 128, ((const char*) (__func__)), "GIMP_IS_CONTAINER (filtered_container->src_container)"); } while (0);
...
gimp_filtered_container_dispose (GObject *object)
{
  ...
  if (filtered_container->src_container)
    {
      g_signal_handlers_disconnect_matched ((filtered_container->src_container), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_filtered_container_src_add), (filtered_container));


      g_signal_handlers_disconnect_matched ((filtered_container->src_container), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_filtered_container_src_remove), (filtered_container));


      g_signal_handlers_disconnect_matched ((filtered_container->src_container), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_filtered_container_src_freeze), (filtered_container));


      g_signal_handlers_disconnect_matched ((filtered_container->src_container), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_filtered_container_src_thaw), (filtered_container));


    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_filtered_container_parent_class)), (((GType) ((20) << (2))))))))->dispose (object);
}
  ...
  if (filtered_container->src_container)
    {
      ...
      filtered_container->src_container = ((void*)0);
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_filtered_container_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                                      ...
                                      GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_SRC_CONTAINER:
      ...
      g_signal_connect_data ((filtered_container->src_container), ("add"), (((GCallback) (gimp_filtered_container_src_add))), (filtered_container), ((void*)0), (GConnectFlags) 0);


      g_signal_connect_data ((filtered_container->src_container), ("remove"), (((GCallback) (gimp_filtered_container_src_remove))), (filtered_container), ((void*)0), (GConnectFlags) 0);


      g_signal_connect_data ((filtered_container->src_container), ("freeze"), (((GCallback) (gimp_filtered_container_src_freeze))), (filtered_container), ((void*)0), (GConnectFlags) 0);


      g_signal_connect_data ((filtered_container->src_container), ("thaw"), (((GCallback) (gimp_filtered_container_src_thaw))), (filtered_container), ((void*)0), (GConnectFlags) 0);
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpfilteredcontainer.c", 217, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                      ...
                                      GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpfilteredcontainer.c", 245, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                      ...
                                      GimpObject *object)
{
  if (gimp_filtered_container_object_matches (filtered_container, object))
    {
      gimp_container_add (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((filtered_container)), ((gimp_container_get_type ())))))), object);
    }
}
                                         ...
                                         GimpObject *object)
{
  if (gimp_filtered_container_object_matches (filtered_container, object))
    {
      gimp_container_remove (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((filtered_container)), ((gimp_container_get_type ())))))), object);
    }
}
                             ...
                             gpointer filter_data)
{
  ...
  return g_object_new ((gimp_filtered_container_get_type ()),
                       "sort-func", sort_func,
                                 ...
                                 GimpFilteredContainer *filtered_container)
{
  if (! gimp_container_frozen (filtered_container->src_container))
    {
      ((((GimpFilteredContainerClass*) (((GTypeInstance*) ((filtered_container)))->g_class))))->src_add (filtered_container,
                                                                       object);
    }
}
                                    ...
                                    GimpFilteredContainer *filtered_container)
{
  if (! gimp_container_frozen (filtered_container->src_container))
    {
      ((((GimpFilteredContainerClass*) (((GTypeInstance*) ((filtered_container)))->g_class))))->src_remove (filtered_container,
                                                                          object);
    }
}
...
gimp_filtered_container_src_freeze (GimpContainer *src_container,
                                    GimpFilteredContainer *filtered_container)
{
  gimp_container_freeze (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((filtered_container)), ((gimp_container_get_type ())))))));

  ((((GimpFilteredContainerClass*) (((GTypeInstance*) ((filtered_container)))->g_class))))->src_freeze (filtered_container);
}
...
gimp_filtered_container_src_thaw (GimpContainer *src_container,
                                  GimpFilteredContainer *filtered_container)
{
  ((((GimpFilteredContainerClass*) (((GTypeInstance*) ((filtered_container)))->g_class))))->src_thaw (filtered_container);

  gimp_container_thaw (((((GimpContainer*) g_type_check_instance_cast ((GTypeInstance*) ((filtered_container)), ((gimp_container_get_type ())))))));
}
