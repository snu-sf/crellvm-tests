...
gimp_area_new (gint x1,
               ...
               gint y2)
{
  GimpArea *area = ((GimpArea*) g_slice_alloc (sizeof (GimpArea)));
...
{
  do { if (1) g_slice_free1 (sizeof (GimpArea), (area)); else (void) ((GimpArea*) 0 == (area)); } while (0);
}
                        ...
                        GimpArea *area)
{
  ...
  retval = g_slist_prepend (((void*)0), area);

  for (l = list; l; l = ((l) ? (((GSList *)(l))->next) : ((void*)0)))
    {
      ...
      area1 = (area->x2 - area->x1) * (area->y2 - area->y1) + 25;
      area2 = (this->x2 - this->x1) * (this->y2 - this->y1) + 25;
      area3 = (((((this->x2) > (area->x2)) ? (this->x2) : (area->x2)) - (((this->x1) < (area->x1)) ? (this->x1) : (area->x1))) *
               ((((this->y2) > (area->y2)) ? (this->y2) : (area->y2)) - (((this->y1) < (area->y1)) ? (this->y1) : (area->y1))) + 25);
      ...
      if (area1 + area2 < area3)
        ...
        {
          area->x1 = (((area->x1) < (this->x1)) ? (area->x1) : (this->x1));
          area->y1 = (((area->y1) < (this->y1)) ? (area->y1) : (this->y1));
          area->x2 = (((area->x2) > (this->x2)) ? (area->x2) : (this->x2));
          area->y2 = (((area->y2) > (this->y2)) ? (area->y2) : (this->y2));

          do { if (1) g_slice_free1 (sizeof (GimpArea), (this)); else (void) ((GimpArea*) 0 == (this)); } while (0);
        }
    }
