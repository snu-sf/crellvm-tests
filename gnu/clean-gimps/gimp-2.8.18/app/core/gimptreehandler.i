...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimptreehandler.c" 2
# 21 "gimptreehandler.c"
# 1 "../../config.h" 1
# 22 "gimptreehandler.c" 2
...
void gimp_container_remove_handler (GimpContainer *container,
                                                GQuark id);
# 28 "gimptreehandler.c" 2
# 1 "./gimptreehandler.h" 1
# 36 "./gimptreehandler.h"
...
GType gimp_tree_handler_get_type (void) __attribute__((__const__));
...
static void gimp_tree_handler_init (GimpTreeHandler *self); static void gimp_tree_handler_class_init (GimpTreeHandlerClass *klass); static gpointer gimp_tree_handler_parent_class = ((void*)0); static gint GimpTreeHandler_private_offset; static void gimp_tree_handler_class_intern_init (gpointer klass) { gimp_tree_handler_parent_class = g_type_class_peek_parent (klass); if (GimpTreeHandler_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpTreeHandler_private_offset); gimp_tree_handler_class_init ((GimpTreeHandlerClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_tree_handler_get_instance_private (GimpTreeHandler *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpTreeHandler_private_offset)))); } GType gimp_tree_handler_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_object_get_type ()), g_intern_static_string ("GimpTreeHandler"), sizeof (GimpTreeHandlerClass), (GClassInitFunc) gimp_tree_handler_class_intern_init, sizeof (GimpTreeHandler), (GInstanceInitFunc) gimp_tree_handler_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpTreeHandler *handler = ((((GimpTreeHandler*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_tree_handler_get_type ()))))));

  if (handler->container)
    {
      g_signal_handlers_disconnect_matched ((handler->container), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_tree_handler_freeze), (handler));


      g_signal_handlers_disconnect_matched ((handler->container), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_tree_handler_thaw), (handler));
      ...
      handler->container = ((void*)0);

      g_free (handler->signal_name);
      handler->signal_name = ((void*)0);
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_tree_handler_parent_class)), (((GType) ((20) << (2))))))))->dispose (object);
}
                           ...
                           gpointer user_data)
{
  ...
  do{ if (signal_name != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "signal_name != NULL"); return (((void*)0)); }; }while (0);

  handler = g_object_new ((gimp_tree_handler_get_type ()), ((void*)0));
  ...
  g_signal_connect_object (container, "freeze",
                           ((GCallback) (gimp_tree_handler_freeze)),
                           handler,
                           G_CONNECT_SWAPPED);
  g_signal_connect_object (container, "thaw",
                           ((GCallback) (gimp_tree_handler_thaw)),
                           handler,
                           G_CONNECT_SWAPPED);
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((handler)); GType __t = ((gimp_tree_handler_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "GIMP_IS_TREE_HANDLER (handler)"); return; }; }while (0);

  g_object_run_dispose (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((handler)), (((GType) ((20) << (2)))))))));
                                 ...
                                 GimpContainer *container)
{
  ...
  g_signal_connect_object (container, "add",
                           ((GCallback) (gimp_tree_handler_add)),
                           handler,
                           G_CONNECT_SWAPPED);
  g_signal_connect_object (container, "remove",
                           ((GCallback) (gimp_tree_handler_remove)),
                           handler,
                           G_CONNECT_SWAPPED);
}
...
gimp_tree_handler_add_foreach (GimpViewable *viewable,
                               GimpTreeHandler *handler)
{
  gimp_tree_handler_add (handler, viewable, ((void*)0));
}
                       ...
                       GimpContainer *unused)
{
  ...
  g_signal_connect_data ((viewable), (handler->signal_name), (handler->callback), (handler->user_data), ((void*)0), (GConnectFlags) 0);
...
gimp_tree_handler_remove_container (GimpTreeHandler *handler,
                                    GimpContainer *container)
{
  g_signal_handlers_disconnect_matched ((container), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_tree_handler_add), (handler));


  g_signal_handlers_disconnect_matched ((container), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_tree_handler_remove), (handler));
...
gimp_tree_handler_remove_foreach (GimpViewable *viewable,
                                  GimpTreeHandler *handler)
{
  gimp_tree_handler_remove (handler, viewable, ((void*)0));
}
                          ...
                          GimpContainer *unused)
{
  ...
  g_signal_handlers_disconnect_matched ((viewable), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (handler->callback), (handler->user_data));
