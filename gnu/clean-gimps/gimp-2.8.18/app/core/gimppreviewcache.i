# 1 "gimppreviewcache.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppreviewcache.c" 2
# 18 "gimppreviewcache.c"
# 1 "../../config.h" 1
# 19 "gimppreviewcache.c" 2
...
void temp_buf_dump (TempBuf *buf,
                                  const gchar *filename);
# 25 "gimppreviewcache.c" 2

# 1 "./gimppreviewcache.h" 1
# 26 "./gimppreviewcache.h"
  ...
  if (pn.buf)
    {
      ...
      preview = temp_buf_new (width, height, pn.buf->bytes, 0, 0, ((void*)0));
