...
static const GimpUnitDef gimp_unit_defs[GIMP_UNIT_END] =
{
  ...
  { (0), 25.4, 1, "millimeters", "mm", "mm",
    ("millimeter"), ("millimeters") },


  { (0), 72.0, 0, "points", "pt", "pt",
    ("point"), ("points") },
...
_gimp_unit_new (Gimp *gimp,
                ...
                const gchar *plural)
{
  GimpUnitDef *user_unit = ((GimpUnitDef*) g_slice_alloc0 (sizeof (GimpUnitDef)));

  user_unit->delete_on_exit = (!(0));
...
_gimp_unit_get_deletion_flag (Gimp *gimp,
                              GimpUnit unit)
{
  do{ if (unit < (GIMP_UNIT_END + gimp->n_user_units)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "unit < (GIMP_UNIT_END + gimp->n_user_units)"); return ((0)); }; }while (0);
...
_gimp_unit_set_deletion_flag (Gimp *gimp,
                              ...
                              gboolean deletion_flag)
{
  do{ if ((unit >= GIMP_UNIT_END) && (unit < (GIMP_UNIT_END + gimp->n_user_units))) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "(unit >= GIMP_UNIT_END) && (unit < (GIMP_UNIT_END + gimp->n_user_units))"); return; }; }while (0);
...
_gimp_unit_get_factor (Gimp *gimp,
                       GimpUnit unit)
{
  do{ if (unit < (GIMP_UNIT_END + gimp->n_user_units)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "unit < (GIMP_UNIT_END + gimp->n_user_units)"); return (gimp_unit_defs[GIMP_UNIT_INCH].factor); }; }while (0);
...
_gimp_unit_get_digits (Gimp *gimp,
                       GimpUnit unit)
{
  do{ if (unit < (GIMP_UNIT_END + gimp->n_user_units)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "unit < (GIMP_UNIT_END + gimp->n_user_units)"); return (gimp_unit_defs[GIMP_UNIT_INCH].digits); }; }while (0);
...
_gimp_unit_get_identifier (Gimp *gimp,
                           GimpUnit unit)
{
  do{ if ((unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "(unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)"); return (gimp_unit_defs[GIMP_UNIT_INCH].identifier); }; }while (0);
...
_gimp_unit_get_symbol (Gimp *gimp,
                       GimpUnit unit)
{
  do{ if ((unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "(unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)"); return (gimp_unit_defs[GIMP_UNIT_INCH].symbol); }; }while (0);
...
_gimp_unit_get_abbreviation (Gimp *gimp,
                             GimpUnit unit)
{
  do{ if ((unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "(unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)"); return (gimp_unit_defs[GIMP_UNIT_INCH].abbreviation); }; }while (0);
...
_gimp_unit_get_singular (Gimp *gimp,
                         GimpUnit unit)
{
  do{ if ((unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "(unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)"); return (gimp_unit_defs[GIMP_UNIT_INCH].singular); }; }while (0);



  if (unit < GIMP_UNIT_END)
    return g_dpgettext2 (((void*)0), "unit-singular", gimp_unit_defs[unit].singular);

  if (unit == GIMP_UNIT_PERCENT)
    return g_dpgettext2 (((void*)0), "unit-singular", gimp_unit_percent.singular);
...
_gimp_unit_get_plural (Gimp *gimp,
                       GimpUnit unit)
{
  do{ if ((unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)) { } else { g_return_if_fail_warning ("Gimp-Core", ((const char*) (__func__)), "(unit < (GIMP_UNIT_END + gimp->n_user_units)) || (unit == GIMP_UNIT_PERCENT)"); return (gimp_unit_defs[GIMP_UNIT_INCH].plural); }; }while (0);



  if (unit < GIMP_UNIT_END)
    return g_dpgettext2 (((void*)0), "unit-plural", gimp_unit_defs[unit].plural);

  if (unit == GIMP_UNIT_PERCENT)
    return g_dpgettext2 (((void*)0), "unit-plural", gimp_unit_percent.plural);
...
gimp_user_units_free (Gimp *gimp)
{
  ...
  for (list = gimp->user_units; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
      ...
      do { if (1) g_slice_free1 (sizeof (GimpUnitDef), (user_unit)); else (void) ((GimpUnitDef*) 0 == (user_unit)); } while (0);
    }

  g_list_free (gimp->user_units);
  gimp->user_units = ((void*)0);
  gimp->n_user_units = 0;
}
