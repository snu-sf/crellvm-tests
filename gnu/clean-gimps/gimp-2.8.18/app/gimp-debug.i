...
static GHashTable *class_hash = ((void*)0);


void
gimp_debug_enable_instances (void)
{
  do{ if (class_hash == ((void*)0)) { } else { g_return_if_fail_warning ("Gimp", ((const char*) (__func__)), "class_hash == NULL"); return; }; }while (0);
  ...
  if (class_hash)
    {
      ...
      type_name = g_type_name ((((GTypeClass*) (klass))->g_type));
  ...
  if (class_hash)
    {
      ...
      type_name = g_type_name ((((((GTypeClass*) (((GTypeInstance*) (instance))->g_class))->g_type))));
...
gimp_debug_instance_foreach (GObject *instance)
{
  g_printerr ("  \'%s\': ref_count = %d\n",
              (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((instance)); GType __t = ((gimp_object_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))) ?
