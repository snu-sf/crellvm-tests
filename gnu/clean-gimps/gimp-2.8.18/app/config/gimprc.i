...
# 1 "./gimpconfig-file.h" 1
# 25 "./gimpconfig-file.h"
...
# 1 "./gimprc.h" 1
# 24 "./gimprc.h"
# 1 "../../app/config/gimppluginconfig.h" 1
# 24 "../../app/config/gimppluginconfig.h"
# 1 "../../app/config/gimpguiconfig.h" 1
# 24 "../../app/config/gimpguiconfig.h"
...
# 25 "../../app/config/gimpguiconfig.h" 2
# 34 "../../app/config/gimpguiconfig.h"
...
# 25 "../../app/config/gimppluginconfig.h" 2
# 34 "../../app/config/gimppluginconfig.h"
...
GType gimp_plugin_config_get_type (void) __attribute__((__const__));
# 25 "./gimprc.h" 2
# 34 "./gimprc.h"
...
GType gimp_rc_get_type (void) __attribute__((__const__));
...
gboolean gimp_rc_deserialize (GimpConfig *config,
                               ...
                               gpointer data);
# 35 "gimprc.c" 2
# 1 "./gimprc-serialize.h" 1
# 25 "./gimprc-serialize.h"
...
static void gimp_rc_init (GimpRc *self); static void gimp_rc_class_init (GimpRcClass *klass); static gpointer gimp_rc_parent_class = ((void*)0); static gint GimpRc_private_offset; static void gimp_rc_class_intern_init (gpointer klass) { gimp_rc_parent_class = g_type_class_peek_parent (klass); if (GimpRc_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpRc_private_offset); gimp_rc_class_init ((GimpRcClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_rc_get_instance_private (GimpRc *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpRc_private_offset)))); } GType gimp_rc_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_plugin_config_get_type ()), g_intern_static_string ("GimpRc"), sizeof (GimpRcClass), (GClassInitFunc) gimp_rc_class_intern_init, sizeof (GimpRc), (GInstanceInitFunc) gimp_rc_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) gimp_rc_config_iface_init, ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
{
  GimpRc *rc = ((((GimpRc*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_rc_get_type ()))))));

  if (rc->save_idle_id)
    gimp_rc_idle_save (rc);

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_rc_parent_class)), (((GType) ((20) << (2))))))))->dispose (object);
}
  ...
  if (rc->system_gimprc)
    {
      ...
      rc->system_gimprc = ((void*)0);
    }
  if (rc->user_gimprc)
    {
      g_free (rc->user_gimprc);
      rc->user_gimprc = ((void*)0);
    }

  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_rc_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                      ...
                      GParamSpec *pspec)
{
  ...
  switch (property_id)
   ...
   default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimprc.c", 192, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                      ...
                      GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_USER_GIMPRC:
      ...
      break;
   default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimprc.c", 217, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
...
gimp_rc_duplicate_unknown_token (const gchar *key,
                                 ...
                                 gpointer user_data)
{
  gimp_rc_add_unknown_token (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((user_data)), ((gimp_config_interface_get_type ())))))), key, value);
}

static GimpConfig *
gimp_rc_duplicate (GimpConfig *config)
{
  GimpConfig *dup = g_object_new ((gimp_rc_get_type ()), ((void*)0));

  gimp_config_sync (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))), ((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((dup)), (((GType) ((20) << (2)))))))), 0);
...
gimp_rc_load (GimpRc *rc)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((rc)); GType __t = ((gimp_rc_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "GIMP_IS_RC (rc)"); return; }; }while (0);

  if (rc->verbose)
    g_print ("Parsing '%s'\n",
             gimp_filename_to_utf8 (rc->system_gimprc));

  if (! gimp_config_deserialize_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((rc)), ((gimp_config_interface_get_type ())))))),
                                      rc->system_gimprc, ((void*)0), &error))
    {
  ...
  if (! gimp_config_deserialize_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((rc)), ((gimp_config_interface_get_type ())))))),
                                      rc->user_gimprc, ((void*)0), &error))
    {
      if (error->code != GIMP_CONFIG_ERROR_OPEN_ENOENT)
        {
          g_message ("%s", error->message);

          gimp_config_file_backup_on_error (rc->user_gimprc, "gimprc", ((void*)0));
        }
...
gimp_rc_new (const gchar *system_gimprc,
             ...
             gboolean verbose)
{
  GimpRc *rc = g_object_new ((gimp_rc_get_type ()),
                             "verbose", verbose,
                      ...
                      gboolean autosave)
{
  ...
  if (autosave)
    g_signal_connect_data ((rc), ("notify"), (((GCallback) (gimp_rc_notify))), (((void*)0)), ((void*)0), (GConnectFlags) 0);


  else
    g_signal_handlers_disconnect_matched ((rc), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_rc_notify), (((void*)0)));
               ...
               const gchar *key)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((rc)); GType __t = ((gimp_rc_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "GIMP_IS_RC (rc)"); return (((void*)0)); }; }while (0);
  do{ if (key != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "key != NULL"); return (((void*)0)); }; }while (0);

  rc_object = ((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((rc)), (((GType) ((20) << (2))))))));
  klass = ((((GObjectClass*) (((GTypeInstance*) ((rc)))->g_class))));
  ...
  for (i = 0, prop_spec = ((void*)0); i < n_property_specs && !prop_spec; i++)
    {
  ...
  if (prop_spec)
    {
      GString *str = g_string_new (((void*)0));
      GValue value = { 0, };

      g_value_init (&value, prop_spec->value_type);
      g_object_get_property (rc_object, prop_spec->name, &value);

      if (gimp_config_serialize_value (&value, str, (0)))
        retval = g_string_free (str, (0));
      else
        g_string_free (str, (!(0)));
    ...
    {
      retval = g_strdup (gimp_rc_lookup_unknown_token (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((rc)), ((gimp_config_interface_get_type ())))))), key));
    }
  ...
  if (!retval)
    {
      ...
      for (i = 0; !retval && i < (sizeof (path_tokens) / sizeof ((path_tokens)[0])); i++)
  ...
  if (retval)
    {
      gchar *tmp = gimp_config_path_expand (retval, (0), ((void*)0));
                           ...
                           const gchar *value)
{
  ...
  gimp_rc_add_unknown_token (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((rc)), ((gimp_config_interface_get_type ())))))), token, value);

  if (rc->autosave)
    gimp_rc_notify (rc, ((void*)0), ((void*)0));
}
# 489 "gimprc.c"
void
gimp_rc_save (GimpRc *rc)
{
  ...
  global = g_object_new ((gimp_rc_get_type ()), ((void*)0));

  gimp_config_deserialize_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((global)), ((gimp_config_interface_get_type ())))))),
                                rc->system_gimprc, ((void*)0), ((void*)0));

  header = g_strconcat (top, rc->system_gimprc, bottom, ((void*)0));

  if (rc->verbose)
    g_print ("Writing '%s'\n",
             gimp_filename_to_utf8 (rc->user_gimprc));

  if (! gimp_config_serialize_to_file (((((GimpConfig*) g_type_check_instance_cast ((GTypeInstance*) ((rc)), ((gimp_config_interface_get_type ())))))),
                                       rc->user_gimprc,
...
gimp_rc_migrate (GimpRc *rc)
{
  ...
  pspecs = g_object_class_list_properties (((((GObjectClass*) (((GTypeInstance*) ((rc)))->g_class)))), &n_pspecs);

  for (i = 0; i < n_pspecs; i++)
    {
      GParamSpec *pspec = pspecs[i];

      if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((pspec)); GType __t = ((gimp_param_config_path_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
        {
          GValue value = { 0, };
          ...
          g_object_set_property (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((rc)), (((GType) ((20) << (2)))))))), pspec->name, &value);
