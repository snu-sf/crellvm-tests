# 1 "gimprc-serialize.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimprc-serialize.c" 2
# 21 "gimprc-serialize.c"
# 1 "../../config.h" 1
# 22 "gimprc-serialize.c" 2
...
gimp_rc_serialize (GimpConfig *config,
                   ...
                   gpointer data)
{
  if (data && (((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((data)); GType __t = ((gimp_rc_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
    {
                                   ...
                                   GimpConfigWriter *writer)
{
  ...
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((config)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "G_IS_OBJECT (config)"); return ((0)); }; }while (0);
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((compare)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "G_IS_OBJECT (compare)"); return ((0)); }; }while (0);
  do{ if (((((GTypeClass*) (((GTypeInstance*) (config))->g_class))->g_type)) == ((((GTypeClass*) (((GTypeInstance*) (compare))->g_class))->g_type))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "G_TYPE_FROM_INSTANCE (config) == G_TYPE_FROM_INSTANCE (compare)"); return ((0)); }; }while (0);


  diff = gimp_config_diff (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))),
                           ((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((compare)), (((GType) ((20) << (2)))))))), (1 << (0 + (8))));

  for (list = diff; list; list = ((list) ? (((GList *)(list))->next) : ((void*)0)))
    {
