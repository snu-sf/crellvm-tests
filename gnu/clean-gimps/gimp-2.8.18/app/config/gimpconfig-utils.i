...
# 21 "gimpconfig-utils.c"
# 1 "../../config.h" 1
# 22 "gimpconfig-utils.c" 2
  ...
  if (param_spec->flags & G_PARAM_READABLE)
    {
      ...
      dest_spec = g_object_class_find_property (((((GObjectClass*) (((GTypeInstance*) ((dest)))->g_class)))),
                                                param_spec->name);
      ...
      if (dest_spec &&
          ...
          (dest_spec->flags & G_PARAM_CONSTRUCT_ONLY) == 0)
        {
          ...
          g_signal_handlers_block_matched ((dest), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_config_connect_notify), (src));

          g_object_set_property (dest, param_spec->name, &value);
          g_signal_handlers_unblock_matched ((dest), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_config_connect_notify), (src));
                     ...
                     const gchar *property_name)
{
  ...
  do{ if (a != b) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "a != b"); return; }; }while (0);
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((a)), (((GType) ((20) << (2)))))))) && (((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((b)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "G_IS_OBJECT (a) && G_IS_OBJECT (b)"); return; }; }while (0);

  if (property_name)
    signal_name = g_strconcat ("notify::", property_name, ((void*)0));
  else
    signal_name = "notify";

  g_signal_connect_object (a, signal_name,
                           ((GCallback) (gimp_config_connect_notify)),
                           b, 0);
  ...
  if (param_spec->flags & G_PARAM_READABLE)
    {
      ...
      if (dest_spec &&
          ...
          (dest_spec->flags & G_PARAM_CONSTRUCT_ONLY) == 0)
        {
          ...
          g_signal_handlers_block_matched ((dest), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_config_connect_full_notify), (src));

          g_object_set_property (dest, dest_prop_name, &value);
          g_signal_handlers_unblock_matched ((dest), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (gimp_config_connect_full_notify), (src));
                          ...
                          const gchar *property_name_b)
{
  ...
  do{ if (a != b) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "a != b"); return; }; }while (0);
  do{ if ((((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((a)), (((GType) ((20) << (2)))))))) && (((g_type_check_instance_is_fundamentally_a ((GTypeInstance*) ((b)), (((GType) ((20) << (2))))))))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "G_IS_OBJECT (a) && G_IS_OBJECT (b)"); return; }; }while (0);
  do{ if (property_name_a != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "property_name_a != NULL"); return; }; }while (0);
  do{ if (property_name_b != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "property_name_b != NULL"); return; }; }while (0);

  signal_name = g_strconcat ("notify::", property_name_a, ((void*)0));
  attach_key = g_strdup_printf ("%p-%s", b, property_name_a);

  g_signal_connect_object (a, signal_name,
                           ((GCallback) (gimp_config_connect_full_notify)),
                           b, 0);
  ...
  signal_name = g_strconcat ("notify::", property_name_b, ((void*)0));
                        ...
                        GObject *b)
{
  ...
  g_signal_handlers_disconnect_matched ((b), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (((GCallback) (gimp_config_connect_notify))), (a));


  g_signal_handlers_disconnect_matched ((a), (GSignalMatchType) (G_SIGNAL_MATCH_FUNC | G_SIGNAL_MATCH_DATA), 0, 0, ((void*)0), (((GCallback) (gimp_config_connect_notify))), (b));
