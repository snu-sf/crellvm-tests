...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpbaseconfig.c" 2
# 21 "gimpbaseconfig.c"
# 1 "../../config.h" 1
# 22 "gimpbaseconfig.c" 2
...
void pixel_regions_process_parallel_progress
                                      (PixelProcessorFunc func,
                                       ...
                                       gint num_regions,
                                       ...);
# 37 "gimpbaseconfig.c" 2

# 1 "./gimprc-blurbs.h" 1
# 39 "gimpbaseconfig.c" 2
# 1 "./gimpbaseconfig.h" 1
# 34 "./gimpbaseconfig.h"
...
# 40 "gimpbaseconfig.c" 2

# 1 "../../app/gimp-debug.h" 1
# 25 "../../app/gimp-debug.h"
  ...
  if (! config_type)
    {
      ...
      config_type = g_type_register_static (((GType) ((20) << (2))),
                                            "GimpBaseConfig",
                                            &config_info, 0);
    }
...
gimp_base_config_class_init (GimpBaseConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_TEMP_PATH, gimp_param_spec_config_path ("temp-path", ((void*)0), ("Sets the folder for temporary storage. Files will appear here " "during the course of running GIMP.  Most files will disappear " "when GIMP exits, but some files are likely to remain, so it " "is best if this folder not be one that is shared by other users."), GIMP_CONFIG_PATH_DIR, "${gimp_dir}" "/" "tmp", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));





  g_object_class_install_property (object_class, PROP_SWAP_PATH, gimp_param_spec_config_path ("swap-path", ((void*)0), ("Sets the swap file location. GIMP uses a tile based memory allocation " "scheme. The swap file is used to quickly and easily swap tiles out to " "disk and back in. Be aware that the swap file can easily get very large " "if GIMP is used with large images. " "Also, things can get horribly slow if the swap file is created on " "a folder that is mounted over NFS.  For these reasons, it may be " "desirable to put your swap file in \"/tmp\"."), GIMP_CONFIG_PATH_DIR, "${gimp_dir}", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  num_processors = (((num_processors) < (16)) ? (num_processors) : (16));

  g_object_class_install_property (object_class, PROP_NUM_PROCESSORS, g_param_spec_uint ("num-processors", ((void*)0), ("Sets how many processors GIMP should try to use simultaneously."), 1, 16, num_processors, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  memory_size = ((((((((9223372036854775807L *2UL+1UL)) < (((guint64) 1 << 42))) ? ((9223372036854775807L *2UL+1UL)) : (((guint64) 1 << 42))))) < (memory_size)) ? ((((((9223372036854775807L *2UL+1UL)) < (((guint64) 1 << 42))) ? ((9223372036854775807L *2UL+1UL)) : (((guint64) 1 << 42))))) : (memory_size));
  ...
  g_object_class_install_property (object_class, PROP_TILE_CACHE_SIZE, gimp_param_spec_memsize ("tile-cache-size", ((void*)0), ("When the amount of pixel data exceeds this limit, GIMP will start to " "swap tiles to disk.  This is a lot slower but it makes it possible to " "work on images that wouldn't fit into memory otherwise.  If you have a " "lot of RAM, you may want to set this to a higher value."), 0, (((((9223372036854775807L *2UL+1UL)) < (((guint64) 1 << 42))) ? ((9223372036854775807L *2UL+1UL)) : (((guint64) 1 << 42)))), memory_size, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (3 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  g_object_class_install_property (object_class, PROP_STINGY_MEMORY_USE, g_param_spec_boolean ("stingy-memory-use", ((void*)0), ((void*)0), (0), (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_base_config_init (GimpBaseConfig *config,
                       GimpBaseConfigClass *klass)
{
  gimp_debug_add_instance (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))), ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((klass)), (((GType) ((20) << (2)))))))));
}

static void
gimp_base_config_finalize (GObject *object)
{
  GimpBaseConfig *base_config = ((((GimpBaseConfig*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_base_config_get_type ()))))));
                               ...
                               GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpbaseconfig.c", 252, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
