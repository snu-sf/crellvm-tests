...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimprc-unknown.c" 2
# 21 "gimprc-unknown.c"
# 1 "../../config.h" 1
# 22 "gimprc-unknown.c" 2
                           ...
                           const gchar *value)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((config)); GType __t = ((gimp_config_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "GIMP_IS_CONFIG (config)"); return; }; }while (0);
  do{ if (key != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "key != NULL"); return; }; }while (0);

  unknown_tokens = (GSList *) g_object_get_data (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))),
                                                 "gimp-rc-unknown-tokens");

  for (last = ((void*)0), list = unknown_tokens;
       list;
       last = list, list = ((list) ? (((GSList *)(list))->next) : ((void*)0)))
    {
      ...
      if (strcmp (token->key, key) == 0)
        {
          ...
          if (value)
          ...
          else
            {
              ...
              g_object_set_data_full (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))),
                                      "gimp-rc-unknown-tokens",
                                      unknown_tokens,
  ...
  token = ((GimpConfigToken*) g_slice_alloc (sizeof (GimpConfigToken)));
  ...
  if (last)
    ...
    {
      unknown_tokens = g_slist_append (((void*)0), token);
                              ...
                              const gchar *key)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((config)); GType __t = ((gimp_config_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "GIMP_IS_CONFIG (config)"); return (((void*)0)); }; }while (0);
  do{ if (key != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "key != NULL"); return (((void*)0)); }; }while (0);

  unknown_tokens = g_object_get_data (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((config)), (((GType) ((20) << (2)))))))),
                                      "gimp-rc-unknown-tokens");

  for (list = unknown_tokens; list; list = ((list) ? (((GSList *)(list))->next) : ((void*)0)))
    {
                               ...
                               gpointer user_data)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((config)); GType __t = ((gimp_config_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "GIMP_IS_CONFIG (config)"); return; }; }while (0);
  do{ if (func != ((void*)0)) { } else { g_return_if_fail_warning ("Gimp-Config", ((const char*) (__func__)), "func != NULL"); return; }; }while (0);
  ...
  for (list = unknown_tokens; list; list = ((list) ? (((GSList *)(list))->next) : ((void*)0)))
    {
      ...
      g_free (token->key);
      g_free (token->value);
      do { if (1) g_slice_free1 (sizeof (GimpConfigToken), (token)); else (void) ((GimpConfigToken*) 0 == (token)); } while (0);
    }
