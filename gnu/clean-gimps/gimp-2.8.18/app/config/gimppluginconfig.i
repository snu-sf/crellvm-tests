# 1 "gimppluginconfig.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimppluginconfig.c" 2
# 21 "gimppluginconfig.c"
# 1 "../../config.h" 1
# 22 "gimppluginconfig.c" 2
...
# 29 "gimppluginconfig.c" 2

# 1 "./gimprc-blurbs.h" 1
# 31 "gimppluginconfig.c" 2
# 1 "./gimppluginconfig.h" 1
# 24 "./gimppluginconfig.h"
...
# 25 "./gimppluginconfig.h" 2
# 34 "./gimppluginconfig.h"
...
static void gimp_plugin_config_init (GimpPluginConfig *self); static void gimp_plugin_config_class_init (GimpPluginConfigClass *klass); static gpointer gimp_plugin_config_parent_class = ((void*)0); static gint GimpPluginConfig_private_offset; static void gimp_plugin_config_class_intern_init (gpointer klass) { gimp_plugin_config_parent_class = g_type_class_peek_parent (klass); if (GimpPluginConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpPluginConfig_private_offset); gimp_plugin_config_class_init ((GimpPluginConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_plugin_config_get_instance_private (GimpPluginConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpPluginConfig_private_offset)))); } GType gimp_plugin_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_gui_config_get_type ()), g_intern_static_string ("GimpPluginConfig"), sizeof (GimpPluginConfigClass), (GClassInitFunc) gimp_plugin_config_class_intern_init, sizeof (GimpPluginConfig), (GInstanceInitFunc) gimp_plugin_config_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_plugin_config_class_init (GimpPluginConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_FRACTALEXPLORER_PATH, gimp_param_spec_config_path ("fractalexplorer-path", ((void*)0), "Where to search for fractals used by the Fractal Explorer plug-in.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  g_object_class_install_property (object_class, PROP_GFIG_PATH, gimp_param_spec_config_path ("gfig-path", ((void*)0), "Where to search for Gfig figures used by the Gfig plug-in.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  g_object_class_install_property (object_class, PROP_GFLARE_PATH, gimp_param_spec_config_path ("gflare-path", ((void*)0), "Where to search for gflares used by the GFlare plug-in.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  g_object_class_install_property (object_class, PROP_GIMPRESSIONIST_PATH, gimp_param_spec_config_path ("gimpressionist-path", ((void*)0), "Where to search for data used by the Gimpressionist plug-in.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  g_object_class_install_property (object_class, PROP_SCRIPT_FU_PATH, gimp_param_spec_config_path ("script-fu-path", ((void*)0), "This path will be searched for scripts when the Script-Fu plug-in is run.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
{
  GimpPluginConfig *plugin_config = ((((GimpPluginConfig*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_plugin_config_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_plugin_config_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                                 ...
                                 GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimppluginconfig.c", 206, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
