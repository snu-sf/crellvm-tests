# 1 "gimpdisplayoptions.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpdisplayoptions.c" 2
# 21 "gimpdisplayoptions.c"
# 1 "../../config.h" 1
# 22 "gimpdisplayoptions.c" 2
...
# 32 "gimpdisplayoptions.c" 2

# 1 "./gimprc-blurbs.h" 1
# 34 "gimpdisplayoptions.c" 2
...
static void gimp_display_options_init (GimpDisplayOptions *self); static void gimp_display_options_class_init (GimpDisplayOptionsClass *klass); static gpointer gimp_display_options_parent_class = ((void*)0); static gint GimpDisplayOptions_private_offset; static void gimp_display_options_class_intern_init (gpointer klass) { gimp_display_options_parent_class = g_type_class_peek_parent (klass); if (GimpDisplayOptions_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpDisplayOptions_private_offset); gimp_display_options_class_init ((GimpDisplayOptionsClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_display_options_get_instance_private (GimpDisplayOptions *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpDisplayOptions_private_offset)))); } GType gimp_display_options_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpDisplayOptions"), sizeof (GimpDisplayOptionsClass), (GClassInitFunc) gimp_display_options_class_intern_init, sizeof (GimpDisplayOptions), (GInstanceInitFunc) gimp_display_options_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) ((void*)0), ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
static void gimp_display_options_init (GimpDisplayOptionsFullscreen *self); static void gimp_display_options_fullscreen_class_init (GimpDisplayOptionsFullscreenClass *klass); static gpointer gimp_display_options_fullscreen_parent_class = ((void*)0); static gint GimpDisplayOptionsFullscreen_private_offset; static void gimp_display_options_fullscreen_class_intern_init (gpointer klass) { gimp_display_options_fullscreen_parent_class = g_type_class_peek_parent (klass); if (GimpDisplayOptionsFullscreen_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpDisplayOptionsFullscreen_private_offset); gimp_display_options_fullscreen_class_init ((GimpDisplayOptionsFullscreenClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_display_options_fullscreen_get_instance_private (GimpDisplayOptionsFullscreen *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpDisplayOptionsFullscreen_private_offset)))); } GType gimp_display_options_fullscreen_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_3[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_4[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_display_options_get_type ()), g_intern_static_string ("GimpDisplayOptionsFullscreen"), sizeof (GimpDisplayOptionsFullscreenClass), (GClassInitFunc) gimp_display_options_fullscreen_class_intern_init, sizeof (GimpDisplayOptionsFullscreen), (GInstanceInitFunc) gimp_display_options_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) ((void*)0), ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_5[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
static void gimp_display_options_init (GimpDisplayOptionsNoImage *self); static void gimp_display_options_no_image_class_init (GimpDisplayOptionsNoImageClass *klass); static gpointer gimp_display_options_no_image_parent_class = ((void*)0); static gint GimpDisplayOptionsNoImage_private_offset; static void gimp_display_options_no_image_class_intern_init (gpointer klass) { gimp_display_options_no_image_parent_class = g_type_class_peek_parent (klass); if (GimpDisplayOptionsNoImage_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpDisplayOptionsNoImage_private_offset); gimp_display_options_no_image_class_init ((GimpDisplayOptionsNoImageClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_display_options_no_image_get_instance_private (GimpDisplayOptionsNoImage *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpDisplayOptionsNoImage_private_offset)))); } GType gimp_display_options_no_image_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_6[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_7[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_display_options_get_type ()), g_intern_static_string ("GimpDisplayOptionsNoImage"), sizeof (GimpDisplayOptionsNoImageClass), (GClassInitFunc) gimp_display_options_no_image_class_intern_init, sizeof (GimpDisplayOptionsNoImage), (GInstanceInitFunc) gimp_display_options_init, (GTypeFlags) 0); { {{ const GInterfaceInfo g_implement_interface_info = { (GInterfaceInitFunc) ((void*)0), ((void*)0), ((void*)0) }; g_type_add_interface_static (g_define_type_id, (gimp_config_interface_get_type ()), &g_implement_interface_info); };} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_8[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_display_options_class_init (GimpDisplayOptionsClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_SHOW_MENUBAR, g_param_spec_boolean ("show-menubar", ((void*)0), ("When enabled, the menubar is visible by default. This can also be " "toggled with the \"View->Show Menubar\" command."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SHOW_STATUSBAR, g_param_spec_boolean ("show-statusbar", ((void*)0), ("When enabled, the statusbar is visible by default. This can also be " "toggled with the \"View->Show Statusbar\" command."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SHOW_RULERS, g_param_spec_boolean ("show-rulers", ((void*)0), ("When enabled, the rulers are visible by default. This can also be " "toggled with the \"View->Show Rulers\" command."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SHOW_SCROLLBARS, g_param_spec_boolean ("show-scrollbars", ((void*)0), ("When enabled, the scrollbars are visible by default. This can also be " "toggled with the \"View->Show Scrollbars\" command."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SHOW_SELECTION, g_param_spec_boolean ("show-selection", ((void*)0), ("When enabled, the selection is visible by default. This can also be " "toggled with the \"View->Show Selection\" command."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SHOW_LAYER_BOUNDARY, g_param_spec_boolean ("show-layer-boundary", ((void*)0), ("When enabled, the layer boundary is visible by default. This can also " "be toggled with the \"View->Show Layer Boundary\" command."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SHOW_GUIDES, g_param_spec_boolean ("show-guides", ((void*)0), ("When enabled, the guides are visible by default. This can also be " "toggled with the \"View->Show Guides\" command."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SHOW_GRID, g_param_spec_boolean ("show-grid", ((void*)0), ("When enabled, the grid is visible by default. This can also be toggled " "with the \"View->Show Grid\" command."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SHOW_SAMPLE_POINTS, g_param_spec_boolean ("show-sample-points", ((void*)0), ("When enabled, the sample points are visible by default. This can also be " "toggled with the \"View->Show Sample Points\" command."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_PADDING_MODE, g_param_spec_enum ("padding-mode", ((void*)0), ("Specifies how the area around the image should be drawn."), (gimp_canvas_padding_mode_get_type ()), GIMP_CANVAS_PADDING_MODE_DEFAULT, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_PADDING_COLOR, gimp_param_spec_rgb ("padding-color", ((void*)0), ("Sets the canvas padding color used if the padding mode is set to " "custom color."), (0), &white, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_display_options_fullscreen_class_init (GimpDisplayOptionsFullscreenClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_PADDING_MODE, g_param_spec_enum ("padding-mode", ((void*)0), ("Specifies how the area around the image should be drawn."), (gimp_canvas_padding_mode_get_type ()), GIMP_CANVAS_PADDING_MODE_CUSTOM, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_PADDING_COLOR, gimp_param_spec_rgb ("padding-color", ((void*)0), ("Sets the canvas padding color used if the padding mode is set to " "custom color."), (0), &black, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
gimp_display_options_set_property (GObject *object,
                                   ...
                                   GParamSpec *pspec)
{
  GimpDisplayOptions *options = ((((GimpDisplayOptions*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_display_options_get_type ()))))));
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpdisplayoptions.c", 298, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                                   ...
                                   GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpdisplayoptions.c", 348, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
