...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpconfig-dump.c" 2
# 21 "gimpconfig-dump.c"
# 1 "../../config.h" 1
# 22 "gimpconfig-dump.c" 2
...
# 42 "gimpconfig-dump.c" 2

# 1 "./gimpconfig-dump.h" 1
# 24 "./gimpconfig-dump.h"
typedef enum
{
...
gimp_config_dump (GimpConfigDumpFormat format)
{
  ...
  rc = g_object_new ((gimp_rc_get_type ()), ((void*)0));
...
dump_describe_param (GParamSpec *param_spec)
{
  ...
  if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((param_spec)); GType __t = ((gimp_param_rgb_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
    {
  ...
  else if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((param_spec)); GType __t = ((gimp_param_memsize_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
    {
      values =
  ...
  else if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((param_spec)); GType __t = ((gimp_param_config_path_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
    {
  ...
  else if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((param_spec)); GType __t = ((gimp_param_unit_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; })))))
    {
      values =
        "The unit can be one inches, millimeters, points or picas plus "
        "those in your user units database.";
    }
  else if (g_type_is_a (param_spec->value_type, (gimp_config_interface_get_type ())))
    {
