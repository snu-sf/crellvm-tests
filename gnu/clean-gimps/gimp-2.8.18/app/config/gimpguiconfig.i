...
# 24 "gimpguiconfig.c" 2

# 1 "../../libgimpbase/gimpbase.h" 1
# 24 "../../libgimpbase/gimpbase.h"
...
# 25 "../../libgimpbase/gimpbasetypes.h" 2
...
# 25 "../../libgimpbase/gimpbase.h" 2

# 1 "../../libgimpbase/gimpchecks.h" 1
# 61 "../../libgimpbase/gimpchecks.h"
void gimp_checks_get_shades (GimpCheckType type,
                              guchar *light,
                              guchar *dark);
# 27 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimpcpuaccel.h" 1
# 29 "../../libgimpbase/gimpcpuaccel.h"
typedef enum
{
...
# 28 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimpdatafiles.h" 1
# 47 "../../libgimpbase/gimpdatafiles.h"
...
void gimp_datafiles_read_directories (const gchar *path_str,
                                            ...
                                            gpointer user_data);
# 29 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimpenv.h" 1
# 45 "../../libgimpbase/gimpenv.h"
extern const guint gimp_major_version;
extern const guint gimp_minor_version;
extern const guint gimp_micro_version;


const gchar * gimp_directory (void) __attribute__((__const__));
const gchar * gimp_installation_directory (void) __attribute__((__const__));
const gchar * gimp_data_directory (void) __attribute__((__const__));
const gchar * gimp_locale_directory (void) __attribute__((__const__));
const gchar * gimp_sysconf_directory (void) __attribute__((__const__));
const gchar * gimp_plug_in_directory (void) __attribute__((__const__));





const gchar * gimp_gtkrc (void) __attribute__((__const__));
gchar * gimp_personal_rc_file (const gchar *basename) __attribute__((__malloc__));

GList * gimp_path_parse (const gchar *path,
                                               gint max_paths,
                                               gboolean check,
                                               GList **check_failed);
gchar * gimp_path_to_str (GList *path) __attribute__((__malloc__));
void gimp_path_free (GList *path);

gchar * gimp_path_get_user_writable_dir (GList *path) __attribute__((__malloc__));



void gimp_env_init (gboolean plug_in);
# 30 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimplimits.h" 1
# 31 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimpmemsize.h" 1
# 38 "../../libgimpbase/gimpmemsize.h"
GType gimp_memsize_get_type (void) __attribute__((__const__));

gchar * gimp_memsize_serialize (guint64 memsize) __attribute__((__malloc__));
gboolean gimp_memsize_deserialize (const gchar *string,
                                          guint64 *memsize);
# 58 "../../libgimpbase/gimpmemsize.h"
GType gimp_param_memsize_get_type (void) __attribute__((__const__));
...
GParamSpec * gimp_param_spec_memsize (const gchar *name,
                                           ...
                                           guint64 default_value,
                                           GParamFlags flags);
# 32 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimpparasite.h" 1
# 41 "../../libgimpbase/gimpparasite.h"
GType gimp_parasite_get_type (void) __attribute__((__const__));
# 51 "../../libgimpbase/gimpparasite.h"
GType gimp_param_parasite_get_type (void) __attribute__((__const__));

GParamSpec * gimp_param_spec_parasite (const gchar *name,
                                            const gchar *nick,
                                            const gchar *blurb,
                                            GParamFlags flags);
# 71 "../../libgimpbase/gimpparasite.h"
...
# 33 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimprectangle.h" 1
# 31 "../../libgimpbase/gimprectangle.h"
...
void gimp_rectangle_union (gint x1,
                                    ...
                                    gint *dest_width,
                                    gint *dest_height);
# 34 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimpunit.h" 1
# 42 "../../libgimpbase/gimpunit.h"
GType gimp_unit_get_type (void) __attribute__((__const__));
# 52 "../../libgimpbase/gimpunit.h"
GType gimp_param_unit_get_type (void) __attribute__((__const__));
...
gint gimp_unit_get_number_of_built_in_units (void) __attribute__((__const__));
...
gdouble gimp_units_to_points (gdouble value,
                                             GimpUnit unit,
                                             gdouble resolution);
# 35 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimputils.h" 1
# 29 "../../libgimpbase/gimputils.h"
gchar * gimp_utf8_strtrim (const gchar *str,
                                              gint max_chars) __attribute__((__malloc__));
gchar * gimp_any_to_utf8 (const gchar *str,
                                              gssize len,
                                              const gchar *warning_format,
                                              ...) __attribute__((__format__ (__printf__, 3, 4))) __attribute__((__malloc__));
const gchar * gimp_filename_to_utf8 (const gchar *filename);

gchar * gimp_strip_uline (const gchar *str) __attribute__((__malloc__));
gchar * gimp_escape_uline (const gchar *str) __attribute__((__malloc__));

gchar * gimp_canonicalize_identifier (const gchar *identifier) __attribute__((__malloc__));
...
const gchar * gimp_flags_value_get_help (GFlagsClass *flags_class,
                                              GFlagsValue *flags_value);
# 36 "../../libgimpbase/gimpbase.h" 2
# 1 "../../libgimpbase/gimpversion.h" 1
# 37 "../../libgimpbase/gimpbase.h" 2


# 1 "../../libgimpbase/gimpsignal.h" 1
# 39 "../../libgimpbase/gimpsignal.h"
...
GimpSignalHandlerFunc gimp_signal_private (gint signum,
                                            ...
                                            gint flags);
# 40 "../../libgimpbase/gimpbase.h" 2
# 26 "gimpguiconfig.c" 2
...
# 29 "gimpguiconfig.c" 2

# 1 "./gimprc-blurbs.h" 1
# 31 "gimpguiconfig.c" 2
# 1 "./gimpguiconfig.h" 1
# 24 "./gimpguiconfig.h"
# 1 "../../app/config/gimpdisplayconfig.h" 1
# 24 "../../app/config/gimpdisplayconfig.h"
# 1 "../../app/config/gimpcoreconfig.h" 1
# 24 "../../app/config/gimpcoreconfig.h"
...
# 25 "../../app/config/gimpcoreconfig.h" 2

# 1 "../../app/config/gimpbaseconfig.h" 1
# 24 "../../app/config/gimpbaseconfig.h"
...
# 25 "../../app/config/gimpbaseconfig.h" 2
# 34 "../../app/config/gimpbaseconfig.h"
...
GType gimp_base_config_get_type (void) __attribute__((__const__));
# 27 "../../app/config/gimpcoreconfig.h" 2
# 36 "../../app/config/gimpcoreconfig.h"
...
GType gimp_core_config_get_type (void) __attribute__((__const__));
# 25 "../../app/config/gimpdisplayconfig.h" 2
# 38 "../../app/config/gimpdisplayconfig.h"
...
GType gimp_display_config_get_type (void) __attribute__((__const__));
# 25 "./gimpguiconfig.h" 2
# 34 "./gimpguiconfig.h"
...
GType gimp_gui_config_get_type (void) __attribute__((__const__));
# 32 "gimpguiconfig.c" 2
...
static void gimp_gui_config_init (GimpGuiConfig *self); static void gimp_gui_config_class_init (GimpGuiConfigClass *klass); static gpointer gimp_gui_config_parent_class = ((void*)0); static gint GimpGuiConfig_private_offset; static void gimp_gui_config_class_intern_init (gpointer klass) { gimp_gui_config_parent_class = g_type_class_peek_parent (klass); if (GimpGuiConfig_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpGuiConfig_private_offset); gimp_gui_config_class_init ((GimpGuiConfigClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_gui_config_get_instance_private (GimpGuiConfig *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpGuiConfig_private_offset)))); } GType gimp_gui_config_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple ((gimp_display_config_get_type ()), g_intern_static_string ("GimpGuiConfig"), sizeof (GimpGuiConfigClass), (GClassInitFunc) gimp_gui_config_class_intern_init, sizeof (GimpGuiConfig), (GInstanceInitFunc) gimp_gui_config_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_gui_config_class_init (GimpGuiConfigClass *klass)
{
  ...
  g_object_class_install_property (object_class, PROP_MOVE_TOOL_CHANGES_ACTIVE, g_param_spec_boolean ("move-tool-changes-active", ((void*)0), ("If enabled, the move tool sets the edited layer or path as active.  " "This used to be the default behaviour in older versions."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_IMAGE_MAP_TOOL_MAX_RECENT, g_param_spec_int ("image-map-tool-max-recent", ((void*)0), "How many recent settings to keep around in color correction tools", 0, 255, 10, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_TRUST_DIRTY_FLAG, g_param_spec_boolean ("trust-dirty-flag", ((void*)0), ("When enabled, GIMP will not save an image if it has not been changed " "since it was opened."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_SAVE_DEVICE_STATUS, g_param_spec_boolean ("save-device-status", ((void*)0), ("Remember the current tool, pattern, color, and brush across GIMP " "sessions."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_SAVE_SESSION_INFO, g_param_spec_boolean ("save-session-info", ((void*)0), ("Save the positions and sizes of the main dialogs when GIMP exits."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_RESTORE_SESSION, g_param_spec_boolean ("restore-session", ((void*)0), ("Let GIMP try to restore your last saved session on each startup."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SAVE_TOOL_OPTIONS, g_param_spec_boolean ("save-tool-options", ((void*)0), ("Save the tool options when GIMP exits."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_SHOW_TOOLTIPS, g_param_spec_boolean ("show-tooltips", ((void*)0), ("Show a tooltip when the pointer hovers over an item."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_TEAROFF_MENUS, g_param_spec_boolean ("tearoff-menus", ((void*)0), ("When enabled, menus can be torn off."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_CAN_CHANGE_ACCELS, g_param_spec_boolean ("can-change-accels", ((void*)0), ("When enabled, you can change keyboard shortcuts for menu items " "by hitting a key combination while the menu item is highlighted."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SAVE_ACCELS, g_param_spec_boolean ("save-accels", ((void*)0), ("Save changed keyboard shortcuts when GIMP exits."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_RESTORE_ACCELS, g_param_spec_boolean ("restore-accels", ((void*)0), ("Restore saved keyboard shortcuts on each GIMP startup."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_LAST_OPENED_SIZE, g_param_spec_int ("last-opened-size", ((void*)0), ("How many recently opened image filenames to keep on the File menu."), 0, 1024, 10, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_MAX_NEW_IMAGE_SIZE, gimp_param_spec_memsize ("max-new-image-size", ((void*)0), ("GIMP will warn the user if an attempt is made to create an image that " "would take more memory than the size specified here."), 0, ((guint64) 1 << 42), 1 << 27, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_TOOLBOX_COLOR_AREA, g_param_spec_boolean ("toolbox-color-area", ((void*)0), ("Show the current foreground and background colors in the toolbox."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_TOOLBOX_FOO_AREA, g_param_spec_boolean ("toolbox-foo-area", ((void*)0), ("Show the currently selected brush, pattern and gradient in the toolbox."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_TOOLBOX_IMAGE_AREA, g_param_spec_boolean ("toolbox-image-area", ((void*)0), ("Show the currently active image in the toolbox."), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_TOOLBOX_WILBER, g_param_spec_boolean ("toolbox-wilber", ((void*)0), "Show the GIMP mascot at the top of the toolbox.", (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  path = gimp_config_build_data_path ("themes");
  g_object_class_install_property (object_class, PROP_THEME_PATH, gimp_param_spec_config_path ("theme-path", ((void*)0), "Sets the theme search path.", GIMP_CONFIG_PATH_DIR_LIST, path, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_free (path);
  g_object_class_install_property (object_class, PROP_THEME, g_param_spec_string ("theme", ((void*)0), "The name of the theme to use.", "Default", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_USE_HELP, g_param_spec_boolean ("use-help", ((void*)0), ("When enabled, pressing F1 will open the help browser."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_SHOW_HELP_BUTTON, g_param_spec_boolean ("show-help-button", ((void*)0), ("When enabled, dialogs will show a help button that gives access to " "the related help page.  Without this button, the help page can still " "be reached by pressing F1."), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_HELP_LOCALES, g_param_spec_string ("help-locales", ((void*)0), "Specifies the language preferences used by the help system. This is a " "colon-separated list of language identifiers with decreasing priority. " "If empty, the language is taken from the user's locale setting.", "", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));



  g_object_class_install_property (object_class, PROP_HELP_BROWSER, g_param_spec_enum ("help-browser", ((void*)0), ("Sets the browser used by the help system."), (gimp_help_browser_type_get_type ()), GIMP_HELP_BROWSER_WEB_BROWSER, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_USER_MANUAL_ONLINE, g_param_spec_boolean ("user-manual-online", ((void*)0), "When enabled, the online user manual will be used by the help system. " "Otherwise the locally installed copy is used.", (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_USER_MANUAL_ONLINE_URI, g_param_spec_string ("user-manual-online-uri", ((void*)0), "The location of the online user manual. This is used if " "'user-manual-online' is enabled.", "http://docs.gimp.org/" "2.8", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_DOCK_WINDOW_HINT, g_param_spec_enum ("dock-window-hint", ((void*)0), ("The window type hint that is set on dock windows and the toolbox " "window. This may affect the way your window manager decorates and " "handles these windows."), (gimp_window_hint_get_type ()), GIMP_WINDOW_HINT_UTILITY, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (2 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  g_object_class_install_property (object_class, PROP_CURSOR_FORMAT, g_param_spec_enum ("cursor-format", ((void*)0), ("Sets the pixel format to use for mouse pointers."), (gimp_cursor_format_get_type ()), GIMP_CURSOR_FORMAT_PIXBUF, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_CURSOR_HANDEDNESS, g_param_spec_enum ("cursor-handedness", ((void*)0), ("Sets the handedness for cursor positioning."), (gimp_handedness_get_type ()), GIMP_HANDEDNESS_RIGHT, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
  ...
  g_object_class_install_property (object_class, PROP_INFO_WINDOW_PER_DISPLAY, g_param_spec_boolean ("info-window-per-display", ((void*)0), ((void*)0), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));





  g_object_class_install_property (object_class, PROP_MENU_MNEMONICS, g_param_spec_boolean ("menu-mnemonics", ((void*)0), ((void*)0), (!(0)), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_SHOW_TOOL_TIPS, g_param_spec_boolean ("show-tool-tips", ((void*)0), ((void*)0), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_SHOW_TIPS, g_param_spec_boolean ("show-tips", ((void*)0), ((void*)0), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_TOOLBOX_WINDOW_HINT, g_param_spec_enum ("toolbox-window-hint", ((void*)0), ((void*)0), (gimp_window_hint_get_type ()), GIMP_WINDOW_HINT_UTILITY, (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));





  g_object_class_install_property (object_class, PROP_TRANSIENT_DOCKS, g_param_spec_boolean ("transient-docks", ((void*)0), ((void*)0), (0), (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));




  g_object_class_install_property (object_class, PROP_WEB_BROWSER, gimp_param_spec_config_path ("web-browser", ((void*)0), ((void*)0), GIMP_CONFIG_PATH_FILE, "not used any longer", (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB) | (1 << (5 + (8))) | (G_PARAM_READWRITE | G_PARAM_CONSTRUCT | (1 << (0 + (8))))));
...
{
  GimpGuiConfig *gui_config = ((((GimpGuiConfig*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_gui_config_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_gui_config_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                              ...
                              GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpguiconfig.c", 470, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
