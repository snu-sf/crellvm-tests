...
gboolean gimp_eevl_evaluate (const gchar *string,
                             ...
                             GError **error);
# 72 "gimpeevl.c" 2
# 1 "./gimpwidgets-error.h" 1
# 32 "./gimpwidgets-error.h"
typedef enum
{
  GIMP_WIDGETS_PARSE_ERROR
} GimpWidgetsError;
# 47 "./gimpwidgets-error.h"
GQuark gimp_widgets_error_quark (void) __attribute__((__const__));
# 73 "gimpeevl.c" 2
                    ...
                    GError **error)
{
  ...
  do{ if (g_utf8_validate (string, -1, ((void*)0))) { } else { g_return_if_fail_warning ("LibGimpWidgets", ((const char*) (__func__)), "g_utf8_validate (string, -1, NULL)"); return ((0)); }; }while (0);
  do{ if (unit_resolver_proc != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpWidgets", ((const char*) (__func__)), "unit_resolver_proc != NULL"); return ((0)); }; }while (0);
  do{ if (result != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpWidgets", ((const char*) (__func__)), "result != NULL"); return ((0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpWidgets", ((const char*) (__func__)), "error == NULL || *error == NULL"); return ((0)); }; }while (0);
...
gimp_eevl_complete (GimpEevl *eva)
{
  ...
  if (gimp_eevl_accept (eva, GIMP_EEVL_TOKEN_END, ((void*)0)))
    return result;
...
gimp_eevl_expression (GimpEevl *eva)
{
  ...
  for (subtract = (0);
       gimp_eevl_accept (eva, '+', ((void*)0)) ||
       (subtract = gimp_eevl_accept (eva, '-', ((void*)0)));
       subtract = (0))
    {
...
gimp_eevl_term (GimpEevl *eva)
{
  ...
  for (division = (0);
       gimp_eevl_accept (eva, '*', ((void*)0)) ||
       (division = gimp_eevl_accept (eva, '/', ((void*)0)));
       division = (0))
    {
...
gimp_eevl_signed_factor (GimpEevl *eva)
{
  ...
  if (! gimp_eevl_accept (eva, '+', ((void*)0)))
    negate = gimp_eevl_accept (eva, '-', ((void*)0));
...
gimp_eevl_factor (GimpEevl *eva)
{
  ...
  else if (gimp_eevl_accept (eva, '(', ((void*)0)))
    {
  ...
  if (eva->current_token.type == GIMP_EEVL_TOKEN_IDENTIFIER)
    {
      ...
      identifier = ((gchar*) __builtin_alloca (sizeof (gchar) * (gsize) (consumed_token.value.size + 1)));
...
gimp_eevl_move_past_whitespace (GimpEevl *eva)
{
  ...
  while (((g_ascii_table[(guchar) (*eva->string)] & G_ASCII_SPACE) != 0))
    eva->string++;
}
