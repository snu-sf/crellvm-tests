# 1 "gimpwidgetsmarshal.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 319 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpwidgetsmarshal.c" 2
# 1 "./gimpwidgetsmarshal.h" 1
...
extern void _gimp_widgets_marshal_BOOLEAN__POINTER (GClosure *closure,
                                                    ...
                                                    gpointer invocation_hint,
                                                    gpointer marshal_data);
# 2 "gimpwidgetsmarshal.c" 2
# 56 "gimpwidgetsmarshal.c"
void
                                     ...
                                     gpointer marshal_data)
{
  ...
  do{ if (n_param_values == 3) { } else { g_return_if_fail_warning ("LibGimpWidgets", ((const char*) (__func__)), "n_param_values == 3"); return; }; }while (0);
                                        ...
                                        gpointer marshal_data)
{
  ...
  do{ if (return_value != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpWidgets", ((const char*) (__func__)), "return_value != NULL"); return; }; }while (0);
  do{ if (n_param_values == 2) { } else { g_return_if_fail_warning ("LibGimpWidgets", ((const char*) (__func__)), "n_param_values == 2"); return; }; }while (0);
