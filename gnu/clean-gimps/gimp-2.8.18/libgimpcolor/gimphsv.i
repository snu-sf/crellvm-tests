...
gimp_hsv_clamp (GimpHSV *hsv)
{
  ...
  hsv->s = (((hsv->s) > (1.0)) ? (1.0) : (((hsv->s) < (0.0)) ? (0.0) : (hsv->s)));
  hsv->v = (((hsv->v) > (1.0)) ? (1.0) : (((hsv->v) < (0.0)) ? (0.0) : (hsv->v)));
  hsv->a = (((hsv->a) > (1.0)) ? (1.0) : (((hsv->a) < (0.0)) ? (0.0) : (hsv->a)));
}
...
gimp_hsva_set (GimpHSV *hsva,
               ...
               gdouble a)
{
  do{ if (hsva != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "hsva != NULL"); return; }; }while (0);
