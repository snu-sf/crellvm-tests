...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpcolorspace.c" 2
# 19 "gimpcolorspace.c"
# 1 "../config.h" 1
# 20 "gimpcolorspace.c" 2
...
typedef void (* GimpProgressFunc) (gint min,
                                   ...
                                   gint current,
                                   gpointer data);
# 26 "gimpcolorspace.c" 2

# 1 "./gimpcolorspace.h" 1
# 36 "./gimpcolorspace.h"
                 ...
                 GimpHSV *hsv)
{
  ...
  do{ if (hsv != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "hsv != NULL"); return; }; }while (0);
                 ...
                 GimpHSL *hsl)
{
  ...
  do{ if (rgb != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "rgb != NULL"); return; }; }while (0);
  do{ if (hsl != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "hsl != NULL"); return; }; }while (0);
                  ...
                  GimpCMYK *cmyk)
{
  ...
  do{ if (rgb != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "rgb != NULL"); return; }; }while (0);
  do{ if (cmyk != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "cmyk != NULL"); return; }; }while (0);
  ...
  if (h == -1.0)
  ...
  else
    {
      ...
      switch (i)
        {
          case 6:
          case 0: { rgb->r = v; rgb->g = n; rgb->b = w; return; };
            break;
          case 1: { rgb->r = n; rgb->g = v; rgb->b = w; return; };
            break;
          case 2: { rgb->r = w; rgb->g = v; rgb->b = n; return; };
            break;
          case 3: { rgb->r = w; rgb->g = n; rgb->b = v; return; };
            break;
          case 4: { rgb->r = n; rgb->g = w; rgb->b = v; return; };
            break;
          case 5: { rgb->r = v; rgb->g = w; rgb->b = n; return; };
            break;
        }
    }

}
# 543 "gimpcolorspace.c"
void
  ...
  if (*saturation == 0)
  ...
  else
    {
      ...
      switch (i)
        ...
        case 0:
          *hue = ((int) ((v * 255.0) + 0.5));
          *saturation = ((int) ((t * 255.0) + 0.5));
          *value = ((int) ((p * 255.0) + 0.5));
          break;

        case 1:
          *hue = ((int) ((q * 255.0) + 0.5));
          *saturation = ((int) ((v * 255.0) + 0.5));
          *value = ((int) ((p * 255.0) + 0.5));
          break;
        ...
        case 2:
          *hue = ((int) ((p * 255.0) + 0.5));
          *saturation = ((int) ((v * 255.0) + 0.5));
          *value = ((int) ((t * 255.0) + 0.5));
          break;

        case 3:
          *hue = ((int) ((p * 255.0) + 0.5));
          *saturation = ((int) ((q * 255.0) + 0.5));
          *value = ((int) ((v * 255.0) + 0.5));
          break;

        case 4:
          *hue = ((int) ((t * 255.0) + 0.5));
          *saturation = ((int) ((p * 255.0) + 0.5));
          *value = ((int) ((v * 255.0) + 0.5));
          break;
        ...
        case 5:
          *hue = ((int) ((v * 255.0) + 0.5));
          *saturation = ((int) ((p * 255.0) + 0.5));
          *value = ((int) ((q * 255.0) + 0.5));
          break;
        }
    }
}
# 703 "gimpcolorspace.c"
void
                      ...
                      gint *pullout)
{
  ...
  if (*pullout == 0)
  ...
  else
    {
      ...
      k = (k * (((*pullout) > (100)) ? (100) : (((*pullout) < (0)) ? (0) : (*pullout)))) / 100;
                  ...
                  gdouble value)
{
  ...
  rgb[0] = ((int) ((hue * 255.0) + 0.5));
  rgb[1] = ((int) ((saturation * 255.0) + 0.5));
  rgb[2] = ((int) ((value * 255.0) + 0.5));
}
