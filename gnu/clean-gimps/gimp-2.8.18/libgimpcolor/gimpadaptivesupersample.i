# 1 "gimpadaptivesupersample.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 319 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpadaptivesupersample.c" 2
# 19 "gimpadaptivesupersample.c"
# 1 "../config.h" 1
# 20 "gimpadaptivesupersample.c" 2
...
# 22 "gimpadaptivesupersample.c" 2
...
# 24 "gimpadaptivesupersample.c" 2
...
typedef void (* GimpProgressFunc) (gint min,
                                   ...
                                   gint current,
                                   gpointer data);
# 26 "gimpadaptivesupersample.c" 2

# 1 "./gimpadaptivesupersample.h" 1
# 34 "./gimpadaptivesupersample.h"
...
# 28 "gimpadaptivesupersample.c" 2
# 1 "./gimprgb.h" 1
# 38 "./gimprgb.h"
...
gdouble gimp_rgba_distance (const GimpRGB *rgba1,
                                    const GimpRGB *rgba2);
# 29 "gimpadaptivesupersample.c" 2
# 51 "gimpadaptivesupersample.c"
                       ...
                       gpointer render_data)
{
  ...
  do{ if (render_func != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "render_func != NULL"); return (0); }; }while (0);
                                ...
                                gpointer progress_data)
{
  ...
  gint sub_pixel_size;
  GimpRGB color;
  GimpSampleType tmp_sample;
  GimpSampleType *top_row, *bot_row, *tmp_row;
  GimpSampleType **block;
  gulong num_samples;

  do{ if (render_func != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "render_func != NULL"); return (0); }; }while (0);
  do{ if (put_pixel_func != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "put_pixel_func != NULL"); return (0); }; }while (0);
  ...
  top_row = ((GimpSampleType *) g_malloc_n ((sub_pixel_size * width + 1), sizeof (GimpSampleType)));
  bot_row = ((GimpSampleType *) g_malloc_n ((sub_pixel_size * width + 1), sizeof (GimpSampleType)));
  ...
  block = ((GimpSampleType * *) g_malloc_n ((sub_pixel_size + 1), sizeof (GimpSampleType *)));

  for (y = 0; y < (sub_pixel_size + 1); y++)
    {
      block[y] = ((GimpSampleType *) g_malloc_n ((sub_pixel_size + 1), sizeof (GimpSampleType)));
