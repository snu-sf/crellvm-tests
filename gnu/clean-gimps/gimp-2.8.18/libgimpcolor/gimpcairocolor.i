...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpcairocolor.c" 2
# 23 "gimpcairocolor.c"
# 1 "../config.h" 1
# 24 "gimpcairocolor.c" 2
...
# 29 "gimpcairocolor.c" 2



# 1 "./gimpcairocolor.h" 1
# 27 "./gimpcairocolor.h"
                                ...
                                const GimpRGB *dark)
{
  ...
  do{ if (cr != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "cr != NULL"); return (((void*)0)); }; }while (0);
  do{ if (size > 0) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "size > 0"); return (((void*)0)); }; }while (0);
