                     ...
                     guchar *black)
{
  ...
  if (cyan) *cyan = ((int) (((((cmyk->c) > (1.0)) ? (1.0) : (((cmyk->c) < (0.0)) ? (0.0) : (cmyk->c))) * 255.0) + 0.5));
  if (magenta) *magenta = ((int) (((((cmyk->m) > (1.0)) ? (1.0) : (((cmyk->m) < (0.0)) ? (0.0) : (cmyk->m))) * 255.0) + 0.5));
  if (yellow) *yellow = ((int) (((((cmyk->y) > (1.0)) ? (1.0) : (((cmyk->y) < (0.0)) ? (0.0) : (cmyk->y))) * 255.0) + 0.5));
  if (black) *black = ((int) (((((cmyk->k) > (1.0)) ? (1.0) : (((cmyk->k) < (0.0)) ? (0.0) : (cmyk->k))) * 255.0) + 0.5));
}
# 161 "gimpcmyk.c"
void
gimp_cmyka_set (GimpCMYK *cmyka,
                ...
                gdouble alpha)
{
  do{ if (cmyka != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "cmyka != NULL"); return; }; }while (0);
                      ...
                      guchar *alpha)
{
  ...
  if (cyan) *cyan = ((int) (((((cmyka->c) > (1.0)) ? (1.0) : (((cmyka->c) < (0.0)) ? (0.0) : (cmyka->c))) * 255.0) + 0.5));
  if (magenta) *magenta = ((int) (((((cmyka->m) > (1.0)) ? (1.0) : (((cmyka->m) < (0.0)) ? (0.0) : (cmyka->m))) * 255.0) + 0.5));
  if (yellow) *yellow = ((int) (((((cmyka->y) > (1.0)) ? (1.0) : (((cmyka->y) < (0.0)) ? (0.0) : (cmyka->y))) * 255.0) + 0.5));
  if (black) *black = ((int) (((((cmyka->k) > (1.0)) ? (1.0) : (((cmyka->k) < (0.0)) ? (0.0) : (cmyka->k))) * 255.0) + 0.5));
  if (alpha) *alpha = ((int) (((((cmyka->a) > (1.0)) ? (1.0) : (((cmyka->a) < (0.0)) ? (0.0) : (cmyka->a))) * 255.0) + 0.5));
}
