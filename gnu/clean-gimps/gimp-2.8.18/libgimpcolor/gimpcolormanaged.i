# 1 "gimpcolormanaged.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 319 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpcolormanaged.c" 2
# 22 "gimpcolormanaged.c"
# 1 "../config.h" 1
# 23 "gimpcolormanaged.c" 2
...
typedef void (* GimpProgressFunc) (gint min,
                                   ...
                                   gint current,
                                   gpointer data);
# 27 "gimpcolormanaged.c" 2

# 1 "./gimpcolormanaged.h" 1
# 40 "./gimpcolormanaged.h"
...
# 29 "gimpcolormanaged.c" 2
# 40 "gimpcolormanaged.c"
enum
{
  PROFILE_CHANGED,
  LAST_SIGNAL
  ...
  if (! iface_type)
    {
      ...
      iface_type = g_type_register_static (((GType) ((2) << (2))),
                                           "GimpColorManagedInterface",
                                           &iface_info, 0);

      g_type_interface_add_prerequisite (iface_type, ((GType) ((20) << (2))));
    }
  ...
  if (! initialized)
    {
      gimp_color_managed_signals[PROFILE_CHANGED] =
        g_signal_new ("profile-changed",
                      (((GTypeInterface*) (iface))->g_type),
                      G_SIGNAL_RUN_FIRST,
                      ((glong) __builtin_offsetof(GimpColorManagedInterface, profile_changed)),

                      ((void*)0), ((void*)0),
                      g_cclosure_marshal_VOID__VOID,
                      ((GType) ((1) << (2))), 0);

      iface->get_icc_profile = ((void*)0);
      iface->profile_changed = ((void*)0);

      initialized = (!(0));
    }
}
# 111 "gimpcolormanaged.c"
const guint8 *
                                    ...
                                    gsize *len)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((managed)); GType __t = ((gimp_color_managed_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "GIMP_IS_COLOR_MANAGED (managed)"); return (((void*)0)); }; }while (0);
  do{ if (len != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "len != NULL"); return (((void*)0)); }; }while (0);

  *len = 0;

  iface = ((((GimpColorManagedInterface*) g_type_interface_peek (((GTypeInstance*) ((managed)))->g_class, ((gimp_color_managed_interface_get_type ()))))));
...
# 138 "gimpcolormanaged.c"
void
gimp_color_managed_profile_changed (GimpColorManaged *managed)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((managed)); GType __t = ((gimp_color_managed_interface_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpColor", ((const char*) (__func__)), "GIMP_IS_COLOR_MANAGED (managed)"); return; }; }while (0);
