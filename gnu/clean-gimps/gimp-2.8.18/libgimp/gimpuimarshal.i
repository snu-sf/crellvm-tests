                                      ...
                                      gpointer marshal_data)
{
  ...
  do{ if (n_param_values == 3) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "n_param_values == 3"); return; }; }while (0);
                                                  ...
                                                  gpointer marshal_data)
{
  ...
  do{ if (n_param_values == 5) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "n_param_values == 5"); return; }; }while (0);
                                                          ...
                                                          gpointer marshal_data)
{
  ...
  do{ if (n_param_values == 7) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "n_param_values == 7"); return; }; }while (0);
  ...
  callback (data1,
            ...
            (param_values + 4)->data[0].v_int,
            (param_values + 5)->data[0].v_pointer,
            (param_values + 6)->data[0].v_int,
            data2);
}
                                                                     ...
                                                                     gpointer marshal_data)
{
  ...
  do{ if (n_param_values == 9) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "n_param_values == 9"); return; }; }while (0);
  ...
  callback (data1,
            ...
            (param_values + 6)->data[0].v_int,
            (param_values + 7)->data[0].v_pointer,
            (param_values + 8)->data[0].v_int,
            data2);
}
