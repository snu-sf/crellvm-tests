...
# 27 "gimpunitcache.c" 2

# 1 "./gimpunitcache.h" 1
# 28 "./gimpunitcache.h"
__attribute__((visibility("hidden"))) gint _gimp_unit_cache_get_number_of_units (void);
__attribute__((visibility("hidden"))) gint _gimp_unit_cache_get_number_of_built_in_units (void) __attribute__((__const__));

__attribute__((visibility("hidden"))) GimpUnit _gimp_unit_cache_new (gchar *identifier,
                                                                  gdouble factor,
                                                                  gint digits,
                                                                  gchar *symbol,
                                                                  gchar *abbreviation,
                                                                  gchar *singular,
                                                                  gchar *plural);
__attribute__((visibility("hidden"))) gboolean _gimp_unit_cache_get_deletion_flag (GimpUnit unit);
__attribute__((visibility("hidden"))) void _gimp_unit_cache_set_deletion_flag (GimpUnit unit,
                                                                  gboolean deletion_flag);
__attribute__((visibility("hidden"))) gdouble _gimp_unit_cache_get_factor (GimpUnit unit);
__attribute__((visibility("hidden"))) gint _gimp_unit_cache_get_digits (GimpUnit unit);
__attribute__((visibility("hidden"))) const gchar * _gimp_unit_cache_get_identifier (GimpUnit unit);
__attribute__((visibility("hidden"))) const gchar * _gimp_unit_cache_get_symbol (GimpUnit unit);
__attribute__((visibility("hidden"))) const gchar * _gimp_unit_cache_get_abbreviation (GimpUnit unit);
__attribute__((visibility("hidden"))) const gchar * _gimp_unit_cache_get_singular (GimpUnit unit);
__attribute__((visibility("hidden"))) const gchar * _gimp_unit_cache_get_plural (GimpUnit unit);
# 29 "gimpunitcache.c" 2
# 1 "./gimpunit_pdb.h" 1
# 35 "./gimpunit_pdb.h"
__attribute__((visibility("hidden"))) gint _gimp_unit_get_number_of_units (void);
__attribute__((visibility("hidden"))) gint _gimp_unit_get_number_of_built_in_units (void);
__attribute__((visibility("hidden"))) GimpUnit _gimp_unit_new (const gchar *identifier,
                                                                  gdouble factor,
                                                                  gint digits,
                                                                  const gchar *symbol,
                                                                  ...
                                                                  const gchar *plural);
__attribute__((visibility("hidden"))) gboolean _gimp_unit_get_deletion_flag (GimpUnit unit_id);
__attribute__((visibility("hidden"))) gboolean _gimp_unit_set_deletion_flag (GimpUnit unit_id,
                                                                  gboolean deletion_flag);
__attribute__((visibility("hidden"))) gchar* _gimp_unit_get_identifier (GimpUnit unit_id);
__attribute__((visibility("hidden"))) gdouble _gimp_unit_get_factor (GimpUnit unit_id);
__attribute__((visibility("hidden"))) gint _gimp_unit_get_digits (GimpUnit unit_id);
__attribute__((visibility("hidden"))) gchar* _gimp_unit_get_symbol (GimpUnit unit_id);
__attribute__((visibility("hidden"))) gchar* _gimp_unit_get_abbreviation (GimpUnit unit_id);
__attribute__((visibility("hidden"))) gchar* _gimp_unit_get_singular (GimpUnit unit_id);
__attribute__((visibility("hidden"))) gchar* _gimp_unit_get_plural (GimpUnit unit_id);
# 30 "gimpunitcache.c" 2
...
static GimpUnitDef * gimp_unit_defs = ((void*)0);
...
gimp_unit_init (GimpUnit unit)
{
  ...
  gimp_unit_defs = ((GimpUnitDef *) g_realloc_n (gimp_unit_defs, (n), sizeof (GimpUnitDef)));
...
{
  do{ if (unit >= GIMP_UNIT_INCH) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "unit >= GIMP_UNIT_INCH"); return (1.0); }; }while (0);
...
{
  do{ if (unit >= GIMP_UNIT_INCH) { } else { g_return_if_fail_warning ("LibGimp", ((const char*) (__func__)), "unit >= GIMP_UNIT_INCH"); return (0); }; }while (0);
...
{
  if (unit == GIMP_UNIT_PERCENT)
    return dgettext ("gimp20" "-libgimp", gimp_unit_percent.singular);

  if (!gimp_unit_init (unit))
    return ((void*)0);

  return dgettext ("gimp20" "-libgimp", gimp_unit_defs[unit].singular);
}
...
{
  if (unit == GIMP_UNIT_PERCENT)
    return dgettext ("gimp20" "-libgimp", gimp_unit_percent.plural);

  if (!gimp_unit_init (unit))
    return ((void*)0);

  return dgettext ("gimp20" "-libgimp", gimp_unit_defs[unit].plural);
}
