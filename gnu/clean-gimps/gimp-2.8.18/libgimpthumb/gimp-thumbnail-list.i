# 1 "gimp-thumbnail-list.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 317 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimp-thumbnail-list.c" 2
...
extern char *stpncpy (char *__restrict __dest,
        const char *__restrict __src, size_t __n)
     __attribute__ ((__nothrow__ )) __attribute__ ((__nonnull__ (1, 2)));
# 6 "gimp-thumbnail-list.c" 2
# 1 "/usr/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf.h" 1
# 29 "/usr/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf.h"
...
# 30 "/usr/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf.h" 2
...
# 7 "gimp-thumbnail-list.c" 2
# 1 "../libgimpthumb/gimpthumb.h" 1
# 30 "../libgimpthumb/gimpthumb.h"
...
# 31 "../libgimpthumb/gimpthumb.h" 2

# 1 "../libgimpthumb/gimpthumb-error.h" 1
# 44 "../libgimpthumb/gimpthumb-error.h"
typedef enum
{
...
# 59 "../libgimpthumb/gimpthumb-error.h"
GQuark gimp_thumb_error_quark (void) __attribute__((__const__));
# 33 "../libgimpthumb/gimpthumb.h" 2
# 1 "../libgimpthumb/gimpthumb-utils.h" 1
# 35 "../libgimpthumb/gimpthumb-utils.h"
...
# 34 "../libgimpthumb/gimpthumb.h" 2
# 1 "../libgimpthumb/gimpthumbnail.h" 1
# 43 "../libgimpthumb/gimpthumbnail.h"
...
# 35 "../libgimpthumb/gimpthumb.h" 2
# 8 "gimp-thumbnail-list.c" 2
...
static GimpThumbState option_state = -1;
static gboolean option_verbose = (0);
static gchar *option_path = ((void*)0);
...
static const GOptionEntry main_entries[] =
{
  ...
  },
  {
    ...
    "Print additional info per matched file", ((void*)0)
  },
  { ((void*)0) }
};
      ...
      gchar *argv[])
{
  ...
  context = g_option_context_new (((void*)0));
  g_option_context_add_main_entries (context, main_entries, ((void*)0));
  ...
  thumb_folder = g_build_filename (home, ".thumbnails", ((void*)0));
  ...
  while ((folder = g_dir_read_name (dir)))
    {
      ...
      filename = g_build_filename (thumb_folder, folder, ((void*)0));
  ...
  while ((name = g_dir_read_name (dir)))
    {
      ...
      filename = g_build_filename (folder, name, ((void*)0));
...
process_thumbnail (const gchar *filename)
{
  ...
  if (! gimp_thumbnail_set_from_thumb (thumbnail, filename, &error))
  ...
  else
    {
      ...
      if ((option_state == -1 || state == option_state)
