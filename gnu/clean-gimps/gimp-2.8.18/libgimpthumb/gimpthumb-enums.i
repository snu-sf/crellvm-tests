...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpthumb-enums.c" 2



# 1 "../config.h" 1
# 5 "gimpthumb-enums.c" 2
...
# 6 "gimpthumb-enums.c" 2
# 1 "./gimpthumb-enums.h" 1
# 51 "./gimpthumb-enums.h"
