...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "gimpthumb-utils.c" 2
# 25 "gimpthumb-utils.c"
# 1 "../config.h" 1
# 26 "gimpthumb-utils.c" 2
...
# 47 "gimpthumb-utils.c" 2
# 58 "gimpthumb-utils.c"
...
static gboolean gimp_thumb_initialized = (0);
static gint thumb_num_sizes = 0;
static gint *thumb_sizes = ((void*)0);
static const gchar **thumb_sizenames = ((void*)0);
static gchar *thumb_dir = ((void*)0);
static gchar **thumb_subdirs = ((void*)0);
static gchar *thumb_fail_subdir = ((void*)0);
# 100 "gimpthumb-utils.c"
gboolean
                 ...
                 const gchar *thumb_basedir)
{
  ...
  do{ if (creator != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "creator != NULL"); return ((0)); }; }while (0);
  do{ if (thumb_basedir == ((void*)0) || g_path_is_absolute (thumb_basedir)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "thumb_basedir == NULL || g_path_is_absolute (thumb_basedir)"); return ((0)); }; }while (0);
  ...
  if (thumb_basedir)
    ...
    {
# 140 "gimpthumb-utils.c"
      const gchar *home_dir = g_get_home_dir ();

      if (home_dir && g_file_test (home_dir, G_FILE_TEST_IS_DIR))
        {
          thumb_dir = g_build_filename (home_dir, ".thumbnails", ((void*)0));
        }
      ...
      if (! thumb_dir)
        {
          ...
          g_message (dgettext ("gimp20" "-libgimp", "Cannot determine a valid home directory.\n" "Thumbnails will be stored in the folder for " "temporary files (%s) instead."), name);


          g_free (name);

          thumb_dir = g_build_filename (g_get_tmp_dir (), ".thumbnails", ((void*)0));
        }
    }

  enum_class = g_type_class_ref ((gimp_thumb_size_get_type ()));

  thumb_num_sizes = enum_class->n_values;
  thumb_sizes = ((gint *) g_malloc_n ((thumb_num_sizes), sizeof (gint)));
  thumb_sizenames = ((const gchar * *) g_malloc_n ((thumb_num_sizes), sizeof (const gchar *)));
  thumb_subdirs = ((gchar * *) g_malloc_n ((thumb_num_sizes), sizeof (gchar *)));
  ...
  for (i = 0, enum_value = enum_class->values;
       ...
       i++, enum_value++)
    {
      ...
      thumb_subdirs[i] = g_build_filename (thumb_dir,
                                             enum_value->value_nick, ((void*)0));
    }

  thumb_fail_subdir = thumb_subdirs[0];
  thumb_subdirs[0] = g_build_filename (thumb_fail_subdir, creator, ((void*)0));

  g_type_class_unref (enum_class);

  gimp_thumb_initialized = (!(0));

  return gimp_thumb_initialized;
}
# 199 "gimpthumb-utils.c"
const gchar *
gimp_thumb_get_thumb_dir (GimpThumbSize size)
{
  do{ if (gimp_thumb_initialized) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "gimp_thumb_initialized"); return (((void*)0)); }; }while (0);

  size = gimp_thumb_size (size);

  return thumb_subdirs[size];
}
# 222 "gimpthumb-utils.c"
gchar *
gimp_thumb_get_thumb_dir_local (const gchar *dirname,
                                GimpThumbSize size)
{
  do{ if (gimp_thumb_initialized) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "gimp_thumb_initialized"); return (((void*)0)); }; }while (0);
  do{ if (dirname != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "dirname != NULL"); return (((void*)0)); }; }while (0);
  do{ if (size > GIMP_THUMB_SIZE_FAIL) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "size > GIMP_THUMB_SIZE_FAIL"); return (((void*)0)); }; }while (0);

  size = gimp_thumb_size (size);

  return g_build_filename (dirname, thumb_sizenames[size], ((void*)0));
}
# 251 "gimpthumb-utils.c"
gboolean
gimp_thumb_ensure_thumb_dir (GimpThumbSize size,
                             GError **error)
{
  do{ if (gimp_thumb_initialized) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "gimp_thumb_initialized"); return ((0)); }; }while (0);
  ...
  if (g_file_test (thumb_dir, G_FILE_TEST_IS_DIR) ||
      (g_mkdir_with_parents (thumb_dir, 0400 | 0200 | 0100) == 0))
    {
      if (size == 0)
        g_mkdir_with_parents (thumb_fail_subdir, 0400 | 0200 | 0100);

      g_mkdir_with_parents (thumb_subdirs[size], 0400 | 0200 | 0100);
    }
  ...
  g_set_error (error,
               (gimp_thumb_error_quark ()), GIMP_THUMB_ERROR_MKDIR,
               dgettext ("gimp20" "-libgimp", "Failed to create thumbnail folder '%s'."),
               thumb_subdirs[size]);

  return (0);
}
# 301 "gimpthumb-utils.c"
gboolean
                                   ...
                                   GError **error)
{
  ...
  do{ if (gimp_thumb_initialized) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "gimp_thumb_initialized"); return ((0)); }; }while (0);
  do{ if (dirname != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "dirname != NULL"); return ((0)); }; }while (0);
  do{ if (g_path_is_absolute (dirname)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "g_path_is_absolute (dirname)"); return ((0)); }; }while (0);
  do{ if (size > GIMP_THUMB_SIZE_FAIL) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "size > GIMP_THUMB_SIZE_FAIL"); return ((0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "error == NULL || *error == NULL"); return ((0)); }; }while (0);
  ...
  basedir = g_build_filename (dirname, ".thumblocal", ((void*)0));

  if (g_file_test (basedir, G_FILE_TEST_IS_DIR) ||
      (mkdir (thumb_dir, 0400 | 0200 | 0100) == 0))
    {
      mkdir (subdir, 0400 | 0200 | 0100);
    }
...
# 364 "gimpthumb-utils.c"
gchar *
gimp_thumb_name_from_uri (const gchar *uri,
                          GimpThumbSize size)
{
  do{ if (gimp_thumb_initialized) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "gimp_thumb_initialized"); return (((void*)0)); }; }while (0);
  do{ if (uri != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "uri != NULL"); return (((void*)0)); }; }while (0);
                       ...
                       GimpThumbSize *size)
{
  ...
  do{ if (gimp_thumb_initialized) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "gimp_thumb_initialized"); return (((void*)0)); }; }while (0);
  do{ if (uri != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "uri != NULL"); return (((void*)0)); }; }while (0);
  do{ if (size != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "size != NULL"); return (((void*)0)); }; }while (0);
  do{ if (*size > GIMP_THUMB_SIZE_FAIL) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "*size > GIMP_THUMB_SIZE_FAIL"); return (((void*)0)); }; }while (0);

  result = gimp_thumb_png_lookup (gimp_thumb_png_name (uri), ((void*)0), size);
...
# 581 "gimpthumb-utils.c"
void
gimp_thumbs_delete_for_uri (const gchar *uri)
{
  gint i;

  do{ if (gimp_thumb_initialized) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "gimp_thumb_initialized"); return; }; }while (0);
  do{ if (uri != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "uri != NULL"); return; }; }while (0);
...
_gimp_thumb_filename_from_uri (const gchar *uri)
{
  ...
  filename = g_filename_from_uri (uri, &hostname, ((void*)0));
...
gimp_thumb_exit (void)
{
  ...
  thumb_num_sizes = 0;
  thumb_sizes = ((void*)0);
  thumb_sizenames = ((void*)0);
  thumb_dir = ((void*)0);
  thumb_subdirs = ((void*)0);
  thumb_fail_subdir = ((void*)0);
  gimp_thumb_initialized = (0);
}
...
gimp_thumb_png_lookup (const gchar *name,
                       ...
                       GimpThumbSize *size)
{
  gchar *thumb_name = ((void*)0);
  gchar **subdirs = ((void*)0);
  gint i, n;

  if (basedir)
    {
      gchar *dir = g_build_filename (basedir, ".thumblocal", ((void*)0));

      if (g_file_test (basedir, G_FILE_TEST_IS_DIR))
        {
          gint i;

          subdirs = ((gchar * *) g_malloc_n ((thumb_num_sizes), sizeof (gchar *)));

          subdirs[0] = ((void*)0);

          for (i = 1; i < thumb_num_sizes; i++)
            subdirs[i] = g_build_filename (dir, thumb_sizenames[i], ((void*)0));
        }
  ...
  for (; i < thumb_num_sizes; i++)
    {
      ...
      thumb_name = g_build_filename (subdirs[i], name, ((void*)0));

      if (gimp_thumb_file_test (thumb_name,
                                ((void*)0), ((void*)0),
                                ((void*)0)) == GIMP_THUMB_FILE_TYPE_REGULAR)
        {
          *size = thumb_sizes[i];
          goto finish;
        }
