         ...
         ...)
{
  ...
  g_logv ("LibGimpThumb", G_LOG_LEVEL_ERROR, format, args);
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("LibGimpThumb", G_LOG_LEVEL_MESSAGE, format, args);
  __builtin_va_end(args);
}
static void
            ...
            ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("LibGimpThumb", G_LOG_LEVEL_CRITICAL, format, args);
  __builtin_va_end(args);
}
static void
           ...
           ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("LibGimpThumb", G_LOG_LEVEL_WARNING, format, args);
  __builtin_va_end(args);
}
static void
        ...
        ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("LibGimpThumb", G_LOG_LEVEL_INFO, format, args);
  __builtin_va_end(args);
}
static void
         ...
         ...)
{
  va_list args;
  __builtin_va_start(args, format);
  g_logv ("LibGimpThumb", G_LOG_LEVEL_DEBUG, format, args);
  __builtin_va_end(args);
}
...
# 32 "/usr/include/gdk-pixbuf-2.0/gdk-pixbuf/gdk-pixbuf.h" 2
...
# 37 "gimpthumbnail.c" 2

# 1 "../libgimpbase/gimpparam.h" 1
# 39 "gimpthumbnail.c" 2
...
# 1 "./gimpthumb-types.h" 1
# 29 "./gimpthumb-types.h"
...
# 30 "./gimpthumb-types.h" 2



typedef struct _GimpThumbnail GimpThumbnail;
# 47 "gimpthumbnail.c" 2
# 1 "./gimpthumb-error.h" 1
# 44 "./gimpthumb-error.h"
typedef enum
{
...
# 59 "./gimpthumb-error.h"
GQuark gimp_thumb_error_quark (void) __attribute__((__const__));
# 48 "gimpthumbnail.c" 2
# 1 "./gimpthumb-utils.h" 1
# 35 "./gimpthumb-utils.h"
gboolean gimp_thumb_init (const gchar *creator,
                                                       const gchar *thumb_basedir);

gchar * gimp_thumb_find_thumb (const gchar *uri,
                                                       GimpThumbSize *size) __attribute__((__malloc__));
...
__attribute__((visibility("hidden"))) void _gimp_thumbs_delete_others (const gchar *uri,
                                                       GimpThumbSize size);
__attribute__((visibility("hidden"))) gchar * _gimp_thumb_filename_from_uri (const gchar *uri);
# 49 "gimpthumbnail.c" 2
# 1 "./gimpthumbnail.h" 1
# 43 "./gimpthumbnail.h"
...
GType gimp_thumbnail_get_type (void) __attribute__((__const__));
...
# 50 "gimpthumbnail.c" 2

# 1 "../libgimp/libgimp-intl.h" 1
# 28 "../libgimp/libgimp-intl.h"
...
# 29 "../libgimp/libgimp-intl.h" 2
# 52 "gimpthumbnail.c" 2
# 87 "gimpthumbnail.c"
enum
{
  PROP_0,
...
static void gimp_thumbnail_init (GimpThumbnail *self); static void gimp_thumbnail_class_init (GimpThumbnailClass *klass); static gpointer gimp_thumbnail_parent_class = ((void*)0); static gint GimpThumbnail_private_offset; static void gimp_thumbnail_class_intern_init (gpointer klass) { gimp_thumbnail_parent_class = g_type_class_peek_parent (klass); if (GimpThumbnail_private_offset != 0) g_type_class_adjust_private_offset (klass, &GimpThumbnail_private_offset); gimp_thumbnail_class_init ((GimpThumbnailClass*) klass); } __attribute__((__unused__)) static inline gpointer gimp_thumbnail_get_instance_private (GimpThumbnail *self) { return (((gpointer) ((guint8*) (self) + (glong) (GimpThumbnail_private_offset)))); } GType gimp_thumbnail_get_type (void) { static volatile gsize g_define_type_id__volatile = 0; if ((__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_0[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? (gpointer) *(&g_define_type_id__volatile) : 0); (!(__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_1[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); __sync_synchronize (); (gpointer) *(&g_define_type_id__volatile); })) && g_once_init_enter (&g_define_type_id__volatile)); }))) { GType g_define_type_id = g_type_register_static_simple (((GType) ((20) << (2))), g_intern_static_string ("GimpThumbnail"), sizeof (GimpThumbnailClass), (GClassInitFunc) gimp_thumbnail_class_intern_init, sizeof (GimpThumbnail), (GInstanceInitFunc) gimp_thumbnail_init, (GTypeFlags) 0); { {{};} } (__extension__ ({ typedef char _GStaticAssertCompileTimeAssertion_2[(sizeof *(&g_define_type_id__volatile) == sizeof (gpointer)) ? 1 : -1] __attribute__((__unused__)); (void) (0 ? *(&g_define_type_id__volatile) = (g_define_type_id) : 0); g_once_init_leave ((&g_define_type_id__volatile), (gsize) (g_define_type_id)); })); } return g_define_type_id__volatile; }
...
gimp_thumbnail_class_init (GimpThumbnailClass *klass)
{
  ...
  g_object_class_install_property (object_class,
                                   PROP_IMAGE_STATE,
                                   g_param_spec_enum ("image-state", ((void*)0),
  ...
  g_object_class_install_property (object_class,
                                   PROP_IMAGE_URI,
                                   g_param_spec_string ("image-uri", ((void*)0),
                                                       "URI of the image file",
                                                        ((void*)0),
                                                        (G_PARAM_READWRITE | (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB))));
  g_object_class_install_property (object_class,
                                   PROP_IMAGE_MTIME,
                                   g_param_spec_int64 ("image-mtime", ((void*)0),
                                                       "Modification time of the image file in seconds since the Epoch",
                                                       ((gint64) (0x8000000000000000L)), (0x7fffffffffffffffL), 0,
                                                       (G_PARAM_READWRITE | (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB))));
  g_object_class_install_property (object_class,
                                   PROP_IMAGE_FILESIZE,
                                   g_param_spec_int64 ("image-filesize", ((void*)0),
                                                       "Size of the image file in bytes",
                                                       0, (0x7fffffffffffffffL), 0,
                                                       (G_PARAM_READWRITE | (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB))));
  ...
  g_object_class_install_property (object_class,
                                   PROP_IMAGE_MIMETYPE,
                                   g_param_spec_string ("image-mimetype", ((void*)0),
                                                        "Image mimetype",
                                                        ((void*)0),
                                                        (G_PARAM_READWRITE | (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB))));
  g_object_class_install_property (object_class,
                                   PROP_IMAGE_WIDTH,
                                   g_param_spec_int ("image-width", ((void*)0),
                                                     "Width of the image in pixels",
                                                     0, 2147483647, 0,
                                                     (G_PARAM_READWRITE | (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB))));
  g_object_class_install_property (object_class,
                                   PROP_IMAGE_HEIGHT,
                                   g_param_spec_int ("image-height", ((void*)0),
                                                     "Height of the image in pixels",
                                                     0, 2147483647, 0,
                                                     (G_PARAM_READWRITE | (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB))));
  g_object_class_install_property (object_class,
                                   PROP_IMAGE_TYPE,
                                   g_param_spec_string ("image-type", ((void*)0),
                                                        "String describing the type of the image format",
                                                        ((void*)0),
                                                        (G_PARAM_READWRITE | (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB))));
  g_object_class_install_property (object_class,
                                   PROP_IMAGE_NUM_LAYERS,
                                   g_param_spec_int ("image-num-layers", ((void*)0),
                                                     "The number of layers in the image",
                                                     0, 2147483647, 0,
                                                     (G_PARAM_READWRITE | (G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB))));
  g_object_class_install_property (object_class,
                                   PROP_THUMB_STATE,
                                   g_param_spec_enum ("thumb-state", ((void*)0),
...
{
  GimpThumbnail *thumbnail = ((((GimpThumbnail*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_thumbnail_get_type ()))))));
  ...
  ((((GObjectClass*) g_type_check_class_cast ((GTypeClass*) ((gimp_thumbnail_parent_class)), (((GType) ((20) << (2))))))))->finalize (object);
}
                             ...
                             GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    case PROP_IMAGE_STATE:
      ...
      break;
    case PROP_IMAGE_URI:
      gimp_thumbnail_set_uri (((((GimpThumbnail*) g_type_check_instance_cast ((GTypeInstance*) ((object)), ((gimp_thumbnail_get_type ())))))),
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpthumbnail.c", 321, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
                             ...
                             GParamSpec *pspec)
{
  ...
  switch (property_id)
    ...
    default:
      do { GObject *_glib__object = (GObject*) ((object)); GParamSpec *_glib__pspec = (GParamSpec*) ((pspec)); guint _glib__property_id = ((property_id)); g_warning ("%s:%u: invalid %s id %u for \"%s\" of type '%s' in '%s'", "gimpthumbnail.c", 368, ("property"), _glib__property_id, _glib__pspec->name, g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__pspec))->g_class))->g_type)))), (g_type_name ((((((GTypeClass*) (((GTypeInstance*) (_glib__object))->g_class))->g_type)))))); } while (0);
      break;
    }
}
# 380 "gimpthumbnail.c"
...
{
  return g_object_new ((gimp_thumbnail_get_type ()), ((void*)0));
}
# 395 "gimpthumbnail.c"
void
gimp_thumbnail_set_uri (GimpThumbnail *thumbnail,
                        const gchar *uri)
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((thumbnail)); GType __t = ((gimp_thumbnail_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "GIMP_IS_THUMBNAIL (thumbnail)"); return; }; }while (0);
                             ...
                             GError **error)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((thumbnail)); GType __t = ((gimp_thumbnail_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "GIMP_IS_THUMBNAIL (thumbnail)"); return ((0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "error == NULL || *error == NULL"); return ((0)); }; }while (0);

  ((void)(0));

  if (filename)
    uri = g_filename_to_uri (filename, ((void*)0), error);
                               ...
                               GError **error)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((thumbnail)); GType __t = ((gimp_thumbnail_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "GIMP_IS_THUMBNAIL (thumbnail)"); return ((0)); }; }while (0);
  do{ if (filename != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "filename != NULL"); return ((0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "error == NULL || *error == NULL"); return ((0)); }; }while (0);
  ...
  uri = gdk_pixbuf_get_option (pixbuf, "tEXt::Thumb::URI");
  if (! uri)
    {
      g_set_error (error, (gimp_thumb_error_quark ()), 0,
                   dgettext ("gimp20" "-libgimp", "Thumbnail contains no Thumb::URI tag"));
...
{
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((thumbnail)); GType __t = ((gimp_thumbnail_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "GIMP_IS_THUMBNAIL (thumbnail)"); return (GIMP_THUMB_STATE_UNKNOWN); }; }while (0);


  ((void)(0));

  g_object_freeze_notify (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((thumbnail)), (((GType) ((20) << (2)))))))));

  gimp_thumbnail_update_image (thumbnail);

  g_object_thaw_notify (((((GObject*) g_type_check_instance_cast ((GTypeInstance*) ((thumbnail)), (((GType) ((20) << (2)))))))));
                            ...
                            GimpThumbSize size)
{
  ...
  pixbuf = gimp_thumbnail_load_thumb (thumbnail, size, ((void*)0));
...
gimp_thumbnail_update_image (GimpThumbnail *thumbnail)
{
  ...
  switch (state)
    ...
    case GIMP_THUMB_STATE_UNKNOWN:
      do{ if (thumbnail->image_filename == ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "thumbnail->image_filename == NULL"); return; }; }while (0);
                             ...
                             GimpThumbSize size)
{
  ...
  switch (state)
    ...
    case GIMP_THUMB_STATE_OK:
      do{ if (thumbnail->thumb_filename != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "thumbnail->thumb_filename != NULL"); return; }; }while (0);
  ...
  if (state != thumbnail->thumb_state)
    {
      ...
      g_object_set (thumbnail, "thumb-state", state, ((void*)0));
                                     ...
                                     GdkPixbuf *pixbuf)
{
  ...
  thumbnail->image_mimetype =
    g_strdup (gdk_pixbuf_get_option (pixbuf, "tEXt::Thumb::Mimetype"));
  ...
  thumbnail->image_type =
    g_strdup (gdk_pixbuf_get_option (pixbuf, "tEXt::Thumb::X-GIMP::Type"));

  option = gdk_pixbuf_get_option (pixbuf, "tEXt::Thumb::X-GIMP::Layers");
  if (option && sscanf (option, "%d", &num) == 1)
                     ...
                     GError **error)
{
  ...
  keys[i] = "tEXt::Description";
  values[i] = g_strdup_printf ("Thumbnail of %s", thumbnail->image_uri);
  i++;

  keys[i] = "tEXt::Software";
  values[i] = g_strdup (software);
  i++;

  keys[i] = "tEXt::Thumb::URI";
  values[i] = g_strdup (thumbnail->image_uri);
  i++;

  keys[i] = "tEXt::Thumb::MTime";
  values[i] = g_strdup_printf ("%" "li", thumbnail->image_mtime);
  i++;

  keys[i] = "tEXt::Thumb::Size";
  values[i] = g_strdup_printf ("%" "li", thumbnail->image_filesize);
  i++;

  if (thumbnail->image_mimetype)
    {
      keys[i] = "tEXt::Thumb::Mimetype";
  ...
  if (thumbnail->image_height > 0)
    {
      keys[i] = "tEXt::Thumb::Image::Height";
  ...
  if (thumbnail->image_num_layers > 0)
    {
      keys[i] = "tEXt::Thumb::X-GIMP::Layers";
  ...
  if (success)
    {
      ...
      success = (rename (tmpname, filename) == 0);

      if (! success)
        g_set_error (error, g_file_error_quark (), g_file_error_from_errno ((*__errno_location ())),
                     dgettext ("gimp20" "-libgimp", "Could not create thumbnail for %s: %s"),
                     thumbnail->image_uri, g_strerror ((*__errno_location ())));
    }
                           ...
                           GError **error)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((thumbnail)); GType __t = ((gimp_thumbnail_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "GIMP_IS_THUMBNAIL (thumbnail)"); return (((void*)0)); }; }while (0);
  ...
  pixbuf = gdk_pixbuf_new_from_file (thumbnail->thumb_filename, ((void*)0));
  if (! pixbuf)
    return ((void*)0);
  ...
  if (!option || sscanf (option, "%" "li", &image_mtime) != 1)
    goto finish;

  option = gdk_pixbuf_get_option (pixbuf, "tEXt::Thumb::Size");
  if (option && sscanf (option, "%" "li", &image_size) != 1)
    goto finish;


  if (image_mtime == thumbnail->image_mtime &&
      (option == ((void*)0) || image_size == thumbnail->image_filesize))
    {
                           ...
                           GError **error)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((thumbnail)); GType __t = ((gimp_thumbnail_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "GIMP_IS_THUMBNAIL (thumbnail)"); return ((0)); }; }while (0);
  do{ if (thumbnail->image_uri != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "thumbnail->image_uri != NULL"); return ((0)); }; }while (0);
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((pixbuf)); GType __t = ((gdk_pixbuf_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "GDK_IS_PIXBUF (pixbuf)"); return ((0)); }; }while (0);
  do{ if (software != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "software != NULL"); return ((0)); }; }while (0);
  do{ if (error == ((void*)0) || *error == ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "error == NULL || *error == NULL"); return ((0)); }; }while (0);

  ((void)(0));

  size = (((gdk_pixbuf_get_width (pixbuf)) > (gdk_pixbuf_get_height (pixbuf))) ? (gdk_pixbuf_get_width (pixbuf)) : (gdk_pixbuf_get_height (pixbuf)));
  if (size < 1)
    return (!(0));
                             ...
                             GError **error)
{
  ...
  pixbuf = gdk_pixbuf_new (GDK_COLORSPACE_RGB, (0), 8, 1, 1);

  desc = g_strdup_printf ("Thumbnail failure for %s", thumbnail->image_uri);
  time_str = g_strdup_printf ("%" "li", thumbnail->image_mtime);
  size_str = g_strdup_printf ("%" "li", thumbnail->image_filesize);

  success = gdk_pixbuf_save (pixbuf, name, "png", error,
                             "tEXt::Description", desc,
                             "tEXt::Software", software,
                             "tEXt::Thumb::URI", thumbnail->image_uri,
                             "tEXt::Thumb::MTime", time_str,
...
gimp_thumbnail_delete_failure (GimpThumbnail *thumbnail)
{
  ...
  do{ if ((((__extension__ ({ GTypeInstance *__inst = (GTypeInstance*) ((thumbnail)); GType __t = ((gimp_thumbnail_get_type ())); gboolean __r; if (!__inst) __r = (0); else if (__inst->g_class && __inst->g_class->g_type == __t) __r = (!(0)); else __r = g_type_check_instance_is_a (__inst, __t); __r; }))))) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "GIMP_IS_THUMBNAIL (thumbnail)"); return; }; }while (0);
  do{ if (thumbnail->image_uri != ((void*)0)) { } else { g_return_if_fail_warning ("LibGimpThumb", ((const char*) (__func__)), "thumbnail->image_uri != NULL"); return; }; }while (0);
...
gimp_thumbnail_has_failed (GimpThumbnail *thumbnail)
{
  ...
  pixbuf = gdk_pixbuf_new_from_file (filename, ((void*)0));
  g_free (filename);
