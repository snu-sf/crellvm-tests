; ModuleID = './app/tools/gimpconvolvetool.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpConvolveToolClass = type { %struct._GimpBrushToolClass }
...
%struct._GimpConvolveTool = type { %struct._GimpBrushTool, i32 }
...
@gimp_convolve_tool_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [17 x i8] c"GimpConvolveTool\00", align 1
@.str.1 = private unnamed_addr constant [19 x i8] c"gimp-convolve-tool\00", align 1
@.str.2 = private unnamed_addr constant [15 x i8] c"Blur / Sharpen\00", align 1
@.str.3 = private unnamed_addr constant [68 x i8] c"Blur / Sharpen Tool: Selective blurring or unblurring using a brush\00", align 1
@.str.4 = private unnamed_addr constant [16 x i8] c"Bl_ur / Sharpen\00", align 1
@.str.5 = private unnamed_addr constant [9 x i8] c"<shift>U\00", align 1
@.str.6 = private unnamed_addr constant [19 x i8] c"gimp-tool-convolve\00", align 1
@.str.7 = private unnamed_addr constant [15 x i8] c"gimp-tool-blur\00", align 1
@gimp_convolve_tool_parent_class = internal global i8* null, align 8
@GimpConvolveTool_private_offset = internal global i32 0, align 4
@.str.8 = private unnamed_addr constant [5 x i8] c"type\00", align 1
@.str.9 = private unnamed_addr constant [14 x i8] c"Click to blur\00", align 1
@.str.10 = private unnamed_addr constant [23 x i8] c"Click to blur the line\00", align 1
@.str.11 = private unnamed_addr constant [14 x i8] c"%s to sharpen\00", align 1
@.str.12 = private unnamed_addr constant [17 x i8] c"Click to sharpen\00", align 1
@.str.13 = private unnamed_addr constant [26 x i8] c"Click to sharpen the line\00", align 1
@.str.14 = private unnamed_addr constant [11 x i8] c"%s to blur\00", align 1
@.str.15 = private unnamed_addr constant [20 x i8] c"Convolve Type  (%s)\00", align 1
@.str.16 = private unnamed_addr constant [5 x i8] c"rate\00", align 1
@.str.17 = private unnamed_addr constant [5 x i8] c"Rate\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_convolve_tool_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_convolve_tool_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_convolve_tool_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 304, void (i8*, i8*)* bitcast (void (i8*)* @gimp_convolve_tool_class_intern_init to void (i8*, i8*)*), i32 368, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpConvolveTool*)* @gimp_convolve_tool_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_convolve_tool_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_convolve_tool_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_convolve_tool_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_convolve_tool_parent_class, align 8
  %1 = load i32, i32* @GimpConvolveTool_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpConvolveTool_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpConvolveToolClass*
  call void @gimp_convolve_tool_class_init(%struct._GimpConvolveToolClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_convolve_tool_init(%struct._GimpConvolveTool* %convolve) #3 {
entry:
  %convolve.addr = alloca %struct._GimpConvolveTool*, align 8
  %tool = alloca %struct._GimpTool*, align 8
  store %struct._GimpConvolveTool* %convolve, %struct._GimpConvolveTool** %convolve.addr, align 8
  %0 = load %struct._GimpConvolveTool*, %struct._GimpConvolveTool** %convolve.addr, align 8
  %1 = bitcast %struct._GimpConvolveTool* %0 to %struct._GTypeInstance*
  ...
  call void @gimp_tool_control_set_tool_cursor(%struct._GimpToolControl* %4, i32 32)
  ...
  call void @gimp_tool_control_set_toggle_cursor_modifier(%struct._GimpToolControl* %6, i32 3)
  %7 = load %struct._GimpTool*, %struct._GimpTool** %tool, align 8
  call void @gimp_convolve_tool_status_update(%struct._GimpTool* %7, i32 0)
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @gimp_convolve_tool_register(void (i64, i64, %struct._GtkWidget* (%struct._GimpToolOptions*)*, i32, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*)* %callback, i8* %data) #3 {
entry:
  ...
  %call = call i64 @gimp_convolve_tool_get_type() #5
...
; Function Attrs: nounwind uwtable
define internal %struct._GtkWidget* @gimp_convolve_options_gui(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  ...
  %call3 = call i8* @gettext(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.15, i32 0, i32 0)) #6
  ...
  %call9 = call i8* @gettext(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.17, i32 0, i32 0)) #6
  %call10 = call %struct._GtkWidget* @gimp_prop_spin_scale_new(%struct._GObject* %13, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.16, i32 0, i32 0), i8* %call9, double 1.000000e+00, double 1.000000e+01, i32 1)
  ...
  %17 = load %struct._GtkWidget*, %struct._GtkWidget** %scale, align 8
...
; Function Attrs: nounwind uwtable
define internal void @gimp_convolve_tool_class_init(%struct._GimpConvolveToolClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpConvolveToolClass*, align 8
  %tool_class = alloca %struct._GimpToolClass*, align 8
  store %struct._GimpConvolveToolClass* %klass, %struct._GimpConvolveToolClass** %klass.addr, align 8
  %0 = load %struct._GimpConvolveToolClass*, %struct._GimpConvolveToolClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpConvolveToolClass* %0 to %struct._GTypeClass*
  %call = call i64 @gimp_tool_get_type() #5
  ...
  store void (%struct._GimpTool*, i32, i32, i32, %struct._GimpDisplay*)* @gimp_convolve_tool_modifier_key, void (%struct._GimpTool*, i32, i32, i32, %struct._GimpDisplay*)** %modifier_key, align 8
  ...
  store void (%struct._GimpTool*, %struct._GimpCoords*, i32, %struct._GimpDisplay*)* @gimp_convolve_tool_cursor_update, void (%struct._GimpTool*, %struct._GimpCoords*, i32, %struct._GimpDisplay*)** %cursor_update, align 8
  ...
  store void (%struct._GimpTool*, %struct._GimpCoords*, i32, i32, %struct._GimpDisplay*)* @gimp_convolve_tool_oper_update, void (%struct._GimpTool*, %struct._GimpCoords*, i32, i32, %struct._GimpDisplay*)** %oper_update, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_convolve_tool_modifier_key(%struct._GimpTool* %tool, i32 %key, i32 %press, i32 %state, %struct._GimpDisplay* %display) #3 {
entry:
  ...
  %convolve = alloca %struct._GimpConvolveTool*, align 8
  ...
  %call = call i64 @gimp_convolve_tool_get_type() #5
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpConvolveTool*
  store %struct._GimpConvolveTool* %2, %struct._GimpConvolveTool** %convolve, align 8
  ...
  %call5 = call i64 @gimp_convolve_options_get_type() #5
  %call6 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %6, i64 %call5)
  %7 = bitcast %struct._GTypeInstance* %call6 to %struct._GimpConvolveOptions*
  store %struct._GimpConvolveOptions* %7, %struct._GimpConvolveOptions** %options, align 8
...
land.lhs.true.8:                                  ; preds = %land.lhs.true
  ...
  %12 = load %struct._GimpConvolveTool*, %struct._GimpConvolveTool** %convolve, align 8
  %toggled = getelementptr inbounds %struct._GimpConvolveTool, %struct._GimpConvolveTool* %12, i32 0, i32 1
...
land.lhs.true.13:                                 ; preds = %land.lhs.true.11
  %16 = load %struct._GimpConvolveTool*, %struct._GimpConvolveTool** %convolve, align 8
  %toggled14 = getelementptr inbounds %struct._GimpConvolveTool, %struct._GimpConvolveTool* %16, i32 0, i32 1
...
if.then:                                          ; preds = %land.lhs.true.16, %land.lhs.true.8
  ...
  %21 = load %struct._GimpConvolveTool*, %struct._GimpConvolveTool** %convolve, align 8
  %toggled19 = getelementptr inbounds %struct._GimpConvolveTool, %struct._GimpConvolveTool* %21, i32 0, i32 1
  store i32 %20, i32* %toggled19, align 4
  %22 = load %struct._GimpConvolveOptions*, %struct._GimpConvolveOptions** %options, align 8
  %type = getelementptr inbounds %struct._GimpConvolveOptions, %struct._GimpConvolveOptions* %22, i32 0, i32 1
...
sw.bb:                                            ; preds = %if.then
  %24 = load %struct._GimpConvolveOptions*, %struct._GimpConvolveOptions** %options, align 8
  %25 = bitcast %struct._GimpConvolveOptions* %24 to i8*
...
sw.bb.20:                                         ; preds = %if.then
  %26 = load %struct._GimpConvolveOptions*, %struct._GimpConvolveOptions** %options, align 8
  %27 = bitcast %struct._GimpConvolveOptions* %26 to i8*
...
; Function Attrs: nounwind uwtable
define internal void @gimp_convolve_tool_cursor_update(%struct._GimpTool* %tool, %struct._GimpCoords* %coords, i32 %state, %struct._GimpDisplay* %display) #3 {
entry:
  %tool.addr = alloca %struct._GimpTool*, align 8
  ...
  %call3 = call i64 @gimp_convolve_options_get_type() #5
  %call4 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %3, i64 %call3)
  %4 = bitcast %struct._GTypeInstance* %call4 to %struct._GimpConvolveOptions*
  store %struct._GimpConvolveOptions* %4, %struct._GimpConvolveOptions** %options, align 8
  ...
  %7 = load %struct._GimpConvolveOptions*, %struct._GimpConvolveOptions** %options, align 8
  %type = getelementptr inbounds %struct._GimpConvolveOptions, %struct._GimpConvolveOptions* %7, i32 0, i32 1
  %8 = load i32, i32* %type, align 4
  %cmp = icmp eq i32 %8, 1
  %conv = zext i1 %cmp to i32
  call void @gimp_tool_control_set_toggled(%struct._GimpToolControl* %6, i32 %conv)
  %9 = load i8*, i8** @gimp_convolve_tool_parent_class, align 8
...
; Function Attrs: nounwind uwtable
define internal void @gimp_convolve_tool_oper_update(%struct._GimpTool* %tool, %struct._GimpCoords* %coords, i32 %state, i32 %proximity, %struct._GimpDisplay* %display) #3 {
entry:
  %tool.addr = alloca %struct._GimpTool*, align 8
  %coords.addr = alloca %struct._GimpCoords*, align 8
  %state.addr = alloca i32, align 4
  ...
  store %struct._GimpConvolveOptions* %4, %struct._GimpConvolveOptions** %options, align 8
  %5 = load %struct._GimpTool*, %struct._GimpTool** %tool.addr, align 8
  %6 = load %struct._GimpConvolveOptions*, %struct._GimpConvolveOptions** %options, align 8
  %type = getelementptr inbounds %struct._GimpConvolveOptions, %struct._GimpConvolveOptions* %6, i32 0, i32 1
  %7 = load i32, i32* %type, align 4
  call void @gimp_convolve_tool_status_update(%struct._GimpTool* %5, i32 %7)
  %8 = load i8*, i8** @gimp_convolve_tool_parent_class, align 8
...
; Function Attrs: nounwind uwtable
define internal void @gimp_convolve_tool_status_update(%struct._GimpTool* %tool, i32 %type) #3 {
entry:
  %tool.addr = alloca %struct._GimpTool*, align 8
...
sw.bb:                                            ; preds = %entry
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.9, i32 0, i32 0)) #6
  ...
  %call3 = call i8* @gettext(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.10, i32 0, i32 0)) #6
  ...
  %call4 = call i8* @gettext(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.11, i32 0, i32 0)) #6
...
sw.bb.5:                                          ; preds = %entry
  %call6 = call i8* @gettext(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.12, i32 0, i32 0)) #6
  ...
  %call8 = call i8* @gettext(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.13, i32 0, i32 0)) #6
  ...
  %call10 = call i8* @gettext(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.14, i32 0, i32 0)) #6
