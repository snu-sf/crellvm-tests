; ModuleID = './app/actions/cursor-info-commands.bc'
...
define void @cursor_info_sample_merged_cmd_callback(%struct._GtkAction* %action, i8* %data) #0 {
entry:
  ...
  call void @gimp_cursor_view_set_sample_merged(%struct._GimpCursorView* %6, i32 %7)
  ret void
}
...
declare void @gimp_cursor_view_set_sample_merged(%struct._GimpCursorView*, i32) #1
