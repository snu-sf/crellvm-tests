; ModuleID = './app/paint/gimpairbrushoptions.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpAirbrushOptionsClass = type { %struct._GimpPaintOptionsClass }
...
@gimp_airbrush_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [20 x i8] c"GimpAirbrushOptions\00", align 1
@gimp_airbrush_options_parent_class = internal global i8* null, align 8
@GimpAirbrushOptions_private_offset = internal global i32 0, align 4
@.str.1 = private unnamed_addr constant [5 x i8] c"rate\00", align 1
@.str.2 = private unnamed_addr constant [12 x i8] c"motion-only\00", align 1
@.str.3 = private unnamed_addr constant [5 x i8] c"flow\00", align 1
@.str.4 = private unnamed_addr constant [9 x i8] c"pressure\00", align 1
@.str.5 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.6 = private unnamed_addr constant [22 x i8] c"gimpairbrushoptions.c\00", align 1
...
define i64 @gimp_airbrush_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_airbrush_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_airbrush_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  %call5 = call i64 @gimp_paint_options_get_type() #5
  %call6 = call i8* @g_intern_static_string(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str, i32 0, i32 0))
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_airbrush_options_class_intern_init to void (i8*, i8*)*), i32 496, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpAirbrushOptions*)* @gimp_airbrush_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_airbrush_options_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_airbrush_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_airbrush_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_airbrush_options_parent_class, align 8
  %1 = load i32, i32* @GimpAirbrushOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpAirbrushOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpAirbrushOptionsClass*
  call void @gimp_airbrush_options_class_init(%struct._GimpAirbrushOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_airbrush_options_init(%struct._GimpAirbrushOptions* %options) #3 {
entry:
  %options.addr = alloca %struct._GimpAirbrushOptions*, align 8
  store %struct._GimpAirbrushOptions* %options, %struct._GimpAirbrushOptions** %options.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_airbrush_options_class_init(%struct._GimpAirbrushOptionsClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpAirbrushOptionsClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  store %struct._GimpAirbrushOptionsClass* %klass, %struct._GimpAirbrushOptionsClass** %klass.addr, align 8
  %0 = load %struct._GimpAirbrushOptionsClass*, %struct._GimpAirbrushOptionsClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpAirbrushOptionsClass* %0 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_airbrush_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %4 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %4, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_airbrush_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %5 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call1 = call %struct._GParamSpec* @g_param_spec_double(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i8* null, i8* null, double 0.000000e+00, double 1.500000e+02, double 8.000000e+01, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %5, i32 1, %struct._GParamSpec* %call1)
  %6 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call2 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.2, i32 0, i32 0), i8* null, i8* null, i32 0, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %6, i32 2, %struct._GParamSpec* %call2)
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call %struct._GParamSpec* @g_param_spec_double(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.3, i32 0, i32 0), i8* null, i8* null, double 0.000000e+00, double 1.000000e+02, double 1.000000e+01, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %7, i32 3, %struct._GParamSpec* %call3)
  %8 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call4 = call %struct._GParamSpec* @g_param_spec_double(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.4, i32 0, i32 0), i8* null, i8* null, double 0.000000e+00, double 1.000000e+02, double 1.000000e+01, i32 8455)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_airbrush_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpAirbrushOptions*, %struct._GimpAirbrushOptions** %options, align 8
  %rate = getelementptr inbounds %struct._GimpAirbrushOptions, %struct._GimpAirbrushOptions* %5, i32 0, i32 1
  store double %call2, double* %rate, align 8
  br label %sw.epilog

sw.bb.3:                                          ; preds = %entry
  %6 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call4 = call i32 @g_value_get_boolean(%struct._GValue* %6)
  %7 = load %struct._GimpAirbrushOptions*, %struct._GimpAirbrushOptions** %options, align 8
  %motion_only = getelementptr inbounds %struct._GimpAirbrushOptions, %struct._GimpAirbrushOptions* %7, i32 0, i32 2
  store i32 %call4, i32* %motion_only, align 4
  br label %sw.epilog

sw.bb.5:                                          ; preds = %entry, %entry
  %8 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call6 = call double @g_value_get_double(%struct._GValue* %8)
  %9 = load %struct._GimpAirbrushOptions*, %struct._GimpAirbrushOptions** %options, align 8
  %flow = getelementptr inbounds %struct._GimpAirbrushOptions, %struct._GimpAirbrushOptions* %9, i32 0, i32 3
  store double %call6, double* %flow, align 8
  br label %sw.epilog
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.6, i32 0, i32 0), i32 115, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i32 0, i32 0), i32 %13, i8* %15, i8* %call7, i8* %call10)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_airbrush_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpAirbrushOptions*, %struct._GimpAirbrushOptions** %options, align 8
  %rate = getelementptr inbounds %struct._GimpAirbrushOptions, %struct._GimpAirbrushOptions* %5, i32 0, i32 1
  %6 = load double, double* %rate, align 8
  call void @g_value_set_double(%struct._GValue* %4, double %6)
  br label %sw.epilog

sw.bb.2:                                          ; preds = %entry
  %7 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %8 = load %struct._GimpAirbrushOptions*, %struct._GimpAirbrushOptions** %options, align 8
  %motion_only = getelementptr inbounds %struct._GimpAirbrushOptions, %struct._GimpAirbrushOptions* %8, i32 0, i32 2
  %9 = load i32, i32* %motion_only, align 4
  call void @g_value_set_boolean(%struct._GValue* %7, i32 %9)
  br label %sw.epilog

sw.bb.3:                                          ; preds = %entry, %entry
  %10 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %11 = load %struct._GimpAirbrushOptions*, %struct._GimpAirbrushOptions** %options, align 8
  %flow = getelementptr inbounds %struct._GimpAirbrushOptions, %struct._GimpAirbrushOptions* %11, i32 0, i32 3
  %12 = load double, double* %flow, align 8
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.6, i32 0, i32 0), i32 142, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i32 0, i32 0), i32 %16, i8* %18, i8* %call4, i8* %call7)
  br label %do.end
