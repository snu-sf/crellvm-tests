; ModuleID = './app/vectors/gimpvectorsundo.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpVectorsUndoClass = type { %struct._GimpItemUndoClass }
...
%struct._GimpVectorsUndo = type { %struct._GimpItemUndo, %struct._GimpVectors*, i32, %struct._GimpVectors* }
...
@gimp_vectors_undo_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [16 x i8] c"GimpVectorsUndo\00", align 1
@gimp_vectors_undo_parent_class = internal global i8* null, align 8
@GimpVectorsUndo_private_offset = internal global i32 0, align 4
...
@.str.3 = private unnamed_addr constant [13 x i8] c"prev-vectors\00", align 1
@.str.4 = private unnamed_addr constant [13 x i8] c"Gimp-Vectors\00", align 1
@.str.5 = private unnamed_addr constant [18 x i8] c"gimpvectorsundo.c\00", align 1
@__func__.gimp_vectors_undo_constructed = private unnamed_addr constant [30 x i8] c"gimp_vectors_undo_constructed\00", align 1
@.str.6 = private unnamed_addr constant [48 x i8] c"GIMP_IS_VECTORS (GIMP_ITEM_UNDO (object)->item)\00", align 1
...
define i64 @gimp_vectors_undo_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_vectors_undo_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_vectors_undo_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 296, void (i8*, i8*)* bitcast (void (i8*)* @gimp_vectors_undo_class_intern_init to void (i8*, i8*)*), i32 104, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpVectorsUndo*)* @gimp_vectors_undo_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_vectors_undo_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_vectors_undo_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_vectors_undo_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_vectors_undo_parent_class, align 8
  %1 = load i32, i32* @GimpVectorsUndo_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpVectorsUndo_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpVectorsUndoClass*
  call void @gimp_vectors_undo_class_init(%struct._GimpVectorsUndoClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_vectors_undo_init(%struct._GimpVectorsUndo* %undo) #3 {
entry:
  %undo.addr = alloca %struct._GimpVectorsUndo*, align 8
  store %struct._GimpVectorsUndo* %undo, %struct._GimpVectorsUndo** %undo.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_vectors_undo_class_init(%struct._GimpVectorsUndoClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpVectorsUndoClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  %gimp_object_class = alloca %struct._GimpObjectClass*, align 8
  %undo_class = alloca %struct._GimpUndoClass*, align 8
  store %struct._GimpVectorsUndoClass* %klass, %struct._GimpVectorsUndoClass** %klass.addr, align 8
  %0 = load %struct._GimpVectorsUndoClass*, %struct._GimpVectorsUndoClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpVectorsUndoClass* %0 to %struct._GTypeClass*
  %call = call %struct._GTypeClass* @g_type_check_class_cast(%struct._GTypeClass* %1, i64 80)
  %2 = bitcast %struct._GTypeClass* %call to %struct._GObjectClass*
  store %struct._GObjectClass* %2, %struct._GObjectClass** %object_class, align 8
  %3 = load %struct._GimpVectorsUndoClass*, %struct._GimpVectorsUndoClass** %klass.addr, align 8
  %4 = bitcast %struct._GimpVectorsUndoClass* %3 to %struct._GTypeClass*
  ...
  %6 = load %struct._GimpVectorsUndoClass*, %struct._GimpVectorsUndoClass** %klass.addr, align 8
  %7 = bitcast %struct._GimpVectorsUndoClass* %6 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*)* @gimp_vectors_undo_constructed, void (%struct._GObject*)** %constructed, align 8
  %10 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %set_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %10, i32 0, i32 3
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_vectors_undo_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %11 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %11, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_vectors_undo_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  ...
  store i64 (%struct._GimpObject*, i64*)* @gimp_vectors_undo_get_memsize, i64 (%struct._GimpObject*, i64*)** %get_memsize, align 8
  ...
  store void (%struct._GimpUndo*, i32, %struct._GimpUndoAccumulator*)* @gimp_vectors_undo_pop, void (%struct._GimpUndo*, i32, %struct._GimpUndoAccumulator*)** %pop, align 8
  ...
  %call8 = call i64 @gimp_vectors_get_type() #7
  %call9 = call %struct._GParamSpec* @g_param_spec_object(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.3, i32 0, i32 0), i8* null, i8* null, i64 %call8, i32 235)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_vectors_undo_constructed(%struct._GObject* %object) #3 {
entry:
  ...
  %0 = load i8*, i8** @gimp_vectors_undo_parent_class, align 8
...
if.then:                                          ; preds = %entry
  %4 = load i8*, i8** @gimp_vectors_undo_parent_class, align 8
...
; Function Attrs: nounwind uwtable
define internal void @gimp_vectors_undo_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
  %pspec.addr = alloca %struct._GParamSpec*, align 8
  %vectors_undo = alloca %struct._GimpVectorsUndo*, align 8
  ...
  %call = call i64 @gimp_vectors_undo_get_type() #7
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpVectorsUndo*
  store %struct._GimpVectorsUndo* %2, %struct._GimpVectorsUndo** %vectors_undo, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = bitcast i8* %call2 to %struct._GimpVectors*
  %6 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_parent = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %6, i32 0, i32 1
  store %struct._GimpVectors* %5, %struct._GimpVectors** %prev_parent, align 8
  br label %sw.epilog

sw.bb.3:                                          ; preds = %entry
  %7 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call4 = call i32 @g_value_get_int(%struct._GValue* %7)
  %8 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_position = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %8, i32 0, i32 2
...
sw.bb.5:                                          ; preds = %entry
  ...
  %10 = bitcast i8* %call6 to %struct._GimpVectors*
  %11 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_vectors = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %11, i32 0, i32 3
  store %struct._GimpVectors* %10, %struct._GimpVectors** %prev_vectors, align 8
  br label %sw.epilog
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.5, i32 0, i32 0), i32 132, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.8, i32 0, i32 0), i32 %15, i8* %17, i8* %call7, i8* %call10)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_vectors_undo_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb:                                            ; preds = %entry
  %4 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %5 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_parent = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %5, i32 0, i32 1
  %6 = load %struct._GimpVectors*, %struct._GimpVectors** %prev_parent, align 8
...
sw.bb.2:                                          ; preds = %entry
  ...
  %9 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_position = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %9, i32 0, i32 2
...
sw.bb.3:                                          ; preds = %entry
  ...
  %12 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_vectors = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %12, i32 0, i32 3
  %13 = load %struct._GimpVectors*, %struct._GimpVectors** %prev_vectors, align 8
  %14 = bitcast %struct._GimpVectors* %13 to i8*
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.5, i32 0, i32 0), i32 158, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.8, i32 0, i32 0), i32 %18, i8* %20, i8* %call4, i8* %call7)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal i64 @gimp_vectors_undo_get_memsize(%struct._GimpObject* %object, i64* %gui_size) #3 {
entry:
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %12 = load i8*, i8** @gimp_vectors_undo_parent_class, align 8
...
; Function Attrs: nounwind uwtable
define internal void @gimp_vectors_undo_pop(%struct._GimpUndo* %undo, i32 %undo_mode, %struct._GimpUndoAccumulator* %accum) #3 {
entry:
  ...
  %7 = bitcast %struct._GimpItem* %6 to %struct._GTypeInstance*
  %call4 = call i64 @gimp_vectors_get_type() #7
  %call5 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %7, i64 %call4)
  ...
  %9 = load i8*, i8** @gimp_vectors_undo_parent_class, align 8
...
land.lhs.true.10:                                 ; preds = %lor.lhs.false
  ...
  %cmp12 = icmp eq i32 %21, 71
  br i1 %cmp12, label %if.then, label %if.else

if.then:                                          ; preds = %land.lhs.true.10, %land.lhs.true
  %22 = load %struct._GimpVectors*, %struct._GimpVectors** %vectors, align 8
  %call13 = call %struct._GimpVectors* @gimp_vectors_get_parent(%struct._GimpVectors* %22)
  %23 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_parent = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %23, i32 0, i32 1
  store %struct._GimpVectors* %call13, %struct._GimpVectors** %prev_parent, align 8
  ...
  %27 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_position = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %27, i32 0, i32 2
  ...
  %31 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_vectors = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %31, i32 0, i32 3
  %32 = load %struct._GimpVectors*, %struct._GimpVectors** %prev_vectors, align 8
  call void @gimp_image_remove_vectors(%struct._GimpImage* %29, %struct._GimpVectors* %30, i32 0, %struct._GimpVectors* %32)
  br label %if.end
...
if.else:                                          ; preds = %land.lhs.true.10, %lor.lhs.false
  ...
  %call18 = call %struct._GimpVectors* @gimp_image_get_active_vectors(%struct._GimpImage* %34)
  %35 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_vectors19 = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %35, i32 0, i32 3
  store %struct._GimpVectors* %call18, %struct._GimpVectors** %prev_vectors19, align 8
  ...
  %39 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_parent21 = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %39, i32 0, i32 1
  %40 = load %struct._GimpVectors*, %struct._GimpVectors** %prev_parent21, align 8
  %41 = load %struct._GimpVectorsUndo*, %struct._GimpVectorsUndo** %vectors_undo, align 8
  %prev_position22 = getelementptr inbounds %struct._GimpVectorsUndo, %struct._GimpVectorsUndo* %41, i32 0, i32 2
  %42 = load i32, i32* %prev_position22, align 4
  %call23 = call i32 @gimp_image_add_vectors(%struct._GimpImage* %37, %struct._GimpVectors* %38, %struct._GimpVectors* %40, i32 %42, i32 0)
  br label %if.end
