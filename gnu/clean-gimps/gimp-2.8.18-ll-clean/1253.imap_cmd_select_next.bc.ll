; ModuleID = './plug-ins/imagemap/imap_cmd_select_next.bc'
...
%struct.SelectNextCommand_t = type { %struct.Command_t, %struct.ObjectList_t* }
...
@.str = private unnamed_addr constant [12 x i8] c"Select Next\00", align 1
@select_next_command_class = internal global %struct.CommandClass_t { void (%struct.Command_t*)* null, i32 (%struct.Command_t*)* @select_next_command_execute, void (%struct.Command_t*)* null, void (%struct.Command_t*)* null }, align 8

; Function Attrs: nounwind uwtable
define %struct.Command_t* @select_next_command_new(%struct.ObjectList_t* %list) #0 {
entry:
  %list.addr = alloca %struct.ObjectList_t*, align 8
  %command = alloca %struct.SelectNextCommand_t*, align 8
  store %struct.ObjectList_t* %list, %struct.ObjectList_t** %list.addr, align 8
  %call = call noalias i8* @g_malloc_n(i64 1, i64 40)
  %0 = bitcast i8* %call to %struct.SelectNextCommand_t*
  store %struct.SelectNextCommand_t* %0, %struct.SelectNextCommand_t** %command, align 8
  %1 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list.addr, align 8
  %2 = load %struct.SelectNextCommand_t*, %struct.SelectNextCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.SelectNextCommand_t, %struct.SelectNextCommand_t* %2, i32 0, i32 1
  store %struct.ObjectList_t* %1, %struct.ObjectList_t** %list1, align 8
  %3 = load %struct.SelectNextCommand_t*, %struct.SelectNextCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.SelectNextCommand_t, %struct.SelectNextCommand_t* %3, i32 0, i32 0
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0)) #3
  %call3 = call %struct.Command_t* @command_init(%struct.Command_t* %parent, i8* %call2, %struct.CommandClass_t* @select_next_command_class)
...
; Function Attrs: nounwind uwtable
define internal i32 @select_next_command_execute(%struct.Command_t* %parent) #0 {
entry:
  ...
  %1 = bitcast %struct.Command_t* %0 to %struct.SelectNextCommand_t*
  store %struct.SelectNextCommand_t* %1, %struct.SelectNextCommand_t** %command, align 8
  %2 = load %struct.SelectNextCommand_t*, %struct.SelectNextCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.SelectNextCommand_t, %struct.SelectNextCommand_t* %2, i32 0, i32 1
  ...
  %5 = load %struct.SelectNextCommand_t*, %struct.SelectNextCommand_t** %command, align 8
  %6 = bitcast %struct.SelectNextCommand_t* %5 to i8*
  ...
  call void @object_list_select_next(%struct.ObjectList_t* %7)
...
entry:
  ...
  %1 = bitcast i8* %0 to %struct.SelectNextCommand_t*
  store %struct.SelectNextCommand_t* %1, %struct.SelectNextCommand_t** %command, align 8
...
cond.end:                                         ; preds = %cond.false, %cond.true
  ...
  %6 = load %struct.SelectNextCommand_t*, %struct.SelectNextCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.SelectNextCommand_t, %struct.SelectNextCommand_t* %6, i32 0, i32 0
...
declare void @object_list_select_next(%struct.ObjectList_t*) #1
