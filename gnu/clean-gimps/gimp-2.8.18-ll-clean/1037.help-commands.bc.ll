; ModuleID = './app/actions/help-commands.bc'
...
define void @help_help_cmd_callback(%struct._GtkAction* %action, i8* %data) #0 {
entry:
...
if.end.4:                                         ; preds = %if.end
  ...
  %6 = bitcast %struct._GimpDisplay* %5 to %struct._GTypeInstance*
  %call5 = call i64 @gimp_progress_interface_get_type() #3
  %call6 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %6, i64 %call5)
  %7 = bitcast %struct._GTypeInstance* %call6 to %struct._GimpProgress*
  call void @gimp_help_show(%struct._Gimp* %4, %struct._GimpProgress* %7, i8* null, i8* null)
  br label %return
...
declare void @gimp_help_show(%struct._Gimp*, %struct._GimpProgress*, i8*, i8*) #1
...
; Function Attrs: nounwind uwtable
define void @help_context_help_cmd_callback(%struct._GtkAction* %action, i8* %data) #0 {
entry:
  %action.addr = alloca %struct._GtkAction*, align 8
  %data.addr = alloca i8*, align 8
...
if.end:                                           ; preds = %entry
  ...
  call void @gimp_context_help(%struct._GtkWidget* %2)
  br label %return
...
declare void @gimp_context_help(%struct._GtkWidget*) #1
