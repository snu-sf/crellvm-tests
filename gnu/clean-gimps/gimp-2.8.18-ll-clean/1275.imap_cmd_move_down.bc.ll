; ModuleID = './plug-ins/imagemap/imap_cmd_move_down.bc'
...
%struct.MoveDownCommand_t = type { %struct.Command_t, %struct.ObjectList_t*, i32 }
...
@.str = private unnamed_addr constant [10 x i8] c"Move Down\00", align 1
@move_down_command_class = internal global %struct.CommandClass_t { void (%struct.Command_t*)* null, i32 (%struct.Command_t*)* @move_down_command_execute, void (%struct.Command_t*)* null, void (%struct.Command_t*)* null }, align 8

; Function Attrs: nounwind uwtable
define %struct.Command_t* @move_down_command_new(%struct.ObjectList_t* %list) #0 {
entry:
  %list.addr = alloca %struct.ObjectList_t*, align 8
  %command = alloca %struct.MoveDownCommand_t*, align 8
  store %struct.ObjectList_t* %list, %struct.ObjectList_t** %list.addr, align 8
  %call = call noalias i8* @g_malloc_n(i64 1, i64 48)
  %0 = bitcast i8* %call to %struct.MoveDownCommand_t*
  store %struct.MoveDownCommand_t* %0, %struct.MoveDownCommand_t** %command, align 8
  %1 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list.addr, align 8
  %2 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %2, i32 0, i32 1
  store %struct.ObjectList_t* %1, %struct.ObjectList_t** %list1, align 8
  %3 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %add = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %3, i32 0, i32 2
  store i32 0, i32* %add, align 4
  %4 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %4, i32 0, i32 0
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0)) #3
  %call3 = call %struct.Command_t* @command_init(%struct.Command_t* %parent, i8* %call2, %struct.CommandClass_t* @move_down_command_class)
...
; Function Attrs: nounwind uwtable
define internal i32 @move_down_command_execute(%struct.Command_t* %parent) #0 {
entry:
  ...
  %1 = bitcast %struct.Command_t* %0 to %struct.MoveDownCommand_t*
  store %struct.MoveDownCommand_t* %1, %struct.MoveDownCommand_t** %command, align 8
  %2 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %list = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %2, i32 0, i32 1
  %3 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list, align 8
  %4 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %5 = bitcast %struct.MoveDownCommand_t* %4 to i8*
  %call = call i8* @object_list_add_move_cb(%struct.ObjectList_t* %3, void (%struct.Object_t*, i8*)* @move_down_one_object, i8* %5)
  store i8* %call, i8** %id, align 8
  %6 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %6, i32 0, i32 1
  %7 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list1, align 8
  call void @object_list_move_selected_down(%struct.ObjectList_t* %7)
  %8 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %list2 = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %8, i32 0, i32 1
...
; Function Attrs: nounwind uwtable
define internal void @move_down_one_object(%struct.Object_t* %obj, i8* %data) #0 {
entry:
  ...
  %1 = bitcast i8* %0 to %struct.MoveDownCommand_t*
  store %struct.MoveDownCommand_t* %1, %struct.MoveDownCommand_t** %command, align 8
  %2 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %add = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %2, i32 0, i32 2
...
if.then:                                          ; preds = %entry
  %4 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %4, i32 0, i32 0
  %5 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %list = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %5, i32 0, i32 1
  %6 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list, align 8
  %7 = load %struct.Object_t*, %struct.Object_t** %obj.addr, align 8
  %call = call %struct.Command_t* @object_down_command_new(%struct.ObjectList_t* %6, %struct.Object_t* %7)
  call void @command_add_subcommand(%struct.Command_t* %parent, %struct.Command_t* %call)
  %8 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %add1 = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %8, i32 0, i32 2
  store i32 0, i32* %add1, align 4
  br label %if.end

if.else:                                          ; preds = %entry
  %9 = load %struct.MoveDownCommand_t*, %struct.MoveDownCommand_t** %command, align 8
  %add2 = getelementptr inbounds %struct.MoveDownCommand_t, %struct.MoveDownCommand_t* %9, i32 0, i32 2
...
declare void @object_list_move_selected_down(%struct.ObjectList_t*) #1
...
declare %struct.Command_t* @object_down_command_new(%struct.ObjectList_t*, %struct.Object_t*) #1
