; ModuleID = './app/tools/gimpsmudgetool.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpSmudgeToolClass = type { %struct._GimpBrushToolClass }
...
%struct._GimpSmudgeTool = type { %struct._GimpBrushTool }
...
@gimp_smudge_tool_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [15 x i8] c"GimpSmudgeTool\00", align 1
@.str.1 = private unnamed_addr constant [17 x i8] c"gimp-smudge-tool\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"Smudge\00", align 1
@.str.3 = private unnamed_addr constant [46 x i8] c"Smudge Tool: Smudge selectively using a brush\00", align 1
@.str.4 = private unnamed_addr constant [8 x i8] c"_Smudge\00", align 1
@.str.5 = private unnamed_addr constant [2 x i8] c"S\00", align 1
@.str.6 = private unnamed_addr constant [17 x i8] c"gimp-tool-smudge\00", align 1
@gimp_smudge_tool_parent_class = internal global i8* null, align 8
@GimpSmudgeTool_private_offset = internal global i32 0, align 4
@.str.7 = private unnamed_addr constant [16 x i8] c"Click to smudge\00", align 1
@.str.8 = private unnamed_addr constant [25 x i8] c"Click to smudge the line\00", align 1
...
define i64 @gimp_smudge_tool_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_smudge_tool_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_smudge_tool_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 304, void (i8*, i8*)* bitcast (void (i8*)* @gimp_smudge_tool_class_intern_init to void (i8*, i8*)*), i32 360, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpSmudgeTool*)* @gimp_smudge_tool_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_smudge_tool_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_smudge_tool_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_smudge_tool_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_smudge_tool_parent_class, align 8
  %1 = load i32, i32* @GimpSmudgeTool_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpSmudgeTool_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpSmudgeToolClass*
  call void @gimp_smudge_tool_class_init(%struct._GimpSmudgeToolClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_smudge_tool_init(%struct._GimpSmudgeTool* %smudge) #3 {
entry:
  %smudge.addr = alloca %struct._GimpSmudgeTool*, align 8
  %tool = alloca %struct._GimpTool*, align 8
  %paint_tool = alloca %struct._GimpPaintTool*, align 8
  store %struct._GimpSmudgeTool* %smudge, %struct._GimpSmudgeTool** %smudge.addr, align 8
  %0 = load %struct._GimpSmudgeTool*, %struct._GimpSmudgeTool** %smudge.addr, align 8
  %1 = bitcast %struct._GimpSmudgeTool* %0 to %struct._GTypeInstance*
  ...
  %3 = load %struct._GimpSmudgeTool*, %struct._GimpSmudgeTool** %smudge.addr, align 8
  %4 = bitcast %struct._GimpSmudgeTool* %3 to %struct._GTypeInstance*
  ...
  call void @gimp_tool_control_set_tool_cursor(%struct._GimpToolControl* %7, i32 31)
  %call4 = call i8* @gettext(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.7, i32 0, i32 0)) #6
  %8 = load %struct._GimpPaintTool*, %struct._GimpPaintTool** %paint_tool, align 8
  %status = getelementptr inbounds %struct._GimpPaintTool, %struct._GimpPaintTool* %8, i32 0, i32 3
  store i8* %call4, i8** %status, align 8
  %call5 = call i8* @gettext(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.8, i32 0, i32 0)) #6
  %9 = load %struct._GimpPaintTool*, %struct._GimpPaintTool** %paint_tool, align 8
  %status_line = getelementptr inbounds %struct._GimpPaintTool, %struct._GimpPaintTool* %9, i32 0, i32 4
  store i8* %call5, i8** %status_line, align 8
  %10 = load %struct._GimpPaintTool*, %struct._GimpPaintTool** %paint_tool, align 8
  %status_ctrl = getelementptr inbounds %struct._GimpPaintTool, %struct._GimpPaintTool* %10, i32 0, i32 5
  store i8* null, i8** %status_ctrl, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @gimp_smudge_tool_register(void (i64, i64, %struct._GtkWidget* (%struct._GimpToolOptions*)*, i32, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*)* %callback, i8* %data) #3 {
entry:
  ...
  %call = call i64 @gimp_smudge_tool_get_type() #5
  ...
  %call3 = call i8* @gettext(i8* getelementptr inbounds ([46 x i8], [46 x i8]* @.str.3, i32 0, i32 0)) #6
  %1 = load i8*, i8** %data.addr, align 8
  call void %0(i64 %call, i64 %call1, %struct._GtkWidget* (%struct._GimpToolOptions*)* @gimp_smudge_options_gui, i32 20416, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.1, i32 0, i32 0), i8* %call2, i8* %call3, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.6, i32 0, i32 0), i8* %1)
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal %struct._GtkWidget* @gimp_smudge_options_gui(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  ...
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.10, i32 0, i32 0)) #6
  %call3 = call %struct._GtkWidget* @gimp_prop_spin_scale_new(%struct._GObject* %4, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.9, i32 0, i32 0), i8* %call2, double 1.000000e+00, double 1.000000e+01, i32 1)
  store %struct._GtkWidget* %call3, %struct._GtkWidget** %scale, align 8
  ...
  %8 = load %struct._GtkWidget*, %struct._GtkWidget** %scale, align 8
...
; Function Attrs: nounwind uwtable
define internal void @gimp_smudge_tool_class_init(%struct._GimpSmudgeToolClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpSmudgeToolClass*, align 8
  store %struct._GimpSmudgeToolClass* %klass, %struct._GimpSmudgeToolClass** %klass.addr, align 8
  ret void
}
