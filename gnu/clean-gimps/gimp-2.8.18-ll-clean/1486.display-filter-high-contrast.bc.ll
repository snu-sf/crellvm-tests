; ModuleID = './modules/display-filter-high-contrast.bc'
...
%struct._CdisplayContrastClass = type { %struct._GimpColorDisplayClass }
...
%struct._CdisplayContrast = type { %struct._GimpColorDisplay, double, [256 x i8] }
...
@cdisplay_contrast_type_id = internal global i64 0, align 8
@cdisplay_contrast_info = internal constant %struct._GimpModuleInfo { i32 4, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i32 0, i32 0) }, align 8
@.str = private unnamed_addr constant [35 x i8] c"High Contrast color display filter\00", align 1
@.str.1 = private unnamed_addr constant [26 x i8] c"Jay Cox <jaycox@gimp.org>\00", align 1
@.str.2 = private unnamed_addr constant [5 x i8] c"v0.2\00", align 1
@.str.3 = private unnamed_addr constant [33 x i8] c"(c) 2000, released under the GPL\00", align 1
@.str.4 = private unnamed_addr constant [17 x i8] c"October 14, 2000\00", align 1
@cdisplay_contrast_register_type.g_define_type_info = internal constant %struct._GTypeInfo { i16 240, void (i8*)* null, void (i8*)* null, void (i8*, i8*)* bitcast (void (i8*)* @cdisplay_contrast_class_intern_init to void (i8*, i8*)*), void (i8*, i8*)* bitcast (void (%struct._CdisplayContrastClass*)* @cdisplay_contrast_class_finalize to void (i8*, i8*)*), i8* null, i16 296, i16 0, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._CdisplayContrast*)* @cdisplay_contrast_init to void (%struct._GTypeInstance*, i8*)*), %struct._GTypeValueTable* null }, align 8
@.str.5 = private unnamed_addr constant [17 x i8] c"CdisplayContrast\00", align 1
@cdisplay_contrast_parent_class = internal global i8* null, align 8
@CdisplayContrast_private_offset = internal global i32 0, align 4
...
@.str.9 = private unnamed_addr constant [27 x i8] c"gimp-colordisplay-contrast\00", align 1
@.str.10 = private unnamed_addr constant [29 x i8] c"gimp-display-filter-contrast\00", align 1
@.str.11 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.12 = private unnamed_addr constant [31 x i8] c"display-filter-high-contrast.c\00", align 1
@.str.13 = private unnamed_addr constant [9 x i8] c"property\00", align 1
@.str.14 = private unnamed_addr constant [18 x i8] c"Contrast c_ycles:\00", align 1

; Function Attrs: nounwind uwtable
define i64 @cdisplay_contrast_get_type() #0 {
entry:
  %0 = load i64, i64* @cdisplay_contrast_type_id, align 8
  ret i64 %0
}
...
entry:
  ...
  ret %struct._GimpModuleInfo* @cdisplay_contrast_info
}
...
entry:
  ...
  call void @cdisplay_contrast_register_type(%struct._GTypeModule* %0)
  ret i32 1
}

; Function Attrs: nounwind uwtable
define internal void @cdisplay_contrast_register_type(%struct._GTypeModule* %type_module) #0 {
entry:
  ...
  %call1 = call i64 @g_type_module_register_type(%struct._GTypeModule* %0, i64 %call, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.5, i32 0, i32 0), %struct._GTypeInfo* @cdisplay_contrast_register_type.g_define_type_info, i32 0)
  store i64 %call1, i64* @cdisplay_contrast_type_id, align 8
  %1 = load i64, i64* @cdisplay_contrast_type_id, align 8
  store i64 %1, i64* %g_define_type_id, align 8
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @cdisplay_contrast_class_intern_init(i8* %klass) #0 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @cdisplay_contrast_parent_class, align 8
  %1 = load i32, i32* @CdisplayContrast_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @CdisplayContrast_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._CdisplayContrastClass*
  call void @cdisplay_contrast_class_init(%struct._CdisplayContrastClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @cdisplay_contrast_class_finalize(%struct._CdisplayContrastClass* %klass) #0 {
entry:
  %klass.addr = alloca %struct._CdisplayContrastClass*, align 8
  store %struct._CdisplayContrastClass* %klass, %struct._CdisplayContrastClass** %klass.addr, align 8
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @cdisplay_contrast_init(%struct._CdisplayContrast* %contrast) #0 {
entry:
  %contrast.addr = alloca %struct._CdisplayContrast*, align 8
  store %struct._CdisplayContrast* %contrast, %struct._CdisplayContrast** %contrast.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @cdisplay_contrast_class_init(%struct._CdisplayContrastClass* %klass) #0 {
entry:
  %klass.addr = alloca %struct._CdisplayContrastClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  %display_class = alloca %struct._GimpColorDisplayClass*, align 8
  store %struct._CdisplayContrastClass* %klass, %struct._CdisplayContrastClass** %klass.addr, align 8
  %0 = load %struct._CdisplayContrastClass*, %struct._CdisplayContrastClass** %klass.addr, align 8
  %1 = bitcast %struct._CdisplayContrastClass* %0 to %struct._GTypeClass*
  %call = call %struct._GTypeClass* @g_type_check_class_cast(%struct._GTypeClass* %1, i64 80)
  %2 = bitcast %struct._GTypeClass* %call to %struct._GObjectClass*
  store %struct._GObjectClass* %2, %struct._GObjectClass** %object_class, align 8
  %3 = load %struct._CdisplayContrastClass*, %struct._CdisplayContrastClass** %klass.addr, align 8
  %4 = bitcast %struct._CdisplayContrastClass* %3 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @cdisplay_contrast_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %set_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %7, i32 0, i32 3
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @cdisplay_contrast_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %8 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call %struct._GParamSpec* @g_param_spec_double(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0), i8* null, i8* null, double 1.000000e-02, double 1.000000e+01, double 1.000000e+00, i32 263)
  call void @g_object_class_install_property(%struct._GObjectClass* %8, i32 1, %struct._GParamSpec* %call3)
  %call4 = call i8* @dgettext(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.8, i32 0, i32 0)) #4
  ...
  store i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.9, i32 0, i32 0), i8** %help_id, align 8
  ...
  store i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.10, i32 0, i32 0), i8** %stock_id, align 8
  ...
  store void (%struct._GimpColorDisplay*, %struct._cairo_surface*)* @cdisplay_contrast_convert_surface, void (%struct._GimpColorDisplay*, %struct._cairo_surface*)** %convert_surface, align 8
  ...
  store %struct._GtkWidget* (%struct._GimpColorDisplay*)* @cdisplay_contrast_configure, %struct._GtkWidget* (%struct._GimpColorDisplay*)** %configure, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @cdisplay_contrast_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #0 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
  %pspec.addr = alloca %struct._GParamSpec*, align 8
  %contrast = alloca %struct._CdisplayContrast*, align 8
  ...
  %call = call i64 @cdisplay_contrast_get_type()
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._CdisplayContrast*
  store %struct._CdisplayContrast* %2, %struct._CdisplayContrast** %contrast, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast, align 8
  %contrast2 = getelementptr inbounds %struct._CdisplayContrast, %struct._CdisplayContrast* %5, i32 0, i32 1
  %6 = load double, double* %contrast2, align 8
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.11, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.12, i32 0, i32 0), i32 157, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.13, i32 0, i32 0), i32 %10, i8* %12, i8* %call3, i8* %call6)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @cdisplay_contrast_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #0 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb:                                            ; preds = %entry
  %4 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast, align 8
  %5 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call2 = call double @g_value_get_double(%struct._GValue* %5)
  call void @cdisplay_contrast_set_contrast(%struct._CdisplayContrast* %4, double %call2)
  br label %sw.epilog
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.11, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.12, i32 0, i32 0), i32 176, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.13, i32 0, i32 0), i32 %9, i8* %11, i8* %call3, i8* %call6)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @cdisplay_contrast_convert_surface(%struct._GimpColorDisplay* %display, %struct._cairo_surface* %surface) #0 {
entry:
...
do.end:                                           ; preds = %do.body
  ...
  %31 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast, align 8
  %lookup = getelementptr inbounds %struct._CdisplayContrast, %struct._CdisplayContrast* %31, i32 0, i32 2
  ...
  %34 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast, align 8
  %lookup26 = getelementptr inbounds %struct._CdisplayContrast, %struct._CdisplayContrast* %34, i32 0, i32 2
  ...
  %37 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast, align 8
  %lookup30 = getelementptr inbounds %struct._CdisplayContrast, %struct._CdisplayContrast* %37, i32 0, i32 2
...
; Function Attrs: nounwind uwtable
define internal %struct._GtkWidget* @cdisplay_contrast_configure(%struct._GimpColorDisplay* %display) #0 {
entry:
  %display.addr = alloca %struct._GimpColorDisplay*, align 8
  %contrast = alloca %struct._CdisplayContrast*, align 8
  ...
  %call3 = call i8* @dgettext(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.14, i32 0, i32 0)) #4
  ...
  %8 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast, align 8
  %9 = bitcast %struct._CdisplayContrast* %8 to %struct._GTypeInstance*
  ...
  %call8 = call %struct._GtkWidget* @gimp_prop_spin_button_new(%struct._GObject* %10, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0), double 1.000000e-01, double 1.000000e+00, i32 3)
...
; Function Attrs: nounwind uwtable
define internal void @cdisplay_contrast_set_contrast(%struct._CdisplayContrast* %contrast, double %value) #0 {
entry:
  %contrast.addr = alloca %struct._CdisplayContrast*, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %2 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast.addr, align 8
  %contrast1 = getelementptr inbounds %struct._CdisplayContrast, %struct._CdisplayContrast* %2, i32 0, i32 1
  %3 = load double, double* %contrast1, align 8
  %cmp2 = fcmp une double %1, %3
  br i1 %cmp2, label %if.then.3, label %if.end.14

if.then.3:                                        ; preds = %if.end
  %4 = load double, double* %value.addr, align 8
  %5 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast.addr, align 8
  %contrast4 = getelementptr inbounds %struct._CdisplayContrast, %struct._CdisplayContrast* %5, i32 0, i32 1
  store double %4, double* %contrast4, align 8
...
for.body:                                         ; preds = %for.cond
  ...
  %mul6 = fmul double %mul, 0x400921FB54442D18
  %8 = load i32, i32* %i, align 4
  %conv = sitofp i32 %8 to double
  %mul7 = fmul double %mul6, %conv
  %div = fdiv double %mul7, 2.550000e+02
  %call = call double @sin(double %div) #4
  %add = fadd double 1.000000e+00, %call
  %mul8 = fmul double 1.275000e+02, %add
  %conv9 = fptosi double %mul8 to i32
  %conv10 = trunc i32 %conv9 to i8
  %9 = load i32, i32* %i, align 4
  %idxprom = sext i32 %9 to i64
  %10 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast.addr, align 8
  %lookup = getelementptr inbounds %struct._CdisplayContrast, %struct._CdisplayContrast* %10, i32 0, i32 2
...
for.end:                                          ; preds = %for.cond
  %12 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast.addr, align 8
  %13 = bitcast %struct._CdisplayContrast* %12 to %struct._GTypeInstance*
  ...
  call void @g_object_notify(%struct._GObject* %14, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0))
  %15 = load %struct._CdisplayContrast*, %struct._CdisplayContrast** %contrast.addr, align 8
  %16 = bitcast %struct._CdisplayContrast* %15 to %struct._GTypeInstance*
  %call12 = call i64 @gimp_color_display_get_type() #5
  %call13 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %16, i64 %call12)
  %17 = bitcast %struct._GTypeInstance* %call13 to %struct._GimpColorDisplay*
  call void @gimp_color_display_changed(%struct._GimpColorDisplay* %17)
  br label %if.end.14
