; ModuleID = './plug-ins/imagemap/imap_cmd_select_prev.bc'
...
%struct.SelectPrevCommand_t = type { %struct.Command_t, %struct.ObjectList_t* }
...
@.str = private unnamed_addr constant [16 x i8] c"Select Previous\00", align 1
@select_prev_command_class = internal global %struct.CommandClass_t { void (%struct.Command_t*)* null, i32 (%struct.Command_t*)* @select_prev_command_execute, void (%struct.Command_t*)* null, void (%struct.Command_t*)* null }, align 8

; Function Attrs: nounwind uwtable
define %struct.Command_t* @select_prev_command_new(%struct.ObjectList_t* %list) #0 {
entry:
  %list.addr = alloca %struct.ObjectList_t*, align 8
  %command = alloca %struct.SelectPrevCommand_t*, align 8
  store %struct.ObjectList_t* %list, %struct.ObjectList_t** %list.addr, align 8
  %call = call noalias i8* @g_malloc_n(i64 1, i64 40)
  %0 = bitcast i8* %call to %struct.SelectPrevCommand_t*
  store %struct.SelectPrevCommand_t* %0, %struct.SelectPrevCommand_t** %command, align 8
  %1 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list.addr, align 8
  %2 = load %struct.SelectPrevCommand_t*, %struct.SelectPrevCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.SelectPrevCommand_t, %struct.SelectPrevCommand_t* %2, i32 0, i32 1
  store %struct.ObjectList_t* %1, %struct.ObjectList_t** %list1, align 8
  %3 = load %struct.SelectPrevCommand_t*, %struct.SelectPrevCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.SelectPrevCommand_t, %struct.SelectPrevCommand_t* %3, i32 0, i32 0
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0)) #3
  %call3 = call %struct.Command_t* @command_init(%struct.Command_t* %parent, i8* %call2, %struct.CommandClass_t* @select_prev_command_class)
...
; Function Attrs: nounwind uwtable
define internal i32 @select_prev_command_execute(%struct.Command_t* %parent) #0 {
entry:
  ...
  %1 = bitcast %struct.Command_t* %0 to %struct.SelectPrevCommand_t*
  store %struct.SelectPrevCommand_t* %1, %struct.SelectPrevCommand_t** %command, align 8
  %2 = load %struct.SelectPrevCommand_t*, %struct.SelectPrevCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.SelectPrevCommand_t, %struct.SelectPrevCommand_t* %2, i32 0, i32 1
  %3 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list1, align 8
  store %struct.ObjectList_t* %3, %struct.ObjectList_t** %list, align 8
  %4 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list, align 8
  %5 = load %struct.SelectPrevCommand_t*, %struct.SelectPrevCommand_t** %command, align 8
  %6 = bitcast %struct.SelectPrevCommand_t* %5 to i8*
  %call = call i8* @object_list_add_select_cb(%struct.ObjectList_t* %4, void (%struct.Object_t*, i8*)* @select_one_object, i8* %6)
  store i8* %call, i8** %id, align 8
  %7 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list, align 8
  call void @object_list_select_prev(%struct.ObjectList_t* %7)
  %8 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list, align 8
  %9 = load i8*, i8** %id, align 8
  call void @object_list_remove_select_cb(%struct.ObjectList_t* %8, i8* %9)
  ret i32 0
}
...
entry:
  ...
  %1 = bitcast i8* %0 to %struct.SelectPrevCommand_t*
  store %struct.SelectPrevCommand_t* %1, %struct.SelectPrevCommand_t** %command, align 8
  %2 = load %struct.Object_t*, %struct.Object_t** %obj.addr, align 8
  %selected = getelementptr inbounds %struct.Object_t, %struct.Object_t* %2, i32 0, i32 3
  %3 = load i32, i32* %selected, align 4
  %tobool = icmp ne i32 %3, 0
  br i1 %tobool, label %cond.true, label %cond.false

cond.true:                                        ; preds = %entry
  %4 = load %struct.Object_t*, %struct.Object_t** %obj.addr, align 8
  %call = call %struct.Command_t* @select_command_new(%struct.Object_t* %4)
  br label %cond.end

cond.false:                                       ; preds = %entry
  %5 = load %struct.Object_t*, %struct.Object_t** %obj.addr, align 8
  %call1 = call %struct.Command_t* @unselect_command_new(%struct.Object_t* %5)
  br label %cond.end

cond.end:                                         ; preds = %cond.false, %cond.true
  %cond = phi %struct.Command_t* [ %call, %cond.true ], [ %call1, %cond.false ]
  store %struct.Command_t* %cond, %struct.Command_t** %sub_command, align 8
  %6 = load %struct.SelectPrevCommand_t*, %struct.SelectPrevCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.SelectPrevCommand_t, %struct.SelectPrevCommand_t* %6, i32 0, i32 0
  %7 = load %struct.Command_t*, %struct.Command_t** %sub_command, align 8
  call void @command_add_subcommand(%struct.Command_t* %parent, %struct.Command_t* %7)
  ret void
}

declare void @object_list_select_prev(%struct.ObjectList_t*) #1
