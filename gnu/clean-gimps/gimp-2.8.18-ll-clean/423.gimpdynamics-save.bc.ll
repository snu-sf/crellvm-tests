; ModuleID = './app/core/gimpdynamics-save.bc'
...
@__func__.gimp_dynamics_save = private unnamed_addr constant [19 x i8] c"gimp_dynamics_save\00", align 1
@.str.1 = private unnamed_addr constant [24 x i8] c"GIMP_IS_DYNAMICS (data)\00", align 1
@.str.2 = private unnamed_addr constant [32 x i8] c"error == NULL || *error == NULL\00", align 1
@.str.3 = private unnamed_addr constant [19 x i8] c"GIMP dynamics file\00", align 1
@.str.4 = private unnamed_addr constant [26 x i8] c"end of GIMP dynamics file\00", align 1

; Function Attrs: nounwind uwtable
define i32 @gimp_dynamics_save(%struct._GimpData* %data, %struct._GError** %error) #0 {
entry:
...
do.body:                                          ; preds = %entry
  ...
  %call = call i64 @gimp_dynamics_get_type() #4
...
if.else.9:                                        ; preds = %if.end.6
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.gimp_dynamics_save, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i32 0, i32 0))
...
if.else.15:                                       ; preds = %lor.lhs.false
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([19 x i8], [19 x i8]* @__func__.gimp_dynamics_save, i32 0, i32 0), i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.2, i32 0, i32 0))
  store i32 0, i32* %retval
  br label %return
...
do.end.17:                                        ; preds = %if.end.16
  ...
  %call21 = call i32 @gimp_config_serialize_to_file(%struct._GimpConfig* %18, i8* %call20, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.4, i32 0, i32 0), i8* null, %struct._GError** %20)
...
declare i64 @gimp_dynamics_get_type() #1
