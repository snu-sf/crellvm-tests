; ModuleID = './app/gegl/gimpoperationvaluemode.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpOperationValueModeClass = type { %struct._GimpOperationPointLayerModeClass }
...
%struct._GimpOperationValueMode = type { %struct._GimpOperationPointLayerMode }
...
@gimp_operation_value_mode_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [23 x i8] c"GimpOperationValueMode\00", align 1
@gimp_operation_value_mode_parent_class = internal global i8* null, align 8
@GimpOperationValueMode_private_offset = internal global i32 0, align 4
@.str.1 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@.str.2 = private unnamed_addr constant [16 x i8] c"gimp:value-mode\00", align 1
@.str.3 = private unnamed_addr constant [12 x i8] c"description\00", align 1
@.str.4 = private unnamed_addr constant [26 x i8] c"GIMP value mode operation\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_operation_value_mode_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_operation_value_mode_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_operation_value_mode_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 400, void (i8*, i8*)* bitcast (void (i8*)* @gimp_operation_value_mode_class_intern_init to void (i8*, i8*)*), i32 40, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpOperationValueMode*)* @gimp_operation_value_mode_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_operation_value_mode_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_operation_value_mode_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_operation_value_mode_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_operation_value_mode_parent_class, align 8
  %1 = load i32, i32* @GimpOperationValueMode_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpOperationValueMode_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpOperationValueModeClass*
  call void @gimp_operation_value_mode_class_init(%struct._GimpOperationValueModeClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_operation_value_mode_init(%struct._GimpOperationValueMode* %self) #3 {
entry:
  %self.addr = alloca %struct._GimpOperationValueMode*, align 8
  store %struct._GimpOperationValueMode* %self, %struct._GimpOperationValueMode** %self.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_operation_value_mode_class_init(%struct._GimpOperationValueModeClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpOperationValueModeClass*, align 8
  ...
  store %struct._GimpOperationValueModeClass* %klass, %struct._GimpOperationValueModeClass** %klass.addr, align 8
  %0 = load %struct._GimpOperationValueModeClass*, %struct._GimpOperationValueModeClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpOperationValueModeClass* %0 to %struct._GTypeClass*
  ...
  %3 = load %struct._GimpOperationValueModeClass*, %struct._GimpOperationValueModeClass** %klass.addr, align 8
  %4 = bitcast %struct._GimpOperationValueModeClass* %3 to %struct._GTypeClass*
  ...
  store i32 (%struct._GeglOperation*, i8*, i8*, i8*, i64, %struct._GeglRectangle*, i32)* @gimp_operation_value_mode_process, i32 (%struct._GeglOperation*, i8*, i8*, i8*, i64, %struct._GeglRectangle*, i32)** %process, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal i32 @gimp_operation_value_mode_process(%struct._GeglOperation* %operation, i8* %in_buf, i8* %aux_buf, i8* %out_buf, i64 %samples, %struct._GeglRectangle* %roi, i32 %level) #3 {
entry:
