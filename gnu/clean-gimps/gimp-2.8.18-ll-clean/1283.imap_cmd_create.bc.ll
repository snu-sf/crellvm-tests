; ModuleID = './plug-ins/imagemap/imap_cmd_create.bc'
...
%struct.CreateCommand_t = type { %struct.Command_t, %struct.ObjectList_t*, %struct.Object_t*, i32 }

@.str = private unnamed_addr constant [7 x i8] c"Create\00", align 1
@create_command_class = internal global %struct.CommandClass_t { void (%struct.Command_t*)* @create_command_destruct, i32 (%struct.Command_t*)* @create_command_execute, void (%struct.Command_t*)* @create_command_undo, void (%struct.Command_t*)* null }, align 8

; Function Attrs: nounwind uwtable
define %struct.Command_t* @create_command_new(%struct.ObjectList_t* %list, %struct.Object_t* %obj) #0 {
entry:
  %list.addr = alloca %struct.ObjectList_t*, align 8
  %obj.addr = alloca %struct.Object_t*, align 8
  %command = alloca %struct.CreateCommand_t*, align 8
  ...
  %0 = bitcast i8* %call to %struct.CreateCommand_t*
  store %struct.CreateCommand_t* %0, %struct.CreateCommand_t** %command, align 8
  %1 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list.addr, align 8
  %2 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %2, i32 0, i32 1
  ...
  %4 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %obj3 = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %4, i32 0, i32 2
  store %struct.Object_t* %call2, %struct.Object_t** %obj3, align 8
  %5 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %5, i32 0, i32 0
  %call4 = call i8* @gettext(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str, i32 0, i32 0)) #3
  %call5 = call %struct.Command_t* @command_init(%struct.Command_t* %parent, i8* %call4, %struct.CommandClass_t* @create_command_class)
...
; Function Attrs: nounwind uwtable
define internal void @create_command_destruct(%struct.Command_t* %parent) #0 {
entry:
  ...
  %1 = bitcast %struct.Command_t* %0 to %struct.CreateCommand_t*
  store %struct.CreateCommand_t* %1, %struct.CreateCommand_t** %command, align 8
  %2 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %obj = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %2, i32 0, i32 2
...
; Function Attrs: nounwind uwtable
define internal i32 @create_command_execute(%struct.Command_t* %parent) #0 {
entry:
  %parent.addr = alloca %struct.Command_t*, align 8
  %command = alloca %struct.CreateCommand_t*, align 8
  store %struct.Command_t* %parent, %struct.Command_t** %parent.addr, align 8
  ...
  store %struct.CreateCommand_t* %1, %struct.CreateCommand_t** %command, align 8
  %2 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %list = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %2, i32 0, i32 1
  ...
  %5 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %changed1 = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %5, i32 0, i32 3
  store i32 %4, i32* %changed1, align 4
  %6 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %list2 = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %6, i32 0, i32 1
  %7 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list2, align 8
  %8 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %obj = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %8, i32 0, i32 2
  %9 = load %struct.Object_t*, %struct.Object_t** %obj, align 8
  %call = call %struct.Object_t* @object_ref(%struct.Object_t* %9)
  call void @object_list_append(%struct.ObjectList_t* %7, %struct.Object_t* %call)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define internal void @create_command_undo(%struct.Command_t* %parent) #0 {
entry:
  %parent.addr = alloca %struct.Command_t*, align 8
  %command = alloca %struct.CreateCommand_t*, align 8
  store %struct.Command_t* %parent, %struct.Command_t** %parent.addr, align 8
  ...
  %3 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list, align 8
  %4 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %obj = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %4, i32 0, i32 2
  %5 = load %struct.Object_t*, %struct.Object_t** %obj, align 8
  call void @object_list_remove(%struct.ObjectList_t* %3, %struct.Object_t* %5)
  %6 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %changed = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %6, i32 0, i32 3
  %7 = load i32, i32* %changed, align 4
  %8 = load %struct.CreateCommand_t*, %struct.CreateCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.CreateCommand_t, %struct.CreateCommand_t* %8, i32 0, i32 1
  %9 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list1, align 8
  %changed2 = getelementptr inbounds %struct.ObjectList_t, %struct.ObjectList_t* %9, i32 0, i32 1
  store i32 %7, i32* %changed2, align 4
  ret void
}
