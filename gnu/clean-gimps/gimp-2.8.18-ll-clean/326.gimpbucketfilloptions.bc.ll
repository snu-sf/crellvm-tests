; ModuleID = './app/tools/gimpbucketfilloptions.bc'
...
@gimp_bucket_fill_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [22 x i8] c"GimpBucketFillOptions\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"Fill Type  (%s)\00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c"fill-mode\00", align 1
@.str.3 = private unnamed_addr constant [18 x i8] c"pattern-view-type\00", align 1
@.str.4 = private unnamed_addr constant [18 x i8] c"pattern-view-size\00", align 1
@.str.5 = private unnamed_addr constant [20 x i8] c"Affected Area  (%s)\00", align 1
@.str.6 = private unnamed_addr constant [15 x i8] c"fill-selection\00", align 1
@.str.7 = private unnamed_addr constant [21 x i8] c"Fill whole selection\00", align 1
@.str.8 = private unnamed_addr constant [20 x i8] c"Fill similar colors\00", align 1
@.str.9 = private unnamed_addr constant [13 x i8] c"radio-button\00", align 1
@.str.10 = private unnamed_addr constant [23 x i8] c"Finding Similar Colors\00", align 1
@.str.11 = private unnamed_addr constant [10 x i8] c"sensitive\00", align 1
@.str.12 = private unnamed_addr constant [17 x i8] c"fill-transparent\00", align 1
@.str.13 = private unnamed_addr constant [23 x i8] c"Fill transparent areas\00", align 1
@.str.14 = private unnamed_addr constant [14 x i8] c"sample-merged\00", align 1
@.str.15 = private unnamed_addr constant [14 x i8] c"Sample merged\00", align 1
...
@.str.18 = private unnamed_addr constant [15 x i8] c"fill-criterion\00", align 1
@.str.19 = private unnamed_addr constant [9 x i8] c"Fill by:\00", align 1
@gimp_bucket_fill_options_parent_class = internal global i8* null, align 8
@GimpBucketFillOptions_private_offset = internal global i32 0, align 4
@.str.20 = private unnamed_addr constant [26 x i8] c"Which area will be filled\00", align 1
@.str.21 = private unnamed_addr constant [50 x i8] c"Allow completely transparent regions to be filled\00", align 1
@.str.22 = private unnamed_addr constant [39 x i8] c"Base filled area on all visible layers\00", align 1
@.str.23 = private unnamed_addr constant [25 x i8] c"Maximum color difference\00", align 1
@.str.24 = private unnamed_addr constant [48 x i8] c"Criterion used for determining color similarity\00", align 1
@.str.25 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.26 = private unnamed_addr constant [24 x i8] c"gimpbucketfilloptions.c\00", align 1
@.str.27 = private unnamed_addr constant [9 x i8] c"property\00", align 1
@.str.28 = private unnamed_addr constant [11 x i8] c"Gimp-Tools\00", align 1
@g_param_spec_types = external global i64*, align 8

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_bucket_fill_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_bucket_fill_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_bucket_fill_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_bucket_fill_options_class_intern_init to void (i8*, i8*)*), i32 504, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpBucketFillOptions*)* @gimp_bucket_fill_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_bucket_fill_options_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_bucket_fill_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_bucket_fill_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_bucket_fill_options_parent_class, align 8
  %1 = load i32, i32* @GimpBucketFillOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpBucketFillOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpPaintOptionsClass*
  call void @gimp_bucket_fill_options_class_init(%struct._GimpPaintOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_bucket_fill_options_init(%struct._GimpBucketFillOptions* %options) #3 {
entry:
  %options.addr = alloca %struct._GimpBucketFillOptions*, align 8
  store %struct._GimpBucketFillOptions* %options, %struct._GimpBucketFillOptions** %options.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_bucket_fill_options_gui(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  ...
  %call3 = call i8* @gettext(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0)) #5
  ...
  %call6 = call %struct._GtkWidget* @gimp_prop_enum_radio_frame_new(%struct._GObject* %5, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i32 0, i32 0), i8* %6, i32 0, i32 0)
  ...
  %call9 = call i64 @gimp_context_get_type() #6
  ...
  %call11 = call %struct._GtkWidget* @gimp_prop_pattern_box_new(%struct._GimpContainer* null, %struct._GimpContext* %15, i8* null, i32 2, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.4, i32 0, i32 0))
  ...
  call void @gimp_enum_radio_frame_add(%struct._GtkFrame* %18, %struct._GtkWidget* %19, i32 2, i32 1)
  %call14 = call i8* @gettext(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.5, i32 0, i32 0)) #5
  %call15 = call i8* @gimp_get_mod_string(i32 1)
  %call16 = call noalias i8* (i8*, ...) @g_strdup_printf(i8* %call14, i8* %call15)
  store i8* %call16, i8** %str, align 8
  %20 = load %struct._GObject*, %struct._GObject** %config, align 8
  %21 = load i8*, i8** %str, align 8
  %call17 = call i8* @gettext(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.7, i32 0, i32 0)) #5
  %call18 = call i8* @gettext(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.8, i32 0, i32 0)) #5
  %call19 = call %struct._GtkWidget* @gimp_prop_boolean_radio_frame_new(%struct._GObject* %20, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.6, i32 0, i32 0), i8* %21, i8* %call17, i8* %call18)
  ...
  %call26 = call i8* @g_object_get_data(%struct._GObject* %30, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.9, i32 0, i32 0))
  %31 = bitcast i8* %call26 to %struct._GtkWidget*
  call void @gtk_box_reorder_child(%struct._GtkBox* %27, %struct._GtkWidget* %31, i32 1)
  ...
  %call29 = call i8* @gettext(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.10, i32 0, i32 0)) #5
  ...
  %call33 = call %struct._GBinding* @g_object_bind_property(i8* %43, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.6, i32 0, i32 0), i8* %45, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.11, i32 0, i32 0), i32 6)
  %call34 = call %struct._GtkWidget* @gtk_box_new(i32 1, i32 0)
  store %struct._GtkWidget* %call34, %struct._GtkWidget** %vbox2, align 8
  %46 = load %struct._GtkWidget*, %struct._GtkWidget** %frame, align 8
  %47 = bitcast %struct._GtkWidget* %46 to %struct._GTypeInstance*
  %call35 = call i64 @gtk_container_get_type() #6
  %call36 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %47, i64 %call35)
  %48 = bitcast %struct._GTypeInstance* %call36 to %struct._GtkContainer*
  ...
  %call37 = call i8* @gettext(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.13, i32 0, i32 0)) #5
  %call38 = call %struct._GtkWidget* @gimp_prop_check_button_new(%struct._GObject* %51, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.12, i32 0, i32 0), i8* %call37)
  ...
  %57 = load %struct._GObject*, %struct._GObject** %config, align 8
  %call41 = call i8* @gettext(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.15, i32 0, i32 0)) #5
  %call42 = call %struct._GtkWidget* @gimp_prop_check_button_new(%struct._GObject* %57, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.14, i32 0, i32 0), i8* %call41)
  store %struct._GtkWidget* %call42, %struct._GtkWidget** %button, align 8
  %58 = load %struct._GtkWidget*, %struct._GtkWidget** %vbox2, align 8
  %59 = bitcast %struct._GtkWidget* %58 to %struct._GTypeInstance*
  %call43 = call i64 @gtk_box_get_type() #6
  %call44 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %59, i64 %call43)
  %60 = bitcast %struct._GTypeInstance* %call44 to %struct._GtkBox*
  ...
  %call45 = call i8* @gettext(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.17, i32 0, i32 0)) #5
  %call46 = call %struct._GtkWidget* @gimp_prop_spin_scale_new(%struct._GObject* %63, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.16, i32 0, i32 0), i8* %call45, double 1.000000e+00, double 1.600000e+01, i32 1)
  ...
  %call49 = call %struct._GtkWidget* @gtk_table_new(i32 2, i32 3, i32 0)
  ...
  %71 = bitcast %struct._GTypeInstance* %call51 to %struct._GtkTable*
  call void @gtk_table_set_col_spacings(%struct._GtkTable* %71, i32 2)
  %72 = load %struct._GtkWidget*, %struct._GtkWidget** %vbox2, align 8
  ...
  %74 = bitcast %struct._GTypeInstance* %call53 to %struct._GtkBox*
  ...
  %call54 = call %struct._GtkWidget* @gimp_prop_enum_combo_box_new(%struct._GObject* %77, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.18, i32 0, i32 0), i32 0, i32 0)
  store %struct._GtkWidget* %call54, %struct._GtkWidget** %combo, align 8
  ...
  %call57 = call i8* @gettext(i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.19, i32 0, i32 0)) #5
  %81 = load %struct._GtkWidget*, %struct._GtkWidget** %combo, align 8
  %call58 = call %struct._GtkWidget* @gimp_table_attach_aligned(%struct._GtkTable* %80, i32 0, i32 0, i8* %call57, float 0.000000e+00, float 5.000000e-01, %struct._GtkWidget* %81, i32 2, i32 0)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_bucket_fill_options_class_init(%struct._GimpPaintOptionsClass* %klass) #3 {
entry:
  ...
  %3 = load %struct._GimpPaintOptionsClass*, %struct._GimpPaintOptionsClass** %klass.addr, align 8
  %4 = bitcast %struct._GimpPaintOptionsClass* %3 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_bucket_fill_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %7 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %7, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_bucket_fill_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  ...
  store void (%struct._GimpToolOptions*)* @gimp_bucket_fill_options_reset, void (%struct._GimpToolOptions*)** %reset, align 8
  %9 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call3 = call i64 @gimp_bucket_fill_mode_get_type() #6
  %call4 = call %struct._GParamSpec* @g_param_spec_enum(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i32 0, i32 0), i8* null, i8* null, i64 %call3, i32 0, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %9, i32 1, %struct._GParamSpec* %call4)
  %10 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call5 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.6, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.20, i32 0, i32 0), i32 0, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %10, i32 2, %struct._GParamSpec* %call5)
  %11 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call6 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.12, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.21, i32 0, i32 0), i32 1, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %11, i32 3, %struct._GParamSpec* %call6)
  %12 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call7 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.14, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([39 x i8], [39 x i8]* @.str.22, i32 0, i32 0), i32 0, i32 487)
  call void @g_object_class_install_property(%struct._GObjectClass* %12, i32 4, %struct._GParamSpec* %call7)
  %13 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call8 = call %struct._GParamSpec* @g_param_spec_double(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.16, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.23, i32 0, i32 0), double 0.000000e+00, double 2.550000e+02, double 1.500000e+01, i32 487)
  ...
  %call9 = call i64 @gimp_select_criterion_get_type() #6
  %call10 = call %struct._GParamSpec* @g_param_spec_enum(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.18, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([48 x i8], [48 x i8]* @.str.24, i32 0, i32 0), i64 %call9, i32 0, i32 487)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_bucket_fill_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  ...
  %call = call i64 @gimp_bucket_fill_options_get_type() #6
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpBucketFillOptions*
  store %struct._GimpBucketFillOptions* %2, %struct._GimpBucketFillOptions** %options, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpBucketFillOptions*, %struct._GimpBucketFillOptions** %options, align 8
  %fill_mode = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %5, i32 0, i32 1
  store i32 %call2, i32* %fill_mode, align 4
  br label %sw.epilog

sw.bb.3:                                          ; preds = %entry
  %6 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call4 = call i32 @g_value_get_boolean(%struct._GValue* %6)
  %7 = load %struct._GimpBucketFillOptions*, %struct._GimpBucketFillOptions** %options, align 8
  %fill_selection = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %7, i32 0, i32 2
  store i32 %call4, i32* %fill_selection, align 4
  br label %sw.epilog

sw.bb.5:                                          ; preds = %entry
  %8 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call6 = call i32 @g_value_get_boolean(%struct._GValue* %8)
  %9 = load %struct._GimpBucketFillOptions*, %struct._GimpBucketFillOptions** %options, align 8
  %fill_transparent = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %9, i32 0, i32 3
  store i32 %call6, i32* %fill_transparent, align 4
  br label %sw.epilog

sw.bb.7:                                          ; preds = %entry
  %10 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %call8 = call i32 @g_value_get_boolean(%struct._GValue* %10)
  %11 = load %struct._GimpBucketFillOptions*, %struct._GimpBucketFillOptions** %options, align 8
  %sample_merged = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %11, i32 0, i32 4
  store i32 %call8, i32* %sample_merged, align 4
  br label %sw.epilog
...
sw.bb.9:                                          ; preds = %entry
  ...
  %threshold = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %13, i32 0, i32 5
  store double %call10, double* %threshold, align 8
  br label %sw.epilog
...
sw.bb.11:                                         ; preds = %entry
  ...
  %fill_criterion = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %15, i32 0, i32 6
  store i32 %call12, i32* %fill_criterion, align 4
  br label %sw.epilog
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.25, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.26, i32 0, i32 0), i32 156, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.27, i32 0, i32 0), i32 %19, i8* %21, i8* %call13, i8* %call16)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_bucket_fill_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpBucketFillOptions*, %struct._GimpBucketFillOptions** %options, align 8
  %fill_mode = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %5, i32 0, i32 1
  %6 = load i32, i32* %fill_mode, align 4
...
sw.bb.2:                                          ; preds = %entry
  ...
  %fill_selection = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %8, i32 0, i32 2
  %9 = load i32, i32* %fill_selection, align 4
...
sw.bb.3:                                          ; preds = %entry
  %10 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %11 = load %struct._GimpBucketFillOptions*, %struct._GimpBucketFillOptions** %options, align 8
  %fill_transparent = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %11, i32 0, i32 3
  %12 = load i32, i32* %fill_transparent, align 4
  call void @g_value_set_boolean(%struct._GValue* %10, i32 %12)
  br label %sw.epilog

sw.bb.4:                                          ; preds = %entry
  %13 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %14 = load %struct._GimpBucketFillOptions*, %struct._GimpBucketFillOptions** %options, align 8
  %sample_merged = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %14, i32 0, i32 4
...
sw.bb.5:                                          ; preds = %entry
  ...
  %threshold = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %17, i32 0, i32 5
  %18 = load double, double* %threshold, align 8
...
sw.bb.6:                                          ; preds = %entry
  ...
  %fill_criterion = getelementptr inbounds %struct._GimpBucketFillOptions, %struct._GimpBucketFillOptions* %20, i32 0, i32 6
  %21 = load i32, i32* %fill_criterion, align 4
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.25, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.26, i32 0, i32 0), i32 191, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.27, i32 0, i32 0), i32 %25, i8* %27, i8* %call7, i8* %call10)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_bucket_fill_options_reset(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  %tool_options.addr = alloca %struct._GimpToolOptions*, align 8
  ...
  %call = call %struct._GParamSpec* @g_object_class_find_property(%struct._GObjectClass* %3, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.16, i32 0, i32 0))
...
if.then:                                          ; preds = %entry
  ...
  %default_threshold = getelementptr inbounds %struct._GimpCoreConfig, %struct._GimpCoreConfig* %8, i32 0, i32 3
  %9 = load i32, i32* %default_threshold, align 4
  ...
  %14 = bitcast %struct._GTypeInstance* %call1 to %struct._GParamSpecDouble*
  %default_value = getelementptr inbounds %struct._GParamSpecDouble, %struct._GParamSpecDouble* %14, i32 0, i32 3
  store double %conv, double* %default_value, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %15 = load i8*, i8** @gimp_bucket_fill_options_parent_class, align 8
...
entry:
  ...
  call void @g_logv(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.28, i32 0, i32 0), i32 16, i8* %0, %struct.__va_list_tag* %arraydecay2)
