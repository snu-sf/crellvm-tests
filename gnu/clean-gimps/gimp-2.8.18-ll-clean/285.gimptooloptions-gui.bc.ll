; ModuleID = './app/tools/gimptooloptions-gui.bc'
...
@__func__.gimp_tool_options_gui = private unnamed_addr constant [22 x i8] c"gimp_tool_options_gui\00", align 1
@.str.1 = private unnamed_addr constant [36 x i8] c"GIMP_IS_TOOL_OPTIONS (tool_options)\00", align 1

; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_tool_options_gui(%struct._GimpToolOptions* %tool_options) #0 {
entry:
...
do.body:                                          ; preds = %entry
  ...
  %call = call i64 @gimp_tool_options_get_type() #4
...
if.else.9:                                        ; preds = %if.end.6
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([22 x i8], [22 x i8]* @__func__.gimp_tool_options_gui, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.1, i32 0, i32 0))
...
do.end:                                           ; preds = %if.end.10
  %call11 = call %struct._GtkWidget* @gtk_box_new(i32 1, i32 4)
