; ModuleID = './app/dialogs/input-devices-dialog.bc'
...
@__func__.input_devices_dialog_new = private unnamed_addr constant [25 x i8] c"input_devices_dialog_new\00", align 1
@.str.1 = private unnamed_addr constant [20 x i8] c"GIMP_IS_GIMP (gimp)\00", align 1
@.str.2 = private unnamed_addr constant [24 x i8] c"Configure Input Devices\00", align 1
@.str.3 = private unnamed_addr constant [26 x i8] c"gimp-input-devices-dialog\00", align 1
@.str.4 = private unnamed_addr constant [24 x i8] c"gimp-help-input-devices\00", align 1
...
define %struct._GtkWidget* @input_devices_dialog_new(%struct._Gimp* %gimp) #0 {
entry:
...
if.else.9:                                        ; preds = %if.end.6
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str, i32 0, i32 0), i8* getelementptr inbounds ([25 x i8], [25 x i8]* @__func__.input_devices_dialog_new, i32 0, i32 0), i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0))
...
do.end:                                           ; preds = %if.end.10
  %call11 = call i8* @gettext(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i32 0, i32 0)) #7
  %call12 = call %struct._GtkWidget* (i8*, i8*, %struct._GtkWidget*, i32, void (i8*, i8*)*, i8*, ...) @gimp_dialog_new(i8* %call11, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i32 0, i32 0), %struct._GtkWidget* null, i32 0, void (i8*, i8*)* @gimp_standard_help_func, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.5, i32 0, i32 0), i32 -7, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.6, i32 0, i32 0), i32 -5, i8* null)
  ...
  %15 = bitcast %struct._GTypeInstance* %call14 to %struct._GtkDialog*
  call void (%struct._GtkDialog*, i32, ...) @gtk_dialog_set_alternative_button_order(%struct._GtkDialog* %15, i32 -5, i32 -7, i32 -1)
  ...
  %call15 = call i64 @g_signal_connect_data(i8* %17, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.7, i32 0, i32 0), void ()* bitcast (void (%struct._GtkWidget*, i32, %struct._Gimp*)* @input_devices_dialog_response to void ()*), i8* %19, void (i8*, %struct._GClosure*)* null, i32 0)
  ...
  %22 = bitcast %struct._GTypeInstance* %call17 to %struct._GtkDialog*
  %call18 = call %struct._GtkWidget* @gtk_dialog_get_content_area(%struct._GtkDialog* %22)
  store %struct._GtkWidget* %call18, %struct._GtkWidget** %content_area, align 8
  %23 = load %struct._Gimp*, %struct._Gimp** %gimp.addr, align 8
  %call19 = call %struct._GtkWidget* @gimp_device_editor_new(%struct._Gimp* %23)
  store %struct._GtkWidget* %call19, %struct._GtkWidget** %editor, align 8
  %24 = load %struct._GtkWidget*, %struct._GtkWidget** %editor, align 8
  ...
  %26 = bitcast %struct._GTypeInstance* %call21 to %struct._GtkContainer*
  call void @gtk_container_set_border_width(%struct._GtkContainer* %26, i32 12)
  %27 = load %struct._GtkWidget*, %struct._GtkWidget** %content_area, align 8
...
; Function Attrs: nounwind uwtable
define internal void @input_devices_dialog_response(%struct._GtkWidget* %dialog, i32 %response_id, %struct._Gimp* %gimp) #0 {
entry:
...
declare %struct._GtkWidget* @gimp_device_editor_new(%struct._Gimp*) #3
