; ModuleID = './app/tools/gimphistogramoptions.bc'
...
@gimp_histogram_options_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [21 x i8] c"GimpHistogramOptions\00", align 1
@.str.1 = private unnamed_addr constant [16 x i8] c"histogram-scale\00", align 1
@.str.2 = private unnamed_addr constant [16 x i8] c"Histogram Scale\00", align 1
@.str.3 = private unnamed_addr constant [11 x i8] c"Gimp-Tools\00", align 1
@__func__.gimp_histogram_options_connect_view = private unnamed_addr constant [36 x i8] c"gimp_histogram_options_connect_view\00", align 1
@.str.4 = private unnamed_addr constant [36 x i8] c"GIMP_IS_HISTOGRAM_OPTIONS (options)\00", align 1
@.str.5 = private unnamed_addr constant [30 x i8] c"GIMP_IS_HISTOGRAM_VIEW (view)\00", align 1
@gimp_histogram_options_parent_class = internal global i8* null, align 8
@GimpHistogramOptions_private_offset = internal global i32 0, align 4
@.str.6 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.7 = private unnamed_addr constant [23 x i8] c"gimphistogramoptions.c\00", align 1
@.str.8 = private unnamed_addr constant [9 x i8] c"property\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_histogram_options_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_histogram_options_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_histogram_options_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  %call5 = call i64 @gimp_color_options_get_type() #7
  %call6 = call i8* @g_intern_static_string(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0))
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 432, void (i8*, i8*)* bitcast (void (i8*)* @gimp_histogram_options_class_intern_init to void (i8*, i8*)*), i32 392, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpHistogramOptions*)* @gimp_histogram_options_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_histogram_options_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_histogram_options_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_histogram_options_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_histogram_options_parent_class, align 8
  %1 = load i32, i32* @GimpHistogramOptions_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpHistogramOptions_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpToolOptionsClass*
  call void @gimp_histogram_options_class_init(%struct._GimpToolOptionsClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_histogram_options_init(%struct._GimpHistogramOptions* %options) #3 {
entry:
  %options.addr = alloca %struct._GimpHistogramOptions*, align 8
  store %struct._GimpHistogramOptions* %options, %struct._GimpHistogramOptions** %options.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_histogram_options_gui(%struct._GimpToolOptions* %tool_options) #3 {
entry:
  ...
  %call3 = call %struct._GtkWidget* @gimp_prop_enum_radio_frame_new(%struct._GObject* %4, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i8* %call2, i32 0, i32 0)
...
; Function Attrs: nounwind uwtable
define void @gimp_histogram_options_connect_view(%struct._GimpHistogramOptions* %options, %struct._GimpHistogramView* %view) #3 {
entry:
  %options.addr = alloca %struct._GimpHistogramOptions*, align 8
...
do.body:                                          ; preds = %entry
  %0 = load %struct._GimpHistogramOptions*, %struct._GimpHistogramOptions** %options.addr, align 8
  %1 = bitcast %struct._GimpHistogramOptions* %0 to %struct._GTypeInstance*
  store %struct._GTypeInstance* %1, %struct._GTypeInstance** %__inst, align 8
  %call = call i64 @gimp_histogram_options_get_type() #7
...
if.else.9:                                        ; preds = %if.end.6
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__func__.gimp_histogram_options_connect_view, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.4, i32 0, i32 0))
  br label %return
...
do.body.11:                                       ; preds = %do.end
  ...
  %14 = bitcast %struct._GimpHistogramView* %13 to %struct._GTypeInstance*
  store %struct._GTypeInstance* %14, %struct._GTypeInstance** %__inst13, align 8
  %call16 = call i64 @gimp_histogram_view_get_type() #7
...
if.else.36:                                       ; preds = %if.end.32
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([36 x i8], [36 x i8]* @__func__.gimp_histogram_options_connect_view, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.5, i32 0, i32 0))
  br label %return
...
do.end.38:                                        ; preds = %if.end.37
  %26 = load %struct._GimpHistogramOptions*, %struct._GimpHistogramOptions** %options.addr, align 8
  %27 = bitcast %struct._GimpHistogramOptions* %26 to %struct._GTypeInstance*
  ...
  %30 = bitcast %struct._GimpHistogramView* %29 to %struct._GTypeInstance*
  %call40 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %30, i64 80)
  %31 = bitcast %struct._GTypeInstance* %call40 to %struct._GObject*
  call void @gimp_config_connect(%struct._GObject* %28, %struct._GObject* %31, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0))
  %32 = load %struct._GimpHistogramOptions*, %struct._GimpHistogramOptions** %options.addr, align 8
  %33 = bitcast %struct._GimpHistogramOptions* %32 to %struct._GTypeInstance*
  %call41 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %33, i64 80)
  %34 = bitcast %struct._GTypeInstance* %call41 to %struct._GObject*
  call void @g_object_notify(%struct._GObject* %34, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0))
  br label %return
...
; Function Attrs: nounwind uwtable
define internal void @gimp_histogram_options_class_init(%struct._GimpToolOptionsClass* %klass) #3 {
entry:
  ...
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_histogram_options_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %4 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %4, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_histogram_options_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %5 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call1 = call i64 @gimp_histogram_scale_get_type() #7
  %call2 = call %struct._GParamSpec* @g_param_spec_enum(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.1, i32 0, i32 0), i8* null, i8* null, i64 %call1, i32 0, i32 487)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_histogram_options_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
  %pspec.addr = alloca %struct._GParamSpec*, align 8
  %options = alloca %struct._GimpHistogramOptions*, align 8
  ...
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpHistogramOptions*
  store %struct._GimpHistogramOptions* %2, %struct._GimpHistogramOptions** %options, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpHistogramOptions*, %struct._GimpHistogramOptions** %options, align 8
  %scale = getelementptr inbounds %struct._GimpHistogramOptions, %struct._GimpHistogramOptions* %5, i32 0, i32 1
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i32 0, i32 0), i32 93, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.8, i32 0, i32 0), i32 %9, i8* %11, i8* %call3, i8* %call6)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_histogram_options_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.7, i32 0, i32 0), i32 113, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.8, i32 0, i32 0), i32 %10, i8* %12, i8* %call2, i8* %call5)
  br label %do.end
...
entry:
  ...
  call void @g_logv(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i32 16, i8* %0, %struct.__va_list_tag* %arraydecay2)
