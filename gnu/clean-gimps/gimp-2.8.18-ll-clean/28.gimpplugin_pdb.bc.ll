; ModuleID = './libgimp/gimpplugin_pdb.bc'
...
@.str = private unnamed_addr constant [28 x i8] c"gimp-plugin-domain-register\00", align 1
@.str.1 = private unnamed_addr constant [26 x i8] c"gimp-plugin-help-register\00", align 1
@.str.2 = private unnamed_addr constant [26 x i8] c"gimp-plugin-menu-register\00", align 1
@.str.3 = private unnamed_addr constant [33 x i8] c"gimp-plugin-menu-branch-register\00", align 1
@.str.4 = private unnamed_addr constant [26 x i8] c"gimp-plugin-icon-register\00", align 1
@.str.5 = private unnamed_addr constant [34 x i8] c"gimp-plugin-set-pdb-error-handler\00", align 1
@.str.6 = private unnamed_addr constant [34 x i8] c"gimp-plugin-get-pdb-error-handler\00", align 1

; Function Attrs: nounwind uwtable
define i32 @gimp_plugin_domain_register(i8* %domain_name, i8* %domain_path) #0 {
entry:
  ...
  %1 = load i8*, i8** %domain_path.addr, align 8
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([28 x i8], [28 x i8]* @.str, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 4, i8* %1, i32 22)
...
; Function Attrs: nounwind uwtable
define i32 @gimp_plugin_help_register(i8* %domain_name, i8* %domain_uri) #0 {
entry:
  %domain_name.addr = alloca i8*, align 8
  ...
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 4, i8* %1, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
  %2 = load %struct._GimpParam*, %struct._GimpParam** %return_vals, align 8
  %arrayidx = getelementptr inbounds %struct._GimpParam, %struct._GimpParam* %2, i64 0
  %data = getelementptr inbounds %struct._GimpParam, %struct._GimpParam* %arrayidx, i32 0, i32 1
...
; Function Attrs: nounwind uwtable
define i32 @gimp_plugin_menu_register(i8* %procedure_name, i8* %menu_path) #0 {
entry:
  ...
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.2, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 4, i8* %1, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
  %2 = load %struct._GimpParam*, %struct._GimpParam** %return_vals, align 8
  %arrayidx = getelementptr inbounds %struct._GimpParam, %struct._GimpParam* %2, i64 0
  %data = getelementptr inbounds %struct._GimpParam, %struct._GimpParam* %arrayidx, i32 0, i32 1
...
; Function Attrs: nounwind uwtable
define i32 @gimp_plugin_menu_branch_register(i8* %menu_path, i8* %menu_name) #0 {
entry:
  %menu_path.addr = alloca i8*, align 8
  %menu_name.addr = alloca i8*, align 8
  %return_vals = alloca %struct._GimpParam*, align 8
  %nreturn_vals = alloca i32, align 4
  %success = alloca i32, align 4
  store i8* %menu_path, i8** %menu_path.addr, align 8
  store i8* %menu_name, i8** %menu_name.addr, align 8
  store i32 1, i32* %success, align 4
  %0 = load i8*, i8** %menu_path.addr, align 8
  %1 = load i8*, i8** %menu_name.addr, align 8
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.3, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 4, i8* %1, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
  %2 = load %struct._GimpParam*, %struct._GimpParam** %return_vals, align 8
  %arrayidx = getelementptr inbounds %struct._GimpParam, %struct._GimpParam* %2, i64 0
  %data = getelementptr inbounds %struct._GimpParam, %struct._GimpParam* %arrayidx, i32 0, i32 1
...
; Function Attrs: nounwind uwtable
define hidden i32 @_gimp_plugin_icon_register(i8* %procedure_name, i32 %icon_type, i32 %icon_data_length, i8* %icon_data) #0 {
entry:
  %procedure_name.addr = alloca i8*, align 8
  ...
  store i32 1, i32* %success, align 4
  %0 = load i8*, i8** %procedure_name.addr, align 8
  %1 = load i32, i32* %icon_type.addr, align 4
  %2 = load i32, i32* %icon_data_length.addr, align 4
  %3 = load i8*, i8** %icon_data.addr, align 8
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.4, i32 0, i32 0), i32* %nreturn_vals, i32 4, i8* %0, i32 0, i32 %1, i32 0, i32 %2, i32 7, i8* %3, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
  %4 = load %struct._GimpParam*, %struct._GimpParam** %return_vals, align 8
...
; Function Attrs: nounwind uwtable
define i32 @gimp_plugin_set_pdb_error_handler(i32 %handler) #0 {
entry:
  ...
  store i32 1, i32* %success, align 4
  %0 = load i32, i32* %handler.addr, align 4
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.5, i32 0, i32 0), i32* %nreturn_vals, i32 0, i32 %0, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
...
; Function Attrs: nounwind uwtable
define i32 @gimp_plugin_get_pdb_error_handler() #0 {
entry:
  %return_vals = alloca %struct._GimpParam*, align 8
  %nreturn_vals = alloca i32, align 4
  %handler = alloca i32, align 4
  store i32 0, i32* %handler, align 4
  %call = call %struct._GimpParam* (i8*, i32*, ...) @gimp_run_procedure(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.6, i32 0, i32 0), i32* %nreturn_vals, i32 22)
  store %struct._GimpParam* %call, %struct._GimpParam** %return_vals, align 8
...
if.then:                                          ; preds = %entry
  ...
  store i32 %3, i32* %handler, align 4
  br label %if.end
