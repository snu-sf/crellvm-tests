; ModuleID = './app/gegl/gimpoperationtilesource.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpOperationTileSourceClass = type { %struct._GeglOperationSourceClass }
...
%struct._GimpOperationTileSource = type { %struct._GeglOperationSource, %struct._TileManager*, i32 }
...
@gimp_operation_tile_source_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [24 x i8] c"GimpOperationTileSource\00", align 1
@gimp_operation_tile_source_parent_class = internal global i8* null, align 8
@GimpOperationTileSource_private_offset = internal global i32 0, align 4
@.str.1 = private unnamed_addr constant [5 x i8] c"name\00", align 1
@.str.2 = private unnamed_addr constant [24 x i8] c"gimp:tilemanager-source\00", align 1
...
@.str.6 = private unnamed_addr constant [24 x i8] c"GIMP TileManager source\00", align 1
@.str.7 = private unnamed_addr constant [13 x i8] c"tile-manager\00", align 1
@.str.8 = private unnamed_addr constant [13 x i8] c"Tile Manager\00", align 1
@.str.9 = private unnamed_addr constant [34 x i8] c"The tile manager to use as source\00", align 1
@.str.10 = private unnamed_addr constant [7 x i8] c"linear\00", align 1
@.str.11 = private unnamed_addr constant [12 x i8] c"Linear data\00", align 1
@.str.12 = private unnamed_addr constant [84 x i8] c"Should the data read from the tile-manager assumed to be linear or gamma-corrected?\00", align 1
@.str.13 = private unnamed_addr constant [54 x i8] c"%s:%u: invalid %s id %u for \22%s\22 of type '%s' in '%s'\00", align 1
@.str.14 = private unnamed_addr constant [26 x i8] c"gimpoperationtilesource.c\00", align 1
@.str.15 = private unnamed_addr constant [9 x i8] c"property\00", align 1
@.str.16 = private unnamed_addr constant [10 x i8] c"Gimp-GEGL\00", align 1
@.str.17 = private unnamed_addr constant [7 x i8] c"output\00", align 1
@.str.18 = private unnamed_addr constant [14 x i8] c"RaGaBaA float\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_operation_tile_source_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_operation_tile_source_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_operation_tile_source_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  %call5 = call i64 @gegl_operation_source_get_type() #5
  %call6 = call i8* @g_intern_static_string(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i32 0, i32 0))
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 352, void (i8*, i8*)* bitcast (void (i8*)* @gimp_operation_tile_source_class_intern_init to void (i8*, i8*)*), i32 48, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpOperationTileSource*)* @gimp_operation_tile_source_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_operation_tile_source_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_operation_tile_source_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_operation_tile_source_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_operation_tile_source_parent_class, align 8
  %1 = load i32, i32* @GimpOperationTileSource_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpOperationTileSource_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpOperationTileSourceClass*
  call void @gimp_operation_tile_source_class_init(%struct._GimpOperationTileSourceClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_operation_tile_source_init(%struct._GimpOperationTileSource* %self) #3 {
entry:
  %self.addr = alloca %struct._GimpOperationTileSource*, align 8
  store %struct._GimpOperationTileSource* %self, %struct._GimpOperationTileSource** %self.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_operation_tile_source_class_init(%struct._GimpOperationTileSourceClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpOperationTileSourceClass*, align 8
  ...
  store %struct._GimpOperationTileSourceClass* %klass, %struct._GimpOperationTileSourceClass** %klass.addr, align 8
  %0 = load %struct._GimpOperationTileSourceClass*, %struct._GimpOperationTileSourceClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpOperationTileSourceClass* %0 to %struct._GTypeClass*
  %call = call %struct._GTypeClass* @g_type_check_class_cast(%struct._GTypeClass* %1, i64 80)
  %2 = bitcast %struct._GTypeClass* %call to %struct._GObjectClass*
  store %struct._GObjectClass* %2, %struct._GObjectClass** %object_class, align 8
  %3 = load %struct._GimpOperationTileSourceClass*, %struct._GimpOperationTileSourceClass** %klass.addr, align 8
  %4 = bitcast %struct._GimpOperationTileSourceClass* %3 to %struct._GTypeClass*
  ...
  %6 = load %struct._GimpOperationTileSourceClass*, %struct._GimpOperationTileSourceClass** %klass.addr, align 8
  %7 = bitcast %struct._GimpOperationTileSourceClass* %6 to %struct._GTypeClass*
  %call3 = call i64 @gegl_operation_source_get_type() #5
  %call4 = call %struct._GTypeClass* @g_type_check_class_cast(%struct._GTypeClass* %7, i64 %call3)
  %8 = bitcast %struct._GTypeClass* %call4 to %struct._GeglOperationSourceClass*
  store %struct._GeglOperationSourceClass* %8, %struct._GeglOperationSourceClass** %source_class, align 8
  %9 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %finalize = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %9, i32 0, i32 6
  store void (%struct._GObject*)* @gimp_operation_tile_source_finalize, void (%struct._GObject*)** %finalize, align 8
  %10 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %set_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %10, i32 0, i32 3
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_operation_tile_source_set_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %set_property, align 8
  %11 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %get_property = getelementptr inbounds %struct._GObjectClass, %struct._GObjectClass* %11, i32 0, i32 4
  store void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)* @gimp_operation_tile_source_get_property, void (%struct._GObject*, i32, %struct._GValue*, %struct._GParamSpec*)** %get_property, align 8
  %12 = load %struct._GeglOperationClass*, %struct._GeglOperationClass** %operation_class, align 8
  call void (%struct._GeglOperationClass*, i8*, ...) @gegl_operation_class_set_keys(%struct._GeglOperationClass* %12, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.2, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.3, i32 0, i32 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i32 0, i32 0), i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.6, i32 0, i32 0), i8* null)
  ...
  store void (%struct._GeglOperation*)* @gimp_operation_tile_source_prepare, void (%struct._GeglOperation*)** %prepare, align 8
  %14 = load %struct._GeglOperationClass*, %struct._GeglOperationClass** %operation_class, align 8
  %get_bounding_box = getelementptr inbounds %struct._GeglOperationClass, %struct._GeglOperationClass* %14, i32 0, i32 7
  store { i64, i64 } (%struct._GeglOperation*)* @gimp_operation_tile_source_get_bounding_box, { i64, i64 } (%struct._GeglOperation*)** %get_bounding_box, align 8
  ...
  %16 = load %struct._GeglOperationSourceClass*, %struct._GeglOperationSourceClass** %source_class, align 8
  %process = getelementptr inbounds %struct._GeglOperationSourceClass, %struct._GeglOperationSourceClass* %16, i32 0, i32 1
  store i32 (%struct._GeglOperation*, %struct._GeglBuffer*, %struct._GeglRectangle*, i32)* @gimp_operation_tile_source_process, i32 (%struct._GeglOperation*, %struct._GeglBuffer*, %struct._GeglRectangle*, i32)** %process, align 8
  %17 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call5 = call i64 @gimp_tile_manager_get_type() #5
  %call6 = call %struct._GParamSpec* @g_param_spec_boxed(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.7, i32 0, i32 0), i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.8, i32 0, i32 0), i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.9, i32 0, i32 0), i64 %call5, i32 7)
  call void @g_object_class_install_property(%struct._GObjectClass* %17, i32 1, %struct._GParamSpec* %call6)
  %18 = load %struct._GObjectClass*, %struct._GObjectClass** %object_class, align 8
  %call7 = call %struct._GParamSpec* @g_param_spec_boolean(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.10, i32 0, i32 0), i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.11, i32 0, i32 0), i8* getelementptr inbounds ([84 x i8], [84 x i8]* @.str.12, i32 0, i32 0), i32 0, i32 7)
...
; Function Attrs: nounwind uwtable
define internal void @gimp_operation_tile_source_finalize(%struct._GObject* %object) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %self = alloca %struct._GimpOperationTileSource*, align 8
  store %struct._GObject* %object, %struct._GObject** %object.addr, align 8
  %0 = load %struct._GObject*, %struct._GObject** %object.addr, align 8
  %1 = bitcast %struct._GObject* %0 to %struct._GTypeInstance*
  %call = call i64 @gimp_operation_tile_source_get_type() #5
  %call1 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %1, i64 %call)
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpOperationTileSource*
  store %struct._GimpOperationTileSource* %2, %struct._GimpOperationTileSource** %self, align 8
  %3 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %3, i32 0, i32 1
  %4 = load %struct._TileManager*, %struct._TileManager** %tile_manager, align 8
  %tobool = icmp ne %struct._TileManager* %4, null
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %5 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager2 = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %5, i32 0, i32 1
  %6 = load %struct._TileManager*, %struct._TileManager** %tile_manager2, align 8
  call void @tile_manager_unref(%struct._TileManager* %6)
  %7 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager3 = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %7, i32 0, i32 1
  store %struct._TileManager* null, %struct._TileManager** %tile_manager3, align 8
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %8 = load i8*, i8** @gimp_operation_tile_source_parent_class, align 8
...
; Function Attrs: nounwind uwtable
define internal void @gimp_operation_tile_source_set_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
...
sw.bb:                                            ; preds = %entry
  %4 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %4, i32 0, i32 1
  %5 = load %struct._TileManager*, %struct._TileManager** %tile_manager, align 8
  %tobool = icmp ne %struct._TileManager* %5, null
  br i1 %tobool, label %if.then, label %if.end

if.then:                                          ; preds = %sw.bb
  %6 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager2 = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %6, i32 0, i32 1
...
if.end:                                           ; preds = %if.then, %sw.bb
  ...
  %10 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager4 = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %10, i32 0, i32 1
...
sw.bb.5:                                          ; preds = %entry
  ...
  %12 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %linear = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %12, i32 0, i32 2
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.13, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.14, i32 0, i32 0), i32 179, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.15, i32 0, i32 0), i32 %16, i8* %18, i8* %call7, i8* %call10)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_operation_tile_source_get_property(%struct._GObject* %object, i32 %property_id, %struct._GValue* %value, %struct._GParamSpec* %pspec) #3 {
entry:
  %object.addr = alloca %struct._GObject*, align 8
  %property_id.addr = alloca i32, align 4
  %value.addr = alloca %struct._GValue*, align 8
...
sw.bb:                                            ; preds = %entry
  ...
  %5 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %5, i32 0, i32 1
...
sw.bb.2:                                          ; preds = %entry
  %8 = load %struct._GValue*, %struct._GValue** %value.addr, align 8
  %9 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %linear = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %9, i32 0, i32 2
...
do.body:                                          ; preds = %sw.default
  ...
  call void (i8*, ...) @g_warning(i8* getelementptr inbounds ([54 x i8], [54 x i8]* @.str.13, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.14, i32 0, i32 0), i32 153, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.15, i32 0, i32 0), i32 %14, i8* %16, i8* %call3, i8* %call6)
  br label %do.end
...
; Function Attrs: nounwind uwtable
define internal void @gimp_operation_tile_source_prepare(%struct._GeglOperation* %operation) #3 {
entry:
...
if.then:                                          ; preds = %entry
  %5 = load %struct._GeglOperation*, %struct._GeglOperation** %operation.addr, align 8
  %call2 = call %union._Babl* @babl_format(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.18, i32 0, i32 0))
  call void @gegl_operation_set_format(%struct._GeglOperation* %5, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.17, i32 0, i32 0), %union._Babl* %call2)
  br label %if.end
...
; Function Attrs: nounwind uwtable
define internal { i64, i64 } @gimp_operation_tile_source_get_bounding_box(%struct._GeglOperation* %operation) #3 {
entry:
  ...
  %2 = bitcast %struct._GTypeInstance* %call1 to %struct._GimpOperationTileSource*
  store %struct._GimpOperationTileSource* %2, %struct._GimpOperationTileSource** %self, align 8
  %3 = bitcast %struct._GeglRectangle* %result to i8*
...
if.then:                                          ; preds = %entry
  %x = getelementptr inbounds %struct._GeglRectangle, %struct._GeglRectangle* %result, i32 0, i32 0
  store i32 0, i32* %x, align 4
  %y = getelementptr inbounds %struct._GeglRectangle, %struct._GeglRectangle* %result, i32 0, i32 1
  store i32 0, i32* %y, align 4
  %6 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager2 = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %6, i32 0, i32 1
  %7 = load %struct._TileManager*, %struct._TileManager** %tile_manager2, align 8
  %call3 = call i32 @tile_manager_width(%struct._TileManager* %7)
  %width = getelementptr inbounds %struct._GeglRectangle, %struct._GeglRectangle* %result, i32 0, i32 2
  store i32 %call3, i32* %width, align 4
  %8 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager4 = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %8, i32 0, i32 1
  %9 = load %struct._TileManager*, %struct._TileManager** %tile_manager4, align 8
  %call5 = call i32 @tile_manager_height(%struct._TileManager* %9)
  %height = getelementptr inbounds %struct._GeglRectangle, %struct._GeglRectangle* %result, i32 0, i32 3
  store i32 %call5, i32* %height, align 4
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %10 = bitcast %struct._GeglRectangle* %retval to i8*
  %11 = bitcast %struct._GeglRectangle* %result to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %10, i8* %11, i64 16, i32 4, i1 false)
  %12 = bitcast %struct._GeglRectangle* %retval to { i64, i64 }*
  %13 = load { i64, i64 }, { i64, i64 }* %12, align 4
  ret { i64, i64 } %13
}

; Function Attrs: nounwind uwtable
define internal i32 @gimp_operation_tile_source_process(%struct._GeglOperation* %operation, %struct._GeglBuffer* %output, %struct._GeglRectangle* %result, i32 %level) #3 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %7 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %linear = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %7, i32 0, i32 2
  ...
  %9 = load %struct._GimpOperationTileSource*, %struct._GimpOperationTileSource** %self, align 8
  %tile_manager5 = getelementptr inbounds %struct._GimpOperationTileSource, %struct._GimpOperationTileSource* %9, i32 0, i32 1
  ...
  call void @pixel_region_init(%struct._PixelRegion* %srcPR, %struct._TileManager* %10, i32 %12, i32 %14, i32 %16, i32 %18, i32 0)
  %call6 = call %struct._PixelRegionIterator* (i32, ...) @pixel_regions_register(i32 1, %struct._PixelRegion* %srcPR)
...
for.body:                                         ; preds = %for.cond
  ...
  %x9 = getelementptr inbounds %struct._PixelRegion, %struct._PixelRegion* %srcPR, i32 0, i32 6
  ...
  %y11 = getelementptr inbounds %struct._PixelRegion, %struct._PixelRegion* %srcPR, i32 0, i32 7
  ...
  %25 = load %struct._GeglBuffer*, %struct._GeglBuffer** %output.addr, align 8
  ...
  call void @gegl_buffer_set(%struct._GeglBuffer* %25, %struct._GeglRectangle* %rect, i32 0, %union._Babl* %26, i8* %27, i32 %28)
  br label %for.inc
...
entry:
  ...
  call void @g_logv(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.16, i32 0, i32 0), i32 16, i8* %0, %struct.__va_list_tag* %arraydecay2)
