; ModuleID = './plug-ins/imagemap/imap_cmd_clear.bc'
...
%struct.ClearCommand_t = type { %struct.Command_t, %struct.ObjectList_t* }
...
@clear_command_class = internal global %struct.CommandClass_t { void (%struct.Command_t*)* null, i32 (%struct.Command_t*)* @clear_command_execute, void (%struct.Command_t*)* null, void (%struct.Command_t*)* null }, align 8

; Function Attrs: nounwind uwtable
define %struct.Command_t* @clear_command_new(%struct.ObjectList_t* %list) #0 {
entry:
  %list.addr = alloca %struct.ObjectList_t*, align 8
  %command = alloca %struct.ClearCommand_t*, align 8
  store %struct.ObjectList_t* %list, %struct.ObjectList_t** %list.addr, align 8
  %call = call noalias i8* @g_malloc_n(i64 1, i64 40)
  %0 = bitcast i8* %call to %struct.ClearCommand_t*
  store %struct.ClearCommand_t* %0, %struct.ClearCommand_t** %command, align 8
  %1 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list.addr, align 8
  %2 = load %struct.ClearCommand_t*, %struct.ClearCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.ClearCommand_t, %struct.ClearCommand_t* %2, i32 0, i32 1
  store %struct.ObjectList_t* %1, %struct.ObjectList_t** %list1, align 8
  %3 = load %struct.ClearCommand_t*, %struct.ClearCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.ClearCommand_t, %struct.ClearCommand_t* %3, i32 0, i32 0
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str, i32 0, i32 0)) #3
  %call3 = call %struct.Command_t* @command_init(%struct.Command_t* %parent, i8* %call2, %struct.CommandClass_t* @clear_command_class)
...
; Function Attrs: nounwind uwtable
define internal i32 @clear_command_execute(%struct.Command_t* %parent) #0 {
entry:
  ...
  %1 = bitcast %struct.Command_t* %0 to %struct.ClearCommand_t*
  store %struct.ClearCommand_t* %1, %struct.ClearCommand_t** %command, align 8
  %2 = load %struct.ClearCommand_t*, %struct.ClearCommand_t** %command, align 8
  %list = getelementptr inbounds %struct.ClearCommand_t, %struct.ClearCommand_t* %2, i32 0, i32 1
  %3 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list, align 8
  %4 = load %struct.ClearCommand_t*, %struct.ClearCommand_t** %command, align 8
  %5 = bitcast %struct.ClearCommand_t* %4 to i8*
  ...
  %6 = load %struct.ClearCommand_t*, %struct.ClearCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.ClearCommand_t, %struct.ClearCommand_t* %6, i32 0, i32 1
  %7 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list1, align 8
  call void @object_list_delete_selected(%struct.ObjectList_t* %7)
  %8 = load %struct.ClearCommand_t*, %struct.ClearCommand_t** %command, align 8
  %list2 = getelementptr inbounds %struct.ClearCommand_t, %struct.ClearCommand_t* %8, i32 0, i32 1
  %9 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list2, align 8
  %10 = load i8*, i8** %id, align 8
  call void @object_list_remove_remove_cb(%struct.ObjectList_t* %9, i8* %10)
  ret i32 0
}
...
entry:
  ...
  %1 = bitcast i8* %0 to %struct.ClearCommand_t*
  store %struct.ClearCommand_t* %1, %struct.ClearCommand_t** %command, align 8
  %2 = load %struct.ClearCommand_t*, %struct.ClearCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.ClearCommand_t, %struct.ClearCommand_t* %2, i32 0, i32 0
  %3 = load %struct.ClearCommand_t*, %struct.ClearCommand_t** %command, align 8
  %list = getelementptr inbounds %struct.ClearCommand_t, %struct.ClearCommand_t* %3, i32 0, i32 1
...
declare void @object_list_delete_selected(%struct.ObjectList_t*) #1
