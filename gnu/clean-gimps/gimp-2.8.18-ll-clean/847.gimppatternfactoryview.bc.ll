; ModuleID = './app/widgets/gimppatternfactoryview.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpPatternFactoryViewClass = type { %struct._GimpDataFactoryViewClass }
...
%struct._GimpPatternFactoryView = type { %struct._GimpDataFactoryView }
...
@gimp_pattern_factory_view_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [23 x i8] c"GimpPatternFactoryView\00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"Gimp-Widgets\00", align 1
@__func__.gimp_pattern_factory_view_new = private unnamed_addr constant [30 x i8] c"gimp_pattern_factory_view_new\00", align 1
...
@.str.14 = private unnamed_addr constant [11 x i8] c"<Patterns>\00", align 1
@.str.15 = private unnamed_addr constant [8 x i8] c"ui-path\00", align 1
@.str.16 = private unnamed_addr constant [16 x i8] c"/patterns-popup\00", align 1
@.str.17 = private unnamed_addr constant [13 x i8] c"action-group\00", align 1
@.str.18 = private unnamed_addr constant [9 x i8] c"patterns\00", align 1
@.str.19 = private unnamed_addr constant [23 x i8] c"patterns-open-as-image\00", align 1
@gimp_pattern_factory_view_parent_class = internal global i8* null, align 8
@GimpPatternFactoryView_private_offset = internal global i32 0, align 4

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_pattern_factory_view_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_pattern_factory_view_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_pattern_factory_view_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  %call5 = call i64 @gimp_data_factory_view_get_type() #5
  %call6 = call i8* @g_intern_static_string(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str, i32 0, i32 0))
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 848, void (i8*, i8*)* bitcast (void (i8*)* @gimp_pattern_factory_view_class_intern_init to void (i8*, i8*)*), i32 152, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpPatternFactoryView*)* @gimp_pattern_factory_view_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_pattern_factory_view_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_pattern_factory_view_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_pattern_factory_view_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_pattern_factory_view_parent_class, align 8
  %1 = load i32, i32* @GimpPatternFactoryView_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpPatternFactoryView_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpPatternFactoryViewClass*
  call void @gimp_pattern_factory_view_class_init(%struct._GimpPatternFactoryViewClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_pattern_factory_view_init(%struct._GimpPatternFactoryView* %view) #3 {
entry:
  %view.addr = alloca %struct._GimpPatternFactoryView*, align 8
  store %struct._GimpPatternFactoryView* %view, %struct._GimpPatternFactoryView** %view.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_pattern_factory_view_new(i32 %view_type, %struct._GimpDataFactory* %factory, %struct._GimpContext* %context, i32 %view_size, i32 %view_border_width, %struct._GimpMenuFactory* %menu_factory) #3 {
entry:
  ...
  %factory_view = alloca %struct._GimpPatternFactoryView*, align 8
...
if.else.9:                                        ; preds = %if.end.6
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__func__.gimp_pattern_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0))
...
if.else.36:                                       ; preds = %if.end.32
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__func__.gimp_pattern_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.44:                                       ; preds = %land.lhs.true.41, %do.body.39
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__func__.gimp_pattern_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.4, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.52:                                       ; preds = %land.lhs.true.49, %do.body.47
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__func__.gimp_pattern_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str.5, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.81:                                       ; preds = %if.end.77
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([30 x i8], [30 x i8]* @__func__.gimp_pattern_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.6, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
do.end.83:                                        ; preds = %if.end.82
  %call84 = call i64 @gimp_pattern_factory_view_get_type() #5
  ...
  %50 = bitcast i8* %call85 to %struct._GimpPatternFactoryView*
  store %struct._GimpPatternFactoryView* %50, %struct._GimpPatternFactoryView** %factory_view, align 8
  %51 = load %struct._GimpPatternFactoryView*, %struct._GimpPatternFactoryView** %factory_view, align 8
  %52 = bitcast %struct._GimpPatternFactoryView* %51 to %struct._GTypeInstance*
  ...
  %call90 = call %struct._GtkWidget* (%struct._GimpEditor*, i8*, i8*, ...) @gimp_editor_add_action_button(%struct._GimpEditor* %57, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.18, i32 0, i32 0), i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.19, i32 0, i32 0), i8* null)
  %58 = load %struct._GimpPatternFactoryView*, %struct._GimpPatternFactoryView** %factory_view, align 8
  %59 = bitcast %struct._GimpPatternFactoryView* %58 to %struct._GTypeInstance*
  %call91 = call i64 @gimp_data_factory_view_get_type() #5
  %call92 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %59, i64 %call91)
  %60 = bitcast %struct._GTypeInstance* %call92 to %struct._GimpDataFactoryView*
  %call93 = call %struct._GtkWidget* @gimp_data_factory_view_get_edit_button(%struct._GimpDataFactoryView* %60)
  call void @gtk_widget_hide(%struct._GtkWidget* %call93)
  %61 = load %struct._GimpPatternFactoryView*, %struct._GimpPatternFactoryView** %factory_view, align 8
  %62 = bitcast %struct._GimpPatternFactoryView* %61 to %struct._GTypeInstance*
  %call94 = call i64 @gimp_data_factory_view_get_type() #5
  %call95 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %62, i64 %call94)
  %63 = bitcast %struct._GTypeInstance* %call95 to %struct._GimpDataFactoryView*
  %call96 = call %struct._GtkWidget* @gimp_data_factory_view_get_duplicate_button(%struct._GimpDataFactoryView* %63)
  call void @gtk_widget_hide(%struct._GtkWidget* %call96)
  %64 = load %struct._GimpPatternFactoryView*, %struct._GimpPatternFactoryView** %factory_view, align 8
  %65 = bitcast %struct._GimpPatternFactoryView* %64 to %struct._GTypeInstance*
  %call97 = call i64 @gtk_widget_get_type() #5
  %call98 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %65, i64 %call97)
  %66 = bitcast %struct._GTypeInstance* %call98 to %struct._GtkWidget*
...
declare %struct._GtkWidget* @gimp_data_factory_view_get_duplicate_button(%struct._GimpDataFactoryView*) #1
...
; Function Attrs: nounwind uwtable
define internal void @gimp_pattern_factory_view_class_init(%struct._GimpPatternFactoryViewClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpPatternFactoryViewClass*, align 8
  store %struct._GimpPatternFactoryViewClass* %klass, %struct._GimpPatternFactoryViewClass** %klass.addr, align 8
  ret void
}
