; ModuleID = './app/tools/gimpinktool.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpInkToolClass = type { %struct._GimpPaintToolClass }
...
%struct._GimpInkTool = type { %struct._GimpPaintTool }
...
@gimp_ink_tool_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [12 x i8] c"GimpInkTool\00", align 1
@.str.1 = private unnamed_addr constant [14 x i8] c"gimp-ink-tool\00", align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"Ink\00", align 1
@.str.3 = private unnamed_addr constant [37 x i8] c"Ink Tool: Calligraphy-style painting\00", align 1
@.str.4 = private unnamed_addr constant [5 x i8] c"In_k\00", align 1
@.str.5 = private unnamed_addr constant [2 x i8] c"K\00", align 1
@.str.6 = private unnamed_addr constant [14 x i8] c"gimp-tool-ink\00", align 1
@gimp_ink_tool_parent_class = internal global i8* null, align 8
@GimpInkTool_private_offset = internal global i32 0, align 4
@.str.7 = private unnamed_addr constant [30 x i8] c"tools/tools-ink-blob-size-set\00", align 1
@.str.8 = private unnamed_addr constant [32 x i8] c"tools/tools-ink-blob-aspect-set\00", align 1
@.str.9 = private unnamed_addr constant [31 x i8] c"tools/tools-ink-blob-angle-set\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_ink_tool_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_ink_tool_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_ink_tool_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  %call5 = call i64 @gimp_paint_tool_get_type() #5
  %call6 = call i8* @g_intern_static_string(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str, i32 0, i32 0))
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 304, void (i8*, i8*)* bitcast (void (i8*)* @gimp_ink_tool_class_intern_init to void (i8*, i8*)*), i32 336, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpInkTool*)* @gimp_ink_tool_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_ink_tool_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_ink_tool_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_ink_tool_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_ink_tool_parent_class, align 8
  %1 = load i32, i32* @GimpInkTool_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpInkTool_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpInkToolClass*
  call void @gimp_ink_tool_class_init(%struct._GimpInkToolClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_ink_tool_init(%struct._GimpInkTool* %ink_tool) #3 {
entry:
  %ink_tool.addr = alloca %struct._GimpInkTool*, align 8
  %tool = alloca %struct._GimpTool*, align 8
  store %struct._GimpInkTool* %ink_tool, %struct._GimpInkTool** %ink_tool.addr, align 8
  %0 = load %struct._GimpInkTool*, %struct._GimpInkTool** %ink_tool.addr, align 8
  %1 = bitcast %struct._GimpInkTool* %0 to %struct._GTypeInstance*
  ...
  call void @gimp_tool_control_set_tool_cursor(%struct._GimpToolControl* %4, i32 27)
  ...
  call void @gimp_tool_control_set_action_value_2(%struct._GimpToolControl* %6, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.7, i32 0, i32 0))
  ...
  call void @gimp_tool_control_set_action_value_3(%struct._GimpToolControl* %8, i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.8, i32 0, i32 0))
  ...
  call void @gimp_tool_control_set_action_value_4(%struct._GimpToolControl* %10, i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.9, i32 0, i32 0))
  %11 = load %struct._GimpInkTool*, %struct._GimpInkTool** %ink_tool.addr, align 8
  %12 = bitcast %struct._GimpInkTool* %11 to %struct._GTypeInstance*
  %call5 = call i64 @gimp_paint_tool_get_type() #5
  %call6 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %12, i64 %call5)
  %13 = bitcast %struct._GTypeInstance* %call6 to %struct._GimpPaintTool*
  call void @gimp_paint_tool_enable_color_picker(%struct._GimpPaintTool* %13, i32 1)
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @gimp_ink_tool_register(void (i64, i64, %struct._GtkWidget* (%struct._GimpToolOptions*)*, i32, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*)* %callback, i8* %data) #3 {
entry:
  ...
  %call = call i64 @gimp_ink_tool_get_type() #5
  %call1 = call i64 @gimp_ink_options_get_type() #5
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0)) #6
  %call3 = call i8* @gettext(i8* getelementptr inbounds ([37 x i8], [37 x i8]* @.str.3, i32 0, i32 0)) #6
  %1 = load i8*, i8** %data.addr, align 8
  call void %0(i64 %call, i64 %call1, %struct._GtkWidget* (%struct._GimpToolOptions*)* @gimp_ink_options_gui, i32 960, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i32 0, i32 0), i8* %call2, i8* %call3, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.5, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.6, i32 0, i32 0), i8* %1)
  ret void
}
...
declare %struct._GtkWidget* @gimp_ink_options_gui(%struct._GimpToolOptions*) #1
...
; Function Attrs: nounwind uwtable
define internal void @gimp_ink_tool_class_init(%struct._GimpInkToolClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpInkToolClass*, align 8
  store %struct._GimpInkToolClass* %klass, %struct._GimpInkToolClass** %klass.addr, align 8
  ret void
}
