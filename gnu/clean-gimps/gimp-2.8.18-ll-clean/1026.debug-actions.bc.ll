; ModuleID = './app/actions/debug-actions.bc'
...
define void @debug_actions_setup(%struct._GimpActionGroup* %group) #0 {
entry:
...
; Function Attrs: nounwind uwtable
define void @debug_actions_update(%struct._GimpActionGroup* %group, i8* %data) #0 {
entry:
  %group.addr = alloca %struct._GimpActionGroup*, align 8
