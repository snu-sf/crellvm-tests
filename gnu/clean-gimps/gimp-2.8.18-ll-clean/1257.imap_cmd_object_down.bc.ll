; ModuleID = './plug-ins/imagemap/imap_cmd_object_down.bc'
...
%struct.ObjectDownCommand_t = type { %struct.Command_t, %struct.ObjectList_t*, %struct.Object_t* }

@.str = private unnamed_addr constant [10 x i8] c"Move Down\00", align 1
@object_down_command_class = internal global %struct.CommandClass_t { void (%struct.Command_t*)* @object_down_command_destruct, i32 (%struct.Command_t*)* @object_down_command_execute, void (%struct.Command_t*)* @object_down_command_undo, void (%struct.Command_t*)* null }, align 8

; Function Attrs: nounwind uwtable
define %struct.Command_t* @object_down_command_new(%struct.ObjectList_t* %list, %struct.Object_t* %obj) #0 {
entry:
  %list.addr = alloca %struct.ObjectList_t*, align 8
  %obj.addr = alloca %struct.Object_t*, align 8
  %command = alloca %struct.ObjectDownCommand_t*, align 8
  ...
  %0 = bitcast i8* %call to %struct.ObjectDownCommand_t*
  store %struct.ObjectDownCommand_t* %0, %struct.ObjectDownCommand_t** %command, align 8
  %1 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list.addr, align 8
  %2 = load %struct.ObjectDownCommand_t*, %struct.ObjectDownCommand_t** %command, align 8
  %list1 = getelementptr inbounds %struct.ObjectDownCommand_t, %struct.ObjectDownCommand_t* %2, i32 0, i32 1
  ...
  %4 = load %struct.ObjectDownCommand_t*, %struct.ObjectDownCommand_t** %command, align 8
  %obj3 = getelementptr inbounds %struct.ObjectDownCommand_t, %struct.ObjectDownCommand_t* %4, i32 0, i32 2
  store %struct.Object_t* %call2, %struct.Object_t** %obj3, align 8
  %5 = load %struct.ObjectDownCommand_t*, %struct.ObjectDownCommand_t** %command, align 8
  %parent = getelementptr inbounds %struct.ObjectDownCommand_t, %struct.ObjectDownCommand_t* %5, i32 0, i32 0
  %call4 = call i8* @gettext(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str, i32 0, i32 0)) #3
  %call5 = call %struct.Command_t* @command_init(%struct.Command_t* %parent, i8* %call4, %struct.CommandClass_t* @object_down_command_class)
...
; Function Attrs: nounwind uwtable
define internal void @object_down_command_destruct(%struct.Command_t* %parent) #0 {
entry:
  ...
  %1 = bitcast %struct.Command_t* %0 to %struct.ObjectDownCommand_t*
  store %struct.ObjectDownCommand_t* %1, %struct.ObjectDownCommand_t** %command, align 8
  %2 = load %struct.ObjectDownCommand_t*, %struct.ObjectDownCommand_t** %command, align 8
  %obj = getelementptr inbounds %struct.ObjectDownCommand_t, %struct.ObjectDownCommand_t* %2, i32 0, i32 2
...
; Function Attrs: nounwind uwtable
define internal i32 @object_down_command_execute(%struct.Command_t* %parent) #0 {
entry:
  %parent.addr = alloca %struct.Command_t*, align 8
  %command = alloca %struct.ObjectDownCommand_t*, align 8
  store %struct.Command_t* %parent, %struct.Command_t** %parent.addr, align 8
  ...
  store %struct.ObjectDownCommand_t* %1, %struct.ObjectDownCommand_t** %command, align 8
  %2 = load %struct.ObjectDownCommand_t*, %struct.ObjectDownCommand_t** %command, align 8
  %list = getelementptr inbounds %struct.ObjectDownCommand_t, %struct.ObjectDownCommand_t* %2, i32 0, i32 1
  %3 = load %struct.ObjectList_t*, %struct.ObjectList_t** %list, align 8
  %4 = load %struct.ObjectDownCommand_t*, %struct.ObjectDownCommand_t** %command, align 8
  %obj = getelementptr inbounds %struct.ObjectDownCommand_t, %struct.ObjectDownCommand_t* %4, i32 0, i32 2
  %5 = load %struct.Object_t*, %struct.Object_t** %obj, align 8
  call void @object_list_move_down(%struct.ObjectList_t* %3, %struct.Object_t* %5)
  ret i32 0
}

; Function Attrs: nounwind uwtable
define internal void @object_down_command_undo(%struct.Command_t* %parent) #0 {
entry:
  %parent.addr = alloca %struct.Command_t*, align 8
  %command = alloca %struct.ObjectDownCommand_t*, align 8
  store %struct.Command_t* %parent, %struct.Command_t** %parent.addr, align 8
  ...
  %obj = getelementptr inbounds %struct.ObjectDownCommand_t, %struct.ObjectDownCommand_t* %4, i32 0, i32 2
  %5 = load %struct.Object_t*, %struct.Object_t** %obj, align 8
  call void @object_list_move_up(%struct.ObjectList_t* %3, %struct.Object_t* %5)
  ret void
}

declare void @object_unref(%struct.Object_t*) #1

declare void @object_list_move_down(%struct.ObjectList_t*, %struct.Object_t*) #1

declare void @object_list_move_up(%struct.ObjectList_t*, %struct.Object_t*) #1
