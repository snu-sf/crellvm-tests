; ModuleID = './app/actions/sample-points-commands.bc'
...
define void @sample_points_sample_merged_cmd_callback(%struct._GtkAction* %action, i8* %data) #0 {
entry:
  ...
  %call2 = call i64 @gtk_toggle_action_get_type() #3
  ...
  %6 = load %struct._GimpSamplePointEditor*, %struct._GimpSamplePointEditor** %editor, align 8
  %7 = load i32, i32* %active, align 4
  call void @gimp_sample_point_editor_set_sample_merged(%struct._GimpSamplePointEditor* %6, i32 %7)
  ret void
}
...
declare void @gimp_sample_point_editor_set_sample_merged(%struct._GimpSamplePointEditor*, i32) #1
