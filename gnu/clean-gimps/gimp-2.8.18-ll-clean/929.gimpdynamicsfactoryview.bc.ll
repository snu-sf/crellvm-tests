; ModuleID = './app/widgets/gimpdynamicsfactoryview.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpDynamicsFactoryViewClass = type { %struct._GimpDataFactoryViewClass }
...
%struct._GimpDynamicsFactoryView = type { %struct._GimpDataFactoryView }
...
@gimp_dynamics_factory_view_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [24 x i8] c"GimpDynamicsFactoryView\00", align 1
@.str.1 = private unnamed_addr constant [13 x i8] c"Gimp-Widgets\00", align 1
@__func__.gimp_dynamics_factory_view_new = private unnamed_addr constant [31 x i8] c"gimp_dynamics_factory_view_new\00", align 1
...
@.str.14 = private unnamed_addr constant [11 x i8] c"<Dynamics>\00", align 1
@.str.15 = private unnamed_addr constant [8 x i8] c"ui-path\00", align 1
@.str.16 = private unnamed_addr constant [16 x i8] c"/dynamics-popup\00", align 1
@.str.17 = private unnamed_addr constant [13 x i8] c"action-group\00", align 1
@.str.18 = private unnamed_addr constant [9 x i8] c"dynamics\00", align 1
@gimp_dynamics_factory_view_parent_class = internal global i8* null, align 8
@GimpDynamicsFactoryView_private_offset = internal global i32 0, align 4

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_dynamics_factory_view_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_dynamics_factory_view_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_dynamics_factory_view_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 848, void (i8*, i8*)* bitcast (void (i8*)* @gimp_dynamics_factory_view_class_intern_init to void (i8*, i8*)*), i32 152, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpDynamicsFactoryView*)* @gimp_dynamics_factory_view_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_dynamics_factory_view_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_dynamics_factory_view_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_dynamics_factory_view_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_dynamics_factory_view_parent_class, align 8
  %1 = load i32, i32* @GimpDynamicsFactoryView_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpDynamicsFactoryView_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpDynamicsFactoryViewClass*
  call void @gimp_dynamics_factory_view_class_init(%struct._GimpDynamicsFactoryViewClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_dynamics_factory_view_init(%struct._GimpDynamicsFactoryView* %view) #3 {
entry:
  %view.addr = alloca %struct._GimpDynamicsFactoryView*, align 8
  store %struct._GimpDynamicsFactoryView* %view, %struct._GimpDynamicsFactoryView** %view.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define %struct._GtkWidget* @gimp_dynamics_factory_view_new(i32 %view_type, %struct._GimpDataFactory* %factory, %struct._GimpContext* %context, i32 %view_size, i32 %view_border_width, %struct._GimpMenuFactory* %menu_factory) #3 {
entry:
...
if.else.9:                                        ; preds = %if.end.6
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__func__.gimp_dynamics_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @.str.2, i32 0, i32 0))
...
if.else.36:                                       ; preds = %if.end.32
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__func__.gimp_dynamics_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.3, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.44:                                       ; preds = %land.lhs.true.41, %do.body.39
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__func__.gimp_dynamics_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.4, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.52:                                       ; preds = %land.lhs.true.49, %do.body.47
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__func__.gimp_dynamics_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([74 x i8], [74 x i8]* @.str.5, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
if.else.81:                                       ; preds = %if.end.77
  call void @g_return_if_fail_warning(i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.1, i32 0, i32 0), i8* getelementptr inbounds ([31 x i8], [31 x i8]* @__func__.gimp_dynamics_factory_view_new, i32 0, i32 0), i8* getelementptr inbounds ([60 x i8], [60 x i8]* @.str.6, i32 0, i32 0))
  store %struct._GtkWidget* null, %struct._GtkWidget** %retval
  br label %return
...
do.end.83:                                        ; preds = %if.end.82
  %call84 = call i64 @gimp_dynamics_factory_view_get_type() #5
  ...
  %50 = bitcast i8* %call85 to %struct._GtkWidget*
...
; Function Attrs: nounwind uwtable
define internal void @gimp_dynamics_factory_view_class_init(%struct._GimpDynamicsFactoryViewClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpDynamicsFactoryViewClass*, align 8
  store %struct._GimpDynamicsFactoryViewClass* %klass, %struct._GimpDynamicsFactoryViewClass** %klass.addr, align 8
  ret void
}
