; ModuleID = './app/actions/config-commands.bc'
...
@.str = private unnamed_addr constant [9 x i8] c"use-gegl\00", align 1

; Function Attrs: nounwind uwtable
define void @config_use_gegl_cmd_callback(%struct._GtkAction* %action, i8* %data) #0 {
entry:
  %action.addr = alloca %struct._GtkAction*, align 8
  %data.addr = alloca i8*, align 8
  %toggle_action = alloca %struct._GtkToggleAction*, align 8
  ...
  store %struct._GtkToggleAction* %2, %struct._GtkToggleAction** %toggle_action, align 8
...
if.end:                                           ; preds = %entry
  ...
  %7 = bitcast %struct._GimpCoreConfig* %6 to i8*
  %8 = load %struct._GtkToggleAction*, %struct._GtkToggleAction** %toggle_action, align 8
  %call3 = call i32 @gtk_toggle_action_get_active(%struct._GtkToggleAction* %8)
  call void (i8*, i8*, ...) @g_object_set(i8* %7, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str, i32 0, i32 0), i32 %call3, i8* null)
  br label %return
