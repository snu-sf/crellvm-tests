; ModuleID = './app/widgets/gimpfontselect.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpFontSelectClass = type { %struct._GimpPdbDialogClass }
...
%struct._GimpFontSelect = type { %struct._GimpPdbDialog }
...
@gimp_font_select_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [15 x i8] c"GimpFontSelect\00", align 1
@gimp_font_select_parent_class = internal global i8* null, align 8
@GimpFontSelect_private_offset = internal global i32 0, align 4

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_font_select_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_font_select_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_font_select_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 1000, void (i8*, i8*)* bitcast (void (i8*)* @gimp_font_select_class_intern_init to void (i8*, i8*)*), i32 336, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpFontSelect*)* @gimp_font_select_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_font_select_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_font_select_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_font_select_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_font_select_parent_class, align 8
  %1 = load i32, i32* @GimpFontSelect_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpFontSelect_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpFontSelectClass*
  call void @gimp_font_select_class_init(%struct._GimpFontSelectClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_font_select_init(%struct._GimpFontSelect* %select) #3 {
entry:
  %select.addr = alloca %struct._GimpFontSelect*, align 8
  store %struct._GimpFontSelect* %select, %struct._GimpFontSelect** %select.addr, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_font_select_class_init(%struct._GimpFontSelectClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpFontSelectClass*, align 8
  %object_class = alloca %struct._GObjectClass*, align 8
  %pdb_class = alloca %struct._GimpPdbDialogClass*, align 8
  store %struct._GimpFontSelectClass* %klass, %struct._GimpFontSelectClass** %klass.addr, align 8
  %0 = load %struct._GimpFontSelectClass*, %struct._GimpFontSelectClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpFontSelectClass* %0 to %struct._GTypeClass*
  %call = call %struct._GTypeClass* @g_type_check_class_cast(%struct._GTypeClass* %1, i64 80)
  %2 = bitcast %struct._GTypeClass* %call to %struct._GObjectClass*
  store %struct._GObjectClass* %2, %struct._GObjectClass** %object_class, align 8
  %3 = load %struct._GimpFontSelectClass*, %struct._GimpFontSelectClass** %klass.addr, align 8
  %4 = bitcast %struct._GimpFontSelectClass* %3 to %struct._GTypeClass*
  ...
  store void (%struct._GObject*)* @gimp_font_select_constructed, void (%struct._GObject*)** %constructed, align 8
  ...
  store %struct._GValueArray* (%struct._GimpPdbDialog*, %struct._GimpObject*, i32, %struct._GError**)* @gimp_font_select_run_callback, %struct._GValueArray* (%struct._GimpPdbDialog*, %struct._GimpObject*, i32, %struct._GError**)** %run_callback, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_font_select_constructed(%struct._GObject* %object) #3 {
entry:
  ...
  %3 = load i8*, i8** @gimp_font_select_parent_class, align 8
...
if.then:                                          ; preds = %entry
  %7 = load i8*, i8** @gimp_font_select_parent_class, align 8
...
if.end:                                           ; preds = %if.then, %entry
  ...
  %call6 = call %struct._GtkWidget* @gimp_font_view_new(i32 0, %struct._GimpContainer* %15, %struct._GimpContext* %17, i32 32, i32 1, %struct._GimpMenuFactory* %19)
...
; Function Attrs: nounwind uwtable
define internal %struct._GValueArray* @gimp_font_select_run_callback(%struct._GimpPdbDialog* %dialog, %struct._GimpObject* %object, i32 %closing, %struct._GError** %error) #3 {
entry:
  ...
  %pdb = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %0, i32 0, i32 1
  %1 = load %struct._GimpPDB*, %struct._GimpPDB** %pdb, align 8
  %2 = load %struct._GimpPdbDialog*, %struct._GimpPdbDialog** %dialog.addr, align 8
  %caller_context = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %2, i32 0, i32 2
  %3 = load %struct._GimpContext*, %struct._GimpContext** %caller_context, align 8
  ...
  %callback_name = getelementptr inbounds %struct._GimpPdbDialog, %struct._GimpPdbDialog* %5, i32 0, i32 6
  %6 = load i8*, i8** %callback_name, align 8
  ...
  %call1 = call i64 @gimp_int32_get_type() #4
  %9 = load i32, i32* %closing.addr, align 4
  %call2 = call %struct._GValueArray* (%struct._GimpPDB*, %struct._GimpContext*, %struct._GimpProgress*, %struct._GError**, i8*, ...) @gimp_pdb_execute_procedure_by_name(%struct._GimpPDB* %1, %struct._GimpContext* %3, %struct._GimpProgress* null, %struct._GError** %4, i8* %6, i64 64, i8* %call, i64 %call1, i32 %9, i64 4)
