; ModuleID = './app/tools/gimpbycolorselecttool.bc'
target datalayout = "e-m:e-i64:64-f80:128-n8:16:32:64-S128"
target triple = "x86_64-unknown-linux-gnu"

%struct._GTypeInstance = type { %struct._GTypeClass* }
%struct._GTypeClass = type { i64 }
%struct._GimpByColorSelectToolClass = type { %struct._GimpRegionSelectToolClass }
...
%struct._GimpByColorSelectTool = type { %struct._GimpRegionSelectTool }
...
@gimp_by_color_select_tool_get_type.g_define_type_id__volatile = internal global i64 0, align 8
@.str = private unnamed_addr constant [22 x i8] c"GimpByColorSelectTool\00", align 1
@.str.1 = private unnamed_addr constant [26 x i8] c"gimp-by-color-select-tool\00", align 1
@.str.2 = private unnamed_addr constant [16 x i8] c"Select by Color\00", align 1
@.str.3 = private unnamed_addr constant [57 x i8] c"Select by Color Tool: Select regions with similar colors\00", align 1
@.str.4 = private unnamed_addr constant [17 x i8] c"_By Color Select\00", align 1
@.str.5 = private unnamed_addr constant [9 x i8] c"<shift>O\00", align 1
@.str.6 = private unnamed_addr constant [26 x i8] c"gimp-tool-by-color-select\00", align 1
@gimp_by_color_select_tool_parent_class = internal global i8* null, align 8
@GimpByColorSelectTool_private_offset = internal global i32 0, align 4
@.str.7 = private unnamed_addr constant [24 x i8] c"command\04Select by Color\00", align 1

; Function Attrs: nounwind readnone uwtable
define i64 @gimp_by_color_select_tool_get_type() #0 {
entry:
  %tmp = alloca i32, align 4
  %tmp1 = alloca i8*, align 8
  %g_define_type_id = alloca i64, align 8
  fence seq_cst
  %0 = load volatile i64, i64* @gimp_by_color_select_tool_get_type.g_define_type_id__volatile, align 8
...
land.rhs:                                         ; preds = %entry
  %call = call i32 @g_once_init_enter(i8* bitcast (i64* @gimp_by_color_select_tool_get_type.g_define_type_id__volatile to i8*))
...
if.then:                                          ; preds = %land.end
  ...
  %call7 = call i64 @g_type_register_static_simple(i64 %call5, i8* %call6, i32 304, void (i8*, i8*)* bitcast (void (i8*)* @gimp_by_color_select_tool_class_intern_init to void (i8*, i8*)*), i32 304, void (%struct._GTypeInstance*, i8*)* bitcast (void (%struct._GimpByColorSelectTool*)* @gimp_by_color_select_tool_init to void (%struct._GTypeInstance*, i8*)*), i32 0)
  store i64 %call7, i64* %g_define_type_id, align 8
  %5 = load i64, i64* %g_define_type_id, align 8
  call void @g_once_init_leave(i8* bitcast (i64* @gimp_by_color_select_tool_get_type.g_define_type_id__volatile to i8*), i64 %5)
  br label %if.end

if.end:                                           ; preds = %if.then, %land.end
  %6 = load volatile i64, i64* @gimp_by_color_select_tool_get_type.g_define_type_id__volatile, align 8
  ret i64 %6
}
...
define internal void @gimp_by_color_select_tool_class_intern_init(i8* %klass) #3 {
entry:
  %klass.addr = alloca i8*, align 8
  store i8* %klass, i8** %klass.addr, align 8
  %0 = load i8*, i8** %klass.addr, align 8
  %call = call i8* @g_type_class_peek_parent(i8* %0)
  store i8* %call, i8** @gimp_by_color_select_tool_parent_class, align 8
  %1 = load i32, i32* @GimpByColorSelectTool_private_offset, align 4
  %cmp = icmp ne i32 %1, 0
  br i1 %cmp, label %if.then, label %if.end

if.then:                                          ; preds = %entry
  %2 = load i8*, i8** %klass.addr, align 8
  call void @g_type_class_adjust_private_offset(i8* %2, i32* @GimpByColorSelectTool_private_offset)
  br label %if.end

if.end:                                           ; preds = %if.then, %entry
  %3 = load i8*, i8** %klass.addr, align 8
  %4 = bitcast i8* %3 to %struct._GimpByColorSelectToolClass*
  call void @gimp_by_color_select_tool_class_init(%struct._GimpByColorSelectToolClass* %4)
  ret void
}

; Function Attrs: nounwind uwtable
define internal void @gimp_by_color_select_tool_init(%struct._GimpByColorSelectTool* %by_color_select) #3 {
entry:
  %by_color_select.addr = alloca %struct._GimpByColorSelectTool*, align 8
  %tool = alloca %struct._GimpTool*, align 8
  store %struct._GimpByColorSelectTool* %by_color_select, %struct._GimpByColorSelectTool** %by_color_select.addr, align 8
  %0 = load %struct._GimpByColorSelectTool*, %struct._GimpByColorSelectTool** %by_color_select.addr, align 8
  %1 = bitcast %struct._GimpByColorSelectTool* %0 to %struct._GTypeInstance*
  ...
  call void @gimp_tool_control_set_tool_cursor(%struct._GimpToolControl* %4, i32 36)
  ret void
}
...
; Function Attrs: nounwind uwtable
define void @gimp_by_color_select_tool_register(void (i64, i64, %struct._GtkWidget* (%struct._GimpToolOptions*)*, i32, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*, i8*)* %callback, i8* %data) #3 {
entry:
  ...
  %call = call i64 @gimp_by_color_select_tool_get_type() #5
  %call1 = call i64 @gimp_region_select_options_get_type() #5
  %call2 = call i8* @gettext(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.2, i32 0, i32 0)) #6
  %call3 = call i8* @gettext(i8* getelementptr inbounds ([57 x i8], [57 x i8]* @.str.3, i32 0, i32 0)) #6
  %1 = load i8*, i8** %data.addr, align 8
  call void %0(i64 %call, i64 %call1, %struct._GtkWidget* (%struct._GimpToolOptions*)* @gimp_region_select_options_gui, i32 0, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.1, i32 0, i32 0), i8* %call2, i8* %call3, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.4, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.5, i32 0, i32 0), i8* null, i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6, i32 0, i32 0), i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.6, i32 0, i32 0), i8* %1)
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal void @gimp_by_color_select_tool_class_init(%struct._GimpByColorSelectToolClass* %klass) #3 {
entry:
  %klass.addr = alloca %struct._GimpByColorSelectToolClass*, align 8
  %region_class = alloca %struct._GimpRegionSelectToolClass*, align 8
  store %struct._GimpByColorSelectToolClass* %klass, %struct._GimpByColorSelectToolClass** %klass.addr, align 8
  %0 = load %struct._GimpByColorSelectToolClass*, %struct._GimpByColorSelectToolClass** %klass.addr, align 8
  %1 = bitcast %struct._GimpByColorSelectToolClass* %0 to %struct._GTypeClass*
  ...
  %call2 = call i8* @g_dpgettext(i8* null, i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.7, i32 0, i32 0), i64 8)
  ...
  store %struct._GimpChannel* (%struct._GimpRegionSelectTool*, %struct._GimpDisplay*)* @gimp_by_color_select_tool_get_mask, %struct._GimpChannel* (%struct._GimpRegionSelectTool*, %struct._GimpDisplay*)** %get_mask, align 8
  ret void
}
...
; Function Attrs: nounwind uwtable
define internal %struct._GimpChannel* @gimp_by_color_select_tool_get_mask(%struct._GimpRegionSelectTool* %region_select, %struct._GimpDisplay* %display) #3 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call19 = call i64 @gimp_pickable_interface_get_type() #5
  %call20 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %29, i64 %call19)
  %30 = bitcast %struct._GTypeInstance* %call20 to %struct._GimpPickable*
  store %struct._GimpPickable* %30, %struct._GimpPickable** %pickable, align 8
  br label %if.end

if.else:                                          ; preds = %entry
  %31 = load %struct._GimpImage*, %struct._GimpImage** %image, align 8
  %call21 = call %struct._GimpProjection* @gimp_image_get_projection(%struct._GimpImage* %31)
  %32 = bitcast %struct._GimpProjection* %call21 to %struct._GTypeInstance*
  %call22 = call i64 @gimp_pickable_interface_get_type() #5
  %call23 = call %struct._GTypeInstance* @g_type_check_instance_cast(%struct._GTypeInstance* %32, i64 %call22)
  %33 = bitcast %struct._GTypeInstance* %call23 to %struct._GimpPickable*
  store %struct._GimpPickable* %33, %struct._GimpPickable** %pickable, align 8
  br label %if.end
...
if.end:                                           ; preds = %if.else, %if.then
  ...
  %call24 = call i32 @gimp_pickable_get_color_at(%struct._GimpPickable* %35, i32 %36, i32 %37, %struct._GimpRGB* %color)
...
if.then.26:                                       ; preds = %if.end
  ...
  %40 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %sample_merged27 = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %40, i32 0, i32 2
  %41 = load i32, i32* %sample_merged27, align 4
  %42 = load %struct._GimpSelectionOptions*, %struct._GimpSelectionOptions** %sel_options, align 8
  %antialias = getelementptr inbounds %struct._GimpSelectionOptions, %struct._GimpSelectionOptions* %42, i32 0, i32 2
  %43 = load i32, i32* %antialias, align 4
  %44 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %threshold = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %44, i32 0, i32 3
  %45 = load double, double* %threshold, align 8
  %conv = fptosi double %45 to i32
  %46 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %select_transparent = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %46, i32 0, i32 1
  %47 = load i32, i32* %select_transparent, align 4
  %48 = load %struct._GimpRegionSelectOptions*, %struct._GimpRegionSelectOptions** %options, align 8
  %select_criterion = getelementptr inbounds %struct._GimpRegionSelectOptions, %struct._GimpRegionSelectOptions* %48, i32 0, i32 4
  %49 = load i32, i32* %select_criterion, align 4
  %call28 = call %struct._GimpChannel* @gimp_image_contiguous_region_by_color(%struct._GimpImage* %38, %struct._GimpDrawable* %39, i32 %41, i32 %43, i32 %conv, i32 %47, i32 %49, %struct._GimpRGB* %color)
  store %struct._GimpChannel* %call28, %struct._GimpChannel** %retval
  br label %return
...
return:                                           ; preds = %if.end.29, %if.then.26
  %50 = load %struct._GimpChannel*, %struct._GimpChannel** %retval
  ret %struct._GimpChannel* %50
}
...
declare i32 @gimp_pickable_get_color_at(%struct._GimpPickable*, i32, i32, %struct._GimpRGB*) #1

declare %struct._GimpChannel* @gimp_image_contiguous_region_by_color(%struct._GimpImage*, %struct._GimpDrawable*, i32, i32, i32, i32, i32, %struct._GimpRGB*) #1
