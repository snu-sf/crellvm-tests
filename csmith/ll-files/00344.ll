...
define internal i64 @func_1() #0 {
  ...
  store i64 8688710424216248619, i64* %l_2, align 8, !tbaa !7
  %2 = load i64, i64* %l_2, align 8, !tbaa !7
  %3 = load volatile i32*, i32** @g_3, align 8, !tbaa !5
  %4 = load i32, i32* %3, align 4, !tbaa !1
  %5 = sext i32 %4 to i64
  %6 = xor i64 %5, %2
  %7 = trunc i64 %6 to i32
  store i32 %7, i32* %3, align 4, !tbaa !1
  %8 = load i64, i64* %l_2, align 8, !tbaa !7
  %9 = bitcast i64* %l_2 to i8*
