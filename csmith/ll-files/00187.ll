...
@g_4 = internal global i32 1762598281, align 4
...
define internal i32 @func_1() #0 {
  ...
  store i8 -118, i8* %l_2, align 1, !tbaa !9
  %1 = bitcast i32* %l_5 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %1) #1
  store i32 -1576284107, i32* %l_5, align 4, !tbaa !1
  %2 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %2) #1
  store i32* @g_4, i32** %l_6, align 8, !tbaa !5
  %3 = bitcast i32* %l_7 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %3) #1
  store i32 -1969966421, i32* %l_7, align 4, !tbaa !1
  %4 = bitcast [1 x i32*]* %l_8 to i8*
...
; <label>:9                                       ; preds = %6
  ...
  %12 = getelementptr inbounds [1 x i32*], [1 x i32*]* %l_8, i32 0, i64 %11
  store i32* @g_4, i32** %12, align 8, !tbaa !5
  br label %13
...
; <label>:16                                      ; preds = %6
  %17 = load i8, i8* %l_2, align 1, !tbaa !9
  %18 = sext i8 %17 to i32
  %19 = load volatile i32*, i32** @g_3, align 8, !tbaa !5
  %20 = load i32, i32* %19, align 4, !tbaa !1
  %21 = or i32 %20, %18
  store i32 %21, i32* %19, align 4, !tbaa !1
  %22 = load volatile i32, i32* @g_9, align 4, !tbaa !1
  %23 = add i32 %22, 1
  store volatile i32 %23, i32* @g_9, align 4, !tbaa !1
  %24 = load i32*, i32** %l_6, align 8, !tbaa !5
  %25 = load i32, i32* %24, align 4, !tbaa !1
  %26 = sext i32 %25 to i64
  %27 = or i64 %26, -1
  %28 = trunc i64 %27 to i32
  store i32 %28, i32* %24, align 4, !tbaa !1
  %29 = load i32*, i32** %l_6, align 8, !tbaa !5
  %30 = load i32, i32* %29, align 4, !tbaa !1
  %31 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %31) #1
  %32 = bitcast [1 x i32*]* %l_8 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %32) #1
  %33 = bitcast i32* %l_7 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %33) #1
  %34 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %34) #1
  %35 = bitcast i32* %l_5 to i8*
