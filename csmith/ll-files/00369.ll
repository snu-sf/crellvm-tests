...
@func_1.l_2 = private unnamed_addr constant [9 x [8 x i32*]] [[8 x i32*] [i32* @g_3, i32* @g_3, i32* null, i32* @g_3, i32* @g_3, i32* null, i32* null, i32* @g_3], [8 x i32*] [i32* @g_3, i32* null, i32* null, i32* @g_3, i32* @g_3, i32* null, i32* @g_3, i32* @g_3], [8 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], [8 x i32*] [i32* @g_3, i32* @g_3, i32* null, i32* @g_3, i32* @g_3, i32* null, i32* null, i32* @g_3], [8 x i32*] [i32* @g_3, i32* null, i32* null, i32* @g_3, i32* @g_3, i32* null, i32* @g_3, i32* @g_3], [8 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* @g_3], [8 x i32*] [i32* @g_3, i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], [8 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* @g_3], [8 x i32*] [i32* @g_3, i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* @g_3]], align 16
...
define internal i32 @func_1() #0 {
  %l_2 = alloca [9 x [8 x i32*]], align 16
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = bitcast [9 x [8 x i32*]]* %l_2 to i8*
  call void @llvm.lifetime.start(i64 576, i8* %1) #1
  %2 = bitcast [9 x [8 x i32*]]* %l_2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([9 x [8 x i32*]]* @func_1.l_2 to i8*), i64 576, i32 16, i1 false)
  %3 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %3) #1
  %4 = bitcast i32* %j to i8*
  call void @llvm.lifetime.start(i64 4, i8* %4) #1
  store i32 6, i32* @g_3, align 4, !tbaa !1
  store i16 6, i16* @g_4, align 2, !tbaa !10
  %5 = load i16, i16* @g_4, align 2, !tbaa !10
  %6 = sext i16 %5 to i32
  %7 = bitcast i32* %j to i8*
  call void @llvm.lifetime.end(i64 4, i8* %7) #1
  %8 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %8) #1
  %9 = bitcast [9 x [8 x i32*]]* %l_2 to i8*
  call void @llvm.lifetime.end(i64 576, i8* %9) #1
  ret i32 %6
}
