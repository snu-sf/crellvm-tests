...
; <label>:7                                       ; preds = %4
  %8 = bitcast i64* %l_7 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %8) #1
  store i64 -4329017734710941992, i64* %l_7, align 8, !tbaa !7
...
; <label>:12                                      ; preds = %7
  %13 = load i64, i64* %l_7, align 8, !tbaa !7
...
; <label>:15                                      ; preds = %12, %11
  %16 = bitcast i64* %l_7 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %16) #1
  %cleanup.dest = load i32, i32* %2
  switch i32 %cleanup.dest, label %25 [
    i32 2, label %22
  ]
                                                  ; No predecessors!
  ...
  store i32 %21, i32* @g_3, align 4, !tbaa !1
  br label %4
