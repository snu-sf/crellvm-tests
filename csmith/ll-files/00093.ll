...
@g_3 = internal global i8 -48, align 1
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %88 = load i8, i8* @g_3, align 1, !tbaa !9
...
; <label>:6                                       ; preds = %3
  ...
  %8 = sext i32 %7 to i64
  %9 = getelementptr inbounds [1 x i32*], [1 x i32*]* %l_2, i32 0, i64 %8
...
; <label>:10                                      ; preds = %6
  ...
  %12 = add nsw i32 %11, 1
  store i32 %12, i32* %i, align 4, !tbaa !1
  br label %3

; <label>:13                                      ; preds = %3
  %14 = load i8, i8* @g_3, align 1, !tbaa !9
  %15 = add i8 %14, -1
  store i8 %15, i8* @g_3, align 1, !tbaa !9
  %16 = load i8, i8* @g_3, align 1, !tbaa !9
  %17 = zext i8 %16 to i16
  %18 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %18) #1
  %19 = bitcast [1 x i32*]* %l_2 to i8*
