...
@g_8 = internal global i16 -30947, align 2
...
@g_15 = internal global i16 -7, align 2
@.str.3 = private unnamed_addr constant [5 x i8] c"g_15\00", align 1
@g_22 = internal global [1 x [9 x [7 x i32]]] [[9 x [7 x i32]] [[7 x i32] [i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4], [7 x i32] [i32 885736471, i32 -5, i32 885736471, i32 -5, i32 885736471, i32 -5, i32 885736471], [7 x i32] [i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4], [7 x i32] [i32 885736471, i32 -5, i32 885736471, i32 -5, i32 885736471, i32 -5, i32 885736471], [7 x i32] [i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4], [7 x i32] [i32 885736471, i32 -5, i32 885736471, i32 -5, i32 885736471, i32 -5, i32 885736471], [7 x i32] [i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4], [7 x i32] [i32 885736471, i32 -5, i32 885736471, i32 -5, i32 885736471, i32 -5, i32 885736471], [7 x i32] [i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4, i32 -4]]], align 16
...
; <label>:111                                     ; preds = %108
  ...
  %118 = getelementptr inbounds [1 x [9 x [7 x i32]]], [1 x [9 x [7 x i32]]]* @g_22, i32 0, i64 %117
  %119 = getelementptr inbounds [9 x [7 x i32]], [9 x [7 x i32]]* %118, i32 0, i64 %115
  %120 = getelementptr inbounds [7 x i32], [7 x i32]* %119, i32 0, i64 %113
...
define internal i64 @func_1() #0 {
  ...
  %3 = bitcast i16** %l_14 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %3) #1
  store i16* @g_15, i16** %l_14, align 8, !tbaa !5
  %4 = bitcast i32* %l_16 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %4) #1
  store i32 737924014, i32* %l_16, align 4, !tbaa !1
  %5 = bitcast i32** %l_23 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %5) #1
  store i32* getelementptr inbounds ([1 x [9 x [7 x i32]]], [1 x [9 x [7 x i32]]]* @g_22, i32 0, i64 0, i64 8, i64 3), i32** %l_23, align 8, !tbaa !5
  %6 = bitcast i32*** %l_24 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %6) #1
  store i32** %l_23, i32*** %l_24, align 8, !tbaa !5
  %7 = load i16, i16* @g_8, align 2, !tbaa !10
  %8 = zext i16 %7 to i32
  %9 = load i16, i16* @g_8, align 2, !tbaa !10
  %10 = load i16*, i16** %l_12, align 8, !tbaa !5
  store i16 27116, i16* %10, align 2, !tbaa !10
  %11 = load i16*, i16** %l_14, align 8, !tbaa !5
  store i16 27116, i16* %11, align 2, !tbaa !10
  %12 = load i16, i16* @g_8, align 2, !tbaa !10
  %13 = load i16, i16* @g_13, align 2, !tbaa !10
  %14 = sext i16 %13 to i64
  %15 = xor i64 %14, 1
  %16 = load i16, i16* @g_15, align 2, !tbaa !10
  %17 = call i32 @safe_mod_func_int32_t_s_s(i32 0, i32 737924014)
  %18 = trunc i32 %17 to i16
  %19 = call signext i16 @safe_mul_func_int16_t_s_s(i16 signext %18, i16 signext -11346)
  ...
  %27 = call signext i8 @safe_add_func_int8_t_s_s(i8 signext -1, i8 signext %26)
  %28 = sext i8 %27 to i64
  %29 = icmp ult i64 %28, 4294967295
  %30 = zext i1 %29 to i32
  %31 = call i32 @func_2(i32 %8, i16 zeroext %9, i32 7, i32 737924014, i8 zeroext -82)
  %32 = load i32*, i32** %l_23, align 8, !tbaa !5
  store i32 %31, i32* %32, align 4, !tbaa !1
  %33 = load i32**, i32*** %l_24, align 8, !tbaa !5
  store i32* getelementptr inbounds ([1 x [9 x [7 x i32]]], [1 x [9 x [7 x i32]]]* @g_22, i32 0, i64 0, i64 8, i64 3), i32** %33, align 8, !tbaa !5
  ...
  %39 = bitcast i32** %l_23 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %39) #1
  %40 = bitcast i32* %l_16 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %40) #1
  %41 = bitcast i16** %l_14 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %41) #1
  %42 = bitcast i16** %l_12 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %42) #1
  %43 = bitcast i16** %l_11 to i8*
...
; Function Attrs: nounwind uwtable
define internal i32 @func_2(i32 %p_3, i16 zeroext %p_4, i32 %p_5, i32 %p_6, i8 zeroext %p_7) #0 {
  %1 = alloca i32, align 4
  ...
  call void @llvm.lifetime.start(i64 8, i8* %6) #1
  store i32* getelementptr inbounds ([1 x [9 x [7 x i32]]], [1 x [9 x [7 x i32]]]* @g_22, i32 0, i64 0, i64 8, i64 3), i32** %l_21, align 8, !tbaa !5
  %7 = load i32*, i32** %l_21, align 8, !tbaa !5
  store i32 -68844391, i32* %7, align 4, !tbaa !1
  %8 = load i32*, i32** %l_21, align 8, !tbaa !5
