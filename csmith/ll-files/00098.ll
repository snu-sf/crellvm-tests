...
@g_4 = internal global [9 x i32] [i32 -774309643, i32 -774309643, i32 -774309643, i32 -774309643, i32 -774309643, i32 -774309643, i32 -774309643, i32 -774309643, i32 -774309643], align 16
@.str.1 = private unnamed_addr constant [7 x i8] c"g_4[i]\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"index = [%d]\0A\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@g_3 = internal global i32* bitcast (i8* getelementptr (i8, i8* bitcast ([9 x i32]* @g_4 to i8*), i64 16) to i32*), align 8
@g_6 = internal global i32*** bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32**]* @g_7 to i8*), i64 16) to i32***), align 8
@g_7 = internal global [4 x i32**] zeroinitializer, align 16
...
; <label>:92                                      ; preds = %89
  ...
  %95 = getelementptr inbounds [9 x i32], [9 x i32]* @g_4, i32 0, i64 %94
...
define internal i64 @func_1() #0 {
  ...
  store i16 -5, i16* %l_2, align 2, !tbaa !10
  %2 = bitcast i32*** %l_5 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %2) #1
  store i32** null, i32*** %l_5, align 8, !tbaa !5
  %3 = bitcast i32** %l_8 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %3) #1
  store i32* getelementptr inbounds ([9 x i32], [9 x i32]* @g_4, i32 0, i64 4), i32** %l_8, align 8, !tbaa !5
  %4 = bitcast i32*** %l_9 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %4) #1
  store i32** %l_8, i32*** %l_9, align 8, !tbaa !5
  %5 = load i16, i16* %l_2, align 2, !tbaa !10
  %6 = sext i16 %5 to i32
  %7 = load volatile i32*, i32** @g_3, align 8, !tbaa !5
  %8 = load i32, i32* %7, align 4, !tbaa !1
  %9 = and i32 %8, %6
  store i32 %9, i32* %7, align 4, !tbaa !1
  %10 = load i32**, i32*** %l_5, align 8, !tbaa !5
  %11 = load volatile i32***, i32**** @g_6, align 8, !tbaa !5
  store i32** %10, i32*** %11, align 8, !tbaa !5
  %12 = load i32*, i32** %l_8, align 8, !tbaa !5
  %13 = load i32**, i32*** %l_9, align 8, !tbaa !5
  store i32* %12, i32** %13, align 8, !tbaa !5
  %14 = load i32, i32* getelementptr inbounds ([9 x i32], [9 x i32]* @g_4, i32 0, i64 5), align 4, !tbaa !1
  %15 = sext i32 %14 to i64
  %16 = bitcast i32*** %l_9 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %16) #1
  %17 = bitcast i32** %l_8 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %17) #1
  %18 = bitcast i32*** %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %18) #1
  %19 = bitcast i16* %l_2 to i8*
