...
@g_2 = internal global i16 3, align 2
@.str.1 = private unnamed_addr constant [4 x i8] c"g_2\00", align 1
@g_5 = internal global i32 1896010057, align 4
@.str.2 = private unnamed_addr constant [4 x i8] c"g_5\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_8 = private unnamed_addr constant [7 x i32*] [i32* @g_5, i32* @g_5, i32* @g_5, i32* @g_5, i32* @g_5, i32* @g_5, i32* @g_5], align 16
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %89 = load i16, i16* @g_2, align 2, !tbaa !10
  ...
  %92 = load i32, i32* @g_5, align 4, !tbaa !1
  ...
  %95 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %96 = zext i32 %95 to i64
  %97 = xor i64 %96, 4294967295
  %98 = trunc i64 %97 to i32
  %99 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %98, i32 %99)
  %100 = bitcast i32* %print_hash_value to i8*
...
define internal zeroext i16 @func_1() #0 {
  ...
  %4 = bitcast [7 x i32*]* %l_8 to i8*
  call void @llvm.lifetime.start(i64 56, i8* %4) #1
  %5 = bitcast [7 x i32*]* %l_8 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %5, i8* bitcast ([7 x i32*]* @func_1.l_8 to i8*), i64 56, i32 16, i1 false)
  %6 = bitcast i16* %l_9 to i8*
  call void @llvm.lifetime.start(i64 2, i8* %6) #1
  store i16 5, i16* %l_9, align 2, !tbaa !10
  %7 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %7) #1
  %8 = load i16, i16* @g_2, align 2, !tbaa !10
  %9 = zext i16 %8 to i32
  %10 = load i32*, i32** %l_6, align 8, !tbaa !5
  store i32 %9, i32* %10, align 4, !tbaa !1
  %11 = load i16, i16* %l_9, align 2, !tbaa !10
  %12 = add i16 %11, 1
  store i16 %12, i16* %l_9, align 2, !tbaa !10
  %13 = load i16, i16* @g_2, align 2, !tbaa !10
  %14 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %14) #1
  %15 = bitcast i16* %l_9 to i8*
  call void @llvm.lifetime.end(i64 2, i8* %15) #1
  %16 = bitcast [7 x i32*]* %l_8 to i8*
  call void @llvm.lifetime.end(i64 56, i8* %16) #1
  %17 = bitcast i32** %l_7 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %17) #1
  %18 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %18) #1
  %19 = bitcast i32** %l_3 to i8*
