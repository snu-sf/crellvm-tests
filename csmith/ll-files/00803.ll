...
define internal signext i8 @func_1() #0 {
  %l_4 = alloca [7 x [1 x i32**]], align 16
  %l_5 = alloca i32*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = bitcast [7 x [1 x i32**]]* %l_4 to i8*
  call void @llvm.lifetime.start(i64 56, i8* %1) #1
  %2 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %2) #1
  store volatile i32* @g_3, i32** %l_5, align 8, !tbaa !5
  %3 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %3) #1
  %4 = bitcast i32* %j to i8*
  call void @llvm.lifetime.start(i64 4, i8* %4) #1
...
; <label>:12                                      ; preds = %9
  ...
  %17 = getelementptr inbounds [7 x [1 x i32**]], [7 x [1 x i32**]]* %l_4, i32 0, i64 %16
  %18 = getelementptr inbounds [1 x i32**], [1 x i32**]* %17, i32 0, i64 %14
...
; <label>:19                                      ; preds = %12
  ...
  %21 = add nsw i32 %20, 1
  store i32 %21, i32* %j, align 4, !tbaa !1
  br label %9
...
; <label>:26                                      ; preds = %5
  %27 = load volatile i32*, i32** @g_2, align 8, !tbaa !5
  store volatile i32* %27, i32** %l_5, align 8, !tbaa !5
  ...
  %33 = bitcast [7 x [1 x i32**]]* %l_4 to i8*
  call void @llvm.lifetime.end(i64 56, i8* %33) #1
  ret i8 %29
}
