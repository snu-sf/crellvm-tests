...
%struct.S0 = type <{ i16, i32, [3 x i8], i32, i32, i32, i64, i64 }>
...
@g_2 = internal global <{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }> <{ i16 1, i32 -1, i8 96, i8 1, i8 0, i32 802870693, i32 0, i32 343520923, i64 -2011881878479148928, i64 -6 }>, align 1
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  call void @llvm.lifetime.start(i64 37, i8* %88) #1
  call void @func_1(%struct.S0* sret %6)
  %89 = bitcast %struct.S0* %6 to i8*
  call void @llvm.lifetime.end(i64 37, i8* %89) #1
  %90 = load volatile i16, i16* getelementptr inbounds (%struct.S0, %struct.S0* bitcast (<{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }>* @g_2 to %struct.S0*), i32 0, i32 0), align 1, !tbaa !10
  ...
  %93 = load i32, i32* getelementptr inbounds (%struct.S0, %struct.S0* bitcast (<{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }>* @g_2 to %struct.S0*), i32 0, i32 1), align 1, !tbaa !13
  %94 = zext i32 %93 to i64
  %95 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %94, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), i32 %95)
  %96 = load i24, i24* bitcast ([3 x i8]* getelementptr inbounds (%struct.S0, %struct.S0* bitcast (<{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }>* @g_2 to %struct.S0*), i32 0, i32 2) to i24*), align 1
  %97 = and i24 %96, 524287
  %98 = zext i24 %97 to i32
  %99 = zext i32 %98 to i64
  %100 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %99, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i32 %100)
  %101 = load volatile i32, i32* getelementptr inbounds (%struct.S0, %struct.S0* bitcast (<{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }>* @g_2 to %struct.S0*), i32 0, i32 3), align 1, !tbaa !14
  %102 = sext i32 %101 to i64
  %103 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %102, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i32 0, i32 0), i32 %103)
  %104 = load volatile i32, i32* getelementptr inbounds (%struct.S0, %struct.S0* bitcast (<{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }>* @g_2 to %struct.S0*), i32 0, i32 4), align 1, !tbaa !15
  %105 = sext i32 %104 to i64
  %106 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %105, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.5, i32 0, i32 0), i32 %106)
  %107 = load i32, i32* getelementptr inbounds (%struct.S0, %struct.S0* bitcast (<{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }>* @g_2 to %struct.S0*), i32 0, i32 5), align 1, !tbaa !16
  %108 = zext i32 %107 to i64
  %109 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %108, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.6, i32 0, i32 0), i32 %109)
  %110 = load i64, i64* getelementptr inbounds (%struct.S0, %struct.S0* bitcast (<{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }>* @g_2 to %struct.S0*), i32 0, i32 6), align 1, !tbaa !17
  %111 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %110, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.7, i32 0, i32 0), i32 %111)
  %112 = load i64, i64* getelementptr inbounds (%struct.S0, %struct.S0* bitcast (<{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }>* @g_2 to %struct.S0*), i32 0, i32 7), align 1, !tbaa !18
  %113 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %112, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.8, i32 0, i32 0), i32 %113)
  %114 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %115 = zext i32 %114 to i64
  %116 = xor i64 %115, 4294967295
  %117 = trunc i64 %116 to i32
  %118 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %117, i32 %118)
  %119 = bitcast i32* %print_hash_value to i8*
...
define internal void @func_1(%struct.S0* noalias sret %agg.result) #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %1, i8* bitcast (<{ i16, i32, i8, i8, i8, i32, i32, i32, i64, i64 }>* @g_2 to i8*), i64 37, i32 1, i1 false), !tbaa.struct !19
  ret void
}
...
!9 = !{!3, !3, i64 0}
!10 = !{!11, !12, i64 0}
!11 = !{!"S0", !12, i64 0, !2, i64 2, !2, i64 6, !2, i64 9, !2, i64 13, !2, i64 17, !8, i64 21, !8, i64 29}
!12 = !{!"short", !3, i64 0}
!13 = !{!11, !2, i64 2}
!14 = !{!11, !2, i64 9}
!15 = !{!11, !2, i64 13}
...
!17 = !{!11, !8, i64 21}
!18 = !{!11, !8, i64 29}
!19 = !{i64 0, i64 2, !20, i64 2, i64 4, !1, i64 6, i64 4, !1, i64 9, i64 4, !1, i64 13, i64 4, !1, i64 17, i64 4, !1, i64 21, i64 8, !7, i64 29, i64 8, !7}
!20 = !{!12, !12, i64 0}
