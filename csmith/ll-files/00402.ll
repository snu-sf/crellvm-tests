...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %88 = load i16, i16* @g_4, align 2, !tbaa !10
...
define internal signext i16 @func_1() #0 {
  ...
  call void @llvm.lifetime.start(i64 4, i8* %2) #1
  store i32 -233838877, i32* %l_3, align 4, !tbaa !1
  %3 = load i32, i32* %l_2, align 4, !tbaa !1
  store i32 %3, i32* %l_3, align 4, !tbaa !1
  %4 = load i16, i16* @g_4, align 2, !tbaa !10
