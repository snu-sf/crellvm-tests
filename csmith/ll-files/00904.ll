...
@g_2 = internal global i16 -23710, align 2
@.str.1 = private unnamed_addr constant [4 x i8] c"g_2\00", align 1
@g_3 = internal global i32 1178848761, align 4
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %87 = call i32 @func_1()
  %88 = load i16, i16* @g_2, align 2, !tbaa !10
...
define internal i32 @func_1() #0 {
  %1 = load i16, i16* @g_2, align 2, !tbaa !10
  %2 = sext i16 %1 to i32
  store i32 %2, i32* @g_3, align 4, !tbaa !1
  br label %3

; <label>:3                                       ; preds = %8, %0
  %4 = load volatile i32**, i32*** @g_4, align 8, !tbaa !5
  store i32* @g_3, i32** %4, align 8, !tbaa !5
  %5 = load i32*, i32** @g_5, align 8, !tbaa !5
  store i32 8, i32* %5, align 4, !tbaa !1
  %6 = load i16, i16* @g_2, align 2, !tbaa !10
  %7 = icmp ne i16 %6, 0
