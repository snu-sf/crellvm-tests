...
@func_1.l_10 = private unnamed_addr constant [7 x [10 x i32]] [[10 x i32] [i32 9, i32 947970099, i32 947970099, i32 9, i32 713203978, i32 1977232547, i32 713203978, i32 9, i32 947970099, i32 947970099], [10 x i32] [i32 713203978, i32 947970099, i32 -336276579, i32 -1140569333, i32 -1140569333, i32 -336276579, i32 947970099, i32 713203978, i32 947970099, i32 -336276579], [10 x i32] [i32 1977232547, i32 9, i32 -1140569333, i32 9, i32 1977232547, i32 -336276579, i32 -336276579, i32 1977232547, i32 9, i32 -1140569333], [10 x i32] [i32 713203978, i32 713203978, i32 -1140569333, i32 1977232547, i32 1660301417, i32 1977232547, i32 -1140569333, i32 713203978, i32 713203978, i32 -1140569333], [10 x i32] [i32 9, i32 1977232547, i32 -336276579, i32 -336276579, i32 1977232547, i32 9, i32 713203978, i32 947970099, i32 -336276579, i32 -1140569333], [10 x i32] [i32 1977232547, i32 1660301417, i32 1977232547, i32 -1140569333, i32 713203978, i32 713203978, i32 -1140569333, i32 1977232547, i32 1660301417, i32 1977232547], [10 x i32] [i32 1977232547, i32 947970099, i32 1660301417, i32 -336276579, i32 1660301417, i32 947970099, i32 1977232547, i32 1977232547, i32 947970099, i32 1660301417]], align 16
...
define internal signext i8 @func_1() #0 {
  ...
  %3 = bitcast [7 x [10 x i32]]* %l_10 to i8*
  call void @llvm.lifetime.start(i64 280, i8* %3) #1
  %4 = bitcast [7 x [10 x i32]]* %l_10 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* bitcast ([7 x [10 x i32]]* @func_1.l_10 to i8*), i64 280, i32 16, i1 false)
  %5 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %5) #1
  %6 = bitcast i32* %j to i8*
  call void @llvm.lifetime.start(i64 4, i8* %6) #1
  %7 = load i32*, i32** %l_3, align 8, !tbaa !5
  %8 = load i32, i32* %7, align 4, !tbaa !1
  %9 = sext i32 %8 to i64
  %10 = or i64 %9, 387168528
...
; <label>:26                                      ; preds = %15
  ...
  %28 = call i32 @safe_sub_func_uint32_t_u_u(i32 %27, i32 3)
  store i32 %28, i32* @g_4, align 4, !tbaa !1
  br label %12
...
; <label>:30                                      ; preds = %48, %29
  %31 = load i32, i32* @g_9, align 4, !tbaa !1
...
; <label>:34                                      ; preds = %44, %33
  %35 = load i32, i32* @g_4, align 4, !tbaa !1
...
; <label>:37                                      ; preds = %34
  ...
  %40 = load i32, i32* @g_9, align 4, !tbaa !1
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds [7 x [10 x i32]], [7 x [10 x i32]]* %l_10, i32 0, i64 %41
  %43 = getelementptr inbounds [10 x i32], [10 x i32]* %42, i32 0, i64 %39
...
; <label>:44                                      ; preds = %37
  ...
  %46 = add nsw i32 %45, 1
  store i32 %46, i32* @g_4, align 4, !tbaa !1
  br label %34
...
; <label>:48                                      ; preds = %47
  ...
  %50 = add nsw i32 %49, 1
  store i32 %50, i32* @g_9, align 4, !tbaa !1
  br label %30

; <label>:51                                      ; preds = %30
  %52 = load i32*, i32** %l_3, align 8, !tbaa !5
  ...
  %57 = bitcast [7 x [10 x i32]]* %l_10 to i8*
  call void @llvm.lifetime.end(i64 280, i8* %57) #1
  %58 = bitcast i32** %l_3 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %58) #1
  %59 = bitcast i32** %l_2 to i8*
