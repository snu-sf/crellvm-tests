...
%struct.S2 = type { i32, i32, %struct.S1 }
%struct.S1 = type <{ i64, i32 }>

@.str = private unnamed_addr constant [2 x i8] c"1\00", align 1
@g_3 = internal global i32 -1829918483, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@g_20 = internal global i64 0, align 8
@.str.2 = private unnamed_addr constant [5 x i8] c"g_20\00", align 1
@g_21 = internal global i16 -1, align 2
@.str.3 = private unnamed_addr constant [5 x i8] c"g_21\00", align 1
@.str.4 = private unnamed_addr constant [8 x i8] c"g_24.f0\00", align 1
@.str.5 = private unnamed_addr constant [8 x i8] c"g_24.f1\00", align 1
@.str.6 = private unnamed_addr constant [11 x i8] c"g_24.f2.f0\00", align 1
@.str.7 = private unnamed_addr constant [11 x i8] c"g_24.f2.f1\00", align 1
@.str.8 = private unnamed_addr constant [11 x i8] c"g_24.f2.f2\00", align 1
@.str.9 = private unnamed_addr constant [11 x i8] c"g_24.f2.f3\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_19 = private unnamed_addr constant [8 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], align 16
@.str.10 = private unnamed_addr constant [36 x i8] c"...checksum after hashing %s : %lX\0A\00", align 1
@g_24 = internal global { i32, i32, { i8, i8, i8, i8, i8, i8, i8, i8, i32 } } { i32 0, i32 -1, { i8, i8, i8, i8, i8, i8, i8, i8, i32 } { i8 19, i8 32, i8 -33, i8 -1, i8 116, i8 11, i8 0, i8 0, i32 1018748932 } }, align 1
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %88 = bitcast %struct.S2* %6 to i8*
  call void @llvm.lifetime.start(i64 20, i8* %88) #1
  call void @func_1(%struct.S2* sret %6)
  %89 = bitcast %struct.S2* %6 to i8*
  call void @llvm.lifetime.end(i64 20, i8* %89) #1
  ...
  %93 = load i64, i64* @g_20, align 8, !tbaa !7
  ...
  %95 = load i16, i16* @g_21, align 2, !tbaa !10
  ...
  %98 = load volatile i32, i32* getelementptr inbounds (%struct.S2, %struct.S2* bitcast ({ i32, i32, { i8, i8, i8, i8, i8, i8, i8, i8, i32 } }* @g_24 to %struct.S2*), i32 0, i32 0), align 1, !tbaa !12
  %99 = zext i32 %98 to i64
  %100 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %99, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.4, i32 0, i32 0), i32 %100)
  %101 = load i32, i32* getelementptr inbounds (%struct.S2, %struct.S2* bitcast ({ i32, i32, { i8, i8, i8, i8, i8, i8, i8, i8, i32 } }* @g_24 to %struct.S2*), i32 0, i32 1), align 1, !tbaa !15
  %102 = zext i32 %101 to i64
  %103 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %102, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.5, i32 0, i32 0), i32 %103)
  %104 = load i64, i64* getelementptr inbounds (%struct.S2, %struct.S2* bitcast ({ i32, i32, { i8, i8, i8, i8, i8, i8, i8, i8, i32 } }* @g_24 to %struct.S2*), i32 0, i32 2, i32 0), align 1
  %105 = and i64 %104, 4095
  %106 = trunc i64 %105 to i32
  %107 = zext i32 %106 to i64
  %108 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %107, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.6, i32 0, i32 0), i32 %108)
  %109 = load volatile i64, i64* getelementptr inbounds (%struct.S2, %struct.S2* bitcast ({ i32, i32, { i8, i8, i8, i8, i8, i8, i8, i8, i32 } }* @g_24 to %struct.S2*), i32 0, i32 2, i32 0), align 1
  %110 = shl i64 %109, 32
  %111 = ashr i64 %110, 44
  ...
  %115 = load i64, i64* getelementptr inbounds (%struct.S2, %struct.S2* bitcast ({ i32, i32, { i8, i8, i8, i8, i8, i8, i8, i8, i32 } }* @g_24 to %struct.S2*), i32 0, i32 2, i32 0), align 1
  %116 = lshr i64 %115, 32
  %117 = and i64 %116, 268435455
  %118 = trunc i64 %117 to i32
  %119 = zext i32 %118 to i64
  %120 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %119, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.8, i32 0, i32 0), i32 %120)
  %121 = load volatile i32, i32* getelementptr inbounds (%struct.S2, %struct.S2* bitcast ({ i32, i32, { i8, i8, i8, i8, i8, i8, i8, i8, i32 } }* @g_24 to %struct.S2*), i32 0, i32 2, i32 1), align 1, !tbaa !16
  %122 = zext i32 %121 to i64
  %123 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %122, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.9, i32 0, i32 0), i32 %123)
  %124 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %125 = zext i32 %124 to i64
  %126 = xor i64 %125, 4294967295
  %127 = trunc i64 %126 to i32
  %128 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %127, i32 %128)
  %129 = bitcast i32* %print_hash_value to i8*
...
define internal void @func_1(%struct.S2* noalias sret %agg.result) #0 {
  ...
  store i32 1112927194, i32* %l_11, align 4, !tbaa !1
  %10 = bitcast i32** %l_12 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %10) #1
  store i32* %l_11, i32** %l_12, align 8, !tbaa !5
  %11 = bitcast i32** %l_13 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %11) #1
  store i32* @g_3, i32** %l_13, align 8, !tbaa !5
  %12 = bitcast i32** %l_14 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %12) #1
  store i32* @g_3, i32** %l_14, align 8, !tbaa !5
  %13 = bitcast i32* %l_15 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %13) #1
  store i32 343890412, i32* %l_15, align 4, !tbaa !1
  %14 = bitcast i32** %l_16 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %14) #1
  store i32* null, i32** %l_16, align 8, !tbaa !5
  %15 = bitcast i32** %l_17 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %15) #1
  store i32* %l_11, i32** %l_17, align 8, !tbaa !5
  %16 = bitcast i32** %l_18 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %16) #1
  store i32* null, i32** %l_18, align 8, !tbaa !5
  %17 = bitcast [8 x i32*]* %l_19 to i8*
  call void @llvm.lifetime.start(i64 64, i8* %17) #1
  %18 = bitcast [8 x i32*]* %l_19 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %18, i8* bitcast ([8 x i32*]* @func_1.l_19 to i8*), i64 64, i32 16, i1 false)
  %19 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %19) #1
  %20 = load i16, i16* @g_21, align 2, !tbaa !10
  %21 = add i16 %20, -1
  store i16 %21, i16* @g_21, align 2, !tbaa !10
  %22 = bitcast %struct.S2* %agg.result to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %22, i8* bitcast ({ i32, i32, { i8, i8, i8, i8, i8, i8, i8, i8, i32 } }* @g_24 to i8*), i64 20, i32 1, i1 false), !tbaa.struct !17
  %23 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %23) #1
  %24 = bitcast [8 x i32*]* %l_19 to i8*
  call void @llvm.lifetime.end(i64 64, i8* %24) #1
  %25 = bitcast i32** %l_18 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %25) #1
  %26 = bitcast i32** %l_17 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %26) #1
  %27 = bitcast i32** %l_16 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %27) #1
  %28 = bitcast i32* %l_15 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %28) #1
  %29 = bitcast i32** %l_14 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %29) #1
  %30 = bitcast i32** %l_13 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %30) #1
  %31 = bitcast i32** %l_12 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %31) #1
  %32 = bitcast i32* %l_11 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %32) #1
  %33 = bitcast i32** %l_10 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %33) #1
  %34 = bitcast i32** %l_9 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %34) #1
  %35 = bitcast i32** %l_8 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %35) #1
  %36 = bitcast i32** %l_7 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %36) #1
  %37 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %37) #1
  %38 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %38) #1
  %39 = bitcast i32** %l_4 to i8*
...
!11 = !{!"short", !3, i64 0}
!12 = !{!13, !2, i64 0}
!13 = !{!"S2", !2, i64 0, !2, i64 4, !14, i64 8}
!14 = !{!"S1", !2, i64 0, !2, i64 1, !2, i64 4, !2, i64 8}
!15 = !{!13, !2, i64 4}
!16 = !{!13, !2, i64 16}
!17 = !{i64 0, i64 4, !1, i64 4, i64 4, !1, i64 8, i64 4, !1, i64 9, i64 4, !1, i64 12, i64 4, !1, i64 16, i64 4, !1}
