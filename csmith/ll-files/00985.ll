...
@g_2 = internal global i64 -7988099436538227639, align 8
@.str.1 = private unnamed_addr constant [4 x i8] c"g_2\00", align 1
@g_6 = internal global [1 x i32] [i32 -54162943], align 4
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %88 = call i32 @func_1()
  %89 = load volatile i64, i64* @g_2, align 8, !tbaa !7
...
; <label>:94                                      ; preds = %91
  ...
  %97 = getelementptr inbounds [1 x i32], [1 x i32]* @g_6, i32 0, i64 %96
  %98 = load i32, i32* %97, align 4, !tbaa !1
  %99 = sext i32 %98 to i64
  %100 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %99, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), i32 %100)
...
; <label>:103                                     ; preds = %94
  ...
  %105 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.3, i32 0, i32 0), i32 %104)
  br label %106
...
; <label>:110                                     ; preds = %91
  %111 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %112 = zext i32 %111 to i64
  %113 = xor i64 %112, 4294967295
  %114 = trunc i64 %113 to i32
  %115 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %114, i32 %115)
  %116 = bitcast i32* %print_hash_value to i8*
...
define internal i32 @func_1() #0 {
  ...
  store i32* getelementptr inbounds ([1 x i32], [1 x i32]* @g_6, i32 0, i64 0), i32** %l_5, align 8, !tbaa !5
  %2 = load volatile i64, i64* @g_2, align 8, !tbaa !7
  %3 = add i64 %2, -1
  store volatile i64 %3, i64* @g_2, align 8, !tbaa !7
  %4 = load i32*, i32** %l_5, align 8, !tbaa !5
  store i32 -6, i32* %4, align 4, !tbaa !1
  %5 = load volatile i64, i64* @g_2, align 8, !tbaa !7
