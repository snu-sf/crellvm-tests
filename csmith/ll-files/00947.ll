...
@g_3 = internal global [5 x i32] zeroinitializer, align 16
...
@func_1.l_2 = private unnamed_addr constant [7 x [9 x i32]] [[9 x i32] [i32 6, i32 2, i32 -1, i32 6, i32 -1, i32 2, i32 6, i32 -5, i32 -5], [9 x i32] [i32 -9, i32 1, i32 -1928511621, i32 -9, i32 -1928511621, i32 1, i32 -9, i32 -1535906928, i32 -1535906928], [9 x i32] [i32 6, i32 2, i32 -1, i32 6, i32 -1, i32 2, i32 6, i32 -5, i32 -5], [9 x i32] [i32 -9, i32 1, i32 -1928511621, i32 -9, i32 -1928511621, i32 1, i32 -9, i32 -1535906928, i32 -1535906928], [9 x i32] [i32 6, i32 2, i32 -1, i32 6, i32 -1, i32 843371795, i32 -5, i32 7, i32 7], [9 x i32] [i32 -1535906928, i32 -359124719, i32 -941828502, i32 -1535906928, i32 -941828502, i32 -359124719, i32 -1535906928, i32 110297244, i32 110297244], [9 x i32] [i32 -5, i32 843371795, i32 1382887045, i32 -5, i32 1382887045, i32 843371795, i32 -5, i32 7, i32 7]], align 16
...
; <label>:108                                     ; preds = %89
  %109 = load i32, i32* @g_4, align 4, !tbaa !1
  %110 = sext i32 %109 to i64
  %111 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %110, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), i32 %111)
  %112 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %113 = zext i32 %112 to i64
  %114 = xor i64 %113, 4294967295
  %115 = trunc i64 %114 to i32
  %116 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %115, i32 %116)
  %117 = bitcast i32* %print_hash_value to i8*
...
define internal i64 @func_1() #0 {
  %l_2 = alloca [7 x [9 x i32]], align 16
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = bitcast [7 x [9 x i32]]* %l_2 to i8*
  call void @llvm.lifetime.start(i64 252, i8* %1) #1
  %2 = bitcast [7 x [9 x i32]]* %l_2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([7 x [9 x i32]]* @func_1.l_2 to i8*), i64 252, i32 16, i1 false)
  %3 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %3) #1
  %4 = bitcast i32* %j to i8*
  call void @llvm.lifetime.start(i64 4, i8* %4) #1
  store i32 0, i32* getelementptr inbounds ([5 x i32], [5 x i32]* @g_3, i32 0, i64 0), align 4, !tbaa !1
  br label %5

; <label>:5                                       ; preds = %23, %0
  %6 = load i32, i32* getelementptr inbounds ([5 x i32], [5 x i32]* @g_3, i32 0, i64 0), align 4, !tbaa !1
  %7 = icmp slt i32 %6, 7
...
; <label>:12                                      ; preds = %9
  ...
  %15 = load i32, i32* getelementptr inbounds ([5 x i32], [5 x i32]* @g_3, i32 0, i64 0), align 4, !tbaa !1
  %16 = sext i32 %15 to i64
  %17 = getelementptr inbounds [7 x [9 x i32]], [7 x [9 x i32]]* %l_2, i32 0, i64 %16
  %18 = getelementptr inbounds [9 x i32], [9 x i32]* %17, i32 0, i64 %14
  store i32 -1581155209, i32* %18, align 4, !tbaa !1
  br label %19

; <label>:19                                      ; preds = %12
  %20 = load i32, i32* @g_4, align 4, !tbaa !1
  %21 = add nsw i32 %20, 1
  store i32 %21, i32* @g_4, align 4, !tbaa !1
  br label %9
...
; <label>:23                                      ; preds = %22
  %24 = load i32, i32* getelementptr inbounds ([5 x i32], [5 x i32]* @g_3, i32 0, i64 0), align 4, !tbaa !1
  %25 = add nsw i32 %24, 1
  store i32 %25, i32* getelementptr inbounds ([5 x i32], [5 x i32]* @g_3, i32 0, i64 0), align 4, !tbaa !1
  br label %5

; <label>:26                                      ; preds = %5
  %27 = getelementptr inbounds [7 x [9 x i32]], [7 x [9 x i32]]* %l_2, i32 0, i64 1
  %28 = getelementptr inbounds [9 x i32], [9 x i32]* %27, i32 0, i64 3
  ...
  %33 = bitcast [7 x [9 x i32]]* %l_2 to i8*
  call void @llvm.lifetime.end(i64 252, i8* %33) #1
  ret i64 %30
}
