...
@g_2 = internal constant i32* @g_3, align 8
@g_4 = internal global i32* @g_5, align 8
@g_3 = internal constant i32 1, align 4
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %87 = call zeroext i8 @func_1()
  %88 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %88)
  %89 = load i32, i32* @g_5, align 4, !tbaa !1
  %90 = sext i32 %89 to i64
  %91 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %90, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 %91)
...
define internal zeroext i8 @func_1() #0 {
  ...
  store i64 8, i64* %l_6, align 8, !tbaa !7
  %2 = load volatile i32*, i32** @g_2, align 8, !tbaa !5
  store volatile i32* %2, i32** @g_4, align 8, !tbaa !5
  %3 = load i64, i64* %l_6, align 8, !tbaa !7
  %4 = trunc i64 %3 to i8
