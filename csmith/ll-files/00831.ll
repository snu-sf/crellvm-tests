...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  call void @transparent_crc(i64 -1025454249, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %88)
  %89 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %90 = zext i32 %89 to i64
  %91 = xor i64 %90, 4294967295
  %92 = trunc i64 %91 to i32
  %93 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %92, i32 %93)
  %94 = bitcast i32* %print_hash_value to i8*
