...
@g_9 = internal global i64 5, align 8
@.str.2 = private unnamed_addr constant [4 x i8] c"g_9\00", align 1
@g_11 = internal global [4 x i32] [i32 -1785099595, i32 -1785099595, i32 -1785099595, i32 -1785099595], align 16
...
@func_1.l_4 = private unnamed_addr constant [3 x [9 x i8*]] [[9 x i8*] [i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5], [9 x i8*] [i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5], [9 x i8*] [i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5, i8* @g_5]], align 16
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %89 = load i8, i8* @g_5, align 1, !tbaa !9
...
; <label>:97                                      ; preds = %94
  ...
  %100 = getelementptr inbounds [4 x i32], [4 x i32]* @g_11, i32 0, i64 %99
...
; <label>:106                                     ; preds = %97
  ...
  %108 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.4, i32 0, i32 0), i32 %107)
  br label %109
...
define internal zeroext i8 @func_1() #0 {
  %l_4 = alloca [3 x [9 x i8*]], align 16
  %l_6 = alloca [3 x i32], align 4
  %l_10 = alloca i32*, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = bitcast [3 x [9 x i8*]]* %l_4 to i8*
  call void @llvm.lifetime.start(i64 216, i8* %1) #1
  %2 = bitcast [3 x [9 x i8*]]* %l_4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([3 x [9 x i8*]]* @func_1.l_4 to i8*), i64 216, i32 16, i1 false)
  %3 = bitcast [3 x i32]* %l_6 to i8*
  call void @llvm.lifetime.start(i64 12, i8* %3) #1
  %4 = bitcast i32** %l_10 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %4) #1
  store i32* getelementptr inbounds ([4 x i32], [4 x i32]* @g_11, i32 0, i64 0), i32** %l_10, align 8, !tbaa !5
...
; <label>:10                                      ; preds = %7
  ...
  %13 = getelementptr inbounds [3 x i32], [3 x i32]* %l_6, i32 0, i64 %12
  store i32 741758029, i32* %13, align 4, !tbaa !1
  br label %14
...
; <label>:17                                      ; preds = %7
  ...
  %19 = add i8 %18, 1
  store i8 %19, i8* @g_5, align 1, !tbaa !9
  %20 = load volatile i64, i64* @g_9, align 8, !tbaa !7
  %21 = getelementptr inbounds [3 x i32], [3 x i32]* %l_6, i32 0, i64 2
  %22 = load i32, i32* %21, align 4, !tbaa !1
  %23 = sext i32 %22 to i64
  %24 = icmp uge i64 %20, %23
  %25 = zext i1 %24 to i32
  %26 = trunc i32 %25 to i8
  %27 = call zeroext i8 @safe_mul_func_uint8_t_u_u(i8 zeroext %18, i8 zeroext %26)
  %28 = zext i8 %27 to i32
  %29 = load i32*, i32** %l_10, align 8, !tbaa !5
  %30 = load i32, i32* %29, align 4, !tbaa !1
  %31 = xor i32 %30, %28
  store i32 %31, i32* %29, align 4, !tbaa !1
  %32 = load i32*, i32** %l_10, align 8, !tbaa !5
  ...
  %37 = bitcast i32** %l_10 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %37) #1
  %38 = bitcast [3 x i32]* %l_6 to i8*
  call void @llvm.lifetime.end(i64 12, i8* %38) #1
  %39 = bitcast [3 x [9 x i8*]]* %l_4 to i8*
  call void @llvm.lifetime.end(i64 216, i8* %39) #1
  ret i8 %34
}
