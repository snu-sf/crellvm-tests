...
@g_2 = internal global i32 1136572182, align 4
...
define internal signext i8 @func_1() #0 {
  ...
  call void @llvm.lifetime.start(i64 4, i8* %3) #1
  store i32 -10, i32* %l_5, align 4, !tbaa !1
  store i32 0, i32* @g_2, align 4, !tbaa !1
  br label %4

; <label>:4                                       ; preds = %10, %0
  %5 = load i32, i32* @g_2, align 4, !tbaa !1
  %6 = icmp sle i32 %5, -4
...
; <label>:7                                       ; preds = %4
  ...
  br label %18
                                                  ; No predecessors!
  %11 = load i32, i32* @g_2, align 4, !tbaa !1
  %12 = trunc i32 %11 to i8
  %13 = call signext i8 @safe_sub_func_int8_t_s_s(i8 signext %12, i8 signext 6)
  %14 = sext i8 %13 to i32
  store i32 %14, i32* @g_2, align 4, !tbaa !1
  br label %4

; <label>:15                                      ; preds = %4
  %16 = load i32, i32* %l_5, align 4, !tbaa !1
