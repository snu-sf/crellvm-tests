...
@g_3 = internal global i32 164374010, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_2 = private unnamed_addr constant [2 x [5 x i32*]] [[5 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], [5 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3]], align 16
...
define internal signext i8 @func_1() #0 {
  %l_2 = alloca [2 x [5 x i32*]], align 16
  %l_4 = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = bitcast [2 x [5 x i32*]]* %l_2 to i8*
  call void @llvm.lifetime.start(i64 80, i8* %1) #1
  %2 = bitcast [2 x [5 x i32*]]* %l_2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([2 x [5 x i32*]]* @func_1.l_2 to i8*), i64 80, i32 16, i1 false)
  ...
  store i32 -1172573518, i32* %l_4, align 4, !tbaa !1
  ...
  %11 = bitcast [2 x [5 x i32*]]* %l_2 to i8*
  call void @llvm.lifetime.end(i64 80, i8* %11) #1
  ret i8 %7
}
