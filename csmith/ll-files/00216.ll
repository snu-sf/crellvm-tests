...
@g_10 = internal global i32 -233693296, align 4
@.str.3 = private unnamed_addr constant [5 x i8] c"g_10\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_9 = private unnamed_addr constant [6 x [1 x [4 x i32*]]] [[1 x [4 x i32*]] [[4 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4]], [1 x [4 x i32*]] [[4 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4]], [1 x [4 x i32*]] [[4 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4]], [1 x [4 x i32*]] [[4 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4]], [1 x [4 x i32*]] [[4 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4]], [1 x [4 x i32*]] [[4 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4]]], align 16
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %87 = call i32 @func_1()
  %88 = load i64, i64* @g_2, align 8, !tbaa !7
  %89 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %88, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %89)
  ...
  %93 = load i32, i32* @g_10, align 4, !tbaa !1
...
define internal i32 @func_1() #0 {
  ...
  %l_9 = alloca [6 x [1 x [4 x i32*]]], align 16
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  call void @llvm.lifetime.start(i64 4, i8* %4) #1
  store i32 -586996596, i32* %l_7, align 4, !tbaa !1
  %5 = bitcast i32** %l_8 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %5) #1
  store i32* @g_4, i32** %l_8, align 8, !tbaa !5
  %6 = bitcast [6 x [1 x [4 x i32*]]]* %l_9 to i8*
  call void @llvm.lifetime.start(i64 192, i8* %6) #1
  %7 = bitcast [6 x [1 x [4 x i32*]]]* %l_9 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %7, i8* bitcast ([6 x [1 x [4 x i32*]]]* @func_1.l_9 to i8*), i64 192, i32 16, i1 false)
  ...
  %11 = load i32, i32* @g_10, align 4, !tbaa !1
  %12 = add i32 %11, 1
  store i32 %12, i32* @g_10, align 4, !tbaa !1
  %13 = load i32*, i32** %l_8, align 8, !tbaa !5
  ...
  %18 = bitcast [6 x [1 x [4 x i32*]]]* %l_9 to i8*
  call void @llvm.lifetime.end(i64 192, i8* %18) #1
  %19 = bitcast i32** %l_8 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %19) #1
  %20 = bitcast i32* %l_7 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %20) #1
  %21 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %21) #1
  %22 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %22) #1
  %23 = bitcast i32** %l_3 to i8*
