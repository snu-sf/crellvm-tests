...
@.str.10 = private unnamed_addr constant [8 x i8] c"g_14.f0\00", align 1
@.str.11 = private unnamed_addr constant [8 x i8] c"g_14.f1\00", align 1
@g_18 = internal global i32 644367647, align 4
@.str.12 = private unnamed_addr constant [5 x i8] c"g_18\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@g_17 = internal global i32* @g_18, align 8
@.str.13 = private unnamed_addr constant [36 x i8] c"...checksum after hashing %s : %lX\0A\00", align 1
@g_14 = internal global { i32, [4 x i8] } { i32 -1, [4 x i8] undef }, align 8
@.str.14 = private unnamed_addr constant [15 x i8] c"checksum = %X\0A\00", align 1
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  call void @transparent_crc(i64 %101, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i32 0, i32 0), i32 %102)
  %103 = load volatile i32, i32* @g_8, align 4, !tbaa !1
  %104 = sext i32 %103 to i64
  %105 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %104, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i32 0, i32 0), i32 %105)
  %106 = load volatile i32, i32* @g_9, align 4, !tbaa !1
  %107 = sext i32 %106 to i64
  %108 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %107, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i32 0, i32 0), i32 %108)
  %109 = load i32, i32* @g_10, align 4, !tbaa !1
  %110 = sext i32 %109 to i64
  %111 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %110, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.8, i32 0, i32 0), i32 %111)
  %112 = load i32, i32* @g_11, align 4, !tbaa !1
  %113 = sext i32 %112 to i64
  %114 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %113, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.9, i32 0, i32 0), i32 %114)
  %115 = load i32, i32* getelementptr inbounds ({ i32, [4 x i8] }, { i32, [4 x i8] }* @g_14, i32 0, i32 0), align 4, !tbaa !1
  %116 = sext i32 %115 to i64
  %117 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %116, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.10, i32 0, i32 0), i32 %117)
  %118 = load volatile i32, i32* getelementptr inbounds ({ i32, [4 x i8] }, { i32, [4 x i8] }* @g_14, i32 0, i32 0), align 4, !tbaa !1
  %119 = zext i32 %118 to i64
  %120 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %119, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.11, i32 0, i32 0), i32 %120)
  %121 = load i32, i32* @g_18, align 4, !tbaa !1
...
define internal signext i16 @func_1() #0 {
  ...
  %i = alloca i32, align 4
  %l_13 = alloca %union.U1*, align 8
  %l_12 = alloca %union.U1**, align 8
  %i1 = alloca i32, align 4
  %2 = alloca i32
  %i2 = alloca i32, align 4
  %3 = bitcast [5 x i64]* %l_2 to i8*
  ...
  store i32 -253772733, i32* %l_19, align 4, !tbaa !1
...
; <label>:16                                      ; preds = %13
  %17 = bitcast %union.U1** %l_13 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %17) #1
  store %union.U1* bitcast ({ i32, [4 x i8] }* @g_14 to %union.U1*), %union.U1** %l_13, align 8, !tbaa !5
  %18 = bitcast %union.U1*** %l_12 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %18) #1
  store %union.U1** %l_13, %union.U1*** %l_12, align 8, !tbaa !5
  store i32 0, i32* @g_11, align 4, !tbaa !1
  br label %19

; <label>:19                                      ; preds = %30, %16
  %20 = load i32, i32* @g_11, align 4, !tbaa !1
...
; <label>:22                                      ; preds = %19
  ...
  %24 = load i32, i32* @g_10, align 4, !tbaa !1
  ...
  br label %53
                                                  ; No predecessors!
  %31 = load i32, i32* @g_11, align 4, !tbaa !1
  %32 = add nsw i32 %31, 1
  store i32 %32, i32* @g_11, align 4, !tbaa !1
  br label %19

; <label>:33                                      ; preds = %19
  %34 = load %union.U1**, %union.U1*** %l_12, align 8, !tbaa !5
  store %union.U1* null, %union.U1** %34, align 8, !tbaa !5
  store i32 4, i32* @g_11, align 4, !tbaa !1
  br label %35
...
; <label>:38                                      ; preds = %35
  ...
  %40 = load i32, i32* @g_10, align 4, !tbaa !1
  %41 = sext i32 %40 to i64
  %42 = getelementptr inbounds [5 x i64], [5 x i64]* %l_2, i32 0, i64 %41
  %43 = load i64, i64* %42, align 8, !tbaa !7
  %44 = trunc i64 %43 to i16
  %45 = call signext i16 @safe_lshift_func_int16_t_s_s(i16 signext %44, i32 14)
  %46 = sext i16 %45 to i32
  %47 = load volatile i32*, i32** @g_17, align 8, !tbaa !5
...
; <label>:49                                      ; preds = %38
  %50 = load i32, i32* @g_11, align 4, !tbaa !1
  %51 = sub nsw i32 %50, 1
  store i32 %51, i32* @g_11, align 4, !tbaa !1
  br label %35
...
; <label>:53                                      ; preds = %52, %22
  %54 = bitcast %union.U1*** %l_12 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %54) #1
  %55 = bitcast %union.U1** %l_13 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %55) #1
  %cleanup.dest = load i32, i32* %2
  switch i32 %cleanup.dest, label %63 [
    i32 0, label %56
  ]
...
; <label>:57                                      ; preds = %56
  %58 = load i32, i32* @g_10, align 4, !tbaa !1
  %59 = add nsw i32 %58, 1
  store i32 %59, i32* @g_10, align 4, !tbaa !1
  br label %13

; <label>:60                                      ; preds = %13
  %61 = load i32, i32* %l_19, align 4, !tbaa !1
...
; <label>:63                                      ; preds = %60, %53
  ...
  %65 = bitcast i32* %l_19 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %65) #1
  %66 = bitcast [5 x i64]* %l_2 to i8*
...
; <label>:7                                       ; preds = %0
  ...
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.13, i32 0, i32 0), i8* %8, i64 %11)
  br label %13
...
define internal void @platform_main_end(i32 %crc, i32 %flag) #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.14, i32 0, i32 0), i32 %3)
  ret void
}
