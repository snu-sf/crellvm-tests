...
@g_4 = internal global i32 -1321846548, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_4\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_3 = private unnamed_addr constant [10 x [5 x i32*]] [[5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4]], align 16
...
define internal signext i8 @func_1() #0 {
  ...
  %l_3 = alloca [10 x [5 x i32*]], align 16
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  call void @llvm.lifetime.start(i64 1, i8* %l_2) #1
  store i8 0, i8* %l_2, align 1, !tbaa !9
  %1 = bitcast [10 x [5 x i32*]]* %l_3 to i8*
  call void @llvm.lifetime.start(i64 400, i8* %1) #1
  %2 = bitcast [10 x [5 x i32*]]* %l_3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([10 x [5 x i32*]]* @func_1.l_3 to i8*), i64 400, i32 16, i1 false)
  %3 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %3) #1
  %4 = bitcast i32* %j to i8*
  call void @llvm.lifetime.start(i64 4, i8* %4) #1
  ...
  %7 = getelementptr inbounds [10 x [5 x i32*]], [10 x [5 x i32*]]* %l_3, i32 0, i64 7
  %8 = getelementptr inbounds [5 x i32*], [5 x i32*]* %7, i32 0, i64 1
  store i32* null, i32** %8, align 8, !tbaa !5
  %9 = getelementptr inbounds [10 x [5 x i32*]], [10 x [5 x i32*]]* %l_3, i32 0, i64 9
  %10 = getelementptr inbounds [5 x i32*], [5 x i32*]* %9, i32 0, i64 4
  %11 = load i32*, i32** %10, align 8, !tbaa !5
  %12 = icmp ne i32* %11, @g_4
  %13 = zext i1 %12 to i32
  store i32 %13, i32* @g_4, align 4, !tbaa !1
  %14 = load i32, i32* @g_4, align 4, !tbaa !1
  %15 = trunc i32 %14 to i8
  %16 = bitcast i32* %j to i8*
  call void @llvm.lifetime.end(i64 4, i8* %16) #1
  %17 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %17) #1
  %18 = bitcast [10 x [5 x i32*]]* %l_3 to i8*
  call void @llvm.lifetime.end(i64 400, i8* %18) #1
