...
@func_1.l_3 = private unnamed_addr constant [7 x [2 x [2 x i32*]]] [[2 x [2 x i32*]] [[2 x i32*] [i32* @g_4, i32* @g_4], [2 x i32*] [i32* null, i32* @g_4]], [2 x [2 x i32*]] [[2 x i32*] [i32* null, i32* @g_4], [2 x i32*] [i32* @g_4, i32* @g_4]], [2 x [2 x i32*]] [[2 x i32*] [i32* @g_4, i32* @g_4], [2 x i32*] [i32* null, i32* @g_4]], [2 x [2 x i32*]] [[2 x i32*] [i32* @g_4, i32* @g_4], [2 x i32*] [i32* @g_4, i32* @g_4]], [2 x [2 x i32*]] [[2 x i32*] [i32* @g_4, i32* @g_4], [2 x i32*] [i32* @g_4, i32* @g_4]], [2 x [2 x i32*]] [[2 x i32*] [i32* @g_4, i32* @g_4], [2 x i32*] [i32* null, i32* @g_4]], [2 x [2 x i32*]] [[2 x i32*] [i32* @g_4, i32* @g_4], [2 x i32*] [i32* @g_4, i32* @g_4]]], align 16
...
define internal signext i8 @func_1() #0 {
  ...
  %l_3 = alloca [7 x [2 x [2 x i32*]]], align 16
  ...
  %2 = bitcast [7 x [2 x [2 x i32*]]]* %l_3 to i8*
  call void @llvm.lifetime.start(i64 224, i8* %2) #1
  %3 = bitcast [7 x [2 x [2 x i32*]]]* %l_3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* bitcast ([7 x [2 x [2 x i32*]]]* @func_1.l_3 to i8*), i64 224, i32 16, i1 false)
  call void @llvm.lifetime.start(i64 1, i8* %l_5) #1
  store i8 53, i8* %l_5, align 1, !tbaa !9
  ...
  %8 = sext i32 %7 to i64
  %9 = and i64 %8, 1701330063
  %10 = trunc i64 %9 to i32
  store i32 %10, i32* @g_4, align 4, !tbaa !1
  %11 = load i8, i8* %l_5, align 1, !tbaa !9
  ...
  %15 = bitcast [7 x [2 x [2 x i32*]]]* %l_3 to i8*
