...
@g_3 = internal global [4 x i32] [i32 6, i32 6, i32 6, i32 6], align 16
@.str.1 = private unnamed_addr constant [7 x i8] c"g_3[i]\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"index = [%d]\0A\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_2 = private unnamed_addr constant [9 x [3 x i32*]] [[3 x i32*] [i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* getelementptr inbounds ([4 x i32], [4 x i32]* @g_3, i32 0, i32 0)], [3 x i32*] [i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 8) to i32*), i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 8) to i32*), i32* null], [3 x i32*] [i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* getelementptr inbounds ([4 x i32], [4 x i32]* @g_3, i32 0, i32 0)], [3 x i32*] [i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 8) to i32*), i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 8) to i32*), i32* null], [3 x i32*] [i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* getelementptr inbounds ([4 x i32], [4 x i32]* @g_3, i32 0, i32 0)], [3 x i32*] [i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 8) to i32*), i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 8) to i32*), i32* null], [3 x i32*] [i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* getelementptr inbounds ([4 x i32], [4 x i32]* @g_3, i32 0, i32 0)], [3 x i32*] [i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 8) to i32*), i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 8) to i32*), i32* null], [3 x i32*] [i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_3 to i8*), i64 12) to i32*), i32* getelementptr inbounds ([4 x i32], [4 x i32]* @g_3, i32 0, i32 0)]], align 16
...
; <label>:92                                      ; preds = %89
  ...
  %95 = getelementptr inbounds [4 x i32], [4 x i32]* @g_3, i32 0, i64 %94
...
define internal i32 @func_1() #0 {
  %l_2 = alloca [9 x [3 x i32*]], align 16
  ...
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = bitcast [9 x [3 x i32*]]* %l_2 to i8*
  call void @llvm.lifetime.start(i64 216, i8* %1) #1
  %2 = bitcast [9 x [3 x i32*]]* %l_2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([9 x [3 x i32*]]* @func_1.l_2 to i8*), i64 216, i32 16, i1 false)
  %3 = bitcast i16* %l_4 to i8*
  call void @llvm.lifetime.start(i64 2, i8* %3) #1
  store i16 5, i16* %l_4, align 2, !tbaa !10
  %4 = bitcast i64* %l_5 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %4) #1
  store i64 -6888027957058519629, i64* %l_5, align 8, !tbaa !7
  %5 = bitcast i32* %l_6 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %5) #1
  store i32 -1599780120, i32* %l_6, align 4, !tbaa !1
  ...
  %9 = load i32, i32* %l_6, align 4, !tbaa !1
  %10 = add i32 %9, -1
  store i32 %10, i32* %l_6, align 4, !tbaa !1
  %11 = load i32, i32* %l_9, align 4, !tbaa !1
  ...
  %15 = bitcast i32* %l_6 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %15) #1
  %16 = bitcast i64* %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %16) #1
  %17 = bitcast i16* %l_4 to i8*
  call void @llvm.lifetime.end(i64 2, i8* %17) #1
  %18 = bitcast [9 x [3 x i32*]]* %l_2 to i8*
  call void @llvm.lifetime.end(i64 216, i8* %18) #1
  ret i32 %11
}
