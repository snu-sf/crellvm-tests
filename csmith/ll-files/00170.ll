...
%union.U3 = type { i32, [24 x i8] }

@.str = private unnamed_addr constant [2 x i8] c"1\00", align 1
@g_2 = internal global %union.U3 { i32 1293449387, [24 x i8] undef }, align 4
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %88 = bitcast %union.U3* %6 to i8*
  call void @llvm.lifetime.start(i64 28, i8* %88) #1
  call void @func_1(%union.U3* sret %6)
  %89 = bitcast %union.U3* %6 to i8*
  call void @llvm.lifetime.end(i64 28, i8* %89) #1
  %90 = load volatile i32, i32* getelementptr inbounds (%union.U3, %union.U3* @g_2, i32 0, i32 0), align 4, !tbaa !1
  ...
  %93 = load i16, i16* bitcast (%union.U3* @g_2 to i16*), align 2, !tbaa !10
  ...
  %96 = load i32, i32* getelementptr inbounds (%union.U3, %union.U3* @g_2, i32 0, i32 0), align 4, !tbaa !1
  %97 = sext i32 %96 to i64
  %98 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %97, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i32 %98)
...
define internal void @func_1(%union.U3* noalias sret %agg.result) #0 {
  %1 = bitcast %union.U3* %agg.result to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %1, i8* bitcast (%union.U3* @g_2 to i8*), i64 28, i32 4, i1 false), !tbaa.struct !12
  ret void
}
...
!10 = !{!11, !11, i64 0}
!11 = !{!"short", !3, i64 0}
!12 = !{i64 0, i64 4, !1, i64 0, i64 2, !10, i64 0, i64 4, !1, i64 0, i64 2, !10, i64 2, i64 4, !1, i64 6, i64 4, !1, i64 10, i64 8, !7, i64 18, i64 8, !7, i64 26, i64 1, !9}
