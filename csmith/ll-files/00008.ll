...
@g_3 = internal global i32 2072267381, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@.str.2 = private unnamed_addr constant [7 x i8] c"g_4.f0\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@.str.3 = private unnamed_addr constant [36 x i8] c"...checksum after hashing %s : %lX\0A\00", align 1
@g_4 = internal global { i8, i8, i8, i8 } { i8 -8, i8 -1, i8 -1, i8 3 }, align 4
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %93 = load i32, i32* getelementptr inbounds (%union.U2, %union.U2* bitcast ({ i8, i8, i8, i8 }* @g_4 to %union.U2*), i32 0, i32 0), align 4
  %94 = shl i32 %93, 6
  %95 = ashr i32 %94, 6
  ...
  %98 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %99 = zext i32 %98 to i64
  %100 = xor i64 %99, 4294967295
  %101 = trunc i64 %100 to i32
  %102 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %101, i32 %102)
  %103 = bitcast i32* %print_hash_value to i8*
...
; <label>:7                                       ; preds = %4
  ...
  %9 = sext i32 %8 to i64
  %10 = getelementptr inbounds [4 x i32*], [4 x i32*]* %l_2, i32 0, i64 %9
...
; <label>:14                                      ; preds = %4
  ...
  %19 = bitcast %union.U2* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %19, i8* getelementptr inbounds ({ i8, i8, i8, i8 }, { i8, i8, i8, i8 }* @g_4, i32 0, i32 0), i64 4, i32 4, i1 false), !tbaa.struct !10
  %20 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %20) #1
  %21 = bitcast [4 x i32*]* %l_2 to i8*
  call void @llvm.lifetime.end(i64 32, i8* %21) #1
  %22 = getelementptr %union.U2, %union.U2* %1, i32 0, i32 0
...
!8 = !{!"long", !3, i64 0}
!9 = !{!3, !3, i64 0}
!10 = !{i64 0, i64 4, !1, i64 0, i64 4, !1, i64 0, i64 4, !1}
