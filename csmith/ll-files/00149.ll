...
@g_5 = internal global [10 x i16] [i16 1, i16 0, i16 -29521, i16 -29521, i16 0, i16 1, i16 0, i16 -29521, i16 -29521, i16 0], align 16
...
@g_6 = internal global i32 -2051651700, align 4
@.str.4 = private unnamed_addr constant [4 x i8] c"g_6\00", align 1
@g_7 = internal global i16 16073, align 2
@.str.5 = private unnamed_addr constant [4 x i8] c"g_7\00", align 1
@g_8 = internal global i8 -2, align 1
@.str.6 = private unnamed_addr constant [4 x i8] c"g_8\00", align 1
@g_9 = internal global i8 -13, align 1
@.str.7 = private unnamed_addr constant [4 x i8] c"g_9\00", align 1
@g_10 = internal global i16 -6802, align 2
@.str.8 = private unnamed_addr constant [5 x i8] c"g_10\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_4 = private unnamed_addr constant [7 x [10 x [3 x i32*]]] [[10 x [3 x i32*]] [[3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null]], [10 x [3 x i32*]] [[3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null]], [10 x [3 x i32*]] [[3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null]], [10 x [3 x i32*]] [[3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null]], [10 x [3 x i32*]] [[3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null]], [10 x [3 x i32*]] [[3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null]], [10 x [3 x i32*]] [[3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null], [3 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3], [3 x i32*] [i32* @g_3, i32* null, i32* null]]], align 16
@g_14 = internal global [10 x i32*] [i32* @g_6, i32* @g_6, i32* @g_6, i32* @g_6, i32* @g_6, i32* @g_6, i32* @g_6, i32* @g_6, i32* @g_6, i32* @g_6], align 16
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %89 = load i32, i32* @g_3, align 4, !tbaa !1
...
; <label>:95                                      ; preds = %92
  ...
  %98 = getelementptr inbounds [10 x i16], [10 x i16]* @g_5, i32 0, i64 %97
...
; <label>:111                                     ; preds = %92
  %112 = load i32, i32* @g_6, align 4, !tbaa !1
  %113 = sext i32 %112 to i64
  %114 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %113, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.4, i32 0, i32 0), i32 %114)
  %115 = load volatile i16, i16* @g_7, align 2, !tbaa !10
  %116 = sext i16 %115 to i64
  %117 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %116, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.5, i32 0, i32 0), i32 %117)
  %118 = load volatile i8, i8* @g_8, align 1, !tbaa !9
  %119 = sext i8 %118 to i64
  %120 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %119, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.6, i32 0, i32 0), i32 %120)
  %121 = load volatile i8, i8* @g_9, align 1, !tbaa !9
  %122 = sext i8 %121 to i64
  %123 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %122, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.7, i32 0, i32 0), i32 %123)
  %124 = load volatile i16, i16* @g_10, align 2, !tbaa !10
...
define internal zeroext i8 @func_1() #0 {
  ...
  %l_4 = alloca [7 x [10 x [3 x i32*]]], align 16
  ...
  %2 = bitcast [7 x [10 x [3 x i32*]]]* %l_4 to i8*
  call void @llvm.lifetime.start(i64 1680, i8* %2) #1
  %3 = bitcast [7 x [10 x [3 x i32*]]]* %l_4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* bitcast ([7 x [10 x [3 x i32*]]]* @func_1.l_4 to i8*), i64 1680, i32 16, i1 false)
...
; <label>:11                                      ; preds = %8
  ...
  %14 = getelementptr inbounds [2 x i32**], [2 x i32**]* %l_13, i32 0, i64 %13
  store i32** %l_2, i32*** %14, align 8, !tbaa !5
  br label %15
...
; <label>:18                                      ; preds = %8
  %19 = load volatile i16, i16* @g_10, align 2, !tbaa !10
  %20 = add i16 %19, -1
  store volatile i16 %20, i16* @g_10, align 2, !tbaa !10
  store i32* @g_3, i32** getelementptr inbounds ([10 x i32*], [10 x i32*]* @g_14, i32 0, i64 9), align 8, !tbaa !5
  %21 = load i16, i16* getelementptr inbounds ([10 x i16], [10 x i16]* @g_5, i32 0, i64 4), align 2, !tbaa !10
  ...
  %26 = bitcast [2 x i32**]* %l_13 to i8*
  call void @llvm.lifetime.end(i64 16, i8* %26) #1
  %27 = bitcast [7 x [10 x [3 x i32*]]]* %l_4 to i8*
  call void @llvm.lifetime.end(i64 1680, i8* %27) #1
  %28 = bitcast i32** %l_2 to i8*
