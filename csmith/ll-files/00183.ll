...
@g_2 = internal global i16 1, align 2
@.str.1 = private unnamed_addr constant [4 x i8] c"g_2\00", align 1
@g_4 = internal global i32 -5306592, align 4
@.str.2 = private unnamed_addr constant [4 x i8] c"g_4\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@g_3 = internal constant i32* @g_4, align 8
...
define internal i32 @func_1() #0 {
  ...
  call void @llvm.lifetime.start(i64 4, i8* %1) #1
  store i32 1195811265, i32* %l_5, align 4, !tbaa !1
  %2 = load i16, i16* @g_2, align 2, !tbaa !10
  %3 = sext i16 %2 to i32
  %4 = load volatile i32*, i32** @g_3, align 8, !tbaa !5
  store i32 %3, i32* %4, align 4, !tbaa !1
  %5 = load i32, i32* %l_5, align 4, !tbaa !1
