...
@g_4 = internal global i32 -1801280268, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_4\00", align 1
@g_5 = internal global i8 -93, align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"g_5\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_3 = private unnamed_addr constant [1 x [5 x i32*]] [[5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4]], align 16
...
define internal i32 @func_1() #0 {
  %l_3 = alloca [1 x [5 x i32*]], align 16
  %l_2 = alloca i32**, align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = bitcast [1 x [5 x i32*]]* %l_3 to i8*
  call void @llvm.lifetime.start(i64 40, i8* %1) #1
  %2 = bitcast [1 x [5 x i32*]]* %l_3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([1 x [5 x i32*]]* @func_1.l_3 to i8*), i64 40, i32 16, i1 false)
  %3 = bitcast i32*** %l_2 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %3) #1
  %4 = getelementptr inbounds [1 x [5 x i32*]], [1 x [5 x i32*]]* %l_3, i32 0, i64 0
  %5 = getelementptr inbounds [5 x i32*], [5 x i32*]* %4, i32 0, i64 1
  store i32** %5, i32*** %l_2, align 8, !tbaa !5
  %6 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %6) #1
  %7 = bitcast i32* %j to i8*
  call void @llvm.lifetime.start(i64 4, i8* %7) #1
  %8 = load i32**, i32*** %l_2, align 8, !tbaa !5
  ...
  %14 = bitcast [1 x [5 x i32*]]* %l_3 to i8*
  call void @llvm.lifetime.end(i64 40, i8* %14) #1
  ret i32 %10
}
