...
@g_11 = internal global i16 -15981, align 2
@.str.3 = private unnamed_addr constant [5 x i8] c"g_11\00", align 1
@g_12 = internal global [2 x i16] [i16 -1624, i16 -1624], align 2
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %89 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 -5, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %89)
  ...
  %93 = load i16, i16* @g_11, align 2, !tbaa !10
...
; <label>:99                                      ; preds = %96
  ...
  %102 = getelementptr inbounds [2 x i16], [2 x i16]* @g_12, i32 0, i64 %101
...
; <label>:108                                     ; preds = %99
  ...
  %110 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.5, i32 0, i32 0), i32 %109)
  br label %111
...
; <label>:115                                     ; preds = %96
  %116 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %117 = zext i32 %116 to i64
  %118 = xor i64 %117, 4294967295
  %119 = trunc i64 %118 to i32
  %120 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %119, i32 %120)
  %121 = bitcast i32* %print_hash_value to i8*
...
define internal zeroext i8 @func_1() #0 {
  ...
  %l_10 = alloca [1 x i32*], align 8
  %i = alloca i32, align 4
  %1 = bitcast i32* %l_4 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %1) #1
  store i32 -1469340548, i32* %l_4, align 4, !tbaa !1
  ...
  store i32* @g_6, i32** %l_9, align 8, !tbaa !5
  %6 = bitcast [1 x i32*]* %l_10 to i8*
...
; <label>:11                                      ; preds = %8
  ...
  %14 = getelementptr inbounds [1 x i32*], [1 x i32*]* %l_10, i32 0, i64 %13
...
; <label>:18                                      ; preds = %8
  store i32 -5, i32* %l_4, align 4, !tbaa !1
  %19 = load volatile i16, i16* getelementptr inbounds ([2 x i16], [2 x i16]* @g_12, i32 0, i64 1), align 2, !tbaa !10
  %20 = add i16 %19, 1
  store volatile i16 %20, i16* getelementptr inbounds ([2 x i16], [2 x i16]* @g_12, i32 0, i64 1), align 2, !tbaa !10
  %21 = load i32*, i32** %l_8, align 8, !tbaa !5
  %22 = load i32, i32* %21, align 4, !tbaa !1
  %23 = trunc i32 %22 to i8
  %24 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %24) #1
  %25 = bitcast [1 x i32*]* %l_10 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %25) #1
  %26 = bitcast i32** %l_9 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %26) #1
  %27 = bitcast i32** %l_8 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %27) #1
  %28 = bitcast i32** %l_7 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %28) #1
  %29 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %29) #1
  %30 = bitcast i32* %l_4 to i8*
