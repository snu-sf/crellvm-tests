...
@g_2 = internal global i8 -14, align 1
@.str.1 = private unnamed_addr constant [4 x i8] c"g_2\00", align 1
@g_4 = internal global [4 x i32] [i32 -10, i32 -10, i32 -10, i32 -10], align 16
...
@g_3 = internal global i32* bitcast (i8* getelementptr (i8, i8* bitcast ([4 x i32]* @g_4 to i8*), i64 8) to i32*), align 8
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %89 = load i8, i8* @g_2, align 1, !tbaa !9
...
; <label>:95                                      ; preds = %92
  ...
  %98 = getelementptr inbounds [4 x i32], [4 x i32]* @g_4, i32 0, i64 %97
...
define internal signext i16 @func_1() #0 {
  %1 = load i8, i8* @g_2, align 1, !tbaa !9
  %2 = sext i8 %1 to i64
  %3 = icmp sle i64 -1, %2
  %4 = zext i1 %3 to i32
  %5 = load volatile i32*, i32** @g_3, align 8, !tbaa !5
  store i32 %4, i32* %5, align 4, !tbaa !1
  %6 = load i32, i32* getelementptr inbounds ([4 x i32], [4 x i32]* @g_4, i32 0, i64 2), align 4, !tbaa !1
