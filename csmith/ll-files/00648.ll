...
@g_3 = internal global i32 1374316261, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@g_7 = internal global i32 556942689, align 4
@.str.2 = private unnamed_addr constant [4 x i8] c"g_7\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_6 = private unnamed_addr constant [5 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], align 16
...
define internal signext i8 @func_1() #0 {
  ...
  %4 = bitcast [5 x i32*]* %l_6 to i8*
  call void @llvm.lifetime.start(i64 40, i8* %4) #1
  %5 = bitcast [5 x i32*]* %l_6 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %5, i8* bitcast ([5 x i32*]* @func_1.l_6 to i8*), i64 40, i32 16, i1 false)
  %6 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %6) #1
  %7 = load i32, i32* @g_7, align 4, !tbaa !1
  %8 = add i32 %7, -1
  store i32 %8, i32* @g_7, align 4, !tbaa !1
  %9 = load i32, i32* @g_7, align 4, !tbaa !1
  %10 = trunc i32 %9 to i8
  %11 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %11) #1
  %12 = bitcast [5 x i32*]* %l_6 to i8*
  call void @llvm.lifetime.end(i64 40, i8* %12) #1
  %13 = bitcast i32** %l_5 to i8*
