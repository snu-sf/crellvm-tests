...
@g_3 = internal global i32 -1192345162, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@g_10 = internal global i16 -29021, align 2
@.str.2 = private unnamed_addr constant [5 x i8] c"g_10\00", align 1
@g_11 = internal global i64 5909413845154402589, align 8
@.str.3 = private unnamed_addr constant [5 x i8] c"g_11\00", align 1
@g_12 = internal global [5 x i8] c"\FD\FD\FD\FD\FD", align 1
@.str.4 = private unnamed_addr constant [8 x i8] c"g_12[i]\00", align 1
@.str.5 = private unnamed_addr constant [14 x i8] c"index = [%d]\0A\00", align 1
@g_13 = internal global [5 x [2 x i32]] [[2 x i32] [i32 4, i32 -1497949736], [2 x i32] [i32 4, i32 4], [2 x i32] [i32 -1497949736, i32 4], [2 x i32] [i32 4, i32 -1497949736], [2 x i32] [i32 4, i32 4]], align 16
@.str.6 = private unnamed_addr constant [11 x i8] c"g_13[i][j]\00", align 1
...
; <label>:88                                      ; preds = %87, %81, %0
  ...
  %93 = load volatile i16, i16* @g_10, align 2, !tbaa !10
  ...
  %96 = load i64, i64* @g_11, align 8, !tbaa !7
...
; <label>:101                                     ; preds = %98
  ...
  %104 = getelementptr inbounds [5 x i8], [5 x i8]* @g_12, i32 0, i64 %103
...
; <label>:125                                     ; preds = %122
  ...
  %130 = getelementptr inbounds [5 x [2 x i32]], [5 x [2 x i32]]* @g_13, i32 0, i64 %129
  %131 = getelementptr inbounds [2 x i32], [2 x i32]* %130, i32 0, i64 %127
  %132 = load i32, i32* %131, align 4, !tbaa !1
  %133 = zext i32 %132 to i64
  %134 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %133, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.6, i32 0, i32 0), i32 %134)
...
; <label>:137                                     ; preds = %125
  ...
  %140 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.7, i32 0, i32 0), i32 %138, i32 %139)
  br label %141

; <label>:141                                     ; preds = %137, %125
  br label %142
...
; <label>:149                                     ; preds = %118
  ...
  call void @transparent_crc(i64 -4032155765995544655, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.8, i32 0, i32 0), i32 %150)
  %151 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %152 = zext i32 %151 to i64
  %153 = xor i64 %152, 4294967295
  %154 = trunc i64 %153 to i32
  %155 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %154, i32 %155)
  %156 = bitcast i32* %print_hash_value to i8*
...
; <label>:12                                      ; preds = %9
  ...
  %15 = getelementptr inbounds [6 x i32*], [6 x i32*]* %l_9, i32 0, i64 %14
  store i32* @g_3, i32** %15, align 8, !tbaa !5
  br label %16
...
; <label>:19                                      ; preds = %9
  %20 = load i32, i32* getelementptr inbounds ([5 x [2 x i32]], [5 x [2 x i32]]* @g_13, i32 0, i64 4, i64 0), align 4, !tbaa !1
  %21 = add i32 %20, 1
  store i32 %21, i32* getelementptr inbounds ([5 x [2 x i32]], [5 x [2 x i32]]* @g_13, i32 0, i64 4, i64 0), align 4, !tbaa !1
  %22 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %22) #1
  %23 = bitcast [6 x i32*]* %l_9 to i8*
  call void @llvm.lifetime.end(i64 48, i8* %23) #1
  %24 = bitcast i32** %l_8 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %24) #1
  %25 = bitcast i32** %l_7 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %25) #1
  %26 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %26) #1
  %27 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %27) #1
  %28 = bitcast i32** %l_4 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %28) #1
  %29 = bitcast i32** %l_2 to i8*
