...
@g_3 = internal global i32 716664160, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_2 = internal constant [7 x [10 x i32*]] [[10 x i32*] [i32* null, i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* @g_3, i32* null, i32* @g_3], [10 x i32*] [i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], [10 x i32*] [i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* @g_3], [10 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* @g_3], [10 x i32*] [i32* null, i32* @g_3, i32* null, i32* @g_3, i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], [10 x i32*] [i32* null, i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* null, i32* @g_3, i32* null, i32* @g_3], [10 x i32*] [i32* null, i32* @g_3, i32* null, i32* null, i32* @g_3, i32* @g_3, i32* @g_3, i32* null, i32* null, i32* @g_3]], align 16
@g_6 = internal global i32** @g_5, align 8
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %92 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %93 = zext i32 %92 to i64
  %94 = xor i64 %93, 4294967295
  %95 = trunc i64 %94 to i32
  %96 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %95, i32 %96)
  %97 = bitcast i32* %print_hash_value to i8*
...
define internal signext i8 @func_1() #0 {
  ...
  call void @llvm.lifetime.start(i64 4, i8* %2) #1
  %3 = load i32*, i32** getelementptr inbounds ([7 x [10 x i32*]], [7 x [10 x i32*]]* @func_1.l_2, i32 0, i64 4, i64 5), align 8, !tbaa !5
  %4 = load volatile i32**, i32*** @g_6, align 8, !tbaa !5
