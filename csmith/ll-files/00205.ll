...
@g_3 = internal global [10 x i32] [i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2, i32 2], align 16
@.str.1 = private unnamed_addr constant [7 x i8] c"g_3[i]\00", align 1
@.str.2 = private unnamed_addr constant [14 x i8] c"index = [%d]\0A\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@g_2 = internal global i32* bitcast (i8* getelementptr (i8, i8* bitcast ([10 x i32]* @g_3 to i8*), i64 12) to i32*), align 8
...
; <label>:92                                      ; preds = %89
  ...
  %96 = load volatile i32, i32* %95, align 4, !tbaa !1
...
define internal signext i8 @func_1() #0 {
  %1 = load i32*, i32** @g_2, align 8, !tbaa !5
  store i32* %1, i32** @g_2, align 8, !tbaa !5
  %2 = load volatile i32, i32* getelementptr inbounds ([10 x i32], [10 x i32]* @g_3, i32 0, i64 9), align 4, !tbaa !1
  %3 = trunc i32 %2 to i8
  ret i8 %3
}
