...
@g_7 = internal global i8 0, align 1
@.str.2 = private unnamed_addr constant [4 x i8] c"g_7\00", align 1
@g_8 = internal global i64 6, align 8
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %94 = load i64, i64* @g_8, align 8, !tbaa !7
  %95 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %94, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3, i32 0, i32 0), i32 %95)
...
; <label>:8                                       ; preds = %5
  ...
  %11 = getelementptr inbounds [2 x i32*], [2 x i32*]* %l_6, i32 0, i64 %10
  store i32* @g_4, i32** %11, align 8, !tbaa !5
  br label %12
...
; <label>:15                                      ; preds = %5
  store i32* null, i32** @g_3, align 8, !tbaa !5
  %16 = load i64, i64* @g_8, align 8, !tbaa !7
  %17 = add i64 %16, -1
  store i64 %17, i64* @g_8, align 8, !tbaa !7
  %18 = load volatile i8, i8* @g_7, align 1, !tbaa !9
  %19 = sext i8 %18 to i16
  %20 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %20) #1
  %21 = bitcast [2 x i32*]* %l_6 to i8*
  call void @llvm.lifetime.end(i64 16, i8* %21) #1
  %22 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %22) #1
  %23 = bitcast i32*** %l_2 to i8*
