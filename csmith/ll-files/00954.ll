...
@g_3 = internal global %struct.S0* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to %struct.S0*), align 8
@.str.4 = private unnamed_addr constant [36 x i8] c"...checksum after hashing %s : %lX\0A\00", align 1
@g_2 = internal global { i8, i8, i8, i8, i8, i8, i8, i8, i8 } { i8 -75, i8 0, i8 -48, i8 -77, i8 -1, i8 95, i8 -127, i8 0, i8 0 }, align 1
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %87 = call i32 @func_1()
  %88 = load volatile i72, i72* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to i72*), align 1
  %89 = and i72 %88, 1048575
  %90 = trunc i72 %89 to i32
  ...
  %93 = load volatile i72, i72* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to i72*), align 1
  %94 = shl i72 %93, 27
  %95 = ashr i72 %94, 47
  %96 = trunc i72 %95 to i32
  %97 = sext i32 %96 to i64
  %98 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %97, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), i32 %98)
  %99 = load volatile i72, i72* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to i72*), align 1
  %100 = lshr i72 %99, 45
  %101 = and i72 %100, 8388607
  %102 = trunc i72 %101 to i32
...
define internal i32 @func_1() #0 {
  %1 = load volatile %struct.S0*, %struct.S0** @g_3, align 8, !tbaa !5
  %2 = bitcast %struct.S0* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds (%struct.S0, %struct.S0* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to %struct.S0*), i32 0, i32 0, i32 0), i64 9, i32 1, i1 true), !tbaa.struct !10
  %3 = load volatile i72, i72* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to i72*), align 1
  %4 = and i72 %3, 1048575
...
!8 = !{!"long", !3, i64 0}
!9 = !{!3, !3, i64 0}
!10 = !{i64 0, i64 4, !1, i64 2, i64 4, !1, i64 5, i64 4, !1}
