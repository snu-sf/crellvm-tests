...
@func_1.l_3 = private unnamed_addr constant [8 x [5 x i32*]] [[5 x i32*] [i32* @g_4, i32* null, i32* null, i32* @g_4, i32* null], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* null, i32* null, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* null, i32* null, i32* null, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* null, i32* @g_4, i32* null, i32* @g_4, i32* null], [5 x i32*] [i32* null, i32* null, i32* @g_4, i32* @g_4, i32* @g_4], [5 x i32*] [i32* @g_4, i32* null, i32* null, i32* @g_4, i32* null]], align 16
...
define internal zeroext i8 @func_1() #0 {
  ...
  %l_3 = alloca [8 x [5 x i32*]], align 16
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = bitcast i16* %l_2 to i8*
  call void @llvm.lifetime.start(i64 2, i8* %1) #1
  store i16 -23660, i16* %l_2, align 2, !tbaa !10
  %2 = bitcast [8 x [5 x i32*]]* %l_3 to i8*
  call void @llvm.lifetime.start(i64 320, i8* %2) #1
  %3 = bitcast [8 x [5 x i32*]]* %l_3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* bitcast ([8 x [5 x i32*]]* @func_1.l_3 to i8*), i64 320, i32 16, i1 false)
  %4 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %4) #1
  %5 = bitcast i32* %j to i8*
  call void @llvm.lifetime.start(i64 4, i8* %5) #1
  %6 = load i16, i16* %l_2, align 2, !tbaa !10
  %7 = sext i16 %6 to i32
  store i32 %7, i32* @g_4, align 4, !tbaa !1
  ...
  %12 = bitcast [8 x [5 x i32*]]* %l_3 to i8*
  call void @llvm.lifetime.end(i64 320, i8* %12) #1
  %13 = bitcast i16* %l_2 to i8*
