...
@g_4 = internal global i32 -272597481, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_4\00", align 1
@g_8 = internal global i64 5545499549777456552, align 8
@.str.2 = private unnamed_addr constant [4 x i8] c"g_8\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_7 = private unnamed_addr constant [7 x [7 x i32*]] [[7 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [7 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [7 x i32*] [i32* @g_4, i32* @g_4, i32* null, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [7 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [7 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4], [7 x i32*] [i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* null], [7 x i32*] [i32* null, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4, i32* @g_4]], align 16
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %91 = load volatile i64, i64* @g_8, align 8, !tbaa !7
  %92 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %91, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2, i32 0, i32 0), i32 %92)
...
define internal i64 @func_1() #0 {
  ...
  %l_7 = alloca [7 x [7 x i32*]], align 16
  ...
  %5 = bitcast [7 x [7 x i32*]]* %l_7 to i8*
  call void @llvm.lifetime.start(i64 392, i8* %5) #1
  %6 = bitcast [7 x [7 x i32*]]* %l_7 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %6, i8* bitcast ([7 x [7 x i32*]]* @func_1.l_7 to i8*), i64 392, i32 16, i1 false)
  ...
  %10 = load volatile i64, i64* @g_8, align 8, !tbaa !7
  %11 = add i64 %10, 1
  store volatile i64 %11, i64* @g_8, align 8, !tbaa !7
  %12 = load i32, i32* %l_11, align 4, !tbaa !1
  %13 = zext i32 %12 to i64
  %14 = bitcast i32* %j to i8*
  call void @llvm.lifetime.end(i64 4, i8* %14) #1
  %15 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %15) #1
  %16 = bitcast i32* %l_11 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %16) #1
  %17 = bitcast [7 x [7 x i32*]]* %l_7 to i8*
  call void @llvm.lifetime.end(i64 392, i8* %17) #1
  %18 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %18) #1
  %19 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %19) #1
  %20 = bitcast i32** %l_3 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %20) #1
  %21 = bitcast i32** %l_2 to i8*
