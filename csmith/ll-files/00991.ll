...
@g_13 = internal global i32 4, align 4
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %90 = load i32, i32* @g_8, align 4, !tbaa !1
  ...
  call void @transparent_crc(i64 %97, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.4, i32 0, i32 0), i32 %98)
  %99 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %100 = zext i32 %99 to i64
  %101 = xor i64 %100, 4294967295
  %102 = trunc i64 %101 to i32
  %103 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %102, i32 %103)
  %104 = bitcast i32* %print_hash_value to i8*
...
define internal i32 @func_1() #0 {
  ...
  %2 = load i64, i64* @g_2, align 8, !tbaa !7
  %3 = add i64 %2, -1
  store i64 %3, i64* @g_2, align 8, !tbaa !7
  store i64 -18, i64* @g_2, align 8, !tbaa !7
  br label %4

; <label>:4                                       ; preds = %26, %0
  %5 = load i64, i64* @g_2, align 8, !tbaa !7
  %6 = icmp eq i64 %5, 38
...
; <label>:7                                       ; preds = %4
  ...
  %12 = load i32*, i32** %l_7, align 8, !tbaa !5
  %13 = load i32, i32* %12, align 4, !tbaa !1
  %14 = sext i32 %13 to i64
  %15 = and i64 %14, %11
  %16 = trunc i64 %15 to i32
  store i32 %16, i32* %12, align 4, !tbaa !1
  %17 = load i32*, i32** %l_9, align 8, !tbaa !5
  store i32 %16, i32* %17, align 4, !tbaa !1
  %18 = load i32*, i32** %l_12, align 8, !tbaa !5
  %19 = load i32, i32* %18, align 4, !tbaa !1
  %20 = xor i32 %19, %16
  store i32 %20, i32* %18, align 4, !tbaa !1
  %21 = load i32*, i32** %l_12, align 8, !tbaa !5
  %22 = load i32, i32* %21, align 4, !tbaa !1
  store i32 %22, i32* %1
  %23 = bitcast i32** %l_12 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %23) #1
  %24 = bitcast i32** %l_9 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %24) #1
  %25 = bitcast i32** %l_7 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %25) #1
  br label %31
                                                  ; No predecessors!
  %27 = load i64, i64* @g_2, align 8, !tbaa !7
  %28 = add i64 %27, 1
  store i64 %28, i64* @g_2, align 8, !tbaa !7
  br label %4

; <label>:29                                      ; preds = %4
  %30 = load i32, i32* @g_13, align 4, !tbaa !1
  store i32 %30, i32* %1
  br label %31
