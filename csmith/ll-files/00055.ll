...
@g_3 = internal global i32 1412566578, align 4
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %91 = load volatile i32, i32* @g_6, align 4, !tbaa !1
...
; <label>:8                                       ; preds = %5
  ...
  %11 = getelementptr inbounds [2 x i32*], [2 x i32*]* %l_5, i32 0, i64 %10
...
; <label>:15                                      ; preds = %5
  %16 = load i32, i32* @g_7, align 4, !tbaa !1
  %17 = add i32 %16, 1
  store i32 %17, i32* @g_7, align 4, !tbaa !1
  %18 = load i32*, i32** %l_4, align 8, !tbaa !5
  %19 = load i32, i32* %18, align 4, !tbaa !1
  %20 = trunc i32 %19 to i8
  %21 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %21) #1
  %22 = bitcast [2 x i32*]* %l_5 to i8*
  call void @llvm.lifetime.end(i64 16, i8* %22) #1
  %23 = bitcast i32** %l_4 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %23) #1
  %24 = bitcast i32** %l_2 to i8*
