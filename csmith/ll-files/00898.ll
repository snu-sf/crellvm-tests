...
@g_13 = internal global [8 x i8] c"\01\D1\01\01\D1\01\01\D1", align 1
@.str.2 = private unnamed_addr constant [8 x i8] c"g_13[i]\00", align 1
@.str.3 = private unnamed_addr constant [14 x i8] c"index = [%d]\0A\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_2 = private unnamed_addr constant [9 x i16] [i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1, i16 1], align 16
...
; <label>:95                                      ; preds = %92
  ...
  %98 = getelementptr inbounds [8 x i8], [8 x i8]* @g_13, i32 0, i64 %97
...
define internal signext i16 @func_1() #0 {
  ...
  %2 = alloca i32
  %3 = bitcast [9 x i16]* %l_2 to i8*
  call void @llvm.lifetime.start(i64 18, i8* %3) #1
  %4 = bitcast [9 x i16]* %l_2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %4, i8* bitcast ([9 x i16]* @func_1.l_2 to i8*), i64 18, i32 16, i1 false)
  ...
  %10 = bitcast i32* %l_9 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %10) #1
  store i32 -1245003837, i32* %l_9, align 4, !tbaa !1
  %11 = bitcast i32** %l_10 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %11) #1
  store i32* @g_3, i32** %l_10, align 8, !tbaa !5
  %12 = bitcast i32** %l_11 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %12) #1
  store i32* @g_3, i32** %l_11, align 8, !tbaa !5
  %13 = bitcast i32** %l_12 to i8*
...
; <label>:18                                      ; preds = %15
  ...
  %22 = getelementptr inbounds [9 x i16], [9 x i16]* %l_2, i32 0, i64 %21
...
; <label>:28                                      ; preds = %15
  %29 = load i8, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @g_13, i32 0, i64 2), align 1, !tbaa !9
  %30 = add i8 %29, 1
  store i8 %30, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @g_13, i32 0, i64 2), align 1, !tbaa !9
  %31 = load i8, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @g_13, i32 0, i64 2), align 1, !tbaa !9
...
; <label>:33                                      ; preds = %28, %18
  ...
  %35 = bitcast i32** %l_12 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %35) #1
  %36 = bitcast i32** %l_11 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %36) #1
  %37 = bitcast i32** %l_10 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %37) #1
  %38 = bitcast i32* %l_9 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %38) #1
  %39 = bitcast i32** %l_8 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %39) #1
  %40 = bitcast i32** %l_7 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %40) #1
  %41 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %41) #1
  %42 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %42) #1
  %43 = bitcast i32** %l_4 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %43) #1
  %44 = bitcast [9 x i16]* %l_2 to i8*
  call void @llvm.lifetime.end(i64 18, i8* %44) #1
  %45 = load i16, i16* %1
  ret i16 %45
}
