...
@g_3 = internal global i32 -2030516299, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@g_5 = internal global i64 -8367778309880639397, align 8
...
define internal zeroext i16 @func_1() #0 {
  ...
  %l_4 = alloca [1 x [5 x [6 x i32*]]], align 16
  ...
  %2 = bitcast [1 x [5 x [6 x i32*]]]* %l_4 to i8*
  call void @llvm.lifetime.start(i64 240, i8* %2) #1
  %3 = bitcast [1 x [5 x [6 x i32*]]]* %l_4 to i8*
  call void @llvm.memset.p0i8.i64(i8* %3, i8 0, i64 240, i32 16, i1 false)
  call void @llvm.lifetime.start(i64 1, i8* %l_6) #1
  store i8 74, i8* %l_6, align 1, !tbaa !9
  ...
  call void @llvm.lifetime.start(i64 4, i8* %6) #1
  %7 = load i8, i8* %l_6, align 1, !tbaa !9
  %8 = add i8 %7, 1
  store i8 %8, i8* %l_6, align 1, !tbaa !9
  %9 = load i64, i64* @g_5, align 8, !tbaa !7
  ...
  %14 = bitcast [1 x [5 x [6 x i32*]]]* %l_4 to i8*
  call void @llvm.lifetime.end(i64 240, i8* %14) #1
