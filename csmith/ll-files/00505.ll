...
@g_3 = internal global [10 x i32] zeroinitializer, align 16
...
; <label>:92                                      ; preds = %89
  ...
  %95 = getelementptr inbounds [10 x i32], [10 x i32]* @g_3, i32 0, i64 %94
...
define internal i64 @func_1() #0 {
  ...
  store i32* getelementptr inbounds ([10 x i32], [10 x i32]* @g_3, i32 0, i64 9), i32** %l_2, align 8, !tbaa !5
  %4 = bitcast i32* %l_4 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %4) #1
  store i32 -2, i32* %l_4, align 4, !tbaa !1
  %5 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %5) #1
  store i32* getelementptr inbounds ([10 x i32], [10 x i32]* @g_3, i32 0, i64 9), i32** %l_5, align 8, !tbaa !5
  %6 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %6) #1
  store i32* %l_4, i32** %l_6, align 8, !tbaa !5
  %7 = bitcast i32** %l_7 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %7) #1
  store i32* getelementptr inbounds ([10 x i32], [10 x i32]* @g_3, i32 0, i64 9), i32** %l_7, align 8, !tbaa !5
  %8 = bitcast [2 x i32*]* %l_8 to i8*
  ...
  store i32 -929205330, i32* %l_12, align 4, !tbaa !1
  %10 = bitcast i32* %l_13 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %10) #1
  store i32 -318116991, i32* %l_13, align 4, !tbaa !1
...
; <label>:15                                      ; preds = %12
  ...
  %18 = getelementptr inbounds [2 x i32*], [2 x i32*]* %l_8, i32 0, i64 %17
  store i32* getelementptr inbounds ([10 x i32], [10 x i32]* @g_3, i32 0, i64 9), i32** %18, align 8, !tbaa !5
  br label %19
...
; <label>:22                                      ; preds = %12
  %23 = load i8, i8* %l_9, align 1, !tbaa !9
  %24 = add i8 %23, -1
  store i8 %24, i8* %l_9, align 1, !tbaa !9
  store i32 1, i32* %l_4, align 4, !tbaa !1
  br label %25

; <label>:25                                      ; preds = %31, %22
  %26 = load i32, i32* %l_4, align 4, !tbaa !1
  %27 = icmp sge i32 %26, 0
  br i1 %27, label %28, label %34

; <label>:28                                      ; preds = %25
  %29 = load i32, i32* getelementptr inbounds ([10 x i32], [10 x i32]* @g_3, i32 0, i64 9), align 4, !tbaa !1
  %30 = sext i32 %29 to i64
  store i64 %30, i64* %1
  store i32 1, i32* %2
  br label %39
                                                  ; No predecessors!
  %32 = load i32, i32* %l_4, align 4, !tbaa !1
  %33 = sub nsw i32 %32, 1
  store i32 %33, i32* %l_4, align 4, !tbaa !1
  br label %25

; <label>:34                                      ; preds = %25
  %35 = load i32, i32* %l_13, align 4, !tbaa !1
  %36 = add i32 %35, 1
  store i32 %36, i32* %l_13, align 4, !tbaa !1
  %37 = load i32, i32* getelementptr inbounds ([10 x i32], [10 x i32]* @g_3, i32 0, i64 2), align 4, !tbaa !1
...
; <label>:39                                      ; preds = %34, %28
  ...
  call void @llvm.lifetime.end(i64 4, i8* %40) #1
  %41 = bitcast i32* %l_13 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %41) #1
  %42 = bitcast i32* %l_12 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %42) #1
  call void @llvm.lifetime.end(i64 1, i8* %l_9) #1
  %43 = bitcast [2 x i32*]* %l_8 to i8*
