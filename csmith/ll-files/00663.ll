...
@func_1.l_2 = private unnamed_addr constant [9 x [1 x [5 x i32]]] [[1 x [5 x i32]] [[5 x i32] [i32 0, i32 8, i32 -7, i32 -1172573518, i32 -7]], [1 x [5 x i32]] [[5 x i32] [i32 -9, i32 -9, i32 8, i32 -1801585424, i32 3]], [1 x [5 x i32]] [[5 x i32] [i32 0, i32 3, i32 -1, i32 -1801585424, i32 -1801585424]], [1 x [5 x i32]] [[5 x i32] [i32 -1801585424, i32 7, i32 -1801585424, i32 -1172573518, i32 -869926305]], [1 x [5 x i32]] [[5 x i32] [i32 -1, i32 3, i32 0, i32 0, i32 -869926305]], [1 x [5 x i32]] [[5 x i32] [i32 8, i32 -9, i32 -9, i32 8, i32 -1801585424]], [1 x [5 x i32]] [[5 x i32] [i32 -7, i32 8, i32 0, i32 -869926305, i32 3]], [1 x [5 x i32]] [[5 x i32] [i32 -7, i32 0, i32 -1801585424, i32 0, i32 -7]], [1 x [5 x i32]] [[5 x i32] [i32 8, i32 0, i32 -1, i32 -869926305, i32 -9]]], align 16
...
define internal signext i8 @func_1() #0 {
  %l_2 = alloca [9 x [1 x [5 x i32]]], align 16
  %l_4 = alloca [1 x i32*], align 8
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %1 = bitcast [9 x [1 x [5 x i32]]]* %l_2 to i8*
  call void @llvm.lifetime.start(i64 180, i8* %1) #1
  %2 = bitcast [9 x [1 x [5 x i32]]]* %l_2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([9 x [1 x [5 x i32]]]* @func_1.l_2 to i8*), i64 180, i32 16, i1 false)
  %3 = bitcast [1 x i32*]* %l_4 to i8*
...
; <label>:10                                      ; preds = %7
  ...
  %13 = getelementptr inbounds [1 x i32*], [1 x i32*]* %l_4, i32 0, i64 %12
...
; <label>:17                                      ; preds = %7
  %18 = getelementptr inbounds [9 x [1 x [5 x i32]]], [9 x [1 x [5 x i32]]]* %l_2, i32 0, i64 7
  %19 = getelementptr inbounds [1 x [5 x i32]], [1 x [5 x i32]]* %18, i32 0, i64 0
  %20 = getelementptr inbounds [5 x i32], [5 x i32]* %19, i32 0, i64 4
  %21 = load i32, i32* %20, align 4, !tbaa !1
  %22 = load i32, i32* @g_5, align 4, !tbaa !1
  %23 = or i32 %22, %21
  store i32 %23, i32* @g_5, align 4, !tbaa !1
  %24 = load i32, i32* @g_5, align 4, !tbaa !1
  ...
  %29 = bitcast [1 x i32*]* %l_4 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %29) #1
  %30 = bitcast [9 x [1 x [5 x i32]]]* %l_2 to i8*
  call void @llvm.lifetime.end(i64 180, i8* %30) #1
  ret i8 %25
}
