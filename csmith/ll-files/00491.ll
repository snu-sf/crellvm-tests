...
@g_3 = internal global i32 -2015416502, align 4
...
define internal signext i8 @func_1() #0 {
  ...
  %l_10 = alloca [7 x [9 x i32*]], align 16
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  ...
  store i32* %l_7, i32** %35, !tbaa !5
  %36 = getelementptr inbounds i32*, i32** %35, i64 1
  store i32* %l_7, i32** %36, !tbaa !5
  %37 = getelementptr inbounds i32*, i32** %36, i64 1
  store i32* %l_7, i32** %37, !tbaa !5
  ...
  store i32* %l_7, i32** %52, !tbaa !5
  %53 = getelementptr inbounds i32*, i32** %52, i64 1
  store i32* %l_7, i32** %53, !tbaa !5
  %54 = getelementptr inbounds i32*, i32** %53, i64 1
  store i32* @g_3, i32** %54, !tbaa !5
  %55 = getelementptr inbounds i32*, i32** %54, i64 1
  store i32* %l_7, i32** %55, !tbaa !5
  %56 = getelementptr inbounds i32*, i32** %55, i64 1
  store i32* @g_3, i32** %56, !tbaa !5
  %57 = getelementptr inbounds i32*, i32** %56, i64 1
  store i32* %l_7, i32** %57, !tbaa !5
  ...
  store i32* %l_7, i32** %78, !tbaa !5
  %79 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %79) #1
  %80 = bitcast i32* %j to i8*
  call void @llvm.lifetime.start(i64 4, i8* %80) #1
  %81 = load volatile i32, i32* @g_11, align 4, !tbaa !1
  %82 = add i32 %81, -1
  store volatile i32 %82, i32* @g_11, align 4, !tbaa !1
  %83 = load i32*, i32** %l_8, align 8, !tbaa !5
  %84 = load i32, i32* %83, align 4, !tbaa !1
  store i32 %84, i32* @g_3, align 4, !tbaa !1
  %85 = load volatile i32, i32* @g_11, align 4, !tbaa !1
  %86 = trunc i32 %85 to i8
  %87 = bitcast i32* %j to i8*
  call void @llvm.lifetime.end(i64 4, i8* %87) #1
  %88 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %88) #1
  %89 = bitcast [7 x [9 x i32*]]* %l_10 to i8*
  call void @llvm.lifetime.end(i64 504, i8* %89) #1
  %90 = bitcast i32** %l_9 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %90) #1
  %91 = bitcast i32** %l_8 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %91) #1
  %92 = bitcast i32* %l_7 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %92) #1
  %93 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %93) #1
  %94 = bitcast i32** %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %94) #1
  %95 = bitcast i32** %l_4 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %95) #1
  %96 = bitcast i32** %l_2 to i8*
