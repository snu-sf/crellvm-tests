...
@g_2 = internal global %union.U3 { i64 -5135132107741218123 }, align 8
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %88 = call i64 @func_1()
  %89 = getelementptr %union.U3, %union.U3* %6, i32 0, i32 0
  store i64 %88, i64* %89, align 8
  %90 = load i64, i64* getelementptr inbounds (%union.U3, %union.U3* @g_2, i32 0, i32 0), align 8, !tbaa !7
  %91 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %90, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.1, i32 0, i32 0), i32 %91)
  %92 = load volatile i8, i8* bitcast (%union.U3* @g_2 to i8*), align 1, !tbaa !9
  %93 = zext i8 %92 to i64
  %94 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %93, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), i32 %94)
...
define internal i64 @func_1() #0 {
  ...
  %2 = bitcast %union.U3* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast (%union.U3* @g_2 to i8*), i64 8, i32 8, i1 false), !tbaa.struct !10
  %3 = getelementptr %union.U3, %union.U3* %1, i32 0, i32 0
...
!8 = !{!"long", !3, i64 0}
!9 = !{!3, !3, i64 0}
!10 = !{i64 0, i64 8, !7, i64 0, i64 1, !9}
