...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %87 = call i32 @func_1()
  %88 = load volatile i8, i8* @g_2, align 1, !tbaa !9
...
define internal i32 @func_1() #0 {
  %1 = load volatile i8, i8* @g_2, align 1, !tbaa !9
  %2 = zext i8 %1 to i64
  %3 = xor i64 %2, 7
  %4 = trunc i64 %3 to i8
  store volatile i8 %4, i8* @g_2, align 1, !tbaa !9
  %5 = load volatile i8, i8* @g_2, align 1, !tbaa !9
  %6 = zext i8 %5 to i32
  ret i32 %6
}
