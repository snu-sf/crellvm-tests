...
@g_3 = internal global i32 763615107, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@g_4 = internal global i64 -1, align 8
@.str.2 = private unnamed_addr constant [4 x i8] c"g_4\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_2 = private unnamed_addr constant [5 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], align 16
...
define internal zeroext i8 @func_1() #0 {
  ...
  %i = alloca i32, align 4
  %1 = bitcast [5 x i32*]* %l_2 to i8*
  call void @llvm.lifetime.start(i64 40, i8* %1) #1
  %2 = bitcast [5 x i32*]* %l_2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([5 x i32*]* @func_1.l_2 to i8*), i64 40, i32 16, i1 false)
  %3 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %3) #1
  %4 = load i32, i32* @g_3, align 4, !tbaa !1
  %5 = sext i32 %4 to i64
  %6 = or i64 %5, 773717504
  %7 = trunc i64 %6 to i32
  store i32 %7, i32* @g_3, align 4, !tbaa !1
  %8 = sext i32 %7 to i64
  %9 = load i64, i64* @g_4, align 8, !tbaa !7
  %10 = xor i64 %9, %8
  store i64 %10, i64* @g_4, align 8, !tbaa !7
  %11 = load i64, i64* @g_4, align 8, !tbaa !7
  %12 = trunc i64 %11 to i8
  %13 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %13) #1
  %14 = bitcast [5 x i32*]* %l_2 to i8*
