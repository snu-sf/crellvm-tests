...
@g_3 = internal global i32 1614784348, align 4
...
define internal signext i16 @func_1() #0 {
  %l_2 = alloca [2 x [1 x [2 x i32*]]], align 16
  %l_4 = alloca i32, align 4
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %1 = bitcast [2 x [1 x [2 x i32*]]]* %l_2 to i8*
...
; <label>:17                                      ; preds = %14
  ...
  %24 = getelementptr inbounds [2 x [1 x [2 x i32*]]], [2 x [1 x [2 x i32*]]]* %l_2, i32 0, i64 %23
  %25 = getelementptr inbounds [1 x [2 x i32*]], [1 x [2 x i32*]]* %24, i32 0, i64 %21
  %26 = getelementptr inbounds [2 x i32*], [2 x i32*]* %25, i32 0, i64 %19
  store i32* @g_3, i32** %26, align 8, !tbaa !5
  br label %27

; <label>:27                                      ; preds = %17
  %28 = load i32, i32* %k, align 4, !tbaa !1
  %29 = add nsw i32 %28, 1
  store i32 %29, i32* %k, align 4, !tbaa !1
  br label %14
...
; <label>:38                                      ; preds = %6
  ...
  %44 = bitcast i32* %l_4 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %44) #1
  %45 = bitcast [2 x [1 x [2 x i32*]]]* %l_2 to i8*
