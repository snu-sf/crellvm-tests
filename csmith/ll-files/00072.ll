...
@g_4 = internal global i32** bitcast (i8* getelementptr (i8, i8* bitcast ([3 x [10 x i32*]]* @g_5 to i8*), i64 192) to i32**), align 8
@g_5 = internal global [3 x [10 x i32*]] [[10 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], [10 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3], [10 x i32*] [i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3, i32* @g_3]], align 16
...
; <label>:88                                      ; preds = %87, %81, %0
  ...
  %89 = call i32 @func_1()
  %90 = load volatile i32, i32* @g_3, align 4, !tbaa !1
...
define internal i32 @func_1() #0 {
  %1 = load volatile i32*, i32** @g_2, align 8, !tbaa !5
  %2 = load volatile i32**, i32*** @g_4, align 8, !tbaa !5
  store volatile i32* %1, i32** %2, align 8, !tbaa !5
  %3 = load volatile i32**, i32*** @g_4, align 8, !tbaa !5
  %4 = load volatile i32*, i32** %3, align 8, !tbaa !5
  %5 = load volatile i32, i32* %4, align 4, !tbaa !1
  ret i32 %5
}
