...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  call void @transparent_crc(i64 4294967295, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.1, i32 0, i32 0), i32 %88)
  %89 = load i32, i32* @g_4, align 4, !tbaa !1
...
define internal zeroext i8 @func_1() #0 {
  %1 = load volatile i32*, i32** @g_3, align 8, !tbaa !5
