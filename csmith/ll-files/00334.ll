...
@g_3 = internal global i32 1643537768, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@crc32_context = internal global i32 -1, align 4
@crc32_tab = internal global [256 x i32] zeroinitializer, align 16
@func_1.l_4 = private unnamed_addr constant [8 x [6 x i64]] [[6 x i64] [i64 1, i64 3, i64 6528078412235795885, i64 3, i64 1, i64 -723785413043221310], [6 x i64] [i64 3125349817614082356, i64 -723785413043221310, i64 1, i64 1, i64 4530524682509849035, i64 541045957357435546], [6 x i64] [i64 -2541570905070774790, i64 988920293078405154, i64 4530524682509849035, i64 -723785413043221310, i64 541045957357435546, i64 541045957357435546], [6 x i64] [i64 0, i64 1, i64 1, i64 0, i64 -9073715917016113866, i64 -723785413043221310], [6 x i64] [i64 541045957357435546, i64 -1, i64 6528078412235795885, i64 9, i64 3, i64 4530524682509849035], [6 x i64] [i64 6528078412235795885, i64 -2541570905070774790, i64 2, i64 988920293078405154, i64 3, i64 988920293078405154], [6 x i64] [i64 3, i64 -1, i64 3, i64 9, i64 -9073715917016113866, i64 -2541570905070774790], [6 x i64] [i64 -723785413043221310, i64 1, i64 1, i64 4530524682509849035, i64 9, i64 -1]], align 16
...
define internal i32 @func_1() #0 {
  ...
  %l_4 = alloca [8 x [6 x i64]], align 16
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %1 = bitcast [9 x i32*]* %l_2 to i8*
  call void @llvm.lifetime.start(i64 72, i8* %1) #1
  %2 = bitcast [8 x [6 x i64]]* %l_4 to i8*
  call void @llvm.lifetime.start(i64 384, i8* %2) #1
  %3 = bitcast [8 x [6 x i64]]* %l_4 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %3, i8* bitcast ([8 x [6 x i64]]* @func_1.l_4 to i8*), i64 384, i32 16, i1 false)
...
; <label>:9                                       ; preds = %6
  ...
  %12 = getelementptr inbounds [9 x i32*], [9 x i32*]* %l_2, i32 0, i64 %11
...
; <label>:16                                      ; preds = %6
  %17 = getelementptr inbounds [8 x [6 x i64]], [8 x [6 x i64]]* %l_4, i32 0, i64 2
  %18 = getelementptr inbounds [6 x i64], [6 x i64]* %17, i32 0, i64 1
  ...
  %24 = bitcast [8 x [6 x i64]]* %l_4 to i8*
  call void @llvm.lifetime.end(i64 384, i8* %24) #1
  %25 = bitcast [9 x i32*]* %l_2 to i8*
