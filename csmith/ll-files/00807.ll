...
@g_2 = internal global %union.U6 { i16 -1 }, align 2
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %88 = call i16 @func_1()
  %89 = getelementptr %union.U6, %union.U6* %6, i32 0, i32 0
  store i16 %88, i16* %89, align 2
  %90 = load volatile i16, i16* getelementptr inbounds (%union.U6, %union.U6* @g_2, i32 0, i32 0), align 2, !tbaa !10
...
define internal i16 @func_1() #0 {
  %1 = alloca %union.U6, align 2
  %2 = bitcast %union.U6* %1 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast (%union.U6* @g_2 to i8*), i64 2, i32 2, i1 false), !tbaa.struct !12
  %3 = getelementptr %union.U6, %union.U6* %1, i32 0, i32 0
