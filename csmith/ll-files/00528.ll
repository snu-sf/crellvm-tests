...
@func_1.l_2 = private unnamed_addr constant [5 x i32] [i32 1, i32 1, i32 1, i32 1, i32 1], align 16
...
define internal zeroext i16 @func_1() #0 {
  ...
  call void @llvm.lifetime.start(i64 20, i8* %1) #1
  %2 = bitcast [5 x i32]* %l_2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([5 x i32]* @func_1.l_2 to i8*), i64 20, i32 16, i1 false)
  %3 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %3) #1
  %4 = getelementptr inbounds [5 x i32], [5 x i32]* %l_2, i32 0, i64 4
  %5 = load i32, i32* %4, align 4, !tbaa !1
  %6 = trunc i32 %5 to i16
  %7 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %7) #1
  %8 = bitcast [5 x i32]* %l_2 to i8*
  call void @llvm.lifetime.end(i64 20, i8* %8) #1
  ret i16 %6
}
