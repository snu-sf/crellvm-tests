...
@g_2 = internal global { i8, i8, i8, i8, i8, i8, i8, i8 } { i8 92, i8 -104, i8 4, i8 0, i8 -78, i8 37, i8 0, i8 0 }, align 4
...
; <label>:87                                      ; preds = %86, %80, %0
  ...
  %88 = call i64 @func_1()
  %89 = bitcast %struct.S0* %6 to i64*
  store i64 %88, i64* %89, align 4
  %90 = load volatile i32, i32* getelementptr inbounds (%struct.S0, %struct.S0* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to %struct.S0*), i32 0, i32 0), align 4
  %91 = shl i32 %90, 27
  %92 = ashr i32 %91, 27
  ...
  %95 = load volatile i32, i32* getelementptr inbounds (%struct.S0, %struct.S0* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to %struct.S0*), i32 0, i32 0), align 4
  %96 = lshr i32 %95, 5
  %97 = and i32 %96, 63
  %98 = zext i32 %97 to i64
  %99 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %98, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.2, i32 0, i32 0), i32 %99)
  %100 = load i32, i32* getelementptr inbounds (%struct.S0, %struct.S0* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to %struct.S0*), i32 0, i32 0), align 4
  %101 = lshr i32 %100, 11
  %102 = and i32 %101, 65535
  %103 = zext i32 %102 to i64
  %104 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %103, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.3, i32 0, i32 0), i32 %104)
  %105 = load i32, i32* getelementptr inbounds (%struct.S0, %struct.S0* bitcast ({ i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2 to %struct.S0*), i32 0, i32 1), align 4
  %106 = shl i32 %105, 4
  %107 = ashr i32 %106, 4
  %108 = sext i32 %107 to i64
  %109 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @transparent_crc(i64 %108, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.4, i32 0, i32 0), i32 %109)
  %110 = load i32, i32* @crc32_context, align 4, !tbaa !1
  %111 = zext i32 %110 to i64
  %112 = xor i64 %111, 4294967295
  %113 = trunc i64 %112 to i32
  %114 = load i32, i32* %print_hash_value, align 4, !tbaa !1
  call void @platform_main_end(i32 %113, i32 %114)
  %115 = bitcast i32* %print_hash_value to i8*
...
define internal i64 @func_1() #0 {
  ...
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ({ i8, i8, i8, i8, i8, i8, i8, i8 }, { i8, i8, i8, i8, i8, i8, i8, i8 }* @g_2, i32 0, i32 0), i64 8, i32 4, i1 false), !tbaa.struct !10
...
!8 = !{!"long", !3, i64 0}
!9 = !{!3, !3, i64 0}
!10 = !{i64 0, i64 4, !1, i64 0, i64 4, !1, i64 1, i64 4, !1, i64 4, i64 4, !1}
