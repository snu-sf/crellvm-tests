...
@g_2 = internal global i32 -1133618054, align 4
@.str.1 = private unnamed_addr constant [4 x i8] c"g_2\00", align 1
@g_3 = internal global i32 1202118380, align 4
@.str.2 = private unnamed_addr constant [4 x i8] c"g_3\00", align 1
@g_7 = internal global i32 -788901530, align 4
...
@g_21 = internal global i32 1376866847, align 4
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %87 = call i32 @func_1()
  %88 = load volatile i32, i32* @g_2, align 4, !tbaa !1
  ...
  %100 = load volatile i8, i8* @g_15, align 1, !tbaa !9
...
; <label>:8                                       ; preds = %5
  ...
  %11 = getelementptr inbounds [3 x i32*], [3 x i32*]* %l_20, i32 0, i64 %10
  store i32* @g_3, i32** %11, align 8, !tbaa !5
  br label %12
...
; <label>:16                                      ; preds = %48, %15
  ...
  %18 = icmp sgt i32 %17, -25
  br i1 %18, label %19, label %51

; <label>:19                                      ; preds = %16
  %20 = bitcast i32** %l_6 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %20) #1
  store i32* @g_7, i32** %l_6, align 8, !tbaa !5
  %21 = bitcast i32* %l_8 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %21) #1
  store i32 1471528749, i32* %l_8, align 4, !tbaa !1
  %22 = bitcast i32** %l_10 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %22) #1
  store i32* %l_8, i32** %l_10, align 8, !tbaa !5
  %23 = bitcast i32** %l_11 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %23) #1
  store i32* %l_8, i32** %l_11, align 8, !tbaa !5
  %24 = bitcast i32** %l_12 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %24) #1
  store i32* %l_8, i32** %l_12, align 8, !tbaa !5
  %25 = bitcast i32** %l_13 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %25) #1
  store i32* %l_8, i32** %l_13, align 8, !tbaa !5
  %26 = bitcast [10 x i32*]* %l_14 to i8*
  call void @llvm.lifetime.start(i64 80, i8* %26) #1
  %27 = getelementptr inbounds [10 x i32*], [10 x i32*]* %l_14, i64 0, i64 0
  store i32* @g_7, i32** %27, !tbaa !5
  %28 = getelementptr inbounds i32*, i32** %27, i64 1
  store i32* %l_8, i32** %28, !tbaa !5
  %29 = getelementptr inbounds i32*, i32** %28, i64 1
  store i32* @g_7, i32** %29, !tbaa !5
  %30 = getelementptr inbounds i32*, i32** %29, i64 1
  store i32* @g_7, i32** %30, !tbaa !5
  %31 = getelementptr inbounds i32*, i32** %30, i64 1
  store i32* %l_8, i32** %31, !tbaa !5
  %32 = getelementptr inbounds i32*, i32** %31, i64 1
  store i32* @g_7, i32** %32, !tbaa !5
  %33 = getelementptr inbounds i32*, i32** %32, i64 1
  store i32* %l_8, i32** %33, !tbaa !5
  %34 = getelementptr inbounds i32*, i32** %33, i64 1
  store i32* @g_7, i32** %34, !tbaa !5
  %35 = getelementptr inbounds i32*, i32** %34, i64 1
  store i32* @g_7, i32** %35, !tbaa !5
  %36 = getelementptr inbounds i32*, i32** %35, i64 1
  store i32* %l_8, i32** %36, !tbaa !5
  %37 = bitcast i32* %i1 to i8*
  call void @llvm.lifetime.start(i64 4, i8* %37) #1
  %38 = load volatile i8, i8* @g_15, align 1, !tbaa !9
  %39 = add i8 %38, -1
  store volatile i8 %39, i8* @g_15, align 1, !tbaa !9
  %40 = bitcast i32* %i1 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %40) #1
  %41 = bitcast [10 x i32*]* %l_14 to i8*
  call void @llvm.lifetime.end(i64 80, i8* %41) #1
  %42 = bitcast i32** %l_13 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %42) #1
  %43 = bitcast i32** %l_12 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %43) #1
  %44 = bitcast i32** %l_11 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %44) #1
  %45 = bitcast i32** %l_10 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %45) #1
  %46 = bitcast i32* %l_8 to i8*
  call void @llvm.lifetime.end(i64 4, i8* %46) #1
  %47 = bitcast i32** %l_6 to i8*
...
; <label>:48                                      ; preds = %19
  ...
  %50 = add nsw i32 %49, -1
  store i32 %50, i32* @g_3, align 4, !tbaa !1
  br label %16

; <label>:51                                      ; preds = %16
  %52 = load volatile i32, i32* @g_21, align 4, !tbaa !1
  %53 = add i32 %52, 1
  store volatile i32 %53, i32* @g_21, align 4, !tbaa !1
  %54 = load i32*, i32** %l_19, align 8, !tbaa !5
  %55 = load i32, i32* %54, align 4, !tbaa !1
  %56 = bitcast i32* %i to i8*
  call void @llvm.lifetime.end(i64 4, i8* %56) #1
  %57 = bitcast [3 x i32*]* %l_20 to i8*
  call void @llvm.lifetime.end(i64 24, i8* %57) #1
  %58 = bitcast i32** %l_19 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %58) #1
  %59 = bitcast i32** %l_18 to i8*
