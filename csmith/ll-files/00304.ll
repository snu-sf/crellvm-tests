...
@g_4 = internal global i32 -1585222453, align 4
...
define internal zeroext i8 @func_1() #0 {
  ...
  %l_3 = alloca [2 x [1 x i32*]], align 16
  %l_5 = alloca [1 x i64], align 8
  ...
  %2 = bitcast [2 x [1 x i32*]]* %l_3 to i8*
  call void @llvm.lifetime.start(i64 16, i8* %2) #1
  %3 = bitcast [1 x i64]* %l_5 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %3) #1
  %4 = bitcast i64* %l_10 to i8*
  call void @llvm.lifetime.start(i64 8, i8* %4) #1
  store i64 8, i64* %l_10, align 8, !tbaa !7
...
; <label>:14                                      ; preds = %11
  ...
  %19 = getelementptr inbounds [2 x [1 x i32*]], [2 x [1 x i32*]]* %l_3, i32 0, i64 %18
  %20 = getelementptr inbounds [1 x i32*], [1 x i32*]* %19, i32 0, i64 %16
  store i32* @g_4, i32** %20, align 8, !tbaa !5
  br label %21
...
; <label>:32                                      ; preds = %29
  ...
  %35 = getelementptr inbounds [1 x i64], [1 x i64]* %l_5, i32 0, i64 %34
  store i64 0, i64* %35, align 8, !tbaa !7
  br label %36
...
; <label>:39                                      ; preds = %29
  %40 = getelementptr inbounds [1 x i64], [1 x i64]* %l_5, i32 0, i64 0
...
; <label>:43                                      ; preds = %51, %39
  %44 = load i32, i32* @g_4, align 4, !tbaa !1
  %45 = icmp ne i32 %44, -5
...
; <label>:51                                      ; preds = %50
  ...
  %54 = call signext i8 @safe_add_func_int8_t_s_s(i8 signext %53, i8 signext 5)
  %55 = sext i8 %54 to i32
  store i32 %55, i32* @g_4, align 4, !tbaa !1
  br label %43

; <label>:56                                      ; preds = %49, %43
  %57 = load i32, i32* @g_4, align 4, !tbaa !1
  %58 = sext i32 %57 to i64
  %59 = xor i64 %58, 126431882
  ...
  %63 = bitcast i64* %l_10 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %63) #1
  %64 = bitcast [1 x i64]* %l_5 to i8*
  call void @llvm.lifetime.end(i64 8, i8* %64) #1
  %65 = bitcast [2 x [1 x i32*]]* %l_3 to i8*
