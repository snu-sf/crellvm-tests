...
@g_3 = internal global i32 -1509420094, align 4
...
@func_1.l_2 = private unnamed_addr constant [3 x [8 x [7 x i16]]] [[8 x [7 x i16]] [[7 x i16] [i16 0, i16 0, i16 17675, i16 -5, i16 -801, i16 25397, i16 -1], [7 x i16] [i16 -27077, i16 -22236, i16 15023, i16 0, i16 -1, i16 25397, i16 0], [7 x i16] [i16 27624, i16 -13184, i16 30544, i16 -1, i16 9, i16 -24723, i16 -4], [7 x i16] [i16 -8215, i16 -27077, i16 14778, i16 -13557, i16 30544, i16 6, i16 6], [7 x i16] [i16 0, i16 1, i16 4373, i16 1, i16 0, i16 0, i16 -27077], [7 x i16] [i16 -5, i16 4, i16 9, i16 -1236, i16 -22236, i16 0, i16 -1], [7 x i16] [i16 17950, i16 0, i16 -29243, i16 -27223, i16 2, i16 30544, i16 8249], [7 x i16] [i16 -1, i16 -1, i16 8249, i16 9, i16 30544, i16 1, i16 -1]], [8 x [7 x i16]] [[7 x i16] [i16 4, i16 2, i16 -801, i16 4, i16 -1, i16 -24723, i16 4373], [7 x i16] [i16 -18842, i16 14778, i16 0, i16 -2127, i16 -1236, i16 -1, i16 -29243], [7 x i16] [i16 30058, i16 8249, i16 5293, i16 0, i16 -19211, i16 -12807, i16 -18842], [7 x i16] [i16 -2824, i16 -27223, i16 5293, i16 -18842, i16 0, i16 -1, i16 0], [7 x i16] [i16 1, i16 -1, i16 0, i16 -24723, i16 1, i16 -1, i16 -19211], [7 x i16] [i16 -1, i16 -2127, i16 -801, i16 1, i16 -13557, i16 1, i16 -801], [7 x i16] [i16 0, i16 0, i16 8249, i16 -1, i16 -1, i16 15023, i16 30058], [7 x i16] [i16 30544, i16 -10, i16 -19211, i16 -4, i16 -13895, i16 8, i16 1]], [8 x [7 x i16]] [[7 x i16] [i16 0, i16 0, i16 17675, i16 0, i16 -1, i16 0, i16 14778], [7 x i16] [i16 17950, i16 -12807, i16 0, i16 0, i16 -13557, i16 -5, i16 4126], [7 x i16] [i16 -5, i16 4126, i16 -4, i16 15817, i16 1, i16 5293, i16 -5], [7 x i16] [i16 1, i16 26366, i16 -1, i16 -1, i16 0, i16 0, i16 -1236], [7 x i16] [i16 4, i16 1, i16 -1, i16 -2824, i16 -19211, i16 -29243, i16 -1236], [7 x i16] [i16 0, i16 1, i16 14778, i16 -12807, i16 -1236, i16 2199, i16 -5], [7 x i16] [i16 -5, i16 0, i16 -2127, i16 0, i16 -1, i16 6, i16 4126], [7 x i16] [i16 -13557, i16 30544, i16 6, i16 6, i16 30544, i16 -13557, i16 14778]]], align 16
...
; <label>:86                                      ; preds = %85, %79, %0
  ...
  %87 = call i64 @func_1()
  %88 = load volatile i32, i32* @g_3, align 4, !tbaa !1
...
define internal i64 @func_1() #0 {
  %l_2 = alloca [3 x [8 x [7 x i16]]], align 16
  %i = alloca i32, align 4
  %j = alloca i32, align 4
  %k = alloca i32, align 4
  %1 = bitcast [3 x [8 x [7 x i16]]]* %l_2 to i8*
  call void @llvm.lifetime.start(i64 336, i8* %1) #1
  %2 = bitcast [3 x [8 x [7 x i16]]]* %l_2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* bitcast ([3 x [8 x [7 x i16]]]* @func_1.l_2 to i8*), i64 336, i32 16, i1 false)
  %3 = bitcast i32* %i to i8*
  call void @llvm.lifetime.start(i64 4, i8* %3) #1
  %4 = bitcast i32* %j to i8*
  call void @llvm.lifetime.start(i64 4, i8* %4) #1
...
; <label>:6                                       ; preds = %35, %0
  %7 = load volatile i32, i32* @g_3, align 4, !tbaa !1
  %8 = icmp slt i32 %7, 3
...
; <label>:10                                      ; preds = %31, %9
  %11 = load volatile i32, i32* @g_4, align 4, !tbaa !1
...
; <label>:14                                      ; preds = %27, %13
  %15 = load volatile i32, i32* @g_5, align 4, !tbaa !1
  %16 = icmp slt i32 %15, 7
  br i1 %16, label %17, label %30

; <label>:17                                      ; preds = %14
  %18 = load volatile i32, i32* @g_5, align 4, !tbaa !1
  %19 = sext i32 %18 to i64
  %20 = load volatile i32, i32* @g_4, align 4, !tbaa !1
  %21 = sext i32 %20 to i64
  %22 = load volatile i32, i32* @g_3, align 4, !tbaa !1
  %23 = sext i32 %22 to i64
  %24 = getelementptr inbounds [3 x [8 x [7 x i16]]], [3 x [8 x [7 x i16]]]* %l_2, i32 0, i64 %23
  %25 = getelementptr inbounds [8 x [7 x i16]], [8 x [7 x i16]]* %24, i32 0, i64 %21
  %26 = getelementptr inbounds [7 x i16], [7 x i16]* %25, i32 0, i64 %19
  store i16 1, i16* %26, align 2, !tbaa !10
  br label %27

; <label>:27                                      ; preds = %17
  %28 = load volatile i32, i32* @g_5, align 4, !tbaa !1
  %29 = add nsw i32 %28, 1
  store volatile i32 %29, i32* @g_5, align 4, !tbaa !1
  br label %14
...
; <label>:31                                      ; preds = %30
  %32 = load volatile i32, i32* @g_4, align 4, !tbaa !1
  %33 = add nsw i32 %32, 1
  store volatile i32 %33, i32* @g_4, align 4, !tbaa !1
  br label %10
...
; <label>:35                                      ; preds = %34
  ...
  %37 = add nsw i32 %36, 1
  store volatile i32 %37, i32* @g_3, align 4, !tbaa !1
  br label %6

; <label>:38                                      ; preds = %6
  %39 = getelementptr inbounds [3 x [8 x [7 x i16]]], [3 x [8 x [7 x i16]]]* %l_2, i32 0, i64 2
  %40 = getelementptr inbounds [8 x [7 x i16]], [8 x [7 x i16]]* %39, i32 0, i64 2
  ...
  %47 = bitcast [3 x [8 x [7 x i16]]]* %l_2 to i8*
  call void @llvm.lifetime.end(i64 336, i8* %47) #1
  ret i64 %43
}
