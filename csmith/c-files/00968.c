...
/* --- GLOBAL VARIABLES --- */
static const volatile int32_t g_5 = 0x8F01BA02L;/* VOLATILE GLOBAL g_5 */
...
{ /* block id: 0 */
    ...
    uint32_t *l_7 = &g_8;
    int32_t *l_9 = &g_10[7];
    (*l_9) |= (((0UL | ((safe_rshift_func_int8_t_s_s((l_4 || (g_5 || g_5)), g_6)) >= g_6)) || ((*l_7) &= l_4)) & g_6);
    return (*l_9);
}
