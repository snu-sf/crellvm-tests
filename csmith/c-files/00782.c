...
static volatile int64_t g_7 = 0xCB3A3FC4B03E3869LL;/* VOLATILE GLOBAL g_7 */
static volatile int32_t g_8 = (-4L);/* VOLATILE GLOBAL g_8 */
static struct S1 g_12 = {19384,3};/* VOLATILE GLOBAL g_12 */
