...
/* --- GLOBAL VARIABLES --- */
static volatile struct S0 g_2 = {1UL};/* VOLATILE GLOBAL g_2 */
static volatile struct S0 g_3 = {0xA7L};/* VOLATILE GLOBAL g_3 */
static struct S1 g_4 = {0,874,33,0,-1,26,874};/* VOLATILE GLOBAL g_4 */
