...
/* --- GLOBAL VARIABLES --- */
static volatile int32_t g_2 = 0xBC6E5C7AL;/* VOLATILE GLOBAL g_2 */
static int32_t g_3 = 0x47A6DEECL;
static int32_t g_7 = 0xD0FA5166L;
static int32_t g_9 = (-1L);
static volatile uint8_t g_15 = 0UL;/* VOLATILE GLOBAL g_15 */
static volatile uint32_t g_21 = 0x5211521FL;/* VOLATILE GLOBAL g_21 */
...
{ /* block id: 0 */
    ...
    { /* block id: 3 */
        int32_t *l_6 = &g_7;
        int32_t l_8 = 0x57B5BF2DL;
        int32_t *l_10 = &l_8;
        int32_t *l_11 = &l_8;
        int32_t *l_12 = &l_8;
        int32_t *l_13 = &l_8;
        int32_t *l_14[10] = {&g_7,&l_8,&g_7,&g_7,&l_8,&g_7,&l_8,&g_7,&g_7,&l_8};
        int i;
        --g_15;
    }
    ++g_21;
