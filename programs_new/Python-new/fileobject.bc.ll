; ModuleID = 'programs_new/Python-new/fileobject.bc.ll'
...
cleanup.251:                                      ; preds = %NewDefault, %if.end.250, %if.then
...
cleanup.55:                                       ; preds = %NewDefault, %if.end.54, %if.then.52, %if.then.49, %if.else.44
