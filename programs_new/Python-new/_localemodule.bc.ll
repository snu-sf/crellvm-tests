; ModuleID = 'programs_new/Python-new/_localemodule.bc.ll'
...
cleanup:                                          ; preds = %if.end.18, %if.then.16
...
exit:                                             ; preds = %LeafBlock.1, %if.end.21, %if.then.6, %if.then.2
...
cleanup.29:                                       ; preds = %NewDefault, %if.end.28, %if.then
