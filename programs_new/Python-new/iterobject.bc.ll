; ModuleID = 'irs-onlybc/iterobject.bc'
...
cleanup.117:                                      ; preds = %if.end.116, %cleanup, %if.then.2
  ...
  switch i32 %cleanup.dest.119, label %unreachable [
    i32 0, label %cleanup.cont.120
    i32 1, label %return
  ]

cleanup.cont.120:                                 ; preds = %cleanup.117
